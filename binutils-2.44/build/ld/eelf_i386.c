...
{
  ldelf_before_plugin_all_symbols_read (true, true,
				        true,
					false,
					32, "/root/AsmXoM/binutils-2.44/build");
}
...
gldelf_i386_after_open (void)
{
  ldelf_after_open (true, true,
		    true, false, 32, "/root/AsmXoM/binutils-2.44/build");
}
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/i386-pc-linux-gnu/lib32\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/x86_64-pc-linux-gnu/lib32\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/lib32\"); SEARCH_DIR(\"/usr/local/lib32\"); SEARCH_DIR(\"/lib32\"); SEARCH_DIR(\"/usr/lib32\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/i386-pc-linux-gnu/lib\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/lib\"); SEARCH_DIR(\"/usr/local/lib\"); SEARCH_DIR(\"/lib\"); SEARCH_DIR(\"/usr/lib\");\n\
SECTIONS\n\
{\n\
