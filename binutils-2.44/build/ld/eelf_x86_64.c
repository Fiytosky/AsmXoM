...
gldelf_x86_64_before_plugin_all_symbols_read (void)
{
  ldelf_before_plugin_all_symbols_read (true, true,
				        true,
					false,
					64, "/root/AsmXoM/binutils-2.44/build");
}
...
gldelf_x86_64_after_open (void)
{
  ldelf_after_open (true, true,
		    true, false, 64, "/root/AsmXoM/binutils-2.44/build");
}
...
OUTPUT_ARCH(i386:x86-64)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/x86_64-pc-linux-gnu/lib64\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/lib64\"); SEARCH_DIR(\"/usr/local/lib64\"); SEARCH_DIR(\"/lib64\"); SEARCH_DIR(\"/usr/lib64\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/x86_64-pc-linux-gnu/lib\"); SEARCH_DIR(\"/root/AsmXoM/binutils-2.44/build/lib\"); SEARCH_DIR(\"/usr/local/lib\"); SEARCH_DIR(\"/lib\"); SEARCH_DIR(\"/usr/lib\");\n\
SECTIONS\n\
{\n\
