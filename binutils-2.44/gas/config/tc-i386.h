...
// fiytosky, add
/* Classification of the fixed bytes stored in an x86 frag.  */
enum i386_frag_byte_kind
{
  I386_FRAG_BYTES_UNCLASSIFIED,
  I386_FRAG_BYTES_INSN,
  I386_FRAG_BYTES_MIXED
};
...
#define TC_FRAG_INIT(FRAGP, MAX_BYTES)				\
 do								\
   {								\
     ...
     (FRAGP)->tc_frag_data.byte_kind = I386_FRAG_BYTES_UNCLASSIFIED; \
...
/* fiytosky: api for disasm frags */
extern enum i386_frag_byte_kind i386_classify_hardcoded_frag (fragS *);
