...
# 18 "../test/list_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 19 "../test/list_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 20 "../test/list_test.c" 2

typedef struct testl_st TESTL;
struct testl_st {
    int n;
    struct { TESTL *next, *prev; } ossl_list_fizz;
    struct { TESTL *next, *prev; } ossl_list_buzz;
};

typedef struct ossl_list_st_fizz OSSL_LIST_fizz; struct ossl_list_st_fizz { TESTL *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_fizz_init(OSSL_LIST_fizz *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_fizz_init_elem(TESTL *elem) { memset(&elem->ossl_list_fizz, 0, sizeof(elem->ossl_list_fizz)); } static __attribute__((unused)) inline int ossl_list_fizz_is_empty(const OSSL_LIST_fizz *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_fizz_num(const OSSL_LIST_fizz *list) { return list->num_elems; } static __attribute__((unused)) inline TESTL * ossl_list_fizz_head(const OSSL_LIST_fizz *list) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; return list->alpha; } static __attribute__((unused)) inline TESTL * ossl_list_fizz_tail(const OSSL_LIST_fizz *list) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; return list->omega; } static __attribute__((unused)) inline TESTL * ossl_list_fizz_next(const TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; return elem->ossl_list_fizz.next; } static __attribute__((unused)) inline TESTL * ossl_list_fizz_prev(const TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; return elem->ossl_list_fizz.prev; } static __attribute__((unused)) inline void ossl_list_fizz_remove(OSSL_LIST_fizz *list, TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_fizz.next; if (list->omega == elem) list->omega = elem->ossl_list_fizz.prev; if (elem->ossl_list_fizz.prev != 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
) elem->ossl_list_fizz.prev->ossl_list_fizz.next = elem->ossl_list_fizz.next; if (elem->ossl_list_fizz.next != 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
) elem->ossl_list_fizz.next->ossl_list_fizz.prev = elem->ossl_list_fizz.prev; list->num_elems--; memset(&elem->ossl_list_fizz, 0, sizeof(elem->ossl_list_fizz)); } static __attribute__((unused)) inline void ossl_list_fizz_insert_head(OSSL_LIST_fizz *list, TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; if (list->alpha != 
...
((void *)0)
# 28 "../test/list_test.c"
) list->alpha->ossl_list_fizz.prev = elem; elem->ossl_list_fizz.next = list->alpha; elem->ossl_list_fizz.prev = 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
...
((void *)0)
# 28 "../test/list_test.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_fizz_insert_tail(OSSL_LIST_fizz *list, TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; if (list->omega != 
...
((void *)0)
# 28 "../test/list_test.c"
) list->omega->ossl_list_fizz.next = elem; elem->ossl_list_fizz.prev = list->omega; elem->ossl_list_fizz.next = 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
...
((void *)0)
# 28 "../test/list_test.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_fizz_insert_before(OSSL_LIST_fizz *list, TESTL *e, TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; elem->ossl_list_fizz.next = e; elem->ossl_list_fizz.prev = e->ossl_list_fizz.prev; if (e->ossl_list_fizz.prev != 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
) e->ossl_list_fizz.prev->ossl_list_fizz.next = elem; e->ossl_list_fizz.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_fizz_insert_after(OSSL_LIST_fizz *list, TESTL *e, TESTL *elem) { 
# 28 "../test/list_test.c" 3 4
((void) (0))
# 28 "../test/list_test.c"
; elem->ossl_list_fizz.prev = e; elem->ossl_list_fizz.next = e->ossl_list_fizz.next; if (e->ossl_list_fizz.next != 
# 28 "../test/list_test.c" 3 4
((void *)0)
# 28 "../test/list_test.c"
) e->ossl_list_fizz.next->ossl_list_fizz.prev = elem; e->ossl_list_fizz.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_fizz;
typedef struct ossl_list_st_buzz OSSL_LIST_buzz; struct ossl_list_st_buzz { TESTL *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_buzz_init(OSSL_LIST_buzz *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_buzz_init_elem(TESTL *elem) { memset(&elem->ossl_list_buzz, 0, sizeof(elem->ossl_list_buzz)); } static __attribute__((unused)) inline int ossl_list_buzz_is_empty(const OSSL_LIST_buzz *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_buzz_num(const OSSL_LIST_buzz *list) { return list->num_elems; } static __attribute__((unused)) inline TESTL * ossl_list_buzz_head(const OSSL_LIST_buzz *list) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; return list->alpha; } static __attribute__((unused)) inline TESTL * ossl_list_buzz_tail(const OSSL_LIST_buzz *list) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; return list->omega; } static __attribute__((unused)) inline TESTL * ossl_list_buzz_next(const TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; return elem->ossl_list_buzz.next; } static __attribute__((unused)) inline TESTL * ossl_list_buzz_prev(const TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; return elem->ossl_list_buzz.prev; } static __attribute__((unused)) inline void ossl_list_buzz_remove(OSSL_LIST_buzz *list, TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_buzz.next; if (list->omega == elem) list->omega = elem->ossl_list_buzz.prev; if (elem->ossl_list_buzz.prev != 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
) elem->ossl_list_buzz.prev->ossl_list_buzz.next = elem->ossl_list_buzz.next; if (elem->ossl_list_buzz.next != 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
) elem->ossl_list_buzz.next->ossl_list_buzz.prev = elem->ossl_list_buzz.prev; list->num_elems--; memset(&elem->ossl_list_buzz, 0, sizeof(elem->ossl_list_buzz)); } static __attribute__((unused)) inline void ossl_list_buzz_insert_head(OSSL_LIST_buzz *list, TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; if (list->alpha != 
...
((void *)0)
# 29 "../test/list_test.c"
) list->alpha->ossl_list_buzz.prev = elem; elem->ossl_list_buzz.next = list->alpha; elem->ossl_list_buzz.prev = 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 29 "../test/list_test.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_buzz_insert_tail(OSSL_LIST_buzz *list, TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; if (list->omega != 
...
((void *)0)
# 29 "../test/list_test.c"
) list->omega->ossl_list_buzz.next = elem; elem->ossl_list_buzz.prev = list->omega; elem->ossl_list_buzz.next = 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 29 "../test/list_test.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_buzz_insert_before(OSSL_LIST_buzz *list, TESTL *e, TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; elem->ossl_list_buzz.next = e; elem->ossl_list_buzz.prev = e->ossl_list_buzz.prev; if (e->ossl_list_buzz.prev != 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
) e->ossl_list_buzz.prev->ossl_list_buzz.next = elem; e->ossl_list_buzz.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_buzz_insert_after(OSSL_LIST_buzz *list, TESTL *e, TESTL *elem) { 
# 29 "../test/list_test.c" 3 4
((void) (0))
# 29 "../test/list_test.c"
; elem->ossl_list_buzz.prev = e; elem->ossl_list_buzz.next = e->ossl_list_buzz.next; if (e->ossl_list_buzz.next != 
# 29 "../test/list_test.c" 3 4
((void *)0)
# 29 "../test/list_test.c"
) e->ossl_list_buzz.next->ossl_list_buzz.prev = elem; e->ossl_list_buzz.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_buzz;
...
static int test_fizzbuzz(void)
{
    ...
    OSSL_LIST_buzz b;
    TESTL elem[20];
    const int nelem = (sizeof(elem)/sizeof((elem)[0]));
    int i, na = 0, nb = 0;

    ossl_list_fizz_init(&a);
    ossl_list_buzz_init(&b);

    if (!test_true("../test/list_test.c", 42, "ossl_list_fizz_is_empty(&a)", (ossl_list_fizz_is_empty(&a)) != 0))
        return 0;
    ...
    if (!test_false("../test/list_test.c", 59, "ossl_list_fizz_is_empty(&a)", (ossl_list_fizz_is_empty(&a)) != 0)
            || !test_size_t_eq("../test/list_test.c", 60, "ossl_list_fizz_num(&a)", "na", ossl_list_fizz_num(&a), na)
            || !test_size_t_eq("../test/list_test.c", 61, "ossl_list_buzz_num(&b)", "nb", ossl_list_buzz_num(&b), nb)
            || !test_ptr("../test/list_test.c", 62, "ossl_list_fizz_head(&a)", ossl_list_fizz_head(&a))
            || !test_ptr("../test/list_test.c", 63, "ossl_list_fizz_tail(&a)", ossl_list_fizz_tail(&a))
            || !test_ptr("../test/list_test.c", 64, "ossl_list_buzz_head(&b)", ossl_list_buzz_head(&b))
            || !test_ptr("../test/list_test.c", 65, "ossl_list_buzz_tail(&b)", ossl_list_buzz_tail(&b))
            || !test_int_eq("../test/list_test.c", 66, "ossl_list_fizz_head(&a)->n", "3", ossl_list_fizz_head(&a)->n, 3)
            || !test_int_eq("../test/list_test.c", 67, "ossl_list_fizz_tail(&a)->n", "na * 3", ossl_list_fizz_tail(&a)->n, na * 3)
            || !test_int_eq("../test/list_test.c", 68, "ossl_list_buzz_head(&b)->n", "nb * 5", ossl_list_buzz_head(&b)->n, nb * 5)
            || !test_int_eq("../test/list_test.c", 69, "ossl_list_buzz_tail(&b)->n", "5", ossl_list_buzz_tail(&b)->n, 5))
        return 0;
    ossl_list_fizz_remove(&a, ossl_list_fizz_head(&a));
    ossl_list_buzz_remove(&b, ossl_list_buzz_tail(&b));
    if (!test_size_t_eq("../test/list_test.c", 73, "ossl_list_fizz_num(&a)", "--na", ossl_list_fizz_num(&a), --na)
            || !test_size_t_eq("../test/list_test.c", 74, "ossl_list_buzz_num(&b)", "--nb", ossl_list_buzz_num(&b), --nb)
            || !test_ptr("../test/list_test.c", 75, "ossl_list_fizz_head(&a)", ossl_list_fizz_head(&a))
            || !test_ptr("../test/list_test.c", 76, "ossl_list_buzz_tail(&b)", ossl_list_buzz_tail(&b))
            || !test_int_eq("../test/list_test.c", 77, "ossl_list_fizz_head(&a)->n", "6", ossl_list_fizz_head(&a)->n, 6)
            || !test_int_eq("../test/list_test.c", 78, "ossl_list_buzz_tail(&b)->n", "10", ossl_list_buzz_tail(&b)->n, 10)
            || !test_ptr("../test/list_test.c", 79, "ossl_list_fizz_next(ossl_list_fizz_head(&a))", ossl_list_fizz_next(ossl_list_fizz_head(&a)))
            || !test_ptr("../test/list_test.c", 80, "ossl_list_fizz_prev(ossl_list_fizz_tail(&a))", ossl_list_fizz_prev(ossl_list_fizz_tail(&a)))
            || !test_int_eq("../test/list_test.c", 81, "ossl_list_fizz_next(ossl_list_fizz_head(&a))->n", "9", ossl_list_fizz_next(ossl_list_fizz_head(&a))->n, 9)
            || !test_int_eq("../test/list_test.c", 82, "ossl_list_fizz_prev(ossl_list_fizz_tail(&a))->n", "15", ossl_list_fizz_prev(ossl_list_fizz_tail(&a))->n, 15))
        return 0;
    return 1;
}
...
struct int_st {
    int n;
    struct { INTL *next, *prev; } ossl_list_int;
};

typedef struct ossl_list_st_int OSSL_LIST_int; struct ossl_list_st_int { INTL *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_int_init(OSSL_LIST_int *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_int_init_elem(INTL *elem) { memset(&elem->ossl_list_int, 0, sizeof(elem->ossl_list_int)); } static __attribute__((unused)) inline int ossl_list_int_is_empty(const OSSL_LIST_int *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_int_num(const OSSL_LIST_int *list) { return list->num_elems; } static __attribute__((unused)) inline INTL * ossl_list_int_head(const OSSL_LIST_int *list) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; return list->alpha; } static __attribute__((unused)) inline INTL * ossl_list_int_tail(const OSSL_LIST_int *list) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; return list->omega; } static __attribute__((unused)) inline INTL * ossl_list_int_next(const INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; return elem->ossl_list_int.next; } static __attribute__((unused)) inline INTL * ossl_list_int_prev(const INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; return elem->ossl_list_int.prev; } static __attribute__((unused)) inline void ossl_list_int_remove(OSSL_LIST_int *list, INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_int.next; if (list->omega == elem) list->omega = elem->ossl_list_int.prev; if (elem->ossl_list_int.prev != 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
) elem->ossl_list_int.prev->ossl_list_int.next = elem->ossl_list_int.next; if (elem->ossl_list_int.next != 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
) elem->ossl_list_int.next->ossl_list_int.prev = elem->ossl_list_int.prev; list->num_elems--; memset(&elem->ossl_list_int, 0, sizeof(elem->ossl_list_int)); } static __attribute__((unused)) inline void ossl_list_int_insert_head(OSSL_LIST_int *list, INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; if (list->alpha != 
...
((void *)0)
# 93 "../test/list_test.c"
) list->alpha->ossl_list_int.prev = elem; elem->ossl_list_int.next = list->alpha; elem->ossl_list_int.prev = 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 93 "../test/list_test.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_int_insert_tail(OSSL_LIST_int *list, INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; if (list->omega != 
...
((void *)0)
# 93 "../test/list_test.c"
) list->omega->ossl_list_int.next = elem; elem->ossl_list_int.prev = list->omega; elem->ossl_list_int.next = 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 93 "../test/list_test.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_int_insert_before(OSSL_LIST_int *list, INTL *e, INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; elem->ossl_list_int.next = e; elem->ossl_list_int.prev = e->ossl_list_int.prev; if (e->ossl_list_int.prev != 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
) e->ossl_list_int.prev->ossl_list_int.next = elem; e->ossl_list_int.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_int_insert_after(OSSL_LIST_int *list, INTL *e, INTL *elem) { 
# 93 "../test/list_test.c" 3 4
((void) (0))
# 93 "../test/list_test.c"
; elem->ossl_list_int.prev = e; elem->ossl_list_int.next = e->ossl_list_int.next; if (e->ossl_list_int.next != 
# 93 "../test/list_test.c" 3 4
((void *)0)
# 93 "../test/list_test.c"
) e->ossl_list_int.next->ossl_list_int.prev = elem; e->ossl_list_int.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_int;
...
static int test_insert(void)
{
    ...
    ossl_list_int_insert_head(&l, elem + 3);
    ossl_list_int_insert_tail(&l, elem + 6);
    ossl_list_int_insert_before(&l, elem + 6, elem + 5);
    ossl_list_int_insert_before(&l, elem + 3, elem + 1);
    ossl_list_int_insert_after(&l, elem + 1, elem + 2);
    ossl_list_int_insert_after(&l, elem + 6, elem + 7);
    ossl_list_int_insert_after(&l, elem + 3, elem + 4);
    if (!test_size_t_eq("../test/list_test.c", 117, "ossl_list_int_num(&l)", "7", ossl_list_int_num(&l), 7))
        return 0;
    c = ossl_list_int_head(&l);
    d = ossl_list_int_tail(&l);
    while (c != 
# 121 "../test/list_test.c" 3 4
               ((void *)0) 
# 121 "../test/list_test.c"
                    && d != 
# 121 "../test/list_test.c" 3 4
                            ((void *)0)
# 121 "../test/list_test.c"
                                ) {
        if (!test_int_eq("../test/list_test.c", 122, "c->n", "n", c->n, n) || !test_int_eq("../test/list_test.c", 122, "d->n", "8 - n", d->n, 8 - n))
            return 0;
        c = ossl_list_int_next(c);
        d = ossl_list_int_prev(d);
        n++;
    }
    if (!test_ptr_null("../test/list_test.c", 128, "c", c) || !test_ptr_null("../test/list_test.c", 128, "d", d))
        return 0;


    ossl_list_int_remove(&l, elem + 1);
    ossl_list_int_remove(&l, elem + 6);
    ossl_list_int_remove(&l, elem + 7);
    n = 2;
    c = ossl_list_int_head(&l);
    d = ossl_list_int_tail(&l);
    while (c != 
# 138 "../test/list_test.c" 3 4
               ((void *)0) 
# 138 "../test/list_test.c"
                    && d != 
# 138 "../test/list_test.c" 3 4
                            ((void *)0)
# 138 "../test/list_test.c"
                                ) {
        if (!test_int_eq("../test/list_test.c", 139, "c->n", "n", c->n, n) || !test_int_eq("../test/list_test.c", 139, "d->n", "7 - n", d->n, 7 - n))
            return 0;
        c = ossl_list_int_next(c);
        d = ossl_list_int_prev(d);
        n++;
    }
    if (!test_ptr_null("../test/list_test.c", 145, "c", c) || !test_ptr_null("../test/list_test.c", 145, "d", d))
        return 0;


    ossl_list_int_remove(&l, elem + 2);
    ossl_list_int_remove(&l, elem + 4);
    ossl_list_int_remove(&l, elem + 3);
    if (!test_ptr("../test/list_test.c", 152, "ossl_list_int_head(&l)", ossl_list_int_head(&l))
            || !test_ptr("../test/list_test.c", 153, "ossl_list_int_tail(&l)", ossl_list_int_tail(&l))
            || !test_int_eq("../test/list_test.c", 154, "ossl_list_int_head(&l)->n", "5", ossl_list_int_head(&l)->n, 5)
            || !test_int_eq("../test/list_test.c", 155, "ossl_list_int_tail(&l)->n", "5", ossl_list_int_tail(&l)->n, 5))
        return 0;


    ossl_list_int_insert_head(&l, elem);
    ossl_list_int_remove(&l, elem + 5);
    if (!test_ptr("../test/list_test.c", 161, "ossl_list_int_head(&l)", ossl_list_int_head(&l))
            || !test_ptr("../test/list_test.c", 162, "ossl_list_int_tail(&l)", ossl_list_int_tail(&l))
            || !test_int_eq("../test/list_test.c", 163, "ossl_list_int_head(&l)->n", "0", ossl_list_int_head(&l)->n, 0)
            || !test_int_eq("../test/list_test.c", 164, "ossl_list_int_tail(&l)->n", "0", ossl_list_int_tail(&l)->n, 0))
        return 0;


    ossl_list_int_remove(&l, elem);
    if (!test_ptr_null("../test/list_test.c", 169, "ossl_list_int_head(&l)", ossl_list_int_head(&l))
            || !test_ptr_null("../test/list_test.c", 170, "ossl_list_int_tail(&l)", ossl_list_int_tail(&l)))
        return 0;
    return 1;
}
