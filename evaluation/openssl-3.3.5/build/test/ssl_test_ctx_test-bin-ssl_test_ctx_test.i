# 0 "../test/ssl_test_ctx_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ssl_test_ctx_test.c"
# 15 "../test/ssl_test_ctx_test.c"
...
# 17 "../test/ssl_test_ctx_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 19 "../test/ssl_test_ctx_test.c" 2
...
static CONF *conf = 
# 26 "../test/ssl_test_ctx_test.c" 3 4
                   ((void *)0)
# 26 "../test/ssl_test_ctx_test.c"
                       ;
...
{
    if (!test_int_eq("../test/ssl_test_ctx_test.c", 39, "conf1->verify_callback", "conf2->verify_callback", conf1->verify_callback, conf2->verify_callback)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 40, "conf1->servername", "conf2->servername", conf1->servername, conf2->servername)
            || !test_str_eq("../test/ssl_test_ctx_test.c", 41, "conf1->npn_protocols", "conf2->npn_protocols", conf1->npn_protocols, conf2->npn_protocols)
            || !test_str_eq("../test/ssl_test_ctx_test.c", 42, "conf1->alpn_protocols", "conf2->alpn_protocols", conf1->alpn_protocols, conf2->alpn_protocols)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 43, "conf1->ct_validation", "conf2->ct_validation", conf1->ct_validation, conf2->ct_validation)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 44, "conf1->max_fragment_len_mode", "conf2->max_fragment_len_mode", conf1->max_fragment_len_mode, conf2->max_fragment_len_mode)
                                                         )
        return 0;
    return 1;
}
...
{
    if (!test_int_eq("../test/ssl_test_ctx_test.c", 53, "serv->servername_callback", "serv2->servername_callback", serv->servername_callback, serv2->servername_callback)
            || !test_str_eq("../test/ssl_test_ctx_test.c", 54, "serv->npn_protocols", "serv2->npn_protocols", serv->npn_protocols, serv2->npn_protocols)
            || !test_str_eq("../test/ssl_test_ctx_test.c", 55, "serv->alpn_protocols", "serv2->alpn_protocols", serv->alpn_protocols, serv2->alpn_protocols)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 56, "serv->broken_session_ticket", "serv2->broken_session_ticket", serv->broken_session_ticket, serv2->broken_session_ticket)

            || !test_str_eq("../test/ssl_test_ctx_test.c", 58, "serv->session_ticket_app_data", "serv2->session_ticket_app_data", serv->session_ticket_app_data, serv2->session_ticket_app_data)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 60, "serv->cert_status", "serv2->cert_status", serv->cert_status, serv2->cert_status))
        return 0;
    return 1;
}
...
{
    if (!test_true("../test/ssl_test_ctx_test.c", 68, "clientconf_eq(&extra->client, &extra2->client)", (clientconf_eq(&extra->client, &extra2->client)) != 0)
            || !test_true("../test/ssl_test_ctx_test.c", 69, "serverconf_eq(&extra->server, &extra2->server)", (serverconf_eq(&extra->server, &extra2->server)) != 0)
            || !test_true("../test/ssl_test_ctx_test.c", 70, "serverconf_eq(&extra->server2, &extra2->server2)", (serverconf_eq(&extra->server2, &extra2->server2)) != 0))
        return 0;
    return 1;
}
...
{
    if (!test_int_eq("../test/ssl_test_ctx_test.c", 77, "ctx->method", "ctx2->method", ctx->method, ctx2->method)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 78, "ctx->handshake_mode", "ctx2->handshake_mode", ctx->handshake_mode, ctx2->handshake_mode)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 79, "ctx->app_data_size", "ctx2->app_data_size", ctx->app_data_size, ctx2->app_data_size)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 80, "ctx->max_fragment_size", "ctx2->max_fragment_size", ctx->max_fragment_size, ctx2->max_fragment_size)
            || !extraconf_eq(&ctx->extra, &ctx2->extra)
            || !extraconf_eq(&ctx->resume_extra, &ctx2->resume_extra)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 83, "ctx->expected_result", "ctx2->expected_result", ctx->expected_result, ctx2->expected_result)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 84, "ctx->expected_client_alert", "ctx2->expected_client_alert", ctx->expected_client_alert, ctx2->expected_client_alert)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 86, "ctx->expected_server_alert", "ctx2->expected_server_alert", ctx->expected_server_alert, ctx2->expected_server_alert)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 88, "ctx->expected_protocol", "ctx2->expected_protocol", ctx->expected_protocol, ctx2->expected_protocol)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 89, "ctx->expected_servername", "ctx2->expected_servername", ctx->expected_servername, ctx2->expected_servername)
            || !test_int_eq("../test/ssl_test_ctx_test.c", 90, "ctx->session_ticket_expected", "ctx2->session_ticket_expected", ctx->session_ticket_expected, ctx2->session_ticket_expected)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 92, "ctx->compression_expected", "ctx2->compression_expected", ctx->compression_expected, ctx2->compression_expected)

            || !test_str_eq("../test/ssl_test_ctx_test.c", 94, "ctx->expected_npn_protocol", "ctx2->expected_npn_protocol", ctx->expected_npn_protocol, ctx2->expected_npn_protocol)

            || !test_str_eq("../test/ssl_test_ctx_test.c", 96, "ctx->expected_alpn_protocol", "ctx2->expected_alpn_protocol", ctx->expected_alpn_protocol, ctx2->expected_alpn_protocol)

            || !test_str_eq("../test/ssl_test_ctx_test.c", 98, "ctx->expected_cipher", "ctx2->expected_cipher", ctx->expected_cipher, ctx2->expected_cipher)

            || !test_str_eq("../test/ssl_test_ctx_test.c", 100, "ctx->expected_session_ticket_app_data", "ctx2->expected_session_ticket_app_data", ctx->expected_session_ticket_app_data, ctx2->expected_session_ticket_app_data)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 102, "ctx->resumption_expected", "ctx2->resumption_expected", ctx->resumption_expected, ctx2->resumption_expected)

            || !test_int_eq("../test/ssl_test_ctx_test.c", 104, "ctx->session_id_expected", "ctx2->session_id_expected", ctx->session_id_expected, ctx2->session_id_expected)
                                                      )
        return 0;
    return 1;
}
...
static SSL_TEST_CTX_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/ssl_test_ctx_test.c", 114, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/ssl_test_ctx_test.c", 114)))
        return 
# 115 "../test/ssl_test_ctx_test.c" 3 4
              ((void *)0)
# 115 "../test/ssl_test_ctx_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/ssl_test_ctx_test.c", 117, "fixture->expected_ctx = SSL_TEST_CTX_new(NULL)", fixture->expected_ctx = SSL_TEST_CTX_new(
# 117 "../test/ssl_test_ctx_test.c" 3 4
        ((void *)0)
# 117 "../test/ssl_test_ctx_test.c"
        ))) {
        CRYPTO_free(fixture, "../test/ssl_test_ctx_test.c", 118);
        return 
# 119 "../test/ssl_test_ctx_test.c" 3 4
              ((void *)0)
# 119 "../test/ssl_test_ctx_test.c"
                  ;
    }
    return fixture;
}
...
static int execute_test(SSL_TEST_CTX_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/ssl_test_ctx_test.c", 129, "ctx = SSL_TEST_CTX_create(conf, fixture->test_section, fixture->expected_ctx->libctx)", ctx = SSL_TEST_CTX_create(conf, fixture->test_section, fixture->expected_ctx->libctx))
...
static void tear_down(SSL_TEST_CTX_TEST_FIXTURE *fixture)
{
    ...
    CRYPTO_free(fixture, "../test/ssl_test_ctx_test.c", 143);
}
...
{
    SSL_TEST_CTX_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 153 "../test/ssl_test_ctx_test.c" 3 4
   ((void *)0)
# 153 "../test/ssl_test_ctx_test.c"
   ) return 0;;
    fixture->test_section = "ssltest_default";
    fixture->expected_ctx->expected_result = SSL_TEST_SUCCESS;
    if (fixture != 
# 156 "../test/ssl_test_ctx_test.c" 3 4
   ((void *)0)
# 156 "../test/ssl_test_ctx_test.c"
   ) { result = execute_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    SSL_TEST_CTX_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 162 "../test/ssl_test_ctx_test.c" 3 4
   ((void *)0)
# 162 "../test/ssl_test_ctx_test.c"
   ) return 0;;
    ...
    fixture->expected_ctx->expected_client_alert = 48;
    fixture->expected_ctx->expected_server_alert = 0;
    fixture->expected_ctx->expected_protocol = 0x0302;
    ...
    fixture->expected_ctx->extra.client.npn_protocols =
        CRYPTO_strdup("foo,bar", "../test/ssl_test_ctx_test.c", 183);
    if (!test_ptr("../test/ssl_test_ctx_test.c", 184, "fixture->expected_ctx->extra.client.npn_protocols", fixture->expected_ctx->extra.client.npn_protocols))
        goto err;
    ...
    fixture->expected_ctx->resume_extra.server2.alpn_protocols =
        CRYPTO_strdup("baz", "../test/ssl_test_ctx_test.c", 193);
    if (!test_ptr("../test/ssl_test_ctx_test.c", 194, "fixture->expected_ctx->resume_extra.server2.alpn_protocols", fixture->expected_ctx->resume_extra.server2.alpn_protocols))
        goto err;
    ...
    if (fixture != 
# 200 "../test/ssl_test_ctx_test.c" 3 4
   ((void *)0)
# 200 "../test/ssl_test_ctx_test.c"
   ) { result = execute_test(fixture); tear_down(fixture); };
    return result;
...
static int test_bad_configuration(int idx)
{
    ...
    if (!test_ptr_null("../test/ssl_test_ctx_test.c", 231, "ctx = SSL_TEST_CTX_create(conf, bad_configurations[idx], NULL)", ctx = SSL_TEST_CTX_create(conf, bad_configurations[idx], 
# 231 "../test/ssl_test_ctx_test.c" 3 4
        ((void *)0)
# 231 "../test/ssl_test_ctx_test.c"
        ))
                                                                                ) {
        SSL_TEST_CTX_free(ctx);
        return 0;
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "conf_file\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 240 "../test/ssl_test_ctx_test.c" 3 4
((void *)0) 
# 240 "../test/ssl_test_ctx_test.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/ssl_test_ctx_test.c", 245, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/ssl_test_ctx_test.c", 249, "conf = NCONF_new(NULL)", conf = NCONF_new(
# 249 "../test/ssl_test_ctx_test.c" 3 4
        ((void *)0)
# 249 "../test/ssl_test_ctx_test.c"
        )))
        return 0;

    if (!test_int_gt("../test/ssl_test_ctx_test.c", 252, "NCONF_load(conf, test_get_argument(0), NULL)", "0", NCONF_load(conf, test_get_argument(0), 
# 252 "../test/ssl_test_ctx_test.c" 3 4
        ((void *)0)
# 252 "../test/ssl_test_ctx_test.c"
        ), 0))
        return 0;

    add_test("test_empty_configuration", test_empty_configuration);
    add_test("test_good_configuration", test_good_configuration);
    add_all_tests("test_bad_configuration", test_bad_configuration, (sizeof(bad_configurations)/sizeof((bad_configurations)[0])), 1);
    return 1;
}
