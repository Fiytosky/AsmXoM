# 0 "../test/params_api_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/params_api_test.c"
# 11 "../test/params_api_test.c"
...
# 37 "../test/params_api_test.c"
static void le_copy(unsigned char *out, size_t outlen,
                    const void *in, size_t inlen)
{
    const int ossl_is_little_endian = 1234 == 1234;

    if ((ossl_is_little_endian)) {
        ...
        if (!__builtin_expect(!!((outlen <= inlen) != 0), 1))
            return;
                                 ...
                                 size_t width)
{
    ...
    const int signd = param->data_type == 1;





    param->return_size = ((size_t)-1);
    if (signd) {
        if ((bit32 && !test_true("../test/params_api_test.c", 137, "OSSL_PARAM_get_int32(param, &i32)", (OSSL_PARAM_get_int32(param, &i32)) != 0))
            || !test_true("../test/params_api_test.c", 138, "OSSL_PARAM_get_int64(param, &i64)", (OSSL_PARAM_get_int64(param, &i64)) != 0))
            return 0;
    } else {
        if ((bit32
             && !test_true("../test/params_api_test.c", 142, "OSSL_PARAM_get_uint32(param, (uint32_t *)&i32)", (OSSL_PARAM_get_uint32(param, (uint32_t *)&i32)) != 0))
            || !test_true("../test/params_api_test.c", 143, "OSSL_PARAM_get_uint64(param, (uint64_t *)&i64)", (OSSL_PARAM_get_uint64(param, (uint64_t *)&i64)) != 0)
            || (sizet && !test_true("../test/params_api_test.c", 144, "OSSL_PARAM_get_size_t(param, &s)", (OSSL_PARAM_get_size_t(param, &s)) != 0)))
            return 0;
    }
    if (!test_false("../test/params_api_test.c", 147, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0))
        return 0;
    ...
    if (bit32) {
        ...
        if (!test_mem_eq("../test/params_api_test.c", 154, "buf", "cmp", buf, sz, cmp, sz))
            return 0;
    }
    le_copy(buf, sizeof(i64), &i64, sizeof(i64));
    sz = sizeof(i64) < width ? sizeof(i64) : width;
    if (!test_mem_eq("../test/params_api_test.c", 159, "buf", "cmp", buf, sz, cmp, sz))
        return 0;
    if (sizet && !signd) {
        le_copy(buf, sizeof(s), &s, sizeof(s));
        sz = sizeof(s) < width ? sizeof(s) : width;
        if (!test_mem_eq("../test/params_api_test.c", 164, "buf", "cmp", buf, sz, cmp, sz))
            return 0;
    }
    ...
    if (sizeof(size_t) > width) {
        if (signd) {
            if (!test_true("../test/params_api_test.c", 171, "OSSL_PARAM_set_int32(param, 12345)", (OSSL_PARAM_set_int32(param, 12345)) != 0)
                || !test_true("../test/params_api_test.c", 172, "OSSL_PARAM_get_int64(param, &i64)", (OSSL_PARAM_get_int64(param, &i64)) != 0)
                || !test_size_t_eq("../test/params_api_test.c", 173, "(size_t)i64", "12345", (size_t)i64, 12345))
                return 0;
        } else {
            if (!test_true("../test/params_api_test.c", 176, "OSSL_PARAM_set_uint32(param, 12345)", (OSSL_PARAM_set_uint32(param, 12345)) != 0)
                || !test_true("../test/params_api_test.c", 177, "OSSL_PARAM_get_uint64(param, (uint64_t *)&i64)", (OSSL_PARAM_get_uint64(param, (uint64_t *)&i64)) != 0)
                || !test_size_t_eq("../test/params_api_test.c", 178, "(size_t)i64", "12345", (size_t)i64, 12345))
                return 0;
        }
        if (!test_true("../test/params_api_test.c", 181, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0))
            return 0;
    }
    return 1;
}
# 199 "../test/params_api_test.c"
static int test_param_int(int n)
{
    int in, out;
    unsigned char buf[20], cmp[sizeof(int)];
    const size_t len = raw_values[n].len >= sizeof(int) ?
                       sizeof(int) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (1), ((
# 205 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 205 "../test/params_api_test.c"
                      )), (sizeof(int)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 207, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 214, "OSSL_PARAM_set_int(&param, in)", (OSSL_PARAM_set_int(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 217, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 220, "OSSL_PARAM_get_int(&param, &in)", (OSSL_PARAM_get_int(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 223, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    long int in, out;
    unsigned char buf[20], cmp[sizeof(long int)];
    const size_t len = raw_values[n].len >= sizeof(long int)
                       ? sizeof(long int) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (1), ((
# 235 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 235 "../test/params_api_test.c"
                      )), (sizeof(long int)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 237, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 244, "OSSL_PARAM_set_long(&param, in)", (OSSL_PARAM_set_long(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 247, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 250, "OSSL_PARAM_get_long(&param, &in)", (OSSL_PARAM_get_long(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 253, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    unsigned int in, out;
    unsigned char buf[20], cmp[sizeof(unsigned int)];
    const size_t len = raw_values[n].len >= sizeof(unsigned int) ? sizeof(unsigned int) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (2), ((
# 264 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 264 "../test/params_api_test.c"
                      )), (sizeof(unsigned int)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 266, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 273, "OSSL_PARAM_set_uint(&param, in)", (OSSL_PARAM_set_uint(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 276, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 279, "OSSL_PARAM_get_uint(&param, &in)", (OSSL_PARAM_get_uint(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 282, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
static int test_param_ulong(int n)
{
    ...
    unsigned char buf[20], cmp[sizeof(unsigned long int)];
    const size_t len = raw_values[n].len >= sizeof(unsigned long int)
                       ? sizeof(unsigned long int) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (2), ((
# 294 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 294 "../test/params_api_test.c"
                      )), (sizeof(unsigned long int)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 296, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 303, "OSSL_PARAM_set_ulong(&param, in)", (OSSL_PARAM_set_ulong(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 306, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 309, "OSSL_PARAM_get_ulong(&param, &in)", (OSSL_PARAM_get_ulong(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 312, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    int32_t in, out;
    unsigned char buf[20], cmp[sizeof(int32_t)];
    const size_t len = raw_values[n].len >= sizeof(int32_t)
                       ? sizeof(int32_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (1), ((
# 324 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 324 "../test/params_api_test.c"
                      )), (sizeof(int32_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 326, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 333, "OSSL_PARAM_set_int32(&param, in)", (OSSL_PARAM_set_int32(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 336, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 339, "OSSL_PARAM_get_int32(&param, &in)", (OSSL_PARAM_get_int32(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 342, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    uint32_t in, out;
    unsigned char buf[20], cmp[sizeof(uint32_t)];
    const size_t len = raw_values[n].len >= sizeof(uint32_t)
                       ? sizeof(uint32_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (2), ((
# 354 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 354 "../test/params_api_test.c"
                      )), (sizeof(uint32_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 356, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 363, "OSSL_PARAM_set_uint32(&param, in)", (OSSL_PARAM_set_uint32(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 366, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 369, "OSSL_PARAM_get_uint32(&param, &in)", (OSSL_PARAM_get_uint32(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 372, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    int64_t in, out;
    unsigned char buf[20], cmp[sizeof(int64_t)];
    const size_t len = raw_values[n].len >= sizeof(int64_t)
                       ? sizeof(int64_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (1), ((
# 384 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 384 "../test/params_api_test.c"
                      )), (sizeof(int64_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 386, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 393, "OSSL_PARAM_set_int64(&param, in)", (OSSL_PARAM_set_int64(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 396, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 399, "OSSL_PARAM_get_int64(&param, &in)", (OSSL_PARAM_get_int64(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 402, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    uint64_t in, out;
    unsigned char buf[20], cmp[sizeof(uint64_t)];
    const size_t len = raw_values[n].len >= sizeof(uint64_t)
                       ? sizeof(uint64_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (2), ((
# 414 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 414 "../test/params_api_test.c"
                      )), (sizeof(uint64_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 416, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 423, "OSSL_PARAM_set_uint64(&param, in)", (OSSL_PARAM_set_uint64(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 426, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 429, "OSSL_PARAM_get_uint64(&param, &in)", (OSSL_PARAM_get_uint64(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 432, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    size_t in, out;
    unsigned char buf[20], cmp[sizeof(size_t)];
    const size_t len = raw_values[n].len >= sizeof(size_t)
                       ? sizeof(size_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (2), ((
# 444 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 444 "../test/params_api_test.c"
                      )), (sizeof(size_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 446, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 453, "OSSL_PARAM_set_size_t(&param, in)", (OSSL_PARAM_set_size_t(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 456, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 459, "OSSL_PARAM_get_size_t(&param, &in)", (OSSL_PARAM_get_size_t(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 462, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
...
{
    time_t in, out;
    unsigned char buf[20], cmp[sizeof(time_t)];
    const size_t len = raw_values[n].len >= sizeof(time_t)
                       ? sizeof(time_t) : raw_values[n].len;
    OSSL_PARAM param = { (("a")), (1), ((
# 474 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 474 "../test/params_api_test.c"
                      )), (sizeof(time_t)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 476, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;
    ...
    memcpy(&in, buf, sizeof(in));
    param.data = &out;
    if (!test_true("../test/params_api_test.c", 483, "OSSL_PARAM_set_time_t(&param, in)", (OSSL_PARAM_set_time_t(&param, in)) != 0))
        return 0;
    le_copy(cmp, sizeof(out), &out, sizeof(out));
    if (!test_mem_eq("../test/params_api_test.c", 486, "cmp", "raw_values[n].value", cmp, len, raw_values[n].value, len))
        return 0;
    in = 0;
    if (!test_true("../test/params_api_test.c", 489, "OSSL_PARAM_get_time_t(&param, &in)", (OSSL_PARAM_get_time_t(&param, &in)) != 0))
        return 0;
    le_copy(cmp, sizeof(in), &in, sizeof(in));
    if (!test_mem_eq("../test/params_api_test.c", 492, "cmp", "raw_values[n].value", cmp, sizeof(in), raw_values[n].value, sizeof(in)))
        return 0;
    param.data = &out;
    return test_param_type_extra(&param, raw_values[n].value, sizeof(size_t));
}
...
{
    unsigned char buf[20], bnbuf[20];
    const size_t len = raw_values[n].len;
    BIGNUM *b = 
# 502 "../test/params_api_test.c" 3 4
               ((void *)0)
# 502 "../test/params_api_test.c"
                   , *c = 
# 502 "../test/params_api_test.c" 3 4
                          ((void *)0)
# 502 "../test/params_api_test.c"
                              ;
    OSSL_PARAM param = { ("bn"), (2), (
# 503 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 503 "../test/params_api_test.c"
                      ), (0), ((size_t)-1) }
                                               ;
    int ret = 0;

    if (!test_int_eq("../test/params_api_test.c", 507, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;

    param.data = bnbuf;
    param.data_size = sizeof(bnbuf);

    if (!test_ptr("../test/params_api_test.c", 513, "b = BN_lebin2bn(raw_values[n].value, (int)len, NULL)", b = BN_lebin2bn(raw_values[n].value, (int)len, 
# 513 "../test/params_api_test.c" 3 4
        ((void *)0)
# 513 "../test/params_api_test.c"
        )))
        goto err;

    if (!test_true("../test/params_api_test.c", 516, "OSSL_PARAM_set_BN(&param, b)", (OSSL_PARAM_set_BN(&param, b)) != 0))
        goto err;
    le_copy(buf, len, bnbuf, sizeof(bnbuf));
    if (!test_mem_eq("../test/params_api_test.c", 519, "raw_values[n].value", "buf", raw_values[n].value, len, buf, len))
        goto err;
    param.data_size = param.return_size;
    if (!test_true("../test/params_api_test.c", 522, "OSSL_PARAM_get_BN(&param, &c)", (OSSL_PARAM_get_BN(&param, &c)) != 0)
        || !test_BN_eq("../test/params_api_test.c", 523, "b", "c", b, c))
        goto err;
...
static int test_param_signed_bignum(int n)
{
    ...
    const size_t len = raw_values[n].len;
    BIGNUM *b = 
# 537 "../test/params_api_test.c" 3 4
               ((void *)0)
# 537 "../test/params_api_test.c"
                   , *c = 
# 537 "../test/params_api_test.c" 3 4
                          ((void *)0)
# 537 "../test/params_api_test.c"
                              ;
    OSSL_PARAM param = { ("bn"), (1), (
# 538 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 538 "../test/params_api_test.c"
                      ), (0), ((size_t)-1) };
    int ret = 0;

    if (!test_int_eq("../test/params_api_test.c", 541, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;

    param.data = bnbuf;
    param.data_size = sizeof(bnbuf);

    if (!test_ptr("../test/params_api_test.c", 547, "b = BN_signed_lebin2bn(raw_values[n].value, (int)len, NULL)", b = BN_signed_lebin2bn(raw_values[n].value, (int)len, 
# 547 "../test/params_api_test.c" 3 4
        ((void *)0)
# 547 "../test/params_api_test.c"
        )))
        goto err;


    if (!test_false("../test/params_api_test.c", 551, "!!(raw_values[n].value[len - 1] & 0x80) ^ BN_is_negative(b)", (!!(raw_values[n].value[len - 1] & 0x80) ^ BN_is_negative(b)) != 0))
        goto err;
    if (!test_true("../test/params_api_test.c", 553, "OSSL_PARAM_set_BN(&param, b)", (OSSL_PARAM_set_BN(&param, b)) != 0))
        goto err;
    le_copy(buf, len, bnbuf, sizeof(bnbuf));
    if (!test_mem_eq("../test/params_api_test.c", 556, "raw_values[n].value", "buf", raw_values[n].value, len, buf, len))
        goto err;
    param.data_size = param.return_size;
    if (!test_true("../test/params_api_test.c", 559, "OSSL_PARAM_get_BN(&param, &c)", (OSSL_PARAM_get_BN(&param, &c)) != 0)
        || !test_BN_eq("../test/params_api_test.c", 560, "b", "c", b, c)) {
        BN_print_fp(
# 561 "../test/params_api_test.c" 3 4
                   stderr
# 561 "../test/params_api_test.c"
                         , c);
        goto err;
    }
...
{
    double p;
    OSSL_PARAM param = { (("r")), (3), ((
# 575 "../test/params_api_test.c" 3 4
                      ((void *)0)
# 575 "../test/params_api_test.c"
                      )), (sizeof(double)), ((size_t)-1) };

    if (!test_int_eq("../test/params_api_test.c", 577, "test_param_type_null(&param)", "1", test_param_type_null(&param), 1))
        return 0;

    param.data = &p;
    return test_true("../test/params_api_test.c", 581, "OSSL_PARAM_set_double(&param, 3.14159)", (OSSL_PARAM_set_double(&param, 3.14159)) != 0)
           && test_double_eq("../test/params_api_test.c", 582, "p", "3.14159", p, 3.14159);
}
...
static int test_param_construct(int tstid)
{
    ...
    OSSL_PARAM *p = 
# 597 "../test/params_api_test.c" 3 4
                   ((void *)0)
# 597 "../test/params_api_test.c"
                       , *p1 = 
# 597 "../test/params_api_test.c" 3 4
                               ((void *)0)
# 597 "../test/params_api_test.c"
    ...
    static const OSSL_PARAM params_empty[] = {
        { 
# 599 "../test/params_api_test.c" 3 4
       ((void *)0)
# 599 "../test/params_api_test.c"
       , 0, 
# 599 "../test/params_api_test.c" 3 4
       ((void *)0)
# 599 "../test/params_api_test.c"
    ...
    void *vp, *vpn = 
# 604 "../test/params_api_test.c" 3 4
                    ((void *)0)
# 604 "../test/params_api_test.c"
                        , *vp2;
    OSSL_PARAM *cp;
    int i, n = 0, ret = 0;
    unsigned int u;
    ...
    double d, d2;
    BIGNUM *bn = 
# 616 "../test/params_api_test.c" 3 4
                ((void *)0)
# 616 "../test/params_api_test.c"
                    , *bn2 = 
# 616 "../test/params_api_test.c" 3 4
                             ((void *)0)
# 616 "../test/params_api_test.c"
    ...
    if (!test_ptr_null("../test/params_api_test.c", 652, "OSSL_PARAM_locate(p, \"fnord\")", OSSL_PARAM_locate(p, "fnord")))
        goto err;


    for (j = 0; j < (sizeof(int_names)/sizeof((int_names)[0])); j++) {
        if (!test_ptr("../test/params_api_test.c", 657, "cp = OSSL_PARAM_locate(p, int_names[j])", cp = OSSL_PARAM_locate(p, int_names[j]))
            || !test_true("../test/params_api_test.c", 658, "OSSL_PARAM_set_int32(cp, (int32_t)(3 + j))", (OSSL_PARAM_set_int32(cp, (int32_t)(3 + j))) != 0)
            || !test_true("../test/params_api_test.c", 659, "OSSL_PARAM_get_int64(cp, &i64)", (OSSL_PARAM_get_int64(cp, &i64)) != 0)
            || !test_size_t_eq("../test/params_api_test.c", 660, "cp->data_size", "cp->return_size", cp->data_size, cp->return_size)
            || !test_size_t_eq("../test/params_api_test.c", 661, "(size_t)i64", "3 + j", (size_t)i64, 3 + j)) {
            test_note("iteration %zu var %s", j + 1, int_names[j]);
            goto err;
        }
    }

    for (j = 0; j < (sizeof(uint_names)/sizeof((uint_names)[0])); j++) {
        if (!test_ptr("../test/params_api_test.c", 668, "cp = OSSL_PARAM_locate(p, uint_names[j])", cp = OSSL_PARAM_locate(p, uint_names[j]))
            || !test_true("../test/params_api_test.c", 669, "OSSL_PARAM_set_uint32(cp, (uint32_t)(3 + j))", (OSSL_PARAM_set_uint32(cp, (uint32_t)(3 + j))) != 0)
            || !test_true("../test/params_api_test.c", 670, "OSSL_PARAM_get_uint64(cp, &u64)", (OSSL_PARAM_get_uint64(cp, &u64)) != 0)
            || !test_size_t_eq("../test/params_api_test.c", 671, "cp->data_size", "cp->return_size", cp->data_size, cp->return_size)
            || !test_size_t_eq("../test/params_api_test.c", 672, "(size_t)u64", "3 + j", (size_t)u64, 3 + j)) {
            test_note("iteration %zu var %s", j + 1, uint_names[j]);
            goto err;
        }
    }

    if (!test_ptr("../test/params_api_test.c", 678, "cp = OSSL_PARAM_locate(p, \"double\")", cp = OSSL_PARAM_locate(p, "double"))
        || !test_true("../test/params_api_test.c", 679, "OSSL_PARAM_set_double(cp, 3.14)", (OSSL_PARAM_set_double(cp, 3.14)) != 0)
        || !test_true("../test/params_api_test.c", 680, "OSSL_PARAM_get_double(cp, &d2)", (OSSL_PARAM_get_double(cp, &d2)) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 681, "cp->return_size", "sizeof(double)", cp->return_size, sizeof(double))
        || !test_double_eq("../test/params_api_test.c", 682, "d2", "3.14", d2, 3.14)
        || (tstid <= 1 && !test_double_eq("../test/params_api_test.c", 683, "d", "d2", d, d2)))
        goto err;

    bufp = 
# 686 "../test/params_api_test.c" 3 4
          ((void *)0)
# 686 "../test/params_api_test.c"
              ;
    if (!test_ptr("../test/params_api_test.c", 687, "cp = OSSL_PARAM_locate(p, \"utf8str\")", cp = OSSL_PARAM_locate(p, "utf8str"))
        || !test_true("../test/params_api_test.c", 688, "OSSL_PARAM_set_utf8_string(cp, \"abcdef\")", (OSSL_PARAM_set_utf8_string(cp, "abcdef")) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 689, "cp->return_size", "sizeof(\"abcdef\") - 1", cp->return_size, sizeof("abcdef") - 1)
        || !test_true("../test/params_api_test.c", 690, "OSSL_PARAM_get_utf8_string(cp, &bufp, 0)", (OSSL_PARAM_get_utf8_string(cp, &bufp, 0)) != 0)
        || !test_str_eq("../test/params_api_test.c", 691, "bufp", "\"abcdef\"", bufp, "abcdef")) {
        CRYPTO_free(bufp, "../test/params_api_test.c", 692);
        goto err;
    }
    CRYPTO_free(bufp, "../test/params_api_test.c", 695);
    bufp = buf2;
    if (!test_true("../test/params_api_test.c", 697, "OSSL_PARAM_get_utf8_string(cp, &bufp, sizeof(buf2))", (OSSL_PARAM_get_utf8_string(cp, &bufp, sizeof(buf2))) != 0)
        || !test_str_eq("../test/params_api_test.c", 698, "buf2", "\"abcdef\"", buf2, "abcdef"))
        goto err;


    bufp = buf;
    if (!test_ptr("../test/params_api_test.c", 703, "cp = OSSL_PARAM_locate(p, \"utf8ptr\")", cp = OSSL_PARAM_locate(p, "utf8ptr"))
        || !test_true("../test/params_api_test.c", 704, "OSSL_PARAM_set_utf8_ptr(cp, \"tuvwxyz\")", (OSSL_PARAM_set_utf8_ptr(cp, "tuvwxyz")) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 705, "cp->return_size", "sizeof(\"tuvwxyz\") - 1", cp->return_size, sizeof("tuvwxyz") - 1)
        || !test_true("../test/params_api_test.c", 706, "OSSL_PARAM_get_utf8_ptr(cp, (const char **)&bufp2)", (OSSL_PARAM_get_utf8_ptr(cp, (const char **)&bufp2)) != 0)
        || !test_str_eq("../test/params_api_test.c", 707, "bufp2", "\"tuvwxyz\"", bufp2, "tuvwxyz")
        || (tstid <= 1 && !test_ptr_eq("../test/params_api_test.c", 708, "bufp2", "bufp", bufp2, bufp)))
        goto err;

    if (!test_ptr("../test/params_api_test.c", 711, "cp = OSSL_PARAM_locate(p, \"octstr\")", cp = OSSL_PARAM_locate(p, "octstr"))
        || !test_true("../test/params_api_test.c", 712, "OSSL_PARAM_set_octet_string(cp, \"abcdefghi\", sizeof(\"abcdefghi\"))", (OSSL_PARAM_set_octet_string(cp, "abcdefghi", sizeof("abcdefghi"))) != 0)

        || !test_size_t_eq("../test/params_api_test.c", 714, "cp->return_size", "sizeof(\"abcdefghi\")", cp->return_size, sizeof("abcdefghi")))
        goto err;

    cp->data_size = cp->return_size;
    if (!test_true("../test/params_api_test.c", 718, "OSSL_PARAM_get_octet_string(cp, &vpn, 0, &s)", (OSSL_PARAM_get_octet_string(cp, &vpn, 0, &s)) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 719, "s", "sizeof(\"abcdefghi\")", s, sizeof("abcdefghi"))
        || !test_mem_eq("../test/params_api_test.c", 720, "vpn", "\"abcdefghi\"", vpn, sizeof("abcdefghi"), "abcdefghi", sizeof("abcdefghi"))
                                                         )
        goto err;
    vp = buf2;
    if (!test_true("../test/params_api_test.c", 724, "OSSL_PARAM_get_octet_string(cp, &vp, sizeof(buf2), &s)", (OSSL_PARAM_get_octet_string(cp, &vp, sizeof(buf2), &s)) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 725, "s", "sizeof(\"abcdefghi\")", s, sizeof("abcdefghi"))
        || !test_mem_eq("../test/params_api_test.c", 726, "vp", "\"abcdefghi\"", vp, sizeof("abcdefghi"), "abcdefghi", sizeof("abcdefghi"))
                                                         )
        goto err;

    vp = &l;
    if (!test_ptr("../test/params_api_test.c", 731, "cp = OSSL_PARAM_locate(p, \"octptr\")", cp = OSSL_PARAM_locate(p, "octptr"))
        || !test_true("../test/params_api_test.c", 732, "OSSL_PARAM_set_octet_ptr(cp, &ul, sizeof(ul))", (OSSL_PARAM_set_octet_ptr(cp, &ul, sizeof(ul))) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 733, "cp->return_size", "sizeof(ul)", cp->return_size, sizeof(ul))
        || (tstid <= 1 && !test_ptr_eq("../test/params_api_test.c", 734, "vp", "&ul", vp, &ul)))
        goto err;

    cp->data_size = cp->return_size;
    if (!test_true("../test/params_api_test.c", 738, "OSSL_PARAM_get_octet_ptr(cp, (const void **)&vp2, &k)", (OSSL_PARAM_get_octet_ptr(cp, (const void **)&vp2, &k)) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 739, "k", "sizeof(ul)", k, sizeof(ul))
        || (tstid <= 1 && !test_ptr_eq("../test/params_api_test.c", 740, "vp2", "vp", vp2, vp)))
        goto err;

    if (!test_ptr("../test/params_api_test.c", 743, "cp = OSSL_PARAM_locate(p, \"bignum\")", cp = OSSL_PARAM_locate(p, "bignum"))
        || !test_ptr("../test/params_api_test.c", 744, "bn = BN_lebin2bn(bn_val, (int)sizeof(bn_val), NULL)", bn = BN_lebin2bn(bn_val, (int)sizeof(bn_val), 
# 744 "../test/params_api_test.c" 3 4
           ((void *)0)
# 744 "../test/params_api_test.c"
           ))
        || !test_true("../test/params_api_test.c", 745, "OSSL_PARAM_set_BN(cp, bn)", (OSSL_PARAM_set_BN(cp, bn)) != 0)
        || !test_size_t_eq("../test/params_api_test.c", 746, "cp->data_size", "cp->return_size", cp->data_size, cp->return_size))
        goto err;

    cp->data_size = cp->return_size;
    if (!test_true("../test/params_api_test.c", 750, "OSSL_PARAM_get_BN(cp, &bn2)", (OSSL_PARAM_get_BN(cp, &bn2)) != 0)
        || !test_BN_eq("../test/params_api_test.c", 751, "bn", "bn2", bn, bn2))
        goto err;
    ret = 1;
err:
    if (p != params)
        CRYPTO_free(p, "../test/params_api_test.c", 756);
    CRYPTO_free(p1, "../test/params_api_test.c", 757);
    CRYPTO_free(vpn, "../test/params_api_test.c", 758);
    BN_free(bn);
    BN_free(bn2);
    return ret;
}
...
{
    OSSL_PARAM param[3] = { { (("a")), (1), ((
# 766 "../test/params_api_test.c" 3 4
                           ((void *)0)
# 766 "../test/params_api_test.c"
                           )), (sizeof(int)), ((size_t)-1) },
                            { (("b")), (1), ((
# 767 "../test/params_api_test.c" 3 4
                           ((void *)0)
# 767 "../test/params_api_test.c"
                           )), (sizeof(int)), ((size_t)-1) },
                            { 
# 768 "../test/params_api_test.c" 3 4
                           ((void *)0)
# 768 "../test/params_api_test.c"
                           , 0, 
# 768 "../test/params_api_test.c" 3 4
                           ((void *)0)
# 768 "../test/params_api_test.c"
    ...
    param->data = &a;
    param[1].data = &b;
    if (!test_false("../test/params_api_test.c", 773, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0)
            && !test_true("../test/params_api_test.c", 774, "OSSL_PARAM_set_int32(param, 1234)", (OSSL_PARAM_set_int32(param, 1234)) != 0)
            && !test_true("../test/params_api_test.c", 775, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0)
            && !test_false("../test/params_api_test.c", 776, "OSSL_PARAM_modified(param + 1)", (OSSL_PARAM_modified(param + 1)) != 0)
            && !test_true("../test/params_api_test.c", 777, "OSSL_PARAM_set_int32(param + 1, 1)", (OSSL_PARAM_set_int32(param + 1, 1)) != 0)
            && !test_true("../test/params_api_test.c", 778, "OSSL_PARAM_modified(param + 1)", (OSSL_PARAM_modified(param + 1)) != 0))
        return 0;
    OSSL_PARAM_set_all_unmodified(param);
    if (!test_false("../test/params_api_test.c", 781, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0)
            && !test_true("../test/params_api_test.c", 782, "OSSL_PARAM_set_int32(param, 4321)", (OSSL_PARAM_set_int32(param, 4321)) != 0)
            && !test_true("../test/params_api_test.c", 783, "OSSL_PARAM_modified(param)", (OSSL_PARAM_modified(param)) != 0)
            && !test_false("../test/params_api_test.c", 784, "OSSL_PARAM_modified(param + 1)", (OSSL_PARAM_modified(param + 1)) != 0)
            && !test_true("../test/params_api_test.c", 785, "OSSL_PARAM_set_int32(param + 1, 2)", (OSSL_PARAM_set_int32(param + 1, 2)) != 0)
            && !test_true("../test/params_api_test.c", 786, "OSSL_PARAM_modified(param + 1)", (OSSL_PARAM_modified(param + 1)) != 0))
        return 0;
    return 1;
}
...
static int test_param_copy_null(void)
{
    ...
    int a = 1, b = 2, i = 0;
    OSSL_PARAM *cp1 = 
# 795 "../test/params_api_test.c" 3 4
                     ((void *)0)
# 795 "../test/params_api_test.c"
                         , *cp2 = 
# 795 "../test/params_api_test.c" 3 4
                                  ((void *)0)
# 795 "../test/params_api_test.c"
    ...
    ret = test_ptr_null("../test/params_api_test.c", 802, "OSSL_PARAM_dup(NULL)", OSSL_PARAM_dup(
# 802 "../test/params_api_test.c" 3 4
         ((void *)0)
# 802 "../test/params_api_test.c"
         ))
          && test_ptr("../test/params_api_test.c", 803, "cp1 = OSSL_PARAM_merge(NULL, param)", cp1 = OSSL_PARAM_merge(
# 803 "../test/params_api_test.c" 3 4
            ((void *)0)
# 803 "../test/params_api_test.c"
            , param))
          && test_ptr("../test/params_api_test.c", 804, "p = OSSL_PARAM_locate(cp1, \"a\")", p = OSSL_PARAM_locate(cp1, "a"))
          && test_true("../test/params_api_test.c", 805, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
          && test_int_eq("../test/params_api_test.c", 806, "val", "1", val, 1)
          && test_ptr("../test/params_api_test.c", 807, "p = OSSL_PARAM_locate(cp1, \"b\")", p = OSSL_PARAM_locate(cp1, "b"))
          && test_true("../test/params_api_test.c", 808, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
          && test_int_eq("../test/params_api_test.c", 809, "val", "2", val, 2)
          && test_ptr("../test/params_api_test.c", 810, "cp2 = OSSL_PARAM_merge(param, NULL)", cp2 = OSSL_PARAM_merge(param, 
# 810 "../test/params_api_test.c" 3 4
            ((void *)0)
# 810 "../test/params_api_test.c"
            ))
          && test_ptr("../test/params_api_test.c", 811, "p = OSSL_PARAM_locate(cp2, \"a\")", p = OSSL_PARAM_locate(cp2, "a"))
          && test_true("../test/params_api_test.c", 812, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
          && test_int_eq("../test/params_api_test.c", 813, "val", "1", val, 1)
          && test_ptr("../test/params_api_test.c", 814, "p = OSSL_PARAM_locate(cp2, \"b\")", p = OSSL_PARAM_locate(cp2, "b"))
          && test_true("../test/params_api_test.c", 815, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
          && test_int_eq("../test/params_api_test.c", 816, "val", "2", val, 2)
          && test_ptr_null("../test/params_api_test.c", 817, "OSSL_PARAM_merge(NULL, NULL)", OSSL_PARAM_merge(
# 817 "../test/params_api_test.c" 3 4
            ((void *)0)
# 817 "../test/params_api_test.c"
            , 
# 817 "../test/params_api_test.c" 3 4
            ((void *)0)
# 817 "../test/params_api_test.c"
...
static int test_param_merge(void)
{
    ...
    int values[] = {1, 2, 3, 4};
    OSSL_PARAM *p = 
# 826 "../test/params_api_test.c" 3 4
                   ((void *)0)
# 826 "../test/params_api_test.c"
                       , *cp = 
# 826 "../test/params_api_test.c" 3 4
                               ((void *)0)
# 826 "../test/params_api_test.c"
    ...
    ret = test_ptr("../test/params_api_test.c", 836, "p = OSSL_PARAM_merge(param, param1)", p = OSSL_PARAM_merge(param, param1))
        && test_ptr("../test/params_api_test.c", 837, "cp = OSSL_PARAM_locate(p, \"diff1\")", cp = OSSL_PARAM_locate(p, "diff1"))
        && test_true("../test/params_api_test.c", 838, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
        && test_int_eq("../test/params_api_test.c", 839, "val", "values[0]", val, values[0])
        && test_ptr("../test/params_api_test.c", 840, "cp = OSSL_PARAM_locate(p, \"diff2\")", cp = OSSL_PARAM_locate(p, "diff2"))
        && test_true("../test/params_api_test.c", 841, "OSSL_PARAM_get_int(cp, &val)", (OSSL_PARAM_get_int(cp, &val)) != 0)
        && test_int_eq("../test/params_api_test.c", 842, "val", "values[2]", val, values[2])
        && test_ptr("../test/params_api_test.c", 843, "cp = OSSL_PARAM_locate(p, \"same\")", cp = OSSL_PARAM_locate(p, "same"))
        && test_true("../test/params_api_test.c", 844, "OSSL_PARAM_get_int(cp, &val)", (OSSL_PARAM_get_int(cp, &val)) != 0)
        && test_int_eq("../test/params_api_test.c", 845, "val", "values[3]", val, values[3]);
    OSSL_PARAM_free(p);
    return ret;
}
...
int setup_tests(void)
{
    add_all_tests("test_param_int", test_param_int, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_long", test_param_long, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_uint", test_param_uint, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_ulong", test_param_ulong, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_int32", test_param_int32, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_uint32", test_param_uint32, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_size_t", test_param_size_t, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_time_t", test_param_time_t, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_int64", test_param_int64, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_uint64", test_param_uint64, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_bignum", test_param_bignum, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    add_all_tests("test_param_signed_bignum", test_param_signed_bignum, (sizeof(raw_values)/sizeof((raw_values)[0])), 1);
    ...
    add_test("test_param_copy_null", test_param_copy_null);
    add_test("test_param_merge", test_param_merge);
    return 1;
}
