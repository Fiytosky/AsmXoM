...
static void tear_down(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    CRYPTO_free(fixture, "../test/cmp_hdr_test.c", 28);
}
...
static CMP_HDR_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 35, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_hdr_test.c", 35)))
        return 
# 36 "../test/cmp_hdr_test.c" 3 4
              ((void *)0)
# 36 "../test/cmp_hdr_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/cmp_hdr_test.c", 38, "fixture->cmp_ctx = OSSL_CMP_CTX_new(NULL, NULL)", fixture->cmp_ctx = OSSL_CMP_CTX_new(
# 38 "../test/cmp_hdr_test.c" 3 4
        ((void *)0)
# 38 "../test/cmp_hdr_test.c"
        , 
# 38 "../test/cmp_hdr_test.c" 3 4
        ((void *)0)
# 38 "../test/cmp_hdr_test.c"
        ...
        goto err;
    if (!test_ptr("../test/cmp_hdr_test.c", 40, "fixture->hdr = OSSL_CMP_PKIHEADER_new()", fixture->hdr = OSSL_CMP_PKIHEADER_new()))
        goto err;
    return fixture;
 ...
 err:
    tear_down(fixture);
    return 
# 46 "../test/cmp_hdr_test.c" 3 4
          ((void *)0)
# 46 "../test/cmp_hdr_test.c"
              ;
}
...
static int execute_HDR_set_get_pvno_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_int_eq("../test/cmp_hdr_test.c", 53, "ossl_cmp_hdr_set_pvno(fixture->hdr, pvno)", "1", ossl_cmp_hdr_set_pvno(fixture->hdr, pvno), 1))
        return 0;
    if (!test_int_eq("../test/cmp_hdr_test.c", 55, "ossl_cmp_hdr_get_pvno(fixture->hdr)", "pvno", ossl_cmp_hdr_get_pvno(fixture->hdr), pvno))
        return 0;
    return 1;
}
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 62 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 62 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 64 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 64 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_set_get_pvno_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_get0_senderNonce_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 78, "sender", sender))
        goto err;

    X509_NAME_add_entry_by_txt((sender), ("CN"), (0x1000|1), (unsigned char *)("A common sender name"), -1, -1, 0);
    if (!test_int_eq("../test/cmp_hdr_test.c", 82, "OSSL_CMP_CTX_set1_subjectName(fixture->cmp_ctx, sender)", "1", OSSL_CMP_CTX_set1_subjectName(fixture->cmp_ctx, sender), 1)
                       )
        goto err;
    if (!test_int_eq("../test/cmp_hdr_test.c", 85, "ossl_cmp_hdr_init(fixture->cmp_ctx, fixture->hdr)", "1", ossl_cmp_hdr_init(fixture->cmp_ctx, fixture->hdr), 1)
                       )
        goto err;
    sn = ossl_cmp_hdr_get0_senderNonce(fixture->hdr);
    if (!test_int_eq("../test/cmp_hdr_test.c", 89, "ASN1_OCTET_STRING_cmp(fixture->cmp_ctx->senderNonce, sn)", "0", ASN1_OCTET_STRING_cmp(fixture->cmp_ctx->senderNonce, sn), 0)
                       )
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 102 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 102 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 104 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 104 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_get0_senderNonce_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_set1_sender_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 113, "x509name", x509name))
        goto err;

    X509_NAME_add_entry_by_txt((x509name), ("CN"), (0x1000|1), (unsigned char *)("A common sender name"), -1, -1, 0);
    if (!test_int_eq("../test/cmp_hdr_test.c", 117, "ossl_cmp_hdr_set1_sender(fixture->hdr, x509name)", "1", ossl_cmp_hdr_set1_sender(fixture->hdr, x509name), 1))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 120, "fixture->hdr->sender->type", "GEN_DIRNAME", fixture->hdr->sender->type, 4))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 123, "X509_NAME_cmp(fixture->hdr->sender->d.directoryName, x509name)", "0", X509_NAME_cmp(fixture->hdr->sender->d.directoryName, x509name), 0)
                                                )
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 136 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 136 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 138 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 138 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_set1_sender_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_set1_recipient_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 147, "x509name", x509name))
        goto err;

    X509_NAME_add_entry_by_txt((x509name), ("CN"), (0x1000|1), (unsigned char *)("A common recipient name"), -1, -1, 0);
    if (!test_int_eq("../test/cmp_hdr_test.c", 151, "ossl_cmp_hdr_set1_recipient(fixture->hdr, x509name)", "1", ossl_cmp_hdr_set1_recipient(fixture->hdr, x509name), 1))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 154, "fixture->hdr->recipient->type", "GEN_DIRNAME", fixture->hdr->recipient->type, 4))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 157, "X509_NAME_cmp(fixture->hdr->recipient->d.directoryName, x509name)", "0", X509_NAME_cmp(fixture->hdr->recipient->d.directoryName, x509name), 0)
                                                )
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 170 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 170 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 172 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 172 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_set1_recipient_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_update_messageTime_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    now = time(
# 181 "../test/cmp_hdr_test.c" 3 4
              ((void *)0)
# 181 "../test/cmp_hdr_test.c"
                  );
    ...
    if (!test_true("../test/cmp_hdr_test.c", 190, "ossl_cmp_hdr_update_messageTime(fixture->hdr)", (ossl_cmp_hdr_update_messageTime(fixture->hdr)) != 0))
        return 0;
    if (!test_true("../test/cmp_hdr_test.c", 192, "ASN1_TIME_to_tm(fixture->hdr->messageTime, &hdrtm)", (ASN1_TIME_to_tm(fixture->hdr->messageTime, &hdrtm)) != 0))
        return 0;

    hdrtime = mktime(&hdrtm);

    if (!test_time_t_le("../test/cmp_hdr_test.c", 197, "before", "hdrtime", before, hdrtime))
        return 0;
    now = time(
# 199 "../test/cmp_hdr_test.c" 3 4
              ((void *)0)
# 199 "../test/cmp_hdr_test.c"
                  );
    tmptm = *gmtime(&now);
    after = mktime(&tmptm);

    return test_time_t_le("../test/cmp_hdr_test.c", 203, "hdrtime", "after", hdrtime, after);
}

static int test_HDR_update_messageTime(void)
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 208 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 208 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 210 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 210 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_update_messageTime_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_set1_senderKID_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 219, "senderKID", senderKID))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 222, "ASN1_OCTET_STRING_set(senderKID, rand_data, sizeof(rand_data))", "1", ASN1_OCTET_STRING_set(senderKID, rand_data, sizeof(rand_data)), 1)
                                                                 )
        goto err;
    if (!test_int_eq("../test/cmp_hdr_test.c", 225, "ossl_cmp_hdr_set1_senderKID(fixture->hdr, senderKID)", "1", ossl_cmp_hdr_set1_senderKID(fixture->hdr, senderKID), 1))
        goto err;
    if (!test_int_eq("../test/cmp_hdr_test.c", 227, "ASN1_OCTET_STRING_cmp(fixture->hdr->senderKID, senderKID)", "0", ASN1_OCTET_STRING_cmp(fixture->hdr->senderKID, senderKID), 0)
                                                         )
        goto err;
    res = 1;
 err:
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 238 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 238 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 240 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 240 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_set1_senderKID_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_push0_freeText_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 248, "text", text))
        return 0;

    if (!ASN1_STRING_set(text, "A free text", -1))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 254, "ossl_cmp_hdr_push0_freeText(fixture->hdr, text)", "1", ossl_cmp_hdr_push0_freeText(fixture->hdr, text), 1))
        goto err;

    if (!test_true("../test/cmp_hdr_test.c", 257, "text == sk_ASN1_UTF8STRING_value(fixture->hdr->freeText, 0)", (text == ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(fixture->hdr->freeText), (0)))) != 0))
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 269 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 269 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 271 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 271 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_push0_freeText_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_push1_freeText_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 281, "text", text))
        goto err;

    if (!ASN1_STRING_set(text, "A free text", -1))
        goto err;

    if (!test_int_eq("../test/cmp_hdr_test.c", 287, "ossl_cmp_hdr_push1_freeText(fixture->hdr, text)", "1", ossl_cmp_hdr_push1_freeText(fixture->hdr, text), 1))
        goto err;

    pushed_text = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(fixture->hdr->freeText), (0)));
    if (!test_int_eq("../test/cmp_hdr_test.c", 291, "ASN1_STRING_cmp(text, pushed_text)", "0", ASN1_STRING_cmp(text, pushed_text), 0))
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 303 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 303 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 305 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 305 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_push1_freeText_test(fixture); tear_down(fixture); };
    return result;
}
...
execute_HDR_generalInfo_push0_item_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 314, "itav", itav))
        return 0;

    if (!test_int_eq("../test/cmp_hdr_test.c", 317, "ossl_cmp_hdr_generalInfo_push0_item(fixture->hdr, itav)", "1", ossl_cmp_hdr_generalInfo_push0_item(fixture->hdr, itav), 1)
                       )
        return 0;

    if (!test_true("../test/cmp_hdr_test.c", 321, "itav == sk_OSSL_CMP_ITAV_value(fixture->hdr->generalInfo, 0)", (itav == ((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(fixture->hdr->generalInfo), (0)))) != 0)
                                                     )
        return 0;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 330 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 330 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 332 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 332 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_generalInfo_push0_item_test(fixture); tear_down(fixture); };
    return result;
}
...
# 342 "../test/cmp_hdr_test.c" 3 4
                                    ((void *)0)
# 342 "../test/cmp_hdr_test.c"
                                        , *ginfo;
    ...
    if (!test_ptr("../test/cmp_hdr_test.c", 348, "asn1int", asn1int))
        return 0;

    if (!test_ptr("../test/cmp_hdr_test.c", 351, "val", val)
            || !test_true("../test/cmp_hdr_test.c", 352, "ASN1_INTEGER_set(asn1int, 88)", (ASN1_INTEGER_set(asn1int, 88)) != 0)) {
        ASN1_INTEGER_free(asn1int);
        return 0;
    }

    ASN1_TYPE_set(val, 2, asn1int);
    if (!test_ptr("../test/cmp_hdr_test.c", 358, "itav = OSSL_CMP_ITAV_create(OBJ_txt2obj(oid, 1), val)", itav = OSSL_CMP_ITAV_create(OBJ_txt2obj(oid, 1), val))) {
        ASN1_TYPE_free(val);
        return 0;
    }
    if (!test_true("../test/cmp_hdr_test.c", 362, "OSSL_CMP_ITAV_push0_stack_item(&itavs, itav)", (OSSL_CMP_ITAV_push0_stack_item(&itavs, itav)) != 0)) {
        OSSL_CMP_ITAV_free(itav);
        return 0;
    }

    if (!test_int_eq("../test/cmp_hdr_test.c", 367, "ossl_cmp_hdr_generalInfo_push1_items(fixture->hdr, itavs)", "1", ossl_cmp_hdr_generalInfo_push1_items(fixture->hdr, itavs), 1)
                       )
        goto err;
    ginfo = fixture->hdr->generalInfo;
    pushed_itav = ((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(ginfo), (0)));
    OBJ_obj2txt(buf, sizeof(buf), OSSL_CMP_ITAV_get0_type(pushed_itav), 0);
    if (!test_int_eq("../test/cmp_hdr_test.c", 373, "memcmp(oid, buf, sizeof(oid))", "0", memcmp(oid, buf, sizeof(oid)), 0))
        goto err;

    pushed_val = OSSL_CMP_ITAV_get0_value(((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(ginfo), (0))));
    if (!test_int_eq("../test/cmp_hdr_test.c", 377, "ASN1_TYPE_cmp(itav->infoValue.other, pushed_val)", "0", ASN1_TYPE_cmp(itav->infoValue.other, pushed_val), 0))
        goto err;
...
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 389 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 389 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 391 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 391 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_generalInfo_push1_items_test(fixture); tear_down(fixture); };
    return result;
}
...
execute_HDR_set_and_check_implicitConfirm_test(CMP_HDR_TEST_FIXTURE
                                               * fixture)
{
    return test_false("../test/cmp_hdr_test.c", 399, "ossl_cmp_hdr_has_implicitConfirm(fixture->hdr)", (ossl_cmp_hdr_has_implicitConfirm(fixture->hdr)) != 0)
        && test_true("../test/cmp_hdr_test.c", 400, "ossl_cmp_hdr_set_implicitConfirm(fixture->hdr)", (ossl_cmp_hdr_set_implicitConfirm(fixture->hdr)) != 0)
        && test_true("../test/cmp_hdr_test.c", 401, "ossl_cmp_hdr_has_implicitConfirm(fixture->hdr)", (ossl_cmp_hdr_has_implicitConfirm(fixture->hdr)) != 0);
}

static int test_HDR_set_and_check_implicit_confirm(void)
{
    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 406 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 406 "../test/cmp_hdr_test.c"
   ) return 0;
    if (fixture != 
# 407 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 407 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_set_and_check_implicitConfirm_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_HDR_init_test(CMP_HDR_TEST_FIXTURE *fixture)
{
    ...
    if (!test_int_eq("../test/cmp_hdr_test.c", 416, "fixture->expected", "ossl_cmp_hdr_init(fixture->cmp_ctx, fixture->hdr)", fixture->expected, ossl_cmp_hdr_init(fixture->cmp_ctx, fixture->hdr))
                                                                       )
        return 0;
    if (fixture->expected == 0)
        return 1;

    if (!test_int_eq("../test/cmp_hdr_test.c", 422, "ossl_cmp_hdr_get_pvno(fixture->hdr)", "OSSL_CMP_PVNO", ossl_cmp_hdr_get_pvno(fixture->hdr), 2))
        return 0;

    header_nonce = ossl_cmp_hdr_get0_senderNonce(fixture->hdr);
    if (!test_int_eq("../test/cmp_hdr_test.c", 426, "0", "ASN1_OCTET_STRING_cmp(header_nonce, fixture->cmp_ctx->senderNonce)", 0, ASN1_OCTET_STRING_cmp(header_nonce, fixture->cmp_ctx->senderNonce))
                                                                             )
        return 0;
    header_transactionID = OSSL_CMP_HDR_get0_transactionID(fixture->hdr);
    if (!test_true("../test/cmp_hdr_test.c", 430, "ASN1_OCTET_STRING_cmp(header_transactionID, fixture->cmp_ctx->transactionID) == 0", (ASN1_OCTET_STRING_cmp(header_transactionID, fixture->cmp_ctx->transactionID) == 0) != 0)
                                                                               )
        return 0;
    ...
    if (ctx_nonce != 
# 436 "../test/cmp_hdr_test.c" 3 4
                    ((void *)0)
            
# 437 "../test/cmp_hdr_test.c"
           && (!test_ptr("../test/cmp_hdr_test.c", 437, "header_nonce", header_nonce)
                    || !test_int_eq("../test/cmp_hdr_test.c", 438, "0", "ASN1_OCTET_STRING_cmp(header_nonce, ctx_nonce)", 0, ASN1_OCTET_STRING_cmp(header_nonce, ctx_nonce))
                                                                        ))
        return 0;
...
{
    unsigned char ref[15];

    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 449 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 449 "../test/cmp_hdr_test.c"
   ) return 0;

    fixture->expected = 1;
    if (!test_int_eq("../test/cmp_hdr_test.c", 452, "1", "RAND_bytes(ref, sizeof(ref))", 1, RAND_bytes(ref, sizeof(ref)))
            || !test_true("../test/cmp_hdr_test.c", 453, "OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, ref, sizeof(ref))", (OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, ref, sizeof(ref))) != 0)
                                                                             ) {
        tear_down(fixture);
        fixture = 
# 456 "../test/cmp_hdr_test.c" 3 4
                 ((void *)0)
# 456 "../test/cmp_hdr_test.c"
                     ;
    }
    if (fixture != 
# 458 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 458 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_init_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    X509_NAME *subject = 
# 464 "../test/cmp_hdr_test.c" 3 4
                        ((void *)0)
# 464 "../test/cmp_hdr_test.c"
                            ;

    CMP_HDR_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 466 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 466 "../test/cmp_hdr_test.c"
   ) return 0;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_hdr_test.c", 468, "subject = X509_NAME_new()", subject = X509_NAME_new())
            || !test_true("../test/cmp_hdr_test.c", 469, "X509_NAME_ADD(subject, \"CN\", \"Common Name\")", (X509_NAME_add_entry_by_txt((subject), ("CN"), (0x1000|1), (unsigned char *)("Common Name"), -1, -1, 0)) != 0)
            || !test_true("../test/cmp_hdr_test.c", 470, "OSSL_CMP_CTX_set1_subjectName(fixture->cmp_ctx, subject)", (OSSL_CMP_CTX_set1_subjectName(fixture->cmp_ctx, subject)) != 0)
                                                                 ) {
        tear_down(fixture);
        fixture = 
# 473 "../test/cmp_hdr_test.c" 3 4
                 ((void *)0)
# 473 "../test/cmp_hdr_test.c"
                     ;
    }
    X509_NAME_free(subject);
    if (fixture != 
# 476 "../test/cmp_hdr_test.c" 3 4
   ((void *)0)
# 476 "../test/cmp_hdr_test.c"
   ) { result = execute_HDR_init_test(fixture); tear_down(fixture); };
    return result;
}
