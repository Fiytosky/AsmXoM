# 0 "../test/threadstest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/threadstest.c"
# 22 "../test/threadstest.c"
...
# 31 "../test/threadstest.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 32 "../test/threadstest.c" 2
...
# 33 "../test/threadstest.c" 2
# 1 "../include/internal/rcu.h" 1
...
# 35 "../test/threadstest.c" 2
# 1 "../test/threadstest.h" 1
# 59 "../test/threadstest.h"
...
static void *thread_run(void *arg)
{
    ...
    *(void **) (&f) = arg;
    ...
    OPENSSL_thread_stop();
    return 
# 69 "../test/threadstest.h" 3 4
          ((void *)0)
# 69 "../test/threadstest.h"
              ;
}
...
# 74 "../test/threadstest.h" 3 4
                            ((void *)0)
# 74 "../test/threadstest.h"
                                , thread_run, *(void **) &f) == 0;
}
...
# 79 "../test/threadstest.h" 3 4
                               ((void *)0)
# 79 "../test/threadstest.h"
                                   ) == 0;
}
# 36 "../test/threadstest.c" 2
# 50 "../test/threadstest.c"
static int do_fips = 0;
static char *privkey;
static char *storedir;
static char *config_file = 
# 53 "../test/threadstest.c" 3 4
                          ((void *)0)
# 53 "../test/threadstest.c"
                              ;
static int multidefault_run = 0;

static const char *default_provider[] = { "default", 
# 56 "../test/threadstest.c" 3 4
                                                    ((void *)0) 
# 56 "../test/threadstest.c"
                                                         };
static const char *fips_provider[] = { "fips", 
# 57 "../test/threadstest.c" 3 4
                                              ((void *)0) 
# 57 "../test/threadstest.c"
                                                   };
static const char *fips_and_default_providers[] = { "default", "fips", 
# 58 "../test/threadstest.c" 3 4
                                                                      ((void *)0) 
# 58 "../test/threadstest.c"
                                                                           };
...
static int get_new_uid(void)
{
    ...
    static _Atomic int current_uid = 1 << (sizeof(int) * 8 - 2);
# 85 "../test/threadstest.c"
    return 
# 85 "../test/threadstest.c" 3 4
          __atomic_fetch_add ((
# 85 "../test/threadstest.c"
          ((&current_uid))
# 85 "../test/threadstest.c" 3 4
...
static int test_lock(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 94, "lock", lock))
        return 0;

    res = test_true("../test/threadstest.c", 97, "CRYPTO_THREAD_read_lock(lock)", (CRYPTO_THREAD_read_lock(lock)) != 0)
          && test_true("../test/threadstest.c", 98, "CRYPTO_THREAD_unlock(lock)", (CRYPTO_THREAD_unlock(lock)) != 0)
          && test_true("../test/threadstest.c", 99, "CRYPTO_THREAD_write_lock(lock)", (CRYPTO_THREAD_write_lock(lock)) != 0)
          && test_true("../test/threadstest.c", 100, "CRYPTO_THREAD_unlock(lock)", (CRYPTO_THREAD_unlock(lock)) != 0);
...
static int *rwwriter_ptr = 
# 115 "../test/threadstest.c" 3 4
                          ((void *)0)
# 115 "../test/threadstest.c"
                              ;
static int rw_torture_result = 1;
static CRYPTO_RWLOCK *rwtorturelock = 
# 117 "../test/threadstest.c" 3 4
                                     ((void *)0)
# 117 "../test/threadstest.c"
                                         ;
static CRYPTO_RWLOCK *atomiclock = 
# 118 "../test/threadstest.c" 3 4
                                  ((void *)0)
# 118 "../test/threadstest.c"
                                      ;
...
static void rwwriter_fn(int id, int *iterations)
{
    ...
    for (count = 0; ; count++) {
        new = CRYPTO_zalloc(sizeof (int), 
# 128 "../test/threadstest.c" 3 4
                                         ((void *)0)
# 128 "../test/threadstest.c"
                                             , 0);
        if (contention == 0)
            OSSL_sleep(1000);
        if (!CRYPTO_THREAD_write_lock(rwtorturelock))
            abort();
        if (rwwriter_ptr != 
# 133 "../test/threadstest.c" 3 4
                           ((void *)0)
# 133 "../test/threadstest.c"
                               ) {
            *new = *rwwriter_ptr + 1;
        } else {
            *new = 0;
        ...
        if (!CRYPTO_THREAD_unlock(rwtorturelock))
            abort();
        if (old != 
# 142 "../test/threadstest.c" 3 4
                  ((void *)0)
# 142 "../test/threadstest.c"
                      )
            CRYPTO_free(old, "../test/threadstest.c", 143);
        t2 = ossl_time_now();
        if (((ossl_time2ticks(t2) / ((uint64_t)1000000000)) - (ossl_time2ticks(t1) / ((uint64_t)1000000000))) >= 4)
            break;
    }
    *iterations = count;
    return;
...
static void rwwriter1_fn(void)
{
    ...
    test_info("../test/threadstest.c", 156, "Starting writer1");
...
static void rwwriter2_fn(void)
{
    ...
    test_info("../test/threadstest.c", 165, "Starting writer 2");
...
static void rwreader_fn(int *iterations)
{
    ...
    while (lw1 != 1 || lw2 != 1) {
        ...
        count++;
        if (rwwriter_ptr != 
# 186 "../test/threadstest.c" 3 4
                           ((void *)0)
# 186 "../test/threadstest.c"
                               ) {
            if (old > *rwwriter_ptr) {
                test_info("../test/threadstest.c", 188, "rwwriter pointer went backwards! %d : %d\n", old, *rwwriter_ptr)
                                             ;
                rw_torture_result = 0;
            }
            old = *rwwriter_ptr;
...
{
    test_info("../test/threadstest.c", 210, "Starting reader 1");
    rwreader_fn(&rwreader1_iterations);
}

static void rwreader2_fn(void)
{
    test_info("../test/threadstest.c", 216, "Starting reader 2");
...
static int _torture_rw(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 235, "rwtorturelock", rwtorturelock) || !test_ptr("../test/threadstest.c", 235, "atomiclock", atomiclock))
        goto out;
    ...
    test_info("../test/threadstest.c", 251, "Staring rw torture");
    t1 = ossl_time_now();
    if (!test_true("../test/threadstest.c", 253, "run_thread(&rwreader1, rwreader1_fn)", (run_thread(&rwreader1, rwreader1_fn)) != 0)
        || !test_true("../test/threadstest.c", 254, "run_thread(&rwreader2, rwreader2_fn)", (run_thread(&rwreader2, rwreader2_fn)) != 0)
        || !test_true("../test/threadstest.c", 255, "run_thread(&rwwriter1, rwwriter1_fn)", (run_thread(&rwwriter1, rwwriter1_fn)) != 0)
        || !test_true("../test/threadstest.c", 256, "run_thread(&rwwriter2, rwwriter2_fn)", (run_thread(&rwwriter2, rwwriter2_fn)) != 0)
        || !test_true("../test/threadstest.c", 257, "wait_for_thread(rwwriter1)", (wait_for_thread(rwwriter1)) != 0)
        || !test_true("../test/threadstest.c", 258, "wait_for_thread(rwwriter2)", (wait_for_thread(rwwriter2)) != 0)
        || !test_true("../test/threadstest.c", 259, "wait_for_thread(rwreader1)", (wait_for_thread(rwreader1)) != 0)
        || !test_true("../test/threadstest.c", 260, "wait_for_thread(rwreader2)", (wait_for_thread(rwreader2)) != 0))
        goto out;

    t2 = ossl_time_now();
    dtime = ossl_time_to_timeval(ossl_time_subtract(t2, t1));
    tottime = dtime.tv_sec + (dtime.tv_usec / 1e6);
    test_info("../test/threadstest.c", 266, "rw_torture_result is %d\n", rw_torture_result);
    test_info("../test/threadstest.c", 267, "performed %d reads and %d writes over 2 read and 2 write threads in %e seconds", rwreader1_iterations + rwreader2_iterations, rwwriter1_iterations + rwwriter2_iterations, tottime)

                                                                   ;
    if ((rwreader1_iterations + rwreader2_iterations == 0)
        || (rwwriter1_iterations + rwwriter2_iterations == 0)) {
        test_info("../test/threadstest.c", 272, "Threads did not iterate\n");
        goto out;
    }
    avr = tottime / (rwreader1_iterations + rwreader2_iterations);
    avw = (tottime / (rwwriter1_iterations + rwwriter2_iterations));
    test_info("../test/threadstest.c", 277, "Average read time %e/read", avr);
    test_info("../test/threadstest.c", 278, "Averate write time %e/write", avw);

    if (test_int_eq("../test/threadstest.c", 280, "rw_torture_result", "1", rw_torture_result, 1))
        ret = 1;
out:
    CRYPTO_THREAD_lock_free(rwtorturelock);
    CRYPTO_THREAD_lock_free(atomiclock);
    rwtorturelock = 
# 285 "../test/threadstest.c" 3 4
                   ((void *)0)
# 285 "../test/threadstest.c"
                       ;
    return ret;
}
...
static CRYPTO_RCU_LOCK *rcu_lock = 
# 302 "../test/threadstest.c" 3 4
                                  ((void *)0)
# 302 "../test/threadstest.c"
                                      ;
...
static uint64_t *writer_ptr = 
# 310 "../test/threadstest.c" 3 4
                             ((void *)0)
# 310 "../test/threadstest.c"
                                 ;
...
{
    CRYPTO_free(data, 
# 315 "../test/threadstest.c" 3 4
                     ((void *)0)
# 315 "../test/threadstest.c"
                         , 0);
}
...
static void writer_fn(int id, int *iterations)
{
    ...
    for (count = 0; ; count++) {
        new = CRYPTO_malloc(sizeof(uint64_t), 
# 327 "../test/threadstest.c" 3 4
                                             ((void *)0)
# 327 "../test/threadstest.c"
                                                 , 0);
        *new = (uint64_t)0xBAD;
        if (contention == 0)
            OSSL_sleep(1000);
        ossl_rcu_write_lock(rcu_lock);
        old = ossl_rcu_uptr_deref((void **)&writer_ptr);
        ;
        *new = global_ctr++;
        ossl_rcu_assign_uptr((void **)&writer_ptr, (void **)&new);
        if (contention == 0)
        ...
        if (contention != 0) {
            ...
            CRYPTO_free(old, 
# 341 "../test/threadstest.c" 3 4
                            ((void *)0)
# 341 "../test/threadstest.c"
                                , 0);
        }
        t2 = ossl_time_now();
        if (((ossl_time2ticks(t2) / ((uint64_t)1000000000)) - (ossl_time2ticks(t1) / ((uint64_t)1000000000))) >= 4)
...
static void writer1_fn(void)
{
    ...
    test_info("../test/threadstest.c", 355, "Starting writer1");
...
static void writer2_fn(void)
{
    ...
    test_info("../test/threadstest.c", 364, "Starting writer2");
...
static void reader_fn(int *iterations)
{
    ...
    while (lw1 != 1 || lw2 != 1) {
        ...
        valp = ossl_rcu_uptr_deref((void **)&writer_ptr);
        val = (valp == 
# 384 "../test/threadstest.c" 3 4
                      ((void *)0)
# 384 "../test/threadstest.c"
                          ) ? 0 : *valp;

        if (oldval > val) {
            test_info("../test/threadstest.c", 387, "rcu torture value went backwards! %llu : %llu", (unsigned long long)oldval, (unsigned long long)val);
            if (valp == 
# 388 "../test/threadstest.c" 3 4
                       ((void *)0)
# 388 "../test/threadstest.c"
                           )
                test_info("../test/threadstest.c", 389, "ossl_rcu_deref did return NULL!");
...
{
    test_info("../test/threadstest.c", 404, "Starting reader 1");
    reader_fn(&reader1_iterations);
}

static void reader2_fn(void)
{
    test_info("../test/threadstest.c", 410, "Starting reader 2");
...
static int _torture_rcu(void)
{
    ...
    atomiclock = CRYPTO_THREAD_lock_new();
    if (!test_ptr("../test/threadstest.c", 428, "atomiclock", atomiclock))
        goto out;
    ...
    rcu_lock = ossl_rcu_lock_new(contention == 2 ? 4 : 1, 
# 444 "../test/threadstest.c" 3 4
                                                         ((void *)0)
# 444 "../test/threadstest.c"
                                                             );
    if (rcu_lock == 
# 445 "../test/threadstest.c" 3 4
                   ((void *)0)
# 445 "../test/threadstest.c"
                       )
        goto out;

    test_info("../test/threadstest.c", 448, "Staring rcu torture");
    t1 = ossl_time_now();
    if (!test_true("../test/threadstest.c", 450, "run_thread(&reader1, reader1_fn)", (run_thread(&reader1, reader1_fn)) != 0)
        || !test_true("../test/threadstest.c", 451, "run_thread(&reader2, reader2_fn)", (run_thread(&reader2, reader2_fn)) != 0)
        || !test_true("../test/threadstest.c", 452, "run_thread(&writer1, writer1_fn)", (run_thread(&writer1, writer1_fn)) != 0)
        || !test_true("../test/threadstest.c", 453, "run_thread(&writer2, writer2_fn)", (run_thread(&writer2, writer2_fn)) != 0)
        || !test_true("../test/threadstest.c", 454, "wait_for_thread(writer1)", (wait_for_thread(writer1)) != 0)
        || !test_true("../test/threadstest.c", 455, "wait_for_thread(writer2)", (wait_for_thread(writer2)) != 0)
        || !test_true("../test/threadstest.c", 456, "wait_for_thread(reader1)", (wait_for_thread(reader1)) != 0)
        || !test_true("../test/threadstest.c", 457, "wait_for_thread(reader2)", (wait_for_thread(reader2)) != 0))
        goto out;

    t2 = ossl_time_now();
    dtime = ossl_time_to_timeval(ossl_time_subtract(t2, t1));
    tottime = dtime.tv_sec + (dtime.tv_usec / 1e6);
    test_info("../test/threadstest.c", 463, "rcu_torture_result is %d\n", rcu_torture_result);
    test_info("../test/threadstest.c", 464, "performed %d reads and %d writes over 2 read and 2 write threads in %e seconds", reader1_iterations + reader2_iterations, writer1_iterations + writer2_iterations, tottime)

                                                               ;
    if ((reader1_iterations + reader2_iterations == 0)
        || (writer1_iterations + writer2_iterations == 0)) {
        test_info("../test/threadstest.c", 469, "Threads did not iterate\n");
        goto out;
    }
    avr = tottime / (reader1_iterations + reader2_iterations);
    avw = tottime / (writer1_iterations + writer2_iterations);
    test_info("../test/threadstest.c", 474, "Average read time %e/read", avr);
    test_info("../test/threadstest.c", 475, "Average write time %e/write", avw);

    if (!test_int_eq("../test/threadstest.c", 477, "rcu_torture_result", "1", rcu_torture_result, 1))
        goto out;
...
out:
    ...
    CRYPTO_THREAD_lock_free(atomiclock);
    if (!test_int_eq("../test/threadstest.c", 484, "rcu_torture_result", "1", rcu_torture_result, 1))
        return 0;
...
# 509 "../test/threadstest.c" 3 4
                             0
# 509 "../test/threadstest.c"
                                                    ;
...
static int test_once(void)
{
    ...
    if (!test_true("../test/threadstest.c", 526, "run_thread(&thread, once_run_thread_cb)", (run_thread(&thread, once_run_thread_cb)) != 0)
        || !test_true("../test/threadstest.c", 527, "wait_for_thread(thread)", (wait_for_thread(thread)) != 0)
        || !CRYPTO_THREAD_run_once(&once_run, once_do_run)
        || !test_int_eq("../test/threadstest.c", 529, "once_run_count", "1", once_run_count, 1))
        return 0;
    return 1;
}
...
static void thread_local_destructor(void *arg)
{
    ...
    if (arg == 
# 542 "../test/threadstest.c" 3 4
              ((void *)0)
# 542 "../test/threadstest.c"
                  )
        return;
...
static void thread_local_thread_cb(void)
{
    ...
    if (!test_ptr_null("../test/threadstest.c", 555, "ptr", ptr)
        || !test_true("../test/threadstest.c", 556, "CRYPTO_THREAD_set_local(&thread_local_key, &destructor_run_count)", (CRYPTO_THREAD_set_local(&thread_local_key, &destructor_run_count)) != 0)
                                                                     )
        return;

    ptr = CRYPTO_THREAD_get_local(&thread_local_key);
    if (!test_ptr_eq("../test/threadstest.c", 561, "ptr", "&destructor_run_count", ptr, &destructor_run_count))
        return;
...
static int test_thread_local(void)
{
    thread_t thread;
    void *ptr = 
# 570 "../test/threadstest.c" 3 4
               ((void *)0)
# 570 "../test/threadstest.c"
                   ;

    if (!test_true("../test/threadstest.c", 572, "CRYPTO_THREAD_init_local(&thread_local_key, thread_local_destructor)", (CRYPTO_THREAD_init_local(&thread_local_key, thread_local_destructor)) != 0)
                                                                     )
        return 0;

    ptr = CRYPTO_THREAD_get_local(&thread_local_key);
    if (!test_ptr_null("../test/threadstest.c", 577, "ptr", ptr)
        || !test_true("../test/threadstest.c", 578, "run_thread(&thread, thread_local_thread_cb)", (run_thread(&thread, thread_local_thread_cb)) != 0)
        || !test_true("../test/threadstest.c", 579, "wait_for_thread(thread)", (wait_for_thread(thread)) != 0)
        || !test_int_eq("../test/threadstest.c", 580, "thread_local_thread_cb_ok", "1", thread_local_thread_cb_ok, 1))
        return 0;



    ptr = CRYPTO_THREAD_get_local(&thread_local_key);
    if (!test_ptr_null("../test/threadstest.c", 586, "ptr", ptr))
        return 0;


    if (!test_int_eq("../test/threadstest.c", 590, "destructor_run_count", "1", destructor_run_count, 1))
        return 0;



    if (!test_true("../test/threadstest.c", 595, "CRYPTO_THREAD_cleanup_local(&thread_local_key)", (CRYPTO_THREAD_cleanup_local(&thread_local_key)) != 0))
        return 0;
    return 1;
}
...
static int test_thread_local_multi_key(void)
{
    ...
    for (i = 0; i < 1000; i++) {
        if (!test_true("../test/threadstest.c", 610, "CRYPTO_THREAD_init_local(&thread_local_key, thread_local_destructor)", (CRYPTO_THREAD_init_local(&thread_local_key, thread_local_destructor)) != 0)
                                                                         )
            return 0;

        if (!test_true("../test/threadstest.c", 614, "CRYPTO_THREAD_set_local(&thread_local_key, &dummy)", (CRYPTO_THREAD_set_local(&thread_local_key, &dummy)) != 0))
            return 0;

        if (!test_true("../test/threadstest.c", 617, "CRYPTO_THREAD_cleanup_local(&thread_local_key)", (CRYPTO_THREAD_cleanup_local(&thread_local_key)) != 0))
            return 0;
    }
    return 1;
}
...
static int test_atomic(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 629, "lock", lock))
        return 0;

    if (CRYPTO_atomic_add(&val, 1, &ret, 
# 632 "../test/threadstest.c" 3 4
                                        ((void *)0)
# 632 "../test/threadstest.c"
                                            )) {

        if (!test_int_eq("../test/threadstest.c", 634, "val", "1", val, 1) || !test_int_eq("../test/threadstest.c", 634, "val", "ret", val, ret))
            goto err;
    } else {

        if (!test_int_eq("../test/threadstest.c", 638, "val", "0", val, 0) || !test_int_eq("../test/threadstest.c", 638, "val", "ret", val, ret))
            goto err;
    }
    val = 0;
    ret = 0;

    if (!test_true("../test/threadstest.c", 644, "CRYPTO_atomic_add(&val, 1, &ret, lock)", (CRYPTO_atomic_add(&val, 1, &ret, lock)) != 0))
        goto err;
    if (!test_int_eq("../test/threadstest.c", 646, "val", "1", val, 1) || !test_int_eq("../test/threadstest.c", 646, "val", "ret", val, ret))
        goto err;

    if (CRYPTO_atomic_or(&val64, 2, &ret64, 
# 649 "../test/threadstest.c" 3 4
                                           ((void *)0)
# 649 "../test/threadstest.c"
                                               )) {

        if (!test_uint_eq("../test/threadstest.c", 651, "(unsigned int)val64", "3", (unsigned int)val64, 3)
                || !test_uint_eq("../test/threadstest.c", 652, "(unsigned int)val64", "(unsigned int)ret64", (unsigned int)val64, (unsigned int)ret64))
            goto err;
    } else {

        if (!test_uint_eq("../test/threadstest.c", 656, "(unsigned int)val64", "1", (unsigned int)val64, 1)
                || !test_int_eq("../test/threadstest.c", 657, "(unsigned int)ret64", "0", (unsigned int)ret64, 0))
            goto err;
    }
    val64 = 1;
    ret64 = 0;

    if (!test_true("../test/threadstest.c", 663, "CRYPTO_atomic_or(&val64, 2, &ret64, lock)", (CRYPTO_atomic_or(&val64, 2, &ret64, lock)) != 0))
        goto err;

    if (!test_uint_eq("../test/threadstest.c", 666, "(unsigned int)val64", "3", (unsigned int)val64, 3)
            || !test_uint_eq("../test/threadstest.c", 667, "(unsigned int)val64", "(unsigned int)ret64", (unsigned int)val64, (unsigned int)ret64))
        goto err;

    ret64 = 0;
    if (CRYPTO_atomic_load(&val64, &ret64, 
# 671 "../test/threadstest.c" 3 4
                                          ((void *)0)
# 671 "../test/threadstest.c"
                                              )) {

        if (!test_uint_eq("../test/threadstest.c", 673, "(unsigned int)val64", "3", (unsigned int)val64, 3)
                || !test_uint_eq("../test/threadstest.c", 674, "(unsigned int)val64", "(unsigned int)ret64", (unsigned int)val64, (unsigned int)ret64))
            goto err;
    } else {

        if (!test_uint_eq("../test/threadstest.c", 678, "(unsigned int)val64", "3", (unsigned int)val64, 3)
                || !test_int_eq("../test/threadstest.c", 679, "(unsigned int)ret64", "0", (unsigned int)ret64, 0))
            goto err;
    }

    ret64 = 0;
    if (!test_true("../test/threadstest.c", 684, "CRYPTO_atomic_load(&val64, &ret64, lock)", (CRYPTO_atomic_load(&val64, &ret64, lock)) != 0))
        goto err;

    if (!test_uint_eq("../test/threadstest.c", 687, "(unsigned int)val64", "3", (unsigned int)val64, 3)
            || !test_uint_eq("../test/threadstest.c", 688, "(unsigned int)val64", "(unsigned int)ret64", (unsigned int)val64, (unsigned int)ret64))
        goto err;
...
static OSSL_LIB_CTX *multi_libctx = 
# 697 "../test/threadstest.c" 3 4
                                   ((void *)0)
# 697 "../test/threadstest.c"
                                       ;
static int multi_success;
static OSSL_PROVIDER *multi_provider[4 + 1];
static size_t multi_num_threads;
static thread_t multi_threads[10];

static void multi_intialise(void)
{
    multi_success = 1;
    multi_libctx = 
# 706 "../test/threadstest.c" 3 4
                  ((void *)0)
# 706 "../test/threadstest.c"
                      ;
    multi_num_threads = 0;
...
static void thead_teardown_libctx(void)
{
    ...
    for (p = multi_provider; *p != 
# 729 "../test/threadstest.c" 3 4
                                  ((void *)0)
# 729 "../test/threadstest.c"
                                      ; p++)
...
static int thread_setup_libctx(int libctx, const char *providers[])
{
    ...
    if (libctx && !test_true("../test/threadstest.c", 739, "test_get_libctx(&multi_libctx, NULL, config_file, NULL, NULL)", (test_get_libctx(&multi_libctx, 
# 739 "../test/threadstest.c" 3 4
                  ((void *)0)
# 739 "../test/threadstest.c"
                  , config_file, 
# 739 "../test/threadstest.c" 3 4
                  ((void *)0)
# 739 "../test/threadstest.c"
...
# 739 "../test/threadstest.c"
    ...
    if (providers != 
# 743 "../test/threadstest.c" 3 4
                    ((void *)0)
# 743 "../test/threadstest.c"
                        )
        for (n = 0; providers[n] != 
# 744 "../test/threadstest.c" 3 4
                                   ((void *)0)
# 744 "../test/threadstest.c"
                                       ; n++)
            if (!test_size_t_lt("../test/threadstest.c", 745, "n", "MAXIMUM_PROVIDERS", n, 4)
                || !test_ptr("../test/threadstest.c", 746, "multi_provider[n] = OSSL_PROVIDER_load(multi_libctx, providers[n])", multi_provider[n] = OSSL_PROVIDER_load(multi_libctx, providers[n]))
                                                                                  ) {
...
static int teardown_threads(void)
{
    ...
    for (i = 0; i < multi_num_threads; i++)
        if (!test_true("../test/threadstest.c", 759, "wait_for_thread(multi_threads[i])", (wait_for_thread(multi_threads[i])) != 0))
            return 0;
    return 1;
}
...
static int start_threads(size_t n, void (*thread_func)(void))
{
    ...
    if (!test_size_t_le("../test/threadstest.c", 768, "multi_num_threads + n", "MAXIMUM_THREADS", multi_num_threads + n, 10))
        return 0;

    for (i = 0 ; i < n; i++)
        if (!test_true("../test/threadstest.c", 772, "run_thread(multi_threads + multi_num_threads++, thread_func)", (run_thread(multi_threads + multi_num_threads++, thread_func)) != 0))
            return 0;
    return 1;
}
                           ...
                           int libctx, const char *providers[])
{
    ...
    if (main_func != 
# 789 "../test/threadstest.c" 3 4
                    ((void *)0)
# 789 "../test/threadstest.c"
                        )
        main_func();

    if (!teardown_threads()
            || !test_true("../test/threadstest.c", 793, "multi_success", (multi_success) != 0))
        goto err;
    testresult = 1;
 err:
    thead_teardown_libctx();
...
static void thread_general_worker(void)
{
    ...
    EVP_MD *md = EVP_MD_fetch(multi_libctx, "SHA2-256", 
# 804 "../test/threadstest.c" 3 4
                                                       ((void *)0)
# 804 "../test/threadstest.c"
                                                           );
    EVP_CIPHER_CTX *cipherctx = EVP_CIPHER_CTX_new();
    EVP_CIPHER *ciph = EVP_CIPHER_fetch(multi_libctx, "AES-128-CBC", 
# 806 "../test/threadstest.c" 3 4
                                                                    ((void *)0)
# 806 "../test/threadstest.c"
                                                                        );
    ...
    int ciphoutl;
    EVP_PKEY *pkey = 
# 821 "../test/threadstest.c" 3 4
                    ((void *)0)
# 821 "../test/threadstest.c"
                        ;
    int testresult = 0;
    int i, isfips;
    ...
    if (!test_ptr("../test/threadstest.c", 827, "mdctx", mdctx)
            || !test_ptr("../test/threadstest.c", 828, "md", md)
            || !test_ptr("../test/threadstest.c", 829, "cipherctx", cipherctx)
            || !test_ptr("../test/threadstest.c", 830, "ciph", ciph))
        goto err;


    for (i = 0; i < 5; i++) {
        if (!test_true("../test/threadstest.c", 835, "EVP_DigestInit_ex(mdctx, md, NULL)", (EVP_DigestInit_ex(mdctx, md, 
# 835 "../test/threadstest.c" 3 4
            ((void *)0)
# 835 "../test/threadstest.c"
            )) != 0)
                || !test_true("../test/threadstest.c", 836, "EVP_DigestUpdate(mdctx, message, messlen)", (EVP_DigestUpdate(mdctx, message, messlen)) != 0)
                || !test_true("../test/threadstest.c", 837, "EVP_DigestFinal(mdctx, out, &mdoutl)", (EVP_DigestFinal(mdctx, out, &mdoutl)) != 0))
            goto err;
    }
    for (i = 0; i < 5; i++) {
        if (!test_true("../test/threadstest.c", 841, "EVP_EncryptInit_ex(cipherctx, ciph, NULL, key, iv)", (EVP_EncryptInit_ex(cipherctx, ciph, 
# 841 "../test/threadstest.c" 3 4
            ((void *)0)
# 841 "../test/threadstest.c"
            , key, iv)) != 0)
                || !test_true("../test/threadstest.c", 842, "EVP_EncryptUpdate(cipherctx, out, &ciphoutl, (unsigned char *)message, messlen)", (EVP_EncryptUpdate(cipherctx, out, &ciphoutl, (unsigned char *)message, messlen)) != 0)


                || !test_true("../test/threadstest.c", 845, "EVP_EncryptFinal(cipherctx, out, &ciphoutl)", (EVP_EncryptFinal(cipherctx, out, &ciphoutl)) != 0))
            goto err;
    }
    ...
    pkey = EVP_PKEY_Q_keygen(multi_libctx, 
# 854 "../test/threadstest.c" 3 4
                                          ((void *)0)
# 854 "../test/threadstest.c"
                                              , "RSA", (size_t)(isfips ? 2048 : 512));
    if (!test_ptr("../test/threadstest.c", 855, "pkey", pkey))
        goto err;
...
{
    EVP_MD *md = EVP_MD_fetch(multi_libctx, "SHA2-256", 
# 871 "../test/threadstest.c" 3 4
                                                       ((void *)0)
# 871 "../test/threadstest.c"
                                                           );

    if (md != 
# 873 "../test/threadstest.c" 3 4
             ((void *)0)
# 873 "../test/threadstest.c"
                 )
        EVP_MD_free(md);
    else
        multi_set_success(0);
...
static EVP_PKEY *shared_evp_pkey = 
# 879 "../test/threadstest.c" 3 4
                                  ((void *)0)
# 879 "../test/threadstest.c"
                                      ;
...
static void thread_shared_evp_pkey(void)
{
    ...
    EVP_PKEY_CTX *ctx = 
# 887 "../test/threadstest.c" 3 4
                       ((void *)0)
# 887 "../test/threadstest.c"
                           ;
    int success = 0;
    int i;
    ...
    for (i = 0; i < 1 + do_fips; i++) {
        ...
        ctx = EVP_PKEY_CTX_new_from_pkey(multi_libctx, shared_evp_pkey,
                                         i == 0 ? "provider=default"
                                                : "provider=fips");
        if (!test_ptr("../test/threadstest.c", 897, "ctx", ctx))
            goto err;

        if (!test_int_ge("../test/threadstest.c", 900, "EVP_PKEY_encrypt_init(ctx)", "0", EVP_PKEY_encrypt_init(ctx), 0)
                || !test_int_ge("../test/threadstest.c", 901, "EVP_PKEY_encrypt(ctx, ctbuf, &ctlen, (unsigned char *)msg, strlen(msg))", "0", EVP_PKEY_encrypt(ctx, ctbuf, &ctlen, (unsigned char *)msg, strlen(msg)), 0)
        ...
        EVP_PKEY_CTX_free(ctx);
        ctx = EVP_PKEY_CTX_new_from_pkey(multi_libctx, shared_evp_pkey, 
# 907 "../test/threadstest.c" 3 4
                                                                       ((void *)0)
# 907 "../test/threadstest.c"
                                                                           );

        if (!test_ptr("../test/threadstest.c", 909, "ctx", ctx))
            goto err;

        ptlen = sizeof(ptbuf);
        if (!test_int_ge("../test/threadstest.c", 913, "EVP_PKEY_decrypt_init(ctx)", "0", EVP_PKEY_decrypt_init(ctx), 0)
                || !test_int_gt("../test/threadstest.c", 914, "EVP_PKEY_decrypt(ctx, ptbuf, &ptlen, ctbuf, ctlen)", "0", EVP_PKEY_decrypt(ctx, ptbuf, &ptlen, ctbuf, ctlen), 0)

                || !test_mem_eq("../test/threadstest.c", 916, "msg", "ptbuf", msg, strlen(msg), ptbuf, ptlen))
            goto err;
    }
...
static void thread_provider_load_unload(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 932, "deflt", deflt)
            || !test_true("../test/threadstest.c", 933, "OSSL_PROVIDER_available(multi_libctx, \"default\")", (OSSL_PROVIDER_available(multi_libctx, "default")) != 0))
        multi_set_success(0);
...
{
    if (!do_fips)
        return test_skip("../test/threadstest.c", 948, "FIPS not supported");
    return thread_run_test(&thread_general_worker, 2, &thread_general_worker,
                           1, fips_provider);
}
...
static int test_multi_shared_pkey_common(void (*worker)(void))
{
    ...
    if (!thread_setup_libctx(1, do_fips ? fips_and_default_providers
                                        : default_provider)
            || !test_ptr("../test/threadstest.c", 966, "shared_evp_pkey = load_pkey_pem(privkey, multi_libctx)", shared_evp_pkey = load_pkey_pem(privkey, multi_libctx))
    ...
    if (!teardown_threads()
            || !test_true("../test/threadstest.c", 974, "multi_success", (multi_success) != 0))
        goto err;
    testresult = 1;
 err:
...
static void thread_downgrade_shared_evp_pkey(void)
{
    ...
    if (EVP_PKEY_get0_RSA(shared_evp_pkey) == 
# 990 "../test/threadstest.c" 3 4
                                             ((void *)0)
# 990 "../test/threadstest.c"
                                                 )
        multi_set_success(0);
}
...
static int test_multi_shared_pkey_release(void)
{
    ...
    multi_intialise();
    shared_evp_pkey = 
# 1017 "../test/threadstest.c" 3 4
                     ((void *)0)
# 1017 "../test/threadstest.c"
                         ;
    if (!thread_setup_libctx(1, do_fips ? fips_and_default_providers
                                        : default_provider)
            || !test_ptr("../test/threadstest.c", 1020, "shared_evp_pkey = load_pkey_pem(privkey, multi_libctx)", shared_evp_pkey = load_pkey_pem(privkey, multi_libctx)))
        goto err;
    for (; i < 10; ++i) {
        if (!test_true("../test/threadstest.c", 1023, "EVP_PKEY_up_ref(shared_evp_pkey)", (EVP_PKEY_up_ref(shared_evp_pkey)) != 0))
            goto err;
    }
    ...
    if (!teardown_threads()
            || !test_true("../test/threadstest.c", 1032, "multi_success", (multi_success) != 0))
        goto err;
    testresult = 1;
 err:
    while (i > 0) {
...
{
    EVP_MD *sha256 = 
# 1046 "../test/threadstest.c" 3 4
                    ((void *)0)
# 1046 "../test/threadstest.c"
                        ;
    OSSL_PROVIDER *prov = 
# 1047 "../test/threadstest.c" 3 4
                         ((void *)0)
# 1047 "../test/threadstest.c"
                             ;
    int testresult = 0;

    multi_intialise();
    if (!thread_setup_libctx(1, 
# 1051 "../test/threadstest.c" 3 4
                               ((void *)0)
# 1051 "../test/threadstest.c"
                                   )
            || !test_ptr("../test/threadstest.c", 1052, "prov = OSSL_PROVIDER_load(multi_libctx, \"default\")", prov = OSSL_PROVIDER_load(multi_libctx, "default"))
            || !test_ptr("../test/threadstest.c", 1053, "sha256 = EVP_MD_fetch(multi_libctx, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(multi_libctx, "SHA2-256", 
# 1053 "../test/threadstest.c" 3 4
               ((void *)0)
# 1053 "../test/threadstest.c"
               ))
            || !test_true("../test/threadstest.c", 1054, "OSSL_PROVIDER_unload(prov)", (OSSL_PROVIDER_unload(prov)) != 0))
        goto err;
    prov = 
# 1056 "../test/threadstest.c" 3 4
          ((void *)0)
# 1056 "../test/threadstest.c"
              ;
    ...
    if (!teardown_threads()
            || !test_true("../test/threadstest.c", 1064, "multi_success", (multi_success) != 0))
        goto err;
    testresult = 1;
 err:
...
static void test_multi_load_worker(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 1084, "prov = OSSL_PROVIDER_load(multi_libctx, multi_load_provider)", prov = OSSL_PROVIDER_load(multi_libctx, multi_load_provider))
            || !test_true("../test/threadstest.c", 1085, "OSSL_PROVIDER_unload(prov)", (OSSL_PROVIDER_unload(prov)) != 0))
        multi_set_success(0);
}
...
static int test_multi_default(void)
{
    ...
    if (multidefault_run) {
        test_skip("../test/threadstest.c", 1093, "multi default test already run");
        return 1;
    }
    multidefault_run = 1;

    return thread_run_test(&thread_multi_simple_fetch,
                           2, &thread_multi_simple_fetch, 0, 
# 1099 "../test/threadstest.c" 3 4
                                                            ((void *)0)
# 1099 "../test/threadstest.c"
                                                                );
}
...
static int test_multi_load(void)
{
    ...
    if (!multidefault_run) {
        test_info("../test/threadstest.c", 1109, "Running multi default test first");
...
# 1119 "../test/threadstest.c" 3 4
                             ((void *)0)
# 1119 "../test/threadstest.c"
                                 , "legacy");
    if (prov == 
# 1120 "../test/threadstest.c" 3 4
               ((void *)0)
# 1120 "../test/threadstest.c"
                   ) {
        test_info("../test/threadstest.c", 1121, "Cannot load legacy provider - assuming this is a no-legacy build");
        multi_load_provider = "default";
    }
    OSSL_PROVIDER_unload(prov);

    return thread_run_test(
# 1126 "../test/threadstest.c" 3 4
                          ((void *)0)
# 1126 "../test/threadstest.c"
                              , 10, &test_multi_load_worker, 0,
                          
# 1127 "../test/threadstest.c" 3 4
                         ((void *)0)
# 1127 "../test/threadstest.c"
                             ) && res;
}
...
static void test_obj_create_one(void)
{
    ...
    if (!test_int_ne("../test/threadstest.c", 1139, "id", "0", id, 0)
            || !test_true("../test/threadstest.c", 1140, "id = OBJ_create(oid, sn, ln)", (id = OBJ_create(oid, sn, ln)) != 0)
            || !test_true("../test/threadstest.c", 1141, "OBJ_add_sigid(id, NID_sha3_256, NID_rsa)", (OBJ_add_sigid(id, 1097, 19)) != 0))
        multi_set_success(0);
}
...
static int test_obj_add(void)
{
    return thread_run_test(&test_obj_create_one,
                           10, &test_obj_create_one,
                           1, default_provider);
}

static void test_lib_ctx_load_config_worker(void)
{
    if (!test_int_eq("../test/threadstest.c", 1154, "OSSL_LIB_CTX_load_config(multi_libctx, config_file)", "1", OSSL_LIB_CTX_load_config(multi_libctx, config_file), 1))
        multi_set_success(0);
}
...
static int test_lib_ctx_load_config(void)
{
    return thread_run_test(&test_lib_ctx_load_config_worker,
                           10, &test_lib_ctx_load_config_worker,
                           1, default_provider);
}
...
static void test_bio_dgram_pair_worker(void)
{
    ...
    if (!test_int_eq("../test/threadstest.c", 1177, "RAND_bytes_ex(multi_libctx, &ch, 1, 64)", "1", RAND_bytes_ex(multi_libctx, &ch, 1, 64), 1))
        goto err;
...
static int test_bio_dgram_pair(void)
{
    int r;
    BIO *bio1 = 
# 1203 "../test/threadstest.c" 3 4
               ((void *)0)
# 1203 "../test/threadstest.c"
                   , *bio2 = 
# 1203 "../test/threadstest.c" 3 4
                             ((void *)0)
# 1203 "../test/threadstest.c"
    ...
    if (!test_int_eq("../test/threadstest.c", 1206, "r", "1", r, 1))
        goto err;
...
# 1233 "../test/threadstest.c" 3 4
   ((void *)0)

# 1234 "../test/threadstest.c"
};

static void test_pem_read_one(void)
{
    EVP_PKEY *key = 
# 1238 "../test/threadstest.c" 3 4
                   ((void *)0)
# 1238 "../test/threadstest.c"
                       ;
    BIO *pem = 
# 1239 "../test/threadstest.c" 3 4
              ((void *)0)
# 1239 "../test/threadstest.c"
                  ;
    char *pemdata;
    size_t len;
    ...
    if (pemdata == 
# 1244 "../test/threadstest.c" 3 4
                  ((void *)0)
# 1244 "../test/threadstest.c"
                      ) {
        multi_set_success(0);
        goto err;
    }
    ...
    if (pem == 
# 1250 "../test/threadstest.c" 3 4
              ((void *)0)
# 1250 "../test/threadstest.c"
                  ) {
        multi_set_success(0);
        goto err;
    }

    key = PEM_read_bio_PrivateKey(pem, 
# 1255 "../test/threadstest.c" 3 4
                                      ((void *)0)
# 1255 "../test/threadstest.c"
                                          , 
# 1255 "../test/threadstest.c" 3 4
                                            ((void *)0)
# 1255 "../test/threadstest.c"
...
# 1255 "../test/threadstest.c"
    ...
    if (key == 
# 1256 "../test/threadstest.c" 3 4
              ((void *)0)
# 1256 "../test/threadstest.c"
                  )
        multi_set_success(0);
 ...
 err:
    EVP_PKEY_free(key);
    BIO_free(pem);
    CRYPTO_free(pemdata, "../test/threadstest.c", 1262);
}


static int test_pem_read(void)
{
    return thread_run_test(&test_pem_read_one, 10,
                           &test_pem_read_one, 1, default_provider);
}

static X509_STORE *store = 
# 1272 "../test/threadstest.c" 3 4
                          ((void *)0)
# 1272 "../test/threadstest.c"
                              ;
...
static void test_x509_store_by_subject(void)
{
    X509_STORE_CTX *ctx;
    X509_OBJECT *obj = 
# 1277 "../test/threadstest.c" 3 4
                      ((void *)0)
# 1277 "../test/threadstest.c"
                          ;
    X509_NAME *name = 
# 1278 "../test/threadstest.c" 3 4
                     ((void *)0)
# 1278 "../test/threadstest.c"
                         ;
    int success = 0;

    ctx = X509_STORE_CTX_new();
    if (!test_ptr("../test/threadstest.c", 1282, "ctx", ctx))
        goto err;

    if (!test_true("../test/threadstest.c", 1285, "X509_STORE_CTX_init(ctx, store, NULL, NULL)", (X509_STORE_CTX_init(ctx, store, 
# 1285 "../test/threadstest.c" 3 4
        ((void *)0)
# 1285 "../test/threadstest.c"
        , 
# 1285 "../test/threadstest.c" 3 4
        ((void *)0)
# 1285 "../test/threadstest.c"
    ...
    name = X509_NAME_new();
    if (!test_ptr("../test/threadstest.c", 1289, "name", name))
        goto err;
    if (!test_true("../test/threadstest.c", 1291, "X509_NAME_add_entry_by_txt(name, \"CN\", MBSTRING_ASC, (unsigned char *)\"Root CA\", -1, -1, 0)", (X509_NAME_add_entry_by_txt(name, "CN", (0x1000|1), (unsigned char *)"Root CA", -1, -1, 0)) != 0)

                                                         )
        goto err;
    obj = X509_STORE_CTX_get_obj_by_subject(ctx, X509_LU_X509, name);
    if (!test_ptr("../test/threadstest.c", 1296, "obj", obj))
        goto err;
...
static int test_x509_store(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 1314, "store", store))
        return 0;
    if (!test_true("../test/threadstest.c", 1316, "X509_STORE_load_store(store, storedir)", (X509_STORE_load_store(store, storedir)) != 0))
        goto err;

    ret = thread_run_test(&test_x509_store_by_subject, 10,
                          &test_x509_store_by_subject, 0, 
# 1320 "../test/threadstest.c" 3 4
                                                         ((void *)0)
# 1320 "../test/threadstest.c"
                                                             );

 err:
    X509_STORE_free(store);
    store = 
# 1324 "../test/threadstest.c" 3 4
           ((void *)0)
# 1324 "../test/threadstest.c"
               ;
    return ret;
}
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 1342 "../test/threadstest.c" 3 4
         ((void *)0) 
# 1342 "../test/threadstest.c"
              }
    };
    return options;
}
...
int setup_tests(void)
{
    ...
    if (!test_ptr("../test/threadstest.c", 1367, "datadir = test_get_argument(0)", datadir = test_get_argument(0)))
        return 0;

    privkey = test_mk_file_path(datadir, "rsakey.pem");
    if (!test_ptr("../test/threadstest.c", 1371, "privkey", privkey))
        return 0;

    storedir = test_mk_file_path(datadir, "store");
    if (!test_ptr("../test/threadstest.c", 1375, "storedir", storedir))
        return 0;

    if (!test_ptr("../test/threadstest.c", 1378, "global_lock = CRYPTO_THREAD_lock_new()", global_lock = CRYPTO_THREAD_lock_new()))
        return 0;
    ...
    add_test("test_thread_local_multi_key", test_thread_local_multi_key);
    add_test("test_atomic", test_atomic);
    add_test("test_multi_load", test_multi_load);
    add_test("test_multi_general_worker_default_provider", test_multi_general_worker_default_provider);
    ...
    add_test("test_lib_ctx_load_config", test_lib_ctx_load_config);
...
void cleanup_tests(void)
{
    CRYPTO_free(privkey, "../test/threadstest.c", 1423);
    CRYPTO_free(storedir, "../test/threadstest.c", 1424);
