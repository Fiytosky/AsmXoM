# 0 "../test/chacha_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/chacha_internal_test.c"
# 15 "../test/chacha_internal_test.c"
...
# 16 "../test/chacha_internal_test.c" 2
...
# 17 "../test/chacha_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
# 18 "../test/chacha_internal_test.c" 2
...
# 19 "../test/chacha_internal_test.c" 2
...
static int test_cha_cha_internal(int n)
{
    ...
    for (j = 0; j < sizeof(ref); j++)
        if (!test_uchar_eq("../test/chacha_internal_test.c", 175, "buf[j]", "ref[j]", buf[j], ref[j])) {
            test_info("../test/chacha_internal_test.c", 176, "%d failed at %u (%02x)\n", i, j, buf[j]);
            return 0;
        }
    return 1;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_cha_cha_internal", test_cha_cha_internal, sizeof(ref), 1);
    return 1;
}
