...
# 13 "../test/gmdifftest.c" 2
# 22 "../test/gmdifftest.c"
static int check_time(long offset)
{
    ...
    o1 = tm1;
    if (!test_true("../test/gmdifftest.c", 35, "OPENSSL_gmtime_adj(&tm1, 0, offset)", (OPENSSL_gmtime_adj(&tm1, 0, offset)) != 0)
        || !test_int_eq("../test/gmdifftest.c", 36, "tm1.tm_year", "tm2.tm_year", tm1.tm_year, tm2.tm_year)
        || !test_int_eq("../test/gmdifftest.c", 37, "tm1.tm_mon", "tm2.tm_mon", tm1.tm_mon, tm2.tm_mon)
        || !test_int_eq("../test/gmdifftest.c", 38, "tm1.tm_mday", "tm2.tm_mday", tm1.tm_mday, tm2.tm_mday)
        || !test_int_eq("../test/gmdifftest.c", 39, "tm1.tm_hour", "tm2.tm_hour", tm1.tm_hour, tm2.tm_hour)
        || !test_int_eq("../test/gmdifftest.c", 40, "tm1.tm_min", "tm2.tm_min", tm1.tm_min, tm2.tm_min)
        || !test_int_eq("../test/gmdifftest.c", 41, "tm1.tm_sec", "tm2.tm_sec", tm1.tm_sec, tm2.tm_sec)
        || !test_true("../test/gmdifftest.c", 42, "OPENSSL_gmtime_diff(&off_day, &off_sec, &o1, &tm1)", (OPENSSL_gmtime_diff(&off_day, &off_sec, &o1, &tm1)) != 0))
        return 0;
    toffset = (long)off_day * (24 * 60 * 60) + off_sec;
    if (!test_long_eq("../test/gmdifftest.c", 45, "offset", "toffset", offset, toffset))
        return 0;
    return 1;
}
...
{
    if (sizeof(time_t) < 8)
        test_info("../test/gmdifftest.c", 63, "Skipping; time_t is less than 64-bits");
    else
