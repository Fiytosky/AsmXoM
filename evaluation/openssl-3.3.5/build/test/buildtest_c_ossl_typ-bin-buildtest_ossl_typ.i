# 0 "test/buildtest_ossl_typ.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_ossl_typ.c"
...
# 17 "../include/openssl/ossl_typ.h" 2
# 11 "test/buildtest_ossl_typ.c" 2
