# 0 "../test/ciphername_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ciphername_test.c"
# 12 "../test/ciphername_test.c"
...
static const char *get_std_name_by_id(int id)
{
    ...
    return 
# 376 "../test/ciphername_test.c" 3 4
          ((void *)0)
# 376 "../test/ciphername_test.c"
              ;
}
...
{
    SSL_CTX *ctx = 
# 381 "../test/ciphername_test.c" 3 4
                  ((void *)0)
# 381 "../test/ciphername_test.c"
                      ;
    SSL *ssl = 
# 382 "../test/ciphername_test.c" 3 4
              ((void *)0)
# 382 "../test/ciphername_test.c"
                  ;
    const SSL_CIPHER *c;
    struct stack_st_SSL_CIPHER *sk = 
# 384 "../test/ciphername_test.c" 3 4
                              ((void *)0)
# 384 "../test/ciphername_test.c"
                                  ;
...
# 389 "../test/ciphername_test.c" 3 4
                                ((void *)0)
# 389 "../test/ciphername_test.c"
                                    );
    if (!test_str_eq("../test/ciphername_test.c", 390, "p", "\"(NONE)\"", p, "(NONE)")) {
        test_info("../test/ciphername_test.c", 391, "test_cipher_name(std) failed: NULL input doesn't return \"(NONE)\"\n");
        goto err;
    }

    p = OPENSSL_cipher_name(
# 395 "../test/ciphername_test.c" 3 4
                           ((void *)0)
# 395 "../test/ciphername_test.c"
                               );
    if (!test_str_eq("../test/ciphername_test.c", 396, "p", "\"(NONE)\"", p, "(NONE)")) {
        test_info("../test/ciphername_test.c", 397, "test_cipher_name(ossl) failed: NULL input doesn't return \"(NONE)\"\n");
        goto err;
    }

    p = OPENSSL_cipher_name("This is not a valid cipher");
    if (!test_str_eq("../test/ciphername_test.c", 402, "p", "\"(NONE)\"", p, "(NONE)")) {
        test_info("../test/ciphername_test.c", 403, "test_cipher_name(ossl) failed: invalid input doesn't return \"(NONE)\"\n");
        goto err;
    }
    ...
    if (ctx == 
# 409 "../test/ciphername_test.c" 3 4
              ((void *)0)
# 409 "../test/ciphername_test.c"
                  ) {
        test_info("../test/ciphername_test.c", 410, "test_cipher_name failed: internal error\n");
        goto err;
    }

    if (!SSL_CTX_set_cipher_list(ctx, ciphers)) {
        test_info("../test/ciphername_test.c", 415, "test_cipher_name failed: internal error\n");
        goto err;
    }

    ssl = SSL_new(ctx);
    if (ssl == 
# 420 "../test/ciphername_test.c" 3 4
              ((void *)0)
# 420 "../test/ciphername_test.c"
                  ) {
        test_info("../test/ciphername_test.c", 421, "test_cipher_name failed: internal error\n");
        goto err;
    }

    sk = SSL_get_ciphers(ssl);
    if (sk == 
# 426 "../test/ciphername_test.c" 3 4
             ((void *)0)
# 426 "../test/ciphername_test.c"
                 ) {
        test_info("../test/ciphername_test.c", 427, "test_cipher_name failed: internal error\n");
        goto err;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)); i++) {
        ...
        if (!test_ptr("../test/ciphername_test.c", 439, "p", p)) {
            test_info("../test/ciphername_test.c", 440, "test_cipher_name failed: expected %s, got NULL, cipher %x\n", q, id)
                            ;
            goto err;
        }

        if (!test_str_eq("../test/ciphername_test.c", 445, "p", "q", p, q)) {
            test_info("../test/ciphername_test.c", 446, "test_cipher_name(std) failed: expected %s, got %s, cipher %x\n", q, p, id)
                                ;
            goto err;
        }
        ...
        if (!test_str_eq("../test/ciphername_test.c", 453, "r", "q", r, q)) {
            test_info("../test/ciphername_test.c", 454, "test_cipher_name(ossl) failed: expected %s, got %s, cipher %x\n", q, r, id)
                                ;
            goto err;
        }
    }
...
int setup_tests(void)
{
    add_test("test_cipher_name", test_cipher_name);
    return 1;
}
