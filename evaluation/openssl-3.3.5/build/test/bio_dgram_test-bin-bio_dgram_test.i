# 0 "../test/bio_dgram_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_dgram_test.c"
# 10 "../test/bio_dgram_test.c"
...
static int compare_addr(const BIO_ADDR *a, const BIO_ADDR *b)
{
    ...
    if (BIO_ADDR_family(a) == 
# 31 "../test/bio_dgram_test.c" 3 4
                             2
# 31 "../test/bio_dgram_test.c"
                                    ) {
        pa = &xa;
        pb = &xb;
        slen = sizeof(xa);
    ...
    else if (BIO_ADDR_family(a) == 
# 37 "../test/bio_dgram_test.c" 3 4
                                  10
# 37 "../test/bio_dgram_test.c"
                                          ) {
        pa = &xa6;
        pb = &xb6;
        slen = sizeof(xa6);
    ...
    tmplen = slen;
    if (!test_int_eq("../test/bio_dgram_test.c", 48, "BIO_ADDR_rawaddress(a, pa, &tmplen)", "1", BIO_ADDR_rawaddress(a, pa, &tmplen), 1))
        return 0;

    tmplen = slen;
    if (!test_int_eq("../test/bio_dgram_test.c", 52, "BIO_ADDR_rawaddress(b, pb, &tmplen)", "1", BIO_ADDR_rawaddress(b, pb, &tmplen), 1))
        return 0;

    if (!test_mem_eq("../test/bio_dgram_test.c", 55, "pa", "pb", pa, slen, pb, slen))
        return 0;

    if (!test_int_eq("../test/bio_dgram_test.c", 58, "BIO_ADDR_rawport(a)", "BIO_ADDR_rawport(b)", BIO_ADDR_rawport(a), BIO_ADDR_rawport(b)))
        return 0;
...
static int test_bio_dgram_impl(int af, int use_local)
{
    int testresult = 0;
    BIO *b1 = 
# 103 "../test/bio_dgram_test.c" 3 4
             ((void *)0)
# 103 "../test/bio_dgram_test.c"
                 , *b2 = 
# 103 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 103 "../test/bio_dgram_test.c"
    ...
    int fd1 = -1, fd2 = -1;
    BIO_ADDR *addr1 = 
# 105 "../test/bio_dgram_test.c" 3 4
                     ((void *)0)
# 105 "../test/bio_dgram_test.c"
                         , *addr2 = 
# 105 "../test/bio_dgram_test.c" 3 4
                                    ((void *)0)
# 105 "../test/bio_dgram_test.c"
...
# 105 "../test/bio_dgram_test.c"
                                                                      ,
             *addr5 = 
# 106 "../test/bio_dgram_test.c" 3 4
                     ((void *)0)
# 106 "../test/bio_dgram_test.c"
                         , *addr6 = 
# 106 "../test/bio_dgram_test.c" 3 4
                                    ((void *)0)
# 106 "../test/bio_dgram_test.c"
    ...
    if (af == 
# 119 "../test/bio_dgram_test.c" 3 4
             2
# 119 "../test/bio_dgram_test.c"
                    ) {
        test_info("../test/bio_dgram_test.c", 120, "# Testing with AF_INET, local=%d\n", use_local);
        pina = &ina;
        inal = sizeof(ina);
    }

    else if (af == 
# 125 "../test/bio_dgram_test.c" 3 4
                  10
# 125 "../test/bio_dgram_test.c"
                          ) {
        test_info("../test/bio_dgram_test.c", 126, "# Testing with AF_INET6, local=%d\n", use_local);
        pina = &ina6;
        inal = sizeof(ina6);
    }
    ...
    ina6.
# 138 "../test/bio_dgram_test.c" 3 4
        __in6_u.__u6_addr8
# 138 "../test/bio_dgram_test.c"
               [15] = 1;


    addr1 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 142, "addr1", addr1))
        goto err;

    addr2 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 146, "addr2", addr2))
        goto err;

    addr3 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 150, "addr3", addr3))
        goto err;

    addr4 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 154, "addr4", addr4))
        goto err;

    addr5 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 158, "addr5", addr5))
        goto err;

    addr6 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 162, "addr6", addr6))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 165, "BIO_ADDR_rawmake(addr1, af, pina, inal, 0)", "1", BIO_ADDR_rawmake(addr1, af, pina, inal, 0), 1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 168, "BIO_ADDR_rawmake(addr2, af, pina, inal, 0)", "1", BIO_ADDR_rawmake(addr2, af, pina, inal, 0), 1))
        goto err;

    fd1 = BIO_socket(af, 
# 171 "../test/bio_dgram_test.c" 3 4
                        SOCK_DGRAM
# 171 "../test/bio_dgram_test.c"
                                  , 
# 171 "../test/bio_dgram_test.c" 3 4
                                    IPPROTO_UDP
# 171 "../test/bio_dgram_test.c"
                                               , 0);
    if (!test_int_ge("../test/bio_dgram_test.c", 172, "fd1", "0", fd1, 0))
        goto err;

    fd2 = BIO_socket(af, 
# 175 "../test/bio_dgram_test.c" 3 4
                        SOCK_DGRAM
# 175 "../test/bio_dgram_test.c"
                                  , 
# 175 "../test/bio_dgram_test.c" 3 4
                                    IPPROTO_UDP
# 175 "../test/bio_dgram_test.c"
                                               , 0);
    if (!test_int_ge("../test/bio_dgram_test.c", 176, "fd2", "0", fd2, 0))
        goto err;

    if (BIO_bind(fd1, addr1, 0) <= 0
        || BIO_bind(fd2, addr2, 0) <= 0) {
        testresult = test_skip("../test/bio_dgram_test.c", 181, "BIO_bind() failed - assuming it's an unavailable address family");
        goto err;
    }

    info1.addr = addr1;
    if (!test_int_gt("../test/bio_dgram_test.c", 186, "BIO_sock_info(fd1, BIO_SOCK_INFO_ADDRESS, &info1)", "0", BIO_sock_info(fd1, BIO_SOCK_INFO_ADDRESS, &info1), 0))
        goto err;

    info2.addr = addr2;
    if (!test_int_gt("../test/bio_dgram_test.c", 190, "BIO_sock_info(fd2, BIO_SOCK_INFO_ADDRESS, &info2)", "0", BIO_sock_info(fd2, BIO_SOCK_INFO_ADDRESS, &info2), 0))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 193, "BIO_ADDR_rawport(addr1)", "0", BIO_ADDR_rawport(addr1), 0))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 196, "BIO_ADDR_rawport(addr2)", "0", BIO_ADDR_rawport(addr2), 0))
        goto err;

    b1 = BIO_new_dgram(fd1, 0);
    if (!test_ptr("../test/bio_dgram_test.c", 200, "b1", b1))
        goto err;

    b2 = BIO_new_dgram(fd2, 0);
    if (!test_ptr("../test/bio_dgram_test.c", 204, "b2", b2))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 207, "BIO_dgram_set_peer(b1, addr2)", "0", (int)BIO_ctrl(b1, 44, 0, (char *)(addr2)), 0))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 210, "BIO_write(b1, \"hello\", 5)", "0", BIO_write(b1, "hello", 5), 0))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 214, "BIO_read(b2, rx_buf, sizeof(rx_buf))", "5", BIO_read(b2, rx_buf, sizeof(rx_buf)), 5))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 217, "rx_buf", "\"hello\"", rx_buf, 5, "hello", 5))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 220, "BIO_dgram_get_peer(b2, addr3)", "0", (int)BIO_ctrl(b2, 46, 0, (char *)(addr3)), 0))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 223, "compare_addr(addr3, addr1)", "1", compare_addr(addr3, addr1), 1))
        goto err;


    if (!test_int_gt("../test/bio_dgram_test.c", 227, "BIO_ADDR_rawmake(addr3, af, pina, inal, 0)", "0", BIO_ADDR_rawmake(addr3, af, pina, inal, 0), 0))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 230, "BIO_dgram_set_peer(b1, addr3)", "0", (int)BIO_ctrl(b1, 44, 0, (char *)(addr3)), 0))
        goto err;

    if (!test_int_gt("../test/bio_dgram_test.c", 233, "BIO_dgram_set_peer(b2, addr3)", "0", (int)BIO_ctrl(b2, 44, 0, (char *)(addr3)), 0))
        goto err;
    ...
    tx_msg[0].data_len = 5;
    tx_msg[0].peer = 
# 239 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 239 "../test/bio_dgram_test.c"
                             ;
    tx_msg[0].local = 
# 240 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 240 "../test/bio_dgram_test.c"
                             ;
    tx_msg[0].flags = 0;
    ...
    tx_msg[1].data_len = 6;
    tx_msg[1].peer = 
# 245 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 245 "../test/bio_dgram_test.c"
                             ;
    tx_msg[1].local = 
# 246 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 246 "../test/bio_dgram_test.c"
                             ;
    tx_msg[1].flags = 0;


    if (!test_false("../test/bio_dgram_test.c", 250, "do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)", (do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 251, "num_processed", "0", num_processed, 0))
        goto err;
    ...
    if (!test_false("../test/bio_dgram_test.c", 262, "do_sendmmsg(b1, tx_msg, 2, 0, &num_processed) || !TEST_size_t_eq(num_processed, 0)", (do_sendmmsg(b1, tx_msg, 2, 0, &num_processed) || !test_size_t_eq("../test/bio_dgram_test.c", 263, "num_processed", "0", num_processed, 0)) != 0)
                                             )
        goto err;


    if ((int)BIO_ctrl((b1), 82, 0, 
# 267 "../test/bio_dgram_test.c" 3 4
       ((void *)0)
# 267 "../test/bio_dgram_test.c"
       ) > 0 && use_local) {
        if (!test_int_eq("../test/bio_dgram_test.c", 268, "BIO_dgram_set_local_addr_enable(b1, 1)", "1", (int)BIO_ctrl((b1), 84, (1), 
# 268 "../test/bio_dgram_test.c" 3 4
            ((void *)0)
# 268 "../test/bio_dgram_test.c"
            ), 1))
            goto err;
    } else {
        tx_msg[0].local = 
# 271 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 271 "../test/bio_dgram_test.c"
                             ;
        tx_msg[1].local = 
# 272 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 272 "../test/bio_dgram_test.c"
                             ;
        use_local = 0;
    }


    if (!test_true("../test/bio_dgram_test.c", 277, "do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)", (do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 278, "num_processed", "2", num_processed, 2))
        goto err;
    ...
    if (!test_false("../test/bio_dgram_test.c", 300, "do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)", (do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 301, "num_processed", "0", num_processed, 0))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 305, "(int)rx_msg[0].data_len", "sizeof(rx_buf)", (int)rx_msg[0].data_len, sizeof(rx_buf)))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 308, "(int)rx_msg[1].data_len", "sizeof(rx_buf2)", (int)rx_msg[1].data_len, sizeof(rx_buf2)))
        goto err;

    if (!test_ulong_eq("../test/bio_dgram_test.c", 311, "(unsigned long)rx_msg[0].flags", "1UL<<31", (unsigned long)rx_msg[0].flags, 1UL<<31))
        goto err;

    if (!test_ulong_eq("../test/bio_dgram_test.c", 314, "(unsigned long)rx_msg[1].flags", "1UL<<31", (unsigned long)rx_msg[1].flags, 1UL<<31))
        goto err;


    if ((int)BIO_ctrl((b2), 82, 0, 
# 318 "../test/bio_dgram_test.c" 3 4
       ((void *)0)
# 318 "../test/bio_dgram_test.c"
       ) > 0 && use_local) {
        if (!test_int_eq("../test/bio_dgram_test.c", 319, "BIO_dgram_set_local_addr_enable(b2, 1)", "1", (int)BIO_ctrl((b2), 84, (1), 
# 319 "../test/bio_dgram_test.c" 3 4
            ((void *)0)
# 319 "../test/bio_dgram_test.c"
            ), 1))
            goto err;
    } else {
        rx_msg[0].local = 
# 322 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 322 "../test/bio_dgram_test.c"
                             ;
        rx_msg[1].local = 
# 323 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 323 "../test/bio_dgram_test.c"
                             ;
        use_local = 0;
    }


    if (!test_true("../test/bio_dgram_test.c", 328, "do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)", (do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 329, "num_processed", "2", num_processed, 2))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 333, "(int)rx_msg[0].data_len", "5", (int)rx_msg[0].data_len, 5))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 336, "(int)rx_msg[1].data_len", "6", (int)rx_msg[1].data_len, 6))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 340, "(int)rx_msg[0].flags", "0", (int)rx_msg[0].flags, 0))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 343, "(int)rx_msg[1].flags", "0", (int)rx_msg[1].flags, 0))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 347, "compare_addr(addr3, addr1)", "1", compare_addr(addr3, addr1), 1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 350, "compare_addr(addr5, addr1)", "1", compare_addr(addr5, addr1), 1))
        goto err;
    ...
    if (!test_true("../test/bio_dgram_test.c", 359, "do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)", (do_sendmmsg(b1, tx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 360, "num_processed", "2", num_processed, 2))
        goto err;
    ...
    if (!test_true("../test/bio_dgram_test.c", 367, "do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)", (do_recvmmsg(b2, rx_msg, 2, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 368, "num_processed", "2", num_processed, 2))
        goto err;

    if (rx_msg[0].local != 
# 371 "../test/bio_dgram_test.c" 3 4
                          ((void *)0)
# 371 "../test/bio_dgram_test.c"
                              ) {

        if (!test_int_eq("../test/bio_dgram_test.c", 373, "compare_addr(addr4, addr2)", "1", compare_addr(addr4, addr2), 1))
            goto err;

        if (!test_int_eq("../test/bio_dgram_test.c", 376, "compare_addr(addr6, addr2)", "1", compare_addr(addr6, addr2), 1))
            goto err;
    }
    ...
    for (i = 0; i < (sizeof(tx_msg)/sizeof((tx_msg)[0])); ++i) {
        tx_buf[i] = (char)i;
        tx_msg[i].data = tx_buf + i;
        tx_msg[i].data_len = 1;
        tx_msg[i].peer = addr2;
        tx_msg[i].local = use_local ? addr1 : 
# 389 "../test/bio_dgram_test.c" 3 4
                                                 ((void *)0)
# 389 "../test/bio_dgram_test.c"
                                                     ;
        tx_msg[i].flags = 0;
    }
    if (!test_true("../test/bio_dgram_test.c", 392, "do_sendmmsg(b1, tx_msg, OSSL_NELEM(tx_msg), 0, &num_processed)", (do_sendmmsg(b1, tx_msg, (sizeof(tx_msg)/sizeof((tx_msg)[0])), 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 393, "num_processed", "OSSL_NELEM(tx_msg)", num_processed, (sizeof(tx_msg)/sizeof((tx_msg)[0]))))
        goto err;
    ...
    for (i = 0; i < (sizeof(rx_msg)/sizeof((rx_msg)[0])); ++i) {
        rx_buf[i] = '\0';
        rx_msg[i].data = rx_buf + i;
        rx_msg[i].data_len = 1;
        rx_msg[i].peer = 
# 404 "../test/bio_dgram_test.c" 3 4
                             ((void *)0)
# 404 "../test/bio_dgram_test.c"
                                 ;
        rx_msg[i].local = 
# 405 "../test/bio_dgram_test.c" 3 4
                             ((void *)0)
# 405 "../test/bio_dgram_test.c"
                                 ;
        rx_msg[i].flags = 0;
    }
    if (!test_true("../test/bio_dgram_test.c", 408, "do_recvmmsg(b2, rx_msg, OSSL_NELEM(rx_msg), 0, &num_processed)", (do_recvmmsg(b2, rx_msg, (sizeof(rx_msg)/sizeof((rx_msg)[0])), 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 409, "num_processed", "OSSL_NELEM(rx_msg)", num_processed, (sizeof(rx_msg)/sizeof((rx_msg)[0]))))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 412, "tx_buf", "rx_buf", tx_buf, (sizeof(tx_msg)/sizeof((tx_msg)[0])), rx_buf, (sizeof(tx_msg)/sizeof((tx_msg)[0]))))
        goto err;
...
static const struct bio_dgram_case bio_dgram_cases[] = {
    ...
    { 
# 438 "../test/bio_dgram_test.c" 3 4
     2
# 438 "../test/bio_dgram_test.c"
            , 0 },

    { 
# 440 "../test/bio_dgram_test.c" 3 4
     10
# 440 "../test/bio_dgram_test.c"
             , 0 },


    { 
# 443 "../test/bio_dgram_test.c" 3 4
     2
# 443 "../test/bio_dgram_test.c"
            , 1 },

    { 
# 445 "../test/bio_dgram_test.c" 3 4
     10
# 445 "../test/bio_dgram_test.c"
             , 1 }
...
static int random_data(const uint32_t *key, uint8_t *data, size_t data_len, size_t offset)
{
    int ret = 0, outl;
    EVP_CIPHER_CTX *ctx = 
# 459 "../test/bio_dgram_test.c" 3 4
                         ((void *)0)
# 459 "../test/bio_dgram_test.c"
                             ;
    EVP_CIPHER *cipher = 
# 460 "../test/bio_dgram_test.c" 3 4
                        ((void *)0)
# 460 "../test/bio_dgram_test.c"
                            ;
    ...
    if (ctx == 
# 467 "../test/bio_dgram_test.c" 3 4
              ((void *)0)
# 467 "../test/bio_dgram_test.c"
                  )
        goto err;

    cipher = EVP_CIPHER_fetch(
# 470 "../test/bio_dgram_test.c" 3 4
                             ((void *)0)
# 470 "../test/bio_dgram_test.c"
                                 , "ChaCha20", 
# 470 "../test/bio_dgram_test.c" 3 4
                                               ((void *)0)
# 470 "../test/bio_dgram_test.c"
    ...
    if (cipher == 
# 471 "../test/bio_dgram_test.c" 3 4
                 ((void *)0)
# 471 "../test/bio_dgram_test.c"
                     )
        goto err;

    if (EVP_EncryptInit_ex2(ctx, cipher, (uint8_t *)key, (uint8_t *)counter, 
# 474 "../test/bio_dgram_test.c" 3 4
                                                                            ((void *)0)
# 474 "../test/bio_dgram_test.c"
                                                                                ) == 0)
        goto err;
...
static int test_bio_dgram_pair(int idx)
{
    ...
    BIO *bio1 = 
# 496 "../test/bio_dgram_test.c" 3 4
               ((void *)0)
# 496 "../test/bio_dgram_test.c"
                   , *bio2 = 
# 496 "../test/bio_dgram_test.c" 3 4
                             ((void *)0)
# 496 "../test/bio_dgram_test.c"
    ...
    BIO_ADDR *addr1 = 
# 501 "../test/bio_dgram_test.c" 3 4
                     ((void *)0)
# 501 "../test/bio_dgram_test.c"
                         , *addr2 = 
# 501 "../test/bio_dgram_test.c" 3 4
                                    ((void *)0)
# 501 "../test/bio_dgram_test.c"
...
# 501 "../test/bio_dgram_test.c"
    ...
    if (idx == 0) {
        if (!test_int_eq("../test/bio_dgram_test.c", 518, "BIO_new_bio_dgram_pair(&bio1, 0, &bio2, 0)", "1", BIO_new_bio_dgram_pair(&bio1, 0, &bio2, 0), 1))
            goto err;
    } else {
        if (!test_ptr("../test/bio_dgram_test.c", 521, "bio1 = bio2 = BIO_new(BIO_s_dgram_mem())", bio1 = bio2 = BIO_new(BIO_s_dgram_mem())))
            goto err;
    }

    mtu1 = (unsigned int)BIO_ctrl((bio1), 41, 0, 
# 525 "../test/bio_dgram_test.c" 3 4
          ((void *)0)
# 525 "../test/bio_dgram_test.c"
          );
    if (!test_int_ge("../test/bio_dgram_test.c", 526, "mtu1", "1280", mtu1, 1280))
        goto err;
    ...
    if (idx == 1) {
        ...
        if (!test_true("../test/bio_dgram_test.c", 537, "BIO_set_write_buf_size(bio1, bufsz)", ((int)BIO_ctrl(bio1,136,bufsz,
# 537 "../test/bio_dgram_test.c" 3 4
            ((void *)0)
# 537 "../test/bio_dgram_test.c"
            )) != 0))
            goto err;
    }

    mtu2 = (unsigned int)BIO_ctrl((bio2), 41, 0, 
# 541 "../test/bio_dgram_test.c" 3 4
          ((void *)0)
# 541 "../test/bio_dgram_test.c"
          );
    if (!test_int_ge("../test/bio_dgram_test.c", 542, "mtu2", "1280", mtu2, 1280))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 545, "mtu1", "mtu2", mtu1, mtu2))
        goto err;

    if (!test_int_le("../test/bio_dgram_test.c", 548, "mtu1", "sizeof(scratch) - 4", mtu1, sizeof(scratch) - 4))
        goto err;

    for (i = 0; total < 1 * 1024 * 1024; ++i) {
        if (!test_int_eq("../test/bio_dgram_test.c", 552, "random_data(key, scratch, sizeof(scratch), i)", "1", random_data(key, scratch, sizeof(scratch), i), 1))
            goto err;
        ...
        if (!test_int_eq("../test/bio_dgram_test.c", 560, "r", "blen", r, blen))
            goto err;

        total += blen;
    }

    if (idx <= 1 && !test_size_t_lt("../test/bio_dgram_test.c", 566, "total", "1 * 1024 * 1024", total, 1 * 1024 * 1024))
        goto err;

    if (idx == 2 && !test_size_t_ge("../test/bio_dgram_test.c", 569, "total", "1 * 1024 * 1024", total, 1 * 1024 * 1024))
        goto err;
# 579 "../test/bio_dgram_test.c"
    if (!test_int_ge("../test/bio_dgram_test.c", 579, "i", "9", i, 9))
        goto err;


    num_dgram = i;
    for (i = 0; i < num_dgram; ++i) {
        if (!test_int_eq("../test/bio_dgram_test.c", 585, "random_data(key, scratch, sizeof(scratch), i)", "1", random_data(key, scratch, sizeof(scratch), i), 1))
            goto err;

        blen = ((*(uint32_t*)scratch) % mtu1) + 1;
        r = BIO_read(bio2, scratch2, sizeof(scratch2));
        if (!test_int_eq("../test/bio_dgram_test.c", 590, "r", "blen", r, blen))
            goto err;

        if (!test_mem_eq("../test/bio_dgram_test.c", 593, "scratch + 4", "scratch2", scratch + 4, blen, scratch2, blen))
            goto err;
    }


    if (!test_int_eq("../test/bio_dgram_test.c", 598, "BIO_read(bio2, scratch2, sizeof(scratch2))", "-1", BIO_read(bio2, scratch2, sizeof(scratch2)), -1))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 602, "random_data(key, scratch, sizeof(scratch), 0)", "1", random_data(key, scratch, sizeof(scratch), 0), 1))
        goto err;
    ...
    if (!test_true("../test/bio_dgram_test.c", 610, "BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), OSSL_NELEM(msgs), 0, &num_processed)", (BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), (sizeof(msgs)/sizeof((msgs)[0])), 0, &num_processed)) != 0)

        || !test_size_t_eq("../test/bio_dgram_test.c", 612, "num_processed", "2", num_processed, 2))
        goto err;
    ...
    rmsgs[1].data_len = 64;
    if (!test_true("../test/bio_dgram_test.c", 619, "BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), OSSL_NELEM(rmsgs), 0, &num_processed)", (BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), (sizeof(rmsgs)/sizeof((rmsgs)[0])), 0, &num_processed)) != 0)

        || !test_size_t_eq("../test/bio_dgram_test.c", 621, "num_processed", "2", num_processed, 2))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 624, "rmsgs[0].data", "scratch", rmsgs[0].data, rmsgs[0].data_len, scratch, 19))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 627, "rmsgs[1].data", "scratch + 19", rmsgs[1].data, rmsgs[1].data_len, scratch + 19, 46))
        goto err;


    addr1 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 632, "addr1", addr1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 635, "BIO_ADDR_rawmake(addr1, AF_INET, &in_local, sizeof(in_local), 1234)", "1", BIO_ADDR_rawmake(addr1, 
# 635 "../test/bio_dgram_test.c" 3 4
        2
# 635 "../test/bio_dgram_test.c"
        , &in_local, sizeof(in_local), 1234), 1)
                                                                 )
        goto err;

    addr2 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 640, "addr2", addr2))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 643, "BIO_ADDR_rawmake(addr2, AF_INET, &in_local, sizeof(in_local), 2345)", "1", BIO_ADDR_rawmake(addr2, 
# 643 "../test/bio_dgram_test.c" 3 4
        2
# 643 "../test/bio_dgram_test.c"
        , &in_local, sizeof(in_local), 2345), 1)
                                                                 )
        goto err;

    addr3 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 648, "addr3", addr3))
        goto err;

    addr4 = BIO_ADDR_new();
    if (!test_ptr("../test/bio_dgram_test.c", 652, "addr4", addr4))
        goto err;

    msgs[0].peer = addr1;


    if (!test_false("../test/bio_dgram_test.c", 658, "BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), OSSL_NELEM(msgs), 0, &num_processed)", (BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), (sizeof(msgs)/sizeof((msgs)[0])), 0, &num_processed)) != 0)

        || !test_size_t_eq("../test/bio_dgram_test.c", 660, "num_processed", "0", num_processed, 0))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 663, "BIO_dgram_set_caps(bio2, ref_caps)", "1", (int)BIO_ctrl((bio2), 87, (long)(ref_caps), 
# 663 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 663 "../test/bio_dgram_test.c"
        ), 1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 666, "BIO_dgram_get_caps(bio2)", "ref_caps", (uint32_t)BIO_ctrl((bio2), 86, 0, 
# 666 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 666 "../test/bio_dgram_test.c"
        ), ref_caps))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 669, "BIO_dgram_get_effective_caps(bio1)", "ref_caps", (uint32_t)BIO_ctrl((bio1), 85, 0, 
# 669 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 669 "../test/bio_dgram_test.c"
        ), ref_caps))
        goto err;

    if (idx == 0 && !test_int_eq("../test/bio_dgram_test.c", 672, "BIO_dgram_get_effective_caps(bio2)", "0", (uint32_t)BIO_ctrl((bio2), 85, 0, 
# 672 "../test/bio_dgram_test.c" 3 4
                    ((void *)0)
# 672 "../test/bio_dgram_test.c"
                    ), 0))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 675, "BIO_dgram_set_caps(bio1, ref_caps)", "1", (int)BIO_ctrl((bio1), 87, (long)(ref_caps), 
# 675 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 675 "../test/bio_dgram_test.c"
        ), 1))
        goto err;


    if (!test_true("../test/bio_dgram_test.c", 679, "BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), 1, 0, &num_processed)", (BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), 1, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 680, "num_processed", "1", num_processed, 1))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 684, "BIO_dgram_set_local_addr_enable(bio2, 1)", "1", (int)BIO_ctrl((bio2), 84, (1), 
# 684 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 684 "../test/bio_dgram_test.c"
        ), 1))
        goto err;
    ...
    rmsgs[0].peer = addr3;
    rmsgs[0].local = addr4;
    if (!test_true("../test/bio_dgram_test.c", 691, "BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), OSSL_NELEM(rmsgs), 0, &num_processed)", (BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), (sizeof(rmsgs)/sizeof((rmsgs)[0])), 0, &num_processed)) != 0)

        || !test_size_t_eq("../test/bio_dgram_test.c", 693, "num_processed", "1", num_processed, 1))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 696, "rmsgs[0].data", "msgs[0].data", rmsgs[0].data, rmsgs[0].data_len, msgs[0].data, 19))
        goto err;


    if (!test_int_eq("../test/bio_dgram_test.c", 700, "BIO_ADDR_family(addr3)", "0", BIO_ADDR_family(addr3), 0))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 703, "BIO_ADDR_family(addr4)", "AF_INET", BIO_ADDR_family(addr4), 
# 703 "../test/bio_dgram_test.c" 3 4
        2
# 703 "../test/bio_dgram_test.c"
        ))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 706, "BIO_ADDR_rawport(addr4)", "1234", BIO_ADDR_rawport(addr4), 1234))
        goto err;


    msgs[0].local = addr2;

    if (!test_int_eq("../test/bio_dgram_test.c", 712, "BIO_dgram_set_local_addr_enable(bio1, 1)", "1", (int)BIO_ctrl((bio1), 84, (1), 
# 712 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 712 "../test/bio_dgram_test.c"
        ), 1))
        goto err;

    if (!test_true("../test/bio_dgram_test.c", 715, "BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), 1, 0, &num_processed)", (BIO_sendmmsg(bio1, msgs, sizeof(BIO_MSG), 1, 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 716, "num_processed", "1", num_processed, 1))
        goto err;

    rmsgs[0].data = scratch2;
    rmsgs[0].data_len = 64;
    if (!test_true("../test/bio_dgram_test.c", 721, "BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), OSSL_NELEM(rmsgs), 0, &num_processed)", (BIO_recvmmsg(bio2, rmsgs, sizeof(BIO_MSG), (sizeof(rmsgs)/sizeof((rmsgs)[0])), 0, &num_processed)) != 0)
        || !test_size_t_eq("../test/bio_dgram_test.c", 722, "num_processed", "1", num_processed, 1))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 725, "rmsgs[0].data", "msgs[0].data", rmsgs[0].data, rmsgs[0].data_len, msgs[0].data, msgs[0].data_len)
                                                    )
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 729, "BIO_ADDR_family(addr3)", "AF_INET", BIO_ADDR_family(addr3), 
# 729 "../test/bio_dgram_test.c" 3 4
        2
# 729 "../test/bio_dgram_test.c"
        ))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 732, "BIO_ADDR_rawport(addr3)", "2345", BIO_ADDR_rawport(addr3), 2345))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 735, "BIO_ADDR_family(addr4)", "AF_INET", BIO_ADDR_family(addr4), 
# 735 "../test/bio_dgram_test.c" 3 4
        2
# 735 "../test/bio_dgram_test.c"
        ))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 738, "BIO_ADDR_rawport(addr4)", "1234", BIO_ADDR_rawport(addr4), 1234))
        goto err;


    r = BIO_write(bio1, scratch, 64);
    if (!test_int_eq("../test/bio_dgram_test.c", 743, "r", "64", r, 64))
        goto err;

    memset(scratch2, 0, 64);
    if (!test_int_eq("../test/bio_dgram_test.c", 747, "BIO_dgram_set_no_trunc(bio2, 1)", "1", (int)BIO_ctrl((bio2), 89, (1), 
# 747 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 747 "../test/bio_dgram_test.c"
        ), 1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 750, "BIO_read(bio2, scratch2, 32)", "-1", BIO_read(bio2, scratch2, 32), -1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 753, "BIO_pending(bio2)", "64", (int)BIO_ctrl(bio2,10,0,
# 753 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 753 "../test/bio_dgram_test.c"
        ), 64))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 756, "BIO_dgram_set_no_trunc(bio2, 0)", "1", (int)BIO_ctrl((bio2), 89, (0), 
# 756 "../test/bio_dgram_test.c" 3 4
        ((void *)0)
# 756 "../test/bio_dgram_test.c"
        ), 1))
        goto err;

    if (!test_int_eq("../test/bio_dgram_test.c", 759, "BIO_read(bio2, scratch2, 32)", "32", BIO_read(bio2, scratch2, 32), 32))
        goto err;

    if (!test_mem_eq("../test/bio_dgram_test.c", 762, "scratch", "scratch2", scratch, 32, scratch2, 32))
        goto err;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/bio_dgram_test.c", 782, "Error parsing test options\n");
        return 0;
    }


    add_all_tests("test_bio_dgram", test_bio_dgram, (sizeof(bio_dgram_cases)/sizeof((bio_dgram_cases)[0])), 1);
