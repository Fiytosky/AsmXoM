# 0 "../test/evp_extra_test2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_extra_test2.c"
# 20 "../test/evp_extra_test2.c"
...
# 23 "../test/evp_extra_test2.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 26 "../test/evp_extra_test2.c" 2
...
# 29 "../test/evp_extra_test2.c" 2


static OSSL_LIB_CTX *mainctx = 
# 31 "../test/evp_extra_test2.c" 3 4
                              ((void *)0)
# 31 "../test/evp_extra_test2.c"
                                  ;
static OSSL_PROVIDER *nullprov = 
# 32 "../test/evp_extra_test2.c" 3 4
                                ((void *)0)
# 32 "../test/evp_extra_test2.c"
                                    ;
...
static APK_DATA keydata[] = {
    {kExampleRSAKeyDER, sizeof(kExampleRSAKeyDER), 6},
    {kExampleRSAKeyPKCS8, sizeof(kExampleRSAKeyPKCS8), 6},


    {kExampleECXKey2DER, sizeof(kExampleECXKey2DER), 1034},

    {kExampleECKeyDER, sizeof(kExampleECKeyDER), 408},
    {kExampleECKey2DER, sizeof(kExampleECKey2DER), 408},


    {kExampleDHPrivateKeyDER, sizeof(kExampleDHPrivateKeyDER), 28},
...
# 274 "../test/evp_extra_test2.c" 3 4
                                             ((void *)0)
# 274 "../test/evp_extra_test2.c"
                                                 );
    } else {
        BIGNUM *bn = 
# 276 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 276 "../test/evp_extra_test2.c"
                        ;
...
# 287 "../test/evp_extra_test2.c" 3 4
                            ((void *)0)
# 287 "../test/evp_extra_test2.c"
                                , *keypair_params = 
# 287 "../test/evp_extra_test2.c" 3 4
                                                    ((void *)0)
# 287 "../test/evp_extra_test2.c"
                                                        ;
    EVP_PKEY *fromkey = 
# 288 "../test/evp_extra_test2.c" 3 4
                       ((void *)0)
# 288 "../test/evp_extra_test2.c"
                           , *fromkeypair = 
# 288 "../test/evp_extra_test2.c" 3 4
                                            ((void *)0)
# 288 "../test/evp_extra_test2.c"
                                                ;
    EVP_PKEY_CTX *fromctx = 
# 289 "../test/evp_extra_test2.c" 3 4
                           ((void *)0)
# 289 "../test/evp_extra_test2.c"
                               ;
    ...
    if (!test_int_eq("../test/evp_extra_test2.c", 297, "EVP_PKEY_todata(key, EVP_PKEY_PUBLIC_KEY, &pub_params)", "1", EVP_PKEY_todata(key, ( ( ( 0x04 | 0x80) ) | 0x02 ), &pub_params), 1)
        || !test_ptr_null("../test/evp_extra_test2.c", 298, "OSSL_PARAM_locate(pub_params, privtag)", OSSL_PARAM_locate(pub_params, privtag)))
        goto end;




    if (!test_int_eq("../test/evp_extra_test2.c", 304, "EVP_PKEY_todata(key, EVP_PKEY_KEYPAIR, &keypair_params)", "1", EVP_PKEY_todata(key, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), &keypair_params), 1)
        || !test_ptr("../test/evp_extra_test2.c", 305, "OSSL_PARAM_locate(keypair_params, privtag)", OSSL_PARAM_locate(keypair_params, privtag)))
        goto end;
    ...
    if (!test_ptr("../test/evp_extra_test2.c", 312, "fromctx = EVP_PKEY_CTX_new_from_name(mainctx, keytype, NULL)", fromctx = EVP_PKEY_CTX_new_from_name(mainctx, keytype, 
# 312 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 312 "../test/evp_extra_test2.c"
        ))
        || !test_int_eq("../test/evp_extra_test2.c", 313, "EVP_PKEY_fromdata_init(fromctx)", "1", EVP_PKEY_fromdata_init(fromctx), 1)
        || !test_int_eq("../test/evp_extra_test2.c", 314, "EVP_PKEY_fromdata(fromctx, &fromkey, EVP_PKEY_PUBLIC_KEY, keypair_params)", "1", EVP_PKEY_fromdata(fromctx, &fromkey, ( ( ( 0x04 | 0x80) ) | 0x02 ), keypair_params), 1)

        || !test_false("../test/evp_extra_test2.c", 316, "pkey_has_private(fromkey, privtag, use_octstring)", (pkey_has_private(fromkey, privtag, use_octstring)) != 0))
        goto end;




    if (!test_int_eq("../test/evp_extra_test2.c", 322, "EVP_PKEY_fromdata(fromctx, &fromkeypair, EVP_PKEY_KEYPAIR, keypair_params)", "1", EVP_PKEY_fromdata(fromctx, &fromkeypair, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), keypair_params), 1)

        || !test_true("../test/evp_extra_test2.c", 324, "pkey_has_private(fromkeypair, privtag, use_octstring)", (pkey_has_private(fromkeypair, privtag, use_octstring)) != 0))
        goto end;
    ret = 1;
end:
...
static int test_dh_tofrom_data_select(void)
{
    ...
    OSSL_PARAM params[2];
    EVP_PKEY *key = 
# 341 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 341 "../test/evp_extra_test2.c"
                       ;
    EVP_PKEY_CTX *gctx = 
# 342 "../test/evp_extra_test2.c" 3 4
                        ((void *)0)
# 342 "../test/evp_extra_test2.c"
                            ;
    ...
    ret = test_ptr("../test/evp_extra_test2.c", 350, "gctx = EVP_PKEY_CTX_new_from_name(mainctx, \"DHX\", NULL)", gctx = EVP_PKEY_CTX_new_from_name(mainctx, "DHX", 
# 350 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 350 "../test/evp_extra_test2.c"
         ))
          && test_int_gt("../test/evp_extra_test2.c", 351, "EVP_PKEY_keygen_init(gctx)", "0", EVP_PKEY_keygen_init(gctx), 0)
          && test_true("../test/evp_extra_test2.c", 352, "EVP_PKEY_CTX_set_params(gctx, params)", (EVP_PKEY_CTX_set_params(gctx, params)) != 0)
          && test_int_gt("../test/evp_extra_test2.c", 353, "EVP_PKEY_generate(gctx, &key)", "0", EVP_PKEY_generate(gctx, &key), 0)
          && test_true("../test/evp_extra_test2.c", 354, "do_pkey_tofrom_data_select(key, \"DHX\")", (do_pkey_tofrom_data_select(key, "DHX")) != 0);

    ret = ret && test_ptr("../test/evp_extra_test2.c", 356, "dhkey = EVP_PKEY_get0_DH(key)", dhkey = EVP_PKEY_get0_DH(key))
              && test_ptr("../test/evp_extra_test2.c", 357, "privkey = DH_get0_priv_key(dhkey)", privkey = DH_get0_priv_key(dhkey))
              && test_int_le("../test/evp_extra_test2.c", 358, "BN_num_bits(privkey)", "225", BN_num_bits(privkey), 225);
...
static int test_dh_paramgen(void)
{
    ...
    OSSL_PARAM params[3];
    EVP_PKEY *pkey = 
# 369 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 369 "../test/evp_extra_test2.c"
                        ;
    EVP_PKEY_CTX *gctx = 
# 370 "../test/evp_extra_test2.c" 3 4
                        ((void *)0)
# 370 "../test/evp_extra_test2.c"
                            ;
    unsigned int pbits = 512;

    params[0] = OSSL_PARAM_construct_uint("pbits", &pbits);
    params[1] = OSSL_PARAM_construct_utf8_string("type",
                                                 "generator", 0);
    params[2] = OSSL_PARAM_construct_end();

    ret = test_ptr("../test/evp_extra_test2.c", 378, "gctx = EVP_PKEY_CTX_new_from_name(mainctx, \"DH\", NULL)", gctx = EVP_PKEY_CTX_new_from_name(mainctx, "DH", 
# 378 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 378 "../test/evp_extra_test2.c"
         ))
          && test_int_gt("../test/evp_extra_test2.c", 379, "EVP_PKEY_paramgen_init(gctx)", "0", EVP_PKEY_paramgen_init(gctx), 0)
          && test_true("../test/evp_extra_test2.c", 380, "EVP_PKEY_CTX_set_params(gctx, params)", (EVP_PKEY_CTX_set_params(gctx, params)) != 0)
          && test_true("../test/evp_extra_test2.c", 381, "EVP_PKEY_paramgen(gctx, &pkey)", (EVP_PKEY_paramgen(gctx, &pkey)) != 0)
          && test_ptr("../test/evp_extra_test2.c", 382, "pkey", pkey);

    EVP_PKEY_CTX_free(gctx);
    gctx = 
# 385 "../test/evp_extra_test2.c" 3 4
          ((void *)0)
# 385 "../test/evp_extra_test2.c"
              ;

    ret = ret && test_ptr("../test/evp_extra_test2.c", 387, "gctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, NULL)", gctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, 
# 387 "../test/evp_extra_test2.c" 3 4
                ((void *)0)
# 387 "../test/evp_extra_test2.c"
                ))
              && test_int_eq("../test/evp_extra_test2.c", 388, "EVP_PKEY_param_check(gctx)", "1", EVP_PKEY_param_check(gctx), 1)
              && test_int_eq("../test/evp_extra_test2.c", 389, "EVP_PKEY_param_check_quick(gctx)", "1", EVP_PKEY_param_check_quick(gctx), 1);
...
static int set_fromdata_string(EVP_PKEY_CTX *ctx, const char *name, char *value)
{
    ...
    OSSL_PARAM params[2];
    EVP_PKEY *pkey = 
# 400 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 400 "../test/evp_extra_test2.c"
                        ;
    ...
    params[1] = OSSL_PARAM_construct_end();
    ret = EVP_PKEY_fromdata(ctx, &pkey, ( ( 0x04 | 0x80) ), params);
    EVP_PKEY_free(pkey);
    return ret;
}
...
static int set_fromdata_uint(EVP_PKEY_CTX *ctx, const char *name)
{
    ...
    OSSL_PARAM params[2];
    EVP_PKEY *pkey = 
# 416 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 416 "../test/evp_extra_test2.c"
                        ;
...
{
    EVP_PKEY_CTX *ctx = 
# 429 "../test/evp_extra_test2.c" 3 4
                       ((void *)0)
# 429 "../test/evp_extra_test2.c"
                           ;
    int ret = 0;


    ret = test_ptr("../test/evp_extra_test2.c", 433, "ctx = EVP_PKEY_CTX_new_from_name(mainctx, \"DH\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(mainctx, "DH", 
# 433 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 433 "../test/evp_extra_test2.c"
         ))
          && test_int_eq("../test/evp_extra_test2.c", 434, "set_fromdata_uint(ctx, OSSL_PKEY_PARAM_GROUP_NAME)", "0", set_fromdata_uint(ctx, "group"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 435, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_GROUP_NAME, \"bad\")", "0", set_fromdata_string(ctx, "group", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 436, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_P, \"bad\")", "0", set_fromdata_string(ctx, "p", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 437, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_GINDEX, \"bad\")", "0", set_fromdata_string(ctx, "gindex", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 438, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_PCOUNTER, \"bad\")", "0", set_fromdata_string(ctx, "pcounter", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 439, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_COFACTOR, \"bad\")", "0", set_fromdata_string(ctx, "j", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 440, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_H, \"bad\")", "0", set_fromdata_string(ctx, "hindex", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 441, "set_fromdata_uint(ctx, OSSL_PKEY_PARAM_FFC_SEED)", "0", set_fromdata_uint(ctx, "seed"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 442, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_VALIDATE_PQ, \"bad\")", "0", set_fromdata_string(ctx, "validate-pq", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 443, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_VALIDATE_G, \"bad\")", "0", set_fromdata_string(ctx, "validate-g", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 444, "set_fromdata_string(ctx, OSSL_PKEY_PARAM_FFC_VALIDATE_LEGACY, \"bad\")", "0", set_fromdata_string(ctx, "validate-legacy", "bad"), 0)
          && test_int_eq("../test/evp_extra_test2.c", 445, "set_fromdata_uint(ctx, OSSL_PKEY_PARAM_FFC_DIGEST)", "0", set_fromdata_uint(ctx, "digest"), 0);
...
static int test_ec_d2i_i2d_pubkey(void)
{
    int ret = 0;
    FILE *fp = 
# 458 "../test/evp_extra_test2.c" 3 4
              ((void *)0)
# 458 "../test/evp_extra_test2.c"
                  ;
    EVP_PKEY *key = 
# 459 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 459 "../test/evp_extra_test2.c"
                       , *outkey = 
# 459 "../test/evp_extra_test2.c" 3 4
                                   ((void *)0)
# 459 "../test/evp_extra_test2.c"
    ...
    if (!test_ptr("../test/evp_extra_test2.c", 462, "fp = fopen(filename, \"wb\")", fp = fopen(filename, "wb"))
        || !test_ptr("../test/evp_extra_test2.c", 463, "key = EVP_PKEY_Q_keygen(mainctx, NULL, \"EC\", \"P-256\")", key = EVP_PKEY_Q_keygen(mainctx, 
# 463 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 463 "../test/evp_extra_test2.c"
           , "EC", "P-256"))
        || !test_true("../test/evp_extra_test2.c", 464, "i2d_PUBKEY_fp(fp, key)", (i2d_PUBKEY_fp(fp, key)) != 0)
        || !test_int_eq("../test/evp_extra_test2.c", 465, "fclose(fp)", "0", fclose(fp), 0))
        goto err;
    fp = 
# 467 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 467 "../test/evp_extra_test2.c"
            ;

    if (!test_ptr("../test/evp_extra_test2.c", 469, "fp = fopen(filename, \"rb\")", fp = fopen(filename, "rb"))
        || !test_ptr("../test/evp_extra_test2.c", 470, "outkey = d2i_PUBKEY_ex_fp(fp, NULL, mainctx, NULL)", outkey = d2i_PUBKEY_ex_fp(fp, 
# 470 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 470 "../test/evp_extra_test2.c"
           , mainctx, 
# 470 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 470 "../test/evp_extra_test2.c"
           ))
        || !test_int_eq("../test/evp_extra_test2.c", 471, "EVP_PKEY_eq(key, outkey)", "1", EVP_PKEY_eq(key, outkey), 1))
        goto err;
...
static int test_ec_tofrom_data_select(void)
{
    int ret;
    EVP_PKEY *key = 
# 486 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 486 "../test/evp_extra_test2.c"
                       ;

    ret = test_ptr("../test/evp_extra_test2.c", 488, "key = EVP_PKEY_Q_keygen(mainctx, NULL, \"EC\", \"P-256\")", key = EVP_PKEY_Q_keygen(mainctx, 
# 488 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 488 "../test/evp_extra_test2.c"
         , "EC", "P-256"))
          && test_true("../test/evp_extra_test2.c", 489, "do_pkey_tofrom_data_select(key, \"EC\")", (do_pkey_tofrom_data_select(key, "EC")) != 0);
    EVP_PKEY_free(key);
    return ret;
}
...
static int test_ecx_tofrom_data_select(void)
{
    int ret;
    EVP_PKEY *key = 
# 498 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 498 "../test/evp_extra_test2.c"
                       ;

    ret = test_ptr("../test/evp_extra_test2.c", 500, "key = EVP_PKEY_Q_keygen(mainctx, NULL, \"X25519\")", key = EVP_PKEY_Q_keygen(mainctx, 
# 500 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 500 "../test/evp_extra_test2.c"
         , "X25519"))
          && test_true("../test/evp_extra_test2.c", 501, "do_pkey_tofrom_data_select(key, \"X25519\")", (do_pkey_tofrom_data_select(key, "X25519")) != 0);
    EVP_PKEY_free(key);
    return ret;
}
...
static int test_sm2_tofrom_data_select(void)
{
    int ret;
    EVP_PKEY *key = 
# 512 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 512 "../test/evp_extra_test2.c"
                       ;

    ret = test_ptr("../test/evp_extra_test2.c", 514, "key = EVP_PKEY_Q_keygen(mainctx, NULL, \"SM2\")", key = EVP_PKEY_Q_keygen(mainctx, 
# 514 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 514 "../test/evp_extra_test2.c"
         , "SM2"))
          && test_true("../test/evp_extra_test2.c", 515, "do_pkey_tofrom_data_select(key, \"SM2\")", (do_pkey_tofrom_data_select(key, "SM2")) != 0);
    EVP_PKEY_free(key);
    return ret;
}
...
static int test_rsa_tofrom_data_select(void)
{
    int ret;
    EVP_PKEY *key = 
# 524 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 524 "../test/evp_extra_test2.c"
                       ;
    const unsigned char *pdata = kExampleRSAKeyDER;
    int pdata_len = sizeof(kExampleRSAKeyDER);

    ret = test_ptr("../test/evp_extra_test2.c", 528, "key = d2i_AutoPrivateKey_ex(NULL, &pdata, pdata_len, mainctx, NULL)", key = d2i_AutoPrivateKey_ex(
# 528 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 528 "../test/evp_extra_test2.c"
         , &pdata, pdata_len, mainctx, 
# 528 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 528 "../test/evp_extra_test2.c"
         ))

          && test_true("../test/evp_extra_test2.c", 530, "do_pkey_tofrom_data_select(key, \"RSA\")", (do_pkey_tofrom_data_select(key, "RSA")) != 0);
    EVP_PKEY_free(key);
    return ret;
}
...
static int test_d2i_AutoPrivateKey_ex(int i)
{
    ...
    EVP_PKEY *pkey = 
# 540 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 540 "../test/evp_extra_test2.c"
                        ;
    ...
    BIGNUM *p_bn = 
# 545 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 545 "../test/evp_extra_test2.c"
                      ;
    BIGNUM *g_bn = 
# 546 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 546 "../test/evp_extra_test2.c"
                      ;
    BIGNUM *priv_bn = 
# 547 "../test/evp_extra_test2.c" 3 4
                     ((void *)0)
# 547 "../test/evp_extra_test2.c"
                         ;

    p = input;
    if (!test_ptr("../test/evp_extra_test2.c", 550, "pkey = d2i_AutoPrivateKey_ex(NULL, &p, input_len, mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 550 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 550 "../test/evp_extra_test2.c"
        , &p, input_len, mainctx, 
# 550 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 550 "../test/evp_extra_test2.c"
            ...
            || !test_ptr_eq("../test/evp_extra_test2.c", 552, "p", "input + input_len", p, input + input_len)
            || !test_int_eq("../test/evp_extra_test2.c", 553, "EVP_PKEY_get_id(pkey)", "expected_id", EVP_PKEY_get_id(pkey), expected_id))
        goto done;

    if (ak->evptype == 6) {
        if (!test_true("../test/evp_extra_test2.c", 557, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_RSA_D, &priv_bn)", (EVP_PKEY_get_bn_param(pkey, "d", &priv_bn)) != 0)
                                                       )
            goto done;
    } else if (ak->evptype == 1034) {
        unsigned char buffer[32];
        size_t len;

        if (!test_true("../test/evp_extra_test2.c", 564, "EVP_PKEY_get_octet_string_param(pkey, OSSL_PKEY_PARAM_PRIV_KEY, buffer, sizeof(buffer), &len)", (EVP_PKEY_get_octet_string_param(pkey, "priv", buffer, sizeof(buffer), &len)) != 0)


                                                             )
            goto done;
    } else {
        if (!test_true("../test/evp_extra_test2.c", 570, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_PRIV_KEY, &priv_bn)", (EVP_PKEY_get_bn_param(pkey, "priv", &priv_bn)) != 0)
                                                       )
            goto done;
    }

    if (ak->evptype == 28) {
        if (!test_true("../test/evp_extra_test2.c", 576, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_FFC_P, &p_bn)", (EVP_PKEY_get_bn_param(pkey, "p", &p_bn)) != 0)
            || !test_true("../test/evp_extra_test2.c", 577, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_FFC_G, &g_bn)", (EVP_PKEY_get_bn_param(pkey, "g", &g_bn)) != 0)
                                                       )
            goto done;
    }
...
static int test_pkcs8key_nid_bio(void)
{
    ...
    EVP_PKEY *pkey = 
# 597 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 597 "../test/evp_extra_test2.c"
                        , *pkey_dec = 
# 597 "../test/evp_extra_test2.c" 3 4
                                      ((void *)0)
# 597 "../test/evp_extra_test2.c"
                                          ;
    BIO *in = 
# 598 "../test/evp_extra_test2.c" 3 4
             ((void *)0)
# 598 "../test/evp_extra_test2.c"
                 , *enc_bio = 
# 598 "../test/evp_extra_test2.c" 3 4
                              ((void *)0)
# 598 "../test/evp_extra_test2.c"
                                  ;
    char *enc_data = 
# 599 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 599 "../test/evp_extra_test2.c"
                        ;
    long enc_datalen = 0;
    OSSL_PROVIDER *provider = 
# 601 "../test/evp_extra_test2.c" 3 4
                             ((void *)0)
# 601 "../test/evp_extra_test2.c"
                                 ;

    ret = test_ptr("../test/evp_extra_test2.c", 603, "provider = OSSL_PROVIDER_load(NULL, \"default\")", provider = OSSL_PROVIDER_load(
# 603 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 603 "../test/evp_extra_test2.c"
         , "default"))
          && test_ptr("../test/evp_extra_test2.c", 604, "enc_bio = BIO_new(BIO_s_mem())", enc_bio = BIO_new(BIO_s_mem()))
          && test_ptr("../test/evp_extra_test2.c", 605, "in = BIO_new_mem_buf(kExampleRSAKeyPKCS8, sizeof(kExampleRSAKeyPKCS8))", in = BIO_new_mem_buf(kExampleRSAKeyPKCS8, sizeof(kExampleRSAKeyPKCS8)))

          && test_ptr("../test/evp_extra_test2.c", 607, "pkey = d2i_PrivateKey_ex_bio(in, NULL, NULL, NULL)", pkey = d2i_PrivateKey_ex_bio(in, 
# 607 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 607 "../test/evp_extra_test2.c"
            , 
# 607 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 607 "../test/evp_extra_test2.c"
...
# 607 "../test/evp_extra_test2.c"
          ...
          && test_int_eq("../test/evp_extra_test2.c", 608, "i2d_PKCS8PrivateKey_nid_bio(enc_bio, pkey, nid, pwd, sizeof(pwd) - 1, NULL, NULL)", "1", i2d_PKCS8PrivateKey_nid_bio(enc_bio, pkey, nid, pwd, sizeof(pwd) - 1, 
# 608 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 608 "../test/evp_extra_test2.c"
            , 
# 608 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 608 "../test/evp_extra_test2.c"
          ...
          && test_int_gt("../test/evp_extra_test2.c", 611, "enc_datalen = BIO_get_mem_data(enc_bio, &enc_data)", "0", enc_datalen = BIO_ctrl(enc_bio,3,0,(char *)(&enc_data)), 0)
          && test_ptr("../test/evp_extra_test2.c", 612, "pkey_dec = d2i_PKCS8PrivateKey_bio(enc_bio, NULL, NULL, (void *)pwd)", pkey_dec = d2i_PKCS8PrivateKey_bio(enc_bio, 
# 612 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 612 "../test/evp_extra_test2.c"
            , 
# 612 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 612 "../test/evp_extra_test2.c"
          ...
          && test_true("../test/evp_extra_test2.c", 614, "EVP_PKEY_eq(pkey, pkey_dec)", (EVP_PKEY_eq(pkey, pkey_dec)) != 0);
...
static int test_alternative_default(void)
{
    ...
    if (!test_ptr_null("../test/evp_extra_test2.c", 635, "sha256 = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(
# 635 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 635 "../test/evp_extra_test2.c"
        , "SHA2-256", 
# 635 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 635 "../test/evp_extra_test2.c"
    ...
    if (!test_ptr("../test/evp_extra_test2.c", 642, "oldctx = OSSL_LIB_CTX_set0_default(mainctx)", oldctx = OSSL_LIB_CTX_set0_default(mainctx))
        || !test_ptr("../test/evp_extra_test2.c", 643, "sha256 = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(
# 643 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 643 "../test/evp_extra_test2.c"
           , "SHA2-256", 
# 643 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 643 "../test/evp_extra_test2.c"
    ...
    EVP_MD_free(sha256);
    sha256 = 
# 646 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 646 "../test/evp_extra_test2.c"
                ;
    ...
    if (!test_ptr_eq("../test/evp_extra_test2.c", 652, "OSSL_LIB_CTX_set0_default(oldctx)", "mainctx", OSSL_LIB_CTX_set0_default(oldctx), mainctx)
        || !test_ptr_null("../test/evp_extra_test2.c", 653, "sha256 = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(
# 653 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 653 "../test/evp_extra_test2.c"
           , "SHA2-256", 
# 653 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 653 "../test/evp_extra_test2.c"
...
{
    EVP_MD *sha256 = 
# 664 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 664 "../test/evp_extra_test2.c"
                        ;
    OSSL_PROVIDER *provider = 
# 665 "../test/evp_extra_test2.c" 3 4
                             ((void *)0)
# 665 "../test/evp_extra_test2.c"
                                 ;
    int ok = 0;

    if (!test_ptr("../test/evp_extra_test2.c", 668, "provider = OSSL_PROVIDER_load(NULL, \"default\")", provider = OSSL_PROVIDER_load(
# 668 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 668 "../test/evp_extra_test2.c"
        , "default"))
        || !test_ptr("../test/evp_extra_test2.c", 669, "sha256 = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(
# 669 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 669 "../test/evp_extra_test2.c"
           , "SHA2-256", 
# 669 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 669 "../test/evp_extra_test2.c"
    ...
    if (testid > 0) {
        OSSL_PROVIDER_unload(provider);
        provider = 
# 674 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 674 "../test/evp_extra_test2.c"
                      ;
        EVP_MD_free(sha256);
        sha256 = 
# 676 "../test/evp_extra_test2.c" 3 4
                ((void *)0)
# 676 "../test/evp_extra_test2.c"
                    ;
    } else {
        EVP_MD_free(sha256);
        sha256 = 
# 679 "../test/evp_extra_test2.c" 3 4
                ((void *)0)
# 679 "../test/evp_extra_test2.c"
                    ;
        OSSL_PROVIDER_unload(provider);
        provider = 
# 681 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 681 "../test/evp_extra_test2.c"
                      ;
    }
    ...
    if (!test_ptr_null("../test/evp_extra_test2.c", 688, "sha256 = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", sha256 = EVP_MD_fetch(
# 688 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 688 "../test/evp_extra_test2.c"
        , "SHA2-256", 
# 688 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 688 "../test/evp_extra_test2.c"
...
static int test_d2i_PrivateKey_ex(int testid)
{
    int ok = 0;
    OSSL_PROVIDER *provider = 
# 701 "../test/evp_extra_test2.c" 3 4
                             ((void *)0)
# 701 "../test/evp_extra_test2.c"
                                 ;
    BIO *key_bio = 
# 702 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 702 "../test/evp_extra_test2.c"
                      ;
    EVP_PKEY *pkey = 
# 703 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 703 "../test/evp_extra_test2.c"
                        ;
    int id = (testid == 0) ? 0 : 2;

    if (!test_ptr("../test/evp_extra_test2.c", 706, "provider = OSSL_PROVIDER_load(NULL, \"default\")", provider = OSSL_PROVIDER_load(
# 706 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 706 "../test/evp_extra_test2.c"
        , "default")))
        goto err;
    if (!test_ptr("../test/evp_extra_test2.c", 708, "key_bio = BIO_new_mem_buf(keydata[id].kder, keydata[id].size)", key_bio = BIO_new_mem_buf(keydata[id].kder, keydata[id].size)))
        goto err;
    if (!test_ptr_null("../test/evp_extra_test2.c", 710, "pkey = PEM_read_bio_PrivateKey(key_bio, NULL, NULL, NULL)", pkey = PEM_read_bio_PrivateKey(key_bio, 
# 710 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 710 "../test/evp_extra_test2.c"
        , 
# 710 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 710 "../test/evp_extra_test2.c"
...
# 710 "../test/evp_extra_test2.c"
    ...
    ERR_clear_error();
    if (!test_int_ge("../test/evp_extra_test2.c", 714, "BIO_seek(key_bio, 0)", "0", (int)BIO_ctrl(key_bio,128,0,
# 714 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 714 "../test/evp_extra_test2.c"
        ), 0))
        goto err;
    ok = test_ptr("../test/evp_extra_test2.c", 716, "pkey = d2i_PrivateKey_bio(key_bio, NULL)", pkey = d2i_PrivateKey_bio(key_bio, 
# 716 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 716 "../test/evp_extra_test2.c"
        ));
    test_int_eq("../test/evp_extra_test2.c", 717, "ERR_peek_error()", "0", ERR_peek_error(), 0);
    test_openssl_errors();
...
static int test_PEM_read_bio_negative(int testid)
{
    int ok = 0;
    OSSL_PROVIDER *provider = 
# 731 "../test/evp_extra_test2.c" 3 4
                             ((void *)0)
# 731 "../test/evp_extra_test2.c"
                                 ;
    BIO *key_bio = 
# 732 "../test/evp_extra_test2.c" 3 4
                  ((void *)0)
# 732 "../test/evp_extra_test2.c"
                      ;
    EVP_PKEY *pkey = 
# 733 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 733 "../test/evp_extra_test2.c"
                        ;

    if (!test_ptr("../test/evp_extra_test2.c", 735, "key_bio = BIO_new_mem_buf(keydata[testid].kder, keydata[testid].size)", key_bio = BIO_new_mem_buf(keydata[testid].kder, keydata[testid].size)))
        goto err;
    ERR_clear_error();
    if (!test_ptr_null("../test/evp_extra_test2.c", 738, "pkey = PEM_read_bio_PrivateKey(key_bio, NULL, NULL, NULL)", pkey = PEM_read_bio_PrivateKey(key_bio, 
# 738 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 738 "../test/evp_extra_test2.c"
        , 
# 738 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 738 "../test/evp_extra_test2.c"
...
# 738 "../test/evp_extra_test2.c"
        ...
        goto err;
    if (!test_int_ne("../test/evp_extra_test2.c", 740, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;
    if (!test_ptr("../test/evp_extra_test2.c", 742, "provider = OSSL_PROVIDER_load(NULL, \"default\")", provider = OSSL_PROVIDER_load(
# 742 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 742 "../test/evp_extra_test2.c"
        , "default")))
        goto err;
    if (!test_int_ge("../test/evp_extra_test2.c", 744, "BIO_seek(key_bio, 0)", "0", (int)BIO_ctrl(key_bio,128,0,
# 744 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 744 "../test/evp_extra_test2.c"
        ), 0))
        goto err;
    ERR_clear_error();
    if (!test_ptr_null("../test/evp_extra_test2.c", 747, "pkey = PEM_read_bio_PrivateKey(key_bio, NULL, NULL, NULL)", pkey = PEM_read_bio_PrivateKey(key_bio, 
# 747 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 747 "../test/evp_extra_test2.c"
        , 
# 747 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 747 "../test/evp_extra_test2.c"
...
# 747 "../test/evp_extra_test2.c"
        ...
        goto err;
    if (!test_int_ne("../test/evp_extra_test2.c", 749, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;
...
{
    int ok = 0;
    OSSL_PROVIDER *provider = OSSL_PROVIDER_load(
# 766 "../test/evp_extra_test2.c" 3 4
                                                ((void *)0)
# 766 "../test/evp_extra_test2.c"
                                                    , "default");
    EVP_PKEY *read_pkey = 
# 767 "../test/evp_extra_test2.c" 3 4
                         ((void *)0)
# 767 "../test/evp_extra_test2.c"
                             ;
    EVP_PKEY *write_pkey = EVP_PKEY_Q_keygen(
# 768 "../test/evp_extra_test2.c" 3 4
                          ((void *)0)
# 768 "../test/evp_extra_test2.c"
                          , 
# 768 "../test/evp_extra_test2.c" 3 4
                          ((void *)0)
# 768 "../test/evp_extra_test2.c"
    ...
    const UI_METHOD *undo_ui_method = 
# 770 "../test/evp_extra_test2.c" 3 4
                                     ((void *)0)
# 770 "../test/evp_extra_test2.c"
                                         ;
    const UI_METHOD *ui_method = 
# 771 "../test/evp_extra_test2.c" 3 4
                                ((void *)0)
# 771 "../test/evp_extra_test2.c"
                                    ;
    if (testid > 0)
        ui_method = UI_null();

    if (!test_ptr("../test/evp_extra_test2.c", 775, "provider", provider))
        goto err;
    if (!test_ptr("../test/evp_extra_test2.c", 777, "key_bio", key_bio))
        goto err;
    if (!test_ptr("../test/evp_extra_test2.c", 779, "write_pkey", write_pkey))
        goto err;
    undo_ui_method = UI_get_default_method();
    UI_set_default_method(ui_method);

    if (
        !test_true("../test/evp_extra_test2.c", 785, "PEM_write_bio_PrivateKey(key_bio, write_pkey, EVP_aes_256_cbc(), NULL, 0, NULL, \"pass\")", (PEM_write_bio_PrivateKey(key_bio, write_pkey, EVP_aes_256_cbc(), 
# 785 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 785 "../test/evp_extra_test2.c"
        , 0, 
# 785 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 785 "../test/evp_extra_test2.c"
    ...
    ERR_clear_error();
    read_pkey = PEM_read_bio_PrivateKey(key_bio, 
# 790 "../test/evp_extra_test2.c" 3 4
                                                ((void *)0)
# 790 "../test/evp_extra_test2.c"
                                                    , 
# 790 "../test/evp_extra_test2.c" 3 4
                                                      ((void *)0)
# 790 "../test/evp_extra_test2.c"
...
# 790 "../test/evp_extra_test2.c"
    ...
    if (!test_ptr_null("../test/evp_extra_test2.c", 791, "read_pkey", read_pkey))
        goto err;

    if (!test_int_eq("../test/evp_extra_test2.c", 794, "ERR_GET_REASON(ERR_get_error())", "PEM_R_PROBLEMS_GETTING_PASSWORD", ERR_GET_REASON(ERR_get_error()), 109))
        goto err;
    ok = 1;
...
{
    EVP_PKEY_CTX *ctx = 
# 812 "../test/evp_extra_test2.c" 3 4
                       ((void *)0)
# 812 "../test/evp_extra_test2.c"
                           ;
    EVP_PKEY *pkey = 
# 813 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 813 "../test/evp_extra_test2.c"
                        ;
    int ret;

    ret = test_ptr("../test/evp_extra_test2.c", 816, "ctx = EVP_PKEY_CTX_new_from_name(mainctx, type, NULL)", ctx = EVP_PKEY_CTX_new_from_name(mainctx, type, 
# 816 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 816 "../test/evp_extra_test2.c"
         ))
          && test_int_eq("../test/evp_extra_test2.c", 817, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
          && test_int_eq("../test/evp_extra_test2.c", 818, "EVP_PKEY_fromdata(ctx, &pkey, EVP_PKEY_KEYPAIR, (OSSL_PARAM *)params)", "1", EVP_PKEY_fromdata(ctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), (OSSL_PARAM *)params), 1)


          && test_true("../test/evp_extra_test2.c", 821, "EVP_PKEY_eq(pkey, expected)", (EVP_PKEY_eq(pkey, expected)) != 0);
    EVP_PKEY_CTX_free(ctx);
    EVP_PKEY_free(pkey);
    return ret;
}
# 836 "../test/evp_extra_test2.c"
...
# 980 "../test/evp_extra_test2.c" 3 4
                           ((void *)0)
# 980 "../test/evp_extra_test2.c"
                               , *check_ctx = 
# 980 "../test/evp_extra_test2.c" 3 4
                                              ((void *)0)
# 980 "../test/evp_extra_test2.c"
                                                  ;
    EVP_PKEY *pkey = 
# 981 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 981 "../test/evp_extra_test2.c"
                        ;
    int ret;

    ret = test_ptr("../test/evp_extra_test2.c", 984, "gen_ctx = EVP_PKEY_CTX_new_from_name(mainctx, \"DSA\", NULL)", gen_ctx = EVP_PKEY_CTX_new_from_name(mainctx, "DSA", 
# 984 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 984 "../test/evp_extra_test2.c"
         ))
          && test_int_eq("../test/evp_extra_test2.c", 985, "EVP_PKEY_fromdata_init(gen_ctx)", "1", EVP_PKEY_fromdata_init(gen_ctx), 1)
          && test_int_eq("../test/evp_extra_test2.c", 986, "EVP_PKEY_fromdata(gen_ctx, &pkey, EVP_PKEY_KEYPAIR, key_params)", "1", EVP_PKEY_fromdata(gen_ctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), key_params), 1)

          && test_ptr("../test/evp_extra_test2.c", 988, "check_ctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, NULL)", check_ctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, 
# 988 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 988 "../test/evp_extra_test2.c"
            ))

          && test_int_eq("../test/evp_extra_test2.c", 990, "EVP_PKEY_param_check(check_ctx)", "expected", EVP_PKEY_param_check(check_ctx), expected);
                       ...
                       const unsigned char *expected, size_t expected_len)
{
    OSSL_PARAM *p;
    BIGNUM *bn = 
# 1001 "../test/evp_extra_test2.c" 3 4
                ((void *)0)
# 1001 "../test/evp_extra_test2.c"
                    ;
    unsigned char buffer[256 + 1];
    int ret, len;

    ret = test_ptr("../test/evp_extra_test2.c", 1005, "p = OSSL_PARAM_locate(params, key)", p = OSSL_PARAM_locate(params, key))
          && test_true("../test/evp_extra_test2.c", 1006, "OSSL_PARAM_get_BN(p, &bn)", (OSSL_PARAM_get_BN(p, &bn)) != 0)
          && test_int_gt("../test/evp_extra_test2.c", 1007, "len = BN_bn2binpad(bn, buffer, expected_len)", "0", len = BN_bn2binpad(bn, buffer, expected_len), 0)
          && test_mem_eq("../test/evp_extra_test2.c", 1008, "expected", "buffer", expected, expected_len, buffer, len);
    BN_free(bn);
    return ret;
}
...
static int do_check_int(OSSL_PARAM params[], const char *key, int expected)
{
    ...
    return test_ptr("../test/evp_extra_test2.c", 1018, "p = OSSL_PARAM_locate(params, key)", p = OSSL_PARAM_locate(params, key))
           && test_true("../test/evp_extra_test2.c", 1019, "OSSL_PARAM_get_int(p, &val)", (OSSL_PARAM_get_int(p, &val)) != 0)
           && test_int_eq("../test/evp_extra_test2.c", 1020, "val", "expected", val, expected);
}
...
static int test_dsa_tofrom_data_select(void)
{
    int ret;
    EVP_PKEY *key = 
# 1026 "../test/evp_extra_test2.c" 3 4
                   ((void *)0)
# 1026 "../test/evp_extra_test2.c"
                       ;
    const unsigned char *pkeydata = dsa_key;

    ret = test_ptr("../test/evp_extra_test2.c", 1029, "key = d2i_AutoPrivateKey_ex(NULL, &pkeydata, sizeof(dsa_key), mainctx, NULL)", key = d2i_AutoPrivateKey_ex(
# 1029 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1029 "../test/evp_extra_test2.c"
         , &pkeydata, sizeof(dsa_key), mainctx, 
# 1029 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1029 "../test/evp_extra_test2.c"
         ))

          && test_true("../test/evp_extra_test2.c", 1031, "do_pkey_tofrom_data_select(key, \"DSA\")", (do_pkey_tofrom_data_select(key, "DSA")) != 0);
...
{
    EVP_PKEY *pkey = 
# 1039 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1039 "../test/evp_extra_test2.c"
                        ;
    OSSL_PARAM *to_params = 
# 1040 "../test/evp_extra_test2.c" 3 4
                           ((void *)0)
# 1040 "../test/evp_extra_test2.c"
                               , *all_params = 
# 1040 "../test/evp_extra_test2.c" 3 4
                                               ((void *)0)
# 1040 "../test/evp_extra_test2.c"
    ...
    gen_params[0] = OSSL_PARAM_construct_octet_string("seed",
                                                      (void*)dsa_seed,
                                                      sizeof(dsa_seed));
    gen_params[1] = OSSL_PARAM_construct_int("gindex",
                                             &dsa_gindex);
    gen_params[2] = OSSL_PARAM_construct_int("pcounter",
                                             &dsa_pcounter);
    gen_params[3] = OSSL_PARAM_construct_end();

    if (!test_ptr("../test/evp_extra_test2.c", 1062, "pkey = d2i_AutoPrivateKey_ex(NULL, &pkeydata, sizeof(dsa_key), mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 1062 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1062 "../test/evp_extra_test2.c"
        , &pkeydata, sizeof(dsa_key), mainctx, 
# 1062 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1062 "../test/evp_extra_test2.c"
        ...
        || !test_int_eq("../test/evp_extra_test2.c", 1064, "EVP_PKEY_todata(pkey, EVP_PKEY_KEYPAIR, &to_params)", "1", EVP_PKEY_todata(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), &to_params), 1)
        || !do_check_bn(to_params, "p", dsa_p, sizeof(dsa_p))
        || !do_check_bn(to_params, "q", dsa_q, sizeof(dsa_q))
        || !do_check_bn(to_params, "g", dsa_g, sizeof(dsa_g))
        || !do_check_bn(to_params, "pub", dsa_pub,
                        sizeof(dsa_pub))
        || !do_check_bn(to_params, "priv", dsa_priv,
                        sizeof(dsa_priv))
        || !do_check_int(to_params, "gindex", -1)
        || !do_check_int(to_params, "pcounter", -1)
        || !do_check_int(to_params, "hindex", 0)
        || !do_check_int(to_params, "validate-pq", 1)
        || !do_check_int(to_params, "validate-g", 1)
        || !do_check_int(to_params, "validate-legacy", 0)
        || !test_ptr_null("../test/evp_extra_test2.c", 1078, "OSSL_PARAM_locate(to_params, OSSL_PKEY_PARAM_FFC_SEED)", OSSL_PARAM_locate(to_params, "seed")))
        goto err;

    if (!do_fromdata_key_is_equal(to_params, pkey, "DSA"))
        goto err;

    if (!test_ptr("../test/evp_extra_test2.c", 1084, "all_params = OSSL_PARAM_merge(to_params, gen_params)", all_params = OSSL_PARAM_merge(to_params, gen_params))
...
{
    EVP_PKEY_CTX *ctx = 
# 1124 "../test/evp_extra_test2.c" 3 4
                       ((void *)0)
# 1124 "../test/evp_extra_test2.c"
                           , *gctx = 
# 1124 "../test/evp_extra_test2.c" 3 4
                                     ((void *)0)
# 1124 "../test/evp_extra_test2.c"
                                         ;
    EVP_PKEY *pkey = 
# 1125 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1125 "../test/evp_extra_test2.c"
                        , *pkey2 = 
# 1125 "../test/evp_extra_test2.c" 3 4
                                    ((void *)0)
# 1125 "../test/evp_extra_test2.c"
    ...
    *p++ = OSSL_PARAM_construct_uint("pbits", &pbits);
    *p++ = OSSL_PARAM_construct_utf8_string("digest", "SHA512", 0);

    *p++ = OSSL_PARAM_construct_utf8_string("properties",
                                            tstid == 0 ? "provider=unknown" : "provider=default", 0);
    *p++ = OSSL_PARAM_construct_end();

    if (!test_ptr("../test/evp_extra_test2.c", 1138, "ctx = EVP_PKEY_CTX_new_from_name(mainctx, \"DSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(mainctx, "DSA", 
# 1138 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1138 "../test/evp_extra_test2.c"
        ))
        || !test_int_eq("../test/evp_extra_test2.c", 1139, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_extra_test2.c", 1140, "EVP_PKEY_fromdata(ctx, &pkey, EVP_PKEY_KEY_PARAMETERS, params)", "1", EVP_PKEY_fromdata(ctx, &pkey, ( ( 0x04 | 0x80) ), params), 1))
        goto err;

    if (!test_ptr("../test/evp_extra_test2.c", 1143, "gctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, NULL)", gctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, 
# 1143 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1143 "../test/evp_extra_test2.c"
        ))
        || !test_int_eq("../test/evp_extra_test2.c", 1144, "EVP_PKEY_paramgen_init(gctx)", "1", EVP_PKEY_paramgen_init(gctx), 1)
        || !test_int_eq("../test/evp_extra_test2.c", 1145, "EVP_PKEY_paramgen(gctx, &pkey2)", "expected", EVP_PKEY_paramgen(gctx, &pkey2), expected))
        goto err;
...
{
    OSSL_PARAM *params = 
# 1160 "../test/evp_extra_test2.c" 3 4
                        ((void *)0)
# 1160 "../test/evp_extra_test2.c"
                            ;
    EVP_PKEY *pkey = 
# 1161 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1161 "../test/evp_extra_test2.c"
                        ;
    int ret = 0;
    const unsigned char *pdata = keydata[0].kder;

    ret = test_ptr("../test/evp_extra_test2.c", 1165, "pkey = d2i_AutoPrivateKey_ex(NULL, &pdata, keydata[0].size, mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 1165 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1165 "../test/evp_extra_test2.c"
         , &pdata, keydata[0].size, mainctx, 
# 1165 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1165 "../test/evp_extra_test2.c"
         ))

          && test_int_eq("../test/evp_extra_test2.c", 1167, "EVP_PKEY_todata(NULL, EVP_PKEY_KEYPAIR, &params)", "0", EVP_PKEY_todata(
# 1167 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1167 "../test/evp_extra_test2.c"
            , ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), &params), 0)
          && test_int_eq("../test/evp_extra_test2.c", 1168, "EVP_PKEY_todata(pkey, EVP_PKEY_KEYPAIR, NULL)", "0", EVP_PKEY_todata(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), 
# 1168 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1168 "../test/evp_extra_test2.c"
            ), 0);
    EVP_PKEY_free(pkey);
    return ret;
}
...
{
    if (arg == 
# 1177 "../test/evp_extra_test2.c" 3 4
              ((void *)0)
# 1177 "../test/evp_extra_test2.c"
                  )
        return 0;
...
{
    EVP_PKEY *pkey = 
# 1184 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1184 "../test/evp_extra_test2.c"
                        ;
    int ret = 0;
    const unsigned char *pdata = keydata[0].kder;

    ret = test_ptr("../test/evp_extra_test2.c", 1188, "pkey = d2i_AutoPrivateKey_ex(NULL, &pdata, keydata[0].size, mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 1188 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1188 "../test/evp_extra_test2.c"
         , &pdata, keydata[0].size, mainctx, 
# 1188 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1188 "../test/evp_extra_test2.c"
          ...
          && test_int_eq("../test/evp_extra_test2.c", 1190, "EVP_PKEY_export(NULL, EVP_PKEY_KEYPAIR, test_pkey_export_cb, NULL)", "0", EVP_PKEY_export(
# 1190 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1190 "../test/evp_extra_test2.c"
            , ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), test_pkey_export_cb, 
# 1190 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1190 "../test/evp_extra_test2.c"
            ), 0)

          && test_int_eq("../test/evp_extra_test2.c", 1192, "EVP_PKEY_export(pkey, EVP_PKEY_KEYPAIR, NULL, NULL)", "0", EVP_PKEY_export(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), 
# 1192 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1192 "../test/evp_extra_test2.c"
            , 
# 1192 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1192 "../test/evp_extra_test2.c"
...
{
    EVP_PKEY *pkey = 
# 1199 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1199 "../test/evp_extra_test2.c"
                        ;

    RSA *rsa = 
# 1201 "../test/evp_extra_test2.c" 3 4
              ((void *)0)
# 1201 "../test/evp_extra_test2.c"
                  ;
    ...
    if (!test_ptr("../test/evp_extra_test2.c", 1207, "pkey = d2i_AutoPrivateKey_ex(NULL, &pdata, pdata_len, mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 1207 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1207 "../test/evp_extra_test2.c"
        , &pdata, pdata_len, mainctx, 
# 1207 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1207 "../test/evp_extra_test2.c"
        ...
        || !test_true("../test/evp_extra_test2.c", 1209, "EVP_PKEY_export(pkey, EVP_PKEY_KEYPAIR, test_pkey_export_cb, pkey)", (EVP_PKEY_export(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), test_pkey_export_cb, pkey)) != 0)

        || !test_false("../test/evp_extra_test2.c", 1211, "EVP_PKEY_export(pkey, EVP_PKEY_KEYPAIR, test_pkey_export_cb, NULL)", (EVP_PKEY_export(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), test_pkey_export_cb, 
# 1211 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 1211 "../test/evp_extra_test2.c"
           )) != 0)
                                                                  )
        ret = 0;
    EVP_PKEY_free(pkey);
    ...
    if (!test_ptr("../test/evp_extra_test2.c", 1220, "rsa = d2i_RSAPrivateKey(NULL, &pdata, pdata_len)", rsa = d2i_RSAPrivateKey(
# 1220 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1220 "../test/evp_extra_test2.c"
        , &pdata, pdata_len))
        || !test_ptr("../test/evp_extra_test2.c", 1221, "pkey = EVP_PKEY_new()", pkey = EVP_PKEY_new())
        || !test_true("../test/evp_extra_test2.c", 1222, "EVP_PKEY_assign_RSA(pkey, rsa)", (EVP_PKEY_assign((pkey),6, (rsa))) != 0)
        || !test_true("../test/evp_extra_test2.c", 1223, "EVP_PKEY_export(pkey, EVP_PKEY_KEYPAIR, test_pkey_export_cb, pkey)", (EVP_PKEY_export(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), test_pkey_export_cb, pkey)) != 0)

        || !test_false("../test/evp_extra_test2.c", 1225, "EVP_PKEY_export(pkey, EVP_PKEY_KEYPAIR, test_pkey_export_cb, NULL)", (EVP_PKEY_export(pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), test_pkey_export_cb, 
# 1225 "../test/evp_extra_test2.c" 3 4
           ((void *)0)
# 1225 "../test/evp_extra_test2.c"
           )) != 0)
                                                                  )
        ret = 0;
    EVP_PKEY_free(pkey);
...
{
    EVP_PKEY *pkey = 
# 1235 "../test/evp_extra_test2.c" 3 4
                    ((void *)0)
# 1235 "../test/evp_extra_test2.c"
                        ;
    EVP_PKEY_CTX *pctx = 
# 1236 "../test/evp_extra_test2.c" 3 4
                        ((void *)0)
# 1236 "../test/evp_extra_test2.c"
                            ;
    int ret = 0;
    const unsigned char *pdata = keydata[0].kder;
    ...
    int padding = 6;
    unsigned char *sig = 
# 1243 "../test/evp_extra_test2.c" 3 4
                        ((void *)0)
# 1243 "../test/evp_extra_test2.c"
                            ;
    size_t sig_len = 0;

    sig_params[0] = OSSL_PARAM_construct_int("pad-mode",
                                             &padding);
    sig_params[1] = OSSL_PARAM_construct_utf8_string("digest",
                                                     (char *)mdname, 0);
    sig_params[2] = OSSL_PARAM_construct_end();

    ret = test_ptr("../test/evp_extra_test2.c", 1252, "pkey = d2i_AutoPrivateKey_ex(NULL, &pdata, keydata[0].size, mainctx, NULL)", pkey = d2i_AutoPrivateKey_ex(
# 1252 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1252 "../test/evp_extra_test2.c"
         , &pdata, keydata[0].size, mainctx, 
# 1252 "../test/evp_extra_test2.c" 3 4
         ((void *)0)
# 1252 "../test/evp_extra_test2.c"
          ...
          && test_ptr("../test/evp_extra_test2.c", 1254, "pctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, NULL)", pctx = EVP_PKEY_CTX_new_from_pkey(mainctx, pkey, 
# 1254 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1254 "../test/evp_extra_test2.c"
            ))
          && test_int_gt("../test/evp_extra_test2.c", 1255, "EVP_PKEY_sign_init_ex(pctx, sig_params)", "0", EVP_PKEY_sign_init_ex(pctx, sig_params), 0)
          && test_int_gt("../test/evp_extra_test2.c", 1256, "EVP_PKEY_sign(pctx, NULL, &sig_len, mdbuf, sizeof(mdbuf))", "0", EVP_PKEY_sign(pctx, 
# 1256 "../test/evp_extra_test2.c" 3 4
            ((void *)0)
# 1256 "../test/evp_extra_test2.c"
            , &sig_len, mdbuf, sizeof(mdbuf)), 0)

          && test_int_gt("../test/evp_extra_test2.c", 1258, "sig_len", "0", sig_len, 0)
          && test_ptr("../test/evp_extra_test2.c", 1259, "sig = OPENSSL_malloc(sig_len)", sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test2.c", 1259))
          && test_int_gt("../test/evp_extra_test2.c", 1260, "EVP_PKEY_sign(pctx, sig, &sig_len, mdbuf, sizeof(mdbuf))", "0", EVP_PKEY_sign(pctx, sig, &sig_len, mdbuf, sizeof(mdbuf)), 0)
                                                         ;

    EVP_PKEY_CTX_free(pctx);
    CRYPTO_free(sig, "../test/evp_extra_test2.c", 1264);
    EVP_PKEY_free(pkey);
...
static int test_evp_md_ctx_dup(void)
{
    EVP_MD_CTX *mdctx;
    EVP_MD_CTX *copyctx = 
# 1273 "../test/evp_extra_test2.c" 3 4
                         ((void *)0)
# 1273 "../test/evp_extra_test2.c"
                             ;
    int ret;


    ret = test_ptr("../test/evp_extra_test2.c", 1277, "mdctx = EVP_MD_CTX_new()", mdctx = EVP_MD_CTX_new())
          && test_ptr("../test/evp_extra_test2.c", 1278, "copyctx = EVP_MD_CTX_dup(mdctx)", copyctx = EVP_MD_CTX_dup(mdctx));
...
{
    EVP_MD_CTX *mdctx = 
# 1287 "../test/evp_extra_test2.c" 3 4
                       ((void *)0)
# 1287 "../test/evp_extra_test2.c"
                           ;
    EVP_MD_CTX *copyctx = 
# 1288 "../test/evp_extra_test2.c" 3 4
                         ((void *)0)
# 1288 "../test/evp_extra_test2.c"
                             ;
    int ret;


    ret = test_ptr("../test/evp_extra_test2.c", 1292, "mdctx = EVP_MD_CTX_new()", mdctx = EVP_MD_CTX_new())
          && test_ptr("../test/evp_extra_test2.c", 1293, "copyctx = EVP_MD_CTX_new()", copyctx = EVP_MD_CTX_new())
          && test_true("../test/evp_extra_test2.c", 1294, "EVP_MD_CTX_copy_ex(copyctx, mdctx)", (EVP_MD_CTX_copy_ex(copyctx, mdctx)) != 0);
...
# 1306 "../test/evp_extra_test2.c" 3 4
                                  ((void *)0)
# 1306 "../test/evp_extra_test2.c"
                                      ;
    EVP_PBE_KEYGEN *keygen = 
# 1307 "../test/evp_extra_test2.c" 3 4
                            ((void *)0)
# 1307 "../test/evp_extra_test2.c"
                                ;

    if (!test_true("../test/evp_extra_test2.c", 1309, "EVP_PBE_alg_add(NID_pbeWithMD5AndDES_CBC, EVP_des_cbc(), EVP_md5(), PKCS5_PBE_keyivgen)", (EVP_PBE_alg_add(10, EVP_des_cbc(), EVP_md5(), PKCS5_PBE_keyivgen)) != 0)
                                                       )
        goto err;

    if (!test_true("../test/evp_extra_test2.c", 1313, "EVP_PBE_find_ex(EVP_PBE_TYPE_OUTER, NID_pbeWithMD5AndDES_CBC, &cipher_nid, &md_nid, &keygen, &keygen_ex)", (EVP_PBE_find_ex(0x0, 10, &cipher_nid, &md_nid, &keygen, &keygen_ex)) != 0)
                                                                              )
        goto err;

    if (!test_true("../test/evp_extra_test2.c", 1317, "keygen != NULL", (keygen != 
# 1317 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1317 "../test/evp_extra_test2.c"
        ) != 0))
        goto err;
    if (!test_true("../test/evp_extra_test2.c", 1319, "keygen_ex == NULL", (keygen_ex == 
# 1319 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1319 "../test/evp_extra_test2.c"
        ) != 0))
        goto err;
...
# 1335 "../test/evp_extra_test2.c"
static int evp_test_name_parsing(void)
{
    EVP_MD *md;

    if (!test_ptr_null("../test/evp_extra_test2.c", 1339, "md = EVP_MD_fetch(mainctx, \"SHA256:BogusName\", NULL)", md = EVP_MD_fetch(mainctx, "SHA256:BogusName", 
# 1339 "../test/evp_extra_test2.c" 3 4
        ((void *)0)
# 1339 "../test/evp_extra_test2.c"
        ))) {
        EVP_MD_free(md);
        return 0;
    }
...
int setup_tests(void)
{
    if (!test_get_libctx(&mainctx, &nullprov, 
# 1349 "../test/evp_extra_test2.c" 3 4
                                             ((void *)0)
# 1349 "../test/evp_extra_test2.c"
                                                 , 
# 1349 "../test/evp_extra_test2.c" 3 4
                                                   ((void *)0)
# 1349 "../test/evp_extra_test2.c"
...
# 1349 "../test/evp_extra_test2.c"
        ...
        mainctx = 
# 1351 "../test/evp_extra_test2.c" 3 4
                 ((void *)0)
# 1351 "../test/evp_extra_test2.c"
                     ;
        return 0;
    }
    ...
    add_all_tests("test_d2i_AutoPrivateKey_ex", test_d2i_AutoPrivateKey_ex, (sizeof(keydata)/sizeof((keydata)[0])), 1);
    ...
    add_all_tests("test_PEM_read_bio_negative", test_PEM_read_bio_negative, (sizeof(keydata)/sizeof((keydata)[0])), 1);
    add_all_tests("test_PEM_read_bio_negative_wrong_password", test_PEM_read_bio_negative_wrong_password, 2, 1);
    ...
    add_test("test_evp_pbe_alg_add", test_evp_pbe_alg_add);
