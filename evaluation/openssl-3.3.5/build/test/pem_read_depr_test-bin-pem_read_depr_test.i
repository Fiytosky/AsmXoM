# 0 "../test/pem_read_depr_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pem_read_depr_test.c"
# 16 "../test/pem_read_depr_test.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 17 "../test/pem_read_depr_test.c" 2
...
# 23 "../test/pem_read_depr_test.c" 2
...
static BIO *getfile(const char *filename)
{
    ...
    BIO *infile = 
# 29 "../test/pem_read_depr_test.c" 3 4
                 ((void *)0)
# 29 "../test/pem_read_depr_test.c"
                     ;

    if (!test_ptr("../test/pem_read_depr_test.c", 31, "paramsfile", paramsfile))
        goto err;
    infile = BIO_new_file(paramsfile, "r");

 err:
    CRYPTO_free(paramsfile, "../test/pem_read_depr_test.c", 36);
    return infile;
}
...
static int test_read_dh_params(void)
{
    ...
    DH *dh = 
# 45 "../test/pem_read_depr_test.c" 3 4
            ((void *)0)
# 45 "../test/pem_read_depr_test.c"
                ;

    if (!test_ptr("../test/pem_read_depr_test.c", 47, "infile", infile))
        goto err;

    dh = PEM_read_bio_DHparams(infile, 
# 50 "../test/pem_read_depr_test.c" 3 4
                                      ((void *)0)
# 50 "../test/pem_read_depr_test.c"
                                          , 
# 50 "../test/pem_read_depr_test.c" 3 4
                                            ((void *)0)
# 50 "../test/pem_read_depr_test.c"
...
# 50 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 51, "dh", dh))
        goto err;
...
static int test_read_dh_x942_params(void)
{
    ...
    DH *dh = 
# 66 "../test/pem_read_depr_test.c" 3 4
            ((void *)0)
# 66 "../test/pem_read_depr_test.c"
                ;

    if (!test_ptr("../test/pem_read_depr_test.c", 68, "infile", infile))
        goto err;

    dh = PEM_read_bio_DHparams(infile, 
# 71 "../test/pem_read_depr_test.c" 3 4
                                      ((void *)0)
# 71 "../test/pem_read_depr_test.c"
                                          , 
# 71 "../test/pem_read_depr_test.c" 3 4
                                            ((void *)0)
# 71 "../test/pem_read_depr_test.c"
...
# 71 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 72, "dh", dh))
        goto err;
...
static int test_read_dsa_params(void)
{
    ...
    DSA *dsa = 
# 89 "../test/pem_read_depr_test.c" 3 4
              ((void *)0)
# 89 "../test/pem_read_depr_test.c"
                  ;

    if (!test_ptr("../test/pem_read_depr_test.c", 91, "infile", infile))
        goto err;

    dsa = PEM_read_bio_DSAparams(infile, 
# 94 "../test/pem_read_depr_test.c" 3 4
                                        ((void *)0)
# 94 "../test/pem_read_depr_test.c"
                                            , 
# 94 "../test/pem_read_depr_test.c" 3 4
                                              ((void *)0)
# 94 "../test/pem_read_depr_test.c"
...
# 94 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 95, "dsa", dsa))
        goto err;
...
static int test_read_dsa_private(void)
{
    ...
    DSA *dsa = 
# 110 "../test/pem_read_depr_test.c" 3 4
              ((void *)0)
# 110 "../test/pem_read_depr_test.c"
                  ;

    if (!test_ptr("../test/pem_read_depr_test.c", 112, "infile", infile))
        goto err;

    dsa = PEM_read_bio_DSAPrivateKey(infile, 
# 115 "../test/pem_read_depr_test.c" 3 4
                                            ((void *)0)
# 115 "../test/pem_read_depr_test.c"
                                                , 
# 115 "../test/pem_read_depr_test.c" 3 4
                                                  ((void *)0)
# 115 "../test/pem_read_depr_test.c"
...
# 115 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 116, "dsa", dsa))
        goto err;
...
static int test_read_dsa_public(void)
{
    ...
    DSA *dsa = 
# 131 "../test/pem_read_depr_test.c" 3 4
              ((void *)0)
# 131 "../test/pem_read_depr_test.c"
                  ;

    if (!test_ptr("../test/pem_read_depr_test.c", 133, "infile", infile))
        goto err;

    dsa = PEM_read_bio_DSA_PUBKEY(infile, 
# 136 "../test/pem_read_depr_test.c" 3 4
                                         ((void *)0)
# 136 "../test/pem_read_depr_test.c"
                                             , 
# 136 "../test/pem_read_depr_test.c" 3 4
                                               ((void *)0)
# 136 "../test/pem_read_depr_test.c"
...
# 136 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 137, "dsa", dsa))
        goto err;
...
static int test_read_rsa_private(void)
{
    ...
    RSA *rsa = 
# 153 "../test/pem_read_depr_test.c" 3 4
              ((void *)0)
# 153 "../test/pem_read_depr_test.c"
                  ;

    if (!test_ptr("../test/pem_read_depr_test.c", 155, "infile", infile))
        goto err;

    rsa = PEM_read_bio_RSAPrivateKey(infile, 
# 158 "../test/pem_read_depr_test.c" 3 4
                                            ((void *)0)
# 158 "../test/pem_read_depr_test.c"
                                                , 
# 158 "../test/pem_read_depr_test.c" 3 4
                                                  ((void *)0)
# 158 "../test/pem_read_depr_test.c"
...
# 158 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 159, "rsa", rsa))
        goto err;
...
static int test_read_rsa_public(void)
{
    ...
    RSA *rsa = 
# 174 "../test/pem_read_depr_test.c" 3 4
              ((void *)0)
# 174 "../test/pem_read_depr_test.c"
                  ;

    if (!test_ptr("../test/pem_read_depr_test.c", 176, "infile", infile))
        goto err;

    rsa = PEM_read_bio_RSA_PUBKEY(infile, 
# 179 "../test/pem_read_depr_test.c" 3 4
                                         ((void *)0)
# 179 "../test/pem_read_depr_test.c"
                                             , 
# 179 "../test/pem_read_depr_test.c" 3 4
                                               ((void *)0)
# 179 "../test/pem_read_depr_test.c"
...
# 179 "../test/pem_read_depr_test.c"
    ...
    if (!test_ptr("../test/pem_read_depr_test.c", 180, "rsa", rsa))
        goto err;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/pem_read_depr_test.c", 194, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/pem_read_depr_test.c", 198, "datadir = test_get_argument(0)", datadir = test_get_argument(0))) {
