# 0 "../test/cmp_server_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_server_test.c"
# 12 "../test/cmp_server_test.c"
...
# 21 "../test/cmp_server_test.c" 3 4
                             ((void *)0)
# 21 "../test/cmp_server_test.c"
                                 ;
static OSSL_PROVIDER *default_null_provider = 
# 22 "../test/cmp_server_test.c" 3 4
                                             ((void *)0)
# 22 "../test/cmp_server_test.c"
                                                 , *provider = 
# 22 "../test/cmp_server_test.c" 3 4
                                                               ((void *)0)
# 22 "../test/cmp_server_test.c"
                                                                   ;
static OSSL_CMP_MSG *request = 
# 23 "../test/cmp_server_test.c" 3 4
                              ((void *)0)
# 23 "../test/cmp_server_test.c"
                                  ;

static void tear_down(CMP_SRV_TEST_FIXTURE *fixture)
{
    OSSL_CMP_SRV_CTX_free(fixture->srv_ctx);
    CRYPTO_free(fixture, "../test/cmp_server_test.c", 28);
}
...
static CMP_SRV_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_server_test.c", 35, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_server_test.c", 35)))
        return 
# 36 "../test/cmp_server_test.c" 3 4
              ((void *)0)
# 36 "../test/cmp_server_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/cmp_server_test.c", 38, "fixture->srv_ctx = OSSL_CMP_SRV_CTX_new(libctx, NULL)", fixture->srv_ctx = OSSL_CMP_SRV_CTX_new(libctx, 
# 38 "../test/cmp_server_test.c" 3 4
        ((void *)0)
# 38 "../test/cmp_server_test.c"
        )))
        goto err;
    return fixture;
 ...
 err:
    tear_down(fixture);
    return 
# 44 "../test/cmp_server_test.c" 3 4
          ((void *)0)
# 44 "../test/cmp_server_test.c"
              ;
}

static int dummy_errorCode = 102;
...
static OSSL_CMP_PKISI *process_cert_request(OSSL_CMP_SRV_CTX *srv_ctx,
                                            ...
                                            struct stack_st_X509 **caPubs)
{
    (ERR_new(), ERR_set_debug("../test/cmp_server_test.c",58,__func__), ERR_set_error)((58),(dummy_errorCode),
# 58 "../test/cmp_server_test.c" 3 4
   ((void *)0)
# 58 "../test/cmp_server_test.c"
   );
    return 
# 59 "../test/cmp_server_test.c" 3 4
          ((void *)0)
# 59 "../test/cmp_server_test.c"
              ;
}
...
static int execute_test_handle_request(CMP_SRV_TEST_FIXTURE *fixture)
{
    ...
    OSSL_CMP_MSG *rsp = 
# 68 "../test/cmp_server_test.c" 3 4
                       ((void *)0)
# 68 "../test/cmp_server_test.c"
                           ;
    OSSL_CMP_ERRORMSGCONTENT *errorContent;
    int res = 0;

    if (!test_ptr("../test/cmp_server_test.c", 72, "client_ctx = OSSL_CMP_CTX_new(libctx, NULL)", client_ctx = OSSL_CMP_CTX_new(libctx, 
# 72 "../test/cmp_server_test.c" 3 4
        ((void *)0)
# 72 "../test/cmp_server_test.c"
        ))
            || !test_true("../test/cmp_server_test.c", 73, "OSSL_CMP_CTX_set_transfer_cb_arg(client_ctx, ctx)", (OSSL_CMP_CTX_set_transfer_cb_arg(client_ctx, ctx)) != 0))
        goto end;

    if (!test_true("../test/cmp_server_test.c", 76, "OSSL_CMP_SRV_CTX_init(ctx, dummy_custom_ctx, process_cert_request, NULL, NULL, NULL, NULL, NULL)", (OSSL_CMP_SRV_CTX_init(ctx, dummy_custom_ctx, process_cert_request, 
# 76 "../test/cmp_server_test.c" 3 4
        ((void *)0)
# 76 "../test/cmp_server_test.c"
        , 
# 76 "../test/cmp_server_test.c" 3 4
        ((void *)0)
# 76 "../test/cmp_server_test.c"
...
# 76 "../test/cmp_server_test.c"
        ...
        || !test_true("../test/cmp_server_test.c", 79, "OSSL_CMP_SRV_CTX_init_trans(ctx, NULL, NULL)", (OSSL_CMP_SRV_CTX_init_trans(ctx, 
# 79 "../test/cmp_server_test.c" 3 4
           ((void *)0)
# 79 "../test/cmp_server_test.c"
           , 
# 79 "../test/cmp_server_test.c" 3 4
           ((void *)0)
# 79 "../test/cmp_server_test.c"
           )) != 0)
        || !test_ptr("../test/cmp_server_test.c", 80, "custom_ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(ctx)", custom_ctx = OSSL_CMP_SRV_CTX_get0_custom_ctx(ctx))
        || !test_int_eq("../test/cmp_server_test.c", 81, "strcmp(custom_ctx, dummy_custom_ctx)", "0", strcmp(custom_ctx, dummy_custom_ctx), 0))
        goto end;

    if (!test_true("../test/cmp_server_test.c", 84, "OSSL_CMP_SRV_CTX_set_send_unprotected_errors(ctx, 0)", (OSSL_CMP_SRV_CTX_set_send_unprotected_errors(ctx, 0)) != 0)
            || !test_true("../test/cmp_server_test.c", 85, "OSSL_CMP_SRV_CTX_set_accept_unprotected(ctx, 0)", (OSSL_CMP_SRV_CTX_set_accept_unprotected(ctx, 0)) != 0)
            || !test_true("../test/cmp_server_test.c", 86, "OSSL_CMP_SRV_CTX_set_accept_raverified(ctx, 1)", (OSSL_CMP_SRV_CTX_set_accept_raverified(ctx, 1)) != 0)
            || !test_true("../test/cmp_server_test.c", 87, "OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(ctx, 1)", (OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(ctx, 1)) != 0))
        goto end;

    if (!test_ptr("../test/cmp_server_test.c", 90, "cmp_ctx = OSSL_CMP_SRV_CTX_get0_cmp_ctx(ctx)", cmp_ctx = OSSL_CMP_SRV_CTX_get0_cmp_ctx(ctx))
    ...
    if (!test_ptr("../test/cmp_server_test.c", 97, "rsp = OSSL_CMP_CTX_server_perform(client_ctx, fixture->req)", rsp = OSSL_CMP_CTX_server_perform(client_ctx, fixture->req))
            || !test_int_eq("../test/cmp_server_test.c", 98, "OSSL_CMP_MSG_get_bodytype(rsp)", "OSSL_CMP_PKIBODY_ERROR", OSSL_CMP_MSG_get_bodytype(rsp), 23)

            || !test_ptr("../test/cmp_server_test.c", 100, "errorContent = rsp->body->value.error", errorContent = rsp->body->value.error)
            || !test_int_eq("../test/cmp_server_test.c", 101, "ASN1_INTEGER_get(errorContent->errorCode)", "ERR_PACK(ERR_LIB_CMP, 0, dummy_errorCode)", ASN1_INTEGER_get(errorContent->errorCode), ( (((unsigned long)(58) & 0xFF ) << 23L) | (((unsigned long)(dummy_errorCode) & 0X7FFFFF)) ))
                                                                      )
        goto end;
...
{
    CMP_SRV_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 115 "../test/cmp_server_test.c" 3 4
   ((void *)0)
# 115 "../test/cmp_server_test.c"
   ) return 0;
    fixture->req = request;
    fixture->expected = 1;
    if (fixture != 
# 118 "../test/cmp_server_test.c" 3 4
   ((void *)0)
# 118 "../test/cmp_server_test.c"
   ) { result = execute_test_handle_request(fixture); tear_down(fixture); };
    return result;
}
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "CR_protected_PBM_1234.der module_name [module_conf_file]\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 133 "../test/cmp_server_test.c" 3 4
((void *)0) 
# 133 "../test/cmp_server_test.c"
} }; return options; }
...
int setup_tests(void)
{
    ...
    if (!test_skip_common_options()) {
        test_error("../test/cmp_server_test.c", 140, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/cmp_server_test.c", 144, "request_f = test_get_argument(0)", request_f = test_get_argument(0))) {
        test_error("../test/cmp_server_test.c", 145, "usage: cmp_server_test %s", "CR_protected_PBM_1234.der module_name [module_conf_file]\n");
        return 0;
    }

    if (!test_arg_libctx(&libctx, &default_null_provider, &provider, 1, "CR_protected_PBM_1234.der module_name [module_conf_file]\n"))
        return 0;

    if (!test_ptr("../test/cmp_server_test.c", 152, "request = load_pkimsg(request_f, libctx)", request = load_pkimsg(request_f, libctx))) {
        cleanup_tests();
        return 0;
    }
# 171 "../test/cmp_server_test.c"
