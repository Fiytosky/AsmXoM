# 0 "../test/tls13ccstest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/tls13ccstest.c"
# 10 "../test/tls13ccstest.c"
...
# 15 "../test/tls13ccstest.c" 2

static char *cert = 
# 16 "../test/tls13ccstest.c" 3 4
                   ((void *)0)
# 16 "../test/tls13ccstest.c"
                       ;
static char *privkey = 
# 17 "../test/tls13ccstest.c" 3 4
                      ((void *)0)
# 17 "../test/tls13ccstest.c"
                          ;

static BIO *s_to_c_fbio = 
# 19 "../test/tls13ccstest.c" 3 4
                         ((void *)0)
# 19 "../test/tls13ccstest.c"
                             , *c_to_s_fbio = 
# 19 "../test/tls13ccstest.c" 3 4
                                              ((void *)0)
# 19 "../test/tls13ccstest.c"
...
static unsigned char chsessid[32];
...
static BIO_METHOD *method_watchccs = 
# 38 "../test/tls13ccstest.c" 3 4
                                    ((void *)0)
# 38 "../test/tls13ccstest.c"
                                        ;

static const BIO_METHOD *bio_f_watchccs_filter(void)
{
    if (method_watchccs == 
# 42 "../test/tls13ccstest.c" 3 4
                          ((void *)0)
# 42 "../test/tls13ccstest.c"
                              ) {
        method_watchccs = BIO_meth_new((0x80 | 0x0200),
                                       "Watch CCS filter");
        if (method_watchccs == 
# 45 "../test/tls13ccstest.c" 3 4
                              ((void *)0)
            
# 46 "../test/tls13ccstest.c"
           || !BIO_meth_set_write(method_watchccs, watchccs_write)
            ...
            return 
# 53 "../test/tls13ccstest.c" 3 4
                  ((void *)0)
# 53 "../test/tls13ccstest.c"
                      ;
    }
...
static int watchccs_read(BIO *bio, char *out, int outl)
{
    ...
    if (outl <= 0)
        return 0;
    if (next == 
# 77 "../test/tls13ccstest.c" 3 4
               ((void *)0)
# 77 "../test/tls13ccstest.c"
                   )
        return 0;
    ...
    if (ret <= 0 && BIO_test_flags(next, 0x01))
...
static int watchccs_write(BIO *bio, const char *in, int inl)
{
    ...
    if (inl <= 0)
        return 0;
    if (next == 
# 98 "../test/tls13ccstest.c" 3 4
               ((void *)0)
# 98 "../test/tls13ccstest.c"
                   )
        return 0;
    ...
    if (ret <= 0 && BIO_test_flags(next, 0x02))
...
static long watchccs_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (next == 
# 218 "../test/tls13ccstest.c" 3 4
               ((void *)0)
# 218 "../test/tls13ccstest.c"
                   )
        return 0;
...
{
    SSL_CTX *sctx = 
# 245 "../test/tls13ccstest.c" 3 4
                   ((void *)0)
# 245 "../test/tls13ccstest.c"
                       , *cctx = 
# 245 "../test/tls13ccstest.c" 3 4
                                 ((void *)0)
# 245 "../test/tls13ccstest.c"
                                     ;
    SSL *sssl = 
# 246 "../test/tls13ccstest.c" 3 4
               ((void *)0)
# 246 "../test/tls13ccstest.c"
                   , *cssl = 
# 246 "../test/tls13ccstest.c" 3 4
                             ((void *)0)
# 246 "../test/tls13ccstest.c"
    ...
    SSL_SESSION *sess = 
# 251 "../test/tls13ccstest.c" 3 4
                       ((void *)0)
# 251 "../test/tls13ccstest.c"
                           ;
    ...
    if (!test_true("../test/tls13ccstest.c", 257, "create_ssl_ctx_pair(NULL, TLS_server_method(), TLS_client_method(), TLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 257 "../test/tls13ccstest.c" 3 4
        ((void *)0)
# 257 "../test/tls13ccstest.c"
        , TLS_server_method(), TLS_client_method(), 0x0301, 0, &sctx, &cctx, cert, privkey)) != 0)


        || !test_true("../test/tls13ccstest.c", 260, "SSL_CTX_set_max_early_data(sctx, SSL3_RT_MAX_PLAIN_LENGTH)", (SSL_CTX_set_max_early_data(sctx, 16384)) != 0)
                                                                           )
        goto err;
# 278 "../test/tls13ccstest.c"
    switch (tst) {
    case 0:
    case 3:
    case 6:
    ...
    case 7:
    case 10:
        SSL_CTX_clear_options(cctx, ((uint64_t)1 << (uint64_t)20));
        break;
    case 2:
    case 5:
    case 8:
    case 11:
        SSL_CTX_clear_options(sctx, ((uint64_t)1 << (uint64_t)20));
        break;
    default:
        test_error("../test/tls13ccstest.c", 297, "Invalid test value");
        goto err;
    }

    if (tst >= 6) {

        if (!test_true("../test/tls13ccstest.c", 303, "create_ssl_objects(sctx, cctx, &sssl, &cssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &sssl, &cssl, 
# 303 "../test/tls13ccstest.c" 3 4
            ((void *)0)
# 303 "../test/tls13ccstest.c"
            , 
# 303 "../test/tls13ccstest.c" 3 4
            ((void *)0)
# 303 "../test/tls13ccstest.c"
            )) != 0)
                || !test_true("../test/tls13ccstest.c", 304, "create_ssl_connection(sssl, cssl, SSL_ERROR_NONE)", (create_ssl_connection(sssl, cssl, 0)) != 0))
            goto err;
        sess = SSL_get1_session(cssl);
        if (!test_ptr("../test/tls13ccstest.c", 307, "sess", sess))
            goto err;
        SSL_shutdown(cssl);
        SSL_shutdown(sssl);
        SSL_free(sssl);
        SSL_free(cssl);
        sssl = cssl = 
# 313 "../test/tls13ccstest.c" 3 4
                     ((void *)0)
# 313 "../test/tls13ccstest.c"
                         ;
    }
    ...
    if ((tst >= 3 && tst <= 5) || tst >= 9) {
        ...
        if (!test_true("../test/tls13ccstest.c", 324, "SSL_CTX_set1_groups_list(sctx, \"P-384\")", (SSL_CTX_ctrl(sctx,92,0,(char *)("P-384"))) != 0))
            goto err;
    ...
    if (!test_ptr("../test/tls13ccstest.c", 331, "s_to_c_fbio", s_to_c_fbio)
            || !test_ptr("../test/tls13ccstest.c", 332, "c_to_s_fbio", c_to_s_fbio)) {
    ...
    if (!test_true("../test/tls13ccstest.c", 339, "create_ssl_objects(sctx, cctx, &sssl, &cssl, s_to_c_fbio, c_to_s_fbio)", (create_ssl_objects(sctx, cctx, &sssl, &cssl, s_to_c_fbio, c_to_s_fbio)) != 0)
                                                   )
        goto err;

    if (tst >= 6) {

        if (!test_true("../test/tls13ccstest.c", 345, "SSL_set_session(cssl, sess)", (SSL_set_session(cssl, sess)) != 0)
                || !test_true("../test/tls13ccstest.c", 346, "SSL_write_early_data(cssl, msg, strlen(msg), &written)", (SSL_write_early_data(cssl, msg, strlen(msg), &written)) != 0)

                || (tst <= 8
                    && !test_int_eq("../test/tls13ccstest.c", 349, "SSL_read_early_data(sssl, buf, sizeof(buf), &readbytes)", "SSL_READ_EARLY_DATA_SUCCESS", SSL_read_early_data(sssl, buf, sizeof(buf), &readbytes), 1)

                                                                            ))
            goto err;
        if (tst <= 8) {
            if (!test_int_gt("../test/tls13ccstest.c", 354, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
                goto err;
        } else {
            if (!test_int_le("../test/tls13ccstest.c", 357, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
                goto err;
        }
        if (!test_int_eq("../test/tls13ccstest.c", 360, "SSL_read_early_data(sssl, buf, sizeof(buf), &readbytes)", "SSL_READ_EARLY_DATA_FINISH", SSL_read_early_data(sssl, buf, sizeof(buf), &readbytes), 2)
    ...
    if (!test_true("../test/tls13ccstest.c", 367, "create_ssl_connection(sssl, cssl, SSL_ERROR_NONE)", (create_ssl_connection(sssl, cssl, 0)) != 0))
        goto err;
    ...
    if (!test_false("../test/tls13ccstest.c", 375, "badccs", (badccs) != 0) || !test_false("../test/tls13ccstest.c", 375, "badvers", (badvers) != 0) || !test_false("../test/tls13ccstest.c", 375, "badsessid", (badsessid) != 0))
        goto err;

    switch (tst) {
    case 0:
        if (!test_true("../test/tls13ccstest.c", 380, "sccsseen", (sccsseen) != 0)
                || !test_true("../test/tls13ccstest.c", 381, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 382, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 383, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 1:
        if (!test_true("../test/tls13ccstest.c", 388, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 389, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 390, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_eq("../test/tls13ccstest.c", 391, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 2:
        if (!test_false("../test/tls13ccstest.c", 396, "sccsseen", (sccsseen) != 0)
                || !test_true("../test/tls13ccstest.c", 397, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 398, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 399, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 3:
        if (!test_true("../test/tls13ccstest.c", 404, "sccsseen", (sccsseen) != 0)
                || !test_true("../test/tls13ccstest.c", 405, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 406, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 407, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 4:
        if (!test_true("../test/tls13ccstest.c", 412, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 413, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 414, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_eq("../test/tls13ccstest.c", 415, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 5:
        if (!test_false("../test/tls13ccstest.c", 420, "sccsseen", (sccsseen) != 0)
                || !test_true("../test/tls13ccstest.c", 421, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 422, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 423, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 6:
        if (!test_true("../test/tls13ccstest.c", 428, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 429, "ccsaftersh", (ccsaftersh) != 0)
                || !test_true("../test/tls13ccstest.c", 430, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 431, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 7:
        if (!test_true("../test/tls13ccstest.c", 436, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 437, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 438, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_eq("../test/tls13ccstest.c", 439, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 8:
        if (!test_false("../test/tls13ccstest.c", 444, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 445, "ccsaftersh", (ccsaftersh) != 0)
                || !test_true("../test/tls13ccstest.c", 446, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 447, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 9:
        if (!test_true("../test/tls13ccstest.c", 452, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 453, "ccsaftersh", (ccsaftersh) != 0)
                || !test_true("../test/tls13ccstest.c", 454, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 455, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 10:
        if (!test_true("../test/tls13ccstest.c", 460, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 461, "ccsaftersh", (ccsaftersh) != 0)
                || !test_false("../test/tls13ccstest.c", 462, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_eq("../test/tls13ccstest.c", 463, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;

    case 11:
        if (!test_false("../test/tls13ccstest.c", 468, "sccsseen", (sccsseen) != 0)
                || !test_false("../test/tls13ccstest.c", 469, "ccsaftersh", (ccsaftersh) != 0)
                || !test_true("../test/tls13ccstest.c", 470, "ccsbeforesh", (ccsbeforesh) != 0)
                || !test_size_t_gt("../test/tls13ccstest.c", 471, "chsessidlen", "0", chsessidlen, 0))
            goto err;
        break;
    }
...
# 487 "../test/tls13ccstest.c" 3 4
((void *)0) 
# 487 "../test/tls13ccstest.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/tls13ccstest.c", 492, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/tls13ccstest.c", 496, "cert = test_get_argument(0)", cert = test_get_argument(0))
            || !test_ptr("../test/tls13ccstest.c", 497, "privkey = test_get_argument(1)", privkey = test_get_argument(1)))
        return 0;

    add_all_tests("test_tls13ccs", test_tls13ccs, 12, 1);
