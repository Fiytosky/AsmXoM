# 0 "../test/keymgmt_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/keymgmt_internal_test.c"
# 14 "../test/keymgmt_internal_test.c"
...
# 15 "../test/keymgmt_internal_test.c" 2
...
# 17 "../test/keymgmt_internal_test.c" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 19 "../test/keymgmt_internal_test.c" 2
...
# 20 "../test/keymgmt_internal_test.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 21 "../test/keymgmt_internal_test.c" 2
...
# 22 "../test/keymgmt_internal_test.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 23 "../test/keymgmt_internal_test.c" 2
...
# 24 "../test/keymgmt_internal_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 25 "../test/keymgmt_internal_test.c" 2
...
# 26 "../test/keymgmt_internal_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 27 "../test/keymgmt_internal_test.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 28 "../test/keymgmt_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 29 "../test/keymgmt_internal_test.c" 2
...
# 38 "../test/keymgmt_internal_test.c" 3 4
                                  ((void *)0)
# 38 "../test/keymgmt_internal_test.c"
                                      ;

static void tear_down(FIXTURE *fixture)
{
    if (fixture != 
# 42 "../test/keymgmt_internal_test.c" 3 4
                  ((void *)0)
# 42 "../test/keymgmt_internal_test.c"
                      ) {
        ...
        CRYPTO_free(fixture, "../test/keymgmt_internal_test.c", 47);
    }
}
...
static FIXTURE *set_up(const char *testcase_name)
{
    ...
    if (!test_ptr("../test/keymgmt_internal_test.c", 55, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/keymgmt_internal_test.c", 55))
        || !test_ptr("../test/keymgmt_internal_test.c", 56, "fixture->ctx1 = OSSL_LIB_CTX_new()", fixture->ctx1 = OSSL_LIB_CTX_new())
        || !test_ptr("../test/keymgmt_internal_test.c", 57, "fixture->prov1 = OSSL_PROVIDER_load(fixture->ctx1, \"default\")", fixture->prov1 = OSSL_PROVIDER_load(fixture->ctx1, "default"))

        || !test_ptr("../test/keymgmt_internal_test.c", 59, "fixture->ctx2 = OSSL_LIB_CTX_new()", fixture->ctx2 = OSSL_LIB_CTX_new())
        || !test_ptr("../test/keymgmt_internal_test.c", 60, "fixture->prov2 = OSSL_PROVIDER_load(fixture->ctx2, \"default\")", fixture->prov2 = OSSL_PROVIDER_load(fixture->ctx2, "default"))
                                                                    ) {
        tear_down(fixture);
        return 
# 63 "../test/keymgmt_internal_test.c" 3 4
              ((void *)0)
# 63 "../test/keymgmt_internal_test.c"
                  ;
    }
    return fixture;
}
# 89 "../test/keymgmt_internal_test.c"
static int get_ulong_via_BN(const OSSL_PARAM *p, unsigned long *goal)
{
    BIGNUM *n = 
# 91 "../test/keymgmt_internal_test.c" 3 4
               ((void *)0)
# 91 "../test/keymgmt_internal_test.c"
                   ;
    int ret = 1;

    if (!test_true("../test/keymgmt_internal_test.c", 94, "OSSL_PARAM_get_BN(p, &n)", (OSSL_PARAM_get_BN(p, &n)) != 0)
        || !test_int_ge("../test/keymgmt_internal_test.c", 95, "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))", "0", BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal)), 0))
        ret = 0;
    BN_free(n);
    return ret;
}
...
static int export_cb(const OSSL_PARAM *params, void *arg)
{
    ...
    const OSSL_PARAM *p = 
# 104 "../test/keymgmt_internal_test.c" 3 4
                         ((void *)0)
# 104 "../test/keymgmt_internal_test.c"
                             ;

    if (keydata == 
# 106 "../test/keymgmt_internal_test.c" 3 4
                  ((void *)0)
# 106 "../test/keymgmt_internal_test.c"
                      )
        return 0;

    if (!test_ptr("../test/keymgmt_internal_test.c", 109, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_N)", p = OSSL_PARAM_locate_const(params, "n"))
        || !test_true("../test/keymgmt_internal_test.c", 110, "get_ulong_via_BN(p, &keydata[N])", (get_ulong_via_BN(p, &keydata[0])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 111, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_E)", p = OSSL_PARAM_locate_const(params, "e"))
        || !test_true("../test/keymgmt_internal_test.c", 112, "get_ulong_via_BN(p, &keydata[E])", (get_ulong_via_BN(p, &keydata[1])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 113, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_D)", p = OSSL_PARAM_locate_const(params, "d"))
        || !test_true("../test/keymgmt_internal_test.c", 114, "get_ulong_via_BN(p, &keydata[D])", (get_ulong_via_BN(p, &keydata[2])) != 0))
        return 0;

    if (!test_ptr("../test/keymgmt_internal_test.c", 117, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_FACTOR1)", p = OSSL_PARAM_locate_const(params, "rsa-factor1"))
        || !test_true("../test/keymgmt_internal_test.c", 118, "get_ulong_via_BN(p, &keydata[P])", (get_ulong_via_BN(p, &keydata[3])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 119, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_FACTOR2)", p = OSSL_PARAM_locate_const(params, "rsa-factor2"))
        || !test_true("../test/keymgmt_internal_test.c", 120, "get_ulong_via_BN(p, &keydata[Q])", (get_ulong_via_BN(p, &keydata[4])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 121, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_FACTOR3)", p = OSSL_PARAM_locate_const(params, "rsa-factor3"))
        || !test_true("../test/keymgmt_internal_test.c", 122, "get_ulong_via_BN(p, &keydata[F3])", (get_ulong_via_BN(p, &keydata[5])) != 0))
        return 0;

    if (!test_ptr("../test/keymgmt_internal_test.c", 125, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_EXPONENT1)", p = OSSL_PARAM_locate_const(params, "rsa-exponent1"))
        || !test_true("../test/keymgmt_internal_test.c", 126, "get_ulong_via_BN(p, &keydata[DP])", (get_ulong_via_BN(p, &keydata[6])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 127, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_EXPONENT2)", p = OSSL_PARAM_locate_const(params, "rsa-exponent2"))
        || !test_true("../test/keymgmt_internal_test.c", 128, "get_ulong_via_BN(p, &keydata[DQ])", (get_ulong_via_BN(p, &keydata[7])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 129, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_EXPONENT3)", p = OSSL_PARAM_locate_const(params, "rsa-exponent3"))
        || !test_true("../test/keymgmt_internal_test.c", 130, "get_ulong_via_BN(p, &keydata[E3])", (get_ulong_via_BN(p, &keydata[8])) != 0))
        return 0;

    if (!test_ptr("../test/keymgmt_internal_test.c", 133, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_COEFFICIENT1)", p = OSSL_PARAM_locate_const(params, "rsa-coefficient1"))
        || !test_true("../test/keymgmt_internal_test.c", 134, "get_ulong_via_BN(p, &keydata[QINV])", (get_ulong_via_BN(p, &keydata[9])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 135, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_COEFFICIENT2)", p = OSSL_PARAM_locate_const(params, "rsa-coefficient2"))
        || !test_true("../test/keymgmt_internal_test.c", 136, "get_ulong_via_BN(p, &keydata[C2])", (get_ulong_via_BN(p, &keydata[10])) != 0))
        return 0;
...
static int test_pass_rsa(FIXTURE *fixture)
{
    ...
    int ret = 0;
    RSA *rsa = 
# 146 "../test/keymgmt_internal_test.c" 3 4
              ((void *)0)
# 146 "../test/keymgmt_internal_test.c"
                  ;
    BIGNUM *bn1 = 
# 147 "../test/keymgmt_internal_test.c" 3 4
                 ((void *)0)
# 147 "../test/keymgmt_internal_test.c"
                     , *bn2 = 
# 147 "../test/keymgmt_internal_test.c" 3 4
                              ((void *)0)
# 147 "../test/keymgmt_internal_test.c"
...
# 147 "../test/keymgmt_internal_test.c"
                                               ;
    EVP_PKEY *pk = 
# 148 "../test/keymgmt_internal_test.c" 3 4
                  ((void *)0)
# 148 "../test/keymgmt_internal_test.c"
                      , *dup_pk = 
# 148 "../test/keymgmt_internal_test.c" 3 4
                                  ((void *)0)
# 148 "../test/keymgmt_internal_test.c"
                                      ;
    EVP_KEYMGMT *km = 
# 149 "../test/keymgmt_internal_test.c" 3 4
                     ((void *)0)
# 149 "../test/keymgmt_internal_test.c"
                         , *km1 = 
# 149 "../test/keymgmt_internal_test.c" 3 4
                                  ((void *)0)
# 149 "../test/keymgmt_internal_test.c"
...
# 149 "../test/keymgmt_internal_test.c"
                                                                ;
    void *provkey = 
# 150 "../test/keymgmt_internal_test.c" 3 4
                   ((void *)0)
# 150 "../test/keymgmt_internal_test.c"
                       , *provkey2 = 
# 150 "../test/keymgmt_internal_test.c" 3 4
                                     ((void *)0)
# 150 "../test/keymgmt_internal_test.c"
                                         ;
    BIGNUM *bn_primes[1] = { 
# 151 "../test/keymgmt_internal_test.c" 3 4
                            ((void *)0) 
# 151 "../test/keymgmt_internal_test.c"
                                 };
    BIGNUM *bn_exps[1] = { 
# 152 "../test/keymgmt_internal_test.c" 3 4
                          ((void *)0) 
# 152 "../test/keymgmt_internal_test.c"
                               };
    BIGNUM *bn_coeffs[1] = { 
# 153 "../test/keymgmt_internal_test.c" 3 4
                            ((void *)0) 
# 153 "../test/keymgmt_internal_test.c"
                                 };
    ...
    static unsigned long keydata[(sizeof(expected)/sizeof((expected)[0]))] = { 0, };

    if (!test_ptr("../test/keymgmt_internal_test.c", 177, "rsa = RSA_new()", rsa = RSA_new()))
        goto err;

    if (!test_ptr("../test/keymgmt_internal_test.c", 180, "bn1 = BN_new()", bn1 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 181, "BN_set_word(bn1, expected[N])", (BN_set_word(bn1, expected[0])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 182, "bn2 = BN_new()", bn2 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 183, "BN_set_word(bn2, expected[E])", (BN_set_word(bn2, expected[1])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 184, "bn3 = BN_new()", bn3 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 185, "BN_set_word(bn3, expected[D])", (BN_set_word(bn3, expected[2])) != 0)
        || !test_true("../test/keymgmt_internal_test.c", 186, "RSA_set0_key(rsa, bn1, bn2, bn3)", (RSA_set0_key(rsa, bn1, bn2, bn3)) != 0))
        goto err;

    if (!test_ptr("../test/keymgmt_internal_test.c", 189, "bn1 = BN_new()", bn1 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 190, "BN_set_word(bn1, expected[P])", (BN_set_word(bn1, expected[3])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 191, "bn2 = BN_new()", bn2 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 192, "BN_set_word(bn2, expected[Q])", (BN_set_word(bn2, expected[4])) != 0)
        || !test_true("../test/keymgmt_internal_test.c", 193, "RSA_set0_factors(rsa, bn1, bn2)", (RSA_set0_factors(rsa, bn1, bn2)) != 0))
        goto err;

    if (!test_ptr("../test/keymgmt_internal_test.c", 196, "bn1 = BN_new()", bn1 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 197, "BN_set_word(bn1, expected[DP])", (BN_set_word(bn1, expected[6])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 198, "bn2 = BN_new()", bn2 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 199, "BN_set_word(bn2, expected[DQ])", (BN_set_word(bn2, expected[7])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 200, "bn3 = BN_new()", bn3 = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 201, "BN_set_word(bn3, expected[QINV])", (BN_set_word(bn3, expected[9])) != 0)
        || !test_true("../test/keymgmt_internal_test.c", 202, "RSA_set0_crt_params(rsa, bn1, bn2, bn3)", (RSA_set0_crt_params(rsa, bn1, bn2, bn3)) != 0))
        goto err;
    bn1 = bn2 = bn3 = 
# 204 "../test/keymgmt_internal_test.c" 3 4
                     ((void *)0)
# 204 "../test/keymgmt_internal_test.c"
                         ;

    if (!test_ptr("../test/keymgmt_internal_test.c", 206, "bn_primes[0] = BN_new()", bn_primes[0] = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 207, "BN_set_word(bn_primes[0], expected[F3])", (BN_set_word(bn_primes[0], expected[5])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 208, "bn_exps[0] = BN_new()", bn_exps[0] = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 209, "BN_set_word(bn_exps[0], expected[E3])", (BN_set_word(bn_exps[0], expected[8])) != 0)
        || !test_ptr("../test/keymgmt_internal_test.c", 210, "bn_coeffs[0] = BN_new()", bn_coeffs[0] = BN_new())
        || !test_true("../test/keymgmt_internal_test.c", 211, "BN_set_word(bn_coeffs[0], expected[C2])", (BN_set_word(bn_coeffs[0], expected[10])) != 0)
        || !test_true("../test/keymgmt_internal_test.c", 212, "RSA_set0_multi_prime_params(rsa, bn_primes, bn_exps, bn_coeffs, 1)", (RSA_set0_multi_prime_params(rsa, bn_primes, bn_exps, bn_coeffs, 1)) != 0)
                                                                )
        goto err;

    if (!test_ptr("../test/keymgmt_internal_test.c", 216, "pk = EVP_PKEY_new()", pk = EVP_PKEY_new())
        || !test_true("../test/keymgmt_internal_test.c", 217, "EVP_PKEY_assign_RSA(pk, rsa)", (EVP_PKEY_assign((pk),6, (rsa))) != 0))
        goto err;
    rsa = 
# 219 "../test/keymgmt_internal_test.c" 3 4
         ((void *)0)
# 219 "../test/keymgmt_internal_test.c"
             ;

    if (!test_ptr("../test/keymgmt_internal_test.c", 221, "km1 = EVP_KEYMGMT_fetch(fixture->ctx1, \"RSA\", NULL)", km1 = EVP_KEYMGMT_fetch(fixture->ctx1, "RSA", 
# 221 "../test/keymgmt_internal_test.c" 3 4
        ((void *)0)
# 221 "../test/keymgmt_internal_test.c"
        ))
        || !test_ptr("../test/keymgmt_internal_test.c", 222, "km2 = EVP_KEYMGMT_fetch(fixture->ctx2, \"RSA\", NULL)", km2 = EVP_KEYMGMT_fetch(fixture->ctx2, "RSA", 
# 222 "../test/keymgmt_internal_test.c" 3 4
           ((void *)0)
# 222 "../test/keymgmt_internal_test.c"
           ))
        || !test_ptr("../test/keymgmt_internal_test.c", 223, "km3 = EVP_KEYMGMT_fetch(fixture->ctx1, \"RSA-PSS\", NULL)", km3 = EVP_KEYMGMT_fetch(fixture->ctx1, "RSA-PSS", 
# 223 "../test/keymgmt_internal_test.c" 3 4
           ((void *)0)
# 223 "../test/keymgmt_internal_test.c"
           ))
        || !test_ptr_ne("../test/keymgmt_internal_test.c", 224, "km1", "km2", km1, km2))
        goto err;
    ...
    for (;;) {
        ...
        if (!test_ptr_null("../test/keymgmt_internal_test.c", 231, "provkey2 = evp_pkey_export_to_provider(pk, NULL, &km, NULL)", provkey2 = evp_pkey_export_to_provider(pk, 
# 231 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 231 "../test/keymgmt_internal_test.c"
            , &km, 
# 231 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 231 "../test/keymgmt_internal_test.c"
        ...
        if (!test_ptr("../test/keymgmt_internal_test.c", 236, "provkey = evp_pkey_export_to_provider(pk, NULL, &km1, NULL)", provkey = evp_pkey_export_to_provider(pk, 
# 236 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 236 "../test/keymgmt_internal_test.c"
            , &km1, 
# 236 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 236 "../test/keymgmt_internal_test.c"
            ...
            || !test_true("../test/keymgmt_internal_test.c", 238, "evp_keymgmt_export(km2, provkey, OSSL_KEYMGMT_SELECT_KEYPAIR, &export_cb, keydata)", (evp_keymgmt_export(km2, provkey, ( 0x01 | 0x02 ), &export_cb, keydata)) != 0)
        ...
        for (i = 0; i < (sizeof(expected)/sizeof((expected)[0])); i++) {
            int rv = test_int_eq("../test/keymgmt_internal_test.c", 249, "expected[i]", "keydata[i]", expected[i], keydata[i]);

            if (!rv)
                test_info("../test/keymgmt_internal_test.c", 252, "i = %zu", i);
            else
                ret++;
        }

        ret = (ret == (sizeof(expected)/sizeof((expected)[0])));

        if (!ret || dup_pk != 
# 259 "../test/keymgmt_internal_test.c" 3 4
                             ((void *)0)
# 259 "../test/keymgmt_internal_test.c"
                                 )
            break;

        if (!test_ptr("../test/keymgmt_internal_test.c", 262, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;

        ret = test_int_eq("../test/keymgmt_internal_test.c", 265, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
{
    FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 291 "../test/keymgmt_internal_test.c" 3 4
   ((void *)0)
# 291 "../test/keymgmt_internal_test.c"
   ) return 0;
    if (fixture != 
# 292 "../test/keymgmt_internal_test.c" 3 4
   ((void *)0)
# 292 "../test/keymgmt_internal_test.c"
   ) { result = tests[n](fixture); tear_down(fixture); };
    return result;
}
...
{
    OSSL_LIB_CTX *libctx = 
# 298 "../test/keymgmt_internal_test.c" 3 4
                          ((void *)0)
# 298 "../test/keymgmt_internal_test.c"
                              ;
    OSSL_PROVIDER *prov = 
# 299 "../test/keymgmt_internal_test.c" 3 4
                         ((void *)0)
# 299 "../test/keymgmt_internal_test.c"
                             ;
    X509 *cert = 
# 300 "../test/keymgmt_internal_test.c" 3 4
                ((void *)0)
# 300 "../test/keymgmt_internal_test.c"
                    ;
    BIO *bio = 
# 301 "../test/keymgmt_internal_test.c" 3 4
              ((void *)0)
# 301 "../test/keymgmt_internal_test.c"
                  ;
    X509_PUBKEY *pubkey = 
# 302 "../test/keymgmt_internal_test.c" 3 4
                         ((void *)0)
# 302 "../test/keymgmt_internal_test.c"
                             ;
    EVP_KEYMGMT *keymgmt = 
# 303 "../test/keymgmt_internal_test.c" 3 4
                          ((void *)0)
# 303 "../test/keymgmt_internal_test.c"
                              ;
    EVP_PKEY *pkey = 
# 304 "../test/keymgmt_internal_test.c" 3 4
                    ((void *)0)
# 304 "../test/keymgmt_internal_test.c"
                        ;
    void *keydata = 
# 305 "../test/keymgmt_internal_test.c" 3 4
                   ((void *)0)
# 305 "../test/keymgmt_internal_test.c"
                       ;
    int ret = 0;

    if (!test_ptr("../test/keymgmt_internal_test.c", 308, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new())
         || !test_ptr("../test/keymgmt_internal_test.c", 309, "prov = OSSL_PROVIDER_load(libctx, \"default\")", prov = OSSL_PROVIDER_load(libctx, "default")))
        goto end;

    if ((bio = BIO_new_file(cert_filename, "r")) == 
# 312 "../test/keymgmt_internal_test.c" 3 4
                                                   ((void *)0)
# 312 "../test/keymgmt_internal_test.c"
                                                       ) {
        test_error("../test/keymgmt_internal_test.c", 313, "Couldn't open '%s' for reading\n", cert_filename);
        test_openssl_errors();
        goto end;
    }

    if ((cert = PEM_read_bio_X509(bio, 
# 318 "../test/keymgmt_internal_test.c" 3 4
                                      ((void *)0)
# 318 "../test/keymgmt_internal_test.c"
                                          , 
# 318 "../test/keymgmt_internal_test.c" 3 4
                                            ((void *)0)
# 318 "../test/keymgmt_internal_test.c"
...
# 318 "../test/keymgmt_internal_test.c"
        ...
        test_error("../test/keymgmt_internal_test.c", 319, "'%s' doesn't appear to be a X.509 certificate in PEM format\n", cert_filename)
                                 ;
        test_openssl_errors();
        goto end;
    }
    ...
    if (n == 0) {
        if (!test_ptr("../test/keymgmt_internal_test.c", 329, "keydata = evp_pkey_export_to_provider(pkey, NULL, NULL, NULL)", keydata = evp_pkey_export_to_provider(pkey, 
# 329 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 329 "../test/keymgmt_internal_test.c"
            , 
# 329 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 329 "../test/keymgmt_internal_test.c"
...
# 329 "../test/keymgmt_internal_test.c"
        ...
        if (!test_ptr("../test/keymgmt_internal_test.c", 333, "keydata = evp_pkey_export_to_provider(pkey, NULL, &keymgmt, NULL)", keydata = evp_pkey_export_to_provider(pkey, 
# 333 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 333 "../test/keymgmt_internal_test.c"
            , &keymgmt, 
# 333 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 333 "../test/keymgmt_internal_test.c"
        ...
        keymgmt = EVP_KEYMGMT_fetch(libctx, "RSA", 
# 337 "../test/keymgmt_internal_test.c" 3 4
                                                  ((void *)0)
# 337 "../test/keymgmt_internal_test.c"
                                                      );

        if (!test_ptr("../test/keymgmt_internal_test.c", 339, "keydata = evp_pkey_export_to_provider(pkey, NULL, &keymgmt, NULL)", keydata = evp_pkey_export_to_provider(pkey, 
# 339 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 339 "../test/keymgmt_internal_test.c"
            , &keymgmt, 
# 339 "../test/keymgmt_internal_test.c" 3 4
            ((void *)0)
# 339 "../test/keymgmt_internal_test.c"
...
int setup_tests(void)
{
    if (!test_ptr("../test/keymgmt_internal_test.c", 356, "cert_filename = test_get_argument(0)", cert_filename = test_get_argument(0)))
        return 0;

    add_all_tests("test_pass_key", test_pass_key, 1, 1);
    add_all_tests("test_evp_pkey_export_to_provider", test_evp_pkey_export_to_provider, 3, 1);
    return 1;
}
