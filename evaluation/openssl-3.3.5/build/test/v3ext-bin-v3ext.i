...
# 25 "../test/v3ext.c"
    ...
    if (!test_ptr("../test/v3ext.c", 29, "b = BIO_new_file(infile, \"r\")", b = BIO_new_file(infile, "r"))
            || !test_ptr("../test/v3ext.c", 30, "x = PEM_read_bio_X509(b, NULL, NULL, NULL)", x = PEM_read_bio_X509(b, 
# 30 "../test/v3ext.c" 3 4
               ((void *)0)
# 30 "../test/v3ext.c"
               , 
...
# 30 "../test/v3ext.c"
            ...
            || !test_int_eq("../test/v3ext.c", 31, "pathlen = X509_get_pathlen(x)", "6", pathlen = X509_get_pathlen(x), 6))
        goto end;
...
# 45 "../test/v3ext.c"
    ...
    if (!test_ptr("../test/v3ext.c", 50, "asid1", asid1)
            || !test_ptr("../test/v3ext.c", 51, "asid2", asid2)
            || !test_ptr("../test/v3ext.c", 52, "asid3", asid3))
        goto err;

    if (!test_ptr("../test/v3ext.c", 55, "val1 = ASN1_INTEGER_new()", val1 = ASN1_INTEGER_new())
            || !test_true("../test/v3ext.c", 56, "ASN1_INTEGER_set_int64(val1, 64496)", (ASN1_INTEGER_set_int64(val1, 64496)) != 0))
        goto err;

    if (!test_true("../test/v3ext.c", 59, "X509v3_asid_add_id_or_range(asid1, V3_ASID_ASNUM, val1, NULL)", (X509v3_asid_add_id_or_range(asid1, 0, val1, 
# 59 "../test/v3ext.c" 3 4
        ((void *)0)
# 59 "../test/v3ext.c"
        )) != 0))
...
# 62 "../test/v3ext.c"
              ;
    if (!test_ptr("../test/v3ext.c", 63, "val2 = ASN1_INTEGER_new()", val2 = ASN1_INTEGER_new())
            || !test_true("../test/v3ext.c", 64, "ASN1_INTEGER_set_int64(val2, 64497)", (ASN1_INTEGER_set_int64(val2, 64497)) != 0))
        goto err;

    if (!test_true("../test/v3ext.c", 67, "X509v3_asid_add_id_or_range(asid2, V3_ASID_ASNUM, val2, NULL)", (X509v3_asid_add_id_or_range(asid2, 0, val2, 
# 67 "../test/v3ext.c" 3 4
        ((void *)0)
# 67 "../test/v3ext.c"
        )) != 0))
...
# 70 "../test/v3ext.c"
              ;
    if (!test_ptr("../test/v3ext.c", 71, "val1 = ASN1_INTEGER_new()", val1 = ASN1_INTEGER_new())
            || !test_true("../test/v3ext.c", 72, "ASN1_INTEGER_set_int64(val1, 64496)", (ASN1_INTEGER_set_int64(val1, 64496)) != 0)
            || !test_ptr("../test/v3ext.c", 73, "val2 = ASN1_INTEGER_new()", val2 = ASN1_INTEGER_new())
            || !test_true("../test/v3ext.c", 74, "ASN1_INTEGER_set_int64(val2, 64497)", (ASN1_INTEGER_set_int64(val2, 64497)) != 0))
        goto err;
    ...
    if (!test_true("../test/v3ext.c", 81, "X509v3_asid_add_id_or_range(asid3, V3_ASID_ASNUM, val1, val2)", (X509v3_asid_add_id_or_range(asid3, 0, val1, val2)) != 0))
        goto err;
    val1 = val2 = 
# 83 "../test/v3ext.c" 3 4
                 ((void *)0)
# 83 "../test/v3ext.c"
    ...
    if (!test_true("../test/v3ext.c", 86, "X509v3_asid_subset(NULL, NULL)", (X509v3_asid_subset(
# 86 "../test/v3ext.c" 3 4
        ((void *)0)
# 86 "../test/v3ext.c"
        , 
...
# 86 "../test/v3ext.c"
            ...
            || !test_true("../test/v3ext.c", 87, "X509v3_asid_subset(NULL, asid1)", (X509v3_asid_subset(
# 87 "../test/v3ext.c" 3 4
               ((void *)0)
# 87 "../test/v3ext.c"
               , asid1)) != 0)
            || !test_true("../test/v3ext.c", 88, "X509v3_asid_subset(asid1, asid1)", (X509v3_asid_subset(asid1, asid1)) != 0)
            || !test_true("../test/v3ext.c", 89, "X509v3_asid_subset(asid2, asid2)", (X509v3_asid_subset(asid2, asid2)) != 0)
            || !test_true("../test/v3ext.c", 90, "X509v3_asid_subset(asid1, asid3)", (X509v3_asid_subset(asid1, asid3)) != 0)
            || !test_true("../test/v3ext.c", 91, "X509v3_asid_subset(asid2, asid3)", (X509v3_asid_subset(asid2, asid3)) != 0)
            || !test_true("../test/v3ext.c", 92, "X509v3_asid_subset(asid3, asid3)", (X509v3_asid_subset(asid3, asid3)) != 0)
            || !test_true("../test/v3ext.c", 93, "X509v3_asid_subset(asid4, asid1)", (X509v3_asid_subset(asid4, asid1)) != 0)
            || !test_true("../test/v3ext.c", 94, "X509v3_asid_subset(asid4, asid2)", (X509v3_asid_subset(asid4, asid2)) != 0)
            || !test_true("../test/v3ext.c", 95, "X509v3_asid_subset(asid4, asid3)", (X509v3_asid_subset(asid4, asid3)) != 0))
        goto err;


    if (!test_false("../test/v3ext.c", 99, "X509v3_asid_subset(asid1, NULL)", (X509v3_asid_subset(asid1, 
# 99 "../test/v3ext.c" 3 4
        ((void *)0)
# 99 "../test/v3ext.c"
        )) != 0)
            || !test_false("../test/v3ext.c", 100, "X509v3_asid_subset(asid1, asid2)", (X509v3_asid_subset(asid1, asid2)) != 0)
            || !test_false("../test/v3ext.c", 101, "X509v3_asid_subset(asid2, asid1)", (X509v3_asid_subset(asid2, asid1)) != 0)
            || !test_false("../test/v3ext.c", 102, "X509v3_asid_subset(asid3, asid1)", (X509v3_asid_subset(asid3, asid1)) != 0)
            || !test_false("../test/v3ext.c", 103, "X509v3_asid_subset(asid3, asid2)", (X509v3_asid_subset(asid3, asid2)) != 0)
            || !test_false("../test/v3ext.c", 104, "X509v3_asid_subset(asid1, asid4)", (X509v3_asid_subset(asid1, asid4)) != 0)
            || !test_false("../test/v3ext.c", 105, "X509v3_asid_subset(asid2, asid4)", (X509v3_asid_subset(asid2, asid4)) != 0)
            || !test_false("../test/v3ext.c", 106, "X509v3_asid_subset(asid3, asid4)", (X509v3_asid_subset(asid3, asid4)) != 0))
        goto err;
...
static int check_addr(IPAddrBlocks *addr, int type)
{
    ...
    if (!test_int_eq("../test/v3ext.c", 151, "sk_IPAddressFamily_num(addr)", "1", OPENSSL_sk_num(ossl_check_const_IPAddressFamily_sk_type(addr)), 1))
        return 0;

    fam = ((IPAddressFamily *)OPENSSL_sk_value(ossl_check_const_IPAddressFamily_sk_type(addr), (0)));
    if (!test_ptr("../test/v3ext.c", 155, "fam", fam))
        return 0;

    if (!test_int_eq("../test/v3ext.c", 158, "fam->ipAddressChoice->type", "IPAddressChoice_addressesOrRanges", fam->ipAddressChoice->type, 1))
        return 0;

    if (!test_int_eq("../test/v3ext.c", 161, "sk_IPAddressOrRange_num(fam->ipAddressChoice->u.addressesOrRanges)", "1", OPENSSL_sk_num(ossl_check_const_IPAddressOrRange_sk_type(fam->ipAddressChoice->u.addressesOrRanges)), 1))
        return 0;

    aorr = ((IPAddressOrRange *)OPENSSL_sk_value(ossl_check_const_IPAddressOrRange_sk_type(fam->ipAddressChoice->u.addressesOrRanges), (0)));
    if (!test_ptr("../test/v3ext.c", 165, "aorr", aorr))
        return 0;

    if (!test_int_eq("../test/v3ext.c", 168, "aorr->type", "type", aorr->type, type))
        return 0;
...
{
    IPAddrBlocks *addr = 
# 176 "../test/v3ext.c" 3 4
                        ((void *)0)
# 176 "../test/v3ext.c"
                            ;
    ASN1_OCTET_STRING *ip1 = 
# 177 "../test/v3ext.c" 3 4
                            ((void *)0)
# 177 "../test/v3ext.c"
                                , *ip2 = 
# 177 "../test/v3ext.c" 3 4
...
# 177 "../test/v3ext.c"
    ...
    for (i = 0; i < (sizeof(ranges)/sizeof((ranges)[0])); i++) {
        ...
        if (!test_ptr("../test/v3ext.c", 183, "addr", addr))
            goto end;




        if (!test_true("../test/v3ext.c", 189, "X509v3_addr_canonize(addr)", (X509v3_addr_canonize(addr)) != 0))
            goto end;

        ip1 = a2i_IPADDRESS(ranges[i].ip1);
        if (!test_ptr("../test/v3ext.c", 193, "ip1", ip1))
            goto end;
        if (!test_true("../test/v3ext.c", 195, "ip1->length == 4 || ip1->length == 16", (ip1->length == 4 || ip1->length == 16) != 0))
            goto end;
        ip2 = a2i_IPADDRESS(ranges[i].ip2);
        if (!test_ptr("../test/v3ext.c", 198, "ip2", ip2))
            goto end;
        if (!test_int_eq("../test/v3ext.c", 200, "ip2->length", "ip1->length", ip2->length, ip1->length))
            goto end;
        if (!test_true("../test/v3ext.c", 202, "memcmp(ip1->data, ip2->data, ip1->length) <= 0", (memcmp(ip1->data, ip2->data, ip1->length) <= 0) != 0))
            goto end;

        if (!test_true("../test/v3ext.c", 205, "X509v3_addr_add_range(addr, ranges[i].afi, NULL, ip1->data, ip2->data)", (X509v3_addr_add_range(addr, ranges[i].afi, 
# 205 "../test/v3ext.c" 3 4
            ((void *)0)
# 205 "../test/v3ext.c"
            , ip1->data, ip2->data)) != 0))
            goto end;

        if (!test_true("../test/v3ext.c", 208, "X509v3_addr_is_canonical(addr)", (X509v3_addr_is_canonical(addr)) != 0))
            goto end;
...
static int test_addr_fam_len(void)
{
    int testresult = 0;
    IPAddrBlocks *addr = 
# 232 "../test/v3ext.c" 3 4
                        ((void *)0)
# 232 "../test/v3ext.c"
                            ;
    IPAddressFamily *f1 = 
# 233 "../test/v3ext.c" 3 4
                         ((void *)0)
# 233 "../test/v3ext.c"
                             ;
    ASN1_OCTET_STRING *ip1 = 
# 234 "../test/v3ext.c" 3 4
                            ((void *)0)
# 234 "../test/v3ext.c"
                                , *ip2 = 
# 234 "../test/v3ext.c" 3 4
...
# 234 "../test/v3ext.c"
    ...
    if (!test_ptr("../test/v3ext.c", 247, "ip2", ip2))
        goto end;
    if (!test_true("../test/v3ext.c", 249, "X509v3_addr_add_range(addr, ranges[0].afi, NULL, ip1->data, ip2->data)", (X509v3_addr_add_range(addr, ranges[0].afi, 
# 249 "../test/v3ext.c" 3 4
        ((void *)0)
# 249 "../test/v3ext.c"
        , ip1->data, ip2->data)) != 0))
        goto end;
    ...
    key[5] = 0xD;
    keylen = 6;
    if ((f1 = IPAddressFamily_new()) == 
# 262 "../test/v3ext.c" 3 4
                                       ((void *)0)
# 262 "../test/v3ext.c"
                                           )
        goto end;
    if (f1->ipAddressChoice == 
# 264 "../test/v3ext.c" 3 4
                              ((void *)0) 
# 264 "../test/v3ext.c"
                                   &&
        (f1->ipAddressChoice = IPAddressChoice_new()) == 
# 265 "../test/v3ext.c" 3 4
                                                        ((void *)0)
# 265 "../test/v3ext.c"
                                                            )
        goto end;
    if (f1->addressFamily == 
# 267 "../test/v3ext.c" 3 4
                            ((void *)0) 
# 267 "../test/v3ext.c"
                                 &&
        (f1->addressFamily = ASN1_OCTET_STRING_new()) == 
# 268 "../test/v3ext.c" 3 4
                                                        ((void *)0)
# 268 "../test/v3ext.c"
                                                            )
        goto end;
    ...
    if (!OPENSSL_sk_push(ossl_check_IPAddressFamily_sk_type(addr), ossl_check_IPAddressFamily_type(f1)))
        goto end;
    f1 = 
# 276 "../test/v3ext.c" 3 4
        ((void *)0)
# 276 "../test/v3ext.c"
            ;


    if (!test_false("../test/v3ext.c", 279, "X509v3_addr_canonize(addr)", (X509v3_addr_canonize(addr)) != 0))
        goto end;


    IPAddressFamily_free(((IPAddressFamily *)OPENSSL_sk_pop(ossl_check_IPAddressFamily_sk_type(addr))));
    ...
    keylen = 3;
    if ((f1 = IPAddressFamily_new()) == 
# 290 "../test/v3ext.c" 3 4
                                       ((void *)0)
# 290 "../test/v3ext.c"
                                           )
        goto end;
    if (f1->ipAddressChoice == 
# 292 "../test/v3ext.c" 3 4
                              ((void *)0) 
# 292 "../test/v3ext.c"
                                   &&
        (f1->ipAddressChoice = IPAddressChoice_new()) == 
# 293 "../test/v3ext.c" 3 4
                                                        ((void *)0)
# 293 "../test/v3ext.c"
                                                            )
        goto end;
    if (f1->addressFamily == 
# 295 "../test/v3ext.c" 3 4
                            ((void *)0) 
# 295 "../test/v3ext.c"
                                 &&
        (f1->addressFamily = ASN1_OCTET_STRING_new()) == 
# 296 "../test/v3ext.c" 3 4
                                                        ((void *)0)
# 296 "../test/v3ext.c"
                                                            )
        goto end;
    ...
    f1->ipAddressChoice->type = 0;


    if (!OPENSSL_sk_push(ossl_check_IPAddressFamily_sk_type(addr), ossl_check_IPAddressFamily_type(f1)))
        goto end;
    f1 = 
# 307 "../test/v3ext.c" 3 4
        ((void *)0)
# 307 "../test/v3ext.c"
            ;


    if (!test_true("../test/v3ext.c", 310, "X509v3_addr_canonize(addr)", (X509v3_addr_canonize(addr)) != 0))
        goto end;
...
static int test_ext_syntax(void)
{
    ...
    for (i = 0; i < (sizeof(extvalues)/sizeof((extvalues)[0])); i++) {
        X509V3_CTX ctx;
        ...
        if (!test_ptr("../test/v3ext.c", 383, "extbio", extbio))
            return 0 ;

        conf = NCONF_new_ex(
# 386 "../test/v3ext.c" 3 4
                           ((void *)0)
# 386 "../test/v3ext.c"
                               , 
# 386 "../test/v3ext.c" 3 4
...
# 386 "../test/v3ext.c"
        ...
        if (!test_ptr("../test/v3ext.c", 387, "conf", conf)) {
            BIO_free(extbio);
            return 0;
        }
        if (!test_long_gt("../test/v3ext.c", 391, "NCONF_load_bio(conf, extbio, &eline)", "0", NCONF_load_bio(conf, extbio, &eline), 0)) {
            testresult = 0;
        } else {
            X509V3_set_ctx(&ctx, 
# 394 "../test/v3ext.c" 3 4
           ((void *)0)
# 394 "../test/v3ext.c"
           , 
# 394 "../test/v3ext.c" 3 4
...
# 394 "../test/v3ext.c"
           , 0x1);
            ...
            if (extvalues[i].pass) {
                if (!test_true("../test/v3ext.c", 398, "X509V3_EXT_add_nconf(conf, &ctx, \"default\", NULL)", (X509V3_EXT_add_nconf(conf, &ctx, "default", 
# 398 "../test/v3ext.c" 3 4
                    ((void *)0)
# 398 "../test/v3ext.c"
                    )) != 0)
                                                          ) {
                    test_info("../test/v3ext.c", 400, "Value: %s", extvalues[i].value);
                    testresult = 0;
                }
            } else {
                ERR_set_mark();
                if (!test_false("../test/v3ext.c", 405, "X509V3_EXT_add_nconf(conf, &ctx, \"default\", NULL)", (X509V3_EXT_add_nconf(conf, &ctx, "default", 
# 405 "../test/v3ext.c" 3 4
                    ((void *)0)
# 405 "../test/v3ext.c"
                    )) != 0)
                                                           ) {
                    testresult = 0;
                    test_info("../test/v3ext.c", 408, "Value: %s", extvalues[i].value);
                    ERR_clear_last_mark();
                } else {
                    ERR_pop_to_mark();
                }
...
static int test_addr_subset(void)
{
    int i;
    int ret = 0;
    IPAddrBlocks *addrEmpty = 
# 426 "../test/v3ext.c" 3 4
                             ((void *)0)
# 426 "../test/v3ext.c"
                                 ;
    IPAddrBlocks *addr[3] = { 
# 427 "../test/v3ext.c" 3 4
                             ((void *)0)
# 427 "../test/v3ext.c"
                                 , 
# 427 "../test/v3ext.c" 3 4
...
# 427 "../test/v3ext.c"
    ...
    ASN1_OCTET_STRING *ip1[3] = { 
# 428 "../test/v3ext.c" 3 4
                                 ((void *)0)
# 428 "../test/v3ext.c"
                                     , 
# 428 "../test/v3ext.c" 3 4
...
# 428 "../test/v3ext.c"
    ...
    ASN1_OCTET_STRING *ip2[3] = { 
# 429 "../test/v3ext.c" 3 4
                                 ((void *)0)
# 429 "../test/v3ext.c"
                                     , 
# 429 "../test/v3ext.c" 3 4
...
# 429 "../test/v3ext.c"
    ...
    int sz = (sizeof(addr)/sizeof((addr)[0]));

    for (i = 0; i < sz; ++i) {

        if (!test_ptr("../test/v3ext.c", 434, "addr[i] = sk_IPAddressFamily_new_null()", addr[i] = ((struct stack_st_IPAddressFamily *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/v3ext.c", 435, "ip1[i] = a2i_IPADDRESS(ranges[i].ip1)", ip1[i] = a2i_IPADDRESS(ranges[i].ip1))
            || !test_ptr("../test/v3ext.c", 436, "ip2[i] = a2i_IPADDRESS(ranges[i].ip2)", ip2[i] = a2i_IPADDRESS(ranges[i].ip2))
            || !test_true("../test/v3ext.c", 437, "X509v3_addr_add_range(addr[i], ranges[i].afi, NULL, ip1[i]->data, ip2[i]->data)", (X509v3_addr_add_range(addr[i], ranges[i].afi, 
# 437 "../test/v3ext.c" 3 4
               ((void *)0)
# 437 "../test/v3ext.c"
               , ip1[i]->data, ip2[i]->data)) != 0)
                                                                            )
            goto end;
    }

    ret = test_ptr("../test/v3ext.c", 442, "addrEmpty = sk_IPAddressFamily_new_null()", addrEmpty = ((struct stack_st_IPAddressFamily *)OPENSSL_sk_new_null()))
          && test_true("../test/v3ext.c", 443, "X509v3_addr_subset(NULL, NULL)", (X509v3_addr_subset(
# 443 "../test/v3ext.c" 3 4
            ((void *)0)
# 443 "../test/v3ext.c"
            , 
# 443 "../test/v3ext.c" 3 4
...
# 443 "../test/v3ext.c"
          ...
          && test_true("../test/v3ext.c", 444, "X509v3_addr_subset(NULL, addr[0])", (X509v3_addr_subset(
# 444 "../test/v3ext.c" 3 4
            ((void *)0)
# 444 "../test/v3ext.c"
            , addr[0])) != 0)
          && test_true("../test/v3ext.c", 445, "X509v3_addr_subset(addrEmpty, addr[0])", (X509v3_addr_subset(addrEmpty, addr[0])) != 0)
          && test_true("../test/v3ext.c", 446, "X509v3_addr_subset(addr[0], addr[0])", (X509v3_addr_subset(addr[0], addr[0])) != 0)
          && test_true("../test/v3ext.c", 447, "X509v3_addr_subset(addr[0], addr[1])", (X509v3_addr_subset(addr[0], addr[1])) != 0)
          && test_true("../test/v3ext.c", 448, "X509v3_addr_subset(addr[0], addr[2])", (X509v3_addr_subset(addr[0], addr[2])) != 0)
          && test_true("../test/v3ext.c", 449, "X509v3_addr_subset(addr[1], addr[2])", (X509v3_addr_subset(addr[1], addr[2])) != 0)
          && test_false("../test/v3ext.c", 450, "X509v3_addr_subset(addr[0], NULL)", (X509v3_addr_subset(addr[0], 
# 450 "../test/v3ext.c" 3 4
            ((void *)0)
# 450 "../test/v3ext.c"
            )) != 0)
          && test_false("../test/v3ext.c", 451, "X509v3_addr_subset(addr[1], addr[0])", (X509v3_addr_subset(addr[1], addr[0])) != 0)
          && test_false("../test/v3ext.c", 452, "X509v3_addr_subset(addr[2], addr[1])", (X509v3_addr_subset(addr[2], addr[1])) != 0)
          && test_false("../test/v3ext.c", 453, "X509v3_addr_subset(addr[0], addrEmpty)", (X509v3_addr_subset(addr[0], addrEmpty)) != 0);
end:
    OPENSSL_sk_pop_free(ossl_check_IPAddressFamily_sk_type(addrEmpty),ossl_check_IPAddressFamily_freefunc_type(IPAddressFamily_free));
    for (i = 0; i < sz; ++i) {
        OPENSSL_sk_pop_free(ossl_check_IPAddressFamily_sk_type(addr[i]),ossl_check_IPAddressFamily_freefunc_type(IPAddressFamily_free));
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/v3ext.c", 471, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/v3ext.c", 475, "infile = test_get_argument(0)", infile = test_get_argument(0)))
        return 0;
    ...
    add_test("test_addr_subset", test_addr_subset);
