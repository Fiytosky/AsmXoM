# 0 "../test/memleaktest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/memleaktest.c"
# 10 "../test/memleaktest.c"
...
# 15 "../test/memleaktest.c" 2
# 35 "../test/memleaktest.c"
int main(int argc, char *argv[])
{
# 45 "../test/memleaktest.c"
    int exitcode = 
# 45 "../test/memleaktest.c" 3 4
                  1
# 45 "../test/memleaktest.c"
                              ;
    ...
    lost = CRYPTO_malloc(3, "../test/memleaktest.c", 49);
    if (!test_ptr("../test/memleaktest.c", 50, "lost", lost))
        return 
# 51 "../test/memleaktest.c" 3 4
              1
# 51 "../test/memleaktest.c"
                          ;

    strcpy(lost, "ab");

    if (argv[1] && strcmp(argv[1], "freeit") == 0) {
        CRYPTO_free(lost, "../test/memleaktest.c", 56);
        exitcode = 
# 57 "../test/memleaktest.c" 3 4
                  0
# 57 "../test/memleaktest.c"
                              ;
    }

    lost = 
# 60 "../test/memleaktest.c" 3 4
          ((void *)0)
# 60 "../test/memleaktest.c"
              ;
    return exitcode;
}
