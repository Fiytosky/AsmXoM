# 0 "../test/pairwise_fail_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pairwise_fail_test.c"
# 10 "../test/pairwise_fail_test.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 11 "../test/pairwise_fail_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../test/pairwise_fail_test.c" 2
...
# 13 "../test/pairwise_fail_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 14 "../test/pairwise_fail_test.c" 2
...
# 29 "../test/pairwise_fail_test.c" 3 4
                             ((void *)0)
# 29 "../test/pairwise_fail_test.c"
                                 ;
static char *pairwise_name = 
# 30 "../test/pairwise_fail_test.c" 3 4
                            ((void *)0)
# 30 "../test/pairwise_fail_test.c"
                                ;
static char *dsaparam_file = 
# 31 "../test/pairwise_fail_test.c" 3 4
                            ((void *)0)
# 31 "../test/pairwise_fail_test.c"
                                ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 43 "../test/pairwise_fail_test.c" 3 4
         ((void *)0) 
# 43 "../test/pairwise_fail_test.c"
              }
    };
    return test_options;
}
...
static int self_test_on_pairwise_fail(const OSSL_PARAM params[], void *arg)
{
    ...
    const OSSL_PARAM *p = 
# 51 "../test/pairwise_fail_test.c" 3 4
                         ((void *)0)
# 51 "../test/pairwise_fail_test.c"
                             ;
    const char *type = 
# 52 "../test/pairwise_fail_test.c" 3 4
                      ((void *)0)
# 52 "../test/pairwise_fail_test.c"
                          , *phase = 
# 52 "../test/pairwise_fail_test.c" 3 4
                                     ((void *)0)
# 52 "../test/pairwise_fail_test.c"
    ...
    if (p == 
# 55 "../test/pairwise_fail_test.c" 3 4
            ((void *)0) 
# 55 "../test/pairwise_fail_test.c"
                 || p->data_type != 4)
        return 0;
    ...
    if (strcmp(phase, "Corrupt") == 0) {
        ...
        if (p == 
# 60 "../test/pairwise_fail_test.c" 3 4
                ((void *)0) 
# 60 "../test/pairwise_fail_test.c"
                     || p->data_type != 4)
            return 0;
...
static int setup_selftest_pairwise_failure(const char *type)
{
    int ret = 0;
    OSSL_PROVIDER *prov = 
# 72 "../test/pairwise_fail_test.c" 3 4
                         ((void *)0)
# 72 "../test/pairwise_fail_test.c"
                             ;

    if (!test_ptr("../test/pairwise_fail_test.c", 74, "prov = OSSL_PROVIDER_load(libctx, \"fips\")", prov = OSSL_PROVIDER_load(libctx, "fips")))
        goto err;
...
{
    BIO *bio = 
# 89 "../test/pairwise_fail_test.c" 3 4
              ((void *)0)
# 89 "../test/pairwise_fail_test.c"
                  ;
    EVP_PKEY_CTX *ctx = 
# 90 "../test/pairwise_fail_test.c" 3 4
                       ((void *)0)
# 90 "../test/pairwise_fail_test.c"
                           ;
    EVP_PKEY *pParams = 
# 91 "../test/pairwise_fail_test.c" 3 4
                       ((void *)0)
# 91 "../test/pairwise_fail_test.c"
                           ;
    EVP_PKEY *pkey = 
# 92 "../test/pairwise_fail_test.c" 3 4
                    ((void *)0)
# 92 "../test/pairwise_fail_test.c"
                        ;
    const char *type = "Conditional_PCT";
    int ret = 0;

    if (strcmp(pairwise_name, "rsa") == 0) {
        if (!test_true("../test/pairwise_fail_test.c", 97, "setup_selftest_pairwise_failure(type)", (setup_selftest_pairwise_failure(type)) != 0))
            goto err;
        if (!test_ptr_null("../test/pairwise_fail_test.c", 99, "pkey = EVP_PKEY_Q_keygen(libctx, NULL, \"RSA\", (size_t)2048)", pkey = EVP_PKEY_Q_keygen(libctx, 
# 99 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 99 "../test/pairwise_fail_test.c"
            , "RSA", (size_t)2048)))
            goto err;
    } else if (strncmp(pairwise_name, "ec", 2) == 0) {
        if (strcmp(pairwise_name, "eckat") == 0)
            type = "Conditional_KAT";
        if (!test_true("../test/pairwise_fail_test.c", 104, "setup_selftest_pairwise_failure(type)", (setup_selftest_pairwise_failure(type)) != 0))
            goto err;
        if (!test_ptr_null("../test/pairwise_fail_test.c", 106, "pkey = EVP_PKEY_Q_keygen(libctx, NULL, \"EC\", \"P-256\")", pkey = EVP_PKEY_Q_keygen(libctx, 
# 106 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 106 "../test/pairwise_fail_test.c"
            , "EC", "P-256")))
            goto err;
    } else if (strncmp(pairwise_name, "dsa", 3) == 0) {
        if (strcmp(pairwise_name, "dsakat") == 0)
            type = "Conditional_KAT";
        if (!test_true("../test/pairwise_fail_test.c", 111, "setup_selftest_pairwise_failure(type)", (setup_selftest_pairwise_failure(type)) != 0))
            goto err;
        if (!test_ptr("../test/pairwise_fail_test.c", 113, "bio = BIO_new_file(dsaparam_file, \"r\")", bio = BIO_new_file(dsaparam_file, "r")))
            goto err;
        if (!test_ptr("../test/pairwise_fail_test.c", 115, "pParams = PEM_read_bio_Parameters_ex(bio, NULL, libctx, NULL)", pParams = PEM_read_bio_Parameters_ex(bio, 
# 115 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 115 "../test/pairwise_fail_test.c"
            , libctx, 
# 115 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 115 "../test/pairwise_fail_test.c"
            ...
            goto err;
        if (!test_ptr("../test/pairwise_fail_test.c", 117, "ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pParams, NULL)", ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pParams, 
# 117 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 117 "../test/pairwise_fail_test.c"
            )))
            goto err;
        if (!test_int_eq("../test/pairwise_fail_test.c", 119, "EVP_PKEY_keygen_init(ctx)", "1", EVP_PKEY_keygen_init(ctx), 1))
            goto err;
        if (!test_int_le("../test/pairwise_fail_test.c", 121, "EVP_PKEY_keygen(ctx, &pkey)", "0", EVP_PKEY_keygen(ctx, &pkey), 0))
            goto err;
        if (!test_ptr_null("../test/pairwise_fail_test.c", 123, "pkey", pkey))
            goto err;
    } else if (strncmp(pairwise_name, "eddsa", 5) == 0) {
        if (!test_true("../test/pairwise_fail_test.c", 126, "setup_selftest_pairwise_failure(type)", (setup_selftest_pairwise_failure(type)) != 0))
            goto err;
        if (!test_ptr("../test/pairwise_fail_test.c", 128, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"ED25519\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(libctx, "ED25519", 
# 128 "../test/pairwise_fail_test.c" 3 4
            ((void *)0)
# 128 "../test/pairwise_fail_test.c"
            )))
            goto err;
        if (!test_int_eq("../test/pairwise_fail_test.c", 130, "EVP_PKEY_keygen_init(ctx)", "1", EVP_PKEY_keygen_init(ctx), 1))
            goto err;
        if (!test_int_le("../test/pairwise_fail_test.c", 132, "EVP_PKEY_keygen(ctx, &pkey)", "0", EVP_PKEY_keygen(ctx, &pkey), 0))
            goto err;
        if (!test_ptr_null("../test/pairwise_fail_test.c", 134, "pkey", pkey))
            goto err;
    }
    ret = 1;
err:
...
int setup_tests(void)
{
    OPTION_CHOICE o;
    char *config_file = 
# 149 "../test/pairwise_fail_test.c" 3 4
                       ((void *)0)
# 149 "../test/pairwise_fail_test.c"
                           ;
    ...
    if (libctx == 
# 171 "../test/pairwise_fail_test.c" 3 4
                 ((void *)0)
# 171 "../test/pairwise_fail_test.c"
                     )
        return 0;
