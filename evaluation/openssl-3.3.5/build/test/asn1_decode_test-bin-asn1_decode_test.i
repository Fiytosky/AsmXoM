# 0 "../test/asn1_decode_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_decode_test.c"
# 10 "../test/asn1_decode_test.c"
...
static const ASN1_TEMPLATE ASN1_LONG_DATA_seq_tt[] = {
    { ((0x1 << 12)), (0), 
# 41 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 41 "../test/asn1_decode_test.c"
   ASN1_LONG_DATA
# 41 "../test/asn1_decode_test.c" 3 4
   , 
# 41 "../test/asn1_decode_test.c"
...
# 42 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 42 "../test/asn1_decode_test.c"
...
static int test_long(void)
{
    ...
    ASN1_LONG_DATA *dectst =
        d2i_ASN1_LONG_DATA(
# 51 "../test/asn1_decode_test.c" 3 4
                          ((void *)0)
# 51 "../test/asn1_decode_test.c"
                              , &p, sizeof(t_invalid_zero));

    if (dectst == 
# 53 "../test/asn1_decode_test.c" 3 4
                 ((void *)0)
# 53 "../test/asn1_decode_test.c"
                     )
        return 0;
...
static const ASN1_TEMPLATE ASN1_INT32_DATA_seq_tt[] = {
    { ((0x1 << 12)), (0), 
# 68 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 68 "../test/asn1_decode_test.c"
   ASN1_INT32_DATA
# 68 "../test/asn1_decode_test.c" 3 4
   , 
# 68 "../test/asn1_decode_test.c"
...
# 69 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 69 "../test/asn1_decode_test.c"
...
static int test_int32(void)
{
    ...
    ASN1_INT32_DATA *dectst =
        d2i_ASN1_INT32_DATA(
# 78 "../test/asn1_decode_test.c" 3 4
                           ((void *)0)
# 78 "../test/asn1_decode_test.c"
                               , &p, sizeof(t_invalid_zero));

    if (dectst == 
# 80 "../test/asn1_decode_test.c" 3 4
                 ((void *)0)
# 80 "../test/asn1_decode_test.c"
                     )
        return 0;
...
static const ASN1_TEMPLATE ASN1_UINT32_DATA_seq_tt[] = {
    { ((0x1 << 12)), (0), 
# 94 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 94 "../test/asn1_decode_test.c"
   ASN1_UINT32_DATA
# 94 "../test/asn1_decode_test.c" 3 4
   , 
# 94 "../test/asn1_decode_test.c"
...
# 95 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 95 "../test/asn1_decode_test.c"
...
# 104 "../test/asn1_decode_test.c" 3 4
                            ((void *)0)
# 104 "../test/asn1_decode_test.c"
                                , &p, sizeof(t_invalid_zero));

    if (dectst == 
# 106 "../test/asn1_decode_test.c" 3 4
                 ((void *)0)
# 106 "../test/asn1_decode_test.c"
                     )
        return 0;
...
static const ASN1_TEMPLATE ASN1_INT64_DATA_seq_tt[] = {
    { ((0x1 << 12)), (0), 
# 120 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 120 "../test/asn1_decode_test.c"
   ASN1_INT64_DATA
# 120 "../test/asn1_decode_test.c" 3 4
   , 
# 120 "../test/asn1_decode_test.c"
...
# 121 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 121 "../test/asn1_decode_test.c"
...
static int test_int64(void)
{
    ...
    ASN1_INT64_DATA *dectst =
        d2i_ASN1_INT64_DATA(
# 130 "../test/asn1_decode_test.c" 3 4
                           ((void *)0)
# 130 "../test/asn1_decode_test.c"
                               , &p, sizeof(t_invalid_zero));

    if (dectst == 
# 132 "../test/asn1_decode_test.c" 3 4
                 ((void *)0)
# 132 "../test/asn1_decode_test.c"
                     )
        return 0;
...
static const ASN1_TEMPLATE ASN1_UINT64_DATA_seq_tt[] = {
    { ((0x1 << 12)), (0), 
# 146 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 146 "../test/asn1_decode_test.c"
   ASN1_UINT64_DATA
# 146 "../test/asn1_decode_test.c" 3 4
   , 
# 146 "../test/asn1_decode_test.c"
...
# 147 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 147 "../test/asn1_decode_test.c"
...
# 156 "../test/asn1_decode_test.c" 3 4
                            ((void *)0)
# 156 "../test/asn1_decode_test.c"
                                , &p, sizeof(t_invalid_zero));

    if (dectst == 
# 158 "../test/asn1_decode_test.c" 3 4
                 ((void *)0)
# 158 "../test/asn1_decode_test.c"
                     )
        return 0;
...
static int test_gentime(void)
{
    ...
    p = der;
    der_len = sizeof(der);
    gentime = d2i_ASN1_GENERALIZEDTIME(
# 180 "../test/asn1_decode_test.c" 3 4
                                      ((void *)0)
# 180 "../test/asn1_decode_test.c"
                                          , &p, der_len);

    if (!test_ptr_null("../test/asn1_decode_test.c", 182, "gentime", gentime))
        rc = 0;
...
static int test_utctime(void)
{
    ...
    p = der;
    der_len = sizeof(der);
    utctime = d2i_ASN1_UTCTIME(
# 204 "../test/asn1_decode_test.c" 3 4
                              ((void *)0)
# 204 "../test/asn1_decode_test.c"
                                  , &p, der_len);

    if (!test_ptr_null("../test/asn1_decode_test.c", 206, "utctime", utctime))
        rc = 0;
...
static const ASN1_TEMPLATE INVALIDTEMPLATE_seq_tt[] = {
    ...
    { (((0x1 << 3)|(0x2<<6)) | (0)), (12), 
# 224 "../test/asn1_decode_test.c" 3 4
   __builtin_offsetof (
# 224 "../test/asn1_decode_test.c"
   INVALIDTEMPLATE
# 224 "../test/asn1_decode_test.c" 3 4
   , 
# 224 "../test/asn1_decode_test.c"
...
# 225 "../test/asn1_decode_test.c" 3 4
 ((void *)0)
# 225 "../test/asn1_decode_test.c"
...
# 239 "../test/asn1_decode_test.c" 3 4
                                              ((void *)0)
# 239 "../test/asn1_decode_test.c"
                                                  , &p,
                                               sizeof(t_invalid_template));


    if (test_ptr_null("../test/asn1_decode_test.c", 243, "tmp", tmp))
        return 1;
...
static int test_reuse_asn1_object(void)
{
    ...
    if (!test_ptr("../test/asn1_decode_test.c", 262, "obj = ASN1_OBJECT_create(NID_undef, cn_der, sizeof(cn_der), \"C\", \"countryName\")", obj = ASN1_OBJECT_create(0, cn_der, sizeof(cn_der), "C", "countryName"))
                                                               )
        goto err;

    if (!test_ptr("../test/asn1_decode_test.c", 266, "d2i_ASN1_OBJECT(&obj, &p, sizeof(oid_der))", d2i_ASN1_OBJECT(&obj, &p, sizeof(oid_der))))
        goto err;
    ret = 1;
err:
...
int setup_tests(void)
{
    ...
    add_test("test_reuse_asn1_object", test_reuse_asn1_object);
    return 1;
}
