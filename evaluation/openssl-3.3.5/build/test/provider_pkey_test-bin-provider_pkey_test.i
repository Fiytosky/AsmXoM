# 0 "../test/provider_pkey_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_pkey_test.c"
# 10 "../test/provider_pkey_test.c"
...
# 11 "../test/provider_pkey_test.c" 2
...
# 12 "../test/provider_pkey_test.c" 2
...
# 13 "../test/provider_pkey_test.c" 2
...
# 14 "../test/provider_pkey_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../test/provider_pkey_test.c" 2
...
# 16 "../test/provider_pkey_test.c" 2
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 17 "../test/provider_pkey_test.c" 2
...
# 18 "../test/provider_pkey_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 19 "../test/provider_pkey_test.c" 2
...
# 20 "../test/provider_pkey_test.c" 2

static OSSL_LIB_CTX *libctx = 
# 21 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 21 "../test/provider_pkey_test.c"
                                 ;
extern int key_deleted;
                     ...
                     OSSL_PROVIDER *expected_prov)
{
    ...
    if (!test_ptr("../test/provider_pkey_test.c", 32, "sig", sig))
        return 0;

    if (!test_ptr("../test/provider_pkey_test.c", 35, "prov = EVP_SIGNATURE_get0_provider(sig)", prov = EVP_SIGNATURE_get0_provider(sig)))
        goto end;

    if (!test_ptr_eq("../test/provider_pkey_test.c", 38, "prov", "expected_prov", prov, expected_prov)) {
        test_info("../test/provider_pkey_test.c", 39, "Fetched provider: %s, Expected provider: %s", OSSL_PROVIDER_get0_name(prov), OSSL_PROVIDER_get0_name(expected_prov))
...
{
    OSSL_PROVIDER *deflt = 
# 54 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 54 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 55 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 55 "../test/provider_pkey_test.c"
                                 ;
    int i, ret = 0;
    EVP_PKEY *pkey = 
# 57 "../test/provider_pkey_test.c" 3 4
                    ((void *)0)
# 57 "../test/provider_pkey_test.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 58 "../test/provider_pkey_test.c" 3 4
                       ((void *)0)
# 58 "../test/provider_pkey_test.c"
                           ;

    if (!test_ptr("../test/provider_pkey_test.c", 60, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        return 0;

    if (!test_ptr("../test/provider_pkey_test.c", 63, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;


    if (!test_true("../test/provider_pkey_test.c", 67, "fetch_sig(libctx, \"RSA\", \"provider=fake-rsa\", fake_rsa)", (fetch_sig(libctx, "RSA", "provider=fake-rsa", fake_rsa)) != 0)
        || !test_true("../test/provider_pkey_test.c", 68, "fetch_sig(libctx, \"RSA\", \"?provider=fake-rsa\", fake_rsa)", (fetch_sig(libctx, "RSA", "?provider=fake-rsa", fake_rsa)) != 0))
        goto end;


    if (!test_ptr("../test/provider_pkey_test.c", 72, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"provider=fake-rsa\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "provider=fake-rsa"))

        || !test_true("../test/provider_pkey_test.c", 74, "EVP_PKEY_fromdata_init(ctx)", (EVP_PKEY_fromdata_init(ctx)) != 0)
        || !test_true("../test/provider_pkey_test.c", 75, "EVP_PKEY_fromdata(ctx, &pkey, EVP_PKEY_KEYPAIR, NULL)", (EVP_PKEY_fromdata(ctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), 
# 75 "../test/provider_pkey_test.c" 3 4
           ((void *)0)
# 75 "../test/provider_pkey_test.c"
           )) != 0)
        || !test_ptr("../test/provider_pkey_test.c", 76, "pkey", pkey))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 80 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 80 "../test/provider_pkey_test.c"
             ;
    ...
    for (i = 0; i < 3; i++) {
        ...
        if (!test_ptr("../test/provider_pkey_test.c", 91, "ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey, \"?provider=default\")", ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey, "?provider=default"))
                                                                            )
            goto end;
        ...
        if (!test_int_eq("../test/provider_pkey_test.c", 100, "EVP_PKEY_sign_init(ctx)", "1", EVP_PKEY_sign_init(ctx), 1))
            goto end;

        if (!test_int_eq("../test/provider_pkey_test.c", 103, "EVP_PKEY_sign(ctx, NULL, &siglen, NULL, 0)", "1", EVP_PKEY_sign(ctx, 
# 103 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 103 "../test/provider_pkey_test.c"
            , &siglen, 
# 103 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 103 "../test/provider_pkey_test.c"
            , 0), 1)
            || !test_size_t_eq("../test/provider_pkey_test.c", 104, "siglen", "256", siglen, 256))
            goto end;

        EVP_PKEY_CTX_free(ctx);
        ctx = 
# 108 "../test/provider_pkey_test.c" 3 4
             ((void *)0)
# 108 "../test/provider_pkey_test.c"
                 ;
    }
...
{
    EVP_PKEY_CTX *ctx = 
# 123 "../test/provider_pkey_test.c" 3 4
                       ((void *)0)
# 123 "../test/provider_pkey_test.c"
                           ;
    OSSL_PROVIDER *deflt = 
# 124 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 124 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 125 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 125 "../test/provider_pkey_test.c"
                                 ;
    const OSSL_PROVIDER *provider;
    const char *provname;
    int ret = 0;

    if (!test_ptr("../test/provider_pkey_test.c", 130, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;


    if (!test_ptr("../test/provider_pkey_test.c", 134, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", 
# 134 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 134 "../test/provider_pkey_test.c"
        )))
        goto end;

    if (!test_int_gt("../test/provider_pkey_test.c", 137, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 140, "provider = EVP_PKEY_CTX_get0_provider(ctx)", provider = EVP_PKEY_CTX_get0_provider(ctx)))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 143, "provname = OSSL_PROVIDER_get0_name(provider)", provname = OSSL_PROVIDER_get0_name(provider)))
        goto end;

    if (!test_str_eq("../test/provider_pkey_test.c", 146, "provname", "\"default\"", provname, "default"))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 150 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 150 "../test/provider_pkey_test.c"
             ;


    if (!test_ptr("../test/provider_pkey_test.c", 153, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        return 0;

    if (!test_ptr("../test/provider_pkey_test.c", 156, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"?provider=fake-rsa\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "?provider=fake-rsa"))
                                                                         )
        goto end;

    if (!test_int_gt("../test/provider_pkey_test.c", 160, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 163, "provider = EVP_PKEY_CTX_get0_provider(ctx)", provider = EVP_PKEY_CTX_get0_provider(ctx)))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 166, "provname = OSSL_PROVIDER_get0_name(provider)", provname = OSSL_PROVIDER_get0_name(provider)))
        goto end;

    if (!test_str_eq("../test/provider_pkey_test.c", 169, "provname", "\"fake-rsa\"", provname, "fake-rsa"))
        goto end;
...
{
    OSSL_PROVIDER *deflt = 
# 183 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 183 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 184 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 184 "../test/provider_pkey_test.c"
                                 ;
    EVP_PKEY *pkey_fake = 
# 185 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 185 "../test/provider_pkey_test.c"
                             ;
    EVP_PKEY *pkey_dflt = 
# 186 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 186 "../test/provider_pkey_test.c"
                             ;
    EVP_PKEY_CTX *ctx = 
# 187 "../test/provider_pkey_test.c" 3 4
                       ((void *)0)
# 187 "../test/provider_pkey_test.c"
                           ;
    OSSL_PARAM *params = 
# 188 "../test/provider_pkey_test.c" 3 4
                        ((void *)0)
# 188 "../test/provider_pkey_test.c"
                            ;
    int ret = 0;

    if (!test_ptr("../test/provider_pkey_test.c", 191, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        return 0;

    if (!test_ptr("../test/provider_pkey_test.c", 194, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;


    if (!test_ptr("../test/provider_pkey_test.c", 198, "params = fake_rsa_key_params(0)", params = fake_rsa_key_params(0))
        || !test_ptr("../test/provider_pkey_test.c", 199, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"provider=fake-rsa\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "provider=fake-rsa"))

        || !test_true("../test/provider_pkey_test.c", 201, "EVP_PKEY_fromdata_init(ctx)", (EVP_PKEY_fromdata_init(ctx)) != 0)
        || !test_true("../test/provider_pkey_test.c", 202, "EVP_PKEY_fromdata(ctx, &pkey_fake, EVP_PKEY_PUBLIC_KEY, params)", (EVP_PKEY_fromdata(ctx, &pkey_fake, ( ( ( 0x04 | 0x80) ) | 0x02 ), params)) != 0)

        || !test_ptr("../test/provider_pkey_test.c", 204, "pkey_fake", pkey_fake))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 208 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 208 "../test/provider_pkey_test.c"
             ;
    OSSL_PARAM_free(params);
    params = 
# 210 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 210 "../test/provider_pkey_test.c"
                ;


    if (!test_ptr("../test/provider_pkey_test.c", 213, "params = fake_rsa_key_params(0)", params = fake_rsa_key_params(0))
        || !test_ptr("../test/provider_pkey_test.c", 214, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"provider=default\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "provider=default"))

        || !test_true("../test/provider_pkey_test.c", 216, "EVP_PKEY_fromdata_init(ctx)", (EVP_PKEY_fromdata_init(ctx)) != 0)
        || !test_true("../test/provider_pkey_test.c", 217, "EVP_PKEY_fromdata(ctx, &pkey_dflt, EVP_PKEY_PUBLIC_KEY, params)", (EVP_PKEY_fromdata(ctx, &pkey_dflt, ( ( ( 0x04 | 0x80) ) | 0x02 ), params)) != 0)

        || !test_ptr("../test/provider_pkey_test.c", 219, "pkey_dflt", pkey_dflt))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 223 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 223 "../test/provider_pkey_test.c"
             ;
    OSSL_PARAM_free(params);
    params = 
# 225 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 225 "../test/provider_pkey_test.c"
                ;


    if (!test_int_eq("../test/provider_pkey_test.c", 228, "EVP_PKEY_eq(pkey_fake, pkey_dflt)", "1", EVP_PKEY_eq(pkey_fake, pkey_dflt), 1))
        goto end;
...
{
    OSSL_PROVIDER *fake_rsa = 
# 244 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 244 "../test/provider_pkey_test.c"
                                 ;
    EVP_PKEY *pkey_fake = 
# 245 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 245 "../test/provider_pkey_test.c"
                             ;
    EVP_PKEY_CTX *ctx = 
# 246 "../test/provider_pkey_test.c" 3 4
                       ((void *)0)
# 246 "../test/provider_pkey_test.c"
                           ;
    OSSL_PARAM *params = 
# 247 "../test/provider_pkey_test.c" 3 4
                        ((void *)0)
# 247 "../test/provider_pkey_test.c"
                            ;
    int ret = 0;

    if (!test_ptr("../test/provider_pkey_test.c", 250, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        return 0;
    ...
    if (!test_int_eq("../test/provider_pkey_test.c", 257, "fake_rsa_query_operation_name", "0", fake_rsa_query_operation_name, 0))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 260, "params = fake_rsa_key_params(0)", params = fake_rsa_key_params(0))
        || !test_ptr("../test/provider_pkey_test.c", 261, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"provider=fake-rsa\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "provider=fake-rsa"))

        || !test_true("../test/provider_pkey_test.c", 263, "EVP_PKEY_fromdata_init(ctx)", (EVP_PKEY_fromdata_init(ctx)) != 0)
        || !test_true("../test/provider_pkey_test.c", 264, "EVP_PKEY_fromdata(ctx, &pkey_fake, EVP_PKEY_PUBLIC_KEY, params)", (EVP_PKEY_fromdata(ctx, &pkey_fake, ( ( ( 0x04 | 0x80) ) | 0x02 ), params)) != 0)

        || !test_true("../test/provider_pkey_test.c", 266, "EVP_PKEY_can_sign(pkey_fake)", (EVP_PKEY_can_sign(pkey_fake)) != 0)
        || !test_ptr("../test/provider_pkey_test.c", 267, "pkey_fake", pkey_fake))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 271 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 271 "../test/provider_pkey_test.c"
             ;
    EVP_PKEY_free(pkey_fake);
    pkey_fake = 
# 273 "../test/provider_pkey_test.c" 3 4
               ((void *)0)
# 273 "../test/provider_pkey_test.c"
                   ;
    OSSL_PARAM_free(params);
    params = 
# 275 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 275 "../test/provider_pkey_test.c"
                ;
    ...
    if (!test_ptr("../test/provider_pkey_test.c", 284, "params = fake_rsa_key_params(0)", params = fake_rsa_key_params(0))
        || !test_ptr("../test/provider_pkey_test.c", 285, "ctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", \"provider=fake-rsa\")", ctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", "provider=fake-rsa"))

        || !test_true("../test/provider_pkey_test.c", 287, "EVP_PKEY_fromdata_init(ctx)", (EVP_PKEY_fromdata_init(ctx)) != 0)
        || !test_true("../test/provider_pkey_test.c", 288, "EVP_PKEY_fromdata(ctx, &pkey_fake, EVP_PKEY_PUBLIC_KEY, params)", (EVP_PKEY_fromdata(ctx, &pkey_fake, ( ( ( 0x04 | 0x80) ) | 0x02 ), params)) != 0)

        || !test_true("../test/provider_pkey_test.c", 290, "EVP_PKEY_can_sign(pkey_fake)", (EVP_PKEY_can_sign(pkey_fake)) != 0)
        || !test_ptr("../test/provider_pkey_test.c", 291, "pkey_fake", pkey_fake))
        goto end;

    EVP_PKEY_CTX_free(ctx);
    ctx = 
# 295 "../test/provider_pkey_test.c" 3 4
         ((void *)0)
# 295 "../test/provider_pkey_test.c"
             ;
    EVP_PKEY_free(pkey_fake);
    pkey_fake = 
# 297 "../test/provider_pkey_test.c" 3 4
               ((void *)0)
# 297 "../test/provider_pkey_test.c"
                   ;
    OSSL_PARAM_free(params);
    params = 
# 299 "../test/provider_pkey_test.c" 3 4
            ((void *)0)
# 299 "../test/provider_pkey_test.c"
                ;
...
{
    OSSL_PROVIDER *deflt = 
# 315 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 315 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 316 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 316 "../test/provider_pkey_test.c"
                                 ;
    int ret = 0;
    EVP_PKEY *pkey = 
# 318 "../test/provider_pkey_test.c" 3 4
                    ((void *)0)
# 318 "../test/provider_pkey_test.c"
                        ;
    OSSL_STORE_LOADER *loader = 
# 319 "../test/provider_pkey_test.c" 3 4
                               ((void *)0)
# 319 "../test/provider_pkey_test.c"
                                   ;
    OSSL_STORE_CTX *ctx = 
# 320 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 320 "../test/provider_pkey_test.c"
                             ;
    ...
    if (!test_ptr("../test/provider_pkey_test.c", 326, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 329, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 332, "loader = OSSL_STORE_LOADER_fetch(libctx, \"fake_rsa\", propq)", loader = OSSL_STORE_LOADER_fetch(libctx, "fake_rsa", propq))
                                                          )
        goto end;

    OSSL_STORE_LOADER_free(loader);

    if (!test_ptr("../test/provider_pkey_test.c", 338, "ctx = OSSL_STORE_open_ex(\"fake_rsa:test\", libctx, propq, NULL, NULL, NULL, NULL, NULL)", ctx = OSSL_STORE_open_ex("fake_rsa:test", libctx, propq, 
# 338 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 338 "../test/provider_pkey_test.c"
        , 
# 338 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 338 "../test/provider_pkey_test.c"
...
# 343 "../test/provider_pkey_test.c" 3 4
                                              ((void *)0)
           
# 344 "../test/provider_pkey_test.c"
          && pkey == 
# 344 "../test/provider_pkey_test.c" 3 4
                     ((void *)0)
# 344 "../test/provider_pkey_test.c"
                         ) {
        if (OSSL_STORE_INFO_get_type(info) == 4)
            pkey = OSSL_STORE_INFO_get1_PKEY(info);
        OSSL_STORE_INFO_free(info);
        info = 
# 348 "../test/provider_pkey_test.c" 3 4
              ((void *)0)
# 348 "../test/provider_pkey_test.c"
                  ;
    }

    if (!test_ptr("../test/provider_pkey_test.c", 351, "pkey", pkey) || !test_int_eq("../test/provider_pkey_test.c", 351, "EVP_PKEY_is_a(pkey, \"RSA\")", "1", EVP_PKEY_is_a(pkey, "RSA"), 1))
        goto end;
...
{
    OSSL_PROVIDER *deflt = 
# 366 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 366 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 367 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 367 "../test/provider_pkey_test.c"
                                 ;
    int ret = 0;
    EVP_PKEY *pkey = 
# 369 "../test/provider_pkey_test.c" 3 4
                    ((void *)0)
# 369 "../test/provider_pkey_test.c"
                        ;
    OSSL_STORE_LOADER *loader = 
# 370 "../test/provider_pkey_test.c" 3 4
                               ((void *)0)
# 370 "../test/provider_pkey_test.c"
                                   ;
    OSSL_STORE_CTX *ctx = 
# 371 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 371 "../test/provider_pkey_test.c"
                             ;
    OSSL_STORE_INFO *info;
    const char *propq = "?provider=fake-rsa";


    if (!test_ptr("../test/provider_pkey_test.c", 376, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 379, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 382, "loader = OSSL_STORE_LOADER_fetch(libctx, \"fake_rsa\", propq)", loader = OSSL_STORE_LOADER_fetch(libctx, "fake_rsa", propq))
                                                          )
        goto end;
    ...
    if (!test_ptr("../test/provider_pkey_test.c", 389, "ctx = OSSL_STORE_open_ex(\"fake_rsa:test\", libctx, propq, NULL, NULL, NULL, NULL, NULL)", ctx = OSSL_STORE_open_ex("fake_rsa:test", libctx, propq, 
# 389 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 389 "../test/provider_pkey_test.c"
        , 
# 389 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 389 "../test/provider_pkey_test.c"
...
# 389 "../test/provider_pkey_test.c"
    ...
    while (!OSSL_STORE_eof(ctx)
           && (info = OSSL_STORE_load(ctx)) != 
# 394 "../test/provider_pkey_test.c" 3 4
                                              ((void *)0)
           
# 395 "../test/provider_pkey_test.c"
          && pkey == 
# 395 "../test/provider_pkey_test.c" 3 4
                     ((void *)0)
# 395 "../test/provider_pkey_test.c"
                         ) {
        if (OSSL_STORE_INFO_get_type(info) == 4)
        ...
        OSSL_STORE_INFO_free(info);
        info = 
# 399 "../test/provider_pkey_test.c" 3 4
              ((void *)0)
# 399 "../test/provider_pkey_test.c"
                  ;
    }

    if (!test_ptr("../test/provider_pkey_test.c", 402, "pkey", pkey) || !test_int_eq("../test/provider_pkey_test.c", 402, "EVP_PKEY_is_a(pkey, \"RSA\")", "1", EVP_PKEY_is_a(pkey, "RSA"), 1))
        goto end;
    EVP_PKEY_free(pkey);
    pkey = 
# 405 "../test/provider_pkey_test.c" 3 4
          ((void *)0)
# 405 "../test/provider_pkey_test.c"
              ;

    if (!test_int_eq("../test/provider_pkey_test.c", 407, "OSSL_STORE_delete(\"fake_rsa:test\", libctx, propq, NULL, NULL, NULL)", "1", OSSL_STORE_delete("fake_rsa:test", libctx, propq, 
# 407 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 407 "../test/provider_pkey_test.c"
        , 
# 407 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 407 "../test/provider_pkey_test.c"
...
# 407 "../test/provider_pkey_test.c"
        ...
        goto end;
    if (!test_int_eq("../test/provider_pkey_test.c", 410, "OSSL_STORE_close(ctx)", "1", OSSL_STORE_close(ctx), 1))
        goto end;


    if (!test_ptr("../test/provider_pkey_test.c", 414, "ctx = OSSL_STORE_open_ex(\"fake_rsa:test\", libctx, propq, NULL, NULL, NULL, NULL, NULL)", ctx = OSSL_STORE_open_ex("fake_rsa:test", libctx, propq, 
# 414 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 414 "../test/provider_pkey_test.c"
        , 
# 414 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 414 "../test/provider_pkey_test.c"
...
# 414 "../test/provider_pkey_test.c"
    ...
    while (!OSSL_STORE_eof(ctx)) {
           info = OSSL_STORE_load(ctx);
    if (!test_ptr_null("../test/provider_pkey_test.c", 420, "info", info))
               goto end;
    }
...
{
    const char *passphrase = "Passphrase Testing";
...
{
    OSSL_PROVIDER *deflt = 
# 448 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 448 "../test/provider_pkey_test.c"
                              ;
    OSSL_PROVIDER *fake_rsa = 
# 449 "../test/provider_pkey_test.c" 3 4
                             ((void *)0)
# 449 "../test/provider_pkey_test.c"
                                 ;
    int ret = 0;
    EVP_PKEY *pkey = 
# 451 "../test/provider_pkey_test.c" 3 4
                    ((void *)0)
# 451 "../test/provider_pkey_test.c"
                        ;
    OSSL_STORE_LOADER *loader = 
# 452 "../test/provider_pkey_test.c" 3 4
                               ((void *)0)
# 452 "../test/provider_pkey_test.c"
                                   ;
    OSSL_STORE_CTX *ctx = 
# 453 "../test/provider_pkey_test.c" 3 4
                         ((void *)0)
# 453 "../test/provider_pkey_test.c"
                             ;
    const char *propq = "?provider=fake-rsa";
    UI_METHOD *ui_method = 
# 455 "../test/provider_pkey_test.c" 3 4
                          ((void *)0)
# 455 "../test/provider_pkey_test.c"
                              ;


    if (!test_ptr("../test/provider_pkey_test.c", 458, "deflt = OSSL_PROVIDER_load(libctx, \"default\")", deflt = OSSL_PROVIDER_load(libctx, "default")))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 461, "fake_rsa = fake_rsa_start(libctx)", fake_rsa = fake_rsa_start(libctx)))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 464, "loader = OSSL_STORE_LOADER_fetch(libctx, \"fake_rsa\", propq)", loader = OSSL_STORE_LOADER_fetch(libctx, "fake_rsa", propq))
                                                          )
        goto end;

    OSSL_STORE_LOADER_free(loader);

    if (!test_ptr("../test/provider_pkey_test.c", 470, "ui_method= UI_create_method(\"PW Callbacks\")", ui_method= UI_create_method("PW Callbacks")))
        goto end;

    if (UI_method_set_reader(ui_method, fake_pw_read_string))
        goto end;

    if (!test_ptr("../test/provider_pkey_test.c", 476, "ctx = OSSL_STORE_open_ex(\"fake_rsa:openpwtest\", libctx, propq, ui_method, NULL, NULL, NULL, NULL)", ctx = OSSL_STORE_open_ex("fake_rsa:openpwtest", libctx, propq, ui_method, 
# 476 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 476 "../test/provider_pkey_test.c"
        , 
# 476 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 476 "../test/provider_pkey_test.c"
...
# 476 "../test/provider_pkey_test.c"
    ...
    OSSL_STORE_close(ctx);
    if (!test_ptr_null("../test/provider_pkey_test.c", 482, "ctx = OSSL_STORE_open_ex(\"fake_rsa:openpwtest\", libctx, propq, NULL, NULL, NULL, NULL, NULL)", ctx = OSSL_STORE_open_ex("fake_rsa:openpwtest", libctx, propq, 
# 482 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 482 "../test/provider_pkey_test.c"
        , 
# 482 "../test/provider_pkey_test.c" 3 4
        ((void *)0)
# 482 "../test/provider_pkey_test.c"
...
int setup_tests(void)
{
    ...
    if (libctx == 
# 501 "../test/provider_pkey_test.c" 3 4
                 ((void *)0)
# 501 "../test/provider_pkey_test.c"
                     )
        return 0;
    ...
    add_test("test_pkey_can_sign", test_pkey_can_sign);
    add_all_tests("test_pkey_store", test_pkey_store, 2, 1);
    add_test("test_pkey_delete", test_pkey_delete);
    add_test("test_pkey_store_open_ex", test_pkey_store_open_ex);
