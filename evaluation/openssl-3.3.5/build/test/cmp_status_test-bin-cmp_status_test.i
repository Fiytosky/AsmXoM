# 0 "../test/cmp_status_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_status_test.c"
# 12 "../test/cmp_status_test.c"
...
static CMP_STATUS_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_status_test.c", 26, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_status_test.c", 26)))
        return 
# 27 "../test/cmp_status_test.c" 3 4
              ((void *)0)
# 27 "../test/cmp_status_test.c"
                  ;
...
{
    CRYPTO_free(fixture, "../test/cmp_status_test.c", 34);
}
...
{
    OSSL_CMP_PKISI *si = 
# 42 "../test/cmp_status_test.c" 3 4
                        ((void *)0)
# 42 "../test/cmp_status_test.c"
                            ;
    int status;
    ASN1_UTF8STRING *statusString = 
# 44 "../test/cmp_status_test.c" 3 4
                                   ((void *)0)
# 44 "../test/cmp_status_test.c"
                                       ;
    int res = 0, i;

    if (!test_ptr("../test/cmp_status_test.c", 47, "si = OSSL_CMP_STATUSINFO_new(fixture->pkistatus, fixture->pkifailure, fixture->text)", si = OSSL_CMP_STATUSINFO_new(fixture->pkistatus, fixture->pkifailure, fixture->text))

                                                              )
        goto end;

    status = ossl_cmp_pkisi_get_status(si);
    if (!test_int_eq("../test/cmp_status_test.c", 53, "fixture->pkistatus", "status", fixture->pkistatus, status)
            || !test_str_eq("../test/cmp_status_test.c", 54, "fixture->str", "ossl_cmp_PKIStatus_to_string(status)", fixture->str, ossl_cmp_PKIStatus_to_string(status)))
        goto end;

    if (!test_ptr("../test/cmp_status_test.c", 57, "statusString = sk_ASN1_UTF8STRING_value(ossl_cmp_pkisi_get0_statusString(si), 0)", statusString = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(ossl_cmp_pkisi_get0_statusString(si)), (0))))


            || !test_mem_eq("../test/cmp_status_test.c", 60, "fixture->text", "(char *)statusString->data", fixture->text, strlen(fixture->text), (char *)statusString->data, statusString->length)
                                                                             )
        goto end;

    if (!test_int_eq("../test/cmp_status_test.c", 64, "fixture->pkifailure", "ossl_cmp_pkisi_get_pkifailureinfo(si)", fixture->pkifailure, ossl_cmp_pkisi_get_pkifailureinfo(si))
                                                           )
        goto end;
    for (i = 0; i <= 26; i++)
        if (!test_int_eq("../test/cmp_status_test.c", 68, "(fixture->pkifailure >> i) & 1", "ossl_cmp_pkisi_check_pkifailureinfo(si, i)", (fixture->pkifailure >> i) & 1, ossl_cmp_pkisi_check_pkifailureinfo(si, i))
                                                                    )
            goto end;
...
{
    CMP_STATUS_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 81 "../test/cmp_status_test.c" 3 4
   ((void *)0)
# 81 "../test/cmp_status_test.c"
   ) return 0;
    fixture->pkistatus = 5;
    ...
    fixture->pkifailure = (1 << 22) |
        (1 << 5);
    if (fixture != 
# 87 "../test/cmp_status_test.c" 3 4
   ((void *)0)
# 87 "../test/cmp_status_test.c"
   ) { result = execute_PKISI_test(fixture); tear_down(fixture); };
    return result;
}
...
int setup_tests(void)
{
# 107 "../test/cmp_status_test.c"
    add_test("test_PKISI", test_PKISI);
    return 1;
}
