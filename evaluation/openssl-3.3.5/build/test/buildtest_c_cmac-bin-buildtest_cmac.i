# 0 "test/buildtest_cmac.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_cmac.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) CMAC_CTX *CMAC_CTX_new(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void CMAC_CTX_cleanup(CMAC_CTX *ctx);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void CMAC_CTX_free(CMAC_CTX *ctx);
__attribute__((deprecated("Since OpenSSL " "3.0"))) EVP_CIPHER_CTX *CMAC_CTX_get0_cipher_ctx(CMAC_CTX *ctx);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int CMAC_CTX_copy(CMAC_CTX *out, const CMAC_CTX *in);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int CMAC_Init(CMAC_CTX *ctx,
                                    const void *key, size_t keylen,
                                    const EVP_CIPHER *cipher, ENGINE *impl);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int CMAC_Update(CMAC_CTX *ctx,
                                      const void *data, size_t dlen);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int CMAC_Final(CMAC_CTX *ctx,
                                     unsigned char *out, size_t *poutlen);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int CMAC_resume(CMAC_CTX *ctx);
# 11 "test/buildtest_cmac.c" 2
