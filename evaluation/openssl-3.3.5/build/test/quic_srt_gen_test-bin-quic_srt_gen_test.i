# 0 "../test/quic_srt_gen_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_srt_gen_test.c"
# 10 "../test/quic_srt_gen_test.c"
...
# 14 "../test/quic_srt_gen_test.c" 2
# 1 "../include/internal/quic_srt_gen.h" 1
...
# 15 "../include/internal/quic_srt_gen.h" 2
...
# 16 "../include/internal/quic_srt_gen.h" 2
...
# 17 "../include/internal/quic_srt_gen.h" 2
...
# 18 "../include/internal/quic_srt_gen.h" 2
# 32 "../include/internal/quic_srt_gen.h"
typedef struct quic_srt_gen_st QUIC_SRT_GEN;
# 42 "../include/internal/quic_srt_gen.h"
...
# 53 "../test/quic_srt_gen_test.c" 3 4
                           ((void *)0)
# 53 "../test/quic_srt_gen_test.c"
                               ;
    QUIC_STATELESS_RESET_TOKEN token;
    size_t i;

    if (!test_ptr("../test/quic_srt_gen_test.c", 57, "srt_gen = ossl_quic_srt_gen_new(NULL, NULL, t->key, t->key_len)", srt_gen = ossl_quic_srt_gen_new(
# 57 "../test/quic_srt_gen_test.c" 3 4
        ((void *)0)
# 57 "../test/quic_srt_gen_test.c"
        , 
# 57 "../test/quic_srt_gen_test.c" 3 4
        ((void *)0)
# 57 "../test/quic_srt_gen_test.c"
    ...
    for (i = 0; i < 2; ++i) {
        ...
        if (!test_true("../test/quic_srt_gen_test.c", 64, "ossl_quic_srt_gen_calculate_token(srt_gen, &t->dcid, &token)", (ossl_quic_srt_gen_calculate_token(srt_gen, &t->dcid, &token)) != 0)
                                                                 )
            goto err;

        if (!test_mem_eq("../test/quic_srt_gen_test.c", 68, "token.token", "&t->expected", token.token, sizeof(token.token), &t->expected, sizeof(t->expected))
                                                           )
            goto err;
    }
...
int setup_tests(void)
{
    add_all_tests("test_srt_gen", test_srt_gen, (sizeof(tests)/sizeof((tests)[0])), 1);
    return 1;
}
