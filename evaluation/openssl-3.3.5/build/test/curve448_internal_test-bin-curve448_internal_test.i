# 0 "../test/curve448_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/curve448_internal_test.c"
# 9 "../test/curve448_internal_test.c"
...
# 10 "../test/curve448_internal_test.c" 2
...
# 11 "../test/curve448_internal_test.c" 2
...
# 12 "../test/curve448_internal_test.c" 2
...
# 13 "../test/curve448_internal_test.c" 2
...
# 14 "../test/curve448_internal_test.c" 2
...
# 15 "../test/curve448_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 16 "../test/curve448_internal_test.c" 2
                             ...
                             size_t msglen)
{
    ...
    if (!EVP_DigestInit_ex(hashctx, EVP_shake256(), 
# 590 "../test/curve448_internal_test.c" 3 4
                                                   ((void *)0)
# 590 "../test/curve448_internal_test.c"
                                                       )
            || !EVP_DigestUpdate(hashctx, msg, msglen)
            || !EVP_DigestFinalXOF(hashctx, hashout, sizeof(hashout)))
        return 
# 593 "../test/curve448_internal_test.c" 3 4
              ((void *)0)
# 593 "../test/curve448_internal_test.c"
                  ;
...
static int test_ed448(void)
{
    ...
    if (!test_ptr("../test/curve448_internal_test.c", 603, "hashctx", hashctx)
            || !test_true("../test/curve448_internal_test.c", 604, "ossl_ed448_sign(NULL, outsig, NULL, 0, pubkey1, privkey1, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 604 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 604 "../test/curve448_internal_test.c"
               , outsig, 
# 604 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 604 "../test/curve448_internal_test.c"
...
# 604 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 606, "memcmp(sig1, outsig, sizeof(sig1))", "0", memcmp(sig1, outsig, sizeof(sig1)), 0)
            || !test_true("../test/curve448_internal_test.c", 607, "ossl_ed448_sign(NULL, outsig, msg2, sizeof(msg2), pubkey2, privkey2, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 607 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 607 "../test/curve448_internal_test.c"
               , outsig, msg2, sizeof(msg2), pubkey2, privkey2, 
# 607 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 607 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 607 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 609, "memcmp(sig2, outsig, sizeof(sig2))", "0", memcmp(sig2, outsig, sizeof(sig2)), 0)
            || !test_true("../test/curve448_internal_test.c", 610, "ossl_ed448_sign(NULL, outsig, msg3, sizeof(msg3), pubkey3, privkey3, context3, sizeof(context3), 0, NULL)", (ossl_ed448_sign(
# 610 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 610 "../test/curve448_internal_test.c"
               , outsig, msg3, sizeof(msg3), pubkey3, privkey3, context3, sizeof(context3), 0, 
# 610 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 610 "../test/curve448_internal_test.c"
               )) != 0)
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 613, "memcmp(sig3, outsig, sizeof(sig3))", "0", memcmp(sig3, outsig, sizeof(sig3)), 0)
            || !test_true("../test/curve448_internal_test.c", 614, "ossl_ed448_sign(NULL, outsig, msg4, sizeof(msg4), pubkey4, privkey4, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 614 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 614 "../test/curve448_internal_test.c"
               , outsig, msg4, sizeof(msg4), pubkey4, privkey4, 
# 614 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 614 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 614 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 616, "memcmp(sig4, outsig, sizeof(sig4))", "0", memcmp(sig4, outsig, sizeof(sig4)), 0)
            || !test_true("../test/curve448_internal_test.c", 617, "ossl_ed448_sign(NULL, outsig, msg5, sizeof(msg5), pubkey5, privkey5, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 617 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 617 "../test/curve448_internal_test.c"
               , outsig, msg5, sizeof(msg5), pubkey5, privkey5, 
# 617 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 617 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 617 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 619, "memcmp(sig5, outsig, sizeof(sig5))", "0", memcmp(sig5, outsig, sizeof(sig5)), 0)
            || !test_true("../test/curve448_internal_test.c", 620, "ossl_ed448_sign(NULL, outsig, msg6, sizeof(msg6), pubkey6, privkey6, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 620 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 620 "../test/curve448_internal_test.c"
               , outsig, msg6, sizeof(msg6), pubkey6, privkey6, 
# 620 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 620 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 620 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 622, "memcmp(sig6, outsig, sizeof(sig6))", "0", memcmp(sig6, outsig, sizeof(sig6)), 0)
            || !test_true("../test/curve448_internal_test.c", 623, "ossl_ed448_sign(NULL, outsig, msg7, sizeof(msg7), pubkey7, privkey7, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 623 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 623 "../test/curve448_internal_test.c"
               , outsig, msg7, sizeof(msg7), pubkey7, privkey7, 
# 623 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 623 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 623 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 625, "memcmp(sig7, outsig, sizeof(sig7))", "0", memcmp(sig7, outsig, sizeof(sig7)), 0)
            || !test_true("../test/curve448_internal_test.c", 626, "ossl_ed448_sign(NULL, outsig, msg8, sizeof(msg8), pubkey8, privkey8, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 626 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 626 "../test/curve448_internal_test.c"
               , outsig, msg8, sizeof(msg8), pubkey8, privkey8, 
# 626 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 626 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 626 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 628, "memcmp(sig8, outsig, sizeof(sig8))", "0", memcmp(sig8, outsig, sizeof(sig8)), 0)
            || !test_true("../test/curve448_internal_test.c", 629, "ossl_ed448_sign(NULL, outsig, msg9, sizeof(msg9), pubkey9, privkey9, NULL, 0, 0, NULL)", (ossl_ed448_sign(
# 629 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 629 "../test/curve448_internal_test.c"
               , outsig, msg9, sizeof(msg9), pubkey9, privkey9, 
# 629 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 629 "../test/curve448_internal_test.c"
               , 0, 0, 
...
# 629 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 631, "memcmp(sig9, outsig, sizeof(sig9))", "0", memcmp(sig9, outsig, sizeof(sig9)), 0)
            || !test_true("../test/curve448_internal_test.c", 632, "ossl_ed448_sign(NULL, outsig, dohash(hashctx, phmsg1, sizeof(phmsg1)), 64, phpubkey1, phprivkey1, NULL, 0, 1, NULL)", (ossl_ed448_sign(
# 632 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 632 "../test/curve448_internal_test.c"
               , outsig, dohash(hashctx, phmsg1, sizeof(phmsg1)), 64, phpubkey1, phprivkey1, 
# 632 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 632 "../test/curve448_internal_test.c"
               , 0, 1, 
...
# 632 "../test/curve448_internal_test.c"
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 636, "memcmp(phsig1, outsig, sizeof(phsig1))", "0", memcmp(phsig1, outsig, sizeof(phsig1)), 0)
            || !test_true("../test/curve448_internal_test.c", 637, "ossl_ed448_sign(NULL, outsig, dohash(hashctx, phmsg2, sizeof(phmsg2)), 64, phpubkey2, phprivkey2, phcontext2, sizeof(phcontext2), 1, NULL)", (ossl_ed448_sign(
# 637 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 637 "../test/curve448_internal_test.c"
               , outsig, dohash(hashctx, phmsg2, sizeof(phmsg2)), 64, phpubkey2, phprivkey2, phcontext2, sizeof(phcontext2), 1, 
# 637 "../test/curve448_internal_test.c" 3 4
               ((void *)0)
# 637 "../test/curve448_internal_test.c"
               )) != 0)
            ...
            || !test_int_eq("../test/curve448_internal_test.c", 642, "memcmp(phsig2, outsig, sizeof(phsig2))", "0", memcmp(phsig2, outsig, sizeof(phsig2)), 0)) {
...
static int test_x448(void)
{
    ...
    if (!test_true("../test/curve448_internal_test.c", 659, "ossl_x448(out, in_scalar1, in_u1)", (ossl_x448(out, in_scalar1, in_u1)) != 0)
          || !test_int_eq("../test/curve448_internal_test.c", 660, "memcmp(out, out_u1, sizeof(out))", "0", memcmp(out, out_u1, sizeof(out)), 0)
          || !test_true("../test/curve448_internal_test.c", 661, "ossl_x448(out, in_scalar2, in_u2)", (ossl_x448(out, in_scalar2, in_u2)) != 0)
          || !test_int_eq("../test/curve448_internal_test.c", 662, "memcmp(out, out_u2, sizeof(out))", "0", memcmp(out, out_u2, sizeof(out)), 0))
        return 0;
    ...
    for (i = 1; i <= max; i++) {
        if (verbose && i % 10000 == 0) {
            printf(".");
            fflush(
# 670 "../test/curve448_internal_test.c" 3 4
                  stdout
# 670 "../test/curve448_internal_test.c"
                        );
        }

        if (!test_true("../test/curve448_internal_test.c", 673, "ossl_x448(out, k, u)", (ossl_x448(out, k, u)) != 0))
            return 0;

        if (i == 1 || i == 1000 || i == 1000000) {
            j++;
            if (!test_int_eq("../test/curve448_internal_test.c", 678, "memcmp(out, out_u3[j], sizeof(out))", "0", memcmp(out, out_u3[j], sizeof(out)), 0)) {
                test_info("../test/curve448_internal_test.c", 679, "Failed at iteration %d", i);
                return 0;
            }
        }
        memcpy(u, k, sizeof(u));
