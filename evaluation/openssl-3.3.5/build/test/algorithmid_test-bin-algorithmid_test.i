# 0 "../test/algorithmid_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/algorithmid_test.c"
# 10 "../test/algorithmid_test.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 12 "../test/algorithmid_test.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 13 "../test/algorithmid_test.c" 2
...
# 15 "../test/algorithmid_test.c" 2


static const char *eecert_filename = 
# 17 "../test/algorithmid_test.c" 3 4
                                    ((void *)0)
# 17 "../test/algorithmid_test.c"
                                        ;
static const char *cacert_filename = 
# 18 "../test/algorithmid_test.c" 3 4
                                    ((void *)0)
# 18 "../test/algorithmid_test.c"
                                        ;
static const char *pubkey_filename = 
# 19 "../test/algorithmid_test.c" 3 4
                                    ((void *)0)
# 19 "../test/algorithmid_test.c"
                                        ;
...
static int test_spki_aid(X509_PUBKEY *pubkey, const char *filename)
{
    ...
    X509_ALGOR *alg = 
# 26 "../test/algorithmid_test.c" 3 4
                     ((void *)0)
# 26 "../test/algorithmid_test.c"
                         ;
    EVP_PKEY *pkey = 
# 27 "../test/algorithmid_test.c" 3 4
                    ((void *)0)
# 27 "../test/algorithmid_test.c"
                        ;
    EVP_KEYMGMT *keymgmt = 
# 28 "../test/algorithmid_test.c" 3 4
                          ((void *)0)
# 28 "../test/algorithmid_test.c"
                              ;
    void *keydata = 
# 29 "../test/algorithmid_test.c" 3 4
                   ((void *)0)
# 29 "../test/algorithmid_test.c"
                       ;
    char name[50] = "";
    unsigned char *algid_legacy = 
# 31 "../test/algorithmid_test.c" 3 4
                                 ((void *)0)
# 31 "../test/algorithmid_test.c"
                                     ;
    int algid_legacy_len = 0;
    static unsigned char algid_prov[256];
    size_t algid_prov_len = 0;
    const OSSL_PARAM *gettable_params = 
# 35 "../test/algorithmid_test.c" 3 4
                                       ((void *)0)
# 35 "../test/algorithmid_test.c"
                                           ;
    OSSL_PARAM params[] = {
        { (("algorithm-id")), (5), ((&algid_prov)), (sizeof(algid_prov)), ((size_t)-1) }
                                                                ,
        { 
# 39 "../test/algorithmid_test.c" 3 4
       ((void *)0)
# 39 "../test/algorithmid_test.c"
       , 0, 
# 39 "../test/algorithmid_test.c" 3 4
       ((void *)0)
# 39 "../test/algorithmid_test.c"
    ...
    if (!test_true("../test/algorithmid_test.c", 43, "X509_PUBKEY_get0_param(NULL, NULL, NULL, &alg, pubkey)", (X509_PUBKEY_get0_param(
# 43 "../test/algorithmid_test.c" 3 4
        ((void *)0)
# 43 "../test/algorithmid_test.c"
        , 
# 43 "../test/algorithmid_test.c" 3 4
        ((void *)0)
# 43 "../test/algorithmid_test.c"
...
# 43 "../test/algorithmid_test.c"
        , &alg, pubkey)) != 0)
        || !test_ptr("../test/algorithmid_test.c", 44, "pkey = X509_PUBKEY_get0(pubkey)", pkey = X509_PUBKEY_get0(pubkey)))
        goto end;

    if (!test_int_ge("../test/algorithmid_test.c", 47, "algid_legacy_len = i2d_X509_ALGOR(alg, &algid_legacy)", "0", algid_legacy_len = i2d_X509_ALGOR(alg, &algid_legacy), 0))
        goto end;

    X509_ALGOR_get0(&oid, 
# 50 "../test/algorithmid_test.c" 3 4
                         ((void *)0)
# 50 "../test/algorithmid_test.c"
                             , 
# 50 "../test/algorithmid_test.c" 3 4
                               ((void *)0)
# 50 "../test/algorithmid_test.c"
                                   , alg);
    if (!test_int_gt("../test/algorithmid_test.c", 51, "OBJ_obj2txt(name, sizeof(name), oid, 0)", "0", OBJ_obj2txt(name, sizeof(name), oid, 0), 0))
        goto end;
    ...
    if ((keydata = evp_pkey_export_to_provider(pkey, 
# 60 "../test/algorithmid_test.c" 3 4
                                                    ((void *)0)
# 60 "../test/algorithmid_test.c"
                                                        ,
                                               &keymgmt, 
# 61 "../test/algorithmid_test.c" 3 4
                                                        ((void *)0)
# 61 "../test/algorithmid_test.c"
                                                            )) == 
# 61 "../test/algorithmid_test.c" 3 4
                                                                  ((void *)0)
# 61 "../test/algorithmid_test.c"
                                                                      ) {
        test_info("../test/algorithmid_test.c", 62, "The public key found in '%s' doesn't have provider support." "  Skipping...", filename)
    ...
    if (!test_true("../test/algorithmid_test.c", 69, "EVP_KEYMGMT_is_a(keymgmt, name)", (EVP_KEYMGMT_is_a(keymgmt, name)) != 0)) {
        test_info("../test/algorithmid_test.c", 70, "The AlgorithmID key type (%s) for the public key found in" " '%s' doesn't match the key type of the extracted public" " key.", name, filename)
    ...
    if (!test_ptr("../test/algorithmid_test.c", 78, "gettable_params = EVP_KEYMGMT_gettable_params(keymgmt)", gettable_params = EVP_KEYMGMT_gettable_params(keymgmt))
        || !test_ptr("../test/algorithmid_test.c", 79, "OSSL_PARAM_locate_const(gettable_params, ALGORITHMID_NAME)", OSSL_PARAM_locate_const(gettable_params, "algorithm-id"))) {
        test_info("../test/algorithmid_test.c", 80, "The %s provider keymgmt appears to lack support for algorithm-id." "  Skipping...", name)
    ...
    algid_prov[0] = '\0';
    if (!test_true("../test/algorithmid_test.c", 88, "evp_keymgmt_get_params(keymgmt, keydata, params)", (evp_keymgmt_get_params(keymgmt, keydata, params)) != 0))
        goto end;
    algid_prov_len = params[0].return_size;


    if (test_mem_eq("../test/algorithmid_test.c", 93, "algid_legacy", "algid_prov", algid_legacy, algid_legacy_len, algid_prov, algid_prov_len)
                                               )
        ret = 1;

 end:
    EVP_KEYMGMT_free(keymgmt);
    CRYPTO_free(algid_legacy, "../test/algorithmid_test.c", 99);
    return ret;
}
...
# 113 "../test/algorithmid_test.c" 3 4
                                ((void *)0)
# 113 "../test/algorithmid_test.c"
                                    ;
    const X509_ALGOR *alg = 
# 114 "../test/algorithmid_test.c" 3 4
                           ((void *)0)
# 114 "../test/algorithmid_test.c"
                               ;
    int sig_nid = 0, dig_nid = 0, pkey_nid = 0;
    EVP_MD_CTX *mdctx = 
# 116 "../test/algorithmid_test.c" 3 4
                       ((void *)0)
# 116 "../test/algorithmid_test.c"
                           ;
    EVP_PKEY_CTX *pctx = 
# 117 "../test/algorithmid_test.c" 3 4
                        ((void *)0)
# 117 "../test/algorithmid_test.c"
                            ;
    EVP_PKEY *pkey = 
# 118 "../test/algorithmid_test.c" 3 4
                    ((void *)0)
# 118 "../test/algorithmid_test.c"
                        ;
    unsigned char *algid_legacy = 
# 119 "../test/algorithmid_test.c" 3 4
                                 ((void *)0)
# 119 "../test/algorithmid_test.c"
                                     ;
    int algid_legacy_len = 0;
    static unsigned char algid_prov[256];
    size_t algid_prov_len = 0;
    const OSSL_PARAM *gettable_params = 
# 123 "../test/algorithmid_test.c" 3 4
                                       ((void *)0)
# 123 "../test/algorithmid_test.c"
                                           ;
    OSSL_PARAM params[] = {
        { (("algorithm-id")), (5), ((&algid_prov)), (sizeof(algid_prov)), ((size_t)-1) }
                                                                ,
        { 
# 127 "../test/algorithmid_test.c" 3 4
       ((void *)0)
# 127 "../test/algorithmid_test.c"
       , 0, 
# 127 "../test/algorithmid_test.c" 3 4
       ((void *)0)
# 127 "../test/algorithmid_test.c"
    ...
    X509_get0_signature(
# 131 "../test/algorithmid_test.c" 3 4
                       ((void *)0)
# 131 "../test/algorithmid_test.c"
                           , &alg, eecert);
    X509_ALGOR_get0(&sig_oid, 
# 132 "../test/algorithmid_test.c" 3 4
                             ((void *)0)
# 132 "../test/algorithmid_test.c"
                                 , 
# 132 "../test/algorithmid_test.c" 3 4
                                   ((void *)0)
# 132 "../test/algorithmid_test.c"
                                       , alg);
    if (!test_int_eq("../test/algorithmid_test.c", 133, "X509_ALGOR_cmp(alg, X509_get0_tbs_sigalg(eecert))", "0", X509_ALGOR_cmp(alg, X509_get0_tbs_sigalg(eecert)), 0))
        goto end;
    if (!test_int_ne("../test/algorithmid_test.c", 135, "sig_nid = OBJ_obj2nid(sig_oid)", "NID_undef", sig_nid = OBJ_obj2nid(sig_oid), 0)
        || !test_true("../test/algorithmid_test.c", 136, "OBJ_find_sigid_algs(sig_nid, &dig_nid, &pkey_nid)", (OBJ_find_sigid_algs(sig_nid, &dig_nid, &pkey_nid)) != 0)
        || !test_ptr("../test/algorithmid_test.c", 137, "pkey = X509_get0_pubkey(cacert)", pkey = X509_get0_pubkey(cacert)))
        goto end;

    if (!test_true("../test/algorithmid_test.c", 140, "EVP_PKEY_is_a(pkey, OBJ_nid2sn(pkey_nid))", (EVP_PKEY_is_a(pkey, OBJ_nid2sn(pkey_nid))) != 0)) {
        test_info("../test/algorithmid_test.c", 141, "The '%s' pubkey can't be used to verify the '%s' signature", ca_filename, ee_filename)
                                           ;
        test_info("../test/algorithmid_test.c", 143, "Signature algorithm is %s (pkey type %s, hash type %s)", OBJ_nid2sn(sig_nid), OBJ_nid2sn(pkey_nid), OBJ_nid2sn(dig_nid))
                                                                                 ;
        test_info("../test/algorithmid_test.c", 145, "Pkey key type is %s", EVP_PKEY_get0_type_name(pkey));
        goto end;
    }

    if (!test_int_ge("../test/algorithmid_test.c", 149, "algid_legacy_len = i2d_X509_ALGOR(alg, &algid_legacy)", "0", algid_legacy_len = i2d_X509_ALGOR(alg, &algid_legacy), 0))
        goto end;

    if (!test_ptr("../test/algorithmid_test.c", 152, "mdctx = EVP_MD_CTX_new()", mdctx = EVP_MD_CTX_new())
        || !test_true("../test/algorithmid_test.c", 153, "EVP_DigestVerifyInit_ex(mdctx, &pctx, OBJ_nid2sn(dig_nid), NULL, NULL, pkey, NULL)", (EVP_DigestVerifyInit_ex(mdctx, &pctx, OBJ_nid2sn(dig_nid), 
# 153 "../test/algorithmid_test.c" 3 4
           ((void *)0)
# 153 "../test/algorithmid_test.c"
           , 
# 153 "../test/algorithmid_test.c" 3 4
           ((void *)0)
# 153 "../test/algorithmid_test.c"
...
# 153 "../test/algorithmid_test.c"
        ...
        test_info("../test/algorithmid_test.c", 156, "Couldn't initialize a DigestVerify operation with " "pkey type %s and hash type %s", OBJ_nid2sn(pkey_nid), OBJ_nid2sn(dig_nid))

                                                            ;
        goto end;
    }

    if (!test_ptr("../test/algorithmid_test.c", 162, "gettable_params = EVP_PKEY_CTX_gettable_params(pctx)", gettable_params = EVP_PKEY_CTX_gettable_params(pctx))
        || !test_ptr("../test/algorithmid_test.c", 163, "OSSL_PARAM_locate_const(gettable_params, ALGORITHMID_NAME)", OSSL_PARAM_locate_const(gettable_params, "algorithm-id"))) {
        test_info("../test/algorithmid_test.c", 164, "The %s provider keymgmt appears to lack support for algorithm-id" "  Skipping...", OBJ_nid2sn(pkey_nid))
    ...
    algid_prov[0] = '\0';
    if (!test_true("../test/algorithmid_test.c", 172, "EVP_PKEY_CTX_get_params(pctx, params)", (EVP_PKEY_CTX_get_params(pctx, params)) != 0))
        goto end;
    algid_prov_len = params[0].return_size;


    if (test_mem_eq("../test/algorithmid_test.c", 177, "algid_legacy", "algid_prov", algid_legacy, algid_legacy_len, algid_prov, algid_prov_len)
                                               )
        ret = 1;
    ...
    CRYPTO_free(algid_legacy, "../test/algorithmid_test.c", 184);
    return ret;
}
...
{
    X509_PUBKEY *pubkey = 
# 190 "../test/algorithmid_test.c" 3 4
                         ((void *)0)
# 190 "../test/algorithmid_test.c"
                             ;
    BIO *b = BIO_new_file(pubkey_filename, "r");
    int ret = 0;

    if (b == 
# 194 "../test/algorithmid_test.c" 3 4
            ((void *)0)
# 194 "../test/algorithmid_test.c"
                ) {
        test_error("../test/algorithmid_test.c", 195, "Couldn't open '%s' for reading\n", pubkey_filename);
        test_openssl_errors();
        goto end;
    }

    if ((pubkey = PEM_read_bio_X509_PUBKEY(b, 
# 200 "../test/algorithmid_test.c" 3 4
                                             ((void *)0)
# 200 "../test/algorithmid_test.c"
                                                 , 
# 200 "../test/algorithmid_test.c" 3 4
                                                   ((void *)0)
# 200 "../test/algorithmid_test.c"
...
# 200 "../test/algorithmid_test.c"
        ...
        test_error("../test/algorithmid_test.c", 201, "'%s' doesn't appear to be a SubjectPublicKeyInfo in PEM format\n", pubkey_filename)
                                   ;
        test_openssl_errors();
        goto end;
    }
...
{
    X509 *eecert = 
# 216 "../test/algorithmid_test.c" 3 4
                  ((void *)0)
# 216 "../test/algorithmid_test.c"
                      , *cacert = 
# 216 "../test/algorithmid_test.c" 3 4
                                  ((void *)0)
# 216 "../test/algorithmid_test.c"
                                      ;
    BIO *bee = 
# 217 "../test/algorithmid_test.c" 3 4
              ((void *)0)
# 217 "../test/algorithmid_test.c"
                  , *bca = 
# 217 "../test/algorithmid_test.c" 3 4
                           ((void *)0)
# 217 "../test/algorithmid_test.c"
    ...
    if ((bee = BIO_new_file(eecert_filename, "r")) == 
# 220 "../test/algorithmid_test.c" 3 4
                                                     ((void *)0)
# 220 "../test/algorithmid_test.c"
                                                         ) {
        test_error("../test/algorithmid_test.c", 221, "Couldn't open '%s' for reading\n", eecert_filename);
        test_openssl_errors();
        goto end;
    }
    if ((bca = BIO_new_file(cacert_filename, "r")) == 
# 225 "../test/algorithmid_test.c" 3 4
                                                     ((void *)0)
# 225 "../test/algorithmid_test.c"
                                                         ) {
        test_error("../test/algorithmid_test.c", 226, "Couldn't open '%s' for reading\n", cacert_filename);
        test_openssl_errors();
        goto end;
    }

    if ((eecert = PEM_read_bio_X509(bee, 
# 231 "../test/algorithmid_test.c" 3 4
                                        ((void *)0)
# 231 "../test/algorithmid_test.c"
                                            , 
# 231 "../test/algorithmid_test.c" 3 4
                                              ((void *)0)
# 231 "../test/algorithmid_test.c"
...
# 231 "../test/algorithmid_test.c"
        ...
        test_error("../test/algorithmid_test.c", 232, "'%s' doesn't appear to be a X.509 certificate in PEM format\n", eecert_filename)
                                   ;
        test_openssl_errors();
        goto end;
    }
    if ((cacert = PEM_read_bio_X509(bca, 
# 237 "../test/algorithmid_test.c" 3 4
                                        ((void *)0)
# 237 "../test/algorithmid_test.c"
                                            , 
# 237 "../test/algorithmid_test.c" 3 4
                                              ((void *)0)
# 237 "../test/algorithmid_test.c"
...
# 237 "../test/algorithmid_test.c"
        ...
        test_error("../test/algorithmid_test.c", 238, "'%s' doesn't appear to be a X.509 certificate in PEM format\n", cacert_filename)
                                   ;
        test_openssl_errors();
        goto end;
    }
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 271 "../test/algorithmid_test.c" 3 4
         ((void *)0) 
# 271 "../test/algorithmid_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    ...
    if (spki && pubkey_filename == 
# 315 "../test/algorithmid_test.c" 3 4
                                  ((void *)0)
# 315 "../test/algorithmid_test.c"
                                      ) {
        BIO_printf(bio_err, "Missing -spki argument\n");
        return 0;
    } else if (x509 && (eecert_filename == 
# 318 "../test/algorithmid_test.c" 3 4
                                          ((void *)0) 
# 318 "../test/algorithmid_test.c"
                                               || cacert_filename == 
# 318 "../test/algorithmid_test.c" 3 4
                                                                     ((void *)0)
# 318 "../test/algorithmid_test.c"
