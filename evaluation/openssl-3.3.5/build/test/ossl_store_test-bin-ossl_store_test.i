# 0 "../test/ossl_store_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ossl_store_test.c"
# 10 "../test/ossl_store_test.c"
...
# 15 "../test/ossl_store_test.c" 2
# 24 "../test/ossl_store_test.c"
...
# 34 "../test/ossl_store_test.c" 3 4
                             ((void *)0)
# 34 "../test/ossl_store_test.c"
                                 ;
static const char *infile = 
# 35 "../test/ossl_store_test.c" 3 4
                           ((void *)0)
# 35 "../test/ossl_store_test.c"
                               ;
static const char *sm2file = 
# 36 "../test/ossl_store_test.c" 3 4
                            ((void *)0)
# 36 "../test/ossl_store_test.c"
                                ;
static const char *datadir = 
# 37 "../test/ossl_store_test.c" 3 4
                            ((void *)0)
# 37 "../test/ossl_store_test.c"
                                ;
...
static int test_store_open(void)
{
    int ret = 0;
    OSSL_STORE_CTX *sctx = 
# 42 "../test/ossl_store_test.c" 3 4
                          ((void *)0)
# 42 "../test/ossl_store_test.c"
                              ;
    OSSL_STORE_SEARCH *search = 
# 43 "../test/ossl_store_test.c" 3 4
                               ((void *)0)
# 43 "../test/ossl_store_test.c"
                                   ;
    UI_METHOD *ui_method = 
# 44 "../test/ossl_store_test.c" 3 4
                          ((void *)0)
# 44 "../test/ossl_store_test.c"
                              ;
    char *input = test_mk_file_path(inputdir, infile);

    ret = test_ptr("../test/ossl_store_test.c", 47, "input", input)
          && test_ptr("../test/ossl_store_test.c", 48, "search = OSSL_STORE_SEARCH_by_alias(\"nothing\")", search = OSSL_STORE_SEARCH_by_alias("nothing"))
          && test_ptr("../test/ossl_store_test.c", 49, "ui_method= UI_create_method(\"DummyUI\")", ui_method= UI_create_method("DummyUI"))
          && test_ptr("../test/ossl_store_test.c", 50, "sctx = OSSL_STORE_open_ex(input, NULL, NULL, ui_method, NULL, NULL, NULL, NULL)", sctx = OSSL_STORE_open_ex(input, 
# 50 "../test/ossl_store_test.c" 3 4
            ((void *)0)
# 50 "../test/ossl_store_test.c"
            , 
# 50 "../test/ossl_store_test.c" 3 4
            ((void *)0)
# 50 "../test/ossl_store_test.c"
...
# 50 "../test/ossl_store_test.c"
          ...
          && test_false("../test/ossl_store_test.c", 52, "OSSL_STORE_find(sctx, NULL)", (OSSL_STORE_find(sctx, 
# 52 "../test/ossl_store_test.c" 3 4
            ((void *)0)
# 52 "../test/ossl_store_test.c"
            )) != 0)
          && test_true("../test/ossl_store_test.c", 53, "OSSL_STORE_find(sctx, search)", (OSSL_STORE_find(sctx, search)) != 0);
    UI_destroy_method(ui_method);
    OSSL_STORE_SEARCH_free(search);
    OSSL_STORE_close(sctx);
    CRYPTO_free(input, "../test/ossl_store_test.c", 57);
    return ret;
}
...
static int test_store_search_by_key_fingerprint_fail(void)
{
    int ret;
    OSSL_STORE_SEARCH *search = 
# 64 "../test/ossl_store_test.c" 3 4
                               ((void *)0)
# 64 "../test/ossl_store_test.c"
                                   ;

    ret = test_ptr_null("../test/ossl_store_test.c", 66, "search = OSSL_STORE_SEARCH_by_key_fingerprint( EVP_sha256(), NULL, 0)", search = OSSL_STORE_SEARCH_by_key_fingerprint( EVP_sha256(), 
# 66 "../test/ossl_store_test.c" 3 4
         ((void *)0)
# 66 "../test/ossl_store_test.c"
         , 0))
                                                            ;
    OSSL_STORE_SEARCH_free(search);
    return ret;
...
{
    EVP_PKEY *pkey = 
# 74 "../test/ossl_store_test.c" 3 4
                    ((void *)0)
# 74 "../test/ossl_store_test.c"
                        ;
    OSSL_STORE_CTX *ctx = 
# 75 "../test/ossl_store_test.c" 3 4
                         ((void *)0)
# 75 "../test/ossl_store_test.c"
                             ;
    OSSL_STORE_INFO *info;
    int ret = 0;

    ctx = OSSL_STORE_open_ex(uri, 
# 79 "../test/ossl_store_test.c" 3 4
                                 ((void *)0)
# 79 "../test/ossl_store_test.c"
                                     , 
# 79 "../test/ossl_store_test.c" 3 4
                                       ((void *)0)
# 79 "../test/ossl_store_test.c"
...
# 79 "../test/ossl_store_test.c"
    ...
    if (!test_ptr("../test/ossl_store_test.c", 80, "ctx", ctx))
        goto err;

    while (!OSSL_STORE_eof(ctx)
            && (info = OSSL_STORE_load(ctx)) != 
# 84 "../test/ossl_store_test.c" 3 4
                                               ((void *)0)
            
# 85 "../test/ossl_store_test.c"
           && pkey == 
# 85 "../test/ossl_store_test.c" 3 4
                      ((void *)0)
# 85 "../test/ossl_store_test.c"
                          ) {
        if (OSSL_STORE_INFO_get_type(info) == 2) {
            pkey = OSSL_STORE_INFO_get1_PARAMS(info);
        }
        OSSL_STORE_INFO_free(info);
        info = 
# 90 "../test/ossl_store_test.c" 3 4
              ((void *)0)
# 90 "../test/ossl_store_test.c"
                  ;
    }

    if (pkey != 
# 93 "../test/ossl_store_test.c" 3 4
               ((void *)0)
# 93 "../test/ossl_store_test.c"
                   )
...
static int test_store_get_params(int idx)
{
    ...
    const char *urifmt;
    char uri[
# 106 "../test/ossl_store_test.c" 3 4
            4096
# 106 "../test/ossl_store_test.c"
                    ];
    ...
    default:
        test_error("../test/ossl_store_test.c", 129, "Invalid test index");
        return 0;
    }

    urifmt = "%s/%s-params.pem";
# 142 "../test/ossl_store_test.c"
    if (!test_true("../test/ossl_store_test.c", 142, "BIO_snprintf(uri, sizeof(uri), urifmt, datadir, type)", (BIO_snprintf(uri, sizeof(uri), urifmt, datadir, type)) != 0))
        return 0;

    test_info("../test/ossl_store_test.c", 145, "Testing uri: %s", uri);
    if (!test_true("../test/ossl_store_test.c", 146, "get_params(uri, type)", (get_params(uri, type)) != 0))
        return 0;
...
# 159 "../test/ossl_store_test.c" 3 4
                               ((void *)0)
# 159 "../test/ossl_store_test.c"
                                   ;
    OSSL_PROVIDER *provider = 
# 160 "../test/ossl_store_test.c" 3 4
                             ((void *)0)
# 160 "../test/ossl_store_test.c"
                                 ;
    OSSL_LIB_CTX *libctx = 
# 161 "../test/ossl_store_test.c" 3 4
                          ((void *)0)
# 161 "../test/ossl_store_test.c"
                              ;
    BIO *bio = 
# 162 "../test/ossl_store_test.c" 3 4
              ((void *)0)
# 162 "../test/ossl_store_test.c"
                  ;
    char *input = test_mk_file_path(inputdir, sm2file);

    ret = test_ptr("../test/ossl_store_test.c", 165, "input", input)
          && test_ptr("../test/ossl_store_test.c", 166, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new())
          && test_ptr("../test/ossl_store_test.c", 167, "provider = OSSL_PROVIDER_load(libctx, \"default\")", provider = OSSL_PROVIDER_load(libctx, "default"))
          && test_ptr("../test/ossl_store_test.c", 168, "bio = BIO_new_file(input, \"r\")", bio = BIO_new_file(input, "r"))
          && test_ptr("../test/ossl_store_test.c", 169, "store_ctx = OSSL_STORE_attach(bio, \"file\", libctx, NULL, NULL, NULL, NULL, NULL, NULL)", store_ctx = OSSL_STORE_attach(bio, "file", libctx, 
# 169 "../test/ossl_store_test.c" 3 4
            ((void *)0)
# 169 "../test/ossl_store_test.c"
            , 
# 169 "../test/ossl_store_test.c" 3 4
            ((void *)0)
# 169 "../test/ossl_store_test.c"
...
# 169 "../test/ossl_store_test.c"
          ...
          && test_int_ne("../test/ossl_store_test.c", 171, "ERR_GET_LIB(ERR_peek_error())", "ERR_LIB_OSSL_STORE", ERR_GET_LIB(ERR_peek_error()), 44)
          && test_int_ne("../test/ossl_store_test.c", 172, "ERR_GET_REASON(ERR_peek_error())", "OSSL_STORE_R_UNREGISTERED_SCHEME", ERR_GET_REASON(ERR_peek_error()), 105)
                                                          ;
    ...
    CRYPTO_free(input, "../test/ossl_store_test.c", 179);
    return ret;
}
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { "data", OPT_DATADIR, 's' },
        { 
# 191 "../test/ossl_store_test.c" 3 4
         ((void *)0) 
# 191 "../test/ossl_store_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    ...
    if (datadir == 
# 222 "../test/ossl_store_test.c" 3 4
                  ((void *)0)
# 222 "../test/ossl_store_test.c"
                      ) {
        test_error("../test/ossl_store_test.c", 223, "No data directory specified");
        return 0;
    }
    if (inputdir == 
# 226 "../test/ossl_store_test.c" 3 4
                   ((void *)0)
# 226 "../test/ossl_store_test.c"
                       ) {
        test_error("../test/ossl_store_test.c", 227, "No input directory specified");
        return 0;
    }

    if (infile != 
# 231 "../test/ossl_store_test.c" 3 4
                 ((void *)0)
# 231 "../test/ossl_store_test.c"
                     )
        add_test("test_store_open", test_store_open);
    add_test("test_store_search_by_key_fingerprint_fail", test_store_search_by_key_fingerprint_fail);
    add_all_tests("test_store_get_params", test_store_get_params, 3, 1);
    if (sm2file != 
# 235 "../test/ossl_store_test.c" 3 4
                  ((void *)0)
# 235 "../test/ossl_store_test.c"
                      )
        add_test("test_store_attach_unregistered_scheme", test_store_attach_unregistered_scheme);
    return 1;
}
