# 0 "../test/quic_newcid_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_newcid_test.c"
# 10 "../test/quic_newcid_test.c"
...
# 15 "../test/quic_newcid_test.c" 2

static char *cert = 
# 16 "../test/quic_newcid_test.c" 3 4
                   ((void *)0)
# 16 "../test/quic_newcid_test.c"
                       ;
static char *privkey = 
# 17 "../test/quic_newcid_test.c" 3 4
                      ((void *)0)
# 17 "../test/quic_newcid_test.c"
                          ;
...
static int test_ncid_frame(int fail)
{
    ...
    QUIC_TSERVER *qtserv = 
# 53 "../test/quic_newcid_test.c" 3 4
                          ((void *)0)
# 53 "../test/quic_newcid_test.c"
                              ;
    SSL *cssl = 
# 54 "../test/quic_newcid_test.c" 3 4
               ((void *)0)
# 54 "../test/quic_newcid_test.c"
                   ;
    ...
    size_t bytesread;
    QTEST_FAULT *fault = 
# 60 "../test/quic_newcid_test.c" 3 4
                        ((void *)0)
# 60 "../test/quic_newcid_test.c"
                            ;
    ...
    ncid_injected = 0;
    if (!test_ptr("../test/quic_newcid_test.c", 67, "cctx", cctx))
        goto err;

    if (!test_true("../test/quic_newcid_test.c", 70, "qtest_create_quic_objects(NULL, cctx, NULL, cert, privkey, 0, &qtserv, &cssl, &fault, NULL)", (qtest_create_quic_objects(
# 70 "../test/quic_newcid_test.c" 3 4
        ((void *)0)
# 70 "../test/quic_newcid_test.c"
        , cctx, 
# 70 "../test/quic_newcid_test.c" 3 4
        ((void *)0)
# 70 "../test/quic_newcid_test.c"
...
# 70 "../test/quic_newcid_test.c"
    ...
    if (!test_true("../test/quic_newcid_test.c", 74, "qtest_create_quic_connection(qtserv, cssl)", (qtest_create_quic_connection(qtserv, cssl)) != 0))
        goto err;

    if (!test_int_eq("../test/quic_newcid_test.c", 77, "SSL_write(cssl, msg, msglen)", "msglen", SSL_write(cssl, msg, msglen), msglen))
        goto err;

    ossl_quic_tserver_tick(qtserv);
    if (!test_true("../test/quic_newcid_test.c", 81, "ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)", (ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)) != 0)
                                                      )
        goto err;
    ...
    if (!test_mem_eq("../test/quic_newcid_test.c", 90, "msg", "buf", msg, msglen, buf, bytesread))
        goto err;
    ...
    if (!test_true("../test/quic_newcid_test.c", 97, "qtest_fault_set_packet_plain_listener(fault, add_ncid_frame_cb, NULL)", (qtest_fault_set_packet_plain_listener(fault, add_ncid_frame_cb, 
# 97 "../test/quic_newcid_test.c" 3 4
        ((void *)0)
# 97 "../test/quic_newcid_test.c"
        )) != 0)

                                                               )
        goto err;
    if (!fail && !test_true("../test/quic_newcid_test.c", 101, "ossl_quic_tserver_set_new_local_cid(qtserv, &conn_id)", (ossl_quic_tserver_set_new_local_cid(qtserv, &conn_id)) != 0))
        goto err;
    if (!test_true("../test/quic_newcid_test.c", 103, "ossl_quic_tserver_write(qtserv, 0, (unsigned char *)msg, msglen, &byteswritten)", (ossl_quic_tserver_write(qtserv, 0, (unsigned char *)msg, msglen, &byteswritten)) != 0)

                                                          )
        goto err;

    if (!test_true("../test/quic_newcid_test.c", 108, "ncid_injected", (ncid_injected) != 0))
        goto err;

    if (!test_size_t_eq("../test/quic_newcid_test.c", 111, "msglen", "byteswritten", msglen, byteswritten))
        goto err;

    ossl_quic_tserver_tick(qtserv);
    if (!test_true("../test/quic_newcid_test.c", 115, "SSL_handle_events(cssl)", (SSL_handle_events(cssl)) != 0))
        goto err;

    if (!test_int_eq("../test/quic_newcid_test.c", 118, "SSL_read(cssl, buf, sizeof(buf))", "msglen", SSL_read(cssl, buf, sizeof(buf)), msglen))
        goto err;

    if (!test_mem_eq("../test/quic_newcid_test.c", 121, "msg", "buf", msg, msglen, buf, bytesread))
        goto err;

    if (!test_int_eq("../test/quic_newcid_test.c", 124, "SSL_write(cssl, msg, msglen)", "msglen", SSL_write(cssl, msg, msglen), msglen))
        goto err;

    ossl_quic_tserver_tick(qtserv);
    if (!test_true("../test/quic_newcid_test.c", 128, "ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)", (ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)) != 0)
                                                      )
        goto err;

    if (fail) {
        if (!test_size_t_eq("../test/quic_newcid_test.c", 133, "bytesread", "0", bytesread, 0))
            goto err;
    } else {
        if (!test_mem_eq("../test/quic_newcid_test.c", 136, "msg", "buf", msg, msglen, buf, bytesread))
            goto err;
    }
...
# 149 "../test/quic_newcid_test.c" 3 4
((void *)0) 
# 149 "../test/quic_newcid_test.c"
} }; return options; }

int setup_tests(void)
{
    char *certsdir = 
# 153 "../test/quic_newcid_test.c" 3 4
                    ((void *)0)
# 153 "../test/quic_newcid_test.c"
                        ;

    if (!test_skip_common_options()) {
        test_error("../test/quic_newcid_test.c", 156, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/quic_newcid_test.c", 160, "certsdir = test_get_argument(0)", certsdir = test_get_argument(0)))
        return 0;

    cert = test_mk_file_path(certsdir, "servercert.pem");
    if (cert == 
# 164 "../test/quic_newcid_test.c" 3 4
               ((void *)0)
# 164 "../test/quic_newcid_test.c"
                   )
        goto err;

    privkey = test_mk_file_path(certsdir, "serverkey.pem");
    if (privkey == 
# 168 "../test/quic_newcid_test.c" 3 4
                  ((void *)0)
# 168 "../test/quic_newcid_test.c"
                      )
        goto err;

    add_all_tests("test_ncid_frame", test_ncid_frame, 2, 1);

    return 1;

 err:
    CRYPTO_free(cert, "../test/quic_newcid_test.c", 176);
    CRYPTO_free(privkey, "../test/quic_newcid_test.c", 177);
    return 0;
}

void cleanup_tests(void)
{
    CRYPTO_free(cert, "../test/quic_newcid_test.c", 183);
    CRYPTO_free(privkey, "../test/quic_newcid_test.c", 184);
}
