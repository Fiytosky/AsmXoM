# 0 "../test/params_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/params_test.c"
# 15 "../test/params_test.c"
...
# 21 "../test/params_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 22 "../test/params_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 23 "../test/params_test.c" 2
# 38 "../test/params_test.c"
struct object_st {
...
static void cleanup_object(void *vobj)
{
    ...
    BN_free(obj->p3);
    obj->p3 = 
# 93 "../test/params_test.c" 3 4
             ((void *)0)
# 93 "../test/params_test.c"
                 ;
    CRYPTO_free(obj->p4, "../test/params_test.c", 94);
    obj->p4 = 
# 95 "../test/params_test.c" 3 4
             ((void *)0)
# 95 "../test/params_test.c"
                 ;
    CRYPTO_free(obj, "../test/params_test.c", 96);
}
...
static void *init_object(void)
{
    ...
    if (!test_ptr("../test/params_test.c", 103, "obj = OPENSSL_zalloc(sizeof(*obj))", obj = CRYPTO_zalloc(sizeof(*obj), "../test/params_test.c", 103)))
        return 
# 104 "../test/params_test.c" 3 4
              ((void *)0)
# 104 "../test/params_test.c"
                  ;

    obj->p1 = 42;
    obj->p2 = 6.283;
    if (!test_true("../test/params_test.c", 108, "BN_hex2bn(&obj->p3, p3_init)", (BN_hex2bn(&obj->p3, "4142434445464748494a4b4c4d4e4f50" "5152535455565758595a616263646566" "6768696a6b6c6d6e6f70717273747576" "7778797a30313233343536373839")) != 0))
        goto fail;
    if (!test_ptr("../test/params_test.c", 110, "obj->p4 = OPENSSL_strdup(p4_init)", obj->p4 = CRYPTO_strdup("BLAKE2s256", "../test/params_test.c", 110)))
        goto fail;
    strcpy(obj->p5, "Hellow World");
    obj->p6 = "3.3.5";
 ...
 fail:
    cleanup_object(obj);
    obj = 
# 118 "../test/params_test.c" 3 4
         ((void *)0)
# 118 "../test/params_test.c"
             ;

    return 
# 120 "../test/params_test.c" 3 4
          ((void *)0)
# 120 "../test/params_test.c"
              ;
}
# 130 "../test/params_test.c"
static int raw_set_params(void *vobj, const OSSL_PARAM *params)
{
    struct object_st *obj = vobj;

    for (; params->key != 
# 134 "../test/params_test.c" 3 4
                         ((void *)0)
# 134 "../test/params_test.c"
                             ; params++)
        if (strcmp(params->key, "p1") == 0) {
            ...
            BN_free(obj->p3);
            if (!test_ptr("../test/params_test.c", 141, "obj->p3 = BN_native2bn(params->data, params->data_size, NULL)", obj->p3 = BN_native2bn(params->data, params->data_size, 
# 141 "../test/params_test.c" 3 4
                ((void *)0)
# 141 "../test/params_test.c"
                ))
                                                                          )
                return 0;
        } else if (strcmp(params->key, "p4") == 0) {
            CRYPTO_free(obj->p4, "../test/params_test.c", 145);
            if (!test_ptr("../test/params_test.c", 146, "obj->p4 = OPENSSL_strndup(params->data, params->data_size)", obj->p4 = CRYPTO_strndup(params->data, params->data_size, "../test/params_test.c", 146))
                                                                       )
                return 0;
            ...
            if (!test_size_t_lt("../test/params_test.c", 158, "data_length", "sizeof(obj->p5)", data_length, sizeof(obj->p5)))
                return 0;
...
static int raw_get_params(void *vobj, OSSL_PARAM *params)
{
    ...
    for (; params->key != 
# 175 "../test/params_test.c" 3 4
                         ((void *)0)
# 175 "../test/params_test.c"
                             ; params++)
        if (strcmp(params->key, "p1") == 0) {
            ...
            *(double *)params->data = obj->p2;
            ...
            params->return_size = ((BN_num_bits(obj->p3)+7)/8);
            if (!test_size_t_ge("../test/params_test.c", 184, "params->data_size", "params->return_size", params->data_size, params->return_size))
                return 0;
            BN_bn2nativepad(obj->p3, params->data, params->return_size);
        } else if (strcmp(params->key, "p4") == 0) {
            params->return_size = strlen(obj->p4);
            if (!test_size_t_gt("../test/params_test.c", 189, "params->data_size", "params->return_size", params->data_size, params->return_size))
                return 0;
            strcpy(params->data, obj->p4);
        } else if (strcmp(params->key, "p5") == 0) {
            params->return_size = strlen(obj->p5);
            if (!test_size_t_gt("../test/params_test.c", 194, "params->data_size", "params->return_size", params->data_size, params->return_size))
                return 0;
...
static int api_set_params(void *vobj, const OSSL_PARAM *params)
{
    struct object_st *obj = vobj;
    const OSSL_PARAM *p = 
# 212 "../test/params_test.c" 3 4
                         ((void *)0)
# 212 "../test/params_test.c"
                             ;

    if ((p = OSSL_PARAM_locate_const(params, "p1")) != 
# 214 "../test/params_test.c" 3 4
                                                      ((void *)0)
        
# 215 "../test/params_test.c"
       && !test_true("../test/params_test.c", 215, "OSSL_PARAM_get_int(p, &obj->p1)", (OSSL_PARAM_get_int(p, &obj->p1)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "p2")) != 
# 217 "../test/params_test.c" 3 4
                                                      ((void *)0)
        
# 218 "../test/params_test.c"
       && !test_true("../test/params_test.c", 218, "OSSL_PARAM_get_double(p, &obj->p2)", (OSSL_PARAM_get_double(p, &obj->p2)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "p3")) != 
# 220 "../test/params_test.c" 3 4
                                                      ((void *)0)
        
# 221 "../test/params_test.c"
       && !test_true("../test/params_test.c", 221, "OSSL_PARAM_get_BN(p, &obj->p3)", (OSSL_PARAM_get_BN(p, &obj->p3)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "p4")) != 
# 223 "../test/params_test.c" 3 4
                                                      ((void *)0)
# 223 "../test/params_test.c"
                                                          ) {
        CRYPTO_free(obj->p4, "../test/params_test.c", 224);
        obj->p4 = 
# 225 "../test/params_test.c" 3 4
                 ((void *)0)
# 225 "../test/params_test.c"
                     ;

        if (!test_true("../test/params_test.c", 227, "OSSL_PARAM_get_utf8_string(p, &obj->p4, 0)", (OSSL_PARAM_get_utf8_string(p, &obj->p4, 0)) != 0))
            return 0;
    }
    if ((p = OSSL_PARAM_locate_const(params, "p5")) != 
# 230 "../test/params_test.c" 3 4
                                                      ((void *)0)
# 230 "../test/params_test.c"
                                                          ) {
        char *p5_ptr = obj->p5;
        if (!test_true("../test/params_test.c", 232, "OSSL_PARAM_get_utf8_string(p, &p5_ptr, sizeof(obj->p5))", (OSSL_PARAM_get_utf8_string(p, &p5_ptr, sizeof(obj->p5))) != 0))
            return 0;
        obj->p5_l = strlen(obj->p5);
    }
    if ((p = OSSL_PARAM_locate_const(params, "p6")) != 
# 236 "../test/params_test.c" 3 4
                                                      ((void *)0)
# 236 "../test/params_test.c"
                                                          ) {
        if (!test_true("../test/params_test.c", 237, "OSSL_PARAM_get_utf8_ptr(p, &obj->p6)", (OSSL_PARAM_get_utf8_ptr(p, &obj->p6)) != 0))
            return 0;
...
static int api_get_params(void *vobj, OSSL_PARAM *params)
{
    struct object_st *obj = vobj;
    OSSL_PARAM *p = 
# 248 "../test/params_test.c" 3 4
                   ((void *)0)
# 248 "../test/params_test.c"
                       ;

    if ((p = OSSL_PARAM_locate(params, "p1")) != 
# 250 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 251 "../test/params_test.c"
       && !test_true("../test/params_test.c", 251, "OSSL_PARAM_set_int(p, obj->p1)", (OSSL_PARAM_set_int(p, obj->p1)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "p2")) != 
# 253 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 254 "../test/params_test.c"
       && !test_true("../test/params_test.c", 254, "OSSL_PARAM_set_double(p, obj->p2)", (OSSL_PARAM_set_double(p, obj->p2)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "p3")) != 
# 256 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 257 "../test/params_test.c"
       && !test_true("../test/params_test.c", 257, "OSSL_PARAM_set_BN(p, obj->p3)", (OSSL_PARAM_set_BN(p, obj->p3)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "p4")) != 
# 259 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 260 "../test/params_test.c"
       && !test_true("../test/params_test.c", 260, "OSSL_PARAM_set_utf8_string(p, obj->p4)", (OSSL_PARAM_set_utf8_string(p, obj->p4)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "p5")) != 
# 262 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 263 "../test/params_test.c"
       && !test_true("../test/params_test.c", 263, "OSSL_PARAM_set_utf8_string(p, obj->p5)", (OSSL_PARAM_set_utf8_string(p, obj->p5)) != 0))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "p6")) != 
# 265 "../test/params_test.c" 3 4
                                                ((void *)0)
        
# 266 "../test/params_test.c"
       && !test_true("../test/params_test.c", 266, "OSSL_PARAM_set_utf8_ptr(p, obj->p6)", (OSSL_PARAM_set_utf8_ptr(p, obj->p6)) != 0))
        return 0;
...
# 305 "../test/params_test.c"
static int app_p1;
static double app_p2;
static BIGNUM *app_p3 = 
# 307 "../test/params_test.c" 3 4
                       ((void *)0)
# 307 "../test/params_test.c"
                           ;
static unsigned char bignumbin[4096];
static char app_p4[256];
static char app_p5[256];
static const char *app_p6 = 
# 311 "../test/params_test.c" 3 4
                           ((void *)0)
# 311 "../test/params_test.c"
                               ;
static unsigned char foo[1];
# 322 "../test/params_test.c"
static int cleanup_app_variables(void)
{
    BN_free(app_p3);
    app_p3 = 
# 325 "../test/params_test.c" 3 4
            ((void *)0)
# 325 "../test/params_test.c"
                ;
    return 1;
}
...
static OSSL_PARAM static_raw_params[] = {
    { "p1", 1, &app_p1, sizeof(app_p1), 0 },
    { "p3", 2, &bignumbin, sizeof(bignumbin), 0 },
    { "p4", 4, &app_p4, sizeof(app_p4), 0 },
    { "p5", 4, &app_p5, sizeof(app_p5), 0 },

    { "p6", 6, &app_p6, sizeof("Cookie") - 1, 0 },
    { "foo", 5, &foo, sizeof(foo), 0 },
    { 
# 361 "../test/params_test.c" 3 4
     ((void *)0)
# 361 "../test/params_test.c"
         , 0, 
# 361 "../test/params_test.c" 3 4
              ((void *)0)
# 361 "../test/params_test.c"
...
static OSSL_PARAM static_api_params[] = {
    { (("p1")), (1), ((&app_p1)), (sizeof(int)), ((size_t)-1) },
    { (("p3")), (2), ((&bignumbin)), ((sizeof(bignumbin))), ((size_t)-1) },
    { ("p4"), (4), (&app_p4), (sizeof(app_p4)), ((size_t)-1) },
    { ("p5"), (4), (&app_p5), (sizeof(app_p5)), ((size_t)-1) },

    { ("p6"), (6), (&app_p6), (sizeof("Cookie") - 1), ((size_t)-1) }
                                            ,
    { ("foo"), (5), (&foo), (sizeof(foo)), ((size_t)-1) },
    { 
# 374 "../test/params_test.c" 3 4
   ((void *)0)
# 374 "../test/params_test.c"
   , 0, 
# 374 "../test/params_test.c" 3 4
   ((void *)0)
# 374 "../test/params_test.c"
...
{
    BIGNUM *verify_p3 = 
# 439 "../test/params_test.c" 3 4
                       ((void *)0)
# 439 "../test/params_test.c"
                           ;
    void *obj = 
# 440 "../test/params_test.c" 3 4
               ((void *)0)
# 440 "../test/params_test.c"
                   ;
    int errcnt = 0;
    OSSL_PARAM *p;
    ...
    if (!test_ptr("../test/params_test.c", 447, "obj = init_object()", obj = init_object())
        || !test_true("../test/params_test.c", 448, "BN_hex2bn(&verify_p3, p3_init)", (BN_hex2bn(&verify_p3, "4142434445464748494a4b4c4d4e4f50" "5152535455565758595a616263646566" "6768696a6b6c6d6e6f70717273747576" "7778797a30313233343536373839")) != 0)) {
        errcnt++;
        goto fin;
    }
    ...
    if (!test_true("../test/params_test.c", 459, "prov->get_params(obj, params)", (prov->get_params(obj, params)) != 0)
        || !test_int_eq("../test/params_test.c", 460, "app_p1", "p1_init", app_p1, 42)
        || !test_double_eq("../test/params_test.c", 461, "app_p2", "app_p2_init", app_p2, 47.11)
        || !test_ptr("../test/params_test.c", 462, "p = OSSL_PARAM_locate(params, \"p3\")", p = OSSL_PARAM_locate(params, "p3"))
        || !test_ptr("../test/params_test.c", 463, "BN_native2bn(bignumbin, p->return_size, app_p3)", BN_native2bn(bignumbin, p->return_size, app_p3))
        || !test_BN_eq("../test/params_test.c", 464, "app_p3", "verify_p3", app_p3, verify_p3)
        || !test_str_eq("../test/params_test.c", 465, "app_p4", "p4_init", app_p4, "BLAKE2s256")
        || !test_ptr("../test/params_test.c", 466, "p = OSSL_PARAM_locate(params, \"p5\")", p = OSSL_PARAM_locate(params, "p5"))
        || !test_size_t_eq("../test/params_test.c", 467, "p->return_size", "sizeof(p5_init) - 1", p->return_size, sizeof("Hellow World") - 1)

        || !test_str_eq("../test/params_test.c", 469, "app_p5", "p5_init", app_p5, "Hellow World")
        || !test_ptr("../test/params_test.c", 470, "p = OSSL_PARAM_locate(params, \"p6\")", p = OSSL_PARAM_locate(params, "p6"))
        || !test_size_t_eq("../test/params_test.c", 471, "p->return_size", "sizeof(p6_init) - 1", p->return_size, sizeof("3.3.5") - 1)

        || !test_str_eq("../test/params_test.c", 473, "app_p6", "p6_init", app_p6, "3.3.5")
        || !test_char_eq("../test/params_test.c", 474, "foo[0]", "app_foo_init", foo[0], 'z')
        || !test_ptr("../test/params_test.c", 475, "p = OSSL_PARAM_locate(params, \"foo\")", p = OSSL_PARAM_locate(params, "foo")))
        errcnt++;
    ...
    if (!test_true("../test/params_test.c", 484, "prov->set_params(obj, params)", (prov->set_params(obj, params)) != 0)) {
        errcnt++;
    } else {
        struct object_st *sneakpeek = obj;

        if (!test_int_eq("../test/params_test.c", 489, "sneakpeek->p1", "app_p1", sneakpeek->p1, app_p1)
            || !test_double_eq("../test/params_test.c", 490, "sneakpeek->p2", "p2_init", sneakpeek->p2, 6.283)
            || !test_BN_eq("../test/params_test.c", 491, "sneakpeek->p3", "app_p3", sneakpeek->p3, app_p3)
            || !test_str_eq("../test/params_test.c", 492, "sneakpeek->p4", "app_p4", sneakpeek->p4, app_p4)
            || !test_str_eq("../test/params_test.c", 493, "sneakpeek->p5", "app_p5", sneakpeek->p5, app_p5)
            || !test_str_eq("../test/params_test.c", 494, "sneakpeek->p6", "app_p6", sneakpeek->p6, app_p6))
            errcnt++;
    }
    ...
    BN_free(verify_p3);
    verify_p3 = 
# 503 "../test/params_test.c" 3 4
               ((void *)0)
# 503 "../test/params_test.c"
                   ;

    if (!test_true("../test/params_test.c", 505, "BN_hex2bn(&verify_p3, app_p3_init)", (BN_hex2bn(&verify_p3, "deadbeef")) != 0)) {
        errcnt++;
        goto fin;
    }

    if (!test_true("../test/params_test.c", 510, "prov->get_params(obj, params)", (prov->get_params(obj, params)) != 0)
        || !test_int_eq("../test/params_test.c", 511, "app_p1", "app_p1_init", app_p1, 17)
        || !test_double_eq("../test/params_test.c", 512, "app_p2", "app_p2_init", app_p2, 47.11)
        || !test_ptr("../test/params_test.c", 513, "p = OSSL_PARAM_locate(params, \"p3\")", p = OSSL_PARAM_locate(params, "p3"))
        || !test_ptr("../test/params_test.c", 514, "BN_native2bn(bignumbin, p->return_size, app_p3)", BN_native2bn(bignumbin, p->return_size, app_p3))
        || !test_BN_eq("../test/params_test.c", 515, "app_p3", "verify_p3", app_p3, verify_p3)
        || !test_str_eq("../test/params_test.c", 516, "app_p4", "app_p4_init", app_p4, "Hello")
        || !test_ptr("../test/params_test.c", 517, "p = OSSL_PARAM_locate(params, \"p5\")", p = OSSL_PARAM_locate(params, "p5"))
        || !test_size_t_eq("../test/params_test.c", 518, "p->return_size", "sizeof(app_p5_init) - 1", p->return_size, sizeof("World") - 1)

        || !test_str_eq("../test/params_test.c", 520, "app_p5", "app_p5_init", app_p5, "World")
        || !test_ptr("../test/params_test.c", 521, "p = OSSL_PARAM_locate(params, \"p6\")", p = OSSL_PARAM_locate(params, "p6"))
        || !test_size_t_eq("../test/params_test.c", 522, "p->return_size", "sizeof(app_p6_init) - 1", p->return_size, sizeof("Cookie") - 1)

        || !test_str_eq("../test/params_test.c", 524, "app_p6", "app_p6_init", app_p6, "Cookie")
        || !test_char_eq("../test/params_test.c", 525, "foo[0]", "app_foo_init", foo[0], 'z')
        || !test_ptr("../test/params_test.c", 526, "p = OSSL_PARAM_locate(params, \"foo\")", p = OSSL_PARAM_locate(params, "foo")))
        errcnt++;

 fin:
    BN_free(verify_p3);
    verify_p3 = 
# 531 "../test/params_test.c" 3 4
               ((void *)0)
# 531 "../test/params_test.c"
                   ;
    cleanup_app_variables();
    cleanup_object(obj);
...
{
    test_info("../test/params_test.c", 540, "Case: %s", test_cases[i].desc);

    return test_case_variant(test_cases[i].app->static_params,
                             test_cases[i].prov)
        && (test_cases[i].app->constructed_params == 
# 544 "../test/params_test.c" 3 4
                                                    ((void *)0)
            
# 545 "../test/params_test.c"
...
static const OSSL_PARAM params_from_text[] = {
    ...
    { (("int")), (1), ((
# 556 "../test/params_test.c" 3 4
   ((void *)0)
# 556 "../test/params_test.c"
   )), (sizeof(int32_t)), ((size_t)-1) },
    { ("short"), (1), (
# 557 "../test/params_test.c" 3 4
   ((void *)0)
# 557 "../test/params_test.c"
   ), (sizeof(int16_t)), ((size_t)-1) },
    { ("ushort"), (2), (
# 558 "../test/params_test.c" 3 4
   ((void *)0)
# 558 "../test/params_test.c"
   ), (sizeof(uint16_t)), ((size_t)-1) },

    { ("num"), (1), (
# 560 "../test/params_test.c" 3 4
   ((void *)0)
# 560 "../test/params_test.c"
   ), (0), ((size_t)-1) },
    { ("unum"), (2), (
# 561 "../test/params_test.c" 3 4
   ((void *)0)
# 561 "../test/params_test.c"
   ), (0), ((size_t)-1) },
    { ("octets"), (5), (
# 562 "../test/params_test.c" 3 4
   ((void *)0)
# 562 "../test/params_test.c"
   ), (0), ((size_t)-1) },
    { 
# 563 "../test/params_test.c" 3 4
   ((void *)0)
# 563 "../test/params_test.c"
   , 0, 
# 563 "../test/params_test.c" 3 4
   ((void *)0)
# 563 "../test/params_test.c"
...
static struct int_from_text_test_st int_from_text_test_cases[] = {
    ...
    { "int", "0x7fffffff", 
# 584 "../test/params_test.c" 3 4
                               (2147483647)
# 584 "../test/params_test.c"
                                        , 1, 4 },
    { "int", "2147483647", 
# 585 "../test/params_test.c" 3 4
                               (2147483647)
# 585 "../test/params_test.c"
                                        , 1, 4 },
    { "int", "2147483648", 0, 0, 0 },
    { "int", "-2147483648", 
# 587 "../test/params_test.c" 3 4
                               (-2147483647-1)
# 587 "../test/params_test.c"
                                        , 1, 4 },
    { "int", "-2147483649", 0, 0, 4 },
    { "short", "0x7fff", 
# 589 "../test/params_test.c" 3 4
                               (32767)
# 589 "../test/params_test.c"
                                        , 1, 2 },
    { "short", "32767", 
# 590 "../test/params_test.c" 3 4
                               (32767)
# 590 "../test/params_test.c"
                                        , 1, 2 },
    { "short", "32768", 0, 0, 0 },
    { "ushort", "0xffff", 
# 592 "../test/params_test.c" 3 4
                              (65535)
# 592 "../test/params_test.c"
                                        , 1, 2 },
    { "ushort", "65535", 
# 593 "../test/params_test.c" 3 4
                              (65535)
# 593 "../test/params_test.c"
                                        , 1, 2 },
    { "ushort", "65536", 0, 0, 0 },
...
static int check_int_from_text(const struct int_from_text_test_st a)
{
    ...
    if (!OSSL_PARAM_allocate_from_text(&param, params_from_text,
                                       a.argname, a.strval, 0, 
# 623 "../test/params_test.c" 3 4
                                                              ((void *)0)
# 623 "../test/params_test.c"
                                                                  )) {
        if (a.expected_res)
            test_error("../test/params_test.c", 625, "unexpected OSSL_PARAM_allocate_from_text() return for %s \"%s\"", a.argname, a.strval)
                                           ;
    ...
    if (param.data_size == 0) {
        CRYPTO_free(param.data, "../test/params_test.c", 632);
        test_error("../test/params_test.c", 633, "unexpected zero size for %s \"%s\"", a.argname, a.strval)
                                       ;
        return 0;
    }
    res = OSSL_PARAM_get_long(&param, &val);
    CRYPTO_free(param.data, "../test/params_test.c", 638);

    if (res ^ a.expected_res) {
        test_error("../test/params_test.c", 641, "unexpected OSSL_PARAM_get_long() return for %s \"%s\": " "%d != %d", a.argname, a.strval, a.expected_res, res)
                                                                        ;
        return 0;
    }
    if (val != a.expected_intval) {
        test_error("../test/params_test.c", 646, "unexpected result for %s \"%s\":  %li != %li", a.argname, a.strval, a.expected_intval, val)
                                                               ;
        return 0;
    }
    if (param.data_size != a.expected_bufsize) {
        test_error("../test/params_test.c", 651, "unexpected size for %s \"%s\":  %d != %d", a.argname, a.strval, (int)a.expected_bufsize, (int)param.data_size)
...
{
    OSSL_PARAM param;
    static const char *values[] = { "", "F", "FF", "FFF", "FFFF", 
# 663 "../test/params_test.c" 3 4
                                                                 ((void *)0) 
# 663 "../test/params_test.c"
                                                                      };
    int i;
    int errcnt = 0;
    ...
    for (i = 0; values[i] != 
# 668 "../test/params_test.c" 3 4
                            ((void *)0)
# 668 "../test/params_test.c"
                                ; i++) {
        ...
        if (expected)
            result =
                test_true("../test/params_test.c", 676, "OSSL_PARAM_allocate_from_text(&param, params_from_text, \"hexoctets\", values[i], 0, NULL)", (OSSL_PARAM_allocate_from_text(&param, params_from_text, "hexoctets", values[i], 0, 
# 676 "../test/params_test.c" 3 4
               ((void *)0)
# 676 "../test/params_test.c"
               )) != 0)
            ...
            result =
                test_false("../test/params_test.c", 682, "OSSL_PARAM_allocate_from_text(&param, params_from_text, \"hexoctets\", values[i], 0, NULL)", (OSSL_PARAM_allocate_from_text(&param, params_from_text, "hexoctets", values[i], 0, 
# 682 "../test/params_test.c" 3 4
               ((void *)0)
# 682 "../test/params_test.c"
               )) != 0)


                                                               ;
        if (!result) {
            test_error("../test/params_test.c", 687, "unexpected OSSL_PARAM_allocate_from_text() %s for 'octets' \"%s\"", (expected ? "failure" : "success"), values[i])
                                                                     ;
            errcnt++;
        }
        CRYPTO_free(param.data, "../test/params_test.c", 691);
    }
    return errcnt == 0;
}
...
int setup_tests(void)
{
    add_all_tests("test_case", test_case, (sizeof(test_cases)/sizeof((test_cases)[0])), 1);
    add_all_tests("test_allocate_from_text", test_allocate_from_text, (sizeof(int_from_text_test_cases)/sizeof((int_from_text_test_cases)[0])), 1);
