# 0 "../test/sm3_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/sm3_internal_test.c"
# 15 "../test/sm3_internal_test.c"
...
static int test_sm3(void)
{
    ...
    if (!test_true("../test/sm3_internal_test.c", 62, "ossl_sm3_init(&ctx1)", (ossl_sm3_init(&ctx1)) != 0)
            || !test_true("../test/sm3_internal_test.c", 63, "ossl_sm3_update(&ctx1, input1, sizeof(input1))", (ossl_sm3_update(&ctx1, input1, sizeof(input1))) != 0)
            || !test_true("../test/sm3_internal_test.c", 64, "ossl_sm3_final(md1, &ctx1)", (ossl_sm3_final(md1, &ctx1)) != 0)
            || !test_mem_eq("../test/sm3_internal_test.c", 65, "md1", "expected1", md1, 32, expected1, 32))
        return 0;

    if (!test_true("../test/sm3_internal_test.c", 68, "ossl_sm3_init(&ctx2)", (ossl_sm3_init(&ctx2)) != 0)
            || !test_true("../test/sm3_internal_test.c", 69, "ossl_sm3_update(&ctx2, input2, sizeof(input2))", (ossl_sm3_update(&ctx2, input2, sizeof(input2))) != 0)
            || !test_true("../test/sm3_internal_test.c", 70, "ossl_sm3_final(md2, &ctx2)", (ossl_sm3_final(md2, &ctx2)) != 0)
            || !test_mem_eq("../test/sm3_internal_test.c", 71, "md2", "expected2", md2, 32, expected2, 32))
        return 0;
