...
struct stack_st_PKCS12_SAFEBAG; typedef int (*sk_PKCS12_SAFEBAG_compfunc)(const PKCS12_SAFEBAG * const *a, const PKCS12_SAFEBAG *const *b); typedef void (*sk_PKCS12_SAFEBAG_freefunc)(PKCS12_SAFEBAG *a); typedef PKCS12_SAFEBAG * (*sk_PKCS12_SAFEBAG_copyfunc)(const PKCS12_SAFEBAG *a); static __attribute__((unused)) inline PKCS12_SAFEBAG *ossl_check_PKCS12_SAFEBAG_type(PKCS12_SAFEBAG *ptr) { return ptr; } static __attribute__((unused)) inline const OPENSSL_STACK *ossl_check_const_PKCS12_SAFEBAG_sk_type(const struct stack_st_PKCS12_SAFEBAG *sk) { return (const OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_STACK *ossl_check_PKCS12_SAFEBAG_sk_type(struct stack_st_PKCS12_SAFEBAG *sk) { return (OPENSSL_STACK *)sk; } static __attribute__((unused)) inline OPENSSL_sk_compfunc ossl_check_PKCS12_SAFEBAG_compfunc_type(sk_PKCS12_SAFEBAG_compfunc cmp) { return (OPENSSL_sk_compfunc)cmp; } static __attribute__((unused)) inline OPENSSL_sk_copyfunc ossl_check_PKCS12_SAFEBAG_copyfunc_type(sk_PKCS12_SAFEBAG_copyfunc cpy) { return (OPENSSL_sk_copyfunc)cpy; } static __attribute__((unused)) inline OPENSSL_sk_freefunc ossl_check_PKCS12_SAFEBAG_freefunc_type(sk_PKCS12_SAFEBAG_freefunc fr) { return (OPENSSL_sk_freefunc)fr; }
# 93 "include/openssl/pkcs12.h"
typedef struct pkcs12_bag_st PKCS12_BAGS;
# 117 "include/openssl/pkcs12.h"
extern ASN1_TYPE *PKCS12_get_attr(const PKCS12_SAFEBAG *bag,
                                                   int attr_nid);
...
void PKCS12_SAFEBAG_set0_attrs(PKCS12_SAFEBAG *bag, struct stack_st_X509_ATTRIBUTE *attrs);
...
extern PKCS12 *PKCS12_new(void); extern void PKCS12_free(PKCS12 *a); extern PKCS12 *d2i_PKCS12(PKCS12 **a, const unsigned char **in, long len); extern int i2d_PKCS12(const PKCS12 *a, unsigned char **out); extern const ASN1_ITEM * PKCS12_it(void);
extern PKCS12_MAC_DATA *PKCS12_MAC_DATA_new(void); extern void PKCS12_MAC_DATA_free(PKCS12_MAC_DATA *a); extern PKCS12_MAC_DATA *d2i_PKCS12_MAC_DATA(PKCS12_MAC_DATA **a, const unsigned char **in, long len); extern int i2d_PKCS12_MAC_DATA(const PKCS12_MAC_DATA *a, unsigned char **out); extern const ASN1_ITEM * PKCS12_MAC_DATA_it(void);
extern PKCS12_SAFEBAG *PKCS12_SAFEBAG_new(void); extern void PKCS12_SAFEBAG_free(PKCS12_SAFEBAG *a); extern PKCS12_SAFEBAG *d2i_PKCS12_SAFEBAG(PKCS12_SAFEBAG **a, const unsigned char **in, long len); extern int i2d_PKCS12_SAFEBAG(const PKCS12_SAFEBAG *a, unsigned char **out); extern const ASN1_ITEM * PKCS12_SAFEBAG_it(void);
extern PKCS12_BAGS *PKCS12_BAGS_new(void); extern void PKCS12_BAGS_free(PKCS12_BAGS *a); extern PKCS12_BAGS *d2i_PKCS12_BAGS(PKCS12_BAGS **a, const unsigned char **in, long len); extern int i2d_PKCS12_BAGS(const PKCS12_BAGS *a, unsigned char **out); extern const ASN1_ITEM * PKCS12_BAGS_it(void);

extern const ASN1_ITEM * PKCS12_SAFEBAGS_it(void);
extern const ASN1_ITEM * PKCS12_AUTHSAFES_it(void);
...
PKCS12_SAFEBAG *PKCS12_add_secret(struct stack_st_PKCS12_SAFEBAG **pbags,
                                  int nid_type, const unsigned char *value, int len);
int PKCS12_add_safe(struct stack_st_PKCS7 **psafes, struct stack_st_PKCS12_SAFEBAG *bags,
                    int safe_nid, int iter, const char *pass);
int PKCS12_add_safe_ex(struct stack_st_PKCS7 **psafes, struct stack_st_PKCS12_SAFEBAG *bags,
                       int safe_nid, int iter, const char *pass,
                       OSSL_LIB_CTX *ctx, const char *propq);

PKCS12 *PKCS12_add_safes(struct stack_st_PKCS7 *safes, int p7_nid);
PKCS12 *PKCS12_add_safes_ex(struct stack_st_PKCS7 *safes, int p7_nid,
                            OSSL_LIB_CTX *ctx, const char *propq);
...
# 22 "../test/evp_test.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 24 "../test/evp_test.c" 2
# 1 "../include/openssl/fips_names.h" 1
# 12 "../include/openssl/fips_names.h"
        
# 25 "../test/evp_test.c" 2
# 1 "../include/openssl/thread.h" 1
# 17 "../include/openssl/thread.h"
# 1 "../include/openssl/types.h" 1
# 18 "../include/openssl/thread.h" 2
...
# 27 "../test/evp_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 28 "../test/evp_test.c" 2
...
# 30 "../test/evp_test.c" 2

typedef struct evp_test_buffer_st EVP_TEST_BUFFER;
struct stack_st_EVP_TEST_BUFFER; typedef int (*sk_EVP_TEST_BUFFER_compfunc)(const EVP_TEST_BUFFER * const *a, const EVP_TEST_BUFFER *const *b); typedef void (*sk_EVP_TEST_BUFFER_freefunc)(EVP_TEST_BUFFER *a); typedef EVP_TEST_BUFFER * (*sk_EVP_TEST_BUFFER_copyfunc)(const EVP_TEST_BUFFER *a); static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_num(const struct stack_st_EVP_TEST_BUFFER *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_value(const struct stack_st_EVP_TEST_BUFFER *sk, int idx) { return (EVP_TEST_BUFFER *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_new(sk_EVP_TEST_BUFFER_compfunc compare) { return (struct stack_st_EVP_TEST_BUFFER *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_new_null(void) { return (struct stack_st_EVP_TEST_BUFFER *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_new_reserve(sk_EVP_TEST_BUFFER_compfunc compare, int n) { return (struct stack_st_EVP_TEST_BUFFER *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_reserve(struct stack_st_EVP_TEST_BUFFER *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_TEST_BUFFER_free(struct stack_st_EVP_TEST_BUFFER *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_TEST_BUFFER_zero(struct stack_st_EVP_TEST_BUFFER *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_delete(struct stack_st_EVP_TEST_BUFFER *sk, int i) { return (EVP_TEST_BUFFER *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_delete_ptr(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr) { return (EVP_TEST_BUFFER *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_push(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_unshift(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_pop(struct stack_st_EVP_TEST_BUFFER *sk) { return (EVP_TEST_BUFFER *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_shift(struct stack_st_EVP_TEST_BUFFER *sk) { return (EVP_TEST_BUFFER *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_TEST_BUFFER_pop_free(struct stack_st_EVP_TEST_BUFFER *sk, sk_EVP_TEST_BUFFER_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_insert(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_set(struct stack_st_EVP_TEST_BUFFER *sk, int idx, EVP_TEST_BUFFER *ptr) { return (EVP_TEST_BUFFER *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_find(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_find_ex(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_find_all(struct stack_st_EVP_TEST_BUFFER *sk, EVP_TEST_BUFFER *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_TEST_BUFFER_sort(struct stack_st_EVP_TEST_BUFFER *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_TEST_BUFFER_is_sorted(const struct stack_st_EVP_TEST_BUFFER *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_TEST_BUFFER * sk_EVP_TEST_BUFFER_dup(const struct stack_st_EVP_TEST_BUFFER *sk) { return (struct stack_st_EVP_TEST_BUFFER *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_TEST_BUFFER *sk_EVP_TEST_BUFFER_deep_copy(const struct stack_st_EVP_TEST_BUFFER *sk, sk_EVP_TEST_BUFFER_copyfunc copyfunc, sk_EVP_TEST_BUFFER_freefunc freefunc) { return (struct stack_st_EVP_TEST_BUFFER *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_TEST_BUFFER_compfunc sk_EVP_TEST_BUFFER_set_cmp_func(struct stack_st_EVP_TEST_BUFFER *sk, sk_EVP_TEST_BUFFER_compfunc compare) { return (sk_EVP_TEST_BUFFER_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
static OSSL_PROVIDER *prov_null = 
# 81 "../test/evp_test.c" 3 4
                                 ((void *)0)
# 81 "../test/evp_test.c"
                                     ;
static OSSL_PROVIDER *libprov = 
# 82 "../test/evp_test.c" 3 4
                               ((void *)0)
# 82 "../test/evp_test.c"
                                   ;
static OSSL_LIB_CTX *libctx = 
# 83 "../test/evp_test.c" 3 4
                             ((void *)0)
# 83 "../test/evp_test.c"
                                 ;
                              ...
                              const void *got, size_t got_len)
{
    ...
    if (t->expected_err != 
# 109 "../test/evp_test.c" 3 4
                          ((void *)0) 
# 109 "../test/evp_test.c"
                               && strcmp(t->expected_err, err) == 0)
        r = !test_mem_ne("../test/evp_test.c", 110, "expected", "got", expected, expected_len, got, got_len);
    else
        r = test_mem_eq("../test/evp_test.c", 112, "expected", "got", expected, expected_len, got, got_len);
    if (!r)
        t->err = err;
    return r;
}
...
static const char *propquery = 
# 120 "../test/evp_test.c" 3 4
                              ((void *)0)
# 120 "../test/evp_test.c"
                                  ;
...
{
    if (db != 
# 144 "../test/evp_test.c" 3 4
             ((void *)0)
# 144 "../test/evp_test.c"
                 ) {
        CRYPTO_free(db->buf, "../test/evp_test.c", 145);
        CRYPTO_free(db, "../test/evp_test.c", 146);
    }
}


static int evp_test_buffer_append(const char *value,
                                  struct stack_st_EVP_TEST_BUFFER **sk)
{
    EVP_TEST_BUFFER *db = 
# 154 "../test/evp_test.c" 3 4
                         ((void *)0)
# 154 "../test/evp_test.c"
                             ;

    if (!test_ptr("../test/evp_test.c", 156, "db = OPENSSL_malloc(sizeof(*db))", db = CRYPTO_malloc(sizeof(*db), "../test/evp_test.c", 156)))
        goto err;
    ...
    if (*sk == 
# 164 "../test/evp_test.c" 3 4
              ((void *)0) 
# 164 "../test/evp_test.c"
                   && !test_ptr("../test/evp_test.c", 164, "*sk = sk_EVP_TEST_BUFFER_new_null()", *sk = sk_EVP_TEST_BUFFER_new_null()))
        goto err;
                                 ...
                                 struct stack_st_EVP_TEST_BUFFER *sk)
{
    ...
    if (ncopy <= 0)
        return 0;
    if (sk == 
# 188 "../test/evp_test.c" 3 4
             ((void *)0) 
# 188 "../test/evp_test.c"
                  || sk_EVP_TEST_BUFFER_num(sk) == 0)
        return 0;
    db = sk_EVP_TEST_BUFFER_value(sk, sk_EVP_TEST_BUFFER_num(sk) - 1);

    tbuflen = db->buflen * ncopy;
    if (!test_ptr("../test/evp_test.c", 193, "tbuf = OPENSSL_malloc(tbuflen)", tbuf = CRYPTO_malloc(tbuflen, "../test/evp_test.c", 193)))
        return 0;
    for (i = 0, p = tbuf; i < ncopy; i++, p += db->buflen)
        memcpy(p, db->buf, db->buflen);

    CRYPTO_free(db->buf, "../test/evp_test.c", 198);
    db->buf = tbuf;
    db->buflen = tbuflen;
    return 1;
}
...
static int evp_test_buffer_do(struct stack_st_EVP_TEST_BUFFER *sk,
                              int (*fn)(void *ctx,
                               ...
                               size_t *out_len)
{
    ...
    if (input_len == 0) {
        *out_len = 0;
        return CRYPTO_zalloc(1, "../test/evp_test.c", 260);
    }


    if (!test_ptr("../test/evp_test.c", 264, "ret = p = OPENSSL_malloc(input_len)", ret = p = CRYPTO_malloc(input_len, "../test/evp_test.c", 264)))
        return 
# 265 "../test/evp_test.c" 3 4
              ((void *)0)
# 265 "../test/evp_test.c"
                  ;
    ...
    for (i = 0; i < input_len; i++) {
        if (*input == '\\') {
            if (i == input_len - 1 || *++input != 'n') {
                test_error("../test/evp_test.c", 270, "Bad escape sequence in file");
                goto err;
            }
            *p++ = '\n';
            i++;
 ...
 err:
    CRYPTO_free(ret, "../test/evp_test.c", 285);
    return 
# 286 "../test/evp_test.c" 3 4
          ((void *)0)
# 286 "../test/evp_test.c"
              ;
}
...
# 299 "../test/evp_test.c"
    ...
    if (*value == '\0') {
        ...
        *buf = CRYPTO_malloc(1, "../test/evp_test.c", 311);
        if (*buf == 
# 312 "../test/evp_test.c" 3 4
                   ((void *)0)
# 312 "../test/evp_test.c"
                       )
            return 0;
...
# 327 "../test/evp_test.c"
    ...
    if (!test_ptr("../test/evp_test.c", 331, "*buf = OPENSSL_hexstr2buf(value, &len)", *buf = OPENSSL_hexstr2buf(value, &len))) {
        test_info("../test/evp_test.c", 332, "Can't convert %s", value);
        test_openssl_errors();
        return -1;
    }
...
typedef struct digest_data_st {
    ...
    struct stack_st_EVP_TEST_BUFFER *input;
...
static int digest_test_init(EVP_TEST *t, const char *alg)
{
    ...
    if (is_digest_disabled(alg)) {
        test_info("../test/evp_test.c", 369, "skipping, '%s' is disabled", alg);
        t->skip = 1;
        return 1;
    }

    if ((digest = fetched_digest = EVP_MD_fetch(libctx, alg, propquery)) == 
# 374 "../test/evp_test.c" 3 4
                                                                           ((void *)0)
        
# 375 "../test/evp_test.c"
       && (digest = EVP_get_digestbyname(alg)) == 
# 375 "../test/evp_test.c" 3 4
                                                  ((void *)0)
# 375 "../test/evp_test.c"
                                                      )
        return 0;
    if (!test_ptr("../test/evp_test.c", 377, "mdat = OPENSSL_zalloc(sizeof(*mdat))", mdat = CRYPTO_zalloc(sizeof(*mdat), "../test/evp_test.c", 377))) {
    ...
    mdat->xof = 0;
    if (fetched_digest != 
# 386 "../test/evp_test.c" 3 4
                         ((void *)0)
# 386 "../test/evp_test.c"
                             )
        test_info("../test/evp_test.c", 387, "%s is fetched", alg);
    return 1;
}
...
static void digest_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(mdat->output, "../test/evp_test.c", 396);
...
static int test_duplicate_md_ctx(EVP_TEST *t, EVP_MD_CTX *mctx)
{
    ...
    if (!test_ptr("../test/evp_test.c", 438, "mctx", mctx))
        return 0;
    ...
    if (!test_str_eq("../test/evp_test.c", 445, "dont", "\"touch\"", dont, "touch")) {
        EVP_MD_CTX_free(mctx);
        t->err = "DIGESTFINALXOF_ERROR";
        return 0;
    }
...
# 459 "../test/evp_test.c"
    ...
    t->err = "TEST_FAILURE";
    if (!test_ptr("../test/evp_test.c", 466, "mctx = EVP_MD_CTX_new()", mctx = EVP_MD_CTX_new()))
        goto err;

    got = CRYPTO_malloc(expected->output_len > 64 ? expected->output_len : 64, "../test/evp_test.c", 469)
                                                                ;
    if (!test_ptr("../test/evp_test.c", 471, "got", got))
        goto err;

    if (expected->xof > 0) {
        xof |= 1;
        *p++ = OSSL_PARAM_construct_size_t("xoflen",
                                           &expected->output_len);
    }
    if (expected->digest_size > 0) {
        *p++ = OSSL_PARAM_construct_size_t("size",
                                           &expected->digest_size);
    }
    if (expected->pad_type > 0)
        *p++ = OSSL_PARAM_construct_int("pad-type",
                                        &expected->pad_type);
    *p++ = OSSL_PARAM_construct_end();
    ...
    xof |= (EVP_MD_get_flags(expected->digest) & 0x0002) != 0;
    if (xof) {
        EVP_MD_CTX *mctx_cpy;

        if (!test_ptr("../test/evp_test.c", 502, "mctx_cpy = EVP_MD_CTX_new()", mctx_cpy = EVP_MD_CTX_new())) {
            goto err;
        }
        if (!test_true("../test/evp_test.c", 505, "EVP_MD_CTX_copy(mctx_cpy, mctx)", (EVP_MD_CTX_copy(mctx_cpy, mctx)) != 0)) {
    ...
    if (!test_int_eq("../test/evp_test.c", 526, "expected->output_len", "got_len", expected->output_len, got_len)) {
...
# 535 "../test/evp_test.c"
    ...
    if (sk_EVP_TEST_BUFFER_num(expected->input) == 1
            ...
            && !test_ptr("../test/evp_test.c", 541, "inbuf = sk_EVP_TEST_BUFFER_value(expected->input, 0)", inbuf = sk_EVP_TEST_BUFFER_value(expected->input, 0))
            && !inbuf->count_set) {
        OPENSSL_cleanse(got, got_len);
        if (!test_true("../test/evp_test.c", 544, "EVP_Q_digest(libctx, EVP_MD_get0_name(expected->fetched_digest), NULL, inbuf->buf, inbuf->buflen, got, &size)", (EVP_Q_digest(libctx, EVP_MD_get0_name(expected->fetched_digest), 
# 544 "../test/evp_test.c" 3 4
            ((void *)0)
# 544 "../test/evp_test.c"
            , inbuf->buf, inbuf->buflen, got, &size)) != 0)



                || !test_mem_eq("../test/evp_test.c", 548, "got", "expected->output", got, size, expected->output, expected->output_len)
                                                                       ) {
 ...
 err:
    CRYPTO_free(got, "../test/evp_test.c", 556);
    EVP_MD_CTX_free(mctx);
    return 1;
}
...
static int cipher_test_init(EVP_TEST *t, const char *alg)
{
    ...
    if (is_cipher_disabled(alg)) {
        t->skip = 1;
        test_info("../test/evp_test.c", 613, "skipping, '%s' is disabled", alg);
        return 1;
    }

    ERR_set_mark();
    if ((cipher = fetched_cipher = EVP_CIPHER_fetch(libctx, alg, propquery)) == 
# 618 "../test/evp_test.c" 3 4
                                                                               ((void *)0)
        
# 619 "../test/evp_test.c"
       && (cipher = EVP_get_cipherbyname(alg)) == 
# 619 "../test/evp_test.c" 3 4
                                                  ((void *)0)
# 619 "../test/evp_test.c"
                                                      ) {

        if (strstr(alg, "HMAC") != 
# 621 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 621 "../test/evp_test.c"
                                      ) {
            ERR_pop_to_mark();
            t->skip = 1;
            test_info("../test/evp_test.c", 624, "skipping, '%s' is not available", alg);
            return 1;
        }
        ERR_clear_last_mark();
        return 0;
    ...
    if (!test_ptr("../test/evp_test.c", 632, "cdat = OPENSSL_zalloc(sizeof(*cdat))", cdat = CRYPTO_zalloc(sizeof(*cdat), "../test/evp_test.c", 632)))
        return 0;
    ...
    if (EVP_CIPHER_get_flags(cipher) & 0x200000)
        cdat->aead = m != 0 ? m : -1;
    else
        cdat->aead = 0;
    ...
    t->data = cdat;
    if (fetched_cipher != 
# 645 "../test/evp_test.c" 3 4
                         ((void *)0)
# 645 "../test/evp_test.c"
                             )
        test_info("../test/evp_test.c", 646, "%s is fetched", alg);
    return 1;
}
...
static void cipher_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(cdat->key, "../test/evp_test.c", 655);
    CRYPTO_free(cdat->iv, "../test/evp_test.c", 656);
    CRYPTO_free(cdat->next_iv, "../test/evp_test.c", 657);
    CRYPTO_free(cdat->ciphertext, "../test/evp_test.c", 658);
    CRYPTO_free(cdat->plaintext, "../test/evp_test.c", 659);
    for (i = 0; i < 4; i++)
        CRYPTO_free(cdat->aad[i], "../test/evp_test.c", 661);
    CRYPTO_free(cdat->tag, "../test/evp_test.c", 662);
    CRYPTO_free(cdat->mac_key, "../test/evp_test.c", 663);
                           ...
                           size_t inp_misalign, int frag, int in_place)
{
    ...
    unsigned char *in, *expected_out, *tmp = 
# 754 "../test/evp_test.c" 3 4
                                            ((void *)0)
# 754 "../test/evp_test.c"
                                                ;
    size_t in_len, out_len, donelen = 0;
    int ok = 0, tmplen, chunklen, tmpflen, i;
    EVP_CIPHER_CTX *ctx_base = 
# 757 "../test/evp_test.c" 3 4
                              ((void *)0)
# 757 "../test/evp_test.c"
                                  ;
    EVP_CIPHER_CTX *ctx = 
# 758 "../test/evp_test.c" 3 4
                         ((void *)0)
# 758 "../test/evp_test.c"
                             , *duped;
    ...
    t->err = "TEST_FAILURE";
    if (!test_ptr("../test/evp_test.c", 762, "ctx_base = EVP_CIPHER_CTX_new()", ctx_base = EVP_CIPHER_CTX_new()))
        goto err;
    if (!test_ptr("../test/evp_test.c", 764, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;
    EVP_CIPHER_CTX_set_flags(ctx_base, 0x1);
    if (enc) {
    ...
    if (in_place == 1) {
        ...
        tmp = CRYPTO_malloc(out_misalign + in_len + 2 * 32, "../test/evp_test.c", 780);
        if (!tmp)
            goto err;
...
# 794 "../test/evp_test.c"
        tmp = CRYPTO_malloc(out_misalign + in_len + 2 * 32 + inp_misalign + in_len, "../test/evp_test.c", 794)
                                                   ;
        if (!tmp)
            goto err;
        in = memcpy(tmp + out_misalign + in_len + 2 * 32 +
                    inp_misalign, in, in_len);
    }
    if (!EVP_CipherInit_ex(ctx_base, expected->cipher, 
# 801 "../test/evp_test.c" 3 4
                                                      ((void *)0)
# 801 "../test/evp_test.c"
                                                          , 
# 801 "../test/evp_test.c" 3 4
...
# 805 "../test/evp_test.c"
    ...
    if (expected->iv) {
        if (expected->aead) {
            if (EVP_CIPHER_CTX_ctrl(ctx_base, 0x9,
                                     expected->iv_len, 0) <= 0) {
    ...
    if (expected->aead && !expected->tls_aad) {
        ...
        if (enc || expected->aead == 0x10003 || expected->tag_late) {
            t->err = "TAG_LENGTH_SET_ERROR";
            tag = 
# 837 "../test/evp_test.c" 3 4
                 ((void *)0)
# 837 "../test/evp_test.c"
                     ;
        } else {
        ...
        if (tag || expected->aead != 0x6) {
            if (EVP_CIPHER_CTX_ctrl(ctx_base, 0x11,
    ...
    if (expected->rounds > 0) {
        ...
        if (EVP_CIPHER_CTX_ctrl(ctx_base, 0x5, rounds, 
# 852 "../test/evp_test.c" 3 4
                                                                          ((void *)0)
# 852 "../test/evp_test.c"
                                                                              ) <= 0) {
    ...
    if (expected->key_bits > 0) {
        ...
        if (EVP_CIPHER_CTX_ctrl(ctx_base, 0x3, bits, 
# 865 "../test/evp_test.c" 3 4
                                                                          ((void *)0)
# 865 "../test/evp_test.c"
                                                                              ) <= 0) {
    ...
    if (!EVP_CipherInit_ex(ctx_base, 
# 870 "../test/evp_test.c" 3 4
                                    ((void *)0)
# 870 "../test/evp_test.c"
                                        , 
# 870 "../test/evp_test.c" 3 4
...
# 870 "../test/evp_test.c"
    ...
    if (expected->iv != 
# 876 "../test/evp_test.c" 3 4
                       ((void *)0)
# 876 "../test/evp_test.c"
                           ) {

        unsigned char iv[128];
        if (!test_true("../test/evp_test.c", 879, "EVP_CIPHER_CTX_get_updated_iv(ctx_base, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx_base, iv, sizeof(iv))) != 0)
            || ((EVP_CIPHER_get_flags(expected->cipher) & 0x10) == 0
                && !test_mem_eq("../test/evp_test.c", 881, "expected->iv", "iv", expected->iv, expected->iv_len, iv, expected->iv_len)
                                                 )) {
            t->err = "INVALID_IV";
            goto err;
        }
    ...
    if (!EVP_CIPHER_CTX_copy(ctx, ctx_base)) {
        if (fips_dupctx_supported) {
            test_info("../test/evp_test.c", 892, "Doing a copy of Cipher %s Fails!\n", EVP_CIPHER_get0_name(expected->cipher))
                                                             ;
            ERR_print_errors_fp(
# 894 "../test/evp_test.c" 3 4
                               stderr
# 894 "../test/evp_test.c"
                                     );
            goto err;
        } else {
            test_info("../test/evp_test.c", 897, "Allowing copy fail as an old fips provider is in use.");
        }
...
# 907 "../test/evp_test.c"
        ...
        if (fips_dupctx_supported) {
            test_info("../test/evp_test.c", 912, "Doing a dup of Cipher %s Fails!\n", EVP_CIPHER_get0_name(expected->cipher))
                                                             ;
            ERR_print_errors_fp(
# 914 "../test/evp_test.c" 3 4
                               stderr
# 914 "../test/evp_test.c"
                                     );
            goto err;
        } else {
            test_info("../test/evp_test.c", 917, "Allowing dup fail as an old fips provider is in use.");
        }
    }
    ERR_pop_to_mark();

    if (expected->mac_key != 
# 922 "../test/evp_test.c" 3 4
                            ((void *)0)
        
# 923 "../test/evp_test.c"
       && EVP_CIPHER_CTX_ctrl(ctx, 0x17,
    ...
    if (expected->tls_version) {
        ...
        params[0] = OSSL_PARAM_construct_int("tls-version",
    ...
    if (expected->aead == 0x7) {
        if (!EVP_CipherUpdate(ctx, 
# 943 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 943 "../test/evp_test.c"
                                      , &tmplen, 
# 943 "../test/evp_test.c" 3 4
...
# 943 "../test/evp_test.c"
    ...
    if (expected->aad[0] != 
# 948 "../test/evp_test.c" 3 4
                           ((void *)0) 
# 948 "../test/evp_test.c"
                                && !expected->tls_aad) {
        t->err = "AAD_SET_ERROR";
        if (!frag) {
            for (i = 0; expected->aad[i] != 
# 951 "../test/evp_test.c" 3 4
                                           ((void *)0)
# 951 "../test/evp_test.c"
                                               ; i++) {
                if (!EVP_CipherUpdate(ctx, 
# 952 "../test/evp_test.c" 3 4
                                          ((void *)0)
# 952 "../test/evp_test.c"
                                              , &chunklen, expected->aad[i],
                                      expected->aad_len[i]))
                    goto err;
            }
        } else {
            ...
            for (i = 0; expected->aad[i] != 
# 960 "../test/evp_test.c" 3 4
                                           ((void *)0)
# 960 "../test/evp_test.c"
                                               ; i++) {
                if (expected->aad_len[i] > 0) {
                    if (!EVP_CipherUpdate(ctx, 
# 962 "../test/evp_test.c" 3 4
                                              ((void *)0)
# 962 "../test/evp_test.c"
                                                  , &chunklen, expected->aad[i], 1))
                        goto err;
                    donelen++;
                }
                if (expected->aad_len[i] > 2) {
                    if (!EVP_CipherUpdate(ctx, 
# 967 "../test/evp_test.c" 3 4
                                              ((void *)0)
# 967 "../test/evp_test.c"
                                                  , &chunklen,
...
# 974 "../test/evp_test.c"
    ...
    if (expected->tls_aad) {
        ...
        if ((tls_aad = CRYPTO_memdup((expected->aad[0]), expected->aad_len[0], "../test/evp_test.c", 986)
                                                           ) == 
# 987 "../test/evp_test.c" 3 4
                                                               ((void *)0)
# 987 "../test/evp_test.c"
                                                                   )
            goto err;
        params[0] = OSSL_PARAM_construct_octet_string("tlsaad",
                                                      tls_aad,
                                                      expected->aad_len[0]);
        params[1] = OSSL_PARAM_construct_end();
        if (!EVP_CIPHER_CTX_set_params(ctx, params)) {
            CRYPTO_free(tls_aad, "../test/evp_test.c", 994);
            t->err = "TLS1_AAD_ERROR";
            goto err;
        }
        CRYPTO_free(tls_aad, "../test/evp_test.c", 998);
    } else if (!enc && (expected->aead == 0x10003
                        || expected->tag_late)) {
        if (EVP_CIPHER_CTX_ctrl(ctx, 0x11,
...
# 1007 "../test/evp_test.c" 3 4
                                 ((void *)0)
# 1007 "../test/evp_test.c"
                                     ) {
        OSSL_PARAM params[2];

        params[0] =
            OSSL_PARAM_construct_utf8_string("xts_standard",
    ...
    if (!enc && expected->tls_aad) {
        if (expected->tls_version >= 0x0302
    ...
    if (enc && expected->aead && !expected->tls_aad) {
        ...
        if (!test_size_t_le("../test/evp_test.c", 1071, "expected->tag_len", "sizeof(rtag)", expected->tag_len, sizeof(rtag))) {
            t->err = "TAG_LENGTH_INTERNAL_ERROR";
            goto err;
        }
        if (EVP_CIPHER_CTX_ctrl(ctx, 0x10,
    ...
    if (expected->next_iv != 
# 1086 "../test/evp_test.c" 3 4
                            ((void *)0)
# 1086 "../test/evp_test.c"
                                ) {

        unsigned char iv[128];
        if (!test_true("../test/evp_test.c", 1089, "EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))) != 0)
            || ((EVP_CIPHER_get_flags(expected->cipher) & 0x10) == 0
                && !test_mem_eq("../test/evp_test.c", 1091, "expected->next_iv", "iv", expected->next_iv, expected->iv_len, iv, expected->iv_len)
                                                 )) {
    ...
    t->err = 
# 1098 "../test/evp_test.c" 3 4
            ((void *)0)
# 1098 "../test/evp_test.c"
                ;
    ok = 1;
 err:
    CRYPTO_free(tmp, "../test/evp_test.c", 1101);
    if (ctx != ctx_base)
        EVP_CIPHER_CTX_free(ctx_base);
    EVP_CIPHER_CTX_free(ctx);
    return ok;
...
{
    return (cdat->aead == 0x7
            || cdat->aead == 0x2
            || (cdat->aead == -1
                && EVP_CIPHER_get_mode(cdat->cipher) == 0x0)
            || ((EVP_CIPHER_get_flags(cdat->cipher) & 0x4000) != 0)
            || EVP_CIPHER_get_mode(cdat->cipher) == 0x10004
            || EVP_CIPHER_get_mode(cdat->cipher) == 0x10005
            || EVP_CIPHER_get_mode(cdat->cipher) == 0x10001
            || EVP_CIPHER_get_mode(cdat->cipher) == 0x10002) ? 0 : 1;
}
...
static int cipher_test_run(EVP_TEST *t)
{
    ...
    test_info("../test/evp_test.c", 1131, "RUNNING TEST FOR CIPHER %s\n", EVP_CIPHER_get0_name(cdat->cipher));
    if (!cdat->key) {
        t->err = "NO_KEY";
        return 0;
    }
    if (!cdat->iv && EVP_CIPHER_get_iv_length(cdat->cipher) > 0) {
        ...
        if (EVP_CIPHER_get_mode(cdat->cipher) != 0x10002) {
            t->err = "NO_IV";
            return 0;
        }
    }
    if (cdat->aead && cdat->tag == 
# 1143 "../test/evp_test.c" 3 4
                                  ((void *)0) 
# 1143 "../test/evp_test.c"
                                       && !cdat->tls_aad) {
        t->err = "NO_TAG";
        return 0;
    }
    ...
    t->aux_err = 
# 1199 "../test/evp_test.c" 3 4
                ((void *)0)
# 1199 "../test/evp_test.c"
                    ;
...
typedef struct mac_data_st {
    ...
    struct stack_st_OPENSSL_STRING *controls;
...
{
    EVP_MAC *mac = 
# 1255 "../test/evp_test.c" 3 4
                  ((void *)0)
# 1255 "../test/evp_test.c"
                      ;
    int type = 0;
    MAC_DATA *mdat;

    if (is_mac_disabled(alg)) {
        test_info("../test/evp_test.c", 1260, "skipping, '%s' is disabled", alg);
        t->skip = 1;
        return 1;
    }
    if ((mac = EVP_MAC_fetch(libctx, alg, propquery)) == 
# 1264 "../test/evp_test.c" 3 4
                                                        ((void *)0)
# 1264 "../test/evp_test.c"
                                                            ) {
    ...
    if (!test_ptr("../test/evp_test.c", 1289, "mdat = OPENSSL_zalloc(sizeof(*mdat))", mdat = CRYPTO_zalloc(sizeof(*mdat), "../test/evp_test.c", 1289)))
        return 0;

    mdat->type = type;
    if (!test_ptr("../test/evp_test.c", 1293, "mdat->mac_name = OPENSSL_strdup(alg)", mdat->mac_name = CRYPTO_strdup(alg, "../test/evp_test.c", 1293))) {
        CRYPTO_free(mdat, "../test/evp_test.c", 1294);
        return 0;
    }

    mdat->mac = mac;
    if (!test_ptr("../test/evp_test.c", 1299, "mdat->controls = sk_OPENSSL_STRING_new_null()", mdat->controls = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null()))) {
        CRYPTO_free(mdat->mac_name, "../test/evp_test.c", 1300);
        CRYPTO_free(mdat, "../test/evp_test.c", 1301);
        return 0;
    }
...
{
    CRYPTO_free(m, "../test/evp_test.c", 1313);
}
...
static void mac_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(mdat->mac_name, "../test/evp_test.c", 1321);
    OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(mdat->controls),ossl_check_OPENSSL_STRING_freefunc_type(openssl_free));
    CRYPTO_free(mdat->alg, "../test/evp_test.c", 1323);
    CRYPTO_free(mdat->key, "../test/evp_test.c", 1324);
    CRYPTO_free(mdat->iv, "../test/evp_test.c", 1325);
    CRYPTO_free(mdat->custom, "../test/evp_test.c", 1326);
    CRYPTO_free(mdat->salt, "../test/evp_test.c", 1327);
    CRYPTO_free(mdat->input, "../test/evp_test.c", 1328);
    CRYPTO_free(mdat->output, "../test/evp_test.c", 1329);
}
                          ...
                          const char *keyword, const char *value)
{
    ...
    if (strcmp(keyword, "Algorithm") == 0) {
        mdata->alg = CRYPTO_strdup(value, "../test/evp_test.c", 1346);
        if (mdata->alg == 
# 1347 "../test/evp_test.c" 3 4
                         ((void *)0)
# 1347 "../test/evp_test.c"
                             )
            return -1;
        return 1;
    }
    ...
    if (strcmp(keyword, "Ctrl") == 0) {
        char *data = CRYPTO_strdup(value, "../test/evp_test.c", 1360);

        if (data == 
# 1362 "../test/evp_test.c" 3 4
                   ((void *)0)
# 1362 "../test/evp_test.c"
                       )
            return -1;
        return OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(mdata->controls), ossl_check_OPENSSL_STRING_type(data)) != 0;
    }
    if (strcmp(keyword, "OutputSize") == 0) {
                              ...
                              const char *value)
{
    ...
    if (!test_ptr("../test/evp_test.c", 1387, "tmpval = OPENSSL_strdup(value)", tmpval = CRYPTO_strdup(value, "../test/evp_test.c", 1387)))
        return 0;
    p = strchr(tmpval, ':');
    if (p != 
# 1390 "../test/evp_test.c" 3 4
            ((void *)0)
# 1390 "../test/evp_test.c"
                ) {
        *p++ = '\0';
    ...
    if (rv == -2)
        ...
        rv = 1;
    CRYPTO_free(tmpval, "../test/evp_test.c", 1400);
    return rv > 0;
}
...
static int mac_test_run_pkey(EVP_TEST *t)
{
    ...
    EVP_MD_CTX *mctx = 
# 1407 "../test/evp_test.c" 3 4
                      ((void *)0)
# 1407 "../test/evp_test.c"
                          ;
    EVP_PKEY_CTX *pctx = 
# 1408 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1408 "../test/evp_test.c"
                            , *genctx = 
# 1408 "../test/evp_test.c" 3 4
                                        ((void *)0)
# 1408 "../test/evp_test.c"
                                            ;
    EVP_PKEY *key = 
# 1409 "../test/evp_test.c" 3 4
                   ((void *)0)
# 1409 "../test/evp_test.c"
                       ;
    const char *mdname = 
# 1410 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1410 "../test/evp_test.c"
                            ;
    EVP_CIPHER *cipher = 
# 1411 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1411 "../test/evp_test.c"
                            ;
    unsigned char *got = 
# 1412 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1412 "../test/evp_test.c"
                            ;
    size_t got_len;
    int i;
    ...
    if (expected->alg == 
# 1420 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1420 "../test/evp_test.c"
                            )
        test_info("../test/evp_test.c", 1421, "Trying the EVP_PKEY %s test", OBJ_nid2sn(expected->type));
    else
        test_info("../test/evp_test.c", 1423, "Trying the EVP_PKEY %s test with %s", OBJ_nid2sn(expected->type), expected->alg)
                                                            ;

    if (expected->type == 894) {
        ...
        if (expected->alg != 
# 1435 "../test/evp_test.c" 3 4
                            ((void *)0) 
# 1435 "../test/evp_test.c"
                                 && is_cipher_disabled(expected->alg)) {
            test_info("../test/evp_test.c", 1436, "skipping, PKEY CMAC '%s' is disabled", expected->alg);
            t->skip = 1;
            t->err = 
# 1438 "../test/evp_test.c" 3 4
                    ((void *)0)
# 1438 "../test/evp_test.c"
                        ;
            goto err;
        }
        if (!test_ptr("../test/evp_test.c", 1441, "cipher = EVP_CIPHER_fetch(libctx, expected->alg, propquery)", cipher = EVP_CIPHER_fetch(libctx, expected->alg, propquery))) {
            t->err = "MAC_KEY_CREATE_ERROR";
            goto err;
        }
        tmpctx = OSSL_LIB_CTX_set0_default(libctx);
        key = EVP_PKEY_new_CMAC_key(
# 1446 "../test/evp_test.c" 3 4
                                   ((void *)0)
# 1446 "../test/evp_test.c"
...
# 1452 "../test/evp_test.c" 3 4
                                                                         ((void *)0)
# 1452 "../test/evp_test.c"
                                                                             ,
                                              expected->key, expected->key_len);
    }
    if (key == 
# 1455 "../test/evp_test.c" 3 4
              ((void *)0)
# 1455 "../test/evp_test.c"
                  ) {
        t->err = "MAC_KEY_CREATE_ERROR";
        goto err;
    }

    if (expected->type == 855 && expected->alg != 
# 1460 "../test/evp_test.c" 3 4
                                                           ((void *)0)
# 1460 "../test/evp_test.c"
                                                               ) {
        if (is_digest_disabled(expected->alg)) {
            test_info("../test/evp_test.c", 1462, "skipping, HMAC '%s' is disabled", expected->alg);
            t->skip = 1;
            t->err = 
# 1464 "../test/evp_test.c" 3 4
                    ((void *)0)
# 1464 "../test/evp_test.c"
                        ;
            goto err;
        }
        mdname = expected->alg;
    }
    if (!test_ptr("../test/evp_test.c", 1469, "mctx = EVP_MD_CTX_new()", mctx = EVP_MD_CTX_new())) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }
    if (!EVP_DigestSignInit_ex(mctx, &pctx, mdname, libctx, 
# 1473 "../test/evp_test.c" 3 4
                                                           ((void *)0)
# 1473 "../test/evp_test.c"
                                                               , key, 
# 1473 "../test/evp_test.c" 3 4
                                                                      ((void *)0)
# 1473 "../test/evp_test.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(expected->controls)); i++)
        if (!mac_test_ctrl_pkey(t, pctx,
                                ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(expected->controls), (i)))
                                                          )) {
...
# 1488 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 1488 "../test/evp_test.c"
                                      , &got_len)) {
        t->err = "DIGESTSIGNFINAL_LENGTH_ERROR";
        goto err;
    }
    if (!test_ptr("../test/evp_test.c", 1492, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 1492))) {
        t->err = "TEST_FAILURE";
        goto err;
    }
    ...
    t->err = 
# 1503 "../test/evp_test.c" 3 4
            ((void *)0)
# 1503 "../test/evp_test.c"
                ;
 err:
    EVP_CIPHER_free(cipher);
    EVP_MD_CTX_free(mctx);
    CRYPTO_free(got, "../test/evp_test.c", 1507);
...
static int mac_test_run_mac(EVP_TEST *t)
{
    MAC_DATA *expected = t->data;
    EVP_MAC_CTX *ctx = 
# 1516 "../test/evp_test.c" 3 4
                      ((void *)0)
# 1516 "../test/evp_test.c"
                          ;
    unsigned char *got = 
# 1517 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1517 "../test/evp_test.c"
                            ;
    ...
    if (expected->alg == 
# 1529 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1529 "../test/evp_test.c"
                            )
        test_info("../test/evp_test.c", 1530, "Trying the EVP_MAC %s test", expected->mac_name);
    else
        test_info("../test/evp_test.c", 1532, "Trying the EVP_MAC %s test with %s", expected->mac_name, expected->alg)
                                                    ;

    if (expected->alg != 
# 1535 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1535 "../test/evp_test.c"
                            ) {
        int skip = 0;
        ...
        if (OSSL_PARAM_locate_const(defined_params,
                                    "cipher") != 
# 1544 "../test/evp_test.c" 3 4
                                                             ((void *)0)
# 1544 "../test/evp_test.c"
                                                                 ) {
            if (is_cipher_disabled(expected->alg))
                ...
                params[params_n++] =
                    OSSL_PARAM_construct_utf8_string("cipher",
                                           ...
                                           "digest") != 
# 1552 "../test/evp_test.c" 3 4
                                                                    ((void *)0)
# 1552 "../test/evp_test.c"
                                                                        ) {
            if (is_digest_disabled(expected->alg))
                skip = 1;
            else
        ...
        if (skip) {
            test_info("../test/evp_test.c", 1564, "skipping, algorithm '%s' is disabled", expected->alg);
            t->skip = 1;
            t->err = 
# 1566 "../test/evp_test.c" 3 4
                    ((void *)0)
# 1566 "../test/evp_test.c"
                        ;
            goto err;
        }
    }
    if (expected->custom != 
# 1570 "../test/evp_test.c" 3 4
                           ((void *)0)
# 1570 "../test/evp_test.c"
                               )
        params[params_n++] =
            OSSL_PARAM_construct_octet_string("custom",
                                              expected->custom,
                                              expected->custom_len);
    if (expected->salt != 
# 1575 "../test/evp_test.c" 3 4
                         ((void *)0)
# 1575 "../test/evp_test.c"
                             )
        params[params_n++] =
            OSSL_PARAM_construct_octet_string("salt",
                                              ...
                                              expected->salt_len);
    if (expected->iv != 
# 1580 "../test/evp_test.c" 3 4
                       ((void *)0)
# 1580 "../test/evp_test.c"
                           )
        params[params_n++] =
            OSSL_PARAM_construct_octet_string("iv",
                                              expected->iv,
                                              expected->iv_len);


    if (params_n + OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(expected->controls))
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(expected->controls)); i++) {
        char *tmpkey, *tmpval;
        char *value = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(expected->controls), (i)));

        if (!test_ptr("../test/evp_test.c", 1597, "tmpkey = OPENSSL_strdup(value)", tmpkey = CRYPTO_strdup(value, "../test/evp_test.c", 1597))) {
            t->err = "MAC_PARAM_ERROR";
            goto err;
        }
        tmpval = strchr(tmpkey, ':');
        if (tmpval != 
# 1602 "../test/evp_test.c" 3 4
                     ((void *)0)
# 1602 "../test/evp_test.c"
                         )
            *tmpval++ = '\0';

        if (tmpval == 
# 1605 "../test/evp_test.c" 3 4
                     ((void *)0)
            
# 1606 "../test/evp_test.c"
           || !OSSL_PARAM_allocate_from_text(&params[params_n],
                                              defined_params,
                                              tmpkey, tmpval,
                                              strlen(tmpval), 
# 1609 "../test/evp_test.c" 3 4
                                                             ((void *)0)
# 1609 "../test/evp_test.c"
                                                                 )) {
            CRYPTO_free(tmpkey, "../test/evp_test.c", 1610);
            t->err = "MAC_PARAM_ERROR";
            goto err;
        }
        params_n++;
        ...
        if (strcmp(tmpkey, "size") == 0)
            size_val = (size_t)strtoul(tmpval, 
# 1617 "../test/evp_test.c" 3 4
                                              ((void *)0)
# 1617 "../test/evp_test.c"
                                                  , 0);

        CRYPTO_free(tmpkey, "../test/evp_test.c", 1619);
    }
    params[params_n] = OSSL_PARAM_construct_end();

    if ((ctx = EVP_MAC_CTX_new(expected->mac)) == 
# 1623 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 1623 "../test/evp_test.c"
                                                     ) {
    ...
    if (!test_false("../test/evp_test.c", 1634, "size_before_init == 0 && size_after_init == 0", (size_before_init == 0 && size_after_init == 0) != 0)) {
        t->err = "MAC SIZE not set";
        goto err;
    }
    if (size_before_init != 0) {

        if (size_val == 0 && !test_size_t_eq("../test/evp_test.c", 1640, "size_before_init", "size_after_init", size_before_init, size_after_init)) {
            t->err = "MAC SIZE check failed";
            goto err;
        }

        if (size_val != 0 && !test_size_t_eq("../test/evp_test.c", 1645, "size_val", "size_after_init", size_val, size_after_init)) {
            t->err = "MAC SIZE check failed";
            goto err;
        }
    }
    if (expected->output_size >= 0)
        *psizes++ = OSSL_PARAM_construct_int("size",
                                             &output_size);
    if (expected->block_size >= 0)
        *psizes++ = OSSL_PARAM_construct_int("block-size",
                                             &block_size);
    if (psizes != sizes) {
        *psizes = OSSL_PARAM_construct_end();
        if (!test_true("../test/evp_test.c", 1658, "EVP_MAC_CTX_get_params(ctx, sizes)", (EVP_MAC_CTX_get_params(ctx, sizes)) != 0)) {
            t->err = "INTERNAL_ERROR";
            goto err;
        }
        if (expected->output_size >= 0
                && !test_int_eq("../test/evp_test.c", 1663, "output_size", "expected->output_size", output_size, expected->output_size)) {
            t->err = "TEST_FAILURE";
            goto err;
        }
        if (expected->block_size >= 0
                && !test_int_eq("../test/evp_test.c", 1668, "block_size", "expected->block_size", block_size, expected->block_size)) {
            t->err = "TEST_FAILURE";
            goto err;
        }
    }
 retry:
    ...
    xof = expected->xof;
    if (xof) {
        if (!test_ptr("../test/evp_test.c", 1680, "got = OPENSSL_malloc(expected->output_len)", got = CRYPTO_malloc(expected->output_len, "../test/evp_test.c", 1680))) {
            t->err = "TEST_FAILURE";
            goto err;
        }
...
# 1692 "../test/evp_test.c" 3 4
                               ((void *)0)
# 1692 "../test/evp_test.c"
                                   , &got_len, 0)) {
            t->err = "MAC_FINAL_LENGTH_ERROR";
            goto err;
        }
        if (!test_ptr("../test/evp_test.c", 1696, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 1696))) {
            t->err = "TEST_FAILURE";
            goto err;
        }
...
# 1710 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 1710 "../test/evp_test.c"
                                  , 0, 
# 1710 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 1710 "../test/evp_test.c"
...
# 1710 "../test/evp_test.c"
        ...
        if (expected->iv != 
# 1714 "../test/evp_test.c" 3 4
                           ((void *)0)
# 1714 "../test/evp_test.c"
                               ) {
            ivparams[0] =
                OSSL_PARAM_construct_octet_string("iv",
                                                  expected->iv,
...
# 1722 "../test/evp_test.c" 3 4
                               ((void *)0)
# 1722 "../test/evp_test.c"
                                   , 0, ivparams);
        if (expected->no_reinit) {
            ...
            ERR_clear_last_mark();
            CRYPTO_free(got, "../test/evp_test.c", 1731);
            got = 
# 1732 "../test/evp_test.c" 3 4
                 ((void *)0)
# 1732 "../test/evp_test.c"
                     ;
            goto retry;
        } else {
            ERR_clear_last_mark();
    ...
    t->err = 
# 1742 "../test/evp_test.c" 3 4
            ((void *)0)
# 1742 "../test/evp_test.c"
                ;


    if (!xof) {
        OPENSSL_cleanse(got, got_len);
        if (!test_true("../test/evp_test.c", 1747, "EVP_Q_mac(libctx, expected->mac_name, NULL, expected->alg, params, expected->key, expected->key_len, expected->input, expected->input_len, got, got_len, &size)", (EVP_Q_mac(libctx, expected->mac_name, 
# 1747 "../test/evp_test.c" 3 4
            ((void *)0)
# 1747 "../test/evp_test.c"
            , expected->alg, params, expected->key, expected->key_len, expected->input, expected->input_len, got, got_len, &size)) != 0)




                || !test_mem_eq("../test/evp_test.c", 1752, "got", "expected->output", got, size, expected->output, expected->output_len)
                                                                       ) {
 ...
 err:
    while (params_n-- > params_n_allocstart) {
        CRYPTO_free(params[params_n].data, "../test/evp_test.c", 1760);
    }
    EVP_MAC_CTX_free(ctx);
    CRYPTO_free(got, "../test/evp_test.c", 1763);
    return 1;
}
...
static int mac_test_run(EVP_TEST *t)
{
    ...
    if (expected->mac != 
# 1771 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1771 "../test/evp_test.c"
                            )
                                       ...
                                       size_t tbslen))
{
    PKEY_DATA *kdata;
    EVP_PKEY *pkey = 
# 1818 "../test/evp_test.c" 3 4
                    ((void *)0)
# 1818 "../test/evp_test.c"
                        ;
    int rv = 0;
    ...
    if (rv == 0 || pkey == 
# 1825 "../test/evp_test.c" 3 4
                          ((void *)0)
# 1825 "../test/evp_test.c"
                              ) {
        test_info("../test/evp_test.c", 1826, "skipping, key '%s' is disabled", name);
        t->skip = 1;
        return 1;
    }

    if (!test_ptr("../test/evp_test.c", 1831, "kdata = OPENSSL_zalloc(sizeof(*kdata))", kdata = CRYPTO_zalloc(sizeof(*kdata), "../test/evp_test.c", 1831))) {
        EVP_PKEY_free(pkey);
        return 0;
    }
    kdata->keyop = keyop;
    if (!test_ptr("../test/evp_test.c", 1836, "kdata->ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey, propquery)", kdata->ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey, propquery))) {
        EVP_PKEY_free(pkey);
        CRYPTO_free(kdata, "../test/evp_test.c", 1838);
        return 0;
    }
...
static void pkey_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(kdata->input, "../test/evp_test.c", 1851);
    CRYPTO_free(kdata->output, "../test/evp_test.c", 1852);
                          ...
                          const char *value)
{
    ...
    if (!test_ptr("../test/evp_test.c", 1862, "tmpval = OPENSSL_strdup(value)", tmpval = CRYPTO_strdup(value, "../test/evp_test.c", 1862)))
        return 0;
    p = strchr(tmpval, ':');
    if (p != 
# 1865 "../test/evp_test.c" 3 4
            ((void *)0)
# 1865 "../test/evp_test.c"
                ) {
        *p++ = '\0';
        rv = EVP_PKEY_CTX_ctrl_str(pctx, tmpval, p);
    }
...
# 1872 "../test/evp_test.c" 3 4
                   ((void *)0) 
# 1872 "../test/evp_test.c"
                        && rv <= 0) {
        if (is_digest_disabled(p) || is_cipher_disabled(p)) {
            test_info("../test/evp_test.c", 1874, "skipping, '%s' is disabled", p);
            t->skip = 1;
            rv = 1;
        } else {
            t->err = "PKEY_CTRL_ERROR";
    ...
    CRYPTO_free(tmpval, "../test/evp_test.c", 1882);
    return rv > 0;
}
...
static int pkey_test_run(EVP_TEST *t)
{
    ...
    unsigned char *got = 
# 1902 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1902 "../test/evp_test.c"
                            ;
    size_t got_len;
    EVP_PKEY_CTX *copy = 
# 1904 "../test/evp_test.c" 3 4
                        ((void *)0)
# 1904 "../test/evp_test.c"
                            ;

    if (expected->keyop(expected->ctx, 
# 1906 "../test/evp_test.c" 3 4
                                      ((void *)0)
# 1906 "../test/evp_test.c"
                                          , &got_len,
                        expected->input, expected->input_len) <= 0
            || !test_ptr("../test/evp_test.c", 1908, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 1908))) {
    ...
    t->err = 
# 1922 "../test/evp_test.c" 3 4
            ((void *)0)
# 1922 "../test/evp_test.c"
                ;
    CRYPTO_free(got, "../test/evp_test.c", 1923);
    got = 
# 1924 "../test/evp_test.c" 3 4
         ((void *)0)
# 1924 "../test/evp_test.c"
             ;


    if (!test_ptr("../test/evp_test.c", 1927, "copy = EVP_PKEY_CTX_dup(expected->ctx)", copy = EVP_PKEY_CTX_dup(expected->ctx))) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }
    if (expected->keyop(copy, 
# 1931 "../test/evp_test.c" 3 4
                             ((void *)0)
# 1931 "../test/evp_test.c"
                                 , &got_len, expected->input,
                        expected->input_len) <= 0
            || !test_ptr("../test/evp_test.c", 1933, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 1933))) {
        t->err = "KEYOP_LENGTH_ERROR";
        goto err;
    }
 ...
 err:
    CRYPTO_free(got, "../test/evp_test.c", 1948);
                              ...
                              const char *keyword, const char *value)
{
    ...
    if (validate || strcmp(keyword, "PeerKey") == 0) {
        ...
        t->err = 
# 2039 "../test/evp_test.c" 3 4
                ((void *)0)
# 2039 "../test/evp_test.c"
                    ;
        return 1;
    }
    ...
    if (strcmp(keyword, "KDFType") == 0) {
        ...
        params[0] = OSSL_PARAM_construct_utf8_string("kdf-type",
                                                     (char *)value, 0);
        params[1] = OSSL_PARAM_construct_end();
    ...
    if (strcmp(keyword, "KDFDigest") == 0) {
        ...
        params[0] = OSSL_PARAM_construct_utf8_string("kdf-digest",
                                                     (char *)value, 0);
        params[1] = OSSL_PARAM_construct_end();
        if (EVP_PKEY_CTX_set_params(kdata->ctx, params) == 0)
            return -1;
    ...
    if (strcmp(keyword, "CEKAlg") == 0) {
        ...
        params[0] = OSSL_PARAM_construct_utf8_string("cekalg",
                                                     (char *)value, 0);
        params[1] = OSSL_PARAM_construct_end();
        if (EVP_PKEY_CTX_set_params(kdata->ctx, params) == 0)
            return -1;
    ...
    if (strcmp(keyword, "KDFOutlen") == 0) {
        ...
        params[0] = OSSL_PARAM_construct_size_t("kdf-outlen",
                                                &outlen);
        params[1] = OSSL_PARAM_construct_end();
        if (EVP_PKEY_CTX_set_params(kdata->ctx, params) == 0)
            return -1;
...
{
    EVP_PKEY_CTX *dctx = 
# 2096 "../test/evp_test.c" 3 4
                        ((void *)0)
# 2096 "../test/evp_test.c"
                            ;
    PKEY_DATA *expected = t->data;
    unsigned char *got = 
# 2098 "../test/evp_test.c" 3 4
                        ((void *)0)
# 2098 "../test/evp_test.c"
                            ;
    size_t got_len;

    if (!test_ptr("../test/evp_test.c", 2101, "dctx = EVP_PKEY_CTX_dup(expected->ctx)", dctx = EVP_PKEY_CTX_dup(expected->ctx))) {
        t->err = "DERIVE_ERROR";
        goto err;
    }

    if (EVP_PKEY_derive(dctx, 
# 2106 "../test/evp_test.c" 3 4
                             ((void *)0)
# 2106 "../test/evp_test.c"
                                 , &got_len) <= 0
        || !test_size_t_ne("../test/evp_test.c", 2107, "got_len", "0", got_len, 0)) {
        t->err = "DERIVE_ERROR";
        goto err;
    }
    if (!test_ptr("../test/evp_test.c", 2111, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 2111))) {
        t->err = "DERIVE_ERROR";
        goto err;
    }
    ...
    t->err = 
# 2124 "../test/evp_test.c" 3 4
            ((void *)0)
# 2124 "../test/evp_test.c"
                ;
 err:
    CRYPTO_free(got, "../test/evp_test.c", 2126);
...
static int parse_uint64(const char *value, uint64_t *pr)
{
    ...
    if (!test_true("../test/evp_test.c", 2173, "*p", (*p) != 0)) {
        test_info("../test/evp_test.c", 2174, "Invalid empty integer value");
        return -1;
    }
    for (*pr = 0; *p; ) {
        if (*pr > 
# 2178 "../test/evp_test.c" 3 4
                 (18446744073709551615UL) 
# 2178 "../test/evp_test.c"
                            / 10) {
            test_error("../test/evp_test.c", 2179, "Integer overflow in string %s", value);
            return -1;
        }
        *pr *= 10;
        if (!test_true("../test/evp_test.c", 2183, "isdigit((unsigned char)*p)", (
# 2183 "../test/evp_test.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 2183 "../test/evp_test.c"
            (unsigned char)*p
# 2183 "../test/evp_test.c" 3 4
            ))] & (unsigned short int) _ISdigit)
# 2183 "../test/evp_test.c"
            ) != 0)) {
            test_error("../test/evp_test.c", 2184, "Invalid character in string %s", value);
            return -1;
        }
        *pr += *p - '0';
        p++;
                             ...
                             const char *keyword, const char *value)
{
    ...
    if (strcmp(keyword, "MD") == 0) {
        ...
        if (pdata->md == 
# 2223 "../test/evp_test.c" 3 4
                        ((void *)0)
# 2223 "../test/evp_test.c"
                            )
            return -1;
        return 1;
    }
...
static int pbe_test_init(EVP_TEST *t, const char *alg)
{
    ...
    if (is_kdf_disabled(alg)) {
        test_info("../test/evp_test.c", 2250, "skipping, '%s' is disabled", alg);
        t->skip = 1;
        return 1;
    }
    if (strcmp(alg, "scrypt") == 0) {
        ...
        test_error("../test/evp_test.c", 2261, "Unknown pbe algorithm %s", alg);
        return 0;
    }
    if (!test_ptr("../test/evp_test.c", 2264, "pdat = OPENSSL_zalloc(sizeof(*pdat))", pdat = CRYPTO_zalloc(sizeof(*pdat), "../test/evp_test.c", 2264)))
        return 0;
...
static void pbe_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(pdat->pass, "../test/evp_test.c", 2275);
    CRYPTO_free(pdat->salt, "../test/evp_test.c", 2276);
    CRYPTO_free(pdat->key, "../test/evp_test.c", 2277);
}
...
static int pbe_test_run(EVP_TEST *t)
{
    ...
    unsigned char *key;
    EVP_MD *fetched_digest = 
# 2306 "../test/evp_test.c" 3 4
                            ((void *)0)
# 2306 "../test/evp_test.c"
                                ;
    OSSL_LIB_CTX *save_libctx;

    save_libctx = OSSL_LIB_CTX_set0_default(libctx);

    if (!test_ptr("../test/evp_test.c", 2311, "key = OPENSSL_malloc(expected->key_len)", key = CRYPTO_malloc(expected->key_len, "../test/evp_test.c", 2311))) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }
    if (expected->pbe_type == PBE_TYPE_PBKDF2) {
        ...
        fetched_digest = EVP_MD_fetch(libctx, EVP_MD_get0_name(expected->md),
                                      propquery);
        if (fetched_digest == 
# 2336 "../test/evp_test.c" 3 4
                             ((void *)0)
# 2336 "../test/evp_test.c"
                                 ) {
            t->err = "PKCS12_ERROR";
            goto err;
        }
    ...
    t->err = 
# 2352 "../test/evp_test.c" 3 4
            ((void *)0)
# 2352 "../test/evp_test.c"
                ;
err:
    EVP_MD_free(fetched_digest);
    CRYPTO_free(key, "../test/evp_test.c", 2355);
...
static int encode_test_init(EVP_TEST *t, const char *encoding)
{
    ...
    if (!test_ptr("../test/evp_test.c", 2393, "edata = OPENSSL_zalloc(sizeof(*edata))", edata = CRYPTO_zalloc(sizeof(*edata), "../test/evp_test.c", 2393)))
        return 0;
    if (strcmp(encoding, "canonical") == 0) {
        ...
        if (!test_ptr("../test/evp_test.c", 2401, "t->expected_err = OPENSSL_strdup(\"DECODE_ERROR\")", t->expected_err = CRYPTO_strdup("DECODE_ERROR", "../test/evp_test.c", 2401)))
            goto err;
    } else {
        test_error("../test/evp_test.c", 2404, "Bad encoding: %s." " Should be one of {canonical, valid, invalid}", encoding)
    ...
    return 1;
err:
    CRYPTO_free(edata, "../test/evp_test.c", 2412);
    return 0;
}
...
static void encode_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(edata->input, "../test/evp_test.c", 2420);
    CRYPTO_free(edata->output, "../test/evp_test.c", 2421);
...
# 2440 "../test/evp_test.c" 3 4
                               ((void *)0)
# 2440 "../test/evp_test.c"
                                   , *decode_out = 
# 2440 "../test/evp_test.c" 3 4
                                                   ((void *)0)
# 2440 "../test/evp_test.c"
...
# 2442 "../test/evp_test.c" 3 4
                                ((void *)0)
# 2442 "../test/evp_test.c"
                                    , *encode_ctx = 
# 2442 "../test/evp_test.c" 3 4
                                                    ((void *)0)
# 2442 "../test/evp_test.c"
    ...
    if (!test_ptr("../test/evp_test.c", 2444, "decode_ctx = EVP_ENCODE_CTX_new()", decode_ctx = EVP_ENCODE_CTX_new())) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }
    ...
    if (expected->encoding == BASE64_CANONICAL_ENCODING) {
        ...
        if (!test_ptr("../test/evp_test.c", 2451, "encode_ctx = EVP_ENCODE_CTX_new()", encode_ctx = EVP_ENCODE_CTX_new())
                || !test_ptr("../test/evp_test.c", 2452, "encode_out = OPENSSL_malloc(EVP_ENCODE_LENGTH(expected->input_len))", encode_out = CRYPTO_malloc(((((expected->input_len)+2)/3*4)+((expected->input_len)/48+1)*2+80), "../test/evp_test.c", 2453))
                                                                               )
            goto err;

        EVP_EncodeInit(encode_ctx);
        if (!test_true("../test/evp_test.c", 2457, "EVP_EncodeUpdate(encode_ctx, encode_out, &chunk_len, expected->input, expected->input_len)", (EVP_EncodeUpdate(encode_ctx, encode_out, &chunk_len, expected->input, expected->input_len)) != 0)
                                                                              )
            goto err;
    ...
    if (!test_ptr("../test/evp_test.c", 2472, "decode_out = OPENSSL_malloc(EVP_DECODE_LENGTH(expected->output_len))", decode_out = CRYPTO_malloc((((expected->output_len)+3)/4*3+80), "../test/evp_test.c", 2473))
                                                                        )
        goto err;
    ...
    t->err = 
# 2498 "../test/evp_test.c" 3 4
            ((void *)0)
# 2498 "../test/evp_test.c"
                ;
 err:
    CRYPTO_free(encode_out, "../test/evp_test.c", 2500);
    CRYPTO_free(decode_out, "../test/evp_test.c", 2501);
...
static int rand_test_init(EVP_TEST *t, const char *name)
{
    ...
    EVP_RAND *rand;
    OSSL_PARAM params[2] = { { 
# 2556 "../test/evp_test.c" 3 4
                            ((void *)0)
# 2556 "../test/evp_test.c"
                            , 0, 
# 2556 "../test/evp_test.c" 3 4
                            ((void *)0)
# 2556 "../test/evp_test.c"
...
# 2556 "../test/evp_test.c"
    ...
    if (!test_ptr("../test/evp_test.c", 2559, "rdata = OPENSSL_zalloc(sizeof(*rdata))", rdata = CRYPTO_zalloc(sizeof(*rdata), "../test/evp_test.c", 2559)))
        return 0;


    rand = EVP_RAND_fetch(libctx, "TEST-RAND", "-fips");
    if (rand == 
# 2564 "../test/evp_test.c" 3 4
               ((void *)0)
# 2564 "../test/evp_test.c"
                   )
        goto err;
    rdata->parent = EVP_RAND_CTX_new(rand, 
# 2566 "../test/evp_test.c" 3 4
                                          ((void *)0)
# 2566 "../test/evp_test.c"
                                              );
    EVP_RAND_free(rand);
    if (rdata->parent == 
# 2568 "../test/evp_test.c" 3 4
                        ((void *)0)
# 2568 "../test/evp_test.c"
                            )
        goto err;

    *params = OSSL_PARAM_construct_uint("strength", &strength);
    if (!EVP_RAND_CTX_set_params(rdata->parent, params))
        goto err;

    rand = EVP_RAND_fetch(libctx, name, propquery);
    if (rand == 
# 2576 "../test/evp_test.c" 3 4
               ((void *)0)
# 2576 "../test/evp_test.c"
                   )
        goto err;
    rdata->ctx = EVP_RAND_CTX_new(rand, rdata->parent);
    EVP_RAND_free(rand);
    if (rdata->ctx == 
# 2580 "../test/evp_test.c" 3 4
                     ((void *)0)
# 2580 "../test/evp_test.c"
                         )
        goto err;
 ...
 err:
    ...
    CRYPTO_free(rdata, "../test/evp_test.c", 2588);
    return 0;
}
...
static void rand_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(rdata->cipher, "../test/evp_test.c", 2597);
    CRYPTO_free(rdata->digest, "../test/evp_test.c", 2598);

    for (i = 0; i <= rdata->n; i++) {
        CRYPTO_free(rdata->data[i].entropy, "../test/evp_test.c", 2601);
        CRYPTO_free(rdata->data[i].reseed_entropy, "../test/evp_test.c", 2602);
        CRYPTO_free(rdata->data[i].nonce, "../test/evp_test.c", 2603);
        CRYPTO_free(rdata->data[i].pers, "../test/evp_test.c", 2604);
        CRYPTO_free(rdata->data[i].reseed_addin, "../test/evp_test.c", 2605);
        CRYPTO_free(rdata->data[i].addinA, "../test/evp_test.c", 2606);
        CRYPTO_free(rdata->data[i].addinB, "../test/evp_test.c", 2607);
        CRYPTO_free(rdata->data[i].pr_entropyA, "../test/evp_test.c", 2608);
        CRYPTO_free(rdata->data[i].pr_entropyB, "../test/evp_test.c", 2609);
        CRYPTO_free(rdata->data[i].output, "../test/evp_test.c", 2610);
    }
                          ...
                          const char *keyword, const char *value)
{
    ...
    if ((p = strchr(keyword, '.')) != 
# 2624 "../test/evp_test.c" 3 4
                                     ((void *)0)
# 2624 "../test/evp_test.c"
                                         ) {
        n = atoi(++p);
        if (n >= 15)
            return 0;
        if (n > rdata->n)
            rdata->n = n;
        item = rdata->data + n;
        if ((strncmp(keyword, "Entropy." "", sizeof("Entropy.") - 1) == 0))
            return parse_bin(value, &item->entropy, &item->entropy_len);
        if ((strncmp(keyword, "ReseedEntropy." "", sizeof("ReseedEntropy.") - 1) == 0))
            return parse_bin(value, &item->reseed_entropy,
                             &item->reseed_entropy_len);
        if ((strncmp(keyword, "Nonce." "", sizeof("Nonce.") - 1) == 0))
            return parse_bin(value, &item->nonce, &item->nonce_len);
        if ((strncmp(keyword, "PersonalisationString." "", sizeof("PersonalisationString.") - 1) == 0))
            return parse_bin(value, &item->pers, &item->pers_len);
        if ((strncmp(keyword, "ReseedAdditionalInput." "", sizeof("ReseedAdditionalInput.") - 1) == 0))
            return parse_bin(value, &item->reseed_addin,
                             &item->reseed_addin_len);
        if ((strncmp(keyword, "AdditionalInputA." "", sizeof("AdditionalInputA.") - 1) == 0))
            return parse_bin(value, &item->addinA, &item->addinA_len);
        if ((strncmp(keyword, "AdditionalInputB." "", sizeof("AdditionalInputB.") - 1) == 0))
            return parse_bin(value, &item->addinB, &item->addinB_len);
        if ((strncmp(keyword, "EntropyPredictionResistanceA." "", sizeof("EntropyPredictionResistanceA.") - 1) == 0))
            return parse_bin(value, &item->pr_entropyA, &item->pr_entropyA_len);
        if ((strncmp(keyword, "EntropyPredictionResistanceB." "", sizeof("EntropyPredictionResistanceB.") - 1) == 0))
            return parse_bin(value, &item->pr_entropyB, &item->pr_entropyB_len);
        if ((strncmp(keyword, "Output." "", sizeof("Output.") - 1) == 0))
            return parse_bin(value, &item->output, &item->output_len);
    } else {
        if (strcmp(keyword, "Cipher") == 0)
            return test_ptr("../test/evp_test.c", 2655, "rdata->cipher = OPENSSL_strdup(value)", rdata->cipher = CRYPTO_strdup(value, "../test/evp_test.c", 2655));
        if (strcmp(keyword, "Digest") == 0)
            return test_ptr("../test/evp_test.c", 2657, "rdata->digest = OPENSSL_strdup(value)", rdata->digest = CRYPTO_strdup(value, "../test/evp_test.c", 2657));
...
static int rand_test_run(EVP_TEST *t)
{
    ...
    if (!test_ptr("../test/evp_test.c", 2687, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 2687)))
        return 0;

    *p++ = OSSL_PARAM_construct_int("use_derivation_function", &expected->use_df);
    if (expected->cipher != 
# 2691 "../test/evp_test.c" 3 4
                           ((void *)0)
# 2691 "../test/evp_test.c"
                               )
        *p++ = OSSL_PARAM_construct_utf8_string("cipher",
                                                expected->cipher, 0);
    if (expected->digest != 
# 2694 "../test/evp_test.c" 3 4
                           ((void *)0)
# 2694 "../test/evp_test.c"
                               )
        *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                                expected->digest, 0);
    *p++ = OSSL_PARAM_construct_utf8_string("mac", "HMAC", 0);
    *p = OSSL_PARAM_construct_end();
    if (!test_true("../test/evp_test.c", 2699, "EVP_RAND_CTX_set_params(expected->ctx, params)", (EVP_RAND_CTX_set_params(expected->ctx, params)) != 0))
        goto err;
    ...
    for (i = 0; i <= expected->n; i++) {
        ...
        p = params;
        z = item->entropy != 
# 2707 "../test/evp_test.c" 3 4
                            ((void *)0) 
# 2707 "../test/evp_test.c"
                                 ? item->entropy : (unsigned char *)"";
        *p++ = OSSL_PARAM_construct_octet_string("test_entropy",
                                                 z, item->entropy_len);
        z = item->nonce != 
# 2710 "../test/evp_test.c" 3 4
                          ((void *)0) 
# 2710 "../test/evp_test.c"
                               ? item->nonce : (unsigned char *)"";
        *p++ = OSSL_PARAM_construct_octet_string("test_nonce",
                                                 z, item->nonce_len);
        *p = OSSL_PARAM_construct_end();
        if (!test_true("../test/evp_test.c", 2714, "EVP_RAND_instantiate(expected->parent, strength, 0, NULL, 0, params)", (EVP_RAND_instantiate(expected->parent, strength, 0, 
# 2714 "../test/evp_test.c" 3 4
            ((void *)0)
# 2714 "../test/evp_test.c"
            , 0, params)) != 0)
                                                                )
            goto err;

        z = item->pers != 
# 2718 "../test/evp_test.c" 3 4
                         ((void *)0) 
# 2718 "../test/evp_test.c"
                              ? item->pers : (unsigned char *)"";
        if (!test_true("../test/evp_test.c", 2719, "EVP_RAND_instantiate (expected->ctx, strength, expected->prediction_resistance, z, item->pers_len, NULL)", (EVP_RAND_instantiate (expected->ctx, strength, expected->prediction_resistance, z, item->pers_len, 
# 2719 "../test/evp_test.c" 3 4
            ((void *)0)
# 2719 "../test/evp_test.c"
            )) != 0)
...
# 2725 "../test/evp_test.c" 3 4
                                   ((void *)0)
# 2725 "../test/evp_test.c"
                                       ) {
            params[0] = OSSL_PARAM_construct_octet_string
                           ("test_entropy", item->reseed_entropy,
                            item->reseed_entropy_len);
            params[1] = OSSL_PARAM_construct_end();
            if (!test_true("../test/evp_test.c", 2730, "EVP_RAND_CTX_set_params(expected->parent, params)", (EVP_RAND_CTX_set_params(expected->parent, params)) != 0))
                goto err;

            if (!test_true("../test/evp_test.c", 2733, "EVP_RAND_reseed (expected->ctx, expected->prediction_resistance, NULL, 0, item->reseed_addin, item->reseed_addin_len)", (EVP_RAND_reseed (expected->ctx, expected->prediction_resistance, 
# 2733 "../test/evp_test.c" 3 4
                ((void *)0)
# 2733 "../test/evp_test.c"
                , 0, item->reseed_addin, item->reseed_addin_len)) != 0)
        ...
        if (item->pr_entropyA != 
# 2739 "../test/evp_test.c" 3 4
                                ((void *)0)
# 2739 "../test/evp_test.c"
                                    ) {
            params[0] = OSSL_PARAM_construct_octet_string
                           ("test_entropy", item->pr_entropyA,
                            item->pr_entropyA_len);
            params[1] = OSSL_PARAM_construct_end();
            if (!test_true("../test/evp_test.c", 2744, "EVP_RAND_CTX_set_params(expected->parent, params)", (EVP_RAND_CTX_set_params(expected->parent, params)) != 0))
                goto err;
        }
        if (!test_true("../test/evp_test.c", 2747, "EVP_RAND_generate (expected->ctx, got, got_len, strength, expected->prediction_resistance, item->addinA, item->addinA_len)", (EVP_RAND_generate (expected->ctx, got, got_len, strength, expected->prediction_resistance, item->addinA, item->addinA_len)) != 0)
        ...
        if (item->pr_entropyB != 
# 2753 "../test/evp_test.c" 3 4
                                ((void *)0)
# 2753 "../test/evp_test.c"
                                    ) {
            params[0] = OSSL_PARAM_construct_octet_string
                           ("test_entropy", item->pr_entropyB,
                            item->pr_entropyB_len);
            params[1] = OSSL_PARAM_construct_end();
            if (!test_true("../test/evp_test.c", 2758, "EVP_RAND_CTX_set_params(expected->parent, params)", (EVP_RAND_CTX_set_params(expected->parent, params)) != 0))
                goto err;
        }
        if (!test_true("../test/evp_test.c", 2761, "EVP_RAND_generate (expected->ctx, got, got_len, strength, expected->prediction_resistance, item->addinB, item->addinB_len)", (EVP_RAND_generate (expected->ctx, got, got_len, strength, expected->prediction_resistance, item->addinB, item->addinB_len)) != 0)


                                                            )
            goto err;
        if (!test_mem_eq("../test/evp_test.c", 2766, "got", "item->output", got, got_len, item->output, item->output_len))
            goto err;
        if (!test_true("../test/evp_test.c", 2768, "EVP_RAND_uninstantiate(expected->ctx)", (EVP_RAND_uninstantiate(expected->ctx)) != 0)
                || !test_true("../test/evp_test.c", 2769, "EVP_RAND_uninstantiate(expected->parent)", (EVP_RAND_uninstantiate(expected->parent)) != 0)
                || !test_true("../test/evp_test.c", 2770, "EVP_RAND_verify_zeroization(expected->ctx)", (EVP_RAND_verify_zeroization(expected->ctx)) != 0)
                || !test_int_eq("../test/evp_test.c", 2771, "EVP_RAND_get_state(expected->ctx)", "EVP_RAND_STATE_UNINITIALISED", EVP_RAND_get_state(expected->ctx), 0)
                                                             )
            goto err;
    }
    t->err = 
# 2775 "../test/evp_test.c" 3 4
            ((void *)0)
# 2775 "../test/evp_test.c"
                ;
    ret = 1;

 err:
    if (ret == 0 && i >= 0)
        test_info("../test/evp_test.c", 2780, "Error in test case %d of %d\n", i, expected->n + 1);
    CRYPTO_free(got, "../test/evp_test.c", 2781);
    return ret;
}
...
static int kdf_test_init(EVP_TEST *t, const char *name)
{
    ...
    if (is_kdf_disabled(name)) {
        test_info("../test/evp_test.c", 2817, "skipping, '%s' is disabled", name);
        t->skip = 1;
        return 1;
    }

    if (!test_ptr("../test/evp_test.c", 2822, "kdata = OPENSSL_zalloc(sizeof(*kdata))", kdata = CRYPTO_zalloc(sizeof(*kdata), "../test/evp_test.c", 2822)))
        return 0;
    ...
    *kdata->p = OSSL_PARAM_construct_end();
    ...
    if (kdf == 
# 2828 "../test/evp_test.c" 3 4
              ((void *)0)
# 2828 "../test/evp_test.c"
                  ) {
        CRYPTO_free(kdata, "../test/evp_test.c", 2829);
        return 0;
    }
    kdata->ctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kdata->ctx == 
# 2834 "../test/evp_test.c" 3 4
                     ((void *)0)
# 2834 "../test/evp_test.c"
                         ) {
        CRYPTO_free(kdata, "../test/evp_test.c", 2835);
        return 0;
    }
    t->data = kdata;
    return 1;
...
static void kdf_test_cleanup(EVP_TEST *t)
{
    ...
    for (p = kdata->params; p->key != 
# 2847 "../test/evp_test.c" 3 4
                                     ((void *)0)
# 2847 "../test/evp_test.c"
                                         ; p++)
        CRYPTO_free(p->data, "../test/evp_test.c", 2848);
    CRYPTO_free(kdata->output, "../test/evp_test.c", 2849);
                         ...
                         const char *value)
{
    ...
    if (!test_ptr("../test/evp_test.c", 2861, "name = OPENSSL_strdup(value)", name = CRYPTO_strdup(value, "../test/evp_test.c", 2861)))
        return 0;
    p = strchr(name, ':');
    if (p == 
# 2864 "../test/evp_test.c" 3 4
            ((void *)0)
# 2864 "../test/evp_test.c"
                )
        p = "";
    else
        *p++ = '\0';
    ...
    if (strcmp(name, "r") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2870 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2870 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2871, "skipping, setting 'r' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "lanes") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2877 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2877 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2878, "skipping, setting 'lanes' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "iter") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2884 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2884 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2885, "skipping, setting 'iter' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "memcost") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2891 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2891 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2892, "skipping, setting 'memcost' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "secret") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2898 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2898 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2899, "skipping, setting 'secret' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "pass") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2905 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2905 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2906, "skipping, setting 'pass' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    if (strcmp(name, "ad") == 0
        && OSSL_PARAM_locate_const(defs, name) == 
# 2912 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2912 "../test/evp_test.c"
                                                     ) {
        test_info("../test/evp_test.c", 2913, "skipping, setting 'ad' is unsupported");
        t->skip = 1;
        goto end;
    }
    ...
    rv = OSSL_PARAM_allocate_from_text(kdata->p, defs, name, p,
                                       strlen(p), 
# 2919 "../test/evp_test.c" 3 4
                                                 ((void *)0)
# 2919 "../test/evp_test.c"
                                                     );
    *++kdata->p = OSSL_PARAM_construct_end();
    if (!rv) {
        t->err = "KDF_PARAM_ERROR";
        CRYPTO_free(name, "../test/evp_test.c", 2923);
        return 0;
    }
    if (strcmp(name, "digest") == 0) {
        if (is_digest_disabled(p)) {
            test_info("../test/evp_test.c", 2928, "skipping, '%s' is disabled", p);
            t->skip = 1;
        }
        goto end;
    }
    ...
    if ((strcmp(name, "cipher") == 0
        ...
        test_info("../test/evp_test.c", 2937, "skipping, '%s' is disabled", p);
        t->skip = 1;
        goto end;
    }
    if ((strcmp(name, "mac") == 0)
        && is_mac_disabled(p)) {
        test_info("../test/evp_test.c", 2943, "skipping, '%s' is disabled", p);
        t->skip = 1;
    }
 end:
    CRYPTO_free(name, "../test/evp_test.c", 2947);
    return 1;
}
                          ...
                          const char *keyword, const char *value)
{
    ...
    if (strcmp(keyword, "Output") == 0)
        return parse_bin(value, &kdata->output, &kdata->output_len);
    if ((strncmp(keyword, "Ctrl" "", sizeof("Ctrl") - 1) == 0))
...
static int kdf_test_run(EVP_TEST *t)
{
    ...
    unsigned char *got = 
# 2966 "../test/evp_test.c" 3 4
                        ((void *)0)
# 2966 "../test/evp_test.c"
                            ;
    ...
    if (!test_ptr("../test/evp_test.c", 2974, "got = OPENSSL_malloc(got_len == 0 ? 1 : got_len)", got = CRYPTO_malloc(got_len == 0 ? 1 : got_len, "../test/evp_test.c", 2974))) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }

    if (fips_provider_version_gt(libctx, 3, 0, 0)
            && (ctx = EVP_KDF_CTX_dup(expected->ctx)) != 
# 2980 "../test/evp_test.c" 3 4
                                                        ((void *)0)
# 2980 "../test/evp_test.c"
                                                            ) {
        EVP_KDF_CTX_free(expected->ctx);
        expected->ctx = ctx;
    }
    if (EVP_KDF_derive(expected->ctx, got, got_len, 
# 2984 "../test/evp_test.c" 3 4
                                                   ((void *)0)
# 2984 "../test/evp_test.c"
                                                       ) <= 0) {
    ...
    t->err = 
# 2993 "../test/evp_test.c" 3 4
            ((void *)0)
# 2993 "../test/evp_test.c"
                ;

 err:
    CRYPTO_free(got, "../test/evp_test.c", 2996);
    return 1;
}
...
{
    PKEY_KDF_DATA *kdata = 
# 3026 "../test/evp_test.c" 3 4
                          ((void *)0)
# 3026 "../test/evp_test.c"
                              ;

    if (is_kdf_disabled(name)) {
        test_info("../test/evp_test.c", 3029, "skipping, '%s' is disabled", name);
        t->skip = 1;
        return 1;
    }

    if (!test_ptr("../test/evp_test.c", 3034, "kdata = OPENSSL_zalloc(sizeof(*kdata))", kdata = CRYPTO_zalloc(sizeof(*kdata), "../test/evp_test.c", 3034)))
        return 0;

    kdata->ctx = EVP_PKEY_CTX_new_from_name(libctx, name, propquery);
    if (kdata->ctx == 
# 3038 "../test/evp_test.c" 3 4
                     ((void *)0)
        
# 3039 "../test/evp_test.c"
...
err:
    EVP_PKEY_CTX_free(kdata->ctx);
    CRYPTO_free(kdata, "../test/evp_test.c", 3046);
    return 0;
}
...
static void pkey_kdf_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(kdata->output, "../test/evp_test.c", 3054);
    EVP_PKEY_CTX_free(kdata->ctx);
}
...
static int pkey_kdf_test_run(EVP_TEST *t)
{
    ...
    unsigned char *got = 
# 3073 "../test/evp_test.c" 3 4
                        ((void *)0)
# 3073 "../test/evp_test.c"
                            ;
    size_t got_len = 0;
    ...
    if (fips_provider_version_eq(libctx, 3, 0, 0)) {
        ...
        if (EVP_PKEY_derive(expected->ctx, 
# 3081 "../test/evp_test.c" 3 4
                                          ((void *)0)
# 3081 "../test/evp_test.c"
                                              , &got_len) <= 0) {
            t->err = "INTERNAL_ERROR";
            goto err;
        }
        ...
        if (got_len == 
# 3091 "../test/evp_test.c" 3 4
                      (18446744073709551615UL) 
# 3091 "../test/evp_test.c"
                               || got_len == 0)
            got_len = expected->output_len;
        else
    ...
    if (!test_ptr("../test/evp_test.c", 3097, "got = OPENSSL_malloc(got_len == 0 ? 1 : got_len)", got = CRYPTO_malloc(got_len == 0 ? 1 : got_len, "../test/evp_test.c", 3097))) {
        t->err = "INTERNAL_ERROR";
        goto err;
    }
    ...
    if (!test_mem_eq("../test/evp_test.c", 3105, "expected->output", "got", expected->output, expected->output_len, got, got_len)) {
        t->err = "KDF_MISMATCH";
        goto err;
    }
    t->err = 
# 3109 "../test/evp_test.c" 3 4
            ((void *)0)
# 3109 "../test/evp_test.c"
                ;

 err:
    CRYPTO_free(got, "../test/evp_test.c", 3112);
    return 1;
}
...
static int keypair_test_init(EVP_TEST *t, const char *pair)
{
    ...
    int rv = 0;
    EVP_PKEY *pk = 
# 3137 "../test/evp_test.c" 3 4
                  ((void *)0)
# 3137 "../test/evp_test.c"
                      , *pubk = 
# 3137 "../test/evp_test.c" 3 4
                                ((void *)0)
# 3137 "../test/evp_test.c"
                                    ;
    char *pub, *priv = 
# 3138 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3138 "../test/evp_test.c"
                          ;


    if (!test_ptr("../test/evp_test.c", 3141, "priv = OPENSSL_strdup(pair)", priv = CRYPTO_strdup(pair, "../test/evp_test.c", 3141))
            || !test_ptr("../test/evp_test.c", 3142, "pub = strchr(priv, ':')", pub = strchr(priv, ':'))) {
        t->err = "PARSING_ERROR";
        goto end;
    }
    *pub++ = '\0';

    if (!test_true("../test/evp_test.c", 3148, "find_key(&pk, priv, private_keys)", (find_key(&pk, priv, private_keys)) != 0)) {
        test_info("../test/evp_test.c", 3149, "Can't find private key: %s", priv);
        t->err = "MISSING_PRIVATE_KEY";
        goto end;
    }
    if (!test_true("../test/evp_test.c", 3153, "find_key(&pubk, pub, public_keys)", (find_key(&pubk, pub, public_keys)) != 0)) {
        test_info("../test/evp_test.c", 3154, "Can't find public key: %s", pub);
        t->err = "MISSING_PUBLIC_KEY";
        goto end;
    }

    if (pk == 
# 3159 "../test/evp_test.c" 3 4
             ((void *)0) 
# 3159 "../test/evp_test.c"
                  && pubk == 
# 3159 "../test/evp_test.c" 3 4
                             ((void *)0)
# 3159 "../test/evp_test.c"
    ...
    if (!test_ptr("../test/evp_test.c", 3166, "data = OPENSSL_malloc(sizeof(*data))", data = CRYPTO_malloc(sizeof(*data), "../test/evp_test.c", 3166)))
        goto end;
    data->privk = pk;
    data->pubk = pubk;
    t->data = data;
    rv = 1;
    t->err = 
# 3172 "../test/evp_test.c" 3 4
            ((void *)0)
# 3172 "../test/evp_test.c"
                ;

end:
    CRYPTO_free(priv, "../test/evp_test.c", 3175);
    return rv;
}

static void keypair_test_cleanup(EVP_TEST *t)
{
    CRYPTO_free(t->data, "../test/evp_test.c", 3181);
    t->data = 
# 3182 "../test/evp_test.c" 3 4
             ((void *)0)
# 3182 "../test/evp_test.c"
                 ;
}
...
static int keypair_test_run(EVP_TEST *t)
{
    ...
    if (pair->privk == 
# 3198 "../test/evp_test.c" 3 4
                      ((void *)0) 
# 3198 "../test/evp_test.c"
                           || pair->pubk == 
# 3198 "../test/evp_test.c" 3 4
                                            ((void *)0)
# 3198 "../test/evp_test.c"
    ...
    if ((rv = EVP_PKEY_eq(pair->privk, pair->pubk)) != 1) {
        if (0 == rv) {
            ...
            test_error("../test/evp_test.c", 3217, "Unexpected error in key comparison");
            rv = 0;
            goto end;
        }
        rv = 1;
    ...
    rv = 1;
    t->err = 
# 3226 "../test/evp_test.c" 3 4
            ((void *)0)
# 3226 "../test/evp_test.c"
                ;
...
static int keygen_test_init(EVP_TEST *t, const char *alg)
{
    ...
    if (!test_ptr("../test/evp_test.c", 3265, "genctx = EVP_PKEY_CTX_new_from_name(libctx, alg, propquery)", genctx = EVP_PKEY_CTX_new_from_name(libctx, alg, propquery)))
        goto err;
    ...
    if (!test_ptr("../test/evp_test.c", 3273, "data = OPENSSL_malloc(sizeof(*data))", data = CRYPTO_malloc(sizeof(*data), "../test/evp_test.c", 3273)))
        goto err;
    data->genctx = genctx;
    data->keyname = 
# 3276 "../test/evp_test.c" 3 4
                   ((void *)0)
# 3276 "../test/evp_test.c"
                       ;
    t->data = data;
    t->err = 
# 3278 "../test/evp_test.c" 3 4
            ((void *)0)
# 3278 "../test/evp_test.c"
                ;
    return 1;
...
static void keygen_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(keygen->keyname, "../test/evp_test.c", 3291);
    CRYPTO_free(t->data, "../test/evp_test.c", 3292);
    t->data = 
# 3293 "../test/evp_test.c" 3 4
             ((void *)0)
# 3293 "../test/evp_test.c"
                 ;
}
                             ...
                             const char *keyword, const char *value)
{
    ...
    if (strcmp(keyword, "KeyName") == 0)
        return test_ptr("../test/evp_test.c", 3302, "keygen->keyname = OPENSSL_strdup(value)", keygen->keyname = CRYPTO_strdup(value, "../test/evp_test.c", 3302));
    if (strcmp(keyword, "Ctrl") == 0)
...
static int keygen_test_run(EVP_TEST *t)
{
    KEYGEN_TEST_DATA *keygen = t->data;
    EVP_PKEY *pkey = 
# 3311 "../test/evp_test.c" 3 4
                    ((void *)0)
# 3311 "../test/evp_test.c"
                        ;
    int rv = 1;
    ...
    if (!((pkey)->keymgmt != 
# 3319 "../test/evp_test.c" 3 4
        ((void *)0)
# 3319 "../test/evp_test.c"
        )) {
        test_info("../test/evp_test.c", 3320, "Warning: legacy key generated %s", keygen->keyname);
        goto err;
    }
    if (keygen->keyname != 
# 3323 "../test/evp_test.c" 3 4
                          ((void *)0)
# 3323 "../test/evp_test.c"
                              ) {
        KEY_LIST *key;

        rv = 0;
        if (find_key(
# 3327 "../test/evp_test.c" 3 4
                    ((void *)0)
# 3327 "../test/evp_test.c"
                        , keygen->keyname, private_keys)) {
            test_info("../test/evp_test.c", 3328, "Duplicate key %s", keygen->keyname);
            goto err;
        }

        if (!test_ptr("../test/evp_test.c", 3332, "key = OPENSSL_malloc(sizeof(*key))", key = CRYPTO_malloc(sizeof(*key), "../test/evp_test.c", 3332)))
            goto err;
        key->name = keygen->keyname;
        keygen->keyname = 
# 3335 "../test/evp_test.c" 3 4
                         ((void *)0)
# 3335 "../test/evp_test.c"
                             ;
        key->key = pkey;
    ...
    t->err = 
# 3344 "../test/evp_test.c" 3 4
            ((void *)0)
# 3344 "../test/evp_test.c"
                ;
...
{
    const EVP_MD *md = 
# 3379 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3379 "../test/evp_test.c"
                          ;
    ...
    if (strcmp(alg, "NULL") != 0) {
        ...
        if (md == 
# 3388 "../test/evp_test.c" 3 4
                 ((void *)0)
# 3388 "../test/evp_test.c"
                     )
            return 0;
    }
    if (!test_ptr("../test/evp_test.c", 3391, "mdat = OPENSSL_zalloc(sizeof(*mdat))", mdat = CRYPTO_zalloc(sizeof(*mdat), "../test/evp_test.c", 3391)))
        return 0;
    mdat->md = md;
    if (!test_ptr("../test/evp_test.c", 3394, "mdat->ctx = EVP_MD_CTX_new()", mdat->ctx = EVP_MD_CTX_new())) {
        CRYPTO_free(mdat, "../test/evp_test.c", 3395);
        return 0;
    }
...
static void digestsigver_test_cleanup(EVP_TEST *t)
{
    ...
    CRYPTO_free(mdata->osin, "../test/evp_test.c", 3415);
    CRYPTO_free(mdata->output, "../test/evp_test.c", 3416);
    CRYPTO_free(mdata, "../test/evp_test.c", 3417);
    t->data = 
# 3418 "../test/evp_test.c" 3 4
             ((void *)0)
# 3418 "../test/evp_test.c"
                 ;
}
                                   ...
                                   const char *keyword, const char *value)
{
    ...
    if (strcmp(keyword, "Key") == 0) {
        EVP_PKEY *pkey = 
# 3427 "../test/evp_test.c" 3 4
                        ((void *)0)
# 3427 "../test/evp_test.c"
                            ;
        int rv = 0;
        const char *name = mdata->md == 
# 3429 "../test/evp_test.c" 3 4
                                       ((void *)0) 
# 3429 "../test/evp_test.c"
                                            ? 
# 3429 "../test/evp_test.c" 3 4
                                              ((void *)0) 
# 3429 "../test/evp_test.c"
                                                   : EVP_MD_get0_name(mdata->md);
        ...
        if (rv == 0 || pkey == 
# 3435 "../test/evp_test.c" 3 4
                              ((void *)0)
# 3435 "../test/evp_test.c"
                                  ) {
            t->skip = 1;
            return 1;
        }
...
# 3441 "../test/evp_test.c" 3 4
                                        ((void *)0)
# 3441 "../test/evp_test.c"
                                            , pkey, 
# 3441 "../test/evp_test.c" 3 4
                                                    ((void *)0)
# 3441 "../test/evp_test.c"
        ...
        if (!EVP_DigestSignInit_ex(mdata->ctx, &mdata->pctx, name, libctx, 
# 3445 "../test/evp_test.c" 3 4
                                                                          ((void *)0)
# 3445 "../test/evp_test.c"
                                                                              ,
                                   pkey, 
# 3446 "../test/evp_test.c" 3 4
                                        ((void *)0)
# 3446 "../test/evp_test.c"
                                            ))
            t->err = "DIGESTSIGNINIT_ERROR";
        return 1;
    }
    ...
    if (strcmp(keyword, "Ctrl") == 0) {
        if (mdata->pctx == 
# 3466 "../test/evp_test.c" 3 4
                          ((void *)0)
# 3466 "../test/evp_test.c"
                              )
            return -1;
    ...
    if (strcmp(keyword, "NonceType") == 0) {
        if (strcmp(value, "deterministic") == 0) {
            ...
            params[0] =
                OSSL_PARAM_construct_uint("nonce-type",
                                          &nonce_type);
            params[1] = OSSL_PARAM_construct_end();
...
static int digestsign_test_run(EVP_TEST *t)
{
    ...
    unsigned char *got = 
# 3502 "../test/evp_test.c" 3 4
                        ((void *)0)
# 3502 "../test/evp_test.c"
                            ;
    size_t got_len;
    ...
    if (!EVP_DigestSignFinal(expected->ctx, 
# 3511 "../test/evp_test.c" 3 4
                                           ((void *)0)
# 3511 "../test/evp_test.c"
                                               , &got_len)) {
        t->err = "DIGESTSIGNFINAL_LENGTH_ERROR";
        goto err;
    }
    if (!test_ptr("../test/evp_test.c", 3515, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 3515))) {
    ...
    t->err = 
# 3529 "../test/evp_test.c" 3 4
            ((void *)0)
# 3529 "../test/evp_test.c"
                ;
 err:
    CRYPTO_free(got, "../test/evp_test.c", 3531);
    return 1;
}
...
static int oneshot_digestsign_test_run(EVP_TEST *t)
{
    DIGESTSIGN_DATA *expected = t->data;
    unsigned char *got = 
# 3585 "../test/evp_test.c" 3 4
                        ((void *)0)
# 3585 "../test/evp_test.c"
                            ;
    size_t got_len;

    if (!EVP_DigestSign(expected->ctx, 
# 3588 "../test/evp_test.c" 3 4
                                      ((void *)0)
# 3588 "../test/evp_test.c"
                                          , &got_len,
                        expected->osin, expected->osin_len)) {
        t->err = "DIGESTSIGN_LENGTH_ERROR";
        goto err;
    }
    if (!test_ptr("../test/evp_test.c", 3593, "got = OPENSSL_malloc(got_len)", got = CRYPTO_malloc(got_len, "../test/evp_test.c", 3593))) {
        t->err = "MALLOC_FAILURE";
        goto err;
    }
    got_len *= 2;
    ...
    t->err = 
# 3608 "../test/evp_test.c" 3 4
            ((void *)0)
# 3608 "../test/evp_test.c"
                ;
 err:
    CRYPTO_free(got, "../test/evp_test.c", 3610);
    return 1;
}
...
# 3670 "../test/evp_test.c" 3 4
   ((void *)0)

# 3671 "../test/evp_test.c"
};
...
static const EVP_TEST_METHOD *find_test(const char *name)
{
    ...
    return 
# 3681 "../test/evp_test.c" 3 4
          ((void *)0)
# 3681 "../test/evp_test.c"
              ;
}
...
static void clear_test(EVP_TEST *t)
{
    ...
    ERR_clear_error();
    if (t->data != 
# 3688 "../test/evp_test.c" 3 4
                  ((void *)0)
# 3688 "../test/evp_test.c"
                      ) {
        if (t->meth != 
# 3689 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3689 "../test/evp_test.c"
                          )
            t->meth->cleanup(t);
        CRYPTO_free(t->data, "../test/evp_test.c", 3691);
        t->data = 
# 3692 "../test/evp_test.c" 3 4
                 ((void *)0)
# 3692 "../test/evp_test.c"
                     ;
    }
    CRYPTO_free(t->expected_err, "../test/evp_test.c", 3694);
    t->expected_err = 
# 3695 "../test/evp_test.c" 3 4
                     ((void *)0)
# 3695 "../test/evp_test.c"
                         ;
    CRYPTO_free(t->reason, "../test/evp_test.c", 3696);
    t->reason = 
# 3697 "../test/evp_test.c" 3 4
               ((void *)0)
# 3697 "../test/evp_test.c"
                   ;


    t->err = 
# 3700 "../test/evp_test.c" 3 4
            ((void *)0)
# 3700 "../test/evp_test.c"
                ;
    t->skip = 0;
    t->meth = 
# 3702 "../test/evp_test.c" 3 4
             ((void *)0)
# 3702 "../test/evp_test.c"
                 ;
...
static int check_test_error(EVP_TEST *t)
{
    ...
    if (t->err == 
# 3715 "../test/evp_test.c" 3 4
                 ((void *)0) 
# 3715 "../test/evp_test.c"
                      && t->expected_err == 
# 3715 "../test/evp_test.c" 3 4
                                            ((void *)0)
# 3715 "../test/evp_test.c"
        ...
        return 1;
    if (t->err != 
# 3717 "../test/evp_test.c" 3 4
                 ((void *)0) 
# 3717 "../test/evp_test.c"
                      && t->expected_err == 
# 3717 "../test/evp_test.c" 3 4
                                            ((void *)0)
# 3717 "../test/evp_test.c"
        ...
        if (t->aux_err != 
# 3718 "../test/evp_test.c" 3 4
                         ((void *)0)
# 3718 "../test/evp_test.c"
                             ) {
            test_info("../test/evp_test.c", 3719, "%s:%d: Source of above error (%s); unexpected error %s", t->s.test_file, t->s.start, t->aux_err, t->err)
                                                                     ;
        } else {
            test_info("../test/evp_test.c", 3722, "%s:%d: Source of above error; unexpected error %s", t->s.test_file, t->s.start, t->err)
                                                         ;
        }
        return 0;
    }
    if (t->err == 
# 3727 "../test/evp_test.c" 3 4
                 ((void *)0) 
# 3727 "../test/evp_test.c"
                      && t->expected_err != 
# 3727 "../test/evp_test.c" 3 4
                                            ((void *)0)
# 3727 "../test/evp_test.c"
                                                ) {
        test_info("../test/evp_test.c", 3728, "%s:%d: Succeeded but was expecting %s", t->s.test_file, t->s.start, t->expected_err)
                                                              ;
        return 0;
    }

    if (strcmp(t->err, t->expected_err) != 0) {
        test_info("../test/evp_test.c", 3734, "%s:%d: Expected %s got %s", t->s.test_file, t->s.start, t->expected_err, t->err)
                                                                      ;
        return 0;
    }

    if (t->reason == 
# 3739 "../test/evp_test.c" 3 4
                    ((void *)0)
# 3739 "../test/evp_test.c"
                        )
        return 1;

    if (t->reason == 
# 3742 "../test/evp_test.c" 3 4
                    ((void *)0)
# 3742 "../test/evp_test.c"
                        ) {
        test_info("../test/evp_test.c", 3743, "%s:%d: Test is missing function or reason code", t->s.test_file, t->s.start)
                                             ;
        return 0;
    }
    ...
    err = ERR_peek_error();
    if (err == 0) {
        test_info("../test/evp_test.c", 3750, "%s:%d: Expected error \"%s\" not set", t->s.test_file, t->s.start, t->reason)
                                                        ;
        return 0;
    }
    ...
    if (reason == 
# 3756 "../test/evp_test.c" 3 4
                 ((void *)0)
# 3756 "../test/evp_test.c"
                     ) {
        test_info("../test/evp_test.c", 3757, "%s:%d: Expected error \"%s\", no strings available." " Assuming ok.", t->s.test_file, t->s.start, t->reason)
    ...
    test_info("../test/evp_test.c", 3766, "%s:%d: Expected error \"%s\", got \"%s\"", t->s.test_file, t->s.start, t->reason, reason)
                                                            ;
...
{
    if (t->meth == 
# 3775 "../test/evp_test.c" 3 4
                  ((void *)0)
# 3775 "../test/evp_test.c"
                      )
        return 1;
    t->s.numtests++;
    if (t->skip) {
        ...
        if (t->err == 
# 3782 "../test/evp_test.c" 3 4
                     ((void *)0) 
# 3782 "../test/evp_test.c"
                          && t->meth->run_test(t) != 1) {
            test_info("../test/evp_test.c", 3783, "%s:%d %s error", t->s.test_file, t->s.start, t->meth->name)
                                                                ;
            return 0;
        }
...
{
    for (; lst != 
# 3799 "../test/evp_test.c" 3 4
                 ((void *)0)
# 3799 "../test/evp_test.c"
                     ; lst = lst->next) {
        if (strcmp(lst->name, name) == 0) {
            if (ppk != 
# 3801 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3801 "../test/evp_test.c"
                          )
                *ppk = lst->key;
            return 1;
        }
...
{
    while (lst != 
# 3811 "../test/evp_test.c" 3 4
                 ((void *)0)
# 3811 "../test/evp_test.c"
                     ) {
        KEY_LIST *next = lst->next;

        EVP_PKEY_free(lst->key);
        CRYPTO_free(lst->name, "../test/evp_test.c", 3815);
        CRYPTO_free(lst, "../test/evp_test.c", 3816);
        lst = next;
    }
}
...
static char *take_value(PAIR *pp)
{
    ...
    pp->value = 
# 3857 "../test/evp_test.c" 3 4
               ((void *)0)
# 3857 "../test/evp_test.c"
                   ;
    return p;
}
# 3895 "../test/evp_test.c"
static int prov_available(char *providers)
{
    ...
    while (more) {
        for (; 
# 3901 "../test/evp_test.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 3901 "../test/evp_test.c"
              (unsigned char)(*providers)
# 3901 "../test/evp_test.c" 3 4
...
# 3901 "../test/evp_test.c"
        ...
        if (*providers == '\0')
            break;
        for (p = providers; *p != '\0' && !
# 3905 "../test/evp_test.c" 3 4
                                          ((*__ctype_b_loc ())[(int) ((
# 3905 "../test/evp_test.c"
                                          (unsigned char)(*p)
# 3905 "../test/evp_test.c" 3 4
                                          ))] & (unsigned short int) _ISspace)
# 3905 "../test/evp_test.c"
...
top:
    do {
        if ((int)BIO_ctrl(t->s.fp,2,0,
# 3927 "../test/evp_test.c" 3 4
           ((void *)0)
# 3927 "../test/evp_test.c"
           ))
            return 
# 3928 "../test/evp_test.c" 3 4
                  (-1)
# 3928 "../test/evp_test.c"
                     ;
        clear_test(t);
    ...
    klist = 
# 3936 "../test/evp_test.c" 3 4
           ((void *)0)
# 3936 "../test/evp_test.c"
               ;
    pkey = 
# 3937 "../test/evp_test.c" 3 4
          ((void *)0)
# 3937 "../test/evp_test.c"
              ;
start:
    if (strcmp(pp->key, "PrivateKey") == 0) {
        pkey = PEM_read_bio_PrivateKey_ex(t->s.key, 
# 3940 "../test/evp_test.c" 3 4
                                                   ((void *)0)
# 3940 "../test/evp_test.c"
                                                       , 0, 
# 3940 "../test/evp_test.c" 3 4
                                                            ((void *)0)
# 3940 "../test/evp_test.c"
...
# 3940 "../test/evp_test.c"
        ...
        if (pkey == 
# 3941 "../test/evp_test.c" 3 4
                   ((void *)0) 
# 3941 "../test/evp_test.c"
                        && !key_unsupported()) {
            EVP_PKEY_free(pkey);
            test_info("../test/evp_test.c", 3943, "Can't read private key %s", pp->value);
            test_openssl_errors();
            return 0;
        }
        klist = &private_keys;
    } else if (strcmp(pp->key, "PublicKey") == 0) {
        pkey = PEM_read_bio_PUBKEY_ex(t->s.key, 
# 3949 "../test/evp_test.c" 3 4
                                               ((void *)0)
# 3949 "../test/evp_test.c"
                                                   , 0, 
# 3949 "../test/evp_test.c" 3 4
                                                        ((void *)0)
# 3949 "../test/evp_test.c"
...
# 3949 "../test/evp_test.c"
        ...
        if (pkey == 
# 3950 "../test/evp_test.c" 3 4
                   ((void *)0) 
# 3950 "../test/evp_test.c"
                        && !key_unsupported()) {
            EVP_PKEY_free(pkey);
            test_info("../test/evp_test.c", 3952, "Can't read public key %s", pp->value);
            test_openssl_errors();
            return 0;
        }
        klist = &public_keys;
        ...
        char *strnid = 
# 3959 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3959 "../test/evp_test.c"
                          , *keydata = 
# 3959 "../test/evp_test.c" 3 4
                                       ((void *)0)
# 3959 "../test/evp_test.c"
        ...
        if (strnid != 
# 3970 "../test/evp_test.c" 3 4
                     ((void *)0)
# 3970 "../test/evp_test.c"
                         ) {
            *strnid++ = '\0';
            keydata = strchr(strnid, ':');
            if (keydata != 
# 3973 "../test/evp_test.c" 3 4
                          ((void *)0)
# 3973 "../test/evp_test.c"
                              )
                *keydata++ = '\0';
        }
        if (keydata == 
# 3976 "../test/evp_test.c" 3 4
                      ((void *)0)
# 3976 "../test/evp_test.c"
                          ) {
            test_info("../test/evp_test.c", 3977, "Failed to parse %s value", pp->key);
            return 0;
        }

        nid = OBJ_txt2nid(strnid);
        if (nid == 0) {
            test_info("../test/evp_test.c", 3983, "Unrecognised algorithm NID");
            return 0;
        }
        if (!parse_bin(keydata, &keybin, &keylen)) {
            test_info("../test/evp_test.c", 3987, "Failed to create binary key");
            return 0;
        }
        if (klist == &private_keys)
            pkey = EVP_PKEY_new_raw_private_key_ex(libctx, strnid, 
# 3991 "../test/evp_test.c" 3 4
                                                                  ((void *)0)
# 3991 "../test/evp_test.c"
                                                                      , keybin,
                                                   keylen);
        else
            pkey = EVP_PKEY_new_raw_public_key_ex(libctx, strnid, 
# 3994 "../test/evp_test.c" 3 4
                                                                 ((void *)0)
# 3994 "../test/evp_test.c"
                                                                     , keybin,
                                                  keylen);
        if (pkey == 
# 3996 "../test/evp_test.c" 3 4
                   ((void *)0) 
# 3996 "../test/evp_test.c"
                        && !key_unsupported()) {
            test_info("../test/evp_test.c", 3997, "Can't read %s data", pp->key);
            CRYPTO_free(keybin, "../test/evp_test.c", 3998);
            test_openssl_errors();
            return 0;
        }
        CRYPTO_free(keybin, "../test/evp_test.c", 4002);
    } else if (strcmp(pp->key, "Availablein") == 0) {
        if (!prov_available(pp->value)) {
            test_info("../test/evp_test.c", 4005, "skipping, '%s' provider not available: %s:%d", pp->value, t->s.test_file, t->s.start)
                                                            ;
                t->skip = 1;
                return 0;
        }
        ...
        if (prov_available("fips")) {
            ...
            if (j < 0) {
                test_info("../test/evp_test.c", 4017, "Line %d: error matching FIPS versions\n", t->s.curr);
                return 0;
            } else if (j == 0) {
                test_info("../test/evp_test.c", 4020, "skipping, FIPS provider incompatible version: %s:%d", t->s.test_file, t->s.start)
                                                     ;
                    t->skip = 1;
                    return 0;
            }
    ...
    if (klist != 
# 4032 "../test/evp_test.c" 3 4
                ((void *)0)
# 4032 "../test/evp_test.c"
                    ) {
        if (find_key(
# 4033 "../test/evp_test.c" 3 4
                    ((void *)0)
# 4033 "../test/evp_test.c"
                        , pp->value, *klist)) {
            test_info("../test/evp_test.c", 4034, "Duplicate key %s", pp->value);
            return 0;
        }
        if (!test_ptr("../test/evp_test.c", 4037, "key = OPENSSL_malloc(sizeof(*key))", key = CRYPTO_malloc(sizeof(*key), "../test/evp_test.c", 4037)))
            return 0;
        ...
        *klist = key;
        ...
        if ((t->s.numpairs - skipped) != 1)
            test_info("../test/evp_test.c", 4046, "Line %d: missing blank line\n", t->s.curr);
        goto top;
    }


    if (!test_ptr("../test/evp_test.c", 4051, "t->meth = find_test(pp->key)", t->meth = find_test(pp->key)))
        return 0;
    if (!t->meth->init(t, pp->value)) {
        test_error("../test/evp_test.c", 4054, "unknown %s: %s\n", pp->key, pp->value);
        return 0;
    }
    if (t->skip == 1) {
    ...
    for (pp++, i = 1; i < (t->s.numpairs - skipped); pp++, i++) {
        if (strcmp(pp->key, "Securitycheck") == 0) {
            ...
            {
                test_info("../test/evp_test.c", 4069, "skipping, Securitycheck is disabled: %s:%d", t->s.test_file, t->s.start)
                                                     ;
                t->skip = 1;
                return 0;
            }
        } else if (strcmp(pp->key, "Availablein") == 0) {
            test_info("../test/evp_test.c", 4075, "Line %d: 'Availablein' should be the first option", t->s.curr)
                                ;
            return 0;
        } else if (strcmp(pp->key, "Result") == 0) {
            if (t->expected_err != 
# 4079 "../test/evp_test.c" 3 4
                                  ((void *)0)
# 4079 "../test/evp_test.c"
                                      ) {
                test_info("../test/evp_test.c", 4080, "Line %d: multiple result lines", t->s.curr);
                return 0;
            }
            ...
            if (t->reason != 
# 4087 "../test/evp_test.c" 3 4
                            ((void *)0)
# 4087 "../test/evp_test.c"
                                ) {
                test_info("../test/evp_test.c", 4088, "Line %d: multiple reason lines", t->s.curr);
                return 0;
            }
            t->reason = take_value(pp);
        } else if (strcmp(pp->key, "Threads") == 0) {
            if (OSSL_set_max_threads(libctx, atoi(pp->value)) == 0) {
                test_info("../test/evp_test.c", 4094, "skipping, '%s' threads not available: %s:%d", pp->value, t->s.test_file, t->s.start)
                                                                ;
                t->skip = 1;
            }
        } else {
            ...
            if (rv == 0) {
                test_info("../test/evp_test.c", 4103, "Line %d: unknown keyword %s", t->s.curr, pp->key);
                return 0;
            }
            if (rv < 0) {
                test_info("../test/evp_test.c", 4107, "Line %d: error processing keyword %s = %s\n", t->s.curr, pp->key, pp->value)
                                                        ;
                return 0;
            }
            if (t->skip)
...
static int run_file_tests(int i)
{
    ...
    if (!test_ptr("../test/evp_test.c", 4125, "t = OPENSSL_zalloc(sizeof(*t))", t = CRYPTO_zalloc(sizeof(*t), "../test/evp_test.c", 4125)))
        return 0;
    if (!test_start_file(&t->s, testfile)) {
        CRYPTO_free(t, "../test/evp_test.c", 4128);
        return 0;
    }

    while (!(int)BIO_ctrl(t->s.fp,2,0,
# 4132 "../test/evp_test.c" 3 4
           ((void *)0)
# 4132 "../test/evp_test.c"
           )) {
        c = parse(t);
        if (t->skip) {
            t->s.numskip++;
    ...
    public_keys = 
# 4147 "../test/evp_test.c" 3 4
                 ((void *)0)
# 4147 "../test/evp_test.c"
                     ;
    free_key_list(private_keys);
    private_keys = 
# 4149 "../test/evp_test.c" 3 4
                  ((void *)0)
# 4149 "../test/evp_test.c"
                      ;
    BIO_free(t->s.key);
    c = t->s.errors;
    CRYPTO_free(t, "../test/evp_test.c", 4152);
    return c == 0;
}
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 4169 "../test/evp_test.c" 3 4
         ((void *)0) 
# 4169 "../test/evp_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    size_t n;
    char *config_file = 
# 4177 "../test/evp_test.c" 3 4
                       ((void *)0)
# 4177 "../test/evp_test.c"
                           ;
    char *provider_name = 
# 4178 "../test/evp_test.c" 3 4
                         ((void *)0)
# 4178 "../test/evp_test.c"
                             ;
    ...
    if (config_file == 
# 4210 "../test/evp_test.c" 3 4
                      ((void *)0) 
# 4210 "../test/evp_test.c"
                           && provider_name == 
# 4210 "../test/evp_test.c" 3 4
                                               ((void *)0)
# 4210 "../test/evp_test.c"
    ...
    add_all_tests("run_file_tests", run_file_tests, n, 1);
    return 1;
}
...
static int is_digest_disabled(const char *name)
{
    ...
    if (OPENSSL_strcasecmp(name, "MD2") == 0)
        return 1;
# 4264 "../test/evp_test.c"
    return 0;
}

static int is_pkey_disabled(const char *name)
{
# 4285 "../test/evp_test.c"
    return 0;
}

static int is_mac_disabled(const char *name)
{
# 4307 "../test/evp_test.c"
    return 0;
}
static int is_kdf_disabled(const char *name)
{
# 4319 "../test/evp_test.c"
    return 0;
}

static int is_cipher_disabled(const char *name)
{
# 4371 "../test/evp_test.c"
    if ((OPENSSL_strncasecmp(name, "RC5" "", sizeof("RC5") - 1) == 0))
        return 1;
# 4386 "../test/evp_test.c"
    return 0;
}
