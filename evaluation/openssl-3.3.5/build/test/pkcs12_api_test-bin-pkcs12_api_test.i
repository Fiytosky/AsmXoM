# 0 "../test/pkcs12_api_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pkcs12_api_test.c"
# 10 "../test/pkcs12_api_test.c"
...
# 13 "../test/pkcs12_api_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../test/pkcs12_api_test.c" 2
...
void check_secretbag(PKCS12_BUILDER *pb, int secret_nid, const char *secret,
                     const PKCS12_ATTR *attrs);
# 23 "../test/pkcs12_api_test.c" 2

static OSSL_LIB_CTX *testctx = 
# 24 "../test/pkcs12_api_test.c" 3 4
                              ((void *)0)
# 24 "../test/pkcs12_api_test.c"
                                  ;
static OSSL_PROVIDER *nullprov = 
# 25 "../test/pkcs12_api_test.c" 3 4
                                ((void *)0)
# 25 "../test/pkcs12_api_test.c"
                                    ;

static int test_null_args(void)
{
    return test_false("../test/pkcs12_api_test.c", 29, "PKCS12_parse(NULL, NULL, NULL, NULL, NULL)", (PKCS12_parse(
# 29 "../test/pkcs12_api_test.c" 3 4
          ((void *)0)
# 29 "../test/pkcs12_api_test.c"
          , 
# 29 "../test/pkcs12_api_test.c" 3 4
          ((void *)0)
# 29 "../test/pkcs12_api_test.c"
...
{
    BIO *bio = 
# 34 "../test/pkcs12_api_test.c" 3 4
              ((void *)0)
# 34 "../test/pkcs12_api_test.c"
                  ;
    PKCS12 *p12 = 
# 35 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 35 "../test/pkcs12_api_test.c"
                     ;

    bio = BIO_new_file(fpath, "rb");
    if (!test_ptr("../test/pkcs12_api_test.c", 38, "bio", bio))
        goto err;

    p12 = PKCS12_init_ex(21, testctx, "provider=default");
    if (!test_ptr("../test/pkcs12_api_test.c", 42, "p12", p12))
        goto err;

    if (!test_true("../test/pkcs12_api_test.c", 45, "p12 == d2i_PKCS12_bio(bio, &p12)", (p12 == d2i_PKCS12_bio(bio, &p12)) != 0))
        goto err;
...
err:
    ...
    PKCS12_free(p12);
    return 
# 55 "../test/pkcs12_api_test.c" 3 4
          ((void *)0)
# 55 "../test/pkcs12_api_test.c"
              ;
}

static const char *in_file = 
# 58 "../test/pkcs12_api_test.c" 3 4
                            ((void *)0)
# 58 "../test/pkcs12_api_test.c"
                                ;
...
static int changepass(PKCS12 *p12, EVP_PKEY *key, X509 *cert, struct stack_st_X509 *ca)
{
    int ret = 0;
    PKCS12 *p12new = 
# 67 "../test/pkcs12_api_test.c" 3 4
                    ((void *)0)
# 67 "../test/pkcs12_api_test.c"
                        ;
    EVP_PKEY *key2 = 
# 68 "../test/pkcs12_api_test.c" 3 4
                    ((void *)0)
# 68 "../test/pkcs12_api_test.c"
                        ;
    X509 *cert2 = 
# 69 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 69 "../test/pkcs12_api_test.c"
                     ;
    struct stack_st_X509 *ca2 = 
# 70 "../test/pkcs12_api_test.c" 3 4
                         ((void *)0)
# 70 "../test/pkcs12_api_test.c"
                             ;
    BIO *bio = 
# 71 "../test/pkcs12_api_test.c" 3 4
              ((void *)0)
# 71 "../test/pkcs12_api_test.c"
                  ;

    if (!test_true("../test/pkcs12_api_test.c", 73, "PKCS12_newpass(p12, in_pass, \"NEWPASS\")", (PKCS12_newpass(p12, in_pass, "NEWPASS")) != 0))
        goto err;
    if (!test_ptr("../test/pkcs12_api_test.c", 75, "bio = BIO_new(BIO_s_mem())", bio = BIO_new(BIO_s_mem())))
        goto err;
    if (!test_true("../test/pkcs12_api_test.c", 77, "i2d_PKCS12_bio(bio, p12)", (i2d_PKCS12_bio(bio, p12)) != 0))
        goto err;
    if (!test_ptr("../test/pkcs12_api_test.c", 79, "p12new = PKCS12_init_ex(NID_pkcs7_data, testctx, \"provider=default\")", p12new = PKCS12_init_ex(21, testctx, "provider=default")))
        goto err;
    if (!test_ptr("../test/pkcs12_api_test.c", 81, "d2i_PKCS12_bio(bio, &p12new)", d2i_PKCS12_bio(bio, &p12new)))
        goto err;
    if (!test_true("../test/pkcs12_api_test.c", 83, "PKCS12_parse(p12new, \"NEWPASS\", &key2, &cert2, &ca2)", (PKCS12_parse(p12new, "NEWPASS", &key2, &cert2, &ca2)) != 0))
        goto err;
    if (has_key) {
        if (!test_ptr("../test/pkcs12_api_test.c", 86, "key2", key2) || !test_int_eq("../test/pkcs12_api_test.c", 86, "EVP_PKEY_eq(key, key2)", "1", EVP_PKEY_eq(key, key2), 1))
            goto err;
    }
    if (has_cert) {
        if (!test_ptr("../test/pkcs12_api_test.c", 90, "cert2", cert2) || !test_int_eq("../test/pkcs12_api_test.c", 90, "X509_cmp(cert, cert2)", "0", X509_cmp(cert, cert2), 0))
            goto err;
    }
    ret = 1;
err:
...
static int pkcs12_parse_test(void)
{
    int ret = 0;
    PKCS12 *p12 = 
# 106 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 106 "../test/pkcs12_api_test.c"
                     ;
    EVP_PKEY *key = 
# 107 "../test/pkcs12_api_test.c" 3 4
                   ((void *)0)
# 107 "../test/pkcs12_api_test.c"
                       ;
    X509 *cert = 
# 108 "../test/pkcs12_api_test.c" 3 4
                ((void *)0)
# 108 "../test/pkcs12_api_test.c"
                    ;
    struct stack_st_X509 *ca = 
# 109 "../test/pkcs12_api_test.c" 3 4
                        ((void *)0)
# 109 "../test/pkcs12_api_test.c"
                            ;

    if (in_file != 
# 111 "../test/pkcs12_api_test.c" 3 4
                  ((void *)0)
# 111 "../test/pkcs12_api_test.c"
                      ) {
        p12 = PKCS12_load(in_file);
        if (!test_ptr("../test/pkcs12_api_test.c", 113, "p12", p12))
            goto err;

        if (!test_true("../test/pkcs12_api_test.c", 116, "PKCS12_parse(p12, in_pass, &key, &cert, &ca)", (PKCS12_parse(p12, in_pass, &key, &cert, &ca)) != 0))
            goto err;

        if ((has_key && !test_ptr("../test/pkcs12_api_test.c", 119, "key", key)) || (!has_key && !test_ptr_null("../test/pkcs12_api_test.c", 119, "key", key)))
            goto err;
        if ((has_cert && !test_ptr("../test/pkcs12_api_test.c", 121, "cert", cert)) || (!has_cert && !test_ptr_null("../test/pkcs12_api_test.c", 121, "cert", cert)))
            goto err;
        if ((has_ca && !test_ptr("../test/pkcs12_api_test.c", 123, "ca", ca)) || (!has_ca && !test_ptr_null("../test/pkcs12_api_test.c", 123, "ca", ca)))
            goto err;
...
err:
    ...
    return test_true("../test/pkcs12_api_test.c", 134, "ret", (ret) != 0);
}
...
static PKCS12 *pkcs12_create_ex2_setup(EVP_PKEY **key, X509 **cert, struct stack_st_X509 **ca)
{
    PKCS12 *p12 = 
# 145 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 145 "../test/pkcs12_api_test.c"
                     ;
    p12 = PKCS12_load("out6.p12");
    if (!test_ptr("../test/pkcs12_api_test.c", 147, "p12", p12))
        goto err;

    if (!test_true("../test/pkcs12_api_test.c", 150, "PKCS12_parse(p12, \"\", key, cert, ca)", (PKCS12_parse(p12, "", key, cert, ca)) != 0))
        goto err;
...
err:
    PKCS12_free(p12);
    return 
# 156 "../test/pkcs12_api_test.c" 3 4
          ((void *)0)
# 156 "../test/pkcs12_api_test.c"
              ;
}
...
static int pkcs12_create_ex2_test(int test)
{
    int ret = 0, cb_ret = 0;
    PKCS12 *ptr = 
# 162 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 162 "../test/pkcs12_api_test.c"
                     , *p12 = 
# 162 "../test/pkcs12_api_test.c" 3 4
                              ((void *)0)
# 162 "../test/pkcs12_api_test.c"
                                  ;
    EVP_PKEY *key = 
# 163 "../test/pkcs12_api_test.c" 3 4
                   ((void *)0)
# 163 "../test/pkcs12_api_test.c"
                       ;
    X509 *cert = 
# 164 "../test/pkcs12_api_test.c" 3 4
                ((void *)0)
# 164 "../test/pkcs12_api_test.c"
                    ;
    struct stack_st_X509 *ca = 
# 165 "../test/pkcs12_api_test.c" 3 4
                        ((void *)0)
# 165 "../test/pkcs12_api_test.c"
                            ;

    p12 = pkcs12_create_ex2_setup(&key, &cert, &ca);
    if (!test_ptr("../test/pkcs12_api_test.c", 168, "p12", p12))
        goto err;

    if (test == 0) {

        ptr = PKCS12_create_ex2(
# 173 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 173 "../test/pkcs12_api_test.c"
                                   , 
# 173 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 173 "../test/pkcs12_api_test.c"
...
# 174 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 174 "../test/pkcs12_api_test.c"
                                   , 
# 174 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 174 "../test/pkcs12_api_test.c"
                                ...
                                0, 0, 0,
                                testctx, 
# 176 "../test/pkcs12_api_test.c" 3 4
                                        ((void *)0)
# 176 "../test/pkcs12_api_test.c"
                                            ,
                                
# 177 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 177 "../test/pkcs12_api_test.c"
                                   , 
# 177 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 177 "../test/pkcs12_api_test.c"
                                         );
        if (test_ptr("../test/pkcs12_api_test.c", 178, "ptr", ptr))
            goto err;


        if (!test_ptr("../test/pkcs12_api_test.c", 182, "cert", cert))
            goto err;


        cb_ret = 1;
        ptr = PKCS12_create_ex2(
# 187 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 187 "../test/pkcs12_api_test.c"
                                   , 
# 187 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 187 "../test/pkcs12_api_test.c"
...
# 187 "../test/pkcs12_api_test.c"
                                               ,
                                cert, 
# 188 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 188 "../test/pkcs12_api_test.c"
                                         , 0, 0,
                                0, 0, 0,
                                testctx, 
# 190 "../test/pkcs12_api_test.c" 3 4
                                        ((void *)0)
# 190 "../test/pkcs12_api_test.c"
                                            ,
                                pkcs12_create_cb, (void*)&cb_ret);

        if (!test_ptr("../test/pkcs12_api_test.c", 193, "ptr", ptr))
            goto err;
    } else if (test == 1) {

        cb_ret = -1;
        ptr = PKCS12_create_ex2(
# 198 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 198 "../test/pkcs12_api_test.c"
                                   , 
# 198 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 198 "../test/pkcs12_api_test.c"
...
# 198 "../test/pkcs12_api_test.c"
                                               ,
                                cert, 
# 199 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 199 "../test/pkcs12_api_test.c"
                                         , 0, 0,
                                0, 0, 0,
                                testctx, 
# 201 "../test/pkcs12_api_test.c" 3 4
                                        ((void *)0)
# 201 "../test/pkcs12_api_test.c"
                                            ,
                                pkcs12_create_cb, (void*)&cb_ret);

       if (test_ptr("../test/pkcs12_api_test.c", 204, "ptr", ptr))
            goto err;
    } else if (test == 2) {

        cb_ret = 0;
        ptr = PKCS12_create_ex2(
# 209 "../test/pkcs12_api_test.c" 3 4
                               ((void *)0)
# 209 "../test/pkcs12_api_test.c"
                                   , 
# 209 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 209 "../test/pkcs12_api_test.c"
...
# 209 "../test/pkcs12_api_test.c"
                                               ,
                                cert, 
# 210 "../test/pkcs12_api_test.c" 3 4
                                     ((void *)0)
# 210 "../test/pkcs12_api_test.c"
                                         , 0, 0,
                                0, 0, 0,
                                testctx, 
# 212 "../test/pkcs12_api_test.c" 3 4
                                        ((void *)0)
# 212 "../test/pkcs12_api_test.c"
                                            ,
                                pkcs12_create_cb, (void*)&cb_ret);

        if (!test_ptr("../test/pkcs12_api_test.c", 215, "ptr", ptr))
            goto err;
    }
...
err:
    ...
    X509_free(cert);
    OSSL_STACK_OF_X509_free(ca);
    return test_true("../test/pkcs12_api_test.c", 226, "ret", (ret) != 0);
}
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 251 "../test/pkcs12_api_test.c" 3 4
         ((void *)0) 
# 251 "../test/pkcs12_api_test.c"
              }
    };
    return options;
}
...
# 286 "../test/pkcs12_api_test.c" 3 4
                                             ((void *)0)
# 286 "../test/pkcs12_api_test.c"
                                                 , 
# 286 "../test/pkcs12_api_test.c" 3 4
                                                   ((void *)0)
# 286 "../test/pkcs12_api_test.c"
...
# 286 "../test/pkcs12_api_test.c"
        ...
        testctx = 
# 288 "../test/pkcs12_api_test.c" 3 4
                 ((void *)0)
# 288 "../test/pkcs12_api_test.c"
                     ;
        return 0;
    }
