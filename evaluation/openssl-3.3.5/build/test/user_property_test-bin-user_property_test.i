# 0 "../test/user_property_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/user_property_test.c"
# 10 "../test/user_property_test.c"
...
# 11 "../test/user_property_test.c" 2
...
# 12 "../test/user_property_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../test/user_property_test.c" 2
...
# 14 "../test/user_property_test.c" 2
...
# 15 "../test/user_property_test.c" 2
...
# 16 "../test/user_property_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 17 "../test/user_property_test.c" 2
...
{
    OSSL_PARAM *p = 
# 26 "../test/user_property_test.c" 3 4
                   ((void *)0)
# 26 "../test/user_property_test.c"
                       ;

    p = OSSL_PARAM_locate(params, "blocksize");
    if (p != 
# 29 "../test/user_property_test.c" 3 4
            ((void *)0) 
# 29 "../test/user_property_test.c"
                 && !OSSL_PARAM_set_size_t(p, 1))
        return 0;

    p = OSSL_PARAM_locate(params, "size");
    if (p != 
# 33 "../test/user_property_test.c" 3 4
            ((void *)0) 
# 33 "../test/user_property_test.c"
                 && !OSSL_PARAM_set_size_t(p, 1))
        return 0;
...
static const OSSL_DISPATCH testprovmd_functions[] = {
    { 8, (void (*)(void))tmpmd_get_params },
    { 5, (void (*)(void))tmpmd_digest },
    { 0, 
# 48 "../test/user_property_test.c" 3 4
   ((void *)0) 
# 48 "../test/user_property_test.c"
   }
};

static const OSSL_ALGORITHM testprov_digests[] = {
    { "testprovmd", "foo.bar=yes", testprovmd_functions },
    { 
# 53 "../test/user_property_test.c" 3 4
     ((void *)0)
# 53 "../test/user_property_test.c"
         , 
# 53 "../test/user_property_test.c" 3 4
           ((void *)0)
# 53 "../test/user_property_test.c"
...
{
    *no_cache = 0;
    return operation_id == 1 ? testprov_digests : 
# 61 "../test/user_property_test.c" 3 4
                                                              ((void *)0)
# 61 "../test/user_property_test.c"
                                                                  ;
}

static const OSSL_DISPATCH testprov_dispatch_table[] = {
    { 1027, (void (*)(void))testprov_query },
    { 0, 
# 66 "../test/user_property_test.c" 3 4
   ((void *)0) 
# 66 "../test/user_property_test.c"
   }
};
...
{
    OSSL_LIB_CTX *libctx;
    OSSL_PROVIDER *testprov = 
# 89 "../test/user_property_test.c" 3 4
                             ((void *)0)
# 89 "../test/user_property_test.c"
                                 ;
    EVP_MD *testprovmd = 
# 90 "../test/user_property_test.c" 3 4
                        ((void *)0)
# 90 "../test/user_property_test.c"
                            ;
    int res = 0;

    if (!test_ptr("../test/user_property_test.c", 93, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new())
            || !test_true("../test/user_property_test.c", 94, "OSSL_PROVIDER_add_builtin(libctx, \"testprov\", testprov_provider_init)", (OSSL_PROVIDER_add_builtin(libctx, "testprov", testprov_provider_init)) != 0)
                                                                            )
        goto err;

    if (propsorder == DEFAULT_PROPS_FIRST
            && !test_true("../test/user_property_test.c", 99, "EVP_set_default_properties(libctx, MYPROPERTIES)", (EVP_set_default_properties(libctx, "foo.bar=yes")) != 0))
        goto err;

    if (!test_ptr("../test/user_property_test.c", 102, "testprov = OSSL_PROVIDER_load(libctx, \"testprov\")", testprov = OSSL_PROVIDER_load(libctx, "testprov")))
        goto err;

    if (propsorder == DEFAULT_PROPS_AFTER_LOAD
            && !test_true("../test/user_property_test.c", 106, "EVP_set_default_properties(libctx, MYPROPERTIES)", (EVP_set_default_properties(libctx, "foo.bar=yes")) != 0))
        goto err;

    if (!test_ptr("../test/user_property_test.c", 109, "testprovmd = EVP_MD_fetch(libctx, \"testprovmd\", NULL)", testprovmd = EVP_MD_fetch(libctx, "testprovmd", 
# 109 "../test/user_property_test.c" 3 4
        ((void *)0)
# 109 "../test/user_property_test.c"
        )))
        goto err;

    if (propsorder == DEFAULT_PROPS_AFTER_FETCH) {
        if (!test_true("../test/user_property_test.c", 113, "EVP_set_default_properties(libctx, MYPROPERTIES)", (EVP_set_default_properties(libctx, "foo.bar=yes")) != 0))
            goto err;
        EVP_MD_free(testprovmd);
        if (!test_ptr("../test/user_property_test.c", 116, "testprovmd = EVP_MD_fetch(libctx, \"testprovmd\", NULL)", testprovmd = EVP_MD_fetch(libctx, "testprovmd", 
# 116 "../test/user_property_test.c" 3 4
            ((void *)0)
# 116 "../test/user_property_test.c"
            )))
            goto err;
    }
...
int setup_tests(void)
{
    add_all_tests("test_default_props_and_providers", test_default_props_and_providers, DEFAULT_PROPS_FINAL, 1);
    return 1;
}
