# 0 "../test/poly1305_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/poly1305_internal_test.c"
# 12 "../test/poly1305_internal_test.c"
...
# 13 "../test/poly1305_internal_test.c" 2
...
# 14 "../test/poly1305_internal_test.c" 2
...
# 16 "../test/poly1305_internal_test.c" 2
...
# 17 "../test/poly1305_internal_test.c" 2
...
static int test_poly1305(int idx)
{
    ...
    if (!test_size_t_eq("../test/poly1305_internal_test.c", 1517, "expectedlen", "sizeof(out)", expectedlen, sizeof(out)))
        return 0;
    ...
    if (!test_mem_eq("../test/poly1305_internal_test.c", 1524, "out", "expected", out, expectedlen, expected, expectedlen)) {
        test_info("../test/poly1305_internal_test.c", 1525, "Poly1305 test #%d failed.", idx);
        return 0;
    }
    ...
    if (inlen > 16) {
        ...
        if (!test_mem_eq("../test/poly1305_internal_test.c", 1535, "out", "expected", out, expectedlen, expected, expectedlen)) {
            test_info("../test/poly1305_internal_test.c", 1536, "Poly1305 test #%d/1+(N-1) failed.", idx);
            return 0;
        }
    }
    ...
    if (inlen > 32) {
        ...
        if (!test_mem_eq("../test/poly1305_internal_test.c", 1549, "out", "expected", out, expectedlen, expected, expectedlen)) {
            test_info("../test/poly1305_internal_test.c", 1550, "Poly1305 test #%d/2 failed.", idx);
            return 0;
        }
        ...
        for (half = 16; half < inlen; half += 16) {
            ...
            if (!test_mem_eq("../test/poly1305_internal_test.c", 1560, "out", "expected", out, expectedlen, expected, expectedlen)) {
                test_info("../test/poly1305_internal_test.c", 1561, "Poly1305 test #%d/%zu+%zu failed.", idx, half, inlen-half)
                                                ;
                return 0;
            }
        }
...
int setup_tests(void)
{
    add_all_tests("test_poly1305", test_poly1305, (sizeof(tests)/sizeof((tests)[0])), 1);
    return 1;
}
