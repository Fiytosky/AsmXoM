# 0 "../test/testutil/test_options.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/test_options.c"
# 10 "../test/testutil/test_options.c"
...
# 11 "../test/testutil/test_options.c" 2
...
# 12 "../test/testutil/test_options.c" 2
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS default_options[] = {
        ...
        { 
# 18 "../test/testutil/test_options.c" 3 4
         ((void *)0) 
# 18 "../test/testutil/test_options.c"
              }
    };
