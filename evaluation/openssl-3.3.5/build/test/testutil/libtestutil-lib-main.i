# 0 "../test/testutil/main.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/main.c"
# 10 "../test/testutil/main.c"
...
# 13 "../test/testutil/main.c" 2


int main(int argc, char *argv[])
{
    int ret = 
# 17 "../test/testutil/main.c" 3 4
             1
# 17 "../test/testutil/main.c"
                         ;
    int setup_res;
