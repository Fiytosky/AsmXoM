# 0 "../test/testutil/cb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/cb.c"
# 10 "../test/testutil/cb.c"
...
int test_printf_taperr(const char *fmt, ...)
    __attribute__((__format__(__gnu_printf__, 1, 2)));
# 11 "../test/testutil/cb.c" 2
# 1 "../test/testutil/tu_local.h" 1
# 10 "../test/testutil/tu_local.h"
