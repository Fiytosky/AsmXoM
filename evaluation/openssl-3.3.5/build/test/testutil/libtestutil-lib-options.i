# 0 "../test/testutil/options.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/options.c"
# 10 "../test/testutil/options.c"
...
char *test_get_argument(size_t n)
{
    ...
    (void)((n < sizeof(used)) ? 0 : (OPENSSL_die("assertion failed: " "n < sizeof(used)", "../test/testutil/options.c", 43), 1));
    if ((int)n >= opt_num_rest() || argv == 
# 44 "../test/testutil/options.c" 3 4
                                           ((void *)0)
# 44 "../test/testutil/options.c"
                                               )
        return 
# 45 "../test/testutil/options.c" 3 4
              ((void *)0)
# 45 "../test/testutil/options.c"
                  ;
    used[n] = 1;
    return argv[n];
}
...
void opt_check_usage(void)
{
    ...
    if (arg_count > (int)(sizeof(used)/sizeof((used)[0])))
        n = (int)(sizeof(used)/sizeof((used)[0]));
    else
        n = arg_count;
    for (i = 0; i < n; i++) {
        if (used[i] == 0)
...
# 74 "../test/testutil/options.c" 3 4
   __builtin_c23_va_start(
# 74 "../test/testutil/options.c"
   ap, fmt
# 74 "../test/testutil/options.c" 3 4
   )
# 74 "../test/testutil/options.c"
...
# 76 "../test/testutil/options.c" 3 4
   __builtin_va_end(
# 76 "../test/testutil/options.c"
   ap
# 76 "../test/testutil/options.c" 3 4
   )
# 76 "../test/testutil/options.c"
