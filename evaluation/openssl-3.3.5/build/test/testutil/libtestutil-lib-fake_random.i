# 0 "../test/testutil/fake_random.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/fake_random.c"
# 11 "../test/testutil/fake_random.c"
...
# 12 "../test/testutil/fake_random.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../test/testutil/fake_random.c" 2
...
int RAND_poll(void);
# 14 "../test/testutil/fake_random.c" 2
...
# 15 "../test/testutil/fake_random.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 16 "../test/testutil/fake_random.c" 2
# 1 "../test/testutil/../../crypto/evp/evp_local.h" 1
# 16 "../test/testutil/../../crypto/evp/evp_local.h"
...
# 1 "../include/openssl/types.h" 1
# 265 "../test/testutil/../../crypto/evp/evp_local.h" 2
...
int evp_cipher_set_asn1_aead_params(EVP_CIPHER_CTX *c, ASN1_TYPE *type,
                                    evp_cipher_aead_asn1_params *asn1_params);
# 331 "../test/testutil/../../crypto/evp/evp_local.h"
...
# 362 "../test/testutil/../../crypto/evp/evp_local.h"
...
# 17 "../test/testutil/fake_random.c" 2
# 1 "../test/testutil/../testutil.h" 1
# 14 "../test/testutil/../testutil.h"
...
# 18 "../test/testutil/fake_random.c" 2
...
{
    FAKE_RAND *r = CRYPTO_zalloc(sizeof(*r), "../test/testutil/fake_random.c", 38);

    if (r != 
# 40 "../test/testutil/fake_random.c" 3 4
            ((void *)0)
# 40 "../test/testutil/fake_random.c"
                )
        r->state = 0;
    return r;
}
...
{
    CRYPTO_free(vrng, "../test/testutil/fake_random.c", 47);
}

static int fake_rand_instantiate(void *vrng, __attribute__((unused)) unsigned int strength,
                                 __attribute__((unused)) int prediction_resistance,
                                 __attribute__((unused)) const unsigned char *pstr,
                                 size_t pstr_len,
                              ...
                              const unsigned char *adin, size_t adinlen)
{
    ...
    if (frng->cb != 
# 78 "../test/testutil/fake_random.c" 3 4
                   ((void *)0)
# 78 "../test/testutil/fake_random.c"
                       )
...
static int fake_rand_get_ctx_params(__attribute__((unused)) void *vrng, OSSL_PARAM params[])
{
    FAKE_RAND *frng = (FAKE_RAND *)vrng;
    OSSL_PARAM *p;

    p = OSSL_PARAM_locate(params, "state");
    if (p != 
# 102 "../test/testutil/fake_random.c" 3 4
            ((void *)0) 
# 102 "../test/testutil/fake_random.c"
                 && !OSSL_PARAM_set_int(p, frng->state))
        return 0;

    p = OSSL_PARAM_locate(params, "strength");
    if (p != 
# 106 "../test/testutil/fake_random.c" 3 4
            ((void *)0) 
# 106 "../test/testutil/fake_random.c"
                 && !OSSL_PARAM_set_int(p, 256))
        return 0;

    p = OSSL_PARAM_locate(params, "max_request");
    if (p != 
# 110 "../test/testutil/fake_random.c" 3 4
            ((void *)0) 
# 110 "../test/testutil/fake_random.c"
                 && !OSSL_PARAM_set_size_t(p, 0x7fffffff
# 110 "../test/testutil/fake_random.c"
                                                     ))
        return 0;
    return 1;
...
static const OSSL_PARAM *fake_rand_gettable_ctx_params(__attribute__((unused)) void *vrng,
                                                       __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("state")), (1), ((
# 119 "../test/testutil/fake_random.c" 3 4
       ((void *)0)
# 119 "../test/testutil/fake_random.c"
       )), (sizeof(int)), ((size_t)-1) },
        { (("strength")), (2), ((
# 120 "../test/testutil/fake_random.c" 3 4
       ((void *)0)
# 120 "../test/testutil/fake_random.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("max_request")), (2), ((
# 121 "../test/testutil/fake_random.c" 3 4
       ((void *)0)
# 121 "../test/testutil/fake_random.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 122 "../test/testutil/fake_random.c" 3 4
       ((void *)0)
# 122 "../test/testutil/fake_random.c"
       , 0, 
# 122 "../test/testutil/fake_random.c" 3 4
       ((void *)0)
# 122 "../test/testutil/fake_random.c"
...
static const OSSL_DISPATCH fake_rand_functions[] = {
    { 1, (void (*)(void))fake_rand_newctx },
    { 2, (void (*)(void))fake_rand_freectx },
    { 3, (void (*)(void))fake_rand_instantiate },
    { 4, (void (*)(void))fake_rand_uninstantiate },
    { 5, (void (*)(void))fake_rand_generate },
    { 8, (void (*)(void))fake_rand_enable_locking },
    { 12,
      (void(*)(void))fake_rand_gettable_ctx_params },
    { 15, (void(*)(void))fake_rand_get_ctx_params },
    { 0, 
# 137 "../test/testutil/fake_random.c" 3 4
   ((void *)0) 
# 137 "../test/testutil/fake_random.c"
   }
};
...
static const OSSL_ALGORITHM fake_rand_rand[] = {
    ...
    { 
# 142 "../test/testutil/fake_random.c" 3 4
     ((void *)0)
# 142 "../test/testutil/fake_random.c"
         , 
# 142 "../test/testutil/fake_random.c" 3 4
           ((void *)0)
# 142 "../test/testutil/fake_random.c"
                                             ...
                                             int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 154 "../test/testutil/fake_random.c" 3 4
          ((void *)0)
# 154 "../test/testutil/fake_random.c"
              ;
}


static const OSSL_DISPATCH fake_rand_method[] = {
    { 1024, (void (*)(void))OSSL_LIB_CTX_free },
    { 1027, (void (*)(void))fake_rand_query },
    { 0, 
# 161 "../test/testutil/fake_random.c" 3 4
   ((void *)0) 
# 161 "../test/testutil/fake_random.c"
   }
};
...
{
    if (!test_ptr("../test/testutil/fake_random.c", 168, "*provctx = OSSL_LIB_CTX_new()", *provctx = OSSL_LIB_CTX_new()))
        return 0;
...
static int check_rng(EVP_RAND_CTX *rng, const char *name)
{
    ...
    if (!test_ptr("../test/testutil/fake_random.c", 178, "rng", rng)) {
        test_info("../test/testutil/fake_random.c", 179, "random: %s", name);
        return 0;
    }
    f = rng->algctx;
    f->name = name;
...
OSSL_PROVIDER *fake_rand_start(OSSL_LIB_CTX *libctx)
{
    ...
    if (!test_true("../test/testutil/fake_random.c", 192, "OSSL_PROVIDER_add_builtin(libctx, \"fake-rand\", fake_rand_provider_init)", (OSSL_PROVIDER_add_builtin(libctx, "fake-rand", fake_rand_provider_init)) != 0)

            || !test_true("../test/testutil/fake_random.c", 194, "RAND_set_DRBG_type(libctx, \"fake\", NULL, NULL, NULL)", (RAND_set_DRBG_type(libctx, "fake", 
# 194 "../test/testutil/fake_random.c" 3 4
               ((void *)0)
# 194 "../test/testutil/fake_random.c"
               , 
# 194 "../test/testutil/fake_random.c" 3 4
               ((void *)0)
# 194 "../test/testutil/fake_random.c"
...
# 194 "../test/testutil/fake_random.c"
            ...
            || !test_ptr("../test/testutil/fake_random.c", 195, "p = OSSL_PROVIDER_try_load(libctx, \"fake-rand\", 1)", p = OSSL_PROVIDER_try_load(libctx, "fake-rand", 1)))
        return 
# 196 "../test/testutil/fake_random.c" 3 4
              ((void *)0)
# 196 "../test/testutil/fake_random.c"
                  ;


    if (!test_true("../test/testutil/fake_random.c", 199, "check_rng(RAND_get0_primary(libctx), \"primary\")", (check_rng(RAND_get0_primary(libctx), "primary")) != 0)
            || !test_true("../test/testutil/fake_random.c", 200, "check_rng(RAND_get0_private(libctx), \"private\")", (check_rng(RAND_get0_private(libctx), "private")) != 0)
            || !test_true("../test/testutil/fake_random.c", 201, "check_rng(RAND_get0_public(libctx), \"public\")", (check_rng(RAND_get0_public(libctx), "public")) != 0)) {
        OSSL_PROVIDER_unload(p);
        return 
# 203 "../test/testutil/fake_random.c" 3 4
              ((void *)0)
# 203 "../test/testutil/fake_random.c"
                  ;
    }
...
{
    if (rng != 
# 218 "../test/testutil/fake_random.c" 3 4
              ((void *)0)
# 218 "../test/testutil/fake_random.c"
                  )
