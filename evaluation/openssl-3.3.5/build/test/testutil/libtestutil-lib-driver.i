# 0 "../test/testutil/driver.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/driver.c"
# 10 "../test/testutil/driver.c"
...
# 13 "../test/testutil/driver.c" 2


# 1 "/usr/include/assert.h" 1 3 4
# 16 "../test/testutil/driver.c" 2




# 1 "../apps/include/platform.h" 1
# 21 "../test/testutil/driver.c" 2
# 30 "../test/testutil/driver.c"
...
# 61 "../test/testutil/driver.c" 3 4
   ((void) (0))
# 61 "../test/testutil/driver.c"
                                             ;
...
# 72 "../test/testutil/driver.c" 3 4
   ((void) (0))
# 72 "../test/testutil/driver.c"
                                             ;
    all_tests[num_tests].test_case_name = test_case_name;
...
static void set_seed(int s)
{
    ...
    if (seed <= 0)
        seed = (int)time(
# 98 "../test/testutil/driver.c" 3 4
                        ((void *)0)
# 98 "../test/testutil/driver.c"
                            );
...
int setup_test_framework(int argc, char *argv[])
{
    ...
    if (TAP_levels != 
# 109 "../test/testutil/driver.c" 3 4
                     ((void *)0)
# 109 "../test/testutil/driver.c"
                         )
        level = 4 * atoi(TAP_levels);
    test_adjust_streams_tap_level(level);
    if (test_rand_order != 
# 112 "../test/testutil/driver.c" 3 4
                          ((void *)0)
# 112 "../test/testutil/driver.c"
                              ) {
        rand_order = 1;
        set_seed(atoi(test_rand_order));
    } else if (test_rand_seed != 
# 115 "../test/testutil/driver.c" 3 4
                                ((void *)0)
# 115 "../test/testutil/driver.c"
                                    ) {
        set_seed(atoi(test_rand_seed));
    } else {
        set_seed(0);
    }
# 130 "../test/testutil/driver.c"
...
{
    if (name != 
# 142 "../test/testutil/driver.c" 3 4
               ((void *)0)
# 142 "../test/testutil/driver.c"
                   ) {
        int i;
...
static int process_shared_options(void)
{
    ...
    char *flag_iter = "";
    char *testname = 
# 194 "../test/testutil/driver.c" 3 4
                    ((void *)0)
# 194 "../test/testutil/driver.c"
                        ;
...
{
    set_test_title(
# 242 "../test/testutil/driver.c" 3 4
                  ((void *)0)
# 242 "../test/testutil/driver.c"
                      );
    return ret;
}
...
# 251 "../test/testutil/driver.c" 3 4
                                             ((void *)0)
# 251 "../test/testutil/driver.c"
                                                 );
}

static char *test_title = 
# 254 "../test/testutil/driver.c" 3 4
                         ((void *)0)
# 254 "../test/testutil/driver.c"
                             ;
...
void set_test_title(const char *title)
{
    free(test_title);
    test_title = title == 
# 259 "../test/testutil/driver.c" 3 4
                         ((void *)0) 
# 259 "../test/testutil/driver.c"
                              ? 
# 259 "../test/testutil/driver.c" 3 4
                                ((void *)0) 
# 259 "../test/testutil/driver.c"
...
__attribute__ ((format(printf, 2, 3))) static void test_verdict(int verdict,
...
# 277 "../test/testutil/driver.c" 3 4
   __builtin_c23_va_start(
# 277 "../test/testutil/driver.c"
   ap, description
# 277 "../test/testutil/driver.c" 3 4
   )
# 277 "../test/testutil/driver.c"
...
# 279 "../test/testutil/driver.c" 3 4
   __builtin_va_end(
# 279 "../test/testutil/driver.c"
   ap
# 279 "../test/testutil/driver.c" 3 4
   )
# 279 "../test/testutil/driver.c"
...
int run_tests(const char *test_prog_name)
{
    ...
    int permute[(sizeof(all_tests)/sizeof((all_tests)[0]))];

    i = process_shared_options();
    if (i == 0)
        return 
# 297 "../test/testutil/driver.c" 3 4
              0
# 297 "../test/testutil/driver.c"
                          ;
    if (i == -1)
        return 
# 299 "../test/testutil/driver.c" 3 4
              1
# 299 "../test/testutil/driver.c"
                          ;
    ...
    if (num_failed != 0)
        return 
# 410 "../test/testutil/driver.c" 3 4
              1
# 410 "../test/testutil/driver.c"
                          ;
    return 
# 411 "../test/testutil/driver.c" 3 4
          0
# 411 "../test/testutil/driver.c"
                      ;
}
...
char *glue_strings(const char *list[], size_t *out_len)
{
    ...
    for (i = 0; list[i] != 
# 424 "../test/testutil/driver.c" 3 4
                          ((void *)0)
# 424 "../test/testutil/driver.c"
                              ; i++)
        len += strlen(list[i]);

    if (out_len != 
# 427 "../test/testutil/driver.c" 3 4
                  ((void *)0)
# 427 "../test/testutil/driver.c"
                      )
        *out_len = len;

    if (!test_ptr("../test/testutil/driver.c", 430, "ret = p = OPENSSL_malloc(len + 1)", ret = p = CRYPTO_malloc(len + 1, "../test/testutil/driver.c", 430)))
        return 
# 431 "../test/testutil/driver.c" 3 4
              ((void *)0)
# 431 "../test/testutil/driver.c"
                  ;

    for (i = 0; list[i] != 
# 433 "../test/testutil/driver.c" 3 4
                          ((void *)0)
# 433 "../test/testutil/driver.c"
                              ; i++)
...
char *test_mk_file_path(const char *dir, const char *file)
{
    ...
    size_t dirlen = dir != 
# 448 "../test/testutil/driver.c" 3 4
                          ((void *)0) 
# 448 "../test/testutil/driver.c"
                               ? strlen(dir) : 0;
    size_t len = dirlen + strlen(sep) + strlen(file) + 1;
    char *full_file = CRYPTO_zalloc(len, "../test/testutil/driver.c", 450);

    if (full_file != 
# 452 "../test/testutil/driver.c" 3 4
                    ((void *)0)
# 452 "../test/testutil/driver.c"
                        ) {
        if (dir != 
# 453 "../test/testutil/driver.c" 3 4
                  ((void *)0) 
# 453 "../test/testutil/driver.c"
                       && dirlen > 0) {
            OPENSSL_strlcpy(full_file, dir, len);
# 473 "../test/testutil/driver.c"
