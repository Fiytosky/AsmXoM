# 0 "../test/testutil/provider.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/provider.c"
# 10 "../test/testutil/provider.c"
...
# 12 "../test/testutil/provider.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../test/testutil/provider.c" 2



# 16 "../test/testutil/provider.c"
int test_get_libctx(OSSL_LIB_CTX **libctx, OSSL_PROVIDER **default_null_prov,
                    const char *config_file,
                    OSSL_PROVIDER **provider, const char *module_name)
{
    OSSL_LIB_CTX *new_libctx = 
# 20 "../test/testutil/provider.c" 3 4
                              ((void *)0)
# 20 "../test/testutil/provider.c"
                                  ;

    if (libctx != 
# 22 "../test/testutil/provider.c" 3 4
                 ((void *)0)
# 22 "../test/testutil/provider.c"
                     ) {
        if ((new_libctx = *libctx = OSSL_LIB_CTX_new()) == 
# 23 "../test/testutil/provider.c" 3 4
                                                          ((void *)0)
# 23 "../test/testutil/provider.c"
                                                              ) {
    ...
    if (default_null_prov != 
# 29 "../test/testutil/provider.c" 3 4
                            ((void *)0)
        
# 30 "../test/testutil/provider.c"
       && (*default_null_prov = OSSL_PROVIDER_load(
# 30 "../test/testutil/provider.c" 3 4
                                                   ((void *)0)
# 30 "../test/testutil/provider.c"
                                                       , "null")) == 
# 30 "../test/testutil/provider.c" 3 4
...
# 30 "../test/testutil/provider.c"
    ...
    if (config_file != 
# 35 "../test/testutil/provider.c" 3 4
                      ((void *)0)
            
# 36 "../test/testutil/provider.c"
    ...
    if (provider != 
# 41 "../test/testutil/provider.c" 3 4
                   ((void *)0) 
# 41 "../test/testutil/provider.c"
                        && module_name != 
# 41 "../test/testutil/provider.c" 3 4
                                          ((void *)0)
            
# 42 "../test/testutil/provider.c"
           && (*provider = OSSL_PROVIDER_load(new_libctx, module_name)) == 
# 42 "../test/testutil/provider.c" 3 4
                                                                           ((void *)0)
# 42 "../test/testutil/provider.c"
                                                                               ) {
 ...
 err:
    ERR_print_errors_fp(
# 49 "../test/testutil/provider.c" 3 4
                       stderr
# 49 "../test/testutil/provider.c"
                             );
    return 0;
}
                    ...
                    OSSL_PROVIDER **provider, int argn, const char *usage)
{
    ...
    if (!test_ptr("../test/testutil/provider.c", 58, "module_name = test_get_argument(argn)", module_name = test_get_argument(argn))) {
        test_error("../test/testutil/provider.c", 59, "usage: <prog> %s", usage);
        return 0;
    }
...
{
    OSSL_PARAM params[2] = { { 
# 79 "../test/testutil/provider.c" 3 4
                            ((void *)0)
# 79 "../test/testutil/provider.c"
                            , 0, 
# 79 "../test/testutil/provider.c" 3 4
                            ((void *)0)
# 79 "../test/testutil/provider.c"
...
# 79 "../test/testutil/provider.c"
    ...
    if (!OSSL_PROVIDER_available(libctx, "fips"))
        return 0;
    *params = OSSL_PARAM_construct_utf8_ptr("version", &vs, 0);
    if ((fips_prov = OSSL_PROVIDER_load(libctx, "fips")) == 
# 86 "../test/testutil/provider.c" 3 4
                                                           ((void *)0)
# 86 "../test/testutil/provider.c"
                                                               )
        return -1;
...
int fips_provider_version_match(OSSL_LIB_CTX *libctx, const char *versions)
{
    ...
    while (*versions != '\0') {
        for (; 
# 180 "../test/testutil/provider.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 180 "../test/testutil/provider.c"
...
# 180 "../test/testutil/provider.c"
        ...
        if (*versions == '\0')
            break;
        for (p = versions; *versions != '\0' && !
# 184 "../test/testutil/provider.c" 3 4
                                                ((*__ctype_b_loc ())[(int) ((
# 184 "../test/testutil/provider.c"
                                                (unsigned char)(*versions)
# 184 "../test/testutil/provider.c" 3 4
                                                ))] & (unsigned short int) _ISspace)
# 184 "../test/testutil/provider.c"
...
# 204 "../test/testutil/provider.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 204 "../test/testutil/provider.c"
                  (unsigned char)*p
# 204 "../test/testutil/provider.c" 3 4
...
# 204 "../test/testutil/provider.c"
            ...
            test_info("../test/testutil/provider.c", 207, "Error matching FIPS version: mode %s\n", p);
            return -1;
        }
        if (sscanf(p, "%d.%d.%d", &major, &minor, &patch) != 3) {
            test_info("../test/testutil/provider.c", 211, "Error matching FIPS version: version %s\n", p);
            return -1;
        }
        switch (mode) {
        case MODE_EQ:
        ...
        if (r < 0) {
            test_info("../test/testutil/provider.c", 235, "Error matching FIPS version: internal error\n");
            return -1;
        }
        if (r == 0)
            return 0;
