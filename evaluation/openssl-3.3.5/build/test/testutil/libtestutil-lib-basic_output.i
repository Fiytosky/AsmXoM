# 0 "../test/testutil/basic_output.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/basic_output.c"
# 10 "../test/testutil/basic_output.c"
...
# 11 "../test/testutil/basic_output.c" 2
...
int test_printf_taperr(const char *fmt, ...)
    __attribute__((__format__(__gnu_printf__, 1, 2)));
# 12 "../test/testutil/basic_output.c" 2
...
# 13 "../test/testutil/basic_output.c" 2
...
BIO *bio_out = 
# 18 "../test/testutil/basic_output.c" 3 4
              ((void *)0)
# 18 "../test/testutil/basic_output.c"
                  ;
BIO *bio_err = 
# 19 "../test/testutil/basic_output.c" 3 4
              ((void *)0)
# 19 "../test/testutil/basic_output.c"
                  ;


static BIO *tap_out = 
# 22 "../test/testutil/basic_output.c" 3 4
                     ((void *)0)
# 22 "../test/testutil/basic_output.c"
                         ;
static BIO *tap_err = 
# 23 "../test/testutil/basic_output.c" 3 4
                     ((void *)0)
# 23 "../test/testutil/basic_output.c"
                         ;


static CRYPTO_RWLOCK *io_lock = 
# 26 "../test/testutil/basic_output.c" 3 4
                               ((void *)0)
# 26 "../test/testutil/basic_output.c"
                                   ;
...
{
    tap_out = BIO_new_fp(
# 31 "../test/testutil/basic_output.c" 3 4
                        stdout
# 31 "../test/testutil/basic_output.c"
                              , 0x00 | 0x10);
    tap_err = BIO_new_fp(
# 32 "../test/testutil/basic_output.c" 3 4
                        stderr
# 32 "../test/testutil/basic_output.c"
                              , 0x00 | 0x10);
    ...
    BIO_ctrl((bio_out), 79, 0, (void *)("# "));
    BIO_ctrl((bio_err), 79, 0, (void *)("# "));
    ...
    (void)((bio_out != 
# 49 "../test/testutil/basic_output.c" 3 4
   ((void *)0)
# 49 "../test/testutil/basic_output.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "bio_out != NULL", "../test/testutil/basic_output.c", 49), 1));
    (void)((bio_err != 
# 50 "../test/testutil/basic_output.c" 3 4
   ((void *)0)
# 50 "../test/testutil/basic_output.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "bio_err != NULL", "../test/testutil/basic_output.c", 50), 1));

    (void)((io_lock != 
# 52 "../test/testutil/basic_output.c" 3 4
   ((void *)0)
# 52 "../test/testutil/basic_output.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "io_lock != NULL", "../test/testutil/basic_output.c", 52), 1));

}

void test_adjust_streams_tap_level(int level)
{
    BIO_ctrl((tap_out), 80, (level), 
# 58 "../test/testutil/basic_output.c" 3 4
   ((void *)0)
# 58 "../test/testutil/basic_output.c"
   );
    BIO_ctrl((tap_err), 80, (level), 
# 59 "../test/testutil/basic_output.c" 3 4
   ((void *)0)
# 59 "../test/testutil/basic_output.c"
   );
}
...
static inline void test_io_lock(void)
{
    ...
    (void)((CRYPTO_THREAD_write_lock(io_lock) > 0) ? 0 : (OPENSSL_die("assertion failed: " "CRYPTO_THREAD_write_lock(io_lock) > 0", "../test/testutil/basic_output.c", 82), 1));
...
int test_flush_stdout(void)
{
    ...
    test_io_lock();
    r = (int)BIO_ctrl(bio_out,11,0,
# 120 "../test/testutil/basic_output.c" 3 4
       ((void *)0)
# 120 "../test/testutil/basic_output.c"
       );
    test_io_unlock();
...
int test_flush_stderr(void)
{
    ...
    test_io_lock();
    r = (int)BIO_ctrl(bio_err,11,0,
# 131 "../test/testutil/basic_output.c" 3 4
       ((void *)0)
# 131 "../test/testutil/basic_output.c"
       );
    test_io_unlock();
...
int test_flush_tapout(void)
{
    ...
    test_io_lock();
    r = (int)BIO_ctrl(tap_out,11,0,
# 164 "../test/testutil/basic_output.c" 3 4
       ((void *)0)
# 164 "../test/testutil/basic_output.c"
       );
    test_io_unlock();
...
int test_flush_taperr(void)
{
    ...
    test_io_lock();
    r = (int)BIO_ctrl(tap_err,11,0,
# 175 "../test/testutil/basic_output.c" 3 4
       ((void *)0)
# 175 "../test/testutil/basic_output.c"
       );
    test_io_unlock();
