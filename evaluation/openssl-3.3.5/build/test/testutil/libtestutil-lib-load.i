# 0 "../test/testutil/load.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/load.c"
# 10 "../test/testutil/load.c"
...
# 17 "../test/testutil/load.c" 2

X509 *load_cert_pem(const char *file, OSSL_LIB_CTX *libctx)
{
    X509 *cert = 
# 20 "../test/testutil/load.c" 3 4
                ((void *)0)
# 20 "../test/testutil/load.c"
                    ;
    BIO *bio = 
# 21 "../test/testutil/load.c" 3 4
              ((void *)0)
# 21 "../test/testutil/load.c"
                  ;

    if (!test_ptr("../test/testutil/load.c", 23, "file", file) || !test_ptr("../test/testutil/load.c", 23, "bio = BIO_new(BIO_s_file())", bio = BIO_new(BIO_s_file())))
        return 
# 24 "../test/testutil/load.c" 3 4
              ((void *)0)
# 24 "../test/testutil/load.c"
                  ;
    if (test_int_gt("../test/testutil/load.c", 25, "BIO_read_filename(bio, file)", "0", (int)BIO_ctrl(bio,108, 0x01|0x02,(char *)(file)), 0)
            && test_ptr("../test/testutil/load.c", 26, "cert = X509_new_ex(libctx, NULL)", cert = X509_new_ex(libctx, 
# 26 "../test/testutil/load.c" 3 4
              ((void *)0)
# 26 "../test/testutil/load.c"
              )))
        (void)test_ptr("../test/testutil/load.c", 27, "cert = PEM_read_bio_X509(bio, &cert, NULL, NULL)", cert = PEM_read_bio_X509(bio, &cert, 
# 27 "../test/testutil/load.c" 3 4
             ((void *)0)
# 27 "../test/testutil/load.c"
             , 
# 27 "../test/testutil/load.c" 3 4
             ((void *)0)
# 27 "../test/testutil/load.c"
...
struct stack_st_X509 *load_certs_pem(const char *file)
{
    ...
    if (!test_ptr("../test/testutil/load.c", 39, "file", file) || (bio = BIO_new_file(file, "r")) == 
# 39 "../test/testutil/load.c" 3 4
                                                             ((void *)0)
# 39 "../test/testutil/load.c"
                                                                 )
        return 
# 40 "../test/testutil/load.c" 3 4
              ((void *)0)
# 40 "../test/testutil/load.c"
                  ;

    certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    if (certs == 
# 43 "../test/testutil/load.c" 3 4
                ((void *)0)
# 43 "../test/testutil/load.c"
                    ) {
        BIO_free(bio);
        return 
# 45 "../test/testutil/load.c" 3 4
              ((void *)0)
# 45 "../test/testutil/load.c"
                  ;
    }
...
# 50 "../test/testutil/load.c" 3 4
                                  ((void *)0)
# 50 "../test/testutil/load.c"
                                      , 0, 
# 50 "../test/testutil/load.c" 3 4
                                           ((void *)0)
# 50 "../test/testutil/load.c"
        ...
        if (x != 
# 51 "../test/testutil/load.c" 3 4
                ((void *)0) 
# 51 "../test/testutil/load.c"
                     && !OPENSSL_sk_push(ossl_check_X509_sk_type(certs), ossl_check_X509_type(x))) {
            OSSL_STACK_OF_X509_free(certs);
            BIO_free(bio);
            return 
# 54 "../test/testutil/load.c" 3 4
                  ((void *)0)
# 54 "../test/testutil/load.c"
                      ;
        } else if (x == 
# 55 "../test/testutil/load.c" 3 4
                       ((void *)0)
# 55 "../test/testutil/load.c"
                           ) {
...
# 62 "../test/testutil/load.c" 3 4
                 ((void *)0)
# 62 "../test/testutil/load.c"
                     );
...
{
    EVP_PKEY *key = 
# 71 "../test/testutil/load.c" 3 4
                   ((void *)0)
# 71 "../test/testutil/load.c"
                       ;
    BIO *bio = 
# 72 "../test/testutil/load.c" 3 4
              ((void *)0)
# 72 "../test/testutil/load.c"
                  ;

    if (!test_ptr("../test/testutil/load.c", 74, "file", file) || !test_ptr("../test/testutil/load.c", 74, "bio = BIO_new(BIO_s_file())", bio = BIO_new(BIO_s_file())))
        return 
# 75 "../test/testutil/load.c" 3 4
              ((void *)0)
# 75 "../test/testutil/load.c"
                  ;
    if (test_int_gt("../test/testutil/load.c", 76, "BIO_read_filename(bio, file)", "0", (int)BIO_ctrl(bio,108, 0x01|0x02,(char *)(file)), 0)) {
        unsigned long err = ERR_peek_error();

        if (test_ptr("../test/testutil/load.c", 79, "key = PEM_read_bio_PrivateKey_ex(bio, NULL, NULL, NULL, libctx, NULL)", key = PEM_read_bio_PrivateKey_ex(bio, 
# 79 "../test/testutil/load.c" 3 4
           ((void *)0)
# 79 "../test/testutil/load.c"
           , 
# 79 "../test/testutil/load.c" 3 4
           ((void *)0)
# 79 "../test/testutil/load.c"
...
# 79 "../test/testutil/load.c"
            ...
            && err != ERR_peek_error()) {
            test_info("../test/testutil/load.c", 82, "Spurious error from reading PEM");
            EVP_PKEY_free(key);
            key = 
# 84 "../test/testutil/load.c" 3 4
                 ((void *)0)
# 84 "../test/testutil/load.c"
                     ;
        }
    }
...
{
    X509_REQ *csr = 
# 94 "../test/testutil/load.c" 3 4
                   ((void *)0)
# 94 "../test/testutil/load.c"
                       ;
    BIO *bio = 
# 95 "../test/testutil/load.c" 3 4
              ((void *)0)
# 95 "../test/testutil/load.c"
                  ;

    if (!test_ptr("../test/testutil/load.c", 97, "file", file) || !test_ptr("../test/testutil/load.c", 97, "bio = BIO_new_file(file, \"rb\")", bio = BIO_new_file(file, "rb")))
        return 
# 98 "../test/testutil/load.c" 3 4
              ((void *)0)
# 98 "../test/testutil/load.c"
                  ;

    csr = X509_REQ_new_ex(libctx, 
# 100 "../test/testutil/load.c" 3 4
                                 ((void *)0)
# 100 "../test/testutil/load.c"
                                     );
    if (test_ptr("../test/testutil/load.c", 101, "csr", csr))
        (void)test_ptr("../test/testutil/load.c", 102, "d2i_X509_REQ_bio(bio, &csr)", d2i_X509_REQ_bio(bio, &csr));
    BIO_free(bio);
    return csr;
}
