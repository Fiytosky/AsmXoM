# 0 "../test/testutil/apps_shims.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/apps_shims.c"
# 10 "../test/testutil/apps_shims.c"
...
# 11 "../test/testutil/apps_shims.c" 2
...
# 12 "../test/testutil/apps_shims.c" 2
# 1 "../test/testutil/../testutil.h" 1
# 16 "../test/testutil/../testutil.h"
...
# 17 "../test/testutil/../testutil.h" 2




# 1 "../apps/include/opt.h" 1
# 22 "../test/testutil/../testutil.h" 2
# 200 "../test/testutil/../testutil.h"
...
# 273 "../test/testutil/../testutil.h"
int fips_provider_version_match(OSSL_LIB_CTX *libctx, const char *versions);
# 284 "../test/testutil/../testutil.h"
const OPTIONS *test_get_options(void);
# 317 "../test/testutil/../testutil.h"
...
# 13 "../test/testutil/apps_shims.c" 2
...
void *app_malloc(size_t sz, const char *what)
{
    ...
    if (!test_ptr("../test/testutil/apps_shims.c", 25, "vp = OPENSSL_malloc(sz)", vp = CRYPTO_malloc(sz, "../test/testutil/apps_shims.c", 25))) {
        test_info("../test/testutil/apps_shims.c", 26, "Could not allocate %zu bytes for %s\n", sz, what);
        abort();
    }
    return vp;
}
...
{
    return 
# 50 "../test/testutil/apps_shims.c" 3 4
          ((void *)0)
# 50 "../test/testutil/apps_shims.c"
              ;
}
...
{
    return 
# 55 "../test/testutil/apps_shims.c" 3 4
          ((void *)0)
# 55 "../test/testutil/apps_shims.c"
              ;
}
