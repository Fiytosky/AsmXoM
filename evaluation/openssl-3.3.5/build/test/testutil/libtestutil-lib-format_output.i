# 0 "../test/testutil/format_output.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/testutil/format_output.c"
# 10 "../test/testutil/format_output.c"
...
# 11 "../test/testutil/format_output.c" 2
...
int test_printf_taperr(const char *fmt, ...)
    __attribute__((__format__(__gnu_printf__, 1, 2)));
# 12 "../test/testutil/format_output.c" 2
...
# 13 "../test/testutil/format_output.c" 2
...
# 16 "../test/testutil/format_output.c" 2
...
# 23 "../test/testutil/format_output.c"
...
{
    if (m == 
# 32 "../test/testutil/format_output.c" 3 4
            ((void *)0)
# 32 "../test/testutil/format_output.c"
                )
...
{
    const size_t width =
        ((80) - BIO_ctrl((bio_err), 81, 0, 
# 45 "../test/testutil/format_output.c" 3 4
                           ((void *)0)
# 45 "../test/testutil/format_output.c"
                           ) - 12) / 16 * 16;
    char b1[(80) + 1], b2[(80) + 1];
    char bdiff[(80) + 1];
    size_t n1, n2, i;
    ...
    if (m1 == 
# 52 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 52 "../test/testutil/format_output.c"
                 )
        l1 = 0;
    if (m2 == 
# 54 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 54 "../test/testutil/format_output.c"
                 )
        l2 = 0;
    if (l1 == 0 && l2 == 0) {
        if ((m1 == 
# 57 "../test/testutil/format_output.c" 3 4
                  ((void *)0)
# 57 "../test/testutil/format_output.c"
                      ) == (m2 == 
# 57 "../test/testutil/format_output.c" 3 4
                                  ((void *)0)
# 57 "../test/testutil/format_output.c"
    ...
    while (l1 > 0 || l2 > 0) {
        ...
        if (l1 > 0) {
            ...
            for (i = 0; i < n1; i++)
                b1[i] = 
# 75 "../test/testutil/format_output.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 75 "../test/testutil/format_output.c"
                       (unsigned char)m1[i]
# 75 "../test/testutil/format_output.c" 3 4
...
# 75 "../test/testutil/format_output.c"
        ...
        if (l2 > 0) {
            ...
            for (i = 0; i < n2; i++)
                b2[i] = 
# 80 "../test/testutil/format_output.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 80 "../test/testutil/format_output.c"
                       (unsigned char)m2[i]
# 80 "../test/testutil/format_output.c" 3 4
                       ))] & (unsigned short int) _ISprint) 
# 80 "../test/testutil/format_output.c"
        ...
        if (n1 == n2 && !diff) {
            ...
            if (cnt == 0 && (m1 == 
# 99 "../test/testutil/format_output.c" 3 4
                                  ((void *)0) 
# 99 "../test/testutil/format_output.c"
                                       || *m1 == '\0'))
                test_string_null_empty(m1, '-');
            else if (n1 > 0)
                test_printf_stderr("%4u:- '%s'\n", cnt, b1);
            if (cnt == 0 && (m2 == 
# 103 "../test/testutil/format_output.c" 3 4
                                  ((void *)0) 
# 103 "../test/testutil/format_output.c"
                                       || *m2 == '\0'))
               test_string_null_empty(m2, '+');
            else if (n2 > 0)
                test_printf_stderr("%4u:+ '%s'\n", cnt, b2);
        ...
        if (m1 != 
# 110 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 110 "../test/testutil/format_output.c"
                     )
            m1 += n1;
        if (m2 != 
# 112 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 112 "../test/testutil/format_output.c"
                     )
            m2 += n2;
        l1 -= n1;
        l2 -= n2;
...
void test_output_string(const char *name, const char *m, size_t l)
{
    test_fail_string_common("string", 
# 140 "../test/testutil/format_output.c" 3 4
                                     ((void *)0)
# 140 "../test/testutil/format_output.c"
                                         , 0, 
# 140 "../test/testutil/format_output.c" 3 4
                                              ((void *)0)
# 140 "../test/testutil/format_output.c"
...
static const int bn_bytes = ((80) - 9) / ((8) * 2 + 1)
                            * (8);
static const int bn_chars = ((80) - 9) / ((8) * 2 + 1)
                            * ((8) * 2 + 1) - 1;
...
{
    if (bn != 
# 185 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 185 "../test/testutil/format_output.c"
                 )
...
static void test_bignum_zero_print(const BIGNUM *bn, char sep)
{
    ...
    const char *suf = bn != 
# 197 "../test/testutil/format_output.c" 3 4
                           ((void *)0) 
# 197 "../test/testutil/format_output.c"
                                ? ":    0" : "";
                             ...
                             char *out, int *lz, const BIGNUM *bn)
{
    int n = bytes * 2, i;
    char *p = out, *q = 
# 210 "../test/testutil/format_output.c" 3 4
                       ((void *)0)
# 210 "../test/testutil/format_output.c"
                           ;
    const char *r;

    if (bn != 
# 213 "../test/testutil/format_output.c" 3 4
             ((void *)0) 
# 213 "../test/testutil/format_output.c"
                  && !BN_is_zero(bn)) {
    ...
    *p = '\0';
    if (bn == 
# 253 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 253 "../test/testutil/format_output.c"
                 )
        r = "NULL";
    else
                                    ...
                                    const BIGNUM *bn1, const BIGNUM *bn2)
{
    ...
    unsigned char *m1 = 
# 276 "../test/testutil/format_output.c" 3 4
                       ((void *)0)
# 276 "../test/testutil/format_output.c"
                           , *m2 = 
# 276 "../test/testutil/format_output.c" 3 4
                                   ((void *)0)
# 276 "../test/testutil/format_output.c"
                                       ;
    int lz1 = 1, lz2 = 1;
    unsigned char buffer[(2000) * 2], *bufp = buffer;

    test_fail_message_prefix(prefix, file, line, type, left, right, op);
    l1 = bn1 == 
# 281 "../test/testutil/format_output.c" 3 4
               ((void *)0) 
# 281 "../test/testutil/format_output.c"
                    ? 0 : (((BN_num_bits(bn1)+7)/8) + (BN_is_negative(bn1) ? 1 : 0));
    l2 = bn2 == 
# 282 "../test/testutil/format_output.c" 3 4
               ((void *)0) 
# 282 "../test/testutil/format_output.c"
                    ? 0 : (((BN_num_bits(bn2)+7)/8) + (BN_is_negative(bn2) ? 1 : 0));
    if (l1 == 0 && l2 == 0) {
        if ((bn1 == 
# 284 "../test/testutil/format_output.c" 3 4
                   ((void *)0)
# 284 "../test/testutil/format_output.c"
                       ) == (bn2 == 
# 284 "../test/testutil/format_output.c" 3 4
                                    ((void *)0)
# 284 "../test/testutil/format_output.c"
    ...
    if (l1 != l2 || bn1 == 
# 296 "../test/testutil/format_output.c" 3 4
                          ((void *)0) 
# 296 "../test/testutil/format_output.c"
                               || bn2 == 
# 296 "../test/testutil/format_output.c" 3 4
                                         ((void *)0) 
# 296 "../test/testutil/format_output.c"
    ...
    if (len > (2000) && (bufp = CRYPTO_malloc(len * 2, "../test/testutil/format_output.c", 302)) == 
# 302 "../test/testutil/format_output.c" 3 4
                                                                    ((void *)0)
# 302 "../test/testutil/format_output.c"
                                                                        ) {
        bufp = buffer;
        len = (2000);
    ...
    if (bn1 != 
# 308 "../test/testutil/format_output.c" 3 4
              ((void *)0)
# 308 "../test/testutil/format_output.c"
                  ) {
        m1 = bufp;
        BN_bn2binpad(bn1, m1, len);
    }
    if (bn2 != 
# 312 "../test/testutil/format_output.c" 3 4
              ((void *)0)
# 312 "../test/testutil/format_output.c"
                  ) {
        m2 = bufp + len;
    ...
    while (len > 0) {
        ...
        *p++ = '\0';
        if (!diff) {
            ...
            if (cnt == 0 && bn1 == 
# 337 "../test/testutil/format_output.c" 3 4
                                  ((void *)0)
# 337 "../test/testutil/format_output.c"
                                      )
                test_printf_stderr("-%s\n", b1);
            else if (cnt == 0 || n1 > 0)
                test_printf_stderr("-%s:% 5d\n", b1, cnt);
            if (cnt == 0 && bn2 == 
# 341 "../test/testutil/format_output.c" 3 4
                                  ((void *)0)
# 341 "../test/testutil/format_output.c"
                                      )
                test_printf_stderr("+%s\n", b2);
            else if (cnt == 0 || n2 > 0)
                test_printf_stderr("+%s:% 5d\n", b2, cnt);
            if (real_diff && (cnt == 0 || (n1 > 0 && n2 > 0))
                    && bn1 != 
# 346 "../test/testutil/format_output.c" 3 4
                             ((void *)0) 
# 346 "../test/testutil/format_output.c"
                                  && bn2 != 
# 346 "../test/testutil/format_output.c" 3 4
                                            ((void *)0)
# 346 "../test/testutil/format_output.c"
        ...
        if (m1 != 
# 349 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 349 "../test/testutil/format_output.c"
                     )
            m1 += bytes;
        if (m2 != 
# 351 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 351 "../test/testutil/format_output.c"
                     )
            m2 += bytes;
        len -= bytes;
    }
fin:
    test_flush_stderr();
    if (bufp != buffer)
        CRYPTO_free(bufp, "../test/testutil/format_output.c", 358);
}
...
{
    if (bn == 
# 387 "../test/testutil/format_output.c" 3 4
             ((void *)0) 
# 387 "../test/testutil/format_output.c"
                  || BN_is_zero(bn)) {
        test_printf_stderr("bignum: '%s' = %s\n", name,
                           test_bignum_zero_null(bn));
    } else if (((BN_num_bits(bn)+7)/8) <= (8)) {
        unsigned char buf[(8)];
        char out[2 * sizeof(buf) + 1];
        char *p = out;
        int n = BN_bn2bin(bn, buf);

        hex_convert_memory(buf, n, p, (8));
        while (*p == '0' && *++p != '\0')
            ;
        test_printf_stderr("bignum: '%s' = %s0x%s\n", name,
                           BN_is_negative(bn) ? "-" : "", p);
    } else {
        test_fail_bignum_common("bignum", 
# 402 "../test/testutil/format_output.c" 3 4
                                         ((void *)0)
# 402 "../test/testutil/format_output.c"
                                             , 0, 
# 402 "../test/testutil/format_output.c" 3 4
                                                  ((void *)0)
# 402 "../test/testutil/format_output.c"
...
{
    if (m == 
# 414 "../test/testutil/format_output.c" 3 4
            ((void *)0)
# 414 "../test/testutil/format_output.c"
                )
                                    ...
                                    const unsigned char *m2, size_t l2)
{
    ...
    test_fail_message_prefix(prefix, file, line, type, left, right, op);
    if (m1 == 
# 437 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 437 "../test/testutil/format_output.c"
                 )
        l1 = 0;
    if (m2 == 
# 439 "../test/testutil/format_output.c" 3 4
             ((void *)0)
# 439 "../test/testutil/format_output.c"
                 )
        l2 = 0;
    if (l1 == 0 && l2 == 0) {
        if ((m1 == 
# 442 "../test/testutil/format_output.c" 3 4
                  ((void *)0)
# 442 "../test/testutil/format_output.c"
                      ) == (m2 == 
# 442 "../test/testutil/format_output.c" 3 4
                                  ((void *)0)
# 442 "../test/testutil/format_output.c"
    ...
    while (l1 > 0 || l2 > 0) {
        ...
        if (n1 == n2 && !diff) {
            ...
            if (cnt == 0 && (m1 == 
# 490 "../test/testutil/format_output.c" 3 4
                                  ((void *)0) 
# 490 "../test/testutil/format_output.c"
                                       || l1 == 0))
                test_memory_null_empty(m1, '-');
            else if (n1 > 0)
                test_printf_stderr("%04x:-%s\n", cnt, b1);
            if (cnt == 0 && (m2 == 
# 494 "../test/testutil/format_output.c" 3 4
                                  ((void *)0) 
# 494 "../test/testutil/format_output.c"
                                       || l2 == 0))
                test_memory_null_empty(m2, '+');
            else if (n2 > 0)
                test_printf_stderr("%04x:+%s\n", cnt, b2);
        ...
        if (m1 != 
# 501 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 501 "../test/testutil/format_output.c"
                     )
            m1 += n1;
        if (m2 != 
# 503 "../test/testutil/format_output.c" 3 4
                 ((void *)0)
# 503 "../test/testutil/format_output.c"
                     )
            m2 += n2;
        l1 -= n1;
        l2 -= n2;
...
void test_output_memory(const char *name, const unsigned char *m, size_t l)
{
    test_fail_memory_common("memory", 
# 532 "../test/testutil/format_output.c" 3 4
                                     ((void *)0)
# 532 "../test/testutil/format_output.c"
                                         , 0, 
# 532 "../test/testutil/format_output.c" 3 4
                                              ((void *)0)
# 532 "../test/testutil/format_output.c"
