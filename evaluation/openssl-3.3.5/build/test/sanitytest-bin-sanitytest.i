...
# 18 "../test/sanitytest.c" 2



# 20 "../test/sanitytest.c"
static int test_sanity_null_zero(void)
{
    ...
    p = 
# 26 "../test/sanitytest.c" 3 4
       ((void *)0)
# 26 "../test/sanitytest.c"
           ;
    memset(bytes, 0, sizeof(bytes));
    return test_mem_eq("../test/sanitytest.c", 28, "&p", "bytes", &p, sizeof(p), bytes, sizeof(bytes));
}
...
static int test_sanity_enum_size(void)
{
    ...
    if (!test_size_t_eq("../test/sanitytest.c", 49, "sizeof(enum smallchoices)", "sizeof(int)", sizeof(enum smallchoices), sizeof(int))
        || !test_size_t_eq("../test/sanitytest.c", 50, "sizeof(enum medchoices)", "sizeof(int)", sizeof(enum medchoices), sizeof(int))
        || !test_size_t_eq("../test/sanitytest.c", 51, "sizeof(enum largechoices)", "sizeof(int)", sizeof(enum largechoices), sizeof(int)))
        return 0;
    return 1;
}
...
static int test_sanity_twos_complement(void)
{
    ...
    if (!test_int_eq("../test/sanitytest.c", 59, "~(-1)", "0", ~(-1), 0)
        || !test_long_eq("../test/sanitytest.c", 60, "~(-1L)", "0L", ~(-1L), 0L))
        return 0;
    return 1;
}
...
static int test_sanity_sign(void)
{
    ...
    if (!test_int_eq("../test/sanitytest.c", 68, "-(INT_MIN + 1)", "INT_MAX", -(
# 68 "../test/sanitytest.c" 3 4
        (-0x7fffffff - 1) 
# 68 "../test/sanitytest.c"
        + 1), 0x7fffffff
# 68 "../test/sanitytest.c"
        )
        || !test_long_eq("../test/sanitytest.c", 69, "-(LONG_MIN + 1)", "LONG_MAX", -(
# 69 "../test/sanitytest.c" 3 4
           (-0x7fffffffffffffffL - 1L) 
# 69 "../test/sanitytest.c"
...
static int test_sanity_unsigned_conversion(void)
{
    ...
    if (!test_int_eq("../test/sanitytest.c", 77, "(int)((unsigned int)INT_MAX + 1)", "INT_MIN", (int)((unsigned int)0x7fffffff 
# 77 "../test/sanitytest.c"
        + 1), 
# 77 "../test/sanitytest.c" 3 4
        (-0x7fffffff - 1)
# 77 "../test/sanitytest.c"
        )
        || !test_long_eq("../test/sanitytest.c", 78, "(long)((unsigned long)LONG_MAX + 1)", "LONG_MIN", (long)((unsigned long)0x7fffffffffffffffL 
# 78 "../test/sanitytest.c"
           + 1), 
# 78 "../test/sanitytest.c" 3 4
           (-0x7fffffffffffffffL - 1L)
# 78 "../test/sanitytest.c"
           ))
        return 0;
...
static int test_sanity_range(void)
{
    ...
    if (!test_size_t_eq("../test/sanitytest.c", 86, "sizeof(int8_t)", "1", sizeof(int8_t), 1)
            || !test_size_t_eq("../test/sanitytest.c", 87, "sizeof(uint8_t)", "1", sizeof(uint8_t), 1)
            || !test_size_t_eq("../test/sanitytest.c", 88, "sizeof(int16_t)", "2", sizeof(int16_t), 2)
            || !test_size_t_eq("../test/sanitytest.c", 89, "sizeof(uint16_t)", "2", sizeof(uint16_t), 2)
            || !test_size_t_eq("../test/sanitytest.c", 90, "sizeof(int32_t)", "4", sizeof(int32_t), 4)
            || !test_size_t_eq("../test/sanitytest.c", 91, "sizeof(uint32_t)", "4", sizeof(uint32_t), 4)
            || !test_size_t_eq("../test/sanitytest.c", 92, "sizeof(int64_t)", "8", sizeof(int64_t), 8)
            || !test_size_t_eq("../test/sanitytest.c", 93, "sizeof(uint64_t)", "8", sizeof(uint64_t), 8)

            || !test_size_t_eq("../test/sanitytest.c", 95, "sizeof(int128_t)", "16", sizeof(int128_t), 16)
            || !test_size_t_eq("../test/sanitytest.c", 96, "sizeof(uint128_t)", "16", sizeof(uint128_t), 16)

            || !test_size_t_eq("../test/sanitytest.c", 98, "sizeof(char)", "1", sizeof(char), 1)
            || !test_size_t_eq("../test/sanitytest.c", 99, "sizeof(unsigned char)", "1", sizeof(unsigned char), 1))
        return 0;


    if (!test_size_t_ge("../test/sanitytest.c", 103, "sizeof(long long int)", "8", sizeof(long long int), 8)
            || !test_size_t_ge("../test/sanitytest.c", 104, "sizeof(unsigned long long int)", "8", sizeof(unsigned long long int), 8))
        return 0;
    ...
    if (!test_size_t_ge("../test/sanitytest.c", 112, "sizeof(ossl_intmax_t)", "8", sizeof(ossl_intmax_t), 8)
            || !test_size_t_ge("../test/sanitytest.c", 113, "sizeof(ossl_uintmax_t)", "8", sizeof(ossl_uintmax_t), 8)
            || !test_size_t_ge("../test/sanitytest.c", 114, "sizeof(ossl_uintmax_t)", "sizeof(size_t)", sizeof(ossl_uintmax_t), sizeof(size_t)))
        return 0;


    if (
# 118 "../test/sanitytest.c" 3 4
       (18446744073709551615UL) 
# 118 "../test/sanitytest.c"
                < 0x7fffffff
# 118 "../test/sanitytest.c"
                         ) {
        test_error("../test/sanitytest.c", 119, "int must not be wider than size_t");
        return 0;
    }


    if (
# 124 "../test/sanitytest.c" 3 4
       (18446744073709551615UL) 
# 124 "../test/sanitytest.c"
                - 0x7fffffff 
# 124 "../test/sanitytest.c"
                          <= 0x7fffffff
# 124 "../test/sanitytest.c"
                                    ) {
        test_error("../test/sanitytest.c", 125, "SIZE_MAX must exceed 2*INT_MAX");
        return 0;
    }
...
static int test_sanity_sleep(int i)
{
    ...
    do {
        ...
        sa.
# 165 "../test/sanitytest.c" 3 4
          __sigaction_handler.sa_handler 
# 165 "../test/sanitytest.c"
                     = alrm_handler;

        if (sigaction(
# 167 "../test/sanitytest.c" 3 4
                     14
# 167 "../test/sanitytest.c"
                            , &sa, 
# 167 "../test/sanitytest.c" 3 4
                                   ((void *)0)
# 167 "../test/sanitytest.c"
        ...
        sigemptyset(&mask);
        sigaddset(&mask, 
# 173 "../test/sanitytest.c" 3 4
                        14
# 173 "../test/sanitytest.c"
                               );
        if (sigprocmask(
# 174 "../test/sanitytest.c" 3 4
                       1
# 174 "../test/sanitytest.c"
                                  , &mask, 
# 174 "../test/sanitytest.c" 3 4
                                           ((void *)0)
# 174 "../test/sanitytest.c"
        ...
        if (setitimer(
# 179 "../test/sanitytest.c" 3 4
                     ITIMER_REAL
# 179 "../test/sanitytest.c"
                                , &it, 
# 179 "../test/sanitytest.c" 3 4
                                       ((void *)0)
# 179 "../test/sanitytest.c"
    ...
    do {
        ...
        if (setitimer(
# 197 "../test/sanitytest.c" 3 4
                     ITIMER_REAL
# 197 "../test/sanitytest.c"
                                , &it, 
# 197 "../test/sanitytest.c" 3 4
                                       ((void *)0)
# 197 "../test/sanitytest.c"
    ...
    ms = (ossl_time2ticks(ossl_time_subtract(ossl_time_now(), start)) / (((uint64_t)1000000000) / 1000));

    if (!test_uint64_t_ge("../test/sanitytest.c", 206, "ms", "td->val", ms, td->val) + !test_uint64_t_le("../test/sanitytest.c", 206, "ms", "td->val + 20000", ms, td->val + 20000))
        return 0;
    return 1;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_sanity_sleep", test_sanity_sleep, (sizeof(sleep_test_vectors)/sizeof((sleep_test_vectors)[0])), 1);
    return 1;
}
