# 0 "../test/rsa_x931_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rsa_x931_test.c"
# 10 "../test/rsa_x931_test.c"
...
# 16 "../test/rsa_x931_test.c" 2

static OSSL_PROVIDER *prov_null = 
# 17 "../test/rsa_x931_test.c" 3 4
                                 ((void *)0)
# 17 "../test/rsa_x931_test.c"
                                     ;
static OSSL_LIB_CTX *libctx = 
# 18 "../test/rsa_x931_test.c" 3 4
                             ((void *)0)
# 18 "../test/rsa_x931_test.c"
                                 ;
...
static int test_rsa_x931_keygen(void)
{
    int ret = 0;
    BIGNUM *e = 
# 23 "../test/rsa_x931_test.c" 3 4
               ((void *)0)
# 23 "../test/rsa_x931_test.c"
                   ;
    RSA *rsa = 
# 24 "../test/rsa_x931_test.c" 3 4
              ((void *)0)
# 24 "../test/rsa_x931_test.c"
                  ;

    ret = test_ptr("../test/rsa_x931_test.c", 26, "rsa = ossl_rsa_new_with_ctx(libctx)", rsa = ossl_rsa_new_with_ctx(libctx))
          && test_ptr("../test/rsa_x931_test.c", 27, "e = BN_new()", e = BN_new())
          && test_int_eq("../test/rsa_x931_test.c", 28, "BN_set_word(e, RSA_F4)", "1", BN_set_word(e, 0x10001L), 1)
          && test_int_eq("../test/rsa_x931_test.c", 29, "RSA_X931_generate_key_ex(rsa, 1024, e, NULL)", "1", RSA_X931_generate_key_ex(rsa, 1024, e, 
# 29 "../test/rsa_x931_test.c" 3 4
            ((void *)0)
# 29 "../test/rsa_x931_test.c"
            ), 1);
    BN_free(e);
    RSA_free(rsa);
    return ret;
...
int setup_tests(void)
{
    if (!test_get_libctx(&libctx, &prov_null, 
# 37 "../test/rsa_x931_test.c" 3 4
                                             ((void *)0)
# 37 "../test/rsa_x931_test.c"
                                                 , 
# 37 "../test/rsa_x931_test.c" 3 4
                                                   ((void *)0)
# 37 "../test/rsa_x931_test.c"
...
# 37 "../test/rsa_x931_test.c"
    ...
    add_test("test_rsa_x931_keygen", test_rsa_x931_keygen);
    return 1;
}
