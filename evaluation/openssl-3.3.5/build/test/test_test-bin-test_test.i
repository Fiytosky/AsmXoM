...
# 18 "../test/test_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 20 "../test/test_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
{
    if (!test_case((1), "TEST_int_eq(1, 1)", (test_int_eq("../test/test_test.c", 35, "1", "1", 1, 1)))
        || !test_case((0), "TEST_int_eq(1, -1)", (test_int_eq("../test/test_test.c", 36, "1", "-1", 1, -1)))
        || !test_case((1), "TEST_int_ne(1, 2)", (test_int_ne("../test/test_test.c", 37, "1", "2", 1, 2)))
        || !test_case((0), "TEST_int_ne(3, 3)", (test_int_ne("../test/test_test.c", 38, "3", "3", 3, 3)))
        || !test_case((1), "TEST_int_lt(4, 9)", (test_int_lt("../test/test_test.c", 39, "4", "9", 4, 9)))
        || !test_case((0), "TEST_int_lt(9, 4)", (test_int_lt("../test/test_test.c", 40, "9", "4", 9, 4)))
        || !test_case((1), "TEST_int_le(4, 9)", (test_int_le("../test/test_test.c", 41, "4", "9", 4, 9)))
        || !test_case((1), "TEST_int_le(5, 5)", (test_int_le("../test/test_test.c", 42, "5", "5", 5, 5)))
        || !test_case((0), "TEST_int_le(9, 4)", (test_int_le("../test/test_test.c", 43, "9", "4", 9, 4)))
        || !test_case((1), "TEST_int_gt(8, 5)", (test_int_gt("../test/test_test.c", 44, "8", "5", 8, 5)))
        || !test_case((0), "TEST_int_gt(5, 8)", (test_int_gt("../test/test_test.c", 45, "5", "8", 5, 8)))
        || !test_case((1), "TEST_int_ge(8, 5)", (test_int_ge("../test/test_test.c", 46, "8", "5", 8, 5)))
        || !test_case((1), "TEST_int_ge(6, 6)", (test_int_ge("../test/test_test.c", 47, "6", "6", 6, 6)))
        || !test_case((0), "TEST_int_ge(5, 8)", (test_int_ge("../test/test_test.c", 48, "5", "8", 5, 8))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_uint_eq(3u, 3u)", (test_uint_eq("../test/test_test.c", 58, "3u", "3u", 3u, 3u)))
        || !test_case((0), "TEST_uint_eq(3u, 5u)", (test_uint_eq("../test/test_test.c", 59, "3u", "5u", 3u, 5u)))
        || !test_case((1), "TEST_uint_ne(4u, 2u)", (test_uint_ne("../test/test_test.c", 60, "4u", "2u", 4u, 2u)))
        || !test_case((0), "TEST_uint_ne(6u, 6u)", (test_uint_ne("../test/test_test.c", 61, "6u", "6u", 6u, 6u)))
        || !test_case((1), "TEST_uint_lt(5u, 9u)", (test_uint_lt("../test/test_test.c", 62, "5u", "9u", 5u, 9u)))
        || !test_case((0), "TEST_uint_lt(9u, 5u)", (test_uint_lt("../test/test_test.c", 63, "9u", "5u", 9u, 5u)))
        || !test_case((1), "TEST_uint_le(5u, 9u)", (test_uint_le("../test/test_test.c", 64, "5u", "9u", 5u, 9u)))
        || !test_case((1), "TEST_uint_le(7u, 7u)", (test_uint_le("../test/test_test.c", 65, "7u", "7u", 7u, 7u)))
        || !test_case((0), "TEST_uint_le(9u, 5u)", (test_uint_le("../test/test_test.c", 66, "9u", "5u", 9u, 5u)))
        || !test_case((1), "TEST_uint_gt(11u, 1u)", (test_uint_gt("../test/test_test.c", 67, "11u", "1u", 11u, 1u)))
        || !test_case((0), "TEST_uint_gt(1u, 11u)", (test_uint_gt("../test/test_test.c", 68, "1u", "11u", 1u, 11u)))
        || !test_case((1), "TEST_uint_ge(11u, 1u)", (test_uint_ge("../test/test_test.c", 69, "11u", "1u", 11u, 1u)))
        || !test_case((1), "TEST_uint_ge(6u, 6u)", (test_uint_ge("../test/test_test.c", 70, "6u", "6u", 6u, 6u)))
        || !test_case((0), "TEST_uint_ge(1u, 11u)", (test_uint_ge("../test/test_test.c", 71, "1u", "11u", 1u, 11u))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_char_eq('a', 'a')", (test_char_eq("../test/test_test.c", 81, "'a'", "'a'", 'a', 'a')))
        || !test_case((0), "TEST_char_eq('a', 'A')", (test_char_eq("../test/test_test.c", 82, "'a'", "'A'", 'a', 'A')))
        || !test_case((1), "TEST_char_ne('a', 'c')", (test_char_ne("../test/test_test.c", 83, "'a'", "'c'", 'a', 'c')))
        || !test_case((0), "TEST_char_ne('e', 'e')", (test_char_ne("../test/test_test.c", 84, "'e'", "'e'", 'e', 'e')))
        || !test_case((1), "TEST_char_lt('i', 'x')", (test_char_lt("../test/test_test.c", 85, "'i'", "'x'", 'i', 'x')))
        || !test_case((0), "TEST_char_lt('x', 'i')", (test_char_lt("../test/test_test.c", 86, "'x'", "'i'", 'x', 'i')))
        || !test_case((1), "TEST_char_le('i', 'x')", (test_char_le("../test/test_test.c", 87, "'i'", "'x'", 'i', 'x')))
        || !test_case((1), "TEST_char_le('n', 'n')", (test_char_le("../test/test_test.c", 88, "'n'", "'n'", 'n', 'n')))
        || !test_case((0), "TEST_char_le('x', 'i')", (test_char_le("../test/test_test.c", 89, "'x'", "'i'", 'x', 'i')))
        || !test_case((1), "TEST_char_gt('w', 'n')", (test_char_gt("../test/test_test.c", 90, "'w'", "'n'", 'w', 'n')))
        || !test_case((0), "TEST_char_gt('n', 'w')", (test_char_gt("../test/test_test.c", 91, "'n'", "'w'", 'n', 'w')))
        || !test_case((1), "TEST_char_ge('w', 'n')", (test_char_ge("../test/test_test.c", 92, "'w'", "'n'", 'w', 'n')))
        || !test_case((1), "TEST_char_ge('p', 'p')", (test_char_ge("../test/test_test.c", 93, "'p'", "'p'", 'p', 'p')))
        || !test_case((0), "TEST_char_ge('n', 'w')", (test_char_ge("../test/test_test.c", 94, "'n'", "'w'", 'n', 'w'))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_uchar_eq(49, 49)", (test_uchar_eq("../test/test_test.c", 104, "49", "49", 49, 49)))
        || !test_case((0), "TEST_uchar_eq(49, 60)", (test_uchar_eq("../test/test_test.c", 105, "49", "60", 49, 60)))
        || !test_case((1), "TEST_uchar_ne(50, 2)", (test_uchar_ne("../test/test_test.c", 106, "50", "2", 50, 2)))
        || !test_case((0), "TEST_uchar_ne(66, 66)", (test_uchar_ne("../test/test_test.c", 107, "66", "66", 66, 66)))
        || !test_case((1), "TEST_uchar_lt(60, 80)", (test_uchar_lt("../test/test_test.c", 108, "60", "80", 60, 80)))
        || !test_case((0), "TEST_uchar_lt(80, 60)", (test_uchar_lt("../test/test_test.c", 109, "80", "60", 80, 60)))
        || !test_case((1), "TEST_uchar_le(60, 80)", (test_uchar_le("../test/test_test.c", 110, "60", "80", 60, 80)))
        || !test_case((1), "TEST_uchar_le(78, 78)", (test_uchar_le("../test/test_test.c", 111, "78", "78", 78, 78)))
        || !test_case((0), "TEST_uchar_le(80, 60)", (test_uchar_le("../test/test_test.c", 112, "80", "60", 80, 60)))
        || !test_case((1), "TEST_uchar_gt(88, 37)", (test_uchar_gt("../test/test_test.c", 113, "88", "37", 88, 37)))
        || !test_case((0), "TEST_uchar_gt(37, 88)", (test_uchar_gt("../test/test_test.c", 114, "37", "88", 37, 88)))
        || !test_case((1), "TEST_uchar_ge(88, 37)", (test_uchar_ge("../test/test_test.c", 115, "88", "37", 88, 37)))
        || !test_case((1), "TEST_uchar_ge(66, 66)", (test_uchar_ge("../test/test_test.c", 116, "66", "66", 66, 66)))
        || !test_case((0), "TEST_uchar_ge(37, 88)", (test_uchar_ge("../test/test_test.c", 117, "37", "88", 37, 88))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_long_eq(123l, 123l)", (test_long_eq("../test/test_test.c", 127, "123l", "123l", 123l, 123l)))
        || !test_case((0), "TEST_long_eq(123l, -123l)", (test_long_eq("../test/test_test.c", 128, "123l", "-123l", 123l, -123l)))
        || !test_case((1), "TEST_long_ne(123l, 500l)", (test_long_ne("../test/test_test.c", 129, "123l", "500l", 123l, 500l)))
        || !test_case((0), "TEST_long_ne(1000l, 1000l)", (test_long_ne("../test/test_test.c", 130, "1000l", "1000l", 1000l, 1000l)))
        || !test_case((1), "TEST_long_lt(-8923l, 102934563l)", (test_long_lt("../test/test_test.c", 131, "-8923l", "102934563l", -8923l, 102934563l)))
        || !test_case((0), "TEST_long_lt(102934563l, -8923l)", (test_long_lt("../test/test_test.c", 132, "102934563l", "-8923l", 102934563l, -8923l)))
        || !test_case((1), "TEST_long_le(-8923l, 102934563l)", (test_long_le("../test/test_test.c", 133, "-8923l", "102934563l", -8923l, 102934563l)))
        || !test_case((1), "TEST_long_le(12345l, 12345l)", (test_long_le("../test/test_test.c", 134, "12345l", "12345l", 12345l, 12345l)))
        || !test_case((0), "TEST_long_le(102934563l, -8923l)", (test_long_le("../test/test_test.c", 135, "102934563l", "-8923l", 102934563l, -8923l)))
        || !test_case((1), "TEST_long_gt(84325677l, 12345l)", (test_long_gt("../test/test_test.c", 136, "84325677l", "12345l", 84325677l, 12345l)))
        || !test_case((0), "TEST_long_gt(12345l, 84325677l)", (test_long_gt("../test/test_test.c", 137, "12345l", "84325677l", 12345l, 84325677l)))
        || !test_case((1), "TEST_long_ge(84325677l, 12345l)", (test_long_ge("../test/test_test.c", 138, "84325677l", "12345l", 84325677l, 12345l)))
        || !test_case((1), "TEST_long_ge(465869l, 465869l)", (test_long_ge("../test/test_test.c", 139, "465869l", "465869l", 465869l, 465869l)))
        || !test_case((0), "TEST_long_ge(12345l, 84325677l)", (test_long_ge("../test/test_test.c", 140, "12345l", "84325677l", 12345l, 84325677l))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_ulong_eq(919ul, 919ul)", (test_ulong_eq("../test/test_test.c", 150, "919ul", "919ul", 919ul, 919ul)))
        || !test_case((0), "TEST_ulong_eq(919ul, 10234ul)", (test_ulong_eq("../test/test_test.c", 151, "919ul", "10234ul", 919ul, 10234ul)))
        || !test_case((1), "TEST_ulong_ne(8190ul, 66ul)", (test_ulong_ne("../test/test_test.c", 152, "8190ul", "66ul", 8190ul, 66ul)))
        || !test_case((0), "TEST_ulong_ne(10555ul, 10555ul)", (test_ulong_ne("../test/test_test.c", 153, "10555ul", "10555ul", 10555ul, 10555ul)))
        || !test_case((1), "TEST_ulong_lt(10234ul, 1000000ul)", (test_ulong_lt("../test/test_test.c", 154, "10234ul", "1000000ul", 10234ul, 1000000ul)))
        || !test_case((0), "TEST_ulong_lt(1000000ul, 10234ul)", (test_ulong_lt("../test/test_test.c", 155, "1000000ul", "10234ul", 1000000ul, 10234ul)))
        || !test_case((1), "TEST_ulong_le(10234ul, 1000000ul)", (test_ulong_le("../test/test_test.c", 156, "10234ul", "1000000ul", 10234ul, 1000000ul)))
        || !test_case((1), "TEST_ulong_le(100000ul, 100000ul)", (test_ulong_le("../test/test_test.c", 157, "100000ul", "100000ul", 100000ul, 100000ul)))
        || !test_case((0), "TEST_ulong_le(1000000ul, 10234ul)", (test_ulong_le("../test/test_test.c", 158, "1000000ul", "10234ul", 1000000ul, 10234ul)))
        || !test_case((1), "TEST_ulong_gt(100000000ul, 22ul)", (test_ulong_gt("../test/test_test.c", 159, "100000000ul", "22ul", 100000000ul, 22ul)))
        || !test_case((0), "TEST_ulong_gt(22ul, 100000000ul)", (test_ulong_gt("../test/test_test.c", 160, "22ul", "100000000ul", 22ul, 100000000ul)))
        || !test_case((1), "TEST_ulong_ge(100000000ul, 22ul)", (test_ulong_ge("../test/test_test.c", 161, "100000000ul", "22ul", 100000000ul, 22ul)))
        || !test_case((1), "TEST_ulong_ge(10555ul, 10555ul)", (test_ulong_ge("../test/test_test.c", 162, "10555ul", "10555ul", 10555ul, 10555ul)))
        || !test_case((0), "TEST_ulong_ge(22ul, 100000000ul)", (test_ulong_ge("../test/test_test.c", 163, "22ul", "100000000ul", 22ul, 100000000ul))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_size_t_eq((size_t)10, (size_t)10)", (test_size_t_eq("../test/test_test.c", 173, "(size_t)10", "(size_t)10", (size_t)10, (size_t)10)))
        || !test_case((0), "TEST_size_t_eq((size_t)10, (size_t)12)", (test_size_t_eq("../test/test_test.c", 174, "(size_t)10", "(size_t)12", (size_t)10, (size_t)12)))
        || !test_case((1), "TEST_size_t_ne((size_t)10, (size_t)12)", (test_size_t_ne("../test/test_test.c", 175, "(size_t)10", "(size_t)12", (size_t)10, (size_t)12)))
        || !test_case((0), "TEST_size_t_ne((size_t)24, (size_t)24)", (test_size_t_ne("../test/test_test.c", 176, "(size_t)24", "(size_t)24", (size_t)24, (size_t)24)))
        || !test_case((1), "TEST_size_t_lt((size_t)30, (size_t)88)", (test_size_t_lt("../test/test_test.c", 177, "(size_t)30", "(size_t)88", (size_t)30, (size_t)88)))
        || !test_case((0), "TEST_size_t_lt((size_t)88, (size_t)30)", (test_size_t_lt("../test/test_test.c", 178, "(size_t)88", "(size_t)30", (size_t)88, (size_t)30)))
        || !test_case((1), "TEST_size_t_le((size_t)30, (size_t)88)", (test_size_t_le("../test/test_test.c", 179, "(size_t)30", "(size_t)88", (size_t)30, (size_t)88)))
        || !test_case((1), "TEST_size_t_le((size_t)33, (size_t)33)", (test_size_t_le("../test/test_test.c", 180, "(size_t)33", "(size_t)33", (size_t)33, (size_t)33)))
        || !test_case((0), "TEST_size_t_le((size_t)88, (size_t)30)", (test_size_t_le("../test/test_test.c", 181, "(size_t)88", "(size_t)30", (size_t)88, (size_t)30)))
        || !test_case((1), "TEST_size_t_gt((size_t)52, (size_t)33)", (test_size_t_gt("../test/test_test.c", 182, "(size_t)52", "(size_t)33", (size_t)52, (size_t)33)))
        || !test_case((0), "TEST_size_t_gt((size_t)33, (size_t)52)", (test_size_t_gt("../test/test_test.c", 183, "(size_t)33", "(size_t)52", (size_t)33, (size_t)52)))
        || !test_case((1), "TEST_size_t_ge((size_t)52, (size_t)33)", (test_size_t_ge("../test/test_test.c", 184, "(size_t)52", "(size_t)33", (size_t)52, (size_t)33)))
        || !test_case((1), "TEST_size_t_ge((size_t)38, (size_t)38)", (test_size_t_ge("../test/test_test.c", 185, "(size_t)38", "(size_t)38", (size_t)38, (size_t)38)))
        || !test_case((0), "TEST_size_t_ge((size_t)33, (size_t)52)", (test_size_t_ge("../test/test_test.c", 186, "(size_t)33", "(size_t)52", (size_t)33, (size_t)52))))
        goto err;
    return 1;
...
{
    if (!test_case((1), "TEST_time_t_eq((time_t)10, (time_t)10)", (test_time_t_eq("../test/test_test.c", 196, "(time_t)10", "(time_t)10", (time_t)10, (time_t)10)))
        || !test_case((0), "TEST_time_t_eq((time_t)10, (time_t)12)", (test_time_t_eq("../test/test_test.c", 197, "(time_t)10", "(time_t)12", (time_t)10, (time_t)12)))
        || !test_case((1), "TEST_time_t_ne((time_t)10, (time_t)12)", (test_time_t_ne("../test/test_test.c", 198, "(time_t)10", "(time_t)12", (time_t)10, (time_t)12)))
        || !test_case((0), "TEST_time_t_ne((time_t)24, (time_t)24)", (test_time_t_ne("../test/test_test.c", 199, "(time_t)24", "(time_t)24", (time_t)24, (time_t)24)))
        || !test_case((1), "TEST_time_t_lt((time_t)30, (time_t)88)", (test_time_t_lt("../test/test_test.c", 200, "(time_t)30", "(time_t)88", (time_t)30, (time_t)88)))
        || !test_case((0), "TEST_time_t_lt((time_t)88, (time_t)30)", (test_time_t_lt("../test/test_test.c", 201, "(time_t)88", "(time_t)30", (time_t)88, (time_t)30)))
        || !test_case((1), "TEST_time_t_le((time_t)30, (time_t)88)", (test_time_t_le("../test/test_test.c", 202, "(time_t)30", "(time_t)88", (time_t)30, (time_t)88)))
        || !test_case((1), "TEST_time_t_le((time_t)33, (time_t)33)", (test_time_t_le("../test/test_test.c", 203, "(time_t)33", "(time_t)33", (time_t)33, (time_t)33)))
        || !test_case((0), "TEST_time_t_le((time_t)88, (time_t)30)", (test_time_t_le("../test/test_test.c", 204, "(time_t)88", "(time_t)30", (time_t)88, (time_t)30)))
        || !test_case((1), "TEST_time_t_gt((time_t)52, (time_t)33)", (test_time_t_gt("../test/test_test.c", 205, "(time_t)52", "(time_t)33", (time_t)52, (time_t)33)))
        || !test_case((0), "TEST_time_t_gt((time_t)33, (time_t)52)", (test_time_t_gt("../test/test_test.c", 206, "(time_t)33", "(time_t)52", (time_t)33, (time_t)52)))
        || !test_case((1), "TEST_time_t_ge((time_t)52, (time_t)33)", (test_time_t_ge("../test/test_test.c", 207, "(time_t)52", "(time_t)33", (time_t)52, (time_t)33)))
        || !test_case((1), "TEST_time_t_ge((time_t)38, (time_t)38)", (test_time_t_ge("../test/test_test.c", 208, "(time_t)38", "(time_t)38", (time_t)38, (time_t)38)))
        || !test_case((0), "TEST_time_t_ge((time_t)33, (time_t)52)", (test_time_t_ge("../test/test_test.c", 209, "(time_t)33", "(time_t)52", (time_t)33, (time_t)52))))
        goto err;
    return 1;
...
static int test_pointer(void)
{
    ...
    if (!test_case((1), "TEST_ptr(&y)", (test_ptr("../test/test_test.c", 222, "&y", &y)))
        || !test_case((0), "TEST_ptr(NULL)", (test_ptr("../test/test_test.c", 223, "NULL", 
# 223 "../test/test_test.c" 3 4
           ((void *)0)
# 223 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_ptr_null(&y)", (test_ptr_null("../test/test_test.c", 224, "&y", &y)))
        || !test_case((1), "TEST_ptr_null(NULL)", (test_ptr_null("../test/test_test.c", 225, "NULL", 
# 225 "../test/test_test.c" 3 4
           ((void *)0)
# 225 "../test/test_test.c"
           )))
        || !test_case((1), "TEST_ptr_eq(NULL, NULL)", (test_ptr_eq("../test/test_test.c", 226, "NULL", "NULL", 
# 226 "../test/test_test.c" 3 4
           ((void *)0)
# 226 "../test/test_test.c"
           , 
# 226 "../test/test_test.c" 3 4
           ((void *)0)
# 226 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_ptr_eq(NULL, &y)", (test_ptr_eq("../test/test_test.c", 227, "NULL", "&y", 
# 227 "../test/test_test.c" 3 4
           ((void *)0)
# 227 "../test/test_test.c"
           , &y)))
        || !test_case((0), "TEST_ptr_eq(&y, NULL)", (test_ptr_eq("../test/test_test.c", 228, "&y", "NULL", &y, 
# 228 "../test/test_test.c" 3 4
           ((void *)0)
# 228 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_ptr_eq(&y, &x)", (test_ptr_eq("../test/test_test.c", 229, "&y", "&x", &y, &x)))
        || !test_case((1), "TEST_ptr_eq(&x, &x)", (test_ptr_eq("../test/test_test.c", 230, "&x", "&x", &x, &x)))
        || !test_case((0), "TEST_ptr_ne(NULL, NULL)", (test_ptr_ne("../test/test_test.c", 231, "NULL", "NULL", 
# 231 "../test/test_test.c" 3 4
           ((void *)0)
# 231 "../test/test_test.c"
           , 
# 231 "../test/test_test.c" 3 4
           ((void *)0)
# 231 "../test/test_test.c"
           )))
        || !test_case((1), "TEST_ptr_ne(NULL, &y)", (test_ptr_ne("../test/test_test.c", 232, "NULL", "&y", 
# 232 "../test/test_test.c" 3 4
           ((void *)0)
# 232 "../test/test_test.c"
           , &y)))
        || !test_case((1), "TEST_ptr_ne(&y, NULL)", (test_ptr_ne("../test/test_test.c", 233, "&y", "NULL", &y, 
# 233 "../test/test_test.c" 3 4
           ((void *)0)
# 233 "../test/test_test.c"
           )))
        || !test_case((1), "TEST_ptr_ne(&y, &x)", (test_ptr_ne("../test/test_test.c", 234, "&y", "&x", &y, &x)))
        || !test_case((0), "TEST_ptr_ne(&x, &x)", (test_ptr_ne("../test/test_test.c", 235, "&x", "&x", &x, &x))))
        goto err;
    return 1;
...
{
    if (!test_case((0), "TEST_true(0)", (test_true("../test/test_test.c", 245, "0", (0) != 0)))
        || !test_case((1), "TEST_true(1)", (test_true("../test/test_test.c", 246, "1", (1) != 0)))
        || !test_case((1), "TEST_false(0)", (test_false("../test/test_test.c", 247, "0", (0) != 0)))
        || !test_case((0), "TEST_false(1)", (test_false("../test/test_test.c", 248, "1", (1) != 0))))
        goto err;
    return 1;
...
static int test_string(void)
{
    ...
    if (!test_case((1), "TEST_str_eq(NULL, NULL)", (test_str_eq("../test/test_test.c", 260, "NULL", "NULL", 
# 260 "../test/test_test.c" 3 4
        ((void *)0)
# 260 "../test/test_test.c"
        , 
# 260 "../test/test_test.c" 3 4
        ((void *)0)
# 260 "../test/test_test.c"
        )))
        || !test_case((1), "TEST_str_eq(\"abc\", buf)", (test_str_eq("../test/test_test.c", 261, "\"abc\"", "buf", "abc", buf)))
        || !test_case((0), "TEST_str_eq(\"abc\", NULL)", (test_str_eq("../test/test_test.c", 262, "\"abc\"", "NULL", "abc", 
# 262 "../test/test_test.c" 3 4
           ((void *)0)
# 262 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_str_eq(\"abc\", \"\")", (test_str_eq("../test/test_test.c", 263, "\"abc\"", "\"\"", "abc", "")))
        || !test_case((0), "TEST_str_eq(NULL, buf)", (test_str_eq("../test/test_test.c", 264, "NULL", "buf", 
# 264 "../test/test_test.c" 3 4
           ((void *)0)
# 264 "../test/test_test.c"
           , buf)))
        || !test_case((0), "TEST_str_ne(NULL, NULL)", (test_str_ne("../test/test_test.c", 265, "NULL", "NULL", 
# 265 "../test/test_test.c" 3 4
           ((void *)0)
# 265 "../test/test_test.c"
           , 
# 265 "../test/test_test.c" 3 4
           ((void *)0)
# 265 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_str_eq(\"\", NULL)", (test_str_eq("../test/test_test.c", 266, "\"\"", "NULL", "", 
# 266 "../test/test_test.c" 3 4
           ((void *)0)
# 266 "../test/test_test.c"
           )))
        || !test_case((0), "TEST_str_eq(NULL, \"\")", (test_str_eq("../test/test_test.c", 267, "NULL", "\"\"", 
# 267 "../test/test_test.c" 3 4
           ((void *)0)
# 267 "../test/test_test.c"
           , "")))
        || !test_case((0), "TEST_str_ne(\"\", \"\")", (test_str_ne("../test/test_test.c", 268, "\"\"", "\"\"", "", "")))
        || !test_case((0), "TEST_str_eq(\"\\1\\2\\3\\4\\5\", \"\\1x\\3\\6\\5\")", (test_str_eq("../test/test_test.c", 269, "\"\\1\\2\\3\\4\\5\"", "\"\\1x\\3\\6\\5\"", "\1\2\3\4\5", "\1x\3\6\5")))
        || !test_case((0), "TEST_str_ne(\"abc\", buf)", (test_str_ne("../test/test_test.c", 270, "\"abc\"", "buf", "abc", buf)))
        || !test_case((1), "TEST_str_ne(\"abc\", NULL)", (test_str_ne("../test/test_test.c", 271, "\"abc\"", "NULL", "abc", 
# 271 "../test/test_test.c" 3 4
           ((void *)0)
# 271 "../test/test_test.c"
           )))
        || !test_case((1), "TEST_str_ne(NULL, buf)", (test_str_ne("../test/test_test.c", 272, "NULL", "buf", 
# 272 "../test/test_test.c" 3 4
           ((void *)0)
# 272 "../test/test_test.c"
           , buf)))
        || !test_case((0), "TEST_str_eq(\"abcdef\", \"abcdefghijk\")", (test_str_eq("../test/test_test.c", 273, "\"abcdef\"", "\"abcdefghijk\"", "abcdef", "abcdefghijk"))))
        goto err;
    return 1;
...
static int test_memory(void)
{
    ...
    if (!test_case((1), "TEST_mem_eq(NULL, 0, NULL, 0)", (test_mem_eq("../test/test_test.c", 285, "NULL", "NULL", 
# 285 "../test/test_test.c" 3 4
        ((void *)0)
# 285 "../test/test_test.c"
        , 0, 
# 285 "../test/test_test.c" 3 4
        ((void *)0)
# 285 "../test/test_test.c"
        , 0)))
        || !test_case((1), "TEST_mem_eq(NULL, 1, NULL, 2)", (test_mem_eq("../test/test_test.c", 286, "NULL", "NULL", 
# 286 "../test/test_test.c" 3 4
           ((void *)0)
# 286 "../test/test_test.c"
           , 1, 
# 286 "../test/test_test.c" 3 4
           ((void *)0)
# 286 "../test/test_test.c"
           , 2)))
        || !test_case((0), "TEST_mem_eq(NULL, 0, \"xyz\", 3)", (test_mem_eq("../test/test_test.c", 287, "NULL", "\"xyz\"", 
# 287 "../test/test_test.c" 3 4
           ((void *)0)
# 287 "../test/test_test.c"
           , 0, "xyz", 3)))
        || !test_case((0), "TEST_mem_eq(NULL, 7, \"abc\", 3)", (test_mem_eq("../test/test_test.c", 288, "NULL", "\"abc\"", 
# 288 "../test/test_test.c" 3 4
           ((void *)0)
# 288 "../test/test_test.c"
           , 7, "abc", 3)))
        || !test_case((0), "TEST_mem_ne(NULL, 0, NULL, 0)", (test_mem_ne("../test/test_test.c", 289, "NULL", "NULL", 
# 289 "../test/test_test.c" 3 4
           ((void *)0)
# 289 "../test/test_test.c"
           , 0, 
# 289 "../test/test_test.c" 3 4
           ((void *)0)
# 289 "../test/test_test.c"
           , 0)))
        || !test_case((0), "TEST_mem_eq(NULL, 0, \"\", 0)", (test_mem_eq("../test/test_test.c", 290, "NULL", "\"\"", 
# 290 "../test/test_test.c" 3 4
           ((void *)0)
# 290 "../test/test_test.c"
           , 0, "", 0)))
        || !test_case((0), "TEST_mem_eq(\"\", 0, NULL, 0)", (test_mem_eq("../test/test_test.c", 291, "\"\"", "NULL", "", 0, 
# 291 "../test/test_test.c" 3 4
           ((void *)0)
# 291 "../test/test_test.c"
           , 0)))
        || !test_case((0), "TEST_mem_ne(\"\", 0, \"\", 0)", (test_mem_ne("../test/test_test.c", 292, "\"\"", "\"\"", "", 0, "", 0)))
        || !test_case((0), "TEST_mem_eq(\"xyz\", 3, NULL, 0)", (test_mem_eq("../test/test_test.c", 293, "\"xyz\"", "NULL", "xyz", 3, 
# 293 "../test/test_test.c" 3 4
           ((void *)0)
# 293 "../test/test_test.c"
           , 0)))
        || !test_case((0), "TEST_mem_eq(\"xyz\", 3, buf, sizeof(buf))", (test_mem_eq("../test/test_test.c", 294, "\"xyz\"", "buf", "xyz", 3, buf, sizeof(buf))))
        || !test_case((1), "TEST_mem_eq(\"xyz\", 4, buf, sizeof(buf))", (test_mem_eq("../test/test_test.c", 295, "\"xyz\"", "buf", "xyz", 4, buf, sizeof(buf)))))
        goto err;
    return 1;
...
static int test_memory_overflow(void)
{
    ...
    return test_case((0), "TEST_mem_eq(p, strlen(p), q, strlen(q))", (test_mem_eq("../test/test_test.c", 309, "p", "q", p, strlen(p), q, strlen(q))));
}

static int test_bignum(void)
{
    BIGNUM *a = 
# 314 "../test/test_test.c" 3 4
               ((void *)0)
# 314 "../test/test_test.c"
                   , *b = 
# 314 "../test/test_test.c" 3 4
                          ((void *)0)
# 314 "../test/test_test.c"
...
# 314 "../test/test_test.c"
    ...
    if (!test_case((1), "TEST_int_eq(BN_dec2bn(&a, \"0\"), 1)", (test_int_eq("../test/test_test.c", 317, "BN_dec2bn(&a, \"0\")", "1", BN_dec2bn(&a, "0"), 1)))
        || !test_case((1), "TEST_BN_eq_word(a, 0)", (test_BN_eq_word("../test/test_test.c", 318, "a", "0", a, 0)))
        || !test_case((0), "TEST_BN_eq_word(a, 30)", (test_BN_eq_word("../test/test_test.c", 319, "a", "30", a, 30)))
        || !test_case((1), "TEST_BN_abs_eq_word(a, 0)", (test_BN_abs_eq_word("../test/test_test.c", 320, "a", "0", a, 0)))
        || !test_case((0), "TEST_BN_eq_one(a)", (test_BN_eq_one("../test/test_test.c", 321, "a", a)))
        || !test_case((1), "TEST_BN_eq_zero(a)", (test_BN_eq_zero("../test/test_test.c", 322, "a", a)))
        || !test_case((0), "TEST_BN_ne_zero(a)", (test_BN_ne_zero("../test/test_test.c", 323, "a", a)))
        || !test_case((1), "TEST_BN_le_zero(a)", (test_BN_le_zero("../test/test_test.c", 324, "a", a)))
        || !test_case((0), "TEST_BN_lt_zero(a)", (test_BN_lt_zero("../test/test_test.c", 325, "a", a)))
        || !test_case((1), "TEST_BN_ge_zero(a)", (test_BN_ge_zero("../test/test_test.c", 326, "a", a)))
        || !test_case((0), "TEST_BN_gt_zero(a)", (test_BN_gt_zero("../test/test_test.c", 327, "a", a)))
        || !test_case((1), "TEST_BN_even(a)", (test_BN_even("../test/test_test.c", 328, "a", a)))
        || !test_case((0), "TEST_BN_odd(a)", (test_BN_odd("../test/test_test.c", 329, "a", a)))
        || !test_case((1), "TEST_BN_eq(b, c)", (test_BN_eq("../test/test_test.c", 330, "b", "c", b, c)))
        || !test_case((0), "TEST_BN_eq(a, b)", (test_BN_eq("../test/test_test.c", 331, "a", "b", a, b)))
        || !test_case((0), "TEST_BN_ne(NULL, c)", (test_BN_ne("../test/test_test.c", 332, "NULL", "c", 
# 332 "../test/test_test.c" 3 4
           ((void *)0)
# 332 "../test/test_test.c"
           , c)))
        || !test_case((1), "TEST_int_eq(BN_dec2bn(&b, \"1\"), 1)", (test_int_eq("../test/test_test.c", 333, "BN_dec2bn(&b, \"1\")", "1", BN_dec2bn(&b, "1"), 1)))
        || !test_case((1), "TEST_BN_eq_word(b, 1)", (test_BN_eq_word("../test/test_test.c", 334, "b", "1", b, 1)))
        || !test_case((1), "TEST_BN_eq_one(b)", (test_BN_eq_one("../test/test_test.c", 335, "b", b)))
        || !test_case((0), "TEST_BN_abs_eq_word(b, 0)", (test_BN_abs_eq_word("../test/test_test.c", 336, "b", "0", b, 0)))
        || !test_case((1), "TEST_BN_abs_eq_word(b, 1)", (test_BN_abs_eq_word("../test/test_test.c", 337, "b", "1", b, 1)))
        || !test_case((0), "TEST_BN_eq_zero(b)", (test_BN_eq_zero("../test/test_test.c", 338, "b", b)))
        || !test_case((1), "TEST_BN_ne_zero(b)", (test_BN_ne_zero("../test/test_test.c", 339, "b", b)))
        || !test_case((0), "TEST_BN_le_zero(b)", (test_BN_le_zero("../test/test_test.c", 340, "b", b)))
        || !test_case((0), "TEST_BN_lt_zero(b)", (test_BN_lt_zero("../test/test_test.c", 341, "b", b)))
        || !test_case((1), "TEST_BN_ge_zero(b)", (test_BN_ge_zero("../test/test_test.c", 342, "b", b)))
        || !test_case((1), "TEST_BN_gt_zero(b)", (test_BN_gt_zero("../test/test_test.c", 343, "b", b)))
        || !test_case((0), "TEST_BN_even(b)", (test_BN_even("../test/test_test.c", 344, "b", b)))
        || !test_case((1), "TEST_BN_odd(b)", (test_BN_odd("../test/test_test.c", 345, "b", b)))
        || !test_case((1), "TEST_int_eq(BN_dec2bn(&c, \"-334739439\"), 10)", (test_int_eq("../test/test_test.c", 346, "BN_dec2bn(&c, \"-334739439\")", "10", BN_dec2bn(&c, "-334739439"), 10)))
        || !test_case((0), "TEST_BN_eq_word(c, 334739439)", (test_BN_eq_word("../test/test_test.c", 347, "c", "334739439", c, 334739439)))
        || !test_case((1), "TEST_BN_abs_eq_word(c, 334739439)", (test_BN_abs_eq_word("../test/test_test.c", 348, "c", "334739439", c, 334739439)))
        || !test_case((0), "TEST_BN_eq_zero(c)", (test_BN_eq_zero("../test/test_test.c", 349, "c", c)))
        || !test_case((1), "TEST_BN_ne_zero(c)", (test_BN_ne_zero("../test/test_test.c", 350, "c", c)))
        || !test_case((1), "TEST_BN_le_zero(c)", (test_BN_le_zero("../test/test_test.c", 351, "c", c)))
        || !test_case((1), "TEST_BN_lt_zero(c)", (test_BN_lt_zero("../test/test_test.c", 352, "c", c)))
        || !test_case((0), "TEST_BN_ge_zero(c)", (test_BN_ge_zero("../test/test_test.c", 353, "c", c)))
        || !test_case((0), "TEST_BN_gt_zero(c)", (test_BN_gt_zero("../test/test_test.c", 354, "c", c)))
        || !test_case((0), "TEST_BN_even(c)", (test_BN_even("../test/test_test.c", 355, "c", c)))
        || !test_case((1), "TEST_BN_odd(c)", (test_BN_odd("../test/test_test.c", 356, "c", c)))
        || !test_case((1), "TEST_BN_eq(a, a)", (test_BN_eq("../test/test_test.c", 357, "a", "a", a, a)))
        || !test_case((0), "TEST_BN_ne(a, a)", (test_BN_ne("../test/test_test.c", 358, "a", "a", a, a)))
        || !test_case((0), "TEST_BN_eq(a, b)", (test_BN_eq("../test/test_test.c", 359, "a", "b", a, b)))
        || !test_case((1), "TEST_BN_ne(a, b)", (test_BN_ne("../test/test_test.c", 360, "a", "b", a, b)))
        || !test_case((0), "TEST_BN_lt(a, c)", (test_BN_lt("../test/test_test.c", 361, "a", "c", a, c)))
        || !test_case((1), "TEST_BN_lt(c, b)", (test_BN_lt("../test/test_test.c", 362, "c", "b", c, b)))
        || !test_case((0), "TEST_BN_lt(b, c)", (test_BN_lt("../test/test_test.c", 363, "b", "c", b, c)))
        || !test_case((0), "TEST_BN_le(a, c)", (test_BN_le("../test/test_test.c", 364, "a", "c", a, c)))
        || !test_case((1), "TEST_BN_le(c, b)", (test_BN_le("../test/test_test.c", 365, "c", "b", c, b)))
        || !test_case((0), "TEST_BN_le(b, c)", (test_BN_le("../test/test_test.c", 366, "b", "c", b, c)))
        || !test_case((1), "TEST_BN_gt(a, c)", (test_BN_gt("../test/test_test.c", 367, "a", "c", a, c)))
        || !test_case((0), "TEST_BN_gt(c, b)", (test_BN_gt("../test/test_test.c", 368, "c", "b", c, b)))
        || !test_case((1), "TEST_BN_gt(b, c)", (test_BN_gt("../test/test_test.c", 369, "b", "c", b, c)))
        || !test_case((1), "TEST_BN_ge(a, c)", (test_BN_ge("../test/test_test.c", 370, "a", "c", a, c)))
        || !test_case((0), "TEST_BN_ge(c, b)", (test_BN_ge("../test/test_test.c", 371, "c", "b", c, b)))
        || !test_case((1), "TEST_BN_ge(b, c)", (test_BN_ge("../test/test_test.c", 372, "b", "c", b, c))))
        goto err;
...
static int test_long_output(void)
{
    ...
    return test_case((0), "TEST_str_eq(p, q)", (test_str_eq("../test/test_test.c", 395, "p", "q", p, q)))
           & test_case((0), "TEST_str_eq(q, r)", (test_str_eq("../test/test_test.c", 396, "q", "r", q, r)))
           & test_case((0), "TEST_str_eq(r, s)", (test_str_eq("../test/test_test.c", 397, "r", "s", r, s)))
           & test_case((0), "TEST_mem_eq(r, strlen(r), s, strlen(s))", (test_mem_eq("../test/test_test.c", 398, "r", "s", r, strlen(r), s, strlen(s))));
}
...
static int test_long_bignum(void)
{
    int r;
    BIGNUM *a = 
# 404 "../test/test_test.c" 3 4
               ((void *)0)
# 404 "../test/test_test.c"
                   , *b = 
# 404 "../test/test_test.c" 3 4
                          ((void *)0)
# 404 "../test/test_test.c"
...
# 404 "../test/test_test.c"
    ...
    r = test_true("../test/test_test.c", 424, "BN_hex2bn(&a, as)", (BN_hex2bn(&a, as)) != 0)
        && test_true("../test/test_test.c", 425, "BN_hex2bn(&b, bs)", (BN_hex2bn(&b, bs)) != 0)
        && test_true("../test/test_test.c", 426, "BN_hex2bn(&c, cs)", (BN_hex2bn(&c, cs)) != 0)
        && test_true("../test/test_test.c", 427, "BN_hex2bn(&d, ds)", (BN_hex2bn(&d, ds)) != 0)
        && (test_case((0), "TEST_BN_eq(a, b)", (test_BN_eq("../test/test_test.c", 428, "a", "b", a, b)))
            & test_case((0), "TEST_BN_eq(b, a)", (test_BN_eq("../test/test_test.c", 429, "b", "a", b, a)))
            & test_case((0), "TEST_BN_eq(b, NULL)", (test_BN_eq("../test/test_test.c", 430, "b", "NULL", b, 
# 430 "../test/test_test.c" 3 4
             ((void *)0)
# 430 "../test/test_test.c"
             )))
            & test_case((0), "TEST_BN_eq(NULL, a)", (test_BN_eq("../test/test_test.c", 431, "NULL", "a", 
# 431 "../test/test_test.c" 3 4
             ((void *)0)
# 431 "../test/test_test.c"
             , a)))
            & test_case((1), "TEST_BN_ne(a, NULL)", (test_BN_ne("../test/test_test.c", 432, "a", "NULL", a, 
# 432 "../test/test_test.c" 3 4
             ((void *)0)
# 432 "../test/test_test.c"
             )))
            & test_case((0), "TEST_BN_eq(c, d)", (test_BN_eq("../test/test_test.c", 433, "c", "d", c, d))));
    BN_free(a);
    BN_free(b);
    BN_free(c);
    BN_free(d);
...
{
    test_info("../test/test_test.c", 443, "This is an %s message.", "info");
    test_error("../test/test_test.c", 444, "This is an %s message.", "error");
    return 1;
}
...
static int test_single_eval(void)
{
    ...
    return test_int_eq("../test/test_test.c", 459, "i++", "4", i++, 4)
           && test_int_eq("../test/test_test.c", 460, "i", "5", i, 5)
           && test_int_gt("../test/test_test.c", 461, "++i", "5", ++i, 5)
           && test_int_le("../test/test_test.c", 462, "5", "i++", 5, i++)
           && test_int_ne("../test/test_test.c", 463, "--i", "5", --i, 5)
           && test_int_eq("../test/test_test.c", 464, "12", "i *= 2", 12, i *= 2)

           && test_long_eq("../test/test_test.c", 466, "l--", "-9000L", l--, -9000L)
           && test_long_eq("../test/test_test.c", 467, "++l", "-9000L", ++l, -9000L)
           && test_long_ne("../test/test_test.c", 468, "-9000L", "l /= 2", -9000L, l /= 2)
           && test_long_lt("../test/test_test.c", 469, "--l", "-4500L", --l, -4500L)

           && test_char_eq("../test/test_test.c", 471, "++c", "'e'", ++c, 'e')
           && test_char_eq("../test/test_test.c", 472, "'e'", "c--", 'e', c--)
           && test_char_ne("../test/test_test.c", 473, "'d'", "--c", 'd', --c)
           && test_char_le("../test/test_test.c", 474, "'b'", "--c", 'b', --c)
           && test_char_lt("../test/test_test.c", 475, "c++", "'c'", c++, 'c')

           && test_uchar_eq("../test/test_test.c", 477, "22", "uc++", 22, uc++)
           && test_uchar_eq("../test/test_test.c", 478, "uc /= 2", "11", uc /= 2, 11)
           && test_ulong_eq("../test/test_test.c", 479, "ul ^= 1", "501", ul ^= 1, 501)
           && test_ulong_eq("../test/test_test.c", 480, "502", "ul ^= 3", 502, ul ^= 3)
           && test_ulong_eq("../test/test_test.c", 481, "ul = ul * 3 - 6", "1500", ul = ul * 3 - 6, 1500)

           && test_size_t_eq("../test/test_test.c", 483, "(--i, st++)", "1234", (--i, st++), 1234)
           && test_size_t_eq("../test/test_test.c", 484, "st", "1235", st, 1235)
           && test_int_eq("../test/test_test.c", 485, "11", "i", 11, i)

           && test_ptr_eq("../test/test_test.c", 487, "p++", "buf", p++, buf)
           && test_ptr_eq("../test/test_test.c", 488, "buf + 2", "++p", buf + 2, ++p)
           && test_ptr_eq("../test/test_test.c", 489, "buf", "p -= 2", buf, p -= 2)
           && test_ptr("../test/test_test.c", 490, "++p", ++p)
           && test_ptr_eq("../test/test_test.c", 491, "p", "buf + 1", p, buf + 1)
           && test_ptr_null("../test/test_test.c", 492, "p = NULL", p = 
# 492 "../test/test_test.c" 3 4
             ((void *)0)
# 492 "../test/test_test.c"
             )

           && test_str_eq("../test/test_test.c", 494, "p = &(\"123456\"[1])", "\"23456\"", p = &("123456"[1]), "23456")
           && test_str_eq("../test/test_test.c", 495, "\"3456\"", "++p", "3456", ++p)
           && test_str_ne("../test/test_test.c", 496, "p++", "\"456\"", p++, "456")

           && test_mem_eq("../test/test_test.c", 498, "--p", "\"3456\"", --p, sizeof("3456"), "3456", sizeof("3456"))
           && test_mem_ne("../test/test_test.c", 499, "p++", "\"456\"", p++, sizeof("456"), "456", sizeof("456"))
           && test_mem_eq("../test/test_test.c", 500, "p--", "\"456\"", p--, sizeof("456"), "456", sizeof("456"));
}
...
# 514 "../test/test_test.c" 3 4
   ((void *)0)
# 514 "../test/test_test.c"
       ,
    "0",
    "-12345678",
    "1234567890123456789012345678901234567890123456789012"
...
{
    BIGNUM *b = 
# 524 "../test/test_test.c" 3 4
               ((void *)0)
# 524 "../test/test_test.c"
                   ;

    if (bn_output_tests[n] != 
# 526 "../test/test_test.c" 3 4
                             ((void *)0)
            
# 527 "../test/test_test.c"
           && !test_true("../test/test_test.c", 527, "BN_hex2bn(&b, bn_output_tests[n])", (BN_hex2bn(&b, bn_output_tests[n])) != 0))
        return 0;
...
{
    return test_skip("../test/test_test.c", 536, "skip test");
}

static int test_skip_many(int n)
{
    return test_skip("../test/test_test.c", 541, "skip tests: %d", n);
}
...
static int test_skip_null(void)
{
    ...
    return test_skip("../test/test_test.c", 550, 
# 550 "../test/test_test.c" 3 4
          ((void *)0)
# 550 "../test/test_test.c"
          );
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_bn_output", test_bn_output, (sizeof(bn_output_tests)/sizeof((bn_output_tests)[0])), 1);
    add_test("test_skip_one", test_skip_one);
    add_test("test_skip_null", test_skip_null);
    add_all_tests("test_skip_many", test_skip_many, 3, 1);
    return 1;
}
