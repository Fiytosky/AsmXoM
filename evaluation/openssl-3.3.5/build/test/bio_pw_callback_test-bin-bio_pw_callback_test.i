# 0 "../test/bio_pw_callback_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_pw_callback_test.c"
# 10 "../test/bio_pw_callback_test.c"
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
# 11 "../test/bio_pw_callback_test.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 14 "../test/bio_pw_callback_test.c" 2
...
# 28 "../test/bio_pw_callback_test.c" 3 4
                       ((void *)0)
# 28 "../test/bio_pw_callback_test.c"
                           ;
static EVP_PKEY *original_pkey = 
# 29 "../test/bio_pw_callback_test.c" 3 4
                                ((void *)0)
# 29 "../test/bio_pw_callback_test.c"
                                    ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 67 "../test/bio_pw_callback_test.c" 3 4
         ((void *)0) 
# 67 "../test/bio_pw_callback_test.c"
              }
    };
    return test_options;
}
...
static int read_callback(char *buf, int size, int rwflag, void *u)
{
    ...
    if (!test_ptr("../test/bio_pw_callback_test.c", 116, "cb_data", cb_data))
        goto err;
    if (!test_char_eq("../test/bio_pw_callback_test.c", 118, "cb_data->magic", "cb_magic", cb_data->magic, cb_magic))
        goto err;
    if (!test_ptr("../test/bio_pw_callback_test.c", 120, "buf", buf))
        goto err;
    if (!test_int_gt("../test/bio_pw_callback_test.c", 122, "size", "0", size, 0))
        goto err;
    if (!test_int_eq("../test/bio_pw_callback_test.c", 124, "rwflag", "0", rwflag, 0))
        goto err;
...
static int write_callback(char *buf, int size, int rwflag, void *u)
{
    ...
    if (!test_ptr("../test/bio_pw_callback_test.c", 138, "cb_data", cb_data))
        goto err;
    if (!test_char_eq("../test/bio_pw_callback_test.c", 140, "cb_data->magic", "cb_magic", cb_data->magic, cb_magic))
        goto err;
    if (!test_ptr("../test/bio_pw_callback_test.c", 142, "buf", buf))
        goto err;
    if (!test_int_gt("../test/bio_pw_callback_test.c", 144, "size", "0", size, 0))
        goto err;
    if (!test_int_eq("../test/bio_pw_callback_test.c", 146, "rwflag", "1", rwflag, 1))
        goto err;
    ret = callback_copy_password(buf, size);
    cb_data->result = 1;
err:
                          ...
                          KEY_ENCODING key_encoding)
{
    ...
    int w_ret = 0;
    BUF_MEM *bptr = 
# 159 "../test/bio_pw_callback_test.c" 3 4
                   ((void *)0)
# 159 "../test/bio_pw_callback_test.c"
                       ;
    BIO *bio = 
# 160 "../test/bio_pw_callback_test.c" 3 4
              ((void *)0)
# 160 "../test/bio_pw_callback_test.c"
                  ;
    int ret = 0;

    if (!test_ptr("../test/bio_pw_callback_test.c", 163, "enc_data", enc_data))
        goto err;
    if (!test_ptr("../test/bio_pw_callback_test.c", 165, "enc_data_size", enc_data_size))
        goto err;
    if (!test_ptr("../test/bio_pw_callback_test.c", 167, "bio = BIO_new(BIO_s_mem())", bio = BIO_new(BIO_s_mem())))
        goto err;
...
# 174 "../test/bio_pw_callback_test.c" 3 4
                                        ((void *)0)
# 174 "../test/bio_pw_callback_test.c"
                                            , 0, write_callback, &cb_data);
        break;
    case KE_PKCS8:
        w_ret = i2d_PKCS8PrivateKey_bio(bio, original_pkey, EVP_aes_256_cbc(),
                                        
# 178 "../test/bio_pw_callback_test.c" 3 4
                                       ((void *)0)
# 178 "../test/bio_pw_callback_test.c"
                                           , 0, write_callback, &cb_data);
        break;
    }
    if (!test_int_ne("../test/bio_pw_callback_test.c", 181, "w_ret", "0", w_ret, 0))
        goto err;
    if (!test_char_eq("../test/bio_pw_callback_test.c", 183, "cb_data.magic", "cb_magic", cb_data.magic, cb_magic))
        goto err;
    if (!test_int_eq("../test/bio_pw_callback_test.c", 185, "cb_data.result", "1", cb_data.result, 1))
        goto err;
    *enc_data_size = BIO_ctrl(bio,3,0,(char *)(enc_data));
    BIO_ctrl(bio,115,0, (char *)(&bptr));
    if (!(int)BIO_ctrl(bio,9,(0x00),
# 189 "../test/bio_pw_callback_test.c" 3 4
        ((void *)0)
# 189 "../test/bio_pw_callback_test.c"
        ))
        goto err;
    bptr->data = 
# 191 "../test/bio_pw_callback_test.c" 3 4
                ((void *)0)
# 191 "../test/bio_pw_callback_test.c"
                    ;
    ret = 1;
err:
    BUF_MEM_free(bptr);
                       ...
                       EXPECTED_RESULT expected_result)
{
    CALLBACK_DATA cb_data;
    EVP_PKEY *r_ret = 
# 204 "../test/bio_pw_callback_test.c" 3 4
                     ((void *)0)
# 204 "../test/bio_pw_callback_test.c"
                         ;
    BIO *bio = 
# 205 "../test/bio_pw_callback_test.c" 3 4
              ((void *)0)
# 205 "../test/bio_pw_callback_test.c"
                  ;
    EVP_PKEY *pkey = 
# 206 "../test/bio_pw_callback_test.c" 3 4
                    ((void *)0)
# 206 "../test/bio_pw_callback_test.c"
                        ;
    int ret = 0;

    if (!test_ptr("../test/bio_pw_callback_test.c", 209, "bio = BIO_new_mem_buf(enc_data, enc_data_size)", bio = BIO_new_mem_buf(enc_data, enc_data_size)))
        goto err;
    cb_data.magic = cb_magic;
    cb_data.result = 0;
    switch (key_encoding) {
    ...
    if (expected_result == ER_SUCCESS) {
        if (!test_ptr("../test/bio_pw_callback_test.c", 222, "r_ret", r_ret))
            goto err;
    } else {
        if (!test_ptr_null("../test/bio_pw_callback_test.c", 225, "r_ret", r_ret))
            goto err;
    }
    if (!test_char_eq("../test/bio_pw_callback_test.c", 228, "cb_data.magic", "cb_magic", cb_data.magic, cb_magic))
        goto err;
    if (!test_int_eq("../test/bio_pw_callback_test.c", 230, "cb_data.result", "1", cb_data.result, 1))
        goto err;
    ret = 1;
err:
    EVP_PKEY_free(pkey);
...
{
    char *enc_data = 
# 243 "../test/bio_pw_callback_test.c" 3 4
                    ((void *)0)
# 243 "../test/bio_pw_callback_test.c"
                        ;
    int enc_data_size = 0;
    int ret = 0;
    ...
    ret = 1;
err:
    CRYPTO_free(enc_data, "../test/bio_pw_callback_test.c", 256);
    return ret;
}
...
int setup_tests(void)
{
    OPTION_CHOICE o;
    BIO *bio = 
# 356 "../test/bio_pw_callback_test.c" 3 4
              ((void *)0)
# 356 "../test/bio_pw_callback_test.c"
                  ;
    ...
    if (!test_ptr("../test/bio_pw_callback_test.c", 372, "bio = BIO_new_file(key_file, \"r\")", bio = BIO_new_file(key_file, "r")))
        return 0;
    if (!test_ptr("../test/bio_pw_callback_test.c", 374, "PEM_read_bio_PrivateKey(bio, &original_pkey, callback_original_pw, NULL)", PEM_read_bio_PrivateKey(bio, &original_pkey, callback_original_pw, 
# 374 "../test/bio_pw_callback_test.c" 3 4
        ((void *)0)
# 374 "../test/bio_pw_callback_test.c"
        ))
                                                                      )
        return 0;
    BIO_free(bio);
