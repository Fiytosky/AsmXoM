# 0 "../test/x509_check_cert_pkey_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/x509_check_cert_pkey_test.c"
# 10 "../test/x509_check_cert_pkey_test.c"
...
# 11 "../test/x509_check_cert_pkey_test.c" 2
...
# 12 "../test/x509_check_cert_pkey_test.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 14 "../test/x509_check_cert_pkey_test.c" 2
...
# 16 "../test/x509_check_cert_pkey_test.c" 2
...
{
    BIO *bio = 
# 30 "../test/x509_check_cert_pkey_test.c" 3 4
              ((void *)0)
# 30 "../test/x509_check_cert_pkey_test.c"
                  ;
    X509 *x509 = 
# 31 "../test/x509_check_cert_pkey_test.c" 3 4
                ((void *)0)
# 31 "../test/x509_check_cert_pkey_test.c"
                    ;
    X509_REQ *x509_req = 
# 32 "../test/x509_check_cert_pkey_test.c" 3 4
                        ((void *)0)
# 32 "../test/x509_check_cert_pkey_test.c"
                            ;
    EVP_PKEY *pkey = 
# 33 "../test/x509_check_cert_pkey_test.c" 3 4
                    ((void *)0)
# 33 "../test/x509_check_cert_pkey_test.c"
                        ;
    ...
    if (strcmp(t, "cert") == 0) {
        ...
        test_error("../test/x509_check_cert_pkey_test.c", 45, "invalid 'type'");
        goto failed;
    }
    ...
    if (strcmp(e, "ok") == 0) {
        ...
        test_error("../test/x509_check_cert_pkey_test.c", 54, "invalid 'expected'");
        goto failed;
    }


    if (!test_ptr("../test/x509_check_cert_pkey_test.c", 59, "bio = BIO_new_file(k, \"r\")", bio = BIO_new_file(k, "r")))
        goto failed;

    if (!test_ptr("../test/x509_check_cert_pkey_test.c", 62, "pkey = PEM_read_bio_PrivateKey(bio, NULL, NULL, NULL)", pkey = PEM_read_bio_PrivateKey(bio, 
# 62 "../test/x509_check_cert_pkey_test.c" 3 4
        ((void *)0)
# 62 "../test/x509_check_cert_pkey_test.c"
        , 
# 62 "../test/x509_check_cert_pkey_test.c" 3 4
        ((void *)0)
# 62 "../test/x509_check_cert_pkey_test.c"
...
# 62 "../test/x509_check_cert_pkey_test.c"
    ...
    if (!test_ptr("../test/x509_check_cert_pkey_test.c", 68, "bio = BIO_new_file(c, \"r\")", bio = BIO_new_file(c, "r")))
        goto failed;

    switch (type) {
    case 1:
        x509 = PEM_read_bio_X509(bio, 
# 73 "../test/x509_check_cert_pkey_test.c" 3 4
                                     ((void *)0)
# 73 "../test/x509_check_cert_pkey_test.c"
                                         , 
# 73 "../test/x509_check_cert_pkey_test.c" 3 4
                                           ((void *)0)
# 73 "../test/x509_check_cert_pkey_test.c"
...
# 73 "../test/x509_check_cert_pkey_test.c"
        ...
        if (x509 == 
# 74 "../test/x509_check_cert_pkey_test.c" 3 4
                   ((void *)0)
# 74 "../test/x509_check_cert_pkey_test.c"
                       ) {
            test_error("../test/x509_check_cert_pkey_test.c", 75, "read PEM x509 failed");
            goto failed;
        }
        ...
        break;
    case 2:
        x509_req = PEM_read_bio_X509_REQ(bio, 
# 82 "../test/x509_check_cert_pkey_test.c" 3 4
                                             ((void *)0)
# 82 "../test/x509_check_cert_pkey_test.c"
                                                 , 
# 82 "../test/x509_check_cert_pkey_test.c" 3 4
                                                   ((void *)0)
# 82 "../test/x509_check_cert_pkey_test.c"
...
# 82 "../test/x509_check_cert_pkey_test.c"
        ...
        if (x509_req == 
# 83 "../test/x509_check_cert_pkey_test.c" 3 4
                       ((void *)0)
# 83 "../test/x509_check_cert_pkey_test.c"
                           ) {
            test_error("../test/x509_check_cert_pkey_test.c", 84, "read PEM x509 req failed");
            goto failed;
        }
    ...
    if (!test_int_eq("../test/x509_check_cert_pkey_test.c", 95, "result", "expected", result, expected)) {
        test_error("../test/x509_check_cert_pkey_test.c", 96, "check private key: expected: %d, got: %d", expected, result);
        goto failed;
    }
...
static int test_PEM_X509_INFO_read_bio(void)
{
    ...
    if (!test_ptr("../test/x509_check_cert_pkey_test.c", 119, "(in = BIO_new_file(file, \"r\"))", (in = BIO_new_file(file, "r"))))
        return 0;
    sk = PEM_X509_INFO_read_bio(in, 
# 121 "../test/x509_check_cert_pkey_test.c" 3 4
                                   ((void *)0)
# 121 "../test/x509_check_cert_pkey_test.c"
                                       , 
# 121 "../test/x509_check_cert_pkey_test.c" 3 4
                                         ((void *)0)
# 121 "../test/x509_check_cert_pkey_test.c"
                                             , "");
    BIO_free(in);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(sk)); i++) {
        it = ((X509_INFO *)OPENSSL_sk_value(ossl_check_const_X509_INFO_sk_type(sk), (i)));
        if (it->x509 != 
# 125 "../test/x509_check_cert_pkey_test.c" 3 4
                       ((void *)0)
# 125 "../test/x509_check_cert_pkey_test.c"
                           )
            count++;
        if (it->crl != 
# 127 "../test/x509_check_cert_pkey_test.c" 3 4
                      ((void *)0)
# 127 "../test/x509_check_cert_pkey_test.c"
                          )
            count++;
        if (it->x_pkey != 
# 129 "../test/x509_check_cert_pkey_test.c" 3 4
                         ((void *)0)
# 129 "../test/x509_check_cert_pkey_test.c"
                             )
            count++;
    }
    OPENSSL_sk_pop_free(ossl_check_X509_INFO_sk_type(sk),ossl_check_X509_INFO_freefunc_type(X509_INFO_free));
    return test_int_eq("../test/x509_check_cert_pkey_test.c", 133, "count", "expected", count, expected);
}

const OPTIONS *test_get_options(void)
{
    enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED };
    static const OPTIONS test_options[] = {
        { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "cert key type expected\n" "     or [options] file num\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }
                                                                         ,
        ...
        { 
# 148 "../test/x509_check_cert_pkey_test.c" 3 4
         ((void *)0) 
# 148 "../test/x509_check_cert_pkey_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/x509_check_cert_pkey_test.c", 156, "Error parsing test options\n");
        return 0;
    }
    ...
    if (test_get_argument_count() == 2) {
        ...
        if (!test_ptr("../test/x509_check_cert_pkey_test.c", 163, "file = test_get_argument(0)", file = test_get_argument(0))
                || !test_ptr("../test/x509_check_cert_pkey_test.c", 164, "num = test_get_argument(1)", num = test_get_argument(1)))
            return 0;
        if (!test_int_eq("../test/x509_check_cert_pkey_test.c", 166, "sscanf(num, \"%d\", &expected)", "1", sscanf(num, "%d", &expected), 1))
            return 0;
        add_test("test_PEM_X509_INFO_read_bio", test_PEM_X509_INFO_read_bio);
        return 1;
    }

    if (!test_ptr("../test/x509_check_cert_pkey_test.c", 172, "c = test_get_argument(0)", c = test_get_argument(0))
            || !test_ptr("../test/x509_check_cert_pkey_test.c", 173, "k = test_get_argument(1)", k = test_get_argument(1))
            || !test_ptr("../test/x509_check_cert_pkey_test.c", 174, "t = test_get_argument(2)", t = test_get_argument(2))
            || !test_ptr("../test/x509_check_cert_pkey_test.c", 175, "e = test_get_argument(3)", e = test_get_argument(3))) {
        return 0;
    }

    add_test("test_x509_check_cert_pkey", test_x509_check_cert_pkey);
    return 1;
}
