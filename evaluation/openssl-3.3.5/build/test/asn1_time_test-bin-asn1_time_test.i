# 0 "../test/asn1_time_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_time_test.c"
# 12 "../test/asn1_time_test.c"
...
static struct testdata tbl_testdata_pos[] = {
    ...
    { "ABCD", 24, 24, 0, 0, 0, 0, },
    { "0ABCD", 24, 24, 0, 0, 0, 0, },
    { "1-700101000000Z", 24, 24, 0, 0, 0, 0, },
    { "`9700101000000Z", 24, 24, 0, 0, 0, 0, },
    { "19700101000000Z", 23, 23, 0, 0, 0, 0, },
    { "A00101000000Z", 23, 23, 0, 0, 0, 0, },
    { "A9700101000000Z", 24, 24, 0, 0, 0, 0, },
    { "1A700101000000Z", 24, 24, 0, 0, 0, 0, },
    { "19A00101000000Z", 24, 24, 0, 0, 0, 0, },
    { "197A0101000000Z", 24, 24, 0, 0, 0, 0, },
    { "1970A101000000Z", 24, 24, 0, 0, 0, 0, },
    { "19700A01000000Z", 24, 24, 0, 0, 0, 0, },
    { "197001A1000000Z", 24, 24, 0, 0, 0, 0, },
    { "1970010A000000Z", 24, 24, 0, 0, 0, 0, },
    { "19700101A00000Z", 24, 24, 0, 0, 0, 0, },
    { "197001010A0000Z", 24, 24, 0, 0, 0, 0, },
    { "1970010100A000Z", 24, 24, 0, 0, 0, 0, },
    { "19700101000A00Z", 24, 24, 0, 0, 0, 0, },
    { "197001010000A0Z", 24, 24, 0, 0, 0, 0, },
    { "1970010100000AZ", 24, 24, 0, 0, 0, 0, },
    { "700101000000X", 23, 23, 0, 0, 0, 0, },
    { "19700101000000X", 24, 24, 0, 0, 0, 0, },
    { "209912312359Z", 24, 24, 0, 0, 0, 0, },
    { "199912310000Z", 24, 24, 0, 0, 0, 0, },
    { "9912312359Z", 23, 23, 0, 0, 0, 0, },
    { "9912310000Z", 23, 23, 0, 0, 0, 0, },
    { "19700101000000Z", 24, 23, 1, 0, -1, 1, },
    { "700101000000Z", 23, 23, 1, 0, -1, 1, },
    { "20380119031407Z", 24, 23, 1, 0x7FFFFFFF, 1, 1, },
    { "380119031407Z", 23, 23, 1, 0x7FFFFFFF, 1, 1, },
    { "20371231235959Z", 24, 23, 1, 2145916799, 1, 1, },
    { "20371231235959Z", 23, 23, 0, 0, 0, 1, },
    { "371231235959Z", 23, 23, 1, 2145916799, 1, 1, },
    { "19701006121456Z", 24, 23, 1, 24063296, -1, 1, },
    { "701006121456Z", 23, 23, 1, 24063296, -1, 1, },
    { "19991231000000Z", 24, 23, 1, 946598400, 0, 1, },
    { "991231000000Z", 23, 23, 1, 946598400, 0, 1, },
    { "9912310000+0000", 23, 23, 1, 946598400, 0, 1, },
    { "199912310000+0000", 24, 23, 1, 946598400, 0, 1, },
    { "9912310000-0000", 23, 23, 1, 946598400, 0, 1, },
    { "199912310000-0000", 24, 23, 1, 946598400, 0, 1, },
    { "199912310100+0100", 24, 23, 1, 946598400, 0, 1, },
    { "199912302300-0100", 24, 23, 1, 946598400, 0, 1, },
    { "199912302300-A000", 24, 23, 0, 946598400, 0, 1, },
    { "199912302300-0A00", 24, 23, 0, 946598400, 0, 1, },
    { "9912310100+0100", 23, 23, 1, 946598400, 0, 1, },
    { "9912302300-0100", 23, 23, 1, 946598400, 0, 1, },
};


static struct testdata tbl_testdata_neg[] = {
    { "19011213204552Z", 24, 24, 1, 
# 133 "../test/asn1_time_test.c" 3 4
                                                                                 (-0x7fffffff - 1)
# 133 "../test/asn1_time_test.c"
                                                                                        , -1, 0, },
    { "691006121456Z", 23, 23, 1, -7472704, -1, 1, },
    { "19691006121456Z", 24, 23, 1, -7472704, -1, 1, },
};


static struct testdata tbl_testdata_pos_64bit[] = {
    { "20380119031408Z", 24, 23, 1, (time_t)0x80000000, 1, 1, },
    { "20380119031409Z", 24, 23, 1, (time_t)0x80000001, 1, 1, },
    { "380119031408Z", 23, 23, 1, (time_t)0x80000000, 1, 1, },
    { "20500101120000Z", 24, 24, 1, (time_t)0x967b1ec0, 1, 0, },
};


static struct testdata tbl_testdata_neg_64bit[] = {
    { "19011213204551Z", 24, 24, 1, (time_t)-2147483649LL, -1, 0, },
    { "19000101120000Z", 24, 24, 1, (time_t)-2208945600LL, -1, 0, },
};
...
static int test_table(struct testdata *tbl, int idx)
{
    ...
    if (!test_int_eq("../test/asn1_time_test.c", 174, "ASN1_TIME_check(&atime)", "td->check_result", ASN1_TIME_check(&atime), td->check_result)) {
        test_info("../test/asn1_time_test.c", 175, "ASN1_TIME_check(%s) unexpected result", atime.data);
        error = 1;
    }
    if (td->check_result == 0)
        return 1;

    if (!test_int_eq("../test/asn1_time_test.c", 181, "ASN1_TIME_cmp_time_t(&atime, td->t)", "0", ASN1_TIME_cmp_time_t(&atime, td->t), 0)) {
        test_info("../test/asn1_time_test.c", 182, "ASN1_TIME_cmp_time_t(%s vs %ld) compare failed", atime.data, (long)td->t);
        error = 1;
    }

    if (!test_true("../test/asn1_time_test.c", 186, "ASN1_TIME_diff(&day, &sec, &atime, &atime)", (ASN1_TIME_diff(&day, &sec, &atime, &atime)) != 0)) {
        test_info("../test/asn1_time_test.c", 187, "ASN1_TIME_diff(%s) to self failed", atime.data);
        error = 1;
    }
    if (!test_int_eq("../test/asn1_time_test.c", 190, "day", "0", day, 0) || !test_int_eq("../test/asn1_time_test.c", 190, "sec", "0", sec, 0)) {
        test_info("../test/asn1_time_test.c", 191, "ASN1_TIME_diff(%s) to self not equal", atime.data);
        error = 1;
    }

    if (!test_true("../test/asn1_time_test.c", 195, "ASN1_TIME_diff(&day, &sec, &gtime, &atime)", (ASN1_TIME_diff(&day, &sec, &gtime, &atime)) != 0)) {
        test_info("../test/asn1_time_test.c", 196, "ASN1_TIME_diff(%s) to baseline failed", atime.data);
        error = 1;
    } else if (!((td->cmp_result == 0 && test_true("../test/asn1_time_test.c", 198, "(day == 0 && sec == 0)", ((day == 0 && sec == 0)) != 0)) ||
                 (td->cmp_result == -1 && test_true("../test/asn1_time_test.c", 199, "(day < 0 || sec < 0)", ((day < 0 || sec < 0)) != 0)) ||
                 (td->cmp_result == 1 && test_true("../test/asn1_time_test.c", 200, "(day > 0 || sec > 0)", ((day > 0 || sec > 0)) != 0)))) {
        test_info("../test/asn1_time_test.c", 201, "ASN1_TIME_diff(%s) to baseline bad comparison", atime.data);
        error = 1;
    }

    if (!test_int_eq("../test/asn1_time_test.c", 205, "ASN1_TIME_cmp_time_t(&atime, gtime_t)", "td->cmp_result", ASN1_TIME_cmp_time_t(&atime, gtime_t), td->cmp_result)) {
        test_info("../test/asn1_time_test.c", 206, "ASN1_TIME_cmp_time_t(%s) to baseline bad comparison", atime.data);
        error = 1;
    }

    ptime = ASN1_TIME_set(
# 210 "../test/asn1_time_test.c" 3 4
                         ((void *)0)
# 210 "../test/asn1_time_test.c"
                             , td->t);
    if (!test_ptr("../test/asn1_time_test.c", 211, "ptime", ptime)) {
        test_info("../test/asn1_time_test.c", 212, "ASN1_TIME_set(%ld) failed", (long)td->t);
        error = 1;
    } else {
        int local_error = 0;
        if (!test_int_eq("../test/asn1_time_test.c", 216, "ASN1_TIME_cmp_time_t(ptime, td->t)", "0", ASN1_TIME_cmp_time_t(ptime, td->t), 0)) {
            test_info("../test/asn1_time_test.c", 217, "ASN1_TIME_set(%ld) compare failed (%s->%s)", (long)td->t, td->data, ptime->data)
                                                       ;
            local_error = error = 1;
        }
        if (!test_int_eq("../test/asn1_time_test.c", 221, "ptime->type", "td->expected_type", ptime->type, td->expected_type)) {
            test_info("../test/asn1_time_test.c", 222, "ASN1_TIME_set(%ld) unexpected type", (long)td->t);
            local_error = error = 1;
        }
        if (local_error)
            test_info("../test/asn1_time_test.c", 226, "ASN1_TIME_set() = %*s", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }

    ptime = ASN1_TIME_new();
    if (!test_ptr("../test/asn1_time_test.c", 231, "ptime", ptime)) {
        test_info("../test/asn1_time_test.c", 232, "ASN1_TIME_new() failed");
        error = 1;
    } else {
        int local_error = 0;
        if (!test_int_eq("../test/asn1_time_test.c", 236, "ASN1_TIME_set_string(ptime, td->data)", "td->check_result", ASN1_TIME_set_string(ptime, td->data), td->check_result)) {
            test_info("../test/asn1_time_test.c", 237, "ASN1_TIME_set_string_gmt(%s) failed", td->data);
            local_error = error = 1;
        }
        if (!test_int_eq("../test/asn1_time_test.c", 240, "ASN1_TIME_normalize(ptime)", "td->check_result", ASN1_TIME_normalize(ptime), td->check_result)) {
            test_info("../test/asn1_time_test.c", 241, "ASN1_TIME_normalize(%s) failed", td->data);
            local_error = error = 1;
        }
        if (!test_int_eq("../test/asn1_time_test.c", 244, "ptime->type", "td->expected_type", ptime->type, td->expected_type)) {
            test_info("../test/asn1_time_test.c", 245, "ASN1_TIME_set_string_gmt(%s) unexpected type", td->data);
            local_error = error = 1;
        }
        day = sec = 0;
        if (!test_true("../test/asn1_time_test.c", 249, "ASN1_TIME_diff(&day, &sec, ptime, &atime)", (ASN1_TIME_diff(&day, &sec, ptime, &atime)) != 0) || !test_int_eq("../test/asn1_time_test.c", 249, "day", "0", day, 0) || !test_int_eq("../test/asn1_time_test.c", 249, "sec", "0", sec, 0)) {
            test_info("../test/asn1_time_test.c", 250, "ASN1_TIME_diff(day=%d, sec=%d, %s) after ASN1_TIME_set_string_gmt() failed", day, sec, td->data);
            local_error = error = 1;
        }
        if (!test_int_eq("../test/asn1_time_test.c", 253, "ASN1_TIME_cmp_time_t(ptime, gtime_t)", "td->cmp_result", ASN1_TIME_cmp_time_t(ptime, gtime_t), td->cmp_result)) {
            test_info("../test/asn1_time_test.c", 254, "ASN1_TIME_cmp_time_t(%s) after ASN1_TIME_set_string_gnt() to baseline bad comparison", td->data);
            local_error = error = 1;
        }
        if (local_error)
            test_info("../test/asn1_time_test.c", 258, "ASN1_TIME_set_string_gmt() = %*s", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }

    ptime = ASN1_TIME_new();
    if (!test_ptr("../test/asn1_time_test.c", 263, "ptime", ptime)) {
        test_info("../test/asn1_time_test.c", 264, "ASN1_TIME_new() failed");
        error = 1;
    } else {
        int local_error = 0;
        if (!test_int_eq("../test/asn1_time_test.c", 268, "ASN1_TIME_set_string(ptime, td->data)", "td->check_result", ASN1_TIME_set_string(ptime, td->data), td->check_result)) {
            test_info("../test/asn1_time_test.c", 269, "ASN1_TIME_set_string(%s) failed", td->data);
            local_error = error = 1;
        }
        day = sec = 0;
        if (!test_true("../test/asn1_time_test.c", 273, "ASN1_TIME_diff(&day, &sec, ptime, &atime)", (ASN1_TIME_diff(&day, &sec, ptime, &atime)) != 0) || !test_int_eq("../test/asn1_time_test.c", 273, "day", "0", day, 0) || !test_int_eq("../test/asn1_time_test.c", 273, "sec", "0", sec, 0)) {
            test_info("../test/asn1_time_test.c", 274, "ASN1_TIME_diff(day=%d, sec=%d, %s) after ASN1_TIME_set_string() failed", day, sec, td->data);
            local_error = error = 1;
        }
        if (!test_int_eq("../test/asn1_time_test.c", 277, "ASN1_TIME_cmp_time_t(ptime, gtime_t)", "td->cmp_result", ASN1_TIME_cmp_time_t(ptime, gtime_t), td->cmp_result)) {
            test_info("../test/asn1_time_test.c", 278, "ASN1_TIME_cmp_time_t(%s) after ASN1_TIME_set_string() to baseline bad comparison", td->data);
            local_error = error = 1;
        }
        if (local_error)
            test_info("../test/asn1_time_test.c", 282, "ASN1_TIME_set_string() = %*s", ptime->length, ptime->data);
        ASN1_TIME_free(ptime);
    }

    if (td->type == 23) {
        ptime = ASN1_TIME_to_generalizedtime(&atime, 
# 287 "../test/asn1_time_test.c" 3 4
                                                    ((void *)0)
# 287 "../test/asn1_time_test.c"
                                                        );
        if (td->convert_result == 1 && !test_ptr("../test/asn1_time_test.c", 288, "ptime", ptime)) {
            test_info("../test/asn1_time_test.c", 289, "ASN1_TIME_to_generalizedtime(%s) failed", atime.data);
            error = 1;
        } else if (td->convert_result == 0 && !test_ptr_null("../test/asn1_time_test.c", 291, "ptime", ptime)) {
            test_info("../test/asn1_time_test.c", 292, "ASN1_TIME_to_generalizedtime(%s) should have failed", atime.data);
            error = 1;
        }
        if (ptime != 
# 295 "../test/asn1_time_test.c" 3 4
                    ((void *)0) 
# 295 "../test/asn1_time_test.c"
                         && !test_int_eq("../test/asn1_time_test.c", 295, "ASN1_TIME_cmp_time_t(ptime, td->t)", "0", ASN1_TIME_cmp_time_t(ptime, td->t), 0)) {
            test_info("../test/asn1_time_test.c", 296, "ASN1_TIME_to_generalizedtime(%s->%s) bad result", atime.data, ptime->data);
            error = 1;
        }
        ASN1_TIME_free(ptime);
    }
    ...
    if (error)
        test_error("../test/asn1_time_test.c", 304, "atime=%s", atime.data);
...
static struct compare_testdata tbl_compare_testdata[] = {
    { { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, 0 },
    { { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, 0 },
    { { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, -1 },
    { { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, -1 },

    { { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, 0 },
    { { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, 0 },
    { { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, -1 },
    { { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, -1 },

    { { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, 1 },
    { { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, 1 },
    { { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, 0 },
    { { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, 0 },

    { { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, { sizeof(TODAY_GEN_STR)-1, 24, TODAY_GEN_STR, 0 }, 1 },
    { { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, { sizeof(TODAY_UTC_STR)-1, 23, TODAY_UTC_STR, 0 }, 1 },
    { { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, { sizeof(TOMORROW_GEN_STR)-1, 24, TOMORROW_GEN_STR, 0 }, 0 },
    { { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, { sizeof(TOMORROW_UTC_STR)-1, 23, TOMORROW_UTC_STR, 0 }, 0 }
};
...
static int test_table_compare(int idx)
{
    ...
    return test_int_eq("../test/asn1_time_test.c", 371, "ASN1_TIME_compare(&td->t1, &td->t2)", "td->result", ASN1_TIME_compare(&td->t1, &td->t2), td->result);
}
...
static int test_time_dup(void)
{
    int ret = 0;
    ASN1_TIME *asn1_time = 
# 377 "../test/asn1_time_test.c" 3 4
                          ((void *)0)
# 377 "../test/asn1_time_test.c"
                              ;
    ASN1_TIME *asn1_time_dup = 
# 378 "../test/asn1_time_test.c" 3 4
                              ((void *)0)
# 378 "../test/asn1_time_test.c"
                                  ;
    ASN1_TIME *asn1_gentime = 
# 379 "../test/asn1_time_test.c" 3 4
                             ((void *)0)
# 379 "../test/asn1_time_test.c"
                                 ;

    asn1_time = ASN1_TIME_adj(
# 381 "../test/asn1_time_test.c" 3 4
                             ((void *)0)
# 381 "../test/asn1_time_test.c"
                                 , time(
# 381 "../test/asn1_time_test.c" 3 4
                                        ((void *)0)
# 381 "../test/asn1_time_test.c"
    ...
    if (asn1_time == 
# 382 "../test/asn1_time_test.c" 3 4
                    ((void *)0)
# 382 "../test/asn1_time_test.c"
                        ) {
        test_info("../test/asn1_time_test.c", 383, "Internal error.");
        goto err;
    }

    asn1_gentime = ASN1_TIME_to_generalizedtime(asn1_time, 
# 387 "../test/asn1_time_test.c" 3 4
                                                          ((void *)0)
# 387 "../test/asn1_time_test.c"
                                                              );
    if (asn1_gentime == 
# 388 "../test/asn1_time_test.c" 3 4
                       ((void *)0)
# 388 "../test/asn1_time_test.c"
                           ) {
        test_info("../test/asn1_time_test.c", 389, "Internal error.");
        goto err;
    }

    asn1_time_dup = ASN1_TIME_dup(asn1_time);
    if (!test_ptr_ne("../test/asn1_time_test.c", 394, "asn1_time_dup", "NULL", asn1_time_dup, 
# 394 "../test/asn1_time_test.c" 3 4
        ((void *)0)
# 394 "../test/asn1_time_test.c"
        )) {
        test_info("../test/asn1_time_test.c", 395, "ASN1_TIME_dup() failed.");
        goto err;
    }
    if (!test_int_eq("../test/asn1_time_test.c", 398, "ASN1_TIME_compare(asn1_time, asn1_time_dup)", "0", ASN1_TIME_compare(asn1_time, asn1_time_dup), 0)) {
    ...
    if (!test_ptr_ne("../test/asn1_time_test.c", 405, "asn1_time_dup", "NULL", asn1_time_dup, 
# 405 "../test/asn1_time_test.c" 3 4
        ((void *)0)
# 405 "../test/asn1_time_test.c"
        )) {
        test_info("../test/asn1_time_test.c", 406, "ASN1_UTCTIME_dup() failed.");
        goto err;
    }
    if (!test_int_eq("../test/asn1_time_test.c", 409, "ASN1_TIME_compare(asn1_time, asn1_time_dup)", "0", ASN1_TIME_compare(asn1_time, asn1_time_dup), 0)) {
        test_info("../test/asn1_time_test.c", 410, "ASN1_UTCTIME_dup() duplicated non-identical UTCTIME value.");
        goto err;
    }
    ASN1_STRING_free(asn1_time_dup);

    asn1_time_dup = ASN1_GENERALIZEDTIME_dup(asn1_gentime);
    if (!test_ptr_ne("../test/asn1_time_test.c", 416, "asn1_time_dup", "NULL", asn1_time_dup, 
# 416 "../test/asn1_time_test.c" 3 4
        ((void *)0)
# 416 "../test/asn1_time_test.c"
        )) {
        test_info("../test/asn1_time_test.c", 417, "ASN1_GENERALIZEDTIME_dup() failed.");
        goto err;
    }
    if (!test_int_eq("../test/asn1_time_test.c", 420, "ASN1_TIME_compare(asn1_gentime, asn1_time_dup)", "0", ASN1_TIME_compare(asn1_gentime, asn1_time_dup), 0)) {
        test_info("../test/asn1_time_test.c", 421, "ASN1_GENERALIZEDTIME_dup() dup'ed non-identical value.");
        goto err;
    }
...
static int convert_asn1_to_time_t(int idx)
{
    ...
    if (!test_time_t_eq("../test/asn1_time_test.c", 439, "testdateutc", "asn1_to_utc[idx].expected", testdateutc, asn1_to_utc[idx].expected)) {
        test_info("../test/asn1_time_test.c", 440, "ossl_asn1_string_to_time_t (%s) failed: expected %lli, got %lli\n", asn1_to_utc[idx].input, (long long int)asn1_to_utc[idx].expected, (long long int)testdateutc)
...
static int convert_tm_to_asn1_time(void)
{
    ...
    if (sizeof(time_t) * 8 
# 460 "../test/asn1_time_test.c"
                                 >= 64) {
        t = 67768011791126057ULL;
        at = ASN1_TIME_set(
# 462 "../test/asn1_time_test.c" 3 4
                          ((void *)0)
# 462 "../test/asn1_time_test.c"
                              , t);
...
# 483 "../test/asn1_time_test.c"
    ...
    add_all_tests("test_table_pos", test_table_pos, (sizeof(tbl_testdata_pos)/sizeof((tbl_testdata_pos)[0])), 1);
    if (!(t > 0) && ptm != 
# 492 "../test/asn1_time_test.c" 3 4
                          ((void *)0)
# 492 "../test/asn1_time_test.c"
                              ) {
        test_info("../test/asn1_time_test.c", 493, "Adding negative-sign time_t tests");
        add_all_tests("test_table_neg", test_table_neg, (sizeof(tbl_testdata_neg)/sizeof((tbl_testdata_neg)[0])), 1);
    }
    if (sizeof(time_t) > sizeof(uint32_t)) {
        test_info("../test/asn1_time_test.c", 497, "Adding 64-bit time_t tests");
        add_all_tests("test_table_pos_64bit", test_table_pos_64bit, (sizeof(tbl_testdata_pos_64bit)/sizeof((tbl_testdata_pos_64bit)[0])), 1);

        if (!(t > 0) && ptm != 
# 500 "../test/asn1_time_test.c" 3 4
                              ((void *)0)
# 500 "../test/asn1_time_test.c"
                                  ) {
            test_info("../test/asn1_time_test.c", 501, "Adding negative-sign 64-bit time_t tests");
            add_all_tests("test_table_neg_64bit", test_table_neg_64bit, (sizeof(tbl_testdata_neg_64bit)/sizeof((tbl_testdata_neg_64bit)[0])), 1);
        }

    }
    add_all_tests("test_table_compare", test_table_compare, (sizeof(tbl_compare_testdata)/sizeof((tbl_compare_testdata)[0])), 1);
    add_test("test_time_dup", test_time_dup);
    add_all_tests("convert_asn1_to_time_t", convert_asn1_to_time_t, (sizeof(asn1_to_utc)/sizeof((asn1_to_utc)[0])), 1);
    add_test("convert_tm_to_asn1_time", convert_tm_to_asn1_time);
    return 1;
}
