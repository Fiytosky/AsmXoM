...
xor_prov_get_keymgmt_new(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 136 "../test/tls-provider.c" 3 4
          ((void *)0)
# 136 "../test/tls-provider.c"
              ;
}
...
xor_prov_get_keymgmt_free(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 147 "../test/tls-provider.c" 3 4
          ((void *)0)
# 147 "../test/tls-provider.c"
              ;
}
...
xor_prov_get_keymgmt_import(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 158 "../test/tls-provider.c" 3 4
          ((void *)0)
# 158 "../test/tls-provider.c"
              ;
}
...
xor_prov_get_keymgmt_export(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 169 "../test/tls-provider.c" 3 4
          ((void *)0)
# 169 "../test/tls-provider.c"
              ;
}
                           ...
                           int selection, const OSSL_PARAM params[])
{
    ...
    void *key = 
# 179 "../test/tls-provider.c" 3 4
               ((void *)0)
# 179 "../test/tls-provider.c"
                   ;

    if (kmgmt_new != 
# 181 "../test/tls-provider.c" 3 4
                    ((void *)0) 
# 181 "../test/tls-provider.c"
                         && kmgmt_import != 
# 181 "../test/tls-provider.c" 3 4
                                            ((void *)0) 
# 181 "../test/tls-provider.c"
...
# 181 "../test/tls-provider.c"
        ...
        if ((key = kmgmt_new(provctx)) == 
# 182 "../test/tls-provider.c" 3 4
                                         ((void *)0)
            
# 183 "../test/tls-provider.c"
           || !kmgmt_import(key, selection, params)) {
            kmgmt_free(key);
            key = 
# 185 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 185 "../test/tls-provider.c"
                     ;
        }
    }
    return key;
...
static void xor_prov_free_key(const OSSL_DISPATCH *fns, void *key)
{
    ...
    if (kmgmt_free != 
# 195 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 195 "../test/tls-provider.c"
                         )
        kmgmt_free(key);
}
...
static const OSSL_PARAM xor_group_params[] = {
    ...
    { 
# 255 "../test/tls-provider.c" 3 4
   ((void *)0)
# 255 "../test/tls-provider.c"
   , 0, 
# 255 "../test/tls-provider.c" 3 4
   ((void *)0)
# 255 "../test/tls-provider.c"
...
static const OSSL_PARAM xor_kemgroup_params[] = {
    ...
    { 
# 274 "../test/tls-provider.c" 3 4
   ((void *)0)
# 274 "../test/tls-provider.c"
   , 0, 
# 274 "../test/tls-provider.c" 3 4
   ((void *)0)
# 274 "../test/tls-provider.c"
...
static const OSSL_PARAM xor_sig_nohash_params[] = {
    ...
    { (("tls-max-tls")), (1), ((&xor_sigalg.maxtls)), (sizeof(int)), ((size_t)-1) }
                                      ,
    { 
# 335 "../test/tls-provider.c" 3 4
   ((void *)0)
# 335 "../test/tls-provider.c"
   , 0, 
# 335 "../test/tls-provider.c" 3 4
   ((void *)0)
# 335 "../test/tls-provider.c"
...
static const OSSL_PARAM xor_sig_hash_params[] = {
    ...
    { (("tls-max-tls")), (1), ((&xor_sigalg_hash.maxtls)), (sizeof(int)), ((size_t)-1) }
                                           ,
    { 
# 356 "../test/tls-provider.c" 3 4
   ((void *)0)
# 356 "../test/tls-provider.c"
   , 0, 
# 356 "../test/tls-provider.c" 3 4
   ((void *)0)
# 356 "../test/tls-provider.c"
...
static const OSSL_PARAM xor_sig_12_params[] = {
    ...
    { (("tls-max-tls")), (1), ((&xor_sigalg12.maxtls)), (sizeof(int)), ((size_t)-1) }
                                        ,
    { 
# 375 "../test/tls-provider.c" 3 4
   ((void *)0)
# 375 "../test/tls-provider.c"
   , 0, 
# 375 "../test/tls-provider.c" 3 4
   ((void *)0)
# 375 "../test/tls-provider.c"
                                     ...
                                     OSSL_CALLBACK *cb, void *arg)
{
    ...
    if (strcmp(capability, "TLS-GROUP") == 0) {
        ...
        (void)((xor_group.group_id >= 65024 && xor_group.group_id < 65279 - 50) ? 0 : (OPENSSL_die("assertion failed: " "xor_group.group_id >= 65024 && xor_group.group_id < 65279 - NUM_DUMMY_GROUPS", "../test/tls-provider.c", 388), 1))
                                                                        ;
        ...
        for (i = 0; i < 50; i++) {
            ...
            if (dummy_group_names[i] == 
# 406 "../test/tls-provider.c" 3 4
                                       ((void *)0)
# 406 "../test/tls-provider.c"
                                           ) {
                dummy_group_names[i] = CRYPTO_zalloc(dummy_name_max_size, "../test/tls-provider.c", 407);
                if (dummy_group_names[i] == 
# 408 "../test/tls-provider.c" 3 4
                                           ((void *)0)
# 408 "../test/tls-provider.c"
                                               )
                    return 0;
...
static PROV_XOR_CTX *xor_newprovctx(OSSL_LIB_CTX *libctx)
{
    ...
    if (prov_ctx == 
# 439 "../test/tls-provider.c" 3 4
                   ((void *)0)
# 439 "../test/tls-provider.c"
                       )
        return 
# 440 "../test/tls-provider.c" 3 4
              ((void *)0)
# 440 "../test/tls-provider.c"
                  ;

    if (libctx == 
# 442 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 442 "../test/tls-provider.c"
                     ) {
        CRYPTO_free(prov_ctx, "../test/tls-provider.c", 443);
        return 
# 444 "../test/tls-provider.c" 3 4
              ((void *)0)
# 444 "../test/tls-provider.c"
                  ;
    }
...
static void *xor_newkemkexctx(void *provctx)
{
    ...
    if (pxorctx == 
# 469 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 469 "../test/tls-provider.c"
                      )
        return 
# 470 "../test/tls-provider.c" 3 4
              ((void *)0)
# 470 "../test/tls-provider.c"
                  ;
...
static int xor_init(void *vpxorctx, void *vkey,
                    __attribute__((unused)) const OSSL_PARAM params[])
{
    PROV_XORKEMKEX_CTX *pxorctx = (PROV_XORKEMKEX_CTX *)vpxorctx;

    if (pxorctx == 
# 482 "../test/tls-provider.c" 3 4
                  ((void *)0) 
# 482 "../test/tls-provider.c"
                       || vkey == 
# 482 "../test/tls-provider.c" 3 4
                                  ((void *)0)
# 482 "../test/tls-provider.c"
...
static int xor_set_peer(void *vpxorctx, void *vpeerkey)
{
    ...
    if (pxorctx == 
# 492 "../test/tls-provider.c" 3 4
                  ((void *)0) 
# 492 "../test/tls-provider.c"
                       || vpeerkey == 
# 492 "../test/tls-provider.c" 3 4
                                      ((void *)0)
# 492 "../test/tls-provider.c"
                      ...
                      size_t outlen)
{
    ...
    if (pxorctx->key == 
# 504 "../test/tls-provider.c" 3 4
                       ((void *)0) 
# 504 "../test/tls-provider.c"
                            || pxorctx->peerkey == 
# 504 "../test/tls-provider.c" 3 4
                                                   ((void *)0)
# 504 "../test/tls-provider.c"
    ...
    *secretlen = 32;
    if (secret == 
# 508 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 508 "../test/tls-provider.c"
                     )
        return 1;
...
static void *xor_dupctx(void *vpxorctx)
{
    ...
    if (dstctx == 
# 531 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 531 "../test/tls-provider.c"
                     )
        return 
# 532 "../test/tls-provider.c" 3 4
              ((void *)0)
# 532 "../test/tls-provider.c"
                  ;
...
static const OSSL_DISPATCH xor_keyexch_functions[] = {
    ...
    { 0, 
# 546 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 546 "../test/tls-provider.c"
   }
};
...
static const OSSL_ALGORITHM tls_prov_keyexch[] = {
    ...
    { 
# 555 "../test/tls-provider.c" 3 4
     ((void *)0)
# 555 "../test/tls-provider.c"
         , 
# 555 "../test/tls-provider.c" 3 4
           ((void *)0)
# 555 "../test/tls-provider.c"
...
# 575 "../test/tls-provider.c"
    int rv = 0;
    void *genctx = 
# 576 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 576 "../test/tls-provider.c"
                      , *derivectx = 
# 576 "../test/tls-provider.c" 3 4
                                     ((void *)0)
# 576 "../test/tls-provider.c"
                                         ;
    XORKEY *ourkey = 
# 577 "../test/tls-provider.c" 3 4
                    ((void *)0)
# 577 "../test/tls-provider.c"
                        ;
    PROV_XORKEMKEX_CTX *pxorctx = vpxorctx;

    if (ct == 
# 580 "../test/tls-provider.c" 3 4
             ((void *)0) 
# 580 "../test/tls-provider.c"
                  || ss == 
# 580 "../test/tls-provider.c" 3 4
                           ((void *)0)
# 580 "../test/tls-provider.c"
        ...
        if (ctlen == 
# 583 "../test/tls-provider.c" 3 4
                    ((void *)0) 
# 583 "../test/tls-provider.c"
                         && sslen == 
# 583 "../test/tls-provider.c" 3 4
                                     ((void *)0)
# 583 "../test/tls-provider.c"
            ...
            return 0;
        if (ctlen != 
# 585 "../test/tls-provider.c" 3 4
                    ((void *)0)
# 585 "../test/tls-provider.c"
                        )
            *ctlen = 32;
        if (sslen != 
# 587 "../test/tls-provider.c" 3 4
                    ((void *)0)
# 587 "../test/tls-provider.c"
                        )
            *sslen = 32;
        return 1;
    }
    ...
    genctx = xor_gen_init(pxorctx->provctx, ( 0x01 | 0x02 ), 
# 593 "../test/tls-provider.c" 3 4
                                                                        ((void *)0)
# 593 "../test/tls-provider.c"
                                                                            );
    if (genctx == 
# 594 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 594 "../test/tls-provider.c"
                     )
        goto end;
    ourkey = xor_gen(genctx, 
# 596 "../test/tls-provider.c" 3 4
                            ((void *)0)
# 596 "../test/tls-provider.c"
                                , 
# 596 "../test/tls-provider.c" 3 4
                                  ((void *)0)
# 596 "../test/tls-provider.c"
    ...
    if (ourkey == 
# 597 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 597 "../test/tls-provider.c"
                     )
        goto end;
    ...
    *ctlen = 32;
    ...
    if (derivectx == 
# 606 "../test/tls-provider.c" 3 4
                    ((void *)0)
            
# 607 "../test/tls-provider.c"
           || !xor_init(derivectx, ourkey, 
# 607 "../test/tls-provider.c" 3 4
                                           ((void *)0)
# 607 "../test/tls-provider.c"
                                               )
                           ...
                           const unsigned char *ct, size_t ctlen)
{
    ...
    int rv = 0;
    void *derivectx = 
# 632 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 632 "../test/tls-provider.c"
                         ;
    XORKEY *peerkey = 
# 633 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 633 "../test/tls-provider.c"
                         ;
    PROV_XORKEMKEX_CTX *pxorctx = vpxorctx;

    if (ss == 
# 636 "../test/tls-provider.c" 3 4
             ((void *)0)
# 636 "../test/tls-provider.c"
                 ) {

        if (sslen == 
# 638 "../test/tls-provider.c" 3 4
                    ((void *)0)
# 638 "../test/tls-provider.c"
                        )
            return 0;
        *sslen = 32;
        return 1;
    ...
    if (peerkey == 
# 647 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 647 "../test/tls-provider.c"
                      )
        goto end;
    ...
    derivectx = xor_newkemkexctx(pxorctx->provctx);
    if (derivectx == 
# 653 "../test/tls-provider.c" 3 4
                    ((void *)0)
            
# 654 "../test/tls-provider.c"
           || !xor_init(derivectx, pxorctx->key, 
# 654 "../test/tls-provider.c" 3 4
                                                 ((void *)0)
# 654 "../test/tls-provider.c"
                                                     )
...
static const OSSL_DISPATCH xor_kem_functions[] = {
    ...
    { 0, 
# 675 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 675 "../test/tls-provider.c"
   }
};
...
static const OSSL_ALGORITHM tls_prov_kem[] = {
    ...
    { 
# 684 "../test/tls-provider.c" 3 4
     ((void *)0)
# 684 "../test/tls-provider.c"
         , 
# 684 "../test/tls-provider.c" 3 4
           ((void *)0)
# 684 "../test/tls-provider.c"
...
static void *xor_newkey(void *provctx)
{
    ...
    if (ret == 
# 693 "../test/tls-provider.c" 3 4
              ((void *)0)
# 693 "../test/tls-provider.c"
                  )
        return 
# 694 "../test/tls-provider.c" 3 4
              ((void *)0)
# 694 "../test/tls-provider.c"
                  ;

    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_free(ret, "../test/tls-provider.c", 697);
        return 
# 698 "../test/tls-provider.c" 3 4
              ((void *)0)
# 698 "../test/tls-provider.c"
                  ;
    }
...
static void xor_freekey(void *keydata)
{
    ...
    if (key == 
# 709 "../test/tls-provider.c" 3 4
              ((void *)0)
# 709 "../test/tls-provider.c"
                  )
        return;
...
# 717 "../test/tls-provider.c" 3 4
   ((void) (0))
# 717 "../test/tls-provider.c"
                      ;

    if (key != 
# 719 "../test/tls-provider.c" 3 4
              ((void *)0)
# 719 "../test/tls-provider.c"
                  ) {
        CRYPTO_free(key->tls_name, "../test/tls-provider.c", 720);
        key->tls_name = 
# 721 "../test/tls-provider.c" 3 4
                       ((void *)0)
# 721 "../test/tls-provider.c"
                           ;
    }
...
# 734 "../test/tls-provider.c" 3 4
   ((void) (0))
# 734 "../test/tls-provider.c"
                     ;
    return (refcnt > 1);
}
...
static int xor_has(const void *vkey, int selection)
{
    ...
    if (key != 
# 743 "../test/tls-provider.c" 3 4
              ((void *)0)
# 743 "../test/tls-provider.c"
                  ) {
        ok = 1;
...
{
    XORKEY *tokey = xor_newkey(
# 756 "../test/tls-provider.c" 3 4
                              ((void *)0)
# 756 "../test/tls-provider.c"
                                  );
    const XORKEY *fromkey = vfromkey;
    int ok = 0;

    if (tokey != 
# 760 "../test/tls-provider.c" 3 4
                ((void *)0) 
# 760 "../test/tls-provider.c"
                     && fromkey != 
# 760 "../test/tls-provider.c" 3 4
                                   ((void *)0)
# 760 "../test/tls-provider.c"
        ...
        if (fromkey->tls_name != 
# 779 "../test/tls-provider.c" 3 4
                                ((void *)0)
# 779 "../test/tls-provider.c"
                                    )
    ...
    if (!ok) {
        xor_freekey(tokey);
        tokey = 
# 784 "../test/tls-provider.c" 3 4
               ((void *)0)
# 784 "../test/tls-provider.c"
                   ;
    }
    return tokey;
}
...
static inline int xor_get_params(void *vkey, OSSL_PARAM params[])
{
    ...
    if ((p = OSSL_PARAM_locate(params, "bits")) != 
# 794 "../test/tls-provider.c" 3 4
                                                                ((void *)0)
        
# 795 "../test/tls-provider.c"
       && !OSSL_PARAM_set_int(p, 32))
        return 0;

    if ((p = OSSL_PARAM_locate(params, "security-bits")) != 
# 798 "../test/tls-provider.c" 3 4
                                                                         ((void *)0)
        
# 799 "../test/tls-provider.c"
       && !OSSL_PARAM_set_int(p, xor_group.secbits))
        return 0;

    if ((p = OSSL_PARAM_locate(params,
                               "encoded-pub-key")) != 
# 803 "../test/tls-provider.c" 3 4
                                                                      ((void *)0)
# 803 "../test/tls-provider.c"
                                                                          ) {
        if (p->data_type != 5)
            return 0;
        p->return_size = 32;
        if (p->data != 
# 807 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 807 "../test/tls-provider.c"
                           && p->data_size >= 32)
...
static const OSSL_PARAM xor_params[] = {
    { (("bits")), (1), ((
# 815 "../test/tls-provider.c" 3 4
   ((void *)0)
# 815 "../test/tls-provider.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("security-bits")), (1), ((
# 816 "../test/tls-provider.c" 3 4
   ((void *)0)
# 816 "../test/tls-provider.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("encoded-pub-key")), (5), ((
# 817 "../test/tls-provider.c" 3 4
   ((void *)0)
# 817 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { 
# 818 "../test/tls-provider.c" 3 4
   ((void *)0)
# 818 "../test/tls-provider.c"
   , 0, 
# 818 "../test/tls-provider.c" 3 4
   ((void *)0)
# 818 "../test/tls-provider.c"
...
static int xor_set_params(void *vkey, const OSSL_PARAM params[])
{
    ...
    if (p != 
# 832 "../test/tls-provider.c" 3 4
            ((void *)0)
# 832 "../test/tls-provider.c"
                ) {
        if (p->data_type != 5
                || p->data_size != 32)
            return 0;
...
static const OSSL_PARAM xor_known_settable_params[] = {
    { (("encoded-pub-key")), (5), ((
# 844 "../test/tls-provider.c" 3 4
   ((void *)0)
# 844 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { 
# 845 "../test/tls-provider.c" 3 4
   ((void *)0)
# 845 "../test/tls-provider.c"
   , 0, 
# 845 "../test/tls-provider.c" 3 4
   ((void *)0)
# 845 "../test/tls-provider.c"
...
{
    XORKEY *key = 
# 850 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 850 "../test/tls-provider.c"
                     ;
    ...
    if (reference_sz == sizeof(key)) {
        ...
        *(XORKEY **)reference = 
# 856 "../test/tls-provider.c" 3 4
                               ((void *)0)
# 856 "../test/tls-provider.c"
                                   ;
        return key;
    }
    return 
# 859 "../test/tls-provider.c" 3 4
          ((void *)0)
# 859 "../test/tls-provider.c"
              ;
}
...
static int xor_match(const void *keydata1, const void *keydata2, int selection)
{
    ...
    if (key1->tls_name != 
# 879 "../test/tls-provider.c" 3 4
                         ((void *)0) 
# 879 "../test/tls-provider.c"
                              && key2->tls_name != 
# 879 "../test/tls-provider.c" 3 4
                                                   ((void *)0)
# 879 "../test/tls-provider.c"
...
static void *xor_gen_init(void *provctx, int selection,
                          const OSSL_PARAM params[])
{
    struct xor_gen_ctx *gctx = 
# 927 "../test/tls-provider.c" 3 4
                              ((void *)0)
# 927 "../test/tls-provider.c"
                                  ;

    if ((selection & (( 0x01 | 0x02 )
                      | 0x04)) == 0)
        return 
# 931 "../test/tls-provider.c" 3 4
              ((void *)0)
# 931 "../test/tls-provider.c"
                  ;

    if ((gctx = CRYPTO_zalloc(sizeof(*gctx), "../test/tls-provider.c", 933)) == 
# 933 "../test/tls-provider.c" 3 4
                                                 ((void *)0)
# 933 "../test/tls-provider.c"
                                                     )
        return 
# 934 "../test/tls-provider.c" 3 4
              ((void *)0)
# 934 "../test/tls-provider.c"
                  ;
    ...
    if (!xor_gen_set_params(gctx, params)) {
        CRYPTO_free(gctx, "../test/tls-provider.c", 940);
        return 
# 941 "../test/tls-provider.c" 3 4
              ((void *)0)
# 941 "../test/tls-provider.c"
                  ;
    }
    return gctx;
}
...
static int xor_gen_set_params(void *genctx, const OSSL_PARAM params[])
{
    ...
    if (gctx == 
# 951 "../test/tls-provider.c" 3 4
               ((void *)0)
# 951 "../test/tls-provider.c"
                   )
        return 0;

    p = OSSL_PARAM_locate_const(params, "group");
    if (p != 
# 955 "../test/tls-provider.c" 3 4
            ((void *)0)
# 955 "../test/tls-provider.c"
                ) {
        if (p->data_type != 4
...
static const OSSL_PARAM *xor_gen_settable_params(__attribute__((unused)) void *genctx,
                                                 __attribute__((unused)) void *provctx)
{
    static OSSL_PARAM settable[] = {
        { (("group")), (4), ((
# 969 "../test/tls-provider.c" 3 4
       ((void *)0)
# 969 "../test/tls-provider.c"
       )), (0), ((size_t)-1) },
        { 
# 970 "../test/tls-provider.c" 3 4
       ((void *)0)
# 970 "../test/tls-provider.c"
       , 0, 
# 970 "../test/tls-provider.c" 3 4
       ((void *)0)
# 970 "../test/tls-provider.c"
...
{
    struct xor_gen_ctx *gctx = genctx;
    XORKEY *key = xor_newkey(
# 978 "../test/tls-provider.c" 3 4
                            ((void *)0)
# 978 "../test/tls-provider.c"
                                );
    size_t i;

    if (key == 
# 981 "../test/tls-provider.c" 3 4
              ((void *)0)
# 981 "../test/tls-provider.c"
                  )
        return 
# 982 "../test/tls-provider.c" 3 4
              ((void *)0)
# 982 "../test/tls-provider.c"
                  ;

    if ((gctx->selection & ( 0x01 | 0x02 )) != 0) {
        if (RAND_bytes_ex(gctx->libctx, key->privkey, 32, 0) <= 0) {
            CRYPTO_free(key, "../test/tls-provider.c", 986);
            return 
# 987 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 987 "../test/tls-provider.c"
                      ;
        }
        for (i = 0; i < 32; i++)
...
static int xor_import(void *vkey, int select, const OSSL_PARAM params[])
{
    ...
    if (key == 
# 1010 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1010 "../test/tls-provider.c"
                   || (select & ( 0x01 | 0x02 )) == 0)
        return 0;
    ...
    if ((param_priv_key != 
# 1018 "../test/tls-provider.c" 3 4
                          ((void *)0)
         
# 1019 "../test/tls-provider.c"
        && !OSSL_PARAM_get_octet_string(param_priv_key, &pprivkey,
                                         sizeof(privkey), &priv_len))
        || (param_pub_key != 
# 1021 "../test/tls-provider.c" 3 4
                            ((void *)0)
            
# 1022 "../test/tls-provider.c"
                      ...
                      void *cbarg)
{
    ...
    if (key == 
# 1045 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1045 "../test/tls-provider.c"
                   || (select & ( 0x01 | 0x02 )) == 0)
        return 0;
...
static const OSSL_PARAM xor_key_types[] = {
    { (("pub")), (2), ((
# 1059 "../test/tls-provider.c" 3 4
   ((void *)0)
# 1059 "../test/tls-provider.c"
   )), ((0)), ((size_t)-1) },
    { (("priv")), (2), ((
# 1060 "../test/tls-provider.c" 3 4
   ((void *)0)
# 1060 "../test/tls-provider.c"
   )), ((0)), ((size_t)-1) },
    { 
# 1061 "../test/tls-provider.c" 3 4
   ((void *)0)
# 1061 "../test/tls-provider.c"
   , 0, 
# 1061 "../test/tls-provider.c" 3 4
   ((void *)0)
# 1061 "../test/tls-provider.c"
...
{
    return (select & ( 0x01 | 0x02 )) != 0 ? xor_key_types : 
# 1066 "../test/tls-provider.c" 3 4
                                                                        ((void *)0)
# 1066 "../test/tls-provider.c"
                                                                            ;
}
...
{
    if (provctx == 
# 1071 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1071 "../test/tls-provider.c"
                      )
        return 
# 1072 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1072 "../test/tls-provider.c"
                  ;
...
{
    return (select & ( 0x01 | 0x02 )) != 0 ? xor_key_types : 
# 1079 "../test/tls-provider.c" 3 4
                                                                        ((void *)0)
# 1079 "../test/tls-provider.c"
                                                                            ;
}
...
{
    if (provctx == 
# 1084 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1084 "../test/tls-provider.c"
                      )
        return 
# 1085 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1085 "../test/tls-provider.c"
                  ;
...
{
    CRYPTO_free(genctx, "../test/tls-provider.c", 1092);
}
...
static const OSSL_DISPATCH xor_keymgmt_functions[] = {
    ...
    { 0, 
# 1116 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 1116 "../test/tls-provider.c"
   }
};
...
static void *xor_xorhmacsig_gen(void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
    ...
    if (k == 
# 1124 "../test/tls-provider.c" 3 4
            ((void *)0)
# 1124 "../test/tls-provider.c"
                )
        return 
# 1125 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1125 "../test/tls-provider.c"
                  ;
    k->tls_name = CRYPTO_strdup("xorhmacsig", "../test/tls-provider.c", 1126);
    if (k->tls_name == 
# 1127 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 1127 "../test/tls-provider.c"
                          ) {
        xor_freekey(k);
        return 
# 1129 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1129 "../test/tls-provider.c"
                  ;
    }
    return k;
}
...
static void *xor_xorhmacsha2sig_gen(void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
    ...
    if (k == 
# 1138 "../test/tls-provider.c" 3 4
            ((void *)0)
# 1138 "../test/tls-provider.c"
                )
        return 
# 1139 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1139 "../test/tls-provider.c"
                  ;
    k->tls_name = CRYPTO_strdup("xorhmacsha2sig", "../test/tls-provider.c", 1140);
    if (k->tls_name == 
# 1141 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 1141 "../test/tls-provider.c"
                          ) {
        xor_freekey(k);
        return 
# 1143 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1143 "../test/tls-provider.c"
                  ;
    }
    return k;
}
...
static const OSSL_DISPATCH xor_xorhmacsig_keymgmt_functions[] = {
    ...
    { 0, 
# 1170 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 1170 "../test/tls-provider.c"
   }
};
...
static const OSSL_DISPATCH xor_xorhmacsha2sig_keymgmt_functions[] = {
    ...
    { 23, (void (*)(void))xor_match },
    { 0, 
# 1194 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 1194 "../test/tls-provider.c"
   }
};
...
{
    XORKEY *key = 
# 1209 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 1209 "../test/tls-provider.c"
                     ;
    int nid = 0;

    if (palg != 
# 1212 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1212 "../test/tls-provider.c"
                   ) {
        int ptype;


        X509_ALGOR_get0(
# 1216 "../test/tls-provider.c" 3 4
                       ((void *)0)
# 1216 "../test/tls-provider.c"
                           , &ptype, 
# 1216 "../test/tls-provider.c" 3 4
                                     ((void *)0)
# 1216 "../test/tls-provider.c"
                                         , palg);
        if (ptype != -1 || palg->algorithm == 
# 1217 "../test/tls-provider.c" 3 4
                                                       ((void *)0)
# 1217 "../test/tls-provider.c"
                                                           ) {
            (ERR_new(), ERR_set_debug("../test/tls-provider.c",1218,__func__), ERR_set_error)((128),(7),
# 1218 "../test/tls-provider.c" 3 4
           ((void *)0)
# 1218 "../test/tls-provider.c"
           );
            return 0;
        }
    ...
    if (p == 
# 1224 "../test/tls-provider.c" 3 4
            ((void *)0) 
# 1224 "../test/tls-provider.c"
                 || nid == 0 || nid == 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1225,__func__), ERR_set_error)((128),(7),
# 1225 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1225 "../test/tls-provider.c"
       );
        return 0;
    }

    key = xor_newkey(
# 1229 "../test/tls-provider.c" 3 4
                    ((void *)0)
# 1229 "../test/tls-provider.c"
                        );
    if (key == 
# 1230 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1230 "../test/tls-provider.c"
                  ) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1231,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 1231 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1231 "../test/tls-provider.c"
       );
        return 0;
    }

    if (32 != plen) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1236,__func__), ERR_set_error)((128),(7),
# 1236 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1236 "../test/tls-provider.c"
       );
        goto err;
    }
    ...
    key->tls_name = CRYPTO_strdup(OBJ_nid2sn(nid), "../test/tls-provider.c", 1248);
    if (key->tls_name == 
# 1249 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1249 "../test/tls-provider.c"
                            )
        goto err;
    return key;
 ...
 err:
    xor_freekey(key);
    return 
# 1255 "../test/tls-provider.c" 3 4
          ((void *)0)
# 1255 "../test/tls-provider.c"
              ;
}
                                 ...
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (!xpk || (!X509_PUBKEY_get0_param(
# 1265 "../test/tls-provider.c" 3 4
                                        ((void *)0)
# 1265 "../test/tls-provider.c"
                                            , &p, &plen, &palg, xpk))) {
        return 
# 1266 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1266 "../test/tls-provider.c"
                  ;
    }
...
{
    XORKEY *xork = 
# 1274 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1274 "../test/tls-provider.c"
                      ;
    const unsigned char *p;
    int plen;
    ASN1_OCTET_STRING *oct = 
# 1277 "../test/tls-provider.c" 3 4
                            ((void *)0)
# 1277 "../test/tls-provider.c"
                                ;
    const X509_ALGOR *palg;

    if (!PKCS8_pkey_get0(
# 1280 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1280 "../test/tls-provider.c"
                            , &p, &plen, &palg, p8inf))
        return 0;

    oct = d2i_ASN1_OCTET_STRING(
# 1283 "../test/tls-provider.c" 3 4
                               ((void *)0)
# 1283 "../test/tls-provider.c"
                                   , &p, plen);
    if (oct == 
# 1284 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1284 "../test/tls-provider.c"
                  ) {
        p = 
# 1285 "../test/tls-provider.c" 3 4
           ((void *)0)
# 1285 "../test/tls-provider.c"
               ;
        plen = 0;
    } else {
...
static const OSSL_ALGORITHM tls_prov_keymgmt[] = {
    ...
    { 
# 1310 "../test/tls-provider.c" 3 4
     ((void *)0)
# 1310 "../test/tls-provider.c"
         , 
# 1310 "../test/tls-provider.c" 3 4
           ((void *)0)
# 1310 "../test/tls-provider.c"
                                          ...
                                          i2d_of_void *k2d)
{
    ...
    unsigned char *der = 
# 1356 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1356 "../test/tls-provider.c"
                            ;
    int derlen;

    PKCS8_PRIV_KEY_INFO *p8info = 
# 1359 "../test/tls-provider.c" 3 4
                                 ((void *)0)
# 1359 "../test/tls-provider.c"
                                     ;

    if ((p8info = PKCS8_PRIV_KEY_INFO_new()) == 
# 1361 "../test/tls-provider.c" 3 4
                                               ((void *)0)
        
# 1362 "../test/tls-provider.c"
       || (derlen = k2d(key, &der)) <= 0
        || !PKCS8_pkey_set0(p8info, OBJ_nid2obj(key_nid), 0,
                            -1, 
# 1364 "../test/tls-provider.c" 3 4
                                         ((void *)0)
# 1364 "../test/tls-provider.c"
                                             ,
                            der, derlen)) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1366,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 1366 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1366 "../test/tls-provider.c"
       );
        PKCS8_PRIV_KEY_INFO_free(p8info);
        CRYPTO_free(der, "../test/tls-provider.c", 1368);
        p8info = 
# 1369 "../test/tls-provider.c" 3 4
                ((void *)0)
# 1369 "../test/tls-provider.c"
                    ;
    }
...
{
    X509_SIG *p8 = 
# 1378 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1378 "../test/tls-provider.c"
                      ;
    char kstr[1024];
    size_t klen = 0;
    ...
    if (ctx->cipher == 
# 1383 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 1383 "../test/tls-provider.c"
                           || ctx->pwcb == 
# 1383 "../test/tls-provider.c" 3 4
                                           ((void *)0)
# 1383 "../test/tls-provider.c"
        ...
        return 
# 1384 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1384 "../test/tls-provider.c"
                  ;

    if (!ctx->pwcb(kstr, 1024, &klen, 
# 1386 "../test/tls-provider.c" 3 4
                                            ((void *)0)
# 1386 "../test/tls-provider.c"
                                                , ctx->pwcbarg)) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1387,__func__), ERR_set_error)((128),(159),
# 1387 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1387 "../test/tls-provider.c"
       );
        return 
# 1388 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1388 "../test/tls-provider.c"
                  ;
    }

    p8 = PKCS8_encrypt_ex(-1, ctx->cipher, kstr, klen, 
# 1391 "../test/tls-provider.c" 3 4
                                                      ((void *)0)
# 1391 "../test/tls-provider.c"
                                                          , 0, 0, p8info, libctx, 
# 1391 "../test/tls-provider.c" 3 4
                                                                                  ((void *)0)
# 1391 "../test/tls-provider.c"
                              ...
                              i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    ...
    X509_SIG *p8 = 
# 1402 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1402 "../test/tls-provider.c"
                      ;

    if (p8info == 
# 1404 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 1404 "../test/tls-provider.c"
                     ) {
                                  ...
                                  i2d_of_void k2d)
{
    ...
    unsigned char *der = 
# 1418 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1418 "../test/tls-provider.c"
                            ;
    int derlen;

    X509_PUBKEY *xpk = 
# 1421 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 1421 "../test/tls-provider.c"
                          ;

    if ((xpk = X509_PUBKEY_new()) == 
# 1423 "../test/tls-provider.c" 3 4
                                    ((void *)0)
        
# 1424 "../test/tls-provider.c"
       || (derlen = k2d(key, &der)) <= 0
        || !X509_PUBKEY_set0_param(xpk, OBJ_nid2obj(key_nid),
                        -1, 
# 1426 "../test/tls-provider.c" 3 4
                                     ((void *)0)
# 1426 "../test/tls-provider.c"
                                         ,
                        der, derlen)) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1428,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 1428 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1428 "../test/tls-provider.c"
       );
        X509_PUBKEY_free(xpk);
        CRYPTO_free(der, "../test/tls-provider.c", 1430);
        xpk = 
# 1431 "../test/tls-provider.c" 3 4
             ((void *)0)
# 1431 "../test/tls-provider.c"
                 ;
    }

    return xpk;
}
# 1456 "../test/tls-provider.c"
static int key_to_epki_der_priv_bio(BIO *out, const void *key,
                                    int key_nid,
                                    __attribute__((unused)) const char *pemname,
                                    ...
                                    struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = 
# 1464 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1464 "../test/tls-provider.c"
                   ;
    int strtype = -1;
    X509_SIG *p8;
    ...
    if (p2s != 
# 1471 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1471 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;

    p8 = key_to_encp8(key, key_nid, str, strtype, k2d, ctx);
    if (p8 != 
# 1476 "../test/tls-provider.c" 3 4
             ((void *)0)
# 1476 "../test/tls-provider.c"
                 )
                                    ...
                                    struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = 
# 1492 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1492 "../test/tls-provider.c"
                   ;
    int strtype = -1;
    X509_SIG *p8;
    ...
    if (p2s != 
# 1499 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1499 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;
    ...
    p8 = key_to_encp8(key, key_nid, str, strtype, k2d, ctx);
    if (p8 != 
# 1504 "../test/tls-provider.c" 3 4
             ((void *)0)
# 1504 "../test/tls-provider.c"
                 )
                                   ...
                                   struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = 
# 1520 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1520 "../test/tls-provider.c"
                   ;
    int strtype = -1;
    PKCS8_PRIV_KEY_INFO *p8info;
    ...
    if (p2s != 
# 1528 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1528 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;
    ...
    if (p8info != 
# 1534 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 1534 "../test/tls-provider.c"
                     )
                                   ...
                                   struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = 
# 1552 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1552 "../test/tls-provider.c"
                   ;
    int strtype = -1;
    PKCS8_PRIV_KEY_INFO *p8info;
    ...
    if (p2s != 
# 1560 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1560 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;
    ...
    if (p8info != 
# 1566 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 1566 "../test/tls-provider.c"
                     )
                                   ...
                                   struct key2any_ctx_st *ctx)
{
    int ret = 0;
    X509_PUBKEY *xpk = 
# 1584 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 1584 "../test/tls-provider.c"
                          ;
    void *str = 
# 1585 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1585 "../test/tls-provider.c"
                   ;
    int strtype = -1;

    if (p2s != 
# 1588 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1588 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;
    ...
    if (xpk != 
# 1594 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1594 "../test/tls-provider.c"
                  )
                                   ...
                                   struct key2any_ctx_st *ctx)
{
    int ret = 0;
    X509_PUBKEY *xpk = 
# 1609 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 1609 "../test/tls-provider.c"
                          ;
    void *str = 
# 1610 "../test/tls-provider.c" 3 4
               ((void *)0)
# 1610 "../test/tls-provider.c"
                   ;
    int strtype = -1;

    if (p2s != 
# 1613 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1613 "../test/tls-provider.c"
                   && !p2s(key, key_nid, ctx->save_parameters,
                            &str, &strtype))
        return 0;
    ...
    if (xpk != 
# 1619 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1619 "../test/tls-provider.c"
                  )
...
{
    ASN1_OBJECT *params = 
# 1634 "../test/tls-provider.c" 3 4
                         ((void *)0)
# 1634 "../test/tls-provider.c"
                             ;
    XORKEY *k = (XORKEY*)xorxkey;

    if (k->tls_name && OBJ_sn2nid(k->tls_name) != nid) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1638,__func__), ERR_set_error)((128),(3),
# 1638 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1638 "../test/tls-provider.c"
       );
        return 0;
    }

    if (nid == 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1643,__func__), ERR_set_error)((128),(5),
# 1643 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1643 "../test/tls-provider.c"
       );
        return 0;
    }
    ...
    if (params == 
# 1649 "../test/tls-provider.c" 3 4
                 ((void *)0) 
# 1649 "../test/tls-provider.c"
                      || OBJ_length(params) == 0) {

        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1651,__func__), ERR_set_error)((128),(5),
# 1651 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1651 "../test/tls-provider.c"
       );
...
static int xorx_spki_pub_to_der(const void *vecxkey, unsigned char **pder)
{
    ...
    if (xorxkey == 
# 1666 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1666 "../test/tls-provider.c"
                      ) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1667,__func__), ERR_set_error)((128),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1667 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1667 "../test/tls-provider.c"
       );
        return 0;
    }

    keyblob = CRYPTO_memdup((xorxkey->pubkey), retlen = 32, "../test/tls-provider.c", 1671);
    if (keyblob == 
# 1672 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1672 "../test/tls-provider.c"
                      ) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1673,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 1673 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1673 "../test/tls-provider.c"
       );
        return 0;
    }
...
static int xorx_pki_priv_to_der(const void *vecxkey, unsigned char **pder)
{
    ...
    unsigned char* buf = 
# 1684 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1684 "../test/tls-provider.c"
                            ;
    ASN1_OCTET_STRING oct;
    int keybloblen;

    if (xorxkey == 
# 1688 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1688 "../test/tls-provider.c"
                      ) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1689,__func__), ERR_set_error)((128),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1689 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1689 "../test/tls-provider.c"
       );
        return 0;
    }

    buf = CRYPTO_secure_malloc(32, "../test/tls-provider.c", 1693);
    ...
    if (keybloblen < 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1702,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 1702 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1702 "../test/tls-provider.c"
       );
        keybloblen = 0;
    }

    CRYPTO_secure_clear_free(buf, 32, "../test/tls-provider.c", 1706);
    return keybloblen;
}
# 1728 "../test/tls-provider.c"
...
{
    struct key2any_ctx_st *ctx = CRYPTO_zalloc(sizeof(*ctx), "../test/tls-provider.c", 1733);

    if (ctx != 
# 1735 "../test/tls-provider.c" 3 4
              ((void *)0)
# 1735 "../test/tls-provider.c"
                  ) {
        ctx->provctx = provctx;
...
static void key2any_freectx(void *vctx)
{
    ...
    CRYPTO_free(ctx, "../test/tls-provider.c", 1748);
}

static const OSSL_PARAM *key2any_settable_ctx_params(__attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM settables[] = {
        { (("cipher")), (4), ((
# 1754 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1754 "../test/tls-provider.c"
       )), (0), ((size_t)-1) },
        { (("properties")), (4), ((
# 1755 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1755 "../test/tls-provider.c"
       )), (0), ((size_t)-1) },
        { 
# 1756 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1756 "../test/tls-provider.c"
       , 0, 
# 1756 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1756 "../test/tls-provider.c"
...
static int key2any_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (cipherp != 
# 1773 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1773 "../test/tls-provider.c"
                      ) {
        const char *ciphername = 
# 1774 "../test/tls-provider.c" 3 4
                                ((void *)0)
# 1774 "../test/tls-provider.c"
                                    ;
        const char *props = 
# 1775 "../test/tls-provider.c" 3 4
                           ((void *)0)
# 1775 "../test/tls-provider.c"
                               ;

        if (!OSSL_PARAM_get_utf8_string_ptr(cipherp, &ciphername))
            return 0;
        if (propsp != 
# 1779 "../test/tls-provider.c" 3 4
                     ((void *)0) 
# 1779 "../test/tls-provider.c"
                          && !OSSL_PARAM_get_utf8_string_ptr(propsp, &props))
            return 0;

        EVP_CIPHER_free(ctx->cipher);
        ctx->cipher = 
# 1783 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 1783 "../test/tls-provider.c"
                         ;
        ctx->cipher_intent = ciphername != 
# 1784 "../test/tls-provider.c" 3 4
                                          ((void *)0)
# 1784 "../test/tls-provider.c"
                                              ;
        if (ciphername != 
# 1785 "../test/tls-provider.c" 3 4
                         ((void *)0)
            
# 1786 "../test/tls-provider.c"
           && ((ctx->cipher =
                 EVP_CIPHER_fetch(libctx, ciphername, props)) == 
# 1787 "../test/tls-provider.c" 3 4
                                                                ((void *)0)
# 1787 "../test/tls-provider.c"
                                                                    )) {
            return 0;
        }
    }
    ...
    if (save_paramsp != 
# 1792 "../test/tls-provider.c" 3 4
                       ((void *)0)
# 1792 "../test/tls-provider.c"
                           ) {
                          ...
                          i2d_of_void *key2der)
{
    ...
    if (key == 
# 1843 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 1843 "../test/tls-provider.c"
                   || type <= 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",1844,__func__), ERR_set_error)((128),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1844 "../test/tls-provider.c" 3 4
       ((void *)0)
# 1844 "../test/tls-provider.c"
       );
    } else if (writer != 
# 1845 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 1845 "../test/tls-provider.c"
                            ) {
        BIO *out = BIO_new_from_core_bio(ctx->provctx->libctx, cout);

        if (out != 
# 1848 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 1848 "../test/tls-provider.c"
                      ) {
            ctx->pwcb = pwcb;
            ctx->pwcbarg = pwcbarg;
...
# 2033 "../test/tls-provider.c" 3 4
((void *)0)
# 2033 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2033,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2033 "../test/tls-provider.c" 3 4
((void *)0)
# 2033 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsig", "xorhmacsig" " PRIVATE KEY", key_to_epki_pem_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2033,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2033 "../test/tls-provider.c" 3 4
((void *)0)
# 2033 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsig_to_EncryptedPrivateKeyInfo_pem_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsig_to_EncryptedPrivateKeyInfo_pem_does_selection }, { 20, (void (*)(void))xorhmacsig_to_EncryptedPrivateKeyInfo_pem_import_object }, { 21, (void (*)(void))xorhmacsig_to_EncryptedPrivateKeyInfo_pem_free_object }, { 11, (void (*)(void))xorhmacsig_to_EncryptedPrivateKeyInfo_pem_encode }, { 0, 
# 2033 "../test/tls-provider.c" 3 4
((void *)0) 
# 2033 "../test/tls-provider.c"
} };
...
# 2034 "../test/tls-provider.c" 3 4
((void *)0)
# 2034 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2034,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2034 "../test/tls-provider.c" 3 4
((void *)0)
# 2034 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsig", "xorhmacsig" " PRIVATE KEY", key_to_pki_der_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2034,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2034 "../test/tls-provider.c" 3 4
((void *)0)
# 2034 "../test/tls-provider.c"
...
# 2035 "../test/tls-provider.c" 3 4
((void *)0)
# 2035 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2035,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2035 "../test/tls-provider.c" 3 4
((void *)0)
# 2035 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsig", "xorhmacsig" " PRIVATE KEY", key_to_pki_pem_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2035,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2035 "../test/tls-provider.c" 3 4
((void *)0)
# 2035 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsig_to_PrivateKeyInfo_pem_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsig_to_PrivateKeyInfo_pem_does_selection }, { 20, (void (*)(void))xorhmacsig_to_PrivateKeyInfo_pem_import_object }, { 21, (void (*)(void))xorhmacsig_to_PrivateKeyInfo_pem_free_object }, { 11, (void (*)(void))xorhmacsig_to_PrivateKeyInfo_pem_encode }, { 0, 
# 2035 "../test/tls-provider.c" 3 4
((void *)0) 
# 2035 "../test/tls-provider.c"
} };
...
# 2036 "../test/tls-provider.c" 3 4
((void *)0)
# 2036 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2036,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2036 "../test/tls-provider.c" 3 4
((void *)0)
# 2036 "../test/tls-provider.c"
); return 0; } if ((selection & 0x02) != 0) return key2any_encode(ctx, cout, key, "xorhmacsig", "xorhmacsig" " PUBLIC KEY", key_to_spki_der_pub_bio, cb, cbarg, prepare_xorx_params, xorx_spki_pub_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2036,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2036 "../test/tls-provider.c" 3 4
((void *)0)
# 2036 "../test/tls-provider.c"
...
# 2037 "../test/tls-provider.c" 3 4
((void *)0)
# 2037 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2037,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2037 "../test/tls-provider.c" 3 4
((void *)0)
# 2037 "../test/tls-provider.c"
); return 0; } if ((selection & 0x02) != 0) return key2any_encode(ctx, cout, key, "xorhmacsig", "xorhmacsig" " PUBLIC KEY", key_to_spki_pem_pub_bio, cb, cbarg, prepare_xorx_params, xorx_spki_pub_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2037,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2037 "../test/tls-provider.c" 3 4
((void *)0)
# 2037 "../test/tls-provider.c"
...
# 2038 "../test/tls-provider.c" 3 4
((void *)0)
# 2038 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2038,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2038 "../test/tls-provider.c" 3 4
((void *)0)
# 2038 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PRIVATE KEY", key_to_epki_der_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2038,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2038 "../test/tls-provider.c" 3 4
((void *)0)
# 2038 "../test/tls-provider.c"
...
# 2039 "../test/tls-provider.c" 3 4
((void *)0)
# 2039 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2039,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2039 "../test/tls-provider.c" 3 4
((void *)0)
# 2039 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PRIVATE KEY", key_to_epki_pem_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2039,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2039 "../test/tls-provider.c" 3 4
((void *)0)
# 2039 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_does_selection }, { 20, (void (*)(void))xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_import_object }, { 21, (void (*)(void))xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_free_object }, { 11, (void (*)(void))xorhmacsha2sig_to_EncryptedPrivateKeyInfo_pem_encode }, { 0, 
# 2039 "../test/tls-provider.c" 3 4
((void *)0) 
# 2039 "../test/tls-provider.c"
} };
...
# 2040 "../test/tls-provider.c" 3 4
((void *)0)
# 2040 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2040,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2040 "../test/tls-provider.c" 3 4
((void *)0)
# 2040 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PRIVATE KEY", key_to_pki_der_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2040,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2040 "../test/tls-provider.c" 3 4
((void *)0)
# 2040 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsha2sig_to_PrivateKeyInfo_der_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_der_does_selection }, { 20, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_der_import_object }, { 21, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_der_free_object }, { 11, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_der_encode }, { 0, 
# 2040 "../test/tls-provider.c" 3 4
((void *)0) 
# 2040 "../test/tls-provider.c"
} };
...
# 2041 "../test/tls-provider.c" 3 4
((void *)0)
# 2041 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2041,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2041 "../test/tls-provider.c" 3 4
((void *)0)
# 2041 "../test/tls-provider.c"
); return 0; } if ((selection & 0x01) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PRIVATE KEY", key_to_pki_pem_priv_bio, cb, cbarg, prepare_xorx_params, xorx_pki_priv_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2041,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2041 "../test/tls-provider.c" 3 4
((void *)0)
# 2041 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsha2sig_to_PrivateKeyInfo_pem_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_pem_does_selection }, { 20, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_pem_import_object }, { 21, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_pem_free_object }, { 11, (void (*)(void))xorhmacsha2sig_to_PrivateKeyInfo_pem_encode }, { 0, 
# 2041 "../test/tls-provider.c" 3 4
((void *)0) 
# 2041 "../test/tls-provider.c"
} };
...
# 2042 "../test/tls-provider.c" 3 4
((void *)0)
# 2042 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2042,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2042 "../test/tls-provider.c" 3 4
((void *)0)
# 2042 "../test/tls-provider.c"
); return 0; } if ((selection & 0x02) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PUBLIC KEY", key_to_spki_der_pub_bio, cb, cbarg, prepare_xorx_params, xorx_spki_pub_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2042,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2042 "../test/tls-provider.c" 3 4
((void *)0)
# 2042 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsha2sig_to_SubjectPublicKeyInfo_der_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_der_does_selection }, { 20, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_der_import_object }, { 21, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_der_free_object }, { 11, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_der_encode }, { 0, 
# 2042 "../test/tls-provider.c" 3 4
((void *)0) 
# 2042 "../test/tls-provider.c"
} };
...
# 2043 "../test/tls-provider.c" 3 4
((void *)0)
# 2043 "../test/tls-provider.c"
) { (ERR_new(), ERR_set_debug("../test/tls-provider.c",2043,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2043 "../test/tls-provider.c" 3 4
((void *)0)
# 2043 "../test/tls-provider.c"
); return 0; } if ((selection & 0x02) != 0) return key2any_encode(ctx, cout, key, "xorhmacsha2sig", "xorhmacsha2sig" " PUBLIC KEY", key_to_spki_pem_pub_bio, cb, cbarg, prepare_xorx_params, xorx_spki_pub_to_der); (ERR_new(), ERR_set_debug("../test/tls-provider.c",2043,__func__), ERR_set_error)((128),((262|(0x2 << 18L))),
# 2043 "../test/tls-provider.c" 3 4
((void *)0)
# 2043 "../test/tls-provider.c"
); return 0; } static const OSSL_DISPATCH xor_xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_encoder_functions[] = { { 1, (void (*)(void))key2any_newctx }, { 2, (void (*)(void))key2any_freectx }, { 6, (void (*)(void))key2any_settable_ctx_params }, { 5, (void (*)(void))key2any_set_ctx_params }, { 10, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_does_selection }, { 20, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_import_object }, { 21, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_free_object }, { 11, (void (*)(void))xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_encode }, { 0, 
# 2043 "../test/tls-provider.c" 3 4
((void *)0) 
# 2043 "../test/tls-provider.c"
} };
...
{ "xorhmacsha2sig", "provider=" "tls-provider" ",fips=yes,output=" "pem" ",structure=" "SubjectPublicKeyInfo", (xor_xorhmacsha2sig_to_SubjectPublicKeyInfo_pem_encoder_functions) }
    ...
    { 
# 2109 "../test/tls-provider.c" 3 4
     ((void *)0)
# 2109 "../test/tls-provider.c"
         , 
# 2109 "../test/tls-provider.c" 3 4
           ((void *)0)
# 2109 "../test/tls-provider.c"
...
static const ASN1_TEMPLATE X509_PUBKEY_INTERNAL_seq_tt[] = {
        { (0), (0), 
# 2177 "../test/tls-provider.c" 3 4
       __builtin_offsetof (
# 2177 "../test/tls-provider.c"
       X509_PUBKEY
# 2177 "../test/tls-provider.c" 3 4
       , 
# 2177 "../test/tls-provider.c"
...
# 2177 "../test/tls-provider.c"
       , "algor", (X509_ALGOR_it) },
        { (0), (0), 
# 2178 "../test/tls-provider.c" 3 4
       __builtin_offsetof (
# 2178 "../test/tls-provider.c"
       X509_PUBKEY
# 2178 "../test/tls-provider.c" 3 4
       , 
# 2178 "../test/tls-provider.c"
...
# 2179 "../test/tls-provider.c" 3 4
 ((void *)0)
# 2179 "../test/tls-provider.c"
...
{
    X509_PUBKEY *xpub = CRYPTO_zalloc(sizeof(*xpub), "../test/tls-provider.c", 2184);

    if (xpub == 
# 2186 "../test/tls-provider.c" 3 4
               ((void *)0)
# 2186 "../test/tls-provider.c"
                   )
        return 
# 2187 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2187 "../test/tls-provider.c"
                  ;
    return (X509_PUBKEY *)ASN1_item_d2i_ex((ASN1_VALUE **)&xpub, pp, len,
                                           (X509_PUBKEY_INTERNAL_it()),
                                           libctx, 
# 2190 "../test/tls-provider.c" 3 4
                                                  ((void *)0)
# 2190 "../test/tls-provider.c"
                                                      );
}
...
{
    BUF_MEM *mem = 
# 2209 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 2209 "../test/tls-provider.c"
                      ;
    ...
    if (ok) {
        ...
        *len = (long)mem->length;
        CRYPTO_free(mem, "../test/tls-provider.c", 2216);
    }
    BIO_free(in);
    return ok;
}
...
{
    PKCS8_PRIV_KEY_INFO *p8inf = 
# 2228 "../test/tls-provider.c" 3 4
                                ((void *)0)
# 2228 "../test/tls-provider.c"
                                    ;
    const X509_ALGOR *alg = 
# 2229 "../test/tls-provider.c" 3 4
                           ((void *)0)
# 2229 "../test/tls-provider.c"
                               ;
    void *key = 
# 2230 "../test/tls-provider.c" 3 4
               ((void *)0)
# 2230 "../test/tls-provider.c"
                   ;

    if ((p8inf = d2i_PKCS8_PRIV_KEY_INFO(
# 2232 "../test/tls-provider.c" 3 4
                                        ((void *)0)
# 2232 "../test/tls-provider.c"
                                            , input_der, input_der_len)) != 
# 2232 "../test/tls-provider.c" 3 4
                                                                            ((void *)0)
        
# 2233 "../test/tls-provider.c"
       && PKCS8_pkey_get0(
# 2233 "../test/tls-provider.c" 3 4
                          ((void *)0)
# 2233 "../test/tls-provider.c"
                              , 
# 2233 "../test/tls-provider.c" 3 4
...
# 2233 "../test/tls-provider.c"
        ...
        key = key_from_pkcs8(p8inf, (((PROV_XOR_CTX *)ctx->provctx)->libctx), 
# 2235 "../test/tls-provider.c" 3 4
                                                                     ((void *)0)
# 2235 "../test/tls-provider.c"
                                                                         );
...
{
    XORKEY *key = 
# 2244 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 2244 "../test/tls-provider.c"
                     ;
    X509_PUBKEY *xpk;

    xpk = xorx_d2i_X509_PUBKEY_INTERNAL(pp, length, 
# 2247 "../test/tls-provider.c" 3 4
                                                   ((void *)0)
# 2247 "../test/tls-provider.c"
                                                       );

    key = xor_key_from_x509pubkey(xpk, 
# 2249 "../test/tls-provider.c" 3 4
                                      ((void *)0)
# 2249 "../test/tls-provider.c"
                                          , 
# 2249 "../test/tls-provider.c" 3 4
                                            ((void *)0)
# 2249 "../test/tls-provider.c"
    ...
    if (key == 
# 2251 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2251 "../test/tls-provider.c"
                  )
        goto err_exit;

    if (a != 
# 2254 "../test/tls-provider.c" 3 4
            ((void *)0)
# 2254 "../test/tls-provider.c"
                ) {
        xor_freekey(*a);
        *a = key;
    }
...
{
    struct der2key_ctx_st *ctx = CRYPTO_zalloc(sizeof(*ctx), "../test/tls-provider.c", 2274);

    if (ctx != 
# 2276 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2276 "../test/tls-provider.c"
                  ) {
        ctx->provctx = provctx;
        ctx->desc = desc;
        if (desc->evp_type == 0) {
...
static void der2key_freectx(void *vctx)
{
    ...
    CRYPTO_free(ctx, "../test/tls-provider.c", 2290);
}
                          ...
                          OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    struct der2key_ctx_st *ctx = vctx;
    unsigned char *der = 
# 2332 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 2332 "../test/tls-provider.c"
                            ;
    const unsigned char *derp;
    long der_len = 0;
    void *key = 
# 2335 "../test/tls-provider.c" 3 4
               ((void *)0)
# 2335 "../test/tls-provider.c"
                   ;
    int ok = 0;

    ctx->selection = selection;
# 2347 "../test/tls-provider.c"
    if (selection == 0)
        selection = ctx->desc->selection_mask;
    if ((selection & ctx->desc->selection_mask) == 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2350,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 2350 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2350 "../test/tls-provider.c"
       );
        return 0;
    }
...
# 2362 "../test/tls-provider.c" 3 4
                                   ((void *)0)
# 2362 "../test/tls-provider.c"
                                       ) {
            key = ctx->desc->d2i_PKCS8(
# 2363 "../test/tls-provider.c" 3 4
                                      ((void *)0)
# 2363 "../test/tls-provider.c"
                                          , &derp, der_len, ctx);
            if (ctx->flag_fatal)
                goto end;
        } else if (ctx->desc->d2i_private_key != 
# 2366 "../test/tls-provider.c" 3 4
                                                ((void *)0)
# 2366 "../test/tls-provider.c"
                                                    ) {
            key = ctx->desc->d2i_private_key(
# 2367 "../test/tls-provider.c" 3 4
                                            ((void *)0)
# 2367 "../test/tls-provider.c"
                                                , &derp, der_len);
        }
        if (key == 
# 2369 "../test/tls-provider.c" 3 4
                  ((void *)0) 
# 2369 "../test/tls-provider.c"
                       && ctx->selection != 0)
            goto next;
    }
    if (key == 
# 2372 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 2372 "../test/tls-provider.c"
                   && (selection & 0x02) != 0) {
        derp = der;
        if (ctx->desc->d2i_PUBKEY != 
# 2374 "../test/tls-provider.c" 3 4
                                    ((void *)0)
# 2374 "../test/tls-provider.c"
                                        )
            key = ctx->desc->d2i_PUBKEY(
# 2375 "../test/tls-provider.c" 3 4
                                       ((void *)0)
# 2375 "../test/tls-provider.c"
                                           , &derp, der_len);
        else
            key = ctx->desc->d2i_public_key(
# 2377 "../test/tls-provider.c" 3 4
                                           ((void *)0)
# 2377 "../test/tls-provider.c"
                                               , &derp, der_len);
        if (key == 
# 2378 "../test/tls-provider.c" 3 4
                  ((void *)0) 
# 2378 "../test/tls-provider.c"
                       && ctx->selection != 0)
            goto next;
    }
    if (key == 
# 2381 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 2381 "../test/tls-provider.c"
                   && (selection & ( 0x04 | 0x80)) != 0) {
        derp = der;
        if (ctx->desc->d2i_key_params != 
# 2383 "../test/tls-provider.c" 3 4
                                        ((void *)0)
# 2383 "../test/tls-provider.c"
                                            )
            key = ctx->desc->d2i_key_params(
# 2384 "../test/tls-provider.c" 3 4
                                           ((void *)0)
# 2384 "../test/tls-provider.c"
                                               , &derp, der_len);
        if (key == 
# 2385 "../test/tls-provider.c" 3 4
                  ((void *)0) 
# 2385 "../test/tls-provider.c"
                       && ctx->selection != 0)
            goto next;
    }
# 2396 "../test/tls-provider.c"
    if (key != 
# 2396 "../test/tls-provider.c" 3 4
              ((void *)0)
        
# 2397 "../test/tls-provider.c"
       && ctx->desc->check_key != 
# 2397 "../test/tls-provider.c" 3 4
                                  ((void *)0)
        
# 2398 "../test/tls-provider.c"
       && !ctx->desc->check_key(key, ctx)) {
        ctx->desc->free_key(key);
        key = 
# 2400 "../test/tls-provider.c" 3 4
             ((void *)0)
# 2400 "../test/tls-provider.c"
                 ;
    }

    if (key != 
# 2403 "../test/tls-provider.c" 3 4
              ((void *)0) 
# 2403 "../test/tls-provider.c"
                   && ctx->desc->adjust_key != 
# 2403 "../test/tls-provider.c" 3 4
                                               ((void *)0)
# 2403 "../test/tls-provider.c"
 ...
 next:
    ...
    CRYPTO_free(der, "../test/tls-provider.c", 2418);
    der = 
# 2419 "../test/tls-provider.c" 3 4
         ((void *)0)
# 2419 "../test/tls-provider.c"
             ;

    if (key != 
# 2421 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2421 "../test/tls-provider.c"
                  ) {
        OSSL_PARAM params[4];
        int object_type = 2;
    ...
    ctx->desc->free_key(key);
    CRYPTO_free(der, "../test/tls-provider.c", 2442);
...
# 2456 "../test/tls-provider.c" 3 4
                                                    ((void *)0)
# 2456 "../test/tls-provider.c"
                                                        ) {
...
# 2553 "../test/tls-provider.c"
static struct keytype_desc_st PrivateKeyInfo_xorhmacsig_desc = { "xorhmacsig", xor_xorhmacsig_keymgmt_functions, "PrivateKeyInfo", 0, ( 0x01 ), 
# 2553 "../test/tls-provider.c" 3 4
((void *)0)
# 2553 "../test/tls-provider.c"
, 
# 2553 "../test/tls-provider.c" 3 4
...
{ "xorhmacsha2sig", "provider=" "tls-provider" ",fips=yes,input=" "der" ",structure=" "SubjectPublicKeyInfo", (xor_SubjectPublicKeyInfo_der_to_xorhmacsha2sig_decoder_functions) },
    ...
    { 
# 2584 "../test/tls-provider.c" 3 4
     ((void *)0)
# 2584 "../test/tls-provider.c"
         , 
# 2584 "../test/tls-provider.c" 3 4
           ((void *)0)
# 2584 "../test/tls-provider.c"
...
static int xor_get_aid(unsigned char** oidbuf, const char *tls_name) {
   ...
   X509_ALGOR_set0(algor, OBJ_txt2obj(tls_name, 0), -1, 
# 2616 "../test/tls-provider.c" 3 4
                                                                 ((void *)0)
# 2616 "../test/tls-provider.c"
                                                                     );
...
static void *xor_sig_newctx(void *provctx, const char *propq)
{
    ...
    pxor_sigctx = CRYPTO_zalloc(sizeof(PROV_XORSIG_CTX), "../test/tls-provider.c", 2655);
    if (pxor_sigctx == 
# 2656 "../test/tls-provider.c" 3 4
                      ((void *)0)
# 2656 "../test/tls-provider.c"
                          )
        return 
# 2657 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2657 "../test/tls-provider.c"
                  ;

    pxor_sigctx->libctx = ((PROV_XOR_CTX*)provctx)->libctx;
    pxor_sigctx->flag_allow_md = 0;
    if (propq != 
# 2661 "../test/tls-provider.c" 3 4
                ((void *)0) 
# 2661 "../test/tls-provider.c"
                     && (pxor_sigctx->propq = CRYPTO_strdup(propq, "../test/tls-provider.c", 2661)) == 
# 2661 "../test/tls-provider.c" 3 4
                                                                        ((void *)0)
# 2661 "../test/tls-provider.c"
                                                                            ) {
        CRYPTO_free(pxor_sigctx, "../test/tls-provider.c", 2662);
        pxor_sigctx = 
# 2663 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 2663 "../test/tls-provider.c"
                         ;
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2664,__func__), ERR_set_error)((128),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 2664 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2664 "../test/tls-provider.c"
       );
    }
    return pxor_sigctx;
}
                        ...
                        const char *mdname, const char *mdprops)
{
    ...
    if (mdprops == 
# 2674 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 2674 "../test/tls-provider.c"
                      )
        mdprops = ctx->propq;
    ...
    if ((md == 
# 2679 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2679 "../test/tls-provider.c"
                  ) || (EVP_MD_get_type(md)==0)) {
        if (md == 
# 2680 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 2680 "../test/tls-provider.c"
                     )
            (ERR_new(), ERR_set_debug("../test/tls-provider.c",2681,__func__), ERR_set_error)(128, 1,
    ...
    ctx->mdctx = 
# 2688 "../test/tls-provider.c" 3 4
                ((void *)0)
# 2688 "../test/tls-provider.c"
                    ;
    EVP_MD_free(ctx->md);
    ctx->md = 
# 2690 "../test/tls-provider.c" 3 4
             ((void *)0)
# 2690 "../test/tls-provider.c"
                 ;

    CRYPTO_free(ctx->aid, "../test/tls-provider.c", 2692);
    ctx->aid = 
# 2693 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2693 "../test/tls-provider.c"
                  ;
    ...
    ctx->mdctx = 
# 2700 "../test/tls-provider.c" 3 4
                ((void *)0)
# 2700 "../test/tls-provider.c"
                    ;
    ctx->md = md;
                                   ...
                                   int operation)
{
    ...
    if (pxor_sigctx == 
# 2711 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 2711 "../test/tls-provider.c"
                           || vxorsig == 
# 2711 "../test/tls-provider.c" 3 4
                                         ((void *)0)
# 2711 "../test/tls-provider.c"
    ...
    if ((operation==(1<<4) && pxor_sigctx->sig == 
# 2718 "../test/tls-provider.c" 3 4
                                                           ((void *)0)
# 2718 "../test/tls-provider.c"
                                                               )
        || (operation==(1<<5) && pxor_sigctx->sig == 
# 2719 "../test/tls-provider.c" 3 4
                                                                ((void *)0)
# 2719 "../test/tls-provider.c"
                                                                    )) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2720,__func__), ERR_set_error)((128),(3),
# 2720 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2720 "../test/tls-provider.c"
       );
        return 0;
    }
    return 1;
                    ...
                    size_t sigsize, const unsigned char *tbs, size_t tbslen)
{
    ...
    if (xorkey == 
# 2748 "../test/tls-provider.c" 3 4
                 ((void *)0) 
# 2748 "../test/tls-provider.c"
                      || !xorkey->hasprivkey) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2749,__func__), ERR_set_error)((128),(10),
# 2749 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2749 "../test/tls-provider.c"
       );
        return rv;
    }

    if (sig == 
# 2753 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2753 "../test/tls-provider.c"
                  ) {
        *siglen = max_sig_len;
        return 1;
    }
    if (*siglen < max_sig_len) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2758,__func__), ERR_set_error)((128),(11),
# 2758 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2758 "../test/tls-provider.c"
       );
        return rv;
    }
    ...
    if (!EVP_Q_mac(pxor_sigctx->libctx, "HMAC", 
# 2766 "../test/tls-provider.c" 3 4
                                               ((void *)0)
# 2766 "../test/tls-provider.c"
                                                   , "sha1", 
# 2766 "../test/tls-provider.c" 3 4
                                                             ((void *)0)
# 2766 "../test/tls-provider.c"
        ...
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2769,__func__), ERR_set_error)((128),(12),
# 2769 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2769 "../test/tls-provider.c"
       );
        goto endsign;
    }
                          ...
                          const unsigned char *tbs, size_t tbslen)
{
    ...
    if (xorkey == 
# 2790 "../test/tls-provider.c" 3 4
                 ((void *)0) 
# 2790 "../test/tls-provider.c"
                      || sig == 
# 2790 "../test/tls-provider.c" 3 4
                                ((void *)0) 
# 2790 "../test/tls-provider.c"
...
# 2790 "../test/tls-provider.c"
        ...
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2791,__func__), ERR_set_error)((128),(13),
# 2791 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2791 "../test/tls-provider.c"
       );
        return 0;
    }
    ...
    if (!EVP_Q_mac(pxor_sigctx->libctx, "HMAC", 
# 2804 "../test/tls-provider.c" 3 4
                                               ((void *)0)
# 2804 "../test/tls-provider.c"
                                                   , "sha1", 
# 2804 "../test/tls-provider.c" 3 4
                                                             ((void *)0)
# 2804 "../test/tls-provider.c"
        ...
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2807,__func__), ERR_set_error)((128),(14),
# 2807 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2807 "../test/tls-provider.c"
       );
        return 0;
    }
    ...
    if (siglen != resiglen || memcmp(resignature, sig, siglen) != 0) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",2813,__func__), ERR_set_error)((128),(14),
# 2813 "../test/tls-provider.c" 3 4
       ((void *)0)
# 2813 "../test/tls-provider.c"
       );
        return 0;
    }
    return 1;
                                      ...
                                      void *vxorsig, int operation)
{
    ...
    if (rmdname == 
# 2825 "../test/tls-provider.c" 3 4
                  ((void *)0)
# 2825 "../test/tls-provider.c"
                      )
        rmdname = "sha256";
    ...
    if (!xor_sig_setup_md(pxor_sigctx, rmdname, 
# 2832 "../test/tls-provider.c" 3 4
                                               ((void *)0)
# 2832 "../test/tls-provider.c"
                                                   ))
        return 0;

    pxor_sigctx->mdctx = EVP_MD_CTX_new();
    if (pxor_sigctx->mdctx == 
# 2836 "../test/tls-provider.c" 3 4
                             ((void *)0)
# 2836 "../test/tls-provider.c"
                                 )
        goto error;

    if (!EVP_DigestInit_ex(pxor_sigctx->mdctx, pxor_sigctx->md, 
# 2839 "../test/tls-provider.c" 3 4
                                                               ((void *)0)
# 2839 "../test/tls-provider.c"
                                                                   ))
        goto error;
 ...
 error:
    ...
    pxor_sigctx->mdctx = 
# 2847 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 2847 "../test/tls-provider.c"
                            ;
    pxor_sigctx->md = 
# 2848 "../test/tls-provider.c" 3 4
                     ((void *)0)
# 2848 "../test/tls-provider.c"
                         ;
    return 0;
}
                                     ...
                                     size_t datalen)
{
    ...
    if (pxor_sigctx == 
# 2871 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 2871 "../test/tls-provider.c"
                           || pxor_sigctx->mdctx == 
# 2871 "../test/tls-provider.c" 3 4
                                                    ((void *)0)
# 2871 "../test/tls-provider.c"
                              ...
                              size_t sigsize)
{
    ...
    if (sig != 
# 2885 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2885 "../test/tls-provider.c"
                  ) {
        if (pxor_sigctx == 
# 2886 "../test/tls-provider.c" 3 4
                          ((void *)0) 
# 2886 "../test/tls-provider.c"
                               || pxor_sigctx->mdctx == 
# 2886 "../test/tls-provider.c" 3 4
                                                        ((void *)0)
# 2886 "../test/tls-provider.c"
                            ...
                            size_t siglen)
{
    ...
    if (pxor_sigctx == 
# 2906 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 2906 "../test/tls-provider.c"
                           || pxor_sigctx->mdctx == 
# 2906 "../test/tls-provider.c" 3 4
                                                    ((void *)0)
# 2906 "../test/tls-provider.c"
...
static void xor_sig_freectx(void *vpxor_sigctx)
{
    ...
    CRYPTO_free(ctx->propq, "../test/tls-provider.c", 2921);
    EVP_MD_CTX_free(ctx->mdctx);
    EVP_MD_free(ctx->md);
    ctx->propq = 
# 2924 "../test/tls-provider.c" 3 4
                ((void *)0)
# 2924 "../test/tls-provider.c"
                    ;
    ctx->mdctx = 
# 2925 "../test/tls-provider.c" 3 4
                ((void *)0)
# 2925 "../test/tls-provider.c"
                    ;
    ctx->md = 
# 2926 "../test/tls-provider.c" 3 4
             ((void *)0)
# 2926 "../test/tls-provider.c"
                 ;
    xor_freekey(ctx->sig);
    ctx->sig = 
# 2928 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2928 "../test/tls-provider.c"
                  ;
    CRYPTO_free(ctx->aid, "../test/tls-provider.c", 2929);
    CRYPTO_free(ctx, "../test/tls-provider.c", 2930);
}
...
static void *xor_sig_dupctx(void *vpxor_sigctx)
{
    ...
    dstctx = CRYPTO_zalloc(sizeof(*srcctx), "../test/tls-provider.c", 2938);
    if (dstctx == 
# 2939 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 2939 "../test/tls-provider.c"
                     )
        return 
# 2940 "../test/tls-provider.c" 3 4
              ((void *)0)
# 2940 "../test/tls-provider.c"
                  ;

    *dstctx = *srcctx;
    dstctx->sig = 
# 2943 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 2943 "../test/tls-provider.c"
                     ;
    dstctx->md = 
# 2944 "../test/tls-provider.c" 3 4
                ((void *)0)
# 2944 "../test/tls-provider.c"
                    ;
    dstctx->mdctx = 
# 2945 "../test/tls-provider.c" 3 4
                   ((void *)0)
# 2945 "../test/tls-provider.c"
                       ;
    dstctx->aid = 
# 2946 "../test/tls-provider.c" 3 4
                 ((void *)0)
# 2946 "../test/tls-provider.c"
                     ;

    if ((srcctx->sig != 
# 2948 "../test/tls-provider.c" 3 4
                       ((void *)0)
# 2948 "../test/tls-provider.c"
                           ) && !xor_key_up_ref(srcctx->sig))
        goto err;
    dstctx->sig = srcctx->sig;

    if (srcctx->md != 
# 2952 "../test/tls-provider.c" 3 4
                     ((void *)0) 
# 2952 "../test/tls-provider.c"
                          && !EVP_MD_up_ref(srcctx->md))
        goto err;
    dstctx->md = srcctx->md;

    if (srcctx->mdctx != 
# 2956 "../test/tls-provider.c" 3 4
                        ((void *)0)
# 2956 "../test/tls-provider.c"
                            ) {
        dstctx->mdctx = EVP_MD_CTX_new();
        if (dstctx->mdctx == 
# 2958 "../test/tls-provider.c" 3 4
                            ((void *)0)
                
# 2959 "../test/tls-provider.c"
 ...
 err:
    ...
    return 
# 2966 "../test/tls-provider.c" 3 4
          ((void *)0)
# 2966 "../test/tls-provider.c"
              ;
}
...
static int xor_sig_get_ctx_params(void *vpxor_sigctx, OSSL_PARAM *params)
{
    ...
    if (pxor_sigctx == 
# 2974 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 2974 "../test/tls-provider.c"
                           || params == 
# 2974 "../test/tls-provider.c" 3 4
                                        ((void *)0)
# 2974 "../test/tls-provider.c"
    ...
    if (pxor_sigctx->aid == 
# 2979 "../test/tls-provider.c" 3 4
                           ((void *)0)
# 2979 "../test/tls-provider.c"
                               )
        pxor_sigctx->aid_len = xor_get_aid(&(pxor_sigctx->aid), pxor_sigctx->sig->tls_name);

    if (p != 
# 2982 "../test/tls-provider.c" 3 4
            ((void *)0)
        
# 2983 "../test/tls-provider.c"
       && !OSSL_PARAM_set_octet_string(p, pxor_sigctx->aid, pxor_sigctx->aid_len))
        return 0;

    p = OSSL_PARAM_locate(params, "digest");
    if (p != 
# 2987 "../test/tls-provider.c" 3 4
            ((void *)0) 
# 2987 "../test/tls-provider.c"
                 && !OSSL_PARAM_set_utf8_string(p, pxor_sigctx->mdname))
        return 0;
...
static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("algorithm-id")), (5), ((
# 2994 "../test/tls-provider.c" 3 4
   ((void *)0)
# 2994 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { (("digest")), (4), ((
# 2995 "../test/tls-provider.c" 3 4
   ((void *)0)
# 2995 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { 
# 2996 "../test/tls-provider.c" 3 4
   ((void *)0)
# 2996 "../test/tls-provider.c"
   , 0, 
# 2996 "../test/tls-provider.c" 3 4
   ((void *)0)
# 2996 "../test/tls-provider.c"
...
static const OSSL_PARAM *xor_sig_gettable_ctx_params(__attribute__((unused)) void *vpxor_sigctx, __attribute__((unused)) void *vctx)
{
...
static int xor_sig_set_ctx_params(void *vpxor_sigctx, const OSSL_PARAM params[])
{
    ...
    if (pxor_sigctx == 
# 3009 "../test/tls-provider.c" 3 4
                      ((void *)0) 
# 3009 "../test/tls-provider.c"
                           || params == 
# 3009 "../test/tls-provider.c" 3 4
                                        ((void *)0)
# 3009 "../test/tls-provider.c"
    ...
    if (p != 
# 3014 "../test/tls-provider.c" 3 4
            ((void *)0) 
# 3014 "../test/tls-provider.c"
                 && !pxor_sigctx->flag_allow_md)
        return 0;
    if (p != 
# 3016 "../test/tls-provider.c" 3 4
            ((void *)0)
# 3016 "../test/tls-provider.c"
                ) {
        ...
        if (!OSSL_PARAM_get_utf8_string(p, &pmdname, sizeof(mdname)))
            return 0;
        if (propsp != 
# 3025 "../test/tls-provider.c" 3 4
                     ((void *)0)
            
# 3026 "../test/tls-provider.c"
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("digest")), (4), ((
# 3036 "../test/tls-provider.c" 3 4
   ((void *)0)
# 3036 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { (("properties")), (4), ((
# 3037 "../test/tls-provider.c" 3 4
   ((void *)0)
# 3037 "../test/tls-provider.c"
   )), (0), ((size_t)-1) },
    { 
# 3038 "../test/tls-provider.c" 3 4
   ((void *)0)
# 3038 "../test/tls-provider.c"
   , 0, 
# 3038 "../test/tls-provider.c" 3 4
   ((void *)0)
# 3038 "../test/tls-provider.c"
...
static const OSSL_PARAM *xor_sig_settable_ctx_params(__attribute__((unused)) void *vpsm2ctx,
                                                     __attribute__((unused)) void *provctx)
{
...
static int xor_sig_get_ctx_md_params(void *vpxor_sigctx, OSSL_PARAM *params)
{
    ...
    if (pxor_sigctx->mdctx == 
# 3051 "../test/tls-provider.c" 3 4
                             ((void *)0)
# 3051 "../test/tls-provider.c"
                                 )
        return 0;
...
static const OSSL_PARAM *xor_sig_gettable_ctx_md_params(void *vpxor_sigctx)
{
    ...
    if (pxor_sigctx->md == 
# 3061 "../test/tls-provider.c" 3 4
                          ((void *)0)
# 3061 "../test/tls-provider.c"
                              )
        return 0;
...
static int xor_sig_set_ctx_md_params(void *vpxor_sigctx, const OSSL_PARAM params[])
{
    ...
    if (pxor_sigctx->mdctx == 
# 3071 "../test/tls-provider.c" 3 4
                             ((void *)0)
# 3071 "../test/tls-provider.c"
                                 )
        return 0;
...
static const OSSL_PARAM *xor_sig_settable_ctx_md_params(void *vpxor_sigctx)
{
    ...
    if (pxor_sigctx->md == 
# 3081 "../test/tls-provider.c" 3 4
                          ((void *)0)
# 3081 "../test/tls-provider.c"
                              )
        return 0;
...
static const OSSL_DISPATCH xor_signature_functions[] = {
    ...
    { 0, 
# 3121 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 3121 "../test/tls-provider.c"
   }
};
...
static const OSSL_ALGORITHM tls_prov_signature[] = {
    ...
    { "xorhmacsig12", "provider=tls-provider,fips=yes",
                           xor_signature_functions },
    { 
# 3135 "../test/tls-provider.c" 3 4
     ((void *)0)
# 3135 "../test/tls-provider.c"
         , 
# 3135 "../test/tls-provider.c" 3 4
           ((void *)0)
# 3135 "../test/tls-provider.c"
                                            ...
                                            int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 3157 "../test/tls-provider.c" 3 4
          ((void *)0)
# 3157 "../test/tls-provider.c"
              ;
}
...
static void tls_prov_teardown(void *provctx)
{
    ...
    for (i = 0; i < 50; i++) {
        CRYPTO_free(dummy_group_names[i], "../test/tls-provider.c", 3168);
        dummy_group_names[i] = 
# 3169 "../test/tls-provider.c" 3 4
                              ((void *)0)
# 3169 "../test/tls-provider.c"
                                  ;
    }
    CRYPTO_free(pctx, "../test/tls-provider.c", 3171);
}
...
static const OSSL_DISPATCH tls_prov_dispatch_table[] = {
    ...
    { 0, 
# 3179 "../test/tls-provider.c" 3 4
   ((void *)0) 
# 3179 "../test/tls-provider.c"
   }
};
                      ...
                      void **provctx)
{
    ...
    OSSL_FUNC_core_obj_create_fn *c_obj_create= 
# 3222 "../test/tls-provider.c" 3 4
                                               ((void *)0)
# 3222 "../test/tls-provider.c"
                                                   ;
    OSSL_FUNC_core_obj_add_sigid_fn *c_obj_add_sigid= 
# 3223 "../test/tls-provider.c" 3 4
                                                     ((void *)0)
# 3223 "../test/tls-provider.c"
                                                         ;
    PROV_XOR_CTX *xor_prov_ctx = xor_newprovctx(libctx);

    if (libctx == 
# 3226 "../test/tls-provider.c" 3 4
                 ((void *)0) 
# 3226 "../test/tls-provider.c"
                      || xor_prov_ctx == 
# 3226 "../test/tls-provider.c" 3 4
                                         ((void *)0)
# 3226 "../test/tls-provider.c"
    ...
    *provctx = xor_prov_ctx;
    ...
    if (!c_obj_create(handle, "1.3.6.1.4.1.16604.998888.1", "xorhmacsig", "xorhmacsig")) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",3261,__func__), ERR_set_error)((128),(6),
# 3261 "../test/tls-provider.c" 3 4
       ((void *)0)
# 3261 "../test/tls-provider.c"
       );
        goto err;
    }

    if (!c_obj_add_sigid(handle, "1.3.6.1.4.1.16604.998888.1", "", "1.3.6.1.4.1.16604.998888.1")) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",3266,__func__), ERR_set_error)((128),(6),
# 3266 "../test/tls-provider.c" 3 4
       ((void *)0)
# 3266 "../test/tls-provider.c"
       );
        goto err;
    }
    if (!c_obj_create(handle, "1.3.6.1.4.1.16604.998888.2", "xorhmacsha2sig", 
# 3269 "../test/tls-provider.c" 3 4
                                                                      ((void *)0)
# 3269 "../test/tls-provider.c"
                                                                          )) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",3270,__func__), ERR_set_error)((128),(6),
# 3270 "../test/tls-provider.c" 3 4
       ((void *)0)
# 3270 "../test/tls-provider.c"
       );
        goto err;
    }

    if (!c_obj_add_sigid(handle, "1.3.6.1.4.1.16604.998888.2", "SHA256", "1.3.6.1.4.1.16604.998888.2")) {
        (ERR_new(), ERR_set_debug("../test/tls-provider.c",3275,__func__), ERR_set_error)((128),(6),
# 3275 "../test/tls-provider.c" 3 4
       ((void *)0)
# 3275 "../test/tls-provider.c"
       );
        goto err;
    }
...
err:
    CRYPTO_free(xor_prov_ctx, "../test/tls-provider.c", 3283);
    *provctx = 
# 3284 "../test/tls-provider.c" 3 4
              ((void *)0)
# 3284 "../test/tls-provider.c"
                  ;
