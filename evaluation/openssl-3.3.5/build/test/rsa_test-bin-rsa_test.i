...
# 20 "../test/rsa_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 22 "../test/rsa_test.c" 2
...
static int key1(RSA *key, unsigned char *c)
{
    ...
    RSA_set0_key(key, BN_bin2bn(n, sizeof(n)-1, 
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
...
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
   )); RSA_set0_factors(key, BN_bin2bn(p, sizeof(p)-1, 
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
...
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
   )); RSA_set0_crt_params(key, BN_bin2bn(dmp1, sizeof(dmp1)-1, 
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
...
# 94 "../test/rsa_test.c" 3 4
   ((void *)0)
# 94 "../test/rsa_test.c"
   ) memcpy(c, ctext_ex, sizeof(ctext_ex) - 1); return sizeof(ctext_ex) - 1;;
}
...
# 249 "../test/rsa_test.c"
    ...
    if (!test_int_eq("../test/rsa_test.c", 253, "num", "clentmp", num, clentmp))
        goto err;

    num = RSA_private_decrypt(num, ctext, ptext, key, de_pad_type);
    if (success) {
        if (!test_int_gt("../test/rsa_test.c", 258, "num", "0", num, 0) || !test_mem_eq("../test/rsa_test.c", 258, "ptext", "ptext_ex", ptext, num, ptext_ex, plen))
            goto err;
    } else {
        if (!test_int_lt("../test/rsa_test.c", 261, "num", "0", num, 0))
            goto err;
    }

    ret = 1;
    if (retkey != 
# 266 "../test/rsa_test.c" 3 4
                 ((void *)0)
# 266 "../test/rsa_test.c"
                     ) {
        *retkey = key;
        key = 
# 268 "../test/rsa_test.c" 3 4
             ((void *)0)
# 268 "../test/rsa_test.c"
                 ;
    }
...
{
    return test_rsa_simple(idx, 1, 1, 1, 
# 277 "../test/rsa_test.c" 3 4
                                                                        ((void *)0)
# 277 "../test/rsa_test.c"
                                                                            ,
                           
# 278 "../test/rsa_test.c" 3 4
                          ((void *)0)
# 278 "../test/rsa_test.c"
                              , 
# 278 "../test/rsa_test.c" 3 4
...
# 284 "../test/rsa_test.c"
    ...
    num = RSA_private_decrypt(clen, ctext_ex, ptext, key,
                              4);
    if (num <= 0 || !test_mem_eq("../test/rsa_test.c", 302, "ptext", "ptext_ex", ptext, num, ptext_ex, plen))
        goto err;
    ...
    for (n = 0; n < clen; ++n) {
        ...
        num = RSA_private_decrypt(clen, ctext_ex, ptext, key,
                                      4);
        if (!test_int_le("../test/rsa_test.c", 310, "num", "0", num, 0))
            goto err;
        ctext_ex[n] ^= 1;
    }
    ...
    for (n = -1; n < clen; ++n) {
        num = RSA_private_decrypt(n, ctext_ex, ptext, key,
                                  4);
        if (!test_int_le("../test/rsa_test.c", 319, "num", "0", num, 0))
            goto err;
    }
...
static int test_rsa_security_bit(int n)
{
    ...
    if (!test_ptr("../test/rsa_test.c", 369, "key", key) || !test_int_le("../test/rsa_test.c", 369, "bytes", "(int)sizeof(num)", bytes, (int)sizeof(num)))
        goto err;
    ...
    if (test_true("../test/rsa_test.c", 385, "RSA_set0_key(key, BN_bin2bn(num, bytes, NULL), BN_bin2bn(num, bytes, NULL), NULL)", (RSA_set0_key(key, BN_bin2bn(num, bytes, 
# 385 "../test/rsa_test.c" 3 4
       ((void *)0)
# 385 "../test/rsa_test.c"
       ), BN_bin2bn(num, bytes, 
# 385 "../test/rsa_test.c" 3 4
...
# 385 "../test/rsa_test.c"
            ...
            && test_uint_eq("../test/rsa_test.c", 387, "RSA_security_bits(key)", "result", RSA_security_bits(key), result))
        r = 1;
err:
    RSA_free(key);
    return r;
...
static int test_EVP_rsa_legacy_key(void)
{
    ...
    const EVP_MD *md;
    EVP_MD_CTX *ctx = 
# 408 "../test/rsa_test.c" 3 4
                     ((void *)0)
# 408 "../test/rsa_test.c"
                         ;
    EVP_PKEY *pkey = 
# 409 "../test/rsa_test.c" 3 4
                    ((void *)0)
# 409 "../test/rsa_test.c"
                        ;
    ...
    ret = (test_ptr("../test/rsa_test.c", 489, "(p = BN_bin2bn(p_data, sizeof(p_data), NULL))", (p = BN_bin2bn(p_data, sizeof(p_data), 
# 489 "../test/rsa_test.c" 3 4
          ((void *)0)
# 489 "../test/rsa_test.c"
          )))
           && test_ptr("../test/rsa_test.c", 490, "(q = BN_bin2bn(q_data, sizeof(q_data), NULL))", (q = BN_bin2bn(q_data, sizeof(q_data), 
# 490 "../test/rsa_test.c" 3 4
             ((void *)0)
# 490 "../test/rsa_test.c"
             )))
           && test_ptr("../test/rsa_test.c", 491, "(n = BN_bin2bn(n_data, sizeof(n_data), NULL))", (n = BN_bin2bn(n_data, sizeof(n_data), 
# 491 "../test/rsa_test.c" 3 4
             ((void *)0)
# 491 "../test/rsa_test.c"
             )))
           && test_ptr("../test/rsa_test.c", 492, "(d = BN_bin2bn(d_data, sizeof(d_data), NULL))", (d = BN_bin2bn(d_data, sizeof(d_data), 
# 492 "../test/rsa_test.c" 3 4
             ((void *)0)
# 492 "../test/rsa_test.c"
             )))
           && test_ptr("../test/rsa_test.c", 493, "(e = BN_bin2bn(e_data, sizeof(e_data), NULL))", (e = BN_bin2bn(e_data, sizeof(e_data), 
# 493 "../test/rsa_test.c" 3 4
             ((void *)0)
# 493 "../test/rsa_test.c"
             )))
           && test_ptr("../test/rsa_test.c", 494, "(rsa = RSA_new())", (rsa = RSA_new()))
           && test_ptr("../test/rsa_test.c", 495, "(md = EVP_sha256())", (md = EVP_sha256()))
           && test_ptr("../test/rsa_test.c", 496, "(ctx = EVP_MD_CTX_new())", (ctx = EVP_MD_CTX_new()))
           && test_ptr("../test/rsa_test.c", 497, "(pkey = EVP_PKEY_new())", (pkey = EVP_PKEY_new()))
           && test_true("../test/rsa_test.c", 498, "RSA_set0_factors(rsa, p, q)", (RSA_set0_factors(rsa, p, q)) != 0)
           && test_true("../test/rsa_test.c", 499, "RSA_set0_key(rsa, n, e, d)", (RSA_set0_key(rsa, n, e, d)) != 0)
           && test_true("../test/rsa_test.c", 500, "EVP_PKEY_assign_RSA(pkey, rsa)", (EVP_PKEY_assign((pkey),6, (rsa))) != 0)
           && test_true("../test/rsa_test.c", 501, "EVP_DigestSignInit(ctx, NULL, md, NULL, pkey)", (EVP_DigestSignInit(ctx, 
# 501 "../test/rsa_test.c" 3 4
             ((void *)0)
# 501 "../test/rsa_test.c"
             , md, 
# 501 "../test/rsa_test.c" 3 4
...
# 501 "../test/rsa_test.c"
             , pkey)) != 0)
           && test_true("../test/rsa_test.c", 502, "EVP_DigestSign(ctx, sigbuf, &buflen, msgbuf, msglen)", (EVP_DigestSign(ctx, sigbuf, &buflen, msgbuf, msglen)) != 0));
...
{
    RSA *rsa = 
# 511 "../test/rsa_test.c" 3 4
              ((void *)0)
# 511 "../test/rsa_test.c"
                  ;
    BIGNUM *pn = 
# 512 "../test/rsa_test.c" 3 4
                ((void *)0)
# 512 "../test/rsa_test.c"
                    , *pe = 
# 512 "../test/rsa_test.c" 3 4
...
# 512 "../test/rsa_test.c"
    ...
    if (!test_ptr("../test/rsa_test.c", 559, "rsa = RSA_new()", rsa = RSA_new()))
        return 
# 560 "../test/rsa_test.c" 3 4
              ((void *)0)
# 560 "../test/rsa_test.c"
                  ;
    pn = BN_bin2bn(n, sizeof(n), 
# 561 "../test/rsa_test.c" 3 4
                                ((void *)0)
# 561 "../test/rsa_test.c"
                                    );
    pe = BN_bin2bn(e, sizeof(e), 
# 562 "../test/rsa_test.c" 3 4
                                ((void *)0)
# 562 "../test/rsa_test.c"
                                    );
    if (priv)
        pd = BN_bin2bn(d, sizeof(d), 
# 564 "../test/rsa_test.c" 3 4
                                    ((void *)0)
# 564 "../test/rsa_test.c"
                                        );
    if (!test_false("../test/rsa_test.c", 565, "pn == NULL || pe == NULL || (priv && pd == NULL) || !RSA_set0_key(rsa, pn, pe, pd)", (pn == 
# 565 "../test/rsa_test.c" 3 4
        ((void *)0) 
# 565 "../test/rsa_test.c"
        || pe == 
# 565 "../test/rsa_test.c" 3 4
...
# 582 "../test/rsa_test.c"
    ...
    unsigned int inlen = sizeof(in) - 11 - 3;
    ...
    if (!test_ptr("../test/rsa_test.c", 659, "rsa_priv = load_key(1)", rsa_priv = load_key(1)))
        goto err;
    if (!test_ptr("../test/rsa_test.c", 661, "rsa_pub = load_key(0)", rsa_pub = load_key(0)))
        goto err;
    if (!test_int_ge("../test/rsa_test.c", 663, "(int)sizeof(sig)", "RSA_size(rsa_priv)", (int)sizeof(sig), RSA_size(rsa_priv)))
        goto err;


    if (!test_true("../test/rsa_test.c", 667, "RSA_sign_ASN1_OCTET_STRING(0, in, inlen, sig, &siglen, rsa_priv)", (RSA_sign_ASN1_OCTET_STRING(0, in, inlen, sig, &siglen, rsa_priv)) != 0)
                                                        )
        goto err;
    if (!test_true("../test/rsa_test.c", 670, "RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen, rsa_pub)", (RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen, rsa_pub)) != 0))
        goto err;


    if (!test_false("../test/rsa_test.c", 674, "RSA_sign_ASN1_OCTET_STRING(0, in, inlen + 1, sig, &siglen, rsa_priv)", (RSA_sign_ASN1_OCTET_STRING(0, in, inlen + 1, sig, &siglen, rsa_priv)) != 0)
                                                         )
        goto err;


    if (!test_false("../test/rsa_test.c", 679, "RSA_sign_ASN1_OCTET_STRING(0, in, inlen, sig, &siglen, rsa_pub)", (RSA_sign_ASN1_OCTET_STRING(0, in, inlen, sig, &siglen, rsa_pub)) != 0)
                                                        )
        goto err;


    if (!test_false("../test/rsa_test.c", 684, "RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen - 1, rsa_pub)", (RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen - 1, rsa_pub)) != 0))
        goto err;


    if (!test_false("../test/rsa_test.c", 688, "RSA_verify_ASN1_OCTET_STRING(0, in, inlen, (unsigned char *)no_octet_sig, (unsigned int)sizeof(no_octet_sig), rsa_pub)", (RSA_verify_ASN1_OCTET_STRING(0, in, inlen, (unsigned char *)no_octet_sig, (unsigned int)sizeof(no_octet_sig), rsa_pub)) != 0)

                                                          )
        goto err;


    if (!test_false("../test/rsa_test.c", 694, "RSA_verify_ASN1_OCTET_STRING(0, in, inlen, (unsigned char *)sig_mismatch, (unsigned int)sizeof(sig_mismatch), rsa_pub)", (RSA_verify_ASN1_OCTET_STRING(0, in, inlen, (unsigned char *)sig_mismatch, (unsigned int)sizeof(sig_mismatch), rsa_pub)) != 0)
    ...
    sig[0]++;
    if (!test_false("../test/rsa_test.c", 701, "RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen, rsa_pub)", (RSA_verify_ASN1_OCTET_STRING(0, in, inlen, sig, siglen, rsa_pub)) != 0))
        goto err;
    sig[0]--;
...
int setup_tests(void)
{
    ...
    add_all_tests("test_rsa_security_bit", test_rsa_security_bit, (sizeof(rsa_security_bits_cases)/sizeof((rsa_security_bits_cases)[0])), 1);
