# 0 "../test/bio_core_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_core_test.c"
# 10 "../test/bio_core_test.c"
...
static const OSSL_DISPATCH biocbs[] = {
    { 42, (void (*)(void))tst_bio_core_read_ex },
    { 43, (void (*)(void))tst_bio_core_write_ex },
    { 49, (void (*)(void))tst_bio_core_gets },
    { 48, (void (*)(void))tst_bio_core_puts },
    { 50, (void (*)(void))tst_bio_core_ctrl },
    { 44, (void (*)(void))tst_bio_core_up_ref },
    { 45, (void (*)(void))tst_bio_core_free },
    { 0, 
# 64 "../test/bio_core_test.c" 3 4
   ((void *)0) 
# 64 "../test/bio_core_test.c"
   }
};
...
{
    BIO *cbio = 
# 69 "../test/bio_core_test.c" 3 4
               ((void *)0)
# 69 "../test/bio_core_test.c"
                   , *cbiobad = 
# 69 "../test/bio_core_test.c" 3 4
                                ((void *)0)
# 69 "../test/bio_core_test.c"
                                    ;
    OSSL_LIB_CTX *libctx = OSSL_LIB_CTX_new_from_dispatch(
# 70 "../test/bio_core_test.c" 3 4
                                                         ((void *)0)
# 70 "../test/bio_core_test.c"
                                                             , biocbs);
    int testresult = 0;
    ...
    if (!test_ptr("../test/bio_core_test.c", 77, "corebio.bio", corebio.bio)
            || !test_ptr("../test/bio_core_test.c", 78, "libctx", libctx)




            || !test_ptr_null("../test/bio_core_test.c", 83, "(cbiobad = BIO_new_from_core_bio(NULL, &corebio))", (cbiobad = BIO_new_from_core_bio(
# 83 "../test/bio_core_test.c" 3 4
               ((void *)0)
# 83 "../test/bio_core_test.c"
               , &corebio)))
            || !test_ptr("../test/bio_core_test.c", 84, "(cbio = BIO_new_from_core_bio(libctx, &corebio))", (cbio = BIO_new_from_core_bio(libctx, &corebio))))
        goto err;

    if (!test_int_gt("../test/bio_core_test.c", 87, "BIO_puts(corebio.bio, msg)", "0", BIO_puts(corebio.bio, msg), 0)

            || !test_false("../test/bio_core_test.c", 89, "BIO_eof(cbio)", ((int)BIO_ctrl(cbio,2,0,
# 89 "../test/bio_core_test.c" 3 4
               ((void *)0)
# 89 "../test/bio_core_test.c"
               )) != 0)
            || !test_int_gt("../test/bio_core_test.c", 90, "BIO_gets(cbio, buf, sizeof(buf))", "0", BIO_gets(cbio, buf, sizeof(buf)), 0)
            || !test_true("../test/bio_core_test.c", 91, "BIO_eof(cbio)", ((int)BIO_ctrl(cbio,2,0,
# 91 "../test/bio_core_test.c" 3 4
               ((void *)0)
# 91 "../test/bio_core_test.c"
               )) != 0)
            || !test_str_eq("../test/bio_core_test.c", 92, "buf", "msg", buf, msg))
        goto err;

    buf[0] = '\0';
    if (!test_int_gt("../test/bio_core_test.c", 96, "BIO_write(cbio, msg, strlen(msg) + 1)", "0", BIO_write(cbio, msg, strlen(msg) + 1), 0)
            || !test_int_gt("../test/bio_core_test.c", 97, "BIO_read(cbio, buf, sizeof(buf))", "0", BIO_read(cbio, buf, sizeof(buf)), 0)
            || !test_str_eq("../test/bio_core_test.c", 98, "buf", "msg", buf, msg))
        goto err;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/bio_core_test.c", 113, "Error parsing test options\n");
        return 0;
    }
