# 0 "../test/rand_status_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rand_status_test.c"
# 10 "../test/rand_status_test.c"
...
{
    return test_true("../test/rand_status_test.c", 20, "RAND_status()", (RAND_status()) != 0);
}
