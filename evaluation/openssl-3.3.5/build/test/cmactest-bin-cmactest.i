...
# 19 "../test/cmactest.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 21 "../test/cmactest.c" 2
...
# 142 "../test/cmactest.c"
    ...
    ctx = CMAC_CTX_new();
    if (!test_ptr("../test/cmactest.c", 146, "ctx", ctx)
        || !test_false("../test/cmactest.c", 147, "CMAC_Init(ctx, NULL, 0, NULL, NULL)", (CMAC_Init(ctx, 
# 147 "../test/cmactest.c" 3 4
           ((void *)0)
# 147 "../test/cmactest.c"
           , 0, 
# 147 "../test/cmactest.c" 3 4
...
# 147 "../test/cmactest.c"
        ...
        || !test_false("../test/cmactest.c", 148, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0)

        || !test_true("../test/cmactest.c", 150, "CMAC_Init(ctx, NULL, 0, EVP_aes_128_cbc(), NULL)", (CMAC_Init(ctx, 
# 150 "../test/cmactest.c" 3 4
           ((void *)0)
# 150 "../test/cmactest.c"
           , 0, EVP_aes_128_cbc(), 
# 150 "../test/cmactest.c" 3 4
...
# 150 "../test/cmactest.c"
        ...
        || !test_false("../test/cmactest.c", 152, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0)

        || !test_true("../test/cmactest.c", 154, "CMAC_Init(ctx, test[0].key, test[0].key_len, NULL, NULL)", (CMAC_Init(ctx, test[0].key, test[0].key_len, 
# 154 "../test/cmactest.c" 3 4
           ((void *)0)
# 154 "../test/cmactest.c"
           , 
# 154 "../test/cmactest.c" 3 4
...
# 154 "../test/cmactest.c"
        ...
        || !test_true("../test/cmactest.c", 156, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0)

        || !test_false("../test/cmactest.c", 158, "CMAC_Init(ctx, xtskey, sizeof(xtskey), EVP_aes_128_xts(), NULL)", (CMAC_Init(ctx, xtskey, sizeof(xtskey), EVP_aes_128_xts(), 
# 158 "../test/cmactest.c" 3 4
           ((void *)0)
# 158 "../test/cmactest.c"
           )) != 0)

        || !test_false("../test/cmactest.c", 160, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0))
        goto err;
...
# 172 "../test/cmactest.c"
    ...
    for (case_idx = 0; case_idx < (sizeof(test)/sizeof((test)[0])); case_idx++) {
    ...
    if (!test_true("../test/cmactest.c", 197, "CMAC_Init(ctx, test[0].key, test[0].key_len, EVP_aes_128_cbc(), NULL)", (CMAC_Init(ctx, test[0].key, test[0].key_len, EVP_aes_128_cbc(), 
# 197 "../test/cmactest.c" 3 4
        ((void *)0)
# 197 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 199, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0)
        || !test_true("../test/cmactest.c", 200, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 204, "p", "test[0].mac", p, test[0].mac))
        goto err;

    if (!test_true("../test/cmactest.c", 207, "CMAC_Init(ctx, test[1].key, test[1].key_len, EVP_aes_256_cbc(), NULL)", (CMAC_Init(ctx, test[1].key, test[1].key_len, EVP_aes_256_cbc(), 
# 207 "../test/cmactest.c" 3 4
        ((void *)0)
# 207 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 209, "CMAC_Update(ctx, test[1].data, test[1].data_len)", (CMAC_Update(ctx, test[1].data, test[1].data_len)) != 0)
        || !test_true("../test/cmactest.c", 210, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 214, "p", "test[1].mac", p, test[1].mac))
        goto err;

    if (!test_true("../test/cmactest.c", 217, "CMAC_Init(ctx, test[2].key, test[2].key_len, NULL, NULL)", (CMAC_Init(ctx, test[2].key, test[2].key_len, 
# 217 "../test/cmactest.c" 3 4
        ((void *)0)
# 217 "../test/cmactest.c"
        , 
# 217 "../test/cmactest.c" 3 4
...
# 217 "../test/cmactest.c"
        ...
        || !test_true("../test/cmactest.c", 218, "CMAC_Update(ctx, test[2].data, test[2].data_len)", (CMAC_Update(ctx, test[2].data, test[2].data_len)) != 0)
        || !test_true("../test/cmactest.c", 219, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 222, "p", "test[2].mac", p, test[2].mac))
        goto err;

    if (!test_true("../test/cmactest.c", 225, "CMAC_Init(ctx, NULL, 0, NULL, NULL)", (CMAC_Init(ctx, 
# 225 "../test/cmactest.c" 3 4
        ((void *)0)
# 225 "../test/cmactest.c"
        , 0, 
# 225 "../test/cmactest.c" 3 4
...
# 225 "../test/cmactest.c"
        ...
        || !test_true("../test/cmactest.c", 226, "CMAC_Update(ctx, test[2].data, test[2].data_len)", (CMAC_Update(ctx, test[2].data, test[2].data_len)) != 0)
        || !test_true("../test/cmactest.c", 227, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 230, "p", "test[2].mac", p, test[2].mac))
        goto err;


    if (!test_true("../test/cmactest.c", 234, "CMAC_Init(ctx, NULL, 0, EVP_aes_256_cbc(), NULL)", (CMAC_Init(ctx, 
# 234 "../test/cmactest.c" 3 4
        ((void *)0)
# 234 "../test/cmactest.c"
        , 0, EVP_aes_256_cbc(), 
# 234 "../test/cmactest.c" 3 4
...
# 234 "../test/cmactest.c"
        ...
        || !test_true("../test/cmactest.c", 235, "CMAC_Init(ctx, test[2].key, test[2].key_len, NULL, NULL)", (CMAC_Init(ctx, test[2].key, test[2].key_len, 
# 235 "../test/cmactest.c" 3 4
           ((void *)0)
# 235 "../test/cmactest.c"
           , 
# 235 "../test/cmactest.c" 3 4
...
# 235 "../test/cmactest.c"
        ...
        || !test_true("../test/cmactest.c", 236, "CMAC_Update(ctx, test[2].data, test[2].data_len)", (CMAC_Update(ctx, test[2].data, test[2].data_len)) != 0)
        || !test_true("../test/cmactest.c", 237, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 240, "p", "test[2].mac", p, test[2].mac))
        goto err;


    if (!test_true("../test/cmactest.c", 244, "CMAC_Init(ctx, test[3].key, test[3].key_len, EVP_aes_128_cbc(), NULL)", (CMAC_Init(ctx, test[3].key, test[3].key_len, EVP_aes_128_cbc(), 
# 244 "../test/cmactest.c" 3 4
        ((void *)0)
# 244 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 246, "CMAC_Update(ctx, test[3].data, test[3].data_len)", (CMAC_Update(ctx, test[3].data, test[3].data_len)) != 0)
        || !test_true("../test/cmactest.c", 247, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 250, "p", "test[3].mac", p, test[3].mac))
        goto err;

    if (!test_true("../test/cmactest.c", 253, "CMAC_Init(ctx, test[4].key, test[4].key_len, EVP_aes_192_cbc(), NULL)", (CMAC_Init(ctx, test[4].key, test[4].key_len, EVP_aes_192_cbc(), 
# 253 "../test/cmactest.c" 3 4
        ((void *)0)
# 253 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 255, "CMAC_Update(ctx, test[4].data, test[4].data_len)", (CMAC_Update(ctx, test[4].data, test[4].data_len)) != 0)
        || !test_true("../test/cmactest.c", 256, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 259, "p", "test[4].mac", p, test[4].mac))
        goto err;

    if (!test_true("../test/cmactest.c", 262, "CMAC_Init(ctx, test[5].key, test[5].key_len, EVP_aes_256_cbc(), NULL)", (CMAC_Init(ctx, test[5].key, test[5].key_len, EVP_aes_256_cbc(), 
# 262 "../test/cmactest.c" 3 4
        ((void *)0)
# 262 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 264, "CMAC_Update(ctx, test[5].data, test[5].data_len)", (CMAC_Update(ctx, test[5].data, test[5].data_len)) != 0)
        || !test_true("../test/cmactest.c", 265, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 268, "p", "test[5].mac", p, test[5].mac))
        goto err;


    if (!test_true("../test/cmactest.c", 272, "CMAC_Init(ctx, test[6].key, test[6].key_len, EVP_des_ede3_cbc(), NULL)", (CMAC_Init(ctx, test[6].key, test[6].key_len, EVP_des_ede3_cbc(), 
# 272 "../test/cmactest.c" 3 4
        ((void *)0)
# 272 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 274, "CMAC_Update(ctx, test[6].data, test[6].data_len)", (CMAC_Update(ctx, test[6].data, test[6].data_len)) != 0)
        || !test_true("../test/cmactest.c", 275, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 278, "p", "test[6].mac", p, test[6].mac))
        goto err;



    if (!test_true("../test/cmactest.c", 283, "CMAC_Init(ctx, test[7].key, test[7].key_len, EVP_sm4_cbc(), NULL)", (CMAC_Init(ctx, test[7].key, test[7].key_len, EVP_sm4_cbc(), 
# 283 "../test/cmactest.c" 3 4
        ((void *)0)
# 283 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 285, "CMAC_Update(ctx, test[7].data, test[7].data_len)", (CMAC_Update(ctx, test[7].data, test[7].data_len)) != 0)
        || !test_true("../test/cmactest.c", 286, "CMAC_Final(ctx, buf, &len)", (CMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 289, "p", "test[7].mac", p, test[7].mac))
        goto err;
...
# 302 "../test/cmactest.c"
    ...
    ctx = CMAC_CTX_new();
    ctx2 = CMAC_CTX_new();
    if (!test_ptr("../test/cmactest.c", 309, "ctx", ctx) || !test_ptr("../test/cmactest.c", 309, "ctx2", ctx2))
        goto err;

    if (!test_true("../test/cmactest.c", 312, "CMAC_Init(ctx, test[0].key, test[0].key_len, EVP_aes_128_cbc(), NULL)", (CMAC_Init(ctx, test[0].key, test[0].key_len, EVP_aes_128_cbc(), 
# 312 "../test/cmactest.c" 3 4
        ((void *)0)
# 312 "../test/cmactest.c"
        )) != 0)

        || !test_true("../test/cmactest.c", 314, "CMAC_Update(ctx, test[0].data, test[0].data_len)", (CMAC_Update(ctx, test[0].data, test[0].data_len)) != 0)
        || !test_true("../test/cmactest.c", 315, "CMAC_CTX_copy(ctx2, ctx)", (CMAC_CTX_copy(ctx2, ctx)) != 0)
        || !test_true("../test/cmactest.c", 316, "CMAC_Final(ctx2, buf, &len)", (CMAC_Final(ctx2, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_str_eq("../test/cmactest.c", 320, "p", "test[0].mac", p, test[0].mac))
        goto err;
...
static char *pt(unsigned char *md, unsigned int len)
{
    ...
    for (i = 0; i < len && (i + 1) * 2 < sizeof(buf); i++)
        BIO_snprintf(buf + i * 2,
                     2 + 1, "%02x", md[i]);
    return buf;
}
