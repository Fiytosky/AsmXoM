# 0 "../test/params_conversion_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/params_conversion_test.c"
# 11 "../test/params_conversion_test.c"
...
# 12 "../test/params_conversion_test.c" 2
...
# 13 "../test/params_conversion_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 14 "../test/params_conversion_test.c" 2
# 23 "../test/params_conversion_test.c"
typedef struct {
    OSSL_PARAM *param;
    int32_t i32;
    int64_t i64;
...
static int param_conversion_load_stanza(PARAM_CONVERSION *pc, const STANZA *s)
{
    ...
    static OSSL_PARAM params[] = {
        { (("int32")), (1), ((&datum_i32)), (sizeof(int32_t)), ((size_t)-1) },
        { (("int64")), (1), ((&datum_i64)), (sizeof(int64_t)), ((size_t)-1) },
        { (("uint32")), (2), ((&datum_u32)), (sizeof(uint32_t)), ((size_t)-1) },
        { (("uint64")), (2), ((&datum_u64)), (sizeof(uint64_t)), ((size_t)-1) },
        { (("double")), (3), ((&datum_d)), (sizeof(double)), ((size_t)-1) },
        { 
# 49 "../test/params_conversion_test.c" 3 4
       ((void *)0)
# 49 "../test/params_conversion_test.c"
       , 0, 
# 49 "../test/params_conversion_test.c" 3 4
       ((void *)0)
# 49 "../test/params_conversion_test.c"
    ...
    const char *type = 
# 53 "../test/params_conversion_test.c" 3 4
                      ((void *)0)
# 53 "../test/params_conversion_test.c"
                          ;
    char *p;
    int i;
    ...
    for (i = 0; i < s->numpairs; i++, pp++) {
        ...
        if (OPENSSL_strcasecmp(pp->key, "type") == 0) {
            if (type != 
# 62 "../test/params_conversion_test.c" 3 4
                       ((void *)0)
# 62 "../test/params_conversion_test.c"
                           ) {
                test_info("../test/params_conversion_test.c", 63, "Line %d: multiple type lines", s->curr);
                return 0;
            }
            pc->param = OSSL_PARAM_locate(params, type = pp->value);
            if (pc->param == 
# 67 "../test/params_conversion_test.c" 3 4
                            ((void *)0)
# 67 "../test/params_conversion_test.c"
                                ) {
                test_info("../test/params_conversion_test.c", 68, "Line %d: unknown type line", s->curr);
                return 0;
            }
        } else if (OPENSSL_strcasecmp(pp->key, "int32") == 0) {
            if (def_i32++) {
                test_info("../test/params_conversion_test.c", 73, "Line %d: multiple int32 lines", s->curr);
                return 0;
            }
            ...
            if (def_i64++) {
                test_info("../test/params_conversion_test.c", 82, "Line %d: multiple int64 lines", s->curr);
                return 0;
            }
            if (OPENSSL_strcasecmp(pp->value, "invalid") != 0) {
                pc->valid_i64 = 1;
            ...
            if (def_u32++) {
                test_info("../test/params_conversion_test.c", 91, "Line %d: multiple uint32 lines", s->curr);
                return 0;
            }
            if (OPENSSL_strcasecmp(pp->value, "invalid") != 0) {
                pc->valid_u32 = 1;
            ...
            if (def_u64++) {
                test_info("../test/params_conversion_test.c", 100, "Line %d: multiple uint64 lines", s->curr);
                return 0;
            }
            if (OPENSSL_strcasecmp(pp->value, "invalid") != 0) {
                pc->valid_u64 = 1;
            ...
            if (def_d++) {
                test_info("../test/params_conversion_test.c", 109, "Line %d: multiple double lines", s->curr);
                return 0;
            }
            if (OPENSSL_strcasecmp(pp->value, "invalid") != 0) {
                pc->valid_d = 1;
            ...
            test_info("../test/params_conversion_test.c", 117, "Line %d: unknown keyword %s", s->curr, pp->key);
            return 0;
        }
        if (*p != '\0') {
            test_info("../test/params_conversion_test.c", 121, "Line %d: extra characters at end '%s' for %s", s->curr, p, pp->key)
                                          ;
            return 0;
        }
    }

    if (!test_ptr("../test/params_conversion_test.c", 127, "type", type)) {
        test_info("../test/params_conversion_test.c", 128, "Line %d: type not found", s->curr);
        return 0;
    }

    if (OPENSSL_strcasecmp(type, "int32") == 0) {
        if (!test_true("../test/params_conversion_test.c", 133, "def_i32", (def_i32) != 0) || !test_true("../test/params_conversion_test.c", 133, "pc->valid_i32", (pc->valid_i32) != 0)) {
        ...
        if (!test_true("../test/params_conversion_test.c", 142, "def_i64", (def_i64) != 0) || !test_true("../test/params_conversion_test.c", 142, "pc->valid_i64", (pc->valid_i64) != 0)) {
        ...
        if (!test_true("../test/params_conversion_test.c", 151, "def_u32", (def_u32) != 0) || !test_true("../test/params_conversion_test.c", 151, "pc->valid_u32", (pc->valid_u32) != 0)) {
        ...
        if (!test_true("../test/params_conversion_test.c", 160, "def_u64", (def_u64) != 0) || !test_true("../test/params_conversion_test.c", 160, "pc->valid_u64", (pc->valid_u64) != 0)) {
        ...
        if (!test_true("../test/params_conversion_test.c", 169, "def_d", (def_d) != 0) || !test_true("../test/params_conversion_test.c", 169, "pc->valid_d", (pc->valid_d) != 0)) {
        ...
        test_error("../test/params_conversion_test.c", 178, "type unknown at line %d", s->curr);
        return 0;
    }
    return 1;
}
...
static int param_conversion_test(const PARAM_CONVERSION *pc, int line)
{
    ...
    if (!pc->valid_i32) {
        if (!test_false("../test/params_conversion_test.c", 193, "OSSL_PARAM_get_int32(pc->param, &i32)", (OSSL_PARAM_get_int32(pc->param, &i32)) != 0)
                || !test_ulong_ne("../test/params_conversion_test.c", 194, "ERR_get_error()", "0", ERR_get_error(), 0)) {
            test_note("unexpected valid conversion to int32 on line %d", line);
            return 0;
        }
    } else {
        if (!test_true("../test/params_conversion_test.c", 199, "OSSL_PARAM_get_int32(pc->param, &i32)", (OSSL_PARAM_get_int32(pc->param, &i32)) != 0)
            || !test_true("../test/params_conversion_test.c", 200, "i32 == pc->i32", (i32 == pc->i32) != 0)) {
            test_note("unexpected conversion to int32 on line %d", line);
            return 0;
        }
        memset(pc->datum, 44, pc->size);
        if (!test_true("../test/params_conversion_test.c", 205, "OSSL_PARAM_set_int32(pc->param, i32)", (OSSL_PARAM_set_int32(pc->param, i32)) != 0)
            || !test_mem_eq("../test/params_conversion_test.c", 206, "pc->datum", "pc->ref", pc->datum, pc->size, pc->ref, pc->size)) {
    ...
    if (!pc->valid_i64) {
        if (!test_false("../test/params_conversion_test.c", 214, "OSSL_PARAM_get_int64(pc->param, &i64)", (OSSL_PARAM_get_int64(pc->param, &i64)) != 0)
                || !test_ulong_ne("../test/params_conversion_test.c", 215, "ERR_get_error()", "0", ERR_get_error(), 0)) {
            test_note("unexpected valid conversion to int64 on line %d", line);
            return 0;
        }
    } else {
        if (!test_true("../test/params_conversion_test.c", 220, "OSSL_PARAM_get_int64(pc->param, &i64)", (OSSL_PARAM_get_int64(pc->param, &i64)) != 0)
            || !test_true("../test/params_conversion_test.c", 221, "i64 == pc->i64", (i64 == pc->i64) != 0)) {
            test_note("unexpected conversion to int64 on line %d", line);
            return 0;
        }
        memset(pc->datum, 44, pc->size);
        if (!test_true("../test/params_conversion_test.c", 226, "OSSL_PARAM_set_int64(pc->param, i64)", (OSSL_PARAM_set_int64(pc->param, i64)) != 0)
            || !test_mem_eq("../test/params_conversion_test.c", 227, "pc->datum", "pc->ref", pc->datum, pc->size, pc->ref, pc->size)) {
    ...
    if (!pc->valid_u32) {
        if (!test_false("../test/params_conversion_test.c", 235, "OSSL_PARAM_get_uint32(pc->param, &u32)", (OSSL_PARAM_get_uint32(pc->param, &u32)) != 0)
                || !test_ulong_ne("../test/params_conversion_test.c", 236, "ERR_get_error()", "0", ERR_get_error(), 0)) {
            test_note("unexpected valid conversion to uint32 on line %d", line);
            return 0;
        }
    } else {
        if (!test_true("../test/params_conversion_test.c", 241, "OSSL_PARAM_get_uint32(pc->param, &u32)", (OSSL_PARAM_get_uint32(pc->param, &u32)) != 0)
            || !test_true("../test/params_conversion_test.c", 242, "u32 == pc->u32", (u32 == pc->u32) != 0)) {
            test_note("unexpected conversion to uint32 on line %d", line);
            return 0;
        }
        memset(pc->datum, 44, pc->size);
        if (!test_true("../test/params_conversion_test.c", 247, "OSSL_PARAM_set_uint32(pc->param, u32)", (OSSL_PARAM_set_uint32(pc->param, u32)) != 0)
            || !test_mem_eq("../test/params_conversion_test.c", 248, "pc->datum", "pc->ref", pc->datum, pc->size, pc->ref, pc->size)) {
    ...
    if (!pc->valid_u64) {
        if (!test_false("../test/params_conversion_test.c", 256, "OSSL_PARAM_get_uint64(pc->param, &u64)", (OSSL_PARAM_get_uint64(pc->param, &u64)) != 0)
                || !test_ulong_ne("../test/params_conversion_test.c", 257, "ERR_get_error()", "0", ERR_get_error(), 0)) {
            test_note("unexpected valid conversion to uint64 on line %d", line);
            return 0;
        }
    } else {
        if (!test_true("../test/params_conversion_test.c", 262, "OSSL_PARAM_get_uint64(pc->param, &u64)", (OSSL_PARAM_get_uint64(pc->param, &u64)) != 0)
            || !test_true("../test/params_conversion_test.c", 263, "u64 == pc->u64", (u64 == pc->u64) != 0)) {
            test_note("unexpected conversion to uint64 on line %d", line);
            return 0;
        }
        memset(pc->datum, 44, pc->size);
        if (!test_true("../test/params_conversion_test.c", 268, "OSSL_PARAM_set_uint64(pc->param, u64)", (OSSL_PARAM_set_uint64(pc->param, u64)) != 0)
            || !test_mem_eq("../test/params_conversion_test.c", 269, "pc->datum", "pc->ref", pc->datum, pc->size, pc->ref, pc->size)) {
    ...
    if (!pc->valid_d) {
        if (!test_false("../test/params_conversion_test.c", 277, "OSSL_PARAM_get_double(pc->param, &d)", (OSSL_PARAM_get_double(pc->param, &d)) != 0)
                || !test_ulong_ne("../test/params_conversion_test.c", 278, "ERR_get_error()", "0", ERR_get_error(), 0)) {
            test_note("unexpected valid conversion to double on line %d", line);
            return 0;
        }
    } else {
        if (!test_true("../test/params_conversion_test.c", 283, "OSSL_PARAM_get_double(pc->param, &d)", (OSSL_PARAM_get_double(pc->param, &d)) != 0)) {
        ...
        if (!(d == d)) {
            ...
            if (!test_false("../test/params_conversion_test.c", 300, "pc->d == pc->d", (pc->d == pc->d) != 0)) {
                test_note("unexpected NaN on line %d", line);
                return 0;
            }
        } else if (!test_true("../test/params_conversion_test.c", 304, "d == pc->d", (d == pc->d) != 0)) {
            test_note("unexpected conversion to double on line %d", line);
            return 0;
        }
        memset(pc->datum, 44, pc->size);
        if (!test_true("../test/params_conversion_test.c", 309, "OSSL_PARAM_set_double(pc->param, d)", (OSSL_PARAM_set_double(pc->param, d)) != 0)
            || !test_mem_eq("../test/params_conversion_test.c", 310, "pc->datum", "pc->ref", pc->datum, pc->size, pc->ref, pc->size)) {
...
static int run_param_file_tests(int i)
{
    ...
    if (!test_ptr("../test/params_conversion_test.c", 327, "s = OPENSSL_zalloc(sizeof(*s))", s = CRYPTO_zalloc(sizeof(*s), "../test/params_conversion_test.c", 327)))
        return 0;
    if (!test_start_file(s, testfile)) {
        CRYPTO_free(s, "../test/params_conversion_test.c", 330);
        return 0;
    }

    while (!(int)BIO_ctrl(s->fp,2,0,
# 334 "../test/params_conversion_test.c" 3 4
           ((void *)0)
# 334 "../test/params_conversion_test.c"
           )) {
    ...
    test_end_file(s);
    CRYPTO_free(s, "../test/params_conversion_test.c", 347);
    return res;
}



const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "file...\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 353 "../test/params_conversion_test.c" 3 4
((void *)0) 
# 353 "../test/params_conversion_test.c"
} }; return options; }
...
int setup_tests(void)
{
    ...
    if (!test_skip_common_options()) {
        test_error("../test/params_conversion_test.c", 360, "Error parsing test options\n");
        return 0;
    }
    ...
    add_all_tests("run_param_file_tests", run_param_file_tests, n, 1);
