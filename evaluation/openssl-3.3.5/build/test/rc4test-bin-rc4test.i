...
static int test_rc4_encrypt(const int i)
{
    ...
    return test_mem_eq("../test/rc4test.c", 72, "obuf", "output[i]", obuf, data_len[i] + 1, output[i], data_len[i] + 1);
}
...
static int test_rc4_end_processing(const int i)
{
    ...
    if (!test_mem_eq("../test/rc4test.c", 83, "obuf", "output[3]", obuf, i, output[3], i))
        return 0;
    return test_uchar_eq("../test/rc4test.c", 85, "obuf[i]", "0", obuf[i], 0);
}
...
static int test_rc4_multi_call(const int i)
{
    ...
    return test_mem_eq("../test/rc4test.c", 97, "obuf", "output[3]", obuf, data_len[3] + 1, output[3], data_len[3] + 1);
}
...
static int test_rc_bulk(void)
{
    ...
    return test_mem_eq("../test/rc4test.c", 121, "md", "expected", md, sizeof(md), expected, sizeof(expected));
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_rc4_encrypt", test_rc4_encrypt, (sizeof(data_len)/sizeof((data_len)[0])), 1);
    add_all_tests("test_rc4_end_processing", test_rc4_end_processing, data_len[3], 1);
    add_all_tests("test_rc4_multi_call", test_rc4_multi_call, data_len[3], 1);
    add_test("test_rc_bulk", test_rc_bulk);
