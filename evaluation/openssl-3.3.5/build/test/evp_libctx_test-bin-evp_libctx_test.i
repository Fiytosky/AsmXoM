# 0 "../test/evp_libctx_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_libctx_test.c"
# 22 "../test/evp_libctx_test.c"
...
# 36 "../test/evp_libctx_test.c" 2

static OSSL_LIB_CTX *libctx = 
# 37 "../test/evp_libctx_test.c" 3 4
                             ((void *)0)
# 37 "../test/evp_libctx_test.c"
                                 ;
static OSSL_PROVIDER *nullprov = 
# 38 "../test/evp_libctx_test.c" 3 4
                                ((void *)0)
# 38 "../test/evp_libctx_test.c"
                                    ;
static OSSL_PROVIDER *libprov = 
# 39 "../test/evp_libctx_test.c" 3 4
                               ((void *)0)
# 39 "../test/evp_libctx_test.c"
                                   ;
static struct stack_st_OPENSSL_STRING *cipher_names = 
# 40 "../test/evp_libctx_test.c" 3 4
                                               ((void *)0)
# 40 "../test/evp_libctx_test.c"
                                                   ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 60 "../test/evp_libctx_test.c" 3 4
         ((void *)0) 
# 60 "../test/evp_libctx_test.c"
              }
    };
    return test_options;
}
...
static int test_evp_cipher_api_safety(void)
{
    int ret = 0;
    EVP_CIPHER_CTX *ctx = 
# 79 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 79 "../test/evp_libctx_test.c"
                             ;

    ctx = EVP_CIPHER_CTX_new();

    if (!test_ptr("../test/evp_libctx_test.c", 83, "ctx", ctx))
        goto err;
    ...
    if (!test_int_eq("../test/evp_libctx_test.c", 90, "EVP_CIPHER_CTX_get_block_size(ctx)", "0", EVP_CIPHER_CTX_get_block_size(ctx), 0))
        goto err_free;
    ...
    if (!test_int_eq("../test/evp_libctx_test.c", 97, "EVP_CIPHER_CTX_get_iv_length(ctx)", "0", EVP_CIPHER_CTX_get_iv_length(ctx), 0))
        goto err_free;
...
# 117 "../test/evp_libctx_test.c" 3 4
                           ((void *)0)
# 117 "../test/evp_libctx_test.c"
                               ;
    EVP_PKEY *pkey_parm = 
# 118 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 118 "../test/evp_libctx_test.c"
                             ;
    EVP_PKEY *pkey = 
# 119 "../test/evp_libctx_test.c" 3 4
                    ((void *)0)
# 119 "../test/evp_libctx_test.c"
                        , *dup_pk = 
# 119 "../test/evp_libctx_test.c" 3 4
                                    ((void *)0)
# 119 "../test/evp_libctx_test.c"
                                        ;
    DSA *dsa = 
# 120 "../test/evp_libctx_test.c" 3 4
              ((void *)0)
# 120 "../test/evp_libctx_test.c"
                  ;
    int pind, qind, gind;
    BIGNUM *p = 
# 122 "../test/evp_libctx_test.c" 3 4
               ((void *)0)
# 122 "../test/evp_libctx_test.c"
                   , *q = 
# 122 "../test/evp_libctx_test.c" 3 4
                          ((void *)0)
# 122 "../test/evp_libctx_test.c"
...
# 122 "../test/evp_libctx_test.c"
    ...
    if (!test_ptr("../test/evp_libctx_test.c", 146, "pkey_parm = EVP_PKEY_new()", pkey_parm = EVP_PKEY_new())
        || !test_ptr("../test/evp_libctx_test.c", 147, "dsa = DSA_new()", dsa = DSA_new())
        || !test_ptr("../test/evp_libctx_test.c", 148, "p = BN_dup(bn[pind])", p = BN_dup(bn[pind]))
        || !test_ptr("../test/evp_libctx_test.c", 149, "q = BN_dup(bn[qind])", q = BN_dup(bn[qind]))
        || !test_ptr("../test/evp_libctx_test.c", 150, "g = BN_dup(bn[gind])", g = BN_dup(bn[gind]))
        || !test_true("../test/evp_libctx_test.c", 151, "DSA_set0_pqg(dsa, p, q, g)", (DSA_set0_pqg(dsa, p, q, g)) != 0))
        goto err;
    p = q = g = 
# 153 "../test/evp_libctx_test.c" 3 4
               ((void *)0)
# 153 "../test/evp_libctx_test.c"
                   ;

    if (!test_true("../test/evp_libctx_test.c", 155, "EVP_PKEY_assign_DSA(pkey_parm, dsa)", (EVP_PKEY_assign((pkey_parm),116, (dsa))) != 0))
        goto err;
    dsa = 
# 157 "../test/evp_libctx_test.c" 3 4
         ((void *)0)
# 157 "../test/evp_libctx_test.c"
             ;

    if (!test_ptr("../test/evp_libctx_test.c", 159, "gen_ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey_parm, NULL)", gen_ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey_parm, 
# 159 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 159 "../test/evp_libctx_test.c"
        ))
        || !test_int_gt("../test/evp_libctx_test.c", 160, "EVP_PKEY_keygen_init(gen_ctx)", "0", EVP_PKEY_keygen_init(gen_ctx), 0)
        || !test_int_eq("../test/evp_libctx_test.c", 161, "EVP_PKEY_keygen(gen_ctx, &pkey)", "expected", EVP_PKEY_keygen(gen_ctx, &pkey), expected))
        goto err;

    if (expected) {
        if (!test_ptr("../test/evp_libctx_test.c", 165, "dup_pk = EVP_PKEY_dup(pkey)", dup_pk = EVP_PKEY_dup(pkey))
            || !test_int_eq("../test/evp_libctx_test.c", 166, "EVP_PKEY_eq(pkey, dup_pk)", "1", EVP_PKEY_eq(pkey, dup_pk), 1))
            goto err;
    }
...
static int do_dh_param_keygen(int tstid, const BIGNUM **bn)
{
    ...
    int expected;
    EVP_PKEY_CTX *gen_ctx = 
# 189 "../test/evp_libctx_test.c" 3 4
                           ((void *)0)
# 189 "../test/evp_libctx_test.c"
                               ;
    EVP_PKEY *pkey_parm = 
# 190 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 190 "../test/evp_libctx_test.c"
                             ;
    EVP_PKEY *pkey = 
# 191 "../test/evp_libctx_test.c" 3 4
                    ((void *)0)
# 191 "../test/evp_libctx_test.c"
                        , *dup_pk = 
# 191 "../test/evp_libctx_test.c" 3 4
                                    ((void *)0)
# 191 "../test/evp_libctx_test.c"
                                        ;
    DH *dh = 
# 192 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 192 "../test/evp_libctx_test.c"
                ;
    int pind, qind, gind;
    BIGNUM *p = 
# 194 "../test/evp_libctx_test.c" 3 4
               ((void *)0)
# 194 "../test/evp_libctx_test.c"
                   , *q = 
# 194 "../test/evp_libctx_test.c" 3 4
                          ((void *)0)
# 194 "../test/evp_libctx_test.c"
...
# 194 "../test/evp_libctx_test.c"
    ...
    if (!test_ptr("../test/evp_libctx_test.c", 209, "pkey_parm = EVP_PKEY_new()", pkey_parm = EVP_PKEY_new())
        || !test_ptr("../test/evp_libctx_test.c", 210, "dh = DH_new()", dh = DH_new())
        || !test_ptr("../test/evp_libctx_test.c", 211, "p = BN_dup(bn[pind])", p = BN_dup(bn[pind]))
        || !test_ptr("../test/evp_libctx_test.c", 212, "q = BN_dup(bn[qind])", q = BN_dup(bn[qind]))
        || !test_ptr("../test/evp_libctx_test.c", 213, "g = BN_dup(bn[gind])", g = BN_dup(bn[gind]))
        || !test_true("../test/evp_libctx_test.c", 214, "DH_set0_pqg(dh, p, q, g)", (DH_set0_pqg(dh, p, q, g)) != 0))
        goto err;
    p = q = g = 
# 216 "../test/evp_libctx_test.c" 3 4
               ((void *)0)
# 216 "../test/evp_libctx_test.c"
                   ;

    if (!test_true("../test/evp_libctx_test.c", 218, "EVP_PKEY_assign_DH(pkey_parm, dh)", (EVP_PKEY_assign((pkey_parm),28,(dh))) != 0))
        goto err;
    dh = 
# 220 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 220 "../test/evp_libctx_test.c"
            ;

    if (!test_ptr("../test/evp_libctx_test.c", 222, "gen_ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey_parm, NULL)", gen_ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey_parm, 
# 222 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 222 "../test/evp_libctx_test.c"
        ))
        || !test_int_gt("../test/evp_libctx_test.c", 223, "EVP_PKEY_keygen_init(gen_ctx)", "0", EVP_PKEY_keygen_init(gen_ctx), 0)
        || !test_int_eq("../test/evp_libctx_test.c", 224, "EVP_PKEY_keygen(gen_ctx, &pkey)", "expected", EVP_PKEY_keygen(gen_ctx, &pkey), expected))
        goto err;

    if (expected) {
        if (!test_ptr("../test/evp_libctx_test.c", 228, "dup_pk = EVP_PKEY_dup(pkey)", dup_pk = EVP_PKEY_dup(pkey))
            || !test_int_eq("../test/evp_libctx_test.c", 229, "EVP_PKEY_eq(pkey, dup_pk)", "1", EVP_PKEY_eq(pkey, dup_pk), 1))
            goto err;
    }
...
static int dhx_cert_load(void)
{
    int ret = 0;
    X509 *cert = 
# 263 "../test/evp_libctx_test.c" 3 4
                ((void *)0)
# 263 "../test/evp_libctx_test.c"
                    ;
    BIO *bio = 
# 264 "../test/evp_libctx_test.c" 3 4
              ((void *)0)
# 264 "../test/evp_libctx_test.c"
                  ;
    ...
    if (!test_ptr("../test/evp_libctx_test.c", 334, "bio = BIO_new_mem_buf(dhx_cert, sizeof(dhx_cert))", bio = BIO_new_mem_buf(dhx_cert, sizeof(dhx_cert)))
        || !test_ptr("../test/evp_libctx_test.c", 335, "cert = X509_new_ex(libctx, NULL)", cert = X509_new_ex(libctx, 
# 335 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 335 "../test/evp_libctx_test.c"
           ))
        || !test_ptr("../test/evp_libctx_test.c", 336, "d2i_X509_bio(bio, &cert)", d2i_X509_bio(bio, &cert)))
        goto err;
    ret = 1;
err:
    X509_free(cert);
...
static int test_cipher_reinit(int test_id)
{
    ...
    EVP_CIPHER *cipher = 
# 351 "../test/evp_libctx_test.c" 3 4
                        ((void *)0)
# 351 "../test/evp_libctx_test.c"
                            ;
    EVP_CIPHER_CTX *ctx = 
# 352 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 352 "../test/evp_libctx_test.c"
                             ;
    ...
    const char *name = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(cipher_names), (test_id)));

    if (!test_ptr("../test/evp_libctx_test.c", 376, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;

    test_note("Fetching %s\n", name);
    if (!test_ptr("../test/evp_libctx_test.c", 380, "cipher = EVP_CIPHER_fetch(libctx, name, NULL)", cipher = EVP_CIPHER_fetch(libctx, name, 
# 380 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 380 "../test/evp_libctx_test.c"
        )))
        goto err;


    ccm = (EVP_CIPHER_get_mode(cipher) == 0x7);


    siv = (EVP_CIPHER_get_mode(cipher) == 0x10004);
    ...
    if (!test_true("../test/evp_libctx_test.c", 400, "EVP_EncryptInit_ex(ctx, cipher, NULL, key, iv)", (EVP_EncryptInit_ex(ctx, cipher, 
# 400 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 400 "../test/evp_libctx_test.c"
        , key, iv)) != 0)
        || !test_true("../test/evp_libctx_test.c", 401, "EVP_EncryptUpdate(ctx, out1, &out1_len, in, sizeof(in))", (EVP_EncryptUpdate(ctx, out1, &out1_len, in, sizeof(in))) != 0)
        || !test_true("../test/evp_libctx_test.c", 402, "EVP_EncryptInit_ex(ctx, NULL, NULL, key, iv)", (EVP_EncryptInit_ex(ctx, 
# 402 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 402 "../test/evp_libctx_test.c"
           , 
# 402 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 402 "../test/evp_libctx_test.c"
           , key, iv)) != 0)
        || !test_int_eq("../test/evp_libctx_test.c", 403, "EVP_EncryptUpdate(ctx, out2, &out2_len, in, sizeof(in))", "ccm ? 0 : 1", EVP_EncryptUpdate(ctx, out2, &out2_len, in, sizeof(in)), ccm ? 0 : 1)

        || (!no_null_key
        && (!test_true("../test/evp_libctx_test.c", 406, "EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, iv)", (EVP_EncryptInit_ex(ctx, 
# 406 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 406 "../test/evp_libctx_test.c"
            , 
# 406 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 406 "../test/evp_libctx_test.c"
...
# 406 "../test/evp_libctx_test.c"
            , iv)) != 0)
        || !test_int_eq("../test/evp_libctx_test.c", 407, "EVP_EncryptUpdate(ctx, out3, &out3_len, in, sizeof(in))", "ccm || siv ? 0 : 1", EVP_EncryptUpdate(ctx, out3, &out3_len, in, sizeof(in)), ccm || siv ? 0 : 1)
                                           )))
        goto err;

    if (ccm == 0) {
        if (diff) {
            if (!test_mem_ne("../test/evp_libctx_test.c", 413, "out1", "out2", out1, out1_len, out2, out2_len)
                || !test_mem_ne("../test/evp_libctx_test.c", 414, "out1", "out3", out1, out1_len, out3, out3_len)
                || !test_mem_ne("../test/evp_libctx_test.c", 415, "out2", "out3", out2, out2_len, out3, out3_len))
                goto err;
        } else {
            if (!test_mem_eq("../test/evp_libctx_test.c", 418, "out1", "out2", out1, out1_len, out2, out2_len)
                || (!siv && !no_null_key && !test_mem_eq("../test/evp_libctx_test.c", 419, "out1", "out3", out1, out1_len, out3, out3_len)))
                goto err;
        }
    }
    ret = 1;
...
static int test_cipher_reinit_partialupdate(int test_id)
{
    ...
    int out1_len = 0, out2_len = 0, out3_len = 0;
    EVP_CIPHER *cipher = 
# 440 "../test/evp_libctx_test.c" 3 4
                        ((void *)0)
# 440 "../test/evp_libctx_test.c"
                            ;
    EVP_CIPHER_CTX *ctx = 
# 441 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 441 "../test/evp_libctx_test.c"
                             ;
    unsigned char out1[256];
    unsigned char out2[256];
    unsigned char out3[256];
    ...
    if (!test_ptr("../test/evp_libctx_test.c", 467, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;

    test_note("Fetching %s\n", name);
    if (!test_ptr("../test/evp_libctx_test.c", 471, "cipher = EVP_CIPHER_fetch(libctx, name, NULL)", cipher = EVP_CIPHER_fetch(libctx, name, 
# 471 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 471 "../test/evp_libctx_test.c"
        )))
        goto err;

    in_len = EVP_CIPHER_get_block_size(cipher);
    if (!test_int_gt("../test/evp_libctx_test.c", 475, "in_len", "0", in_len, 0))
        goto err;
    if (in_len > 1)
        in_len /= 2;
    ...
    if (((EVP_CIPHER_get_flags(cipher)
          & (0x4000 | 0x400000)) != 0)
        || EVP_CIPHER_get_mode(cipher) == 0x7
        || EVP_CIPHER_get_mode(cipher) == 0x10001
        || EVP_CIPHER_get_mode(cipher) == 0x10002) {
        ret = 1;
        goto err;
    }

    if (!test_true("../test/evp_libctx_test.c", 490, "EVP_EncryptInit_ex(ctx, cipher, NULL, key, iv)", (EVP_EncryptInit_ex(ctx, cipher, 
# 490 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 490 "../test/evp_libctx_test.c"
        , key, iv)) != 0)
        || !test_true("../test/evp_libctx_test.c", 491, "EVP_EncryptUpdate(ctx, out1, &out1_len, in, in_len)", (EVP_EncryptUpdate(ctx, out1, &out1_len, in, in_len)) != 0)
        || !test_true("../test/evp_libctx_test.c", 492, "EVP_EncryptInit_ex(ctx, NULL, NULL, key, iv)", (EVP_EncryptInit_ex(ctx, 
# 492 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 492 "../test/evp_libctx_test.c"
           , 
# 492 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 492 "../test/evp_libctx_test.c"
           , key, iv)) != 0)
        || !test_true("../test/evp_libctx_test.c", 493, "EVP_EncryptUpdate(ctx, out2, &out2_len, in, in_len)", (EVP_EncryptUpdate(ctx, out2, &out2_len, in, in_len)) != 0))
        goto err;

    if (EVP_CIPHER_get_iv_length(cipher) != 0)
        if (!test_mem_eq("../test/evp_libctx_test.c", 497, "out1", "out2", out1, out1_len, out2, out2_len))
            goto err;

    if (EVP_CIPHER_get_mode(cipher) != 0x10004) {
        if (!test_true("../test/evp_libctx_test.c", 501, "EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, iv)", (EVP_EncryptInit_ex(ctx, 
# 501 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 501 "../test/evp_libctx_test.c"
            , 
# 501 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 501 "../test/evp_libctx_test.c"
...
# 501 "../test/evp_libctx_test.c"
            , iv)) != 0)
            || !test_true("../test/evp_libctx_test.c", 502, "EVP_EncryptUpdate(ctx, out3, &out3_len, in, in_len)", (EVP_EncryptUpdate(ctx, out3, &out3_len, in, in_len)) != 0))
            goto err;

        if (EVP_CIPHER_get_iv_length(cipher) != 0)
            if (!test_mem_eq("../test/evp_libctx_test.c", 506, "out1", "out3", out1, out1_len, out3, out3_len))
                goto err;
    }
    ret = 1;
err:
...
{
    struct stack_st_OPENSSL_STRING *names = cipher_names_list;
    const char *name = EVP_CIPHER_get0_name(cipher);
    char *namedup = 
# 526 "../test/evp_libctx_test.c" 3 4
                   ((void *)0)
# 526 "../test/evp_libctx_test.c"
                       ;

    
# 528 "../test/evp_libctx_test.c" 3 4
   ((void) (0))
# 528 "../test/evp_libctx_test.c"
                       ;

    if ((namedup = CRYPTO_strdup(name, "../test/evp_libctx_test.c", 530)) != 
# 530 "../test/evp_libctx_test.c" 3 4
                                           ((void *)0)
        
# 531 "../test/evp_libctx_test.c"
       && !OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(names), ossl_check_OPENSSL_STRING_type(namedup)))
        CRYPTO_free(namedup, "../test/evp_libctx_test.c", 532);
}
...
# 538 "../test/evp_libctx_test.c" 3 4
                            ((void *)0)
# 538 "../test/evp_libctx_test.c"
                                ;
    const unsigned char *pp = 
# 539 "../test/evp_libctx_test.c" 3 4
                             ((void *)0)
# 539 "../test/evp_libctx_test.c"
                                 ;
    size_t len = 0;
    OSSL_ENCODER_CTX *ectx = 
# 541 "../test/evp_libctx_test.c" 3 4
                            ((void *)0)
# 541 "../test/evp_libctx_test.c"
                                ;

    if (!test_ptr("../test/evp_libctx_test.c", 543, "*priv = EVP_PKEY_Q_keygen(libctx, NULL, \"RSA\", (size_t)bits)", *priv = EVP_PKEY_Q_keygen(libctx, 
# 543 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 543 "../test/evp_libctx_test.c"
        , "RSA", (size_t)bits))
        || !test_ptr("../test/evp_libctx_test.c", 544, "ectx = OSSL_ENCODER_CTX_new_for_pkey(*priv, EVP_PKEY_PUBLIC_KEY, \"DER\", \"type-specific\", NULL)", ectx = OSSL_ENCODER_CTX_new_for_pkey(*priv, ( ( ( 0x04 | 0x80) ) | 0x02 ), "DER", "type-specific", 
# 544 "../test/evp_libctx_test.c" 3 4
           ((void *)0)
# 544 "../test/evp_libctx_test.c"
           ))




        || !test_true("../test/evp_libctx_test.c", 549, "OSSL_ENCODER_to_data(ectx, &pub_der, &len)", (OSSL_ENCODER_to_data(ectx, &pub_der, &len)) != 0))
        goto err;
    pp = pub_der;
    if (!test_ptr("../test/evp_libctx_test.c", 552, "d2i_PublicKey(EVP_PKEY_RSA, pub, &pp, len)", d2i_PublicKey(6, pub, &pp, len)))
        goto err;
    ret = 1;
err:
    OSSL_ENCODER_CTX_free(ectx);
    CRYPTO_free(pub_der, "../test/evp_libctx_test.c", 557);
    return ret;
}
...
static int kem_rsa_gen_recover(void)
{
    int ret = 0;
    EVP_PKEY *pub = 
# 564 "../test/evp_libctx_test.c" 3 4
                   ((void *)0)
# 564 "../test/evp_libctx_test.c"
                       ;
    EVP_PKEY *priv = 
# 565 "../test/evp_libctx_test.c" 3 4
                    ((void *)0)
# 565 "../test/evp_libctx_test.c"
                        ;
    EVP_PKEY_CTX *sctx = 
# 566 "../test/evp_libctx_test.c" 3 4
                        ((void *)0)
# 566 "../test/evp_libctx_test.c"
                            , *rctx = 
# 566 "../test/evp_libctx_test.c" 3 4
                                      ((void *)0)
# 566 "../test/evp_libctx_test.c"
...
# 566 "../test/evp_libctx_test.c"
    ...
    ret = test_true("../test/evp_libctx_test.c", 573, "rsa_keygen(bits, &pub, &priv)", (rsa_keygen(bits, &pub, &priv)) != 0)
          && test_ptr("../test/evp_libctx_test.c", 574, "sctx = EVP_PKEY_CTX_new_from_pkey(libctx, pub, NULL)", sctx = EVP_PKEY_CTX_new_from_pkey(libctx, pub, 
# 574 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 574 "../test/evp_libctx_test.c"
            ))
          && test_int_eq("../test/evp_libctx_test.c", 575, "EVP_PKEY_encapsulate_init(sctx, NULL)", "1", EVP_PKEY_encapsulate_init(sctx, 
# 575 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 575 "../test/evp_libctx_test.c"
            ), 1)
          && test_int_eq("../test/evp_libctx_test.c", 576, "EVP_PKEY_CTX_set_kem_op(sctx, \"RSASVE\")", "1", EVP_PKEY_CTX_set_kem_op(sctx, "RSASVE"), 1)
          && test_ptr("../test/evp_libctx_test.c", 577, "dctx = EVP_PKEY_CTX_dup(sctx)", dctx = EVP_PKEY_CTX_dup(sctx))

          && test_int_eq("../test/evp_libctx_test.c", 579, "EVP_PKEY_encapsulate(dctx, NULL, NULL, NULL, NULL)", "0", EVP_PKEY_encapsulate(dctx, 
# 579 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 579 "../test/evp_libctx_test.c"
            , 
# 579 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 579 "../test/evp_libctx_test.c"
...
# 579 "../test/evp_libctx_test.c"
          ...
          && test_int_eq("../test/evp_libctx_test.c", 580, "EVP_PKEY_encapsulate(dctx, NULL, &ctlen, NULL, &secretlen)", "1", EVP_PKEY_encapsulate(dctx, 
# 580 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 580 "../test/evp_libctx_test.c"
            , &ctlen, 
# 580 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 580 "../test/evp_libctx_test.c"
          ...
          && test_int_eq("../test/evp_libctx_test.c", 582, "ctlen", "secretlen", ctlen, secretlen)
          && test_int_eq("../test/evp_libctx_test.c", 583, "ctlen", "bits / 8", ctlen, bits / 8)
          && test_int_eq("../test/evp_libctx_test.c", 584, "EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen)", "1", EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen), 1)

          && test_ptr("../test/evp_libctx_test.c", 586, "rctx = EVP_PKEY_CTX_new_from_pkey(libctx, priv, NULL)", rctx = EVP_PKEY_CTX_new_from_pkey(libctx, priv, 
# 586 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 586 "../test/evp_libctx_test.c"
            ))
          && test_int_eq("../test/evp_libctx_test.c", 587, "EVP_PKEY_decapsulate_init(rctx, NULL)", "1", EVP_PKEY_decapsulate_init(rctx, 
# 587 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 587 "../test/evp_libctx_test.c"
            ), 1)
          && test_int_eq("../test/evp_libctx_test.c", 588, "EVP_PKEY_CTX_set_kem_op(rctx, \"RSASVE\")", "1", EVP_PKEY_CTX_set_kem_op(rctx, "RSASVE"), 1)

          && test_int_eq("../test/evp_libctx_test.c", 590, "EVP_PKEY_decapsulate(rctx, NULL, NULL, ct, ctlen)", "0", EVP_PKEY_decapsulate(rctx, 
# 590 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 590 "../test/evp_libctx_test.c"
            , 
# 590 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 590 "../test/evp_libctx_test.c"
            , ct, ctlen), 0)
          && test_int_eq("../test/evp_libctx_test.c", 591, "EVP_PKEY_decapsulate(rctx, NULL, &unwraplen, ct, ctlen)", "1", EVP_PKEY_decapsulate(rctx, 
# 591 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 591 "../test/evp_libctx_test.c"
            , &unwraplen, ct, ctlen), 1)

          && test_int_eq("../test/evp_libctx_test.c", 593, "EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen, ct, ctlen)", "1", EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen, ct, ctlen), 1)

          && test_mem_eq("../test/evp_libctx_test.c", 595, "unwrap", "secret", unwrap, unwraplen, secret, secretlen);


    if (fips_provider_version_match(libctx, ">=3.4.0")) {
        ctlen = 1;
        if (!test_int_eq("../test/evp_libctx_test.c", 600, "EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen)", "0", EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen), 0)
                                                             )
            ret = 0;
        unwraplen = 1;
        if (!test_int_eq("../test/evp_libctx_test.c", 604, "EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen, ct, ctlen)", "0", EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen, ct, ctlen), 0)
                                                        )
            ret = 0;
    }
...
static int test_cipher_tdes_randkey(void)
{
    int ret;
    EVP_CIPHER_CTX *ctx = 
# 625 "../test/evp_libctx_test.c" 3 4
                         ((void *)0)
# 625 "../test/evp_libctx_test.c"
                             ;
    EVP_CIPHER *tdes_cipher = 
# 626 "../test/evp_libctx_test.c" 3 4
                             ((void *)0)
# 626 "../test/evp_libctx_test.c"
                                 , *aes_cipher = 
# 626 "../test/evp_libctx_test.c" 3 4
                                                 ((void *)0)
# 626 "../test/evp_libctx_test.c"
    ...
    ret = test_ptr("../test/evp_libctx_test.c", 629, "aes_cipher = EVP_CIPHER_fetch(libctx, \"AES-256-CBC\", NULL)", aes_cipher = EVP_CIPHER_fetch(libctx, "AES-256-CBC", 
# 629 "../test/evp_libctx_test.c" 3 4
         ((void *)0)
# 629 "../test/evp_libctx_test.c"
         ))
          && test_int_eq("../test/evp_libctx_test.c", 630, "EVP_CIPHER_get_flags(aes_cipher) & EVP_CIPH_RAND_KEY", "0", EVP_CIPHER_get_flags(aes_cipher) & 0x200, 0)
          && test_ptr("../test/evp_libctx_test.c", 631, "tdes_cipher = EVP_CIPHER_fetch(libctx, \"DES-EDE3-CBC\", NULL)", tdes_cipher = EVP_CIPHER_fetch(libctx, "DES-EDE3-CBC", 
# 631 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 631 "../test/evp_libctx_test.c"
            ))
          && test_int_ne("../test/evp_libctx_test.c", 632, "EVP_CIPHER_get_flags(tdes_cipher) & EVP_CIPH_RAND_KEY", "0", EVP_CIPHER_get_flags(tdes_cipher) & 0x200, 0)
          && test_ptr("../test/evp_libctx_test.c", 633, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
          && test_true("../test/evp_libctx_test.c", 634, "EVP_CipherInit_ex(ctx, tdes_cipher, NULL, NULL, NULL, 1)", (EVP_CipherInit_ex(ctx, tdes_cipher, 
# 634 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 634 "../test/evp_libctx_test.c"
            , 
# 634 "../test/evp_libctx_test.c" 3 4
            ((void *)0)
# 634 "../test/evp_libctx_test.c"
...
# 634 "../test/evp_libctx_test.c"
            , 1)) != 0)
          && test_int_gt("../test/evp_libctx_test.c", 635, "EVP_CIPHER_CTX_rand_key(ctx, key)", "0", EVP_CIPHER_CTX_rand_key(ctx, key), 0);
...
static int kem_rsa_params(void)
{
    int ret = 0;
    EVP_PKEY *pub = 
# 647 "../test/evp_libctx_test.c" 3 4
                   ((void *)0)
# 647 "../test/evp_libctx_test.c"
                       ;
    EVP_PKEY *priv = 
# 648 "../test/evp_libctx_test.c" 3 4
                    ((void *)0)
# 648 "../test/evp_libctx_test.c"
                        ;
    EVP_PKEY_CTX *pubctx = 
# 649 "../test/evp_libctx_test.c" 3 4
                          ((void *)0)
# 649 "../test/evp_libctx_test.c"
                              , *privctx = 
# 649 "../test/evp_libctx_test.c" 3 4
                                           ((void *)0)
# 649 "../test/evp_libctx_test.c"
    ...
    ret = test_true("../test/evp_libctx_test.c", 654, "rsa_keygen(2048, &pub, &priv)", (rsa_keygen(2048, &pub, &priv)) != 0)
        && test_ptr("../test/evp_libctx_test.c", 655, "pubctx = EVP_PKEY_CTX_new_from_pkey(libctx, pub, NULL)", pubctx = EVP_PKEY_CTX_new_from_pkey(libctx, pub, 
# 655 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 655 "../test/evp_libctx_test.c"
          ))
        && test_ptr("../test/evp_libctx_test.c", 656, "privctx = EVP_PKEY_CTX_new_from_pkey(libctx, priv, NULL)", privctx = EVP_PKEY_CTX_new_from_pkey(libctx, priv, 
# 656 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 656 "../test/evp_libctx_test.c"
          ))

        && test_int_eq("../test/evp_libctx_test.c", 658, "EVP_PKEY_CTX_set_kem_op(pubctx, \"RSASVE\")", "-2", EVP_PKEY_CTX_set_kem_op(pubctx, "RSASVE"), -2)

        && test_int_eq("../test/evp_libctx_test.c", 660, "EVP_PKEY_encapsulate_init(NULL, NULL)", "0", EVP_PKEY_encapsulate_init(
# 660 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 660 "../test/evp_libctx_test.c"
          , 
# 660 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 660 "../test/evp_libctx_test.c"
          ), 0)
        && test_int_eq("../test/evp_libctx_test.c", 661, "EVP_PKEY_encapsulate(NULL, NULL, NULL, NULL, NULL)", "0", EVP_PKEY_encapsulate(
# 661 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 661 "../test/evp_libctx_test.c"
          , 
# 661 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 661 "../test/evp_libctx_test.c"
...
# 661 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 662, "EVP_PKEY_decapsulate_init(NULL, NULL)", "0", EVP_PKEY_decapsulate_init(
# 662 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 662 "../test/evp_libctx_test.c"
          , 
# 662 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 662 "../test/evp_libctx_test.c"
          ), 0)
        && test_int_eq("../test/evp_libctx_test.c", 663, "EVP_PKEY_decapsulate(NULL, NULL, NULL, NULL, 0)", "0", EVP_PKEY_decapsulate(
# 663 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 663 "../test/evp_libctx_test.c"
          , 
# 663 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 663 "../test/evp_libctx_test.c"
...
# 663 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 665, "EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL, NULL)", "-1", EVP_PKEY_encapsulate(pubctx, 
# 665 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 665 "../test/evp_libctx_test.c"
          , 
# 665 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 665 "../test/evp_libctx_test.c"
...
# 665 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 666, "EVP_PKEY_decapsulate(privctx, NULL, NULL, NULL, 0)", "0", EVP_PKEY_decapsulate(privctx, 
# 666 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 666 "../test/evp_libctx_test.c"
          , 
# 666 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 666 "../test/evp_libctx_test.c"
...
# 666 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 668, "EVP_PKEY_decapsulate_init(pubctx, NULL)", "1", EVP_PKEY_decapsulate_init(pubctx, 
# 668 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 668 "../test/evp_libctx_test.c"
          ), 1)
        && test_int_eq("../test/evp_libctx_test.c", 669, "EVP_PKEY_CTX_set_kem_op(pubctx, \"RSASVE\")", "1", EVP_PKEY_CTX_set_kem_op(pubctx, "RSASVE"), 1)
        && test_int_eq("../test/evp_libctx_test.c", 670, "EVP_PKEY_decapsulate(pubctx, secret, &secretlen, ct, sizeof(ct))", "0", EVP_PKEY_decapsulate(pubctx, secret, &secretlen, ct, sizeof(ct)), 0)

        && test_uchar_eq("../test/evp_libctx_test.c", 672, "secret[0]", "0", secret[0], 0)

        && test_int_eq("../test/evp_libctx_test.c", 674, "EVP_PKEY_encapsulate_init(pubctx, NULL)", "1", EVP_PKEY_encapsulate_init(pubctx, 
# 674 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 674 "../test/evp_libctx_test.c"
          ), 1)
        && (!is_fips_lt_3_5 ||
            test_int_eq("../test/evp_libctx_test.c", 676, "EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret, &secretlen)", "-2", EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret, &secretlen), -2))

        && test_int_eq("../test/evp_libctx_test.c", 678, "EVP_PKEY_CTX_set_kem_op(pubctx, \"RSA\")", "0", EVP_PKEY_CTX_set_kem_op(pubctx, "RSA"), 0)
        && test_int_eq("../test/evp_libctx_test.c", 679, "EVP_PKEY_CTX_set_kem_op(pubctx, NULL)", "0", EVP_PKEY_CTX_set_kem_op(pubctx, 
# 679 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 679 "../test/evp_libctx_test.c"
          ), 0)
        && test_int_eq("../test/evp_libctx_test.c", 680, "EVP_PKEY_CTX_set_kem_op(NULL, \"RSASVE\")", "0", EVP_PKEY_CTX_set_kem_op(
# 680 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 680 "../test/evp_libctx_test.c"
          , "RSASVE"), 0)
        && test_int_eq("../test/evp_libctx_test.c", 681, "EVP_PKEY_CTX_set_kem_op(NULL, NULL)", "0", EVP_PKEY_CTX_set_kem_op(
# 681 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 681 "../test/evp_libctx_test.c"
          , 
# 681 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 681 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 683, "EVP_PKEY_CTX_set_kem_op(pubctx, \"RSASVE\")", "1", EVP_PKEY_CTX_set_kem_op(pubctx, "RSASVE"), 1)
        && test_int_eq("../test/evp_libctx_test.c", 684, "EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, NULL)", "1", EVP_PKEY_encapsulate(pubctx, 
# 684 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 684 "../test/evp_libctx_test.c"
          , &ctlen, 
# 684 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 684 "../test/evp_libctx_test.c"
...
# 684 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 685, "EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret, NULL)", "1", EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret, 
# 685 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 685 "../test/evp_libctx_test.c"
          ), 1)
        && test_int_eq("../test/evp_libctx_test.c", 686, "EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, NULL)", "1", EVP_PKEY_encapsulate(pubctx, 
# 686 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 686 "../test/evp_libctx_test.c"
          , &ctlen, 
# 686 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 686 "../test/evp_libctx_test.c"
...
# 686 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 688, "EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL, &secretlen)", "1", EVP_PKEY_encapsulate(pubctx, 
# 688 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 688 "../test/evp_libctx_test.c"
          , 
# 688 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 688 "../test/evp_libctx_test.c"
...
# 688 "../test/evp_libctx_test.c"
          , &secretlen), 1)
        && test_int_eq("../test/evp_libctx_test.c", 689, "EVP_PKEY_encapsulate(pubctx, ct, NULL, secret, &secretlen)", "1", EVP_PKEY_encapsulate(pubctx, ct, 
# 689 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 689 "../test/evp_libctx_test.c"
          , secret, &secretlen), 1)

        && test_int_eq("../test/evp_libctx_test.c", 691, "EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL, NULL)", "0", EVP_PKEY_encapsulate(pubctx, 
# 691 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 691 "../test/evp_libctx_test.c"
          , 
# 691 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 691 "../test/evp_libctx_test.c"
...
# 691 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 692, "EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, NULL)", "1", EVP_PKEY_encapsulate(pubctx, 
# 692 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 692 "../test/evp_libctx_test.c"
          , &ctlen, 
# 692 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 692 "../test/evp_libctx_test.c"
...
# 692 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 693, "EVP_PKEY_encapsulate(pubctx, NULL, NULL, NULL, &secretlen)", "1", EVP_PKEY_encapsulate(pubctx, 
# 693 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 693 "../test/evp_libctx_test.c"
          , 
# 693 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 693 "../test/evp_libctx_test.c"
...
# 693 "../test/evp_libctx_test.c"
          , &secretlen), 1)
        && test_int_eq("../test/evp_libctx_test.c", 694, "EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, &secretlen)", "1", EVP_PKEY_encapsulate(pubctx, 
# 694 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 694 "../test/evp_libctx_test.c"
          , &ctlen, 
# 694 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 694 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 696, "EVP_PKEY_encapsulate(pubctx, ct, &ctlen, NULL, NULL)", "0", EVP_PKEY_encapsulate(pubctx, ct, &ctlen, 
# 696 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 696 "../test/evp_libctx_test.c"
          , 
# 696 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 696 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 698, "EVP_PKEY_encapsulate(pubctx, ct, NULL, secret, NULL)", "1", EVP_PKEY_encapsulate(pubctx, ct, 
# 698 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 698 "../test/evp_libctx_test.c"
          , secret, 
# 698 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 698 "../test/evp_libctx_test.c"
        ...
        && test_int_eq("../test/evp_libctx_test.c", 700, "EVP_PKEY_decapsulate_init(privctx, NULL)", "1", EVP_PKEY_decapsulate_init(privctx, 
# 700 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 700 "../test/evp_libctx_test.c"
          ), 1)
        && test_int_eq("../test/evp_libctx_test.c", 701, "EVP_PKEY_CTX_set_kem_op(privctx, \"RSASVE\")", "1", EVP_PKEY_CTX_set_kem_op(privctx, "RSASVE"), 1)
        && test_int_eq("../test/evp_libctx_test.c", 702, "EVP_PKEY_decapsulate(privctx, secret, NULL, ct, sizeof(ct))", "1", EVP_PKEY_decapsulate(privctx, secret, 
# 702 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 702 "../test/evp_libctx_test.c"
          , ct, sizeof(ct)), 1)
        && test_int_eq("../test/evp_libctx_test.c", 703, "EVP_PKEY_decapsulate(privctx, NULL, &secretlen, ct, sizeof(ct))", "1", EVP_PKEY_decapsulate(privctx, 
# 703 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 703 "../test/evp_libctx_test.c"
          , &secretlen, ct, sizeof(ct)), 1)
        && test_int_eq("../test/evp_libctx_test.c", 704, "secretlen", "256", secretlen, 256)

        && test_int_eq("../test/evp_libctx_test.c", 706, "EVP_PKEY_decapsulate(privctx, NULL, NULL, ct, sizeof(ct))", "0", EVP_PKEY_decapsulate(privctx, 
# 706 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 706 "../test/evp_libctx_test.c"
          , 
# 706 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 706 "../test/evp_libctx_test.c"
          , ct, sizeof(ct)), 0)
        && test_int_eq("../test/evp_libctx_test.c", 707, "EVP_PKEY_decapsulate(privctx, secret, &secretlen, NULL, 0)", "0", EVP_PKEY_decapsulate(privctx, secret, &secretlen, 
# 707 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 707 "../test/evp_libctx_test.c"
          , 0), 0)
        && test_int_eq("../test/evp_libctx_test.c", 708, "EVP_PKEY_decapsulate(privctx, secret, &secretlen, NULL, sizeof(ct))", "0", EVP_PKEY_decapsulate(privctx, secret, &secretlen, 
# 708 "../test/evp_libctx_test.c" 3 4
          ((void *)0)
# 708 "../test/evp_libctx_test.c"
          , sizeof(ct)), 0)
        && test_int_eq("../test/evp_libctx_test.c", 709, "EVP_PKEY_decapsulate(privctx, secret, &secretlen, ct, 0)", "0", EVP_PKEY_decapsulate(privctx, secret, &secretlen, ct, 0), 0);
...
{
    EVP_PKEY_CTX *gctx = 
# 721 "../test/evp_libctx_test.c" 3 4
                        ((void *)0)
# 721 "../test/evp_libctx_test.c"
                            ;
    EVP_PKEY *pkey = 
# 722 "../test/evp_libctx_test.c" 3 4
                    ((void *)0)
# 722 "../test/evp_libctx_test.c"
                        ;
    OSSL_PARAM params[2];
    ...
    if (!test_ptr("../test/evp_libctx_test.c", 728, "gctx = EVP_PKEY_CTX_new_from_name(libctx, \"DH\", NULL)", gctx = EVP_PKEY_CTX_new_from_name(libctx, "DH", 
# 728 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 728 "../test/evp_libctx_test.c"
        ))
        || !test_int_gt("../test/evp_libctx_test.c", 729, "EVP_PKEY_keygen_init(gctx)", "0", EVP_PKEY_keygen_init(gctx), 0)
        || !test_true("../test/evp_libctx_test.c", 730, "EVP_PKEY_CTX_set_params(gctx, params)", (EVP_PKEY_CTX_set_params(gctx, params)) != 0)
        || !test_true("../test/evp_libctx_test.c", 731, "EVP_PKEY_keygen(gctx, &pkey)", (EVP_PKEY_keygen(gctx, &pkey)) != 0))
        goto err;
err:
...
static int kem_invalid_keytype(void)
{
    int ret = 0;
    EVP_PKEY *key = 
# 742 "../test/evp_libctx_test.c" 3 4
                   ((void *)0)
# 742 "../test/evp_libctx_test.c"
                       ;
    EVP_PKEY_CTX *sctx = 
# 743 "../test/evp_libctx_test.c" 3 4
                        ((void *)0)
# 743 "../test/evp_libctx_test.c"
                            ;

    if (!test_ptr("../test/evp_libctx_test.c", 745, "key = gen_dh_key()", key = gen_dh_key()))
        goto done;

    if (!test_ptr("../test/evp_libctx_test.c", 748, "sctx = EVP_PKEY_CTX_new_from_pkey(libctx, key, NULL)", sctx = EVP_PKEY_CTX_new_from_pkey(libctx, key, 
# 748 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 748 "../test/evp_libctx_test.c"
        )))
        goto done;
    if (!test_int_eq("../test/evp_libctx_test.c", 750, "EVP_PKEY_encapsulate_init(sctx, NULL)", "-2", EVP_PKEY_encapsulate_init(sctx, 
# 750 "../test/evp_libctx_test.c" 3 4
        ((void *)0)
# 750 "../test/evp_libctx_test.c"
        ), -2))
        goto done;
...
int setup_tests(void)
{
    ...
    char *config_file = 
# 764 "../test/evp_libctx_test.c" 3 4
                       ((void *)0)
# 764 "../test/evp_libctx_test.c"
                           ;
    OPTION_CHOICE o;
    ...
    if (!is_fips || fips_provider_version_lt(libctx, 3, 4, 0))
        add_all_tests("test_dsa_param_keygen", test_dsa_param_keygen, 3 * 3 * 3, 1);


    add_all_tests("test_dh_safeprime_param_keygen", test_dh_safeprime_param_keygen, 3 * 3 * 3, 1);
    add_test("dhx_cert_load", dhx_cert_load);


    if (!test_ptr("../test/evp_libctx_test.c", 802, "cipher_names = sk_OPENSSL_STRING_new(name_cmp)", cipher_names = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new(ossl_check_OPENSSL_STRING_compfunc_type(name_cmp)))))
        return 0;
    EVP_CIPHER_do_all_provided(libctx, collect_cipher_names, cipher_names);

    add_all_tests("test_cipher_reinit", test_cipher_reinit, OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(cipher_names)), 1);
    add_all_tests("test_cipher_reinit_partialupdate", test_cipher_reinit_partialupdate, OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(cipher_names)), 1)
                                                      ;
    ...
    add_test("test_cipher_tdes_randkey", test_cipher_tdes_randkey);
...
{
    CRYPTO_free(m, "../test/evp_libctx_test.c", 823);
}

void cleanup_tests(void)
{
    OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(cipher_names),ossl_check_OPENSSL_STRING_freefunc_type(string_free));
