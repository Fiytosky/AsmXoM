# 0 "test/buildtest_whrlpool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_whrlpool.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int WHIRLPOOL_Init(WHIRLPOOL_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int WHIRLPOOL_Update(WHIRLPOOL_CTX *c,
                                           const void *inp, size_t bytes);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void WHIRLPOOL_BitUpdate(WHIRLPOOL_CTX *c,
                                               const void *inp, size_t bits);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int WHIRLPOOL_Final(unsigned char *md, WHIRLPOOL_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned char *WHIRLPOOL(const void *inp, size_t bytes,
                                               unsigned char *md);
# 11 "test/buildtest_whrlpool.c" 2
