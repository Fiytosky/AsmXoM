# 0 "../test/quic_srtm_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_srtm_test.c"
# 10 "../test/quic_srtm_test.c"
...
# 15 "../include/internal/quic_srtm.h" 2
...
# 16 "../include/internal/quic_srtm.h" 2
...
# 17 "../include/internal/quic_srtm.h" 2
...
# 18 "../include/internal/quic_srtm.h" 2
...
# 19 "../include/internal/quic_srtm.h" 2
...
static int test_srtm(void)
{
    ...
    QUIC_SRTM *srtm;
    void *opaque = 
# 27 "../test/quic_srtm_test.c" 3 4
                  ((void *)0)
# 27 "../test/quic_srtm_test.c"
                      ;
    uint64_t seq_num = 0;

    if (!test_ptr("../test/quic_srtm_test.c", 30, "srtm = ossl_quic_srtm_new(NULL, NULL)", srtm = ossl_quic_srtm_new(
# 30 "../test/quic_srtm_test.c" 3 4
        ((void *)0)
# 30 "../test/quic_srtm_test.c"
        , 
# 30 "../test/quic_srtm_test.c" 3 4
        ((void *)0)
# 30 "../test/quic_srtm_test.c"
    ...
    if (!test_true("../test/quic_srtm_test.c", 33, "ossl_quic_srtm_add(srtm, ptrs + 0, 0, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 0, 0, &token_1)) != 0)
        || !test_false("../test/quic_srtm_test.c", 34, "ossl_quic_srtm_add(srtm, ptrs + 0, 0, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 0, 0, &token_1)) != 0)
        || !test_false("../test/quic_srtm_test.c", 35, "ossl_quic_srtm_remove(srtm, ptrs + 0, 1)", (ossl_quic_srtm_remove(srtm, ptrs + 0, 1)) != 0)
        || !test_false("../test/quic_srtm_test.c", 36, "ossl_quic_srtm_remove(srtm, ptrs + 3, 0)", (ossl_quic_srtm_remove(srtm, ptrs + 3, 0)) != 0)
        || !test_true("../test/quic_srtm_test.c", 37, "ossl_quic_srtm_cull(srtm, ptrs + 3)", (ossl_quic_srtm_cull(srtm, ptrs + 3)) != 0)
        || !test_true("../test/quic_srtm_test.c", 38, "ossl_quic_srtm_cull(srtm, ptrs + 3)", (ossl_quic_srtm_cull(srtm, ptrs + 3)) != 0)
        || !test_true("../test/quic_srtm_test.c", 39, "ossl_quic_srtm_add(srtm, ptrs + 0, 1, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 0, 1, &token_1)) != 0)
        || !test_true("../test/quic_srtm_test.c", 40, "ossl_quic_srtm_add(srtm, ptrs + 0, 2, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 0, 2, &token_1)) != 0)
        || !test_true("../test/quic_srtm_test.c", 41, "ossl_quic_srtm_add(srtm, ptrs + 0, 3, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 0, 3, &token_1)) != 0)
        || !test_true("../test/quic_srtm_test.c", 42, "ossl_quic_srtm_add(srtm, ptrs + 1, 0, &token_1)", (ossl_quic_srtm_add(srtm, ptrs + 1, 0, &token_1)) != 0)
        || !test_true("../test/quic_srtm_test.c", 43, "ossl_quic_srtm_add(srtm, ptrs + 2, 0, &token_2)", (ossl_quic_srtm_add(srtm, ptrs + 2, 0, &token_2)) != 0)
        || !test_true("../test/quic_srtm_test.c", 44, "ossl_quic_srtm_add(srtm, ptrs + 3, 3, &token_2)", (ossl_quic_srtm_add(srtm, ptrs + 3, 3, &token_2)) != 0)
        || !test_true("../test/quic_srtm_test.c", 45, "ossl_quic_srtm_remove(srtm, ptrs + 3, 3)", (ossl_quic_srtm_remove(srtm, ptrs + 3, 3)) != 0)
        || !test_true("../test/quic_srtm_test.c", 46, "ossl_quic_srtm_lookup(srtm, &token_1, 0, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 0, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 47, "opaque", "ptrs + 1", opaque, ptrs + 1)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 48, "seq_num", "0", seq_num, 0)
        || !test_true("../test/quic_srtm_test.c", 49, "ossl_quic_srtm_lookup(srtm, &token_1, 1, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 1, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 50, "opaque", "ptrs + 0", opaque, ptrs + 0)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 51, "seq_num", "3", seq_num, 3)
        || !test_true("../test/quic_srtm_test.c", 52, "ossl_quic_srtm_lookup(srtm, &token_1, 2, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 2, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 53, "opaque", "ptrs + 0", opaque, ptrs + 0)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 54, "seq_num", "2", seq_num, 2)
        || !test_true("../test/quic_srtm_test.c", 55, "ossl_quic_srtm_lookup(srtm, &token_1, 3, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 3, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 56, "opaque", "ptrs + 0", opaque, ptrs + 0)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 57, "seq_num", "1", seq_num, 1)
        || !test_true("../test/quic_srtm_test.c", 58, "ossl_quic_srtm_lookup(srtm, &token_1, 4, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 4, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 59, "opaque", "ptrs + 0", opaque, ptrs + 0)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 60, "seq_num", "0", seq_num, 0)
        || !test_false("../test/quic_srtm_test.c", 61, "ossl_quic_srtm_lookup(srtm, &token_1, 5, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 5, &opaque, &seq_num)) != 0)
        || !test_true("../test/quic_srtm_test.c", 62, "ossl_quic_srtm_cull(srtm, ptrs + 0)", (ossl_quic_srtm_cull(srtm, ptrs + 0)) != 0)
        || !test_true("../test/quic_srtm_test.c", 63, "ossl_quic_srtm_lookup(srtm, &token_1, 0, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_1, 0, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 64, "opaque", "ptrs + 1", opaque, ptrs + 1)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 65, "seq_num", "0", seq_num, 0)
        || !test_true("../test/quic_srtm_test.c", 66, "ossl_quic_srtm_lookup(srtm, &token_2, 0, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_2, 0, &opaque, &seq_num)) != 0)
        || !test_ptr_eq("../test/quic_srtm_test.c", 67, "opaque", "ptrs + 2", opaque, ptrs + 2)
        || !test_uint64_t_eq("../test/quic_srtm_test.c", 68, "seq_num", "0", seq_num, 0)
        || !test_true("../test/quic_srtm_test.c", 69, "ossl_quic_srtm_remove(srtm, ptrs + 2, 0)", (ossl_quic_srtm_remove(srtm, ptrs + 2, 0)) != 0)
        || !test_false("../test/quic_srtm_test.c", 70, "ossl_quic_srtm_lookup(srtm, &token_2, 0, &opaque, &seq_num)", (ossl_quic_srtm_lookup(srtm, &token_2, 0, &opaque, &seq_num)) != 0)
       )
        goto err;
