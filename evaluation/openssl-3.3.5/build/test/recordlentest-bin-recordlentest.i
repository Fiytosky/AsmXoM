# 0 "../test/recordlentest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/recordlentest.c"
# 10 "../test/recordlentest.c"
...
# 14 "../test/recordlentest.c" 2

static char *cert = 
# 15 "../test/recordlentest.c" 3 4
                   ((void *)0)
# 15 "../test/recordlentest.c"
                       ;
static char *privkey = 
# 16 "../test/recordlentest.c" 3 4
                      ((void *)0)
# 16 "../test/recordlentest.c"
                          ;
# 27 "../test/recordlentest.c"
static int write_record(BIO *b, size_t len, uint8_t rectype, int recversion)
{
    ...
    if (!BIO_write_ex(b, header, 5, &written)
            || written != 5)
        return 0;
...
{
    SSL_CTX *cctx = 
# 82 "../test/recordlentest.c" 3 4
                   ((void *)0)
# 82 "../test/recordlentest.c"
                       , *sctx = 
# 82 "../test/recordlentest.c" 3 4
                                 ((void *)0)
# 82 "../test/recordlentest.c"
                                     ;
    SSL *clientssl = 
# 83 "../test/recordlentest.c" 3 4
                    ((void *)0)
# 83 "../test/recordlentest.c"
                        , *serverssl = 
# 83 "../test/recordlentest.c" 3 4
                                       ((void *)0)
# 83 "../test/recordlentest.c"
    ...
    BIO *serverbio;
    int recversion;
# 104 "../test/recordlentest.c"
    if (!test_true("../test/recordlentest.c", 104, "create_ssl_ctx_pair(NULL, TLS_server_method(), TLS_client_method(), TLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 104 "../test/recordlentest.c" 3 4
        ((void *)0)
# 104 "../test/recordlentest.c"
    ...
    if (idx == 4
            || idx == 5) {
        len = ((256 + 64)+(16384 +1024));

        len -= 1024;

        SSL_CTX_ctrl(sctx, 124, 0x0303, 
# 116 "../test/recordlentest.c" 3 4
       ((void *)0)
# 116 "../test/recordlentest.c"
       );
    } else if (idx == 2
               || idx == 3) {
        len = (16384 + 256);
    ...
    if (!test_true("../test/recordlentest.c", 122, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 122 "../test/recordlentest.c" 3 4
        ((void *)0)
# 122 "../test/recordlentest.c"
        , 
# 122 "../test/recordlentest.c" 3 4
        ((void *)0)
# 122 "../test/recordlentest.c"
    ...
    if (idx == 0
        ...
        if (!test_true("../test/recordlentest.c", 135, "write_record(serverbio, len, SSL3_RT_HANDSHAKE, TLS1_VERSION)", (write_record(serverbio, len, 22, 0x0301)) != 0)
                                                                     )
            goto end;

        if (!test_int_le("../test/recordlentest.c", 139, "SSL_accept(serverssl)", "0", SSL_accept(serverssl), 0))
            goto end;

        overf_expected = (idx == 0) ? 0 : 1;
        if (!test_int_eq("../test/recordlentest.c", 143, "fail_due_to_record_overflow(0)", "overf_expected", fail_due_to_record_overflow(0), overf_expected))
            goto end;

        goto success;
    }

    if (!test_true("../test/recordlentest.c", 149, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0)
                                                         )
        goto end;
    ...
    if (!test_true("../test/recordlentest.c", 163, "write_record(serverbio, len, SSL3_RT_APPLICATION_DATA, recversion)", (write_record(serverbio, len, 23, recversion)) != 0)
                                            )
        goto end;

    if (!test_false("../test/recordlentest.c", 167, "SSL_read_ex(serverssl, &buf, sizeof(buf), &written)", (SSL_read_ex(serverssl, &buf, sizeof(buf), &written)) != 0))
        goto end;

    if (!test_int_eq("../test/recordlentest.c", 170, "fail_due_to_record_overflow(1)", "overf_expected", fail_due_to_record_overflow(1), overf_expected))
        goto end;
...
# 184 "../test/recordlentest.c" 3 4
((void *)0) 
# 184 "../test/recordlentest.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/recordlentest.c", 189, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/recordlentest.c", 193, "cert = test_get_argument(0)", cert = test_get_argument(0))
            || !test_ptr("../test/recordlentest.c", 194, "privkey = test_get_argument(1)", privkey = test_get_argument(1)))
        return 0;
