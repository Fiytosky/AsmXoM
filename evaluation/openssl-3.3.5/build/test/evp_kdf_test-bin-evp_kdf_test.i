# 0 "../test/evp_kdf_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_kdf_test.c"
# 13 "../test/evp_kdf_test.c"
...
# 18 "../test/evp_kdf_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 19 "../test/evp_kdf_test.c" 2
...
# 21 "../test/evp_kdf_test.c" 2


static EVP_KDF_CTX *get_kdfbyname_libctx(OSSL_LIB_CTX *libctx, const char *name)
{
    EVP_KDF *kdf = EVP_KDF_fetch(libctx, name, 
# 25 "../test/evp_kdf_test.c" 3 4
                                              ((void *)0)
# 25 "../test/evp_kdf_test.c"
                                                  );
...
{
    return get_kdfbyname_libctx(
# 34 "../test/evp_kdf_test.c" 3 4
                               ((void *)0)
# 34 "../test/evp_kdf_test.c"
                                   , name);
}
...
static OSSL_PARAM *construct_tls1_prf_params(const char *digest, const char *secret,
    const char *seed)
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 4, "../test/evp_kdf_test.c", 40);
    OSSL_PARAM *p = params;

    if (params == 
# 43 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 43 "../test/evp_kdf_test.c"
                     )
        return 
# 44 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 44 "../test/evp_kdf_test.c"
                  ;

    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)digest, 0);
    *p++ = OSSL_PARAM_construct_octet_string("secret",
                                             (unsigned char *)secret,
                                             strlen(secret));
    *p++ = OSSL_PARAM_construct_octet_string("seed",
                                             (unsigned char *)seed,
                                             strlen(seed));
...
static int test_kdf_tls1_prf(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 62 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 62 "../test/evp_kdf_test.c"
                           ;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 72, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 73, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_int_gt("../test/evp_kdf_test.c", 74, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 75, "out", "expected", out, sizeof(out), expected, sizeof(expected));

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 78);
    return ret;
}
...
static int test_kdf_tls1_prf_invalid_digest(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 85 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 85 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM *params;

    params = construct_tls1_prf_params("blah", "secret", "seed");

    ret = test_ptr("../test/evp_kdf_test.c", 90, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 91, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_false("../test/evp_kdf_test.c", 92, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 95);
    return ret;
}
...
static int test_kdf_tls1_prf_zero_output_size(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 102 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 102 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[16];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 109, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 110, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_true("../test/evp_kdf_test.c", 111, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        && test_int_eq("../test/evp_kdf_test.c", 112, "EVP_KDF_derive(kctx, out, 0, NULL)", "0", EVP_KDF_derive(kctx, out, 0, 
# 112 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 112 "../test/evp_kdf_test.c"
          ), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 115);
    return ret;
}
...
static int test_kdf_tls1_prf_empty_secret(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 122 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 122 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[16];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 128, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 129, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_int_gt("../test/evp_kdf_test.c", 130, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 133);
    return ret;
}
...
static int test_kdf_tls1_prf_1byte_secret(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 140 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 140 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[16];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 146, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 147, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_int_gt("../test/evp_kdf_test.c", 148, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 151);
    return ret;
}
...
static int test_kdf_tls1_prf_empty_seed(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 158 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 158 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[16];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 165, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 166, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_true("../test/evp_kdf_test.c", 167, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        && test_int_eq("../test/evp_kdf_test.c", 168, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 168 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 168 "../test/evp_kdf_test.c"
          ), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 171);
    return ret;
}
...
static int test_kdf_tls1_prf_1byte_seed(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 178 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 178 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[16];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 184, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 185, "kctx = get_kdfbyname(OSSL_KDF_NAME_TLS1_PRF)", kctx = get_kdfbyname("TLS1-PRF"))
        && test_int_gt("../test/evp_kdf_test.c", 186, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 189);
    return ret;
}
...
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 5, "../test/evp_kdf_test.c", 196);
    OSSL_PARAM *p = params;

    if (params == 
# 199 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 199 "../test/evp_kdf_test.c"
                     )
        return 
# 200 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 200 "../test/evp_kdf_test.c"
                  ;

    if (digest != 
# 202 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 202 "../test/evp_kdf_test.c"
                     )
        *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                                digest, 0);
    ...
    *p++ = OSSL_PARAM_construct_octet_string("key",
    ...
    if (info != 
# 209 "../test/evp_kdf_test.c" 3 4
               ((void *)0)
# 209 "../test/evp_kdf_test.c"
                   )
...
static int test_kdf_hkdf(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 223 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 223 "../test/evp_kdf_test.c"
                           ;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 232, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 233, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 234, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 235, "out", "expected", out, sizeof(out), expected, sizeof(expected));

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 238);
    return ret;
}
...
static int do_kdf_hkdf_gettables(int expand_only, int has_digest)
{
    ...
    EVP_KDF_CTX *kctx = 
# 249 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 249 "../test/evp_kdf_test.c"
                           ;

    if (!test_ptr("../test/evp_kdf_test.c", 251, "params = construct_hkdf_params( has_digest ? \"sha256\" : NULL, \"secret\", 6, \"salt\", expand_only ? NULL : \"label\")", params = construct_hkdf_params( has_digest ? "sha256" : 
# 251 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 251 "../test/evp_kdf_test.c"
        , "secret", 6, "salt", expand_only ? 
# 251 "../test/evp_kdf_test.c" 3 4
        ((void *)0) 
# 251 "../test/evp_kdf_test.c"
        : "label"))
        ...
        || !test_ptr("../test/evp_kdf_test.c", 255, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        || !test_true("../test/evp_kdf_test.c", 256, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0))
        goto err;


    if (!test_ptr("../test/evp_kdf_test.c", 260, "gettables = EVP_KDF_CTX_gettable_params(kctx)", gettables = EVP_KDF_CTX_gettable_params(kctx))
        || !test_ptr("../test/evp_kdf_test.c", 261, "p = OSSL_PARAM_locate_const(gettables, OSSL_KDF_PARAM_SIZE)", p = OSSL_PARAM_locate_const(gettables, "size")))
        goto err;


    params_get[0] = OSSL_PARAM_construct_size_t("size", &sz);
    params_get[1] = OSSL_PARAM_construct_end();
    if (has_digest) {
        if (!test_int_eq("../test/evp_kdf_test.c", 268, "EVP_KDF_CTX_get_params(kctx, params_get)", "1", EVP_KDF_CTX_get_params(kctx, params_get), 1)
            || !test_size_t_eq("../test/evp_kdf_test.c", 269, "sz", "expand_only ? SHA256_DIGEST_LENGTH : SIZE_MAX", sz, expand_only ? 32 : 
# 269 "../test/evp_kdf_test.c" 3 4
               (18446744073709551615UL)
# 269 "../test/evp_kdf_test.c"
               ))
            goto err;
    } else {
        if (!test_int_eq("../test/evp_kdf_test.c", 272, "EVP_KDF_CTX_get_params(kctx, params_get)", "0", EVP_KDF_CTX_get_params(kctx, params_get), 0))
            goto err;
    }


    params_get[0] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 278, "EVP_KDF_CTX_get_params(kctx, params_get)", "-2", EVP_KDF_CTX_get_params(kctx, params_get), -2))
        goto err;
    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 283);
    return ret;
}
...
static int test_kdf_hkdf_invalid_digest(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 305 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 305 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM *params;

    params = construct_hkdf_params("blah", "secret", 6, "salt", "label");

    ret = test_ptr("../test/evp_kdf_test.c", 310, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 311, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_false("../test/evp_kdf_test.c", 312, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 315);
    return ret;
}
...
static int test_kdf_hkdf_derive_set_params_fail(void)
{
    int ret = 0, i = 0;
    EVP_KDF_CTX *kctx = 
# 322 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 322 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM params[2];
    unsigned char out[10];

    if (!test_ptr("../test/evp_kdf_test.c", 326, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF")))
        goto end;




    params[0] = OSSL_PARAM_construct_int("digest", &i);
    params[1] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 334, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0))
        goto end;
    ret = 1;
end:
    EVP_KDF_CTX_free(kctx);
...
static int test_kdf_hkdf_set_invalid_mode(void)
{
    ...
    EVP_KDF_CTX *kctx = 
# 345 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 345 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM params[2];

    if (!test_ptr("../test/evp_kdf_test.c", 348, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF")))
        goto end;
    params[0] = OSSL_PARAM_construct_utf8_string("mode",
                                                 "BADMODE", 0);
    params[1] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 353, "EVP_KDF_CTX_set_params(kctx, params)", "0", EVP_KDF_CTX_set_params(kctx, params), 0))
        goto end;

    params[0] = OSSL_PARAM_construct_int("mode", &bad_mode);
    if (!test_int_eq("../test/evp_kdf_test.c", 357, "EVP_KDF_CTX_set_params(kctx, params)", "0", EVP_KDF_CTX_set_params(kctx, params), 0))
        goto end;
...
static int do_kdf_hkdf_set_invalid_param(const char *key, int type)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 369 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 369 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM params[2];
    unsigned char buf[2];

    if (!test_ptr("../test/evp_kdf_test.c", 373, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF")))
        goto end;
    ...
    params[1] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 381, "EVP_KDF_CTX_set_params(kctx, params)", "0", EVP_KDF_CTX_set_params(kctx, params), 0))
        goto end;
...
{
    return do_kdf_hkdf_set_invalid_param("mode",
                                         5)
           && do_kdf_hkdf_set_invalid_param("key",
                                            4)
           && do_kdf_hkdf_set_invalid_param("salt",
                                            4)
           && do_kdf_hkdf_set_invalid_param("info",
                                            4);
}
...
static int test_kdf_hkdf_zero_output_size(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 405 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 405 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[10];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 412, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 413, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_true("../test/evp_kdf_test.c", 414, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        && test_int_eq("../test/evp_kdf_test.c", 415, "EVP_KDF_derive(kctx, out, 0, NULL)", "0", EVP_KDF_derive(kctx, out, 0, 
# 415 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 415 "../test/evp_kdf_test.c"
          ), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 418);
    return ret;
}
...
static int test_kdf_hkdf_empty_key(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 425 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 425 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[10];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 431, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 432, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 433, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 436);
    return ret;
}
...
static int test_kdf_hkdf_1byte_key(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 443 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 443 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[10];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 449, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 450, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 451, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 454);
    return ret;
}
...
static int test_kdf_hkdf_empty_salt(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 461 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 461 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[10];
    OSSL_PARAM *params;
    ...
    ret = test_ptr("../test/evp_kdf_test.c", 467, "params", params)
        && test_ptr("../test/evp_kdf_test.c", 468, "kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)", kctx = get_kdfbyname("HKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 469, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 472);
    return ret;
}
...
static OSSL_PARAM *construct_pbkdf1_params(char *pass, char *digest, char *salt,
    unsigned int *iter)
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 5, "../test/evp_kdf_test.c", 479);
    OSSL_PARAM *p = params;

    if (params == 
# 482 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 482 "../test/evp_kdf_test.c"
                     )
        return 
# 483 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 483 "../test/evp_kdf_test.c"
                  ;

    *p++ = OSSL_PARAM_construct_octet_string("pass",
...
static int test_kdf_pbkdf1(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 500 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 500 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    unsigned int iterations = 4096;
    OSSL_LIB_CTX *libctx = 
# 503 "../test/evp_kdf_test.c" 3 4
                          ((void *)0)
# 503 "../test/evp_kdf_test.c"
                              ;
    OSSL_PARAM *params = 
# 504 "../test/evp_kdf_test.c" 3 4
                        ((void *)0)
# 504 "../test/evp_kdf_test.c"
                            ;
    OSSL_PROVIDER *legacyprov = 
# 505 "../test/evp_kdf_test.c" 3 4
                               ((void *)0)
# 505 "../test/evp_kdf_test.c"
                                   ;
    OSSL_PROVIDER *defprov = 
# 506 "../test/evp_kdf_test.c" 3 4
                            ((void *)0)
# 506 "../test/evp_kdf_test.c"
                                ;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 513, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new()))
        goto err;


    legacyprov = OSSL_PROVIDER_load(libctx, "legacy");
    if (legacyprov == 
# 518 "../test/evp_kdf_test.c" 3 4
                     ((void *)0)
# 518 "../test/evp_kdf_test.c"
                         ) {
        OSSL_LIB_CTX_free(libctx);
        return test_skip("../test/evp_kdf_test.c", 520, "PBKDF1 only available in legacy provider");
    }

    if (!test_ptr("../test/evp_kdf_test.c", 523, "defprov = OSSL_PROVIDER_load(libctx, \"default\")", defprov = OSSL_PROVIDER_load(libctx, "default")))
        goto err;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 530, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 531, "kctx = get_kdfbyname_libctx(libctx, OSSL_KDF_NAME_PBKDF1)", kctx = get_kdfbyname_libctx(libctx, "PBKDF1"))
        || !test_true("../test/evp_kdf_test.c", 532, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        || !test_int_gt("../test/evp_kdf_test.c", 533, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 533 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 533 "../test/evp_kdf_test.c"
           ), 0)
        || !test_mem_eq("../test/evp_kdf_test.c", 534, "out", "expected", out, sizeof(out), expected, sizeof(expected)))
        goto err;

    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 540);
...
static int test_kdf_pbkdf1_key_too_long(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 550 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 550 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[64 + 1];
    unsigned int iterations = 4096;
    OSSL_LIB_CTX *libctx = 
# 553 "../test/evp_kdf_test.c" 3 4
                          ((void *)0)
# 553 "../test/evp_kdf_test.c"
                              ;
    OSSL_PARAM *params = 
# 554 "../test/evp_kdf_test.c" 3 4
                        ((void *)0)
# 554 "../test/evp_kdf_test.c"
                            ;
    OSSL_PROVIDER *legacyprov = 
# 555 "../test/evp_kdf_test.c" 3 4
                               ((void *)0)
# 555 "../test/evp_kdf_test.c"
                                   ;
    OSSL_PROVIDER *defprov = 
# 556 "../test/evp_kdf_test.c" 3 4
                            ((void *)0)
# 556 "../test/evp_kdf_test.c"
                                ;

    if (!test_ptr("../test/evp_kdf_test.c", 558, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new()))
        goto err;


    legacyprov = OSSL_PROVIDER_load(libctx, "legacy");
    if (legacyprov == 
# 563 "../test/evp_kdf_test.c" 3 4
                     ((void *)0)
# 563 "../test/evp_kdf_test.c"
                         ) {
        OSSL_LIB_CTX_free(libctx);
        return test_skip("../test/evp_kdf_test.c", 565, "PBKDF1 only available in legacy provider");
    }

    if (!test_ptr("../test/evp_kdf_test.c", 568, "defprov = OSSL_PROVIDER_load(libctx, \"default\")", defprov = OSSL_PROVIDER_load(libctx, "default")))
        goto err;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 580, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 581, "kctx = get_kdfbyname_libctx(libctx, OSSL_KDF_NAME_PBKDF1)", kctx = get_kdfbyname_libctx(libctx, "PBKDF1"))
        || !test_true("../test/evp_kdf_test.c", 582, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        || !test_int_eq("../test/evp_kdf_test.c", 583, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 583 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 583 "../test/evp_kdf_test.c"
           ), 0))
        goto err;
...
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 589);
    OSSL_PROVIDER_unload(defprov);
    OSSL_PROVIDER_unload(legacyprov);
    OSSL_LIB_CTX_free(libctx);
    return ret;
...
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 6, "../test/evp_kdf_test.c", 599);
    OSSL_PARAM *p = params;

    if (params == 
# 602 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 602 "../test/evp_kdf_test.c"
                     )
        return 
# 603 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 603 "../test/evp_kdf_test.c"
                  ;
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                             digest, 0);
    *p++ = OSSL_PARAM_construct_int("pkcs5", mode);
    *p = OSSL_PARAM_construct_end();
...
static int test_kdf_pbkdf2(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 621 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 621 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    unsigned int iterations = 4096;
    int mode = 0;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 637, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 638, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))
        || !test_int_gt("../test/evp_kdf_test.c", 639, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        || !test_mem_eq("../test/evp_kdf_test.c", 640, "out", "expected", out, sizeof(out), expected, sizeof(expected)))
        goto err;

    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 646);
    return ret;
}
...
static int test_kdf_pbkdf2_small_output(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 653 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 653 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    unsigned int iterations = 4096;
    int mode = 0;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 663, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 664, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))
        || !test_true("../test/evp_kdf_test.c", 665, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)

        || !test_int_eq("../test/evp_kdf_test.c", 667, "EVP_KDF_derive(kctx, out, 112 / 8 - 1, NULL)", "0", EVP_KDF_derive(kctx, out, 112 / 8 - 1, 
# 667 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 667 "../test/evp_kdf_test.c"
           ), 0))
        goto err;
...
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 673);
    return ret;
}
...
static int test_kdf_pbkdf2_large_output(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 680 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 680 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    size_t len = 0;
    unsigned int iterations = 4096;
    ...
    if (sizeof(len) > 32)
        len = 
# 688 "../test/evp_kdf_test.c" 3 4
             (18446744073709551615UL)
# 688 "../test/evp_kdf_test.c"
                     ;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 694, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 695, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_true("../test/evp_kdf_test.c", 697, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        || (len != 0 && !test_int_eq("../test/evp_kdf_test.c", 698, "EVP_KDF_derive(kctx, out, len, NULL)", "0", EVP_KDF_derive(kctx, out, len, 
# 698 "../test/evp_kdf_test.c" 3 4
                        ((void *)0)
# 698 "../test/evp_kdf_test.c"
                        ), 0)))
        goto err;
...
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 704);
    return ret;
}
...
static int test_kdf_pbkdf2_small_salt(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 711 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 711 "../test/evp_kdf_test.c"
                           ;
    unsigned int iterations = 4096;
    int mode = 0;
    OSSL_PARAM *params;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 720, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 721, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_false("../test/evp_kdf_test.c", 723, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0))
        goto err;

    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 729);
    return ret;
}
...
static int test_kdf_pbkdf2_small_iterations(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 736 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 736 "../test/evp_kdf_test.c"
                           ;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 745, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 746, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_false("../test/evp_kdf_test.c", 748, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0))
        goto err;

    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 754);
    return ret;
}
...
static int test_kdf_pbkdf2_small_salt_pkcs5(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 761 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 761 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    unsigned int iterations = 4096;
    int mode = 1;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 772, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 773, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_true("../test/evp_kdf_test.c", 775, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        || !test_int_gt("../test/evp_kdf_test.c", 776, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 776 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 776 "../test/evp_kdf_test.c"
           ), 0))
        goto err;

    mode = 0;
    mode_params[0] = OSSL_PARAM_construct_int("pkcs5", &mode);
    mode_params[1] = OSSL_PARAM_construct_end();


    if (!test_true("../test/evp_kdf_test.c", 784, "EVP_KDF_CTX_set_params(kctx, mode_params)", (EVP_KDF_CTX_set_params(kctx, mode_params)) != 0)
        || !test_int_eq("../test/evp_kdf_test.c", 785, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 785 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 785 "../test/evp_kdf_test.c"
           ), 0))
        goto err;
...
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 791);
    return ret;
}
...
static int test_kdf_pbkdf2_small_iterations_pkcs5(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 798 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 798 "../test/evp_kdf_test.c"
                           ;
    unsigned char out[25];
    unsigned int iterations = 1;
    int mode = 1;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 809, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 810, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_true("../test/evp_kdf_test.c", 812, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        || !test_int_gt("../test/evp_kdf_test.c", 813, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 813 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 813 "../test/evp_kdf_test.c"
           ), 0))
        goto err;
    ...
    if (!test_true("../test/evp_kdf_test.c", 821, "EVP_KDF_CTX_set_params(kctx, mode_params)", (EVP_KDF_CTX_set_params(kctx, mode_params)) != 0)
        || !test_int_eq("../test/evp_kdf_test.c", 822, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 822 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 822 "../test/evp_kdf_test.c"
           ), 0))
        goto err;
...
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 828);
    return ret;
}
...
static int test_kdf_pbkdf2_invalid_digest(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 835 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 835 "../test/evp_kdf_test.c"
                           ;
    unsigned int iterations = 4096;
    int mode = 0;
    OSSL_PARAM *params;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 844, "params", params)
        || !test_ptr("../test/evp_kdf_test.c", 845, "kctx = get_kdfbyname(OSSL_KDF_NAME_PBKDF2)", kctx = get_kdfbyname("PBKDF2"))

        || !test_false("../test/evp_kdf_test.c", 847, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0))
        goto err;

    ret = 1;
err:
    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 853);
    return ret;
}
...
static int test_kdf_scrypt(void)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_string("salt",
                                             (char *)"NaCl", 4);
    *p++ = OSSL_PARAM_construct_uint("n", &nu);
    *p++ = OSSL_PARAM_construct_uint("r", &ru);
    *p++ = OSSL_PARAM_construct_uint("p", &pu);
    *p++ = OSSL_PARAM_construct_uint("maxmem_bytes", &maxmem);
    *p = OSSL_PARAM_construct_end();

    ret = test_ptr("../test/evp_kdf_test.c", 886, "kctx = get_kdfbyname(OSSL_KDF_NAME_SCRYPT)", kctx = get_kdfbyname("SCRYPT"));
    for (i = 0; ret && i < 2; ++i) {
        ret = ret
            && test_true("../test/evp_kdf_test.c", 889, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);
        if (i == 0)
            ret = ret
                && test_int_le("../test/evp_kdf_test.c", 892, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 892 "../test/evp_kdf_test.c" 3 4
                  ((void *)0)
# 892 "../test/evp_kdf_test.c"
                  ), 0)
                && test_true("../test/evp_kdf_test.c", 893, "OSSL_PARAM_set_uint(p - 1, 10 * 1024 * 1024)", (OSSL_PARAM_set_uint(p - 1, 10 * 1024 * 1024)) != 0)
                && test_true("../test/evp_kdf_test.c", 894, "EVP_KDF_CTX_set_params(kctx, p - 1)", (EVP_KDF_CTX_set_params(kctx, p - 1)) != 0);
        ret = ret
            && test_int_gt("../test/evp_kdf_test.c", 896, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 896 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 896 "../test/evp_kdf_test.c"
              ), 0)
            && test_mem_eq("../test/evp_kdf_test.c", 897, "out", "expected", out, sizeof(out), expected, sizeof(expected));
        if (i == 0)
...
static int test_kdf_ss_hash(void)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)"sha224", 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", z, sizeof(z));
    *p++ = OSSL_PARAM_construct_octet_string("info", other,
                                             sizeof(other));
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 937, "kctx = get_kdfbyname(OSSL_KDF_NAME_SSKDF)", kctx = get_kdfbyname("SSKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 938, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 939, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_x963(void)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)"sha512", 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", z, sizeof(z));
    *p++ = OSSL_PARAM_construct_octet_string("info", shared,
                                             sizeof(shared));
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 990, "kctx = get_kdfbyname(OSSL_KDF_NAME_X963KDF)", kctx = get_kdfbyname("X963KDF"))
        && test_int_gt("../test/evp_kdf_test.c", 991, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 992, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_kbkdf_6803_128(void)
{
    ...
    for (i = 0; i < 3; i++) {
        ...
        params[p++] = OSSL_PARAM_construct_utf8_string(
            "cipher", "CAMELLIA-128-CBC", 0);
        params[p++] = OSSL_PARAM_construct_utf8_string(
            "mac", "CMAC", 0);
        params[p++] = OSSL_PARAM_construct_utf8_string(
            "mode", "FEEDBACK", 0);
        params[p++] = OSSL_PARAM_construct_octet_string(
            "key", input_key, sizeof(input_key));
        params[p++] = OSSL_PARAM_construct_octet_string(
            "salt", constants[i], sizeof(constants[i]));
        params[p++] = OSSL_PARAM_construct_octet_string(
            "seed", iv, sizeof(iv));
        params[p] = OSSL_PARAM_construct_end();

        kctx = get_kdfbyname("KBKDF");
        ret = test_ptr("../test/evp_kdf_test.c", 1045, "kctx", kctx)
            && test_int_gt("../test/evp_kdf_test.c", 1046, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)

            && test_mem_eq("../test/evp_kdf_test.c", 1048, "result", "outputs[i]", result, sizeof(result), outputs[i], sizeof(outputs[i]))
                                              ;
        EVP_KDF_CTX_free(kctx);
        if (ret != 1)
            return ret;
...
static int test_kdf_kbkdf_6803_256(void)
{
    ...
    for (i = 0; i < 3; i++) {
        ...
        kctx = get_kdfbyname("KBKDF");
        ret = test_ptr("../test/evp_kdf_test.c", 1111, "kctx", kctx)
            && test_int_gt("../test/evp_kdf_test.c", 1112, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)

            && test_mem_eq("../test/evp_kdf_test.c", 1114, "result", "outputs[i]", result, sizeof(result), outputs[i], sizeof(outputs[i]))
                                              ;
        EVP_KDF_CTX_free(kctx);
        if (ret != 1)
            return ret;
...
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 8, "../test/evp_kdf_test.c", 1128);
    OSSL_PARAM *p = params;

    if (params == 
# 1131 "../test/evp_kdf_test.c" 3 4
                 ((void *)0)
# 1131 "../test/evp_kdf_test.c"
                     )
        return 
# 1132 "../test/evp_kdf_test.c" 3 4
              ((void *)0)
# 1132 "../test/evp_kdf_test.c"
                  ;
...
static int test_kdf_kbkdf_invalid_digest(void)
{
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1163, "params", params))
        return 0;


    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1168, "kctx", kctx)
        && test_false("../test/evp_kdf_test.c", 1169, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1172);
    return ret;
}
...
static int test_kdf_kbkdf_invalid_mac(void)
{
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1186, "params", params))
        return 0;


    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1191, "kctx", kctx)
        && test_false("../test/evp_kdf_test.c", 1192, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1195);
    return ret;
}
...
static int test_kdf_kbkdf_invalid_r(void)
{
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1209, "params", params))
        return 0;


    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1214, "kctx", kctx)
        && test_false("../test/evp_kdf_test.c", 1215, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1218);
    return ret;
}
...
static int test_kdf_kbkdf_empty_key(void)
{
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1234, "params", params))
        return 0;


    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1239, "kctx", kctx)
        && test_true("../test/evp_kdf_test.c", 1240, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        && test_int_eq("../test/evp_kdf_test.c", 1241, "EVP_KDF_derive(kctx, result, sizeof(result), NULL)", "0", EVP_KDF_derive(kctx, result, sizeof(result), 
# 1241 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1241 "../test/evp_kdf_test.c"
          ), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1244);
    return ret;
}
...
static int test_kdf_kbkdf_1byte_key(void)
{
    ...
    params = construct_kbkdf_params("sha256", "HMAC", key, 1, "prf", "test", &r);
    if (!test_ptr("../test/evp_kdf_test.c", 1259, "params", params))
        return 0;

    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1263, "kctx", kctx)
        && test_int_gt("../test/evp_kdf_test.c", 1264, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1267);
    return ret;
}
...
static int test_kdf_kbkdf_zero_output_size(void)
{
    ...
    params = construct_kbkdf_params("sha256", "HMAC", key, 1, "prf", "test", &r);
    if (!test_ptr("../test/evp_kdf_test.c", 1282, "params", params))
        return 0;


    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1287, "kctx", kctx)
        && test_true("../test/evp_kdf_test.c", 1288, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0)
        && test_int_eq("../test/evp_kdf_test.c", 1289, "EVP_KDF_derive(kctx, result, 0, NULL)", "0", EVP_KDF_derive(kctx, result, 0, 
# 1289 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1289 "../test/evp_kdf_test.c"
          ), 0);

    EVP_KDF_CTX_free(kctx);
    CRYPTO_free(params, "../test/evp_kdf_test.c", 1292);
    return ret;
}
...
static int test_kdf_kbkdf_8009_prf1(void)
{
    ...
    params[i++] = OSSL_PARAM_construct_octet_string(
        "key", input_key, sizeof(input_key));
    params[i++] = OSSL_PARAM_construct_octet_string(
        "salt", label, strlen(label));
    params[i++] = OSSL_PARAM_construct_octet_string(
        "info", prf_input, strlen(prf_input));
    params[i] = OSSL_PARAM_construct_end();

    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1330, "kctx", kctx)
        && test_int_gt("../test/evp_kdf_test.c", 1331, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1332, "result", "output", result, sizeof(result), output, sizeof(output));
...
static int test_kdf_kbkdf_8009_prf2(void)
{
    ...
    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1374, "kctx", kctx)
        && test_int_gt("../test/evp_kdf_test.c", 1375, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1376, "result", "output", result, sizeof(result), output, sizeof(output));
...
static int test_kdf_kbkdf_fixedinfo(void)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("cipher", cipher, 0);
    *p++ = OSSL_PARAM_construct_utf8_string("mac", mac, 0);
    *p++ = OSSL_PARAM_construct_utf8_string("mode", mode, 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", input_key,
                                             sizeof(input_key));
    *p++ = OSSL_PARAM_construct_octet_string("info",
                                             fixed_input, sizeof(fixed_input));
    *p++ = OSSL_PARAM_construct_int("use-l", &use_l);
    *p++ = OSSL_PARAM_construct_int("use-separator",
                                    &use_separator);
    *p = OSSL_PARAM_construct_end();

    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1433, "kctx", kctx)
        && test_int_gt("../test/evp_kdf_test.c", 1434, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1435, "result", "output", result, sizeof(result), output, sizeof(output));
...
static int test_kdf_kbkdf_kmac(void)
{
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    kctx = get_kdfbyname("KBKDF");
    ret = test_ptr("../test/evp_kdf_test.c", 1585, "kctx", kctx)
        && test_size_t_eq("../test/evp_kdf_test.c", 1586, "EVP_KDF_CTX_get_kdf_size(kctx)", "SIZE_MAX", EVP_KDF_CTX_get_kdf_size(kctx), 
# 1586 "../test/evp_kdf_test.c" 3 4
          (18446744073709551615UL)
# 1586 "../test/evp_kdf_test.c"
          )
        && test_int_gt("../test/evp_kdf_test.c", 1587, "EVP_KDF_derive(kctx, result, sizeof(result), params)", "0", EVP_KDF_derive(kctx, result, sizeof(result), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1588, "result", "output", result, sizeof(result), output, sizeof(output));
...
static int test_kdf_ss_hmac(void)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("mac",
                                            (char *)"HMAC", 0);
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)"sha256", 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", z, sizeof(z));
    *p++ = OSSL_PARAM_construct_octet_string("info", other,
                                             sizeof(other));
    *p++ = OSSL_PARAM_construct_octet_string("salt", salt,
                                             sizeof(salt));
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 1627, "kctx = get_kdfbyname(OSSL_KDF_NAME_SSKDF)", kctx = get_kdfbyname("SSKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 1628, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1629, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_ss_kmac(void)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_string("salt", salt,
                                             sizeof(salt));
    *p++ = OSSL_PARAM_construct_size_t("maclen", &mac_size);
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 1674, "kctx = get_kdfbyname(OSSL_KDF_NAME_SSKDF)", kctx = get_kdfbyname("SSKDF"))
        && test_size_t_eq("../test/evp_kdf_test.c", 1675, "EVP_KDF_CTX_get_kdf_size(kctx)", "0", EVP_KDF_CTX_get_kdf_size(kctx), 0)
        && test_int_eq("../test/evp_kdf_test.c", 1676, "EVP_KDF_CTX_set_params(kctx, params)", "1", EVP_KDF_CTX_set_params(kctx, params), 1)

        && (fips_provider_version_lt(
# 1678 "../test/evp_kdf_test.c" 3 4
                                    ((void *)0)
# 1678 "../test/evp_kdf_test.c"
                                        , 3, 0, 8)
            || test_size_t_eq("../test/evp_kdf_test.c", 1679, "EVP_KDF_CTX_get_kdf_size(kctx)", "SIZE_MAX", EVP_KDF_CTX_get_kdf_size(kctx), 
# 1679 "../test/evp_kdf_test.c" 3 4
              (18446744073709551615UL)
# 1679 "../test/evp_kdf_test.c"
              ))
        && test_int_gt("../test/evp_kdf_test.c", 1680, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 1680 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1680 "../test/evp_kdf_test.c"
          ), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1681, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_sshkdf(void)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)"sha256", 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", key,
                                             sizeof(key));
    *p++ = OSSL_PARAM_construct_octet_string("xcghash",
                                             xcghash, sizeof(xcghash));
    *p++ = OSSL_PARAM_construct_octet_string("session_id",
                                             sessid, sizeof(sessid));
    *p++ = OSSL_PARAM_construct_utf8_string("type",
                                            &kdftype, sizeof(kdftype));
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 1736, "kctx = get_kdfbyname(OSSL_KDF_NAME_SSHKDF)", kctx = get_kdfbyname("SSHKDF"))
        && test_int_gt("../test/evp_kdf_test.c", 1737, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1738, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdfs_same(EVP_KDF *kdf1, EVP_KDF *kdf2)
{
    ...
    return test_ptr_eq("../test/evp_kdf_test.c", 1755, "EVP_KDF_get0_provider(kdf1)", "EVP_KDF_get0_provider(kdf2)", EVP_KDF_get0_provider(kdf1), EVP_KDF_get0_provider(kdf2))
           && test_str_eq("../test/evp_kdf_test.c", 1756, "EVP_KDF_get0_name(kdf1)", "EVP_KDF_get0_name(kdf2)", EVP_KDF_get0_name(kdf1), EVP_KDF_get0_name(kdf2));
}

static int test_kdf_get_kdf(void)
{
    EVP_KDF *kdf1 = 
# 1761 "../test/evp_kdf_test.c" 3 4
                   ((void *)0)
# 1761 "../test/evp_kdf_test.c"
                       , *kdf2 = 
# 1761 "../test/evp_kdf_test.c" 3 4
                                 ((void *)0)
# 1761 "../test/evp_kdf_test.c"
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1765, "obj = OBJ_nid2obj(NID_id_pbkdf2)", obj = OBJ_nid2obj(69))
        || !test_ptr("../test/evp_kdf_test.c", 1766, "kdf1 = EVP_KDF_fetch(NULL, OSSL_KDF_NAME_PBKDF2, NULL)", kdf1 = EVP_KDF_fetch(
# 1766 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 1766 "../test/evp_kdf_test.c"
           , "PBKDF2", 
# 1766 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 1766 "../test/evp_kdf_test.c"
           ))
        || !test_ptr("../test/evp_kdf_test.c", 1767, "kdf2 = EVP_KDF_fetch(NULL, OBJ_nid2sn(OBJ_obj2nid(obj)), NULL)", kdf2 = EVP_KDF_fetch(
# 1767 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 1767 "../test/evp_kdf_test.c"
...
# 1767 "../test/evp_kdf_test.c"
    ...
    EVP_KDF_free(kdf1);
    kdf1 = 
# 1772 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1772 "../test/evp_kdf_test.c"
              ;
    EVP_KDF_free(kdf2);
    kdf2 = 
# 1774 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1774 "../test/evp_kdf_test.c"
              ;

    if (!test_ptr("../test/evp_kdf_test.c", 1776, "kdf1 = EVP_KDF_fetch(NULL, SN_tls1_prf, NULL)", kdf1 = EVP_KDF_fetch(
# 1776 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1776 "../test/evp_kdf_test.c"
        , "TLS1-PRF", 
# 1776 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1776 "../test/evp_kdf_test.c"
        ))
        || !test_ptr("../test/evp_kdf_test.c", 1777, "kdf2 = EVP_KDF_fetch(NULL, LN_tls1_prf, NULL)", kdf2 = EVP_KDF_fetch(
# 1777 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 1777 "../test/evp_kdf_test.c"
           , "tls1-prf", 
# 1777 "../test/evp_kdf_test.c" 3 4
           ((void *)0)
# 1777 "../test/evp_kdf_test.c"
    ...
    EVP_KDF_free(kdf2);
    kdf2 = 
# 1782 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1782 "../test/evp_kdf_test.c"
              ;

    if (!test_ptr("../test/evp_kdf_test.c", 1784, "kdf2 = EVP_KDF_fetch(NULL, OBJ_nid2sn(NID_tls1_prf), NULL)", kdf2 = EVP_KDF_fetch(
# 1784 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1784 "../test/evp_kdf_test.c"
        , OBJ_nid2sn(1021), 
# 1784 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1784 "../test/evp_kdf_test.c"
    ...
    EVP_KDF_free(kdf1);
    kdf1 = 
# 1788 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1788 "../test/evp_kdf_test.c"
              ;
    EVP_KDF_free(kdf2);
    kdf2 = 
# 1790 "../test/evp_kdf_test.c" 3 4
          ((void *)0)
# 1790 "../test/evp_kdf_test.c"
              ;
...
static int test_kdf_x942_asn1(void)
{
    int ret;
    EVP_KDF_CTX *kctx = 
# 1799 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 1799 "../test/evp_kdf_test.c"
                           ;
    OSSL_PARAM params[4], *p = params;
    const char *cek_alg = "id-smime-alg-CMS3DESwrap";
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)"sha1", 0);
    *p++ = OSSL_PARAM_construct_octet_string("key", z,
                                             sizeof(z));
    *p++ = OSSL_PARAM_construct_utf8_string("cekalg",
                                            (char *)cek_alg, 0);
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 1823, "kctx = get_kdfbyname(OSSL_KDF_NAME_X942KDF_ASN1)", kctx = get_kdfbyname("X942KDF-ASN1"))
        && test_int_gt("../test/evp_kdf_test.c", 1824, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1825, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_krb5kdf(void)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_string("key", key,
                                             sizeof(key));
    *p++ = OSSL_PARAM_construct_octet_string("constant",
                                             constant, sizeof(constant));
    *p = OSSL_PARAM_construct_end();

    ret =
        test_ptr("../test/evp_kdf_test.c", 1859, "kctx = get_kdfbyname(OSSL_KDF_NAME_KRB5KDF)", kctx = get_kdfbyname("KRB5KDF"))
        && test_int_gt("../test/evp_kdf_test.c", 1860, "EVP_KDF_derive(kctx, out, sizeof(out), params)", "0", EVP_KDF_derive(kctx, out, sizeof(out), params), 0)
        && test_mem_eq("../test/evp_kdf_test.c", 1861, "out", "expected", out, sizeof(out), expected, sizeof(expected));
...
static int test_kdf_hmac_drbg_settables(void)
{
    int ret = 0, i = 0, j = 0;
    EVP_KDF_CTX *kctx = 
# 1870 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 1870 "../test/evp_kdf_test.c"
                           ;
    ...
    char macname[32];
    EVP_MD *shake256 = 
# 1877 "../test/evp_kdf_test.c" 3 4
                      ((void *)0)
# 1877 "../test/evp_kdf_test.c"
                          ;


    if (!test_ptr("../test/evp_kdf_test.c", 1880, "kctx = get_kdfbyname(OSSL_KDF_NAME_HMACDRBGKDF)", kctx = get_kdfbyname("HMAC-DRBG-KDF"))
            || !test_ptr("../test/evp_kdf_test.c", 1881, "settableparams = EVP_KDF_CTX_settable_params(kctx)", settableparams = EVP_KDF_CTX_settable_params(kctx)))
        goto err;


    if (!test_int_le("../test/evp_kdf_test.c", 1885, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "0", EVP_KDF_derive(kctx, out, sizeof(out), 
# 1885 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1885 "../test/evp_kdf_test.c"
        ), 0))
        goto err;


    params[1] = OSSL_PARAM_construct_end();
    for (i = 0; settableparams[i].key != 
# 1890 "../test/evp_kdf_test.c" 3 4
                                        ((void *)0)
# 1890 "../test/evp_kdf_test.c"
                                            ; ++i) {
        ...
        if (OPENSSL_strcasecmp(settableparams[i].key,
            ...
            if (!test_int_le("../test/evp_kdf_test.c", 1896, "EVP_KDF_CTX_set_params(kctx, params)", "0", EVP_KDF_CTX_set_params(kctx, params), 0))
                goto err;
        }
    }

    params[0] = OSSL_PARAM_construct_octet_string("entropy",
                                                  (char *)ent, sizeof(ent));
    params[1] = OSSL_PARAM_construct_octet_string("nonce",
                                                  (char *)ent, sizeof(ent));
    params[2] = OSSL_PARAM_construct_utf8_string("digest", "SHA256",
                                                 0);
    params[3] = OSSL_PARAM_construct_utf8_string("properties", "",
                                                 0);
    params[4] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 1910, "EVP_KDF_CTX_set_params(kctx, params)", "1", EVP_KDF_CTX_set_params(kctx, params), 1))
        goto err;
    if (!test_int_eq("../test/evp_kdf_test.c", 1912, "EVP_KDF_CTX_set_params(kctx, params)", "1", EVP_KDF_CTX_set_params(kctx, params), 1))
        goto err;

    params[0] = OSSL_PARAM_construct_utf8_string("digest",
                                                 digestname, sizeof(digestname));
    params[1] = OSSL_PARAM_construct_utf8_string("mac",
                                                 macname, sizeof(macname));
    params[2] = OSSL_PARAM_construct_end();
    if (!test_int_eq("../test/evp_kdf_test.c", 1920, "EVP_KDF_CTX_get_params(kctx, params)", "1", EVP_KDF_CTX_get_params(kctx, params), 1)
            || !test_mem_eq("../test/evp_kdf_test.c", 1921, "digestname", "\"SHA2-256\"", digestname, params[0].return_size, "SHA2-256", 8)
            || !test_mem_eq("../test/evp_kdf_test.c", 1922, "macname", "\"HMAC\"", macname, params[1].return_size, "HMAC", 4))
        goto err;


    if (!test_int_eq("../test/evp_kdf_test.c", 1926, "EVP_KDF_derive(kctx, out, sizeof(out), NULL)", "1", EVP_KDF_derive(kctx, out, sizeof(out), 
# 1926 "../test/evp_kdf_test.c" 3 4
        ((void *)0)
# 1926 "../test/evp_kdf_test.c"
        ), 1))
        goto err;
    ...
    params[0] = OSSL_PARAM_construct_utf8_string("digest",
                                                 "shake256", 0);
    params[1] = OSSL_PARAM_construct_end();
    if (!test_int_le("../test/evp_kdf_test.c", 1933, "EVP_KDF_CTX_set_params(kctx, params)", "0", EVP_KDF_CTX_set_params(kctx, params), 0))
        goto err;
...
static int test_kdf_hmac_drbg_gettables(void)
{
    int ret = 0, i, j = 0;
    EVP_KDF_CTX *kctx = 
# 1946 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 1946 "../test/evp_kdf_test.c"
                           ;
    ...
    if (!test_ptr("../test/evp_kdf_test.c", 1952, "kctx = get_kdfbyname(OSSL_KDF_NAME_HMACDRBGKDF)", kctx = get_kdfbyname("HMAC-DRBG-KDF"))
            || !test_ptr("../test/evp_kdf_test.c", 1953, "gettableparams = EVP_KDF_CTX_gettable_params(kctx)", gettableparams = EVP_KDF_CTX_gettable_params(kctx)))
        goto err;

    params[1] = OSSL_PARAM_construct_end();
    for (i = 0; gettableparams[i].key != 
# 1957 "../test/evp_kdf_test.c" 3 4
                                        ((void *)0)
# 1957 "../test/evp_kdf_test.c"
                                            ; ++i) {
        params[0] = OSSL_PARAM_construct_int(gettableparams[i].key, &j);
        if (!test_int_le("../test/evp_kdf_test.c", 1959, "EVP_KDF_CTX_get_params(kctx, params)", "0", EVP_KDF_CTX_get_params(kctx, params), 0))
            goto err;
    }

    for (i = 0; gettableparams[i].key != 
# 1963 "../test/evp_kdf_test.c" 3 4
                                        ((void *)0)
# 1963 "../test/evp_kdf_test.c"
                                            ; ++i) {
        params[0] = OSSL_PARAM_construct_utf8_string(gettableparams[i].key,
                                                     buf, sizeof(buf));
        if (!test_int_le("../test/evp_kdf_test.c", 1966, "EVP_KDF_CTX_get_params(kctx, params)", "0", EVP_KDF_CTX_get_params(kctx, params), 0))
            goto err;
    }
    ret = 1;
err:
...
static int test_kbkdf_mac_change(void)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 1979 "../test/evp_kdf_test.c" 3 4
                       ((void *)0)
# 1979 "../test/evp_kdf_test.c"
                           ;
    ...
    params[0] = OSSL_PARAM_construct_utf8_string("mac",
                                                 "KMAC128", 0);
    params[1] = OSSL_PARAM_construct_end();
    if (!test_ptr("../test/evp_kdf_test.c", 2008, "kctx = get_kdfbyname(OSSL_KDF_NAME_KBKDF)", kctx = get_kdfbyname("KBKDF"))
            || !test_true("../test/evp_kdf_test.c", 2009, "EVP_KDF_CTX_set_params(kctx, params)", (EVP_KDF_CTX_set_params(kctx, params)) != 0))
        goto err;

    *p++ = OSSL_PARAM_construct_utf8_string("mode", "COUNTER", 0);
    *p++ = OSSL_PARAM_construct_utf8_string("mac", "HMAC", 0);
    *p++ = OSSL_PARAM_construct_utf8_string("digest", "SHA256", 0);
    *p++ = OSSL_PARAM_construct_int("use-l", &l);
    *p++ = OSSL_PARAM_construct_int("use-separator", &sep);
    *p++ = OSSL_PARAM_construct_int("r", &r);
    *p++ = OSSL_PARAM_construct_octet_string("key",
                                             key, sizeof(key));
    *p++ = OSSL_PARAM_construct_octet_string("info",
                                             info, sizeof(info));
    *p = OSSL_PARAM_construct_end();
    if (!test_true("../test/evp_kdf_test.c", 2023, "EVP_KDF_derive(kctx, out, sizeof(out), params)", (EVP_KDF_derive(kctx, out, sizeof(out), params)) != 0)
            || !test_mem_eq("../test/evp_kdf_test.c", 2024, "out", "output", out, sizeof(out), output, sizeof(output)))
        goto err;
...
int setup_tests(void)
{
    ...
    if (fips_provider_version_ge(
# 2052 "../test/evp_kdf_test.c" 3 4
                                ((void *)0)
# 2052 "../test/evp_kdf_test.c"
                                    , 3, 1, 0))
