...
# 19 "../test/mdc2test.c" 2
# 1 "../include/openssl/types.h" 1
# 20 "../test/mdc2test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../test/mdc2test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 50 "../test/mdc2test.c"
    ...
    OSSL_PROVIDER *prov = 
# 53 "../test/mdc2test.c" 3 4
                         ((void *)0)
# 53 "../test/mdc2test.c"
                             ;
    OSSL_PARAM params[2];

    params[i++] = OSSL_PARAM_construct_uint("pad-type",
                                            &pad_type),
    params[i++] = OSSL_PARAM_construct_end();

    prov = OSSL_PROVIDER_load(
# 60 "../test/mdc2test.c" 3 4
                             ((void *)0)
# 60 "../test/mdc2test.c"
                                 , "legacy");
    if (!test_ptr("../test/mdc2test.c", 61, "prov", prov))
        goto end;
    ...
    c = EVP_MD_CTX_new();
    if (!test_ptr("../test/mdc2test.c", 69, "c", c)
        || !test_true("../test/mdc2test.c", 70, "EVP_DigestInit_ex(c, EVP_mdc2(), NULL)", (EVP_DigestInit_ex(c, EVP_mdc2(), 
# 70 "../test/mdc2test.c" 3 4
           ((void *)0)
# 70 "../test/mdc2test.c"
           )) != 0)
        || !test_true("../test/mdc2test.c", 71, "EVP_DigestUpdate(c, (unsigned char *)text, tlen)", (EVP_DigestUpdate(c, (unsigned char *)text, tlen)) != 0)
        || !test_true("../test/mdc2test.c", 72, "EVP_DigestFinal_ex(c, &(md[0]), NULL)", (EVP_DigestFinal_ex(c, &(md[0]), 
# 72 "../test/mdc2test.c" 3 4
           ((void *)0)
# 72 "../test/mdc2test.c"
           )) != 0)
        || !test_mem_eq("../test/mdc2test.c", 73, "md", "pad1", md, 16, pad1, 16)
        || !test_true("../test/mdc2test.c", 74, "EVP_DigestInit_ex(c, EVP_mdc2(), NULL)", (EVP_DigestInit_ex(c, EVP_mdc2(), 
# 74 "../test/mdc2test.c" 3 4
           ((void *)0)
# 74 "../test/mdc2test.c"
           )) != 0))
        goto end;

    if (!test_int_gt("../test/mdc2test.c", 77, "EVP_MD_CTX_set_params(c, params)", "0", EVP_MD_CTX_set_params(c, params), 0)
        || !test_true("../test/mdc2test.c", 78, "EVP_DigestUpdate(c, (unsigned char *)text, tlen)", (EVP_DigestUpdate(c, (unsigned char *)text, tlen)) != 0)
        || !test_true("../test/mdc2test.c", 79, "EVP_DigestFinal_ex(c, &(md[0]), NULL)", (EVP_DigestFinal_ex(c, &(md[0]), 
# 79 "../test/mdc2test.c" 3 4
           ((void *)0)
# 79 "../test/mdc2test.c"
           )) != 0)
        || !test_mem_eq("../test/mdc2test.c", 80, "md", "pad2", md, 16, pad2, 16))
        goto end;
