...
# 15 "../test/v3nametest.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../test/v3nametest.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 34 "../test/v3nametest.c" 3 4
   ((void *)0)

# 35 "../test/v3nametest.c"
};
...
# 72 "../test/v3nametest.c" 3 4
   ((void *)0)

# 73 "../test/v3nametest.c"
};
...
static int set_cn(X509 *crt, ...)
{
    int ret = 0;
    X509_NAME *n = 
# 88 "../test/v3nametest.c" 3 4
                  ((void *)0)
# 88 "../test/v3nametest.c"
                      ;
    va_list ap;

    
# 91 "../test/v3nametest.c" 3 4
   __builtin_c23_va_start(
# 91 "../test/v3nametest.c"
   ap, crt
# 91 "../test/v3nametest.c" 3 4
   )
# 91 "../test/v3nametest.c"
    ...
    n = X509_NAME_new();
    if (n == 
# 93 "../test/v3nametest.c" 3 4
            ((void *)0)
# 93 "../test/v3nametest.c"
                )
        goto out;
    ...
    while (1) {
        ...
        nid = 
# 100 "../test/v3nametest.c" 3 4
             __builtin_va_arg(
# 100 "../test/v3nametest.c"
             ap
# 100 "../test/v3nametest.c" 3 4
             ,
# 100 "../test/v3nametest.c"
...
# 100 "../test/v3nametest.c"
        ...
        if (nid == 0)
            break;
        name = 
# 103 "../test/v3nametest.c" 3 4
              __builtin_va_arg(
# 103 "../test/v3nametest.c"
              ap
# 103 "../test/v3nametest.c" 3 4
              ,
# 103 "../test/v3nametest.c"
...
# 103 "../test/v3nametest.c"
                                      ;
        if (!X509_NAME_add_entry_by_NID(n, nid, (0x1000|1),
...
# 113 "../test/v3nametest.c" 3 4
   __builtin_va_end(
# 113 "../test/v3nametest.c"
   ap
# 113 "../test/v3nametest.c" 3 4
   )
# 113 "../test/v3nametest.c"
...
# 124 "../test/v3nametest.c"
static int set_altname(X509 *crt, ...)
{
    int ret = 0;
    GENERAL_NAMES *gens = 
# 127 "../test/v3nametest.c" 3 4
                         ((void *)0)
# 127 "../test/v3nametest.c"
                             ;
    GENERAL_NAME *gen = 
# 128 "../test/v3nametest.c" 3 4
                       ((void *)0)
# 128 "../test/v3nametest.c"
                           ;
    ASN1_IA5STRING *ia5 = 
# 129 "../test/v3nametest.c" 3 4
                         ((void *)0)
# 129 "../test/v3nametest.c"
                             ;
    va_list ap;
    
# 131 "../test/v3nametest.c" 3 4
   __builtin_c23_va_start(
# 131 "../test/v3nametest.c"
   ap, crt
# 131 "../test/v3nametest.c" 3 4
   )
# 131 "../test/v3nametest.c"
                    ;
    gens = ((struct stack_st_GENERAL_NAME *)OPENSSL_sk_new_null());
    if (gens == 
# 133 "../test/v3nametest.c" 3 4
               ((void *)0)
# 133 "../test/v3nametest.c"
                   )
        goto out;
    while (1) {
        int type;
        const char *name;
        type = 
# 138 "../test/v3nametest.c" 3 4
              __builtin_va_arg(
# 138 "../test/v3nametest.c"
              ap
# 138 "../test/v3nametest.c" 3 4
              ,
# 138 "../test/v3nametest.c"
...
# 138 "../test/v3nametest.c"
        ...
        if (type == 0)
            break;
        name = 
# 141 "../test/v3nametest.c" 3 4
              __builtin_va_arg(
# 141 "../test/v3nametest.c"
              ap
# 141 "../test/v3nametest.c" 3 4
              ,
# 141 "../test/v3nametest.c"
...
# 141 "../test/v3nametest.c"
        ...
        if (gen == 
# 144 "../test/v3nametest.c" 3 4
                  ((void *)0)
# 144 "../test/v3nametest.c"
                      )
            goto out;
        ia5 = ASN1_IA5STRING_new();
        if (ia5 == 
# 147 "../test/v3nametest.c" 3 4
                  ((void *)0)
# 147 "../test/v3nametest.c"
                      )
            goto out;
        ...
        case 2:
            ...
            ia5 = 
# 155 "../test/v3nametest.c" 3 4
                 ((void *)0)
# 155 "../test/v3nametest.c"
                     ;
            break;
        default:
            abort();
        }
        OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(gens), ossl_check_GENERAL_NAME_type(gen));
        gen = 
# 161 "../test/v3nametest.c" 3 4
             ((void *)0)
# 161 "../test/v3nametest.c"
                 ;
    }
    if (!X509_add1_ext_i2d(crt, 85, gens, 0, 0))
        goto out;
    ret = 1;
 out:
...
# 170 "../test/v3nametest.c" 3 4
   __builtin_va_end(
# 170 "../test/v3nametest.c"
   ap
# 170 "../test/v3nametest.c" 3 4
   )
# 170 "../test/v3nametest.c"
...
{
    return set_cn(crt, 13, name, 0);
}

static int set_cn_and_email(X509 *crt, const char *name)
{
    return set_cn(crt, 13, name,
                  48, "dummy@example.com", 0);
}

static int set_cn2(X509 *crt, const char *name)
{
    return set_cn(crt, 13, "dummy value",
                  13, name, 0);
}
...
{
    X509 *crt = 
# 252 "../test/v3nametest.c" 3 4
               ((void *)0)
# 252 "../test/v3nametest.c"
                   ;

    if (!test_ptr("../test/v3nametest.c", 254, "crt = X509_new()", crt = X509_new()))
        return 
# 255 "../test/v3nametest.c" 3 4
              ((void *)0)
# 255 "../test/v3nametest.c"
                  ;
    if (!test_true("../test/v3nametest.c", 256, "X509_set_version(crt, X509_VERSION_3)", (X509_set_version(crt, 2)) != 0)) {
        X509_free(crt);
        return 
# 258 "../test/v3nametest.c" 3 4
              ((void *)0)
# 258 "../test/v3nametest.c"
                  ;
    }
    return crt;
}
                         ...
                         const char *nameincert, int match, const char *name)
{
    ...
    if (is_exception(msg))
        return 1;
    test_error("../test/v3nametest.c", 275, "%s", msg);
    return 0;
}
                     ...
                     const struct set_name_fn *fn)
{
    ...
    for (; *pname != 
# 285 "../test/v3nametest.c" 3 4
                    ((void *)0)
# 285 "../test/v3nametest.c"
                        ; ++pname) {
        int samename = OPENSSL_strcasecmp(nameincert, *pname) == 0;
        size_t namelen = strlen(*pname);
        char *name = CRYPTO_malloc(namelen + 1, "../test/v3nametest.c", 288);
        int match, ret;

        if (!test_ptr("../test/v3nametest.c", 291, "name", name))
            return 0;
        memcpy(name, *pname, namelen + 1);

        match = -1;
        if (!test_int_ge("../test/v3nametest.c", 296, "ret = X509_check_host(crt, name, namelen, 0, NULL)", "0", ret = X509_check_host(crt, name, namelen, 0, 
# 296 "../test/v3nametest.c" 3 4
            ((void *)0)
# 296 "../test/v3nametest.c"
            ), 0)
                           ) {
            failed = 1;
        } else if (fn->host) {
            ...
            match = 1;
        if (!test_true("../test/v3nametest.c", 306, "check_message(fn, \"host\", nameincert, match, *pname)", (check_message(fn, "host", nameincert, match, *pname)) != 0))
            failed = 1;

        match = -1;
        if (!test_int_ge("../test/v3nametest.c", 310, "ret = X509_check_host(crt, name, namelen, X509_CHECK_FLAG_NO_WILDCARDS, NULL)", "0", ret = X509_check_host(crt, name, namelen, 0x2, 
# 310 "../test/v3nametest.c" 3 4
            ((void *)0)
# 310 "../test/v3nametest.c"
            ), 0)
            ...
            match = 1;
        if (!test_true("../test/v3nametest.c", 321, "check_message(fn, \"host-no-wildcards\", nameincert, match, *pname)", (check_message(fn, "host-no-wildcards", nameincert, match, *pname)) != 0)
                                                                )
            failed = 1;
...
# 330 "../test/v3nametest.c" 3 4
                                                              ((void *)0)
# 330 "../test/v3nametest.c"
                                                                  )
                match = 0;
        } else if (ret)
            match = 1;
        if (!test_true("../test/v3nametest.c", 334, "check_message(fn, \"email\", nameincert, match, *pname)", (check_message(fn, "email", nameincert, match, *pname)) != 0))
            failed = 1;
        CRYPTO_free(name, "../test/v3nametest.c", 336);
    }
...
static int call_run_cert(int i)
{
    ...
    test_info("../test/v3nametest.c", 349, "%s", pfn->name);
    for (pname = names; *pname != 
# 350 "../test/v3nametest.c" 3 4
                                 ((void *)0)
# 350 "../test/v3nametest.c"
                                     ; pname++) {
        if (!test_ptr("../test/v3nametest.c", 351, "crt = make_cert()", crt = make_cert())
             || !test_true("../test/v3nametest.c", 352, "pfn->fn(crt, *pname)", (pfn->fn(crt, *pname)) != 0)
...
# 559 "../test/v3nametest.c"
        {
            0xa5, 0x09, 0xa0, 0x02, 0x0c, 0x00, 0xa1, 0x03, 0x0c, 0x01, 0x61
        },
        11
    }, {
# 574 "../test/v3nametest.c"
        {
...
{
    size_t i, j;
    GENERAL_NAME **namesa = CRYPTO_malloc(sizeof(*namesa) * (sizeof(gennames)/sizeof((gennames)[0])), "../test/v3nametest.c", 661)
                                                                  ;
    GENERAL_NAME **namesb = CRYPTO_malloc(sizeof(*namesb) * (sizeof(gennames)/sizeof((gennames)[0])), "../test/v3nametest.c", 663)
                                                                  ;
    int testresult = 0;

    if (!test_ptr("../test/v3nametest.c", 667, "namesa", namesa) || !test_ptr("../test/v3nametest.c", 667, "namesb", namesb))
        goto end;

    for (i = 0; i < (sizeof(gennames)/sizeof((gennames)[0])); i++) {
        ...
        namesa[i] = d2i_GENERAL_NAME(
# 677 "../test/v3nametest.c" 3 4
                                    ((void *)0)
# 677 "../test/v3nametest.c"
                                        , &derp, gennames[i].derlen);
        derp = gennames[i].der;
        namesb[i] = d2i_GENERAL_NAME(
# 679 "../test/v3nametest.c" 3 4
                                    ((void *)0)
# 679 "../test/v3nametest.c"
                                        , &derp, gennames[i].derlen);
        if (!test_ptr("../test/v3nametest.c", 680, "namesa[i]", namesa[i]) || !test_ptr("../test/v3nametest.c", 680, "namesb[i]", namesb[i]))
            goto end;
    }


    for (i = 0; i < (sizeof(gennames)/sizeof((gennames)[0])); i++) {
        for (j = 0; j < (sizeof(gennames)/sizeof((gennames)[0])); j++) {
            if (i == j) {
                if (!test_int_eq("../test/v3nametest.c", 688, "GENERAL_NAME_cmp(namesa[i], namesb[j])", "0", GENERAL_NAME_cmp(namesa[i], namesb[j]), 0))
                    goto end;
            } else {
                if (!test_int_ne("../test/v3nametest.c", 691, "GENERAL_NAME_cmp(namesa[i], namesb[j])", "0", GENERAL_NAME_cmp(namesa[i], namesb[j]), 0))
                    goto end;
            }
        }
    }
    ...
    for (i = 0; i < (sizeof(gennames)/sizeof((gennames)[0])); i++) {
        if (namesa != 
# 700 "../test/v3nametest.c" 3 4
                     ((void *)0)
# 700 "../test/v3nametest.c"
                         )
            GENERAL_NAME_free(namesa[i]);
        if (namesb != 
# 702 "../test/v3nametest.c" 3 4
                     ((void *)0)
# 702 "../test/v3nametest.c"
                         )
            GENERAL_NAME_free(namesb[i]);
    }
    CRYPTO_free(namesa, "../test/v3nametest.c", 705);
    CRYPTO_free(namesb, "../test/v3nametest.c", 706);
...
int setup_tests(void)
{
    add_all_tests("call_run_cert", call_run_cert, (sizeof(name_fns)/sizeof((name_fns)[0])), 1);
    add_test("test_GENERAL_NAME_cmp", test_GENERAL_NAME_cmp);
    return 1;
}
