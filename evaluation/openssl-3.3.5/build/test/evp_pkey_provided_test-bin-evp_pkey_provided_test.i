# 0 "../test/evp_pkey_provided_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_pkey_provided_test.c"
# 10 "../test/evp_pkey_provided_test.c"
...
# 11 "../test/evp_pkey_provided_test.c" 2
...
# 12 "../test/evp_pkey_provided_test.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 13 "../test/evp_pkey_provided_test.c" 2
...
OSSL_ENCODER_CTX *OSSL_ENCODER_CTX_new_for_pkey(const EVP_PKEY *pkey,
                                                ...
                                                const char *propquery);
# 14 "../test/evp_pkey_provided_test.c" 2
...
# 15 "../test/evp_pkey_provided_test.c" 2
...
# 16 "../test/evp_pkey_provided_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../test/evp_pkey_provided_test.c" 2
...
# 19 "../test/evp_pkey_provided_test.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 20 "../test/evp_pkey_provided_test.c" 2
# 1 "../include/crypto/bn_dh.h" 1
# 15 "../include/crypto/bn_dh.h"
extern const BIGNUM ossl_bignum_dh1024_160_p; extern const BIGNUM ossl_bignum_dh1024_160_q; extern const BIGNUM ossl_bignum_dh1024_160_g;
extern const BIGNUM ossl_bignum_dh2048_224_p; extern const BIGNUM ossl_bignum_dh2048_224_q; extern const BIGNUM ossl_bignum_dh2048_224_g;
extern const BIGNUM ossl_bignum_dh2048_256_p; extern const BIGNUM ossl_bignum_dh2048_256_q; extern const BIGNUM ossl_bignum_dh2048_256_g;
...
# 21 "../test/evp_pkey_provided_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 22 "../test/evp_pkey_provided_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 23 "../test/evp_pkey_provided_test.c" 2

static char *datadir = 
# 24 "../test/evp_pkey_provided_test.c" 3 4
                      ((void *)0)
# 24 "../test/evp_pkey_provided_test.c"
                          ;
# 38 "../test/evp_pkey_provided_test.c"
...
static int compare_with_file(const char *alg, int type, BIO *membio)
{
    char filename[80];
    BIO *file = 
# 57 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 57 "../test/evp_pkey_provided_test.c"
                   ;
    char buf[4096];
    char *memdata, *fullfile = 
# 59 "../test/evp_pkey_provided_test.c" 3 4
                              ((void *)0)
# 59 "../test/evp_pkey_provided_test.c"
                                  ;
    const char *suffix;
    size_t readbytes;
    int ret = 0;
    ...
    default:
        test_error("../test/evp_pkey_provided_test.c", 92, "Invalid file type");
        goto err;
    }

    BIO_snprintf(filename, sizeof(filename), "%s.%s", alg, suffix);
    fullfile = test_mk_file_path(datadir, filename);
    if (!test_ptr("../test/evp_pkey_provided_test.c", 98, "fullfile", fullfile))
        goto err;

    file = BIO_new_file(fullfile, "rb");
    if (!test_ptr("../test/evp_pkey_provided_test.c", 102, "file", file))
        goto err;

    if (!test_true("../test/evp_pkey_provided_test.c", 105, "BIO_read_ex(file, buf, sizeof(buf), &readbytes)", (BIO_read_ex(file, buf, sizeof(buf), &readbytes)) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 106, "BIO_eof(file)", ((int)BIO_ctrl(file,2,0,
# 106 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 106 "../test/evp_pkey_provided_test.c"
               )) != 0)
            || !test_size_t_lt("../test/evp_pkey_provided_test.c", 107, "readbytes", "sizeof(buf)", readbytes, sizeof(buf)))
        goto err;

    len = BIO_ctrl(membio,3,0,(char *)(&memdata));
    if (!test_int_gt("../test/evp_pkey_provided_test.c", 111, "len", "0", len, 0))
        goto err;
    ...
    if (!test_mem_eq("../test/evp_pkey_provided_test.c", 120, "memdata", "buf", memdata, slen, buf, readbytes))
        goto err;

    ret = 1;
 err:
    CRYPTO_free(fullfile, "../test/evp_pkey_provided_test.c", 125);
    (void)(int)BIO_ctrl(membio,1,0,
# 126 "../test/evp_pkey_provided_test.c" 3 4
         ((void *)0)
# 126 "../test/evp_pkey_provided_test.c"
         );
    BIO_free(file);
    return ret;
}
...
static int test_print_key_using_pem(const char *alg, const EVP_PKEY *pk)
{
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 146, "membio", membio))
        goto err;

    if (
        !test_true("../test/evp_pkey_provided_test.c", 150, "PEM_write_bio_PrivateKey(bio_out, pk, EVP_aes_256_cbc(), (unsigned char *)\"pass\", 4, NULL, NULL)", (PEM_write_bio_PrivateKey(bio_out, pk, EVP_aes_256_cbc(), (unsigned char *)"pass", 4, 
# 150 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 150 "../test/evp_pkey_provided_test.c"
        , 
# 150 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 150 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 154, "PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), (const char *)~0, 0, NULL, NULL)", (PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), (const char *)~0, 0, 
# 154 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 154 "../test/evp_pkey_provided_test.c"
           , 
# 154 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 154 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 158, "PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), NULL, 0, NULL, \"\")", (PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), 
# 158 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 158 "../test/evp_pkey_provided_test.c"
           , 0, 
# 158 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 158 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 161, "PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), NULL, 0, pass_cb, NULL)", (PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), 
# 161 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 161 "../test/evp_pkey_provided_test.c"
           , 0, pass_cb, 
# 161 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 161 "../test/evp_pkey_provided_test.c"
        ...
        || !test_false("../test/evp_pkey_provided_test.c", 164, "PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), NULL, 0, pass_cb_error, NULL)", (PEM_write_bio_PKCS8PrivateKey(bio_out, pk, EVP_aes_256_cbc(), 
# 164 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 164 "../test/evp_pkey_provided_test.c"
           , 0, pass_cb_error, 
# 164 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 164 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 169, "PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, NID_pbe_WithSHA1And3_Key_TripleDES_CBC, (const char *)~0, 0, NULL, NULL)", (PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, 146, (const char *)~0, 0, 
# 169 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 169 "../test/evp_pkey_provided_test.c"
           , 
# 169 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 169 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 172, "PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, NID_pbe_WithSHA1And3_Key_TripleDES_CBC, NULL, 0, NULL, \"\")", (PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, 146, 
# 172 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 172 "../test/evp_pkey_provided_test.c"
           , 0, 
# 172 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 172 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 175, "PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, NID_pbe_WithSHA1And3_Key_TripleDES_CBC, NULL, 0, pass_cb, NULL)", (PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, 146, 
# 175 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 175 "../test/evp_pkey_provided_test.c"
           , 0, pass_cb, 
# 175 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 175 "../test/evp_pkey_provided_test.c"
        ...
        || !test_false("../test/evp_pkey_provided_test.c", 178, "PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, NID_pbe_WithSHA1And3_Key_TripleDES_CBC, NULL, 0, pass_cb_error, NULL)", (PEM_write_bio_PKCS8PrivateKey_nid( bio_out, pk, 146, 
# 178 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 178 "../test/evp_pkey_provided_test.c"
           , 0, pass_cb_error, 
# 178 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 178 "../test/evp_pkey_provided_test.c"
        ...
        || !test_int_gt("../test/evp_pkey_provided_test.c", 183, "EVP_PKEY_print_private(membio, pk, 0, NULL)", "0", EVP_PKEY_print_private(membio, pk, 0, 
# 183 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 183 "../test/evp_pkey_provided_test.c"
           ), 0)
        || !test_true("../test/evp_pkey_provided_test.c", 184, "compare_with_file(alg, PRIV_TEXT, membio)", (compare_with_file(alg, 0, membio)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 186, "PEM_write_bio_PUBKEY(membio, pk)", (PEM_write_bio_PUBKEY(membio, pk)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 187, "compare_with_file(alg, PUB_PEM, membio)", (compare_with_file(alg, 4, membio)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 189, "PEM_write_bio_PrivateKey(membio, pk, NULL, NULL, 0, NULL, NULL)", (PEM_write_bio_PrivateKey(membio, pk, 
# 189 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 189 "../test/evp_pkey_provided_test.c"
           , 
# 189 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 189 "../test/evp_pkey_provided_test.c"
...
# 189 "../test/evp_pkey_provided_test.c"
        ...
        || !test_true("../test/evp_pkey_provided_test.c", 191, "compare_with_file(alg, PRIV_PEM, membio)", (compare_with_file(alg, 1, membio)) != 0)

        || !test_false("../test/evp_pkey_provided_test.c", 193, "PEM_write_bio_PrivateKey(membio, NULL, NULL, NULL, 0, NULL, NULL)", (PEM_write_bio_PrivateKey(membio, 
# 193 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 193 "../test/evp_pkey_provided_test.c"
           , 
# 193 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 193 "../test/evp_pkey_provided_test.c"
...
# 193 "../test/evp_pkey_provided_test.c"
        ...
        || !test_false("../test/evp_pkey_provided_test.c", 195, "PEM_write_bio_PrivateKey_traditional(membio, NULL, NULL, NULL, 0, NULL, NULL)", (PEM_write_bio_PrivateKey_traditional(membio, 
# 195 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 195 "../test/evp_pkey_provided_test.c"
           , 
# 195 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 195 "../test/evp_pkey_provided_test.c"
...
# 210 "../test/evp_pkey_provided_test.c" 3 4
                           ((void *)0)
# 210 "../test/evp_pkey_provided_test.c"
                               ;
    BIO *membio = BIO_new(BIO_s_mem());
    int ret = 0;
    ...
    case 0:
        output_type = "TEXT";
        output_structure = 
# 217 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 217 "../test/evp_pkey_provided_test.c"
                              ;
        selection = ( 0x01 | 0x02 )
            | 0x04;
        break;
    ...
    case 3:
        output_type = "TEXT";
        output_structure = 
# 238 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 238 "../test/evp_pkey_provided_test.c"
                              ;
        selection = 0x02
            | 0x04;
        break;
    ...
    default:
        test_error("../test/evp_pkey_provided_test.c", 258, "Invalid encoding type");
        goto err;
    }

    if (!test_ptr("../test/evp_pkey_provided_test.c", 262, "membio", membio))
        goto err;


    test_note("Setting up a OSSL_ENCODER context with passphrase");
    if (!test_ptr("../test/evp_pkey_provided_test.c", 267, "ctx = OSSL_ENCODER_CTX_new_for_pkey(pk, selection, output_type, output_structure, NULL)", ctx = OSSL_ENCODER_CTX_new_for_pkey(pk, selection, output_type, output_structure, 
# 267 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 267 "../test/evp_pkey_provided_test.c"
        ))




        || !test_int_ne("../test/evp_pkey_provided_test.c", 272, "OSSL_ENCODER_CTX_get_num_encoders(ctx)", "0", OSSL_ENCODER_CTX_get_num_encoders(ctx), 0))
        goto err;


    test_note("Testing with no encryption");
    if (!test_true("../test/evp_pkey_provided_test.c", 277, "OSSL_ENCODER_to_bio(ctx, membio)", (OSSL_ENCODER_to_bio(ctx, membio)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 278, "compare_with_file(alg, type, membio)", (compare_with_file(alg, type, membio)) != 0))
        goto err;

    if (type == 1) {

        if (!test_true("../test/evp_pkey_provided_test.c", 283, "OSSL_ENCODER_CTX_set_passphrase(ctx, (unsigned char *)\"pass\", 4)", (OSSL_ENCODER_CTX_set_passphrase(ctx, (unsigned char *)"pass", 4)) != 0)
        ...
        if (!test_true("../test/evp_pkey_provided_test.c", 290, "OSSL_ENCODER_CTX_set_cipher(ctx, \"AES-256-CBC\", NULL)", (OSSL_ENCODER_CTX_set_cipher(ctx, "AES-256-CBC", 
# 290 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 290 "../test/evp_pkey_provided_test.c"
            )) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 291, "OSSL_ENCODER_to_bio(ctx, bio_out)", (OSSL_ENCODER_to_bio(ctx, bio_out)) != 0))
            goto err;


        test_note("NOT Displaying PEM encrypted with (invalid) FOO");
        if (!test_false("../test/evp_pkey_provided_test.c", 296, "OSSL_ENCODER_CTX_set_cipher(ctx, \"FOO\", NULL)", (OSSL_ENCODER_CTX_set_cipher(ctx, "FOO", 
# 296 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 296 "../test/evp_pkey_provided_test.c"
            )) != 0)
            || !test_false("../test/evp_pkey_provided_test.c", 297, "OSSL_ENCODER_to_bio(ctx, bio_out)", (OSSL_ENCODER_to_bio(ctx, bio_out)) != 0))
            goto err;


        test_note("Testing with encryption cleared (no encryption)");
        if (!test_true("../test/evp_pkey_provided_test.c", 302, "OSSL_ENCODER_CTX_set_cipher(ctx, NULL, NULL)", (OSSL_ENCODER_CTX_set_cipher(ctx, 
# 302 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 302 "../test/evp_pkey_provided_test.c"
            , 
# 302 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 302 "../test/evp_pkey_provided_test.c"
            )) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 303, "OSSL_ENCODER_to_bio(ctx, membio)", (OSSL_ENCODER_to_bio(ctx, membio)) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 304, "compare_with_file(alg, type, membio)", (compare_with_file(alg, type, membio)) != 0))
            goto err;
    }
    ret = 1;
err:
...
# 349 "../test/evp_pkey_provided_test.c"
static int test_fromdata_rsa(void)
{
    int ret = 0, i;
    EVP_PKEY_CTX *ctx = 
# 352 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 352 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 352 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 352 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 353 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 353 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 353 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 353 "../test/evp_pkey_provided_test.c"
...
# 353 "../test/evp_pkey_provided_test.c"
    ...
    OSSL_PARAM fromdata_params[] = {
        { (("n")), (2), ((&key_numbers[0])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("e")), (2), ((&key_numbers[1])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("d")), (2), ((&key_numbers[2])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("rsa-factor1")), (2), ((&key_numbers[3])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("rsa-factor2")), (2), ((&key_numbers[4])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("rsa-exponent1")), (2), ((&key_numbers[5])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("rsa-exponent2")), (2), ((&key_numbers[6])), (sizeof(unsigned long int)), ((size_t)-1) },
        { (("rsa-coefficient1")), (2), ((&key_numbers[7])), (sizeof(unsigned long int)), ((size_t)-1) },
        { 
# 379 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 379 "../test/evp_pkey_provided_test.c"
       , 0, 
# 379 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 379 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 384, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"RSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 384 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 384 "../test/evp_pkey_provided_test.c"
        , "RSA", 
# 384 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 384 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 387, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 388, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;

    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 394, "EVP_PKEY_get_bits(pk)", "32", EVP_PKEY_get_bits(pk), 32)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 395, "EVP_PKEY_get_security_bits(pk)", "8", EVP_PKEY_get_security_bits(pk), 8)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 396, "EVP_PKEY_get_size(pk)", "4", EVP_PKEY_get_size(pk), 4)
            || !test_false("../test/evp_pkey_provided_test.c", 397, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        EVP_PKEY_CTX_free(key_ctx);
        if (!test_ptr("../test/evp_pkey_provided_test.c", 401, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 401 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 401 "../test/evp_pkey_provided_test.c"
            , pk, "")))
            goto err;

        if (!test_int_gt("../test/evp_pkey_provided_test.c", 404, "EVP_PKEY_check(key_ctx)", "0", EVP_PKEY_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 405, "EVP_PKEY_public_check(key_ctx)", "0", EVP_PKEY_public_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 406, "EVP_PKEY_private_check(key_ctx)", "0", EVP_PKEY_private_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 407, "EVP_PKEY_pairwise_check(key_ctx)", "0", EVP_PKEY_pairwise_check(key_ctx), 0))
            goto err;


        if (!test_ptr("../test/evp_pkey_provided_test.c", 411, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())
            || !test_false("../test/evp_pkey_provided_test.c", 412, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 415 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 415 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 420 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 420 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 423, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 425, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
 ...
 err:
    ...
    for (i = 0; fromdata_params[i].key != 
# 433 "../test/evp_pkey_provided_test.c" 3 4
                                         ((void *)0)
# 433 "../test/evp_pkey_provided_test.c"
                                             ; ++i) {
        if (!test_true("../test/evp_pkey_provided_test.c", 434, "BN_set_word(bn_from, key_numbers[i])", (BN_set_word(bn_from, key_numbers[i])) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 435, "EVP_PKEY_get_bn_param(pk, fromdata_params[i].key, &bn)", (EVP_PKEY_get_bn_param(pk, fromdata_params[i].key, &bn)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 437, "bn", "bn_from", bn, bn_from))
            ret = 0;
    }
    BN_free(bn_from);
    BN_free(bn);
...
# 460 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 460 "../test/evp_pkey_provided_test.c"
                                       ;
    BIGNUM *check_bn = 
# 461 "../test/evp_pkey_provided_test.c" 3 4
                      ((void *)0)
# 461 "../test/evp_pkey_provided_test.c"
                          ;
    OSSL_PARAM *todata_params = 
# 462 "../test/evp_pkey_provided_test.c" 3 4
                               ((void *)0)
# 462 "../test/evp_pkey_provided_test.c"
                                   ;
    EVP_PKEY_CTX *ctx = 
# 463 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 463 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 463 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 463 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 464 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 464 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 464 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 464 "../test/evp_pkey_provided_test.c"
...
# 464 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 468, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"RSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 468 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 468 "../test/evp_pkey_provided_test.c"
        , "RSA", 
# 468 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 468 "../test/evp_pkey_provided_test.c"
        ))
        || !test_int_eq("../test/evp_pkey_provided_test.c", 469, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 470, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 478, "EVP_PKEY_todata(pk, EVP_PKEY_KEYPAIR, &todata_params)", "1", EVP_PKEY_todata(pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), &todata_params), 1))
        goto err;

    for (i = 0; check[i].pname != 
# 481 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 481 "../test/evp_pkey_provided_test.c"
                                     ; i++) {
        if (!test_ptr("../test/evp_pkey_provided_test.c", 482, "check_param = OSSL_PARAM_locate_const(todata_params, check[i].pname)", check_param = OSSL_PARAM_locate_const(todata_params, check[i].pname))
                                                                            )
            goto err;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 485, "OSSL_PARAM_get_BN(check_param, &check_bn)", "1", OSSL_PARAM_get_BN(check_param, &check_bn), 1))
            goto err;
        if (!test_BN_eq("../test/evp_pkey_provided_test.c", 487, "check_bn", "check[i].comparebn", check_bn, check[i].comparebn)) {
            test_info("../test/evp_pkey_provided_test.c", 488, "Data mismatch for parameter %s", check[i].pname);
            goto err;
        }
        BN_free(check_bn);
        check_bn = 
# 492 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 492 "../test/evp_pkey_provided_test.c"
                      ;
    }

    for (;;) {
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 496, "EVP_PKEY_get_bits(pk)", "expected_nbits", EVP_PKEY_get_bits(pk), expected_nbits)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 497, "EVP_PKEY_get_security_bits(pk)", "expected_sbits", EVP_PKEY_get_security_bits(pk), expected_sbits)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 498, "EVP_PKEY_get_size(pk)", "expected_ksize", EVP_PKEY_get_size(pk), expected_ksize)
            || !test_false("../test/evp_pkey_provided_test.c", 499, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        EVP_PKEY_CTX_free(key_ctx);
        if (!test_ptr("../test/evp_pkey_provided_test.c", 503, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 503 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 503 "../test/evp_pkey_provided_test.c"
            , pk, "")))
            goto err;

        if (!test_int_gt("../test/evp_pkey_provided_test.c", 506, "EVP_PKEY_check(key_ctx)", "0", EVP_PKEY_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 507, "EVP_PKEY_public_check(key_ctx)", "0", EVP_PKEY_public_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 508, "EVP_PKEY_private_check(key_ctx)", "0", EVP_PKEY_private_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 509, "EVP_PKEY_pairwise_check(key_ctx)", "0", EVP_PKEY_pairwise_check(key_ctx), 0))
            goto err;


        if (!test_ptr("../test/evp_pkey_provided_test.c", 513, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())
            || !test_false("../test/evp_pkey_provided_test.c", 514, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 517 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 517 "../test/evp_pkey_provided_test.c"
                     ;

        if (dup_pk != 
# 519 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 519 "../test/evp_pkey_provided_test.c"
                         )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 522, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 524, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1)) {
...
{
    OSSL_PARAM_BLD *bld = 
# 544 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 544 "../test/evp_pkey_provided_test.c"
                             ;
    BIGNUM *n = 
# 545 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 545 "../test/evp_pkey_provided_test.c"
                   , *e = 
# 545 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 545 "../test/evp_pkey_provided_test.c"
...
# 545 "../test/evp_pkey_provided_test.c"
                                                               ;
    BIGNUM *dmp1 = 
# 546 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 546 "../test/evp_pkey_provided_test.c"
                      , *dmq1 = 
# 546 "../test/evp_pkey_provided_test.c" 3 4
                                ((void *)0)
# 546 "../test/evp_pkey_provided_test.c"
...
# 546 "../test/evp_pkey_provided_test.c"
                                                  ;
    OSSL_PARAM *fromdata_params = 
# 547 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 547 "../test/evp_pkey_provided_test.c"
                                     ;
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 593, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 594, "n = BN_bin2bn(n_data, sizeof(n_data), NULL)", n = BN_bin2bn(n_data, sizeof(n_data), 
# 594 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 594 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 595, "e = BN_bin2bn(e_data, sizeof(e_data), NULL)", e = BN_bin2bn(e_data, sizeof(e_data), 
# 595 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 595 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 596, "d = BN_bin2bn(d_data, sizeof(d_data), NULL)", d = BN_bin2bn(d_data, sizeof(d_data), 
# 596 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 596 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 597, "p = BN_bin2bn(p_data, sizeof(p_data), NULL)", p = BN_bin2bn(p_data, sizeof(p_data), 
# 597 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 597 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 598, "q = BN_bin2bn(q_data, sizeof(q_data), NULL)", q = BN_bin2bn(q_data, sizeof(q_data), 
# 598 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 598 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 599, "dmp1 = BN_bin2bn(dmp1_data, sizeof(dmp1_data), NULL)", dmp1 = BN_bin2bn(dmp1_data, sizeof(dmp1_data), 
# 599 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 599 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 600, "dmq1 = BN_bin2bn(dmq1_data, sizeof(dmq1_data), NULL)", dmq1 = BN_bin2bn(dmq1_data, sizeof(dmq1_data), 
# 600 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 600 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 601, "iqmp = BN_bin2bn(iqmp_data, sizeof(iqmp_data), NULL)", iqmp = BN_bin2bn(iqmp_data, sizeof(iqmp_data), 
# 601 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 601 "../test/evp_pkey_provided_test.c"
           ))
        || !test_true("../test/evp_pkey_provided_test.c", 602, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_N, n)", (OSSL_PARAM_BLD_push_BN(bld, "n", n)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 603, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_E, e)", (OSSL_PARAM_BLD_push_BN(bld, "e", e)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 604, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_D, d)", (OSSL_PARAM_BLD_push_BN(bld, "d", d)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 605, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_FACTOR1, p)", (OSSL_PARAM_BLD_push_BN(bld, "rsa-factor1", p)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 607, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_FACTOR2, q)", (OSSL_PARAM_BLD_push_BN(bld, "rsa-factor2", q)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 609, "OSSL_PARAM_BLD_push_int(bld, OSSL_PKEY_PARAM_RSA_DERIVE_FROM_PQ, 1)", (OSSL_PARAM_BLD_push_int(bld, "rsa-derive-from-pq", 1)) != 0)

        || !test_ptr("../test/evp_pkey_provided_test.c", 611, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    cdata[0].pname = "rsa-exponent1";
    cdata[0].comparebn = dmp1;
    cdata[1].pname = "rsa-exponent2";
    cdata[1].comparebn = dmq1;
    cdata[2].pname = "rsa-coefficient1";
    cdata[2].comparebn = iqmp;
    cdata[3].pname = 
# 620 "../test/evp_pkey_provided_test.c" 3 4
                    ((void *)0)
# 620 "../test/evp_pkey_provided_test.c"
                        ;
    cdata[3].comparebn = 
# 621 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 621 "../test/evp_pkey_provided_test.c"
                            ;
...
{
    OSSL_PARAM_BLD *bld = 
# 640 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 640 "../test/evp_pkey_provided_test.c"
                             ;
    BIGNUM *n = 
# 641 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 641 "../test/evp_pkey_provided_test.c"
                   , *e = 
# 641 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 641 "../test/evp_pkey_provided_test.c"
...
# 641 "../test/evp_pkey_provided_test.c"
                                         ;
    BIGNUM *p = 
# 642 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 642 "../test/evp_pkey_provided_test.c"
                   , *q = 
# 642 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 642 "../test/evp_pkey_provided_test.c"
...
# 642 "../test/evp_pkey_provided_test.c"
                                          ;
    BIGNUM *dmp1 = 
# 643 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 643 "../test/evp_pkey_provided_test.c"
                      , *dmq1 = 
# 643 "../test/evp_pkey_provided_test.c" 3 4
                                ((void *)0)
# 643 "../test/evp_pkey_provided_test.c"
...
# 643 "../test/evp_pkey_provided_test.c"
                                                  ;
    BIGNUM *exp3 = 
# 644 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 644 "../test/evp_pkey_provided_test.c"
                      , *coeff2 = 
# 644 "../test/evp_pkey_provided_test.c" 3 4
                                  ((void *)0)
# 644 "../test/evp_pkey_provided_test.c"
                                      ;
    OSSL_PARAM *fromdata_params = 
# 645 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 645 "../test/evp_pkey_provided_test.c"
                                     ;
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 775, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 776, "n = BN_bin2bn(n_data, sizeof(n_data), NULL)", n = BN_bin2bn(n_data, sizeof(n_data), 
# 776 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 776 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 777, "e = BN_bin2bn(e_data, sizeof(e_data), NULL)", e = BN_bin2bn(e_data, sizeof(e_data), 
# 777 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 777 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 778, "d = BN_bin2bn(d_data, sizeof(d_data), NULL)", d = BN_bin2bn(d_data, sizeof(d_data), 
# 778 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 778 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 779, "p = BN_bin2bn(p_data, sizeof(p_data), NULL)", p = BN_bin2bn(p_data, sizeof(p_data), 
# 779 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 779 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 780, "q = BN_bin2bn(q_data, sizeof(q_data), NULL)", q = BN_bin2bn(q_data, sizeof(q_data), 
# 780 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 780 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 781, "p2 = BN_bin2bn(p2_data, sizeof(p2_data), NULL)", p2 = BN_bin2bn(p2_data, sizeof(p2_data), 
# 781 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 781 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 782, "exp3 = BN_bin2bn(exp3_data, sizeof(exp3_data), NULL)", exp3 = BN_bin2bn(exp3_data, sizeof(exp3_data), 
# 782 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 782 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 783, "coeff2 = BN_bin2bn(coeff2_data, sizeof(coeff2_data), NULL)", coeff2 = BN_bin2bn(coeff2_data, sizeof(coeff2_data), 
# 783 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 783 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 784, "dmp1 = BN_bin2bn(dmp1_data, sizeof(dmp1_data), NULL)", dmp1 = BN_bin2bn(dmp1_data, sizeof(dmp1_data), 
# 784 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 784 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 785, "dmq1 = BN_bin2bn(dmq1_data, sizeof(dmq1_data), NULL)", dmq1 = BN_bin2bn(dmq1_data, sizeof(dmq1_data), 
# 785 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 785 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 786, "iqmp = BN_bin2bn(iqmp_data, sizeof(iqmp_data), NULL)", iqmp = BN_bin2bn(iqmp_data, sizeof(iqmp_data), 
# 786 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 786 "../test/evp_pkey_provided_test.c"
           ))
        || !test_true("../test/evp_pkey_provided_test.c", 787, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_N, n)", (OSSL_PARAM_BLD_push_BN(bld, "n", n)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 788, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_E, e)", (OSSL_PARAM_BLD_push_BN(bld, "e", e)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 789, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_D, d)", (OSSL_PARAM_BLD_push_BN(bld, "d", d)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 790, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_FACTOR1, p)", (OSSL_PARAM_BLD_push_BN(bld, "rsa-factor1", p)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 792, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_FACTOR2, q)", (OSSL_PARAM_BLD_push_BN(bld, "rsa-factor2", q)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 794, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_FACTOR3, p2)", (OSSL_PARAM_BLD_push_BN(bld, "rsa-factor3", p2)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 796, "OSSL_PARAM_BLD_push_int(bld, OSSL_PKEY_PARAM_RSA_DERIVE_FROM_PQ, 1)", (OSSL_PARAM_BLD_push_int(bld, "rsa-derive-from-pq", 1)) != 0)

        || !test_ptr("../test/evp_pkey_provided_test.c", 798, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;
    ...
    cdata[2].pname = "rsa-coefficient1";
    cdata[2].comparebn = iqmp;
    cdata[3].pname = "rsa-exponent3";
    cdata[3].comparebn = exp3;
    cdata[4].pname = "rsa-coefficient2";
    ...
    cdata[7].pname = "d";
    cdata[7].comparebn = d;
    cdata[8].pname = "rsa-factor1";
    cdata[8].comparebn = p;
    cdata[9].pname = "rsa-factor2";
    cdata[9].comparebn = q;
    cdata[10].pname = "rsa-factor3";
    cdata[10].comparebn = p2;
    cdata[11].pname = 
# 823 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 823 "../test/evp_pkey_provided_test.c"
                         ;
    cdata[11].comparebn = 
# 824 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 824 "../test/evp_pkey_provided_test.c"
                             ;
...
static int test_evp_pkey_get_bn_param_large(void)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 847 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 847 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 847 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 847 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 848 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 848 "../test/evp_pkey_provided_test.c"
                      ;
    OSSL_PARAM_BLD *bld = 
# 849 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 849 "../test/evp_pkey_provided_test.c"
                             ;
    OSSL_PARAM *fromdata_params = 
# 850 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 850 "../test/evp_pkey_provided_test.c"
                                     ;
    BIGNUM *n = 
# 851 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 851 "../test/evp_pkey_provided_test.c"
                   , *e = 
# 851 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 851 "../test/evp_pkey_provided_test.c"
...
# 851 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 867, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 868, "n = BN_bin2bn(n_data, sizeof(n_data), NULL)", n = BN_bin2bn(n_data, sizeof(n_data), 
# 868 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 868 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 869, "e = BN_bin2bn(e_data, sizeof(e_data), NULL)", e = BN_bin2bn(e_data, sizeof(e_data), 
# 869 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 869 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 870, "d = BN_bin2bn(d_data, sizeof(d_data), NULL)", d = BN_bin2bn(d_data, sizeof(d_data), 
# 870 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 870 "../test/evp_pkey_provided_test.c"
           ))
        || !test_true("../test/evp_pkey_provided_test.c", 871, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_N, n)", (OSSL_PARAM_BLD_push_BN(bld, "n", n)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 872, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_E, e)", (OSSL_PARAM_BLD_push_BN(bld, "e", e)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 873, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_D, d)", (OSSL_PARAM_BLD_push_BN(bld, "d", d)) != 0)
        || !test_ptr("../test/evp_pkey_provided_test.c", 874, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_pkey_provided_test.c", 875, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"RSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 875 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 875 "../test/evp_pkey_provided_test.c"
           , "RSA", 
# 875 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 875 "../test/evp_pkey_provided_test.c"
           ))
        || !test_int_eq("../test/evp_pkey_provided_test.c", 876, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 877, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)

        || !test_ptr("../test/evp_pkey_provided_test.c", 879, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 879 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 879 "../test/evp_pkey_provided_test.c"
           , pk, ""))
        || !test_true("../test/evp_pkey_provided_test.c", 880, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_RSA_N, &n_out)", (EVP_PKEY_get_bn_param(pk, "n", &n_out)) != 0)
        || !test_BN_eq("../test/evp_pkey_provided_test.c", 881, "n", "n_out", n, n_out))
        goto err;
    ret = 1;
 err:
    BN_free(n_out);
...
static int test_fromdata_dh_named_group(void)
{
    ...
    EVP_PKEY_CTX *ctx = 
# 903 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 903 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 903 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 903 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 904 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 904 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 904 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 904 "../test/evp_pkey_provided_test.c"
...
# 904 "../test/evp_pkey_provided_test.c"
    ...
    size_t len;
    BIGNUM *pub = 
# 906 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 906 "../test/evp_pkey_provided_test.c"
                     , *priv = 
# 906 "../test/evp_pkey_provided_test.c" 3 4
                               ((void *)0)
# 906 "../test/evp_pkey_provided_test.c"
                                   ;
    BIGNUM *pub_out = 
# 907 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 907 "../test/evp_pkey_provided_test.c"
                         , *priv_out = 
# 907 "../test/evp_pkey_provided_test.c" 3 4
                                       ((void *)0)
# 907 "../test/evp_pkey_provided_test.c"
                                           ;
    BIGNUM *p = 
# 908 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 908 "../test/evp_pkey_provided_test.c"
                   , *q = 
# 908 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 908 "../test/evp_pkey_provided_test.c"
...
# 908 "../test/evp_pkey_provided_test.c"
                                                    ;
    OSSL_PARAM *fromdata_params = 
# 909 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 909 "../test/evp_pkey_provided_test.c"
                                     ;
    OSSL_PARAM_BLD *bld = 
# 910 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 910 "../test/evp_pkey_provided_test.c"
                             ;
    char name_out[80];
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 951, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 952, "pub = BN_bin2bn(pub_data, sizeof(pub_data), NULL)", pub = BN_bin2bn(pub_data, sizeof(pub_data), 
# 952 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 952 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 953, "priv = BN_bin2bn(priv_data, sizeof(priv_data), NULL)", priv = BN_bin2bn(priv_data, sizeof(priv_data), 
# 953 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 953 "../test/evp_pkey_provided_test.c"
           ))
        || !test_true("../test/evp_pkey_provided_test.c", 954, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, group_name, 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", group_name, 0)) != 0)


        || !test_true("../test/evp_pkey_provided_test.c", 957, "OSSL_PARAM_BLD_push_long(bld, OSSL_PKEY_PARAM_DH_PRIV_LEN, priv_len)", (OSSL_PARAM_BLD_push_long(bld, "priv_len", priv_len)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 959, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 960, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
        || !test_ptr("../test/evp_pkey_provided_test.c", 961, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 964, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"DH\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 964 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 964 "../test/evp_pkey_provided_test.c"
        , "DH", 
# 964 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 964 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 967, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 968, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;
    ...
    if (!test_true("../test/evp_pkey_provided_test.c", 977, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, NULL, sizeof(name_out), &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", 
# 977 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 977 "../test/evp_pkey_provided_test.c"
        , sizeof(name_out), &len)) != 0)



        || !test_size_t_eq("../test/evp_pkey_provided_test.c", 981, "len", "sizeof(group_name) - 1", len, sizeof(group_name) - 1)

        || !test_true("../test/evp_pkey_provided_test.c", 983, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(group_name), &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(group_name), &len)) != 0)




        || !test_size_t_eq("../test/evp_pkey_provided_test.c", 988, "len", "sizeof(group_name) - 1", len, sizeof(group_name) - 1)

        || !test_false("../test/evp_pkey_provided_test.c", 990, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(group_name) - 1, &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(group_name) - 1, &len)) != 0)





        || !test_false("../test/evp_pkey_provided_test.c", 996, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(group_name) - 2, &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(group_name) - 2, &len)) != 0)
    ...
    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 1005, "EVP_PKEY_get_bits(pk)", "2048", EVP_PKEY_get_bits(pk), 2048)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1006, "EVP_PKEY_get_security_bits(pk)", "112", EVP_PKEY_get_security_bits(pk), 112)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1007, "EVP_PKEY_get_size(pk)", "256", EVP_PKEY_get_size(pk), 256)
            || !test_false("../test/evp_pkey_provided_test.c", 1008, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        if (!test_true("../test/evp_pkey_provided_test.c", 1011, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(name_out), &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(name_out), &len)) != 0)




            || !test_str_eq("../test/evp_pkey_provided_test.c", 1016, "name_out", "group_name", name_out, group_name)
            || !test_true("../test/evp_pkey_provided_test.c", 1017, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PUB_KEY, &pub_out)", (EVP_PKEY_get_bn_param(pk, "pub", &pub_out)) != 0)


            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1020, "pub", "pub_out", pub, pub_out)
            || !test_true("../test/evp_pkey_provided_test.c", 1021, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PRIV_KEY, &priv_out)", (EVP_PKEY_get_bn_param(pk, "priv", &priv_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1023, "priv", "priv_out", priv, priv_out)
            || !test_true("../test/evp_pkey_provided_test.c", 1024, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_P, &p)", (EVP_PKEY_get_bn_param(pk, "p", &p)) != 0)
            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1025, "&ossl_bignum_ffdhe2048_p", "p", &ossl_bignum_ffdhe2048_p, p)
            || !test_true("../test/evp_pkey_provided_test.c", 1026, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_Q, &q)", (EVP_PKEY_get_bn_param(pk, "q", &q)) != 0)
            || !test_ptr("../test/evp_pkey_provided_test.c", 1027, "q", q)
            || !test_true("../test/evp_pkey_provided_test.c", 1028, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_G, &g)", (EVP_PKEY_get_bn_param(pk, "g", &g)) != 0)
            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1029, "&ossl_bignum_const_2", "g", &ossl_bignum_const_2, g)
            || !test_false("../test/evp_pkey_provided_test.c", 1030, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_COFACTOR, &j)", (EVP_PKEY_get_bn_param(pk, "j", &j)) != 0)


            || !test_ptr_null("../test/evp_pkey_provided_test.c", 1033, "j", j)
            || !test_false("../test/evp_pkey_provided_test.c", 1034, "EVP_PKEY_get_octet_string_param(pk, OSSL_PKEY_PARAM_FFC_SEED, seed_out, sizeof(seed_out), &len)", (EVP_PKEY_get_octet_string_param(pk, "seed", seed_out, sizeof(seed_out), &len)) != 0)




            || !test_true("../test/evp_pkey_provided_test.c", 1039, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_GINDEX, &gindex)", (EVP_PKEY_get_int_param(pk, "gindex", &gindex)) != 0)

            || !test_int_eq("../test/evp_pkey_provided_test.c", 1041, "gindex", "-1", gindex, -1)
            || !test_true("../test/evp_pkey_provided_test.c", 1042, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_H, &hindex)", (EVP_PKEY_get_int_param(pk, "hindex", &hindex)) != 0)

            || !test_int_eq("../test/evp_pkey_provided_test.c", 1044, "hindex", "0", hindex, 0)
            || !test_true("../test/evp_pkey_provided_test.c", 1045, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_PCOUNTER, &pcounter)", (EVP_PKEY_get_int_param(pk, "pcounter", &pcounter)) != 0)


            || !test_int_eq("../test/evp_pkey_provided_test.c", 1048, "pcounter", "-1", pcounter, -1))
            goto err;
        BN_free(p);
        p = 
# 1051 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1051 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(q);
        q = 
# 1053 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1053 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(g);
        g = 
# 1055 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1055 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(j);
        j = 
# 1057 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1057 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(pub_out);
        pub_out = 
# 1059 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1059 "../test/evp_pkey_provided_test.c"
                     ;
        BN_free(priv_out);
        priv_out = 
# 1061 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1061 "../test/evp_pkey_provided_test.c"
                      ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1063, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 1063 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1063 "../test/evp_pkey_provided_test.c"
            , pk, "")))
            goto err;

        if (!test_int_gt("../test/evp_pkey_provided_test.c", 1066, "EVP_PKEY_check(key_ctx)", "0", EVP_PKEY_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1067, "EVP_PKEY_public_check(key_ctx)", "0", EVP_PKEY_public_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1068, "EVP_PKEY_private_check(key_ctx)", "0", EVP_PKEY_private_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1069, "EVP_PKEY_pairwise_check(key_ctx)", "0", EVP_PKEY_pairwise_check(key_ctx), 0))
            goto err;
        EVP_PKEY_CTX_free(key_ctx);
        key_ctx = 
# 1072 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1072 "../test/evp_pkey_provided_test.c"
                     ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1074, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())
            || !test_true("../test/evp_pkey_provided_test.c", 1075, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 1078 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1078 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 1083 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 1083 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1086, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 1088, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
static int test_fromdata_dh_fips186_4(void)
{
    ...
    int gindex = 0, pcounter = 0, hindex = 0;
    EVP_PKEY_CTX *ctx = 
# 1117 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 1117 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 1117 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 1117 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 1118 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1118 "../test/evp_pkey_provided_test.c"
                      , *dup_pk = 
# 1118 "../test/evp_pkey_provided_test.c" 3 4
                                  ((void *)0)
# 1118 "../test/evp_pkey_provided_test.c"
    ...
    size_t len;
    BIGNUM *pub = 
# 1120 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1120 "../test/evp_pkey_provided_test.c"
                     , *priv = 
# 1120 "../test/evp_pkey_provided_test.c" 3 4
                               ((void *)0)
# 1120 "../test/evp_pkey_provided_test.c"
                                   ;
    BIGNUM *pub_out = 
# 1121 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1121 "../test/evp_pkey_provided_test.c"
                         , *priv_out = 
# 1121 "../test/evp_pkey_provided_test.c" 3 4
                                       ((void *)0)
# 1121 "../test/evp_pkey_provided_test.c"
                                           ;
    BIGNUM *p = 
# 1122 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1122 "../test/evp_pkey_provided_test.c"
                   , *q = 
# 1122 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 1122 "../test/evp_pkey_provided_test.c"
...
# 1122 "../test/evp_pkey_provided_test.c"
                                                    ;
    OSSL_PARAM_BLD *bld = 
# 1123 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 1123 "../test/evp_pkey_provided_test.c"
                             ;
    OSSL_PARAM *fromdata_params = 
# 1124 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 1124 "../test/evp_pkey_provided_test.c"
                                     ;
    char name_out[80];
    unsigned char seed_out[32];
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1166, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 1167, "pub = BN_bin2bn(pub_data, sizeof(pub_data), NULL)", pub = BN_bin2bn(pub_data, sizeof(pub_data), 
# 1167 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1167 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1168, "priv = BN_bin2bn(priv_data, sizeof(priv_data), NULL)", priv = BN_bin2bn(priv_data, sizeof(priv_data), 
# 1168 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1168 "../test/evp_pkey_provided_test.c"
           ))
        || !test_true("../test/evp_pkey_provided_test.c", 1169, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, group_name, 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", group_name, 0)) != 0)


        || !test_true("../test/evp_pkey_provided_test.c", 1172, "OSSL_PARAM_BLD_push_long(bld, OSSL_PKEY_PARAM_DH_PRIV_LEN, priv_len)", (OSSL_PARAM_BLD_push_long(bld, "priv_len", priv_len)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 1174, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 1175, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
        || !test_ptr("../test/evp_pkey_provided_test.c", 1176, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 1179, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"DH\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 1179 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1179 "../test/evp_pkey_provided_test.c"
        , "DH", 
# 1179 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1179 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 1182, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 1183, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;

    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 1189, "EVP_PKEY_get_bits(pk)", "2048", EVP_PKEY_get_bits(pk), 2048)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1190, "EVP_PKEY_get_security_bits(pk)", "112", EVP_PKEY_get_security_bits(pk), 112)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1191, "EVP_PKEY_get_size(pk)", "256", EVP_PKEY_get_size(pk), 256)
            || !test_false("../test/evp_pkey_provided_test.c", 1192, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        if (!test_true("../test/evp_pkey_provided_test.c", 1195, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(name_out), &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(name_out), &len)) != 0)




            || !test_str_eq("../test/evp_pkey_provided_test.c", 1200, "name_out", "group_name", name_out, group_name)
            || !test_true("../test/evp_pkey_provided_test.c", 1201, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PUB_KEY, &pub_out)", (EVP_PKEY_get_bn_param(pk, "pub", &pub_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1203, "pub", "pub_out", pub, pub_out)
            || !test_true("../test/evp_pkey_provided_test.c", 1204, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PRIV_KEY, &priv_out)", (EVP_PKEY_get_bn_param(pk, "priv", &priv_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1206, "priv", "priv_out", priv, priv_out)
            || !test_true("../test/evp_pkey_provided_test.c", 1207, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_P, &p)", (EVP_PKEY_get_bn_param(pk, "p", &p)) != 0)
            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1208, "&ossl_bignum_ffdhe2048_p", "p", &ossl_bignum_ffdhe2048_p, p)
            || !test_true("../test/evp_pkey_provided_test.c", 1209, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_Q, &q)", (EVP_PKEY_get_bn_param(pk, "q", &q)) != 0)
            || !test_ptr("../test/evp_pkey_provided_test.c", 1210, "q", q)
            || !test_true("../test/evp_pkey_provided_test.c", 1211, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_G, &g)", (EVP_PKEY_get_bn_param(pk, "g", &g)) != 0)
            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1212, "&ossl_bignum_const_2", "g", &ossl_bignum_const_2, g)
            || !test_false("../test/evp_pkey_provided_test.c", 1213, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_COFACTOR, &j)", (EVP_PKEY_get_bn_param(pk, "j", &j)) != 0)


            || !test_ptr_null("../test/evp_pkey_provided_test.c", 1216, "j", j)
            || !test_false("../test/evp_pkey_provided_test.c", 1217, "EVP_PKEY_get_octet_string_param(pk, OSSL_PKEY_PARAM_FFC_SEED, seed_out, sizeof(seed_out), &len)", (EVP_PKEY_get_octet_string_param(pk, "seed", seed_out, sizeof(seed_out), &len)) != 0)




            || !test_true("../test/evp_pkey_provided_test.c", 1222, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_GINDEX, &gindex)", (EVP_PKEY_get_int_param(pk, "gindex", &gindex)) != 0)


            || !test_int_eq("../test/evp_pkey_provided_test.c", 1225, "gindex", "-1", gindex, -1)
            || !test_true("../test/evp_pkey_provided_test.c", 1226, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_H, &hindex)", (EVP_PKEY_get_int_param(pk, "hindex", &hindex)) != 0)

            || !test_int_eq("../test/evp_pkey_provided_test.c", 1228, "hindex", "0", hindex, 0)
            || !test_true("../test/evp_pkey_provided_test.c", 1229, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_PCOUNTER, &pcounter)", (EVP_PKEY_get_int_param(pk, "pcounter", &pcounter)) != 0)


            || !test_int_eq("../test/evp_pkey_provided_test.c", 1232, "pcounter", "-1", pcounter, -1))
            goto err;
        BN_free(p);
        p = 
# 1235 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1235 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(q);
        q = 
# 1237 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1237 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(g);
        g = 
# 1239 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1239 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(j);
        j = 
# 1241 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1241 "../test/evp_pkey_provided_test.c"
               ;
        BN_free(pub_out);
        pub_out = 
# 1243 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1243 "../test/evp_pkey_provided_test.c"
                     ;
        BN_free(priv_out);
        priv_out = 
# 1245 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1245 "../test/evp_pkey_provided_test.c"
                      ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1247, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 1247 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1247 "../test/evp_pkey_provided_test.c"
            , pk, "")))
            goto err;

        if (!test_int_gt("../test/evp_pkey_provided_test.c", 1250, "EVP_PKEY_check(key_ctx)", "0", EVP_PKEY_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1251, "EVP_PKEY_public_check(key_ctx)", "0", EVP_PKEY_public_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1252, "EVP_PKEY_private_check(key_ctx)", "0", EVP_PKEY_private_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 1253, "EVP_PKEY_pairwise_check(key_ctx)", "0", EVP_PKEY_pairwise_check(key_ctx), 0))
            goto err;
        EVP_PKEY_CTX_free(key_ctx);
        key_ctx = 
# 1256 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1256 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 1261 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 1261 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1264, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 1266, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
# 1312 "../test/evp_pkey_provided_test.c"
static int test_fromdata_ecx(int tst)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 1315 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 1315 "../test/evp_pkey_provided_test.c"
                           , *ctx2 = 
# 1315 "../test/evp_pkey_provided_test.c" 3 4
                                     ((void *)0)
# 1315 "../test/evp_pkey_provided_test.c"
                                         ;
    EVP_PKEY *pk = 
# 1316 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1316 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 1316 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 1316 "../test/evp_pkey_provided_test.c"
...
# 1316 "../test/evp_pkey_provided_test.c"
                                                       ;
    const char *alg = 
# 1317 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1317 "../test/evp_pkey_provided_test.c"
                         ;
    size_t len;
    unsigned char out_pub[57];
    unsigned char out_priv[57];
    OSSL_PARAM params[3] = { { 
# 1321 "../test/evp_pkey_provided_test.c" 3 4
                            ((void *)0)
# 1321 "../test/evp_pkey_provided_test.c"
                            , 0, 
# 1321 "../test/evp_pkey_provided_test.c" 3 4
                            ((void *)0)
# 1321 "../test/evp_pkey_provided_test.c"
...
# 1321 "../test/evp_pkey_provided_test.c"
    ...
    static unsigned char key_numbers[4][2][57] = {
    ...
    OSSL_PARAM x25519_fromdata_params[] = {
        { (("priv")), (5), ((key_numbers[0][0])), (32), ((size_t)-1) }

                                              ,
        { (("pub")), (5), ((key_numbers[0][1])), (32), ((size_t)-1) }

                                              ,
        { 
# 1409 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1409 "../test/evp_pkey_provided_test.c"
       , 0, 
# 1409 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1409 "../test/evp_pkey_provided_test.c"
    ...
    OSSL_PARAM x448_fromdata_params[] = {
        { (("priv")), (5), ((key_numbers[1][0])), (56), ((size_t)-1) }

                                            ,
        { (("pub")), (5), ((key_numbers[1][1])), (56), ((size_t)-1) }

                                            ,
        { 
# 1418 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1418 "../test/evp_pkey_provided_test.c"
       , 0, 
# 1418 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1418 "../test/evp_pkey_provided_test.c"
    ...
    OSSL_PARAM ed25519_fromdata_params[] = {
        { (("priv")), (5), ((key_numbers[2][0])), (32), ((size_t)-1) }

                                               ,
        { (("pub")), (5), ((key_numbers[2][1])), (32), ((size_t)-1) }

                                               ,
        { 
# 1427 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1427 "../test/evp_pkey_provided_test.c"
       , 0, 
# 1427 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1427 "../test/evp_pkey_provided_test.c"
    ...
    OSSL_PARAM ed448_fromdata_params[] = {
        { (("priv")), (5), ((key_numbers[3][0])), (57), ((size_t)-1) }

                                             ,
        { (("pub")), (5), ((key_numbers[3][1])), (57), ((size_t)-1) }

                                             ,
        { 
# 1436 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1436 "../test/evp_pkey_provided_test.c"
       , 0, 
# 1436 "../test/evp_pkey_provided_test.c" 3 4
       ((void *)0)
# 1436 "../test/evp_pkey_provided_test.c"
    ...
    OSSL_PARAM *fromdata_params = 
# 1438 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 1438 "../test/evp_pkey_provided_test.c"
                                     ;
    int bits = 0, security_bits = 0, size = 0;
    OSSL_PARAM *orig_fromdata_params = 
# 1440 "../test/evp_pkey_provided_test.c" 3 4
                                      ((void *)0)
# 1440 "../test/evp_pkey_provided_test.c"
                                          ;
...
# 1478 "../test/evp_pkey_provided_test.c" 3 4
                                    ((void *)0)
# 1478 "../test/evp_pkey_provided_test.c"
                                        , alg, 
# 1478 "../test/evp_pkey_provided_test.c" 3 4
                                               ((void *)0)
# 1478 "../test/evp_pkey_provided_test.c"
                                                   );
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1479, "ctx", ctx))
        goto err;
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 1493, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 1494, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;

    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 1500, "EVP_PKEY_get_bits(pk)", "bits", EVP_PKEY_get_bits(pk), bits)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1501, "EVP_PKEY_get_security_bits(pk)", "security_bits", EVP_PKEY_get_security_bits(pk), security_bits)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1502, "EVP_PKEY_get_size(pk)", "size", EVP_PKEY_get_size(pk), size)
            || !test_false("../test/evp_pkey_provided_test.c", 1503, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1506, "ctx2 = EVP_PKEY_CTX_new_from_pkey(NULL, pk, NULL)", ctx2 = EVP_PKEY_CTX_new_from_pkey(
# 1506 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1506 "../test/evp_pkey_provided_test.c"
            , pk, 
# 1506 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1506 "../test/evp_pkey_provided_test.c"
            ...
            goto err;
        if (tst <= 7) {
            if (!test_int_gt("../test/evp_pkey_provided_test.c", 1509, "EVP_PKEY_check(ctx2)", "0", EVP_PKEY_check(ctx2), 0))
                goto err;
            if (!test_true("../test/evp_pkey_provided_test.c", 1511, "EVP_PKEY_get_octet_string_param( pk, orig_fromdata_params[PRIV_KEY].key, out_priv, sizeof(out_priv), &len)", (EVP_PKEY_get_octet_string_param( pk, orig_fromdata_params[0].key, out_priv, sizeof(out_priv), &len)) != 0)


                || !test_mem_eq("../test/evp_pkey_provided_test.c", 1514, "out_priv", "orig_fromdata_params[PRIV_KEY].data", out_priv, len, orig_fromdata_params[0].data, orig_fromdata_params[0].data_size)


                || !test_true("../test/evp_pkey_provided_test.c", 1517, "EVP_PKEY_get_octet_string_param( pk, orig_fromdata_params[PUB_KEY].key, out_pub, sizeof(out_pub), &len)", (EVP_PKEY_get_octet_string_param( pk, orig_fromdata_params[1].key, out_pub, sizeof(out_pub), &len)) != 0)


                || !test_mem_eq("../test/evp_pkey_provided_test.c", 1520, "out_pub", "orig_fromdata_params[PUB_KEY].data", out_pub, len, orig_fromdata_params[1].data, orig_fromdata_params[1].data_size)

                                                                        )
                goto err;
        } else {

            if (!test_int_gt("../test/evp_pkey_provided_test.c", 1526, "EVP_PKEY_public_check(ctx2)", "0", EVP_PKEY_public_check(ctx2), 0)
                || !test_int_le("../test/evp_pkey_provided_test.c", 1527, "EVP_PKEY_private_check(ctx2)", "0", EVP_PKEY_private_check(ctx2), 0)
                || !test_int_le("../test/evp_pkey_provided_test.c", 1528, "EVP_PKEY_check(ctx2)", "0", EVP_PKEY_check(ctx2), 0))
                goto err;
        }
        EVP_PKEY_CTX_free(ctx2);
        ctx2 = 
# 1532 "../test/evp_pkey_provided_test.c" 3 4
              ((void *)0)
# 1532 "../test/evp_pkey_provided_test.c"
                  ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1534, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())

            || !test_true("../test/evp_pkey_provided_test.c", 1536, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        if (!test_ptr("../test/evp_pkey_provided_test.c", 1538, "ctx2 = EVP_PKEY_CTX_new_from_pkey(NULL, copy_pk, NULL)", ctx2 = EVP_PKEY_CTX_new_from_pkey(
# 1538 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1538 "../test/evp_pkey_provided_test.c"
            , copy_pk, 
# 1538 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 1538 "../test/evp_pkey_provided_test.c"
            ...
            || !test_int_le("../test/evp_pkey_provided_test.c", 1540, "EVP_PKEY_public_check(ctx2)", "0", EVP_PKEY_public_check(ctx2), 0))
            goto err;
        EVP_PKEY_CTX_free(ctx2);
        ctx2 = 
# 1543 "../test/evp_pkey_provided_test.c" 3 4
              ((void *)0)
# 1543 "../test/evp_pkey_provided_test.c"
                  ;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 1545 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1545 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 1553 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 1553 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1556, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 1558, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
static int test_fromdata_ec(void)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 1578 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 1578 "../test/evp_pkey_provided_test.c"
                           ;
    EVP_PKEY *pk = 
# 1579 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1579 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 1579 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 1579 "../test/evp_pkey_provided_test.c"
...
# 1579 "../test/evp_pkey_provided_test.c"
                                                       ;
    OSSL_PARAM_BLD *bld = 
# 1580 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 1580 "../test/evp_pkey_provided_test.c"
                             ;
    BIGNUM *ec_priv_bn = 
# 1581 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 1581 "../test/evp_pkey_provided_test.c"
                            ;
    BIGNUM *bn_priv = 
# 1582 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1582 "../test/evp_pkey_provided_test.c"
                         ;
    OSSL_PARAM *fromdata_params = 
# 1583 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 1583 "../test/evp_pkey_provided_test.c"
                                     ;
    const char *alg = "EC";
    ...
    OSSL_PARAM nokey_params[2] = {
       { 
# 1588 "../test/evp_pkey_provided_test.c" 3 4
      ((void *)0)
# 1588 "../test/evp_pkey_provided_test.c"
      , 0, 
# 1588 "../test/evp_pkey_provided_test.c" 3 4
      ((void *)0)
# 1588 "../test/evp_pkey_provided_test.c"
      , 0, 0 },
       { 
# 1589 "../test/evp_pkey_provided_test.c" 3 4
      ((void *)0)
# 1589 "../test/evp_pkey_provided_test.c"
      , 0, 
# 1589 "../test/evp_pkey_provided_test.c" 3 4
      ((void *)0)
# 1589 "../test/evp_pkey_provided_test.c"
...
# 1619 "../test/evp_pkey_provided_test.c" 3 4
                                ((void *)0)
# 1619 "../test/evp_pkey_provided_test.c"
                                    ;
    size_t len;
    EC_GROUP *group = 
# 1621 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1621 "../test/evp_pkey_provided_test.c"
                         ;
    BIGNUM *group_a = 
# 1622 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1622 "../test/evp_pkey_provided_test.c"
                         ;
    BIGNUM *group_b = 
# 1623 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1623 "../test/evp_pkey_provided_test.c"
                         ;
    BIGNUM *group_p = 
# 1624 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1624 "../test/evp_pkey_provided_test.c"
                         ;
    BIGNUM *a = 
# 1625 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1625 "../test/evp_pkey_provided_test.c"
                   ;
    BIGNUM *b = 
# 1626 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1626 "../test/evp_pkey_provided_test.c"
                   ;
    BIGNUM *p = 
# 1627 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1627 "../test/evp_pkey_provided_test.c"
                   ;


    if (!test_ptr("../test/evp_pkey_provided_test.c", 1630, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new()))
        goto err;
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1632, "ec_priv_bn = BN_bin2bn(ec_priv_keydata, sizeof(ec_priv_keydata), NULL)", ec_priv_bn = BN_bin2bn(ec_priv_keydata, sizeof(ec_priv_keydata), 
# 1632 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1632 "../test/evp_pkey_provided_test.c"
        ))
                                                                        )
        goto err;
    ...
    if (OSSL_PARAM_BLD_push_utf8_string(bld, "group",
                                        curve, 0) <= 0)
        goto err;
# 1647 "../test/evp_pkey_provided_test.c"
    if (OSSL_PARAM_BLD_push_octet_string(bld, "pub",
                                         ec_pub_keydata_compressed,
                                         sizeof(ec_pub_keydata_compressed)) <= 0)
        goto err;
    if (OSSL_PARAM_BLD_push_BN(bld, "priv", ec_priv_bn) <= 0)
        goto err;
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1653, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;
    ctx = EVP_PKEY_CTX_new_from_name(
# 1655 "../test/evp_pkey_provided_test.c" 3 4
                                    ((void *)0)
# 1655 "../test/evp_pkey_provided_test.c"
                                        , alg, 
# 1655 "../test/evp_pkey_provided_test.c" 3 4
                                               ((void *)0)
# 1655 "../test/evp_pkey_provided_test.c"
                                                   );
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1656, "ctx", ctx))
        goto err;
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 1663, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 1664, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEY_PARAMETERS, nokey_params)", "0", EVP_PKEY_fromdata(ctx, &pk, ( ( 0x04 | 0x80) ), nokey_params), 0)

        || !test_ptr_null("../test/evp_pkey_provided_test.c", 1666, "pk", pk))
        goto err;

    if (!test_int_eq("../test/evp_pkey_provided_test.c", 1669, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 1670, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;

    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 1676, "EVP_PKEY_get_bits(pk)", "256", EVP_PKEY_get_bits(pk), 256)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1677, "EVP_PKEY_get_security_bits(pk)", "128", EVP_PKEY_get_security_bits(pk), 128)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 1678, "EVP_PKEY_get_size(pk)", "2 + 35 * 2", EVP_PKEY_get_size(pk), 2 + 35 * 2)
            || !test_false("../test/evp_pkey_provided_test.c", 1679, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1682, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())
            || !test_true("../test/evp_pkey_provided_test.c", 1683, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 1686 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1686 "../test/evp_pkey_provided_test.c"
                     ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1688, "gettable = EVP_PKEY_gettable_params(pk)", gettable = EVP_PKEY_gettable_params(pk))
            || !test_ptr("../test/evp_pkey_provided_test.c", 1689, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_GROUP_NAME)", OSSL_PARAM_locate_const(gettable, "group"))

            || !test_ptr("../test/evp_pkey_provided_test.c", 1691, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_PUB_KEY)", OSSL_PARAM_locate_const(gettable, "pub"))

            || !test_ptr("../test/evp_pkey_provided_test.c", 1693, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_PRIV_KEY)", OSSL_PARAM_locate_const(gettable, "priv"))
                                                                           )
            goto err;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1697, "group = EC_GROUP_new_by_curve_name(OBJ_sn2nid(curve))", group = EC_GROUP_new_by_curve_name(OBJ_sn2nid(curve)))
            || !test_ptr("../test/evp_pkey_provided_test.c", 1698, "group_p = BN_new()", group_p = BN_new())
            || !test_ptr("../test/evp_pkey_provided_test.c", 1699, "group_a = BN_new()", group_a = BN_new())
            || !test_ptr("../test/evp_pkey_provided_test.c", 1700, "group_b = BN_new()", group_b = BN_new())
            || !test_true("../test/evp_pkey_provided_test.c", 1701, "EC_GROUP_get_curve(group, group_p, group_a, group_b, NULL)", (EC_GROUP_get_curve(group, group_p, group_a, group_b, 
# 1701 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1701 "../test/evp_pkey_provided_test.c"
               )) != 0))
            goto err;

        if (!test_true("../test/evp_pkey_provided_test.c", 1704, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_EC_A, &a)", (EVP_PKEY_get_bn_param(pk, "a", &a)) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 1705, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_EC_B, &b)", (EVP_PKEY_get_bn_param(pk, "b", &b)) != 0)
            || !test_true("../test/evp_pkey_provided_test.c", 1706, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_EC_P, &p)", (EVP_PKEY_get_bn_param(pk, "p", &p)) != 0))
            goto err;

        if (!test_BN_eq("../test/evp_pkey_provided_test.c", 1709, "group_p", "p", group_p, p) || !test_BN_eq("../test/evp_pkey_provided_test.c", 1709, "group_a", "a", group_a, a)
            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1710, "group_b", "b", group_b, b))
            goto err;

        EC_GROUP_free(group);
        group = 
# 1714 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1714 "../test/evp_pkey_provided_test.c"
                   ;
        BN_free(group_p);
        group_p = 
# 1716 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1716 "../test/evp_pkey_provided_test.c"
                     ;
        BN_free(group_a);
        group_a = 
# 1718 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1718 "../test/evp_pkey_provided_test.c"
                     ;
        BN_free(group_b);
        group_b = 
# 1720 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1720 "../test/evp_pkey_provided_test.c"
                     ;

        if (!EVP_PKEY_get_utf8_string_param(pk, "group",
                                            out_curve_name,
                                            sizeof(out_curve_name),
                                            &len)
            || !test_str_eq("../test/evp_pkey_provided_test.c", 1726, "out_curve_name", "curve", out_curve_name, curve)
            || !EVP_PKEY_get_octet_string_param(pk, "pub",
            ...
            || !test_true("../test/evp_pkey_provided_test.c", 1736, "out_pub[0] == POINT_CONVERSION_UNCOMPRESSED", (out_pub[0] == POINT_CONVERSION_UNCOMPRESSED) != 0)
            || !test_mem_eq("../test/evp_pkey_provided_test.c", 1737, "out_pub + 1", "ec_pub_keydata + 1", out_pub + 1, len - 1, ec_pub_keydata + 1, sizeof(ec_pub_keydata) - 1)


            || !test_true("../test/evp_pkey_provided_test.c", 1740, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PRIV_KEY, &bn_priv)", (EVP_PKEY_get_bn_param(pk, "priv", &bn_priv)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 1742, "ec_priv_bn", "bn_priv", ec_priv_bn, bn_priv))
            goto err;
        BN_free(bn_priv);
        bn_priv = 
# 1745 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1745 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 1750 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 1750 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 1753, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 1755, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
static int test_ec_dup_no_operation(void)
{
    int ret = 0;
    EVP_PKEY_CTX *pctx = 
# 1783 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 1783 "../test/evp_pkey_provided_test.c"
                            , *ctx = 
# 1783 "../test/evp_pkey_provided_test.c" 3 4
                                     ((void *)0)
# 1783 "../test/evp_pkey_provided_test.c"
...
# 1783 "../test/evp_pkey_provided_test.c"
                                                       ;
    EVP_PKEY *param = 
# 1784 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1784 "../test/evp_pkey_provided_test.c"
                         , *pkey = 
# 1784 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 1784 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1786, "pctx = EVP_PKEY_CTX_new_id(EVP_PKEY_EC, NULL)", pctx = EVP_PKEY_CTX_new_id(408, 
# 1786 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1786 "../test/evp_pkey_provided_test.c"
        ))
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1787, "EVP_PKEY_paramgen_init(pctx)", "0", EVP_PKEY_paramgen_init(pctx), 0)
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1788, "EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, NID_X9_62_prime256v1)", "0", EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, 415), 0)

        || !test_int_gt("../test/evp_pkey_provided_test.c", 1790, "EVP_PKEY_paramgen(pctx, &param)", "0", EVP_PKEY_paramgen(pctx, &param), 0)
        || !test_ptr("../test/evp_pkey_provided_test.c", 1791, "param", param))
        goto err;

    EVP_PKEY_CTX_free(pctx);
    pctx = 
# 1795 "../test/evp_pkey_provided_test.c" 3 4
          ((void *)0)
# 1795 "../test/evp_pkey_provided_test.c"
              ;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 1797, "ctx = EVP_PKEY_CTX_new_from_pkey(NULL, param, NULL)", ctx = EVP_PKEY_CTX_new_from_pkey(
# 1797 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1797 "../test/evp_pkey_provided_test.c"
        , param, 
# 1797 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1797 "../test/evp_pkey_provided_test.c"
        ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1798, "kctx = EVP_PKEY_CTX_dup(ctx)", kctx = EVP_PKEY_CTX_dup(ctx))
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1799, "EVP_PKEY_keygen_init(kctx)", "0", EVP_PKEY_keygen_init(kctx), 0)
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1800, "EVP_PKEY_keygen(kctx, &pkey)", "0", EVP_PKEY_keygen(kctx, &pkey), 0))
        goto err;
    ret = 1;
err:
    EVP_PKEY_free(pkey);
...
static int test_ec_dup_keygen_operation(void)
{
    int ret = 0;
    EVP_PKEY_CTX *pctx = 
# 1816 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 1816 "../test/evp_pkey_provided_test.c"
                            , *ctx = 
# 1816 "../test/evp_pkey_provided_test.c" 3 4
                                     ((void *)0)
# 1816 "../test/evp_pkey_provided_test.c"
...
# 1816 "../test/evp_pkey_provided_test.c"
                                                       ;
    EVP_PKEY *param = 
# 1817 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1817 "../test/evp_pkey_provided_test.c"
                         , *pkey = 
# 1817 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 1817 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1819, "pctx = EVP_PKEY_CTX_new_id(EVP_PKEY_EC, NULL)", pctx = EVP_PKEY_CTX_new_id(408, 
# 1819 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1819 "../test/evp_pkey_provided_test.c"
        ))
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1820, "EVP_PKEY_paramgen_init(pctx)", "0", EVP_PKEY_paramgen_init(pctx), 0)
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1821, "EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, NID_X9_62_prime256v1)", "0", EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, 415), 0)

        || !test_int_gt("../test/evp_pkey_provided_test.c", 1823, "EVP_PKEY_paramgen(pctx, &param)", "0", EVP_PKEY_paramgen(pctx, &param), 0)
        || !test_ptr("../test/evp_pkey_provided_test.c", 1824, "param", param))
        goto err;

    EVP_PKEY_CTX_free(pctx);
    pctx = 
# 1828 "../test/evp_pkey_provided_test.c" 3 4
          ((void *)0)
# 1828 "../test/evp_pkey_provided_test.c"
              ;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 1830, "ctx = EVP_PKEY_CTX_new_from_pkey(NULL, param, NULL)", ctx = EVP_PKEY_CTX_new_from_pkey(
# 1830 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1830 "../test/evp_pkey_provided_test.c"
        , param, 
# 1830 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1830 "../test/evp_pkey_provided_test.c"
        ))
        || !test_int_gt("../test/evp_pkey_provided_test.c", 1831, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0)
        || !test_ptr_null("../test/evp_pkey_provided_test.c", 1832, "kctx = EVP_PKEY_CTX_dup(ctx)", kctx = EVP_PKEY_CTX_dup(ctx)))
        goto err;
    ret = 1;
err:
    EVP_PKEY_free(pkey);
...
static int test_fromdata_dsa_fips186_4(void)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 1850 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 1850 "../test/evp_pkey_provided_test.c"
                           , *key_ctx = 
# 1850 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 1850 "../test/evp_pkey_provided_test.c"
                                            ;
    EVP_PKEY *pk = 
# 1851 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 1851 "../test/evp_pkey_provided_test.c"
                      , *copy_pk = 
# 1851 "../test/evp_pkey_provided_test.c" 3 4
                                   ((void *)0)
# 1851 "../test/evp_pkey_provided_test.c"
...
# 1851 "../test/evp_pkey_provided_test.c"
                                                       ;
    BIGNUM *pub = 
# 1852 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 1852 "../test/evp_pkey_provided_test.c"
                     , *priv = 
# 1852 "../test/evp_pkey_provided_test.c" 3 4
                               ((void *)0)
# 1852 "../test/evp_pkey_provided_test.c"
                                   ;
    BIGNUM *p = 
# 1853 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 1853 "../test/evp_pkey_provided_test.c"
                   , *q = 
# 1853 "../test/evp_pkey_provided_test.c" 3 4
                          ((void *)0)
# 1853 "../test/evp_pkey_provided_test.c"
...
# 1853 "../test/evp_pkey_provided_test.c"
                                         ;
    BIGNUM *pub_out = 
# 1854 "../test/evp_pkey_provided_test.c" 3 4
                     ((void *)0)
# 1854 "../test/evp_pkey_provided_test.c"
                         , *priv_out = 
# 1854 "../test/evp_pkey_provided_test.c" 3 4
                                       ((void *)0)
# 1854 "../test/evp_pkey_provided_test.c"
                                           ;
    BIGNUM *p_out = 
# 1855 "../test/evp_pkey_provided_test.c" 3 4
                   ((void *)0)
# 1855 "../test/evp_pkey_provided_test.c"
                       , *q_out = 
# 1855 "../test/evp_pkey_provided_test.c" 3 4
                                  ((void *)0)
# 1855 "../test/evp_pkey_provided_test.c"
...
# 1855 "../test/evp_pkey_provided_test.c"
    ...
    size_t len;
    OSSL_PARAM_BLD *bld = 
# 1860 "../test/evp_pkey_provided_test.c" 3 4
                         ((void *)0)
# 1860 "../test/evp_pkey_provided_test.c"
                             ;
    OSSL_PARAM *fromdata_params = 
# 1861 "../test/evp_pkey_provided_test.c" 3 4
                                 ((void *)0)
# 1861 "../test/evp_pkey_provided_test.c"
                                     ;
    ...
    if (!test_ptr("../test/evp_pkey_provided_test.c", 1965, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_pkey_provided_test.c", 1966, "pub = BN_bin2bn(pub_data, sizeof(pub_data), NULL)", pub = BN_bin2bn(pub_data, sizeof(pub_data), 
# 1966 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1966 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1967, "priv = BN_bin2bn(priv_data, sizeof(priv_data), NULL)", priv = BN_bin2bn(priv_data, sizeof(priv_data), 
# 1967 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1967 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1968, "p = BN_bin2bn(p_data, sizeof(p_data), NULL)", p = BN_bin2bn(p_data, sizeof(p_data), 
# 1968 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1968 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1969, "q = BN_bin2bn(q_data, sizeof(q_data), NULL)", q = BN_bin2bn(q_data, sizeof(q_data), 
# 1969 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1969 "../test/evp_pkey_provided_test.c"
           ))
        || !test_ptr("../test/evp_pkey_provided_test.c", 1970, "g = BN_bin2bn(g_data, sizeof(g_data), NULL)", g = BN_bin2bn(g_data, sizeof(g_data), 
# 1970 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 1970 "../test/evp_pkey_provided_test.c"
           ))

        || !test_true("../test/evp_pkey_provided_test.c", 1972, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 1973, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 1974, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0)
        || !test_true("../test/evp_pkey_provided_test.c", 1975, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_FFC_SEED, seed_data, sizeof(seed_data))", (OSSL_PARAM_BLD_push_octet_string(bld, "seed", seed_data, sizeof(seed_data))) != 0)



        || !test_true("../test/evp_pkey_provided_test.c", 1979, "OSSL_PARAM_BLD_push_int(bld, OSSL_PKEY_PARAM_FFC_GINDEX, gindex)", (OSSL_PARAM_BLD_push_int(bld, "gindex", gindex)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 1981, "OSSL_PARAM_BLD_push_int(bld, OSSL_PKEY_PARAM_FFC_PCOUNTER, pcounter)", (OSSL_PARAM_BLD_push_int(bld, "pcounter", pcounter)) != 0)


        || !test_true("../test/evp_pkey_provided_test.c", 1984, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)

        || !test_true("../test/evp_pkey_provided_test.c", 1986, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)

        || !test_ptr("../test/evp_pkey_provided_test.c", 1988, "fromdata_params = OSSL_PARAM_BLD_to_param(bld)", fromdata_params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 1991, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"DSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 1991 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1991 "../test/evp_pkey_provided_test.c"
        , "DSA", 
# 1991 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 1991 "../test/evp_pkey_provided_test.c"
    ...
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 1994, "EVP_PKEY_fromdata_init(ctx)", "1", EVP_PKEY_fromdata_init(ctx), 1)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 1995, "EVP_PKEY_fromdata(ctx, &pk, EVP_PKEY_KEYPAIR, fromdata_params)", "1", EVP_PKEY_fromdata(ctx, &pk, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), fromdata_params), 1)
                                                              )
        goto err;

    for (;;) {
        ret = 0;
        if (!test_int_eq("../test/evp_pkey_provided_test.c", 2001, "EVP_PKEY_get_bits(pk)", "2048", EVP_PKEY_get_bits(pk), 2048)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 2002, "EVP_PKEY_get_security_bits(pk)", "112", EVP_PKEY_get_security_bits(pk), 112)
            || !test_int_eq("../test/evp_pkey_provided_test.c", 2003, "EVP_PKEY_get_size(pk)", "2 + 2 * (3 + sizeof(q_data))", EVP_PKEY_get_size(pk), 2 + 2 * (3 + sizeof(q_data)))
            || !test_false("../test/evp_pkey_provided_test.c", 2004, "EVP_PKEY_missing_parameters(pk)", (EVP_PKEY_missing_parameters(pk)) != 0))
            goto err;

        if (!test_false("../test/evp_pkey_provided_test.c", 2007, "EVP_PKEY_get_utf8_string_param(pk, OSSL_PKEY_PARAM_GROUP_NAME, name_out, sizeof(name_out), &len)", (EVP_PKEY_get_utf8_string_param(pk, "group", name_out, sizeof(name_out), &len)) != 0)




            || !test_true("../test/evp_pkey_provided_test.c", 2012, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PUB_KEY, &pub_out)", (EVP_PKEY_get_bn_param(pk, "pub", &pub_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 2014, "pub", "pub_out", pub, pub_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2015, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_PRIV_KEY, &priv_out)", (EVP_PKEY_get_bn_param(pk, "priv", &priv_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 2017, "priv", "priv_out", priv, priv_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2018, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_P, &p_out)", (EVP_PKEY_get_bn_param(pk, "p", &p_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 2020, "p", "p_out", p, p_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2021, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_Q, &q_out)", (EVP_PKEY_get_bn_param(pk, "q", &q_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 2023, "q", "q_out", q, q_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2024, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_G, &g_out)", (EVP_PKEY_get_bn_param(pk, "g", &g_out)) != 0)

            || !test_BN_eq("../test/evp_pkey_provided_test.c", 2026, "g", "g_out", g, g_out)
            || !test_false("../test/evp_pkey_provided_test.c", 2027, "EVP_PKEY_get_bn_param(pk, OSSL_PKEY_PARAM_FFC_COFACTOR, &j_out)", (EVP_PKEY_get_bn_param(pk, "j", &j_out)) != 0)


            || !test_ptr_null("../test/evp_pkey_provided_test.c", 2030, "j_out", j_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2031, "EVP_PKEY_get_octet_string_param(pk, OSSL_PKEY_PARAM_FFC_SEED, seed_out, sizeof(seed_out), &len)", (EVP_PKEY_get_octet_string_param(pk, "seed", seed_out, sizeof(seed_out), &len)) != 0)




            || !test_true("../test/evp_pkey_provided_test.c", 2036, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_GINDEX, &gindex_out)", (EVP_PKEY_get_int_param(pk, "gindex", &gindex_out)) != 0)


            || !test_int_eq("../test/evp_pkey_provided_test.c", 2039, "gindex", "gindex_out", gindex, gindex_out)
            || !test_true("../test/evp_pkey_provided_test.c", 2040, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_H, &hindex_out)", (EVP_PKEY_get_int_param(pk, "hindex", &hindex_out)) != 0)

            || !test_int_eq("../test/evp_pkey_provided_test.c", 2042, "hindex_out", "0", hindex_out, 0)
            || !test_true("../test/evp_pkey_provided_test.c", 2043, "EVP_PKEY_get_int_param(pk, OSSL_PKEY_PARAM_FFC_PCOUNTER, &pcounter_out)", (EVP_PKEY_get_int_param(pk, "pcounter", &pcounter_out)) != 0)


            || !test_int_eq("../test/evp_pkey_provided_test.c", 2046, "pcounter", "pcounter_out", pcounter, pcounter_out))
            goto err;
        BN_free(p_out);
        p_out = 
# 2049 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 2049 "../test/evp_pkey_provided_test.c"
                   ;
        BN_free(q_out);
        q_out = 
# 2051 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 2051 "../test/evp_pkey_provided_test.c"
                   ;
        BN_free(g_out);
        g_out = 
# 2053 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 2053 "../test/evp_pkey_provided_test.c"
                   ;
        BN_free(j_out);
        j_out = 
# 2055 "../test/evp_pkey_provided_test.c" 3 4
               ((void *)0)
# 2055 "../test/evp_pkey_provided_test.c"
                   ;
        BN_free(pub_out);
        pub_out = 
# 2057 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 2057 "../test/evp_pkey_provided_test.c"
                     ;
        BN_free(priv_out);
        priv_out = 
# 2059 "../test/evp_pkey_provided_test.c" 3 4
                  ((void *)0)
# 2059 "../test/evp_pkey_provided_test.c"
                      ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 2061, "key_ctx = EVP_PKEY_CTX_new_from_pkey(NULL, pk, \"\")", key_ctx = EVP_PKEY_CTX_new_from_pkey(
# 2061 "../test/evp_pkey_provided_test.c" 3 4
            ((void *)0)
# 2061 "../test/evp_pkey_provided_test.c"
            , pk, "")))
            goto err;

        if (!test_int_gt("../test/evp_pkey_provided_test.c", 2064, "EVP_PKEY_check(key_ctx)", "0", EVP_PKEY_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 2065, "EVP_PKEY_public_check(key_ctx)", "0", EVP_PKEY_public_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 2066, "EVP_PKEY_private_check(key_ctx)", "0", EVP_PKEY_private_check(key_ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 2067, "EVP_PKEY_pairwise_check(key_ctx)", "0", EVP_PKEY_pairwise_check(key_ctx), 0))
            goto err;
        EVP_PKEY_CTX_free(key_ctx);
        key_ctx = 
# 2070 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 2070 "../test/evp_pkey_provided_test.c"
                     ;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 2072, "copy_pk = EVP_PKEY_new()", copy_pk = EVP_PKEY_new())
            || !test_true("../test/evp_pkey_provided_test.c", 2073, "EVP_PKEY_copy_parameters(copy_pk, pk)", (EVP_PKEY_copy_parameters(copy_pk, pk)) != 0))
            goto err;
        EVP_PKEY_free(copy_pk);
        copy_pk = 
# 2076 "../test/evp_pkey_provided_test.c" 3 4
                 ((void *)0)
# 2076 "../test/evp_pkey_provided_test.c"
                     ;
        ...
        if (!ret || dup_pk != 
# 2081 "../test/evp_pkey_provided_test.c" 3 4
                             ((void *)0)
# 2081 "../test/evp_pkey_provided_test.c"
                                 )
            break;

        if (!test_ptr("../test/evp_pkey_provided_test.c", 2084, "dup_pk = EVP_PKEY_dup(pk)", dup_pk = EVP_PKEY_dup(pk)))
            goto err;
        ret = ret && test_int_eq("../test/evp_pkey_provided_test.c", 2086, "EVP_PKEY_eq(pk, dup_pk)", "1", EVP_PKEY_eq(pk, dup_pk), 1);
        EVP_PKEY_free(pk);
        pk = dup_pk;
        if (!ret)
            goto err;
...
static int test_check_dsa(void)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 2118 "../test/evp_pkey_provided_test.c" 3 4
                       ((void *)0)
# 2118 "../test/evp_pkey_provided_test.c"
                           ;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 2120, "ctx = EVP_PKEY_CTX_new_from_name(NULL, \"DSA\", NULL)", ctx = EVP_PKEY_CTX_new_from_name(
# 2120 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 2120 "../test/evp_pkey_provided_test.c"
        , "DSA", 
# 2120 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 2120 "../test/evp_pkey_provided_test.c"
        ))
        || !test_int_le("../test/evp_pkey_provided_test.c", 2121, "EVP_PKEY_check(ctx)", "0", EVP_PKEY_check(ctx), 0)
        || !test_int_le("../test/evp_pkey_provided_test.c", 2122, "EVP_PKEY_public_check(ctx)", "0", EVP_PKEY_public_check(ctx), 0)
        || !test_int_le("../test/evp_pkey_provided_test.c", 2123, "EVP_PKEY_private_check(ctx)", "0", EVP_PKEY_private_check(ctx), 0)
        || !test_int_le("../test/evp_pkey_provided_test.c", 2124, "EVP_PKEY_pairwise_check(ctx)", "0", EVP_PKEY_pairwise_check(ctx), 0))
       goto err;
...
{
    OSSL_PARAM *params = CRYPTO_malloc(sizeof(OSSL_PARAM) * 5, "../test/evp_pkey_provided_test.c", 2139);
    OSSL_PARAM *p = params;
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("mode",
                                            "EXTRACT_ONLY", 0);
...
static int test_evp_pkey_ctx_dup_kdf(void)
{
    ...
    size_t len = 0, dlen = 0;
    EVP_PKEY_CTX *pctx = 
# 2158 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 2158 "../test/evp_pkey_provided_test.c"
                            , *dctx = 
# 2158 "../test/evp_pkey_provided_test.c" 3 4
                                      ((void *)0)
# 2158 "../test/evp_pkey_provided_test.c"
                                          ;
    OSSL_PARAM *params = 
# 2159 "../test/evp_pkey_provided_test.c" 3 4
                        ((void *)0)
# 2159 "../test/evp_pkey_provided_test.c"
                            ;

    if (!test_ptr("../test/evp_pkey_provided_test.c", 2161, "params = do_construct_hkdf_params(\"sha256\", \"secret\", 6, \"salt\")", params = do_construct_hkdf_params("sha256", "secret", 6, "salt"))
                                                            )
        goto err;
    if (!test_ptr("../test/evp_pkey_provided_test.c", 2164, "pctx = EVP_PKEY_CTX_new_from_name(NULL, \"HKDF\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(
# 2164 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 2164 "../test/evp_pkey_provided_test.c"
        , "HKDF", 
# 2164 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 2164 "../test/evp_pkey_provided_test.c"
        ...
        goto err;
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 2166, "EVP_PKEY_derive_init_ex(pctx, params)", "1", EVP_PKEY_derive_init_ex(pctx, params), 1))
        goto err;
    if (!test_ptr("../test/evp_pkey_provided_test.c", 2168, "dctx = EVP_PKEY_CTX_dup(pctx)", dctx = EVP_PKEY_CTX_dup(pctx)))
        goto err;
    if (!test_int_eq("../test/evp_pkey_provided_test.c", 2170, "EVP_PKEY_derive(pctx, NULL, &len)", "1", EVP_PKEY_derive(pctx, 
# 2170 "../test/evp_pkey_provided_test.c" 3 4
        ((void *)0)
# 2170 "../test/evp_pkey_provided_test.c"
        , &len), 1)
        || !test_size_t_eq("../test/evp_pkey_provided_test.c", 2171, "len", "SHA256_DIGEST_LENGTH", len, 32)
        || !test_int_eq("../test/evp_pkey_provided_test.c", 2172, "EVP_PKEY_derive(dctx, NULL, &dlen)", "1", EVP_PKEY_derive(dctx, 
# 2172 "../test/evp_pkey_provided_test.c" 3 4
           ((void *)0)
# 2172 "../test/evp_pkey_provided_test.c"
           , &dlen), 1)
        || !test_size_t_eq("../test/evp_pkey_provided_test.c", 2173, "dlen", "SHA256_DIGEST_LENGTH", dlen, 32))
        goto err;
    ret = 1;
err:
    CRYPTO_free(params, "../test/evp_pkey_provided_test.c", 2177);
...
# 2193 "../test/evp_pkey_provided_test.c" 3 4
   ((void *)0)

# 2194 "../test/evp_pkey_provided_test.c"
};
...
static int test_name_dup(int idx)
{
    ...
    EVP_PKEY *key = 
# 2199 "../test/evp_pkey_provided_test.c" 3 4
                   ((void *)0)
# 2199 "../test/evp_pkey_provided_test.c"
                       ;
    EVP_PKEY_CTX *factory = 
# 2200 "../test/evp_pkey_provided_test.c" 3 4
                           ((void *)0)
# 2200 "../test/evp_pkey_provided_test.c"
                               , *ctx = 
# 2200 "../test/evp_pkey_provided_test.c" 3 4
                                        ((void *)0)
# 2200 "../test/evp_pkey_provided_test.c"
    ...
    if (alg == 
# 2203 "../test/evp_pkey_provided_test.c" 3 4
              ((void *)0)
        
# 2204 "../test/evp_pkey_provided_test.c"
       || (factory = EVP_PKEY_CTX_new_from_name(
# 2204 "../test/evp_pkey_provided_test.c" 3 4
                                                ((void *)0)
# 2204 "../test/evp_pkey_provided_test.c"
                                                    , alg, 
# 2204 "../test/evp_pkey_provided_test.c" 3 4
...
# 2204 "../test/evp_pkey_provided_test.c"
        ...
        return 1;
    test_info("../test/evp_pkey_provided_test.c", 2206, "Testing fresh context dup for: %s", alg);
    ...
    for (i = 0; i < 2; ++i) {
        ...
        EVP_PKEY_free(key);
        key = 
# 2212 "../test/evp_pkey_provided_test.c" 3 4
             ((void *)0)
# 2212 "../test/evp_pkey_provided_test.c"
                 ;
        if (!test_ptr("../test/evp_pkey_provided_test.c", 2213, "ctx = EVP_PKEY_CTX_dup(factory)", ctx = EVP_PKEY_CTX_dup(factory))
            || !test_int_gt("../test/evp_pkey_provided_test.c", 2214, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0)
            || !test_int_gt("../test/evp_pkey_provided_test.c", 2215, "EVP_PKEY_keygen(ctx, &key)", "0", EVP_PKEY_keygen(ctx, &key), 0)) {
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/evp_pkey_provided_test.c", 2233, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/evp_pkey_provided_test.c", 2237, "datadir = test_get_argument(0)", datadir = test_get_argument(0)))
        return 0;

    add_test("test_evp_pkey_ctx_dup_kdf", test_evp_pkey_ctx_dup_kdf);
    add_all_tests("test_name_dup", test_name_dup, (sizeof(name_dup_algs)/sizeof((name_dup_algs)[0])), 1);
    ...
    add_all_tests("test_fromdata_ecx", test_fromdata_ecx, 4 * 3, 1);
