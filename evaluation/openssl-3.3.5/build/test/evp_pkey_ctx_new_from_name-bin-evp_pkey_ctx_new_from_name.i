# 0 "../test/evp_pkey_ctx_new_from_name.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_pkey_ctx_new_from_name.c"
...
# 2 "../test/evp_pkey_ctx_new_from_name.c" 2
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 3 "../test/evp_pkey_ctx_new_from_name.c" 2
...
# 4 "../test/evp_pkey_ctx_new_from_name.c" 2
...
# 5 "../test/evp_pkey_ctx_new_from_name.c" 2

int main(int argc, char *argv[])
{
    EVP_PKEY_CTX *pctx = 
# 8 "../test/evp_pkey_ctx_new_from_name.c" 3 4
                        ((void *)0)
# 8 "../test/evp_pkey_ctx_new_from_name.c"
                            ;

    pctx = EVP_PKEY_CTX_new_from_name(
# 10 "../test/evp_pkey_ctx_new_from_name.c" 3 4
                                     ((void *)0)
# 10 "../test/evp_pkey_ctx_new_from_name.c"
                                         , "NO_SUCH_ALGORITHM", 
# 10 "../test/evp_pkey_ctx_new_from_name.c" 3 4
                                                                ((void *)0)
# 10 "../test/evp_pkey_ctx_new_from_name.c"
