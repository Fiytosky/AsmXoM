...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 16 "../test/cmsapitest.c" 2
# 1 "../test/../crypto/cms/cms_local.h" 1
# 21 "../test/../crypto/cms/cms_local.h"
...
# 390 "../test/../crypto/cms/cms_local.h"
...
# 19 "../test/cmsapitest.c" 2

static X509 *cert = 
# 20 "../test/cmsapitest.c" 3 4
                   ((void *)0)
# 20 "../test/cmsapitest.c"
                       ;
static EVP_PKEY *privkey = 
# 21 "../test/cmsapitest.c" 3 4
                          ((void *)0)
# 21 "../test/cmsapitest.c"
                              ;
static char *derin = 
# 22 "../test/cmsapitest.c" 3 4
                    ((void *)0)
# 22 "../test/cmsapitest.c"
                        ;

static int test_encrypt_decrypt(const EVP_CIPHER *cipher)
{
    int testresult = 0;
    struct stack_st_X509 *certstack = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    const char *msg = "Hello world";
    BIO *msgbio = BIO_new_mem_buf(msg, strlen(msg));
    BIO *outmsgbio = BIO_new(BIO_s_mem());
    CMS_ContentInfo* content = 
# 31 "../test/cmsapitest.c" 3 4
                              ((void *)0)
# 31 "../test/cmsapitest.c"
                                  ;
    BIO *contentbio = 
# 32 "../test/cmsapitest.c" 3 4
                     ((void *)0)
# 32 "../test/cmsapitest.c"
                         ;
    char buf[80];

    if (!test_ptr("../test/cmsapitest.c", 35, "certstack", certstack) || !test_ptr("../test/cmsapitest.c", 35, "msgbio", msgbio) || !test_ptr("../test/cmsapitest.c", 35, "outmsgbio", outmsgbio))
        goto end;

    if (!test_int_gt("../test/cmsapitest.c", 38, "sk_X509_push(certstack, cert)", "0", OPENSSL_sk_push(ossl_check_X509_sk_type(certstack), ossl_check_X509_type(cert)), 0))
        goto end;

    content = CMS_encrypt(certstack, msgbio, cipher, 0x1);
    if (!test_ptr("../test/cmsapitest.c", 42, "content", content))
        goto end;

    if (!test_true("../test/cmsapitest.c", 45, "CMS_decrypt(content, privkey, cert, NULL, outmsgbio, CMS_TEXT)", (CMS_decrypt(content, privkey, cert, 
# 45 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 45 "../test/cmsapitest.c"
        , outmsgbio, 0x1)) != 0)
                                         )
        goto end;

    if (!test_ptr("../test/cmsapitest.c", 49, "contentbio = CMS_EnvelopedData_decrypt(content->d.envelopedData, NULL, privkey, cert, NULL, CMS_TEXT, NULL, NULL)", contentbio = CMS_EnvelopedData_decrypt(content->d.envelopedData, 
# 49 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 49 "../test/cmsapitest.c"
        , privkey, cert, 
# 49 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 49 "../test/cmsapitest.c"
...
# 49 "../test/cmsapitest.c"
    ...
    if (!test_int_eq("../test/cmsapitest.c", 56, "BIO_gets(outmsgbio, buf, sizeof(buf))", "strlen(msg)", BIO_gets(outmsgbio, buf, sizeof(buf)), strlen(msg))
            || !test_int_eq("../test/cmsapitest.c", 57, "strcmp(buf, msg)", "0", strcmp(buf, msg), 0))
        goto end;

    testresult = 1;
 end:
    BIO_free(contentbio);
    OPENSSL_sk_free(ossl_check_X509_sk_type(certstack));
    BIO_free(msgbio);
    BIO_free(outmsgbio);
    CMS_ContentInfo_free(content);

    return testresult && test_int_eq("../test/cmsapitest.c", 68, "ERR_peek_error()", "0", ERR_peek_error(), 0);
}
...
{
    CMS_ContentInfo *cms = 
# 93 "../test/cmsapitest.c" 3 4
                          ((void *)0)
# 93 "../test/cmsapitest.c"
                              ;
    int ret = 0;

    ret = test_ptr("../test/cmsapitest.c", 96, "cms = CMS_ContentInfo_new()", cms = CMS_ContentInfo_new())
        && test_ptr("../test/cmsapitest.c", 97, "CMS_add1_signer(cms, cert, privkey, NULL, 0)", CMS_add1_signer(cms, cert, privkey, 
# 97 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 97 "../test/cmsapitest.c"
          , 0))
        && test_true("../test/cmsapitest.c", 98, "CMS_add1_cert(cms, cert)", (CMS_add1_cert(cms, cert)) != 0);
...
{
    BIO *bio, *content = 
# 106 "../test/cmsapitest.c" 3 4
                        ((void *)0)
# 106 "../test/cmsapitest.c"
                            ;
    CMS_ContentInfo *cms = 
# 107 "../test/cmsapitest.c" 3 4
                          ((void *)0)
# 107 "../test/cmsapitest.c"
                              ;
    ...
    ret = test_ptr("../test/cmsapitest.c", 306, "bio = BIO_new_mem_buf(cms_data, sizeof(cms_data))", bio = BIO_new_mem_buf(cms_data, sizeof(cms_data)))
        && test_ptr("../test/cmsapitest.c", 307, "cms = d2i_CMS_bio(bio, NULL)", cms = d2i_CMS_bio(bio, 
# 307 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 307 "../test/cmsapitest.c"
          ))
        && test_true("../test/cmsapitest.c", 308, "CMS_verify(cms, NULL, NULL, NULL, NULL, flags)", (CMS_verify(cms, 
# 308 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 308 "../test/cmsapitest.c"
          , 
# 308 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 308 "../test/cmsapitest.c"
...
# 308 "../test/cmsapitest.c"
          , flags)) != 0)
        && test_ptr("../test/cmsapitest.c", 309, "content = CMS_SignedData_verify(cms->d.signedData, NULL, NULL, NULL, NULL, NULL, flags, NULL, NULL)", content = CMS_SignedData_verify(cms->d.signedData, 
# 309 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 309 "../test/cmsapitest.c"
          , 
# 309 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 309 "../test/cmsapitest.c"
...
# 309 "../test/cmsapitest.c"
    ...
    CMS_ContentInfo_free(cms);
    BIO_free(bio);
    return ret && test_int_eq("../test/cmsapitest.c", 315, "ERR_peek_error()", "0", ERR_peek_error(), 0);
}
...
static unsigned char *read_all(BIO *bio, long *p_len)
{
    const int step = 256;
    unsigned char *buf = 
# 321 "../test/cmsapitest.c" 3 4
                        ((void *)0)
# 321 "../test/cmsapitest.c"
                            ;
    unsigned char *tmp = 
# 322 "../test/cmsapitest.c" 3 4
                        ((void *)0)
# 322 "../test/cmsapitest.c"
                            ;
    int ret;

    *p_len = 0;
    for (;;) {
        tmp = CRYPTO_realloc(buf, *p_len + step, "../test/cmsapitest.c", 327);
        if (tmp == 
# 328 "../test/cmsapitest.c" 3 4
                  ((void *)0)
# 328 "../test/cmsapitest.c"
                      )
            break;
        buf = tmp;
    ...
    CRYPTO_free(buf, "../test/cmsapitest.c", 342);
    *p_len = 0;
    return 
# 344 "../test/cmsapitest.c" 3 4
          ((void *)0)
# 344 "../test/cmsapitest.c"
              ;
}
...
{
    BIO *bio = 
# 349 "../test/cmsapitest.c" 3 4
              ((void *)0)
# 349 "../test/cmsapitest.c"
                  ;
    CMS_ContentInfo *cms = 
# 350 "../test/cmsapitest.c" 3 4
                          ((void *)0)
# 350 "../test/cmsapitest.c"
                              ;
    unsigned char *buf = 
# 351 "../test/cmsapitest.c" 3 4
                        ((void *)0)
# 351 "../test/cmsapitest.c"
                            ;
    const unsigned char *tmp = 
# 352 "../test/cmsapitest.c" 3 4
                              ((void *)0)
# 352 "../test/cmsapitest.c"
                                  ;
    long buf_len = 0;
    int ret = 0;

    if (!test_ptr("../test/cmsapitest.c", 356, "bio = BIO_new_file(derin, \"r\")", bio = BIO_new_file(derin, "r")))
      goto end;

    switch (idx) {
    case 0:
        if (!test_ptr("../test/cmsapitest.c", 361, "cms = d2i_CMS_bio(bio, NULL)", cms = d2i_CMS_bio(bio, 
# 361 "../test/cmsapitest.c" 3 4
            ((void *)0)
# 361 "../test/cmsapitest.c"
            )))
            goto end;
        break;
    case 1:
        if (!test_ptr("../test/cmsapitest.c", 365, "buf = read_all(bio, &buf_len)", buf = read_all(bio, &buf_len)))
            goto end;
        tmp = buf;
        if (!test_ptr("../test/cmsapitest.c", 368, "cms = d2i_CMS_ContentInfo(NULL, &tmp, buf_len)", cms = d2i_CMS_ContentInfo(
# 368 "../test/cmsapitest.c" 3 4
            ((void *)0)
# 368 "../test/cmsapitest.c"
            , &tmp, buf_len)))
            goto end;
        break;
    }

    if (!test_int_eq("../test/cmsapitest.c", 373, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto end;
    ...
    CMS_ContentInfo_free(cms);
    BIO_free(bio);
    CRYPTO_free(buf, "../test/cmsapitest.c", 380);

    return ret;
}

const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "certfile privkeyfile derfile\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 385 "../test/cmsapitest.c" 3 4
((void *)0) 
# 385 "../test/cmsapitest.c"
} }; return options; }

int setup_tests(void)
{
    char *certin = 
# 389 "../test/cmsapitest.c" 3 4
                  ((void *)0)
# 389 "../test/cmsapitest.c"
                      , *privkeyin = 
# 389 "../test/cmsapitest.c" 3 4
                                     ((void *)0)
# 389 "../test/cmsapitest.c"
                                         ;
    BIO *certbio = 
# 390 "../test/cmsapitest.c" 3 4
                  ((void *)0)
# 390 "../test/cmsapitest.c"
                      , *privkeybio = 
# 390 "../test/cmsapitest.c" 3 4
                                      ((void *)0)
# 390 "../test/cmsapitest.c"
    ...
    if (!test_skip_common_options()) {
        test_error("../test/cmsapitest.c", 393, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/cmsapitest.c", 397, "certin = test_get_argument(0)", certin = test_get_argument(0))
            || !test_ptr("../test/cmsapitest.c", 398, "privkeyin = test_get_argument(1)", privkeyin = test_get_argument(1))
            || !test_ptr("../test/cmsapitest.c", 399, "derin = test_get_argument(2)", derin = test_get_argument(2)))
        return 0;

    certbio = BIO_new_file(certin, "r");
    if (!test_ptr("../test/cmsapitest.c", 403, "certbio", certbio))
        return 0;
    if (!test_true("../test/cmsapitest.c", 405, "PEM_read_bio_X509(certbio, &cert, NULL, NULL)", (PEM_read_bio_X509(certbio, &cert, 
# 405 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 405 "../test/cmsapitest.c"
        , 
# 405 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 405 "../test/cmsapitest.c"
    ...
    if (!test_ptr("../test/cmsapitest.c", 412, "privkeybio", privkeybio)) {
        X509_free(cert);
        cert = 
# 414 "../test/cmsapitest.c" 3 4
              ((void *)0)
# 414 "../test/cmsapitest.c"
                  ;
        return 0;
    }
    if (!test_true("../test/cmsapitest.c", 417, "PEM_read_bio_PrivateKey(privkeybio, &privkey, NULL, NULL)", (PEM_read_bio_PrivateKey(privkeybio, &privkey, 
# 417 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 417 "../test/cmsapitest.c"
        , 
# 417 "../test/cmsapitest.c" 3 4
        ((void *)0)
# 417 "../test/cmsapitest.c"
        ...
        X509_free(cert);
        cert = 
# 420 "../test/cmsapitest.c" 3 4
              ((void *)0)
# 420 "../test/cmsapitest.c"
                  ;
        return 0;
    }
    BIO_free(privkeybio);
    ...
    add_test("test_d2i_CMS_bio_NULL", test_d2i_CMS_bio_NULL);
