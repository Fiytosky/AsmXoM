# 0 "../test/helpers/predefined_dhparams.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/predefined_dhparams.c"
# 10 "../test/helpers/predefined_dhparams.c"
...
# 11 "../test/helpers/predefined_dhparams.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../test/helpers/predefined_dhparams.c" 2
...
# 13 "../test/helpers/predefined_dhparams.c" 2
...
# 15 "../test/helpers/predefined_dhparams.c" 2
...
{
    EVP_PKEY_CTX *pctx = EVP_PKEY_CTX_new_from_name(libctx, type, 
# 21 "../test/helpers/predefined_dhparams.c" 3 4
                                                                 ((void *)0)
# 21 "../test/helpers/predefined_dhparams.c"
                                                                     );
    OSSL_PARAM_BLD *tmpl = 
# 22 "../test/helpers/predefined_dhparams.c" 3 4
                          ((void *)0)
# 22 "../test/helpers/predefined_dhparams.c"
                              ;
    OSSL_PARAM *params = 
# 23 "../test/helpers/predefined_dhparams.c" 3 4
                        ((void *)0)
# 23 "../test/helpers/predefined_dhparams.c"
                            ;
    EVP_PKEY *dhpkey = 
# 24 "../test/helpers/predefined_dhparams.c" 3 4
                      ((void *)0)
# 24 "../test/helpers/predefined_dhparams.c"
                          ;

    if (pctx == 
# 26 "../test/helpers/predefined_dhparams.c" 3 4
               ((void *)0) 
# 26 "../test/helpers/predefined_dhparams.c"
                    || EVP_PKEY_fromdata_init(pctx) <= 0)
        goto err;

    if ((tmpl = OSSL_PARAM_BLD_new()) == 
# 29 "../test/helpers/predefined_dhparams.c" 3 4
                                        ((void *)0)
            
# 30 "../test/helpers/predefined_dhparams.c"
           || !OSSL_PARAM_BLD_push_BN(tmpl, "p", p)
            || !OSSL_PARAM_BLD_push_BN(tmpl, "g", g)
            || (q != 
# 32 "../test/helpers/predefined_dhparams.c" 3 4
                    ((void *)0)
                
# 33 "../test/helpers/predefined_dhparams.c"
               && !OSSL_PARAM_BLD_push_BN(tmpl, "q", q)))
        goto err;

    params = OSSL_PARAM_BLD_to_param(tmpl);
    if (params == 
# 37 "../test/helpers/predefined_dhparams.c" 3 4
                 ((void *)0)
        
# 38 "../test/helpers/predefined_dhparams.c"
       || EVP_PKEY_fromdata(pctx, &dhpkey, ( ( 0x04 | 0x80) ), params) <= 0)
        goto err;
...
{
    EVP_PKEY *dhpkey = 
# 53 "../test/helpers/predefined_dhparams.c" 3 4
                      ((void *)0)
# 53 "../test/helpers/predefined_dhparams.c"
                          ;
    BIGNUM *p = 
# 54 "../test/helpers/predefined_dhparams.c" 3 4
               ((void *)0)
# 54 "../test/helpers/predefined_dhparams.c"
                   , *g = 
# 54 "../test/helpers/predefined_dhparams.c" 3 4
                          ((void *)0)
# 54 "../test/helpers/predefined_dhparams.c"
...
# 54 "../test/helpers/predefined_dhparams.c"
    ...
    p = BN_bin2bn(pdata, plen, 
# 56 "../test/helpers/predefined_dhparams.c" 3 4
                              ((void *)0)
# 56 "../test/helpers/predefined_dhparams.c"
                                  );
    g = BN_bin2bn(gdata, glen, 
# 57 "../test/helpers/predefined_dhparams.c" 3 4
                              ((void *)0)
# 57 "../test/helpers/predefined_dhparams.c"
                                  );
    if (p == 
# 58 "../test/helpers/predefined_dhparams.c" 3 4
            ((void *)0) 
# 58 "../test/helpers/predefined_dhparams.c"
                 || g == 
# 58 "../test/helpers/predefined_dhparams.c" 3 4
                         ((void *)0)
# 58 "../test/helpers/predefined_dhparams.c"
        ...
        goto err;
    if (qdata != 
# 60 "../test/helpers/predefined_dhparams.c" 3 4
                ((void *)0) 
# 60 "../test/helpers/predefined_dhparams.c"
                     && (q = BN_bin2bn(qdata, qlen, 
# 60 "../test/helpers/predefined_dhparams.c" 3 4
                                                    ((void *)0)
# 60 "../test/helpers/predefined_dhparams.c"
                                                        )) == 
...
# 87 "../test/helpers/predefined_dhparams.c" 3 4
                                                   ((void *)0)
# 87 "../test/helpers/predefined_dhparams.c"
                                                       , 0);
}
...
# 149 "../test/helpers/predefined_dhparams.c" 3 4
                                                     ((void *)0)
# 149 "../test/helpers/predefined_dhparams.c"
                                                         , 0);
}
...
{
    BIGNUM *p = 
# 154 "../test/helpers/predefined_dhparams.c" 3 4
               ((void *)0)
# 154 "../test/helpers/predefined_dhparams.c"
                   , *g = 
# 154 "../test/helpers/predefined_dhparams.c" 3 4
                          ((void *)0)
# 154 "../test/helpers/predefined_dhparams.c"
                              ;
    EVP_PKEY *dhpkey = 
# 155 "../test/helpers/predefined_dhparams.c" 3 4
                      ((void *)0)
# 155 "../test/helpers/predefined_dhparams.c"
                          ;

    g = BN_new();
    if (g == 
# 158 "../test/helpers/predefined_dhparams.c" 3 4
            ((void *)0) 
# 158 "../test/helpers/predefined_dhparams.c"
                 || !BN_set_word(g, 2))
        goto err;

    p = BN_get_rfc3526_prime_2048(
# 161 "../test/helpers/predefined_dhparams.c" 3 4
                                 ((void *)0)
# 161 "../test/helpers/predefined_dhparams.c"
                                     );
    if (p == 
# 162 "../test/helpers/predefined_dhparams.c" 3 4
            ((void *)0)
# 162 "../test/helpers/predefined_dhparams.c"
                )
        goto err;

    dhpkey = get_dh_from_pg_bn(libctx, "DH", p, g, 
# 165 "../test/helpers/predefined_dhparams.c" 3 4
                                                  ((void *)0)
# 165 "../test/helpers/predefined_dhparams.c"
                                                      );
...
{
    BIGNUM *p = 
# 175 "../test/helpers/predefined_dhparams.c" 3 4
               ((void *)0)
# 175 "../test/helpers/predefined_dhparams.c"
                   , *g = 
# 175 "../test/helpers/predefined_dhparams.c" 3 4
                          ((void *)0)
# 175 "../test/helpers/predefined_dhparams.c"
                              ;
    EVP_PKEY *dhpkey = 
# 176 "../test/helpers/predefined_dhparams.c" 3 4
                      ((void *)0)
# 176 "../test/helpers/predefined_dhparams.c"
                          ;

    g = BN_new();
    if (g == 
# 179 "../test/helpers/predefined_dhparams.c" 3 4
            ((void *)0) 
# 179 "../test/helpers/predefined_dhparams.c"
                 || !BN_set_word(g, 2))
        goto err;

    p = BN_get_rfc3526_prime_4096(
# 182 "../test/helpers/predefined_dhparams.c" 3 4
                                 ((void *)0)
# 182 "../test/helpers/predefined_dhparams.c"
                                     );
    if (p == 
# 183 "../test/helpers/predefined_dhparams.c" 3 4
            ((void *)0)
# 183 "../test/helpers/predefined_dhparams.c"
                )
        goto err;

    dhpkey = get_dh_from_pg_bn(libctx, "DH", p, g, 
# 186 "../test/helpers/predefined_dhparams.c" 3 4
                                                  ((void *)0)
# 186 "../test/helpers/predefined_dhparams.c"
                                                      );
