# 0 "../test/helpers/handshake_srp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/handshake_srp.c"
# 17 "../test/helpers/handshake_srp.c"
...
# 18 "../test/helpers/handshake_srp.c" 2
...
# 19 "../test/helpers/handshake_srp.c" 2
...
# 20 "../test/helpers/handshake_srp.c" 2
...
# 21 "../test/helpers/handshake_srp.c" 2

static char *client_srp_cb(SSL *s, void *arg)
{
    CTX_DATA *ctx_data = (CTX_DATA*)(arg);
    return CRYPTO_strdup(ctx_data->srp_password, "../test/helpers/handshake_srp.c", 25);
}
...
int configure_handshake_ctx_for_srp(SSL_CTX *server_ctx, SSL_CTX *server2_ctx,
                                    ...
                                    CTX_DATA *client_ctx_data)
{
    if (extra->server.srp_user != 
# 49 "../test/helpers/handshake_srp.c" 3 4
                                 ((void *)0)
# 49 "../test/helpers/handshake_srp.c"
                                     ) {
        SSL_CTX_set_srp_username_callback(server_ctx, server_srp_cb);
        server_ctx_data->srp_user = CRYPTO_strdup(extra->server.srp_user, "../test/helpers/handshake_srp.c", 51);
        server_ctx_data->srp_password = CRYPTO_strdup(extra->server.srp_password, "../test/helpers/handshake_srp.c", 52);
        if (server_ctx_data->srp_user == 
# 53 "../test/helpers/handshake_srp.c" 3 4
                                        ((void *)0) 
# 53 "../test/helpers/handshake_srp.c"
                                             || server_ctx_data->srp_password == 
# 53 "../test/helpers/handshake_srp.c" 3 4
                                                                                 ((void *)0)
# 53 "../test/helpers/handshake_srp.c"
                                                                                     ) {
            CRYPTO_free(server_ctx_data->srp_user, "../test/helpers/handshake_srp.c", 54);
            CRYPTO_free(server_ctx_data->srp_password, "../test/helpers/handshake_srp.c", 55);
            server_ctx_data->srp_user = 
# 56 "../test/helpers/handshake_srp.c" 3 4
                                       ((void *)0)
# 56 "../test/helpers/handshake_srp.c"
                                           ;
            server_ctx_data->srp_password = 
# 57 "../test/helpers/handshake_srp.c" 3 4
                                           ((void *)0)
# 57 "../test/helpers/handshake_srp.c"
                                               ;
            return 0;
        }
        SSL_CTX_set_srp_cb_arg(server_ctx, server_ctx_data);
    }
    if (extra->server2.srp_user != 
# 62 "../test/helpers/handshake_srp.c" 3 4
                                  ((void *)0)
# 62 "../test/helpers/handshake_srp.c"
                                      ) {
        if (!test_ptr("../test/helpers/handshake_srp.c", 63, "server2_ctx", server2_ctx))
            return 0;
        SSL_CTX_set_srp_username_callback(server2_ctx, server_srp_cb);
        server2_ctx_data->srp_user = CRYPTO_strdup(extra->server2.srp_user, "../test/helpers/handshake_srp.c", 66);
        server2_ctx_data->srp_password = CRYPTO_strdup(extra->server2.srp_password, "../test/helpers/handshake_srp.c", 67);
        if (server2_ctx_data->srp_user == 
# 68 "../test/helpers/handshake_srp.c" 3 4
                                         ((void *)0) 
# 68 "../test/helpers/handshake_srp.c"
                                              || server2_ctx_data->srp_password == 
# 68 "../test/helpers/handshake_srp.c" 3 4
                                                                                   ((void *)0)
# 68 "../test/helpers/handshake_srp.c"
                                                                                       ) {
            CRYPTO_free(server2_ctx_data->srp_user, "../test/helpers/handshake_srp.c", 69);
            CRYPTO_free(server2_ctx_data->srp_password, "../test/helpers/handshake_srp.c", 70);
            server2_ctx_data->srp_user = 
# 71 "../test/helpers/handshake_srp.c" 3 4
                                        ((void *)0)
# 71 "../test/helpers/handshake_srp.c"
                                            ;
            server2_ctx_data->srp_password = 
# 72 "../test/helpers/handshake_srp.c" 3 4
                                            ((void *)0)
# 72 "../test/helpers/handshake_srp.c"
                                                ;
            return 0;
        }
        SSL_CTX_set_srp_cb_arg(server2_ctx, server2_ctx_data);
    }
    if (extra->client.srp_user != 
# 77 "../test/helpers/handshake_srp.c" 3 4
                                 ((void *)0)
# 77 "../test/helpers/handshake_srp.c"
                                     ) {
        if (!test_true("../test/helpers/handshake_srp.c", 78, "SSL_CTX_set_srp_username(client_ctx, extra->client.srp_user)", (SSL_CTX_set_srp_username(client_ctx, extra->client.srp_user)) != 0)
                                                                        )
            return 0;
        SSL_CTX_set_srp_client_pwd_callback(client_ctx, client_srp_cb);
        client_ctx_data->srp_password = CRYPTO_strdup(extra->client.srp_password, "../test/helpers/handshake_srp.c", 82);
        if (client_ctx_data->srp_password == 
# 83 "../test/helpers/handshake_srp.c" 3 4
                                            ((void *)0)
# 83 "../test/helpers/handshake_srp.c"
                                                )
            return 0;
