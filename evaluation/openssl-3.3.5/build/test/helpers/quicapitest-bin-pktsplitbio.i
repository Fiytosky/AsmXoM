# 0 "../test/helpers/pktsplitbio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/pktsplitbio.c"
# 10 "../test/helpers/pktsplitbio.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 11 "../test/helpers/pktsplitbio.c" 2
...
# 12 "../test/helpers/pktsplitbio.c" 2
...
# 13 "../test/helpers/pktsplitbio.c" 2
...
static long pkt_split_dgram_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (next == 
# 19 "../test/helpers/pktsplitbio.c" 3 4
               ((void *)0)
# 19 "../test/helpers/pktsplitbio.c"
                   )
        return 0;
                                    ...
                                    size_t *msgs_processed)
{
    ...
    if (next == 
# 39 "../test/helpers/pktsplitbio.c" 3 4
               ((void *)0)
# 39 "../test/helpers/pktsplitbio.c"
                   )
        return 0;
                                    ...
                                    size_t *msgs_processed)
{
    ...
    if (!test_ptr("../test/helpers/pktsplitbio.c", 57, "next", next))
        return 0;
# 67 "../test/helpers/pktsplitbio.c"
    for (i = 0; i < num_msg; i++) {
        if (i == 0)
            data_len = msg[i].data_len;
        else if (!test_size_t_eq("../test/helpers/pktsplitbio.c", 70, "msg[i].data_len", "data_len", msg[i].data_len, data_len))
            return 0;
    }
...
# 80 "../test/helpers/pktsplitbio.c" 3 4
   ((void) (0))
# 80 "../test/helpers/pktsplitbio.c"
                            ;
    ...
    for (i = 0, thismsg = msg; i < msg_cnt; i++, thismsg++) {
        ...
        if (ossl_quic_wire_decode_pkt_hdr(&pkt, 0, 0, 0, &hdr, 
# 95 "../test/helpers/pktsplitbio.c" 3 4
                                                              ((void *)0)
# 95 "../test/helpers/pktsplitbio.c"
                                                                  ) != 1)
            return 0;
...
static BIO_METHOD *method_pkt_split_dgram = 
# 119 "../test/helpers/pktsplitbio.c" 3 4
                                           ((void *)0)
# 119 "../test/helpers/pktsplitbio.c"
                                               ;


const BIO_METHOD *bio_f_pkt_split_dgram_filter(void)
{
    if (method_pkt_split_dgram == 
# 124 "../test/helpers/pktsplitbio.c" 3 4
                                 ((void *)0)
# 124 "../test/helpers/pktsplitbio.c"
                                     ) {
        method_pkt_split_dgram = BIO_meth_new((0x81 | 0x0200),
                                              "Packet splitting datagram filter");
        if (method_pkt_split_dgram == 
# 127 "../test/helpers/pktsplitbio.c" 3 4
                                     ((void *)0)
            
# 128 "../test/helpers/pktsplitbio.c"
           || !BIO_meth_set_ctrl(method_pkt_split_dgram, pkt_split_dgram_ctrl)
            ...
            return 
# 133 "../test/helpers/pktsplitbio.c" 3 4
                  ((void *)0)
# 133 "../test/helpers/pktsplitbio.c"
                      ;
    }
