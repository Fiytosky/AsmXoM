# 0 "../test/helpers/noisydgrambio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/noisydgrambio.c"
# 10 "../test/helpers/noisydgrambio.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 11 "../test/helpers/noisydgrambio.c" 2
...
# 12 "../test/helpers/noisydgrambio.c" 2
...
# 13 "../test/helpers/noisydgrambio.c" 2
...
struct bw_limiter_st {
    struct pkt_info_st pinfos[1024];
    size_t start, num;
    size_t size_sum;
    size_t bw;
};
...
static long noisy_dgram_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (next == 
# 46 "../test/helpers/noisydgrambio.c" 3 4
               ((void *)0)
# 46 "../test/helpers/noisydgrambio.c"
                   )
        return 0;
    ...
    case 1001: {
            ...
            if (!test_ptr("../test/helpers/noisydgrambio.c", 57, "data", data))
                return 0;
            data->backoff = 1;
            ret = 1;
            break;
    ...
    case 1002: {
            ...
            data = BIO_get_data(bio);
            if (!test_ptr("../test/helpers/noisydgrambio.c", 67, "data", data))
                return 0;
    ...
    case 1003: {
            ...
            data = BIO_get_data(bio);
            if (!test_ptr("../test/helpers/noisydgrambio.c", 77, "data", data))
                return 0;
    ...
    case 1004: {
            ...
            data = BIO_get_data(bio);
            if (!test_ptr("../test/helpers/noisydgrambio.c", 87, "data", data))
                return 0;
    ...
    case 1005: {
            ...
            data = BIO_get_data(bio);
            if (!test_ptr("../test/helpers/noisydgrambio.c", 98, "data", data))
                return 0;
                              ...
                              BIO_MSG *msg, size_t num_msg)
{
    ...
    OSSL_TIME sampling_start
        = ossl_time_subtract(now, ossl_ticks2time((10) * (((uint64_t)1000000000) / 1000)));
    ...
    for (i = 0; i < num_msg; ++i) {
         ...
         if ((limit->size_sum + pktsize) / 10 > limit->bw) {
# 151 "../test/helpers/noisydgrambio.c"
             num_msg = i;
             break;
         }
         ...
         if (limit->num >= 1024) {
             ...
             limit->start = (limit->start + 1) % 1024;
         } else {
           ++limit->num;
         }
         end = (limit->start + limit->num) % 1024;
                                ...
                                size_t *msgs_processed)
{
    ...
    if (next == 
# 177 "../test/helpers/noisydgrambio.c" 3 4
               ((void *)0)
# 177 "../test/helpers/noisydgrambio.c"
                   )
        return 0;

    data = BIO_get_data(bio);
    if (!test_ptr("../test/helpers/noisydgrambio.c", 181, "data", data))
        return 0;

    now = data->now_cb != 
# 184 "../test/helpers/noisydgrambio.c" 3 4
                         ((void *)0) 
# 184 "../test/helpers/noisydgrambio.c"
                              ? data->now_cb(data->now_cb_arg)
                               : ossl_time_now();
    ...
    if (num_msg == 0) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../test/helpers/noisydgrambio.c",191,__func__), ERR_set_error)((32),(112),
# 191 "../test/helpers/noisydgrambio.c" 3 4
       ((void *)0)
# 191 "../test/helpers/noisydgrambio.c"
       );
        return 0;
    }
...
# 227 "../test/helpers/noisydgrambio.c"
                      ...
                      int *should_drop, uint16_t *flip, size_t *flip_offset)
{
    ...
    *flip = 0;
    ...
    type = test_random() % 4;
# 250 "../test/helpers/noisydgrambio.c"
    *should_drop = (type == 0 || type == 2);





    *reinject = (type == 1 || type == 2)
                ? (uint64_t)((test_random() % 4) + 1)
                : 0;
...
# 298 "../test/helpers/noisydgrambio.c"
                                ...
                                size_t *msgs_processed)
{
    ...
    if (!test_ptr("../test/helpers/noisydgrambio.c", 312, "next", next))
        return 0;

    data = BIO_get_data(bio);
    if (!test_ptr("../test/helpers/noisydgrambio.c", 316, "data", data))
        return 0;
# 326 "../test/helpers/noisydgrambio.c"
    for (i = 0; i < num_msg; i++) {
        if (i == 0) {
            data_len = msg[i].data_len;
            if (!test_size_t_le("../test/helpers/noisydgrambio.c", 329, "data_len", "MSG_DATA_LEN_MAX", data_len, 1472))
                return 0;
        } else if (!test_size_t_eq("../test/helpers/noisydgrambio.c", 331, "msg[i].data_len", "data_len", msg[i].data_len, data_len)) {
            return 0;
        }
    }
    ...
    if (!BIO_recvmmsg(next, msg, stride, num_msg, flags, msgs_processed))
        return 0;
# 349 "../test/helpers/noisydgrambio.c"
    now = data->now_cb != 
# 349 "../test/helpers/noisydgrambio.c" 3 4
                         ((void *)0) 
# 349 "../test/helpers/noisydgrambio.c"
                              ? data->now_cb(data->now_cb_arg)
                               : ossl_time_now();
    ...
    for (i = 0, thismsg = msg;
        ...
        get_noise(data->noise_rate,
                                    (((uint8_t *)thismsg->data)[0] & 0x80) != 0,
                  &reinject, &should_drop, &flip, &flip_offset);
        if (data->backoff) {
# 406 "../test/helpers/noisydgrambio.c"
            should_drop = 0;
            flip = 0;
            data->backoff = 0;
        }
...
# 461 "../test/helpers/noisydgrambio.c"
 end:
    *msgs_processed = msg_cnt;

    if (msg_cnt == 0) {
        (ERR_new(), ERR_set_debug("../test/helpers/noisydgrambio.c",465,__func__), ERR_set_error)((32),(112),
# 465 "../test/helpers/noisydgrambio.c" 3 4
       ((void *)0)
# 465 "../test/helpers/noisydgrambio.c"
       );
        return 0;
    }
...
{
    if (data == 
# 474 "../test/helpers/noisydgrambio.c" 3 4
               ((void *)0)
# 474 "../test/helpers/noisydgrambio.c"
                   )
        return;

    CRYPTO_free(data->msg.data, "../test/helpers/noisydgrambio.c", 477);
    BIO_ADDR_free(data->msg.peer);
    BIO_ADDR_free(data->msg.local);
    CRYPTO_free(data, "../test/helpers/noisydgrambio.c", 480);
}

static int noisy_dgram_new(BIO *bio)
{
    struct noisy_dgram_st *data = CRYPTO_zalloc(sizeof(*data), "../test/helpers/noisydgrambio.c", 485);

    if (!test_ptr("../test/helpers/noisydgrambio.c", 487, "data", data))
        return 0;

    data->noise_rate = 5;
    data->msg.data = CRYPTO_malloc(1472, "../test/helpers/noisydgrambio.c", 491);
    data->msg.peer = BIO_ADDR_new();
    data->msg.local = BIO_ADDR_new();
    if (data->msg.data == 
# 494 "../test/helpers/noisydgrambio.c" 3 4
                         ((void *)0)
            
# 495 "../test/helpers/noisydgrambio.c"
           || data->msg.peer == 
# 495 "../test/helpers/noisydgrambio.c" 3 4
                                ((void *)0)
            
# 496 "../test/helpers/noisydgrambio.c"
           || data->msg.local == 
# 496 "../test/helpers/noisydgrambio.c" 3 4
                                 ((void *)0)
# 496 "../test/helpers/noisydgrambio.c"
                                     ) {
        data_free(data);
...
static int noisy_dgram_free(BIO *bio)
{
    ...
    BIO_set_data(bio, 
# 510 "../test/helpers/noisydgrambio.c" 3 4
                     ((void *)0)
# 510 "../test/helpers/noisydgrambio.c"
                         );
    BIO_set_init(bio, 0);
...
static BIO_METHOD *method_noisy_dgram = 
# 519 "../test/helpers/noisydgrambio.c" 3 4
                                       ((void *)0)
# 519 "../test/helpers/noisydgrambio.c"
                                           ;


const BIO_METHOD *bio_f_noisy_dgram_filter(void)
{
    if (method_noisy_dgram == 
# 524 "../test/helpers/noisydgrambio.c" 3 4
                             ((void *)0)
# 524 "../test/helpers/noisydgrambio.c"
                                 ) {
        method_noisy_dgram = BIO_meth_new((0x80 | 0x0200),
                                          "Noisy datagram filter");
        if (method_noisy_dgram == 
# 527 "../test/helpers/noisydgrambio.c" 3 4
                                 ((void *)0)
            
# 528 "../test/helpers/noisydgrambio.c"
           || !BIO_meth_set_ctrl(method_noisy_dgram, noisy_dgram_ctrl)
            ...
            return 
# 533 "../test/helpers/noisydgrambio.c" 3 4
                  ((void *)0)
# 533 "../test/helpers/noisydgrambio.c"
                      ;
    }
