# 0 "../test/helpers/ssl_test_ctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/ssl_test_ctx.c"
# 10 "../test/helpers/ssl_test_ctx.c"
...
# 11 "../test/helpers/ssl_test_ctx.c" 2
...
# 13 "../test/helpers/ssl_test_ctx.c" 2
...
# 14 "../test/helpers/ssl_test_ctx.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../test/helpers/ssl_test_ctx.c" 2
# 1 "../test/helpers/ssl_test_ctx.h" 1
# 13 "../test/helpers/ssl_test_ctx.h"
...
# 14 "../test/helpers/ssl_test_ctx.h" 2
...
# 15 "../test/helpers/ssl_test_ctx.h" 2
...
# 193 "../test/helpers/ssl_test_ctx.h"
    ...
    struct stack_st_X509_NAME *expected_server_ca_names;
    ...
    struct stack_st_X509_NAME *expected_client_ca_names;
...
# 17 "../test/helpers/ssl_test_ctx.c" 2
...
# 18 "../test/helpers/ssl_test_ctx.c" 2
...
static int parse_boolean(const char *value, int *result)
{
    ...
    test_error("../test/helpers/ssl_test_ctx.c", 33, "parse_boolean given: '%s'", value);
    return 0;
}
# 59 "../test/helpers/ssl_test_ctx.c"
typedef struct {
    const char *name;
    int value;
} test_enum;
 ...
 static int parse_enum(const test_enum *enums, size_t num_enums,
...
static const test_enum ssl_test_results[] = {
 ...
 static int parse_expected_result(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_test_results, (sizeof(ssl_test_results)/sizeof((ssl_test_results)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_test_result_name(ssl_test_result_t result)
{
    return enum_name(ssl_test_results, (sizeof(ssl_test_results)/sizeof((ssl_test_results)[0])), result);
}
...
static const test_enum ssl_alerts[] = {
 ...
 static int parse_alert(int *alert, const char *value)
{
    return parse_enum(ssl_alerts, (sizeof(ssl_alerts)/sizeof((ssl_alerts)[0])), alert, value);
}

 static int parse_client_alert(SSL_TEST_CTX *test_ctx, const char *value)
{
    return parse_alert(&test_ctx->expected_client_alert, value);
}

 static int parse_server_alert(SSL_TEST_CTX *test_ctx, const char *value)
{
...
const char *ssl_alert_name(int alert)
{
    return enum_name(ssl_alerts, (sizeof(ssl_alerts)/sizeof((ssl_alerts)[0])), alert);
}
...
static const test_enum ssl_protocols[] = {
 ...
 static int parse_protocol(SSL_TEST_CTX *test_ctx, const char *value)
{
    return parse_enum(ssl_protocols, (sizeof(ssl_protocols)/sizeof((ssl_protocols)[0])),
                      &test_ctx->expected_protocol, value);
}

const char *ssl_protocol_name(int protocol)
{
    return enum_name(ssl_protocols, (sizeof(ssl_protocols)/sizeof((ssl_protocols)[0])), protocol);
}
...
static const test_enum ssl_verify_callbacks[] = {
 ...
 static int parse_client_verify_callback(SSL_TEST_CLIENT_CONF *client_conf,
                                               const char *value)
{
    int ret_value;

    if (!parse_enum(ssl_verify_callbacks, (sizeof(ssl_verify_callbacks)/sizeof((ssl_verify_callbacks)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
{
    return enum_name(ssl_verify_callbacks, (sizeof(ssl_verify_callbacks)/sizeof((ssl_verify_callbacks)[0])),
                     callback);
}
...
static const test_enum ssl_servername[] = {
 ...
 static int parse_servername(SSL_TEST_CLIENT_CONF *client_conf,
                                   const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_servername, (sizeof(ssl_servername)/sizeof((ssl_servername)[0])),
                    &ret_value, value)) {
        return 0;
    }
 ...
 static int parse_expected_servername(SSL_TEST_CTX *test_ctx,
                                            const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_servername, (sizeof(ssl_servername)/sizeof((ssl_servername)[0])),
...
const char *ssl_servername_name(ssl_servername_t server)
{
    return enum_name(ssl_servername, (sizeof(ssl_servername)/sizeof((ssl_servername)[0])),
                     server);
}
...
static const test_enum ssl_servername_callbacks[] = {
 ...
 static int parse_servername_callback(SSL_TEST_SERVER_CONF *server_conf,
                                            const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_servername_callbacks,
                    (sizeof(ssl_servername_callbacks)/sizeof((ssl_servername_callbacks)[0])), &ret_value, value)) {
        return 0;
    }
...
const char *ssl_servername_callback_name(ssl_servername_callback_t callback)
{
    return enum_name(ssl_servername_callbacks,
                     (sizeof(ssl_servername_callbacks)/sizeof((ssl_servername_callbacks)[0])), callback);
}
...
static const test_enum ssl_session_ticket[] = {
 ...
 static int parse_session_ticket(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_session_ticket, (sizeof(ssl_session_ticket)/sizeof((ssl_session_ticket)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_session_ticket_name(ssl_session_ticket_t server)
{
    return enum_name(ssl_session_ticket,
                     (sizeof(ssl_session_ticket)/sizeof((ssl_session_ticket)[0])),
                     server);
}



static int parse_test_compression_expected(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->compression_expected); }
...
static const test_enum ssl_session_id[] = {
 ...
 static int parse_session_id(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_session_id, (sizeof(ssl_session_id)/sizeof((ssl_session_id)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_session_id_name(ssl_session_id_t server)
{
    return enum_name(ssl_session_id,
                     (sizeof(ssl_session_id)/sizeof((ssl_session_id)[0])),
                     server);
}
...
static const test_enum ssl_test_methods[] = {
 ...
 static int parse_test_method(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_test_methods, (sizeof(ssl_test_methods)/sizeof((ssl_test_methods)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_test_method_name(ssl_test_method_t method)
{
    return enum_name(ssl_test_methods, (sizeof(ssl_test_methods)/sizeof((ssl_test_methods)[0])), method);
}



static int parse_client_npn_protocols(SSL_TEST_CLIENT_CONF *ctx, const char *value) { CRYPTO_free(ctx->npn_protocols, "../test/helpers/ssl_test_ctx.c", 352); ctx->npn_protocols = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 352); return test_ptr("../test/helpers/ssl_test_ctx.c", 352, "ctx->npn_protocols", ctx->npn_protocols); }
static int parse_server_npn_protocols(SSL_TEST_SERVER_CONF *ctx, const char *value) { CRYPTO_free(ctx->npn_protocols, "../test/helpers/ssl_test_ctx.c", 353); ctx->npn_protocols = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 353); return test_ptr("../test/helpers/ssl_test_ctx.c", 353, "ctx->npn_protocols", ctx->npn_protocols); }
static int parse_test_expected_npn_protocol(SSL_TEST_CTX *ctx, const char *value) { CRYPTO_free(ctx->expected_npn_protocol, "../test/helpers/ssl_test_ctx.c", 354); ctx->expected_npn_protocol = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 354); return test_ptr("../test/helpers/ssl_test_ctx.c", 354, "ctx->expected_npn_protocol", ctx->expected_npn_protocol); }
static int parse_client_alpn_protocols(SSL_TEST_CLIENT_CONF *ctx, const char *value) { CRYPTO_free(ctx->alpn_protocols, "../test/helpers/ssl_test_ctx.c", 355); ctx->alpn_protocols = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 355); return test_ptr("../test/helpers/ssl_test_ctx.c", 355, "ctx->alpn_protocols", ctx->alpn_protocols); }
static int parse_server_alpn_protocols(SSL_TEST_SERVER_CONF *ctx, const char *value) { CRYPTO_free(ctx->alpn_protocols, "../test/helpers/ssl_test_ctx.c", 356); ctx->alpn_protocols = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 356); return test_ptr("../test/helpers/ssl_test_ctx.c", 356, "ctx->alpn_protocols", ctx->alpn_protocols); }
static int parse_test_expected_alpn_protocol(SSL_TEST_CTX *ctx, const char *value) { CRYPTO_free(ctx->expected_alpn_protocol, "../test/helpers/ssl_test_ctx.c", 357); ctx->expected_alpn_protocol = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 357); return test_ptr("../test/helpers/ssl_test_ctx.c", 357, "ctx->expected_alpn_protocol", ctx->expected_alpn_protocol); }


static int parse_client_srp_user(SSL_TEST_CLIENT_CONF *ctx, const char *value) { CRYPTO_free(ctx->srp_user, "../test/helpers/ssl_test_ctx.c", 360); ctx->srp_user = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 360); return test_ptr("../test/helpers/ssl_test_ctx.c", 360, "ctx->srp_user", ctx->srp_user); }
static int parse_server_srp_user(SSL_TEST_SERVER_CONF *ctx, const char *value) { CRYPTO_free(ctx->srp_user, "../test/helpers/ssl_test_ctx.c", 361); ctx->srp_user = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 361); return test_ptr("../test/helpers/ssl_test_ctx.c", 361, "ctx->srp_user", ctx->srp_user); }
static int parse_client_srp_password(SSL_TEST_CLIENT_CONF *ctx, const char *value) { CRYPTO_free(ctx->srp_password, "../test/helpers/ssl_test_ctx.c", 362); ctx->srp_password = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 362); return test_ptr("../test/helpers/ssl_test_ctx.c", 362, "ctx->srp_password", ctx->srp_password); }
static int parse_server_srp_password(SSL_TEST_SERVER_CONF *ctx, const char *value) { CRYPTO_free(ctx->srp_password, "../test/helpers/ssl_test_ctx.c", 363); ctx->srp_password = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 363); return test_ptr("../test/helpers/ssl_test_ctx.c", 363, "ctx->srp_password", ctx->srp_password); }


static int parse_test_expected_session_ticket_app_data(SSL_TEST_CTX *ctx, const char *value) { CRYPTO_free(ctx->expected_session_ticket_app_data, "../test/helpers/ssl_test_ctx.c", 366); ctx->expected_session_ticket_app_data = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 366); return test_ptr("../test/helpers/ssl_test_ctx.c", 366, "ctx->expected_session_ticket_app_data", ctx->expected_session_ticket_app_data); }
static int parse_server_session_ticket_app_data(SSL_TEST_SERVER_CONF *ctx, const char *value) { CRYPTO_free(ctx->session_ticket_app_data, "../test/helpers/ssl_test_ctx.c", 367); ctx->session_ticket_app_data = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 367); return test_ptr("../test/helpers/ssl_test_ctx.c", 367, "ctx->session_ticket_app_data", ctx->session_ticket_app_data); }
...
static const test_enum ssl_handshake_modes[] = {
 ...
 static int parse_handshake_mode(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_handshake_modes, (sizeof(ssl_handshake_modes)/sizeof((ssl_handshake_modes)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_handshake_mode_name(ssl_handshake_mode_t mode)
{
    return enum_name(ssl_handshake_modes, (sizeof(ssl_handshake_modes)/sizeof((ssl_handshake_modes)[0])),
                     mode);
}



static int parse_client_reneg_ciphers(SSL_TEST_CLIENT_CONF *ctx, const char *value) { CRYPTO_free(ctx->reneg_ciphers, "../test/helpers/ssl_test_ctx.c", 400); ctx->reneg_ciphers = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 400); return test_ptr("../test/helpers/ssl_test_ctx.c", 400, "ctx->reneg_ciphers", ctx->reneg_ciphers); }
...
static const test_enum ssl_key_update_types[] = {
 ...
 static int parse_key_update_type(SSL_TEST_CTX *test_ctx, const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_key_update_types, (sizeof(ssl_key_update_types)/sizeof((ssl_key_update_types)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
static const test_enum ssl_ct_validation_modes[] = {
 ...
 static int parse_ct_validation(SSL_TEST_CLIENT_CONF *client_conf,
                                      const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_ct_validation_modes, (sizeof(ssl_ct_validation_modes)/sizeof((ssl_ct_validation_modes)[0])),
                    &ret_value, value)) {
        return 0;
    }
...
const char *ssl_ct_validation_name(ssl_ct_validation_t mode)
{
    return enum_name(ssl_ct_validation_modes, (sizeof(ssl_ct_validation_modes)/sizeof((ssl_ct_validation_modes)[0])),
                     mode);
}

static int parse_test_resumption_expected(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->resumption_expected); }
static int parse_server_broken_session_ticket(SSL_TEST_SERVER_CONF *ctx, const char *value) { return parse_boolean(value, &ctx->broken_session_ticket); }
static int parse_test_use_sctp(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->use_sctp); }
static int parse_test_compress_certificates(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->compress_certificates); }
static int parse_test_enable_client_sctp_label_bug(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->enable_client_sctp_label_bug); }
static int parse_test_enable_server_sctp_label_bug(SSL_TEST_CTX *ctx, const char *value) { return parse_boolean(value, &ctx->enable_server_sctp_label_bug); }
...
static const test_enum ssl_certstatus[] = {
 ...
 static int parse_certstatus(SSL_TEST_SERVER_CONF *server_conf,
                                            const char *value)
{
    int ret_value;
    if (!parse_enum(ssl_certstatus, (sizeof(ssl_certstatus)/sizeof((ssl_certstatus)[0])), &ret_value,
                    value)) {
        return 0;
    }
...
const char *ssl_certstatus_name(ssl_cert_status_t cert_status)
{
    return enum_name(ssl_certstatus,
                     (sizeof(ssl_certstatus)/sizeof((ssl_certstatus)[0])), cert_status);
}



static int parse_test_app_data_size(SSL_TEST_CTX *ctx, const char *value) { ctx->app_data_size = atoi(value); return 1; }




static int parse_test_max_fragment_size(SSL_TEST_CTX *ctx, const char *value) { ctx->max_fragment_size = atoi(value); return 1; }
                                              ...
                                              const char *value)
{
    ...
    if (!parse_enum(ssl_max_fragment_len_mode,
                    (sizeof(ssl_max_fragment_len_mode)/sizeof((ssl_max_fragment_len_mode)[0])), &ret_value, value)) {
        return 0;
    }
...
const char *ssl_max_fragment_len_name(int MFL_mode)
{
    return enum_name(ssl_max_fragment_len_mode,
                     (sizeof(ssl_max_fragment_len_mode)/sizeof((ssl_max_fragment_len_mode)[0])), MFL_mode);
}




 static int parse_expected_key_type(int *ptype, const char *value)
{
    int nid;
    const EVP_PKEY_ASN1_METHOD *ameth;

    if (value == 
# 524 "../test/helpers/ssl_test_ctx.c" 3 4
                ((void *)0)
# 524 "../test/helpers/ssl_test_ctx.c"
                    )
        return 0;
    ameth = EVP_PKEY_asn1_find_str(
# 526 "../test/helpers/ssl_test_ctx.c" 3 4
                                  ((void *)0)
# 526 "../test/helpers/ssl_test_ctx.c"
                                      , value, -1);
    if (ameth != 
# 527 "../test/helpers/ssl_test_ctx.c" 3 4
                ((void *)0)
# 527 "../test/helpers/ssl_test_ctx.c"
                    )
        EVP_PKEY_asn1_get0_info(&nid, 
# 528 "../test/helpers/ssl_test_ctx.c" 3 4
                                     ((void *)0)
# 528 "../test/helpers/ssl_test_ctx.c"
                                         , 
# 528 "../test/helpers/ssl_test_ctx.c" 3 4
                                           ((void *)0)
# 528 "../test/helpers/ssl_test_ctx.c"
...
# 528 "../test/helpers/ssl_test_ctx.c"
 ...
 static int parse_expected_tmp_key_type(SSL_TEST_CTX *test_ctx,
                                              const char *value)
{
    return parse_expected_key_type(&test_ctx->expected_tmp_key_type, value);
}

 static int parse_expected_server_cert_type(SSL_TEST_CTX *test_ctx,
                                                  const char *value)
{
 ...
 static int parse_expected_server_sign_type(SSL_TEST_CTX *test_ctx,
                                                 const char *value)
{
 ...
 static int parse_expected_client_cert_type(SSL_TEST_CTX *test_ctx,
                                                  const char *value)
{
 ...
 static int parse_expected_client_sign_type(SSL_TEST_CTX *test_ctx,
                                                 const char *value)
{
 ...
 static int parse_expected_sign_hash(int *ptype, const char *value)
{
    int nid;

    if (value == 
# 595 "../test/helpers/ssl_test_ctx.c" 3 4
                ((void *)0)
# 595 "../test/helpers/ssl_test_ctx.c"
                    )
        return 0;
    nid = OBJ_sn2nid(value);
    if (nid == 0)
 ...
 static int parse_expected_server_sign_hash(SSL_TEST_CTX *test_ctx,
                                                  const char *value)
{
 ...
 static int parse_expected_client_sign_hash(SSL_TEST_CTX *test_ctx,
                                                  const char *value)
{
 ...
 static int parse_expected_ca_names(struct stack_st_X509_NAME **pnames,
                                          const char *value,
                                          OSSL_LIB_CTX *libctx)
{
    if (value == 
# 624 "../test/helpers/ssl_test_ctx.c" 3 4
                ((void *)0)
# 624 "../test/helpers/ssl_test_ctx.c"
                    )
        return 0;
    if (!strcmp(value, "empty"))
        *pnames = ((struct stack_st_X509_NAME *)OPENSSL_sk_new_null());
    else
        *pnames = SSL_load_client_CA_file_ex(value, libctx, 
# 629 "../test/helpers/ssl_test_ctx.c" 3 4
                                                           ((void *)0)
# 629 "../test/helpers/ssl_test_ctx.c"
                                                               );
    return *pnames != 
# 630 "../test/helpers/ssl_test_ctx.c" 3 4
                     ((void *)0)
# 630 "../test/helpers/ssl_test_ctx.c"
                         ;
}
 static int parse_expected_server_ca_names(SSL_TEST_CTX *test_ctx,
                                                 const char *value)
{
    return parse_expected_ca_names(&test_ctx->expected_server_ca_names, value,
                                   test_ctx->libctx);
}
 static int parse_expected_client_ca_names(SSL_TEST_CTX *test_ctx,
                                                 const char *value)
{
...
static int parse_test_expected_cipher(SSL_TEST_CTX *ctx, const char *value) { CRYPTO_free(ctx->expected_cipher, "../test/helpers/ssl_test_ctx.c", 647); ctx->expected_cipher = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 647); return test_ptr("../test/helpers/ssl_test_ctx.c", 647, "ctx->expected_cipher", ctx->expected_cipher); }



static int parse_client_enable_pha(SSL_TEST_CLIENT_CONF *ctx, const char *value) { return parse_boolean(value, &ctx->enable_pha); }
static int parse_server_force_pha(SSL_TEST_SERVER_CONF *ctx, const char *value) { return parse_boolean(value, &ctx->force_pha); }
static int parse_client_no_extms_on_reneg(SSL_TEST_CLIENT_CONF *ctx, const char *value) { return parse_boolean(value, &ctx->no_extms_on_reneg); }


static int parse_test_fips_version(SSL_TEST_CTX *ctx, const char *value) { CRYPTO_free(ctx->fips_version, "../test/helpers/ssl_test_ctx.c", 656); ctx->fips_version = CRYPTO_strdup(value, "../test/helpers/ssl_test_ctx.c", 656); return test_ptr("../test/helpers/ssl_test_ctx.c", 656, "ctx->fips_version", ctx->fips_version); }
...
SSL_TEST_CTX *SSL_TEST_CTX_new(OSSL_LIB_CTX *libctx)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../test/helpers/ssl_test_ctx.c", 744)) != 
# 744 "../test/helpers/ssl_test_ctx.c" 3 4
                                               ((void *)0)
# 744 "../test/helpers/ssl_test_ctx.c"
                                                   ) {
        ret->libctx = libctx;
...
{
    CRYPTO_free(conf->client.npn_protocols, "../test/helpers/ssl_test_ctx.c", 754);
    CRYPTO_free(conf->server.npn_protocols, "../test/helpers/ssl_test_ctx.c", 755);
    CRYPTO_free(conf->server2.npn_protocols, "../test/helpers/ssl_test_ctx.c", 756);
    CRYPTO_free(conf->client.alpn_protocols, "../test/helpers/ssl_test_ctx.c", 757);
    CRYPTO_free(conf->server.alpn_protocols, "../test/helpers/ssl_test_ctx.c", 758);
    CRYPTO_free(conf->server2.alpn_protocols, "../test/helpers/ssl_test_ctx.c", 759);
    CRYPTO_free(conf->client.reneg_ciphers, "../test/helpers/ssl_test_ctx.c", 760);
    CRYPTO_free(conf->server.srp_user, "../test/helpers/ssl_test_ctx.c", 761);
    CRYPTO_free(conf->server.srp_password, "../test/helpers/ssl_test_ctx.c", 762);
    CRYPTO_free(conf->server2.srp_user, "../test/helpers/ssl_test_ctx.c", 763);
    CRYPTO_free(conf->server2.srp_password, "../test/helpers/ssl_test_ctx.c", 764);
    CRYPTO_free(conf->client.srp_user, "../test/helpers/ssl_test_ctx.c", 765);
    CRYPTO_free(conf->client.srp_password, "../test/helpers/ssl_test_ctx.c", 766);
    CRYPTO_free(conf->server.session_ticket_app_data, "../test/helpers/ssl_test_ctx.c", 767);
    CRYPTO_free(conf->server2.session_ticket_app_data, "../test/helpers/ssl_test_ctx.c", 768);
}
...
{
    if (ctx == 
# 779 "../test/helpers/ssl_test_ctx.c" 3 4
              ((void *)0)
# 779 "../test/helpers/ssl_test_ctx.c"
                  )
        return;
    ssl_test_ctx_free_extra_data(ctx);
    CRYPTO_free(ctx->expected_npn_protocol, "../test/helpers/ssl_test_ctx.c", 782);
    CRYPTO_free(ctx->expected_alpn_protocol, "../test/helpers/ssl_test_ctx.c", 783);
    CRYPTO_free(ctx->expected_session_ticket_app_data, "../test/helpers/ssl_test_ctx.c", 784);
    OPENSSL_sk_pop_free(ossl_check_X509_NAME_sk_type(ctx->expected_server_ca_names),ossl_check_X509_NAME_freefunc_type(X509_NAME_free));
    OPENSSL_sk_pop_free(ossl_check_X509_NAME_sk_type(ctx->expected_client_ca_names),ossl_check_X509_NAME_freefunc_type(X509_NAME_free));
    CRYPTO_free(ctx->expected_cipher, "../test/helpers/ssl_test_ctx.c", 787);
    CRYPTO_free(ctx->fips_version, "../test/helpers/ssl_test_ctx.c", 788);
    CRYPTO_free(ctx, "../test/helpers/ssl_test_ctx.c", 789);
}

static int parse_client_options(SSL_TEST_CLIENT_CONF *client, const CONF *conf,
                                const char *client_section)
{
    struct stack_st_CONF_VALUE *sk_conf;
    int i;
    size_t j;

    if (!test_ptr("../test/helpers/ssl_test_ctx.c", 799, "sk_conf = NCONF_get_section(conf, client_section)", sk_conf = NCONF_get_section(conf, client_section)))
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk_conf)); i++) {
        int found = 0;
        const CONF_VALUE *option = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sk_conf), (i)));
        for (j = 0; j < (sizeof(ssl_test_client_options)/sizeof((ssl_test_client_options)[0])); j++) {
            if (strcmp(option->name, ssl_test_client_options[j].name) == 0) {
                if (!ssl_test_client_options[j].parse(client, option->value)) {
                    test_info("../test/helpers/ssl_test_ctx.c", 808, "Bad value %s for option %s", option->value, option->name)
                                                          ;
                    return 0;
                }
                found = 1;
        ...
        if (!found) {
            test_info("../test/helpers/ssl_test_ctx.c", 817, "Unknown test option: %s", option->name);
            return 0;
        }
    }
                                ...
                                const char *server_section)
{
    ...
    if (!test_ptr("../test/helpers/ssl_test_ctx.c", 832, "sk_conf = NCONF_get_section(conf, server_section)", sk_conf = NCONF_get_section(conf, server_section)))
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk_conf)); i++) {
        int found = 0;
        const CONF_VALUE *option = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sk_conf), (i)));
        for (j = 0; j < (sizeof(ssl_test_server_options)/sizeof((ssl_test_server_options)[0])); j++) {
            if (strcmp(option->name, ssl_test_server_options[j].name) == 0) {
                if (!ssl_test_server_options[j].parse(server, option->value)) {
                    test_info("../test/helpers/ssl_test_ctx.c", 841, "Bad value %s for option %s", option->value, option->name)
                                                           ;
                    return 0;
                }
                found = 1;
        ...
        if (!found) {
            test_info("../test/helpers/ssl_test_ctx.c", 850, "Unknown test option: %s", option->name);
            return 0;
        }
    }
...
{
    struct stack_st_CONF_VALUE *sk_conf = 
# 861 "../test/helpers/ssl_test_ctx.c" 3 4
                                   ((void *)0)
# 861 "../test/helpers/ssl_test_ctx.c"
                                       ;
    SSL_TEST_CTX *ctx = 
# 862 "../test/helpers/ssl_test_ctx.c" 3 4
                       ((void *)0)
# 862 "../test/helpers/ssl_test_ctx.c"
                           ;
    int i;
    size_t j;

    if (!test_ptr("../test/helpers/ssl_test_ctx.c", 866, "sk_conf = NCONF_get_section(conf, test_section)", sk_conf = NCONF_get_section(conf, test_section))
            || !test_ptr("../test/helpers/ssl_test_ctx.c", 867, "ctx = SSL_TEST_CTX_new(libctx)", ctx = SSL_TEST_CTX_new(libctx)))
        goto err;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk_conf)); i++) {
        ...
        if (strcmp(option->name, "client") == 0) {
            ...
            for (j = 0; j < (sizeof(ssl_test_ctx_options)/sizeof((ssl_test_ctx_options)[0])); j++) {
                if (strcmp(option->name, ssl_test_ctx_options[j].name) == 0) {
                    if (!ssl_test_ctx_options[j].parse(ctx, option->value)) {
                        test_info("../test/helpers/ssl_test_ctx.c", 900, "Bad value %s for option %s", option->value, option->name)
                                                               ;
                        goto err;
                    }
                    found = 1;
            ...
            if (!found) {
                test_info("../test/helpers/ssl_test_ctx.c", 909, "Unknown test option: %s", option->name);
                goto err;
            }
        }
    }
 ...
 err:
    ...
    ctx = 
# 919 "../test/helpers/ssl_test_ctx.c" 3 4
         ((void *)0)
# 919 "../test/helpers/ssl_test_ctx.c"
             ;
 done:
    return ctx;
}
