# 0 "../test/helpers/cmp_testlib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/cmp_testlib.c"
# 12 "../test/helpers/cmp_testlib.c"
...
int print_to_bio_out(const char *func, const char *file, int line,
                     OSSL_CMP_severity level, const char *msg);
# 13 "../test/helpers/cmp_testlib.c" 2
...
OSSL_CMP_MSG *load_pkimsg(const char *file, OSSL_LIB_CTX *libctx)
{
    ...
    (void)test_ptr("../test/helpers/cmp_testlib.c", 19, "(msg = OSSL_CMP_MSG_read(file, libctx, NULL))", (msg = OSSL_CMP_MSG_read(file, libctx, 
# 19 "../test/helpers/cmp_testlib.c" 3 4
         ((void *)0)
# 19 "../test/helpers/cmp_testlib.c"
         )));
    return msg;
}
...
{
    return msg != 
# 28 "../test/helpers/cmp_testlib.c" 3 4
                 ((void *)0) 
# 28 "../test/helpers/cmp_testlib.c"
                      ? i2d_OSSL_CMP_MSG(msg, 
# 28 "../test/helpers/cmp_testlib.c" 3 4
                                              ((void *)0)
# 28 "../test/helpers/cmp_testlib.c"
                                                  ) > 0 : 0;
...
int STACK_OF_X509_cmp(const struct stack_st_X509 *sk1, const struct stack_st_X509 *sk2)
{
    ...
    if (sk1 == sk2)
        return 0;
    if (sk1 == 
# 42 "../test/helpers/cmp_testlib.c" 3 4
              ((void *)0)
# 42 "../test/helpers/cmp_testlib.c"
                  )
        return -1;
    if (sk2 == 
# 44 "../test/helpers/cmp_testlib.c" 3 4
              ((void *)0)
# 44 "../test/helpers/cmp_testlib.c"
                  )
        return 1;
    if ((res = OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk1)) - OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk2))))
        return res;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk1)); i++) {
        a = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sk1), (i)));
        b = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sk2), (i)));
        if (a != b)
...
int STACK_OF_X509_push1(struct stack_st_X509 *sk, X509 *cert)
{
    ...
    if (sk == 
# 67 "../test/helpers/cmp_testlib.c" 3 4
             ((void *)0) 
# 67 "../test/helpers/cmp_testlib.c"
                  || cert == 
# 67 "../test/helpers/cmp_testlib.c" 3 4
                             ((void *)0)
# 67 "../test/helpers/cmp_testlib.c"
    ...
    if (!X509_up_ref(cert))
        return -1;
    res = OPENSSL_sk_push(ossl_check_X509_sk_type(sk), ossl_check_X509_type(cert));
    if (res <= 0)
        X509_free(cert);
    return res;
}
