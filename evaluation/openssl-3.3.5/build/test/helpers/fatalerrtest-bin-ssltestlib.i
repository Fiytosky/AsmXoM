# 0 "../test/helpers/ssltestlib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/ssltestlib.c"
# 18 "../test/helpers/ssltestlib.c"
...
# 19 "../test/helpers/ssltestlib.c" 2
...
# 21 "../test/helpers/ssltestlib.c" 2
...
# 22 "../test/helpers/ssltestlib.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 23 "../test/helpers/ssltestlib.c" 2
# 1 "../test/helpers/ssltestlib.h" 1
# 13 "../test/helpers/ssltestlib.h"
...
# 14 "../test/helpers/ssltestlib.h" 2
...
# 24 "../test/helpers/ssltestlib.c" 2
# 1 "../test/helpers/../testutil.h" 1
# 14 "../test/helpers/../testutil.h"
...
# 25 "../test/helpers/ssltestlib.c" 2
...
# 29 "../test/helpers/ssltestlib.c" 2




# 32 "../test/helpers/ssltestlib.c"
...
# 46 "../test/helpers/ssltestlib.c" 3 4
                                    ((void *)0)
# 46 "../test/helpers/ssltestlib.c"
                                        ;
static BIO_METHOD *meth_mem = 
# 47 "../test/helpers/ssltestlib.c" 3 4
                             ((void *)0)
# 47 "../test/helpers/ssltestlib.c"
                                 ;
static BIO_METHOD *meth_always_retry = 
# 48 "../test/helpers/ssltestlib.c" 3 4
                                      ((void *)0)
# 48 "../test/helpers/ssltestlib.c"
                                          ;
static BIO_METHOD *meth_maybe_retry = 
# 49 "../test/helpers/ssltestlib.c" 3 4
                                     ((void *)0)
# 49 "../test/helpers/ssltestlib.c"
                                         ;
...
{
    if (method_tls_dump == 
# 55 "../test/helpers/ssltestlib.c" 3 4
                          ((void *)0)
# 55 "../test/helpers/ssltestlib.c"
                              ) {
        method_tls_dump = BIO_meth_new((0x80 | 0x0200),
                                        "TLS dump filter");
        if (method_tls_dump == 
# 58 "../test/helpers/ssltestlib.c" 3 4
                              ((void *)0)
            
# 59 "../test/helpers/ssltestlib.c"
           || !BIO_meth_set_write(method_tls_dump, tls_dump_write)
            ...
            return 
# 66 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 66 "../test/helpers/ssltestlib.c"
                      ;
    }
...
static void copy_flags(BIO *bio)
{
    ...
    flags = BIO_test_flags(next, 0x08 | (0x01|0x02|0x04));
    BIO_clear_flags(bio, 0x08 | (0x01|0x02|0x04));
    BIO_set_flags(bio, flags);
}
# 123 "../test/helpers/ssltestlib.c"
static void dump_data(const char *data, int len)
{
    ...
    fflush(
# 196 "../test/helpers/ssltestlib.c" 3 4
          stdout
# 196 "../test/helpers/ssltestlib.c"
                );
}
...
static long tls_dump_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (next == 
# 230 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 230 "../test/helpers/ssltestlib.c"
                   )
        return 0;
...
{
    if (pkt->data != 
# 265 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 265 "../test/helpers/ssltestlib.c"
                        )
        CRYPTO_free(pkt->data, "../test/helpers/ssltestlib.c", 266);
    CRYPTO_free(pkt, "../test/helpers/ssltestlib.c", 267);
}

typedef struct mempacket_test_ctx_st {
    struct stack_st_MEMPACKET *pkts;
    uint16_t epoch;
...
{
    if (meth_mem == 
# 293 "../test/helpers/ssltestlib.c" 3 4
                   ((void *)0)
# 293 "../test/helpers/ssltestlib.c"
                       ) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 294, "meth_mem = BIO_meth_new(BIO_TYPE_MEMPACKET_TEST, \"Mem Packet Test\")", meth_mem = BIO_meth_new(0x81, "Mem Packet Test"))

            || !test_true("../test/helpers/ssltestlib.c", 296, "BIO_meth_set_write(meth_mem, mempacket_test_write)", (BIO_meth_set_write(meth_mem, mempacket_test_write)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 297, "BIO_meth_set_read(meth_mem, mempacket_test_read)", (BIO_meth_set_read(meth_mem, mempacket_test_read)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 298, "BIO_meth_set_puts(meth_mem, mempacket_test_puts)", (BIO_meth_set_puts(meth_mem, mempacket_test_puts)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 299, "BIO_meth_set_gets(meth_mem, mempacket_test_gets)", (BIO_meth_set_gets(meth_mem, mempacket_test_gets)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 300, "BIO_meth_set_ctrl(meth_mem, mempacket_test_ctrl)", (BIO_meth_set_ctrl(meth_mem, mempacket_test_ctrl)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 301, "BIO_meth_set_create(meth_mem, mempacket_test_new)", (BIO_meth_set_create(meth_mem, mempacket_test_new)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 302, "BIO_meth_set_destroy(meth_mem, mempacket_test_free)", (BIO_meth_set_destroy(meth_mem, mempacket_test_free)) != 0))
            return 
# 303 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 303 "../test/helpers/ssltestlib.c"
                      ;
    }
    return meth_mem;
}
...
static int mempacket_test_new(BIO *bio)
{
    ...
    if (!test_ptr("../test/helpers/ssltestlib.c", 317, "ctx = OPENSSL_zalloc(sizeof(*ctx))", ctx = CRYPTO_zalloc(sizeof(*ctx), "../test/helpers/ssltestlib.c", 317)))
        return 0;
    if (!test_ptr("../test/helpers/ssltestlib.c", 319, "ctx->pkts = sk_MEMPACKET_new_null()", ctx->pkts = sk_MEMPACKET_new_null())) {
        CRYPTO_free(ctx, "../test/helpers/ssltestlib.c", 320);
        return 0;
    }
    ctx->dropepoch = 0;
    ctx->droprec = -1;
...
static int mempacket_test_free(BIO *bio)
{
    ...
    CRYPTO_free(ctx, "../test/helpers/ssltestlib.c", 335);
    BIO_set_data(bio, 
# 336 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 336 "../test/helpers/ssltestlib.c"
                         );
    BIO_set_init(bio, 0);
    return 1;
}
# 350 "../test/helpers/ssltestlib.c"
static int mempacket_test_read(BIO *bio, char *out, int outl)
{
    ...
    if ((thispkt = sk_MEMPACKET_value(ctx->pkts, 0)) == 
# 359 "../test/helpers/ssltestlib.c" 3 4
                                                       ((void *)0)
        
# 360 "../test/helpers/ssltestlib.c"
...
int mempacket_swap_epoch(BIO *bio)
{
    ...
    unsigned char *rec, *prevrec = 
# 428 "../test/helpers/ssltestlib.c" 3 4
                                  ((void *)0)
# 428 "../test/helpers/ssltestlib.c"
                                      , *tmp;
    unsigned int epoch;
    ...
    if (thispkt == 
# 440 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 440 "../test/helpers/ssltestlib.c"
                      )
        return 0;
    ...
    for (rem = thispkt->len, rec = thispkt->data; rem > 0; rem -= len, rec += len) {
        ...
        if (epoch != ctx->epoch) {
            if (prevrec == 
# 454 "../test/helpers/ssltestlib.c" 3 4
                          ((void *)0)
# 454 "../test/helpers/ssltestlib.c"
                              )
                return 0;
            ...
            tmp = CRYPTO_malloc(prevlen, "../test/helpers/ssltestlib.c", 461);
            if (tmp == 
# 462 "../test/helpers/ssltestlib.c" 3 4
                      ((void *)0)
# 462 "../test/helpers/ssltestlib.c"
                          )
                return 0;
            ...
            thispkt = CRYPTO_malloc(sizeof(*thispkt), "../test/helpers/ssltestlib.c", 478);
            if (thispkt == 
# 479 "../test/helpers/ssltestlib.c" 3 4
                          ((void *)0)
# 479 "../test/helpers/ssltestlib.c"
                              ) {
                CRYPTO_free(tmp, "../test/helpers/ssltestlib.c", 480);
                return 0;
            }
            thispkt->type = 1;
            thispkt->data = tmp;
            ...
            if (sk_MEMPACKET_insert(ctx->pkts, thispkt, numpkts) <= 0) {
                CRYPTO_free(tmp, "../test/helpers/ssltestlib.c", 488);
                CRYPTO_free(thispkt, "../test/helpers/ssltestlib.c", 489);
                return 0;
            }
...
int mempacket_move_packet(BIO *bio, int d, int s)
{
    ...
    if (thispkt == 
# 519 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 519 "../test/helpers/ssltestlib.c"
                      )
        return 0;
...
int mempacket_dup_last_packet(BIO *bio)
{
    ...
    thispkt = sk_MEMPACKET_value(ctx->pkts, numpkts - 1);
    if (thispkt == 
# 550 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 550 "../test/helpers/ssltestlib.c"
                      )
        return 0;

    duppkt = CRYPTO_malloc(sizeof(*duppkt), "../test/helpers/ssltestlib.c", 553);
    if (duppkt == 
# 554 "../test/helpers/ssltestlib.c" 3 4
                 ((void *)0)
# 554 "../test/helpers/ssltestlib.c"
                     )
        return 0;

    *duppkt = *thispkt;
    duppkt->data = CRYPTO_memdup((thispkt->data), thispkt->len, "../test/helpers/ssltestlib.c", 558);
    if (duppkt->data == 
# 559 "../test/helpers/ssltestlib.c" 3 4
                       ((void *)0)
# 559 "../test/helpers/ssltestlib.c"
                           ) {
                          ...
                          int type)
{
    MEMPACKET_TEST_CTX *ctx = BIO_get_data(bio);
    MEMPACKET *thispkt = 
# 576 "../test/helpers/ssltestlib.c" 3 4
                        ((void *)0)
# 576 "../test/helpers/ssltestlib.c"
                            , *looppkt, *nextpkt, *allpkts[3];
    int i, duprec;
    const unsigned char *inu = (const unsigned char *)in;
    size_t len = ((inu[11] << 8) | inu[12])
                 + 13;

    if (ctx == 
# 582 "../test/helpers/ssltestlib.c" 3 4
              ((void *)0)
# 582 "../test/helpers/ssltestlib.c"
                  )
        return -1;
    ...
    for (i = 0; i < (duprec ? 3 : 1); i++) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 607, "allpkts[i] = OPENSSL_malloc(sizeof(*thispkt))", allpkts[i] = CRYPTO_malloc(sizeof(*thispkt), "../test/helpers/ssltestlib.c", 607)))
            goto err;
        thispkt = allpkts[i];

        if (!test_ptr("../test/helpers/ssltestlib.c", 611, "thispkt->data = OPENSSL_malloc(inl)", thispkt->data = CRYPTO_malloc(inl, "../test/helpers/ssltestlib.c", 611)))
            goto err;
    ...
    for (i = 0; i < sk_MEMPACKET_num(ctx->pkts); i++) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 632, "looppkt = sk_MEMPACKET_value(ctx->pkts, i)", looppkt = sk_MEMPACKET_value(ctx->pkts, i)))
            goto err;
        ...
        if (looppkt->num > thispkt->num) {
            ...
            do {
                ...
                if (nextpkt != 
# 650 "../test/helpers/ssltestlib.c" 3 4
                              ((void *)0) 
# 650 "../test/helpers/ssltestlib.c"
...
{
    return mempacket_test_inject(bio, in, inl, -1, 0);
}
...
static long mempacket_test_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    case 10:
        ...
        if (thispkt == 
# 711 "../test/helpers/ssltestlib.c" 3 4
                      ((void *)0)
# 711 "../test/helpers/ssltestlib.c"
                          )
            ret = 0;
        else
            ret = thispkt->len;
...
# 763 "../test/helpers/ssltestlib.c" 3 4
                            ((void *)0)
# 763 "../test/helpers/ssltestlib.c"
                                ) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 764, "meth_always_retry = BIO_meth_new(BIO_TYPE_ALWAYS_RETRY, \"Always Retry\")", meth_always_retry = BIO_meth_new(0x82, "Always Retry"))

            || !test_true("../test/helpers/ssltestlib.c", 766, "BIO_meth_set_write(meth_always_retry, always_retry_write)", (BIO_meth_set_write(meth_always_retry, always_retry_write)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 768, "BIO_meth_set_read(meth_always_retry, always_retry_read)", (BIO_meth_set_read(meth_always_retry, always_retry_read)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 770, "BIO_meth_set_puts(meth_always_retry, always_retry_puts)", (BIO_meth_set_puts(meth_always_retry, always_retry_puts)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 772, "BIO_meth_set_gets(meth_always_retry, always_retry_gets)", (BIO_meth_set_gets(meth_always_retry, always_retry_gets)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 774, "BIO_meth_set_ctrl(meth_always_retry, always_retry_ctrl)", (BIO_meth_set_ctrl(meth_always_retry, always_retry_ctrl)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 776, "BIO_meth_set_create(meth_always_retry, always_retry_new)", (BIO_meth_set_create(meth_always_retry, always_retry_new)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 778, "BIO_meth_set_destroy(meth_always_retry, always_retry_free)", (BIO_meth_set_destroy(meth_always_retry, always_retry_free)) != 0)
                                                                  )
            return 
# 780 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 780 "../test/helpers/ssltestlib.c"
                      ;
    }
...
{
    BIO_set_data(bio, 
# 798 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 798 "../test/helpers/ssltestlib.c"
                         );
    BIO_set_init(bio, 0);
    return 1;
}
...
{
    if (meth_maybe_retry == 
# 863 "../test/helpers/ssltestlib.c" 3 4
                           ((void *)0)
# 863 "../test/helpers/ssltestlib.c"
                               ) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 864, "meth_maybe_retry = BIO_meth_new(BIO_TYPE_MAYBE_RETRY, \"Maybe Retry\")", meth_maybe_retry = BIO_meth_new((0x83 | 0x0200), "Maybe Retry"))

            || !test_true("../test/helpers/ssltestlib.c", 866, "BIO_meth_set_write(meth_maybe_retry, maybe_retry_write)", (BIO_meth_set_write(meth_maybe_retry, maybe_retry_write)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 868, "BIO_meth_set_ctrl(meth_maybe_retry, maybe_retry_ctrl)", (BIO_meth_set_ctrl(meth_maybe_retry, maybe_retry_ctrl)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 870, "BIO_meth_set_create(meth_maybe_retry, maybe_retry_new)", (BIO_meth_set_create(meth_maybe_retry, maybe_retry_new)) != 0)

            || !test_true("../test/helpers/ssltestlib.c", 872, "BIO_meth_set_destroy(meth_maybe_retry, maybe_retry_free)", (BIO_meth_set_destroy(meth_maybe_retry, maybe_retry_free)) != 0)
                                                                 )
            return 
# 874 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 874 "../test/helpers/ssltestlib.c"
                      ;
    }
...
{
    struct maybe_retry_data_st *data = CRYPTO_zalloc(sizeof(*data), "../test/helpers/ssltestlib.c", 886);

    if (data == 
# 888 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 888 "../test/helpers/ssltestlib.c"
                   )
        return 0;
...
static int maybe_retry_free(BIO *bio)
{
    ...
    CRYPTO_free(data, "../test/helpers/ssltestlib.c", 900);
    BIO_set_data(bio, 
# 901 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 901 "../test/helpers/ssltestlib.c"
                         );
    BIO_set_init(bio, 0);
    return 1;
}
...
static int maybe_retry_write(BIO *bio, const char *in, int inl)
{
    ...
    if (data == 
# 910 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 910 "../test/helpers/ssltestlib.c"
                   )
        return -1;
...
static long maybe_retry_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (data == 
# 926 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 926 "../test/helpers/ssltestlib.c"
                   )
        return 0;
...
{
    SSL_CTX *serverctx = 
# 951 "../test/helpers/ssltestlib.c" 3 4
                        ((void *)0)
# 951 "../test/helpers/ssltestlib.c"
                            ;
    SSL_CTX *clientctx = 
# 952 "../test/helpers/ssltestlib.c" 3 4
                        ((void *)0)
# 952 "../test/helpers/ssltestlib.c"
                            ;

    if (sctx != 
# 954 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 954 "../test/helpers/ssltestlib.c"
                   ) {
        if (*sctx != 
# 955 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 955 "../test/helpers/ssltestlib.c"
                        )
            serverctx = *sctx;
        else if (!test_ptr("../test/helpers/ssltestlib.c", 957, "serverctx = SSL_CTX_new_ex(libctx, NULL, sm)", serverctx = SSL_CTX_new_ex(libctx, 
# 957 "../test/helpers/ssltestlib.c" 3 4
                 ((void *)0)
# 957 "../test/helpers/ssltestlib.c"
                 , sm))
            || !test_true("../test/helpers/ssltestlib.c", 958, "SSL_CTX_set_options(serverctx, SSL_OP_ALLOW_CLIENT_RENEGOTIATION)", (SSL_CTX_set_options(serverctx, ((uint64_t)1 << (uint64_t)8))) != 0)
                                                                                 )
            goto err;
    }

    if (cctx != 
# 963 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 963 "../test/helpers/ssltestlib.c"
                   ) {
        if (*cctx != 
# 964 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 964 "../test/helpers/ssltestlib.c"
                        )
            clientctx = *cctx;
        else if (!test_ptr("../test/helpers/ssltestlib.c", 966, "clientctx = SSL_CTX_new_ex(libctx, NULL, cm)", clientctx = SSL_CTX_new_ex(libctx, 
# 966 "../test/helpers/ssltestlib.c" 3 4
                 ((void *)0)
# 966 "../test/helpers/ssltestlib.c"
                 , cm)))
            goto err;
    }
# 982 "../test/helpers/ssltestlib.c"
    if (serverctx != 
# 982 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
            
# 983 "../test/helpers/ssltestlib.c"
           && ((min_proto_version > 0
                 && !test_true("../test/helpers/ssltestlib.c", 984, "SSL_CTX_set_min_proto_version(serverctx, min_proto_version)", (SSL_CTX_ctrl(serverctx, 123, min_proto_version, 
# 984 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 984 "../test/helpers/ssltestlib.c"
                    )) != 0)
                                                                               )
                || (max_proto_version > 0
                    && !test_true("../test/helpers/ssltestlib.c", 987, "SSL_CTX_set_max_proto_version(serverctx, max_proto_version)", (SSL_CTX_ctrl(serverctx, 124, max_proto_version, 
# 987 "../test/helpers/ssltestlib.c" 3 4
                       ((void *)0)
# 987 "../test/helpers/ssltestlib.c"
                       )) != 0)
                                                                                   )))
        goto err;
    if (clientctx != 
# 990 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
        
# 991 "../test/helpers/ssltestlib.c"
       && ((min_proto_version > 0
             && !test_true("../test/helpers/ssltestlib.c", 992, "SSL_CTX_set_min_proto_version(clientctx, min_proto_version)", (SSL_CTX_ctrl(clientctx, 123, min_proto_version, 
# 992 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
# 992 "../test/helpers/ssltestlib.c"
                )) != 0)
                                                                            )
            || (max_proto_version > 0
                && !test_true("../test/helpers/ssltestlib.c", 995, "SSL_CTX_set_max_proto_version(clientctx, max_proto_version)", (SSL_CTX_ctrl(clientctx, 124, max_proto_version, 
# 995 "../test/helpers/ssltestlib.c" 3 4
                   ((void *)0)
# 995 "../test/helpers/ssltestlib.c"
                   )) != 0)
                                                                               )))
        goto err;

    if (serverctx != 
# 999 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0) 
# 999 "../test/helpers/ssltestlib.c"
                         && certfile != 
# 999 "../test/helpers/ssltestlib.c" 3 4
                                        ((void *)0) 
# 999 "../test/helpers/ssltestlib.c"
...
# 999 "../test/helpers/ssltestlib.c"
        ...
        if (!test_int_eq("../test/helpers/ssltestlib.c", 1000, "SSL_CTX_use_certificate_file(serverctx, certfile, SSL_FILETYPE_PEM)", "1", SSL_CTX_use_certificate_file(serverctx, certfile, 1), 1)

                || !test_int_eq("../test/helpers/ssltestlib.c", 1002, "SSL_CTX_use_PrivateKey_file(serverctx, privkeyfile, SSL_FILETYPE_PEM)", "1", SSL_CTX_use_PrivateKey_file(serverctx, privkeyfile, 1), 1)


                || !test_int_eq("../test/helpers/ssltestlib.c", 1005, "SSL_CTX_check_private_key(serverctx)", "1", SSL_CTX_check_private_key(serverctx), 1))
            goto err;
    }

    if (sctx != 
# 1009 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 1009 "../test/helpers/ssltestlib.c"
                   )
        *sctx = serverctx;
    if (cctx != 
# 1011 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0)
# 1011 "../test/helpers/ssltestlib.c"
                   )
        *cctx = clientctx;
    return 1;
 ...
 err:
    if (sctx != 
# 1016 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0) 
# 1016 "../test/helpers/ssltestlib.c"
                    && *sctx == 
# 1016 "../test/helpers/ssltestlib.c" 3 4
                                ((void *)0)
# 1016 "../test/helpers/ssltestlib.c"
    ...
    if (cctx != 
# 1018 "../test/helpers/ssltestlib.c" 3 4
               ((void *)0) 
# 1018 "../test/helpers/ssltestlib.c"
                    && *cctx == 
# 1018 "../test/helpers/ssltestlib.c" 3 4
                                ((void *)0)
# 1018 "../test/helpers/ssltestlib.c"
...
# 1035 "../test/helpers/ssltestlib.c" 3 4
   ((void) (((
# 1035 "../test/helpers/ssltestlib.c"
   &readfds
# 1035 "../test/helpers/ssltestlib.c" 3 4
   )->__fds_bits)[((
# 1035 "../test/helpers/ssltestlib.c"
...
# 1035 "../test/helpers/ssltestlib.c"
    ...
    select(width, &readfds, 
# 1039 "../test/helpers/ssltestlib.c" 3 4
                           ((void *)0)
# 1039 "../test/helpers/ssltestlib.c"
                               , 
# 1039 "../test/helpers/ssltestlib.c" 3 4
                                 ((void *)0)
# 1039 "../test/helpers/ssltestlib.c"
    ...
    return 
# 1041 "../test/helpers/ssltestlib.c" 3 4
          ((((
# 1041 "../test/helpers/ssltestlib.c"
          &readfds
# 1041 "../test/helpers/ssltestlib.c" 3 4
          )->__fds_bits)[((
# 1041 "../test/helpers/ssltestlib.c"
...
int create_test_sockets(int *cfdp, int *sfdp, int socktype, BIO_ADDR *saddr)
{
    ...
    sin.sin_family = 
# 1053 "../test/helpers/ssltestlib.c" 3 4
                    2
# 1053 "../test/helpers/ssltestlib.c"
                           ;
    sin.sin_addr.s_addr = inet_addr(host);

    afd = BIO_socket(
# 1056 "../test/helpers/ssltestlib.c" 3 4
                    2
# 1056 "../test/helpers/ssltestlib.c"
                           , socktype,
                     socktype == 
# 1057 "../test/helpers/ssltestlib.c" 3 4
                                SOCK_STREAM 
# 1057 "../test/helpers/ssltestlib.c"
                                            ? 
# 1057 "../test/helpers/ssltestlib.c" 3 4
                                              IPPROTO_TCP 
# 1057 "../test/helpers/ssltestlib.c"
...
# 1057 "../test/helpers/ssltestlib.c"
    ...
    if (saddr != 
# 1067 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
            
# 1068 "../test/helpers/ssltestlib.c"
           && !BIO_ADDR_rawmake(saddr, sin.sin_family, &sin.sin_addr,
                                 sizeof(sin.sin_addr), sin.sin_port))
        goto out;

    if (socktype == 
# 1072 "../test/helpers/ssltestlib.c" 3 4
                   SOCK_STREAM 
# 1072 "../test/helpers/ssltestlib.c"
                               && listen(afd, 1) < 0)
        goto out;

    cfd = BIO_socket(
# 1075 "../test/helpers/ssltestlib.c" 3 4
                    2
# 1075 "../test/helpers/ssltestlib.c"
                           , socktype,
                     socktype == 
# 1076 "../test/helpers/ssltestlib.c" 3 4
                                SOCK_STREAM 
# 1076 "../test/helpers/ssltestlib.c"
                                            ? 
# 1076 "../test/helpers/ssltestlib.c" 3 4
                                              IPPROTO_TCP 
# 1076 "../test/helpers/ssltestlib.c"
...
# 1076 "../test/helpers/ssltestlib.c"
    ...
    if (socktype == 
# 1087 "../test/helpers/ssltestlib.c" 3 4
                   SOCK_DGRAM
# 1087 "../test/helpers/ssltestlib.c"
                             ) {
        cfd_connected = 1;
        sfd = afd;
        afd = -1;
    ...
    while (sfd == -1 || !cfd_connected) {
        sfd = accept(afd, 
# 1094 "../test/helpers/ssltestlib.c" 3 4
                         ((void *)0)
# 1094 "../test/helpers/ssltestlib.c"
                             , 0);
        if (sfd == -1 && 
# 1095 "../test/helpers/ssltestlib.c" 3 4
                        (*__errno_location ()) 
# 1095 "../test/helpers/ssltestlib.c"
                              != 
# 1095 "../test/helpers/ssltestlib.c" 3 4
                                 11
# 1095 "../test/helpers/ssltestlib.c"
...
{
    SSL *serverssl = 
# 1125 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 1125 "../test/helpers/ssltestlib.c"
                        , *clientssl = 
# 1125 "../test/helpers/ssltestlib.c" 3 4
                                       ((void *)0)
# 1125 "../test/helpers/ssltestlib.c"
                                           ;
    BIO *s_to_c_bio = 
# 1126 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 1126 "../test/helpers/ssltestlib.c"
                         , *c_to_s_bio = 
# 1126 "../test/helpers/ssltestlib.c" 3 4
                                         ((void *)0)
# 1126 "../test/helpers/ssltestlib.c"
    ...
    if (*sssl != 
# 1129 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
# 1129 "../test/helpers/ssltestlib.c"
                    )
        serverssl = *sssl;
    else if (!test_ptr("../test/helpers/ssltestlib.c", 1131, "serverssl = SSL_new(serverctx)", serverssl = SSL_new(serverctx)))
        goto error;
    if (*cssl != 
# 1133 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
# 1133 "../test/helpers/ssltestlib.c"
                    )
        clientssl = *cssl;
    else if (!test_ptr("../test/helpers/ssltestlib.c", 1135, "clientssl = SSL_new(clientctx)", clientssl = SSL_new(clientctx)))
        goto error;

    if (!test_ptr("../test/helpers/ssltestlib.c", 1138, "s_to_c_bio = BIO_new_socket(sfd, BIO_NOCLOSE)", s_to_c_bio = BIO_new_socket(sfd, 0x00))
            || !test_ptr("../test/helpers/ssltestlib.c", 1139, "c_to_s_bio = BIO_new_socket(cfd, BIO_NOCLOSE)", c_to_s_bio = BIO_new_socket(cfd, 0x00)))
        goto error;

    if (!test_false("../test/helpers/ssltestlib.c", 1142, "SSL_get_rpoll_descriptor(clientssl, &rdesc) || !TEST_false(SSL_get_wpoll_descriptor(clientssl, &wdesc))", (SSL_get_rpoll_descriptor(clientssl, &rdesc) || !test_false("../test/helpers/ssltestlib.c", 1143, "SSL_get_wpoll_descriptor(clientssl, &wdesc)", (SSL_get_wpoll_descriptor(clientssl, &wdesc)) != 0)) != 0)
                                                                    )
        goto error;
    ...
    if (!test_true("../test/helpers/ssltestlib.c", 1149, "SSL_get_rpoll_descriptor(clientssl, &rdesc)", (SSL_get_rpoll_descriptor(clientssl, &rdesc)) != 0)
        || !test_true("../test/helpers/ssltestlib.c", 1150, "SSL_get_wpoll_descriptor(clientssl, &wdesc)", (SSL_get_wpoll_descriptor(clientssl, &wdesc)) != 0)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1151, "rdesc.type", "BIO_POLL_DESCRIPTOR_TYPE_SOCK_FD", rdesc.type, 1)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1152, "wdesc.type", "BIO_POLL_DESCRIPTOR_TYPE_SOCK_FD", wdesc.type, 1)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1153, "rdesc.value.fd", "cfd", rdesc.value.fd, cfd)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1154, "wdesc.value.fd", "cfd", wdesc.value.fd, cfd))
        goto error;

    if (!test_true("../test/helpers/ssltestlib.c", 1157, "SSL_get_rpoll_descriptor(serverssl, &rdesc)", (SSL_get_rpoll_descriptor(serverssl, &rdesc)) != 0)
        || !test_true("../test/helpers/ssltestlib.c", 1158, "SSL_get_wpoll_descriptor(serverssl, &wdesc)", (SSL_get_wpoll_descriptor(serverssl, &wdesc)) != 0)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1159, "rdesc.type", "BIO_POLL_DESCRIPTOR_TYPE_SOCK_FD", rdesc.type, 1)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1160, "wdesc.type", "BIO_POLL_DESCRIPTOR_TYPE_SOCK_FD", wdesc.type, 1)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1161, "rdesc.value.fd", "sfd", rdesc.value.fd, sfd)
        || !test_int_eq("../test/helpers/ssltestlib.c", 1162, "wdesc.value.fd", "sfd", wdesc.value.fd, sfd))
        goto error;
...
# 1189 "../test/helpers/ssltestlib.c"
int create_ssl_objects(SSL_CTX *serverctx, SSL_CTX *clientctx, SSL **sssl,
                          SSL **cssl, BIO *s_to_c_fbio, BIO *c_to_s_fbio)
{
    SSL *serverssl = 
# 1192 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 1192 "../test/helpers/ssltestlib.c"
                        , *clientssl = 
# 1192 "../test/helpers/ssltestlib.c" 3 4
                                       ((void *)0)
# 1192 "../test/helpers/ssltestlib.c"
                                           ;
    BIO *s_to_c_bio = 
# 1193 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 1193 "../test/helpers/ssltestlib.c"
                         , *c_to_s_bio = 
# 1193 "../test/helpers/ssltestlib.c" 3 4
                                         ((void *)0)
# 1193 "../test/helpers/ssltestlib.c"
    ...
    if (*sssl != 
# 1195 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
# 1195 "../test/helpers/ssltestlib.c"
                    )
        serverssl = *sssl;
    else if (!test_ptr("../test/helpers/ssltestlib.c", 1197, "serverssl = SSL_new(serverctx)", serverssl = SSL_new(serverctx)))
        goto error;
    if (*cssl != 
# 1199 "../test/helpers/ssltestlib.c" 3 4
                ((void *)0)
# 1199 "../test/helpers/ssltestlib.c"
                    )
        clientssl = *cssl;
    else if (!test_ptr("../test/helpers/ssltestlib.c", 1201, "clientssl = SSL_new(clientctx)", clientssl = SSL_new(clientctx)))
        goto error;

    if (SSL_is_dtls(clientssl)) {
        if (!test_ptr("../test/helpers/ssltestlib.c", 1205, "s_to_c_bio = BIO_new(bio_s_mempacket_test())", s_to_c_bio = BIO_new(bio_s_mempacket_test()))
                || !test_ptr("../test/helpers/ssltestlib.c", 1206, "c_to_s_bio = BIO_new(bio_s_mempacket_test())", c_to_s_bio = BIO_new(bio_s_mempacket_test())))
            goto error;
    } else {
        if (!test_ptr("../test/helpers/ssltestlib.c", 1209, "s_to_c_bio = BIO_new(BIO_s_mem())", s_to_c_bio = BIO_new(BIO_s_mem()))
                || !test_ptr("../test/helpers/ssltestlib.c", 1210, "c_to_s_bio = BIO_new(BIO_s_mem())", c_to_s_bio = BIO_new(BIO_s_mem())))
            goto error;
    }

    if (s_to_c_fbio != 
# 1214 "../test/helpers/ssltestlib.c" 3 4
                      ((void *)0)
            
# 1215 "../test/helpers/ssltestlib.c"
           && !test_ptr("../test/helpers/ssltestlib.c", 1215, "s_to_c_bio = BIO_push(s_to_c_fbio, s_to_c_bio)", s_to_c_bio = BIO_push(s_to_c_fbio, s_to_c_bio)))
        goto error;
    if (c_to_s_fbio != 
# 1217 "../test/helpers/ssltestlib.c" 3 4
                      ((void *)0)
            
# 1218 "../test/helpers/ssltestlib.c"
           && !test_ptr("../test/helpers/ssltestlib.c", 1218, "c_to_s_bio = BIO_push(c_to_s_fbio, c_to_s_bio)", c_to_s_bio = BIO_push(c_to_s_fbio, c_to_s_bio)))
        goto error;


    BIO_ctrl(s_to_c_bio,130,-1,
# 1222 "../test/helpers/ssltestlib.c" 3 4
   ((void *)0)
# 1222 "../test/helpers/ssltestlib.c"
   );
    BIO_ctrl(c_to_s_bio,130,-1,
# 1223 "../test/helpers/ssltestlib.c" 3 4
   ((void *)0)
# 1223 "../test/helpers/ssltestlib.c"
   );
...
# 1255 "../test/helpers/ssltestlib.c"
int create_bare_ssl_connection(SSL *serverssl, SSL *clientssl, int want,
                               int read, int listen)
{
    ...
    BIO_ADDR *peer = 
# 1262 "../test/helpers/ssltestlib.c" 3 4
                    ((void *)0)
# 1262 "../test/helpers/ssltestlib.c"
                        ;

    if (listen) {
        if (!isdtls) {
            test_error("../test/helpers/ssltestlib.c", 1266, "DTLSv1_listen requested for non-DTLS object\n");
            return 0;
        }
        peer = BIO_ADDR_new();
        if (!test_ptr("../test/helpers/ssltestlib.c", 1270, "peer", peer))
            return 0;
    }
    ...
    do {
        err = 3;
        while (!clienterr && retc <= 0 && err == 3) {
            retc = SSL_connect(clientssl);
            if (retc <= 0)
                err = SSL_get_error(clientssl, retc);
        }

        if (!clienterr && retc <= 0 && err != 2) {
            test_info("../test/helpers/ssltestlib.c", 1289, "SSL_connect() failed %d, %d", retc, err);
            if (want != 1)
                test_openssl_errors();
            clienterr = 1;
        }
        ...
        if (!servererr && rets <= 0
                && err != 2
                && err != 4) {
            test_info("../test/helpers/ssltestlib.c", 1323, "SSL_accept() failed %d, %d", rets, err);
            if (want != 1)
                test_openssl_errors();
            servererr = 1;
        }
        ...
        if (isdtls && read) {
            ...
            if (rets > 0 && retc <= 0) {
                if (SSL_read(serverssl, buf, sizeof(buf)) > 0) {
                    ...
                    test_info("../test/helpers/ssltestlib.c", 1339, "Unexpected SSL_read() success!");
                    goto err;
                }
            }
            if (retc > 0 && rets <= 0) {
                if (SSL_read(clientssl, buf, sizeof(buf)) > 0) {
                    ...
                    test_info("../test/helpers/ssltestlib.c", 1346, "Unexpected SSL_read() success!");
                    goto err;
                }
            }
        }
        if (++abortctr == 1000000) {
            test_info("../test/helpers/ssltestlib.c", 1352, "No progress made");
            goto err;
        }
...
int create_ssl_connection(SSL *serverssl, SSL *clientssl, int want)
{
    ...
    for (i = 0; i < 2; i++) {
        if (SSL_read_ex(clientssl, &buf, sizeof(buf), &readbytes) > 0) {
            if (!test_ulong_eq("../test/helpers/ssltestlib.c", 1393, "readbytes", "0", readbytes, 0))
                return 0;
        } else if (!test_int_eq("../test/helpers/ssltestlib.c", 1395, "SSL_get_error(clientssl, 0)", "SSL_ERROR_WANT_READ", SSL_get_error(clientssl, 0), 2)
                                                    ) {
            return 0;
        }
    }
...
# 1414 "../test/helpers/ssltestlib.c" 3 4
                              ((void *)0)
# 1414 "../test/helpers/ssltestlib.c"
                                  ;
    ...
    SSL_SESSION *sess = 
# 1422 "../test/helpers/ssltestlib.c" 3 4
                       ((void *)0)
# 1422 "../test/helpers/ssltestlib.c"
                           ;

    if (mdsize == 48) {
        cipher = SSL_CIPHER_find(ssl, ((const unsigned char *)"\x13\x02"));
    } else if (mdsize == 32) {




        cipher = SSL_CIPHER_find(ssl, ((const unsigned char *)"\x13\x01"));
    } else {

        return 
# 1434 "../test/helpers/ssltestlib.c" 3 4
              ((void *)0)
# 1434 "../test/helpers/ssltestlib.c"
                  ;
    }
    sess = SSL_SESSION_new();
    if (!test_ptr("../test/helpers/ssltestlib.c", 1437, "sess", sess)
            || !test_ptr("../test/helpers/ssltestlib.c", 1438, "cipher", cipher)
            || !test_true("../test/helpers/ssltestlib.c", 1439, "SSL_SESSION_set1_master_key(sess, key, mdsize)", (SSL_SESSION_set1_master_key(sess, key, mdsize)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 1440, "SSL_SESSION_set_cipher(sess, cipher)", (SSL_SESSION_set_cipher(sess, cipher)) != 0)
            || !test_true("../test/helpers/ssltestlib.c", 1441, "SSL_SESSION_set_protocol_version(sess, TLS1_3_VERSION)", (SSL_SESSION_set_protocol_version(sess, 0x0304)) != 0)

                                                                     ) {
        SSL_SESSION_free(sess);
        return 
# 1445 "../test/helpers/ssltestlib.c" 3 4
              ((void *)0)
# 1445 "../test/helpers/ssltestlib.c"
                  ;
    }
    return sess;
}
...
{
    BIO *certbio = 
# 1455 "../test/helpers/ssltestlib.c" 3 4
                  ((void *)0)
# 1455 "../test/helpers/ssltestlib.c"
                      ;
    X509 *chaincert = 
# 1456 "../test/helpers/ssltestlib.c" 3 4
                     ((void *)0)
# 1456 "../test/helpers/ssltestlib.c"
                         ;
    int certlen;
    int ret = 0;
    int i;

    if (!test_ptr("../test/helpers/ssltestlib.c", 1461, "certbio = BIO_new_file(cert_file, \"r\")", certbio = BIO_new_file(cert_file, "r")))
        goto end;

    if (!test_ptr("../test/helpers/ssltestlib.c", 1464, "chaincert = X509_new_ex(libctx, NULL)", chaincert = X509_new_ex(libctx, 
# 1464 "../test/helpers/ssltestlib.c" 3 4
        ((void *)0)
# 1464 "../test/helpers/ssltestlib.c"
        )))
        goto end;

    if (PEM_read_bio_X509(certbio, &chaincert, 
# 1467 "../test/helpers/ssltestlib.c" 3 4
                                              ((void *)0)
# 1467 "../test/helpers/ssltestlib.c"
                                                  , 
# 1467 "../test/helpers/ssltestlib.c" 3 4
                                                    ((void *)0)
# 1467 "../test/helpers/ssltestlib.c"
...
# 1467 "../test/helpers/ssltestlib.c"
    ...
    BIO_free(certbio);
    certbio = 
# 1470 "../test/helpers/ssltestlib.c" 3 4
             ((void *)0)
# 1470 "../test/helpers/ssltestlib.c"
                 ;
# 1479 "../test/helpers/ssltestlib.c"
    certlen = i2d_X509(chaincert, 
# 1479 "../test/helpers/ssltestlib.c" 3 4
                                 ((void *)0)
# 1479 "../test/helpers/ssltestlib.c"
                                     );
    (void)((certlen * 40 > (16384 * 4) / 3) ? 0 : (OPENSSL_die("assertion failed: " "certlen * NUM_EXTRA_CERTS > (SSL3_RT_MAX_PLAIN_LENGTH * 4) / 3", "../test/helpers/ssltestlib.c", 1480), 1))
                                                      ;
    for (i = 0; i < 40; i++) {
        if (!X509_up_ref(chaincert))
            goto end;
        if (!SSL_CTX_ctrl(sctx,14,0,(char *)(chaincert))) {
            X509_free(chaincert);
            goto end;
        }
    }
...
ENGINE *load_dasync(void)
{
# 1518 "../test/helpers/ssltestlib.c"
    return 
# 1518 "../test/helpers/ssltestlib.c" 3 4
          ((void *)0)
# 1518 "../test/helpers/ssltestlib.c"
              ;
