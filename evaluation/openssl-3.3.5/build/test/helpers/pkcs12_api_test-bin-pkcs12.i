# 0 "../test/helpers/pkcs12.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/pkcs12.c"
# 10 "../test/helpers/pkcs12.c"
...
# 13 "../test/helpers/pkcs12.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../test/helpers/pkcs12.c" 2
...
# 22 "../test/helpers/pkcs12.c" 2
# 1 "../test/helpers/pkcs12.h" 1
# 29 "../test/helpers/pkcs12.h"
...
static OSSL_LIB_CTX *test_ctx = 
# 29 "../test/helpers/pkcs12.c" 3 4
                               ((void *)0)
# 29 "../test/helpers/pkcs12.c"
                                   ;
static const char *test_propq = 
# 30 "../test/helpers/pkcs12.c" 3 4
                               ((void *)0)
# 30 "../test/helpers/pkcs12.c"
                                   ;
...
static int check_attrs(const struct stack_st_X509_ATTRIBUTE *bag_attrs, const PKCS12_ATTR *attrs);
...
{
    X509 *cert = 
# 79 "../test/helpers/pkcs12.c" 3 4
                ((void *)0)
# 79 "../test/helpers/pkcs12.c"
                    ;

    cert = d2i_X509(
# 81 "../test/helpers/pkcs12.c" 3 4
                   ((void *)0)
# 81 "../test/helpers/pkcs12.c"
                       , &bytes, len);
    if (!test_ptr("../test/helpers/pkcs12.c", 82, "cert", cert))
        goto err;
err:
    return cert;
}
...
{
    EVP_PKEY *pkey = 
# 90 "../test/helpers/pkcs12.c" 3 4
                    ((void *)0)
# 90 "../test/helpers/pkcs12.c"
                        ;

    pkey = d2i_AutoPrivateKey(
# 92 "../test/helpers/pkcs12.c" 3 4
                             ((void *)0)
# 92 "../test/helpers/pkcs12.c"
                                 , &bytes, len);
    if (!test_ptr("../test/helpers/pkcs12.c", 93, "pkey", pkey))
        goto err;
err:
    return pkey;
}
...
PKCS12_BUILDER *new_pkcs12_builder(const char *filename)
{
    PKCS12_BUILDER *pb = CRYPTO_malloc(sizeof(PKCS12_BUILDER), "../test/helpers/pkcs12.c", 105);
    if (!test_ptr("../test/helpers/pkcs12.c", 106, "pb", pb))
        return 
# 107 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 107 "../test/helpers/pkcs12.c"
                  ;
...
int end_pkcs12_builder(PKCS12_BUILDER *pb)
{
    ...
    CRYPTO_free(pb, "../test/helpers/pkcs12.c", 118);
    return result;
}
...
{
    pb->safes = 
# 125 "../test/helpers/pkcs12.c" 3 4
               ((void *)0)
# 125 "../test/helpers/pkcs12.c"
                   ;
}
...
void end_pkcs12(PKCS12_BUILDER *pb)
{
    if (!pb->success)
        return;
    generate_p12(pb, 
# 133 "../test/helpers/pkcs12.c" 3 4
                    ((void *)0)
# 133 "../test/helpers/pkcs12.c"
                        );
}
...
static void generate_p12(PKCS12_BUILDER *pb, const PKCS12_ENC *mac)
{
    PKCS12 *p12;
    EVP_MD *md = 
# 149 "../test/helpers/pkcs12.c" 3 4
                ((void *)0)
# 149 "../test/helpers/pkcs12.c"
                    ;
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 155, "pb->p12bio", pb->p12bio)) {
        pb->success = 0;
        return;
    }
    if (legacy)
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 163, "p12", p12)) {
        pb->success = 0;
        goto err;
    }
    OPENSSL_sk_pop_free(ossl_check_PKCS7_sk_type(pb->safes),ossl_check_PKCS7_freefunc_type(PKCS7_free));

    if (mac != 
# 169 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 169 "../test/helpers/pkcs12.c"
                  ) {
        if (legacy)
            md = (EVP_MD *)EVP_get_digestbyname(OBJ_nid2sn(mac->nid));
        else
            md = EVP_MD_fetch(test_ctx, OBJ_nid2sn(mac->nid), test_propq);

        if (!test_true("../test/helpers/pkcs12.c", 175, "PKCS12_set_mac(p12, mac->pass, strlen(mac->pass), NULL, 0, mac->iter, md)", (PKCS12_set_mac(p12, mac->pass, strlen(mac->pass), 
# 175 "../test/helpers/pkcs12.c" 3 4
            ((void *)0)
# 175 "../test/helpers/pkcs12.c"
            , 0, mac->iter, md)) != 0)
                                                              ) {
            pb->success = 0;
            goto err;
...
err:
    if (!legacy && md != 
# 187 "../test/helpers/pkcs12.c" 3 4
                        ((void *)0)
# 187 "../test/helpers/pkcs12.c"
                            )
        EVP_MD_free(md);
    PKCS12_free(p12);
}
...
static int write_p12(PKCS12 *p12, const char *outfile)
{
    ...
    if (out == 
# 198 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 198 "../test/helpers/pkcs12.c"
                  )
        goto err;

    if (!test_int_eq("../test/helpers/pkcs12.c", 201, "i2d_PKCS12_bio(out, p12)", "1", i2d_PKCS12_bio(out, p12), 1))
        goto err;
    ret = 1;
err:
    BIO_free(out);
...
{
    PKCS12 *p12 = 
# 211 "../test/helpers/pkcs12.c" 3 4
                 ((void *)0)
# 211 "../test/helpers/pkcs12.c"
                     ;


    if (!legacy) {
        p12 = PKCS12_init_ex(21, test_ctx, test_propq);
        if (!test_ptr("../test/helpers/pkcs12.c", 216, "p12", p12))
            goto err;
    }
    p12 = d2i_PKCS12_bio(bio, &p12);
    BIO_free(bio);
    if (!test_ptr("../test/helpers/pkcs12.c", 221, "p12", p12))
        goto err;
    if (mac == 
# 223 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 223 "../test/helpers/pkcs12.c"
                  ) {
        if (!test_false("../test/helpers/pkcs12.c", 224, "PKCS12_mac_present(p12)", (PKCS12_mac_present(p12)) != 0))
            goto err;
    } else {
...
err:
    PKCS12_free(p12);
    return 
# 233 "../test/helpers/pkcs12.c" 3 4
          ((void *)0)
# 233 "../test/helpers/pkcs12.c"
              ;
}
...
{
    PKCS12 *p12 = 
# 240 "../test/helpers/pkcs12.c" 3 4
                 ((void *)0)
# 240 "../test/helpers/pkcs12.c"
                     ;
    BIO *in = BIO_new_file(infile, "r");

    if (in == 
# 243 "../test/helpers/pkcs12.c" 3 4
             ((void *)0)
# 243 "../test/helpers/pkcs12.c"
                 )
        goto err;
    p12 = d2i_PKCS12_bio(in, 
# 245 "../test/helpers/pkcs12.c" 3 4
                            ((void *)0)
# 245 "../test/helpers/pkcs12.c"
                                );
    BIO_free(in);
    if (!test_ptr("../test/helpers/pkcs12.c", 247, "p12", p12))
        goto err;
    if (mac == 
# 249 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 249 "../test/helpers/pkcs12.c"
                  ) {
        if (!test_false("../test/helpers/pkcs12.c", 250, "PKCS12_mac_present(p12)", (PKCS12_mac_present(p12)) != 0))
            goto err;
    } else {
        if (!check_p12_mac(p12, mac))
            goto err;
...
err:
    PKCS12_free(p12);
    return 
# 259 "../test/helpers/pkcs12.c" 3 4
          ((void *)0)
# 259 "../test/helpers/pkcs12.c"
              ;
}

static int check_p12_mac(PKCS12 *p12, const PKCS12_ENC *mac)
{
    return test_true("../test/helpers/pkcs12.c", 264, "PKCS12_mac_present(p12)", (PKCS12_mac_present(p12)) != 0)
        && test_true("../test/helpers/pkcs12.c", 265, "PKCS12_verify_mac(p12, mac->pass, strlen(mac->pass))", (PKCS12_verify_mac(p12, mac->pass, strlen(mac->pass))) != 0);
}
...
{
    pb->bags = 
# 275 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 275 "../test/helpers/pkcs12.c"
                  ;
}
...
void end_contentinfo(PKCS12_BUILDER *pb)
{
    if (pb->success && pb->bags != 
# 281 "../test/helpers/pkcs12.c" 3 4
                                  ((void *)0)
# 281 "../test/helpers/pkcs12.c"
                                      ) {
        if (!test_true("../test/helpers/pkcs12.c", 282, "PKCS12_add_safe(&pb->safes, pb->bags, -1, 0, NULL)", (PKCS12_add_safe(&pb->safes, pb->bags, -1, 0, 
# 282 "../test/helpers/pkcs12.c" 3 4
            ((void *)0)
# 282 "../test/helpers/pkcs12.c"
            )) != 0))
            pb->success = 0;
    }
    OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(pb->bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    pb->bags = 
# 286 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 286 "../test/helpers/pkcs12.c"
                  ;
}
...
{
    if (pb->success && pb->bags != 
# 292 "../test/helpers/pkcs12.c" 3 4
                                  ((void *)0)
# 292 "../test/helpers/pkcs12.c"
                                      ) {
        if (legacy) {
            if (!test_true("../test/helpers/pkcs12.c", 294, "PKCS12_add_safe(&pb->safes, pb->bags, enc->nid, enc->iter, enc->pass)", (PKCS12_add_safe(&pb->safes, pb->bags, enc->nid, enc->iter, enc->pass)) != 0)
                                                                 )
                pb->success = 0;
        } else {
            if (!test_true("../test/helpers/pkcs12.c", 298, "PKCS12_add_safe_ex(&pb->safes, pb->bags, enc->nid, enc->iter, enc->pass, test_ctx, test_propq)", (PKCS12_add_safe_ex(&pb->safes, pb->bags, enc->nid, enc->iter, enc->pass, test_ctx, test_propq)) != 0)
    ...
    OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(pb->bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    pb->bags = 
# 305 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 305 "../test/helpers/pkcs12.c"
                  ;
}


static struct stack_st_PKCS12_SAFEBAG *decode_contentinfo(struct stack_st_PKCS7 *safes, int idx, const PKCS12_ENC *enc)
{
    struct stack_st_PKCS12_SAFEBAG *bags = 
# 311 "../test/helpers/pkcs12.c" 3 4
                                    ((void *)0)
# 311 "../test/helpers/pkcs12.c"
                                        ;
    int bagnid;
    PKCS7 *p7 = ((PKCS7 *)OPENSSL_sk_value(ossl_check_const_PKCS7_sk_type(safes), (idx)));

    if (!test_ptr("../test/helpers/pkcs12.c", 315, "p7", p7))
        goto err;

    bagnid = OBJ_obj2nid(p7->type);
    if (enc) {
        if (!test_int_eq("../test/helpers/pkcs12.c", 320, "bagnid", "NID_pkcs7_encrypted", bagnid, 26))
            goto err;
        bags = PKCS12_unpack_p7encdata(p7, enc->pass, strlen(enc->pass));
    } else {
        if (!test_int_eq("../test/helpers/pkcs12.c", 324, "bagnid", "NID_pkcs7_data", bagnid, 21))
            goto err;
        bags = PKCS12_unpack_p7data(p7);
    }
    if (!test_ptr("../test/helpers/pkcs12.c", 328, "bags", bags))
        goto err;

    return bags;
err:
    return 
# 333 "../test/helpers/pkcs12.c" 3 4
          ((void *)0)
# 333 "../test/helpers/pkcs12.c"
              ;
}
...
# 346 "../test/helpers/pkcs12.c" 3 4
                                     ((void *)0)
# 346 "../test/helpers/pkcs12.c"
                                         ;
    X509_ATTRIBUTE *x509_attr = 
# 347 "../test/helpers/pkcs12.c" 3 4
                               ((void *)0)
# 347 "../test/helpers/pkcs12.c"
                                   ;

    if (attr == 
# 349 "../test/helpers/pkcs12.c" 3 4
               ((void *)0)
# 349 "../test/helpers/pkcs12.c"
                   )
        return 1;

    while (p_attr->oid != 
# 352 "../test/helpers/pkcs12.c" 3 4
                         ((void *)0)
# 352 "../test/helpers/pkcs12.c"
                             ) {
        test_info("../test/helpers/pkcs12.c", 353, "Adding attribute %s = %s", p_attr->oid, p_attr->value);
        attr_nid = OBJ_txt2nid(p_attr->oid);

        if (attr_nid == 156) {
            if (!test_true("../test/helpers/pkcs12.c", 357, "PKCS12_add_friendlyname(bag, p_attr->value, -1)", (PKCS12_add_friendlyname_utf8(bag, p_attr->value, -1)) != 0))
                goto err;
        } else if (attr_nid == 157) {
            if (!test_true("../test/helpers/pkcs12.c", 360, "PKCS12_add_localkeyid(bag, (unsigned char *)p_attr->value, strlen(p_attr->value))", (PKCS12_add_localkeyid(bag, (unsigned char *)p_attr->value, strlen(p_attr->value))) != 0)
                                                                        )
                goto err;
        } else if (attr_nid == 1283) {
            attrs = (struct stack_st_X509_ATTRIBUTE*)PKCS12_SAFEBAG_get0_attrs(bag);
            x509_attr = X509_ATTRIBUTE_create(attr_nid, 6, OBJ_txt2obj(p_attr->value, 0));
            X509at_add1_attr(&attrs, x509_attr);
            PKCS12_SAFEBAG_set0_attrs(bag, attrs);
            X509_ATTRIBUTE_free(x509_attr);
        } else {

            if (!test_true("../test/helpers/pkcs12.c", 371, "PKCS12_add1_attr_by_txt(bag, p_attr->oid, MBSTRING_ASC, (unsigned char *)p_attr->value, strlen(p_attr->value))", (PKCS12_add1_attr_by_txt(bag, p_attr->oid, (0x1000|1), (unsigned char *)p_attr->value, strlen(p_attr->value))) != 0)
...
{
    PKCS12_SAFEBAG *bag = 
# 386 "../test/helpers/pkcs12.c" 3 4
                         ((void *)0)
# 386 "../test/helpers/pkcs12.c"
                             ;
    X509 *cert = 
# 387 "../test/helpers/pkcs12.c" 3 4
                ((void *)0)
# 387 "../test/helpers/pkcs12.c"
                    ;
    char *name;
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 394, "cert", cert)) {
        pb->success = 0;
        return;
    }

    name = X509_NAME_oneline(X509_get_subject_name(cert), 
# 399 "../test/helpers/pkcs12.c" 3 4
                                                         ((void *)0)
# 399 "../test/helpers/pkcs12.c"
                                                             , 0);
    test_info("../test/helpers/pkcs12.c", 400, "Adding certificate <%s>", name);
    CRYPTO_free(name, "../test/helpers/pkcs12.c", 401);

    bag = PKCS12_add_cert(&pb->bags, cert);
    if (!test_ptr("../test/helpers/pkcs12.c", 404, "bag", bag)) {
        pb->success = 0;
        goto err;
    }

    if (!test_true("../test/helpers/pkcs12.c", 409, "add_attributes(bag, attrs)", (add_attributes(bag, attrs)) != 0)) {
        pb->success = 0;
        goto err;
    }
err:
...
{
    PKCS12_SAFEBAG *bag = 
# 420 "../test/helpers/pkcs12.c" 3 4
                         ((void *)0)
# 420 "../test/helpers/pkcs12.c"
                             ;
    EVP_PKEY *pkey = 
# 421 "../test/helpers/pkcs12.c" 3 4
                    ((void *)0)
# 421 "../test/helpers/pkcs12.c"
                        ;

    if (!pb->success)
        return;

    test_info("../test/helpers/pkcs12.c", 426, "Adding key");

    pkey = load_pkey_asn1(bytes, len);
    if (!test_ptr("../test/helpers/pkcs12.c", 429, "pkey", pkey)) {
        pb->success = 0;
        return;
    }

    if (legacy)
        bag = PKCS12_add_key(&pb->bags, pkey, 0 , enc->iter, enc->nid, enc->pass);
    else
        bag = PKCS12_add_key_ex(&pb->bags, pkey, 0 , enc->iter, enc->nid, enc->pass,
                                test_ctx, test_propq);
    if (!test_ptr("../test/helpers/pkcs12.c", 439, "bag", bag)) {
        pb->success = 0;
        goto err;
    }
...
{
    PKCS12_SAFEBAG *bag = 
# 452 "../test/helpers/pkcs12.c" 3 4
                         ((void *)0)
# 452 "../test/helpers/pkcs12.c"
                             ;

    if (!pb->success)
        return;

    test_info("../test/helpers/pkcs12.c", 457, "Adding secret <%s>", secret);

    bag = PKCS12_add_secret(&pb->bags, secret_nid, (const unsigned char *)secret, strlen(secret));
    if (!test_ptr("../test/helpers/pkcs12.c", 460, "bag", bag)) {
        pb->success = 0;
        return;
    }
    if (!add_attributes(bag, attrs))
...
static int check_asn1_string(const ASN1_TYPE *av, const char *txt)
{
    int ret = 0;
    char *value = 
# 476 "../test/helpers/pkcs12.c" 3 4
                 ((void *)0)
# 476 "../test/helpers/pkcs12.c"
                     ;

    if (!test_ptr("../test/helpers/pkcs12.c", 478, "av", av))
        goto err;
    ...
    case 30:
        ...
        if (!test_str_eq("../test/helpers/pkcs12.c", 485, "txt", "(char *)value", txt, (char *)value))
            goto err;
        break;

    case 12:
        if (!test_mem_eq("../test/helpers/pkcs12.c", 490, "txt", "(char *)av->value.utf8string->data", txt, strlen(txt), (char *)av->value.utf8string->data, av->value.utf8string->length)
                                                      )
            goto err;
        break;

    case 4:
        if (!test_mem_eq("../test/helpers/pkcs12.c", 496, "txt", "(char *)av->value.octet_string->data", txt, strlen(txt), (char *)av->value.octet_string->data, av->value.octet_string->length)
    ...
    ret = 1;
err:
    CRYPTO_free(value, "../test/helpers/pkcs12.c", 508);
    return ret;
}
...
static int check_attrs(const struct stack_st_X509_ATTRIBUTE *bag_attrs, const PKCS12_ATTR *attrs)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(bag_attrs)); i++) {
        const PKCS12_ATTR *p_attr = attrs;
        ASN1_OBJECT *attr_obj;

        attr = ((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(bag_attrs), (i)));
        attr_obj = X509_ATTRIBUTE_get0_object(attr);
        OBJ_obj2txt(attr_txt, 100, attr_obj, 0);

        while (p_attr->oid != 
# 528 "../test/helpers/pkcs12.c" 3 4
                             ((void *)0)
# 528 "../test/helpers/pkcs12.c"
                                 ) {

            if (strcmp(p_attr->oid, attr_txt) == 0) {
                if (!test_int_eq("../test/helpers/pkcs12.c", 531, "X509_ATTRIBUTE_count(attr)", "1", X509_ATTRIBUTE_count(attr), 1))
                    goto err;

                for (j = 0; j < X509_ATTRIBUTE_count(attr); j++)
                {
                    av = X509_ATTRIBUTE_get0_type(attr, j);
                    if (!test_true("../test/helpers/pkcs12.c", 537, "check_asn1_string(av, p_attr->value)", (check_asn1_string(av, p_attr->value)) != 0))
                        goto err;
                }
                break;
            }
...
{
    X509 *x509 = 
# 553 "../test/helpers/pkcs12.c" 3 4
                ((void *)0)
# 553 "../test/helpers/pkcs12.c"
                    ;
    X509 *ref_x509 = 
# 554 "../test/helpers/pkcs12.c" 3 4
                    ((void *)0)
# 554 "../test/helpers/pkcs12.c"
                        ;
    ...
    bag = ((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags), (pb->bag_idx++)));
    if (!test_ptr("../test/helpers/pkcs12.c", 561, "bag", bag)) {
        pb->success = 0;
        return;
    }
    if (!check_attrs(PKCS12_SAFEBAG_get0_attrs(bag), attrs)
        || !test_int_eq("../test/helpers/pkcs12.c", 566, "PKCS12_SAFEBAG_get_nid(bag)", "NID_certBag", PKCS12_SAFEBAG_get_nid(bag), 152)
        || !test_int_eq("../test/helpers/pkcs12.c", 567, "PKCS12_SAFEBAG_get_bag_nid(bag)", "NID_x509Certificate", PKCS12_SAFEBAG_get_bag_nid(bag), 158)) {
        pb->success = 0;
        return;
    }
    x509 = PKCS12_SAFEBAG_get1_cert(bag);
    if (!test_ptr("../test/helpers/pkcs12.c", 572, "x509", x509)) {
        pb->success = 0;
        goto err;
    }
    ref_x509 = load_cert_asn1(bytes, len);
    if (!test_false("../test/helpers/pkcs12.c", 577, "X509_cmp(x509, ref_x509)", (X509_cmp(x509, ref_x509)) != 0))
        pb->success = 0;
err:
    X509_free(x509);
    X509_free(ref_x509);
...
{
    EVP_PKEY *pkey = 
# 587 "../test/helpers/pkcs12.c" 3 4
                    ((void *)0)
# 587 "../test/helpers/pkcs12.c"
                        ;
    EVP_PKEY *ref_pkey = 
# 588 "../test/helpers/pkcs12.c" 3 4
                        ((void *)0)
# 588 "../test/helpers/pkcs12.c"
                            ;
    ...
    bag = ((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags), (pb->bag_idx++)));
    if (!test_ptr("../test/helpers/pkcs12.c", 597, "bag", bag)) {
        pb->success = 0;
        return;
    }
    ...
    case 150:
        ...
        if (!test_ptr("../test/helpers/pkcs12.c", 610, "pkey = EVP_PKCS82PKEY(p8c)", pkey = EVP_PKCS82PKEY(p8c))) {
            pb->success = 0;
            goto err;
        }
        break;
    ...
    case 151:
        ...
        if (!test_ptr("../test/helpers/pkcs12.c", 621, "p8", p8)) {
            pb->success = 0;
            goto err;
        }
        if (!test_ptr("../test/helpers/pkcs12.c", 625, "pkey = EVP_PKCS82PKEY(p8)", pkey = EVP_PKCS82PKEY(p8))) {
    ...
    if (!test_true("../test/helpers/pkcs12.c", 640, "EVP_PKEY_eq(pkey, ref_pkey)", (EVP_PKEY_eq(pkey, ref_pkey)) != 0))
        pb->success = 0;
err:
    EVP_PKEY_free(pkey);
...
void check_secretbag(PKCS12_BUILDER *pb, int secret_nid, const char *secret, const PKCS12_ATTR *attrs)
{
    ...
    bag = ((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags), (pb->bag_idx++)));
    if (!test_ptr("../test/helpers/pkcs12.c", 655, "bag", bag)) {
        pb->success = 0;
        return;
    }

    if (!check_attrs(PKCS12_SAFEBAG_get0_attrs(bag), attrs)
        || !test_int_eq("../test/helpers/pkcs12.c", 661, "PKCS12_SAFEBAG_get_nid(bag)", "NID_secretBag", PKCS12_SAFEBAG_get_nid(bag), 154)
        || !test_int_eq("../test/helpers/pkcs12.c", 662, "PKCS12_SAFEBAG_get_bag_nid(bag)", "secret_nid", PKCS12_SAFEBAG_get_bag_nid(bag), secret_nid)
        || !test_true("../test/helpers/pkcs12.c", 663, "check_asn1_string(PKCS12_SAFEBAG_get0_bag_obj(bag), secret)", (check_asn1_string(PKCS12_SAFEBAG_get0_bag_obj(bag), secret)) != 0))
        pb->success = 0;
}
...
void start_check_pkcs12(PKCS12_BUILDER *pb)
{
    ...
    p12 = from_bio_p12(pb->p12bio, 
# 675 "../test/helpers/pkcs12.c" 3 4
                                  ((void *)0)
# 675 "../test/helpers/pkcs12.c"
                                      );
    if (!test_ptr("../test/helpers/pkcs12.c", 676, "p12", p12)) {
        pb->success = 0;
        return;
    }
    pb->safes = PKCS12_unpack_authsafes(p12);
    if (!test_ptr("../test/helpers/pkcs12.c", 681, "pb->safes", pb->safes))
        pb->success = 0;
...
void start_check_pkcs12_with_mac(PKCS12_BUILDER *pb, const PKCS12_ENC *mac)
{
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 696, "p12", p12)) {
        pb->success = 0;
        return;
    }
    pb->safes = PKCS12_unpack_authsafes(p12);
    if (!test_ptr("../test/helpers/pkcs12.c", 701, "pb->safes", pb->safes))
        pb->success = 0;
...
void start_check_pkcs12_file(PKCS12_BUILDER *pb)
{
    ...
    p12 = read_p12(pb->filename, 
# 715 "../test/helpers/pkcs12.c" 3 4
                                ((void *)0)
# 715 "../test/helpers/pkcs12.c"
                                    );
    if (!test_ptr("../test/helpers/pkcs12.c", 716, "p12", p12)) {
        pb->success = 0;
        return;
    }
    pb->safes = PKCS12_unpack_authsafes(p12);
    if (!test_ptr("../test/helpers/pkcs12.c", 721, "pb->safes", pb->safes))
        pb->success = 0;
...
void start_check_pkcs12_file_with_mac(PKCS12_BUILDER *pb, const PKCS12_ENC *mac)
{
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 736, "p12", p12)) {
        pb->success = 0;
        return;
    }
    pb->safes = PKCS12_unpack_authsafes(p12);
    if (!test_ptr("../test/helpers/pkcs12.c", 741, "pb->safes", pb->safes))
        pb->success = 0;
...
void start_check_contentinfo(PKCS12_BUILDER *pb)
{
    ...
    pb->bag_idx = 0;
    pb->bags = decode_contentinfo(pb->safes, pb->safe_idx++, 
# 763 "../test/helpers/pkcs12.c" 3 4
                                                            ((void *)0)
# 763 "../test/helpers/pkcs12.c"
                                                                );
    if (!test_ptr("../test/helpers/pkcs12.c", 764, "pb->bags", pb->bags)) {
        pb->success = 0;
        return;
    }
    test_info("../test/helpers/pkcs12.c", 768, "Decoding %d bags", OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags)));
}
...
void start_check_contentinfo_encrypted(PKCS12_BUILDER *pb, const PKCS12_ENC *enc)
{
    ...
    if (!test_ptr("../test/helpers/pkcs12.c", 778, "pb->bags", pb->bags)) {
        pb->success = 0;
        return;
    }
    test_info("../test/helpers/pkcs12.c", 782, "Decoding %d bags", OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags)));
}
...
void end_check_contentinfo(PKCS12_BUILDER *pb)
{
    ...
    if (!test_int_eq("../test/helpers/pkcs12.c", 791, "sk_PKCS12_SAFEBAG_num(pb->bags)", "pb->bag_idx", OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags)), pb->bag_idx))
        pb->success = 0;
    OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(pb->bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    pb->bags = 
# 794 "../test/helpers/pkcs12.c" 3 4
              ((void *)0)
# 794 "../test/helpers/pkcs12.c"
                  ;
}
