# 0 "../test/helpers/quictestlib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/helpers/quictestlib.c"
# 10 "../test/helpers/quictestlib.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 13 "../test/helpers/quictestlib.c" 2
...
# 14 "../test/helpers/quictestlib.c" 2
# 1 "../test/helpers/quictestlib.h" 1
# 10 "../test/helpers/quictestlib.h"
...
# 11 "../test/helpers/quictestlib.h" 2
# 1 "../include/internal/quic_tserver.h" 1
# 15 "../include/internal/quic_tserver.h"
...
# 16 "../include/internal/quic_stream.h" 2
...
# 17 "../include/internal/quic_stream.h" 2
...
# 18 "../include/internal/quic_stream.h" 2
...
# 15 "../include/internal/packet_quic.h" 2
...
# 19 "../include/internal/quic_stream.h" 2
...
# 20 "../include/internal/quic_stream.h" 2
...
# 23 "../include/internal/quic_stream.h" 2
...
# 16 "../include/internal/quic_tserver.h" 2
...
# 17 "../include/internal/quic_tserver.h" 2
...
int ossl_statem_set_mutator(SSL *s,
                            ...
                            ossl_statem_finish_mutate_handshake_cb finish_mutate_handshake_cb,
                            void *mutatearg);
# 18 "../include/internal/quic_tserver.h" 2
# 35 "../include/internal/quic_tserver.h"
...
# 93 "../include/internal/quic_tserver.h"
...
# 115 "../include/internal/quic_tserver.h"
...
void ossl_quic_tserver_set_psk_find_session_cb(QUIC_TSERVER *srv,
                                               SSL_psk_find_session_cb_func cb);
# 12 "../test/helpers/quictestlib.h" 2
...
int qtest_fault_set_packet_plain_listener(QTEST_FAULT *fault,
                                          ...
                                          void *pplaincbarg);
# 132 "../test/helpers/quictestlib.h"
...
# 15 "../test/helpers/quictestlib.c" 2
...
# 16 "../test/helpers/quictestlib.c" 2
...
# 17 "../test/helpers/quictestlib.c" 2

# 1 "../test/helpers/../threadstest.h" 1
# 15 "../test/helpers/../threadstest.h"
# 1 "../test/helpers/../testutil.h" 1
# 16 "../test/helpers/../threadstest.h" 2
# 59 "../test/helpers/../threadstest.h"
...
static void *thread_run(void *arg)
{
    ...
    *(void **) (&f) = arg;
    ...
    OPENSSL_thread_stop();
    return 
# 69 "../test/helpers/../threadstest.h" 3 4
          ((void *)0)
# 69 "../test/helpers/../threadstest.h"
              ;
}
...
# 74 "../test/helpers/../threadstest.h" 3 4
                            ((void *)0)
# 74 "../test/helpers/../threadstest.h"
                                , thread_run, *(void **) &f) == 0;
}
...
# 79 "../test/helpers/../threadstest.h" 3 4
                               ((void *)0)
# 79 "../test/helpers/../threadstest.h"
                                   ) == 0;
}
# 19 "../test/helpers/quictestlib.c" 2
...
# 22 "../include/internal/quic_ackm.h"
...
int ossl_quic_conn_poll_events(SSL *ssl, uint64_t events, int do_tick,
                               uint64_t *revents);
# 21 "../test/helpers/quictestlib.c" 2


# 1 "../include/internal/quic_error.h" 1
# 27 "../include/internal/quic_error.h"
const char *ossl_quic_err_to_string(uint64_t error_code);
# 24 "../test/helpers/quictestlib.c" 2
...
# 57 "../include/internal/tsan_assist.h" 2
# 26 "../test/helpers/quictestlib.c" 2




# 29 "../test/helpers/quictestlib.c"
...
static CRYPTO_RWLOCK *fake_now_lock = 
# 82 "../test/helpers/quictestlib.c" 3 4
                                     ((void *)0)
# 82 "../test/helpers/quictestlib.c"
                                         ;
...
# 103 "../test/helpers/quictestlib.c" 3 4
                                                                ((void *)0)
# 103 "../test/helpers/quictestlib.c"
                                                                    ))
            return;
        ...
        if (frame_type == 0x01) {
            ...
            (void)BIO_ctrl(noiseargs->cbio, 1001, 0, 
# 112 "../test/helpers/quictestlib.c" 3 4
                                                                       ((void *)0)
# 112 "../test/helpers/quictestlib.c"
                                                                           );
            (void)BIO_ctrl(noiseargs->sbio, 1001, 0, 
# 113 "../test/helpers/quictestlib.c" 3 4
                                                                       ((void *)0)
# 113 "../test/helpers/quictestlib.c"
                                                                           );
        }
    }


    if ((noiseargs->flags & (1 << 4)) != 0
            && !SSL_is_server(ssl))
                              ...
                              QTEST_FAULT **fault, BIO **tracebio)
{
    ...
    BIO *cbio = 
# 133 "../test/helpers/quictestlib.c" 3 4
               ((void *)0)
# 133 "../test/helpers/quictestlib.c"
                   , *sbio = 
# 133 "../test/helpers/quictestlib.c" 3 4
                             ((void *)0)
# 133 "../test/helpers/quictestlib.c"
...
# 133 "../test/helpers/quictestlib.c"
                                                 ;
    BIO_ADDR *peeraddr = 
# 134 "../test/helpers/quictestlib.c" 3 4
                        ((void *)0)
# 134 "../test/helpers/quictestlib.c"
                            ;
    struct in_addr ina = {0};
    BIO *tmpbio = 
# 136 "../test/helpers/quictestlib.c" 3 4
                 ((void *)0)
# 136 "../test/helpers/quictestlib.c"
                     ;

    *qtserv = 
# 138 "../test/helpers/quictestlib.c" 3 4
             ((void *)0)
# 138 "../test/helpers/quictestlib.c"
                 ;

    if (fault != 
# 140 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 140 "../test/helpers/quictestlib.c"
                    ) {
        *fault = CRYPTO_zalloc(sizeof(**fault), "../test/helpers/quictestlib.c", 141);
        if (*fault == 
# 142 "../test/helpers/quictestlib.c" 3 4
                     ((void *)0)
# 142 "../test/helpers/quictestlib.c"
                         )
            goto err;
    }

    if (*cssl == 
# 146 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 146 "../test/helpers/quictestlib.c"
                    ) {
        *cssl = SSL_new(clientctx);
        if (!test_ptr("../test/helpers/quictestlib.c", 148, "*cssl", *cssl))
            goto err;
    }
    ...
    if ((flags & (1 << 4)) != 0) {
        tmpbio = BIO_new_fp(
# 154 "../test/helpers/quictestlib.c" 3 4
                           stdout
# 154 "../test/helpers/quictestlib.c"
                                 , 0x00);
        if (!test_ptr("../test/helpers/quictestlib.c", 155, "tmpbio", tmpbio))
            goto err;

        SSL_set_msg_callback(*cssl, SSL_trace);
        SSL_ctrl((*cssl), 16, 0, (tmpbio));
    }

    if (tracebio != 
# 162 "../test/helpers/quictestlib.c" 3 4
                   ((void *)0)
# 162 "../test/helpers/quictestlib.c"
                       )
        *tracebio = tmpbio;


    if (!test_false("../test/helpers/quictestlib.c", 166, "SSL_set_alpn_protos(*cssl, alpn, sizeof(alpn))", (SSL_set_alpn_protos(*cssl, alpn, sizeof(alpn))) != 0))
        goto err;

    if (!test_ptr("../test/helpers/quictestlib.c", 169, "peeraddr = BIO_ADDR_new()", peeraddr = BIO_ADDR_new()))
        goto err;
    ...
    if ((flags & (1 << 0)) != 0) {
        ...
        if (!test_true("../test/helpers/quictestlib.c", 180, "create_test_sockets(&cfd, &sfd, SOCK_DGRAM, peeraddr)", (create_test_sockets(&cfd, &sfd, 
# 180 "../test/helpers/quictestlib.c" 3 4
            SOCK_DGRAM
# 180 "../test/helpers/quictestlib.c"
            , peeraddr)) != 0))
            goto err;
        cbio = BIO_new_dgram(cfd, 1);
        if (!test_ptr("../test/helpers/quictestlib.c", 183, "cbio", cbio)) {
            close(cfd);
            close(sfd);
            goto err;
        }
        sbio = BIO_new_dgram(sfd, 1);
        if (!test_ptr("../test/helpers/quictestlib.c", 189, "sbio", sbio)) {
            close(sfd);
            goto err;
        }
        ...
        if (!test_true("../test/helpers/quictestlib.c", 197, "BIO_new_bio_dgram_pair(&cbio, 0, &sbio, 0)", (BIO_new_bio_dgram_pair(&cbio, 0, &sbio, 0)) != 0))
            goto err;

        if (!test_true("../test/helpers/quictestlib.c", 200, "BIO_dgram_set_caps(cbio, BIO_DGRAM_CAP_HANDLES_DST_ADDR)", ((int)BIO_ctrl((cbio), 87, (long)((1U << 1)), 
# 200 "../test/helpers/quictestlib.c" 3 4
            ((void *)0)
# 200 "../test/helpers/quictestlib.c"
            )) != 0)
                || !test_true("../test/helpers/quictestlib.c", 201, "BIO_dgram_set_caps(sbio, BIO_DGRAM_CAP_HANDLES_DST_ADDR)", ((int)BIO_ctrl((sbio), 87, (long)((1U << 1)), 
# 201 "../test/helpers/quictestlib.c" 3 4
                   ((void *)0)
# 201 "../test/helpers/quictestlib.c"
                   )) != 0))
            goto err;


        if (!test_true("../test/helpers/quictestlib.c", 205, "BIO_ADDR_rawmake(peeraddr, AF_INET, &ina, sizeof(ina), htons(0))", (BIO_ADDR_rawmake(peeraddr, 
# 205 "../test/helpers/quictestlib.c" 3 4
            2
# 205 "../test/helpers/quictestlib.c"
            , &ina, sizeof(ina), htons(0))) != 0)
                                                  )
            goto err;
    }
    ...
    if ((flags & (1 << 3)) != 0) {
        ...
        if (!test_ptr("../test/helpers/quictestlib.c", 213, "pktsplitbio", pktsplitbio))
            goto err;
        cbio = BIO_push(pktsplitbio, cbio);

        pktsplitbio = BIO_new(bio_f_pkt_split_dgram_filter());
        if (!test_ptr("../test/helpers/quictestlib.c", 218, "pktsplitbio", pktsplitbio))
            goto err;
    ...
    if ((flags & (1 << 2)) != 0) {
        BIO *noisebio;
        struct bio_noise_now_cb_st now_cb = { fake_now_cb, 
# 225 "../test/helpers/quictestlib.c" 3 4
                                                          ((void *)0) 
# 225 "../test/helpers/quictestlib.c"
                                                               };




        if (!test_ptr("../test/helpers/quictestlib.c", 230, "fault", fault))
            goto err;

        noisebio = BIO_new(bio_f_noisy_dgram_filter());

        if (!test_ptr("../test/helpers/quictestlib.c", 235, "noisebio", noisebio))
            goto err;
        cbio = BIO_push(noisebio, cbio);
        if ((flags & (1 << 1)) != 0) {
            if (!test_int_eq("../test/helpers/quictestlib.c", 239, "BIO_ctrl(cbio, BIO_CTRL_NOISE_SET_NOW_CB, 0, &now_cb)", "1", BIO_ctrl(cbio, 1005, 0, &now_cb), 1)
                                                     )
                goto err;
        }
        ...
        if (!test_ptr("../test/helpers/quictestlib.c", 246, "noisebio", noisebio))
            goto err;
        sbio = BIO_push(noisebio, sbio);
        if ((flags & (1 << 1)) != 0) {
            if (!test_int_eq("../test/helpers/quictestlib.c", 250, "BIO_ctrl(sbio, BIO_CTRL_NOISE_SET_NOW_CB, 0, &now_cb)", "1", BIO_ctrl(sbio, 1005, 0, &now_cb), 1)
                                                     )
                goto err;
        }
        ...
        (void)BIO_ctrl(sbio, 1001, 0, 
# 261 "../test/helpers/quictestlib.c" 3 4
                                                        ((void *)0)
# 261 "../test/helpers/quictestlib.c"
                                                            );
        ...
        SSL_ctrl((*cssl), 16, 0, (&(*fault)->noiseargs));
    }

    SSL_set_bio(*cssl, cbio, cbio);

    if (!test_true("../test/helpers/quictestlib.c", 274, "SSL_set_blocking_mode(*cssl, (flags & QTEST_FLAG_BLOCK) != 0 ? 1 : 0)", (SSL_set_blocking_mode(*cssl, (flags & (1 << 0)) != 0 ? 1 : 0)) != 0)
                                                                                  )
        goto err;

    if (!test_true("../test/helpers/quictestlib.c", 278, "SSL_set1_initial_peer_addr(*cssl, peeraddr)", (SSL_set1_initial_peer_addr(*cssl, peeraddr)) != 0))
        goto err;

    fisbio = BIO_new(qtest_get_bio_method());
    if (!test_ptr("../test/helpers/quictestlib.c", 282, "fisbio", fisbio))
        goto err;

    BIO_set_data(fisbio, fault == 
# 285 "../test/helpers/quictestlib.c" 3 4
                                 ((void *)0) 
# 285 "../test/helpers/quictestlib.c"
                                      ? 
# 285 "../test/helpers/quictestlib.c" 3 4
                                        ((void *)0) 
# 285 "../test/helpers/quictestlib.c"
    ...
    if (!BIO_up_ref(sbio))
        goto err;
    if (!test_ptr("../test/helpers/quictestlib.c", 289, "BIO_push(fisbio, sbio)", BIO_push(fisbio, sbio))) {
        BIO_free(sbio);
        goto err;
    }
    ...
    tserver_args.alpn = 
# 297 "../test/helpers/quictestlib.c" 3 4
                       ((void *)0)
# 297 "../test/helpers/quictestlib.c"
                           ;
    if (serverctx != 
# 298 "../test/helpers/quictestlib.c" 3 4
                    ((void *)0) 
# 298 "../test/helpers/quictestlib.c"
                         && !test_true("../test/helpers/quictestlib.c", 298, "SSL_CTX_up_ref(serverctx)", (SSL_CTX_up_ref(serverctx)) != 0))
        goto err;
    tserver_args.ctx = serverctx;
    if (fake_now_lock == 
# 301 "../test/helpers/quictestlib.c" 3 4
                        ((void *)0)
# 301 "../test/helpers/quictestlib.c"
                            ) {
        fake_now_lock = CRYPTO_THREAD_lock_new();
        if (fake_now_lock == 
# 303 "../test/helpers/quictestlib.c" 3 4
                            ((void *)0)
# 303 "../test/helpers/quictestlib.c"
                                )
            goto err;
    }
    if ((flags & (1 << 1)) != 0) {
        ...
        (void)ossl_quic_conn_set_override_now_cb(*cssl, fake_now_cb, 
# 310 "../test/helpers/quictestlib.c" 3 4
                                                                    ((void *)0)
# 310 "../test/helpers/quictestlib.c"
                                                                        );
    } else {
        using_fake_time = 0;
    }

    if (!test_ptr("../test/helpers/quictestlib.c", 315, "*qtserv = ossl_quic_tserver_new(&tserver_args, certfile, keyfile)", *qtserv = ossl_quic_tserver_new(&tserver_args, certfile, keyfile))
                                                           )
        goto err;


    sbio = 
# 320 "../test/helpers/quictestlib.c" 3 4
          ((void *)0)
# 320 "../test/helpers/quictestlib.c"
              ;
    fisbio = 
# 321 "../test/helpers/quictestlib.c" 3 4
            ((void *)0)
# 321 "../test/helpers/quictestlib.c"
                ;
    ...
    if (fault != 
# 327 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 327 "../test/helpers/quictestlib.c"
                    )
        (*fault)->qtserv = *qtserv;
 ...
 err:
    ...
    SSL_free(*cssl);
    *cssl = 
# 340 "../test/helpers/quictestlib.c" 3 4
           ((void *)0)
# 340 "../test/helpers/quictestlib.c"
               ;
    ossl_quic_tserver_free(*qtserv);
    if (fault != 
# 342 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 342 "../test/helpers/quictestlib.c"
                    )
        CRYPTO_free(*fault, "../test/helpers/quictestlib.c", 343);
    BIO_free(tmpbio);
    if (tracebio != 
# 345 "../test/helpers/quictestlib.c" 3 4
                   ((void *)0)
# 345 "../test/helpers/quictestlib.c"
                       )
        *tracebio = 
# 346 "../test/helpers/quictestlib.c" 3 4
                   ((void *)0)
# 346 "../test/helpers/quictestlib.c"
                       ;
...
void qtest_add_time(uint64_t millis)
{
    if (!CRYPTO_THREAD_write_lock(fake_now_lock))
        return;
    fake_now = ossl_time_add(fake_now, ossl_ticks2time((millis) * (((uint64_t)1000000000) / 1000)));
...
uint64_t qtest_get_stopwatch_time(void)
{
    return (ossl_time2ticks(ossl_time_subtract(qtest_get_time(), start_time)) / (((uint64_t)1000000000) / 1000));
}
...
QTEST_FAULT *qtest_create_injector(QUIC_TSERVER *ts)
{
    ...
    f = CRYPTO_zalloc(sizeof(*f), "../test/helpers/quictestlib.c", 394);
    if (f == 
# 395 "../test/helpers/quictestlib.c" 3 4
            ((void *)0)
# 395 "../test/helpers/quictestlib.c"
                )
        return 
# 396 "../test/helpers/quictestlib.c" 3 4
              ((void *)0)
# 396 "../test/helpers/quictestlib.c"
                  ;
...
static _Atomic int abortserverthread = 0;
...
static void run_server_thread(void)
{
    ...
    globserverret = qtest_create_quic_connection(globtserv, 
# 427 "../test/helpers/quictestlib.c" 3 4
                                                           ((void *)0)
# 427 "../test/helpers/quictestlib.c"
                                                               );
}
...
int qtest_wait_for_timeout(SSL *s, QUIC_TSERVER *qtserv)
{
    ...
    if (s == 
# 438 "../test/helpers/quictestlib.c" 3 4
            ((void *)0) 
# 438 "../test/helpers/quictestlib.c"
                 || SSL_get_blocking_mode(s))
        return 1;


    if ((int)BIO_ctrl(SSL_get_rbio(s),10,0,
# 442 "../test/helpers/quictestlib.c" 3 4
       ((void *)0)
# 442 "../test/helpers/quictestlib.c"
       ) > 0
            || (int)BIO_ctrl(ossl_quic_tserver_get0_rbio(qtserv),10,0,
# 443 "../test/helpers/quictestlib.c" 3 4
              ((void *)0)
# 443 "../test/helpers/quictestlib.c"
              ) > 0)
        return 1;
# 453 "../test/helpers/quictestlib.c"
    ...
    if (using_fake_time)
        qtest_add_time((ossl_time2ticks(mintimeout) / (((uint64_t)1000000000) / 1000)));
    else
        OSSL_sleep((ossl_time2ticks(mintimeout) / (((uint64_t)1000000000) / 1000)));
                                    ...
                                    int wanterr)
{
    ...
    if (clientssl != 
# 487 "../test/helpers/quictestlib.c" 3 4
                    ((void *)0)
# 487 "../test/helpers/quictestlib.c"
                        )
        abortserverthread = 0;


    if (!test_ptr("../test/helpers/quictestlib.c", 491, "qtserv", qtserv)) {
        goto err;
    } else if (clientssl == 
# 493 "../test/helpers/quictestlib.c" 3 4
                           ((void *)0)
# 493 "../test/helpers/quictestlib.c"
                               ) {
        retc = 1;
        ...
        globtserv = qtserv;
        if (!test_true("../test/helpers/quictestlib.c", 502, "run_thread(&t, run_server_thread)", (run_thread(&t, run_server_thread)) != 0))
            goto err;

        qtserv = 
# 505 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 505 "../test/helpers/quictestlib.c"
                    ;
        rets = 1;
        ...
        if (!clienterr && retc <= 0) {
            ...
            if (retc <= 0) {
                ...
                if (err == wanterr) {
                    ...
                    if (qtserv == 
# 524 "../test/helpers/quictestlib.c" 3 4
                                 ((void *)0) 
# 524 "../test/helpers/quictestlib.c"
                                      && rets > 0)
                        
# 525 "../test/helpers/quictestlib.c" 3 4
                       __extension__ ({ __auto_type __atomic_store_ptr = (
# 525 "../test/helpers/quictestlib.c"
                       (&abortserverthread)
# 525 "../test/helpers/quictestlib.c" 3 4
...
# 525 "../test/helpers/quictestlib.c"
                    ...
                    if (err != 2
                            && err != 3) {
                        test_info("../test/helpers/quictestlib.c", 532, "SSL_connect() failed %d, %d", retc, err);
                        test_openssl_errors();
                        clienterr = 1;
                    }
                }
        ...
        qtest_add_time(1);
        if (clientssl != 
# 541 "../test/helpers/quictestlib.c" 3 4
                        ((void *)0)
# 541 "../test/helpers/quictestlib.c"
                            )
            SSL_handle_events(clientssl);
        if (qtserv != 
# 543 "../test/helpers/quictestlib.c" 3 4
                     ((void *)0)
# 543 "../test/helpers/quictestlib.c"
                         )
        ...
        if (clientssl != 
# 555 "../test/helpers/quictestlib.c" 3 4
                        ((void *)0) 
# 555 "../test/helpers/quictestlib.c"
                             && ++abortctr == 1000) {
            test_info("../test/helpers/quictestlib.c", 556, "No progress made");
            goto err;
        }
        ...
        if ((retc <= 0 && !clienterr) || (rets <= 0 && !servererr)) {
            if (!qtest_wait_for_timeout(clientssl, qtserv))
             ...
             || (rets <= 0 && !servererr
                 ...
                 && !
# 567 "../test/helpers/quictestlib.c" 3 4
                    __extension__ ({ __auto_type __atomic_load_ptr = (
# 567 "../test/helpers/quictestlib.c"
                    (&abortserverthread)
# 567 "../test/helpers/quictestlib.c" 3 4
...
# 569 "../test/helpers/quictestlib.c"
               ));

    if (qtserv == 
# 571 "../test/helpers/quictestlib.c" 3 4
                 ((void *)0) 
# 571 "../test/helpers/quictestlib.c"
                      && rets > 0) {

        if (!test_true("../test/helpers/quictestlib.c", 573, "wait_for_thread(t)", (wait_for_thread(t)) != 0) || !test_true("../test/helpers/quictestlib.c", 573, "globserverret", (globserverret) != 0))
            goto err;
...
int qtest_create_quic_connection(QUIC_TSERVER *qtserv, SSL *clientssl)
{
    return qtest_create_quic_connection_ex(qtserv, clientssl, 0);
}


static _Atomic int shutdowndone;
...
# 604 "../test/helpers/quictestlib.c" 3 4
            __extension__ ({ __auto_type __atomic_load_ptr = (
# 604 "../test/helpers/quictestlib.c"
            (&shutdowndone)
# 604 "../test/helpers/quictestlib.c" 3 4
            ); __typeof__ ((void)0, *__atomic_load_ptr) __atomic_load_tmp; __atomic_load (__atomic_load_ptr, &__atomic_load_tmp, (
# 604 "../test/helpers/quictestlib.c"
...
int qtest_shutdown(QUIC_TSERVER *qtserv, SSL *clientssl)
{
    ...
    if (SSL_get_blocking_mode(clientssl) > 0) {
        ...
        globtserv = qtserv;
        shutdowndone = 0;
        if (!test_true("../test/helpers/quictestlib.c", 628, "run_thread(&t, run_server_shutdown_thread)", (run_thread(&t, run_server_shutdown_thread)) != 0))
            return 0;
...
# 655 "../test/helpers/quictestlib.c" 3 4
   __extension__ ({ __auto_type __atomic_store_ptr = (
# 655 "../test/helpers/quictestlib.c"
   (&shutdowndone)
# 655 "../test/helpers/quictestlib.c" 3 4
   ); __typeof__ ((void)0, *__atomic_store_ptr) __atomic_store_tmp = (
# 655 "../test/helpers/quictestlib.c"
...
# 655 "../test/helpers/quictestlib.c"
                               ;
    if (!tickserver) {
        if (!test_true("../test/helpers/quictestlib.c", 657, "wait_for_thread(t)", (wait_for_thread(t)) != 0))
            ret = 0;
    }
...
int qtest_check_server_transport_err(QUIC_TSERVER *qtserv, uint64_t code)
{
    ...
    if (!test_true("../test/helpers/quictestlib.c", 674, "ossl_quic_tserver_is_term_any(qtserv)", (ossl_quic_tserver_is_term_any(qtserv)) != 0))
        return 0;

    cause = ossl_quic_tserver_get_terminate_cause(qtserv);
    if (!test_ptr("../test/helpers/quictestlib.c", 678, "cause", cause)
            || !test_true("../test/helpers/quictestlib.c", 679, "cause->remote", (cause->remote) != 0)
            || !test_false("../test/helpers/quictestlib.c", 680, "cause->app", (cause->app) != 0)
            || !test_uint64_t_eq("../test/helpers/quictestlib.c", 681, "cause->error_code", "code", cause->error_code, code))
        return 0;
...
int qtest_check_server_protocol_err(QUIC_TSERVER *qtserv)
{
    return qtest_check_server_transport_err(qtserv, 0x0A);
}

int qtest_check_server_frame_encoding_err(QUIC_TSERVER *qtserv)
{
    return qtest_check_server_transport_err(qtserv, 0x07);
}

void qtest_fault_free(QTEST_FAULT *fault)
{
    if (fault == 
# 699 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
# 699 "../test/helpers/quictestlib.c"
                    )
        return;
    ...
    CRYPTO_free(fault, "../test/helpers/quictestlib.c", 705);
}
                               ...
                               void *arg)
{
    ...
    fault->pplainio.buf = cur = CRYPTO_malloc(bufsz, "../test/helpers/quictestlib.c", 730);
    if (cur == 
# 731 "../test/helpers/quictestlib.c" 3 4
              ((void *)0)
# 731 "../test/helpers/quictestlib.c"
                  ) {
    ...
    if (fault->pplaincb != 
# 747 "../test/helpers/quictestlib.c" 3 4
                          ((void *)0)
            
# 748 "../test/helpers/quictestlib.c"
...
static void packet_plain_finish(void *arg)
{
    ...
    CRYPTO_free((unsigned char *)fault->pplainio.buf, "../test/helpers/quictestlib.c", 765);
    fault->pplainio.buf_len = 0;
    fault->pplainbuf_alloc = 0;
    fault->pplainio.buf = 
# 768 "../test/helpers/quictestlib.c" 3 4
                         ((void *)0)
# 768 "../test/helpers/quictestlib.c"
                             ;
}
                              ...
                              size_t frame_len)
{
    ...
    if (!test_true("../test/helpers/quictestlib.c", 838, "qtest_fault_resize_plain_packet(fault, old_len + frame_len)", (qtest_fault_resize_plain_packet(fault, old_len + frame_len)) != 0)
                                                                        )
        return 0;
                            ...
                            void *arg)
{
    ...
    buf = CRYPTO_malloc(msginlen + 1024, "../test/helpers/quictestlib.c", 858);
    if (buf == 
# 859 "../test/helpers/quictestlib.c" 3 4
              ((void *)0)
# 859 "../test/helpers/quictestlib.c"
                  )
        return 0;

    fault->handbuf = buf;
    fault->handbuflen = msginlen;
    fault->handbufalloc = msginlen + 1024;
    ...
    case 8:
    {
        ...
        if (fault->encextcb == 
# 879 "../test/helpers/quictestlib.c" 3 4
                              ((void *)0)
# 879 "../test/helpers/quictestlib.c"
                                  )
            break;
    ...
    if (fault->handshakecb != 
# 897 "../test/helpers/quictestlib.c" 3 4
                             ((void *)0)
            
# 898 "../test/helpers/quictestlib.c"
...
static void handshake_finish(void *arg)
{
    ...
    CRYPTO_free(fault->handbuf, "../test/helpers/quictestlib.c", 912);
    fault->handbuf = 
# 913 "../test/helpers/quictestlib.c" 3 4
                    ((void *)0)
# 913 "../test/helpers/quictestlib.c"
                        ;
}
...
int qtest_fault_resize_message(QTEST_FAULT *fault, size_t newlen)
{
    ...
    if (!qtest_fault_resize_handshake(fault, newlen + 4))
        return 0;
                                 ...
                                 BUF_MEM *old_ext)
{
    ...
    if (old_ext != 
# 1015 "../test/helpers/quictestlib.c" 3 4
                  ((void *)0)
# 1015 "../test/helpers/quictestlib.c"
                      ) {
...
static BIO_METHOD *pcipherbiometh = 
# 1068 "../test/helpers/quictestlib.c" 3 4
                                   ((void *)0)
# 1068 "../test/helpers/quictestlib.c"
                                       ;
                            ...
                            size_t *num_processed)
{
    ...
    if (next == 
# 1084 "../test/helpers/quictestlib.c" 3 4
               ((void *)0)
# 1084 "../test/helpers/quictestlib.c"
                   )
        return 0;

    fault = BIO_get_data(b);
    if (fault == 
# 1088 "../test/helpers/quictestlib.c" 3 4
                ((void *)0)
            
# 1089 "../test/helpers/quictestlib.c"
           || (fault->pciphercb == 
# 1089 "../test/helpers/quictestlib.c" 3 4
                                   ((void *)0) 
# 1089 "../test/helpers/quictestlib.c"
                                        && fault->datagramcb == 
# 1089 "../test/helpers/quictestlib.c" 3 4
...
# 1089 "../test/helpers/quictestlib.c"
    ...
    for (i = 0; i < num_msg; ++i) {
        fault->msg = (*(BIO_MSG *)((char *)(msg) + (i)*(stride)));


        tmpdata = CRYPTO_malloc(fault->msg.data_len + 1024, "../test/helpers/quictestlib.c", 1101);
        if (tmpdata == 
# 1102 "../test/helpers/quictestlib.c" 3 4
                      ((void *)0)
# 1102 "../test/helpers/quictestlib.c"
                          )
            return 0;
        memcpy(tmpdata, fault->msg.data, fault->msg.data_len);
        fault->msg.data = tmpdata;
        fault->msgalloc = fault->msg.data_len + 1024;

        if (fault->pciphercb != 
# 1108 "../test/helpers/quictestlib.c" 3 4
                               ((void *)0)
# 1108 "../test/helpers/quictestlib.c"
                                   ) {
            ...
            do {
                if (!ossl_quic_wire_decode_pkt_hdr(&pkt,
                        ...
                        1,
                        0, &hdr, 
# 1121 "../test/helpers/quictestlib.c" 3 4
                                ((void *)0)
# 1121 "../test/helpers/quictestlib.c"
                                    ))
                    goto out;
                ...
                if (!fault->pciphercb(fault, &hdr, (unsigned char *)hdr.data,
                    ...
                    goto out;
# 1139 "../test/helpers/quictestlib.c"
            } while (PACKET_remaining(&pkt) > 0);
        }

        if (fault->datagramcb != 
# 1142 "../test/helpers/quictestlib.c" 3 4
                                ((void *)0)
                
# 1143 "../test/helpers/quictestlib.c"
        ...
        CRYPTO_free(fault->msg.data, "../test/helpers/quictestlib.c", 1152);
        fault->msg.data = 
# 1153 "../test/helpers/quictestlib.c" 3 4
                         ((void *)0)
# 1153 "../test/helpers/quictestlib.c"
                             ;
        fault->msgalloc = 0;
    }
...
out:
    ret = i > 0;
    CRYPTO_free(fault->msg.data, "../test/helpers/quictestlib.c", 1160);
    fault->msg.data = 
# 1161 "../test/helpers/quictestlib.c" 3 4
                     ((void *)0)
# 1161 "../test/helpers/quictestlib.c"
                         ;
    return ret;
}
...
static long pcipher_ctrl(BIO *b, int cmd, long larg, void *parg)
{
    ...
    if (next == 
# 1169 "../test/helpers/quictestlib.c" 3 4
               ((void *)0)
# 1169 "../test/helpers/quictestlib.c"
                   )
        return -1;
...
BIO_METHOD *qtest_get_bio_method(void)
{
    ...
    if (pcipherbiometh != 
# 1179 "../test/helpers/quictestlib.c" 3 4
                         ((void *)0)
# 1179 "../test/helpers/quictestlib.c"
                             )
        return pcipherbiometh;

    tmp = BIO_meth_new((0x80 | 0x0200), "Cipher Packet Filter");

    if (!test_ptr("../test/helpers/quictestlib.c", 1184, "tmp", tmp))
        return 
# 1185 "../test/helpers/quictestlib.c" 3 4
              ((void *)0)
# 1185 "../test/helpers/quictestlib.c"
                  ;

    if (!test_true("../test/helpers/quictestlib.c", 1187, "BIO_meth_set_sendmmsg(tmp, pcipher_sendmmsg)", (BIO_meth_set_sendmmsg(tmp, pcipher_sendmmsg)) != 0)
            || !test_true("../test/helpers/quictestlib.c", 1188, "BIO_meth_set_ctrl(tmp, pcipher_ctrl)", (BIO_meth_set_ctrl(tmp, pcipher_ctrl)) != 0))
        goto err;

    pcipherbiometh = tmp;
    tmp = 
# 1192 "../test/helpers/quictestlib.c" 3 4
         ((void *)0)
# 1192 "../test/helpers/quictestlib.c"
             ;
 err:
    BIO_meth_free(tmp);
    return pcipherbiometh;
                             ...
                             int noise_rate)
{
    ...
    if (!test_ptr("../test/helpers/quictestlib.c", 1240, "sbio", sbio) || !test_ptr("../test/helpers/quictestlib.c", 1240, "cbio", cbio))
        return 0;
    if (!test_int_eq("../test/helpers/quictestlib.c", 1242, "BIO_ctrl(sbio, BIO_CTRL_NOISE_RATE, noise_rate, NULL)", "1", BIO_ctrl(sbio, 1002, noise_rate, 
# 1242 "../test/helpers/quictestlib.c" 3 4
        ((void *)0)
# 1242 "../test/helpers/quictestlib.c"
        ), 1))
        return 0;
    if (!test_int_eq("../test/helpers/quictestlib.c", 1244, "BIO_ctrl(cbio, BIO_CTRL_NOISE_RATE, noise_rate, NULL)", "1", BIO_ctrl(cbio, 1002, noise_rate, 
# 1244 "../test/helpers/quictestlib.c" 3 4
        ((void *)0)
# 1244 "../test/helpers/quictestlib.c"
        ), 1))
        return 0;

    if (!test_int_eq("../test/helpers/quictestlib.c", 1247, "BIO_ctrl(cbio, BIO_CTRL_NOISE_SEND_BANDWIDTH, (long)ctos_bw, NULL)", "1", BIO_ctrl(cbio, 1004, (long)ctos_bw, 
# 1247 "../test/helpers/quictestlib.c" 3 4
        ((void *)0)
# 1247 "../test/helpers/quictestlib.c"
        ), 1)
                                                      )
        return 0;
    if (!test_int_eq("../test/helpers/quictestlib.c", 1250, "BIO_ctrl(sbio, BIO_CTRL_NOISE_SEND_BANDWIDTH, (long)stoc_bw, NULL)", "1", BIO_ctrl(sbio, 1004, (long)stoc_bw, 
# 1250 "../test/helpers/quictestlib.c" 3 4
        ((void *)0)
# 1250 "../test/helpers/quictestlib.c"
        ), 1)
                                                      )
        return 0;
    return 1;
...
int bio_msg_copy(BIO_MSG *dst, BIO_MSG *src)
{
    ...
    dst->flags = src->flags;
    if (dst->local != 
# 1266 "../test/helpers/quictestlib.c" 3 4
                     ((void *)0)
# 1266 "../test/helpers/quictestlib.c"
                         ) {
        if (src->local != 
# 1267 "../test/helpers/quictestlib.c" 3 4
                         ((void *)0)
# 1267 "../test/helpers/quictestlib.c"
                             ) {
            if (!test_true("../test/helpers/quictestlib.c", 1268, "BIO_ADDR_copy(dst->local, src->local)", (BIO_ADDR_copy(dst->local, src->local)) != 0))
                return 0;
        } else {
            BIO_ADDR_clear(dst->local);
        }
    }
    if (!test_true("../test/helpers/quictestlib.c", 1274, "BIO_ADDR_copy(dst->peer, src->peer)", (BIO_ADDR_copy(dst->peer, src->peer)) != 0))
        return 0;
