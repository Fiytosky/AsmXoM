...
# 18 "../test/dtlstest.c" 2

static char *cert = 
# 19 "../test/dtlstest.c" 3 4
                   ((void *)0)
# 19 "../test/dtlstest.c"
                       ;
static char *privkey = 
# 20 "../test/dtlstest.c" 3 4
                      ((void *)0)
# 20 "../test/dtlstest.c"
                          ;
...
static int verify_cookie_cb(SSL *ssl, const unsigned char *cookie,
                            unsigned int cookie_len)
{
    return test_mem_eq("../test/dtlstest.c", 58, "cookie", "dummy_cookie", cookie, cookie_len, dummy_cookie, sizeof(dummy_cookie));
}
...
# 74 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 80, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 80 "../test/dtlstest.c" 3 4
        ((void *)0)
# 80 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
    ...
    if (!test_true("../test/dtlstest.c", 87, "SSL_CTX_set_cipher_list(cctx, \"AES128-SHA\")", (SSL_CTX_set_cipher_list(cctx, "AES128-SHA")) != 0))
        goto end;
# 97 "../test/dtlstest.c"
    c_to_s_fbio = BIO_new(bio_f_tls_dump_filter());
    if (!test_ptr("../test/dtlstest.c", 98, "c_to_s_fbio", c_to_s_fbio))
        goto end;


    if (!test_true("../test/dtlstest.c", 102, "create_ssl_objects(sctx, cctx, &serverssl1, &clientssl1, NULL, c_to_s_fbio)", (create_ssl_objects(sctx, cctx, &serverssl1, &clientssl1, 
# 102 "../test/dtlstest.c" 3 4
        ((void *)0)
# 102 "../test/dtlstest.c"
        , c_to_s_fbio)) != 0)
                                                         )
    ...
    if (!test_true("../test/dtlstest.c", 127, "create_bare_ssl_connection(serverssl1, clientssl1, SSL_ERROR_NONE, 0, 0)", (create_bare_ssl_connection(serverssl1, clientssl1, 0, 0, 0)) != 0)
                                                                    )
        goto end;
...
# 198 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 202, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 202 "../test/dtlstest.c" 3 4
        ((void *)0)
# 202 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
        ...
        return 0;
# 216 "../test/dtlstest.c"
    if (!test_true("../test/dtlstest.c", 216, "SSL_CTX_set_dh_auto(sctx, 1)", (SSL_CTX_ctrl(sctx,118,1,
# 216 "../test/dtlstest.c" 3 4
        ((void *)0)
# 216 "../test/dtlstest.c"
        )) != 0))
        goto end;

    SSL_CTX_set_options(sctx, ((uint64_t)1 << (uint64_t)13));
    SSL_CTX_set_cookie_generate_cb(sctx, generate_cookie_cb);
    SSL_CTX_set_cookie_verify_cb(sctx, verify_cookie_cb);

    if (idx >= (1 + 1 + 3 + 1 + 10 + 1)) {

        if (!test_true("../test/dtlstest.c", 225, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 225 "../test/dtlstest.c" 3 4
            ((void *)0)
# 225 "../test/dtlstest.c"
            , 
# 225 "../test/dtlstest.c" 3 4
...
# 225 "../test/dtlstest.c"
                ...
                || !test_true("../test/dtlstest.c", 227, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0)

                || !test_ptr("../test/dtlstest.c", 229, "sess = SSL_get1_session(clientssl)", sess = SSL_get1_session(clientssl)))
            goto end;
...
# 236 "../test/dtlstest.c"
        ...
        cli_to_srv_epoch0 = 3;
        cli_to_srv_epoch1 = 1;
        srv_to_cli_epoch0 = 10;
        cli_to_srv_cookie = 1;
    }

    c_to_s_fbio = BIO_new(bio_f_tls_dump_filter());
    if (!test_ptr("../test/dtlstest.c", 251, "c_to_s_fbio", c_to_s_fbio))
        goto end;


    if (!test_true("../test/dtlstest.c", 255, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, c_to_s_fbio)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 255 "../test/dtlstest.c" 3 4
        ((void *)0)
# 255 "../test/dtlstest.c"
        , c_to_s_fbio)) != 0)
                                                         )
    ...
    if (sess != 
# 259 "../test/dtlstest.c" 3 4
               ((void *)0)
# 259 "../test/dtlstest.c"
                   ) {
        if (!test_true("../test/dtlstest.c", 260, "SSL_set_session(clientssl, sess)", (SSL_set_session(clientssl, sess)) != 0))
            goto end;
    }
    ...
    if (idx >= cli_to_srv_cookie + cli_to_srv_epoch0 + cli_to_srv_epoch1) {
        ...
        if (idx >= 1 + srv_to_cli_epoch0) {
            epoch = 1;
            idx -= 1 + srv_to_cli_epoch0;
        }
    } else {
    ...
    BIO_ctrl(mempackbio, (1 << 15), epoch, 
# 283 "../test/dtlstest.c" 3 4
                                                              ((void *)0)
# 283 "../test/dtlstest.c"
                                                                  );
    BIO_ctrl(mempackbio, (2 << 15), idx, 
# 284 "../test/dtlstest.c" 3 4
                                                          ((void *)0)
# 284 "../test/dtlstest.c"
                                                              );

    if (!test_true("../test/dtlstest.c", 286, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0))
        goto end;

    if (sess != 
# 289 "../test/dtlstest.c" 3 4
               ((void *)0) 
# 289 "../test/dtlstest.c"
                    && !test_true("../test/dtlstest.c", 289, "SSL_session_reused(clientssl)", (SSL_session_reused(clientssl)) != 0))
        goto end;


    if (!test_int_eq("../test/dtlstest.c", 293, "(int)BIO_ctrl(mempackbio, MEMPACKET_CTRL_GET_DROP_REC, 0, NULL)", "-1", (int)BIO_ctrl(mempackbio, (3 << 15), 0, 
# 293 "../test/dtlstest.c" 3 4
        ((void *)0)
# 293 "../test/dtlstest.c"
        ), -1)
                                             )
...
# 312 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 315, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 315 "../test/dtlstest.c" 3 4
        ((void *)0)
# 315 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
    ...
    SSL_CTX_set_cookie_verify_cb(sctx, verify_cookie_cb);
# 333 "../test/dtlstest.c"
    if (!test_true("../test/dtlstest.c", 333, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 333 "../test/dtlstest.c" 3 4
        ((void *)0)
# 333 "../test/dtlstest.c"
        , 
# 333 "../test/dtlstest.c" 3 4
...
# 333 "../test/dtlstest.c"
            ...
            || !test_true("../test/dtlstest.c", 335, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0)
                                                                )
        goto end;
...
# 352 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 355, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 355 "../test/dtlstest.c" 3 4
        ((void *)0)
# 355 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
        ...
        return 0;
# 369 "../test/dtlstest.c"
    if (!test_true("../test/dtlstest.c", 369, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 369 "../test/dtlstest.c" 3 4
        ((void *)0)
# 369 "../test/dtlstest.c"
        , 
# 369 "../test/dtlstest.c" 3 4
...
# 369 "../test/dtlstest.c"
    ...
    BIO_ctrl(SSL_get_wbio(clientssl), (4 << 15), 1, 
# 376 "../test/dtlstest.c" 3 4
                                                                          ((void *)0)
# 376 "../test/dtlstest.c"
                                                                              );
    BIO_ctrl(SSL_get_wbio(serverssl), (4 << 15), 1, 
# 377 "../test/dtlstest.c" 3 4
                                                                          ((void *)0)
# 377 "../test/dtlstest.c"
                                                                              );

    if (!test_true("../test/dtlstest.c", 379, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0))
        goto end;
...
static int test_just_finished(void)
{
    ...
    SSL_CTX *sctx = 
# 399 "../test/dtlstest.c" 3 4
                   ((void *)0)
# 399 "../test/dtlstest.c"
                       ;
    SSL *serverssl = 
# 400 "../test/dtlstest.c" 3 4
                    ((void *)0)
# 400 "../test/dtlstest.c"
                        ;
    BIO *rbio = 
# 401 "../test/dtlstest.c" 3 4
               ((void *)0)
# 401 "../test/dtlstest.c"
                   , *wbio = 
# 401 "../test/dtlstest.c" 3 4
...
# 401 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 423, "create_ssl_ctx_pair(NULL, DTLS_server_method(), NULL, 0, 0, &sctx, NULL, cert, privkey)", (create_ssl_ctx_pair(
# 423 "../test/dtlstest.c" 3 4
        ((void *)0)
# 423 "../test/dtlstest.c"
        , DTLS_server_method(), 
# 423 "../test/dtlstest.c" 3 4
...
# 423 "../test/dtlstest.c"
    ...
    if (!test_ptr("../test/dtlstest.c", 438, "serverssl", serverssl) || !test_ptr("../test/dtlstest.c", 438, "rbio", rbio) || !test_ptr("../test/dtlstest.c", 438, "wbio", wbio))
        goto end;
    ...
    rbio = wbio = 
# 444 "../test/dtlstest.c" 3 4
                 ((void *)0)
# 444 "../test/dtlstest.c"
                     ;
    DTLS_set_timer_cb(serverssl, timer_cb);

    if (!test_int_eq("../test/dtlstest.c", 447, "BIO_write(sbio, buf, sizeof(buf))", "sizeof(buf)", BIO_write(sbio, buf, sizeof(buf)), sizeof(buf)))
        goto end;


    if (!test_int_le("../test/dtlstest.c", 451, "ret = SSL_accept(serverssl)", "0", ret = SSL_accept(serverssl), 0))
        goto end;


    if (!test_int_eq("../test/dtlstest.c", 455, "SSL_get_error(serverssl, ret)", "SSL_ERROR_SSL", SSL_get_error(serverssl, ret), 1))
        goto end;

    if (!test_int_eq("../test/dtlstest.c", 458, "ERR_GET_REASON(ERR_get_error())", "SSL_R_UNEXPECTED_MESSAGE", ERR_GET_REASON(ERR_get_error()), 244))
        goto end;
...
# 481 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 487, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 487 "../test/dtlstest.c" 3 4
        ((void *)0)
# 487 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
    ...
    if (!test_true("../test/dtlstest.c", 494, "SSL_CTX_set_cipher_list(cctx, \"AES128-SHA\")", (SSL_CTX_set_cipher_list(cctx, "AES128-SHA")) != 0))
        goto end;
# 504 "../test/dtlstest.c"
    if (!test_true("../test/dtlstest.c", 504, "create_ssl_objects(sctx, cctx, &sssl, &cssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &sssl, &cssl, 
# 504 "../test/dtlstest.c" 3 4
        ((void *)0)
# 504 "../test/dtlstest.c"
        , 
# 504 "../test/dtlstest.c" 3 4
...
# 504 "../test/dtlstest.c"
    ...
    if (!test_int_le("../test/dtlstest.c", 509, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;


    if (!test_int_le("../test/dtlstest.c", 513, "SSL_accept(sssl)", "0", SSL_accept(sssl), 0))
        goto end;


    if (!test_int_le("../test/dtlstest.c", 517, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;

    if (idx == 0) {

        bio = SSL_get_wbio(cssl);
        if (!test_ptr("../test/dtlstest.c", 523, "bio", bio)
                || !test_true("../test/dtlstest.c", 524, "mempacket_swap_epoch(bio)", (mempacket_swap_epoch(bio)) != 0))
            goto end;
    }


    if (!test_int_gt("../test/dtlstest.c", 529, "SSL_accept(sssl)", "0", SSL_accept(sssl), 0))
        goto end;


    if (!test_int_eq("../test/dtlstest.c", 533, "SSL_write(sssl, msg, sizeof(msg))", "(int)sizeof(msg)", SSL_write(sssl, msg, sizeof(msg)), (int)sizeof(msg)))
        goto end;

    bio = SSL_get_wbio(sssl);
    if (!test_ptr("../test/dtlstest.c", 537, "bio", bio))
        goto end;
    if (idx == 1) {

        if (!test_true("../test/dtlstest.c", 541, "mempacket_move_packet(bio, 0, 1)", (mempacket_move_packet(bio, 0, 1)) != 0))
            goto end;
    } else if (idx == 2) {

        if (!test_true("../test/dtlstest.c", 545, "mempacket_move_packet(bio, 0, 2)", (mempacket_move_packet(bio, 0, 2)) != 0))
            goto end;
    } else if (idx == 3) {

        bio = SSL_get_wbio(sssl);
        if (!test_true("../test/dtlstest.c", 550, "mempacket_move_packet(bio, 1, 2)", (mempacket_move_packet(bio, 1, 2)) != 0))
            goto end;
    }
    ...
    if (!test_int_gt("../test/dtlstest.c", 558, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;

    if (idx == 0 || idx == 1) {

        if (!test_int_eq("../test/dtlstest.c", 563, "SSL_pending(cssl)", "0", SSL_pending(cssl), 0)
                || !test_false("../test/dtlstest.c", 564, "SSL_has_pending(cssl)", (SSL_has_pending(cssl)) != 0))
            goto end;

    } else {

        if (!test_int_eq("../test/dtlstest.c", 569, "SSL_pending(cssl)", "(int)sizeof(msg)", SSL_pending(cssl), (int)sizeof(msg))
                || !test_true("../test/dtlstest.c", 570, "SSL_has_pending(cssl)", (SSL_has_pending(cssl)) != 0))
            goto end;
    }
    ...
    if (!test_int_eq("../test/dtlstest.c", 577, "SSL_read(cssl, buf, sizeof(buf))", "(int)sizeof(msg)", SSL_read(cssl, buf, sizeof(buf)), (int)sizeof(msg)))
        goto end;
...
# 593 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 600, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 600 "../test/dtlstest.c" 3 4
        ((void *)0)
# 600 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
    ...
    if (!test_true("../test/dtlstest.c", 607, "SSL_CTX_set_cipher_list(cctx, \"AES128-SHA\")", (SSL_CTX_set_cipher_list(cctx, "AES128-SHA")) != 0))
        goto end;
# 617 "../test/dtlstest.c"
    if (!test_true("../test/dtlstest.c", 617, "create_ssl_objects(sctx, cctx, &sssl, &cssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &sssl, &cssl, 
# 617 "../test/dtlstest.c" 3 4
        ((void *)0)
# 617 "../test/dtlstest.c"
        , 
# 617 "../test/dtlstest.c" 3 4
...
# 617 "../test/dtlstest.c"
    ...
    if (!test_int_le("../test/dtlstest.c", 622, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;


    if (!test_int_le("../test/dtlstest.c", 626, "SSL_accept(sssl)", "0", SSL_accept(sssl), 0))
        goto end;


    if (!test_int_le("../test/dtlstest.c", 630, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;


    if (!test_int_gt("../test/dtlstest.c", 634, "SSL_accept(sssl)", "0", SSL_accept(sssl), 0))
        goto end;

    bio = SSL_get_wbio(sssl);
    if (!test_ptr("../test/dtlstest.c", 638, "bio", bio))
        goto end;
    ...
    if (!test_int_eq("../test/dtlstest.c", 645, "SSL_write(sssl, msg, sizeof(msg))", "(int)sizeof(msg)", SSL_write(sssl, msg, sizeof(msg)), (int)sizeof(msg)))
        goto end;

    if (!test_true("../test/dtlstest.c", 648, "mempacket_dup_last_packet(bio)", (mempacket_dup_last_packet(bio)) != 0))
        goto end;


    if (!test_true("../test/dtlstest.c", 652, "mempacket_move_packet(bio, 0, 2)", (mempacket_move_packet(bio, 0, 2)) != 0))
        goto end;
    ...
    if (!test_int_gt("../test/dtlstest.c", 659, "SSL_connect(cssl)", "0", SSL_connect(cssl), 0))
        goto end;




    if (!test_int_eq("../test/dtlstest.c", 665, "SSL_read(cssl, buf, sizeof(buf))", "(int)sizeof(msg)", SSL_read(cssl, buf, sizeof(buf)), (int)sizeof(msg)))
        goto end;

    if (!test_mem_eq("../test/dtlstest.c", 668, "buf", "msg", buf, sizeof(msg), msg, sizeof(msg)))
        goto end;
    ...
    if (!test_int_le("../test/dtlstest.c", 675, "ret = SSL_read(cssl, buf, sizeof(buf))", "0", ret = SSL_read(cssl, buf, sizeof(buf)), 0)
            || !test_int_eq("../test/dtlstest.c", 676, "SSL_get_error(cssl, ret)", "SSL_ERROR_WANT_READ", SSL_get_error(cssl, ret), 2))
        goto end;
...
# 693 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 696, "create_ssl_ctx_pair(NULL, DTLS_server_method(), DTLS_client_method(), DTLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 696 "../test/dtlstest.c" 3 4
        ((void *)0)
# 696 "../test/dtlstest.c"
        , DTLS_server_method(), DTLS_client_method(), 0xFEFF, 0, &sctx, &cctx, cert, privkey)) != 0)
...
# 710 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 713, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 713 "../test/dtlstest.c" 3 4
        ((void *)0)
# 713 "../test/dtlstest.c"
        , 
# 713 "../test/dtlstest.c" 3 4
...
# 713 "../test/dtlstest.c"
    ...
    if (!test_true("../test/dtlstest.c", 724, "create_bare_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE, 1, 1)", (create_bare_ssl_connection(serverssl, clientssl, 0, 1, 1)) != 0)
                                                                    )
        goto end;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/dtlstest.c", 743, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/dtlstest.c", 747, "cert = test_get_argument(0)", cert = test_get_argument(0))
            || !test_ptr("../test/dtlstest.c", 748, "privkey = test_get_argument(1)", privkey = test_get_argument(1)))
        return 0;

    add_all_tests("test_dtls_unprocessed", test_dtls_unprocessed, 2, 1);

    add_all_tests("test_dtls_drop_records", test_dtls_drop_records, ((1 + 1 + 3 + 1 + 10 + 1) + (2 + 1 + 3 + 1 + 2 + 1)), 1);
    ...
    add_test("test_duplicate_app_data", test_duplicate_app_data);
