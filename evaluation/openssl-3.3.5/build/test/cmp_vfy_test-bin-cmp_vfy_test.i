# 0 "../test/cmp_vfy_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_vfy_test.c"
# 12 "../test/cmp_vfy_test.c"
...
int print_to_bio_out(const char *func, const char *file, int line,
                     OSSL_CMP_severity level, const char *msg);
# 13 "../test/cmp_vfy_test.c" 2
# 1 "../test/../crypto/crmf/crmf_local.h" 1
# 21 "../test/../crypto/crmf/crmf_local.h"
# 1 "../include/openssl/types.h" 1
# 22 "../test/../crypto/crmf/crmf_local.h" 2
# 45 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_encryptedvalue_st {
    X509_ALGOR *intendedAlg;
    X509_ALGOR *symmAlg;
    ASN1_BIT_STRING *encSymmKey;
    X509_ALGOR *keyAlg;
    ASN1_OCTET_STRING *valueHint;
    ASN1_BIT_STRING *encValue;
} ;
# 65 "../test/../crypto/crmf/crmf_local.h"
...
extern OSSL_CRMF_PRIVATEKEYINFO *OSSL_CRMF_PRIVATEKEYINFO_new(void); extern void OSSL_CRMF_PRIVATEKEYINFO_free(OSSL_CRMF_PRIVATEKEYINFO *a); extern OSSL_CRMF_PRIVATEKEYINFO *d2i_OSSL_CRMF_PRIVATEKEYINFO(OSSL_CRMF_PRIVATEKEYINFO **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_PRIVATEKEYINFO(const OSSL_CRMF_PRIVATEKEYINFO *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_PRIVATEKEYINFO_it(void);
# 85 "../test/../crypto/crmf/crmf_local.h"
...
extern OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_new(void); extern void OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_free(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *a); extern OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *d2i_OSSL_CRMF_ENCKEYWITHID_IDENTIFIER(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_ENCKEYWITHID_IDENTIFIER(const OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it(void);
...
extern OSSL_CRMF_ENCKEYWITHID *OSSL_CRMF_ENCKEYWITHID_new(void); extern void OSSL_CRMF_ENCKEYWITHID_free(OSSL_CRMF_ENCKEYWITHID *a); extern OSSL_CRMF_ENCKEYWITHID *d2i_OSSL_CRMF_ENCKEYWITHID(OSSL_CRMF_ENCKEYWITHID **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_ENCKEYWITHID(const OSSL_CRMF_ENCKEYWITHID *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_ENCKEYWITHID_it(void);
...
# 122 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_singlepubinfo_st {
    ASN1_INTEGER *pubMethod;
    GENERAL_NAME *pubLocation;
} ;
struct stack_st_OSSL_CRMF_SINGLEPUBINFO; typedef int (*sk_OSSL_CRMF_SINGLEPUBINFO_compfunc)(const OSSL_CRMF_SINGLEPUBINFO * const *a, const OSSL_CRMF_SINGLEPUBINFO *const *b); typedef void (*sk_OSSL_CRMF_SINGLEPUBINFO_freefunc)(OSSL_CRMF_SINGLEPUBINFO *a); typedef OSSL_CRMF_SINGLEPUBINFO * (*sk_OSSL_CRMF_SINGLEPUBINFO_copyfunc)(const OSSL_CRMF_SINGLEPUBINFO *a); static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_num(const struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_value(const struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, int idx) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_new(sk_OSSL_CRMF_SINGLEPUBINFO_compfunc compare) { return (struct stack_st_OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_new_null(void) { return (struct stack_st_OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_new_reserve(sk_OSSL_CRMF_SINGLEPUBINFO_compfunc compare, int n) { return (struct stack_st_OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_reserve(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_CRMF_SINGLEPUBINFO_free(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_CRMF_SINGLEPUBINFO_zero(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_delete(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, int i) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_delete_ptr(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_push(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_unshift(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_pop(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_shift(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_CRMF_SINGLEPUBINFO_pop_free(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, sk_OSSL_CRMF_SINGLEPUBINFO_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_insert(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_set(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, int idx, OSSL_CRMF_SINGLEPUBINFO *ptr) { return (OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_find(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_find_ex(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_find_all(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, OSSL_CRMF_SINGLEPUBINFO *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_CRMF_SINGLEPUBINFO_sort(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_CRMF_SINGLEPUBINFO_is_sorted(const struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_SINGLEPUBINFO * sk_OSSL_CRMF_SINGLEPUBINFO_dup(const struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk) { return (struct stack_st_OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk_OSSL_CRMF_SINGLEPUBINFO_deep_copy(const struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, sk_OSSL_CRMF_SINGLEPUBINFO_copyfunc copyfunc, sk_OSSL_CRMF_SINGLEPUBINFO_freefunc freefunc) { return (struct stack_st_OSSL_CRMF_SINGLEPUBINFO *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_CRMF_SINGLEPUBINFO_compfunc sk_OSSL_CRMF_SINGLEPUBINFO_set_cmp_func(struct stack_st_OSSL_CRMF_SINGLEPUBINFO *sk, sk_OSSL_CRMF_SINGLEPUBINFO_compfunc compare) { return (sk_OSSL_CRMF_SINGLEPUBINFO_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
typedef struct stack_st_OSSL_CRMF_SINGLEPUBINFO OSSL_CRMF_PUBINFOS;
# 140 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_pkipublicationinfo_st {
    ASN1_INTEGER *action;
    OSSL_CRMF_PUBINFOS *pubInfos;
} ;
extern OSSL_CRMF_PKIPUBLICATIONINFO *OSSL_CRMF_PKIPUBLICATIONINFO_dup(const OSSL_CRMF_PKIPUBLICATIONINFO *a);
# 154 "../test/../crypto/crmf/crmf_local.h"
typedef struct ossl_crmf_pkmacvalue_st {
    X509_ALGOR *algId;
    ASN1_BIT_STRING *value;
} OSSL_CRMF_PKMACVALUE;
extern OSSL_CRMF_PKMACVALUE *OSSL_CRMF_PKMACVALUE_new(void); extern void OSSL_CRMF_PKMACVALUE_free(OSSL_CRMF_PKMACVALUE *a); extern OSSL_CRMF_PKMACVALUE *d2i_OSSL_CRMF_PKMACVALUE(OSSL_CRMF_PKMACVALUE **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_PKMACVALUE(const OSSL_CRMF_PKMACVALUE *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_PKMACVALUE_it(void);
# 183 "../test/../crypto/crmf/crmf_local.h"
typedef struct ossl_crmf_popoprivkey_st {
    ...
    union {
        ...
        OSSL_CRMF_PKMACVALUE *agreeMAC;
        ASN1_NULL *encryptedKey;

    } value;
} OSSL_CRMF_POPOPRIVKEY;
extern OSSL_CRMF_POPOPRIVKEY *OSSL_CRMF_POPOPRIVKEY_new(void); extern void OSSL_CRMF_POPOPRIVKEY_free(OSSL_CRMF_POPOPRIVKEY *a); extern OSSL_CRMF_POPOPRIVKEY *d2i_OSSL_CRMF_POPOPRIVKEY(OSSL_CRMF_POPOPRIVKEY **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_POPOPRIVKEY(const OSSL_CRMF_POPOPRIVKEY *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_POPOPRIVKEY_it(void);
# 208 "../test/../crypto/crmf/crmf_local.h"
...
# 230 "../test/../crypto/crmf/crmf_local.h"
...
extern OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_new(void); extern void OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_free(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *a); extern OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *d2i_OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO(const OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it(void);
...
extern OSSL_CRMF_POPOSIGNINGKEYINPUT *OSSL_CRMF_POPOSIGNINGKEYINPUT_new(void); extern void OSSL_CRMF_POPOSIGNINGKEYINPUT_free(OSSL_CRMF_POPOSIGNINGKEYINPUT *a); extern OSSL_CRMF_POPOSIGNINGKEYINPUT *d2i_OSSL_CRMF_POPOSIGNINGKEYINPUT(OSSL_CRMF_POPOSIGNINGKEYINPUT **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_POPOSIGNINGKEYINPUT(const OSSL_CRMF_POPOSIGNINGKEYINPUT *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEYINPUT_it(void);
# 252 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_poposigningkey_st {
    OSSL_CRMF_POPOSIGNINGKEYINPUT *poposkInput;
    X509_ALGOR *algorithmIdentifier;
    ASN1_BIT_STRING *signature;
} ;
extern OSSL_CRMF_POPOSIGNINGKEY *OSSL_CRMF_POPOSIGNINGKEY_new(void); extern void OSSL_CRMF_POPOSIGNINGKEY_free(OSSL_CRMF_POPOSIGNINGKEY *a); extern OSSL_CRMF_POPOSIGNINGKEY *d2i_OSSL_CRMF_POPOSIGNINGKEY(OSSL_CRMF_POPOSIGNINGKEY **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_POPOSIGNINGKEY(const OSSL_CRMF_POPOSIGNINGKEY *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEY_it(void);
# 269 "../test/../crypto/crmf/crmf_local.h"
typedef struct ossl_crmf_popo_st {
    int type;
    union {
        ASN1_NULL *raVerified;
        OSSL_CRMF_POPOSIGNINGKEY *signature;
        OSSL_CRMF_POPOPRIVKEY *keyEncipherment;
        OSSL_CRMF_POPOPRIVKEY *keyAgreement;
    } value;
} OSSL_CRMF_POPO;
extern OSSL_CRMF_POPO *OSSL_CRMF_POPO_new(void); extern void OSSL_CRMF_POPO_free(OSSL_CRMF_POPO *a); extern OSSL_CRMF_POPO *d2i_OSSL_CRMF_POPO(OSSL_CRMF_POPO **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_POPO(const OSSL_CRMF_POPO *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_POPO_it(void);
...
extern OSSL_CRMF_OPTIONALVALIDITY *OSSL_CRMF_OPTIONALVALIDITY_new(void); extern void OSSL_CRMF_OPTIONALVALIDITY_free(OSSL_CRMF_OPTIONALVALIDITY *a); extern OSSL_CRMF_OPTIONALVALIDITY *d2i_OSSL_CRMF_OPTIONALVALIDITY(OSSL_CRMF_OPTIONALVALIDITY **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_OPTIONALVALIDITY(const OSSL_CRMF_OPTIONALVALIDITY *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_OPTIONALVALIDITY_it(void);
# 306 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_certtemplate_st {
    ASN1_INTEGER *version;
    ASN1_INTEGER *serialNumber;

    X509_ALGOR *signingAlg;
...
# 330 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_certrequest_st {
    ASN1_INTEGER *certReqId;
    OSSL_CRMF_CERTTEMPLATE *certTemplate;
    struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls;
} ;
extern OSSL_CRMF_CERTREQUEST *OSSL_CRMF_CERTREQUEST_new(void); extern void OSSL_CRMF_CERTREQUEST_free(OSSL_CRMF_CERTREQUEST *a); extern OSSL_CRMF_CERTREQUEST *d2i_OSSL_CRMF_CERTREQUEST(OSSL_CRMF_CERTREQUEST **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_CERTREQUEST(const OSSL_CRMF_CERTREQUEST *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_CERTREQUEST_it(void);
extern OSSL_CRMF_CERTREQUEST *OSSL_CRMF_CERTREQUEST_dup(const OSSL_CRMF_CERTREQUEST *a);
...
extern OSSL_CRMF_ATTRIBUTETYPEANDVALUE *OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new(void); extern void OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a); extern OSSL_CRMF_ATTRIBUTETYPEANDVALUE *d2i_OSSL_CRMF_ATTRIBUTETYPEANDVALUE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE **a, const unsigned char **in, long len); extern int i2d_OSSL_CRMF_ATTRIBUTETYPEANDVALUE(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a, unsigned char **out); extern const ASN1_ITEM * OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it(void);
struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE; typedef int (*sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc)(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE * const *a, const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *const *b); typedef void (*sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_freefunc)(OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a); typedef OSSL_CRMF_ATTRIBUTETYPEANDVALUE * (*sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_copyfunc)(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a); static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(const struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(const struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, int idx) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new(sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc compare) { return (struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_null(void) { return (struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_reserve(sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc compare, int n) { return (struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_reserve(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_zero(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_delete(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, int i) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_delete_ptr(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_push(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_unshift(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_pop(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_shift(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_pop_free(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_insert(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_set(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, int idx, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_find(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_find_ex(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_find_all(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_sort(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_is_sorted(const struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE * sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_dup(const struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk) { return (struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_deep_copy(const struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_copyfunc copyfunc, sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_freefunc freefunc) { return (struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_set_cmp_func(struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *sk, sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc compare) { return (sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
extern OSSL_CRMF_ATTRIBUTETYPEANDVALUE *OSSL_CRMF_ATTRIBUTETYPEANDVALUE_dup(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a);
# 378 "../test/../crypto/crmf/crmf_local.h"
struct ossl_crmf_msg_st {
    OSSL_CRMF_CERTREQUEST *certReq;

    OSSL_CRMF_POPO *popo;

    struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *regInfo;
} ;
# 14 "../test/cmp_vfy_test.c" 2
...
# 40 "../test/cmp_vfy_test.c" 3 4
                             ((void *)0)
# 40 "../test/cmp_vfy_test.c"
                                 ;
static OSSL_PROVIDER *default_null_provider = 
# 41 "../test/cmp_vfy_test.c" 3 4
                                             ((void *)0)
# 41 "../test/cmp_vfy_test.c"
                                                 , *provider = 
# 41 "../test/cmp_vfy_test.c" 3 4
                                                               ((void *)0)
# 41 "../test/cmp_vfy_test.c"
...
static void tear_down(CMP_VFY_TEST_FIXTURE *fixture)
{
    ...
    CRYPTO_free(fixture, "../test/cmp_vfy_test.c", 47);
}
...
static CMP_VFY_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_vfy_test.c", 57, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_vfy_test.c", 57)))
        return 
# 58 "../test/cmp_vfy_test.c" 3 4
              ((void *)0)
# 58 "../test/cmp_vfy_test.c"
                  ;

    ts = X509_STORE_new();
    fixture->test_case_name = test_case_name;
    if (ts == 
# 62 "../test/cmp_vfy_test.c" 3 4
             ((void *)0)
            
# 63 "../test/cmp_vfy_test.c"
           || !test_ptr("../test/cmp_vfy_test.c", 63, "fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, NULL)", fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, 
# 63 "../test/cmp_vfy_test.c" 3 4
               ((void *)0)
# 63 "../test/cmp_vfy_test.c"
               ))
        ...
        X509_STORE_free(ts);
        return 
# 68 "../test/cmp_vfy_test.c" 3 4
              ((void *)0)
# 68 "../test/cmp_vfy_test.c"
                  ;
    }
...
static X509 *srvcert = 
# 75 "../test/cmp_vfy_test.c" 3 4
                      ((void *)0)
# 75 "../test/cmp_vfy_test.c"
                          ;
static X509 *clcert = 
# 76 "../test/cmp_vfy_test.c" 3 4
                     ((void *)0)
# 76 "../test/cmp_vfy_test.c"
                         ;

static X509 *endentity1 = 
# 78 "../test/cmp_vfy_test.c" 3 4
                         ((void *)0)
# 78 "../test/cmp_vfy_test.c"
                             , *endentity2 = 
# 78 "../test/cmp_vfy_test.c" 3 4
                                             ((void *)0)
# 78 "../test/cmp_vfy_test.c"
                                                 ,
    *intermediate = 
# 79 "../test/cmp_vfy_test.c" 3 4
                   ((void *)0)
# 79 "../test/cmp_vfy_test.c"
                       , *root = 
# 79 "../test/cmp_vfy_test.c" 3 4
                                 ((void *)0)
# 79 "../test/cmp_vfy_test.c"
...
static X509 *insta_cert = 
# 81 "../test/cmp_vfy_test.c" 3 4
                         ((void *)0)
# 81 "../test/cmp_vfy_test.c"
                             , *instaca_cert = 
# 81 "../test/cmp_vfy_test.c" 3 4
                                               ((void *)0)
# 81 "../test/cmp_vfy_test.c"
...
static unsigned char rand_data[16];
...
{
    if ((fixture->msg = load_pkimsg(ir_protected_f, libctx)) == 
# 102 "../test/cmp_vfy_test.c" 3 4
                                                               ((void *)0)
# 102 "../test/cmp_vfy_test.c"
                                                                   )
        return 0;
    if (fixture->expected == 0) {
        const OSSL_CRMF_MSGS *reqs = fixture->msg->body->value.ir;
        const OSSL_CRMF_MSG *req = ((OSSL_CRMF_MSG *)OPENSSL_sk_value(ossl_check_const_OSSL_CRMF_MSG_sk_type(reqs), (0)));

        if (req == 
# 108 "../test/cmp_vfy_test.c" 3 4
                  ((void *)0) 
# 108 "../test/cmp_vfy_test.c"
                       || !flip_bit(req->popo->value.signature->signature))
            return 0;
    }
    return test_int_eq("../test/cmp_vfy_test.c", 111, "fixture->expected", "ossl_cmp_verify_popo(fixture->cmp_ctx, fixture->msg, fixture->additional_arg)", fixture->expected, ossl_cmp_verify_popo(fixture->cmp_ctx, fixture->msg, fixture->additional_arg))
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 118 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 118 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 120 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 120 "../test/cmp_vfy_test.c"
   ) { result = execute_verify_popo_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 127 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 127 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->expected = 0;
    if (fixture != 
# 129 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 129 "../test/cmp_vfy_test.c"
   ) { result = execute_verify_popo_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    int res = test_int_eq("../test/cmp_vfy_test.c", 137, "fixture->expected", "ossl_cmp_msg_check_update(fixture->cmp_ctx, fixture->msg, NULL, 0)", fixture->expected, ossl_cmp_msg_check_update(fixture->cmp_ctx, fixture->msg, 
# 137 "../test/cmp_vfy_test.c" 3 4
             ((void *)0)
# 137 "../test/cmp_vfy_test.c"
             , 0))

                                                                           ;
    X509 *validated = OSSL_CMP_CTX_get0_validatedSrvCert(fixture->cmp_ctx);

    return res && (!fixture->expected || test_ptr_eq("../test/cmp_vfy_test.c", 142, "validated", "fixture->cert", validated, fixture->cert));
}
...
static int execute_validate_cert_path_test(CMP_VFY_TEST_FIXTURE *fixture)
{
    ...
    int res = test_int_eq("../test/cmp_vfy_test.c", 148, "fixture->expected", "OSSL_CMP_validate_cert_path(fixture->cmp_ctx, ts, fixture->cert)", fixture->expected, OSSL_CMP_validate_cert_path(fixture->cmp_ctx, ts, fixture->cert))
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 158 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 158 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = 
# 159 "../test/cmp_vfy_test.c" 3 4
                   ((void *)0)
# 159 "../test/cmp_vfy_test.c"
                       ;

    fixture->expected = !miss && !wrong;
    if (!test_true("../test/cmp_vfy_test.c", 162, "miss ? OSSL_CMP_CTX_set0_trusted(fixture->cmp_ctx, NULL) : OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_1, wrong ? 4 : sizeof(sec_1))", (miss ? OSSL_CMP_CTX_set0_trustedStore(fixture->cmp_ctx, 
# 162 "../test/cmp_vfy_test.c" 3 4
        ((void *)0)
# 162 "../test/cmp_vfy_test.c"
        ) : OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_1, wrong ? 4 : sizeof(sec_1))) != 0)


            || !test_ptr("../test/cmp_vfy_test.c", 165, "fixture->msg = load_pkimsg(ip_waiting_f, libctx)", fixture->msg = load_pkimsg(ip_waiting_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 167 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 167 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 169 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 169 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_validate_msg_mac_alg_protection_bad(void)
{
    ...
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 196 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 196 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = 
# 197 "../test/cmp_vfy_test.c" 3 4
                   ((void *)0)
# 197 "../test/cmp_vfy_test.c"
                       ;
    fixture->expected = 0;

    if (!test_true("../test/cmp_vfy_test.c", 200, "OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_bad, sizeof(sec_bad))", (OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_bad, sizeof(sec_bad))) != 0)

            || !test_ptr("../test/cmp_vfy_test.c", 202, "fixture->msg = load_pkimsg(ip_waiting_f, libctx)", fixture->msg = load_pkimsg(ip_waiting_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 204 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 204 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 206 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 206 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_validate_msg_signature_partial_chain(int expired)
{
    ...
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 226 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 226 "../test/cmp_vfy_test.c"
   ) return 0;
    ...
    if (ts == 
# 231 "../test/cmp_vfy_test.c" 3 4
             ((void *)0)
            
# 232 "../test/cmp_vfy_test.c"
           || !test_ptr("../test/cmp_vfy_test.c", 232, "fixture->msg = load_pkimsg(ir_protected_f, libctx)", fixture->msg = load_pkimsg(ir_protected_f, libctx))
            || !add_trusted(fixture->cmp_ctx, srvcert)) {
        tear_down(fixture);
        fixture = 
# 235 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 235 "../test/cmp_vfy_test.c"
                     ;
    } else {
    ...
    if (fixture != 
# 243 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 243 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 261 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 261 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = srvcert;
    fixture->expected = !bad_sig && !wrong && !miss;
    if (!test_ptr("../test/cmp_vfy_test.c", 264, "fixture->msg = load_pkimsg(ir_protected_f, libctx)", fixture->msg = load_pkimsg(ir_protected_f, libctx))
        || !test_true("../test/cmp_vfy_test.c", 265, "miss ? OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_1, sizeof(sec_1)) : OSSL_CMP_CTX_set1_srvCert(fixture->cmp_ctx, wrong? clcert : srvcert)", (miss ? OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_1, sizeof(sec_1)) : OSSL_CMP_CTX_set1_srvCert(fixture->cmp_ctx, wrong? clcert : srvcert)) != 0)
        ...
        tear_down(fixture);
        fixture = 
# 271 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 271 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 273 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 273 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 303 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 303 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = insta_cert;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_vfy_test.c", 306, "fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx)", fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx))
            || !add_trusted(fixture->cmp_ctx, instaca_cert)
            || !add_untrusted(fixture->cmp_ctx, insta_cert)) {
        tear_down(fixture);
        fixture = 
# 310 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 310 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 312 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 312 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 318 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 318 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = insta_cert;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_vfy_test.c", 321, "fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx)", fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx))
            || !add_trusted(fixture->cmp_ctx, instaca_cert)
            || !add_trusted(fixture->cmp_ctx, insta_cert)) {
        tear_down(fixture);
        fixture = 
# 325 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 325 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 327 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 327 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 333 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 333 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_vfy_test.c", 335, "fixture->msg = load_pkimsg(ir_protected_2_extracerts, libctx)", fixture->msg = load_pkimsg(ir_protected_2_extracerts, libctx))
            || !add_trusted(fixture->cmp_ctx, instaca_cert)) {
        tear_down(fixture);
        fixture = 
# 338 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 338 "../test/cmp_vfy_test.c"
                     ;
    } else {
        fixture->cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(fixture->msg->extraCerts), (1)));
    }
    if (fixture != 
# 342 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 342 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 349 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 349 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->expected = 0;
    if (!test_ptr("../test/cmp_vfy_test.c", 351, "fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx)", fixture->msg = load_pkimsg(ir_protected_0_extracerts, libctx))
                                                                 ) {
        tear_down(fixture);
        fixture = 
# 354 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 354 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 356 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 356 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 363 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 363 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->cert = srvcert;
    fixture->expected = expected;
    if (!test_ptr("../test/cmp_vfy_test.c", 366, "fixture->msg = load_pkimsg(ir_protected_f, libctx)", fixture->msg = load_pkimsg(ir_protected_f, libctx))
        || !test_true("../test/cmp_vfy_test.c", 367, "OSSL_CMP_CTX_set1_expected_sender(fixture->cmp_ctx, name)", (OSSL_CMP_CTX_set1_expected_sender(fixture->cmp_ctx, name)) != 0)
        || !test_true("../test/cmp_vfy_test.c", 368, "OSSL_CMP_CTX_set1_srvCert(fixture->cmp_ctx, srvcert)", (OSSL_CMP_CTX_set1_srvCert(fixture->cmp_ctx, srvcert)) != 0)) {
        tear_down(fixture);
        fixture = 
# 370 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 370 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 372 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 372 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 389 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 389 "../test/cmp_vfy_test.c"
   ) return 0;
    fixture->expected = 0;
    if (!test_ptr("../test/cmp_vfy_test.c", 391, "fixture->msg = load_pkimsg(ir_unprotected_f, libctx)", fixture->msg = load_pkimsg(ir_unprotected_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 393 "../test/cmp_vfy_test.c" 3 4
                 ((void *)0)
# 393 "../test/cmp_vfy_test.c"
                     ;
    }
    if (fixture != 
# 395 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 395 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_msg_test(fixture); tear_down(fixture); };
    return result;
}
...
# 403 "../test/cmp_vfy_test.c" 3 4
                                   ((void *)0) 
# 403 "../test/cmp_vfy_test.c"
                                        && !expired;
    if (expired) {
        X509_STORE *ts = OSSL_CMP_CTX_get0_trustedStore((*fixture)->cmp_ctx);
        X509_VERIFY_PARAM *vpm = X509_STORE_get0_param(ts);
    ...
    if (!add_trusted((*fixture)->cmp_ctx, wrong == 
# 410 "../test/cmp_vfy_test.c" 3 4
                                                  ((void *)0) 
# 410 "../test/cmp_vfy_test.c"
                                                       ? root : wrong)
            || !add_untrusted((*fixture)->cmp_ctx, endentity1)
            || !add_untrusted((*fixture)->cmp_ctx, intermediate)) {
        tear_down((*fixture));
        (*fixture) = 
# 414 "../test/cmp_vfy_test.c" 3 4
                    ((void *)0)
# 414 "../test/cmp_vfy_test.c"
                        ;
    }
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 420 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 420 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_path(&fixture, 
# 421 "../test/cmp_vfy_test.c" 3 4
                        ((void *)0)
# 421 "../test/cmp_vfy_test.c"
                            , 0);
    if (fixture != 
# 422 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 422 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_cert_path_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 428 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 428 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_path(&fixture, srvcert , 0);
    if (fixture != 
# 430 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 430 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_cert_path_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 436 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 436 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_path(&fixture, 
# 437 "../test/cmp_vfy_test.c" 3 4
                        ((void *)0)
# 437 "../test/cmp_vfy_test.c"
                            , 1);
    if (fixture != 
# 438 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 438 "../test/cmp_vfy_test.c"
   ) { result = execute_validate_cert_path_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_msg_check_test(CMP_VFY_TEST_FIXTURE *fixture)
{
    ...
    if (!test_int_eq("../test/cmp_vfy_test.c", 447, "fixture->expected", "ossl_cmp_msg_check_update(fixture->cmp_ctx, fixture->msg, fixture->allow_unprotected_cb, fixture->additional_arg)", fixture->expected, ossl_cmp_msg_check_update(fixture->cmp_ctx, fixture->msg, fixture->allow_unprotected_cb, fixture->additional_arg))
    ...
    if (fixture->expected == 0)
        return 1;
    return
        test_int_eq("../test/cmp_vfy_test.c", 457, "0", "ASN1_OCTET_STRING_cmp(ossl_cmp_hdr_get0_senderNonce(hdr), fixture->cmp_ctx->recipNonce)", 0, ASN1_OCTET_STRING_cmp(ossl_cmp_hdr_get0_senderNonce(hdr), fixture->cmp_ctx->recipNonce))


        && test_int_eq("../test/cmp_vfy_test.c", 460, "0", "ASN1_OCTET_STRING_cmp(tid, fixture->cmp_ctx->transactionID)", 0, ASN1_OCTET_STRING_cmp(tid, fixture->cmp_ctx->transactionID))
                               ...
                               const unsigned char *nonce_data)
{
    ...
    if ((*fixture)->msg == 
# 483 "../test/cmp_vfy_test.c" 3 4
                          ((void *)0)
        
# 484 "../test/cmp_vfy_test.c"
       || (nonce_data != 
# 484 "../test/cmp_vfy_test.c" 3 4
                         ((void *)0)
            
# 485 "../test/cmp_vfy_test.c"
           && !ossl_cmp_asn1_octet_string_set1_bytes(&ctx->senderNonce,
                                                      nonce_data, nonce_len))) {
        tear_down((*fixture));
        (*fixture) = 
# 488 "../test/cmp_vfy_test.c" 3 4
                    ((void *)0)
# 488 "../test/cmp_vfy_test.c"
                        ;
    } else if (trid_data != 
# 489 "../test/cmp_vfy_test.c" 3 4
                           ((void *)0)
# 489 "../test/cmp_vfy_test.c"
                               ) {
        ASN1_OCTET_STRING *trid = ASN1_OCTET_STRING_new();

        if (trid == 
# 492 "../test/cmp_vfy_test.c" 3 4
                   ((void *)0)
            
# 493 "../test/cmp_vfy_test.c"
           || !ASN1_OCTET_STRING_set(trid, trid_data,
                                      16)
            || !OSSL_CMP_CTX_set1_transactionID(ctx, trid)) {
            tear_down((*fixture));
            (*fixture) = 
# 497 "../test/cmp_vfy_test.c" 3 4
                        ((void *)0)
# 497 "../test/cmp_vfy_test.c"
                            ;
        }
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 506 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 506 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 0, 
# 507 "../test/cmp_vfy_test.c" 3 4
                                   ((void *)0)
# 507 "../test/cmp_vfy_test.c"
                                       , 0, 
# 507 "../test/cmp_vfy_test.c" 3 4
                                            ((void *)0)
# 507 "../test/cmp_vfy_test.c"
...
# 507 "../test/cmp_vfy_test.c"
    ...
    if (fixture != 
# 508 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 508 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 514 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 514 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 0, allow_unprotected, 0, 
# 515 "../test/cmp_vfy_test.c" 3 4
                                                         ((void *)0)
# 515 "../test/cmp_vfy_test.c"
                                                             , 
# 515 "../test/cmp_vfy_test.c" 3 4
                                                               ((void *)0)
# 515 "../test/cmp_vfy_test.c"
    ...
    if (fixture != 
# 516 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 516 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 523 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 523 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 1, allow_unprotected, 1, 
# 524 "../test/cmp_vfy_test.c" 3 4
                                                         ((void *)0)
# 524 "../test/cmp_vfy_test.c"
                                                             , 
# 524 "../test/cmp_vfy_test.c" 3 4
                                                               ((void *)0)
# 524 "../test/cmp_vfy_test.c"
    ...
    if (fixture != 
# 525 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 525 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_msg_check_transaction_id(void)
{
    ...
    const unsigned char trans_id[16] = {
        0x39, 0xB6, 0x90, 0x28, 0xC4, 0xBC, 0x7A, 0xF6,
        0xBE, 0xC6, 0x4A, 0x88, 0x97, 0xA6, 0x95, 0x0B
    };

    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 537 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 537 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 1, allow_unprotected, 1, trans_id, 
# 538 "../test/cmp_vfy_test.c" 3 4
                                                                   ((void *)0)
# 538 "../test/cmp_vfy_test.c"
                                                                       );
    if (fixture != 
# 539 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 539 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 546 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 546 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 0, allow_unprotected, 1, rand_data, 
# 547 "../test/cmp_vfy_test.c" 3 4
                                                                    ((void *)0)
# 547 "../test/cmp_vfy_test.c"
                                                                        );
    if (fixture != 
# 548 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 548 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_msg_check_recipient_nonce(void)
{
    ...
    const unsigned char rec_nonce[16] = {
        0x48, 0xF1, 0x71, 0x1F, 0xE5, 0xAF, 0x1C, 0x8B,
        0x21, 0x97, 0x5C, 0x84, 0x74, 0x49, 0xBA, 0x32
    };

    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 561 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 561 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 1, allow_unprotected, 1, 
# 562 "../test/cmp_vfy_test.c" 3 4
                                                         ((void *)0)
# 562 "../test/cmp_vfy_test.c"
                                                             , rec_nonce);
    if (fixture != 
# 563 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 563 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_VFY_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 570 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 570 "../test/cmp_vfy_test.c"
   ) return 0;
    setup_check_update(&fixture, 0, allow_unprotected, 1, 
# 571 "../test/cmp_vfy_test.c" 3 4
                                                         ((void *)0)
# 571 "../test/cmp_vfy_test.c"
                                                             , rand_data);
    if (fixture != 
# 572 "../test/cmp_vfy_test.c" 3 4
   ((void *)0)
# 572 "../test/cmp_vfy_test.c"
   ) { result = execute_msg_check_test(fixture); tear_down(fixture); };
    return result;
}
...
int setup_tests(void)
{
    ...
    ts.tm_mon = 1;
    ts.tm_mday = 18;
    test_time_valid = mktime(&ts);
    ts.tm_year += 10;
    test_time_after_expiration = mktime(&ts);

    if (!test_skip_common_options()) {
        test_error("../test/cmp_vfy_test.c", 618, "Error parsing test options\n");
        return 0;
    }

    RAND_bytes(rand_data, 16);
    if (!test_ptr("../test/cmp_vfy_test.c", 623, "server_f = test_get_argument(0)", server_f = test_get_argument(0))
            || !test_ptr("../test/cmp_vfy_test.c", 624, "client_f = test_get_argument(1)", client_f = test_get_argument(1))
            || !test_ptr("../test/cmp_vfy_test.c", 625, "endentity1_f = test_get_argument(2)", endentity1_f = test_get_argument(2))
            || !test_ptr("../test/cmp_vfy_test.c", 626, "endentity2_f = test_get_argument(3)", endentity2_f = test_get_argument(3))
            || !test_ptr("../test/cmp_vfy_test.c", 627, "root_f = test_get_argument(4)", root_f = test_get_argument(4))
            || !test_ptr("../test/cmp_vfy_test.c", 628, "intermediate_f = test_get_argument(5)", intermediate_f = test_get_argument(5))
            || !test_ptr("../test/cmp_vfy_test.c", 629, "ir_protected_f = test_get_argument(6)", ir_protected_f = test_get_argument(6))
            || !test_ptr("../test/cmp_vfy_test.c", 630, "ir_unprotected_f = test_get_argument(7)", ir_unprotected_f = test_get_argument(7))
            || !test_ptr("../test/cmp_vfy_test.c", 631, "ip_waiting_f = test_get_argument(8)", ip_waiting_f = test_get_argument(8))
            || !test_ptr("../test/cmp_vfy_test.c", 632, "ir_rmprotection_f = test_get_argument(9)", ir_rmprotection_f = test_get_argument(9))
            || !test_ptr("../test/cmp_vfy_test.c", 633, "instacert_f = test_get_argument(10)", instacert_f = test_get_argument(10))
            || !test_ptr("../test/cmp_vfy_test.c", 634, "instaca_f = test_get_argument(11)", instaca_f = test_get_argument(11))
            || !test_ptr("../test/cmp_vfy_test.c", 635, "ir_protected_0_extracerts = test_get_argument(12)", ir_protected_0_extracerts = test_get_argument(12))
            || !test_ptr("../test/cmp_vfy_test.c", 636, "ir_protected_2_extracerts = test_get_argument(13)", ir_protected_2_extracerts = test_get_argument(13))) {
        test_error("../test/cmp_vfy_test.c", 637, "usage: cmp_vfy_test %s", "server.crt client.crt " "EndEntity1.crt EndEntity2.crt " "Root_CA.crt Intermediate_CA.crt " "CMP_IR_protected.der CMP_IR_unprotected.der " "IP_waitingStatus_PBM.der IR_rmprotection.der " "insta.cert.pem insta_ca.cert.pem " "IR_protected_0_extraCerts.der " "IR_protected_2_extraCerts.der module_name [module_conf_file]\n");
        return 0;
    }

    if (!test_arg_libctx(&libctx, &default_null_provider, &provider, 14, "server.crt client.crt " "EndEntity1.crt EndEntity2.crt " "Root_CA.crt Intermediate_CA.crt " "CMP_IR_protected.der CMP_IR_unprotected.der " "IP_waitingStatus_PBM.der IR_rmprotection.der " "insta.cert.pem insta_ca.cert.pem " "IR_protected_0_extraCerts.der " "IR_protected_2_extraCerts.der module_name [module_conf_file]\n"))
        return 0;


    if (!test_ptr("../test/cmp_vfy_test.c", 645, "endentity1 = load_cert_pem(endentity1_f, libctx)", endentity1 = load_cert_pem(endentity1_f, libctx))
            || !test_ptr("../test/cmp_vfy_test.c", 646, "endentity2 = load_cert_pem(endentity2_f, libctx)", endentity2 = load_cert_pem(endentity2_f, libctx))
            || !test_ptr("../test/cmp_vfy_test.c", 647, "root = load_cert_pem(root_f, NULL)", root = load_cert_pem(root_f, 
# 647 "../test/cmp_vfy_test.c" 3 4
               ((void *)0)
# 647 "../test/cmp_vfy_test.c"
               ))
            || !test_ptr("../test/cmp_vfy_test.c", 648, "intermediate = load_cert_pem(intermediate_f, libctx)", intermediate = load_cert_pem(intermediate_f, libctx)))
        goto err;

    if (!test_ptr("../test/cmp_vfy_test.c", 651, "insta_cert = load_cert_pem(instacert_f, libctx)", insta_cert = load_cert_pem(instacert_f, libctx))
            || !test_ptr("../test/cmp_vfy_test.c", 652, "instaca_cert = load_cert_pem(instaca_f, libctx)", instaca_cert = load_cert_pem(instaca_f, libctx)))
        goto err;


    if (!test_ptr("../test/cmp_vfy_test.c", 656, "srvcert = load_cert_pem(server_f, libctx)", srvcert = load_cert_pem(server_f, libctx))
            || !test_ptr("../test/cmp_vfy_test.c", 657, "clcert = load_cert_pem(client_f, libctx)", clcert = load_cert_pem(client_f, libctx)))
        goto err;
    if (!test_int_eq("../test/cmp_vfy_test.c", 659, "1", "RAND_bytes(rand_data, OSSL_CMP_TRANSACTIONID_LENGTH)", 1, RAND_bytes(rand_data, 16)))
        goto err;
    if (!test_ptr("../test/cmp_vfy_test.c", 661, "ir_unprotected = load_pkimsg(ir_unprotected_f, libctx)", ir_unprotected = load_pkimsg(ir_unprotected_f, libctx))
            || !test_ptr("../test/cmp_vfy_test.c", 662, "ir_rmprotection = load_pkimsg(ir_rmprotection_f, libctx)", ir_rmprotection = load_pkimsg(ir_rmprotection_f, libctx))
                                                               )
        goto err;
    ...
    add_test("test_verify_popo_bad", test_verify_popo_bad);

    add_test("test_validate_msg_signature_trusted_ok", test_validate_msg_signature_trusted_ok);

    add_test("test_validate_msg_signature_trusted_expired", test_validate_msg_signature_trusted_expired);
    add_test("test_validate_msg_signature_srvcert_missing", test_validate_msg_signature_srvcert_missing);

    add_test("test_validate_msg_signature_srvcert_wrong", test_validate_msg_signature_srvcert_wrong);

    add_test("test_validate_msg_signature_bad", test_validate_msg_signature_bad);

    add_test("test_validate_msg_signature_sender_cert_srvcert", test_validate_msg_signature_sender_cert_srvcert);
    add_test("test_validate_msg_signature_sender_cert_untrusted", test_validate_msg_signature_sender_cert_untrusted);
    add_test("test_validate_msg_signature_sender_cert_trusted", test_validate_msg_signature_sender_cert_trusted);
    add_test("test_validate_msg_signature_sender_cert_extracert", test_validate_msg_signature_sender_cert_extracert);

    add_test("test_validate_msg_signature_sender_cert_absent", test_validate_msg_signature_sender_cert_absent);

    add_test("test_validate_msg_signature_expected_sender", test_validate_msg_signature_expected_sender);
    add_test("test_validate_msg_signature_unexpected_sender", test_validate_msg_signature_unexpected_sender);

    add_test("test_validate_msg_unprotected_request", test_validate_msg_unprotected_request);

    add_test("test_validate_msg_mac_alg_protection_ok", test_validate_msg_mac_alg_protection_ok);

    add_test("test_validate_msg_mac_alg_protection_missing", test_validate_msg_mac_alg_protection_missing);
    add_test("test_validate_msg_mac_alg_protection_wrong", test_validate_msg_mac_alg_protection_wrong);
    add_test("test_validate_msg_mac_alg_protection_bad", test_validate_msg_mac_alg_protection_bad);



    add_test("test_validate_cert_path_ok", test_validate_cert_path_ok);
    add_test("test_validate_cert_path_expired", test_validate_cert_path_expired);
    add_test("test_validate_cert_path_wrong_anchor", test_validate_cert_path_wrong_anchor);


    add_test("test_msg_check_no_protection_no_cb", test_msg_check_no_protection_no_cb);
    add_test("test_msg_check_no_protection_restrictive_cb", test_msg_check_no_protection_restrictive_cb);

    add_test("test_msg_check_no_protection_permissive_cb", test_msg_check_no_protection_permissive_cb);
    add_test("test_msg_check_transaction_id", test_msg_check_transaction_id);

    add_test("test_msg_check_transaction_id_bad", test_msg_check_transaction_id_bad);

    add_test("test_msg_check_recipient_nonce", test_msg_check_recipient_nonce);

    add_test("test_msg_check_recipient_nonce_bad", test_msg_check_recipient_nonce_bad);
