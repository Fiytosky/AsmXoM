# 0 "../test/ocspapitest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ocspapitest.c"
# 10 "../test/ocspapitest.c"
...
static int get_cert_and_key(X509 **cert_out, EVP_PKEY **key_out)
{
    BIO *certbio, *keybio;
    X509 *cert = 
# 28 "../test/ocspapitest.c" 3 4
                ((void *)0)
# 28 "../test/ocspapitest.c"
                    ;
    EVP_PKEY *key = 
# 29 "../test/ocspapitest.c" 3 4
                   ((void *)0)
# 29 "../test/ocspapitest.c"
                       ;

    if (!test_ptr("../test/ocspapitest.c", 31, "certbio = BIO_new_file(certstr, \"r\")", certbio = BIO_new_file(certstr, "r")))
        return 0;
    cert = PEM_read_bio_X509(certbio, 
# 33 "../test/ocspapitest.c" 3 4
                                     ((void *)0)
# 33 "../test/ocspapitest.c"
                                         , 
# 33 "../test/ocspapitest.c" 3 4
                                           ((void *)0)
# 33 "../test/ocspapitest.c"
...
# 33 "../test/ocspapitest.c"
    ...
    BIO_free(certbio);
    if (!test_ptr("../test/ocspapitest.c", 35, "keybio = BIO_new_file(privkeystr, \"r\")", keybio = BIO_new_file(privkeystr, "r")))
        goto end;
    key = PEM_read_bio_PrivateKey(keybio, 
# 37 "../test/ocspapitest.c" 3 4
                                         ((void *)0)
# 37 "../test/ocspapitest.c"
                                             , 
# 37 "../test/ocspapitest.c" 3 4
                                               ((void *)0)
# 37 "../test/ocspapitest.c"
...
# 37 "../test/ocspapitest.c"
    ...
    BIO_free(keybio);
    if (!test_ptr("../test/ocspapitest.c", 39, "cert", cert) || !test_ptr("../test/ocspapitest.c", 39, "key", key))
        goto end;
    *cert_out = cert;
    *key_out = key;
    return 1;
...
static int get_cert(X509 **cert_out)
{
    BIO *certbio;
    X509 *cert = 
# 53 "../test/ocspapitest.c" 3 4
                ((void *)0)
# 53 "../test/ocspapitest.c"
                    ;

    if (!test_ptr("../test/ocspapitest.c", 55, "certbio = BIO_new_file(certstr, \"r\")", certbio = BIO_new_file(certstr, "r")))
        return 0;
    cert = PEM_read_bio_X509(certbio, 
# 57 "../test/ocspapitest.c" 3 4
                                     ((void *)0)
# 57 "../test/ocspapitest.c"
                                         , 
# 57 "../test/ocspapitest.c" 3 4
                                           ((void *)0)
# 57 "../test/ocspapitest.c"
...
# 57 "../test/ocspapitest.c"
    ...
    BIO_free(certbio);
    if (!test_ptr("../test/ocspapitest.c", 59, "cert", cert))
        goto end;
    *cert_out = cert;
    return 1;
 end:
...
static OCSP_BASICRESP *make_dummy_resp(void)
{
    ...
    OCSP_BASICRESP *bs_out = 
# 73 "../test/ocspapitest.c" 3 4
                            ((void *)0)
# 73 "../test/ocspapitest.c"
                                ;
    OCSP_CERTID *cid = 
# 74 "../test/ocspapitest.c" 3 4
                      ((void *)0)
# 74 "../test/ocspapitest.c"
                          ;
    ASN1_TIME *thisupd = ASN1_TIME_set(
# 75 "../test/ocspapitest.c" 3 4
                                      ((void *)0)
# 75 "../test/ocspapitest.c"
                                          , time(
# 75 "../test/ocspapitest.c" 3 4
                                                 ((void *)0)
# 75 "../test/ocspapitest.c"
                                                     ));
    ASN1_TIME *nextupd = ASN1_TIME_set(
# 76 "../test/ocspapitest.c" 3 4
                                      ((void *)0)
# 76 "../test/ocspapitest.c"
                                          , time(
# 76 "../test/ocspapitest.c" 3 4
                                                 ((void *)0)
# 76 "../test/ocspapitest.c"
    ...
    if (!test_ptr("../test/ocspapitest.c", 81, "name", name)
        || !test_ptr("../test/ocspapitest.c", 82, "key", key)
        || !test_ptr("../test/ocspapitest.c", 83, "serial", serial)
        || !test_true("../test/ocspapitest.c", 84, "X509_NAME_add_entry_by_NID(name, NID_commonName, MBSTRING_ASC, namestr, -1, -1, 1)", (X509_NAME_add_entry_by_NID(name, 13, (0x1000|1), namestr, -1, -1, 1)) != 0)


        || !test_true("../test/ocspapitest.c", 87, "ASN1_BIT_STRING_set(key, keybytes, sizeof(keybytes))", (ASN1_BIT_STRING_set(key, keybytes, sizeof(keybytes))) != 0)
        || !test_true("../test/ocspapitest.c", 88, "ASN1_INTEGER_set_uint64(serial, (uint64_t)1)", (ASN1_INTEGER_set_uint64(serial, (uint64_t)1)) != 0))
        goto err;
    cid = OCSP_cert_id_new(EVP_sha256(), name, key, serial);
    if (!test_ptr("../test/ocspapitest.c", 91, "bs", bs)
        || !test_ptr("../test/ocspapitest.c", 92, "thisupd", thisupd)
        || !test_ptr("../test/ocspapitest.c", 93, "nextupd", nextupd)
        || !test_ptr("../test/ocspapitest.c", 94, "cid", cid)
        || !test_true("../test/ocspapitest.c", 95, "OCSP_basic_add1_status(bs, cid, V_OCSP_CERTSTATUS_UNKNOWN, 0, NULL, thisupd, nextupd)", (OCSP_basic_add1_status(bs, cid, 2, 0, 
# 95 "../test/ocspapitest.c" 3 4
           ((void *)0)
# 95 "../test/ocspapitest.c"
           , thisupd, nextupd)) != 0)
    ...
    bs_out = bs;
    bs = 
# 100 "../test/ocspapitest.c" 3 4
        ((void *)0)
# 100 "../test/ocspapitest.c"
            ;
 err:
...
{
    OCSP_BASICRESP *bs = 
# 114 "../test/ocspapitest.c" 3 4
                        ((void *)0)
# 114 "../test/ocspapitest.c"
                            ;
    X509 *signer = 
# 115 "../test/ocspapitest.c" 3 4
                  ((void *)0)
# 115 "../test/ocspapitest.c"
                      , *tmp;
    EVP_PKEY *key = 
# 116 "../test/ocspapitest.c" 3 4
                   ((void *)0)
# 116 "../test/ocspapitest.c"
                       ;
    struct stack_st_X509 *extra_certs = 
# 117 "../test/ocspapitest.c" 3 4
                                 ((void *)0)
# 117 "../test/ocspapitest.c"
                                     ;
    int ret = 0;
    ...
    bs = make_dummy_resp();
    extra_certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    if (!test_ptr("../test/ocspapitest.c", 126, "bs", bs)
        || !test_ptr("../test/ocspapitest.c", 127, "extra_certs", extra_certs)
        || !test_true("../test/ocspapitest.c", 128, "get_cert_and_key(&signer, &key)", (get_cert_and_key(&signer, &key)) != 0)
        || !test_true("../test/ocspapitest.c", 129, "sk_X509_push(extra_certs, signer)", (OPENSSL_sk_push(ossl_check_X509_sk_type(extra_certs), ossl_check_X509_type(signer))) != 0)
        || !test_true("../test/ocspapitest.c", 130, "OCSP_basic_sign(bs, signer, key, EVP_sha1(), NULL, OCSP_NOCERTS)", (OCSP_basic_sign(bs, signer, key, EVP_sha1(), 
# 130 "../test/ocspapitest.c" 3 4
           ((void *)0)
# 130 "../test/ocspapitest.c"
           , 0x1)) != 0)
                                                          )
        goto err;
    if (!test_true("../test/ocspapitest.c", 133, "OCSP_resp_get0_signer(bs, &tmp, extra_certs)", (OCSP_resp_get0_signer(bs, &tmp, extra_certs)) != 0)
        || !test_int_eq("../test/ocspapitest.c", 134, "X509_cmp(tmp, signer)", "0", X509_cmp(tmp, signer), 0))
        goto err;
    OCSP_BASICRESP_free(bs);
    ...
    bs = make_dummy_resp();
    tmp = 
# 140 "../test/ocspapitest.c" 3 4
         ((void *)0)
# 140 "../test/ocspapitest.c"
             ;
    if (!test_ptr("../test/ocspapitest.c", 141, "bs", bs)
        || !test_true("../test/ocspapitest.c", 142, "OCSP_basic_sign(bs, signer, key, EVP_sha1(), NULL, 0)", (OCSP_basic_sign(bs, signer, key, EVP_sha1(), 
# 142 "../test/ocspapitest.c" 3 4
           ((void *)0)
# 142 "../test/ocspapitest.c"
           , 0)) != 0)
                                               )
        goto err;
    if (!test_true("../test/ocspapitest.c", 145, "OCSP_resp_get0_signer(bs, &tmp, NULL)", (OCSP_resp_get0_signer(bs, &tmp, 
# 145 "../test/ocspapitest.c" 3 4
        ((void *)0)
# 145 "../test/ocspapitest.c"
        )) != 0)
        || !test_int_eq("../test/ocspapitest.c", 146, "X509_cmp(tmp, signer)", "0", X509_cmp(tmp, signer), 0))
        goto err;
    ret = 1;
 err:
    OCSP_BASICRESP_free(bs);
    OPENSSL_sk_free(ossl_check_X509_sk_type(extra_certs));
    X509_free(signer);
    EVP_PKEY_free(key);
    return ret;
}
...
static int test_access_description(int testcase)
{
    ...
    if (!test_ptr("../test/ocspapitest.c", 162, "ad", ad))
        goto err;
    ...
    case 0:
        break;
    case 1:
        if (!test_ptr("../test/ocspapitest.c", 169, "ad->location", ad->location))
            goto err;
        GENERAL_NAME_free(ad->location);
        ad->location = 
# 172 "../test/ocspapitest.c" 3 4
                      ((void *)0)
# 172 "../test/ocspapitest.c"
                          ;
        break;
    case 2:
        GENERAL_NAME_free(ad->location);
        ad->location = GENERAL_NAME_new();
        if (!test_ptr("../test/ocspapitest.c", 177, "ad->location", ad->location))
            goto err;
        break;
    }
...
# 192 "../test/ocspapitest.c" 3 4
       ((void *)0)
    
# 193 "../test/ocspapitest.c"
   };

    X509 *issuer = 
# 195 "../test/ocspapitest.c" 3 4
                  ((void *)0)
# 195 "../test/ocspapitest.c"
                      ;
    X509_EXTENSION *ext = 
# 196 "../test/ocspapitest.c" 3 4
                         ((void *)0)
# 196 "../test/ocspapitest.c"
                             ;
    int ret = 0;

    if (!test_true("../test/ocspapitest.c", 199, "get_cert(&issuer)", (get_cert(&issuer)) != 0))
        goto err;
    ...
    if (!test_ptr("../test/ocspapitest.c", 206, "ext", ext))
        goto err;
...
# 218 "../test/ocspapitest.c" 3 4
((void *)0) 
# 218 "../test/ocspapitest.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/ocspapitest.c", 223, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/ocspapitest.c", 227, "certstr = test_get_argument(0)", certstr = test_get_argument(0))
        || !test_ptr("../test/ocspapitest.c", 228, "privkeystr = test_get_argument(1)", privkeystr = test_get_argument(1)))
        return 0;

    add_test("test_resp_signer", test_resp_signer);
    add_all_tests("test_access_description", test_access_description, 3, 1);
