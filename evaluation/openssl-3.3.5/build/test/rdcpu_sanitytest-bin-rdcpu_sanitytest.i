# 0 "../test/rdcpu_sanitytest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rdcpu_sanitytest.c"
# 10 "../test/rdcpu_sanitytest.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 15 "../test/rdcpu_sanitytest.c" 2
# 123 "../test/rdcpu_sanitytest.c"
int setup_tests(void)
{
# 149 "../test/rdcpu_sanitytest.c"
    return 1;
}
