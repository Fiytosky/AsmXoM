# 0 "../test/provider_default_search_path_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_default_search_path_test.c"
# 10 "../test/provider_default_search_path_test.c"
...
# 11 "../test/provider_default_search_path_test.c" 2
...
# 12 "../test/provider_default_search_path_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
# 13 "../test/provider_default_search_path_test.c" 2

static int test_default_libctx(void)
{
    OSSL_LIB_CTX *ctx = 
# 16 "../test/provider_default_search_path_test.c" 3 4
                       ((void *)0)
# 16 "../test/provider_default_search_path_test.c"
                           ;
    char *path = "./some/path";
    const char *retrieved_path = 
# 18 "../test/provider_default_search_path_test.c" 3 4
                                ((void *)0)
# 18 "../test/provider_default_search_path_test.c"
                                    ;
    int ok;

    ok = test_true("../test/provider_default_search_path_test.c", 21, "OSSL_PROVIDER_set_default_search_path(ctx, path)", (OSSL_PROVIDER_set_default_search_path(ctx, path)) != 0)
        && test_ptr("../test/provider_default_search_path_test.c", 22, "retrieved_path = OSSL_PROVIDER_get0_default_search_path(ctx)", retrieved_path = OSSL_PROVIDER_get0_default_search_path(ctx))
        && test_str_eq("../test/provider_default_search_path_test.c", 23, "path", "retrieved_path", path, retrieved_path);
...
{
    OSSL_LIB_CTX *ctx = 
# 30 "../test/provider_default_search_path_test.c" 3 4
                       ((void *)0)
# 30 "../test/provider_default_search_path_test.c"
                           ;
    char *def_libctx_path = "./some/path";
    char *path = "./another/location";
    const char *retrieved_defctx_path = 
# 33 "../test/provider_default_search_path_test.c" 3 4
                                       ((void *)0)
# 33 "../test/provider_default_search_path_test.c"
                                           ;
    const char *retrieved_path = 
# 34 "../test/provider_default_search_path_test.c" 3 4
                                ((void *)0)
# 34 "../test/provider_default_search_path_test.c"
                                    ;
    int ok;
    ...
    ok = test_true("../test/provider_default_search_path_test.c", 40, "OSSL_PROVIDER_set_default_search_path(NULL, def_libctx_path)", (OSSL_PROVIDER_set_default_search_path(
# 40 "../test/provider_default_search_path_test.c" 3 4
        ((void *)0)
# 40 "../test/provider_default_search_path_test.c"
        , def_libctx_path)) != 0)
        && test_ptr("../test/provider_default_search_path_test.c", 41, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new())
        && test_true("../test/provider_default_search_path_test.c", 42, "OSSL_PROVIDER_set_default_search_path(ctx, path)", (OSSL_PROVIDER_set_default_search_path(ctx, path)) != 0)
        && test_ptr("../test/provider_default_search_path_test.c", 43, "retrieved_defctx_path = OSSL_PROVIDER_get0_default_search_path(NULL)", retrieved_defctx_path = OSSL_PROVIDER_get0_default_search_path(
# 43 "../test/provider_default_search_path_test.c" 3 4
          ((void *)0)
# 43 "../test/provider_default_search_path_test.c"
          ))
        && test_str_eq("../test/provider_default_search_path_test.c", 44, "def_libctx_path", "retrieved_defctx_path", def_libctx_path, retrieved_defctx_path)
        && test_ptr("../test/provider_default_search_path_test.c", 45, "retrieved_path = OSSL_PROVIDER_get0_default_search_path(ctx)", retrieved_path = OSSL_PROVIDER_get0_default_search_path(ctx))
        && test_str_eq("../test/provider_default_search_path_test.c", 46, "path", "retrieved_path", path, retrieved_path)
        && test_str_ne("../test/provider_default_search_path_test.c", 47, "retrieved_path", "retrieved_defctx_path", retrieved_path, retrieved_defctx_path);
...
int setup_tests(void)
{
    add_test("test_default_libctx", test_default_libctx);
