# 0 "../test/evp_extra_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_extra_test.c"
# 13 "../test/evp_extra_test.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 23 "../test/evp_extra_test.c" 2
# 1 "../include/openssl/kdf.h" 1
...
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 21 "../include/openssl/kdf.h" 2
# 1 "../include/openssl/types.h" 1
# 22 "../include/openssl/kdf.h" 2
...
# 25 "../test/evp_extra_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 26 "../test/evp_extra_test.c" 2

# 1 "../include/openssl/param_build.h" 1
# 13 "../include/openssl/param_build.h"
        


# 1 "../include/openssl/types.h" 1
# 17 "../include/openssl/param_build.h" 2
...
extern const char *AES_options(void);
extern
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 31 "../test/evp_extra_test.c" 2
# 1 "../include/openssl/decoder.h" 1
...
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 21 "../include/openssl/decoder.h" 2
# 1 "../include/openssl/decodererr.h" 1
# 13 "../include/openssl/decodererr.h"
        
# 22 "../include/openssl/decoder.h" 2
# 1 "../include/openssl/types.h" 1
# 23 "../include/openssl/decoder.h" 2
...
extern int RAND_set_rand_method(const RAND_METHOD *meth);
extern const RAND_METHOD *RAND_get_rand_method(void);

extern int RAND_set_rand_engine(ENGINE *engine);


extern RAND_METHOD *RAND_OpenSSL(void);
...
int RAND_poll(void);
# 30 "../include/openssl/engine.h" 2
# 1 "include/openssl/ui.h" 1
# 17 "include/openssl/ui.h"
        
# 31 "include/openssl/ui.h"
# 1 "../include/openssl/types.h" 1
# 32 "include/openssl/ui.h" 2
# 1 "../include/openssl/uierr.h" 1
# 13 "../include/openssl/uierr.h"
        
# 33 "include/openssl/ui.h" 2
# 53 "include/openssl/ui.h"
UI *UI_new(void);
UI *UI_new_method(const UI_METHOD *method);
void UI_free(UI *ui);
# 100 "include/openssl/ui.h"
...
# 1 "../include/openssl/types.h" 1
# 34 "../include/openssl/engine.h" 2


# 1 "../include/openssl/engineerr.h" 1
# 13 "../include/openssl/engineerr.h"
        
# 37 "../include/openssl/engine.h" 2
# 257 "../include/openssl/engine.h"
...
typedef int (*ENGINE_PKEY_ASN1_METHS_PTR) (ENGINE *, EVP_PKEY_ASN1_METHOD **,
                                           const int **, int);
# 318 "../include/openssl/engine.h"
extern ENGINE *ENGINE_get_first(void);
extern ENGINE *ENGINE_get_last(void);



extern ENGINE *ENGINE_get_next(ENGINE *e);
extern ENGINE *ENGINE_get_prev(ENGINE *e);



extern int ENGINE_add(ENGINE *e);



extern int ENGINE_remove(ENGINE *e);



extern ENGINE *ENGINE_by_id(const char *id);
...
extern unsigned int ENGINE_get_table_flags(void);
extern void ENGINE_set_table_flags(unsigned int flags);
# 378 "../include/openssl/engine.h"
extern int ENGINE_register_RSA(ENGINE *e);
extern void ENGINE_unregister_RSA(ENGINE *e);
extern void ENGINE_register_all_RSA(void);
extern int ENGINE_register_DSA(ENGINE *e);
extern void ENGINE_unregister_DSA(ENGINE *e);
extern void ENGINE_register_all_DSA(void);
extern int ENGINE_register_EC(ENGINE *e);
extern void ENGINE_unregister_EC(ENGINE *e);
extern void ENGINE_register_all_EC(void);
extern int ENGINE_register_DH(ENGINE *e);
extern void ENGINE_unregister_DH(ENGINE *e);
extern void ENGINE_register_all_DH(void);
extern int ENGINE_register_RAND(ENGINE *e);
extern void ENGINE_unregister_RAND(ENGINE *e);
extern void ENGINE_register_all_RAND(void);
extern int ENGINE_register_ciphers(ENGINE *e);
extern void ENGINE_unregister_ciphers(ENGINE *e);
extern void ENGINE_register_all_ciphers(void);
extern int ENGINE_register_digests(ENGINE *e);
extern void ENGINE_unregister_digests(ENGINE *e);
extern void ENGINE_register_all_digests(void);
extern int ENGINE_register_pkey_meths(ENGINE *e);
extern void ENGINE_unregister_pkey_meths(ENGINE *e);
extern void ENGINE_register_all_pkey_meths(void);
extern int ENGINE_register_pkey_asn1_meths(ENGINE *e);
extern void ENGINE_unregister_pkey_asn1_meths(ENGINE *e);
extern void ENGINE_register_all_pkey_asn1_meths(void);
# 414 "../include/openssl/engine.h"
extern int ENGINE_register_complete(ENGINE *e);
extern int ENGINE_register_all_complete(void);
# 429 "../include/openssl/engine.h"
extern int ENGINE_ctrl(ENGINE *e, int cmd, long i, void *p,
                                      void (*f) (void));
# 440 "../include/openssl/engine.h"
extern int ENGINE_cmd_is_executable(ENGINE *e, int cmd);
# 450 "../include/openssl/engine.h"
extern int ENGINE_ctrl_cmd(ENGINE *e, const char *cmd_name,
                                          long i, void *p, void (*f) (void),
                                          int cmd_optional);
# 478 "../include/openssl/engine.h"
extern
int ENGINE_ctrl_cmd_string(ENGINE *e, const char *cmd_name, const char *arg,
                           int cmd_optional);
# 492 "../include/openssl/engine.h"
extern ENGINE *ENGINE_new(void);
extern int ENGINE_free(ENGINE *e);
extern int ENGINE_up_ref(ENGINE *e);
extern int ENGINE_set_id(ENGINE *e, const char *id);
extern int ENGINE_set_name(ENGINE *e, const char *name);
extern int ENGINE_set_RSA(ENGINE *e, const RSA_METHOD *rsa_meth);
extern int ENGINE_set_DSA(ENGINE *e, const DSA_METHOD *dsa_meth);
extern int ENGINE_set_EC(ENGINE *e, const EC_KEY_METHOD *ecdsa_meth);
extern int ENGINE_set_DH(ENGINE *e, const DH_METHOD *dh_meth);
extern int ENGINE_set_RAND(ENGINE *e, const RAND_METHOD *rand_meth);
extern
...
extern int ENGINE_set_flags(ENGINE *e, int flags);
extern int ENGINE_set_cmd_defns(ENGINE *e,
...
extern int ENGINE_set_ex_data(ENGINE *e, int idx, void *arg);
extern void *ENGINE_get_ex_data(const ENGINE *e, int idx);
# 552 "../include/openssl/engine.h"
extern const char *ENGINE_get_id(const ENGINE *e);
extern const char *ENGINE_get_name(const ENGINE *e);
extern const RSA_METHOD *ENGINE_get_RSA(const ENGINE *e);
extern const DSA_METHOD *ENGINE_get_DSA(const ENGINE *e);
extern const EC_KEY_METHOD *ENGINE_get_EC(const ENGINE *e);
extern const DH_METHOD *ENGINE_get_DH(const ENGINE *e);
extern const RAND_METHOD *ENGINE_get_RAND(const ENGINE *e);
extern
...
extern int ENGINE_get_flags(const ENGINE *e);
# 620 "../include/openssl/engine.h"
...
EVP_PKEY *ENGINE_load_public_key(ENGINE *e, const char *key_id,
                                 UI_METHOD *ui_method, void *callback_data);
extern
int ENGINE_load_ssl_client_cert(ENGINE *e, SSL *s, struct stack_st_X509_NAME *ca_dn,
                                X509 **pcert, EVP_PKEY **ppkey,
                                struct stack_st_X509 **pother,
                                UI_METHOD *ui_method, void *callback_data);
# 657 "../include/openssl/engine.h"
extern ENGINE *ENGINE_get_default_RSA(void);



extern ENGINE *ENGINE_get_default_DSA(void);
extern ENGINE *ENGINE_get_default_EC(void);
extern ENGINE *ENGINE_get_default_DH(void);
extern ENGINE *ENGINE_get_default_RAND(void);
...
extern ENGINE *ENGINE_get_cipher_engine(int nid);
extern ENGINE *ENGINE_get_digest_engine(int nid);
extern ENGINE *ENGINE_get_pkey_meth_engine(int nid);
extern ENGINE *ENGINE_get_pkey_asn1_meth_engine(int nid);
# 684 "../include/openssl/engine.h"
extern int ENGINE_set_default_RSA(ENGINE *e);
extern int ENGINE_set_default_string(ENGINE *e,
                                                    const char *def_list);



extern int ENGINE_set_default_DSA(ENGINE *e);
extern int ENGINE_set_default_EC(ENGINE *e);
extern int ENGINE_set_default_DH(ENGINE *e);
extern int ENGINE_set_default_RAND(ENGINE *e);
extern int ENGINE_set_default_ciphers(ENGINE *e);
extern int ENGINE_set_default_digests(ENGINE *e);
extern int ENGINE_set_default_pkey_meths(ENGINE *e);
extern int ENGINE_set_default_pkey_asn1_meths(ENGINE *e);
# 708 "../include/openssl/engine.h"
extern int ENGINE_set_default(ENGINE *e, unsigned int flags);
extern void ENGINE_add_conf_module(void);
# 738 "../include/openssl/engine.h"
...
# 768 "../include/openssl/engine.h"
typedef unsigned long (*dynamic_v_check_fn) (unsigned long ossl_version);
# 793 "../include/openssl/engine.h"
typedef int (*dynamic_bind_engine) (ENGINE *e, const char *id,
                                    const dynamic_fns *fns);
# 820 "../include/openssl/engine.h"
void *ENGINE_get_static_state(void);
# 34 "../test/evp_extra_test.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 35 "../test/evp_extra_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 36 "../test/evp_extra_test.c" 2

# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 38 "../test/evp_extra_test.c" 2
# 1 "../include/crypto/evp.h" 1
...
struct stack_st_EVP_PKEY_METHOD; typedef int (*sk_EVP_PKEY_METHOD_compfunc)(const EVP_PKEY_METHOD * const *a, const EVP_PKEY_METHOD *const *b); typedef void (*sk_EVP_PKEY_METHOD_freefunc)(EVP_PKEY_METHOD *a); typedef EVP_PKEY_METHOD * (*sk_EVP_PKEY_METHOD_copyfunc)(const EVP_PKEY_METHOD *a); static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_num(const struct stack_st_EVP_PKEY_METHOD *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_value(const struct stack_st_EVP_PKEY_METHOD *sk, int idx) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_new(sk_EVP_PKEY_METHOD_compfunc compare) { return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_new_null(void) { return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_new_reserve(sk_EVP_PKEY_METHOD_compfunc compare, int n) { return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_reserve(struct stack_st_EVP_PKEY_METHOD *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_PKEY_METHOD_free(struct stack_st_EVP_PKEY_METHOD *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_PKEY_METHOD_zero(struct stack_st_EVP_PKEY_METHOD *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_delete(struct stack_st_EVP_PKEY_METHOD *sk, int i) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_delete_ptr(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_push(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_unshift(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_pop(struct stack_st_EVP_PKEY_METHOD *sk) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_shift(struct stack_st_EVP_PKEY_METHOD *sk) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_PKEY_METHOD_pop_free(struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_insert(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline const EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_set(struct stack_st_EVP_PKEY_METHOD *sk, int idx, const EVP_PKEY_METHOD *ptr) { return (const EVP_PKEY_METHOD *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_find(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_find_ex(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_find_all(struct stack_st_EVP_PKEY_METHOD *sk, const EVP_PKEY_METHOD *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_PKEY_METHOD_sort(struct stack_st_EVP_PKEY_METHOD *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_PKEY_METHOD_is_sorted(const struct stack_st_EVP_PKEY_METHOD *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_PKEY_METHOD * sk_EVP_PKEY_METHOD_dup(const struct stack_st_EVP_PKEY_METHOD *sk) { return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_PKEY_METHOD *sk_EVP_PKEY_METHOD_deep_copy(const struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_copyfunc copyfunc, sk_EVP_PKEY_METHOD_freefunc freefunc) { return (struct stack_st_EVP_PKEY_METHOD *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_PKEY_METHOD_compfunc sk_EVP_PKEY_METHOD_set_cmp_func(struct stack_st_EVP_PKEY_METHOD *sk, sk_EVP_PKEY_METHOD_compfunc compare) { return (sk_EVP_PKEY_METHOD_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
struct stack_st_OP_CACHE_ELEM; typedef int (*sk_OP_CACHE_ELEM_compfunc)(const OP_CACHE_ELEM * const *a, const OP_CACHE_ELEM *const *b); typedef void (*sk_OP_CACHE_ELEM_freefunc)(OP_CACHE_ELEM *a); typedef OP_CACHE_ELEM * (*sk_OP_CACHE_ELEM_copyfunc)(const OP_CACHE_ELEM *a); static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_num(const struct stack_st_OP_CACHE_ELEM *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_value(const struct stack_st_OP_CACHE_ELEM *sk, int idx) { return (OP_CACHE_ELEM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OP_CACHE_ELEM *sk_OP_CACHE_ELEM_new(sk_OP_CACHE_ELEM_compfunc compare) { return (struct stack_st_OP_CACHE_ELEM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OP_CACHE_ELEM *sk_OP_CACHE_ELEM_new_null(void) { return (struct stack_st_OP_CACHE_ELEM *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OP_CACHE_ELEM *sk_OP_CACHE_ELEM_new_reserve(sk_OP_CACHE_ELEM_compfunc compare, int n) { return (struct stack_st_OP_CACHE_ELEM *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_reserve(struct stack_st_OP_CACHE_ELEM *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OP_CACHE_ELEM_free(struct stack_st_OP_CACHE_ELEM *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OP_CACHE_ELEM_zero(struct stack_st_OP_CACHE_ELEM *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_delete(struct stack_st_OP_CACHE_ELEM *sk, int i) { return (OP_CACHE_ELEM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_delete_ptr(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr) { return (OP_CACHE_ELEM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_push(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_unshift(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_pop(struct stack_st_OP_CACHE_ELEM *sk) { return (OP_CACHE_ELEM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_shift(struct stack_st_OP_CACHE_ELEM *sk) { return (OP_CACHE_ELEM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OP_CACHE_ELEM_pop_free(struct stack_st_OP_CACHE_ELEM *sk, sk_OP_CACHE_ELEM_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_insert(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OP_CACHE_ELEM *sk_OP_CACHE_ELEM_set(struct stack_st_OP_CACHE_ELEM *sk, int idx, OP_CACHE_ELEM *ptr) { return (OP_CACHE_ELEM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_find(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_find_ex(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_find_all(struct stack_st_OP_CACHE_ELEM *sk, OP_CACHE_ELEM *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OP_CACHE_ELEM_sort(struct stack_st_OP_CACHE_ELEM *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OP_CACHE_ELEM_is_sorted(const struct stack_st_OP_CACHE_ELEM *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OP_CACHE_ELEM * sk_OP_CACHE_ELEM_dup(const struct stack_st_OP_CACHE_ELEM *sk) { return (struct stack_st_OP_CACHE_ELEM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OP_CACHE_ELEM *sk_OP_CACHE_ELEM_deep_copy(const struct stack_st_OP_CACHE_ELEM *sk, sk_OP_CACHE_ELEM_copyfunc copyfunc, sk_OP_CACHE_ELEM_freefunc freefunc) { return (struct stack_st_OP_CACHE_ELEM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OP_CACHE_ELEM_compfunc sk_OP_CACHE_ELEM_set_cmp_func(struct stack_st_OP_CACHE_ELEM *sk, sk_OP_CACHE_ELEM_compfunc compare) { return (sk_OP_CACHE_ELEM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
# 645 "../include/crypto/evp.h"
...
# 700 "../include/crypto/evp.h"
    ...
    size_t dirty_cnt;
# 715 "../include/crypto/evp.h"
    struct stack_st_OP_CACHE_ELEM *operation_cache;
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 39 "../test/evp_extra_test.c" 2
# 1 "../test/fake_rsaprov.h" 1
# 15 "../test/fake_rsaprov.h"
...
# 40 "../test/evp_extra_test.c" 2


OSSL_provider_init_fn ossl_legacy_provider_init;


static OSSL_LIB_CTX *testctx = 
# 45 "../test/evp_extra_test.c" 3 4
                              ((void *)0)
# 45 "../test/evp_extra_test.c"
                                  ;
static char *testpropq = 
# 46 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 46 "../test/evp_extra_test.c"
                            ;

static OSSL_PROVIDER *nullprov = 
# 48 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 48 "../test/evp_extra_test.c"
                                    ;
static OSSL_PROVIDER *deflprov = 
# 49 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 49 "../test/evp_extra_test.c"
                                    ;
static OSSL_PROVIDER *lgcyprov = 
# 50 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 50 "../test/evp_extra_test.c"
                                    ;
...
static APK_DATA keydata[] = {
    {kExampleRSAKeyDER, sizeof(kExampleRSAKeyDER), "RSA", 6},
    {kExampleRSAKeyPKCS8, sizeof(kExampleRSAKeyPKCS8), "RSA", 6},

    {kExampleECKeyDER, sizeof(kExampleECKeyDER), "EC", 408}

};

static APK_DATA keycheckdata[] = {
    {kExampleRSAKeyDER, sizeof(kExampleRSAKeyDER), "RSA", 6, 1, 1, 1,
     0},
    {kExampleBadRSAKeyDER, sizeof(kExampleBadRSAKeyDER), "RSA", 6,
     0, 1, 1, 0},
    {kExampleBad2RSAKeyDER, sizeof(kExampleBad2RSAKeyDER), "RSA", 6,
     0, 0, 1 , 0},

    {kExampleECKeyDER, sizeof(kExampleECKeyDER), "EC", 408, 1, 1, 1, 0},

    {kExampleECPubKeyDER, sizeof(kExampleECPubKeyDER), "EC", 408, 0, 1,
     1, 1},
    {pExampleECParamDER, sizeof(pExampleECParamDER), "EC", 408, 0, 0, 1,
     2},
                                  ...
                                  const unsigned char *data, size_t data_len)
{
    ...
    EVP_PKEY *pkey = 
# 613 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 613 "../test/evp_extra_test.c"
                        ;
    OSSL_DECODER_CTX *dctx =
        OSSL_DECODER_CTX_new_for_pkey(&pkey, "DER", 
# 615 "../test/evp_extra_test.c" 3 4
                                                   ((void *)0)
# 615 "../test/evp_extra_test.c"
                                                       , keytype, 0,
                                      testctx, testpropq);
...
{
    EVP_PKEY *pkey = 
# 672 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 672 "../test/evp_extra_test.c"
                        ;
    unsigned char key[] = {
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
...
# 680 "../test/evp_extra_test.c" 3 4
                                          ((void *)0)
# 680 "../test/evp_extra_test.c"
                                              , key, sizeof(key));
    if (!test_ptr("../test/evp_extra_test.c", 681, "pkey", pkey))
        return 
# 682 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 682 "../test/evp_extra_test.c"
                  ;
...
static int test_EVP_set_default_properties(void)
{
    OSSL_LIB_CTX *ctx;
    EVP_MD *md = 
# 690 "../test/evp_extra_test.c" 3 4
                ((void *)0)
# 690 "../test/evp_extra_test.c"
                    ;
    int res = 0;

    if (!test_ptr("../test/evp_extra_test.c", 693, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new())
            || !test_ptr("../test/evp_extra_test.c", 694, "md = EVP_MD_fetch(ctx, \"sha256\", NULL)", md = EVP_MD_fetch(ctx, "sha256", 
# 694 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 694 "../test/evp_extra_test.c"
               )))
        goto err;
    EVP_MD_free(md);
    md = 
# 697 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 697 "../test/evp_extra_test.c"
            ;

    if (!test_true("../test/evp_extra_test.c", 699, "EVP_set_default_properties(ctx, \"provider=fizzbang\")", (EVP_set_default_properties(ctx, "provider=fizzbang")) != 0)
            || !test_ptr_null("../test/evp_extra_test.c", 700, "md = EVP_MD_fetch(ctx, \"sha256\", NULL)", md = EVP_MD_fetch(ctx, "sha256", 
# 700 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 700 "../test/evp_extra_test.c"
               ))
            || !test_ptr("../test/evp_extra_test.c", 701, "md = EVP_MD_fetch(ctx, \"sha256\", \"-provider\")", md = EVP_MD_fetch(ctx, "sha256", "-provider")))
        goto err;
    EVP_MD_free(md);
    md = 
# 704 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 704 "../test/evp_extra_test.c"
            ;

    if (!test_true("../test/evp_extra_test.c", 706, "EVP_set_default_properties(ctx, NULL)", (EVP_set_default_properties(ctx, 
# 706 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 706 "../test/evp_extra_test.c"
        )) != 0)
            || !test_ptr("../test/evp_extra_test.c", 707, "md = EVP_MD_fetch(ctx, \"sha256\", NULL)", md = EVP_MD_fetch(ctx, "sha256", 
# 707 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 707 "../test/evp_extra_test.c"
               )))
        goto err;
    res = 1;
err:
...
{
    EVP_PKEY_CTX *pctx = 
# 719 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 719 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *tmp_pkey = 
# 720 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 720 "../test/evp_extra_test.c"
                            , *pkey = 
# 720 "../test/evp_extra_test.c" 3 4
                                      ((void *)0)
# 720 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 722, "pctx = EVP_PKEY_CTX_new_from_name(testctx, keytype, testpropq)", pctx = EVP_PKEY_CTX_new_from_name(testctx, keytype, testpropq)))
        goto err;

    if (!test_int_eq("../test/evp_extra_test.c", 725, "EVP_PKEY_CTX_set_params(pctx, params)", "0", EVP_PKEY_CTX_set_params(pctx, params), 0)
        || !test_int_gt("../test/evp_extra_test.c", 726, "EVP_PKEY_fromdata_init(pctx)", "0", EVP_PKEY_fromdata_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 727, "EVP_PKEY_fromdata(pctx, &tmp_pkey, EVP_PKEY_KEYPAIR, params)", "0", EVP_PKEY_fromdata(pctx, &tmp_pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params), 0)
                                                     )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 731, "tmp_pkey", tmp_pkey))
        goto err;

    pkey = tmp_pkey;
    tmp_pkey = 
# 735 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 735 "../test/evp_extra_test.c"
                  ;
 err:
...
static int test_selection(EVP_PKEY *pkey, int selection)
{
    ...
    if ((selection & 0x02) != 0) {
        if (!test_true("../test/evp_extra_test.c", 750, "ret", (ret) != 0))
            goto err;
    } else {
        if (!test_false("../test/evp_extra_test.c", 753, "ret", (ret) != 0))
            goto err;
    }
    ret = PEM_write_bio_PrivateKey_ex(bio, pkey, 
# 756 "../test/evp_extra_test.c" 3 4
                                                ((void *)0)
# 756 "../test/evp_extra_test.c"
                                                    , 
# 756 "../test/evp_extra_test.c" 3 4
                                                      ((void *)0)
# 756 "../test/evp_extra_test.c"
...
# 756 "../test/evp_extra_test.c"
                                                                         ,
                                      testctx, 
# 757 "../test/evp_extra_test.c" 3 4
                                              ((void *)0)
# 757 "../test/evp_extra_test.c"
                                                  );
    if ((selection & 0x01) != 0) {
        if (!test_true("../test/evp_extra_test.c", 759, "ret", (ret) != 0))
            goto err;
    } else {
        if (!test_false("../test/evp_extra_test.c", 762, "ret", (ret) != 0))
            goto err;
    }
...
{
    OSSL_PARAM_BLD *bld = 
# 781 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 781 "../test/evp_extra_test.c"
                             ;
    OSSL_PARAM *params = 
# 782 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 782 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *just_params = 
# 783 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 783 "../test/evp_extra_test.c"
                               ;
    EVP_PKEY *params_and_priv = 
# 784 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 784 "../test/evp_extra_test.c"
                                   ;
    EVP_PKEY *params_and_pub = 
# 785 "../test/evp_extra_test.c" 3 4
                              ((void *)0)
# 785 "../test/evp_extra_test.c"
                                  ;
    EVP_PKEY *params_and_keypair = 
# 786 "../test/evp_extra_test.c" 3 4
                                  ((void *)0)
# 786 "../test/evp_extra_test.c"
                                      ;
    BIGNUM *p = 
# 787 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 787 "../test/evp_extra_test.c"
                   , *q = 
# 787 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 787 "../test/evp_extra_test.c"
...
# 787 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 794, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 795, "q = BN_new()", q = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 796, "g = BN_new()", g = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 797, "pub = BN_new()", pub = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 798, "priv = BN_new()", priv = BN_new()))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 802, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 803, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_extra_test.c", 804, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_extra_test.c", 805, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0))
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 807, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 808, "just_params = make_key_fromdata(keytype, params)", just_params = make_key_fromdata(keytype, params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 813 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 813 "../test/evp_extra_test.c"
                ;
    bld = 
# 814 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 814 "../test/evp_extra_test.c"
             ;

    if (!test_selection(just_params, ( 0x04 | 0x80))
        || test_selection(just_params, ( 0x01 | 0x02 )))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 821, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 822, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_extra_test.c", 823, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_extra_test.c", 824, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0)
        || !test_true("../test/evp_extra_test.c", 825, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 828, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 829, "params_and_priv = make_key_fromdata(keytype, params)", params_and_priv = make_key_fromdata(keytype, params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 834 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 834 "../test/evp_extra_test.c"
                ;
    bld = 
# 835 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 835 "../test/evp_extra_test.c"
             ;

    if (!test_selection(params_and_priv, 0x01)
        || test_selection(params_and_priv, 0x02))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 842, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 843, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_extra_test.c", 844, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_extra_test.c", 845, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0)
        || !test_true("../test/evp_extra_test.c", 846, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)
                                                  )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 849, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 850, "params_and_pub = make_key_fromdata(keytype, params)", params_and_pub = make_key_fromdata(keytype, params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 855 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 855 "../test/evp_extra_test.c"
                ;
    bld = 
# 856 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 856 "../test/evp_extra_test.c"
             ;

    if (!test_selection(params_and_pub, 0x02)
        || test_selection(params_and_pub, 0x01))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 863, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 864, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_extra_test.c", 865, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_extra_test.c", 866, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0)
        || !test_true("../test/evp_extra_test.c", 867, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)

        || !test_true("../test/evp_extra_test.c", 869, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 872, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 873, "params_and_keypair = make_key_fromdata(keytype, params)", params_and_keypair = make_key_fromdata(keytype, params)))
        goto err;

    if (!test_selection(params_and_keypair, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 )))
        goto err;
...
{
    OSSL_PARAM_BLD *bld = 
# 918 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 918 "../test/evp_extra_test.c"
                             ;
    OSSL_PARAM *params = 
# 919 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 919 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *just_params = 
# 920 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 920 "../test/evp_extra_test.c"
                               ;
    EVP_PKEY *params_and_priv = 
# 921 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 921 "../test/evp_extra_test.c"
                                   ;
    EVP_PKEY *params_and_pub = 
# 922 "../test/evp_extra_test.c" 3 4
                              ((void *)0)
# 922 "../test/evp_extra_test.c"
                                  ;
    EVP_PKEY *params_and_keypair = 
# 923 "../test/evp_extra_test.c" 3 4
                                  ((void *)0)
# 923 "../test/evp_extra_test.c"
                                      ;
    BIGNUM *priv = 
# 924 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 924 "../test/evp_extra_test.c"
                      ;
    int ret = 0;
    unsigned char *encoded = 
# 926 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 926 "../test/evp_extra_test.c"
                                ;
    size_t len = 0;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 934, "priv = BN_bin2bn(ec_priv, sizeof(ec_priv), NULL)", priv = BN_bin2bn(ec_priv, sizeof(ec_priv), 
# 934 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 934 "../test/evp_extra_test.c"
        )))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 938, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 939, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, \"P-256\", 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", "P-256", 0)) != 0)

                                                                  )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 943, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 944, "just_params = make_key_fromdata(\"EC\", params)", just_params = make_key_fromdata("EC", params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 949 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 949 "../test/evp_extra_test.c"
                ;
    bld = 
# 950 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 950 "../test/evp_extra_test.c"
             ;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 957, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 958, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, \"P-256\", 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", "P-256", 0)) != 0)


        || !test_true("../test/evp_extra_test.c", 961, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 964, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 965, "params_and_priv = make_key_fromdata(\"EC\", params)", params_and_priv = make_key_fromdata("EC", params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 970 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 970 "../test/evp_extra_test.c"
                ;
    bld = 
# 971 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 971 "../test/evp_extra_test.c"
             ;
    ...
    if (!test_selection(params_and_priv, ( 0x04 | 0x80))
        || test_selection(params_and_priv, 0x02))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 984, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 985, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, \"P-256\", 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", "P-256", 0)) != 0)


        || !test_true("../test/evp_extra_test.c", 988, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_PUB_KEY, ec_pub, sizeof(ec_pub))", (OSSL_PARAM_BLD_push_octet_string(bld, "pub", ec_pub, sizeof(ec_pub))) != 0)

                                                                               )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 992, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 993, "params_and_pub = make_key_fromdata(\"EC\", params)", params_and_pub = make_key_fromdata("EC", params)))
        goto err;

    OSSL_PARAM_free(params);
    OSSL_PARAM_BLD_free(bld);
    params = 
# 998 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 998 "../test/evp_extra_test.c"
                ;
    bld = 
# 999 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 999 "../test/evp_extra_test.c"
             ;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 1006, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 1007, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, \"P-256\", 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", "P-256", 0)) != 0)


        || !test_true("../test/evp_extra_test.c", 1010, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_PUB_KEY, ec_pub, sizeof(ec_pub))", (OSSL_PARAM_BLD_push_octet_string(bld, "pub", ec_pub, sizeof(ec_pub))) != 0)


        || !test_true("../test/evp_extra_test.c", 1013, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 1016, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 1017, "params_and_keypair = make_key_fromdata(\"EC\", params)", params_and_keypair = make_key_fromdata("EC", params)))
        goto err;
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 1024, "EVP_PKEY_parameters_eq(just_params, just_params)", "0", EVP_PKEY_parameters_eq(just_params, just_params), 0)
        || !test_int_gt("../test/evp_extra_test.c", 1025, "EVP_PKEY_parameters_eq(just_params, params_and_pub)", "0", EVP_PKEY_parameters_eq(just_params, params_and_pub), 0)

        || !test_int_gt("../test/evp_extra_test.c", 1027, "EVP_PKEY_parameters_eq(just_params, params_and_priv)", "0", EVP_PKEY_parameters_eq(just_params, params_and_priv), 0)

        || !test_int_gt("../test/evp_extra_test.c", 1029, "EVP_PKEY_parameters_eq(just_params, params_and_keypair)", "0", EVP_PKEY_parameters_eq(just_params, params_and_keypair), 0)

        || !test_int_gt("../test/evp_extra_test.c", 1031, "EVP_PKEY_eq(params_and_pub, params_and_pub)", "0", EVP_PKEY_eq(params_and_pub, params_and_pub), 0)
        || !test_int_gt("../test/evp_extra_test.c", 1032, "EVP_PKEY_eq(params_and_priv, params_and_priv)", "0", EVP_PKEY_eq(params_and_priv, params_and_priv), 0)
        || !test_int_gt("../test/evp_extra_test.c", 1033, "EVP_PKEY_eq(params_and_keypair, params_and_pub)", "0", EVP_PKEY_eq(params_and_keypair, params_and_pub), 0)
        || !test_int_gt("../test/evp_extra_test.c", 1034, "EVP_PKEY_eq(params_and_keypair, params_and_priv)", "0", EVP_PKEY_eq(params_and_keypair, params_and_priv), 0))
        goto err;


    if (!test_int_gt("../test/evp_extra_test.c", 1038, "EVP_PKEY_get1_encoded_public_key(params_and_pub, &encoded)", "0", EVP_PKEY_get1_encoded_public_key(params_and_pub, &encoded), 0))
        goto err;
    CRYPTO_free(encoded, "../test/evp_extra_test.c", 1040);
    encoded = 
# 1041 "../test/evp_extra_test.c" 3 4
             ((void *)0)
# 1041 "../test/evp_extra_test.c"
                 ;
    if (!test_int_eq("../test/evp_extra_test.c", 1042, "EVP_PKEY_get1_encoded_public_key(just_params, &encoded)", "0", EVP_PKEY_get1_encoded_public_key(just_params, &encoded), 0)) {
        CRYPTO_free(encoded, "../test/evp_extra_test.c", 1043);
        encoded = 
# 1044 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 1044 "../test/evp_extra_test.c"
                     ;
        goto err;
    }


    if (!test_int_eq("../test/evp_extra_test.c", 1049, "EVP_PKEY_get_octet_string_param(params_and_pub, OSSL_PKEY_PARAM_ENCODED_PUBLIC_KEY, buffer, sizeof(buffer), &len)", "1", EVP_PKEY_get_octet_string_param(params_and_pub, "encoded-pub-key", buffer, sizeof(buffer), &len), 1)


        || !test_int_eq("../test/evp_extra_test.c", 1052, "len", "65", len, 65))
        goto err;

    len = 0;
    if (!test_int_eq("../test/evp_extra_test.c", 1056, "EVP_PKEY_get_octet_string_param(params_and_pub, OSSL_PKEY_PARAM_ENCODED_PUBLIC_KEY, NULL, 0, &len)", "1", EVP_PKEY_get_octet_string_param(params_and_pub, "encoded-pub-key", 
# 1056 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1056 "../test/evp_extra_test.c"
        , 0, &len), 1)


        || !test_int_eq("../test/evp_extra_test.c", 1059, "len", "65", len, 65))
        goto err;


    if (!test_int_eq("../test/evp_extra_test.c", 1063, "EVP_PKEY_get_octet_string_param(params_and_pub, OSSL_PKEY_PARAM_ENCODED_PUBLIC_KEY, buffer, 10, &len)", "0", EVP_PKEY_get_octet_string_param(params_and_pub, "encoded-pub-key", buffer, 10, &len), 0)
...
{
    OSSL_PARAM_BLD *bld = 
# 1084 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 1084 "../test/evp_extra_test.c"
                             ;
    OSSL_PARAM *params = 
# 1085 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1085 "../test/evp_extra_test.c"
                            ;
    unsigned char *pad = 
# 1086 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1086 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *keypair = 
# 1087 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1087 "../test/evp_extra_test.c"
                           ;
    BIGNUM *priv = 
# 1088 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1088 "../test/evp_extra_test.c"
                      ;
    BIGNUM *x = 
# 1089 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1089 "../test/evp_extra_test.c"
                   ;
    BIGNUM *y = 
# 1090 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1090 "../test/evp_extra_test.c"
                   ;
    int ret = 0;

    if (!test_ptr("../test/evp_extra_test.c", 1093, "priv = BN_bin2bn(ec_priv, sizeof(ec_priv), NULL)", priv = BN_bin2bn(ec_priv, sizeof(ec_priv), 
# 1093 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1093 "../test/evp_extra_test.c"
        )))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1096, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/evp_extra_test.c", 1097, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_GROUP_NAME, \"P-256\", 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "group", "P-256", 0)) != 0)


        || !test_true("../test/evp_extra_test.c", 1100, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_PUB_KEY, ec_pub, sizeof(ec_pub))", (OSSL_PARAM_BLD_push_octet_string(bld, "pub", ec_pub, sizeof(ec_pub))) != 0)


        || !test_true("../test/evp_extra_test.c", 1103, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1107, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/evp_extra_test.c", 1108, "keypair = make_key_fromdata(\"EC\", params)", keypair = make_key_fromdata("EC", params)))
        goto err;

    if (!test_selection(keypair, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 )))
        goto err;

    if (!EVP_PKEY_get_bn_param(keypair, "qx", &x)
        || !EVP_PKEY_get_bn_param(keypair, "qy", &y))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1118, "pad = OPENSSL_zalloc(sizeof(ec_pub))", pad = CRYPTO_zalloc(sizeof(ec_pub), "../test/evp_extra_test.c", 1118)))
        goto err;

    pad[0] = ec_pub[0];
    BN_bn2bin(x, &pad[1]);
    BN_bn2bin(y, &pad[33]);
    if (!test_true("../test/evp_extra_test.c", 1124, "memcmp(ec_pub, pad, sizeof(ec_pub)) == 0", (memcmp(ec_pub, pad, sizeof(ec_pub)) == 0) != 0))
        goto err;
...
err:
    ...
    CRYPTO_free(pad, "../test/evp_extra_test.c", 1133);
    BN_free(priv);
    BN_free(x);
    BN_free(y);
    return ret;
...
{
    BIGNUM *priv = 
# 1144 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1144 "../test/evp_extra_test.c"
                      ;
    int ret = 0;
    EC_KEY *eckey = 
# 1146 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1146 "../test/evp_extra_test.c"
                       ;
    EVP_PKEY *pkey = 
# 1147 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1147 "../test/evp_extra_test.c"
                        , *dup_pk = 
# 1147 "../test/evp_extra_test.c" 3 4
                                    ((void *)0)
# 1147 "../test/evp_extra_test.c"
                                        ;
    EVP_MD_CTX *ctx = 
# 1148 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 1148 "../test/evp_extra_test.c"
                         ;


    if (!test_ptr("../test/evp_extra_test.c", 1151, "priv = BN_bin2bn(ec_priv, sizeof(ec_priv), NULL)", priv = BN_bin2bn(ec_priv, sizeof(ec_priv), 
# 1151 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1151 "../test/evp_extra_test.c"
        )))
        goto err;

    eckey = EC_KEY_new_by_curve_name(415);
    if (!test_ptr("../test/evp_extra_test.c", 1155, "eckey", eckey))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 1158, "EC_KEY_set_private_key(eckey, priv)", (EC_KEY_set_private_key(eckey, priv)) != 0))
        goto err;

    pkey = EVP_PKEY_new();
    if (!test_ptr("../test/evp_extra_test.c", 1162, "pkey", pkey))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 1165, "EVP_PKEY_assign_EC_KEY(pkey, eckey)", (EVP_PKEY_assign((pkey), 408, (eckey))) != 0))
        goto err;
    eckey = 
# 1167 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1167 "../test/evp_extra_test.c"
               ;

    for (;;) {
        ret = 0;
        ctx = EVP_MD_CTX_new();
        if (!test_ptr("../test/evp_extra_test.c", 1172, "ctx", ctx))
            goto err;
        ...
        if (!test_true("../test/evp_extra_test.c", 1179, "EVP_DigestSignInit_ex(ctx, NULL, NULL, testctx, testpropq, pkey, NULL)", (EVP_DigestSignInit_ex(ctx, 
# 1179 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1179 "../test/evp_extra_test.c"
            , 
# 1179 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1179 "../test/evp_extra_test.c"
            , testctx, testpropq, pkey, 
# 1179 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1179 "../test/evp_extra_test.c"
            )) != 0)
        ...
        EVP_MD_CTX_free(ctx);
        ctx = 
# 1183 "../test/evp_extra_test.c" 3 4
             ((void *)0)
# 1183 "../test/evp_extra_test.c"
                 ;

        if (dup_pk != 
# 1185 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 1185 "../test/evp_extra_test.c"
                         )
            break;

        if (!test_ptr("../test/evp_extra_test.c", 1188, "dup_pk = EVP_PKEY_dup(pkey)", dup_pk = EVP_PKEY_dup(pkey)))
            goto err;

        ret = test_int_eq("../test/evp_extra_test.c", 1191, "EVP_PKEY_eq(pkey, dup_pk)", "-2", EVP_PKEY_eq(pkey, dup_pk), -2);
        EVP_PKEY_free(pkey);
        pkey = dup_pk;
        if (!ret)
            goto err;
...
{
    OSSL_LIB_CTX *libctx = 
# 1210 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 1210 "../test/evp_extra_test.c"
                              ;
    unsigned char *pad = 
# 1211 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1211 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *pkey = 
# 1212 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1212 "../test/evp_extra_test.c"
                        ;
    EC_KEY *eckey = 
# 1213 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1213 "../test/evp_extra_test.c"
                       ;
    BIGNUM *priv = 
# 1214 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1214 "../test/evp_extra_test.c"
                      ;
    BIGNUM *x = 
# 1215 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1215 "../test/evp_extra_test.c"
                   ;
    BIGNUM *y = 
# 1216 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1216 "../test/evp_extra_test.c"
                   ;
    int ret = 0;

    if (!test_ptr("../test/evp_extra_test.c", 1219, "libctx = OSSL_LIB_CTX_new()", libctx = OSSL_LIB_CTX_new()))
        goto err;


    if (!test_ptr("../test/evp_extra_test.c", 1223, "eckey = EC_KEY_new_by_curve_name_ex(libctx, NULL, NID_X9_62_prime256v1)", eckey = EC_KEY_new_by_curve_name_ex(libctx, 
# 1223 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1223 "../test/evp_extra_test.c"
        , 415))
                                                                            )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1227, "priv = BN_bin2bn(ec_priv, sizeof(ec_priv), NULL)", priv = BN_bin2bn(ec_priv, sizeof(ec_priv), 
# 1227 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1227 "../test/evp_extra_test.c"
        )))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 1230, "EC_KEY_set_private_key(eckey, priv)", (EC_KEY_set_private_key(eckey, priv)) != 0))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1233, "x = BN_bin2bn(&ec_pub[1], 32, NULL)", x = BN_bin2bn(&ec_pub[1], 32, 
# 1233 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1233 "../test/evp_extra_test.c"
        )))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1236, "y = BN_bin2bn(&ec_pub[33], 32, NULL)", y = BN_bin2bn(&ec_pub[33], 32, 
# 1236 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1236 "../test/evp_extra_test.c"
        )))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 1239, "EC_KEY_set_public_key_affine_coordinates(eckey, x, y)", (EC_KEY_set_public_key_affine_coordinates(eckey, x, y)) != 0))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1242, "pkey = EVP_PKEY_new()", pkey = EVP_PKEY_new()))
        goto err;


    if (!test_true("../test/evp_extra_test.c", 1246, "EVP_PKEY_assign_EC_KEY(pkey, eckey)", (EVP_PKEY_assign((pkey), 408, (eckey))) != 0))
        goto err;
    eckey = 
# 1248 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1248 "../test/evp_extra_test.c"
               ;

    if (!test_true("../test/evp_extra_test.c", 1250, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_EC_PUB_X, &x)", (EVP_PKEY_get_bn_param(pkey, "qx", &x)) != 0)
        || !test_true("../test/evp_extra_test.c", 1251, "EVP_PKEY_get_bn_param(pkey, OSSL_PKEY_PARAM_EC_PUB_Y, &y)", (EVP_PKEY_get_bn_param(pkey, "qy", &y)) != 0))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1254, "pad = OPENSSL_zalloc(sizeof(ec_pub))", pad = CRYPTO_zalloc(sizeof(ec_pub), "../test/evp_extra_test.c", 1254)))
        goto err;
    ...
    if (!test_true("../test/evp_extra_test.c", 1261, "memcmp(ec_pub, pad, sizeof(ec_pub)) == 0", (memcmp(ec_pub, pad, sizeof(ec_pub)) == 0) != 0))
        goto err;
...
err:
    ...
    EVP_PKEY_free(pkey);
    EC_KEY_free(eckey);
    CRYPTO_free(pad, "../test/evp_extra_test.c", 1270);
    BN_free(priv);
    BN_free(x);
    BN_free(y);
...
static int test_EVP_PKEY_sign(int tst)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 1283 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1283 "../test/evp_extra_test.c"
                        ;
    unsigned char *sig = 
# 1284 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1284 "../test/evp_extra_test.c"
                            ;
    size_t sig_len = 0, shortsig_len = 1;
    EVP_PKEY_CTX *ctx = 
# 1286 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1286 "../test/evp_extra_test.c"
                           ;
    unsigned char tbs[] = {
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
    ...
    if (tst == 0) {
        if (!test_ptr("../test/evp_extra_test.c", 1293, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key()))
            goto out;
    } else if (tst == 1) {

        if (!test_ptr("../test/evp_extra_test.c", 1297, "pkey = load_example_dsa_key()", pkey = load_example_dsa_key()))
            goto out;
        ...
        if (!test_ptr("../test/evp_extra_test.c", 1305, "pkey = load_example_ec_key()", pkey = load_example_ec_key()))
            goto out;
    ...
    ctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, 
# 1313 "../test/evp_extra_test.c" 3 4
                                                   ((void *)0)
# 1313 "../test/evp_extra_test.c"
                                                       );
    if (!test_ptr("../test/evp_extra_test.c", 1314, "ctx", ctx)
            || !test_int_gt("../test/evp_extra_test.c", 1315, "EVP_PKEY_sign_init(ctx)", "0", EVP_PKEY_sign_init(ctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1316, "EVP_PKEY_sign(ctx, NULL, &sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, 
# 1316 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1316 "../test/evp_extra_test.c"
               , &sig_len, tbs, sizeof(tbs)), 0)
                                                          )
        goto out;
    sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test.c", 1319);
    if (!test_ptr("../test/evp_extra_test.c", 1320, "sig", sig)

            || !test_int_le("../test/evp_extra_test.c", 1322, "EVP_PKEY_sign(ctx, sig, &shortsig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, sig, &shortsig_len, tbs, sizeof(tbs)), 0)

            || !test_int_gt("../test/evp_extra_test.c", 1324, "EVP_PKEY_sign(ctx, sig, &sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, sig, &sig_len, tbs, sizeof(tbs)), 0)


            || !test_int_gt("../test/evp_extra_test.c", 1327, "EVP_PKEY_verify_init(ctx)", "0", EVP_PKEY_verify_init(ctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1328, "EVP_PKEY_verify(ctx, sig, sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_verify(ctx, sig, sig_len, tbs, sizeof(tbs)), 0)
                              )
        goto out;
 ...
 out:
    ...
    CRYPTO_free(sig, "../test/evp_extra_test.c", 1335);
    EVP_PKEY_free(pkey);
    return ret;
}
...
static int test_EVP_PKEY_sign_with_app_method(int tst)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 1344 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1344 "../test/evp_extra_test.c"
                        ;
    RSA *rsa = 
# 1345 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 1345 "../test/evp_extra_test.c"
                  ;
    RSA_METHOD *rsa_meth = 
# 1346 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 1346 "../test/evp_extra_test.c"
                              ;

    DSA *dsa = 
# 1348 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 1348 "../test/evp_extra_test.c"
                  ;
    DSA_METHOD *dsa_meth = 
# 1349 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 1349 "../test/evp_extra_test.c"
                              ;

    unsigned char *sig = 
# 1351 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1351 "../test/evp_extra_test.c"
                            ;
    size_t sig_len = 0, shortsig_len = 1;
    EVP_PKEY_CTX *ctx = 
# 1353 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1353 "../test/evp_extra_test.c"
                           ;
    unsigned char tbs[] = {
        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
        0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13
    ...
    if (tst == 0) {
        if (!test_ptr("../test/evp_extra_test.c", 1360, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key()))
            goto out;
        if (!test_ptr("../test/evp_extra_test.c", 1362, "rsa_meth = RSA_meth_dup(RSA_get_default_method())", rsa_meth = RSA_meth_dup(RSA_get_default_method())))
            goto out;

        if (!test_ptr("../test/evp_extra_test.c", 1365, "rsa = EVP_PKEY_get1_RSA(pkey)", rsa = EVP_PKEY_get1_RSA(pkey))
            || !test_int_gt("../test/evp_extra_test.c", 1366, "RSA_set_method(rsa, rsa_meth)", "0", RSA_set_method(rsa, rsa_meth), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1367, "EVP_PKEY_assign_RSA(pkey, rsa)", "0", EVP_PKEY_assign((pkey),6, (rsa)), 0))
            goto out;
        rsa = 
# 1369 "../test/evp_extra_test.c" 3 4
             ((void *)0)
# 1369 "../test/evp_extra_test.c"
                 ;
    } else {

        if (!test_ptr("../test/evp_extra_test.c", 1372, "pkey = load_example_dsa_key()", pkey = load_example_dsa_key()))
                goto out;
        if (!test_ptr("../test/evp_extra_test.c", 1374, "dsa_meth = DSA_meth_dup(DSA_get_default_method())", dsa_meth = DSA_meth_dup(DSA_get_default_method())))
            goto out;

        if (!test_ptr("../test/evp_extra_test.c", 1377, "dsa = EVP_PKEY_get1_DSA(pkey)", dsa = EVP_PKEY_get1_DSA(pkey))
            || !test_int_gt("../test/evp_extra_test.c", 1378, "DSA_set_method(dsa, dsa_meth)", "0", DSA_set_method(dsa, dsa_meth), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1379, "EVP_PKEY_assign_DSA(pkey, dsa)", "0", EVP_PKEY_assign((pkey),116, (dsa)), 0))
            goto out;
        dsa = 
# 1381 "../test/evp_extra_test.c" 3 4
             ((void *)0)
# 1381 "../test/evp_extra_test.c"
                 ;
    ...
    ctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, 
# 1388 "../test/evp_extra_test.c" 3 4
                                                   ((void *)0)
# 1388 "../test/evp_extra_test.c"
                                                       );
    if (!test_ptr("../test/evp_extra_test.c", 1389, "ctx", ctx)
            || !test_int_gt("../test/evp_extra_test.c", 1390, "EVP_PKEY_sign_init(ctx)", "0", EVP_PKEY_sign_init(ctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1391, "EVP_PKEY_sign(ctx, NULL, &sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, 
# 1391 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1391 "../test/evp_extra_test.c"
               , &sig_len, tbs, sizeof(tbs)), 0)
                                                          )
        goto out;
    sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test.c", 1394);
    if (!test_ptr("../test/evp_extra_test.c", 1395, "sig", sig)

            || !test_int_le("../test/evp_extra_test.c", 1397, "EVP_PKEY_sign(ctx, sig, &shortsig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, sig, &shortsig_len, tbs, sizeof(tbs)), 0)

            || !test_int_gt("../test/evp_extra_test.c", 1399, "EVP_PKEY_sign(ctx, sig, &sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_sign(ctx, sig, &sig_len, tbs, sizeof(tbs)), 0)


            || !test_int_gt("../test/evp_extra_test.c", 1402, "EVP_PKEY_verify_init(ctx)", "0", EVP_PKEY_verify_init(ctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 1403, "EVP_PKEY_verify(ctx, sig, sig_len, tbs, sizeof(tbs))", "0", EVP_PKEY_verify(ctx, sig, sig_len, tbs, sizeof(tbs)), 0)
                              )
        goto out;
 ...
 out:
    EVP_PKEY_CTX_free(ctx);
    CRYPTO_free(sig, "../test/evp_extra_test.c", 1410);
    EVP_PKEY_free(pkey);
    RSA_free(rsa);
...
static int test_EVP_Enveloped(int n)
{
    int ret = 0;
    EVP_CIPHER_CTX *ctx = 
# 1429 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 1429 "../test/evp_extra_test.c"
                             ;
    EVP_PKEY *keypair = 
# 1430 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1430 "../test/evp_extra_test.c"
                           ;
    unsigned char *kek = 
# 1431 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1431 "../test/evp_extra_test.c"
                            ;
    unsigned char iv[16];
    ...
    EVP_CIPHER *type = 
# 1436 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 1436 "../test/evp_extra_test.c"
                          ;

    if (nullprov != 
# 1438 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1438 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 1439, "Test does not support a non-default library context");

    if (n == 0)
        type = (EVP_CIPHER *)EVP_aes_256_cbc();
    else if (!test_ptr("../test/evp_extra_test.c", 1443, "type = EVP_CIPHER_fetch(testctx, \"AES-256-CBC\", testpropq)", type = EVP_CIPHER_fetch(testctx, "AES-256-CBC", testpropq))
                                                          )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 1447, "keypair = load_example_rsa_key()", keypair = load_example_rsa_key())
            || !test_ptr("../test/evp_extra_test.c", 1448, "kek = OPENSSL_zalloc(EVP_PKEY_get_size(keypair))", kek = CRYPTO_zalloc(EVP_PKEY_get_size(keypair), "../test/evp_extra_test.c", 1448))
            || !test_ptr("../test/evp_extra_test.c", 1449, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_true("../test/evp_extra_test.c", 1450, "EVP_SealInit(ctx, type, &kek, &kek_len, iv, &keypair, 1)", (EVP_SealInit(ctx, type, &kek, &kek_len, iv, &keypair, 1)) != 0)

            || !test_true("../test/evp_extra_test.c", 1452, "EVP_SealUpdate(ctx, ciphertext, &ciphertext_len, msg, sizeof(msg))", (EVP_EncryptUpdate(ctx,ciphertext,&ciphertext_len,msg,sizeof(msg))) != 0)

            || !test_true("../test/evp_extra_test.c", 1454, "EVP_SealFinal(ctx, ciphertext + ciphertext_len, &len)", (EVP_SealFinal(ctx, ciphertext + ciphertext_len, &len)) != 0)
                                              )
        goto err;

    ciphertext_len += len;

    if (!test_true("../test/evp_extra_test.c", 1460, "EVP_OpenInit(ctx, type, kek, kek_len, iv, keypair)", (EVP_OpenInit(ctx, type, kek, kek_len, iv, keypair)) != 0)
            || !test_true("../test/evp_extra_test.c", 1461, "EVP_OpenUpdate(ctx, plaintext, &plaintext_len, ciphertext, ciphertext_len)", (EVP_DecryptUpdate(ctx,plaintext,&plaintext_len,ciphertext,ciphertext_len)) != 0)

            || !test_true("../test/evp_extra_test.c", 1463, "EVP_OpenFinal(ctx, plaintext + plaintext_len, &len)", (EVP_OpenFinal(ctx, plaintext + plaintext_len, &len)) != 0))
        goto err;

    plaintext_len += len;
    if (!test_mem_eq("../test/evp_extra_test.c", 1467, "msg", "plaintext", msg, sizeof(msg), plaintext, plaintext_len))
        goto err;
...
err:
    ...
    CRYPTO_free(kek, "../test/evp_extra_test.c", 1474);
    EVP_PKEY_free(keypair);
    EVP_CIPHER_CTX_free(ctx);
    return ret;
}
# 1498 "../test/evp_extra_test.c"
static int test_EVP_DigestSignInit(int tst)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 1501 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1501 "../test/evp_extra_test.c"
                        ;
    unsigned char *sig = 
# 1502 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1502 "../test/evp_extra_test.c"
                            , *sig2 = 
# 1502 "../test/evp_extra_test.c" 3 4
                                      ((void *)0)
# 1502 "../test/evp_extra_test.c"
    ...
    EVP_MD_CTX *md_ctx = 
# 1504 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1504 "../test/evp_extra_test.c"
                            , *md_ctx_verify = 
# 1504 "../test/evp_extra_test.c" 3 4
                                               ((void *)0)
# 1504 "../test/evp_extra_test.c"
                                                   ;
    EVP_MD_CTX *a_md_ctx = 
# 1505 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 1505 "../test/evp_extra_test.c"
                              , *a_md_ctx_verify = 
# 1505 "../test/evp_extra_test.c" 3 4
                                                   ((void *)0)
# 1505 "../test/evp_extra_test.c"
                                                       ;
    BIO *mdbio = 
# 1506 "../test/evp_extra_test.c" 3 4
                ((void *)0)
# 1506 "../test/evp_extra_test.c"
                    , *membio = 
# 1506 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 1506 "../test/evp_extra_test.c"
    ...
    const EVP_MD *md;
    EVP_MD *mdexp = 
# 1509 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1509 "../test/evp_extra_test.c"
                       ;
    int reinit = 0;

    if (nullprov != 
# 1512 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1512 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 1513, "Test does not support a non-default library context");
    ...
    if (tst >= 6 && tst <= 8) {
        ...
        if (!test_ptr("../test/evp_extra_test.c", 1523, "membio", membio) || !test_ptr("../test/evp_extra_test.c", 1523, "mdbio", mdbio))
            goto out;
        BIO_push(mdbio, membio);
        if (!test_int_gt("../test/evp_extra_test.c", 1526, "BIO_get_md_ctx(mdbio, &md_ctx)", "0", BIO_ctrl(mdbio,120,0,(&md_ctx)), 0))
            goto out;
    } else {
        if (!test_ptr("../test/evp_extra_test.c", 1529, "a_md_ctx = md_ctx = EVP_MD_CTX_new()", a_md_ctx = md_ctx = EVP_MD_CTX_new())
                || !test_ptr("../test/evp_extra_test.c", 1530, "a_md_ctx_verify = md_ctx_verify = EVP_MD_CTX_new()", a_md_ctx_verify = md_ctx_verify = EVP_MD_CTX_new()))
            goto out;
    }

    if (tst % 3 == 0) {
        if (!test_ptr("../test/evp_extra_test.c", 1535, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key()))
                goto out;
    } else if (tst % 3 == 1) {

        if (!test_ptr("../test/evp_extra_test.c", 1539, "pkey = load_example_dsa_key()", pkey = load_example_dsa_key()))
                goto out;
        ...
        if (!test_ptr("../test/evp_extra_test.c", 1546, "pkey = load_example_hmac_key()", pkey = load_example_hmac_key()))
                goto out;
    }

    if (tst >= 3 && tst <= 5)
        md = mdexp = EVP_MD_fetch(
# 1551 "../test/evp_extra_test.c" 3 4
                                 ((void *)0)
# 1551 "../test/evp_extra_test.c"
                                     , "SHA256", 
# 1551 "../test/evp_extra_test.c" 3 4
                                                 ((void *)0)
# 1551 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 1555, "EVP_DigestSignInit(md_ctx, NULL, md, NULL, pkey)", (EVP_DigestSignInit(md_ctx, 
# 1555 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1555 "../test/evp_extra_test.c"
        , md, 
# 1555 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1555 "../test/evp_extra_test.c"
    ...
    if (reinit && !test_true("../test/evp_extra_test.c", 1558, "EVP_DigestSignInit(md_ctx, NULL, NULL, NULL, NULL)", (EVP_DigestSignInit(md_ctx, 
# 1558 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1558 "../test/evp_extra_test.c"
                  , 
# 1558 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1558 "../test/evp_extra_test.c"
...
# 1558 "../test/evp_extra_test.c"
    ...
    if (tst >= 6 && tst <= 8) {
        ...
        if (!test_true("../test/evp_extra_test.c", 1565, "EVP_DigestSignUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestSignUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0))
            goto out;
    }

    if (tst >= 9) {

        if (!test_true("../test/evp_extra_test.c", 1571, "EVP_DigestSign(md_ctx, NULL, &sig_len, kMsg, sizeof(kMsg))", (EVP_DigestSign(md_ctx, 
# 1571 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1571 "../test/evp_extra_test.c"
            , &sig_len, kMsg, sizeof(kMsg))) != 0)

                || !test_ptr("../test/evp_extra_test.c", 1573, "sig = OPENSSL_malloc(sig_len)", sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test.c", 1573)))
            goto out;
        if (tst <= 11) {

            if (!test_false("../test/evp_extra_test.c", 1577, "EVP_DigestSign(md_ctx, sig, &shortsig_len, kMsg, sizeof(kMsg))", (EVP_DigestSign(md_ctx, sig, &shortsig_len, kMsg, sizeof(kMsg))) != 0)
                                                         )
                goto out;
        ...
        if (!test_true("../test/evp_extra_test.c", 1587, "EVP_DigestSign(md_ctx, sig, &sig_len, kMsg, sizeof(kMsg))", (EVP_DigestSign(md_ctx, sig, &sig_len, kMsg, sizeof(kMsg))) != 0)
                                                    )
            goto out;
    } else {

        if (!test_true("../test/evp_extra_test.c", 1592, "EVP_DigestSignFinal(md_ctx, NULL, &sig_len)", (EVP_DigestSignFinal(md_ctx, 
# 1592 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1592 "../test/evp_extra_test.c"
            , &sig_len)) != 0)
                || !test_ptr("../test/evp_extra_test.c", 1593, "sig = OPENSSL_malloc(sig_len)", sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test.c", 1593))




                || !test_false("../test/evp_extra_test.c", 1598, "EVP_DigestSignFinal(md_ctx, sig, &shortsig_len)", (EVP_DigestSignFinal(md_ctx, sig, &shortsig_len)) != 0)
                || !test_true("../test/evp_extra_test.c", 1599, "EVP_DigestSignFinal(md_ctx, sig, &sig_len)", (EVP_DigestSignFinal(md_ctx, sig, &sig_len)) != 0))
            goto out;
    }
    ...
    if (tst % 3 != 2) {
        if (tst >= 6 && tst <= 8) {
            if (!test_int_gt("../test/evp_extra_test.c", 1609, "BIO_reset(mdbio)", "0", (int)BIO_ctrl(mdbio,1,0,
# 1609 "../test/evp_extra_test.c" 3 4
                ((void *)0)
# 1609 "../test/evp_extra_test.c"
                ), 0)
                || !test_int_gt("../test/evp_extra_test.c", 1610, "BIO_get_md_ctx(mdbio, &md_ctx_verify)", "0", BIO_ctrl(mdbio,120,0,(&md_ctx_verify)), 0))
                goto out;
        }

        if (!test_true("../test/evp_extra_test.c", 1614, "EVP_DigestVerifyInit(md_ctx_verify, NULL, md, NULL, pkey)", (EVP_DigestVerifyInit(md_ctx_verify, 
# 1614 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1614 "../test/evp_extra_test.c"
            , md, 
# 1614 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1614 "../test/evp_extra_test.c"
        ...
        if (tst >= 6 && tst <= 8) {
            if (!test_true("../test/evp_extra_test.c", 1619, "BIO_write_ex(mdbio, kMsg, sizeof(kMsg), &written)", (BIO_write_ex(mdbio, kMsg, sizeof(kMsg), &written)) != 0))
                goto out;
        } else {
            if (!test_true("../test/evp_extra_test.c", 1622, "EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))", (EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))) != 0)
                                                                )
                goto out;
        }
        if (!test_int_gt("../test/evp_extra_test.c", 1626, "EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len)", "0", EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len), 0))
            goto out;


        if (!test_int_gt("../test/evp_extra_test.c", 1630, "EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len)", "0", EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len), 0))
            goto out;
    } else {
        ...
        if (!test_true("../test/evp_extra_test.c", 1637, "EVP_DigestSignFinal(md_ctx, NULL, &sig2_len)", (EVP_DigestSignFinal(md_ctx, 
# 1637 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 1637 "../test/evp_extra_test.c"
            , &sig2_len)) != 0)
            || !test_ptr("../test/evp_extra_test.c", 1638, "sig2 = OPENSSL_malloc(sig2_len)", sig2 = CRYPTO_malloc(sig2_len, "../test/evp_extra_test.c", 1638))
            || !test_true("../test/evp_extra_test.c", 1639, "EVP_DigestSignFinal(md_ctx, sig2, &sig2_len)", (EVP_DigestSignFinal(md_ctx, sig2, &sig2_len)) != 0))
            goto out;

        if (!test_mem_eq("../test/evp_extra_test.c", 1642, "sig", "sig2", sig, sig_len, sig2, sig2_len))
            goto out;
    }
 ...
 out:
    ...
    EVP_PKEY_free(pkey);
    CRYPTO_free(sig, "../test/evp_extra_test.c", 1654);
    CRYPTO_free(sig2, "../test/evp_extra_test.c", 1655);
    EVP_MD_free(mdexp);
...
static int test_EVP_DigestVerifyInit(void)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 1664 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1664 "../test/evp_extra_test.c"
                        ;
    EVP_MD_CTX *md_ctx = 
# 1665 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1665 "../test/evp_extra_test.c"
                            ;

    if (nullprov != 
# 1667 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1667 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 1668, "Test does not support a non-default library context");

    if (!test_ptr("../test/evp_extra_test.c", 1670, "md_ctx = EVP_MD_CTX_new()", md_ctx = EVP_MD_CTX_new())
            || !test_ptr("../test/evp_extra_test.c", 1671, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key()))
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1674, "EVP_DigestVerifyInit(md_ctx, NULL, EVP_sha256(), NULL, pkey)", (EVP_DigestVerifyInit(md_ctx, 
# 1674 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1674 "../test/evp_extra_test.c"
        , EVP_sha256(), 
# 1674 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1674 "../test/evp_extra_test.c"
        , pkey)) != 0)
            || !test_true("../test/evp_extra_test.c", 1675, "EVP_DigestVerifyUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestVerifyUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0)
            || !test_int_gt("../test/evp_extra_test.c", 1676, "EVP_DigestVerifyFinal(md_ctx, kSignature, sizeof(kSignature))", "0", EVP_DigestVerifyFinal(md_ctx, kSignature, sizeof(kSignature)), 0)
                                                                        )
        goto out;


    if (!test_true("../test/evp_extra_test.c", 1681, "EVP_DigestVerifyInit(md_ctx, NULL, NULL, NULL, NULL)", (EVP_DigestVerifyInit(md_ctx, 
# 1681 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1681 "../test/evp_extra_test.c"
        , 
# 1681 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1681 "../test/evp_extra_test.c"
...
# 1681 "../test/evp_extra_test.c"
            ...
            || !test_true("../test/evp_extra_test.c", 1682, "EVP_DigestVerifyUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestVerifyUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0)
            || !test_int_gt("../test/evp_extra_test.c", 1683, "EVP_DigestVerifyFinal(md_ctx, kSignature, sizeof(kSignature))", "0", EVP_DigestVerifyFinal(md_ctx, kSignature, sizeof(kSignature)), 0)
                                                                        )
        goto out;
    ret = 1;
...
static int test_siphash_digestsign(void)
{
    ...
    EVP_PKEY *pkey = 
# 1703 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1703 "../test/evp_extra_test.c"
                        ;
    EVP_MD_CTX *mdctx = 
# 1704 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1704 "../test/evp_extra_test.c"
                           ;
    EVP_PKEY_CTX *ctx = 
# 1705 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 1705 "../test/evp_extra_test.c"
                           ;
    int ret = 0;
    size_t len = 8;

    if (nullprov != 
# 1709 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1709 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 1710, "Test does not support a non-default library context");

    memset(buf, 0, 8);
    memset(key, 1, 16);
    if (!test_ptr("../test/evp_extra_test.c", 1714, "pkey = EVP_PKEY_new_raw_private_key(EVP_PKEY_SIPHASH, NULL, key, 16)", pkey = EVP_PKEY_new_raw_private_key(1062, 
# 1714 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1714 "../test/evp_extra_test.c"
        , key, 16))
                                                               )
        goto out;

    if (!test_ptr("../test/evp_extra_test.c", 1718, "mdctx = EVP_MD_CTX_create()", mdctx = EVP_MD_CTX_new()))
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1721, "EVP_DigestSignInit(mdctx, &ctx, NULL, NULL, pkey)", (EVP_DigestSignInit(mdctx, &ctx, 
# 1721 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1721 "../test/evp_extra_test.c"
        , 
# 1721 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1721 "../test/evp_extra_test.c"
        , pkey)) != 0))
        goto out;
    if (!test_int_eq("../test/evp_extra_test.c", 1723, "EVP_PKEY_CTX_ctrl(ctx, -1, EVP_PKEY_OP_SIGNCTX, EVP_PKEY_CTRL_SET_DIGEST_SIZE, 8, NULL)", "1", EVP_PKEY_CTX_ctrl(ctx, -1, (1<<7), 14, 8, 
# 1723 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1723 "../test/evp_extra_test.c"
        ), 1)

                                                   )
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1728, "EVP_DigestSignInit(mdctx, NULL, NULL, NULL, NULL)", (EVP_DigestSignInit(mdctx, 
# 1728 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1728 "../test/evp_extra_test.c"
        , 
# 1728 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1728 "../test/evp_extra_test.c"
...
# 1728 "../test/evp_extra_test.c"
        ...
        goto out;
    if (!test_true("../test/evp_extra_test.c", 1730, "EVP_DigestSignUpdate(mdctx, buf, 8)", (EVP_DigestSignUpdate(mdctx, buf, 8)) != 0))
        goto out;
    if (!test_true("../test/evp_extra_test.c", 1732, "EVP_DigestSignFinal(mdctx, digest, &len)", (EVP_DigestSignFinal(mdctx, digest, &len)) != 0))
        goto out;
    if (!test_mem_eq("../test/evp_extra_test.c", 1734, "digest", "expected", digest, len, expected, sizeof(expected)))
        goto out;
...
static int test_EVP_Digest(void)
{
    int ret = 0;
    EVP_MD_CTX *md_ctx = 
# 1751 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1751 "../test/evp_extra_test.c"
                            ;
    unsigned char md[64];
    EVP_MD *sha256 = 
# 1753 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1753 "../test/evp_extra_test.c"
                        ;
    EVP_MD *shake256 = 
# 1754 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 1754 "../test/evp_extra_test.c"
                          ;

    if (!test_ptr("../test/evp_extra_test.c", 1756, "md_ctx = EVP_MD_CTX_new()", md_ctx = EVP_MD_CTX_new()))
        goto out;

    if (!test_ptr("../test/evp_extra_test.c", 1759, "sha256 = EVP_MD_fetch(testctx, \"sha256\", testpropq)", sha256 = EVP_MD_fetch(testctx, "sha256", testpropq))
            || !test_ptr("../test/evp_extra_test.c", 1760, "shake256 = EVP_MD_fetch(testctx, \"shake256\", testpropq)", shake256 = EVP_MD_fetch(testctx, "shake256", testpropq)))
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1763, "EVP_DigestInit_ex(md_ctx, sha256, NULL)", (EVP_DigestInit_ex(md_ctx, sha256, 
# 1763 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1763 "../test/evp_extra_test.c"
        )) != 0)
            || !test_true("../test/evp_extra_test.c", 1764, "EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0)
            || !test_true("../test/evp_extra_test.c", 1765, "EVP_DigestFinal(md_ctx, md, NULL)", (EVP_DigestFinal(md_ctx, md, 
# 1765 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1765 "../test/evp_extra_test.c"
               )) != 0)

            || !test_ptr_eq("../test/evp_extra_test.c", 1767, "EVP_MD_CTX_get0_md(md_ctx)", "NULL", EVP_MD_CTX_get0_md(md_ctx), 
# 1767 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1767 "../test/evp_extra_test.c"
               ))
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1770, "EVP_DigestInit_ex(md_ctx, sha256, NULL)", (EVP_DigestInit_ex(md_ctx, sha256, 
# 1770 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1770 "../test/evp_extra_test.c"
        )) != 0)
            || !test_true("../test/evp_extra_test.c", 1771, "EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0)
            || !test_true("../test/evp_extra_test.c", 1772, "EVP_DigestFinal_ex(md_ctx, md, NULL)", (EVP_DigestFinal_ex(md_ctx, md, 
# 1772 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1772 "../test/evp_extra_test.c"
               )) != 0)

            || !test_ptr("../test/evp_extra_test.c", 1774, "EVP_MD_CTX_get0_md(md_ctx)", EVP_MD_CTX_get0_md(md_ctx))




            || !test_true("../test/evp_extra_test.c", 1779, "EVP_DigestInit_ex(md_ctx, NULL, NULL)", (EVP_DigestInit_ex(md_ctx, 
# 1779 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1779 "../test/evp_extra_test.c"
               , 
# 1779 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1779 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 1782, "EVP_DigestInit_ex(md_ctx, shake256, NULL)", (EVP_DigestInit_ex(md_ctx, shake256, 
# 1782 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1782 "../test/evp_extra_test.c"
        )) != 0)
            || !test_true("../test/evp_extra_test.c", 1783, "EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0)
            || !test_true("../test/evp_extra_test.c", 1784, "EVP_DigestFinalXOF(md_ctx, md, sizeof(md))", (EVP_DigestFinalXOF(md_ctx, md, sizeof(md))) != 0)

            || !test_ptr("../test/evp_extra_test.c", 1786, "EVP_MD_CTX_get0_md(md_ctx)", EVP_MD_CTX_get0_md(md_ctx))
            || !test_true("../test/evp_extra_test.c", 1787, "EVP_DigestInit_ex(md_ctx, NULL, NULL)", (EVP_DigestInit_ex(md_ctx, 
# 1787 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1787 "../test/evp_extra_test.c"
               , 
# 1787 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 1787 "../test/evp_extra_test.c"
...
static int test_EVP_md_null(void)
{
    int ret = 0;
    EVP_MD_CTX *md_ctx = 
# 1801 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 1801 "../test/evp_extra_test.c"
                            ;
    ...
    if (nullprov != 
# 1806 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 1806 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 1807, "Test does not support a non-default library context");

    if (!test_ptr("../test/evp_extra_test.c", 1809, "md_null", md_null)
        || !test_ptr("../test/evp_extra_test.c", 1810, "md_ctx = EVP_MD_CTX_new()", md_ctx = EVP_MD_CTX_new()))
        goto out;

    if (!test_true("../test/evp_extra_test.c", 1813, "EVP_DigestInit_ex(md_ctx, md_null, NULL)", (EVP_DigestInit_ex(md_ctx, md_null, 
# 1813 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1813 "../test/evp_extra_test.c"
        )) != 0)
        || !test_true("../test/evp_extra_test.c", 1814, "EVP_DigestUpdate(md_ctx, \"test\", 4)", (EVP_DigestUpdate(md_ctx, "test", 4)) != 0)
        || !test_true("../test/evp_extra_test.c", 1815, "EVP_DigestFinal_ex(md_ctx, md_value, &md_len)", (EVP_DigestFinal_ex(md_ctx, md_value, &md_len)) != 0))
        goto out;

    if (!test_uint_eq("../test/evp_extra_test.c", 1818, "md_len", "0", md_len, 0))
        goto out;
...
static int test_d2i_AutoPrivateKey(int i)
{
    ...
    EVP_PKEY *pkey = 
# 1831 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1831 "../test/evp_extra_test.c"
                        ;
    ...
    p = input;
    if (!test_ptr("../test/evp_extra_test.c", 1838, "pkey = d2i_AutoPrivateKey(NULL, &p, input_len)", pkey = d2i_AutoPrivateKey(
# 1838 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1838 "../test/evp_extra_test.c"
        , &p, input_len))
            || !test_ptr_eq("../test/evp_extra_test.c", 1839, "p", "input + input_len", p, input + input_len)
            || !test_int_eq("../test/evp_extra_test.c", 1840, "EVP_PKEY_get_id(pkey)", "expected_id", EVP_PKEY_get_id(pkey), expected_id))
        goto done;
...
static int test_invalide_ec_char2_pub_range_decode(int id)
{
    ...
    ret = (ec_der_pub_keys[id].valid && test_ptr("../test/evp_extra_test.c", 1901, "pkey", pkey))
          || test_ptr_null("../test/evp_extra_test.c", 1902, "pkey", pkey);
    EVP_PKEY_free(pkey);
    return ret;
}
...
static int test_EVP_PKCS82PKEY(void)
{
    ...
    PKCS8_PRIV_KEY_INFO *p8inf = 
# 1912 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 1912 "../test/evp_extra_test.c"
                                    ;
    EVP_PKEY *pkey = 
# 1913 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1913 "../test/evp_extra_test.c"
                        ;

    if (!test_ptr("../test/evp_extra_test.c", 1915, "p8inf = d2i_PKCS8_PRIV_KEY_INFO(NULL, &derp, sizeof(kExampleBadECKeyDER))", p8inf = d2i_PKCS8_PRIV_KEY_INFO(
# 1915 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 1915 "../test/evp_extra_test.c"
        , &derp, sizeof(kExampleBadECKeyDER)))
                                                                           )
        goto done;

    if (!test_ptr_eq("../test/evp_extra_test.c", 1919, "derp", "kExampleBadECKeyDER + sizeof(kExampleBadECKeyDER)", derp, kExampleBadECKeyDER + sizeof(kExampleBadECKeyDER))
                                                                       )
        goto done;

    if (!test_ptr_null("../test/evp_extra_test.c", 1923, "pkey = EVP_PKCS82PKEY(p8inf)", pkey = EVP_PKCS82PKEY(p8inf)))
        goto done;
...
{
    EVP_PKEY *pkey = 
# 1938 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1938 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY *pkey2 = 
# 1939 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 1939 "../test/evp_extra_test.c"
                         ;
    BIO *membio = 
# 1940 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 1940 "../test/evp_extra_test.c"
                     ;
    char *membuf = 
# 1941 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1941 "../test/evp_extra_test.c"
                      ;
    PKCS8_PRIV_KEY_INFO *p8inf = 
# 1942 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 1942 "../test/evp_extra_test.c"
                                    ;
    int ok = 0;

    if (testctx != 
# 1945 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1945 "../test/evp_extra_test.c"
                      )

        return 1;

    if (!test_ptr("../test/evp_extra_test.c", 1949, "membio = BIO_new(BIO_s_mem())", membio = BIO_new(BIO_s_mem()))
        || !test_ptr("../test/evp_extra_test.c", 1950, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key())
        || !test_int_gt("../test/evp_extra_test.c", 1951, "i2d_PKCS8PrivateKey_bio(membio, pkey, NULL, NULL, 0, NULL, NULL)", "0", i2d_PKCS8PrivateKey_bio(membio, pkey, 
# 1951 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1951 "../test/evp_extra_test.c"
           , 
# 1951 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1951 "../test/evp_extra_test.c"
...
# 1951 "../test/evp_extra_test.c"
        ...
        || !test_int_gt("../test/evp_extra_test.c", 1954, "BIO_get_mem_data(membio, &membuf)", "0", BIO_ctrl(membio,3,0,(char *)(&membuf)), 0)
        || !test_ptr("../test/evp_extra_test.c", 1955, "p8inf = d2i_PKCS8_PRIV_KEY_INFO_bio(membio, NULL)", p8inf = d2i_PKCS8_PRIV_KEY_INFO_bio(membio, 
# 1955 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1955 "../test/evp_extra_test.c"
           ))
        || !test_ptr("../test/evp_extra_test.c", 1956, "pkey2 = EVP_PKCS82PKEY(p8inf)", pkey2 = EVP_PKCS82PKEY(p8inf))
        || !test_int_eq("../test/evp_extra_test.c", 1957, "ERR_peek_last_error()", "0", ERR_peek_last_error(), 0)) {
        goto done;
    }
...
{
    EVP_PKEY *pkey = 
# 1973 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 1973 "../test/evp_extra_test.c"
                        ;
    BIO *membio = 
# 1974 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 1974 "../test/evp_extra_test.c"
                     ;
    char *membuf = 
# 1975 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 1975 "../test/evp_extra_test.c"
                      ;
    long membuf_len = 0;
    int ok = 0;

    if (!test_ptr("../test/evp_extra_test.c", 1979, "membio = BIO_new(BIO_s_mem())", membio = BIO_new(BIO_s_mem()))
        || !test_ptr("../test/evp_extra_test.c", 1980, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key())
        || !test_int_gt("../test/evp_extra_test.c", 1981, "i2d_PKCS8PrivateKey_bio(membio, pkey, NULL, NULL, 0, NULL, NULL)", "0", i2d_PKCS8PrivateKey_bio(membio, pkey, 
# 1981 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1981 "../test/evp_extra_test.c"
           , 
# 1981 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1981 "../test/evp_extra_test.c"
...
# 1981 "../test/evp_extra_test.c"
        ...
        || !test_int_gt("../test/evp_extra_test.c", 1984, "membuf_len = BIO_get_mem_data(membio, &membuf)", "0", membuf_len = BIO_ctrl(membio,3,0,(char *)(&membuf)), 0)
        || !test_ptr("../test/evp_extra_test.c", 1985, "membuf", membuf)
        || !test_mem_eq("../test/evp_extra_test.c", 1986, "membuf", "kExampleRSAKeyPKCS8", membuf, (size_t)membuf_len, kExampleRSAKeyPKCS8, sizeof(kExampleRSAKeyPKCS8))





        || !test_int_gt("../test/evp_extra_test.c", 1992, "PEM_write_bio_PKCS8PrivateKey(membio, pkey, NULL, NULL, 0, NULL, NULL)", "0", PEM_write_bio_PKCS8PrivateKey(membio, pkey, 
# 1992 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1992 "../test/evp_extra_test.c"
           , 
# 1992 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 1992 "../test/evp_extra_test.c"
...
static int ec_export_get_encoding_cb(const OSSL_PARAM params[], void *arg)
{
    const OSSL_PARAM *p;
    const char *enc_name = 
# 2016 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 2016 "../test/evp_extra_test.c"
                              ;
    int *enc = arg;
    size_t i;
    ...
    *enc = -1;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2022, "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_EC_ENCODING)", p = OSSL_PARAM_locate_const(params, "encoding"))

        || !test_true("../test/evp_extra_test.c", 2024, "OSSL_PARAM_get_utf8_string_ptr(p, &enc_name)", (OSSL_PARAM_get_utf8_string_ptr(p, &enc_name)) != 0))
        return 0;

    for (i = 0; i < (sizeof(ec_encodings)/sizeof((ec_encodings)[0])); i++) {
...
{
    EVP_PKEY *params = 
# 2039 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 2039 "../test/evp_extra_test.c"
                          , *key = 
# 2039 "../test/evp_extra_test.c" 3 4
                                   ((void *)0)
# 2039 "../test/evp_extra_test.c"
                                       ;
    EVP_PKEY_CTX *pctx = 
# 2040 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2040 "../test/evp_extra_test.c"
                            , *kctx = 
# 2040 "../test/evp_extra_test.c" 3 4
                                      ((void *)0)
# 2040 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2047, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"EC\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "EC", 
# 2047 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2047 "../test/evp_extra_test.c"
        ))
        || !test_int_gt("../test/evp_extra_test.c", 2048, "EVP_PKEY_paramgen_init(pctx)", "0", EVP_PKEY_paramgen_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 2049, "EVP_PKEY_CTX_set_group_name(pctx, \"P-256\")", "0", EVP_PKEY_CTX_set_group_name(pctx, "P-256"), 0)
        || !test_int_gt("../test/evp_extra_test.c", 2050, "EVP_PKEY_CTX_set_ec_param_enc(pctx, enc)", "0", EVP_PKEY_CTX_set_ec_param_enc(pctx, enc), 0)
        || !test_true("../test/evp_extra_test.c", 2051, "EVP_PKEY_paramgen(pctx, &params)", (EVP_PKEY_paramgen(pctx, &params)) != 0)
        || !test_ptr("../test/evp_extra_test.c", 2052, "params", params))
        goto done;


    if (!test_ptr("../test/evp_extra_test.c", 2056, "kctx = EVP_PKEY_CTX_new_from_pkey(testctx, params, NULL)", kctx = EVP_PKEY_CTX_new_from_pkey(testctx, params, 
# 2056 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2056 "../test/evp_extra_test.c"
        ))
        || !test_int_gt("../test/evp_extra_test.c", 2057, "EVP_PKEY_keygen_init(kctx)", "0", EVP_PKEY_keygen_init(kctx), 0)
        || !test_true("../test/evp_extra_test.c", 2058, "EVP_PKEY_keygen(kctx, &key)", (EVP_PKEY_keygen(kctx, &key)) != 0)
        || !test_ptr("../test/evp_extra_test.c", 2059, "key", key))
        goto done;


    if (!test_true("../test/evp_extra_test.c", 2063, "evp_keymgmt_util_export(key, OSSL_KEYMGMT_SELECT_ALL, ec_export_get_encoding_cb, &enc)", (evp_keymgmt_util_export(key, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ), ec_export_get_encoding_cb, &enc)) != 0)

        || !test_int_eq("../test/evp_extra_test.c", 2065, "enc", "ec_encodings[idx].encoding", enc, ec_encodings[idx].encoding))
        goto done;
...
static int test_EVP_SM2_verify(void)
{
    ...
    int rc = 0;
    BIO *bio = 
# 2102 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 2102 "../test/evp_extra_test.c"
                  ;
    EVP_PKEY *pkey = 
# 2103 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 2103 "../test/evp_extra_test.c"
                        ;
    EVP_MD_CTX *mctx = 
# 2104 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 2104 "../test/evp_extra_test.c"
                          ;
    EVP_PKEY_CTX *pctx = 
# 2105 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2105 "../test/evp_extra_test.c"
                            ;
    EVP_MD *sm3 = 
# 2106 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 2106 "../test/evp_extra_test.c"
                     ;

    bio = BIO_new_mem_buf(pubkey, strlen(pubkey));
    if (!test_true("../test/evp_extra_test.c", 2109, "bio != NULL", (bio != 
# 2109 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2109 "../test/evp_extra_test.c"
        ) != 0))
        goto done;

    pkey = PEM_read_bio_PUBKEY_ex(bio, 
# 2112 "../test/evp_extra_test.c" 3 4
                                      ((void *)0)
# 2112 "../test/evp_extra_test.c"
                                          , 
# 2112 "../test/evp_extra_test.c" 3 4
                                            ((void *)0)
# 2112 "../test/evp_extra_test.c"
...
# 2112 "../test/evp_extra_test.c"
                                                      , testctx, testpropq);
    if (!test_true("../test/evp_extra_test.c", 2113, "pkey != NULL", (pkey != 
# 2113 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2113 "../test/evp_extra_test.c"
        ) != 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2116, "EVP_PKEY_is_a(pkey, \"SM2\")", (EVP_PKEY_is_a(pkey, "SM2")) != 0))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2119, "mctx = EVP_MD_CTX_new()", mctx = EVP_MD_CTX_new()))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2122, "pctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)", pctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)))
        goto done;

    EVP_MD_CTX_set_pkey_ctx(mctx, pctx);

    if (!test_ptr("../test/evp_extra_test.c", 2127, "sm3 = EVP_MD_fetch(testctx, \"sm3\", testpropq)", sm3 = EVP_MD_fetch(testctx, "sm3", testpropq)))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2130, "EVP_DigestVerifyInit(mctx, NULL, sm3, NULL, pkey)", (EVP_DigestVerifyInit(mctx, 
# 2130 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2130 "../test/evp_extra_test.c"
        , sm3, 
# 2130 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2130 "../test/evp_extra_test.c"
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 2133, "EVP_PKEY_CTX_set1_id(pctx, id, strlen(id))", "0", EVP_PKEY_CTX_set1_id(pctx, id, strlen(id)), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2136, "EVP_DigestVerifyUpdate(mctx, msg, strlen(msg))", (EVP_DigestVerifyUpdate(mctx, msg, strlen(msg))) != 0))
        goto done;

    if (!test_int_gt("../test/evp_extra_test.c", 2139, "EVP_DigestVerifyFinal(mctx, signature, sizeof(signature))", "0", EVP_DigestVerifyFinal(mctx, signature, sizeof(signature)), 0))
        goto done;
    rc = 1;
...
static int test_EVP_SM2(void)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 2155 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 2155 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY *pkeyparams = 
# 2156 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 2156 "../test/evp_extra_test.c"
                              ;
    EVP_PKEY_CTX *pctx = 
# 2157 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2157 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY_CTX *kctx = 
# 2158 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2158 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY_CTX *sctx = 
# 2159 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2159 "../test/evp_extra_test.c"
                            ;
    size_t sig_len = 0;
    unsigned char *sig = 
# 2161 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2161 "../test/evp_extra_test.c"
                            ;
    EVP_MD_CTX *md_ctx = 
# 2162 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2162 "../test/evp_extra_test.c"
                            ;
    EVP_MD_CTX *md_ctx_verify = 
# 2163 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 2163 "../test/evp_extra_test.c"
                                   ;
    EVP_PKEY_CTX *cctx = 
# 2164 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2164 "../test/evp_extra_test.c"
                            ;
    EVP_MD *check_md = 
# 2165 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 2165 "../test/evp_extra_test.c"
                          ;
...
# 2175 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 2175 "../test/evp_extra_test.c"
                            , 0, 
# 2175 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 2175 "../test/evp_extra_test.c"
...
# 2176 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 2176 "../test/evp_extra_test.c"
                            , 0, 
# 2176 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 2176 "../test/evp_extra_test.c"
...
# 2176 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2180, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"SM2\", testpropq)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "SM2", testpropq))
                                                                      )
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2184, "EVP_PKEY_paramgen_init(pctx) == 1", (EVP_PKEY_paramgen_init(pctx) == 1) != 0))
        goto done;

    if (!test_int_gt("../test/evp_extra_test.c", 2187, "EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, NID_sm2)", "0", EVP_PKEY_CTX_set_ec_paramgen_curve_nid(pctx, 1172), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2190, "EVP_PKEY_paramgen(pctx, &pkeyparams)", (EVP_PKEY_paramgen(pctx, &pkeyparams)) != 0))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2193, "kctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkeyparams, testpropq)", kctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkeyparams, testpropq))
                                                                           )
        goto done;

    if (!test_int_gt("../test/evp_extra_test.c", 2197, "EVP_PKEY_keygen_init(kctx)", "0", EVP_PKEY_keygen_init(kctx), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2200, "EVP_PKEY_keygen(kctx, &pkey)", (EVP_PKEY_keygen(kctx, &pkey)) != 0))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2203, "md_ctx = EVP_MD_CTX_new()", md_ctx = EVP_MD_CTX_new()))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2206, "md_ctx_verify = EVP_MD_CTX_new()", md_ctx_verify = EVP_MD_CTX_new()))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2209, "sctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)", sctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)))
        goto done;

    EVP_MD_CTX_set_pkey_ctx(md_ctx, sctx);
    EVP_MD_CTX_set_pkey_ctx(md_ctx_verify, sctx);

    if (!test_ptr("../test/evp_extra_test.c", 2215, "check_md = EVP_MD_fetch(testctx, \"sm3\", testpropq)", check_md = EVP_MD_fetch(testctx, "sm3", testpropq)))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2218, "EVP_DigestSignInit(md_ctx, NULL, check_md, NULL, pkey)", (EVP_DigestSignInit(md_ctx, 
# 2218 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2218 "../test/evp_extra_test.c"
        , check_md, 
# 2218 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2218 "../test/evp_extra_test.c"
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 2221, "EVP_PKEY_CTX_set1_id(sctx, sm2_id, sizeof(sm2_id))", "0", EVP_PKEY_CTX_set1_id(sctx, sm2_id, sizeof(sm2_id)), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2224, "EVP_DigestSignUpdate(md_ctx, kMsg, sizeof(kMsg))", (EVP_DigestSignUpdate(md_ctx, kMsg, sizeof(kMsg))) != 0))
        goto done;


    if (!test_true("../test/evp_extra_test.c", 2228, "EVP_DigestSignFinal(md_ctx, NULL, &sig_len)", (EVP_DigestSignFinal(md_ctx, 
# 2228 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2228 "../test/evp_extra_test.c"
        , &sig_len)) != 0))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2231, "sig = OPENSSL_malloc(sig_len)", sig = CRYPTO_malloc(sig_len, "../test/evp_extra_test.c", 2231)))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2234, "EVP_DigestSignFinal(md_ctx, sig, &sig_len)", (EVP_DigestSignFinal(md_ctx, sig, &sig_len)) != 0))
        goto done;



    if (!test_true("../test/evp_extra_test.c", 2239, "EVP_DigestVerifyInit(md_ctx_verify, NULL, check_md, NULL, pkey)", (EVP_DigestVerifyInit(md_ctx_verify, 
# 2239 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2239 "../test/evp_extra_test.c"
        , check_md, 
# 2239 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2239 "../test/evp_extra_test.c"
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 2243, "EVP_PKEY_CTX_set1_id(sctx, sm2_id, sizeof(sm2_id))", "0", EVP_PKEY_CTX_set1_id(sctx, sm2_id, sizeof(sm2_id)), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2246, "EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))", (EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))) != 0))
        goto done;

    if (!test_int_gt("../test/evp_extra_test.c", 2249, "EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len)", "0", EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len), 0))
        goto done;
    ...
    if (!test_true("../test/evp_extra_test.c", 2257, "EVP_DigestVerifyInit(md_ctx_verify, NULL, check_md, NULL, pkey)", (EVP_DigestVerifyInit(md_ctx_verify, 
# 2257 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2257 "../test/evp_extra_test.c"
        , check_md, 
# 2257 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2257 "../test/evp_extra_test.c"
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 2261, "EVP_PKEY_CTX_set1_id(sctx, NULL, 0)", "0", EVP_PKEY_CTX_set1_id(sctx, 
# 2261 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2261 "../test/evp_extra_test.c"
        , 0), 0))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2264, "EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))", (EVP_DigestVerifyUpdate(md_ctx_verify, kMsg, sizeof(kMsg))) != 0))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2267, "EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len)", "0", EVP_DigestVerifyFinal(md_ctx_verify, sig, sig_len), 0))
        goto done;



    gparams[0] = OSSL_PARAM_construct_utf8_string("digest",
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (mdnames[i] == 
# 2284 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 2284 "../test/evp_extra_test.c"
                             )
            continue;
        ...
        if (!test_ptr("../test/evp_extra_test.c", 2291, "cctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)", cctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq))
                                                                         )
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2295, "EVP_PKEY_encrypt_init(cctx)", (EVP_PKEY_encrypt_init(cctx)) != 0))
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2298, "EVP_PKEY_CTX_set_params(cctx, sparams)", (EVP_PKEY_CTX_set_params(cctx, sparams)) != 0))
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2301, "EVP_PKEY_encrypt(cctx, ciphertext, &ctext_len, kMsg, sizeof(kMsg))", (EVP_PKEY_encrypt(cctx, ciphertext, &ctext_len, kMsg, sizeof(kMsg))) != 0)
                                                      )
            goto done;

        if (!test_int_gt("../test/evp_extra_test.c", 2305, "EVP_PKEY_decrypt_init(cctx)", "0", EVP_PKEY_decrypt_init(cctx), 0))
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2308, "EVP_PKEY_CTX_set_params(cctx, sparams)", (EVP_PKEY_CTX_set_params(cctx, sparams)) != 0))
            goto done;

        if (!test_int_gt("../test/evp_extra_test.c", 2311, "EVP_PKEY_decrypt(cctx, plaintext, &ptext_len, ciphertext, ctext_len)", "0", EVP_PKEY_decrypt(cctx, plaintext, &ptext_len, ciphertext, ctext_len), 0)
                                                      )
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2315, "EVP_PKEY_CTX_get_params(cctx, gparams)", (EVP_PKEY_CTX_get_params(cctx, gparams)) != 0))
            goto done;
        ...
        if (!test_ptr("../test/evp_extra_test.c", 2324, "check_md = EVP_MD_fetch(testctx, mdname, testpropq)", check_md = EVP_MD_fetch(testctx, mdname, testpropq)))
            goto done;
        if (!test_true("../test/evp_extra_test.c", 2326, "EVP_MD_is_a(check_md, mdnames[i])", (EVP_MD_is_a(check_md, mdnames[i])) != 0)) {
            test_info("../test/evp_extra_test.c", 2327, "Fetched md %s isn't %s", mdname, mdnames[i]);
            goto done;
        }

        if (!test_true("../test/evp_extra_test.c", 2331, "ptext_len == sizeof(kMsg)", (ptext_len == sizeof(kMsg)) != 0))
            goto done;

        if (!test_true("../test/evp_extra_test.c", 2334, "memcmp(plaintext, kMsg, sizeof(kMsg)) == 0", (memcmp(plaintext, kMsg, sizeof(kMsg)) == 0) != 0))
            goto done;
    }
    ...
    EVP_MD_free(check_md);
    CRYPTO_free(sig, "../test/evp_extra_test.c", 2349);
    return ret;
}
...
static struct keys_st {
    ...
    {
        855, "0123456789", 
# 2361 "../test/evp_extra_test.c" 3 4
                                    ((void *)0)
    
# 2362 "../test/evp_extra_test.c"
   },
    {
        855, "", 
# 2364 "../test/evp_extra_test.c" 3 4
                          ((void *)0)

    
# 2366 "../test/evp_extra_test.c"
   }, {
        1061, "01234567890123456789012345678901", 
# 2367 "../test/evp_extra_test.c" 3 4
                                                              ((void *)0)


    
# 2370 "../test/evp_extra_test.c"
   }, {
        1062, "0123456789012345", 
# 2371 "../test/evp_extra_test.c" 3 4
                                             ((void *)0)

    
# 2373 "../test/evp_extra_test.c"
   },

    {
        1034, "01234567890123456789012345678901",
        "abcdefghijklmnopqrstuvwxyzabcdef"
    }, {
        1087, "01234567890123456789012345678901",
        "abcdefghijklmnopqrstuvwxyzabcdef"
    }, {
        1035,
...
static int test_set_get_raw_keys_int(int tst, int pub, int uselibctx)
{
    ...
    if (pub && keys[tst].pub == 
# 2402 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 2402 "../test/evp_extra_test.c"
                                   )
        return 1;
...
# 2415 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2415 "../test/evp_extra_test.c"
                           ,
                        in,
                        inlen);
        } else {
...
# 2420 "../test/evp_extra_test.c" 3 4
                                              ((void *)0)
# 2420 "../test/evp_extra_test.c"
                                                  ,
                                               in,
                                               inlen);
        }
...
# 2433 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2433 "../test/evp_extra_test.c"
                           ,
                        in,
                        inlen);
        } else {
...
# 2438 "../test/evp_extra_test.c" 3 4
                                               ((void *)0)
# 2438 "../test/evp_extra_test.c"
                                                   ,
                                                in,
                                                inlen);
        }
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2444, "pkey", pkey)
            || !test_int_eq("../test/evp_extra_test.c", 2445, "EVP_PKEY_eq(pkey, pkey)", "1", EVP_PKEY_eq(pkey, pkey), 1)
            || (!pub && !test_true("../test/evp_extra_test.c", 2446, "EVP_PKEY_get_raw_private_key(pkey, NULL, &len)", (EVP_PKEY_get_raw_private_key(pkey, 
# 2446 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2446 "../test/evp_extra_test.c"
                        , &len)) != 0))
            || (pub && !test_true("../test/evp_extra_test.c", 2447, "EVP_PKEY_get_raw_public_key(pkey, NULL, &len)", (EVP_PKEY_get_raw_public_key(pkey, 
# 2447 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2447 "../test/evp_extra_test.c"
                       , &len)) != 0))
            || !test_true("../test/evp_extra_test.c", 2448, "len == inlen", (len == inlen) != 0))
        goto done;
    if (tst != 1) {
        ...
        if ((!pub && !test_false("../test/evp_extra_test.c", 2455, "EVP_PKEY_get_raw_private_key(pkey, buf, &shortlen)", (EVP_PKEY_get_raw_private_key(pkey, buf, &shortlen)) != 0)
                                                                            )
                || (pub && !test_false("../test/evp_extra_test.c", 2457, "EVP_PKEY_get_raw_public_key(pkey, buf, &shortlen)", (EVP_PKEY_get_raw_public_key(pkey, buf, &shortlen)) != 0)
                                                                              ))
            goto done;
    }
    if ((!pub && !test_true("../test/evp_extra_test.c", 2461, "EVP_PKEY_get_raw_private_key(pkey, buf, &len)", (EVP_PKEY_get_raw_private_key(pkey, buf, &len)) != 0))
            || (pub && !test_true("../test/evp_extra_test.c", 2462, "EVP_PKEY_get_raw_public_key(pkey, buf, &len)", (EVP_PKEY_get_raw_public_key(pkey, buf, &len)) != 0))
            || !test_mem_eq("../test/evp_extra_test.c", 2463, "in", "buf", in, inlen, buf, len))
        goto done;
...
{
    return (nullprov != 
# 2474 "../test/evp_extra_test.c" 3 4
                       ((void *)0) 
# 2474 "../test/evp_extra_test.c"
                            || test_set_get_raw_keys_int(tst, 0, 0))
           && test_set_get_raw_keys_int(tst, 0, 1)
           && (nullprov != 
# 2476 "../test/evp_extra_test.c" 3 4
                          ((void *)0) 
# 2476 "../test/evp_extra_test.c"
...
static int test_EVP_PKEY_check(int i)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 2502 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 2502 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 2503 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2503 "../test/evp_extra_test.c"
                           ;

    EVP_PKEY_CTX *ctx2 = 
# 2505 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2505 "../test/evp_extra_test.c"
                            ;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2516, "pkey = load_example_key(ak->keytype, input, input_len)", pkey = load_example_key(ak->keytype, input, input_len)))
        goto done;
    if (type == 0
        && !test_int_eq("../test/evp_extra_test.c", 2519, "EVP_PKEY_get_id(pkey)", "expected_id", EVP_PKEY_get_id(pkey), expected_id))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2522, "ctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)", ctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2525, "EVP_PKEY_check(ctx)", "expected_check", EVP_PKEY_check(ctx), expected_check))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2528, "EVP_PKEY_public_check(ctx)", "expected_pub_check", EVP_PKEY_public_check(ctx), expected_pub_check))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2531, "EVP_PKEY_param_check(ctx)", "expected_param_check", EVP_PKEY_param_check(ctx), expected_param_check))
        goto done;


    ctx2 = EVP_PKEY_CTX_new_id(0xdefaced, 
# 2535 "../test/evp_extra_test.c" 3 4
                                         ((void *)0)
# 2535 "../test/evp_extra_test.c"
                                             );

    EVP_PKEY_up_ref(pkey);
    ctx2->pkey = pkey;

    if (!test_int_eq("../test/evp_extra_test.c", 2540, "EVP_PKEY_check(ctx2)", "0xbeef", EVP_PKEY_check(ctx2), 0xbeef))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2543, "EVP_PKEY_public_check(ctx2)", "0xbeef", EVP_PKEY_public_check(ctx2), 0xbeef))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 2546, "EVP_PKEY_param_check(ctx2)", "0xbeef", EVP_PKEY_param_check(ctx2), 0xbeef))
        goto done;
...
static int get_cmac_val(EVP_PKEY *pkey, unsigned char *mac)
{
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2569, "mdctx", mdctx)
            || !test_true("../test/evp_extra_test.c", 2570, "EVP_DigestSignInit_ex(mdctx, NULL, NULL, testctx, testpropq, pkey, NULL)", (EVP_DigestSignInit_ex(mdctx, 
# 2570 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 2570 "../test/evp_extra_test.c"
               , 
# 2570 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 2570 "../test/evp_extra_test.c"
...
# 2570 "../test/evp_extra_test.c"
            ...
            || !test_true("../test/evp_extra_test.c", 2572, "EVP_DigestSignUpdate(mdctx, msg, sizeof(msg))", (EVP_DigestSignUpdate(mdctx, msg, sizeof(msg))) != 0)
            || !test_true("../test/evp_extra_test.c", 2573, "EVP_DigestSignFinal(mdctx, mac, &maclen)", (EVP_DigestSignFinal(mdctx, mac, &maclen)) != 0)
            || !test_size_t_eq("../test/evp_extra_test.c", 2574, "maclen", "AES_BLOCK_SIZE", maclen, 16))
        ret = 0;
...
static int test_CMAC_keygen(void)
{
    ...
    EVP_PKEY_CTX *kctx = 
# 2588 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2588 "../test/evp_extra_test.c"
                            ;
    int ret = 0;
    EVP_PKEY *pkey = 
# 2590 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 2590 "../test/evp_extra_test.c"
                        ;
    ...
    if (nullprov != 
# 2596 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 2596 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 2597, "Test does not support a non-default library context");





    kctx = EVP_PKEY_CTX_new_id(894, 
# 2603 "../test/evp_extra_test.c" 3 4
                                             ((void *)0)
# 2603 "../test/evp_extra_test.c"
                                                 );


    if (!test_int_gt("../test/evp_extra_test.c", 2606, "EVP_PKEY_keygen_init(kctx)", "0", EVP_PKEY_keygen_init(kctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2607, "EVP_PKEY_CTX_ctrl(kctx, -1, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_CIPHER, 0, (void *)EVP_aes_256_cbc())", "0", EVP_PKEY_CTX_ctrl(kctx, -1, (1<<2), 12, 0, (void *)EVP_aes_256_cbc()), 0)


            || !test_int_gt("../test/evp_extra_test.c", 2610, "EVP_PKEY_CTX_ctrl(kctx, -1, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_SET_MAC_KEY, sizeof(key), (void *)key)", "0", EVP_PKEY_CTX_ctrl(kctx, -1, (1<<2), 6, sizeof(key), (void *)key), 0)


            || !test_int_gt("../test/evp_extra_test.c", 2613, "EVP_PKEY_keygen(kctx, &pkey)", "0", EVP_PKEY_keygen(kctx, &pkey), 0)
            || !test_ptr("../test/evp_extra_test.c", 2614, "pkey", pkey)
            || !test_true("../test/evp_extra_test.c", 2615, "get_cmac_val(pkey, mac)", (get_cmac_val(pkey, mac)) != 0))
        goto done;
    ...
    pkey = EVP_PKEY_new_CMAC_key(
# 2625 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 2625 "../test/evp_extra_test.c"
                                    , key, sizeof(key), EVP_aes_256_cbc());
    if (!test_ptr("../test/evp_extra_test.c", 2626, "pkey", pkey)
            || !test_true("../test/evp_extra_test.c", 2627, "get_cmac_val(pkey, mac2)", (get_cmac_val(pkey, mac2)) != 0)
            || !test_mem_eq("../test/evp_extra_test.c", 2628, "mac", "mac2", mac, sizeof(mac), mac2, sizeof(mac2)))
        goto done;
...
static int test_HKDF(void)
{
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2656, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"HKDF\", testpropq)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "HKDF", testpropq)))
        goto done;
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (!test_int_gt("../test/evp_extra_test.c", 2664, "EVP_PKEY_derive_init(pctx)", "0", EVP_PKEY_derive_init(pctx), 0)
                || !test_int_gt("../test/evp_extra_test.c", 2665, "EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256())", "0", EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256()), 0)
                || !test_int_gt("../test/evp_extra_test.c", 2666, "EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1), 0)

                || !test_int_gt("../test/evp_extra_test.c", 2668, "EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1), 0)

                || !test_int_gt("../test/evp_extra_test.c", 2670, "EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1)", "0", EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1), 0)

                || !test_int_gt("../test/evp_extra_test.c", 2672, "EVP_PKEY_derive(pctx, out, &outlen)", "0", EVP_PKEY_derive(pctx, out, &outlen), 0)
                || !test_mem_eq("../test/evp_extra_test.c", 2673, "out", "expected", out, outlen, expected, expectedlen))
            goto done;
    }
...
static int test_emptyikm_HKDF(void)
{
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2700, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"HKDF\", testpropq)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "HKDF", testpropq)))
        goto done;

    outlen = sizeof(out);
    memset(out, 0, outlen);

    if (!test_int_gt("../test/evp_extra_test.c", 2706, "EVP_PKEY_derive_init(pctx)", "0", EVP_PKEY_derive_init(pctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2707, "EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256())", "0", EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256()), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2708, "EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2710, "EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2712, "EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1)", "0", EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2714, "EVP_PKEY_derive(pctx, out, &outlen)", "0", EVP_PKEY_derive(pctx, out, &outlen), 0)
            || !test_mem_eq("../test/evp_extra_test.c", 2715, "out", "expected", out, outlen, expected, expectedlen))
        goto done;
...
static int test_empty_salt_info_HKDF(void)
{
 ...
 0xaa, 0xe9, 0xb3, 0xb9, 0x52, 0x5f, 0xe0, 0x06,
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2742, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"HKDF\", testpropq)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "HKDF", testpropq)))
        goto done;

    outlen = sizeof(out);
    memset(out, 0, outlen);

    if (!test_int_gt("../test/evp_extra_test.c", 2748, "EVP_PKEY_derive_init(pctx)", "0", EVP_PKEY_derive_init(pctx), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2749, "EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256())", "0", EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256()), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2750, "EVP_PKEY_CTX_set1_hkdf_salt(pctx, fake, sizeof(fake) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_salt(pctx, fake, sizeof(fake) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2752, "EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_salt(pctx, salt, sizeof(salt) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2754, "EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1)", "0", EVP_PKEY_CTX_set1_hkdf_key(pctx, key, sizeof(key) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2756, "EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1)", "0", EVP_PKEY_CTX_add1_hkdf_info(pctx, info, sizeof(info) - 1), 0)

            || !test_int_gt("../test/evp_extra_test.c", 2758, "EVP_PKEY_derive(pctx, out, &outlen)", "0", EVP_PKEY_derive(pctx, out, &outlen), 0)
            || !test_mem_eq("../test/evp_extra_test.c", 2759, "out", "expected", out, outlen, expected, expectedlen))
        goto done;
...
static int test_X509_PUBKEY_inplace(void)
{
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2778, "xp", xp))
        goto done;
    if (!test_ptr("../test/evp_extra_test.c", 2780, "d2i_X509_PUBKEY(&xp, &p, input_len)", d2i_X509_PUBKEY(&xp, &p, input_len)))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2783, "X509_PUBKEY_get0(xp)", X509_PUBKEY_get0(xp)))
        goto done;

    p = kExampleBadECPubKeyDER;
    input_len = sizeof(kExampleBadECPubKeyDER);

    if (!test_ptr("../test/evp_extra_test.c", 2789, "xp = d2i_X509_PUBKEY(&xp, &p, input_len)", xp = d2i_X509_PUBKEY(&xp, &p, input_len)))
        goto done;

    if (!test_true("../test/evp_extra_test.c", 2792, "X509_PUBKEY_get0(xp) == NULL", (X509_PUBKEY_get0(xp) == 
# 2792 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2792 "../test/evp_extra_test.c"
        ) != 0))
        goto done;
...
static int test_X509_PUBKEY_dup(void)
{
    int ret = 0;
    X509_PUBKEY *xp = 
# 2805 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 2805 "../test/evp_extra_test.c"
                         , *xq = 
# 2805 "../test/evp_extra_test.c" 3 4
                                 ((void *)0)
# 2805 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2810, "xp", xp)
            || !test_ptr("../test/evp_extra_test.c", 2811, "d2i_X509_PUBKEY(&xp, &p, input_len)", d2i_X509_PUBKEY(&xp, &p, input_len))
            || !test_ptr("../test/evp_extra_test.c", 2812, "xq = X509_PUBKEY_dup(xp)", xq = X509_PUBKEY_dup(xp))
            || !test_ptr_ne("../test/evp_extra_test.c", 2813, "xp", "xq", xp, xq))
        goto done;

    if (!test_ptr("../test/evp_extra_test.c", 2816, "X509_PUBKEY_get0(xq)", X509_PUBKEY_get0(xq))
            || !test_ptr("../test/evp_extra_test.c", 2817, "X509_PUBKEY_get0(xp)", X509_PUBKEY_get0(xp))
            || !test_ptr_ne("../test/evp_extra_test.c", 2818, "X509_PUBKEY_get0(xq)", "X509_PUBKEY_get0(xp)", X509_PUBKEY_get0(xq), X509_PUBKEY_get0(xp)))
        goto done;

    X509_PUBKEY_free(xq);
    xq = 
# 2822 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2822 "../test/evp_extra_test.c"
            ;
    p = kExampleBadECPubKeyDER;
    input_len = sizeof(kExampleBadECPubKeyDER);

    if (!test_ptr("../test/evp_extra_test.c", 2826, "xp = d2i_X509_PUBKEY(&xp, &p, input_len)", xp = d2i_X509_PUBKEY(&xp, &p, input_len))
            || !test_ptr("../test/evp_extra_test.c", 2827, "xq = X509_PUBKEY_dup(xp)", xq = X509_PUBKEY_dup(xp)))
        goto done;

    X509_PUBKEY_free(xp);
    xp = 
# 2831 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2831 "../test/evp_extra_test.c"
            ;
    if (!test_true("../test/evp_extra_test.c", 2832, "X509_PUBKEY_get0(xq) == NULL", (X509_PUBKEY_get0(xq) == 
# 2832 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2832 "../test/evp_extra_test.c"
        ) != 0))
        goto done;
...
{
    EVP_MD_CTX *mdctx = 
# 2847 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2847 "../test/evp_extra_test.c"
                           ;
    EVP_PKEY_CTX *ctx = 
# 2848 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 2848 "../test/evp_extra_test.c"
                           ;
    const OSSL_PARAM *params;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2858, "ctx", ctx)
            || !test_int_gt("../test/evp_extra_test.c", 2859, "EVP_PKEY_sign_init(ctx)", "0", EVP_PKEY_sign_init(ctx), 0))
        goto err;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2866, "params", params)
        || !test_ptr("../test/evp_extra_test.c", 2867, "OSSL_PARAM_locate_const(params, OSSL_SIGNATURE_PARAM_DIGEST)", OSSL_PARAM_locate_const(params, "digest"))
                                                                          )
        goto err;

    params = EVP_PKEY_CTX_gettable_params(ctx);
    if (!test_ptr("../test/evp_extra_test.c", 2872, "params", params)
        || !test_ptr("../test/evp_extra_test.c", 2873, "OSSL_PARAM_locate_const(params, OSSL_SIGNATURE_PARAM_ALGORITHM_ID)", OSSL_PARAM_locate_const(params, "algorithm-id"))

        || !test_ptr("../test/evp_extra_test.c", 2875, "OSSL_PARAM_locate_const(params, OSSL_SIGNATURE_PARAM_DIGEST)", OSSL_PARAM_locate_const(params, "digest"))
                                                                          )
        goto err;
    ...
    param_md = param;
    *param++ = OSSL_PARAM_construct_utf8_string("digest",
                                                mdname, 0);
    *param++ = OSSL_PARAM_construct_end();

    if (!test_true("../test/evp_extra_test.c", 2889, "EVP_PKEY_CTX_set_params(ctx, ourparams)", (EVP_PKEY_CTX_set_params(ctx, ourparams)) != 0))
        goto err;

    mdname[0] = '\0';
    *param_md = OSSL_PARAM_construct_utf8_string("digest",
                                                 mdname, sizeof(mdname));
    if (!test_true("../test/evp_extra_test.c", 2895, "EVP_PKEY_CTX_get_params(ctx, ourparams)", (EVP_PKEY_CTX_get_params(ctx, ourparams)) != 0)
            || !test_str_eq("../test/evp_extra_test.c", 2896, "mdname", "\"SHA512\"", mdname, "SHA512"))
        goto err;
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 2903, "EVP_PKEY_CTX_set_signature_md(ctx, EVP_sha256())", "0", EVP_PKEY_CTX_set_signature_md(ctx, EVP_sha256()), 0)
            || !test_int_gt("../test/evp_extra_test.c", 2904, "EVP_PKEY_CTX_get_signature_md(ctx, &md)", "0", EVP_PKEY_CTX_get_signature_md(ctx, &md), 0)
            || !test_ptr_eq("../test/evp_extra_test.c", 2905, "md", "EVP_sha256()", md, EVP_sha256()))
        goto err;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2912, "mdctx", mdctx)
        || !test_true("../test/evp_extra_test.c", 2913, "EVP_DigestSignInit_ex(mdctx, NULL, \"SHA1\", testctx, testpropq, pkey, NULL)", (EVP_DigestSignInit_ex(mdctx, 
# 2913 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 2913 "../test/evp_extra_test.c"
           , "SHA1", testctx, testpropq, pkey, 
# 2913 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 2913 "../test/evp_extra_test.c"
           )) != 0)
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2922, "params", params)
            || !test_int_eq("../test/evp_extra_test.c", 2923, "strcmp(params[0].key, OSSL_DIGEST_PARAM_SSL3_MS)", "0", strcmp(params[0].key, "ssl3-ms"), 0)

            || !test_ptr_null("../test/evp_extra_test.c", 2925, "params[1].key", params[1].key))
        goto err;

    param = ourparams;
    memset(ssl3ms, 0, sizeof(ssl3ms));
    *param++ = OSSL_PARAM_construct_octet_string("ssl3-ms",
                                                 ssl3ms, sizeof(ssl3ms));
    *param++ = OSSL_PARAM_construct_end();

    if (!test_true("../test/evp_extra_test.c", 2934, "EVP_MD_CTX_set_params(mdctx, ourparams)", (EVP_MD_CTX_set_params(mdctx, ourparams)) != 0))
        goto err;
...
{
    OSSL_PARAM_BLD *bld = 
# 2949 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 2949 "../test/evp_extra_test.c"
                             ;
    OSSL_PARAM *params = 
# 2950 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2950 "../test/evp_extra_test.c"
                            ;
    BIGNUM *p = 
# 2951 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 2951 "../test/evp_extra_test.c"
                   , *q = 
# 2951 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 2951 "../test/evp_extra_test.c"
...
# 2951 "../test/evp_extra_test.c"
                                                                    ;
    EVP_PKEY_CTX *pctx = 
# 2952 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 2952 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *pkey = 
# 2953 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 2953 "../test/evp_extra_test.c"
                        ;
    int ret = 0;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 2960, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"DSA\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "DSA", 
# 2960 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 2960 "../test/evp_extra_test.c"
        ))
        || !test_ptr("../test/evp_extra_test.c", 2961, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_extra_test.c", 2962, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 2963, "q = BN_new()", q = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 2964, "g = BN_new()", g = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 2965, "pub = BN_new()", pub = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 2966, "priv = BN_new()", priv = BN_new()))
        goto err;
    if (!test_true("../test/evp_extra_test.c", 2968, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/evp_extra_test.c", 2969, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_Q, q)", (OSSL_PARAM_BLD_push_BN(bld, "q", q)) != 0)
        || !test_true("../test/evp_extra_test.c", 2970, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_FFC_G, g)", (OSSL_PARAM_BLD_push_BN(bld, "g", g)) != 0)
        || !test_true("../test/evp_extra_test.c", 2971, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pub)", (OSSL_PARAM_BLD_push_BN(bld, "pub", pub)) != 0)

        || !test_true("../test/evp_extra_test.c", 2973, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, priv)", (OSSL_PARAM_BLD_push_BN(bld, "priv", priv)) != 0)
                                                   )
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 2976, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_int_gt("../test/evp_extra_test.c", 2979, "EVP_PKEY_fromdata_init(pctx)", "0", EVP_PKEY_fromdata_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 2980, "EVP_PKEY_fromdata(pctx, &pkey, EVP_PKEY_KEYPAIR, params)", "0", EVP_PKEY_fromdata(pctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params), 0)
                                                     )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 2984, "pkey", pkey))
        goto err;
...
{
    OSSL_PARAM_BLD *bld = 
# 3016 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 3016 "../test/evp_extra_test.c"
                             ;
    OSSL_PARAM *params = 
# 3017 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3017 "../test/evp_extra_test.c"
                            ;
    BIGNUM *n = 
# 3018 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3018 "../test/evp_extra_test.c"
                   , *e = 
# 3018 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
# 3018 "../test/evp_extra_test.c"
...
# 3018 "../test/evp_extra_test.c"
                                         ;
    EVP_PKEY_CTX *pctx = 
# 3019 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3019 "../test/evp_extra_test.c"
                            ;
    EVP_PKEY *pkey = 
# 3020 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3020 "../test/evp_extra_test.c"
                        ;
    int ret = 0;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 3027, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"RSA\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(testctx, "RSA", 
# 3027 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3027 "../test/evp_extra_test.c"
        ))
        || !test_ptr("../test/evp_extra_test.c", 3028, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/evp_extra_test.c", 3029, "n = BN_new()", n = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 3030, "e = BN_new()", e = BN_new())
        || !test_ptr("../test/evp_extra_test.c", 3031, "d = BN_new()", d = BN_new()))
        goto err;
    if (!test_true("../test/evp_extra_test.c", 3033, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_N, n)", (OSSL_PARAM_BLD_push_BN(bld, "n", n)) != 0)
        || !test_true("../test/evp_extra_test.c", 3034, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_E, e)", (OSSL_PARAM_BLD_push_BN(bld, "e", e)) != 0)
        || !test_true("../test/evp_extra_test.c", 3035, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_RSA_D, d)", (OSSL_PARAM_BLD_push_BN(bld, "d", d)) != 0))
        goto err;
    if (!test_ptr("../test/evp_extra_test.c", 3037, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_int_gt("../test/evp_extra_test.c", 3040, "EVP_PKEY_fromdata_init(pctx)", "0", EVP_PKEY_fromdata_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 3041, "EVP_PKEY_fromdata(pctx, &pkey, EVP_PKEY_KEYPAIR, params)", "0", EVP_PKEY_fromdata(pctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params), 0)
                                                     )
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 3045, "pkey", pkey))
        goto err;
...
static int test_RSA_OAEP_set_get_params(void)
{
    int ret = 0;
    EVP_PKEY *key = 
# 3065 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3065 "../test/evp_extra_test.c"
                       ;
    EVP_PKEY_CTX *key_ctx = 
# 3066 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 3066 "../test/evp_extra_test.c"
                               ;

    if (nullprov != 
# 3068 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3068 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 3069, "Test does not support a non-default library context");

    if (!test_ptr("../test/evp_extra_test.c", 3071, "key = load_example_rsa_key()", key = load_example_rsa_key())
        || !test_ptr("../test/evp_extra_test.c", 3072, "key_ctx = EVP_PKEY_CTX_new_from_pkey(0, key, 0)", key_ctx = EVP_PKEY_CTX_new_from_pkey(0, key, 0)))
        goto err;

    {
        ...
        params[0] = OSSL_PARAM_construct_int("pad-mode", &padding);
        params[1] = OSSL_PARAM_construct_utf8_string("digest",
                                                     "SHA2-256", 0);
        params[2] = OSSL_PARAM_construct_utf8_string("mgf1-digest",
                                                     "SHA1", 0);
        params[3] = OSSL_PARAM_construct_end();

        if (!test_int_gt("../test/evp_extra_test.c", 3086, "EVP_PKEY_encrypt_init_ex(key_ctx, params)", "0", EVP_PKEY_encrypt_init_ex(key_ctx, params), 0))
            goto err;
    }
    {
        OSSL_PARAM params[3];
        ...
        params[1] = OSSL_PARAM_construct_utf8_string("mgf1-digest",
                                                     mgf1md, sizeof(mgf1md));
        params[2] = OSSL_PARAM_construct_end();

        if (!test_true("../test/evp_extra_test.c", 3100, "EVP_PKEY_CTX_get_params(key_ctx, params)", (EVP_PKEY_CTX_get_params(key_ctx, params)) != 0))
            goto err;

        if (!test_str_eq("../test/evp_extra_test.c", 3103, "oaepmd", "OSSL_DIGEST_NAME_SHA2_256", oaepmd, "SHA2-256")
            || !test_str_eq("../test/evp_extra_test.c", 3104, "mgf1md", "OSSL_DIGEST_NAME_SHA1", mgf1md, "SHA1"))
            goto err;
    }
...
static int test_RSA_OAEP_set_null_label(void)
{
    int ret = 0;
    EVP_PKEY *key = 
# 3121 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3121 "../test/evp_extra_test.c"
                       ;
    EVP_PKEY_CTX *key_ctx = 
# 3122 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 3122 "../test/evp_extra_test.c"
                               ;

    if (!test_ptr("../test/evp_extra_test.c", 3124, "key = load_example_rsa_key()", key = load_example_rsa_key())
        || !test_ptr("../test/evp_extra_test.c", 3125, "key_ctx = EVP_PKEY_CTX_new_from_pkey(testctx, key, NULL)", key_ctx = EVP_PKEY_CTX_new_from_pkey(testctx, key, 
# 3125 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 3125 "../test/evp_extra_test.c"
           ))
        || !test_true("../test/evp_extra_test.c", 3126, "EVP_PKEY_encrypt_init(key_ctx)", (EVP_PKEY_encrypt_init(key_ctx)) != 0))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3129, "EVP_PKEY_CTX_set_rsa_padding(key_ctx, RSA_PKCS1_OAEP_PADDING)", (EVP_PKEY_CTX_set_rsa_padding(key_ctx, 4)) != 0))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3132, "EVP_PKEY_CTX_set0_rsa_oaep_label(key_ctx, OPENSSL_strdup(\"foo\"), 0)", (EVP_PKEY_CTX_set0_rsa_oaep_label(key_ctx, CRYPTO_strdup("foo", "../test/evp_extra_test.c", 3132), 0)) != 0))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3135, "EVP_PKEY_CTX_set0_rsa_oaep_label(key_ctx, NULL, 0)", (EVP_PKEY_CTX_set0_rsa_oaep_label(key_ctx, 
# 3135 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3135 "../test/evp_extra_test.c"
        , 0)) != 0))
        goto err;
...
static int test_RSA_legacy(void)
{
    int ret = 0;
    BIGNUM *p = 
# 3151 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3151 "../test/evp_extra_test.c"
                   ;
    BIGNUM *q = 
# 3152 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3152 "../test/evp_extra_test.c"
                   ;
    BIGNUM *n = 
# 3153 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3153 "../test/evp_extra_test.c"
                   ;
    BIGNUM *e = 
# 3154 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3154 "../test/evp_extra_test.c"
                   ;
    BIGNUM *d = 
# 3155 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3155 "../test/evp_extra_test.c"
                   ;
    const EVP_MD *md = EVP_sha256();
    EVP_MD_CTX *ctx = 
# 3157 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 3157 "../test/evp_extra_test.c"
                         ;
    EVP_PKEY *pkey = 
# 3158 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3158 "../test/evp_extra_test.c"
                        ;
    RSA *rsa = 
# 3159 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 3159 "../test/evp_extra_test.c"
                  ;

    if (nullprov != 
# 3161 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3161 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 3162, "Test does not support a non-default library context");

    if (!test_ptr("../test/evp_extra_test.c", 3164, "p = BN_dup(BN_value_one())", p = BN_dup(BN_value_one()))
        || !test_ptr("../test/evp_extra_test.c", 3165, "q = BN_dup(BN_value_one())", q = BN_dup(BN_value_one()))
        || !test_ptr("../test/evp_extra_test.c", 3166, "n = BN_dup(BN_value_one())", n = BN_dup(BN_value_one()))
        || !test_ptr("../test/evp_extra_test.c", 3167, "e = BN_dup(BN_value_one())", e = BN_dup(BN_value_one()))
        || !test_ptr("../test/evp_extra_test.c", 3168, "d = BN_dup(BN_value_one())", d = BN_dup(BN_value_one())))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 3171, "rsa = RSA_new()", rsa = RSA_new())
        || !test_ptr("../test/evp_extra_test.c", 3172, "pkey = EVP_PKEY_new()", pkey = EVP_PKEY_new())
        || !test_ptr("../test/evp_extra_test.c", 3173, "ctx = EVP_MD_CTX_new()", ctx = EVP_MD_CTX_new()))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3176, "RSA_set0_factors(rsa, p, q)", (RSA_set0_factors(rsa, p, q)) != 0))
        goto err;
    p = 
# 3178 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 3178 "../test/evp_extra_test.c"
           ;
    q = 
# 3179 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 3179 "../test/evp_extra_test.c"
           ;

    if (!test_true("../test/evp_extra_test.c", 3181, "RSA_set0_key(rsa, n, e, d)", (RSA_set0_key(rsa, n, e, d)) != 0))
        goto err;
    n = 
# 3183 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 3183 "../test/evp_extra_test.c"
           ;
    e = 
# 3184 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 3184 "../test/evp_extra_test.c"
           ;
    d = 
# 3185 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 3185 "../test/evp_extra_test.c"
           ;

    if (!test_true("../test/evp_extra_test.c", 3187, "EVP_PKEY_assign_RSA(pkey, rsa)", (EVP_PKEY_assign((pkey),6, (rsa))) != 0))
        goto err;

    rsa = 
# 3190 "../test/evp_extra_test.c" 3 4
         ((void *)0)
# 3190 "../test/evp_extra_test.c"
             ;

    if (!test_true("../test/evp_extra_test.c", 3192, "EVP_DigestSignInit(ctx, NULL, md, NULL, pkey)", (EVP_DigestSignInit(ctx, 
# 3192 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3192 "../test/evp_extra_test.c"
        , md, 
# 3192 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3192 "../test/evp_extra_test.c"
...
static int test_RSA_encrypt(void)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 3214 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3214 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY_CTX *pctx = 
# 3215 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3215 "../test/evp_extra_test.c"
                            ;
    unsigned char *cbuf = 
# 3216 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 3216 "../test/evp_extra_test.c"
                             , *pbuf = 
# 3216 "../test/evp_extra_test.c" 3 4
                                       ((void *)0)
# 3216 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 3219, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key())
        || !test_ptr("../test/evp_extra_test.c", 3220, "pctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq)", pctx = EVP_PKEY_CTX_new_from_pkey(testctx, pkey, testpropq))

        || !test_int_gt("../test/evp_extra_test.c", 3222, "EVP_PKEY_encrypt_init(pctx)", "0", EVP_PKEY_encrypt_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 3223, "EVP_PKEY_encrypt(pctx, cbuf, &clen, kMsg, sizeof(kMsg))", "0", EVP_PKEY_encrypt(pctx, cbuf, &clen, kMsg, sizeof(kMsg)), 0)
        || !test_ptr("../test/evp_extra_test.c", 3224, "cbuf = OPENSSL_malloc(clen)", cbuf = CRYPTO_malloc(clen, "../test/evp_extra_test.c", 3224))
        || !test_int_gt("../test/evp_extra_test.c", 3225, "EVP_PKEY_encrypt(pctx, cbuf, &clen, kMsg, sizeof(kMsg))", "0", EVP_PKEY_encrypt(pctx, cbuf, &clen, kMsg, sizeof(kMsg)), 0))
        goto done;


    plen = clen - 1;
    if (!test_int_le("../test/evp_extra_test.c", 3230, "EVP_PKEY_encrypt(pctx, cbuf, &plen, kMsg, sizeof(kMsg))", "0", EVP_PKEY_encrypt(pctx, cbuf, &plen, kMsg, sizeof(kMsg)), 0))
        goto done;

    test_openssl_errors();


    if (!test_int_gt("../test/evp_extra_test.c", 3236, "EVP_PKEY_decrypt_init(pctx)", "0", EVP_PKEY_decrypt_init(pctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 3237, "EVP_PKEY_decrypt(pctx, pbuf, &plen, cbuf, clen)", "0", EVP_PKEY_decrypt(pctx, pbuf, &plen, cbuf, clen), 0)
        || !test_ptr("../test/evp_extra_test.c", 3238, "pbuf = OPENSSL_malloc(plen)", pbuf = CRYPTO_malloc(plen, "../test/evp_extra_test.c", 3238))
        || !test_int_gt("../test/evp_extra_test.c", 3239, "EVP_PKEY_decrypt(pctx, pbuf, &plen, cbuf, clen)", "0", EVP_PKEY_decrypt(pctx, pbuf, &plen, cbuf, clen), 0)
        || !test_mem_eq("../test/evp_extra_test.c", 3240, "pbuf", "kMsg", pbuf, plen, kMsg, sizeof(kMsg))
        || !test_int_gt("../test/evp_extra_test.c", 3241, "EVP_PKEY_encrypt_init(pctx)", "0", EVP_PKEY_encrypt_init(pctx), 0))
        goto done;
    ...
    EVP_PKEY_CTX_free(pctx);
    EVP_PKEY_free(pkey);
    CRYPTO_free(cbuf, "../test/evp_extra_test.c", 3248);
    CRYPTO_free(pbuf, "../test/evp_extra_test.c", 3249);
    return ret;
}
...
{
    EVP_CIPHER_CTX* ctx = 
# 3256 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 3256 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *cipher = 
# 3257 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3257 "../test/evp_extra_test.c"
                            ;
    ...
    if (!test_ptr("../test/evp_extra_test.c", 3274, "cipher = EVP_CIPHER_fetch(testctx, \"ChaCha20-Poly1305\", testpropq)", cipher = EVP_CIPHER_fetch(testctx, "ChaCha20-Poly1305", testpropq))
            || !test_ptr("../test/evp_extra_test.c", 3275, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_true("../test/evp_extra_test.c", 3276, "EVP_EncryptInit_ex(ctx, cipher, NULL, key, iv)", (EVP_EncryptInit_ex(ctx, cipher, 
# 3276 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3276 "../test/evp_extra_test.c"
               , key, iv)) != 0)

            || !test_true("../test/evp_extra_test.c", 3278, "EVP_EncryptUpdate(ctx, ciphertext, &ctlen, msg, enc_offset)", (EVP_EncryptUpdate(ctx, ciphertext, &ctlen, msg, enc_offset)) != 0)


            || !test_true("../test/evp_extra_test.c", 3281, "EVP_EncryptUpdate(ctx, ciphertext + ctlen, &tmp, NULL, 0)", (EVP_EncryptUpdate(ctx, ciphertext + ctlen, &tmp, 
# 3281 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3281 "../test/evp_extra_test.c"
               , 0)) != 0)

            || !test_int_eq("../test/evp_extra_test.c", 3283, "tmp", "0", tmp, 0)
            || !test_true("../test/evp_extra_test.c", 3284, "EVP_EncryptUpdate(ctx, ciphertext + ctlen, &tmp, msg + enc_offset, sizeof(msg) - enc_offset)", (EVP_EncryptUpdate(ctx, ciphertext + ctlen, &tmp, msg + enc_offset, sizeof(msg) - enc_offset)) != 0)


            || !test_int_eq("../test/evp_extra_test.c", 3287, "ctlen += tmp", "sizeof(msg)", ctlen += tmp, sizeof(msg))
            || !test_true("../test/evp_extra_test.c", 3288, "EVP_EncryptFinal(ctx, ciphertext + ctlen, &tmp)", (EVP_EncryptFinal(ctx, ciphertext + ctlen, &tmp)) != 0)
            || !test_int_eq("../test/evp_extra_test.c", 3289, "tmp", "0", tmp, 0))
        goto err;


    tmp = 99;
    if (!test_true("../test/evp_extra_test.c", 3294, "EVP_DecryptInit_ex(ctx, cipher, NULL, key, iv)", (EVP_DecryptInit_ex(ctx, cipher, 
# 3294 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3294 "../test/evp_extra_test.c"
        , key, iv)) != 0)
            || !test_true("../test/evp_extra_test.c", 3295, "EVP_DecryptUpdate(ctx, plaintext, &ptlen, ciphertext, dec_offset)", (EVP_DecryptUpdate(ctx, plaintext, &ptlen, ciphertext, dec_offset)) != 0)





            || !test_true("../test/evp_extra_test.c", 3301, "EVP_DecryptUpdate(ctx, plaintext + ptlen, &tmp, NULL, 0)", (EVP_DecryptUpdate(ctx, plaintext + ptlen, &tmp, 
# 3301 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3301 "../test/evp_extra_test.c"
               , 0)) != 0)

            || !test_int_eq("../test/evp_extra_test.c", 3303, "tmp", "0", tmp, 0)
            || !test_true("../test/evp_extra_test.c", 3304, "EVP_DecryptUpdate(ctx, plaintext + ptlen, &tmp, ciphertext + dec_offset, ctlen - dec_offset)", (EVP_DecryptUpdate(ctx, plaintext + ptlen, &tmp, ciphertext + dec_offset, ctlen - dec_offset)) != 0)


            || !test_int_eq("../test/evp_extra_test.c", 3307, "ptlen += tmp", "sizeof(msg)", ptlen += tmp, sizeof(msg))
            || !test_true("../test/evp_extra_test.c", 3308, "EVP_DecryptFinal(ctx, plaintext + ptlen, &tmp)", (EVP_DecryptFinal(ctx, plaintext + ptlen, &tmp)) != 0)
            || !test_int_eq("../test/evp_extra_test.c", 3309, "tmp", "0", tmp, 0)
            || !test_mem_eq("../test/evp_extra_test.c", 3310, "msg", "plaintext", msg, sizeof(msg), plaintext, ptlen))
        goto err;
...
{
    DH *x942dh = 
# 3334 "../test/evp_extra_test.c" 3 4
                ((void *)0)
# 3334 "../test/evp_extra_test.c"
                    , *noqdh = 
# 3334 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 3334 "../test/evp_extra_test.c"
                                   ;
    EVP_PKEY *pkey1 = 
# 3335 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 3335 "../test/evp_extra_test.c"
                         , *pkey2 = 
# 3335 "../test/evp_extra_test.c" 3 4
                                    ((void *)0)
# 3335 "../test/evp_extra_test.c"
    ...
    int ret = 0;
    BIGNUM *p, *g = 
# 3337 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3337 "../test/evp_extra_test.c"
                       ;
    BIGNUM *pubkey = 
# 3338 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3338 "../test/evp_extra_test.c"
                        ;
    unsigned char pub[2048 / 8];
    size_t len = 0;

    if (!test_ptr("../test/evp_extra_test.c", 3342, "p = BN_new()", p = BN_new())
            || !test_ptr("../test/evp_extra_test.c", 3343, "g = BN_new()", g = BN_new())
            || !test_ptr("../test/evp_extra_test.c", 3344, "pubkey = BN_new()", pubkey = BN_new())
            || !test_true("../test/evp_extra_test.c", 3345, "BN_set_word(p, 9999)", (BN_set_word(p, 9999)) != 0)
            || !test_true("../test/evp_extra_test.c", 3346, "BN_set_word(g, 2)", (BN_set_word(g, 2)) != 0)
            || !test_true("../test/evp_extra_test.c", 3347, "BN_set_word(pubkey, 4321)", (BN_set_word(pubkey, 4321)) != 0)
            || !test_ptr("../test/evp_extra_test.c", 3348, "noqdh = DH_new()", noqdh = DH_new())
            || !test_true("../test/evp_extra_test.c", 3349, "DH_set0_pqg(noqdh, p, NULL, g)", (DH_set0_pqg(noqdh, p, 
# 3349 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3349 "../test/evp_extra_test.c"
               , g)) != 0)
            || !test_true("../test/evp_extra_test.c", 3350, "DH_set0_key(noqdh, pubkey, NULL)", (DH_set0_key(noqdh, pubkey, 
# 3350 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3350 "../test/evp_extra_test.c"
               )) != 0)
            || !test_ptr("../test/evp_extra_test.c", 3351, "pubkey = BN_new()", pubkey = BN_new())
            || !test_true("../test/evp_extra_test.c", 3352, "BN_set_word(pubkey, 4321)", (BN_set_word(pubkey, 4321)) != 0))
        goto err;
    p = g = 
# 3354 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 3354 "../test/evp_extra_test.c"
               ;

    x942dh = DH_get_2048_256();
    pkey1 = EVP_PKEY_new();
    pkey2 = EVP_PKEY_new();
    if (!test_ptr("../test/evp_extra_test.c", 3359, "x942dh", x942dh)
            || !test_ptr("../test/evp_extra_test.c", 3360, "noqdh", noqdh)
            || !test_ptr("../test/evp_extra_test.c", 3361, "pkey1", pkey1)
            || !test_ptr("../test/evp_extra_test.c", 3362, "pkey2", pkey2)
            || !test_true("../test/evp_extra_test.c", 3363, "DH_set0_key(x942dh, pubkey, NULL)", (DH_set0_key(x942dh, pubkey, 
# 3363 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3363 "../test/evp_extra_test.c"
               )) != 0))
        goto err;
    pubkey = 
# 3365 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 3365 "../test/evp_extra_test.c"
                ;

    if (!test_true("../test/evp_extra_test.c", 3367, "EVP_PKEY_set1_DH(pkey1, x942dh)", (EVP_PKEY_set1_DH(pkey1, x942dh)) != 0)
            || !test_int_eq("../test/evp_extra_test.c", 3368, "EVP_PKEY_get_id(pkey1)", "EVP_PKEY_DHX", EVP_PKEY_get_id(pkey1), 920))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3371, "EVP_PKEY_get_bn_param(pkey1, OSSL_PKEY_PARAM_PUB_KEY, &pubkey)", (EVP_PKEY_get_bn_param(pkey1, "pub", &pubkey)) != 0)

            || !test_ptr("../test/evp_extra_test.c", 3373, "pubkey", pubkey))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3376, "EVP_PKEY_set1_DH(pkey2, noqdh)", (EVP_PKEY_set1_DH(pkey2, noqdh)) != 0)
            || !test_int_eq("../test/evp_extra_test.c", 3377, "EVP_PKEY_get_id(pkey2)", "EVP_PKEY_DH", EVP_PKEY_get_id(pkey2), 28))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3380, "EVP_PKEY_get_octet_string_param(pkey2, OSSL_PKEY_PARAM_PUB_KEY, pub, sizeof(pub), &len)", (EVP_PKEY_get_octet_string_param(pkey2, "pub", pub, sizeof(pub), &len)) != 0)


            || !test_size_t_ne("../test/evp_extra_test.c", 3383, "len", "0", len, 0))
        goto err;
...
# 3408 "../test/evp_extra_test.c"
static int test_keygen_with_empty_template(int n)
{
    EVP_PKEY_CTX *ctx = 
# 3410 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3410 "../test/evp_extra_test.c"
                           ;
    EVP_PKEY *pkey = 
# 3411 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3411 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY *tkey = 
# 3412 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3412 "../test/evp_extra_test.c"
                        ;
    int ret = 0;

    if (nullprov != 
# 3415 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3415 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 3416, "Test does not support a non-default library context");

    switch (n) {
    case 0:

        if (!test_ptr("../test/evp_extra_test.c", 3421, "ctx = EVP_PKEY_CTX_new_id(EVP_PKEY_RSA, NULL)", ctx = EVP_PKEY_CTX_new_id(6, 
# 3421 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 3421 "../test/evp_extra_test.c"
            )))
            goto err;
        break;
    case 1:

        if (!test_ptr("../test/evp_extra_test.c", 3426, "tkey = EVP_PKEY_new()", tkey = EVP_PKEY_new())
            || !test_true("../test/evp_extra_test.c", 3427, "EVP_PKEY_set_type(tkey, EVP_PKEY_RSA)", (EVP_PKEY_set_type(tkey, 6)) != 0)
            || !test_ptr("../test/evp_extra_test.c", 3428, "ctx = EVP_PKEY_CTX_new(tkey, NULL)", ctx = EVP_PKEY_CTX_new(tkey, 
# 3428 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3428 "../test/evp_extra_test.c"
               )))
            goto err;
        break;
    }

    if (!test_int_gt("../test/evp_extra_test.c", 3433, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 3434, "EVP_PKEY_keygen(ctx, &pkey)", "0", EVP_PKEY_keygen(ctx, &pkey), 0))
        goto err;
...
# 3453 "../test/evp_extra_test.c"
static int test_pkey_ctx_fail_without_provider(int tst)
{
    OSSL_LIB_CTX *tmpctx = OSSL_LIB_CTX_new();
    OSSL_PROVIDER *tmpnullprov = 
# 3456 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 3456 "../test/evp_extra_test.c"
                                    ;
    EVP_PKEY_CTX *pctx = 
# 3457 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3457 "../test/evp_extra_test.c"
                            ;
    const char *keytype = 
# 3458 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 3458 "../test/evp_extra_test.c"
                             ;
    int expect_null = 0;
    int ret = 0;

    if (!test_ptr("../test/evp_extra_test.c", 3462, "tmpctx", tmpctx))
        goto err;

    tmpnullprov = OSSL_PROVIDER_load(tmpctx, "null");
    if (!test_ptr("../test/evp_extra_test.c", 3466, "tmpnullprov", tmpnullprov))
        goto err;
# 3476 "../test/evp_extra_test.c"
    switch (tst) {
    case 0:
        keytype = "RSA";
        expect_null = 1;
    ...
    case 1:
        keytype = "SM2";
        expect_null = 1;
# 3492 "../test/evp_extra_test.c"
        break;
    default:
        test_error("../test/evp_extra_test.c", 3494, "No test for case %d", tst);
        goto err;
    }

    pctx = EVP_PKEY_CTX_new_from_name(tmpctx, keytype, "");
    if (expect_null ? !test_ptr_null("../test/evp_extra_test.c", 3499, "pctx", pctx) : !test_ptr("../test/evp_extra_test.c", 3499, "pctx", pctx))
        goto err;
...
static int test_rand_agglomeration(void)
{
    ...
    if (!test_int_ne("../test/evp_extra_test.c", 3525, "sizeof(seed) % step", "0", sizeof(seed) % step, 0)
            || !test_ptr("../test/evp_extra_test.c", 3526, "rand = EVP_RAND_fetch(testctx, \"TEST-RAND\", testpropq)", rand = EVP_RAND_fetch(testctx, "TEST-RAND", testpropq)))
        return 0;
    ctx = EVP_RAND_CTX_new(rand, 
# 3528 "../test/evp_extra_test.c" 3 4
                                ((void *)0)
# 3528 "../test/evp_extra_test.c"
                                    );
    EVP_RAND_free(rand);
    if (!test_ptr("../test/evp_extra_test.c", 3530, "ctx", ctx))
        return 0;

    memset(out, 0, sizeof(out));
    *p++ = OSSL_PARAM_construct_octet_string("test_entropy",
                                             seed, sizeof(seed));
    *p++ = OSSL_PARAM_construct_uint("max_request", &step);
    *p = OSSL_PARAM_construct_end();
    res = test_true("../test/evp_extra_test.c", 3538, "EVP_RAND_CTX_set_params(ctx, params)", (EVP_RAND_CTX_set_params(ctx, params)) != 0)
          && test_true("../test/evp_extra_test.c", 3539, "EVP_RAND_generate(ctx, out, sizeof(out), 0, 1, NULL, 0)", (EVP_RAND_generate(ctx, out, sizeof(out), 0, 1, 
# 3539 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 3539 "../test/evp_extra_test.c"
            , 0)) != 0)
          && test_mem_eq("../test/evp_extra_test.c", 3540, "seed", "out", seed, sizeof(seed), out, sizeof(out));
...
# 3579 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 3579 "../test/evp_extra_test.c"
                                ;
    int iv_reset = 0;

    if (nullprov != 
# 3582 "../test/evp_extra_test.c" 3 4
                   ((void *)0) 
# 3582 "../test/evp_extra_test.c"
                        && idx < 6)
        return test_skip("../test/evp_extra_test.c", 3583, "Test does not support a non-default library context");
    ...
    case 6:
        type = (type != 
# 3590 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3590 "../test/evp_extra_test.c"
                           ) ? type :
    ...
    case 7:
        type = (type != 
# 3600 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3600 "../test/evp_extra_test.c"
                           ) ? type :
        ...
        break;
    case 2:
        type = EVP_aes_128_cfb128();

    case 8:
        type = (type != 
# 3610 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3610 "../test/evp_extra_test.c"
                           ) ? type :
    ...
    case 9:
        type = (type != 
# 3620 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3620 "../test/evp_extra_test.c"
                           ) ? type :
    ...
    case 10:
        type = (type != 
# 3629 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3629 "../test/evp_extra_test.c"
                           ) ? type :
    ...
    case 11:
        type = (type != 
# 3643 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3643 "../test/evp_extra_test.c"
                           ) ? type :
    ...
    if (!test_ptr("../test/evp_extra_test.c", 3653, "type", type)
            || !test_ptr("../test/evp_extra_test.c", 3654, "(ctx = EVP_CIPHER_CTX_new())", (ctx = EVP_CIPHER_CTX_new()))
            || !test_true("../test/evp_extra_test.c", 3655, "EVP_EncryptInit_ex(ctx, type, NULL, key, init_iv)", (EVP_EncryptInit_ex(ctx, type, 
# 3655 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3655 "../test/evp_extra_test.c"
               , key, init_iv)) != 0)
            || !test_true("../test/evp_extra_test.c", 3656, "EVP_EncryptUpdate(ctx, ciphertext, &len, msg, (int)sizeof(msg))", (EVP_EncryptUpdate(ctx, ciphertext, &len, msg, (int)sizeof(msg))) != 0)

            || !test_true("../test/evp_extra_test.c", 3658, "EVP_CIPHER_CTX_get_original_iv(ctx, oiv, sizeof(oiv))", (EVP_CIPHER_CTX_get_original_iv(ctx, oiv, sizeof(oiv))) != 0)
            || !test_true("../test/evp_extra_test.c", 3659, "EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))) != 0)
            || !test_true("../test/evp_extra_test.c", 3660, "EVP_EncryptFinal_ex(ctx, ciphertext, &len)", (EVP_EncryptFinal_ex(ctx, ciphertext, &len)) != 0))
        goto err;
    ivlen = EVP_CIPHER_CTX_get_iv_length(ctx);

    if (!test_int_gt("../test/evp_extra_test.c", 3664, "ivlen", "0", ivlen, 0))
        goto err;

    if (!test_mem_eq("../test/evp_extra_test.c", 3667, "init_iv", "oiv", init_iv, ivlen, oiv, ivlen)
            || !test_mem_eq("../test/evp_extra_test.c", 3668, "ref_iv", "iv", ref_iv, ref_len, iv, ivlen))
        goto err;


    if (!test_true("../test/evp_extra_test.c", 3672, "EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, NULL)", (EVP_EncryptInit_ex(ctx, 
# 3672 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3672 "../test/evp_extra_test.c"
        , 
# 3672 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3672 "../test/evp_extra_test.c"
...
# 3672 "../test/evp_extra_test.c"
        ...
        || !test_true("../test/evp_extra_test.c", 3673, "EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))) != 0))
        goto err;
    if (iv_reset) {
        if (!test_mem_eq("../test/evp_extra_test.c", 3676, "init_iv", "iv", init_iv, ivlen, iv, ivlen))
            goto err;
    } else {
        if (!test_mem_eq("../test/evp_extra_test.c", 3679, "ref_iv", "iv", ref_iv, ivlen, iv, ivlen))
            goto err;
    }
...
static int test_evp_iv_des(int idx)
{
    int ret = 0;
    EVP_CIPHER_CTX *ctx = 
# 3695 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 3695 "../test/evp_extra_test.c"
                             ;
    ...
    size_t ivlen, ref_len;
    EVP_CIPHER *type = 
# 3728 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 3728 "../test/evp_extra_test.c"
                          ;

    if (lgcyprov == 
# 3730 "../test/evp_extra_test.c" 3 4
                   ((void *)0) 
# 3730 "../test/evp_extra_test.c"
                        && idx < 3)
        return test_skip("../test/evp_extra_test.c", 3731, "Test requires legacy provider to be loaded");
    ...
    if (!test_ptr("../test/evp_extra_test.c", 3768, "type", type)
            || !test_ptr("../test/evp_extra_test.c", 3769, "(ctx = EVP_CIPHER_CTX_new())", (ctx = EVP_CIPHER_CTX_new()))
            || !test_true("../test/evp_extra_test.c", 3770, "EVP_EncryptInit_ex(ctx, type, NULL, key, init_iv)", (EVP_EncryptInit_ex(ctx, type, 
# 3770 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 3770 "../test/evp_extra_test.c"
               , key, init_iv)) != 0)
            || !test_true("../test/evp_extra_test.c", 3771, "EVP_EncryptUpdate(ctx, ciphertext, &len, msg, (int)sizeof(msg))", (EVP_EncryptUpdate(ctx, ciphertext, &len, msg, (int)sizeof(msg))) != 0)

            || !test_true("../test/evp_extra_test.c", 3773, "EVP_CIPHER_CTX_get_original_iv(ctx, oiv, sizeof(oiv))", (EVP_CIPHER_CTX_get_original_iv(ctx, oiv, sizeof(oiv))) != 0)
            || !test_true("../test/evp_extra_test.c", 3774, "EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))) != 0)
            || !test_true("../test/evp_extra_test.c", 3775, "EVP_EncryptFinal_ex(ctx, ciphertext, &len)", (EVP_EncryptFinal_ex(ctx, ciphertext, &len)) != 0))
        goto err;
    ivlen = EVP_CIPHER_CTX_get_iv_length(ctx);

    if (!test_int_gt("../test/evp_extra_test.c", 3779, "ivlen", "0", ivlen, 0))
        goto err;

    if (!test_mem_eq("../test/evp_extra_test.c", 3782, "init_iv", "oiv", init_iv, ivlen, oiv, ivlen)
            || !test_mem_eq("../test/evp_extra_test.c", 3783, "ref_iv", "iv", ref_iv, ref_len, iv, ivlen))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3786, "EVP_EncryptInit_ex(ctx, NULL, NULL, NULL, NULL)", (EVP_EncryptInit_ex(ctx, 
# 3786 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3786 "../test/evp_extra_test.c"
        , 
# 3786 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3786 "../test/evp_extra_test.c"
...
# 3786 "../test/evp_extra_test.c"
        ...
        || !test_true("../test/evp_extra_test.c", 3787, "EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, iv, sizeof(iv))) != 0))
        goto err;
    if (!test_mem_eq("../test/evp_extra_test.c", 3789, "init_iv", "iv", init_iv, ivlen, iv, ivlen))
        goto err;
...
static int test_evp_bf_default_keylen(int idx)
{
    ...
    int ivlen[4] = { 0, 8, 8, 8 };
    EVP_CIPHER *cipher = 
# 3808 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 3808 "../test/evp_extra_test.c"
                            ;

    if (lgcyprov == 
# 3810 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3810 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 3811, "Test requires legacy provider to be loaded");

    if (!test_ptr("../test/evp_extra_test.c", 3813, "cipher = EVP_CIPHER_fetch(testctx, algos[idx], testpropq)", cipher = EVP_CIPHER_fetch(testctx, algos[idx], testpropq))
            || !test_int_eq("../test/evp_extra_test.c", 3814, "EVP_CIPHER_get_key_length(cipher)", "16", EVP_CIPHER_get_key_length(cipher), 16)
            || !test_int_eq("../test/evp_extra_test.c", 3815, "EVP_CIPHER_get_iv_length(cipher)", "ivlen[idx]", EVP_CIPHER_get_iv_length(cipher), ivlen[idx]))
        goto err;
...
static int test_ecpub(int idx)
{
    ...
    unsigned char *p;
    EVP_PKEY *pkey = 
# 3842 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3842 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 3843 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3843 "../test/evp_extra_test.c"
                           ;

    const unsigned char *q;
    EVP_PKEY *pkey2 = 
# 3846 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 3846 "../test/evp_extra_test.c"
                         ;
    EC_KEY *ec = 
# 3847 "../test/evp_extra_test.c" 3 4
                ((void *)0)
# 3847 "../test/evp_extra_test.c"
                    ;


    if (nullprov != 
# 3850 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 3850 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 3851, "Test does not support a non-default library context");

    nid = ecpub_nids[idx];

    ctx = EVP_PKEY_CTX_new_id(408, 
# 3855 "../test/evp_extra_test.c" 3 4
                                          ((void *)0)
# 3855 "../test/evp_extra_test.c"
                                              );
    if (!test_ptr("../test/evp_extra_test.c", 3856, "ctx", ctx)
        || !test_int_gt("../test/evp_extra_test.c", 3857, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0)
        || !test_int_gt("../test/evp_extra_test.c", 3858, "EVP_PKEY_CTX_set_ec_paramgen_curve_nid(ctx, nid)", "0", EVP_PKEY_CTX_set_ec_paramgen_curve_nid(ctx, nid), 0)
        || !test_true("../test/evp_extra_test.c", 3859, "EVP_PKEY_keygen(ctx, &pkey)", (EVP_PKEY_keygen(ctx, &pkey)) != 0))
        goto done;
    len = i2d_PublicKey(pkey, 
# 3861 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 3861 "../test/evp_extra_test.c"
                                 );
    savelen = len;
    if (!test_int_ge("../test/evp_extra_test.c", 3863, "len", "1", len, 1)
        || !test_int_lt("../test/evp_extra_test.c", 3864, "len", "1024", len, 1024))
        goto done;
    p = buf;
    len = i2d_PublicKey(pkey, &p);
    if (!test_int_ge("../test/evp_extra_test.c", 3868, "len", "1", len, 1)
            || !test_int_eq("../test/evp_extra_test.c", 3869, "len", "savelen", len, savelen))
        goto done;



    q = buf;
    if (!test_ptr("../test/evp_extra_test.c", 3875, "(pkey2 = EVP_PKEY_new())", (pkey2 = EVP_PKEY_new()))
            || !test_ptr("../test/evp_extra_test.c", 3876, "(ec = EC_KEY_new_by_curve_name(nid))", (ec = EC_KEY_new_by_curve_name(nid)))
            || !test_true("../test/evp_extra_test.c", 3877, "EVP_PKEY_assign_EC_KEY(pkey2, ec)", (EVP_PKEY_assign((pkey2), 408, (ec))) != 0))
        goto done;

    ec = 
# 3880 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 3880 "../test/evp_extra_test.c"
            ;
    if (!test_ptr("../test/evp_extra_test.c", 3881, "d2i_PublicKey(EVP_PKEY_EC, &pkey2, &q, savelen)", d2i_PublicKey(408, &pkey2, &q, savelen)))
        goto done;

    if (!test_int_eq("../test/evp_extra_test.c", 3884, "EVP_PKEY_eq(pkey, pkey2)", "1", EVP_PKEY_eq(pkey, pkey2), 1))
        goto done;
...
static int test_EVP_rsa_pss_with_keygen_bits(void)
{
    int ret = 0;
    EVP_PKEY_CTX *ctx = 
# 3904 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 3904 "../test/evp_extra_test.c"
                           ;
    EVP_PKEY *pkey = 
# 3905 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3905 "../test/evp_extra_test.c"
                        ;
    EVP_MD *md;

    md = EVP_MD_fetch(testctx, "sha256", testpropq);
    ret = test_ptr("../test/evp_extra_test.c", 3909, "md", md)
        && test_ptr("../test/evp_extra_test.c", 3910, "(ctx = EVP_PKEY_CTX_new_from_name(testctx, \"RSA-PSS\", testpropq))", (ctx = EVP_PKEY_CTX_new_from_name(testctx, "RSA-PSS", testpropq)))
        && test_int_gt("../test/evp_extra_test.c", 3911, "EVP_PKEY_keygen_init(ctx)", "0", EVP_PKEY_keygen_init(ctx), 0)
        && test_int_gt("../test/evp_extra_test.c", 3912, "EVP_PKEY_CTX_set_rsa_keygen_bits(ctx, 512)", "0", EVP_PKEY_CTX_set_rsa_keygen_bits(ctx, 512), 0)
        && test_int_gt("../test/evp_extra_test.c", 3913, "EVP_PKEY_CTX_set_rsa_pss_keygen_md(ctx, md)", "0", EVP_PKEY_CTX_set_rsa_pss_keygen_md(ctx, md), 0)
        && test_true("../test/evp_extra_test.c", 3914, "EVP_PKEY_keygen(ctx, &pkey)", (EVP_PKEY_keygen(ctx, &pkey)) != 0);
...
static int test_EVP_rsa_pss_set_saltlen(void)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 3925 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3925 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY_CTX *pkey_ctx = 
# 3926 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 3926 "../test/evp_extra_test.c"
                                ;
    EVP_MD *sha256 = 
# 3927 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3927 "../test/evp_extra_test.c"
                        ;
    EVP_MD_CTX *sha256_ctx = 
# 3928 "../test/evp_extra_test.c" 3 4
                            ((void *)0)
# 3928 "../test/evp_extra_test.c"
                                ;
    int saltlen = 9999;
    const int test_value = 32;

    ret = test_ptr("../test/evp_extra_test.c", 3932, "pkey = load_example_rsa_key()", pkey = load_example_rsa_key())
        && test_ptr("../test/evp_extra_test.c", 3933, "sha256 = EVP_MD_fetch(testctx, \"sha256\", NULL)", sha256 = EVP_MD_fetch(testctx, "sha256", 
# 3933 "../test/evp_extra_test.c" 3 4
          ((void *)0)
# 3933 "../test/evp_extra_test.c"
          ))
        && test_ptr("../test/evp_extra_test.c", 3934, "sha256_ctx = EVP_MD_CTX_new()", sha256_ctx = EVP_MD_CTX_new())
        && test_true("../test/evp_extra_test.c", 3935, "EVP_DigestSignInit(sha256_ctx, &pkey_ctx, sha256, NULL, pkey)", (EVP_DigestSignInit(sha256_ctx, &pkey_ctx, sha256, 
# 3935 "../test/evp_extra_test.c" 3 4
          ((void *)0)
# 3935 "../test/evp_extra_test.c"
          , pkey)) != 0)
        && test_true("../test/evp_extra_test.c", 3936, "EVP_PKEY_CTX_set_rsa_padding(pkey_ctx, RSA_PKCS1_PSS_PADDING)", (EVP_PKEY_CTX_set_rsa_padding(pkey_ctx, 6)) != 0)
        && test_int_gt("../test/evp_extra_test.c", 3937, "EVP_PKEY_CTX_set_rsa_pss_saltlen(pkey_ctx, test_value)", "0", EVP_PKEY_CTX_set_rsa_pss_saltlen(pkey_ctx, test_value), 0)
        && test_int_gt("../test/evp_extra_test.c", 3938, "EVP_PKEY_CTX_get_rsa_pss_saltlen(pkey_ctx, &saltlen)", "0", EVP_PKEY_CTX_get_rsa_pss_saltlen(pkey_ctx, &saltlen), 0)
        && test_int_eq("../test/evp_extra_test.c", 3939, "saltlen", "test_value", saltlen, test_value);
...
static void md_names(const char *name, void *vctx)
{
    ...
    EVP_CIPHER *aes128 = EVP_CIPHER_fetch(ctx, "AES-128-CBC", 
# 3953 "../test/evp_extra_test.c" 3 4
                                                             ((void *)0)
# 3953 "../test/evp_extra_test.c"
                                                                 );

    if (!test_ptr("../test/evp_extra_test.c", 3955, "aes128", aes128))
        success = 0;
...
static int test_names_do_all(void)
{
    ...
    EVP_MD *sha256 = 
# 3969 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 3969 "../test/evp_extra_test.c"
                        ;
    int testresult = 0;

    if (!test_ptr("../test/evp_extra_test.c", 3972, "ctx", ctx))
        goto err;

    sha256 = EVP_MD_fetch(ctx, "SHA2-256", 
# 3975 "../test/evp_extra_test.c" 3 4
                                          ((void *)0)
# 3975 "../test/evp_extra_test.c"
                                              );
    if (!test_ptr("../test/evp_extra_test.c", 3976, "sha256", sha256))
        goto err;
    ...
    if (!test_true("../test/evp_extra_test.c", 3983, "EVP_MD_names_do_all(sha256, md_names, ctx)", (EVP_MD_names_do_all(sha256, md_names, ctx)) != 0))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 3986, "success", (success) != 0))
        goto err;
...
static const EVP_INIT_TEST_st evp_init_tests[] = {
    {
        ...
        cfbCiphertext, 
# 4015 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4015 "../test/evp_extra_test.c"
                          , 0, sizeof(cfbPlaintext), sizeof(cfbCiphertext),
        0, 1, 0, 1
    },
    {
    ...
    },
    {
        "aes-128-cfb", kCFBDefaultKey, iCFBIV, cfbPlaintext,
        cfbCiphertext, 
# 4026 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4026 "../test/evp_extra_test.c"
                          , 0, sizeof(cfbPlaintext), sizeof(cfbCiphertext),
        0, 0, 0, 1
    },
    {
    ...
    },
    {
        ...
        cfbPlaintext, 
# 4037 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 4037 "../test/evp_extra_test.c"
                         , 0, sizeof(cfbCiphertext), sizeof(cfbPlaintext),
        0, 1, 1, 0
    },
    {
    ...
    },
    {
        "aes-128-cfb", kCFBDefaultKey, iCFBIV, cfbCiphertext,
        cfbPlaintext, 
# 4048 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 4048 "../test/evp_extra_test.c"
                         , 0, sizeof(cfbCiphertext), sizeof(cfbPlaintext),
        0, 0, 1, 0
    },
    {
...
# 4063 "../test/evp_extra_test.c" 3 4
                              ((void *)0)
# 4063 "../test/evp_extra_test.c"
...
# 4068 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 4068 "../test/evp_extra_test.c"
...
# 4073 "../test/evp_extra_test.c" 3 4
                              ((void *)0)
# 4073 "../test/evp_extra_test.c"
                                  , 0, sizeof(cfbPlaintext_partial),
    ...
    },
    {
        ...
        cfbPlaintext_partial, 
# 4078 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 4078 "../test/evp_extra_test.c"
...
static int evp_init_seq_set_iv(EVP_CIPHER_CTX *ctx, const EVP_INIT_TEST_st *t)
{
    ...
    if (t->ivlen != 0) {
        if (!test_int_gt("../test/evp_extra_test.c", 4088, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_GCM_SET_IVLEN, t->ivlen, NULL)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x9, t->ivlen, 
# 4088 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4088 "../test/evp_extra_test.c"
            ), 0))
            goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4091, "EVP_CipherInit_ex(ctx, NULL, NULL, NULL, t->iv, -1)", (EVP_CipherInit_ex(ctx, 
# 4091 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4091 "../test/evp_extra_test.c"
        , 
# 4091 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4091 "../test/evp_extra_test.c"
...
static int test_evp_init_seq(int idx)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 4110 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4110 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *type = 
# 4111 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4111 "../test/evp_extra_test.c"
                          ;
    size_t taglen = sizeof(tag);
    char *errmsg = 
# 4113 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4113 "../test/evp_extra_test.c"
                      ;

    ctx = EVP_CIPHER_CTX_new();
    if (ctx == 
# 4116 "../test/evp_extra_test.c" 3 4
              ((void *)0)
# 4116 "../test/evp_extra_test.c"
                  ) {
        errmsg = "CTX_ALLOC";
        goto err;
    }
    if (!test_ptr("../test/evp_extra_test.c", 4120, "type = EVP_CIPHER_fetch(testctx, t->cipher, testpropq)", type = EVP_CIPHER_fetch(testctx, t->cipher, testpropq))) {
        errmsg = "CIPHER_FETCH";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4124, "EVP_CipherInit_ex(ctx, type, NULL, NULL, NULL, t->initenc)", (EVP_CipherInit_ex(ctx, type, 
# 4124 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4124 "../test/evp_extra_test.c"
        , 
# 4124 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4124 "../test/evp_extra_test.c"
...
# 4124 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4128, "EVP_CIPHER_CTX_set_padding(ctx, 0)", (EVP_CIPHER_CTX_set_padding(ctx, 0)) != 0)) {
        errmsg = "PADDING";
        goto err;
    }
    if (t->keyfirst && !test_true("../test/evp_extra_test.c", 4132, "EVP_CipherInit_ex(ctx, NULL, NULL, t->key, NULL, -1)", (EVP_CipherInit_ex(ctx, 
# 4132 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 4132 "../test/evp_extra_test.c"
                       , 
# 4132 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 4132 "../test/evp_extra_test.c"
...
# 4132 "../test/evp_extra_test.c"
    ...
    if (t->keyfirst == 0 && !test_true("../test/evp_extra_test.c", 4140, "EVP_CipherInit_ex(ctx, NULL, NULL, t->key, NULL, -1)", (EVP_CipherInit_ex(ctx, 
# 4140 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 4140 "../test/evp_extra_test.c"
                             , 
# 4140 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 4140 "../test/evp_extra_test.c"
...
# 4140 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4144, "EVP_CipherInit_ex(ctx, NULL, NULL, NULL, NULL, t->finalenc)", (EVP_CipherInit_ex(ctx, 
# 4144 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4144 "../test/evp_extra_test.c"
        , 
# 4144 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4144 "../test/evp_extra_test.c"
...
# 4144 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4148, "EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)", (EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)) != 0)) {
        errmsg = "CIPHER_UPDATE";
        goto err;
    }
    if (t->finalenc == 0 && t->tag != 
# 4152 "../test/evp_extra_test.c" 3 4
                                     ((void *)0)
# 4152 "../test/evp_extra_test.c"
                                         ) {

        if (!test_int_gt("../test/evp_extra_test.c", 4154, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_TAG, t->taglen, (void *)t->tag)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x11, t->taglen, (void *)t->tag), 0)
                                                                         ) {
            errmsg = "SET_TAG";
            goto err;
        }
    }
    if (!test_true("../test/evp_extra_test.c", 4160, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4164, "t->expected", "outbuf", t->expected, t->expectedlen, outbuf, outlen1 + outlen2)) {
        errmsg = "WRONG_RESULT";
        goto err;
    }
    if (t->finalenc != 0 && t->tag != 
# 4168 "../test/evp_extra_test.c" 3 4
                                     ((void *)0)
# 4168 "../test/evp_extra_test.c"
                                         ) {
        if (!test_int_gt("../test/evp_extra_test.c", 4169, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, taglen, tag)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x10, taglen, tag), 0)) {
            errmsg = "GET_TAG";
            goto err;
        }
        if (!test_mem_eq("../test/evp_extra_test.c", 4173, "t->tag", "tag", t->tag, t->taglen, tag, taglen)) {
            errmsg = "TAG_ERROR";
            goto err;
        }
    }
 ...
 err:
    if (errmsg != 
# 4180 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 4180 "../test/evp_extra_test.c"
                     )
        test_info("../test/evp_extra_test.c", 4181, "evp_init_test %d: %s", idx, errmsg);
    EVP_CIPHER_CTX_free(ctx);
    EVP_CIPHER_free(type);
    return testresult;
}
...
static int test_evp_reinit_seq(int idx)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 4198 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4198 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *type = 
# 4199 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4199 "../test/evp_extra_test.c"
                          ;

    if (!test_ptr("../test/evp_extra_test.c", 4201, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_ptr("../test/evp_extra_test.c", 4202, "type = EVP_CIPHER_fetch(testctx, t->cipher, testpropq)", type = EVP_CIPHER_fetch(testctx, t->cipher, testpropq))

            || !test_true("../test/evp_extra_test.c", 4204, "EVP_CipherInit_ex2(ctx, type, t->key, t->iv, t->initenc, NULL)", (EVP_CipherInit_ex2(ctx, type, t->key, t->iv, t->initenc, 
# 4204 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 4204 "../test/evp_extra_test.c"
               )) != 0)

            || !test_true("../test/evp_extra_test.c", 4206, "EVP_CipherUpdate(ctx, outbuf1, &outlen1, t->input, t->inlen)", (EVP_CipherUpdate(ctx, outbuf1, &outlen1, t->input, t->inlen)) != 0)
            || !test_true("../test/evp_extra_test.c", 4207, "EVP_CipherFinal_ex(ctx, outbuf1, &outlen_final)", (EVP_CipherFinal_ex(ctx, outbuf1, &outlen_final)) != 0)

            || !test_mem_eq("../test/evp_extra_test.c", 4209, "t->expected", "outbuf1", t->expected, t->expectedlen, outbuf1, outlen1 + outlen_final)

            || !test_true("../test/evp_extra_test.c", 4211, "EVP_CipherInit_ex2(ctx, NULL, NULL, NULL, -1, NULL)", (EVP_CipherInit_ex2(ctx, 
# 4211 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 4211 "../test/evp_extra_test.c"
               , 
# 4211 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 4211 "../test/evp_extra_test.c"
...
# 4211 "../test/evp_extra_test.c"
            ...
            || !test_true("../test/evp_extra_test.c", 4213, "EVP_CipherUpdate(ctx, outbuf2, &outlen2, t->input, t->inlen)", (EVP_CipherUpdate(ctx, outbuf2, &outlen2, t->input, t->inlen)) != 0)
            || !test_true("../test/evp_extra_test.c", 4214, "EVP_CipherFinal_ex(ctx, outbuf2, &outlen_final)", (EVP_CipherFinal_ex(ctx, outbuf2, &outlen_final)) != 0)

            || !test_mem_eq("../test/evp_extra_test.c", 4216, "t->expected", "outbuf2", t->expected, t->expectedlen, outbuf2, outlen2 + outlen_final))
        goto err;
    testresult = 1;
 err:
    EVP_CIPHER_CTX_free(ctx);
...
static int test_evp_reset(int idx)
{
    ...
    unsigned char outbuf[1024];
    EVP_CIPHER_CTX *ctx = 
# 4254 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4254 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *type = 
# 4255 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4255 "../test/evp_extra_test.c"
                          ;
    char *errmsg = 
# 4256 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4256 "../test/evp_extra_test.c"
                      ;

    if (!test_ptr("../test/evp_extra_test.c", 4258, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())) {
        errmsg = "CTX_ALLOC";
        goto err;
    }
    if (!test_ptr("../test/evp_extra_test.c", 4262, "type = EVP_CIPHER_fetch(testctx, \"aes-128-cfb\", testpropq)", type = EVP_CIPHER_fetch(testctx, "aes-128-cfb", testpropq))) {
        errmsg = "CIPHER_FETCH";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4266, "EVP_CipherInit_ex(ctx, type, NULL, kCFBDefaultKey, iCFBIV, t->enc)", (EVP_CipherInit_ex(ctx, type, 
# 4266 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4266 "../test/evp_extra_test.c"
        , kCFBDefaultKey, iCFBIV, t->enc)) != 0)) {
        errmsg = "CIPHER_INIT";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4270, "EVP_CIPHER_CTX_set_padding(ctx, 0)", (EVP_CIPHER_CTX_set_padding(ctx, 0)) != 0)) {
        errmsg = "PADDING";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4274, "EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)", (EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)) != 0)) {
        errmsg = "CIPHER_UPDATE";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4278, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4282, "t->expected", "outbuf", t->expected, t->expectedlen, outbuf, outlen1 + outlen2)) {
        errmsg = "WRONG_RESULT";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4286, "EVP_CipherInit_ex(ctx, NULL, NULL, NULL, NULL, -1)", (EVP_CipherInit_ex(ctx, 
# 4286 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4286 "../test/evp_extra_test.c"
        , 
# 4286 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4286 "../test/evp_extra_test.c"
...
# 4286 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4290, "EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)", (EVP_CipherUpdate(ctx, outbuf, &outlen1, t->input, t->inlen)) != 0)) {
        errmsg = "CIPHER_UPDATE (reinit)";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4294, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL (reinit)";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4298, "t->expected", "outbuf", t->expected, t->expectedlen, outbuf, outlen1 + outlen2)) {
 ...
 err:
    if (errmsg != 
# 4304 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 4304 "../test/evp_extra_test.c"
                     )
        test_info("../test/evp_extra_test.c", 4305, "test_evp_reset %d: %s", idx, errmsg);
    EVP_CIPHER_CTX_free(ctx);
    EVP_CIPHER_free(type);
    return testresult;
}
...
static int test_evp_updated_iv(int idx)
{
    ...
    unsigned char outbuf[1024];
    EVP_CIPHER_CTX *ctx = 
# 4365 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4365 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *type = 
# 4366 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4366 "../test/evp_extra_test.c"
                          ;
    unsigned char updated_iv[16];
    int iv_len;
    char *errmsg = 
# 4369 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4369 "../test/evp_extra_test.c"
                      ;

    if (!test_ptr("../test/evp_extra_test.c", 4371, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())) {
        errmsg = "CTX_ALLOC";
        goto err;
    }
    if ((type = EVP_CIPHER_fetch(testctx, t->cipher, testpropq)) == 
# 4375 "../test/evp_extra_test.c" 3 4
                                                                   ((void *)0)
# 4375 "../test/evp_extra_test.c"
                                                                       ) {
        test_info("../test/evp_extra_test.c", 4376, "cipher %s not supported, skipping", t->cipher);
        goto ok;
    }

    if (!test_true("../test/evp_extra_test.c", 4380, "EVP_CipherInit_ex(ctx, type, NULL, kCFBDefaultKey, iCFBIV, t->enc)", (EVP_CipherInit_ex(ctx, type, 
# 4380 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4380 "../test/evp_extra_test.c"
        , kCFBDefaultKey, iCFBIV, t->enc)) != 0)) {
        errmsg = "CIPHER_INIT";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4384, "EVP_CIPHER_CTX_set_padding(ctx, 0)", (EVP_CIPHER_CTX_set_padding(ctx, 0)) != 0)) {
        errmsg = "PADDING";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4388, "EVP_CipherUpdate(ctx, outbuf, &outlen1, cfbPlaintext, sizeof(cfbPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen1, cfbPlaintext, sizeof(cfbPlaintext))) != 0)) {
        errmsg = "CIPHER_UPDATE";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4392, "EVP_CIPHER_CTX_get_updated_iv(ctx, updated_iv, sizeof(updated_iv))", (EVP_CIPHER_CTX_get_updated_iv(ctx, updated_iv, sizeof(updated_iv))) != 0)) {
        errmsg = "CIPHER_CTX_GET_UPDATED_IV";
        goto err;
    }
    iv_len = EVP_CIPHER_CTX_get_iv_length(ctx);
    if (!test_int_ge("../test/evp_extra_test.c", 4397, "iv_len", "0", iv_len, 0)) {
        errmsg = "CIPHER_CTX_GET_IV_LEN";
        goto err;
    }
    if (!test_mem_ne("../test/evp_extra_test.c", 4401, "iCFBIV", "updated_iv", iCFBIV, sizeof(iCFBIV), updated_iv, iv_len)) {
        errmsg = "IV_NOT_UPDATED";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4405, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL";
        goto err;
    }
 ok:
 ...
 err:
    if (errmsg != 
# 4412 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 4412 "../test/evp_extra_test.c"
                     )
        test_info("../test/evp_extra_test.c", 4413, "test_evp_updated_iv %d: %s", idx, errmsg);
    EVP_CIPHER_CTX_free(ctx);
    EVP_CIPHER_free(type);
    return testresult;
}
...
static int test_gcm_reinit(int idx)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 4452 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4452 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *type = 
# 4453 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4453 "../test/evp_extra_test.c"
                          ;
    size_t taglen = sizeof(tag);
    char *errmsg = 
# 4455 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4455 "../test/evp_extra_test.c"
                      ;

    if (!test_ptr("../test/evp_extra_test.c", 4457, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())) {
        errmsg = "CTX_ALLOC";
        goto err;
    }
    if (!test_ptr("../test/evp_extra_test.c", 4461, "type = EVP_CIPHER_fetch(testctx, \"aes-256-gcm\", testpropq)", type = EVP_CIPHER_fetch(testctx, "aes-256-gcm", testpropq))) {
        errmsg = "CIPHER_FETCH";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4465, "EVP_CipherInit_ex(ctx, type, NULL, NULL, NULL, 1)", (EVP_CipherInit_ex(ctx, type, 
# 4465 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4465 "../test/evp_extra_test.c"
        , 
# 4465 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4465 "../test/evp_extra_test.c"
...
# 4465 "../test/evp_extra_test.c"
    ...
    if (!test_int_gt("../test/evp_extra_test.c", 4469, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_GCM_SET_IVLEN, t->ivlen1, NULL)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x9, t->ivlen1, 
# 4469 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4469 "../test/evp_extra_test.c"
        ), 0)) {
        errmsg = "SET_IVLEN1";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4473, "EVP_CipherInit_ex(ctx, NULL, NULL, kGCMResetKey, t->iv1, 1)", (EVP_CipherInit_ex(ctx, 
# 4473 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4473 "../test/evp_extra_test.c"
        , 
# 4473 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4473 "../test/evp_extra_test.c"
        , kGCMResetKey, t->iv1, 1)) != 0)) {
        errmsg = "SET_IV1";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4477, "EVP_CipherUpdate(ctx, NULL, &outlen3, gcmAAD, sizeof(gcmAAD))", (EVP_CipherUpdate(ctx, 
# 4477 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4477 "../test/evp_extra_test.c"
        , &outlen3, gcmAAD, sizeof(gcmAAD))) != 0)) {
        errmsg = "AAD1";
        goto err;
    }
    EVP_CIPHER_CTX_set_padding(ctx, 0);
    if (!test_true("../test/evp_extra_test.c", 4482, "EVP_CipherUpdate(ctx, outbuf, &outlen1, gcmResetPlaintext, sizeof(gcmResetPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen1, gcmResetPlaintext, sizeof(gcmResetPlaintext))) != 0)
                                                               ) {
        errmsg = "CIPHER_UPDATE1";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4487, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL1";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4491, "t->expected1", "outbuf", t->expected1, t->expectedlen1, outbuf, outlen1 + outlen2)) {
        errmsg = "WRONG_RESULT1";
        goto err;
    }
    if (!test_int_gt("../test/evp_extra_test.c", 4495, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, taglen, tag)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x10, taglen, tag), 0)) {
        errmsg = "GET_TAG1";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4499, "t->tag1", "tag", t->tag1, taglen, tag, taglen)) {
        errmsg = "TAG_ERROR1";
        goto err;
    }

    if (!test_int_gt("../test/evp_extra_test.c", 4504, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_GCM_SET_IVLEN, t->ivlen2, NULL)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x9, t->ivlen2, 
# 4504 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4504 "../test/evp_extra_test.c"
        ), 0)) {
        errmsg = "SET_IVLEN2";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4508, "EVP_CipherInit_ex(ctx, NULL, NULL, NULL, t->iv2, -1)", (EVP_CipherInit_ex(ctx, 
# 4508 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4508 "../test/evp_extra_test.c"
        , 
# 4508 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4508 "../test/evp_extra_test.c"
...
# 4508 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4512, "EVP_CipherUpdate(ctx, NULL, &outlen3, gcmAAD, sizeof(gcmAAD))", (EVP_CipherUpdate(ctx, 
# 4512 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4512 "../test/evp_extra_test.c"
        , &outlen3, gcmAAD, sizeof(gcmAAD))) != 0)) {
        errmsg = "AAD2";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4516, "EVP_CipherUpdate(ctx, outbuf, &outlen1, gcmResetPlaintext, sizeof(gcmResetPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen1, gcmResetPlaintext, sizeof(gcmResetPlaintext))) != 0)
                                                               ) {
        errmsg = "CIPHER_UPDATE2";
        goto err;
    }
    if (!test_true("../test/evp_extra_test.c", 4521, "EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)", (EVP_CipherFinal_ex(ctx, outbuf + outlen1, &outlen2)) != 0)) {
        errmsg = "CIPHER_FINAL2";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4525, "t->expected2", "outbuf", t->expected2, t->expectedlen2, outbuf, outlen1 + outlen2)) {
        errmsg = "WRONG_RESULT2";
        goto err;
    }
    if (!test_int_gt("../test/evp_extra_test.c", 4529, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, taglen, tag)", "0", EVP_CIPHER_CTX_ctrl(ctx, 0x10, taglen, tag), 0)) {
        errmsg = "GET_TAG2";
        goto err;
    }
    if (!test_mem_eq("../test/evp_extra_test.c", 4533, "t->tag2", "tag", t->tag2, taglen, tag, taglen)) {
        errmsg = "TAG_ERROR2";
        goto err;
    }
    testresult = 1;
 err:
    if (errmsg != 
# 4539 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 4539 "../test/evp_extra_test.c"
                     )
        test_info("../test/evp_extra_test.c", 4540, "evp_init_test %d: %s", idx, errmsg);
    EVP_CIPHER_CTX_free(ctx);
    EVP_CIPHER_free(type);
    return testresult;
}
...
static int test_ivlen_change(int idx)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 4564 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4564 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *ciph = 
# 4565 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4565 "../test/evp_extra_test.c"
                          ;
    OSSL_PARAM params[] = { { 
# 4566 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 4566 "../test/evp_extra_test.c"
                           , 0, 
# 4566 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 4566 "../test/evp_extra_test.c"
...
# 4566 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 4569, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 4572, "ciph = EVP_CIPHER_fetch(testctx, ivlen_change_ciphers[idx], testpropq)", ciph = EVP_CIPHER_fetch(testctx, ivlen_change_ciphers[idx], testpropq))
                                                     )
        goto err;

    if (!test_true("../test/evp_extra_test.c", 4576, "EVP_CipherInit_ex(ctx, ciph, NULL, kGCMDefaultKey, iv, 1)", (EVP_CipherInit_ex(ctx, ciph, 
# 4576 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4576 "../test/evp_extra_test.c"
        , kGCMDefaultKey, iv, 1)) != 0))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 4579, "EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))) != 0)
                                                                 )
        goto err;

    params[0] = OSSL_PARAM_construct_size_t("ivlen",
                                            &ivlen);
    if (!test_true("../test/evp_extra_test.c", 4585, "EVP_CIPHER_CTX_set_params(ctx, params)", (EVP_CIPHER_CTX_set_params(ctx, params)) != 0))
        goto err;

    ERR_set_mark();
    if (!test_false("../test/evp_extra_test.c", 4589, "EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))) != 0)
                                                                 ) {
        ERR_clear_last_mark();
        goto err;
    }
...
# 4619 "../test/evp_extra_test.c" 3 4
   ((void *)0)

# 4620 "../test/evp_extra_test.c"
};
...
static int test_keylen_change(int idx)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 4632 "../test/evp_extra_test.c" 3 4
                         ((void *)0)
# 4632 "../test/evp_extra_test.c"
                             ;
    EVP_CIPHER *ciph = 
# 4633 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 4633 "../test/evp_extra_test.c"
                          ;
    OSSL_PARAM params[] = { { 
# 4634 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 4634 "../test/evp_extra_test.c"
                           , 0, 
# 4634 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 4634 "../test/evp_extra_test.c"
...
# 4634 "../test/evp_extra_test.c"
    ...
    if (lgcyprov == 
# 4637 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 4637 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 4638, "Test requires legacy provider to be loaded");

    if (!test_ptr("../test/evp_extra_test.c", 4640, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 4643, "ciph = EVP_CIPHER_fetch(testctx, keylen_change_ciphers[idx], testpropq)", ciph = EVP_CIPHER_fetch(testctx, keylen_change_ciphers[idx], testpropq))
                                                     )
        goto err;

    if (!test_true("../test/evp_extra_test.c", 4647, "EVP_CipherInit_ex(ctx, ciph, NULL, key, NULL, 1)", (EVP_CipherInit_ex(ctx, ciph, 
# 4647 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4647 "../test/evp_extra_test.c"
        , key, 
# 4647 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 4647 "../test/evp_extra_test.c"
    ...
    if (!test_true("../test/evp_extra_test.c", 4650, "EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))) != 0)
                                                                 )
        goto err;

    params[0] = OSSL_PARAM_construct_size_t("keylen",
                                            &keylen);
    if (!test_true("../test/evp_extra_test.c", 4656, "EVP_CIPHER_CTX_set_params(ctx, params)", (EVP_CIPHER_CTX_set_params(ctx, params)) != 0))
        goto err;

    ERR_set_mark();
    if (!test_false("../test/evp_extra_test.c", 4660, "EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))", (EVP_CipherUpdate(ctx, outbuf, &outlen, gcmDefaultPlaintext, sizeof(gcmDefaultPlaintext))) != 0)
                                                                 ) {
        ERR_clear_last_mark();
        goto err;
    }
...
static EVP_PKEY_METHOD *custom_pmeth = 
# 4675 "../test/evp_extra_test.c" 3 4
                                       ((void *)0)
# 4675 "../test/evp_extra_test.c"
                                           ;
static const EVP_PKEY_METHOD *orig_pmeth = 
# 4676 "../test/evp_extra_test.c" 3 4
                                          ((void *)0)
# 4676 "../test/evp_extra_test.c"
                                              ;
...
# 4703 "../test/evp_extra_test.c" 3 4
                                      ((void *)0)
# 4703 "../test/evp_extra_test.c"
                                          , &psign);
                               ...
                               size_t *keylen)
{
    ...
    EVP_PKEY_meth_get_derive(orig_pmeth, 
# 4723 "../test/evp_extra_test.c" 3 4
                                        ((void *)0)
# 4723 "../test/evp_extra_test.c"
                                            , &pderive);
...
static int custom_pmeth_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2)
{
    ...
    EVP_PKEY_meth_get_ctrl(orig_pmeth, &pctrl, 
# 4741 "../test/evp_extra_test.c" 3 4
                                              ((void *)0)
# 4741 "../test/evp_extra_test.c"
                                                  );
...
{
    EVP_PKEY_CTX *pctx = 
# 4753 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 4753 "../test/evp_extra_test.c"
                            ;
    EVP_MD_CTX *ctx = 
# 4754 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 4754 "../test/evp_extra_test.c"
                         ;
    EVP_PKEY *pkey = 
# 4755 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 4755 "../test/evp_extra_test.c"
                        ;
    int id, orig_id, orig_flags;
    int testresult = 0;
    size_t reslen;
    unsigned char *res = 
# 4759 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 4759 "../test/evp_extra_test.c"
                            ;
    ...
    if (testctx != 
# 4767 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4767 "../test/evp_extra_test.c"
                      )
        return 1;
    ...
    case 9:
        ...
        id = 1087;
        md = 
# 4798 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4798 "../test/evp_extra_test.c"
                ;
    ...
    default:
        test_error("../test/evp_extra_test.c", 4825, "Should not happen");
        goto err;
    }

    if (!test_ptr("../test/evp_extra_test.c", 4829, "pkey", pkey))
        goto err;

    if (idx < 6) {
        if (!test_true("../test/evp_extra_test.c", 4833, "evp_pkey_is_provided(pkey)", (((pkey)->keymgmt != 
# 4833 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4833 "../test/evp_extra_test.c"
            )) != 0))
            goto err;
    } else {
        EVP_PKEY *tmp = pkey;
        ...
        pkey = EVP_PKEY_new();
        if (!test_ptr("../test/evp_extra_test.c", 4840, "pkey", pkey)) {
            pkey = tmp;
            goto err;
        }
        if (!test_true("../test/evp_extra_test.c", 4844, "evp_pkey_copy_downgraded(&pkey, tmp)", (evp_pkey_copy_downgraded(&pkey, tmp)) != 0)) {
            EVP_PKEY_free(tmp);
            goto err;
        }
        EVP_PKEY_free(tmp);
        if (!test_true("../test/evp_extra_test.c", 4849, "evp_pkey_is_legacy(pkey)", (((pkey)->type != 0 && (pkey)->keymgmt == 
# 4849 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4849 "../test/evp_extra_test.c"
            )) != 0))
            goto err;
    }

    if (!test_ptr("../test/evp_extra_test.c", 4853, "orig_pmeth = EVP_PKEY_meth_find(id)", orig_pmeth = EVP_PKEY_meth_find(id))
            || !test_ptr("../test/evp_extra_test.c", 4854, "pkey", pkey))
        goto err;

    EVP_PKEY_meth_get0_info(&orig_id, &orig_flags, orig_pmeth);
    if (!test_int_eq("../test/evp_extra_test.c", 4858, "orig_id", "id", orig_id, id)
            || !test_ptr("../test/evp_extra_test.c", 4859, "custom_pmeth = EVP_PKEY_meth_new(id, orig_flags)", custom_pmeth = EVP_PKEY_meth_new(id, orig_flags)))
        goto err;

    if (id == 1087) {
        EVP_PKEY_meth_set_digestsign(custom_pmeth, custom_pmeth_digestsign);
    } if (id == 28 || id == 1034) {
        EVP_PKEY_meth_set_derive(custom_pmeth, 
# 4865 "../test/evp_extra_test.c" 3 4
                                              ((void *)0)
# 4865 "../test/evp_extra_test.c"
                                                  , custom_pmeth_derive);
    } else {
        EVP_PKEY_meth_set_sign(custom_pmeth, 
# 4867 "../test/evp_extra_test.c" 3 4
                                            ((void *)0)
# 4867 "../test/evp_extra_test.c"
                                                , custom_pmeth_sign);
    }
    if (id != 1087 && id != 1034) {
    ...
    EVP_PKEY_meth_set_ctrl(custom_pmeth, custom_pmeth_ctrl, 
# 4874 "../test/evp_extra_test.c" 3 4
                                                           ((void *)0)
# 4874 "../test/evp_extra_test.c"
                                                               );
    if (!test_true("../test/evp_extra_test.c", 4875, "EVP_PKEY_meth_add0(custom_pmeth)", (EVP_PKEY_meth_add0(custom_pmeth)) != 0))
        goto err;

    if (doderive) {
        pctx = EVP_PKEY_CTX_new(pkey, 
# 4879 "../test/evp_extra_test.c" 3 4
                                     ((void *)0)
# 4879 "../test/evp_extra_test.c"
                                         );
        if (!test_ptr("../test/evp_extra_test.c", 4880, "pctx", pctx)
                || !test_int_eq("../test/evp_extra_test.c", 4881, "EVP_PKEY_derive_init(pctx)", "1", EVP_PKEY_derive_init(pctx), 1)
                || !test_int_ge("../test/evp_extra_test.c", 4882, "EVP_PKEY_CTX_ctrl(pctx, -1, -1, EVP_PKEY_CTRL_MY_COMMAND, 0, NULL)", "1", EVP_PKEY_CTX_ctrl(pctx, -1, -1, 9999, 0, 
# 4882 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 4882 "../test/evp_extra_test.c"
                   ), 1)


                || !test_int_eq("../test/evp_extra_test.c", 4885, "ctrl_called", "1", ctrl_called, 1)
                || !test_int_ge("../test/evp_extra_test.c", 4886, "EVP_PKEY_derive_set_peer(pctx, pkey)", "1", EVP_PKEY_derive_set_peer(pctx, pkey), 1)
                || !test_int_ge("../test/evp_extra_test.c", 4887, "EVP_PKEY_derive(pctx, NULL, &reslen)", "1", EVP_PKEY_derive(pctx, 
# 4887 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 4887 "../test/evp_extra_test.c"
                   , &reslen), 1)
                || !test_ptr("../test/evp_extra_test.c", 4888, "res = OPENSSL_malloc(reslen)", res = CRYPTO_malloc(reslen, "../test/evp_extra_test.c", 4888))
                || !test_int_ge("../test/evp_extra_test.c", 4889, "EVP_PKEY_derive(pctx, res, &reslen)", "1", EVP_PKEY_derive(pctx, res, &reslen), 1))
            goto err;
    } else {
        ctx = EVP_MD_CTX_new();
        reslen = EVP_PKEY_get_size(pkey);
        res = CRYPTO_malloc(reslen, "../test/evp_extra_test.c", 4894);
        if (!test_ptr("../test/evp_extra_test.c", 4895, "ctx", ctx)
                || !test_ptr("../test/evp_extra_test.c", 4896, "res", res)
                || !test_true("../test/evp_extra_test.c", 4897, "EVP_DigestSignInit(ctx, &pctx, md, NULL, pkey)", (EVP_DigestSignInit(ctx, &pctx, md, 
# 4897 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 4897 "../test/evp_extra_test.c"
                   , pkey)) != 0)
                || !test_int_ge("../test/evp_extra_test.c", 4898, "EVP_PKEY_CTX_ctrl(pctx, -1, -1, EVP_PKEY_CTRL_MY_COMMAND, 0, NULL)", "1", EVP_PKEY_CTX_ctrl(pctx, -1, -1, 9999, 0, 
# 4898 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 4898 "../test/evp_extra_test.c"
                   ), 1)


                || !test_int_eq("../test/evp_extra_test.c", 4901, "ctrl_called", "1", ctrl_called, 1))
            goto err;

        if (id == 1087) {
            if (!test_true("../test/evp_extra_test.c", 4905, "EVP_DigestSign(ctx, res, &reslen, msg, sizeof(msg))", (EVP_DigestSign(ctx, res, &reslen, msg, sizeof(msg))) != 0))
                goto err;
        } else {
            if (!test_true("../test/evp_extra_test.c", 4908, "EVP_DigestUpdate(ctx, msg, sizeof(msg))", (EVP_DigestUpdate(ctx, msg, sizeof(msg))) != 0)
                    || !test_true("../test/evp_extra_test.c", 4909, "EVP_DigestSignFinal(ctx, res, &reslen)", (EVP_DigestSignFinal(ctx, res, &reslen)) != 0))
                goto err;
        }
    }
    ...
    testresult = 1;
 err:
    CRYPTO_free(res, "../test/evp_extra_test.c", 4916);
    EVP_MD_CTX_free(ctx);
    if (doderive)
        EVP_PKEY_CTX_free(pctx);
    EVP_PKEY_free(pkey);
    ...
    custom_pmeth = 
# 4923 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4923 "../test/evp_extra_test.c"
                      ;
    return testresult;
}
...
static int test_evp_md_cipher_meth(void)
{
    ...
    if (!test_ptr("../test/evp_extra_test.c", 4933, "md", md) || !test_ptr("../test/evp_extra_test.c", 4933, "ciph", ciph))
        goto err;
...
{
    custom_dgst_ctx *p = EVP_MD_CTX_get0_md_data(ctx);

    if (p == 
# 4956 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4956 "../test/evp_extra_test.c"
                )
        return 0;
...
static int custom_md_cleanup(EVP_MD_CTX *ctx)
{
    ...
    if (p == 
# 4967 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 4967 "../test/evp_extra_test.c"
                )
...
{
    ASN1_OBJECT *o = 
# 4977 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 4977 "../test/evp_extra_test.c"
                        ;
    EVP_MD_CTX *mdctx = 
# 4978 "../test/evp_extra_test.c" 3 4
                       ((void *)0)
# 4978 "../test/evp_extra_test.c"
                           ;
    EVP_MD *tmp = 
# 4979 "../test/evp_extra_test.c" 3 4
                 ((void *)0)
# 4979 "../test/evp_extra_test.c"
                     ;
    ...
    if (testctx != 
# 4990 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 4990 "../test/evp_extra_test.c"
                      )
        return test_skip("../test/evp_extra_test.c", 4991, "Non-default libctx");

    custom_md_init_called = custom_md_cleanup_called = 0;

    nid = OBJ_create("1.3.6.1.4.1.16604.998866.1", "custom-md", "custom-md");
    if (!test_int_ne("../test/evp_extra_test.c", 4996, "nid", "NID_undef", nid, 0))
        goto err;
    tmp = EVP_MD_meth_new(nid, 0);
    if (!test_ptr("../test/evp_extra_test.c", 4999, "tmp", tmp))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 5002, "EVP_MD_meth_set_init(tmp, custom_md_init)", (EVP_MD_meth_set_init(tmp, custom_md_init)) != 0)
            || !test_true("../test/evp_extra_test.c", 5003, "EVP_MD_meth_set_cleanup(tmp, custom_md_cleanup)", (EVP_MD_meth_set_cleanup(tmp, custom_md_cleanup)) != 0)
            || !test_true("../test/evp_extra_test.c", 5004, "EVP_MD_meth_set_app_datasize(tmp, sizeof(custom_dgst_ctx))", (EVP_MD_meth_set_app_datasize(tmp, sizeof(custom_dgst_ctx))) != 0)
                                                                                )
        goto err;

    mdctx = EVP_MD_CTX_new();
    if (!test_ptr("../test/evp_extra_test.c", 5009, "mdctx", mdctx)





            || !test_true("../test/evp_extra_test.c", 5015, "EVP_DigestInit_ex(mdctx, tmp, NULL)", (EVP_DigestInit_ex(mdctx, tmp, 
# 5015 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5015 "../test/evp_extra_test.c"
               )) != 0)
            || !test_true("../test/evp_extra_test.c", 5016, "EVP_DigestInit_ex(mdctx, EVP_sha256(), NULL)", (EVP_DigestInit_ex(mdctx, EVP_sha256(), 
# 5016 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5016 "../test/evp_extra_test.c"
               )) != 0)
            || !test_true("../test/evp_extra_test.c", 5017, "EVP_DigestUpdate(mdctx, mess, strlen(mess))", (EVP_DigestUpdate(mdctx, mess, strlen(mess))) != 0)
            || !test_true("../test/evp_extra_test.c", 5018, "EVP_DigestFinal_ex(mdctx, md_value, &md_len)", (EVP_DigestFinal_ex(mdctx, md_value, &md_len)) != 0)
            || !test_int_eq("../test/evp_extra_test.c", 5019, "custom_md_init_called", "1", custom_md_init_called, 1)
            || !test_int_eq("../test/evp_extra_test.c", 5020, "custom_md_cleanup_called", "1", custom_md_cleanup_called, 1))
        goto err;

    if (!test_int_eq("../test/evp_extra_test.c", 5023, "OBJ_create(\"1.3.6.1.4.1.16604.998866.1\", \"custom-md\", \"custom-md\")", "NID_undef", OBJ_create("1.3.6.1.4.1.16604.998866.1", "custom-md", "custom-md"), 0)

            || !test_int_eq("../test/evp_extra_test.c", 5025, "ERR_GET_LIB(ERR_peek_error())", "ERR_LIB_OBJ", ERR_GET_LIB(ERR_peek_error()), 8)
            || !test_int_eq("../test/evp_extra_test.c", 5026, "ERR_GET_REASON(ERR_get_error())", "OBJ_R_OID_EXISTS", ERR_GET_REASON(ERR_get_error()), 102))
        goto err;

    o = ASN1_OBJECT_create(nid, (unsigned char *)
                                "\53\6\1\4\1\201\201\134\274\373\122\1", 12,
                                "custom-md", "custom-md");
    if (!test_int_eq("../test/evp_extra_test.c", 5032, "OBJ_add_object(o)", "nid", OBJ_add_object(o), nid))
        goto err;
                            ...
                            const unsigned char *iv, int enc)
{
    ...
    if (p == 
# 5055 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 5055 "../test/evp_extra_test.c"
                )
        return 0;
...
static int custom_ciph_cleanup(EVP_CIPHER_CTX *ctx)
{
    ...
    if (p == 
# 5066 "../test/evp_extra_test.c" 3 4
            ((void *)0)
# 5066 "../test/evp_extra_test.c"
                )
...
# 5076 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 5076 "../test/evp_extra_test.c"
                                 ;
    EVP_CIPHER *tmp = 
# 5077 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 5077 "../test/evp_extra_test.c"
                         ;
    int testresult = 0;
    int nid;
    ...
    if (testctx != 
# 5085 "../test/evp_extra_test.c" 3 4
                  ((void *)0)
# 5085 "../test/evp_extra_test.c"
                      )
        return test_skip("../test/evp_extra_test.c", 5086, "Non-default libctx");

    custom_ciph_init_called = custom_ciph_cleanup_called = 0;

    nid = OBJ_create("1.3.6.1.4.1.16604.998866.2", "custom-ciph", "custom-ciph");
    if (!test_int_ne("../test/evp_extra_test.c", 5091, "nid", "NID_undef", nid, 0))
        goto err;
    tmp = EVP_CIPHER_meth_new(nid, 16, 16);
    if (!test_ptr("../test/evp_extra_test.c", 5094, "tmp", tmp))
        goto err;

    if (!test_true("../test/evp_extra_test.c", 5097, "EVP_CIPHER_meth_set_init(tmp, custom_ciph_init)", (EVP_CIPHER_meth_set_init(tmp, custom_ciph_init)) != 0)
            || !test_true("../test/evp_extra_test.c", 5098, "EVP_CIPHER_meth_set_flags(tmp, EVP_CIPH_ALWAYS_CALL_INIT)", (EVP_CIPHER_meth_set_flags(tmp, 0x20)) != 0)
            || !test_true("../test/evp_extra_test.c", 5099, "EVP_CIPHER_meth_set_cleanup(tmp, custom_ciph_cleanup)", (EVP_CIPHER_meth_set_cleanup(tmp, custom_ciph_cleanup)) != 0)
            || !test_true("../test/evp_extra_test.c", 5100, "EVP_CIPHER_meth_set_impl_ctx_size(tmp, sizeof(custom_ciph_ctx))", (EVP_CIPHER_meth_set_impl_ctx_size(tmp, sizeof(custom_ciph_ctx))) != 0)
                                                                                     )
        goto err;

    ciphctx = EVP_CIPHER_CTX_new();
    if (!test_ptr("../test/evp_extra_test.c", 5105, "ciphctx", ciphctx)





            || !test_true("../test/evp_extra_test.c", 5111, "EVP_CipherInit_ex(ciphctx, tmp, NULL, NULL, NULL, 1)", (EVP_CipherInit_ex(ciphctx, tmp, 
# 5111 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5111 "../test/evp_extra_test.c"
               , 
# 5111 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5111 "../test/evp_extra_test.c"
...
# 5111 "../test/evp_extra_test.c"
               , 1)) != 0)
            || !test_true("../test/evp_extra_test.c", 5112, "EVP_CipherInit_ex(ciphctx, EVP_aes_128_cbc(), NULL, NULL, NULL, 1)", (EVP_CipherInit_ex(ciphctx, EVP_aes_128_cbc(), 
# 5112 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5112 "../test/evp_extra_test.c"
               , 
# 5112 "../test/evp_extra_test.c" 3 4
               ((void *)0)
# 5112 "../test/evp_extra_test.c"
...
# 5112 "../test/evp_extra_test.c"
            ...
            || !test_int_eq("../test/evp_extra_test.c", 5114, "custom_ciph_init_called", "1", custom_ciph_init_called, 1)
            || !test_int_eq("../test/evp_extra_test.c", 5115, "custom_ciph_cleanup_called", "1", custom_ciph_cleanup_called, 1))
        goto err;
...
# 5288 "../test/evp_extra_test.c" 3 4
                                          ((void *)0)
# 5288 "../test/evp_extra_test.c"
                                              , &ecxkeydata, 1);
    if (!test_ptr_null("../test/evp_extra_test.c", 5289, "pkey", pkey)) {
        EVP_PKEY_free(pkey);
        return 0;
    }
...
{
    EVP_PKEY *pkey = 
# 5319 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 5319 "../test/evp_extra_test.c"
                        ;

    const unsigned char msg[] = { 0x00, 0x01, 0x02, 0x03 };
    int testresult = 0;
    EVP_MD_CTX *ctx = 
# 5323 "../test/evp_extra_test.c" 3 4
                     ((void *)0)
# 5323 "../test/evp_extra_test.c"
                         ;
    unsigned char *mac = 
# 5324 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5324 "../test/evp_extra_test.c"
                            ;
    size_t maclen = 0;
    ...
    case 1034:
    case 1035:
        return test_skip("../test/evp_extra_test.c", 5332, "signing not supported for X25519/X448");
    }


    if (keys[tst].pub == 
# 5336 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5336 "../test/evp_extra_test.c"
                            )
        return test_skip("../test/evp_extra_test.c", 5337, "no public key present");
...
# 5343 "../test/evp_extra_test.c" 3 4
                                         ((void *)0)
# 5343 "../test/evp_extra_test.c"
                                             , pubkey, pubkeylen);
    if (!test_ptr("../test/evp_extra_test.c", 5344, "pkey", pkey))
        goto err;

    if (!test_ptr("../test/evp_extra_test.c", 5347, "ctx = EVP_MD_CTX_new()", ctx = EVP_MD_CTX_new()))
        goto err;

    if (EVP_DigestSignInit(ctx, 
# 5350 "../test/evp_extra_test.c" 3 4
                               ((void *)0)
# 5350 "../test/evp_extra_test.c"
                                   , 
# 5350 "../test/evp_extra_test.c" 3 4
                                     ((void *)0)
# 5350 "../test/evp_extra_test.c"
...
# 5353 "../test/evp_extra_test.c" 3 4
                           ((void *)0)
# 5353 "../test/evp_extra_test.c"
                               , &maclen, msg, sizeof(msg)) != 1)
        goto check_err;

    if (!test_ptr("../test/evp_extra_test.c", 5356, "mac = OPENSSL_malloc(maclen)", mac = CRYPTO_malloc(maclen, "../test/evp_extra_test.c", 5356)))
        goto err;

    if (!test_int_eq("../test/evp_extra_test.c", 5359, "EVP_DigestSign(ctx, mac, &maclen, msg, sizeof(msg))", "0", EVP_DigestSign(ctx, mac, &maclen, msg, sizeof(msg)), 0))
        goto err;
 ...
 check_err:
    ...
    if (ERR_GET_REASON(ERR_peek_error()) == 221) {
        testresult = 1;
        ERR_clear_error();
    }
 ...
 err:
    EVP_MD_CTX_free(ctx);
    CRYPTO_free(mac, "../test/evp_extra_test.c", 5375);
    EVP_PKEY_free(pkey);
...
{
    OSSL_PROVIDER *fake_rsa = 
# 5384 "../test/evp_extra_test.c" 3 4
                             ((void *)0)
# 5384 "../test/evp_extra_test.c"
                                 ;
    int testresult = 0;
    EVP_PKEY *pkey = 
# 5386 "../test/evp_extra_test.c" 3 4
                    ((void *)0)
# 5386 "../test/evp_extra_test.c"
                        ;
    EVP_PKEY_CTX *pctx = 
# 5387 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5387 "../test/evp_extra_test.c"
                            ;
    EVP_MD_CTX *mctx = 
# 5388 "../test/evp_extra_test.c" 3 4
                      ((void *)0)
# 5388 "../test/evp_extra_test.c"
                          ;
    ...
    static const OSSL_PARAM nodup_params[] = {
        { (("NO_DUP")), (1), ((&nodupnum)), (sizeof(int)), ((size_t)-1) },
        { 
# 5395 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5395 "../test/evp_extra_test.c"
       , 0, 
# 5395 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5395 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 5398, "fake_rsa = fake_rsa_start(testctx)", fake_rsa = fake_rsa_start(testctx)))
        return 0;


    if (!test_ptr("../test/evp_extra_test.c", 5402, "pctx = EVP_PKEY_CTX_new_from_name(testctx, \"RSA\", \"provider=fake-rsa\")", pctx = EVP_PKEY_CTX_new_from_name(testctx, "RSA", "provider=fake-rsa"))

        || !test_true("../test/evp_extra_test.c", 5404, "EVP_PKEY_fromdata_init(pctx)", (EVP_PKEY_fromdata_init(pctx)) != 0)
        || !test_true("../test/evp_extra_test.c", 5405, "EVP_PKEY_fromdata(pctx, &pkey, EVP_PKEY_KEYPAIR, NULL)", (EVP_PKEY_fromdata(pctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), 
# 5405 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 5405 "../test/evp_extra_test.c"
           )) != 0)
        || !test_ptr("../test/evp_extra_test.c", 5406, "pkey", pkey))
        goto end;


    if (!test_ptr("../test/evp_extra_test.c", 5410, "mctx = EVP_MD_CTX_new()", mctx = EVP_MD_CTX_new())
        || !test_true("../test/evp_extra_test.c", 5411, "EVP_DigestSignInit_ex(mctx, NULL, NULL, testctx, NULL, pkey, NULL)", (EVP_DigestSignInit_ex(mctx, 
# 5411 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 5411 "../test/evp_extra_test.c"
           , 
# 5411 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 5411 "../test/evp_extra_test.c"
...
# 5411 "../test/evp_extra_test.c"
        ...
        || !test_true("../test/evp_extra_test.c", 5413, "EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))", (EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))) != 0)
        || !test_true("../test/evp_extra_test.c", 5414, "EVP_DigestSignFinal(mctx, signature, &siglen)", (EVP_DigestSignFinal(mctx, signature, &siglen)) != 0)
        || !test_true("../test/evp_extra_test.c", 5415, "EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))", (EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))) != 0)
        || !test_true("../test/evp_extra_test.c", 5416, "EVP_DigestSignFinal(mctx, signature, &siglen)", (EVP_DigestSignFinal(mctx, signature, &siglen)) != 0))
        goto end;

    EVP_MD_CTX_free(mctx);


    if (!test_ptr("../test/evp_extra_test.c", 5422, "mctx = EVP_MD_CTX_new()", mctx = EVP_MD_CTX_new())
        || !test_true("../test/evp_extra_test.c", 5423, "EVP_DigestSignInit_ex(mctx, NULL, NULL, testctx, NULL, pkey, nodup_params)", (EVP_DigestSignInit_ex(mctx, 
# 5423 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 5423 "../test/evp_extra_test.c"
           , 
# 5423 "../test/evp_extra_test.c" 3 4
           ((void *)0)
# 5423 "../test/evp_extra_test.c"
...
# 5423 "../test/evp_extra_test.c"
        ...
        || !test_true("../test/evp_extra_test.c", 5425, "EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))", (EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))) != 0)
        || !test_true("../test/evp_extra_test.c", 5426, "EVP_DigestSignFinal(mctx, signature, &siglen)", (EVP_DigestSignFinal(mctx, signature, &siglen)) != 0)
        || !test_false("../test/evp_extra_test.c", 5427, "EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))", (EVP_DigestSignUpdate(mctx, sigbuf, sizeof(sigbuf))) != 0)
        || !test_false("../test/evp_extra_test.c", 5428, "EVP_DigestSignFinal(mctx, signature, &siglen)", (EVP_DigestSignFinal(mctx, signature, &siglen)) != 0))
        goto end;
                           ...
                           const unsigned char *gcm_tag, size_t gcm_tag_s)
{
    ...
    EVP_CIPHER_CTX *ctx;
    EVP_CIPHER *cipher = 
# 5450 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5450 "../test/evp_extra_test.c"
                            ;
    int outlen, tmplen;
    unsigned char outbuf[1024];
    ...
    OSSL_PARAM params[2] = {
        { 
# 5455 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5455 "../test/evp_extra_test.c"
       , 0, 
# 5455 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5455 "../test/evp_extra_test.c"
...
# 5455 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 5458, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_ptr("../test/evp_extra_test.c", 5459, "cipher = EVP_CIPHER_fetch(testctx, \"AES-256-GCM\", \"\")", cipher = EVP_CIPHER_fetch(testctx, "AES-256-GCM", "")))
        goto err;

    params[0] = OSSL_PARAM_construct_size_t("ivlen",
                                            &gcm_ivlen);

    if (!test_true("../test/evp_extra_test.c", 5465, "EVP_EncryptInit_ex2(ctx, cipher, gcm_key, gcm_iv, params)", (EVP_EncryptInit_ex2(ctx, cipher, gcm_key, gcm_iv, params)) != 0)
            || (gcm_aad != 
# 5466 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
                
# 5467 "../test/evp_extra_test.c"
               && !test_true("../test/evp_extra_test.c", 5467, "EVP_EncryptUpdate(ctx, NULL, &outlen, gcm_aad, gcm_aad_s)", (EVP_EncryptUpdate(ctx, 
# 5467 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 5467 "../test/evp_extra_test.c"
                   , &outlen, gcm_aad, gcm_aad_s)) != 0)
                                                                    )
            || !test_true("../test/evp_extra_test.c", 5469, "EVP_EncryptUpdate(ctx, outbuf, &outlen, gcm_pt, gcm_pt_s)", (EVP_EncryptUpdate(ctx, outbuf, &outlen, gcm_pt, gcm_pt_s)) != 0)

            || !test_true("../test/evp_extra_test.c", 5471, "EVP_EncryptFinal_ex(ctx, outbuf, &tmplen)", (EVP_EncryptFinal_ex(ctx, outbuf, &tmplen)) != 0))
        goto err;

    params[0] = OSSL_PARAM_construct_octet_string("tag",
                                                  outtag, sizeof(outtag));

    if (!test_true("../test/evp_extra_test.c", 5477, "EVP_CIPHER_CTX_get_params(ctx, params)", (EVP_CIPHER_CTX_get_params(ctx, params)) != 0)
            || !test_mem_eq("../test/evp_extra_test.c", 5478, "outbuf", "gcm_ct", outbuf, outlen, gcm_ct, gcm_ct_s)
            || !test_mem_eq("../test/evp_extra_test.c", 5479, "outtag", "gcm_tag", outtag, gcm_tag_s, gcm_tag, gcm_tag_s))
        goto err;
                           ...
                           const unsigned char *gcm_tag, size_t gcm_tag_s)
{
    ...
    EVP_CIPHER_CTX *ctx;
    EVP_CIPHER *cipher = 
# 5499 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5499 "../test/evp_extra_test.c"
                            ;
    int outlen;
    unsigned char outbuf[1024];
    OSSL_PARAM params[2] = {
        { 
# 5503 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5503 "../test/evp_extra_test.c"
       , 0, 
# 5503 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5503 "../test/evp_extra_test.c"
...
# 5506 "../test/evp_extra_test.c" 3 4
                                       ((void *)0)
# 5506 "../test/evp_extra_test.c"
                                           )
        goto err;

    if ((cipher = EVP_CIPHER_fetch(testctx, "AES-256-GCM", "")) == 
# 5509 "../test/evp_extra_test.c" 3 4
                                                                  ((void *)0)
# 5509 "../test/evp_extra_test.c"
                                                                      )
        goto err;
    ...
    if (!test_true("../test/evp_extra_test.c", 5515, "EVP_DecryptInit_ex2(ctx, cipher, gcm_key, gcm_iv, params)", (EVP_DecryptInit_ex2(ctx, cipher, gcm_key, gcm_iv, params)) != 0)
            || (gcm_aad != 
# 5516 "../test/evp_extra_test.c" 3 4
                          ((void *)0)
                
# 5517 "../test/evp_extra_test.c"
               && !test_true("../test/evp_extra_test.c", 5517, "EVP_DecryptUpdate(ctx, NULL, &outlen, gcm_aad, gcm_aad_s)", (EVP_DecryptUpdate(ctx, 
# 5517 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 5517 "../test/evp_extra_test.c"
                   , &outlen, gcm_aad, gcm_aad_s)) != 0)
                                                                    )
            || !test_true("../test/evp_extra_test.c", 5519, "EVP_DecryptUpdate(ctx, outbuf, &outlen, gcm_ct, gcm_ct_s)", (EVP_DecryptUpdate(ctx, outbuf, &outlen, gcm_ct, gcm_ct_s)) != 0)

            || !test_mem_eq("../test/evp_extra_test.c", 5521, "outbuf", "gcm_pt", outbuf, outlen, gcm_pt, gcm_pt_s))
        goto err;

    params[0] = OSSL_PARAM_construct_octet_string("tag",
                                                  (void*)gcm_tag, gcm_tag_s);

    if (!test_true("../test/evp_extra_test.c", 5527, "EVP_CIPHER_CTX_set_params(ctx, params)", (EVP_CIPHER_CTX_set_params(ctx, params)) != 0)
            ||!test_true("../test/evp_extra_test.c", 5528, "EVP_DecryptFinal_ex(ctx, outbuf, &outlen)", (EVP_DecryptFinal_ex(ctx, outbuf, &outlen)) != 0))
        goto err;
...
# 5574 "../test/evp_extra_test.c" 3 4
                                                  ((void *)0)
# 5574 "../test/evp_extra_test.c"
                                                      , 0,
                           gcm_ct, sizeof(gcm_ct), gcm_tag, sizeof(gcm_tag))
        && aes_gcm_decrypt(gcm_key, sizeof(gcm_key), gcm_iv, sizeof(gcm_iv),
                           gcm_pt, sizeof(gcm_pt), 
# 5577 "../test/evp_extra_test.c" 3 4
                                                  ((void *)0)
# 5577 "../test/evp_extra_test.c"
                                                      , 0,
                           gcm_ct, sizeof(gcm_ct), gcm_tag, sizeof(gcm_tag));
}
                       ...
                       const unsigned char *rc4_ct, size_t rc4_ct_s)
{
    ...
    EVP_CIPHER_CTX *ctx;
    EVP_CIPHER *cipher = 
# 5588 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5588 "../test/evp_extra_test.c"
                            ;
    int outlen, tmplen;
    unsigned char outbuf[1024];
    OSSL_PARAM params[2] = {
        { 
# 5592 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5592 "../test/evp_extra_test.c"
       , 0, 
# 5592 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5592 "../test/evp_extra_test.c"
...
# 5592 "../test/evp_extra_test.c"
    ...
    if (!test_ptr("../test/evp_extra_test.c", 5595, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_ptr("../test/evp_extra_test.c", 5596, "cipher = EVP_CIPHER_fetch(testctx, \"RC4\", \"\")", cipher = EVP_CIPHER_fetch(testctx, "RC4", "")))
        goto err;

    params[0] = OSSL_PARAM_construct_size_t("keylen",
                                            &rc4_key_s);

    if (!test_true("../test/evp_extra_test.c", 5602, "EVP_EncryptInit_ex2(ctx, cipher, rc4_key, NULL, params)", (EVP_EncryptInit_ex2(ctx, cipher, rc4_key, 
# 5602 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 5602 "../test/evp_extra_test.c"
        , params)) != 0)
            || !test_true("../test/evp_extra_test.c", 5603, "EVP_EncryptUpdate(ctx, outbuf, &outlen, rc4_pt, rc4_pt_s)", (EVP_EncryptUpdate(ctx, outbuf, &outlen, rc4_pt, rc4_pt_s)) != 0)

            || !test_true("../test/evp_extra_test.c", 5605, "EVP_EncryptFinal_ex(ctx, outbuf, &tmplen)", (EVP_EncryptFinal_ex(ctx, outbuf, &tmplen)) != 0))
        goto err;

    if (!test_mem_eq("../test/evp_extra_test.c", 5608, "outbuf", "rc4_ct", outbuf, outlen, rc4_ct, rc4_ct_s))
        goto err;
                       ...
                       const unsigned char *rc4_ct, size_t rc4_ct_s)
{
    ...
    EVP_CIPHER_CTX *ctx;
    EVP_CIPHER *cipher = 
# 5625 "../test/evp_extra_test.c" 3 4
                        ((void *)0)
# 5625 "../test/evp_extra_test.c"
                            ;
    int outlen;
    unsigned char outbuf[1024];
    OSSL_PARAM params[2] = {
        { 
# 5629 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5629 "../test/evp_extra_test.c"
       , 0, 
# 5629 "../test/evp_extra_test.c" 3 4
       ((void *)0)
# 5629 "../test/evp_extra_test.c"
...
# 5629 "../test/evp_extra_test.c"
    ...
    if ((ctx = EVP_CIPHER_CTX_new()) == 
# 5632 "../test/evp_extra_test.c" 3 4
                                       ((void *)0)
# 5632 "../test/evp_extra_test.c"
                                           )
        goto err;

    if ((cipher = EVP_CIPHER_fetch(testctx, "RC4", "")) == 
# 5635 "../test/evp_extra_test.c" 3 4
                                                          ((void *)0)
# 5635 "../test/evp_extra_test.c"
                                                              )
        goto err;
    ...
    if (!test_true("../test/evp_extra_test.c", 5641, "EVP_DecryptInit_ex2(ctx, cipher, rc4_key, NULL, params)", (EVP_DecryptInit_ex2(ctx, cipher, rc4_key, 
# 5641 "../test/evp_extra_test.c" 3 4
        ((void *)0)
# 5641 "../test/evp_extra_test.c"
        , params)) != 0)
            || !test_true("../test/evp_extra_test.c", 5642, "EVP_DecryptUpdate(ctx, outbuf, &outlen, rc4_ct, rc4_ct_s)", (EVP_DecryptUpdate(ctx, outbuf, &outlen, rc4_ct, rc4_ct_s)) != 0)

            || !test_mem_eq("../test/evp_extra_test.c", 5644, "outbuf", "rc4_pt", outbuf, outlen, rc4_pt, rc4_pt_s))
        goto err;
...
static int test_aes_rc4_keylen_change_cve_2023_5363(void)
{
    ...
    if (lgcyprov == 
# 5678 "../test/evp_extra_test.c" 3 4
                   ((void *)0)
# 5678 "../test/evp_extra_test.c"
                       )
        return test_skip("../test/evp_extra_test.c", 5679, "Test requires legacy provider to be loaded");
...
static int test_invalid_ctx_for_digest(void)
{
    ...
    mdctx = EVP_MD_CTX_new();
    if (!test_ptr("../test/evp_extra_test.c", 5694, "mdctx", mdctx))
        return 0;

    if (!test_int_eq("../test/evp_extra_test.c", 5697, "EVP_DigestUpdate(mdctx, \"test\", sizeof(\"test\") - 1)", "0", EVP_DigestUpdate(mdctx, "test", sizeof("test") - 1), 0))
        ret = 0;
    else
        ret = 1;
...
int setup_tests(void)
{
    ...
    while ((o = opt_next()) != OPT_EOF) {
        ...
        case OPT_CONTEXT:
            ...
            if (!test_ptr("../test/evp_extra_test.c", 5716, "testctx", testctx))
                return 0;
  ...
  return 0;
            ...
            nullprov = OSSL_PROVIDER_load(
# 5728 "../test/evp_extra_test.c" 3 4
                                         ((void *)0)
# 5728 "../test/evp_extra_test.c"
                                             , "null");
            ...
            break;
        case OPT_TEST_HELP: case OPT_TEST_LIST: case OPT_TEST_SINGLE: case OPT_TEST_ITERATION: case OPT_TEST_INDENT: case OPT_TEST_SEED:
            break;
        default:
            return 0;
        }
    ...
    add_all_tests("test_EVP_DigestSignInit", test_EVP_DigestSignInit, 30, 1);
    ...
    add_all_tests("test_d2i_AutoPrivateKey", test_d2i_AutoPrivateKey, (sizeof(keydata)/sizeof((keydata)[0])), 1);
    ...
    add_all_tests("test_EC_keygen_with_enc", test_EC_keygen_with_enc, (sizeof(ec_encodings)/sizeof((ec_encodings)[0])), 1);


    add_test("test_EVP_SM2", test_EVP_SM2);
    add_test("test_EVP_SM2_verify", test_EVP_SM2_verify);

    add_all_tests("test_set_get_raw_keys", test_set_get_raw_keys, (sizeof(keys)/sizeof((keys)[0])), 1);

    custom_pmeth = EVP_PKEY_meth_new(0xdefaced, 0);
    if (!test_ptr("../test/evp_extra_test.c", 5770, "custom_pmeth", custom_pmeth))
        return 0;
    ...
    if (!test_int_eq("../test/evp_extra_test.c", 5775, "EVP_PKEY_meth_add0(custom_pmeth)", "1", EVP_PKEY_meth_add0(custom_pmeth), 1))
        return 0;

    add_all_tests("test_EVP_PKEY_check", test_EVP_PKEY_check, (sizeof(keycheckdata)/sizeof((keycheckdata)[0])), 1);
    ...
    add_all_tests("test_invalide_ec_char2_pub_range_decode", test_invalide_ec_char2_pub_range_decode, (sizeof(ec_der_pub_keys)/sizeof((ec_der_pub_keys)[0])), 1)
                                              ;
    ...
    add_test("test_RSA_encrypt", test_RSA_encrypt);
    ...
    add_all_tests("test_evp_iv_aes", test_evp_iv_aes, 12, 1);
    ...
    add_all_tests("test_ecpub", test_ecpub, (sizeof(ecpub_nids)/sizeof((ecpub_nids)[0])), 1);


    add_test("test_names_do_all", test_names_do_all);

    add_all_tests("test_evp_init_seq", test_evp_init_seq, (sizeof(evp_init_tests)/sizeof((evp_init_tests)[0])), 1);
    add_all_tests("test_evp_reset", test_evp_reset, (sizeof(evp_reset_tests)/sizeof((evp_reset_tests)[0])), 1);
    add_all_tests("test_evp_reinit_seq", test_evp_reinit_seq, (sizeof(evp_reinit_tests)/sizeof((evp_reinit_tests)[0])), 1);
    add_all_tests("test_gcm_reinit", test_gcm_reinit, (sizeof(gcm_reinit_tests)/sizeof((gcm_reinit_tests)[0])), 1);
    add_all_tests("test_evp_updated_iv", test_evp_updated_iv, (sizeof(evp_updated_iv_tests)/sizeof((evp_updated_iv_tests)[0])), 1);
    add_all_tests("test_ivlen_change", test_ivlen_change, (sizeof(ivlen_change_ciphers)/sizeof((ivlen_change_ciphers)[0])), 1);
    if ((sizeof(keylen_change_ciphers)/sizeof((keylen_change_ciphers)[0])) - 1 > 0)
        add_all_tests("test_keylen_change", test_keylen_change, (sizeof(keylen_change_ciphers)/sizeof((keylen_change_ciphers)[0])) - 1, 1);


    add_all_tests("test_custom_pmeth", test_custom_pmeth, 12, 1);
...
# 5867 "../test/evp_extra_test.c"
    add_all_tests("test_ecx_short_keys", test_ecx_short_keys, (sizeof(ecxnids)/sizeof((ecxnids)[0])), 1);
    add_all_tests("test_ecx_not_private_key", test_ecx_not_private_key, (sizeof(keys)/sizeof((keys)[0])), 1);
