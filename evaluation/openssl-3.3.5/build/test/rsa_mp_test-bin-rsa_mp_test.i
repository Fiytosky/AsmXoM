# 0 "../test/rsa_mp_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rsa_mp_test.c"
# 17 "../test/rsa_mp_test.c"
...
{
    if (!test_int_eq("../test/rsa_mp_test.c", 141, "RSA_set0_key(key, BN_bin2bn(n, sizeof(n) - 1, NULL), BN_bin2bn(e, sizeof(e) - 1, NULL), BN_bin2bn(d, sizeof(d) - 1, NULL))", "1", RSA_set0_key(key, BN_bin2bn(n, sizeof(n) - 1, 
# 141 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 141 "../test/rsa_mp_test.c"
        ), BN_bin2bn(e, sizeof(e) - 1, 
# 141 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 141 "../test/rsa_mp_test.c"
        ), BN_bin2bn(d, sizeof(d) - 1, 
# 141 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 141 "../test/rsa_mp_test.c"
        )), 1)
...
{
    BIGNUM **pris = 
# 152 "../test/rsa_mp_test.c" 3 4
                   ((void *)0)
# 152 "../test/rsa_mp_test.c"
                       , **exps = 
# 152 "../test/rsa_mp_test.c" 3 4
                                  ((void *)0)
# 152 "../test/rsa_mp_test.c"
...
# 152 "../test/rsa_mp_test.c"
    ...
    if (!test_int_eq("../test/rsa_mp_test.c", 156, "RSA_set0_factors(key, BN_bin2bn(p, sizeof(p) - 1, NULL), BN_bin2bn(q, sizeof(q) - 1, NULL))", "1", RSA_set0_factors(key, BN_bin2bn(p, sizeof(p) - 1, 
# 156 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 156 "../test/rsa_mp_test.c"
        ), BN_bin2bn(q, sizeof(q) - 1, 
# 156 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 156 "../test/rsa_mp_test.c"
        )), 1)
    ...
    if (!test_int_eq("../test/rsa_mp_test.c", 161, "RSA_set0_crt_params(key, BN_bin2bn(dmp1, sizeof(dmp1) - 1, NULL), BN_bin2bn(dmq1, sizeof(dmq1) - 1, NULL), BN_bin2bn(iqmp, sizeof(iqmp) - 1, NULL))", "1", RSA_set0_crt_params(key, BN_bin2bn(dmp1, sizeof(dmp1) - 1, 
# 161 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 161 "../test/rsa_mp_test.c"
...
# 161 "../test/rsa_mp_test.c"
    ...
    pris = CRYPTO_zalloc(sizeof(BIGNUM *), "../test/rsa_mp_test.c", 168);
    exps = CRYPTO_zalloc(sizeof(BIGNUM *), "../test/rsa_mp_test.c", 169);
    coeffs = CRYPTO_zalloc(sizeof(BIGNUM *), "../test/rsa_mp_test.c", 170);
    if (!test_ptr("../test/rsa_mp_test.c", 171, "pris", pris) || !test_ptr("../test/rsa_mp_test.c", 171, "exps", exps) || !test_ptr("../test/rsa_mp_test.c", 171, "coeffs", coeffs))
        goto err;

    pris[0] = BN_bin2bn(ex_prime, sizeof(ex_prime) - 1, 
# 174 "../test/rsa_mp_test.c" 3 4
                                                       ((void *)0)
# 174 "../test/rsa_mp_test.c"
                                                           );
    exps[0] = BN_bin2bn(ex_exponent, sizeof(ex_exponent) - 1, 
# 175 "../test/rsa_mp_test.c" 3 4
                                                             ((void *)0)
# 175 "../test/rsa_mp_test.c"
                                                                 );
    coeffs[0] = BN_bin2bn(ex_coefficient, sizeof(ex_coefficient) - 1, 
# 176 "../test/rsa_mp_test.c" 3 4
                                                                     ((void *)0)
# 176 "../test/rsa_mp_test.c"
                                                                         );
    if (!test_ptr("../test/rsa_mp_test.c", 177, "pris[0]", pris[0]) || !test_ptr("../test/rsa_mp_test.c", 177, "exps[0]", exps[0]) || !test_ptr("../test/rsa_mp_test.c", 177, "coeffs[0]", coeffs[0]))
        goto err;

    if (!test_true("../test/rsa_mp_test.c", 180, "RSA_set0_multi_prime_params(key, pris, exps, coeffs, NUM_EXTRA_PRIMES)", (RSA_set0_multi_prime_params(key, pris, exps, coeffs, 1)) != 0)
                                                                         )
        goto err;

 ret:
    CRYPTO_free(pris, "../test/rsa_mp_test.c", 185);
    CRYPTO_free(exps, "../test/rsa_mp_test.c", 186);
    CRYPTO_free(coeffs, "../test/rsa_mp_test.c", 187);
    return rv;
 err:
    if (pris != 
# 190 "../test/rsa_mp_test.c" 3 4
               ((void *)0)
# 190 "../test/rsa_mp_test.c"
                   )
        BN_free(pris[0]);
    if (exps != 
# 192 "../test/rsa_mp_test.c" 3 4
               ((void *)0)
# 192 "../test/rsa_mp_test.c"
                   )
        BN_free(exps[0]);
    if (coeffs != 
# 194 "../test/rsa_mp_test.c" 3 4
                 ((void *)0)
# 194 "../test/rsa_mp_test.c"
                     )
        BN_free(coeffs[0]);
    rv = 0;
    goto ret;
...
{
    struct stack_st_BIGNUM *primes = 
# 202 "../test/rsa_mp_test.c" 3 4
                              ((void *)0)
# 202 "../test/rsa_mp_test.c"
                                  , *exps = 
# 202 "../test/rsa_mp_test.c" 3 4
                                            ((void *)0)
# 202 "../test/rsa_mp_test.c"
...
# 202 "../test/rsa_mp_test.c"
                                                                ;
    BIGNUM *num = 
# 203 "../test/rsa_mp_test.c" 3 4
                 ((void *)0)
# 203 "../test/rsa_mp_test.c"
                     ;
    int rv = RSA_size(key);

    if (!test_ptr("../test/rsa_mp_test.c", 206, "primes = sk_BIGNUM_new_null()", primes = sk_BIGNUM_new_null())
        || !test_ptr("../test/rsa_mp_test.c", 207, "exps = sk_BIGNUM_new_null()", exps = sk_BIGNUM_new_null())
        || !test_ptr("../test/rsa_mp_test.c", 208, "coeffs = sk_BIGNUM_new_null()", coeffs = sk_BIGNUM_new_null()))
        goto err;

    if (!test_ptr("../test/rsa_mp_test.c", 211, "num = BN_bin2bn(p, sizeof(p) - 1, NULL)", num = BN_bin2bn(p, sizeof(p) - 1, 
# 211 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 211 "../test/rsa_mp_test.c"
        ))
        || !test_int_ne("../test/rsa_mp_test.c", 212, "sk_BIGNUM_push(primes, num)", "0", sk_BIGNUM_push(primes, num), 0)
        || !test_ptr("../test/rsa_mp_test.c", 213, "num = BN_bin2bn(q, sizeof(q) - 1, NULL)", num = BN_bin2bn(q, sizeof(q) - 1, 
# 213 "../test/rsa_mp_test.c" 3 4
           ((void *)0)
# 213 "../test/rsa_mp_test.c"
           ))
        || !test_int_ne("../test/rsa_mp_test.c", 214, "sk_BIGNUM_push(primes, num)", "0", sk_BIGNUM_push(primes, num), 0)
        || !test_ptr("../test/rsa_mp_test.c", 215, "num = BN_bin2bn(ex_prime, sizeof(ex_prime) - 1, NULL)", num = BN_bin2bn(ex_prime, sizeof(ex_prime) - 1, 
# 215 "../test/rsa_mp_test.c" 3 4
           ((void *)0)
# 215 "../test/rsa_mp_test.c"
           ))
        || !test_int_ne("../test/rsa_mp_test.c", 216, "sk_BIGNUM_push(primes, num)", "0", sk_BIGNUM_push(primes, num), 0))
        goto err;

    if (!test_ptr("../test/rsa_mp_test.c", 219, "num = BN_bin2bn(dmp1, sizeof(dmp1) - 1, NULL)", num = BN_bin2bn(dmp1, sizeof(dmp1) - 1, 
# 219 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 219 "../test/rsa_mp_test.c"
        ))
        || !test_int_ne("../test/rsa_mp_test.c", 220, "sk_BIGNUM_push(exps, num)", "0", sk_BIGNUM_push(exps, num), 0)
        || !test_ptr("../test/rsa_mp_test.c", 221, "num = BN_bin2bn(dmq1, sizeof(dmq1) - 1, NULL)", num = BN_bin2bn(dmq1, sizeof(dmq1) - 1, 
# 221 "../test/rsa_mp_test.c" 3 4
           ((void *)0)
# 221 "../test/rsa_mp_test.c"
           ))
        || !test_int_ne("../test/rsa_mp_test.c", 222, "sk_BIGNUM_push(exps, num)", "0", sk_BIGNUM_push(exps, num), 0)
        || !test_ptr("../test/rsa_mp_test.c", 223, "num = BN_bin2bn(ex_exponent, sizeof(ex_exponent) - 1, NULL)", num = BN_bin2bn(ex_exponent, sizeof(ex_exponent) - 1, 
# 223 "../test/rsa_mp_test.c" 3 4
           ((void *)0)
# 223 "../test/rsa_mp_test.c"
           ))
        || !test_int_ne("../test/rsa_mp_test.c", 224, "sk_BIGNUM_push(exps, num)", "0", sk_BIGNUM_push(exps, num), 0))
        goto err;

    if (!test_ptr("../test/rsa_mp_test.c", 227, "num = BN_bin2bn(iqmp, sizeof(iqmp) - 1, NULL)", num = BN_bin2bn(iqmp, sizeof(iqmp) - 1, 
# 227 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 227 "../test/rsa_mp_test.c"
        ))
        || !test_int_ne("../test/rsa_mp_test.c", 228, "sk_BIGNUM_push(coeffs, num)", "0", sk_BIGNUM_push(coeffs, num), 0)
        || !test_ptr("../test/rsa_mp_test.c", 229, "num = BN_bin2bn(ex_coefficient, sizeof(ex_coefficient) - 1, NULL)", num = BN_bin2bn(ex_coefficient, sizeof(ex_coefficient) - 1, 
# 229 "../test/rsa_mp_test.c" 3 4
           ((void *)0)
# 229 "../test/rsa_mp_test.c"
           ))
        || !test_int_ne("../test/rsa_mp_test.c", 230, "sk_BIGNUM_push(coeffs, num)", "0", sk_BIGNUM_push(coeffs, num), 0))
        goto err;

    if (!test_true("../test/rsa_mp_test.c", 233, "ossl_rsa_set0_all_params(key, primes, exps, coeffs)", (ossl_rsa_set0_all_params(key, primes, exps, coeffs)) != 0))
        goto err;
 ...
 err:
    ...
    primes = exps = coeffs = 
# 245 "../test/rsa_mp_test.c" 3 4
                            ((void *)0)
# 245 "../test/rsa_mp_test.c"
                                ;
    rv = 0;
    goto ret;
}
...
static int test_rsa_mp(int i)
{
    ...
    key = RSA_new();
    if (!test_ptr("../test/rsa_mp_test.c", 267, "key", key))
        goto err;

    if (!test_int_eq("../test/rsa_mp_test.c", 270, "(clen = key2048_key(key))", "256", (clen = key2048_key(key)), 256)
        || !test_int_eq("../test/rsa_mp_test.c", 271, "(clen = param_set[i](key))", "256", (clen = param_set[i](key)), 256))
        goto err;

    if (!test_true("../test/rsa_mp_test.c", 274, "RSA_check_key_ex(key, NULL)", (RSA_check_key_ex(key, 
# 274 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 274 "../test/rsa_mp_test.c"
        )) != 0))
        goto err;

    num = RSA_public_encrypt(plen, ptext_ex, ctext, key,
                             1);
    if (!test_int_eq("../test/rsa_mp_test.c", 279, "num", "clen", num, clen))
        goto err;

    num = RSA_private_decrypt(num, ctext, ptext, key, 1);
    if (!test_mem_eq("../test/rsa_mp_test.c", 283, "ptext", "ptext_ex", ptext, num, ptext_ex, plen))
        goto err;
...
static int test_rsa_mp_gen_bad_input(void)
{
    int ret = 0;
    RSA *rsa = 
# 295 "../test/rsa_mp_test.c" 3 4
              ((void *)0)
# 295 "../test/rsa_mp_test.c"
                  ;
    BIGNUM *ebn = 
# 296 "../test/rsa_mp_test.c" 3 4
                 ((void *)0)
# 296 "../test/rsa_mp_test.c"
                     ;

    if (!test_ptr("../test/rsa_mp_test.c", 298, "rsa = RSA_new()", rsa = RSA_new()))
        goto err;

    if (!test_ptr("../test/rsa_mp_test.c", 301, "ebn = BN_new()", ebn = BN_new()))
        goto err;
    if (!test_true("../test/rsa_mp_test.c", 303, "BN_set_word(ebn, 65537)", (BN_set_word(ebn, 65537)) != 0))
        goto err;


    if (!test_int_eq("../test/rsa_mp_test.c", 307, "RSA_generate_multi_prime_key(rsa, 1024, 2, NULL, NULL)", "0", RSA_generate_multi_prime_key(rsa, 1024, 2, 
# 307 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 307 "../test/rsa_mp_test.c"
        , 
# 307 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 307 "../test/rsa_mp_test.c"
    ...
    if (!test_int_eq("../test/rsa_mp_test.c", 311, "RSA_generate_multi_prime_key(rsa, 500, 2, ebn, NULL)", "0", RSA_generate_multi_prime_key(rsa, 500, 2, ebn, 
# 311 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 311 "../test/rsa_mp_test.c"
        ), 0))
        goto err;


    if (!test_int_eq("../test/rsa_mp_test.c", 315, "RSA_generate_multi_prime_key(rsa, 1024, 1, ebn, NULL)", "0", RSA_generate_multi_prime_key(rsa, 1024, 1, ebn, 
# 315 "../test/rsa_mp_test.c" 3 4
        ((void *)0)
# 315 "../test/rsa_mp_test.c"
        ), 0))
        goto err;
    ret = 1;
err:
...
int setup_tests(void)
{
    ...
    add_all_tests("test_rsa_mp", test_rsa_mp, 2, 1);
    return 1;
}
