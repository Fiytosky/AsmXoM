# 0 "../test/ssl_old_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ssl_old_test.c"
# 12 "../test/ssl_old_test.c"
...
# 13 "../test/ssl_old_test.c" 2
# 22 "../test/ssl_old_test.c"
# 1 "/usr/include/assert.h" 1 3 4
# 23 "../test/ssl_old_test.c" 2
...
# 24 "../test/ssl_old_test.c" 2
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/limits.h" 1 3 4
# 25 "../test/ssl_old_test.c" 2
...
# 28 "../test/ssl_old_test.c" 2


# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 31 "../test/ssl_old_test.c" 2
# 39 "../test/ssl_old_test.c"
...
int RAND_poll(void);
# 49 "../test/ssl_old_test.c" 2
# 57 "../test/ssl_old_test.c"
...
int test_printf_taperr(const char *fmt, ...)
    __attribute__((__format__(__gnu_printf__, 1, 2)));
# 60 "../test/ssl_old_test.c" 2
# 75 "../test/ssl_old_test.c"
...
# 76 "../test/ssl_old_test.c" 2

static SSL_CTX *s_ctx = 
# 77 "../test/ssl_old_test.c" 3 4
                       ((void *)0)
# 77 "../test/ssl_old_test.c"
                           ;
static SSL_CTX *s_ctx2 = 
# 78 "../test/ssl_old_test.c" 3 4
                        ((void *)0)
# 78 "../test/ssl_old_test.c"
                            ;
...
static char *psk_key = 
# 94 "../test/ssl_old_test.c" 3 4
                      ((void *)0)
# 94 "../test/ssl_old_test.c"
                          ;
...
# 106 "../test/ssl_old_test.c" 3 4
                        ((void *)0)
# 106 "../test/ssl_old_test.c"
                            ;
...
static int servername_cb(SSL *s, int *ad, void *arg)
{
    ...
    if (sn_server2 == 
# 213 "../test/ssl_old_test.c" 3 4
                     ((void *)0)
# 213 "../test/ssl_old_test.c"
                         ) {
    ...
    if (servername) {
        if (s_ctx2 != 
# 219 "../test/ssl_old_test.c" 3 4
                     ((void *)0) 
# 219 "../test/ssl_old_test.c"
                          && sn_server2 != 
# 219 "../test/ssl_old_test.c" 3 4
                                           ((void *)0) 
# 219 "../test/ssl_old_test.c"
                                        ...
                                        const char *in)
{
    ...
    if (len >= 65535)
        return 
# 265 "../test/ssl_old_test.c" 3 4
              ((void *)0)
# 265 "../test/ssl_old_test.c"
                  ;

    out = CRYPTO_malloc(strlen(in) + 1, "../test/ssl_old_test.c", 267);
    if (!out)
        return 
# 269 "../test/ssl_old_test.c" 3 4
              ((void *)0)
# 269 "../test/ssl_old_test.c"
                  ;

    for (i = 0; i <= len; ++i) {
        if (i == len || in[i] == ',') {
            if (i - start > 255) {
                CRYPTO_free(out, "../test/ssl_old_test.c", 274);
                return 
# 275 "../test/ssl_old_test.c" 3 4
                      ((void *)0)
# 275 "../test/ssl_old_test.c"
                          ;
            }
                          ...
                          unsigned int inlen, void *arg)
{
    ...
    if (protos == 
# 296 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 296 "../test/ssl_old_test.c"
                     ) {
        fprintf(
# 297 "../test/ssl_old_test.c" 3 4
               stderr
# 297 "../test/ssl_old_test.c"
    ...
    if (SSL_select_next_proto
        ((unsigned char **)out, outlen, protos, protos_len, in,
         inlen) != 1) {
        CRYPTO_free(protos, "../test/ssl_old_test.c", 305);
        return 3;
    }
    ...
    alpn_selected = CRYPTO_malloc(*outlen, "../test/ssl_old_test.c", 313);
    if (alpn_selected == 
# 314 "../test/ssl_old_test.c" 3 4
                        ((void *)0)
# 314 "../test/ssl_old_test.c"
                            ) {
        fprintf(
# 315 "../test/ssl_old_test.c" 3 4
               stderr
# 315 "../test/ssl_old_test.c"
                     , "failed to allocate memory\n");
        CRYPTO_free(protos, "../test/ssl_old_test.c", 316);
        abort();
    }
    memcpy(alpn_selected, *out, *outlen);
    *out = alpn_selected;

    CRYPTO_free(protos, "../test/ssl_old_test.c", 322);
    return 0;
}
...
static int verify_alpn(SSL *client, SSL *server)
{
    ...
    CRYPTO_free(alpn_selected, "../test/ssl_old_test.c", 333);
    alpn_selected = 
# 334 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
# 334 "../test/ssl_old_test.c"
                       ;

    if (client_proto == 
# 336 "../test/ssl_old_test.c" 3 4
                       ((void *)0) 
# 336 "../test/ssl_old_test.c"
                            && client_proto_len != 0) {
        BIO_printf(bio_stdout,
    ...
    if (server_proto == 
# 342 "../test/ssl_old_test.c" 3 4
                       ((void *)0) 
# 342 "../test/ssl_old_test.c"
                            && server_proto_len != 0) {
        BIO_printf(bio_stdout,
    ...
    if (client_proto != 
# 353 "../test/ssl_old_test.c" 3 4
                       ((void *)0) 
# 353 "../test/ssl_old_test.c"
                            &&
    ...
    if (client_proto_len > 0 && alpn_expected == 
# 359 "../test/ssl_old_test.c" 3 4
                                                ((void *)0)
# 359 "../test/ssl_old_test.c"
                                                    ) {
    ...
    if (alpn_expected != 
# 364 "../test/ssl_old_test.c" 3 4
                        ((void *)0) 
# 364 "../test/ssl_old_test.c"
                             &&
...
# 404 "../test/ssl_old_test.c"
static const char custom_ext_cli_string[] = "abc";
static const char custom_ext_srv_string[] = "defg";


static char *serverinfo_file = 
# 408 "../test/ssl_old_test.c" 3 4
                              ((void *)0)
# 408 "../test/ssl_old_test.c"
                                  ;
...
{
    *out = 
# 596 "../test/ssl_old_test.c" 3 4
          ((void *)0)
# 596 "../test/ssl_old_test.c"
              ;
    *outlen = 0;
    return 1;
}
...
static char *cipher = 
# 624 "../test/ssl_old_test.c" 3 4
                     ((void *)0)
# 624 "../test/ssl_old_test.c"
                         ;
static char *ciphersuites = 
# 625 "../test/ssl_old_test.c" 3 4
                           ((void *)0)
# 625 "../test/ssl_old_test.c"
                               ;
...
{
    fprintf(
# 637 "../test/ssl_old_test.c" 3 4
           stderr
# 637 "../test/ssl_old_test.c"
                 , "usage: ssltest [args ...]\n");
    fprintf(
# 638 "../test/ssl_old_test.c" 3 4
           stderr
# 638 "../test/ssl_old_test.c"
                 , "\n");
    fprintf(
# 639 "../test/ssl_old_test.c" 3 4
           stderr
# 639 "../test/ssl_old_test.c"
                 , " -server_auth  - check server certificate\n");
    fprintf(
# 640 "../test/ssl_old_test.c" 3 4
           stderr
# 640 "../test/ssl_old_test.c"
                 , " -client_auth  - do client authentication\n");
    fprintf(
# 641 "../test/ssl_old_test.c" 3 4
           stderr
# 641 "../test/ssl_old_test.c"
                 , " -v            - more output\n");
    fprintf(
# 642 "../test/ssl_old_test.c" 3 4
           stderr
# 642 "../test/ssl_old_test.c"
                 , " -d            - debug output\n");
    fprintf(
# 643 "../test/ssl_old_test.c" 3 4
           stderr
# 643 "../test/ssl_old_test.c"
                 , " -reuse        - use session-id reuse\n");
    fprintf(
# 644 "../test/ssl_old_test.c" 3 4
           stderr
# 644 "../test/ssl_old_test.c"
                 , " -num <val>    - number of connections to perform\n");
    fprintf(
# 645 "../test/ssl_old_test.c" 3 4
           stderr
# 645 "../test/ssl_old_test.c"
                 ,
            " -bytes <val>  - number of bytes to swap between client/server\n");

    fprintf(
# 648 "../test/ssl_old_test.c" 3 4
           stderr
# 648 "../test/ssl_old_test.c"
                 ,
            " -dhe512       - use 512 bit key for DHE (to test failure)\n");
    fprintf(
# 650 "../test/ssl_old_test.c" 3 4
           stderr
# 650 "../test/ssl_old_test.c"
                 ,
            " -dhe1024dsa   - use 1024 bit key (with 160-bit subprime) for DHE\n");
    fprintf(
# 652 "../test/ssl_old_test.c" 3 4
           stderr
# 652 "../test/ssl_old_test.c"
                 ,
            " -dhe2048      - use 2048 bit key (safe prime) for DHE (default, no-op)\n");
    fprintf(
# 654 "../test/ssl_old_test.c" 3 4
           stderr
# 654 "../test/ssl_old_test.c"
                 ,
            " -dhe4096      - use 4096 bit key (safe prime) for DHE\n");

    fprintf(
# 657 "../test/ssl_old_test.c" 3 4
           stderr
# 657 "../test/ssl_old_test.c"
                 , " -no_dhe       - disable DHE\n");

    fprintf(
# 659 "../test/ssl_old_test.c" 3 4
           stderr
# 659 "../test/ssl_old_test.c"
                 , " -no_ecdhe     - disable ECDHE\n");


    fprintf(
# 662 "../test/ssl_old_test.c" 3 4
           stderr
# 662 "../test/ssl_old_test.c"
    ...
    fprintf(
# 668 "../test/ssl_old_test.c" 3 4
           stderr
# 668 "../test/ssl_old_test.c"
                 , " -tls1         - use TLSv1\n");


    fprintf(
# 671 "../test/ssl_old_test.c" 3 4
           stderr
# 671 "../test/ssl_old_test.c"
                 , " -tls1_1       - use TLSv1.1\n");


    fprintf(
# 674 "../test/ssl_old_test.c" 3 4
           stderr
# 674 "../test/ssl_old_test.c"
                 , " -tls1_2       - use TLSv1.2\n");


    fprintf(
# 677 "../test/ssl_old_test.c" 3 4
           stderr
# 677 "../test/ssl_old_test.c"
                 , " -dtls         - use DTLS\n");

    fprintf(
# 679 "../test/ssl_old_test.c" 3 4
           stderr
# 679 "../test/ssl_old_test.c"
                 , " -dtls1        - use DTLSv1\n");


    fprintf(
# 682 "../test/ssl_old_test.c" 3 4
           stderr
# 682 "../test/ssl_old_test.c"
                 , " -dtls12       - use DTLSv1.2\n");


    fprintf(
# 685 "../test/ssl_old_test.c" 3 4
           stderr
# 685 "../test/ssl_old_test.c"
                 , " -CApath arg   - PEM format directory of CA's\n");
    fprintf(
# 686 "../test/ssl_old_test.c" 3 4
           stderr
# 686 "../test/ssl_old_test.c"
                 , " -CAfile arg   - PEM format file of CA's\n");
    fprintf(
# 687 "../test/ssl_old_test.c" 3 4
           stderr
# 687 "../test/ssl_old_test.c"
                 , " -s_cert arg   - Server certificate file\n");
    fprintf(
# 688 "../test/ssl_old_test.c" 3 4
           stderr
# 688 "../test/ssl_old_test.c"
                 ,
            " -s_key arg    - Server key file (default: same as -cert)\n");
    fprintf(
# 690 "../test/ssl_old_test.c" 3 4
           stderr
# 690 "../test/ssl_old_test.c"
                 , " -c_cert arg   - Client certificate file\n");
    fprintf(
# 691 "../test/ssl_old_test.c" 3 4
           stderr
# 691 "../test/ssl_old_test.c"
                 ,
            " -c_key arg    - Client key file (default: same as -c_cert)\n");
    fprintf(
# 693 "../test/ssl_old_test.c" 3 4
           stderr
# 693 "../test/ssl_old_test.c"
                 , " -cipher arg   - The TLSv1.2 and below cipher list\n");
    fprintf(
# 694 "../test/ssl_old_test.c" 3 4
           stderr
# 694 "../test/ssl_old_test.c"
                 , " -ciphersuites arg   - The TLSv1.3 ciphersuites\n");
    fprintf(
# 695 "../test/ssl_old_test.c" 3 4
           stderr
# 695 "../test/ssl_old_test.c"
                 , " -bio_pair     - Use BIO pairs\n");
    fprintf(
# 696 "../test/ssl_old_test.c" 3 4
           stderr
# 696 "../test/ssl_old_test.c"
                 , " -ipv4         - Use IPv4 connection on localhost\n");
    fprintf(
# 697 "../test/ssl_old_test.c" 3 4
           stderr
# 697 "../test/ssl_old_test.c"
                 , " -ipv6         - Use IPv6 connection on localhost\n");
    fprintf(
# 698 "../test/ssl_old_test.c" 3 4
           stderr
# 698 "../test/ssl_old_test.c"
                 , " -f            - Test even cases that can't work\n");
    fprintf(
# 699 "../test/ssl_old_test.c" 3 4
           stderr
# 699 "../test/ssl_old_test.c"
                 ,
            " -time         - measure processor time used by client and server\n");
    fprintf(
# 701 "../test/ssl_old_test.c" 3 4
           stderr
# 701 "../test/ssl_old_test.c"
                 , " -zlib         - use zlib compression\n");

    fprintf(
# 703 "../test/ssl_old_test.c" 3 4
           stderr
# 703 "../test/ssl_old_test.c"
                 , " -npn_client - have client side offer NPN\n");
    fprintf(
# 704 "../test/ssl_old_test.c" 3 4
           stderr
# 704 "../test/ssl_old_test.c"
                 , " -npn_server - have server side offer NPN\n");
    fprintf(
# 705 "../test/ssl_old_test.c" 3 4
           stderr
# 705 "../test/ssl_old_test.c"
                 , " -npn_server_reject - have server reject NPN\n");

    fprintf(
# 707 "../test/ssl_old_test.c" 3 4
           stderr
# 707 "../test/ssl_old_test.c"
                 , " -serverinfo_file file - have server use this file\n");
    fprintf(
# 708 "../test/ssl_old_test.c" 3 4
           stderr
# 708 "../test/ssl_old_test.c"
                 , " -serverinfo_sct  - have client offer and expect SCT\n");
    fprintf(
# 709 "../test/ssl_old_test.c" 3 4
           stderr
# 709 "../test/ssl_old_test.c"
                 ,
            " -serverinfo_tack - have client offer and expect TACK\n");
    fprintf(
# 711 "../test/ssl_old_test.c" 3 4
           stderr
# 711 "../test/ssl_old_test.c"
                 ,
            " -custom_ext - try various custom extension callbacks\n");
    fprintf(
# 713 "../test/ssl_old_test.c" 3 4
           stderr
# 713 "../test/ssl_old_test.c"
                 , " -alpn_client <string> - have client side offer ALPN\n");
    fprintf(
# 714 "../test/ssl_old_test.c" 3 4
           stderr
# 714 "../test/ssl_old_test.c"
                 , " -alpn_server <string> - have server side offer ALPN\n");
    fprintf(
# 715 "../test/ssl_old_test.c" 3 4
           stderr
# 715 "../test/ssl_old_test.c"
                 , " -alpn_server1 <string> - alias for -alpn_server\n");
    fprintf(
# 716 "../test/ssl_old_test.c" 3 4
           stderr
# 716 "../test/ssl_old_test.c"
                 , " -alpn_server2 <string> - have server side context 2 offer ALPN\n");
    fprintf(
# 717 "../test/ssl_old_test.c" 3 4
           stderr
# 717 "../test/ssl_old_test.c"
                 ,
            " -alpn_expected <string> - the ALPN protocol that should be negotiated\n");
    fprintf(
# 719 "../test/ssl_old_test.c" 3 4
           stderr
# 719 "../test/ssl_old_test.c"
                 , " -server_min_proto <string> - Minimum version the server should support\n");
    fprintf(
# 720 "../test/ssl_old_test.c" 3 4
           stderr
# 720 "../test/ssl_old_test.c"
                 , " -server_max_proto <string> - Maximum version the server should support\n");
    fprintf(
# 721 "../test/ssl_old_test.c" 3 4
           stderr
# 721 "../test/ssl_old_test.c"
                 , " -client_min_proto <string> - Minimum version the client should support\n");
    fprintf(
# 722 "../test/ssl_old_test.c" 3 4
           stderr
# 722 "../test/ssl_old_test.c"
                 , " -client_max_proto <string> - Maximum version the client should support\n");
    fprintf(
# 723 "../test/ssl_old_test.c" 3 4
           stderr
# 723 "../test/ssl_old_test.c"
                 , " -should_negotiate <string> - The version that should be negotiated, fail-client or fail-server\n");

    fprintf(
# 725 "../test/ssl_old_test.c" 3 4
           stderr
# 725 "../test/ssl_old_test.c"
                 , " -noct         - no certificate transparency\n");
    fprintf(
# 726 "../test/ssl_old_test.c" 3 4
           stderr
# 726 "../test/ssl_old_test.c"
                 , " -requestct    - request certificate transparency\n");
    fprintf(
# 727 "../test/ssl_old_test.c" 3 4
           stderr
# 727 "../test/ssl_old_test.c"
                 , " -requirect    - require certificate transparency\n");

    fprintf(
# 729 "../test/ssl_old_test.c" 3 4
           stderr
# 729 "../test/ssl_old_test.c"
                 , " -sn_client <string>  - have client request this servername\n");
    fprintf(
# 730 "../test/ssl_old_test.c" 3 4
           stderr
# 730 "../test/ssl_old_test.c"
                 , " -sn_server1 <string> - have server context 1 respond to this servername\n");
    fprintf(
# 731 "../test/ssl_old_test.c" 3 4
           stderr
# 731 "../test/ssl_old_test.c"
                 , " -sn_server2 <string> - have server context 2 respond to this servername\n");
    fprintf(
# 732 "../test/ssl_old_test.c" 3 4
           stderr
# 732 "../test/ssl_old_test.c"
                 , " -sn_expect1          - expected server 1\n");
    fprintf(
# 733 "../test/ssl_old_test.c" 3 4
           stderr
# 733 "../test/ssl_old_test.c"
                 , " -sn_expect2          - expected server 2\n");
    fprintf(
# 734 "../test/ssl_old_test.c" 3 4
           stderr
# 734 "../test/ssl_old_test.c"
                 , " -server_sess_out <file>    - Save the server session to a file\n");
    fprintf(
# 735 "../test/ssl_old_test.c" 3 4
           stderr
# 735 "../test/ssl_old_test.c"
                 , " -server_sess_in <file>     - Read the server session from a file\n");
    fprintf(
# 736 "../test/ssl_old_test.c" 3 4
           stderr
# 736 "../test/ssl_old_test.c"
                 , " -client_sess_out <file>    - Save the client session to a file\n");
    fprintf(
# 737 "../test/ssl_old_test.c" 3 4
           stderr
# 737 "../test/ssl_old_test.c"
                 , " -client_sess_in <file>     - Read the client session from a file\n");
    fprintf(
# 738 "../test/ssl_old_test.c" 3 4
           stderr
# 738 "../test/ssl_old_test.c"
                 , " -should_reuse <number>     - The expected state of reusing the session\n");
    fprintf(
# 739 "../test/ssl_old_test.c" 3 4
           stderr
# 739 "../test/ssl_old_test.c"
                 , " -no_ticket    - do not issue TLS session ticket\n");
    fprintf(
# 740 "../test/ssl_old_test.c" 3 4
           stderr
# 740 "../test/ssl_old_test.c"
                 , " -client_ktls  - try to enable client KTLS\n");
    fprintf(
# 741 "../test/ssl_old_test.c" 3 4
           stderr
# 741 "../test/ssl_old_test.c"
                 , " -server_ktls  - try to enable server KTLS\n");
    fprintf(
# 742 "../test/ssl_old_test.c" 3 4
           stderr
# 742 "../test/ssl_old_test.c"
                 , " -provider <name>    - Load the given provider into the library context\n");
    fprintf(
# 743 "../test/ssl_old_test.c" 3 4
           stderr
# 743 "../test/ssl_old_test.c"
...
static void print_details(SSL *c_ssl, const char *prefix)
{
    ...
    if (cert != 
# 793 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 793 "../test/ssl_old_test.c"
                   ) {
        EVP_PKEY* pubkey = X509_get0_pubkey(cert);

        if (pubkey != 
# 796 "../test/ssl_old_test.c" 3 4
                     ((void *)0)
# 796 "../test/ssl_old_test.c"
                         ) {
            BIO_puts(bio_stdout, ", ");
            print_key_details(bio_stdout, pubkey);
        }
    }
    if (SSL_ctrl(c_ssl,109,0,&pkey)) {
        BIO_puts(bio_stdout, ", temp key: ");
        print_key_details(bio_stdout, pkey);
        EVP_PKEY_free(pkey);
    }
    if (SSL_ctrl(c_ssl,108,0,&mdnid))
...
static SSL_SESSION *read_session(const char *filename)
{
    ...
    if (f == 
# 844 "../test/ssl_old_test.c" 3 4
            ((void *)0)
# 844 "../test/ssl_old_test.c"
                ) {
        BIO_printf(bio_err, "Can't open session file %s\n", filename);
        ERR_print_errors(bio_err);
        return 
# 847 "../test/ssl_old_test.c" 3 4
              ((void *)0)
# 847 "../test/ssl_old_test.c"
                  ;
    }
    sess = PEM_read_bio_SSL_SESSION(f, 
# 849 "../test/ssl_old_test.c" 3 4
                                      ((void *)0)
# 849 "../test/ssl_old_test.c"
                                          , 0, 
# 849 "../test/ssl_old_test.c" 3 4
                                               ((void *)0)
# 849 "../test/ssl_old_test.c"
    ...
    if (sess == 
# 850 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 850 "../test/ssl_old_test.c"
                   ) {
...
static int write_session(const char *filename, SSL_SESSION *sess)
{
    ...
    if (sess == 
# 862 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 862 "../test/ssl_old_test.c"
                   ) {
    ...
    if (f == 
# 868 "../test/ssl_old_test.c" 3 4
            ((void *)0)
# 868 "../test/ssl_old_test.c"
                ) {
        BIO_printf(bio_err, "Can't open session file %s\n", filename);
        ERR_print_errors(bio_err);
        return 0;
...
{
    if (version != 
# 885 "../test/ssl_old_test.c" 3 4
                  ((void *)0)
# 885 "../test/ssl_old_test.c"
                      ) {
        ...
        return SSL_ctrl(ssl, setting, ver, 
# 891 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 891 "../test/ssl_old_test.c"
                                              );
    }
    return 1;
}
...
{
    const char *CApath = 
# 898 "../test/ssl_old_test.c" 3 4
                        ((void *)0)
# 898 "../test/ssl_old_test.c"
                            , *CAfile = 
# 898 "../test/ssl_old_test.c" 3 4
                                        ((void *)0)
# 898 "../test/ssl_old_test.c"
    ...
    int ret = 
# 903 "../test/ssl_old_test.c" 3 4
             1
# 903 "../test/ssl_old_test.c"
                         ;
    int client_auth = 0;
    int server_auth = 0, i;
    struct app_verify_arg app_verify_arg =
        { "Test Callback Argument", 0 };
    SSL_CTX *c_ctx = 
# 908 "../test/ssl_old_test.c" 3 4
                    ((void *)0)
# 908 "../test/ssl_old_test.c"
                        ;
    const SSL_METHOD *meth = 
# 909 "../test/ssl_old_test.c" 3 4
                            ((void *)0)
# 909 "../test/ssl_old_test.c"
                                ;
    SSL *c_ssl = 
# 910 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 910 "../test/ssl_old_test.c"
                    ;
    SSL *s_ssl = 
# 911 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 911 "../test/ssl_old_test.c"
                    ;
    ...
    int n, comp = 0;
    COMP_METHOD *cm = 
# 927 "../test/ssl_old_test.c" 3 4
                     ((void *)0)
# 927 "../test/ssl_old_test.c"
                         ;
    struct stack_st_SSL_COMP *ssl_comp_methods = 
# 928 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 928 "../test/ssl_old_test.c"
                                              ;
    ...
    SSL_CONF_CTX *s_cctx = 
# 939 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 939 "../test/ssl_old_test.c"
                              , *c_cctx = 
# 939 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 939 "../test/ssl_old_test.c"
...
# 939 "../test/ssl_old_test.c"
                                                               ;
    struct stack_st_OPENSSL_STRING *conf_args = 
# 940 "../test/ssl_old_test.c" 3 4
                                         ((void *)0)
# 940 "../test/ssl_old_test.c"
                                             ;
    char *arg = 
# 941 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 941 "../test/ssl_old_test.c"
                   , *argn = 
# 941 "../test/ssl_old_test.c" 3 4
                             ((void *)0)
# 941 "../test/ssl_old_test.c"
                                 ;
    const char *provider = 
# 942 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 942 "../test/ssl_old_test.c"
                              , *config = 
# 942 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 942 "../test/ssl_old_test.c"
...
# 943 "../test/ssl_old_test.c" 3 4
                             ((void *)0)
# 943 "../test/ssl_old_test.c"
                                 , *defctxnull = 
# 943 "../test/ssl_old_test.c" 3 4
                                                 ((void *)0)
# 943 "../test/ssl_old_test.c"
                                                     ;
    OSSL_LIB_CTX *libctx = 
# 944 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 944 "../test/ssl_old_test.c"
                              ;
    ...
    bio_stdout = BIO_new_fp(
# 951 "../test/ssl_old_test.c" 3 4
                           stdout
# 951 "../test/ssl_old_test.c"
                                 , 0x00 | 0x10);
    ...
    while (argc >= 1) {
        if (strcmp(*argv, "-F") == 0) {
            fprintf(
# 993 "../test/ssl_old_test.c" 3 4
                   stderr
# 993 "../test/ssl_old_test.c"
                         ,
                    "not compiled with FIPS support, so exiting without running.\n");
            ret = 
# 995 "../test/ssl_old_test.c" 3 4
                 0
# 995 "../test/ssl_old_test.c"
                             ;
            goto end;
            ...
            dtls = 1;
        } else if ((strncmp(*argv, "-num" "", sizeof("-num") - 1) == 0)) {
            if (--argc < 1)
                goto bad;
            number = atoi(*(++argv));
            if (number == 0)
            ...
            if (rv > 0) {
                if (rv == 1)
                    argn = 
# 1230 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 1230 "../test/ssl_old_test.c"
                              ;
                if (!conf_args) {
                    conf_args = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
                    if (!conf_args)
                        goto end;
                }
                if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(conf_args), ossl_check_OPENSSL_STRING_type(arg)))
                    goto end;
                if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(conf_args), ossl_check_OPENSSL_STRING_type(argn)))
                    goto end;
                continue;
            }
            if (rv == -3)
 ...
 bad:
    ...
    if (ssl3 + tls1 + tls1_1 + tls1_2 + dtls + dtls1 + dtls12 > 1) {
        fprintf(
# 1261 "../test/ssl_old_test.c" 3 4
               stderr
# 1261 "../test/ssl_old_test.c"
...
# 1296 "../test/ssl_old_test.c"
    ...
    if (no_protocol) {
        fprintf(
# 1304 "../test/ssl_old_test.c" 3 4
               stderr
# 1304 "../test/ssl_old_test.c"
                     , "Testing was requested for a disabled protocol. "
                "Skipping tests.\n");
        ret = 
# 1306 "../test/ssl_old_test.c" 3 4
             0
# 1306 "../test/ssl_old_test.c"
                         ;
        goto end;
    }
    ...
    if (!ssl3 && !tls1 && !tls1_1 && !tls1_2 && !dtls && !dtls1 && !dtls12 && number > 1
            && !reuse && !force) {
        fprintf(
# 1312 "../test/ssl_old_test.c" 3 4
               stderr
# 1312 "../test/ssl_old_test.c"
    ...
    if (print_time) {
        if (bio_type == BIO_MEM) {
            fprintf(
# 1321 "../test/ssl_old_test.c" 3 4
                   stderr
# 1321 "../test/ssl_old_test.c"
                         , "Using BIO pair (-bio_pair)\n");
            bio_type = BIO_PAIR;
        }
        if (number < 50 && !force)
            fprintf(
# 1325 "../test/ssl_old_test.c" 3 4
                   stderr
# 1325 "../test/ssl_old_test.c"
                         ,
    ...
    if (comp == 1)
        cm = COMP_zlib();
    if (cm != 
# 1332 "../test/ssl_old_test.c" 3 4
             ((void *)0)
# 1332 "../test/ssl_old_test.c"
                 ) {
        if (SSL_COMP_add_compression_method(comp, cm) != 0) {
            fprintf(
# 1334 "../test/ssl_old_test.c" 3 4
                   stderr
# 1334 "../test/ssl_old_test.c"
                         , "Failed to add compression method\n");
            ERR_print_errors_fp(
# 1335 "../test/ssl_old_test.c" 3 4
                               stderr
# 1335 "../test/ssl_old_test.c"
                                     );
        }
    } else {
        fprintf(
# 1338 "../test/ssl_old_test.c" 3 4
               stderr
# 1338 "../test/ssl_old_test.c"
                     ,
                "Warning: %s compression not supported\n",
                comp == 1 ? "zlib" : "unknown");
        ERR_print_errors_fp(
# 1341 "../test/ssl_old_test.c" 3 4
                           stderr
# 1341 "../test/ssl_old_test.c"
                                 );
    }
    ssl_comp_methods = SSL_COMP_get_compression_methods();
    n = OPENSSL_sk_num(ossl_check_const_SSL_COMP_sk_type(ssl_comp_methods));
    if (n) {
        int j;
        printf("Available compression methods:");
        for (j = 0; j < n; j++) {
            SSL_COMP *c = ((SSL_COMP *)OPENSSL_sk_value(ossl_check_const_SSL_COMP_sk_type(ssl_comp_methods), (j)));
    ...
    if (provider != 
# 1396 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
            
# 1397 "../test/ssl_old_test.c"
           && !test_get_libctx(&libctx, &defctxnull, config, &thisprov, provider))
        goto end;

    c_ctx = SSL_CTX_new_ex(libctx, 
# 1400 "../test/ssl_old_test.c" 3 4
                                  ((void *)0)
# 1400 "../test/ssl_old_test.c"
                                      , meth);
    s_ctx = SSL_CTX_new_ex(libctx, 
# 1401 "../test/ssl_old_test.c" 3 4
                                  ((void *)0)
# 1401 "../test/ssl_old_test.c"
                                      , meth);
    s_ctx2 = SSL_CTX_new_ex(libctx, 
# 1402 "../test/ssl_old_test.c" 3 4
                                   ((void *)0)
# 1402 "../test/ssl_old_test.c"
                                       , meth);
    if ((c_ctx == 
# 1403 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 1403 "../test/ssl_old_test.c"
                     ) || (s_ctx == 
# 1403 "../test/ssl_old_test.c" 3 4
                                    ((void *)0)
# 1403 "../test/ssl_old_test.c"
...
# 1403 "../test/ssl_old_test.c"
    ...
    if (no_ticket) {
        SSL_CTX_set_options(c_ctx, ((uint64_t)1 << (uint64_t)14));
        SSL_CTX_set_options(s_ctx, ((uint64_t)1 << (uint64_t)14));
    }

    if (SSL_CTX_ctrl(c_ctx, 123, min_version, 
# 1421 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1421 "../test/ssl_old_test.c"
       ) == 0)
        goto end;
    if (SSL_CTX_ctrl(c_ctx, 124, max_version, 
# 1423 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1423 "../test/ssl_old_test.c"
       ) == 0)
        goto end;
    if (SSL_CTX_ctrl(s_ctx, 123, min_version, 
# 1425 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1425 "../test/ssl_old_test.c"
       ) == 0)
        goto end;
    if (SSL_CTX_ctrl(s_ctx, 124, max_version, 
# 1427 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1427 "../test/ssl_old_test.c"
       ) == 0)
        goto end;

    if (cipher != 
# 1430 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 1430 "../test/ssl_old_test.c"
                     ) {
        if (strcmp(cipher, "") == 0) {
            if (!SSL_CTX_set_cipher_list(c_ctx, cipher)) {
                if (ERR_GET_REASON(ERR_peek_error()) == 185) {
                    ERR_clear_error();
                } else {
                    ERR_print_errors(bio_err);
                    goto end;
                ...
                fprintf(
# 1441 "../test/ssl_old_test.c" 3 4
                       stderr
# 1441 "../test/ssl_old_test.c"
            ...
            if (!SSL_CTX_set_cipher_list(s_ctx, cipher)) {
                ...
                fprintf(
# 1454 "../test/ssl_old_test.c" 3 4
                       stderr
# 1454 "../test/ssl_old_test.c"
                             , "CLEARING ALL TLSv1.2 CIPHERS SHOULD FAIL\n");
                goto end;
            }
            ...
            if (!SSL_CTX_set_cipher_list(s_ctx2, cipher)) {
                ...
                fprintf(
# 1467 "../test/ssl_old_test.c" 3 4
                       stderr
# 1467 "../test/ssl_old_test.c"
                             , "CLEARING ALL TLSv1.2 CIPHERS SHOULD FAIL\n");
                goto end;
            }
        } else {
    ...
    if (ciphersuites != 
# 1479 "../test/ssl_old_test.c" 3 4
                       ((void *)0)
# 1479 "../test/ssl_old_test.c"
                           ) {
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(conf_args)); i += 2) {
        int rv;
        arg = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(conf_args), (i)));
        argn = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(conf_args), (i + 1)));
    ...
    if (!no_dhe) {
        ...
        if (dhpkey == 
# 1536 "../test/ssl_old_test.c" 3 4
                     ((void *)0) 
# 1536 "../test/ssl_old_test.c"
    ...
    if (server_auth) {
        ...
        SSL_CTX_set_verify(c_ctx, 0x01, verify_callback);
    ...
    if (psk_key != 
# 1601 "../test/ssl_old_test.c" 3 4
                  ((void *)0)
# 1601 "../test/ssl_old_test.c"
                      ) {
        ...
        if (no_psk) {
            ...
            ret = 
# 1610 "../test/ssl_old_test.c" 3 4
                 0
# 1610 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
    ...
    if (npn_client) {
        SSL_CTX_set_next_proto_select_cb(c_ctx, cb_client_npn, 
# 1630 "../test/ssl_old_test.c" 3 4
                                                              ((void *)0)
# 1630 "../test/ssl_old_test.c"
                                                                  );
    }
    if (npn_server) {
        ...
        SSL_CTX_set_next_protos_advertised_cb(s_ctx, cb_server_npn, 
# 1638 "../test/ssl_old_test.c" 3 4
                                                           ((void *)0)
# 1638 "../test/ssl_old_test.c"
                                                               );
        SSL_CTX_set_next_protos_advertised_cb(s_ctx2, cb_server_npn, 
# 1639 "../test/ssl_old_test.c" 3 4
                                                            ((void *)0)
# 1639 "../test/ssl_old_test.c"
                                                                );
    }
    if (npn_server_reject) {
        SSL_CTX_set_next_protos_advertised_cb(s_ctx, cb_server_rejects_npn, 
# 1642 "../test/ssl_old_test.c" 3 4
                                                                   ((void *)0)
# 1642 "../test/ssl_old_test.c"
                                                                       );
        SSL_CTX_set_next_protos_advertised_cb(s_ctx2, cb_server_rejects_npn, 
# 1643 "../test/ssl_old_test.c" 3 4
                                                                    ((void *)0)
# 1643 "../test/ssl_old_test.c"
                                                                        );
    }
...
# 1650 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 1650 "../test/ssl_old_test.c"
                   , 
# 1650 "../test/ssl_old_test.c" 3 4
                     ((void *)0)
# 1650 "../test/ssl_old_test.c"
...
# 1651 "../test/ssl_old_test.c" 3 4
                                        ((void *)0)
# 1651 "../test/ssl_old_test.c"
                                            )) {
    ...
    if (serverinfo_tack) {
        if (!SSL_CTX_add_client_custom_ext(c_ctx, 62208,
                                      
# 1658 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1658 "../test/ssl_old_test.c"
                                         , 
# 1658 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1658 "../test/ssl_old_test.c"
...
# 1658 "../test/ssl_old_test.c"
                                                     ,
                                      serverinfo_cli_parse_cb, 
# 1659 "../test/ssl_old_test.c" 3 4
                                                              ((void *)0)
# 1659 "../test/ssl_old_test.c"
                                                                  )) {
    ...
    if (custom_ext) {
        if (!SSL_CTX_add_client_custom_ext(c_ctx, 1000,
                                      custom_ext_0_cli_add_cb,
                                      
# 1674 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1674 "../test/ssl_old_test.c"
                                         , 
# 1674 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1674 "../test/ssl_old_test.c"
...
# 1675 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1675 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_client_custom_ext(c_ctx, 1001,
                                      custom_ext_1_cli_add_cb,
                                      
# 1678 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1678 "../test/ssl_old_test.c"
                                         , 
# 1678 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1678 "../test/ssl_old_test.c"
...
# 1679 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1679 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_client_custom_ext(c_ctx, 1002,
                                      custom_ext_2_cli_add_cb,
                                      
# 1682 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1682 "../test/ssl_old_test.c"
                                         , 
# 1682 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1682 "../test/ssl_old_test.c"
...
# 1683 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1683 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_client_custom_ext(c_ctx, 1003,
                                      custom_ext_3_cli_add_cb,
                                      
# 1686 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1686 "../test/ssl_old_test.c"
                                         , 
# 1686 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1686 "../test/ssl_old_test.c"
...
# 1687 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1687 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx, 1000,
                                      custom_ext_0_srv_add_cb,
                                      
# 1690 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1690 "../test/ssl_old_test.c"
                                         , 
# 1690 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1690 "../test/ssl_old_test.c"
...
# 1691 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1691 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx2, 1000,
                                      custom_ext_0_srv_add_cb,
                                      
# 1694 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1694 "../test/ssl_old_test.c"
                                         , 
# 1694 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1694 "../test/ssl_old_test.c"
                                               ,
                                      custom_ext_0_srv_parse_cb, 
# 1695 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1695 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx, 1001,
                                      custom_ext_1_srv_add_cb,
                                      
# 1698 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1698 "../test/ssl_old_test.c"
                                         , 
# 1698 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1698 "../test/ssl_old_test.c"
...
# 1699 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1699 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx2, 1001,
                                      custom_ext_1_srv_add_cb,
                                      
# 1702 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1702 "../test/ssl_old_test.c"
                                         , 
# 1702 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1702 "../test/ssl_old_test.c"
                                               ,
                                      custom_ext_1_srv_parse_cb, 
# 1703 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1703 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx, 1002,
                                      custom_ext_2_srv_add_cb,
                                      
# 1706 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1706 "../test/ssl_old_test.c"
                                         , 
# 1706 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1706 "../test/ssl_old_test.c"
...
# 1707 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1707 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx2, 1002,
                                      custom_ext_2_srv_add_cb,
                                      
# 1710 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1710 "../test/ssl_old_test.c"
                                         , 
# 1710 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1710 "../test/ssl_old_test.c"
                                               ,
                                      custom_ext_2_srv_parse_cb, 
# 1711 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1711 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx, 1003,
                                      custom_ext_3_srv_add_cb,
                                      
# 1714 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1714 "../test/ssl_old_test.c"
                                         , 
# 1714 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1714 "../test/ssl_old_test.c"
...
# 1715 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1715 "../test/ssl_old_test.c"
                                                                    )
            || !SSL_CTX_add_server_custom_ext(s_ctx2, 1003,
                                      custom_ext_3_srv_add_cb,
                                      
# 1718 "../test/ssl_old_test.c" 3 4
                                     ((void *)0)
# 1718 "../test/ssl_old_test.c"
                                         , 
# 1718 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1718 "../test/ssl_old_test.c"
                                               ,
                                      custom_ext_3_srv_parse_cb, 
# 1719 "../test/ssl_old_test.c" 3 4
                                                                ((void *)0)
# 1719 "../test/ssl_old_test.c"
                                                                    )) {
    ...
    if (alpn_client) {
        ...
        if (alpn == 
# 1734 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
# 1734 "../test/ssl_old_test.c"
                       ) {
        ...
        if (SSL_CTX_set_alpn_protos(c_ctx, alpn, alpn_len)) {
            ...
            CRYPTO_free(alpn, "../test/ssl_old_test.c", 1741);
            goto end;
        }
        CRYPTO_free(alpn, "../test/ssl_old_test.c", 1744);
    }

    if (server_sess_in != 
# 1747 "../test/ssl_old_test.c" 3 4
                         ((void *)0)
# 1747 "../test/ssl_old_test.c"
                             ) {
        server_sess = read_session(server_sess_in);
        if (server_sess == 
# 1749 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 1749 "../test/ssl_old_test.c"
                              )
            goto end;
    }
    if (client_sess_in != 
# 1752 "../test/ssl_old_test.c" 3 4
                         ((void *)0)
# 1752 "../test/ssl_old_test.c"
                             ) {
        client_sess = read_session(client_sess_in);
        if (client_sess == 
# 1754 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 1754 "../test/ssl_old_test.c"
                              )
            goto end;
    }

    if (server_sess_out != 
# 1758 "../test/ssl_old_test.c" 3 4
                          ((void *)0) 
# 1758 "../test/ssl_old_test.c"
                               || server_sess_in != 
# 1758 "../test/ssl_old_test.c" 3 4
                                                    ((void *)0)
# 1758 "../test/ssl_old_test.c"
        ...
        size = SSL_CTX_ctrl(s_ctx,59,0,
# 1763 "../test/ssl_old_test.c" 3 4
              ((void *)0)
# 1763 "../test/ssl_old_test.c"
              );
        keys = CRYPTO_zalloc(size, "../test/ssl_old_test.c", 1764);
        if (keys == 
# 1765 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
# 1765 "../test/ssl_old_test.c"
                       )
            goto end;
        SSL_CTX_ctrl(s_ctx,59,size,keys);
        CRYPTO_free(keys, "../test/ssl_old_test.c", 1768);
    }

    if (sn_server1 != 
# 1771 "../test/ssl_old_test.c" 3 4
                     ((void *)0) 
# 1771 "../test/ssl_old_test.c"
                          || sn_server2 != 
# 1771 "../test/ssl_old_test.c" 3 4
                                           ((void *)0)
# 1771 "../test/ssl_old_test.c"
                                               )
        SSL_CTX_callback_ctrl(s_ctx,53, (void (*)(void))servername_cb);

    c_ssl = SSL_new(c_ctx);
    s_ssl = SSL_new(s_ctx);
    if (c_ssl == 
# 1776 "../test/ssl_old_test.c" 3 4
                ((void *)0) 
# 1776 "../test/ssl_old_test.c"
                     || s_ssl == 
# 1776 "../test/ssl_old_test.c" 3 4
                                 ((void *)0)
# 1776 "../test/ssl_old_test.c"
    ...
    if (sn_client)
        SSL_ctrl(c_ssl,55,0, (void *)sn_client);
    if (client_ktls)
        SSL_set_options(c_ssl, ((uint64_t)1 << (uint64_t)3));
    if (server_ktls)
        SSL_set_options(s_ssl, ((uint64_t)1 << (uint64_t)3));

    if (!set_protocol_version(server_min_proto, s_ssl, 123))
        goto end;
    if (!set_protocol_version(server_max_proto, s_ssl, 124))
        goto end;
    if (!set_protocol_version(client_min_proto, c_ssl, 123))
        goto end;
    if (!set_protocol_version(client_max_proto, c_ssl, 124))
        goto end;
    ...
    for (i = 0; i < number; i++) {
        if (!reuse) {
            if (!SSL_set_session(c_ssl, 
# 1806 "../test/ssl_old_test.c" 3 4
                                       ((void *)0)
# 1806 "../test/ssl_old_test.c"
                                           )) {
        ...
        if (client_sess_in != 
# 1811 "../test/ssl_old_test.c" 3 4
                             ((void *)0)
# 1811 "../test/ssl_old_test.c"
                                 ) {
        ...
        case BIO_IPV4:
            ret = doit_localhost(s_ssl, c_ssl, 4,
                                 bytes, &s_time, &c_time);
            break;
        case BIO_IPV6:
            ret = doit_localhost(s_ssl, c_ssl, 6,
                                 bytes, &s_time, &c_time);
            break;
        ...
        if (ret != 
# 1841 "../test/ssl_old_test.c" 3 4
                  0
# 1841 "../test/ssl_old_test.c"
                              )
            break;
    }

    if (should_negotiate && ret == 
# 1845 "../test/ssl_old_test.c" 3 4
                                  0 
# 1845 "../test/ssl_old_test.c"
                                               &&
        ...
        if (version < 0) {
            BIO_printf(bio_err, "Error parsing: %s\n", should_negotiate);
            ret = 
# 1851 "../test/ssl_old_test.c" 3 4
                 1
# 1851 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
        if (SSL_version(c_ssl) != version) {
            ...
            ret = 
# 1857 "../test/ssl_old_test.c" 3 4
                 1
# 1857 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
    }
    ...
    if (should_reuse != -1) {
        if (SSL_session_reused(s_ssl) != should_reuse ||
            ...
            ret = 
# 1868 "../test/ssl_old_test.c" 3 4
                 1
# 1868 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
    }
    ...
    if (server_sess_out != 
# 1873 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 1873 "../test/ssl_old_test.c"
                              ) {
        if (write_session(server_sess_out, SSL_get_session(s_ssl)) == 0) {
            ret = 
# 1875 "../test/ssl_old_test.c" 3 4
                 1
# 1875 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
    }
    if (client_sess_out != 
# 1879 "../test/ssl_old_test.c" 3 4
                          ((void *)0)
# 1879 "../test/ssl_old_test.c"
                              ) {
        if (write_session(client_sess_out, SSL_get_session(c_ssl)) == 0) {
            ret = 
# 1881 "../test/ssl_old_test.c" 3 4
                 1
# 1881 "../test/ssl_old_test.c"
                             ;
            goto end;
        }
    }
    ...
    if (print_time) {
        ...
        BIO_printf(bio_stdout, "Approximate total server time: %6.2f s\n"
                   ...
                   (double)s_time / 
# 1898 "../test/ssl_old_test.c" 3 4
                                   ((__clock_t) 1000000)
# 1898 "../test/ssl_old_test.c"
                                                 ,
                   (double)c_time / 
# 1899 "../test/ssl_old_test.c" 3 4
                                   ((__clock_t) 1000000)
# 1899 "../test/ssl_old_test.c"
                                                 );
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(conf_args));
                   ...
                   clock_t *s_time, clock_t *c_time)
{
    ...
    BIO *s_ssl_bio = 
# 1938 "../test/ssl_old_test.c" 3 4
                    ((void *)0)
# 1938 "../test/ssl_old_test.c"
                        , *c_ssl_bio = 
# 1938 "../test/ssl_old_test.c" 3 4
                                       ((void *)0)
# 1938 "../test/ssl_old_test.c"
                                           ;
    BIO *acpt = 
# 1939 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 1939 "../test/ssl_old_test.c"
                   , *server = 
# 1939 "../test/ssl_old_test.c" 3 4
                               ((void *)0)
# 1939 "../test/ssl_old_test.c"
...
# 1939 "../test/ssl_old_test.c"
    ...
    char addr_str[40];
    int ret = 
# 1941 "../test/ssl_old_test.c" 3 4
             1
# 1941 "../test/ssl_old_test.c"
                         ;
    int err_in_client = 0;
    int err_in_server = 0;

    acpt = BIO_new_accept(family == 4 ? "127.0.0.1:0"
                                                    : "[::1]:0");
    if (acpt == 
# 1947 "../test/ssl_old_test.c" 3 4
               ((void *)0)
# 1947 "../test/ssl_old_test.c"
                   )
        goto err;
    BIO_int_ctrl(acpt,118,4,family);
    BIO_ctrl(acpt,131,0x08 | 0x01,
# 1950 "../test/ssl_old_test.c" 3 4
   ((void *)0)
# 1950 "../test/ssl_old_test.c"
   );
    if (BIO_ctrl(acpt,101,0,
# 1951 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1951 "../test/ssl_old_test.c"
       ) <= 0)
        goto err;

    BIO_snprintf(addr_str, sizeof(addr_str), ":%s", ((const char *)BIO_ptr_ctrl(acpt,124,1)));

    client = BIO_new_connect(addr_str);
    if (!client)
        goto err;
    BIO_int_ctrl(client,100,3,family);

    if (BIO_ctrl(client,102,(1),
# 1961 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1961 "../test/ssl_old_test.c"
       ) <= 0)
        goto err;
    if (BIO_ctrl(acpt,102,(1),
# 1963 "../test/ssl_old_test.c" 3 4
       ((void *)0)
# 1963 "../test/ssl_old_test.c"
       ) <= 0)
        goto err;

    {
        ...
        while (!st_connect || !st_accept) {
            if (!st_connect) {
                if (BIO_ctrl(client,101,0,
# 1971 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
# 1971 "../test/ssl_old_test.c"
                   ) <= 0) {
                    if (!BIO_test_flags(client, 0x08))
                        goto err;
                } else {
                    st_connect = 1;
                }
            ...
            if (!st_accept) {
                if (BIO_ctrl(acpt,101,0,
# 1979 "../test/ssl_old_test.c" 3 4
                   ((void *)0)
# 1979 "../test/ssl_old_test.c"
                   ) <= 0) {
                    if (!BIO_test_flags(acpt, 0x08))
                        goto err;
                } else {
                    st_accept = 1;
                }
    ...
    BIO_free_all(acpt);
    acpt = 
# 1991 "../test/ssl_old_test.c" 3 4
          ((void *)0)
# 1991 "../test/ssl_old_test.c"
              ;
    ...
    (void)BIO_ctrl(c_ssl_bio,109,0x00,(char *)(c_ssl));

    SSL_set_accept_state(s_ssl);
    SSL_set_bio(s_ssl, server, server);
    (void)BIO_ctrl(s_ssl_bio,109,0x00,(char *)(s_ssl));

    do {
# 2028 "../test/ssl_old_test.c"
        {
            ...
            if (cw_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(c_ssl_bio, 0x08)) {
                        fprintf(
# 2052 "../test/ssl_old_test.c" 3 4
                               stderr
# 2052 "../test/ssl_old_test.c"
                                     , "ERROR in CLIENT (write)\n");
                        err_in_client = 1;
                        goto err;
                    }
                    ...
                    fprintf(
# 2063 "../test/ssl_old_test.c" 3 4
                           stderr
# 2063 "../test/ssl_old_test.c"
            ...
            if (cr_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(c_ssl_bio, 0x08)) {
                        fprintf(
# 2078 "../test/ssl_old_test.c" 3 4
                               stderr
# 2078 "../test/ssl_old_test.c"
                    ...
                    fprintf(
# 2086 "../test/ssl_old_test.c" 3 4
                           stderr
# 2086 "../test/ssl_old_test.c"
                                 , "SSL CLIENT STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
...
# 2104 "../test/ssl_old_test.c"
...

        {
            ...
            if (sw_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(s_ssl_bio, 0x08)) {
                        fprintf(
# 2131 "../test/ssl_old_test.c" 3 4
                               stderr
# 2131 "../test/ssl_old_test.c"
                    ...
                    fprintf(
# 2137 "../test/ssl_old_test.c" 3 4
                           stderr
# 2137 "../test/ssl_old_test.c"
            ...
            if (sr_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(s_ssl_bio, 0x08)) {
                        fprintf(
# 2152 "../test/ssl_old_test.c" 3 4
                               stderr
# 2152 "../test/ssl_old_test.c"
                    ...
                    fprintf(
# 2158 "../test/ssl_old_test.c" 3 4
                           stderr
# 2158 "../test/ssl_old_test.c"
                                 , "SSL SERVER STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
    ...
    if (verify_serverinfo() < 0) {
        fprintf(
# 2196 "../test/ssl_old_test.c" 3 4
               stderr
# 2196 "../test/ssl_old_test.c"
    ...
    if (custom_ext_error) {
        fprintf(
# 2204 "../test/ssl_old_test.c" 3 4
               stderr
# 2204 "../test/ssl_old_test.c"
    ...
    ret = 
# 2211 "../test/ssl_old_test.c" 3 4
         0
# 2211 "../test/ssl_old_test.c"
                     ;
 ...
 err:
    ...
    if (should_negotiate != 
# 2222 "../test/ssl_old_test.c" 3 4
                           ((void *)0) 
# 2222 "../test/ssl_old_test.c"
                                && strcmp(should_negotiate, "fail-client") == 0)
        ret = (err_in_client != 0) ? 
# 2223 "../test/ssl_old_test.c" 3 4
                                    0 
# 2223 "../test/ssl_old_test.c"
                                                 : 
# 2223 "../test/ssl_old_test.c" 3 4
                                                   1
# 2223 "../test/ssl_old_test.c"
                                                               ;
    else if (should_negotiate != 
# 2224 "../test/ssl_old_test.c" 3 4
                                ((void *)0) 
# 2224 "../test/ssl_old_test.c"
                                     && strcmp(should_negotiate, "fail-server") == 0)
        ret = (err_in_server != 0) ? 
# 2225 "../test/ssl_old_test.c" 3 4
                                    0 
# 2225 "../test/ssl_old_test.c"
                                                 : 
# 2225 "../test/ssl_old_test.c" 3 4
                                                   1
# 2225 "../test/ssl_old_test.c"
                 ...
                 clock_t *s_time, clock_t *c_time)
{
    long cw_num = count, cr_num = count, sw_num = count, sr_num = count;
    BIO *s_ssl_bio = 
# 2235 "../test/ssl_old_test.c" 3 4
                    ((void *)0)
# 2235 "../test/ssl_old_test.c"
                        , *c_ssl_bio = 
# 2235 "../test/ssl_old_test.c" 3 4
                                       ((void *)0)
# 2235 "../test/ssl_old_test.c"
                                           ;
    BIO *server = 
# 2236 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 2236 "../test/ssl_old_test.c"
                     , *server_io = 
# 2236 "../test/ssl_old_test.c" 3 4
                                    ((void *)0)
# 2236 "../test/ssl_old_test.c"
...
# 2236 "../test/ssl_old_test.c"
                                                                           ;
    int ret = 
# 2237 "../test/ssl_old_test.c" 3 4
             1
# 2237 "../test/ssl_old_test.c"
                         ;
    int err_in_client = 0;
    int err_in_server = 0;
...
# 2307 "../test/ssl_old_test.c"
        {
            ...
            if (cw_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(c_ssl_bio, 0x08)) {
                        fprintf(
# 2331 "../test/ssl_old_test.c" 3 4
                               stderr
# 2331 "../test/ssl_old_test.c"
                                     , "ERROR in CLIENT\n");
                        err_in_client = 1;
                        goto err;
                    }
                    ...
                    fprintf(
# 2342 "../test/ssl_old_test.c" 3 4
                           stderr
# 2342 "../test/ssl_old_test.c"
                                 , "SSL CLIENT STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
            ...
            if (cr_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(c_ssl_bio, 0x08)) {
                        fprintf(
# 2357 "../test/ssl_old_test.c" 3 4
                               stderr
# 2357 "../test/ssl_old_test.c"
                                     , "ERROR in CLIENT\n");
                        err_in_client = 1;
                        goto err;
                    }
                    ...
                    fprintf(
# 2365 "../test/ssl_old_test.c" 3 4
                           stderr
# 2365 "../test/ssl_old_test.c"
                                 , "SSL CLIENT STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
...

        {
            ...
            if (sw_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(s_ssl_bio, 0x08)) {
                        fprintf(
# 2410 "../test/ssl_old_test.c" 3 4
                               stderr
# 2410 "../test/ssl_old_test.c"
                                     , "ERROR in SERVER\n");
                        err_in_server = 1;
                        goto err;
                    }
                    ...
                    fprintf(
# 2416 "../test/ssl_old_test.c" 3 4
                           stderr
# 2416 "../test/ssl_old_test.c"
                                 , "SSL SERVER STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
            ...
            if (sr_num > 0) {
                ...
                if (r < 0) {
                    if (!BIO_test_flags(s_ssl_bio, 0x08)) {
                        fprintf(
# 2431 "../test/ssl_old_test.c" 3 4
                               stderr
# 2431 "../test/ssl_old_test.c"
                                     , "ERROR in SERVER\n");
                        err_in_server = 1;
                        goto err;
                    }
                    ...
                    fprintf(
# 2437 "../test/ssl_old_test.c" 3 4
                           stderr
# 2437 "../test/ssl_old_test.c"
                                 , "SSL SERVER STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
...

        {
            ...
            do {
                ...
                if (num) {
                    ...
                    if (0x7fffffff 
# 2476 "../test/ssl_old_test.c"
                               < num)
                        num = 0x7fffffff
# 2477 "../test/ssl_old_test.c"
                                    ;

                    r = BIO_nread(io1, &dataptr, (int)num);
                    
# 2480 "../test/ssl_old_test.c" 3 4
                   ((void) (0))
# 2480 "../test/ssl_old_test.c"
                                ;
                    
# 2481 "../test/ssl_old_test.c" 3 4
                   ((void) (0))
# 2481 "../test/ssl_old_test.c"
                                        ;
                    ...
                    if (r != (int)num) {
                        fprintf(
# 2488 "../test/ssl_old_test.c" 3 4
                               stderr
# 2488 "../test/ssl_old_test.c"
...

            {
                ...
                if (num) {
                    ...
                    if (0x7fffffff 
# 2520 "../test/ssl_old_test.c"
                               < num)
                        num = 0x7fffffff
# 2521 "../test/ssl_old_test.c"
                                    ;
...
# 2527 "../test/ssl_old_test.c" 3 4
                   ((void) (0))
# 2527 "../test/ssl_old_test.c"
                                ;
                    if (r < (int)num)
                        num = r;
                    ...
                    if (r != (int)num) {
                        fprintf(
# 2532 "../test/ssl_old_test.c" 3 4
                               stderr
# 2532 "../test/ssl_old_test.c"
                    ...
                    if (r != (int)num) {
                        fprintf(
# 2539 "../test/ssl_old_test.c" 3 4
                               stderr
# 2539 "../test/ssl_old_test.c"
            ...
            if (!progress && !prev_progress)
                if (cw_num > 0 || cr_num > 0 || sw_num > 0 || sr_num > 0) {
                    fprintf(
# 2554 "../test/ssl_old_test.c" 3 4
                           stderr
# 2554 "../test/ssl_old_test.c"
                                 , "ERROR: got stuck\n");
                    fprintf(
# 2555 "../test/ssl_old_test.c" 3 4
                           stderr
# 2555 "../test/ssl_old_test.c"
                                 , " ERROR.\n");
                    goto err;
                }
    ...
    if (verify_serverinfo() < 0) {
        fprintf(
# 2570 "../test/ssl_old_test.c" 3 4
               stderr
# 2570 "../test/ssl_old_test.c"
                     , "Server info verify error\n");
        goto err;
    }
    if (verify_alpn(c_ssl, s_ssl) < 0
    ...
    if (custom_ext_error) {
        fprintf(
# 2578 "../test/ssl_old_test.c" 3 4
               stderr
# 2578 "../test/ssl_old_test.c"
                     , "Custom extension error\n");
        goto err;
    }
    ...
    ret = 
# 2585 "../test/ssl_old_test.c" 3 4
         0
# 2585 "../test/ssl_old_test.c"
                     ;
 ...
 err:
    ...
    if (should_negotiate != 
# 2597 "../test/ssl_old_test.c" 3 4
                           ((void *)0) 
# 2597 "../test/ssl_old_test.c"
                                && strcmp(should_negotiate, "fail-client") == 0)
        ret = (err_in_client != 0) ? 
# 2598 "../test/ssl_old_test.c" 3 4
                                    0 
# 2598 "../test/ssl_old_test.c"
                                                 : 
# 2598 "../test/ssl_old_test.c" 3 4
                                                   1
# 2598 "../test/ssl_old_test.c"
...
# 2599 "../test/ssl_old_test.c" 3 4
                                ((void *)0) 
# 2599 "../test/ssl_old_test.c"
                                     && strcmp(should_negotiate, "fail-server") == 0)
        ret = (err_in_server != 0) ? 
# 2600 "../test/ssl_old_test.c" 3 4
                                    0 
# 2600 "../test/ssl_old_test.c"
                                                 : 
# 2600 "../test/ssl_old_test.c" 3 4
                                                   1
# 2600 "../test/ssl_old_test.c"
...
{
    char *cbuf = 
# 2612 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2612 "../test/ssl_old_test.c"
                    , *sbuf = 
# 2612 "../test/ssl_old_test.c" 3 4
                              ((void *)0)
# 2612 "../test/ssl_old_test.c"
    ...
    int ret = 
# 2616 "../test/ssl_old_test.c" 3 4
             1
# 2616 "../test/ssl_old_test.c"
                         ;
    BIO *c_to_s = 
# 2617 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 2617 "../test/ssl_old_test.c"
                     ;
    BIO *s_to_c = 
# 2618 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 2618 "../test/ssl_old_test.c"
                     ;
    BIO *c_bio = 
# 2619 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2619 "../test/ssl_old_test.c"
                    ;
    BIO *s_bio = 
# 2620 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2620 "../test/ssl_old_test.c"
                    ;
    int c_r, c_w, s_r, s_w;
    int i, j;
    int done = 0;
    ...
    if ((cbuf = CRYPTO_zalloc(bufsiz, "../test/ssl_old_test.c", 2632)) == 
# 2632 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 2632 "../test/ssl_old_test.c"
                                              )
        goto err;
    if ((sbuf = CRYPTO_zalloc(bufsiz, "../test/ssl_old_test.c", 2634)) == 
# 2634 "../test/ssl_old_test.c" 3 4
                                          ((void *)0)
# 2634 "../test/ssl_old_test.c"
                                              )
        goto err;
    ...
    if ((s_to_c == 
# 2639 "../test/ssl_old_test.c" 3 4
                  ((void *)0)
# 2639 "../test/ssl_old_test.c"
                      ) || (c_to_s == 
# 2639 "../test/ssl_old_test.c" 3 4
                                      ((void *)0)
# 2639 "../test/ssl_old_test.c"
    ...
    if ((c_bio == 
# 2646 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 2646 "../test/ssl_old_test.c"
                     ) || (s_bio == 
# 2646 "../test/ssl_old_test.c" 3 4
                                    ((void *)0)
# 2646 "../test/ssl_old_test.c"
    ...
    SSL_ctrl(c_ssl,52,max_frag,
# 2653 "../test/ssl_old_test.c" 3 4
   ((void *)0)
# 2653 "../test/ssl_old_test.c"
   );
    BIO_ctrl(c_bio,109,0x00,(char *)(c_ssl));
    ...
    if (!BIO_up_ref(c_to_s)) {
        ...
        c_to_s = 
# 2662 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2662 "../test/ssl_old_test.c"
                    ;
        s_to_c = 
# 2663 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2663 "../test/ssl_old_test.c"
                    ;
        goto err;
    }
    if (!BIO_up_ref(s_to_c)) {
        ...
        s_to_c = 
# 2668 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2668 "../test/ssl_old_test.c"
                    ;
        goto err;
    }
    ...
    c_to_s = 
# 2676 "../test/ssl_old_test.c" 3 4
            ((void *)0)
# 2676 "../test/ssl_old_test.c"
                ;
    s_to_c = 
# 2677 "../test/ssl_old_test.c" 3 4
            ((void *)0)
# 2677 "../test/ssl_old_test.c"
                ;

    SSL_ctrl(s_ssl,52,max_frag,
# 2679 "../test/ssl_old_test.c" 3 4
   ((void *)0)
# 2679 "../test/ssl_old_test.c"
   );
    BIO_ctrl(s_bio,109,0x00,(char *)(s_ssl));
    ...
    for (;;) {
        ...
        i = (int)(int)BIO_ctrl(s_bio,10,0,
# 2693 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2693 "../test/ssl_old_test.c"
                );
        if ((i && s_r) || s_w)
            do_server = 1;

        i = (int)(int)BIO_ctrl(c_bio,10,0,
# 2697 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2697 "../test/ssl_old_test.c"
                );
        if ((i && c_r) || c_w)
            do_client = 1;
        ...
        if (!do_client && !do_server) {
            fprintf(
# 2714 "../test/ssl_old_test.c" 3 4
                   stdout
# 2714 "../test/ssl_old_test.c"
                         , "ERROR IN STARTUP\n");
            ERR_print_errors(bio_err);
            goto err;
        }
        if (do_client && !(done & 1)) {
            if (c_write) {
                ...
                if (i < 0) {
                    c_r = 0;
                    c_w = 0;
                    if (BIO_test_flags(c_bio, 0x08)) {
                        if (BIO_test_flags(c_bio, 0x01))
                            c_r = 1;
                        if (BIO_test_flags(c_bio, 0x02))
                            c_w = 1;
                    } else {
                        fprintf(
# 2731 "../test/ssl_old_test.c" 3 4
                               stderr
# 2731 "../test/ssl_old_test.c"
                                     , "ERROR in CLIENT\n");
                        err_in_client = 1;
                        ERR_print_errors(bio_err);
                        goto err;
                    ...
                    fprintf(
# 2737 "../test/ssl_old_test.c" 3 4
                           stderr
# 2737 "../test/ssl_old_test.c"
                                 , "SSL CLIENT STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
                    ...
                    cw_num -= i;
                    if (max_frag > 1029)
                        SSL_ctrl(c_ssl,52,max_frag -= 5,
# 2747 "../test/ssl_old_test.c" 3 4
                       ((void *)0)
# 2747 "../test/ssl_old_test.c"
                       );
                }
            } else {
                ...
                if (i < 0) {
                    ...
                    if (BIO_test_flags(c_bio, 0x08)) {
                        ...
                        fprintf(
# 2760 "../test/ssl_old_test.c" 3 4
                               stderr
# 2760 "../test/ssl_old_test.c"
                                     , "ERROR in CLIENT\n");
                        err_in_client = 1;
                        ERR_print_errors(bio_err);
                        goto err;
                    ...
                    fprintf(
# 2766 "../test/ssl_old_test.c" 3 4
                           stderr
# 2766 "../test/ssl_old_test.c"
                                 , "SSL CLIENT STARTUP FAILED\n");
                    goto err;
                } else {
                    if (debug)
        ...
        if (do_server && !(done & 2)) {
            if (!s_write) {
                ...
                if (i < 0) {
                    s_r = 0;
                    s_w = 0;
                    if (BIO_test_flags(s_bio, 0x08)) {
                        if (BIO_test_flags(s_bio, 0x01))
                            s_r = 1;
                        if (BIO_test_flags(s_bio, 0x02))
                            s_w = 1;
                    } else {
                        fprintf(
# 2797 "../test/ssl_old_test.c" 3 4
                               stderr
# 2797 "../test/ssl_old_test.c"
                                     , "ERROR in SERVER\n");
                        err_in_server = 1;
                        ERR_print_errors(bio_err);
                        goto err;
                    ...
                    ERR_print_errors(bio_err);
                    fprintf(
# 2804 "../test/ssl_old_test.c" 3 4
                           stderr
# 2804 "../test/ssl_old_test.c"
                                 ,
                ...
                if (i < 0) {
                    ...
                    if (BIO_test_flags(s_bio, 0x08)) {
                        ...
                        fprintf(
# 2833 "../test/ssl_old_test.c" 3 4
                               stderr
# 2833 "../test/ssl_old_test.c"
                                     , "ERROR in SERVER\n");
                        err_in_server = 1;
                        ERR_print_errors(bio_err);
                        goto err;
                    ...
                    ERR_print_errors(bio_err);
                    fprintf(
# 2840 "../test/ssl_old_test.c" 3 4
                           stderr
# 2840 "../test/ssl_old_test.c"
                                 ,
                    ...
                    if (max_frag > 1029)
                        SSL_ctrl(s_ssl,52,max_frag -= 5,
# 2852 "../test/ssl_old_test.c" 3 4
                       ((void *)0)
# 2852 "../test/ssl_old_test.c"
                       );
                }
            }
        }
    ...
    if (verify_serverinfo() < 0) {
        fprintf(
# 2868 "../test/ssl_old_test.c" 3 4
               stderr
# 2868 "../test/ssl_old_test.c"
                     , "Server info verify error\n");
        goto err;
    }
    if (custom_ext_error) {
        fprintf(
# 2872 "../test/ssl_old_test.c" 3 4
               stderr
# 2872 "../test/ssl_old_test.c"
                     , "Custom extension error\n");
        goto err;
    }
    ret = 
# 2875 "../test/ssl_old_test.c" 3 4
         0
# 2875 "../test/ssl_old_test.c"
                     ;
 err:
    BIO_free(c_to_s);
    BIO_free(s_to_c);
    BIO_free_all(c_bio);
    BIO_free_all(s_bio);
    CRYPTO_free(cbuf, "../test/ssl_old_test.c", 2881);
    CRYPTO_free(sbuf, "../test/ssl_old_test.c", 2882);

    if (should_negotiate != 
# 2884 "../test/ssl_old_test.c" 3 4
                           ((void *)0) 
# 2884 "../test/ssl_old_test.c"
                                && strcmp(should_negotiate, "fail-client") == 0)
        ret = (err_in_client != 0) ? 
# 2885 "../test/ssl_old_test.c" 3 4
                                    0 
# 2885 "../test/ssl_old_test.c"
                                                 : 
# 2885 "../test/ssl_old_test.c" 3 4
                                                   1
# 2885 "../test/ssl_old_test.c"
...
# 2886 "../test/ssl_old_test.c" 3 4
                                ((void *)0) 
# 2886 "../test/ssl_old_test.c"
                                     && strcmp(should_negotiate, "fail-server") == 0)
        ret = (err_in_server != 0) ? 
# 2887 "../test/ssl_old_test.c" 3 4
                                    0 
# 2887 "../test/ssl_old_test.c"
                                                 : 
# 2887 "../test/ssl_old_test.c" 3 4
                                                   1
# 2887 "../test/ssl_old_test.c"
...
static int verify_callback(int ok, X509_STORE_CTX *ctx)
{
    ...
    s = X509_NAME_oneline(X509_get_subject_name(X509_STORE_CTX_get_current_cert(ctx)),
                          buf, sizeof(buf));
    if (s != 
# 2898 "../test/ssl_old_test.c" 3 4
            ((void *)0)
# 2898 "../test/ssl_old_test.c"
                ) {
        if (ok)
            printf("depth=%d %s\n", X509_STORE_CTX_get_error_depth(ctx), buf);
        else {
            fprintf(
# 2902 "../test/ssl_old_test.c" 3 4
                   stderr
# 2902 "../test/ssl_old_test.c"
                         , "depth=%d error=%d %s\n",
    ...
    if (ok == 0) {
        ...
        default:
            fprintf(
# 2913 "../test/ssl_old_test.c" 3 4
                   stderr
# 2913 "../test/ssl_old_test.c"
                         , "Error string: %s\n",
...
static int app_verify_callback(X509_STORE_CTX *ctx, void *arg)
{
    ...
    if (cb_arg->app_verify) {
        char *s = 
# 2933 "../test/ssl_old_test.c" 3 4
                 ((void *)0)
# 2933 "../test/ssl_old_test.c"
                     , buf[256];
        ...
        if (s != 
# 2942 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2942 "../test/ssl_old_test.c"
                    ) {
                      ...
                      unsigned int max_psk_len)
{
    int ret;
    BIGNUM *bn = 
# 2960 "../test/ssl_old_test.c" 3 4
                ((void *)0)
# 2960 "../test/ssl_old_test.c"
                    ;
    ...
    if (((BN_num_bits(bn)+7)/8) > (int)max_psk_len) {
        BIO_printf(bio_err,
                   "psk buffer of callback is too small (%d) for key (%d)\n",
                   max_psk_len, ((BN_num_bits(bn)+7)/8));
        BN_free(bn);
        return 0;
    }
                                        ...
                                        unsigned int max_psk_len)
{
    ...
    if (debug)
        fprintf(
# 2994 "../test/ssl_old_test.c" 3 4
               stderr
# 2994 "../test/ssl_old_test.c"
