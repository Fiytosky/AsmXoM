...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 15 "../test/pkcs7_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../test/pkcs7_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
static int pkcs7_verify_test(void)
{
    ...
    size_t i;
    BIO *msg_bio = 
# 55 "../test/pkcs7_test.c" 3 4
                  ((void *)0)
# 55 "../test/pkcs7_test.c"
                      , *x509_bio = 
# 55 "../test/pkcs7_test.c" 3 4
                                    ((void *)0)
# 55 "../test/pkcs7_test.c"
...
# 55 "../test/pkcs7_test.c"
                                                     ;
    X509 *cert = 
# 56 "../test/pkcs7_test.c" 3 4
                ((void *)0)
# 56 "../test/pkcs7_test.c"
                    ;
    X509_STORE *store = 
# 57 "../test/pkcs7_test.c" 3 4
                       ((void *)0)
# 57 "../test/pkcs7_test.c"
                           ;
    PKCS7 *p7 = 
# 58 "../test/pkcs7_test.c" 3 4
               ((void *)0)
# 58 "../test/pkcs7_test.c"
                   ;
    const char *sig[] = {
    ...
    if (!test_ptr("../test/pkcs7_test.c", 71, "bio = BIO_new(BIO_s_mem())", bio = BIO_new(BIO_s_mem())))
        goto end;
    for (i = 0; i < (sizeof(sig)/sizeof((sig)[0])); ++i)
        BIO_puts(bio, sig[i]);

    ret = test_ptr("../test/pkcs7_test.c", 76, "msg_bio = BIO_new_mem_buf(signed_data, strlen(signed_data))", msg_bio = BIO_new_mem_buf(signed_data, strlen(signed_data)))
          && test_ptr("../test/pkcs7_test.c", 77, "x509_bio = BIO_new_mem_buf(cert_der, sizeof(cert_der))", x509_bio = BIO_new_mem_buf(cert_der, sizeof(cert_der)))
          && test_ptr("../test/pkcs7_test.c", 78, "cert = d2i_X509_bio(x509_bio, NULL)", cert = d2i_X509_bio(x509_bio, 
# 78 "../test/pkcs7_test.c" 3 4
            ((void *)0)
# 78 "../test/pkcs7_test.c"
            ))
          && test_int_eq("../test/pkcs7_test.c", 79, "ERR_peek_error()", "0", ERR_peek_error(), 0)
          && test_ptr("../test/pkcs7_test.c", 80, "store = X509_STORE_new()", store = X509_STORE_new())
          && test_true("../test/pkcs7_test.c", 81, "X509_STORE_add_cert(store, cert)", (X509_STORE_add_cert(store, cert)) != 0)
          && test_ptr("../test/pkcs7_test.c", 82, "p7 = SMIME_read_PKCS7(bio, NULL)", p7 = SMIME_read_PKCS7(bio, 
# 82 "../test/pkcs7_test.c" 3 4
            ((void *)0)
# 82 "../test/pkcs7_test.c"
            ))
          && test_int_eq("../test/pkcs7_test.c", 83, "ERR_peek_error()", "0", ERR_peek_error(), 0)
          && test_true("../test/pkcs7_test.c", 84, "PKCS7_verify(p7, NULL, store, msg_bio, NULL, PKCS7_TEXT)", (PKCS7_verify(p7, 
# 84 "../test/pkcs7_test.c" 3 4
            ((void *)0)
# 84 "../test/pkcs7_test.c"
            , store, msg_bio, 
# 84 "../test/pkcs7_test.c" 3 4
            ((void *)0)
# 84 "../test/pkcs7_test.c"
            , 0x1)) != 0)
          && test_int_eq("../test/pkcs7_test.c", 85, "ERR_peek_error()", "0", ERR_peek_error(), 0);
end:
