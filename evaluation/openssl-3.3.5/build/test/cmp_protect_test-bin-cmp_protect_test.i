# 0 "../test/cmp_protect_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_protect_test.c"
# 12 "../test/cmp_protect_test.c"
...
# 36 "../test/cmp_protect_test.c" 3 4
                             ((void *)0)
# 36 "../test/cmp_protect_test.c"
                                 ;
static OSSL_PROVIDER *default_null_provider = 
# 37 "../test/cmp_protect_test.c" 3 4
                                             ((void *)0)
# 37 "../test/cmp_protect_test.c"
                                                 , *provider = 
# 37 "../test/cmp_protect_test.c" 3 4
                                                               ((void *)0)
# 37 "../test/cmp_protect_test.c"
...
{
    if (fixture != 
# 41 "../test/cmp_protect_test.c" 3 4
                  ((void *)0)
# 41 "../test/cmp_protect_test.c"
                      ) {
        OSSL_CMP_CTX_free(fixture->cmp_ctx);
        OSSL_CMP_MSG_free(fixture->msg);
        OSSL_CMP_PKISI_free(fixture->si);

        CRYPTO_free(fixture->mem, "../test/cmp_protect_test.c", 46);
        OPENSSL_sk_free(ossl_check_X509_sk_type(fixture->certs));
        OPENSSL_sk_free(ossl_check_X509_sk_type(fixture->chain));

        CRYPTO_free(fixture, "../test/cmp_protect_test.c", 50);
    }
}
...
static CMP_PROTECT_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_protect_test.c", 58, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_protect_test.c", 58)))
        return 
# 59 "../test/cmp_protect_test.c" 3 4
              ((void *)0)
# 59 "../test/cmp_protect_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/cmp_protect_test.c", 61, "fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, NULL)", fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, 
# 61 "../test/cmp_protect_test.c" 3 4
        ((void *)0)
# 61 "../test/cmp_protect_test.c"
        ))) {
        tear_down(fixture);
        return 
# 63 "../test/cmp_protect_test.c" 3 4
              ((void *)0)
# 63 "../test/cmp_protect_test.c"
                  ;
    }
    return fixture;
}
...
# 68 "../test/cmp_protect_test.c" 3 4
                               ((void *)0)
# 68 "../test/cmp_protect_test.c"
                                   ;

static EVP_PKEY *prot_Ed_key = 
# 70 "../test/cmp_protect_test.c" 3 4
                              ((void *)0)
# 70 "../test/cmp_protect_test.c"
                                  ;
static OSSL_CMP_MSG *genm_protected_Ed;

static EVP_PKEY *server_key = 
# 73 "../test/cmp_protect_test.c" 3 4
                             ((void *)0)
# 73 "../test/cmp_protect_test.c"
                                 ;
static X509 *server_cert = 
# 74 "../test/cmp_protect_test.c" 3 4
                          ((void *)0)
# 74 "../test/cmp_protect_test.c"
                              ;
static unsigned char rand_data[16];
static OSSL_CMP_MSG *ir_unprotected, *ir_protected;
static X509 *endentity1 = 
# 77 "../test/cmp_protect_test.c" 3 4
                         ((void *)0)
# 77 "../test/cmp_protect_test.c"
                             , *endentity2 = 
# 77 "../test/cmp_protect_test.c" 3 4
                                             ((void *)0)
# 77 "../test/cmp_protect_test.c"
                                                 ,
    *root = 
# 78 "../test/cmp_protect_test.c" 3 4
           ((void *)0)
# 78 "../test/cmp_protect_test.c"
               , *intermediate = 
# 78 "../test/cmp_protect_test.c" 3 4
                                 ((void *)0)
# 78 "../test/cmp_protect_test.c"
...
static int execute_calc_protection_fails_test(CMP_PROTECT_TEST_FIXTURE *fixture)
{
    ...
    int res = test_ptr_null("../test/cmp_protect_test.c", 84, "protection", protection);
...
static int execute_calc_protection_pbmac_test(CMP_PROTECT_TEST_FIXTURE *fixture)
{
    ASN1_BIT_STRING *protection =
        ossl_cmp_calc_protection(fixture->cmp_ctx, fixture->msg);
    int res = test_ptr("../test/cmp_protect_test.c", 94, "protection", protection)
            && test_true("../test/cmp_protect_test.c", 95, "ASN1_STRING_cmp(protection, fixture->msg->protection) == 0", (ASN1_STRING_cmp(protection, fixture->msg->protection) == 0) != 0)
                                                                        ;
                            ...
                            EVP_PKEY *pkey, EVP_MD *digest)
{
    ...
    return ASN1_item_verify_ex((OSSL_CMP_PROTECTEDPART_it()),
                               msg->header->protectionAlg, protection,
                               &prot_part, 
# 116 "../test/cmp_protect_test.c" 3 4
                                          ((void *)0)
# 116 "../test/cmp_protect_test.c"
                                              , pkey, libctx, 
# 116 "../test/cmp_protect_test.c" 3 4
                                                              ((void *)0)
# 116 "../test/cmp_protect_test.c"
                                                  ...
                                                  fixture)
{
    ASN1_BIT_STRING *protection =
        ossl_cmp_calc_protection(fixture->cmp_ctx, fixture->msg);
    int ret = (test_ptr("../test/cmp_protect_test.c", 125, "protection", protection)
               && test_true("../test/cmp_protect_test.c", 126, "verify_signature(fixture->msg, protection, fixture->pubkey, fixture->cmp_ctx->digest)", (verify_signature(fixture->msg, protection, fixture->pubkey, fixture->cmp_ctx->digest)) != 0)
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 136 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 136 "../test/cmp_protect_test.c"
   ) return 0;
    if (!test_ptr("../test/cmp_protect_test.c", 137, "fixture->msg = load_pkimsg(ir_unprotected_f, libctx)", fixture->msg = load_pkimsg(ir_unprotected_f, libctx))
            || !test_ptr("../test/cmp_protect_test.c", 138, "fixture->msg->header->protectionAlg = X509_ALGOR_new()", fixture->msg->header->protectionAlg = X509_ALGOR_new())
                                                                            ) {
        tear_down(fixture);
        fixture = 
# 141 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 141 "../test/cmp_protect_test.c"
                     ;
    }

    if (fixture != 
# 144 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 144 "../test/cmp_protect_test.c"
   ) { result = execute_calc_protection_fails_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 150 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 150 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->pubkey = prot_RSA_key;
    if (!test_true("../test/cmp_protect_test.c", 152, "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, prot_RSA_key)", (OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, prot_RSA_key)) != 0)
        || !test_ptr("../test/cmp_protect_test.c", 153, "fixture->msg = load_pkimsg(ir_protected_f, libctx)", fixture->msg = load_pkimsg(ir_protected_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 155 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 155 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 157 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 157 "../test/cmp_protect_test.c"
   ) { result = execute_calc_protection_signature_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 164 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 164 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->pubkey = prot_Ed_key;
    if (!test_true("../test/cmp_protect_test.c", 166, "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, prot_Ed_key)", (OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, prot_Ed_key)) != 0)
        || !test_ptr("../test/cmp_protect_test.c", 167, "fixture->msg = load_pkimsg(genm_prot_Ed_f, libctx)", fixture->msg = load_pkimsg(genm_prot_Ed_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 169 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 169 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 171 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 171 "../test/cmp_protect_test.c"
   ) { result = execute_calc_protection_signature_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_cmp_calc_protection_pbmac(void)
{
    ...
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 180 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 180 "../test/cmp_protect_test.c"
   ) return 0;
    if (!test_true("../test/cmp_protect_test.c", 181, "OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_insta, sizeof(sec_insta))", (OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_insta, sizeof(sec_insta))) != 0)

            || !test_ptr("../test/cmp_protect_test.c", 183, "fixture->msg = load_pkimsg(ip_PBM_f, libctx)", fixture->msg = load_pkimsg(ip_PBM_f, libctx))) {
        tear_down(fixture);
        fixture = 
# 185 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 185 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 187 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 187 "../test/cmp_protect_test.c"
   ) { result = execute_calc_protection_pbmac_test(fixture); tear_down(fixture); };
    return result;
}
static int execute_MSG_protect_test(CMP_PROTECT_TEST_FIXTURE *fixture)
{
    return test_int_eq("../test/cmp_protect_test.c", 192, "fixture->expected", "ossl_cmp_msg_protect(fixture->cmp_ctx, fixture->msg)", fixture->expected, ossl_cmp_msg_protect(fixture->cmp_ctx, fixture->msg))
                                                                            ;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 200 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 200 "../test/cmp_protect_test.c"
   ) return 0;

    fixture->expected = 1;
    if (!test_ptr("../test/cmp_protect_test.c", 203, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))
            || !test_true("../test/cmp_protect_test.c", 204, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 1)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (1))) != 0)) {
        tear_down(fixture);
        fixture = 
# 206 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 206 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 208 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 208 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_MSG_protect_with_msg_sig_alg_protection_plus_rsa_key(void)
{
    ...
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 216 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 216 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 1;

    if (!test_ptr("../test/cmp_protect_test.c", 219, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))
            || !test_true("../test/cmp_protect_test.c", 220, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (0))) != 0)




            || !test_true("../test/cmp_protect_test.c", 225, "OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, rand_data, size)", (OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, rand_data, size)) != 0)

            || !test_true("../test/cmp_protect_test.c", 227, "OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, rand_data + size, size)", (OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, rand_data + size, size)) != 0)

                                                              ) {
        tear_down(fixture);
        fixture = 
# 231 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 231 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 233 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 233 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 239 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 239 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 1;

    if (!test_ptr("../test/cmp_protect_test.c", 242, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))

            || !test_true("../test/cmp_protect_test.c", 244, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (0))) != 0)
            || !test_true("../test/cmp_protect_test.c", 245, "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, server_key)", (OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, server_key)) != 0)
            || !test_true("../test/cmp_protect_test.c", 246, "OSSL_CMP_CTX_set1_cert(fixture->cmp_ctx, server_cert)", (OSSL_CMP_CTX_set1_cert(fixture->cmp_ctx, server_cert)) != 0)
                                                              ) {
        tear_down(fixture);
        fixture = 
# 249 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 249 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 251 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 251 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_MSG_protect_certificate_based_without_cert(void)
{
    ...
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 259 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 259 "../test/cmp_protect_test.c"
   ) return 0;
    ctx = fixture->cmp_ctx;
    fixture->expected = 0;
    if (!test_ptr("../test/cmp_protect_test.c", 262, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))

            || !test_true("../test/cmp_protect_test.c", 264, "SET_OPT_UNPROTECTED_SEND(ctx, 0)", (OSSL_CMP_CTX_set_option((ctx), 30, (0))) != 0)
            || !test_true("../test/cmp_protect_test.c", 265, "OSSL_CMP_CTX_set0_newPkey(ctx, 1, server_key)", (OSSL_CMP_CTX_set0_newPkey(ctx, 1, server_key)) != 0)) {
        tear_down(fixture);
        fixture = 
# 267 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 267 "../test/cmp_protect_test.c"
                     ;
    }
    EVP_PKEY_up_ref(server_key);
    if (fixture != 
# 270 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 270 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 276 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 276 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 0;
    if (!test_ptr("../test/cmp_protect_test.c", 278, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))
            || !test_true("../test/cmp_protect_test.c", 279, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (0))) != 0)) {
        tear_down(fixture);
        fixture = 
# 281 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 281 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 283 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 283 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_MSG_protect_pbmac_no_sender(int with_ref)
{
    ...
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 292 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 292 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = with_ref;
    if (!test_ptr("../test/cmp_protect_test.c", 294, "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)", fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected))
            || !OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (0))
            || !ossl_cmp_hdr_set1_sender(fixture->msg->header, 
# 296 "../test/cmp_protect_test.c" 3 4
                                                              ((void *)0)
# 296 "../test/cmp_protect_test.c"
                                                                  )
            || !OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx,
                                              secret, sizeof(secret))
            || (!OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx,
                                                  with_ref ? ref : 
# 300 "../test/cmp_protect_test.c" 3 4
                                                                  ((void *)0)
# 300 "../test/cmp_protect_test.c"
                                                                      ,
                                                  sizeof(ref)))) {
        tear_down(fixture);
        fixture = 
# 303 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 303 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 305 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 305 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_protect_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    return test_true("../test/cmp_protect_test.c", 321, "ossl_cmp_msg_add_extraCerts(fixture->cmp_ctx, fixture->msg)", (ossl_cmp_msg_add_extraCerts(fixture->cmp_ctx, fixture->msg)) != 0)
                                                               ;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 327 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 327 "../test/cmp_protect_test.c"
   ) return 0;
    if (!test_ptr("../test/cmp_protect_test.c", 328, "fixture->msg = OSSL_CMP_MSG_dup(ir_protected)", fixture->msg = OSSL_CMP_MSG_dup(ir_protected))) {
        tear_down(fixture);
        fixture = 
# 330 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 330 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 332 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 332 "../test/cmp_protect_test.c"
   ) { result = execute_MSG_add_extraCerts_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_cmp_build_cert_chain_test(CMP_PROTECT_TEST_FIXTURE *fixture)
{
    ...
    X509_STORE *store;
    struct stack_st_X509 *chain =
        X509_build_chain(fixture->cert, fixture->certs, 
# 344 "../test/cmp_protect_test.c" 3 4
                                                       ((void *)0)
# 344 "../test/cmp_protect_test.c"
                                                           ,
                         fixture->with_ss, ctx->libctx, ctx->propq);

    if (test_ptr("../test/cmp_protect_test.c", 347, "chain", chain)) {

        ret = test_int_eq("../test/cmp_protect_test.c", 349, "0", "STACK_OF_X509_cmp(chain, fixture->chain)", 0, STACK_OF_X509_cmp(chain, fixture->chain));
        OSSL_STACK_OF_X509_free(chain);
    }
    if (!ret)
        return 0;

    if (test_ptr("../test/cmp_protect_test.c", 355, "store = X509_STORE_new()", store = X509_STORE_new())
            && test_true("../test/cmp_protect_test.c", 356, "X509_STORE_add_cert(store, root)", (X509_STORE_add_cert(store, root)) != 0)) {
        X509_VERIFY_PARAM_set_flags(X509_STORE_get0_param(store),
                                    0x200000);
        chain = X509_build_chain(fixture->cert, fixture->certs, store,
                                 fixture->with_ss, ctx->libctx, ctx->propq);
        ret = test_int_eq("../test/cmp_protect_test.c", 361, "fixture->expected", "chain != NULL", fixture->expected, chain != 
# 361 "../test/cmp_protect_test.c" 3 4
             ((void *)0)
# 361 "../test/cmp_protect_test.c"
             );
        if (ret && chain != 
# 362 "../test/cmp_protect_test.c" 3 4
                           ((void *)0)
# 362 "../test/cmp_protect_test.c"
                               ) {

            ret = test_int_eq("../test/cmp_protect_test.c", 364, "0", "STACK_OF_X509_cmp(chain, fixture->chain)", 0, STACK_OF_X509_cmp(chain, fixture->chain));
            OSSL_STACK_OF_X509_free(chain);
        }
    }
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 374 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 374 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 1;
    fixture->with_ss = 0;
    fixture->cert = endentity2;
    if (!test_ptr("../test/cmp_protect_test.c", 378, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/cmp_protect_test.c", 379, "fixture->chain = sk_X509_new_null()", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_true("../test/cmp_protect_test.c", 380, "sk_X509_push(fixture->certs, endentity1)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity1))) != 0)
            || !test_true("../test/cmp_protect_test.c", 381, "sk_X509_push(fixture->certs, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(root))) != 0)
            || !test_true("../test/cmp_protect_test.c", 382, "sk_X509_push(fixture->certs, intermediate)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(intermediate))) != 0)
            || !test_true("../test/cmp_protect_test.c", 383, "sk_X509_push(fixture->chain, endentity2)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(endentity2))) != 0)
            || !test_true("../test/cmp_protect_test.c", 384, "sk_X509_push(fixture->chain, intermediate)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(intermediate))) != 0)) {
        tear_down(fixture);
        fixture = 
# 386 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 386 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 388 "../test/cmp_protect_test.c" 3 4
                  ((void *)0)
# 388 "../test/cmp_protect_test.c"
                      ) {
        result = execute_cmp_build_cert_chain_test(fixture);
        fixture->with_ss = 1;
        if (result && test_true("../test/cmp_protect_test.c", 391, "sk_X509_push(fixture->chain, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(root))) != 0))
            result = execute_cmp_build_cert_chain_test(fixture);
    }
    tear_down(fixture);
    return result;
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 400 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 400 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 0;
    fixture->with_ss = 0;
    fixture->cert = endentity2;
    if (!test_ptr("../test/cmp_protect_test.c", 404, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/cmp_protect_test.c", 405, "fixture->chain = sk_X509_new_null()", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_true("../test/cmp_protect_test.c", 406, "sk_X509_push(fixture->certs, endentity1)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity1))) != 0)
            || !test_true("../test/cmp_protect_test.c", 407, "sk_X509_push(fixture->certs, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(root))) != 0)
            || !test_true("../test/cmp_protect_test.c", 408, "sk_X509_push(fixture->chain, endentity2)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(endentity2))) != 0)) {
        tear_down(fixture);
        fixture = 
# 410 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 410 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 412 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 412 "../test/cmp_protect_test.c"
   ) { result = execute_cmp_build_cert_chain_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 418 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 418 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 1;
    fixture->with_ss = 0;
    fixture->cert = endentity2;
    if (!test_ptr("../test/cmp_protect_test.c", 422, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/cmp_protect_test.c", 423, "fixture->chain = sk_X509_new_null()", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_true("../test/cmp_protect_test.c", 424, "sk_X509_push(fixture->certs, endentity1)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity1))) != 0)
            || !test_true("../test/cmp_protect_test.c", 425, "sk_X509_push(fixture->certs, intermediate)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(intermediate))) != 0)
            || !test_true("../test/cmp_protect_test.c", 426, "sk_X509_push(fixture->chain, endentity2)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(endentity2))) != 0)
            || !test_true("../test/cmp_protect_test.c", 427, "sk_X509_push(fixture->chain, intermediate)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(intermediate))) != 0)) {
        tear_down(fixture);
        fixture = 
# 429 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 429 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 431 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 431 "../test/cmp_protect_test.c"
   ) { result = execute_cmp_build_cert_chain_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 437 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 437 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 1;
    fixture->with_ss = 0;
    fixture->cert = root;
    if (!test_ptr("../test/cmp_protect_test.c", 441, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/cmp_protect_test.c", 442, "fixture->chain = sk_X509_new_null()", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_true("../test/cmp_protect_test.c", 443, "sk_X509_push(fixture->certs, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(root))) != 0)
            || !test_true("../test/cmp_protect_test.c", 444, "sk_X509_push(fixture->chain, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(root))) != 0)) {
        tear_down(fixture);
        fixture = 
# 446 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 446 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 448 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 448 "../test/cmp_protect_test.c"
   ) { result = execute_cmp_build_cert_chain_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 454 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 454 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->expected = 0;
    fixture->with_ss = 0;
    fixture->cert = endentity2;
    if (!test_ptr("../test/cmp_protect_test.c", 458, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_ptr("../test/cmp_protect_test.c", 459, "fixture->chain = sk_X509_new_null()", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !test_true("../test/cmp_protect_test.c", 460, "sk_X509_push(fixture->chain, endentity2)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(endentity2))) != 0)) {
        tear_down(fixture);
        fixture = 
# 462 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 462 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 464 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 464 "../test/cmp_protect_test.c"
   ) { result = execute_cmp_build_cert_chain_test(fixture); tear_down(fixture); };
    return result;
}
...
# 472 "../test/cmp_protect_test.c" 3 4
                        ((void *)0)
# 472 "../test/cmp_protect_test.c"
                            ;
    int res = 0;

    if (!test_true("../test/cmp_protect_test.c", 475, "ossl_cmp_X509_STORE_add1_certs(store, fixture->certs, fixture->callback_arg)", (ossl_cmp_X509_STORE_add1_certs(store, fixture->certs, fixture->callback_arg)) != 0)

                                                                         )
        goto err;
    sk = X509_STORE_get1_all_certs(store);
    if (!test_int_eq("../test/cmp_protect_test.c", 480, "0", "STACK_OF_X509_cmp(sk, fixture->chain)", 0, STACK_OF_X509_cmp(sk, fixture->chain)))
        goto err;
    res = 1;
 err:
    X509_STORE_free(store);
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 492 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 492 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->callback_arg = 0;
    if (!test_ptr("../test/cmp_protect_test.c", 494, "fixture->certs = sk_X509_new_null()", fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null()))
            || !OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity1))
            || !OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity2))
            || !OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(root))
            || !OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(intermediate))
            || !test_ptr("../test/cmp_protect_test.c", 499, "fixture->chain = sk_X509_dup(fixture->certs)", fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_dup(ossl_check_const_X509_sk_type(fixture->certs))))) {
        tear_down(fixture);
        fixture = 
# 501 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 501 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 503 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 503 "../test/cmp_protect_test.c"
   ) { result = execute_X509_STORE_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_PROTECT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 509 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 509 "../test/cmp_protect_test.c"
   ) return 0;
    fixture->certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    fixture->chain = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    fixture->callback_arg = 1;
    if (!test_true("../test/cmp_protect_test.c", 513, "sk_X509_push(fixture->certs, endentity1)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity1))) != 0)
            || !test_true("../test/cmp_protect_test.c", 514, "sk_X509_push(fixture->certs, endentity2)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(endentity2))) != 0)
            || !test_true("../test/cmp_protect_test.c", 515, "sk_X509_push(fixture->certs, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(root))) != 0)
            || !test_true("../test/cmp_protect_test.c", 516, "sk_X509_push(fixture->certs, intermediate)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->certs), ossl_check_X509_type(intermediate))) != 0)
            || !test_true("../test/cmp_protect_test.c", 517, "sk_X509_push(fixture->chain, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->chain), ossl_check_X509_type(root))) != 0)) {
        tear_down(fixture);
        fixture = 
# 519 "../test/cmp_protect_test.c" 3 4
                 ((void *)0)
# 519 "../test/cmp_protect_test.c"
                     ;
    }
    if (fixture != 
# 521 "../test/cmp_protect_test.c" 3 4
   ((void *)0)
# 521 "../test/cmp_protect_test.c"
   ) { result = execute_X509_STORE_test(fixture); tear_down(fixture); };
    return result;
}
...
int setup_tests(void)
{
    ...
    if (!test_skip_common_options()) {
        test_error("../test/cmp_protect_test.c", 563, "Error parsing test options\n");
        return 0;
    }

    RAND_bytes(rand_data, 16);
    if (!test_ptr("../test/cmp_protect_test.c", 568, "prot_RSA_f = test_get_argument(0)", prot_RSA_f = test_get_argument(0))
            || !test_ptr("../test/cmp_protect_test.c", 569, "ir_protected_f = test_get_argument(1)", ir_protected_f = test_get_argument(1))
            || !test_ptr("../test/cmp_protect_test.c", 570, "prot_Ed_f = test_get_argument(2)", prot_Ed_f = test_get_argument(2))
            || !test_ptr("../test/cmp_protect_test.c", 571, "genm_prot_Ed_f = test_get_argument(3)", genm_prot_Ed_f = test_get_argument(3))
            || !test_ptr("../test/cmp_protect_test.c", 572, "ir_unprotected_f = test_get_argument(4)", ir_unprotected_f = test_get_argument(4))
            || !test_ptr("../test/cmp_protect_test.c", 573, "ip_PBM_f = test_get_argument(5)", ip_PBM_f = test_get_argument(5))
            || !test_ptr("../test/cmp_protect_test.c", 574, "server_cert_f = test_get_argument(6)", server_cert_f = test_get_argument(6))
            || !test_ptr("../test/cmp_protect_test.c", 575, "server_key_f = test_get_argument(7)", server_key_f = test_get_argument(7))
            || !test_ptr("../test/cmp_protect_test.c", 576, "endentity1_f = test_get_argument(8)", endentity1_f = test_get_argument(8))
            || !test_ptr("../test/cmp_protect_test.c", 577, "endentity2_f = test_get_argument(9)", endentity2_f = test_get_argument(9))
            || !test_ptr("../test/cmp_protect_test.c", 578, "root_f = test_get_argument(10)", root_f = test_get_argument(10))
            || !test_ptr("../test/cmp_protect_test.c", 579, "intermediate_f = test_get_argument(11)", intermediate_f = test_get_argument(11))) {
        test_error("../test/cmp_protect_test.c", 580, "usage: cmp_protect_test %s", "prot_RSA.pem IR_protected.der prot_Ed.pem " "GENM_protected_Ed.der IR_unprotected.der IP_PBM.der " "server.crt server.pem EndEntity1.crt EndEntity2.crt Root_CA.crt " "Intermediate_CA.crt module_name [module_conf_file]\n");
        return 0;
    }

    if (!test_arg_libctx(&libctx, &default_null_provider, &provider, 12, "prot_RSA.pem IR_protected.der prot_Ed.pem " "GENM_protected_Ed.der IR_unprotected.der IP_PBM.der " "server.crt server.pem EndEntity1.crt EndEntity2.crt Root_CA.crt " "Intermediate_CA.crt module_name [module_conf_file]\n"))
        return 0;

    if (!test_ptr("../test/cmp_protect_test.c", 587, "server_key = load_pkey_pem(server_key_f, libctx)", server_key = load_pkey_pem(server_key_f, libctx))
            || !test_ptr("../test/cmp_protect_test.c", 588, "server_cert = load_cert_pem(server_cert_f, libctx)", server_cert = load_cert_pem(server_cert_f, libctx)))
        return 0;

    if (!test_ptr("../test/cmp_protect_test.c", 591, "prot_RSA_key = load_pkey_pem(prot_RSA_f, libctx)", prot_RSA_key = load_pkey_pem(prot_RSA_f, libctx)))
        return 0;

    if (!test_ptr("../test/cmp_protect_test.c", 594, "prot_Ed_key = load_pkey_pem(prot_Ed_f, libctx)", prot_Ed_key = load_pkey_pem(prot_Ed_f, libctx)))
        return 0;

    if (!test_ptr("../test/cmp_protect_test.c", 597, "ir_protected = load_pkimsg(ir_protected_f, libctx)", ir_protected = load_pkimsg(ir_protected_f, libctx))

        || !test_ptr("../test/cmp_protect_test.c", 599, "genm_protected_Ed = load_pkimsg(genm_prot_Ed_f, libctx)", genm_protected_Ed = load_pkimsg(genm_prot_Ed_f, libctx))

        || !test_ptr("../test/cmp_protect_test.c", 601, "ir_unprotected = load_pkimsg(ir_unprotected_f, libctx)", ir_unprotected = load_pkimsg(ir_unprotected_f, libctx)))
        return 0;
    if (!test_ptr("../test/cmp_protect_test.c", 603, "endentity1 = load_cert_pem(endentity1_f, libctx)", endentity1 = load_cert_pem(endentity1_f, libctx))
            || !test_ptr("../test/cmp_protect_test.c", 604, "endentity2 = load_cert_pem(endentity2_f, libctx)", endentity2 = load_cert_pem(endentity2_f, libctx))
            || !test_ptr("../test/cmp_protect_test.c", 605, "root = load_cert_pem(root_f, libctx)", root = load_cert_pem(root_f, libctx))
            || !test_ptr("../test/cmp_protect_test.c", 606, "intermediate = load_cert_pem(intermediate_f, libctx)", intermediate = load_cert_pem(intermediate_f, libctx)))
        return 0;
    if (!test_int_eq("../test/cmp_protect_test.c", 608, "1", "RAND_bytes(rand_data, OSSL_CMP_TRANSACTIONID_LENGTH)", 1, RAND_bytes(rand_data, 16)))
        return 0;


    add_test("test_cmp_calc_protection_no_key_no_secret", test_cmp_calc_protection_no_key_no_secret);
    add_test("test_cmp_calc_protection_pkey", test_cmp_calc_protection_pkey);

    add_test("test_cmp_calc_protection_pkey_Ed", test_cmp_calc_protection_pkey_Ed);

    add_test("test_cmp_calc_protection_pbmac", test_cmp_calc_protection_pbmac);

    add_test("test_MSG_protect_with_msg_sig_alg_protection_plus_rsa_key", test_MSG_protect_with_msg_sig_alg_protection_plus_rsa_key);
    add_test("test_MSG_protect_with_certificate_and_key", test_MSG_protect_with_certificate_and_key);
    add_test("test_MSG_protect_certificate_based_without_cert", test_MSG_protect_certificate_based_without_cert);
    add_test("test_MSG_protect_unprotected_request", test_MSG_protect_unprotected_request);
    add_test("test_MSG_protect_no_key_no_secret", test_MSG_protect_no_key_no_secret);
    add_test("test_MSG_protect_pbmac_no_sender_with_ref", test_MSG_protect_pbmac_no_sender_with_ref);
    add_test("test_MSG_protect_pbmac_no_sender_no_ref", test_MSG_protect_pbmac_no_sender_no_ref);
    add_test("test_MSG_add_extraCerts", test_MSG_add_extraCerts);


    add_test("test_cmp_build_cert_chain", test_cmp_build_cert_chain);
    add_test("test_cmp_build_cert_chain_only_root", test_cmp_build_cert_chain_only_root);
    add_test("test_cmp_build_cert_chain_no_root", test_cmp_build_cert_chain_no_root);
    add_test("test_cmp_build_cert_chain_missing_intermediate", test_cmp_build_cert_chain_missing_intermediate);
    add_test("test_cmp_build_cert_chain_no_certs", test_cmp_build_cert_chain_no_certs);


    add_test("test_X509_STORE", test_X509_STORE);
    add_test("test_X509_STORE_only_self_issued", test_X509_STORE_only_self_issued);
