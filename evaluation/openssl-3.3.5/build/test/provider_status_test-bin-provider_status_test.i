# 0 "../test/provider_status_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_status_test.c"
# 10 "../test/provider_status_test.c"
...
# 11 "../test/provider_status_test.c" 2
...
# 12 "../test/provider_status_test.c" 2
...
# 13 "../test/provider_status_test.c" 2
...
# 14 "../test/provider_status_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../test/provider_status_test.c" 2
...
# 16 "../test/provider_status_test.c" 2
...
# 17 "../test/provider_status_test.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 18 "../test/provider_status_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 19 "../test/provider_status_test.c" 2
...
# 32 "../test/provider_status_test.c" 3 4
                             ((void *)0)
# 32 "../test/provider_status_test.c"
                                 ;
static char *provider_name = 
# 33 "../test/provider_status_test.c" 3 4
                            ((void *)0)
# 33 "../test/provider_status_test.c"
                                ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 44 "../test/provider_status_test.c" 3 4
         ((void *)0) 
# 44 "../test/provider_status_test.c"
              }
    };
    return test_options;
}
                            ...
                            const char *title, int corrupt)
{
    ...
    const OSSL_PARAM *p = 
# 53 "../test/provider_status_test.c" 3 4
                         ((void *)0)
# 53 "../test/provider_status_test.c"
                             ;
    const char *phase = 
# 54 "../test/provider_status_test.c" 3 4
                       ((void *)0)
# 54 "../test/provider_status_test.c"
                           , *type = 
# 54 "../test/provider_status_test.c" 3 4
                                     ((void *)0)
# 54 "../test/provider_status_test.c"
...
# 54 "../test/provider_status_test.c"
    ...
    if (p == 
# 62 "../test/provider_status_test.c" 3 4
            ((void *)0) 
# 62 "../test/provider_status_test.c"
                 || p->data_type != 4)
        goto err;
    ...
    if (p == 
# 67 "../test/provider_status_test.c" 3 4
            ((void *)0) 
# 67 "../test/provider_status_test.c"
                 || p->data_type != 4)
        goto err;
    ...
    if (p == 
# 72 "../test/provider_status_test.c" 3 4
            ((void *)0) 
# 72 "../test/provider_status_test.c"
                 || p->data_type != 4)
        goto err;
    ...
    if (corrupt && strcmp(phase, "Corrupt") == 0)
        goto err;
    ret = 1;
err:
    return ret;
...
static int get_provider_params(const OSSL_PROVIDER *prov)
{
    ...
    if (!test_ptr("../test/provider_status_test.c", 115, "gettable = OSSL_PROVIDER_gettable_params(prov)", gettable = OSSL_PROVIDER_gettable_params(prov))
        || !test_ptr("../test/provider_status_test.c", 116, "p = OSSL_PARAM_locate_const(gettable, OSSL_PROV_PARAM_NAME)", p = OSSL_PARAM_locate_const(gettable, "name"))
        || !test_ptr("../test/provider_status_test.c", 117, "p = OSSL_PARAM_locate_const(gettable, OSSL_PROV_PARAM_VERSION)", p = OSSL_PARAM_locate_const(gettable, "version"))
        || !test_ptr("../test/provider_status_test.c", 118, "p = OSSL_PARAM_locate_const(gettable, OSSL_PROV_PARAM_STATUS)", p = OSSL_PARAM_locate_const(gettable, "status"))
        || !test_ptr("../test/provider_status_test.c", 119, "p = OSSL_PARAM_locate_const(gettable, OSSL_PROV_PARAM_BUILDINFO)", p = OSSL_PARAM_locate_const(gettable, "buildinfo")))
        goto end;
    ...
    if (!test_true("../test/provider_status_test.c", 130, "OSSL_PROVIDER_get_params(prov, params)", (OSSL_PROVIDER_get_params(prov, params)) != 0))
        goto end;
    if (!test_true("../test/provider_status_test.c", 132, "OSSL_PARAM_modified(params + 0)", (OSSL_PARAM_modified(params + 0)) != 0)
        || !test_true("../test/provider_status_test.c", 133, "OSSL_PARAM_modified(params + 1)", (OSSL_PARAM_modified(params + 1)) != 0)
        || !test_true("../test/provider_status_test.c", 134, "OSSL_PARAM_modified(params + 2)", (OSSL_PARAM_modified(params + 2)) != 0)
        || !test_true("../test/provider_status_test.c", 135, "OSSL_PARAM_modified(params + 3)", (OSSL_PARAM_modified(params + 3)) != 0)
        || !test_true("../test/provider_status_test.c", 136, "status == 1", (status == 1) != 0))
        goto end;
...
static int test_provider_status(void)
{
    ...
    OSSL_PROVIDER *prov = 
# 148 "../test/provider_status_test.c" 3 4
                         ((void *)0)
# 148 "../test/provider_status_test.c"
                             ;
    OSSL_PARAM params[2];
    EVP_MD *fetch = 
# 150 "../test/provider_status_test.c" 3 4
                   ((void *)0)
# 150 "../test/provider_status_test.c"
                       ;
    EVP_PKEY_CTX *pctx = 
# 151 "../test/provider_status_test.c" 3 4
                        ((void *)0)
# 151 "../test/provider_status_test.c"
                            ;
    EVP_PKEY *pkey = 
# 152 "../test/provider_status_test.c" 3 4
                    ((void *)0)
# 152 "../test/provider_status_test.c"
                        ;

    if (!test_ptr("../test/provider_status_test.c", 154, "prov = OSSL_PROVIDER_load(libctx, provider_name)", prov = OSSL_PROVIDER_load(libctx, provider_name)))
        goto err;
    if (!get_provider_params(prov))
        goto err;


    params[0] = OSSL_PARAM_construct_uint("status", &status);
    params[1] = OSSL_PARAM_construct_end();
    if (!test_true("../test/provider_status_test.c", 162, "OSSL_PROVIDER_get_params(prov, params)", (OSSL_PROVIDER_get_params(prov, params)) != 0)
        || !test_true("../test/provider_status_test.c", 163, "status == 1", (status == 1) != 0))
        goto err;
    if (!test_ptr("../test/provider_status_test.c", 165, "fetch = EVP_MD_fetch(libctx, \"SHA256\", NULL)", fetch = EVP_MD_fetch(libctx, "SHA256", 
# 165 "../test/provider_status_test.c" 3 4
        ((void *)0)
# 165 "../test/provider_status_test.c"
        )))
        goto err;
    EVP_MD_free(fetch);
    fetch = 
# 168 "../test/provider_status_test.c" 3 4
           ((void *)0)
# 168 "../test/provider_status_test.c"
               ;

    if (!test_ptr("../test/provider_status_test.c", 170, "(pctx = EVP_PKEY_CTX_new_from_name(libctx, \"RSA\", NULL))", (pctx = EVP_PKEY_CTX_new_from_name(libctx, "RSA", 
# 170 "../test/provider_status_test.c" 3 4
        ((void *)0)
# 170 "../test/provider_status_test.c"
        )))
        || !test_int_gt("../test/provider_status_test.c", 171, "EVP_PKEY_keygen_init(pctx)", "0", EVP_PKEY_keygen_init(pctx), 0)
        || !test_int_gt("../test/provider_status_test.c", 172, "EVP_PKEY_CTX_set_rsa_keygen_bits(pctx, 2048)", "0", EVP_PKEY_CTX_set_rsa_keygen_bits(pctx, 2048), 0)
        || !test_int_gt("../test/provider_status_test.c", 173, "EVP_PKEY_keygen(pctx, &pkey)", "0", EVP_PKEY_keygen(pctx, &pkey), 0))
        goto err;
    EVP_PKEY_free(pkey);
    EVP_PKEY_CTX_free(pctx);
    pkey = 
# 177 "../test/provider_status_test.c" 3 4
          ((void *)0)
# 177 "../test/provider_status_test.c"
              ;
    pctx = 
# 178 "../test/provider_status_test.c" 3 4
          ((void *)0)
# 178 "../test/provider_status_test.c"
              ;


    self_test_args.count = 0;
    OSSL_SELF_TEST_set_callback(libctx, self_test_on_demand, &self_test_args);
    if (!test_true("../test/provider_status_test.c", 183, "OSSL_PROVIDER_self_test(prov)", (OSSL_PROVIDER_self_test(prov)) != 0))
        goto err;


    self_test_args.count = 0;
    OSSL_SELF_TEST_set_callback(libctx, self_test_on_demand_fail, &self_test_args);
    if (!test_false("../test/provider_status_test.c", 189, "OSSL_PROVIDER_self_test(prov)", (OSSL_PROVIDER_self_test(prov)) != 0))
        goto err;
    if (!test_true("../test/provider_status_test.c", 191, "OSSL_PROVIDER_get_params(prov, params)", (OSSL_PROVIDER_get_params(prov, params)) != 0)
        || !test_uint_eq("../test/provider_status_test.c", 192, "status", "0", status, 0))
        goto err;
    if (!test_ptr_null("../test/provider_status_test.c", 194, "fetch = EVP_MD_fetch(libctx, \"SHA256\", NULL)", fetch = EVP_MD_fetch(libctx, "SHA256", 
# 194 "../test/provider_status_test.c" 3 4
        ((void *)0)
# 194 "../test/provider_status_test.c"
        )))
        goto err;
...
static int test_provider_gettable_params(void)
{
    ...
    if (!test_ptr("../test/provider_status_test.c", 209, "prov = OSSL_PROVIDER_load(libctx, provider_name)", prov = OSSL_PROVIDER_load(libctx, provider_name)))
        return 0;
...
int setup_tests(void)
{
    OPTION_CHOICE o;
    char *config_file = 
# 219 "../test/provider_status_test.c" 3 4
                       ((void *)0)
# 219 "../test/provider_status_test.c"
                           ;
    ...
    if (libctx == 
# 238 "../test/provider_status_test.c" 3 4
                 ((void *)0)
# 238 "../test/provider_status_test.c"
                     )
        return 0;
