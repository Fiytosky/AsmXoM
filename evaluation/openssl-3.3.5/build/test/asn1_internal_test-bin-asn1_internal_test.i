# 0 "../test/asn1_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_internal_test.c"
# 16 "../test/asn1_internal_test.c"
...
# 17 "../test/asn1_internal_test.c" 2
...
# 19 "../test/asn1_internal_test.c" 2
...
# 20 "../test/asn1_internal_test.c" 2
...
# 22 "../test/asn1_internal_test.c" 2
...
# 23 "../test/asn1_internal_test.c" 2
...
# 25 "../test/asn1_internal_test.c" 2
# 33 "../test/asn1_internal_test.c"
# 1 "../test/../crypto/asn1/tbl_standard.h" 1
# 28 "../test/../crypto/asn1/tbl_standard.h"
static const ASN1_STRING_TABLE tbl_standard[] = {
    ...
    {18, 1, 64, (0x0002|0x0004|0x0800|0x2000),
     0},
    {48, 1, 128, 0x0010,
     0x02},
    ...
    {460, 1, 256, 0x0010,
     0x02},
    {957, 2, 2, 0x0002, 0x02},
    {1004, 1, 12, 0x0001, 0x02},
    {1005, 1, 13, 0x0001, 0x02},
    {1006, 1, 11, 0x0001, 0x02},
    {1090, 3, 3, 0x0002, 0x02},
    {1091, 3, 3, 0x0001, 0x02},
    {1092, 0, -1, 0x2000, 0x02},
    {1208, 1, 128, 0x2000, 0x02}
};
# 34 "../test/asn1_internal_test.c" 2
...
static int test_tbl_standard(void)
{
    ...
    for (tmp = tbl_standard, i = 0; i < (sizeof(tbl_standard)/sizeof((tbl_standard)[0])); i++, tmp++) {
        if (tmp->nid < last_nid) {
            last_nid = 0;
            break;
        }
    ...
    if (test_int_ne("../test/asn1_internal_test.c", 49, "last_nid", "0", last_nid, 0)) {
        test_info("../test/asn1_internal_test.c", 50, "asn1 tbl_standard: Table order OK");
        return 1;
    }

    test_info("../test/asn1_internal_test.c", 54, "asn1 tbl_standard: out of order");
    for (tmp = tbl_standard, i = 0; i < (sizeof(tbl_standard)/sizeof((tbl_standard)[0])); i++, tmp++)
...
# 69 "../test/asn1_internal_test.c" 2
# 1 "../test/../crypto/asn1/standard_methods.h" 1
# 15 "../test/../crypto/asn1/standard_methods.h"
...
# 70 "../test/asn1_internal_test.c" 2
...
static int test_standard_methods(void)
{
    ...
    for (tmp = standard_methods, i = 0; i < (sizeof(standard_methods)/sizeof((standard_methods)[0]));
         i++, tmp++) {
...
# 94 "../test/asn1_internal_test.c"
        if (!test_true("../test/asn1_internal_test.c", 94, "((*tmp)->pem_str == NULL && ((*tmp)->pkey_flags & ASN1_PKEY_ALIAS) != 0) || ((*tmp)->pem_str != NULL && ((*tmp)->pkey_flags & ASN1_PKEY_ALIAS) == 0)", (((*tmp)->pem_str == 
# 94 "../test/asn1_internal_test.c" 3 4
            ((void *)0) 
# 94 "../test/asn1_internal_test.c"
            && ((*tmp)->pkey_flags & 0x1) != 0) || ((*tmp)->pem_str != 
# 94 "../test/asn1_internal_test.c" 3 4
            ((void *)0) 
# 94 "../test/asn1_internal_test.c"
            && ((*tmp)->pkey_flags & 0x1) == 0)) != 0)
                                                                                                   ) {
    ...
    if (test_int_ne("../test/asn1_internal_test.c", 102, "last_pkey_id", "0", last_pkey_id, 0)) {
        test_info("../test/asn1_internal_test.c", 103, "asn1 standard methods: Table order OK");
        return ok;
    }
...
# 124 "../test/asn1_internal_test.c"
static int test_empty_nonoptional_content(void)
{
    RSA *rsa = 
# 126 "../test/asn1_internal_test.c" 3 4
              ((void *)0)
# 126 "../test/asn1_internal_test.c"
                  ;
    BIGNUM *n = 
# 127 "../test/asn1_internal_test.c" 3 4
               ((void *)0)
# 127 "../test/asn1_internal_test.c"
                   ;
    BIGNUM *e = 
# 128 "../test/asn1_internal_test.c" 3 4
               ((void *)0)
# 128 "../test/asn1_internal_test.c"
                   ;
    int ok = 0;

    if (!test_ptr("../test/asn1_internal_test.c", 131, "rsa = RSA_new()", rsa = RSA_new())
        || !test_ptr("../test/asn1_internal_test.c", 132, "n = BN_new()", n = BN_new())
        || !test_ptr("../test/asn1_internal_test.c", 133, "e = BN_new()", e = BN_new())
        || !test_true("../test/asn1_internal_test.c", 134, "RSA_set0_key(rsa, n, e, NULL)", (RSA_set0_key(rsa, n, e, 
# 134 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 134 "../test/asn1_internal_test.c"
           )) != 0))
        goto end;

    n = e = 
# 137 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 137 "../test/asn1_internal_test.c"
               ;
    ...
    if (test_int_le("../test/asn1_internal_test.c", 143, "i2d_RSAPrivateKey(rsa, NULL)", "0", i2d_RSAPrivateKey(rsa, 
# 143 "../test/asn1_internal_test.c" 3 4
       ((void *)0)
# 143 "../test/asn1_internal_test.c"
       ), 0))
        ok = 1;
...
static int test_unicode(const unsigned char *univ, size_t len, int expected)
{
    ...
    for (; univ < end; univ += 4) {
        if (!test_int_eq("../test/asn1_internal_test.c", 165, "ASN1_mbstring_copy(NULL, univ, 4, MBSTRING_UNIV, B_ASN1_UTF8STRING)", "expected", ASN1_mbstring_copy(
# 165 "../test/asn1_internal_test.c" 3 4
            ((void *)0)
# 165 "../test/asn1_internal_test.c"
            , univ, 4, (0x1000|4), 0x2000), expected)
...
static int test_unicode_range(void)
{
    ...
    if (!test_unicode(univ_ok, sizeof univ_ok - 1, 12))
        ok = 0;
...
static int test_obj_create(void)
{
    ...
    if (!test_true("../test/asn1_internal_test.c", 231, "test_obj_create_once(NULL, sn_prefix \"1\", NULL)", (test_obj_create_once(
# 231 "../test/asn1_internal_test.c" 3 4
        ((void *)0)
...
# 231 "../test/asn1_internal_test.c"
        ...
        || !test_int_ne("../test/asn1_internal_test.c", 232, "OBJ_sn2nid(sn_prefix \"1\")", "NID_undef", OBJ_sn2nid("custom" "1"), 0)
        || !test_true("../test/asn1_internal_test.c", 233, "test_obj_create_once(NULL, NULL, ln_prefix \"2\")", (test_obj_create_once(
# 233 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 233 "../test/asn1_internal_test.c"
           , 
# 233 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 233 "../test/asn1_internal_test.c"
           , "custom" "2")) != 0)
        || !test_int_ne("../test/asn1_internal_test.c", 234, "OBJ_ln2nid(ln_prefix \"2\")", "NID_undef", OBJ_ln2nid("custom" "2"), 0)
        || !test_true("../test/asn1_internal_test.c", 235, "test_obj_create_once(NULL, sn_prefix \"3\", ln_prefix \"3\")", (test_obj_create_once(
# 235 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 235 "../test/asn1_internal_test.c"
           , "custom" "3", "custom" "3")) != 0)
        || !test_int_ne("../test/asn1_internal_test.c", 236, "OBJ_sn2nid(sn_prefix \"3\")", "NID_undef", OBJ_sn2nid("custom" "3"), 0)
        || !test_int_ne("../test/asn1_internal_test.c", 237, "OBJ_ln2nid(ln_prefix \"3\")", "NID_undef", OBJ_ln2nid("custom" "3"), 0)
        || !test_true("../test/asn1_internal_test.c", 238, "test_obj_create_once(arc \"4\", NULL, NULL)", (test_obj_create_once("1.3.6.1.4.1.16604.998866." "4", 
# 238 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 238 "../test/asn1_internal_test.c"
           , 
# 238 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 238 "../test/asn1_internal_test.c"
           )) != 0)
        || !test_true("../test/asn1_internal_test.c", 239, "test_obj_create_once(arc \"5\", sn_prefix \"5\", NULL)", (test_obj_create_once("1.3.6.1.4.1.16604.998866." "5", "custom" "5", 
# 239 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 239 "../test/asn1_internal_test.c"
           )) != 0)
        || !test_int_ne("../test/asn1_internal_test.c", 240, "OBJ_sn2nid(sn_prefix \"5\")", "NID_undef", OBJ_sn2nid("custom" "5"), 0)
        || !test_true("../test/asn1_internal_test.c", 241, "test_obj_create_once(arc \"6\", NULL, ln_prefix \"6\")", (test_obj_create_once("1.3.6.1.4.1.16604.998866." "6", 
# 241 "../test/asn1_internal_test.c" 3 4
           ((void *)0)
# 241 "../test/asn1_internal_test.c"
           , "custom" "6")) != 0)
        || !test_int_ne("../test/asn1_internal_test.c", 242, "OBJ_ln2nid(ln_prefix \"6\")", "NID_undef", OBJ_ln2nid("custom" "6"), 0)
        || !test_true("../test/asn1_internal_test.c", 243, "test_obj_create_once(arc \"7\", sn_prefix \"7\", ln_prefix \"7\")", (test_obj_create_once("1.3.6.1.4.1.16604.998866." "7", "custom" "7", "custom" "7")) != 0)

        || !test_int_ne("../test/asn1_internal_test.c", 245, "OBJ_sn2nid(sn_prefix \"7\")", "NID_undef", OBJ_sn2nid("custom" "7"), 0)
        || !test_int_ne("../test/asn1_internal_test.c", 246, "OBJ_ln2nid(ln_prefix \"7\")", "NID_undef", OBJ_ln2nid("custom" "7"), 0))
        return 0;

    if (!test_false("../test/asn1_internal_test.c", 249, "test_obj_create_once(NULL, NULL, NULL)", (test_obj_create_once(
# 249 "../test/asn1_internal_test.c" 3 4
        ((void *)0)
# 249 "../test/asn1_internal_test.c"
        , 
# 249 "../test/asn1_internal_test.c" 3 4
        ((void *)0)
# 249 "../test/asn1_internal_test.c"
...
# 249 "../test/asn1_internal_test.c"
        ...
        || !test_false("../test/asn1_internal_test.c", 250, "test_obj_create_once(broken_arc \"8\", sn_prefix \"8\", ln_prefix \"8\")", (test_obj_create_once("25." "8", "custom" "8", "custom" "8")) != 0)
                                                                          )
        return 0;
...
{
    if (!test_ptr("../test/asn1_internal_test.c", 259, "OBJ_nid2obj(NID_undef)", OBJ_nid2obj(0))
        || !test_ptr("../test/asn1_internal_test.c", 260, "OBJ_nid2sn(NID_undef)", OBJ_nid2sn(0))
        || !test_ptr("../test/asn1_internal_test.c", 261, "OBJ_nid2ln(NID_undef)", OBJ_nid2ln(0)))
        return 0;
...
int setup_tests(void)
{
    ...
    add_test("test_obj_nid_undef", test_obj_nid_undef);
    return 1;
}
