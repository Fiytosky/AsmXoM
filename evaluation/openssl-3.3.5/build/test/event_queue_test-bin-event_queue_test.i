# 0 "../test/event_queue_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/event_queue_test.c"
# 10 "../test/event_queue_test.c"
...
int ossl_event_queue_get1_next_event(OSSL_EVENT_QUEUE *queue,
                                     OSSL_EVENT **event);
# 11 "../test/event_queue_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 12 "../test/event_queue_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
static int event_test(void)
{
    int res = 0;
    size_t len = 0;
    OSSL_EVENT *e1, *e2, e3, *e4 = 
# 27 "../test/event_queue_test.c" 3 4
                                  ((void *)0)
# 27 "../test/event_queue_test.c"
                                      , *ep = 
# 27 "../test/event_queue_test.c" 3 4
                                              ((void *)0)
# 27 "../test/event_queue_test.c"
                                                  ;
    OSSL_EVENT_QUEUE *q = 
# 28 "../test/event_queue_test.c" 3 4
                         ((void *)0)
# 28 "../test/event_queue_test.c"
                             ;
    void *p;
    static char payload[] = "payload";


    if (!test_ptr("../test/event_queue_test.c", 33, "q = ossl_event_queue_new()", q = ossl_event_queue_new())
            || !test_ptr("../test/event_queue_test.c", 34, "e1 = ossl_event_queue_add_new(q, 1, 10, ossl_ticks2time(1100), \"ctx 1\", PAYLOAD(payload))", e1 = ossl_event_queue_add_new(q, 1, 10, ossl_ticks2time(1100), "ctx 1", payload, strlen(payload) + 1))



            || !test_ptr("../test/event_queue_test.c", 38, "e2 = ossl_event_queue_add_new(q, 2, 5, ossl_ticks2time(1100), \"ctx 2\", PAYLOAD(\"data\"))", e2 = ossl_event_queue_add_new(q, 2, 5, ossl_ticks2time(1100), "ctx 2", "data", strlen("data") + 1))



            || !test_true("../test/event_queue_test.c", 42, "ossl_event_queue_add(q, &e3, 3, 20, ossl_ticks2time(1200), \"ctx 3\", PAYLOAD(\"more data\"))", (ossl_event_queue_add(q, &e3, 3, 20, ossl_ticks2time(1200), "ctx 3", "more data", strlen("more data") + 1)) != 0)


            || !test_ptr("../test/event_queue_test.c", 45, "e4 = ossl_event_queue_add_new(q, 2, 5, ossl_ticks2time(1150), \"ctx 2\", PAYLOAD(\"data\"))", e4 = ossl_event_queue_add_new(q, 2, 5, ossl_ticks2time(1150), "ctx 2", "data", strlen("data") + 1))





            || !test_uint_eq("../test/event_queue_test.c", 51, "ossl_event_get_type(e1)", "1", ossl_event_get_type(e1), 1)
            || !test_uint_eq("../test/event_queue_test.c", 52, "ossl_event_get_priority(e1)", "10", ossl_event_get_priority(e1), 10)
            || !test_uint64_t_eq("../test/event_queue_test.c", 53, "ossl_time2ticks(ossl_event_get_when(e1))", "1100", ossl_time2ticks(ossl_event_get_when(e1)), 1100)

            || !test_str_eq("../test/event_queue_test.c", 55, "ossl_event_get0_ctx(e1)", "\"ctx 1\"", ossl_event_get0_ctx(e1), "ctx 1")
            || !test_ptr("../test/event_queue_test.c", 56, "p = ossl_event_get0_payload(e1, &len)", p = ossl_event_get0_payload(e1, &len))
            || !test_str_eq("../test/event_queue_test.c", 57, "(char *)p", "payload", (char *)p, payload)
            || !test_uint64_t_eq("../test/event_queue_test.c", 58, "ossl_time2ticks(ossl_event_time_until(&e3))", "1100", ossl_time2ticks(ossl_event_time_until(&e3)), 1100)

            || !test_uint64_t_eq("../test/event_queue_test.c", 60, "ossl_time2ticks(ossl_event_queue_time_until_next(q))", "1000", ossl_time2ticks(ossl_event_queue_time_until_next(q)), 1000)



            || !test_true("../test/event_queue_test.c", 64, "ossl_event_queue_postpone_until(q, e1, ossl_ticks2time(1200))", (ossl_event_queue_postpone_until(q, e1, ossl_ticks2time(1200))) != 0)

            || !test_uint64_t_eq("../test/event_queue_test.c", 66, "ossl_time2ticks(ossl_event_get_when(e1))", "1200", ossl_time2ticks(ossl_event_get_when(e1)), 1200)
            || !test_true("../test/event_queue_test.c", 67, "ossl_event_queue_remove(q, e4)", (ossl_event_queue_remove(q, e4)) != 0))
        goto err;
    ossl_event_free(e4);


    cur_time = ossl_ticks2time(1000);
    if (!test_true("../test/event_queue_test.c", 73, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_null("../test/event_queue_test.c", 74, "ep", ep))
        goto err;
    cur_time = ossl_ticks2time(1100);
    if (!test_true("../test/event_queue_test.c", 77, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_eq("../test/event_queue_test.c", 78, "ep", "e2", ep, e2))
        goto err;
    ossl_event_free(ep);
    ep = e2 = 
# 81 "../test/event_queue_test.c" 3 4
             ((void *)0)
# 81 "../test/event_queue_test.c"
                 ;
    if (!test_true("../test/event_queue_test.c", 82, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_null("../test/event_queue_test.c", 83, "ep", ep))
        goto err;

    cur_time = ossl_ticks2time(1250);
    if (!test_true("../test/event_queue_test.c", 87, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_eq("../test/event_queue_test.c", 88, "ep", "&e3", ep, &e3))
        goto err;
    ossl_event_free(ep);
    ep = 
# 91 "../test/event_queue_test.c" 3 4
        ((void *)0)
# 91 "../test/event_queue_test.c"
            ;
    if (!test_true("../test/event_queue_test.c", 92, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_eq("../test/event_queue_test.c", 93, "ep", "e1", ep, e1))
        goto err;
    ossl_event_free(ep);
    ep = e1 = 
# 96 "../test/event_queue_test.c" 3 4
             ((void *)0)
# 96 "../test/event_queue_test.c"
                 ;
    if (!test_true("../test/event_queue_test.c", 97, "ossl_event_queue_get1_next_event(q, &ep)", (ossl_event_queue_get1_next_event(q, &ep)) != 0)
            || !test_ptr_null("../test/event_queue_test.c", 98, "ep", ep))
        goto err;
