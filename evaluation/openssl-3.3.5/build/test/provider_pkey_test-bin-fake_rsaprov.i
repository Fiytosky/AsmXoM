# 0 "../test/fake_rsaprov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/fake_rsaprov.c"
# 11 "../test/fake_rsaprov.c"
...
static void *fake_rsa_keymgmt_new(void *provctx)
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 51, "key = OPENSSL_zalloc(sizeof(struct fake_rsa_keydata))", key = CRYPTO_zalloc(sizeof(struct fake_rsa_keydata), "../test/fake_rsaprov.c", 51)))
        return 
# 52 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 52 "../test/fake_rsaprov.c"
                  ;
...
{
    CRYPTO_free(keydata, "../test/fake_rsaprov.c", 65);
}
...
static const char *fake_rsa_keymgmt_query(int id)
{
    ...
    return fake_rsa_query_operation_name ? 
# 82 "../test/fake_rsaprov.c" 3 4
                                          ((void *)0)
# 82 "../test/fake_rsaprov.c"
                                              : "RSA";
}
...
OSSL_PARAM *fake_rsa_key_params(int priv)
{
    if (priv) {
        OSSL_PARAM params[] = {
            { (("n")), (2), ((fake_rsa_n)), ((sizeof(fake_rsa_n) -1)), ((size_t)-1) }
                                                ,
            { (("e")), (2), ((fake_rsa_e)), ((sizeof(fake_rsa_e) -1)), ((size_t)-1) }
                                                ,
            { (("d")), (2), ((fake_rsa_d)), ((sizeof(fake_rsa_d) -1)), ((size_t)-1) }
                                                ,
            { (("rsa-factor1")), (2), ((fake_rsa_p)), ((sizeof(fake_rsa_p) -1)), ((size_t)-1) }
                                                ,
            { (("rsa-factor2")), (2), ((fake_rsa_q)), ((sizeof(fake_rsa_q) -1)), ((size_t)-1) }
                                                ,
            { (("rsa-exponent1")), (2), ((fake_rsa_dmp1)), ((sizeof(fake_rsa_dmp1) -1)), ((size_t)-1) }
                                                   ,
            { (("rsa-exponent2")), (2), ((fake_rsa_dmq1)), ((sizeof(fake_rsa_dmq1) -1)), ((size_t)-1) }
                                                   ,
            { (("rsa-coefficient1")), (2), ((fake_rsa_iqmp)), ((sizeof(fake_rsa_iqmp) -1)), ((size_t)-1) }
                                                   ,
            { 
# 154 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 154 "../test/fake_rsaprov.c"
           , 0, 
# 154 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 154 "../test/fake_rsaprov.c"
        ...
        OSSL_PARAM params[] = {
            ...
            { (("e")), (2), ((fake_rsa_e)), ((sizeof(fake_rsa_e) -1)), ((size_t)-1) }
                                                ,
            { 
# 163 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 163 "../test/fake_rsaprov.c"
           , 0, 
# 163 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 163 "../test/fake_rsaprov.c"
...
{
    OSSL_PARAM *params = 
# 172 "../test/fake_rsaprov.c" 3 4
                        ((void *)0)
# 172 "../test/fake_rsaprov.c"
                            ;
    int ret;
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 178, "params = fake_rsa_key_params(0)", params = fake_rsa_key_params(0)))
        return 0;
...
static const OSSL_PARAM fake_rsa_import_key_types[] = {
    { (("n")), (2), ((
# 187 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 187 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("e")), (2), ((
# 188 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 188 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("d")), (2), ((
# 189 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 189 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("rsa-factor1")), (2), ((
# 190 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 190 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("rsa-factor2")), (2), ((
# 191 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 191 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("rsa-exponent1")), (2), ((
# 192 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 192 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("rsa-exponent2")), (2), ((
# 193 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 193 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("rsa-coefficient1")), (2), ((
# 194 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 194 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { 
# 195 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 195 "../test/fake_rsaprov.c"
   , 0, 
# 195 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 195 "../test/fake_rsaprov.c"
...
static const OSSL_PARAM fake_rsa_export_key_types[] = {
    { (("n")), (2), ((
# 207 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 207 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { (("e")), (2), ((
# 208 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 208 "../test/fake_rsaprov.c"
   )), ((0)), ((size_t)-1) },
    { 
# 209 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 209 "../test/fake_rsaprov.c"
   , 0, 
# 209 "../test/fake_rsaprov.c" 3 4
   ((void *)0)
# 209 "../test/fake_rsaprov.c"
...
{
    struct fake_rsa_keydata *key = 
# 222 "../test/fake_rsaprov.c" 3 4
                                  ((void *)0)
# 222 "../test/fake_rsaprov.c"
                                      ;

    if (reference_sz != sizeof(*key))
        return 
# 225 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 225 "../test/fake_rsaprov.c"
                  ;

    key = *(struct fake_rsa_keydata **)reference;
    if (key->status != 1)
        return 
# 229 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 229 "../test/fake_rsaprov.c"
                  ;


    *(struct fake_rsa_keydata **)reference = 
# 232 "../test/fake_rsaprov.c" 3 4
                                             ((void *)0)
# 232 "../test/fake_rsaprov.c"
                                                 ;
...
{
    unsigned char *gctx = 
# 240 "../test/fake_rsaprov.c" 3 4
                         ((void *)0)
# 240 "../test/fake_rsaprov.c"
                             ;

    if (!test_ptr("../test/fake_rsaprov.c", 242, "gctx = OPENSSL_malloc(1)", gctx = CRYPTO_malloc(1, "../test/fake_rsaprov.c", 242)))
        return 
# 243 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 243 "../test/fake_rsaprov.c"
                  ;
...
static void *fake_rsa_gen(void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 256, "gctx", gctx)
        || !test_mem_eq("../test/fake_rsaprov.c", 257, "gctx", "inited", gctx, sizeof(*gctx), inited, sizeof(inited)))
        return 
# 258 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 258 "../test/fake_rsaprov.c"
                  ;

    if (!test_ptr("../test/fake_rsaprov.c", 260, "keydata = fake_rsa_keymgmt_new(NULL)", keydata = fake_rsa_keymgmt_new(
# 260 "../test/fake_rsaprov.c" 3 4
        ((void *)0)
# 260 "../test/fake_rsaprov.c"
        )))
        return 
# 261 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 261 "../test/fake_rsaprov.c"
                  ;
...
{
   CRYPTO_free(genctx, "../test/fake_rsaprov.c", 269);
}

static const OSSL_DISPATCH fake_rsa_keymgmt_funcs[] = {
    { 1, (void (*)(void))fake_rsa_keymgmt_new },
    { 10, (void (*)(void))fake_rsa_keymgmt_free} ,
    { 21, (void (*)(void))fake_rsa_keymgmt_has },
    { 20,
        (void (*)(void))fake_rsa_keymgmt_query },
    { 40, (void (*)(void))fake_rsa_keymgmt_import },
    { 41,
        (void (*)(void))fake_rsa_keymgmt_imptypes },
    { 42, (void (*)(void))fake_rsa_keymgmt_export },
    { 43,
        (void (*)(void))fake_rsa_keymgmt_exptypes },
    { 8, (void (*)(void))fake_rsa_keymgmt_load },
    { 2, (void (*)(void))fake_rsa_gen_init },
    { 6, (void (*)(void))fake_rsa_gen },
    { 7, (void (*)(void))fake_rsa_gen_cleanup },
    { 0, 
# 288 "../test/fake_rsaprov.c" 3 4
   ((void *)0) 
# 288 "../test/fake_rsaprov.c"
   }
};
...
static const OSSL_ALGORITHM fake_rsa_keymgmt_algs[] = {
    ...
    { 
# 293 "../test/fake_rsaprov.c" 3 4
     ((void *)0)
# 293 "../test/fake_rsaprov.c"
         , 
# 293 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 293 "../test/fake_rsaprov.c"
...
{
    unsigned char *sigctx = CRYPTO_zalloc(1, "../test/fake_rsaprov.c", 303);

    test_ptr("../test/fake_rsaprov.c", 305, "sigctx", sigctx);
...
{
    CRYPTO_free(sigctx, "../test/fake_rsaprov.c", 312);
}
                                  ...
                                  const OSSL_PARAM params[])
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 322, "sigctx", sigctx))
        return 0;


    if (!test_ptr("../test/fake_rsaprov.c", 326, "keydata", keydata) || !test_int_gt("../test/fake_rsaprov.c", 326, "keydata->status", "0", keydata->status, 0))
        return 0;
                             ...
                             const unsigned char *tbs, size_t tbslen)
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 341, "sigctx", sigctx) || !test_int_eq("../test/fake_rsaprov.c", 341, "*sigctx", "1", *sigctx, 1))
        return 0;

    *siglen = 256;

    if (sig != 
# 346 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 346 "../test/fake_rsaprov.c"
                  ) {
        if (!test_int_ge("../test/fake_rsaprov.c", 347, "sigsize", "*siglen", sigsize, *siglen))
            return 0;
        *sigctx = 2;
...
static void *fake_rsa_sig_dupctx(void *ctx)
{
    ...
    if ((*sigctx & 0xA0) != 0)
        return 
# 369 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 369 "../test/fake_rsaprov.c"
                  ;

    if (!test_ptr("../test/fake_rsaprov.c", 371, "newctx = OPENSSL_zalloc(1)", newctx = CRYPTO_zalloc(1, "../test/fake_rsaprov.c", 371)))
        return 
# 372 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 372 "../test/fake_rsaprov.c"
                  ;
                                    ...
                                    void *provkey, const OSSL_PARAM params[])
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 385, "sigctx", sigctx))
        return 0;


    if (!test_ptr("../test/fake_rsaprov.c", 389, "keydata", keydata) || !test_int_gt("../test/fake_rsaprov.c", 389, "keydata->status", "0", keydata->status, 0))
        return 0;
    ...
    *sigctx = type;
    ...
    if (params) {
        ...
        if (p != 
# 399 "../test/fake_rsaprov.c" 3 4
                ((void *)0)
# 399 "../test/fake_rsaprov.c"
                    ) {
...
static int fake_rsa_dgstsgn_init(void *ctx, const char *mdname,
                                 void *provkey, const OSSL_PARAM params[])
{
    return fake_rsa_dgstsgnvfy_init(ctx, 0x01, provkey, params);
}

static int fake_rsa_dgstvfy_init(void *ctx, const char *mdname,
                                 void *provkey, const OSSL_PARAM params[])
{
    return fake_rsa_dgstsgnvfy_init(ctx, 0x02, provkey, params);
}
                                      ...
                                      size_t datalen)
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 427, "sigctx", sigctx))
        return 0;

    if (*sigctx == 0 || (*sigctx & 0x08) != 0)
        return 0;
                                     ...
                                     size_t *siglen, size_t sigsize)
{
    ...
    if (!test_ptr("../test/fake_rsaprov.c", 443, "sigctx", sigctx))
        return 0;

    if (*sigctx == 0 || (*sigctx & 0x08) != 0)
        return 0;

    if ((*sigctx & 0x01) != 0 && (siglen == 
# 449 "../test/fake_rsaprov.c" 3 4
                                                        ((void *)0)
# 449 "../test/fake_rsaprov.c"
                                                            ))
        return 0;

    if ((*sigctx & 0x02) != 0 && (siglen != 
# 452 "../test/fake_rsaprov.c" 3 4
                                                          ((void *)0)
# 452 "../test/fake_rsaprov.c"
                                                              ))
        return 0;
    ...
    if (siglen) {
        *siglen = 256;
        ...
        if (sig != 
# 459 "../test/fake_rsaprov.c" 3 4
                  ((void *)0)
# 459 "../test/fake_rsaprov.c"
                      ) {
            if (!test_int_ge("../test/fake_rsaprov.c", 460, "sigsize", "*siglen", sigsize, *siglen))
                return 0;
...
static int fake_rsa_dgstvfy_final(void *ctx, unsigned char *sig,
                                  size_t siglen)
{
    return fake_rsa_dgstsgnvfy_final(ctx, sig, 
# 477 "../test/fake_rsaprov.c" 3 4
                                              ((void *)0)
# 477 "../test/fake_rsaprov.c"
                                                  , siglen);
}
...
static const OSSL_DISPATCH fake_rsa_sig_funcs[] = {
    { 1, (void (*)(void))fake_rsa_sig_newctx },
    { 16, (void (*)(void))fake_rsa_sig_freectx },
    { 2, (void (*)(void))fake_rsa_sig_sign_init },
    { 3, (void (*)(void))fake_rsa_sig_sign },
    { 17, (void (*)(void))fake_rsa_sig_dupctx },
    { 8,
    ...
    { 0, 
# 521 "../test/fake_rsaprov.c" 3 4
   ((void *)0) 
# 521 "../test/fake_rsaprov.c"
   }
};
...
static const OSSL_ALGORITHM fake_rsa_sig_algs[] = {
    ...
    { 
# 526 "../test/fake_rsaprov.c" 3 4
     ((void *)0)
# 526 "../test/fake_rsaprov.c"
         , 
# 526 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 526 "../test/fake_rsaprov.c"
...
static void *fake_rsa_st_open_ex(void *provctx, const char *uri,
                                 ...
                                 void *pw_cbarg)
{
    unsigned char *storectx = 
# 547 "../test/fake_rsaprov.c" 3 4
                             ((void *)0)
# 547 "../test/fake_rsaprov.c"
                                 ;


    if (strncmp(uri, fake_rsa_scheme, sizeof(fake_rsa_scheme) - 1) != 0)
        return 
# 551 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 551 "../test/fake_rsaprov.c"
                  ;

    if (strncmp(uri, fake_rsa_openpwtest,
                sizeof(fake_rsa_openpwtest) - 1) == 0) {
        const char *pw_check = "Passphrase Testing";
        char fakepw[sizeof("Passphrase Testing") + 1] = { 0 };
        size_t fakepw_len = 0;
        OSSL_PARAM pw_params[2] = {
            { (("info")), (4), (((void *)fake_rsa_prompt)), (sizeof(fake_rsa_prompt) - 1), ((size_t)-1) }

                                                               ,
            { 
# 562 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 562 "../test/fake_rsaprov.c"
           , 0, 
# 562 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 562 "../test/fake_rsaprov.c"
        ...
        if (pw_cb == 
# 565 "../test/fake_rsaprov.c" 3 4
                    ((void *)0)
# 565 "../test/fake_rsaprov.c"
                        ) {
            return 
# 566 "../test/fake_rsaprov.c" 3 4
                  ((void *)0)
# 566 "../test/fake_rsaprov.c"
                      ;
        }

        if (!pw_cb(fakepw, sizeof(fakepw), &fakepw_len, pw_params, pw_cbarg)) {
            test_info("../test/fake_rsaprov.c", 570, "fake_rsa_open_ex failed passphrase callback");
            return 
# 571 "../test/fake_rsaprov.c" 3 4
                  ((void *)0)
# 571 "../test/fake_rsaprov.c"
                      ;
        }
        if (strncmp(pw_check, fakepw, sizeof(pw_check) - 1) != 0) {
            test_info("../test/fake_rsaprov.c", 574, "fake_rsa_open_ex failed passphrase check");
            return 
# 575 "../test/fake_rsaprov.c" 3 4
                  ((void *)0)
# 575 "../test/fake_rsaprov.c"
                      ;
        }
    }

    storectx = CRYPTO_zalloc(1, "../test/fake_rsaprov.c", 579);
    if (!test_ptr("../test/fake_rsaprov.c", 580, "storectx", storectx))
        return 
# 581 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 581 "../test/fake_rsaprov.c"
                  ;

    test_info("../test/fake_rsaprov.c", 583, "fake_rsa_open_ex called");
...
{
    unsigned char *storectx = 
# 590 "../test/fake_rsaprov.c" 3 4
                             ((void *)0)
# 590 "../test/fake_rsaprov.c"
                                 ;

    storectx = fake_rsa_st_open_ex(provctx, uri, 
# 592 "../test/fake_rsaprov.c" 3 4
                                                ((void *)0)
# 592 "../test/fake_rsaprov.c"
                                                    , 
# 592 "../test/fake_rsaprov.c" 3 4
                                                      ((void *)0)
# 592 "../test/fake_rsaprov.c"
...
# 592 "../test/fake_rsaprov.c"
    ...
    test_info("../test/fake_rsaprov.c", 594, "fake_rsa_open called");
...
static const OSSL_PARAM *fake_rsa_st_settable_ctx_params(void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { 
# 602 "../test/fake_rsaprov.c" 3 4
       ((void *)0)
# 602 "../test/fake_rsaprov.c"
       , 0, 
# 602 "../test/fake_rsaprov.c" 3 4
       ((void *)0)
# 602 "../test/fake_rsaprov.c"
                            ...
                            OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    ...
    int object_type = 2;
    struct fake_rsa_keydata *key = 
# 620 "../test/fake_rsaprov.c" 3 4
                                  ((void *)0)
# 620 "../test/fake_rsaprov.c"
                                      ;
    int rv = 0;
    ...
    case 0:
        ...
        if (!test_ptr("../test/fake_rsaprov.c", 631, "key = fake_rsa_keymgmt_new(NULL)", key = fake_rsa_keymgmt_new(
# 631 "../test/fake_rsaprov.c" 3 4
            ((void *)0)
# 631 "../test/fake_rsaprov.c"
            )))
            break;
        if (!test_int_gt("../test/fake_rsaprov.c", 633, "fake_rsa_keymgmt_import(key, 0, NULL)", "0", fake_rsa_keymgmt_import(key, 0, 
# 633 "../test/fake_rsaprov.c" 3 4
            ((void *)0)
# 633 "../test/fake_rsaprov.c"
            ), 0))
            break;
        params[0] =
    ...
    case 2:
        test_info("../test/fake_rsaprov.c", 650, "fake_rsa_load() called in error state");
        break;

    default:
        test_info("../test/fake_rsaprov.c", 654, "fake_rsa_load() called in eof state");
        break;
    }

    test_info("../test/fake_rsaprov.c", 658, "fake_rsa_load called - rv: %d", rv);
...
{
    CRYPTO_free(loaderctx, "../test/fake_rsaprov.c", 685);
    return 1;
}

static const OSSL_DISPATCH fake_rsa_store_funcs[] = {
    { 1, (void (*)(void))fake_rsa_st_open },
    { 10, (void (*)(void))fake_rsa_st_open_ex },
    { 3,
      (void (*)(void))fake_rsa_st_settable_ctx_params },
    { 4, (void (*)(void))fake_rsa_st_set_ctx_params },
    { 5, (void (*)(void))fake_rsa_st_load },
    { 6, (void (*)(void))fake_rsa_st_eof },
    { 7, (void (*)(void))fake_rsa_st_close },
    { 9, (void (*)(void))fake_rsa_st_delete },
    { 0, 
# 699 "../test/fake_rsaprov.c" 3 4
   ((void *)0) 
# 699 "../test/fake_rsaprov.c"
   },
};
...
static const OSSL_ALGORITHM fake_rsa_store_algs[] = {
    ...
    { 
# 704 "../test/fake_rsaprov.c" 3 4
     ((void *)0)
# 704 "../test/fake_rsaprov.c"
         , 
# 704 "../test/fake_rsaprov.c" 3 4
           ((void *)0)
# 704 "../test/fake_rsaprov.c"
                                            ...
                                            int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 722 "../test/fake_rsaprov.c" 3 4
          ((void *)0)
# 722 "../test/fake_rsaprov.c"
              ;
}
...
static const OSSL_DISPATCH fake_rsa_method[] = {
    ...
    { 1027, (void (*)(void))fake_rsa_query },
    { 0, 
# 729 "../test/fake_rsaprov.c" 3 4
   ((void *)0) 
# 729 "../test/fake_rsaprov.c"
   }
};
...
{
    if (!test_ptr("../test/fake_rsaprov.c", 736, "*provctx = OSSL_LIB_CTX_new()", *provctx = OSSL_LIB_CTX_new()))
        return 0;
    *out = fake_rsa_method;
    return 1;
}
...
OSSL_PROVIDER *fake_rsa_start(OSSL_LIB_CTX *libctx)
{
    ...
    if (!test_true("../test/fake_rsaprov.c", 746, "OSSL_PROVIDER_add_builtin(libctx, \"fake-rsa\", fake_rsa_provider_init)", (OSSL_PROVIDER_add_builtin(libctx, "fake-rsa", fake_rsa_provider_init)) != 0)

            || !test_ptr("../test/fake_rsaprov.c", 748, "p = OSSL_PROVIDER_try_load(libctx, \"fake-rsa\", 1)", p = OSSL_PROVIDER_try_load(libctx, "fake-rsa", 1)))
        return 
# 749 "../test/fake_rsaprov.c" 3 4
              ((void *)0)
# 749 "../test/fake_rsaprov.c"
                  ;
