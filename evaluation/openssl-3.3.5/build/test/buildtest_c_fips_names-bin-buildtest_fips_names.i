# 0 "test/buildtest_fips_names.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_fips_names.c"
...
# 6 "test/buildtest_fips_names.c" 2
...
# 8 "test/buildtest_fips_names.c" 2


# 1 "../include/openssl/fips_names.h" 1
# 12 "../include/openssl/fips_names.h"
        
# 11 "test/buildtest_fips_names.c" 2



# 13 "test/buildtest_fips_names.c"
int main(void)
{
    return 0;
}
