# 0 "../test/param_build_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/param_build_test.c"
# 11 "../test/param_build_test.c"
...
# 14 "../test/param_build_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../test/param_build_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 16 "../test/param_build_test.c" 2

static const OSSL_PARAM params_empty[] = { { 
# 17 "../test/param_build_test.c" 3 4
                                          ((void *)0)
# 17 "../test/param_build_test.c"
                                          , 0, 
# 17 "../test/param_build_test.c" 3 4
                                          ((void *)0)
# 17 "../test/param_build_test.c"
...
{
    OSSL_PARAM_BLD *bld = 
# 21 "../test/param_build_test.c" 3 4
                         ((void *)0)
# 21 "../test/param_build_test.c"
                             ;
    OSSL_PARAM *params = 
# 22 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 22 "../test/param_build_test.c"
                            , *params_blt = 
# 22 "../test/param_build_test.c" 3 4
                                            ((void *)0)
# 22 "../test/param_build_test.c"
                                                , *p;
    BIGNUM *zbn = 
# 23 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 23 "../test/param_build_test.c"
                     , *zbn_res = 
# 23 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 23 "../test/param_build_test.c"
    ...
    if (!test_ptr("../test/param_build_test.c", 26, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/param_build_test.c", 27, "zbn = BN_new()", zbn = BN_new())
        || !test_true("../test/param_build_test.c", 28, "OSSL_PARAM_BLD_push_BN(bld, \"zeronumber\", idx == 0 ? zbn : NULL)", (OSSL_PARAM_BLD_push_BN(bld, "zeronumber", idx == 0 ? zbn : 
# 28 "../test/param_build_test.c" 3 4
           ((void *)0)
# 28 "../test/param_build_test.c"
           )) != 0)

        || !test_ptr("../test/param_build_test.c", 30, "params_blt = OSSL_PARAM_BLD_to_param(bld)", params_blt = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    params = params_blt;

    if (!test_ptr("../test/param_build_test.c", 35, "p = OSSL_PARAM_locate(params, \"zeronumber\")", p = OSSL_PARAM_locate(params, "zeronumber"))
        || !test_str_eq("../test/param_build_test.c", 36, "p->key", "\"zeronumber\"", p->key, "zeronumber")
        || !test_uint_eq("../test/param_build_test.c", 37, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 38, "OSSL_PARAM_get_BN(p, &zbn_res)", (OSSL_PARAM_get_BN(p, &zbn_res)) != 0)
        || !test_BN_eq("../test/param_build_test.c", 39, "zbn_res", "zbn", zbn_res, zbn))
        goto err;
    res = 1;
err:
    if (params != params_blt)
        CRYPTO_free(params, "../test/param_build_test.c", 44);
...
{
    OSSL_PARAM_BLD *bld = 
# 54 "../test/param_build_test.c" 3 4
                         ((void *)0)
# 54 "../test/param_build_test.c"
                             ;
    OSSL_PARAM *params = 
# 55 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 55 "../test/param_build_test.c"
                            , *params_blt = 
# 55 "../test/param_build_test.c" 3 4
                                            ((void *)0)
# 55 "../test/param_build_test.c"
                                                , *p;
    BIGNUM *zbn = 
# 56 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 56 "../test/param_build_test.c"
                     , *zbn_res = 
# 56 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 56 "../test/param_build_test.c"
    ...
    if (!test_ptr("../test/param_build_test.c", 59, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/param_build_test.c", 60, "zbn = BN_secure_new()", zbn = BN_secure_new())
        || !test_true("../test/param_build_test.c", 61, "OSSL_PARAM_BLD_push_BN(bld, \"zeronumber\", zbn)", (OSSL_PARAM_BLD_push_BN(bld, "zeronumber", zbn)) != 0)
        || !test_ptr("../test/param_build_test.c", 62, "params_blt = OSSL_PARAM_BLD_to_param(bld)", params_blt = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    params = params_blt;

    if (!test_ptr("../test/param_build_test.c", 67, "p = OSSL_PARAM_locate(params, \"zeronumber\")", p = OSSL_PARAM_locate(params, "zeronumber"))
        || !test_true("../test/param_build_test.c", 68, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 69, "p->key", "\"zeronumber\"", p->key, "zeronumber")
        || !test_uint_eq("../test/param_build_test.c", 70, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 71, "OSSL_PARAM_get_BN(p, &zbn_res)", (OSSL_PARAM_get_BN(p, &zbn_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 72, "BN_get_flags(zbn, BN_FLG_SECURE)", "BN_FLG_SECURE", BN_get_flags(zbn, 0x08), 0x08)
        || !test_BN_eq("../test/param_build_test.c", 73, "zbn_res", "zbn", zbn_res, zbn))
        goto err;
    res = 1;
err:
    if (params != params_blt)
        CRYPTO_free(params, "../test/param_build_test.c", 78);
    OSSL_PARAM_free(params_blt);
    OSSL_PARAM_BLD_free(bld);
    BN_free(zbn);
    BN_free(zbn_res);
...
static int template_public_test(int tstid)
{
    ...
    OSSL_PARAM *params = 
# 89 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 89 "../test/param_build_test.c"
                            , *params_blt = 
# 89 "../test/param_build_test.c" 3 4
                                            ((void *)0)
# 89 "../test/param_build_test.c"
...
# 89 "../test/param_build_test.c"
                                                            , *p;
    BIGNUM *zbn = 
# 90 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 90 "../test/param_build_test.c"
                     , *zbn_res = 
# 90 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 90 "../test/param_build_test.c"
                                      ;
    BIGNUM *pbn = 
# 91 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 91 "../test/param_build_test.c"
                     , *pbn_res = 
# 91 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 91 "../test/param_build_test.c"
                                      ;
    BIGNUM *nbn = 
# 92 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 92 "../test/param_build_test.c"
                     , *nbn_res = 
# 92 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 92 "../test/param_build_test.c"
    ...
    time_t t;
    char *utf = 
# 99 "../test/param_build_test.c" 3 4
               ((void *)0)
# 99 "../test/param_build_test.c"
                   ;
    const char *cutf;
    int res = 0;

    if (!test_ptr("../test/param_build_test.c", 103, "bld", bld)
        || !test_true("../test/param_build_test.c", 104, "OSSL_PARAM_BLD_push_long(bld, \"l\", 42)", (OSSL_PARAM_BLD_push_long(bld, "l", 42)) != 0)
        || !test_true("../test/param_build_test.c", 105, "OSSL_PARAM_BLD_push_int32(bld, \"i32\", 1532)", (OSSL_PARAM_BLD_push_int32(bld, "i32", 1532)) != 0)
        || !test_true("../test/param_build_test.c", 106, "OSSL_PARAM_BLD_push_int64(bld, \"i64\", -9999999)", (OSSL_PARAM_BLD_push_int64(bld, "i64", -9999999)) != 0)
        || !test_true("../test/param_build_test.c", 107, "OSSL_PARAM_BLD_push_time_t(bld, \"t\", 11224)", (OSSL_PARAM_BLD_push_time_t(bld, "t", 11224)) != 0)
        || !test_true("../test/param_build_test.c", 108, "OSSL_PARAM_BLD_push_double(bld, \"d\", 1.61803398875)", (OSSL_PARAM_BLD_push_double(bld, "d", 1.61803398875)) != 0)
        || !test_ptr("../test/param_build_test.c", 109, "zbn = BN_new()", zbn = BN_new())
        || !test_true("../test/param_build_test.c", 110, "OSSL_PARAM_BLD_push_BN(bld, \"zeronumber\", zbn)", (OSSL_PARAM_BLD_push_BN(bld, "zeronumber", zbn)) != 0)
        || !test_ptr("../test/param_build_test.c", 111, "pbn = BN_new()", pbn = BN_new())
        || !test_true("../test/param_build_test.c", 112, "BN_set_word(pbn, 1729)", (BN_set_word(pbn, 1729)) != 0)
        || !test_true("../test/param_build_test.c", 113, "OSSL_PARAM_BLD_push_BN(bld, \"bignumber\", pbn)", (OSSL_PARAM_BLD_push_BN(bld, "bignumber", pbn)) != 0)
        || !test_ptr("../test/param_build_test.c", 114, "nbn = BN_secure_new()", nbn = BN_secure_new())
        || !test_true("../test/param_build_test.c", 115, "BN_set_word(nbn, 1733)", (BN_set_word(nbn, 1733)) != 0)
        || !test_true("../test/param_build_test.c", 116, "(BN_set_negative(nbn, 1), 1)", ((BN_set_negative(nbn, 1), 1)) != 0)
        || !test_true("../test/param_build_test.c", 117, "OSSL_PARAM_BLD_push_BN(bld, \"negativebignumber\", nbn)", (OSSL_PARAM_BLD_push_BN(bld, "negativebignumber", nbn)) != 0)
        || !test_true("../test/param_build_test.c", 118, "OSSL_PARAM_BLD_push_utf8_string(bld, \"utf8_s\", \"foo\", sizeof(\"foo\"))", (OSSL_PARAM_BLD_push_utf8_string(bld, "utf8_s", "foo", sizeof("foo"))) != 0)

        || !test_true("../test/param_build_test.c", 120, "OSSL_PARAM_BLD_push_utf8_ptr(bld, \"utf8_p\", \"bar-boom\", 0)", (OSSL_PARAM_BLD_push_utf8_ptr(bld, "utf8_p", "bar-boom", 0)) != 0)

        || !test_true("../test/param_build_test.c", 122, "OSSL_PARAM_BLD_push_int(bld, \"i\", -6)", (OSSL_PARAM_BLD_push_int(bld, "i", -6)) != 0)
        || !test_ptr("../test/param_build_test.c", 123, "params_blt = OSSL_PARAM_BLD_to_param(bld)", params_blt = OSSL_PARAM_BLD_to_param(bld)))
        goto err;
    ...
    if (!test_ptr("../test/param_build_test.c", 146, "p = OSSL_PARAM_locate(params, \"i\")", p = OSSL_PARAM_locate(params, "i"))
        || !test_true("../test/param_build_test.c", 147, "OSSL_PARAM_get_int(p, &i)", (OSSL_PARAM_get_int(p, &i)) != 0)
        || !test_str_eq("../test/param_build_test.c", 148, "p->key", "\"i\"", p->key, "i")
        || !test_uint_eq("../test/param_build_test.c", 149, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_size_t_eq("../test/param_build_test.c", 150, "p->data_size", "sizeof(int)", p->data_size, sizeof(int))
        || !test_int_eq("../test/param_build_test.c", 151, "i", "-6", i, -6)

        || !test_ptr("../test/param_build_test.c", 153, "p = OSSL_PARAM_locate(params, \"i32\")", p = OSSL_PARAM_locate(params, "i32"))
        || !test_true("../test/param_build_test.c", 154, "OSSL_PARAM_get_int32(p, &i32)", (OSSL_PARAM_get_int32(p, &i32)) != 0)
        || !test_str_eq("../test/param_build_test.c", 155, "p->key", "\"i32\"", p->key, "i32")
        || !test_uint_eq("../test/param_build_test.c", 156, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_size_t_eq("../test/param_build_test.c", 157, "p->data_size", "sizeof(int32_t)", p->data_size, sizeof(int32_t))
        || !test_int_eq("../test/param_build_test.c", 158, "(int)i32", "1532", (int)i32, 1532)

        || !test_ptr("../test/param_build_test.c", 160, "p = OSSL_PARAM_locate(params, \"i64\")", p = OSSL_PARAM_locate(params, "i64"))
        || !test_str_eq("../test/param_build_test.c", 161, "p->key", "\"i64\"", p->key, "i64")
        || !test_uint_eq("../test/param_build_test.c", 162, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_size_t_eq("../test/param_build_test.c", 163, "p->data_size", "sizeof(int64_t)", p->data_size, sizeof(int64_t))
        || !test_true("../test/param_build_test.c", 164, "OSSL_PARAM_get_int64(p, &i64)", (OSSL_PARAM_get_int64(p, &i64)) != 0)
        || !test_long_eq("../test/param_build_test.c", 165, "(long)i64", "-9999999", (long)i64, -9999999)

        || !test_ptr("../test/param_build_test.c", 167, "p = OSSL_PARAM_locate(params, \"l\")", p = OSSL_PARAM_locate(params, "l"))
        || !test_str_eq("../test/param_build_test.c", 168, "p->key", "\"l\"", p->key, "l")
        || !test_uint_eq("../test/param_build_test.c", 169, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_size_t_eq("../test/param_build_test.c", 170, "p->data_size", "sizeof(long int)", p->data_size, sizeof(long int))
        || !test_true("../test/param_build_test.c", 171, "OSSL_PARAM_get_long(p, &l)", (OSSL_PARAM_get_long(p, &l)) != 0)
        || !test_long_eq("../test/param_build_test.c", 172, "l", "42", l, 42)

        || !test_ptr("../test/param_build_test.c", 174, "p = OSSL_PARAM_locate(params, \"t\")", p = OSSL_PARAM_locate(params, "t"))
        || !test_str_eq("../test/param_build_test.c", 175, "p->key", "\"t\"", p->key, "t")
        || !test_uint_eq("../test/param_build_test.c", 176, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_size_t_eq("../test/param_build_test.c", 177, "p->data_size", "sizeof(time_t)", p->data_size, sizeof(time_t))
        || !test_true("../test/param_build_test.c", 178, "OSSL_PARAM_get_time_t(p, &t)", (OSSL_PARAM_get_time_t(p, &t)) != 0)
        || !test_time_t_eq("../test/param_build_test.c", 179, "t", "11224", t, 11224)

        || !test_ptr("../test/param_build_test.c", 181, "p = OSSL_PARAM_locate(params, \"d\")", p = OSSL_PARAM_locate(params, "d"))
        || !test_true("../test/param_build_test.c", 182, "OSSL_PARAM_get_double(p, &d)", (OSSL_PARAM_get_double(p, &d)) != 0)
        || !test_str_eq("../test/param_build_test.c", 183, "p->key", "\"d\"", p->key, "d")
        || !test_uint_eq("../test/param_build_test.c", 184, "p->data_type", "OSSL_PARAM_REAL", p->data_type, 3)
        || !test_size_t_eq("../test/param_build_test.c", 185, "p->data_size", "sizeof(double)", p->data_size, sizeof(double))
        || !test_double_eq("../test/param_build_test.c", 186, "d", "1.61803398875", d, 1.61803398875)

        || !test_ptr("../test/param_build_test.c", 188, "p = OSSL_PARAM_locate(params, \"utf8_s\")", p = OSSL_PARAM_locate(params, "utf8_s"))
        || !test_str_eq("../test/param_build_test.c", 189, "p->data", "\"foo\"", p->data, "foo")
        || !test_true("../test/param_build_test.c", 190, "OSSL_PARAM_get_utf8_string(p, &utf, 0)", (OSSL_PARAM_get_utf8_string(p, &utf, 0)) != 0)
        || !test_str_eq("../test/param_build_test.c", 191, "utf", "\"foo\"", utf, "foo")

        || !test_ptr("../test/param_build_test.c", 193, "p = OSSL_PARAM_locate(params, \"utf8_p\")", p = OSSL_PARAM_locate(params, "utf8_p"))
        || !test_true("../test/param_build_test.c", 194, "OSSL_PARAM_get_utf8_ptr(p, &cutf)", (OSSL_PARAM_get_utf8_ptr(p, &cutf)) != 0)
        || !test_str_eq("../test/param_build_test.c", 195, "cutf", "\"bar-boom\"", cutf, "bar-boom")

        || !test_ptr("../test/param_build_test.c", 197, "p = OSSL_PARAM_locate(params, \"zeronumber\")", p = OSSL_PARAM_locate(params, "zeronumber"))
        || !test_str_eq("../test/param_build_test.c", 198, "p->key", "\"zeronumber\"", p->key, "zeronumber")
        || !test_uint_eq("../test/param_build_test.c", 199, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 200, "OSSL_PARAM_get_BN(p, &zbn_res)", (OSSL_PARAM_get_BN(p, &zbn_res)) != 0)
        || !test_BN_eq("../test/param_build_test.c", 201, "zbn_res", "zbn", zbn_res, zbn)

        || !test_ptr("../test/param_build_test.c", 203, "p = OSSL_PARAM_locate(params, \"bignumber\")", p = OSSL_PARAM_locate(params, "bignumber"))
        || !test_str_eq("../test/param_build_test.c", 204, "p->key", "\"bignumber\"", p->key, "bignumber")
        || !test_uint_eq("../test/param_build_test.c", 205, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 206, "OSSL_PARAM_get_BN(p, &pbn_res)", (OSSL_PARAM_get_BN(p, &pbn_res)) != 0)
        || !test_BN_eq("../test/param_build_test.c", 207, "pbn_res", "pbn", pbn_res, pbn)

        || !test_ptr("../test/param_build_test.c", 209, "p = OSSL_PARAM_locate(params, \"negativebignumber\")", p = OSSL_PARAM_locate(params, "negativebignumber"))
        || !test_str_eq("../test/param_build_test.c", 210, "p->key", "\"negativebignumber\"", p->key, "negativebignumber")
        || !test_uint_eq("../test/param_build_test.c", 211, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_true("../test/param_build_test.c", 212, "OSSL_PARAM_get_BN(p, &nbn_res)", (OSSL_PARAM_get_BN(p, &nbn_res)) != 0)
        || !test_BN_eq("../test/param_build_test.c", 213, "nbn_res", "nbn", nbn_res, nbn))
        goto err;
    res = 1;
err:
    CRYPTO_free(p1, "../test/param_build_test.c", 217);
    if (params != params_blt)
        CRYPTO_free(params, "../test/param_build_test.c", 219);
    OSSL_PARAM_free(params_blt);
    OSSL_PARAM_BLD_free(bld);
    CRYPTO_free(utf, "../test/param_build_test.c", 222);
    BN_free(zbn);
    BN_free(zbn_res);
    BN_free(pbn);
    BN_free(pbn_res);
...
{
    int *data1 = 
# 234 "../test/param_build_test.c" 3 4
                ((void *)0)
# 234 "../test/param_build_test.c"
                    , *data2 = 
# 234 "../test/param_build_test.c" 3 4
                               ((void *)0)
# 234 "../test/param_build_test.c"
    ...
    OSSL_PARAM_BLD *bld = 
# 239 "../test/param_build_test.c" 3 4
                         ((void *)0)
# 239 "../test/param_build_test.c"
                             ;
    OSSL_PARAM *params = 
# 240 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 240 "../test/param_build_test.c"
                            , *params_blt = 
# 240 "../test/param_build_test.c" 3 4
                                            ((void *)0)
# 240 "../test/param_build_test.c"
...
# 240 "../test/param_build_test.c"
    ...
    size_t st;
    BIGNUM *zbn = 
# 246 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 246 "../test/param_build_test.c"
                     , *zbn_res = 
# 246 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 246 "../test/param_build_test.c"
                                      ;
    BIGNUM *pbn = 
# 247 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 247 "../test/param_build_test.c"
                     , *pbn_res = 
# 247 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 247 "../test/param_build_test.c"
                                      ;
    BIGNUM *nbn = 
# 248 "../test/param_build_test.c" 3 4
                 ((void *)0)
# 248 "../test/param_build_test.c"
                     , *nbn_res = 
# 248 "../test/param_build_test.c" 3 4
                                  ((void *)0)
# 248 "../test/param_build_test.c"
    ...
    if (!test_ptr("../test/param_build_test.c", 251, "data1 = OPENSSL_secure_malloc(data1_size)", data1 = CRYPTO_secure_malloc(data1_size, "../test/param_build_test.c", 251))
            || !test_ptr("../test/param_build_test.c", 252, "data2 = OPENSSL_secure_malloc(data2_size)", data2 = CRYPTO_secure_malloc(data2_size, "../test/param_build_test.c", 252))
            || !test_ptr("../test/param_build_test.c", 253, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new()))
        goto err;
    ...
    if (!test_true("../test/param_build_test.c", 261, "OSSL_PARAM_BLD_push_uint(bld, \"i\", 6)", (OSSL_PARAM_BLD_push_uint(bld, "i", 6)) != 0)
        || !test_true("../test/param_build_test.c", 262, "OSSL_PARAM_BLD_push_ulong(bld, \"l\", 42)", (OSSL_PARAM_BLD_push_ulong(bld, "l", 42)) != 0)
        || !test_true("../test/param_build_test.c", 263, "OSSL_PARAM_BLD_push_uint32(bld, \"i32\", 1532)", (OSSL_PARAM_BLD_push_uint32(bld, "i32", 1532)) != 0)
        || !test_true("../test/param_build_test.c", 264, "OSSL_PARAM_BLD_push_uint64(bld, \"i64\", 9999999)", (OSSL_PARAM_BLD_push_uint64(bld, "i64", 9999999)) != 0)
        || !test_true("../test/param_build_test.c", 265, "OSSL_PARAM_BLD_push_size_t(bld, \"st\", 65537)", (OSSL_PARAM_BLD_push_size_t(bld, "st", 65537)) != 0)
        || !test_ptr("../test/param_build_test.c", 266, "zbn = BN_secure_new()", zbn = BN_secure_new())
        || !test_true("../test/param_build_test.c", 267, "OSSL_PARAM_BLD_push_BN(bld, \"zeronumber\", zbn)", (OSSL_PARAM_BLD_push_BN(bld, "zeronumber", zbn)) != 0)
        || !test_ptr("../test/param_build_test.c", 268, "pbn = BN_secure_new()", pbn = BN_secure_new())
        || !test_true("../test/param_build_test.c", 269, "BN_set_word(pbn, 1729)", (BN_set_word(pbn, 1729)) != 0)
        || !test_true("../test/param_build_test.c", 270, "OSSL_PARAM_BLD_push_BN(bld, \"bignumber\", pbn)", (OSSL_PARAM_BLD_push_BN(bld, "bignumber", pbn)) != 0)
        || !test_ptr("../test/param_build_test.c", 271, "nbn = BN_secure_new()", nbn = BN_secure_new())
        || !test_true("../test/param_build_test.c", 272, "BN_set_word(nbn, 1733)", (BN_set_word(nbn, 1733)) != 0)
        || !test_true("../test/param_build_test.c", 273, "(BN_set_negative(nbn, 1), 1)", ((BN_set_negative(nbn, 1), 1)) != 0)
        || !test_true("../test/param_build_test.c", 274, "OSSL_PARAM_BLD_push_BN(bld, \"negativebignumber\", nbn)", (OSSL_PARAM_BLD_push_BN(bld, "negativebignumber", nbn)) != 0)
        || !test_true("../test/param_build_test.c", 275, "OSSL_PARAM_BLD_push_octet_string(bld, \"oct_s\", data1, data1_size)", (OSSL_PARAM_BLD_push_octet_string(bld, "oct_s", data1, data1_size)) != 0)

        || !test_true("../test/param_build_test.c", 277, "OSSL_PARAM_BLD_push_octet_ptr(bld, \"oct_p\", data2, data2_size)", (OSSL_PARAM_BLD_push_octet_ptr(bld, "oct_p", data2, data2_size)) != 0)

        || !test_ptr("../test/param_build_test.c", 279, "params_blt = OSSL_PARAM_BLD_to_param(bld)", params_blt = OSSL_PARAM_BLD_to_param(bld)))
        goto err;
    switch (tstid) {
    case 0:
        params = params_blt;
    ...
    if (!test_ptr("../test/param_build_test.c", 301, "p = OSSL_PARAM_locate(params, \"i\")", p = OSSL_PARAM_locate(params, "i"))
        || !test_false("../test/param_build_test.c", 302, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_true("../test/param_build_test.c", 303, "OSSL_PARAM_get_uint(p, &i)", (OSSL_PARAM_get_uint(p, &i)) != 0)
        || !test_str_eq("../test/param_build_test.c", 304, "p->key", "\"i\"", p->key, "i")
        || !test_uint_eq("../test/param_build_test.c", 305, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 306, "p->data_size", "sizeof(int)", p->data_size, sizeof(int))
        || !test_uint_eq("../test/param_build_test.c", 307, "i", "6", i, 6)

        || !test_ptr("../test/param_build_test.c", 309, "p = OSSL_PARAM_locate(params, \"i32\")", p = OSSL_PARAM_locate(params, "i32"))
        || !test_false("../test/param_build_test.c", 310, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_true("../test/param_build_test.c", 311, "OSSL_PARAM_get_uint32(p, &i32)", (OSSL_PARAM_get_uint32(p, &i32)) != 0)
        || !test_str_eq("../test/param_build_test.c", 312, "p->key", "\"i32\"", p->key, "i32")
        || !test_uint_eq("../test/param_build_test.c", 313, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 314, "p->data_size", "sizeof(int32_t)", p->data_size, sizeof(int32_t))
        || !test_uint_eq("../test/param_build_test.c", 315, "(unsigned int)i32", "1532", (unsigned int)i32, 1532)

        || !test_ptr("../test/param_build_test.c", 317, "p = OSSL_PARAM_locate(params, \"i64\")", p = OSSL_PARAM_locate(params, "i64"))
        || !test_false("../test/param_build_test.c", 318, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 319, "p->key", "\"i64\"", p->key, "i64")
        || !test_uint_eq("../test/param_build_test.c", 320, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 321, "p->data_size", "sizeof(int64_t)", p->data_size, sizeof(int64_t))
        || !test_true("../test/param_build_test.c", 322, "OSSL_PARAM_get_uint64(p, &i64)", (OSSL_PARAM_get_uint64(p, &i64)) != 0)
        || !test_ulong_eq("../test/param_build_test.c", 323, "(unsigned long)i64", "9999999", (unsigned long)i64, 9999999)

        || !test_ptr("../test/param_build_test.c", 325, "p = OSSL_PARAM_locate(params, \"l\")", p = OSSL_PARAM_locate(params, "l"))
        || !test_false("../test/param_build_test.c", 326, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 327, "p->key", "\"l\"", p->key, "l")
        || !test_uint_eq("../test/param_build_test.c", 328, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 329, "p->data_size", "sizeof(unsigned long int)", p->data_size, sizeof(unsigned long int))
        || !test_true("../test/param_build_test.c", 330, "OSSL_PARAM_get_ulong(p, &l)", (OSSL_PARAM_get_ulong(p, &l)) != 0)
        || !test_ulong_eq("../test/param_build_test.c", 331, "l", "42", l, 42)

        || !test_ptr("../test/param_build_test.c", 333, "p = OSSL_PARAM_locate(params, \"st\")", p = OSSL_PARAM_locate(params, "st"))
        || !test_false("../test/param_build_test.c", 334, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 335, "p->key", "\"st\"", p->key, "st")
        || !test_uint_eq("../test/param_build_test.c", 336, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 337, "p->data_size", "sizeof(size_t)", p->data_size, sizeof(size_t))
        || !test_true("../test/param_build_test.c", 338, "OSSL_PARAM_get_size_t(p, &st)", (OSSL_PARAM_get_size_t(p, &st)) != 0)
        || !test_size_t_eq("../test/param_build_test.c", 339, "st", "65537", st, 65537)

        || !test_ptr("../test/param_build_test.c", 341, "p = OSSL_PARAM_locate(params, \"oct_s\")", p = OSSL_PARAM_locate(params, "oct_s"))
        || !test_true("../test/param_build_test.c", 342, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 343, "p->key", "\"oct_s\"", p->key, "oct_s")
        || !test_uint_eq("../test/param_build_test.c", 344, "p->data_type", "OSSL_PARAM_OCTET_STRING", p->data_type, 5)
        || !test_mem_eq("../test/param_build_test.c", 345, "p->data", "data1", p->data, p->data_size, data1, data1_size)

        || !test_ptr("../test/param_build_test.c", 347, "p = OSSL_PARAM_locate(params, \"oct_p\")", p = OSSL_PARAM_locate(params, "oct_p"))
        || !test_false("../test/param_build_test.c", 348, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_true("../test/param_build_test.c", 349, "CRYPTO_secure_allocated(*(void **)p->data)", (CRYPTO_secure_allocated(*(void **)p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 350, "p->key", "\"oct_p\"", p->key, "oct_p")
        || !test_uint_eq("../test/param_build_test.c", 351, "p->data_type", "OSSL_PARAM_OCTET_PTR", p->data_type, 7)
        || !test_mem_eq("../test/param_build_test.c", 352, "*(void **)p->data", "data2", *(void **)p->data, p->data_size, data2, data2_size)

        || !test_ptr("../test/param_build_test.c", 354, "p = OSSL_PARAM_locate(params, \"zeronumber\")", p = OSSL_PARAM_locate(params, "zeronumber"))
        || !test_true("../test/param_build_test.c", 355, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 356, "p->key", "\"zeronumber\"", p->key, "zeronumber")
        || !test_uint_eq("../test/param_build_test.c", 357, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 358, "OSSL_PARAM_get_BN(p, &zbn_res)", (OSSL_PARAM_get_BN(p, &zbn_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 359, "BN_get_flags(pbn, BN_FLG_SECURE)", "BN_FLG_SECURE", BN_get_flags(pbn, 0x08), 0x08)
        || !test_BN_eq("../test/param_build_test.c", 360, "zbn_res", "zbn", zbn_res, zbn)

        || !test_ptr("../test/param_build_test.c", 362, "p = OSSL_PARAM_locate(params, \"bignumber\")", p = OSSL_PARAM_locate(params, "bignumber"))
        || !test_true("../test/param_build_test.c", 363, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 364, "p->key", "\"bignumber\"", p->key, "bignumber")
        || !test_uint_eq("../test/param_build_test.c", 365, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 366, "OSSL_PARAM_get_BN(p, &pbn_res)", (OSSL_PARAM_get_BN(p, &pbn_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 367, "BN_get_flags(pbn, BN_FLG_SECURE)", "BN_FLG_SECURE", BN_get_flags(pbn, 0x08), 0x08)
        || !test_BN_eq("../test/param_build_test.c", 368, "pbn_res", "pbn", pbn_res, pbn)

        || !test_ptr("../test/param_build_test.c", 370, "p = OSSL_PARAM_locate(params, \"negativebignumber\")", p = OSSL_PARAM_locate(params, "negativebignumber"))
        || !test_true("../test/param_build_test.c", 371, "CRYPTO_secure_allocated(p->data)", (CRYPTO_secure_allocated(p->data)) != 0)
        || !test_str_eq("../test/param_build_test.c", 372, "p->key", "\"negativebignumber\"", p->key, "negativebignumber")
        || !test_uint_eq("../test/param_build_test.c", 373, "p->data_type", "OSSL_PARAM_INTEGER", p->data_type, 1)
        || !test_true("../test/param_build_test.c", 374, "OSSL_PARAM_get_BN(p, &nbn_res)", (OSSL_PARAM_get_BN(p, &nbn_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 375, "BN_get_flags(nbn, BN_FLG_SECURE)", "BN_FLG_SECURE", BN_get_flags(nbn, 0x08), 0x08)
        || !test_BN_eq("../test/param_build_test.c", 376, "nbn_res", "nbn", nbn_res, nbn))
        goto err;
    res = 1;
err:
    OSSL_PARAM_free(p1);
    ...
    OSSL_PARAM_free(params_blt);
    OSSL_PARAM_BLD_free(bld);
    CRYPTO_secure_free(data1, "../test/param_build_test.c", 385);
    CRYPTO_secure_free(data2, "../test/param_build_test.c", 386);
    BN_free(zbn);
    BN_free(zbn_res);
    BN_free(pbn);
    BN_free(pbn_res);
...
static int builder_limit_test(void)
{
    ...
    OSSL_PARAM_BLD *bld = OSSL_PARAM_BLD_new();
    OSSL_PARAM *params = 
# 401 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 401 "../test/param_build_test.c"
                            ;
    int i, res = 0;

    if (!test_ptr("../test/param_build_test.c", 404, "bld", bld))
        goto err;
    ...
    for (i = 0; i < n; i++) {
        ...
        names[i][1] = 'a' + (i % 26) - 1;
        names[i][2] = '\0';
        if (!test_true("../test/param_build_test.c", 411, "OSSL_PARAM_BLD_push_int(bld, names[i], 3 * i + 1)", (OSSL_PARAM_BLD_push_int(bld, names[i], 3 * i + 1)) != 0))
            goto err;
    }
    if (!test_ptr("../test/param_build_test.c", 414, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    for (i = 0; params[i].key != 
# 417 "../test/param_build_test.c" 3 4
                                ((void *)0)
# 417 "../test/param_build_test.c"
                                    ; i++);
    if (!test_int_eq("../test/param_build_test.c", 418, "i", "n", i, n))
        goto err;


    OSSL_PARAM_free(params);
    params = 
# 423 "../test/param_build_test.c" 3 4
            ((void *)0)
# 423 "../test/param_build_test.c"
                ;

    if (!test_true("../test/param_build_test.c", 425, "OSSL_PARAM_BLD_push_int(bld, \"g\", 2)", (OSSL_PARAM_BLD_push_int(bld, "g", 2)) != 0)
        || !test_ptr("../test/param_build_test.c", 426, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    for (i = 0; params[i].key != 
# 429 "../test/param_build_test.c" 3 4
                                ((void *)0)
# 429 "../test/param_build_test.c"
                                    ; i++);
    if (!test_int_eq("../test/param_build_test.c", 430, "i", "1", i, 1))
        goto err;
    res = 1;
err:
    OSSL_PARAM_free(params);
...
static int builder_merge_test(void)
{
    ...
    OSSL_PARAM *params = 
# 445 "../test/param_build_test.c" 3 4
                        ((void *)0)
# 445 "../test/param_build_test.c"
                            , *params_blt = 
# 445 "../test/param_build_test.c" 3 4
                                            ((void *)0)
# 445 "../test/param_build_test.c"
...
# 445 "../test/param_build_test.c"
    ...
    size_t st;
    BIGNUM *bn_priv = 
# 451 "../test/param_build_test.c" 3 4
                     ((void *)0)
# 451 "../test/param_build_test.c"
                         , *bn_priv_res = 
# 451 "../test/param_build_test.c" 3 4
                                          ((void *)0)
# 451 "../test/param_build_test.c"
                                              ;
    BIGNUM *bn_pub = 
# 452 "../test/param_build_test.c" 3 4
                    ((void *)0)
# 452 "../test/param_build_test.c"
                        , *bn_pub_res = 
# 452 "../test/param_build_test.c" 3 4
                                        ((void *)0)
# 452 "../test/param_build_test.c"
    ...
    if (!test_ptr("../test/param_build_test.c", 455, "bld", bld)
        || !test_true("../test/param_build_test.c", 456, "OSSL_PARAM_BLD_push_uint(bld, \"i\", 6)", (OSSL_PARAM_BLD_push_uint(bld, "i", 6)) != 0)
        || !test_true("../test/param_build_test.c", 457, "OSSL_PARAM_BLD_push_ulong(bld, \"l\", 42)", (OSSL_PARAM_BLD_push_ulong(bld, "l", 42)) != 0)
        || !test_true("../test/param_build_test.c", 458, "OSSL_PARAM_BLD_push_uint32(bld, \"i32\", 1532)", (OSSL_PARAM_BLD_push_uint32(bld, "i32", 1532)) != 0)
        || !test_true("../test/param_build_test.c", 459, "OSSL_PARAM_BLD_push_uint64(bld, \"i64\", 9999999)", (OSSL_PARAM_BLD_push_uint64(bld, "i64", 9999999)) != 0)
        || !test_true("../test/param_build_test.c", 460, "OSSL_PARAM_BLD_push_size_t(bld, \"st\", 65537)", (OSSL_PARAM_BLD_push_size_t(bld, "st", 65537)) != 0)
        || !test_ptr("../test/param_build_test.c", 461, "bn_priv = BN_secure_new()", bn_priv = BN_secure_new())
        || !test_true("../test/param_build_test.c", 462, "BN_set_word(bn_priv, 1729)", (BN_set_word(bn_priv, 1729)) != 0)
        || !test_true("../test/param_build_test.c", 463, "OSSL_PARAM_BLD_push_BN(bld, \"bignumber_priv\", bn_priv)", (OSSL_PARAM_BLD_push_BN(bld, "bignumber_priv", bn_priv)) != 0)
        || !test_ptr("../test/param_build_test.c", 464, "params_blt = OSSL_PARAM_BLD_to_param(bld)", params_blt = OSSL_PARAM_BLD_to_param(bld)))
        goto err;

    if (!test_ptr("../test/param_build_test.c", 467, "bld2", bld2)
        || !test_true("../test/param_build_test.c", 468, "OSSL_PARAM_BLD_push_octet_string(bld2, \"oct_s\", data1, sizeof(data1))", (OSSL_PARAM_BLD_push_octet_string(bld2, "oct_s", data1, sizeof(data1))) != 0)

        || !test_true("../test/param_build_test.c", 470, "OSSL_PARAM_BLD_push_octet_ptr(bld2, \"oct_p\", data2, sizeof(data2))", (OSSL_PARAM_BLD_push_octet_ptr(bld2, "oct_p", data2, sizeof(data2))) != 0)

        || !test_true("../test/param_build_test.c", 472, "OSSL_PARAM_BLD_push_uint32(bld2, \"i32\", 99)", (OSSL_PARAM_BLD_push_uint32(bld2, "i32", 99)) != 0)
        || !test_ptr("../test/param_build_test.c", 473, "bn_pub = BN_new()", bn_pub = BN_new())
        || !test_true("../test/param_build_test.c", 474, "BN_set_word(bn_pub, 0x42)", (BN_set_word(bn_pub, 0x42)) != 0)
        || !test_true("../test/param_build_test.c", 475, "OSSL_PARAM_BLD_push_BN(bld2, \"bignumber_pub\", bn_pub)", (OSSL_PARAM_BLD_push_BN(bld2, "bignumber_pub", bn_pub)) != 0)
        || !test_ptr("../test/param_build_test.c", 476, "params2_blt = OSSL_PARAM_BLD_to_param(bld2)", params2_blt = OSSL_PARAM_BLD_to_param(bld2)))
        goto err;

    if (!test_ptr("../test/param_build_test.c", 479, "params = OSSL_PARAM_merge(params_blt, params2_blt)", params = OSSL_PARAM_merge(params_blt, params2_blt)))
        goto err;

    if (!test_ptr("../test/param_build_test.c", 482, "p = OSSL_PARAM_locate(params, \"i\")", p = OSSL_PARAM_locate(params, "i"))
        || !test_true("../test/param_build_test.c", 483, "OSSL_PARAM_get_uint(p, &i)", (OSSL_PARAM_get_uint(p, &i)) != 0)
        || !test_str_eq("../test/param_build_test.c", 484, "p->key", "\"i\"", p->key, "i")
        || !test_uint_eq("../test/param_build_test.c", 485, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 486, "p->data_size", "sizeof(int)", p->data_size, sizeof(int))
        || !test_uint_eq("../test/param_build_test.c", 487, "i", "6", i, 6)

        || !test_ptr("../test/param_build_test.c", 489, "p = OSSL_PARAM_locate(params, \"i32\")", p = OSSL_PARAM_locate(params, "i32"))
        || !test_true("../test/param_build_test.c", 490, "OSSL_PARAM_get_uint32(p, &i32)", (OSSL_PARAM_get_uint32(p, &i32)) != 0)
        || !test_str_eq("../test/param_build_test.c", 491, "p->key", "\"i32\"", p->key, "i32")
        || !test_uint_eq("../test/param_build_test.c", 492, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 493, "p->data_size", "sizeof(int32_t)", p->data_size, sizeof(int32_t))
        || !test_uint_eq("../test/param_build_test.c", 494, "(unsigned int)i32", "99", (unsigned int)i32, 99)

        || !test_ptr("../test/param_build_test.c", 496, "p = OSSL_PARAM_locate(params, \"i64\")", p = OSSL_PARAM_locate(params, "i64"))
        || !test_str_eq("../test/param_build_test.c", 497, "p->key", "\"i64\"", p->key, "i64")
        || !test_uint_eq("../test/param_build_test.c", 498, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 499, "p->data_size", "sizeof(int64_t)", p->data_size, sizeof(int64_t))
        || !test_true("../test/param_build_test.c", 500, "OSSL_PARAM_get_uint64(p, &i64)", (OSSL_PARAM_get_uint64(p, &i64)) != 0)
        || !test_ulong_eq("../test/param_build_test.c", 501, "(unsigned long)i64", "9999999", (unsigned long)i64, 9999999)

        || !test_ptr("../test/param_build_test.c", 503, "p = OSSL_PARAM_locate(params, \"l\")", p = OSSL_PARAM_locate(params, "l"))
        || !test_str_eq("../test/param_build_test.c", 504, "p->key", "\"l\"", p->key, "l")
        || !test_uint_eq("../test/param_build_test.c", 505, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 506, "p->data_size", "sizeof(unsigned long int)", p->data_size, sizeof(unsigned long int))
        || !test_true("../test/param_build_test.c", 507, "OSSL_PARAM_get_ulong(p, &l)", (OSSL_PARAM_get_ulong(p, &l)) != 0)
        || !test_ulong_eq("../test/param_build_test.c", 508, "l", "42", l, 42)

        || !test_ptr("../test/param_build_test.c", 510, "p = OSSL_PARAM_locate(params, \"st\")", p = OSSL_PARAM_locate(params, "st"))
        || !test_str_eq("../test/param_build_test.c", 511, "p->key", "\"st\"", p->key, "st")
        || !test_uint_eq("../test/param_build_test.c", 512, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_size_t_eq("../test/param_build_test.c", 513, "p->data_size", "sizeof(size_t)", p->data_size, sizeof(size_t))
        || !test_true("../test/param_build_test.c", 514, "OSSL_PARAM_get_size_t(p, &st)", (OSSL_PARAM_get_size_t(p, &st)) != 0)
        || !test_size_t_eq("../test/param_build_test.c", 515, "st", "65537", st, 65537)

        || !test_ptr("../test/param_build_test.c", 517, "p = OSSL_PARAM_locate(params, \"oct_s\")", p = OSSL_PARAM_locate(params, "oct_s"))
        || !test_str_eq("../test/param_build_test.c", 518, "p->key", "\"oct_s\"", p->key, "oct_s")
        || !test_uint_eq("../test/param_build_test.c", 519, "p->data_type", "OSSL_PARAM_OCTET_STRING", p->data_type, 5)
        || !test_mem_eq("../test/param_build_test.c", 520, "p->data", "data1", p->data, p->data_size, data1, sizeof(data1))

        || !test_ptr("../test/param_build_test.c", 522, "p = OSSL_PARAM_locate(params, \"oct_p\")", p = OSSL_PARAM_locate(params, "oct_p"))
        || !test_str_eq("../test/param_build_test.c", 523, "p->key", "\"oct_p\"", p->key, "oct_p")
        || !test_uint_eq("../test/param_build_test.c", 524, "p->data_type", "OSSL_PARAM_OCTET_PTR", p->data_type, 7)
        || !test_mem_eq("../test/param_build_test.c", 525, "*(void **)p->data", "data2", *(void **)p->data, p->data_size, data2, sizeof(data2))

        || !test_ptr("../test/param_build_test.c", 527, "p = OSSL_PARAM_locate(params, \"bignumber_pub\")", p = OSSL_PARAM_locate(params, "bignumber_pub"))
        || !test_str_eq("../test/param_build_test.c", 528, "p->key", "\"bignumber_pub\"", p->key, "bignumber_pub")
        || !test_uint_eq("../test/param_build_test.c", 529, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 530, "OSSL_PARAM_get_BN(p, &bn_pub_res)", (OSSL_PARAM_get_BN(p, &bn_pub_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 531, "BN_cmp(bn_pub_res, bn_pub)", "0", BN_cmp(bn_pub_res, bn_pub), 0)
        || !test_ptr("../test/param_build_test.c", 532, "p = OSSL_PARAM_locate(params, \"bignumber_priv\")", p = OSSL_PARAM_locate(params, "bignumber_priv"))
        || !test_str_eq("../test/param_build_test.c", 533, "p->key", "\"bignumber_priv\"", p->key, "bignumber_priv")
        || !test_uint_eq("../test/param_build_test.c", 534, "p->data_type", "OSSL_PARAM_UNSIGNED_INTEGER", p->data_type, 2)
        || !test_true("../test/param_build_test.c", 535, "OSSL_PARAM_get_BN(p, &bn_priv_res)", (OSSL_PARAM_get_BN(p, &bn_priv_res)) != 0)
        || !test_int_eq("../test/param_build_test.c", 536, "BN_cmp(bn_priv_res, bn_priv)", "0", BN_cmp(bn_priv_res, bn_priv), 0))
        goto err;
    res = 1;
err:
    OSSL_PARAM_free(params);
...
int setup_tests(void)
{
    ...
    add_test("builder_merge_test", builder_merge_test);
    return 1;
}
