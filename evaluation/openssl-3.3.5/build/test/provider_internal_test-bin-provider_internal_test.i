# 0 "../test/provider_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_internal_test.c"
# 10 "../test/provider_internal_test.c"
...
# 11 "../test/provider_internal_test.c" 2
...
# 12 "../test/provider_internal_test.c" 2
...
# 13 "../test/provider_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 14 "../test/provider_internal_test.c" 2

extern OSSL_provider_init_fn p_test_init;

static char buf[256];
static OSSL_PARAM greeting_request[] = {
    { "greeting", 4, buf, sizeof(buf), 0 },
    { 
# 20 "../test/provider_internal_test.c" 3 4
     ((void *)0)
# 20 "../test/provider_internal_test.c"
         , 0, 
# 20 "../test/provider_internal_test.c" 3 4
              ((void *)0)
# 20 "../test/provider_internal_test.c"
...
static int test_provider(OSSL_PROVIDER *prov, const char *expected_greeting)
{
    ...
    ret =
        test_true("../test/provider_internal_test.c", 29, "ossl_provider_activate(prov, 1, 0)", (ossl_provider_activate(prov, 1, 0)) != 0)
        && test_true("../test/provider_internal_test.c", 30, "ossl_provider_get_params(prov, greeting_request)", (ossl_provider_get_params(prov, greeting_request)) != 0)
        && test_ptr("../test/provider_internal_test.c", 31, "greeting = greeting_request[0].data", greeting = greeting_request[0].data)
        && test_size_t_gt("../test/provider_internal_test.c", 32, "greeting_request[0].data_size", "0", greeting_request[0].data_size, 0)
        && test_str_eq("../test/provider_internal_test.c", 33, "greeting", "expected_greeting", greeting, expected_greeting)
        && test_true("../test/provider_internal_test.c", 34, "ossl_provider_deactivate(prov, 1)", (ossl_provider_deactivate(prov, 1)) != 0);

    test_info("../test/provider_internal_test.c", 36, "Got this greeting: %s\n", greeting);
...
static int test_builtin_provider(void)
{
    ...
    OSSL_PROVIDER *prov = 
# 55 "../test/provider_internal_test.c" 3 4
                         ((void *)0)
# 55 "../test/provider_internal_test.c"
                             ;
    int ret;
...
# 63 "../test/provider_internal_test.c" 3 4
                              ((void *)0)
# 63 "../test/provider_internal_test.c"
                                  , "fips=yes");

    ret =
        test_ptr("../test/provider_internal_test.c", 66, "prov = ossl_provider_new(NULL, name, PROVIDER_INIT_FUNCTION_NAME, NULL, 0)", prov = ossl_provider_new(
# 66 "../test/provider_internal_test.c" 3 4
       ((void *)0)
# 66 "../test/provider_internal_test.c"
       , name, p_test_init, 
# 66 "../test/provider_internal_test.c" 3 4
       ((void *)0)
# 66 "../test/provider_internal_test.c"
    ...
    EVP_set_default_properties(
# 70 "../test/provider_internal_test.c" 3 4
                              ((void *)0)
# 70 "../test/provider_internal_test.c"
                                  , "");
...
static int test_loaded_provider(void)
{
    ...
    OSSL_PROVIDER *prov = 
# 79 "../test/provider_internal_test.c" 3 4
                         ((void *)0)
# 79 "../test/provider_internal_test.c"
                             ;

    return
        test_ptr("../test/provider_internal_test.c", 82, "prov = ossl_provider_new(NULL, name, NULL, NULL, 0)", prov = ossl_provider_new(
# 82 "../test/provider_internal_test.c" 3 4
       ((void *)0)
# 82 "../test/provider_internal_test.c"
       , name, 
# 82 "../test/provider_internal_test.c" 3 4
       ((void *)0)
# 82 "../test/provider_internal_test.c"
...
static int test_configured_provider(void)
{
    ...
    OSSL_PROVIDER *prov = 
# 90 "../test/provider_internal_test.c" 3 4
                         ((void *)0)
# 90 "../test/provider_internal_test.c"
                             ;
    ...
    return
        test_ptr("../test/provider_internal_test.c", 96, "prov = ossl_provider_find(NULL, name, 0)", prov = ossl_provider_find(
# 96 "../test/provider_internal_test.c" 3 4
       ((void *)0)
# 96 "../test/provider_internal_test.c"
       , name, 0))
...
static int test_cache_flushes(void)
{
    OSSL_LIB_CTX *ctx;
    OSSL_PROVIDER *prov = 
# 105 "../test/provider_internal_test.c" 3 4
                         ((void *)0)
# 105 "../test/provider_internal_test.c"
                             ;
    EVP_MD *md = 
# 106 "../test/provider_internal_test.c" 3 4
                ((void *)0)
# 106 "../test/provider_internal_test.c"
                    ;
    int ret = 0;

    if (!test_ptr("../test/provider_internal_test.c", 109, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new())
            || !test_ptr("../test/provider_internal_test.c", 110, "prov = OSSL_PROVIDER_load(ctx, \"default\")", prov = OSSL_PROVIDER_load(ctx, "default"))
            || !test_true("../test/provider_internal_test.c", 111, "OSSL_PROVIDER_available(ctx, \"default\")", (OSSL_PROVIDER_available(ctx, "default")) != 0)
            || !test_ptr("../test/provider_internal_test.c", 112, "md = EVP_MD_fetch(ctx, \"SHA256\", NULL)", md = EVP_MD_fetch(ctx, "SHA256", 
# 112 "../test/provider_internal_test.c" 3 4
               ((void *)0)
# 112 "../test/provider_internal_test.c"
               )))
        goto err;
    EVP_MD_free(md);
    md = 
# 115 "../test/provider_internal_test.c" 3 4
        ((void *)0)
# 115 "../test/provider_internal_test.c"
            ;
    OSSL_PROVIDER_unload(prov);
    prov = 
# 117 "../test/provider_internal_test.c" 3 4
          ((void *)0)
# 117 "../test/provider_internal_test.c"
              ;

    if (!test_false("../test/provider_internal_test.c", 119, "OSSL_PROVIDER_available(ctx, \"default\")", (OSSL_PROVIDER_available(ctx, "default")) != 0))
        goto err;

    if (!test_ptr_null("../test/provider_internal_test.c", 122, "md = EVP_MD_fetch(ctx, \"SHA256\", NULL)", md = EVP_MD_fetch(ctx, "SHA256", 
# 122 "../test/provider_internal_test.c" 3 4
        ((void *)0)
# 122 "../test/provider_internal_test.c"
        ))) {
        const char *provname = OSSL_PROVIDER_get0_name(EVP_MD_get0_provider(md));

        if (OSSL_PROVIDER_available(
# 125 "../test/provider_internal_test.c" 3 4
                                   ((void *)0)
# 125 "../test/provider_internal_test.c"
                                       , provname))
            test_info("../test/provider_internal_test.c", 126, "%s provider is available\n", provname);
        else
            test_info("../test/provider_internal_test.c", 128, "%s provider is not available\n", provname);
    }
...
int setup_tests(void)
{
    ...
    add_test("test_cache_flushes", test_cache_flushes);
    return 1;
}
