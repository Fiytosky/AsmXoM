# 0 "../test/provider_fallback_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_fallback_test.c"
# 10 "../test/provider_fallback_test.c"
...
# 11 "../test/provider_fallback_test.c" 2
...
# 12 "../test/provider_fallback_test.c" 2
...
# 13 "../test/provider_fallback_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 14 "../test/provider_fallback_test.c" 2

static int test_provider(OSSL_LIB_CTX *ctx)
{
    EVP_KEYMGMT *rsameth = 
# 17 "../test/provider_fallback_test.c" 3 4
                          ((void *)0)
# 17 "../test/provider_fallback_test.c"
                              ;
    const OSSL_PROVIDER *prov = 
# 18 "../test/provider_fallback_test.c" 3 4
                               ((void *)0)
# 18 "../test/provider_fallback_test.c"
                                   ;
    int ok;

    ok = test_true("../test/provider_fallback_test.c", 21, "OSSL_PROVIDER_available(ctx, \"default\")", (OSSL_PROVIDER_available(ctx, "default")) != 0)
        && test_ptr("../test/provider_fallback_test.c", 22, "rsameth = EVP_KEYMGMT_fetch(ctx, \"RSA\", NULL)", rsameth = EVP_KEYMGMT_fetch(ctx, "RSA", 
# 22 "../test/provider_fallback_test.c" 3 4
          ((void *)0)
# 22 "../test/provider_fallback_test.c"
          ))
        && test_ptr("../test/provider_fallback_test.c", 23, "prov = EVP_KEYMGMT_get0_provider(rsameth)", prov = EVP_KEYMGMT_get0_provider(rsameth))
        && test_str_eq("../test/provider_fallback_test.c", 24, "OSSL_PROVIDER_get0_name(prov)", "\"default\"", OSSL_PROVIDER_get0_name(prov), "default");
...
# 32 "../test/provider_fallback_test.c" 3 4
                        ((void *)0)
# 32 "../test/provider_fallback_test.c"
                            );
}
...
{
    OSSL_LIB_CTX *ctx = 
# 37 "../test/provider_fallback_test.c" 3 4
                       ((void *)0)
# 37 "../test/provider_fallback_test.c"
                           ;
    OSSL_PROVIDER *prov = 
# 38 "../test/provider_fallback_test.c" 3 4
                         ((void *)0)
# 38 "../test/provider_fallback_test.c"
                             ;
    int ok;

    ok = test_ptr("../test/provider_fallback_test.c", 41, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new())
        && test_ptr("../test/provider_fallback_test.c", 42, "prov = OSSL_PROVIDER_load(ctx, \"default\")", prov = OSSL_PROVIDER_load(ctx, "default"));

    if (ok) {
        ok = test_provider(ctx);
        if (ok)
            ok = test_true("../test/provider_fallback_test.c", 47, "OSSL_PROVIDER_unload(prov)", (OSSL_PROVIDER_unload(prov)) != 0);
        else
