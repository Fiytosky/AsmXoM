...
static X509 *test_root = 
# 190 "../test/crltest.c" 3 4
                        ((void *)0)
# 190 "../test/crltest.c"
                            ;
static X509 *test_leaf = 
# 191 "../test/crltest.c" 3 4
                        ((void *)0)
# 191 "../test/crltest.c"
                            ;
...
static X509_CRL *CRL_from_strings(const char **pem)
{
    ...
    if (b == 
# 214 "../test/crltest.c" 3 4
            ((void *)0)
# 214 "../test/crltest.c"
                ) {
        CRYPTO_free(p, "../test/crltest.c", 215);
        return 
# 216 "../test/crltest.c" 3 4
              ((void *)0)
# 216 "../test/crltest.c"
                  ;
    }

    crl = PEM_read_bio_X509_CRL(b, 
# 219 "../test/crltest.c" 3 4
                                  ((void *)0)
# 219 "../test/crltest.c"
                                      , 
# 219 "../test/crltest.c" 3 4
...
# 219 "../test/crltest.c"
    ...
    CRYPTO_free(p, "../test/crltest.c", 221);
    BIO_free(b);
    return crl;
}
...
static X509 *X509_from_strings(const char **pem)
{
    ...
    if (b == 
# 235 "../test/crltest.c" 3 4
            ((void *)0)
# 235 "../test/crltest.c"
                ) {
        CRYPTO_free(p, "../test/crltest.c", 236);
        return 
# 237 "../test/crltest.c" 3 4
              ((void *)0)
# 237 "../test/crltest.c"
                  ;
    }

    x = PEM_read_bio_X509(b, 
# 240 "../test/crltest.c" 3 4
                            ((void *)0)
# 240 "../test/crltest.c"
                                , 
# 240 "../test/crltest.c" 3 4
...
# 240 "../test/crltest.c"
    ...
    CRYPTO_free(p, "../test/crltest.c", 242);
    BIO_free(b);
    return x;
}
...
static int verify(X509 *leaf, X509 *root, struct stack_st_X509_CRL *crls,
                  unsigned long flags)
{
    X509_STORE_CTX *ctx = X509_STORE_CTX_new();
    X509_STORE *store = X509_STORE_new();
    X509_VERIFY_PARAM *param = X509_VERIFY_PARAM_new();
    struct stack_st_X509 *roots = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    int status = 1;

    if (!test_ptr("../test/crltest.c", 262, "ctx", ctx)
        || !test_ptr("../test/crltest.c", 263, "store", store)
        || !test_ptr("../test/crltest.c", 264, "param", param)
        || !test_ptr("../test/crltest.c", 265, "roots", roots))
        goto err;


    X509_up_ref(root);
    if (!test_true("../test/crltest.c", 270, "sk_X509_push(roots, root)", (OPENSSL_sk_push(ossl_check_X509_sk_type(roots), ossl_check_X509_type(root))) != 0)
        || !test_true("../test/crltest.c", 271, "X509_STORE_CTX_init(ctx, store, leaf, NULL)", (X509_STORE_CTX_init(ctx, store, leaf, 
# 271 "../test/crltest.c" 3 4
           ((void *)0)
# 271 "../test/crltest.c"
           )) != 0))
        goto err;
    ...
    X509_VERIFY_PARAM_set_time(param, 1474934400);
    if (!test_long_eq("../test/crltest.c", 276, "(long)X509_VERIFY_PARAM_get_time(param)", "PARAM_TIME", (long)X509_VERIFY_PARAM_get_time(param), 1474934400))
        goto err;
    ...
    param = 
# 282 "../test/crltest.c" 3 4
           ((void *)0)
# 282 "../test/crltest.c"
               ;

    ERR_clear_error();
    status = X509_verify_cert(ctx) == 1 ? 0
...
static struct stack_st_X509_CRL *make_CRL_stack(X509_CRL *x1, X509_CRL *x2)
{
    struct stack_st_X509_CRL *sk = ((struct stack_st_X509_CRL *)OPENSSL_sk_new_null());

    OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(sk), ossl_check_X509_CRL_type(x1));
    X509_CRL_up_ref(x1);
    if (x2 != 
# 307 "../test/crltest.c" 3 4
             ((void *)0)
# 307 "../test/crltest.c"
                 ) {
        OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(sk), ossl_check_X509_CRL_type(x2));
        X509_CRL_up_ref(x2);
    }
    return sk;
}
...
static int test_basic_crl(void)
{
    ...
    r = test_ptr("../test/crltest.c", 320, "basic_crl", basic_crl)
        && test_ptr("../test/crltest.c", 321, "revoked_crl", revoked_crl)
        && test_int_eq("../test/crltest.c", 322, "verify(test_leaf, test_root, make_CRL_stack(basic_crl, NULL), X509_V_FLAG_CRL_CHECK)", "X509_V_OK", verify(test_leaf, test_root, make_CRL_stack(basic_crl, 
# 322 "../test/crltest.c" 3 4
          ((void *)0)
# 322 "../test/crltest.c"
          ), 0x4), 0)


        && test_int_eq("../test/crltest.c", 325, "verify(test_leaf, test_root, make_CRL_stack(basic_crl, revoked_crl), X509_V_FLAG_CRL_CHECK)", "X509_V_ERR_CERT_REVOKED", verify(test_leaf, test_root, make_CRL_stack(basic_crl, revoked_crl), 0x4), 23)
...
{
    return test_int_eq("../test/crltest.c", 335, "verify(test_leaf, test_root, NULL, X509_V_FLAG_CRL_CHECK)", "X509_V_ERR_UNABLE_TO_GET_CRL", verify(test_leaf, test_root, 
# 335 "../test/crltest.c" 3 4
          ((void *)0)
# 335 "../test/crltest.c"
          , 0x4), 3)
...
static int test_bad_issuer_crl(void)
{
    ...
    r = test_ptr("../test/crltest.c", 345, "bad_issuer_crl", bad_issuer_crl)
        && test_int_eq("../test/crltest.c", 346, "verify(test_leaf, test_root, make_CRL_stack(bad_issuer_crl, NULL), X509_V_FLAG_CRL_CHECK)", "X509_V_ERR_UNABLE_TO_GET_CRL", verify(test_leaf, test_root, make_CRL_stack(bad_issuer_crl, 
# 346 "../test/crltest.c" 3 4
          ((void *)0)
# 346 "../test/crltest.c"
          ), 0x4), 3)
...
static int test_known_critical_crl(void)
{
    ...
    r = test_ptr("../test/crltest.c", 359, "known_critical_crl", known_critical_crl)
        && test_int_eq("../test/crltest.c", 360, "verify(test_leaf, test_root, make_CRL_stack(known_critical_crl, NULL), X509_V_FLAG_CRL_CHECK)", "X509_V_OK", verify(test_leaf, test_root, make_CRL_stack(known_critical_crl, 
# 360 "../test/crltest.c" 3 4
          ((void *)0)
# 360 "../test/crltest.c"
          ), 0x4), 0)
...
static int test_unknown_critical_crl(int n)
{
    ...
    r = test_ptr("../test/crltest.c", 372, "unknown_critical_crl", unknown_critical_crl)
        && test_int_eq("../test/crltest.c", 373, "verify(test_leaf, test_root, make_CRL_stack(unknown_critical_crl, NULL), X509_V_FLAG_CRL_CHECK)", "X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION", verify(test_leaf, test_root, make_CRL_stack(unknown_critical_crl, 
# 373 "../test/crltest.c" 3 4
          ((void *)0)
# 373 "../test/crltest.c"
          ), 0x4), 36)
...
static int test_reuse_crl(int idx)
{
    ...
    X509_CRL *addref_crl = 
# 384 "../test/crltest.c" 3 4
                          ((void *)0)
# 384 "../test/crltest.c"
                              ;
    char *p = 
# 385 "../test/crltest.c" 3 4
             ((void *)0)
# 385 "../test/crltest.c"
                 ;
    BIO *b = 
# 386 "../test/crltest.c" 3 4
            ((void *)0)
# 386 "../test/crltest.c"
                ;
    int r = 0;

    if (!test_ptr("../test/crltest.c", 389, "reused_crl", reused_crl))
        goto err;

    if (idx & 1) {
        if (!test_true("../test/crltest.c", 393, "X509_CRL_up_ref(reused_crl)", (X509_CRL_up_ref(reused_crl)) != 0))
            goto err;
 addref_crl = reused_crl;
    ...
    if (!test_ptr("../test/crltest.c", 401, "b", b))
        goto err;

    result = PEM_read_bio_X509_CRL(b, &reused_crl, 
# 404 "../test/crltest.c" 3 4
                                                  ((void *)0)
# 404 "../test/crltest.c"
                                                      , 
# 404 "../test/crltest.c" 3 4
...
# 404 "../test/crltest.c"
    ...
    switch (idx) {
    case 0:
        if (!test_ptr_null("../test/crltest.c", 408, "result", result)
                || !test_ptr_null("../test/crltest.c", 409, "reused_crl", reused_crl))
            goto err;
        break;
    case 1:
        if (!test_ptr_null("../test/crltest.c", 413, "result", result)
                || !test_ptr("../test/crltest.c", 414, "reused_crl", reused_crl))
            goto err;
        break;
    case 2:
        if (!test_ptr("../test/crltest.c", 418, "result", result)
                || !test_ptr("../test/crltest.c", 419, "reused_crl", reused_crl)
                || !test_ptr_eq("../test/crltest.c", 420, "result", "reused_crl", result, reused_crl))
            goto err;
        break;
    }
 ...
 err:
    CRYPTO_free(p, "../test/crltest.c", 428);
    BIO_free(b);
...
int setup_tests(void)
{
    if (!test_ptr("../test/crltest.c", 437, "test_root = X509_from_strings(kCRLTestRoot)", test_root = X509_from_strings(kCRLTestRoot))
        || !test_ptr("../test/crltest.c", 438, "test_leaf = X509_from_strings(kCRLTestLeaf)", test_leaf = X509_from_strings(kCRLTestLeaf)))
        return 0;
    ...
    add_all_tests("test_unknown_critical_crl", test_unknown_critical_crl, (sizeof(unknown_critical_crls)/sizeof((unknown_critical_crls)[0])), 1);
