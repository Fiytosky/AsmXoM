# 0 "../test/bio_callback_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_callback_test.c"
# 10 "../test/bio_callback_test.c"
...
# 15 "../test/bio_callback_test.c" 2


static int my_param_count;
static BIO *my_param_b[5];
static int my_param_oper[5];
static const char *my_param_argp[5];
static int my_param_argi[5];
static long my_param_argl[5];
static long my_param_ret[5];
static size_t my_param_len[5];
static size_t my_param_processed[5];
                         ...
                         int argi, long argl, int ret, size_t *processed)
{
    ...
    my_param_processed[my_param_count] = processed != 
# 39 "../test/bio_callback_test.c" 3 4
                                                     ((void *)0) 
# 39 "../test/bio_callback_test.c"
                                                          ? *processed : 0;
...
static int test_bio_callback_ex(void)
{
    ...
    if (bio == 
# 59 "../test/bio_callback_test.c" 3 4
              ((void *)0)
# 59 "../test/bio_callback_test.c"
                  )
        goto err;

    BIO_set_callback_ex(bio, my_bio_cb_ex);
    i = BIO_write(bio, test1, test1len);
    if (!test_int_eq("../test/bio_callback_test.c", 64, "i", "test1len", i, test1len)
            || !test_int_eq("../test/bio_callback_test.c", 65, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 66, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 67, "my_param_oper[0]", "BIO_CB_WRITE", my_param_oper[0], 0x03)
            || !test_ptr_eq("../test/bio_callback_test.c", 68, "my_param_argp[0]", "test1", my_param_argp[0], test1)
            || !test_size_t_eq("../test/bio_callback_test.c", 69, "my_param_len[0]", "test1len", my_param_len[0], test1len)
            || !test_long_eq("../test/bio_callback_test.c", 70, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 71, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 72, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 73, "my_param_oper[1]", "BIO_CB_WRITE | BIO_CB_RETURN", my_param_oper[1], 0x03 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 74, "my_param_argp[1]", "test1", my_param_argp[1], test1)
            || !test_size_t_eq("../test/bio_callback_test.c", 75, "my_param_len[1]", "test1len", my_param_len[1], test1len)
            || !test_long_eq("../test/bio_callback_test.c", 76, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_size_t_eq("../test/bio_callback_test.c", 77, "my_param_processed[1]", "test1len", my_param_processed[1], test1len)
            || !test_int_eq("../test/bio_callback_test.c", 78, "(int)my_param_ret[1]", "1", (int)my_param_ret[1], 1))
        goto err;

    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_mem_eq("../test/bio_callback_test.c", 83, "buf", "test1", buf, i, test1, test1len)
            || !test_int_eq("../test/bio_callback_test.c", 84, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 85, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 86, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 87, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 88, "my_param_len[0]", "sizeof(buf)", my_param_len[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 89, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 90, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 91, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 92, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 93, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 94, "my_param_len[1]", "sizeof(buf)", my_param_len[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 95, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_size_t_eq("../test/bio_callback_test.c", 96, "my_param_processed[1]", "test1len", my_param_processed[1], test1len)
            || !test_int_eq("../test/bio_callback_test.c", 97, "(int)my_param_ret[1]", "1", (int)my_param_ret[1], 1))
        goto err;


    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_int_eq("../test/bio_callback_test.c", 103, "i", "-1", i, -1)
            || !test_int_eq("../test/bio_callback_test.c", 104, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 105, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 106, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 107, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 108, "my_param_len[0]", "sizeof(buf)", my_param_len[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 109, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 110, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 111, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 112, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 113, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 114, "my_param_len[1]", "sizeof(buf)", my_param_len[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 115, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_size_t_eq("../test/bio_callback_test.c", 116, "my_param_processed[1]", "0", my_param_processed[1], 0)
            || !test_int_eq("../test/bio_callback_test.c", 117, "(int)my_param_ret[1]", "-1", (int)my_param_ret[1], -1))
        goto err;


    my_param_count = 0;
    i = BIO_ctrl(bio,130,0,
# 122 "../test/bio_callback_test.c" 3 4
       ((void *)0)
# 122 "../test/bio_callback_test.c"
       );
    if (!test_int_eq("../test/bio_callback_test.c", 123, "i", "1", i, 1)
            || !test_int_eq("../test/bio_callback_test.c", 124, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 125, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 126, "my_param_oper[0]", "BIO_CB_CTRL", my_param_oper[0], 0x06)
            || !test_ptr_eq("../test/bio_callback_test.c", 127, "my_param_argp[0]", "NULL", my_param_argp[0], 
# 127 "../test/bio_callback_test.c" 3 4
               ((void *)0)
# 127 "../test/bio_callback_test.c"
               )
            || !test_int_eq("../test/bio_callback_test.c", 128, "my_param_argi[0]", "BIO_C_SET_BUF_MEM_EOF_RETURN", my_param_argi[0], 130)
            || !test_long_eq("../test/bio_callback_test.c", 129, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 130, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 131, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 132, "my_param_oper[1]", "BIO_CB_CTRL | BIO_CB_RETURN", my_param_oper[1], 0x06 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 133, "my_param_argp[1]", "NULL", my_param_argp[1], 
# 133 "../test/bio_callback_test.c" 3 4
               ((void *)0)
# 133 "../test/bio_callback_test.c"
               )
            || !test_int_eq("../test/bio_callback_test.c", 134, "my_param_argi[1]", "BIO_C_SET_BUF_MEM_EOF_RETURN", my_param_argi[1], 130)
            || !test_long_eq("../test/bio_callback_test.c", 135, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 136, "(int)my_param_ret[1]", "1", (int)my_param_ret[1], 1))
        goto err;
    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_int_eq("../test/bio_callback_test.c", 140, "i", "0", i, 0)
            || !test_int_eq("../test/bio_callback_test.c", 141, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 142, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 143, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 144, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 145, "my_param_len[0]", "sizeof(buf)", my_param_len[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 146, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 147, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 148, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 149, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 150, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_size_t_eq("../test/bio_callback_test.c", 151, "my_param_len[1]", "sizeof(buf)", my_param_len[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 152, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_size_t_eq("../test/bio_callback_test.c", 153, "my_param_processed[1]", "0", my_param_processed[1], 0)
            || !test_int_eq("../test/bio_callback_test.c", 154, "(int)my_param_ret[1]", "0", (int)my_param_ret[1], 0))
        goto err;

    my_param_count = 0;
    i = BIO_puts(bio, test2);
    if (!test_int_eq("../test/bio_callback_test.c", 159, "i", "5", i, 5)
            || !test_int_eq("../test/bio_callback_test.c", 160, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 161, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 162, "my_param_oper[0]", "BIO_CB_PUTS", my_param_oper[0], 0x04)
            || !test_ptr_eq("../test/bio_callback_test.c", 163, "my_param_argp[0]", "test2", my_param_argp[0], test2)
            || !test_int_eq("../test/bio_callback_test.c", 164, "my_param_argi[0]", "0", my_param_argi[0], 0)
            || !test_long_eq("../test/bio_callback_test.c", 165, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 166, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 167, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 168, "my_param_oper[1]", "BIO_CB_PUTS | BIO_CB_RETURN", my_param_oper[1], 0x04 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 169, "my_param_argp[1]", "test2", my_param_argp[1], test2)
            || !test_int_eq("../test/bio_callback_test.c", 170, "my_param_argi[1]", "0", my_param_argi[1], 0)
            || !test_long_eq("../test/bio_callback_test.c", 171, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_size_t_eq("../test/bio_callback_test.c", 172, "my_param_processed[1]", "test2len", my_param_processed[1], test2len)
            || !test_int_eq("../test/bio_callback_test.c", 173, "(int)my_param_ret[1]", "1", (int)my_param_ret[1], 1))
        goto err;

    my_param_count = 0;
    i = BIO_free(bio);
    if (!test_int_eq("../test/bio_callback_test.c", 178, "i", "1", i, 1)
            || !test_int_eq("../test/bio_callback_test.c", 179, "my_param_count", "1", my_param_count, 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 180, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 181, "my_param_oper[0]", "BIO_CB_FREE", my_param_oper[0], 0x01)
            || !test_ptr_eq("../test/bio_callback_test.c", 182, "my_param_argp[0]", "NULL", my_param_argp[0], 
# 182 "../test/bio_callback_test.c" 3 4
               ((void *)0)
# 182 "../test/bio_callback_test.c"
               )
            || !test_int_eq("../test/bio_callback_test.c", 183, "my_param_argi[0]", "0", my_param_argi[0], 0)
            || !test_long_eq("../test/bio_callback_test.c", 184, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_int_eq("../test/bio_callback_test.c", 185, "(int)my_param_ret[0]", "1", (int)my_param_ret[0], 1))
        goto finish;
...
static int test_bio_callback(void)
{
    ...
    bio = BIO_new(BIO_s_mem());
    if (bio == 
# 231 "../test/bio_callback_test.c" 3 4
              ((void *)0)
# 231 "../test/bio_callback_test.c"
                  )
        goto err;

    BIO_set_callback(bio, my_bio_callback);
    i = BIO_write(bio, test1, test1len);
    if (!test_int_eq("../test/bio_callback_test.c", 236, "i", "test1len", i, test1len)
            || !test_int_eq("../test/bio_callback_test.c", 237, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 238, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 239, "my_param_oper[0]", "BIO_CB_WRITE", my_param_oper[0], 0x03)
            || !test_ptr_eq("../test/bio_callback_test.c", 240, "my_param_argp[0]", "test1", my_param_argp[0], test1)
            || !test_int_eq("../test/bio_callback_test.c", 241, "my_param_argi[0]", "test1len", my_param_argi[0], test1len)
            || !test_long_eq("../test/bio_callback_test.c", 242, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 243, "my_param_ret[0]", "1L", my_param_ret[0], 1L)
            || !test_ptr_eq("../test/bio_callback_test.c", 244, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 245, "my_param_oper[1]", "BIO_CB_WRITE | BIO_CB_RETURN", my_param_oper[1], 0x03 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 246, "my_param_argp[1]", "test1", my_param_argp[1], test1)
            || !test_int_eq("../test/bio_callback_test.c", 247, "my_param_argi[1]", "test1len", my_param_argi[1], test1len)
            || !test_long_eq("../test/bio_callback_test.c", 248, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 249, "my_param_ret[1]", "(long)test1len", my_param_ret[1], (long)test1len))
        goto err;

    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_mem_eq("../test/bio_callback_test.c", 254, "buf", "test1", buf, i, test1, test1len)
            || !test_int_eq("../test/bio_callback_test.c", 255, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 256, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 257, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 258, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_int_eq("../test/bio_callback_test.c", 259, "my_param_argi[0]", "sizeof(buf)", my_param_argi[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 260, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 261, "my_param_ret[0]", "1L", my_param_ret[0], 1L)
            || !test_ptr_eq("../test/bio_callback_test.c", 262, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 263, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 264, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_int_eq("../test/bio_callback_test.c", 265, "my_param_argi[1]", "sizeof(buf)", my_param_argi[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 266, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 267, "my_param_ret[1]", "(long)test1len", my_param_ret[1], (long)test1len))
        goto err;


    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_int_eq("../test/bio_callback_test.c", 273, "i", "-1", i, -1)
            || !test_int_eq("../test/bio_callback_test.c", 274, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 275, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 276, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 277, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_int_eq("../test/bio_callback_test.c", 278, "my_param_argi[0]", "sizeof(buf)", my_param_argi[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 279, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 280, "my_param_ret[0]", "1L", my_param_ret[0], 1L)
            || !test_ptr_eq("../test/bio_callback_test.c", 281, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 282, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 283, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_int_eq("../test/bio_callback_test.c", 284, "my_param_argi[1]", "sizeof(buf)", my_param_argi[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 285, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 286, "my_param_ret[1]", "-1L", my_param_ret[1], -1L))
        goto err;


    BIO_ctrl(bio,130,0,
# 290 "../test/bio_callback_test.c" 3 4
   ((void *)0)
# 290 "../test/bio_callback_test.c"
   );
    my_param_count = 0;
    i = BIO_read(bio, buf, sizeof(buf));
    if (!test_int_eq("../test/bio_callback_test.c", 293, "i", "0", i, 0)
            || !test_int_eq("../test/bio_callback_test.c", 294, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 295, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 296, "my_param_oper[0]", "BIO_CB_READ", my_param_oper[0], 0x02)
            || !test_ptr_eq("../test/bio_callback_test.c", 297, "my_param_argp[0]", "buf", my_param_argp[0], buf)
            || !test_int_eq("../test/bio_callback_test.c", 298, "my_param_argi[0]", "sizeof(buf)", my_param_argi[0], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 299, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 300, "my_param_ret[0]", "1L", my_param_ret[0], 1L)
            || !test_ptr_eq("../test/bio_callback_test.c", 301, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 302, "my_param_oper[1]", "BIO_CB_READ | BIO_CB_RETURN", my_param_oper[1], 0x02 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 303, "my_param_argp[1]", "buf", my_param_argp[1], buf)
            || !test_int_eq("../test/bio_callback_test.c", 304, "my_param_argi[1]", "sizeof(buf)", my_param_argi[1], sizeof(buf))
            || !test_long_eq("../test/bio_callback_test.c", 305, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 306, "my_param_ret[1]", "0L", my_param_ret[1], 0L))
        goto err;

    my_param_count = 0;
    i = BIO_puts(bio, test2);
    if (!test_int_eq("../test/bio_callback_test.c", 311, "i", "5", i, 5)
            || !test_int_eq("../test/bio_callback_test.c", 312, "my_param_count", "2", my_param_count, 2)
            || !test_ptr_eq("../test/bio_callback_test.c", 313, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 314, "my_param_oper[0]", "BIO_CB_PUTS", my_param_oper[0], 0x04)
            || !test_ptr_eq("../test/bio_callback_test.c", 315, "my_param_argp[0]", "test2", my_param_argp[0], test2)
            || !test_int_eq("../test/bio_callback_test.c", 316, "my_param_argi[0]", "0", my_param_argi[0], 0)
            || !test_long_eq("../test/bio_callback_test.c", 317, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 318, "my_param_ret[0]", "1L", my_param_ret[0], 1L)
            || !test_ptr_eq("../test/bio_callback_test.c", 319, "my_param_b[1]", "bio", my_param_b[1], bio)
            || !test_int_eq("../test/bio_callback_test.c", 320, "my_param_oper[1]", "BIO_CB_PUTS | BIO_CB_RETURN", my_param_oper[1], 0x04 | 0x80)
            || !test_ptr_eq("../test/bio_callback_test.c", 321, "my_param_argp[1]", "test2", my_param_argp[1], test2)
            || !test_int_eq("../test/bio_callback_test.c", 322, "my_param_argi[1]", "0", my_param_argi[1], 0)
            || !test_long_eq("../test/bio_callback_test.c", 323, "my_param_argl[1]", "0L", my_param_argl[1], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 324, "my_param_ret[1]", "(long)test2len", my_param_ret[1], (long)test2len))
        goto err;

    my_param_count = 0;
    i = BIO_free(bio);
    if (!test_int_eq("../test/bio_callback_test.c", 329, "i", "1", i, 1)
            || !test_int_eq("../test/bio_callback_test.c", 330, "my_param_count", "1", my_param_count, 1)
            || !test_ptr_eq("../test/bio_callback_test.c", 331, "my_param_b[0]", "bio", my_param_b[0], bio)
            || !test_int_eq("../test/bio_callback_test.c", 332, "my_param_oper[0]", "BIO_CB_FREE", my_param_oper[0], 0x01)
            || !test_ptr_eq("../test/bio_callback_test.c", 333, "my_param_argp[0]", "NULL", my_param_argp[0], 
# 333 "../test/bio_callback_test.c" 3 4
               ((void *)0)
# 333 "../test/bio_callback_test.c"
               )
            || !test_int_eq("../test/bio_callback_test.c", 334, "my_param_argi[0]", "0", my_param_argi[0], 0)
            || !test_long_eq("../test/bio_callback_test.c", 335, "my_param_argl[0]", "0L", my_param_argl[0], 0L)
            || !test_long_eq("../test/bio_callback_test.c", 336, "my_param_ret[0]", "1L", my_param_ret[0], 1L))
        goto finish;
