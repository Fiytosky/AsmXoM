# 0 "../test/threadstest_fips.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/threadstest_fips.c"
# 14 "../test/threadstest_fips.c"
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
static void thread_fips_rand_fetch(void)
{
    ...
    if (!test_true("../test/threadstest_fips.c", 23, "md = EVP_MD_fetch(NULL, \"SHA2-256\", NULL)", (md = EVP_MD_fetch(
# 23 "../test/threadstest_fips.c" 3 4
        ((void *)0)
# 23 "../test/threadstest_fips.c"
        , "SHA2-256", 
# 23 "../test/threadstest_fips.c" 3 4
        ((void *)0)
# 23 "../test/threadstest_fips.c"
...
static int test_fips_rand_leak(void)
{
    ...
    if (!test_true("../test/threadstest_fips.c", 34, "run_thread(&thread, thread_fips_rand_fetch)", (run_thread(&thread, thread_fips_rand_fetch)) != 0))
        return 0;
    if (!test_true("../test/threadstest_fips.c", 36, "wait_for_thread(thread)", (wait_for_thread(thread)) != 0))
        return 0;
    return test_true("../test/threadstest_fips.c", 38, "success", (success) != 0);
}
