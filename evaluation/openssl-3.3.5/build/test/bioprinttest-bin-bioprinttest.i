...
static z_data zu_data[] = {
    { 
# 124 "../test/bioprinttest.c" 3 4
     (18446744073709551615UL)
# 124 "../test/bioprinttest.c"
    ...
    { 
# 131 "../test/bioprinttest.c" 3 4
     (18446744073709551615UL) 
# 131 "../test/bioprinttest.c"
              / 2 + 1, "%zi", (sizeof(size_t) == 4 ? "-2147483648"
...
static int test_zu(int i)
{
    ...
    if (!test_str_eq("../test/bioprinttest.c", 144, "bio_buf", "data->expected", bio_buf, data->expected))
        return 0;
    return 1;
}
...
static int test_j(int i)
{
    ...
    BIO_snprintf(bio_buf, sizeof(bio_buf) - 1, data->format, data->value);
    if (!test_str_eq("../test/bioprinttest.c", 172, "bio_buf", "data->expected", bio_buf, data->expected))
        return 0;
    return 1;
}
...
static int dofptest(int test, int sub, double val, const char *width, int prec)
{
    ...
    for (i = 0; i < (int)(sizeof(fspecs) / sizeof((fspecs)[0])); i++) {
        ...
        if (justprint) {
            if (i == 0)
                ...
                printf(", \"%s\"", result);
        } else if (!test_str_eq("../test/bioprinttest.c", 217, "fpexpected[test][sub][i]", "result", fpexpected[test][sub][i], result)) {
            test_info("../test/bioprinttest.c", 218, "test %d format=|%s| exp=|%s|, ret=|%s|", test, format, fpexpected[test][sub][i], result)
                                                                   ;
            ret = 0;
        }
    }
...
static int test_fp(int i)
{
    ...
    if (justprint)
        printf("    {\n");
    r = test_true("../test/bioprinttest.c", 236, "dofptest(i, t++, 0.0, pwp->w, pwp->p)", (dofptest(i, t++, 0.0, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 237, "dofptest(i, t++, 0.67, pwp->w, pwp->p)", (dofptest(i, t++, 0.67, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 238, "dofptest(i, t++, frac, pwp->w, pwp->p)", (dofptest(i, t++, frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 239, "dofptest(i, t++, frac / 1000, pwp->w, pwp->p)", (dofptest(i, t++, frac / 1000, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 240, "dofptest(i, t++, frac / 10000, pwp->w, pwp->p)", (dofptest(i, t++, frac / 10000, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 241, "dofptest(i, t++, 6.0 + frac, pwp->w, pwp->p)", (dofptest(i, t++, 6.0 + frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 242, "dofptest(i, t++, 66.0 + frac, pwp->w, pwp->p)", (dofptest(i, t++, 66.0 + frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 243, "dofptest(i, t++, 666.0 + frac, pwp->w, pwp->p)", (dofptest(i, t++, 666.0 + frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 244, "dofptest(i, t++, 6666.0 + frac, pwp->w, pwp->p)", (dofptest(i, t++, 6666.0 + frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 245, "dofptest(i, t++, 66666.0 + frac, pwp->w, pwp->p)", (dofptest(i, t++, 66666.0 + frac, pwp->w, pwp->p)) != 0)
        && test_true("../test/bioprinttest.c", 246, "dofptest(i, t++, -66666.0 - frac, pwp->w, pwp->p)", (dofptest(i, t++, -66666.0 - frac, pwp->w, pwp->p)) != 0);
    if (justprint)
        printf("    },\n");
    return r;
}
...
static int test_big(void)
{
    ...
    if (!test_int_eq("../test/bioprinttest.c", 257, "BIO_snprintf(buf, sizeof(buf), \"%f\\n\", 2 * (double)ULONG_MAX)", "-1", BIO_snprintf(buf, sizeof(buf), "%f\n", 2 * (double)
# 257 "../test/bioprinttest.c" 3 4
        (0x7fffffffffffffffL * 2UL + 1UL)
# 257 "../test/bioprinttest.c"
        ), -1)
                                                                     )
        return 0;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 276 "../test/bioprinttest.c" 3 4
         ((void *)0) 
# 276 "../test/bioprinttest.c"
              }
    };
    return options;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_fp", test_fp, (int)(sizeof(pw_params) / sizeof((pw_params)[0])), 1);
    add_all_tests("test_zu", test_zu, (int)(sizeof(zu_data) / sizeof((zu_data)[0])), 1);
    add_all_tests("test_j", test_j, (int)(sizeof(jf_data) / sizeof((jf_data)[0])), 1);
    return 1;
}
...
BIO *bio_out = 
# 308 "../test/bioprinttest.c" 3 4
              ((void *)0)
# 308 "../test/bioprinttest.c"
                  ;
BIO *bio_err = 
# 309 "../test/bioprinttest.c" 3 4
              ((void *)0)
# 309 "../test/bioprinttest.c"
                  ;
...
{
    return fprintf(
# 333 "../test/bioprinttest.c" 3 4
                  stdout
# 333 "../test/bioprinttest.c"
                        , "%*s# ", tap_level, "") + vfprintf(
# 333 "../test/bioprinttest.c" 3 4
                                                             stdout
# 333 "../test/bioprinttest.c"
                                                                   , fmt, ap);
...
{
    return fprintf(
# 338 "../test/bioprinttest.c" 3 4
                  stderr
# 338 "../test/bioprinttest.c"
                        , "%*s# ", tap_level, "") + vfprintf(
# 338 "../test/bioprinttest.c" 3 4
                                                             stderr
# 338 "../test/bioprinttest.c"
...
{
    return fflush(
# 343 "../test/bioprinttest.c" 3 4
                 stdout
# 343 "../test/bioprinttest.c"
                       );
}
...
{
    return fflush(
# 348 "../test/bioprinttest.c" 3 4
                 stderr
# 348 "../test/bioprinttest.c"
                       );
}
...
{
    return fprintf(
# 353 "../test/bioprinttest.c" 3 4
                  stdout
# 353 "../test/bioprinttest.c"
                        , "%*s", tap_level, "") + vfprintf(
# 353 "../test/bioprinttest.c" 3 4
                                                           stdout
# 353 "../test/bioprinttest.c"
...
{
    return fprintf(
# 358 "../test/bioprinttest.c" 3 4
                  stderr
# 358 "../test/bioprinttest.c"
                        , "%*s", tap_level, "") + vfprintf(
# 358 "../test/bioprinttest.c" 3 4
                                                           stderr
# 358 "../test/bioprinttest.c"
...
{
    return fflush(
# 363 "../test/bioprinttest.c" 3 4
                 stdout
# 363 "../test/bioprinttest.c"
                       );
}
...
{
    return fflush(
# 368 "../test/bioprinttest.c" 3 4
                 stderr
# 368 "../test/bioprinttest.c"
                       );
}
