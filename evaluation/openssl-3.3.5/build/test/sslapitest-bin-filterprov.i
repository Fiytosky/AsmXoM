...
# 20 "../test/filterprov.c" 2
# 1 "../test/filterprov.h" 1
# 12 "../test/filterprov.h"
                           ...
                           const OSSL_ALGORITHM *algs)
{
    ...
    if (!test_ulong_gt("../test/filterprov.c", 103, "globs->query_count", "0", globs->query_count, 0))
        globs->error = 1;
    else
        globs->query_count--;
...
static const OSSL_DISPATCH filter_dispatch_table[] = {
    { 1025, (void (*)(void))filter_gettable_params },
    { 1026, (void (*)(void))filter_get_params },
    { 1027, (void (*)(void))filter_query },
    { 1028, (void (*)(void))filter_unquery },
    { 1030, (void (*)(void))filter_get_capabilities },
    { 1024, (void (*)(void))filter_teardown },
    { 0, 
# 131 "../test/filterprov.c" 3 4
   ((void *)0) 
# 131 "../test/filterprov.c"
   }
};
                         ...
                         void **provctx)
{
    ...
    if (ourglobals.libctx == 
# 141 "../test/filterprov.c" 3 4
                            ((void *)0)
# 141 "../test/filterprov.c"
                                )
        goto err;

    ourglobals.deflt = OSSL_PROVIDER_load(ourglobals.libctx, "default");
    if (ourglobals.deflt == 
# 145 "../test/filterprov.c" 3 4
                           ((void *)0)
# 145 "../test/filterprov.c"
                               )
        goto err;
...
int filter_provider_set_filter(int operation, const char *filterstr)
{
    ...
    struct filter_prov_globals_st *globs = get_globals();
    size_t namelen;
    char *filterstrtmp = CRYPTO_strdup(filterstr, "../test/filterprov.c", 170);
    char *name, *sep;
    ...
    if (filterstrtmp == 
# 177 "../test/filterprov.c" 3 4
                       ((void *)0)
# 177 "../test/filterprov.c"
                           )
        goto err;


    if (provalgs == 
# 181 "../test/filterprov.c" 3 4
                   ((void *)0)
# 181 "../test/filterprov.c"
                       )
        goto err;

    if (globs->num_dispatch >= 10)
        goto err;

    for (name = filterstrtmp; !last; name = (sep == 
# 187 "../test/filterprov.c" 3 4
                                                   ((void *)0) 
# 187 "../test/filterprov.c"
                                                        ? 
# 187 "../test/filterprov.c" 3 4
                                                          ((void *)0) 
# 187 "../test/filterprov.c"
        ...
        sep = strstr(name, ":");
        if (sep != 
# 189 "../test/filterprov.c" 3 4
                  ((void *)0)
# 189 "../test/filterprov.c"
                      )
            *sep = '\0';
        else
            last = 1;
        ...
        for (algs = provalgs; algs->algorithm_names != 
# 195 "../test/filterprov.c" 3 4
                                                      ((void *)0)
# 195 "../test/filterprov.c"
                                                          ; algs++) {
            const char *found = strstr(algs->algorithm_names, name);

            if (found == 
# 198 "../test/filterprov.c" 3 4
                        ((void *)0)
# 198 "../test/filterprov.c"
                            )
                continue;
        ...
        if (algs->algorithm_names == 
# 212 "../test/filterprov.c" 3 4
                                    ((void *)0)
# 212 "../test/filterprov.c"
                                        ) {
 ...
 err:
    ...
    CRYPTO_free(filterstrtmp, "../test/filterprov.c", 225);
    return ret;
}
...
int filter_provider_check_clean_finish(void)
{
    ...
    return test_ulong_eq("../test/filterprov.c", 237, "globs->query_count", "0", globs->query_count, 0) && !globs->error;
}
