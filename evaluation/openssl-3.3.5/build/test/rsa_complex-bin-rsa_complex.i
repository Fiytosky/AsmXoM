# 0 "../test/rsa_complex.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rsa_complex.c"
# 21 "../test/rsa_complex.c"
...
int main(int argc, char *argv[])
{
    ...
    return 
# 31 "../test/rsa_complex.c" 3 4
          0
# 31 "../test/rsa_complex.c"
                      ;
}
