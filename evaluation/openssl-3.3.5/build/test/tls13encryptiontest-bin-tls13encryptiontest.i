# 0 "../test/tls13encryptiontest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/tls13encryptiontest.c"
# 10 "../test/tls13encryptiontest.c"
...
# 11 "../test/tls13encryptiontest.c" 2
...
# 13 "../test/tls13encryptiontest.c" 2
# 1 "../test/../ssl/record/record_local.h" 1
# 14 "../test/tls13encryptiontest.c" 2
...
# 16 "../test/tls13encryptiontest.c" 2
...
# 18 "../test/tls13encryptiontest.c" 2
...
static unsigned char *multihexstr2buf(const char *str[3], size_t *len)
{
    ...
    for (outer = 0; outer < 3; outer++) {
        ...
        if ((totlen & 1) != 0)
            return 
# 214 "../test/tls13encryptiontest.c" 3 4
                  ((void *)0)
# 214 "../test/tls13encryptiontest.c"
                      ;
    }

    totlen /= 2;
    outbuf = CRYPTO_malloc(totlen, "../test/tls13encryptiontest.c", 218);
    if (outbuf == 
# 219 "../test/tls13encryptiontest.c" 3 4
                 ((void *)0)
# 219 "../test/tls13encryptiontest.c"
                     )
        return 
# 220 "../test/tls13encryptiontest.c" 3 4
              ((void *)0)
# 220 "../test/tls13encryptiontest.c"
                  ;
    ...
    for (outer = 0; outer < 3; outer++) {
        for (inner = 0; str[outer][inner] != 0; inner += 2) {
            ...
            if (hi < 0 || lo < 0) {
                CRYPTO_free(outbuf, "../test/tls13encryptiontest.c", 230);
                return 
# 231 "../test/tls13encryptiontest.c" 3 4
                      ((void *)0)
# 231 "../test/tls13encryptiontest.c"
                          ;
            }
            outbuf[curr++] = (hi << 4) | lo;
        }
...
{
    unsigned char *pt = 
# 245 "../test/tls13encryptiontest.c" 3 4
                       ((void *)0)
# 245 "../test/tls13encryptiontest.c"
                           , *sq = 
# 245 "../test/tls13encryptiontest.c" 3 4
                                   ((void *)0)
# 245 "../test/tls13encryptiontest.c"
...
# 245 "../test/tls13encryptiontest.c"
    ...
    *key = OPENSSL_hexstr2buf(recd->key, 
# 248 "../test/tls13encryptiontest.c" 3 4
                                        ((void *)0)
# 248 "../test/tls13encryptiontest.c"
                                            );
    ivtmp = OPENSSL_hexstr2buf(recd->iv, 
# 249 "../test/tls13encryptiontest.c" 3 4
                                        ((void *)0)
# 249 "../test/tls13encryptiontest.c"
                                            );
    sq = OPENSSL_hexstr2buf(recd->seq, 
# 250 "../test/tls13encryptiontest.c" 3 4
                                      ((void *)0)
# 250 "../test/tls13encryptiontest.c"
                                          );
    pt = multihexstr2buf(recd->plaintext, &ptlen);

    if (*key == 
# 253 "../test/tls13encryptiontest.c" 3 4
               ((void *)0) 
# 253 "../test/tls13encryptiontest.c"
                    || ivtmp == 
# 253 "../test/tls13encryptiontest.c" 3 4
                                ((void *)0) 
# 253 "../test/tls13encryptiontest.c"
...
# 253 "../test/tls13encryptiontest.c"
    ...
    rec->data = rec->input = CRYPTO_malloc(ptlen + 16, "../test/tls13encryptiontest.c", 256);

    if (rec->data == 
# 258 "../test/tls13encryptiontest.c" 3 4
                    ((void *)0)
# 258 "../test/tls13encryptiontest.c"
                        )
        goto err;

    rec->length = ptlen;
    memcpy(rec->data, pt, ptlen);
    CRYPTO_free(pt, "../test/tls13encryptiontest.c", 263);
    memcpy(seq, sq, 8);
    CRYPTO_free(sq, "../test/tls13encryptiontest.c", 265);
    memcpy(iv, ivtmp, ivlen);
    CRYPTO_free(ivtmp, "../test/tls13encryptiontest.c", 267);

    return 1;
 err:
    CRYPTO_free(*key, "../test/tls13encryptiontest.c", 271);
    *key = 
# 272 "../test/tls13encryptiontest.c" 3 4
          ((void *)0)
# 272 "../test/tls13encryptiontest.c"
              ;
    CRYPTO_free(ivtmp, "../test/tls13encryptiontest.c", 273);
    CRYPTO_free(sq, "../test/tls13encryptiontest.c", 274);
    CRYPTO_free(pt, "../test/tls13encryptiontest.c", 275);
    return 0;
}
...
static int test_record(TLS_RL_RECORD *rec, RECORD_DATA *recd, int enc)
{
    ...
    if (!test_ptr("../test/tls13encryptiontest.c", 290, "refd", refd)) {
        test_info("../test/tls13encryptiontest.c", 291, "Failed to get reference data");
        goto err;
    }

    if (!test_mem_eq("../test/tls13encryptiontest.c", 295, "rec->data", "refd", rec->data, rec->length, refd, refdatalen))
        goto err;

    ret = 1;

 err:
    CRYPTO_free(refd, "../test/tls13encryptiontest.c", 301);
    return ret;
}
...
static int test_tls13_encryption(void)
{
    TLS_RL_RECORD rec;
    unsigned char *key = 
# 310 "../test/tls13encryptiontest.c" 3 4
                        ((void *)0)
# 310 "../test/tls13encryptiontest.c"
                            ;
    ...
    unsigned char iv[16];
    OSSL_RECORD_LAYER *rrl = 
# 316 "../test/tls13encryptiontest.c" 3 4
                            ((void *)0)
# 316 "../test/tls13encryptiontest.c"
                                , *wrl = 
# 316 "../test/tls13encryptiontest.c" 3 4
                                         ((void *)0)
# 316 "../test/tls13encryptiontest.c"
    ...
    rec.data = 
# 322 "../test/tls13encryptiontest.c" 3 4
              ((void *)0)
# 322 "../test/tls13encryptiontest.c"
                  ;
    rec.type = 23;
    rec.rec_version = 0x0303;

    for (ctr = 0; ctr < (sizeof(refdata)/sizeof((refdata)[0])); ctr++) {

        ivlen = EVP_CIPHER_get_iv_length(ciph);
        if (!load_record(&rec, &refdata[ctr], &key, iv, ivlen, seqbuf)) {
            test_error("../test/tls13encryptiontest.c", 330, "Failed loading key into EVP_CIPHER_CTX");
            goto err;
        }


        if (!test_true("../test/tls13encryptiontest.c", 335, "ossl_tls_record_method.new_record_layer( NULL, NULL, TLS1_3_VERSION, OSSL_RECORD_ROLE_SERVER, OSSL_RECORD_DIRECTION_WRITE, OSSL_RECORD_PROTECTION_LEVEL_APPLICATION, 0, NULL, 0, key, 16, iv, ivlen, NULL, 0, EVP_aes_128_gcm(), EVP_GCM_TLS_TAG_LEN, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, &wrl)", (ossl_tls_record_method.new_record_layer( 
# 335 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 335 "../test/tls13encryptiontest.c"
            , 
# 335 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 335 "../test/tls13encryptiontest.c"
...
# 335 "../test/tls13encryptiontest.c"
        ...
        if (!test_size_t_eq("../test/tls13encryptiontest.c", 347, "wrl->funcs->cipher(wrl, &rec, 1, 1, NULL, 0)", "1", wrl->funcs->cipher(wrl, &rec, 1, 1, 
# 347 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 347 "../test/tls13encryptiontest.c"
            , 0), 1)) {
            test_info("../test/tls13encryptiontest.c", 348, "Failed to encrypt record %zu", ctr);
            goto err;
        }

        if (!test_true("../test/tls13encryptiontest.c", 352, "test_record(&rec, &refdata[ctr], 1)", (test_record(&rec, &refdata[ctr], 1)) != 0)) {
            test_info("../test/tls13encryptiontest.c", 353, "Record %zu encryption test failed", ctr);
            goto err;
        }


        if (!test_true("../test/tls13encryptiontest.c", 358, "ossl_tls_record_method.new_record_layer( NULL, NULL, TLS1_3_VERSION, OSSL_RECORD_ROLE_SERVER, OSSL_RECORD_DIRECTION_READ, OSSL_RECORD_PROTECTION_LEVEL_APPLICATION, 0, NULL, 0, key, 16, iv, ivlen, NULL, 0, EVP_aes_128_gcm(), EVP_GCM_TLS_TAG_LEN, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, &rrl)", (ossl_tls_record_method.new_record_layer( 
# 358 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 358 "../test/tls13encryptiontest.c"
            , 
# 358 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 358 "../test/tls13encryptiontest.c"
...
# 358 "../test/tls13encryptiontest.c"
        ...
        if (!test_int_eq("../test/tls13encryptiontest.c", 370, "rrl->funcs->cipher(rrl, &rec, 1, 0, NULL, 0)", "1", rrl->funcs->cipher(rrl, &rec, 1, 0, 
# 370 "../test/tls13encryptiontest.c" 3 4
            ((void *)0)
# 370 "../test/tls13encryptiontest.c"
            , 0), 1)) {
            test_info("../test/tls13encryptiontest.c", 371, "Failed to decrypt record %zu", ctr);
            goto err;
        }

        if (!test_true("../test/tls13encryptiontest.c", 375, "test_record(&rec, &refdata[ctr], 0)", (test_record(&rec, &refdata[ctr], 0)) != 0)) {
            test_info("../test/tls13encryptiontest.c", 376, "Record %zu decryption test failed", ctr);
            goto err;
        }
        ...
        rrl = wrl = 
# 382 "../test/tls13encryptiontest.c" 3 4
                   ((void *)0)
# 382 "../test/tls13encryptiontest.c"
                       ;
        CRYPTO_free(rec.data, "../test/tls13encryptiontest.c", 383);
        CRYPTO_free(key, "../test/tls13encryptiontest.c", 384);
        rec.data = 
# 385 "../test/tls13encryptiontest.c" 3 4
                  ((void *)0)
# 385 "../test/tls13encryptiontest.c"
                      ;
        key = 
# 386 "../test/tls13encryptiontest.c" 3 4
             ((void *)0)
# 386 "../test/tls13encryptiontest.c"
                 ;
    }
 ...
 err:
    ossl_tls_record_method.free(rrl);
    ossl_tls_record_method.free(wrl);
    CRYPTO_free(rec.data, "../test/tls13encryptiontest.c", 395);
    CRYPTO_free(key, "../test/tls13encryptiontest.c", 396);
    return ret;
}
