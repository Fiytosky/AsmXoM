# 0 "../test/provider_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provider_test.c"
# 10 "../test/provider_test.c"
...
# 14 "../test/provider_test.c" 2

extern OSSL_provider_init_fn p_test_init;

static char buf[256];
static OSSL_PARAM greeting_request[] = {
    { "greeting", 4, buf, sizeof(buf) },
    { 
# 20 "../test/provider_test.c" 3 4
     ((void *)0)
# 20 "../test/provider_test.c"
         , 0, 
# 20 "../test/provider_test.c" 3 4
              ((void *)0)
# 20 "../test/provider_test.c"
...
static OSSL_PARAM digest_check[] = {
    { "digest-check", 2, &digestsuccess,
      sizeof(digestsuccess) },
    { 
# 27 "../test/provider_test.c" 3 4
     ((void *)0)
# 27 "../test/provider_test.c"
         , 0, 
# 27 "../test/provider_test.c" 3 4
              ((void *)0)
# 27 "../test/provider_test.c"
...
static OSSL_PARAM stop_property_mirror[] = {
    { "stop-property-mirror", 2, &stopsuccess,
      sizeof(stopsuccess) },
    { 
# 34 "../test/provider_test.c" 3 4
     ((void *)0)
# 34 "../test/provider_test.c"
         , 0, 
# 34 "../test/provider_test.c" 3 4
              ((void *)0)
# 34 "../test/provider_test.c"
...
{
    OSSL_PROVIDER *prov = 
# 40 "../test/provider_test.c" 3 4
                         ((void *)0)
# 40 "../test/provider_test.c"
                             ;
    const char *greeting = 
# 41 "../test/provider_test.c" 3 4
                          ((void *)0)
# 41 "../test/provider_test.c"
                              ;
    char expected_greeting[256];
    int ok = 0;
    long err;
    int dolegacycheck = (legacy != 
# 45 "../test/provider_test.c" 3 4
                                  ((void *)0)
# 45 "../test/provider_test.c"
                                      );
    OSSL_PROVIDER *deflt = 
# 46 "../test/provider_test.c" 3 4
                          ((void *)0)
# 46 "../test/provider_test.c"
                              , *base = 
# 46 "../test/provider_test.c" 3 4
                                        ((void *)0)
# 46 "../test/provider_test.c"
    ...
    if (!test_ptr("../test/provider_test.c", 63, "base = OSSL_PROVIDER_load(*libctx, \"base\")", base = OSSL_PROVIDER_load(*libctx, "base")))
        goto err;
    if (!test_ptr("../test/provider_test.c", 65, "prov = OSSL_PROVIDER_load(*libctx, name)", prov = OSSL_PROVIDER_load(*libctx, name)))
        goto err;
    ...
    if (dolegacycheck) {
        if (!test_true("../test/provider_test.c", 74, "OSSL_PROVIDER_get_params(prov, digest_check)", (OSSL_PROVIDER_get_params(prov, digest_check)) != 0)
                || !test_true("../test/provider_test.c", 75, "digestsuccess", (digestsuccess) != 0))
            goto err;
        ...
        if (!test_true("../test/provider_test.c", 82, "OSSL_PROVIDER_get_params(prov, stop_property_mirror)", (OSSL_PROVIDER_get_params(prov, stop_property_mirror)) != 0)
                || !test_true("../test/provider_test.c", 83, "stopsuccess", (stopsuccess) != 0))
            goto err;
        EVP_set_default_properties(*libctx, "fips=yes");
        if (!test_true("../test/provider_test.c", 86, "OSSL_PROVIDER_get_params(prov, digest_check)", (OSSL_PROVIDER_get_params(prov, digest_check)) != 0)
                || !test_true("../test/provider_test.c", 87, "digestsuccess", (digestsuccess) != 0))
            goto err;
        EVP_set_default_properties(*libctx, "");
    }
    if (!test_true("../test/provider_test.c", 91, "OSSL_PROVIDER_get_params(prov, greeting_request)", (OSSL_PROVIDER_get_params(prov, greeting_request)) != 0)
            || !test_ptr("../test/provider_test.c", 92, "greeting = greeting_request[0].data", greeting = greeting_request[0].data)
            || !test_size_t_gt("../test/provider_test.c", 93, "greeting_request[0].data_size", "0", greeting_request[0].data_size, 0)
            || !test_str_eq("../test/provider_test.c", 94, "greeting", "expected_greeting", greeting, expected_greeting))
        goto err;


    err = ERR_peek_last_error();
    if (!test_int_gt("../test/provider_test.c", 99, "err", "0", err, 0)
            || !test_int_eq("../test/provider_test.c", 100, "ERR_GET_REASON(err)", "1", ERR_GET_REASON(err), 1))
        goto err;

    OSSL_PROVIDER_unload(legacy);
    legacy = 
# 104 "../test/provider_test.c" 3 4
            ((void *)0)
# 104 "../test/provider_test.c"
                ;

    if (dolegacycheck) {

        if (!test_true("../test/provider_test.c", 108, "OSSL_PROVIDER_get_params(prov, digest_check)", (OSSL_PROVIDER_get_params(prov, digest_check)) != 0)
                || !test_false("../test/provider_test.c", 109, "digestsuccess", (digestsuccess) != 0))
            goto err;
        ...
        if (!test_ptr("../test/provider_test.c", 119, "deflt", deflt)
                || !test_true("../test/provider_test.c", 120, "OSSL_PROVIDER_available(*libctx, \"default\")", (OSSL_PROVIDER_available(*libctx, "default")) != 0))
            goto err;
        OSSL_PROVIDER_unload(deflt);
        deflt = 
# 123 "../test/provider_test.c" 3 4
               ((void *)0)
# 123 "../test/provider_test.c"
                   ;
        if (!test_ptr("../test/provider_test.c", 124, "legacy", legacy)
                || !test_false("../test/provider_test.c", 125, "OSSL_PROVIDER_available(*libctx, \"default\")", (OSSL_PROVIDER_available(*libctx, "default")) != 0)
                || !test_true("../test/provider_test.c", 126, "OSSL_PROVIDER_get_params(prov, digest_check)", (OSSL_PROVIDER_get_params(prov, digest_check)) != 0)
                || !test_true("../test/provider_test.c", 127, "digestsuccess", (digestsuccess) != 0))
        goto err;
        OSSL_PROVIDER_unload(legacy);
        legacy = 
# 130 "../test/provider_test.c" 3 4
                ((void *)0)
# 130 "../test/provider_test.c"
                    ;
    }

    if (!test_true("../test/provider_test.c", 133, "OSSL_PROVIDER_unload(base)", (OSSL_PROVIDER_unload(base)) != 0))
        goto err;
    base = 
# 135 "../test/provider_test.c" 3 4
          ((void *)0)
# 135 "../test/provider_test.c"
              ;
    if (!test_true("../test/provider_test.c", 136, "OSSL_PROVIDER_unload(prov)", (OSSL_PROVIDER_unload(prov)) != 0))
        goto err;
    prov = 
# 138 "../test/provider_test.c" 3 4
          ((void *)0)
# 138 "../test/provider_test.c"
              ;
    ...
    *libctx = 
# 145 "../test/provider_test.c" 3 4
             ((void *)0)
# 145 "../test/provider_test.c"
                 ;


    ERR_print_errors_fp(
# 148 "../test/provider_test.c" 3 4
                       stderr
# 148 "../test/provider_test.c"
                             );
    ok = 1;
 err:
    ...
    OSSL_PROVIDER_unload(legacy);
    legacy = 
# 154 "../test/provider_test.c" 3 4
            ((void *)0)
# 154 "../test/provider_test.c"
                ;
    OSSL_PROVIDER_unload(prov);
    OSSL_LIB_CTX_free(*libctx);
    *libctx = 
# 157 "../test/provider_test.c" 3 4
             ((void *)0)
# 157 "../test/provider_test.c"
                 ;
    return ok;
}
...
{
    OSSL_PROVIDER *prov = 
# 164 "../test/provider_test.c" 3 4
                         ((void *)0)
# 164 "../test/provider_test.c"
                             ;
    const char *greeting = 
# 165 "../test/provider_test.c" 3 4
                          ((void *)0)
# 165 "../test/provider_test.c"
                              ;
    int ok = 0;
    long err;
    const char custom_buf[] = "Custom greeting";
    OSSL_PARAM_BLD *bld = 
# 169 "../test/provider_test.c" 3 4
                         ((void *)0)
# 169 "../test/provider_test.c"
                             ;
    OSSL_PARAM *params = 
# 170 "../test/provider_test.c" 3 4
                        ((void *)0)
# 170 "../test/provider_test.c"
                            ;

    if (!test_ptr("../test/provider_test.c", 172, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new())
        || !test_true("../test/provider_test.c", 173, "OSSL_PARAM_BLD_push_utf8_string(bld, \"greeting\", custom_buf, strlen(custom_buf))", (OSSL_PARAM_BLD_push_utf8_string(bld, "greeting", custom_buf, strlen(custom_buf))) != 0)

        || !test_ptr("../test/provider_test.c", 175, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))) {
        goto err;
    }

    if (!test_ptr("../test/provider_test.c", 179, "prov = OSSL_PROVIDER_load_ex(*libctx, name, params)", prov = OSSL_PROVIDER_load_ex(*libctx, name, params)))
        goto err;

    if (!test_true("../test/provider_test.c", 182, "OSSL_PROVIDER_get_params(prov, greeting_request)", (OSSL_PROVIDER_get_params(prov, greeting_request)) != 0)
            || !test_ptr("../test/provider_test.c", 183, "greeting = greeting_request[0].data", greeting = greeting_request[0].data)
            || !test_size_t_gt("../test/provider_test.c", 184, "greeting_request[0].data_size", "0", greeting_request[0].data_size, 0)
            || !test_str_eq("../test/provider_test.c", 185, "greeting", "custom_buf", greeting, custom_buf))
        goto err;


    err = ERR_peek_last_error();
    if (!test_int_gt("../test/provider_test.c", 190, "err", "0", err, 0)
            || !test_int_eq("../test/provider_test.c", 191, "ERR_GET_REASON(err)", "1", ERR_GET_REASON(err), 1))
        goto err;

    if (!test_true("../test/provider_test.c", 194, "OSSL_PROVIDER_unload(prov)", (OSSL_PROVIDER_unload(prov)) != 0))
        goto err;
    prov = 
# 196 "../test/provider_test.c" 3 4
          ((void *)0)
# 196 "../test/provider_test.c"
              ;
    ...
    OSSL_LIB_CTX_free(*libctx);
    *libctx = 
# 203 "../test/provider_test.c" 3 4
             ((void *)0)
# 203 "../test/provider_test.c"
                 ;


    ERR_print_errors_fp(
# 206 "../test/provider_test.c" 3 4
                       stderr
# 206 "../test/provider_test.c"
                             );
    ok = 1;
 err:
    ...
    OSSL_LIB_CTX_free(*libctx);
    *libctx = 
# 213 "../test/provider_test.c" 3 4
             ((void *)0)
# 213 "../test/provider_test.c"
                 ;
    return ok;
}
...
static int test_builtin_provider(void)
{
    ...
    ok =
        test_ptr("../test/provider_test.c", 225, "libctx", libctx)
        && test_true("../test/provider_test.c", 226, "OSSL_PROVIDER_add_builtin(libctx, name, PROVIDER_INIT_FUNCTION_NAME)", (OSSL_PROVIDER_add_builtin(libctx, name, p_test_init)) != 0)

        && test_provider(&libctx, name, 
# 228 "../test/provider_test.c" 3 4
                                       ((void *)0)
# 228 "../test/provider_test.c"
                                           );
...
static int test_builtin_provider_with_child(void)
{
    ...
    if (!test_ptr("../test/provider_test.c", 243, "libctx", libctx))
        return 0;

    legacy = OSSL_PROVIDER_load(libctx, "legacy");
    if (legacy == 
# 247 "../test/provider_test.c" 3 4
                 ((void *)0)
# 247 "../test/provider_test.c"
                     ) {
    ...
    if (!test_true("../test/provider_test.c", 256, "OSSL_PROVIDER_add_builtin(libctx, name, PROVIDER_INIT_FUNCTION_NAME)", (OSSL_PROVIDER_add_builtin(libctx, name, p_test_init)) != 0)
                                                                          ) {
        OSSL_PROVIDER_unload(legacy);
        OSSL_LIB_CTX_free(libctx);
        return 0;
...
static int test_loaded_provider(void)
{
    ...
    if (!test_ptr("../test/provider_test.c", 275, "libctx", libctx))
        return 0;


    res = test_provider(&libctx, name, 
# 279 "../test/provider_test.c" 3 4
                                      ((void *)0)
# 279 "../test/provider_test.c"
                                          );

    libctx = OSSL_LIB_CTX_new();
    if (!test_ptr("../test/provider_test.c", 282, "libctx", libctx))
        return 0;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 304 "../test/provider_test.c" 3 4
         ((void *)0) 
# 304 "../test/provider_test.c"
              }
    };
    return test_options;
}
