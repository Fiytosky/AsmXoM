# 0 "../test/quicfaultstest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quicfaultstest.c"
# 10 "../test/quicfaultstest.c"
...
# 12 "../test/quicfaultstest.c" 2
# 1 "../test/helpers/quictestlib.h" 1
# 11 "../test/helpers/quictestlib.h"
...
# 15 "../test/quicfaultstest.c" 2

static char *cert = 
# 16 "../test/quicfaultstest.c" 3 4
                   ((void *)0)
# 16 "../test/quicfaultstest.c"
                       ;
static char *privkey = 
# 17 "../test/quicfaultstest.c" 3 4
                      ((void *)0)
# 17 "../test/quicfaultstest.c"
                          ;
...
static int test_basic(void)
{
    ...
    QUIC_TSERVER *qtserv = 
# 27 "../test/quicfaultstest.c" 3 4
                          ((void *)0)
# 27 "../test/quicfaultstest.c"
                              ;
    SSL *cssl = 
# 28 "../test/quicfaultstest.c" 3 4
               ((void *)0)
# 28 "../test/quicfaultstest.c"
                   ;
    ...
    if (!test_ptr("../test/quicfaultstest.c", 34, "cctx", cctx))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 37, "qtest_create_quic_objects(NULL, cctx, NULL, cert, privkey, 0, &qtserv, &cssl, NULL, NULL)", (qtest_create_quic_objects(
# 37 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 37 "../test/quicfaultstest.c"
        , cctx, 
# 37 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 37 "../test/quicfaultstest.c"
        , cert, privkey, 0, &qtserv, &cssl, 
# 37 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 37 "../test/quicfaultstest.c"
        , 
...
# 37 "../test/quicfaultstest.c"
    ...
    if (!test_true("../test/quicfaultstest.c", 41, "qtest_create_quic_connection(qtserv, cssl)", (qtest_create_quic_connection(qtserv, cssl)) != 0))
        goto err;

    if (!test_int_eq("../test/quicfaultstest.c", 44, "SSL_write(cssl, msg, msglen)", "msglen", SSL_write(cssl, msg, msglen), msglen))
        goto err;

    ossl_quic_tserver_tick(qtserv);
    if (!test_true("../test/quicfaultstest.c", 48, "ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)", (ossl_quic_tserver_read(qtserv, 0, buf, sizeof(buf), &bytesread)) != 0))
        goto err;
    ...
    if (!test_mem_eq("../test/quicfaultstest.c", 56, "msg", "buf", msg, msglen, buf, bytesread))
        goto err;
...
static int test_unknown_frame(void)
{
    ...
    SSL_CTX *cctx = SSL_CTX_new(OSSL_QUIC_client_method());
    QUIC_TSERVER *qtserv = 
# 95 "../test/quicfaultstest.c" 3 4
                          ((void *)0)
# 95 "../test/quicfaultstest.c"
                              ;
    SSL *cssl = 
# 96 "../test/quicfaultstest.c" 3 4
               ((void *)0)
# 96 "../test/quicfaultstest.c"
                   ;
    char *msg = "Hello World!";
    size_t msglen = strlen(msg);
    unsigned char buf[80];
    size_t byteswritten;
    QTEST_FAULT *fault = 
# 101 "../test/quicfaultstest.c" 3 4
                        ((void *)0)
# 101 "../test/quicfaultstest.c"
                            ;
    uint64_t sid = 
# 102 "../test/quicfaultstest.c" 3 4
                  (18446744073709551615UL)
# 102 "../test/quicfaultstest.c"
                            ;

    if (!test_ptr("../test/quicfaultstest.c", 104, "cctx", cctx))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 107, "qtest_create_quic_objects(NULL, cctx, NULL, cert, privkey, 0, &qtserv, &cssl, &fault, NULL)", (qtest_create_quic_objects(
# 107 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 107 "../test/quicfaultstest.c"
        , cctx, 
# 107 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 107 "../test/quicfaultstest.c"
        , cert, privkey, 0, &qtserv, &cssl, &fault, 
# 107 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 107 "../test/quicfaultstest.c"
        )) != 0)
    ...
    if (!test_true("../test/quicfaultstest.c", 111, "qtest_create_quic_connection(qtserv, cssl)", (qtest_create_quic_connection(qtserv, cssl)) != 0))
        goto err;
    ...
    if (!test_true("../test/quicfaultstest.c", 118, "qtest_fault_set_packet_plain_listener(fault, add_unknown_frame_cb, NULL)", (qtest_fault_set_packet_plain_listener(fault, add_unknown_frame_cb, 
# 118 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 118 "../test/quicfaultstest.c"
        )) != 0)

                                                               )
        goto err;

    if (!test_true("../test/quicfaultstest.c", 123, "ossl_quic_tserver_stream_new(qtserv, 0, &sid)", (ossl_quic_tserver_stream_new(qtserv, 0, &sid)) != 0)
        || !test_uint64_t_eq("../test/quicfaultstest.c", 124, "sid", "1", sid, 1))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 127, "ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg, msglen, &byteswritten)", (ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg, msglen, &byteswritten)) != 0)
                                                          )
        goto err;

    if (!test_size_t_eq("../test/quicfaultstest.c", 131, "msglen", "byteswritten", msglen, byteswritten))
        goto err;

    ossl_quic_tserver_tick(qtserv);
    if (!test_true("../test/quicfaultstest.c", 135, "SSL_handle_events(cssl)", (SSL_handle_events(cssl)) != 0))
        goto err;

    if (!test_int_le("../test/quicfaultstest.c", 138, "ret = SSL_read(cssl, buf, sizeof(buf))", "0", ret = SSL_read(cssl, buf, sizeof(buf)), 0))
        goto err;

    if (!test_int_eq("../test/quicfaultstest.c", 141, "SSL_get_error(cssl, ret)", "SSL_ERROR_SSL", SSL_get_error(cssl, ret), 1))
        goto err;

    if (!test_int_eq("../test/quicfaultstest.c", 144, "ERR_GET_REASON(ERR_peek_error())", "SSL_R_QUIC_PROTOCOL_ERROR", ERR_GET_REASON(ERR_peek_error()), 382)
                                               )
        goto err;

    if (!test_true("../test/quicfaultstest.c", 148, "qtest_check_server_frame_encoding_err(qtserv)", (qtest_check_server_frame_encoding_err(qtserv)) != 0))
        goto err;
                                    ...
                                    size_t eelen, void *encextcbarg)
{
    ...
    if (!qtest_fault_delete_extension(fault, *ext, ee->extensions,
                                      &ee->extensionslen, 
# 171 "../test/quicfaultstest.c" 3 4
                                                         ((void *)0)
# 171 "../test/quicfaultstest.c"
                                                             ))
        return 0;
...
static int test_drop_extensions(int idx)
{
    ...
    SSL_CTX *cctx = SSL_CTX_new(OSSL_QUIC_client_method());
    QUIC_TSERVER *qtserv = 
# 181 "../test/quicfaultstest.c" 3 4
                          ((void *)0)
# 181 "../test/quicfaultstest.c"
                              ;
    SSL *cssl = 
# 182 "../test/quicfaultstest.c" 3 4
               ((void *)0)
# 182 "../test/quicfaultstest.c"
                   ;
    QTEST_FAULT *fault = 
# 183 "../test/quicfaultstest.c" 3 4
                        ((void *)0)
# 183 "../test/quicfaultstest.c"
                            ;
    int ext, err;

    if (!test_ptr("../test/quicfaultstest.c", 186, "cctx", cctx))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 189, "qtest_create_quic_objects(NULL, cctx, NULL, cert, privkey, 0, &qtserv, &cssl, &fault, NULL)", (qtest_create_quic_objects(
# 189 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 189 "../test/quicfaultstest.c"
        , cctx, 
# 189 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 189 "../test/quicfaultstest.c"
...
# 189 "../test/quicfaultstest.c"
    ...
    if (!test_true("../test/quicfaultstest.c", 201, "qtest_fault_set_hand_enc_ext_listener(fault, drop_extensions_cb, &ext)", (qtest_fault_set_hand_enc_ext_listener(fault, drop_extensions_cb, &ext)) != 0)
    ...
    if (!test_false("../test/quicfaultstest.c", 210, "qtest_create_quic_connection(qtserv, cssl)", (qtest_create_quic_connection(qtserv, cssl)) != 0))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 213, "qtest_check_server_transport_err(qtserv, err)", (qtest_check_server_transport_err(qtserv, err)) != 0))
        goto err;
...
{
    QTEST_FAULT *fault = 
# 262 "../test/quicfaultstest.c" 3 4
                        ((void *)0)
# 262 "../test/quicfaultstest.c"
                            ;
    int testresult = 0;
    SSL_CTX *cctx = SSL_CTX_new(OSSL_QUIC_client_method());
    QUIC_TSERVER *qtserv = 
# 265 "../test/quicfaultstest.c" 3 4
                          ((void *)0)
# 265 "../test/quicfaultstest.c"
                              ;
    SSL *cssl = 
# 266 "../test/quicfaultstest.c" 3 4
               ((void *)0)
# 266 "../test/quicfaultstest.c"
                   ;
    char *msg = "Hello World!";
    size_t msglen = strlen(msg);
    unsigned char buf[80];
    ...
    uint64_t sid = 
# 271 "../test/quicfaultstest.c" 3 4
                  (18446744073709551615UL)
# 271 "../test/quicfaultstest.c"
                            ;

    if (!test_ptr("../test/quicfaultstest.c", 273, "cctx", cctx))
        goto err;

    if (!test_true("../test/quicfaultstest.c", 276, "qtest_create_quic_objects(NULL, cctx, NULL, cert, privkey, QTEST_FLAG_FAKE_TIME, &qtserv, &cssl, &fault, NULL)", (qtest_create_quic_objects(
# 276 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 276 "../test/quicfaultstest.c"
        , cctx, 
# 276 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 276 "../test/quicfaultstest.c"
        , cert, privkey, (1 << 1), &qtserv, &cssl, &fault, 
# 276 "../test/quicfaultstest.c" 3 4
        ((void *)0)
# 276 "../test/quicfaultstest.c"
        )) != 0)
    ...
    if (idx == 0) {
        ...
        if (!test_true("../test/quicfaultstest.c", 283, "qtest_fault_set_packet_cipher_listener(fault, on_packet_cipher_cb, NULL)", (qtest_fault_set_packet_cipher_listener(fault, on_packet_cipher_cb, 
# 283 "../test/quicfaultstest.c" 3 4
            ((void *)0)
# 283 "../test/quicfaultstest.c"
            )) != 0)
        ...
        if (!test_true("../test/quicfaultstest.c", 289, "qtest_fault_set_datagram_listener(fault, on_datagram_cb, NULL)", (qtest_fault_set_datagram_listener(fault, on_datagram_cb, 
# 289 "../test/quicfaultstest.c" 3 4
            ((void *)0)
# 289 "../test/quicfaultstest.c"
            )) != 0)

                                                               )
            goto err;
    }
    if (!test_true("../test/quicfaultstest.c", 294, "qtest_create_quic_connection(qtserv, cssl)", (qtest_create_quic_connection(qtserv, cssl)) != 0))
        goto err;


    docorrupt = 1;

    if (!test_true("../test/quicfaultstest.c", 300, "ossl_quic_tserver_stream_new(qtserv, 0, &sid)", (ossl_quic_tserver_stream_new(qtserv, 0, &sid)) != 0)
        || !test_uint64_t_eq("../test/quicfaultstest.c", 301, "sid", "1", sid, 1))
        goto err;
    ...
    if (!test_true("../test/quicfaultstest.c", 308, "ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg, 5, &byteswritten)", (ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg, 5, &byteswritten)) != 0)
                                                          )
        goto err;

    if (!test_size_t_eq("../test/quicfaultstest.c", 312, "byteswritten", "5", byteswritten, 5))
        goto err;
    ...
    if (!test_true("../test/quicfaultstest.c", 324, "ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg + 5, msglen - 5, &byteswritten)", (ossl_quic_tserver_write(qtserv, sid, (unsigned char *)msg + 5, msglen - 5, &byteswritten)) != 0)
                                                                      )
        goto err;

    if (!test_size_t_eq("../test/quicfaultstest.c", 328, "byteswritten", "msglen - 5", byteswritten, msglen - 5))
        goto err;
    ...
    if (!test_true("../test/quicfaultstest.c", 336, "SSL_handle_events(cssl)", (SSL_handle_events(cssl)) != 0))
        goto err;
    ...
    if (!test_true("../test/quicfaultstest.c", 346, "SSL_handle_events(cssl)", (SSL_handle_events(cssl)) != 0))
        goto err;


    if (!test_true("../test/quicfaultstest.c", 350, "SSL_read_ex(cssl, buf, sizeof(buf), &bytesread)", (SSL_read_ex(cssl, buf, sizeof(buf), &bytesread)) != 0))
        goto err;

    if (!test_mem_eq("../test/quicfaultstest.c", 353, "msg", "buf", msg, msglen, buf, bytesread))
        goto err;
    ...
    if (!test_false("../test/quicfaultstest.c", 360, "docorrupt", (docorrupt) != 0))
        goto err;
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "certsdir\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 372 "../test/quicfaultstest.c" 3 4
((void *)0) 
# 372 "../test/quicfaultstest.c"
} }; return options; }

int setup_tests(void)
{
    char *certsdir = 
# 376 "../test/quicfaultstest.c" 3 4
                    ((void *)0)
# 376 "../test/quicfaultstest.c"
                        ;

    if (!test_skip_common_options()) {
        test_error("../test/quicfaultstest.c", 379, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/quicfaultstest.c", 383, "certsdir = test_get_argument(0)", certsdir = test_get_argument(0)))
        return 0;

    cert = test_mk_file_path(certsdir, "servercert.pem");
    if (cert == 
# 387 "../test/quicfaultstest.c" 3 4
               ((void *)0)
# 387 "../test/quicfaultstest.c"
                   )
        goto err;

    privkey = test_mk_file_path(certsdir, "serverkey.pem");
    if (privkey == 
# 391 "../test/quicfaultstest.c" 3 4
                  ((void *)0)
# 391 "../test/quicfaultstest.c"
                      )
        goto err;
    ...
    add_all_tests("test_corrupted_data", test_corrupted_data, 2, 1);

    return 1;

 err:
    CRYPTO_free(cert, "../test/quicfaultstest.c", 402);
    CRYPTO_free(privkey, "../test/quicfaultstest.c", 403);
    return 0;
}

void cleanup_tests(void)
{
    CRYPTO_free(cert, "../test/quicfaultstest.c", 409);
    CRYPTO_free(privkey, "../test/quicfaultstest.c", 410);
}
