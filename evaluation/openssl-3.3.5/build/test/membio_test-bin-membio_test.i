# 0 "../test/membio_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/membio_test.c"
# 10 "../test/membio_test.c"
...
# 12 "../test/membio_test.c" 2


static int test_dgram(void)
{
    BIO *bio = BIO_new(BIO_s_dgram_mem()), *rbio = 
# 16 "../test/membio_test.c" 3 4
                                                  ((void *)0)
# 16 "../test/membio_test.c"
                                                      ;
    int testresult = 0;
    ...
    if (!test_ptr("../test/membio_test.c", 24, "bio", bio))
        goto err;

    rbio = BIO_new_mem_buf(msg1, sizeof(msg1));
    if (!test_ptr("../test/membio_test.c", 28, "rbio", rbio))
        goto err;


    if (!test_int_gt("../test/membio_test.c", 32, "BIO_set_mem_eof_return(rbio, 0)", "0", BIO_ctrl(rbio,130,0,
# 32 "../test/membio_test.c" 3 4
        ((void *)0)
# 32 "../test/membio_test.c"
        ), 0))
        goto err;


    if (!test_int_le("../test/membio_test.c", 36, "BIO_set_mem_eof_return(bio, 0)", "0", BIO_ctrl(bio,130,0,
# 36 "../test/membio_test.c" 3 4
        ((void *)0)
# 36 "../test/membio_test.c"
        ), 0))
        goto err;


    if (!test_int_eq("../test/membio_test.c", 40, "BIO_write(bio, msg1, sizeof(msg1))", "sizeof(msg1)", BIO_write(bio, msg1, sizeof(msg1)), sizeof(msg1)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 42, "BIO_write(bio, msg2, sizeof(msg2))", "sizeof(msg2)", BIO_write(bio, msg2, sizeof(msg2)), sizeof(msg2)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 44, "BIO_write(bio, msg3, sizeof(msg3))", "sizeof(msg3)", BIO_write(bio, msg3, sizeof(msg3)), sizeof(msg3)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 46, "BIO_write(bio, msg4, sizeof(msg4))", "sizeof(msg4)", BIO_write(bio, msg4, sizeof(msg4)), sizeof(msg4)))
        goto err;


    if (!test_int_eq("../test/membio_test.c", 50, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg1)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg1))
            || !test_mem_eq("../test/membio_test.c", 51, "buf", "msg1", buf, sizeof(msg1), msg1, sizeof(msg1))
            || !test_int_eq("../test/membio_test.c", 52, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg2)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg2))
            || !test_mem_eq("../test/membio_test.c", 53, "buf", "msg2", buf, sizeof(msg2), msg2, sizeof(msg2))
            || !test_int_eq("../test/membio_test.c", 54, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg3)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg3))
            || !test_mem_eq("../test/membio_test.c", 55, "buf", "msg3", buf, sizeof(msg3), msg3, sizeof(msg3))
            || !test_int_eq("../test/membio_test.c", 56, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg4)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg4))
            || !test_mem_eq("../test/membio_test.c", 57, "buf", "msg4", buf, sizeof(msg4), msg4, sizeof(msg4)))
        goto err;


    if (!test_int_eq("../test/membio_test.c", 61, "BIO_write(bio, msg1, sizeof(msg1))", "sizeof(msg1)", BIO_write(bio, msg1, sizeof(msg1)), sizeof(msg1)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 63, "BIO_write(bio, msg2, sizeof(msg2))", "sizeof(msg2)", BIO_write(bio, msg2, sizeof(msg2)), sizeof(msg2)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 65, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg1)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg1))
            || !test_mem_eq("../test/membio_test.c", 66, "buf", "msg1", buf, sizeof(msg1), msg1, sizeof(msg1)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 68, "BIO_write(bio, msg3, sizeof(msg3))", "sizeof(msg3)", BIO_write(bio, msg3, sizeof(msg3)), sizeof(msg3)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 70, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg2)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg2))
            || !test_mem_eq("../test/membio_test.c", 71, "buf", "msg2", buf, sizeof(msg2), msg2, sizeof(msg2))
            || !test_int_eq("../test/membio_test.c", 72, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg3)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg3))
            || !test_mem_eq("../test/membio_test.c", 73, "buf", "msg3", buf, sizeof(msg3), msg3, sizeof(msg3)))
        goto err;
    ...
    if (!test_int_eq("../test/membio_test.c", 80, "BIO_write(bio, msg1, sizeof(msg1))", "sizeof(msg1)", BIO_write(bio, msg1, sizeof(msg1)), sizeof(msg1)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 82, "BIO_write(bio, msg2, sizeof(msg2))", "sizeof(msg2)", BIO_write(bio, msg2, sizeof(msg2)), sizeof(msg2)))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 84, "BIO_read(bio, buf, 2)", "2", BIO_read(bio, buf, 2), 2)
            || !test_mem_eq("../test/membio_test.c", 85, "buf", "msg1", buf, 2, msg1, 2))
        goto err;
    if (!test_int_eq("../test/membio_test.c", 87, "BIO_read(bio, buf, sizeof(buf))", "sizeof(msg2)", BIO_read(bio, buf, sizeof(buf)), sizeof(msg2))
            || !test_mem_eq("../test/membio_test.c", 88, "buf", "msg2", buf, sizeof(msg2), msg2, sizeof(msg2)))
        goto err;
    ...
    if (!test_int_eq("../test/membio_test.c", 96, "BIO_write(bio, NULL, 0)", "0", BIO_write(bio, 
# 96 "../test/membio_test.c" 3 4
        ((void *)0)
# 96 "../test/membio_test.c"
        , 0), 0)
            || !test_int_lt("../test/membio_test.c", 97, "BIO_read(bio, buf, sizeof(buf))", "0", BIO_read(bio, buf, sizeof(buf)), 0)
            || !test_false("../test/membio_test.c", 98, "BIO_eof(bio)", ((int)BIO_ctrl(bio,2,0,
# 98 "../test/membio_test.c" 3 4
               ((void *)0)
# 98 "../test/membio_test.c"
               )) != 0)
            || !test_true("../test/membio_test.c", 99, "BIO_should_retry(bio)", (BIO_test_flags(bio, 0x08)) != 0))
        goto err;

    if (!test_int_eq("../test/membio_test.c", 102, "BIO_dgram_set_mtu(bio, 123456)", "1", (int)BIO_ctrl((bio), 42, (123456), 
# 102 "../test/membio_test.c" 3 4
        ((void *)0)
# 102 "../test/membio_test.c"
        ), 1)
            || !test_int_eq("../test/membio_test.c", 103, "BIO_dgram_get_mtu(bio)", "123456", (unsigned int)BIO_ctrl((bio), 41, 0, 
# 103 "../test/membio_test.c" 3 4
               ((void *)0)
# 103 "../test/membio_test.c"
               ), 123456))
        goto err;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/membio_test.c", 117, "Error parsing test options\n");
        return 0;
    }


    add_test("test_dgram", test_dgram);
