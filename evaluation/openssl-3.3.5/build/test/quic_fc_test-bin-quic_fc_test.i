# 0 "../test/quic_fc_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_fc_test.c"
# 10 "../test/quic_fc_test.c"
...
# 14 "../include/internal/quic_fc.h" 2
...
# 15 "../include/internal/quic_fc.h" 2
...
static int test_txfc(int is_stream)
{
    ...
    if (!test_true("../test/quic_fc_test.c", 19, "ossl_quic_txfc_init(&conn_txfc, 0)", (ossl_quic_txfc_init(&conn_txfc, 0)) != 0))
        goto err;

    if (is_stream && !test_true("../test/quic_fc_test.c", 22, "ossl_quic_txfc_init(&stream_txfc, &conn_txfc)", (ossl_quic_txfc_init(&stream_txfc, &conn_txfc)) != 0))
        goto err;

    txfc = is_stream ? &stream_txfc : &conn_txfc;
    parent_txfc = is_stream ? &conn_txfc : 
# 26 "../test/quic_fc_test.c" 3 4
                                          ((void *)0)
# 26 "../test/quic_fc_test.c"
                                              ;

    if (!test_true("../test/quic_fc_test.c", 28, "ossl_quic_txfc_bump_cwm(txfc, 2000)", (ossl_quic_txfc_bump_cwm(txfc, 2000)) != 0))
        goto err;

    if (is_stream && !test_true("../test/quic_fc_test.c", 31, "ossl_quic_txfc_bump_cwm(parent_txfc, 2000)", (ossl_quic_txfc_bump_cwm(parent_txfc, 2000)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 34, "ossl_quic_txfc_get_swm(txfc)", "0", ossl_quic_txfc_get_swm(txfc), 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 37, "ossl_quic_txfc_get_cwm(txfc)", "2000", ossl_quic_txfc_get_cwm(txfc), 2000))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 40, "ossl_quic_txfc_get_credit_local(txfc, 0)", "2000", ossl_quic_txfc_get_credit_local(txfc, 0), 2000))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 43, "ossl_quic_txfc_get_credit_local(txfc, 100)", "1900", ossl_quic_txfc_get_credit_local(txfc, 100), 1900))
        goto err;

    if (is_stream) {
        if ( !test_uint64_t_eq("../test/quic_fc_test.c", 47, "ossl_quic_txfc_get_credit(txfc, 0)", "2000", ossl_quic_txfc_get_credit(txfc, 0), 2000))
            goto err;

        if ( !test_uint64_t_eq("../test/quic_fc_test.c", 50, "ossl_quic_txfc_get_credit(txfc, 100)", "1900", ossl_quic_txfc_get_credit(txfc, 100), 1900))
            goto err;
    }

    if (!test_false("../test/quic_fc_test.c", 54, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 57, "ossl_quic_txfc_consume_credit(txfc, 500)", (ossl_quic_txfc_consume_credit(txfc, 500)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 60, "ossl_quic_txfc_get_credit_local(txfc, 0)", "1500", ossl_quic_txfc_get_credit_local(txfc, 0), 1500))
        goto err;

    if (is_stream && !test_uint64_t_eq("../test/quic_fc_test.c", 63, "ossl_quic_txfc_get_credit(txfc, 0)", "1500", ossl_quic_txfc_get_credit(txfc, 0), 1500)
                                            )
        goto err;

    if (!test_false("../test/quic_fc_test.c", 67, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 70, "ossl_quic_txfc_get_swm(txfc)", "500", ossl_quic_txfc_get_swm(txfc), 500))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 73, "ossl_quic_txfc_consume_credit(txfc, 100)", (ossl_quic_txfc_consume_credit(txfc, 100)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 76, "ossl_quic_txfc_get_swm(txfc)", "600", ossl_quic_txfc_get_swm(txfc), 600))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 79, "ossl_quic_txfc_get_credit_local(txfc, 0)", "1400", ossl_quic_txfc_get_credit_local(txfc, 0), 1400))
        goto err;

    if (is_stream && !test_uint64_t_eq("../test/quic_fc_test.c", 82, "ossl_quic_txfc_get_credit(txfc, 0)", "1400", ossl_quic_txfc_get_credit(txfc, 0), 1400)
                                            )
        goto err;

    if (!test_false("../test/quic_fc_test.c", 86, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 89, "ossl_quic_txfc_consume_credit(txfc, 1400)", (ossl_quic_txfc_consume_credit(txfc, 1400)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 92, "ossl_quic_txfc_get_credit_local(txfc, 0)", "0", ossl_quic_txfc_get_credit_local(txfc, 0), 0))
        goto err;

    if (is_stream && !test_uint64_t_eq("../test/quic_fc_test.c", 95, "ossl_quic_txfc_get_credit(txfc, 0)", "0", ossl_quic_txfc_get_credit(txfc, 0), 0)
                                         )
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 99, "ossl_quic_txfc_get_swm(txfc)", "2000", ossl_quic_txfc_get_swm(txfc), 2000))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 102, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 105, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 108, "ossl_quic_txfc_has_become_blocked(txfc, 1)", (ossl_quic_txfc_has_become_blocked(txfc, 1)) != 0))
        goto err;

    if (!test_false("../test/quic_fc_test.c", 111, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_false("../test/quic_fc_test.c", 114, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
        goto err;

    if (!test_false("../test/quic_fc_test.c", 117, "ossl_quic_txfc_consume_credit(txfc, 1)", (ossl_quic_txfc_consume_credit(txfc, 1)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 120, "ossl_quic_txfc_get_cwm(txfc)", "2000", ossl_quic_txfc_get_cwm(txfc), 2000))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 123, "ossl_quic_txfc_get_swm(txfc)", "2000", ossl_quic_txfc_get_swm(txfc), 2000))
        goto err;

    if (!test_false("../test/quic_fc_test.c", 126, "ossl_quic_txfc_bump_cwm(txfc, 2000)", (ossl_quic_txfc_bump_cwm(txfc, 2000)) != 0))
        goto err;

    if (!test_true("../test/quic_fc_test.c", 129, "ossl_quic_txfc_bump_cwm(txfc, 2500)", (ossl_quic_txfc_bump_cwm(txfc, 2500)) != 0))
        goto err;

    if (is_stream && !test_true("../test/quic_fc_test.c", 132, "ossl_quic_txfc_bump_cwm(parent_txfc, 2400)", (ossl_quic_txfc_bump_cwm(parent_txfc, 2400)) != 0))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 135, "ossl_quic_txfc_get_cwm(txfc)", "2500", ossl_quic_txfc_get_cwm(txfc), 2500))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 138, "ossl_quic_txfc_get_swm(txfc)", "2000", ossl_quic_txfc_get_swm(txfc), 2000))
        goto err;

    if (!test_uint64_t_eq("../test/quic_fc_test.c", 141, "ossl_quic_txfc_get_credit_local(txfc, 0)", "500", ossl_quic_txfc_get_credit_local(txfc, 0), 500))
        goto err;
    ...
    if (is_stream) {
        if (!test_uint64_t_eq("../test/quic_fc_test.c", 148, "ossl_quic_txfc_get_credit(txfc, 400)", "0", ossl_quic_txfc_get_credit(txfc, 400), 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 151, "ossl_quic_txfc_consume_credit(txfc, 399)", (ossl_quic_txfc_consume_credit(txfc, 399)) != 0))
            goto err;

        if (!test_false("../test/quic_fc_test.c", 154, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
            goto err;

        if (!test_uint64_t_eq("../test/quic_fc_test.c", 157, "ossl_quic_txfc_get_credit(txfc, 0)", "1", ossl_quic_txfc_get_credit(txfc, 0), 1))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 160, "ossl_quic_txfc_consume_credit(txfc, 1)", (ossl_quic_txfc_consume_credit(txfc, 1)) != 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 163, "ossl_quic_txfc_has_become_blocked(parent_txfc, 0)", (ossl_quic_txfc_has_become_blocked(parent_txfc, 0)) != 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 166, "ossl_quic_txfc_has_become_blocked(parent_txfc, 1)", (ossl_quic_txfc_has_become_blocked(parent_txfc, 1)) != 0))
            goto err;

        if (!test_false("../test/quic_fc_test.c", 169, "ossl_quic_txfc_has_become_blocked(parent_txfc, 0)", (ossl_quic_txfc_has_become_blocked(parent_txfc, 0)) != 0))
            goto err;
    } else {
        if (!test_true("../test/quic_fc_test.c", 172, "ossl_quic_txfc_consume_credit(txfc, 499)", (ossl_quic_txfc_consume_credit(txfc, 499)) != 0))
            goto err;

        if (!test_false("../test/quic_fc_test.c", 175, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
            goto err;

        if (is_stream && !test_false("../test/quic_fc_test.c", 178, "ossl_quic_txfc_has_become_blocked(parent_txfc, 0)", (ossl_quic_txfc_has_become_blocked(parent_txfc, 0)) != 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 181, "ossl_quic_txfc_consume_credit(txfc, 1)", (ossl_quic_txfc_consume_credit(txfc, 1)) != 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 184, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
            goto err;

        if (!test_true("../test/quic_fc_test.c", 187, "ossl_quic_txfc_has_become_blocked(txfc, 1)", (ossl_quic_txfc_has_become_blocked(txfc, 1)) != 0))
            goto err;

        if (!test_false("../test/quic_fc_test.c", 190, "ossl_quic_txfc_has_become_blocked(txfc, 0)", (ossl_quic_txfc_has_become_blocked(txfc, 0)) != 0))
            goto err;
    }
...
# 290 "../test/quic_fc_test.c"
static const struct rx_test_op rx_script_1[] = {
    { 15, 0, (1000 * (((uint64_t)1000000000) / 1000)) },
    { 1, 0, ((1 * 1024 * 1024)), (10 * (1 * 1024 * 1024)) }, { 2, (0), ((1 * 1024 * 1024)), (10 * (1 * 1024 * 1024)) },

    { 5, 0, ((1 * 1024 * 1024)) }, { 6, (0), ((1 * 1024 * 1024)) },
    { 13, 0, (0), (0) }, { 14, (0), (0), (0) },
    { 11, 0, (0), (0) }, { 12, (0), (0), (0) },
    ...
    { 3, (0), (60), (0) },
    { 7, 0, (60) }, { 8, (0), (60) },
    { 4, (0), (20), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 9, 0, (20) }, { 10, (0), (20) },
    { 7, 0, (60) }, { 8, (0), (60) },
    { 5, 0, ((1 * 1024 * 1024)) }, { 6, (0), ((1 * 1024 * 1024)) },
    { 11, 0, (0), (0) }, { 12, (0), (0), (0) },
    ...
    { 15, 0, (201 * (((uint64_t)1000000000) / 1000)) },
    { 3, (0), ((1 * 1024 * 1024)), (0) },
    { 4, (0), ((1 * 1024 * 1024) - 60), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 7, 0, ((1 * 1024 * 1024)) }, { 8, (0), ((1 * 1024 * 1024)) },
    { 11, 0, (1), (0) }, { 12, (0), (1), (0) },
    { 11, 0, (1), (1) }, { 12, (0), (1), (1) },
    { 11, 0, (0), (0) }, { 12, (0), (0), (0) },
    { 13, 0, (0), (0) }, { 14, (0), (0), (0) },
    { 5, 0, ((1 * 1024 * 1024) * 2) }, { 6, (0), ((1 * 1024 * 1024) * 2) },


    { 3, (0), ((1 * 1024 * 1024) + 1), (0) },
    { 15, 0, (201 * (((uint64_t)1000000000) / 1000)) },
    { 3, (0), ((1 * 1024 * 1024) * 2), (0) },
    { 4, (0), ((1 * 1024 * 1024)), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 7, 0, ((1 * 1024 * 1024) * 2) }, { 8, (0), ((1 * 1024 * 1024) * 2) },
    { 11, 0, (1), (0) }, { 12, (0), (1), (0) },
    { 11, 0, (1), (1) }, { 12, (0), (1), (1) },
    { 11, 0, (0), (0) }, { 12, (0), (0), (0) },
    { 13, 0, (0), (0) }, { 14, (0), (0), (0) },
    { 5, 0, ((1 * 1024 * 1024) * 3) }, { 6, (0), ((1 * 1024 * 1024) * 3) },


    { 3, (0), ((1 * 1024 * 1024) * 2 + 1), (0) },
    { 15, 0, (199 * (((uint64_t)1000000000) / 1000)) },
    { 3, (0), ((1 * 1024 * 1024) * 3), (0) },
    { 4, (0), ((1 * 1024 * 1024)), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 7, 0, ((1 * 1024 * 1024) * 3) }, { 8, (0), ((1 * 1024 * 1024) * 3) },
    { 11, 0, (1), (0) }, { 12, (0), (1), (0) },
    { 11, 0, (1), (1) }, { 12, (0), (1), (1) },
    { 11, 0, (0), (0) }, { 12, (0), (0), (0) },
    { 13, 0, (0), (0) }, { 14, (0), (0), (0) },
    { 5, 0, ((1 * 1024 * 1024) * 5) }, { 6, (0), ((1 * 1024 * 1024) * 5) },


    { 3, (0), ((1 * 1024 * 1024) * 5 - 5), (0) },
    { 15, 0, (250 * (((uint64_t)1000000000) / 1000)) },
    { 3, (0), ((1 * 1024 * 1024) * 5 + 1), (0) },
    { 7, 0, ((1 * 1024 * 1024) * 5) }, { 8, (0), ((1 * 1024 * 1024) * 5) },
    { 13, 0, (0x03), (0) }, { 14, (0), (0x03), (0) },
    { 13, 0, (0x03), (1) }, { 14, (0), (0x03), (1) },
    { 13, 0, (0), (0) }, { 14, (0), (0), (0) },
    { 5, 0, ((1 * 1024 * 1024) * 5) }, { 6, (0), ((1 * 1024 * 1024) * 5) },
...
static const struct rx_test_op rx_script_2[] = {
    { 15, 0, (1000 * (((uint64_t)1000000000) / 1000)) },
    { 1, 0, ((1 * 1024 * 1024)), (10 * (1 * 1024 * 1024)) },
    { 2, (0), ((384 * 1024)), (30 * (384 * 1024)) },
    { 2, (1), ((384 * 1024)), (30 * (384 * 1024)) },
    ...
    { 4, (0), (10), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 9, 0, (10) },
    { 10, (0), (10) },
    { 5, 0, ((1 * 1024 * 1024)) },
    { 6, (0), ((384 * 1024)) },
    ...
    { 4, (1), (42), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 9, 0, (52) },
    { 10, (1), (42) },
    { 5, 0, ((1 * 1024 * 1024)) },
    { 6, (0), ((384 * 1024)) },
    ...
    { 4, (0), ((384 * 1024) - 10), (50 * (((uint64_t)1000000000) / 1000)), (0) },
    { 6, (0), ((384 * 1024) * 2) },
    { 12, (0), (1), (0) },
    { 12, (0), (1), (1) },
    { 12, (0), (0), (0) },
...
static int run_rxfc_script(const struct rx_test_op *script)
{
    ...
    QUIC_RXFC conn_rxfc = {0}, stream_rxfc[3] = {0};
    char stream_init_done[3] = {0};
    ...
    for (; op->op != 0; ++op) {
        switch (op->op) {
            case 1:
                if (!test_true("../test/quic_fc_test.c", 492, "ossl_quic_rxfc_init(&conn_rxfc, 0, op->arg0, op->arg1, fake_now, NULL)", (ossl_quic_rxfc_init(&conn_rxfc, 0, op->arg0, op->arg1, fake_now, 
# 492 "../test/quic_fc_test.c" 3 4
                    ((void *)0)
# 492 "../test/quic_fc_test.c"
                    )) != 0)
            ...
            case 2:
                if (!test_size_t_lt("../test/quic_fc_test.c", 501, "op->stream_idx", "OSSL_NELEM(stream_rxfc)", op->stream_idx, (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])))
                    || !test_true("../test/quic_fc_test.c", 502, "conn_init_done", (conn_init_done) != 0))
                    goto err;

                if (!test_true("../test/quic_fc_test.c", 505, "ossl_quic_rxfc_init(&stream_rxfc[op->stream_idx], &conn_rxfc, op->arg0, op->arg1, fake_now, NULL)", (ossl_quic_rxfc_init(&stream_rxfc[op->stream_idx], &conn_rxfc, op->arg0, op->arg1, fake_now, 
# 505 "../test/quic_fc_test.c" 3 4
                    ((void *)0)
# 505 "../test/quic_fc_test.c"
                    )) != 0)
            ...
            case 3:
                if (!test_true("../test/quic_fc_test.c", 515, "conn_init_done && op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (conn_init_done && op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;

                if (!test_true("../test/quic_fc_test.c", 519, "ossl_quic_rxfc_on_rx_stream_frame(&stream_rxfc[op->stream_idx], op->arg0, (int)op->arg1)", (ossl_quic_rxfc_on_rx_stream_frame(&stream_rxfc[op->stream_idx], op->arg0, (int)op->arg1)) != 0)
            ...
            case 4:
                if (!test_true("../test/quic_fc_test.c", 527, "conn_init_done && op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (conn_init_done && op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;

                if (!test_int_eq("../test/quic_fc_test.c", 531, "ossl_quic_rxfc_on_retire(&stream_rxfc[op->stream_idx], op->arg0, ossl_ticks2time(op->arg1))", "!op->expect_fail", ossl_quic_rxfc_on_retire(&stream_rxfc[op->stream_idx], op->arg0, ossl_ticks2time(op->arg1)), !op->expect_fail)
                ...
                break;
            case 5:
                if (!test_true("../test/quic_fc_test.c", 539, "conn_init_done", (conn_init_done) != 0))
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 541, "ossl_quic_rxfc_get_cwm(&conn_rxfc)", "op->arg0", ossl_quic_rxfc_get_cwm(&conn_rxfc), op->arg0)
                                               )
                    goto err;
                break;
            case 6:
                if (!test_true("../test/quic_fc_test.c", 546, "op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 549, "ossl_quic_rxfc_get_cwm(&stream_rxfc[op->stream_idx])", "op->arg0", ossl_quic_rxfc_get_cwm(&stream_rxfc[op->stream_idx]), op->arg0)
                                               )
                    goto err;
                break;
            case 7:
                if (!test_true("../test/quic_fc_test.c", 554, "conn_init_done", (conn_init_done) != 0))
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 556, "ossl_quic_rxfc_get_swm(&conn_rxfc)", "op->arg0", ossl_quic_rxfc_get_swm(&conn_rxfc), op->arg0)
                                               )
                    goto err;
                break;
            case 8:
                if (!test_true("../test/quic_fc_test.c", 561, "op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 564, "ossl_quic_rxfc_get_swm(&stream_rxfc[op->stream_idx])", "op->arg0", ossl_quic_rxfc_get_swm(&stream_rxfc[op->stream_idx]), op->arg0)
                                               )
                    goto err;
                break;
            case 9:
                if (!test_true("../test/quic_fc_test.c", 569, "conn_init_done", (conn_init_done) != 0))
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 571, "ossl_quic_rxfc_get_rwm(&conn_rxfc)", "op->arg0", ossl_quic_rxfc_get_rwm(&conn_rxfc), op->arg0)
                                               )
                    goto err;
                break;
            case 10:
                if (!test_true("../test/quic_fc_test.c", 576, "op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;
                if (!test_uint64_t_eq("../test/quic_fc_test.c", 579, "ossl_quic_rxfc_get_rwm(&stream_rxfc[op->stream_idx])", "op->arg0", ossl_quic_rxfc_get_rwm(&stream_rxfc[op->stream_idx]), op->arg0)
                                               )
                    goto err;
                break;
            case 11:
                if (!test_true("../test/quic_fc_test.c", 584, "conn_init_done", (conn_init_done) != 0))
                    goto err;
                if (!test_int_eq("../test/quic_fc_test.c", 586, "ossl_quic_rxfc_has_cwm_changed(&conn_rxfc, (int)op->arg1)", "(int)op->arg0", ossl_quic_rxfc_has_cwm_changed(&conn_rxfc, (int)op->arg1), (int)op->arg0)

                                               )
                    goto err;
                break;
            case 12:
                if (!test_true("../test/quic_fc_test.c", 592, "op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;
                if (!test_int_eq("../test/quic_fc_test.c", 595, "ossl_quic_rxfc_has_cwm_changed(&stream_rxfc[op->stream_idx], (int)op->arg1)", "(int)op->arg0", ossl_quic_rxfc_has_cwm_changed(&stream_rxfc[op->stream_idx], (int)op->arg1), (int)op->arg0)

                                               )
                    goto err;
                break;
            case 13:
                if (!test_true("../test/quic_fc_test.c", 601, "conn_init_done", (conn_init_done) != 0))
                    goto err;
                if (!test_int_eq("../test/quic_fc_test.c", 603, "ossl_quic_rxfc_get_error(&conn_rxfc, (int)op->arg1)", "(int)op->arg0", ossl_quic_rxfc_get_error(&conn_rxfc, (int)op->arg1), (int)op->arg0)

                                               )
                    goto err;
                break;
            case 14:
                if (!test_true("../test/quic_fc_test.c", 609, "op->stream_idx < OSSL_NELEM(stream_rxfc) && stream_init_done[op->stream_idx]", (op->stream_idx < (sizeof(stream_rxfc)/sizeof((stream_rxfc)[0])) && stream_init_done[op->stream_idx]) != 0)
                                                                   )
                    goto err;
                if (!test_int_eq("../test/quic_fc_test.c", 612, "ossl_quic_rxfc_get_error(&stream_rxfc[op->stream_idx], (int)op->arg1)", "(int)op->arg0", ossl_quic_rxfc_get_error(&stream_rxfc[op->stream_idx], (int)op->arg1), (int)op->arg0)
            ...
            case 16:
                fprintf(
# 621 "../test/quic_fc_test.c" 3 4
                       stderr
# 621 "../test/quic_fc_test.c"
                             , "# %s\n", op->msg);
                break;
            default:
                goto err;
...
int setup_tests(void)
{
    ...
    add_all_tests("test_rxfc", test_rxfc, (sizeof(rx_scripts)/sizeof((rx_scripts)[0])), 1);
    return 1;
}
