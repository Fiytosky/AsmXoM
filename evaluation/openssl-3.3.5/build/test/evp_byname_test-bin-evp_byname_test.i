# 0 "../test/evp_byname_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_byname_test.c"
# 10 "../test/evp_byname_test.c"
...
# 16 "../test/evp_byname_test.c" 2

static int test_evp_get_digestbyname(void)
{
    const EVP_MD *md;

    if (!test_ptr("../test/evp_byname_test.c", 21, "md = EVP_get_digestbyname(\"SHA2-256\")", md = EVP_get_digestbyname("SHA2-256")))
        return 0;
    return 1;
}
...
static int test_evp_get_cipherbyname(void)
{
    ...
    if (!test_ptr("../test/evp_byname_test.c", 30, "cipher = EVP_get_cipherbyname(\"AES-256-WRAP\")", cipher = EVP_get_cipherbyname("AES-256-WRAP")))
        return 0;
    return 1;
}
...
int setup_tests(void)
{
    ...
    add_test("test_evp_get_cipherbyname", test_evp_get_cipherbyname);
    return 1;
}
