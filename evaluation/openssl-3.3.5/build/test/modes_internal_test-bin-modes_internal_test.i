# 0 "../test/modes_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/modes_internal_test.c"
# 16 "../test/modes_internal_test.c"
...
# 17 "../test/modes_internal_test.c" 2
...
# 19 "../test/modes_internal_test.c" 2
...
# 20 "../test/modes_internal_test.c" 2
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 22 "../test/modes_internal_test.c" 2
...
# 23 "../test/modes_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 24 "../test/modes_internal_test.c" 2
...
# 25 "../test/modes_internal_test.c" 2
...
static const SIZED_DATA aes_cts128_vectors[] = {
    { sizeof(vector_17), vector_17 },
    { sizeof(vector_31), vector_31 },
    { sizeof(vector_32), vector_32 },
    { sizeof(vector_47), vector_47 },
    { sizeof(vector_48), vector_48 },
    { sizeof(vector_64), vector_64 },
};
...
static int execute_cts128(const CTS128_FIXTURE *fixture, int num)
{
    ...
    test_info("../test/modes_internal_test.c", 197, "%s_vector_%lu", fixture->case_name, (unsigned long)len);

    tail = fixture->last_blocks_correction(orig_vector, vector, len);


    memcpy(iv, test_iv, test_iv_len);
    if (!test_size_t_eq("../test/modes_internal_test.c", 203, "fixture->encrypt_block(test_input, ciphertext, len, encrypt_key_schedule, iv, (block128_f)AES_encrypt)", "len", fixture->encrypt_block(test_input, ciphertext, len, encrypt_key_schedule, iv, (block128_f)AES_encrypt), len)


            || !test_mem_eq("../test/modes_internal_test.c", 206, "ciphertext", "vector", ciphertext, len, vector, len)
            || !test_mem_eq("../test/modes_internal_test.c", 207, "iv", "vector + len - tail", iv, sizeof(iv), vector + len - tail, sizeof(iv)))
        return 0;
    ...
    if (!test_true("../test/modes_internal_test.c", 215, "len == size || len + 16 == size", (len == size || len + 16 == size) != 0)
            || !test_mem_eq("../test/modes_internal_test.c", 216, "cleartext", "test_input", cleartext, len, test_input, len)
            || !test_mem_eq("../test/modes_internal_test.c", 217, "iv", "vector + len - tail", iv, sizeof(iv), vector + len - tail, sizeof(iv)))
        return 0;


    memcpy(iv, test_iv, test_iv_len);
    if (!test_size_t_eq("../test/modes_internal_test.c", 222, "fixture->encrypt_stream(test_input, ciphertext, len, encrypt_key_schedule, iv, (cbc128_f) AES_cbc_encrypt)", "len", fixture->encrypt_stream(test_input, ciphertext, len, encrypt_key_schedule, iv, (cbc128_f) AES_cbc_encrypt), len)



            || !test_mem_eq("../test/modes_internal_test.c", 226, "ciphertext", "vector", ciphertext, len, vector, len)
            || !test_mem_eq("../test/modes_internal_test.c", 227, "iv", "vector + len - tail", iv, sizeof(iv), vector + len - tail, sizeof(iv)))
        return 0;


    memcpy(iv, test_iv, test_iv_len);
    if (!test_size_t_eq("../test/modes_internal_test.c", 232, "fixture->decrypt_stream(ciphertext, cleartext, len, decrypt_key_schedule, iv, (cbc128_f)AES_cbc_encrypt)", "len", fixture->decrypt_stream(ciphertext, cleartext, len, decrypt_key_schedule, iv, (cbc128_f)AES_cbc_encrypt), len)



            || !test_mem_eq("../test/modes_internal_test.c", 236, "cleartext", "test_input", cleartext, len, test_input, len)
            || !test_mem_eq("../test/modes_internal_test.c", 237, "iv", "vector + len - tail", iv, sizeof(iv), vector + len - tail, sizeof(iv)))
        return 0;
...
# 272 "../test/modes_internal_test.c"
...
# 814 "../test/modes_internal_test.c"
static struct gcm128_data {
    ...
    { {sizeof(K1), K1}, {sizeof(IV1), IV1}, {sizeof(A1), A1}, {sizeof(P1), P1}, {sizeof(C1), C1}, {sizeof(T1), T1} },
    { {sizeof(K1), K1}, {sizeof(IV1), IV1}, {sizeof(A1), A1}, {sizeof(P2), P2}, {sizeof(C2), C2}, {sizeof(T2), T2} },
    { {sizeof(K3), K3}, {sizeof(IV3), IV3}, {sizeof(A1), A1}, {sizeof(P3), P3}, {sizeof(C3), C3}, {sizeof(T3), T3} },
    { {sizeof(K3), K3}, {sizeof(IV3), IV3}, {sizeof(A4), A4}, {sizeof(P4), P4}, {sizeof(C4), C4}, {sizeof(T4), T4} },
    { {sizeof(K3), K3}, {sizeof(IV5), IV5}, {sizeof(A4), A4}, {sizeof(P4), P4}, {sizeof(C5), C5}, {sizeof(T5), T5} },
    { {sizeof(K3), K3}, {sizeof(IV6), IV6}, {sizeof(A4), A4}, {sizeof(P4), P4}, {sizeof(C6), C6}, {sizeof(T6), T6} },
    { {sizeof(K7), K7}, {sizeof(IV7), IV7}, {sizeof(A7), A7}, {sizeof(P7), P7}, {sizeof(C7), C7}, {sizeof(T7), T7} },
    { {sizeof(K7), K7}, {sizeof(IV7), IV7}, {sizeof(A7), A7}, {sizeof(P8), P8}, {sizeof(C8), C8}, {sizeof(T8), T8} },
    { {sizeof(K9), K9}, {sizeof(IV9), IV9}, {sizeof(A7), A7}, {sizeof(P9), P9}, {sizeof(C9), C9}, {sizeof(T9), T9} },
    { {sizeof(K9), K9}, {sizeof(IV9), IV9}, {sizeof(A10), A10}, {sizeof(P10), P10}, {sizeof(C10), C10}, {sizeof(T10), T10} },
    { {sizeof(K9), K9}, {sizeof(IV11), IV11}, {sizeof(A10), A10}, {sizeof(P10), P10}, {sizeof(C11), C11}, {sizeof(T11), T11} },
    { {sizeof(K9), K9}, {sizeof(IV12), IV12}, {sizeof(A10), A10}, {sizeof(P10), P10}, {sizeof(C12), C12}, {sizeof(T12), T12} },
    { {sizeof(K13), K13}, {sizeof(IV13), IV13}, {sizeof(A13), A13}, {sizeof(P13), P13}, {sizeof(C13), C13}, {sizeof(T13), T13} },
    { {sizeof(K13), K13}, {sizeof(IV14), IV14}, {sizeof(A13), A13}, {sizeof(P14), P14}, {sizeof(C14), C14}, {sizeof(T14), T14} },
    { {sizeof(K15), K15}, {sizeof(IV15), IV15}, {sizeof(A13), A13}, {sizeof(P15), P15}, {sizeof(C15), C15}, {sizeof(T15), T15} },
    { {sizeof(K15), K15}, {sizeof(IV15), IV15}, {sizeof(A16), A16}, {sizeof(P16), P16}, {sizeof(C16), C16}, {sizeof(T16), T16} },
    { {sizeof(K15), K15}, {sizeof(IV17), IV17}, {sizeof(A16), A16}, {sizeof(P16), P16}, {sizeof(C17), C17}, {sizeof(T17), T17} },
    { {sizeof(K15), K15}, {sizeof(IV18), IV18}, {sizeof(A16), A16}, {sizeof(P16), P16}, {sizeof(C18), C18}, {sizeof(T18), T18} },
    { {sizeof(K1), K1}, {sizeof(IV1), IV1}, {sizeof(A19), A19}, {sizeof(P1), P1}, {sizeof(C1), C1}, {sizeof(T19), T19} },
    { {sizeof(K1), K1}, {sizeof(IV20), IV20}, {sizeof(A1), A1}, {sizeof(P20), P20}, {sizeof(C20), C20}, {sizeof(T20), T20} }
};
...
static int test_gcm128(int idx)
{
    ...
    if (A.size == 1)
        A.data = 
# 858 "../test/modes_internal_test.c" 3 4
                ((void *)0)
# 858 "../test/modes_internal_test.c"
                    ;
    if (P.size == 1)
        P.data = 
# 860 "../test/modes_internal_test.c" 3 4
                ((void *)0)
# 860 "../test/modes_internal_test.c"
                    ;
    if (C.size == 1)
        C.data = 
# 862 "../test/modes_internal_test.c" 3 4
                ((void *)0)
# 862 "../test/modes_internal_test.c"
                    ;
    ...
    memset(out, 0, P.size);
    if (A.data != 
# 869 "../test/modes_internal_test.c" 3 4
                 ((void *)0)
# 869 "../test/modes_internal_test.c"
                     )
        CRYPTO_gcm128_aad(&ctx, A.data, A.size);
    if (P.data != 
# 871 "../test/modes_internal_test.c" 3 4
                 ((void *)0)
# 871 "../test/modes_internal_test.c"
                     )
        if (!test_int_ge("../test/modes_internal_test.c", 872, "CRYPTO_gcm128_encrypt(&ctx, P.data, out, P.size)", "0", CRYPTO_gcm128_encrypt(&ctx, P.data, out, P.size), 0))
            return 0;
    if (!test_false("../test/modes_internal_test.c", 874, "CRYPTO_gcm128_finish(&ctx, T.data, 16)", (CRYPTO_gcm128_finish(&ctx, T.data, 16)) != 0)
            || (C.data != 
# 875 "../test/modes_internal_test.c" 3 4
                         ((void *)0)
                    
# 876 "../test/modes_internal_test.c"
                   && !test_mem_eq("../test/modes_internal_test.c", 876, "out", "C.data", out, P.size, C.data, P.size)))
        return 0;

    CRYPTO_gcm128_setiv(&ctx, IV.data, IV.size);
    memset(out, 0, P.size);
    if (A.data != 
# 881 "../test/modes_internal_test.c" 3 4
                 ((void *)0)
# 881 "../test/modes_internal_test.c"
                     )
        CRYPTO_gcm128_aad(&ctx, A.data, A.size);
    if (C.data != 
# 883 "../test/modes_internal_test.c" 3 4
                 ((void *)0)
# 883 "../test/modes_internal_test.c"
                     )
        CRYPTO_gcm128_decrypt(&ctx, C.data, out, P.size);
    if (!test_false("../test/modes_internal_test.c", 885, "CRYPTO_gcm128_finish(&ctx, T.data, 16)", (CRYPTO_gcm128_finish(&ctx, T.data, 16)) != 0)
            || (P.data != 
# 886 "../test/modes_internal_test.c" 3 4
                         ((void *)0)
                    
# 887 "../test/modes_internal_test.c"
                   && !test_mem_eq("../test/modes_internal_test.c", 887, "out", "P.data", out, P.size, P.data, P.size)))
        return 0;
...
int setup_tests(void)
{
    add_all_tests("test_aes_cts128", test_aes_cts128, (sizeof(aes_cts128_vectors)/sizeof((aes_cts128_vectors)[0])), 1);
    add_all_tests("test_aes_cts128_nist", test_aes_cts128_nist, (sizeof(aes_cts128_vectors)/sizeof((aes_cts128_vectors)[0])), 1);
    add_all_tests("test_gcm128", test_gcm128, (sizeof(gcm128_vectors)/sizeof((gcm128_vectors)[0])), 1);
    return 1;
}
