# 0 "../test/verify_extra_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/verify_extra_test.c"
# 10 "../test/verify_extra_test.c"
...
# 19 "../test/verify_extra_test.c" 2

static const char *certs_dir;
static char *root_f = 
# 21 "../test/verify_extra_test.c" 3 4
                     ((void *)0)
# 21 "../test/verify_extra_test.c"
                         ;
static char *roots_f = 
# 22 "../test/verify_extra_test.c" 3 4
                      ((void *)0)
# 22 "../test/verify_extra_test.c"
                          ;
static char *untrusted_f = 
# 23 "../test/verify_extra_test.c" 3 4
                          ((void *)0)
# 23 "../test/verify_extra_test.c"
                              ;
static char *bad_f = 
# 24 "../test/verify_extra_test.c" 3 4
                    ((void *)0)
# 24 "../test/verify_extra_test.c"
                        ;
static char *req_f = 
# 25 "../test/verify_extra_test.c" 3 4
                    ((void *)0)
# 25 "../test/verify_extra_test.c"
                        ;
static char *sroot_cert = 
# 26 "../test/verify_extra_test.c" 3 4
                         ((void *)0)
# 26 "../test/verify_extra_test.c"
                             ;
static char *ca_cert = 
# 27 "../test/verify_extra_test.c" 3 4
                      ((void *)0)
# 27 "../test/verify_extra_test.c"
                          ;
static char *ee_cert = 
# 28 "../test/verify_extra_test.c" 3 4
                      ((void *)0)
# 28 "../test/verify_extra_test.c"
                          ;
# 61 "../test/verify_extra_test.c"
static int test_alt_chains_cert_forgery(void)
{
    int ret = 0;
    int i;
    X509 *x = 
# 65 "../test/verify_extra_test.c" 3 4
             ((void *)0)
# 65 "../test/verify_extra_test.c"
                 ;
    struct stack_st_X509 *untrusted = 
# 66 "../test/verify_extra_test.c" 3 4
                               ((void *)0)
# 66 "../test/verify_extra_test.c"
                                   ;
    X509_STORE_CTX *sctx = 
# 67 "../test/verify_extra_test.c" 3 4
                          ((void *)0)
# 67 "../test/verify_extra_test.c"
                              ;
    X509_STORE *store = 
# 68 "../test/verify_extra_test.c" 3 4
                       ((void *)0)
# 68 "../test/verify_extra_test.c"
                           ;
    X509_LOOKUP *lookup = 
# 69 "../test/verify_extra_test.c" 3 4
                         ((void *)0)
# 69 "../test/verify_extra_test.c"
                             ;

    store = X509_STORE_new();
    if (store == 
# 72 "../test/verify_extra_test.c" 3 4
                ((void *)0)
# 72 "../test/verify_extra_test.c"
                    )
        goto err;

    lookup = X509_STORE_add_lookup(store, X509_LOOKUP_file());
    if (lookup == 
# 76 "../test/verify_extra_test.c" 3 4
                 ((void *)0)
# 76 "../test/verify_extra_test.c"
                     )
        goto err;
    if (!X509_LOOKUP_ctrl((lookup),1,(roots_f),(long)(1),
# 78 "../test/verify_extra_test.c" 3 4
        ((void *)0)
# 78 "../test/verify_extra_test.c"
        ))
        goto err;

    untrusted = load_certs_pem(untrusted_f);

    if ((x = load_cert_pem(bad_f, 
# 83 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 83 "../test/verify_extra_test.c"
            )) == 
# 83 "../test/verify_extra_test.c" 3 4
                                           ((void *)0)
# 83 "../test/verify_extra_test.c"
    ...
    if (sctx == 
# 87 "../test/verify_extra_test.c" 3 4
               ((void *)0)
# 87 "../test/verify_extra_test.c"
                   )
        goto err;
    ...
    if (i == 0 && X509_STORE_CTX_get_error(sctx) == 79) {
...
{
    X509 *x = 
# 109 "../test/verify_extra_test.c" 3 4
             ((void *)0)
# 109 "../test/verify_extra_test.c"
                 ;
    int ret = 0;
    ASN1_OCTET_STRING *v = 
# 111 "../test/verify_extra_test.c" 3 4
                          ((void *)0)
# 111 "../test/verify_extra_test.c"
                              , *v2 = 
# 111 "../test/verify_extra_test.c" 3 4
                                      ((void *)0)
# 111 "../test/verify_extra_test.c"
    ...
    x = load_cert_pem(bad_f, 
# 114 "../test/verify_extra_test.c" 3 4
       ((void *)0)
# 114 "../test/verify_extra_test.c"
       );
    if (x == 
# 115 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 115 "../test/verify_extra_test.c"
                )
        goto err;

    v = ASN1_OCTET_STRING_new();
    if (v == 
# 119 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 119 "../test/verify_extra_test.c"
                )
        goto err;
    ...
    if (!test_ptr("../test/verify_extra_test.c", 131, "v2", v2)
            || !test_int_eq("../test/verify_extra_test.c", 132, "ASN1_OCTET_STRING_cmp(v, v2)", "0", ASN1_OCTET_STRING_cmp(v, v2), 0))
        goto err;
...
{
    X509_REQ *x = 
# 143 "../test/verify_extra_test.c" 3 4
                 ((void *)0)
# 143 "../test/verify_extra_test.c"
                     ;
    BIO *bio = 
# 144 "../test/verify_extra_test.c" 3 4
              ((void *)0)
# 144 "../test/verify_extra_test.c"
                  ;
    int ret = 0;
    ASN1_OCTET_STRING *v = 
# 146 "../test/verify_extra_test.c" 3 4
                          ((void *)0)
# 146 "../test/verify_extra_test.c"
                              , *v2 = 
# 146 "../test/verify_extra_test.c" 3 4
                                      ((void *)0)
# 146 "../test/verify_extra_test.c"
    ...
    if (bio == 
# 150 "../test/verify_extra_test.c" 3 4
              ((void *)0)
# 150 "../test/verify_extra_test.c"
                  )
        goto err;

    x = PEM_read_bio_X509_REQ(bio, 
# 153 "../test/verify_extra_test.c" 3 4
                                  ((void *)0)
# 153 "../test/verify_extra_test.c"
                                      , 0, 
# 153 "../test/verify_extra_test.c" 3 4
                                           ((void *)0)
# 153 "../test/verify_extra_test.c"
    ...
    if (x == 
# 154 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 154 "../test/verify_extra_test.c"
                )
        goto err;

    v = ASN1_OCTET_STRING_new();
    if (v == 
# 158 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 158 "../test/verify_extra_test.c"
                )
        goto err;
    ...
    if (!test_ptr("../test/verify_extra_test.c", 170, "v2", v2)
            || !test_int_eq("../test/verify_extra_test.c", 171, "ASN1_OCTET_STRING_cmp(v, v2)", "0", ASN1_OCTET_STRING_cmp(v, v2), 0))
        goto err;
...
# 183 "../test/verify_extra_test.c" 3 4
                ((void *)0)
# 183 "../test/verify_extra_test.c"
                );
    struct stack_st_X509 *trusted = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    X509_STORE_CTX *ctx = X509_STORE_CTX_new();
    int ret;

    ret = test_int_eq("../test/verify_extra_test.c", 188, "X509_self_signed(cert, 1)", "expected", X509_self_signed(cert, 1), expected);

    if (cert != 
# 190 "../test/verify_extra_test.c" 3 4
               ((void *)0)
# 190 "../test/verify_extra_test.c"
                   ) {
        if (use_trusted)
            ret = ret && test_true("../test/verify_extra_test.c", 192, "sk_X509_push(trusted, cert)", (OPENSSL_sk_push(ossl_check_X509_sk_type(trusted), ossl_check_X509_type(cert))) != 0);
        ret = ret && test_true("../test/verify_extra_test.c", 193, "X509_STORE_CTX_init(ctx, NULL, cert, NULL)", (X509_STORE_CTX_init(ctx, 
# 193 "../test/verify_extra_test.c" 3 4
                    ((void *)0)
# 193 "../test/verify_extra_test.c"
                    , cert, 
# 193 "../test/verify_extra_test.c" 3 4
                    ((void *)0)
# 193 "../test/verify_extra_test.c"
        ...
        ret = ret && test_int_eq("../test/verify_extra_test.c", 195, "X509_verify_cert(ctx)", "expected", X509_verify_cert(ctx), expected);
    }

    X509_STORE_CTX_free(ctx);
    OPENSSL_sk_free(ossl_check_X509_sk_type(trusted));
    X509_free(cert);
    return ret;
}
...
{
    X509 *eecert = load_cert_pem(ee_cert, 
# 227 "../test/verify_extra_test.c" 3 4
                  ((void *)0)
# 227 "../test/verify_extra_test.c"
                  );
    X509 *untrcert = load_cert_pem(ca_cert, 
# 228 "../test/verify_extra_test.c" 3 4
                    ((void *)0)
# 228 "../test/verify_extra_test.c"
                    );
    X509 *trcert = load_cert_pem(sroot_cert, 
# 229 "../test/verify_extra_test.c" 3 4
                  ((void *)0)
# 229 "../test/verify_extra_test.c"
                  );
    struct stack_st_X509 *trusted = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    struct stack_st_X509 *untrusted = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    X509_STORE_CTX *ctx = X509_STORE_CTX_new();
    int testresult = 0;

    if (!test_ptr("../test/verify_extra_test.c", 235, "eecert", eecert)
            || !test_ptr("../test/verify_extra_test.c", 236, "untrcert", untrcert)
            || !test_ptr("../test/verify_extra_test.c", 237, "trcert", trcert)
            || !test_ptr("../test/verify_extra_test.c", 238, "trusted", trusted)
            || !test_ptr("../test/verify_extra_test.c", 239, "untrusted", untrusted)
            || !test_ptr("../test/verify_extra_test.c", 240, "ctx", ctx))
        goto err;


    if (!test_true("../test/verify_extra_test.c", 244, "sk_X509_push(trusted, trcert)", (OPENSSL_sk_push(ossl_check_X509_sk_type(trusted), ossl_check_X509_type(trcert))) != 0))
        goto err;
    trcert = 
# 246 "../test/verify_extra_test.c" 3 4
            ((void *)0)
# 246 "../test/verify_extra_test.c"
                ;
    if (!test_true("../test/verify_extra_test.c", 247, "sk_X509_push(untrusted, untrcert)", (OPENSSL_sk_push(ossl_check_X509_sk_type(untrusted), ossl_check_X509_type(untrcert))) != 0))
        goto err;
    untrcert = 
# 249 "../test/verify_extra_test.c" 3 4
              ((void *)0)
# 249 "../test/verify_extra_test.c"
                  ;

    if (!test_true("../test/verify_extra_test.c", 251, "X509_STORE_CTX_init(ctx, NULL, eecert, untrusted)", (X509_STORE_CTX_init(ctx, 
# 251 "../test/verify_extra_test.c" 3 4
        ((void *)0)
# 251 "../test/verify_extra_test.c"
        , eecert, untrusted)) != 0))
        goto err;

    if (!test_true("../test/verify_extra_test.c", 254, "X509_STORE_CTX_set_purpose(ctx, purpose)", (X509_STORE_CTX_set_purpose(ctx, purpose)) != 0))
        goto err;
    ...
    if (!test_int_eq("../test/verify_extra_test.c", 264, "X509_verify_cert(ctx)", "expected", X509_verify_cert(ctx), expected))
        goto err;
...
{
    return do_test_purpose(1, 0);
}

static int test_purpose_ssl_server(void)
{
    return do_test_purpose(2, 1);
}

static int test_purpose_any(void)
{
    return do_test_purpose(7, 1);
}

const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "certs-dir\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 293 "../test/verify_extra_test.c" 3 4
((void *)0) 
# 293 "../test/verify_extra_test.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/verify_extra_test.c", 298, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/verify_extra_test.c", 302, "certs_dir = test_get_argument(0)", certs_dir = test_get_argument(0)))
        return 0;

    if (!test_ptr("../test/verify_extra_test.c", 305, "root_f = test_mk_file_path(certs_dir, \"rootCA.pem\")", root_f = test_mk_file_path(certs_dir, "rootCA.pem"))
            || !test_ptr("../test/verify_extra_test.c", 306, "roots_f = test_mk_file_path(certs_dir, \"roots.pem\")", roots_f = test_mk_file_path(certs_dir, "roots.pem"))
            || !test_ptr("../test/verify_extra_test.c", 307, "untrusted_f = test_mk_file_path(certs_dir, \"untrusted.pem\")", untrusted_f = test_mk_file_path(certs_dir, "untrusted.pem"))
            || !test_ptr("../test/verify_extra_test.c", 308, "bad_f = test_mk_file_path(certs_dir, \"bad.pem\")", bad_f = test_mk_file_path(certs_dir, "bad.pem"))
            || !test_ptr("../test/verify_extra_test.c", 309, "req_f = test_mk_file_path(certs_dir, \"sm2-csr.pem\")", req_f = test_mk_file_path(certs_dir, "sm2-csr.pem"))
            || !test_ptr("../test/verify_extra_test.c", 310, "sroot_cert = test_mk_file_path(certs_dir, \"sroot-cert.pem\")", sroot_cert = test_mk_file_path(certs_dir, "sroot-cert.pem"))
            || !test_ptr("../test/verify_extra_test.c", 311, "ca_cert = test_mk_file_path(certs_dir, \"ca-cert.pem\")", ca_cert = test_mk_file_path(certs_dir, "ca-cert.pem"))
            || !test_ptr("../test/verify_extra_test.c", 312, "ee_cert = test_mk_file_path(certs_dir, \"ee-cert.pem\")", ee_cert = test_mk_file_path(certs_dir, "ee-cert.pem")))
        goto err;
...
void cleanup_tests(void)
{
    CRYPTO_free(root_f, "../test/verify_extra_test.c", 333);
    CRYPTO_free(roots_f, "../test/verify_extra_test.c", 334);
    CRYPTO_free(untrusted_f, "../test/verify_extra_test.c", 335);
    CRYPTO_free(bad_f, "../test/verify_extra_test.c", 336);
    CRYPTO_free(req_f, "../test/verify_extra_test.c", 337);
    CRYPTO_free(sroot_cert, "../test/verify_extra_test.c", 338);
    CRYPTO_free(ca_cert, "../test/verify_extra_test.c", 339);
    CRYPTO_free(ee_cert, "../test/verify_extra_test.c", 340);
}
