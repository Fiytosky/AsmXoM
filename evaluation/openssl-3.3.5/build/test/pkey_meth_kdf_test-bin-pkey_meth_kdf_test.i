# 0 "../test/pkey_meth_kdf_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pkey_meth_kdf_test.c"
# 12 "../test/pkey_meth_kdf_test.c"
...
# 13 "../test/pkey_meth_kdf_test.c" 2
...
# 14 "../test/pkey_meth_kdf_test.c" 2
...
# 16 "../test/pkey_meth_kdf_test.c" 2
...
# 17 "../test/pkey_meth_kdf_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 18 "../test/pkey_meth_kdf_test.c" 2
...
static int test_kdf_tls1_prf(int index)
{
    ...
    if ((pctx = EVP_PKEY_CTX_new_id(1021, 
# 26 "../test/pkey_meth_kdf_test.c" 3 4
                                                      ((void *)0)
# 26 "../test/pkey_meth_kdf_test.c"
                                                          )) == 
# 26 "../test/pkey_meth_kdf_test.c" 3 4
                                                                ((void *)0)
# 26 "../test/pkey_meth_kdf_test.c"
                                                                    ) {
        test_error("../test/pkey_meth_kdf_test.c", 27, "EVP_PKEY_TLS1_PRF");
        goto err;
    }
    if (EVP_PKEY_derive_init(pctx) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 31, "EVP_PKEY_derive_init");
        goto err;
    }
    if (EVP_PKEY_CTX_set_tls1_prf_md(pctx, EVP_sha256()) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 35, "EVP_PKEY_CTX_set_tls1_prf_md");
        goto err;
    }
    if (EVP_PKEY_CTX_set1_tls1_prf_secret(pctx,
                                          (unsigned char *)"secret", 6) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 40, "EVP_PKEY_CTX_set1_tls1_prf_secret");
        goto err;
    }
    if (index == 0) {
        if (EVP_PKEY_CTX_add1_tls1_prf_seed(pctx,
                                            (unsigned char *)"seed", 4) <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 46, "EVP_PKEY_CTX_add1_tls1_prf_seed");
            goto err;
        }
    } else {
        if (EVP_PKEY_CTX_add1_tls1_prf_seed(pctx,
                                            (unsigned char *)"se", 2) <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 52, "EVP_PKEY_CTX_add1_tls1_prf_seed");
            goto err;
        }
        if (EVP_PKEY_CTX_add1_tls1_prf_seed(pctx,
                                            (unsigned char *)"ed", 2) <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 57, "EVP_PKEY_CTX_add1_tls1_prf_seed");
            goto err;
        }
    }
    if (EVP_PKEY_derive(pctx, out, &outlen) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 62, "EVP_PKEY_derive");
        goto err;
    }

    {
        ...
        if (!test_mem_eq("../test/pkey_meth_kdf_test.c", 71, "out", "expected", out, sizeof(out), expected, sizeof(expected))) {
            goto err;
        }
    }
    ret = 1;
...
static int test_kdf_hkdf(int index)
{
    ...
    if ((pctx = EVP_PKEY_CTX_new_id(1036, 
# 88 "../test/pkey_meth_kdf_test.c" 3 4
                                                  ((void *)0)
# 88 "../test/pkey_meth_kdf_test.c"
                                                      )) == 
# 88 "../test/pkey_meth_kdf_test.c" 3 4
                                                            ((void *)0)
# 88 "../test/pkey_meth_kdf_test.c"
                                                                ) {
        test_error("../test/pkey_meth_kdf_test.c", 89, "EVP_PKEY_HKDF");
        goto err;
    }
    if (EVP_PKEY_derive_init(pctx) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 93, "EVP_PKEY_derive_init");
        goto err;
    }
    if (EVP_PKEY_CTX_set_hkdf_md(pctx, EVP_sha256()) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 97, "EVP_PKEY_CTX_set_hkdf_md");
        goto err;
    }
    if (EVP_PKEY_CTX_set1_hkdf_salt(pctx, (const unsigned char *)"salt", 4)
            <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 102, "EVP_PKEY_CTX_set1_hkdf_salt");
        goto err;
    }
    if (EVP_PKEY_CTX_set1_hkdf_key(pctx, (const unsigned char *)"secret", 6)
            <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 107, "EVP_PKEY_CTX_set1_hkdf_key");
        goto err;
    }
    if (index == 0) {
        if (EVP_PKEY_CTX_add1_hkdf_info(pctx, (const unsigned char *)"label", 5)
            <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 113, "EVP_PKEY_CTX_add1_hkdf_info");
            goto err;
        }
    } else {
        if (EVP_PKEY_CTX_add1_hkdf_info(pctx, (const unsigned char *)"lab", 3)
            <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 119, "EVP_PKEY_CTX_add1_hkdf_info");
            goto err;
        }
        if (EVP_PKEY_CTX_add1_hkdf_info(pctx, (const unsigned char *)"el", 2)
            <= 0) {
            test_error("../test/pkey_meth_kdf_test.c", 124, "EVP_PKEY_CTX_add1_hkdf_info");
            goto err;
        }
    }
    if (EVP_PKEY_derive(pctx, out, &outlen) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 129, "EVP_PKEY_derive");
        goto err;
    }

    {
        ...
        if (!test_mem_eq("../test/pkey_meth_kdf_test.c", 137, "out", "expected", out, sizeof(out), expected, sizeof(expected))) {
            goto err;
        }
    }
    ret = 1;
...
static int test_kdf_scrypt(void)
{
    ...
    if ((pctx = EVP_PKEY_CTX_new_id(973, 
# 155 "../test/pkey_meth_kdf_test.c" 3 4
                                                    ((void *)0)
# 155 "../test/pkey_meth_kdf_test.c"
                                                        )) == 
# 155 "../test/pkey_meth_kdf_test.c" 3 4
                                                              ((void *)0)
# 155 "../test/pkey_meth_kdf_test.c"
                                                                  ) {
        test_error("../test/pkey_meth_kdf_test.c", 156, "EVP_PKEY_SCRYPT");
        goto err;
    }
    if (EVP_PKEY_derive_init(pctx) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 160, "EVP_PKEY_derive_init");
        goto err;
    }
    if (EVP_PKEY_CTX_set1_pbe_pass(pctx, "password", 8) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 164, "EVP_PKEY_CTX_set1_pbe_pass");
        goto err;
    }
    if (EVP_PKEY_CTX_set1_scrypt_salt(pctx, (unsigned char *)"NaCl", 4) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 168, "EVP_PKEY_CTX_set1_scrypt_salt");
        goto err;
    }
    if (EVP_PKEY_CTX_set_scrypt_N(pctx, 1024) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 172, "EVP_PKEY_CTX_set_scrypt_N");
        goto err;
    }
    if (EVP_PKEY_CTX_set_scrypt_r(pctx, 8) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 176, "EVP_PKEY_CTX_set_scrypt_r");
        goto err;
    }
    if (EVP_PKEY_CTX_set_scrypt_p(pctx, 16) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 180, "EVP_PKEY_CTX_set_scrypt_p");
        goto err;
    }
    if (EVP_PKEY_CTX_set_scrypt_maxmem_bytes(pctx, 16) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 184, "EVP_PKEY_CTX_set_maxmem_bytes");
        goto err;
    }
    if (EVP_PKEY_derive(pctx, out, &outlen) > 0) {
        test_error("../test/pkey_meth_kdf_test.c", 188, "EVP_PKEY_derive should have failed");
        goto err;
    }
    if (EVP_PKEY_CTX_set_scrypt_maxmem_bytes(pctx, 10 * 1024 * 1024) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 192, "EVP_PKEY_CTX_set_maxmem_bytes");
        goto err;
    }
    if (EVP_PKEY_derive(pctx, out, &outlen) <= 0) {
        test_error("../test/pkey_meth_kdf_test.c", 196, "EVP_PKEY_derive");
        goto err;
    }

    {
        ...
        if (!test_mem_eq("../test/pkey_meth_kdf_test.c", 211, "out", "expected", out, sizeof(out), expected, sizeof(expected))) {
            goto err;
        }
    }
    ret = 1;
...
# 226 "../test/pkey_meth_kdf_test.c" 3 4
                                ((void *)0)
# 226 "../test/pkey_meth_kdf_test.c"
                                    , 3, 3, 1))
        tests = 2;

    add_all_tests("test_kdf_tls1_prf", test_kdf_tls1_prf, tests, 1);
    add_all_tests("test_kdf_hkdf", test_kdf_hkdf, tests, 1);
