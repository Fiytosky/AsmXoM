# 0 "../test/x509_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/x509_internal_test.c"
# 12 "../test/x509_internal_test.c"
...
# 13 "../test/x509_internal_test.c" 2
...
# 14 "../test/x509_internal_test.c" 2
...
# 16 "../test/x509_internal_test.c" 2
...
# 17 "../test/x509_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 18 "../test/x509_internal_test.c" 2
# 26 "../test/x509_internal_test.c"
# 1 "../test/../crypto/x509/ext_dat.h" 1
# 10 "../test/../crypto/x509/ext_dat.h"
...
# 27 "../test/x509_internal_test.c" 2
# 1 "../test/../crypto/x509/standard_exts.h" 1
# 15 "../test/../crypto/x509/standard_exts.h"
...
# 28 "../test/x509_internal_test.c" 2
...
static int test_standard_exts(void)
{
    ...
    tmp = standard_exts;
    for (i = 0; i < (sizeof(standard_exts)/sizeof((standard_exts)[0])); i++, tmp++) {
        if ((*tmp)->ext_nid < prev)
            good = 0;
        prev = (*tmp)->ext_nid;
    ...
    if (!good) {
        tmp = standard_exts;
        test_error("../test/x509_internal_test.c", 44, "Extensions out of order!");
        for (i = 0; i < (sizeof(standard_exts)/sizeof((standard_exts)[0])); i++, tmp++)
...
static IP_TESTDATA a2i_ipaddress_tests[] = {
    ...
    {"1.2.3", 
# 61 "../test/x509_internal_test.c" 3 4
             ((void *)0)
# 61 "../test/x509_internal_test.c"
                 , 0},
    {"1.2.3 .4", 
# 62 "../test/x509_internal_test.c" 3 4
                ((void *)0)
# 62 "../test/x509_internal_test.c"
                    , 0},
...
# 67 "../test/x509_internal_test.c" 3 4
                            ((void *)0)
# 67 "../test/x509_internal_test.c"
                                , 0},
    {":::1", 
# 68 "../test/x509_internal_test.c" 3 4
            ((void *)0)
# 68 "../test/x509_internal_test.c"
                , 0},
    {"2001::123g", 
# 69 "../test/x509_internal_test.c" 3 4
                  ((void *)0)
# 69 "../test/x509_internal_test.c"
                      , 0},

    {"example.test", 
# 71 "../test/x509_internal_test.c" 3 4
                    ((void *)0)
# 71 "../test/x509_internal_test.c"
                        , 0},
    {"", 
# 72 "../test/x509_internal_test.c" 3 4
        ((void *)0)
# 72 "../test/x509_internal_test.c"
            , 0},
...
# 77 "../test/x509_internal_test.c" 3 4
                            ((void *)0)
# 77 "../test/x509_internal_test.c"
                                , 0},
};
...
static int test_a2i_ipaddress(int idx)
{
    ...
    if (len == 0) {
        if (!test_ptr_null("../test/x509_internal_test.c", 89, "ip", ip)) {
            good = 0;
            test_note("'%s' should not be parsed as IP address", a2i_ipaddress_tests[idx].ipasc);
        }
    } else {
        if (!test_ptr("../test/x509_internal_test.c", 94, "ip", ip)
            || !test_int_eq("../test/x509_internal_test.c", 95, "ASN1_STRING_length(ip)", "len", ASN1_STRING_length(ip), len)
            || !test_mem_eq("../test/x509_internal_test.c", 96, "ASN1_STRING_get0_data(ip)", "a2i_ipaddress_tests[idx].data", ASN1_STRING_get0_data(ip), len, a2i_ipaddress_tests[idx].data, len)
                                                               ) {
            good = 0;
        }
    }
...
int setup_tests(void)
{
    ...
    add_all_tests("test_a2i_ipaddress", test_a2i_ipaddress, (sizeof(a2i_ipaddress_tests)/sizeof((a2i_ipaddress_tests)[0])), 1);
    return 1;
}
