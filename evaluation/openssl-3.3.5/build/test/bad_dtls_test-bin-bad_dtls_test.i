...
{
    EVP_PKEY_CTX *pctx = EVP_PKEY_CTX_new_id(1021, 
# 70 "../test/bad_dtls_test.c" 3 4
                                                               ((void *)0)
# 70 "../test/bad_dtls_test.c"
                                                                   );
    size_t outlen = olen;
...
static SSL_SESSION *client_session(void)
{
    ...
    return d2i_SSL_SESSION(
# 113 "../test/bad_dtls_test.c" 3 4
                          ((void *)0)
# 113 "../test/bad_dtls_test.c"
                              , &p, sizeof(session_asn1));
}
...
static int validate_client_hello(BIO *wbio)
{
    ...
    (void)(int)BIO_ctrl(wbio,1,0,
# 190 "../test/bad_dtls_test.c" 3 4
         ((void *)0)
# 190 "../test/bad_dtls_test.c"
         );
                       ...
                       const void *msg, size_t len)
{
    ...
    EVP_MAC *hmac = 
# 284 "../test/bad_dtls_test.c" 3 4
                   ((void *)0)
# 284 "../test/bad_dtls_test.c"
                       ;
    EVP_MAC_CTX *ctx = 
# 285 "../test/bad_dtls_test.c" 3 4
                      ((void *)0)
# 285 "../test/bad_dtls_test.c"
                          ;
    EVP_CIPHER_CTX *enc_ctx = 
# 286 "../test/bad_dtls_test.c" 3 4
                             ((void *)0)
# 286 "../test/bad_dtls_test.c"
                                 ;
    unsigned char iv[16];
    unsigned char pad;
    unsigned char *enc;
    ...
    if (enc == 
# 302 "../test/bad_dtls_test.c" 3 4
              ((void *)0)
# 302 "../test/bad_dtls_test.c"
                  )
        return 0;
    ...
    if (!test_ptr("../test/bad_dtls_test.c", 309, "hmac = EVP_MAC_fetch(NULL, \"HMAC\", NULL)", hmac = EVP_MAC_fetch(
# 309 "../test/bad_dtls_test.c" 3 4
        ((void *)0)
# 309 "../test/bad_dtls_test.c"
        , "HMAC", 
# 309 "../test/bad_dtls_test.c" 3 4
        ((void *)0)
# 309 "../test/bad_dtls_test.c"
    ...
    if (!EVP_MAC_init(ctx, (key_block + 20), 20, params)
            ...
            || !EVP_MAC_final(ctx, enc + len, 
# 324 "../test/bad_dtls_test.c" 3 4
                                             ((void *)0)
# 324 "../test/bad_dtls_test.c"
                                                 , 20))
        goto end;
    ...
    if (!test_int_gt("../test/bad_dtls_test.c", 334, "RAND_bytes(iv, sizeof(iv))", "0", RAND_bytes(iv, sizeof(iv)), 0)
            ...
            || !test_true("../test/bad_dtls_test.c", 336, "EVP_CipherInit_ex(enc_ctx, EVP_aes_128_cbc(), NULL, enc_key, iv, 1)", (EVP_CipherInit_ex(enc_ctx, EVP_aes_128_cbc(), 
# 336 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 336 "../test/bad_dtls_test.c"
               , (key_block + 56), iv, 1)) != 0)
...
static int send_finished(SSL *s, BIO *rbio)
{
    ...
    if (!EVP_DigestFinal_ex(handshake_md, handshake_hash, 
# 381 "../test/bad_dtls_test.c" 3 4
                                                         ((void *)0)
# 381 "../test/bad_dtls_test.c"
                                                             ))
        return 0;
...
# 386 "../test/bad_dtls_test.c" 3 4
          ((void *)0)
# 386 "../test/bad_dtls_test.c"
              , 0,
           finished_msg + 12, 12);
...
{
    SSL_SESSION *sess = 
# 465 "../test/bad_dtls_test.c" 3 4
                       ((void *)0)
# 465 "../test/bad_dtls_test.c"
                           ;
    SSL_CTX *ctx = 
# 466 "../test/bad_dtls_test.c" 3 4
                  ((void *)0)
# 466 "../test/bad_dtls_test.c"
                      ;
    SSL *con = 
# 467 "../test/bad_dtls_test.c" 3 4
              ((void *)0)
# 467 "../test/bad_dtls_test.c"
                  ;
    BIO *rbio = 
# 468 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 468 "../test/bad_dtls_test.c"
                   ;
    BIO *wbio = 
# 469 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 469 "../test/bad_dtls_test.c"
                   ;
    time_t now = 0;
    int testresult = 0;
    int ret;
    ...
    now = time(
# 480 "../test/bad_dtls_test.c" 3 4
              ((void *)0)
# 480 "../test/bad_dtls_test.c"
                  );
    ...
    if (!test_ptr("../test/bad_dtls_test.c", 488, "handshake_md", handshake_md)
            || !test_true("../test/bad_dtls_test.c", 489, "EVP_DigestInit_ex(handshake_md, EVP_md5_sha1(), NULL)", (EVP_DigestInit_ex(handshake_md, EVP_md5_sha1(), 
# 489 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 489 "../test/bad_dtls_test.c"
               )) != 0)
                                                  )
        goto end;

    ctx = SSL_CTX_new(DTLS_client_method());
    if (!test_ptr("../test/bad_dtls_test.c", 494, "ctx", ctx)
            || !test_true("../test/bad_dtls_test.c", 495, "SSL_CTX_set_min_proto_version(ctx, DTLS1_BAD_VER)", (SSL_CTX_ctrl(ctx, 123, 0x0100, 
# 495 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 495 "../test/bad_dtls_test.c"
               )) != 0)
            || !test_true("../test/bad_dtls_test.c", 496, "SSL_CTX_set_max_proto_version(ctx, DTLS1_BAD_VER)", (SSL_CTX_ctrl(ctx, 124, 0x0100, 
# 496 "../test/bad_dtls_test.c" 3 4
               ((void *)0)
# 496 "../test/bad_dtls_test.c"
               )) != 0)
            || !test_true("../test/bad_dtls_test.c", 497, "SSL_CTX_set_options(ctx, SSL_OP_LEGACY_SERVER_CONNECT)", (SSL_CTX_set_options(ctx, ((uint64_t)1 << (uint64_t)2))) != 0)

            || !test_true("../test/bad_dtls_test.c", 499, "SSL_CTX_set_cipher_list(ctx, \"AES128-SHA\")", (SSL_CTX_set_cipher_list(ctx, "AES128-SHA")) != 0))
        goto end;

    SSL_CTX_set_security_level(ctx, 0);
    con = SSL_new(ctx);
    if (!test_ptr("../test/bad_dtls_test.c", 504, "con", con)
            || !test_true("../test/bad_dtls_test.c", 505, "SSL_set_session(con, sess)", (SSL_set_session(con, sess)) != 0))
        goto end;

    rbio = BIO_new(BIO_s_mem());
    wbio = BIO_new(BIO_s_mem());

    if (!test_ptr("../test/bad_dtls_test.c", 511, "rbio", rbio)
            || !test_ptr("../test/bad_dtls_test.c", 512, "wbio", wbio))
        goto end;

    SSL_set_bio(con, rbio, wbio);

    if (!test_true("../test/bad_dtls_test.c", 517, "BIO_up_ref(rbio)", (BIO_up_ref(rbio)) != 0)) {




        rbio = wbio = 
# 522 "../test/bad_dtls_test.c" 3 4
                     ((void *)0)
# 522 "../test/bad_dtls_test.c"
                         ;
        goto end;
    }

    if (!test_true("../test/bad_dtls_test.c", 526, "BIO_up_ref(wbio)", (BIO_up_ref(wbio)) != 0)) {
        wbio = 
# 527 "../test/bad_dtls_test.c" 3 4
              ((void *)0)
# 527 "../test/bad_dtls_test.c"
                  ;
        goto end;
    }
    ...
    if (!test_int_le("../test/bad_dtls_test.c", 535, "ret", "0", ret, 0)
            || !test_int_eq("../test/bad_dtls_test.c", 536, "SSL_get_error(con, ret)", "SSL_ERROR_WANT_READ", SSL_get_error(con, ret), 2)
            || !test_int_eq("../test/bad_dtls_test.c", 537, "validate_client_hello(wbio)", "1", validate_client_hello(wbio), 1)
            || !test_true("../test/bad_dtls_test.c", 538, "send_hello_verify(rbio)", (send_hello_verify(rbio)) != 0))
        goto end;

    ret = SSL_do_handshake(con);
    if (!test_int_le("../test/bad_dtls_test.c", 542, "ret", "0", ret, 0)
            || !test_int_eq("../test/bad_dtls_test.c", 543, "SSL_get_error(con, ret)", "SSL_ERROR_WANT_READ", SSL_get_error(con, ret), 2)
            || !test_int_eq("../test/bad_dtls_test.c", 544, "validate_client_hello(wbio)", "2", validate_client_hello(wbio), 2)
            || !test_true("../test/bad_dtls_test.c", 545, "send_server_hello(rbio)", (send_server_hello(rbio)) != 0))
        goto end;

    ret = SSL_do_handshake(con);
    if (!test_int_le("../test/bad_dtls_test.c", 549, "ret", "0", ret, 0)
            || !test_int_eq("../test/bad_dtls_test.c", 550, "SSL_get_error(con, ret)", "SSL_ERROR_WANT_READ", SSL_get_error(con, ret), 2)
            || !test_true("../test/bad_dtls_test.c", 551, "send_finished(con, rbio)", (send_finished(con, rbio)) != 0))
        goto end;

    ret = SSL_do_handshake(con);
    if (!test_int_gt("../test/bad_dtls_test.c", 555, "ret", "0", ret, 0)
            || !test_true("../test/bad_dtls_test.c", 556, "validate_ccs(wbio)", (validate_ccs(wbio)) != 0))
        goto end;
    ...
    for (i = 0; i < (int)(sizeof(tests)/sizeof((tests)[0])); i++) {
        ...
        if (!test_true("../test/bad_dtls_test.c", 567, "send_record(rbio, SSL3_RT_APPLICATION_DATA, tests[i].seq, &tests[i].seq, sizeof(uint64_t))", (send_record(rbio, 23, tests[i].seq, &tests[i].seq, sizeof(uint64_t))) != 0)
                                                                    ) {
            test_error("../test/bad_dtls_test.c", 569, "Failed to send data seq #0x%x%08x (%d)\n", (unsigned int)(tests[i].seq >> 32), (unsigned int)tests[i].seq, i)
                                                                                         ;
            goto end;
        }
        ...
        if (!test_int_eq("../test/bad_dtls_test.c", 578, "ret", "(int)sizeof(uint64_t)", ret, (int)sizeof(uint64_t))) {
            test_error("../test/bad_dtls_test.c", 579, "SSL_read failed or wrong size on seq#0x%x%08x (%d)\n", (unsigned int)(tests[i].seq >> 32), (unsigned int)tests[i].seq, i)
                                                                                         ;
            goto end;
        }
        if (!test_true("../test/bad_dtls_test.c", 583, "recv_buf[0] == tests[i].seq", (recv_buf[0] == tests[i].seq) != 0))
            goto end;
    }


    if (!test_false("../test/bad_dtls_test.c", 588, "tests[i-1].drop", (tests[i-1].drop) != 0))
        goto end;
