# 0 "../test/time_offset_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/time_offset_test.c"
# 12 "../test/time_offset_test.c"
...
# 34 "../test/time_offset_test.c"
static TESTDATA tests[] = {
    { "20001201000000Z", 0, 24 },
    { "20001201010000+0100", 0, 24 },
    { "20001201050000+0500", 0, 24 },
    { "20001130230000-0100", 0, 24 },
    { "20001130190000-0500", 0, 24 },
    { "20001130190001-0500", 1, 24 },
    { "20001130185959-0500", -1, 24 },
    { "001201000000Z", 0, 23 },
    { "001201010000+0100", 0, 23 },
    { "001201050000+0500", 0, 23 },
    { "001130230000-0100", 0, 23 },
    { "001130190000-0500", 0, 23 },
    { "001201000000-0000", 0, 23 },
    { "001201000001-0000", 1, 23 },
    { "001130235959-0000", -1, 23 },
    { "20001201000000+0000", 0, 24 },
    { "20001201000000+0100", -1, 24 },
    { "001201000000+0100", -1, 23 },
    { "20001201000000-0100", 1, 24 },
    { "001201000000-0100", 1, 23 },
    { "20001201123400+1234", 0, 24 },
    { "20001130112600-1234", 0, 24 },
};
...
static int test_offset(int idx)
{
    ...
    if (!test_true("../test/time_offset_test.c", 79, "ASN1_TIME_diff(&day, &sec, &the_asn1_time, &at)", (ASN1_TIME_diff(&day, &sec, &the_asn1_time, &at)) != 0)) {
        test_info("../test/time_offset_test.c", 80, "ASN1_TIME_diff() failed for %s\n", at.data);
        return 0;
    }
    if (day > 0)
        ret = 1;
    ...
    if (!test_int_eq("../test/time_offset_test.c", 94, "testdata->time_result", "ret", testdata->time_result, ret)) {
        test_info("../test/time_offset_test.c", 95, "ASN1_TIME_diff() test failed for %s day=%d sec=%d\n", at.data, day, sec);
        return 0;
    }

    ret = ASN1_TIME_cmp_time_t(&at, the_time);

    if (!test_int_eq("../test/time_offset_test.c", 101, "testdata->time_result", "ret", testdata->time_result, ret)) {
        test_info("../test/time_offset_test.c", 102, "ASN1_UTCTIME_cmp_time_t() test failed for %s\n", at.data);
        return 0;
    }
...
int setup_tests(void)
{
    add_all_tests("test_offset", test_offset, (sizeof(tests)/sizeof((tests)[0])), 1);
    return 1;
}
