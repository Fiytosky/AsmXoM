# 0 "../test/cmp_msg_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_msg_test.c"
# 12 "../test/cmp_msg_test.c"
...
# 33 "../test/cmp_msg_test.c" 3 4
                             ((void *)0)
# 33 "../test/cmp_msg_test.c"
                                 ;
static OSSL_PROVIDER *default_null_provider = 
# 34 "../test/cmp_msg_test.c" 3 4
                                             ((void *)0)
# 34 "../test/cmp_msg_test.c"
                                                 , *provider = 
# 34 "../test/cmp_msg_test.c" 3 4
                                                               ((void *)0)
# 34 "../test/cmp_msg_test.c"
...
static void tear_down(CMP_MSG_TEST_FIXTURE *fixture)
{
    ...
    CRYPTO_free(fixture, "../test/cmp_msg_test.c", 43);
}
...
static CMP_MSG_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_msg_test.c", 52, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_msg_test.c", 52)))
        return 
# 53 "../test/cmp_msg_test.c" 3 4
              ((void *)0)
# 53 "../test/cmp_msg_test.c"
                  ;
    fixture->test_case_name = test_case_name;

    if (!test_ptr("../test/cmp_msg_test.c", 56, "fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, NULL)", fixture->cmp_ctx = OSSL_CMP_CTX_new(libctx, 
# 56 "../test/cmp_msg_test.c" 3 4
        ((void *)0)
# 56 "../test/cmp_msg_test.c"
        ))
            || !test_true("../test/cmp_msg_test.c", 57, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 1)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (1))) != 0)
            || !test_true("../test/cmp_msg_test.c", 58, "OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, ref, sizeof(ref))", (OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, ref, sizeof(ref))) != 0)
                                                                             ) {
        tear_down(fixture);
        return 
# 61 "../test/cmp_msg_test.c" 3 4
              ((void *)0)
# 61 "../test/cmp_msg_test.c"
                  ;
    }
    return fixture;
}

static EVP_PKEY *newkey = 
# 66 "../test/cmp_msg_test.c" 3 4
                         ((void *)0)
# 66 "../test/cmp_msg_test.c"
                             ;
static X509 *cert = 
# 67 "../test/cmp_msg_test.c" 3 4
                   ((void *)0)
# 67 "../test/cmp_msg_test.c"
                       ;
# 88 "../test/cmp_msg_test.c"
static int execute_certreq_create_test(CMP_MSG_TEST_FIXTURE *fixture)
{
    do { OSSL_CMP_MSG *msg = 
# 90 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 90 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 90, "msg = (ossl_cmp_certreq_new(fixture->cmp_ctx, fixture->bodytype, ((void *)0)))", msg = (ossl_cmp_certreq_new(fixture->cmp_ctx, fixture->bodytype, 
# 90 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 90 "../test/cmp_msg_test.c"
   ))) && test_true("../test/cmp_msg_test.c", 90, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 90, "msg = (ossl_cmp_certreq_new(fixture->cmp_ctx, fixture->bodytype, ((void *)0)))", msg = (ossl_cmp_certreq_new(fixture->cmp_ctx, fixture->bodytype, 
# 90 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 90 "../test/cmp_msg_test.c"
   ))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 90 "../test/cmp_msg_test.c" 3 4
   stderr
# 90 "../test/cmp_msg_test.c"
   ); return good; } while (0)
...
{
    do { OSSL_CMP_MSG *msg = 
# 97 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 97 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 97, "msg = (ossl_cmp_error_new(fixture->cmp_ctx, fixture->si, fixture->err_code, \"details\", 0))", msg = (ossl_cmp_error_new(fixture->cmp_ctx, fixture->si, fixture->err_code, "details", 0))) && test_true("../test/cmp_msg_test.c", 97, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 97, "msg = (ossl_cmp_error_new(fixture->cmp_ctx, fixture->si, fixture->err_code, \"details\", 0))", msg = (ossl_cmp_error_new(fixture->cmp_ctx, fixture->si, fixture->err_code, "details", 0))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 97 "../test/cmp_msg_test.c" 3 4
   stderr
# 97 "../test/cmp_msg_test.c"
   ); return good; } while (0)
...
{
    do { OSSL_CMP_MSG *msg = 
# 104 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 104 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 104, "msg = (ossl_cmp_rr_new(fixture->cmp_ctx))", msg = (ossl_cmp_rr_new(fixture->cmp_ctx))) && test_true("../test/cmp_msg_test.c", 104, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 104, "msg = (ossl_cmp_rr_new(fixture->cmp_ctx))", msg = (ossl_cmp_rr_new(fixture->cmp_ctx))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 104 "../test/cmp_msg_test.c" 3 4
   stderr
# 104 "../test/cmp_msg_test.c"
   ); return good; } while (0);
...
{
    do { OSSL_CMP_MSG *msg = 
# 109 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 109 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 109, "msg = (ossl_cmp_certConf_new (fixture->cmp_ctx, 0, fixture->fail_info, ((void *)0)))", msg = (ossl_cmp_certConf_new (fixture->cmp_ctx, 0, fixture->fail_info, 
# 109 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 109 "../test/cmp_msg_test.c"
   ))) && test_true("../test/cmp_msg_test.c", 109, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 109, "msg = (ossl_cmp_certConf_new (fixture->cmp_ctx, 0, fixture->fail_info, ((void *)0)))", msg = (ossl_cmp_certConf_new (fixture->cmp_ctx, 0, fixture->fail_info, 
# 109 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 109 "../test/cmp_msg_test.c"
   ))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
...
{
    do { OSSL_CMP_MSG *msg = 
# 116 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 116 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 116, "msg = (ossl_cmp_genm_new(fixture->cmp_ctx))", msg = (ossl_cmp_genm_new(fixture->cmp_ctx))) && test_true("../test/cmp_msg_test.c", 116, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 116, "msg = (ossl_cmp_genm_new(fixture->cmp_ctx))", msg = (ossl_cmp_genm_new(fixture->cmp_ctx))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 116 "../test/cmp_msg_test.c" 3 4
   stderr
# 116 "../test/cmp_msg_test.c"
   ); return good; } while (0);
...
{
    do { OSSL_CMP_MSG *msg = 
# 121 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 121 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 121, "msg = (ossl_cmp_pollReq_new(fixture->cmp_ctx, 4711))", msg = (ossl_cmp_pollReq_new(fixture->cmp_ctx, 4711))) && test_true("../test/cmp_msg_test.c", 121, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 121, "msg = (ossl_cmp_pollReq_new(fixture->cmp_ctx, 4711))", msg = (ossl_cmp_pollReq_new(fixture->cmp_ctx, 4711))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 121 "../test/cmp_msg_test.c" 3 4
   stderr
# 121 "../test/cmp_msg_test.c"
   ); return good; } while (0);
...
{
    do { OSSL_CMP_MSG *msg = 
# 126 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 126 "../test/cmp_msg_test.c"
   ; int good = fixture->expected != 0 ? test_ptr("../test/cmp_msg_test.c", 126, "msg = (ossl_cmp_msg_create (fixture->cmp_ctx, fixture->bodytype))", msg = (ossl_cmp_msg_create (fixture->cmp_ctx, fixture->bodytype))) && test_true("../test/cmp_msg_test.c", 126, "valid_asn1_encoding(msg)", (valid_asn1_encoding(msg)) != 0) : test_ptr_null("../test/cmp_msg_test.c", 126, "msg = (ossl_cmp_msg_create (fixture->cmp_ctx, fixture->bodytype))", msg = (ossl_cmp_msg_create (fixture->cmp_ctx, fixture->bodytype))); OSSL_CMP_MSG_free(msg); ERR_print_errors_fp(
# 126 "../test/cmp_msg_test.c" 3 4
   stderr
# 126 "../test/cmp_msg_test.c"
   ); return good; } while (0)
...
static int test_cmp_create_ir_protection_set(void)
{
    ...
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 147 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 147 "../test/cmp_msg_test.c"
   ) return 0;
    ...
    fixture->err_code = -1;
    fixture->expected = 1;
    if (!test_int_eq("../test/cmp_msg_test.c", 153, "1", "RAND_bytes_ex(libctx, secret, sizeof(secret), 0)", 1, RAND_bytes_ex(libctx, secret, sizeof(secret), 0))
            || !test_true("../test/cmp_msg_test.c", 154, "SET_OPT_UNPROTECTED_SEND(ctx, 0)", (OSSL_CMP_CTX_set_option((ctx), 30, (0))) != 0)
            || !test_true("../test/cmp_msg_test.c", 155, "set1_newPkey(ctx, newkey)", (set1_newPkey(ctx, newkey)) != 0)
            || !test_true("../test/cmp_msg_test.c", 156, "OSSL_CMP_CTX_set1_secretValue(ctx, secret, sizeof(secret))", (OSSL_CMP_CTX_set1_secretValue(ctx, secret, sizeof(secret))) != 0)
                                                                        ) {
        tear_down(fixture);
        fixture = 
# 159 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 159 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 161 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 161 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 167 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 167 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 0;
    fixture->err_code = -1;
    fixture->expected = 0;
    if (!test_true("../test/cmp_msg_test.c", 171, "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, newkey)", (OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, newkey)) != 0)
            || !test_true("../test/cmp_msg_test.c", 172, "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)", (OSSL_CMP_CTX_set_option((fixture->cmp_ctx), 30, (0))) != 0)

            || !test_true("../test/cmp_msg_test.c", 174, "OSSL_CMP_CTX_set1_cert(fixture->cmp_ctx, cert)", (OSSL_CMP_CTX_set1_cert(fixture->cmp_ctx, cert)) != 0)) {
        tear_down(fixture);
        fixture = 
# 176 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 176 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 178 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 178 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 184 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 184 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 2;
    fixture->err_code = -1;
    fixture->expected = 0;
    if (fixture != 
# 188 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 188 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 194 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 194 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 2;
    fixture->err_code = -1;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 198, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)) {
        tear_down(fixture);
        fixture = 
# 200 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 200 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 202 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 202 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 208 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 208 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 11;
    fixture->err_code = -1;
    fixture->expected = 0;
    if (!test_true("../test/cmp_msg_test.c", 212, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)) {
        tear_down(fixture);
        fixture = 
# 214 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 214 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 216 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 216 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_cmp_create_p10cr(void)
{
    OSSL_CMP_CTX *ctx;
    X509_REQ *p10cr = 
# 223 "../test/cmp_msg_test.c" 3 4
                     ((void *)0)
# 223 "../test/cmp_msg_test.c"
                         ;

    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 225 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 225 "../test/cmp_msg_test.c"
   ) return 0;
    ctx = fixture->cmp_ctx;
    fixture->bodytype = 4;
    fixture->err_code = 163;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_msg_test.c", 230, "p10cr = load_csr_der(pkcs10_f, libctx)", p10cr = load_csr_der(pkcs10_f, libctx))
            || !test_true("../test/cmp_msg_test.c", 231, "set1_newPkey(ctx, newkey)", (set1_newPkey(ctx, newkey)) != 0)
            || !test_true("../test/cmp_msg_test.c", 232, "OSSL_CMP_CTX_set1_p10CSR(ctx, p10cr)", (OSSL_CMP_CTX_set1_p10CSR(ctx, p10cr)) != 0)) {
        tear_down(fixture);
        fixture = 
# 234 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 234 "../test/cmp_msg_test.c"
                     ;
    }
    X509_REQ_free(p10cr);
    if (fixture != 
# 237 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 237 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 243 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 243 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 4;
    fixture->err_code = 163;
    fixture->expected = 0;
    if (!test_true("../test/cmp_msg_test.c", 247, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)) {
        tear_down(fixture);
        fixture = 
# 249 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 249 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 251 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 251 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 257 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 257 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 7;
    fixture->err_code = -1;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 261, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)
            || !test_true("../test/cmp_msg_test.c", 262, "OSSL_CMP_CTX_set1_oldCert(fixture->cmp_ctx, cert)", (OSSL_CMP_CTX_set1_oldCert(fixture->cmp_ctx, cert)) != 0)) {
        tear_down(fixture);
        fixture = 
# 264 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 264 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 266 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 266 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 272 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 272 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->bodytype = 7;
    fixture->err_code = -1;
    fixture->expected = 0;
    if (!test_true("../test/cmp_msg_test.c", 276, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)) {
        tear_down(fixture);
        fixture = 
# 278 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 278 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 280 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 280 "../test/cmp_msg_test.c"
   ) { result = execute_certreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 286 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 286 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->fail_info = 0;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 289, "ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))", (ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))) != 0)
                                                             ) {
        tear_down(fixture);
        fixture = 
# 292 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 292 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 294 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 294 "../test/cmp_msg_test.c"
   ) { result = execute_certconf_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 300 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 300 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->fail_info = 1 << 0;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 303, "ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))", (ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))) != 0)
                                                             ) {
        tear_down(fixture);
        fixture = 
# 306 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 306 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 308 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 308 "../test/cmp_msg_test.c"
   ) { result = execute_certconf_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 314 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 314 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->fail_info = 1 << 26;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 317, "ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))", (ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(cert))) != 0)
                                                             ) {
        tear_down(fixture);
        fixture = 
# 320 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 320 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 322 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 322 "../test/cmp_msg_test.c"
   ) { result = execute_certconf_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 328 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 328 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->si = OSSL_CMP_STATUSINFO_new(2,
                                          25,
                                          
# 331 "../test/cmp_msg_test.c" 3 4
                                         ((void *)0)
# 331 "../test/cmp_msg_test.c"
                                             );
    fixture->err_code = -1;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 334, "set1_newPkey(fixture->cmp_ctx, newkey)", (set1_newPkey(fixture->cmp_ctx, newkey)) != 0)) {
        tear_down(fixture);
        fixture = 
# 336 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 336 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 338 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 338 "../test/cmp_msg_test.c"
   ) { result = execute_errormsg_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 344 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 344 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 346 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 346 "../test/cmp_msg_test.c"
   ) { result = execute_pollreq_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 352 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 352 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->expected = 1;
    if (!test_true("../test/cmp_msg_test.c", 354, "OSSL_CMP_CTX_set1_oldCert(fixture->cmp_ctx, cert)", (OSSL_CMP_CTX_set1_oldCert(fixture->cmp_ctx, cert)) != 0)) {
        tear_down(fixture);
        fixture = 
# 356 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 356 "../test/cmp_msg_test.c"
                     ;
    }
    if (fixture != 
# 358 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 358 "../test/cmp_msg_test.c"
   ) { result = execute_rr_create_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    OSSL_CMP_ITAV *iv = 
# 364 "../test/cmp_msg_test.c" 3 4
                       ((void *)0)
# 364 "../test/cmp_msg_test.c"
                           ;

    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 366 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 366 "../test/cmp_msg_test.c"
   ) return 0;
    fixture->expected = 1;
    iv = OSSL_CMP_ITAV_create(OBJ_nid2obj(310), 
# 368 "../test/cmp_msg_test.c" 3 4
                                                                     ((void *)0)
# 368 "../test/cmp_msg_test.c"
                                                                         );
    if (!test_ptr("../test/cmp_msg_test.c", 369, "iv", iv)
            || !test_true("../test/cmp_msg_test.c", 370, "OSSL_CMP_CTX_push0_genm_ITAV(fixture->cmp_ctx, iv)", (OSSL_CMP_CTX_push0_genm_ITAV(fixture->cmp_ctx, iv)) != 0)) {
        OSSL_CMP_ITAV_free(iv);
        tear_down(fixture);
        fixture = 
# 373 "../test/cmp_msg_test.c" 3 4
                 ((void *)0)
# 373 "../test/cmp_msg_test.c"
                     ;
    }

    if (fixture != 
# 376 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 376 "../test/cmp_msg_test.c"
   ) { result = execute_genm_create_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_certrep_create(CMP_MSG_TEST_FIXTURE *fixture)
{
    ...
    X509 *certfromresp = 
# 385 "../test/cmp_msg_test.c" 3 4
                        ((void *)0)
# 385 "../test/cmp_msg_test.c"
                            ;
    int res = 0;

    if (crepmsg == 
# 388 "../test/cmp_msg_test.c" 3 4
                  ((void *)0) 
# 388 "../test/cmp_msg_test.c"
                       || cresp == 
# 388 "../test/cmp_msg_test.c" 3 4
                                   ((void *)0)
# 388 "../test/cmp_msg_test.c"
    ...
    if (!ASN1_INTEGER_set(cresp->certReqId, 99))
        goto err;
    if ((cresp->certifiedKeyPair = OSSL_CMP_CERTIFIEDKEYPAIR_new()) == 
# 392 "../test/cmp_msg_test.c" 3 4
                                                                      ((void *)0)
# 392 "../test/cmp_msg_test.c"
                                                                          )
        goto err;
    ...
    if ((cresp->certifiedKeyPair->certOrEncCert->value.certificate =
         X509_dup(cert)) == 
# 397 "../test/cmp_msg_test.c" 3 4
                           ((void *)0)
            
# 398 "../test/cmp_msg_test.c"
           || !OPENSSL_sk_push(ossl_check_OSSL_CMP_CERTRESPONSE_sk_type(crepmsg->response), ossl_check_OSSL_CMP_CERTRESPONSE_type(cresp)))
        goto err;
    cresp = 
# 400 "../test/cmp_msg_test.c" 3 4
           ((void *)0)
# 400 "../test/cmp_msg_test.c"
               ;
    read_cresp = ossl_cmp_certrepmessage_get0_certresponse(crepmsg, 99);
    if (!test_ptr("../test/cmp_msg_test.c", 402, "read_cresp", read_cresp))
        goto err;
    if (!test_ptr_null("../test/cmp_msg_test.c", 404, "ossl_cmp_certrepmessage_get0_certresponse(crepmsg, 88)", ossl_cmp_certrepmessage_get0_certresponse(crepmsg, 88)))
        goto err;
    certfromresp = ossl_cmp_certresponse_get1_cert(ctx, read_cresp);
    if (certfromresp == 
# 407 "../test/cmp_msg_test.c" 3 4
                       ((void *)0) 
# 407 "../test/cmp_msg_test.c"
                            || !test_int_eq("../test/cmp_msg_test.c", 407, "X509_cmp(cert, certfromresp)", "0", X509_cmp(cert, certfromresp), 0))
        goto err;
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 420 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 420 "../test/cmp_msg_test.c"
   ) return 0;
    if (fixture != 
# 421 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 421 "../test/cmp_msg_test.c"
   ) { result = execute_certrep_create(fixture); tear_down(fixture); };
    return result;
}
...
# 430 "../test/cmp_msg_test.c" 3 4
                           ((void *)0)
# 430 "../test/cmp_msg_test.c"
                               ;
    OSSL_CMP_MSG *rpmsg = 
# 431 "../test/cmp_msg_test.c" 3 4
                         ((void *)0)
# 431 "../test/cmp_msg_test.c"
                             ;
    int res = 0;

    if (si == 
# 434 "../test/cmp_msg_test.c" 3 4
             ((void *)0) 
# 434 "../test/cmp_msg_test.c"
                  || issuer == 
# 434 "../test/cmp_msg_test.c" 3 4
                               ((void *)0) 
# 434 "../test/cmp_msg_test.c"
...
# 434 "../test/cmp_msg_test.c"
    ...
    if (!X509_NAME_add_entry_by_txt(issuer, "CN", (0x1000|1),
                                    (unsigned char *)"The Issuer", -1, -1, 0)
            || !ASN1_INTEGER_set(serial, 99)
            || (cid = OSSL_CRMF_CERTID_gen(issuer, serial)) == 
# 440 "../test/cmp_msg_test.c" 3 4
                                                              ((void *)0)
            
# 441 "../test/cmp_msg_test.c"
           || (rpmsg = ossl_cmp_rp_new(fixture->cmp_ctx, si, cid, 1)) == 
# 441 "../test/cmp_msg_test.c" 3 4
                                                                         ((void *)0)
# 441 "../test/cmp_msg_test.c"
                                                                             )
        goto err;

    if (!test_ptr("../test/cmp_msg_test.c", 444, "ossl_cmp_revrepcontent_get_CertId(rpmsg->body->value.rp, 0)", ossl_cmp_revrepcontent_get_CertId(rpmsg->body->value.rp, 0)))
        goto err;

    if (!test_ptr("../test/cmp_msg_test.c", 447, "ossl_cmp_revrepcontent_get_pkisi(rpmsg->body->value.rp, 0)", ossl_cmp_revrepcontent_get_pkisi(rpmsg->body->value.rp, 0)))
        goto err;
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 462 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 462 "../test/cmp_msg_test.c"
   ) return 0;
    if (fixture != 
# 463 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 463 "../test/cmp_msg_test.c"
   ) { result = execute_rp_create(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_pollrep_create(CMP_MSG_TEST_FIXTURE *fixture)
{
    ...
    if (!test_ptr("../test/cmp_msg_test.c", 473, "pollrep", pollrep))
        return 0;
    if (!test_ptr("../test/cmp_msg_test.c", 475, "ossl_cmp_pollrepcontent_get0_pollrep(pollrep->body-> value.pollRep, 77)", ossl_cmp_pollrepcontent_get0_pollrep(pollrep->body-> value.pollRep, 77))
                                                                          )
        goto err;
    if (!test_ptr_null("../test/cmp_msg_test.c", 478, "ossl_cmp_pollrepcontent_get0_pollrep(pollrep->body-> value.pollRep, 88)", ossl_cmp_pollrepcontent_get0_pollrep(pollrep->body-> value.pollRep, 88))
                                                                               )
        goto err;
...
{
    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 490 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 490 "../test/cmp_msg_test.c"
   ) return 0;
    if (fixture != 
# 491 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 491 "../test/cmp_msg_test.c"
   ) { result = execute_pollrep_create(fixture); tear_down(fixture); };
    return result;
}
...
{
    X509_REQ *p10cr = 
# 497 "../test/cmp_msg_test.c" 3 4
                     ((void *)0)
# 497 "../test/cmp_msg_test.c"
                         ;

    CMP_MSG_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 499 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 499 "../test/cmp_msg_test.c"
   ) return 0;
    ...
    case 4:
        ...
        if (!test_true("../test/cmp_msg_test.c", 505, "OSSL_CMP_CTX_set1_p10CSR(fixture->cmp_ctx, p10cr)", (OSSL_CMP_CTX_set1_p10CSR(fixture->cmp_ctx, p10cr)) != 0)) {
            tear_down(fixture);
            fixture = 
# 507 "../test/cmp_msg_test.c" 3 4
                     ((void *)0)
# 507 "../test/cmp_msg_test.c"
                         ;
        }
        X509_REQ_free(p10cr);
        break;
    ...
    if (fixture != 
# 533 "../test/cmp_msg_test.c" 3 4
   ((void *)0)
# 533 "../test/cmp_msg_test.c"
   ) { result = execute_pkimessage_create_test(fixture); tear_down(fixture); };
    return result;
}
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "new.key server.crt pkcs10.der module_name [module_conf_file]\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 547 "../test/cmp_msg_test.c" 3 4
((void *)0) 
# 547 "../test/cmp_msg_test.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/cmp_msg_test.c", 552, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/cmp_msg_test.c", 556, "newkey_f = test_get_argument(0)", newkey_f = test_get_argument(0))
            || !test_ptr("../test/cmp_msg_test.c", 557, "server_cert_f = test_get_argument(1)", server_cert_f = test_get_argument(1))
            || !test_ptr("../test/cmp_msg_test.c", 558, "pkcs10_f = test_get_argument(2)", pkcs10_f = test_get_argument(2))) {
        test_error("../test/cmp_msg_test.c", 559, "usage: cmp_msg_test %s", "new.key server.crt pkcs10.der module_name [module_conf_file]\n");
        return 0;
    }

    if (!test_arg_libctx(&libctx, &default_null_provider, &provider, 3, "new.key server.crt pkcs10.der module_name [module_conf_file]\n"))
        return 0;

    if (!test_ptr("../test/cmp_msg_test.c", 566, "newkey = load_pkey_pem(newkey_f, libctx)", newkey = load_pkey_pem(newkey_f, libctx))
            || !test_ptr("../test/cmp_msg_test.c", 567, "cert = load_cert_pem(server_cert_f, libctx)", cert = load_cert_pem(server_cert_f, libctx))
            || !test_int_eq("../test/cmp_msg_test.c", 568, "1", "RAND_bytes_ex(libctx, ref, sizeof(ref), 0)", 1, RAND_bytes_ex(libctx, ref, sizeof(ref), 0))) {
        cleanup_tests();
        return 0;
    }


    add_test("test_cmp_create_certreq_with_invalid_bodytype", test_cmp_create_certreq_with_invalid_bodytype);
    ...
    add_test("test_cmp_create_certconf_fail_info_max", test_cmp_create_certconf_fail_info_max);
    ...
    add_all_tests("test_cmp_pkimessage_create", test_cmp_pkimessage_create, 26 + 1, 0)
                                                         ;
    return 1;
}
