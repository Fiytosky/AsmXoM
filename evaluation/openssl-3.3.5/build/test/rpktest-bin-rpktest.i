...
# 14 "../test/rpktest.c" 2
# 25 "../test/rpktest.c"
static char *certsdir = 
# 25 "../test/rpktest.c" 3 4
                       ((void *)0)
# 25 "../test/rpktest.c"
                           ;
static char *rootcert = 
# 26 "../test/rpktest.c" 3 4
                       ((void *)0)
# 26 "../test/rpktest.c"
                           ;
static char *cert = 
# 27 "../test/rpktest.c" 3 4
                   ((void *)0)
# 27 "../test/rpktest.c"
                       ;
static char *privkey = 
# 28 "../test/rpktest.c" 3 4
                      ((void *)0)
# 28 "../test/rpktest.c"
                          ;
static char *cert2 = 
# 29 "../test/rpktest.c" 3 4
                    ((void *)0)
# 29 "../test/rpktest.c"
                        ;
static char *privkey2 = 
# 30 "../test/rpktest.c" 3 4
                       ((void *)0)
# 30 "../test/rpktest.c"
                           ;
static char *cert448 = 
# 31 "../test/rpktest.c" 3 4
                      ((void *)0)
# 31 "../test/rpktest.c"
                          ;
static char *privkey448 = 
# 32 "../test/rpktest.c" 3 4
                         ((void *)0)
# 32 "../test/rpktest.c"
                             ;
static char *cert25519 = 
# 33 "../test/rpktest.c" 3 4
                        ((void *)0)
# 33 "../test/rpktest.c"
                            ;
static char *privkey25519 = 
# 34 "../test/rpktest.c" 3 4
                           ((void *)0)
# 34 "../test/rpktest.c"
                               ;
static OSSL_LIB_CTX *libctx = 
# 35 "../test/rpktest.c" 3 4
                             ((void *)0)
# 35 "../test/rpktest.c"
                                 ;
static OSSL_PROVIDER *defctxnull = 
# 36 "../test/rpktest.c" 3 4
                                  ((void *)0)
# 36 "../test/rpktest.c"
                                      ;

static const unsigned char cert_type_rpk[] = { 2, 0 };
...
static int rpk_verify_client_cb(int ok, X509_STORE_CTX *ctx)
{
    ...
    if (X509_STORE_CTX_get0_rpk(ctx) != 
# 45 "../test/rpktest.c" 3 4
                                       ((void *)0)
# 45 "../test/rpktest.c"
                                           ) {
        if (err != 0) {
            test_info("../test/rpktest.c", 47, "rpk_verify_client_cb: ok=%d err=%d", ok, err);
            return 0;
        }
    }
    return 1;
...
static int rpk_verify_server_cb(int ok, X509_STORE_CTX *ctx)
{
    ...
    if (X509_STORE_CTX_get0_rpk(ctx) != 
# 57 "../test/rpktest.c" 3 4
                                       ((void *)0)
# 57 "../test/rpktest.c"
                                           ) {
        if (err != 0) {
            test_info("../test/rpktest.c", 59, "rpk_verify_server_cb: ok=%d err=%d", ok, err);
            return 0;
        }
    }
    return 1;
...
# 104 "../test/rpktest.c"
    ...
    int client_expected = 0;
    int verify;
    int tls_version;
    char *cert_file = 
# 109 "../test/rpktest.c" 3 4
                     ((void *)0)
# 109 "../test/rpktest.c"
                         ;
    char *privkey_file = 
# 110 "../test/rpktest.c" 3 4
                        ((void *)0)
# 110 "../test/rpktest.c"
                            ;
    char *other_cert_file = 
# 111 "../test/rpktest.c" 3 4
                           ((void *)0)
# 111 "../test/rpktest.c"
                               ;
    SSL_SESSION *client_sess = 
# 112 "../test/rpktest.c" 3 4
                              ((void *)0)
# 112 "../test/rpktest.c"
                                  ;
    SSL_SESSION *server_sess = 
# 113 "../test/rpktest.c" 3 4
                              ((void *)0)
# 113 "../test/rpktest.c"
                                  ;
    ...
    OSSL_LIB_CTX *test_libctx = 
# 122 "../test/rpktest.c" 3 4
                               ((void *)0)
# 122 "../test/rpktest.c"
                                   ;

    if (!test_int_le("../test/rpktest.c", 124, "idx", "RPK_TESTS * RPK_DIMS", idx, 18 * (2 * 4 * 2 * 2 * 2 * 2)))
        return 0;

    idx_server_server_rpk = idx / (18 * 2 * 4 * 2 * 2 * 2);
    idx %= 18 * 2 * 4 * 2 * 2 * 2;
    idx_server_client_rpk = idx / (18 * 2 * 4 * 2 * 2);
    idx %= 18 * 2 * 4 * 2 * 2;
    idx_client_server_rpk = idx / (18 * 2 * 4 * 2);
    idx %= 18 * 2 * 4 * 2;
    idx_client_client_rpk = idx / (18 * 2 * 4);
    idx %= 18 * 2 * 4;
    idx_cert = idx / (18 * 2);
    idx %= 18 * 2;
    idx_prot = idx / 18;
    ...
    root_x509 = load_cert_pem(rootcert, 
# 141 "../test/rpktest.c" 3 4
                                       ((void *)0)
# 141 "../test/rpktest.c"
                                           );
    if (!test_ptr("../test/rpktest.c", 142, "root_x509", root_x509))
        goto end;
    root_pkey = X509_get0_pubkey(root_x509);
    if (!test_ptr("../test/rpktest.c", 145, "root_pkey", root_pkey))
        goto end;
    ...
    switch (idx_cert) {
        ...
        default:
            testresult = test_skip("../test/rpktest.c", 178, "EDCSA disabled");
            goto end;
    }

    x509 = load_cert_pem(cert_file, 
# 182 "../test/rpktest.c" 3 4
                                   ((void *)0)
# 182 "../test/rpktest.c"
                                       );
    if (!test_ptr("../test/rpktest.c", 183, "x509", x509))
        goto end;
    pkey = X509_get0_pubkey(x509);

    other_x509 = load_cert_pem(other_cert_file, 
# 187 "../test/rpktest.c" 3 4
                                               ((void *)0)
# 187 "../test/rpktest.c"
                                                   );
    if (!test_ptr("../test/rpktest.c", 188, "other_x509", other_x509))
        goto end;
...
# 200 "../test/rpktest.c"
    ...
    if (idx == 15) {
        test_libctx = libctx;
        defctxnull = OSSL_PROVIDER_load(
# 223 "../test/rpktest.c" 3 4
                                       ((void *)0)
# 223 "../test/rpktest.c"
                                           , "null");
        if (!test_ptr("../test/rpktest.c", 224, "defctxnull", defctxnull))
            goto end;
    }
    if (!test_true("../test/rpktest.c", 227, "create_ssl_ctx_pair(test_libctx, TLS_server_method(), TLS_client_method(), tls_version, tls_version, &sctx, &cctx, NULL, NULL)", (create_ssl_ctx_pair(test_libctx, TLS_server_method(), TLS_client_method(), tls_version, tls_version, &sctx, &cctx, 
# 227 "../test/rpktest.c" 3 4
        ((void *)0)
# 227 "../test/rpktest.c"
        , 
# 227 "../test/rpktest.c" 3 4
...
# 227 "../test/rpktest.c"
    ...
    if (idx_server_server_rpk)
        if (!test_true("../test/rpktest.c", 234, "SSL_CTX_set1_server_cert_type(sctx, cert_type_rpk, sizeof(cert_type_rpk))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_rpk, sizeof(cert_type_rpk))) != 0))
            goto end;
    if (idx_server_client_rpk)
        if (!test_true("../test/rpktest.c", 237, "SSL_CTX_set1_client_cert_type(sctx, cert_type_rpk, sizeof(cert_type_rpk))", (SSL_CTX_set1_client_cert_type(sctx, cert_type_rpk, sizeof(cert_type_rpk))) != 0))
            goto end;
    if (idx_client_server_rpk)
        if (!test_true("../test/rpktest.c", 240, "SSL_CTX_set1_server_cert_type(cctx, cert_type_rpk, sizeof(cert_type_rpk))", (SSL_CTX_set1_server_cert_type(cctx, cert_type_rpk, sizeof(cert_type_rpk))) != 0))
            goto end;
    if (idx_client_client_rpk)
        if (!test_true("../test/rpktest.c", 243, "SSL_CTX_set1_client_cert_type(cctx, cert_type_rpk, sizeof(cert_type_rpk))", (SSL_CTX_set1_client_cert_type(cctx, cert_type_rpk, sizeof(cert_type_rpk))) != 0))
            goto end;
    if (!test_true("../test/rpktest.c", 245, "SSL_CTX_set_session_id_context(sctx, SID_CTX, sizeof(SID_CTX))", (SSL_CTX_set_session_id_context(sctx, SID_CTX, sizeof(SID_CTX))) != 0))
        goto end;
    if (!test_true("../test/rpktest.c", 247, "SSL_CTX_set_session_id_context(cctx, SID_CTX, sizeof(SID_CTX))", (SSL_CTX_set_session_id_context(cctx, SID_CTX, sizeof(SID_CTX))) != 0))
        goto end;

    if (!test_int_gt("../test/rpktest.c", 250, "SSL_CTX_dane_enable(sctx)", "0", SSL_CTX_dane_enable(sctx), 0))
        goto end;
    if (!test_int_gt("../test/rpktest.c", 252, "SSL_CTX_dane_enable(cctx)", "0", SSL_CTX_dane_enable(cctx), 0))
        goto end;


    SSL_CTX_set_verify(cctx, 0x01, rpk_verify_client_cb);

    if (!test_true("../test/rpktest.c", 258, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 258 "../test/rpktest.c" 3 4
        ((void *)0)
# 258 "../test/rpktest.c"
        , 
# 258 "../test/rpktest.c" 3 4
...
# 258 "../test/rpktest.c"
    ...
    if (!test_int_gt("../test/rpktest.c", 262, "SSL_dane_enable(serverssl, NULL)", "0", SSL_dane_enable(serverssl, 
# 262 "../test/rpktest.c" 3 4
        ((void *)0)
# 262 "../test/rpktest.c"
        ), 0))
        goto end;
    if (!test_int_gt("../test/rpktest.c", 264, "SSL_dane_enable(clientssl, \"example.com\")", "0", SSL_dane_enable(clientssl, "example.com"), 0))
        goto end;


    if (!test_int_eq("../test/rpktest.c", 268, "SSL_use_PrivateKey_file(serverssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(serverssl, privkey_file, 1), 1))
        goto end;
    ...
    if (idx == 1) {
        ...
        if (!test_int_eq("../test/rpktest.c", 278, "SSL_use_certificate_file(serverssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(serverssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 280, "SSL_check_private_key(serverssl)", "1", SSL_check_private_key(serverssl), 1))
            goto end;
    }

    switch (idx) {
    default:
        if (!test_true("../test/rpktest.c", 286, "idx < RPK_TESTS", (idx < 18) != 0))
            goto end;
        break;
    case 0:
        if (!test_true("../test/rpktest.c", 290, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        break;
    case 1:
        if (!test_true("../test/rpktest.c", 294, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        break;
    case 2:
        if (!test_true("../test/rpktest.c", 298, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 300, "SSL_add_expected_rpk(serverssl, pkey)", (SSL_add_expected_rpk(serverssl, pkey)) != 0))
            goto end;

        if (!test_int_eq("../test/rpktest.c", 303, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 305, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 307, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
            goto end;
        SSL_set_verify(serverssl, 0x01 | 0x02, rpk_verify_server_cb);
        client_auth = 1;
        break;
    case 3:
        if (!test_true("../test/rpktest.c", 313, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 315, "SSL_add_expected_rpk(clientssl, root_pkey)", (SSL_add_expected_rpk(clientssl, root_pkey)) != 0))
            goto end;
        break;
    case 4:
        if (!test_true("../test/rpktest.c", 319, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 321, "SSL_add_expected_rpk(clientssl, other_pkey)", (SSL_add_expected_rpk(clientssl, other_pkey)) != 0))
            goto end;
        break;
    case 5:
        if (!test_true("../test/rpktest.c", 325, "SSL_add_expected_rpk(clientssl, root_pkey)", (SSL_add_expected_rpk(clientssl, root_pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 327, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        break;
    case 6:
        if (!test_true("../test/rpktest.c", 331, "SSL_add_expected_rpk(clientssl, other_pkey)", (SSL_add_expected_rpk(clientssl, other_pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 333, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        break;
    case 7:
        if (idx_server_server_rpk == 1 && idx_client_server_rpk == 1)
            client_expected = -1;
        if (!test_true("../test/rpktest.c", 339, "SSL_add_expected_rpk(clientssl, other_pkey)", (SSL_add_expected_rpk(clientssl, other_pkey)) != 0))
            goto end;
        SSL_set_verify(clientssl, 0x00, rpk_verify_client_cb);
        client_verify_result = 65;
        break;
    case 8:
        if (idx_server_server_rpk == 1 && idx_client_server_rpk == 1)
            client_expected = -1;
        ...
        SSL_set_verify(clientssl, 0x00, rpk_verify_client_cb);
        client_verify_result = 95;
        break;
    case 9:
        if (tls_version != 0x0304) {
            testresult = test_skip("../test/rpktest.c", 353, "PHA requires TLSv1.3");
            goto end;
        }
        if (!test_true("../test/rpktest.c", 356, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 358, "SSL_add_expected_rpk(serverssl, pkey)", (SSL_add_expected_rpk(serverssl, pkey)) != 0))
            goto end;

        if (!test_int_eq("../test/rpktest.c", 361, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 363, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 365, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
            goto end;
        SSL_set_verify(serverssl, 0x01 | 0x02 | 0x08, rpk_verify_server_cb);
        SSL_set_post_handshake_auth(clientssl, 1);
        client_auth = 1;
        break;
    case 10:
        if (!test_true("../test/rpktest.c", 372, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 374, "SSL_add_expected_rpk(serverssl, pkey)", (SSL_add_expected_rpk(serverssl, pkey)) != 0))
            goto end;

        if (!test_int_eq("../test/rpktest.c", 377, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
            goto end;

        if (!idx_server_client_rpk || !idx_client_client_rpk) {
            expected = 0;
            want_error = 1;
            SSL_set_verify(serverssl, 0x01 | 0x02, 
# 383 "../test/rpktest.c" 3 4
                                                                                        ((void *)0)
# 383 "../test/rpktest.c"
                                                                                            );
        } else {
    ...
    case 11:
        if (!idx_server_server_rpk || !idx_client_server_rpk) {
            testresult = test_skip("../test/rpktest.c", 391, "Only testing resumption with server RPK");
            goto end;
        }
        if (!test_true("../test/rpktest.c", 394, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        resumption = 1;
        break;
    case 12:
        if (!idx_server_server_rpk || !idx_client_server_rpk) {
            testresult = test_skip("../test/rpktest.c", 400, "Only testing resumption with server RPK");
            goto end;
        }
        if (!test_true("../test/rpktest.c", 403, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        SSL_set_options(serverssl, ((uint64_t)1 << (uint64_t)14));
        SSL_set_options(clientssl, ((uint64_t)1 << (uint64_t)14));
        resumption = 1;
        break;
    case 13:
        if (!idx_server_server_rpk || !idx_client_server_rpk) {
            testresult = test_skip("../test/rpktest.c", 411, "Only testing resumption with server RPK");
            goto end;
        }
        if (!idx_server_client_rpk || !idx_client_client_rpk) {
            testresult = test_skip("../test/rpktest.c", 415, "Only testing client authentication resumption with client RPK");
            goto end;
        }
        if (!test_true("../test/rpktest.c", 418, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 420, "SSL_add_expected_rpk(serverssl, pkey)", (SSL_add_expected_rpk(serverssl, pkey)) != 0))
            goto end;

        if (!test_int_eq("../test/rpktest.c", 423, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 425, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 427, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
            goto end;
        SSL_set_verify(serverssl, 0x01 | 0x02, rpk_verify_server_cb);
        client_auth = 1;
        resumption = 1;
    ...
    case 14:
        if (!idx_server_server_rpk || !idx_client_server_rpk) {
            testresult = test_skip("../test/rpktest.c", 435, "Only testing resumption with server RPK");
            goto end;
        }
        if (!idx_server_client_rpk || !idx_client_client_rpk) {
            testresult = test_skip("../test/rpktest.c", 439, "Only testing client authentication resumption with client RPK");
            goto end;
        }
        if (!test_true("../test/rpktest.c", 442, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 444, "SSL_add_expected_rpk(serverssl, pkey)", (SSL_add_expected_rpk(serverssl, pkey)) != 0))
            goto end;

        if (!test_int_eq("../test/rpktest.c", 447, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 449, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 451, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
            goto end;
        SSL_set_verify(serverssl, 0x01 | 0x02, rpk_verify_server_cb);
        SSL_set_options(serverssl, ((uint64_t)1 << (uint64_t)14));
        SSL_set_options(clientssl, ((uint64_t)1 << (uint64_t)14));
        ...
        break;
    case 15:
        if (!test_true("../test/rpktest.c", 460, "SSL_add_expected_rpk(clientssl, pkey)", (SSL_add_expected_rpk(clientssl, pkey)) != 0))
            goto end;
        break;
    case 16:
        if (idx_server_server_rpk == 1 && idx_client_server_rpk == 1) {
            ...
            expected = 0;
            want_error = 1;
            SSL_set_verify(serverssl, 0x01, 
# 468 "../test/rpktest.c" 3 4
                                                      ((void *)0)
# 468 "../test/rpktest.c"
                                                          );
        }
        if (!test_true("../test/rpktest.c", 470, "SSL_add_expected_rpk(clientssl, other_pkey)", (SSL_add_expected_rpk(clientssl, other_pkey)) != 0))
            goto end;
        break;
    case 17:
        if (idx_server_server_rpk == 1 && idx_client_server_rpk == 1) {
...
# 478 "../test/rpktest.c"
    ...
    if (!test_int_eq("../test/rpktest.c", 484, "expected", "ret", expected, ret))
        goto end;
    ...
    if (idx_server_server_rpk && idx_client_server_rpk) {
        if (!test_long_eq("../test/rpktest.c", 494, "SSL_get_verify_result(clientssl)", "client_verify_result", SSL_get_verify_result(clientssl), client_verify_result))
            goto end;
        if (!test_ptr("../test/rpktest.c", 496, "SSL_get0_peer_rpk(clientssl)", SSL_get0_peer_rpk(clientssl)))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 498, "SSL_get_negotiated_server_cert_type(serverssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_server_cert_type(serverssl), 2))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 500, "SSL_get_negotiated_server_cert_type(clientssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_server_cert_type(clientssl), 2))
            goto end;
    } else {
        if (!test_ptr("../test/rpktest.c", 503, "SSL_get0_peer_certificate(clientssl)", SSL_get0_peer_certificate(clientssl)))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 505, "SSL_get_negotiated_server_cert_type(serverssl)", "TLSEXT_cert_type_x509", SSL_get_negotiated_server_cert_type(serverssl), 0))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 507, "SSL_get_negotiated_server_cert_type(clientssl)", "TLSEXT_cert_type_x509", SSL_get_negotiated_server_cert_type(clientssl), 0))
            goto end;
    }

    if (idx == 9) {

        if (!test_true("../test/rpktest.c", 513, "SSL_verify_client_post_handshake(serverssl)", (SSL_verify_client_post_handshake(serverssl)) != 0))
            goto end;
        if (!test_true("../test/rpktest.c", 515, "SSL_do_handshake(serverssl)", (SSL_do_handshake(serverssl)) != 0))
            goto end;
        if (!test_int_le("../test/rpktest.c", 517, "SSL_read(clientssl, NULL, 0)", "0", SSL_read(clientssl, 
# 517 "../test/rpktest.c" 3 4
            ((void *)0)
# 517 "../test/rpktest.c"
            , 0), 0))
            goto end;
        if (!test_int_le("../test/rpktest.c", 519, "SSL_read(serverssl, NULL, 0)", "0", SSL_read(serverssl, 
# 519 "../test/rpktest.c" 3 4
            ((void *)0)
# 519 "../test/rpktest.c"
            , 0), 0))
            goto end;
    ...
    if (client_auth) {
        if (idx_server_client_rpk && idx_client_client_rpk) {
            if (!test_long_eq("../test/rpktest.c", 526, "SSL_get_verify_result(serverssl)", "server_verify_result", SSL_get_verify_result(serverssl), server_verify_result))
                goto end;
            if (!test_ptr("../test/rpktest.c", 528, "SSL_get0_peer_rpk(serverssl)", SSL_get0_peer_rpk(serverssl)))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 530, "SSL_get_negotiated_client_cert_type(serverssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_client_cert_type(serverssl), 2))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 532, "SSL_get_negotiated_client_cert_type(clientssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_client_cert_type(clientssl), 2))
                goto end;
        } else {
            if (!test_ptr("../test/rpktest.c", 535, "SSL_get0_peer_certificate(serverssl)", SSL_get0_peer_certificate(serverssl)))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 537, "SSL_get_negotiated_client_cert_type(serverssl)", "TLSEXT_cert_type_x509", SSL_get_negotiated_client_cert_type(serverssl), 0))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 539, "SSL_get_negotiated_client_cert_type(clientssl)", "TLSEXT_cert_type_x509", SSL_get_negotiated_client_cert_type(clientssl), 0))
                goto end;
        }
    }
...
# 545 "../test/rpktest.c" 3 4
                               ((void *)0)
# 545 "../test/rpktest.c"
                                   ;
        EVP_PKEY *server_pkey = 
# 546 "../test/rpktest.c" 3 4
                               ((void *)0)
# 546 "../test/rpktest.c"
                                   ;

        if (!test_ptr("../test/rpktest.c", 548, "(client_sess = SSL_get1_session(clientssl))", (client_sess = SSL_get1_session(clientssl)))
                || !test_ptr("../test/rpktest.c", 549, "(client_pkey = SSL_SESSION_get0_peer_rpk(client_sess))", (client_pkey = SSL_SESSION_get0_peer_rpk(client_sess))))
            goto end;
        if (client_auth) {
            if (!test_ptr("../test/rpktest.c", 552, "(server_sess = SSL_get1_session(serverssl))", (server_sess = SSL_get1_session(serverssl)))
                || !test_ptr("../test/rpktest.c", 553, "(server_pkey = SSL_SESSION_get0_peer_rpk(server_sess))", (server_pkey = SSL_SESSION_get0_peer_rpk(server_sess))))
            goto end;
        }
        ...
        SSL_free(serverssl);
        serverssl = clientssl = 
# 560 "../test/rpktest.c" 3 4
                               ((void *)0)
# 560 "../test/rpktest.c"
                                   ;

        if (!test_true("../test/rpktest.c", 562, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 562 "../test/rpktest.c" 3 4
            ((void *)0)
# 562 "../test/rpktest.c"
            , 
# 562 "../test/rpktest.c" 3 4
...
# 562 "../test/rpktest.c"
                ...
                || !test_true("../test/rpktest.c", 564, "SSL_set_session(clientssl, client_sess)", (SSL_set_session(clientssl, client_sess)) != 0))
            goto end;


        if (!test_int_eq("../test/rpktest.c", 568, "SSL_use_PrivateKey_file(serverssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(serverssl, privkey_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 570, "SSL_use_certificate_file(serverssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(serverssl, cert_file, 1), 1))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 572, "SSL_check_private_key(serverssl)", "1", SSL_check_private_key(serverssl), 1))
            goto end;
        if (!test_int_gt("../test/rpktest.c", 574, "SSL_dane_enable(serverssl, \"example.com\")", "0", SSL_dane_enable(serverssl, "example.com"), 0))
            goto end;
        if (!test_int_gt("../test/rpktest.c", 576, "SSL_dane_enable(clientssl, \"example.com\")", "0", SSL_dane_enable(clientssl, "example.com"), 0))
            goto end;
        ...
        default:
            break;
        case 11:
            if (!test_true("../test/rpktest.c", 583, "SSL_add_expected_rpk(clientssl, client_pkey)", (SSL_add_expected_rpk(clientssl, client_pkey)) != 0))
                goto end;
            break;
        case 12:
            if (!test_true("../test/rpktest.c", 587, "SSL_add_expected_rpk(clientssl, client_pkey)", (SSL_add_expected_rpk(clientssl, client_pkey)) != 0))
                goto end;
            SSL_set_options(clientssl, ((uint64_t)1 << (uint64_t)14));
            SSL_set_options(serverssl, ((uint64_t)1 << (uint64_t)14));
            break;
        case 13:
            if (!test_true("../test/rpktest.c", 593, "SSL_add_expected_rpk(clientssl, client_pkey)", (SSL_add_expected_rpk(clientssl, client_pkey)) != 0))
                goto end;
            if (!test_true("../test/rpktest.c", 595, "SSL_add_expected_rpk(serverssl, server_pkey)", (SSL_add_expected_rpk(serverssl, server_pkey)) != 0))
                goto end;

            if (!test_int_eq("../test/rpktest.c", 598, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 600, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 602, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
                goto end;
            SSL_set_verify(serverssl, 0x01 | 0x02, rpk_verify_server_cb);
            break;
        case 14:
            if (!test_true("../test/rpktest.c", 607, "SSL_add_expected_rpk(clientssl, client_pkey)", (SSL_add_expected_rpk(clientssl, client_pkey)) != 0))
                goto end;
            if (!test_true("../test/rpktest.c", 609, "SSL_add_expected_rpk(serverssl, server_pkey)", (SSL_add_expected_rpk(serverssl, server_pkey)) != 0))
                goto end;

            if (!test_int_eq("../test/rpktest.c", 612, "SSL_use_PrivateKey_file(clientssl, privkey_file, SSL_FILETYPE_PEM)", "1", SSL_use_PrivateKey_file(clientssl, privkey_file, 1), 1))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 614, "SSL_use_certificate_file(clientssl, cert_file, SSL_FILETYPE_PEM)", "1", SSL_use_certificate_file(clientssl, cert_file, 1), 1))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 616, "SSL_check_private_key(clientssl)", "1", SSL_check_private_key(clientssl), 1))
                goto end;
            SSL_set_verify(serverssl, 0x01 | 0x02, rpk_verify_server_cb);
            SSL_set_options(serverssl, ((uint64_t)1 << (uint64_t)14));
            SSL_set_options(clientssl, ((uint64_t)1 << (uint64_t)14));
        ...
        ret = create_ssl_connection(serverssl, clientssl, 0);
        if (!test_true("../test/rpktest.c", 625, "ret", (ret) != 0))
            goto end;
        verify = SSL_get_verify_result(clientssl);
        if (!test_int_eq("../test/rpktest.c", 628, "client_expected", "verify", client_expected, verify))
            goto end;
        if (!test_true("../test/rpktest.c", 630, "SSL_session_reused(clientssl)", (SSL_session_reused(clientssl)) != 0))
            goto end;

        if (!test_ptr("../test/rpktest.c", 633, "SSL_get0_peer_rpk(clientssl)", SSL_get0_peer_rpk(clientssl)))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 635, "SSL_get_negotiated_server_cert_type(serverssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_server_cert_type(serverssl), 2))
            goto end;
        if (!test_int_eq("../test/rpktest.c", 637, "SSL_get_negotiated_server_cert_type(clientssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_server_cert_type(clientssl), 2))
            goto end;

        if (client_auth) {
            if (!test_ptr("../test/rpktest.c", 641, "SSL_get0_peer_rpk(serverssl)", SSL_get0_peer_rpk(serverssl)))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 643, "SSL_get_negotiated_client_cert_type(serverssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_client_cert_type(serverssl), 2))
                goto end;
            if (!test_int_eq("../test/rpktest.c", 645, "SSL_get_negotiated_client_cert_type(clientssl)", "TLSEXT_cert_type_rpk", SSL_get_negotiated_client_cert_type(clientssl), 2))
                goto end;
        }
    }
...
# 654 "../test/rpktest.c"
    ...
    if (testresult == 0) {
        test_info("../test/rpktest.c", 666, "idx_ss_rpk=%d, idx_sc_rpk=%d, idx_cs_rpk=%d, idx_cc_rpk=%d, idx_cert=%d, idx_prot=%d, idx=%d", idx_server_server_rpk, idx_server_client_rpk, idx_client_server_rpk, idx_client_client_rpk, idx_cert, idx_prot, idx)
...
# 677 "../test/rpktest.c"
                                     ;
    unsigned char cert_type_dups[] = { 2,
                                       0,
                                       0 };
    unsigned char cert_type_bad[] = { 0xFF };
    unsigned char cert_type_extra[] = { 2,
                                        0,
                                        0xFF };
    unsigned char cert_type_unsup[] = { 1,
                                        3 };
    unsigned char cert_type_just_x509[] = { 0 };
    unsigned char cert_type_just_rpk[] = { 2 };

    if (!test_true("../test/rpktest.c", 690, "create_ssl_ctx_pair(NULL, TLS_server_method(), TLS_client_method(), TLS1_2_VERSION, TLS1_2_VERSION, &sctx, &cctx, NULL, NULL)", (create_ssl_ctx_pair(
# 690 "../test/rpktest.c" 3 4
        ((void *)0)
# 690 "../test/rpktest.c"
        , TLS_server_method(), TLS_client_method(), 0x0303, 0x0303, &sctx, &cctx, 
# 690 "../test/rpktest.c" 3 4
        ((void *)0)
# 690 "../test/rpktest.c"
        , 
...
# 690 "../test/rpktest.c"
    ...
    if (!test_false("../test/rpktest.c", 696, "SSL_CTX_set1_server_cert_type(sctx, cert_type_dups, sizeof(cert_type_dups))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_dups, sizeof(cert_type_dups))) != 0))
        goto end;

    if (!test_false("../test/rpktest.c", 699, "SSL_CTX_set1_server_cert_type(sctx, cert_type_bad, sizeof(cert_type_bad))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_bad, sizeof(cert_type_bad))) != 0))
        goto end;

    if (!test_false("../test/rpktest.c", 702, "SSL_CTX_set1_server_cert_type(sctx, cert_type_extra, sizeof(cert_type_extra))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_extra, sizeof(cert_type_extra))) != 0))
        goto end;

    if (!test_false("../test/rpktest.c", 705, "SSL_CTX_set1_server_cert_type(sctx, cert_type_unsup, sizeof(cert_type_unsup))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_unsup, sizeof(cert_type_unsup))) != 0))
        goto end;

    if (!test_true("../test/rpktest.c", 708, "SSL_CTX_set1_server_cert_type(sctx, cert_type_just_x509, sizeof(cert_type_just_x509))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_just_x509, sizeof(cert_type_just_x509))) != 0))
        goto end;

    if (!test_true("../test/rpktest.c", 711, "SSL_CTX_set1_server_cert_type(sctx, cert_type_just_rpk, sizeof(cert_type_just_rpk))", (SSL_CTX_set1_server_cert_type(sctx, cert_type_just_rpk, sizeof(cert_type_just_rpk))) != 0))
        goto end;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/rpktest.c", 725, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/rpktest.c", 729, "certsdir = test_get_argument(0)", certsdir = test_get_argument(0)))
        return 0;

    rootcert = test_mk_file_path(certsdir, "rootcert.pem");
    if (rootcert == 
# 733 "../test/rpktest.c" 3 4
                   ((void *)0)
# 733 "../test/rpktest.c"
                       )
        goto err;
...
# 769 "../test/rpktest.c"
    ...
    add_all_tests("test_rpk", test_rpk, 18 * (2 * 4 * 2 * 2 * 2 * 2), 1);
    return 1;
...
void cleanup_tests(void)
{
    CRYPTO_free(rootcert, "../test/rpktest.c", 782);
    CRYPTO_free(cert, "../test/rpktest.c", 783);
    CRYPTO_free(privkey, "../test/rpktest.c", 784);
    CRYPTO_free(cert2, "../test/rpktest.c", 785);
    CRYPTO_free(privkey2, "../test/rpktest.c", 786);
    CRYPTO_free(cert448, "../test/rpktest.c", 787);
    CRYPTO_free(privkey448, "../test/rpktest.c", 788);
    CRYPTO_free(cert25519, "../test/rpktest.c", 789);
    CRYPTO_free(privkey25519, "../test/rpktest.c", 790);
