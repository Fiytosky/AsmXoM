# 0 "test/buildtest_prov_ssl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_prov_ssl.c"
...
# 8 "test/buildtest_prov_ssl.c" 2


# 1 "../include/openssl/prov_ssl.h" 1
# 12 "../include/openssl/prov_ssl.h"
        
# 11 "test/buildtest_prov_ssl.c" 2



# 13 "test/buildtest_prov_ssl.c"
int main(void)
{
    return 0;
}
