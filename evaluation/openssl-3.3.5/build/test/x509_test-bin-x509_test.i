...
# 19 "../test/x509_test.c" 2

static EVP_PKEY *pubkey = 
# 20 "../test/x509_test.c" 3 4
                         ((void *)0)
# 20 "../test/x509_test.c"
                             ;
static EVP_PKEY *privkey = 
# 21 "../test/x509_test.c" 3 4
                          ((void *)0)
# 21 "../test/x509_test.c"
                              ;
static EVP_MD *signmd = 
# 22 "../test/x509_test.c" 3 4
                       ((void *)0)
# 22 "../test/x509_test.c"
                           ;
...
static int test_x509_tbs_cache(void)
{
    int ret;
    X509 *x = 
# 95 "../test/x509_test.c" 3 4
             ((void *)0)
# 95 "../test/x509_test.c"
                 ;
    const unsigned char *p = certdata;

    ret = test_ptr("../test/x509_test.c", 98, "x = d2i_X509(NULL, &p, sizeof(certdata))", x = d2i_X509(
# 98 "../test/x509_test.c" 3 4
         ((void *)0)
# 98 "../test/x509_test.c"
         , &p, sizeof(certdata)))
          && test_int_gt("../test/x509_test.c", 99, "X509_sign(x, privkey, signmd)", "0", X509_sign(x, privkey, signmd), 0)
          && test_int_eq("../test/x509_test.c", 100, "X509_verify(x, pubkey)", "1", X509_verify(x, pubkey), 1);
    X509_free(x);
    return ret;
}
...
static int test_x509_crl_tbs_cache(void)
{
    int ret;
    X509_CRL *crl = 
# 113 "../test/x509_test.c" 3 4
                   ((void *)0)
# 113 "../test/x509_test.c"
                       ;
    const unsigned char *p = crldata;

    ret = test_ptr("../test/x509_test.c", 116, "crl = d2i_X509_CRL(NULL, &p, sizeof(crldata))", crl = d2i_X509_CRL(
# 116 "../test/x509_test.c" 3 4
         ((void *)0)
# 116 "../test/x509_test.c"
         , &p, sizeof(crldata)))
          && test_int_gt("../test/x509_test.c", 117, "X509_CRL_sign(crl, privkey, signmd)", "0", X509_CRL_sign(crl, privkey, signmd), 0)
          && test_int_eq("../test/x509_test.c", 118, "X509_CRL_verify(crl, pubkey)", "1", X509_CRL_verify(crl, pubkey), 1);
...
static int test_asn1_item_verify(void)
{
    int ret = 0;
    BIO *bio = 
# 127 "../test/x509_test.c" 3 4
              ((void *)0)
# 127 "../test/x509_test.c"
                  ;
    X509 *x509 = 
# 128 "../test/x509_test.c" 3 4
                ((void *)0)
# 128 "../test/x509_test.c"
                    ;
    const char *certfile;
    const ASN1_BIT_STRING *sig = 
# 130 "../test/x509_test.c" 3 4
                                ((void *)0)
# 130 "../test/x509_test.c"
                                    ;
    const X509_ALGOR *alg = 
# 131 "../test/x509_test.c" 3 4
                           ((void *)0)
# 131 "../test/x509_test.c"
                               ;
    EVP_PKEY *pkey;

    RSA *rsa = 
# 134 "../test/x509_test.c" 3 4
              ((void *)0)
# 134 "../test/x509_test.c"
                  ;


    if (!test_ptr("../test/x509_test.c", 137, "certfile = test_get_argument(0)", certfile = test_get_argument(0))
        || !test_ptr("../test/x509_test.c", 138, "bio = BIO_new_file(certfile, \"r\")", bio = BIO_new_file(certfile, "r"))
        || !test_ptr("../test/x509_test.c", 139, "x509 = PEM_read_bio_X509(bio, NULL, NULL, NULL)", x509 = PEM_read_bio_X509(bio, 
# 139 "../test/x509_test.c" 3 4
           ((void *)0)
# 139 "../test/x509_test.c"
           , 
# 139 "../test/x509_test.c" 3 4
           ((void *)0)
# 139 "../test/x509_test.c"
...
# 139 "../test/x509_test.c"
        ...
        || !test_ptr("../test/x509_test.c", 140, "pkey = X509_get0_pubkey(x509)", pkey = X509_get0_pubkey(x509)))
        goto err;



    if (!test_ptr("../test/x509_test.c", 145, "rsa = EVP_PKEY_get1_RSA(pkey)", rsa = EVP_PKEY_get1_RSA(pkey)))
        goto err;

    if (!test_int_gt("../test/x509_test.c", 148, "EVP_PKEY_set1_RSA(pkey, rsa)", "0", EVP_PKEY_set1_RSA(pkey, rsa), 0))
        goto err;


    X509_get0_signature(&sig, &alg, x509);

    if (!test_int_gt("../test/x509_test.c", 154, "ASN1_item_verify(ASN1_ITEM_rptr(X509_CINF), (X509_ALGOR *)alg, (ASN1_BIT_STRING *)sig, &x509->cert_info, pkey)", "0", ASN1_item_verify((X509_CINF_it()), (X509_ALGOR *)alg, (ASN1_BIT_STRING *)sig, &x509->cert_info, pkey), 0)

                                                                 )
        goto err;

    ERR_set_mark();
    if (!test_int_lt("../test/x509_test.c", 160, "ASN1_item_verify(ASN1_ITEM_rptr(X509_CINF), (X509_ALGOR *)alg, (ASN1_BIT_STRING *)sig, NULL, pkey)", "0", ASN1_item_verify((X509_CINF_it()), (X509_ALGOR *)alg, (ASN1_BIT_STRING *)sig, 
# 160 "../test/x509_test.c" 3 4
        ((void *)0)
# 160 "../test/x509_test.c"
        , pkey), 0)
...
static int test_x509_delete_last_extension(void)
{
    int ret = 0;
    X509 *x509 = 
# 182 "../test/x509_test.c" 3 4
                ((void *)0)
# 182 "../test/x509_test.c"
                    ;
    X509_EXTENSION *ext = 
# 183 "../test/x509_test.c" 3 4
                         ((void *)0)
# 183 "../test/x509_test.c"
                             ;
    ASN1_OBJECT *obj = 
# 184 "../test/x509_test.c" 3 4
                      ((void *)0)
# 184 "../test/x509_test.c"
                          ;

    if (!test_ptr("../test/x509_test.c", 186, "(x509 = X509_new())", (x509 = X509_new()))

        || !test_ptr_null("../test/x509_test.c", 188, "X509_get0_extensions(x509)", X509_get0_extensions(x509))

        || !test_ptr("../test/x509_test.c", 190, "(ext = X509_EXTENSION_new())", (ext = X509_EXTENSION_new()))
        || !test_ptr("../test/x509_test.c", 191, "(obj = OBJ_nid2obj(NID_subject_key_identifier))", (obj = OBJ_nid2obj(82)))
        || !test_int_eq("../test/x509_test.c", 192, "X509_EXTENSION_set_object(ext, obj)", "1", X509_EXTENSION_set_object(ext, obj), 1)
        || !test_int_eq("../test/x509_test.c", 193, "X509_add_ext(x509, ext, -1)", "1", X509_add_ext(x509, ext, -1), 1)

        || !test_ptr("../test/x509_test.c", 195, "X509_get0_extensions(x509)", X509_get0_extensions(x509))
        || !test_int_eq("../test/x509_test.c", 196, "sk_X509_EXTENSION_num(X509_get0_extensions(x509))", "1", OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_get0_extensions(x509))), 1))
        goto err;
    ...
    if (!test_ptr_null("../test/x509_test.c", 203, "X509_get0_extensions(x509)", X509_get0_extensions(x509)))
        goto err;
...
static int test_x509_crl_delete_last_extension(void)
{
    int ret = 0;
    X509_CRL *crl = 
# 217 "../test/x509_test.c" 3 4
                   ((void *)0)
# 217 "../test/x509_test.c"
                       ;
    X509_EXTENSION *ext = 
# 218 "../test/x509_test.c" 3 4
                         ((void *)0)
# 218 "../test/x509_test.c"
                             ;
    ASN1_OBJECT *obj = 
# 219 "../test/x509_test.c" 3 4
                      ((void *)0)
# 219 "../test/x509_test.c"
                          ;

    if (!test_ptr("../test/x509_test.c", 221, "(crl = X509_CRL_new())", (crl = X509_CRL_new()))

        || !test_ptr_null("../test/x509_test.c", 223, "X509_CRL_get0_extensions(crl)", X509_CRL_get0_extensions(crl))

        || !test_ptr("../test/x509_test.c", 225, "(ext = X509_EXTENSION_new())", (ext = X509_EXTENSION_new()))
        || !test_ptr("../test/x509_test.c", 226, "(obj = OBJ_nid2obj(NID_subject_key_identifier))", (obj = OBJ_nid2obj(82)))
        || !test_int_eq("../test/x509_test.c", 227, "X509_EXTENSION_set_object(ext, obj)", "1", X509_EXTENSION_set_object(ext, obj), 1)
        || !test_int_eq("../test/x509_test.c", 228, "X509_CRL_add_ext(crl, ext, -1)", "1", X509_CRL_add_ext(crl, ext, -1), 1)

        || !test_ptr("../test/x509_test.c", 230, "X509_CRL_get0_extensions(crl)", X509_CRL_get0_extensions(crl))
        || !test_int_eq("../test/x509_test.c", 231, "sk_X509_EXTENSION_num(X509_CRL_get0_extensions(crl))", "1", OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_CRL_get0_extensions(crl))), 1)
                          )
        goto err;
    ...
    if (!test_ptr_null("../test/x509_test.c", 239, "X509_CRL_get0_extensions(crl)", X509_CRL_get0_extensions(crl)))
        goto err;
...
static int test_x509_revoked_delete_last_extension(void)
{
    int ret = 0;
    X509_REVOKED *rev = 
# 253 "../test/x509_test.c" 3 4
                       ((void *)0)
# 253 "../test/x509_test.c"
                           ;
    X509_EXTENSION *ext = 
# 254 "../test/x509_test.c" 3 4
                         ((void *)0)
# 254 "../test/x509_test.c"
                             ;
    ASN1_OBJECT *obj = 
# 255 "../test/x509_test.c" 3 4
                      ((void *)0)
# 255 "../test/x509_test.c"
                          ;

    if (!test_ptr("../test/x509_test.c", 257, "(rev = X509_REVOKED_new())", (rev = X509_REVOKED_new()))

        || !test_ptr_null("../test/x509_test.c", 259, "X509_REVOKED_get0_extensions(rev)", X509_REVOKED_get0_extensions(rev))

        || !test_ptr("../test/x509_test.c", 261, "(ext = X509_EXTENSION_new())", (ext = X509_EXTENSION_new()))
        || !test_ptr("../test/x509_test.c", 262, "(obj = OBJ_nid2obj(NID_subject_key_identifier))", (obj = OBJ_nid2obj(82)))
        || !test_int_eq("../test/x509_test.c", 263, "X509_EXTENSION_set_object(ext, obj)", "1", X509_EXTENSION_set_object(ext, obj), 1)
        || !test_int_eq("../test/x509_test.c", 264, "X509_REVOKED_add_ext(rev, ext, -1)", "1", X509_REVOKED_add_ext(rev, ext, -1), 1)

        || !test_ptr("../test/x509_test.c", 266, "X509_REVOKED_get0_extensions(rev)", X509_REVOKED_get0_extensions(rev))
        || !test_int_eq("../test/x509_test.c", 267, "sk_X509_EXTENSION_num(X509_REVOKED_get0_extensions(rev))", "1", OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_REVOKED_get0_extensions(rev))), 1))
        goto err;
    ...
    if (!test_ptr_null("../test/x509_test.c", 274, "X509_REVOKED_get0_extensions(rev)", X509_REVOKED_get0_extensions(rev)))
        goto err;
...
int setup_tests(void)
{
    ...
    if (cnt != 1) {
        test_error("../test/x509_test.c", 294, "Must specify a certificate file self-signed with RSA-PSS.\n");
        return 0;
    }

    p = pubkeydata;
    pubkey = d2i_PUBKEY(
# 299 "../test/x509_test.c" 3 4
                       ((void *)0)
# 299 "../test/x509_test.c"
                           , &p, sizeof(pubkeydata));

    p = privkeydata;
    privkey = d2i_PrivateKey(408, 
# 302 "../test/x509_test.c" 3 4
                                         ((void *)0)
# 302 "../test/x509_test.c"
                                             , &p, sizeof(privkeydata));

    if (pubkey == 
# 304 "../test/x509_test.c" 3 4
                 ((void *)0) 
# 304 "../test/x509_test.c"
                      || privkey == 
# 304 "../test/x509_test.c" 3 4
                                    ((void *)0)
# 304 "../test/x509_test.c"
    ...
    signmd = EVP_MD_fetch(
# 310 "../test/x509_test.c" 3 4
                         ((void *)0)
# 310 "../test/x509_test.c"
                             , "SHA384", 
# 310 "../test/x509_test.c" 3 4
                                         ((void *)0)
# 310 "../test/x509_test.c"
    ...
    if (signmd == 
# 311 "../test/x509_test.c" 3 4
                 ((void *)0)
# 311 "../test/x509_test.c"
                     ) {
    ...
    add_test("test_asn1_item_verify", test_asn1_item_verify);
    add_test("test_x509_delete_last_extension", test_x509_delete_last_extension);
    add_test("test_x509_crl_delete_last_extension", test_x509_crl_delete_last_extension);
    add_test("test_x509_revoked_delete_last_extension", test_x509_revoked_delete_last_extension);
    return 1;
}
