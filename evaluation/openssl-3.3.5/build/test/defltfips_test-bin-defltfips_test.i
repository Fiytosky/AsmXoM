# 0 "../test/defltfips_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/defltfips_test.c"
# 10 "../test/defltfips_test.c"
...
static int test_is_fips_enabled(void)
{
    ...
    EVP_MD *sha256 = 
# 21 "../test/defltfips_test.c" 3 4
                    ((void *)0)
# 21 "../test/defltfips_test.c"
                        ;
    ...
    is_fips_enabled = EVP_default_properties_is_fips_enabled(
# 28 "../test/defltfips_test.c" 3 4
                                                            ((void *)0)
# 28 "../test/defltfips_test.c"
                                                                );
    is_fips_loaded = OSSL_PROVIDER_available(
# 29 "../test/defltfips_test.c" 3 4
                                            ((void *)0)
# 29 "../test/defltfips_test.c"
                                                , "fips");
    ...
    if (!test_int_eq("../test/defltfips_test.c", 37, "is_fips || bad_fips", "is_fips_enabled", is_fips || bad_fips, is_fips_enabled)
            || !test_int_eq("../test/defltfips_test.c", 38, "is_fips && !bad_fips", "is_fips_loaded", is_fips && !bad_fips, is_fips_loaded))
        return 0;
    ...
    sha256 = EVP_MD_fetch(
# 45 "../test/defltfips_test.c" 3 4
                         ((void *)0)
# 45 "../test/defltfips_test.c"
                             , "SHA2-256", 
# 45 "../test/defltfips_test.c" 3 4
                                           ((void *)0)
# 45 "../test/defltfips_test.c"
    ...
    if (bad_fips) {
        if (!test_ptr_null("../test/defltfips_test.c", 47, "sha256", sha256)) {
            EVP_MD_free(sha256);
            return 0;
        }
    } else {
        if (!test_ptr("../test/defltfips_test.c", 52, "sha256", sha256))
            return 0;
        if (is_fips
            && !test_str_eq("../test/defltfips_test.c", 55, "OSSL_PROVIDER_get0_name(EVP_MD_get0_provider(sha256))", "\"fips\"", OSSL_PROVIDER_get0_name(EVP_MD_get0_provider(sha256)), "fips")
                                   ) {
            EVP_MD_free(sha256);
            return 0;
        }
    ...
    is_fips_enabled = EVP_default_properties_is_fips_enabled(
# 64 "../test/defltfips_test.c" 3 4
                                                            ((void *)0)
# 64 "../test/defltfips_test.c"
                                                                );
    if (!test_int_eq("../test/defltfips_test.c", 65, "is_fips || bad_fips", "is_fips_enabled", is_fips || bad_fips, is_fips_enabled))
        return 0;
...
int setup_tests(void)
{
    ...
    if (!test_skip_common_options()) {
        test_error("../test/defltfips_test.c", 77, "Error parsing test options\n");
        return 0;
    }
    ...
    default:
        test_error("../test/defltfips_test.c", 101, "Invalid argument\n");
        return 0;
    }


    add_test("test_is_fips_enabled", test_is_fips_enabled);
    return 1;
}
