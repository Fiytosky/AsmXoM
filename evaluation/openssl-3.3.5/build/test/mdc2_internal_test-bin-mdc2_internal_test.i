# 0 "../test/mdc2_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/mdc2_internal_test.c"
# 16 "../test/mdc2_internal_test.c"
...
# 17 "../test/mdc2_internal_test.c" 2
...
# 19 "../test/mdc2_internal_test.c" 2
...
# 20 "../test/mdc2_internal_test.c" 2
...
extern unsigned char *MDC2(const unsigned char *d, size_t n,
                                          unsigned char *md);
# 22 "../test/mdc2_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 23 "../test/mdc2_internal_test.c" 2
...
static int test_mdc2(int idx)
{
    ...
    if (!test_mem_eq("../test/mdc2_internal_test.c", 64, "testdata.expected", "md", testdata.expected, 16, md, 16)
                                            ) {
        test_info("../test/mdc2_internal_test.c", 66, "mdc2 test %d: unexpected output", idx);
        return 0;
    }
...
int setup_tests(void)
{
    add_all_tests("test_mdc2", test_mdc2, (sizeof(tests)/sizeof((tests)[0])), 1);
    return 1;
}
