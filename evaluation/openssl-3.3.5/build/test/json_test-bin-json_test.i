...
# 14 "../test/json_test.c" 2
# 1 "../include/internal/json_enc.h" 1
# 23 "../include/internal/json_enc.h"
...
# 70 "../include/internal/json_enc.h"
...
# 96 "../include/internal/json_enc.h"
int ossl_json_reset(OSSL_JSON_ENC *json);
# 107 "../include/internal/json_enc.h"
int ossl_json_flush(OSSL_JSON_ENC *json);
# 117 "../include/internal/json_enc.h"
...
# 147 "../include/internal/json_enc.h"
int ossl_json_in_error(OSSL_JSON_ENC *json);
# 176 "../include/internal/json_enc.h"
...
static int helper_ensure(struct helper *h)
{
    ...
    if (!test_ptr("../test/json_test.c", 28, "h->mem_bio = BIO_new(BIO_s_mem())", h->mem_bio = BIO_new(BIO_s_mem())))
        return 0;

    if (!ossl_json_init(&h->j, h->mem_bio, h->flags)) {
        BIO_free_all(h->mem_bio);
        h->mem_bio = 
# 33 "../test/json_test.c" 3 4
                    ((void *)0)
# 33 "../test/json_test.c"
                        ;
        return 0;
...
# 160 "../test/json_test.c"
static const struct script_info *get_script_null(void) { static const char script_name[] = "null"; static const char script_title[] = "\"serialize a single null\""; static const struct script_word script_words[] = { { 
# 160 "../test/json_test.c" 3 4
((void *)0)
# 160 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 160 "../test/json_test.c" 3 4
...
, (0) },
    { 
# 161 "../test/json_test.c" 3 4
   ((void *)0)
# 161 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 161 "../test/json_test.c" 3 4
   ((void *)0)
# 161 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
{ 
# 162 "../test/json_test.c" 3 4
((void *)0)
# 162 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("null"), (sizeof("null") - 1) }; return &script_info; }

static const struct script_info *get_script_obj_empty(void) { static const char script_name[] = "obj_empty"; static const char script_title[] = "\"serialize an empty object\""; static const struct script_word script_words[] = { { 
# 164 "../test/json_test.c" 3 4
((void *)0)
# 164 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 164 "../test/json_test.c" 3 4
((void *)0)
# 164 "../test/json_test.c"
, (0) },
    { 
# 165 "../test/json_test.c" 3 4
   ((void *)0)
# 165 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 165 "../test/json_test.c" 3 4
   ((void *)0)
# 165 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 166 "../test/json_test.c" 3 4
   ((void *)0)
# 166 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 166 "../test/json_test.c" 3 4
   ((void *)0)
# 166 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
{ 
# 167 "../test/json_test.c" 3 4
((void *)0)
# 167 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{}"), (sizeof("{}") - 1) }; return &script_info; }

static const struct script_info *get_script_array_empty(void) { static const char script_name[] = "array_empty"; static const char script_title[] = "\"serialize an empty array\""; static const struct script_word script_words[] = { { 
# 169 "../test/json_test.c" 3 4
((void *)0)
# 169 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 169 "../test/json_test.c" 3 4
((void *)0)
# 169 "../test/json_test.c"
, (0) },
    { 
# 170 "../test/json_test.c" 3 4
   ((void *)0)
# 170 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 170 "../test/json_test.c" 3 4
   ((void *)0)
# 170 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 171 "../test/json_test.c" 3 4
   ((void *)0)
# 171 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 171 "../test/json_test.c" 3 4
   ((void *)0)
# 171 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 172 "../test/json_test.c" 3 4
((void *)0)
# 172 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[]"), (sizeof("[]") - 1) }; return &script_info; }

static const struct script_info *get_script_bool_false(void) { static const char script_name[] = "bool_false"; static const char script_title[] = "\"serialize false\""; static const struct script_word script_words[] = { { 
# 174 "../test/json_test.c" 3 4
((void *)0)
# 174 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 174 "../test/json_test.c" 3 4
((void *)0)
# 174 "../test/json_test.c"
, (0) },
    { 
# 175 "../test/json_test.c" 3 4
   ((void *)0)
# 175 "../test/json_test.c"
   , (OPK_CALL_I) }, { 
# 175 "../test/json_test.c" 3 4
   ((void *)0)
# 175 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_bool) }, { 
# 175 "../test/json_test.c" 3 4
   ((void *)0)
# 175 "../test/json_test.c"
   , 0, ((0)) },
{ 
# 176 "../test/json_test.c" 3 4
((void *)0)
# 176 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("false"), (sizeof("false") - 1) }; return &script_info; }

static const struct script_info *get_script_bool_true(void) { static const char script_name[] = "bool_true"; static const char script_title[] = "\"serialize true\""; static const struct script_word script_words[] = { { 
# 178 "../test/json_test.c" 3 4
((void *)0)
# 178 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 178 "../test/json_test.c" 3 4
((void *)0)
# 178 "../test/json_test.c"
, (0) },
    { 
# 179 "../test/json_test.c" 3 4
   ((void *)0)
# 179 "../test/json_test.c"
   , (OPK_CALL_I) }, { 
# 179 "../test/json_test.c" 3 4
   ((void *)0)
# 179 "../test/json_test.c"
...
# 179 "../test/json_test.c"
   , 0, ((1)) },
{ 
# 180 "../test/json_test.c" 3 4
((void *)0)
# 180 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("true"), (sizeof("true") - 1) }; return &script_info; }

static const struct script_info *get_script_u64_0(void) { static const char script_name[] = "u64_0"; static const char script_title[] = "\"serialize u64(0)\""; static const struct script_word script_words[] = { { 
# 182 "../test/json_test.c" 3 4
((void *)0)
# 182 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 182 "../test/json_test.c" 3 4
((void *)0)
# 182 "../test/json_test.c"
, (0) },
    { 
# 183 "../test/json_test.c" 3 4
   ((void *)0)
# 183 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 183 "../test/json_test.c" 3 4
   ((void *)0)
# 183 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_u64) }, { 
# 183 "../test/json_test.c" 3 4
   ((void *)0)
# 183 "../test/json_test.c"
   , ((0)) },
{ 
# 184 "../test/json_test.c" 3 4
((void *)0)
# 184 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("0"), (sizeof("0") - 1) }; return &script_info; }

static const struct script_info *get_script_u64_1(void) { static const char script_name[] = "u64_1"; static const char script_title[] = "\"serialize u64(1)\""; static const struct script_word script_words[] = { { 
# 186 "../test/json_test.c" 3 4
((void *)0)
# 186 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 186 "../test/json_test.c" 3 4
((void *)0)
# 186 "../test/json_test.c"
, (0) },
    { 
# 187 "../test/json_test.c" 3 4
   ((void *)0)
# 187 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 187 "../test/json_test.c" 3 4
   ((void *)0)
# 187 "../test/json_test.c"
...
# 187 "../test/json_test.c"
   , ((1)) },
{ 
# 188 "../test/json_test.c" 3 4
((void *)0)
# 188 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("1"), (sizeof("1") - 1) }; return &script_info; }

static const struct script_info *get_script_u64_10(void) { static const char script_name[] = "u64_10"; static const char script_title[] = "\"serialize u64(10)\""; static const struct script_word script_words[] = { { 
# 190 "../test/json_test.c" 3 4
((void *)0)
# 190 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 190 "../test/json_test.c" 3 4
((void *)0)
# 190 "../test/json_test.c"
, (0) },
    { 
# 191 "../test/json_test.c" 3 4
   ((void *)0)
# 191 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 191 "../test/json_test.c" 3 4
   ((void *)0)
# 191 "../test/json_test.c"
...
# 191 "../test/json_test.c"
   , ((10)) },
{ 
# 192 "../test/json_test.c" 3 4
((void *)0)
# 192 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("10"), (sizeof("10") - 1) }; return &script_info; }

static const struct script_info *get_script_u64_12345(void) { static const char script_name[] = "u64_12345"; static const char script_title[] = "\"serialize u64(12345)\""; static const struct script_word script_words[] = { { 
# 194 "../test/json_test.c" 3 4
((void *)0)
# 194 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 194 "../test/json_test.c" 3 4
((void *)0)
# 194 "../test/json_test.c"
, (0) },
    { 
# 195 "../test/json_test.c" 3 4
   ((void *)0)
# 195 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 195 "../test/json_test.c" 3 4
   ((void *)0)
# 195 "../test/json_test.c"
...
# 195 "../test/json_test.c"
   , ((12345)) },
{ 
# 196 "../test/json_test.c" 3 4
((void *)0)
# 196 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("12345"), (sizeof("12345") - 1) }; return &script_info; }

static const struct script_info *get_script_u64_18446744073709551615(void) { static const char script_name[] = "u64_18446744073709551615"; static const char script_title[] = "\"serialize u64(18446744073709551615)\""; static const struct script_word script_words[] = { { 
# 198 "../test/json_test.c" 3 4
((void *)0)
# 198 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 198 "../test/json_test.c" 3 4
((void *)0)
# 198 "../test/json_test.c"
, (0) },
    { 
# 199 "../test/json_test.c" 3 4
   ((void *)0)
# 199 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 199 "../test/json_test.c" 3 4
   ((void *)0)
# 199 "../test/json_test.c"
...
{ 
# 200 "../test/json_test.c" 3 4
((void *)0)
# 200 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("18446744073709551615"), (sizeof("18446744073709551615") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_0(void) { static const char script_name[] = "i64_0"; static const char script_title[] = "\"serialize i64(0)\""; static const struct script_word script_words[] = { { 
# 202 "../test/json_test.c" 3 4
((void *)0)
# 202 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 202 "../test/json_test.c" 3 4
((void *)0)
# 202 "../test/json_test.c"
, (0) },
    { 
# 203 "../test/json_test.c" 3 4
   ((void *)0)
# 203 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 203 "../test/json_test.c" 3 4
   ((void *)0)
# 203 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_i64) }, { 
# 203 "../test/json_test.c" 3 4
   ((void *)0)
# 203 "../test/json_test.c"
   , 0, ((0)) },
{ 
# 204 "../test/json_test.c" 3 4
((void *)0)
# 204 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("0"), (sizeof("0") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_1(void) { static const char script_name[] = "i64_1"; static const char script_title[] = "\"serialize i64(1)\""; static const struct script_word script_words[] = { { 
# 206 "../test/json_test.c" 3 4
((void *)0)
# 206 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 206 "../test/json_test.c" 3 4
((void *)0)
# 206 "../test/json_test.c"
, (0) },
    { 
# 207 "../test/json_test.c" 3 4
   ((void *)0)
# 207 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 207 "../test/json_test.c" 3 4
   ((void *)0)
# 207 "../test/json_test.c"
...
# 207 "../test/json_test.c"
   , 0, ((1)) },
{ 
# 208 "../test/json_test.c" 3 4
((void *)0)
# 208 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("1"), (sizeof("1") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_2(void) { static const char script_name[] = "i64_2"; static const char script_title[] = "\"serialize i64(2)\""; static const struct script_word script_words[] = { { 
# 210 "../test/json_test.c" 3 4
((void *)0)
# 210 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 210 "../test/json_test.c" 3 4
((void *)0)
# 210 "../test/json_test.c"
, (0) },
    { 
# 211 "../test/json_test.c" 3 4
   ((void *)0)
# 211 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 211 "../test/json_test.c" 3 4
   ((void *)0)
# 211 "../test/json_test.c"
...
# 211 "../test/json_test.c"
   , 0, ((2)) },
{ 
# 212 "../test/json_test.c" 3 4
((void *)0)
# 212 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("2"), (sizeof("2") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_10(void) { static const char script_name[] = "i64_10"; static const char script_title[] = "\"serialize i64(10)\""; static const struct script_word script_words[] = { { 
# 214 "../test/json_test.c" 3 4
((void *)0)
# 214 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 214 "../test/json_test.c" 3 4
((void *)0)
# 214 "../test/json_test.c"
, (0) },
    { 
# 215 "../test/json_test.c" 3 4
   ((void *)0)
# 215 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 215 "../test/json_test.c" 3 4
   ((void *)0)
# 215 "../test/json_test.c"
...
# 215 "../test/json_test.c"
   , 0, ((10)) },
{ 
# 216 "../test/json_test.c" 3 4
((void *)0)
# 216 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("10"), (sizeof("10") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_12345(void) { static const char script_name[] = "i64_12345"; static const char script_title[] = "\"serialize i64(12345)\""; static const struct script_word script_words[] = { { 
# 218 "../test/json_test.c" 3 4
((void *)0)
# 218 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 218 "../test/json_test.c" 3 4
((void *)0)
# 218 "../test/json_test.c"
, (0) },
    { 
# 219 "../test/json_test.c" 3 4
   ((void *)0)
# 219 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 219 "../test/json_test.c" 3 4
   ((void *)0)
# 219 "../test/json_test.c"
...
# 219 "../test/json_test.c"
   , 0, ((12345)) },
{ 
# 220 "../test/json_test.c" 3 4
((void *)0)
# 220 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("12345"), (sizeof("12345") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_9223372036854775807(void) { static const char script_name[] = "i64_9223372036854775807"; static const char script_title[] = "\"serialize i64(9223372036854775807)\""; static const struct script_word script_words[] = { { 
# 222 "../test/json_test.c" 3 4
((void *)0)
# 222 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 222 "../test/json_test.c" 3 4
((void *)0)
# 222 "../test/json_test.c"
, (0) },
    { 
# 223 "../test/json_test.c" 3 4
   ((void *)0)
# 223 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 223 "../test/json_test.c" 3 4
   ((void *)0)
# 223 "../test/json_test.c"
...
{ 
# 224 "../test/json_test.c" 3 4
((void *)0)
# 224 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("9223372036854775807"), (sizeof("9223372036854775807") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m1(void) { static const char script_name[] = "i64_m1"; static const char script_title[] = "\"serialize i64(-1)\""; static const struct script_word script_words[] = { { 
# 226 "../test/json_test.c" 3 4
((void *)0)
# 226 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 226 "../test/json_test.c" 3 4
((void *)0)
# 226 "../test/json_test.c"
, (0) },
    { 
# 227 "../test/json_test.c" 3 4
   ((void *)0)
# 227 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 227 "../test/json_test.c" 3 4
   ((void *)0)
# 227 "../test/json_test.c"
...
# 227 "../test/json_test.c"
   , 0, ((-1)) },
{ 
# 228 "../test/json_test.c" 3 4
((void *)0)
# 228 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-1"), (sizeof("-1") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m2(void) { static const char script_name[] = "i64_m2"; static const char script_title[] = "\"serialize i64(-2)\""; static const struct script_word script_words[] = { { 
# 230 "../test/json_test.c" 3 4
((void *)0)
# 230 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 230 "../test/json_test.c" 3 4
((void *)0)
# 230 "../test/json_test.c"
, (0) },
    { 
# 231 "../test/json_test.c" 3 4
   ((void *)0)
# 231 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 231 "../test/json_test.c" 3 4
   ((void *)0)
# 231 "../test/json_test.c"
...
# 231 "../test/json_test.c"
   , 0, ((-2)) },
{ 
# 232 "../test/json_test.c" 3 4
((void *)0)
# 232 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-2"), (sizeof("-2") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m10(void) { static const char script_name[] = "i64_m10"; static const char script_title[] = "\"serialize i64(-10)\""; static const struct script_word script_words[] = { { 
# 234 "../test/json_test.c" 3 4
((void *)0)
# 234 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 234 "../test/json_test.c" 3 4
((void *)0)
# 234 "../test/json_test.c"
, (0) },
    { 
# 235 "../test/json_test.c" 3 4
   ((void *)0)
# 235 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 235 "../test/json_test.c" 3 4
   ((void *)0)
# 235 "../test/json_test.c"
...
# 235 "../test/json_test.c"
   , 0, ((-10)) },
{ 
# 236 "../test/json_test.c" 3 4
((void *)0)
# 236 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-10"), (sizeof("-10") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m12345(void) { static const char script_name[] = "i64_m12345"; static const char script_title[] = "\"serialize i64(-12345)\""; static const struct script_word script_words[] = { { 
# 238 "../test/json_test.c" 3 4
((void *)0)
# 238 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 238 "../test/json_test.c" 3 4
((void *)0)
# 238 "../test/json_test.c"
, (0) },
    { 
# 239 "../test/json_test.c" 3 4
   ((void *)0)
# 239 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 239 "../test/json_test.c" 3 4
   ((void *)0)
# 239 "../test/json_test.c"
...
# 239 "../test/json_test.c"
   , 0, ((-12345)) },
{ 
# 240 "../test/json_test.c" 3 4
((void *)0)
# 240 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-12345"), (sizeof("-12345") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m9223372036854775807(void) { static const char script_name[] = "i64_m9223372036854775807"; static const char script_title[] = "\"serialize i64(-9223372036854775807)\""; static const struct script_word script_words[] = { { 
# 242 "../test/json_test.c" 3 4
((void *)0)
# 242 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 242 "../test/json_test.c" 3 4
((void *)0)
# 242 "../test/json_test.c"
, (0) },
    { 
# 243 "../test/json_test.c" 3 4
   ((void *)0)
# 243 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 243 "../test/json_test.c" 3 4
   ((void *)0)
# 243 "../test/json_test.c"
...
# 243 "../test/json_test.c"
   , 0, ((-9223372036854775807LL)) },
{ 
# 244 "../test/json_test.c" 3 4
((void *)0)
# 244 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-9223372036854775807"), (sizeof("-9223372036854775807") - 1) }; return &script_info; }

static const struct script_info *get_script_i64_m9223372036854775808(void) { static const char script_name[] = "i64_m9223372036854775808"; static const char script_title[] = "\"serialize i64(-9223372036854775808)\""; static const struct script_word script_words[] = { { 
# 246 "../test/json_test.c" 3 4
((void *)0)
# 246 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 246 "../test/json_test.c" 3 4
((void *)0)
# 246 "../test/json_test.c"
, (0) },
    { 
# 247 "../test/json_test.c" 3 4
   ((void *)0)
# 247 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 247 "../test/json_test.c" 3 4
   ((void *)0)
# 247 "../test/json_test.c"
...
# 247 "../test/json_test.c" 3 4
   ((void *)0)
# 247 "../test/json_test.c"
   , 0, ((-9223372036854775807LL - 1LL)) },
{ 
# 248 "../test/json_test.c" 3 4
((void *)0)
# 248 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("-9223372036854775808"), (sizeof("-9223372036854775808") - 1) }; return &script_info; }

static const struct script_info *get_script_str_empty(void) { static const char script_name[] = "str_empty"; static const char script_title[] = "\"serialize \\\"\\\"\""; static const struct script_word script_words[] = { { 
# 250 "../test/json_test.c" 3 4
((void *)0)
# 250 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 250 "../test/json_test.c" 3 4
((void *)0)
# 250 "../test/json_test.c"
, (0) },
    { 
# 251 "../test/json_test.c" 3 4
   ((void *)0)
# 251 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 251 "../test/json_test.c" 3 4
   ((void *)0)
# 251 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("")) },
{ 
# 252 "../test/json_test.c" 3 4
((void *)0)
# 252 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"\""), (sizeof("\"\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_a(void) { static const char script_name[] = "str_a"; static const char script_title[] = "\"serialize \\\"a\\\"\""; static const struct script_word script_words[] = { { 
# 254 "../test/json_test.c" 3 4
((void *)0)
# 254 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 254 "../test/json_test.c" 3 4
((void *)0)
# 254 "../test/json_test.c"
, (0) },
    { 
# 255 "../test/json_test.c" 3 4
   ((void *)0)
# 255 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 255 "../test/json_test.c" 3 4
   ((void *)0)
# 255 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("a")) },
{ 
# 256 "../test/json_test.c" 3 4
((void *)0)
# 256 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"a\""), (sizeof("\"a\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_abc(void) { static const char script_name[] = "str_abc"; static const char script_title[] = "\"serialize \\\"abc\\\"\""; static const struct script_word script_words[] = { { 
# 258 "../test/json_test.c" 3 4
((void *)0)
# 258 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 258 "../test/json_test.c" 3 4
((void *)0)
# 258 "../test/json_test.c"
, (0) },
    { 
# 259 "../test/json_test.c" 3 4
   ((void *)0)
# 259 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 259 "../test/json_test.c" 3 4
   ((void *)0)
# 259 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("abc")) },
{ 
# 260 "../test/json_test.c" 3 4
((void *)0)
# 260 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"abc\""), (sizeof("\"abc\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_quote(void) { static const char script_name[] = "str_quote"; static const char script_title[] = "\"serialize with quote\""; static const struct script_word script_words[] = { { 
# 262 "../test/json_test.c" 3 4
((void *)0)
# 262 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 262 "../test/json_test.c" 3 4
((void *)0)
# 262 "../test/json_test.c"
, (0) },
    { 
# 263 "../test/json_test.c" 3 4
   ((void *)0)
# 263 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 263 "../test/json_test.c" 3 4
   ((void *)0)
# 263 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("abc\"def")) },
{ 
# 264 "../test/json_test.c" 3 4
((void *)0)
# 264 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"abc\\\"def\""), (sizeof("\"abc\\\"def\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_quote2(void) { static const char script_name[] = "str_quote2"; static const char script_title[] = "\"serialize with quote\""; static const struct script_word script_words[] = { { 
# 266 "../test/json_test.c" 3 4
((void *)0)
# 266 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 266 "../test/json_test.c" 3 4
((void *)0)
# 266 "../test/json_test.c"
, (0) },
    { 
# 267 "../test/json_test.c" 3 4
   ((void *)0)
# 267 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 267 "../test/json_test.c" 3 4
   ((void *)0)
# 267 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("abc\"\"def")) },
{ 
# 268 "../test/json_test.c" 3 4
((void *)0)
# 268 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"abc\\\"\\\"def\""), (sizeof("\"abc\\\"\\\"def\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_escape(void) { static const char script_name[] = "str_escape"; static const char script_title[] = "\"serialize with various escapes\""; static const struct script_word script_words[] = { { 
# 270 "../test/json_test.c" 3 4
((void *)0)
# 270 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 270 "../test/json_test.c" 3 4
((void *)0)
# 270 "../test/json_test.c"
, (0) },
    { 
# 271 "../test/json_test.c" 3 4
   ((void *)0)
# 271 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 271 "../test/json_test.c" 3 4
   ((void *)0)
# 271 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("abc\"\"de'f\r\n\t\b\f\\\x01\v\x7f\\")) },
{ 
# 272 "../test/json_test.c" 3 4
((void *)0)
# 272 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"abc\\\"\\\"de'f\\r\\n\\t\\b\\f\\\\\\u0001\\u000b\\u007f\\\\\""), (sizeof("\"abc\\\"\\\"de'f\\r\\n\\t\\b\\f\\\\\\u0001\\u000b\\u007f\\\\\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_len(void) { static const char script_name[] = "str_len"; static const char script_title[] = "\"length-signalled string\""; static const struct script_word script_words[] = { { 
# 274 "../test/json_test.c" 3 4
((void *)0)
# 274 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 274 "../test/json_test.c" 3 4
((void *)0)
# 274 "../test/json_test.c"
, (0) },
    { 
# 275 "../test/json_test.c" 3 4
   ((void *)0)
# 275 "../test/json_test.c"
   , (OPK_CALL_PZ) }, { 
# 275 "../test/json_test.c" 3 4
   ((void *)0)
# 275 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str_len) }, { (("abcdef")) }, { 
# 275 "../test/json_test.c" 3 4
   ((void *)0)
# 275 "../test/json_test.c"
   , ((6)) },
{ 
# 276 "../test/json_test.c" 3 4
((void *)0)
# 276 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"abcdef\""), (sizeof("\"abcdef\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_len0(void) { static const char script_name[] = "str_len0"; static const char script_title[] = "\"0-length-signalled string\""; static const struct script_word script_words[] = { { 
# 278 "../test/json_test.c" 3 4
((void *)0)
# 278 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 278 "../test/json_test.c" 3 4
((void *)0)
# 278 "../test/json_test.c"
, (0) },
    { 
# 279 "../test/json_test.c" 3 4
   ((void *)0)
# 279 "../test/json_test.c"
   , (OPK_CALL_PZ) }, { 
# 279 "../test/json_test.c" 3 4
   ((void *)0)
# 279 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str_len) }, { (("")) }, { 
# 279 "../test/json_test.c" 3 4
   ((void *)0)
# 279 "../test/json_test.c"
   , ((0)) },
{ 
# 280 "../test/json_test.c" 3 4
((void *)0)
# 280 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"\""), (sizeof("\"\"") - 1) }; return &script_info; }

static const struct script_info *get_script_str_len_nul(void) { static const char script_name[] = "str_len_nul"; static const char script_title[] = "\"string with NUL\""; static const struct script_word script_words[] = { { 
# 282 "../test/json_test.c" 3 4
((void *)0)
# 282 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 282 "../test/json_test.c" 3 4
((void *)0)
# 282 "../test/json_test.c"
, (0) },
    { 
# 283 "../test/json_test.c" 3 4
   ((void *)0)
# 283 "../test/json_test.c"
   , (OPK_CALL_PZ) }, { 
# 283 "../test/json_test.c" 3 4
   ((void *)0)
# 283 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str_len) }, { (("x\0y")) }, { 
# 283 "../test/json_test.c" 3 4
   ((void *)0)
# 283 "../test/json_test.c"
   , ((3)) },
{ 
# 284 "../test/json_test.c" 3 4
((void *)0)
# 284 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"x\\u0000y\""), (sizeof("\"x\\u0000y\"") - 1) }; return &script_info; }

static const struct script_info *get_script_hex_data0(void) { static const char script_name[] = "hex_data0"; static const char script_title[] = "\"zero-length hex data\""; static const struct script_word script_words[] = { { 
# 286 "../test/json_test.c" 3 4
((void *)0)
# 286 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 286 "../test/json_test.c" 3 4
((void *)0)
# 286 "../test/json_test.c"
, (0) },
    { 
# 287 "../test/json_test.c" 3 4
   ((void *)0)
# 287 "../test/json_test.c"
   , (OPK_CALL_PZ) }, { 
# 287 "../test/json_test.c" 3 4
   ((void *)0)
# 287 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str_hex) }, { (("")) }, { 
# 287 "../test/json_test.c" 3 4
   ((void *)0)
# 287 "../test/json_test.c"
   , ((0)) },
{ 
# 288 "../test/json_test.c" 3 4
((void *)0)
# 288 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"\""), (sizeof("\"\"") - 1) }; return &script_info; }

static const struct script_info *get_script_hex_data(void) { static const char script_name[] = "hex_data"; static const char script_title[] = "\"hex data\""; static const struct script_word script_words[] = { { 
# 290 "../test/json_test.c" 3 4
((void *)0)
# 290 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 290 "../test/json_test.c" 3 4
((void *)0)
# 290 "../test/json_test.c"
, (0) },
    { 
# 291 "../test/json_test.c" 3 4
   ((void *)0)
# 291 "../test/json_test.c"
   , (OPK_CALL_PZ) }, { 
# 291 "../test/json_test.c" 3 4
   ((void *)0)
# 291 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str_hex) }, { (("\x00\x01\x5a\xfb\xff")) }, { 
# 291 "../test/json_test.c" 3 4
   ((void *)0)
# 291 "../test/json_test.c"
   , ((5)) },
{ 
# 292 "../test/json_test.c" 3 4
((void *)0)
# 292 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"00015afbff\""), (sizeof("\"00015afbff\"") - 1) }; return &script_info; }

static const struct script_info *get_script_array_nest1(void) { static const char script_name[] = "array_nest1"; static const char script_title[] = "\"serialize nested empty arrays\""; static const struct script_word script_words[] = { { 
# 294 "../test/json_test.c" 3 4
((void *)0)
# 294 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 294 "../test/json_test.c" 3 4
((void *)0)
# 294 "../test/json_test.c"
, (0) },
    { 
# 295 "../test/json_test.c" 3 4
   ((void *)0)
# 295 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 295 "../test/json_test.c" 3 4
   ((void *)0)
# 295 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 296 "../test/json_test.c" 3 4
   ((void *)0)
# 296 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 296 "../test/json_test.c" 3 4
   ((void *)0)
# 296 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 297 "../test/json_test.c" 3 4
   ((void *)0)
# 297 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 297 "../test/json_test.c" 3 4
   ((void *)0)
# 297 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 298 "../test/json_test.c" 3 4
   ((void *)0)
# 298 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 298 "../test/json_test.c" 3 4
   ((void *)0)
# 298 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 299 "../test/json_test.c" 3 4
((void *)0)
# 299 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[[]]"), (sizeof("[[]]") - 1) }; return &script_info; }

static const struct script_info *get_script_array_nest2(void) { static const char script_name[] = "array_nest2"; static const char script_title[] = "\"serialize nested empty arrays\""; static const struct script_word script_words[] = { { 
# 301 "../test/json_test.c" 3 4
((void *)0)
# 301 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 301 "../test/json_test.c" 3 4
((void *)0)
# 301 "../test/json_test.c"
, (0) },
    { 
# 302 "../test/json_test.c" 3 4
   ((void *)0)
# 302 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 302 "../test/json_test.c" 3 4
   ((void *)0)
# 302 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 303 "../test/json_test.c" 3 4
   ((void *)0)
# 303 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 303 "../test/json_test.c" 3 4
   ((void *)0)
# 303 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 304 "../test/json_test.c" 3 4
   ((void *)0)
# 304 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 304 "../test/json_test.c" 3 4
   ((void *)0)
# 304 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 305 "../test/json_test.c" 3 4
   ((void *)0)
# 305 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 305 "../test/json_test.c" 3 4
   ((void *)0)
# 305 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 306 "../test/json_test.c" 3 4
   ((void *)0)
# 306 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 306 "../test/json_test.c" 3 4
   ((void *)0)
# 306 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 307 "../test/json_test.c" 3 4
   ((void *)0)
# 307 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 307 "../test/json_test.c" 3 4
   ((void *)0)
# 307 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 308 "../test/json_test.c" 3 4
((void *)0)
# 308 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[[[]]]"), (sizeof("[[[]]]") - 1) }; return &script_info; }

static const struct script_info *get_script_array_nest3(void) { static const char script_name[] = "array_nest3"; static const char script_title[] = "\"serialize nested empty arrays\""; static const struct script_word script_words[] = { { 
# 310 "../test/json_test.c" 3 4
((void *)0)
# 310 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 310 "../test/json_test.c" 3 4
((void *)0)
# 310 "../test/json_test.c"
, (0) },
    { 
# 311 "../test/json_test.c" 3 4
   ((void *)0)
# 311 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 311 "../test/json_test.c" 3 4
   ((void *)0)
# 311 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 312 "../test/json_test.c" 3 4
   ((void *)0)
# 312 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 312 "../test/json_test.c" 3 4
   ((void *)0)
# 312 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 313 "../test/json_test.c" 3 4
   ((void *)0)
# 313 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 313 "../test/json_test.c" 3 4
   ((void *)0)
# 313 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 314 "../test/json_test.c" 3 4
   ((void *)0)
# 314 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 314 "../test/json_test.c" 3 4
   ((void *)0)
# 314 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 315 "../test/json_test.c" 3 4
   ((void *)0)
# 315 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 315 "../test/json_test.c" 3 4
   ((void *)0)
# 315 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 316 "../test/json_test.c" 3 4
   ((void *)0)
# 316 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 316 "../test/json_test.c" 3 4
   ((void *)0)
# 316 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 317 "../test/json_test.c" 3 4
   ((void *)0)
# 317 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 317 "../test/json_test.c" 3 4
   ((void *)0)
# 317 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 318 "../test/json_test.c" 3 4
   ((void *)0)
# 318 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 318 "../test/json_test.c" 3 4
   ((void *)0)
# 318 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 319 "../test/json_test.c" 3 4
   ((void *)0)
# 319 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 319 "../test/json_test.c" 3 4
   ((void *)0)
# 319 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 320 "../test/json_test.c" 3 4
   ((void *)0)
# 320 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 320 "../test/json_test.c" 3 4
   ((void *)0)
# 320 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 321 "../test/json_test.c" 3 4
   ((void *)0)
# 321 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 321 "../test/json_test.c" 3 4
   ((void *)0)
# 321 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 322 "../test/json_test.c" 3 4
   ((void *)0)
# 322 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 322 "../test/json_test.c" 3 4
   ((void *)0)
# 322 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 323 "../test/json_test.c" 3 4
((void *)0)
# 323 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[[[],[],[]],[]]"), (
# 323 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 323 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_array_nest4(void) { static const char script_name[] = "array_nest4"; static const char script_title[] = "\"deep nested arrays\""; static const struct script_word script_words[] = { { 
# 325 "../test/json_test.c" 3 4
((void *)0)
# 325 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 325 "../test/json_test.c" 3 4
((void *)0)
# 325 "../test/json_test.c"
, (0) },
    { 
# 326 "../test/json_test.c" 3 4
   ((void *)0)
# 326 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 326 "../test/json_test.c" 3 4
   ((void *)0)
# 326 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 327 "../test/json_test.c" 3 4
   ((void *)0)
# 327 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 327 "../test/json_test.c" 3 4
   ((void *)0)
# 327 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 328 "../test/json_test.c" 3 4
   ((void *)0)
# 328 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 328 "../test/json_test.c" 3 4
   ((void *)0)
# 328 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 329 "../test/json_test.c" 3 4
   ((void *)0)
# 329 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 329 "../test/json_test.c" 3 4
   ((void *)0)
# 329 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 330 "../test/json_test.c" 3 4
   ((void *)0)
# 330 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 330 "../test/json_test.c" 3 4
   ((void *)0)
# 330 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 331 "../test/json_test.c" 3 4
   ((void *)0)
# 331 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 331 "../test/json_test.c" 3 4
   ((void *)0)
# 331 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 332 "../test/json_test.c" 3 4
   ((void *)0)
# 332 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 332 "../test/json_test.c" 3 4
   ((void *)0)
# 332 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 333 "../test/json_test.c" 3 4
   ((void *)0)
# 333 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 333 "../test/json_test.c" 3 4
   ((void *)0)
# 333 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 334 "../test/json_test.c" 3 4
   ((void *)0)
# 334 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 334 "../test/json_test.c" 3 4
   ((void *)0)
# 334 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 335 "../test/json_test.c" 3 4
   ((void *)0)
# 335 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 335 "../test/json_test.c" 3 4
   ((void *)0)
# 335 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 336 "../test/json_test.c" 3 4
   ((void *)0)
# 336 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 336 "../test/json_test.c" 3 4
   ((void *)0)
# 336 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 337 "../test/json_test.c" 3 4
   ((void *)0)
# 337 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 337 "../test/json_test.c" 3 4
   ((void *)0)
# 337 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 338 "../test/json_test.c" 3 4
   ((void *)0)
# 338 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 338 "../test/json_test.c" 3 4
   ((void *)0)
# 338 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 339 "../test/json_test.c" 3 4
   ((void *)0)
# 339 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 339 "../test/json_test.c" 3 4
   ((void *)0)
# 339 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 340 "../test/json_test.c" 3 4
   ((void *)0)
# 340 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 340 "../test/json_test.c" 3 4
   ((void *)0)
# 340 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 341 "../test/json_test.c" 3 4
   ((void *)0)
# 341 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 341 "../test/json_test.c" 3 4
   ((void *)0)
# 341 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 342 "../test/json_test.c" 3 4
   ((void *)0)
# 342 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 342 "../test/json_test.c" 3 4
   ((void *)0)
# 342 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 343 "../test/json_test.c" 3 4
   ((void *)0)
# 343 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 343 "../test/json_test.c" 3 4
   ((void *)0)
# 343 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 344 "../test/json_test.c" 3 4
   ((void *)0)
# 344 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 344 "../test/json_test.c" 3 4
   ((void *)0)
# 344 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 345 "../test/json_test.c" 3 4
   ((void *)0)
# 345 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 345 "../test/json_test.c" 3 4
   ((void *)0)
# 345 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 346 "../test/json_test.c" 3 4
   ((void *)0)
# 346 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 346 "../test/json_test.c" 3 4
   ((void *)0)
# 346 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 347 "../test/json_test.c" 3 4
   ((void *)0)
# 347 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 347 "../test/json_test.c" 3 4
   ((void *)0)
# 347 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 348 "../test/json_test.c" 3 4
   ((void *)0)
# 348 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 348 "../test/json_test.c" 3 4
   ((void *)0)
# 348 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 349 "../test/json_test.c" 3 4
   ((void *)0)
# 349 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 349 "../test/json_test.c" 3 4
   ((void *)0)
# 349 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 350 "../test/json_test.c" 3 4
   ((void *)0)
# 350 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 350 "../test/json_test.c" 3 4
   ((void *)0)
# 350 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 351 "../test/json_test.c" 3 4
   ((void *)0)
# 351 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 351 "../test/json_test.c" 3 4
   ((void *)0)
# 351 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 352 "../test/json_test.c" 3 4
   ((void *)0)
# 352 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 352 "../test/json_test.c" 3 4
   ((void *)0)
# 352 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 353 "../test/json_test.c" 3 4
   ((void *)0)
# 353 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 353 "../test/json_test.c" 3 4
   ((void *)0)
# 353 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 354 "../test/json_test.c" 3 4
   ((void *)0)
# 354 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 354 "../test/json_test.c" 3 4
   ((void *)0)
# 354 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 355 "../test/json_test.c" 3 4
   ((void *)0)
# 355 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 355 "../test/json_test.c" 3 4
   ((void *)0)
# 355 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 356 "../test/json_test.c" 3 4
   ((void *)0)
# 356 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 356 "../test/json_test.c" 3 4
   ((void *)0)
# 356 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 357 "../test/json_test.c" 3 4
   ((void *)0)
# 357 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 357 "../test/json_test.c" 3 4
   ((void *)0)
# 357 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 358 "../test/json_test.c" 3 4
   ((void *)0)
# 358 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 358 "../test/json_test.c" 3 4
   ((void *)0)
# 358 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 359 "../test/json_test.c" 3 4
   ((void *)0)
# 359 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 359 "../test/json_test.c" 3 4
   ((void *)0)
# 359 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 360 "../test/json_test.c" 3 4
   ((void *)0)
# 360 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 360 "../test/json_test.c" 3 4
   ((void *)0)
# 360 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 361 "../test/json_test.c" 3 4
   ((void *)0)
# 361 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 361 "../test/json_test.c" 3 4
   ((void *)0)
# 361 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 362 "../test/json_test.c" 3 4
   ((void *)0)
# 362 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 362 "../test/json_test.c" 3 4
   ((void *)0)
# 362 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 363 "../test/json_test.c" 3 4
   ((void *)0)
# 363 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 363 "../test/json_test.c" 3 4
   ((void *)0)
# 363 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 364 "../test/json_test.c" 3 4
   ((void *)0)
# 364 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 364 "../test/json_test.c" 3 4
   ((void *)0)
# 364 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 365 "../test/json_test.c" 3 4
   ((void *)0)
# 365 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 365 "../test/json_test.c" 3 4
   ((void *)0)
# 365 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 366 "../test/json_test.c" 3 4
   ((void *)0)
# 366 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 366 "../test/json_test.c" 3 4
   ((void *)0)
# 366 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 367 "../test/json_test.c" 3 4
((void *)0)
# 367 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]],null]"), (
# 367 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 367 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_obj_nontrivial1(void) { static const char script_name[] = "obj_nontrivial1"; static const char script_title[] = "\"serialize nontrivial object\""; static const struct script_word script_words[] = { { 
# 369 "../test/json_test.c" 3 4
((void *)0)
# 369 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 369 "../test/json_test.c" 3 4
((void *)0)
# 369 "../test/json_test.c"
, (0) },
    { 
# 370 "../test/json_test.c" 3 4
   ((void *)0)
# 370 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 370 "../test/json_test.c" 3 4
   ((void *)0)
# 370 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 371 "../test/json_test.c" 3 4
   ((void *)0)
# 371 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 371 "../test/json_test.c" 3 4
   ((void *)0)
# 371 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("")) },
    { 
# 372 "../test/json_test.c" 3 4
   ((void *)0)
# 372 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 372 "../test/json_test.c" 3 4
   ((void *)0)
# 372 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 373 "../test/json_test.c" 3 4
   ((void *)0)
# 373 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 373 "../test/json_test.c" 3 4
   ((void *)0)
# 373 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
{ 
# 374 "../test/json_test.c" 3 4
((void *)0)
# 374 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{\"\":null}"), (
# 374 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 374 "../test/json_test.c"
...
static const struct script_info *get_script_obj_nontrivial2(void) { static const char script_name[] = "obj_nontrivial2"; static const char script_title[] = "\"serialize nontrivial object\""; static const struct script_word script_words[] = { { 
# 376 "../test/json_test.c" 3 4
((void *)0)
# 376 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 376 "../test/json_test.c" 3 4
((void *)0)
# 376 "../test/json_test.c"
, (0) },
    { 
# 377 "../test/json_test.c" 3 4
   ((void *)0)
# 377 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 377 "../test/json_test.c" 3 4
   ((void *)0)
# 377 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 378 "../test/json_test.c" 3 4
   ((void *)0)
# 378 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 378 "../test/json_test.c" 3 4
   ((void *)0)
# 378 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("")) },
    { 
# 379 "../test/json_test.c" 3 4
   ((void *)0)
# 379 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 379 "../test/json_test.c" 3 4
   ((void *)0)
# 379 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 380 "../test/json_test.c" 3 4
   ((void *)0)
# 380 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 380 "../test/json_test.c" 3 4
   ((void *)0)
# 380 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 381 "../test/json_test.c" 3 4
   ((void *)0)
# 381 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 381 "../test/json_test.c" 3 4
   ((void *)0)
# 381 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 382 "../test/json_test.c" 3 4
   ((void *)0)
# 382 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 382 "../test/json_test.c" 3 4
   ((void *)0)
# 382 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
{ 
# 383 "../test/json_test.c" 3 4
((void *)0)
# 383 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{\"\":null,\"x\":null}"), (
# 383 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 383 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_obj_nest1(void) { static const char script_name[] = "obj_nest1"; static const char script_title[] = "\"serialize nested objects\""; static const struct script_word script_words[] = { { 
# 385 "../test/json_test.c" 3 4
((void *)0)
# 385 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 385 "../test/json_test.c" 3 4
((void *)0)
# 385 "../test/json_test.c"
, (0) },
    { 
# 386 "../test/json_test.c" 3 4
   ((void *)0)
# 386 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 386 "../test/json_test.c" 3 4
   ((void *)0)
# 386 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 387 "../test/json_test.c" 3 4
   ((void *)0)
# 387 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 387 "../test/json_test.c" 3 4
   ((void *)0)
# 387 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("")) },
    { 
# 388 "../test/json_test.c" 3 4
   ((void *)0)
# 388 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 388 "../test/json_test.c" 3 4
   ((void *)0)
# 388 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 389 "../test/json_test.c" 3 4
   ((void *)0)
# 389 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 389 "../test/json_test.c" 3 4
   ((void *)0)
# 389 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 390 "../test/json_test.c" 3 4
   ((void *)0)
# 390 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 390 "../test/json_test.c" 3 4
   ((void *)0)
# 390 "../test/json_test.c"
...
# 390 "../test/json_test.c"
   , ((42)) },
    { 
# 391 "../test/json_test.c" 3 4
   ((void *)0)
# 391 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 391 "../test/json_test.c" 3 4
   ((void *)0)
# 391 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
    { 
# 392 "../test/json_test.c" 3 4
   ((void *)0)
# 392 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 392 "../test/json_test.c" 3 4
   ((void *)0)
# 392 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 393 "../test/json_test.c" 3 4
   ((void *)0)
# 393 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 393 "../test/json_test.c" 3 4
   ((void *)0)
# 393 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 394 "../test/json_test.c" 3 4
   ((void *)0)
# 394 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 394 "../test/json_test.c" 3 4
   ((void *)0)
# 394 "../test/json_test.c"
...
# 394 "../test/json_test.c"
   , ((42)) },
    { 
# 395 "../test/json_test.c" 3 4
   ((void *)0)
# 395 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 395 "../test/json_test.c" 3 4
   ((void *)0)
# 395 "../test/json_test.c"
...
# 395 "../test/json_test.c"
   , ((101)) },
    { 
# 396 "../test/json_test.c" 3 4
   ((void *)0)
# 396 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 396 "../test/json_test.c" 3 4
   ((void *)0)
# 396 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 397 "../test/json_test.c" 3 4
   ((void *)0)
# 397 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 397 "../test/json_test.c" 3 4
   ((void *)0)
# 397 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("y")) },
    { 
# 398 "../test/json_test.c" 3 4
   ((void *)0)
# 398 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 398 "../test/json_test.c" 3 4
   ((void *)0)
# 398 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 399 "../test/json_test.c" 3 4
   ((void *)0)
# 399 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 399 "../test/json_test.c" 3 4
   ((void *)0)
# 399 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("z")) },
    { 
# 400 "../test/json_test.c" 3 4
   ((void *)0)
# 400 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 400 "../test/json_test.c" 3 4
   ((void *)0)
# 400 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 401 "../test/json_test.c" 3 4
   ((void *)0)
# 401 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 401 "../test/json_test.c" 3 4
   ((void *)0)
# 401 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("z0")) },
    { 
# 402 "../test/json_test.c" 3 4
   ((void *)0)
# 402 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 402 "../test/json_test.c" 3 4
   ((void *)0)
# 402 "../test/json_test.c"
...
# 402 "../test/json_test.c"
   , 0, ((-1)) },
    { 
# 403 "../test/json_test.c" 3 4
   ((void *)0)
# 403 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 403 "../test/json_test.c" 3 4
   ((void *)0)
# 403 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("z1")) },
    { 
# 404 "../test/json_test.c" 3 4
   ((void *)0)
# 404 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 404 "../test/json_test.c" 3 4
   ((void *)0)
# 404 "../test/json_test.c"
...
# 404 "../test/json_test.c"
   , 0, ((-2)) },
    { 
# 405 "../test/json_test.c" 3 4
   ((void *)0)
# 405 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 405 "../test/json_test.c" 3 4
   ((void *)0)
# 405 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
    { 
# 406 "../test/json_test.c" 3 4
   ((void *)0)
# 406 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 406 "../test/json_test.c" 3 4
   ((void *)0)
# 406 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
{ 
# 407 "../test/json_test.c" 3 4
((void *)0)
# 407 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{\"\":{\"x\":42},\"x\":[42,101],\"y\":null,\"z\":{\"z0\":-1,\"z1\":-2}}"), (
# 407 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 407 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_err_obj_no_key(void) { static const char script_name[] = "err_obj_no_key"; static const char script_title[] = "\"error test: object item without key\""; static const struct script_word script_words[] = { { 
# 409 "../test/json_test.c" 3 4
((void *)0)
# 409 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 409 "../test/json_test.c" 3 4
((void *)0)
# 409 "../test/json_test.c"
, (0) },
    { 
# 410 "../test/json_test.c" 3 4
   ((void *)0)
# 410 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 410 "../test/json_test.c" 3 4
   ((void *)0)
# 410 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 411 "../test/json_test.c" 3 4
   ((void *)0)
# 411 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 411 "../test/json_test.c" 3 4
   ((void *)0)
# 411 "../test/json_test.c"
   , (0) },
    { 
# 412 "../test/json_test.c" 3 4
   ((void *)0)
# 412 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 412 "../test/json_test.c" 3 4
   ((void *)0)
# 412 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 413 "../test/json_test.c" 3 4
   ((void *)0)
# 413 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 413 "../test/json_test.c" 3 4
   ((void *)0)
# 413 "../test/json_test.c"
   , (1) },
    { 
# 414 "../test/json_test.c" 3 4
   ((void *)0)
# 414 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 414 "../test/json_test.c" 3 4
   ((void *)0)
# 414 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
    { 
# 415 "../test/json_test.c" 3 4
   ((void *)0)
# 415 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 415 "../test/json_test.c" 3 4
   ((void *)0)
# 415 "../test/json_test.c"
   , (1) },
{ 
# 416 "../test/json_test.c" 3 4
((void *)0)
# 416 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{"), (
# 416 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 416 "../test/json_test.c"
...
static const struct script_info *get_script_err_obj_multi_key(void) { static const char script_name[] = "err_obj_multi_key"; static const char script_title[] = "\"error test: object item with repeated key\""; static const struct script_word script_words[] = { { 
# 418 "../test/json_test.c" 3 4
((void *)0)
# 418 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 418 "../test/json_test.c" 3 4
((void *)0)
# 418 "../test/json_test.c"
, (0) },
    { 
# 419 "../test/json_test.c" 3 4
   ((void *)0)
# 419 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 419 "../test/json_test.c" 3 4
   ((void *)0)
# 419 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 420 "../test/json_test.c" 3 4
   ((void *)0)
# 420 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 420 "../test/json_test.c" 3 4
   ((void *)0)
# 420 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 421 "../test/json_test.c" 3 4
   ((void *)0)
# 421 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 421 "../test/json_test.c" 3 4
   ((void *)0)
# 421 "../test/json_test.c"
   , (0) },
    { 
# 422 "../test/json_test.c" 3 4
   ((void *)0)
# 422 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 422 "../test/json_test.c" 3 4
   ((void *)0)
# 422 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("y")) },
    { 
# 423 "../test/json_test.c" 3 4
   ((void *)0)
# 423 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 423 "../test/json_test.c" 3 4
   ((void *)0)
# 423 "../test/json_test.c"
   , (1) },
    { 
# 424 "../test/json_test.c" 3 4
   ((void *)0)
# 424 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 424 "../test/json_test.c" 3 4
   ((void *)0)
# 424 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 425 "../test/json_test.c" 3 4
   ((void *)0)
# 425 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 425 "../test/json_test.c" 3 4
   ((void *)0)
# 425 "../test/json_test.c"
   , (1) },
{ 
# 426 "../test/json_test.c" 3 4
((void *)0)
# 426 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{\"x\":"), (
# 426 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 426 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_err_obj_no_value(void) { static const char script_name[] = "err_obj_no_value"; static const char script_title[] = "\"error test: object item with no value\""; static const struct script_word script_words[] = { { 
# 428 "../test/json_test.c" 3 4
((void *)0)
# 428 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 428 "../test/json_test.c" 3 4
((void *)0)
# 428 "../test/json_test.c"
, (0) },
    { 
# 429 "../test/json_test.c" 3 4
   ((void *)0)
# 429 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 429 "../test/json_test.c" 3 4
   ((void *)0)
# 429 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 430 "../test/json_test.c" 3 4
   ((void *)0)
# 430 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 430 "../test/json_test.c" 3 4
   ((void *)0)
# 430 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 431 "../test/json_test.c" 3 4
   ((void *)0)
# 431 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 431 "../test/json_test.c" 3 4
   ((void *)0)
# 431 "../test/json_test.c"
   , (0) },
    { 
# 432 "../test/json_test.c" 3 4
   ((void *)0)
# 432 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 432 "../test/json_test.c" 3 4
   ((void *)0)
# 432 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
    { 
# 433 "../test/json_test.c" 3 4
   ((void *)0)
# 433 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 433 "../test/json_test.c" 3 4
   ((void *)0)
# 433 "../test/json_test.c"
   , (1) },
{ 
# 434 "../test/json_test.c" 3 4
((void *)0)
# 434 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("{\"x\":"), (
# 434 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 434 "../test/json_test.c"
...
static const struct script_info *get_script_err_utf8(void) { static const char script_name[] = "err_utf8"; static const char script_title[] = "\"error test: only basic ASCII supported\""; static const struct script_word script_words[] = { { 
# 436 "../test/json_test.c" 3 4
((void *)0)
# 436 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 436 "../test/json_test.c" 3 4
((void *)0)
# 436 "../test/json_test.c"
, (0) },
    { 
# 437 "../test/json_test.c" 3 4
   ((void *)0)
# 437 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 437 "../test/json_test.c" 3 4
   ((void *)0)
# 437 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("\x80")) },
    { 
# 438 "../test/json_test.c" 3 4
   ((void *)0)
# 438 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 438 "../test/json_test.c" 3 4
   ((void *)0)
# 438 "../test/json_test.c"
   , (0) },
{ 
# 439 "../test/json_test.c" 3 4
((void *)0)
# 439 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"\\u0080\""), (
# 439 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 439 "../test/json_test.c"
...
static const struct script_info *get_script_utf8_2(void) { static const char script_name[] = "utf8_2"; static const char script_title[] = "\"test: valid UTF-8 2byte supported\""; static const struct script_word script_words[] = { { 
# 441 "../test/json_test.c" 3 4
((void *)0)
# 441 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 441 "../test/json_test.c" 3 4
((void *)0)
# 441 "../test/json_test.c"
, (0) },
    { 
# 442 "../test/json_test.c" 3 4
   ((void *)0)
# 442 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 442 "../test/json_test.c" 3 4
   ((void *)0)
# 442 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("low=\xc2\x80, high=\xdf\xbf")) },
    { 
# 443 "../test/json_test.c" 3 4
   ((void *)0)
# 443 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 443 "../test/json_test.c" 3 4
   ((void *)0)
# 443 "../test/json_test.c"
   , (0) },
{ 
# 444 "../test/json_test.c" 3 4
((void *)0)
# 444 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"low=\xc2\x80, high=\xdf\xbf\""), (
# 444 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 444 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_utf8_3(void) { static const char script_name[] = "utf8_3"; static const char script_title[] = "\"test: valid UTF-8 3byte supported\""; static const struct script_word script_words[] = { { 
# 446 "../test/json_test.c" 3 4
((void *)0)
# 446 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 446 "../test/json_test.c" 3 4
((void *)0)
# 446 "../test/json_test.c"
, (0) },
    { 
# 447 "../test/json_test.c" 3 4
   ((void *)0)
# 447 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 447 "../test/json_test.c" 3 4
   ((void *)0)
# 447 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("low=\xe0\xa0\x80, high=\xef\xbf\xbf")) },
    { 
# 448 "../test/json_test.c" 3 4
   ((void *)0)
# 448 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 448 "../test/json_test.c" 3 4
   ((void *)0)
# 448 "../test/json_test.c"
   , (0) },
{ 
# 449 "../test/json_test.c" 3 4
((void *)0)
# 449 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"low=\xe0\xa0\x80, high=\xef\xbf\xbf\""), (
# 449 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 449 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_utf8_4(void) { static const char script_name[] = "utf8_4"; static const char script_title[] = "\"test: valid UTF-8 4byte supported\""; static const struct script_word script_words[] = { { 
# 451 "../test/json_test.c" 3 4
((void *)0)
# 451 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 451 "../test/json_test.c" 3 4
((void *)0)
# 451 "../test/json_test.c"
, (0) },
    { 
# 452 "../test/json_test.c" 3 4
   ((void *)0)
# 452 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 452 "../test/json_test.c" 3 4
   ((void *)0)
# 452 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_str) }, { (("low=\xf0\x90\xbf\xbf, high=\xf4\x8f\xbf\xbf")) },
    { 
# 453 "../test/json_test.c" 3 4
   ((void *)0)
# 453 "../test/json_test.c"
   , (OPK_ASSERT_ERROR) }, { 
# 453 "../test/json_test.c" 3 4
   ((void *)0)
# 453 "../test/json_test.c"
   , (0) },
{ 
# 454 "../test/json_test.c" 3 4
((void *)0)
# 454 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\"low=\xf0\x90\xbf\xbf, high=\xf4\x8f\xbf\xbf\""), (
# 454 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 454 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_ijson_int(void) { static const char script_name[] = "ijson_int"; static const char script_title[] = "\"I-JSON: large integer\""; static const struct script_word script_words[] = { { 
# 456 "../test/json_test.c" 3 4
((void *)0)
# 456 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 456 "../test/json_test.c" 3 4
((void *)0)
# 456 "../test/json_test.c"
, ((1U << 2)) },
    { 
# 457 "../test/json_test.c" 3 4
   ((void *)0)
# 457 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 457 "../test/json_test.c" 3 4
   ((void *)0)
# 457 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 458 "../test/json_test.c" 3 4
   ((void *)0)
# 458 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 458 "../test/json_test.c" 3 4
   ((void *)0)
# 458 "../test/json_test.c"
...
# 458 "../test/json_test.c"
   , ((1)) },
    { 
# 459 "../test/json_test.c" 3 4
   ((void *)0)
# 459 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 459 "../test/json_test.c" 3 4
   ((void *)0)
# 459 "../test/json_test.c"
...
# 459 "../test/json_test.c"
   , 0, ((-1)) },
    { 
# 460 "../test/json_test.c" 3 4
   ((void *)0)
# 460 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 460 "../test/json_test.c" 3 4
   ((void *)0)
# 460 "../test/json_test.c"
...
# 460 "../test/json_test.c"
   , ((9007199254740991)) },
    { 
# 461 "../test/json_test.c" 3 4
   ((void *)0)
# 461 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 461 "../test/json_test.c" 3 4
   ((void *)0)
# 461 "../test/json_test.c"
...
# 461 "../test/json_test.c"
   , ((9007199254740992)) },
    { 
# 462 "../test/json_test.c" 3 4
   ((void *)0)
# 462 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 462 "../test/json_test.c" 3 4
   ((void *)0)
# 462 "../test/json_test.c"
...
# 462 "../test/json_test.c"
   , 0, ((-9007199254740991)) },
    { 
# 463 "../test/json_test.c" 3 4
   ((void *)0)
# 463 "../test/json_test.c"
   , (OPK_CALL_I64) }, { 
# 463 "../test/json_test.c" 3 4
   ((void *)0)
# 463 "../test/json_test.c"
...
# 463 "../test/json_test.c"
   , 0, ((-9007199254740992)) },
    { 
# 464 "../test/json_test.c" 3 4
   ((void *)0)
# 464 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 464 "../test/json_test.c" 3 4
   ((void *)0)
# 464 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 465 "../test/json_test.c" 3 4
((void *)0)
# 465 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("[1,-1,9007199254740991,\"9007199254740992\",-9007199254740991,\"-9007199254740992\"]"), (
# 465 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 465 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_multi_item(void) { static const char script_name[] = "multi_item"; static const char script_title[] = "\"multiple top level items\""; static const struct script_word script_words[] = { { 
# 467 "../test/json_test.c" 3 4
((void *)0)
# 467 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 467 "../test/json_test.c" 3 4
((void *)0)
# 467 "../test/json_test.c"
, (0) },
    { 
# 468 "../test/json_test.c" 3 4
   ((void *)0)
# 468 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 468 "../test/json_test.c" 3 4
   ((void *)0)
# 468 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 469 "../test/json_test.c" 3 4
   ((void *)0)
# 469 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 469 "../test/json_test.c" 3 4
   ((void *)0)
# 469 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 470 "../test/json_test.c" 3 4
   ((void *)0)
# 470 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 470 "../test/json_test.c" 3 4
   ((void *)0)
# 470 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 471 "../test/json_test.c" 3 4
   ((void *)0)
# 471 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 471 "../test/json_test.c" 3 4
   ((void *)0)
# 471 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
    { 
# 472 "../test/json_test.c" 3 4
   ((void *)0)
# 472 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 472 "../test/json_test.c" 3 4
   ((void *)0)
# 472 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_begin) },
    { 
# 473 "../test/json_test.c" 3 4
   ((void *)0)
# 473 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 473 "../test/json_test.c" 3 4
   ((void *)0)
# 473 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_array_end) },
{ 
# 474 "../test/json_test.c" 3 4
((void *)0)
# 474 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("nullnull[][]"), (
# 474 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 474 "../test/json_test.c"
) }; return &script_info; }

static const struct script_info *get_script_seq(void) { static const char script_name[] = "seq"; static const char script_title[] = "\"JSON-SEQ\""; static const struct script_word script_words[] = { { 
# 476 "../test/json_test.c" 3 4
((void *)0)
# 476 "../test/json_test.c"
, (OPK_INIT_FLAGS) }, { 
# 476 "../test/json_test.c" 3 4
((void *)0)
# 476 "../test/json_test.c"
, ((1U << 0)) },
    { 
# 477 "../test/json_test.c" 3 4
   ((void *)0)
# 477 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 477 "../test/json_test.c" 3 4
   ((void *)0)
# 477 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 478 "../test/json_test.c" 3 4
   ((void *)0)
# 478 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 478 "../test/json_test.c" 3 4
   ((void *)0)
# 478 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 479 "../test/json_test.c" 3 4
   ((void *)0)
# 479 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 479 "../test/json_test.c" 3 4
   ((void *)0)
# 479 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_null) },
    { 
# 480 "../test/json_test.c" 3 4
   ((void *)0)
# 480 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 480 "../test/json_test.c" 3 4
   ((void *)0)
# 480 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 481 "../test/json_test.c" 3 4
   ((void *)0)
# 481 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 481 "../test/json_test.c" 3 4
   ((void *)0)
# 481 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("x")) },
    { 
# 482 "../test/json_test.c" 3 4
   ((void *)0)
# 482 "../test/json_test.c"
   , (OPK_CALL_U64) }, { 
# 482 "../test/json_test.c" 3 4
   ((void *)0)
# 482 "../test/json_test.c"
...
# 482 "../test/json_test.c"
   , ((1)) },
    { 
# 483 "../test/json_test.c" 3 4
   ((void *)0)
# 483 "../test/json_test.c"
   , (OPK_CALL_P) }, { 
# 483 "../test/json_test.c" 3 4
   ((void *)0)
# 483 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_key) }, { (("y")) },
    { 
# 484 "../test/json_test.c" 3 4
   ((void *)0)
# 484 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 484 "../test/json_test.c" 3 4
   ((void *)0)
# 484 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_begin) },
    { 
# 485 "../test/json_test.c" 3 4
   ((void *)0)
# 485 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 485 "../test/json_test.c" 3 4
   ((void *)0)
# 485 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
    { 
# 486 "../test/json_test.c" 3 4
   ((void *)0)
# 486 "../test/json_test.c"
   , (OPK_CALL) }, { 
# 486 "../test/json_test.c" 3 4
   ((void *)0)
# 486 "../test/json_test.c"
   , 0, 0, 0, (void (*)(void))(ossl_json_object_end) },
{ 
# 487 "../test/json_test.c" 3 4
((void *)0)
# 487 "../test/json_test.c"
, (OPK_END) }, }; static const struct script_info script_info = { script_name, script_title, script_words, (sizeof(script_words)/sizeof((script_words)[0])), ("\x1Enull\n" "\x1Enull\n" "\x1Enull\n" "\x1E{\"x\":1,\"y\":{}}\n"), (
# 487 "../test/json_test.c" 3 4
(18446744073709551615UL)
# 487 "../test/json_test.c"
) }; return &script_info; }
...
static int run_script(const struct script_info *info)
{
    ...
    struct helper h = {0};
    BUF_MEM *bufp = 
# 550 "../test/json_test.c" 3 4
                   ((void *)0)
# 550 "../test/json_test.c"
                       ;

    test_info("../test/json_test.c", 552, "running script '%s' (%s)", info->name, info->title);
    ...
    for (;;)
        switch (((w = words[wp++]).u64)) {
        case OPK_END:
            goto stop;
        case OPK_INIT_FLAGS:
            helper_set_flags(&h, (uint32_t)((w = words[wp++]).u64));
            break;
        case OPK_CALL:
        {
            fp_type f = (fp_type)((w = words[wp++]).fp);

            if (!test_true("../test/json_test.c", 571, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;
        ...
        case OPK_CALL_I:
        {
            fp_i_type f = (fp_i_type)((w = words[wp++]).fp);

            if (!test_true("../test/json_test.c", 581, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;

            f(&h.j, (int)((w = words[wp++]).i64));
            break;
        }
        case OPK_CALL_U64:
        {
            fp_u64_type f = (fp_u64_type)((w = words[wp++]).fp);

            if (!test_true("../test/json_test.c", 591, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;

            f(&h.j, ((w = words[wp++]).u64));
            break;
        }
        case OPK_CALL_I64:
        {
            fp_i64_type f = (fp_i64_type)((w = words[wp++]).fp);

            if (!test_true("../test/json_test.c", 601, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;

            f(&h.j, ((w = words[wp++]).i64));
            break;
        }
        case OPK_CALL_P:
        {
            fp_p_type f = (fp_p_type)((w = words[wp++]).fp);

            if (!test_true("../test/json_test.c", 611, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;
        ...
        case OPK_CALL_PZ:
        {
            fp_pz_type f = (fp_pz_type)((w = words[wp++]).fp);
            void *p;
            uint64_t u64;

            if (!test_true("../test/json_test.c", 623, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;
        ...
        {
            if (!test_true("../test/json_test.c", 633, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
                goto err;

            asserted = (int)((w = words[wp++]).u64);
            if (!test_int_eq("../test/json_test.c", 637, "ossl_json_in_error(&h.j)", "asserted", ossl_json_in_error(&h.j), asserted))
                goto err;
        ...
        default:
            test_error("../test/json_test.c", 645, "unknown opcode");
            goto err;
        }
stop:

    if (!test_true("../test/json_test.c", 650, "helper_ensure(&h)", (helper_ensure(&h)) != 0))
        goto err;

    if (!test_true("../test/json_test.c", 653, "ossl_json_flush(&h.j)", (ossl_json_flush(&h.j)) != 0))
        goto err;


    if (asserted < 0 && !test_false("../test/json_test.c", 657, "ossl_json_in_error(&h.j)", (ossl_json_in_error(&h.j)) != 0))
        goto err;

    if (!test_true("../test/json_test.c", 660, "BIO_get_mem_ptr(h.mem_bio, &bufp)", (BIO_ctrl(h.mem_bio,115,0, (char *)(&bufp))) != 0))
        goto err;

    if (!test_mem_eq("../test/json_test.c", 663, "bufp->data", "info->expected_output", bufp->data, bufp->length, info->expected_output, info->expected_output_len == 
# 663 "../test/json_test.c" 3 4
        (18446744073709551615UL) 
# 663 "../test/json_test.c"
        ? strlen(info->expected_output) : info->expected_output_len)
...
err:
    if (!ok)
        test_error("../test/json_test.c", 673, "script '%s' failed", info->name);
...
static int test_json_enc(void)
{
    ...
    for (i = 0; i < (sizeof(scripts)/sizeof((scripts)[0])); ++i)
        if (!test_true("../test/json_test.c", 685, "run_script(scripts[i]())", (run_script(scripts[i]())) != 0))
            ok = 0;
