# 0 "../test/fips_version_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/fips_version_test.c"
# 10 "../test/fips_version_test.c"
...
# 13 "../test/fips_version_test.c" 2

static OSSL_LIB_CTX *libctx = 
# 14 "../test/fips_version_test.c" 3 4
                             ((void *)0)
# 14 "../test/fips_version_test.c"
                                 ;
static OSSL_PROVIDER *libprov = 
# 15 "../test/fips_version_test.c" 3 4
                               ((void *)0)
# 15 "../test/fips_version_test.c"
                                   ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 30 "../test/fips_version_test.c" 3 4
         ((void *)0) 
# 30 "../test/fips_version_test.c"
              }
    };
    return test_options;
}
...
static int test_fips_version(int n)
{
    ...
    if (!test_ptr("../test/fips_version_test.c", 39, "version", version))
        return 0;
    return test_int_eq("../test/fips_version_test.c", 41, "fips_provider_version_match(libctx, version)", "1", fips_provider_version_match(libctx, version), 1);
}

int setup_tests(void)
{
    char *config_file = 
# 46 "../test/fips_version_test.c" 3 4
                       ((void *)0)
# 46 "../test/fips_version_test.c"
                           ;
    OPTION_CHOICE o;
    int n;
    ...
    if (!test_get_libctx(&libctx, 
# 63 "../test/fips_version_test.c" 3 4
                                 ((void *)0)
# 63 "../test/fips_version_test.c"
                                     , config_file, &libprov, 
# 63 "../test/fips_version_test.c" 3 4
                                                              ((void *)0)
# 63 "../test/fips_version_test.c"
    ...
    add_all_tests("test_fips_version", test_fips_version, n, 1);
    return 1;
}
