# 0 "test/buildtest_camellia.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_camellia.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int Camellia_set_key(const unsigned char *userKey,
                                           const int bits,
                                           CAMELLIA_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_encrypt(const unsigned char *in,
                                            unsigned char *out,
                                            const CAMELLIA_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_decrypt(const unsigned char *in,
                                            unsigned char *out,
                                            const CAMELLIA_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_ecb_encrypt(const unsigned char *in,
                                                unsigned char *out,
                                                const CAMELLIA_KEY *key,
                                                const int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_cbc_encrypt(const unsigned char *in,
                                                unsigned char *out,
                                                size_t length,
                                                const CAMELLIA_KEY *key,
                                                unsigned char *ivec,
                                                const int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_cfb128_encrypt(const unsigned char *in,
                                                   unsigned char *out,
                                                   size_t length,
                                                   const CAMELLIA_KEY *key,
                                                   unsigned char *ivec,
                                                   int *num,
                                                   const int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_cfb1_encrypt(const unsigned char *in,
                                                 unsigned char *out,
                                                 size_t length,
                                                 const CAMELLIA_KEY *key,
                                                 unsigned char *ivec,
                                                 int *num,
                                                 const int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_cfb8_encrypt(const unsigned char *in,
                                                 unsigned char *out,
                                                 size_t length,
                                                 const CAMELLIA_KEY *key,
                                                 unsigned char *ivec,
                                                 int *num,
                                                 const int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void Camellia_ofb128_encrypt(const unsigned char *in,
                                                   unsigned char *out,
                                                   size_t length,
                                                   const CAMELLIA_KEY *key,
                                                   unsigned char *ivec,
...
void Camellia_ctr128_encrypt(const unsigned char *in, unsigned char *out,
                             ...
                             unsigned int *num);
# 11 "test/buildtest_camellia.c" 2
