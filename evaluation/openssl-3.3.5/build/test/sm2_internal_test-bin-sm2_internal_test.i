# 0 "../test/sm2_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/sm2_internal_test.c"
# 13 "../test/sm2_internal_test.c"
...
const unsigned char *ossl_sm2_algorithmidentifier_encoding(int md_nid,
                                                           size_t *len);
# 30 "../test/sm2_internal_test.c" 2

static fake_random_generate_cb get_faked_bytes;

static OSSL_PROVIDER *fake_rand = 
# 33 "../test/sm2_internal_test.c" 3 4
                                 ((void *)0)
# 33 "../test/sm2_internal_test.c"
                                     ;
static uint8_t *fake_rand_bytes = 
# 34 "../test/sm2_internal_test.c" 3 4
                                 ((void *)0)
# 34 "../test/sm2_internal_test.c"
                                     ;
...
static int get_faked_bytes(unsigned char *buf, size_t num,
                           ...
                           __attribute__((unused)) EVP_RAND_CTX *ctx)
{
    if (!test_ptr("../test/sm2_internal_test.c", 42, "fake_rand_bytes", fake_rand_bytes) || !test_size_t_gt("../test/sm2_internal_test.c", 42, "fake_rand_size", "0", fake_rand_size, 0))
        return 0;
...
{
    CRYPTO_free(fake_rand_bytes, "../test/sm2_internal_test.c", 56);
    fake_rand_bytes_offset = 0;
    fake_rand_size = strlen(hex_bytes) / 2;
    if (!test_ptr("../test/sm2_internal_test.c", 59, "fake_rand_bytes = OPENSSL_hexstr2buf(hex_bytes, NULL)", fake_rand_bytes = OPENSSL_hexstr2buf(hex_bytes, 
# 59 "../test/sm2_internal_test.c" 3 4
        ((void *)0)
# 59 "../test/sm2_internal_test.c"
        )))
        return 0;


    fake_rand_set_public_private_callbacks(
# 63 "../test/sm2_internal_test.c" 3 4
                                          ((void *)0)
# 63 "../test/sm2_internal_test.c"
                                              , get_faked_bytes);
    return 1;
...
{
    fake_rand_set_public_private_callbacks(
# 70 "../test/sm2_internal_test.c" 3 4
                                          ((void *)0)
# 70 "../test/sm2_internal_test.c"
                                              , 
# 70 "../test/sm2_internal_test.c" 3 4
                                                ((void *)0)
# 70 "../test/sm2_internal_test.c"
                                                    );
    CRYPTO_free(fake_rand_bytes, "../test/sm2_internal_test.c", 71);
    fake_rand_bytes = 
# 72 "../test/sm2_internal_test.c" 3 4
                     ((void *)0)
# 72 "../test/sm2_internal_test.c"
                         ;
    fake_rand_bytes_offset = 0;
}
...
{
    BIGNUM *p = 
# 81 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 81 "../test/sm2_internal_test.c"
                   ;
    BIGNUM *a = 
# 82 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 82 "../test/sm2_internal_test.c"
                   ;
    BIGNUM *b = 
# 83 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 83 "../test/sm2_internal_test.c"
                   ;
    BIGNUM *g_x = 
# 84 "../test/sm2_internal_test.c" 3 4
                 ((void *)0)
# 84 "../test/sm2_internal_test.c"
                     ;
    BIGNUM *g_y = 
# 85 "../test/sm2_internal_test.c" 3 4
                 ((void *)0)
# 85 "../test/sm2_internal_test.c"
                     ;
    BIGNUM *order = 
# 86 "../test/sm2_internal_test.c" 3 4
                   ((void *)0)
# 86 "../test/sm2_internal_test.c"
                       ;
    BIGNUM *cof = 
# 87 "../test/sm2_internal_test.c" 3 4
                 ((void *)0)
# 87 "../test/sm2_internal_test.c"
                     ;
    EC_POINT *generator = 
# 88 "../test/sm2_internal_test.c" 3 4
                         ((void *)0)
# 88 "../test/sm2_internal_test.c"
                             ;
    EC_GROUP *group = 
# 89 "../test/sm2_internal_test.c" 3 4
                     ((void *)0)
# 89 "../test/sm2_internal_test.c"
                         ;
    int ok = 0;

    if (!test_true("../test/sm2_internal_test.c", 92, "BN_hex2bn(&p, p_hex)", (BN_hex2bn(&p, p_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 93, "BN_hex2bn(&a, a_hex)", (BN_hex2bn(&a, a_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 94, "BN_hex2bn(&b, b_hex)", (BN_hex2bn(&b, b_hex)) != 0))
        goto done;

    group = EC_GROUP_new_curve_GFp(p, a, b, 
# 97 "../test/sm2_internal_test.c" 3 4
                                           ((void *)0)
# 97 "../test/sm2_internal_test.c"
                                               );
    if (!test_ptr("../test/sm2_internal_test.c", 98, "group", group))
        goto done;

    generator = EC_POINT_new(group);
    if (!test_ptr("../test/sm2_internal_test.c", 102, "generator", generator))
        goto done;

    if (!test_true("../test/sm2_internal_test.c", 105, "BN_hex2bn(&g_x, x_hex)", (BN_hex2bn(&g_x, x_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 106, "BN_hex2bn(&g_y, y_hex)", (BN_hex2bn(&g_y, y_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 107, "EC_POINT_set_affine_coordinates(group, generator, g_x, g_y, NULL)", (EC_POINT_set_affine_coordinates(group, generator, g_x, g_y, 
# 107 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 107 "../test/sm2_internal_test.c"
               )) != 0)
                                                                     )
        goto done;

    if (!test_true("../test/sm2_internal_test.c", 111, "BN_hex2bn(&order, order_hex)", (BN_hex2bn(&order, order_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 112, "BN_hex2bn(&cof, cof_hex)", (BN_hex2bn(&cof, cof_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 113, "EC_GROUP_set_generator(group, generator, order, cof)", (EC_GROUP_set_generator(group, generator, order, cof)) != 0))
        goto done;
    ...
    if (!ok) {
        EC_GROUP_free(group);
        group = 
# 128 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 128 "../test/sm2_internal_test.c"
                   ;
    }
                          ...
                          const char *k_hex, const char *ctext_hex)
{
    ...
    BIGNUM *priv = 
# 141 "../test/sm2_internal_test.c" 3 4
                  ((void *)0)
# 141 "../test/sm2_internal_test.c"
                      ;
    EC_KEY *key = 
# 142 "../test/sm2_internal_test.c" 3 4
                 ((void *)0)
# 142 "../test/sm2_internal_test.c"
                     ;
    EC_POINT *pt = 
# 143 "../test/sm2_internal_test.c" 3 4
                  ((void *)0)
# 143 "../test/sm2_internal_test.c"
                      ;
    unsigned char *expected = OPENSSL_hexstr2buf(ctext_hex, 
# 144 "../test/sm2_internal_test.c" 3 4
                                                           ((void *)0)
# 144 "../test/sm2_internal_test.c"
                                                               );
    size_t ctext_len = 0;
    size_t ptext_len = 0;
    uint8_t *ctext = 
# 147 "../test/sm2_internal_test.c" 3 4
                    ((void *)0)
# 147 "../test/sm2_internal_test.c"
                        ;
    uint8_t *recovered = 
# 148 "../test/sm2_internal_test.c" 3 4
                        ((void *)0)
# 148 "../test/sm2_internal_test.c"
                            ;
    size_t recovered_len = msg_len;
    int rc = 0;

    if (!test_ptr("../test/sm2_internal_test.c", 152, "expected", expected)
            || !test_true("../test/sm2_internal_test.c", 153, "BN_hex2bn(&priv, privkey_hex)", (BN_hex2bn(&priv, privkey_hex)) != 0))
        goto done;

    key = EC_KEY_new();
    if (!test_ptr("../test/sm2_internal_test.c", 157, "key", key)
            || !test_true("../test/sm2_internal_test.c", 158, "EC_KEY_set_group(key, group)", (EC_KEY_set_group(key, group)) != 0)
            || !test_true("../test/sm2_internal_test.c", 159, "EC_KEY_set_private_key(key, priv)", (EC_KEY_set_private_key(key, priv)) != 0))
        goto done;

    pt = EC_POINT_new(group);
    if (!test_ptr("../test/sm2_internal_test.c", 163, "pt", pt)
            || !test_true("../test/sm2_internal_test.c", 164, "EC_POINT_mul(group, pt, priv, NULL, NULL, NULL)", (EC_POINT_mul(group, pt, priv, 
# 164 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 164 "../test/sm2_internal_test.c"
               , 
# 164 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 164 "../test/sm2_internal_test.c"
...
# 164 "../test/sm2_internal_test.c"
            ...
            || !test_true("../test/sm2_internal_test.c", 165, "EC_KEY_set_public_key(key, pt)", (EC_KEY_set_public_key(key, pt)) != 0)
            || !test_true("../test/sm2_internal_test.c", 166, "ossl_sm2_ciphertext_size(key, digest, msg_len, &ctext_len)", (ossl_sm2_ciphertext_size(key, digest, msg_len, &ctext_len)) != 0)
                                                               )
        goto done;

    ctext = CRYPTO_zalloc(ctext_len, "../test/sm2_internal_test.c", 170);
    if (!test_ptr("../test/sm2_internal_test.c", 171, "ctext", ctext))
        goto done;

    start_fake_rand(k_hex);
    if (!test_true("../test/sm2_internal_test.c", 175, "ossl_sm2_encrypt(key, digest, (const uint8_t *)message, msg_len, ctext, &ctext_len)", (ossl_sm2_encrypt(key, digest, (const uint8_t *)message, msg_len, ctext, &ctext_len)) != 0)
    ...
    if (!test_mem_eq("../test/sm2_internal_test.c", 183, "ctext", "expected", ctext, ctext_len, expected, ctext_len))
        goto done;

    if (!test_true("../test/sm2_internal_test.c", 186, "ossl_sm2_plaintext_size(ctext, ctext_len, &ptext_len)", (ossl_sm2_plaintext_size(ctext, ctext_len, &ptext_len)) != 0)
            || !test_int_eq("../test/sm2_internal_test.c", 187, "ptext_len", "msg_len", ptext_len, msg_len))
        goto done;

    recovered = CRYPTO_zalloc(ptext_len, "../test/sm2_internal_test.c", 190);
    if (!test_ptr("../test/sm2_internal_test.c", 191, "recovered", recovered)
            || !test_true("../test/sm2_internal_test.c", 192, "ossl_sm2_decrypt(key, digest, ctext, ctext_len, recovered, &recovered_len)", (ossl_sm2_decrypt(key, digest, ctext, ctext_len, recovered, &recovered_len)) != 0)

            || !test_int_eq("../test/sm2_internal_test.c", 194, "recovered_len", "msg_len", recovered_len, msg_len)
            || !test_mem_eq("../test/sm2_internal_test.c", 195, "recovered", "message", recovered, recovered_len, message, msg_len))
        goto done;
    ...
    BN_free(priv);
    EC_POINT_free(pt);
    CRYPTO_free(ctext, "../test/sm2_internal_test.c", 202);
    CRYPTO_free(recovered, "../test/sm2_internal_test.c", 203);
    CRYPTO_free(expected, "../test/sm2_internal_test.c", 204);
    EC_KEY_free(key);
    return rc;
}
...
static int sm2_crypt_test(void)
{
    int testresult = 0;
    EC_GROUP *gm_group = 
# 212 "../test/sm2_internal_test.c" 3 4
                        ((void *)0)
# 212 "../test/sm2_internal_test.c"
                            ;
    EC_GROUP *test_group =
        create_EC_group
    ...
    if (!test_ptr("../test/sm2_internal_test.c", 223, "test_group", test_group))
        goto done;
    ...
    if (!test_ptr("../test/sm2_internal_test.c", 265, "gm_group", gm_group))
        goto done;
                         ...
                         int omit_pubkey)
{
    ...
    int ok = 0;
    BIGNUM *priv = 
# 313 "../test/sm2_internal_test.c" 3 4
                  ((void *)0)
# 313 "../test/sm2_internal_test.c"
                      ;
    EC_POINT *pt = 
# 314 "../test/sm2_internal_test.c" 3 4
                  ((void *)0)
# 314 "../test/sm2_internal_test.c"
                      ;
    EC_KEY *key = 
# 315 "../test/sm2_internal_test.c" 3 4
                 ((void *)0)
# 315 "../test/sm2_internal_test.c"
                     ;
    ECDSA_SIG *sig = 
# 316 "../test/sm2_internal_test.c" 3 4
                    ((void *)0)
# 316 "../test/sm2_internal_test.c"
                        ;
    const BIGNUM *sig_r = 
# 317 "../test/sm2_internal_test.c" 3 4
                         ((void *)0)
# 317 "../test/sm2_internal_test.c"
                             ;
    const BIGNUM *sig_s = 
# 318 "../test/sm2_internal_test.c" 3 4
                         ((void *)0)
# 318 "../test/sm2_internal_test.c"
                             ;
    BIGNUM *r = 
# 319 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 319 "../test/sm2_internal_test.c"
                   ;
    BIGNUM *s = 
# 320 "../test/sm2_internal_test.c" 3 4
               ((void *)0)
# 320 "../test/sm2_internal_test.c"
                   ;

    if (!test_true("../test/sm2_internal_test.c", 322, "BN_hex2bn(&priv, privkey_hex)", (BN_hex2bn(&priv, privkey_hex)) != 0))
        goto done;

    key = EC_KEY_new();
    if (!test_ptr("../test/sm2_internal_test.c", 326, "key", key)
            || !test_true("../test/sm2_internal_test.c", 327, "EC_KEY_set_group(key, group)", (EC_KEY_set_group(key, group)) != 0)
            || !test_true("../test/sm2_internal_test.c", 328, "EC_KEY_set_private_key(key, priv)", (EC_KEY_set_private_key(key, priv)) != 0))
        goto done;

    if (omit_pubkey == 0) {
        pt = EC_POINT_new(group);
        if (!test_ptr("../test/sm2_internal_test.c", 333, "pt", pt)
                || !test_true("../test/sm2_internal_test.c", 334, "EC_POINT_mul(group, pt, priv, NULL, NULL, NULL)", (EC_POINT_mul(group, pt, priv, 
# 334 "../test/sm2_internal_test.c" 3 4
                   ((void *)0)
# 334 "../test/sm2_internal_test.c"
                   , 
# 334 "../test/sm2_internal_test.c" 3 4
                   ((void *)0)
# 334 "../test/sm2_internal_test.c"
...
# 334 "../test/sm2_internal_test.c"
                ...
                || !test_true("../test/sm2_internal_test.c", 335, "EC_KEY_set_public_key(key, pt)", (EC_KEY_set_public_key(key, pt)) != 0))
            goto done;
    }
    ...
    if (!test_ptr("../test/sm2_internal_test.c", 342, "sig", sig)) {
        restore_rand();
        goto done;
    }
    restore_rand();
    ...
    if (!test_true("../test/sm2_internal_test.c", 350, "BN_hex2bn(&r, r_hex)", (BN_hex2bn(&r, r_hex)) != 0)
            || !test_true("../test/sm2_internal_test.c", 351, "BN_hex2bn(&s, s_hex)", (BN_hex2bn(&s, s_hex)) != 0)
            || !test_BN_eq("../test/sm2_internal_test.c", 352, "r", "sig_r", r, sig_r)
            || !test_BN_eq("../test/sm2_internal_test.c", 353, "s", "sig_s", s, sig_s))
        goto done;
    ...
    test_true("../test/sm2_internal_test.c", 360, "ok", (ok) != 0);
...
static int sm2_sig_test(void)
{
    int testresult = 0;
    EC_GROUP *gm_group = 
# 376 "../test/sm2_internal_test.c" 3 4
                        ((void *)0)
# 376 "../test/sm2_internal_test.c"
                            ;
    ...
    if (!test_ptr("../test/sm2_internal_test.c", 388, "test_group", test_group))
        goto done;

    if (!test_true("../test/sm2_internal_test.c", 391, "test_sm2_sign( test_group, \"ALICE123@YAHOO.COM\", \"128B2FA8BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263\", \"message digest\", \"006CB28D99385C175C94F94E934817663FC176D925DD72B727260DBAAE1FB2F96F\" \"007c47811054c6f99613a578eb8453706ccb96384fe7df5c171671e760bfa8be3a\", \"40F1EC59F793D9F49E09DCEF49130D4194F79FB1EED2CAA55BACDB49C4E755D1\", \"6FC6DAC32C5D5CF10C77DFB20F7C2EB667A457872FB09EC56327A67EC7DEEBE7\", 0)", (test_sm2_sign( test_group, "ALICE123@YAHOO.COM", "128B2FA8BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263", "message digest", "006CB28D99385C175C94F94E934817663FC176D925DD72B727260DBAAE1FB2F96F" "007c47811054c6f99613a578eb8453706ccb96384fe7df5c171671e760bfa8be3a", "40F1EC59F793D9F49E09DCEF49130D4194F79FB1EED2CAA55BACDB49C4E755D1", "6FC6DAC32C5D5CF10C77DFB20F7C2EB667A457872FB09EC56327A67EC7DEEBE7", 0)) != 0)
    ...
    if (!test_ptr("../test/sm2_internal_test.c", 412, "gm_group", gm_group))
        goto done;

    if (!test_true("../test/sm2_internal_test.c", 415, "test_sm2_sign( gm_group, SM2_DEFAULT_USERID, \"3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8\", \"message digest\", \"59276E27D506861A16680F3AD9C02DCCEF3CC1FA3CDBE4CE6D54B80DEAC1BC21\", \"F5A03B0648D2C4630EEAC513E1BB81A15944DA3827D5B74143AC7EACEEE720B3\", \"B1B6AA29DF212FD8763182BC0D421CA1BB9038FD1F7F42D4840B69C485BBC1AA\", 0)", (test_sm2_sign( gm_group, "1234567812345678", "3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8", "message digest", "59276E27D506861A16680F3AD9C02DCCEF3CC1FA3CDBE4CE6D54B80DEAC1BC21", "F5A03B0648D2C4630EEAC513E1BB81A15944DA3827D5B74143AC7EACEEE720B3", "B1B6AA29DF212FD8763182BC0D421CA1BB9038FD1F7F42D4840B69C485BBC1AA", 0)) != 0)
# 430 "../test/sm2_internal_test.c"
                                                                                           )
        goto done;



    if (!test_false("../test/sm2_internal_test.c", 435, "test_sm2_sign( gm_group, SM2_DEFAULT_USERID, \"3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8\", \"message digest\", \"59276E27D506861A16680F3AD9C02DCCEF3CC1FA3CDBE4CE6D54B80DEAC1BC21\", \"F5A03B0648D2C4630EEAC513E1BB81A15944DA3827D5B74143AC7EACEEE720B3\", \"B1B6AA29DF212FD8763182BC0D421CA1BB9038FD1F7F42D4840B69C485BBC1AA\", 1)", (test_sm2_sign( gm_group, "1234567812345678", "3945208F7B2144B13F36E38AC6D39F95889393692860B51A42FB81EF4DF7C5B8", "message digest", "59276E27D506861A16680F3AD9C02DCCEF3CC1FA3CDBE4CE6D54B80DEAC1BC21", "F5A03B0648D2C4630EEAC513E1BB81A15944DA3827D5B74143AC7EACEEE720B3", "B1B6AA29DF212FD8763182BC0D421CA1BB9038FD1F7F42D4840B69C485BBC1AA", 1)) != 0)
# 450 "../test/sm2_internal_test.c"
                                                                                            )
        goto done;
...
# 469 "../test/sm2_internal_test.c" 3 4
                               ((void *)0)
# 469 "../test/sm2_internal_test.c"
                                   );
    if (fake_rand == 
# 470 "../test/sm2_internal_test.c" 3 4
                    ((void *)0)
# 470 "../test/sm2_internal_test.c"
                        )
        return 0;
