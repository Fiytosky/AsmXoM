...
# 11 "../test/hpke_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../test/hpke_test.c" 2
...
int RAND_poll(void);
# 13 "../test/hpke_test.c" 2
# 1 "../include/openssl/hpke.h" 1
# 13 "../include/openssl/hpke.h"
        

# 1 "../include/openssl/types.h" 1
# 16 "../include/openssl/hpke.h" 2
# 80 "../include/openssl/hpke.h"
typedef struct {
    uint16_t kem_id;
    uint16_t kdf_id;
    uint16_t aead_id;
} OSSL_HPKE_SUITE;
# 106 "../include/openssl/hpke.h"
...
# 15 "../test/hpke_test.c" 2




static OSSL_LIB_CTX *testctx = 
# 19 "../test/hpke_test.c" 3 4
                              ((void *)0)
# 19 "../test/hpke_test.c"
                                  ;
static OSSL_PROVIDER *nullprov = 
# 20 "../test/hpke_test.c" 3 4
                                ((void *)0)
# 20 "../test/hpke_test.c"
                                    ;
static OSSL_PROVIDER *deflprov = 
# 21 "../test/hpke_test.c" 3 4
                                ((void *)0)
# 21 "../test/hpke_test.c"
                                    ;
                  ...
                  const unsigned char *pub, size_t publen)
{
    ...
    if (!test_true("../test/hpke_test.c", 82, "publen <= sizeof(pubbuf)", (publen <= sizeof(pubbuf)) != 0))
        return 0;
    erv = EVP_PKEY_get_octet_string_param(pkey,
                                          "encoded-pub-key",
                                          pubbuf, sizeof(pubbuf), &pubbuflen);
    if (!test_true("../test/hpke_test.c", 87, "erv", (erv) != 0))
        return 0;
    if (pub != 
# 89 "../test/hpke_test.c" 3 4
              ((void *)0) 
# 89 "../test/hpke_test.c"
                   && !test_mem_eq("../test/hpke_test.c", 89, "pubbuf", "pub", pubbuf, pubbuflen, pub, publen))
        return 0;
    return 1;
}
                       ...
                       const TEST_EXPORTDATA *export, size_t exportsz)
{
    ...
    OSSL_HPKE_CTX *sealctx = 
# 100 "../test/hpke_test.c" 3 4
                            ((void *)0)
# 100 "../test/hpke_test.c"
                                , *openctx = 
# 100 "../test/hpke_test.c" 3 4
                                             ((void *)0)
# 100 "../test/hpke_test.c"
    ...
    EVP_PKEY *privE = 
# 109 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 109 "../test/hpke_test.c"
                         ;
    unsigned char authpub[512];
    size_t authpublen = sizeof(authpub);
    EVP_PKEY *authpriv = 
# 112 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 112 "../test/hpke_test.c"
                            ;
    unsigned char rpub[512];
    size_t rpublen = sizeof(pub);
    EVP_PKEY *privR = 
# 115 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 115 "../test/hpke_test.c"
                         ;
    int ret = 0;
    size_t i;
    uint64_t lastseq = 0;

    if (!test_true("../test/hpke_test.c", 120, "OSSL_HPKE_keygen(base->suite, pub, &publen, &privE, base->ikmE, base->ikmElen, libctx, propq)", (OSSL_HPKE_keygen(base->suite, pub, &publen, &privE, base->ikmE, base->ikmElen, libctx, propq)) != 0)
                                                                              )
        goto end;
    if (!test_true("../test/hpke_test.c", 123, "cmpkey(privE, base->expected_pkEm, base->expected_pkEmlen)", (cmpkey(privE, base->expected_pkEm, base->expected_pkEmlen)) != 0))
        goto end;
    if (!test_ptr("../test/hpke_test.c", 125, "sealctx = OSSL_HPKE_CTX_new(base->mode, base->suite, OSSL_HPKE_ROLE_SENDER, libctx, propq)", sealctx = OSSL_HPKE_CTX_new(base->mode, base->suite, 0, libctx, propq))

                                                             )
        goto end;
    if (!test_true("../test/hpke_test.c", 129, "OSSL_HPKE_CTX_set1_ikme(sealctx, base->ikmE, base->ikmElen)", (OSSL_HPKE_CTX_set1_ikme(sealctx, base->ikmE, base->ikmElen)) != 0))
        goto end;
    if (base->mode == 2
        || base->mode == 3) {
        if (!test_true("../test/hpke_test.c", 133, "base->ikmAuth != NULL && base->ikmAuthlen > 0", (base->ikmAuth != 
# 133 "../test/hpke_test.c" 3 4
            ((void *)0) 
# 133 "../test/hpke_test.c"
            && base->ikmAuthlen > 0) != 0))
            goto end;
        if (!test_true("../test/hpke_test.c", 135, "OSSL_HPKE_keygen(base->suite, authpub, &authpublen, &authpriv, base->ikmAuth, base->ikmAuthlen, libctx, propq)", (OSSL_HPKE_keygen(base->suite, authpub, &authpublen, &authpriv, base->ikmAuth, base->ikmAuthlen, libctx, propq)) != 0)


                                                       )
            goto end;
        if (!test_true("../test/hpke_test.c", 140, "OSSL_HPKE_CTX_set1_authpriv(sealctx, authpriv)", (OSSL_HPKE_CTX_set1_authpriv(sealctx, authpriv)) != 0))
            goto end;
    }
    if (!test_true("../test/hpke_test.c", 143, "OSSL_HPKE_keygen(base->suite, rpub, &rpublen, &privR, base->ikmR, base->ikmRlen, libctx, propq)", (OSSL_HPKE_keygen(base->suite, rpub, &rpublen, &privR, base->ikmR, base->ikmRlen, libctx, propq)) != 0)
                                                                              )
        goto end;
    if (!test_true("../test/hpke_test.c", 146, "cmpkey(privR, base->expected_pkRm, base->expected_pkRmlen)", (cmpkey(privR, base->expected_pkRm, base->expected_pkRmlen)) != 0))
        goto end;
    if (base->mode == 1
        || base->mode == 3) {
        if (!test_true("../test/hpke_test.c", 150, "OSSL_HPKE_CTX_set1_psk(sealctx, base->pskid, base->psk, base->psklen)", (OSSL_HPKE_CTX_set1_psk(sealctx, base->pskid, base->psk, base->psklen)) != 0)
                                                                       )
            goto end;
    }
    if (!test_true("../test/hpke_test.c", 154, "OSSL_HPKE_encap(sealctx, enc, &enclen, rpub, rpublen, base->ksinfo, base->ksinfolen)", (OSSL_HPKE_encap(sealctx, enc, &enclen, rpub, rpublen, base->ksinfo, base->ksinfolen)) != 0)

                                                                  )
        goto end;
    if (!test_true("../test/hpke_test.c", 158, "cmpkey(privE, enc, enclen)", (cmpkey(privE, enc, enclen)) != 0))
        goto end;
    for (i = 0; i < aeadsz; ++i) {
        ctlen = sizeof(ct);
        memset(ct, 0, ctlen);
        if (!test_true("../test/hpke_test.c", 163, "OSSL_HPKE_seal(sealctx, ct, &ctlen, aead[i].aad, aead[i].aadlen, aead[i].pt, aead[i].ptlen)", (OSSL_HPKE_seal(sealctx, ct, &ctlen, aead[i].aad, aead[i].aadlen, aead[i].pt, aead[i].ptlen)) != 0)

                                                                 )
            goto end;
        if (!test_mem_eq("../test/hpke_test.c", 167, "ct", "aead[i].expected_ct", ct, ctlen, aead[i].expected_ct, aead[i].expected_ctlen)
                                                )
            goto end;
        if (!test_true("../test/hpke_test.c", 170, "OSSL_HPKE_CTX_get_seq(sealctx, &lastseq)", (OSSL_HPKE_CTX_get_seq(sealctx, &lastseq)) != 0))
            goto end;
        if (lastseq != (uint64_t)(i + 1))
            goto end;
    }
    if (!test_ptr("../test/hpke_test.c", 175, "openctx = OSSL_HPKE_CTX_new(base->mode, base->suite, OSSL_HPKE_ROLE_RECEIVER, libctx, propq)", openctx = OSSL_HPKE_CTX_new(base->mode, base->suite, 1, libctx, propq))

                                                             )
        goto end;
    if (base->mode == 1
        || base->mode == 3) {
        if (!test_true("../test/hpke_test.c", 181, "base->pskid != NULL && base->psk != NULL && base->psklen > 0", (base->pskid != 
# 181 "../test/hpke_test.c" 3 4
            ((void *)0) 
# 181 "../test/hpke_test.c"
            && base->psk != 
# 181 "../test/hpke_test.c" 3 4
            ((void *)0) 
# 181 "../test/hpke_test.c"
            ...
            goto end;
        if (!test_true("../test/hpke_test.c", 184, "OSSL_HPKE_CTX_set1_psk(openctx, base->pskid, base->psk, base->psklen)", (OSSL_HPKE_CTX_set1_psk(openctx, base->pskid, base->psk, base->psklen)) != 0)
                                                                       )
            goto end;
    }
    if (base->mode == 2
        || base->mode == 3) {
        if (!test_true("../test/hpke_test.c", 190, "OSSL_HPKE_CTX_set1_authpub(openctx, authpub, authpublen)", (OSSL_HPKE_CTX_set1_authpub(openctx, authpub, authpublen)) != 0)
                                                                       )
            goto end;
    }
    if (!test_true("../test/hpke_test.c", 194, "OSSL_HPKE_decap(openctx, enc, enclen, privR, base->ksinfo, base->ksinfolen)", (OSSL_HPKE_decap(openctx, enc, enclen, privR, base->ksinfo, base->ksinfolen)) != 0)
                                                                  )
        goto end;
    for (i = 0; i < aeadsz; ++i) {
        ptoutlen = sizeof(ptout);
        memset(ptout, 0, ptoutlen);
        if (!test_true("../test/hpke_test.c", 200, "OSSL_HPKE_open(openctx, ptout, &ptoutlen, aead[i].aad, aead[i].aadlen, aead[i].expected_ct, aead[i].expected_ctlen)", (OSSL_HPKE_open(openctx, ptout, &ptoutlen, aead[i].aad, aead[i].aadlen, aead[i].expected_ct, aead[i].expected_ctlen)) != 0)


                                                              )
            goto end;
        if (!test_mem_eq("../test/hpke_test.c", 205, "aead[i].pt", "ptout", aead[i].pt, aead[i].ptlen, ptout, ptoutlen))
            goto end;

        if (!test_true("../test/hpke_test.c", 208, "OSSL_HPKE_CTX_get_seq(openctx, &lastseq)", (OSSL_HPKE_CTX_get_seq(openctx, &lastseq)) != 0))
            goto end;
        if (lastseq != (uint64_t)(i + 1))
            goto end;
    }
    ...
    for (i = 0; i < exportsz; ++i) {
        ...
        unsigned char eval[512];

        if (len > sizeof(eval))
            goto end;

        if (!test_false("../test/hpke_test.c", 221, "OSSL_HPKE_export(sealctx, eval, len, export[i].context, -1)", (OSSL_HPKE_export(sealctx, eval, len, export[i].context, -1)) != 0)
                                                                )
            goto end;

        if (!test_true("../test/hpke_test.c", 225, "OSSL_HPKE_export(sealctx, eval, len, export[i].context, export[i].contextlen)", (OSSL_HPKE_export(sealctx, eval, len, export[i].context, export[i].contextlen)) != 0)

                                                              )
            goto end;
        if (!test_mem_eq("../test/hpke_test.c", 229, "eval", "export[i].expected_secret", eval, len, export[i].expected_secret, export[i].expected_secretlen)
                                                      )
            goto end;
        ...
        if (aeadsz == 0) {
            ...
            if (!test_false("../test/hpke_test.c", 236, "OSSL_HPKE_seal(sealctx, ct, &ctlen, NULL, 0, ptout, ptoutlen)", (OSSL_HPKE_seal(sealctx, ct, &ctlen, 
# 236 "../test/hpke_test.c" 3 4
                ((void *)0)
# 236 "../test/hpke_test.c"
                , 0, ptout, ptoutlen)) != 0)
                                                                     )
                goto end;
        }
...
# 389 "../test/hpke_test.c" 3 4
       ((void *)0)
# 389 "../test/hpke_test.c"
           , 0,
    ...
    const TEST_EXPORTDATA exportdata[] = {
        { 
# 413 "../test/hpke_test.c" 3 4
         ((void *)0)
# 413 "../test/hpke_test.c"
             , 0, first_export1, sizeof(first_export1) },
    ...
    return do_testhpke(&pskdata, aeaddata, (sizeof(aeaddata)/sizeof((aeaddata)[0])),
                       exportdata, (sizeof(exportdata)/sizeof((exportdata)[0])));
}
...
# 521 "../test/hpke_test.c" 3 4
       ((void *)0)
# 521 "../test/hpke_test.c"
           , 0,
        
# 522 "../test/hpke_test.c" 3 4
       ((void *)0)
# 522 "../test/hpke_test.c"
           , 0, 
# 522 "../test/hpke_test.c" 3 4
                ((void *)0)
    
# 523 "../test/hpke_test.c"
   };
    const TEST_AEADDATA aeaddata[] = {
        {
            0,
    ...
    const TEST_EXPORTDATA exportdata[] = {
        { 
# 539 "../test/hpke_test.c" 3 4
         ((void *)0)
# 539 "../test/hpke_test.c"
             , 0, second_export1, sizeof(second_export1) },
    ...
    return do_testhpke(&basedata, aeaddata, (sizeof(aeaddata)/sizeof((aeaddata)[0])),
                       exportdata, (sizeof(exportdata)/sizeof((exportdata)[0])));
}
...
# 658 "../test/hpke_test.c" 3 4
       ((void *)0)
# 658 "../test/hpke_test.c"
           , 0,
        
# 659 "../test/hpke_test.c" 3 4
       ((void *)0)
# 659 "../test/hpke_test.c"
           , 0, 
# 659 "../test/hpke_test.c" 3 4
                ((void *)0)
    
# 660 "../test/hpke_test.c"
   };
    const TEST_AEADDATA aeaddata[] = {
        {
            0,
    ...
    const TEST_EXPORTDATA exportdata[] = {
        { 
# 676 "../test/hpke_test.c" 3 4
         ((void *)0)
# 676 "../test/hpke_test.c"
             , 0, third_export1, sizeof(third_export1) },
...
# 764 "../test/hpke_test.c" 3 4
       ((void *)0)
# 764 "../test/hpke_test.c"
           , 0,
        
# 765 "../test/hpke_test.c" 3 4
       ((void *)0)
# 765 "../test/hpke_test.c"
           , 0, 
# 765 "../test/hpke_test.c" 3 4
                ((void *)0)
    
# 766 "../test/hpke_test.c"
   };
    const TEST_EXPORTDATA exportdata[] = {
        { 
# 768 "../test/hpke_test.c" 3 4
         ((void *)0)
# 768 "../test/hpke_test.c"
             , 0, fourth_export1, sizeof(fourth_export1) },
    ...
    return do_testhpke(&basedata, 
# 774 "../test/hpke_test.c" 3 4
                                 ((void *)0)
# 774 "../test/hpke_test.c"
                                     , 0,
                       exportdata, (sizeof(exportdata)/sizeof((exportdata)[0])));
}
# 785 "../test/hpke_test.c"
...
# 888 "../test/hpke_test.c" 3 4
   ((void *)0)
# 888 "../test/hpke_test.c"
       ,
    "",
    ",",
    ",,"
};
# 904 "../test/hpke_test.c"
static int test_hpke_modes_suites(void)
{
    ...
    for (mind = 0; mind < (sizeof(hpke_mode_list)/sizeof((hpke_mode_list)[0])); mind++) {
        int hpke_mode = hpke_mode_list[mind];
        size_t aadlen = 512;
        unsigned char aad[512];
        unsigned char *aadp = 
# 917 "../test/hpke_test.c" 3 4
                             ((void *)0)
# 917 "../test/hpke_test.c"
                                 ;
        size_t infolen = 32;
        unsigned char info[32];
        unsigned char *infop = 
# 920 "../test/hpke_test.c" 3 4
                              ((void *)0)
# 920 "../test/hpke_test.c"
                                  ;
        unsigned char lpsk[32];
        unsigned char *pskp = 
# 922 "../test/hpke_test.c" 3 4
                             ((void *)0)
# 922 "../test/hpke_test.c"
                                 ;
        char lpskid[32];
        size_t psklen = 32;
        char *pskidp = 
# 925 "../test/hpke_test.c" 3 4
                      ((void *)0)
# 925 "../test/hpke_test.c"
                          ;
        EVP_PKEY *privp = 
# 926 "../test/hpke_test.c" 3 4
                         ((void *)0)
# 926 "../test/hpke_test.c"
                             ;
        OSSL_HPKE_SUITE hpke_suite = { 0x0020, 0x0001, 0x0001 };
        size_t plainlen = 512;
        unsigned char plain[512];
        OSSL_HPKE_CTX *rctx = 
# 930 "../test/hpke_test.c" 3 4
                             ((void *)0)
# 930 "../test/hpke_test.c"
                                 ;
        OSSL_HPKE_CTX *ctx = 
# 931 "../test/hpke_test.c" 3 4
                            ((void *)0)
# 931 "../test/hpke_test.c"
                                ;

        memset(plain, 0x00, 512);
        ...
        for (kemind = 0;
             overallresult == 1 && kemind < (sizeof(hpke_kem_list)/sizeof((hpke_kem_list)[0]));
             kemind++) {
            uint16_t kem_id = hpke_kem_list[kemind];
            size_t authpublen = 512;
            unsigned char authpub[512];
            unsigned char *authpubp = 
# 970 "../test/hpke_test.c" 3 4
                                     ((void *)0)
# 970 "../test/hpke_test.c"
                                         ;
            EVP_PKEY *authpriv = 
# 971 "../test/hpke_test.c" 3 4
                                ((void *)0)
# 971 "../test/hpke_test.c"
                                    ;

            hpke_suite.kem_id = kem_id;
            if (hpke_mode == 2
                || hpke_mode == 3) {
                if (test_true("../test/hpke_test.c", 976, "OSSL_HPKE_keygen(hpke_suite, authpub, &authpublen, &authpriv, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, authpub, &authpublen, &authpriv, 
# 976 "../test/hpke_test.c" 3 4
                   ((void *)0)
# 976 "../test/hpke_test.c"
                   , 0, testctx, 
# 976 "../test/hpke_test.c" 3 4
                   ((void *)0)
# 976 "../test/hpke_test.c"
            ...
            for (kdfind = 0;
                 overallresult == 1 && kdfind < (sizeof(hpke_kdf_list)/sizeof((hpke_kdf_list)[0]));
                 kdfind++) {
                ...
                for (aeadind = 0;
                     overallresult == 1
                     && aeadind < (sizeof(hpke_aead_list)/sizeof((hpke_aead_list)[0]));
                     aeadind++) {
                    uint16_t aead_id = hpke_aead_list[aeadind];
                    size_t publen = 512;
                    unsigned char pub[512];
                    size_t senderpublen = 512;
                    unsigned char senderpub[512];
                    ...
                    if (!test_true("../test/hpke_test.c", 1006, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1006 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1006 "../test/hpke_test.c"
                        , 0, testctx, 
# 1006 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1006 "../test/hpke_test.c"
                        ...
                        overallresult = 0;
                    if (!test_ptr("../test/hpke_test.c", 1010, "ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 0, testctx, 
# 1010 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1010 "../test/hpke_test.c"
                        ))
                    ...
                    if (hpke_mode == 1
                        || hpke_mode == 3) {
                        if (!test_true("../test/hpke_test.c", 1016, "OSSL_HPKE_CTX_set1_psk(ctx, pskidp, pskp, psklen)", (OSSL_HPKE_CTX_set1_psk(ctx, pskidp, pskp, psklen)) != 0)
                                                                            )
                            overallresult = 0;
                    }
                    if (hpke_mode == 2
                        || hpke_mode == 3) {
                        if (!test_true("../test/hpke_test.c", 1022, "OSSL_HPKE_CTX_set1_authpriv(ctx, authpriv)", (OSSL_HPKE_CTX_set1_authpriv(ctx, authpriv)) != 0)
                                                                             )
                            overallresult = 0;
                    }
                    if (!test_true("../test/hpke_test.c", 1026, "OSSL_HPKE_encap(ctx, senderpub, &senderpublen, pub, publen, infop, infolen)", (OSSL_HPKE_encap(ctx, senderpub, &senderpublen, pub, publen, infop, infolen)) != 0)
                    ...
                    cipherlen = 15;
                    if (!test_false("../test/hpke_test.c", 1033, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, aadp, aadlen, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, aadp, aadlen, plain, plainlen)) != 0)

                                                                    )
                        overallresult = 0;

                    cipherlen = 512;
                    if (!test_true("../test/hpke_test.c", 1039, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, aadp, aadlen, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, aadp, aadlen, plain, plainlen)) != 0)
                    ...
                    rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite,
                                             1,
                                             testctx, 
# 1047 "../test/hpke_test.c" 3 4
                                                     ((void *)0)
# 1047 "../test/hpke_test.c"
                                                         );
                    if (!test_ptr("../test/hpke_test.c", 1048, "rctx", rctx))
                        overallresult = 0;
                    if (hpke_mode == 1
                        || hpke_mode == 3) {
                        if (!test_true("../test/hpke_test.c", 1052, "OSSL_HPKE_CTX_set1_psk(rctx, pskidp, pskp, psklen)", (OSSL_HPKE_CTX_set1_psk(rctx, pskidp, pskp, psklen)) != 0)
                                                                            )
                            overallresult = 0;
                    }
                    if (hpke_mode == 2
                        ...
                        if (hpke_suite.kem_id == 0x0010) {

                            if (!test_false("../test/hpke_test.c", 1061, "OSSL_HPKE_CTX_set1_authpub(rctx, authpub, 10 )", (OSSL_HPKE_CTX_set1_authpub(rctx, authpub, 10 )) != 0)


                                                                         )
                                overallresult = 0;
                        }
                        if (!test_true("../test/hpke_test.c", 1067, "OSSL_HPKE_CTX_set1_authpub(rctx, authpubp, authpublen)", (OSSL_HPKE_CTX_set1_authpub(rctx, authpubp, authpublen)) != 0)

                                                                              )
                            overallresult = 0;
                    }
                    if (!test_true("../test/hpke_test.c", 1072, "OSSL_HPKE_decap(rctx, senderpub, senderpublen, privp, infop, infolen)", (OSSL_HPKE_decap(rctx, senderpub, senderpublen, privp, infop, infolen)) != 0)

                                                                   )
                        overallresult = 0;

                    clearlen = 15;
                    if (!test_false("../test/hpke_test.c", 1078, "OSSL_HPKE_open(rctx, clear, &clearlen, aadp, aadlen, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, aadp, aadlen, cipher, cipherlen)) != 0)

                                                              )
                        overallresult = 0;

                    clearlen = 512;
                    if (!test_true("../test/hpke_test.c", 1084, "OSSL_HPKE_open(rctx, clear, &clearlen, aadp, aadlen, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, aadp, aadlen, cipher, cipherlen)) != 0)
                    ...
                    EVP_PKEY_free(privp);
                    privp = 
# 1090 "../test/hpke_test.c" 3 4
                           ((void *)0)
# 1090 "../test/hpke_test.c"
                               ;

                    if (!test_mem_eq("../test/hpke_test.c", 1092, "clear", "plain", clear, clearlen, plain, plainlen)) {
                        overallresult = 0;
                    }
                    if (verbose || overallresult != 1) {
                        const char *res = 
# 1096 "../test/hpke_test.c" 3 4
                                         ((void *)0)
# 1096 "../test/hpke_test.c"
                                             ;
...
static int test_hpke_export(void)
{
    int erv = 0;
    EVP_PKEY *privp = 
# 1122 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 1122 "../test/hpke_test.c"
                         ;
    unsigned char pub[512];
    size_t publen = sizeof(pub);
    int hpke_mode = 0;
    OSSL_HPKE_SUITE hpke_suite = { 0x0020, 0x0001, 0x0001 };
    OSSL_HPKE_CTX *ctx = 
# 1127 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1127 "../test/hpke_test.c"
                            ;
    OSSL_HPKE_CTX *rctx = 
# 1128 "../test/hpke_test.c" 3 4
                         ((void *)0)
# 1128 "../test/hpke_test.c"
                             ;
    ...
    if (!test_true("../test/hpke_test.c", 1143, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1143 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1143 "../test/hpke_test.c"
        , 0, testctx, 
# 1143 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1143 "../test/hpke_test.c"
        ...
        goto end;
    if (!test_ptr("../test/hpke_test.c", 1146, "ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 0, testctx, 
# 1146 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1146 "../test/hpke_test.c"
        ))

                                                         )
        goto end;

    if (!test_false("../test/hpke_test.c", 1151, "OSSL_HPKE_export(NULL, exp, sizeof(exp), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(
# 1151 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1151 "../test/hpke_test.c"
        , exp, sizeof(exp), (unsigned char *)estr, strlen(estr))) != 0)
                                                                          )
        goto end;

    if (!test_false("../test/hpke_test.c", 1155, "OSSL_HPKE_export(ctx, exp, sizeof(exp), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(ctx, exp, sizeof(exp), (unsigned char *)estr, strlen(estr))) != 0)
                                                                          )
        goto end;
    if (!test_true("../test/hpke_test.c", 1158, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1158 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1158 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1160, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1160 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1160 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                   )
        goto end;

    if (!test_true("../test/hpke_test.c", 1164, "OSSL_HPKE_export(ctx, exp, sizeof(exp), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(ctx, exp, sizeof(exp), (unsigned char *)estr, strlen(estr))) != 0)
                                                                         )
        goto end;

    if (!test_true("../test/hpke_test.c", 1168, "OSSL_HPKE_export(ctx, exp2, sizeof(exp2), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(ctx, exp2, sizeof(exp2), (unsigned char *)estr, strlen(estr))) != 0)
                                                                         )
        goto end;
    if (!test_mem_eq("../test/hpke_test.c", 1171, "exp", "exp2", exp, sizeof(exp), exp2, sizeof(exp2)))
        goto end;
    if (!test_ptr("../test/hpke_test.c", 1173, "rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_RECEIVER, testctx, NULL)", rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 1, testctx, 
# 1173 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1173 "../test/hpke_test.c"
        ))

                                                          )
        goto end;
    if (!test_true("../test/hpke_test.c", 1177, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1177 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1177 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1179, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1179 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1179 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                     )
        goto end;
    if (!test_true("../test/hpke_test.c", 1182, "OSSL_HPKE_export(rctx, rexp, sizeof(rexp), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(rctx, rexp, sizeof(rexp), (unsigned char *)estr, strlen(estr))) != 0)
                                                                         )
        goto end;

    if (!test_true("../test/hpke_test.c", 1186, "OSSL_HPKE_export(rctx, rexp2, sizeof(rexp2), (unsigned char *)estr, strlen(estr))", (OSSL_HPKE_export(rctx, rexp2, sizeof(rexp2), (unsigned char *)estr, strlen(estr))) != 0)
                                                                         )
        goto end;
    if (!test_mem_eq("../test/hpke_test.c", 1189, "rexp", "rexp2", rexp, sizeof(rexp), rexp2, sizeof(rexp2)))
        goto end;
    if (!test_mem_eq("../test/hpke_test.c", 1191, "exp", "rexp", exp, sizeof(exp), rexp, sizeof(rexp)))
        goto end;
    erv = 1;
end:
    OSSL_HPKE_CTX_free(ctx);
...
static int test_hpke_suite_strs(void)
{
    ...
    for (kemind = 0; kemind != (sizeof(kem_str_list)/sizeof((kem_str_list)[0])); kemind++) {
        for (kdfind = 0; kdfind != (sizeof(kdf_str_list)/sizeof((kdf_str_list)[0])); kdfind++) {
            for (aeadind = 0; aeadind != (sizeof(aead_str_list)/sizeof((aead_str_list)[0])); aeadind++) {
                BIO_snprintf(sstr, 128, "%s,%s,%s", kem_str_list[kemind],
                             kdf_str_list[kdfind], aead_str_list[aeadind]);
                if (test_true("../test/hpke_test.c", 1221, "OSSL_HPKE_str2suite(sstr, &stirred)", (OSSL_HPKE_str2suite(sstr, &stirred)) != 0) != 1) {
                    if (verbose)
    ...
    for (sind = 0; sind != (sizeof(bogus_suite_strs)/sizeof((bogus_suite_strs)[0])); sind++) {
        if (test_false("../test/hpke_test.c", 1231, "OSSL_HPKE_str2suite(bogus_suite_strs[sind], &stirred)", (OSSL_HPKE_str2suite(bogus_suite_strs[sind], &stirred)) != 0)
                                                      != 1) {
            if (verbose)
    ...
    if (!test_false("../test/hpke_test.c", 1240, "OSSL_HPKE_str2suite(\"\", &stirred)", (OSSL_HPKE_str2suite("", &stirred)) != 0))
        overallresult = 0;
    if (!test_false("../test/hpke_test.c", 1242, "OSSL_HPKE_str2suite(NULL, &stirred)", (OSSL_HPKE_str2suite(
# 1242 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1242 "../test/hpke_test.c"
        , &stirred)) != 0))
        overallresult = 0;
    if (!test_false("../test/hpke_test.c", 1244, "OSSL_HPKE_str2suite(\"\", NULL)", (OSSL_HPKE_str2suite("", 
# 1244 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1244 "../test/hpke_test.c"
        )) != 0))
        overallresult = 0;
    memset(giant, 'A', sizeof(giant) - 1);
    giant[sizeof(giant) - 1] = '\0';
    if (!test_false("../test/hpke_test.c", 1248, "OSSL_HPKE_str2suite(giant, &stirred)", (OSSL_HPKE_str2suite(giant, &stirred)) != 0))
        overallresult = 0;
...
static int test_hpke_grease(void)
{
    ...
    unsigned char g_pub[512];
    size_t g_pub_len = 512;
    unsigned char g_cipher[512];
    ...
    g_pub_len = 10;
    if (test_false("../test/hpke_test.c", 1275, "OSSL_HPKE_get_grease_value(NULL, &g_suite, g_pub, &g_pub_len, g_cipher, g_cipher_len, testctx, NULL)", (OSSL_HPKE_get_grease_value(
# 1275 "../test/hpke_test.c" 3 4
       ((void *)0)
# 1275 "../test/hpke_test.c"
       , &g_suite, g_pub, &g_pub_len, g_cipher, g_cipher_len, testctx, 
# 1275 "../test/hpke_test.c" 3 4
       ((void *)0)
# 1275 "../test/hpke_test.c"
       )) != 0)
    ...
    g_pub_len = 512;
    if (test_true("../test/hpke_test.c", 1283, "OSSL_HPKE_get_grease_value(NULL, &g_suite, g_pub, &g_pub_len, g_cipher, g_cipher_len, testctx, NULL)", (OSSL_HPKE_get_grease_value(
# 1283 "../test/hpke_test.c" 3 4
       ((void *)0)
# 1283 "../test/hpke_test.c"
       , &g_suite, g_pub, &g_pub_len, g_cipher, g_cipher_len, testctx, 
# 1283 "../test/hpke_test.c" 3 4
       ((void *)0)
# 1283 "../test/hpke_test.c"
    ...
    if (!test_size_t_gt("../test/hpke_test.c", 1291, "expanded", "clearlen", expanded, clearlen)) {
        overallresult = 0;
    }
    enclen = OSSL_HPKE_get_public_encap_size(g_suite);
    if (!test_size_t_ne("../test/hpke_test.c", 1295, "enclen", "0", enclen, 0))
        overallresult = 0;

    ikmelen = OSSL_HPKE_get_recommended_ikmelen(g_suite);
    if (!test_size_t_ne("../test/hpke_test.c", 1299, "ikmelen", "0", ikmelen, 0))
        overallresult = 0;
...
static int test_hpke_oddcalls(void)
{
    int erv = 0;
    EVP_PKEY *privp = 
# 1311 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 1311 "../test/hpke_test.c"
                         ;
    unsigned char pub[512];
    size_t publen = sizeof(pub);
    int hpke_mode = 0;
    ...
    OSSL_HPKE_CTX *ctx = 
# 1318 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1318 "../test/hpke_test.c"
                            ;
    OSSL_HPKE_CTX *rctx = 
# 1319 "../test/hpke_test.c" 3 4
                         ((void *)0)
# 1319 "../test/hpke_test.c"
                             ;
    unsigned char plain[] = "quick brown fox";
    size_t plainlen = sizeof(plain);
    unsigned char enc[512], smallenc[10];
    size_t enclen = sizeof(enc), smallenclen = sizeof(smallenc);
    unsigned char cipher[512];
    size_t cipherlen = sizeof(cipher);
    unsigned char clear[512];
    size_t clearlen = sizeof(clear);
    unsigned char fake_ikm[512];
    char *badpropq = "yeah, this won't work";
    uint64_t lseq = 0;
    char giant_pskid[66 + 10];
    ...
    OSSL_HPKE_CTX_free(
# 1337 "../test/hpke_test.c" 3 4
                      ((void *)0)
# 1337 "../test/hpke_test.c"
                          );
    if (!test_false("../test/hpke_test.c", 1338, "OSSL_HPKE_CTX_set_seq(NULL, 1)", (OSSL_HPKE_CTX_set_seq(
# 1338 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1338 "../test/hpke_test.c"
        , 1)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1340, "OSSL_HPKE_CTX_get_seq(NULL, &lseq)", (OSSL_HPKE_CTX_get_seq(
# 1340 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1340 "../test/hpke_test.c"
        , &lseq)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1342, "OSSL_HPKE_CTX_set1_authpub(NULL, pub, publen)", (OSSL_HPKE_CTX_set1_authpub(
# 1342 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1342 "../test/hpke_test.c"
        , pub, publen)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1344, "OSSL_HPKE_CTX_set1_authpriv(NULL, privp)", (OSSL_HPKE_CTX_set1_authpriv(
# 1344 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1344 "../test/hpke_test.c"
        , privp)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1346, "OSSL_HPKE_CTX_set1_ikme(NULL, NULL, 0)", (OSSL_HPKE_CTX_set1_ikme(
# 1346 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1346 "../test/hpke_test.c"
        , 
# 1346 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1346 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1348, "OSSL_HPKE_CTX_set1_psk(NULL, NULL, NULL, 0)", (OSSL_HPKE_CTX_set1_psk(
# 1348 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1348 "../test/hpke_test.c"
        , 
# 1348 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1348 "../test/hpke_test.c"
...
# 1348 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1353, "OSSL_HPKE_suite_check(hpke_suite)", (OSSL_HPKE_suite_check(hpke_suite)) != 0))
        goto end;
    hpke_suite.aead_id = 0x0001;
    if (!test_false("../test/hpke_test.c", 1356, "OSSL_HPKE_suite_check(bad_suite)", (OSSL_HPKE_suite_check(bad_suite)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1358, "OSSL_HPKE_get_recommended_ikmelen(bad_suite)", (OSSL_HPKE_get_recommended_ikmelen(bad_suite)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1360, "OSSL_HPKE_get_public_encap_size(bad_suite)", (OSSL_HPKE_get_public_encap_size(bad_suite)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1362, "OSSL_HPKE_get_ciphertext_size(bad_suite, 0)", (OSSL_HPKE_get_ciphertext_size(bad_suite, 0)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1364, "OSSL_HPKE_keygen(bad_suite, pub, &publen, &privp, NULL, 0, testctx, badpropq)", (OSSL_HPKE_keygen(bad_suite, pub, &publen, &privp, 
# 1364 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1364 "../test/hpke_test.c"
        , 0, testctx, badpropq)) != 0)
                                                                 )
        goto end;
    if (!test_false("../test/hpke_test.c", 1367, "OSSL_HPKE_keygen(bad_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(bad_suite, pub, &publen, &privp, 
# 1367 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1367 "../test/hpke_test.c"
        , 0, testctx, 
# 1367 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1367 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1373, "OSSL_HPKE_keygen(hpke_suite, NULL, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, 
# 1373 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1373 "../test/hpke_test.c"
        , &publen, &privp, 
# 1373 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1373 "../test/hpke_test.c"
...
# 1373 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1377, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 80, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1377 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1377 "../test/hpke_test.c"
        , 80, testctx, 
# 1377 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1377 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1381, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, fake_ikm, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, fake_ikm, 0, testctx, 
# 1381 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1381 "../test/hpke_test.c"
        )) != 0)
                                                                 )
        goto end;

    if (!test_false("../test/hpke_test.c", 1385, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, fake_ikm, -1, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, fake_ikm, -1, testctx, 
# 1385 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1385 "../test/hpke_test.c"
        )) != 0)
                                                                  )
        goto end;

    publen = 10;
    if (!test_false("../test/hpke_test.c", 1390, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1390 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1390 "../test/hpke_test.c"
        , 0, testctx, 
# 1390 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1390 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1396, "OSSL_HPKE_encap(NULL, NULL, NULL, NULL, 0, NULL, 0)", (OSSL_HPKE_encap(
# 1396 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1396 "../test/hpke_test.c"
        , 
# 1396 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1396 "../test/hpke_test.c"
...
# 1396 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1398, "OSSL_HPKE_decap(NULL, NULL, 0, NULL, NULL, 0)", (OSSL_HPKE_decap(
# 1398 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1398 "../test/hpke_test.c"
        , 
# 1398 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1398 "../test/hpke_test.c"
...
# 1398 "../test/hpke_test.c"
    ...
    if (!test_true("../test/hpke_test.c", 1406, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1406 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1406 "../test/hpke_test.c"
        , 0, testctx, 
# 1406 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1406 "../test/hpke_test.c"
    ...
    if (!test_ptr("../test/hpke_test.c", 1411, "ctx = OSSL_HPKE_CTX_new(OSSL_HPKE_MODE_PSK, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(1, hpke_suite, 0, testctx, 
# 1411 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1411 "../test/hpke_test.c"
        ))

                                                         )
        goto end;

    if (!test_false("../test/hpke_test.c", 1416, "OSSL_HPKE_CTX_set1_psk(ctx, \"foo\", (unsigned char *)\"bar\", -1)", (OSSL_HPKE_CTX_set1_psk(ctx, "foo", (unsigned char *)"bar", -1)) != 0)
                                                                       )
        goto end;

    memset(giant_pskid, 'A', sizeof(giant_pskid) - 1);
    giant_pskid[sizeof(giant_pskid) - 1] = '\0';
    if (!test_false("../test/hpke_test.c", 1422, "OSSL_HPKE_CTX_set1_psk(ctx, giant_pskid, (unsigned char *)\"bar\", 3)", (OSSL_HPKE_CTX_set1_psk(ctx, giant_pskid, (unsigned char *)"bar", 3)) != 0)
                                                                      )
        goto end;

    if (!test_false("../test/hpke_test.c", 1426, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1426 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1426 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    OSSL_HPKE_CTX_free(ctx);


    if (!test_ptr_null("../test/hpke_test.c", 1431, "ctx = OSSL_HPKE_CTX_new(hpke_mode, bad_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, bad_suite, 0, testctx, 
# 1431 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1431 "../test/hpke_test.c"
        ))

                                                              )
        goto end;

    if (!test_ptr_null("../test/hpke_test.c", 1436, "ctx = OSSL_HPKE_CTX_new(bad_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(bad_mode, hpke_suite, 0, testctx, 
# 1436 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1436 "../test/hpke_test.c"
        ))

                                                              )
        goto end;

    if (!test_ptr("../test/hpke_test.c", 1441, "ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 0, testctx, 
# 1441 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1441 "../test/hpke_test.c"
        ))

                                                         )
        goto end;

    if (!test_false("../test/hpke_test.c", 1446, "OSSL_HPKE_CTX_set1_ikme(ctx, fake_ikm, -1)", (OSSL_HPKE_CTX_set1_ikme(ctx, fake_ikm, -1)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1449, "OSSL_HPKE_CTX_set1_ikme(ctx, fake_ikm, 0)", (OSSL_HPKE_CTX_set1_ikme(ctx, fake_ikm, 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1452, "OSSL_HPKE_CTX_set1_authpub(ctx, NULL, 0)", (OSSL_HPKE_CTX_set1_authpub(ctx, 
# 1452 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1452 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1455, "OSSL_HPKE_CTX_set1_authpriv(ctx, NULL)", (OSSL_HPKE_CTX_set1_authpriv(ctx, 
# 1455 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1455 "../test/hpke_test.c"
        )) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1458, "OSSL_HPKE_CTX_set1_authpriv(ctx, privp)", (OSSL_HPKE_CTX_set1_authpriv(ctx, privp)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1461, "OSSL_HPKE_CTX_set1_psk(ctx, \"foo\", (unsigned char *)\"bar\", 3)", (OSSL_HPKE_CTX_set1_psk(ctx, "foo", (unsigned char *)"bar", 3)) != 0)
                                                                      )
        goto end;

    if (!test_false("../test/hpke_test.c", 1465, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1465 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1465 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                    )
        goto end;

    if (!test_false("../test/hpke_test.c", 1469, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, 
# 1469 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1469 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1472, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, info, -1)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, info, -1)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1475, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, NULL, 1)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, 
# 1475 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1475 "../test/hpke_test.c"
        , 1)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1478, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, info, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, 1, info, 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1481, "OSSL_HPKE_encap(ctx, smallenc, &smallenclen, pub, 1, NULL, 0)", (OSSL_HPKE_encap(ctx, smallenc, &smallenclen, pub, 1, 
# 1481 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1481 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_true("../test/hpke_test.c", 1484, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1484 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1484 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1487, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1487 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1487 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    plainlen = 0;

    if (!test_false("../test/hpke_test.c", 1491, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1491 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1491 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                    )
        goto end;
    plainlen = sizeof(plain);

    if (!test_true("../test/hpke_test.c", 1496, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1496 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1496 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                   )
        goto end;
    ...
    if (!test_ptr("../test/hpke_test.c", 1502, "rctx = OSSL_HPKE_CTX_new(OSSL_HPKE_MODE_PSK, hpke_suite, OSSL_HPKE_ROLE_RECEIVER, testctx, NULL)", rctx = OSSL_HPKE_CTX_new(1, hpke_suite, 1, testctx, 
# 1502 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1502 "../test/hpke_test.c"
        ))

                                                          )
        goto end;
    if (!test_false("../test/hpke_test.c", 1506, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1506 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1506 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    ...
    if (!test_ptr("../test/hpke_test.c", 1512, "rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_RECEIVER, testctx, NULL)", rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 1, testctx, 
# 1512 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1512 "../test/hpke_test.c"
        ))

                                                          )
        goto end;

    if (!test_false("../test/hpke_test.c", 1517, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1517 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1517 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                      )
        goto end;

    if (!test_false("../test/hpke_test.c", 1521, "OSSL_HPKE_decap(rctx, enc, enclen, privp, info, -1)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, info, -1)) != 0))
        goto end;

    if (!test_true("../test/hpke_test.c", 1524, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1524 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1524 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1527, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1527 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1527 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    clearlen = 0;
    if (!test_false("../test/hpke_test.c", 1531, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1531 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1531 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                      )
        goto end;
    clearlen = 512;

    if (!test_true("../test/hpke_test.c", 1536, "OSSL_HPKE_CTX_set_seq(rctx, -1)", (OSSL_HPKE_CTX_set_seq(rctx, -1)) != 0))
        goto end;
    if (!test_false("../test/hpke_test.c", 1538, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1538 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1538 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                      )
        goto end;
    if (!test_true("../test/hpke_test.c", 1541, "OSSL_HPKE_CTX_set_seq(rctx, 0)", (OSSL_HPKE_CTX_set_seq(rctx, 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1543, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1543 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1543 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                     )
        goto end;
    if (!test_mem_eq("../test/hpke_test.c", 1546, "plain", "clear", plain, plainlen, clear, clearlen))
        goto end;
    erv = 1;
end:
    OSSL_HPKE_CTX_free(ctx);
...
{
    OSSL_HPKE_SUITE def_suite = { 0x0020, 0x0001, 0x0001 };
    OSSL_HPKE_SUITE suite = { 0x0020, 0x0001, 0x0001 };
    ...
    if (!test_false("../test/hpke_test.c", 1658, "OSSL_HPKE_get_grease_value(NULL, NULL, NULL, NULL, NULL, 0, testctx, NULL)", (OSSL_HPKE_get_grease_value(
# 1658 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1658 "../test/hpke_test.c"
        , 
# 1658 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1658 "../test/hpke_test.c"
...
# 1658 "../test/hpke_test.c"
        ...
        return 0;
    enclen = 10;
    if (!test_false("../test/hpke_test.c", 1663, "OSSL_HPKE_get_grease_value(&def_suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&def_suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1663 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1663 "../test/hpke_test.c"
        )) != 0)
    ...
    if (!test_true("../test/hpke_test.c", 1670, "OSSL_HPKE_get_grease_value(&def_suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&def_suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1670 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1670 "../test/hpke_test.c"
        )) != 0)
    ...
    enclen = sizeof(enc);
    if (!test_true("../test/hpke_test.c", 1676, "OSSL_HPKE_get_grease_value(NULL, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(
# 1676 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1676 "../test/hpke_test.c"
        , &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1676 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1676 "../test/hpke_test.c"
        )) != 0)
    ...
    enclen = sizeof(enc);
    suite.kem_id = 0x0012;
    if (!test_true("../test/hpke_test.c", 1684, "OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1684 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1684 "../test/hpke_test.c"
        )) != 0)
    ...
    enclen = sizeof(enc);
    ctlen = 2;
    if (!test_false("../test/hpke_test.c", 1690, "OSSL_HPKE_get_grease_value(NULL, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(
# 1690 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1690 "../test/hpke_test.c"
        , &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1690 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1690 "../test/hpke_test.c"
    ...
    if (!test_false("../test/hpke_test.c", 1700, "OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1700 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1700 "../test/hpke_test.c"
        )) != 0)
    ...
    suite.kdf_id = 0x3451;
    if (!test_false("../test/hpke_test.c", 1707, "OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1707 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1707 "../test/hpke_test.c"
        )) != 0)
    ...
    suite.kem_id = 0x4517;
    if (!test_false("../test/hpke_test.c", 1714, "OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, NULL)", (OSSL_HPKE_get_grease_value(&suite, &suite2, enc, &enclen, ct, ctlen, testctx, 
# 1714 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1714 "../test/hpke_test.c"
        )) != 0)
...
# 1734 "../test/hpke_test.c"
static int test_hpke_one_ikm_gen(uint16_t kem_id,
                                 const unsigned char *ikm, size_t ikmlen,
                                 const unsigned char *pub, size_t publen)
{
    OSSL_HPKE_SUITE hpke_suite = { 0x0020, 0x0001, 0x0001 };
    unsigned char lpub[512];
    size_t lpublen = 512;
    EVP_PKEY *sk = 
# 1741 "../test/hpke_test.c" 3 4
                  ((void *)0)
# 1741 "../test/hpke_test.c"
                      ;

    hpke_suite.kem_id = kem_id;
    if (!test_true("../test/hpke_test.c", 1744, "OSSL_HPKE_keygen(hpke_suite, lpub, &lpublen, &sk, ikm, ikmlen, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, lpub, &lpublen, &sk, ikm, ikmlen, testctx, 
# 1744 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1744 "../test/hpke_test.c"
        )) != 0)
                                                                )
        return 0;
    if (!test_ptr("../test/hpke_test.c", 1747, "sk", sk))
        return 0;
    EVP_PKEY_free(sk);
    if (!test_mem_eq("../test/hpke_test.c", 1750, "pub", "lpub", pub, publen, lpub, lpublen))
        return 0;
    return 1;
}
...
static int test_hpke_ikms(void)
{
    ...
    res = test_hpke_one_ikm_gen(0x0020,
    ...
    res = test_hpke_one_ikm_gen(0x0012,
                                ikmp521, sizeof(ikmp521),
                                pubp521, sizeof(pubp521));
    if (res != 1)
        return res;

    res = test_hpke_one_ikm_gen(0x0010,
...
static int test_hpke_compressed(void)
{
    int erv = 0;
    EVP_PKEY *privp = 
# 1799 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 1799 "../test/hpke_test.c"
                         ;
    unsigned char pub[512];
    size_t publen = sizeof(pub);
    EVP_PKEY *authpriv = 
# 1802 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1802 "../test/hpke_test.c"
                            ;
    unsigned char authpub[512];
    size_t authpublen = sizeof(authpub);
    int hpke_mode = 2;
    OSSL_HPKE_SUITE hpke_suite = { 0x0020, 0x0001, 0x0001 };
    OSSL_HPKE_CTX *ctx = 
# 1807 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1807 "../test/hpke_test.c"
                            ;
    OSSL_HPKE_CTX *rctx = 
# 1808 "../test/hpke_test.c" 3 4
                         ((void *)0)
# 1808 "../test/hpke_test.c"
                             ;
    unsigned char plain[] = "quick brown fox";
    size_t plainlen = sizeof(plain);
    unsigned char enc[512];
    ...
    hpke_suite.kem_id = 0x0010;


    if (!test_true("../test/hpke_test.c", 1821, "OSSL_HPKE_keygen(hpke_suite, authpub, &authpublen, &authpriv, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, authpub, &authpublen, &authpriv, 
# 1821 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1821 "../test/hpke_test.c"
        , 0, testctx, 
# 1821 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1821 "../test/hpke_test.c"
    ...
    if (!test_true("../test/hpke_test.c", 1825, "EVP_PKEY_set_utf8_string_param(authpriv, OSSL_PKEY_PARAM_EC_POINT_CONVERSION_FORMAT, OSSL_PKEY_EC_POINT_CONVERSION_FORMAT_COMPRESSED)", (EVP_PKEY_set_utf8_string_param(authpriv, "point-format", "compressed")) != 0)

                                                                       )
        goto end;
    if (!test_true("../test/hpke_test.c", 1829, "EVP_PKEY_get_octet_string_param(authpriv, OSSL_PKEY_PARAM_PUB_KEY, authpub, sizeof(authpub), &authpublen)", (EVP_PKEY_get_octet_string_param(authpriv, "pub", authpub, sizeof(authpub), &authpublen)) != 0)
    ...
    if (!test_true("../test/hpke_test.c", 1837, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1837 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1837 "../test/hpke_test.c"
        , 0, testctx, 
# 1837 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1837 "../test/hpke_test.c"
        ...
        goto end;
    if (!test_ptr("../test/hpke_test.c", 1840, "ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 0, testctx, 
# 1840 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1840 "../test/hpke_test.c"
        ))

                                                         )
        goto end;
    if (!test_true("../test/hpke_test.c", 1844, "OSSL_HPKE_CTX_set1_authpriv(ctx, authpriv)", (OSSL_HPKE_CTX_set1_authpriv(ctx, authpriv)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1846, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1846 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1846 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1848, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1848 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1848 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                   )
        goto end;


    if (!test_ptr("../test/hpke_test.c", 1853, "rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_RECEIVER, testctx, NULL)", rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 1, testctx, 
# 1853 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1853 "../test/hpke_test.c"
        ))

                                                          )
        goto end;
    if (!test_true("../test/hpke_test.c", 1857, "OSSL_HPKE_CTX_set1_authpub(rctx, authpub, authpublen)", (OSSL_HPKE_CTX_set1_authpub(rctx, authpub, authpublen)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1859, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1859 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1859 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1861, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1861 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1861 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                     )
        goto end;
    erv = 1;
...
static int test_hpke_noncereuse(void)
{
    int erv = 0;
    EVP_PKEY *privp = 
# 1880 "../test/hpke_test.c" 3 4
                     ((void *)0)
# 1880 "../test/hpke_test.c"
                         ;
    unsigned char pub[512];
    size_t publen = sizeof(pub);
    int hpke_mode = 0;
    OSSL_HPKE_SUITE hpke_suite = { 0x0020, 0x0001, 0x0001 };
    OSSL_HPKE_CTX *ctx = 
# 1885 "../test/hpke_test.c" 3 4
                        ((void *)0)
# 1885 "../test/hpke_test.c"
                            ;
    OSSL_HPKE_CTX *rctx = 
# 1886 "../test/hpke_test.c" 3 4
                         ((void *)0)
# 1886 "../test/hpke_test.c"
                             ;
    unsigned char plain[] = "quick brown fox";
    size_t plainlen = sizeof(plain);
    unsigned char enc[512];
    ...
    if (!test_true("../test/hpke_test.c", 1898, "OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, NULL, 0, testctx, NULL)", (OSSL_HPKE_keygen(hpke_suite, pub, &publen, &privp, 
# 1898 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1898 "../test/hpke_test.c"
        , 0, testctx, 
# 1898 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1898 "../test/hpke_test.c"
        ...
        goto end;
    if (!test_ptr("../test/hpke_test.c", 1901, "ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_SENDER, testctx, NULL)", ctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 0, testctx, 
# 1901 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1901 "../test/hpke_test.c"
        ))

                                                         )
        goto end;

    if (!test_false("../test/hpke_test.c", 1906, "OSSL_HPKE_CTX_set_seq(ctx, seq)", (OSSL_HPKE_CTX_set_seq(ctx, seq)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1908, "OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, NULL, 0)", (OSSL_HPKE_encap(ctx, enc, &enclen, pub, publen, 
# 1908 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1908 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1911, "OSSL_HPKE_CTX_set_seq(ctx, seq + 1)", (OSSL_HPKE_CTX_set_seq(ctx, seq + 1)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1913, "OSSL_HPKE_seal(ctx, cipher, &cipherlen, NULL, 0, plain, plainlen)", (OSSL_HPKE_seal(ctx, cipher, &cipherlen, 
# 1913 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1913 "../test/hpke_test.c"
        , 0, plain, plainlen)) != 0)
                                                   )
        goto end;


    if (!test_ptr("../test/hpke_test.c", 1918, "rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, OSSL_HPKE_ROLE_RECEIVER, testctx, NULL)", rctx = OSSL_HPKE_CTX_new(hpke_mode, hpke_suite, 1, testctx, 
# 1918 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1918 "../test/hpke_test.c"
        ))

                                                          )
        goto end;

    if (!test_true("../test/hpke_test.c", 1923, "OSSL_HPKE_CTX_set_seq(rctx, seq)", (OSSL_HPKE_CTX_set_seq(rctx, seq)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1925, "OSSL_HPKE_decap(rctx, enc, enclen, privp, NULL, 0)", (OSSL_HPKE_decap(rctx, enc, enclen, privp, 
# 1925 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1925 "../test/hpke_test.c"
        , 0)) != 0))
        goto end;

    if (!test_true("../test/hpke_test.c", 1928, "OSSL_HPKE_CTX_set_seq(rctx, seq)", (OSSL_HPKE_CTX_set_seq(rctx, seq)) != 0))
        goto end;

    if (!test_false("../test/hpke_test.c", 1931, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1931 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1931 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                      )
        goto end;

    if (!test_true("../test/hpke_test.c", 1935, "OSSL_HPKE_CTX_set_seq(rctx, 0)", (OSSL_HPKE_CTX_set_seq(rctx, 0)) != 0))
        goto end;
    if (!test_true("../test/hpke_test.c", 1937, "OSSL_HPKE_open(rctx, clear, &clearlen, NULL, 0, cipher, cipherlen)", (OSSL_HPKE_open(rctx, clear, &clearlen, 
# 1937 "../test/hpke_test.c" 3 4
        ((void *)0)
# 1937 "../test/hpke_test.c"
        , 0, cipher, cipherlen)) != 0)
                                                     )
        goto end;
    erv = 1;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 1962 "../test/hpke_test.c" 3 4
         ((void *)0) 
# 1962 "../test/hpke_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    ...
    if (!test_get_libctx(&testctx, &nullprov, 
# 1983 "../test/hpke_test.c" 3 4
                                             ((void *)0)
# 1983 "../test/hpke_test.c"
                                                 , &deflprov, "default"))
        return 0;
    ...
    add_test("test_hpke_noncereuse", test_hpke_noncereuse);
    return 1;
}
