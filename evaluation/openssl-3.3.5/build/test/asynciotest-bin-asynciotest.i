# 0 "../test/asynciotest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asynciotest.c"
# 11 "../test/asynciotest.c"
...
# 20 "../test/asynciotest.c" 2


static int fragment = 0;

static char *cert = 
# 24 "../test/asynciotest.c" 3 4
                   ((void *)0)
# 24 "../test/asynciotest.c"
                       ;
static char *privkey = 
# 25 "../test/asynciotest.c" 3 4
                      ((void *)0)
# 25 "../test/asynciotest.c"
                          ;
...
static BIO_METHOD *methods_async = 
# 38 "../test/asynciotest.c" 3 4
                                  ((void *)0)
# 38 "../test/asynciotest.c"
                                      ;
...
{
    if (methods_async == 
# 47 "../test/asynciotest.c" 3 4
                        ((void *)0)
# 47 "../test/asynciotest.c"
                            ) {
        methods_async = BIO_meth_new((0x80 | 0x0200), "Async filter");
        if ( methods_async == 
# 49 "../test/asynciotest.c" 3 4
                               ((void *)0)
            
# 50 "../test/asynciotest.c"
           || !BIO_meth_set_write(methods_async, async_write)
            ...
            return 
# 57 "../test/asynciotest.c" 3 4
                  ((void *)0)
# 57 "../test/asynciotest.c"
                      ;
    }
...
static int async_new(BIO *bio)
{
    ...
    ctrs = CRYPTO_zalloc(sizeof(struct async_ctrs), "../test/asynciotest.c", 66);
    if (ctrs == 
# 67 "../test/asynciotest.c" 3 4
               ((void *)0)
# 67 "../test/asynciotest.c"
                   )
        return 0;
...
static int async_free(BIO *bio)
{
    ...
    if (bio == 
# 79 "../test/asynciotest.c" 3 4
              ((void *)0)
# 79 "../test/asynciotest.c"
                  )
        return 0;
    ctrs = BIO_get_data(bio);
    CRYPTO_free(ctrs, "../test/asynciotest.c", 82);
    BIO_set_data(bio, 
# 83 "../test/asynciotest.c" 3 4
                     ((void *)0)
# 83 "../test/asynciotest.c"
                         );
    BIO_set_init(bio, 0);
...
static int async_read(BIO *bio, char *out, int outl)
{
    ...
    if (outl <= 0)
        return 0;
    if (next == 
# 97 "../test/asynciotest.c" 3 4
               ((void *)0)
# 97 "../test/asynciotest.c"
                   )
        return 0;
...
static int async_write(BIO *bio, const char *in, int inl)
{
    ...
    if (inl <= 0)
        return 0;
    if (next == 
# 133 "../test/asynciotest.c" 3 4
               ((void *)0)
# 133 "../test/asynciotest.c"
                   )
        return 0;
        ...
        if (fragment) {
            ...
            while (PACKET_remaining(&pkt) > 0) {
                ...
                while (PACKET_get_1(&payload, &data)) {
                    ...
                    smallrec[0] = contenttype;
                    smallrec[1] = versionhi;
                    smallrec[2] = versionlo;
                    smallrec[5] = data;
                    ret = BIO_write(next, smallrec, 6);
                    if (ret <= 0)
                        return -1;
                    written++;
                }
...
static long async_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (next == 
# 262 "../test/asynciotest.c" 3 4
               ((void *)0)
# 262 "../test/asynciotest.c"
                   )
        return 0;
...
{
    SSL_CTX *serverctx = 
# 291 "../test/asynciotest.c" 3 4
                        ((void *)0)
# 291 "../test/asynciotest.c"
                            , *clientctx = 
# 291 "../test/asynciotest.c" 3 4
                                           ((void *)0)
# 291 "../test/asynciotest.c"
                                               ;
    SSL *serverssl = 
# 292 "../test/asynciotest.c" 3 4
                    ((void *)0)
# 292 "../test/asynciotest.c"
                        , *clientssl = 
# 292 "../test/asynciotest.c" 3 4
                                       ((void *)0)
# 292 "../test/asynciotest.c"
                                           ;
    BIO *s_to_c_fbio = 
# 293 "../test/asynciotest.c" 3 4
                      ((void *)0)
# 293 "../test/asynciotest.c"
                          , *c_to_s_fbio = 
# 293 "../test/asynciotest.c" 3 4
                                           ((void *)0)
# 293 "../test/asynciotest.c"
    ...
    if (!test_true("../test/asynciotest.c", 299, "create_ssl_ctx_pair(NULL, TLS_server_method(), TLS_client_method(), TLS1_VERSION, 0, &serverctx, &clientctx, cert, privkey)", (create_ssl_ctx_pair(
# 299 "../test/asynciotest.c" 3 4
        ((void *)0)
# 299 "../test/asynciotest.c"
        , TLS_server_method(), TLS_client_method(), 0x0301, 0, &serverctx, &clientctx, cert, privkey)) != 0)
    ...
    if (!test_ptr("../test/asynciotest.c", 317, "s_to_c_fbio", s_to_c_fbio)
            || !test_ptr("../test/asynciotest.c", 318, "c_to_s_fbio", c_to_s_fbio)) {
    ...
    if (!test_true("../test/asynciotest.c", 325, "create_ssl_objects(serverctx, clientctx, &serverssl, &clientssl, s_to_c_fbio, c_to_s_fbio)", (create_ssl_objects(serverctx, clientctx, &serverssl, &clientssl, s_to_c_fbio, c_to_s_fbio)) != 0)

            || !test_true("../test/asynciotest.c", 327, "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)", (create_ssl_connection(serverssl, clientssl, 0)) != 0)
                                          )
        goto end;
    ...
    for (j = 0; j < 2; j++) {
        ...
        for (ret = -1, i = 0, len = 0; len != sizeof(testdata) && i < 2;
            ...
            if (ret > 0) {
                ...
                if (!test_false("../test/asynciotest.c", 351, "ssl_error == SSL_ERROR_SYSCALL || ssl_error == SSL_ERROR_SSL", (ssl_error == 5 || ssl_error == 1) != 0)
                                                           )
                    goto end;
            }
        }
        if (!test_size_t_eq("../test/asynciotest.c", 356, "len", "sizeof(testdata)", len, sizeof(testdata)))
            goto end;
        ...
        for (ret = -1, i = 0, len = 0; len != sizeof(testdata) &&
            ...
            if (ret > 0) {
                ...
                if (!test_false("../test/asynciotest.c", 372, "ssl_error == SSL_ERROR_SYSCALL || ssl_error == SSL_ERROR_SSL", (ssl_error == 5 || ssl_error == 1) != 0)
                                                           )
                    goto end;
            }
        }
        if (!test_mem_eq("../test/asynciotest.c", 377, "testdata", "buf", testdata, sizeof(testdata), buf, len))
            goto end;
    }
    ...
    SSL_free(serverssl);
    clientssl = serverssl = 
# 384 "../test/asynciotest.c" 3 4
                           ((void *)0)
# 384 "../test/asynciotest.c"
                               ;
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "certname privkey\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 397 "../test/asynciotest.c" 3 4
((void *)0) 
# 397 "../test/asynciotest.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/asynciotest.c", 402, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/asynciotest.c", 406, "cert = test_get_argument(0)", cert = test_get_argument(0))
            || !test_ptr("../test/asynciotest.c", 407, "privkey = test_get_argument(1)", privkey = test_get_argument(1)))
        return 0;
