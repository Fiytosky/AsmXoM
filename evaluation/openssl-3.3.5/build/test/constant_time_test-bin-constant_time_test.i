# 0 "../test/constant_time_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/constant_time_test.c"
# 10 "../test/constant_time_test.c"
...
# 11 "../test/constant_time_test.c" 2
...
# 12 "../test/constant_time_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 14 "../test/constant_time_test.c" 2
...
# 15 "../test/constant_time_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 16 "../test/constant_time_test.c" 2
...
static unsigned int test_values[] = {
    0, 1, 1024, 12345, 32000, 
# 30 "../test/constant_time_test.c" 3 4
                             (0x7fffffff * 2U + 1U) 
# 30 "../test/constant_time_test.c"
                                      / 2 - 1,
    
# 31 "../test/constant_time_test.c" 3 4
   (0x7fffffff * 2U + 1U) 
# 31 "../test/constant_time_test.c"
            / 2, 
# 31 "../test/constant_time_test.c" 3 4
                 (0x7fffffff * 2U + 1U) 
# 31 "../test/constant_time_test.c"
...
# 32 "../test/constant_time_test.c" 3 4
   (0x7fffffff * 2U + 1U)
...
static int signed_test_values[] = {
    ...
    32000, -32000, 0x7fffffff
# 41 "../test/constant_time_test.c"
                         , 
# 41 "../test/constant_time_test.c" 3 4
                           (-0x7fffffff - 1)
# 41 "../test/constant_time_test.c"
                                  , 0x7fffffff 
# 41 "../test/constant_time_test.c"
...
# 42 "../test/constant_time_test.c" 3 4
   (-0x7fffffff - 1) 
# 42 "../test/constant_time_test.c"
           + 1
};

static size_t test_values_s[] = {
    0, 1, 1024, 12345, 32000, 
# 46 "../test/constant_time_test.c" 3 4
                             (18446744073709551615UL) 
# 46 "../test/constant_time_test.c"
                                      / 2 - 1,
    
# 47 "../test/constant_time_test.c" 3 4
   (18446744073709551615UL) 
# 47 "../test/constant_time_test.c"
            / 2, 
# 47 "../test/constant_time_test.c" 3 4
                 (18446744073709551615UL) 
# 47 "../test/constant_time_test.c"
...
# 48 "../test/constant_time_test.c" 3 4
   (18446744073709551615UL)

# 49 "../test/constant_time_test.c"
};

static uint32_t test_values_32[] = {
    0, 1, 1024, 12345, 32000, 
# 52 "../test/constant_time_test.c" 3 4
                             (4294967295U) 
# 52 "../test/constant_time_test.c"
                                        / 2, 
# 52 "../test/constant_time_test.c" 3 4
                                             (4294967295U) 
# 52 "../test/constant_time_test.c"
...
# 53 "../test/constant_time_test.c" 3 4
   (4294967295U) 
# 53 "../test/constant_time_test.c"
              - 1, 
# 53 "../test/constant_time_test.c" 3 4
                   (4294967295U)

# 54 "../test/constant_time_test.c"
};

static uint64_t test_values_64[] = {
    0, 1, 1024, 12345, 32000, 32000000, 32000000001, 
# 57 "../test/constant_time_test.c" 3 4
                                                    (18446744073709551615UL) 
# 57 "../test/constant_time_test.c"
                                                               / 2,
    
# 58 "../test/constant_time_test.c" 3 4
   (18446744073709551615UL) 
# 58 "../test/constant_time_test.c"
              / 2 + 1, 
# 58 "../test/constant_time_test.c" 3 4
                       (18446744073709551615UL) 
# 58 "../test/constant_time_test.c"
...
static int test_binary_op(unsigned int (*op) (unsigned int a, unsigned int b),
                          ...
                          int is_true)
{
    if (is_true && !test_uint_eq("../test/constant_time_test.c", 65, "op(a, b)", "CONSTTIME_TRUE", op(a, b), CONSTTIME_TRUE))
        return 0;
    if (!is_true && !test_uint_eq("../test/constant_time_test.c", 67, "op(a, b)", "CONSTTIME_FALSE", op(a, b), CONSTTIME_FALSE))
        return 0;
    return 1;
}
...
{
    if (is_true && !test_uint_eq("../test/constant_time_test.c", 77, "op(a, b)", "CONSTTIME_TRUE_8", op(a, b), CONSTTIME_TRUE_8))
        return 0;
    if (!is_true && !test_uint_eq("../test/constant_time_test.c", 79, "op(a, b)", "CONSTTIME_FALSE_8", op(a, b), CONSTTIME_FALSE_8))
        return 0;
    return 1;
}
...
static int test_binary_op_s(size_t (*op) (size_t a, size_t b),
                            ...
                            int is_true)
{
    if (is_true && !test_size_t_eq("../test/constant_time_test.c", 88, "op(a, b)", "CONSTTIME_TRUE_S", op(a, b), CONSTTIME_TRUE_S))
        return 0;
    if (!is_true && !test_uint_eq("../test/constant_time_test.c", 90, "op(a, b)", "CONSTTIME_FALSE_S", op(a, b), CONSTTIME_FALSE_S))
        return 0;
    return 1;
}
                             ...
                             int is_true)
{
    ...
    if (is_true && c != CONSTTIME_TRUE_64) {
        test_error("../test/constant_time_test.c", 102, "TRUE %s op failed", op_name);
        BIO_printf(bio_err, "a=%jx b=%jx\n", a, b);
        return 0;
    } else if (!is_true && c != CONSTTIME_FALSE_64) {
        test_error("../test/constant_time_test.c", 106, "FALSE %s op failed", op_name);
        BIO_printf(bio_err, "a=%jx b=%jx\n", a, b);
        return 0;
    }
    return 1;
...
static int test_is_zero(int i)
{
    ...
    if (a == 0 && !test_uint_eq("../test/constant_time_test.c", 117, "constant_time_is_zero(a)", "CONSTTIME_TRUE", constant_time_is_zero(a), CONSTTIME_TRUE))
        return 0;
    if (a != 0 && !test_uint_eq("../test/constant_time_test.c", 119, "constant_time_is_zero(a)", "CONSTTIME_FALSE", constant_time_is_zero(a), CONSTTIME_FALSE))
        return 0;
    return 1;
}
...
static int test_is_zero_8(int i)
{
    ...
    if (a == 0 && !test_uint_eq("../test/constant_time_test.c", 128, "constant_time_is_zero_8(a)", "CONSTTIME_TRUE_8", constant_time_is_zero_8(a), CONSTTIME_TRUE_8))
        return 0;
    if (a != 0 && !test_uint_eq("../test/constant_time_test.c", 130, "constant_time_is_zero_8(a)", "CONSTTIME_FALSE_8", constant_time_is_zero_8(a), CONSTTIME_FALSE_8))
        return 0;
    return 1;
}
...
static int test_is_zero_32(int i)
{
    ...
    if (a == 0 && !test_true("../test/constant_time_test.c", 139, "constant_time_is_zero_32(a) == CONSTTIME_TRUE_32", (constant_time_is_zero_32(a) == CONSTTIME_TRUE_32) != 0))
        return 0;
    if (a != 0 && !test_true("../test/constant_time_test.c", 141, "constant_time_is_zero_32(a) == CONSTTIME_FALSE_32", (constant_time_is_zero_32(a) == CONSTTIME_FALSE_32) != 0))
        return 0;
    return 1;
}
...
static int test_is_zero_s(int i)
{
    ...
    if (a == 0 && !test_size_t_eq("../test/constant_time_test.c", 150, "constant_time_is_zero_s(a)", "CONSTTIME_TRUE_S", constant_time_is_zero_s(a), CONSTTIME_TRUE_S))
        return 0;
    if (a != 0 && !test_uint_eq("../test/constant_time_test.c", 152, "constant_time_is_zero_s(a)", "CONSTTIME_FALSE_S", constant_time_is_zero_s(a), CONSTTIME_FALSE_S))
        return 0;
    return 1;
}
...
{
    if (!test_uint_eq("../test/constant_time_test.c", 159, "constant_time_select(CONSTTIME_TRUE, a, b)", "a", constant_time_select(CONSTTIME_TRUE, a, b), a))
        return 0;
    if (!test_uint_eq("../test/constant_time_test.c", 161, "constant_time_select(CONSTTIME_FALSE, a, b)", "b", constant_time_select(CONSTTIME_FALSE, a, b), b))
        return 0;
    return 1;
}
...
{
    if (!test_uint_eq("../test/constant_time_test.c", 168, "constant_time_select_8(CONSTTIME_TRUE_8, a, b)", "a", constant_time_select_8(CONSTTIME_TRUE_8, a, b), a))
        return 0;
    if (!test_uint_eq("../test/constant_time_test.c", 170, "constant_time_select_8(CONSTTIME_FALSE_8, a, b)", "b", constant_time_select_8(CONSTTIME_FALSE_8, a, b), b))
        return 0;
    return 1;
}
...
{
    if (!test_true("../test/constant_time_test.c", 177, "constant_time_select_32(CONSTTIME_TRUE_32, a, b) == a", (constant_time_select_32(CONSTTIME_TRUE_32, a, b) == a) != 0))
        return 0;
    if (!test_true("../test/constant_time_test.c", 179, "constant_time_select_32(CONSTTIME_FALSE_32, a, b) == b", (constant_time_select_32(CONSTTIME_FALSE_32, a, b) == b) != 0))
        return 0;
    return 1;
}
...
{
    if (!test_uint_eq("../test/constant_time_test.c", 186, "constant_time_select_s(CONSTTIME_TRUE_S, a, b)", "a", constant_time_select_s(CONSTTIME_TRUE_S, a, b), a))
        return 0;
    if (!test_uint_eq("../test/constant_time_test.c", 188, "constant_time_select_s(CONSTTIME_FALSE_S, a, b)", "b", constant_time_select_s(CONSTTIME_FALSE_S, a, b), b))
        return 0;
    return 1;
}
...
static int test_select_64(uint64_t a, uint64_t b)
{
    ...
    if (selected != a) {
        test_error("../test/constant_time_test.c", 198, "test_select_64 TRUE failed");
...
{
    if (!test_int_eq("../test/constant_time_test.c", 212, "constant_time_select_int(CONSTTIME_TRUE, a, b)", "a", constant_time_select_int(CONSTTIME_TRUE, a, b), a))
        return 0;
    if (!test_int_eq("../test/constant_time_test.c", 214, "constant_time_select_int(CONSTTIME_FALSE, a, b)", "b", constant_time_select_int(CONSTTIME_FALSE, a, b), b))
        return 0;
    return 1;
}
...
{
    if (a == b && !test_int_eq("../test/constant_time_test.c", 221, "constant_time_eq_int_8(a, b)", "CONSTTIME_TRUE_8", constant_time_eq_int_8(a, b), CONSTTIME_TRUE_8))
        return 0;
    if (a != b && !test_int_eq("../test/constant_time_test.c", 223, "constant_time_eq_int_8(a, b)", "CONSTTIME_FALSE_8", constant_time_eq_int_8(a, b), CONSTTIME_FALSE_8))
        return 0;
    return 1;
}
...
{
    if (a == b && !test_size_t_eq("../test/constant_time_test.c", 230, "constant_time_eq_s(a, b)", "CONSTTIME_TRUE_S", constant_time_eq_s(a, b), CONSTTIME_TRUE_S))
        return 0;
    if (a != b && !test_int_eq("../test/constant_time_test.c", 232, "constant_time_eq_s(a, b)", "CONSTTIME_FALSE_S", constant_time_eq_s(a, b), CONSTTIME_FALSE_S))
        return 0;
    return 1;
}
...
{
    if (a == b && !test_uint_eq("../test/constant_time_test.c", 239, "constant_time_eq_int(a, b)", "CONSTTIME_TRUE", constant_time_eq_int(a, b), CONSTTIME_TRUE))
        return 0;
    if (a != b && !test_uint_eq("../test/constant_time_test.c", 241, "constant_time_eq_int(a, b)", "CONSTTIME_FALSE", constant_time_eq_int(a, b), CONSTTIME_FALSE))
        return 0;
    return 1;
}
...
{
    if (!test_uint_eq("../test/constant_time_test.c", 248, "OSSL_NELEM(test_values)", "OSSL_NELEM(test_values_s)", (sizeof(test_values)/sizeof((test_values)[0])), (sizeof(test_values_s)/sizeof((test_values_s)[0]))))
        return 0;
    return 1;
}
...
static int test_binops(int i)
{
    ...
    for (j = 0; j < (int)(sizeof(test_values)/sizeof((test_values)[0])); ++j) {
...
static int test_binops_8(int i)
{
    ...
    for (j = 0; j < (int)(sizeof(test_values_8)/sizeof((test_values_8)[0])); ++j) {
...
static int test_binops_s(int i)
{
    ...
    for (j = 0; j < (int)(sizeof(test_values_s)/sizeof((test_values_s)[0])); ++j) {
...
static int test_signed(int i)
{
    ...
    for (j = 0; j < (sizeof(signed_test_values)/sizeof((signed_test_values)[0])); ++j) {
...
static int test_32values(int i)
{
    ...
    for (j = 0; j < (sizeof(test_values_32)/sizeof((test_values_32)[0])); j++) {
...
static int test_64values(int i)
{
    ...
    for (j = i + 1; j < (int)(sizeof(test_values_64)/sizeof((test_values_64)[0])); j++) {
        uint64_t h = test_values_64[j];

        if (!test_binary_op_64(&constant_time_lt_64, "constant_time_lt_64",
                               g, h, g < h)
                || !test_select_64(g, h)) {
            test_info("../test/constant_time_test.c", 392, "test_64values failed i=%d j=%d", i, j);
            ret = 0;
        }
    }
    return ret;
...
int setup_tests(void)
{
    ...
    add_all_tests("test_is_zero", test_is_zero, (sizeof(test_values)/sizeof((test_values)[0])), 1);
    add_all_tests("test_is_zero_8", test_is_zero_8, (sizeof(test_values_8)/sizeof((test_values_8)[0])), 1);
    add_all_tests("test_is_zero_32", test_is_zero_32, (sizeof(test_values_32)/sizeof((test_values_32)[0])), 1);
    add_all_tests("test_is_zero_s", test_is_zero_s, (sizeof(test_values_s)/sizeof((test_values_s)[0])), 1);
    add_all_tests("test_binops", test_binops, (sizeof(test_values)/sizeof((test_values)[0])), 1);
    add_all_tests("test_binops_8", test_binops_8, (sizeof(test_values_8)/sizeof((test_values_8)[0])), 1);
    add_all_tests("test_binops_s", test_binops_s, (sizeof(test_values_s)/sizeof((test_values_s)[0])), 1);
    add_all_tests("test_signed", test_signed, (sizeof(signed_test_values)/sizeof((signed_test_values)[0])), 1);
    add_all_tests("test_8values", test_8values, (sizeof(test_values_8)/sizeof((test_values_8)[0])), 1);
    add_all_tests("test_32values", test_32values, (sizeof(test_values_32)/sizeof((test_values_32)[0])), 1);
    add_all_tests("test_64values", test_64values, (sizeof(test_values_64)/sizeof((test_values_64)[0])), 1);
    return 1;
}
