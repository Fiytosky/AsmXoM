# 0 "../test/ssl_handshake_rtt_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ssl_handshake_rtt_test.c"
# 18 "../test/ssl_handshake_rtt_test.c"
...
# 19 "../test/ssl_handshake_rtt_test.c" 2
...
# 20 "../test/ssl_handshake_rtt_test.c" 2
...
# 22 "../test/ssl_handshake_rtt_test.c" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 23 "../test/ssl_handshake_rtt_test.c" 2
...
# 25 "../test/ssl_handshake_rtt_test.c" 2
...
# 26 "../test/ssl_handshake_rtt_test.c" 2
...
# 28 "../test/ssl_handshake_rtt_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 29 "../test/ssl_handshake_rtt_test.c" 2
...
int test_printf_taperr(const char *fmt, ...)
    __attribute__((__format__(__gnu_printf__, 1, 2)));
# 30 "../test/ssl_handshake_rtt_test.c" 2
# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 31 "../test/ssl_handshake_rtt_test.c" 2
...
# 32 "../test/ssl_handshake_rtt_test.c" 2
# 1 "../test/../ssl/statem/statem_local.h" 1
# 46 "../test/../ssl/statem/statem_local.h"
...
const struct stack_st_X509_NAME *get_ca_names(SSL_CONNECTION *s);
int construct_ca_names(SSL_CONNECTION *s, const struct stack_st_X509_NAME *ca_sk,
                       WPACKET *pkt);
...
WORK_STATE ossl_statem_server_post_process_message(SSL_CONNECTION *s,
 ...
 MSG_PROCESS_RETURN tls_process_key_update(SSL_CONNECTION *s,
                                                 PACKET *pkt);
 WORK_STATE tls_finish_handshake(SSL_CONNECTION *s, WORK_STATE wst,
                                       int clearbufs, int stop);
 WORK_STATE dtls_wait_for_dry(SSL_CONNECTION *s);
# 143 "../test/../ssl/statem/statem_local.h"
 CON_FUNC_RETURN tls_construct_client_hello(SSL_CONNECTION *s,
                                                  WPACKET *pkt);
 MSG_PROCESS_RETURN tls_process_server_hello(SSL_CONNECTION *s,
                                                   PACKET *pkt);
 ...
 MSG_PROCESS_RETURN tls_process_cert_status(SSL_CONNECTION *s,
                                                  PACKET *pkt);
 MSG_PROCESS_RETURN tls_process_server_done(SSL_CONNECTION *s,
                                                  PACKET *pkt);
 CON_FUNC_RETURN tls_construct_cert_verify(SSL_CONNECTION *s,
                                                 WPACKET *pkt);
 WORK_STATE tls_prepare_client_certificate(SSL_CONNECTION *s,
                                                 WORK_STATE wst);
 ...
 int ssl_do_client_cert_cb(SSL_CONNECTION *s, X509 **px509,
                                 EVP_PKEY **ppkey);
 ...
 CON_FUNC_RETURN tls_construct_cert_status(SSL_CONNECTION *s,
                                                 WPACKET *pkt);
 MSG_PROCESS_RETURN tls_process_key_exchange(SSL_CONNECTION *s,
                                                   PACKET *pkt);
 MSG_PROCESS_RETURN tls_process_server_rpk(SSL_CONNECTION *sc,
                                                 PACKET *pkt);
 MSG_PROCESS_RETURN tls_process_client_rpk(SSL_CONNECTION *sc,
                                                 PACKET *pkt);
 unsigned long tls_output_rpk(SSL_CONNECTION *sc, WPACKET *pkt,
                                    CERT_PKEY *cpk);
 int tls_process_rpk(SSL_CONNECTION *s, PACKET *pkt, EVP_PKEY **peer_rpk);
 ...
 MSG_PROCESS_RETURN tls_process_client_hello(SSL_CONNECTION *s,
                                                   PACKET *pkt);
 WORK_STATE tls_post_process_client_hello(SSL_CONNECTION *s,
                                                WORK_STATE wst);
 CON_FUNC_RETURN tls_construct_server_hello(SSL_CONNECTION *s,
                                                  WPACKET *pkt);
 ...
 CON_FUNC_RETURN tls_construct_certificate_request(SSL_CONNECTION *s,
                                                         WPACKET *pkt);
 CON_FUNC_RETURN tls_construct_server_done(SSL_CONNECTION *s,
                                                 WPACKET *pkt);
 ...
 WORK_STATE tls_post_process_client_key_exchange(SSL_CONNECTION *s,
                                                       WORK_STATE wst);
 MSG_PROCESS_RETURN tls_process_cert_verify(SSL_CONNECTION *s,
                                                  PACKET *pkt);

 MSG_PROCESS_RETURN tls_process_next_proto(SSL_CONNECTION *s,
                                                 PACKET *pkt);
...
int tls_parse_stoc_server_cert_type(SSL_CONNECTION *s, PACKET *pkt,
                                    unsigned int context,
                                    X509 *x, size_t chainidx);
# 33 "../test/ssl_handshake_rtt_test.c" 2

static OSSL_LIB_CTX *libctx = 
# 34 "../test/ssl_handshake_rtt_test.c" 3 4
                             ((void *)0)
# 34 "../test/ssl_handshake_rtt_test.c"
                                 ;
static char *cert = 
# 35 "../test/ssl_handshake_rtt_test.c" 3 4
                   ((void *)0)
# 35 "../test/ssl_handshake_rtt_test.c"
                       ;
static char *privkey = 
# 36 "../test/ssl_handshake_rtt_test.c" 3 4
                      ((void *)0)
# 36 "../test/ssl_handshake_rtt_test.c"
                          ;
# 45 "../test/ssl_handshake_rtt_test.c"
static int test_handshake_rtt(int tst)
{
    SSL_CTX *cctx = 
# 47 "../test/ssl_handshake_rtt_test.c" 3 4
                   ((void *)0)
# 47 "../test/ssl_handshake_rtt_test.c"
                       , *sctx = 
# 47 "../test/ssl_handshake_rtt_test.c" 3 4
                                 ((void *)0)
# 47 "../test/ssl_handshake_rtt_test.c"
                                     ;
    SSL *clientssl = 
# 48 "../test/ssl_handshake_rtt_test.c" 3 4
                    ((void *)0)
# 48 "../test/ssl_handshake_rtt_test.c"
                        , *serverssl = 
# 48 "../test/ssl_handshake_rtt_test.c" 3 4
                                       ((void *)0)
# 48 "../test/ssl_handshake_rtt_test.c"
    ...
    int testresult = 0;
    SSL_CONNECTION *s = 
# 50 "../test/ssl_handshake_rtt_test.c" 3 4
                       ((void *)0)
# 50 "../test/ssl_handshake_rtt_test.c"
                           ;
    OSSL_STATEM *st = 
# 51 "../test/ssl_handshake_rtt_test.c" 3 4
                     ((void *)0)
# 51 "../test/ssl_handshake_rtt_test.c"
                         ;
    uint64_t rtt;
# 63 "../test/ssl_handshake_rtt_test.c"
    if (!test_true("../test/ssl_handshake_rtt_test.c", 63, "create_ssl_ctx_pair(libctx, TLS_server_method(), TLS_client_method(), TLS1_VERSION, (tst <= 1) ? TLS1_2_VERSION : TLS1_3_VERSION, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(libctx, TLS_server_method(), TLS_client_method(), 0x0301, (tst <= 1) ? 0x0303 : 0x0304, &sctx, &cctx, cert, privkey)) != 0)





            || !test_true("../test/ssl_handshake_rtt_test.c", 69, "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &serverssl, &clientssl, 
# 69 "../test/ssl_handshake_rtt_test.c" 3 4
               ((void *)0)
# 69 "../test/ssl_handshake_rtt_test.c"
               , 
# 69 "../test/ssl_handshake_rtt_test.c" 3 4
               ((void *)0)
# 69 "../test/ssl_handshake_rtt_test.c"
...
# 73 "../test/ssl_handshake_rtt_test.c" 3 4
       ((void *)0) 
# 73 "../test/ssl_handshake_rtt_test.c"
       ? 
# 73 "../test/ssl_handshake_rtt_test.c" 3 4
       ((void *)0) 
# 73 "../test/ssl_handshake_rtt_test.c"
       : ((tst % 2 == 0 ? clientssl : serverssl)->type == 0 ? ( SSL_CONNECTION *)(tst % 2 == 0 ? clientssl : serverssl) : ((tst % 2 == 0 ? clientssl : serverssl)->type == 1 ? ( SSL_CONNECTION *)(( QUIC_CONNECTION *)(tst % 2 == 0 ? clientssl : serverssl))->tls : 
# 73 "../test/ssl_handshake_rtt_test.c" 3 4
       ((void *)0)
# 73 "../test/ssl_handshake_rtt_test.c"
       )));
    if (!test_ptr("../test/ssl_handshake_rtt_test.c", 74, "s", s) || !test_ptr("../test/ssl_handshake_rtt_test.c", 74, "st = &s->statem", st = &s->statem))
        return 0;
    ...
    if (!test_int_gt("../test/ssl_handshake_rtt_test.c", 116, "SSL_get_handshake_rtt(SSL_CONNECTION_GET_SSL(s), &rtt)", "0", SSL_get_handshake_rtt((&(s)->ssl), &rtt), 0))
        goto end;

    if (!test_uint64_t_ge("../test/ssl_handshake_rtt_test.c", 119, "rtt", "1000", rtt, 1000))
        goto end;
...
int setup_tests(void)
{
    add_all_tests("test_handshake_rtt", test_handshake_rtt, 5, 1);
