...
# 18 "../test/ideatest.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 20 "../test/ideatest.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
static const unsigned char plain[24] = {
...
static const unsigned char cfb_cipher64[24] = {
...
static int test_idea_ecb(void)
{
    ...
    if (!test_mem_eq("../test/ideatest.c", 67, "out", "c", out, 8, c, sizeof(c)))
        return 0;

    IDEA_set_decrypt_key(&key, &dkey);
    IDEA_ecb_encrypt(c, out, &dkey);
    return test_mem_eq("../test/ideatest.c", 72, "out", "in", out, 8, in, sizeof(in));
}
...
static int test_idea_cbc(void)
{
    ...
    return test_mem_eq("../test/ideatest.c", 88, "text", "out", text, text_len, out, text_len);
}
...
static int test_idea_cfb64(void)
{
    ...
    IDEA_cfb64_encrypt(&plain[12], &cfb_buf1[12],
                       (long)24 - 12, &eks,
                       cfb_tmp, &n, 1);
    if (!test_mem_eq("../test/ideatest.c", 105, "cfb_cipher64", "cfb_buf1", cfb_cipher64, 24, cfb_buf1, 24))
        return 0;
    memcpy(cfb_tmp, cfb_iv, sizeof(cfb_tmp));
    n = 0;
    ...
    IDEA_cfb64_encrypt(&cfb_buf1[13], &cfb_buf2[13],
                       (long)24 - 13, &eks,
                       cfb_tmp, &n, 0);
    return test_mem_eq("../test/ideatest.c", 114, "plain", "cfb_buf2", plain, 24, cfb_buf2, 24);
}
...
int setup_tests(void)
{
    ...
    add_test("test_idea_cfb64", test_idea_cfb64);
