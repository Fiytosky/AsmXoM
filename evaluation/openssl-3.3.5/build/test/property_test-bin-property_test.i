# 0 "../test/property_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/property_test.c"
# 11 "../test/property_test.c"
...
# 16 "../test/property_test.c" 2
# 1 "../test/../crypto/property/property_local.h" 1
# 14 "../test/../crypto/property/property_local.h"
...
# 33 "../test/property_test.c" 3 4
   __builtin_c23_va_start(
# 33 "../test/property_test.c"
   args, n
# 33 "../test/property_test.c" 3 4
   )
# 33 "../test/property_test.c"
                    ;
    do {
        if (!test_int_ne("../test/property_test.c", 35, "ossl_property_name(NULL, n, 1)", "0", ossl_property_name(
# 35 "../test/property_test.c" 3 4
            ((void *)0)
# 35 "../test/property_test.c"
            , n, 1), 0))
            res = 0;
    } while ((n = 
# 37 "../test/property_test.c" 3 4
                 __builtin_va_arg(
# 37 "../test/property_test.c"
                 args
# 37 "../test/property_test.c" 3 4
                 ,
# 37 "../test/property_test.c"
...
# 38 "../test/property_test.c" 3 4
   __builtin_va_end(
# 38 "../test/property_test.c"
   args
# 38 "../test/property_test.c" 3 4
   )
# 38 "../test/property_test.c"
...
# 54 "../test/property_test.c" 3 4
                              ((void *)0)
# 54 "../test/property_test.c"
                                  ;
    int res = 0;
    ...
    if (test_ptr("../test/property_test.c", 62, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new())
        && test_ptr("../test/property_test.c", 63, "store = ossl_method_store_new(ctx)", store = ossl_method_store_new(ctx))
        && test_int_eq("../test/property_test.c", 64, "ossl_property_name(ctx, \"fnord\", 0)", "0", ossl_property_name(ctx, "fnord", 0), 0)
        && test_int_ne("../test/property_test.c", 65, "ossl_property_name(ctx, \"fnord\", 1)", "0", ossl_property_name(ctx, "fnord", 1), 0)
        && test_int_ne("../test/property_test.c", 66, "ossl_property_name(ctx, \"name\", 1)", "0", ossl_property_name(ctx, "name", 1), 0)

        && test_str_eq("../test/property_test.c", 68, "ossl_property_name_str(ctx, 1)", "\"provider\"", ossl_property_name_str(ctx, 1), "provider")
        && test_str_eq("../test/property_test.c", 69, "ossl_property_name_str(ctx, 2)", "\"version\"", ossl_property_name_str(ctx, 2), "version")
        && test_str_eq("../test/property_test.c", 70, "ossl_property_name_str(ctx, 3)", "\"fips\"", ossl_property_name_str(ctx, 3), "fips")
        && test_str_eq("../test/property_test.c", 71, "ossl_property_name_str(ctx, 4)", "\"output\"", ossl_property_name_str(ctx, 4), "output")
        && test_str_eq("../test/property_test.c", 72, "ossl_property_name_str(ctx, 5)", "\"input\"", ossl_property_name_str(ctx, 5), "input")
        && test_str_eq("../test/property_test.c", 73, "ossl_property_name_str(ctx, 6)", "\"structure\"", ossl_property_name_str(ctx, 6), "structure")

        && test_str_eq("../test/property_test.c", 75, "ossl_property_name_str(ctx, 7)", "\"fnord\"", ossl_property_name_str(ctx, 7), "fnord")
        && test_str_eq("../test/property_test.c", 76, "ossl_property_name_str(ctx, 8)", "\"name\"", ossl_property_name_str(ctx, 8), "name")

        && test_ptr_null("../test/property_test.c", 78, "ossl_property_name_str(ctx, 0)", ossl_property_name_str(ctx, 0))
        && test_ptr_null("../test/property_test.c", 79, "ossl_property_name_str(ctx, 9)", ossl_property_name_str(ctx, 9))

        && test_int_eq("../test/property_test.c", 81, "ossl_property_value(ctx, \"fnord\", 0)", "0", ossl_property_value(ctx, "fnord", 0), 0)
        && test_int_ne("../test/property_test.c", 82, "i = ossl_property_value(ctx, \"no\", 0)", "0", i = ossl_property_value(ctx, "no", 0), 0)
        && test_int_ne("../test/property_test.c", 83, "j = ossl_property_value(ctx, \"yes\", 0)", "0", j = ossl_property_value(ctx, "yes", 0), 0)
        && test_int_ne("../test/property_test.c", 84, "i", "j", i, j)
        && test_int_eq("../test/property_test.c", 85, "ossl_property_value(ctx, \"yes\", 1)", "j", ossl_property_value(ctx, "yes", 1), j)
        && test_int_eq("../test/property_test.c", 86, "ossl_property_value(ctx, \"no\", 1)", "i", ossl_property_value(ctx, "no", 1), i)
        && test_int_ne("../test/property_test.c", 87, "i = ossl_property_value(ctx, \"illuminati\", 1)", "0", i = ossl_property_value(ctx, "illuminati", 1), 0)
        && test_int_eq("../test/property_test.c", 88, "j = ossl_property_value(ctx, \"fnord\", 1)", "i + 1", j = ossl_property_value(ctx, "fnord", 1), i + 1)
        && test_int_eq("../test/property_test.c", 89, "ossl_property_value(ctx, \"fnord\", 1)", "j", ossl_property_value(ctx, "fnord", 1), j)

        && test_str_eq("../test/property_test.c", 91, "ossl_property_value_str(ctx, 1)", "\"yes\"", ossl_property_value_str(ctx, 1), "yes")
        && test_str_eq("../test/property_test.c", 92, "ossl_property_value_str(ctx, 2)", "\"no\"", ossl_property_value_str(ctx, 2), "no")

        && test_str_eq("../test/property_test.c", 94, "ossl_property_value_str(ctx, 3)", "\"illuminati\"", ossl_property_value_str(ctx, 3), "illuminati")
        && test_str_eq("../test/property_test.c", 95, "ossl_property_value_str(ctx, 4)", "\"fnord\"", ossl_property_value_str(ctx, 4), "fnord")

        && test_ptr_null("../test/property_test.c", 97, "ossl_property_value_str(ctx, 0)", ossl_property_value_str(ctx, 0))
        && test_ptr_null("../test/property_test.c", 98, "ossl_property_value_str(ctx, 5)", ossl_property_value_str(ctx, 5))

        && test_int_eq("../test/property_test.c", 100, "ossl_property_value(ctx, \"cold\", 0)", "0", ossl_property_value(ctx, "cold", 0), 0)
        && test_int_ne("../test/property_test.c", 101, "ossl_property_name(ctx, \"fnord\", 0)", "ossl_property_value(ctx, \"fnord\", 0)", ossl_property_name(ctx, "fnord", 0), ossl_property_value(ctx, "fnord", 0))
                                                            )
        res = 1;
...
static const struct {
    ...
    { "n=0x7fffffffffffffff", "n=0x7fffffffffffffff", 1 },
    { "n=9223372036854775807", "n=9223372036854775807", 1 },
    { "n=0777777777777777777777", "n=0777777777777777777777", 1 },
    { "n=033", "n=27", 1 },
    { "n=0", "n=00", 1 },
    { "n=0x0", "n=0", 1 },
...
# 153 "../test/property_test.c" 3 4
                           ((void *)0)
# 153 "../test/property_test.c"
                               , *q = 
# 153 "../test/property_test.c" 3 4
                                      ((void *)0)
# 153 "../test/property_test.c"
    ...
    if (test_ptr("../test/property_test.c", 156, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 156 "../test/property_test.c" 3 4
       ((void *)0)
# 156 "../test/property_test.c"
       ))
        && add_property_names("sky", "groan", "cold", "today", "tomorrow", "n",
                              
# 158 "../test/property_test.c" 3 4
                             ((void *)0)
# 158 "../test/property_test.c"
                                 )
        && test_ptr("../test/property_test.c", 159, "p = ossl_parse_property(NULL, parser_tests[n].defn)", p = ossl_parse_property(
# 159 "../test/property_test.c" 3 4
          ((void *)0)
# 159 "../test/property_test.c"
          , parser_tests[n].defn))
        && test_ptr("../test/property_test.c", 160, "q = ossl_parse_query(NULL, parser_tests[n].query, 0)", q = ossl_parse_query(
# 160 "../test/property_test.c" 3 4
          ((void *)0)
# 160 "../test/property_test.c"
          , parser_tests[n].query, 0))
        && test_int_eq("../test/property_test.c", 161, "ossl_property_match_count(q, p)", "parser_tests[n].e", ossl_property_match_count(q, p), parser_tests[n].e))
        r = 1;
...
static int test_property_query_value_create(void)
{
    OSSL_METHOD_STORE *store;
    OSSL_PROPERTY_LIST *p = 
# 172 "../test/property_test.c" 3 4
                           ((void *)0)
# 172 "../test/property_test.c"
                               , *q = 
# 172 "../test/property_test.c" 3 4
                                      ((void *)0)
# 172 "../test/property_test.c"
...
# 172 "../test/property_test.c"
    ...
    if (test_ptr("../test/property_test.c", 176, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 176 "../test/property_test.c" 3 4
       ((void *)0)
# 176 "../test/property_test.c"
       ))
        && add_property_names("wood", 
# 177 "../test/property_test.c" 3 4
                                     ((void *)0)
# 177 "../test/property_test.c"
                                         )
        && test_ptr("../test/property_test.c", 178, "p = ossl_parse_query(NULL, \"wood=oak\", 0)", p = ossl_parse_query(
# 178 "../test/property_test.c" 3 4
          ((void *)0)
# 178 "../test/property_test.c"
          , "wood=oak", 0))
        && test_ptr("../test/property_test.c", 179, "q = ossl_parse_query(NULL, \"wood=oak\", 1)", q = ossl_parse_query(
# 179 "../test/property_test.c" 3 4
          ((void *)0)
# 179 "../test/property_test.c"
          , "wood=oak", 1))
        && test_ptr("../test/property_test.c", 180, "o = ossl_parse_query(NULL, \"wood=oak\", 0)", o = ossl_parse_query(
# 180 "../test/property_test.c" 3 4
          ((void *)0)
# 180 "../test/property_test.c"
          , "wood=oak", 0))
        && test_int_eq("../test/property_test.c", 181, "ossl_property_match_count(q, p)", "-1", ossl_property_match_count(q, p), -1)
        && test_int_eq("../test/property_test.c", 182, "ossl_property_match_count(q, o)", "1", ossl_property_match_count(q, o), 1))
        r = 1;
...
static const struct {
    ...
    { 0, "n=0x28FG, a=3" },
    { 0, "n=145d, a=2" },
    { 0, "n=0x8000000000000000, a=3" },
    { 0, "n=922337203000000000d, a=2" },
    { 0, "a=2, n=1000000000000000000000" },
    { 1, "@='hello'" },
    { 1, "n0123456789012345678901234567890123456789"
         "0123456789012345678901234567890123456789"
         "0123456789012345678901234567890123456789"
         "0123456789012345678901234567890123456789=yes" },
    { 0, ".n=3" },
    { 1, "fnord.fnord.=3" }
};
...
static int test_property_parse_error(int n)
{
    OSSL_METHOD_STORE *store;
    OSSL_PROPERTY_LIST *p = 
# 220 "../test/property_test.c" 3 4
                           ((void *)0)
# 220 "../test/property_test.c"
                               ;
    int r = 0;
    const char *ps;

    if (!test_ptr("../test/property_test.c", 224, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 224 "../test/property_test.c" 3 4
        ((void *)0)
# 224 "../test/property_test.c"
        ))
        || !add_property_names("a", "n", 
# 225 "../test/property_test.c" 3 4
                                        ((void *)0)
# 225 "../test/property_test.c"
                                            ))
        goto err;
    ps = parse_error_tests[n].ps;
    if (parse_error_tests[n].query) {
        if (!test_ptr_null("../test/property_test.c", 229, "p = ossl_parse_query(NULL, ps, 1)", p = ossl_parse_query(
# 229 "../test/property_test.c" 3 4
            ((void *)0)
# 229 "../test/property_test.c"
            , ps, 1)))
            goto err;
    } else if (!test_ptr_null("../test/property_test.c", 231, "p = ossl_parse_property(NULL, ps)", p = ossl_parse_property(
# 231 "../test/property_test.c" 3 4
               ((void *)0)
# 231 "../test/property_test.c"
               , ps))) {
        goto err;
    }
    r = 1;
...
{
    OSSL_METHOD_STORE *store;
    OSSL_PROPERTY_LIST *q_global = 
# 270 "../test/property_test.c" 3 4
                                  ((void *)0)
# 270 "../test/property_test.c"
                                      , *q_local = 
# 270 "../test/property_test.c" 3 4
                                                   ((void *)0)
# 270 "../test/property_test.c"
                                                       ;
    OSSL_PROPERTY_LIST *q_combined = 
# 271 "../test/property_test.c" 3 4
                                    ((void *)0)
# 271 "../test/property_test.c"
                                        , *prop = 
# 271 "../test/property_test.c" 3 4
                                                  ((void *)0)
# 271 "../test/property_test.c"
    ...
    if (test_ptr("../test/property_test.c", 274, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 274 "../test/property_test.c" 3 4
       ((void *)0)
# 274 "../test/property_test.c"
       ))
        && add_property_names("colour", "urn", "clouds", "pot", "day", "night",
                              
# 276 "../test/property_test.c" 3 4
                             ((void *)0)
# 276 "../test/property_test.c"
                                 )
        && test_ptr("../test/property_test.c", 277, "prop = ossl_parse_property(NULL, merge_tests[n].prop)", prop = ossl_parse_property(
# 277 "../test/property_test.c" 3 4
          ((void *)0)
# 277 "../test/property_test.c"
          , merge_tests[n].prop))
        && test_ptr("../test/property_test.c", 278, "q_global = ossl_parse_query(NULL, merge_tests[n].q_global, 0)", q_global = ossl_parse_query(
# 278 "../test/property_test.c" 3 4
          ((void *)0)
# 278 "../test/property_test.c"
          , merge_tests[n].q_global, 0))

        && test_ptr("../test/property_test.c", 280, "q_local = ossl_parse_query(NULL, merge_tests[n].q_local, 0)", q_local = ossl_parse_query(
# 280 "../test/property_test.c" 3 4
          ((void *)0)
# 280 "../test/property_test.c"
          , merge_tests[n].q_local, 0))
        && test_ptr("../test/property_test.c", 281, "q_combined = ossl_property_merge(q_local, q_global)", q_combined = ossl_property_merge(q_local, q_global))
        && test_int_ge("../test/property_test.c", 282, "ossl_property_match_count(q_combined, prop)", "0", ossl_property_match_count(q_combined, prop), 0))
        r = 1;
...
{
    OSSL_METHOD_STORE *store;
    OSSL_PROPERTY_LIST *red = 
# 295 "../test/property_test.c" 3 4
                             ((void *)0)
# 295 "../test/property_test.c"
                                 , *blue = 
# 295 "../test/property_test.c" 3 4
                                           ((void *)0)
# 295 "../test/property_test.c"
...
# 295 "../test/property_test.c"
    ...
    r = test_ptr("../test/property_test.c", 298, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 298 "../test/property_test.c" 3 4
       ((void *)0)
# 298 "../test/property_test.c"
       ))
        && add_property_names("red", "blue", 
# 299 "../test/property_test.c" 3 4
                                            ((void *)0)
# 299 "../test/property_test.c"
                                                )
        && test_ptr("../test/property_test.c", 300, "red = ossl_parse_property(NULL, \"red\")", red = ossl_parse_property(
# 300 "../test/property_test.c" 3 4
          ((void *)0)
# 300 "../test/property_test.c"
          , "red"))
        && test_ptr("../test/property_test.c", 301, "blue = ossl_parse_property(NULL, \"blue\")", blue = ossl_parse_property(
# 301 "../test/property_test.c" 3 4
          ((void *)0)
# 301 "../test/property_test.c"
          , "blue"))
        && test_ptr_ne("../test/property_test.c", 302, "red", "blue", red, blue)
        && test_true("../test/property_test.c", 303, "ossl_prop_defn_set(NULL, \"red\", &red)", (ossl_prop_defn_set(
# 303 "../test/property_test.c" 3 4
          ((void *)0)
# 303 "../test/property_test.c"
          , "red", &red)) != 0);

    if (!r) {
        ossl_property_free(red);
        red = 
# 307 "../test/property_test.c" 3 4
             ((void *)0)
# 307 "../test/property_test.c"
                 ;
        ossl_property_free(blue);
        blue = 
# 309 "../test/property_test.c" 3 4
              ((void *)0)
# 309 "../test/property_test.c"
                  ;
    }

    r = r && test_true("../test/property_test.c", 312, "ossl_prop_defn_set(NULL, \"blue\", &blue)", (ossl_prop_defn_set(
# 312 "../test/property_test.c" 3 4
            ((void *)0)
# 312 "../test/property_test.c"
            , "blue", &blue)) != 0);
    if (!r) {
        ossl_property_free(blue);
        blue = 
# 315 "../test/property_test.c" 3 4
              ((void *)0)
# 315 "../test/property_test.c"
                  ;
    }

    r = r && test_ptr_eq("../test/property_test.c", 318, "ossl_prop_defn_get(NULL, \"red\")", "red", ossl_prop_defn_get(
# 318 "../test/property_test.c" 3 4
            ((void *)0)
# 318 "../test/property_test.c"
            , "red"), red)
        && test_ptr_eq("../test/property_test.c", 319, "ossl_prop_defn_get(NULL, \"blue\")", "blue", ossl_prop_defn_get(
# 319 "../test/property_test.c" 3 4
          ((void *)0)
# 319 "../test/property_test.c"
          , "blue"), blue)
        && test_ptr("../test/property_test.c", 320, "blue2 = ossl_parse_property(NULL, \"blue\")", blue2 = ossl_parse_property(
# 320 "../test/property_test.c" 3 4
          ((void *)0)
# 320 "../test/property_test.c"
          , "blue"))
        && test_ptr_ne("../test/property_test.c", 321, "blue2", "blue", blue2, blue)
        && test_true("../test/property_test.c", 322, "ossl_prop_defn_set(NULL, \"blue\", &blue2)", (ossl_prop_defn_set(
# 322 "../test/property_test.c" 3 4
          ((void *)0)
# 322 "../test/property_test.c"
          , "blue", &blue2)) != 0);
    if (!r) {
        ossl_property_free(blue2);
        blue2 = 
# 325 "../test/property_test.c" 3 4
               ((void *)0)
# 325 "../test/property_test.c"
                   ;
    }

    r = r && test_ptr_eq("../test/property_test.c", 328, "blue2", "blue", blue2, blue)
        && test_ptr_eq("../test/property_test.c", 329, "ossl_prop_defn_get(NULL, \"blue\")", "blue", ossl_prop_defn_get(
# 329 "../test/property_test.c" 3 4
          ((void *)0)
# 329 "../test/property_test.c"
          , "blue"), blue);
...
{
    OSSL_METHOD_STORE *store;
    OSSL_PROPERTY_LIST *d = 
# 356 "../test/property_test.c" 3 4
                           ((void *)0)
# 356 "../test/property_test.c"
                               , *q = 
# 356 "../test/property_test.c" 3 4
                                      ((void *)0)
# 356 "../test/property_test.c"
    ...
    r = test_ptr("../test/property_test.c", 359, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 359 "../test/property_test.c" 3 4
       ((void *)0)
# 359 "../test/property_test.c"
       ))
        && add_property_names("alpha", "omega", 
# 360 "../test/property_test.c" 3 4
                                               ((void *)0)
# 360 "../test/property_test.c"
                                                   )
        && test_ptr("../test/property_test.c", 361, "d = ossl_parse_property(NULL, definition_tests[n].defn)", d = ossl_parse_property(
# 361 "../test/property_test.c" 3 4
          ((void *)0)
# 361 "../test/property_test.c"
          , definition_tests[n].defn))
        && test_ptr("../test/property_test.c", 362, "q = ossl_parse_query(NULL, definition_tests[n].query, 0)", q = ossl_parse_query(
# 362 "../test/property_test.c" 3 4
          ((void *)0)
# 362 "../test/property_test.c"
          , definition_tests[n].query, 0))
        && test_int_eq("../test/property_test.c", 363, "ossl_property_match_count(q, d)", "definition_tests[n].e", ossl_property_match_count(q, d), definition_tests[n].e);
...
static int test_register_deregister(void)
{
    ...
    if (!test_ptr("../test/property_test.c", 388, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 388 "../test/property_test.c" 3 4
        ((void *)0)
# 388 "../test/property_test.c"
        ))
        || !add_property_names("position", 
# 389 "../test/property_test.c" 3 4
                                          ((void *)0)
# 389 "../test/property_test.c"
                                              ))
        goto err;

    for (i = 0; i < (sizeof(impls)/sizeof((impls)[0])); i++)
        if (!test_true("../test/property_test.c", 393, "ossl_method_store_add(store, &prov, impls[i].nid, impls[i].prop, impls[i].impl, &up_ref, &down_ref)", (ossl_method_store_add(store, &prov, impls[i].nid, impls[i].prop, impls[i].impl, &up_ref, &down_ref)) != 0)
    ...
    for (i = 0; i < (sizeof(impls)/sizeof((impls)[0])); i++) {
        const size_t j = (1 + i * 3) % (sizeof(impls)/sizeof((impls)[0]));
        int nid = impls[j].nid;
        void *impl = impls[j].impl;

        if (!test_true("../test/property_test.c", 406, "ossl_method_store_remove(store, nid, impl)", (ossl_method_store_remove(store, nid, impl)) != 0)
            || !test_false("../test/property_test.c", 407, "ossl_method_store_remove(store, nid, impl)", (ossl_method_store_remove(store, nid, impl)) != 0)) {
            test_note("iteration %zd, position %zd", i + 1, j + 1);
            goto err;
        }
    }

    if (test_false("../test/property_test.c", 413, "ossl_method_store_remove(store, impls[0].nid, impls[0].impl)", (ossl_method_store_remove(store, impls[0].nid, impls[0].impl)) != 0))
        ret = 1;
err:
    ossl_method_store_free(store);
    return ret;
...
static int test_property(void)
{
    ...
    static const struct {
        ...
        { &fake_prov2, 3, 
# 436 "../test/property_test.c" 3 4
                         ((void *)0)
# 436 "../test/property_test.c"
                             , "d" },
    ...
    if (!test_ptr("../test/property_test.c", 462, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 462 "../test/property_test.c" 3 4
        ((void *)0)
# 462 "../test/property_test.c"
        ))
        || !add_property_names("fast", "colour", "sky", "furry", 
# 463 "../test/property_test.c" 3 4
                                                                ((void *)0)
# 463 "../test/property_test.c"
                                                                    ))
        goto err;

    for (i = 0; i < (sizeof(impls)/sizeof((impls)[0])); i++)
        if (!test_true("../test/property_test.c", 467, "ossl_method_store_add(store, *impls[i].prov, impls[i].nid, impls[i].prop, impls[i].impl, &up_ref, &down_ref)", (ossl_method_store_add(store, *impls[i].prov, impls[i].nid, impls[i].prop, impls[i].impl, &up_ref, &down_ref)) != 0)
    ...
    for (i = 0; i < (sizeof(queries)/sizeof((queries)[0])); i++) {
        const OSSL_PROVIDER *nullprov = 
# 479 "../test/property_test.c" 3 4
                                       ((void *)0)
# 479 "../test/property_test.c"
                                           ;
        OSSL_PROPERTY_LIST *pq = 
# 480 "../test/property_test.c" 3 4
                                ((void *)0)
# 480 "../test/property_test.c"
                                    ;

        if (!test_true("../test/property_test.c", 482, "ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &nullprov, &result)", (ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &nullprov, &result)) != 0)


            || !test_str_eq("../test/property_test.c", 485, "(char *)result", "queries[i].expected", (char *)result, queries[i].expected)) {
            test_note("iteration %zd", i + 1);
    ...
    for (i = 0; i < (sizeof(queries)/sizeof((queries)[0])); i++) {
        OSSL_PROPERTY_LIST *pq = 
# 496 "../test/property_test.c" 3 4
                                ((void *)0)
# 496 "../test/property_test.c"
                                    ;

        result = 
# 498 "../test/property_test.c" 3 4
                ((void *)0)
# 498 "../test/property_test.c"
                    ;
        if (queries[i].prov == &fake_prov1) {
            if (!test_true("../test/property_test.c", 500, "ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov1, &result)", (ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov1, &result)) != 0)



                || !test_ptr_eq("../test/property_test.c", 504, "fake_prov1", "&fake_provider1", fake_prov1, &fake_provider1)
                || !test_str_eq("../test/property_test.c", 505, "(char *)result", "queries[i].expected", (char *)result, queries[i].expected)) {
                test_note("iteration %zd", i + 1);
                ossl_property_free(pq);
                goto err;
            }
        } else {
            if (!test_false("../test/property_test.c", 511, "ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov1, &result)", (ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov1, &result)) != 0)



                || !test_ptr_eq("../test/property_test.c", 515, "fake_prov1", "&fake_provider1", fake_prov1, &fake_provider1)
                || !test_ptr_null("../test/property_test.c", 516, "result", result)) {
                test_note("iteration %zd", i + 1);
                ossl_property_free(pq);
                goto err;
            }
    ...
    for (i = 0; i < (sizeof(queries)/sizeof((queries)[0])); i++) {
        OSSL_PROPERTY_LIST *pq = 
# 528 "../test/property_test.c" 3 4
                                ((void *)0)
# 528 "../test/property_test.c"
                                    ;

        result = 
# 530 "../test/property_test.c" 3 4
                ((void *)0)
# 530 "../test/property_test.c"
                    ;
        if (queries[i].prov == &fake_prov2) {
            if (!test_true("../test/property_test.c", 532, "ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov2, &result)", (ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov2, &result)) != 0)



                || !test_ptr_eq("../test/property_test.c", 536, "fake_prov2", "&fake_provider2", fake_prov2, &fake_provider2)
                || !test_str_eq("../test/property_test.c", 537, "(char *)result", "queries[i].expected", (char *)result, queries[i].expected)) {
                test_note("iteration %zd", i + 1);
                ossl_property_free(pq);
                goto err;
            }
        } else {
            if (!test_false("../test/property_test.c", 543, "ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov2, &result)", (ossl_method_store_fetch(store, queries[i].nid, queries[i].prop, &fake_prov2, &result)) != 0)



                || !test_ptr_eq("../test/property_test.c", 547, "fake_prov2", "&fake_provider2", fake_prov2, &fake_provider2)
                || !test_ptr_null("../test/property_test.c", 548, "result", result)) {
                test_note("iteration %zd", i + 1);
                ossl_property_free(pq);
                goto err;
            }
...
static int test_query_cache_stochastic(void)
{
    ...
    if (!test_ptr("../test/property_test.c", 573, "store = ossl_method_store_new(NULL)", store = ossl_method_store_new(
# 573 "../test/property_test.c" 3 4
        ((void *)0)
# 573 "../test/property_test.c"
        ))
        || !add_property_names("n", 
# 574 "../test/property_test.c" 3 4
                                   ((void *)0)
# 574 "../test/property_test.c"
                                       ))
        goto err;
    ...
    for (i = 1; i <= max; i++) {
        ...
        if (!test_true("../test/property_test.c", 580, "ossl_method_store_add(store, &prov, i, buf, \"abc\", &up_ref, &down_ref)", (ossl_method_store_add(store, &prov, i, buf, "abc", &up_ref, &down_ref)) != 0)

                || !test_true("../test/property_test.c", 582, "ossl_method_store_cache_set(store, &prov, i, buf, v + i, &up_ref, &down_ref)", (ossl_method_store_cache_set(store, &prov, i, buf, v + i, &up_ref, &down_ref)) != 0)


                || !test_true("../test/property_test.c", 585, "ossl_method_store_cache_set(store, &prov, i, \"n=1234\", \"miss\", &up_ref, &down_ref)", (ossl_method_store_cache_set(store, &prov, i, "n=1234", "miss", &up_ref, &down_ref)) != 0)
    ...
    for (i = 1; i <= max; i++) {
        BIO_snprintf(buf, sizeof(buf), "n=%d\n", i);
        if (!ossl_method_store_cache_get(store, 
# 594 "../test/property_test.c" 3 4
                                               ((void *)0)
# 594 "../test/property_test.c"
                                                   , i, buf, &result)
            || result != v + i)
            errors++;
    }

    res = test_int_gt("../test/property_test.c", 599, "errors", "tail", errors, tail) && test_int_lt("../test/property_test.c", 599, "errors", "max - tail", errors, max - tail);
...
static int test_fips_mode(void)
{
    int ret = 0;
    OSSL_LIB_CTX *ctx = 
# 609 "../test/property_test.c" 3 4
                       ((void *)0)
# 609 "../test/property_test.c"
                           ;

    if (!test_ptr("../test/property_test.c", 611, "ctx = OSSL_LIB_CTX_new()", ctx = OSSL_LIB_CTX_new()))
        goto err;

    ret = test_true("../test/property_test.c", 614, "EVP_set_default_properties(ctx, \"default=yes,fips=yes\")", (EVP_set_default_properties(ctx, "default=yes,fips=yes")) != 0)
          && test_true("../test/property_test.c", 615, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 616, "EVP_set_default_properties(ctx, \"fips=no,default=yes\")", (EVP_set_default_properties(ctx, "fips=no,default=yes")) != 0)
          && test_false("../test/property_test.c", 617, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 618, "EVP_set_default_properties(ctx, \"fips=no\")", (EVP_set_default_properties(ctx, "fips=no")) != 0)
          && test_false("../test/property_test.c", 619, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 620, "EVP_set_default_properties(ctx, \"fips!=no\")", (EVP_set_default_properties(ctx, "fips!=no")) != 0)
          && test_true("../test/property_test.c", 621, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 622, "EVP_set_default_properties(ctx, \"fips=no\")", (EVP_set_default_properties(ctx, "fips=no")) != 0)
          && test_false("../test/property_test.c", 623, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 624, "EVP_set_default_properties(ctx, \"fips=no,default=yes\")", (EVP_set_default_properties(ctx, "fips=no,default=yes")) != 0)
          && test_true("../test/property_test.c", 625, "EVP_default_properties_enable_fips(ctx, 1)", (EVP_default_properties_enable_fips(ctx, 1)) != 0)
          && test_true("../test/property_test.c", 626, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0)
          && test_true("../test/property_test.c", 627, "EVP_default_properties_enable_fips(ctx, 0)", (EVP_default_properties_enable_fips(ctx, 0)) != 0)
          && test_false("../test/property_test.c", 628, "EVP_default_properties_is_fips_enabled(ctx)", (EVP_default_properties_is_fips_enabled(ctx)) != 0);
err:
    OSSL_LIB_CTX_free(ctx);
    return ret;
}
...
static struct {
    ...
    { 
# 658 "../test/property_test.c" 3 4
     ((void *)0)
# 658 "../test/property_test.c"
         , "" }
};
...
{
    OSSL_PROPERTY_LIST *pl = 
# 663 "../test/property_test.c" 3 4
                            ((void *)0)
# 663 "../test/property_test.c"
                                ;
    int ret = 0;
    size_t bufsize;
    char *buf = 
# 666 "../test/property_test.c" 3 4
               ((void *)0)
# 666 "../test/property_test.c"
                   ;

    if (to_string_tests[i].in != 
# 668 "../test/property_test.c" 3 4
                                ((void *)0)
            
# 669 "../test/property_test.c"
           && !test_ptr("../test/property_test.c", 669, "pl = ossl_parse_query(NULL, to_string_tests[i].in, 1)", pl = ossl_parse_query(
# 669 "../test/property_test.c" 3 4
               ((void *)0)
# 669 "../test/property_test.c"
               , to_string_tests[i].in, 1)))
        goto err;
    bufsize = ossl_property_list_to_string(
# 671 "../test/property_test.c" 3 4
                                          ((void *)0)
# 671 "../test/property_test.c"
                                              , pl, 
# 671 "../test/property_test.c" 3 4
                                                    ((void *)0)
# 671 "../test/property_test.c"
                                                        , 0);
    if (!test_size_t_gt("../test/property_test.c", 672, "bufsize", "0", bufsize, 0))
        goto err;
    buf = CRYPTO_malloc(bufsize, "../test/property_test.c", 674);
    if (!test_ptr("../test/property_test.c", 675, "buf", buf)
            || !test_size_t_eq("../test/property_test.c", 676, "ossl_property_list_to_string(NULL, pl, buf, bufsize)", "bufsize", ossl_property_list_to_string(
# 676 "../test/property_test.c" 3 4
               ((void *)0)
# 676 "../test/property_test.c"
               , pl, buf, bufsize), bufsize)


            || !test_str_eq("../test/property_test.c", 679, "to_string_tests[i].out", "buf", to_string_tests[i].out, buf)
            || !test_size_t_eq("../test/property_test.c", 680, "bufsize", "strlen(to_string_tests[i].out) + 1", bufsize, strlen(to_string_tests[i].out) + 1))
        goto err;

    ret = 1;
 err:
    CRYPTO_free(buf, "../test/property_test.c", 685);
...
{
    OSSL_PROPERTY_LIST *pl = 
# 692 "../test/property_test.c" 3 4
                            ((void *)0)
# 692 "../test/property_test.c"
                                ;
    char buf[16];
    int ret = 0;

    if (!test_ptr("../test/property_test.c", 696, "pl = ossl_parse_query(NULL, \"provider='$1'\", 1)", pl = ossl_parse_query(
# 696 "../test/property_test.c" 3 4
        ((void *)0)
# 696 "../test/property_test.c"
        , "provider='$1'", 1)))
        goto err;
    if (!test_size_t_eq("../test/property_test.c", 698, "ossl_property_list_to_string(NULL, pl, buf, 10)", "14", ossl_property_list_to_string(
# 698 "../test/property_test.c" 3 4
        ((void *)0)
# 698 "../test/property_test.c"
        , pl, buf, 10), 14))
        goto err;
    ret = 1;
 err:
...
int setup_tests(void)
{
    ...
    add_all_tests("test_property_parse", test_property_parse, (sizeof(parser_tests)/sizeof((parser_tests)[0])), 1);
    add_all_tests("test_property_parse_error", test_property_parse_error, (sizeof(parse_error_tests)/sizeof((parse_error_tests)[0])), 1);
    add_all_tests("test_property_merge", test_property_merge, (sizeof(merge_tests)/sizeof((merge_tests)[0])), 1);
    add_test("test_property_defn_cache", test_property_defn_cache);
    add_all_tests("test_definition_compares", test_definition_compares, (sizeof(definition_tests)/sizeof((definition_tests)[0])), 1);
    ...
    add_all_tests("test_property_list_to_string", test_property_list_to_string, (sizeof(to_string_tests)/sizeof((to_string_tests)[0])), 1);
    add_test("test_property_list_to_string_bounds", test_property_list_to_string_bounds);
    return 1;
}
