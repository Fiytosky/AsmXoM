# 0 "../test/sparse_array_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/sparse_array_test.c"
# 11 "../test/sparse_array_test.c"
...
# 16 "../test/sparse_array_test.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 17 "../test/sparse_array_test.c" 2
...
# 19 "../test/sparse_array_test.c" 2
# 27 "../test/sparse_array_test.c"
struct sparse_array_st_char; static __attribute__((unused)) inline struct sparse_array_st_char * ossl_sa_char_new(void) { return (struct sparse_array_st_char *)ossl_sa_new(); } static __attribute__((unused)) inline void ossl_sa_char_free(struct sparse_array_st_char *sa) { ossl_sa_free((OPENSSL_SA *)sa); } static __attribute__((unused)) inline void ossl_sa_char_free_leaves(struct sparse_array_st_char *sa) { ossl_sa_free_leaves((OPENSSL_SA *)sa); } static __attribute__((unused)) inline size_t ossl_sa_char_num(const struct sparse_array_st_char *sa) { return ossl_sa_num((OPENSSL_SA *)sa); } static __attribute__((unused)) inline void ossl_sa_char_doall(const struct sparse_array_st_char *sa, void (*leaf)(ossl_uintmax_t, char *)) { ossl_sa_doall((OPENSSL_SA *)sa, (void (*)(ossl_uintmax_t, void *))leaf); } static __attribute__((unused)) inline void ossl_sa_char_doall_arg(const struct sparse_array_st_char *sa, void (*leaf)(ossl_uintmax_t, char *, void *), void *arg) { ossl_sa_doall_arg((OPENSSL_SA *)sa, (void (*)(ossl_uintmax_t, void *, void *))leaf, arg); } static __attribute__((unused)) inline char *ossl_sa_char_get(const struct sparse_array_st_char *sa, ossl_uintmax_t n) { return (char *)ossl_sa_get((OPENSSL_SA *)sa, n); } static __attribute__((unused)) inline int ossl_sa_char_set(struct sparse_array_st_char *sa, ossl_uintmax_t n, char *val) { return ossl_sa_set((OPENSSL_SA *)sa, n, (void *)val); } struct sparse_array_st_char;
...
static int test_sparse_array(void)
{
    static const struct {
        ...
        { 22, "a" }, { 0, "z" }, { 1, "b" }, { 290, "c" },
        { 0x7fffffff
# 36 "../test/sparse_array_test.c"
                , "m" }, { 6666666, "d" }, { (ossl_uintmax_t)-1, "H" },
        { 99, "e" }
    };
    struct sparse_array_st_char *sa;
    size_t i, j;
    int res = 0;

    if (!test_ptr("../test/sparse_array_test.c", 43, "sa = ossl_sa_char_new()", sa = ossl_sa_char_new())
            || !test_ptr_null("../test/sparse_array_test.c", 44, "ossl_sa_char_get(sa, 3)", ossl_sa_char_get(sa, 3))
            || !test_ptr_null("../test/sparse_array_test.c", 45, "ossl_sa_char_get(sa, 0)", ossl_sa_char_get(sa, 0))
            || !test_ptr_null("../test/sparse_array_test.c", 46, "ossl_sa_char_get(sa, UINT_MAX)", ossl_sa_char_get(sa, 
# 46 "../test/sparse_array_test.c" 3 4
               (0x7fffffff * 2U + 1U)
# 46 "../test/sparse_array_test.c"
               )))
        goto err;

    for (i = 0; i < (sizeof(cases)/sizeof((cases)[0])); i++) {
        if (!test_true("../test/sparse_array_test.c", 50, "ossl_sa_char_set(sa, cases[i].n, cases[i].v)", (ossl_sa_char_set(sa, cases[i].n, cases[i].v)) != 0)) {
            test_note("iteration %zu", i + 1);
            goto err;
        }
        for (j = 0; j <= i; j++)
            if (!test_str_eq("../test/sparse_array_test.c", 55, "ossl_sa_char_get(sa, cases[j].n)", "cases[j].v", ossl_sa_char_get(sa, cases[j].n), cases[j].v)) {
...
static int test_sparse_array_num(void)
{
    static const struct {
        ...
        { 1, 22, "a" }, { 2, 1021, "b" }, { 3, 3, "c" }, { 2, 22, 
# 74 "../test/sparse_array_test.c" 3 4
                                                                 ((void *)0) 
# 74 "../test/sparse_array_test.c"
                                                                      },
        { 2, 3, "d" }, { 3, 22, "e" }, { 3, 666, 
# 75 "../test/sparse_array_test.c" 3 4
                                                ((void *)0) 
# 75 "../test/sparse_array_test.c"
                                                     }, { 4, 666, "f" },
        { 3, 3, 
# 76 "../test/sparse_array_test.c" 3 4
               ((void *)0) 
# 76 "../test/sparse_array_test.c"
                    }, { 2, 22, 
# 76 "../test/sparse_array_test.c" 3 4
                                ((void *)0) 
# 76 "../test/sparse_array_test.c"
...
# 76 "../test/sparse_array_test.c"
        ...
        { 1, 1021, 
# 77 "../test/sparse_array_test.c" 3 4
                  ((void *)0) 
# 77 "../test/sparse_array_test.c"
                       }, { 0, 64000, 
# 77 "../test/sparse_array_test.c" 3 4
                                      ((void *)0) 
# 77 "../test/sparse_array_test.c"
...
# 77 "../test/sparse_array_test.c"
    ...
    struct sparse_array_st_char *sa = 
# 79 "../test/sparse_array_test.c" 3 4
                               ((void *)0)
# 79 "../test/sparse_array_test.c"
                                   ;
    size_t i;
    int res = 0;

    if (!test_size_t_eq("../test/sparse_array_test.c", 83, "ossl_sa_char_num(NULL)", "0", ossl_sa_char_num(
# 83 "../test/sparse_array_test.c" 3 4
        ((void *)0)
# 83 "../test/sparse_array_test.c"
        ), 0)
            || !test_ptr("../test/sparse_array_test.c", 84, "sa = ossl_sa_char_new()", sa = ossl_sa_char_new())
            || !test_size_t_eq("../test/sparse_array_test.c", 85, "ossl_sa_char_num(sa)", "0", ossl_sa_char_num(sa), 0))
        goto err;
    for (i = 0; i < (sizeof(cases)/sizeof((cases)[0])); i++)
        if (!test_true("../test/sparse_array_test.c", 88, "ossl_sa_char_set(sa, cases[i].n, cases[i].v)", (ossl_sa_char_set(sa, cases[i].n, cases[i].v)) != 0)
                || !test_size_t_eq("../test/sparse_array_test.c", 89, "ossl_sa_char_num(sa)", "cases[i].num", ossl_sa_char_num(sa), cases[i].num))
            goto err;
    res = 1;
err:
    ossl_sa_char_free(sa);
...
static void leaf_check_all(ossl_uintmax_t n, char *value, void *arg)
{
    ...
    test_error("../test/sparse_array_test.c", 124, "Index %ju with value %s not found", n, value);
}
...
static void leaf_delete(ossl_uintmax_t n, char *value, void *arg)
{
    ...
    for (i = 0; i < doall_data->num_cases; i++)
        if (n == cases[i].n && strcmp(value, cases[i].v) == 0) {
            doall_data->res = 1;
            ossl_sa_char_set(doall_data->sa, n, 
# 137 "../test/sparse_array_test.c" 3 4
                                               ((void *)0)
# 137 "../test/sparse_array_test.c"
                                                   );
            return;
        }
    test_error("../test/sparse_array_test.c", 140, "Index %ju with value %s not found", n, value);
}

static int test_sparse_array_doall(void)
{
    static const struct index_cases_st cases[] = {
        { 22, "A", 1 }, { 1021, "b", 0 }, { 3, "c", 0 }, { 0x7fffffff
# 146 "../test/sparse_array_test.c"
                                                                 , "d", 1 },
    ...
    size_t i;
    struct sparse_array_st_char *sa = 
# 152 "../test/sparse_array_test.c" 3 4
                               ((void *)0)
# 152 "../test/sparse_array_test.c"
                                   ;
    int res = 0;

    if (!test_ptr("../test/sparse_array_test.c", 155, "sa = ossl_sa_char_new()", sa = ossl_sa_char_new()))
        goto err;
    doall_data.num_cases = (sizeof(cases)/sizeof((cases)[0]));
    doall_data.cases = cases;
    doall_data.all = 1;
    doall_data.sa = 
# 160 "../test/sparse_array_test.c" 3 4
                   ((void *)0)
# 160 "../test/sparse_array_test.c"
                       ;
    for (i = 0; i < (sizeof(cases)/sizeof((cases)[0])); i++)
        if (!test_true("../test/sparse_array_test.c", 162, "ossl_sa_char_set(sa, cases[i].n, cases[i].v)", (ossl_sa_char_set(sa, cases[i].n, cases[i].v)) != 0)) {
    ...
    if (doall_data.res == 0) {
        test_info("../test/sparse_array_test.c", 169, "while checking all elements");
        goto err;
    }
    doall_data.all = 0;
    doall_data.sa = sa;
    ...
    if (doall_data.res == 0) {
        test_info("../test/sparse_array_test.c", 176, "while deleting selected elements");
        goto err;
    }
    ossl_sa_char_doall_arg(sa, &leaf_check_all, &doall_data);
    if (doall_data.res == 0) {
        test_info("../test/sparse_array_test.c", 181, "while checking for deleted elements");
        goto err;
    }
    res = 1;
