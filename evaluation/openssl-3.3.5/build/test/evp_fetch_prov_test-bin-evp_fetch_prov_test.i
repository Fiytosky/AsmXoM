# 0 "../test/evp_fetch_prov_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_fetch_prov_test.c"
# 15 "../test/evp_fetch_prov_test.c"
...
# 16 "../test/evp_fetch_prov_test.c" 2
...
# 18 "../test/evp_fetch_prov_test.c" 2
...
# 19 "../test/evp_fetch_prov_test.c" 2
...
# 20 "../test/evp_fetch_prov_test.c" 2
...
# 21 "../test/evp_fetch_prov_test.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 22 "../test/evp_fetch_prov_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 23 "../test/evp_fetch_prov_test.c" 2

static char *config_file = 
# 24 "../test/evp_fetch_prov_test.c" 3 4
                          ((void *)0)
# 24 "../test/evp_fetch_prov_test.c"
                              ;
static char *alg = "digest";
static int use_default_ctx = 0;
static char *fetch_property = 
# 27 "../test/evp_fetch_prov_test.c" 3 4
                             ((void *)0)
# 27 "../test/evp_fetch_prov_test.c"
                                 ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 52 "../test/evp_fetch_prov_test.c" 3 4
         ((void *)0) 
# 52 "../test/evp_fetch_prov_test.c"
              }
    };
    return test_options;
}
                            ...
                            const unsigned char *exptd)
{
    ...
    if (!test_ptr("../test/evp_fetch_prov_test.c", 64, "ctx = EVP_MD_CTX_new()", ctx = EVP_MD_CTX_new())
            || !test_true("../test/evp_fetch_prov_test.c", 65, "EVP_DigestInit_ex(ctx, md, NULL)", (EVP_DigestInit_ex(ctx, md, 
# 65 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 65 "../test/evp_fetch_prov_test.c"
               )) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 66, "EVP_DigestUpdate(ctx, msg, len)", (EVP_DigestUpdate(ctx, msg, len)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 67, "EVP_DigestFinal_ex(ctx, out, NULL)", (EVP_DigestFinal_ex(ctx, out, 
# 67 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 67 "../test/evp_fetch_prov_test.c"
               )) != 0)
            || !test_mem_eq("../test/evp_fetch_prov_test.c", 68, "out", "exptd", out, 32, exptd, 32)

            || !test_true("../test/evp_fetch_prov_test.c", 70, "md == EVP_MD_CTX_get0_md(ctx)", (md == EVP_MD_CTX_get0_md(ctx)) != 0))
        goto err;
...
{
    OSSL_LIB_CTX *ctx = 
# 81 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 81 "../test/evp_fetch_prov_test.c"
                           ;
    int ret = 0;
    size_t i;

    ctx = OSSL_LIB_CTX_new();
    if (!test_ptr("../test/evp_fetch_prov_test.c", 86, "ctx", ctx))
        goto err;

    if (!test_true("../test/evp_fetch_prov_test.c", 89, "OSSL_LIB_CTX_load_config(ctx, config_file)", (OSSL_LIB_CTX_load_config(ctx, config_file)) != 0))
        goto err;
    ...
    for (i = 0; i < test_get_argument_count(); ++i) {
        ...
        if (!test_ptr("../test/evp_fetch_prov_test.c", 97, "prov[i]", prov[i]))
            goto err;
    }
...
{
    if (prov[0] != 
# 111 "../test/evp_fetch_prov_test.c" 3 4
                  ((void *)0)
# 111 "../test/evp_fetch_prov_test.c"
                      )
        OSSL_PROVIDER_unload(prov[0]);
    if (prov[1] != 
# 113 "../test/evp_fetch_prov_test.c" 3 4
                  ((void *)0)
# 113 "../test/evp_fetch_prov_test.c"
                      )
    ...
    if (libctx != 
# 118 "../test/evp_fetch_prov_test.c" 3 4
                 ((void *)0) 
# 118 "../test/evp_fetch_prov_test.c"
                      && *libctx != 
# 118 "../test/evp_fetch_prov_test.c" 3 4
                                    ((void *)0)
# 118 "../test/evp_fetch_prov_test.c"
...
{
    OSSL_LIB_CTX *ctx = 
# 126 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 126 "../test/evp_fetch_prov_test.c"
                           ;
    int rc = 0;

    ctx = OSSL_LIB_CTX_new();
    if (!test_ptr("../test/evp_fetch_prov_test.c", 130, "ctx", ctx))
        goto err;

    if (!test_true("../test/evp_fetch_prov_test.c", 133, "OSSL_LIB_CTX_load_config(ctx, config_file)", (OSSL_LIB_CTX_load_config(ctx, config_file)) != 0))
        goto err;

    if (!test_int_eq("../test/evp_fetch_prov_test.c", 136, "OSSL_PROVIDER_available(ctx, \"legacy\")", "0", OSSL_PROVIDER_available(ctx, "legacy"), 0))
        goto err;
...
static X509_ALGOR *make_algor(int nid)
{
    ...
    if (!test_ptr("../test/evp_fetch_prov_test.c", 149, "algor = X509_ALGOR_new()", algor = X509_ALGOR_new())
        || !test_true("../test/evp_fetch_prov_test.c", 150, "X509_ALGOR_set0(algor, OBJ_nid2obj(nid), V_ASN1_UNDEF, NULL)", (X509_ALGOR_set0(algor, OBJ_nid2obj(nid), -1, 
# 150 "../test/evp_fetch_prov_test.c" 3 4
           ((void *)0)
# 150 "../test/evp_fetch_prov_test.c"
           )) != 0)
                                                          ) {
        X509_ALGOR_free(algor);
        return 
# 153 "../test/evp_fetch_prov_test.c" 3 4
              ((void *)0)
# 153 "../test/evp_fetch_prov_test.c"
                  ;
    }
    return algor;
}
...
static int test_md(const EVP_MD *md)
{
    ...
    return test_ptr("../test/evp_fetch_prov_test.c", 170, "md", md)
        && test_true("../test/evp_fetch_prov_test.c", 171, "EVP_MD_is_a(md, \"SHA256\")", (EVP_MD_is_a(md, "SHA256")) != 0)
        && test_true("../test/evp_fetch_prov_test.c", 172, "calculate_digest(md, testmsg, sizeof(testmsg), exptd)", (calculate_digest(md, testmsg, sizeof(testmsg), exptd)) != 0)
        && test_int_eq("../test/evp_fetch_prov_test.c", 173, "EVP_MD_get_size(md)", "SHA256_DIGEST_LENGTH", EVP_MD_get_size(md), 32)
        && test_int_eq("../test/evp_fetch_prov_test.c", 174, "EVP_MD_get_block_size(md)", "SHA256_CBLOCK", EVP_MD_get_block_size(md), (16*4));
}

static int test_implicit_EVP_MD_fetch(void)
{
    OSSL_LIB_CTX *ctx = 
# 179 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 179 "../test/evp_fetch_prov_test.c"
                           ;
    OSSL_PROVIDER *prov[2] = {
# 180 "../test/evp_fetch_prov_test.c" 3 4
                             ((void *)0)
# 180 "../test/evp_fetch_prov_test.c"
                                 , 
# 180 "../test/evp_fetch_prov_test.c" 3 4
                                   ((void *)0)
# 180 "../test/evp_fetch_prov_test.c"
...
{
    OSSL_LIB_CTX *ctx = 
# 192 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 192 "../test/evp_fetch_prov_test.c"
                           ;
    EVP_MD *md = 
# 193 "../test/evp_fetch_prov_test.c" 3 4
                ((void *)0)
# 193 "../test/evp_fetch_prov_test.c"
                    ;
    OSSL_PROVIDER *prov[2] = {
# 194 "../test/evp_fetch_prov_test.c" 3 4
                             ((void *)0)
# 194 "../test/evp_fetch_prov_test.c"
                                 , 
# 194 "../test/evp_fetch_prov_test.c" 3 4
                                   ((void *)0)
# 194 "../test/evp_fetch_prov_test.c"
    ...
    if (expected_fetch_result != 0) {
        ...
        if (!test_true("../test/evp_fetch_prov_test.c", 206, "EVP_MD_up_ref(md)", (EVP_MD_up_ref(md)) != 0))
            goto err;

        EVP_MD_free(md);
    } else {
        if (!test_ptr_null("../test/evp_fetch_prov_test.c", 211, "md", md))
            goto err;
    }
    ret = 1;
...
{
    int ret = 0;
    X509_ALGOR *algor = make_algor(672);
    const ASN1_OBJECT *obj;
    char id[50] = { 0 };

    if (algor == 
# 238 "../test/evp_fetch_prov_test.c" 3 4
                ((void *)0)
# 238 "../test/evp_fetch_prov_test.c"
                    )
        return 0;

    X509_ALGOR_get0(&obj, 
# 241 "../test/evp_fetch_prov_test.c" 3 4
                         ((void *)0)
# 241 "../test/evp_fetch_prov_test.c"
                             , 
# 241 "../test/evp_fetch_prov_test.c" 3 4
                               ((void *)0)
# 241 "../test/evp_fetch_prov_test.c"
    ...
    switch (idx) {
    case 0:
        if (!test_int_gt("../test/evp_fetch_prov_test.c", 244, "OBJ_obj2txt(id, sizeof(id), obj, 0)", "0", OBJ_obj2txt(id, sizeof(id), obj, 0), 0))
            goto end;
        break;
    case 1:
        if (!test_int_gt("../test/evp_fetch_prov_test.c", 248, "OBJ_obj2txt(id, sizeof(id), obj, 1)", "0", OBJ_obj2txt(id, sizeof(id), obj, 1), 0))
            goto end;
        break;
    }
                           ...
                           size_t len)
{
    ...
    EVP_CIPHER_CTX *ctx = 
# 266 "../test/evp_fetch_prov_test.c" 3 4
                         ((void *)0)
# 266 "../test/evp_fetch_prov_test.c"
                             ;
    unsigned char key[128 / 8];
    unsigned char ct[64], pt[64];

    memset(key, 0, sizeof(key));
    if (!test_ptr("../test/evp_fetch_prov_test.c", 271, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !test_true("../test/evp_fetch_prov_test.c", 272, "EVP_CipherInit_ex(ctx, cipher, NULL, key, NULL, 1)", (EVP_CipherInit_ex(ctx, cipher, 
# 272 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 272 "../test/evp_fetch_prov_test.c"
               , key, 
# 272 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 272 "../test/evp_fetch_prov_test.c"
               , 1)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 273, "EVP_CipherUpdate(ctx, ct, &ctlen, msg, len)", (EVP_CipherUpdate(ctx, ct, &ctlen, msg, len)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 274, "EVP_CipherFinal_ex(ctx, ct, &ctlen)", (EVP_CipherFinal_ex(ctx, ct, &ctlen)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 275, "EVP_CipherInit_ex(ctx, cipher, NULL, key, NULL, 0)", (EVP_CipherInit_ex(ctx, cipher, 
# 275 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 275 "../test/evp_fetch_prov_test.c"
               , key, 
# 275 "../test/evp_fetch_prov_test.c" 3 4
               ((void *)0)
# 275 "../test/evp_fetch_prov_test.c"
               , 0)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 276, "EVP_CipherUpdate(ctx, pt, &ptlen, ct, ctlen)", (EVP_CipherUpdate(ctx, pt, &ptlen, ct, ctlen)) != 0)
            || !test_true("../test/evp_fetch_prov_test.c", 277, "EVP_CipherFinal_ex(ctx, pt, &ptlen)", (EVP_CipherFinal_ex(ctx, pt, &ptlen)) != 0)
            || !test_mem_eq("../test/evp_fetch_prov_test.c", 278, "pt", "msg", pt, ptlen, msg, len))
        goto err;
...
static int test_cipher(const EVP_CIPHER *cipher)
{
    ...
    return test_ptr("../test/evp_fetch_prov_test.c", 291, "cipher", cipher)
        && test_true("../test/evp_fetch_prov_test.c", 292, "encrypt_decrypt(cipher, testmsg, sizeof(testmsg))", (encrypt_decrypt(cipher, testmsg, sizeof(testmsg))) != 0);
}

static int test_implicit_EVP_CIPHER_fetch(void)
{
    OSSL_LIB_CTX *ctx = 
# 297 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 297 "../test/evp_fetch_prov_test.c"
                           ;
    OSSL_PROVIDER *prov[2] = {
# 298 "../test/evp_fetch_prov_test.c" 3 4
                             ((void *)0)
# 298 "../test/evp_fetch_prov_test.c"
                                 , 
# 298 "../test/evp_fetch_prov_test.c" 3 4
                                   ((void *)0)
# 298 "../test/evp_fetch_prov_test.c"
...
{
    OSSL_LIB_CTX *ctx = 
# 310 "../test/evp_fetch_prov_test.c" 3 4
                       ((void *)0)
# 310 "../test/evp_fetch_prov_test.c"
                           ;
    EVP_CIPHER *cipher = 
# 311 "../test/evp_fetch_prov_test.c" 3 4
                        ((void *)0)
# 311 "../test/evp_fetch_prov_test.c"
                            ;
    OSSL_PROVIDER *prov[2] = {
# 312 "../test/evp_fetch_prov_test.c" 3 4
                             ((void *)0)
# 312 "../test/evp_fetch_prov_test.c"
                                 , 
# 312 "../test/evp_fetch_prov_test.c" 3 4
                                   ((void *)0)
# 312 "../test/evp_fetch_prov_test.c"
    ...
    if (expected_fetch_result != 0) {
        ...
        if (!test_true("../test/evp_fetch_prov_test.c", 323, "EVP_CIPHER_up_ref(cipher)", (EVP_CIPHER_up_ref(cipher)) != 0))
            goto err;

        EVP_CIPHER_free(cipher);
    } else {
        if (!test_ptr_null("../test/evp_fetch_prov_test.c", 328, "cipher", cipher))
            goto err;
    }
    ret = 1;
err:
...
{
    int ret = 0;
    X509_ALGOR *algor = make_algor(419);
    const ASN1_OBJECT *obj;
    char id[50] = { 0 };

    if (algor == 
# 354 "../test/evp_fetch_prov_test.c" 3 4
                ((void *)0)
# 354 "../test/evp_fetch_prov_test.c"
                    )
        return 0;

    X509_ALGOR_get0(&obj, 
# 357 "../test/evp_fetch_prov_test.c" 3 4
                         ((void *)0)
# 357 "../test/evp_fetch_prov_test.c"
                             , 
# 357 "../test/evp_fetch_prov_test.c" 3 4
                               ((void *)0)
# 357 "../test/evp_fetch_prov_test.c"
    ...
    switch (idx) {
    case 0:
        if (!test_int_gt("../test/evp_fetch_prov_test.c", 360, "OBJ_obj2txt(id, sizeof(id), obj, 0)", "0", OBJ_obj2txt(id, sizeof(id), obj, 0), 0))
            goto end;
        break;
    case 1:
        if (!test_int_gt("../test/evp_fetch_prov_test.c", 364, "OBJ_obj2txt(id, sizeof(id), obj, 1)", "0", OBJ_obj2txt(id, sizeof(id), obj, 1), 0))
            goto end;
        break;
    }
...
int setup_tests(void)
{
    ...
    if (strcmp(alg, "digest") == 0) {
        ...
        add_all_tests("test_explicit_EVP_MD_fetch_by_X509_ALGOR", test_explicit_EVP_MD_fetch_by_X509_ALGOR, 2, 0);
    } else {
        ...
        add_all_tests("test_explicit_EVP_CIPHER_fetch_by_X509_ALGOR", test_explicit_EVP_CIPHER_fetch_by_X509_ALGOR, 2, 0);
    }
    return 1;
}
