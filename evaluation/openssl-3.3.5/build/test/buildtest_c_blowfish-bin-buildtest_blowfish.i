# 0 "test/buildtest_blowfish.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_blowfish.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_set_key(BF_KEY *key, int len,
                                      const unsigned char *data);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_encrypt(unsigned int *data, const BF_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_decrypt(unsigned int *data, const BF_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_ecb_encrypt(const unsigned char *in,
                                          unsigned char *out, const BF_KEY *key,
                                          int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_cbc_encrypt(const unsigned char *in,
                                          unsigned char *out, long length,
                                          const BF_KEY *schedule,
                                          unsigned char *ivec, int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_cfb64_encrypt(const unsigned char *in,
                                            unsigned char *out,
                                            long length, const BF_KEY *schedule,
                                            unsigned char *ivec, int *num,
                                            int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void BF_ofb64_encrypt(const unsigned char *in,
                                            unsigned char *out,
                                            long length, const BF_KEY *schedule,
                                            unsigned char *ivec, int *num);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const char *BF_options(void);
# 11 "test/buildtest_blowfish.c" 2
