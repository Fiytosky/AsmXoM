# 0 "../test/pkcs12_format_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pkcs12_format_test.c"
# 10 "../test/pkcs12_format_test.c"
...
# 11 "../test/pkcs12_format_test.c" 2
...
# 12 "../test/pkcs12_format_test.c" 2
...
# 13 "../test/pkcs12_format_test.c" 2
...
# 15 "../test/pkcs12_format_test.c" 2
...
# 17 "../test/pkcs12_format_test.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 18 "../test/pkcs12_format_test.c" 2
...
# 20 "../test/pkcs12_format_test.c" 2
# 1 "../test/helpers/pkcs12.h" 1
# 21 "../test/helpers/pkcs12.h"
# 1 "../test/helpers/../testutil.h" 1
# 22 "../test/helpers/pkcs12.h" 2
...
void check_secretbag(PKCS12_BUILDER *pb, int secret_nid, const char *secret,
                     const PKCS12_ATTR *attrs);
# 21 "../test/pkcs12_format_test.c" 2

static int default_libctx = 1;

static OSSL_LIB_CTX *testctx = 
# 24 "../test/pkcs12_format_test.c" 3 4
                              ((void *)0)
# 24 "../test/pkcs12_format_test.c"
                                  ;
static OSSL_PROVIDER *nullprov = 
# 25 "../test/pkcs12_format_test.c" 3 4
                                ((void *)0)
# 25 "../test/pkcs12_format_test.c"
                                    ;
static OSSL_PROVIDER *deflprov = 
# 26 "../test/pkcs12_format_test.c" 3 4
                                ((void *)0)
# 26 "../test/pkcs12_format_test.c"
                                    ;
static OSSL_PROVIDER *lgcyprov = 
# 27 "../test/pkcs12_format_test.c" 3 4
                                ((void *)0)
# 27 "../test/pkcs12_format_test.c"
                                    ;
...
static const PKCS12_ATTR ATTRS1[] = {
    ...
    { 
# 196 "../test/pkcs12_format_test.c" 3 4
     ((void *)0)
# 196 "../test/pkcs12_format_test.c"
         , 
# 196 "../test/pkcs12_format_test.c" 3 4
           ((void *)0) 
# 196 "../test/pkcs12_format_test.c"
...
static const PKCS12_ATTR ATTRS2[] = {
    ...
    { 
# 203 "../test/pkcs12_format_test.c" 3 4
     ((void *)0)
# 203 "../test/pkcs12_format_test.c"
         , 
# 203 "../test/pkcs12_format_test.c" 3 4
           ((void *)0) 
# 203 "../test/pkcs12_format_test.c"
...
static const PKCS12_ATTR ATTRS3[] = {
    ...
    { 
# 210 "../test/pkcs12_format_test.c" 3 4
     ((void *)0)
# 210 "../test/pkcs12_format_test.c"
         , 
# 210 "../test/pkcs12_format_test.c" 3 4
           ((void *)0) 
# 210 "../test/pkcs12_format_test.c"
...
static const PKCS12_ATTR ATTRS4[] = {
    ...
    { "localKeyID", "1122334455" },
    { 
# 216 "../test/pkcs12_format_test.c" 3 4
     ((void *)0)
# 216 "../test/pkcs12_format_test.c"
         , 
# 216 "../test/pkcs12_format_test.c" 3 4
           ((void *)0) 
# 216 "../test/pkcs12_format_test.c"
...
static int get_custom_oid(void)
{
    ...
    if (sec_nid != -1)
        return sec_nid;
    if (!test_true("../test/pkcs12_format_test.c", 328, "OBJ_create(\"1.3.5.7.9\", \"CustomSecretOID\", \"My custom secret OID\")", (OBJ_create("1.3.5.7.9", "CustomSecretOID", "My custom secret OID")) != 0))
        return -1;
...
static int test_single_cert_no_attrs(void)
{
    ...
    start_pkcs12(pb);
        ...
        start_contentinfo(pb);
            ...
            add_certbag(pb, CERT1, sizeof(CERT1), 
# 347 "../test/pkcs12_format_test.c" 3 4
                                                 ((void *)0)
# 347 "../test/pkcs12_format_test.c"
                                                     );
    ...
    start_check_pkcs12(pb);
        ...
        start_check_contentinfo(pb);
            ...
            check_certbag(pb, CERT1, sizeof(CERT1), 
# 358 "../test/pkcs12_format_test.c" 3 4
                                                   ((void *)0)
# 358 "../test/pkcs12_format_test.c"
                                                       );
...
static int test_single_key(PKCS12_ENC *enc)
{
    ...
    start_pkcs12(pb);
        ...
        start_contentinfo(pb);
            ...
            add_keybag(pb, KEY1, sizeof(KEY1), 
# 382 "../test/pkcs12_format_test.c" 3 4
                                              ((void *)0)
# 382 "../test/pkcs12_format_test.c"
                                                  , enc);
    ...
    start_check_pkcs12(pb);
        ...
        start_check_contentinfo(pb);
            ...
            check_keybag(pb, KEY1, sizeof(KEY1), 
# 393 "../test/pkcs12_format_test.c" 3 4
                                                ((void *)0)
# 393 "../test/pkcs12_format_test.c"
                                                    , enc);
...
static int test_single_key_enc_alg(int z)
{
    ...
    if (lgcyprov == 
# 406 "../test/pkcs12_format_test.c" 3 4
                   ((void *)0)
# 406 "../test/pkcs12_format_test.c"
                       )
...
static int test_single_cert_mac(PKCS12_ENC *mac)
{
    ...
    start_pkcs12(pb);
        ...
        start_contentinfo(pb);
            ...
            add_certbag(pb, CERT1, sizeof(CERT1), 
# 482 "../test/pkcs12_format_test.c" 3 4
                                                 ((void *)0)
# 482 "../test/pkcs12_format_test.c"
                                                     );
    ...
    start_check_pkcs12_with_mac(pb, mac);
        ...
        start_check_contentinfo(pb);
            ...
            check_certbag(pb, CERT1, sizeof(CERT1), 
# 493 "../test/pkcs12_format_test.c" 3 4
                                                   ((void *)0)
# 493 "../test/pkcs12_format_test.c"
                                                       );
...
static int test_single_secret_enc_alg(int z)
{
    ...
    if (lgcyprov == 
# 667 "../test/pkcs12_format_test.c" 3 4
                   ((void *)0)
# 667 "../test/pkcs12_format_test.c"
                       )
        enc.nid = enc_nids_no_legacy[z];
    else
        enc.nid = enc_nids_all[z];
...
static int test_set0_attrs(void)
{
    ...
    PKCS12_SAFEBAG *bag = 
# 757 "../test/pkcs12_format_test.c" 3 4
                         ((void *)0)
# 757 "../test/pkcs12_format_test.c"
                             ;
    struct stack_st_X509_ATTRIBUTE *attrs = 
# 758 "../test/pkcs12_format_test.c" 3 4
                                     ((void *)0)
# 758 "../test/pkcs12_format_test.c"
                                         ;
    X509_ATTRIBUTE *attr = 
# 759 "../test/pkcs12_format_test.c" 3 4
                          ((void *)0)
# 759 "../test/pkcs12_format_test.c"
                              ;
    ...
    start_pkcs12(pb);
        ...
        start_contentinfo(pb);
            ...
            bag = ((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(pb->bags), (0)));
            attrs = (struct stack_st_X509_ATTRIBUTE*)PKCS12_SAFEBAG_get0_attrs(bag);


            attr = X509_ATTRIBUTE_create(1283, 6, OBJ_txt2obj("anyExtendedKeyUsage", 0));
            X509at_add1_attr(&attrs, attr);
            PKCS12_SAFEBAG_set0_attrs(bag, attrs);
            attrs = (struct stack_st_X509_ATTRIBUTE*)PKCS12_SAFEBAG_get0_attrs(bag);
            X509_ATTRIBUTE_free(attr);
            if(!test_ptr("../test/pkcs12_format_test.c", 777, "attrs", attrs)) {
                goto err;
            }
...
static int pkcs12_create_test(void)
{
    int ret = 0;
    EVP_PKEY *pkey = 
# 808 "../test/pkcs12_format_test.c" 3 4
                    ((void *)0)
# 808 "../test/pkcs12_format_test.c"
                        ;
    PKCS12 *p12 = 
# 809 "../test/pkcs12_format_test.c" 3 4
                 ((void *)0)
# 809 "../test/pkcs12_format_test.c"
                     ;
    ...
    p = rsa_key;
    if (!test_ptr("../test/pkcs12_format_test.c", 867, "pkey = d2i_PrivateKey_ex(EVP_PKEY_RSA, NULL, &p, sizeof(rsa_key), NULL, NULL)", pkey = d2i_PrivateKey_ex(6, 
# 867 "../test/pkcs12_format_test.c" 3 4
        ((void *)0)
# 867 "../test/pkcs12_format_test.c"
        , &p, sizeof(rsa_key), 
# 867 "../test/pkcs12_format_test.c" 3 4
        ((void *)0)
# 867 "../test/pkcs12_format_test.c"
...
# 867 "../test/pkcs12_format_test.c"
        ...
        goto err;
    if (!test_int_eq("../test/pkcs12_format_test.c", 870, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;
    p12 = PKCS12_create(
# 872 "../test/pkcs12_format_test.c" 3 4
                       ((void *)0)
# 872 "../test/pkcs12_format_test.c"
                           , 
# 872 "../test/pkcs12_format_test.c" 3 4
                             ((void *)0)
# 872 "../test/pkcs12_format_test.c"
...
# 872 "../test/pkcs12_format_test.c"
                        ...
                        146,
                        146, 2, 1, 0);
    if (!test_ptr("../test/pkcs12_format_test.c", 875, "p12", p12))
        goto err;

    if (!test_int_eq("../test/pkcs12_format_test.c", 878, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;
    ret = 1;
err:
    PKCS12_free(p12);
...
static int pkcs12_recreate_test(void)
{
    int ret = 0;
    X509 *cert = 
# 891 "../test/pkcs12_format_test.c" 3 4
                ((void *)0)
# 891 "../test/pkcs12_format_test.c"
                    ;
    X509 *cert_parsed = 
# 892 "../test/pkcs12_format_test.c" 3 4
                       ((void *)0)
# 892 "../test/pkcs12_format_test.c"
                           ;
    EVP_PKEY *pkey = 
# 893 "../test/pkcs12_format_test.c" 3 4
                    ((void *)0)
# 893 "../test/pkcs12_format_test.c"
                        ;
    EVP_PKEY *pkey_parsed = 
# 894 "../test/pkcs12_format_test.c" 3 4
                           ((void *)0)
# 894 "../test/pkcs12_format_test.c"
                               ;
    PKCS12 *p12 = 
# 895 "../test/pkcs12_format_test.c" 3 4
                 ((void *)0)
# 895 "../test/pkcs12_format_test.c"
                     ;
    PKCS12 *p12_parsed = 
# 896 "../test/pkcs12_format_test.c" 3 4
                        ((void *)0)
# 896 "../test/pkcs12_format_test.c"
                            ;
    PKCS12 *p12_recreated = 
# 897 "../test/pkcs12_format_test.c" 3 4
                           ((void *)0)
# 897 "../test/pkcs12_format_test.c"
                               ;
    const unsigned char *cert_bytes = CERT1;
    const unsigned char *key_bytes = KEY1;
    BIO *bio = 
# 900 "../test/pkcs12_format_test.c" 3 4
              ((void *)0)
# 900 "../test/pkcs12_format_test.c"
                  ;

    cert = d2i_X509(
# 902 "../test/pkcs12_format_test.c" 3 4
                   ((void *)0)
# 902 "../test/pkcs12_format_test.c"
                       , &cert_bytes, sizeof(CERT1));
    if (!test_ptr("../test/pkcs12_format_test.c", 903, "cert", cert))
        goto err;
    pkey = d2i_AutoPrivateKey(
# 905 "../test/pkcs12_format_test.c" 3 4
                             ((void *)0)
# 905 "../test/pkcs12_format_test.c"
                                 , &key_bytes, sizeof(KEY1));
    if (!test_ptr("../test/pkcs12_format_test.c", 906, "pkey", pkey))
        goto err;
    p12 = PKCS12_create("pass", 
# 908 "../test/pkcs12_format_test.c" 3 4
                               ((void *)0)
# 908 "../test/pkcs12_format_test.c"
                                   , pkey, cert, 
# 908 "../test/pkcs12_format_test.c" 3 4
                                                 ((void *)0)
# 908 "../test/pkcs12_format_test.c"
                                                     , 427,
                        427, 2, 1, 0);
    if (!test_ptr("../test/pkcs12_format_test.c", 910, "p12", p12))
        goto err;
    if (!test_int_eq("../test/pkcs12_format_test.c", 912, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;

    bio = BIO_new(BIO_s_mem());
    if (!test_ptr("../test/pkcs12_format_test.c", 916, "bio", bio))
        goto err;
    if (!test_int_eq("../test/pkcs12_format_test.c", 918, "i2d_PKCS12_bio(bio, p12)", "1", i2d_PKCS12_bio(bio, p12), 1))
        goto err;
    p12_parsed = PKCS12_init_ex(21, testctx, 
# 920 "../test/pkcs12_format_test.c" 3 4
                                                        ((void *)0)
# 920 "../test/pkcs12_format_test.c"
                                                            );
    if (!test_ptr("../test/pkcs12_format_test.c", 921, "p12_parsed", p12_parsed))
        goto err;
    p12_parsed = d2i_PKCS12_bio(bio, &p12_parsed);
    if (!test_ptr("../test/pkcs12_format_test.c", 924, "p12_parsed", p12_parsed))
        goto err;
    if (!test_int_eq("../test/pkcs12_format_test.c", 926, "PKCS12_parse(p12_parsed, \"pass\", &pkey_parsed, &cert_parsed, NULL)", "1", PKCS12_parse(p12_parsed, "pass", &pkey_parsed, &cert_parsed, 
# 926 "../test/pkcs12_format_test.c" 3 4
        ((void *)0)
# 926 "../test/pkcs12_format_test.c"
        ), 1)
                                                         )
        goto err;


    p12_recreated = PKCS12_create("new_pass", 
# 931 "../test/pkcs12_format_test.c" 3 4
                                             ((void *)0)
# 931 "../test/pkcs12_format_test.c"
                                                 , pkey_parsed, cert_parsed,
                                  
# 932 "../test/pkcs12_format_test.c" 3 4
                                 ((void *)0)
# 932 "../test/pkcs12_format_test.c"
                                     , 427, 427,
                                  2, 1, 0);
    if (!test_ptr("../test/pkcs12_format_test.c", 934, "p12_recreated", p12_recreated))
        goto err;
    if (!test_int_eq("../test/pkcs12_format_test.c", 936, "ERR_peek_error()", "0", ERR_peek_error(), 0))
        goto err;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 968 "../test/pkcs12_format_test.c" 3 4
         ((void *)0) 
# 968 "../test/pkcs12_format_test.c"
              }
    };
    return options;
}
...
int setup_tests(void)
{
    ...
    if (!default_libctx) {
        ...
        if (!test_ptr("../test/pkcs12_format_test.c", 997, "testctx", testctx))
            return 0;
        nullprov = OSSL_PROVIDER_load(
# 999 "../test/pkcs12_format_test.c" 3 4
                                     ((void *)0)
# 999 "../test/pkcs12_format_test.c"
                                         , "null");
        if (!test_ptr("../test/pkcs12_format_test.c", 1000, "nullprov", nullprov))
            return 0;
    }

    deflprov = OSSL_PROVIDER_load(testctx, "default");
    if (!test_ptr("../test/pkcs12_format_test.c", 1005, "deflprov", deflprov))
        return 0;
    ...
    if (!default_libctx) {
        if (!test_false("../test/pkcs12_format_test.c", 1016, "OSSL_PROVIDER_available(NULL, \"default\")", (OSSL_PROVIDER_available(
# 1016 "../test/pkcs12_format_test.c" 3 4
            ((void *)0)
# 1016 "../test/pkcs12_format_test.c"
            , "default")) != 0)
                || !test_false("../test/pkcs12_format_test.c", 1017, "OSSL_PROVIDER_available(NULL, \"fips\")", (OSSL_PROVIDER_available(
# 1017 "../test/pkcs12_format_test.c" 3 4
                   ((void *)0)
# 1017 "../test/pkcs12_format_test.c"
                   , "fips")) != 0))
            return 0;
    }
    ...
    if (lgcyprov == 
# 1022 "../test/pkcs12_format_test.c" 3 4
                   ((void *)0)
# 1022 "../test/pkcs12_format_test.c"
                       ) {
        add_all_tests("test_single_key_enc_alg", test_single_key_enc_alg, (sizeof(enc_nids_no_legacy)/sizeof((enc_nids_no_legacy)[0])), 1);
        add_all_tests("test_single_secret_enc_alg", test_single_secret_enc_alg, (sizeof(enc_nids_no_legacy)/sizeof((enc_nids_no_legacy)[0])), 1);
    } else {
        add_all_tests("test_single_key_enc_alg", test_single_key_enc_alg, (sizeof(enc_nids_all)/sizeof((enc_nids_all)[0])), 1);
        add_all_tests("test_single_secret_enc_alg", test_single_secret_enc_alg, (sizeof(enc_nids_all)/sizeof((enc_nids_all)[0])), 1);
    }

    if (default_libctx)
        add_test("pkcs12_create_test", pkcs12_create_test);

    if (default_libctx)
        add_test("pkcs12_recreate_test", pkcs12_recreate_test);
    add_all_tests("test_single_key_enc_pass", test_single_key_enc_pass, (sizeof(passwords)/sizeof((passwords)[0])), 1);
    add_all_tests("test_single_key_enc_iter", test_single_key_enc_iter, (sizeof(iters)/sizeof((iters)[0])), 1);
    add_test("test_single_key_with_attrs", test_single_key_with_attrs);
    add_all_tests("test_single_cert_mac_alg", test_single_cert_mac_alg, (sizeof(mac_nids)/sizeof((mac_nids)[0])), 1);
    add_all_tests("test_single_cert_mac_pass", test_single_cert_mac_pass, (sizeof(passwords)/sizeof((passwords)[0])), 1);
    add_all_tests("test_single_cert_mac_iter", test_single_cert_mac_iter, (sizeof(iters)/sizeof((iters)[0])), 1);
    ...
    add_test("test_set0_attrs", test_set0_attrs);
    return 1;
}
