# 0 "../test/ec_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ec_internal_test.c"
# 13 "../test/ec_internal_test.c"
...
# 14 "../test/ec_internal_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../test/ec_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
# 19 "../test/ec_internal_test.c" 2


static size_t crv_len = 0;
static EC_builtin_curve *curves = 
# 22 "../test/ec_internal_test.c" 3 4
                                 ((void *)0)
# 22 "../test/ec_internal_test.c"
                                     ;
...
{
    BIGNUM *a = 
# 27 "../test/ec_internal_test.c" 3 4
               ((void *)0)
# 27 "../test/ec_internal_test.c"
                   , *b = 
# 27 "../test/ec_internal_test.c" 3 4
                          ((void *)0)
# 27 "../test/ec_internal_test.c"
...
# 27 "../test/ec_internal_test.c"
    ...
    if (group->meth->field_inv == 
# 30 "../test/ec_internal_test.c" 3 4
                                 ((void *)0) 
# 30 "../test/ec_internal_test.c"
                                      || group->meth->field_mul == 
# 30 "../test/ec_internal_test.c" 3 4
                                                                   ((void *)0)
# 30 "../test/ec_internal_test.c"
                                                                       )
    ...
    a = BN_CTX_get(ctx);
    b = BN_CTX_get(ctx);
    if (!test_ptr("../test/ec_internal_test.c", 36, "c = BN_CTX_get(ctx)", c = BN_CTX_get(ctx))

        || !test_true("../test/ec_internal_test.c", 38, "group->meth->field_inv(group, b, BN_value_one(), ctx)", (group->meth->field_inv(group, b, BN_value_one(), ctx)) != 0)
        || !test_true("../test/ec_internal_test.c", 39, "BN_is_one(b)", (BN_is_one(b)) != 0)

        || !test_true("../test/ec_internal_test.c", 41, "BN_rand(a, BN_num_bits(group->field) - 1, BN_RAND_TOP_ONE, BN_RAND_BOTTOM_ANY)", (BN_rand(a, BN_num_bits(group->field) - 1, 0, 0)) != 0)

        || !test_true("../test/ec_internal_test.c", 43, "group->meth->field_inv(group, b, a, ctx)", (group->meth->field_inv(group, b, a, ctx)) != 0)
        || (group->meth->field_encode &&
            !test_true("../test/ec_internal_test.c", 45, "group->meth->field_encode(group, a, a, ctx)", (group->meth->field_encode(group, a, a, ctx)) != 0))
        || (group->meth->field_encode &&
            !test_true("../test/ec_internal_test.c", 47, "group->meth->field_encode(group, b, b, ctx)", (group->meth->field_encode(group, b, b, ctx)) != 0))
        || !test_true("../test/ec_internal_test.c", 48, "group->meth->field_mul(group, c, a, b, ctx)", (group->meth->field_mul(group, c, a, b, ctx)) != 0)
        || (group->meth->field_decode &&
            !test_true("../test/ec_internal_test.c", 50, "group->meth->field_decode(group, c, c, ctx)", (group->meth->field_decode(group, c, c, ctx)) != 0))
        || !test_true("../test/ec_internal_test.c", 51, "BN_is_one(c)", (BN_is_one(c)) != 0))
        goto err;


    BN_zero_ex(a);
    if (!test_false("../test/ec_internal_test.c", 56, "group->meth->field_inv(group, b, a, ctx)", (group->meth->field_inv(group, b, a, ctx)) != 0)
        || !test_true("../test/ec_internal_test.c", 57, "ERR_GET_LIB(ERR_peek_last_error()) == ERR_LIB_EC", (ERR_GET_LIB(ERR_peek_last_error()) == 16) != 0)
        || !test_true("../test/ec_internal_test.c", 58, "ERR_GET_REASON(ERR_peek_last_error()) == EC_R_CANNOT_INVERT", (ERR_GET_REASON(ERR_peek_last_error()) == 165) != 0)


        || !test_false("../test/ec_internal_test.c", 61, "group->meth->field_inv(group, b, group->field, ctx)", (group->meth->field_inv(group, b, group->field, ctx)) != 0)
        || !test_true("../test/ec_internal_test.c", 62, "ERR_GET_LIB(ERR_peek_last_error()) == ERR_LIB_EC", (ERR_GET_LIB(ERR_peek_last_error()) == 16) != 0)
        || !test_true("../test/ec_internal_test.c", 63, "ERR_GET_REASON(ERR_peek_last_error()) == EC_R_CANNOT_INVERT", (ERR_GET_REASON(ERR_peek_last_error()) == 165) != 0)
                                         )
        goto err;
...
{
    BN_CTX *ctx = 
# 78 "../test/ec_internal_test.c" 3 4
                 ((void *)0)
# 78 "../test/ec_internal_test.c"
                     ;
    BIGNUM *p = 
# 79 "../test/ec_internal_test.c" 3 4
               ((void *)0)
# 79 "../test/ec_internal_test.c"
                   , *a = 
# 79 "../test/ec_internal_test.c" 3 4
                          ((void *)0)
# 79 "../test/ec_internal_test.c"
...
# 79 "../test/ec_internal_test.c"
                                         ;
    EC_GROUP *group = 
# 80 "../test/ec_internal_test.c" 3 4
                     ((void *)0)
# 80 "../test/ec_internal_test.c"
                         ;
    int ret = 0;

    if (!test_ptr("../test/ec_internal_test.c", 83, "ctx = BN_CTX_new()", ctx = BN_CTX_new()))
        return 0;

    BN_CTX_start(ctx);
    p = BN_CTX_get(ctx);
    a = BN_CTX_get(ctx);
    if (!test_ptr("../test/ec_internal_test.c", 89, "b = BN_CTX_get(ctx)", b = BN_CTX_get(ctx))
        || !test_ptr("../test/ec_internal_test.c", 90, "group = EC_GROUP_new(meth)", group = EC_GROUP_new(meth))
        || !test_true("../test/ec_internal_test.c", 91, "BN_bin2bn(params, len, p)", (BN_bin2bn(params, len, p)) != 0)
        || !test_true("../test/ec_internal_test.c", 92, "BN_bin2bn(params + len, len, a)", (BN_bin2bn(params + len, len, a)) != 0)
        || !test_true("../test/ec_internal_test.c", 93, "BN_bin2bn(params + 2 * len, len, b)", (BN_bin2bn(params + 2 * len, len, b)) != 0)
        || !test_true("../test/ec_internal_test.c", 94, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)
 ...
 err:
    ...
    BN_CTX_free(ctx);
    if (group != 
# 102 "../test/ec_internal_test.c" 3 4
                ((void *)0)
# 102 "../test/ec_internal_test.c"
                    )
        EC_GROUP_free(group);
    return ret;
}
...
{
    test_info("../test/ec_internal_test.c", 144, "Testing EC_GFp_simple_method()\n");
...
{
    test_info("../test/ec_internal_test.c", 152, "Testing EC_GFp_mont_method()\n");
...
static int ec2m_field_sanity(void)
{
    ...
    BIGNUM *p, *a, *b;
    EC_GROUP *group1 = 
# 164 "../test/ec_internal_test.c" 3 4
                      ((void *)0)
# 164 "../test/ec_internal_test.c"
                          , *group2 = 
# 164 "../test/ec_internal_test.c" 3 4
                                      ((void *)0)
# 164 "../test/ec_internal_test.c"
...
# 164 "../test/ec_internal_test.c"
    ...
    test_info("../test/ec_internal_test.c", 166, "Testing GF2m hardening\n");

    BN_CTX_start(ctx);
    p = BN_CTX_get(ctx);
    a = BN_CTX_get(ctx);
    if (!test_ptr("../test/ec_internal_test.c", 171, "b = BN_CTX_get(ctx)", b = BN_CTX_get(ctx))
        || !test_true("../test/ec_internal_test.c", 172, "BN_one(a)", ((BN_set_word((a),1))) != 0)
        || !test_true("../test/ec_internal_test.c", 173, "BN_one(b)", ((BN_set_word((b),1))) != 0))
        goto out;


    if (!test_true("../test/ec_internal_test.c", 177, "BN_set_word(p, 0xf2)", (BN_set_word(p, 0xf2)) != 0))
        goto out;
    if (!test_ptr_null("../test/ec_internal_test.c", 179, "group1 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", group1 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)))
        test_error("../test/ec_internal_test.c", 180, "Zero constant term accepted in GF2m polynomial");


    if (!test_true("../test/ec_internal_test.c", 183, "BN_set_word(p, 0xf3)", (BN_set_word(p, 0xf3)) != 0))
        goto out;
    if (!test_ptr_null("../test/ec_internal_test.c", 185, "group2 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", group2 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)))
        test_error("../test/ec_internal_test.c", 186, "Hexanomial accepted as GF2m polynomial");


    if (!test_true("../test/ec_internal_test.c", 189, "BN_set_word(p, 0x71)", (BN_set_word(p, 0x71)) != 0)
        || !test_true("../test/ec_internal_test.c", 190, "BN_set_bit(p, OPENSSL_ECC_MAX_FIELD_BITS + 1)", (BN_set_bit(p, 661 + 1)) != 0))
        goto out;
    if (!test_ptr_null("../test/ec_internal_test.c", 192, "group3 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", group3 = EC_GROUP_new_curve_GF2m(p, a, b, ctx)))
        test_error("../test/ec_internal_test.c", 193, "GF2m polynomial degree > %d accepted", 661)
                                              ;

    ret = group1 == 
# 196 "../test/ec_internal_test.c" 3 4
                   ((void *)0) 
# 196 "../test/ec_internal_test.c"
                        && group2 == 
# 196 "../test/ec_internal_test.c" 3 4
                                     ((void *)0) 
# 196 "../test/ec_internal_test.c"
...
{
    test_info("../test/ec_internal_test.c", 211, "Testing EC_GF2m_simple_method()\n");
...
{
    BN_CTX *ctx = 
# 220 "../test/ec_internal_test.c" 3 4
                 ((void *)0)
# 220 "../test/ec_internal_test.c"
                     ;
    EC_GROUP *group = 
# 221 "../test/ec_internal_test.c" 3 4
                     ((void *)0)
# 221 "../test/ec_internal_test.c"
                         ;
    int nid = curves[n].nid;
    int ret = 0;

    test_info("../test/ec_internal_test.c", 225, "Testing curve %s\n", OBJ_nid2sn(nid));

    if (!test_ptr("../test/ec_internal_test.c", 227, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))
        || !test_ptr("../test/ec_internal_test.c", 228, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !group_field_tests(group, ctx))
        goto err;
 ...
 err:
    if (group != 
# 234 "../test/ec_internal_test.c" 3 4
                ((void *)0)
# 234 "../test/ec_internal_test.c"
                    )
        EC_GROUP_free(group);
    if (ctx != 
# 236 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 236 "../test/ec_internal_test.c"
                  )
        BN_CTX_free(ctx);
    return ret;
}
# 315 "../test/ec_internal_test.c"
static int set_private_key(void)
{
    EC_KEY *key = 
# 317 "../test/ec_internal_test.c" 3 4
                 ((void *)0)
# 317 "../test/ec_internal_test.c"
                     , *aux_key = 
# 317 "../test/ec_internal_test.c" 3 4
                                  ((void *)0)
# 317 "../test/ec_internal_test.c"
    ...
    key = EC_KEY_new_by_curve_name(713);
    aux_key = EC_KEY_new_by_curve_name(713);
    if (!test_ptr("../test/ec_internal_test.c", 322, "key", key)
        || !test_ptr("../test/ec_internal_test.c", 323, "aux_key", aux_key)
        || !test_int_eq("../test/ec_internal_test.c", 324, "EC_KEY_generate_key(key)", "1", EC_KEY_generate_key(key), 1)
        || !test_int_eq("../test/ec_internal_test.c", 325, "EC_KEY_generate_key(aux_key)", "1", EC_KEY_generate_key(aux_key), 1))
        goto err;


    if (!test_int_eq("../test/ec_internal_test.c", 329, "EC_KEY_set_private_key(key, aux_key->priv_key)", "1", EC_KEY_set_private_key(key, aux_key->priv_key), 1))
        goto err;


    if (!test_int_eq("../test/ec_internal_test.c", 333, "EC_KEY_set_private_key(key, NULL)", "0", EC_KEY_set_private_key(key, 
# 333 "../test/ec_internal_test.c" 3 4
        ((void *)0)
# 333 "../test/ec_internal_test.c"
        ), 0)
        || !test_ptr_null("../test/ec_internal_test.c", 334, "key->priv_key", key->priv_key))
        goto err;
...
static int decoded_flag_test(void)
{
    EC_GROUP *grp;
    EC_GROUP *grp_copy = 
# 351 "../test/ec_internal_test.c" 3 4
                        ((void *)0)
# 351 "../test/ec_internal_test.c"
                            ;
    ECPARAMETERS *ecparams = 
# 352 "../test/ec_internal_test.c" 3 4
                            ((void *)0)
# 352 "../test/ec_internal_test.c"
                                ;
    ECPKPARAMETERS *ecpkparams = 
# 353 "../test/ec_internal_test.c" 3 4
                                ((void *)0)
# 353 "../test/ec_internal_test.c"
                                    ;
    EC_KEY *key = 
# 354 "../test/ec_internal_test.c" 3 4
                 ((void *)0)
# 354 "../test/ec_internal_test.c"
                     ;
    unsigned char *encodedparams = 
# 355 "../test/ec_internal_test.c" 3 4
                                  ((void *)0)
# 355 "../test/ec_internal_test.c"
                                      ;
    ...
    if (!test_ptr("../test/ec_internal_test.c", 362, "grp", grp)
        || !test_int_eq("../test/ec_internal_test.c", 363, "grp->decoded_from_explicit_params", "0", grp->decoded_from_explicit_params, 0))
        goto err;
    EC_GROUP_free(grp);


    grp = EC_GROUP_new_by_curve_name(415);
    if (!test_ptr("../test/ec_internal_test.c", 369, "grp", grp)
        || !test_int_eq("../test/ec_internal_test.c", 370, "grp->decoded_from_explicit_params", "0", grp->decoded_from_explicit_params, 0))
        goto err;


    if (!test_ptr("../test/ec_internal_test.c", 374, "ecparams = EC_GROUP_get_ecparameters(grp, NULL)", ecparams = EC_GROUP_get_ecparameters(grp, 
# 374 "../test/ec_internal_test.c" 3 4
        ((void *)0)
# 374 "../test/ec_internal_test.c"
        ))
        || !test_ptr("../test/ec_internal_test.c", 375, "grp_copy = EC_GROUP_new_from_ecparameters(ecparams)", grp_copy = EC_GROUP_new_from_ecparameters(ecparams))
        || !test_int_eq("../test/ec_internal_test.c", 376, "grp_copy->decoded_from_explicit_params", "0", grp_copy->decoded_from_explicit_params, 0))
        goto err;
    EC_GROUP_free(grp_copy);
    grp_copy = 
# 379 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 379 "../test/ec_internal_test.c"
                  ;
    ECPARAMETERS_free(ecparams);
    ecparams = 
# 381 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 381 "../test/ec_internal_test.c"
                  ;


    if (!test_int_eq("../test/ec_internal_test.c", 384, "EC_GROUP_get_asn1_flag(grp)", "OPENSSL_EC_NAMED_CURVE", EC_GROUP_get_asn1_flag(grp), 0x001)
        || !test_ptr("../test/ec_internal_test.c", 385, "ecpkparams = EC_GROUP_get_ecpkparameters(grp, NULL)", ecpkparams = EC_GROUP_get_ecpkparameters(grp, 
# 385 "../test/ec_internal_test.c" 3 4
           ((void *)0)
# 385 "../test/ec_internal_test.c"
           ))
        || !test_ptr("../test/ec_internal_test.c", 386, "grp_copy = EC_GROUP_new_from_ecpkparameters(ecpkparams)", grp_copy = EC_GROUP_new_from_ecpkparameters(ecpkparams))
        || !test_int_eq("../test/ec_internal_test.c", 387, "grp_copy->decoded_from_explicit_params", "0", grp_copy->decoded_from_explicit_params, 0)
        || !test_ptr("../test/ec_internal_test.c", 388, "key = EC_KEY_new()", key = EC_KEY_new())

        || !test_int_eq("../test/ec_internal_test.c", 390, "EC_KEY_decoded_from_explicit_params(key)", "-1", EC_KEY_decoded_from_explicit_params(key), -1)
        || !test_int_eq("../test/ec_internal_test.c", 391, "EC_KEY_set_group(key, grp_copy)", "1", EC_KEY_set_group(key, grp_copy), 1)

        || !test_int_eq("../test/ec_internal_test.c", 393, "EC_KEY_decoded_from_explicit_params(key)", "0", EC_KEY_decoded_from_explicit_params(key), 0))
        goto err;
    EC_GROUP_free(grp_copy);
    grp_copy = 
# 396 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 396 "../test/ec_internal_test.c"
                  ;
    ECPKPARAMETERS_free(ecpkparams);
    ecpkparams = 
# 398 "../test/ec_internal_test.c" 3 4
                ((void *)0)
# 398 "../test/ec_internal_test.c"
                    ;


    if (!test_int_gt("../test/ec_internal_test.c", 401, "encodedlen = i2d_ECPKParameters(grp, &encodedparams)", "0", encodedlen = i2d_ECPKParameters(grp, &encodedparams), 0)
        || !test_ptr("../test/ec_internal_test.c", 402, "encp = encodedparams", encp = encodedparams)
        || !test_ptr("../test/ec_internal_test.c", 403, "grp_copy = d2i_ECPKParameters(NULL, &encp, encodedlen)", grp_copy = d2i_ECPKParameters(
# 403 "../test/ec_internal_test.c" 3 4
           ((void *)0)
# 403 "../test/ec_internal_test.c"
           , &encp, encodedlen))
        || !test_int_eq("../test/ec_internal_test.c", 404, "grp_copy->decoded_from_explicit_params", "0", grp_copy->decoded_from_explicit_params, 0))
        goto err;
    EC_GROUP_free(grp_copy);
    grp_copy = 
# 407 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 407 "../test/ec_internal_test.c"
                  ;
    CRYPTO_free(encodedparams, "../test/ec_internal_test.c", 408);
    encodedparams = 
# 409 "../test/ec_internal_test.c" 3 4
                   ((void *)0)
# 409 "../test/ec_internal_test.c"
                       ;


    EC_GROUP_set_asn1_flag(grp, 0x000);
    if (!test_ptr("../test/ec_internal_test.c", 413, "ecpkparams = EC_GROUP_get_ecpkparameters(grp, NULL)", ecpkparams = EC_GROUP_get_ecpkparameters(grp, 
# 413 "../test/ec_internal_test.c" 3 4
        ((void *)0)
# 413 "../test/ec_internal_test.c"
        ))
        || !test_ptr("../test/ec_internal_test.c", 414, "grp_copy = EC_GROUP_new_from_ecpkparameters(ecpkparams)", grp_copy = EC_GROUP_new_from_ecpkparameters(ecpkparams))
        || !test_int_eq("../test/ec_internal_test.c", 415, "EC_GROUP_get_asn1_flag(grp_copy)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(grp_copy), 0x000)
        || !test_int_eq("../test/ec_internal_test.c", 416, "grp_copy->decoded_from_explicit_params", "0", grp_copy->decoded_from_explicit_params, 0))
        goto err;
    EC_GROUP_free(grp_copy);
    grp_copy = 
# 419 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 419 "../test/ec_internal_test.c"
                  ;


    if (!test_int_gt("../test/ec_internal_test.c", 422, "encodedlen = i2d_ECPKParameters(grp, &encodedparams)", "0", encodedlen = i2d_ECPKParameters(grp, &encodedparams), 0)
        || !test_ptr("../test/ec_internal_test.c", 423, "encp = encodedparams", encp = encodedparams)
        || !test_ptr("../test/ec_internal_test.c", 424, "grp_copy = d2i_ECPKParameters(NULL, &encp, encodedlen)", grp_copy = d2i_ECPKParameters(
# 424 "../test/ec_internal_test.c" 3 4
           ((void *)0)
# 424 "../test/ec_internal_test.c"
           , &encp, encodedlen))
        || !test_int_eq("../test/ec_internal_test.c", 425, "EC_GROUP_get_asn1_flag(grp_copy)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(grp_copy), 0x000)
        || !test_int_eq("../test/ec_internal_test.c", 426, "grp_copy->decoded_from_explicit_params", "1", grp_copy->decoded_from_explicit_params, 1)
        || !test_int_eq("../test/ec_internal_test.c", 427, "EC_KEY_set_group(key, grp_copy)", "1", EC_KEY_set_group(key, grp_copy), 1)

        || !test_int_eq("../test/ec_internal_test.c", 429, "EC_KEY_decoded_from_explicit_params(key)", "1", EC_KEY_decoded_from_explicit_params(key), 1))
        goto err;
 ...
 err:
    ...
    ECPARAMETERS_free(ecparams);
    ECPKPARAMETERS_free(ecpkparams);
    CRYPTO_free(encodedparams, "../test/ec_internal_test.c", 440);
...
{
    EC_GROUP *g1 = 
# 448 "../test/ec_internal_test.c" 3 4
                  ((void *)0)
# 448 "../test/ec_internal_test.c"
                      , *g2 = 
# 448 "../test/ec_internal_test.c" 3 4
                              ((void *)0)
# 448 "../test/ec_internal_test.c"
                                  ;
    FILE *fp = 
# 449 "../test/ec_internal_test.c" 3 4
              ((void *)0)
# 449 "../test/ec_internal_test.c"
                  ;
    int nid = curves[n].nid;
    int testresult = 0;


    if (!test_ptr("../test/ec_internal_test.c", 454, "g1 = EC_GROUP_new_by_curve_name(nid)", g1 = EC_GROUP_new_by_curve_name(nid)))
        goto end;


    if (!test_ptr("../test/ec_internal_test.c", 458, "fp = fopen(\"params.der\", \"wb\")", fp = fopen("params.der", "wb"))
            || !test_true("../test/ec_internal_test.c", 459, "i2d_ECPKParameters_fp(fp, g1)", (ASN1_i2d_fp((i2d_of_void *)i2d_ECPKParameters, (fp), (void *)(g1))) != 0))
        goto end;


    if (!test_int_eq("../test/ec_internal_test.c", 463, "fclose(fp)", "0", fclose(fp), 0)) {
        fp = 
# 464 "../test/ec_internal_test.c" 3 4
            ((void *)0)
# 464 "../test/ec_internal_test.c"
                ;
        goto end;
    }
    fp = 
# 467 "../test/ec_internal_test.c" 3 4
        ((void *)0)
# 467 "../test/ec_internal_test.c"
            ;


    if (!test_ptr("../test/ec_internal_test.c", 470, "fp = fopen(\"params.der\", \"rb\")", fp = fopen("params.der", "rb"))
            || !test_ptr("../test/ec_internal_test.c", 471, "g2 = d2i_ECPKParameters_fp(fp, NULL)", g2 = (EC_GROUP *)ASN1_d2i_fp(
# 471 "../test/ec_internal_test.c" 3 4
               ((void *)0)
# 471 "../test/ec_internal_test.c"
               , (d2i_of_void *)d2i_ECPKParameters, (fp), (void **)(
# 471 "../test/ec_internal_test.c" 3 4
               ((void *)0)
# 471 "../test/ec_internal_test.c"
               ))))
    ...
    if (fp != 
# 477 "../test/ec_internal_test.c" 3 4
             ((void *)0)
# 477 "../test/ec_internal_test.c"
                 )
        fclose(fp);
...
# 488 "../test/ec_internal_test.c" 3 4
                                   ((void *)0)
# 488 "../test/ec_internal_test.c"
                                       , 0);
    if (!test_ptr("../test/ec_internal_test.c", 489, "curves = OPENSSL_malloc(sizeof(*curves) * crv_len)", curves = CRYPTO_malloc(sizeof(*curves) * crv_len, "../test/ec_internal_test.c", 489))
        || !test_true("../test/ec_internal_test.c", 490, "EC_get_builtin_curves(curves, crv_len)", (EC_get_builtin_curves(curves, crv_len)) != 0))
        return 0;
    ...
    add_all_tests("field_tests_default", field_tests_default, crv_len, 1);



    add_test("set_private_key", set_private_key);
    add_test("decoded_flag_test", decoded_flag_test);
    add_all_tests("ecpkparams_i2d2i_test", ecpkparams_i2d2i_test, crv_len, 1);
...
void cleanup_tests(void)
{
    CRYPTO_free(curves, "../test/ec_internal_test.c", 512);
}
