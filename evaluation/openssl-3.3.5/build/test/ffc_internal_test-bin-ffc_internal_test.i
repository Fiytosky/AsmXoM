# 0 "../test/ffc_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ffc_internal_test.c"
# 15 "../test/ffc_internal_test.c"
...
# 20 "../test/ffc_internal_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 22 "../test/ffc_internal_test.c" 2
...
static int ffc_params_validate_g_unverified_test(void)
{
    ...
    FFC_PARAMS params;
    BIGNUM *p = 
# 178 "../test/ffc_internal_test.c" 3 4
               ((void *)0)
# 178 "../test/ffc_internal_test.c"
                   , *q = 
# 178 "../test/ffc_internal_test.c" 3 4
                          ((void *)0)
# 178 "../test/ffc_internal_test.c"
...
# 178 "../test/ffc_internal_test.c"
                                         ;
    BIGNUM *p1 = 
# 179 "../test/ffc_internal_test.c" 3 4
                ((void *)0)
# 179 "../test/ffc_internal_test.c"
                    , *g1 = 
# 179 "../test/ffc_internal_test.c" 3 4
                            ((void *)0)
# 179 "../test/ffc_internal_test.c"
    ...
    if (!test_ptr("../test/ffc_internal_test.c", 183, "p = BN_bin2bn(dsa_2048_224_sha256_p, sizeof(dsa_2048_224_sha256_p), NULL)", p = BN_bin2bn(dsa_2048_224_sha256_p, sizeof(dsa_2048_224_sha256_p), 
# 183 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 183 "../test/ffc_internal_test.c"
        ))
                                                                     )
        goto err;
    p1 = p;
    if (!test_ptr("../test/ffc_internal_test.c", 187, "q = BN_bin2bn(dsa_2048_224_sha256_q, sizeof(dsa_2048_224_sha256_q), NULL)", q = BN_bin2bn(dsa_2048_224_sha256_q, sizeof(dsa_2048_224_sha256_q), 
# 187 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 187 "../test/ffc_internal_test.c"
        ))
                                                                     )
        goto err;
    if (!test_ptr("../test/ffc_internal_test.c", 190, "g = BN_bin2bn(dsa_2048_224_sha256_g, sizeof(dsa_2048_224_sha256_g), NULL)", g = BN_bin2bn(dsa_2048_224_sha256_g, sizeof(dsa_2048_224_sha256_g), 
# 190 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 190 "../test/ffc_internal_test.c"
        ))
                                                                     )
        goto err;
    g1 = g;
    ...
    ossl_ffc_params_set0_pqg(&params, p, q, 
# 196 "../test/ffc_internal_test.c" 3 4
                                           ((void *)0)
# 196 "../test/ffc_internal_test.c"
                                               );
    p = 
# 197 "../test/ffc_internal_test.c" 3 4
       ((void *)0)
# 197 "../test/ffc_internal_test.c"
           ;
    q = 
# 198 "../test/ffc_internal_test.c" 3 4
       ((void *)0)
# 198 "../test/ffc_internal_test.c"
           ;
    ossl_ffc_params_set_flags(&params, 0x02);
    ossl_ffc_set_digest(&params, "SHA256", 
# 200 "../test/ffc_internal_test.c" 3 4
                                          ((void *)0)
# 200 "../test/ffc_internal_test.c"
                                              );

    if (!test_false("../test/ffc_internal_test.c", 202, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 202 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 202 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 202 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 202 "../test/ffc_internal_test.c"
    ...
    g = 
# 208 "../test/ffc_internal_test.c" 3 4
       ((void *)0)
# 208 "../test/ffc_internal_test.c"
           ;
    if (!test_true("../test/ffc_internal_test.c", 209, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 209 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 209 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 209 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 209 "../test/ffc_internal_test.c"
    ...
    BN_add_word(g1, 1);
    if (!test_false("../test/ffc_internal_test.c", 216, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 216 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 216 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 216 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 216 "../test/ffc_internal_test.c"
    ...
    BN_set_word(g1, 1);
    if (!test_false("../test/ffc_internal_test.c", 223, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 223 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 223 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 223 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 223 "../test/ffc_internal_test.c"
    ...
    if (!test_false("../test/ffc_internal_test.c", 230, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 230 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 230 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 230 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 230 "../test/ffc_internal_test.c"
...
static int ffc_params_validate_pq_test(void)
{
    ...
    FFC_PARAMS params;
    BIGNUM *p = 
# 248 "../test/ffc_internal_test.c" 3 4
               ((void *)0)
# 248 "../test/ffc_internal_test.c"
                   , *q = 
# 248 "../test/ffc_internal_test.c" 3 4
                          ((void *)0)
# 248 "../test/ffc_internal_test.c"
    ...
    ossl_ffc_params_init(&params);
    if (!test_ptr("../test/ffc_internal_test.c", 251, "p = BN_bin2bn(dsa_2048_224_sha224_p, sizeof(dsa_2048_224_sha224_p), NULL)", p = BN_bin2bn(dsa_2048_224_sha224_p, sizeof(dsa_2048_224_sha224_p), 
# 251 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 251 "../test/ffc_internal_test.c"
        ))

                                         )
        goto err;
    if (!test_ptr("../test/ffc_internal_test.c", 255, "q = BN_bin2bn(dsa_2048_224_sha224_q, sizeof(dsa_2048_224_sha224_q), NULL)", q = BN_bin2bn(dsa_2048_224_sha224_q, sizeof(dsa_2048_224_sha224_q), 
# 255 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 255 "../test/ffc_internal_test.c"
        ))
    ...
    ossl_ffc_params_set0_pqg(&params, 
# 261 "../test/ffc_internal_test.c" 3 4
                                     ((void *)0)
# 261 "../test/ffc_internal_test.c"
                                         , q, 
# 261 "../test/ffc_internal_test.c" 3 4
                                              ((void *)0)
# 261 "../test/ffc_internal_test.c"
    ...
    q = 
# 262 "../test/ffc_internal_test.c" 3 4
       ((void *)0)
# 262 "../test/ffc_internal_test.c"
           ;
    ossl_ffc_params_set_flags(&params, 0x01);
    ossl_ffc_set_digest(&params, "SHA224", 
# 264 "../test/ffc_internal_test.c" 3 4
                                          ((void *)0)
# 264 "../test/ffc_internal_test.c"
                                              );

    if (!test_false("../test/ffc_internal_test.c", 266, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 266 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 266 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 266 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 266 "../test/ffc_internal_test.c"
    ...
    ossl_ffc_params_set0_pqg(&params, p, 
# 272 "../test/ffc_internal_test.c" 3 4
                                        ((void *)0)
# 272 "../test/ffc_internal_test.c"
                                            , 
# 272 "../test/ffc_internal_test.c" 3 4
                                              ((void *)0)
# 272 "../test/ffc_internal_test.c"
    ...
    p = 
# 273 "../test/ffc_internal_test.c" 3 4
       ((void *)0)
# 273 "../test/ffc_internal_test.c"
           ;
    ...
    if (!test_true("../test/ffc_internal_test.c", 277, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 277 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 277 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 277 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 277 "../test/ffc_internal_test.c"
    ...
    ossl_ffc_params_set_validate_params(&params, dsa_2048_224_sha224_seed,
                                        sizeof(dsa_2048_224_sha224_seed),
                                        1);
    if (!test_false("../test/ffc_internal_test.c", 286, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 286 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 286 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 286 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 286 "../test/ffc_internal_test.c"
    ...
    ossl_ffc_params_set_validate_params(&params, dsa_2048_224_sha224_seed,
                                        ...
                                        dsa_2048_224_sha224_counter);
    if (!test_false("../test/ffc_internal_test.c", 295, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 295 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 295 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 295 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 295 "../test/ffc_internal_test.c"
    ...
    ossl_ffc_params_set_validate_params(&params, dsa_2048_224_sha224_bad_seed,
                                        ...
                                        dsa_2048_224_sha224_counter);
    if (!test_false("../test/ffc_internal_test.c", 304, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 304 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 304 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 304 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 304 "../test/ffc_internal_test.c"
    ...
    if (!test_ptr("../test/ffc_internal_test.c", 309, "p = BN_bin2bn(dsa_3072_256_sha512_p, sizeof(dsa_3072_256_sha512_p), NULL)", p = BN_bin2bn(dsa_3072_256_sha512_p, sizeof(dsa_3072_256_sha512_p), 
# 309 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 309 "../test/ffc_internal_test.c"
        ))
                                                                     )
        goto err;
    if (!test_ptr("../test/ffc_internal_test.c", 312, "q = BN_bin2bn(dsa_3072_256_sha512_q, sizeof(dsa_3072_256_sha512_q), NULL)", q = BN_bin2bn(dsa_3072_256_sha512_q, sizeof(dsa_3072_256_sha512_q), 
# 312 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 312 "../test/ffc_internal_test.c"
        ))
    ...
    ossl_ffc_params_set0_pqg(&params, p, q, 
# 318 "../test/ffc_internal_test.c" 3 4
                                           ((void *)0)
# 318 "../test/ffc_internal_test.c"
                                               );
    p = q = 
# 319 "../test/ffc_internal_test.c" 3 4
            ((void *)0)
# 319 "../test/ffc_internal_test.c"
                ;
    ossl_ffc_set_digest(&params, "SHA512", 
# 320 "../test/ffc_internal_test.c" 3 4
                                          ((void *)0)
# 320 "../test/ffc_internal_test.c"
                                              );
    ...
    if (!test_false("../test/ffc_internal_test.c", 325, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 325 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 325 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 325 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 325 "../test/ffc_internal_test.c"
    ...
    if (!test_false("../test/ffc_internal_test.c", 331, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DH, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 331 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 331 "../test/ffc_internal_test.c"
        , &params, 1, &res, 
# 331 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 331 "../test/ffc_internal_test.c"
...
static int ffc_params_gen_test(void)
{
    ...
    ossl_ffc_params_init(&params);
    if (!test_true("../test/ffc_internal_test.c", 352, "ossl_ffc_params_FIPS186_4_generate(NULL, &params, FFC_PARAM_TYPE_DH, 2048, 256, &res, NULL)", (ossl_ffc_params_FIPS186_4_generate(
# 352 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 352 "../test/ffc_internal_test.c"
        , &params, 1, 2048, 256, &res, 
# 352 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 352 "../test/ffc_internal_test.c"
        )) != 0)
        ...
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 356, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DH, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 356 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 356 "../test/ffc_internal_test.c"
        , &params, 1, &res, 
# 356 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 356 "../test/ffc_internal_test.c"
...
static int ffc_params_gen_canonicalg_test(void)
{
    ...
    ossl_ffc_params_init(&params);
    params.gindex = 1;
    if (!test_true("../test/ffc_internal_test.c", 374, "ossl_ffc_params_FIPS186_4_generate(NULL, &params, FFC_PARAM_TYPE_DH, 2048, 256, &res, NULL)", (ossl_ffc_params_FIPS186_4_generate(
# 374 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 374 "../test/ffc_internal_test.c"
        , &params, 1, 2048, 256, &res, 
# 374 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 374 "../test/ffc_internal_test.c"
        ...
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 378, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DH, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 378 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 378 "../test/ffc_internal_test.c"
        , &params, 1, &res, 
# 378 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 378 "../test/ffc_internal_test.c"
    ...
    if (!test_true("../test/ffc_internal_test.c", 383, "ossl_ffc_params_print(bio_out, &params, 4)", (ossl_ffc_params_print(bio_out, &params, 4)) != 0))
        goto err;
...
static int ffc_params_fips186_2_gen_validate_test(void)
{
    ...
    FFC_PARAMS params;
    BIGNUM *bn = 
# 396 "../test/ffc_internal_test.c" 3 4
                ((void *)0)
# 396 "../test/ffc_internal_test.c"
                    ;

    ossl_ffc_params_init(&params);
    if (!test_ptr("../test/ffc_internal_test.c", 399, "bn = BN_new()", bn = BN_new()))
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 401, "ossl_ffc_params_FIPS186_2_generate(NULL, &params, FFC_PARAM_TYPE_DH, 1024, 160, &res, NULL)", (ossl_ffc_params_FIPS186_2_generate(
# 401 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 401 "../test/ffc_internal_test.c"
        , &params, 1, 1024, 160, &res, 
# 401 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 401 "../test/ffc_internal_test.c"
        )) != 0)
        ...
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 405, "ossl_ffc_params_FIPS186_2_validate(NULL, &params, FFC_PARAM_TYPE_DH, &res, NULL)", (ossl_ffc_params_FIPS186_2_validate(
# 405 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 405 "../test/ffc_internal_test.c"
        , &params, 1, &res, 
# 405 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 405 "../test/ffc_internal_test.c"
    ...
    if (!test_false("../test/ffc_internal_test.c", 414, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", (ossl_ffc_params_FIPS186_4_validate(
# 414 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 414 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 414 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 414 "../test/ffc_internal_test.c"
    ...
    if (!test_true("../test/ffc_internal_test.c", 419, "res == FFC_CHECK_Q_MISMATCH || res == FFC_CHECK_Q_NOT_PRIME", (res == 0x04000 || res == 0x00010) != 0))
        goto err;

    ossl_ffc_params_set_flags(&params, 0x02);

    if (!test_int_eq("../test/ffc_internal_test.c", 424, "ossl_ffc_params_FIPS186_4_validate(NULL, &params, FFC_PARAM_TYPE_DSA, &res, NULL)", "2", ossl_ffc_params_FIPS186_4_validate(
# 424 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 424 "../test/ffc_internal_test.c"
        , &params, 0, &res, 
# 424 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 424 "../test/ffc_internal_test.c"
    ...
    if (!test_true("../test/ffc_internal_test.c", 429, "ossl_ffc_params_print(bio_out, &params, 4)", (ossl_ffc_params_print(bio_out, &params, 4)) != 0))
        goto err;
...
static int ffc_public_validate_test(void)
{
    ...
    FFC_PARAMS *params;
    BIGNUM *pub = 
# 445 "../test/ffc_internal_test.c" 3 4
                 ((void *)0)
# 445 "../test/ffc_internal_test.c"
                     ;
    DH *dh = 
# 446 "../test/ffc_internal_test.c" 3 4
            ((void *)0)
# 446 "../test/ffc_internal_test.c"
                ;

    if (!test_ptr("../test/ffc_internal_test.c", 448, "pub = BN_new()", pub = BN_new()))
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 451, "dh = DH_new_by_nid(NID_ffdhe2048)", dh = DH_new_by_nid(1126)))
        goto err;
    params = ossl_dh_get0_params(dh);

    if (!test_true("../test/ffc_internal_test.c", 455, "BN_set_word(pub, 1)", (BN_set_word(pub, 1)) != 0))
        goto err;
    BN_set_negative(pub, 1);

    if (!test_true("../test/ffc_internal_test.c", 459, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 461, "FFC_ERROR_PUBKEY_TOO_SMALL", "res", 0x01, res))
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 463, "BN_set_word(pub, 0)", (BN_set_word(pub, 0)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 466, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 468, "FFC_ERROR_PUBKEY_TOO_SMALL", "res", 0x01, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 471, "ossl_ffc_validate_public_key(params, BN_value_one(), &res)", (ossl_ffc_validate_public_key(params, BN_value_one(), &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 473, "FFC_ERROR_PUBKEY_TOO_SMALL", "res", 0x01, res))
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 475, "BN_add_word(pub, 2)", (BN_add_word(pub, 2)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 478, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 481, "BN_copy(pub, params->p)", BN_copy(pub, params->p)))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 484, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 486, "FFC_ERROR_PUBKEY_TOO_LARGE", "res", 0x02, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 489, "BN_sub_word(pub, 1)", (BN_sub_word(pub, 1)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 492, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 494, "FFC_ERROR_PUBKEY_TOO_LARGE", "res", 0x02, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 497, "BN_sub_word(pub, 1)", (BN_sub_word(pub, 1)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 500, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 502, "FFC_ERROR_PUBKEY_INVALID", "res", 0x04, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 505, "BN_sub_word(pub, 5)", (BN_sub_word(pub, 5)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 508, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;


    if (!test_true("../test/ffc_internal_test.c", 512, "ossl_ffc_validate_public_key(NULL, pub, &res)", (ossl_ffc_validate_public_key(
# 512 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 512 "../test/ffc_internal_test.c"
        , pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 514, "FFC_ERROR_PASSED_NULL_PARAM", "res", 0x40, res))
        goto err;
    res = -1;

    if (!test_true("../test/ffc_internal_test.c", 518, "ossl_ffc_validate_public_key(params, NULL, &res)", (ossl_ffc_validate_public_key(params, 
# 518 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 518 "../test/ffc_internal_test.c"
        , &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 520, "FFC_ERROR_PASSED_NULL_PARAM", "res", 0x40, res))
        goto err;
    res = -1;

    BN_free(params->p);
    params->p = 
# 525 "../test/ffc_internal_test.c" 3 4
               ((void *)0)
# 525 "../test/ffc_internal_test.c"
                   ;

    if (!test_true("../test/ffc_internal_test.c", 527, "ossl_ffc_validate_public_key(params, pub, &res)", (ossl_ffc_validate_public_key(params, pub, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 529, "FFC_ERROR_PASSED_NULL_PARAM", "res", 0x40, res))
        goto err;
...
static int ffc_private_validate_test(void)
{
    ...
    FFC_PARAMS *params;
    BIGNUM *priv = 
# 543 "../test/ffc_internal_test.c" 3 4
                  ((void *)0)
# 543 "../test/ffc_internal_test.c"
                      ;
    DH *dh = 
# 544 "../test/ffc_internal_test.c" 3 4
            ((void *)0)
# 544 "../test/ffc_internal_test.c"
                ;

    if (!test_ptr("../test/ffc_internal_test.c", 546, "priv = BN_new()", priv = BN_new()))
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 549, "dh = DH_new_by_nid(NID_ffdhe2048)", dh = DH_new_by_nid(1126)))
        goto err;
    params = ossl_dh_get0_params(dh);

    if (!test_true("../test/ffc_internal_test.c", 553, "BN_set_word(priv, 1)", (BN_set_word(priv, 1)) != 0))
        goto err;
    BN_set_negative(priv, 1);

    if (!test_false("../test/ffc_internal_test.c", 557, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 559, "FFC_ERROR_PRIVKEY_TOO_SMALL", "res", 0x10, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 562, "BN_set_word(priv, 0)", (BN_set_word(priv, 0)) != 0))
        goto err;

    if (!test_false("../test/ffc_internal_test.c", 565, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 567, "FFC_ERROR_PRIVKEY_TOO_SMALL", "res", 0x10, res))
        goto err;


    if (!test_true("../test/ffc_internal_test.c", 571, "ossl_ffc_validate_private_key(params->q, BN_value_one(), &res)", (ossl_ffc_validate_private_key(params->q, BN_value_one(), &res)) != 0)
                                                       )
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 575, "BN_copy(priv, params->q)", BN_copy(priv, params->q)))
        goto err;

    if (!test_false("../test/ffc_internal_test.c", 578, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 580, "FFC_ERROR_PRIVKEY_TOO_LARGE", "res", 0x20, res))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 583, "BN_sub_word(priv, 1)", (BN_sub_word(priv, 1)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 586, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;

    if (!test_false("../test/ffc_internal_test.c", 589, "ossl_ffc_validate_private_key(NULL, priv, &res)", (ossl_ffc_validate_private_key(
# 589 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 589 "../test/ffc_internal_test.c"
        , priv, &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 591, "FFC_ERROR_PASSED_NULL_PARAM", "res", 0x40, res))
        goto err;
    res = -1;
    if (!test_false("../test/ffc_internal_test.c", 594, "ossl_ffc_validate_private_key(params->q, NULL, &res)", (ossl_ffc_validate_private_key(params->q, 
# 594 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 594 "../test/ffc_internal_test.c"
        , &res)) != 0))
        goto err;
    if (!test_int_eq("../test/ffc_internal_test.c", 596, "FFC_ERROR_PASSED_NULL_PARAM", "res", 0x40, res))
        goto err;
...
static int ffc_private_gen_test(int index)
{
    ...
    FFC_PARAMS *params;
    BIGNUM *priv = 
# 610 "../test/ffc_internal_test.c" 3 4
                  ((void *)0)
# 610 "../test/ffc_internal_test.c"
                      ;
    DH *dh = 
# 611 "../test/ffc_internal_test.c" 3 4
            ((void *)0)
# 611 "../test/ffc_internal_test.c"
                ;
    BN_CTX *ctx = 
# 612 "../test/ffc_internal_test.c" 3 4
                 ((void *)0)
# 612 "../test/ffc_internal_test.c"
                     ;

    if (!test_ptr("../test/ffc_internal_test.c", 614, "ctx = BN_CTX_new_ex(NULL)", ctx = BN_CTX_new_ex(
# 614 "../test/ffc_internal_test.c" 3 4
        ((void *)0)
# 614 "../test/ffc_internal_test.c"
        )))
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 617, "priv = BN_new()", priv = BN_new()))
        goto err;

    if (!test_ptr("../test/ffc_internal_test.c", 620, "dh = DH_new_by_nid(NID_ffdhe2048)", dh = DH_new_by_nid(1126)))
        goto err;
    params = ossl_dh_get0_params(dh);

    N = BN_num_bits(params->q);

    if (!test_false("../test/ffc_internal_test.c", 626, "ossl_ffc_generate_private_key(ctx, params, 220, 112, priv)", (ossl_ffc_generate_private_key(ctx, params, 220, 112, priv)) != 0))
        goto err;

    if (!test_false("../test/ffc_internal_test.c", 629, "ossl_ffc_generate_private_key(ctx, params, N + 1, 112, priv)", (ossl_ffc_generate_private_key(ctx, params, N + 1, 112, priv)) != 0))
        goto err;

    if (!test_false("../test/ffc_internal_test.c", 632, "ossl_ffc_generate_private_key(ctx, params, N, 0, priv)", (ossl_ffc_generate_private_key(ctx, params, N, 0, priv)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 635, "ossl_ffc_generate_private_key(ctx, params, N, 112, priv)", (ossl_ffc_generate_private_key(ctx, params, N, 112, priv)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 638, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 641, "ossl_ffc_generate_private_key(ctx, params, N / 2, 112, priv)", (ossl_ffc_generate_private_key(ctx, params, N / 2, 112, priv)) != 0))
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 643, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 646, "ossl_ffc_generate_private_key(ctx, params, 0, ossl_ifc_ffc_compute_security_bits(BN_num_bits(params->p)), priv)", (ossl_ffc_generate_private_key(ctx, params, 0, ossl_ifc_ffc_compute_security_bits(BN_num_bits(params->p)), priv)) != 0)

                                                       )
        goto err;
    if (!test_int_le("../test/ffc_internal_test.c", 650, "BN_num_bits(priv)", "225", BN_num_bits(priv), 225))
        goto err;
    if (!test_true("../test/ffc_internal_test.c", 652, "ossl_ffc_validate_private_key(params->q, priv, &res)", (ossl_ffc_validate_private_key(params->q, priv, &res)) != 0))
        goto err;
...
static int ffc_params_copy_test(void)
{
    int ret = 0;
    DH *dh = 
# 666 "../test/ffc_internal_test.c" 3 4
            ((void *)0)
# 666 "../test/ffc_internal_test.c"
                ;
    FFC_PARAMS *params, copy;

    ossl_ffc_params_init(&copy);

    if (!test_ptr("../test/ffc_internal_test.c", 671, "dh = DH_new_by_nid(NID_ffdhe3072)", dh = DH_new_by_nid(1127)))
        goto err;
    params = ossl_dh_get0_params(dh);

    if (!test_int_eq("../test/ffc_internal_test.c", 675, "params->keylength", "275", params->keylength, 275))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 678, "ossl_ffc_params_copy(&copy, params)", (ossl_ffc_params_copy(&copy, params)) != 0))
        goto err;

    if (!test_int_eq("../test/ffc_internal_test.c", 681, "copy.keylength", "275", copy.keylength, 275))
        goto err;

    if (!test_true("../test/ffc_internal_test.c", 684, "ossl_ffc_params_cmp(&copy, params, 0)", (ossl_ffc_params_cmp(&copy, params, 0)) != 0))
        goto err;
...
int setup_tests(void)
{
    ...
    add_test("ffc_params_copy_test", ffc_params_copy_test);
