# 0 "../test/bio_addr_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_addr_test.c"
# 10 "../test/bio_addr_test.c"
...
# 14 "../test/bio_addr_test.c" 2

static int families[] = {
    
# 16 "../test/bio_addr_test.c" 3 4
   2
# 16 "../test/bio_addr_test.c"
          ,

    
# 18 "../test/bio_addr_test.c" 3 4
   10
# 18 "../test/bio_addr_test.c"
           ,


    
# 21 "../test/bio_addr_test.c" 3 4
   1


# 23 "../test/bio_addr_test.c"
};
...
static BIO_ADDR *make_dummy_addr(int family)
{
    ...
    switch(family) {
    case 
# 42 "../test/bio_addr_test.c" 3 4
        2
# 42 "../test/bio_addr_test.c"
               :
    ...
    case 
# 47 "../test/bio_addr_test.c" 3 4
        10
# 47 "../test/bio_addr_test.c"
                :
    ...
    case 
# 53 "../test/bio_addr_test.c" 3 4
        1
# 53 "../test/bio_addr_test.c"
               :
    ...
    default:
        test_error("../test/bio_addr_test.c", 60, "Unsupported address family");
        return 0;
    }
    ...
    addr = BIO_ADDR_new();
    if (!test_ptr("../test/bio_addr_test.c", 70, "addr", addr))
        return 
# 71 "../test/bio_addr_test.c" 3 4
              ((void *)0)
# 71 "../test/bio_addr_test.c"
                  ;

    if (!test_true("../test/bio_addr_test.c", 73, "BIO_ADDR_rawmake(addr, family, where, wherelen, 1000)", (BIO_ADDR_rawmake(addr, family, where, wherelen, 1000)) != 0)) {
        BIO_ADDR_free(addr);
        return 
# 75 "../test/bio_addr_test.c" 3 4
              ((void *)0)
# 75 "../test/bio_addr_test.c"
                  ;
    }
...
{
    unsigned char *adata = 
# 83 "../test/bio_addr_test.c" 3 4
                          ((void *)0)
# 83 "../test/bio_addr_test.c"
                              , *bdata = 
# 83 "../test/bio_addr_test.c" 3 4
                                         ((void *)0)
# 83 "../test/bio_addr_test.c"
    ...
    if (a == 
# 92 "../test/bio_addr_test.c" 3 4
            ((void *)0) 
# 92 "../test/bio_addr_test.c"
                 || b == 
# 92 "../test/bio_addr_test.c" 3 4
                         ((void *)0)
# 92 "../test/bio_addr_test.c"
    ...
    if (!BIO_ADDR_rawaddress(a, 
# 102 "../test/bio_addr_test.c" 3 4
                               ((void *)0)
# 102 "../test/bio_addr_test.c"
                                   , &alen))
        return 0;

    if (!BIO_ADDR_rawaddress(b, 
# 105 "../test/bio_addr_test.c" 3 4
                               ((void *)0)
# 105 "../test/bio_addr_test.c"
                                   , &blen))
        goto err;
    ...
    adata = CRYPTO_malloc(alen, "../test/bio_addr_test.c", 114);
    if (!test_ptr("../test/bio_addr_test.c", 115, "adata", adata)
            || !BIO_ADDR_rawaddress(a, adata, &alen))
        goto err;

    bdata = CRYPTO_malloc(blen, "../test/bio_addr_test.c", 119);
    if (!test_ptr("../test/bio_addr_test.c", 120, "bdata", bdata)
 ...
 err:
    CRYPTO_free(adata, "../test/bio_addr_test.c", 127);
    CRYPTO_free(bdata, "../test/bio_addr_test.c", 128);
    return ret;
}
...
{
    BIO_ADDR *src = 
# 134 "../test/bio_addr_test.c" 3 4
                   ((void *)0)
# 134 "../test/bio_addr_test.c"
                       , *dst = 
# 134 "../test/bio_addr_test.c" 3 4
                                ((void *)0)
# 134 "../test/bio_addr_test.c"
    ...
    if (!test_ptr("../test/bio_addr_test.c", 141, "src", src))
        return 0;

    if (docopy) {
        dst = BIO_ADDR_new();
        if (!test_ptr("../test/bio_addr_test.c", 146, "dst", dst))
            goto err;

        if (!test_true("../test/bio_addr_test.c", 149, "BIO_ADDR_copy(dst, src)", (BIO_ADDR_copy(dst, src)) != 0))
            goto err;
    } else {
        dst = BIO_ADDR_dup(src);
        if (!test_ptr("../test/bio_addr_test.c", 153, "dst", dst))
            goto err;
    }

    if (!test_true("../test/bio_addr_test.c", 157, "bio_addr_is_eq(src, dst)", (bio_addr_is_eq(src, dst)) != 0))
        goto err;
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/bio_addr_test.c", 170, "Error parsing test options\n");
        return 0;
    }

    add_all_tests("test_bio_addr_copy_dup", test_bio_addr_copy_dup, (sizeof(families)/sizeof((families)[0])) * 2, 1);
    return 1;
}
