# 0 "../test/bio_readbuffer_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_readbuffer_test.c"
# 10 "../test/bio_readbuffer_test.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 11 "../test/bio_readbuffer_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 12 "../test/bio_readbuffer_test.c" 2

static const char *filename = 
# 13 "../test/bio_readbuffer_test.c" 3 4
                             ((void *)0)
# 13 "../test/bio_readbuffer_test.c"
                                 ;
# 26 "../test/bio_readbuffer_test.c"
static int test_readbuffer_file_bio(int tstid)
{
    int ret = 0, len, partial;
    BIO *in = 
# 29 "../test/bio_readbuffer_test.c" 3 4
             ((void *)0)
# 29 "../test/bio_readbuffer_test.c"
                 , *in_bio = 
# 29 "../test/bio_readbuffer_test.c" 3 4
                             ((void *)0)
# 29 "../test/bio_readbuffer_test.c"
...
# 29 "../test/bio_readbuffer_test.c"
    ...
    if (!test_ptr("../test/bio_readbuffer_test.c", 35, "in = BIO_new_file(filename, \"r\")", in = BIO_new_file(filename, "r"))
        || !test_int_eq("../test/bio_readbuffer_test.c", 36, "BIO_read_ex(in, expected, sizeof(expected), &readbytes)", "1", BIO_read_ex(in, expected, sizeof(expected), &readbytes), 1)

        || !test_int_lt("../test/bio_readbuffer_test.c", 38, "readbytes", "sizeof(expected)", readbytes, sizeof(expected)))
        goto err;
    BIO_free(in);
    in = 
# 41 "../test/bio_readbuffer_test.c" 3 4
        ((void *)0)
# 41 "../test/bio_readbuffer_test.c"
            ;


    if (!test_ptr("../test/bio_readbuffer_test.c", 44, "readbuf_bio = BIO_new(BIO_f_readbuffer())", readbuf_bio = BIO_new(BIO_f_readbuffer()))
        || !test_ptr("../test/bio_readbuffer_test.c", 45, "in_bio = BIO_new_file(filename, \"r\")", in_bio = BIO_new_file(filename, "r")))
        goto err;

    in_bio = BIO_push(readbuf_bio, in_bio);
    readbuf_bio = 
# 49 "../test/bio_readbuffer_test.c" 3 4
                 ((void *)0)
# 49 "../test/bio_readbuffer_test.c"
                     ;

    if (!test_int_eq("../test/bio_readbuffer_test.c", 51, "BIO_tell(in_bio)", "0", (int)BIO_ctrl(in_bio,133,0,
# 51 "../test/bio_readbuffer_test.c" 3 4
        ((void *)0)
# 51 "../test/bio_readbuffer_test.c"
        ), 0))
        goto err;

    if (tstid != 0) {
        partial = 4;
        while (!(int)BIO_ctrl(in_bio,2,0,
# 56 "../test/bio_readbuffer_test.c" 3 4
               ((void *)0)
# 56 "../test/bio_readbuffer_test.c"
               )) {
            len = BIO_gets(in_bio, buf, sizeof(buf));
            if (len == 0) {
                if (!test_true("../test/bio_readbuffer_test.c", 59, "BIO_eof(in_bio)", ((int)BIO_ctrl(in_bio,2,0,
# 59 "../test/bio_readbuffer_test.c" 3 4
                    ((void *)0)
# 59 "../test/bio_readbuffer_test.c"
                    )) != 0))
                    goto err;
            } else {
                if (!test_int_gt("../test/bio_readbuffer_test.c", 62, "len", "0", len, 0)
                    || !test_int_le("../test/bio_readbuffer_test.c", 63, "len", "(int)sizeof(buf) - 1", len, (int)sizeof(buf) - 1))
                    goto err;
                if (!test_true("../test/bio_readbuffer_test.c", 65, "buf[len] == 0", (buf[len] == 0) != 0))
                    goto err;
                if (len > 1
                    && !(int)BIO_ctrl(in_bio,2,0,
# 68 "../test/bio_readbuffer_test.c" 3 4
                       ((void *)0)
# 68 "../test/bio_readbuffer_test.c"
                       )
                    && len != ((int)sizeof(buf) - 1)
                    && !test_true("../test/bio_readbuffer_test.c", 70, "buf[len - 1] == '\\n'", (buf[len - 1] == '\n') != 0))
                    goto err;
            }
    ...
    if (!test_int_eq("../test/bio_readbuffer_test.c", 77, "BIO_seek(in_bio, 0)", "1", (int)BIO_ctrl(in_bio,128,0,
# 77 "../test/bio_readbuffer_test.c" 3 4
        ((void *)0)
# 77 "../test/bio_readbuffer_test.c"
        ), 1))
        goto err;

    len = 8;
    while (!(int)BIO_ctrl(in_bio,2,0,
# 81 "../test/bio_readbuffer_test.c" 3 4
           ((void *)0)
# 81 "../test/bio_readbuffer_test.c"
           )) {
        if (!test_int_eq("../test/bio_readbuffer_test.c", 82, "BIO_read_ex(in_bio, buf, len, &bytes)", "1", BIO_read_ex(in_bio, buf, len, &bytes), 1))
            break;
        if (!test_mem_eq("../test/bio_readbuffer_test.c", 84, "buf", "expected + count", buf, bytes, expected + count, bytes))
            goto err;
        count += bytes;
        len = sizeof(buf);
    }
    if (!test_int_eq("../test/bio_readbuffer_test.c", 89, "count", "readbytes", count, readbytes))
        goto err;
    ret = 1;
err:
    BIO_free(in);
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 110 "../test/bio_readbuffer_test.c" 3 4
         ((void *)0) 
# 110 "../test/bio_readbuffer_test.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_readbuffer_file_bio", test_readbuffer_file_bio, 3, 1);
    return 1;
}
