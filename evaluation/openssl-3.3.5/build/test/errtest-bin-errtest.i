...
static int test_print_error_format(void)
{
    ...
    const char *file = "../test/errtest.c";
    const int line = 37;
...
# 54 "../test/errtest.c"
    ...
    int ret = 0, len;
    BIO *bio = 
# 56 "../test/errtest.c" 3 4
              ((void *)0)
# 56 "../test/errtest.c"
                  ;
    const int syserr = 
# 57 "../test/errtest.c" 3 4
                      1
# 57 "../test/errtest.c"
                           ;
    ...
    (ERR_new(), ERR_set_debug((file), (line), __func__), ERR_set_error((2), (syserr), 
# 68 "../test/errtest.c" 3 4
   ((void *)0)
# 68 "../test/errtest.c"
   ));
    ...
    if (!test_int_eq("../test/errtest.c", 72, "reasoncode", "syserr", reasoncode, syserr)) {
        ERR_pop_to_mark();
        goto err;
    }
    ...
    if (!test_ptr("../test/errtest.c", 93, "bio = BIO_new(BIO_s_mem())", bio = BIO_new(BIO_s_mem())))
        goto err;

    ERR_print_errors(bio);

    if (!test_int_gt("../test/errtest.c", 98, "len = BIO_get_mem_data(bio, &out)", "0", len = BIO_ctrl(bio,3,0,(char *)(&out)), 0))
        goto err;

    for (p = out; *p != ':' && *p != 0; ++p) {
        if (!test_true("../test/errtest.c", 102, "IS_HEX(*p)", (((*p >= '0' && *p <='9') || (*p >= 'A' && *p <='F'))) != 0))
            goto err;
    }
    if (!test_true("../test/errtest.c", 105, "*p != 0", (*p != 0) != 0)
        || !test_strn_eq("../test/errtest.c", 106, "expected", "p", expected, strlen(expected), p, strlen(expected)))
        goto err;
...
# 124 "../test/errtest.c"
                 ;
    ERR_get_error();
    return test_int_eq("../test/errtest.c", 126, "errno", "EINVAL", 
# 126 "../test/errtest.c" 3 4
          (*__errno_location ())
# 126 "../test/errtest.c"
          , 
# 126 "../test/errtest.c" 3 4
...
static int vdata_appends(void)
{
    ...
    (ERR_new(), ERR_set_debug("../test/errtest.c",135,__func__), ERR_set_error)((15),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 135 "../test/errtest.c" 3 4
   ((void *)0)
# 135 "../test/errtest.c"
   );
...
# 138 "../test/errtest.c" 3 4
                              ((void *)0)
# 138 "../test/errtest.c"
                                  );
    return test_str_eq("../test/errtest.c", 139, "data", "\"hello world\"", data, "hello world");
}
...
static int raised_error(void)
{
    ...
    (ERR_new(), ERR_set_debug("../test/errtest.c",159,__func__), ERR_set_error)(1, (259|((0x1 << 18L)|(0x2 << 18L))),
                   "calling exit()");
    if (!test_ulong_ne("../test/errtest.c", 161, "e = ERR_get_error_all(&f, &l, NULL, &data, NULL)", "0", e = ERR_get_error_all(&f, &l, 
# 161 "../test/errtest.c" 3 4
        ((void *)0)
# 161 "../test/errtest.c"
        , &data, 
# 161 "../test/errtest.c" 3 4
...
# 161 "../test/errtest.c"
            ...
            || !test_int_eq("../test/errtest.c", 162, "ERR_GET_REASON(e)", "ERR_R_INTERNAL_ERROR", ERR_GET_REASON(e), (259|((0x1 << 18L)|(0x2 << 18L))))

            || !test_int_eq("../test/errtest.c", 164, "l", "line", l, line)
            || !test_str_eq("../test/errtest.c", 165, "f", "file", f, file)

            || !test_str_eq("../test/errtest.c", 167, "data", "\"calling exit()\"", data, "calling exit()"))
        return 0;
    return 1;
}
...
static int test_marks(void)
{
    ...
    (ERR_new(), ERR_set_debug("../test/errtest.c",177,__func__), ERR_set_error)((15),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 177 "../test/errtest.c" 3 4
   ((void *)0)
# 177 "../test/errtest.c"
   );
    mallocfail = ERR_peek_last_error();
    if (!test_ulong_gt("../test/errtest.c", 179, "mallocfail", "0", mallocfail, 0))
        return 0;


    if (!test_true("../test/errtest.c", 183, "ERR_set_mark()", (ERR_set_mark()) != 0)
            || !test_true("../test/errtest.c", 184, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 185, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error())
            || !test_true("../test/errtest.c", 186, "ERR_set_mark()", (ERR_set_mark()) != 0)
            || !test_true("../test/errtest.c", 187, "ERR_clear_last_mark()", (ERR_clear_last_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 188, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        return 0;


    if (!test_true("../test/errtest.c", 192, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",194,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 194 "../test/errtest.c" 3 4
   ((void *)0)
# 194 "../test/errtest.c"
   );
    if (!test_ulong_ne("../test/errtest.c", 195, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error())
            || !test_true("../test/errtest.c", 196, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 197, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        return 0;


    if (!test_true("../test/errtest.c", 201, "ERR_set_mark()", (ERR_set_mark()) != 0)
            || !test_true("../test/errtest.c", 202, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",204,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 204 "../test/errtest.c" 3 4
   ((void *)0)
# 204 "../test/errtest.c"
   );
    if (!test_ulong_ne("../test/errtest.c", 205, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error())
            || !test_true("../test/errtest.c", 206, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_true("../test/errtest.c", 207, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 208, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        return 0;

    if (!test_true("../test/errtest.c", 211, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",213,__func__), ERR_set_error)((15),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 213 "../test/errtest.c" 3 4
   ((void *)0)
# 213 "../test/errtest.c"
   );
    shouldnot = ERR_peek_last_error();
    if (!test_ulong_ne("../test/errtest.c", 215, "mallocfail", "shouldnot", mallocfail, shouldnot)
            || !test_true("../test/errtest.c", 216, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",218,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 218 "../test/errtest.c" 3 4
   ((void *)0)
# 218 "../test/errtest.c"
   );
    if (!test_ulong_ne("../test/errtest.c", 219, "shouldnot", "ERR_peek_last_error()", shouldnot, ERR_peek_last_error())
            || !test_true("../test/errtest.c", 220, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 221, "shouldnot", "ERR_peek_last_error()", shouldnot, ERR_peek_last_error())
            || !test_true("../test/errtest.c", 222, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 223, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        return 0;


    if (!test_true("../test/errtest.c", 227, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",229,__func__), ERR_set_error)((15),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 229 "../test/errtest.c" 3 4
   ((void *)0)
# 229 "../test/errtest.c"
   );
    if (!test_true("../test/errtest.c", 230, "ERR_clear_last_mark()", (ERR_clear_last_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 231, "shouldnot", "ERR_peek_last_error()", shouldnot, ERR_peek_last_error()))
        return 0;
    ...
    if (!test_false("../test/errtest.c", 238, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 239, "0", "ERR_peek_last_error()", 0, ERR_peek_last_error()))
        return 0;


    (ERR_new(), ERR_set_debug("../test/errtest.c",243,__func__), ERR_set_error)((15),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 243 "../test/errtest.c" 3 4
   ((void *)0)
# 243 "../test/errtest.c"
   );
    if (!test_false("../test/errtest.c", 244, "ERR_clear_last_mark()", (ERR_clear_last_mark()) != 0)

            || !test_ulong_eq("../test/errtest.c", 246, "mallocfail", "ERR_get_error()", mallocfail, ERR_get_error())
            || !test_ulong_eq("../test/errtest.c", 247, "0", "ERR_peek_last_error()", 0, ERR_peek_last_error()))
        return 0;
# 260 "../test/errtest.c"
    if (!test_false("../test/errtest.c", 260, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;

    (ERR_new(), ERR_set_debug("../test/errtest.c",263,__func__), ERR_set_error)((15),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 263 "../test/errtest.c" 3 4
   ((void *)0)
# 263 "../test/errtest.c"
   );
    if (!test_true("../test/errtest.c", 264, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",266,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 266 "../test/errtest.c" 3 4
   ((void *)0)
# 266 "../test/errtest.c"
   );
    (ERR_new(), ERR_set_debug("../test/errtest.c",267,__func__), ERR_set_error)((15),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 267 "../test/errtest.c" 3 4
   ((void *)0)
# 267 "../test/errtest.c"
   );


    if (!test_true("../test/errtest.c", 270, "ERR_pop_to_mark()", (ERR_pop_to_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 271, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        return 0;

    if (!test_true("../test/errtest.c", 274, "ERR_set_mark()", (ERR_set_mark()) != 0))
        return 0;
    (ERR_new(), ERR_set_debug("../test/errtest.c",276,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 276 "../test/errtest.c" 3 4
   ((void *)0)
# 276 "../test/errtest.c"
   );
    (ERR_new(), ERR_set_debug("../test/errtest.c",277,__func__), ERR_set_error)((15),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 277 "../test/errtest.c" 3 4
   ((void *)0)
# 277 "../test/errtest.c"
   );


    if (!test_true("../test/errtest.c", 280, "ERR_clear_last_mark()", (ERR_clear_last_mark()) != 0)
            || !test_ulong_eq("../test/errtest.c", 281, "shouldnot", "ERR_peek_last_error()", shouldnot, ERR_peek_last_error()))
        return 0;
...
# 293 "../test/errtest.c"
    ...
    (ERR_new(), ERR_set_debug("../test/errtest.c",297,__func__), ERR_set_error)(0, 0, "hello %s", "world");
    ERR_peek_error_data(&data, &flags);
    if (!test_str_eq("../test/errtest.c", 299, "data", "\"hello world\"", data, "hello world")
            || !test_int_eq("../test/errtest.c", 300, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
        goto err;
    ERR_clear_error();


    (ERR_new(), ERR_set_debug("../test/errtest.c",305,__func__), ERR_set_error)((0),(0),
# 305 "../test/errtest.c" 3 4
   ((void *)0)
# 305 "../test/errtest.c"
   );
    ERR_peek_error_data(&data, &flags);
    if (!test_str_eq("../test/errtest.c", 307, "data", "\"\"", data, "")
            || !test_int_eq("../test/errtest.c", 308, "flags", "ERR_TXT_MALLOCED", flags, 0x01))
        goto err;
    ERR_clear_error();


    (ERR_new(), ERR_set_debug("../test/errtest.c",313,__func__), ERR_set_error)(0, 0, "goodbye %s world", "cruel");
    ERR_peek_error_data(&data, &flags);
    if (!test_str_eq("../test/errtest.c", 315, "data", "\"goodbye cruel world\"", data, "goodbye cruel world")
            || !test_int_eq("../test/errtest.c", 316, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
        goto err;
    ERR_clear_error();
    ...
    (ERR_new(), ERR_set_debug("../test/errtest.c",324,__func__), ERR_set_error)((0),(0),
# 324 "../test/errtest.c" 3 4
   ((void *)0)
# 324 "../test/errtest.c"
   );
    ERR_peek_error_data(&data, &flags);
    if (!test_str_eq("../test/errtest.c", 326, "data", "\"\"", data, "")
            || !test_int_eq("../test/errtest.c", 327, "flags", "ERR_TXT_MALLOCED", flags, 0x01))
        goto err;
    ERR_clear_error();
...
static int test_save_restore(int idx)
{
    ...
    const char *data = 
# 348 "../test/errtest.c" 3 4
                      ((void *)0)
# 348 "../test/errtest.c"
                          ;

    if (!test_ptr("../test/errtest.c", 350, "es = OSSL_ERR_STATE_new()", es = OSSL_ERR_STATE_new()))
        goto err;

    (ERR_new(), ERR_set_debug("../test/errtest.c",353,__func__), ERR_set_error)((15),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 353 "../test/errtest.c" 3 4
   ((void *)0)
# 353 "../test/errtest.c"
   );
    mallocfail = ERR_peek_last_error();
    if (!test_ulong_gt("../test/errtest.c", 355, "mallocfail", "0", mallocfail, 0))
        goto err;

    if (idx == 1 && !test_int_eq("../test/errtest.c", 358, "ERR_set_mark()", "1", ERR_set_mark(), 1))
        goto err;

    (ERR_new(), ERR_set_debug("../test/errtest.c",361,__func__), ERR_set_error)(15, (259|((0x1 << 18L)|(0x2 << 18L))), testdata);
    interr = ERR_peek_last_error();
    if (!test_ulong_ne("../test/errtest.c", 363, "mallocfail", "ERR_peek_last_error()", mallocfail, ERR_peek_last_error()))
        goto err;

    if (idx == 0) {
        OSSL_ERR_STATE_save(es);

        if (!test_ulong_eq("../test/errtest.c", 369, "ERR_peek_last_error()", "0", ERR_peek_last_error(), 0))
            goto err;
    } else {
        OSSL_ERR_STATE_save_to_mark(es);

        if (!test_ulong_ne("../test/errtest.c", 374, "ERR_peek_last_error()", "0", ERR_peek_last_error(), 0))
            goto err;
    }
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (!test_ulong_eq("../test/errtest.c", 381, "ERR_peek_last_error()", "interr", ERR_peek_last_error(), interr))
            goto err;
        ERR_peek_last_error_data(&data, &flags);
        if (!test_str_eq("../test/errtest.c", 384, "data", "testdata", data, testdata)
                || !test_int_eq("../test/errtest.c", 385, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
            goto err;
        ...
        if (idx == 0 || i == 0) {
            if (!test_ulong_eq("../test/errtest.c", 393, "ERR_get_error_all(NULL, NULL, NULL, &data, &flags)", "mallocfail", ERR_get_error_all(
# 393 "../test/errtest.c" 3 4
                ((void *)0)
# 393 "../test/errtest.c"
                , 
# 393 "../test/errtest.c" 3 4
...
# 393 "../test/errtest.c"
                ...
                || !test_int_ne("../test/errtest.c", 395, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
                goto err;
        }

        if (!test_ulong_eq("../test/errtest.c", 399, "ERR_get_error_all(NULL, NULL, NULL, &data, &flags)", "interr", ERR_get_error_all(
# 399 "../test/errtest.c" 3 4
            ((void *)0)
# 399 "../test/errtest.c"
            , 
# 399 "../test/errtest.c" 3 4
...
# 399 "../test/errtest.c"
            ...
            || !test_str_eq("../test/errtest.c", 401, "data", "testdata", data, testdata)
            || !test_int_eq("../test/errtest.c", 402, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
            goto err;

        if (idx == 0) {
            if (!test_ulong_eq("../test/errtest.c", 406, "ERR_get_error_all(NULL, NULL, NULL, &data, &flags)", "mallocfail", ERR_get_error_all(
# 406 "../test/errtest.c" 3 4
                ((void *)0)
# 406 "../test/errtest.c"
                , 
# 406 "../test/errtest.c" 3 4
...
# 406 "../test/errtest.c"
                ...
                || !test_int_ne("../test/errtest.c", 408, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
                goto err;
        }

        if (!test_ulong_eq("../test/errtest.c", 412, "ERR_get_error_all(NULL, NULL, NULL, &data, &flags)", "interr", ERR_get_error_all(
# 412 "../test/errtest.c" 3 4
            ((void *)0)
# 412 "../test/errtest.c"
            , 
# 412 "../test/errtest.c" 3 4
...
# 412 "../test/errtest.c"
            ...
            || !test_str_eq("../test/errtest.c", 414, "data", "testdata", data, testdata)
            || !test_int_eq("../test/errtest.c", 415, "flags", "ERR_TXT_STRING | ERR_TXT_MALLOCED", flags, 0x02 | 0x01))
            goto err;

        if (!test_ulong_eq("../test/errtest.c", 418, "ERR_get_error()", "0", ERR_get_error(), 0))
            goto err;
    }
...
int setup_tests(void)
{
    ...
    add_test("test_clear_error", test_clear_error);
    return 1;
}
