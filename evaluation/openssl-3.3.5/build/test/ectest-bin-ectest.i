...
# 42 "../test/ectest.c"
                                                      ;
    const EC_POINT *G = 
# 43 "../test/ectest.c" 3 4
                       ((void *)0)
# 43 "../test/ectest.c"
                           ;
    BN_CTX *ctx = 
# 44 "../test/ectest.c" 3 4
                 ((void *)0)
# 44 "../test/ectest.c"
                     ;
    int i = 0, r = 0;

    if (!test_ptr("../test/ectest.c", 47, "n1 = BN_new()", n1 = BN_new())
        || !test_ptr("../test/ectest.c", 48, "n2 = BN_new()", n2 = BN_new())
        || !test_ptr("../test/ectest.c", 49, "order = BN_new()", order = BN_new())
        || !test_ptr("../test/ectest.c", 50, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 51, "G = EC_GROUP_get0_generator(group)", G = EC_GROUP_get0_generator(group))
        || !test_ptr("../test/ectest.c", 52, "P = EC_POINT_new(group)", P = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 53, "Q = EC_POINT_new(group)", Q = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 54, "R = EC_POINT_new(group)", R = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 55, "S = EC_POINT_new(group)", S = EC_POINT_new(group)))
        goto err;

    if (!test_true("../test/ectest.c", 58, "EC_GROUP_get_order(group, order, ctx)", (EC_GROUP_get_order(group, order, ctx)) != 0)
        || !test_true("../test/ectest.c", 59, "EC_POINT_mul(group, Q, order, NULL, NULL, ctx)", (EC_POINT_mul(group, Q, order, 
# 59 "../test/ectest.c" 3 4
           ((void *)0)
# 59 "../test/ectest.c"
           , 
# 59 "../test/ectest.c" 3 4
...
# 59 "../test/ectest.c"
           , ctx)) != 0)
        || !test_true("../test/ectest.c", 60, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0)

        || !test_true("../test/ectest.c", 62, "EC_GROUP_precompute_mult(group, ctx)", (EC_GROUP_precompute_mult(group, ctx)) != 0)

        || !test_true("../test/ectest.c", 64, "EC_POINT_mul(group, Q, order, NULL, NULL, ctx)", (EC_POINT_mul(group, Q, order, 
# 64 "../test/ectest.c" 3 4
           ((void *)0)
# 64 "../test/ectest.c"
           , 
# 64 "../test/ectest.c" 3 4
...
# 64 "../test/ectest.c"
           , ctx)) != 0)
        || !test_true("../test/ectest.c", 65, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0)
        || !test_true("../test/ectest.c", 66, "EC_POINT_copy(P, G)", (EC_POINT_copy(P, G)) != 0)
        || !test_true("../test/ectest.c", 67, "BN_one(n1)", ((BN_set_word((n1),1))) != 0)
        || !test_true("../test/ectest.c", 68, "EC_POINT_mul(group, Q, n1, NULL, NULL, ctx)", (EC_POINT_mul(group, Q, n1, 
# 68 "../test/ectest.c" 3 4
           ((void *)0)
# 68 "../test/ectest.c"
           , 
# 68 "../test/ectest.c" 3 4
...
# 68 "../test/ectest.c"
           , ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 69, "0", "EC_POINT_cmp(group, Q, P, ctx)", 0, EC_POINT_cmp(group, Q, P, ctx))
        || !test_true("../test/ectest.c", 70, "BN_sub(n1, order, n1)", (BN_sub(n1, order, n1)) != 0)
        || !test_true("../test/ectest.c", 71, "EC_POINT_mul(group, Q, n1, NULL, NULL, ctx)", (EC_POINT_mul(group, Q, n1, 
# 71 "../test/ectest.c" 3 4
           ((void *)0)
# 71 "../test/ectest.c"
           , 
# 71 "../test/ectest.c" 3 4
...
# 71 "../test/ectest.c"
           , ctx)) != 0)
        || !test_true("../test/ectest.c", 72, "EC_POINT_invert(group, Q, ctx)", (EC_POINT_invert(group, Q, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 73, "0", "EC_POINT_cmp(group, Q, P, ctx)", 0, EC_POINT_cmp(group, Q, P, ctx)))
        goto err;
    ...
    for (i = 1; i <= 2; i++) {
        ...
        if (!test_true("../test/ectest.c", 82, "BN_set_word(n1, i)", (BN_set_word(n1, i)) != 0)




            || !test_true("../test/ectest.c", 87, "EC_POINT_mul(group, P, n1, NULL, NULL, ctx)", (EC_POINT_mul(group, P, n1, 
# 87 "../test/ectest.c" 3 4
               ((void *)0)
# 87 "../test/ectest.c"
               , 
# 87 "../test/ectest.c" 3 4
...
# 87 "../test/ectest.c"
               , ctx)) != 0)
            || (i == 1 && !test_int_eq("../test/ectest.c", 88, "0", "EC_POINT_cmp(group, P, G, ctx)", 0, EC_POINT_cmp(group, P, G, ctx)))
            || !test_true("../test/ectest.c", 89, "BN_one(n1)", ((BN_set_word((n1),1))) != 0)

            || !test_true("../test/ectest.c", 91, "BN_sub(n1, n1, order)", (BN_sub(n1, n1, order)) != 0)
            || !test_true("../test/ectest.c", 92, "EC_POINT_mul(group, Q, NULL, P, n1, ctx)", (EC_POINT_mul(group, Q, 
# 92 "../test/ectest.c" 3 4
               ((void *)0)
# 92 "../test/ectest.c"
               , P, n1, ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 93, "0", "EC_POINT_cmp(group, Q, P, ctx)", 0, EC_POINT_cmp(group, Q, P, ctx))


            || !test_true("../test/ectest.c", 96, "BN_add(n2, order, BN_value_one())", (BN_add(n2, order, BN_value_one())) != 0)
            || !test_true("../test/ectest.c", 97, "EC_POINT_mul(group, Q, NULL, P, n2, ctx)", (EC_POINT_mul(group, Q, 
# 97 "../test/ectest.c" 3 4
               ((void *)0)
# 97 "../test/ectest.c"
               , P, n2, ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 98, "0", "EC_POINT_cmp(group, Q, P, ctx)", 0, EC_POINT_cmp(group, Q, P, ctx))


            || !test_true("../test/ectest.c", 101, "BN_mul(n2, n1, n2, ctx)", (BN_mul(n2, n1, n2, ctx)) != 0)
            || !test_true("../test/ectest.c", 102, "EC_POINT_mul(group, Q, NULL, P, n2, ctx)", (EC_POINT_mul(group, Q, 
# 102 "../test/ectest.c" 3 4
               ((void *)0)
# 102 "../test/ectest.c"
               , P, n2, ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 103, "0", "EC_POINT_cmp(group, Q, P, ctx)", 0, EC_POINT_cmp(group, Q, P, ctx)))
            goto err;


        BN_set_negative(n2, 0);
        if (!test_true("../test/ectest.c", 108, "EC_POINT_mul(group, Q, NULL, P, n2, ctx)", (EC_POINT_mul(group, Q, 
# 108 "../test/ectest.c" 3 4
            ((void *)0)
# 108 "../test/ectest.c"
            , P, n2, ctx)) != 0)

            || !test_true("../test/ectest.c", 110, "EC_POINT_add(group, Q, Q, P, ctx)", (EC_POINT_add(group, Q, Q, P, ctx)) != 0)
            || !test_true("../test/ectest.c", 111, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0)
            || !test_false("../test/ectest.c", 112, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
            goto err;
        ...
        if (!test_true("../test/ectest.c", 120, "EC_POINTs_mul(group, R, NULL, 2, points, scalars, ctx)", (EC_POINTs_mul(group, R, 
# 120 "../test/ectest.c" 3 4
            ((void *)0)
# 120 "../test/ectest.c"
            , 2, points, scalars, ctx)) != 0)
            || !test_true("../test/ectest.c", 121, "EC_POINT_dbl(group, S, points[0], ctx)", (EC_POINT_dbl(group, S, points[0], ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 122, "0", "EC_POINT_cmp(group, R, S, ctx)", 0, EC_POINT_cmp(group, R, S, ctx)))
            goto err;
        ...
        scalars[5] = n2;
        points[5] = Q;
        if (!test_true("../test/ectest.c", 137, "EC_POINTs_mul(group, P, NULL, 6, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 137 "../test/ectest.c" 3 4
            ((void *)0)
# 137 "../test/ectest.c"
            , 6, points, scalars, ctx)) != 0)
            || !test_true("../test/ectest.c", 138, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
            goto err;
...
err:
    if (r == 0 && i != 0)
        test_info("../test/ectest.c", 146, i == 1 ? "allowing precomputation" : "without precomputation")
                                                    ;
    EC_POINT_free(P);
    EC_POINT_free(Q);
    EC_POINT_free(R);
...
{
    BN_CTX *ctx = 
# 161 "../test/ectest.c" 3 4
                 ((void *)0)
# 161 "../test/ectest.c"
                     ;
    BIGNUM *p = 
# 162 "../test/ectest.c" 3 4
               ((void *)0)
# 162 "../test/ectest.c"
                   , *a = 
# 162 "../test/ectest.c" 3 4
...
# 162 "../test/ectest.c"
                                                          ;
    EC_GROUP *group = 
# 163 "../test/ectest.c" 3 4
                     ((void *)0)
# 163 "../test/ectest.c"
                         ;
    EC_POINT *P = 
# 164 "../test/ectest.c" 3 4
                 ((void *)0)
# 164 "../test/ectest.c"
                     , *Q = 
# 164 "../test/ectest.c" 3 4
...
# 165 "../test/ectest.c"
    ...
    if (!test_ptr("../test/ectest.c", 174, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 175, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/ectest.c", 176, "a = BN_new()", a = BN_new())
        || !test_ptr("../test/ectest.c", 177, "b = BN_new()", b = BN_new())
        || !test_true("../test/ectest.c", 178, "BN_hex2bn(&p, \"17\")", (BN_hex2bn(&p, "17")) != 0)
        || !test_true("../test/ectest.c", 179, "BN_hex2bn(&a, \"1\")", (BN_hex2bn(&a, "1")) != 0)
        || !test_true("../test/ectest.c", 180, "BN_hex2bn(&b, \"1\")", (BN_hex2bn(&b, "1")) != 0)
        || !test_ptr("../test/ectest.c", 181, "group = EC_GROUP_new_curve_GFp(p, a, b, ctx)", group = EC_GROUP_new_curve_GFp(p, a, b, ctx))
        || !test_true("../test/ectest.c", 182, "EC_GROUP_get_curve(group, p, a, b, ctx)", (EC_GROUP_get_curve(group, p, a, b, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 185, "Curve defined by Weierstrass equation");
    ...
    buf[0] = 0;
    if (!test_ptr("../test/ectest.c", 192, "P = EC_POINT_new(group)", P = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 193, "Q = EC_POINT_new(group)", Q = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 194, "R = EC_POINT_new(group)", R = EC_POINT_new(group))
        || !test_true("../test/ectest.c", 195, "EC_POINT_set_to_infinity(group, P)", (EC_POINT_set_to_infinity(group, P)) != 0)
        || !test_true("../test/ectest.c", 196, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0)
        || !test_true("../test/ectest.c", 197, "EC_POINT_oct2point(group, Q, buf, 1, ctx)", (EC_POINT_oct2point(group, Q, buf, 1, ctx)) != 0)
        || !test_true("../test/ectest.c", 198, "EC_POINT_add(group, P, P, Q, ctx)", (EC_POINT_add(group, P, P, Q, ctx)) != 0)
        || !test_true("../test/ectest.c", 199, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0)
        || !test_ptr("../test/ectest.c", 200, "x = BN_new()", x = BN_new())
        || !test_ptr("../test/ectest.c", 201, "y = BN_new()", y = BN_new())
        || !test_ptr("../test/ectest.c", 202, "z = BN_new()", z = BN_new())
        || !test_ptr("../test/ectest.c", 203, "yplusone = BN_new()", yplusone = BN_new())
        || !test_true("../test/ectest.c", 204, "BN_hex2bn(&x, \"D\")", (BN_hex2bn(&x, "D")) != 0)
        || !test_true("../test/ectest.c", 205, "EC_POINT_set_compressed_coordinates(group, Q, x, 1, ctx)", (EC_POINT_set_compressed_coordinates(group, Q, x, 1, ctx)) != 0))
        goto err;

    if (!test_int_gt("../test/ectest.c", 208, "EC_POINT_is_on_curve(group, Q, ctx)", "0", EC_POINT_is_on_curve(group, Q, ctx), 0)) {
        if (!test_true("../test/ectest.c", 209, "EC_POINT_get_affine_coordinates(group, Q, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, Q, x, y, ctx)) != 0))
            goto err;
        test_info("../test/ectest.c", 211, "Point is not on curve");
    ...
    k = 100;
    do {
        if (!test_int_ne("../test/ectest.c", 220, "k--", "0", k--, 0))
            goto err;

        if (EC_POINT_is_at_infinity(group, P)) {
            test_note("     point at infinity");
        } else {
            if (!test_true("../test/ectest.c", 226, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0)
                                                                )
                goto err;
        ...
        if (!test_true("../test/ectest.c", 234, "EC_POINT_copy(R, P)", (EC_POINT_copy(R, P)) != 0)
            || !test_true("../test/ectest.c", 235, "EC_POINT_add(group, P, P, Q, ctx)", (EC_POINT_add(group, P, P, Q, ctx)) != 0))
            goto err;

    } while (!EC_POINT_is_at_infinity(group, P));

    if (!test_true("../test/ectest.c", 240, "EC_POINT_add(group, P, Q, R, ctx)", (EC_POINT_add(group, P, Q, R, ctx)) != 0)
        || !test_true("../test/ectest.c", 241, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
        goto err;

    len =
        EC_POINT_point2oct(group, Q, POINT_CONVERSION_COMPRESSED, buf,
                           sizeof(buf), ctx);
    if (!test_size_t_ne("../test/ectest.c", 247, "len", "0", len, 0)
        || !test_true("../test/ectest.c", 248, "EC_POINT_oct2point(group, P, buf, len, ctx)", (EC_POINT_oct2point(group, P, buf, len, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 249, "0", "EC_POINT_cmp(group, P, Q, ctx)", 0, EC_POINT_cmp(group, P, Q, ctx)))
        goto err;
    ...
    len = EC_POINT_point2oct(group, Q, POINT_CONVERSION_UNCOMPRESSED,
                             buf, sizeof(buf), ctx);
    if (!test_size_t_ne("../test/ectest.c", 256, "len", "0", len, 0)
        || !test_true("../test/ectest.c", 257, "EC_POINT_oct2point(group, P, buf, len, ctx)", (EC_POINT_oct2point(group, P, buf, len, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 258, "0", "EC_POINT_cmp(group, P, Q, ctx)", 0, EC_POINT_cmp(group, P, Q, ctx)))
        goto err;
    ...
    len = EC_POINT_point2oct(group, Q, POINT_CONVERSION_HYBRID,
                             buf, sizeof(buf), ctx);
    if (!test_size_t_ne("../test/ectest.c", 265, "len", "0", len, 0)
        || !test_true("../test/ectest.c", 266, "EC_POINT_oct2point(group, P, buf, len, ctx)", (EC_POINT_oct2point(group, P, buf, len, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 267, "0", "EC_POINT_cmp(group, P, Q, ctx)", 0, EC_POINT_cmp(group, P, Q, ctx)))
        goto err;
    test_output_memory("Generator as octet string, hybrid form:",
                       buf, len);

    if (!test_true("../test/ectest.c", 272, "EC_POINT_invert(group, P, ctx)", (EC_POINT_invert(group, P, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 273, "0", "EC_POINT_cmp(group, P, R, ctx)", 0, EC_POINT_cmp(group, P, R, ctx))
        ...
        || !test_true("../test/ectest.c", 280, "BN_hex2bn(&p, \"FFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF\")", (BN_hex2bn(&p, "FFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF")) != 0)

        || !test_int_eq("../test/ectest.c", 282, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 282 "../test/ectest.c" 3 4
           ((void *)0)
# 282 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 283, "BN_hex2bn(&a, \"FFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC\")", (BN_hex2bn(&a, "FFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")) != 0)

        || !test_true("../test/ectest.c", 285, "BN_hex2bn(&b, \"1C97BEFC\" \"54BD7A8B65ACF89F81D4D4ADC565FA45\")", (BN_hex2bn(&b, "1C97BEFC" "54BD7A8B65ACF89F81D4D4ADC565FA45")) != 0)

        || !test_true("../test/ectest.c", 287, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)
        || !test_true("../test/ectest.c", 288, "BN_hex2bn(&x, \"4A96B568\" \"8EF573284664698968C38BB913CBFC82\")", (BN_hex2bn(&x, "4A96B568" "8EF573284664698968C38BB913CBFC82")) != 0)

        || !test_true("../test/ectest.c", 290, "BN_hex2bn(&y, \"23a62855\" \"3168947d59dcc912042351377ac5fb32\")", (BN_hex2bn(&y, "23a62855" "3168947d59dcc912042351377ac5fb32")) != 0)

        || !test_true("../test/ectest.c", 292, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 297, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_true("../test/ectest.c", 299, "EC_POINT_set_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, y, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 300, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 301, "BN_hex2bn(&z, \"0100000000\" \"000000000001F4C8F927AED3CA752257\")", (BN_hex2bn(&z, "0100000000" "000000000001F4C8F927AED3CA752257")) != 0)

        || !test_true("../test/ectest.c", 303, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 304, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;
    test_info("../test/ectest.c", 306, "SEC2 curve secp160r1 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 310, "BN_hex2bn(&z, \"23a62855\" \"3168947d59dcc912042351377ac5fb32\")", (BN_hex2bn(&z, "23a62855" "3168947d59dcc912042351377ac5fb32")) != 0)

        || !test_BN_eq("../test/ectest.c", 312, "y", "z", y, z)
        || !test_int_eq("../test/ectest.c", 313, "EC_GROUP_get_degree(group)", "160", EC_GROUP_get_degree(group), 160)
        || !group_order_tests(group)



        || !test_true("../test/ectest.c", 318, "BN_hex2bn(&p, \"FFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF\")", (BN_hex2bn(&p, "FFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF")) != 0)

        || !test_int_eq("../test/ectest.c", 320, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 320 "../test/ectest.c" 3 4
           ((void *)0)
# 320 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 321, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")) != 0)

        || !test_true("../test/ectest.c", 323, "BN_hex2bn(&b, \"64210519E59C80E7\" \"0FA7E9AB72243049FEB8DEECC146B9B1\")", (BN_hex2bn(&b, "64210519E59C80E7" "0FA7E9AB72243049FEB8DEECC146B9B1")) != 0)

        || !test_true("../test/ectest.c", 325, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)
        || !test_true("../test/ectest.c", 326, "BN_hex2bn(&x, \"188DA80EB03090F6\" \"7CBF20EB43A18800F4FF0AFD82FF1012\")", (BN_hex2bn(&x, "188DA80EB03090F6" "7CBF20EB43A18800F4FF0AFD82FF1012")) != 0)

        || !test_true("../test/ectest.c", 328, "EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)", (EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 329, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 330, "BN_hex2bn(&z, \"FFFFFFFFFFFFFFFF\" \"FFFFFFFF99DEF836146BC9B1B4D22831\")", (BN_hex2bn(&z, "FFFFFFFFFFFFFFFF" "FFFFFFFF99DEF836146BC9B1B4D22831")) != 0)

        || !test_true("../test/ectest.c", 332, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 333, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 336, "NIST curve P-192 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 340, "BN_hex2bn(&z, \"07192B95FFC8DA78\" \"631011ED6B24CDD573F977A11E794811\")", (BN_hex2bn(&z, "07192B95FFC8DA78" "631011ED6B24CDD573F977A11E794811")) != 0)

        || !test_BN_eq("../test/ectest.c", 342, "y", "z", y, z)
        || !test_true("../test/ectest.c", 343, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 348, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_int_eq("../test/ectest.c", 350, "EC_GROUP_get_degree(group)", "192", EC_GROUP_get_degree(group), 192)
        || !group_order_tests(group)



        || !test_true("../test/ectest.c", 355, "BN_hex2bn(&p, \"FFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFF000000000000000000000001\")", (BN_hex2bn(&p, "FFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFF000000000000000000000001")) != 0)

        || !test_int_eq("../test/ectest.c", 357, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 357 "../test/ectest.c" 3 4
           ((void *)0)
# 357 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 358, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")) != 0)

        || !test_true("../test/ectest.c", 360, "BN_hex2bn(&b, \"B4050A850C04B3ABF5413256\" \"5044B0B7D7BFD8BA270B39432355FFB4\")", (BN_hex2bn(&b, "B4050A850C04B3ABF5413256" "5044B0B7D7BFD8BA270B39432355FFB4")) != 0)

        || !test_true("../test/ectest.c", 362, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)
        || !test_true("../test/ectest.c", 363, "BN_hex2bn(&x, \"B70E0CBD6BB4BF7F321390B9\" \"4A03C1D356C21122343280D6115C1D21\")", (BN_hex2bn(&x, "B70E0CBD6BB4BF7F321390B9" "4A03C1D356C21122343280D6115C1D21")) != 0)

        || !test_true("../test/ectest.c", 365, "EC_POINT_set_compressed_coordinates(group, P, x, 0, ctx)", (EC_POINT_set_compressed_coordinates(group, P, x, 0, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 366, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 367, "BN_hex2bn(&z, \"FFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFF16A2E0B8F03E13DD29455C5C2A3D\")", (BN_hex2bn(&z, "FFFFFFFFFFFFFFFFFFFFFFFF" "FFFF16A2E0B8F03E13DD29455C5C2A3D")) != 0)

        || !test_true("../test/ectest.c", 369, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 370, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 373, "NIST curve P-224 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 377, "BN_hex2bn(&z, \"BD376388B5F723FB4C22DFE6\" \"CD4375A05A07476444D5819985007E34\")", (BN_hex2bn(&z, "BD376388B5F723FB4C22DFE6" "CD4375A05A07476444D5819985007E34")) != 0)

        || !test_BN_eq("../test/ectest.c", 379, "y", "z", y, z)
        || !test_true("../test/ectest.c", 380, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 385, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_int_eq("../test/ectest.c", 387, "EC_GROUP_get_degree(group)", "224", EC_GROUP_get_degree(group), 224)
        || !group_order_tests(group)



        || !test_true("../test/ectest.c", 392, "BN_hex2bn(&p, \"FFFFFFFF000000010000000000000000\" \"00000000FFFFFFFFFFFFFFFFFFFFFFFF\")", (BN_hex2bn(&p, "FFFFFFFF000000010000000000000000" "00000000FFFFFFFFFFFFFFFFFFFFFFFF")) != 0)

        || !test_int_eq("../test/ectest.c", 394, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 394 "../test/ectest.c" 3 4
           ((void *)0)
# 394 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 395, "BN_hex2bn(&a, \"FFFFFFFF000000010000000000000000\" \"00000000FFFFFFFFFFFFFFFFFFFFFFFC\")", (BN_hex2bn(&a, "FFFFFFFF000000010000000000000000" "00000000FFFFFFFFFFFFFFFFFFFFFFFC")) != 0)

        || !test_true("../test/ectest.c", 397, "BN_hex2bn(&b, \"5AC635D8AA3A93E7B3EBBD55769886BC\" \"651D06B0CC53B0F63BCE3C3E27D2604B\")", (BN_hex2bn(&b, "5AC635D8AA3A93E7B3EBBD55769886BC" "651D06B0CC53B0F63BCE3C3E27D2604B")) != 0)

        || !test_true("../test/ectest.c", 399, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)

        || !test_true("../test/ectest.c", 401, "BN_hex2bn(&x, \"6B17D1F2E12C4247F8BCE6E563A440F2\" \"77037D812DEB33A0F4A13945D898C296\")", (BN_hex2bn(&x, "6B17D1F2E12C4247F8BCE6E563A440F2" "77037D812DEB33A0F4A13945D898C296")) != 0)

        || !test_true("../test/ectest.c", 403, "EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)", (EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 404, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 405, "BN_hex2bn(&z, \"FFFFFFFF00000000FFFFFFFFFFFFFFFF\" \"BCE6FAADA7179E84F3B9CAC2FC632551\")", (BN_hex2bn(&z, "FFFFFFFF00000000FFFFFFFFFFFFFFFF" "BCE6FAADA7179E84F3B9CAC2FC632551")) != 0)

        || !test_true("../test/ectest.c", 407, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 408, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 411, "NIST curve P-256 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 415, "BN_hex2bn(&z, \"4FE342E2FE1A7F9B8EE7EB4A7C0F9E16\" \"2BCE33576B315ECECBB6406837BF51F5\")", (BN_hex2bn(&z, "4FE342E2FE1A7F9B8EE7EB4A7C0F9E16" "2BCE33576B315ECECBB6406837BF51F5")) != 0)

        || !test_BN_eq("../test/ectest.c", 417, "y", "z", y, z)
        || !test_true("../test/ectest.c", 418, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 423, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_int_eq("../test/ectest.c", 425, "EC_GROUP_get_degree(group)", "256", EC_GROUP_get_degree(group), 256)
        || !group_order_tests(group)



        || !test_true("../test/ectest.c", 430, "BN_hex2bn(&p, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE\" \"FFFFFFFF0000000000000000FFFFFFFF\")", (BN_hex2bn(&p, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE" "FFFFFFFF0000000000000000FFFFFFFF")) != 0)


        || !test_int_eq("../test/ectest.c", 433, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 433 "../test/ectest.c" 3 4
           ((void *)0)
# 433 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 434, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE\" \"FFFFFFFF0000000000000000FFFFFFFC\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE" "FFFFFFFF0000000000000000FFFFFFFC")) != 0)


        || !test_true("../test/ectest.c", 437, "BN_hex2bn(&b, \"B3312FA7E23EE7E4988E056BE3F82D19\" \"181D9C6EFE8141120314088F5013875A\" \"C656398D8A2ED19D2A85C8EDD3EC2AEF\")", (BN_hex2bn(&b, "B3312FA7E23EE7E4988E056BE3F82D19" "181D9C6EFE8141120314088F5013875A" "C656398D8A2ED19D2A85C8EDD3EC2AEF")) != 0)


        || !test_true("../test/ectest.c", 440, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)

        || !test_true("../test/ectest.c", 442, "BN_hex2bn(&x, \"AA87CA22BE8B05378EB1C71EF320AD74\" \"6E1D3B628BA79B9859F741E082542A38\" \"5502F25DBF55296C3A545E3872760AB7\")", (BN_hex2bn(&x, "AA87CA22BE8B05378EB1C71EF320AD74" "6E1D3B628BA79B9859F741E082542A38" "5502F25DBF55296C3A545E3872760AB7")) != 0)


        || !test_true("../test/ectest.c", 445, "EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)", (EC_POINT_set_compressed_coordinates(group, P, x, 1, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 446, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 447, "BN_hex2bn(&z, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFC7634D81F4372DDF\" \"581A0DB248B0A77AECEC196ACCC52973\")", (BN_hex2bn(&z, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFC7634D81F4372DDF" "581A0DB248B0A77AECEC196ACCC52973")) != 0)


        || !test_true("../test/ectest.c", 450, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 451, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 454, "NIST curve P-384 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 458, "BN_hex2bn(&z, \"3617DE4A96262C6F5D9E98BF9292DC29\" \"F8F41DBD289A147CE9DA3113B5F0B8C0\" \"0A60B1CE1D7E819D7A431D7C90EA0E5F\")", (BN_hex2bn(&z, "3617DE4A96262C6F5D9E98BF9292DC29" "F8F41DBD289A147CE9DA3113B5F0B8C0" "0A60B1CE1D7E819D7A431D7C90EA0E5F")) != 0)


        || !test_BN_eq("../test/ectest.c", 461, "y", "z", y, z)
        || !test_true("../test/ectest.c", 462, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 467, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_int_eq("../test/ectest.c", 469, "EC_GROUP_get_degree(group)", "384", EC_GROUP_get_degree(group), 384)
        || !group_order_tests(group)


        || !test_true("../test/ectest.c", 473, "BN_hex2bn(&p, \"1FF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\")", (BN_hex2bn(&p, "1FF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")) != 0)




        || !test_int_eq("../test/ectest.c", 478, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 478 "../test/ectest.c" 3 4
           ((void *)0)
# 478 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 479, "BN_hex2bn(&a, \"1FF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC\")", (BN_hex2bn(&a, "1FF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC")) != 0)




        || !test_true("../test/ectest.c", 484, "BN_hex2bn(&b, \"051\" \"953EB9618E1C9A1F929A21A0B68540EE\" \"A2DA725B99B315F3B8B489918EF109E1\" \"56193951EC7E937B1652C0BD3BB1BF07\" \"3573DF883D2C34F1EF451FD46B503F00\")", (BN_hex2bn(&b, "051" "953EB9618E1C9A1F929A21A0B68540EE" "A2DA725B99B315F3B8B489918EF109E1" "56193951EC7E937B1652C0BD3BB1BF07" "3573DF883D2C34F1EF451FD46B503F00")) != 0)




        || !test_true("../test/ectest.c", 489, "EC_GROUP_set_curve(group, p, a, b, ctx)", (EC_GROUP_set_curve(group, p, a, b, ctx)) != 0)
        || !test_true("../test/ectest.c", 490, "BN_hex2bn(&x, \"C6\" \"858E06B70404E9CD9E3ECB662395B442\" \"9C648139053FB521F828AF606B4D3DBA\" \"A14B5E77EFE75928FE1DC127A2FFA8DE\" \"3348B3C1856A429BF97E7E31C2E5BD66\")", (BN_hex2bn(&x, "C6" "858E06B70404E9CD9E3ECB662395B442" "9C648139053FB521F828AF606B4D3DBA" "A14B5E77EFE75928FE1DC127A2FFA8DE" "3348B3C1856A429BF97E7E31C2E5BD66")) != 0)




        || !test_true("../test/ectest.c", 495, "EC_POINT_set_compressed_coordinates(group, P, x, 0, ctx)", (EC_POINT_set_compressed_coordinates(group, P, x, 0, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 496, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 497, "BN_hex2bn(&z, \"1FF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA\" \"51868783BF2F966B7FCC0148F709A5D0\" \"3BB5C9B8899C47AEBB6FB71E91386409\")", (BN_hex2bn(&z, "1FF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA" "51868783BF2F966B7FCC0148F709A5D0" "3BB5C9B8899C47AEBB6FB71E91386409")) != 0)




        || !test_true("../test/ectest.c", 502, "EC_GROUP_set_generator(group, P, z, BN_value_one())", (EC_GROUP_set_generator(group, P, z, BN_value_one())) != 0)
        || !test_true("../test/ectest.c", 503, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 506, "NIST curve P-521 -- Generator");
    test_output_bignum("x", x);
    test_output_bignum("y", y);

    if (!test_true("../test/ectest.c", 510, "BN_hex2bn(&z, \"118\" \"39296A789A3BC0045C8A5FB42C7D1BD9\" \"98F54449579B446817AFBD17273E662C\" \"97EE72995EF42640C550B9013FAD0761\" \"353C7086A272C24088BE94769FD16650\")", (BN_hex2bn(&z, "118" "39296A789A3BC0045C8A5FB42C7D1BD9" "98F54449579B446817AFBD17273E662C" "97EE72995EF42640C550B9013FAD0761" "353C7086A272C24088BE94769FD16650")) != 0)




        || !test_BN_eq("../test/ectest.c", 515, "y", "z", y, z)
        || !test_true("../test/ectest.c", 516, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 521, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)

        || !test_int_eq("../test/ectest.c", 523, "EC_GROUP_get_degree(group)", "521", EC_GROUP_get_degree(group), 521)
        || !group_order_tests(group)




        || !test_true("../test/ectest.c", 529, "EC_POINT_set_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, y, ctx)) != 0)
        || !test_true("../test/ectest.c", 530, "EC_POINT_copy(Q, P)", (EC_POINT_copy(Q, P)) != 0)
        || !test_false("../test/ectest.c", 531, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0)
        || !test_true("../test/ectest.c", 532, "EC_POINT_dbl(group, P, P, ctx)", (EC_POINT_dbl(group, P, P, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 533, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 534, "EC_POINT_invert(group, Q, ctx)", (EC_POINT_invert(group, Q, ctx)) != 0)
        || !test_true("../test/ectest.c", 535, "EC_POINT_add(group, R, P, Q, ctx)", (EC_POINT_add(group, R, P, Q, ctx)) != 0)
        || !test_true("../test/ectest.c", 536, "EC_POINT_add(group, R, R, Q, ctx)", (EC_POINT_add(group, R, R, Q, ctx)) != 0)
        || !test_true("../test/ectest.c", 537, "EC_POINT_is_at_infinity(group, R)", (EC_POINT_is_at_infinity(group, R)) != 0)
        || !test_false("../test/ectest.c", 538, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0))
        goto err;
    ...
    if (!test_true("../test/ectest.c", 548, "EC_GROUP_get_order(group, z, ctx)", (EC_GROUP_get_order(group, z, ctx)) != 0)
        || !test_true("../test/ectest.c", 549, "BN_add(y, z, BN_value_one())", (BN_add(y, z, BN_value_one())) != 0)
        || !test_BN_even("../test/ectest.c", 550, "y", y)
        || !test_true("../test/ectest.c", 551, "BN_rshift1(y, y)", (BN_rshift1(y, y)) != 0))
        goto err;
    ...
    if (!test_true("../test/ectest.c", 558, "EC_POINTs_mul(group, P, NULL, 2, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 558 "../test/ectest.c" 3 4
        ((void *)0)
# 558 "../test/ectest.c"
        , 2, points, scalars, ctx)) != 0)
        || !test_true("../test/ectest.c", 559, "EC_POINTs_mul(group, R, z, 2, points, scalars, ctx)", (EC_POINTs_mul(group, R, z, 2, points, scalars, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 560, "0", "EC_POINT_cmp(group, P, R, ctx)", 0, EC_POINT_cmp(group, P, R, ctx))
        || !test_int_eq("../test/ectest.c", 561, "0", "EC_POINT_cmp(group, R, Q, ctx)", 0, EC_POINT_cmp(group, R, Q, ctx))
        || !test_true("../test/ectest.c", 562, "BN_rand(y, BN_num_bits(y), 0, 0)", (BN_rand(y, BN_num_bits(y), 0, 0)) != 0)
        || !test_true("../test/ectest.c", 563, "BN_add(z, z, y)", (BN_add(z, z, y)) != 0))
        goto err;
    BN_set_negative(z, 1);
    scalars[0] = y;
    scalars[1] = z;

    if (!test_true("../test/ectest.c", 569, "EC_POINTs_mul(group, P, NULL, 2, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 569 "../test/ectest.c" 3 4
        ((void *)0)
# 569 "../test/ectest.c"
        , 2, points, scalars, ctx)) != 0)
        || !test_true("../test/ectest.c", 570, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0)
        || !test_true("../test/ectest.c", 571, "BN_rand(x, BN_num_bits(y) - 1, 0, 0)", (BN_rand(x, BN_num_bits(y) - 1, 0, 0)) != 0)
        || !test_true("../test/ectest.c", 572, "BN_add(z, x, y)", (BN_add(z, x, y)) != 0))
        goto err;
    BN_set_negative(z, 1);
    scalars[0] = x;
    scalars[1] = y;
    ...
    if (!test_ptr("../test/ectest.c", 579, "scalar3 = BN_new()", scalar3 = BN_new()))
        goto err;
    BN_zero_ex(scalar3);
    scalars[3] = scalar3;

    if (!test_true("../test/ectest.c", 584, "EC_POINTs_mul(group, P, NULL, 4, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 584 "../test/ectest.c" 3 4
        ((void *)0)
# 584 "../test/ectest.c"
        , 4, points, scalars, ctx)) != 0)
        || !test_true("../test/ectest.c", 585, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
        goto err;
...
static int char2_curve_test(int n)
{
    int r = 0;
    BN_CTX *ctx = 
# 782 "../test/ectest.c" 3 4
                 ((void *)0)
# 782 "../test/ectest.c"
                     ;
    BIGNUM *p = 
# 783 "../test/ectest.c" 3 4
               ((void *)0)
# 783 "../test/ectest.c"
                   , *a = 
# 783 "../test/ectest.c" 3 4
...
# 784 "../test/ectest.c"
                                                                        ;
    EC_GROUP *group = 
# 785 "../test/ectest.c" 3 4
                     ((void *)0)
# 785 "../test/ectest.c"
                         ;
    EC_POINT *P = 
# 786 "../test/ectest.c" 3 4
                 ((void *)0)
# 786 "../test/ectest.c"
                     , *Q = 
# 786 "../test/ectest.c" 3 4
...
# 786 "../test/ectest.c"
    ...
    if (!test_ptr("../test/ectest.c", 793, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 794, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/ectest.c", 795, "a = BN_new()", a = BN_new())
        || !test_ptr("../test/ectest.c", 796, "b = BN_new()", b = BN_new())
        || !test_ptr("../test/ectest.c", 797, "x = BN_new()", x = BN_new())
        || !test_ptr("../test/ectest.c", 798, "y = BN_new()", y = BN_new())
        || !test_ptr("../test/ectest.c", 799, "z = BN_new()", z = BN_new())
        || !test_ptr("../test/ectest.c", 800, "yplusone = BN_new()", yplusone = BN_new())
        || !test_true("../test/ectest.c", 801, "BN_hex2bn(&p, test->p)", (BN_hex2bn(&p, test->p)) != 0)
        || !test_true("../test/ectest.c", 802, "BN_hex2bn(&a, test->a)", (BN_hex2bn(&a, test->a)) != 0)
        || !test_true("../test/ectest.c", 803, "BN_hex2bn(&b, test->b)", (BN_hex2bn(&b, test->b)) != 0)
        || !test_true("../test/ectest.c", 804, "group = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", (group = EC_GROUP_new_curve_GF2m(p, a, b, ctx)) != 0)
        || !test_ptr("../test/ectest.c", 805, "P = EC_POINT_new(group)", P = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 806, "Q = EC_POINT_new(group)", Q = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 807, "R = EC_POINT_new(group)", R = EC_POINT_new(group))
        || !test_true("../test/ectest.c", 808, "BN_hex2bn(&x, test->x)", (BN_hex2bn(&x, test->x)) != 0)
        || !test_true("../test/ectest.c", 809, "BN_hex2bn(&y, test->y)", (BN_hex2bn(&y, test->y)) != 0)
        || !test_true("../test/ectest.c", 810, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0))
        goto err;
# 841 "../test/ectest.c"
    if (!test_false("../test/ectest.c", 841, "EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, yplusone, ctx)) != 0)
        || !test_true("../test/ectest.c", 842, "EC_POINT_set_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, y, ctx)) != 0)
        || !test_int_gt("../test/ectest.c", 843, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
        || !test_true("../test/ectest.c", 844, "BN_hex2bn(&z, test->order)", (BN_hex2bn(&z, test->order)) != 0)
        || !test_true("../test/ectest.c", 845, "BN_hex2bn(&cof, test->cof)", (BN_hex2bn(&cof, test->cof)) != 0)
        || !test_true("../test/ectest.c", 846, "EC_GROUP_set_generator(group, P, z, cof)", (EC_GROUP_set_generator(group, P, z, cof)) != 0))
        goto err;
    test_info("../test/ectest.c", 848, "%s -- Generator:", test->name);
    test_output_bignum("x", x);
    test_output_bignum("y", y);


    if (!test_int_eq("../test/ectest.c", 853, "EC_GROUP_get_degree(group)", "test->degree", EC_GROUP_get_degree(group), test->degree)
        || !group_order_tests(group))
        goto err;


    if (n == (sizeof(char2_curve_tests)/sizeof((char2_curve_tests)[0])) - 1) {
        if (!test_true("../test/ectest.c", 859, "EC_POINT_set_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_set_affine_coordinates(group, P, x, y, ctx)) != 0)
            || !test_true("../test/ectest.c", 860, "EC_POINT_copy(Q, P)", (EC_POINT_copy(Q, P)) != 0)
            || !test_false("../test/ectest.c", 861, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0)
            || !test_true("../test/ectest.c", 862, "EC_POINT_dbl(group, P, P, ctx)", (EC_POINT_dbl(group, P, P, ctx)) != 0)
            || !test_int_gt("../test/ectest.c", 863, "EC_POINT_is_on_curve(group, P, ctx)", "0", EC_POINT_is_on_curve(group, P, ctx), 0)
            || !test_true("../test/ectest.c", 864, "EC_POINT_invert(group, Q, ctx)", (EC_POINT_invert(group, Q, ctx)) != 0)
            || !test_true("../test/ectest.c", 865, "EC_POINT_add(group, R, P, Q, ctx)", (EC_POINT_add(group, R, P, Q, ctx)) != 0)
            || !test_true("../test/ectest.c", 866, "EC_POINT_add(group, R, R, Q, ctx)", (EC_POINT_add(group, R, R, Q, ctx)) != 0)
            || !test_true("../test/ectest.c", 867, "EC_POINT_is_at_infinity(group, R)", (EC_POINT_is_at_infinity(group, R)) != 0)
            || !test_false("../test/ectest.c", 868, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0))
            goto err;
        ...
        if (!test_true("../test/ectest.c", 877, "BN_add(y, z, BN_value_one())", (BN_add(y, z, BN_value_one())) != 0)
            || !test_BN_even("../test/ectest.c", 878, "y", y)
            || !test_true("../test/ectest.c", 879, "BN_rshift1(y, y)", (BN_rshift1(y, y)) != 0))
            goto err;
        scalars[0] = y;
        scalars[1] = y;


        if (!test_true("../test/ectest.c", 885, "EC_POINTs_mul(group, P, NULL, 2, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 885 "../test/ectest.c" 3 4
            ((void *)0)
# 885 "../test/ectest.c"
            , 2, points, scalars, ctx)) != 0)
            || !test_true("../test/ectest.c", 886, "EC_POINTs_mul(group, R, z, 2, points, scalars, ctx)", (EC_POINTs_mul(group, R, z, 2, points, scalars, ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 887, "0", "EC_POINT_cmp(group, P, R, ctx)", 0, EC_POINT_cmp(group, P, R, ctx))
            || !test_int_eq("../test/ectest.c", 888, "0", "EC_POINT_cmp(group, R, Q, ctx)", 0, EC_POINT_cmp(group, R, Q, ctx)))
            goto err;

        if (!test_true("../test/ectest.c", 891, "BN_rand(y, BN_num_bits(y), 0, 0)", (BN_rand(y, BN_num_bits(y), 0, 0)) != 0)
            || !test_true("../test/ectest.c", 892, "BN_add(z, z, y)", (BN_add(z, z, y)) != 0))
            goto err;
        BN_set_negative(z, 1);
        scalars[0] = y;
        scalars[1] = z;

        if (!test_true("../test/ectest.c", 898, "EC_POINTs_mul(group, P, NULL, 2, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 898 "../test/ectest.c" 3 4
            ((void *)0)
# 898 "../test/ectest.c"
            , 2, points, scalars, ctx)) != 0)
            || !test_true("../test/ectest.c", 899, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
            goto err;

        if (!test_true("../test/ectest.c", 902, "BN_rand(x, BN_num_bits(y) - 1, 0, 0)", (BN_rand(x, BN_num_bits(y) - 1, 0, 0)) != 0)
            || !test_true("../test/ectest.c", 903, "BN_add(z, x, y)", (BN_add(z, x, y)) != 0))
            goto err;
        BN_set_negative(z, 1);
        scalars[0] = x;
        scalars[1] = y;
        ...
        if (!test_true("../test/ectest.c", 910, "EC_POINTs_mul(group, P, NULL, 3, points, scalars, ctx)", (EC_POINTs_mul(group, P, 
# 910 "../test/ectest.c" 3 4
            ((void *)0)
# 910 "../test/ectest.c"
            , 3, points, scalars, ctx)) != 0)
            || !test_true("../test/ectest.c", 911, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
            goto err;
...
{
    BN_CTX *ctx = 
# 936 "../test/ectest.c" 3 4
                 ((void *)0)
# 936 "../test/ectest.c"
                     ;
    BIGNUM *p = 
# 937 "../test/ectest.c" 3 4
               ((void *)0)
# 937 "../test/ectest.c"
                   , *a = 
# 937 "../test/ectest.c" 3 4
...
# 937 "../test/ectest.c"
                                         ;
    EC_GROUP *group = 
# 938 "../test/ectest.c" 3 4
                     ((void *)0)
# 938 "../test/ectest.c"
                         ;
    EC_POINT *P = 
# 939 "../test/ectest.c" 3 4
                 ((void *)0)
# 939 "../test/ectest.c"
                     , *Q = 
# 939 "../test/ectest.c" 3 4
...
# 940 "../test/ectest.c"
    ...
    if (!test_ptr("../test/ectest.c", 945, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 946, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/ectest.c", 947, "a = BN_new()", a = BN_new())
        || !test_ptr("../test/ectest.c", 948, "b = BN_new()", b = BN_new())
        || !test_true("../test/ectest.c", 949, "BN_hex2bn(&p, \"13\")", (BN_hex2bn(&p, "13")) != 0)
        || !test_true("../test/ectest.c", 950, "BN_hex2bn(&a, \"3\")", (BN_hex2bn(&a, "3")) != 0)
        || !test_true("../test/ectest.c", 951, "BN_hex2bn(&b, \"1\")", (BN_hex2bn(&b, "1")) != 0))
        goto err;

    if (!test_ptr("../test/ectest.c", 954, "group = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", group = EC_GROUP_new_curve_GF2m(p, a, b, ctx))
        || !test_true("../test/ectest.c", 955, "EC_GROUP_get_curve(group, p, a, b, ctx)", (EC_GROUP_get_curve(group, p, a, b, ctx)) != 0))
        goto err;

    test_info("../test/ectest.c", 958, "Curve defined by Weierstrass equation");
    test_note("     y^2 + x*y = x^3 + a*x^2 + b (mod p)");
    test_output_bignum("a", a);
    test_output_bignum("b", b);
    test_output_bignum("p", p);

     if (!test_ptr("../test/ectest.c", 964, "P = EC_POINT_new(group)", P = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 965, "Q = EC_POINT_new(group)", Q = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 966, "R = EC_POINT_new(group)", R = EC_POINT_new(group))
        || !test_true("../test/ectest.c", 967, "EC_POINT_set_to_infinity(group, P)", (EC_POINT_set_to_infinity(group, P)) != 0)
        || !test_true("../test/ectest.c", 968, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
        goto err;

    buf[0] = 0;
    if (!test_true("../test/ectest.c", 972, "EC_POINT_oct2point(group, Q, buf, 1, ctx)", (EC_POINT_oct2point(group, Q, buf, 1, ctx)) != 0)
        || !test_true("../test/ectest.c", 973, "EC_POINT_add(group, P, P, Q, ctx)", (EC_POINT_add(group, P, P, Q, ctx)) != 0)
        || !test_true("../test/ectest.c", 974, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0)
        || !test_ptr("../test/ectest.c", 975, "x = BN_new()", x = BN_new())
        || !test_ptr("../test/ectest.c", 976, "y = BN_new()", y = BN_new())
        || !test_ptr("../test/ectest.c", 977, "z = BN_new()", z = BN_new())
        || !test_ptr("../test/ectest.c", 978, "cof = BN_new()", cof = BN_new())
        || !test_ptr("../test/ectest.c", 979, "yplusone = BN_new()", yplusone = BN_new())
        || !test_true("../test/ectest.c", 980, "BN_hex2bn(&x, \"6\")", (BN_hex2bn(&x, "6")) != 0)




        || !test_true("../test/ectest.c", 985, "BN_hex2bn(&y, \"8\")", (BN_hex2bn(&y, "8")) != 0)
        || !test_true("../test/ectest.c", 986, "EC_POINT_set_affine_coordinates(group, Q, x, y, ctx)", (EC_POINT_set_affine_coordinates(group, Q, x, y, ctx)) != 0)

       )
        goto err;
    if (!test_int_gt("../test/ectest.c", 990, "EC_POINT_is_on_curve(group, Q, ctx)", "0", EC_POINT_is_on_curve(group, Q, ctx), 0)) {





        test_info("../test/ectest.c", 996, "Point is not on curve");
        test_output_bignum("x", x);
        test_output_bignum("y", y);
        goto err;
    }
    ...
    k = 100;
    do {
        if (!test_int_ne("../test/ectest.c", 1005, "k--", "0", k--, 0))
            goto err;

        if (EC_POINT_is_at_infinity(group, P))
            test_note("     point at infinity");
        else {
            if (!test_true("../test/ectest.c", 1011, "EC_POINT_get_affine_coordinates(group, P, x, y, ctx)", (EC_POINT_get_affine_coordinates(group, P, x, y, ctx)) != 0)
                                                                )
                goto err;
        ...
        if (!test_true("../test/ectest.c", 1019, "EC_POINT_copy(R, P)", (EC_POINT_copy(R, P)) != 0)
            || !test_true("../test/ectest.c", 1020, "EC_POINT_add(group, P, P, Q, ctx)", (EC_POINT_add(group, P, P, Q, ctx)) != 0))
            goto err;
    }
    while (!EC_POINT_is_at_infinity(group, P));

    if (!test_true("../test/ectest.c", 1025, "EC_POINT_add(group, P, Q, R, ctx)", (EC_POINT_add(group, P, Q, R, ctx)) != 0)
        || !test_true("../test/ectest.c", 1026, "EC_POINT_is_at_infinity(group, P)", (EC_POINT_is_at_infinity(group, P)) != 0))
        goto err;
# 1041 "../test/ectest.c"
    len = EC_POINT_point2oct(group, Q, POINT_CONVERSION_UNCOMPRESSED,
                             buf, sizeof(buf), ctx);
    if (!test_size_t_ne("../test/ectest.c", 1043, "len", "0", len, 0)
        || !test_true("../test/ectest.c", 1044, "EC_POINT_oct2point(group, P, buf, len, ctx)", (EC_POINT_oct2point(group, P, buf, len, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 1045, "0", "EC_POINT_cmp(group, P, Q, ctx)", 0, EC_POINT_cmp(group, P, Q, ctx)))
        goto err;
    test_output_memory("Generator as octet string, uncompressed form:",
                       buf, len);
# 1063 "../test/ectest.c"
    if (!test_true("../test/ectest.c", 1063, "EC_POINT_invert(group, P, ctx)", (EC_POINT_invert(group, P, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 1064, "0", "EC_POINT_cmp(group, P, R, ctx)", 0, EC_POINT_cmp(group, P, R, ctx)))
        goto err;
...
# 1089 "../test/ectest.c"
                              ;
    EC_GROUP *group = 
# 1090 "../test/ectest.c" 3 4
                     ((void *)0)
# 1090 "../test/ectest.c"
                         ;
    EC_POINT *point = 
# 1091 "../test/ectest.c" 3 4
                     ((void *)0)
# 1091 "../test/ectest.c"
                         ;
    unsigned char *buf = 
# 1092 "../test/ectest.c" 3 4
                        ((void *)0)
# 1092 "../test/ectest.c"
                            ;
    size_t len;
    ...
    if (!test_true("../test/ectest.c", 1096, "BN_dec2bn(&x, \"0\")", (BN_dec2bn(&x, "0")) != 0)
        || !test_true("../test/ectest.c", 1097, "BN_dec2bn(&y, \"1\")", (BN_dec2bn(&y, "1")) != 0)
        || !test_ptr("../test/ectest.c", 1098, "group = EC_GROUP_new_by_curve_name(NID_sect571k1)", group = EC_GROUP_new_by_curve_name(733))
        || !test_ptr("../test/ectest.c", 1099, "point = EC_POINT_new(group)", point = EC_POINT_new(group))
        || !test_true("../test/ectest.c", 1100, "EC_POINT_set_affine_coordinates(group, point, x, y, NULL)", (EC_POINT_set_affine_coordinates(group, point, x, y, 
# 1100 "../test/ectest.c" 3 4
           ((void *)0)
# 1100 "../test/ectest.c"
           )) != 0)
        || !test_size_t_ne("../test/ectest.c", 1101, "0", "(len = EC_POINT_point2oct(group, point, POINT_CONVERSION_HYBRID, NULL, 0, NULL))", 0, (len = EC_POINT_point2oct(group, point, POINT_CONVERSION_HYBRID, 
# 1101 "../test/ectest.c" 3 4
           ((void *)0)
# 1101 "../test/ectest.c"
           , 0, 
# 1101 "../test/ectest.c" 3 4
...
# 1101 "../test/ectest.c"
        ...
        || !test_ptr("../test/ectest.c", 1107, "buf = OPENSSL_malloc(len)", buf = CRYPTO_malloc(len, "../test/ectest.c", 1107))
        || !test_size_t_eq("../test/ectest.c", 1108, "len", "EC_POINT_point2oct(group, point, POINT_CONVERSION_HYBRID, buf, len, NULL)", len, EC_POINT_point2oct(group, point, POINT_CONVERSION_HYBRID, buf, len, 
# 1108 "../test/ectest.c" 3 4
           ((void *)0)
# 1108 "../test/ectest.c"
           ))
    ...
    if (!test_true("../test/ectest.c", 1119, "EC_POINT_oct2point(group, point, buf, len, NULL)", (EC_POINT_oct2point(group, point, buf, len, 
# 1119 "../test/ectest.c" 3 4
        ((void *)0)
# 1119 "../test/ectest.c"
        )) != 0))
        r = 0;
    ...
    buf[0] ^= 1;
    if (!test_false("../test/ectest.c", 1124, "EC_POINT_oct2point(group, point, buf, len, NULL)", (EC_POINT_oct2point(group, point, buf, len, 
# 1124 "../test/ectest.c" 3 4
        ((void *)0)
# 1124 "../test/ectest.c"
        )) != 0))
        r = 0;
...
err:
    ...
    EC_GROUP_free(group);
    EC_POINT_free(point);
    CRYPTO_free(buf, "../test/ectest.c", 1132);
    return r;
}
...
{
    EC_GROUP *group = 
# 1139 "../test/ectest.c" 3 4
                     ((void *)0)
# 1139 "../test/ectest.c"
                         ;
    int nid = curves[n].nid;

    if (!test_ptr("../test/ectest.c", 1142, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))) {
        test_info("../test/ectest.c", 1143, "EC_GROUP_new_curve_name() failed with curve %s\n", OBJ_nid2sn(nid))
                                  ;
        return 0;
    }
    if (!test_true("../test/ectest.c", 1147, "EC_GROUP_check(group, NULL)", (EC_GROUP_check(group, 
# 1147 "../test/ectest.c" 3 4
        ((void *)0)
# 1147 "../test/ectest.c"
        )) != 0)) {
        test_info("../test/ectest.c", 1148, "EC_GROUP_check() failed with curve %s\n", OBJ_nid2sn(nid));
        EC_GROUP_free(group);
        return 0;
    }
    EC_GROUP_free(group);
...
static int internal_curve_test_method(int n)
{
    ...
    if (!test_ptr("../test/ectest.c", 1161, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))) {
        test_info("../test/ectest.c", 1162, "Curve %s failed\n", OBJ_nid2sn(nid));
        return 0;
    }
...
{
    int r = 1;
    BIGNUM *secp521r1_field = 
# 1173 "../test/ectest.c" 3 4
                             ((void *)0)
# 1173 "../test/ectest.c"
                                 ;
    BIGNUM *sect163r2_field = 
# 1174 "../test/ectest.c" 3 4
                             ((void *)0)
# 1174 "../test/ectest.c"
                                 ;
    EC_GROUP *secp521r1_group = 
# 1175 "../test/ectest.c" 3 4
                               ((void *)0)
# 1175 "../test/ectest.c"
                                   ;
    EC_GROUP *sect163r2_group = 
# 1176 "../test/ectest.c" 3 4
                               ((void *)0)
# 1176 "../test/ectest.c"
                                   ;
    ...
    secp521r1_group = EC_GROUP_new_by_curve_name(716);
    if (BN_cmp(secp521r1_field, EC_GROUP_get0_field(secp521r1_group)))
      r = 0;


    sect163r2_group = EC_GROUP_new_by_curve_name(723);
...
static int nistp_single_test(int idx)
{
    ...
    BN_CTX *ctx = 
# 1315 "../test/ectest.c" 3 4
                 ((void *)0)
# 1315 "../test/ectest.c"
                     ;
    BIGNUM *p = 
# 1316 "../test/ectest.c" 3 4
               ((void *)0)
# 1316 "../test/ectest.c"
                   , *a = 
# 1316 "../test/ectest.c" 3 4
...
# 1317 "../test/ectest.c"
                                                               ;
    EC_GROUP *NISTP = 
# 1318 "../test/ectest.c" 3 4
                     ((void *)0)
# 1318 "../test/ectest.c"
                         ;
    EC_POINT *G = 
# 1319 "../test/ectest.c" 3 4
                 ((void *)0)
# 1319 "../test/ectest.c"
                     , *P = 
# 1319 "../test/ectest.c" 3 4
...
# 1319 "../test/ectest.c"
    ...
    test_note("NIST curve P-%d (optimised implementation):",
              test->degree);
    if (!test_ptr("../test/ectest.c", 1324, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 1325, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/ectest.c", 1326, "a = BN_new()", a = BN_new())
        || !test_ptr("../test/ectest.c", 1327, "b = BN_new()", b = BN_new())
        || !test_ptr("../test/ectest.c", 1328, "x = BN_new()", x = BN_new())
        || !test_ptr("../test/ectest.c", 1329, "y = BN_new()", y = BN_new())
        || !test_ptr("../test/ectest.c", 1330, "m = BN_new()", m = BN_new())
        || !test_ptr("../test/ectest.c", 1331, "n = BN_new()", n = BN_new())
        || !test_ptr("../test/ectest.c", 1332, "order = BN_new()", order = BN_new())
        || !test_ptr("../test/ectest.c", 1333, "yplusone = BN_new()", yplusone = BN_new())

        || !test_ptr("../test/ectest.c", 1335, "NISTP = EC_GROUP_new_by_curve_name(test->nid)", NISTP = EC_GROUP_new_by_curve_name(test->nid))
        || !test_true("../test/ectest.c", 1336, "BN_hex2bn(&p, test->p)", (BN_hex2bn(&p, test->p)) != 0)
        || !test_int_eq("../test/ectest.c", 1337, "1", "BN_check_prime(p, ctx, NULL)", 1, BN_check_prime(p, ctx, 
# 1337 "../test/ectest.c" 3 4
           ((void *)0)
# 1337 "../test/ectest.c"
           ))
        || !test_true("../test/ectest.c", 1338, "BN_hex2bn(&a, test->a)", (BN_hex2bn(&a, test->a)) != 0)
        || !test_true("../test/ectest.c", 1339, "BN_hex2bn(&b, test->b)", (BN_hex2bn(&b, test->b)) != 0)
        || !test_true("../test/ectest.c", 1340, "EC_GROUP_set_curve(NISTP, p, a, b, ctx)", (EC_GROUP_set_curve(NISTP, p, a, b, ctx)) != 0)
        || !test_ptr("../test/ectest.c", 1341, "G = EC_POINT_new(NISTP)", G = EC_POINT_new(NISTP))
        || !test_ptr("../test/ectest.c", 1342, "P = EC_POINT_new(NISTP)", P = EC_POINT_new(NISTP))
        || !test_ptr("../test/ectest.c", 1343, "Q = EC_POINT_new(NISTP)", Q = EC_POINT_new(NISTP))
        || !test_ptr("../test/ectest.c", 1344, "Q_CHECK = EC_POINT_new(NISTP)", Q_CHECK = EC_POINT_new(NISTP))
        || !test_true("../test/ectest.c", 1345, "BN_hex2bn(&x, test->Qx)", (BN_hex2bn(&x, test->Qx)) != 0)
        || !test_true("../test/ectest.c", 1346, "BN_hex2bn(&y, test->Qy)", (BN_hex2bn(&y, test->Qy)) != 0)
        || !test_true("../test/ectest.c", 1347, "BN_add(yplusone, y, BN_value_one())", (BN_add(yplusone, y, BN_value_one())) != 0)




        || !test_false("../test/ectest.c", 1352, "EC_POINT_set_affine_coordinates(NISTP, Q_CHECK, x, yplusone, ctx)", (EC_POINT_set_affine_coordinates(NISTP, Q_CHECK, x, yplusone, ctx)) != 0)

        || !test_true("../test/ectest.c", 1354, "EC_POINT_set_affine_coordinates(NISTP, Q_CHECK, x, y, ctx)", (EC_POINT_set_affine_coordinates(NISTP, Q_CHECK, x, y, ctx)) != 0)

        || !test_true("../test/ectest.c", 1356, "BN_hex2bn(&x, test->Gx)", (BN_hex2bn(&x, test->Gx)) != 0)
        || !test_true("../test/ectest.c", 1357, "BN_hex2bn(&y, test->Gy)", (BN_hex2bn(&y, test->Gy)) != 0)
        || !test_true("../test/ectest.c", 1358, "EC_POINT_set_affine_coordinates(NISTP, G, x, y, ctx)", (EC_POINT_set_affine_coordinates(NISTP, G, x, y, ctx)) != 0)
        || !test_true("../test/ectest.c", 1359, "BN_hex2bn(&order, test->order)", (BN_hex2bn(&order, test->order)) != 0)
        || !test_true("../test/ectest.c", 1360, "EC_GROUP_set_generator(NISTP, G, order, BN_value_one())", (EC_GROUP_set_generator(NISTP, G, order, BN_value_one())) != 0)
        || !test_int_eq("../test/ectest.c", 1361, "EC_GROUP_get_degree(NISTP)", "test->degree", EC_GROUP_get_degree(NISTP), test->degree))
        goto err;

    test_note("NIST test vectors ... ");
    if (!test_true("../test/ectest.c", 1365, "BN_hex2bn(&n, test->d)", (BN_hex2bn(&n, test->d)) != 0))
        goto err;

    EC_POINT_mul(NISTP, Q, n, 
# 1368 "../test/ectest.c" 3 4
                             ((void *)0)
# 1368 "../test/ectest.c"
                                 , 
# 1368 "../test/ectest.c" 3 4
...
# 1368 "../test/ectest.c"
                                       , ctx);
    if (!test_int_eq("../test/ectest.c", 1369, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)))
        goto err;

    EC_POINT_mul(NISTP, Q, 
# 1372 "../test/ectest.c" 3 4
                          ((void *)0)
# 1372 "../test/ectest.c"
                              , G, n, ctx);
    if (!test_int_eq("../test/ectest.c", 1373, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx))


        || !test_true("../test/ectest.c", 1376, "EC_POINT_dbl(NISTP, P, G, ctx)", (EC_POINT_dbl(NISTP, P, G, ctx)) != 0)
        || !test_true("../test/ectest.c", 1377, "EC_GROUP_set_generator(NISTP, P, order, BN_value_one())", (EC_GROUP_set_generator(NISTP, P, order, BN_value_one())) != 0)

        || !test_true("../test/ectest.c", 1379, "BN_rshift(m, n, 1)", (BN_rshift(m, n, 1)) != 0))
        goto err;



    EC_POINT_mul(NISTP, Q, m, 
# 1384 "../test/ectest.c" 3 4
                             ((void *)0)
# 1384 "../test/ectest.c"
                                 , 
# 1384 "../test/ectest.c" 3 4
...
# 1384 "../test/ectest.c"
                                       , ctx);
    if (!test_int_eq("../test/ectest.c", 1385, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)))
        goto err;

    EC_POINT_mul(NISTP, Q, 
# 1388 "../test/ectest.c" 3 4
                          ((void *)0)
# 1388 "../test/ectest.c"
                              , P, m, ctx);
    if (!test_int_eq("../test/ectest.c", 1389, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx))


        || !test_false("../test/ectest.c", 1392, "EC_GROUP_have_precompute_mult(NISTP)", (EC_GROUP_have_precompute_mult(NISTP)) != 0)

        || !test_true("../test/ectest.c", 1394, "EC_GROUP_precompute_mult(NISTP, ctx)", (EC_GROUP_precompute_mult(NISTP, ctx)) != 0)
...
# 1400 "../test/ectest.c"
                                       , ctx);
    if (!test_int_eq("../test/ectest.c", 1401, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)))
        goto err;

    EC_POINT_mul(NISTP, Q, 
# 1404 "../test/ectest.c" 3 4
                          ((void *)0)
# 1404 "../test/ectest.c"
                              , P, m, ctx);
    if (!test_int_eq("../test/ectest.c", 1405, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx))


        || !test_true("../test/ectest.c", 1408, "EC_GROUP_set_generator(NISTP, G, order, BN_value_one())", (EC_GROUP_set_generator(NISTP, G, order, BN_value_one())) != 0))
        goto err;

    EC_POINT_mul(NISTP, Q, n, 
# 1411 "../test/ectest.c" 3 4
                             ((void *)0)
# 1411 "../test/ectest.c"
                                 , 
# 1411 "../test/ectest.c" 3 4
...
# 1411 "../test/ectest.c"
                                       , ctx);
    if (!test_int_eq("../test/ectest.c", 1412, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)))
        goto err;

    EC_POINT_mul(NISTP, Q, 
# 1415 "../test/ectest.c" 3 4
                          ((void *)0)
# 1415 "../test/ectest.c"
                              , G, n, ctx);
    if (!test_int_eq("../test/ectest.c", 1416, "0", "EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)", 0, EC_POINT_cmp(NISTP, Q, Q_CHECK, ctx)))
        goto err;


    if (!test_true("../test/ectest.c", 1420, "BN_set_word(m, 32)", (BN_set_word(m, 32)) != 0)
        || !test_true("../test/ectest.c", 1421, "BN_set_word(n, 31)", (BN_set_word(n, 31)) != 0)
        || !test_true("../test/ectest.c", 1422, "EC_POINT_copy(P, G)", (EC_POINT_copy(P, G)) != 0)
        || !test_true("../test/ectest.c", 1423, "EC_POINT_invert(NISTP, P, ctx)", (EC_POINT_invert(NISTP, P, ctx)) != 0)
        || !test_true("../test/ectest.c", 1424, "EC_POINT_mul(NISTP, Q, m, P, n, ctx)", (EC_POINT_mul(NISTP, Q, m, P, n, ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 1425, "0", "EC_POINT_cmp(NISTP, Q, G, ctx)", 0, EC_POINT_cmp(NISTP, Q, G, ctx)))
      goto err;
...
# 1502 "../test/ectest.c" 3 4
                               ((void *)0)
# 1502 "../test/ectest.c"
                                   ;
    EC_POINT *other_gen = 
# 1503 "../test/ectest.c" 3 4
                         ((void *)0)
# 1503 "../test/ectest.c"
                             ;
    BIGNUM *group_p = 
# 1504 "../test/ectest.c" 3 4
                     ((void *)0)
# 1504 "../test/ectest.c"
                         , *group_a = 
# 1504 "../test/ectest.c" 3 4
...
# 1505 "../test/ectest.c"
                                                           ;
    BIGNUM *group_cofactor = 
# 1506 "../test/ectest.c" 3 4
                            ((void *)0)
# 1506 "../test/ectest.c"
                                , *other_cofactor = 
# 1506 "../test/ectest.c" 3 4
...
# 1506 "../test/ectest.c"
                                                        ;
    BIGNUM *other_order = 
# 1507 "../test/ectest.c" 3 4
                         ((void *)0)
# 1507 "../test/ectest.c"
                             ;
    const BIGNUM *group_order = 
# 1508 "../test/ectest.c" 3 4
                               ((void *)0)
# 1508 "../test/ectest.c"
                                   ;
    BN_CTX *bn_ctx = 
# 1509 "../test/ectest.c" 3 4
                    ((void *)0)
# 1509 "../test/ectest.c"
                        ;
    ...
    nid = curves[id].nid;
    if (!test_ptr("../test/ectest.c", 1515, "bn_ctx = BN_CTX_new()", bn_ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 1516, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))
        || !test_ptr("../test/ectest.c", 1517, "gtest = EC_GROUP_dup(group)", gtest = EC_GROUP_dup(group))
        || !test_ptr("../test/ectest.c", 1518, "group_p = BN_new()", group_p = BN_new())
        || !test_ptr("../test/ectest.c", 1519, "group_a = BN_new()", group_a = BN_new())
        || !test_ptr("../test/ectest.c", 1520, "group_b = BN_new()", group_b = BN_new())
        || !test_ptr("../test/ectest.c", 1521, "group_cofactor = BN_new()", group_cofactor = BN_new())
        || !test_ptr("../test/ectest.c", 1522, "group_gen = EC_GROUP_get0_generator(group)", group_gen = EC_GROUP_get0_generator(group))
        || !test_ptr("../test/ectest.c", 1523, "group_order = EC_GROUP_get0_order(group)", group_order = EC_GROUP_get0_order(group))
        || !test_true("../test/ectest.c", 1524, "EC_GROUP_get_cofactor(group, group_cofactor, NULL)", (EC_GROUP_get_cofactor(group, group_cofactor, 
# 1524 "../test/ectest.c" 3 4
           ((void *)0)
# 1524 "../test/ectest.c"
           )) != 0)
        || !test_true("../test/ectest.c", 1525, "EC_GROUP_get_curve(group, group_p, group_a, group_b, NULL)", (EC_GROUP_get_curve(group, group_p, group_a, group_b, 
# 1525 "../test/ectest.c" 3 4
           ((void *)0)
# 1525 "../test/ectest.c"
           )) != 0)
        || !test_ptr("../test/ectest.c", 1526, "other_gen = EC_POINT_dup(group_gen, group)", other_gen = EC_POINT_dup(group_gen, group))
        || !test_true("../test/ectest.c", 1527, "EC_POINT_add(group, other_gen, group_gen, group_gen, NULL)", (EC_POINT_add(group, other_gen, group_gen, group_gen, 
# 1527 "../test/ectest.c" 3 4
           ((void *)0)
# 1527 "../test/ectest.c"
           )) != 0)
        || !test_ptr("../test/ectest.c", 1528, "other_order = BN_dup(group_order)", other_order = BN_dup(group_order))
        || !test_true("../test/ectest.c", 1529, "BN_add_word(other_order, 1)", (BN_add_word(other_order, 1)) != 0)
        || !test_ptr("../test/ectest.c", 1530, "other_a = BN_dup(group_a)", other_a = BN_dup(group_a))
        || !test_true("../test/ectest.c", 1531, "BN_add_word(other_a, 1)", (BN_add_word(other_a, 1)) != 0)
        || !test_ptr("../test/ectest.c", 1532, "other_b = BN_dup(group_b)", other_b = BN_dup(group_b))
        || !test_true("../test/ectest.c", 1533, "BN_add_word(other_b, 1)", (BN_add_word(other_b, 1)) != 0)
        || !test_ptr("../test/ectest.c", 1534, "other_cofactor = BN_dup(group_cofactor)", other_cofactor = BN_dup(group_cofactor))
        || !test_true("../test/ectest.c", 1535, "BN_add_word(other_cofactor, 1)", (BN_add_word(other_cofactor, 1)) != 0))
        goto err;
    ...
    if (field_nid == 407) {
        if (!test_ptr("../test/ectest.c", 1542, "other_p = BN_dup(group_p)", other_p = BN_dup(group_p))
            || !test_true("../test/ectest.c", 1543, "BN_lshift1(other_p, other_p)", (BN_lshift1(other_p, other_p)) != 0))
            goto err;
    } else {
        if (!test_ptr("../test/ectest.c", 1546, "other_p = BN_dup(group_p)", other_p = BN_dup(group_p)))
            goto err;
        ...
        if (!test_ptr("../test/ectest.c", 1553, "BN_copy(other_p, BN_ucmp(BN_get0_nist_prime_192(), other_p) == 0 ? BN_get0_nist_prime_256() : BN_get0_nist_prime_192())", BN_copy(other_p, BN_ucmp(BN_get0_nist_prime_192(), other_p) == 0 ? BN_get0_nist_prime_256() : BN_get0_nist_prime_192()))
    ...
    if (!test_int_eq("../test/ectest.c", 1561, "EC_GROUP_check_named_curve(group, 0, NULL)", "nid", EC_GROUP_check_named_curve(group, 0, 
# 1561 "../test/ectest.c" 3 4
        ((void *)0)
# 1561 "../test/ectest.c"
        ), nid)

        || !test_int_eq("../test/ectest.c", 1563, "EC_GROUP_check_named_curve(group, 1, NULL)", "EC_curve_nid2nist(nid) != NULL ? nid : NID_undef", EC_GROUP_check_named_curve(group, 1, 
# 1563 "../test/ectest.c" 3 4
           ((void *)0)
# 1563 "../test/ectest.c"
...
# 1563 "../test/ectest.c"
    ...
    ERR_set_mark();
    if (!test_int_le("../test/ectest.c", 1570, "EC_GROUP_check_named_curve(group, 0, NULL)", "0", EC_GROUP_check_named_curve(group, 0, 
# 1570 "../test/ectest.c" 3 4
        ((void *)0)
# 1570 "../test/ectest.c"
        ), 0))
        goto err;
    ...
    if (!test_int_eq("../test/ectest.c", 1576, "EC_GROUP_check_named_curve(group, 0, NULL)", "nid", EC_GROUP_check_named_curve(group, 0, 
# 1576 "../test/ectest.c" 3 4
        ((void *)0)
# 1576 "../test/ectest.c"
        ), nid))
        goto err;

    if (!test_int_eq("../test/ectest.c", 1579, "EC_GROUP_set_seed(group, invalid_seed, invalid_seed_len)", "invalid_seed_len", EC_GROUP_set_seed(group, invalid_seed, invalid_seed_len), invalid_seed_len)
                                      )
        goto err;
    ...
    if (has_seed) {
        ...
        if (!test_int_eq("../test/ectest.c", 1588, "EC_GROUP_check_named_curve(group, 0, NULL)", "0", EC_GROUP_check_named_curve(group, 0, 
# 1588 "../test/ectest.c" 3 4
            ((void *)0)
# 1588 "../test/ectest.c"
            ), 0))
            goto err;
        ...
        if (!test_int_eq("../test/ectest.c", 1595, "EC_GROUP_check_named_curve(group, 0, NULL)", "nid", EC_GROUP_check_named_curve(group, 0, 
# 1595 "../test/ectest.c" 3 4
            ((void *)0)
# 1595 "../test/ectest.c"
            ), nid))
            goto err;
    ...
    if (!test_int_eq("../test/ectest.c", 1599, "EC_GROUP_set_seed(group, NULL, 0)", "1", EC_GROUP_set_seed(group, 
# 1599 "../test/ectest.c" 3 4
        ((void *)0)
# 1599 "../test/ectest.c"
        , 0), 1)
        || !test_int_eq("../test/ectest.c", 1600, "EC_GROUP_check_named_curve(group, 0, NULL)", "nid", EC_GROUP_check_named_curve(group, 0, 
# 1600 "../test/ectest.c" 3 4
           ((void *)0)
# 1600 "../test/ectest.c"
           ), nid))
        goto err;
    ...
    if (!test_int_eq("../test/ectest.c", 1604, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "nid", EC_GROUP_check_named_curve(gtest, 0, 
# 1604 "../test/ectest.c" 3 4
        ((void *)0)
# 1604 "../test/ectest.c"
        ), nid))
        goto err;
    ...
    if (!test_true("../test/ectest.c", 1608, "EC_GROUP_set_generator(gtest, other_gen, group_order, group_cofactor)", (EC_GROUP_set_generator(gtest, other_gen, group_order, group_cofactor)) != 0)

        || !test_int_eq("../test/ectest.c", 1610, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1610 "../test/ectest.c" 3 4
           ((void *)0)
# 1610 "../test/ectest.c"
           ), 0)
        || !test_true("../test/ectest.c", 1611, "EC_GROUP_set_generator(gtest, group_gen, other_order, group_cofactor)", (EC_GROUP_set_generator(gtest, group_gen, other_order, group_cofactor)) != 0)

        || !test_int_eq("../test/ectest.c", 1613, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1613 "../test/ectest.c" 3 4
           ((void *)0)
# 1613 "../test/ectest.c"
           ), 0)

        || !test_false("../test/ectest.c", 1615, "EC_GROUP_set_generator(gtest, group_gen, NULL, group_cofactor)", (EC_GROUP_set_generator(gtest, group_gen, 
# 1615 "../test/ectest.c" 3 4
           ((void *)0)
# 1615 "../test/ectest.c"
           , group_cofactor)) != 0)

        || !test_true("../test/ectest.c", 1617, "EC_GROUP_set_generator(gtest, group_gen, group_order, other_cofactor)", (EC_GROUP_set_generator(gtest, group_gen, group_order, other_cofactor)) != 0)

        || !test_int_eq("../test/ectest.c", 1619, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1619 "../test/ectest.c" 3 4
           ((void *)0)
# 1619 "../test/ectest.c"
           ), 0)

        || !test_true("../test/ectest.c", 1621, "EC_GROUP_set_generator(gtest, group_gen, group_order, NULL)", (EC_GROUP_set_generator(gtest, group_gen, group_order, 
# 1621 "../test/ectest.c" 3 4
           ((void *)0)
# 1621 "../test/ectest.c"
           )) != 0)

        || !test_int_eq("../test/ectest.c", 1623, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "nid", EC_GROUP_check_named_curve(gtest, 0, 
# 1623 "../test/ectest.c" 3 4
           ((void *)0)
# 1623 "../test/ectest.c"
           ), nid)

        || !test_true("../test/ectest.c", 1625, "EC_GROUP_set_generator(gtest, group_gen, group_order, group_cofactor)", (EC_GROUP_set_generator(gtest, group_gen, group_order, group_cofactor)) != 0)

        || !test_int_eq("../test/ectest.c", 1627, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "nid", EC_GROUP_check_named_curve(gtest, 0, 
# 1627 "../test/ectest.c" 3 4
           ((void *)0)
# 1627 "../test/ectest.c"
           ), nid))
        goto err;
# 1637 "../test/ectest.c"
    ERR_set_mark();
    if (EC_GROUP_set_curve(gtest, other_p, group_a, group_b, 
# 1638 "../test/ectest.c" 3 4
                                                            ((void *)0)
# 1638 "../test/ectest.c"
                                                                )) {
        if (!test_int_le("../test/ectest.c", 1639, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1639 "../test/ectest.c" 3 4
            ((void *)0)
# 1639 "../test/ectest.c"
            ), 0))
            goto err;
    ...
    if (EC_GROUP_set_curve(gtest, group_p, other_a, group_b, 
# 1646 "../test/ectest.c" 3 4
                                                            ((void *)0)
# 1646 "../test/ectest.c"
                                                                )) {
        if (!test_int_le("../test/ectest.c", 1647, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1647 "../test/ectest.c" 3 4
            ((void *)0)
# 1647 "../test/ectest.c"
            ), 0))
            goto err;
    ...
    if (EC_GROUP_set_curve(gtest, group_p, group_a, other_b, 
# 1654 "../test/ectest.c" 3 4
                                                            ((void *)0)
# 1654 "../test/ectest.c"
                                                                )) {
        if (!test_int_le("../test/ectest.c", 1655, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "0", EC_GROUP_check_named_curve(gtest, 0, 
# 1655 "../test/ectest.c" 3 4
            ((void *)0)
# 1655 "../test/ectest.c"
            ), 0))
            goto err;
    ...
    if (!test_true("../test/ectest.c", 1665, "EC_GROUP_set_curve(gtest, group_p, group_a, group_b, NULL)", (EC_GROUP_set_curve(gtest, group_p, group_a, group_b, 
# 1665 "../test/ectest.c" 3 4
        ((void *)0)
# 1665 "../test/ectest.c"
        )) != 0)
        || !test_int_eq("../test/ectest.c", 1666, "EC_GROUP_check_named_curve(gtest, 0, NULL)", "nid", EC_GROUP_check_named_curve(gtest, 0, 
# 1666 "../test/ectest.c" 3 4
           ((void *)0)
# 1666 "../test/ectest.c"
           ), nid))
        goto err;
...
# 1699 "../test/ectest.c"
    ...
    nid = curves[id].nid;
    if (!test_ptr("../test/ectest.c", 1703, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 1704, "g = EC_GROUP_new_by_curve_name(nid)", g = EC_GROUP_new_by_curve_name(nid))
        || !test_ptr("../test/ectest.c", 1705, "p = EC_GROUP_get_ecparameters(g, NULL)", p = EC_GROUP_get_ecparameters(g, 
# 1705 "../test/ectest.c" 3 4
           ((void *)0)
# 1705 "../test/ectest.c"
           )))
        goto err;
    ...
    EC_GROUP_free(g);
    if (!test_ptr("../test/ectest.c", 1710, "g = EC_GROUP_new_from_ecparameters(p)", g = EC_GROUP_new_from_ecparameters(p)))
        goto err;

    if (!test_int_gt("../test/ectest.c", 1713, "rv = EC_GROUP_check_named_curve(g, 0, NULL)", "0", rv = EC_GROUP_check_named_curve(g, 0, 
# 1713 "../test/ectest.c" 3 4
        ((void *)0)
# 1713 "../test/ectest.c"
        ), 0))
        goto err;
    if (rv != nid) {
# 1725 "../test/ectest.c"
        if (!test_ptr("../test/ectest.c", 1725, "ga = EC_GROUP_new_by_curve_name(rv)", ga = EC_GROUP_new_by_curve_name(rv))
                || !test_ptr("../test/ectest.c", 1726, "pa = EC_GROUP_get_ecparameters(ga, NULL)", pa = EC_GROUP_get_ecparameters(ga, 
# 1726 "../test/ectest.c" 3 4
                   ((void *)0)
# 1726 "../test/ectest.c"
                   )))
            goto err;
        ...
        EC_GROUP_free(ga);
        if (!test_ptr("../test/ectest.c", 1731, "ga = EC_GROUP_new_from_ecparameters(pa)", ga = EC_GROUP_new_from_ecparameters(pa))
                || !test_int_eq("../test/ectest.c", 1732, "EC_GROUP_cmp(g, ga, ctx)", "0", EC_GROUP_cmp(g, ga, ctx), 0))
            goto err;
    }
...
# 1824 "../test/ectest.c"
                                                       ;
    const EC_POINT *group_gen = 
# 1825 "../test/ectest.c" 3 4
                               ((void *)0)
# 1825 "../test/ectest.c"
                                   ;
    EC_POINT *other_gen = 
# 1826 "../test/ectest.c" 3 4
                         ((void *)0)
# 1826 "../test/ectest.c"
                             ;
    BIGNUM *group_cofactor = 
# 1827 "../test/ectest.c" 3 4
                            ((void *)0)
# 1827 "../test/ectest.c"
                                , *other_cofactor = 
# 1827 "../test/ectest.c" 3 4
...
# 1828 "../test/ectest.c"
                                                  ;
    const BIGNUM *group_order = 
# 1829 "../test/ectest.c" 3 4
                               ((void *)0)
# 1829 "../test/ectest.c"
                                   ;
    BIGNUM *other_order = 
# 1830 "../test/ectest.c" 3 4
                         ((void *)0)
# 1830 "../test/ectest.c"
                             ;
    BN_CTX *bn_ctx = 
# 1831 "../test/ectest.c" 3 4
                    ((void *)0)
# 1831 "../test/ectest.c"
                        ;
    static const unsigned char invalid_seed[] = "THIS IS NOT A VALID SEED";
...
# 1834 "../test/ectest.c"
                                                    ;
    EC_GROUP *g_ary[8] = {
# 1835 "../test/ectest.c" 3 4
                         ((void *)0)
# 1835 "../test/ectest.c"
                             };
    EC_GROUP **g_next = &g_ary[0];
    ECPARAMETERS *p_ary[8] = {
# 1837 "../test/ectest.c" 3 4
                             ((void *)0)
# 1837 "../test/ectest.c"
                                 };
    ...
    if (!test_ptr("../test/ectest.c", 1843, "bn_ctx = BN_CTX_new()", bn_ctx = BN_CTX_new()))
        return ret;
    BN_CTX_start(bn_ctx);

    if (
        !test_ptr("../test/ectest.c", 1848, "group_cofactor = BN_CTX_get(bn_ctx)", group_cofactor = BN_CTX_get(bn_ctx))
        || !test_ptr("../test/ectest.c", 1849, "other_gen_x = BN_CTX_get(bn_ctx)", other_gen_x = BN_CTX_get(bn_ctx))
        || !test_ptr("../test/ectest.c", 1850, "other_gen_y = BN_CTX_get(bn_ctx)", other_gen_y = BN_CTX_get(bn_ctx))
        || !test_ptr("../test/ectest.c", 1851, "other_order = BN_CTX_get(bn_ctx)", other_order = BN_CTX_get(bn_ctx))
        || !test_ptr("../test/ectest.c", 1852, "other_cofactor = BN_CTX_get(bn_ctx)", other_cofactor = BN_CTX_get(bn_ctx))

        || !test_ptr("../test/ectest.c", 1854, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))
        || !test_ptr("../test/ectest.c", 1855, "params = EC_GROUP_get_ecparameters(group, NULL)", params = EC_GROUP_get_ecparameters(group, 
# 1855 "../test/ectest.c" 3 4
           ((void *)0)
# 1855 "../test/ectest.c"
           ))
        || !test_ptr("../test/ectest.c", 1856, "group_gen = EC_GROUP_get0_generator(group)", group_gen = EC_GROUP_get0_generator(group))
        || !test_ptr("../test/ectest.c", 1857, "group_order = EC_GROUP_get0_order(group)", group_order = EC_GROUP_get0_order(group))
        || !test_true("../test/ectest.c", 1858, "EC_GROUP_get_cofactor(group, group_cofactor, NULL)", (EC_GROUP_get_cofactor(group, group_cofactor, 
# 1858 "../test/ectest.c" 3 4
           ((void *)0)
# 1858 "../test/ectest.c"
           )) != 0)

        || !test_ptr("../test/ectest.c", 1860, "tmpg = EC_GROUP_dup(group)", tmpg = EC_GROUP_dup(group))
        || !test_ptr("../test/ectest.c", 1861, "other_gen = EC_POINT_dup(group_gen, group)", other_gen = EC_POINT_dup(group_gen, group))
        || !test_true("../test/ectest.c", 1862, "EC_POINT_add(group, other_gen, group_gen, group_gen, NULL)", (EC_POINT_add(group, other_gen, group_gen, group_gen, 
# 1862 "../test/ectest.c" 3 4
           ((void *)0)
# 1862 "../test/ectest.c"
           )) != 0)
        || !test_true("../test/ectest.c", 1863, "EC_POINT_get_affine_coordinates(group, other_gen, other_gen_x, other_gen_y, bn_ctx)", (EC_POINT_get_affine_coordinates(group, other_gen, other_gen_x, other_gen_y, bn_ctx)) != 0)

        || !test_true("../test/ectest.c", 1865, "BN_copy(other_order, group_order)", (BN_copy(other_order, group_order)) != 0)
        || !test_true("../test/ectest.c", 1866, "BN_add_word(other_order, 1)", (BN_add_word(other_order, 1)) != 0)
        || !test_true("../test/ectest.c", 1867, "BN_copy(other_cofactor, group_cofactor)", (BN_copy(other_cofactor, group_cofactor)) != 0)
        || !test_true("../test/ectest.c", 1868, "BN_add_word(other_cofactor, 1)", (BN_add_word(other_cofactor, 1)) != 0))
        goto err;

    EC_POINT_free(other_gen);
    other_gen = 
# 1872 "../test/ectest.c" 3 4
               ((void *)0)
# 1872 "../test/ectest.c"
                   ;

    if (!test_ptr("../test/ectest.c", 1874, "other_gen = EC_POINT_new(tmpg)", other_gen = EC_POINT_new(tmpg))
        || !test_true("../test/ectest.c", 1875, "EC_POINT_set_affine_coordinates(tmpg, other_gen, other_gen_x, other_gen_y, bn_ctx)", (EC_POINT_set_affine_coordinates(tmpg, other_gen, other_gen_x, other_gen_y, bn_ctx)) != 0)

                                                              )
        goto err;
# 1890 "../test/ectest.c"
    if (!test_ptr("../test/ectest.c", 1890, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(params))
        || !test_int_ne("../test/ectest.c", 1891, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0))
        goto err;




    if (!test_true("../test/ectest.c", 1897, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)) {
        test_info("../test/ectest.c", 1898, "nid = %s, tnid = %s", OBJ_nid2sn(nid), OBJ_nid2sn(tnid));
        goto err;
    }

    if (!test_int_eq("../test/ectest.c", 1902, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000))
        goto err;
    ...
    if (!test_int_eq("../test/ectest.c", 1909, "EC_GROUP_set_seed(tmpg, invalid_seed, invalid_seed_len)", "invalid_seed_len", EC_GROUP_set_seed(tmpg, invalid_seed, invalid_seed_len), invalid_seed_len)

            || !test_ptr("../test/ectest.c", 1911, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1911 "../test/ectest.c" 3 4
               ((void *)0)
# 1911 "../test/ectest.c"
               ))

            || !test_ptr("../test/ectest.c", 1913, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

            || !test_int_ne("../test/ectest.c", 1915, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)
            || !test_true("../test/ectest.c", 1916, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)
            || !test_int_eq("../test/ectest.c", 1917, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000)
                                                      ) {
        test_info("../test/ectest.c", 1919, "nid = %s, tnid = %s", OBJ_nid2sn(nid), OBJ_nid2sn(tnid));
        goto err;
    }
    ...
    if (!test_int_eq("../test/ectest.c", 1927, "EC_GROUP_set_seed(tmpg, NULL, 0)", "1", EC_GROUP_set_seed(tmpg, 
# 1927 "../test/ectest.c" 3 4
        ((void *)0)
# 1927 "../test/ectest.c"
        , 0), 1)
            || !test_ptr("../test/ectest.c", 1928, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1928 "../test/ectest.c" 3 4
               ((void *)0)
# 1928 "../test/ectest.c"
               ))

            || !test_ptr("../test/ectest.c", 1930, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

            || !test_int_ne("../test/ectest.c", 1932, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)
            || !test_true("../test/ectest.c", 1933, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)
            || !test_int_eq("../test/ectest.c", 1934, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000)
                                                      ) {
        test_info("../test/ectest.c", 1936, "nid = %s, tnid = %s", OBJ_nid2sn(nid), OBJ_nid2sn(tnid));
        goto err;
    }
    ...
    if (
        !test_true("../test/ectest.c", 1945, "EC_GROUP_set_generator(tmpg, other_gen, group_order, group_cofactor)", (EC_GROUP_set_generator(tmpg, other_gen, group_order, group_cofactor)) != 0)

        || !test_ptr("../test/ectest.c", 1947, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1947 "../test/ectest.c" 3 4
           ((void *)0)
# 1947 "../test/ectest.c"
           ))

        || !test_ptr("../test/ectest.c", 1949, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

        || !test_int_eq("../test/ectest.c", 1951, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)

        || !test_true("../test/ectest.c", 1953, "EC_GROUP_set_generator(tmpg, group_gen, other_order, group_cofactor)", (EC_GROUP_set_generator(tmpg, group_gen, other_order, group_cofactor)) != 0)

        || !test_ptr("../test/ectest.c", 1955, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1955 "../test/ectest.c" 3 4
           ((void *)0)
# 1955 "../test/ectest.c"
           ))

        || !test_ptr("../test/ectest.c", 1957, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

        || !test_int_eq("../test/ectest.c", 1959, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)

        || !test_false("../test/ectest.c", 1961, "EC_GROUP_set_generator(tmpg, group_gen, NULL, group_cofactor)", (EC_GROUP_set_generator(tmpg, group_gen, 
# 1961 "../test/ectest.c" 3 4
           ((void *)0)
# 1961 "../test/ectest.c"
           , group_cofactor)) != 0)


        || !test_true("../test/ectest.c", 1964, "EC_GROUP_set_generator(tmpg, group_gen, group_order, other_cofactor)", (EC_GROUP_set_generator(tmpg, group_gen, group_order, other_cofactor)) != 0)

        || !test_ptr("../test/ectest.c", 1966, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1966 "../test/ectest.c" 3 4
           ((void *)0)
# 1966 "../test/ectest.c"
           ))

        || !test_ptr("../test/ectest.c", 1968, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

        || !test_int_ne("../test/ectest.c", 1970, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)
        || !test_true("../test/ectest.c", 1971, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)
        || !test_int_eq("../test/ectest.c", 1972, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000)


        || !test_true("../test/ectest.c", 1975, "EC_GROUP_set_generator(tmpg, group_gen, group_order, NULL)", (EC_GROUP_set_generator(tmpg, group_gen, group_order, 
# 1975 "../test/ectest.c" 3 4
           ((void *)0)
# 1975 "../test/ectest.c"
           )) != 0)

        || !test_ptr("../test/ectest.c", 1977, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1977 "../test/ectest.c" 3 4
           ((void *)0)
# 1977 "../test/ectest.c"
           ))

        || !test_ptr("../test/ectest.c", 1979, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

        || !test_int_ne("../test/ectest.c", 1981, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)
        || !test_true("../test/ectest.c", 1982, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)
        || !test_int_eq("../test/ectest.c", 1983, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000)


        || !test_true("../test/ectest.c", 1986, "EC_GROUP_set_generator(tmpg, group_gen, group_order, group_cofactor)", (EC_GROUP_set_generator(tmpg, group_gen, group_order, group_cofactor)) != 0)

        || !test_ptr("../test/ectest.c", 1988, "other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, NULL)", other_params = *p_next++ = EC_GROUP_get_ecparameters(tmpg, 
# 1988 "../test/ectest.c" 3 4
           ((void *)0)
# 1988 "../test/ectest.c"
           ))

        || !test_ptr("../test/ectest.c", 1990, "tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params)", tgroup = *g_next++ = EC_GROUP_new_from_ecparameters(other_params))

        || !test_int_ne("../test/ectest.c", 1992, "(tnid = EC_GROUP_get_curve_name(tgroup))", "NID_undef", (tnid = EC_GROUP_get_curve_name(tgroup)), 0)
        || !test_true("../test/ectest.c", 1993, "are_ec_nids_compatible(nid, tnid)", (are_ec_nids_compatible(nid, tnid)) != 0)
        || !test_int_eq("../test/ectest.c", 1994, "EC_GROUP_get_asn1_flag(tgroup)", "OPENSSL_EC_EXPLICIT_CURVE", EC_GROUP_get_asn1_flag(tgroup), 0x000)
                                                  )
        goto err;

    ret = 1;
err:
    for (g_next = &g_ary[0]; g_next < g_ary + (sizeof(g_ary)/sizeof((g_ary)[0])); g_next++)
        EC_GROUP_free(*g_next);
    for (p_next = &p_ary[0]; p_next < p_ary + (sizeof(g_ary)/sizeof((g_ary)[0])); p_next++)
...
# 2017 "../test/ectest.c" 3 4
                                ((void *)0)
# 2017 "../test/ectest.c"
                                    ;
    unsigned char *buf = 
# 2018 "../test/ectest.c" 3 4
                        ((void *)0)
# 2018 "../test/ectest.c"
                            ;
    int r = 0, len;

    if (!test_ptr("../test/ectest.c", 2021, "group = EC_GROUP_new_by_curve_name(NID_secp384r1)", group = EC_GROUP_new_by_curve_name(715))
        || !test_ptr("../test/ectest.c", 2022, "ecparameters = EC_GROUP_get_ecparameters(group, NULL)", ecparameters = EC_GROUP_get_ecparameters(group, 
# 2022 "../test/ectest.c" 3 4
           ((void *)0)
# 2022 "../test/ectest.c"
           ))
        || !test_ptr("../test/ectest.c", 2023, "group2 = EC_GROUP_new_from_ecparameters(ecparameters)", group2 = EC_GROUP_new_from_ecparameters(ecparameters))
        || !test_int_eq("../test/ectest.c", 2024, "EC_GROUP_cmp(group, group2, NULL)", "0", EC_GROUP_cmp(group, group2, 
# 2024 "../test/ectest.c" 3 4
           ((void *)0)
# 2024 "../test/ectest.c"
           ), 0))
        goto err;
    ...
    EC_GROUP_free(group);
    group = 
# 2028 "../test/ectest.c" 3 4
           ((void *)0)
# 2028 "../test/ectest.c"
               ;


    if (!test_ptr("../test/ectest.c", 2031, "group = EC_GROUP_new_by_curve_name(NID_secp521r1)", group = EC_GROUP_new_by_curve_name(716))
        || !test_true("../test/ectest.c", 2032, "(len = i2d_ECPKParameters(group, &buf)) >= 0", ((len = i2d_ECPKParameters(group, &buf)) >= 0) != 0)
        || !test_mem_eq("../test/ectest.c", 2033, "buf", "p521_named", buf, len, p521_named, sizeof(p521_named)))
        goto err;

    CRYPTO_free(buf, "../test/ectest.c", 2036);
    buf = 
# 2037 "../test/ectest.c" 3 4
         ((void *)0)
# 2037 "../test/ectest.c"
             ;
    ...
    EC_GROUP_set_asn1_flag(group, 0x000);
    if (!test_true("../test/ectest.c", 2044, "(len = i2d_ECPKParameters(group, &buf)) >= 0", ((len = i2d_ECPKParameters(group, &buf)) >= 0) != 0)
        || !test_mem_eq("../test/ectest.c", 2045, "buf", "p521_explicit", buf, len, p521_explicit, sizeof(p521_explicit)))
        goto err;
...
err:
    ...
    CRYPTO_free(buf, "../test/ectest.c", 2053);
    return r;
}
...
# 2065 "../test/ectest.c"
                                                     ;
    OSSL_PARAM *params_exp = 
# 2066 "../test/ectest.c" 3 4
                            ((void *)0)
# 2066 "../test/ectest.c"
                                , *params_exp2 = 
# 2066 "../test/ectest.c" 3 4
...
# 2067 "../test/ectest.c"
                                          ;
    BN_CTX *bn_ctx = 
# 2068 "../test/ectest.c" 3 4
                    ((void *)0)
# 2068 "../test/ectest.c"
                        ;
    OSSL_PARAM_BLD *bld = 
# 2069 "../test/ectest.c" 3 4
                         ((void *)0)
# 2069 "../test/ectest.c"
                             ;
    BIGNUM *p, *a, *b;
    const EC_POINT *group_gen = 
# 2071 "../test/ectest.c" 3 4
                               ((void *)0)
# 2071 "../test/ectest.c"
                                   ;
    size_t bsize;
    ...
    if (!test_ptr("../test/ectest.c", 2075, "bn_ctx = BN_CTX_new()", bn_ctx = BN_CTX_new()))
        goto err;


    if (!test_ptr("../test/ectest.c", 2079, "group_nmd = EC_GROUP_new_by_curve_name(NID_secp384r1)", group_nmd = EC_GROUP_new_by_curve_name(715))

        || !test_ptr("../test/ectest.c", 2081, "params_nmd = EC_GROUP_to_params( group_nmd, NULL, NULL, NULL)", params_nmd = EC_GROUP_to_params( group_nmd, 
# 2081 "../test/ectest.c" 3 4
           ((void *)0)
# 2081 "../test/ectest.c"
           , 
# 2081 "../test/ectest.c" 3 4
...
# 2081 "../test/ectest.c"
        ...
        || !test_ptr("../test/ectest.c", 2083, "group_nmd2 = EC_GROUP_new_from_params( params_nmd, NULL, NULL)", group_nmd2 = EC_GROUP_new_from_params( params_nmd, 
# 2083 "../test/ectest.c" 3 4
           ((void *)0)
# 2083 "../test/ectest.c"
           , 
# 2083 "../test/ectest.c" 3 4
...
# 2083 "../test/ectest.c"
        ...
        || !test_int_eq("../test/ectest.c", 2085, "EC_GROUP_cmp(group_nmd, group_nmd2, NULL)", "0", EC_GROUP_cmp(group_nmd, group_nmd2, 
# 2085 "../test/ectest.c" 3 4
           ((void *)0)
# 2085 "../test/ectest.c"
           ), 0)

        || !test_ptr("../test/ectest.c", 2087, "params_nmd2 = EC_GROUP_to_params( group_nmd, NULL, NULL, bn_ctx)", params_nmd2 = EC_GROUP_to_params( group_nmd, 
# 2087 "../test/ectest.c" 3 4
           ((void *)0)
# 2087 "../test/ectest.c"
           , 
# 2087 "../test/ectest.c" 3 4
...
# 2087 "../test/ectest.c"
        ...
        || !test_ptr("../test/ectest.c", 2089, "group_nmd3 = EC_GROUP_new_from_params( params_nmd2, NULL, NULL)", group_nmd3 = EC_GROUP_new_from_params( params_nmd2, 
# 2089 "../test/ectest.c" 3 4
           ((void *)0)
# 2089 "../test/ectest.c"
           , 
# 2089 "../test/ectest.c" 3 4
...
# 2089 "../test/ectest.c"
        ...
        || !test_int_eq("../test/ectest.c", 2091, "EC_GROUP_cmp(group_nmd, group_nmd3, NULL)", "0", EC_GROUP_cmp(group_nmd, group_nmd3, 
# 2091 "../test/ectest.c" 3 4
           ((void *)0)
# 2091 "../test/ectest.c"
           ), 0))
        goto err;
    ...
    if (!test_ptr("../test/ectest.c", 2095, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new()))
        goto err;
    ...
    if (!test_true("../test/ectest.c", 2103, "EC_GROUP_get_curve(group_nmd, p, a, b, bn_ctx)", (EC_GROUP_get_curve(group_nmd, p, a, b, bn_ctx)) != 0)
        || !test_true("../test/ectest.c", 2104, "OSSL_PARAM_BLD_push_utf8_string( bld, OSSL_PKEY_PARAM_EC_FIELD_TYPE, SN_X9_62_prime_field, 0)", (OSSL_PARAM_BLD_push_utf8_string( bld, "field-type", "prime-field", 0)) != 0)

        || !test_true("../test/ectest.c", 2106, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/ectest.c", 2107, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_A, a)", (OSSL_PARAM_BLD_push_BN(bld, "a", a)) != 0)
        || !test_true("../test/ectest.c", 2108, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_B, b)", (OSSL_PARAM_BLD_push_BN(bld, "b", b)) != 0))
        goto err;

    if (EC_GROUP_get0_seed(group_nmd) != 
# 2111 "../test/ectest.c" 3 4
                                        ((void *)0)
# 2111 "../test/ectest.c"
                                            ) {
        if (!test_true("../test/ectest.c", 2112, "OSSL_PARAM_BLD_push_octet_string( bld, OSSL_PKEY_PARAM_EC_SEED, EC_GROUP_get0_seed(group_nmd), EC_GROUP_get_seed_len(group_nmd))", (OSSL_PARAM_BLD_push_octet_string( bld, "seed", EC_GROUP_get0_seed(group_nmd), EC_GROUP_get_seed_len(group_nmd))) != 0)

                                                  )
            goto err;
    }
    if (EC_GROUP_get0_cofactor(group_nmd) != 
# 2117 "../test/ectest.c" 3 4
                                            ((void *)0)
# 2117 "../test/ectest.c"
                                                ) {
        if (!test_true("../test/ectest.c", 2118, "OSSL_PARAM_BLD_push_BN( bld, OSSL_PKEY_PARAM_EC_COFACTOR, EC_GROUP_get0_cofactor(group_nmd))", (OSSL_PARAM_BLD_push_BN( bld, "cofactor", EC_GROUP_get0_cofactor(group_nmd))) != 0)

                                                   )
            goto err;
    }

    if (!test_ptr("../test/ectest.c", 2124, "group_gen = EC_GROUP_get0_generator(group_nmd)", group_gen = EC_GROUP_get0_generator(group_nmd))
        || !test_size_t_gt("../test/ectest.c", 2125, "bsize = EC_POINT_point2oct( group_nmd, EC_GROUP_get0_generator(group_nmd), POINT_CONVERSION_UNCOMPRESSED, NULL, 0, bn_ctx)", "0", bsize = EC_POINT_point2oct( group_nmd, EC_GROUP_get0_generator(group_nmd), POINT_CONVERSION_UNCOMPRESSED, 
# 2125 "../test/ectest.c" 3 4
           ((void *)0)
# 2125 "../test/ectest.c"
           , 0, bn_ctx), 0)


        || !test_ptr("../test/ectest.c", 2128, "buf2 = OPENSSL_malloc(bsize)", buf2 = CRYPTO_malloc(bsize, "../test/ectest.c", 2128))
        || !test_size_t_eq("../test/ectest.c", 2129, "EC_POINT_point2oct( group_nmd, EC_GROUP_get0_generator(group_nmd), POINT_CONVERSION_UNCOMPRESSED, buf2, bsize, bn_ctx)", "bsize", EC_POINT_point2oct( group_nmd, EC_GROUP_get0_generator(group_nmd), POINT_CONVERSION_UNCOMPRESSED, buf2, bsize, bn_ctx), bsize)


        || !test_true("../test/ectest.c", 2132, "OSSL_PARAM_BLD_push_octet_string( bld, OSSL_PKEY_PARAM_EC_GENERATOR, buf2, bsize)", (OSSL_PARAM_BLD_push_octet_string( bld, "generator", buf2, bsize)) != 0)

        || !test_true("../test/ectest.c", 2134, "OSSL_PARAM_BLD_push_BN( bld, OSSL_PKEY_PARAM_EC_ORDER, EC_GROUP_get0_order(group_nmd))", (OSSL_PARAM_BLD_push_BN( bld, "order", EC_GROUP_get0_order(group_nmd))) != 0)
                                                                               )
        goto err;

    if (!test_ptr("../test/ectest.c", 2138, "params_exp = OSSL_PARAM_BLD_to_param(bld)", params_exp = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/ectest.c", 2139, "group_exp = EC_GROUP_new_from_params(params_exp, NULL, NULL)", group_exp = EC_GROUP_new_from_params(params_exp, 
# 2139 "../test/ectest.c" 3 4
           ((void *)0)
# 2139 "../test/ectest.c"
           , 
# 2139 "../test/ectest.c" 3 4
...
# 2139 "../test/ectest.c"
        ...
        || !test_ptr("../test/ectest.c", 2141, "params_exp2 = EC_GROUP_to_params(group_exp, NULL, NULL, NULL)", params_exp2 = EC_GROUP_to_params(group_exp, 
# 2141 "../test/ectest.c" 3 4
           ((void *)0)
# 2141 "../test/ectest.c"
           , 
# 2141 "../test/ectest.c" 3 4
...
# 2141 "../test/ectest.c"
        ...
        || !test_ptr("../test/ectest.c", 2143, "group_exp2 = EC_GROUP_new_from_params(params_exp2, NULL, NULL)", group_exp2 = EC_GROUP_new_from_params(params_exp2, 
# 2143 "../test/ectest.c" 3 4
           ((void *)0)
# 2143 "../test/ectest.c"
           , 
# 2143 "../test/ectest.c" 3 4
...
# 2143 "../test/ectest.c"
        ...
        || !test_int_eq("../test/ectest.c", 2145, "EC_GROUP_cmp(group_exp, group_exp2, NULL)", "0", EC_GROUP_cmp(group_exp, group_exp2, 
# 2145 "../test/ectest.c" 3 4
           ((void *)0)
# 2145 "../test/ectest.c"
           ), 0))
        goto err;
...
err:
    ...
    CRYPTO_free(buf, "../test/ectest.c", 2156);

    EC_GROUP_free(group_exp);
    EC_GROUP_free(group_exp2);
    BN_CTX_end(bn_ctx);
    BN_CTX_free(bn_ctx);
    CRYPTO_free(buf2, "../test/ectest.c", 2162);
...
{
    EC_GROUP *group = 
# 2239 "../test/ectest.c" 3 4
                     ((void *)0)
# 2239 "../test/ectest.c"
                         ;
    BIGNUM *cf = 
# 2240 "../test/ectest.c" 3 4
                ((void *)0)
# 2240 "../test/ectest.c"
                    ;
    int ret = 0;
    ...
    if (!test_ptr("../test/ectest.c", 2245, "group = d2i_ECPKParameters(NULL, &b1, sizeof(params_cf_fail))", group = d2i_ECPKParameters(
# 2245 "../test/ectest.c" 3 4
        ((void *)0)
# 2245 "../test/ectest.c"
        , &b1, sizeof(params_cf_fail)))
        || !test_BN_eq_zero("../test/ectest.c", 2246, "EC_GROUP_get0_cofactor(group)", EC_GROUP_get0_cofactor(group))
        || !test_ptr("../test/ectest.c", 2247, "group = d2i_ECPKParameters(&group, &b2, sizeof(params_cf_pass))", group = d2i_ECPKParameters(&group, &b2, sizeof(params_cf_pass)))

        || !test_int_gt("../test/ectest.c", 2249, "BN_hex2bn(&cf, \"12bc94785251297abfafddf1565100da\")", "0", BN_hex2bn(&cf, "12bc94785251297abfafddf1565100da"), 0)
        || !test_BN_eq("../test/ectest.c", 2250, "cf", "EC_GROUP_get0_cofactor(group)", cf, EC_GROUP_get0_cofactor(group)))
        goto err;
    ret = 1;
 err:
    BN_free(cf);
...
static int cardinality_test(int n)
{
    ...
    int nid = curves[n].nid;
    BN_CTX *ctx = 
# 2269 "../test/ectest.c" 3 4
                 ((void *)0)
# 2269 "../test/ectest.c"
                     ;
    EC_GROUP *g1 = 
# 2270 "../test/ectest.c" 3 4
                  ((void *)0)
# 2270 "../test/ectest.c"
                      , *g2 = 
# 2270 "../test/ectest.c" 3 4
...
# 2270 "../test/ectest.c"
                                  ;
    EC_POINT *g2_gen = 
# 2271 "../test/ectest.c" 3 4
                      ((void *)0)
# 2271 "../test/ectest.c"
                          ;
    BIGNUM *g1_p = 
# 2272 "../test/ectest.c" 3 4
                  ((void *)0)
# 2272 "../test/ectest.c"
                      , *g1_a = 
# 2272 "../test/ectest.c" 3 4
...
# 2273 "../test/ectest.c"
    ...
    test_info("../test/ectest.c", 2275, "Curve %s cardinality test", OBJ_nid2sn(nid));

    if (!test_ptr("../test/ectest.c", 2277, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
        || !test_ptr("../test/ectest.c", 2278, "g1 = EC_GROUP_new_by_curve_name(nid)", g1 = EC_GROUP_new_by_curve_name(nid))) {
        BN_CTX_free(ctx);
        return 0;
    }

    is_binary = (EC_GROUP_get_field_type(g1) == 407);
    ...
    if (!test_ptr("../test/ectest.c", 2294, "g2_cf = BN_CTX_get(ctx)", g2_cf = BN_CTX_get(ctx))

        || !test_true("../test/ectest.c", 2296, "EC_GROUP_get_curve(g1, g1_p, g1_a, g1_b, ctx)", (EC_GROUP_get_curve(g1, g1_p, g1_a, g1_b, ctx)) != 0)
        || !test_true("../test/ectest.c", 2297, "EC_POINT_get_affine_coordinates(g1, EC_GROUP_get0_generator(g1), g1_x, g1_y, ctx)", (EC_POINT_get_affine_coordinates(g1, EC_GROUP_get0_generator(g1), g1_x, g1_y, ctx)) != 0)

        || !test_true("../test/ectest.c", 2299, "BN_copy(g1_order, EC_GROUP_get0_order(g1))", (BN_copy(g1_order, EC_GROUP_get0_order(g1))) != 0)
        || !test_true("../test/ectest.c", 2300, "EC_GROUP_get_cofactor(g1, g1_cf, ctx)", (EC_GROUP_get_cofactor(g1, g1_cf, ctx)) != 0)


        || !test_ptr("../test/ectest.c", 2303, "g2 = (is_binary) ? EC_GROUP_new_curve_GF2m(g1_p, g1_a, g1_b, ctx) : EC_GROUP_new_curve_GFp(g1_p, g1_a, g1_b, ctx)", g2 = (is_binary) ? EC_GROUP_new_curve_GF2m(g1_p, g1_a, g1_b, ctx) : EC_GROUP_new_curve_GFp(g1_p, g1_a, g1_b, ctx))
        ...
        || !test_ptr("../test/ectest.c", 2310, "g2_gen = EC_POINT_new(g2)", g2_gen = EC_POINT_new(g2))
        || !test_true("../test/ectest.c", 2311, "EC_POINT_set_affine_coordinates(g2, g2_gen, g1_x, g1_y, ctx)", (EC_POINT_set_affine_coordinates(g2, g2_gen, g1_x, g1_y, ctx)) != 0)

        || !test_true("../test/ectest.c", 2313, "EC_GROUP_set_generator(g2, g2_gen, g1_order, NULL)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, 
# 2313 "../test/ectest.c" 3 4
           ((void *)0)
# 2313 "../test/ectest.c"
           )) != 0)
        || !test_true("../test/ectest.c", 2314, "EC_GROUP_get_cofactor(g2, g2_cf, ctx)", (EC_GROUP_get_cofactor(g2, g2_cf, ctx)) != 0)
        || !test_BN_eq("../test/ectest.c", 2315, "g1_cf", "g2_cf", g1_cf, g2_cf)

        || !test_true("../test/ectest.c", 2317, "BN_set_word(g2_cf, 0)", (BN_set_word(g2_cf, 0)) != 0)
        || !test_true("../test/ectest.c", 2318, "EC_GROUP_set_generator(g2, g2_gen, g1_order, g2_cf)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, g2_cf)) != 0)
        || !test_true("../test/ectest.c", 2319, "EC_GROUP_get_cofactor(g2, g2_cf, ctx)", (EC_GROUP_get_cofactor(g2, g2_cf, ctx)) != 0)
        || !test_BN_eq("../test/ectest.c", 2320, "g1_cf", "g2_cf", g1_cf, g2_cf)

        || !test_true("../test/ectest.c", 2322, "BN_set_word(g2_cf, 0)", (BN_set_word(g2_cf, 0)) != 0)
        || !test_true("../test/ectest.c", 2323, "BN_sub(g2_cf, g2_cf, BN_value_one())", (BN_sub(g2_cf, g2_cf, BN_value_one())) != 0)
        || !test_false("../test/ectest.c", 2324, "EC_GROUP_set_generator(g2, g2_gen, g1_order, g2_cf)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, g2_cf)) != 0)

        || !test_false("../test/ectest.c", 2326, "EC_GROUP_set_generator(g2, g2_gen, NULL, NULL)", (EC_GROUP_set_generator(g2, g2_gen, 
# 2326 "../test/ectest.c" 3 4
           ((void *)0)
# 2326 "../test/ectest.c"
           , 
# 2326 "../test/ectest.c" 3 4
...
# 2326 "../test/ectest.c"
        ...
        || !test_true("../test/ectest.c", 2328, "BN_set_word(g1_order, 0)", (BN_set_word(g1_order, 0)) != 0)
        || !test_false("../test/ectest.c", 2329, "EC_GROUP_set_generator(g2, g2_gen, g1_order, NULL)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, 
# 2329 "../test/ectest.c" 3 4
           ((void *)0)
# 2329 "../test/ectest.c"
           )) != 0)

        || !test_true("../test/ectest.c", 2331, "BN_set_word(g2_cf, 0)", (BN_set_word(g2_cf, 0)) != 0)
        || !test_true("../test/ectest.c", 2332, "BN_sub(g2_cf, g2_cf, BN_value_one())", (BN_sub(g2_cf, g2_cf, BN_value_one())) != 0)
        || !test_false("../test/ectest.c", 2333, "EC_GROUP_set_generator(g2, g2_gen, g1_order, NULL)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, 
# 2333 "../test/ectest.c" 3 4
           ((void *)0)
# 2333 "../test/ectest.c"
           )) != 0)

        || !test_true("../test/ectest.c", 2335, "BN_lshift(g1_order, g1_p, 2)", (BN_lshift(g1_order, g1_p, 2)) != 0)
        || !test_false("../test/ectest.c", 2336, "EC_GROUP_set_generator(g2, g2_gen, g1_order, NULL)", (EC_GROUP_set_generator(g2, g2_gen, g1_order, 
# 2336 "../test/ectest.c" 3 4
           ((void *)0)
# 2336 "../test/ectest.c"
           )) != 0))
        goto err;
...
static int check_ec_key_field_public_range_test(int id)
{
    int ret = 0, type = 0;
    const EC_POINT *pub = 
# 2351 "../test/ectest.c" 3 4
                         ((void *)0)
# 2351 "../test/ectest.c"
                             ;
    const EC_GROUP *group = 
# 2352 "../test/ectest.c" 3 4
                           ((void *)0)
# 2352 "../test/ectest.c"
                               ;
    const BIGNUM *field = 
# 2353 "../test/ectest.c" 3 4
                         ((void *)0)
# 2353 "../test/ectest.c"
                             ;
    BIGNUM *x = 
# 2354 "../test/ectest.c" 3 4
               ((void *)0)
# 2354 "../test/ectest.c"
                   , *y = 
# 2354 "../test/ectest.c" 3 4
...
# 2354 "../test/ectest.c"
                              ;
    EC_KEY *key = 
# 2355 "../test/ectest.c" 3 4
                 ((void *)0)
# 2355 "../test/ectest.c"
                     ;

    if (!test_ptr("../test/ectest.c", 2357, "x = BN_new()", x = BN_new())
            || !test_ptr("../test/ectest.c", 2358, "y = BN_new()", y = BN_new())
            || !test_ptr("../test/ectest.c", 2359, "key = EC_KEY_new_by_curve_name(curves[id].nid)", key = EC_KEY_new_by_curve_name(curves[id].nid))
            || !test_ptr("../test/ectest.c", 2360, "group = EC_KEY_get0_group(key)", group = EC_KEY_get0_group(key))
            || !test_ptr("../test/ectest.c", 2361, "field = EC_GROUP_get0_field(group)", field = EC_GROUP_get0_field(group))
            || !test_int_gt("../test/ectest.c", 2362, "EC_KEY_generate_key(key)", "0", EC_KEY_generate_key(key), 0)
            || !test_int_gt("../test/ectest.c", 2363, "EC_KEY_check_key(key)", "0", EC_KEY_check_key(key), 0)
            || !test_ptr("../test/ectest.c", 2364, "pub = EC_KEY_get0_public_key(key)", pub = EC_KEY_get0_public_key(key))
            || !test_int_gt("../test/ectest.c", 2365, "EC_POINT_get_affine_coordinates(group, pub, x, y, NULL)", "0", EC_POINT_get_affine_coordinates(group, pub, x, y, 
# 2365 "../test/ectest.c" 3 4
               ((void *)0)
# 2365 "../test/ectest.c"
               ), 0)
                                                                     )
    ...
    if (type == 407) {
        ...
        if (!test_true("../test/ectest.c", 2377, "BN_GF2m_add(x, x, field)", (BN_GF2m_add(x, x, field)) != 0))
            goto err;
    } else

    if (type == 406) {

        if (!test_true("../test/ectest.c", 2383, "BN_add(x, x, field)", (BN_add(x, x, field)) != 0))
            goto err;
    } else {

        test_error("../test/ectest.c", 2387, "Unsupported EC_METHOD field_type");
        goto err;
    }
    if (!test_int_le("../test/ectest.c", 2390, "EC_KEY_set_public_key_affine_coordinates(key, x, y)", "0", EC_KEY_set_public_key_affine_coordinates(key, x, y), 0))
        goto err;
...
# 2415 "../test/ectest.c"
                                   ;
    char *hex = 
# 2416 "../test/ectest.c" 3 4
               ((void *)0)
# 2416 "../test/ectest.c"
                   ;

    if (P == 
# 2418 "../test/ectest.c" 3 4
            ((void *)0)
# 2418 "../test/ectest.c"
                ) {

        if (!test_ptr("../test/ectest.c", 2420, "Pinf = EC_POINT_new(group)", Pinf = EC_POINT_new(group))
                || !test_true("../test/ectest.c", 2421, "EC_POINT_set_to_infinity(group, Pinf)", (EC_POINT_set_to_infinity(group, Pinf)) != 0))
            goto err;
        P = Pinf;
    }

    if (!test_ptr("../test/ectest.c", 2426, "hex = EC_POINT_point2hex(group, P, form, bnctx)", hex = EC_POINT_point2hex(group, P, form, bnctx))
            || !test_ptr("../test/ectest.c", 2427, "Q = EC_POINT_hex2point(group, hex, NULL, bnctx)", Q = EC_POINT_hex2point(group, hex, 
# 2427 "../test/ectest.c" 3 4
               ((void *)0)
# 2427 "../test/ectest.c"
               , bnctx))
            || !test_int_eq("../test/ectest.c", 2428, "0", "EC_POINT_cmp(group, Q, P, bnctx)", 0, EC_POINT_cmp(group, Q, P, bnctx)))
        goto err;
    ...
    if (Pinf != 
# 2437 "../test/ectest.c" 3 4
               ((void *)0)
            
# 2438 "../test/ectest.c"
           && !test_true("../test/ectest.c", 2438, "EC_POINT_is_at_infinity(group, Q)", (EC_POINT_is_at_infinity(group, Q)) != 0))
        goto err;
 ...
 err:
    EC_POINT_free(Pinf);
    CRYPTO_free(hex, "../test/ectest.c", 2445);
    EC_POINT_free(Q);
...
static int ec_point_hex2point_test(int id)
{
    int ret = 0, nid;
    EC_GROUP *group = 
# 2457 "../test/ectest.c" 3 4
                     ((void *)0)
# 2457 "../test/ectest.c"
                         ;
    const EC_POINT *G = 
# 2458 "../test/ectest.c" 3 4
                       ((void *)0)
# 2458 "../test/ectest.c"
                           ;
    EC_POINT *P = 
# 2459 "../test/ectest.c" 3 4
                 ((void *)0)
# 2459 "../test/ectest.c"
                     ;
    BN_CTX *bnctx = 
# 2460 "../test/ectest.c" 3 4
                   ((void *)0)
# 2460 "../test/ectest.c"
                       ;
    ...
    nid = curves[id].nid;
    if (!test_ptr("../test/ectest.c", 2464, "bnctx = BN_CTX_new()", bnctx = BN_CTX_new())
            || !test_ptr("../test/ectest.c", 2465, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid))
            || !test_ptr("../test/ectest.c", 2466, "G = EC_GROUP_get0_generator(group)", G = EC_GROUP_get0_generator(group))
            || !test_ptr("../test/ectest.c", 2467, "P = EC_POINT_dup(G, group)", P = EC_POINT_dup(G, group)))
        goto err;

    if (!test_true("../test/ectest.c", 2470, "ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_COMPRESSED, bnctx)", (ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_COMPRESSED, bnctx)) != 0)


            || !test_true("../test/ectest.c", 2473, "ec_point_hex2point_test_helper(group, NULL, POINT_CONVERSION_COMPRESSED, bnctx)", (ec_point_hex2point_test_helper(group, 
# 2473 "../test/ectest.c" 3 4
               ((void *)0)
# 2473 "../test/ectest.c"
               , POINT_CONVERSION_COMPRESSED, bnctx)) != 0)


            || !test_true("../test/ectest.c", 2476, "ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_UNCOMPRESSED, bnctx)", (ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_UNCOMPRESSED, bnctx)) != 0)


            || !test_true("../test/ectest.c", 2479, "ec_point_hex2point_test_helper(group, NULL, POINT_CONVERSION_UNCOMPRESSED, bnctx)", (ec_point_hex2point_test_helper(group, 
# 2479 "../test/ectest.c" 3 4
               ((void *)0)
# 2479 "../test/ectest.c"
               , POINT_CONVERSION_UNCOMPRESSED, bnctx)) != 0)


            || !test_true("../test/ectest.c", 2482, "ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_HYBRID, bnctx)", (ec_point_hex2point_test_helper(group, P, POINT_CONVERSION_HYBRID, bnctx)) != 0)


            || !test_true("../test/ectest.c", 2485, "ec_point_hex2point_test_helper(group, NULL, POINT_CONVERSION_HYBRID, bnctx)", (ec_point_hex2point_test_helper(group, 
# 2485 "../test/ectest.c" 3 4
               ((void *)0)
# 2485 "../test/ectest.c"
               , POINT_CONVERSION_HYBRID, bnctx)) != 0)
                                            ...
                                            unsigned char *gen, int gen_size)
{
    int ret = 0, i_out;
    EVP_PKEY_CTX *pctx = 
# 2504 "../test/ectest.c" 3 4
                        ((void *)0)
# 2504 "../test/ectest.c"
                            ;
    EVP_PKEY *pkeyparam = 
# 2505 "../test/ectest.c" 3 4
                         ((void *)0)
# 2505 "../test/ectest.c"
                             ;
    OSSL_PARAM_BLD *bld = 
# 2506 "../test/ectest.c" 3 4
                         ((void *)0)
# 2506 "../test/ectest.c"
                             ;
    const char *field_name;
    OSSL_PARAM *params = 
# 2508 "../test/ectest.c" 3 4
                        ((void *)0)
# 2508 "../test/ectest.c"
                            ;
...
# 2518 "../test/ectest.c"
    ...
    if (!test_ptr("../test/ectest.c", 2525, "b", b)
        || !test_ptr("../test/ectest.c", 2526, "bld = OSSL_PARAM_BLD_new()", bld = OSSL_PARAM_BLD_new()))
        goto err;

    if (EC_GROUP_get_field_type(group) == 406) {
        field_name = "prime-field";
    } else {
        field_name = "characteristic-two-field";

        if (EC_GROUP_get_basis_type(group) == 682) {
            basis_name = "tpBasis";
            if (!test_true("../test/ectest.c", 2536, "EC_GROUP_get_trinomial_basis(group, &k1)", (EC_GROUP_get_trinomial_basis(group, &k1)) != 0))
                goto err;
        } else {
            basis_name = "ppBasis";
            if (!test_true("../test/ectest.c", 2540, "EC_GROUP_get_pentanomial_basis(group, &k1, &k2, &k3)", (EC_GROUP_get_pentanomial_basis(group, &k1, &k2, &k3)) != 0))
                goto err;
        }

    }
    if (!test_true("../test/ectest.c", 2545, "EC_GROUP_get_curve(group, p, a, b, ctx)", (EC_GROUP_get_curve(group, p, a, b, ctx)) != 0)
        || !test_true("../test/ectest.c", 2546, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_EC_FIELD_TYPE, field_name, 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "field-type", field_name, 0)) != 0)

        || !test_true("../test/ectest.c", 2548, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_P, p)", (OSSL_PARAM_BLD_push_BN(bld, "p", p)) != 0)
        || !test_true("../test/ectest.c", 2549, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_A, a)", (OSSL_PARAM_BLD_push_BN(bld, "a", a)) != 0)
        || !test_true("../test/ectest.c", 2550, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_B, b)", (OSSL_PARAM_BLD_push_BN(bld, "b", b)) != 0))
        goto err;

    if (EC_GROUP_get0_seed(group) != 
# 2553 "../test/ectest.c" 3 4
                                    ((void *)0)
# 2553 "../test/ectest.c"
                                        ) {
        if (!test_true("../test/ectest.c", 2554, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_EC_SEED, EC_GROUP_get0_seed(group), EC_GROUP_get_seed_len(group))", (OSSL_PARAM_BLD_push_octet_string(bld, "seed", EC_GROUP_get0_seed(group), EC_GROUP_get_seed_len(group))) != 0)

                                                         )
            goto err;
    }
    if (EC_GROUP_get0_cofactor(group) != 
# 2559 "../test/ectest.c" 3 4
                                        ((void *)0)
# 2559 "../test/ectest.c"
                                            ) {
        if (!test_true("../test/ectest.c", 2560, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_COFACTOR, EC_GROUP_get0_cofactor(group))", (OSSL_PARAM_BLD_push_BN(bld, "cofactor", EC_GROUP_get0_cofactor(group))) != 0)
                                                                             )
            goto err;
    }

    if (!test_true("../test/ectest.c", 2565, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_EC_GENERATOR, gen, gen_size)", (OSSL_PARAM_BLD_push_octet_string(bld, "generator", gen, gen_size)) != 0)

        || !test_true("../test/ectest.c", 2567, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_ORDER, EC_GROUP_get0_order(group))", (OSSL_PARAM_BLD_push_BN(bld, "order", EC_GROUP_get0_order(group))) != 0)
                                                                         )
        goto err;

    if (!test_ptr("../test/ectest.c", 2571, "params = OSSL_PARAM_BLD_to_param(bld)", params = OSSL_PARAM_BLD_to_param(bld))
        || !test_ptr("../test/ectest.c", 2572, "pctx = EVP_PKEY_CTX_new_from_name(NULL, \"EC\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(
# 2572 "../test/ectest.c" 3 4
           ((void *)0)
# 2572 "../test/ectest.c"
           , "EC", 
# 2572 "../test/ectest.c" 3 4
...
# 2572 "../test/ectest.c"
        ...
        || !test_int_gt("../test/ectest.c", 2573, "EVP_PKEY_fromdata_init(pctx)", "0", EVP_PKEY_fromdata_init(pctx), 0)
        || !test_int_gt("../test/ectest.c", 2574, "EVP_PKEY_fromdata(pctx, &pkeyparam, EVP_PKEY_KEY_PARAMETERS, params)", "0", EVP_PKEY_fromdata(pctx, &pkeyparam, ( ( 0x04 | 0x80) ), params), 0)
                                                                              )
        goto err;
    ...
    if (!test_false("../test/ectest.c", 2581, "EVP_PKEY_get_utf8_string_param(pkeyparam, OSSL_PKEY_PARAM_GROUP_NAME, name, sizeof(name), &name_len)", (EVP_PKEY_get_utf8_string_param(pkeyparam, "group", name, sizeof(name), &name_len)) != 0)

                                   )
        goto err;


    if (!test_true("../test/ectest.c", 2587, "EVP_PKEY_get_utf8_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_ENCODING, name, sizeof(name), &name_len)", (EVP_PKEY_get_utf8_string_param(pkeyparam, "encoding", name, sizeof(name), &name_len)) != 0)


        || !test_str_eq("../test/ectest.c", 2590, "name", "OSSL_PKEY_EC_ENCODING_EXPLICIT", name, "explicit"))
        goto err;

    if (!test_true("../test/ectest.c", 2593, "EVP_PKEY_get_utf8_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_FIELD_TYPE, name, sizeof(name), &name_len)", (EVP_PKEY_get_utf8_string_param(pkeyparam, "field-type", name, sizeof(name), &name_len)) != 0)


        || !test_str_eq("../test/ectest.c", 2596, "name", "field_name", name, field_name))
        goto err;

    if (!test_true("../test/ectest.c", 2599, "EVP_PKEY_get_octet_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_GENERATOR, buf, sizeof(buf), &buf_len)", (EVP_PKEY_get_octet_string_param(pkeyparam, "generator", buf, sizeof(buf), &buf_len)) != 0)

        || !test_mem_eq("../test/ectest.c", 2601, "buf", "gen", buf, (int)buf_len, gen, gen_size))
        goto err;

    if (!test_true("../test/ectest.c", 2604, "EVP_PKEY_get_bn_param(pkeyparam, OSSL_PKEY_PARAM_EC_P, &p_out)", (EVP_PKEY_get_bn_param(pkeyparam, "p", &p_out)) != 0)
        || !test_BN_eq("../test/ectest.c", 2605, "p_out", "p", p_out, p)
        || !test_true("../test/ectest.c", 2606, "EVP_PKEY_get_bn_param(pkeyparam, OSSL_PKEY_PARAM_EC_A, &a_out)", (EVP_PKEY_get_bn_param(pkeyparam, "a", &a_out)) != 0)

        || !test_BN_eq("../test/ectest.c", 2608, "a_out", "a", a_out, a)
        || !test_true("../test/ectest.c", 2609, "EVP_PKEY_get_bn_param(pkeyparam, OSSL_PKEY_PARAM_EC_B, &b_out)", (EVP_PKEY_get_bn_param(pkeyparam, "b", &b_out)) != 0)

        || !test_BN_eq("../test/ectest.c", 2611, "b_out", "b", b_out, b)
        || !test_true("../test/ectest.c", 2612, "EVP_PKEY_get_bn_param(pkeyparam, OSSL_PKEY_PARAM_EC_ORDER, &order_out)", (EVP_PKEY_get_bn_param(pkeyparam, "order", &order_out)) != 0)

        || !test_BN_eq("../test/ectest.c", 2614, "order_out", "EC_GROUP_get0_order(group)", order_out, EC_GROUP_get0_order(group)))
        goto err;

    if (EC_GROUP_get0_cofactor(group) != 
# 2617 "../test/ectest.c" 3 4
                                        ((void *)0)
# 2617 "../test/ectest.c"
                                            ) {
        if (!test_true("../test/ectest.c", 2618, "EVP_PKEY_get_bn_param(pkeyparam, OSSL_PKEY_PARAM_EC_COFACTOR, &cofactor_out)", (EVP_PKEY_get_bn_param(pkeyparam, "cofactor", &cofactor_out)) != 0)

            || !test_BN_eq("../test/ectest.c", 2620, "cofactor_out", "EC_GROUP_get0_cofactor(group)", cofactor_out, EC_GROUP_get0_cofactor(group)))
            goto err;
    }
    if (EC_GROUP_get0_seed(group) != 
# 2623 "../test/ectest.c" 3 4
                                    ((void *)0)
# 2623 "../test/ectest.c"
                                        ) {
        if (!test_true("../test/ectest.c", 2624, "EVP_PKEY_get_octet_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_SEED, buf, sizeof(buf), &buf_len)", (EVP_PKEY_get_octet_string_param(pkeyparam, "seed", buf, sizeof(buf), &buf_len)) != 0)

            || !test_mem_eq("../test/ectest.c", 2626, "buf", "EC_GROUP_get0_seed(group)", buf, buf_len, EC_GROUP_get0_seed(group), EC_GROUP_get_seed_len(group))
                                                         )
            goto err;
    }
    ...
    if (EC_GROUP_get_field_type(group) == 406) {
        ...
        if (!test_false("../test/ectest.c", 2633, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_M, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "m", &i_out)) != 0)

            || !test_false("../test/ectest.c", 2635, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_TP_BASIS, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "tp", &i_out)) != 0)

            || !test_false("../test/ectest.c", 2637, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K1, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k1", &i_out)) != 0)

            || !test_false("../test/ectest.c", 2639, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K2, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k2", &i_out)) != 0)

            || !test_false("../test/ectest.c", 2641, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K3, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k3", &i_out)) != 0)

            || !test_false("../test/ectest.c", 2643, "EVP_PKEY_get_utf8_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_TYPE, name, sizeof(name), &name_len)", (EVP_PKEY_get_utf8_string_param(pkeyparam, "basis-type", name, sizeof(name), &name_len)) != 0)

                                          )
            goto err;
    } else {

        if (!test_true("../test/ectest.c", 2649, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_M, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "m", &i_out)) != 0)

            || !test_int_eq("../test/ectest.c", 2651, "EC_GROUP_get_degree(group)", "i_out", EC_GROUP_get_degree(group), i_out)
            || !test_true("../test/ectest.c", 2652, "EVP_PKEY_get_utf8_string_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_TYPE, name, sizeof(name), &name_len)", (EVP_PKEY_get_utf8_string_param(pkeyparam, "basis-type", name, sizeof(name), &name_len)) != 0)


            || !test_str_eq("../test/ectest.c", 2655, "name", "basis_name", name, basis_name))
            goto err;

        if (EC_GROUP_get_basis_type(group) == 682) {
            if (!test_true("../test/ectest.c", 2659, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_TP_BASIS, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "tp", &i_out)) != 0)

                || !test_int_eq("../test/ectest.c", 2661, "k1", "i_out", k1, i_out)
                || !test_false("../test/ectest.c", 2662, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K1, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k1", &i_out)) != 0)

                || !test_false("../test/ectest.c", 2664, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K2, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k2", &i_out)) != 0)

                || !test_false("../test/ectest.c", 2666, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K3, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k3", &i_out)) != 0)
                                                                           )
                goto err;
        } else {
            if (!test_false("../test/ectest.c", 2670, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_TP_BASIS, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "tp", &i_out)) != 0)

                || !test_true("../test/ectest.c", 2672, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K1, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k1", &i_out)) != 0)

                || !test_int_eq("../test/ectest.c", 2674, "k1", "i_out", k1, i_out)
                || !test_true("../test/ectest.c", 2675, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K2, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k2", &i_out)) != 0)

                || !test_int_eq("../test/ectest.c", 2677, "k2", "i_out", k2, i_out)
                || !test_true("../test/ectest.c", 2678, "EVP_PKEY_get_int_param(pkeyparam, OSSL_PKEY_PARAM_EC_CHAR2_PP_K3, &i_out)", (EVP_PKEY_get_int_param(pkeyparam, "k3", &i_out)) != 0)

                || !test_int_eq("../test/ectest.c", 2680, "k3", "i_out", k3, i_out))
                goto err;
        }

    }
    if (!test_ptr("../test/ectest.c", 2685, "gettable = EVP_PKEY_gettable_params(pkeyparam)", gettable = EVP_PKEY_gettable_params(pkeyparam))
        || !test_ptr("../test/ectest.c", 2686, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_GROUP_NAME)", OSSL_PARAM_locate_const(gettable, "group"))
        || !test_ptr("../test/ectest.c", 2687, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_ENCODING)", OSSL_PARAM_locate_const(gettable, "encoding"))
        || !test_ptr("../test/ectest.c", 2688, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_FIELD_TYPE)", OSSL_PARAM_locate_const(gettable, "field-type"))
        || !test_ptr("../test/ectest.c", 2689, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_P)", OSSL_PARAM_locate_const(gettable, "p"))
        || !test_ptr("../test/ectest.c", 2690, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_A)", OSSL_PARAM_locate_const(gettable, "a"))
        || !test_ptr("../test/ectest.c", 2691, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_B)", OSSL_PARAM_locate_const(gettable, "b"))
        || !test_ptr("../test/ectest.c", 2692, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_GENERATOR)", OSSL_PARAM_locate_const(gettable, "generator"))
        || !test_ptr("../test/ectest.c", 2693, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_ORDER)", OSSL_PARAM_locate_const(gettable, "order"))
        || !test_ptr("../test/ectest.c", 2694, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_COFACTOR)", OSSL_PARAM_locate_const(gettable, "cofactor"))
        || !test_ptr("../test/ectest.c", 2695, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_SEED)", OSSL_PARAM_locate_const(gettable, "seed"))

        || !test_ptr("../test/ectest.c", 2697, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_M)", OSSL_PARAM_locate_const(gettable, "m"))
        || !test_ptr("../test/ectest.c", 2698, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_TYPE)", OSSL_PARAM_locate_const(gettable, "basis-type"))
        || !test_ptr("../test/ectest.c", 2699, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_TP_BASIS)", OSSL_PARAM_locate_const(gettable, "tp"))
        || !test_ptr("../test/ectest.c", 2700, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_PP_K1)", OSSL_PARAM_locate_const(gettable, "k1"))
        || !test_ptr("../test/ectest.c", 2701, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_PP_K2)", OSSL_PARAM_locate_const(gettable, "k2"))
        || !test_ptr("../test/ectest.c", 2702, "OSSL_PARAM_locate_const(gettable, OSSL_PKEY_PARAM_EC_CHAR2_PP_K3)", OSSL_PARAM_locate_const(gettable, "k3"))
...
static int custom_generator_test(int id)
{
    int ret = 0, nid, bsize;
    EC_GROUP *group = 
# 2726 "../test/ectest.c" 3 4
                     ((void *)0)
# 2726 "../test/ectest.c"
                         ;
    EC_POINT *G2 = 
# 2727 "../test/ectest.c" 3 4
                  ((void *)0)
# 2727 "../test/ectest.c"
                      , *Q1 = 
# 2727 "../test/ectest.c" 3 4
...
# 2727 "../test/ectest.c"
                                              ;
    BN_CTX *ctx = 
# 2728 "../test/ectest.c" 3 4
                 ((void *)0)
# 2728 "../test/ectest.c"
                     ;
    BIGNUM *k = 
# 2729 "../test/ectest.c" 3 4
               ((void *)0)
# 2729 "../test/ectest.c"
                   ;
    unsigned char *b1 = 
# 2730 "../test/ectest.c" 3 4
                       ((void *)0)
# 2730 "../test/ectest.c"
                           , *b2 = 
# 2730 "../test/ectest.c" 3 4
...
# 2730 "../test/ectest.c"
    ...
    nid = curves[id].nid;
    test_note("Curve %s", OBJ_nid2sn(nid));
    if (!test_ptr("../test/ectest.c", 2735, "ctx = BN_CTX_new()", ctx = BN_CTX_new()))
        return 0;

    BN_CTX_start(ctx);

    if (!test_ptr("../test/ectest.c", 2740, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid)))
        goto err;
    ...
    if (!test_ptr("../test/ectest.c", 2747, "k = BN_CTX_get(ctx)", k = BN_CTX_get(ctx))

        || !test_true("../test/ectest.c", 2749, "BN_rand(k, EC_GROUP_order_bits(group) - 1, BN_RAND_TOP_ONE, BN_RAND_BOTTOM_ANY)", (BN_rand(k, EC_GROUP_order_bits(group) - 1, 0, 0)) != 0)


        || !test_true("../test/ectest.c", 2752, "BN_clear_bit(k, 0)", (BN_clear_bit(k, 0)) != 0)
        || !test_ptr("../test/ectest.c", 2753, "G2 = EC_POINT_new(group)", G2 = EC_POINT_new(group))
        || !test_ptr("../test/ectest.c", 2754, "Q1 = EC_POINT_new(group)", Q1 = EC_POINT_new(group))

        || !test_true("../test/ectest.c", 2756, "EC_POINT_mul(group, Q1, k, NULL, NULL, ctx)", (EC_POINT_mul(group, Q1, k, 
# 2756 "../test/ectest.c" 3 4
           ((void *)0)
# 2756 "../test/ectest.c"
           , 
# 2756 "../test/ectest.c" 3 4
...
# 2756 "../test/ectest.c"
        ...
        || !test_int_eq("../test/ectest.c", 2758, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, 
# 2758 "../test/ectest.c" 3 4
           ((void *)0)
# 2758 "../test/ectest.c"
           , 0, ctx), bsize)


        || !test_ptr("../test/ectest.c", 2761, "b1 = OPENSSL_malloc(bsize)", b1 = CRYPTO_malloc(bsize, "../test/ectest.c", 2761))
        || !test_int_eq("../test/ectest.c", 2762, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, b1, bsize, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, b1, bsize, ctx), bsize)



        || !test_true("../test/ectest.c", 2766, "EC_POINT_dbl(group, G2, EC_GROUP_get0_generator(group), ctx)", (EC_POINT_dbl(group, G2, EC_GROUP_get0_generator(group), ctx)) != 0)

        || !test_true("../test/ectest.c", 2768, "EC_GROUP_set_generator(group, G2, EC_GROUP_get0_order(group), EC_GROUP_get0_cofactor(group))", (EC_GROUP_set_generator(group, G2, EC_GROUP_get0_order(group), EC_GROUP_get0_cofactor(group))) != 0)


        || !test_ptr("../test/ectest.c", 2771, "Q2 = EC_POINT_new(group)", Q2 = EC_POINT_new(group))
        || !test_true("../test/ectest.c", 2772, "BN_rshift1(k, k)", (BN_rshift1(k, k)) != 0)

        || !test_true("../test/ectest.c", 2774, "EC_POINT_mul(group, Q2, k, NULL, NULL, ctx)", (EC_POINT_mul(group, Q2, k, 
# 2774 "../test/ectest.c" 3 4
           ((void *)0)
# 2774 "../test/ectest.c"
           , 
# 2774 "../test/ectest.c" 3 4
...
# 2774 "../test/ectest.c"
           , ctx)) != 0)
        || !test_int_eq("../test/ectest.c", 2775, "EC_POINT_point2oct(group, Q2, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(group, Q2, POINT_CONVERSION_UNCOMPRESSED, 
# 2775 "../test/ectest.c" 3 4
           ((void *)0)
# 2775 "../test/ectest.c"
           , 0, ctx), bsize)


        || !test_ptr("../test/ectest.c", 2778, "b2 = OPENSSL_malloc(bsize)", b2 = CRYPTO_malloc(bsize, "../test/ectest.c", 2778))
        || !test_int_eq("../test/ectest.c", 2779, "EC_POINT_point2oct(group, Q2, POINT_CONVERSION_UNCOMPRESSED, b2, bsize, ctx)", "bsize", EC_POINT_point2oct(group, Q2, POINT_CONVERSION_UNCOMPRESSED, b2, bsize, ctx), bsize)



        || !test_mem_eq("../test/ectest.c", 2783, "b1", "b2", b1, bsize, b2, bsize))
        goto err;
 ...
 err:
    ...
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_free(b1, "../test/ectest.c", 2798);
    CRYPTO_free(b2, "../test/ectest.c", 2799);
...
# 2810 "../test/ectest.c" 3 4
                            ((void *)0)
# 2810 "../test/ectest.c"
                                ;
    EC_GROUP *group = 
# 2811 "../test/ectest.c" 3 4
                     ((void *)0)
# 2811 "../test/ectest.c"
                         , *altgroup = 
# 2811 "../test/ectest.c" 3 4
...
# 2812 "../test/ectest.c"
                                              ;
    const EC_POINT *Q = 
# 2813 "../test/ectest.c" 3 4
                       ((void *)0)
# 2813 "../test/ectest.c"
                           ;
    BN_CTX *ctx = 
# 2814 "../test/ectest.c" 3 4
                 ((void *)0)
# 2814 "../test/ectest.c"
                     ;
    BIGNUM *k = 
# 2815 "../test/ectest.c" 3 4
               ((void *)0)
# 2815 "../test/ectest.c"
                   ;
    unsigned char *buf1 = 
# 2816 "../test/ectest.c" 3 4
                         ((void *)0)
# 2816 "../test/ectest.c"
                             , *buf2 = 
# 2816 "../test/ectest.c" 3 4
...
# 2825 "../test/ectest.c" 3 4
                               ((void *)0)
# 2825 "../test/ectest.c"
                                   ;
    OSSL_PARAM *params1 = 
# 2826 "../test/ectest.c" 3 4
                         ((void *)0)
# 2826 "../test/ectest.c"
                             , *params2 = 
# 2826 "../test/ectest.c" 3 4
...
# 2826 "../test/ectest.c"
    ...
    if (nid == 1172)
        return test_skip("../test/ectest.c", 2834, "custom params not supported with SM2");

    if (!test_ptr("../test/ectest.c", 2836, "ctx = BN_CTX_new()", ctx = BN_CTX_new()))
        return 0;

    BN_CTX_start(ctx);
    if (!test_ptr("../test/ectest.c", 2840, "p = BN_CTX_get(ctx)", p = BN_CTX_get(ctx))
            || !test_ptr("../test/ectest.c", 2841, "a = BN_CTX_get(ctx)", a = BN_CTX_get(ctx))
            || !test_ptr("../test/ectest.c", 2842, "b = BN_CTX_get(ctx)", b = BN_CTX_get(ctx))
            || !test_ptr("../test/ectest.c", 2843, "k = BN_CTX_get(ctx)", k = BN_CTX_get(ctx)))
        goto err;

    if (!test_ptr("../test/ectest.c", 2846, "group = EC_GROUP_new_by_curve_name(nid)", group = EC_GROUP_new_by_curve_name(nid)))
        goto err;

    is_prime = EC_GROUP_get_field_type(group) == 406;
# 2858 "../test/ectest.c"
    bsize = (EC_GROUP_get_degree(group) + 7) / 8;
    bsize = 1 + 2 * bsize;


    if (!test_true("../test/ectest.c", 2862, "EC_GROUP_get_curve(group, p, a, b, ctx)", (EC_GROUP_get_curve(group, p, a, b, ctx)) != 0)
            || !test_ptr("../test/ectest.c", 2863, "G2 = EC_POINT_new(group)", G2 = EC_POINT_new(group))

            || !test_true("../test/ectest.c", 2865, "EC_POINT_dbl(group, G2, EC_GROUP_get0_generator(group), ctx)", (EC_POINT_dbl(group, G2, EC_GROUP_get0_generator(group), ctx)) != 0)


            || !test_int_eq("../test/ectest.c", 2868, "EC_POINT_point2oct(group, G2, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(group, G2, POINT_CONVERSION_UNCOMPRESSED, 
# 2868 "../test/ectest.c" 3 4
               ((void *)0)
# 2868 "../test/ectest.c"
               , 0, ctx), bsize)


            || !test_ptr("../test/ectest.c", 2871, "buf1 = OPENSSL_malloc(bsize)", buf1 = CRYPTO_malloc(bsize, "../test/ectest.c", 2871))
            || !test_int_eq("../test/ectest.c", 2872, "EC_POINT_point2oct(group, G2, POINT_CONVERSION_UNCOMPRESSED, buf1, bsize, ctx)", "bsize", EC_POINT_point2oct(group, G2, POINT_CONVERSION_UNCOMPRESSED, buf1, bsize, ctx), bsize)


            || !test_ptr("../test/ectest.c", 2875, "z = EC_GROUP_get0_order(group)", z = EC_GROUP_get0_order(group))
            || !test_ptr("../test/ectest.c", 2876, "cof = EC_GROUP_get0_cofactor(group)", cof = EC_GROUP_get0_cofactor(group))
        )
        goto err;


    if (is_prime) {
        if (!test_ptr("../test/ectest.c", 2882, "altgroup = EC_GROUP_new_curve_GFp(p, a, b, ctx)", altgroup = EC_GROUP_new_curve_GFp(p, a, b, ctx)))
            goto err;
    }

    else {
        if (!test_ptr("../test/ectest.c", 2887, "altgroup = EC_GROUP_new_curve_GF2m(p, a, b, ctx)", altgroup = EC_GROUP_new_curve_GF2m(p, a, b, ctx)))
            goto err;
    }
    ...
    EC_POINT_free(G2);
    if (!test_ptr("../test/ectest.c", 2894, "G2 = EC_POINT_new(altgroup)", G2 = EC_POINT_new(altgroup))
            || !test_true("../test/ectest.c", 2895, "EC_POINT_oct2point(altgroup, G2, buf1, bsize, ctx)", (EC_POINT_oct2point(altgroup, G2, buf1, bsize, ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 2896, "EC_POINT_is_on_curve(altgroup, G2, ctx)", "1", EC_POINT_is_on_curve(altgroup, G2, ctx), 1)
            || !test_true("../test/ectest.c", 2897, "EC_GROUP_set_generator(altgroup, G2, z, cof)", (EC_GROUP_set_generator(altgroup, G2, z, cof)) != 0)
       )
        goto err;


    if (
            !test_ptr("../test/ectest.c", 2903, "Q1 = EC_POINT_new(group)", Q1 = EC_POINT_new(group))
            || !test_ptr("../test/ectest.c", 2904, "Q2 = EC_POINT_new(altgroup)", Q2 = EC_POINT_new(altgroup))

            || !test_true("../test/ectest.c", 2906, "BN_rand(k, EC_GROUP_order_bits(group) - 1, BN_RAND_TOP_ONE, BN_RAND_BOTTOM_ANY)", (BN_rand(k, EC_GROUP_order_bits(group) - 1, 0, 0)) != 0)


            || !test_true("../test/ectest.c", 2909, "BN_clear_bit(k, 0)", (BN_clear_bit(k, 0)) != 0)

            || !test_true("../test/ectest.c", 2911, "EC_POINT_mul(group, Q1, k, NULL, NULL, ctx)", (EC_POINT_mul(group, Q1, k, 
# 2911 "../test/ectest.c" 3 4
               ((void *)0)
# 2911 "../test/ectest.c"
               , 
# 2911 "../test/ectest.c" 3 4
...
# 2911 "../test/ectest.c"
            ...
            || !test_int_eq("../test/ectest.c", 2913, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, 
# 2913 "../test/ectest.c" 3 4
               ((void *)0)
# 2913 "../test/ectest.c"
               , 0, ctx), bsize)


            || !test_int_eq("../test/ectest.c", 2916, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, buf1, bsize, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, buf1, bsize, ctx), bsize)



            || !test_true("../test/ectest.c", 2920, "BN_rshift1(k, k)", (BN_rshift1(k, k)) != 0)

            || !test_true("../test/ectest.c", 2922, "EC_POINT_mul(altgroup, Q2, k, NULL, NULL, ctx)", (EC_POINT_mul(altgroup, Q2, k, 
# 2922 "../test/ectest.c" 3 4
               ((void *)0)
# 2922 "../test/ectest.c"
               , 
# 2922 "../test/ectest.c" 3 4
...
# 2922 "../test/ectest.c"
            ...
            || !test_int_eq("../test/ectest.c", 2924, "EC_POINT_point2oct(altgroup, Q2, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(altgroup, Q2, POINT_CONVERSION_UNCOMPRESSED, 
# 2924 "../test/ectest.c" 3 4
               ((void *)0)
# 2924 "../test/ectest.c"
               , 0, ctx), bsize)


            || !test_ptr("../test/ectest.c", 2927, "buf2 = OPENSSL_malloc(bsize)", buf2 = CRYPTO_malloc(bsize, "../test/ectest.c", 2927))
            || !test_int_eq("../test/ectest.c", 2928, "EC_POINT_point2oct(altgroup, Q2, POINT_CONVERSION_UNCOMPRESSED, buf2, bsize, ctx)", "bsize", EC_POINT_point2oct(altgroup, Q2, POINT_CONVERSION_UNCOMPRESSED, buf2, bsize, ctx), bsize)



            || !test_mem_eq("../test/ectest.c", 2932, "buf1", "buf2", buf1, bsize, buf2, bsize))
        goto err;


    if (!test_ptr("../test/ectest.c", 2936, "eckey1 = EC_KEY_new()", eckey1 = EC_KEY_new())
            || !test_true("../test/ectest.c", 2937, "EC_KEY_set_group(eckey1, altgroup)", (EC_KEY_set_group(eckey1, altgroup)) != 0)
            || !test_true("../test/ectest.c", 2938, "EC_KEY_generate_key(eckey1)", (EC_KEY_generate_key(eckey1)) != 0)
            || !test_ptr("../test/ectest.c", 2939, "eckey2 = EC_KEY_new()", eckey2 = EC_KEY_new())
            || !test_true("../test/ectest.c", 2940, "EC_KEY_set_group(eckey2, altgroup)", (EC_KEY_set_group(eckey2, altgroup)) != 0)
            || !test_true("../test/ectest.c", 2941, "EC_KEY_generate_key(eckey2)", (EC_KEY_generate_key(eckey2)) != 0))
        goto err;


    if (!test_ptr("../test/ectest.c", 2945, "priv1 = EC_KEY_get0_private_key(eckey1)", priv1 = EC_KEY_get0_private_key(eckey1)))
        goto err;
    ...
    if (!test_true("../test/ectest.c", 2954, "EC_POINT_mul(group, Q1, priv1, NULL, NULL, ctx)", (EC_POINT_mul(group, Q1, priv1, 
# 2954 "../test/ectest.c" 3 4
        ((void *)0)
# 2954 "../test/ectest.c"
        , 
# 2954 "../test/ectest.c" 3 4
...
# 2954 "../test/ectest.c"
        , ctx)) != 0)
            || !test_int_eq("../test/ectest.c", 2955, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, 
# 2955 "../test/ectest.c" 3 4
               ((void *)0)
# 2955 "../test/ectest.c"
               , 0, ctx), bsize)


            || !test_ptr("../test/ectest.c", 2958, "pub1 = OPENSSL_malloc(bsize)", pub1 = CRYPTO_malloc(bsize, "../test/ectest.c", 2958))
            || !test_int_eq("../test/ectest.c", 2959, "EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, pub1, bsize, ctx)", "bsize", EC_POINT_point2oct(group, Q1, POINT_CONVERSION_UNCOMPRESSED, pub1, bsize, ctx), bsize)

                                                                        )
        goto err;


    if (!test_ptr("../test/ectest.c", 2965, "Q = EC_KEY_get0_public_key(eckey2)", Q = EC_KEY_get0_public_key(eckey2))
            || !test_int_eq("../test/ectest.c", 2966, "EC_POINT_point2oct(altgroup, Q, POINT_CONVERSION_UNCOMPRESSED, NULL, 0, ctx)", "bsize", EC_POINT_point2oct(altgroup, Q, POINT_CONVERSION_UNCOMPRESSED, 
# 2966 "../test/ectest.c" 3 4
               ((void *)0)
# 2966 "../test/ectest.c"
               , 0, ctx), bsize)


            || !test_ptr("../test/ectest.c", 2969, "pub2 = OPENSSL_malloc(bsize)", pub2 = CRYPTO_malloc(bsize, "../test/ectest.c", 2969))
            || !test_int_eq("../test/ectest.c", 2970, "EC_POINT_point2oct(altgroup, Q, POINT_CONVERSION_UNCOMPRESSED, pub2, bsize, ctx)", "bsize", EC_POINT_point2oct(altgroup, Q, POINT_CONVERSION_UNCOMPRESSED, pub2, bsize, ctx), bsize)

                                                                        )
        goto err;


    if (!test_ptr("../test/ectest.c", 2976, "pkey1 = EVP_PKEY_new()", pkey1 = EVP_PKEY_new())
            || !test_int_eq("../test/ectest.c", 2977, "EVP_PKEY_assign_EC_KEY(pkey1, eckey1)", "1", EVP_PKEY_assign((pkey1), 408, (eckey1)), 1))
        goto err;
    eckey1 = 
# 2979 "../test/ectest.c" 3 4
            ((void *)0)
# 2979 "../test/ectest.c"
                ;
    if (!test_ptr("../test/ectest.c", 2980, "pkey2 = EVP_PKEY_new()", pkey2 = EVP_PKEY_new())
            || !test_int_eq("../test/ectest.c", 2981, "EVP_PKEY_assign_EC_KEY(pkey2, eckey2)", "1", EVP_PKEY_assign((pkey2), 408, (eckey2)), 1))
        goto err;
    eckey2 = 
# 2983 "../test/ectest.c" 3 4
            ((void *)0)
# 2983 "../test/ectest.c"
                ;


    if (!test_ptr("../test/ectest.c", 2986, "pctx1 = EVP_PKEY_CTX_new(pkey1, NULL)", pctx1 = EVP_PKEY_CTX_new(pkey1, 
# 2986 "../test/ectest.c" 3 4
        ((void *)0)
# 2986 "../test/ectest.c"
        ))
            || !test_int_eq("../test/ectest.c", 2987, "EVP_PKEY_derive_init(pctx1)", "1", EVP_PKEY_derive_init(pctx1), 1)
            || !test_int_eq("../test/ectest.c", 2988, "EVP_PKEY_derive_set_peer(pctx1, pkey2)", "1", EVP_PKEY_derive_set_peer(pctx1, pkey2), 1)
            || !test_int_eq("../test/ectest.c", 2989, "EVP_PKEY_derive(pctx1, NULL, &sslen)", "1", EVP_PKEY_derive(pctx1, 
# 2989 "../test/ectest.c" 3 4
               ((void *)0)
# 2989 "../test/ectest.c"
               , &sslen), 1)
            || !test_int_gt("../test/ectest.c", 2990, "bsize", "sslen", bsize, sslen)
            || !test_int_eq("../test/ectest.c", 2991, "EVP_PKEY_derive(pctx1, buf1, &sslen)", "1", EVP_PKEY_derive(pctx1, buf1, &sslen), 1))
        goto err;
    if (!test_ptr("../test/ectest.c", 2993, "pctx2 = EVP_PKEY_CTX_new(pkey2, NULL)", pctx2 = EVP_PKEY_CTX_new(pkey2, 
# 2993 "../test/ectest.c" 3 4
        ((void *)0)
# 2993 "../test/ectest.c"
        ))
            || !test_int_eq("../test/ectest.c", 2994, "EVP_PKEY_derive_init(pctx2)", "1", EVP_PKEY_derive_init(pctx2), 1)
            || !test_int_eq("../test/ectest.c", 2995, "EVP_PKEY_derive_set_peer(pctx2, pkey1)", "1", EVP_PKEY_derive_set_peer(pctx2, pkey1), 1)
            || !test_int_eq("../test/ectest.c", 2996, "EVP_PKEY_derive(pctx2, NULL, &t)", "1", EVP_PKEY_derive(pctx2, 
# 2996 "../test/ectest.c" 3 4
               ((void *)0)
# 2996 "../test/ectest.c"
               , &t), 1)
            || !test_int_gt("../test/ectest.c", 2997, "bsize", "t", bsize, t)
            || !test_int_le("../test/ectest.c", 2998, "sslen", "t", sslen, t)
            || !test_int_eq("../test/ectest.c", 2999, "EVP_PKEY_derive(pctx2, buf2, &t)", "1", EVP_PKEY_derive(pctx2, buf2, &t), 1))
        goto err;


    if (!test_mem_eq("../test/ectest.c", 3003, "buf1", "buf2", buf1, sslen, buf2, t))
        goto err;


    if (!test_ptr("../test/ectest.c", 3007, "param_bld = OSSL_PARAM_BLD_new()", param_bld = OSSL_PARAM_BLD_new())
            || !test_true("../test/ectest.c", 3008, "OSSL_PARAM_BLD_push_utf8_string(param_bld, OSSL_PKEY_PARAM_GROUP_NAME, curve_name, 0)", (OSSL_PARAM_BLD_push_utf8_string(param_bld, "group", curve_name, 0)) != 0)


            || !test_true("../test/ectest.c", 3011, "OSSL_PARAM_BLD_push_octet_string(param_bld, OSSL_PKEY_PARAM_PUB_KEY, pub1, bsize)", (OSSL_PARAM_BLD_push_octet_string(param_bld, "pub", pub1, bsize)) != 0)


            || !test_true("../test/ectest.c", 3014, "OSSL_PARAM_BLD_push_BN(param_bld, OSSL_PKEY_PARAM_PRIV_KEY, priv1)", (OSSL_PARAM_BLD_push_BN(param_bld, "priv", priv1)) != 0)


            || !test_ptr("../test/ectest.c", 3017, "params1 = OSSL_PARAM_BLD_to_param(param_bld)", params1 = OSSL_PARAM_BLD_to_param(param_bld)))
        goto err;

    OSSL_PARAM_BLD_free(param_bld);
    if (!test_ptr("../test/ectest.c", 3021, "param_bld = OSSL_PARAM_BLD_new()", param_bld = OSSL_PARAM_BLD_new())
            || !test_true("../test/ectest.c", 3022, "OSSL_PARAM_BLD_push_utf8_string(param_bld, OSSL_PKEY_PARAM_GROUP_NAME, curve_name, 0)", (OSSL_PARAM_BLD_push_utf8_string(param_bld, "group", curve_name, 0)) != 0)


            || !test_true("../test/ectest.c", 3025, "OSSL_PARAM_BLD_push_octet_string(param_bld, OSSL_PKEY_PARAM_PUB_KEY, pub2, bsize)", (OSSL_PARAM_BLD_push_octet_string(param_bld, "pub", pub2, bsize)) != 0)


            || !test_ptr("../test/ectest.c", 3028, "params2 = OSSL_PARAM_BLD_to_param(param_bld)", params2 = OSSL_PARAM_BLD_to_param(param_bld)))
        goto err;


    EVP_PKEY_CTX_free(pctx2);
    if (!test_ptr("../test/ectest.c", 3033, "pctx2 = EVP_PKEY_CTX_new_from_name(NULL, \"EC\", NULL)", pctx2 = EVP_PKEY_CTX_new_from_name(
# 3033 "../test/ectest.c" 3 4
        ((void *)0)
# 3033 "../test/ectest.c"
        , "EC", 
# 3033 "../test/ectest.c" 3 4
...
# 3033 "../test/ectest.c"
            ...
            || !test_int_eq("../test/ectest.c", 3034, "EVP_PKEY_fromdata_init(pctx2)", "1", EVP_PKEY_fromdata_init(pctx2), 1)
            || !test_int_eq("../test/ectest.c", 3035, "EVP_PKEY_fromdata(pctx2, &pkey1, EVP_PKEY_KEYPAIR, params1)", "1", EVP_PKEY_fromdata(pctx2, &pkey1, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params1), 1)

            || !test_int_eq("../test/ectest.c", 3037, "EVP_PKEY_fromdata(pctx2, &pkey2, EVP_PKEY_PUBLIC_KEY, params2)", "1", EVP_PKEY_fromdata(pctx2, &pkey2, ( ( ( 0x04 | 0x80) ) | 0x02 ), params2), 1)
                                                          )
        goto err;


    EVP_PKEY_CTX_free(pctx1);
    if (!test_ptr("../test/ectest.c", 3043, "pctx1 = EVP_PKEY_CTX_new(pkey1, NULL)", pctx1 = EVP_PKEY_CTX_new(pkey1, 
# 3043 "../test/ectest.c" 3 4
        ((void *)0)
# 3043 "../test/ectest.c"
        ))
            || !test_int_eq("../test/ectest.c", 3044, "EVP_PKEY_derive_init(pctx1)", "1", EVP_PKEY_derive_init(pctx1), 1)
            || !test_ptr("../test/ectest.c", 3045, "dctx = EVP_PKEY_CTX_dup(pctx1)", dctx = EVP_PKEY_CTX_dup(pctx1))
            || !test_int_eq("../test/ectest.c", 3046, "EVP_PKEY_derive_set_peer_ex(dctx, pkey2, 1)", "1", EVP_PKEY_derive_set_peer_ex(dctx, pkey2, 1), 1)
            || !test_int_eq("../test/ectest.c", 3047, "EVP_PKEY_derive(dctx, NULL, &t)", "1", EVP_PKEY_derive(dctx, 
# 3047 "../test/ectest.c" 3 4
               ((void *)0)
# 3047 "../test/ectest.c"
               , &t), 1)
            || !test_int_gt("../test/ectest.c", 3048, "bsize", "t", bsize, t)
            || !test_int_le("../test/ectest.c", 3049, "sslen", "t", sslen, t)
            || !test_int_eq("../test/ectest.c", 3050, "EVP_PKEY_derive(dctx, buf1, &t)", "1", EVP_PKEY_derive(dctx, buf1, &t), 1)

            || !test_mem_eq("../test/ectest.c", 3052, "buf1", "buf2", buf1, t, buf2, sslen))
        goto err;
 ...
 err:
    ...
    CRYPTO_free(buf1, "../test/ectest.c", 3068);
    CRYPTO_free(buf2, "../test/ectest.c", 3069);
    CRYPTO_free(pub1, "../test/ectest.c", 3070);
    CRYPTO_free(pub2, "../test/ectest.c", 3071);
    EC_KEY_free(eckey1);
    EC_KEY_free(eckey2);
    EVP_PKEY_free(pkey1);
    EVP_PKEY_free(pkey2);
...
# 3089 "../test/ectest.c"
   ...
   if (!test_ptr("../test/ectest.c", 3093, "gen_key = EVP_EC_gen(\"P-256\")", gen_key = EVP_PKEY_Q_keygen(
# 3093 "../test/ectest.c" 3 4
       ((void *)0)
# 3093 "../test/ectest.c"
       , 
# 3093 "../test/ectest.c" 3 4
       ((void *)0)
# 3093 "../test/ectest.c"
       , "EC", (char *)(strstr("P-256", "")))))
       goto err;

   if (!test_int_gt("../test/ectest.c", 3096, "pklen = i2d_PublicKey(gen_key, &pubkey_enc)", "0", pklen = i2d_PublicKey(gen_key, &pubkey_enc), 0))
       goto err;
   ...
   if (!test_ptr("../test/ectest.c", 3103, "pctx = EVP_PKEY_CTX_new_from_name(NULL, \"EC\", NULL)", pctx = EVP_PKEY_CTX_new_from_name(
# 3103 "../test/ectest.c" 3 4
       ((void *)0)
# 3103 "../test/ectest.c"
       , "EC", 
# 3103 "../test/ectest.c" 3 4
...
# 3103 "../test/ectest.c"
       ...
       || !test_true("../test/ectest.c", 3104, "EVP_PKEY_fromdata_init(pctx)", (EVP_PKEY_fromdata_init(pctx)) != 0)
       || !test_true("../test/ectest.c", 3105, "EVP_PKEY_fromdata(pctx, &decoded_key, OSSL_KEYMGMT_SELECT_DOMAIN_PARAMETERS, params)", (EVP_PKEY_fromdata(pctx, &decoded_key, 0x04, params)) != 0)


       || !test_ptr("../test/ectest.c", 3108, "decoded_key", decoded_key)
       || !test_ptr("../test/ectest.c", 3109, "decoded_key = d2i_PublicKey(EVP_PKEY_EC, &decoded_key, &pk_enc, pklen)", decoded_key = d2i_PublicKey(408, &decoded_key, &pk_enc, pklen))
                                                                )
       goto err;

   if (!test_true("../test/ectest.c", 3113, "EVP_PKEY_eq(gen_key, decoded_key)", (EVP_PKEY_eq(gen_key, decoded_key)) != 0))
       goto err;
   ret = 1;
...
int setup_tests(void)
{
    crv_len = EC_get_builtin_curves(
# 3126 "../test/ectest.c" 3 4
                                   ((void *)0)
# 3126 "../test/ectest.c"
                                       , 0);
    if (!test_ptr("../test/ectest.c", 3127, "curves = OPENSSL_malloc(sizeof(*curves) * crv_len)", curves = CRYPTO_malloc(sizeof(*curves) * crv_len, "../test/ectest.c", 3127))
        || !test_true("../test/ectest.c", 3128, "EC_get_builtin_curves(curves, crv_len)", (EC_get_builtin_curves(curves, crv_len)) != 0))
        return 0;
    ...
    add_all_tests("cardinality_test", cardinality_test, crv_len, 1);
    ...
    add_all_tests("char2_curve_test", char2_curve_test, (sizeof(char2_curve_tests)/sizeof((char2_curve_tests)[0])), 1);

    add_all_tests("nistp_single_test", nistp_single_test, (sizeof(nistp_tests_params)/sizeof((nistp_tests_params)[0])), 1);
    add_all_tests("internal_curve_test", internal_curve_test, crv_len, 1);
    add_all_tests("internal_curve_test_method", internal_curve_test_method, crv_len, 1);
    add_test("group_field_test", group_field_test);
    add_all_tests("check_named_curve_test", check_named_curve_test, crv_len, 1);
    add_all_tests("check_named_curve_lookup_test", check_named_curve_lookup_test, crv_len, 1);
    add_all_tests("check_ec_key_field_public_range_test", check_ec_key_field_public_range_test, crv_len, 1);
    add_all_tests("check_named_curve_from_ecparameters", check_named_curve_from_ecparameters, crv_len, 1);
    add_all_tests("ec_point_hex2point_test", ec_point_hex2point_test, crv_len, 1);
    add_all_tests("custom_generator_test", custom_generator_test, crv_len, 1);
    add_all_tests("custom_params_test", custom_params_test, crv_len, 1);
...
void cleanup_tests(void)
{
    CRYPTO_free(curves, "../test/ectest.c", 3158);
}
