...
{
    char *bigstring = glue_strings(bn_strings, 
# 74 "../test/bntest.c" 3 4
                                              ((void *)0)
# 74 "../test/bntest.c"
                                                  );
    int ret = BN_hex2bn(out, bigstring);

    CRYPTO_free(bigstring, "../test/bntest.c", 77);
    return ret;
}
...
static BIGNUM *getBN(STANZA *s, const char *attribute)
{
    const char *hex;
    BIGNUM *ret = 
# 99 "../test/bntest.c" 3 4
                 ((void *)0)
# 99 "../test/bntest.c"
                     ;

    if ((hex = findattr(s, attribute)) == 
# 101 "../test/bntest.c" 3 4
                                         ((void *)0)
# 101 "../test/bntest.c"
                                             ) {
        test_error("../test/bntest.c", 102, "%s:%d: Can't find %s", s->test_file, s->start, attribute);
        return 
# 103 "../test/bntest.c" 3 4
              ((void *)0)
# 103 "../test/bntest.c"
                  ;
    }
    ...
    if (parseBN(&ret, hex) != (int)strlen(hex)) {
        test_error("../test/bntest.c", 107, "Could not decode '%s'", hex);
        return 
# 108 "../test/bntest.c" 3 4
              ((void *)0)
# 108 "../test/bntest.c"
                  ;
    }
...
static int getint(STANZA *s, int *out, const char *attribute)
{
    ...
    if (!test_ptr("../test/bntest.c", 119, "ret = getBN(s, attribute)", ret = getBN(s, attribute))
            || !test_ulong_le("../test/bntest.c", 120, "word = BN_get_word(ret)", "INT_MAX", word = BN_get_word(ret), 0x7fffffff
# 120 "../test/bntest.c"
               ))
        goto err;
...
static int equalBN(const char *op, const BIGNUM *expected, const BIGNUM *actual)
{
    ...
    test_error("../test/bntest.c", 135, "unexpected %s value", op);
    test_BN_eq("../test/bntest.c", 136, "expected", "actual", expected, actual);
    return 0;
}
...
# 153 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 156, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 157, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 158, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 159, "d = BN_new()", d = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 162, "BN_bntest_rand(a, 1024, 1, 0)", (BN_bntest_rand(a, 1024, 1, 0)) != 0)
            && test_true("../test/bntest.c", 163, "BN_bntest_rand(b, 1024, 1, 0)", (BN_bntest_rand(b, 1024, 1, 0)) != 0)
            && test_ptr("../test/bntest.c", 164, "BN_copy(c, a)", BN_copy(c, a))
            && test_ptr("../test/bntest.c", 165, "BN_copy(d, b)", BN_copy(d, b))))
        goto err;
    top = BN_num_bits(a) / (8 * 8);
    ...
    if (!equalBN("swap, flags", a, d)
            ...
            || !test_true("../test/bntest.c", 210, "BN_get_flags(b, BN_FLG_CONSTTIME)", (BN_get_flags(b, 0x04)) != 0)
            || !test_false("../test/bntest.c", 211, "BN_get_flags(a, BN_FLG_CONSTTIME)", (BN_get_flags(a, 0x04)) != 0))
        goto err;
    ...
    if (!equalBN("cswap true, flags", a, c)
            ...
            || !test_true("../test/bntest.c", 218, "BN_get_flags(a, BN_FLG_CONSTTIME)", (BN_get_flags(a, 0x04)) != 0)
            || !test_false("../test/bntest.c", 219, "BN_get_flags(b, BN_FLG_CONSTTIME)", (BN_get_flags(b, 0x04)) != 0))
        goto err;
    ...
    if (!equalBN("cswap false, flags", a, c)
            ...
            || !test_true("../test/bntest.c", 226, "BN_get_flags(a, BN_FLG_CONSTTIME)", (BN_get_flags(a, 0x04)) != 0)
            || !test_false("../test/bntest.c", 227, "BN_get_flags(b, BN_FLG_CONSTTIME)", (BN_get_flags(b, 0x04)) != 0))
        goto err;
...
# 241 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 244, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 245, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 246, "c = BN_new()", c = BN_new()))
        goto err;

    for (i = 0; i < NUM0 + NUM1; i++) {
        if (i < NUM1) {
            if (!(test_true("../test/bntest.c", 251, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
                    && test_ptr("../test/bntest.c", 252, "BN_copy(b, a)", BN_copy(b, a))
                    && test_int_ne("../test/bntest.c", 253, "BN_set_bit(a, i)", "0", BN_set_bit(a, i), 0)
                    && test_true("../test/bntest.c", 254, "BN_add_word(b, i)", (BN_add_word(b, i)) != 0))
                goto err;
        } else {
            if (!test_true("../test/bntest.c", 257, "BN_bntest_rand(b, 400 + i - NUM1, 0, 0)", (BN_bntest_rand(b, 400 + i - NUM1, 0, 0)) != 0))
                goto err;
            BN_set_negative(a, rand_neg());
            BN_set_negative(b, rand_neg());
        }
        if (!(test_true("../test/bntest.c", 262, "BN_sub(c, a, b)", (BN_sub(c, a, b)) != 0)
                && test_true("../test/bntest.c", 263, "BN_add(c, c, b)", (BN_add(c, c, b)) != 0)
                && test_true("../test/bntest.c", 264, "BN_sub(c, c, a)", (BN_sub(c, c, a)) != 0)
                && test_BN_eq_zero("../test/bntest.c", 265, "c", c)))
            goto err;
    }
    st = 1;
 err:
...
# 278 "../test/bntest.c"
                                                               ;
    BN_RECP_CTX *recp = 
# 279 "../test/bntest.c" 3 4
                       ((void *)0)
# 279 "../test/bntest.c"
                           ;
    int st = 0, i;

    if (!test_ptr("../test/bntest.c", 282, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 283, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 284, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 285, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 286, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 287, "recp = BN_RECP_CTX_new()", recp = BN_RECP_CTX_new()))
        goto err;

    for (i = 0; i < NUM0 + NUM1; i++) {
        if (i < NUM1) {
            if (!(test_true("../test/bntest.c", 292, "BN_bntest_rand(a, 400, 0, 0)", (BN_bntest_rand(a, 400, 0, 0)) != 0)
                    && test_ptr("../test/bntest.c", 293, "BN_copy(b, a)", BN_copy(b, a))
                    && test_true("../test/bntest.c", 294, "BN_lshift(a, a, i)", (BN_lshift(a, a, i)) != 0)
                    && test_true("../test/bntest.c", 295, "BN_add_word(a, i)", (BN_add_word(a, i)) != 0)))
                goto err;
        } else {
            if (!(test_true("../test/bntest.c", 298, "BN_bntest_rand(b, 50 + 3 * (i - NUM1), 0, 0)", (BN_bntest_rand(b, 50 + 3 * (i - NUM1), 0, 0)) != 0)))
                goto err;
        }
        BN_set_negative(a, rand_neg());
        BN_set_negative(b, rand_neg());
        if (!(test_true("../test/bntest.c", 303, "BN_RECP_CTX_set(recp, b, ctx)", (BN_RECP_CTX_set(recp, b, ctx)) != 0)
                && test_true("../test/bntest.c", 304, "BN_div_recp(d, c, a, recp, ctx)", (BN_div_recp(d, c, a, recp, ctx)) != 0)
                && test_true("../test/bntest.c", 305, "BN_mul(e, d, b, ctx)", (BN_mul(e, d, b, ctx)) != 0)
                && test_true("../test/bntest.c", 306, "BN_add(d, e, c)", (BN_add(d, e, c)) != 0)
                && test_true("../test/bntest.c", 307, "BN_sub(d, d, a)", (BN_sub(d, d, a)) != 0)
                && test_BN_eq_zero("../test/bntest.c", 308, "d", d)))
            goto err;
    }
    st = 1;
 err:
...
static BIGNUM *set_signed_bn(int value)
{
    ...
    if (bn == 
# 335 "../test/bntest.c" 3 4
             ((void *)0)
# 335 "../test/bntest.c"
                 )
        return 
# 336 "../test/bntest.c" 3 4
              ((void *)0)
# 336 "../test/bntest.c"
                  ;
...
# 347 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 350, "a = set_signed_bn(signed_mod_tests[n].n)", a = set_signed_bn(signed_mod_tests[n].n))
            || !test_ptr("../test/bntest.c", 351, "b = set_signed_bn(signed_mod_tests[n].divisor)", b = set_signed_bn(signed_mod_tests[n].divisor))
            || !test_ptr("../test/bntest.c", 352, "c = set_signed_bn(signed_mod_tests[n].result)", c = set_signed_bn(signed_mod_tests[n].result))
            || !test_ptr("../test/bntest.c", 353, "d = set_signed_bn(signed_mod_tests[n].remainder)", d = set_signed_bn(signed_mod_tests[n].remainder)))
        goto err;

    if (test_true("../test/bntest.c", 356, "BN_div(a, b, a, b, ctx)", (BN_div(a, b, a, b, ctx)) != 0)
            && test_BN_eq("../test/bntest.c", 357, "a", "c", a, c)
            && test_BN_eq("../test/bntest.c", 358, "b", "d", b, d))
        st = 1;
 err:
    BN_free(a);
    BN_free(b);
...
# 370 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 373, "a = set_signed_bn(signed_mod_tests[n].n)", a = set_signed_bn(signed_mod_tests[n].n))
            || !test_ptr("../test/bntest.c", 374, "b = set_signed_bn(signed_mod_tests[n].divisor)", b = set_signed_bn(signed_mod_tests[n].divisor))
            || !test_ptr("../test/bntest.c", 375, "c = set_signed_bn(signed_mod_tests[n].result)", c = set_signed_bn(signed_mod_tests[n].result))
            || !test_ptr("../test/bntest.c", 376, "d = set_signed_bn(signed_mod_tests[n].remainder)", d = set_signed_bn(signed_mod_tests[n].remainder)))
        goto err;

    if (test_true("../test/bntest.c", 379, "BN_div(b, a, a, b, ctx)", (BN_div(b, a, a, b, ctx)) != 0)
            && test_BN_eq("../test/bntest.c", 380, "b", "c", b, c)
            && test_BN_eq("../test/bntest.c", 381, "a", "d", a, d))
        st = 1;
 err:
    BN_free(a);
    BN_free(b);
...
# 393 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 396, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 397, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 398, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 399, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 400, "e = BN_new()", e = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 403, "BN_bntest_rand(a, 1024, 0, 0)", (BN_bntest_rand(a, 1024, 0, 0)) != 0)))
        goto err;
    for (i = 0; i < NUM0; i++) {
        if (!(test_true("../test/bntest.c", 406, "BN_bntest_rand(b, 450 + i * 10, 0, 0)", (BN_bntest_rand(b, 450 + i * 10, 0, 0)) != 0)))
            goto err;
        BN_set_negative(a, rand_neg());
        BN_set_negative(b, rand_neg());
        if (!(test_true("../test/bntest.c", 410, "BN_mod(c, a, b, ctx)", (BN_div(
# 410 "../test/bntest.c" 3 4
             ((void *)0)
# 410 "../test/bntest.c"
             ,(c),(a),(b),(ctx))) != 0)
                && test_true("../test/bntest.c", 411, "BN_div(d, e, a, b, ctx)", (BN_div(d, e, a, b, ctx)) != 0)
                && test_BN_eq("../test/bntest.c", 412, "e", "c", e, c)
                && test_true("../test/bntest.c", 413, "BN_mul(c, d, b, ctx)", (BN_mul(c, d, b, ctx)) != 0)
                && test_true("../test/bntest.c", 414, "BN_add(d, c, e)", (BN_add(d, c, e)) != 0)
                && test_BN_eq("../test/bntest.c", 415, "d", "a", d, a)))
            goto err;
    }
    st = 1;
 err:
...
# 475 "../test/bntest.c"
                                         ;
    BN_MONT_CTX *mont = 
# 476 "../test/bntest.c" 3 4
                       ((void *)0)
# 476 "../test/bntest.c"
                           ;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 479, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 480, "p = BN_new()", p = BN_new())
            || !test_ptr("../test/bntest.c", 481, "m = BN_new()", m = BN_new())
            || !test_ptr("../test/bntest.c", 482, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 483, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 484, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 485, "n = BN_new()", n = BN_new())
            || !test_ptr("../test/bntest.c", 486, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 487, "mont = BN_MONT_CTX_new()", mont = BN_MONT_CTX_new()))
        goto err;


    if (!(test_true("../test/bntest.c", 491, "BN_bntest_rand(m, 1024, 0, 1)", (BN_bntest_rand(m, 1024, 0, 1)) != 0)

            && test_true("../test/bntest.c", 493, "BN_bntest_rand(a, 1024, 0, 0)", (BN_bntest_rand(a, 1024, 0, 0)) != 0)))
        goto err;
    BN_zero_ex(p);

    if (!test_true("../test/bntest.c", 497, "BN_mod_exp_mont_consttime(d, a, p, m, ctx, NULL)", (BN_mod_exp_mont_consttime(d, a, p, m, ctx, 
# 497 "../test/bntest.c" 3 4
        ((void *)0)
# 497 "../test/bntest.c"
        )) != 0))
        goto err;
    if (!test_BN_eq_one("../test/bntest.c", 499, "d", d))
        goto err;


    if (!(test_true("../test/bntest.c", 503, "BN_hex2bn(&a, \"7878787878787878787878787878787878787878787878787878787878787878\" \"7878787878787878787878787878787878787878787878787878787878787878\" \"7878787878787878787878787878787878787878787878787878787878787878\" \"7878787878787878787878787878787878787878787878787878787878787878\")", (BN_hex2bn(&a, "7878787878787878787878787878787878787878787878787878787878787878" "7878787878787878787878787878787878787878787878787878787878787878" "7878787878787878787878787878787878787878787878787878787878787878" "7878787878787878787878787878787878787878787878787878787878787878")) != 0)




        && test_true("../test/bntest.c", 508, "BN_hex2bn(&b, \"095D72C08C097BA488C5E439C655A192EAFB6380073D8C2664668EDDB4060744\" \"E16E57FB4EDB9AE10A0CEFCDC28A894F689A128379DB279D48A2E20849D68593\" \"9B7803BCF46CEBF5C533FB0DD35B080593DE5472E3FE5DB951B8BFF9B4CB8F03\" \"9CC638A5EE8CDD703719F8000E6A9F63BEED5F2FCD52FF293EA05A251BB4AB81\")", (BN_hex2bn(&b, "095D72C08C097BA488C5E439C655A192EAFB6380073D8C2664668EDDB4060744" "E16E57FB4EDB9AE10A0CEFCDC28A894F689A128379DB279D48A2E20849D68593" "9B7803BCF46CEBF5C533FB0DD35B080593DE5472E3FE5DB951B8BFF9B4CB8F03" "9CC638A5EE8CDD703719F8000E6A9F63BEED5F2FCD52FF293EA05A251BB4AB81")) != 0)




        && test_true("../test/bntest.c", 513, "BN_hex2bn(&n, \"D78AF684E71DB0C39CFF4E64FB9DB567132CB9C50CC98009FEB820B26F2DED9B\" \"91B9B5E2B83AE0AE4EB4E0523CA726BFBE969B89FD754F674CE99118C3F2D1C5\" \"D81FDC7C54E02B60262B241D53C040E99E45826ECA37A804668E690E1AFC1CA4\" \"2C9A15D84D4954425F0B7642FC0BD9D7B24E2618D2DCC9B729D944BADACFDDAF\")", (BN_hex2bn(&n, "D78AF684E71DB0C39CFF4E64FB9DB567132CB9C50CC98009FEB820B26F2DED9B" "91B9B5E2B83AE0AE4EB4E0523CA726BFBE969B89FD754F674CE99118C3F2D1C5" "D81FDC7C54E02B60262B241D53C040E99E45826ECA37A804668E690E1AFC1CA4" "2C9A15D84D4954425F0B7642FC0BD9D7B24E2618D2DCC9B729D944BADACFDDAF")) != 0)
    ...
    if (!(test_true("../test/bntest.c", 520, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)
            && test_true("../test/bntest.c", 521, "BN_mod_mul_montgomery(c, a, b, mont, ctx)", (BN_mod_mul_montgomery(c, a, b, mont, ctx)) != 0)
            && test_true("../test/bntest.c", 522, "BN_mod_mul_montgomery(d, b, a, mont, ctx)", (BN_mod_mul_montgomery(d, b, a, mont, ctx)) != 0)
            && test_BN_eq("../test/bntest.c", 523, "c", "d", c, d)))
        goto err;


    if (!(test_true("../test/bntest.c", 527, "parse_bigBN(&n, bn1strings)", (parse_bigBN(&n, bn1strings)) != 0)
            && test_true("../test/bntest.c", 528, "parse_bigBN(&a, bn2strings)", (parse_bigBN(&a, bn2strings)) != 0)))
        goto err;
    BN_free(b);
    if (!(test_ptr("../test/bntest.c", 531, "b = BN_dup(a)", b = BN_dup(a))
            && test_true("../test/bntest.c", 532, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)
            && test_true("../test/bntest.c", 533, "BN_mod_mul_montgomery(c, a, a, mont, ctx)", (BN_mod_mul_montgomery(c, a, a, mont, ctx)) != 0)
            && test_true("../test/bntest.c", 534, "BN_mod_mul_montgomery(d, a, b, mont, ctx)", (BN_mod_mul_montgomery(d, a, b, mont, ctx)) != 0)
            && test_BN_eq("../test/bntest.c", 535, "c", "d", c, d)))
        goto err;
...
# 568 "../test/bntest.c" 3 4
           ((void *)0)
        
# 569 "../test/bntest.c"
       };

        if (!(test_true("../test/bntest.c", 571, "parse_bigBN(&a, ahex)", (parse_bigBN(&a, ahex)) != 0)
                && test_true("../test/bntest.c", 572, "parse_bigBN(&n, nhex)", (parse_bigBN(&n, nhex)) != 0)))
            goto err;
    }
    BN_free(b);
    if (!(test_ptr("../test/bntest.c", 576, "b = BN_dup(a)", b = BN_dup(a))
            && test_true("../test/bntest.c", 577, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)))
        goto err;

    if (!test_true("../test/bntest.c", 580, "BN_mod_mul_montgomery(c, a, a, mont, ctx)", (BN_mod_mul_montgomery(c, a, a, mont, ctx)) != 0)
            || !test_true("../test/bntest.c", 581, "BN_mod_mul_montgomery(d, a, b, mont, ctx)", (BN_mod_mul_montgomery(d, a, b, mont, ctx)) != 0)
            || !test_BN_eq("../test/bntest.c", 582, "c", "d", c, d))
        goto err;


    if (!(test_true("../test/bntest.c", 586, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")) != 0)



         && test_true("../test/bntest.c", 590, "BN_hex2bn(&n, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\")", (BN_hex2bn(&n, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")) != 0)


        && test_true("../test/bntest.c", 593, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)
        && test_false("../test/bntest.c", 594, "BN_mod_mul_montgomery(d, a, a, mont, ctx)", (BN_mod_mul_montgomery(d, a, a, mont, ctx)) != 0)))
        goto err;


    if (!(test_true("../test/bntest.c", 598, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF")) != 0)




        && test_true("../test/bntest.c", 603, "BN_hex2bn(&b, \"2020202020202020202020202020202020202020202020202020202020202020\" \"2020202020202020202020202020202020202020202020202020202020202020\" \"20202020202020FF202020202020202020202020202020202020202020202020\" \"2020202020202020202020202020202020202020202020202020202020202020\")", (BN_hex2bn(&b, "2020202020202020202020202020202020202020202020202020202020202020" "2020202020202020202020202020202020202020202020202020202020202020" "20202020202020FF202020202020202020202020202020202020202020202020" "2020202020202020202020202020202020202020202020202020202020202020")) != 0)




        && test_true("../test/bntest.c", 608, "BN_hex2bn(&n, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020FF\")", (BN_hex2bn(&n, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020FF")) != 0)




        && test_true("../test/bntest.c", 613, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)
        && test_true("../test/bntest.c", 614, "BN_mod_exp_mont_consttime(c, a, b, n, ctx, mont)", (BN_mod_exp_mont_consttime(c, a, b, n, ctx, mont)) != 0)
        && test_true("../test/bntest.c", 615, "BN_mod_exp_mont(d, a, b, n, ctx, mont)", (BN_mod_exp_mont(d, a, b, n, ctx, mont)) != 0)
        && test_BN_eq("../test/bntest.c", 616, "c", "d", c, d)))
        goto err;
    ...
    if (!(test_true("../test/bntest.c", 623, "BN_hex2bn(&a, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF\")", (BN_hex2bn(&a, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF")) != 0)




        && test_true("../test/bntest.c", 628, "BN_hex2bn(&b, \"1FA53F26F8811C58BE0357897AA5E165693230BC9DF5F01DFA6A2D59229EC69D\" \"9DE6A89C36E3B6957B22D6FAAD5A3C73AE587B710DBE92E83D3A9A3339A085CB\" \"B58F508CA4F837924BB52CC1698B7FDC2FD74362456A595A5B58E38E38E38E38\" \"E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E\")", (BN_hex2bn(&b, "1FA53F26F8811C58BE0357897AA5E165693230BC9DF5F01DFA6A2D59229EC69D" "9DE6A89C36E3B6957B22D6FAAD5A3C73AE587B710DBE92E83D3A9A3339A085CB" "B58F508CA4F837924BB52CC1698B7FDC2FD74362456A595A5B58E38E38E38E38" "E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E38E")) != 0)




        && test_true("../test/bntest.c", 633, "BN_hex2bn(&n, \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\" \"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF\")", (BN_hex2bn(&n, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF2020202020DF")) != 0)




        && test_true("../test/bntest.c", 638, "BN_MONT_CTX_set(mont, n, ctx)", (BN_MONT_CTX_set(mont, n, ctx)) != 0)
        && test_true("../test/bntest.c", 639, "BN_mod_exp_mont_consttime(c, a, b, n, ctx, mont)", (BN_mod_exp_mont_consttime(c, a, b, n, ctx, mont)) != 0)))
        goto err;
    BN_zero_ex(d);
    if (!test_BN_eq("../test/bntest.c", 642, "c", "d", c, d))
        goto err;
...
# 679 "../test/bntest.c" 3 4
           ((void *)0)
# 679 "../test/bntest.c"
               };

        if (!test_true("../test/bntest.c", 681, "parse_bigBN(&e, ehex)", (parse_bigBN(&e, ehex)) != 0)
                || !test_true("../test/bntest.c", 682, "parse_bigBN(&p, phex)", (parse_bigBN(&p, phex)) != 0)
                || !test_true("../test/bntest.c", 683, "parse_bigBN(&m, mhex)", (parse_bigBN(&m, mhex)) != 0)
                || !test_true("../test/bntest.c", 684, "BN_mod_exp_mont_consttime(d, e, p, m, ctx, NULL)", (BN_mod_exp_mont_consttime(d, e, p, m, ctx, 
# 684 "../test/bntest.c" 3 4
                   ((void *)0)
# 684 "../test/bntest.c"
                   )) != 0)
                || !test_true("../test/bntest.c", 685, "BN_mod_exp_simple(a, e, p, m, ctx)", (BN_mod_exp_simple(a, e, p, m, ctx)) != 0)
                || !test_BN_eq("../test/bntest.c", 686, "a", "d", a, d))
            goto err;
    }


    if (!test_true("../test/bntest.c", 691, "BN_bntest_rand(p, 1024, 0, 0)", (BN_bntest_rand(p, 1024, 0, 0)) != 0))
        goto err;
    BN_zero_ex(a);
    if (!test_true("../test/bntest.c", 694, "BN_mod_exp_mont_consttime(d, a, p, m, ctx, NULL)", (BN_mod_exp_mont_consttime(d, a, p, m, ctx, 
# 694 "../test/bntest.c" 3 4
        ((void *)0)
# 694 "../test/bntest.c"
        )) != 0)
            || !test_BN_eq_zero("../test/bntest.c", 695, "d", d))
        goto err;
    ...
    if (!(test_true("../test/bntest.c", 703, "BN_one(a)", ((BN_set_word((a),1))) != 0)
            && test_true("../test/bntest.c", 704, "BN_MONT_CTX_set(mont, m, ctx)", (BN_MONT_CTX_set(mont, m, ctx)) != 0)))
        goto err;
    if (!test_true("../test/bntest.c", 706, "BN_from_montgomery(e, a, mont, ctx)", (BN_from_montgomery(e, a, mont, ctx)) != 0)
            || !test_true("../test/bntest.c", 707, "BN_mod_exp_mont_consttime(d, e, p, m, ctx, NULL)", (BN_mod_exp_mont_consttime(d, e, p, m, ctx, 
# 707 "../test/bntest.c" 3 4
               ((void *)0)
# 707 "../test/bntest.c"
               )) != 0)
            || !test_true("../test/bntest.c", 708, "BN_mod_exp_simple(a, e, p, m, ctx)", (BN_mod_exp_simple(a, e, p, m, ctx)) != 0)
            || !test_BN_eq("../test/bntest.c", 709, "a", "d", a, d))
        goto err;


    if (!(test_true("../test/bntest.c", 713, "BN_bntest_rand(e, 1024, 0, 0)", (BN_bntest_rand(e, 1024, 0, 0)) != 0)
            && test_true("../test/bntest.c", 714, "BN_mod_exp_mont_consttime(d, e, p, m, ctx, NULL)", (BN_mod_exp_mont_consttime(d, e, p, m, ctx, 
# 714 "../test/bntest.c" 3 4
              ((void *)0)
# 714 "../test/bntest.c"
              )) != 0)
            && test_true("../test/bntest.c", 715, "BN_mod_exp_simple(a, e, p, m, ctx)", (BN_mod_exp_simple(a, e, p, m, ctx)) != 0)
            && test_BN_eq("../test/bntest.c", 716, "a", "d", a, d)))
        goto err;
...
# 737 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 740, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 741, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 742, "c = BN_new()", c = BN_new()))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!(test_true("../test/bntest.c", 746, "BN_rand(a, 512, 0, 0)", (BN_rand(a, 512, 0, 0)) != 0)
                && test_ptr("../test/bntest.c", 747, "BN_copy(b, BN_value_one())", BN_copy(b, BN_value_one()))))
            goto err;
        BN_set_negative(a, rand_neg());
        BN_set_negative(b, rand_neg());
        if (!(test_true("../test/bntest.c", 751, "BN_GF2m_add(c, a, b)", (BN_GF2m_add(c, a, b)) != 0)

                && test_false("../test/bntest.c", 753, "(BN_is_odd(a) && BN_is_odd(c)) || (!BN_is_odd(a) && !BN_is_odd(c))", ((BN_is_odd(a) && BN_is_odd(c)) || (!BN_is_odd(a) && !BN_is_odd(c))) != 0)
                                                            ))
            goto err;
        if (!(test_true("../test/bntest.c", 756, "BN_GF2m_add(c, c, c)", (BN_GF2m_add(c, c, c)) != 0)

                && test_BN_eq_zero("../test/bntest.c", 758, "c", c)))
            goto err;
    }
    st = 1;
 err:
...
# 771 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 774, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 775, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 776, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 777, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 778, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 779, "e = BN_new()", e = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 782, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 783, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 787, "BN_bntest_rand(a, 1024, 0, 0)", (BN_bntest_rand(a, 1024, 0, 0)) != 0))
            goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 790, "BN_GF2m_mod(c, a, b[j])", (BN_GF2m_mod(c, a, b[j])) != 0)
                    && test_true("../test/bntest.c", 791, "BN_GF2m_add(d, a, c)", (BN_GF2m_add(d, a, c)) != 0)
                    && test_true("../test/bntest.c", 792, "BN_GF2m_mod(e, d, b[j])", (BN_GF2m_mod(e, d, b[j])) != 0)

                    && test_BN_eq_zero("../test/bntest.c", 794, "e", e)))
                goto err;
        }
    }
    st = 1;
...
# 812 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 815, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 816, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 817, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 818, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 819, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 820, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 821, "f = BN_new()", f = BN_new())
            || !test_ptr("../test/bntest.c", 822, "g = BN_new()", g = BN_new())
            || !test_ptr("../test/bntest.c", 823, "h = BN_new()", h = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 826, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 827, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!(test_true("../test/bntest.c", 831, "BN_bntest_rand(a, 1024, 0, 0)", (BN_bntest_rand(a, 1024, 0, 0)) != 0)
                && test_true("../test/bntest.c", 832, "BN_bntest_rand(c, 1024, 0, 0)", (BN_bntest_rand(c, 1024, 0, 0)) != 0)
                && test_true("../test/bntest.c", 833, "BN_bntest_rand(d, 1024, 0, 0)", (BN_bntest_rand(d, 1024, 0, 0)) != 0)))
            goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 836, "BN_GF2m_mod_mul(e, a, c, b[j], ctx)", (BN_GF2m_mod_mul(e, a, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 837, "BN_GF2m_add(f, a, d)", (BN_GF2m_add(f, a, d)) != 0)
                    && test_true("../test/bntest.c", 838, "BN_GF2m_mod_mul(g, f, c, b[j], ctx)", (BN_GF2m_mod_mul(g, f, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 839, "BN_GF2m_mod_mul(h, d, c, b[j], ctx)", (BN_GF2m_mod_mul(h, d, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 840, "BN_GF2m_add(f, e, g)", (BN_GF2m_add(f, e, g)) != 0)
                    && test_true("../test/bntest.c", 841, "BN_GF2m_add(f, f, h)", (BN_GF2m_add(f, f, h)) != 0)

                    && test_BN_eq_zero("../test/bntest.c", 843, "f", f)))
                goto err;
        }
    }
    st = 1;
...
# 864 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 867, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 868, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 869, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 870, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 871, "d = BN_new()", d = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 874, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 875, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 879, "BN_bntest_rand(a, 1024, 0, 0)", (BN_bntest_rand(a, 1024, 0, 0)) != 0))
                goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 882, "BN_GF2m_mod_sqr(c, a, b[j], ctx)", (BN_GF2m_mod_sqr(c, a, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 883, "BN_copy(d, a)", (BN_copy(d, a)) != 0)
                    && test_true("../test/bntest.c", 884, "BN_GF2m_mod_mul(d, a, d, b[j], ctx)", (BN_GF2m_mod_mul(d, a, d, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 885, "BN_GF2m_add(d, c, d)", (BN_GF2m_add(d, c, d)) != 0)

                    && test_BN_eq_zero("../test/bntest.c", 887, "d", d)))
                goto err;
        }
    }
    st = 1;
...
# 903 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 906, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 907, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 908, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 909, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 910, "d = BN_new()", d = BN_new()))
        goto err;


    if (!test_true("../test/bntest.c", 914, "BN_one(b[0])", ((BN_set_word((b[0]),1))) != 0))
        goto err;
    if (!test_true("../test/bntest.c", 916, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
        goto err;
    if (!test_false("../test/bntest.c", 918, "BN_GF2m_mod_inv(c, a, b[0], ctx)", (BN_GF2m_mod_inv(c, a, b[0], ctx)) != 0))
        goto err;

    if (!(test_true("../test/bntest.c", 921, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 922, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 926, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
            goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 929, "BN_GF2m_mod_inv(c, a, b[j], ctx)", (BN_GF2m_mod_inv(c, a, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 930, "BN_GF2m_mod_mul(d, a, c, b[j], ctx)", (BN_GF2m_mod_mul(d, a, c, b[j], ctx)) != 0)

                    && test_BN_eq_one("../test/bntest.c", 932, "d", d)))
                goto err;
        }
    }
    st = 1;
...
# 949 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 952, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 953, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 954, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 955, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 956, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 957, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 958, "f = BN_new()", f = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 961, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 962, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!(test_true("../test/bntest.c", 966, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0)
                && test_true("../test/bntest.c", 967, "BN_bntest_rand(c, 512, 0, 0)", (BN_bntest_rand(c, 512, 0, 0)) != 0)))
            goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 970, "BN_GF2m_mod_div(d, a, c, b[j], ctx)", (BN_GF2m_mod_div(d, a, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 971, "BN_GF2m_mod_mul(e, d, c, b[j], ctx)", (BN_GF2m_mod_mul(e, d, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 972, "BN_GF2m_mod_div(f, a, e, b[j], ctx)", (BN_GF2m_mod_div(f, a, e, b[j], ctx)) != 0)

                    && test_BN_eq_one("../test/bntest.c", 974, "f", f)))
                goto err;
        }
    }
    st = 1;
...
# 993 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 996, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 997, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 998, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 999, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 1000, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 1001, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 1002, "f = BN_new()", f = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 1005, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 1006, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!(test_true("../test/bntest.c", 1010, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0)
                && test_true("../test/bntest.c", 1011, "BN_bntest_rand(c, 512, 0, 0)", (BN_bntest_rand(c, 512, 0, 0)) != 0)
                && test_true("../test/bntest.c", 1012, "BN_bntest_rand(d, 512, 0, 0)", (BN_bntest_rand(d, 512, 0, 0)) != 0)))
            goto err;
        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 1015, "BN_GF2m_mod_exp(e, a, c, b[j], ctx)", (BN_GF2m_mod_exp(e, a, c, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1016, "BN_GF2m_mod_exp(f, a, d, b[j], ctx)", (BN_GF2m_mod_exp(f, a, d, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1017, "BN_GF2m_mod_mul(e, e, f, b[j], ctx)", (BN_GF2m_mod_mul(e, e, f, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1018, "BN_add(f, c, d)", (BN_add(f, c, d)) != 0)
                    && test_true("../test/bntest.c", 1019, "BN_GF2m_mod_exp(f, a, f, b[j], ctx)", (BN_GF2m_mod_exp(f, a, f, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1020, "BN_GF2m_add(f, e, f)", (BN_GF2m_add(f, e, f)) != 0)

                    && test_BN_eq_zero("../test/bntest.c", 1022, "f", f)))
                goto err;
        }
    }
    st = 1;
...
# 1041 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1044, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 1045, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 1046, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 1047, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 1048, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 1049, "e = BN_new()", e = BN_new())
            || !test_ptr("../test/bntest.c", 1050, "f = BN_new()", f = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 1053, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 1054, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 1058, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
            goto err;

        for (j = 0; j < 2; j++) {
            if (!(test_true("../test/bntest.c", 1062, "BN_GF2m_mod(c, a, b[j])", (BN_GF2m_mod(c, a, b[j])) != 0)
                    && test_true("../test/bntest.c", 1063, "BN_GF2m_mod_sqrt(d, a, b[j], ctx)", (BN_GF2m_mod_sqrt(d, a, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1064, "BN_GF2m_mod_sqr(e, d, b[j], ctx)", (BN_GF2m_mod_sqr(e, d, b[j], ctx)) != 0)
                    && test_true("../test/bntest.c", 1065, "BN_GF2m_add(f, c, e)", (BN_GF2m_add(f, c, e)) != 0)

                    && test_BN_eq_zero("../test/bntest.c", 1067, "f", f)))
                goto err;
        }
    }
    st = 1;
...
# 1085 "../test/bntest.c"
                                                               ;
    BIGNUM *e = 
# 1086 "../test/bntest.c" 3 4
               ((void *)0)
# 1086 "../test/bntest.c"
                   ;
    int i, j, s = 0, t, st = 0;

    if (!test_ptr("../test/bntest.c", 1089, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 1090, "b[0] = BN_new()", b[0] = BN_new())
            || !test_ptr("../test/bntest.c", 1091, "b[1] = BN_new()", b[1] = BN_new())
            || !test_ptr("../test/bntest.c", 1092, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 1093, "d = BN_new()", d = BN_new())
            || !test_ptr("../test/bntest.c", 1094, "e = BN_new()", e = BN_new()))
        goto err;

    if (!(test_true("../test/bntest.c", 1097, "BN_GF2m_arr2poly(p0, b[0])", (BN_GF2m_arr2poly(p0, b[0])) != 0)
            && test_true("../test/bntest.c", 1098, "BN_GF2m_arr2poly(p1, b[1])", (BN_GF2m_arr2poly(p1, b[1])) != 0)))
        goto err;

    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 1102, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
            goto err;
        for (j = 0; j < 2; j++) {
            t = BN_GF2m_mod_solve_quad(c, a, b[j], ctx);
            if (t) {
                s++;
                if (!(test_true("../test/bntest.c", 1108, "BN_GF2m_mod_sqr(d, c, b[j], ctx)", (BN_GF2m_mod_sqr(d, c, b[j], ctx)) != 0)
                        && test_true("../test/bntest.c", 1109, "BN_GF2m_add(d, c, d)", (BN_GF2m_add(d, c, d)) != 0)
                        && test_true("../test/bntest.c", 1110, "BN_GF2m_mod(e, a, b[j])", (BN_GF2m_mod(e, a, b[j])) != 0)
                        && test_true("../test/bntest.c", 1111, "BN_GF2m_add(e, e, d)", (BN_GF2m_add(e, e, d)) != 0)




                        && test_BN_eq_zero("../test/bntest.c", 1116, "e", e)))
                    goto err;
            }
        }
    }
    if (!test_int_ge("../test/bntest.c", 1121, "s", "0", s, 0)) {
        test_info("../test/bntest.c", 1122, "%d tests found no roots; probably an error", NUM0);
        goto err;
    }
    st = 1;
 err:
...
# 1139 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1142, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 1143, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 1144, "r = BN_new()", r = BN_new())
            || !test_ptr("../test/bntest.c", 1145, "t = BN_new()", t = BN_new()))
        goto err;
# 1158 "../test/bntest.c"
    if (!test_true("../test/bntest.c", 1158, "BN_generate_prime_ex(b, 512, 0, NULL, NULL, NULL)", (BN_generate_prime_ex(b, 512, 0, 
# 1158 "../test/bntest.c" 3 4
        ((void *)0)
# 1158 "../test/bntest.c"
        , 
# 1158 "../test/bntest.c" 3 4
...
# 1158 "../test/bntest.c"
    ...
    for (i = 0; i < NUM0; i++) {
        if (!test_true("../test/bntest.c", 1163, "BN_bntest_rand(a, 512, 0, 0)", (BN_bntest_rand(a, 512, 0, 0)) != 0))
            goto err;
        BN_set_negative(a, rand_neg());


        if (!test_true("../test/bntest.c", 1168, "BN_copy(t, b)", (BN_copy(t, b)) != 0))
            goto err;
        BN_set_negative(t, 0);
        if (!test_true("../test/bntest.c", 1171, "BN_sub_word(t, 1)", (BN_sub_word(t, 1)) != 0))
            goto err;
        if (!test_true("../test/bntest.c", 1173, "BN_rshift1(t, t)", (BN_rshift1(t, t)) != 0))
            goto err;

        BN_set_negative(b, 0);

        if (!test_true("../test/bntest.c", 1178, "BN_mod_exp_recp(r, a, t, b, ctx)", (BN_mod_exp_recp(r, a, t, b, ctx)) != 0))
            goto err;
        BN_set_negative(b, 1);
        ...
        if (BN_is_word(r, 1))
            ...
            if (!test_true("../test/bntest.c", 1187, "BN_add_word(r, 1)", (BN_add_word(r, 1)) != 0))
                goto err;
            if (!test_int_eq("../test/bntest.c", 1189, "BN_ucmp(r, b)", "0", BN_ucmp(r, b), 0)) {
                test_info("../test/bntest.c", 1190, "Legendre symbol computation failed");
                goto err;
            }
            legendre = -1;
        }

        if (!test_int_ge("../test/bntest.c", 1196, "kronecker = BN_kronecker(a, b, ctx)", "-1", kronecker = BN_kronecker(a, b, ctx), -1))
            goto err;

        if (BN_is_negative(a) && BN_is_negative(b))
            kronecker = -kronecker;

        if (!test_int_eq("../test/bntest.c", 1202, "legendre", "kronecker", legendre, kronecker))
            goto err;
    }
...
# 1217 "../test/bntest.c"
                                                        ;
    unsigned long b_word;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 1221, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1222, "b = getBN(s, \"B\")", b = getBN(s, "B"))
            || !test_ptr("../test/bntest.c", 1223, "sum = getBN(s, \"Sum\")", sum = getBN(s, "Sum"))
            || !test_ptr("../test/bntest.c", 1224, "ret = BN_new()", ret = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1227, "BN_add(ret, a, b)", (BN_add(ret, a, b)) != 0)
            || !equalBN("A + B", sum, ret)
            || !test_true("../test/bntest.c", 1229, "BN_sub(ret, sum, a)", (BN_sub(ret, sum, a)) != 0)
            || !equalBN("Sum - A", b, ret)
            || !test_true("../test/bntest.c", 1231, "BN_sub(ret, sum, b)", (BN_sub(ret, sum, b)) != 0)
            || !equalBN("Sum - B", a, ret))
        goto err;
    ...
    if (!test_true("../test/bntest.c", 1240, "BN_copy(ret, a)", (BN_copy(ret, a)) != 0)
            || !test_true("../test/bntest.c", 1241, "BN_add(ret, ret, b)", (BN_add(ret, ret, b)) != 0)
            || !equalBN("A + B (r is a)", sum, ret)
            || !test_true("../test/bntest.c", 1243, "BN_copy(ret, b)", (BN_copy(ret, b)) != 0)
            || !test_true("../test/bntest.c", 1244, "BN_add(ret, a, ret)", (BN_add(ret, a, ret)) != 0)
            || !equalBN("A + B (r is b)", sum, ret)
            || !test_true("../test/bntest.c", 1246, "BN_copy(ret, sum)", (BN_copy(ret, sum)) != 0)
            || !test_true("../test/bntest.c", 1247, "BN_sub(ret, ret, a)", (BN_sub(ret, ret, a)) != 0)
            || !equalBN("Sum - A (r is a)", b, ret)
            || !test_true("../test/bntest.c", 1249, "BN_copy(ret, a)", (BN_copy(ret, a)) != 0)
            || !test_true("../test/bntest.c", 1250, "BN_sub(ret, sum, ret)", (BN_sub(ret, sum, ret)) != 0)
            || !equalBN("Sum - A (r is b)", b, ret)
            || !test_true("../test/bntest.c", 1252, "BN_copy(ret, sum)", (BN_copy(ret, sum)) != 0)
            || !test_true("../test/bntest.c", 1253, "BN_sub(ret, ret, b)", (BN_sub(ret, ret, b)) != 0)
            || !equalBN("Sum - B (r is a)", a, ret)
            || !test_true("../test/bntest.c", 1255, "BN_copy(ret, b)", (BN_copy(ret, b)) != 0)
            || !test_true("../test/bntest.c", 1256, "BN_sub(ret, sum, ret)", (BN_sub(ret, sum, ret)) != 0)
    ...
    if (!BN_is_negative(a) && !BN_is_negative(b) && BN_cmp(a, b) >= 0) {
        if (!test_true("../test/bntest.c", 1267, "BN_uadd(ret, a, b)", (BN_uadd(ret, a, b)) != 0)
                || !equalBN("A +u B", sum, ret)
                || !test_true("../test/bntest.c", 1269, "BN_usub(ret, sum, a)", (BN_usub(ret, sum, a)) != 0)
                || !equalBN("Sum -u A", b, ret)
                || !test_true("../test/bntest.c", 1271, "BN_usub(ret, sum, b)", (BN_usub(ret, sum, b)) != 0)
        ...
        if (!test_true("../test/bntest.c", 1280, "BN_copy(ret, a)", (BN_copy(ret, a)) != 0)
                || !test_true("../test/bntest.c", 1281, "BN_uadd(ret, ret, b)", (BN_uadd(ret, ret, b)) != 0)
                || !equalBN("A +u B (r is a)", sum, ret)
                || !test_true("../test/bntest.c", 1283, "BN_copy(ret, b)", (BN_copy(ret, b)) != 0)
                || !test_true("../test/bntest.c", 1284, "BN_uadd(ret, a, ret)", (BN_uadd(ret, a, ret)) != 0)
                || !equalBN("A +u B (r is b)", sum, ret)
                || !test_true("../test/bntest.c", 1286, "BN_copy(ret, sum)", (BN_copy(ret, sum)) != 0)
                || !test_true("../test/bntest.c", 1287, "BN_usub(ret, ret, a)", (BN_usub(ret, ret, a)) != 0)
                || !equalBN("Sum -u A (r is a)", b, ret)
                || !test_true("../test/bntest.c", 1289, "BN_copy(ret, a)", (BN_copy(ret, a)) != 0)
                || !test_true("../test/bntest.c", 1290, "BN_usub(ret, sum, ret)", (BN_usub(ret, sum, ret)) != 0)
                || !equalBN("Sum -u A (r is b)", b, ret)
                || !test_true("../test/bntest.c", 1292, "BN_copy(ret, sum)", (BN_copy(ret, sum)) != 0)
                || !test_true("../test/bntest.c", 1293, "BN_usub(ret, ret, b)", (BN_usub(ret, ret, b)) != 0)
                || !equalBN("Sum -u B (r is a)", a, ret)
                || !test_true("../test/bntest.c", 1295, "BN_copy(ret, b)", (BN_copy(ret, b)) != 0)
                || !test_true("../test/bntest.c", 1296, "BN_usub(ret, sum, ret)", (BN_usub(ret, sum, ret)) != 0)
    ...
    if (!BN_is_negative(b) && b_word != (unsigned long)-1) {
        if (!test_true("../test/bntest.c", 1306, "BN_copy(ret, a)", (BN_copy(ret, a)) != 0)
                || !test_true("../test/bntest.c", 1307, "BN_add_word(ret, b_word)", (BN_add_word(ret, b_word)) != 0)
                || !equalBN("A + B (word)", sum, ret)
                || !test_true("../test/bntest.c", 1309, "BN_copy(ret, sum)", (BN_copy(ret, sum)) != 0)
                || !test_true("../test/bntest.c", 1310, "BN_sub_word(ret, b_word)", (BN_sub_word(ret, b_word)) != 0)
...
# 1327 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1330, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1331, "lshift1 = getBN(s, \"LShift1\")", lshift1 = getBN(s, "LShift1"))
            || !test_ptr("../test/bntest.c", 1332, "zero = BN_new()", zero = BN_new())
            || !test_ptr("../test/bntest.c", 1333, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1334, "two = BN_new()", two = BN_new())
            || !test_ptr("../test/bntest.c", 1335, "remainder = BN_new()", remainder = BN_new()))
        goto err;

    BN_zero_ex(zero);

    if (!test_true("../test/bntest.c", 1340, "BN_set_word(two, 2)", (BN_set_word(two, 2)) != 0)
            || !test_true("../test/bntest.c", 1341, "BN_add(ret, a, a)", (BN_add(ret, a, a)) != 0)
            || !equalBN("A + A", lshift1, ret)
            || !test_true("../test/bntest.c", 1343, "BN_mul(ret, a, two, ctx)", (BN_mul(ret, a, two, ctx)) != 0)
            || !equalBN("A * 2", lshift1, ret)
            || !test_true("../test/bntest.c", 1345, "BN_div(ret, remainder, lshift1, two, ctx)", (BN_div(ret, remainder, lshift1, two, ctx)) != 0)
            || !equalBN("LShift1 / 2", a, ret)
            || !equalBN("LShift1 % 2", zero, remainder)
            || !test_true("../test/bntest.c", 1348, "BN_lshift1(ret, a)", (BN_lshift1(ret, a)) != 0)
            || !equalBN("A << 1", lshift1, ret)
            || !test_true("../test/bntest.c", 1350, "BN_rshift1(ret, lshift1)", (BN_rshift1(ret, lshift1)) != 0)
            || !equalBN("LShift >> 1", a, ret)
            || !test_true("../test/bntest.c", 1352, "BN_rshift1(ret, lshift1)", (BN_rshift1(ret, lshift1)) != 0)
            || !equalBN("LShift >> 1", a, ret))
        goto err;


    if (!test_true("../test/bntest.c", 1357, "BN_set_bit(lshift1, 0)", (BN_set_bit(lshift1, 0)) != 0)
            || !test_true("../test/bntest.c", 1358, "BN_div(ret, NULL , lshift1, two, ctx)", (BN_div(ret, 
# 1358 "../test/bntest.c" 3 4
               ((void *)0) 
# 1358 "../test/bntest.c"
               , lshift1, two, ctx)) != 0)
            || !equalBN("(LShift1 | 1) / 2", a, ret)
            || !test_true("../test/bntest.c", 1360, "BN_rshift1(ret, lshift1)", (BN_rshift1(ret, lshift1)) != 0)
...
# 1378 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1381, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1382, "lshift = getBN(s, \"LShift\")", lshift = getBN(s, "LShift"))
            || !test_ptr("../test/bntest.c", 1383, "ret = BN_new()", ret = BN_new())
            || !getint(s, &n, "N"))
        goto err;

    if (!test_true("../test/bntest.c", 1387, "BN_lshift(ret, a, n)", (BN_lshift(ret, a, n)) != 0)
            || !equalBN("A << N", lshift, ret)
            || !test_true("../test/bntest.c", 1389, "BN_rshift(ret, lshift, n)", (BN_rshift(ret, lshift, n)) != 0)
            || !equalBN("A >> N", a, ret))
        goto err;
...
# 1403 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1406, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1407, "rshift = getBN(s, \"RShift\")", rshift = getBN(s, "RShift"))
            || !test_ptr("../test/bntest.c", 1408, "ret = BN_new()", ret = BN_new())
            || !getint(s, &n, "N"))
        goto err;

    if (!test_true("../test/bntest.c", 1412, "BN_rshift(ret, a, n)", (BN_rshift(ret, a, n)) != 0)
            || !equalBN("A >> N", rshift, ret))
        goto err;


    if (n == 1) {
        if (!test_true("../test/bntest.c", 1418, "BN_rshift1(ret, a)", (BN_rshift1(ret, a)) != 0)
...
# 1434 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1437, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1438, "square = getBN(s, \"Square\")", square = getBN(s, "Square"))
            || !test_ptr("../test/bntest.c", 1439, "zero = BN_new()", zero = BN_new())
            || !test_ptr("../test/bntest.c", 1440, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1441, "remainder = BN_new()", remainder = BN_new()))
        goto err;

    BN_zero_ex(zero);
    if (!test_true("../test/bntest.c", 1445, "BN_sqr(ret, a, ctx)", (BN_sqr(ret, a, ctx)) != 0)
            || !equalBN("A^2", square, ret)
            || !test_true("../test/bntest.c", 1447, "BN_mul(ret, a, a, ctx)", (BN_mul(ret, a, a, ctx)) != 0)
            || !equalBN("A * A", square, ret)
            || !test_true("../test/bntest.c", 1449, "BN_div(ret, remainder, square, a, ctx)", (BN_div(ret, remainder, square, a, ctx)) != 0)
...
# 1494 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1497, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1498, "b = getBN(s, \"B\")", b = getBN(s, "B"))
            || !test_ptr("../test/bntest.c", 1499, "product = getBN(s, \"Product\")", product = getBN(s, "Product"))
            || !test_ptr("../test/bntest.c", 1500, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1501, "remainder = BN_new()", remainder = BN_new())
            || !test_ptr("../test/bntest.c", 1502, "zero = BN_new()", zero = BN_new()))
        goto err;

    BN_zero_ex(zero);

    if (!test_true("../test/bntest.c", 1507, "BN_mul(ret, a, b, ctx)", (BN_mul(ret, a, b, ctx)) != 0)
            || !equalBN("A * B", product, ret)
            || !test_true("../test/bntest.c", 1509, "BN_div(ret, remainder, product, a, ctx)", (BN_div(ret, remainder, product, a, ctx)) != 0)
            || !equalBN("Product / A", b, ret)
            || !equalBN("Product % A", zero, remainder)
            || !test_true("../test/bntest.c", 1512, "BN_div(ret, remainder, product, b, ctx)", (BN_div(ret, remainder, product, b, ctx)) != 0)
...
# 1531 "../test/bntest.c"
                                                  ;
    unsigned long b_word, ret_word;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 1535, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1536, "b = getBN(s, \"B\")", b = getBN(s, "B"))
            || !test_ptr("../test/bntest.c", 1537, "quotient = getBN(s, \"Quotient\")", quotient = getBN(s, "Quotient"))
            || !test_ptr("../test/bntest.c", 1538, "remainder = getBN(s, \"Remainder\")", remainder = getBN(s, "Remainder"))
            || !test_ptr("../test/bntest.c", 1539, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1540, "ret2 = BN_new()", ret2 = BN_new())
            || !test_ptr("../test/bntest.c", 1541, "nnmod = BN_new()", nnmod = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1544, "BN_div(ret, ret2, a, b, ctx)", (BN_div(ret, ret2, a, b, ctx)) != 0)
            || !equalBN("A / B", quotient, ret)
            || !equalBN("A % B", remainder, ret2)
            || !test_true("../test/bntest.c", 1547, "BN_mul(ret, quotient, b, ctx)", (BN_mul(ret, quotient, b, ctx)) != 0)
            || !test_true("../test/bntest.c", 1548, "BN_add(ret, ret, remainder)", (BN_add(ret, ret, remainder)) != 0)
    ...
    b_word = BN_get_word(b);
    if (!BN_is_negative(b) && b_word != (unsigned long)-1) {
        unsigned long remainder_word = BN_get_word(remainder);

        
# 1560 "../test/bntest.c" 3 4
       ((void) (0))
# 1560 "../test/bntest.c"
                                             ;
        if (!test_ptr("../test/bntest.c", 1561, "BN_copy(ret, a)", BN_copy(ret, a)))
            goto err;
        ...
        if (ret_word != remainder_word) {
            ...
            test_error("../test/bntest.c", 1570, "Got A %% B (word) mismatch");
        ...
        if (ret_word != remainder_word) {
            ...
            test_error("../test/bntest.c", 1584, "Got A %% B (word) mismatch");
    ...
    if (!BN_is_negative(b)) {
        if (!test_true("../test/bntest.c", 1592, "BN_copy(nnmod, remainder)", (BN_copy(nnmod, remainder)) != 0)
                || (BN_is_negative(nnmod)
                        && !test_true("../test/bntest.c", 1594, "BN_add(nnmod, nnmod, b)", (BN_add(nnmod, nnmod, b)) != 0))
                || !test_true("../test/bntest.c", 1595, "BN_nnmod(ret, a, b, ctx)", (BN_nnmod(ret, a, b, ctx)) != 0)
...
# 1614 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1617, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1618, "b = getBN(s, \"B\")", b = getBN(s, "B"))
            || !test_ptr("../test/bntest.c", 1619, "m = getBN(s, \"M\")", m = getBN(s, "M"))
            || !test_ptr("../test/bntest.c", 1620, "mod_mul = getBN(s, \"ModMul\")", mod_mul = getBN(s, "ModMul"))
            || !test_ptr("../test/bntest.c", 1621, "ret = BN_new()", ret = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1624, "BN_mod_mul(ret, a, b, m, ctx)", (BN_mod_mul(ret, a, b, m, ctx)) != 0)
...
# 1635 "../test/bntest.c"
               || !test_true("../test/bntest.c", 1635, "BN_MONT_CTX_set(mont, m, ctx)", (BN_MONT_CTX_set(mont, m, ctx)) != 0)
                || !test_true("../test/bntest.c", 1636, "BN_nnmod(a_tmp, a, m, ctx)", (BN_nnmod(a_tmp, a, m, ctx)) != 0)
                || !test_true("../test/bntest.c", 1637, "BN_nnmod(b_tmp, b, m, ctx)", (BN_nnmod(b_tmp, b, m, ctx)) != 0)
                || !test_true("../test/bntest.c", 1638, "BN_to_montgomery(a_tmp, a_tmp, mont, ctx)", (BN_to_montgomery(a_tmp, a_tmp, mont, ctx)) != 0)
                || !test_true("../test/bntest.c", 1639, "BN_to_montgomery(b_tmp, b_tmp, mont, ctx)", (BN_to_montgomery(b_tmp, b_tmp, mont, ctx)) != 0)
                || !test_true("../test/bntest.c", 1640, "BN_mod_mul_montgomery(ret, a_tmp, b_tmp, mont, ctx)", (BN_mod_mul_montgomery(ret, a_tmp, b_tmp, mont, ctx)) != 0)

                || !test_true("../test/bntest.c", 1642, "BN_from_montgomery(ret, ret, mont, ctx)", (BN_from_montgomery(ret, ret, mont, ctx)) != 0)
...
# 1667 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1670, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1671, "e = getBN(s, \"E\")", e = getBN(s, "E"))
            || !test_ptr("../test/bntest.c", 1672, "m = getBN(s, \"M\")", m = getBN(s, "M"))
            || !test_ptr("../test/bntest.c", 1673, "mod_exp = getBN(s, \"ModExp\")", mod_exp = getBN(s, "ModExp"))
            || !test_ptr("../test/bntest.c", 1674, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1675, "d = BN_new()", d = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1678, "BN_mod_exp(ret, a, e, m, ctx)", (BN_mod_exp(ret, a, e, m, ctx)) != 0)
            || !equalBN("A ^ E (mod M)", mod_exp, ret))
        goto err;

    if (BN_is_odd(m)) {
        if (!test_true("../test/bntest.c", 1683, "BN_mod_exp_mont(ret, a, e, m, ctx, NULL)", (BN_mod_exp_mont(ret, a, e, m, ctx, 
# 1683 "../test/bntest.c" 3 4
            ((void *)0)
# 1683 "../test/bntest.c"
            )) != 0)
                || !equalBN("A ^ E (mod M) (mont)", mod_exp, ret)
                || !test_true("../test/bntest.c", 1685, "BN_mod_exp_mont_consttime(ret, a, e, m, ctx, NULL)", (BN_mod_exp_mont_consttime(ret, a, e, m, ctx, 
# 1685 "../test/bntest.c" 3 4
                   ((void *)0)
# 1685 "../test/bntest.c"
                   )) != 0)
    ...
    if (!test_true("../test/bntest.c", 1701, "BN_mod_exp(d, a, b, c, ctx)", (BN_mod_exp(d, a, b, c, ctx)) != 0)
        || !test_true("../test/bntest.c", 1702, "BN_mul(e, a, a, ctx)", (BN_mul(e, a, a, ctx)) != 0)
        || !test_BN_eq("../test/bntest.c", 1703, "d", "e", d, e))
        goto err;
...
# 1721 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1724, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1725, "e = getBN(s, \"E\")", e = getBN(s, "E"))
            || !test_ptr("../test/bntest.c", 1726, "exp = getBN(s, \"Exp\")", exp = getBN(s, "Exp"))
            || !test_ptr("../test/bntest.c", 1727, "ret = BN_new()", ret = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1730, "BN_exp(ret, a, e, ctx)", (BN_exp(ret, a, e, ctx)) != 0)
            || !equalBN("A ^ E", exp, ret))
        goto err;
...
# 1745 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1748, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1749, "p = getBN(s, \"P\")", p = getBN(s, "P"))
            || !test_ptr("../test/bntest.c", 1750, "mod_sqrt = getBN(s, \"ModSqrt\")", mod_sqrt = getBN(s, "ModSqrt"))
            || !test_ptr("../test/bntest.c", 1751, "ret = BN_new()", ret = BN_new())
            || !test_ptr("../test/bntest.c", 1752, "ret2 = BN_new()", ret2 = BN_new()))
        goto err;

    if (BN_is_negative(mod_sqrt)) {

        if (!test_ptr_null("../test/bntest.c", 1757, "BN_mod_sqrt(ret, a, p, ctx)", BN_mod_sqrt(ret, a, p, ctx)))
            goto err;
    ...
    if (!test_ptr("../test/bntest.c", 1765, "BN_mod_sqrt(ret, a, p, ctx)", BN_mod_sqrt(ret, a, p, ctx))
            || !test_true("../test/bntest.c", 1766, "BN_sub(ret2, p, ret)", (BN_sub(ret2, p, ret)) != 0))
        goto err;
...
# 1786 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1789, "a = getBN(s, \"A\")", a = getBN(s, "A"))
            || !test_ptr("../test/bntest.c", 1790, "b = getBN(s, \"B\")", b = getBN(s, "B"))
            || !test_ptr("../test/bntest.c", 1791, "gcd = getBN(s, \"GCD\")", gcd = getBN(s, "GCD"))
            || !test_ptr("../test/bntest.c", 1792, "ret = BN_new()", ret = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 1795, "BN_gcd(ret, a, b, ctx)", (BN_gcd(ret, a, b, ctx)) != 0)
...
static int test_bn2padded(void)
{
    ...
    if (!test_ptr("../test/bntest.c", 1816, "(n = BN_new())", (n = BN_new())))
        goto err;
    if (!test_int_eq("../test/bntest.c", 1818, "BN_bn2binpad(n, NULL, 0)", "0", BN_bn2binpad(n, 
# 1818 "../test/bntest.c" 3 4
        ((void *)0)
# 1818 "../test/bntest.c"
        , 0), 0))
        goto err;
    memset(out, -1, sizeof(out));
    if (!test_int_eq("../test/bntest.c", 1821, "BN_bn2binpad(n, out, sizeof(out))", "sizeof(out)", BN_bn2binpad(n, out, sizeof(out)), sizeof(out)))
        goto err;
    memset(zeros, 0, sizeof(zeros));
    if (!test_mem_eq("../test/bntest.c", 1824, "zeros", "out", zeros, sizeof(zeros), out, sizeof(out)))
        goto err;
    ...
    for (bytes = 128 - 7; bytes <= 128; bytes++) {
        ...
        if (!test_true("../test/bntest.c", 1831, "BN_rand(n, bytes * 8, TOP_BIT_ON, BOTTOM_BIT_NOTOUCH)", (BN_rand(n, bytes * 8, 0, 0)) != 0))
            goto err;
        if (!test_int_eq("../test/bntest.c", 1833, "BN_num_bytes(n)", "bytes", ((BN_num_bits(n)+7)/8), bytes)
                || !test_int_eq("../test/bntest.c", 1834, "BN_bn2bin(n, reference)", "bytes", BN_bn2bin(n, reference), bytes))
            goto err;

        if (!test_int_eq("../test/bntest.c", 1837, "BN_bn2binpad(n, NULL, 0)", "-1", BN_bn2binpad(n, 
# 1837 "../test/bntest.c" 3 4
            ((void *)0)
# 1837 "../test/bntest.c"
            , 0), -1))
            goto err;

        if (!test_int_eq("../test/bntest.c", 1840, "BN_bn2binpad(n, out, bytes - 1)", "-1", BN_bn2binpad(n, out, bytes - 1), -1))
            goto err;

        if (!test_int_eq("../test/bntest.c", 1843, "BN_bn2binpad(n, out, bytes)", "bytes", BN_bn2binpad(n, out, bytes), bytes)
                || !test_mem_eq("../test/bntest.c", 1844, "out", "reference", out, bytes, reference, bytes))
            goto err;

        if (!test_int_eq("../test/bntest.c", 1847, "BN_bn2binpad(n, out, bytes + 1)", "bytes + 1", BN_bn2binpad(n, out, bytes + 1), bytes + 1)
                || !test_mem_eq("../test/bntest.c", 1848, "out + 1", "reference", out + 1, bytes, reference, bytes)
                || !test_mem_eq("../test/bntest.c", 1849, "out", "zeros", out, 1, zeros, 1))
            goto err;

        if (!test_int_eq("../test/bntest.c", 1852, "BN_bn2binpad(n, out, sizeof(out))", "sizeof(out)", BN_bn2binpad(n, out, sizeof(out)), sizeof(out))
                || !test_mem_eq("../test/bntest.c", 1853, "out + sizeof(out) - bytes", "reference", out + sizeof(out) - bytes, bytes, reference, bytes)

                || !test_mem_eq("../test/bntest.c", 1855, "out", "zeros", out, sizeof(out) - bytes, zeros, sizeof(out) - bytes)
                                                           )
            goto err;
    }
...
# 1932 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 1935, "bn = BN_new()", bn = BN_new())
        || !test_true("../test/bntest.c", 1936, "BN_asc2bn(&bn, test->base10)", (BN_asc2bn(&bn, test->base10)) != 0))
        goto err;
    ...
    if (!test_int_eq("../test/bntest.c", 1945, "BN_signed_bn2bin(bn, scratch, sizeof(scratch))", "sizeof(scratch)", BN_signed_bn2bin(bn, scratch, sizeof(scratch)), sizeof(scratch))

        || !test_true("../test/bntest.c", 1947, "copy_reversed(reversed, scratch, sizeof(scratch))", (copy_reversed(reversed, scratch, sizeof(scratch))) != 0)
        || !test_mem_eq("../test/bntest.c", 1948, "test->mpi", "scratch + i", test->mpi, test->mpi_len, scratch + i, test->mpi_len))
        goto err;

    if (!test_ptr("../test/bntest.c", 1951, "bn2 = BN_signed_bin2bn(scratch, sizeof(scratch), NULL)", bn2 = BN_signed_bin2bn(scratch, sizeof(scratch), 
# 1951 "../test/bntest.c" 3 4
        ((void *)0)
# 1951 "../test/bntest.c"
        ))
        || !test_BN_eq("../test/bntest.c", 1952, "bn", "bn2", bn, bn2))
        goto err;

    BN_free(bn2);
    bn2 = 
# 1956 "../test/bntest.c" 3 4
         ((void *)0)
# 1956 "../test/bntest.c"
             ;


    if (!test_ptr("../test/bntest.c", 1959, "bn2 = BN_signed_lebin2bn(reversed, sizeof(reversed), NULL)", bn2 = BN_signed_lebin2bn(reversed, sizeof(reversed), 
# 1959 "../test/bntest.c" 3 4
        ((void *)0)
# 1959 "../test/bntest.c"
        ))
        || !test_BN_eq("../test/bntest.c", 1960, "bn", "bn2", bn, bn2))
        goto err;

    BN_free(bn2);
    bn2 = 
# 1964 "../test/bntest.c" 3 4
         ((void *)0)
# 1964 "../test/bntest.c"
             ;
    ...
    if (!test_int_eq("../test/bntest.c", 1972, "BN_signed_bn2lebin(bn, scratch, sizeof(scratch))", "sizeof(scratch)", BN_signed_bn2lebin(bn, scratch, sizeof(scratch)), sizeof(scratch))

        || !test_true("../test/bntest.c", 1974, "copy_reversed(reversed, scratch, sizeof(scratch))", (copy_reversed(reversed, scratch, sizeof(scratch))) != 0)
        || !test_mem_eq("../test/bntest.c", 1975, "test->mpi", "reversed + i", test->mpi, test->mpi_len, reversed + i, test->mpi_len))
        goto err;

    if (!test_ptr("../test/bntest.c", 1978, "bn2 = BN_signed_lebin2bn(scratch, sizeof(scratch), NULL)", bn2 = BN_signed_lebin2bn(scratch, sizeof(scratch), 
# 1978 "../test/bntest.c" 3 4
        ((void *)0)
# 1978 "../test/bntest.c"
        ))
        || !test_BN_eq("../test/bntest.c", 1979, "bn", "bn2", bn, bn2))
        goto err;

    BN_free(bn2);
    bn2 = 
# 1983 "../test/bntest.c" 3 4
         ((void *)0)
# 1983 "../test/bntest.c"
             ;


    if (!test_ptr("../test/bntest.c", 1986, "bn2 = BN_signed_bin2bn(reversed, sizeof(reversed), NULL)", bn2 = BN_signed_bin2bn(reversed, sizeof(reversed), 
# 1986 "../test/bntest.c" 3 4
        ((void *)0)
# 1986 "../test/bntest.c"
        ))
        || !test_BN_eq("../test/bntest.c", 1987, "bn", "bn2", bn, bn2))
        goto err;
...
{
    BIGNUM *bn = 
# 1999 "../test/bntest.c" 3 4
                ((void *)0)
# 1999 "../test/bntest.c"
                    ;
    int st = 0;

    if (!test_int_eq("../test/bntest.c", 2002, "parsedecBN(&bn, \"0\")", "1", parsedecBN(&bn, "0"), 1)
            || !test_BN_eq_word("../test/bntest.c", 2003, "bn", "0", bn, 0)
            || !test_BN_eq_zero("../test/bntest.c", 2004, "bn", bn)
            || !test_BN_le_zero("../test/bntest.c", 2005, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2006, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2007, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2010 "../test/bntest.c" 3 4
        ((void *)0)
# 2010 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2012, "parsedecBN(&bn, \"256\")", "3", parsedecBN(&bn, "256"), 3)
            || !test_BN_eq_word("../test/bntest.c", 2013, "bn", "256", bn, 256)
            || !test_BN_ge_zero("../test/bntest.c", 2014, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2015, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2016, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2017, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2020 "../test/bntest.c" 3 4
        ((void *)0)
# 2020 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2022, "parsedecBN(&bn, \"-42\")", "3", parsedecBN(&bn, "-42"), 3)
            || !test_BN_abs_eq_word("../test/bntest.c", 2023, "bn", "42", bn, 42)
            || !test_BN_lt_zero("../test/bntest.c", 2024, "bn", bn)
            || !test_BN_le_zero("../test/bntest.c", 2025, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2026, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2027, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2030 "../test/bntest.c" 3 4
        ((void *)0)
# 2030 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2032, "parsedecBN(&bn, \"1\")", "1", parsedecBN(&bn, "1"), 1)
            || !test_BN_eq_word("../test/bntest.c", 2033, "bn", "1", bn, 1)
            || !test_BN_ne_zero("../test/bntest.c", 2034, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2035, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2036, "bn", bn)
            || !test_BN_eq_one("../test/bntest.c", 2037, "bn", bn)
            || !test_BN_odd("../test/bntest.c", 2038, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2041 "../test/bntest.c" 3 4
        ((void *)0)
# 2041 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2043, "parsedecBN(&bn, \"-0\")", "2", parsedecBN(&bn, "-0"), 2)
            || !test_BN_eq_zero("../test/bntest.c", 2044, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2045, "bn", bn)
            || !test_BN_le_zero("../test/bntest.c", 2046, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2047, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2050 "../test/bntest.c" 3 4
        ((void *)0)
# 2050 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2052, "parsedecBN(&bn, \"42trailing garbage is ignored\")", "2", parsedecBN(&bn, "42trailing garbage is ignored"), 2)
            || !test_BN_abs_eq_word("../test/bntest.c", 2053, "bn", "42", bn, 42)
            || !test_BN_ge_zero("../test/bntest.c", 2054, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2055, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2056, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2057, "bn", bn))
        goto err;
...
{
    BIGNUM *bn = 
# 2068 "../test/bntest.c" 3 4
                ((void *)0)
# 2068 "../test/bntest.c"
                    ;
    int st = 0;

    if (!test_int_eq("../test/bntest.c", 2071, "parseBN(&bn, \"0\")", "1", parseBN(&bn, "0"), 1)
            || !test_BN_eq_zero("../test/bntest.c", 2072, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2073, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2074, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2077 "../test/bntest.c" 3 4
        ((void *)0)
# 2077 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2079, "parseBN(&bn, \"256\")", "3", parseBN(&bn, "256"), 3)
            || !test_BN_eq_word("../test/bntest.c", 2080, "bn", "0x256", bn, 0x256)
            || !test_BN_ge_zero("../test/bntest.c", 2081, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2082, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2083, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2084, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2087 "../test/bntest.c" 3 4
        ((void *)0)
# 2087 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2089, "parseBN(&bn, \"-42\")", "3", parseBN(&bn, "-42"), 3)
            || !test_BN_abs_eq_word("../test/bntest.c", 2090, "bn", "0x42", bn, 0x42)
            || !test_BN_lt_zero("../test/bntest.c", 2091, "bn", bn)
            || !test_BN_le_zero("../test/bntest.c", 2092, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2093, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2094, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2097 "../test/bntest.c" 3 4
        ((void *)0)
# 2097 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2099, "parseBN(&bn, \"cb\")", "2", parseBN(&bn, "cb"), 2)
            || !test_BN_eq_word("../test/bntest.c", 2100, "bn", "0xCB", bn, 0xCB)
            || !test_BN_ge_zero("../test/bntest.c", 2101, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2102, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2103, "bn", bn)
            || !test_BN_odd("../test/bntest.c", 2104, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2107 "../test/bntest.c" 3 4
        ((void *)0)
# 2107 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2109, "parseBN(&bn, \"-0\")", "2", parseBN(&bn, "-0"), 2)
            || !test_BN_eq_zero("../test/bntest.c", 2110, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2111, "bn", bn)
            || !test_BN_le_zero("../test/bntest.c", 2112, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2113, "bn", bn))
        goto err;
    BN_free(bn);
    bn = 
# 2116 "../test/bntest.c" 3 4
        ((void *)0)
# 2116 "../test/bntest.c"
            ;

    if (!test_int_eq("../test/bntest.c", 2118, "parseBN(&bn, \"abctrailing garbage is ignored\")", "3", parseBN(&bn, "abctrailing garbage is ignored"), 3)
            || !test_BN_eq_word("../test/bntest.c", 2119, "bn", "0xabc", bn, 0xabc)
            || !test_BN_ge_zero("../test/bntest.c", 2120, "bn", bn)
            || !test_BN_gt_zero("../test/bntest.c", 2121, "bn", bn)
            || !test_BN_ne_zero("../test/bntest.c", 2122, "bn", bn)
            || !test_BN_even("../test/bntest.c", 2123, "bn", bn))
        goto err;
    st = 1;
...
{
    BIGNUM *bn = 
# 2134 "../test/bntest.c" 3 4
                ((void *)0)
# 2134 "../test/bntest.c"
                    ;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 2137, "bn = BN_new()", bn = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 2140, "BN_asc2bn(&bn, \"0\")", (BN_asc2bn(&bn, "0")) != 0)
            || !test_BN_eq_zero("../test/bntest.c", 2141, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2142, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2145, "BN_asc2bn(&bn, \"256\")", (BN_asc2bn(&bn, "256")) != 0)
            || !test_BN_eq_word("../test/bntest.c", 2146, "bn", "256", bn, 256)
            || !test_BN_ge_zero("../test/bntest.c", 2147, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2150, "BN_asc2bn(&bn, \"-42\")", (BN_asc2bn(&bn, "-42")) != 0)
            || !test_BN_abs_eq_word("../test/bntest.c", 2151, "bn", "42", bn, 42)
            || !test_BN_lt_zero("../test/bntest.c", 2152, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2155, "BN_asc2bn(&bn, \"0x1234\")", (BN_asc2bn(&bn, "0x1234")) != 0)
            || !test_BN_eq_word("../test/bntest.c", 2156, "bn", "0x1234", bn, 0x1234)
            || !test_BN_ge_zero("../test/bntest.c", 2157, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2160, "BN_asc2bn(&bn, \"0X1234\")", (BN_asc2bn(&bn, "0X1234")) != 0)
            || !test_BN_eq_word("../test/bntest.c", 2161, "bn", "0x1234", bn, 0x1234)
            || !test_BN_ge_zero("../test/bntest.c", 2162, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2165, "BN_asc2bn(&bn, \"-0xabcd\")", (BN_asc2bn(&bn, "-0xabcd")) != 0)
            || !test_BN_abs_eq_word("../test/bntest.c", 2166, "bn", "0xabcd", bn, 0xabcd)
            || !test_BN_lt_zero("../test/bntest.c", 2167, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2170, "BN_asc2bn(&bn, \"-0\")", (BN_asc2bn(&bn, "-0")) != 0)
            || !test_BN_eq_zero("../test/bntest.c", 2171, "bn", bn)
            || !test_BN_ge_zero("../test/bntest.c", 2172, "bn", bn))
        goto err;

    if (!test_true("../test/bntest.c", 2175, "BN_asc2bn(&bn, \"123trailing garbage is ignored\")", (BN_asc2bn(&bn, "123trailing garbage is ignored")) != 0)
            || !test_BN_eq_word("../test/bntest.c", 2176, "bn", "123", bn, 123)
            || !test_BN_ge_zero("../test/bntest.c", 2177, "bn", bn))
        goto err;
...
static int test_mpi(int i)
{
    ...
    BIGNUM *bn = 
# 2200 "../test/bntest.c" 3 4
                ((void *)0)
# 2200 "../test/bntest.c"
                    ;
    BIGNUM *bn2 = 
# 2201 "../test/bntest.c" 3 4
                 ((void *)0)
# 2201 "../test/bntest.c"
                     ;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 2204, "bn = BN_new()", bn = BN_new())
            || !test_true("../test/bntest.c", 2205, "BN_asc2bn(&bn, test->base10)", (BN_asc2bn(&bn, test->base10)) != 0))
        goto err;
    mpi_len = BN_bn2mpi(bn, 
# 2207 "../test/bntest.c" 3 4
                           ((void *)0)
# 2207 "../test/bntest.c"
                               );
    if (!test_size_t_le("../test/bntest.c", 2208, "mpi_len", "sizeof(scratch)", mpi_len, sizeof(scratch)))
        goto err;

    if (!test_size_t_eq("../test/bntest.c", 2211, "mpi_len2 = BN_bn2mpi(bn, scratch)", "mpi_len", mpi_len2 = BN_bn2mpi(bn, scratch), mpi_len)
            || !test_mem_eq("../test/bntest.c", 2212, "test->mpi", "scratch", test->mpi, test->mpi_len, scratch, mpi_len))
        goto err;

    if (!test_ptr("../test/bntest.c", 2215, "bn2 = BN_mpi2bn(scratch, mpi_len, NULL)", bn2 = BN_mpi2bn(scratch, mpi_len, 
# 2215 "../test/bntest.c" 3 4
        ((void *)0)
# 2215 "../test/bntest.c"
        )))
        goto err;

    if (!test_BN_eq("../test/bntest.c", 2218, "bn", "bn2", bn, bn2)) {
        BN_free(bn2);
        goto err;
    }
    BN_free(bn2);
...
static int test_bin2zero(void)
{
    ...
    BIGNUM *zbn = 
# 2233 "../test/bntest.c" 3 4
                 ((void *)0)
# 2233 "../test/bntest.c"
                     ;
    int ret = 0;

    if (!test_ptr("../test/bntest.c", 2236, "zbn = BN_new()", zbn = BN_new()))
        goto err;
# 2248 "../test/bntest.c"
    if (!test_ptr("../test/bntest.c", 2248, "BN_bin2bn(input, 1, zbn)", BN_bin2bn(input, 1, zbn)) || !test_true("../test/bntest.c", 2248, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2248, "BN_bin2bn(input, 0, zbn)", BN_bin2bn(input, 0, zbn)) || !test_true("../test/bntest.c", 2248, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2248, "BN_bin2bn(NULL, 0, zbn)", BN_bin2bn(
# 2248 "../test/bntest.c" 3 4
   ((void *)0)
# 2248 "../test/bntest.c"
   , 0, zbn)) || !test_true("../test/bntest.c", 2248, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0)) goto err;
    if (!test_ptr("../test/bntest.c", 2249, "BN_signed_bin2bn(input, 1, zbn)", BN_signed_bin2bn(input, 1, zbn)) || !test_true("../test/bntest.c", 2249, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2249, "BN_signed_bin2bn(input, 0, zbn)", BN_signed_bin2bn(input, 0, zbn)) || !test_true("../test/bntest.c", 2249, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2249, "BN_signed_bin2bn(NULL, 0, zbn)", BN_signed_bin2bn(
# 2249 "../test/bntest.c" 3 4
   ((void *)0)
# 2249 "../test/bntest.c"
   , 0, zbn)) || !test_true("../test/bntest.c", 2249, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0)) goto err;
    if (!test_ptr("../test/bntest.c", 2250, "BN_lebin2bn(input, 1, zbn)", BN_lebin2bn(input, 1, zbn)) || !test_true("../test/bntest.c", 2250, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2250, "BN_lebin2bn(input, 0, zbn)", BN_lebin2bn(input, 0, zbn)) || !test_true("../test/bntest.c", 2250, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2250, "BN_lebin2bn(NULL, 0, zbn)", BN_lebin2bn(
# 2250 "../test/bntest.c" 3 4
   ((void *)0)
# 2250 "../test/bntest.c"
   , 0, zbn)) || !test_true("../test/bntest.c", 2250, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0)) goto err;
    if (!test_ptr("../test/bntest.c", 2251, "BN_signed_lebin2bn(input, 1, zbn)", BN_signed_lebin2bn(input, 1, zbn)) || !test_true("../test/bntest.c", 2251, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2251, "BN_signed_lebin2bn(input, 0, zbn)", BN_signed_lebin2bn(input, 0, zbn)) || !test_true("../test/bntest.c", 2251, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0) || !test_ptr("../test/bntest.c", 2251, "BN_signed_lebin2bn(NULL, 0, zbn)", BN_signed_lebin2bn(
# 2251 "../test/bntest.c" 3 4
   ((void *)0)
# 2251 "../test/bntest.c"
   , 0, zbn)) || !test_true("../test/bntest.c", 2251, "BN_is_zero(zbn)", (BN_is_zero(zbn)) != 0)) goto err;
...
# 2264 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 2267, "bn_be = BN_new()", bn_be = BN_new())
        || !test_ptr("../test/bntest.c", 2268, "bn_expected_be = BN_new()", bn_expected_be = BN_new())
        || !test_true("../test/bntest.c", 2269, "BN_set_word(bn_expected_be, 0x102)", (BN_set_word(bn_expected_be, 0x102)) != 0)
        || !test_ptr("../test/bntest.c", 2270, "bn_le = BN_new()", bn_le = BN_new())
        || !test_ptr("../test/bntest.c", 2271, "bn_expected_le = BN_new()", bn_expected_le = BN_new())
        || !test_true("../test/bntest.c", 2272, "BN_set_word(bn_expected_le, 0x201)", (BN_set_word(bn_expected_le, 0x201)) != 0))
        goto err;
# 2283 "../test/bntest.c"
    if (!test_ptr_null("../test/bntest.c", 2283, "BN_bin2bn(input, -1, bn_be)", BN_bin2bn(input, -1, bn_be)) || !test_ptr("../test/bntest.c", 2283, "BN_bin2bn(input, 0, bn_be)", BN_bin2bn(input, 0, bn_be)) || !test_true("../test/bntest.c", 2283, "BN_is_zero(bn_be)", (BN_is_zero(bn_be)) != 0) || !test_ptr("../test/bntest.c", 2283, "BN_bin2bn(input, 2, bn_be)", BN_bin2bn(input, 2, bn_be)) || !test_int_eq("../test/bntest.c", 2283, "BN_cmp(bn_be, bn_expected_be)", "0", BN_cmp(bn_be, bn_expected_be), 0)) goto err;
    if (!test_ptr_null("../test/bntest.c", 2284, "BN_signed_bin2bn(input, -1, bn_be)", BN_signed_bin2bn(input, -1, bn_be)) || !test_ptr("../test/bntest.c", 2284, "BN_signed_bin2bn(input, 0, bn_be)", BN_signed_bin2bn(input, 0, bn_be)) || !test_true("../test/bntest.c", 2284, "BN_is_zero(bn_be)", (BN_is_zero(bn_be)) != 0) || !test_ptr("../test/bntest.c", 2284, "BN_signed_bin2bn(input, 2, bn_be)", BN_signed_bin2bn(input, 2, bn_be)) || !test_int_eq("../test/bntest.c", 2284, "BN_cmp(bn_be, bn_expected_be)", "0", BN_cmp(bn_be, bn_expected_be), 0)) goto err;
    if (!test_ptr_null("../test/bntest.c", 2285, "BN_lebin2bn(input, -1, bn_le)", BN_lebin2bn(input, -1, bn_le)) || !test_ptr("../test/bntest.c", 2285, "BN_lebin2bn(input, 0, bn_le)", BN_lebin2bn(input, 0, bn_le)) || !test_true("../test/bntest.c", 2285, "BN_is_zero(bn_le)", (BN_is_zero(bn_le)) != 0) || !test_ptr("../test/bntest.c", 2285, "BN_lebin2bn(input, 2, bn_le)", BN_lebin2bn(input, 2, bn_le)) || !test_int_eq("../test/bntest.c", 2285, "BN_cmp(bn_le, bn_expected_le)", "0", BN_cmp(bn_le, bn_expected_le), 0)) goto err;
    if (!test_ptr_null("../test/bntest.c", 2286, "BN_signed_lebin2bn(input, -1, bn_le)", BN_signed_lebin2bn(input, -1, bn_le)) || !test_ptr("../test/bntest.c", 2286, "BN_signed_lebin2bn(input, 0, bn_le)", BN_signed_lebin2bn(input, 0, bn_le)) || !test_true("../test/bntest.c", 2286, "BN_is_zero(bn_le)", (BN_is_zero(bn_le)) != 0) || !test_ptr("../test/bntest.c", 2286, "BN_signed_lebin2bn(input, 2, bn_le)", BN_signed_lebin2bn(input, 2, bn_le)) || !test_int_eq("../test/bntest.c", 2286, "BN_cmp(bn_le, bn_expected_le)", "0", BN_cmp(bn_le, bn_expected_le), 0)) goto err;
...
{
    BIGNUM *bn = 
# 2300 "../test/bntest.c" 3 4
                ((void *)0)
# 2300 "../test/bntest.c"
                    ;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 2303, "bn = BN_new()", bn = BN_new()))
        return 0;


    if (!test_false("../test/bntest.c", 2307, "BN_rand(bn, 0, 0 , 0 )", (BN_rand(bn, 0, 0 , 0 )) != 0)
            || !test_false("../test/bntest.c", 2308, "BN_rand(bn, 0, 1 , 1 )", (BN_rand(bn, 0, 1 , 1 )) != 0)
            || !test_true("../test/bntest.c", 2309, "BN_rand(bn, 1, 0 , 0 )", (BN_rand(bn, 1, 0 , 0 )) != 0)
            || !test_BN_eq_one("../test/bntest.c", 2310, "bn", bn)
            || !test_false("../test/bntest.c", 2311, "BN_rand(bn, 1, 1 , 0 )", (BN_rand(bn, 1, 1 , 0 )) != 0)
            || !test_true("../test/bntest.c", 2312, "BN_rand(bn, 1, -1 , 1 )", (BN_rand(bn, 1, -1 , 1 )) != 0)
            || !test_BN_eq_one("../test/bntest.c", 2313, "bn", bn)
            || !test_true("../test/bntest.c", 2314, "BN_rand(bn, 2, 1 , 0 )", (BN_rand(bn, 2, 1 , 0 )) != 0)
            || !test_BN_eq_word("../test/bntest.c", 2315, "bn", "3", bn, 3))
        goto err;
...
# 1 "../test/bn_rand_range.h" 1
# 13 "../test/bn_rand_range.h"
static const struct {
    unsigned int range;
    unsigned int iterations;
    double critical;
...
# 2353 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 2358, "counts = OPENSSL_zalloc(sizeof(*counts) * range)", counts = CRYPTO_zalloc(sizeof(*counts) * range, "../test/bntest.c", 2358))
        || !test_ptr("../test/bntest.c", 2359, "rng = BN_new()", rng = BN_new())
        || !test_ptr("../test/bntest.c", 2360, "val = BN_new()", val = BN_new())
        || !test_true("../test/bntest.c", 2361, "BN_set_word(rng, range)", (BN_set_word(rng, range)) != 0))
        goto err;
    for (i = 0; i < iterations; i++) {
        if (!test_true("../test/bntest.c", 2364, "BN_rand_range(val, rng)", (BN_rand_range(val, rng)) != 0)
            || !test_uint_lt("../test/bntest.c", 2365, "v = (unsigned int)BN_get_word(val)", "range", v = (unsigned int)BN_get_word(val), range))
            goto err;
        counts[v]++;
    }
    ...
    if (sum > critical) {
        test_info("../test/bntest.c", 2377, "Chi^2 test negative %.4f > %4.f", sum, critical);
...
err:
    BN_free(rng);
    BN_free(val);
    CRYPTO_free(counts, "../test/bntest.c", 2387);
    return res;
}
...
static int test_rand_range(void)
{
    ...
    for (i = 0; i < (sizeof(rand_range_cases)/sizeof((rand_range_cases)[0])); i++)
        n_success += test_rand_range_single(i);
    if (test_int_ge("../test/bntest.c", 2398, "n_success", "binomial_critical", n_success, binomial_critical))
        return 1;
...
# 2407 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 2410, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 2411, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 2412, "c = BN_new()", c = BN_new())
            || !test_ptr("../test/bntest.c", 2413, "d = BN_new()", d = BN_new()))
        goto err;


    if (!test_true("../test/bntest.c", 2417, "BN_set_word(a, 1)", (BN_set_word(a, 1)) != 0))
        goto err;
    BN_set_negative(a, 1);
    BN_zero_ex(b);
    if (!test_true("../test/bntest.c", 2421, "BN_mul(c, a, b, ctx)", (BN_mul(c, a, b, ctx)) != 0))
        goto err;
    if (!test_BN_eq_zero("../test/bntest.c", 2423, "c", c)
            || !test_BN_ge_zero("../test/bntest.c", 2424, "c", c))
        goto err;

    for (consttime = 0; consttime < 2; consttime++) {
        if (!test_ptr("../test/bntest.c", 2428, "numerator = BN_new()", numerator = BN_new())
                || !test_ptr("../test/bntest.c", 2429, "denominator = BN_new()", denominator = BN_new()))
            goto err;
        if (consttime) {
            BN_set_flags(numerator, 0x04);
            BN_set_flags(denominator, 0x04);
        }

        if (!test_true("../test/bntest.c", 2436, "BN_set_word(numerator, 1)", (BN_set_word(numerator, 1)) != 0)
                || !test_true("../test/bntest.c", 2437, "BN_set_word(denominator, 2)", (BN_set_word(denominator, 2)) != 0))
            goto err;
        BN_set_negative(numerator, 1);
        if (!test_true("../test/bntest.c", 2440, "BN_div(a, b, numerator, denominator, ctx)", (BN_div(a, b, numerator, denominator, ctx)) != 0)
                || !test_BN_eq_zero("../test/bntest.c", 2441, "a", a)
                || !test_BN_ge_zero("../test/bntest.c", 2442, "a", a))
            goto err;


        if (!test_true("../test/bntest.c", 2446, "BN_set_word(denominator, 1)", (BN_set_word(denominator, 1)) != 0)
                || !test_true("../test/bntest.c", 2447, "BN_div(a, b, numerator, denominator, ctx)", (BN_div(a, b, numerator, denominator, ctx)) != 0)
                || !test_BN_eq_zero("../test/bntest.c", 2448, "b", b)
                || !test_BN_ge_zero("../test/bntest.c", 2449, "b", b))
            goto err;
        BN_free(numerator);
        BN_free(denominator);
        numerator = denominator = 
# 2453 "../test/bntest.c" 3 4
                                 ((void *)0)
# 2453 "../test/bntest.c"
                                     ;
    }
...
# 2475 "../test/bntest.c"
                                            ;
    BN_MONT_CTX *mont = 
# 2476 "../test/bntest.c" 3 4
                       ((void *)0)
# 2476 "../test/bntest.c"
                           ;
    int st = 0;

    if (!test_ptr("../test/bntest.c", 2479, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 2480, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 2481, "zero = BN_new()", zero = BN_new())
            || !test_ptr("../test/bntest.c", 2482, "mont = BN_MONT_CTX_new()", mont = BN_MONT_CTX_new()))
        goto err;
    BN_zero_ex(zero);

    if (!test_false("../test/bntest.c", 2486, "BN_div(a, b, BN_value_one(), zero, ctx)", (BN_div(a, b, BN_value_one(), zero, ctx)) != 0))
        goto err;
    ERR_clear_error();

    if (!test_false("../test/bntest.c", 2490, "BN_mod_mul(a, BN_value_one(), BN_value_one(), zero, ctx)", (BN_mod_mul(a, BN_value_one(), BN_value_one(), zero, ctx)) != 0))
        goto err;
    ERR_clear_error();

    if (!test_false("../test/bntest.c", 2494, "BN_mod_exp(a, BN_value_one(), BN_value_one(), zero, ctx)", (BN_mod_exp(a, BN_value_one(), BN_value_one(), zero, ctx)) != 0))
        goto err;
    ERR_clear_error();

    if (!test_false("../test/bntest.c", 2498, "BN_mod_exp_mont(a, BN_value_one(), BN_value_one(), zero, ctx, NULL)", (BN_mod_exp_mont(a, BN_value_one(), BN_value_one(), zero, ctx, 
# 2498 "../test/bntest.c" 3 4
        ((void *)0)
# 2498 "../test/bntest.c"
        )) != 0)
                                                     )
    ...
    if (!test_false("../test/bntest.c", 2503, "BN_mod_exp_mont_consttime(a, BN_value_one(), BN_value_one(), zero, ctx, NULL)", (BN_mod_exp_mont_consttime(a, BN_value_one(), BN_value_one(), zero, ctx, 
# 2503 "../test/bntest.c" 3 4
        ((void *)0)
# 2503 "../test/bntest.c"
        )) != 0)
                                                               )
    ...
    if (!test_false("../test/bntest.c", 2508, "BN_MONT_CTX_set(mont, zero, ctx)", (BN_MONT_CTX_set(mont, zero, ctx)) != 0))
        goto err;
    ERR_clear_error();


    if (!test_true("../test/bntest.c", 2513, "BN_set_word(b, 16)", (BN_set_word(b, 16)) != 0))
        goto err;

    if (!test_false("../test/bntest.c", 2516, "BN_MONT_CTX_set(mont, b, ctx)", (BN_MONT_CTX_set(mont, b, ctx)) != 0))
        goto err;
    ERR_clear_error();

    if (!test_false("../test/bntest.c", 2520, "BN_mod_exp_mont(a, BN_value_one(), BN_value_one(), b, ctx, NULL)", (BN_mod_exp_mont(a, BN_value_one(), BN_value_one(), b, ctx, 
# 2520 "../test/bntest.c" 3 4
        ((void *)0)
# 2520 "../test/bntest.c"
        )) != 0)
                                                  )
    ...
    if (!test_false("../test/bntest.c", 2525, "BN_mod_exp_mont_consttime(a, BN_value_one(), BN_value_one(), b, ctx, NULL)", (BN_mod_exp_mont_consttime(a, BN_value_one(), BN_value_one(), b, ctx, 
# 2525 "../test/bntest.c" 3 4
        ((void *)0)
# 2525 "../test/bntest.c"
        )) != 0)
                                                            )
...
# 2541 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 2544, "zero = BN_new()", zero = BN_new())
            || !test_ptr("../test/bntest.c", 2545, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 2546, "r = BN_new()", r = BN_new()))
        goto err;
    BN_zero_ex(zero);

    if (!test_true("../test/bntest.c", 2550, "BN_mod_exp(r, a, zero, BN_value_one(), NULL)", (BN_mod_exp(r, a, zero, BN_value_one(), 
# 2550 "../test/bntest.c" 3 4
        ((void *)0)
# 2550 "../test/bntest.c"
        )) != 0)
            || !test_BN_eq_zero("../test/bntest.c", 2551, "r", r)
            || !test_true("../test/bntest.c", 2552, "BN_mod_exp_mont(r, a, zero, BN_value_one(), NULL, NULL)", (BN_mod_exp_mont(r, a, zero, BN_value_one(), 
# 2552 "../test/bntest.c" 3 4
               ((void *)0)
# 2552 "../test/bntest.c"
               , 
# 2552 "../test/bntest.c" 3 4
...
# 2552 "../test/bntest.c"
            ...
            || !test_BN_eq_zero("../test/bntest.c", 2554, "r", r)
            || !test_true("../test/bntest.c", 2555, "BN_mod_exp_mont_consttime(r, a, zero, BN_value_one(), NULL, NULL)", (BN_mod_exp_mont_consttime(r, a, zero, BN_value_one(), 
# 2555 "../test/bntest.c" 3 4
               ((void *)0)
# 2555 "../test/bntest.c"
               , 
# 2555 "../test/bntest.c" 3 4
...
# 2555 "../test/bntest.c"
            ...
            || !test_BN_eq_zero("../test/bntest.c", 2558, "r", r)
            || !test_true("../test/bntest.c", 2559, "BN_mod_exp_mont_word(r, 42, zero, BN_value_one(), NULL, NULL)", (BN_mod_exp_mont_word(r, 42, zero, BN_value_one(), 
# 2559 "../test/bntest.c" 3 4
               ((void *)0)
# 2559 "../test/bntest.c"
               , 
# 2559 "../test/bntest.c" 3 4
...
# 2559 "../test/bntest.c"
            ...
            || !test_BN_eq_zero("../test/bntest.c", 2561, "r", r))
        goto err;
...
static int test_expmodone(void)
{
    ...
    if (!test_ptr("../test/bntest.c", 2580, "r", r)
            || !test_ptr("../test/bntest.c", 2581, "a", a)
            || !test_ptr("../test/bntest.c", 2582, "p", p)
            || !test_ptr("../test/bntest.c", 2583, "p", p)
            || !test_ptr("../test/bntest.c", 2584, "m", m)
            || !test_true("../test/bntest.c", 2585, "BN_set_word(a, 1)", (BN_set_word(a, 1)) != 0)
            || !test_true("../test/bntest.c", 2586, "BN_set_word(p, 0)", (BN_set_word(p, 0)) != 0)
            || !test_true("../test/bntest.c", 2587, "BN_set_word(m, 1)", (BN_set_word(m, 1)) != 0))
        goto err;


    for (i = 0; i < 2; i++) {
        if (!test_true("../test/bntest.c", 2592, "BN_mod_exp(r, a, p, m, NULL)", (BN_mod_exp(r, a, p, m, 
# 2592 "../test/bntest.c" 3 4
            ((void *)0)
# 2592 "../test/bntest.c"
            )) != 0)
                || !test_BN_eq_zero("../test/bntest.c", 2593, "r", r)
                || !test_true("../test/bntest.c", 2594, "BN_mod_exp_mont(r, a, p, m, NULL, NULL)", (BN_mod_exp_mont(r, a, p, m, 
# 2594 "../test/bntest.c" 3 4
                   ((void *)0)
# 2594 "../test/bntest.c"
                   , 
# 2594 "../test/bntest.c" 3 4
...
# 2594 "../test/bntest.c"
                ...
                || !test_BN_eq_zero("../test/bntest.c", 2595, "r", r)
                || !test_true("../test/bntest.c", 2596, "BN_mod_exp_mont_consttime(r, a, p, m, NULL, NULL)", (BN_mod_exp_mont_consttime(r, a, p, m, 
# 2596 "../test/bntest.c" 3 4
                   ((void *)0)
# 2596 "../test/bntest.c"
                   , 
# 2596 "../test/bntest.c" 3 4
...
# 2596 "../test/bntest.c"
                ...
                || !test_BN_eq_zero("../test/bntest.c", 2597, "r", r)
                || !test_true("../test/bntest.c", 2598, "BN_mod_exp_mont_word(r, 1, p, m, NULL, NULL)", (BN_mod_exp_mont_word(r, 1, p, m, 
# 2598 "../test/bntest.c" 3 4
                   ((void *)0)
# 2598 "../test/bntest.c"
                   , 
# 2598 "../test/bntest.c" 3 4
...
# 2598 "../test/bntest.c"
                ...
                || !test_BN_eq_zero("../test/bntest.c", 2599, "r", r)
                || !test_true("../test/bntest.c", 2600, "BN_mod_exp_simple(r, a, p, m, NULL)", (BN_mod_exp_simple(r, a, p, m, 
# 2600 "../test/bntest.c" 3 4
                   ((void *)0)
# 2600 "../test/bntest.c"
                   )) != 0)
                || !test_BN_eq_zero("../test/bntest.c", 2601, "r", r)
                || !test_true("../test/bntest.c", 2602, "BN_mod_exp_recp(r, a, p, m, NULL)", (BN_mod_exp_recp(r, a, p, m, 
# 2602 "../test/bntest.c" 3 4
                   ((void *)0)
# 2602 "../test/bntest.c"
                   )) != 0)
                || !test_BN_eq_zero("../test/bntest.c", 2603, "r", r))
            goto err;
...
static int test_smallprime(int kBits)
{
    ...
    if (!test_ptr("../test/bntest.c", 2624, "r = BN_new()", r = BN_new()))
        goto err;

    if (kBits <= 1) {
        if (!test_false("../test/bntest.c", 2628, "BN_generate_prime_ex(r, kBits, 0, NULL, NULL, NULL)", (BN_generate_prime_ex(r, kBits, 0, 
# 2628 "../test/bntest.c" 3 4
            ((void *)0)
# 2628 "../test/bntest.c"
            , 
# 2628 "../test/bntest.c" 3 4
...
# 2628 "../test/bntest.c"
        ...
        if (!test_true("../test/bntest.c", 2632, "BN_generate_prime_ex(r, kBits, 0, NULL, NULL, NULL)", (BN_generate_prime_ex(r, kBits, 0, 
# 2632 "../test/bntest.c" 3 4
            ((void *)0)
# 2632 "../test/bntest.c"
            , 
# 2632 "../test/bntest.c" 3 4
...
# 2632 "../test/bntest.c"
                ...
                || !test_int_eq("../test/bntest.c", 2634, "BN_num_bits(r)", "kBits", BN_num_bits(r), kBits))
            goto err;
    }
...
static int test_smallsafeprime(int kBits)
{
    ...
    if (!test_ptr("../test/bntest.c", 2649, "r = BN_new()", r = BN_new()))
        goto err;

    if (kBits <= 5 && kBits != 3) {
        if (!test_false("../test/bntest.c", 2653, "BN_generate_prime_ex(r, kBits, 1, NULL, NULL, NULL)", (BN_generate_prime_ex(r, kBits, 1, 
# 2653 "../test/bntest.c" 3 4
            ((void *)0)
# 2653 "../test/bntest.c"
            , 
# 2653 "../test/bntest.c" 3 4
...
# 2653 "../test/bntest.c"
        ...
        if (!test_true("../test/bntest.c", 2657, "BN_generate_prime_ex(r, kBits, 1, NULL, NULL, NULL)", (BN_generate_prime_ex(r, kBits, 1, 
# 2657 "../test/bntest.c" 3 4
            ((void *)0)
# 2657 "../test/bntest.c"
            , 
# 2657 "../test/bntest.c" 3 4
...
# 2657 "../test/bntest.c"
                ...
                || !test_int_eq("../test/bntest.c", 2659, "BN_num_bits(r)", "kBits", BN_num_bits(r), kBits))
            goto err;
    }
...
static int test_is_prime(int i)
{
    int ret = 0;
    BIGNUM *r = 
# 2674 "../test/bntest.c" 3 4
               ((void *)0)
# 2674 "../test/bntest.c"
                   ;
    int trial;

    if (!test_ptr("../test/bntest.c", 2677, "r = BN_new()", r = BN_new()))
        goto err;

    for (trial = 0; trial <= 1; ++trial) {
        if (!test_true("../test/bntest.c", 2681, "BN_set_word(r, primes[i])", (BN_set_word(r, primes[i])) != 0)
                || !test_int_eq("../test/bntest.c", 2682, "BN_check_prime(r, ctx, NULL)", "1", BN_check_prime(r, ctx, 
# 2682 "../test/bntest.c" 3 4
                   ((void *)0)
# 2682 "../test/bntest.c"
                   ), 1)
                                  )
...
static int test_not_prime(int i)
{
    int ret = 0;
    BIGNUM *r = 
# 2698 "../test/bntest.c" 3 4
               ((void *)0)
# 2698 "../test/bntest.c"
                   ;
    int trial;

    if (!test_ptr("../test/bntest.c", 2701, "r = BN_new()", r = BN_new()))
        goto err;

    for (trial = 0; trial <= 1; ++trial) {
        if (!test_true("../test/bntest.c", 2705, "BN_set_word(r, not_primes[i])", (BN_set_word(r, not_primes[i])) != 0)
                || !test_false("../test/bntest.c", 2706, "BN_check_prime(r, ctx, NULL)", (BN_check_prime(r, ctx, 
# 2706 "../test/bntest.c" 3 4
                   ((void *)0)
# 2706 "../test/bntest.c"
                   )) != 0))
            goto err;
...
static int test_ctx_set_ct_flag(BN_CTX *c)
{
    ...
    for (i = 0; i < (sizeof(b)/sizeof((b)[0])); i++) {
        if (!test_ptr("../test/bntest.c", 2724, "b[i] = BN_CTX_get(c)", b[i] = BN_CTX_get(c)))
            goto err;
        if (i % 2 == 1)
            BN_set_flags(b[i], 0x04);
    }
...
static int test_ctx_check_ct_flag(BN_CTX *c)
{
    ...
    BN_CTX_start(c);
    for (i = 0; i < (sizeof(b)/sizeof((b)[0])); i++) {
        if (!test_ptr("../test/bntest.c", 2744, "b[i] = BN_CTX_get(c)", b[i] = BN_CTX_get(c)))
            goto err;
        if (!test_false("../test/bntest.c", 2746, "BN_get_flags(b[i], BN_FLG_CONSTTIME)", (BN_get_flags(b[i], 0x04)) != 0))
            goto err;
    }
...
# 2779 "../test/bntest.c"
    BN_CTX *nctx = 
# 2779 "../test/bntest.c" 3 4
                  ((void *)0)
# 2779 "../test/bntest.c"
                      ;
    BN_CTX *sctx = 
# 2780 "../test/bntest.c" 3 4
                  ((void *)0)
# 2780 "../test/bntest.c"
                      ;
    size_t i = 0;
    ...
    if (!test_ptr("../test/bntest.c", 2784, "nctx = BN_CTX_new()", nctx = BN_CTX_new())
            || !test_ptr("../test/bntest.c", 2785, "sctx = BN_CTX_secure_new()", sctx = BN_CTX_secure_new()))
        goto err;

    for (i = 0; i < 2; i++) {
        BN_CTX *c = i == 0 ? nctx : sctx;
        if (!test_true("../test/bntest.c", 2790, "test_ctx_set_ct_flag(c)", (test_ctx_set_ct_flag(c)) != 0)
                || !test_true("../test/bntest.c", 2791, "test_ctx_check_ct_flag(c)", (test_ctx_check_ct_flag(c)) != 0))
            goto err;
    }
...
# 2804 "../test/bntest.c"
    ...
    ret = test_ptr("../test/bntest.c", 2807, "a = BN_new()", a = BN_new())
          && test_ptr("../test/bntest.c", 2808, "b = BN_new()", b = BN_new())
          && test_true("../test/bntest.c", 2809, "BN_set_word(a, 66)", (BN_set_word(a, 66)) != 0)
          && test_true("../test/bntest.c", 2810, "BN_set_word(b, 99)", (BN_set_word(b, 99)) != 0)
          && test_int_eq("../test/bntest.c", 2811, "BN_are_coprime(a, b, ctx)", "0", BN_are_coprime(a, b, ctx), 0)
          && test_int_eq("../test/bntest.c", 2812, "BN_are_coprime(b, a, ctx)", "0", BN_are_coprime(b, a, ctx), 0)
          && test_true("../test/bntest.c", 2813, "BN_set_word(a, 67)", (BN_set_word(a, 67)) != 0)
          && test_int_eq("../test/bntest.c", 2814, "BN_are_coprime(a, b, ctx)", "1", BN_are_coprime(a, b, ctx), 1)
          && test_int_eq("../test/bntest.c", 2815, "BN_are_coprime(b, a, ctx)", "1", BN_are_coprime(b, a, ctx), 1);
    BN_free(a);
    BN_free(b);
    return ret;
}
...
# 2823 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 2826, "a = BN_new()", a = BN_new())
            || !test_ptr("../test/bntest.c", 2827, "b = BN_new()", b = BN_new())
            || !test_ptr("../test/bntest.c", 2828, "gcd = BN_new()", gcd = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 2831, "BN_generate_prime_ex(a, 1024, 0, NULL, NULL, NULL)", (BN_generate_prime_ex(a, 1024, 0, 
# 2831 "../test/bntest.c" 3 4
        ((void *)0)
# 2831 "../test/bntest.c"
        , 
# 2831 "../test/bntest.c" 3 4
...
# 2831 "../test/bntest.c"
    ...
    for (i = 0; i < NUM_PRIME_TESTS; i++) {
        if (!test_true("../test/bntest.c", 2834, "BN_generate_prime_ex(b, 1024, 0, NULL, NULL, NULL)", (BN_generate_prime_ex(b, 1024, 0, 
# 2834 "../test/bntest.c" 3 4
            ((void *)0)
# 2834 "../test/bntest.c"
            , 
# 2834 "../test/bntest.c" 3 4
...
# 2834 "../test/bntest.c"
                ...
                || !test_true("../test/bntest.c", 2836, "BN_gcd(gcd, a, b, ctx)", (BN_gcd(gcd, a, b, ctx)) != 0)
                || !test_true("../test/bntest.c", 2837, "BN_is_one(gcd)", (BN_is_one(gcd)) != 0)
                || !test_true("../test/bntest.c", 2838, "BN_are_coprime(a, b, ctx)", (BN_are_coprime(a, b, ctx)) != 0))
            goto err;
    }
...
static int test_mod_exp(int i)
{
    ...
    int res = 0;
    BIGNUM* result = 
# 3064 "../test/bntest.c" 3 4
                    ((void *)0)
# 3064 "../test/bntest.c"
                        ;
    BIGNUM *base = 
# 3065 "../test/bntest.c" 3 4
                  ((void *)0)
# 3065 "../test/bntest.c"
                      , *exponent = 
# 3065 "../test/bntest.c" 3 4
...
# 3065 "../test/bntest.c"
                                                        ;
    char *s = 
# 3066 "../test/bntest.c" 3 4
             ((void *)0)
# 3066 "../test/bntest.c"
                 ;

    if (!test_ptr("../test/bntest.c", 3068, "result = BN_new()", result = BN_new())
            || !test_true("../test/bntest.c", 3069, "BN_dec2bn(&base, test->base)", (BN_dec2bn(&base, test->base)) != 0)
            || !test_true("../test/bntest.c", 3070, "BN_dec2bn(&exponent, test->exp)", (BN_dec2bn(&exponent, test->exp)) != 0)
            || !test_true("../test/bntest.c", 3071, "BN_dec2bn(&modulo, test->mod)", (BN_dec2bn(&modulo, test->mod)) != 0))
        goto err;

    if (!test_int_eq("../test/bntest.c", 3074, "BN_mod_exp(result, base, exponent, modulo, ctx)", "1", BN_mod_exp(result, base, exponent, modulo, ctx), 1))
        goto err;

    if (!test_ptr("../test/bntest.c", 3077, "s = BN_bn2dec(result)", s = BN_bn2dec(result)))
        goto err;

    if (!test_mem_eq("../test/bntest.c", 3080, "s", "test->res", s, strlen(s), test->res, strlen(test->res)))
        goto err;

    res = 1;

 err:
    CRYPTO_free(s, "../test/bntest.c", 3086);
    BN_free(result);
    BN_free(base);
    BN_free(exponent);
    BN_free(modulo);
...
static int test_mod_exp_consttime(int i)
{
    ...
    int res = 0;
    BIGNUM* result = 
# 3098 "../test/bntest.c" 3 4
                    ((void *)0)
# 3098 "../test/bntest.c"
                        ;
    BIGNUM *base = 
# 3099 "../test/bntest.c" 3 4
                  ((void *)0)
# 3099 "../test/bntest.c"
                      , *exponent = 
# 3099 "../test/bntest.c" 3 4
...
# 3099 "../test/bntest.c"
                                                        ;
    char *s = 
# 3100 "../test/bntest.c" 3 4
             ((void *)0)
# 3100 "../test/bntest.c"
                 ;

    if (!test_ptr("../test/bntest.c", 3102, "result = BN_new()", result = BN_new())
            || !test_true("../test/bntest.c", 3103, "BN_dec2bn(&base, test->base)", (BN_dec2bn(&base, test->base)) != 0)
            || !test_true("../test/bntest.c", 3104, "BN_dec2bn(&exponent, test->exp)", (BN_dec2bn(&exponent, test->exp)) != 0)
            || !test_true("../test/bntest.c", 3105, "BN_dec2bn(&modulo, test->mod)", (BN_dec2bn(&modulo, test->mod)) != 0))
        goto err;

    BN_set_flags(base, 0x04);
    BN_set_flags(exponent, 0x04);
    BN_set_flags(modulo, 0x04);

    if (!test_int_eq("../test/bntest.c", 3112, "BN_mod_exp(result, base, exponent, modulo, ctx)", "1", BN_mod_exp(result, base, exponent, modulo, ctx), 1))
        goto err;

    if (!test_ptr("../test/bntest.c", 3115, "s = BN_bn2dec(result)", s = BN_bn2dec(result)))
        goto err;

    if (!test_mem_eq("../test/bntest.c", 3118, "s", "test->res", s, strlen(s), test->res, strlen(test->res)))
        goto err;

    res = 1;

 err:
    CRYPTO_free(s, "../test/bntest.c", 3124);
    BN_free(result);
    BN_free(base);
    BN_free(exponent);
    BN_free(modulo);
...
static int test_mod_exp2_mont(void)
{
    int res = 0;
    BIGNUM *exp_result = 
# 3139 "../test/bntest.c" 3 4
                        ((void *)0)
# 3139 "../test/bntest.c"
                            ;
    BIGNUM *exp_a1 = 
# 3140 "../test/bntest.c" 3 4
                    ((void *)0)
# 3140 "../test/bntest.c"
                        , *exp_p1 = 
# 3140 "../test/bntest.c" 3 4
...
# 3140 "../test/bntest.c"
                                                                        ,
           *exp_m = 
# 3141 "../test/bntest.c" 3 4
                   ((void *)0)
# 3141 "../test/bntest.c"
                       ;

    if (!test_ptr("../test/bntest.c", 3143, "exp_result = BN_new()", exp_result = BN_new())
            || !test_ptr("../test/bntest.c", 3144, "exp_a1 = BN_new()", exp_a1 = BN_new())
            || !test_ptr("../test/bntest.c", 3145, "exp_p1 = BN_new()", exp_p1 = BN_new())
            || !test_ptr("../test/bntest.c", 3146, "exp_a2 = BN_new()", exp_a2 = BN_new())
            || !test_ptr("../test/bntest.c", 3147, "exp_p2 = BN_new()", exp_p2 = BN_new())
            || !test_ptr("../test/bntest.c", 3148, "exp_m = BN_new()", exp_m = BN_new()))
        goto err;

    if (!test_true("../test/bntest.c", 3151, "BN_one(exp_a1)", ((BN_set_word((exp_a1),1))) != 0)
            || !test_true("../test/bntest.c", 3152, "BN_one(exp_p1)", ((BN_set_word((exp_p1),1))) != 0)
            || !test_true("../test/bntest.c", 3153, "BN_one(exp_a2)", ((BN_set_word((exp_a2),1))) != 0)
            || !test_true("../test/bntest.c", 3154, "BN_one(exp_p2)", ((BN_set_word((exp_p2),1))) != 0))
        goto err;

    BN_zero_ex(exp_m);


    if (!test_int_eq("../test/bntest.c", 3160, "BN_mod_exp2_mont(exp_result, exp_a1, exp_p1, exp_a2, exp_p2, exp_m, ctx, NULL)", "0", BN_mod_exp2_mont(exp_result, exp_a1, exp_p1, exp_a2, exp_p2, exp_m, ctx, 
# 3160 "../test/bntest.c" 3 4
        ((void *)0)
# 3160 "../test/bntest.c"
        ), 0)
                                             )
...
static int test_mod_inverse(void)
{
    int res = 0;
    char *str = 
# 3179 "../test/bntest.c" 3 4
               ((void *)0)
# 3179 "../test/bntest.c"
                   ;
    BIGNUM *a = 
# 3180 "../test/bntest.c" 3 4
               ((void *)0)
# 3180 "../test/bntest.c"
                   ;
    BIGNUM *b = 
# 3181 "../test/bntest.c" 3 4
               ((void *)0)
# 3181 "../test/bntest.c"
                   ;
    BIGNUM *r = 
# 3182 "../test/bntest.c" 3 4
               ((void *)0)
# 3182 "../test/bntest.c"
                   ;

    if (!test_true("../test/bntest.c", 3184, "BN_dec2bn(&a, \"5193817943\")", (BN_dec2bn(&a, "5193817943")) != 0))
        goto err;
    if (!test_true("../test/bntest.c", 3186, "BN_dec2bn(&b, \"3259122431\")", (BN_dec2bn(&b, "3259122431")) != 0))
        goto err;
    if (!test_ptr("../test/bntest.c", 3188, "r = BN_new()", r = BN_new()))
        goto err;
    if (!test_ptr_eq("../test/bntest.c", 3190, "BN_mod_inverse(r, a, b, ctx)", "r", BN_mod_inverse(r, a, b, ctx), r))
        goto err;
    if (!test_ptr_ne("../test/bntest.c", 3192, "str = BN_bn2dec(r)", "NULL", str = BN_bn2dec(r), 
# 3192 "../test/bntest.c" 3 4
        ((void *)0)
# 3192 "../test/bntest.c"
        ))
        goto err;
    if (!test_int_eq("../test/bntest.c", 3194, "strcmp(str, \"2609653924\")", "0", strcmp(str, "2609653924"), 0))
        goto err;


    if (!test_ptr_null("../test/bntest.c", 3198, "BN_mod_inverse(b, a, b, ctx)", BN_mod_inverse(b, a, b, ctx)))
        goto err;
...
err:
    ...
    BN_free(b);
    BN_free(r);
    CRYPTO_free(str, "../test/bntest.c", 3207);
    return res;
}
...
static int test_mod_exp_alias(int idx)
{
    int res = 0;
    char *str = 
# 3214 "../test/bntest.c" 3 4
               ((void *)0)
# 3214 "../test/bntest.c"
                   ;
    BIGNUM *a = 
# 3215 "../test/bntest.c" 3 4
               ((void *)0)
# 3215 "../test/bntest.c"
                   ;
    BIGNUM *b = 
# 3216 "../test/bntest.c" 3 4
               ((void *)0)
# 3216 "../test/bntest.c"
                   ;
    BIGNUM *c = 
# 3217 "../test/bntest.c" 3 4
               ((void *)0)
# 3217 "../test/bntest.c"
                   ;
    BIGNUM *r = 
# 3218 "../test/bntest.c" 3 4
               ((void *)0)
# 3218 "../test/bntest.c"
                   ;

    if (!test_true("../test/bntest.c", 3220, "BN_dec2bn(&a, \"15\")", (BN_dec2bn(&a, "15")) != 0))
        goto err;
    if (!test_true("../test/bntest.c", 3222, "BN_dec2bn(&b, \"10\")", (BN_dec2bn(&b, "10")) != 0))
        goto err;
    if (!test_true("../test/bntest.c", 3224, "BN_dec2bn(&c, \"39\")", (BN_dec2bn(&c, "39")) != 0))
        goto err;
    if (!test_ptr("../test/bntest.c", 3226, "r = BN_new()", r = BN_new()))
        goto err;

    if (!test_int_eq("../test/bntest.c", 3229, "(idx == 0 ? BN_mod_exp_simple : BN_mod_exp_recp)(r, a, b, c, ctx)", "1", (idx == 0 ? BN_mod_exp_simple : BN_mod_exp_recp)(r, a, b, c, ctx), 1)
                                                                      )
        goto err;
    if (!test_ptr_ne("../test/bntest.c", 3232, "str = BN_bn2dec(r)", "NULL", str = BN_bn2dec(r), 
# 3232 "../test/bntest.c" 3 4
        ((void *)0)
# 3232 "../test/bntest.c"
        ))
        goto err;
    if (!test_str_eq("../test/bntest.c", 3234, "str", "\"36\"", str, "36"))
        goto err;

    CRYPTO_free(str, "../test/bntest.c", 3237);
    str = 
# 3238 "../test/bntest.c" 3 4
         ((void *)0)
# 3238 "../test/bntest.c"
             ;
    ...
    if (!test_int_eq("../test/bntest.c", 3243, "(idx == 0 ? BN_mod_exp_simple : BN_mod_exp_recp)(r, a, r, c, ctx)", "1", (idx == 0 ? BN_mod_exp_simple : BN_mod_exp_recp)(r, a, r, c, ctx), 1)
                                                                      )
        goto err;
    if (!test_ptr_ne("../test/bntest.c", 3246, "str = BN_bn2dec(r)", "NULL", str = BN_bn2dec(r), 
# 3246 "../test/bntest.c" 3 4
        ((void *)0)
# 3246 "../test/bntest.c"
        ))
        goto err;
    if (!test_str_eq("../test/bntest.c", 3248, "str", "\"36\"", str, "36"))
        goto err;

    CRYPTO_free(str, "../test/bntest.c", 3251);
    str = 
# 3252 "../test/bntest.c" 3 4
         ((void *)0)
# 3252 "../test/bntest.c"
             ;
    ...
    if (idx == 0) {
        if (!test_int_eq("../test/bntest.c", 3256, "BN_mod_exp_simple(c, a, b, c, ctx)", "0", BN_mod_exp_simple(c, a, b, c, ctx), 0))
            goto err;
    } else {
        if (!test_int_eq("../test/bntest.c", 3259, "BN_mod_exp_recp(c, a, b, c, ctx)", "1", BN_mod_exp_recp(c, a, b, c, ctx), 1))
            goto err;
        if (!test_ptr_ne("../test/bntest.c", 3261, "str = BN_bn2dec(c)", "NULL", str = BN_bn2dec(c), 
# 3261 "../test/bntest.c" 3 4
            ((void *)0)
# 3261 "../test/bntest.c"
            ))
            goto err;
        if (!test_str_eq("../test/bntest.c", 3263, "str", "\"36\"", str, "36"))
            goto err;
    }
...
err:
    ...
    BN_free(c);
    BN_free(r);
    CRYPTO_free(str, "../test/bntest.c", 3274);
    return res;
}
...
static int file_test_run(STANZA *s)
{
    ...
    int numtests = (sizeof(filetests)/sizeof((filetests)[0]));
    const FILETEST *tp = filetests;

    for ( ; --numtests >= 0; tp++) {
        if (findattr(s, tp->name) != 
# 3298 "../test/bntest.c" 3 4
                                    ((void *)0)
# 3298 "../test/bntest.c"
                                        ) {
            if (!tp->func(s)) {
                test_info("../test/bntest.c", 3300, "%s:%d: Failed %s test", s->test_file, s->start, tp->name)
                                                           ;
                return 0;
            }
            return 1;
    ...
    test_info("../test/bntest.c", 3307, "%s:%d: Unknown test", s->test_file, s->start);
    return 0;
}
...
# 3313 "../test/bntest.c"
    ...
    if (!test_ptr("../test/bntest.c", 3317, "s = OPENSSL_zalloc(sizeof(*s))", s = CRYPTO_zalloc(sizeof(*s), "../test/bntest.c", 3317)))
        return 0;
    if (!test_start_file(s, testfile)) {
        CRYPTO_free(s, "../test/bntest.c", 3320);
        return 0;
    }


    while (!(int)BIO_ctrl(s->fp,2,0,
# 3325 "../test/bntest.c" 3 4
           ((void *)0)
# 3325 "../test/bntest.c"
           ) && test_readstanza(s)) {
        if (s->numpairs == 0)
    ...
    test_end_file(s);
    c = s->errors;
    CRYPTO_free(s, "../test/bntest.c", 3335);
...
int setup_tests(void)
{
    ...
    if (!test_ptr("../test/bntest.c", 3378, "ctx = BN_CTX_new()", ctx = BN_CTX_new()))
        return 0;

    if (n == 0) {
        add_test("test_sub", test_sub);
        add_test("test_div_recip", test_div_recip);
        add_all_tests("test_signed_mod_replace_ab", test_signed_mod_replace_ab, (sizeof(signed_mod_tests)/sizeof((signed_mod_tests)[0])), 1);
        add_all_tests("test_signed_mod_replace_ba", test_signed_mod_replace_ba, (sizeof(signed_mod_tests)/sizeof((signed_mod_tests)[0])), 1);
        ...
        add_all_tests("test_mpi", test_mpi, (int)(sizeof(kMPITests)/sizeof((kMPITests)[0])), 1);
        add_all_tests("test_bn2signed", test_bn2signed, (int)(sizeof(kSignedTests_BE)/sizeof((kSignedTests_BE)[0])), 1);
        ...
        add_all_tests("test_smallprime", test_smallprime, 16, 1);
        add_all_tests("test_smallsafeprime", test_smallsafeprime, 16, 1);
        ...
        add_all_tests("test_is_prime", test_is_prime, (int)(sizeof(primes)/sizeof((primes)[0])), 1);
        add_all_tests("test_not_prime", test_not_prime, (int)(sizeof(not_primes)/sizeof((not_primes)[0])), 1);
        add_test("test_gcd_prime", test_gcd_prime);
        add_test("test_coprime", test_coprime);
        add_all_tests("test_mod_exp", test_mod_exp, (int)(sizeof(ModExpTests)/sizeof((ModExpTests)[0])), 1);
        add_all_tests("test_mod_exp_consttime", test_mod_exp_consttime, (int)(sizeof(ModExpTests)/sizeof((ModExpTests)[0])), 1);
