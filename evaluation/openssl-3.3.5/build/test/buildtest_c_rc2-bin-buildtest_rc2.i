# 0 "test/buildtest_rc2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_rc2.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_set_key(RC2_KEY *key, int len,
                                       const unsigned char *data, int bits);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_ecb_encrypt(const unsigned char *in,
                                           unsigned char *out, RC2_KEY *key,
                                           int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_encrypt(unsigned long *data, RC2_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_decrypt(unsigned long *data, RC2_KEY *key);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_cbc_encrypt(const unsigned char *in,
                                           unsigned char *out, long length,
                                           RC2_KEY *ks, unsigned char *iv,
                                           int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_cfb64_encrypt(const unsigned char *in,
                                             unsigned char *out, long length,
                                             RC2_KEY *schedule,
                                             unsigned char *ivec,
                                             int *num, int enc);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RC2_ofb64_encrypt(const unsigned char *in,
                                             unsigned char *out, long length,
                                             RC2_KEY *schedule,
                                             unsigned char *ivec,
                                             int *num);
# 11 "test/buildtest_rc2.c" 2
