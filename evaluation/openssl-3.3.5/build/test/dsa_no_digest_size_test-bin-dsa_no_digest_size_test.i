# 0 "../test/dsa_no_digest_size_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/dsa_no_digest_size_test.c"
# 14 "../test/dsa_no_digest_size_test.c"
...
# 15 "../test/dsa_no_digest_size_test.c" 2
...
# 17 "../test/dsa_no_digest_size_test.c" 2
...
# 18 "../test/dsa_no_digest_size_test.c" 2
...
# 20 "../test/dsa_no_digest_size_test.c" 2
...
int RAND_poll(void);
# 24 "../test/dsa_no_digest_size_test.c" 2
...
static DSA *load_dsa_params(void)
{
    ...
    if (dsa == 
# 101 "../test/dsa_no_digest_size_test.c" 3 4
              ((void *)0)
# 101 "../test/dsa_no_digest_size_test.c"
                  )
        return 
# 102 "../test/dsa_no_digest_size_test.c" 3 4
              ((void *)0)
# 102 "../test/dsa_no_digest_size_test.c"
                  ;
    if (!DSA_set0_pqg(dsa, p = BN_bin2bn(dsap_2048, sizeof(dsap_2048), 
# 103 "../test/dsa_no_digest_size_test.c" 3 4
                                                                      ((void *)0)
# 103 "../test/dsa_no_digest_size_test.c"
                                                                          ),
                           q = BN_bin2bn(dsaq_2048, sizeof(dsaq_2048), 
# 104 "../test/dsa_no_digest_size_test.c" 3 4
                                                                      ((void *)0)
# 104 "../test/dsa_no_digest_size_test.c"
                                                                          ),
                           g = BN_bin2bn(dsag_2048, sizeof(dsag_2048), 
# 105 "../test/dsa_no_digest_size_test.c" 3 4
                                                                      ((void *)0)
# 105 "../test/dsa_no_digest_size_test.c"
                                                                          ))) {
        DSA_free(dsa);
        BN_free(p);
        BN_free(q);
        BN_free(g);
        return 
# 110 "../test/dsa_no_digest_size_test.c" 3 4
              ((void *)0)
# 110 "../test/dsa_no_digest_size_test.c"
                  ;
    }
    return dsa;
}
...
{
    if (!test_ptr("../test/dsa_no_digest_size_test.c", 117, "dsakey = load_dsa_params()", dsakey = load_dsa_params()))
        return 0;

    if (!test_int_eq("../test/dsa_no_digest_size_test.c", 120, "DSA_generate_key(dsakey)", "1", DSA_generate_key(dsakey), 1))
        return 0;
...
static int sign_and_verify(int len)
{
    ...
    size_t sigLength;
    int digestlen = ((BN_num_bits(DSA_get0_q(dsakey))+7)/8);
    int ok = 0;

    unsigned char *dataToSign = CRYPTO_malloc(len, "../test/dsa_no_digest_size_test.c", 137);
    unsigned char *paddedData = CRYPTO_malloc(digestlen, "../test/dsa_no_digest_size_test.c", 138);
    unsigned char *signature = 
# 139 "../test/dsa_no_digest_size_test.c" 3 4
                              ((void *)0)
# 139 "../test/dsa_no_digest_size_test.c"
                                  ;
    EVP_PKEY_CTX *ctx = 
# 140 "../test/dsa_no_digest_size_test.c" 3 4
                       ((void *)0)
# 140 "../test/dsa_no_digest_size_test.c"
                           ;
    EVP_PKEY *pkey = 
# 141 "../test/dsa_no_digest_size_test.c" 3 4
                    ((void *)0)
# 141 "../test/dsa_no_digest_size_test.c"
                        ;

    if (!test_ptr("../test/dsa_no_digest_size_test.c", 143, "dataToSign", dataToSign) ||
        !test_ptr("../test/dsa_no_digest_size_test.c", 144, "paddedData", paddedData) ||
        !test_int_eq("../test/dsa_no_digest_size_test.c", 145, "RAND_bytes(dataToSign, len)", "1", RAND_bytes(dataToSign, len), 1))
        goto end;
    ...
    if (!test_ptr("../test/dsa_no_digest_size_test.c", 154, "pkey = EVP_PKEY_new()", pkey = EVP_PKEY_new()))
        goto end;
    EVP_PKEY_set1_DSA(pkey, dsakey);

    if (!test_ptr("../test/dsa_no_digest_size_test.c", 158, "ctx = EVP_PKEY_CTX_new(pkey, NULL)", ctx = EVP_PKEY_CTX_new(pkey, 
# 158 "../test/dsa_no_digest_size_test.c" 3 4
        ((void *)0)
# 158 "../test/dsa_no_digest_size_test.c"
        )))
        goto end;
    if (!test_int_eq("../test/dsa_no_digest_size_test.c", 160, "EVP_PKEY_sign_init(ctx)", "1", EVP_PKEY_sign_init(ctx), 1))
        goto end;

    if (EVP_PKEY_sign(ctx, 
# 163 "../test/dsa_no_digest_size_test.c" 3 4
                          ((void *)0)
# 163 "../test/dsa_no_digest_size_test.c"
                              , &sigLength, dataToSign, len) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 164, "Failed to get signature length, len=%d", len);
        goto end;
    }

    if (!test_ptr("../test/dsa_no_digest_size_test.c", 168, "signature = OPENSSL_malloc(sigLength)", signature = CRYPTO_malloc(sigLength, "../test/dsa_no_digest_size_test.c", 168)))
        goto end;

    if (EVP_PKEY_sign(ctx, signature, &sigLength, dataToSign, len) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 172, "Failed to sign, len=%d", len);
        goto end;
    }


    if (!test_int_eq("../test/dsa_no_digest_size_test.c", 177, "EVP_PKEY_verify_init(ctx)", "1", EVP_PKEY_verify_init(ctx), 1))
        goto end;


    if (EVP_PKEY_verify(ctx, signature, sigLength, dataToSign, len) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 182, "EVP verify with unpadded length %d failed\n", len);
        goto end;
    }


    if (EVP_PKEY_verify(ctx, signature, sigLength, paddedData, digestlen) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 188, "EVP verify with length %d failed\n", len);
        goto end;
    }


    if (DSA_verify(0, dataToSign, len, signature, sigLength, dsakey) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 194, "Verification with unpadded data failed, len=%d", len);
        goto end;
    }

    if (DSA_verify(0, paddedData, digestlen, signature, sigLength, dsakey) != 1) {
        test_error("../test/dsa_no_digest_size_test.c", 199, "verify with length %d failed\n", len);
        goto end;
    }
    ...
    CRYPTO_free(signature, "../test/dsa_no_digest_size_test.c", 208);
    CRYPTO_free(paddedData, "../test/dsa_no_digest_size_test.c", 209);
    CRYPTO_free(dataToSign, "../test/dsa_no_digest_size_test.c", 210);
