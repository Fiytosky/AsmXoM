# 0 "../test/quic_wire_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_wire_test.c"
# 10 "../test/quic_wire_test.c"
...
# 15 "../include/internal/quic_wire.h" 2
...
# 16 "../include/internal/quic_wire.h" 2
...
# 14 "../include/internal/quic_types.h" 2
...
# 17 "../include/internal/quic_wire.h" 2
...
# 18 "../include/internal/quic_wire.h" 2
...
struct encode_test_case {
    ...
    int (*deserializer)(PACKET *pkt, ssize_t fail);
};


static int encode_case_1_enc(WPACKET *pkt)
{
    if (!test_int_eq("../test/quic_wire_test.c", 30, "ossl_quic_wire_encode_padding(pkt, 3)", "1", ossl_quic_wire_encode_padding(pkt, 3), 1))
        return 0;

    return 1;
}

static int encode_case_1_dec(PACKET *pkt, ssize_t fail)
{
    if (fail >= 0)

        return 1;

    if (!test_int_eq("../test/quic_wire_test.c", 42, "ossl_quic_wire_decode_padding(pkt)", "3", ossl_quic_wire_decode_padding(pkt), 3))
        return 0;
...
static int encode_case_2_enc(WPACKET *pkt)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 56, "ossl_quic_wire_encode_frame_ping(pkt)", "1", ossl_quic_wire_encode_frame_ping(pkt), 1))
        return 0;

    return 1;
}

static int encode_case_2_dec(PACKET *pkt, ssize_t fail)
{

    if (!test_int_eq("../test/quic_wire_test.c", 65, "ossl_quic_wire_decode_frame_ping(pkt)", "fail < 0", ossl_quic_wire_decode_frame_ping(pkt), fail < 0))
        return 0;
...
static const OSSL_QUIC_FRAME_ACK encode_case_3_f = {
    ...
    (sizeof(encode_case_3_ranges)/sizeof((encode_case_3_ranges)[0])),
    { (((uint64_t)1000000000) / 1000) },
    60, 70, 80, 1
};

static int encode_case_3_enc(WPACKET *pkt)
{
    if (!test_int_eq("../test/quic_wire_test.c", 90, "ossl_quic_wire_encode_frame_ack(pkt, 3, &encode_case_3_f)", "1", ossl_quic_wire_encode_frame_ack(pkt, 3, &encode_case_3_f), 1))
        return 0;

    return 1;
}

static int encode_case_3_dec(PACKET *pkt, ssize_t fail)
{
    ...
    f.ack_ranges = ranges;
    f.num_ack_ranges = (sizeof(ranges)/sizeof((ranges)[0]));

    ret = ossl_quic_wire_peek_frame_ack_num_ranges(pkt, &peek_total_ranges);
    if (fail < 0 && !test_int_eq("../test/quic_wire_test.c", 107, "ret", "1", ret, 1))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 110, "ossl_quic_wire_decode_frame_ack(pkt, 3, &f, &total_ranges)", "fail < 0", ossl_quic_wire_decode_frame_ack(pkt, 3, &f, &total_ranges), fail < 0))
        return 0;

    if (ret == 1 && !test_uint64_t_eq("../test/quic_wire_test.c", 113, "peek_total_ranges", "2", peek_total_ranges, 2))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 119, "total_ranges", "peek_total_ranges", total_ranges, peek_total_ranges))
        return 0;

    if (!test_uint64_t_le("../test/quic_wire_test.c", 122, "f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE)", "SIZE_MAX", f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE), 
# 122 "../test/quic_wire_test.c" 3 4
        (18446744073709551615UL)
# 122 "../test/quic_wire_test.c"
        )

        || !test_uint64_t_le("../test/quic_wire_test.c", 124, "encode_case_3_f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE)", "SIZE_MAX", encode_case_3_f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE), 
# 124 "../test/quic_wire_test.c" 3 4
           (18446744073709551615UL)
# 124 "../test/quic_wire_test.c"
           )

                                      )
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 129, "f.ack_ranges", "encode_case_3_f.ack_ranges", f.ack_ranges, (size_t)f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE), encode_case_3_f.ack_ranges, (size_t)encode_case_3_f.num_ack_ranges * sizeof(OSSL_QUIC_ACK_RANGE))


                                                                                          )
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 135, "ossl_time2ticks(f.delay_time)", "ossl_time2ticks(encode_case_3_f.delay_time)", ossl_time2ticks(f.delay_time), ossl_time2ticks(encode_case_3_f.delay_time))
                                                                      )
        return 0;

    if (!test_true("../test/quic_wire_test.c", 139, "f.ecn_present", (f.ecn_present) != 0))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 142, "f.ect0", "encode_case_3_f.ect0", f.ect0, encode_case_3_f.ect0))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 145, "f.ect1", "encode_case_3_f.ect1", f.ect1, encode_case_3_f.ect1))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 148, "f.ecnce", "encode_case_3_f.ecnce", f.ecnce, encode_case_3_f.ecnce))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 176, "ossl_quic_wire_encode_frame_reset_stream(pkt, &encode_case_4_f)", "1", ossl_quic_wire_encode_frame_reset_stream(pkt, &encode_case_4_f), 1)
                                                                                   )
        return 0;
...
static int encode_case_4_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_RESET_STREAM f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 187, "ossl_quic_wire_decode_frame_reset_stream(pkt, &f)", "fail < 0", ossl_quic_wire_decode_frame_reset_stream(pkt, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_mem_eq("../test/quic_wire_test.c", 193, "&f", "&encode_case_4_f", &f, sizeof(f), &encode_case_4_f, sizeof(encode_case_4_f)))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 213, "ossl_quic_wire_encode_frame_stop_sending(pkt, &encode_case_5_f)", "1", ossl_quic_wire_encode_frame_stop_sending(pkt, &encode_case_5_f), 1)
                                                                                   )
        return 0;
...
static int encode_case_5_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_STOP_SENDING f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 224, "ossl_quic_wire_decode_frame_stop_sending(pkt, &f)", "fail < 0", ossl_quic_wire_decode_frame_stop_sending(pkt, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_mem_eq("../test/quic_wire_test.c", 230, "&f", "&encode_case_5_f", &f, sizeof(f), &encode_case_5_f, sizeof(encode_case_5_f)))
        return 0;
...
{
    if (!test_ptr("../test/quic_wire_test.c", 253, "ossl_quic_wire_encode_frame_crypto(pkt, &encode_case_6_f)", ossl_quic_wire_encode_frame_crypto(pkt, &encode_case_6_f))
                                                                       )
        return 0;
...
static int encode_case_6_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_CRYPTO f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 264, "ossl_quic_wire_decode_frame_crypto(pkt, 0, &f)", "fail < 0", ossl_quic_wire_decode_frame_crypto(pkt, 0, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 270, "f.offset", "0x1234", f.offset, 0x1234))
        return 0;

    if (!test_uint64_t_le("../test/quic_wire_test.c", 273, "f.len", "SIZE_MAX", f.len, 
# 273 "../test/quic_wire_test.c" 3 4
        (18446744073709551615UL)
# 273 "../test/quic_wire_test.c"
        ))
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 276, "f.data", "encode_case_6_data", f.data, (size_t)f.len, encode_case_6_data, sizeof(encode_case_6_data))
                                                                    )
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 298, "ossl_quic_wire_encode_frame_new_token(pkt, encode_case_7_token, sizeof(encode_case_7_token))", "1", ossl_quic_wire_encode_frame_new_token(pkt, encode_case_7_token, sizeof(encode_case_7_token)), 1)
...
static int encode_case_7_dec(PACKET *pkt, ssize_t fail)
{
    const unsigned char *token = 
# 308 "../test/quic_wire_test.c" 3 4
                                ((void *)0)
# 308 "../test/quic_wire_test.c"
                                    ;
    size_t token_len = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 311, "ossl_quic_wire_decode_frame_new_token(pkt, &token, &token_len)", "fail < 0", ossl_quic_wire_decode_frame_new_token(pkt, &token, &token_len), fail < 0)
    ...
    if (!test_mem_eq("../test/quic_wire_test.c", 319, "token", "encode_case_7_token", token, token_len, encode_case_7_token, sizeof(encode_case_7_token))
                                                                      )
        return 0;
...
{
    if (!test_ptr("../test/quic_wire_test.c", 343, "ossl_quic_wire_encode_frame_stream(pkt, &encode_case_8_f)", ossl_quic_wire_encode_frame_stream(pkt, &encode_case_8_f))
                                                                       )
        return 0;
...
static int encode_case_8_dec(PACKET *pkt, ssize_t fail)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 361, "ossl_quic_wire_decode_frame_stream(pkt, 0, &f)", "fail < 0", ossl_quic_wire_decode_frame_stream(pkt, 0, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_le("../test/quic_wire_test.c", 367, "f.len", "SIZE_MAX", f.len, 
# 367 "../test/quic_wire_test.c" 3 4
        (18446744073709551615UL)
# 367 "../test/quic_wire_test.c"
        ))
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 370, "f.data", "encode_case_8_data", f.data, (size_t)f.len, encode_case_8_data, sizeof(encode_case_8_data))
                                                                    )
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 374, "f.stream_id", "0x1234", f.stream_id, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 377, "f.offset", "0", f.offset, 0))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 380, "f.has_explicit_len", "0", f.has_explicit_len, 0))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 383, "f.is_fin", "0", f.is_fin, 0))
        return 0;
...
{
    if (!test_ptr("../test/quic_wire_test.c", 405, "ossl_quic_wire_encode_frame_stream(pkt, &encode_case_9_f)", ossl_quic_wire_encode_frame_stream(pkt, &encode_case_9_f))
                                                                       )
        return 0;
...
static int encode_case_9_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_STREAM f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 416, "ossl_quic_wire_decode_frame_stream(pkt, 0, &f)", "fail < 0", ossl_quic_wire_decode_frame_stream(pkt, 0, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_le("../test/quic_wire_test.c", 422, "f.len", "SIZE_MAX", f.len, 
# 422 "../test/quic_wire_test.c" 3 4
        (18446744073709551615UL)
# 422 "../test/quic_wire_test.c"
        ))
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 425, "f.data", "encode_case_9_data", f.data, (size_t)f.len, encode_case_9_data, sizeof(encode_case_9_data))
                                                                    )
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 429, "f.stream_id", "0x1234", f.stream_id, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 432, "f.offset", "0x39", f.offset, 0x39))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 435, "f.has_explicit_len", "1", f.has_explicit_len, 1))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 438, "f.is_fin", "1", f.is_fin, 1))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 455, "ossl_quic_wire_encode_frame_max_data(pkt, 0x1234)", "1", ossl_quic_wire_encode_frame_max_data(pkt, 0x1234), 1))
        return 0;

    return 1;
}

static int encode_case_10_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t max_data = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 465, "ossl_quic_wire_decode_frame_max_data(pkt, &max_data)", "fail < 0", ossl_quic_wire_decode_frame_max_data(pkt, &max_data), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 471, "max_data", "0x1234", max_data, 0x1234))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 485, "ossl_quic_wire_encode_frame_max_stream_data(pkt, 0x1234, 0x9781)", "1", ossl_quic_wire_encode_frame_max_stream_data(pkt, 0x1234, 0x9781), 1)
...
static int encode_case_11_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t stream_id = 0, max_data = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 497, "ossl_quic_wire_decode_frame_max_stream_data(pkt, &stream_id, &max_data)", "fail < 0", ossl_quic_wire_decode_frame_max_stream_data(pkt, &stream_id, &max_data), fail < 0)
    ...
    if (!test_uint64_t_eq("../test/quic_wire_test.c", 505, "stream_id", "0x1234", stream_id, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 508, "max_data", "0x9781", max_data, 0x9781))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 523, "ossl_quic_wire_encode_frame_max_streams(pkt, 0, 0x1234)", "1", ossl_quic_wire_encode_frame_max_streams(pkt, 0, 0x1234), 1))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 526, "ossl_quic_wire_encode_frame_max_streams(pkt, 1, 0x9781)", "1", ossl_quic_wire_encode_frame_max_streams(pkt, 1, 0x9781), 1))
        return 0;

    return 1;
}

static int encode_case_12_dec(PACKET *pkt, ssize_t fail)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 539, "ossl_quic_wire_peek_frame_header(pkt, &frame_type_1, &is_minimal)", "success_if", ossl_quic_wire_peek_frame_header(pkt, &frame_type_1, &is_minimal), success_if)

                                )
        return 0;

    if (!test_true("../test/quic_wire_test.c", 544, "!success_if || is_minimal", (!success_if || is_minimal) != 0))
        return 0;

    success_if = (fail < 0 || fail >= 3);
    if (!test_int_eq("../test/quic_wire_test.c", 548, "ossl_quic_wire_decode_frame_max_streams(pkt, &max_streams_1)", "success_if", ossl_quic_wire_decode_frame_max_streams(pkt, &max_streams_1), success_if)

                                )
        return 0;

    success_if = (fail < 0 || fail >= 4);
    if (!test_int_eq("../test/quic_wire_test.c", 554, "ossl_quic_wire_peek_frame_header(pkt, &frame_type_2, &is_minimal)", "success_if", ossl_quic_wire_peek_frame_header(pkt, &frame_type_2, &is_minimal), success_if)

                                )
        return 0;

    if (!test_true("../test/quic_wire_test.c", 559, "!success_if || is_minimal", (!success_if || is_minimal) != 0))
        return 0;

    success_if = (fail < 0);
    if (!test_int_eq("../test/quic_wire_test.c", 563, "ossl_quic_wire_decode_frame_max_streams(pkt, &max_streams_2)", "success_if", ossl_quic_wire_decode_frame_max_streams(pkt, &max_streams_2), success_if)

                                )
        return 0;

    if ((fail < 0 || fail >= 3)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 569, "frame_type_1", "OSSL_QUIC_FRAME_TYPE_MAX_STREAMS_BIDI", frame_type_1, 0x12))
        return 0;

    if ((fail < 0 || fail >= 3)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 573, "max_streams_1", "0x1234", max_streams_1, 0x1234))
        return 0;

    if ((fail < 0 || fail >= 8)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 577, "frame_type_2", "OSSL_QUIC_FRAME_TYPE_MAX_STREAMS_UNI", frame_type_2, 0x13))
        return 0;

    if ((fail < 0 || fail >= 8)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 581, "max_streams_2", "0x9781", max_streams_2, 0x9781))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 597, "ossl_quic_wire_encode_frame_data_blocked(pkt, 0x1234)", "1", ossl_quic_wire_encode_frame_data_blocked(pkt, 0x1234), 1))
        return 0;

    return 1;
}

static int encode_case_13_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t max_data = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 607, "ossl_quic_wire_decode_frame_data_blocked(pkt, &max_data)", "fail < 0", ossl_quic_wire_decode_frame_data_blocked(pkt, &max_data), fail < 0)
                                                                                   )
        return 0;
    ...
    if (!test_uint64_t_eq("../test/quic_wire_test.c", 614, "max_data", "0x1234", max_data, 0x1234))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 628, "ossl_quic_wire_encode_frame_stream_data_blocked(pkt, 0x1234, 0x9781)", "1", ossl_quic_wire_encode_frame_stream_data_blocked(pkt, 0x1234, 0x9781), 1)
...
static int encode_case_14_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t stream_id = 0, max_data = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 640, "ossl_quic_wire_decode_frame_stream_data_blocked(pkt, &stream_id, &max_data)", "fail < 0", ossl_quic_wire_decode_frame_stream_data_blocked(pkt, &stream_id, &max_data), fail < 0)
    ...
    if (!test_uint64_t_eq("../test/quic_wire_test.c", 648, "stream_id", "0x1234", stream_id, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 651, "max_data", "0x9781", max_data, 0x9781))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 666, "ossl_quic_wire_encode_frame_streams_blocked(pkt, 0, 0x1234)", "1", ossl_quic_wire_encode_frame_streams_blocked(pkt, 0, 0x1234), 1))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 669, "ossl_quic_wire_encode_frame_streams_blocked(pkt, 1, 0x9781)", "1", ossl_quic_wire_encode_frame_streams_blocked(pkt, 1, 0x9781), 1))
        return 0;

    return 1;
}

static int encode_case_15_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t max_streams_1 = 0, max_streams_2 = 0,
            frame_type_1 = 0, frame_type_2 = 0;
    int is_minimal = 1, success_if;
    ...
    success_if = (fail < 0 || fail >= 1);
    if (!test_int_eq("../test/quic_wire_test.c", 682, "ossl_quic_wire_peek_frame_header(pkt, &frame_type_1, &is_minimal)", "success_if", ossl_quic_wire_peek_frame_header(pkt, &frame_type_1, &is_minimal), success_if)

                                )
        return 0;

    if (!test_true("../test/quic_wire_test.c", 687, "!success_if || is_minimal", (!success_if || is_minimal) != 0))
        return 0;

    success_if = (fail < 0 || fail >= 3);
    if (!test_int_eq("../test/quic_wire_test.c", 691, "ossl_quic_wire_decode_frame_streams_blocked(pkt, &max_streams_1)", "success_if", ossl_quic_wire_decode_frame_streams_blocked(pkt, &max_streams_1), success_if)

                                )
        return 0;

    success_if = (fail < 0 || fail >= 4);
    if (!test_int_eq("../test/quic_wire_test.c", 697, "ossl_quic_wire_peek_frame_header(pkt, &frame_type_2, &is_minimal)", "success_if", ossl_quic_wire_peek_frame_header(pkt, &frame_type_2, &is_minimal), success_if)

                                )
        return 0;

    if (!test_true("../test/quic_wire_test.c", 702, "!success_if || is_minimal", (!success_if || is_minimal) != 0))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 705, "ossl_quic_wire_decode_frame_streams_blocked(pkt, &max_streams_2)", "fail < 0 || fail >= 8", ossl_quic_wire_decode_frame_streams_blocked(pkt, &max_streams_2), fail < 0 || fail >= 8)

                                           )
        return 0;

    if ((fail < 0 || fail >= 1)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 711, "frame_type_1", "OSSL_QUIC_FRAME_TYPE_STREAMS_BLOCKED_BIDI", frame_type_1, 0x16))
        return 0;

    if ((fail < 0 || fail >= 3)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 715, "max_streams_1", "0x1234", max_streams_1, 0x1234))
        return 0;

    if ((fail < 0 || fail >= 4)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 719, "frame_type_2", "OSSL_QUIC_FRAME_TYPE_STREAMS_BLOCKED_UNI", frame_type_2, 0x17))
        return 0;

    if ((fail < 0 || fail >= 8)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 723, "max_streams_2", "0x9781", max_streams_2, 0x9781))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 758, "ossl_quic_wire_encode_frame_new_conn_id(pkt, &encode_case_16_f)", "1", ossl_quic_wire_encode_frame_new_conn_id(pkt, &encode_case_16_f), 1)
                                                                                   )
        return 0;
...
static int encode_case_16_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_NEW_CONN_ID f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 769, "ossl_quic_wire_decode_frame_new_conn_id(pkt, &f)", "fail < 0", ossl_quic_wire_decode_frame_new_conn_id(pkt, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 775, "f.seq_num", "0x9781", f.seq_num, 0x9781))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 778, "f.retire_prior_to", "0x1234", f.retire_prior_to, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 781, "f.conn_id.id_len", "sizeof(encode_case_16_conn_id)", f.conn_id.id_len, sizeof(encode_case_16_conn_id)))
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 784, "f.conn_id.id", "encode_case_16_conn_id", f.conn_id.id, f.conn_id.id_len, encode_case_16_conn_id, sizeof(encode_case_16_conn_id))
                                                                            )
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 788, "f.stateless_reset.token", "encode_case_16_f.stateless_reset.token", f.stateless_reset.token, sizeof(f.stateless_reset.token), encode_case_16_f.stateless_reset.token, sizeof(encode_case_16_f.stateless_reset.token))
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 825, "ossl_quic_wire_encode_frame_new_conn_id(pkt, &encode_case_16b_f)", "1", ossl_quic_wire_encode_frame_new_conn_id(pkt, &encode_case_16b_f), 1)
                                                                                    )
        return 0;
...
static int encode_case_16b_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_NEW_CONN_ID f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 836, "ossl_quic_wire_decode_frame_new_conn_id(pkt, &f)", "0", ossl_quic_wire_decode_frame_new_conn_id(pkt, &f), 0))
        return 0;

    if (!test_true("../test/quic_wire_test.c", 839, "PACKET_forward(pkt, PACKET_remaining(pkt))", (PACKET_forward(pkt, PACKET_remaining(pkt))) != 0))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 858, "ossl_quic_wire_encode_frame_retire_conn_id(pkt, 0x1234)", "1", ossl_quic_wire_encode_frame_retire_conn_id(pkt, 0x1234), 1))
        return 0;

    return 1;
}

static int encode_case_17_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t seq_num = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 868, "ossl_quic_wire_decode_frame_retire_conn_id(pkt, &seq_num)", "fail < 0", ossl_quic_wire_decode_frame_retire_conn_id(pkt, &seq_num), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 874, "seq_num", "0x1234", seq_num, 0x1234))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 891, "ossl_quic_wire_encode_frame_path_challenge(pkt, encode_case_18_data)", "1", ossl_quic_wire_encode_frame_path_challenge(pkt, encode_case_18_data), 1)
                                                                                        )
        return 0;
...
static int encode_case_18_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t challenge = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 902, "ossl_quic_wire_decode_frame_path_challenge(pkt, &challenge)", "fail < 0", ossl_quic_wire_decode_frame_path_challenge(pkt, &challenge), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 908, "challenge", "encode_case_18_data", challenge, encode_case_18_data))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 925, "ossl_quic_wire_encode_frame_path_response(pkt, encode_case_19_data)", "1", ossl_quic_wire_encode_frame_path_response(pkt, encode_case_19_data), 1)
                                                                                       )
        return 0;
...
static int encode_case_19_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t challenge = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 936, "ossl_quic_wire_decode_frame_path_response(pkt, &challenge)", "fail < 0", ossl_quic_wire_decode_frame_path_response(pkt, &challenge), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 942, "challenge", "encode_case_19_data", challenge, encode_case_19_data))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 970, "ossl_quic_wire_encode_frame_conn_close(pkt, &encode_case_20_f)", "1", ossl_quic_wire_encode_frame_conn_close(pkt, &encode_case_20_f), 1)
                                                                                  )
        return 0;
...
static int encode_case_20_dec(PACKET *pkt, ssize_t fail)
{
    OSSL_QUIC_FRAME_CONN_CLOSE f = {0};

    if (!test_int_eq("../test/quic_wire_test.c", 981, "ossl_quic_wire_decode_frame_conn_close(pkt, &f)", "fail < 0", ossl_quic_wire_decode_frame_conn_close(pkt, &f), fail < 0))
        return 0;

    if (fail >= 0)
        return 1;

    if (!test_int_eq("../test/quic_wire_test.c", 987, "f.is_app", "0", f.is_app, 0))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 990, "f.error_code", "0x1234", f.error_code, 0x1234))
        return 0;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 993, "f.frame_type", "0x9781", f.frame_type, 0x9781))
        return 0;

    if (!test_size_t_eq("../test/quic_wire_test.c", 996, "f.reason_len", "18", f.reason_len, 18))
        return 0;

    if (!test_mem_eq("../test/quic_wire_test.c", 999, "f.reason", "encode_case_20_f.reason", f.reason, f.reason_len, encode_case_20_f.reason, encode_case_20_f.reason_len)
                                                                          )
        return 0;
...
static int encode_case_21_enc(WPACKET *pkt)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 1019, "ossl_quic_wire_encode_frame_handshake_done(pkt)", "1", ossl_quic_wire_encode_frame_handshake_done(pkt), 1))
        return 0;

    return 1;
}

static int encode_case_21_dec(PACKET *pkt, ssize_t fail)
{

    if (!test_int_eq("../test/quic_wire_test.c", 1028, "ossl_quic_wire_decode_frame_handshake_done(pkt)", "fail < 0", ossl_quic_wire_decode_frame_handshake_done(pkt), fail < 0))
        return 0;
...
static int encode_case_22_enc(WPACKET *pkt)
{
    ...
    if (!test_ptr("../test/quic_wire_test.c", 1045, "ossl_quic_wire_encode_transport_param_bytes(pkt, 0x1234, encode_case_22_data, sizeof(encode_case_22_data))", ossl_quic_wire_encode_transport_param_bytes(pkt, 0x1234, encode_case_22_data, sizeof(encode_case_22_data)))

                                                                                           )
        return 0;

    if (!test_ptr("../test/quic_wire_test.c", 1050, "p = ossl_quic_wire_encode_transport_param_bytes(pkt, 0x9781, NULL, 2)", p = ossl_quic_wire_encode_transport_param_bytes(pkt, 0x9781, 
# 1050 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1050 "../test/quic_wire_test.c"
        , 2))
                                                                           )
        return 0;
...
static int encode_case_22_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t id = 0;
    size_t len = 0;
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 1067, "ossl_quic_wire_peek_transport_param(pkt, &id)", "fail < 0 || fail >= 2", ossl_quic_wire_peek_transport_param(pkt, &id), fail < 0 || fail >= 2)
                                           )
        return 0;

    if ((fail < 0 || fail >= 2)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1072, "id", "0x1234", id, 0x1234))
        return 0;
    ...
    if (fail < 0 || fail >= 8) {
        if (!test_ptr("../test/quic_wire_test.c", 1079, "p", p))
            return 0;
    } else {
        if (!test_ptr_null("../test/quic_wire_test.c", 1082, "p", p))
            return 0;
    }

    if ((fail < 0 || fail >= 8)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1087, "id", "0x1234", id, 0x1234))
        return 0;

    if ((fail < 0 || fail >= 8)
        && !test_mem_eq("../test/quic_wire_test.c", 1091, "p", "encode_case_22_data", p, len, encode_case_22_data, sizeof(encode_case_22_data)))
        return 0;

    if ((fail < 0 || fail >= 8)
        && !test_int_eq("../test/quic_wire_test.c", 1095, "ossl_quic_wire_peek_transport_param(pkt, &id)", "fail < 0 || fail >= 12", ossl_quic_wire_peek_transport_param(pkt, &id), fail < 0 || fail >= 12)
                                               )
        return 0;

    if ((fail < 0 || fail >= 12)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1100, "id", "0x9781", id, 0x9781))
        return 0;
    ...
    p = ossl_quic_wire_decode_transport_param_bytes(pkt, &id, &len);
    if (fail < 0 || fail >= 15) {
        if (!test_ptr("../test/quic_wire_test.c", 1107, "p", p))
            return 0;
    } else {
        if (!test_ptr_null("../test/quic_wire_test.c", 1110, "p", p))
            return 0;
    }

    if ((fail < 0 || fail >= 15)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1115, "id", "0x9781", id, 0x9781))
        return 0;

    if ((fail < 0 || fail >= 15)
        && !test_mem_eq("../test/quic_wire_test.c", 1119, "p", "data", p, len, data, sizeof(data)))
        return 0;
...
{
    if (!test_int_eq("../test/quic_wire_test.c", 1138, "ossl_quic_wire_encode_transport_param_int(pkt, 0x1234, 0x9781)", "1", ossl_quic_wire_encode_transport_param_int(pkt, 0x1234, 0x9781), 1))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 1141, "ossl_quic_wire_encode_transport_param_int(pkt, 0x2233, 0x4545)", "1", ossl_quic_wire_encode_transport_param_int(pkt, 0x2233, 0x4545), 1))
        return 0;

    return 1;
}

static int encode_case_23_dec(PACKET *pkt, ssize_t fail)
{
    uint64_t id = 0, value = 0;

    if (!test_int_eq("../test/quic_wire_test.c", 1151, "ossl_quic_wire_decode_transport_param_int(pkt, &id, &value)", "fail < 0 || fail >= 7", ossl_quic_wire_decode_transport_param_int(pkt, &id, &value), fail < 0 || fail >= 7)

                                           )
        return 0;

    if ((fail < 0 || fail >= 7)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1157, "id", "0x1234", id, 0x1234))
        return 0;

    if ((fail < 0 || fail >= 7)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1161, "value", "0x9781", value, 0x9781))
        return 0;

    if (!test_int_eq("../test/quic_wire_test.c", 1164, "ossl_quic_wire_decode_transport_param_int(pkt, &id, &value)", "fail < 0 || fail >= 14", ossl_quic_wire_decode_transport_param_int(pkt, &id, &value), fail < 0 || fail >= 14)

                                            )
        return 0;

    if ((fail < 0 || fail >= 14)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1170, "id", "0x2233", id, 0x2233))
        return 0;

    if ((fail < 0 || fail >= 14)
        && !test_uint64_t_eq("../test/quic_wire_test.c", 1174, "value", "0x4545", value, 0x4545))
        return 0;
...
# 1198 "../test/quic_wire_test.c"
static const struct encode_test_case encode_cases[] = {
    { encode_case_1_enc, encode_case_1_expect, (sizeof(encode_case_1_expect)/sizeof((encode_case_1_expect)[0])), encode_case_1_dec },
    { encode_case_2_enc, encode_case_2_expect, (sizeof(encode_case_2_expect)/sizeof((encode_case_2_expect)[0])), encode_case_2_dec },
    { encode_case_3_enc, encode_case_3_expect, (sizeof(encode_case_3_expect)/sizeof((encode_case_3_expect)[0])), encode_case_3_dec },
    { encode_case_4_enc, encode_case_4_expect, (sizeof(encode_case_4_expect)/sizeof((encode_case_4_expect)[0])), encode_case_4_dec },
    { encode_case_5_enc, encode_case_5_expect, (sizeof(encode_case_5_expect)/sizeof((encode_case_5_expect)[0])), encode_case_5_dec },
    { encode_case_6_enc, encode_case_6_expect, (sizeof(encode_case_6_expect)/sizeof((encode_case_6_expect)[0])), encode_case_6_dec },
    { encode_case_7_enc, encode_case_7_expect, (sizeof(encode_case_7_expect)/sizeof((encode_case_7_expect)[0])), encode_case_7_dec },
    { encode_case_8_enc, encode_case_8_expect, (sizeof(encode_case_8_expect)/sizeof((encode_case_8_expect)[0])), encode_case_8_dec },
    { encode_case_9_enc, encode_case_9_expect, (sizeof(encode_case_9_expect)/sizeof((encode_case_9_expect)[0])), encode_case_9_dec },
    { encode_case_10_enc, encode_case_10_expect, (sizeof(encode_case_10_expect)/sizeof((encode_case_10_expect)[0])), encode_case_10_dec },
    { encode_case_11_enc, encode_case_11_expect, (sizeof(encode_case_11_expect)/sizeof((encode_case_11_expect)[0])), encode_case_11_dec },
    { encode_case_12_enc, encode_case_12_expect, (sizeof(encode_case_12_expect)/sizeof((encode_case_12_expect)[0])), encode_case_12_dec },
    { encode_case_13_enc, encode_case_13_expect, (sizeof(encode_case_13_expect)/sizeof((encode_case_13_expect)[0])), encode_case_13_dec },
    { encode_case_14_enc, encode_case_14_expect, (sizeof(encode_case_14_expect)/sizeof((encode_case_14_expect)[0])), encode_case_14_dec },
    { encode_case_15_enc, encode_case_15_expect, (sizeof(encode_case_15_expect)/sizeof((encode_case_15_expect)[0])), encode_case_15_dec },
    { encode_case_16_enc, encode_case_16_expect, (sizeof(encode_case_16_expect)/sizeof((encode_case_16_expect)[0])), encode_case_16_dec },
    { encode_case_16b_enc, encode_case_16b_expect, (sizeof(encode_case_16b_expect)/sizeof((encode_case_16b_expect)[0])), encode_case_16b_dec },
    { encode_case_17_enc, encode_case_17_expect, (sizeof(encode_case_17_expect)/sizeof((encode_case_17_expect)[0])), encode_case_17_dec },
    { encode_case_18_enc, encode_case_18_expect, (sizeof(encode_case_18_expect)/sizeof((encode_case_18_expect)[0])), encode_case_18_dec },
    { encode_case_19_enc, encode_case_19_expect, (sizeof(encode_case_19_expect)/sizeof((encode_case_19_expect)[0])), encode_case_19_dec },
    { encode_case_20_enc, encode_case_20_expect, (sizeof(encode_case_20_expect)/sizeof((encode_case_20_expect)[0])), encode_case_20_dec },
    { encode_case_21_enc, encode_case_21_expect, (sizeof(encode_case_21_expect)/sizeof((encode_case_21_expect)[0])), encode_case_21_dec },
    { encode_case_22_enc, encode_case_22_expect, (sizeof(encode_case_22_expect)/sizeof((encode_case_22_expect)[0])), encode_case_22_dec },
    { encode_case_23_enc, encode_case_23_expect, (sizeof(encode_case_23_expect)/sizeof((encode_case_23_expect)[0])), encode_case_23_dec },
};
...
static int test_wire_encode(int idx)
{
    ...
    PACKET pkt;
    BUF_MEM *buf = 
# 1230 "../test/quic_wire_test.c" 3 4
                  ((void *)0)
# 1230 "../test/quic_wire_test.c"
                      ;
    size_t written;
    ...
    if (!test_ptr("../test/quic_wire_test.c", 1236, "buf = BUF_MEM_new()", buf = BUF_MEM_new()))
        goto err;

    if (!test_int_eq("../test/quic_wire_test.c", 1239, "WPACKET_init(&wpkt, buf)", "1", WPACKET_init(&wpkt, buf), 1))
        goto err;

    have_wpkt = 1;
    if (!test_int_eq("../test/quic_wire_test.c", 1243, "c->serializer(&wpkt)", "1", c->serializer(&wpkt), 1))
        goto err;

    if (!test_int_eq("../test/quic_wire_test.c", 1246, "WPACKET_get_total_written(&wpkt, &written)", "1", WPACKET_get_total_written(&wpkt, &written), 1))
        goto err;

    if (!test_mem_eq("../test/quic_wire_test.c", 1249, "buf->data", "c->expect_buf", buf->data, written, c->expect_buf, c->expect_buf_len))
        goto err;

    if (!test_int_eq("../test/quic_wire_test.c", 1252, "PACKET_buf_init(&pkt, (unsigned char *)buf->data, written)", "1", PACKET_buf_init(&pkt, (unsigned char *)buf->data, written), 1))
        goto err;

    if (!test_int_eq("../test/quic_wire_test.c", 1255, "c->deserializer(&pkt, -1)", "1", c->deserializer(&pkt, -1), 1))
        goto err;

    if (!test_false("../test/quic_wire_test.c", 1258, "PACKET_remaining(&pkt)", (PACKET_remaining(&pkt)) != 0))
        goto err;

    for (i = 0; i < c->expect_buf_len; ++i) {
        PACKET pkt2;
# 1271 "../test/quic_wire_test.c"
        if (!test_int_eq("../test/quic_wire_test.c", 1271, "PACKET_buf_init(&pkt2, (unsigned char *)c->expect_buf, i)", "1", PACKET_buf_init(&pkt2, (unsigned char *)c->expect_buf, i), 1))
            goto err;

        if (!test_int_eq("../test/quic_wire_test.c", 1274, "c->deserializer(&pkt2, i)", "1", c->deserializer(&pkt2, i), 1))
            goto err;
    }
...
static int ack_generic_decode(PACKET *pkt)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 1388, "ossl_quic_wire_peek_frame_ack_num_ranges(pkt, &peek_total_ranges)", "1", ossl_quic_wire_peek_frame_ack_num_ranges(pkt, &peek_total_ranges), 1)
                                                                                     )
        return 0;
    ...
    if (!test_uint64_t_eq("../test/quic_wire_test.c", 1396, "total_ranges", "peek_total_ranges", total_ranges, peek_total_ranges))
        return 0;

    for (i = 0; i < f.num_ack_ranges; ++i) {
        if (!test_uint64_t_le("../test/quic_wire_test.c", 1400, "f.ack_ranges[i].start", "f.ack_ranges[i].end", f.ack_ranges[i].start, f.ack_ranges[i].end))
            return 0;
        if (!test_uint64_t_lt("../test/quic_wire_test.c", 1402, "f.ack_ranges[i].end", "1000", f.ack_ranges[i].end, 1000))
            return 0;
    }

    return 1;
}
# 1417 "../test/quic_wire_test.c"
static const struct ack_test_case ack_cases[] = {
    { ack_case_1_input, sizeof(ack_case_1_input), (ack_generic_decode), (1) },
    { ack_case_2_input, sizeof(ack_case_2_input), (ack_generic_decode), (0) },
    { ack_case_3_input, sizeof(ack_case_3_input), (ack_generic_decode), (1) },
    { ack_case_4_input, sizeof(ack_case_4_input), (ack_generic_decode), (0) },
    { ack_case_5_input, sizeof(ack_case_5_input), (ack_generic_decode), (1) },
    { ack_case_6_input, sizeof(ack_case_6_input), (ack_generic_decode), (1) },
    { ack_case_7_input, sizeof(ack_case_7_input), (ack_generic_decode), (0) },
};
...
static int test_wire_ack(int idx)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 1433, "PACKET_buf_init(&pkt, (unsigned char *)c->input_buf, c->input_buf_len)", "1", PACKET_buf_init(&pkt, (unsigned char *)c->input_buf, c->input_buf_len), 1)
    ...
    if (c->expect_fail) {
        if (!test_int_eq("../test/quic_wire_test.c", 1440, "r", "0", r, 0))
            goto err;
    } else {
        if (!test_int_eq("../test/quic_wire_test.c", 1443, "r", "1", r, 1))
            goto err;

        if (!test_false("../test/quic_wire_test.c", 1446, "PACKET_remaining(&pkt)", (PACKET_remaining(&pkt)) != 0))
            goto err;
    }
...
static int test_wire_pkt_hdr_pn(int tidx)
{
    ...
    if (!test_int_eq("../test/quic_wire_test.c", 1495, "pn_len", "(int)t->expected_len", pn_len, (int)t->expected_len))
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1498, "ossl_quic_wire_encode_pkt_hdr_pn(t->pn, buf, pn_len)", (ossl_quic_wire_encode_pkt_hdr_pn(t->pn, buf, pn_len)) != 0))
        goto err;

    if (!test_mem_eq("../test/quic_wire_test.c", 1501, "t->expected_bytes", "buf", t->expected_bytes, t->expected_len, buf, pn_len))
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1504, "ossl_quic_wire_decode_pkt_hdr_pn(buf, pn_len, t->rx_largest_pn, &res_pn)", (ossl_quic_wire_decode_pkt_hdr_pn(buf, pn_len, t->rx_largest_pn, &res_pn)) != 0)
                                                                               )
        goto err;

    if (!test_uint64_t_eq("../test/quic_wire_test.c", 1508, "res_pn", "t->pn", res_pn, t->pn))
        goto err;
...
static int test_wire_retry_integrity_tag(void)
{
    ...
    PACKET pkt = {0};
    QUIC_PKT_HDR hdr = {0};
    unsigned char got_tag[16] = {0};

    if (!test_true("../test/quic_wire_test.c", 1542, "PACKET_buf_init(&pkt, retry_encoded, sizeof(retry_encoded))", (PACKET_buf_init(&pkt, retry_encoded, sizeof(retry_encoded))) != 0))
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1545, "ossl_quic_wire_decode_pkt_hdr(&pkt, 0, 0, 0, &hdr, NULL)", (ossl_quic_wire_decode_pkt_hdr(&pkt, 0, 0, 0, &hdr, 
# 1545 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1545 "../test/quic_wire_test.c"
        )) != 0))
        goto err;

    if (!test_int_eq("../test/quic_wire_test.c", 1548, "hdr.type", "QUIC_PKT_TYPE_RETRY", hdr.type, 4))
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1551, "ossl_quic_calculate_retry_integrity_tag(NULL, NULL, &hdr, &retry_orig_dcid, got_tag)", (ossl_quic_calculate_retry_integrity_tag(
# 1551 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1551 "../test/quic_wire_test.c"
        , 
# 1551 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1551 "../test/quic_wire_test.c"
        , &hdr, &retry_orig_dcid, got_tag)) != 0)

                                                                    )
        goto err;

    if (!test_mem_eq("../test/quic_wire_test.c", 1556, "got_tag", "retry_encoded + sizeof(retry_encoded) - QUIC_RETRY_INTEGRITY_TAG_LEN", got_tag, sizeof(got_tag), retry_encoded + sizeof(retry_encoded) - 16, 16)


                                                  )
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1562, "ossl_quic_validate_retry_integrity_tag(NULL, NULL, &hdr, &retry_orig_dcid)", (ossl_quic_validate_retry_integrity_tag(
# 1562 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1562 "../test/quic_wire_test.c"
        , 
# 1562 "../test/quic_wire_test.c" 3 4
        ((void *)0)
# 1562 "../test/quic_wire_test.c"
        , &hdr, &retry_orig_dcid)) != 0)
                                                                            )
        goto err;
...
static const size_t non_minimal_len[] = {
    (sizeof(non_minimal_1)/sizeof((non_minimal_1)[0])),
    (sizeof(non_minimal_2)/sizeof((non_minimal_2)[0])),
    (sizeof(non_minimal_3)/sizeof((non_minimal_3)[0])),
    (sizeof(non_minimal_4)/sizeof((non_minimal_4)[0])),
    (sizeof(non_minimal_5)/sizeof((non_minimal_5)[0])),
    (sizeof(non_minimal_6)/sizeof((non_minimal_6)[0])),
};
...
static int test_wire_minimal(int idx)
{
    ...
    if (!test_true("../test/quic_wire_test.c", 1621, "PACKET_buf_init(&pkt, non_minimal[idx], non_minimal_len[idx])", (PACKET_buf_init(&pkt, non_minimal[idx], non_minimal_len[idx])) != 0)
                                                         )
        goto err;

    if (!test_true("../test/quic_wire_test.c", 1625, "ossl_quic_wire_peek_frame_header(&pkt, &frame_type, &is_minimal)", (ossl_quic_wire_peek_frame_header(&pkt, &frame_type, &is_minimal)) != 0)
                                                                 )
        goto err;

    if (!test_false("../test/quic_wire_test.c", 1629, "is_minimal", (is_minimal) != 0))
        goto err;
...
int setup_tests(void)
{
    add_all_tests("test_wire_encode", test_wire_encode, (sizeof(encode_cases)/sizeof((encode_cases)[0])), 1);
    add_all_tests("test_wire_ack", test_wire_ack, (sizeof(ack_cases)/sizeof((ack_cases)[0])), 1);
    add_all_tests("test_wire_pkt_hdr_pn", test_wire_pkt_hdr_pn, (sizeof(pn_tests)/sizeof((pn_tests)[0])), 1);
    add_test("test_wire_retry_integrity_tag", test_wire_retry_integrity_tag);
    add_all_tests("test_wire_minimal", test_wire_minimal, (sizeof(non_minimal_len)/sizeof((non_minimal_len)[0])), 1);
    return 1;
}
