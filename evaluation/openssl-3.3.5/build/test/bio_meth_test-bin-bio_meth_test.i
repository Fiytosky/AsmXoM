# 0 "../test/bio_meth_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_meth_test.c"
# 10 "../test/bio_meth_test.c"
...
# 12 "../test/bio_meth_test.c" 2

static int test_bio_meth(void)
{
    int i, ret = 0, id;
    BIO_METHOD *meth1 = 
# 16 "../test/bio_meth_test.c" 3 4
                       ((void *)0)
# 16 "../test/bio_meth_test.c"
                           , *meth2 = 
# 16 "../test/bio_meth_test.c" 3 4
                                      ((void *)0)
# 16 "../test/bio_meth_test.c"
...
# 16 "../test/bio_meth_test.c"
                                                         ;
    BIO *membio = 
# 17 "../test/bio_meth_test.c" 3 4
                 ((void *)0)
# 17 "../test/bio_meth_test.c"
                     , *bio1 = 
# 17 "../test/bio_meth_test.c" 3 4
                               ((void *)0)
# 17 "../test/bio_meth_test.c"
...
# 17 "../test/bio_meth_test.c"
    ...
    if (!test_int_eq("../test/bio_meth_test.c", 20, "id", "BIO_TYPE_START + 1", id, 128 + 1))
        goto err;

    if (!test_ptr("../test/bio_meth_test.c", 23, "meth1 = BIO_meth_new(id, \"Method1\")", meth1 = BIO_meth_new(id, "Method1"))
        || !test_ptr("../test/bio_meth_test.c", 24, "meth2 = BIO_meth_new(BIO_TYPE_NONE, \"Method2\")", meth2 = BIO_meth_new(0, "Method2"))
        || !test_ptr("../test/bio_meth_test.c", 25, "meth3 = BIO_meth_new(BIO_TYPE_NONE|BIO_TYPE_FILTER, \"Method3\")", meth3 = BIO_meth_new(0|0x0200, "Method3"))
        || !test_ptr("../test/bio_meth_test.c", 26, "bio1 = BIO_new(meth1)", bio1 = BIO_new(meth1))
        || !test_ptr("../test/bio_meth_test.c", 27, "bio2 = BIO_new(meth2)", bio2 = BIO_new(meth2))
        || !test_ptr("../test/bio_meth_test.c", 28, "bio3 = BIO_new(meth3)", bio3 = BIO_new(meth3))
        || !test_ptr("../test/bio_meth_test.c", 29, "membio = BIO_new(BIO_s_mem())", membio = BIO_new(BIO_s_mem())))
        goto err;
    ...
    for (i = id + 1; i <= 0xFF; ++i) {
        if (!test_int_eq("../test/bio_meth_test.c", 38, "BIO_get_new_index()", "i", BIO_get_new_index(), i))
            goto err;
    }
    if (!test_int_eq("../test/bio_meth_test.c", 41, "BIO_get_new_index()", "-1", BIO_get_new_index(), -1))
        goto err;


    if (!test_ptr_eq("../test/bio_meth_test.c", 45, "BIO_find_type(bio3, BIO_TYPE_MEM)", "membio", BIO_find_type(bio3, ( 1|0x0400)), membio)
        || !test_ptr_eq("../test/bio_meth_test.c", 46, "BIO_find_type(bio3, id)", "bio1", BIO_find_type(bio3, id), bio1))
        goto err;


    if (!test_ptr_null("../test/bio_meth_test.c", 50, "BIO_find_type(bio3, BIO_TYPE_NONE)", BIO_find_type(bio3, 0)))
        goto err;

    if (!test_ptr_eq("../test/bio_meth_test.c", 53, "BIO_find_type(bio3, BIO_TYPE_FILTER)", "bio3", BIO_find_type(bio3, 0x0200), bio3))
        goto err;
    ret = 1;
err:
    BIO_free(membio);
...
int setup_tests(void)
{
    add_test("test_bio_meth", test_bio_meth);
    return 1;
}
