...
static int test_time_to_timeval(void)
{
    ...
    if (!test_long_eq("../test/time_test.c", 21, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 21, "tv.tv_usec", "0", tv.tv_usec, 0))
        return 0;


    if (!test_true("../test/time_test.c", 25, "ossl_time_is_zero(ossl_time_from_timeval(tv))", (ossl_time_is_zero(ossl_time_from_timeval(tv))) != 0))
        return 0;


    a = ossl_ticks2time(1);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 31, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 31, "tv.tv_usec", "1", tv.tv_usec, 1))
        return 0;
    a = ossl_ticks2time(999);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 35, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 35, "tv.tv_usec", "1", tv.tv_usec, 1))
        return 0;
    a = ossl_ticks2time(1000);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 39, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 39, "tv.tv_usec", "1", tv.tv_usec, 1))
        return 0;
    a = ossl_ticks2time(1001);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 43, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 43, "tv.tv_usec", "2", tv.tv_usec, 2))
        return 0;
    a = ossl_ticks2time(999000);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 47, "tv.tv_sec", "0", tv.tv_sec, 0) || !test_long_eq("../test/time_test.c", 47, "tv.tv_usec", "999", tv.tv_usec, 999))
        return 0;
    a = ossl_ticks2time(999999001);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 51, "tv.tv_sec", "1", tv.tv_sec, 1) || !test_long_eq("../test/time_test.c", 51, "tv.tv_usec", "0", tv.tv_usec, 0))
        return 0;
    a = ossl_ticks2time(999999999);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 55, "tv.tv_sec", "1", tv.tv_sec, 1) || !test_long_eq("../test/time_test.c", 55, "tv.tv_usec", "0", tv.tv_usec, 0))
        return 0;
    a = ossl_ticks2time(1000000000);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 59, "tv.tv_sec", "1", tv.tv_sec, 1) || !test_long_eq("../test/time_test.c", 59, "tv.tv_usec", "0", tv.tv_usec, 0))
        return 0;
    a = ossl_ticks2time(1000000001);
    tv = ossl_time_to_timeval(a);
    if (!test_long_eq("../test/time_test.c", 63, "tv.tv_sec", "1", tv.tv_sec, 1) || !test_long_eq("../test/time_test.c", 63, "tv.tv_usec", "1", tv.tv_usec, 1))
        return 0;
...
int setup_tests(void)
{
    add_test("test_time_to_timeval", test_time_to_timeval);
