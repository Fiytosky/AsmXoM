# 0 "../test/nodefltctxtest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/nodefltctxtest.c"
# 10 "../test/nodefltctxtest.c"
...
static int test_no_deflt_ctx_init(void)
{
    int testresult = 0;
    EVP_MD *md = 
# 21 "../test/nodefltctxtest.c" 3 4
                ((void *)0)
# 21 "../test/nodefltctxtest.c"
                    ;
    OSSL_LIB_CTX *ctx = OSSL_LIB_CTX_new();

    if (!test_ptr("../test/nodefltctxtest.c", 24, "ctx", ctx))
        return 0;

    md = EVP_MD_fetch(ctx, "SHA2-256", 
# 27 "../test/nodefltctxtest.c" 3 4
                                      ((void *)0)
# 27 "../test/nodefltctxtest.c"
                                          );
    if (!test_ptr("../test/nodefltctxtest.c", 28, "md", md))
        goto err;
    ...
    OPENSSL_init_crypto(0x00000080L, 
# 36 "../test/nodefltctxtest.c" 3 4
                                                    ((void *)0)
# 36 "../test/nodefltctxtest.c"
                                                        );
    ...
    if (!test_true("../test/nodefltctxtest.c", 44, "OSSL_PROVIDER_available(NULL, \"default\")", (OSSL_PROVIDER_available(
# 44 "../test/nodefltctxtest.c" 3 4
        ((void *)0)
# 44 "../test/nodefltctxtest.c"
        , "default")) != 0))
        goto err;
    if (!test_false("../test/nodefltctxtest.c", 46, "OSSL_PROVIDER_available(NULL, \"null\")", (OSSL_PROVIDER_available(
# 46 "../test/nodefltctxtest.c" 3 4
        ((void *)0)
# 46 "../test/nodefltctxtest.c"
        , "null")) != 0))
        goto err;
...
int setup_tests(void)
{
    add_test("test_no_deflt_ctx_init", test_no_deflt_ctx_init);
    return 1;
}
