# 0 "../test/quic_tserver_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_tserver_test.c"
# 9 "../test/quic_tserver_test.c"
...
static int do_test(int use_thread_assist, int use_fake_time, int use_inject)
{
    ...
    int s_fd = -1, c_fd = -1;
    BIO *s_net_bio = 
# 58 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 58 "../test/quic_tserver_test.c"
                        , *s_net_bio_own = 
# 58 "../test/quic_tserver_test.c" 3 4
                                           ((void *)0)
# 58 "../test/quic_tserver_test.c"
                                               ;
    BIO *c_net_bio = 
# 59 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 59 "../test/quic_tserver_test.c"
                        , *c_net_bio_own = 
# 59 "../test/quic_tserver_test.c" 3 4
                                           ((void *)0)
# 59 "../test/quic_tserver_test.c"
                                               ;
    BIO *c_pair_own = 
# 60 "../test/quic_tserver_test.c" 3 4
                     ((void *)0)
# 60 "../test/quic_tserver_test.c"
                         , *s_pair_own = 
# 60 "../test/quic_tserver_test.c" 3 4
                                         ((void *)0)
# 60 "../test/quic_tserver_test.c"
    ...
    QUIC_TSERVER *tserver = 
# 62 "../test/quic_tserver_test.c" 3 4
                           ((void *)0)
# 62 "../test/quic_tserver_test.c"
                               ;
    BIO_ADDR *s_addr_ = 
# 63 "../test/quic_tserver_test.c" 3 4
                       ((void *)0)
# 63 "../test/quic_tserver_test.c"
                           ;
    struct in_addr ina = {0};
    union BIO_sock_info_u s_info = {0};
    SSL_CTX *c_ctx = 
# 66 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 66 "../test/quic_tserver_test.c"
                        ;
    SSL *c_ssl = 
# 67 "../test/quic_tserver_test.c" 3 4
                ((void *)0)
# 67 "../test/quic_tserver_test.c"
                    ;
...
# 85 "../test/quic_tserver_test.c"
    ina.s_addr = htonl(0x7f000001UL);


    s_fd = BIO_socket(
# 88 "../test/quic_tserver_test.c" 3 4
                     2
# 88 "../test/quic_tserver_test.c"
                            , 
# 88 "../test/quic_tserver_test.c" 3 4
                              SOCK_DGRAM
# 88 "../test/quic_tserver_test.c"
...
# 88 "../test/quic_tserver_test.c"
                                                     , 0);
    if (!test_int_ge("../test/quic_tserver_test.c", 89, "s_fd", "0", s_fd, 0))
        goto err;

    if (!test_true("../test/quic_tserver_test.c", 92, "BIO_socket_nbio(s_fd, 1)", (BIO_socket_nbio(s_fd, 1)) != 0))
        goto err;

    if (!test_ptr("../test/quic_tserver_test.c", 95, "s_addr_ = BIO_ADDR_new()", s_addr_ = BIO_ADDR_new()))
        goto err;

    if (!test_true("../test/quic_tserver_test.c", 98, "BIO_ADDR_rawmake(s_addr_, AF_INET, &ina, sizeof(ina), 0)", (BIO_ADDR_rawmake(s_addr_, 
# 98 "../test/quic_tserver_test.c" 3 4
        2
# 98 "../test/quic_tserver_test.c"
        , &ina, sizeof(ina), 0)) != 0))
        goto err;

    if (!test_true("../test/quic_tserver_test.c", 101, "BIO_bind(s_fd, s_addr_, 0)", (BIO_bind(s_fd, s_addr_, 0)) != 0))
        goto err;

    s_info.addr = s_addr_;
    if (!test_true("../test/quic_tserver_test.c", 105, "BIO_sock_info(s_fd, BIO_SOCK_INFO_ADDRESS, &s_info)", (BIO_sock_info(s_fd, BIO_SOCK_INFO_ADDRESS, &s_info)) != 0))
        goto err;

    if (!test_int_gt("../test/quic_tserver_test.c", 108, "BIO_ADDR_rawport(s_addr_)", "0", BIO_ADDR_rawport(s_addr_), 0))
        goto err;

    if (!test_ptr("../test/quic_tserver_test.c", 111, "s_net_bio = s_net_bio_own = BIO_new_dgram(s_fd, 0)", s_net_bio = s_net_bio_own = BIO_new_dgram(s_fd, 0)))
        goto err;

    if (!BIO_up_ref(s_net_bio))
        goto err;

    fake_time = ossl_ticks2time((1000) * (((uint64_t)1000000000) / 1000));

    tserver_args.net_rbio = s_net_bio;
    tserver_args.net_wbio = s_net_bio;
    tserver_args.alpn = 
# 121 "../test/quic_tserver_test.c" 3 4
                       ((void *)0)
# 121 "../test/quic_tserver_test.c"
                           ;
    tserver_args.ctx = 
# 122 "../test/quic_tserver_test.c" 3 4
                      ((void *)0)
# 122 "../test/quic_tserver_test.c"
                          ;
    if (use_fake_time)
        tserver_args.now_cb = fake_now;

    if (!test_ptr("../test/quic_tserver_test.c", 126, "tserver = ossl_quic_tserver_new(&tserver_args, certfile, keyfile)", tserver = ossl_quic_tserver_new(&tserver_args, certfile, keyfile))
                                                           ) {
        BIO_free(s_net_bio);
        goto err;
    }
    ...
    s_net_bio_own = 
# 132 "../test/quic_tserver_test.c" 3 4
                   ((void *)0)
# 132 "../test/quic_tserver_test.c"
                       ;
    ...
    if (use_inject) {
        ...
        if (!test_true("../test/quic_tserver_test.c", 141, "BIO_new_bio_dgram_pair(&c_pair_own, 5000, &s_pair_own, 5000)", (BIO_new_bio_dgram_pair(&c_pair_own, 5000, &s_pair_own, 5000)) != 0)
                                                                 )
            goto err;
    }
    ...
    c_fd = BIO_socket(
# 147 "../test/quic_tserver_test.c" 3 4
                     2
# 147 "../test/quic_tserver_test.c"
                            , 
# 147 "../test/quic_tserver_test.c" 3 4
                              SOCK_DGRAM
# 147 "../test/quic_tserver_test.c"
...
# 147 "../test/quic_tserver_test.c"
                                                     , 0);
    if (!test_int_ge("../test/quic_tserver_test.c", 148, "c_fd", "0", c_fd, 0))
        goto err;

    if (!test_true("../test/quic_tserver_test.c", 151, "BIO_socket_nbio(c_fd, 1)", (BIO_socket_nbio(c_fd, 1)) != 0))
        goto err;

    if (!test_ptr("../test/quic_tserver_test.c", 154, "c_net_bio = c_net_bio_own = BIO_new_dgram(c_fd, 0)", c_net_bio = c_net_bio_own = BIO_new_dgram(c_fd, 0)))
        goto err;

    if (!(int)BIO_ctrl(c_net_bio, 44, 0, (char *)(s_addr_)))
        goto err;

    if (!test_ptr("../test/quic_tserver_test.c", 160, "c_ctx = SSL_CTX_new(use_thread_assist ? OSSL_QUIC_client_thread_method() : OSSL_QUIC_client_method())", c_ctx = SSL_CTX_new(use_thread_assist ? OSSL_QUIC_client_thread_method() : OSSL_QUIC_client_method()))

                                                                   )
        goto err;

    if (!test_ptr("../test/quic_tserver_test.c", 165, "c_ssl = SSL_new(c_ctx)", c_ssl = SSL_new(c_ctx)))
        goto err;

    if (use_fake_time)
        if (!test_true("../test/quic_tserver_test.c", 169, "ossl_quic_conn_set_override_now_cb(c_ssl, fake_now, NULL)", (ossl_quic_conn_set_override_now_cb(c_ssl, fake_now, 
# 169 "../test/quic_tserver_test.c" 3 4
            ((void *)0)
# 169 "../test/quic_tserver_test.c"
            )) != 0))
            goto err;


    if (!test_false("../test/quic_tserver_test.c", 173, "SSL_set_alpn_protos(c_ssl, alpn, sizeof(alpn))", (SSL_set_alpn_protos(c_ssl, alpn, sizeof(alpn))) != 0))
        goto err;
    ...
    if (use_inject) {
        ...
        c_pair_own = 
# 179 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 179 "../test/quic_tserver_test.c"
                        ;
    } else {
        SSL_set0_rbio(c_ssl, c_net_bio);


        if (!test_true("../test/quic_tserver_test.c", 184, "BIO_up_ref(c_net_bio)", (BIO_up_ref(c_net_bio)) != 0)) {
            c_net_bio_own = 
# 185 "../test/quic_tserver_test.c" 3 4
                           ((void *)0)
# 185 "../test/quic_tserver_test.c"
                               ;
            goto err;
        }
    }
    ...
    c_net_bio_own = 
# 191 "../test/quic_tserver_test.c" 3 4
                   ((void *)0)
# 191 "../test/quic_tserver_test.c"
                       ;

    if (!test_true("../test/quic_tserver_test.c", 193, "SSL_set_blocking_mode(c_ssl, 0)", (SSL_set_blocking_mode(c_ssl, 0)) != 0))
        goto err;
    ...
    start_time = real_now(
# 200 "../test/quic_tserver_test.c" 3 4
                         ((void *)0)
# 200 "../test/quic_tserver_test.c"
                             );

    for (;;) {
        if (ossl_time_compare(ossl_time_subtract(real_now(
# 203 "../test/quic_tserver_test.c" 3 4
                                                         ((void *)0)
# 203 "../test/quic_tserver_test.c"
                                                             ), start_time),
                              ossl_ticks2time((limit_ms) * (((uint64_t)1000000000) / 1000))) >= 0) {
            test_error("../test/quic_tserver_test.c", 205, "timeout while attempting QUIC server test");
            goto err;
        }

        if (!c_start_idle_test) {
            ret = SSL_connect(c_ssl);
            if (!test_true("../test/quic_tserver_test.c", 211, "ret == 1 || is_want(c_ssl, ret)", (ret == 1 || is_want(c_ssl, ret)) != 0))
                goto err;
        ...
        if (c_connected && !c_write_done) {
            if (!test_int_eq("../test/quic_tserver_test.c", 219, "SSL_write(c_ssl, msg1, sizeof(msg1) - 1)", "(int)sizeof(msg1) - 1", SSL_write(c_ssl, msg1, sizeof(msg1) - 1), (int)sizeof(msg1) - 1)
                                                   )
                goto err;

            if (!test_true("../test/quic_tserver_test.c", 223, "SSL_stream_conclude(c_ssl, 0)", (SSL_stream_conclude(c_ssl, 0)) != 0))
                goto err;
        ...
        if (c_connected && c_write_done && !s_read_done) {
            if (!ossl_quic_tserver_read(tserver, 0,
                ...
                if (!test_true("../test/quic_tserver_test.c", 233, "ossl_quic_tserver_has_read_ended(tserver, 0)", (ossl_quic_tserver_has_read_ended(tserver, 0)) != 0))
                    goto err;

                if (!test_mem_eq("../test/quic_tserver_test.c", 236, "msg1", "msg2", msg1, sizeof(msg1) - 1, msg2, s_total_read))
                    goto err;
                ...
                s_total_read += l;
                if (!test_size_t_le("../test/quic_tserver_test.c", 243, "s_total_read", "sizeof(msg1) - 1", s_total_read, sizeof(msg1) - 1))
                    goto err;
            }
        }

        if (s_begin_write && s_total_written < sizeof(msg1) - 1) {
            if (!test_true("../test/quic_tserver_test.c", 249, "ossl_quic_tserver_write(tserver, 0, (unsigned char *)msg2 + s_total_written, sizeof(msg1) - 1 - s_total_written, &l)", (ossl_quic_tserver_write(tserver, 0, (unsigned char *)msg2 + s_total_written, sizeof(msg1) - 1 - s_total_written, &l)) != 0)
        ...
        if (c_begin_read && c_total_read < sizeof(msg1) - 1) {
            ...
            if (!test_true("../test/quic_tserver_test.c", 265, "ret == 1 || is_want(c_ssl, ret)", (ret == 1 || is_want(c_ssl, ret)) != 0))
                goto err;

            c_total_read += l;

            if (c_total_read == sizeof(msg1) - 1) {
                if (!test_mem_eq("../test/quic_tserver_test.c", 271, "msg1", "msg3", msg1, sizeof(msg1) - 1, msg3, c_total_read)
                                                    )
                    goto err;
        ...
        if (c_wait_eos && !c_done_eos) {
            ...
            if (!test_false("../test/quic_tserver_test.c", 283, "ret", (ret) != 0))
                goto err;
            ...
            if (SSL_get_error(c_ssl, ret) != 2) {
                if (!test_int_eq("../test/quic_tserver_test.c", 291, "SSL_get_error(c_ssl, ret)", "SSL_ERROR_ZERO_RETURN", SSL_get_error(c_ssl, ret), 6)
                                                       )
                    goto err;

                c_done_eos = 1;
                if (use_thread_assist && use_fake_time) {
                    if (!test_true("../test/quic_tserver_test.c", 297, "ossl_quic_tserver_is_connected(tserver)", (ossl_quic_tserver_is_connected(tserver)) != 0))
                        goto err;
                    c_start_idle_test = 1;
                    limit_ms = 120000;
                } else {
        ...
        if (c_start_idle_test && !c_done_idle_test) {
            ...
            if (idle_units_done < 600) {
                ...
                if (!test_true("../test/quic_tserver_test.c", 314, "CRYPTO_THREAD_write_lock(fake_time_lock)", (CRYPTO_THREAD_write_lock(fake_time_lock)) != 0))
                    goto err;
                fake_time = ossl_time_add(fake_time, ossl_ticks2time((100) * (((uint64_t)1000000000) / 1000)));
                CRYPTO_THREAD_unlock(fake_time_lock);
                ...
                if (!test_true("../test/quic_tserver_test.c", 326, "SSL_get_event_timeout(c_ssl, &tv, &isinf)", (SSL_get_event_timeout(c_ssl, &tv, &isinf)) != 0))
                    goto err;
        ...
        if (c_done_idle_test) {
            ...
            if (!test_true("../test/quic_tserver_test.c", 341, "ossl_quic_tserver_is_connected(tserver)", (ossl_quic_tserver_is_connected(tserver)) != 0))
                goto err;
        ...
        if (use_inject) {
            ...
            for (;;) {
                ...
                if (!test_true("../test/quic_tserver_test.c", 376, "SSL_inject_net_dgram(c_ssl, rmsg.data, rmsg.data_len, NULL, NULL)", (SSL_inject_net_dgram(c_ssl, rmsg.data, rmsg.data_len, 
# 376 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 376 "../test/quic_tserver_test.c"
                    , 
# 376 "../test/quic_tserver_test.c" 3 4
                    ((void *)0)
# 376 "../test/quic_tserver_test.c"
...
# 418 "../test/quic_tserver_test.c" 3 4
((void *)0) 
# 418 "../test/quic_tserver_test.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/quic_tserver_test.c", 423, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/quic_tserver_test.c", 427, "certfile = test_get_argument(0)", certfile = test_get_argument(0))
            || !test_ptr("../test/quic_tserver_test.c", 428, "keyfile = test_get_argument(1)", keyfile = test_get_argument(1)))
        return 0;

    if ((fake_time_lock = CRYPTO_THREAD_lock_new()) == 
# 431 "../test/quic_tserver_test.c" 3 4
                                                      ((void *)0)
# 431 "../test/quic_tserver_test.c"
                                                          )
        return 0;

    add_all_tests("test_tserver", test_tserver, 2 * 2 * 2, 1);
    return 1;
}
