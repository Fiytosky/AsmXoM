# 0 "../test/provfetchtest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/provfetchtest.c"
# 10 "../test/provfetchtest.c"
...
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
# 20 "../include/openssl/decoder.h" 2
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
...
int RAND_poll(void);
# 16 "../test/provfetchtest.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../test/provfetchtest.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
static const OSSL_DISPATCH dummy_decoder_functions[] = {
    { 11, (void (*)(void))dummy_decoder_decode },
    { 0, 
# 28 "../test/provfetchtest.c" 3 4
   ((void *)0) 
# 28 "../test/provfetchtest.c"
   }
};
...
static const OSSL_ALGORITHM dummy_decoders[] = {
    ...
    { 
# 33 "../test/provfetchtest.c" 3 4
     ((void *)0)
# 33 "../test/provfetchtest.c"
         , 
# 33 "../test/provfetchtest.c" 3 4
           ((void *)0)
# 33 "../test/provfetchtest.c"
...
static const OSSL_DISPATCH dummy_encoder_functions[] = {
    { 11, (void (*)(void))dummy_encoder_encode },
    { 0, 
# 46 "../test/provfetchtest.c" 3 4
   ((void *)0) 
# 46 "../test/provfetchtest.c"
   }
};
...
static const OSSL_ALGORITHM dummy_encoders[] = {
    ...
    { 
# 51 "../test/provfetchtest.c" 3 4
     ((void *)0)
# 51 "../test/provfetchtest.c"
         , 
# 51 "../test/provfetchtest.c" 3 4
           ((void *)0)
# 51 "../test/provfetchtest.c"
...
{
    return 
# 56 "../test/provfetchtest.c" 3 4
          ((void *)0)
# 56 "../test/provfetchtest.c"
              ;
}
...
static const OSSL_DISPATCH dummy_store_functions[] = {
    { 1, (void (*)(void))dummy_store_open },
    { 5, (void (*)(void))dummy_store_load },
    { 6, (void (*)(void))dumm_store_eof },
    { 7, (void (*)(void))dummy_store_close },
    { 0, 
# 81 "../test/provfetchtest.c" 3 4
   ((void *)0) 
# 81 "../test/provfetchtest.c"
   }
};
...
static const OSSL_ALGORITHM dummy_store[] = {
    ...
    { 
# 86 "../test/provfetchtest.c" 3 4
     ((void *)0)
# 86 "../test/provfetchtest.c"
         , 
# 86 "../test/provfetchtest.c" 3 4
           ((void *)0)
# 86 "../test/provfetchtest.c"
...
static const OSSL_PARAM *dummy_rand_gettable_ctx_params(void *vctx, void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("max_request")), (2), ((
# 127 "../test/provfetchtest.c" 3 4
       ((void *)0)
# 127 "../test/provfetchtest.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 128 "../test/provfetchtest.c" 3 4
       ((void *)0)
# 128 "../test/provfetchtest.c"
       , 0, 
# 128 "../test/provfetchtest.c" 3 4
       ((void *)0)
# 128 "../test/provfetchtest.c"
...
static int dummy_rand_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 138 "../test/provfetchtest.c" 3 4
            ((void *)0) 
# 138 "../test/provfetchtest.c"
...
static const OSSL_DISPATCH dummy_rand_functions[] = {
    { 1, (void (*)(void))dummy_rand_newctx },
    { 2, (void (*)(void))dummy_rand_freectx },
    { 3, (void (*)(void))dummy_rand_instantiate },
    { 4, (void (*)(void))dummy_rand_uninstantiate },
    { 5, (void (*)(void))dummy_rand_generate },
    { 12,
      (void(*)(void))dummy_rand_gettable_ctx_params },
    { 15, (void(*)(void))dummy_rand_get_ctx_params },
    { 8, (void(*)(void))dummy_rand_enable_locking },
    { 9, (void(*)(void))dummy_rand_lock },
    { 10, (void(*)(void))dummy_rand_unlock },
    { 0, 
# 170 "../test/provfetchtest.c" 3 4
   ((void *)0) 
# 170 "../test/provfetchtest.c"
   }
};
...
static const OSSL_ALGORITHM dummy_rand[] = {
    ...
    { 
# 175 "../test/provfetchtest.c" 3 4
     ((void *)0)
# 175 "../test/provfetchtest.c"
         , 
# 175 "../test/provfetchtest.c" 3 4
           ((void *)0)
# 175 "../test/provfetchtest.c"
                                         ...
                                         int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 192 "../test/provfetchtest.c" 3 4
          ((void *)0)
# 192 "../test/provfetchtest.c"
              ;
}

static const OSSL_DISPATCH dummy_dispatch_table[] = {
    { 1027, (void (*)(void))dummy_query },
    { 1024, (void (*)(void))OSSL_LIB_CTX_free },
    { 0, 
# 198 "../test/provfetchtest.c" 3 4
   ((void *)0) 
# 198 "../test/provfetchtest.c"
   }
};
...
# 230 "../test/provfetchtest.c"
static int fetch_test(int tst)
{
    OSSL_LIB_CTX *libctx = OSSL_LIB_CTX_new();
    OSSL_PROVIDER *dummyprov = 
# 233 "../test/provfetchtest.c" 3 4
                              ((void *)0)
# 233 "../test/provfetchtest.c"
                                  ;
    OSSL_PROVIDER *nullprov = 
# 234 "../test/provfetchtest.c" 3 4
                             ((void *)0)
# 234 "../test/provfetchtest.c"
                                 ;
    OSSL_DECODER *decoder = 
# 235 "../test/provfetchtest.c" 3 4
                           ((void *)0)
# 235 "../test/provfetchtest.c"
                               ;
    OSSL_ENCODER *encoder = 
# 236 "../test/provfetchtest.c" 3 4
                           ((void *)0)
# 236 "../test/provfetchtest.c"
                               ;
    OSSL_STORE_LOADER *loader = 
# 237 "../test/provfetchtest.c" 3 4
                               ((void *)0)
# 237 "../test/provfetchtest.c"
                                   ;
    int testresult = 0;
    unsigned char buf[32];
    int query = tst > 3;

    if (!test_ptr("../test/provfetchtest.c", 242, "libctx", libctx))
        goto err;

    if (!test_true("../test/provfetchtest.c", 245, "OSSL_PROVIDER_add_builtin(libctx, \"dummy-prov\", dummy_provider_init)", (OSSL_PROVIDER_add_builtin(libctx, "dummy-prov", dummy_provider_init)) != 0)

            || !test_ptr("../test/provfetchtest.c", 247, "nullprov = OSSL_PROVIDER_load(libctx, \"default\")", nullprov = OSSL_PROVIDER_load(libctx, "default"))
            || !test_ptr("../test/provfetchtest.c", 248, "dummyprov = OSSL_PROVIDER_load(libctx, \"dummy-prov\")", dummyprov = OSSL_PROVIDER_load(libctx, "dummy-prov")))
        goto err;

    switch (tst % 4) {
    case 0:
        decoder = OSSL_DECODER_fetch(libctx, "DUMMY",
                                     query ? "provider=dummy" : 
# 254 "../test/provfetchtest.c" 3 4
                                                               ((void *)0)
# 254 "../test/provfetchtest.c"
                                                                   );
        if (!test_ptr("../test/provfetchtest.c", 255, "decoder", decoder))
            goto err;
        break;
    case 1:
        encoder = OSSL_ENCODER_fetch(libctx, "DUMMY",
                                     query ? "provider=dummy" : 
# 260 "../test/provfetchtest.c" 3 4
                                                               ((void *)0)
# 260 "../test/provfetchtest.c"
                                                                   );
        if (!test_ptr("../test/provfetchtest.c", 261, "encoder", encoder))
            goto err;
        break;
    case 2:
        loader = OSSL_STORE_LOADER_fetch(libctx, "DUMMY",
                                         query ? "provider=dummy" : 
# 266 "../test/provfetchtest.c" 3 4
                                                                   ((void *)0)
# 266 "../test/provfetchtest.c"
                                                                       );
        if (!test_ptr("../test/provfetchtest.c", 267, "loader", loader))
            goto err;
        break;
    case 3:
        if (!test_true("../test/provfetchtest.c", 271, "RAND_set_DRBG_type(libctx, \"DUMMY\", query ? \"provider=dummy\" : NULL, NULL, NULL)", (RAND_set_DRBG_type(libctx, "DUMMY", query ? "provider=dummy" : 
# 271 "../test/provfetchtest.c" 3 4
            ((void *)0)
# 271 "../test/provfetchtest.c"
            , 
# 271 "../test/provfetchtest.c" 3 4
            ((void *)0)
# 271 "../test/provfetchtest.c"
...
# 271 "../test/provfetchtest.c"
                ...
                || !test_int_ge("../test/provfetchtest.c", 274, "RAND_bytes_ex(libctx, buf, sizeof(buf), 0)", "1", RAND_bytes_ex(libctx, buf, sizeof(buf), 0), 1))
            goto err;
        break;
    default:
        goto err;
