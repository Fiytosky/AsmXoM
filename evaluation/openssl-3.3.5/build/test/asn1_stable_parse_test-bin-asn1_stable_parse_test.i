# 0 "../test/asn1_stable_parse_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_stable_parse_test.c"
# 10 "../test/asn1_stable_parse_test.c"
...
# 11 "../test/asn1_stable_parse_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 12 "../test/asn1_stable_parse_test.c" 2

static char *config_file = 
# 13 "../test/asn1_stable_parse_test.c" 3 4
                          ((void *)0)
# 13 "../test/asn1_stable_parse_test.c"
                              ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 28 "../test/asn1_stable_parse_test.c" 3 4
         ((void *)0) 
# 28 "../test/asn1_stable_parse_test.c"
              }
    };
    return options;
}
...
static int test_asn1_stable_parse(void)
{
    ...
    if (!test_ptr("../test/asn1_stable_parse_test.c", 44, "newctx", newctx))
        goto out;

    if (!test_int_eq("../test/asn1_stable_parse_test.c", 47, "OSSL_LIB_CTX_load_config(newctx, config_file)", "0", OSSL_LIB_CTX_load_config(newctx, config_file), 0))
        goto err;

    errcode = ERR_peek_error();
    if (ERR_GET_LIB(errcode) != 13)
        goto err;
    if (ERR_GET_REASON(errcode) != 218)
        goto err;
...
int setup_tests(void)
{
    ...
    add_test("test_asn1_stable_parse", test_asn1_stable_parse);
    return 1;
}
