# 0 "test/buildtest_mdc2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_mdc2.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MDC2_Init(MDC2_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MDC2_Update(MDC2_CTX *c, const unsigned char *data,
                                      size_t len);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int MDC2_Final(unsigned char *md, MDC2_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned char *MDC2(const unsigned char *d, size_t n,
                                          unsigned char *md);
# 11 "test/buildtest_mdc2.c" 2
