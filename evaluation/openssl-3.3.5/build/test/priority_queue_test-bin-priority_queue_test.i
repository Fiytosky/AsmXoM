# 0 "../test/priority_queue_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/priority_queue_test.c"
# 10 "../test/priority_queue_test.c"
...
# 11 "../test/priority_queue_test.c" 2
...
# 12 "../test/priority_queue_test.c" 2
...
# 14 "../test/priority_queue_test.c" 2
...
# 15 "../include/internal/priority_queue.h" 2
...
# 15 "../test/priority_queue_test.c" 2
...
# 16 "../test/priority_queue_test.c" 2


# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 19 "../test/priority_queue_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 20 "../test/priority_queue_test.c" 2



typedef struct ossl_priority_queue_st_size_t OSSL_PRIORITY_QUEUE_size_t; static __attribute__((unused)) inline OSSL_PRIORITY_QUEUE_size_t * ossl_pqueue_size_t_new(int (*compare)(const size_t *, const size_t *)) { return (OSSL_PRIORITY_QUEUE_size_t *)ossl_pqueue_new( (int (*)(const void *, const void *))compare); } static __attribute__((unused)) inline void ossl_pqueue_size_t_free(OSSL_PRIORITY_QUEUE_size_t *pq) { ossl_pqueue_free((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline void ossl_pqueue_size_t_pop_free(OSSL_PRIORITY_QUEUE_size_t *pq, void (*freefunc)(size_t *)) { ossl_pqueue_pop_free((OSSL_PQUEUE *)pq, (void (*)(void *))freefunc); } static __attribute__((unused)) inline int ossl_pqueue_size_t_reserve(OSSL_PRIORITY_QUEUE_size_t *pq, size_t n) { return ossl_pqueue_reserve((OSSL_PQUEUE *)pq, n); } static __attribute__((unused)) inline size_t ossl_pqueue_size_t_num(const OSSL_PRIORITY_QUEUE_size_t *pq) { return ossl_pqueue_num((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline int ossl_pqueue_size_t_push(OSSL_PRIORITY_QUEUE_size_t *pq, size_t *data, size_t *elem) { return ossl_pqueue_push((OSSL_PQUEUE *)pq, (void *)data, elem); } static __attribute__((unused)) inline size_t * ossl_pqueue_size_t_peek(const OSSL_PRIORITY_QUEUE_size_t *pq) { return (size_t *)ossl_pqueue_peek((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline size_t * ossl_pqueue_size_t_pop(OSSL_PRIORITY_QUEUE_size_t *pq) { return (size_t *)ossl_pqueue_pop((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline size_t * ossl_pqueue_size_t_remove(OSSL_PRIORITY_QUEUE_size_t *pq, size_t elem) { return (size_t *)ossl_pqueue_remove((OSSL_PQUEUE *)pq, elem); } struct ossl_priority_queue_st_size_t;
...
static void free_checker(__attribute__((unused)) size_t *p)
{
    num_rec_freed++;
}
...
{
    OSSL_PRIORITY_QUEUE_size_t *pq = 
# 54 "../test/priority_queue_test.c" 3 4
                                   ((void *)0)
# 54 "../test/priority_queue_test.c"
                                       ;
    static size_t values[500000], sorted[500000], ref[500000];
    size_t n;
    int i, res = 0;
    static const char *orders[3] = { "unordered", "ascending", "descending" };

    test_info("../test/priority_queue_test.c", 60, "testing count %d, %s, %s, values %s, remove %d, %sfree", count, orders[order], reserve ? "reserve" : "grow", random ? "random" : "deterministic", remove, popfree ? "pop " : "")


                                    ;

    if (!test_size_t_le("../test/priority_queue_test.c", 65, "count", "MAX_SAMPLES", count, 500000))
        return 0;
    ...
    if (!test_ptr("../test/priority_queue_test.c", 82, "pq = ossl_pqueue_size_t_new(&size_t_compare)", pq = ossl_pqueue_size_t_new(&size_t_compare))
            || !test_size_t_eq("../test/priority_queue_test.c", 83, "ossl_pqueue_size_t_num(pq)", "0", ossl_pqueue_size_t_num(pq), 0))
        goto err;

    if (reserve && !test_true("../test/priority_queue_test.c", 86, "ossl_pqueue_size_t_reserve(pq, count)", (ossl_pqueue_size_t_reserve(pq, count)) != 0))
        goto err;

    for (i = 0; i < count; i++)
        if (!test_true("../test/priority_queue_test.c", 90, "ossl_pqueue_size_t_push(pq, values + i, ref + i)", (ossl_pqueue_size_t_push(pq, values + i, ref + i)) != 0))
            goto err;

    if (!test_size_t_eq("../test/priority_queue_test.c", 93, "*ossl_pqueue_size_t_peek(pq)", "*sorted", *ossl_pqueue_size_t_peek(pq), *sorted)
            || !test_size_t_eq("../test/priority_queue_test.c", 94, "ossl_pqueue_size_t_num(pq)", "count", ossl_pqueue_size_t_num(pq), count))
        goto err;
    ...
    if (remove) {
        while (remove-- > 0) {
            i = test_random() % count;
            if (values[i] != 
# 100 "../test/priority_queue_test.c" 3 4
                            (18446744073709551615UL)
# 100 "../test/priority_queue_test.c"
                                    ) {
                if (!test_ptr_eq("../test/priority_queue_test.c", 101, "ossl_pqueue_size_t_remove(pq, ref[i])", "values + i", ossl_pqueue_size_t_remove(pq, ref[i]), values + i)
                                            )
                    goto err;
                values[i] = 
# 104 "../test/priority_queue_test.c" 3 4
                           (18446744073709551615UL)
# 104 "../test/priority_queue_test.c"
                                   ;
            }
        }
        memcpy(sorted, values, sizeof(*sorted) * count);
    ...
    for (i = 0; ossl_pqueue_size_t_peek(pq) != 
# 110 "../test/priority_queue_test.c" 3 4
                                              ((void *)0)
# 110 "../test/priority_queue_test.c"
                                                  ; i++)
        if (!test_size_t_eq("../test/priority_queue_test.c", 111, "*ossl_pqueue_size_t_peek(pq)", "sorted[i]", *ossl_pqueue_size_t_peek(pq), sorted[i])
                || !test_size_t_eq("../test/priority_queue_test.c", 112, "*ossl_pqueue_size_t_pop(pq)", "sorted[i]", *ossl_pqueue_size_t_pop(pq), sorted[i]))
                goto err;
    ...
    if (popfree) {
        ...
        pq = 
# 119 "../test/priority_queue_test.c" 3 4
            ((void *)0)
# 119 "../test/priority_queue_test.c"
                ;
        if (!test_size_t_eq("../test/priority_queue_test.c", 120, "num_rec_freed", "n", num_rec_freed, n))
            goto err;
    }
    res = 1;
 err:
...
static int test_size_t_priority_queue(int n)
{
    ...
    count = n % (sizeof(test_size_t_priority_counts)/sizeof((test_size_t_priority_counts)[0]));
    n /= (sizeof(test_size_t_priority_counts)/sizeof((test_size_t_priority_counts)[0]));
    order = n % 3;
    n /= 3;
    random = n % 2;
    n /= 2;
...
{
    return test_size_t_priority_queue_int(0, 0, 500000, 500000 / 100,
                                          1, 1);
}
...
typedef struct ossl_priority_queue_st_INFO OSSL_PRIORITY_QUEUE_INFO; static __attribute__((unused)) inline OSSL_PRIORITY_QUEUE_INFO * ossl_pqueue_INFO_new(int (*compare)(const INFO *, const INFO *)) { return (OSSL_PRIORITY_QUEUE_INFO *)ossl_pqueue_new( (int (*)(const void *, const void *))compare); } static __attribute__((unused)) inline void ossl_pqueue_INFO_free(OSSL_PRIORITY_QUEUE_INFO *pq) { ossl_pqueue_free((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline void ossl_pqueue_INFO_pop_free(OSSL_PRIORITY_QUEUE_INFO *pq, void (*freefunc)(INFO *)) { ossl_pqueue_pop_free((OSSL_PQUEUE *)pq, (void (*)(void *))freefunc); } static __attribute__((unused)) inline int ossl_pqueue_INFO_reserve(OSSL_PRIORITY_QUEUE_INFO *pq, size_t n) { return ossl_pqueue_reserve((OSSL_PQUEUE *)pq, n); } static __attribute__((unused)) inline size_t ossl_pqueue_INFO_num(const OSSL_PRIORITY_QUEUE_INFO *pq) { return ossl_pqueue_num((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline int ossl_pqueue_INFO_push(OSSL_PRIORITY_QUEUE_INFO *pq, INFO *data, size_t *elem) { return ossl_pqueue_push((OSSL_PQUEUE *)pq, (void *)data, elem); } static __attribute__((unused)) inline INFO * ossl_pqueue_INFO_peek(const OSSL_PRIORITY_QUEUE_INFO *pq) { return (INFO *)ossl_pqueue_peek((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline INFO * ossl_pqueue_INFO_pop(OSSL_PRIORITY_QUEUE_INFO *pq) { return (INFO *)ossl_pqueue_pop((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline INFO * ossl_pqueue_INFO_remove(OSSL_PRIORITY_QUEUE_INFO *pq, size_t elem) { return (INFO *)ossl_pqueue_remove((OSSL_PQUEUE *)pq, elem); } struct ossl_priority_queue_st_INFO;
...
static int test_22644(void)
{
    ...
    INFO infos[32];
    int res = 0;
    OSSL_PRIORITY_QUEUE_INFO *pq = ossl_pqueue_INFO_new(cmp);
    ...
    if (!test_true("../test/priority_queue_test.c", 192, "ossl_pqueue_INFO_push(pq, &infos[0], &infos[0].idx)", (ossl_pqueue_INFO_push(pq, &infos[0], &infos[0].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 193, "infos[0].idx", "7", infos[0].idx, 7)
            || !test_ptr("../test/priority_queue_test.c", 194, "ossl_pqueue_INFO_remove(pq, infos[0].idx)", ossl_pqueue_INFO_remove(pq, infos[0].idx)))
        goto err;

    infos[1].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 198, "ossl_pqueue_INFO_push(pq, &infos[1], &infos[1].idx)", (ossl_pqueue_INFO_push(pq, &infos[1], &infos[1].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 199, "infos[1].idx", "7", infos[1].idx, 7)
            || !test_ptr("../test/priority_queue_test.c", 200, "ossl_pqueue_INFO_remove(pq, infos[1].idx)", ossl_pqueue_INFO_remove(pq, infos[1].idx)))
        goto err;

    infos[2].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 204, "ossl_pqueue_INFO_push(pq, &infos[2], &infos[2].idx)", (ossl_pqueue_INFO_push(pq, &infos[2], &infos[2].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 205, "infos[2].idx", "7", infos[2].idx, 7))
        goto err;

    infos[3].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 209, "ossl_pqueue_INFO_push(pq, &infos[3], &infos[3].idx)", (ossl_pqueue_INFO_push(pq, &infos[3], &infos[3].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 210, "infos[3].idx", "6", infos[3].idx, 6))
        goto err;

    infos[4].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 214, "ossl_pqueue_INFO_push(pq, &infos[4], &infos[4].idx)", (ossl_pqueue_INFO_push(pq, &infos[4], &infos[4].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 215, "infos[4].idx", "5", infos[4].idx, 5))
        goto err;

    infos[5].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 219, "ossl_pqueue_INFO_push(pq, &infos[5], &infos[5].idx)", (ossl_pqueue_INFO_push(pq, &infos[5], &infos[5].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 220, "infos[5].idx", "4", infos[5].idx, 4))
        goto err;

    infos[6].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 224, "ossl_pqueue_INFO_push(pq, &infos[6], &infos[6].idx)", (ossl_pqueue_INFO_push(pq, &infos[6], &infos[6].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 225, "infos[6].idx", "3", infos[6].idx, 3))
        goto err;

    infos[7].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 229, "ossl_pqueue_INFO_push(pq, &infos[7], &infos[7].idx)", (ossl_pqueue_INFO_push(pq, &infos[7], &infos[7].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 230, "infos[7].idx", "2", infos[7].idx, 2))
        goto err;

    infos[8].seq_num = 289360691352306692;
    if (!test_true("../test/priority_queue_test.c", 234, "ossl_pqueue_INFO_push(pq, &infos[8], &infos[8].idx)", (ossl_pqueue_INFO_push(pq, &infos[8], &infos[8].idx)) != 0)
            || !test_size_t_eq("../test/priority_queue_test.c", 235, "infos[8].idx", "1", infos[8].idx, 1))
        goto err;

    if (!test_ptr("../test/priority_queue_test.c", 238, "ossl_pqueue_INFO_pop(pq)", ossl_pqueue_INFO_pop(pq))
            || !test_ptr("../test/priority_queue_test.c", 239, "ossl_pqueue_INFO_pop(pq)", ossl_pqueue_INFO_pop(pq)))
        goto err;
    res = 1;
...
int setup_tests(void)
{
    add_all_tests("test_size_t_priority_queue", test_size_t_priority_queue, (sizeof(test_size_t_priority_counts)/sizeof((test_size_t_priority_counts)[0])) * 3 * 2 * 2 * 6 * 2, 1)
