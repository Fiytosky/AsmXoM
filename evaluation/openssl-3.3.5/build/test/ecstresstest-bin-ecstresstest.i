# 0 "../test/ecstresstest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ecstresstest.c"
# 11 "../test/ecstresstest.c"
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 12 "../test/ecstresstest.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
...
# 18 "../test/ecstresstest.c" 2




# 21 "../test/ecstresstest.c"
...
{
    BIGNUM *scalar = 
# 45 "../test/ecstresstest.c" 3 4
                    ((void *)0)
# 45 "../test/ecstresstest.c"
                        ;
    ossl_intmax_t i;

    if (!test_ptr("../test/ecstresstest.c", 48, "scalar = BN_new()", scalar = BN_new())
            || !test_true("../test/ecstresstest.c", 49, "EC_POINT_get_affine_coordinates(group, point, scalar, NULL, NULL)", (EC_POINT_get_affine_coordinates(group, point, scalar, 
# 49 "../test/ecstresstest.c" 3 4
               ((void *)0)
# 49 "../test/ecstresstest.c"
               , 
# 49 "../test/ecstresstest.c" 3 4
               ((void *)0)
# 49 "../test/ecstresstest.c"
    ...
    for (i = 0; i < num; i++) {
        if (!test_true("../test/ecstresstest.c", 54, "EC_POINT_mul(group, point, NULL, point, scalar, NULL)", (EC_POINT_mul(group, point, 
# 54 "../test/ecstresstest.c" 3 4
            ((void *)0)
# 54 "../test/ecstresstest.c"
            , point, scalar, 
# 54 "../test/ecstresstest.c" 3 4
            ((void *)0)
# 54 "../test/ecstresstest.c"
            )) != 0)
                || !test_true("../test/ecstresstest.c", 55, "EC_POINT_get_affine_coordinates(group, point, scalar, NULL, NULL)", (EC_POINT_get_affine_coordinates(group, point, scalar, 
# 55 "../test/ecstresstest.c" 3 4
                   ((void *)0)
# 55 "../test/ecstresstest.c"
                   , 
# 55 "../test/ecstresstest.c" 3 4
                   ((void *)0)
# 55 "../test/ecstresstest.c"
...
err:
    BN_free(scalar);
    return 
# 64 "../test/ecstresstest.c" 3 4
          ((void *)0)
# 64 "../test/ecstresstest.c"
              ;
}
...
{
    EC_GROUP *group = 
# 69 "../test/ecstresstest.c" 3 4
                     ((void *)0)
# 69 "../test/ecstresstest.c"
                         ;
    EC_POINT *point = 
# 70 "../test/ecstresstest.c" 3 4
                     ((void *)0)
# 70 "../test/ecstresstest.c"
                         ;
    BIGNUM *result = 
# 71 "../test/ecstresstest.c" 3 4
                    ((void *)0)
# 71 "../test/ecstresstest.c"
                        , *expected_result = 
# 71 "../test/ecstresstest.c" 3 4
                                             ((void *)0)
# 71 "../test/ecstresstest.c"
    ...
    if (!test_ptr("../test/ecstresstest.c", 78, "group = EC_GROUP_new_by_curve_name(NID_X9_62_prime256v1)", group = EC_GROUP_new_by_curve_name(415))
            || !test_ptr("../test/ecstresstest.c", 79, "point = EC_POINT_dup(EC_GROUP_get0_generator(group), group)", point = EC_POINT_dup(EC_GROUP_get0_generator(group), group))

            || !test_ptr("../test/ecstresstest.c", 81, "result = walk_curve(group, point, num_repeats)", result = walk_curve(group, point, num_repeats)))
        goto err;
    ...
    if (print_mode) {
        ...
        if (!test_true("../test/ecstresstest.c", 89, "BN_hex2bn(&expected_result, kP256DefaultResult)", (BN_hex2bn(&expected_result, kP256DefaultResult)) != 0)
                || !test_ptr("../test/ecstresstest.c", 90, "expected_result", expected_result)
                || !test_BN_eq("../test/ecstresstest.c", 91, "result", "expected_result", result, expected_result))
            goto err;
        ret = 1;
    }
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 117 "../test/ecstresstest.c" 3 4
         ((void *)0) 
# 117 "../test/ecstresstest.c"
              }
    };
    return test_options;
}
...
int setup_tests(void)
{
    ...
    if (!opt_intmax("1000000", &num_repeats)) {
        test_error("../test/ecstresstest.c", 132, "Cannot parse " "1000000");
        return 0;
    }
    ...
    add_test("test_curve", test_curve);
