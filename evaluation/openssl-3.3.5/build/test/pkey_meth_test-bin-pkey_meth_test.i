# 0 "../test/pkey_meth_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/pkey_meth_test.c"
# 15 "../test/pkey_meth_test.c"
...
# 32 "../test/pkey_meth_test.c" 3 4
                                         ((void *)0)
# 32 "../test/pkey_meth_test.c"
                                             , 
# 32 "../test/pkey_meth_test.c" 3 4
                                               ((void *)0)
# 32 "../test/pkey_meth_test.c"
...
# 32 "../test/pkey_meth_test.c"
    ...
    if (!good) {
        test_error("../test/pkey_meth_test.c", 39, "EVP_PKEY_ASN1_METHOD table out of order");
        for (i = 0; i < EVP_PKEY_asn1_get_count(); i++) {
            const char *info;

            ameth = EVP_PKEY_asn1_get0(i);
            EVP_PKEY_asn1_get0_info(&pkey_id, 
# 44 "../test/pkey_meth_test.c" 3 4
                                             ((void *)0)
# 44 "../test/pkey_meth_test.c"
                                                 , 
# 44 "../test/pkey_meth_test.c" 3 4
                                                   ((void *)0)
# 44 "../test/pkey_meth_test.c"
...
# 44 "../test/pkey_meth_test.c"
                                                                    , ameth);
            if (info == 
# 45 "../test/pkey_meth_test.c" 3 4
                       ((void *)0)
# 45 "../test/pkey_meth_test.c"
                           )
                info = "<NO NAME>";
...
static int test_pkey_meths(void)
{
    ...
    for (i = 0; i < EVP_PKEY_meth_get_count(); i++) {
        ...
        EVP_PKEY_meth_get0_info(&pkey_id, 
# 65 "../test/pkey_meth_test.c" 3 4
                                         ((void *)0)
# 65 "../test/pkey_meth_test.c"
                                             , pmeth);
        if (pkey_id < prev)
            good = 0;
        prev = pkey_id;
    ...
    if (!good) {
        test_error("../test/pkey_meth_test.c", 72, "EVP_PKEY_METHOD table out of order");
        for (i = 0; i < EVP_PKEY_meth_get_count(); i++) {
            pmeth = EVP_PKEY_meth_get0(i);
            EVP_PKEY_meth_get0_info(&pkey_id, 
# 75 "../test/pkey_meth_test.c" 3 4
                                             ((void *)0)
# 75 "../test/pkey_meth_test.c"
                                                 , pmeth);
...
int setup_tests(void)
{
    ...
    add_test("test_pkey_meths", test_pkey_meths);
