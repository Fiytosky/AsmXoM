# 0 "../test/endecode_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/endecode_test.c"
# 10 "../test/endecode_test.c"
...
# 16 "../include/openssl/core_dispatch.h" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 14 "../test/endecode_test.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../test/endecode_test.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 23 "../test/endecode_test.c" 2
# 1 "../include/crypto/pem.h" 1
# 12 "../include/crypto/pem.h"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 25 "../test/endecode_test.c" 2

# 1 "../test/helpers/predefined_dhparams.h" 1
# 13 "../test/helpers/predefined_dhparams.h"
...
# 28 "../test/endecode_test.c" 2


OSSL_provider_init_fn ossl_legacy_provider_init;
# 48 "../test/endecode_test.c"
static int default_libctx = 1;
static int is_fips = 0;
static int is_fips_3_0_0 = 0;

static OSSL_LIB_CTX *testctx = 
# 52 "../test/endecode_test.c" 3 4
                              ((void *)0)
# 52 "../test/endecode_test.c"
                                  ;
static OSSL_LIB_CTX *keyctx = 
# 53 "../test/endecode_test.c" 3 4
                             ((void *)0)
# 53 "../test/endecode_test.c"
                                 ;
static char *testpropq = 
# 54 "../test/endecode_test.c" 3 4
                        ((void *)0)
# 54 "../test/endecode_test.c"
                            ;

static OSSL_PROVIDER *nullprov = 
# 56 "../test/endecode_test.c" 3 4
                                ((void *)0)
# 56 "../test/endecode_test.c"
                                    ;
static OSSL_PROVIDER *deflprov = 
# 57 "../test/endecode_test.c" 3 4
                                ((void *)0)
# 57 "../test/endecode_test.c"
                                    ;
static OSSL_PROVIDER *keyprov = 
# 58 "../test/endecode_test.c" 3 4
                               ((void *)0)
# 58 "../test/endecode_test.c"
                                   ;


static BN_CTX *bnctx = 
# 61 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 61 "../test/endecode_test.c"
                          ;
static OSSL_PARAM_BLD *bld_prime_nc = 
# 62 "../test/endecode_test.c" 3 4
                                     ((void *)0)
# 62 "../test/endecode_test.c"
                                         ;
static OSSL_PARAM_BLD *bld_prime = 
# 63 "../test/endecode_test.c" 3 4
                                  ((void *)0)
# 63 "../test/endecode_test.c"
                                      ;
static OSSL_PARAM *ec_explicit_prime_params_nc = 
# 64 "../test/endecode_test.c" 3 4
                                                ((void *)0)
# 64 "../test/endecode_test.c"
                                                    ;
static OSSL_PARAM *ec_explicit_prime_params_explicit = 
# 65 "../test/endecode_test.c" 3 4
                                                      ((void *)0)
# 65 "../test/endecode_test.c"
                                                          ;


static OSSL_PARAM_BLD *bld_tri_nc = 
# 68 "../test/endecode_test.c" 3 4
                                   ((void *)0)
# 68 "../test/endecode_test.c"
                                       ;
static OSSL_PARAM_BLD *bld_tri = 
# 69 "../test/endecode_test.c" 3 4
                                ((void *)0)
# 69 "../test/endecode_test.c"
                                    ;
static OSSL_PARAM *ec_explicit_tri_params_nc = 
# 70 "../test/endecode_test.c" 3 4
                                              ((void *)0)
# 70 "../test/endecode_test.c"
                                                  ;
static OSSL_PARAM *ec_explicit_tri_params_explicit = 
# 71 "../test/endecode_test.c" 3 4
                                                    ((void *)0)
# 71 "../test/endecode_test.c"
                                                        ;
...
{
    EVP_PKEY *pkey = 
# 78 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 78 "../test/endecode_test.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 79 "../test/endecode_test.c" 3 4
                       ((void *)0)
# 79 "../test/endecode_test.c"
                           ;
...
# 97 "../test/endecode_test.c" 3 4
                                                                         ((void *)0)
           
# 98 "../test/endecode_test.c"
          && EVP_PKEY_paramgen_init(ctx) > 0
           && (genparams == 
# 99 "../test/endecode_test.c" 3 4
                           ((void *)0)
               
# 100 "../test/endecode_test.c"
...
{
    EVP_PKEY *pkey = 
# 112 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 112 "../test/endecode_test.c"
                        ;
    EVP_PKEY_CTX *ctx =
        template != 
# 114 "../test/endecode_test.c" 3 4
                   ((void *)0)
        
# 115 "../test/endecode_test.c"
    ...
    (void)(ctx != 
# 122 "../test/endecode_test.c" 3 4
                 ((void *)0)
           
# 123 "../test/endecode_test.c"
          && EVP_PKEY_keygen_init(ctx) > 0
           && (genparams == 
# 124 "../test/endecode_test.c" 3 4
                           ((void *)0)
               
# 125 "../test/endecode_test.c"
              || EVP_PKEY_CTX_set_params(ctx, genparams) > 0)
...
{
    void *encoded = 
# 162 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 162 "../test/endecode_test.c"
                       ;
    long encoded_len = 0;
    EVP_PKEY *pkey2 = 
# 164 "../test/endecode_test.c" 3 4
                     ((void *)0)
# 164 "../test/endecode_test.c"
                         ;
    EVP_PKEY *pkey3 = 
# 165 "../test/endecode_test.c" 3 4
                     ((void *)0)
# 165 "../test/endecode_test.c"
                         ;
    void *encoded2 = 
# 166 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 166 "../test/endecode_test.c"
                        ;
    long encoded2_len = 0;
    int ok = 0;
    ...
    if (!test_true("../test/endecode_test.c", 175, "encode_cb(file, line, &encoded, &encoded_len, pkey, selection, output_type, output_structure, pass, pcipher)", (encode_cb(file, line, &encoded, &encoded_len, pkey, selection, output_type, output_structure, pass, pcipher)) != 0)
                                                                           )
        goto end;

    if ((flags & 0x0002) != 0 && is_fips && !is_fips_3_0_0) {
        if (test_false("../test/endecode_test.c", 180, "decode_cb(file, line, (void **)&pkey2, encoded, encoded_len, output_type, output_structure, (flags & FLAG_DECODE_WITH_TYPE ? type : NULL), selection, pass)", (decode_cb(file, line, (void **)&pkey2, encoded, encoded_len, output_type, output_structure, (flags & 0x0001 ? type : 
# 180 "../test/endecode_test.c" 3 4
           ((void *)0)
# 180 "../test/endecode_test.c"
           ), selection, pass)) != 0)
    ...
    if (!test_true("../test/endecode_test.c", 188, "check_cb(file, line, type, encoded, encoded_len)", (check_cb(file, line, type, encoded, encoded_len)) != 0)
        || !test_true("../test/endecode_test.c", 189, "decode_cb(file, line, (void **)&pkey2, encoded, encoded_len, output_type, output_structure, (flags & FLAG_DECODE_WITH_TYPE ? type : NULL), selection, pass)", (decode_cb(file, line, (void **)&pkey2, encoded, encoded_len, output_type, output_structure, (flags & 0x0001 ? type : 
# 189 "../test/endecode_test.c" 3 4
           ((void *)0)
# 189 "../test/endecode_test.c"
           ), selection, pass)) != 0)



        || ((output_structure == 
# 193 "../test/endecode_test.c" 3 4
                                ((void *)0)
             
# 194 "../test/endecode_test.c"
            || strcmp(output_structure, "type-specific") != 0)
            && !test_true("../test/endecode_test.c", 195, "decode_cb(file, line, (void **)&pkey3, encoded, encoded_len, output_type, output_structure, (flags & FLAG_DECODE_WITH_TYPE ? type : NULL), 0, pass)", (decode_cb(file, line, (void **)&pkey3, encoded, encoded_len, output_type, output_structure, (flags & 0x0001 ? type : 
# 195 "../test/endecode_test.c" 3 4
               ((void *)0)
# 195 "../test/endecode_test.c"
               ), 0, pass)) != 0)


                                             )
        || !test_true("../test/endecode_test.c", 199, "encode_cb(file, line, &encoded2, &encoded2_len, pkey2, selection, output_type, output_structure, pass, pcipher)", (encode_cb(file, line, &encoded2, &encoded2_len, pkey2, selection, output_type, output_structure, pass, pcipher)) != 0)
                                                                              )
        goto end;

    if (selection == 0x04) {
        if (!test_int_eq("../test/endecode_test.c", 204, "EVP_PKEY_parameters_eq(pkey, pkey2)", "1", EVP_PKEY_parameters_eq(pkey, pkey2), 1)
            || (pkey3 != 
# 205 "../test/endecode_test.c" 3 4
                        ((void *)0)
                
# 206 "../test/endecode_test.c"
               && !test_int_eq("../test/endecode_test.c", 206, "EVP_PKEY_parameters_eq(pkey, pkey3)", "1", EVP_PKEY_parameters_eq(pkey, pkey3), 1)))
            goto end;
    } else {
        if (!test_int_eq("../test/endecode_test.c", 209, "EVP_PKEY_eq(pkey, pkey2)", "1", EVP_PKEY_eq(pkey, pkey2), 1)
            || (pkey3 != 
# 210 "../test/endecode_test.c" 3 4
                        ((void *)0)
                
# 211 "../test/endecode_test.c"
               && !test_int_eq("../test/endecode_test.c", 211, "EVP_PKEY_eq(pkey, pkey3)", "1", EVP_PKEY_eq(pkey, pkey3), 1)))
            goto end;
    }
    ...
    if ((pass == 
# 220 "../test/endecode_test.c" 3 4
                ((void *)0) 
# 220 "../test/endecode_test.c"
                     && pcipher == 
# 220 "../test/endecode_test.c" 3 4
                                   ((void *)0)
# 220 "../test/endecode_test.c"
    ...
    if (!ok) {
        if (encoded != 
# 227 "../test/endecode_test.c" 3 4
                      ((void *)0) 
# 227 "../test/endecode_test.c"
                           && encoded_len != 0)
            dump_cb("|pkey| encoded", encoded, encoded_len);
        if (encoded2 != 
# 229 "../test/endecode_test.c" 3 4
                       ((void *)0) 
# 229 "../test/endecode_test.c"
                            && encoded2_len != 0)
            dump_cb("|pkey2| encoded", encoded2, encoded2_len);
    }

    CRYPTO_free(encoded, "../test/endecode_test.c", 233);
    CRYPTO_free(encoded2, "../test/endecode_test.c", 234);
    EVP_PKEY_free(pkey2);
    EVP_PKEY_free(pkey3);
    return ok;
}
...
# 250 "../test/endecode_test.c" 3 4
                            ((void *)0)
# 250 "../test/endecode_test.c"
                                ;
    BIO *mem_ser = 
# 251 "../test/endecode_test.c" 3 4
                  ((void *)0)
# 251 "../test/endecode_test.c"
                      ;
    BUF_MEM *mem_buf = 
# 252 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 252 "../test/endecode_test.c"
                          ;
    const unsigned char *upass = (const unsigned char *)pass;
    int ok = 0;

    if (!test_ptr(file, line, "ectx = OSSL_ENCODER_CTX_new_for_pkey(pkey, selection, output_type, output_structure, testpropq)", ectx = OSSL_ENCODER_CTX_new_for_pkey(pkey, selection, output_type, output_structure, testpropq))



        || !test_int_gt(file, line, "OSSL_ENCODER_CTX_get_num_encoders(ectx)", "0", OSSL_ENCODER_CTX_get_num_encoders(ectx), 0)
        || (pass != 
# 261 "../test/endecode_test.c" 3 4
                   ((void *)0)
            
# 262 "../test/endecode_test.c"
           && !test_true(file, line, "OSSL_ENCODER_CTX_set_passphrase(ectx, upass, strlen(pass))", (OSSL_ENCODER_CTX_set_passphrase(ectx, upass, strlen(pass))) != 0)
                                                                        )
        || (pcipher != 
# 264 "../test/endecode_test.c" 3 4
                      ((void *)0)
            
# 265 "../test/endecode_test.c"
           && !test_true(file, line, "OSSL_ENCODER_CTX_set_cipher(ectx, pcipher, NULL)", (OSSL_ENCODER_CTX_set_cipher(ectx, pcipher, 
# 265 "../test/endecode_test.c" 3 4
               ((void *)0)
# 265 "../test/endecode_test.c"
               )) != 0))
        || !test_ptr(file, line, "mem_ser = BIO_new(BIO_s_mem())", mem_ser = BIO_new(BIO_s_mem()))
        || !test_true(file, line, "OSSL_ENCODER_to_bio(ectx, mem_ser)", (OSSL_ENCODER_to_bio(ectx, mem_ser)) != 0)
        || !test_true(file, line, "BIO_get_mem_ptr(mem_ser, &mem_buf) > 0", (BIO_ctrl(mem_ser,115,0, (char *)(&mem_buf)) > 0) != 0)
        || !test_ptr(file, line, "*encoded = mem_buf->data", *encoded = mem_buf->data)
        || !test_long_gt(file, line, "*encoded_len = mem_buf->length", "0", *encoded_len = mem_buf->length, 0))
        goto end;


    mem_buf->data = 
# 274 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 274 "../test/endecode_test.c"
                       ;
    mem_buf->length = 0;
    ok = 1;
 end:
...
{
    EVP_PKEY *pkey = 
# 290 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 290 "../test/endecode_test.c"
                        , *testpkey = 
# 290 "../test/endecode_test.c" 3 4
                                      ((void *)0)
# 290 "../test/endecode_test.c"
...
# 291 "../test/endecode_test.c" 3 4
                            ((void *)0)
# 291 "../test/endecode_test.c"
                                ;
    BIO *encoded_bio = 
# 292 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 292 "../test/endecode_test.c"
                          ;
    const unsigned char *upass = (const unsigned char *)pass;
    int ok = 0;
    int i;
    ...
    if (!test_ptr(file, line, "encoded_bio = BIO_new_mem_buf(encoded, encoded_len)", encoded_bio = BIO_new_mem_buf(encoded, encoded_len)))
        goto end;
# 313 "../test/endecode_test.c"
    for (i = 0; i < 3; i++) {
        const char *testtype = (i == 0) ? input_type
                                        : ((i == 1) ? 
# 315 "../test/endecode_test.c" 3 4
                                                     ((void *)0) 
# 315 "../test/endecode_test.c"
                                                          : badtype);

        if (!test_ptr(file, line, "dctx = OSSL_DECODER_CTX_new_for_pkey(&testpkey, testtype, structure_type, keytype, selection, testctx, testpropq)", dctx = OSSL_DECODER_CTX_new_for_pkey(&testpkey, testtype, structure_type, keytype, selection, testctx, testpropq))
            ...
            || (pass != 
# 323 "../test/endecode_test.c" 3 4
                       ((void *)0)
                
# 324 "../test/endecode_test.c"
               && !OSSL_DECODER_CTX_set_passphrase(dctx, upass, strlen(pass)))
            || !test_int_gt(file, line, "BIO_reset(encoded_bio)", "0", (int)BIO_ctrl(encoded_bio,1,0,
# 325 "../test/endecode_test.c" 3 4
               ((void *)0)
# 325 "../test/endecode_test.c"
               ), 0)

            || !test_int_eq(file, line, "OSSL_DECODER_from_bio(dctx, encoded_bio)", "(i == 2) ? 0 : 1", OSSL_DECODER_from_bio(dctx, encoded_bio), (i == 2) ? 0 : 1)
                                             )
            goto end;
        OSSL_DECODER_CTX_free(dctx);
        dctx = 
# 331 "../test/endecode_test.c" 3 4
              ((void *)0)
# 331 "../test/endecode_test.c"
                  ;

        if (i == 0) {
            pkey = testpkey;
            testpkey = 
# 335 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 335 "../test/endecode_test.c"
                          ;
        } else if (i == 1) {
            if (selection == 0x04) {
                if (!test_int_eq(file, line, "EVP_PKEY_parameters_eq(pkey, testpkey)", "1", EVP_PKEY_parameters_eq(pkey, testpkey), 1))
                    goto end;
            } else {
                if (!test_int_eq(file, line, "EVP_PKEY_eq(pkey, testpkey)", "1", EVP_PKEY_eq(pkey, testpkey), 1))
                    goto end;
            }
        }
    }
    ...
    *object = pkey;
    pkey = 
# 348 "../test/endecode_test.c" 3 4
          ((void *)0)
# 348 "../test/endecode_test.c"
              ;
...
static int encode_EVP_PKEY_legacy_PEM(const char *file, const int line,
                                      void **encoded, long *encoded_len,
                                      void *object, __attribute__((unused)) int selection,
                                      __attribute__((unused)) const char *output_type,
                                      __attribute__((unused)) const char *output_structure,
                                      const char *pass, const char *pcipher)
{
    EVP_PKEY *pkey = object;
    EVP_CIPHER *cipher = 
# 366 "../test/endecode_test.c" 3 4
                        ((void *)0)
# 366 "../test/endecode_test.c"
                            ;
    BIO *mem_ser = 
# 367 "../test/endecode_test.c" 3 4
                  ((void *)0)
# 367 "../test/endecode_test.c"
                      ;
    BUF_MEM *mem_buf = 
# 368 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 368 "../test/endecode_test.c"
                          ;
    const unsigned char *upass = (const unsigned char *)pass;
    size_t passlen = 0;
    int ok = 0;
    ...
    if (pcipher != 
# 373 "../test/endecode_test.c" 3 4
                  ((void *)0) 
# 373 "../test/endecode_test.c"
                       && pass != 
# 373 "../test/endecode_test.c" 3 4
                                  ((void *)0)
# 373 "../test/endecode_test.c"
        ...
        passlen = strlen(pass);
        if (!test_ptr(file, line, "cipher = EVP_CIPHER_fetch(testctx, pcipher, testpropq)", cipher = EVP_CIPHER_fetch(testctx, pcipher, testpropq)))
            goto end;
    }
    if (!test_ptr(file, line, "mem_ser = BIO_new(BIO_s_mem())", mem_ser = BIO_new(BIO_s_mem()))
        || !test_true(file, line, "PEM_write_bio_PrivateKey_traditional(mem_ser, pkey, cipher, upass, passlen, NULL, NULL)", (PEM_write_bio_PrivateKey_traditional(mem_ser, pkey, cipher, upass, passlen, 
# 379 "../test/endecode_test.c" 3 4
           ((void *)0)
# 379 "../test/endecode_test.c"
           , 
# 379 "../test/endecode_test.c" 3 4
           ((void *)0)
# 379 "../test/endecode_test.c"
    ...
    mem_buf->data = 
# 389 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 389 "../test/endecode_test.c"
                       ;
    mem_buf->length = 0;
    ok = 1;
 end:
...
static int encode_EVP_PKEY_MSBLOB(const char *file, const int line,
                                  ...
                                  __attribute__((unused)) const char *pcipher)
{
    EVP_PKEY *pkey = object;
    BIO *mem_ser = 
# 407 "../test/endecode_test.c" 3 4
                  ((void *)0)
# 407 "../test/endecode_test.c"
                      ;
    BUF_MEM *mem_buf = 
# 408 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 408 "../test/endecode_test.c"
                          ;
    int ok = 0;
    ...
    if ((selection & 0x01) != 0) {
        if (!test_int_ge(file, line, "i2b_PrivateKey_bio(mem_ser, pkey)", "0", i2b_PrivateKey_bio(mem_ser, pkey), 0))
            goto end;
    } else {
        if (!test_int_ge(file, line, "i2b_PublicKey_bio(mem_ser, pkey)", "0", i2b_PublicKey_bio(mem_ser, pkey), 0))
            goto end;
    }

    if (!test_true(file, line, "BIO_get_mem_ptr(mem_ser, &mem_buf) > 0", (BIO_ctrl(mem_ser,115,0, (char *)(&mem_buf)) > 0) != 0)
        || !test_ptr(file, line, "*encoded = mem_buf->data", *encoded = mem_buf->data)
        || !test_long_gt(file, line, "*encoded_len = mem_buf->length", "0", *encoded_len = mem_buf->length, 0))
        goto end;
    ...
    mem_buf->data = 
# 428 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 428 "../test/endecode_test.c"
                       ;
    mem_buf->length = 0;
    ok = 1;
 end:
                               ...
                               __attribute__((unused)) const char *pcipher)
{
    EVP_PKEY *pkey = object;
    BIO *mem_ser = 
# 452 "../test/endecode_test.c" 3 4
                  ((void *)0)
# 452 "../test/endecode_test.c"
                      ;
    BUF_MEM *mem_buf = 
# 453 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 453 "../test/endecode_test.c"
                          ;
    int enc = (pass != 
# 454 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 454 "../test/endecode_test.c"
                          );
    int ok = 0;

    if (!test_true(file, line, "ossl_assert((selection & OSSL_KEYMGMT_SELECT_PRIVATE_KEY) != 0)", (__builtin_expect(!!(((selection & 0x01) != 0) != 0), 1)) != 0)

        || !test_ptr(file, line, "mem_ser = BIO_new(BIO_s_mem())", mem_ser = BIO_new(BIO_s_mem()))
        || !test_int_ge(file, line, "i2b_PVK_bio_ex(mem_ser, pkey, enc, pass_pw, (void *)pass, testctx, testpropq)", "0", i2b_PVK_bio_ex(mem_ser, pkey, enc, pass_pw, (void *)pass, testctx, testpropq), 0)
    ...
    mem_buf->data = 
# 468 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 468 "../test/endecode_test.c"
                       ;
    mem_buf->length = 0;
    ok = 1;
 end:
...
static int test_text(const char *file, const int line,
                     ...
                     const void *data2, size_t data2_len)
{
    return test_strn_eq(file, line, "data1", "data2", data1, data1_len, data2, data2_len);
}
...
static int test_mem(const char *file, const int line,
                    ...
                    const void *data2, size_t data2_len)
{
    return test_mem_eq(file, line, "data1", "data2", data1, data1_len, data2, data2_len);
}
...
static void collect_name(const char *name, void *arg)
{
    ...
    space = strlen(name);
    if (*namelist != 
# 499 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 499 "../test/endecode_test.c"
                        )
        space += strlen(*namelist) + 2 ;
    space++;

    new_namelist = CRYPTO_realloc(*namelist, space, "../test/endecode_test.c", 503);
    if (new_namelist == 
# 504 "../test/endecode_test.c" 3 4
                       ((void *)0)
# 504 "../test/endecode_test.c"
                           )
        return;
    if (*namelist != 
# 506 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 506 "../test/endecode_test.c"
                        ) {
        strcat(new_namelist, ", ");
...
# 531 "../test/endecode_test.c" 3 4
                               ((void *)0)
# 531 "../test/endecode_test.c"
                                   , &datap, data_len);
    int ok = 0;

    if (test_ptr(file, line, "p8inf", p8inf)) {
        EVP_PKEY *pkey = EVP_PKCS82PKEY_ex(p8inf, testctx, testpropq);
        char *namelist = 
# 536 "../test/endecode_test.c" 3 4
                        ((void *)0)
# 536 "../test/endecode_test.c"
                            ;

        if (test_ptr(file, line, "pkey", pkey)) {
            if (!(ok = test_true(file, line, "EVP_PKEY_is_a(pkey, type)", (EVP_PKEY_is_a(pkey, type)) != 0))) {
                EVP_PKEY_type_names_do_all(pkey, collect_name, &namelist);
                if (namelist != 
# 541 "../test/endecode_test.c" 3 4
                               ((void *)0)
# 541 "../test/endecode_test.c"
                                   )
                    test_note("%s isn't any of %s", type, namelist);
                CRYPTO_free(namelist, "../test/endecode_test.c", 543);
            }
            ok = ok && test_true(file, line, "evp_pkey_is_provided(pkey)", (((pkey)->keymgmt != 
# 545 "../test/endecode_test.c" 3 4
                      ((void *)0)
# 545 "../test/endecode_test.c"
                      )) != 0);
            EVP_PKEY_free(pkey);
        }
    }
...
{
    return test_encode_decode("../test/endecode_test.c", 555, type, key,
                              ( 0x01 | 0x02 )
                              | ( 0x04 | 0x80),
                              "DER", "PrivateKeyInfo", 
# 558 "../test/endecode_test.c" 3 4
                                                      ((void *)0)
# 558 "../test/endecode_test.c"
                                                          , 
# 558 "../test/endecode_test.c" 3 4
                                                            ((void *)0)
# 558 "../test/endecode_test.c"
                                       ...
                                       const void *data, size_t data_len)
{
    ...
    return test_strn_eq(file, line, "data", "expected_pem_header", data, sizeof(expected_pem_header) - 1, expected_pem_header, sizeof(expected_pem_header) - 1)
                                                        ;
}

static int test_unprotected_via_PEM(const char *type, EVP_PKEY *key, int fips)
{
    return test_encode_decode("../test/endecode_test.c", 577, type, key,
                              ( 0x01 | 0x02 )
                              | ( 0x04 | 0x80),
                              "PEM", "PrivateKeyInfo", 
# 580 "../test/endecode_test.c" 3 4
                                                      ((void *)0)
# 580 "../test/endecode_test.c"
                                                          , 
# 580 "../test/endecode_test.c" 3 4
                                                            ((void *)0)
# 580 "../test/endecode_test.c"
                            ...
                            const char *type, const void *data, size_t data_len)
{
    ...
    int itype = 0;
    EVP_PKEY *pkey = 
# 593 "../test/endecode_test.c" 3 4
                    ((void *)0)
# 593 "../test/endecode_test.c"
                        ;
    ...
    if (itype != 0) {
        pkey = d2i_KeyParams(itype, 
# 605 "../test/endecode_test.c" 3 4
                                   ((void *)0)
# 605 "../test/endecode_test.c"
                                       , &datap, data_len);
        ok = (pkey != 
# 606 "../test/endecode_test.c" 3 4
                     ((void *)0)
# 606 "../test/endecode_test.c"
                         );
        EVP_PKEY_free(pkey);
    }
                            ...
                            const void *data, size_t data_len)
{
    ...
    return
        test_int_gt(file, line, "BIO_snprintf(expected_pem_header, sizeof(expected_pem_header), \"-----BEGIN %s PARAMETERS-----\", type)", "0", BIO_snprintf(expected_pem_header, sizeof(expected_pem_header), "-----BEGIN %s PARAMETERS-----", type), 0)


        && test_strn_eq(file, line, "data", "expected_pem_header", data, strlen(expected_pem_header), expected_pem_header, strlen(expected_pem_header));
}

static int test_params_via_DER(const char *type, EVP_PKEY *key)
{
    return test_encode_decode("../test/endecode_test.c", 628, type, key, 0x04,
                              "DER", "type-specific", 
# 629 "../test/endecode_test.c" 3 4
                                                     ((void *)0)
# 629 "../test/endecode_test.c"
                                                         , 
# 629 "../test/endecode_test.c" 3 4
                                                           ((void *)0)
# 629 "../test/endecode_test.c"
...
{
    return test_encode_decode("../test/endecode_test.c", 637, type, key, 0x04,
                              "PEM", "type-specific", 
# 638 "../test/endecode_test.c" 3 4
                                                     ((void *)0)
# 638 "../test/endecode_test.c"
                                                         , 
# 638 "../test/endecode_test.c" 3 4
                                                           ((void *)0)
# 638 "../test/endecode_test.c"
                                        ...
                                        const void *data, size_t data_len)
{
    ...
    return
        test_int_gt(file, line, "BIO_snprintf(expected_pem_header, sizeof(expected_pem_header), \"-----BEGIN %s PRIVATE KEY-----\", type)", "0", BIO_snprintf(expected_pem_header, sizeof(expected_pem_header), "-----BEGIN %s PRIVATE KEY-----", type), 0)
...
static int test_unprotected_via_legacy_PEM(const char *type, EVP_PKEY *key)
{
    if (!default_libctx || is_fips)
        return test_skip("../test/endecode_test.c", 661, "Test not available if using a non-default library context or FIPS provider");

    return test_encode_decode("../test/endecode_test.c", 663, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
                              "PEM", "type-specific", 
# 666 "../test/endecode_test.c" 3 4
                                                     ((void *)0)
# 666 "../test/endecode_test.c"
                                                         , 
# 666 "../test/endecode_test.c" 3 4
                                                           ((void *)0)
# 666 "../test/endecode_test.c"
                        ...
                        const char *type, const void *data, size_t data_len)
{
    ...
    int ok = test_ptr(file, line, "pkey", pkey);
...
{
    return test_encode_decode("../test/endecode_test.c", 685, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
                              "MSBLOB", 
# 688 "../test/endecode_test.c" 3 4
                                       ((void *)0)
# 688 "../test/endecode_test.c"
                                           , 
# 688 "../test/endecode_test.c" 3 4
                                             ((void *)0)
# 688 "../test/endecode_test.c"
...
{
    return test_encode_decode("../test/endecode_test.c", 706, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
                              "PVK", 
# 709 "../test/endecode_test.c" 3 4
                                    ((void *)0)
# 709 "../test/endecode_test.c"
                                        , 
# 709 "../test/endecode_test.c" 3 4
                                          ((void *)0)
# 709 "../test/endecode_test.c"
...
{
    const unsigned char *datap = data;
    X509_SIG *p8 = d2i_X509_SIG(
# 723 "../test/endecode_test.c" 3 4
                               ((void *)0)
# 723 "../test/endecode_test.c"
                                   , &datap, data_len);
    int ok = test_ptr(file, line, "p8", p8);
...
{
    return test_encode_decode("../test/endecode_test.c", 732, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
...
{
    return test_encode_decode("../test/endecode_test.c", 755, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
                                      ...
                                      const void *data, size_t data_len)
{
    ...
    return
        ...
        && test_strn_eq(file, line, "data", "expected_pem_header", data, strlen(expected_pem_header), expected_pem_header, strlen(expected_pem_header))
        && test_ptr(file, line, "strstr(data, \"\\nDEK-Info: \")", strstr(data, "\nDEK-Info: "));
}

static int test_protected_via_legacy_PEM(const char *type, EVP_PKEY *key)
{
    if (!default_libctx || is_fips)
        return test_skip("../test/endecode_test.c", 782, "Test not available if using a non-default library context or FIPS provider");

    return test_encode_decode("../test/endecode_test.c", 784, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
...
static int test_protected_via_PVK(const char *type, EVP_PKEY *key)
{
    ...
    if (lgcyprov == 
# 798 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 798 "../test/endecode_test.c"
                       )
        return test_skip("../test/endecode_test.c", 799, "Legacy provider not available");

    ret = test_encode_decode("../test/endecode_test.c", 801, type, key,
                              ( 0x01 | 0x02 )
                              | 0x04,
                              "PVK", 
# 804 "../test/endecode_test.c" 3 4
                                    ((void *)0)
# 804 "../test/endecode_test.c"
                                        , pass, 
# 804 "../test/endecode_test.c" 3 4
                                                ((void *)0)
# 804 "../test/endecode_test.c"
...
{
    const unsigned char *datap = data;
    EVP_PKEY *pkey = d2i_PUBKEY_ex(
# 816 "../test/endecode_test.c" 3 4
                                  ((void *)0)
# 816 "../test/endecode_test.c"
                                      , &datap, data_len, testctx, testpropq);
    int ok = (test_ptr(file, line, "pkey", pkey) && test_true(file, line, "EVP_PKEY_is_a(pkey, type)", (EVP_PKEY_is_a(pkey, type)) != 0));
...
{
    return test_encode_decode("../test/endecode_test.c", 825, type, key,
                              0x02
                              | ( 0x04 | 0x80),
                              "DER", "SubjectPublicKeyInfo", 
# 828 "../test/endecode_test.c" 3 4
                                                            ((void *)0)
# 828 "../test/endecode_test.c"
                                                                , 
# 828 "../test/endecode_test.c" 3 4
                                                                  ((void *)0)
# 828 "../test/endecode_test.c"
                            ...
                            const char *type, const void *data, size_t data_len)
{
    ...
    return
        test_strn_eq(file, line, "data", "expected_pem_header", data, sizeof(expected_pem_header) - 1, expected_pem_header, sizeof(expected_pem_header) - 1)
                                                     ;
}

static int test_public_via_PEM(const char *type, EVP_PKEY *key, int fips)
{
    return test_encode_decode("../test/endecode_test.c", 847, type, key,
                              0x02
                              | ( 0x04 | 0x80),
                              "PEM", "SubjectPublicKeyInfo", 
# 850 "../test/endecode_test.c" 3 4
                                                            ((void *)0)
# 850 "../test/endecode_test.c"
                                                                , 
# 850 "../test/endecode_test.c" 3 4
                                                                  ((void *)0)
# 850 "../test/endecode_test.c"
...
{
    return test_encode_decode("../test/endecode_test.c", 870, type, key, 0x02
                              | 0x04,
                              "MSBLOB", 
# 872 "../test/endecode_test.c" 3 4
                                       ((void *)0)
# 872 "../test/endecode_test.c"
                                           , 
# 872 "../test/endecode_test.c" 3 4
                                             ((void *)0)
# 872 "../test/endecode_test.c"
...
# 994 "../test/endecode_test.c"
static EVP_PKEY *template_DH = 
# 994 "../test/endecode_test.c" 3 4
((void *)0)
# 994 "../test/endecode_test.c"
; static EVP_PKEY *key_DH = 
# 994 "../test/endecode_test.c" 3 4
((void *)0)
# 994 "../test/endecode_test.c"
              ;
static int test_unprotected_DH_via_DER(void) { return test_unprotected_via_DER("DH", key_DH, 1); } static int test_unprotected_DH_via_PEM(void) { return test_unprotected_via_PEM("DH", key_DH, 1); } static int test_protected_DH_via_DER(void) { return test_protected_via_DER("DH", key_DH, 1); } static int test_protected_DH_via_PEM(void) { return test_protected_via_PEM("DH", key_DH, 1); } static int test_public_DH_via_DER(void) { return test_public_via_DER("DH", key_DH, 1); } static int test_public_DH_via_PEM(void) { return test_public_via_PEM("DH", key_DH, 1); }
static int test_params_DH_via_DER(void) { return test_params_via_DER("DH", key_DH); } static int test_params_DH_via_PEM(void) { return test_params_via_PEM("DH", key_DH); }
static EVP_PKEY *template_DHX = 
# 997 "../test/endecode_test.c" 3 4
((void *)0)
# 997 "../test/endecode_test.c"
; static EVP_PKEY *key_DHX = 
# 997 "../test/endecode_test.c" 3 4
((void *)0)
# 997 "../test/endecode_test.c"
               ;
static int test_unprotected_DHX_via_DER(void) { return test_unprotected_via_DER("X9.42 DH", key_DHX, 1); } static int test_unprotected_DHX_via_PEM(void) { return test_unprotected_via_PEM("X9.42 DH", key_DHX, 1); } static int test_protected_DHX_via_DER(void) { return test_protected_via_DER("X9.42 DH", key_DHX, 1); } static int test_protected_DHX_via_PEM(void) { return test_protected_via_PEM("X9.42 DH", key_DHX, 1); } static int test_public_DHX_via_DER(void) { return test_public_via_DER("X9.42 DH", key_DHX, 1); } static int test_public_DHX_via_PEM(void) { return test_public_via_PEM("X9.42 DH", key_DHX, 1); }
static int test_params_DHX_via_DER(void) { return test_params_via_DER("X9.42 DH", key_DHX); } static int test_params_DHX_via_PEM(void) { return test_params_via_PEM("X9.42 DH", key_DHX); }
...
static EVP_PKEY *template_DSA = 
# 1006 "../test/endecode_test.c" 3 4
((void *)0)
# 1006 "../test/endecode_test.c"
; static EVP_PKEY *key_DSA = 
# 1006 "../test/endecode_test.c" 3 4
((void *)0)
# 1006 "../test/endecode_test.c"
               ;
static int test_unprotected_DSA_via_DER(void) { return test_unprotected_via_DER("DSA", key_DSA, 1); } static int test_unprotected_DSA_via_PEM(void) { return test_unprotected_via_PEM("DSA", key_DSA, 1); } static int test_protected_DSA_via_DER(void) { return test_protected_via_DER("DSA", key_DSA, 1); } static int test_protected_DSA_via_PEM(void) { return test_protected_via_PEM("DSA", key_DSA, 1); } static int test_public_DSA_via_DER(void) { return test_public_via_DER("DSA", key_DSA, 1); } static int test_public_DSA_via_PEM(void) { return test_public_via_PEM("DSA", key_DSA, 1); }
static int test_params_DSA_via_DER(void) { return test_params_via_DER("DSA", key_DSA); } static int test_params_DSA_via_PEM(void) { return test_params_via_PEM("DSA", key_DSA); }
static int test_unprotected_DSA_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("DSA", key_DSA); } static int test_protected_DSA_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("DSA", key_DSA); }
static int test_unprotected_DSA_via_MSBLOB(void) { return test_unprotected_via_MSBLOB("DSA", key_DSA); } static int test_public_DSA_via_MSBLOB(void) { return test_public_via_MSBLOB("DSA", key_DSA); }
static int test_unprotected_DSA_via_PVK(void) { return test_unprotected_via_PVK("DSA", key_DSA); }

static int test_protected_DSA_via_PVK(void) { return test_protected_via_PVK("DSA", key_DSA); }



static EVP_PKEY *template_EC = 
# 1017 "../test/endecode_test.c" 3 4
((void *)0)
# 1017 "../test/endecode_test.c"
; static EVP_PKEY *key_EC = 
# 1017 "../test/endecode_test.c" 3 4
((void *)0)
# 1017 "../test/endecode_test.c"
              ;
static int test_unprotected_EC_via_DER(void) { return test_unprotected_via_DER("EC", key_EC, 1); } static int test_unprotected_EC_via_PEM(void) { return test_unprotected_via_PEM("EC", key_EC, 1); } static int test_protected_EC_via_DER(void) { return test_protected_via_DER("EC", key_EC, 1); } static int test_protected_EC_via_PEM(void) { return test_protected_via_PEM("EC", key_EC, 1); } static int test_public_EC_via_DER(void) { return test_public_via_DER("EC", key_EC, 1); } static int test_public_EC_via_PEM(void) { return test_public_via_PEM("EC", key_EC, 1); }
static int test_params_EC_via_DER(void) { return test_params_via_DER("EC", key_EC); } static int test_params_EC_via_PEM(void) { return test_params_via_PEM("EC", key_EC); }
static int test_unprotected_EC_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("EC", key_EC); } static int test_protected_EC_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("EC", key_EC); }
static EVP_PKEY *template_ECExplicitPrimeNamedCurve = 
# 1021 "../test/endecode_test.c" 3 4
((void *)0)
# 1021 "../test/endecode_test.c"
; static EVP_PKEY *key_ECExplicitPrimeNamedCurve = 
# 1021 "../test/endecode_test.c" 3 4
((void *)0)
# 1021 "../test/endecode_test.c"
                                     ;
static int test_unprotected_ECExplicitPrimeNamedCurve_via_DER(void) { return test_unprotected_via_DER("EC", key_ECExplicitPrimeNamedCurve, 1); } static int test_unprotected_ECExplicitPrimeNamedCurve_via_PEM(void) { return test_unprotected_via_PEM("EC", key_ECExplicitPrimeNamedCurve, 1); } static int test_protected_ECExplicitPrimeNamedCurve_via_DER(void) { return test_protected_via_DER("EC", key_ECExplicitPrimeNamedCurve, 1); } static int test_protected_ECExplicitPrimeNamedCurve_via_PEM(void) { return test_protected_via_PEM("EC", key_ECExplicitPrimeNamedCurve, 1); } static int test_public_ECExplicitPrimeNamedCurve_via_DER(void) { return test_public_via_DER("EC", key_ECExplicitPrimeNamedCurve, 1); } static int test_public_ECExplicitPrimeNamedCurve_via_PEM(void) { return test_public_via_PEM("EC", key_ECExplicitPrimeNamedCurve, 1); }
static int test_unprotected_ECExplicitPrimeNamedCurve_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("EC", key_ECExplicitPrimeNamedCurve); } static int test_protected_ECExplicitPrimeNamedCurve_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("EC", key_ECExplicitPrimeNamedCurve); }
static EVP_PKEY *template_ECExplicitPrime2G = 
# 1024 "../test/endecode_test.c" 3 4
((void *)0)
# 1024 "../test/endecode_test.c"
; static EVP_PKEY *key_ECExplicitPrime2G = 
# 1024 "../test/endecode_test.c" 3 4
((void *)0)
# 1024 "../test/endecode_test.c"
                             ;
static int test_unprotected_ECExplicitPrime2G_via_DER(void) { return test_unprotected_via_DER("EC", key_ECExplicitPrime2G, 0); } static int test_unprotected_ECExplicitPrime2G_via_PEM(void) { return test_unprotected_via_PEM("EC", key_ECExplicitPrime2G, 0); } static int test_protected_ECExplicitPrime2G_via_DER(void) { return test_protected_via_DER("EC", key_ECExplicitPrime2G, 0); } static int test_protected_ECExplicitPrime2G_via_PEM(void) { return test_protected_via_PEM("EC", key_ECExplicitPrime2G, 0); } static int test_public_ECExplicitPrime2G_via_DER(void) { return test_public_via_DER("EC", key_ECExplicitPrime2G, 0); } static int test_public_ECExplicitPrime2G_via_PEM(void) { return test_public_via_PEM("EC", key_ECExplicitPrime2G, 0); }
static int test_unprotected_ECExplicitPrime2G_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("EC", key_ECExplicitPrime2G); } static int test_protected_ECExplicitPrime2G_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("EC", key_ECExplicitPrime2G); }

static EVP_PKEY *template_ECExplicitTriNamedCurve = 
# 1028 "../test/endecode_test.c" 3 4
((void *)0)
# 1028 "../test/endecode_test.c"
; static EVP_PKEY *key_ECExplicitTriNamedCurve = 
# 1028 "../test/endecode_test.c" 3 4
((void *)0)
# 1028 "../test/endecode_test.c"
                                   ;
static int test_unprotected_ECExplicitTriNamedCurve_via_DER(void) { return test_unprotected_via_DER("EC", key_ECExplicitTriNamedCurve, 1); } static int test_unprotected_ECExplicitTriNamedCurve_via_PEM(void) { return test_unprotected_via_PEM("EC", key_ECExplicitTriNamedCurve, 1); } static int test_protected_ECExplicitTriNamedCurve_via_DER(void) { return test_protected_via_DER("EC", key_ECExplicitTriNamedCurve, 1); } static int test_protected_ECExplicitTriNamedCurve_via_PEM(void) { return test_protected_via_PEM("EC", key_ECExplicitTriNamedCurve, 1); } static int test_public_ECExplicitTriNamedCurve_via_DER(void) { return test_public_via_DER("EC", key_ECExplicitTriNamedCurve, 1); } static int test_public_ECExplicitTriNamedCurve_via_PEM(void) { return test_public_via_PEM("EC", key_ECExplicitTriNamedCurve, 1); }
static int test_unprotected_ECExplicitTriNamedCurve_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("EC", key_ECExplicitTriNamedCurve); } static int test_protected_ECExplicitTriNamedCurve_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("EC", key_ECExplicitTriNamedCurve); }
static EVP_PKEY *template_ECExplicitTri2G = 
# 1031 "../test/endecode_test.c" 3 4
((void *)0)
# 1031 "../test/endecode_test.c"
; static EVP_PKEY *key_ECExplicitTri2G = 
# 1031 "../test/endecode_test.c" 3 4
((void *)0)
# 1031 "../test/endecode_test.c"
                           ;
static int test_unprotected_ECExplicitTri2G_via_DER(void) { return test_unprotected_via_DER("EC", key_ECExplicitTri2G, 0); } static int test_unprotected_ECExplicitTri2G_via_PEM(void) { return test_unprotected_via_PEM("EC", key_ECExplicitTri2G, 0); } static int test_protected_ECExplicitTri2G_via_DER(void) { return test_protected_via_DER("EC", key_ECExplicitTri2G, 0); } static int test_protected_ECExplicitTri2G_via_PEM(void) { return test_protected_via_PEM("EC", key_ECExplicitTri2G, 0); } static int test_public_ECExplicitTri2G_via_DER(void) { return test_public_via_DER("EC", key_ECExplicitTri2G, 0); } static int test_public_ECExplicitTri2G_via_PEM(void) { return test_public_via_PEM("EC", key_ECExplicitTri2G, 0); }
static int test_unprotected_ECExplicitTri2G_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("EC", key_ECExplicitTri2G); } static int test_protected_ECExplicitTri2G_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("EC", key_ECExplicitTri2G); }


static EVP_PKEY *key_SM2 = 
# 1036 "../test/endecode_test.c" 3 4
((void *)0)
# 1036 "../test/endecode_test.c"
        ;
static int test_unprotected_SM2_via_DER(void) { return test_unprotected_via_DER("SM2", key_SM2, 0); } static int test_unprotected_SM2_via_PEM(void) { return test_unprotected_via_PEM("SM2", key_SM2, 0); } static int test_protected_SM2_via_DER(void) { return test_protected_via_DER("SM2", key_SM2, 0); } static int test_protected_SM2_via_PEM(void) { return test_protected_via_PEM("SM2", key_SM2, 0); } static int test_public_SM2_via_DER(void) { return test_public_via_DER("SM2", key_SM2, 0); } static int test_public_SM2_via_PEM(void) { return test_public_via_PEM("SM2", key_SM2, 0); }

static EVP_PKEY *key_ED25519 = 
# 1039 "../test/endecode_test.c" 3 4
((void *)0)
# 1039 "../test/endecode_test.c"
            ;
static int test_unprotected_ED25519_via_DER(void) { return test_unprotected_via_DER("ED25519", key_ED25519, 1); } static int test_unprotected_ED25519_via_PEM(void) { return test_unprotected_via_PEM("ED25519", key_ED25519, 1); } static int test_protected_ED25519_via_DER(void) { return test_protected_via_DER("ED25519", key_ED25519, 1); } static int test_protected_ED25519_via_PEM(void) { return test_protected_via_PEM("ED25519", key_ED25519, 1); } static int test_public_ED25519_via_DER(void) { return test_public_via_DER("ED25519", key_ED25519, 1); } static int test_public_ED25519_via_PEM(void) { return test_public_via_PEM("ED25519", key_ED25519, 1); }
static EVP_PKEY *key_ED448 = 
# 1041 "../test/endecode_test.c" 3 4
((void *)0)
# 1041 "../test/endecode_test.c"
          ;
static int test_unprotected_ED448_via_DER(void) { return test_unprotected_via_DER("ED448", key_ED448, 1); } static int test_unprotected_ED448_via_PEM(void) { return test_unprotected_via_PEM("ED448", key_ED448, 1); } static int test_protected_ED448_via_DER(void) { return test_protected_via_DER("ED448", key_ED448, 1); } static int test_protected_ED448_via_PEM(void) { return test_protected_via_PEM("ED448", key_ED448, 1); } static int test_public_ED448_via_DER(void) { return test_public_via_DER("ED448", key_ED448, 1); } static int test_public_ED448_via_PEM(void) { return test_public_via_PEM("ED448", key_ED448, 1); }
static EVP_PKEY *key_X25519 = 
# 1043 "../test/endecode_test.c" 3 4
((void *)0)
# 1043 "../test/endecode_test.c"
           ;
static int test_unprotected_X25519_via_DER(void) { return test_unprotected_via_DER("X25519", key_X25519, 1); } static int test_unprotected_X25519_via_PEM(void) { return test_unprotected_via_PEM("X25519", key_X25519, 1); } static int test_protected_X25519_via_DER(void) { return test_protected_via_DER("X25519", key_X25519, 1); } static int test_protected_X25519_via_PEM(void) { return test_protected_via_PEM("X25519", key_X25519, 1); } static int test_public_X25519_via_DER(void) { return test_public_via_DER("X25519", key_X25519, 1); } static int test_public_X25519_via_PEM(void) { return test_public_via_PEM("X25519", key_X25519, 1); }
static EVP_PKEY *key_X448 = 
# 1045 "../test/endecode_test.c" 3 4
((void *)0)
# 1045 "../test/endecode_test.c"
         ;
static int test_unprotected_X448_via_DER(void) { return test_unprotected_via_DER("X448", key_X448, 1); } static int test_unprotected_X448_via_PEM(void) { return test_unprotected_via_PEM("X448", key_X448, 1); } static int test_protected_X448_via_DER(void) { return test_protected_via_DER("X448", key_X448, 1); } static int test_protected_X448_via_PEM(void) { return test_protected_via_PEM("X448", key_X448, 1); } static int test_public_X448_via_DER(void) { return test_public_via_DER("X448", key_X448, 1); } static int test_public_X448_via_PEM(void) { return test_public_via_PEM("X448", key_X448, 1); }





static EVP_PKEY *key_RSA = 
# 1052 "../test/endecode_test.c" 3 4
((void *)0)
# 1052 "../test/endecode_test.c"
        ;
static int test_unprotected_RSA_via_DER(void) { return test_unprotected_via_DER("RSA", key_RSA, 1); } static int test_unprotected_RSA_via_PEM(void) { return test_unprotected_via_PEM("RSA", key_RSA, 1); } static int test_protected_RSA_via_DER(void) { return test_protected_via_DER("RSA", key_RSA, 1); } static int test_protected_RSA_via_PEM(void) { return test_protected_via_PEM("RSA", key_RSA, 1); } static int test_public_RSA_via_DER(void) { return test_public_via_DER("RSA", key_RSA, 1); } static int test_public_RSA_via_PEM(void) { return test_public_via_PEM("RSA", key_RSA, 1); }
static int test_unprotected_RSA_via_legacy_PEM(void) { return test_unprotected_via_legacy_PEM("RSA", key_RSA); } static int test_protected_RSA_via_legacy_PEM(void) { return test_protected_via_legacy_PEM("RSA", key_RSA); }
static EVP_PKEY *key_RSA_PSS = 
# 1055 "../test/endecode_test.c" 3 4
((void *)0)
# 1055 "../test/endecode_test.c"
            ;
static int test_unprotected_RSA_PSS_via_DER(void) { return test_unprotected_via_DER("RSA-PSS", key_RSA_PSS, 1); } static int test_unprotected_RSA_PSS_via_PEM(void) { return test_unprotected_via_PEM("RSA-PSS", key_RSA_PSS, 1); } static int test_protected_RSA_PSS_via_DER(void) { return test_protected_via_DER("RSA-PSS", key_RSA_PSS, 1); } static int test_protected_RSA_PSS_via_PEM(void) { return test_protected_via_PEM("RSA-PSS", key_RSA_PSS, 1); } static int test_public_RSA_PSS_via_DER(void) { return test_public_via_DER("RSA-PSS", key_RSA_PSS, 1); } static int test_public_RSA_PSS_via_PEM(void) { return test_public_via_PEM("RSA-PSS", key_RSA_PSS, 1); }




static int test_unprotected_RSA_via_MSBLOB(void) { return test_unprotected_via_MSBLOB("RSA", key_RSA); } static int test_public_RSA_via_MSBLOB(void) { return test_public_via_MSBLOB("RSA", key_RSA); }
static int test_unprotected_RSA_via_PVK(void) { return test_unprotected_via_PVK("RSA", key_RSA); }

static int test_protected_RSA_via_PVK(void) { return test_protected_via_PVK("RSA", key_RSA); }
                                              ...
                                              size_t gen_len)
{
    ...
    return test_ptr("../test/endecode_test.c", 1107, "a = BN_CTX_get(bnctx)", a = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1108, "b = BN_CTX_get(bnctx)", b = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1109, "prime = BN_CTX_get(bnctx)", prime = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1110, "order = BN_CTX_get(bnctx)", order = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1111, "BN_bin2bn(prime_data, sizeof(prime_data), prime)", BN_bin2bn(prime_data, sizeof(prime_data), prime))
           && test_ptr("../test/endecode_test.c", 1112, "BN_bin2bn(a_data, sizeof(a_data), a)", BN_bin2bn(a_data, sizeof(a_data), a))
           && test_ptr("../test/endecode_test.c", 1113, "BN_bin2bn(b_data, sizeof(b_data), b)", BN_bin2bn(b_data, sizeof(b_data), b))
           && test_ptr("../test/endecode_test.c", 1114, "BN_bin2bn(order_data, sizeof(order_data), order)", BN_bin2bn(order_data, sizeof(order_data), order))
           && test_true("../test/endecode_test.c", 1115, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_EC_FIELD_TYPE, SN_X9_62_prime_field, 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "field-type", "prime-field", 0)) != 0)


           && test_true("../test/endecode_test.c", 1118, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_P, prime)", (OSSL_PARAM_BLD_push_BN(bld, "p", prime)) != 0)
           && test_true("../test/endecode_test.c", 1119, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_A, a)", (OSSL_PARAM_BLD_push_BN(bld, "a", a)) != 0)
           && test_true("../test/endecode_test.c", 1120, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_B, b)", (OSSL_PARAM_BLD_push_BN(bld, "b", b)) != 0)
           && test_true("../test/endecode_test.c", 1121, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_ORDER, order)", (OSSL_PARAM_BLD_push_BN(bld, "order", order)) != 0)

           && test_true("../test/endecode_test.c", 1123, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_EC_GENERATOR, gen, gen_len)", (OSSL_PARAM_BLD_push_octet_string(bld, "generator", gen, gen_len)) != 0)

           && test_true("../test/endecode_test.c", 1125, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_EC_SEED, seed, sizeof(seed))", (OSSL_PARAM_BLD_push_octet_string(bld, "seed", seed, sizeof(seed))) != 0)

           && test_true("../test/endecode_test.c", 1127, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_COFACTOR, BN_value_one())", (OSSL_PARAM_BLD_push_BN(bld, "cofactor", BN_value_one())) != 0)
                                                               ;
}
                                                  ...
                                                  size_t gen_len)
{
    ...
    return test_ptr("../test/endecode_test.c", 1196, "a = BN_CTX_get(bnctx)", a = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1197, "b = BN_CTX_get(bnctx)", b = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1198, "poly = BN_CTX_get(bnctx)", poly = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1199, "order = BN_CTX_get(bnctx)", order = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1200, "cofactor = BN_CTX_get(bnctx)", cofactor = BN_CTX_get(bnctx))
           && test_ptr("../test/endecode_test.c", 1201, "BN_bin2bn(poly_data, sizeof(poly_data), poly)", BN_bin2bn(poly_data, sizeof(poly_data), poly))
           && test_ptr("../test/endecode_test.c", 1202, "BN_bin2bn(a_data, sizeof(a_data), a)", BN_bin2bn(a_data, sizeof(a_data), a))
           && test_ptr("../test/endecode_test.c", 1203, "BN_bin2bn(b_data, sizeof(b_data), b)", BN_bin2bn(b_data, sizeof(b_data), b))
           && test_ptr("../test/endecode_test.c", 1204, "BN_bin2bn(order_data, sizeof(order_data), order)", BN_bin2bn(order_data, sizeof(order_data), order))
           && test_ptr("../test/endecode_test.c", 1205, "BN_bin2bn(cofactor_data, sizeof(cofactor_data), cofactor)", BN_bin2bn(cofactor_data, sizeof(cofactor_data), cofactor))
           && test_true("../test/endecode_test.c", 1206, "OSSL_PARAM_BLD_push_utf8_string(bld, OSSL_PKEY_PARAM_EC_FIELD_TYPE, SN_X9_62_characteristic_two_field, 0)", (OSSL_PARAM_BLD_push_utf8_string(bld, "field-type", "characteristic-two-field", 0)) != 0)


           && test_true("../test/endecode_test.c", 1209, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_P, poly)", (OSSL_PARAM_BLD_push_BN(bld, "p", poly)) != 0)
           && test_true("../test/endecode_test.c", 1210, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_A, a)", (OSSL_PARAM_BLD_push_BN(bld, "a", a)) != 0)
           && test_true("../test/endecode_test.c", 1211, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_B, b)", (OSSL_PARAM_BLD_push_BN(bld, "b", b)) != 0)
           && test_true("../test/endecode_test.c", 1212, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_ORDER, order)", (OSSL_PARAM_BLD_push_BN(bld, "order", order)) != 0)

           && test_true("../test/endecode_test.c", 1214, "OSSL_PARAM_BLD_push_octet_string(bld, OSSL_PKEY_PARAM_EC_GENERATOR, gen, gen_len)", (OSSL_PARAM_BLD_push_octet_string(bld, "generator", gen, gen_len)) != 0)

           && test_true("../test/endecode_test.c", 1216, "OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_EC_COFACTOR, cofactor)", (OSSL_PARAM_BLD_push_BN(bld, "cofactor", cofactor)) != 0)
                                                         ;
}
...
static int ec_encode_to_data_multi(void)
{
    int ret;
    OSSL_ENCODER_CTX *ectx = 
# 1255 "../test/endecode_test.c" 3 4
                            ((void *)0)
# 1255 "../test/endecode_test.c"
                                ;
    EVP_PKEY *key = 
# 1256 "../test/endecode_test.c" 3 4
                   ((void *)0)
# 1256 "../test/endecode_test.c"
                       ;
    uint8_t *enc = 
# 1257 "../test/endecode_test.c" 3 4
                  ((void *)0)
# 1257 "../test/endecode_test.c"
                      ;
    size_t enc_len = 0;

    ret = test_ptr("../test/endecode_test.c", 1260, "key = EVP_PKEY_Q_keygen(testctx, \"\", \"EC\", \"P-256\")", key = EVP_PKEY_Q_keygen(testctx, "", "EC", "P-256"))
        && test_ptr("../test/endecode_test.c", 1261, "ectx = OSSL_ENCODER_CTX_new_for_pkey(key, EVP_PKEY_KEYPAIR, \"DER\", NULL, NULL)", ectx = OSSL_ENCODER_CTX_new_for_pkey(key, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), "DER", 
# 1261 "../test/endecode_test.c" 3 4
          ((void *)0)
# 1261 "../test/endecode_test.c"
          , 
# 1261 "../test/endecode_test.c" 3 4
          ((void *)0)
# 1261 "../test/endecode_test.c"
        ...
        && test_int_eq("../test/endecode_test.c", 1263, "OSSL_ENCODER_to_data(ectx, NULL, &enc_len)", "1", OSSL_ENCODER_to_data(ectx, 
# 1263 "../test/endecode_test.c" 3 4
          ((void *)0)
# 1263 "../test/endecode_test.c"
          , &enc_len), 1)
        && test_int_eq("../test/endecode_test.c", 1264, "OSSL_ENCODER_to_data(ectx, &enc, &enc_len)", "1", OSSL_ENCODER_to_data(ectx, &enc, &enc_len), 1);
    CRYPTO_free(enc, "../test/endecode_test.c", 1265);
    EVP_PKEY_free(key);
    OSSL_ENCODER_CTX_free(ectx);
    return ret;
}
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS options[] = {
        ...
        { 
# 1297 "../test/endecode_test.c" 3 4
         ((void *)0) 
# 1297 "../test/endecode_test.c"
              }
    };
    return options;
}
...
{
    const char *rsa_file = 
# 1304 "../test/endecode_test.c" 3 4
                          ((void *)0)
# 1304 "../test/endecode_test.c"
                              ;
    const char *rsa_pss_file = 
# 1305 "../test/endecode_test.c" 3 4
                              ((void *)0)
# 1305 "../test/endecode_test.c"
                                  ;
    const char *prov_name = "default";
    char *config_file = 
# 1307 "../test/endecode_test.c" 3 4
                       ((void *)0)
# 1307 "../test/endecode_test.c"
                           ;
    int ok = 1;
    ...
    OSSL_PARAM DSA_params[] = {
        { (("pbits")), (2), ((&pbits)), (sizeof(size_t)), ((size_t)-1) },
        { (("qbits")), (2), ((&qbits)), (sizeof(size_t)), ((size_t)-1) },
        { 
# 1316 "../test/endecode_test.c" 3 4
       ((void *)0)
# 1316 "../test/endecode_test.c"
       , 0, 
# 1316 "../test/endecode_test.c" 3 4
       ((void *)0)
# 1316 "../test/endecode_test.c"
    ...
    OSSL_PARAM EC_params[] = {
        { (("group")), (4), ((groupname)), (sizeof(groupname) - 1), ((size_t)-1) },
        { 
# 1324 "../test/endecode_test.c" 3 4
       ((void *)0)
# 1324 "../test/endecode_test.c"
       , 0, 
# 1324 "../test/endecode_test.c" 3 4
       ((void *)0)
# 1324 "../test/endecode_test.c"
    ...
    if (default_libctx) {
        if (!test_get_libctx(
# 1358 "../test/endecode_test.c" 3 4
                            ((void *)0)
# 1358 "../test/endecode_test.c"
                                , 
# 1358 "../test/endecode_test.c" 3 4
                                  ((void *)0)
# 1358 "../test/endecode_test.c"
                                      , config_file, &deflprov, prov_name))
            return 0;
    } else {
    ...
    if (!test_ptr("../test/endecode_test.c", 1379, "keyctx = OSSL_LIB_CTX_new()", keyctx = OSSL_LIB_CTX_new()))
        return 0;
    if (!test_ptr("../test/endecode_test.c", 1381, "keyprov = OSSL_PROVIDER_load(keyctx, \"default\")", keyprov = OSSL_PROVIDER_load(keyctx, "default")))
        return 0;


    if (!test_ptr("../test/endecode_test.c", 1385, "bnctx = BN_CTX_new_ex(testctx)", bnctx = BN_CTX_new_ex(testctx))
        || !test_ptr("../test/endecode_test.c", 1386, "bld_prime_nc = OSSL_PARAM_BLD_new()", bld_prime_nc = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/endecode_test.c", 1387, "bld_prime = OSSL_PARAM_BLD_new()", bld_prime = OSSL_PARAM_BLD_new())
        || !create_ec_explicit_prime_params_namedcurve(bld_prime_nc)
        || !create_ec_explicit_prime_params(bld_prime)
        || !test_ptr("../test/endecode_test.c", 1390, "ec_explicit_prime_params_nc = OSSL_PARAM_BLD_to_param(bld_prime_nc)", ec_explicit_prime_params_nc = OSSL_PARAM_BLD_to_param(bld_prime_nc))
        || !test_ptr("../test/endecode_test.c", 1391, "ec_explicit_prime_params_explicit = OSSL_PARAM_BLD_to_param(bld_prime)", ec_explicit_prime_params_explicit = OSSL_PARAM_BLD_to_param(bld_prime))

        || !test_ptr("../test/endecode_test.c", 1393, "bld_tri_nc = OSSL_PARAM_BLD_new()", bld_tri_nc = OSSL_PARAM_BLD_new())
        || !test_ptr("../test/endecode_test.c", 1394, "bld_tri = OSSL_PARAM_BLD_new()", bld_tri = OSSL_PARAM_BLD_new())
        || !create_ec_explicit_trinomial_params_namedcurve(bld_tri_nc)
        || !create_ec_explicit_trinomial_params(bld_tri)
        || !test_ptr("../test/endecode_test.c", 1397, "ec_explicit_tri_params_nc = OSSL_PARAM_BLD_to_param(bld_tri_nc)", ec_explicit_tri_params_nc = OSSL_PARAM_BLD_to_param(bld_tri_nc))
        || !test_ptr("../test/endecode_test.c", 1398, "ec_explicit_tri_params_explicit = OSSL_PARAM_BLD_to_param(bld_tri)", ec_explicit_tri_params_explicit = OSSL_PARAM_BLD_to_param(bld_tri))

        )
        return 0;


    test_info("../test/endecode_test.c", 1404, "Generating keys...");


    test_info("../test/endecode_test.c", 1407, "Generating DH keys...");
    ok = ok && test_ptr("../test/endecode_test.c", 1408, "template_DH = make_template(\"DH\", ((void *)0))", template_DH = make_template("DH", 
# 1408 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1408 "../test/endecode_test.c"
   )) && test_ptr("../test/endecode_test.c", 1408, "key_DH = make_key(\"DH\", template_DH, NULL)", key_DH = make_key("DH", template_DH, 
# 1408 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1408 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1409, "template_DHX = make_template(\"X9.42 DH\", ((void *)0))", template_DHX = make_template("X9.42 DH", 
# 1409 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1409 "../test/endecode_test.c"
   )) && test_ptr("../test/endecode_test.c", 1409, "key_DHX = make_key(\"X9.42 DH\", template_DHX, NULL)", key_DHX = make_key("X9.42 DH", template_DHX, 
# 1409 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1409 "../test/endecode_test.c"
   ));
    ...
    test_info("../test/endecode_test.c", 1412, "Generating DSA keys...");
    ok = ok && test_ptr("../test/endecode_test.c", 1413, "template_DSA = make_template(\"DSA\", DSA_params)", template_DSA = make_template("DSA", DSA_params)) && test_ptr("../test/endecode_test.c", 1413, "key_DSA = make_key(\"DSA\", template_DSA, NULL)", key_DSA = make_key("DSA", template_DSA, 
# 1413 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1413 "../test/endecode_test.c"
   ));


    test_info("../test/endecode_test.c", 1416, "Generating EC keys...");
    ok = ok && test_ptr("../test/endecode_test.c", 1417, "template_EC = make_template(\"EC\", EC_params)", template_EC = make_template("EC", EC_params)) && test_ptr("../test/endecode_test.c", 1417, "key_EC = make_key(\"EC\", template_EC, NULL)", key_EC = make_key("EC", template_EC, 
# 1417 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1417 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1418, "template_ECExplicitPrimeNamedCurve = make_template(\"EC\", ec_explicit_prime_params_nc)", template_ECExplicitPrimeNamedCurve = make_template("EC", ec_explicit_prime_params_nc)) && test_ptr("../test/endecode_test.c", 1418, "key_ECExplicitPrimeNamedCurve = make_key(\"EC\", template_ECExplicitPrimeNamedCurve, NULL)", key_ECExplicitPrimeNamedCurve = make_key("EC", template_ECExplicitPrimeNamedCurve, 
# 1418 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1418 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1419, "template_ECExplicitPrime2G = make_template(\"EC\", ec_explicit_prime_params_explicit)", template_ECExplicitPrime2G = make_template("EC", ec_explicit_prime_params_explicit)) && test_ptr("../test/endecode_test.c", 1419, "key_ECExplicitPrime2G = make_key(\"EC\", template_ECExplicitPrime2G, NULL)", key_ECExplicitPrime2G = make_key("EC", template_ECExplicitPrime2G, 
# 1419 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1419 "../test/endecode_test.c"
   ));

    ok = ok && test_ptr("../test/endecode_test.c", 1421, "template_ECExplicitTriNamedCurve = make_template(\"EC\", ec_explicit_tri_params_nc)", template_ECExplicitTriNamedCurve = make_template("EC", ec_explicit_tri_params_nc)) && test_ptr("../test/endecode_test.c", 1421, "key_ECExplicitTriNamedCurve = make_key(\"EC\", template_ECExplicitTriNamedCurve, NULL)", key_ECExplicitTriNamedCurve = make_key("EC", template_ECExplicitTriNamedCurve, 
# 1421 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1421 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1422, "template_ECExplicitTri2G = make_template(\"EC\", ec_explicit_tri_params_explicit)", template_ECExplicitTri2G = make_template("EC", ec_explicit_tri_params_explicit)) && test_ptr("../test/endecode_test.c", 1422, "key_ECExplicitTri2G = make_key(\"EC\", template_ECExplicitTri2G, NULL)", key_ECExplicitTri2G = make_key("EC", template_ECExplicitTri2G, 
# 1422 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1422 "../test/endecode_test.c"
   ));


    ok = ok && test_ptr("../test/endecode_test.c", 1425, "key_SM2 = make_key(\"SM2\", NULL, ((void *)0))", key_SM2 = make_key("SM2", 
# 1425 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1425 "../test/endecode_test.c"
   , 
# 1425 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1425 "../test/endecode_test.c"
    ...
    ok = ok && test_ptr("../test/endecode_test.c", 1427, "key_ED25519 = make_key(\"ED25519\", NULL, ((void *)0))", key_ED25519 = make_key("ED25519", 
# 1427 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1427 "../test/endecode_test.c"
   , 
# 1427 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1427 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1428, "key_ED448 = make_key(\"ED448\", NULL, ((void *)0))", key_ED448 = make_key("ED448", 
# 1428 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1428 "../test/endecode_test.c"
   , 
# 1428 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1428 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1429, "key_X25519 = make_key(\"X25519\", NULL, ((void *)0))", key_X25519 = make_key("X25519", 
# 1429 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1429 "../test/endecode_test.c"
   , 
# 1429 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1429 "../test/endecode_test.c"
   ));
    ok = ok && test_ptr("../test/endecode_test.c", 1430, "key_X448 = make_key(\"X448\", NULL, ((void *)0))", key_X448 = make_key("X448", 
# 1430 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1430 "../test/endecode_test.c"
   , 
# 1430 "../test/endecode_test.c" 3 4
   ((void *)0)
# 1430 "../test/endecode_test.c"
    ...
    test_info("../test/endecode_test.c", 1432, "Loading RSA key...");
    ok = ok && test_ptr("../test/endecode_test.c", 1433, "key_RSA = load_pkey_pem(rsa_file, keyctx)", key_RSA = load_pkey_pem(rsa_file, keyctx));
    test_info("../test/endecode_test.c", 1434, "Loading RSA_PSS key...");
    ok = ok && test_ptr("../test/endecode_test.c", 1435, "key_RSA_PSS = load_pkey_pem(rsa_pss_file, keyctx)", key_RSA_PSS = load_pkey_pem(rsa_pss_file, keyctx));
    test_info("../test/endecode_test.c", 1436, "Generating keys done");

    if (ok) {

        add_test("test_unprotected_DH_via_DER", test_unprotected_DH_via_DER); add_test("test_unprotected_DH_via_PEM", test_unprotected_DH_via_PEM); add_test("test_protected_DH_via_DER", test_protected_DH_via_DER); add_test("test_protected_DH_via_PEM", test_protected_DH_via_PEM); add_test("test_public_DH_via_DER", test_public_DH_via_DER); add_test("test_public_DH_via_PEM", test_public_DH_via_PEM);
        add_test("test_params_DH_via_DER", test_params_DH_via_DER); add_test("test_params_DH_via_PEM", test_params_DH_via_PEM);
        add_test("test_unprotected_DHX_via_DER", test_unprotected_DHX_via_DER); add_test("test_unprotected_DHX_via_PEM", test_unprotected_DHX_via_PEM); add_test("test_protected_DHX_via_DER", test_protected_DHX_via_DER); add_test("test_protected_DHX_via_PEM", test_protected_DHX_via_PEM); add_test("test_public_DHX_via_DER", test_public_DHX_via_DER); add_test("test_public_DHX_via_PEM", test_public_DHX_via_PEM);
        add_test("test_params_DHX_via_DER", test_params_DHX_via_DER); add_test("test_params_DHX_via_PEM", test_params_DHX_via_PEM);
        ...
        add_test("test_unprotected_DSA_via_DER", test_unprotected_DSA_via_DER); add_test("test_unprotected_DSA_via_PEM", test_unprotected_DSA_via_PEM); add_test("test_protected_DSA_via_DER", test_protected_DSA_via_DER); add_test("test_protected_DSA_via_PEM", test_protected_DSA_via_PEM); add_test("test_public_DSA_via_DER", test_public_DSA_via_DER); add_test("test_public_DSA_via_PEM", test_public_DSA_via_PEM);
        add_test("test_params_DSA_via_DER", test_params_DSA_via_DER); add_test("test_params_DSA_via_PEM", test_params_DSA_via_PEM);
        add_test("test_unprotected_DSA_via_legacy_PEM", test_unprotected_DSA_via_legacy_PEM); add_test("test_protected_DSA_via_legacy_PEM", test_protected_DSA_via_legacy_PEM);
        add_test("test_unprotected_DSA_via_MSBLOB", test_unprotected_DSA_via_MSBLOB); add_test("test_public_DSA_via_MSBLOB", test_public_DSA_via_MSBLOB);
        add_test("test_unprotected_DSA_via_PVK", test_unprotected_DSA_via_PVK);
        ...
        add_test("test_unprotected_EC_via_DER", test_unprotected_EC_via_DER); add_test("test_unprotected_EC_via_PEM", test_unprotected_EC_via_PEM); add_test("test_protected_EC_via_DER", test_protected_EC_via_DER); add_test("test_protected_EC_via_PEM", test_protected_EC_via_PEM); add_test("test_public_EC_via_DER", test_public_EC_via_DER); add_test("test_public_EC_via_PEM", test_public_EC_via_PEM);
        add_test("test_params_EC_via_DER", test_params_EC_via_DER); add_test("test_params_EC_via_PEM", test_params_EC_via_PEM);
        add_test("test_unprotected_EC_via_legacy_PEM", test_unprotected_EC_via_legacy_PEM); add_test("test_protected_EC_via_legacy_PEM", test_protected_EC_via_legacy_PEM);
        add_test("test_unprotected_ECExplicitPrimeNamedCurve_via_DER", test_unprotected_ECExplicitPrimeNamedCurve_via_DER); add_test("test_unprotected_ECExplicitPrimeNamedCurve_via_PEM", test_unprotected_ECExplicitPrimeNamedCurve_via_PEM); add_test("test_protected_ECExplicitPrimeNamedCurve_via_DER", test_protected_ECExplicitPrimeNamedCurve_via_DER); add_test("test_protected_ECExplicitPrimeNamedCurve_via_PEM", test_protected_ECExplicitPrimeNamedCurve_via_PEM); add_test("test_public_ECExplicitPrimeNamedCurve_via_DER", test_public_ECExplicitPrimeNamedCurve_via_DER); add_test("test_public_ECExplicitPrimeNamedCurve_via_PEM", test_public_ECExplicitPrimeNamedCurve_via_PEM);
        add_test("test_unprotected_ECExplicitPrimeNamedCurve_via_legacy_PEM", test_unprotected_ECExplicitPrimeNamedCurve_via_legacy_PEM); add_test("test_protected_ECExplicitPrimeNamedCurve_via_legacy_PEM", test_protected_ECExplicitPrimeNamedCurve_via_legacy_PEM);
        add_test("test_unprotected_ECExplicitPrime2G_via_DER", test_unprotected_ECExplicitPrime2G_via_DER); add_test("test_unprotected_ECExplicitPrime2G_via_PEM", test_unprotected_ECExplicitPrime2G_via_PEM); add_test("test_protected_ECExplicitPrime2G_via_DER", test_protected_ECExplicitPrime2G_via_DER); add_test("test_protected_ECExplicitPrime2G_via_PEM", test_protected_ECExplicitPrime2G_via_PEM); add_test("test_public_ECExplicitPrime2G_via_DER", test_public_ECExplicitPrime2G_via_DER); add_test("test_public_ECExplicitPrime2G_via_PEM", test_public_ECExplicitPrime2G_via_PEM);
        add_test("test_unprotected_ECExplicitPrime2G_via_legacy_PEM", test_unprotected_ECExplicitPrime2G_via_legacy_PEM); add_test("test_protected_ECExplicitPrime2G_via_legacy_PEM", test_protected_ECExplicitPrime2G_via_legacy_PEM);

        add_test("test_unprotected_ECExplicitTriNamedCurve_via_DER", test_unprotected_ECExplicitTriNamedCurve_via_DER); add_test("test_unprotected_ECExplicitTriNamedCurve_via_PEM", test_unprotected_ECExplicitTriNamedCurve_via_PEM); add_test("test_protected_ECExplicitTriNamedCurve_via_DER", test_protected_ECExplicitTriNamedCurve_via_DER); add_test("test_protected_ECExplicitTriNamedCurve_via_PEM", test_protected_ECExplicitTriNamedCurve_via_PEM); add_test("test_public_ECExplicitTriNamedCurve_via_DER", test_public_ECExplicitTriNamedCurve_via_DER); add_test("test_public_ECExplicitTriNamedCurve_via_PEM", test_public_ECExplicitTriNamedCurve_via_PEM);
        add_test("test_unprotected_ECExplicitTriNamedCurve_via_legacy_PEM", test_unprotected_ECExplicitTriNamedCurve_via_legacy_PEM); add_test("test_protected_ECExplicitTriNamedCurve_via_legacy_PEM", test_protected_ECExplicitTriNamedCurve_via_legacy_PEM);
        add_test("test_unprotected_ECExplicitTri2G_via_DER", test_unprotected_ECExplicitTri2G_via_DER); add_test("test_unprotected_ECExplicitTri2G_via_PEM", test_unprotected_ECExplicitTri2G_via_PEM); add_test("test_protected_ECExplicitTri2G_via_DER", test_protected_ECExplicitTri2G_via_DER); add_test("test_protected_ECExplicitTri2G_via_PEM", test_protected_ECExplicitTri2G_via_PEM); add_test("test_public_ECExplicitTri2G_via_DER", test_public_ECExplicitTri2G_via_DER); add_test("test_public_ECExplicitTri2G_via_PEM", test_public_ECExplicitTri2G_via_PEM);
        add_test("test_unprotected_ECExplicitTri2G_via_legacy_PEM", test_unprotected_ECExplicitTri2G_via_legacy_PEM); add_test("test_protected_ECExplicitTri2G_via_legacy_PEM", test_protected_ECExplicitTri2G_via_legacy_PEM);


        if (!is_fips_3_0_0) {

            add_test("test_unprotected_SM2_via_DER", test_unprotected_SM2_via_DER); add_test("test_unprotected_SM2_via_PEM", test_unprotected_SM2_via_PEM); add_test("test_protected_SM2_via_DER", test_protected_SM2_via_DER); add_test("test_protected_SM2_via_PEM", test_protected_SM2_via_PEM); add_test("test_public_SM2_via_DER", test_public_SM2_via_DER); add_test("test_public_SM2_via_PEM", test_public_SM2_via_PEM);
        }

        add_test("test_unprotected_ED25519_via_DER", test_unprotected_ED25519_via_DER); add_test("test_unprotected_ED25519_via_PEM", test_unprotected_ED25519_via_PEM); add_test("test_protected_ED25519_via_DER", test_protected_ED25519_via_DER); add_test("test_protected_ED25519_via_PEM", test_protected_ED25519_via_PEM); add_test("test_public_ED25519_via_DER", test_public_ED25519_via_DER); add_test("test_public_ED25519_via_PEM", test_public_ED25519_via_PEM);
        add_test("test_unprotected_ED448_via_DER", test_unprotected_ED448_via_DER); add_test("test_unprotected_ED448_via_PEM", test_unprotected_ED448_via_PEM); add_test("test_protected_ED448_via_DER", test_protected_ED448_via_DER); add_test("test_protected_ED448_via_PEM", test_protected_ED448_via_PEM); add_test("test_public_ED448_via_DER", test_public_ED448_via_DER); add_test("test_public_ED448_via_PEM", test_public_ED448_via_PEM);
        add_test("test_unprotected_X25519_via_DER", test_unprotected_X25519_via_DER); add_test("test_unprotected_X25519_via_PEM", test_unprotected_X25519_via_PEM); add_test("test_protected_X25519_via_DER", test_protected_X25519_via_DER); add_test("test_protected_X25519_via_PEM", test_protected_X25519_via_PEM); add_test("test_public_X25519_via_DER", test_public_X25519_via_DER); add_test("test_public_X25519_via_PEM", test_public_X25519_via_PEM);
        add_test("test_unprotected_X448_via_DER", test_unprotected_X448_via_DER); add_test("test_unprotected_X448_via_PEM", test_unprotected_X448_via_PEM); add_test("test_protected_X448_via_DER", test_protected_X448_via_DER); add_test("test_protected_X448_via_PEM", test_protected_X448_via_PEM); add_test("test_public_X448_via_DER", test_public_X448_via_DER); add_test("test_public_X448_via_PEM", test_public_X448_via_PEM);





        add_test("test_unprotected_RSA_via_DER", test_unprotected_RSA_via_DER); add_test("test_unprotected_RSA_via_PEM", test_unprotected_RSA_via_PEM); add_test("test_protected_RSA_via_DER", test_protected_RSA_via_DER); add_test("test_protected_RSA_via_PEM", test_protected_RSA_via_PEM); add_test("test_public_RSA_via_DER", test_public_RSA_via_DER); add_test("test_public_RSA_via_PEM", test_public_RSA_via_PEM);
        add_test("test_unprotected_RSA_via_legacy_PEM", test_unprotected_RSA_via_legacy_PEM); add_test("test_protected_RSA_via_legacy_PEM", test_protected_RSA_via_legacy_PEM);
        add_test("test_unprotected_RSA_PSS_via_DER", test_unprotected_RSA_PSS_via_DER); add_test("test_unprotected_RSA_PSS_via_PEM", test_unprotected_RSA_PSS_via_PEM); add_test("test_protected_RSA_PSS_via_DER", test_protected_RSA_PSS_via_DER); add_test("test_protected_RSA_PSS_via_PEM", test_protected_RSA_PSS_via_PEM); add_test("test_public_RSA_PSS_via_DER", test_public_RSA_PSS_via_DER); add_test("test_public_RSA_PSS_via_PEM", test_public_RSA_PSS_via_PEM);




        add_test("test_unprotected_RSA_via_MSBLOB", test_unprotected_RSA_via_MSBLOB); add_test("test_public_RSA_via_MSBLOB", test_public_RSA_via_MSBLOB);
        add_test("test_unprotected_RSA_via_PVK", test_unprotected_RSA_via_PVK);
...
void cleanup_tests(void)
{
    ...
    EVP_PKEY_free(template_DH); EVP_PKEY_free(key_DH);
    EVP_PKEY_free(template_DHX); EVP_PKEY_free(key_DHX);


    EVP_PKEY_free(template_DSA); EVP_PKEY_free(key_DSA);


    EVP_PKEY_free(template_EC); EVP_PKEY_free(key_EC);
    EVP_PKEY_free(template_ECExplicitPrimeNamedCurve); EVP_PKEY_free(key_ECExplicitPrimeNamedCurve);
    EVP_PKEY_free(template_ECExplicitPrime2G); EVP_PKEY_free(key_ECExplicitPrime2G);

    EVP_PKEY_free(template_ECExplicitTriNamedCurve); EVP_PKEY_free(key_ECExplicitTriNamedCurve);
    EVP_PKEY_free(template_ECExplicitTri2G); EVP_PKEY_free(key_ECExplicitTri2G);
