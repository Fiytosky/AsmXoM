# 0 "../test/cmp_client_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_client_test.c"
# 12 "../test/cmp_client_test.c"
...
int print_to_bio_out(const char *func, const char *file, int line,
                     OSSL_CMP_severity level, const char *msg);
# 13 "../test/cmp_client_test.c" 2

# 1 "../apps/include/cmp_mock_srv.h" 1
# 19 "../apps/include/cmp_mock_srv.h"
...
# 31 "../test/cmp_client_test.c" 3 4
                             ((void *)0)
# 31 "../test/cmp_client_test.c"
                                 ;
static OSSL_PROVIDER *default_null_provider = 
# 32 "../test/cmp_client_test.c" 3 4
                                             ((void *)0)
# 32 "../test/cmp_client_test.c"
                                                 , *provider = 
# 32 "../test/cmp_client_test.c" 3 4
                                                               ((void *)0)
# 32 "../test/cmp_client_test.c"
...
# 34 "../test/cmp_client_test.c" 3 4
                             ((void *)0)
# 34 "../test/cmp_client_test.c"
                                 ;
static X509 *server_cert = 
# 35 "../test/cmp_client_test.c" 3 4
                          ((void *)0)
# 35 "../test/cmp_client_test.c"
                              ;
static EVP_PKEY *client_key = 
# 36 "../test/cmp_client_test.c" 3 4
                             ((void *)0)
# 36 "../test/cmp_client_test.c"
                                 ;
static X509 *client_cert = 
# 37 "../test/cmp_client_test.c" 3 4
                          ((void *)0)
# 37 "../test/cmp_client_test.c"
                              ;
...
static void tear_down(CMP_SES_TEST_FIXTURE *fixture)
{
    ...
    OPENSSL_sk_free(ossl_check_X509_sk_type(fixture->caPubs));
    CRYPTO_free(fixture, "../test/cmp_client_test.c", 51);
}
...
# 57 "../test/cmp_client_test.c" 3 4
                               ((void *)0)
# 57 "../test/cmp_client_test.c"
                                   ;
    OSSL_CMP_CTX *ctx = 
# 58 "../test/cmp_client_test.c" 3 4
                       ((void *)0)
# 58 "../test/cmp_client_test.c"
                           ;

    if (!test_ptr("../test/cmp_client_test.c", 60, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_client_test.c", 60)))
        return 
# 61 "../test/cmp_client_test.c" 3 4
              ((void *)0)
# 61 "../test/cmp_client_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/cmp_client_test.c", 63, "fixture->srv_ctx = ossl_cmp_mock_srv_new(libctx, NULL)", fixture->srv_ctx = ossl_cmp_mock_srv_new(libctx, 
# 63 "../test/cmp_client_test.c" 3 4
        ((void *)0)
# 63 "../test/cmp_client_test.c"
        ))
            ...
            || (srv_cmp_ctx =
                OSSL_CMP_SRV_CTX_get0_cmp_ctx(fixture->srv_ctx)) == 
# 68 "../test/cmp_client_test.c" 3 4
                                                                   ((void *)0)
            
# 69 "../test/cmp_client_test.c"
           || !OSSL_CMP_CTX_set1_cert(srv_cmp_ctx, server_cert)
            || !OSSL_CMP_CTX_set1_pkey(srv_cmp_ctx, server_key))
        goto err;
    if (!test_ptr("../test/cmp_client_test.c", 72, "fixture->cmp_ctx = ctx = OSSL_CMP_CTX_new(libctx, NULL)", fixture->cmp_ctx = ctx = OSSL_CMP_CTX_new(libctx, 
# 72 "../test/cmp_client_test.c" 3 4
        ((void *)0)
# 72 "../test/cmp_client_test.c"
        ))
            ...
            || !OSSL_CMP_CTX_set_option(ctx, 30, 1)
            || !OSSL_CMP_CTX_set_option(ctx, 31, 1)
 ...
 err:
    tear_down(fixture);
    return 
# 89 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 89 "../test/cmp_client_test.c"
              ;
}

static int execute_exec_RR_ses_test(CMP_SES_TEST_FIXTURE *fixt)
{
    return test_int_eq("../test/cmp_client_test.c", 94, "OSSL_CMP_CTX_get_status(fixt->cmp_ctx)", "OSSL_CMP_PKISTATUS_unspecified", OSSL_CMP_CTX_get_status(fixt->cmp_ctx), -1)

        && test_int_eq("../test/cmp_client_test.c", 96, "OSSL_CMP_exec_RR_ses(fixt->cmp_ctx)", "fixt->expected == OSSL_CMP_PKISTATUS_accepted", OSSL_CMP_exec_RR_ses(fixt->cmp_ctx), fixt->expected == 0)

        && test_int_eq("../test/cmp_client_test.c", 98, "OSSL_CMP_CTX_get_status(fixt->cmp_ctx)", "fixt->expected", OSSL_CMP_CTX_get_status(fixt->cmp_ctx), fixt->expected);
}
...
static int execute_exec_GENM_ses_test_single(CMP_SES_TEST_FIXTURE *fixture)
{
    ...
    OSSL_CMP_ITAV *itav = OSSL_CMP_ITAV_create(type, 
# 105 "../test/cmp_client_test.c" 3 4
                                                    ((void *)0)
# 105 "../test/cmp_client_test.c"
                                                        );
    struct stack_st_OSSL_CMP_ITAV *itavs;

    OSSL_CMP_CTX_push0_genm_ITAV(ctx, itav);
    itavs = OSSL_CMP_exec_GENM_ses(ctx);

    OPENSSL_sk_pop_free(ossl_check_OSSL_CMP_ITAV_sk_type(itavs),ossl_check_OSSL_CMP_ITAV_freefunc_type(OSSL_CMP_ITAV_free));
    return test_int_eq("../test/cmp_client_test.c", 112, "OSSL_CMP_CTX_get_status(ctx)", "fixture->expected", OSSL_CMP_CTX_get_status(ctx), fixture->expected)
        && fixture->expected == 0 ?
        test_ptr("../test/cmp_client_test.c", 114, "itavs", itavs) : test_ptr_null("../test/cmp_client_test.c", 114, "itavs", itavs);
}
...
{
    OSSL_CMP_CTX *ctx = fixture->cmp_ctx;
    X509 *res = OSSL_CMP_exec_certreq(ctx, fixture->req_type, 
# 127 "../test/cmp_client_test.c" 3 4
                                                             ((void *)0)
# 127 "../test/cmp_client_test.c"
                                                                 );
    int status = OSSL_CMP_CTX_get_status(ctx);

    OSSL_CMP_CTX_print_errors(ctx);
    if (!test_int_eq("../test/cmp_client_test.c", 131, "status", "fixture->expected", status, fixture->expected)
        && !(fixture->expected == 3
             && test_int_eq("../test/cmp_client_test.c", 133, "status", "OSSL_CMP_PKISTATUS_trans", status, -2)))
        return 0;
    if (fixture->expected != 0)
        return test_ptr_null("../test/cmp_client_test.c", 136, "res", res);

    if (!test_ptr("../test/cmp_client_test.c", 138, "res", res) || !test_int_eq("../test/cmp_client_test.c", 138, "X509_cmp(res, client_cert)", "0", X509_cmp(res, client_cert), 0))
        return 0;
    if (fixture->caPubs != 
# 140 "../test/cmp_client_test.c" 3 4
                          ((void *)0)
# 140 "../test/cmp_client_test.c"
                              ) {
        struct stack_st_X509 *caPubs = OSSL_CMP_CTX_get1_caPubs(fixture->cmp_ctx);
        int ret = test_int_eq("../test/cmp_client_test.c", 142, "STACK_OF_X509_cmp(fixture->caPubs, caPubs)", "0", STACK_OF_X509_cmp(fixture->caPubs, caPubs), 0);
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 152 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 152 "../test/cmp_client_test.c"
   ) return 0;
    if (request_error)
        OSSL_CMP_CTX_set1_oldCert(fixture->cmp_ctx, 
# 154 "../test/cmp_client_test.c" 3 4
                                                   ((void *)0)
# 154 "../test/cmp_client_test.c"
                                                       );
    fixture->expected = request_error ? -3
        : 0;
    if (fixture != 
# 157 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 157 "../test/cmp_client_test.c"
   ) { result = execute_exec_RR_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 173 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 173 "../test/cmp_client_test.c"
   ) return 0;
    ossl_cmp_mock_srv_set_statusInfo(fixture->srv_ctx,
                                     2,
                                     (1 << 20),
                                     "test string");
    ossl_cmp_mock_srv_set_sendError(fixture->srv_ctx, 11);
    fixture->expected = 2;
    if (fixture != 
# 180 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 180 "../test/cmp_client_test.c"
   ) { result = execute_exec_RR_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 186 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 186 "../test/cmp_client_test.c"
   ) return 0;
    fixture->req_type = 0;
    fixture->expected = 0;
    fixture->caPubs = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
    OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->caPubs), ossl_check_X509_type(server_cert));
    OPENSSL_sk_push(ossl_check_X509_sk_type(fixture->caPubs), ossl_check_X509_type(server_cert));
    ossl_cmp_mock_srv_set1_caPubsOut(fixture->srv_ctx, fixture->caPubs);
    if (fixture != 
# 193 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 193 "../test/cmp_client_test.c"
   ) { result = execute_exec_certrequest_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 201 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 201 "../test/cmp_client_test.c"
   ) return 0;
    ...
    if (req_type == 0) {
        if (fixture != 
# 210 "../test/cmp_client_test.c" 3 4
       ((void *)0)
# 210 "../test/cmp_client_test.c"
       ) { result = execute_exec_certrequest_ses_test(fixture); tear_down(fixture); };
    } else if (req_type == 21) {
        if (fixture != 
# 212 "../test/cmp_client_test.c" 3 4
       ((void *)0)
# 212 "../test/cmp_client_test.c"
       ) { result = execute_exec_GENM_ses_test(fixture); tear_down(fixture); };
    }
    return result;
}
...
{
    return test_exec_REQ_ses_poll(0, checkAfter, 2, 0,
                                  0);
}

static int test_exec_IR_ses_poll_no_timeout(void)
{
    return test_exec_REQ_ses_poll(0, checkAfter,
                                  2 ,
                                  checkAfter + 14,
                                  0);
}
...
{
    return !test_exec_REQ_ses_poll(0, checkAfter + 1,
                                   3 , checkAfter + 6,
                                   3);
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 241 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 241 "../test/cmp_client_test.c"
   ) return 0;
    fixture->req_type = 2;
    OSSL_CMP_CTX_set_option(fixture->cmp_ctx,
                            25, implicit_confirm);
    ...
    ossl_cmp_mock_srv_set_sendError(fixture->srv_ctx,
                                    reject ? 24 : -1);
    fixture->expected = reject ? 2
        : 0;
    if (fixture != 
# 250 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 250 "../test/cmp_client_test.c"
   ) { result = execute_exec_certrequest_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 268 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 268 "../test/cmp_client_test.c"
   ) return 0;
    fixture->req_type = 7;


    if (transfer_error)
        OSSL_CMP_CTX_set_transfer_cb_arg(fixture->cmp_ctx, 
# 273 "../test/cmp_client_test.c" 3 4
                                                          ((void *)0)
# 273 "../test/cmp_client_test.c"
                                                              );
    if (pubkey) {
    ...
    if (pubkey || raverified)
        OSSL_CMP_CTX_set_option(fixture->cmp_ctx, 24,
                                0);
    fixture->expected = transfer_error ? -2 :
        raverified ? 2 : 0;
    if (fixture != 
# 286 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 286 "../test/cmp_client_test.c"
   ) { result = execute_exec_certrequest_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
static int test_exec_P10CR_ses(int reject)
{
    OSSL_CMP_CTX *ctx;
    X509_REQ *csr = 
# 334 "../test/cmp_client_test.c" 3 4
                   ((void *)0)
# 334 "../test/cmp_client_test.c"
                       ;

    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 336 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 336 "../test/cmp_client_test.c"
   ) return 0;
    fixture->req_type = 4;
    fixture->expected = reject ? 2
        : 0;
    ctx = fixture->cmp_ctx;
    if (!test_ptr("../test/cmp_client_test.c", 341, "csr = load_csr_der(pkcs10_f, libctx)", csr = load_csr_der(pkcs10_f, libctx))
        || !test_true("../test/cmp_client_test.c", 342, "OSSL_CMP_CTX_set1_p10CSR(ctx, csr)", (OSSL_CMP_CTX_set1_p10CSR(ctx, csr)) != 0)
        || !test_true("../test/cmp_client_test.c", 343, "OSSL_CMP_CTX_set_certConf_cb(ctx, test_certConf_cb)", (OSSL_CMP_CTX_set_certConf_cb(ctx, test_certConf_cb)) != 0)
        || !test_true("../test/cmp_client_test.c", 344, "OSSL_CMP_CTX_set_certConf_cb_arg(ctx, &reject)", (OSSL_CMP_CTX_set_certConf_cb_arg(ctx, &reject)) != 0)) {
        tear_down(fixture);
        fixture = 
# 346 "../test/cmp_client_test.c" 3 4
                 ((void *)0)
# 346 "../test/cmp_client_test.c"
                     ;
    }
    X509_REQ_free(csr);
    if (fixture != 
# 349 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 349 "../test/cmp_client_test.c"
   ) { result = execute_exec_certrequest_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_try_certreq_poll_test(CMP_SES_TEST_FIXTURE *fixture)
{
    ...
    ossl_cmp_mock_srv_set_checkAfterTime(fixture->srv_ctx, CHECK_AFTER);
    return test_int_eq("../test/cmp_client_test.c", 372, "-1", "OSSL_CMP_try_certreq(ctx, TYPE, NULL, &check_after)", -1, OSSL_CMP_try_certreq(ctx, TYPE, 
# 372 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 372 "../test/cmp_client_test.c"
          , &check_after))
        && check_after == CHECK_AFTER
        && test_ptr_eq("../test/cmp_client_test.c", 374, "OSSL_CMP_CTX_get0_newCert(ctx)", "NULL", OSSL_CMP_CTX_get0_newCert(ctx), 
# 374 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 374 "../test/cmp_client_test.c"
          )
        && test_int_eq("../test/cmp_client_test.c", 375, "-1", "OSSL_CMP_try_certreq(ctx, TYPE, NULL, &check_after)", -1, OSSL_CMP_try_certreq(ctx, TYPE, 
# 375 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 375 "../test/cmp_client_test.c"
          , &check_after))
        && check_after == CHECK_AFTER
        && test_ptr_eq("../test/cmp_client_test.c", 377, "OSSL_CMP_CTX_get0_newCert(ctx)", "NULL", OSSL_CMP_CTX_get0_newCert(ctx), 
# 377 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 377 "../test/cmp_client_test.c"
          )
        && test_int_eq("../test/cmp_client_test.c", 378, "fixture->expected", "OSSL_CMP_try_certreq(ctx, TYPE, NULL, NULL)", fixture->expected, OSSL_CMP_try_certreq(ctx, TYPE, 
# 378 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 378 "../test/cmp_client_test.c"
          , 
# 378 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 378 "../test/cmp_client_test.c"
        ...
        && test_int_eq("../test/cmp_client_test.c", 380, "0", "X509_cmp(OSSL_CMP_CTX_get0_newCert(ctx), client_cert)", 0, X509_cmp(OSSL_CMP_CTX_get0_newCert(ctx), client_cert))
                                                                             ;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 386 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 386 "../test/cmp_client_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 388 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 388 "../test/cmp_client_test.c"
   ) { result = execute_try_certreq_poll_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_try_certreq_poll_abort_test(CMP_SES_TEST_FIXTURE *fixture)
{
    ...
    ossl_cmp_mock_srv_set_pollCount(fixture->srv_ctx, 3);
    ossl_cmp_mock_srv_set_checkAfterTime(fixture->srv_ctx, CHECK_AFTER);
    return test_int_eq("../test/cmp_client_test.c", 401, "-1", "OSSL_CMP_try_certreq(ctx, TYPE, NULL, &check_after)", -1, OSSL_CMP_try_certreq(ctx, TYPE, 
# 401 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 401 "../test/cmp_client_test.c"
          , &check_after))
        && check_after == CHECK_AFTER
        && test_ptr_eq("../test/cmp_client_test.c", 403, "OSSL_CMP_CTX_get0_newCert(ctx)", "NULL", OSSL_CMP_CTX_get0_newCert(ctx), 
# 403 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 403 "../test/cmp_client_test.c"
          )
        && test_int_eq("../test/cmp_client_test.c", 404, "fixture->expected", "OSSL_CMP_try_certreq(ctx, -1 , NULL, NULL)", fixture->expected, OSSL_CMP_try_certreq(ctx, -1 , 
# 404 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 404 "../test/cmp_client_test.c"
          , 
# 404 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 404 "../test/cmp_client_test.c"
        ...
        && test_ptr_eq("../test/cmp_client_test.c", 406, "OSSL_CMP_CTX_get0_newCert(fixture->cmp_ctx)", "NULL", OSSL_CMP_CTX_get0_newCert(fixture->cmp_ctx), 
# 406 "../test/cmp_client_test.c" 3 4
          ((void *)0)
# 406 "../test/cmp_client_test.c"
          );
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 411 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 411 "../test/cmp_client_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 413 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 413 "../test/cmp_client_test.c"
   ) { result = execute_try_certreq_poll_abort_test(fixture); tear_down(fixture); };
    return result;
}

static int test_exec_GENM_ses_poll_ok(void)
{
    return test_exec_REQ_ses_poll(21, checkAfter, 2, 0,
                                  0);
}

static int test_exec_GENM_ses_poll_no_timeout(void)
{
    return test_exec_REQ_ses_poll(21, checkAfter,
                                  1 , checkAfter + 1,
                                  0);
}
...
{
    return test_exec_REQ_ses_poll(21, checkAfter + 1,
                                  3 , checkAfter + 2,
                                  3);
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 439 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 439 "../test/cmp_client_test.c"
   ) return 0;
    if (transfer_error)
        OSSL_CMP_CTX_set_transfer_cb_arg(fixture->cmp_ctx, 
# 441 "../test/cmp_client_test.c" 3 4
                                                          ((void *)0)
# 441 "../test/cmp_client_test.c"
                                                              );
    ...
    fixture->expected = expect;
    if (fixture != 
# 448 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 448 "../test/cmp_client_test.c"
   ) { result = execute_exec_GENM_ses_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    return test_exec_GENM_ses(0, 0, 0);
}

static int test_exec_GENM_ses_transfer_error(void)
{
    return test_exec_GENM_ses(1, 0, -2);
}

static int test_exec_GENM_ses_total_timeout(void)
{
    return test_exec_GENM_ses(0, -1, -2);
}

static int execute_exchange_certConf_test(CMP_SES_TEST_FIXTURE *fixture)
{
    int res =
        ossl_cmp_exchange_certConf(fixture->cmp_ctx, 0,
                                   17,
                                   "abcdefg");

    return test_int_eq("../test/cmp_client_test.c", 474, "fixture->expected", "res", fixture->expected, res);
}
...
static int execute_exchange_error_test(CMP_SES_TEST_FIXTURE *fixture)
{
    ...
    return test_int_eq("../test/cmp_client_test.c", 485, "fixture->expected", "res", fixture->expected, res);
}

static int test_exchange_certConf(void)
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 490 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 490 "../test/cmp_client_test.c"
   ) return 0;
    fixture->expected = 0;
    if (!ossl_cmp_ctx_set0_newCert(fixture->cmp_ctx, X509_dup(client_cert))) {
        tear_down(fixture);
        fixture = 
# 494 "../test/cmp_client_test.c" 3 4
                 ((void *)0)
# 494 "../test/cmp_client_test.c"
                     ;
    }
    if (fixture != 
# 496 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 496 "../test/cmp_client_test.c"
   ) { result = execute_exchange_certConf_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_SES_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 502 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 502 "../test/cmp_client_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 504 "../test/cmp_client_test.c" 3 4
   ((void *)0)
# 504 "../test/cmp_client_test.c"
   ) { result = execute_exchange_error_test(fixture); tear_down(fixture); };
    return result;
}
...
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "server.key server.crt client.key client.crt client.csr module_name [module_conf_file]\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 521 "../test/cmp_client_test.c" 3 4
((void *)0) 
# 521 "../test/cmp_client_test.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/cmp_client_test.c", 526, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/cmp_client_test.c", 530, "server_key_f = test_get_argument(0)", server_key_f = test_get_argument(0))
            || !test_ptr("../test/cmp_client_test.c", 531, "server_cert_f = test_get_argument(1)", server_cert_f = test_get_argument(1))
            || !test_ptr("../test/cmp_client_test.c", 532, "client_key_f = test_get_argument(2)", client_key_f = test_get_argument(2))
            || !test_ptr("../test/cmp_client_test.c", 533, "client_cert_f = test_get_argument(3)", client_cert_f = test_get_argument(3))
            || !test_ptr("../test/cmp_client_test.c", 534, "pkcs10_f = test_get_argument(4)", pkcs10_f = test_get_argument(4))) {
        test_error("../test/cmp_client_test.c", 535, "usage: cmp_client_test %s", "server.key server.crt client.key client.crt client.csr module_name [module_conf_file]\n");
        return 0;
    }

    if (!test_arg_libctx(&libctx, &default_null_provider, &provider, 5, "server.key server.crt client.key client.crt client.csr module_name [module_conf_file]\n"))
        return 0;

    if (!test_ptr("../test/cmp_client_test.c", 542, "server_key = load_pkey_pem(server_key_f, libctx)", server_key = load_pkey_pem(server_key_f, libctx))
            || !test_ptr("../test/cmp_client_test.c", 543, "server_cert = load_cert_pem(server_cert_f, libctx)", server_cert = load_cert_pem(server_cert_f, libctx))
            || !test_ptr("../test/cmp_client_test.c", 544, "client_key = load_pkey_pem(client_key_f, libctx)", client_key = load_pkey_pem(client_key_f, libctx))
            || !test_ptr("../test/cmp_client_test.c", 545, "client_cert = load_cert_pem(client_cert_f, libctx)", client_cert = load_cert_pem(client_cert_f, libctx))
            || !test_int_eq("../test/cmp_client_test.c", 546, "1", "RAND_bytes_ex(libctx, ref, sizeof(ref), 0)", 1, RAND_bytes_ex(libctx, ref, sizeof(ref), 0))) {
        cleanup_tests();
        return 0;
    }
    ...
    add_test("test_exec_CR_ses_explicit_confirm", test_exec_CR_ses_explicit_confirm);
    add_test("test_exec_CR_ses_implicit_confirm", test_exec_CR_ses_implicit_confirm);
    ...
    add_test("test_exec_IR_ses_poll_total_timeout", test_exec_IR_ses_poll_total_timeout);
    ...
    add_test("test_exec_GENM_ses_transfer_error", test_exec_GENM_ses_transfer_error);
    ...
    add_test("test_exec_GENM_ses_poll_no_timeout", test_exec_GENM_ses_poll_no_timeout);
    add_test("test_exec_GENM_ses_poll_total_timeout", test_exec_GENM_ses_poll_total_timeout);
