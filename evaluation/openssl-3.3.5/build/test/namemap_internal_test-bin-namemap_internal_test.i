# 0 "../test/namemap_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/namemap_internal_test.c"
# 10 "../test/namemap_internal_test.c"
...
# 11 "../test/namemap_internal_test.c" 2
...
# 12 "../test/namemap_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 16 "../test/testutil.h"
...
# 13 "../test/namemap_internal_test.c" 2
...
{
    OSSL_NAMEMAP *nm = 
# 21 "../test/namemap_internal_test.c" 3 4
                      ((void *)0)
# 21 "../test/namemap_internal_test.c"
                          ;
    int ok;

    ok = test_int_eq("../test/namemap_internal_test.c", 24, "ossl_namemap_empty(NULL)", "1", ossl_namemap_empty(
# 24 "../test/namemap_internal_test.c" 3 4
        ((void *)0)
# 24 "../test/namemap_internal_test.c"
        ), 1)
         && test_ptr("../test/namemap_internal_test.c", 25, "nm = ossl_namemap_new()", nm = ossl_namemap_new())
         && test_int_eq("../test/namemap_internal_test.c", 26, "ossl_namemap_empty(nm)", "1", ossl_namemap_empty(nm), 1)
         && test_int_ne("../test/namemap_internal_test.c", 27, "ossl_namemap_add_name(nm, 0, NAME1)", "0", ossl_namemap_add_name(nm, 0, "name1"), 0)
         && test_int_eq("../test/namemap_internal_test.c", 28, "ossl_namemap_empty(nm)", "0", ossl_namemap_empty(nm), 0);
...
static int test_namemap(OSSL_NAMEMAP *nm)
{
    ...
    int num4 = ossl_namemap_add_name(nm, 0, "ALIAS1");
    ...
    int check4 = ossl_namemap_name2num(nm, "ALIAS1");
    int false1 = ossl_namemap_name2num(nm, "cookie");

    return test_int_ne("../test/namemap_internal_test.c", 45, "num1", "0", num1, 0)
        && test_int_ne("../test/namemap_internal_test.c", 46, "num2", "0", num2, 0)
        && test_int_eq("../test/namemap_internal_test.c", 47, "num1", "num3", num1, num3)
        && test_int_eq("../test/namemap_internal_test.c", 48, "num3", "num4", num3, num4)
        && test_int_eq("../test/namemap_internal_test.c", 49, "num1", "check1", num1, check1)
        && test_int_eq("../test/namemap_internal_test.c", 50, "num2", "check2", num2, check2)
        && test_int_eq("../test/namemap_internal_test.c", 51, "num3", "check3", num3, check3)
        && test_int_eq("../test/namemap_internal_test.c", 52, "num4", "check4", num4, check4)
        && test_int_eq("../test/namemap_internal_test.c", 53, "false1", "0", false1, 0);
}

static int test_namemap_independent(void)
{
    OSSL_NAMEMAP *nm = ossl_namemap_new();
    int ok = test_ptr("../test/namemap_internal_test.c", 59, "nm", nm) && test_namemap(nm);
...
{
    OSSL_NAMEMAP *nm = ossl_namemap_stored(
# 67 "../test/namemap_internal_test.c" 3 4
                                          ((void *)0)
# 67 "../test/namemap_internal_test.c"
                                              );

    return test_ptr("../test/namemap_internal_test.c", 69, "nm", nm)
        && test_namemap(nm);
}
...
static int test_digestbyname(void)
{
    int id;
    OSSL_NAMEMAP *nm = ossl_namemap_stored(
# 80 "../test/namemap_internal_test.c" 3 4
                                          ((void *)0)
# 80 "../test/namemap_internal_test.c"
                                              );
    const EVP_MD *sha256, *foo;

    if (!test_ptr("../test/namemap_internal_test.c", 83, "nm", nm))
        return 0;
    id = ossl_namemap_add_name(nm, 0, "SHA256");
    if (!test_int_ne("../test/namemap_internal_test.c", 86, "id", "0", id, 0))
        return 0;
    if (!test_int_eq("../test/namemap_internal_test.c", 88, "ossl_namemap_add_name(nm, id, \"foo\")", "id", ossl_namemap_add_name(nm, id, "foo"), id))
        return 0;

    sha256 = EVP_get_digestbyname("SHA256");
    if (!test_ptr("../test/namemap_internal_test.c", 92, "sha256", sha256))
        return 0;
    foo = EVP_get_digestbyname("foo");
    if (!test_ptr_eq("../test/namemap_internal_test.c", 95, "sha256", "foo", sha256, foo))
        return 0;
...
static int test_cipherbyname(void)
{
    int id;
    OSSL_NAMEMAP *nm = ossl_namemap_stored(
# 108 "../test/namemap_internal_test.c" 3 4
                                          ((void *)0)
# 108 "../test/namemap_internal_test.c"
                                              );
    const EVP_CIPHER *aes128, *bar;

    if (!test_ptr("../test/namemap_internal_test.c", 111, "nm", nm))
        return 0;
    id = ossl_namemap_add_name(nm, 0, "AES-128-CBC");
    if (!test_int_ne("../test/namemap_internal_test.c", 114, "id", "0", id, 0))
        return 0;
    if (!test_int_eq("../test/namemap_internal_test.c", 116, "ossl_namemap_add_name(nm, id, \"bar\")", "id", ossl_namemap_add_name(nm, id, "bar"), id))
        return 0;

    aes128 = EVP_get_cipherbyname("AES-128-CBC");
    if (!test_ptr("../test/namemap_internal_test.c", 120, "aes128", aes128))
        return 0;
    bar = EVP_get_cipherbyname("bar");
    if (!test_ptr_eq("../test/namemap_internal_test.c", 123, "aes128", "bar", aes128, bar))
        return 0;
...
{
    EVP_CIPHER *fetched = EVP_CIPHER_fetch(
# 135 "../test/namemap_internal_test.c" 3 4
                                          ((void *)0)
# 135 "../test/namemap_internal_test.c"
                                              , "AES-256-CCM", 
# 135 "../test/namemap_internal_test.c" 3 4
                                                               ((void *)0)
# 135 "../test/namemap_internal_test.c"
    ...
    if (!test_ptr("../test/namemap_internal_test.c", 138, "fetched", fetched))
        return 0;
    if (!test_true("../test/namemap_internal_test.c", 140, "EVP_CIPHER_is_a(fetched, \"id-aes256-CCM\")", (EVP_CIPHER_is_a(fetched, "id-aes256-CCM")) != 0)
        || !test_false("../test/namemap_internal_test.c", 141, "EVP_CIPHER_is_a(fetched, \"AES-128-GCM\")", (EVP_CIPHER_is_a(fetched, "AES-128-GCM")) != 0))
        rv = 0;
    if (!test_true("../test/namemap_internal_test.c", 143, "EVP_CIPHER_is_a(EVP_aes_256_gcm(), \"AES-256-GCM\")", (EVP_CIPHER_is_a(EVP_aes_256_gcm(), "AES-256-GCM")) != 0)
        || !test_false("../test/namemap_internal_test.c", 144, "EVP_CIPHER_is_a(EVP_aes_256_gcm(), \"AES-128-CCM\")", (EVP_CIPHER_is_a(EVP_aes_256_gcm(), "AES-128-CCM")) != 0))
        rv = 0;
...
# 157 "../test/namemap_internal_test.c" 3 4
                                  ((void *)0)
# 157 "../test/namemap_internal_test.c"
                                      , "SHA2-512", 
# 157 "../test/namemap_internal_test.c" 3 4
                                                    ((void *)0)
# 157 "../test/namemap_internal_test.c"
    ...
    if (!test_ptr("../test/namemap_internal_test.c", 160, "fetched", fetched))
        return 0;
    if (!test_true("../test/namemap_internal_test.c", 162, "EVP_MD_is_a(fetched, \"SHA512\")", (EVP_MD_is_a(fetched, "SHA512")) != 0)
        || !test_false("../test/namemap_internal_test.c", 163, "EVP_MD_is_a(fetched, \"SHA1\")", (EVP_MD_is_a(fetched, "SHA1")) != 0))
        rv = 0;
    if (!test_true("../test/namemap_internal_test.c", 165, "EVP_MD_is_a(EVP_sha256(), \"SHA2-256\")", (EVP_MD_is_a(EVP_sha256(), "SHA2-256")) != 0)
        || !test_false("../test/namemap_internal_test.c", 166, "EVP_MD_is_a(EVP_sha256(), \"SHA3-256\")", (EVP_MD_is_a(EVP_sha256(), "SHA3-256")) != 0))
        rv = 0;
...
int setup_tests(void)
{
    ...
    add_test("test_cipher_is_a", test_cipher_is_a);
    return 1;
}
