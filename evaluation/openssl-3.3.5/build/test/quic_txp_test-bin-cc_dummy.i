...
static OSSL_CC_DATA *dummy_new(OSSL_TIME (*now_cb)(void *arg),
                               void *now_cb_arg)
{
    OSSL_CC_DUMMY *d = CRYPTO_zalloc(sizeof(*d), "../test/cc_dummy.c", 23);

    if (d == 
# 25 "../test/cc_dummy.c" 3 4
            ((void *)0)
# 25 "../test/cc_dummy.c"
                )
        return 
# 26 "../test/cc_dummy.c" 3 4
              ((void *)0)
# 26 "../test/cc_dummy.c"
                  ;

    d->max_dgram_len = 1200;
    return (OSSL_CC_DATA *)d;
}

static void dummy_free(OSSL_CC_DATA *cc)
{
    CRYPTO_free(cc, "../test/cc_dummy.c", 34);
}
...
static int dummy_unbind_diagnostic(OSSL_CC_DATA *cc, OSSL_PARAM *params)
{
    ...
    if (OSSL_PARAM_locate_const(params, "max_dgram_payload_len")
        != 
# 85 "../test/cc_dummy.c" 3 4
          ((void *)0)
# 85 "../test/cc_dummy.c"
              )
        d->p_diag_max_dgram_len = 
# 86 "../test/cc_dummy.c" 3 4
                                 ((void *)0)
# 86 "../test/cc_dummy.c"
                                     ;
...
static void dummy_update_diag(OSSL_CC_DUMMY *d)
{
    if (d->p_diag_max_dgram_len != 
# 93 "../test/cc_dummy.c" 3 4
                                  ((void *)0)
# 93 "../test/cc_dummy.c"
                                      )
