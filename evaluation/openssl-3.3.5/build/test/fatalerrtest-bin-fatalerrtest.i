# 0 "../test/fatalerrtest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/fatalerrtest.c"
# 10 "../test/fatalerrtest.c"
...
# 14 "../test/fatalerrtest.c" 2


static char *cert = 
# 16 "../test/fatalerrtest.c" 3 4
                   ((void *)0)
# 16 "../test/fatalerrtest.c"
                       ;
static char *privkey = 
# 17 "../test/fatalerrtest.c" 3 4
                      ((void *)0)
# 17 "../test/fatalerrtest.c"
                          ;

static int test_fatalerr(void)
{
    SSL_CTX *sctx = 
# 21 "../test/fatalerrtest.c" 3 4
                   ((void *)0)
# 21 "../test/fatalerrtest.c"
                       , *cctx = 
# 21 "../test/fatalerrtest.c" 3 4
                                 ((void *)0)
# 21 "../test/fatalerrtest.c"
                                     ;
    SSL *sssl = 
# 22 "../test/fatalerrtest.c" 3 4
               ((void *)0)
# 22 "../test/fatalerrtest.c"
                   , *cssl = 
# 22 "../test/fatalerrtest.c" 3 4
                             ((void *)0)
# 22 "../test/fatalerrtest.c"
    ...
    BIO *wbio = 
# 24 "../test/fatalerrtest.c" 3 4
               ((void *)0)
# 24 "../test/fatalerrtest.c"
                   ;
    int ret = 0, len;
    char buf[80];
    ...
    if (!test_true("../test/fatalerrtest.c", 31, "create_ssl_ctx_pair(NULL, TLS_method(), TLS_method(), TLS1_VERSION, 0, &sctx, &cctx, cert, privkey)", (create_ssl_ctx_pair(
# 31 "../test/fatalerrtest.c" 3 4
        ((void *)0)
# 31 "../test/fatalerrtest.c"
        , TLS_method(), TLS_method(), 0x0301, 0, &sctx, &cctx, cert, privkey)) != 0)
    ...
    if (!test_true("../test/fatalerrtest.c", 40, "SSL_CTX_set_cipher_list(sctx, \"AES128-SHA\")", (SSL_CTX_set_cipher_list(sctx, "AES128-SHA")) != 0)
            || !test_true("../test/fatalerrtest.c", 41, "SSL_CTX_set_cipher_list(cctx, \"AES256-SHA\")", (SSL_CTX_set_cipher_list(cctx, "AES256-SHA")) != 0)
            || !test_true("../test/fatalerrtest.c", 42, "SSL_CTX_set_ciphersuites(sctx, \"TLS_AES_128_GCM_SHA256\")", (SSL_CTX_set_ciphersuites(sctx, "TLS_AES_128_GCM_SHA256")) != 0)

            || !test_true("../test/fatalerrtest.c", 44, "SSL_CTX_set_ciphersuites(cctx, \"TLS_AES_256_GCM_SHA384\")", (SSL_CTX_set_ciphersuites(cctx, "TLS_AES_256_GCM_SHA384")) != 0)

            || !test_true("../test/fatalerrtest.c", 46, "create_ssl_objects(sctx, cctx, &sssl, &cssl, NULL, NULL)", (create_ssl_objects(sctx, cctx, &sssl, &cssl, 
# 46 "../test/fatalerrtest.c" 3 4
               ((void *)0)
# 46 "../test/fatalerrtest.c"
               , 
# 46 "../test/fatalerrtest.c" 3 4
               ((void *)0)
# 46 "../test/fatalerrtest.c"
    ...
    if (!test_ptr("../test/fatalerrtest.c", 51, "wbio", wbio)) {
        printf("Unexpected NULL bio received\n");
        goto err;
    }


    if (!test_false("../test/fatalerrtest.c", 57, "create_ssl_connection(sssl, cssl, SSL_ERROR_NONE)", (create_ssl_connection(sssl, cssl, 0)) != 0))
        goto err;

    ERR_clear_error();


    if (!test_int_gt("../test/fatalerrtest.c", 63, "BIO_write(wbio, dummyrec, sizeof(dummyrec))", "0", BIO_write(wbio, dummyrec, sizeof(dummyrec)), 0))
        goto err;


    if (!test_int_le("../test/fatalerrtest.c", 67, "len = SSL_read(sssl, buf, sizeof(buf) - 1)", "0", len = SSL_read(sssl, buf, sizeof(buf) - 1), 0)) {
        buf[len] = '\0';
        test_error("../test/fatalerrtest.c", 69, "Unexpected success reading data: %s\n", buf);
        goto err;
    }
    if (!test_int_le("../test/fatalerrtest.c", 72, "SSL_write(sssl, msg, strlen(msg))", "0", SSL_write(sssl, msg, strlen(msg)), 0))
        goto err;
...
# 85 "../test/fatalerrtest.c" 3 4
((void *)0) 
# 85 "../test/fatalerrtest.c"
} }; return options; }

int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/fatalerrtest.c", 90, "Error parsing test options\n");
        return 0;
    }

    if (!test_ptr("../test/fatalerrtest.c", 94, "cert = test_get_argument(0)", cert = test_get_argument(0))
            || !test_ptr("../test/fatalerrtest.c", 95, "privkey = test_get_argument(1)", privkey = test_get_argument(1)))
        return 0;

    add_test("test_fatalerr", test_fatalerr);
