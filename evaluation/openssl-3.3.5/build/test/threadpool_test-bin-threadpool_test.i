...
# 30 "../test/threadpool_test.c"
    if (!test_int_eq("../test/threadpool_test.c", 30, "flags & OSSL_THREAD_SUPPORT_FLAG_THREAD_POOL", "OSSL_THREAD_SUPPORT_FLAG_THREAD_POOL", flags & (1U<<0), (1U<<0))
                                                          )
        return 0;
    ...
    if (!test_int_eq("../test/threadpool_test.c", 39, "flags & OSSL_THREAD_SUPPORT_FLAG_DEFAULT_SPAWN", "OSSL_THREAD_SUPPORT_FLAG_DEFAULT_SPAWN", flags & (1U<<1), (1U<<1))
                                                            )
        return 0;
...
static int test_thread_native(void)
{
    ...
    if (!test_ptr("../test/threadpool_test.c", 68, "t", t))
        return 0;
    ...
    if (!test_int_eq("../test/threadpool_test.c", 77, "ossl_crypto_thread_native_join(t, &retval)", "1", ossl_crypto_thread_native_join(t, &retval), 1))
        return 0;
    if (!test_int_eq("../test/threadpool_test.c", 79, "ossl_crypto_thread_native_join(t, &retval)", "1", ossl_crypto_thread_native_join(t, &retval), 1))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 82, "retval", "1", retval, 1) || !test_int_eq("../test/threadpool_test.c", 82, "local", "2", local, 2))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 85, "ossl_crypto_thread_native_clean(t)", "1", ossl_crypto_thread_native_clean(t), 1))
        return 0;
    t = 
# 87 "../test/threadpool_test.c" 3 4
       ((void *)0)
# 87 "../test/threadpool_test.c"
           ;

    if (!test_int_eq("../test/threadpool_test.c", 89, "ossl_crypto_thread_native_clean(t)", "0", ossl_crypto_thread_native_clean(t), 0))
        return 0;
...
static int test_thread_internal(void)
{
    ...
    if (threads_supported == 0) {
        if (!test_uint64_t_eq("../test/threadpool_test.c", 110, "OSSL_get_max_threads(NULL)", "0", OSSL_get_max_threads(
# 110 "../test/threadpool_test.c" 3 4
            ((void *)0)
# 110 "../test/threadpool_test.c"
            ), 0))
            goto cleanup;
        if (!test_uint64_t_eq("../test/threadpool_test.c", 112, "OSSL_get_max_threads(cust_ctx)", "0", OSSL_get_max_threads(cust_ctx), 0))
            goto cleanup;

        if (!test_int_eq("../test/threadpool_test.c", 115, "OSSL_set_max_threads(NULL, 1)", "0", OSSL_set_max_threads(
# 115 "../test/threadpool_test.c" 3 4
            ((void *)0)
# 115 "../test/threadpool_test.c"
            , 1), 0))
            goto cleanup;
        if (!test_int_eq("../test/threadpool_test.c", 117, "OSSL_set_max_threads(cust_ctx, 1)", "0", OSSL_set_max_threads(cust_ctx, 1), 0))
            goto cleanup;

        if (!test_uint64_t_eq("../test/threadpool_test.c", 120, "OSSL_get_max_threads(NULL)", "0", OSSL_get_max_threads(
# 120 "../test/threadpool_test.c" 3 4
            ((void *)0)
# 120 "../test/threadpool_test.c"
            ), 0))
            goto cleanup;
        if (!test_uint64_t_eq("../test/threadpool_test.c", 122, "OSSL_get_max_threads(cust_ctx)", "0", OSSL_get_max_threads(cust_ctx), 0))
            goto cleanup;

        t[0] = ossl_crypto_thread_start(
# 125 "../test/threadpool_test.c" 3 4
                                       ((void *)0)
# 125 "../test/threadpool_test.c"
                                           , test_thread_native_fn, &local[0]);
        if (!test_ptr_null("../test/threadpool_test.c", 126, "t[0]", t[0]))
            goto cleanup;
    ...
    if (!test_uint64_t_eq("../test/threadpool_test.c", 135, "OSSL_get_max_threads(NULL)", "0", OSSL_get_max_threads(
# 135 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 135 "../test/threadpool_test.c"
        ), 0))
        goto cleanup;
    t[0] = ossl_crypto_thread_start(
# 137 "../test/threadpool_test.c" 3 4
                                   ((void *)0)
# 137 "../test/threadpool_test.c"
                                       , test_thread_native_fn, &local[0]);
    if (!test_ptr_null("../test/threadpool_test.c", 138, "t[0]", t[0]))
        goto cleanup;


    if (!test_uint64_t_eq("../test/threadpool_test.c", 142, "OSSL_get_max_threads(cust_ctx)", "0", OSSL_get_max_threads(cust_ctx), 0))
        goto cleanup;
    if (!test_int_eq("../test/threadpool_test.c", 144, "OSSL_set_max_threads(cust_ctx, 1)", "1", OSSL_set_max_threads(cust_ctx, 1), 1))
        goto cleanup;
    if (!test_uint64_t_eq("../test/threadpool_test.c", 146, "OSSL_get_max_threads(NULL)", "0", OSSL_get_max_threads(
# 146 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 146 "../test/threadpool_test.c"
        ), 0))
        goto cleanup;
    if (!test_uint64_t_eq("../test/threadpool_test.c", 148, "OSSL_get_max_threads(cust_ctx)", "1", OSSL_get_max_threads(cust_ctx), 1))
        goto cleanup;
    t[0] = ossl_crypto_thread_start(
# 150 "../test/threadpool_test.c" 3 4
                                   ((void *)0)
# 150 "../test/threadpool_test.c"
                                       , test_thread_native_fn, &local[0]);
    if (!test_ptr_null("../test/threadpool_test.c", 151, "t[0]", t[0]))
        goto cleanup;
    if (!test_int_eq("../test/threadpool_test.c", 153, "OSSL_set_max_threads(cust_ctx, 0)", "1", OSSL_set_max_threads(cust_ctx, 0), 1))
        goto cleanup;



    if (!test_int_eq("../test/threadpool_test.c", 158, "OSSL_set_max_threads(NULL, 1)", "1", OSSL_set_max_threads(
# 158 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 158 "../test/threadpool_test.c"
        , 1), 1))
        goto cleanup;
    if (!test_uint64_t_eq("../test/threadpool_test.c", 160, "OSSL_get_max_threads(NULL)", "1", OSSL_get_max_threads(
# 160 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 160 "../test/threadpool_test.c"
        ), 1))
        goto cleanup;
    if (!test_uint64_t_eq("../test/threadpool_test.c", 162, "OSSL_get_max_threads(cust_ctx)", "0", OSSL_get_max_threads(cust_ctx), 0))
        goto cleanup;

    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        local[0] = i + 1;

        t[i] = ossl_crypto_thread_start(
# 168 "../test/threadpool_test.c" 3 4
                                       ((void *)0)
# 168 "../test/threadpool_test.c"
                                           , test_thread_native_fn, &local[0]);
        if (!test_ptr("../test/threadpool_test.c", 169, "t[i]", t[i]))
            goto cleanup;
        ...
        if (!test_int_eq("../test/threadpool_test.c", 178, "ossl_crypto_thread_join(t[i], &retval[0])", "1", ossl_crypto_thread_join(t[i], &retval[0]), 1))
            goto cleanup;
        if (!test_int_eq("../test/threadpool_test.c", 180, "ossl_crypto_thread_join(t[i], &retval[0])", "1", ossl_crypto_thread_join(t[i], &retval[0]), 1))
            goto cleanup;

        if (!test_int_eq("../test/threadpool_test.c", 183, "retval[0]", "i + 1", retval[0], i + 1) || !test_int_eq("../test/threadpool_test.c", 183, "local[0]", "i + 2", local[0], i + 2))
            goto cleanup;

        if (!test_int_eq("../test/threadpool_test.c", 186, "ossl_crypto_thread_clean(t[i])", "1", ossl_crypto_thread_clean(t[i]), 1))
            goto cleanup;
        t[i] = 
# 188 "../test/threadpool_test.c" 3 4
              ((void *)0)
# 188 "../test/threadpool_test.c"
                  ;

        if (!test_int_eq("../test/threadpool_test.c", 190, "ossl_crypto_thread_clean(t[i])", "0", ossl_crypto_thread_clean(t[i]), 0))
            goto cleanup;
    }



    if (!test_int_eq("../test/threadpool_test.c", 196, "OSSL_set_max_threads(NULL, OSSL_NELEM(t))", "1", OSSL_set_max_threads(
# 196 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 196 "../test/threadpool_test.c"
    ...
    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        local[i] = i + 1;
        t[i] = ossl_crypto_thread_start(
# 201 "../test/threadpool_test.c" 3 4
                                       ((void *)0)
# 201 "../test/threadpool_test.c"
                                           , test_thread_native_fn, &local[i]);
        if (!test_ptr("../test/threadpool_test.c", 202, "t[i]", t[i]))
            goto cleanup;
    }
    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        if (!test_int_eq("../test/threadpool_test.c", 206, "ossl_crypto_thread_join(t[i], &retval[i])", "1", ossl_crypto_thread_join(t[i], &retval[i]), 1))
            goto cleanup;
    }
    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        if (!test_int_eq("../test/threadpool_test.c", 210, "retval[i]", "i + 1", retval[i], i + 1) || !test_int_eq("../test/threadpool_test.c", 210, "local[i]", "i + 2", local[i], i + 2))
            goto cleanup;
        if (!test_int_eq("../test/threadpool_test.c", 212, "ossl_crypto_thread_clean(t[i])", "1", ossl_crypto_thread_clean(t[i]), 1))
            goto cleanup;
    }



    if (!test_int_eq("../test/threadpool_test.c", 218, "OSSL_set_max_threads(NULL, OSSL_NELEM(t) - 1)", "1", OSSL_set_max_threads(
# 218 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 218 "../test/threadpool_test.c"
        , (sizeof(t)/sizeof((t)[0])) - 1), 1))
        goto cleanup;

    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        local[i] = i + 1;
        t[i] = ossl_crypto_thread_start(
# 223 "../test/threadpool_test.c" 3 4
                                       ((void *)0)
# 223 "../test/threadpool_test.c"
                                           , test_thread_native_fn, &local[i]);
        if (!test_ptr("../test/threadpool_test.c", 224, "t[i]", t[i]))
            goto cleanup;
    }
    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        if (!test_int_eq("../test/threadpool_test.c", 228, "ossl_crypto_thread_join(t[i], &retval[i])", "1", ossl_crypto_thread_join(t[i], &retval[i]), 1))
            goto cleanup;
    }
    for (i = 0; i < (sizeof(t)/sizeof((t)[0])); ++i) {
        if (!test_int_eq("../test/threadpool_test.c", 232, "retval[i]", "i + 1", retval[i], i + 1) || !test_int_eq("../test/threadpool_test.c", 232, "local[i]", "i + 2", local[i], i + 2))
            goto cleanup;
        if (!test_int_eq("../test/threadpool_test.c", 234, "ossl_crypto_thread_clean(t[i])", "1", ossl_crypto_thread_clean(t[i]), 1))
            goto cleanup;
    }

    if (!test_int_eq("../test/threadpool_test.c", 238, "OSSL_set_max_threads(NULL, 0)", "1", OSSL_set_max_threads(
# 238 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 238 "../test/threadpool_test.c"
        , 0), 1))
        goto cleanup;
...
{
    ossl_crypto_thread_native_join((CRYPTO_THREAD *)data, 
# 255 "../test/threadpool_test.c" 3 4
                                                         ((void *)0)
# 255 "../test/threadpool_test.c"
                                                             );
    return 0;
}
...
{
    ossl_crypto_thread_native_join((CRYPTO_THREAD *)data, 
# 261 "../test/threadpool_test.c" 3 4
                                                         ((void *)0)
# 261 "../test/threadpool_test.c"
                                                             );
    return 0;
}
...
# 269 "../test/threadpool_test.c" 3 4
                                                                              ((void *)0)
# 269 "../test/threadpool_test.c"
                                                                                  , 1);
    ...
    if (!test_ptr("../test/threadpool_test.c", 273, "t", t) || !test_ptr("../test/threadpool_test.c", 273, "t1", t1) || !test_ptr("../test/threadpool_test.c", 273, "t2", t2))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 276, "ossl_crypto_thread_native_join(t2, NULL)", "1", ossl_crypto_thread_native_join(t2, 
# 276 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 276 "../test/threadpool_test.c"
        ), 1))
        return 0;
    if (!test_int_eq("../test/threadpool_test.c", 278, "ossl_crypto_thread_native_join(t1, NULL)", "1", ossl_crypto_thread_native_join(t1, 
# 278 "../test/threadpool_test.c" 3 4
        ((void *)0)
# 278 "../test/threadpool_test.c"
        ), 1))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 281, "ossl_crypto_thread_native_clean(t2)", "1", ossl_crypto_thread_native_clean(t2), 1))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 284, "ossl_crypto_thread_native_clean(t1)", "1", ossl_crypto_thread_native_clean(t1), 1))
        return 0;

    if (!test_int_eq("../test/threadpool_test.c", 287, "ossl_crypto_thread_native_clean(t)", "1", ossl_crypto_thread_native_clean(t), 1))
        return 0;
