# 0 "../test/quic_lcidm_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_lcidm_test.c"
# 10 "../test/quic_lcidm_test.c"
...
# 15 "../include/internal/quic_lcidm.h" 2
...
# 16 "../include/internal/quic_lcidm.h" 2
...
# 17 "../include/internal/quic_lcidm.h" 2
...
# 18 "../include/internal/quic_lcidm.h" 2
...
# 19 "../include/internal/quic_lcidm.h" 2
...
static int test_lcidm(void)
{
    ...
    void *opaque = 
# 28 "../test/quic_lcidm_test.c" 3 4
                  ((void *)0)
# 28 "../test/quic_lcidm_test.c"
                      ;
    uint64_t seq_num = 
# 29 "../test/quic_lcidm_test.c" 3 4
                      (18446744073709551615UL)
# 29 "../test/quic_lcidm_test.c"
                                ;
    int did_retire = 0;

    if (!test_ptr("../test/quic_lcidm_test.c", 32, "lcidm = ossl_quic_lcidm_new(NULL, lcid_len)", lcidm = ossl_quic_lcidm_new(
# 32 "../test/quic_lcidm_test.c" 3 4
        ((void *)0)
# 32 "../test/quic_lcidm_test.c"
        , lcid_len)))
        goto err;

    if (!test_size_t_eq("../test/quic_lcidm_test.c", 35, "ossl_quic_lcidm_get_lcid_len(lcidm)", "lcid_len", ossl_quic_lcidm_get_lcid_len(lcidm), lcid_len))
        goto err;

    if (!test_true("../test/quic_lcidm_test.c", 38, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_1)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_1)) != 0)
        || !test_false("../test/quic_lcidm_test.c", 39, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_2)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_2)) != 0)
        || !test_false("../test/quic_lcidm_test.c", 40, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_1)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_1)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 41, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 1)", "0", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 1), 0)
        || !test_true("../test/quic_lcidm_test.c", 42, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_3)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_3)) != 0)
        || !test_false("../test/quic_lcidm_test.c", 43, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_4)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 1, &cid8_4)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 44, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0)", "1", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0), 1)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 45, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 1)", "1", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 1), 1)
        || !test_true("../test/quic_lcidm_test.c", 46, "ossl_quic_lcidm_retire_odcid(lcidm, ptrs + 0)", (ossl_quic_lcidm_retire_odcid(lcidm, ptrs + 0)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 47, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0)", "0", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0), 0)
        || !test_false("../test/quic_lcidm_test.c", 48, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_1)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_1)) != 0)
        || !test_false("../test/quic_lcidm_test.c", 49, "ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_5)", (ossl_quic_lcidm_enrol_odcid(lcidm, ptrs + 0, &cid8_5)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 50, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0)", "0", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 0), 0)

        || !test_true("../test/quic_lcidm_test.c", 52, "ossl_quic_lcidm_generate_initial(lcidm, ptrs + 2, &lcid_1)", (ossl_quic_lcidm_generate_initial(lcidm, ptrs + 2, &lcid_1)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 53, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "1", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 1)
        || !test_false("../test/quic_lcidm_test.c", 54, "ossl_quic_lcidm_generate_initial(lcidm, ptrs + 2, &lcid_init)", (ossl_quic_lcidm_generate_initial(lcidm, ptrs + 2, &lcid_init)) != 0)
        || !test_true("../test/quic_lcidm_test.c", 55, "ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_1)", (ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_1)) != 0)
        || !test_true("../test/quic_lcidm_test.c", 56, "ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_2)", (ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_2)) != 0)
        || !test_true("../test/quic_lcidm_test.c", 57, "ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_3)", (ossl_quic_lcidm_generate(lcidm, ptrs + 2, &ncid_frame_3)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 58, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "4", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 4)
        || !test_true("../test/quic_lcidm_test.c", 59, "ossl_quic_lcidm_lookup(lcidm, &lcid_1, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &lcid_1, &seq_num, &opaque)) != 0)
        || !test_ptr_eq("../test/quic_lcidm_test.c", 60, "opaque", "ptrs + 2", opaque, ptrs + 2)
        || !test_uint64_t_eq("../test/quic_lcidm_test.c", 61, "seq_num", "0", seq_num, 0)
        || !test_true("../test/quic_lcidm_test.c", 62, "ossl_quic_lcidm_lookup(lcidm, &ncid_frame_1.conn_id, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &ncid_frame_1.conn_id, &seq_num, &opaque)) != 0)

        || !test_ptr_eq("../test/quic_lcidm_test.c", 64, "opaque", "ptrs + 2", opaque, ptrs + 2)
        || !test_uint64_t_eq("../test/quic_lcidm_test.c", 65, "seq_num", "1", seq_num, 1)
        || !test_true("../test/quic_lcidm_test.c", 66, "ossl_quic_lcidm_lookup(lcidm, &ncid_frame_2.conn_id, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &ncid_frame_2.conn_id, &seq_num, &opaque)) != 0)

        || !test_ptr_eq("../test/quic_lcidm_test.c", 68, "opaque", "ptrs + 2", opaque, ptrs + 2)
        || !test_uint64_t_eq("../test/quic_lcidm_test.c", 69, "seq_num", "2", seq_num, 2)
        || !test_true("../test/quic_lcidm_test.c", 70, "ossl_quic_lcidm_lookup(lcidm, &ncid_frame_3.conn_id, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &ncid_frame_3.conn_id, &seq_num, &opaque)) != 0)

        || !test_ptr_eq("../test/quic_lcidm_test.c", 72, "opaque", "ptrs + 2", opaque, ptrs + 2)
        || !test_uint64_t_eq("../test/quic_lcidm_test.c", 73, "seq_num", "3", seq_num, 3)
        || !test_true("../test/quic_lcidm_test.c", 74, "ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, NULL, &lcid_dummy, &seq_num, &did_retire)", (ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, 
# 74 "../test/quic_lcidm_test.c" 3 4
           ((void *)0)
# 74 "../test/quic_lcidm_test.c"
           , &lcid_dummy, &seq_num, &did_retire)) != 0)

        || !test_true("../test/quic_lcidm_test.c", 76, "did_retire", (did_retire) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 77, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "3", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 3)
        || !test_true("../test/quic_lcidm_test.c", 78, "ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, NULL, &lcid_dummy, &seq_num, &did_retire)", (ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, 
# 78 "../test/quic_lcidm_test.c" 3 4
           ((void *)0)
# 78 "../test/quic_lcidm_test.c"
           , &lcid_dummy, &seq_num, &did_retire)) != 0)

        || !test_true("../test/quic_lcidm_test.c", 80, "did_retire", (did_retire) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 81, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "2", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 2)
        || !test_true("../test/quic_lcidm_test.c", 82, "ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, NULL, &lcid_dummy, &seq_num, &did_retire)", (ossl_quic_lcidm_retire(lcidm, ptrs + 2, 2, 
# 82 "../test/quic_lcidm_test.c" 3 4
           ((void *)0)
# 82 "../test/quic_lcidm_test.c"
           , &lcid_dummy, &seq_num, &did_retire)) != 0)

        || !test_false("../test/quic_lcidm_test.c", 84, "did_retire", (did_retire) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 85, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "2", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 2)
        || !test_false("../test/quic_lcidm_test.c", 86, "ossl_quic_lcidm_lookup(lcidm, &lcid_init, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &lcid_init, &seq_num, &opaque)) != 0)

        || !test_false("../test/quic_lcidm_test.c", 88, "ossl_quic_lcidm_lookup(lcidm, &ncid_frame_1.conn_id, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &ncid_frame_1.conn_id, &seq_num, &opaque)) != 0)

        || !test_true("../test/quic_lcidm_test.c", 90, "ossl_quic_lcidm_lookup(lcidm, &ncid_frame_2.conn_id, &seq_num, &opaque)", (ossl_quic_lcidm_lookup(lcidm, &ncid_frame_2.conn_id, &seq_num, &opaque)) != 0)

        || !test_true("../test/quic_lcidm_test.c", 92, "ossl_quic_lcidm_cull(lcidm, ptrs + 2)", (ossl_quic_lcidm_cull(lcidm, ptrs + 2)) != 0)
        || !test_size_t_eq("../test/quic_lcidm_test.c", 93, "ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2)", "0", ossl_quic_lcidm_get_num_active_lcid(lcidm, ptrs + 2), 0))
        goto err;
...
int setup_tests(void)
{
    add_test("test_lcidm", test_lcidm);
    return 1;
}
