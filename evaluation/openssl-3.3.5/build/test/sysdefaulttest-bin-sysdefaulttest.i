# 0 "../test/sysdefaulttest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/sysdefaulttest.c"
# 10 "../test/sysdefaulttest.c"
...
# 18 "../test/sysdefaulttest.c" 2

static SSL_CTX *ctx;

static int test_func(void)
{
    if (!test_int_eq("../test/sysdefaulttest.c", 23, "SSL_CTX_get_min_proto_version(ctx)", "TLS1_2_VERSION", SSL_CTX_ctrl(ctx, 130, 0, 
# 23 "../test/sysdefaulttest.c" 3 4
        ((void *)0)
# 23 "../test/sysdefaulttest.c"
        ), 0x0303)
        && !test_int_eq("../test/sysdefaulttest.c", 24, "SSL_CTX_get_max_proto_version(ctx)", "TLS1_2_VERSION", SSL_CTX_ctrl(ctx, 131, 0, 
# 24 "../test/sysdefaulttest.c" 3 4
           ((void *)0)
# 24 "../test/sysdefaulttest.c"
           ), 0x0303)) {
        test_info("../test/sysdefaulttest.c", 25, "min/max version setting incorrect");
        return 0;
    }
    return 1;
}
...
int global_init(void)
{
    if (!OPENSSL_init_ssl((0x00000200L | 0x00000400L | 0x00001000L | 0x00002000L | 0x00004000L)
                          | 0x00000040L, 
# 34 "../test/sysdefaulttest.c" 3 4
                                                     ((void *)0)
# 34 "../test/sysdefaulttest.c"
                                                         ))
        return 0;
    return 1;
}
...
int setup_tests(void)
{
    if (!test_ptr("../test/sysdefaulttest.c", 41, "ctx = SSL_CTX_new(TLS_method())", ctx = SSL_CTX_new(TLS_method())))
        return 0;
