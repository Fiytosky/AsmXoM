...
# 19 "../test/hmactest.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 21 "../test/hmactest.c" 2
...
extern unsigned char *MD5(const unsigned char *d, size_t n,
                                         unsigned char *md);
extern void MD5_Transform(MD5_CTX *c, const unsigned char *b);
# 26 "../test/hmactest.c" 2
...
static int test_hmac_md5(int idx)
{
    ...
    p = pt(HMAC(EVP_md5(),
                ...
                test[idx].data, test[idx].data_len, 
# 100 "../test/hmactest.c" 3 4
                                                   ((void *)0)
# 100 "../test/hmactest.c"
                                                       , 
# 100 "../test/hmactest.c" 3 4
...
# 100 "../test/hmactest.c"
    ...
    return test_ptr("../test/hmactest.c", 103, "p", p) && test_str_eq("../test/hmactest.c", 103, "p", "test[idx].digest", p, test[idx].digest);
}
...
# 109 "../test/hmactest.c"
    ...
    ctx = HMAC_CTX_new();
    if (!test_ptr("../test/hmactest.c", 113, "ctx", ctx)
        || !test_ptr_null("../test/hmactest.c", 114, "HMAC_CTX_get_md(ctx)", HMAC_CTX_get_md(ctx))
        || !test_false("../test/hmactest.c", 115, "HMAC_Init_ex(ctx, NULL, 0, NULL, NULL)", (HMAC_Init_ex(ctx, 
# 115 "../test/hmactest.c" 3 4
           ((void *)0)
# 115 "../test/hmactest.c"
           , 0, 
# 115 "../test/hmactest.c" 3 4
...
# 115 "../test/hmactest.c"
        ...
        || !test_false("../test/hmactest.c", 116, "HMAC_Update(ctx, test[4].data, test[4].data_len)", (HMAC_Update(ctx, test[4].data, test[4].data_len)) != 0)
        || !test_false("../test/hmactest.c", 117, "HMAC_Init_ex(ctx, NULL, 0, EVP_sha1(), NULL)", (HMAC_Init_ex(ctx, 
# 117 "../test/hmactest.c" 3 4
           ((void *)0)
# 117 "../test/hmactest.c"
           , 0, EVP_sha1(), 
# 117 "../test/hmactest.c" 3 4
...
# 117 "../test/hmactest.c"
        ...
        || !test_false("../test/hmactest.c", 118, "HMAC_Update(ctx, test[4].data, test[4].data_len)", (HMAC_Update(ctx, test[4].data, test[4].data_len)) != 0))
        goto err;
...
# 130 "../test/hmactest.c"
    ...
    if (!test_ptr("../test/hmactest.c", 135, "ctx = HMAC_CTX_new()", ctx = HMAC_CTX_new()))
        return 0;
    HMAC_CTX_reset(ctx);

    if (!test_ptr("../test/hmactest.c", 139, "ctx", ctx)
        || !test_ptr_null("../test/hmactest.c", 140, "HMAC_CTX_get_md(ctx)", HMAC_CTX_get_md(ctx))
        || !test_false("../test/hmactest.c", 141, "HMAC_Init_ex(ctx, NULL, 0, NULL, NULL)", (HMAC_Init_ex(ctx, 
# 141 "../test/hmactest.c" 3 4
           ((void *)0)
# 141 "../test/hmactest.c"
           , 0, 
# 141 "../test/hmactest.c" 3 4
...
# 141 "../test/hmactest.c"
        ...
        || !test_false("../test/hmactest.c", 142, "HMAC_Update(ctx, test[4].data, test[4].data_len)", (HMAC_Update(ctx, test[4].data, test[4].data_len)) != 0)
        || !test_false("../test/hmactest.c", 143, "HMAC_Init_ex(ctx, test[4].key, -1, EVP_sha1(), NULL)", (HMAC_Init_ex(ctx, test[4].key, -1, EVP_sha1(), 
# 143 "../test/hmactest.c" 3 4
           ((void *)0)
# 143 "../test/hmactest.c"
           )) != 0))
        goto err;

    if (!test_true("../test/hmactest.c", 146, "HMAC_Init_ex(ctx, test[4].key, test[4].key_len, EVP_sha1(), NULL)", (HMAC_Init_ex(ctx, test[4].key, test[4].key_len, EVP_sha1(), 
# 146 "../test/hmactest.c" 3 4
        ((void *)0)
# 146 "../test/hmactest.c"
        )) != 0)
        || !test_true("../test/hmactest.c", 147, "HMAC_Update(ctx, test[4].data, test[4].data_len)", (HMAC_Update(ctx, test[4].data, test[4].data_len)) != 0)
        || !test_true("../test/hmactest.c", 148, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 152, "p", p) || !test_str_eq("../test/hmactest.c", 152, "p", "test[4].digest", p, test[4].digest))
        goto err;

    if (!test_false("../test/hmactest.c", 155, "HMAC_Init_ex(ctx, NULL, 0, EVP_sha256(), NULL)", (HMAC_Init_ex(ctx, 
# 155 "../test/hmactest.c" 3 4
        ((void *)0)
# 155 "../test/hmactest.c"
        , 0, EVP_sha256(), 
# 155 "../test/hmactest.c" 3 4
...
# 155 "../test/hmactest.c"
    ...
    if (!test_true("../test/hmactest.c", 158, "HMAC_Init_ex(ctx, test[5].key, test[5].key_len, EVP_sha256(), NULL)", (HMAC_Init_ex(ctx, test[5].key, test[5].key_len, EVP_sha256(), 
# 158 "../test/hmactest.c" 3 4
        ((void *)0)
# 158 "../test/hmactest.c"
        )) != 0)
        || !test_ptr_eq("../test/hmactest.c", 159, "HMAC_CTX_get_md(ctx)", "EVP_sha256()", HMAC_CTX_get_md(ctx), EVP_sha256())
        || !test_true("../test/hmactest.c", 160, "HMAC_Update(ctx, test[5].data, test[5].data_len)", (HMAC_Update(ctx, test[5].data, test[5].data_len)) != 0)
        || !test_true("../test/hmactest.c", 161, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 165, "p", p) || !test_str_eq("../test/hmactest.c", 165, "p", "test[5].digest", p, test[5].digest))
        goto err;

    if (!test_true("../test/hmactest.c", 168, "HMAC_Init_ex(ctx, test[6].key, test[6].key_len, NULL, NULL)", (HMAC_Init_ex(ctx, test[6].key, test[6].key_len, 
# 168 "../test/hmactest.c" 3 4
        ((void *)0)
# 168 "../test/hmactest.c"
        , 
# 168 "../test/hmactest.c" 3 4
...
# 168 "../test/hmactest.c"
        ...
        || !test_true("../test/hmactest.c", 169, "HMAC_Update(ctx, test[6].data, test[6].data_len)", (HMAC_Update(ctx, test[6].data, test[6].data_len)) != 0)
        || !test_true("../test/hmactest.c", 170, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 173, "p", p) || !test_str_eq("../test/hmactest.c", 173, "p", "test[6].digest", p, test[6].digest))
        goto err;


    if (!test_true("../test/hmactest.c", 177, "HMAC_Init_ex(ctx, NULL, 0, NULL, NULL)", (HMAC_Init_ex(ctx, 
# 177 "../test/hmactest.c" 3 4
        ((void *)0)
# 177 "../test/hmactest.c"
        , 0, 
# 177 "../test/hmactest.c" 3 4
...
# 177 "../test/hmactest.c"
        ...
        || !test_true("../test/hmactest.c", 178, "HMAC_Update(ctx, test[6].data, test[6].data_len)", (HMAC_Update(ctx, test[6].data, test[6].data_len)) != 0)
        || !test_true("../test/hmactest.c", 179, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 182, "p", p) || !test_str_eq("../test/hmactest.c", 182, "p", "test[6].digest", p, test[6].digest))
        goto err;
    ...
    if (!test_true("../test/hmactest.c", 189, "HMAC_Init_ex(ctx, NULL, 0, EVP_sha256(), NULL)", (HMAC_Init_ex(ctx, 
# 189 "../test/hmactest.c" 3 4
        ((void *)0)
# 189 "../test/hmactest.c"
        , 0, EVP_sha256(), 
# 189 "../test/hmactest.c" 3 4
...
# 189 "../test/hmactest.c"
        ...
        || !test_true("../test/hmactest.c", 190, "HMAC_Update(ctx, test[6].data, test[6].data_len)", (HMAC_Update(ctx, test[6].data, test[6].data_len)) != 0)
        || !test_true("../test/hmactest.c", 191, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;
    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 194, "p", p) || !test_str_eq("../test/hmactest.c", 194, "p", "test[6].digest", p, test[6].digest))
        goto err;
...
static int test_hmac_single_shot(void)
{
    ...
    p = pt(HMAC(EVP_sha1(), 
# 209 "../test/hmactest.c" 3 4
                           ((void *)0)
# 209 "../test/hmactest.c"
                               , 0, test[4].data, test[4].data_len,
                
# 210 "../test/hmactest.c" 3 4
               ((void *)0)
# 210 "../test/hmactest.c"
                   , 
# 210 "../test/hmactest.c" 3 4
...
# 210 "../test/hmactest.c"
    ...
    if (!test_ptr("../test/hmactest.c", 211, "p", p) || !test_str_eq("../test/hmactest.c", 211, "p", "test[4].digest", p, test[4].digest))
        return 0;
...
# 220 "../test/hmactest.c"
    ...
    if (!test_ptr("../test/hmactest.c", 226, "ctx = HMAC_CTX_new()", ctx = HMAC_CTX_new()))
        goto err;
    if (!test_true("../test/hmactest.c", 228, "HMAC_Init_ex(ctx, test[5].key, test[5].key_len, EVP_sha256(), NULL)", (HMAC_Init_ex(ctx, test[5].key, test[5].key_len, EVP_sha256(), 
# 228 "../test/hmactest.c" 3 4
        ((void *)0)
# 228 "../test/hmactest.c"
        )) != 0)
        || !test_true("../test/hmactest.c", 229, "HMAC_Update(ctx, test[5].data, test[5].data_len)", (HMAC_Update(ctx, test[5].data, test[5].data_len)) != 0)
        || !test_true("../test/hmactest.c", 230, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0)
        || !test_false("../test/hmactest.c", 231, "HMAC_Update(ctx, test[5].data, test[5].data_len)", (HMAC_Update(ctx, test[5].data, test[5].data_len)) != 0)
        || !test_false("../test/hmactest.c", 232, "HMAC_Final(ctx, buf, &len)", (HMAC_Final(ctx, buf, &len)) != 0))
        goto err;
...
# 244 "../test/hmactest.c"
    ...
    ctx = HMAC_CTX_new();
    ctx2 = HMAC_CTX_new();
    if (!test_ptr("../test/hmactest.c", 251, "ctx", ctx) || !test_ptr("../test/hmactest.c", 251, "ctx2", ctx2))
        goto err;

    if (!test_true("../test/hmactest.c", 254, "HMAC_Init_ex(ctx, test[7].key, test[7].key_len, EVP_sha1(), NULL)", (HMAC_Init_ex(ctx, test[7].key, test[7].key_len, EVP_sha1(), 
# 254 "../test/hmactest.c" 3 4
        ((void *)0)
# 254 "../test/hmactest.c"
        )) != 0)
        || !test_true("../test/hmactest.c", 255, "HMAC_Update(ctx, test[7].data, test[7].data_len)", (HMAC_Update(ctx, test[7].data, test[7].data_len)) != 0)
        || !test_true("../test/hmactest.c", 256, "HMAC_CTX_copy(ctx2, ctx)", (HMAC_CTX_copy(ctx2, ctx)) != 0)
        || !test_true("../test/hmactest.c", 257, "HMAC_Final(ctx2, buf, &len)", (HMAC_Final(ctx2, buf, &len)) != 0))
        goto err;

    p = pt(buf, len);
    if (!test_ptr("../test/hmactest.c", 261, "p", p) || !test_str_eq("../test/hmactest.c", 261, "p", "test[7].digest", p, test[7].digest))
        goto err;
...
static int test_hmac_copy_uninited(void)
{
    ...
    EVP_PKEY *pkey = 
# 275 "../test/hmactest.c" 3 4
                    ((void *)0)
# 275 "../test/hmactest.c"
                        ;
    EVP_MD_CTX *ctx = 
# 276 "../test/hmactest.c" 3 4
                     ((void *)0)
# 276 "../test/hmactest.c"
                         ;
    EVP_MD_CTX *ctx_tmp = 
# 277 "../test/hmactest.c" 3 4
                         ((void *)0)
# 277 "../test/hmactest.c"
                             ;
    int res = 0;

    if (!test_ptr("../test/hmactest.c", 280, "ctx = EVP_MD_CTX_new()", ctx = EVP_MD_CTX_new())
            || !test_ptr("../test/hmactest.c", 281, "pkey = EVP_PKEY_new_mac_key(EVP_PKEY_HMAC, NULL, key, sizeof(key))", pkey = EVP_PKEY_new_mac_key(855, 
# 281 "../test/hmactest.c" 3 4
               ((void *)0)
# 281 "../test/hmactest.c"
               , key, sizeof(key)))

            || !test_true("../test/hmactest.c", 283, "EVP_DigestSignInit(ctx, NULL, EVP_sha1(), NULL, pkey)", (EVP_DigestSignInit(ctx, 
# 283 "../test/hmactest.c" 3 4
               ((void *)0)
# 283 "../test/hmactest.c"
               , EVP_sha1(), 
# 283 "../test/hmactest.c" 3 4
...
# 283 "../test/hmactest.c"
               , pkey)) != 0)
            || !test_ptr("../test/hmactest.c", 284, "ctx_tmp = EVP_MD_CTX_new()", ctx_tmp = EVP_MD_CTX_new())
            || !test_true("../test/hmactest.c", 285, "EVP_MD_CTX_copy(ctx_tmp, ctx)", (EVP_MD_CTX_copy(ctx_tmp, ctx)) != 0))
        goto err;
    EVP_MD_CTX_free(ctx);
    ctx = ctx_tmp;
    ctx_tmp = 
# 289 "../test/hmactest.c" 3 4
             ((void *)0)
# 289 "../test/hmactest.c"
                 ;

    if (!test_true("../test/hmactest.c", 291, "EVP_DigestSignUpdate(ctx, ct, sizeof(ct))", (EVP_DigestSignUpdate(ctx, ct, sizeof(ct))) != 0))
        goto err;
    res = 1;
 err:
    EVP_MD_CTX_free(ctx);
...
static char *pt(unsigned char *md, unsigned int len)
{
    ...
    if (md == 
# 308 "../test/hmactest.c" 3 4
             ((void *)0)
# 308 "../test/hmactest.c"
                 )
        return 
# 309 "../test/hmactest.c" 3 4
              ((void *)0)
# 309 "../test/hmactest.c"
                  ;
...
int setup_tests(void)
{
    ...
    add_test("test_hmac_final_update_fail", test_hmac_final_update_fail);
    add_test("test_hmac_copy", test_hmac_copy);
    add_test("test_hmac_copy_uninited", test_hmac_copy_uninited);
    return 1;
}
