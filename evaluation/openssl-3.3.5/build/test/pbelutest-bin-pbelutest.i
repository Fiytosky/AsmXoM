...
static int test_pbelu(void)
{
    ...
    for (i = 0; EVP_PBE_get(&pbe_type, &pbe_nid, i) != 0; i++) {
        if (!test_true("../test/pbelutest.c", 24, "EVP_PBE_find(pbe_type, pbe_nid, NULL, NULL, 0)", (EVP_PBE_find(pbe_type, pbe_nid, 
# 24 "../test/pbelutest.c" 3 4
            ((void *)0)
# 24 "../test/pbelutest.c"
            , 
# 24 "../test/pbelutest.c" 3 4
...
int setup_tests(void)
{
    add_test("test_pbelu", test_pbelu);
    return 1;
}
