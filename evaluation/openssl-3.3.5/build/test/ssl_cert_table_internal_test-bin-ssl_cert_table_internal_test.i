# 0 "../test/ssl_cert_table_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ssl_cert_table_internal_test.c"
# 12 "../test/ssl_cert_table_internal_test.c"
...
# 13 "../test/ssl_cert_table_internal_test.c" 2
...
# 14 "../test/ssl_cert_table_internal_test.c" 2
...
# 16 "../test/ssl_cert_table_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 17 "../test/ssl_cert_table_internal_test.c" 2
...
# 19 "../test/ssl_cert_table_internal_test.c" 2
# 1 "../test/../ssl/ssl_cert_table.h" 1
# 13 "../test/../ssl/ssl_cert_table.h"
...
# 20 "../test/ssl_cert_table_internal_test.c" 2
                              ...
                              const char *idxname)
{
    ...
    test_error("../test/ssl_cert_table_internal_test.c", 32, "Invalid table entry for certificate type %s, index %zu", idxname, idx)
                            ;
    if (clu->nid != nid)
...
{
    return test_size_t_eq("../test/ssl_cert_table_internal_test.c", 47, "OSSL_NELEM(ssl_cert_info)", "SSL_PKEY_NUM", (sizeof(ssl_cert_info)/sizeof((ssl_cert_info)[0])), 9)
           && do_test_cert_table(6, 0x00000001U, 0, "SSL_PKEY_RSA")
           && do_test_cert_table(116, 0x00000002U, 2, "SSL_PKEY_DSA_SIGN")
           && do_test_cert_table(408, 0x00000008U, 3, "SSL_PKEY_ECC")
           && do_test_cert_table(811, 0x00000020U, 4, "SSL_PKEY_GOST01")

           && do_test_cert_table(979, 0x00000080U, 5, "SSL_PKEY_GOST12_256")

           && do_test_cert_table(980, 0x00000080U, 6, "SSL_PKEY_GOST12_512")

           && do_test_cert_table(1087, 0x00000008U, 7, "SSL_PKEY_ED25519")
           && do_test_cert_table(1088, 0x00000008U, 8, "SSL_PKEY_ED448");
}
