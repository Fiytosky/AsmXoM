# 0 "../test/upcallstest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/upcallstest.c"
# 10 "../test/upcallstest.c"
                                       ...
                                       int *no_cache)
{
    *no_cache = 0;
    return 
# 19 "../test/upcallstest.c" 3 4
          ((void *)0)
# 19 "../test/upcallstest.c"
              ;
}

static const OSSL_DISPATCH obj_dispatch_table[] = {
    { 1027, (void (*)(void))obj_query },
    { 0, 
# 24 "../test/upcallstest.c" 3 4
   ((void *)0) 
# 24 "../test/upcallstest.c"
   }
};

static OSSL_FUNC_core_obj_add_sigid_fn *c_obj_add_sigid = 
# 27 "../test/upcallstest.c" 3 4
                                                         ((void *)0)
# 27 "../test/upcallstest.c"
                                                             ;
static OSSL_FUNC_core_obj_create_fn *c_obj_create = 
# 28 "../test/upcallstest.c" 3 4
                                                   ((void *)0)
# 28 "../test/upcallstest.c"
                                                       ;
# 49 "../test/upcallstest.c"
                             ...
                             void **provctx)
{
    ...
    *out = obj_dispatch_table;
    ...
    if (!c_obj_create(handle, "1.3.6.1.4.1.16604.998877.2", "my-digest", "my-digest-long")
            || !c_obj_create(handle, "1.3.6.1.4.1.16604.998877.1", "my-sig", "my-sig-long")
            || !c_obj_create(handle, "1.3.6.1.4.1.16604.998877.3", "my-sigalg", "my-sigalg-long"))
        return 0;

    if (!c_obj_create(handle, "1.3.6.1.4.1.16604.998877.4", "my-nodig-sig", "my-nodig-sig-long")
            || !c_obj_create(handle, "1.3.6.1.4.1.16604.998877.5", "my-nodig-sigalg", "my-nodig-sigalg-long"))
        return 0;

    if (!c_obj_add_sigid(handle, "1.3.6.1.4.1.16604.998877.3", "my-digest", "my-sig-long"))
        return 0;


    if (!c_obj_add_sigid(handle, "1.3.6.1.4.1.16604.998877.5", "", "my-nodig-sig-long"))
        return 0;

    if (c_obj_add_sigid(handle, "1.3.6.1.4.1.16604.998877.5", "NonsenseAlg", "my-nodig-sig-long"))
        return 0;
...
static int obj_create_test(void)
{
    ...
    OSSL_PROVIDER *objprov = 
# 97 "../test/upcallstest.c" 3 4
                            ((void *)0)
# 97 "../test/upcallstest.c"
                                ;
    int sigalgnid, digestnid, signid, foundsid;
    int testresult = 0;

    if (!test_ptr("../test/upcallstest.c", 101, "libctx", libctx))
        goto err;

    if (!test_true("../test/upcallstest.c", 104, "OSSL_PROVIDER_add_builtin(libctx, \"obj-prov\", obj_provider_init)", (OSSL_PROVIDER_add_builtin(libctx, "obj-prov", obj_provider_init)) != 0)

            || !test_ptr("../test/upcallstest.c", 106, "objprov = OSSL_PROVIDER_load(libctx, \"obj-prov\")", objprov = OSSL_PROVIDER_load(libctx, "obj-prov")))
        goto err;


    sigalgnid = OBJ_txt2nid("1.3.6.1.4.1.16604.998877.3");
    if (!test_int_ne("../test/upcallstest.c", 111, "sigalgnid", "NID_undef", sigalgnid, 0)
            || !test_true("../test/upcallstest.c", 112, "OBJ_find_sigid_algs(sigalgnid, &digestnid, &signid)", (OBJ_find_sigid_algs(sigalgnid, &digestnid, &signid)) != 0)
            || !test_int_ne("../test/upcallstest.c", 113, "digestnid", "NID_undef", digestnid, 0)
            || !test_int_ne("../test/upcallstest.c", 114, "signid", "NID_undef", signid, 0)
            || !test_int_eq("../test/upcallstest.c", 115, "digestnid", "OBJ_sn2nid(DIGEST_SN)", digestnid, OBJ_sn2nid("my-digest"))
            || !test_int_eq("../test/upcallstest.c", 116, "signid", "OBJ_ln2nid(SIG_LN)", signid, OBJ_ln2nid("my-sig-long")))
        goto err;


    sigalgnid = OBJ_txt2nid("1.3.6.1.4.1.16604.998877.5");
    if (!test_int_ne("../test/upcallstest.c", 121, "sigalgnid", "NID_undef", sigalgnid, 0)
            || !test_true("../test/upcallstest.c", 122, "OBJ_find_sigid_algs(sigalgnid, &digestnid, &signid)", (OBJ_find_sigid_algs(sigalgnid, &digestnid, &signid)) != 0)
            || !test_int_eq("../test/upcallstest.c", 123, "digestnid", "NID_undef", digestnid, 0)
            || !test_int_ne("../test/upcallstest.c", 124, "signid", "NID_undef", signid, 0))
        goto err;



    sigalgnid = OBJ_sn2nid("my-sigalg");
    digestnid = OBJ_sn2nid("my-digest");
    signid = OBJ_ln2nid("my-sig-long");
    ...
    sigalgnid = OBJ_sn2nid("my-nodig-sigalg");
    digestnid = OBJ_sn2nid("SHA512");
    signid = OBJ_ln2nid("my-nodig-sig-long");
    if ((!OBJ_find_sigid_by_algs(&foundsid, digestnid, signid)) ||
        (foundsid != sigalgnid))
        return 0;
