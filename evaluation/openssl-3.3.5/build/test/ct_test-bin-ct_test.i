...
# 28 "../test/ct_test.c" 3 4
                        ((void *)0)
# 28 "../test/ct_test.c"
                            ;
static char *ct_dir = 
# 29 "../test/ct_test.c" 3 4
                     ((void *)0)
# 29 "../test/ct_test.c"
                         ;
...
# 62 "../test/ct_test.c" 3 4
                              ((void *)0)
# 62 "../test/ct_test.c"
                                  ;

    if (!test_ptr("../test/ct_test.c", 64, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/ct_test.c", 64)))
        goto end;
    fixture->test_case_name = test_case_name;
    fixture->epoch_time_in_ms = 1580335307000ULL;
    if (!test_ptr("../test/ct_test.c", 68, "fixture->ctlog_store = CTLOG_STORE_new()", fixture->ctlog_store = CTLOG_STORE_new())
            || !test_int_eq("../test/ct_test.c", 69, "CTLOG_STORE_load_default_file(fixture->ctlog_store)", "1", CTLOG_STORE_load_default_file(fixture->ctlog_store), 1)
                                                                           )
        goto end;
    return fixture;
    ...
    if (fixture != 
# 75 "../test/ct_test.c" 3 4
                  ((void *)0)
# 75 "../test/ct_test.c"
                      )
        CTLOG_STORE_free(fixture->ctlog_store);
    CRYPTO_free(fixture, "../test/ct_test.c", 77);
    test_error("../test/ct_test.c", 78, "Failed to setup");
    return 
# 79 "../test/ct_test.c" 3 4
          ((void *)0)
# 79 "../test/ct_test.c"
              ;
}
...
# 84 "../test/ct_test.c"
    ...
    CRYPTO_free(fixture, "../test/ct_test.c", 88);
}

static X509 *load_pem_cert(const char *dir, const char *file)
{
    X509 *cert = 
# 93 "../test/ct_test.c" 3 4
                ((void *)0)
# 93 "../test/ct_test.c"
                    ;
...
# 96 "../test/ct_test.c"
        ...
        if (cert_io != 
# 99 "../test/ct_test.c" 3 4
                      ((void *)0)
# 99 "../test/ct_test.c"
                          )
            cert = PEM_read_bio_X509(cert_io, 
# 100 "../test/ct_test.c" 3 4
                                             ((void *)0)
# 100 "../test/ct_test.c"
                                                 , 
# 100 "../test/ct_test.c" 3 4
...
# 100 "../test/ct_test.c"
    ...
    CRYPTO_free(file_path, "../test/ct_test.c", 104);
    return cert;
}
...
# 117 "../test/ct_test.c"
    ...
    CRYPTO_free(file_path, "../test/ct_test.c", 122);
    return len;
}

static int compare_sct_list_printout(struct stack_st_SCT *sct,
                                     const char *expected_output)
{
    BIO *text_buffer = 
# 129 "../test/ct_test.c" 3 4
                      ((void *)0)
# 129 "../test/ct_test.c"
                          ;
    char *actual_output = 
# 130 "../test/ct_test.c" 3 4
                         ((void *)0)
# 130 "../test/ct_test.c"
                             ;
    int result = 0;

    if (!test_ptr("../test/ct_test.c", 133, "text_buffer = BIO_new(BIO_s_mem())", text_buffer = BIO_new(BIO_s_mem())))
        goto end;

    SCT_LIST_print(sct, text_buffer, 0, "\n", 
# 136 "../test/ct_test.c" 3 4
                                             ((void *)0)
# 136 "../test/ct_test.c"
                                                 );


    if (!test_true("../test/ct_test.c", 139, "BIO_write(text_buffer, \"\\0\", 1)", (BIO_write(text_buffer, "\0", 1)) != 0))
        goto end;

    BIO_ctrl(text_buffer,3,0,(char *)(&actual_output));
    if (!test_str_eq("../test/ct_test.c", 143, "actual_output", "expected_output", actual_output, expected_output))
        goto end;
    result = 1;
...
{
    BIO *text_buffer = 
# 155 "../test/ct_test.c" 3 4
                      ((void *)0)
# 155 "../test/ct_test.c"
                          ;
    char *actual_output = 
# 156 "../test/ct_test.c" 3 4
                         ((void *)0)
# 156 "../test/ct_test.c"
                             ;
    int result = 0;

    if (!test_ptr("../test/ct_test.c", 159, "text_buffer = BIO_new(BIO_s_mem())", text_buffer = BIO_new(BIO_s_mem()))
            || !test_true("../test/ct_test.c", 160, "X509V3_EXT_print(text_buffer, extension, X509V3_EXT_DEFAULT, 0)", (X509V3_EXT_print(text_buffer, extension, 0, 0)) != 0)
                                                                  )
        goto end;


    if (!test_true("../test/ct_test.c", 165, "BIO_write(text_buffer, \"\\n\", 1)", (BIO_write(text_buffer, "\n", 1)) != 0))
        goto end;


    if (!test_true("../test/ct_test.c", 169, "BIO_write(text_buffer, \"\\0\", 1)", (BIO_write(text_buffer, "\0", 1)) != 0))
        goto end;

    BIO_ctrl(text_buffer,3,0,(char *)(&actual_output));
    if (!test_str_eq("../test/ct_test.c", 173, "actual_output", "expected_output", actual_output, expected_output))
        goto end;
...
static int assert_validity(CT_TEST_FIXTURE *fixture, struct stack_st_SCT *scts,
                           CT_POLICY_EVAL_CTX *policy_ctx)
{
    ...
    if (!test_int_ge("../test/ct_test.c", 190, "SCT_LIST_validate(scts, policy_ctx)", "0", SCT_LIST_validate(scts, policy_ctx), 0))
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SCT_sk_type(scts)); ++i) {
        SCT *sct_i = ((SCT *)OPENSSL_sk_value(ossl_check_const_SCT_sk_type(scts), (i)));
    ...
    if (!test_int_eq("../test/ct_test.c", 212, "valid_sct_count", "fixture->expected_valid_sct_count", valid_sct_count, fixture->expected_valid_sct_count)) {
        int unverified_sct_count = OPENSSL_sk_num(ossl_check_const_SCT_sk_type(scts)) -
                                        invalid_sct_count - valid_sct_count;

        test_info("../test/ct_test.c", 216, "%d SCTs failed, %d SCTs unverified", invalid_sct_count, unverified_sct_count)
                                                          ;
        return 0;
    }
...
# 228 "../test/ct_test.c" 3 4
                         ((void *)0)
# 228 "../test/ct_test.c"
                             ;
    SCT *sct = 
# 229 "../test/ct_test.c" 3 4
              ((void *)0)
# 229 "../test/ct_test.c"
                  ;
    char expected_sct_text[8096];
    int sct_text_len = 0;
    unsigned char *tls_sct_list = 
# 232 "../test/ct_test.c" 3 4
                                 ((void *)0)
# 232 "../test/ct_test.c"
                                     ;
...
# 236 "../test/ct_test.c"
        ...
        if (!test_int_ge("../test/ct_test.c", 241, "sct_text_len", "0", sct_text_len, 0))
            goto end;
    ...
    if (fixture->certificate_file != 
# 251 "../test/ct_test.c" 3 4
                                    ((void *)0)
# 251 "../test/ct_test.c"
                                        ) {
        int sct_extension_index;
        int i;
        X509_EXTENSION *sct_extension = 
# 254 "../test/ct_test.c" 3 4
                                       ((void *)0)
# 254 "../test/ct_test.c"
                                           ;

        if (!test_ptr("../test/ct_test.c", 256, "cert = load_pem_cert(fixture->certs_dir, fixture->certificate_file)", cert = load_pem_cert(fixture->certs_dir, fixture->certificate_file))
                                                                      )
            goto end;

        CT_POLICY_EVAL_CTX_set1_cert(ct_policy_ctx, cert);

        if (fixture->issuer_file != 
# 262 "../test/ct_test.c" 3 4
                                   ((void *)0)
# 262 "../test/ct_test.c"
                                       ) {
            if (!test_ptr("../test/ct_test.c", 263, "issuer = load_pem_cert(fixture->certs_dir, fixture->issuer_file)", issuer = load_pem_cert(fixture->certs_dir, fixture->issuer_file))
                                                                       )
                goto end;
        ...
        sct_extension_index =
                X509_get_ext_by_NID(cert, 951, -1);
        sct_extension = X509_get_ext(cert, sct_extension_index);
        if (fixture->expected_sct_count > 0) {
            if (!test_ptr("../test/ct_test.c", 273, "sct_extension", sct_extension))
                goto end;
            ...
            for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SCT_sk_type(scts)); ++i) {
                ...
                if (!test_int_eq("../test/ct_test.c", 285, "SCT_get_source(sct_i)", "SCT_SOURCE_X509V3_EXTENSION", SCT_get_source(sct_i), SCT_SOURCE_X509V3_EXTENSION)
                                                             ) {
                    goto end;
                }
            }
        ...
        } else if (!test_ptr_null("../test/ct_test.c", 295, "sct_extension", sct_extension)) {
            goto end;
        }
    }

    if (fixture->tls_sct_list != 
# 300 "../test/ct_test.c" 3 4
                                ((void *)0)
# 300 "../test/ct_test.c"
                                    ) {
        const unsigned char *p = fixture->tls_sct_list;

        if (!test_ptr("../test/ct_test.c", 303, "o2i_SCT_LIST(&scts, &p, fixture->tls_sct_list_len)", o2i_SCT_LIST(&scts, &p, fixture->tls_sct_list_len)))
            goto end;

        if (fixture->test_validity && cert != 
# 306 "../test/ct_test.c" 3 4
                                             ((void *)0)
# 306 "../test/ct_test.c"
                                                 ) {
            if (!assert_validity(fixture, scts, ct_policy_ctx))
        ...
        if (!test_mem_eq("../test/ct_test.c", 317, "fixture->tls_sct_list", "tls_sct_list", fixture->tls_sct_list, fixture->tls_sct_list_len, tls_sct_list, tls_sct_list_len)
                                                        )
            goto end;
    }
    success = 1;
    ...
    CRYPTO_free(tls_sct_list, "../test/ct_test.c", 329);
    return success;
}
...
{
    CT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 338 "../test/ct_test.c" 3 4
   ((void *)0)
# 338 "../test/ct_test.c"
   ) return 0;
    ...
    if (fixture != 
# 343 "../test/ct_test.c" 3 4
   ((void *)0)
# 343 "../test/ct_test.c"
   ) { result = execute_cert_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    const unsigned char tls_sct_list[] = "\x00\x78"
        "\x00\x76"
        "\x00"
...
static int test_encode_tls_sct(void)
{
    ...
    SCT *sct = 
# 447 "../test/ct_test.c" 3 4
              ((void *)0)
# 447 "../test/ct_test.c"
                  ;

    CT_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 449 "../test/ct_test.c" 3 4
   ((void *)0)
# 449 "../test/ct_test.c"
   ) return 0;

    fixture->sct_list = ((struct stack_st_SCT *)OPENSSL_sk_new_null());
    if (fixture->sct_list == 
# 452 "../test/ct_test.c" 3 4
                            ((void *)0)
# 452 "../test/ct_test.c"
                                )
    {
    ...
    if (!test_ptr("../test/ct_test.c", 458, "sct = SCT_new_from_base64(SCT_VERSION_V1, log_id, CT_LOG_ENTRY_TYPE_X509, timestamp, extensions, signature)", sct = SCT_new_from_base64(SCT_VERSION_V1, log_id, CT_LOG_ENTRY_TYPE_X509, timestamp, extensions, signature))
    ...
    OPENSSL_sk_push(ossl_check_SCT_sk_type(fixture->sct_list), ossl_check_SCT_type(sct));
    fixture->sct_dir = ct_dir;
    fixture->sct_text_file = "tls1.sct";
    if (fixture != 
# 469 "../test/ct_test.c" 3 4
   ((void *)0)
# 469 "../test/ct_test.c"
   ) { result = execute_cert_test(fixture); tear_down(fixture); };
    return result;
...
static int test_default_ct_policy_eval_ctx_time_is_now(void)
{
    ...
    if (!test_time_t_le("../test/ct_test.c", 485, "abs((int)difftime(time(NULL), default_time))", "time_tolerance", abs((int)difftime(time(
# 485 "../test/ct_test.c" 3 4
        ((void *)0)
# 485 "../test/ct_test.c"
        ), default_time)), time_tolerance)
                                       )
        goto end;
...
# 497 "../test/ct_test.c"
    ...
    if (!test_true("../test/ct_test.c", 503, "!CTLOG_new_from_base64(&ctlogp, notb64, name)", (!CTLOG_new_from_base64(&ctlogp, notb64, name)) != 0)
        || !test_true("../test/ct_test.c", 504, "!CTLOG_new_from_base64(&ctlogp, pad, name)", (!CTLOG_new_from_base64(&ctlogp, pad, name)) != 0))
        return 0;
    return 1;
}
...
int setup_tests(void)
{
    ...
    if ((ct_dir = getenv("CT_DIR")) == 
# 513 "../test/ct_test.c" 3 4
                                      ((void *)0)
# 513 "../test/ct_test.c"
                                          )
        ct_dir = "ct";
    if ((certs_dir = getenv("CERTS_DIR")) == 
# 515 "../test/ct_test.c" 3 4
                                            ((void *)0)
# 515 "../test/ct_test.c"
                                                )
        certs_dir = "certs";
    ...
    add_test("test_ctlog_from_base64", test_ctlog_from_base64);
