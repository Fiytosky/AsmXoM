...
# 18 "../test/asynctest.c" 2

static int ctr = 0;
static ASYNC_JOB *currjob = 
# 20 "../test/asynctest.c" 3 4
                           ((void *)0)
# 20 "../test/asynctest.c"
                               ;
...
# 90 "../test/asynctest.c"
    ...
    if (!ASYNC_WAIT_CTX_set_wait_fd(waitctx, waitctx, ((int)99), 
# 97 "../test/asynctest.c" 3 4
                                                                    ((void *)0)
# 97 "../test/asynctest.c"
                                                                        , 
# 97 "../test/asynctest.c" 3 4
...
# 97 "../test/asynctest.c"
    ...
    if (!ASYNC_WAIT_CTX_set_wait_fd(waitctx, waitctx, ((int)99), 
# 107 "../test/asynctest.c" 3 4
                                                                    ((void *)0)
# 107 "../test/asynctest.c"
                                                                        , 
# 107 "../test/asynctest.c" 3 4
                                                                          ((void *)0)
# 107 "../test/asynctest.c"
...
{
    ASYNC_JOB *job1 = 
# 127 "../test/asynctest.c" 3 4
                     ((void *)0)
# 127 "../test/asynctest.c"
                         , *job2 = 
# 127 "../test/asynctest.c" 3 4
                                   ((void *)0)
# 127 "../test/asynctest.c"
...
# 127 "../test/asynctest.c"
    ...
    ASYNC_WAIT_CTX *waitctx = 
# 129 "../test/asynctest.c" 3 4
                             ((void *)0)
# 129 "../test/asynctest.c"
                                 ;

    if ( !ASYNC_init_thread(2, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 132 "../test/asynctest.c" 3 4
                                                  ((void *)0)
            
# 133 "../test/asynctest.c"
           || ASYNC_start_job(&job1, waitctx, &funcret1, only_pause, 
# 133 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 133 "../test/asynctest.c"
                                                                         , 0)
                != 2
            || ASYNC_start_job(&job2, waitctx, &funcret2, only_pause, 
# 135 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 135 "../test/asynctest.c"
                                                                         , 0)
                != 2
            || ASYNC_start_job(&job3, waitctx, &funcret3, only_pause, 
# 137 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 137 "../test/asynctest.c"
                                                                         , 0)
                != 1
            || ASYNC_start_job(&job1, waitctx, &funcret1, only_pause, 
# 139 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 139 "../test/asynctest.c"
                                                                         , 0)
                != 3
            || ASYNC_start_job(&job3, waitctx, &funcret3, only_pause, 
# 141 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 141 "../test/asynctest.c"
                                                                         , 0)
                != 2
            || ASYNC_start_job(&job2, waitctx, &funcret2, only_pause, 
# 143 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 143 "../test/asynctest.c"
                                                                         , 0)
                != 3
            || ASYNC_start_job(&job3, waitctx, &funcret3, only_pause, 
# 145 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 145 "../test/asynctest.c"
                                                                         , 0)
                != 3
            || funcret1 != 1
            || funcret2 != 1
            || funcret3 != 1) {
        fprintf(
# 150 "../test/asynctest.c" 3 4
               stderr
# 150 "../test/asynctest.c"
...
{
    ASYNC_WAIT_CTX *waitctx = 
# 169 "../test/asynctest.c" 3 4
                             ((void *)0)
# 169 "../test/asynctest.c"
                                 ;
    int set_arg = 100;
    ...
    if ( !ASYNC_init_thread(1, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 176 "../test/asynctest.c" 3 4
                                                  ((void *)0)
            
# 177 "../test/asynctest.c"
        ...
        fprintf(
# 186 "../test/asynctest.c" 3 4
               stderr
# 186 "../test/asynctest.c"
                     , "test_ASYNC_callback_status() failed\n");
        ASYNC_WAIT_CTX_free(waitctx);
        ASYNC_cleanup_thread();
        return 0;
    }
...
{
    ASYNC_JOB *job = 
# 200 "../test/asynctest.c" 3 4
                    ((void *)0)
# 200 "../test/asynctest.c"
                        ;
    int funcret;
    ASYNC_WAIT_CTX *waitctx = 
# 202 "../test/asynctest.c" 3 4
                             ((void *)0)
# 202 "../test/asynctest.c"
                                 ;
    ...
    if ( !ASYNC_init_thread(1, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 207 "../test/asynctest.c" 3 4
                                                  ((void *)0)
            
# 208 "../test/asynctest.c"
           || ASYNC_start_job(&job, waitctx, &funcret, add_two, 
# 208 "../test/asynctest.c" 3 4
                                                                ((void *)0)
# 208 "../test/asynctest.c"
                                                                    , 0)
               != 2
            || ctr != 1
            || ASYNC_start_job(&job, waitctx, &funcret, add_two, 
# 211 "../test/asynctest.c" 3 4
                                                                ((void *)0)
# 211 "../test/asynctest.c"
                                                                    , 0)
               != 3
            || ctr != 2
            || funcret != 2) {
        fprintf(
# 215 "../test/asynctest.c" 3 4
               stderr
# 215 "../test/asynctest.c"
...
{
    ASYNC_JOB *job = 
# 228 "../test/asynctest.c" 3 4
                    ((void *)0)
# 228 "../test/asynctest.c"
                        ;
    int funcret;
    ASYNC_WAIT_CTX *waitctx = 
# 230 "../test/asynctest.c" 3 4
                             ((void *)0)
# 230 "../test/asynctest.c"
                                 ;

    currjob = 
# 232 "../test/asynctest.c" 3 4
             ((void *)0)
# 232 "../test/asynctest.c"
                 ;

    if ( !ASYNC_init_thread(1, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 235 "../test/asynctest.c" 3 4
                                                  ((void *)0)
            
# 236 "../test/asynctest.c"
           || ASYNC_start_job(&job, waitctx, &funcret, save_current, 
# 236 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 236 "../test/asynctest.c"
                                                                         , 0)
                != 2
            || currjob != job
            || ASYNC_start_job(&job, waitctx, &funcret, save_current, 
# 239 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 239 "../test/asynctest.c"
                                                                         , 0)
                != 3
            || funcret != 1) {
        fprintf(
# 242 "../test/asynctest.c" 3 4
               stderr
# 242 "../test/asynctest.c"
...
{
    ASYNC_JOB *job = 
# 255 "../test/asynctest.c" 3 4
                    ((void *)0)
# 255 "../test/asynctest.c"
                        ;
    int funcret;
    ASYNC_WAIT_CTX *waitctx = 
# 257 "../test/asynctest.c" 3 4
                             ((void *)0)
# 257 "../test/asynctest.c"
                                 ;
    int fd = -1, delfd = -1;
    ...
    if ( !ASYNC_init_thread(1, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 262 "../test/asynctest.c" 3 4
                                                  ((void *)0)

            
# 264 "../test/asynctest.c"
           || ASYNC_start_job(&job, waitctx, &funcret, waitfd, 
# 264 "../test/asynctest.c" 3 4
                                                               ((void *)0)
# 264 "../test/asynctest.c"
                                                                   , 0)
                != 2
            || !ASYNC_WAIT_CTX_get_all_fds(waitctx, 
# 266 "../test/asynctest.c" 3 4
                                                   ((void *)0)
# 266 "../test/asynctest.c"
                                                       , &numfds)
            || numfds != 0
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, 
# 268 "../test/asynctest.c" 3 4
                                                       ((void *)0)
# 268 "../test/asynctest.c"
                                                           , &numfds, 
# 268 "../test/asynctest.c" 3 4
                                                                      ((void *)0)
# 268 "../test/asynctest.c"
            ...
            || ASYNC_start_job(&job, waitctx, &funcret, waitfd, 
# 273 "../test/asynctest.c" 3 4
                                                               ((void *)0)
# 273 "../test/asynctest.c"
                                                                   , 0)
                != 2
            || !ASYNC_WAIT_CTX_get_all_fds(waitctx, 
# 275 "../test/asynctest.c" 3 4
                                                   ((void *)0)
# 275 "../test/asynctest.c"
                                                       , &numfds)
            || numfds != 1
            ...
            || (fd = -1, 0)
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, 
# 280 "../test/asynctest.c" 3 4
                                                       ((void *)0)
# 280 "../test/asynctest.c"
                                                           , &numfds, 
# 280 "../test/asynctest.c" 3 4
                                                                      ((void *)0)
# 280 "../test/asynctest.c"
            ...
            || numfds != 1
            || numdelfds != 0
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, &fd, &numfds, 
# 284 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 284 "../test/asynctest.c"
                                                                         ,
                                               &numdelfds)
            || fd != ((int)99)

            || ASYNC_start_job(&job, waitctx, &funcret, waitfd, 
# 288 "../test/asynctest.c" 3 4
                                                               ((void *)0)
# 288 "../test/asynctest.c"
                                                                   , 0)
                != 2
            || !ASYNC_WAIT_CTX_get_all_fds(waitctx, 
# 290 "../test/asynctest.c" 3 4
                                                   ((void *)0)
# 290 "../test/asynctest.c"
                                                       , &numfds)
            || numfds != 0
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, 
# 292 "../test/asynctest.c" 3 4
                                                       ((void *)0)
# 292 "../test/asynctest.c"
                                                           , &numfds, 
# 292 "../test/asynctest.c" 3 4
                                                                      ((void *)0)
# 292 "../test/asynctest.c"
            ...
            || numdelfds != 1
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, 
# 296 "../test/asynctest.c" 3 4
                                                       ((void *)0)
# 296 "../test/asynctest.c"
                                                           , &numfds, &delfd,
                                               &numdelfds)
            || delfd != ((int)99)

            || ASYNC_start_job(&job, waitctx, &funcret, waitfd, 
# 300 "../test/asynctest.c" 3 4
                                                               ((void *)0)
# 300 "../test/asynctest.c"
                                                                   , 0)
                != 3
            || !ASYNC_WAIT_CTX_get_all_fds(waitctx, 
# 302 "../test/asynctest.c" 3 4
                                                   ((void *)0)
# 302 "../test/asynctest.c"
                                                       , &numfds)
            || numfds != 0
            || !ASYNC_WAIT_CTX_get_changed_fds(waitctx, 
# 304 "../test/asynctest.c" 3 4
                                                       ((void *)0)
# 304 "../test/asynctest.c"
                                                           , &numfds, 
# 304 "../test/asynctest.c" 3 4
                                                                      ((void *)0)
# 304 "../test/asynctest.c"
            ...
            || funcret != 1) {
        fprintf(
# 309 "../test/asynctest.c" 3 4
               stderr
# 309 "../test/asynctest.c"
...
{
    ASYNC_JOB *job = 
# 322 "../test/asynctest.c" 3 4
                    ((void *)0)
# 322 "../test/asynctest.c"
                        ;
    int funcret;
    ASYNC_WAIT_CTX *waitctx = 
# 324 "../test/asynctest.c" 3 4
                             ((void *)0)
# 324 "../test/asynctest.c"
                                 ;

    if ( !ASYNC_init_thread(1, 0)
            || (waitctx = ASYNC_WAIT_CTX_new()) == 
# 327 "../test/asynctest.c" 3 4
                                                  ((void *)0)
            
# 328 "../test/asynctest.c"
           || ASYNC_start_job(&job, waitctx, &funcret, blockpause, 
# 328 "../test/asynctest.c" 3 4
                                                                   ((void *)0)
# 328 "../test/asynctest.c"
                                                                       , 0)
                != 2
            || ASYNC_start_job(&job, waitctx, &funcret, blockpause, 
# 330 "../test/asynctest.c" 3 4
                                                                   ((void *)0)
# 330 "../test/asynctest.c"
                                                                       , 0)
                != 3
            || funcret != 1) {
        fprintf(
# 333 "../test/asynctest.c" 3 4
               stderr
# 333 "../test/asynctest.c"
...
{
    ASYNC_JOB *job = 
# 346 "../test/asynctest.c" 3 4
                    ((void *)0)
# 346 "../test/asynctest.c"
                        ;
    int funcret;
    ASYNC_WAIT_CTX *waitctx = 
# 348 "../test/asynctest.c" 3 4
                             ((void *)0)
# 348 "../test/asynctest.c"
                                 ;
    OSSL_LIB_CTX *libctx = OSSL_LIB_CTX_new();
    ...
    if (libctx == 
# 353 "../test/asynctest.c" 3 4
                 ((void *)0)
# 353 "../test/asynctest.c"
                     ) {
        fprintf(
# 354 "../test/asynctest.c" 3 4
               stderr
# 354 "../test/asynctest.c"
                     ,
    ...
    if ((waitctx = ASYNC_WAIT_CTX_new()) == 
# 361 "../test/asynctest.c" 3 4
                                           ((void *)0)
            
# 362 "../test/asynctest.c"
           || ASYNC_start_job(&job, waitctx, &funcret, change_deflt_libctx,
                               
# 363 "../test/asynctest.c" 3 4
                              ((void *)0)
# 363 "../test/asynctest.c"
                                  , 0)
               != 2) {
        fprintf(
# 365 "../test/asynctest.c" 3 4
               stderr
# 365 "../test/asynctest.c"
                     ,
    ...
    if (tmpctx != libctx) {
        fprintf(
# 374 "../test/asynctest.c" 3 4
               stderr
# 374 "../test/asynctest.c"
                     ,
...
# 379 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 379 "../test/asynctest.c"
                                                                         , 0)
               != 2) {
        fprintf(
# 381 "../test/asynctest.c" 3 4
               stderr
# 381 "../test/asynctest.c"
                     ,
    ...
    if (tmpctx != libctx) {
        fprintf(
# 389 "../test/asynctest.c" 3 4
               stderr
# 389 "../test/asynctest.c"
                     ,
                "test_ASYNC_start_job_ex() failed - unexpected libctx\n");
        goto err;
    }
    ...
    if (ASYNC_start_job(&job, waitctx, &funcret, change_deflt_libctx, 
# 394 "../test/asynctest.c" 3 4
                                                                     ((void *)0)
# 394 "../test/asynctest.c"
                                                                         , 0)
               != 3
                || funcret != 1) {
        fprintf(
# 397 "../test/asynctest.c" 3 4
               stderr
# 397 "../test/asynctest.c"
                     ,
    ...
    if (tmpctx != globalctx) {
        fprintf(
# 406 "../test/asynctest.c" 3 4
               stderr
# 406 "../test/asynctest.c"
                     ,
...
{
    custom_alloc_used = 1;
    return CRYPTO_malloc(*num, "../test/asynctest.c", 422);
}

static void test_free_stack(void *addr)
{
    custom_free_used = 1;
    CRYPTO_free(addr, "../test/asynctest.c", 428);
}
...
static int test_ASYNC_set_mem_functions(void)
{
    ...
    if ((alloc_fn != test_alloc_stack) || (free_fn != test_free_stack)) {
        fprintf(
# 442 "../test/asynctest.c" 3 4
               stderr
# 442 "../test/asynctest.c"
                     ,
    ...
    if (!ASYNC_init_thread(1, 1)) {
        fprintf(
# 448 "../test/asynctest.c" 3 4
               stderr
# 448 "../test/asynctest.c"
                     ,
    ...
    if (!custom_alloc_used || !custom_free_used) {
         fprintf(
# 455 "../test/asynctest.c" 3 4
                stderr
# 455 "../test/asynctest.c"
                      ,
...
int main(int argc, char **argv)
{
    if (!ASYNC_is_capable()) {
        fprintf(
# 467 "../test/asynctest.c" 3 4
               stderr
# 467 "../test/asynctest.c"
                     ,
