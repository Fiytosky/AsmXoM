# 0 "../test/ca_internals_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/ca_internals_test.c"
# 10 "../test/ca_internals_test.c"
...
# 14 "../test/ca_internals_test.c" 2



char *default_config_file = 
# 17 "../test/ca_internals_test.c" 3 4
                           ((void *)0)
# 17 "../test/ca_internals_test.c"
                               ;

static int test_do_updatedb(void)
{
    CA_DB *db = 
# 21 "../test/ca_internals_test.c" 3 4
               ((void *)0)
# 21 "../test/ca_internals_test.c"
                   ;
    time_t testdateutc;
    int rv;
    ...
    if (argc != 4) {
        test_error("../test/ca_internals_test.c", 32, "Usage: %s: do_updatedb dbfile testdate need64bit\n", "ca_internals_test");
        test_error("../test/ca_internals_test.c", 33, "       testdate format: ASN1-String\n");
        return 0;
    }
    ...
    need64bit = (int)strtol(test_get_argument(3), 
# 41 "../test/ca_internals_test.c" 3 4
                                                 ((void *)0)
# 41 "../test/ca_internals_test.c"
                                                     , 0);
    ...
    if (test_time_t_lt("../test/ca_internals_test.c", 51, "testdateutc", "0", testdateutc, 0)) {
        return 0;
    }

    indexfile = test_get_argument(1);
    db = load_index(indexfile, 
# 56 "../test/ca_internals_test.c" 3 4
                              ((void *)0)
# 56 "../test/ca_internals_test.c"
                                  );
    if (test_ptr_null("../test/ca_internals_test.c", 57, "db", db)) {
        return 0;
    }
    ...
    if (rv > 0) {
        if (!test_true("../test/ca_internals_test.c", 67, "save_index(indexfile, \"new\", db)", (save_index(indexfile, "new", db)) != 0))
            goto end;

        if (!test_true("../test/ca_internals_test.c", 70, "rotate_index(indexfile, \"new\", \"old\")", (rotate_index(indexfile, "new", "old")) != 0))
            goto end;
    }
end:
    free_index(db);
...
int setup_tests(void)
{
    ...
    if (test_get_argument_count() < 1) {
        test_error("../test/ca_internals_test.c", 83, "%s: no command specified for testing\n", "ca_internals_test");
        return 0;
    }
    ...
    test_error("../test/ca_internals_test.c", 90, "%s: command '%s' is not supported for testing\n", "ca_internals_test", command);
    return 0;
}
