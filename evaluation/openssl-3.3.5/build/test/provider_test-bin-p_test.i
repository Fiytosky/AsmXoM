...
static const OSSL_PARAM p_param_types[] = {
    { "greeting", 4, 
# 55 "../test/p_test.c" 3 4
                                         ((void *)0)
# 55 "../test/p_test.c"
                                             , 0, 0 },
    { "digest-check", 2, 
# 56 "../test/p_test.c" 3 4
                                                  ((void *)0)
# 56 "../test/p_test.c"
                                                      , 0, 0},
    { 
# 57 "../test/p_test.c" 3 4
     ((void *)0)
# 57 "../test/p_test.c"
         , 0, 
# 57 "../test/p_test.c" 3 4
...
# 82 "../test/p_test.c"
                    ;
    c_new_error(
# 83 "../test/p_test.c" 3 4
               ((void *)0)
# 83 "../test/p_test.c"
                   );
    c_set_error_debug(
# 84 "../test/p_test.c" 3 4
                     ((void *)0)
# 84 "../test/p_test.c"
                         , file, line, func);
    c_vset_error(
# 85 "../test/p_test.c" 3 4
                ((void *)0)
# 85 "../test/p_test.c"
                    , ( (((unsigned long)(lib) & 0xFF ) << 23L) | (((unsigned long)(reason) & 0X7FFFFF)) ), fmt, ap);
    
# 86 "../test/p_test.c" 3 4
   __builtin_va_end(
# 86 "../test/p_test.c"
   ap
# 86 "../test/p_test.c" 3 4
...
# 117 "../test/p_test.c"
            ...
            opensslv = provname = greeting = 
# 122 "../test/p_test.c" 3 4
                                            ((void *)0)
# 122 "../test/p_test.c"
                                                ;
            ...
            EVP_MD *md4 = EVP_MD_fetch(ctx->libctx, "MD4", 
# 152 "../test/p_test.c" 3 4
                                                          ((void *)0)
# 152 "../test/p_test.c"
                                                              );
            ...
            if (deflt == 
# 163 "../test/p_test.c" 3 4
                        ((void *)0)
                    
# 164 "../test/p_test.c"
                   || !OSSL_PROVIDER_available(ctx->libctx, "default")) {

                p_set_error(57, 3, ctx->thisfile, 166,
                            ctx->thisfunc, 
# 167 "../test/p_test.c" 3 4
                                          ((void *)0)
# 167 "../test/p_test.c"
                                              );
                ok = 0;
            ...
            if (ok
                    ...
                    && md4 != 
# 182 "../test/p_test.c" 3 4
                             ((void *)0)
                    
# 183 "../test/p_test.c"
                   && mdctx != 
# 183 "../test/p_test.c" 3 4
                               ((void *)0)
# 183 "../test/p_test.c"
                                   ) {
                if (EVP_DigestInit_ex(mdctx, md4, 
# 184 "../test/p_test.c" 3 4
                                                 ((void *)0)
# 184 "../test/p_test.c"
                                                     )
                        && EVP_DigestUpdate(mdctx, (const unsigned char *)msg,
                                            strlen(msg))
                        && EVP_DigestFinal(mdctx, out, 
# 187 "../test/p_test.c" 3 4
                                                      ((void *)0)
# 187 "../test/p_test.c"
                                                          ))
                    digestsuccess = 1;
            ...
            stopsuccess = EVP_set_default_properties(ctx->libctx, 
# 208 "../test/p_test.c" 3 4
                                                                 ((void *)0)
# 208 "../test/p_test.c"
                                                                     );
...
static const OSSL_DISPATCH p_test_table[] = {
    { 1025, (void (*)(void))p_gettable_params },
    { 1026, (void (*)(void))p_get_params },
    { 1029,
        (void (*)(void))p_get_reason_strings},
    { 1024, (void (*)(void))p_teardown },
    { 1027, (void (*)(void))p_query },
    { 0, 
# 248 "../test/p_test.c" 3 4
   ((void *)0) 
# 248 "../test/p_test.c"
   }
};

int p_test_init(const OSSL_CORE_HANDLE *handle,
...
# 295 "../test/p_test.c"
    ...
    if (ctx == 
# 296 "../test/p_test.c" 3 4
              ((void *)0)
# 296 "../test/p_test.c"
                  )
        return 0;
    ctx->thisfile = strdup("../test/p_test.c");
    ctx->thisfunc = strdup(__func__);
    ctx->handle = handle;


    ctx->libctx = OSSL_LIB_CTX_new_child(handle, oin);
    if (ctx->libctx == 
# 304 "../test/p_test.c" 3 4
                      ((void *)0)
# 304 "../test/p_test.c"
                          ) {

        p_set_error(57, 2, ctx->thisfile, 306, ctx->thisfunc,
                    
# 307 "../test/p_test.c" 3 4
                   ((void *)0)
# 307 "../test/p_test.c"
                       );
        p_teardown(ctx);
    ...
    {
        EVP_MD *sha256 = EVP_MD_fetch(ctx->libctx, "SHA2-256", 
# 316 "../test/p_test.c" 3 4
                                                              ((void *)0)
# 316 "../test/p_test.c"
                                                                  );
        if (sha256 != 
# 317 "../test/p_test.c" 3 4
                     ((void *)0)
# 317 "../test/p_test.c"
                         ) {
            EVP_MD_free(sha256);
    ...
    p_set_error(57, 1, ctx->thisfile, 329, ctx->thisfunc, 
# 329 "../test/p_test.c" 3 4
                                                                            ((void *)0)
# 329 "../test/p_test.c"
                                                                                );
