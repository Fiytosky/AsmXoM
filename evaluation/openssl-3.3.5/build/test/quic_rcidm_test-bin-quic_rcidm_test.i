# 0 "../test/quic_rcidm_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_rcidm_test.c"
# 10 "../test/quic_rcidm_test.c"
# 1 "../include/internal/quic_rcidm.h" 1
# 12 "../include/internal/quic_rcidm.h"
...
# 15 "../include/internal/quic_rcidm.h" 2
...
# 16 "../include/internal/quic_rcidm.h" 2
...
# 17 "../include/internal/quic_rcidm.h" 2
...
# 18 "../include/internal/quic_rcidm.h" 2
# 40 "../include/internal/quic_rcidm.h"
...
# 103 "../include/internal/quic_rcidm.h"
...
# 141 "../include/internal/quic_rcidm.h"
...
# 159 "../include/internal/quic_rcidm.h"
...
# 30 "../test/quic_rcidm_test.c" 3 4
                               ((void *)0)
# 30 "../test/quic_rcidm_test.c"
                                   ;
    ...
    odcid = ((idx == 2) ? 
# 41 "../test/quic_rcidm_test.c" 3 4
                         ((void *)0) 
# 41 "../test/quic_rcidm_test.c"
                              : &cid8_1);
    if (!test_ptr("../test/quic_rcidm_test.c", 42, "rcidm = ossl_quic_rcidm_new(odcid)", rcidm = ossl_quic_rcidm_new(odcid)))
        goto err;

    if (idx != 2) {
        if (
            !test_true("../test/quic_rcidm_test.c", 47, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
            || !test_false("../test/quic_rcidm_test.c", 48, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)) != 0)
            || !test_true("../test/quic_rcidm_test.c", 49, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)

            || !test_true("../test/quic_rcidm_test.c", 51, "ossl_quic_conn_id_eq(&dcid_out, &cid8_1)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_1)) != 0)
            || !test_size_t_eq("../test/quic_rcidm_test.c", 52, "ossl_quic_rcidm_get_num_active(rcidm)", "0", ossl_quic_rcidm_get_num_active(rcidm), 0))
            goto err;
    } else {
        if (!test_false("../test/quic_rcidm_test.c", 55, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
            || !test_size_t_eq("../test/quic_rcidm_test.c", 56, "ossl_quic_rcidm_get_num_active(rcidm)", "0", ossl_quic_rcidm_get_num_active(rcidm), 0))
            goto err;
    }

    if (idx == 1) {
        if (!test_true("../test/quic_rcidm_test.c", 61, "ossl_quic_rcidm_add_from_server_retry(rcidm, &cid8_5)", (ossl_quic_rcidm_add_from_server_retry(rcidm, &cid8_5)) != 0)
            || !test_true("../test/quic_rcidm_test.c", 62, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
            || !test_false("../test/quic_rcidm_test.c", 63, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)) != 0)
            || !test_true("../test/quic_rcidm_test.c", 64, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)

            || !test_true("../test/quic_rcidm_test.c", 66, "ossl_quic_conn_id_eq(&dcid_out, &cid8_5)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_5)) != 0)
            || !test_size_t_eq("../test/quic_rcidm_test.c", 67, "ossl_quic_rcidm_get_num_active(rcidm)", "0", ossl_quic_rcidm_get_num_active(rcidm), 0))
            goto err;
    }

    if (!test_true("../test/quic_rcidm_test.c", 71, "ossl_quic_rcidm_add_from_initial(rcidm, &cid8_2)", (ossl_quic_rcidm_add_from_initial(rcidm, &cid8_2)) != 0)

        || !test_size_t_eq("../test/quic_rcidm_test.c", 73, "ossl_quic_rcidm_get_num_active(rcidm)", "1", ossl_quic_rcidm_get_num_active(rcidm), 1)
        || !test_true("../test/quic_rcidm_test.c", 74, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
        || !test_false("../test/quic_rcidm_test.c", 75, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 76, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 77, "ossl_quic_conn_id_eq(&dcid_out, &cid8_2)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_2)) != 0)

        || !test_true("../test/quic_rcidm_test.c", 79, "ossl_quic_rcidm_add_from_ncid(rcidm, &ncid_frame_1)", (ossl_quic_rcidm_add_from_ncid(rcidm, &ncid_frame_1)) != 0)
        || !test_size_t_eq("../test/quic_rcidm_test.c", 80, "ossl_quic_rcidm_get_num_active(rcidm)", "2", ossl_quic_rcidm_get_num_active(rcidm), 2)

        || !test_false("../test/quic_rcidm_test.c", 82, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 83, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 84, "ossl_quic_conn_id_eq(&dcid_out, &cid8_2)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_2)) != 0)

        || !test_true("../test/quic_rcidm_test.c", 86, "ossl_quic_rcidm_add_from_ncid(rcidm, &ncid_frame_2)", (ossl_quic_rcidm_add_from_ncid(rcidm, &ncid_frame_2)) != 0)
        || !test_size_t_eq("../test/quic_rcidm_test.c", 87, "ossl_quic_rcidm_get_num_active(rcidm)", "3", ossl_quic_rcidm_get_num_active(rcidm), 3)
        || !test_size_t_eq("../test/quic_rcidm_test.c", 88, "ossl_quic_rcidm_get_num_retiring(rcidm)", "0", ossl_quic_rcidm_get_num_retiring(rcidm), 0)
        || !test_false("../test/quic_rcidm_test.c", 89, "ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)", (ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)) != 0)

        || !test_false("../test/quic_rcidm_test.c", 91, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 0)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 92, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 93, "ossl_quic_conn_id_eq(&dcid_out, &cid8_2)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_2)) != 0))
        goto err;

    ossl_quic_rcidm_on_handshake_complete(rcidm);

    if (!test_true("../test/quic_rcidm_test.c", 98, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
        || !test_false("../test/quic_rcidm_test.c", 99, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 100, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 101, "ossl_quic_conn_id_eq(&dcid_out, &cid8_3)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_3)) != 0)
        || !test_size_t_eq("../test/quic_rcidm_test.c", 102, "ossl_quic_rcidm_get_num_retiring(rcidm)", "1", ossl_quic_rcidm_get_num_retiring(rcidm), 1)
        || !test_true("../test/quic_rcidm_test.c", 103, "ossl_quic_rcidm_peek_retire_seq_num(rcidm, &seq_num_out)", (ossl_quic_rcidm_peek_retire_seq_num(rcidm, &seq_num_out)) != 0)
        || !test_uint64_t_eq("../test/quic_rcidm_test.c", 104, "seq_num_out", "0", seq_num_out, 0))
        goto err;

    ossl_quic_rcidm_request_roll(rcidm);

    if (!test_true("../test/quic_rcidm_test.c", 109, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
        || !test_false("../test/quic_rcidm_test.c", 110, "ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)", (ossl_quic_rcidm_get_preferred_tx_dcid_changed(rcidm, 1)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 111, "ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)", (ossl_quic_rcidm_get_preferred_tx_dcid(rcidm, &dcid_out)) != 0)
        || !test_true("../test/quic_rcidm_test.c", 112, "ossl_quic_conn_id_eq(&dcid_out, &cid8_4)", (ossl_quic_conn_id_eq(&dcid_out, &cid8_4)) != 0)
        || !test_size_t_eq("../test/quic_rcidm_test.c", 113, "ossl_quic_rcidm_get_num_retiring(rcidm)", "2", ossl_quic_rcidm_get_num_retiring(rcidm), 2)
        || !test_true("../test/quic_rcidm_test.c", 114, "ossl_quic_rcidm_peek_retire_seq_num(rcidm, &seq_num_out)", (ossl_quic_rcidm_peek_retire_seq_num(rcidm, &seq_num_out)) != 0)
        || !test_uint64_t_eq("../test/quic_rcidm_test.c", 115, "seq_num_out", "0", seq_num_out, 0)
        || !test_true("../test/quic_rcidm_test.c", 116, "ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)", (ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)) != 0)
        || !test_uint64_t_eq("../test/quic_rcidm_test.c", 117, "seq_num_out", "0", seq_num_out, 0)
        || !test_true("../test/quic_rcidm_test.c", 118, "ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)", (ossl_quic_rcidm_pop_retire_seq_num(rcidm, &seq_num_out)) != 0)
        || !test_uint64_t_eq("../test/quic_rcidm_test.c", 119, "seq_num_out", "2", seq_num_out, 2))
        goto err;
