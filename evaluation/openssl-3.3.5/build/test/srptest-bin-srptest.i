                   ...
                   const char *server_pass)
{
    int ret = 0;
    BIGNUM *s = 
# 33 "../test/srptest.c" 3 4
               ((void *)0)
# 33 "../test/srptest.c"
                   ;
    BIGNUM *v = 
# 34 "../test/srptest.c" 3 4
               ((void *)0)
# 34 "../test/srptest.c"
                   ;
    BIGNUM *a = 
# 35 "../test/srptest.c" 3 4
               ((void *)0)
# 35 "../test/srptest.c"
                   ;
    BIGNUM *b = 
# 36 "../test/srptest.c" 3 4
               ((void *)0)
# 36 "../test/srptest.c"
                   ;
    BIGNUM *u = 
# 37 "../test/srptest.c" 3 4
               ((void *)0)
# 37 "../test/srptest.c"
                   ;
    BIGNUM *x = 
# 38 "../test/srptest.c" 3 4
               ((void *)0)
# 38 "../test/srptest.c"
                   ;
    BIGNUM *Apub = 
# 39 "../test/srptest.c" 3 4
                  ((void *)0)
# 39 "../test/srptest.c"
                      ;
    BIGNUM *Bpub = 
# 40 "../test/srptest.c" 3 4
                  ((void *)0)
# 40 "../test/srptest.c"
                      ;
    BIGNUM *Kclient = 
# 41 "../test/srptest.c" 3 4
                     ((void *)0)
# 41 "../test/srptest.c"
                         ;
    BIGNUM *Kserver = 
# 42 "../test/srptest.c" 3 4
                     ((void *)0)
# 42 "../test/srptest.c"
                         ;
    unsigned char rand_tmp[32];

    const SRP_gN *GN;

    if (!test_ptr("../test/srptest.c", 47, "GN = SRP_get_default_gN(\"1024\")", GN = SRP_get_default_gN("1024")))
        return 0;


    if (!test_true("../test/srptest.c", 51, "SRP_create_verifier_BN(username, server_pass, &s, &v, GN->N, GN->g)", (SRP_create_verifier_BN(username, server_pass, &s, &v, GN->N, GN->g)) != 0)
                                                                )
        goto end;
...
# 62 "../test/srptest.c" 3 4
                                             ((void *)0)
# 62 "../test/srptest.c"
                                                 );
    if (!test_BN_ne_zero("../test/srptest.c", 63, "b", b))
        goto end;
    ...
    if (!test_true("../test/srptest.c", 71, "SRP_Verify_B_mod_N(Bpub, GN->N)", (SRP_Verify_B_mod_N(Bpub, GN->N)) != 0))
        goto end;


    RAND_bytes(rand_tmp, sizeof(rand_tmp));
    a = BN_bin2bn(rand_tmp, sizeof(rand_tmp), 
# 76 "../test/srptest.c" 3 4
                                             ((void *)0)
# 76 "../test/srptest.c"
                                                 );
    if (!test_BN_ne_zero("../test/srptest.c", 77, "a", a))
        goto end;
    ...
    if (!test_true("../test/srptest.c", 85, "SRP_Verify_A_mod_N(Apub, GN->N)", (SRP_Verify_A_mod_N(Apub, GN->N)) != 0))
        goto end;
    ...
    if (!test_BN_eq("../test/srptest.c", 100, "Kclient", "Kserver", Kclient, Kserver))
        goto end;
...
{
    BIGNUM *tmp = 
# 122 "../test/srptest.c" 3 4
                 ((void *)0)
# 122 "../test/srptest.c"
                     ;
    int r;

    if (!test_true("../test/srptest.c", 125, "BN_hex2bn(&tmp, hexbn)", (BN_hex2bn(&tmp, hexbn)) != 0))
        return 0;

    if (BN_cmp(bn, tmp) != 0)
        test_error("../test/srptest.c", 129, "unexpected %s value", name);
    r = test_BN_eq("../test/srptest.c", 130, "bn", "tmp", bn, tmp);
    BN_free(tmp);
    return r;
}
...
static int run_srp_kat(void)
{
    int ret = 0;
    BIGNUM *s = 
# 139 "../test/srptest.c" 3 4
               ((void *)0)
# 139 "../test/srptest.c"
                   ;
    BIGNUM *v = 
# 140 "../test/srptest.c" 3 4
               ((void *)0)
# 140 "../test/srptest.c"
                   ;
    BIGNUM *a = 
# 141 "../test/srptest.c" 3 4
               ((void *)0)
# 141 "../test/srptest.c"
                   ;
    BIGNUM *b = 
# 142 "../test/srptest.c" 3 4
               ((void *)0)
# 142 "../test/srptest.c"
                   ;
    BIGNUM *u = 
# 143 "../test/srptest.c" 3 4
               ((void *)0)
# 143 "../test/srptest.c"
                   ;
    BIGNUM *x = 
# 144 "../test/srptest.c" 3 4
               ((void *)0)
# 144 "../test/srptest.c"
                   ;
    BIGNUM *Apub = 
# 145 "../test/srptest.c" 3 4
                  ((void *)0)
# 145 "../test/srptest.c"
                      ;
    BIGNUM *Bpub = 
# 146 "../test/srptest.c" 3 4
                  ((void *)0)
# 146 "../test/srptest.c"
                      ;
    BIGNUM *Kclient = 
# 147 "../test/srptest.c" 3 4
                     ((void *)0)
# 147 "../test/srptest.c"
                         ;
    BIGNUM *Kserver = 
# 148 "../test/srptest.c" 3 4
                     ((void *)0)
# 148 "../test/srptest.c"
                         ;
    ...
    if (!test_ptr("../test/srptest.c", 152, "GN = SRP_get_default_gN(\"1024\")", GN = SRP_get_default_gN("1024")))
        goto err;
    BN_hex2bn(&s, "BEB25379D1A8581EB5A727673A2441EE");

    if (!test_true("../test/srptest.c", 156, "SRP_create_verifier_BN(\"alice\", \"password123\", &s, &v, GN->N, GN->g)", (SRP_create_verifier_BN("alice", "password123", &s, &v, GN->N, GN->g)) != 0)
                                                 )
        goto err;

    test_info("../test/srptest.c", 160, "checking v");
    if (!test_true("../test/srptest.c", 161, "check_bn(\"v\", v, \"7E273DE8696FFC4F4E337D05B4B375BEB0DDE1569E8FA00A9886D812\" \"9BADA1F1822223CA1A605B530E379BA4729FDC59F105B4787E5186F5\" \"C671085A1447B52A48CF1970B4FB6F8400BBF4CEBFBB168152E08AB5\" \"EA53D15C1AFF87B2B9DA6E04E058AD51CC72BFC9033B564E26480D78\" \"E955A5E29E7AB245DB2BE315E2099AFB\")", (check_bn("v", v, "7E273DE8696FFC4F4E337D05B4B375BEB0DDE1569E8FA00A9886D812" "9BADA1F1822223CA1A605B530E379BA4729FDC59F105B4787E5186F5" "C671085A1447B52A48CF1970B4FB6F8400BBF4CEBFBB168152E08AB5" "EA53D15C1AFF87B2B9DA6E04E058AD51CC72BFC9033B564E26480D78" "E955A5E29E7AB245DB2BE315E2099AFB")) != 0)
    ...
    Bpub = SRP_Calc_B(b, GN->N, GN->g, v);
    if (!test_true("../test/srptest.c", 176, "SRP_Verify_B_mod_N(Bpub, GN->N)", (SRP_Verify_B_mod_N(Bpub, GN->N)) != 0))
        goto err;

    test_info("../test/srptest.c", 179, "checking B");
    if (!test_true("../test/srptest.c", 180, "check_bn(\"B\", Bpub, \"BD0C61512C692C0CB6D041FA01BB152D4916A1E77AF46AE105393011\" \"BAF38964DC46A0670DD125B95A981652236F99D9B681CBF87837EC99\" \"6C6DA04453728610D0C6DDB58B318885D7D82C7F8DEB75CE7BD4FBAA\" \"37089E6F9C6059F388838E7A00030B331EB76840910440B1B27AAEAE\" \"EB4012B7D7665238A8E3FB004B117B58\")", (check_bn("B", Bpub, "BD0C61512C692C0CB6D041FA01BB152D4916A1E77AF46AE105393011" "BAF38964DC46A0670DD125B95A981652236F99D9B681CBF87837EC99" "6C6DA04453728610D0C6DDB58B318885D7D82C7F8DEB75CE7BD4FBAA" "37089E6F9C6059F388838E7A00030B331EB76840910440B1B27AAEAE" "EB4012B7D7665238A8E3FB004B117B58")) != 0)
    ...
    Apub = SRP_Calc_A(a, GN->N, GN->g);
    if (!test_true("../test/srptest.c", 195, "SRP_Verify_A_mod_N(Apub, GN->N)", (SRP_Verify_A_mod_N(Apub, GN->N)) != 0))
        goto err;

    test_info("../test/srptest.c", 198, "checking A");
    if (!test_true("../test/srptest.c", 199, "check_bn(\"A\", Apub, \"61D5E490F6F1B79547B0704C436F523DD0E560F0C64115BB72557EC4\" \"4352E8903211C04692272D8B2D1A5358A2CF1B6E0BFCF99F921530EC\" \"8E39356179EAE45E42BA92AEACED825171E1E8B9AF6D9C03E1327F44\" \"BE087EF06530E69F66615261EEF54073CA11CF5858F0EDFDFE15EFEA\" \"B349EF5D76988A3672FAC47B0769447B\")", (check_bn("A", Apub, "61D5E490F6F1B79547B0704C436F523DD0E560F0C64115BB72557EC4" "4352E8903211C04692272D8B2D1A5358A2CF1B6E0BFCF99F921530EC" "8E39356179EAE45E42BA92AEACED825171E1E8B9AF6D9C03E1327F44" "BE087EF06530E69F66615261EEF54073CA11CF5858F0EDFDFE15EFEA" "B349EF5D76988A3672FAC47B0769447B")) != 0)
    ...
    if (!test_true("../test/srptest.c", 211, "check_bn(\"u\", u, \"CE38B9593487DA98554ED47D70A7AE5F462EF019\")", (check_bn("u", u, "CE38B9593487DA98554ED47D70A7AE5F462EF019")) != 0)
                                                                )
        goto err;
    ...
    Kserver = SRP_Calc_server_key(Apub, v, u, b, GN->N);
    test_info("../test/srptest.c", 230, "checking server's key");
    if (!test_true("../test/srptest.c", 231, "check_bn(\"Server's key\", Kserver, \"B0DC82BABCF30674AE450C0287745E7990A3381F63B387AAF271A10D\" \"233861E359B48220F7C4693C9AE12B0A6F67809F0876E2D013800D6C\" \"41BB59B6D5979B5C00A172B4A2A5903A0BDCAF8A709585EB2AFAFA8F\" \"3499B200210DCC1F10EB33943CD67FC88A2F39A4BE5BEC4EC0A3212D\" \"C346D7E474B29EDE8A469FFECA686E5A\")", (check_bn("Server's key", Kserver, "B0DC82BABCF30674AE450C0287745E7990A3381F63B387AAF271A10D" "233861E359B48220F7C4693C9AE12B0A6F67809F0876E2D013800D6C" "41BB59B6D5979B5C00A172B4A2A5903A0BDCAF8A709585EB2AFAFA8F" "3499B200210DCC1F10EB33943CD67FC88A2F39A4BE5BEC4EC0A3212D" "C346D7E474B29EDE8A469FFECA686E5A")) != 0)
...
static int run_srp_tests(void)
{
    ...
    test_info("../test/srptest.c", 260, "run_srp: expecting a mismatch");
    if (!test_false("../test/srptest.c", 261, "run_srp(\"alice\", \"password1\", \"password2\")", (run_srp("alice", "password1", "password2")) != 0))
        return 0;


    test_info("../test/srptest.c", 265, "run_srp: expecting a match");
    if (!test_true("../test/srptest.c", 266, "run_srp(\"alice\", \"password\", \"password\")", (run_srp("alice", "password", "password")) != 0))
        return 0;
