# 0 "../test/evp_xof_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_xof_test.c"
# 10 "../test/evp_xof_test.c"
...
int RAND_poll(void);
# 12 "../test/evp_xof_test.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../test/evp_xof_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
{
    EVP_MD_CTX *ctx = 
# 160 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 160 "../test/evp_xof_test.c"
                         ;
    EVP_MD *md = 
# 161 "../test/evp_xof_test.c" 3 4
                ((void *)0)
# 161 "../test/evp_xof_test.c"
                    ;

    if (!test_ptr("../test/evp_xof_test.c", 163, "md = EVP_MD_fetch(NULL, name, NULL)", md = EVP_MD_fetch(
# 163 "../test/evp_xof_test.c" 3 4
        ((void *)0)
# 163 "../test/evp_xof_test.c"
        , name, 
# 163 "../test/evp_xof_test.c" 3 4
        ((void *)0)
# 163 "../test/evp_xof_test.c"
        ...
        return 
# 164 "../test/evp_xof_test.c" 3 4
              ((void *)0)
# 164 "../test/evp_xof_test.c"
                  ;

    if (!test_ptr("../test/evp_xof_test.c", 166, "ctx = EVP_MD_CTX_new()", ctx = EVP_MD_CTX_new()))
        goto err;
    if (!test_true("../test/evp_xof_test.c", 168, "EVP_DigestInit_ex2(ctx, md, NULL)", (EVP_DigestInit_ex2(ctx, md, 
# 168 "../test/evp_xof_test.c" 3 4
        ((void *)0)
# 168 "../test/evp_xof_test.c"
        )) != 0))
        goto err;
    EVP_MD_free(md);
    return ctx;
err:
    ...
    EVP_MD_CTX_free(ctx);
    return 
# 175 "../test/evp_xof_test.c" 3 4
          ((void *)0)
# 175 "../test/evp_xof_test.c"
              ;
}
...
static int shake_kat_test(void)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 181 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 181 "../test/evp_xof_test.c"
                         ;
    unsigned char out[sizeof(shake256_output)];

    if (!test_ptr("../test/evp_xof_test.c", 184, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256")))
        return 0;
    if (!test_true("../test/evp_xof_test.c", 186, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", (EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))) != 0)

        || !test_true("../test/evp_xof_test.c", 188, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0)
        || !test_mem_eq("../test/evp_xof_test.c", 189, "out", "shake256_output", out, sizeof(out), shake256_output, sizeof(shake256_output))


        || !test_false("../test/evp_xof_test.c", 192, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0)

        || !test_false("../test/evp_xof_test.c", 194, "EVP_DigestSqueeze(ctx, out, sizeof(out))", (EVP_DigestSqueeze(ctx, out, sizeof(out))) != 0))
        goto err;
    ret = 1;
err:
    EVP_MD_CTX_free(ctx);
...
static int shake_kat_digestfinal_test(void)
{
    ...
    EVP_MD_CTX *ctx = 
# 206 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 206 "../test/evp_xof_test.c"
                         ;
    unsigned char out[sizeof(shake256_output)];

    if (!test_ptr("../test/evp_xof_test.c", 209, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256")))
        return 0;
    if (!test_true("../test/evp_xof_test.c", 211, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", (EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))) != 0)

        || !test_true("../test/evp_xof_test.c", 213, "EVP_DigestFinal(ctx, out, &digest_length)", (EVP_DigestFinal(ctx, out, &digest_length)) != 0)
        || !test_uint_eq("../test/evp_xof_test.c", 214, "digest_length", "32", digest_length, 32)
        || !test_mem_eq("../test/evp_xof_test.c", 215, "out", "shake256_output", out, digest_length, shake256_output, digest_length)

        || !test_false("../test/evp_xof_test.c", 217, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0))
        goto err;
    ret = 1;
err:
    EVP_MD_CTX_free(ctx);
...
static int shake_kat_digestfinal_xoflen_test(void)
{
    ...
    unsigned int digest_length = 0;
    EVP_MD_CTX *ctx = 
# 233 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 233 "../test/evp_xof_test.c"
                         ;
    unsigned char out[sizeof(shake256_output)];
    OSSL_PARAM params[2];
    size_t sz = 12;

    if (!test_ptr("../test/evp_xof_test.c", 238, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256")))
        return 0;
    ...
    if (!test_int_eq("../test/evp_xof_test.c", 245, "EVP_MD_CTX_set_params(ctx, params)", "1", EVP_MD_CTX_set_params(ctx, params), 1)
        || !test_true("../test/evp_xof_test.c", 246, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", (EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))) != 0)

        || !test_true("../test/evp_xof_test.c", 248, "EVP_DigestFinal(ctx, out, &digest_length)", (EVP_DigestFinal(ctx, out, &digest_length)) != 0)
        || !test_uint_eq("../test/evp_xof_test.c", 249, "digest_length", "(unsigned int)sz", digest_length, (unsigned int)sz)
        || !test_mem_eq("../test/evp_xof_test.c", 250, "out", "shake256_output", out, digest_length, shake256_output, digest_length)

        || !test_uchar_eq("../test/evp_xof_test.c", 252, "out[digest_length]", "0", out[digest_length], 0))
        goto err;
    ret = 1;
err:
    EVP_MD_CTX_free(ctx);
...
static int shake_absorb_test(void)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 267 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 267 "../test/evp_xof_test.c"
                         ;
    unsigned char out[sizeof(shake256_largemsg_output)];
    size_t total = sizeof(shake256_largemsg_input);
    size_t i, stride, sz;

    if (!test_ptr("../test/evp_xof_test.c", 272, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256")))
        return 0;
    ...
    for (stride = 1; stride < total; ++stride) {
        ...
        for (i = 0; i < total; i += sz) {
            ...
            if ((i + sz) > total)
                sz = total - i;
            if (!test_true("../test/evp_xof_test.c", 281, "EVP_DigestUpdate(ctx, shake256_largemsg_input + i, sz)", (EVP_DigestUpdate(ctx, shake256_largemsg_input + i, sz)) != 0)
                                                )
                goto err;
        }
        if (!test_true("../test/evp_xof_test.c", 285, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0)
            || !test_mem_eq("../test/evp_xof_test.c", 286, "out", "shake256_largemsg_output", out, sizeof(out), shake256_largemsg_output, sizeof(shake256_largemsg_output))

                                                             )
            goto err;
        if (!test_true("../test/evp_xof_test.c", 290, "EVP_DigestInit_ex2(ctx, NULL, NULL)", (EVP_DigestInit_ex2(ctx, 
# 290 "../test/evp_xof_test.c" 3 4
            ((void *)0)
# 290 "../test/evp_xof_test.c"
            , 
# 290 "../test/evp_xof_test.c" 3 4
            ((void *)0)
# 290 "../test/evp_xof_test.c"
                                 ...
                                 size_t expected_outlen)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 354 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 354 "../test/evp_xof_test.c"
                         ;
    unsigned char *out = 
# 355 "../test/evp_xof_test.c" 3 4
                        ((void *)0)
# 355 "../test/evp_xof_test.c"
                            ;
    size_t i = 0, sz = stride_tests[tst].startsz;

    if (!test_ptr("../test/evp_xof_test.c", 358, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256")))
        return 0;
    if (!test_ptr("../test/evp_xof_test.c", 360, "out = OPENSSL_malloc(expected_outlen)", out = CRYPTO_malloc(expected_outlen, "../test/evp_xof_test.c", 360)))
        goto err;
    if (!test_true("../test/evp_xof_test.c", 362, "EVP_DigestUpdate(ctx, in, inlen)", (EVP_DigestUpdate(ctx, in, inlen)) != 0))
        goto err;

    while (i < expected_outlen) {
        if ((i + sz) > expected_outlen)
            sz = expected_outlen - i;
        if (!test_true("../test/evp_xof_test.c", 368, "EVP_DigestSqueeze(ctx, out + i, sz)", (EVP_DigestSqueeze(ctx, out + i, sz)) != 0))
            goto err;
        i += sz;
        sz = stride_tests[tst].incsz;
    }
    if (!test_mem_eq("../test/evp_xof_test.c", 373, "out", "expected_out", out, expected_outlen, expected_out, expected_outlen))
        goto err;
    ret = 1;
err:
    CRYPTO_free(out, "../test/evp_xof_test.c", 377);
    EVP_MD_CTX_free(ctx);
    return ret;
}
...
static int shake_squeeze_large_test(int tst)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 397 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 397 "../test/evp_xof_test.c"
                         ;
    unsigned char msg[16];
    unsigned char out[2000];

    if (!test_int_gt("../test/evp_xof_test.c", 401, "RAND_bytes(msg, sizeof(msg))", "0", RAND_bytes(msg, sizeof(msg)), 0)
        || !test_ptr("../test/evp_xof_test.c", 402, "ctx = shake_setup(\"SHAKE256\")", ctx = shake_setup("SHAKE256"))
        || !test_true("../test/evp_xof_test.c", 403, "EVP_DigestUpdate(ctx, msg, sizeof(msg))", (EVP_DigestUpdate(ctx, msg, sizeof(msg))) != 0)
        || !test_true("../test/evp_xof_test.c", 404, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0))
        goto err;
                                     ...
                                     size_t expected_outlen)
{
    int ret = 0;
    EVP_MD_CTX *cur, *ctx = 
# 424 "../test/evp_xof_test.c" 3 4
                           ((void *)0)
# 424 "../test/evp_xof_test.c"
                               , *dupctx = 
# 424 "../test/evp_xof_test.c" 3 4
                                           ((void *)0)
# 424 "../test/evp_xof_test.c"
                                               ;
    unsigned char *out = 
# 425 "../test/evp_xof_test.c" 3 4
                        ((void *)0)
# 425 "../test/evp_xof_test.c"
                            ;
    size_t i = 0, sz = 10;
    size_t dupoffset = dupoffset_tests[tst];

    if (!test_ptr("../test/evp_xof_test.c", 429, "ctx = shake_setup(alg)", ctx = shake_setup(alg)))
        return 0;
    cur = ctx;
    if (!test_ptr("../test/evp_xof_test.c", 432, "out = OPENSSL_malloc(expected_outlen)", out = CRYPTO_malloc(expected_outlen, "../test/evp_xof_test.c", 432)))
        goto err;
    if (!test_true("../test/evp_xof_test.c", 434, "EVP_DigestUpdate(ctx, in, inlen)", (EVP_DigestUpdate(ctx, in, inlen)) != 0))
        goto err;

    while (i < expected_outlen) {
        if ((i + sz) > expected_outlen)
            sz = expected_outlen - i;
        if (!test_true("../test/evp_xof_test.c", 440, "EVP_DigestSqueeze(cur, out + i, sz)", (EVP_DigestSqueeze(cur, out + i, sz)) != 0))
            goto err;
        i += sz;

        if (dupctx == 
# 444 "../test/evp_xof_test.c" 3 4
                     ((void *)0) 
# 444 "../test/evp_xof_test.c"
                          && i >= dupoffset) {
            if (!test_ptr("../test/evp_xof_test.c", 445, "dupctx = EVP_MD_CTX_dup(ctx)", dupctx = EVP_MD_CTX_dup(ctx)))
                goto err;
            cur = dupctx;
        }
    }
    if (!test_mem_eq("../test/evp_xof_test.c", 450, "out", "expected_out", out, expected_outlen, expected_out, expected_outlen))
        goto err;
    ret = 1;
err:
    CRYPTO_free(out, "../test/evp_xof_test.c", 454);
    EVP_MD_CTX_free(ctx);
...
static int shake_squeeze_dup_test(int tst)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 464 "../test/evp_xof_test.c" 3 4
                     ((void *)0)
# 464 "../test/evp_xof_test.c"
                         ;
    unsigned char msg[16];
    unsigned char out[1000];
    const char *alg = "SHAKE128";

    if (!test_int_gt("../test/evp_xof_test.c", 469, "RAND_bytes(msg, sizeof(msg))", "0", RAND_bytes(msg, sizeof(msg)), 0)
        || !test_ptr("../test/evp_xof_test.c", 470, "ctx = shake_setup(alg)", ctx = shake_setup(alg))
        || !test_true("../test/evp_xof_test.c", 471, "EVP_DigestUpdate(ctx, msg, sizeof(msg))", (EVP_DigestUpdate(ctx, msg, sizeof(msg))) != 0)
        || !test_true("../test/evp_xof_test.c", 472, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", (EVP_DigestFinalXOF(ctx, out, sizeof(out))) != 0))
        goto err;
...
int setup_tests(void)
{
    ...
    add_all_tests("shake_squeeze_kat_test", shake_squeeze_kat_test, (sizeof(stride_tests)/sizeof((stride_tests)[0])), 1);
    add_all_tests("shake_squeeze_large_test", shake_squeeze_large_test, (sizeof(stride_tests)/sizeof((stride_tests)[0])), 1);
    add_all_tests("shake_squeeze_dup_test", shake_squeeze_dup_test, (sizeof(dupoffset_tests)/sizeof((dupoffset_tests)[0])), 1);
    return 1;
}
