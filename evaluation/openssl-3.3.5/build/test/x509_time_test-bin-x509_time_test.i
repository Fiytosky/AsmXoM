# 0 "../test/x509_time_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/x509_time_test.c"
# 12 "../test/x509_time_test.c"
...
static TESTDATA_FORMAT x509_format_tests[] = {

    {
        ...
        "20170217180105Z", 0, 1, -1, 
# 56 "../test/x509_time_test.c" 3 4
                                    ((void *)0)
# 56 "../test/x509_time_test.c"
                                        ,
    },
    {

        "20170229180105Z", 0, 0, -1, 
# 60 "../test/x509_time_test.c" 3 4
                                    ((void *)0)
# 60 "../test/x509_time_test.c"
                                        ,
    },
    {

        "20160229180105Z", 0, 1, -1, 
# 64 "../test/x509_time_test.c" 3 4
                                    ((void *)0)
# 64 "../test/x509_time_test.c"
                                        ,
    },
    {

        "201702171801Z", 0, 0, -1, 
# 68 "../test/x509_time_test.c" 3 4
                                  ((void *)0)
# 68 "../test/x509_time_test.c"
                                      ,
    },
    {

        "20170217180105.001Z", 0, 0, -1, 
# 72 "../test/x509_time_test.c" 3 4
                                        ((void *)0)
# 72 "../test/x509_time_test.c"
                                            ,
    },
    {

        "20170217180105+0800", 0, 0, -1, 
# 76 "../test/x509_time_test.c" 3 4
                                        ((void *)0)
# 76 "../test/x509_time_test.c"
                                            ,
    },
    {

        "201702171801Z", 1, 0, -1, 
# 80 "../test/x509_time_test.c" 3 4
                                  ((void *)0)
# 80 "../test/x509_time_test.c"
                                      ,
    },
    {

        "20170217180105.001Z", 1, 0, -1, 
# 84 "../test/x509_time_test.c" 3 4
                                        ((void *)0)
# 84 "../test/x509_time_test.c"
                                            ,
    },
    {

        "20170217180105+0800", 1, 0, -1, 
# 88 "../test/x509_time_test.c" 3 4
                                        ((void *)0)
# 88 "../test/x509_time_test.c"
                                            ,
    },
    {

        "20170217180154Z", 1, 1, 23, "170217180154Z",
    },
    {

        "20510217180154Z", 1, 1, 24, "20510217180154Z",
    },
    {

        "19230419180154Z", 1, 1, 24, "19230419180154Z",
    },

    {

        "1702171801Z", 0, 0, -1, 
# 105 "../test/x509_time_test.c" 3 4
                                ((void *)0)
# 105 "../test/x509_time_test.c"
                                    ,
    },
    {

        "050229180101Z", 0, 0, -1, 
# 109 "../test/x509_time_test.c" 3 4
                                  ((void *)0)
# 109 "../test/x509_time_test.c"
                                      ,
    },
    {

        "040229180101Z", 0, 1, -1, 
# 113 "../test/x509_time_test.c" 3 4
                                  ((void *)0)
# 113 "../test/x509_time_test.c"
                                      ,
    },
    {

        "170217180154+0800", 0, 0, -1, 
# 117 "../test/x509_time_test.c" 3 4
                                      ((void *)0)
# 117 "../test/x509_time_test.c"
                                          ,
    },
    {

        "1702171801Z", 1, 0, -1, 
# 121 "../test/x509_time_test.c" 3 4
                                ((void *)0)
# 121 "../test/x509_time_test.c"
                                    ,
    },
    {

        "170217180154+0800", 1, 0, -1, 
# 125 "../test/x509_time_test.c" 3 4
                                      ((void *)0)
# 125 "../test/x509_time_test.c"
                                          ,
    },
    {

        "170217180154Z", 1, 1, 23, "170217180154Z",
    },
    {

        "981223180154Z", 1, 1, 23, "981223180154Z",
    },
};
...
static TESTDATA x509_cmp_tests[] = {
    ...
    },
    {
        ...
        "20170217180154.001Z", 24, 0, 0,
    },
    {

        "170217180154.001Z", 23, 0, 0,
    },
    {

        "20170217180154+0100", 24, 0, 0,
    },
    {

        "170217180154+0100", 23, 0, 0,
    },
    {

        "2017021718015400Z", 24, 0, 0,
    },
    {

        "17021718015400Z", 23, 0, 0,
    },
    {

        "2017021718015aZ", 24, 0, 0,
    },
    {

        "17021718015aZ", 23, 0, 0,
    },
    {

        "20170217180154Zlongtrailinggarbage", 24, 0, 0,
    },
    {

        "170217180154Zlongtrailinggarbage", 23, 0, 0,
    },
    {

        "20170217180154Z", 23, 0, 0,
    },
    {

        "170217180154Z", 24, 0, 0,
    },
    {

        "20170217180154Z", 4, 0, 0,
    },
};
...
static int test_x509_cmp_time(int idx)
{
    ...
    if (!test_int_eq("../test/x509_time_test.c", 268, "result", "x509_cmp_tests[idx].expected", result, x509_cmp_tests[idx].expected)) {
        test_info("../test/x509_time_test.c", 269, "test_x509_cmp_time(%d) failed: expected %d, got %d\n", idx, x509_cmp_tests[idx].expected, result)
                                                          ;
        return 0;
    }
    return 1;
...
{
    time_t now = time(
# 278 "../test/x509_time_test.c" 3 4
                     ((void *)0)
# 278 "../test/x509_time_test.c"
                         );

    ASN1_TIME *asn1_before = 
# 280 "../test/x509_time_test.c" 3 4
                            ((void *)0)
# 280 "../test/x509_time_test.c"
                                , *asn1_after = 
# 280 "../test/x509_time_test.c" 3 4
                                                ((void *)0)
# 280 "../test/x509_time_test.c"
    ...
    asn1_before = ASN1_TIME_adj(
# 283 "../test/x509_time_test.c" 3 4
                               ((void *)0)
# 283 "../test/x509_time_test.c"
                                   , now, -1, 0);
    asn1_after = ASN1_TIME_adj(
# 284 "../test/x509_time_test.c" 3 4
                              ((void *)0)
# 284 "../test/x509_time_test.c"
                                  , now, 1, 0);

    cmp_result = X509_cmp_time(asn1_before, 
# 286 "../test/x509_time_test.c" 3 4
                                            ((void *)0)
# 286 "../test/x509_time_test.c"
                                                );
    if (!test_int_eq("../test/x509_time_test.c", 287, "cmp_result", "-1", cmp_result, -1))
        failed = 1;

    cmp_result = X509_cmp_time(asn1_after, 
# 290 "../test/x509_time_test.c" 3 4
                                          ((void *)0)
# 290 "../test/x509_time_test.c"
                                              );
    if (!test_int_eq("../test/x509_time_test.c", 291, "cmp_result", "1", cmp_result, 1))
        failed = 1;
...
{
    int always_0 = vpm != 
# 305 "../test/x509_time_test.c" 3 4
                         ((void *)0)
        
# 306 "../test/x509_time_test.c"
       && (X509_VERIFY_PARAM_get_flags(vpm) & 0x2) == 0
        && (X509_VERIFY_PARAM_get_flags(vpm) & 0x200000) != 0;

    return asn1_before != 
# 309 "../test/x509_time_test.c" 3 4
                         ((void *)0) 
# 309 "../test/x509_time_test.c"
                              && asn1_mid != 
# 309 "../test/x509_time_test.c" 3 4
                                             ((void *)0) 
# 309 "../test/x509_time_test.c"
...
# 310 "../test/x509_time_test.c"
       && test_int_eq("../test/x509_time_test.c", 310, "X509_cmp_timeframe(vpm, asn1_before, asn1_after)", "0", X509_cmp_timeframe(vpm, asn1_before, asn1_after), 0)
        && test_int_eq("../test/x509_time_test.c", 311, "X509_cmp_timeframe(vpm, asn1_before, NULL)", "0", X509_cmp_timeframe(vpm, asn1_before, 
# 311 "../test/x509_time_test.c" 3 4
          ((void *)0)
# 311 "../test/x509_time_test.c"
          ), 0)
        && test_int_eq("../test/x509_time_test.c", 312, "X509_cmp_timeframe(vpm, NULL, asn1_after)", "0", X509_cmp_timeframe(vpm, 
# 312 "../test/x509_time_test.c" 3 4
          ((void *)0)
# 312 "../test/x509_time_test.c"
          , asn1_after), 0)
        && test_int_eq("../test/x509_time_test.c", 313, "X509_cmp_timeframe(vpm, NULL, NULL)", "0", X509_cmp_timeframe(vpm, 
# 313 "../test/x509_time_test.c" 3 4
          ((void *)0)
# 313 "../test/x509_time_test.c"
          , 
# 313 "../test/x509_time_test.c" 3 4
          ((void *)0)
# 313 "../test/x509_time_test.c"
          ), 0)
        && test_int_eq("../test/x509_time_test.c", 314, "X509_cmp_timeframe(vpm, asn1_after, asn1_after)", "always_0 ? 0 : -1", X509_cmp_timeframe(vpm, asn1_after, asn1_after), always_0 ? 0 : -1)

        && test_int_eq("../test/x509_time_test.c", 316, "X509_cmp_timeframe(vpm, asn1_before, asn1_before)", "always_0 ? 0 : 1", X509_cmp_timeframe(vpm, asn1_before, asn1_before), always_0 ? 0 : 1)

        && test_int_eq("../test/x509_time_test.c", 318, "X509_cmp_timeframe(vpm, asn1_after, asn1_before)", "always_0 ? 0 : 1", X509_cmp_timeframe(vpm, asn1_after, asn1_before), always_0 ? 0 : 1)
                                        ;
}
...
{
    time_t now = time(
# 324 "../test/x509_time_test.c" 3 4
                     ((void *)0)
# 324 "../test/x509_time_test.c"
                         );
    ASN1_TIME *asn1_mid = ASN1_TIME_adj(
# 325 "../test/x509_time_test.c" 3 4
                                       ((void *)0)
# 325 "../test/x509_time_test.c"
                                           , now, 0, 0);

    ASN1_TIME *asn1_before = ASN1_TIME_adj(
# 327 "../test/x509_time_test.c" 3 4
                                          ((void *)0)
# 327 "../test/x509_time_test.c"
                                              , now, -1, 0);
    ASN1_TIME *asn1_after = ASN1_TIME_adj(
# 328 "../test/x509_time_test.c" 3 4
                                         ((void *)0)
# 328 "../test/x509_time_test.c"
                                             , now, 1, 0);
    X509_VERIFY_PARAM *vpm = X509_VERIFY_PARAM_new();
    int res = 0;

    if (vpm == 
# 332 "../test/x509_time_test.c" 3 4
              ((void *)0)
# 332 "../test/x509_time_test.c"
                  )
        goto finish;
    res = test_X509_cmp_timeframe_vpm(
# 334 "../test/x509_time_test.c" 3 4
                                     ((void *)0)
# 334 "../test/x509_time_test.c"
                                         , asn1_before, asn1_mid, asn1_after)
...
{
    ASN1_TIME *t = 
# 354 "../test/x509_time_test.c" 3 4
                  ((void *)0)
# 354 "../test/x509_time_test.c"
                      ;
    int result, rv = 0;
    ...
    if (x509_format_tests[idx].set_string) {
        ...
        t = ASN1_TIME_new();
        if (t == 
# 360 "../test/x509_time_test.c" 3 4
                ((void *)0)
# 360 "../test/x509_time_test.c"
                    ) {
            test_info("../test/x509_time_test.c", 361, "test_x509_time(%d) failed: internal error\n", idx);
            return 0;
        }
    }
    ...
    if (!test_int_eq("../test/x509_time_test.c", 368, "result", "x509_format_tests[idx].expected", result, x509_format_tests[idx].expected)) {
        test_info("../test/x509_time_test.c", 369, "test_x509_time(%d) failed: expected %d, got %d\n", idx, x509_format_tests[idx].expected, result)
                                                             ;
        goto out;
    }
    ...
    if (t != 
# 375 "../test/x509_time_test.c" 3 4
            ((void *)0) 
# 375 "../test/x509_time_test.c"
                 && x509_format_tests[idx].expected_type != -1) {
        if (!test_int_eq("../test/x509_time_test.c", 376, "t->type", "x509_format_tests[idx].expected_type", t->type, x509_format_tests[idx].expected_type)) {
            test_info("../test/x509_time_test.c", 377, "test_x509_time(%d) failed: expected_type %d, got %d\n", idx, x509_format_tests[idx].expected_type, t->type)
                                                                       ;
            goto out;
        }
    }
    ...
    if (t != 
# 384 "../test/x509_time_test.c" 3 4
            ((void *)0) 
# 384 "../test/x509_time_test.c"
                 && x509_format_tests[idx].expected_string) {
        if (!test_mem_eq("../test/x509_time_test.c", 385, "(const char *)t->data", "x509_format_tests[idx].expected_string", (const char *)t->data, t->length, x509_format_tests[idx].expected_string, strlen(x509_format_tests[idx].expected_string))

                                                                   ) {
            test_info("../test/x509_time_test.c", 388, "test_x509_time(%d) failed: expected_string %s, got %.*s\n", idx, x509_format_tests[idx].expected_string, t->length, t->data)
...
out:
    if (t != 
# 397 "../test/x509_time_test.c" 3 4
            ((void *)0)
# 397 "../test/x509_time_test.c"
                )
        ASN1_TIME_free(t);
    return rv;
}
...
static int test_days(int n)
{
    char d[16];
    ASN1_TIME *a = 
# 461 "../test/x509_time_test.c" 3 4
                  ((void *)0)
# 461 "../test/x509_time_test.c"
                      ;
    struct tm t;
    int r;
    ...
    if (!test_ptr("../test/x509_time_test.c", 469, "a = ASN1_TIME_new()", a = ASN1_TIME_new()))
        return 0;

    r = test_true("../test/x509_time_test.c", 472, "ASN1_TIME_set_string(a, d)", (ASN1_TIME_set_string(a, d)) != 0)
        && test_true("../test/x509_time_test.c", 473, "ASN1_TIME_to_tm(a, &t)", (ASN1_TIME_to_tm(a, &t)) != 0)
        && test_int_eq("../test/x509_time_test.c", 474, "t.tm_yday", "day_of_week_tests[n].yd", t.tm_yday, day_of_week_tests[n].yd)
        && test_int_eq("../test/x509_time_test.c", 475, "t.tm_wday", "day_of_week_tests[n].wd", t.tm_wday, day_of_week_tests[n].wd);
...
static const struct {
    ...
    { { sizeof("20170731222050Z") - 1, 24, (unsigned char*)"20170731222050Z", 0 }, "Jul 31 22:20:50 2017 GMT" }
                                       ,

    { { sizeof("201707312220Z") - 1, 24, (unsigned char*)"201707312220Z", 0 }, "Bad time value" }
                             ,

    { { sizeof("20170731222050.123Z") - 1, 24, (unsigned char*)"20170731222050.123Z", 0 }, "Jul 31 22:20:50.123 2017 GMT" }
                                           ,

    { { sizeof("20170731222050.1Z") - 1, 24, (unsigned char*)"20170731222050.1Z", 0 }, "Jul 31 22:20:50.1 2017 GMT" }
                                         ,

    { { sizeof("20170731222050.Z") - 1, 24, (unsigned char*)"20170731222050.Z", 0 }, "Bad time value" }
                             ,

    { { sizeof("170731222050Z") - 1, 23, (unsigned char*)"170731222050Z", 0 }, "Jul 31 22:20:50 2017 GMT" }
                                       ,

    { { sizeof("1707312220Z") - 1, 23, (unsigned char*)"1707312220Z", 0 }, "Bad time value" }
                             ,
};
...
static const struct {
    ...
    { { sizeof("20170731222050Z") - 1, 24, (unsigned char*)"20170731222050Z", 0 }, "2017-07-31 22:20:50Z" }
                                   ,

    { { sizeof("201707312220Z") - 1, 24, (unsigned char*)"201707312220Z", 0 }, "Bad time value" }
                             ,

    { { sizeof("20170731222050.123Z") - 1, 24, (unsigned char*)"20170731222050.123Z", 0 }, "2017-07-31 22:20:50.123Z" }
                                       ,

    { { sizeof("20170731222050.1Z") - 1, 24, (unsigned char*)"20170731222050.1Z", 0 }, "2017-07-31 22:20:50.1Z" }
                                     ,

    { { sizeof("20170731222050.Z") - 1, 24, (unsigned char*)"20170731222050.Z", 0 }, "Bad time value" }
                             ,

    { { sizeof("170731222050Z") - 1, 23, (unsigned char*)"170731222050Z", 0 }, "2017-07-31 22:20:50Z" }
                                   ,
...
static int test_x509_time_print_rfc_822(int idx)
{
    ...
    if (!test_ptr("../test/x509_time_test.c", 545, "m = BIO_new(BIO_s_mem())", m = BIO_new(BIO_s_mem())))
        goto err;

    rv = ASN1_TIME_print_ex(m, &x509_print_tests_rfc_822[idx].asn1, 0x00UL);
    readable = x509_print_tests_rfc_822[idx].readable;

    if (rv == 0 && !test_str_eq("../test/x509_time_test.c", 551, "readable", "\"Bad time value\"", readable, "Bad time value")) {

        goto err;
    }
    if (!test_int_ne("../test/x509_time_test.c", 555, "rv = BIO_get_mem_data(m, &pp)", "0", rv = BIO_ctrl(m,3,0,(char *)(&pp)), 0)
        || !test_int_eq("../test/x509_time_test.c", 556, "rv", "(int)strlen(readable)", rv, (int)strlen(readable))
        || !test_strn_eq("../test/x509_time_test.c", 557, "pp", "readable", pp, rv, readable, rv))
        goto err;
...
static int test_x509_time_print_iso_8601(int idx)
{
    ...
    if (!test_ptr("../test/x509_time_test.c", 573, "m = BIO_new(BIO_s_mem())", m = BIO_new(BIO_s_mem())))
        goto err;

    rv = ASN1_TIME_print_ex(m, &x509_print_tests_iso_8601[idx].asn1, 0x01UL);
    readable = x509_print_tests_iso_8601[idx].readable;

    if (rv == 0 && !test_str_eq("../test/x509_time_test.c", 579, "readable", "\"Bad time value\"", readable, "Bad time value")) {

        goto err;
    }
    if (!test_int_ne("../test/x509_time_test.c", 583, "rv = BIO_get_mem_data(m, &pp)", "0", rv = BIO_ctrl(m,3,0,(char *)(&pp)), 0)
        || !test_int_eq("../test/x509_time_test.c", 584, "rv", "(int)strlen(readable)", rv, (int)strlen(readable))
        || !test_strn_eq("../test/x509_time_test.c", 585, "pp", "readable", pp, rv, readable, rv))
        goto err;
...
int setup_tests(void)
{
    ...
    add_all_tests("test_x509_cmp_time", test_x509_cmp_time, (sizeof(x509_cmp_tests)/sizeof((x509_cmp_tests)[0])), 1);
    add_all_tests("test_x509_time", test_x509_time, (sizeof(x509_format_tests)/sizeof((x509_format_tests)[0])), 1);
    add_all_tests("test_days", test_days, (sizeof(day_of_week_tests)/sizeof((day_of_week_tests)[0])), 1);
    add_all_tests("test_x509_time_print_rfc_822", test_x509_time_print_rfc_822, (sizeof(x509_print_tests_rfc_822)/sizeof((x509_print_tests_rfc_822)[0])), 1);
    add_all_tests("test_x509_time_print_iso_8601", test_x509_time_print_iso_8601, (sizeof(x509_print_tests_iso_8601)/sizeof((x509_print_tests_iso_8601)[0])), 1);
    return 1;
}
