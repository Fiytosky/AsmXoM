...
# 17 "../test/stack_test.c" 2


# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 20 "../test/stack_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 21 "../test/stack_test.c" 2
# 29 "../test/stack_test.c"
typedef struct {
    int n;
    char c;
} SS;
...
struct stack_st_sint; typedef int (*sk_sint_compfunc)(const int * const *a, const int *const *b); typedef void (*sk_sint_freefunc)(int *a); typedef int * (*sk_sint_copyfunc)(const int *a); static __attribute__((unused)) inline int sk_sint_num(const struct stack_st_sint *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int *sk_sint_value(const struct stack_st_sint *sk, int idx) { return (int *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_sint *sk_sint_new(sk_sint_compfunc compare) { return (struct stack_st_sint *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_sint *sk_sint_new_null(void) { return (struct stack_st_sint *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_sint *sk_sint_new_reserve(sk_sint_compfunc compare, int n) { return (struct stack_st_sint *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_sint_reserve(struct stack_st_sint *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_sint_free(struct stack_st_sint *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_sint_zero(struct stack_st_sint *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int *sk_sint_delete(struct stack_st_sint *sk, int i) { return (int *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline int *sk_sint_delete_ptr(struct stack_st_sint *sk, int *ptr) { return (int *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_sint_push(struct stack_st_sint *sk, int *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_sint_unshift(struct stack_st_sint *sk, int *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int *sk_sint_pop(struct stack_st_sint *sk) { return (int *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int *sk_sint_shift(struct stack_st_sint *sk) { return (int *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_sint_pop_free(struct stack_st_sint *sk, sk_sint_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_sint_insert(struct stack_st_sint *sk, int *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline int *sk_sint_set(struct stack_st_sint *sk, int idx, int *ptr) { return (int *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_sint_find(struct stack_st_sint *sk, int *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_sint_find_ex(struct stack_st_sint *sk, int *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_sint_find_all(struct stack_st_sint *sk, int *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_sint_sort(struct stack_st_sint *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_sint_is_sorted(const struct stack_st_sint *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_sint * sk_sint_dup(const struct stack_st_sint *sk) { return (struct stack_st_sint *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_sint *sk_sint_deep_copy(const struct stack_st_sint *sk, sk_sint_copyfunc copyfunc, sk_sint_freefunc freefunc) { return (struct stack_st_sint *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_sint_compfunc sk_sint_set_cmp_func(struct stack_st_sint *sk, sk_sint_compfunc compare) { return (sk_sint_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_uchar; typedef int (*sk_uchar_compfunc)(const unsigned char * const *a, const unsigned char *const *b); typedef void (*sk_uchar_freefunc)(unsigned char *a); typedef unsigned char * (*sk_uchar_copyfunc)(const unsigned char *a); static __attribute__((unused)) inline int sk_uchar_num(const struct stack_st_uchar *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const unsigned char *sk_uchar_value(const struct stack_st_uchar *sk, int idx) { return (const unsigned char *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_uchar *sk_uchar_new(sk_uchar_compfunc compare) { return (struct stack_st_uchar *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_uchar *sk_uchar_new_null(void) { return (struct stack_st_uchar *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_uchar *sk_uchar_new_reserve(sk_uchar_compfunc compare, int n) { return (struct stack_st_uchar *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_uchar_reserve(struct stack_st_uchar *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_uchar_free(struct stack_st_uchar *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_uchar_zero(struct stack_st_uchar *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const unsigned char *sk_uchar_delete(struct stack_st_uchar *sk, int i) { return (const unsigned char *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline const unsigned char *sk_uchar_delete_ptr(struct stack_st_uchar *sk, const unsigned char *ptr) { return (const unsigned char *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_uchar_push(struct stack_st_uchar *sk, const unsigned char *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_uchar_unshift(struct stack_st_uchar *sk, const unsigned char *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline const unsigned char *sk_uchar_pop(struct stack_st_uchar *sk) { return (const unsigned char *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const unsigned char *sk_uchar_shift(struct stack_st_uchar *sk) { return (const unsigned char *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_uchar_pop_free(struct stack_st_uchar *sk, sk_uchar_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_uchar_insert(struct stack_st_uchar *sk, const unsigned char *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline const unsigned char *sk_uchar_set(struct stack_st_uchar *sk, int idx, const unsigned char *ptr) { return (const unsigned char *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_uchar_find(struct stack_st_uchar *sk, const unsigned char *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_uchar_find_ex(struct stack_st_uchar *sk, const unsigned char *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_uchar_find_all(struct stack_st_uchar *sk, const unsigned char *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_uchar_sort(struct stack_st_uchar *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_uchar_is_sorted(const struct stack_st_uchar *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_uchar * sk_uchar_dup(const struct stack_st_uchar *sk) { return (struct stack_st_uchar *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_uchar *sk_uchar_deep_copy(const struct stack_st_uchar *sk, sk_uchar_copyfunc copyfunc, sk_uchar_freefunc freefunc) { return (struct stack_st_uchar *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_uchar_compfunc sk_uchar_set_cmp_func(struct stack_st_uchar *sk, sk_uchar_compfunc compare) { return (sk_uchar_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_SS; typedef int (*sk_SS_compfunc)(const SS * const *a, const SS *const *b); typedef void (*sk_SS_freefunc)(SS *a); typedef SS * (*sk_SS_copyfunc)(const SS *a); static __attribute__((unused)) inline int sk_SS_num(const struct stack_st_SS *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline SS *sk_SS_value(const struct stack_st_SS *sk, int idx) { return (SS *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_SS *sk_SS_new(sk_SS_compfunc compare) { return (struct stack_st_SS *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_SS *sk_SS_new_null(void) { return (struct stack_st_SS *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_SS *sk_SS_new_reserve(sk_SS_compfunc compare, int n) { return (struct stack_st_SS *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_SS_reserve(struct stack_st_SS *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_SS_free(struct stack_st_SS *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_SS_zero(struct stack_st_SS *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline SS *sk_SS_delete(struct stack_st_SS *sk, int i) { return (SS *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline SS *sk_SS_delete_ptr(struct stack_st_SS *sk, SS *ptr) { return (SS *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SS_push(struct stack_st_SS *sk, SS *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SS_unshift(struct stack_st_SS *sk, SS *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline SS *sk_SS_pop(struct stack_st_SS *sk) { return (SS *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline SS *sk_SS_shift(struct stack_st_SS *sk) { return (SS *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_SS_pop_free(struct stack_st_SS *sk, sk_SS_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_SS_insert(struct stack_st_SS *sk, SS *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline SS *sk_SS_set(struct stack_st_SS *sk, int idx, SS *ptr) { return (SS *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_SS_find(struct stack_st_SS *sk, SS *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SS_find_ex(struct stack_st_SS *sk, SS *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SS_find_all(struct stack_st_SS *sk, SS *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_SS_sort(struct stack_st_SS *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_SS_is_sorted(const struct stack_st_SS *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_SS * sk_SS_dup(const struct stack_st_SS *sk) { return (struct stack_st_SS *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_SS *sk_SS_deep_copy(const struct stack_st_SS *sk, sk_SS_copyfunc copyfunc, sk_SS_freefunc freefunc) { return (struct stack_st_SS *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_SS_compfunc sk_SS_set_cmp_func(struct stack_st_SS *sk, sk_SS_compfunc compare) { return (sk_SS_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_SU; typedef int (*sk_SU_compfunc)(const SU * const *a, const SU *const *b); typedef void (*sk_SU_freefunc)(SU *a); typedef SU * (*sk_SU_copyfunc)(const SU *a); static __attribute__((unused)) inline int sk_SU_num(const struct stack_st_SU *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const SU *sk_SU_value(const struct stack_st_SU *sk, int idx) { return (const SU *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_SU *sk_SU_new(sk_SU_compfunc compare) { return (struct stack_st_SU *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_SU *sk_SU_new_null(void) { return (struct stack_st_SU *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_SU *sk_SU_new_reserve(sk_SU_compfunc compare, int n) { return (struct stack_st_SU *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_SU_reserve(struct stack_st_SU *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_SU_free(struct stack_st_SU *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_SU_zero(struct stack_st_SU *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const SU *sk_SU_delete(struct stack_st_SU *sk, int i) { return (const SU *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline const SU *sk_SU_delete_ptr(struct stack_st_SU *sk, const SU *ptr) { return (const SU *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SU_push(struct stack_st_SU *sk, const SU *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SU_unshift(struct stack_st_SU *sk, const SU *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline const SU *sk_SU_pop(struct stack_st_SU *sk) { return (const SU *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const SU *sk_SU_shift(struct stack_st_SU *sk) { return (const SU *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_SU_pop_free(struct stack_st_SU *sk, sk_SU_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_SU_insert(struct stack_st_SU *sk, const SU *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline const SU *sk_SU_set(struct stack_st_SU *sk, int idx, const SU *ptr) { return (const SU *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_SU_find(struct stack_st_SU *sk, const SU *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SU_find_ex(struct stack_st_SU *sk, const SU *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_SU_find_all(struct stack_st_SU *sk, const SU *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_SU_sort(struct stack_st_SU *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_SU_is_sorted(const struct stack_st_SU *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_SU * sk_SU_dup(const struct stack_st_SU *sk) { return (struct stack_st_SU *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_SU *sk_SU_deep_copy(const struct stack_st_SU *sk, sk_SU_copyfunc copyfunc, sk_SU_freefunc freefunc) { return (struct stack_st_SU *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_SU_compfunc sk_SU_set_cmp_func(struct stack_st_SU *sk, sk_SU_compfunc compare) { return (sk_SU_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
static int test_int_stack(int reserve)
{
    ...
    const int n_finds = (sizeof(finds)/sizeof((finds)[0]));
    static struct {
        int value;
        int ex;
    } exfinds[] = {
    ...
    const int n_exfinds = (sizeof(exfinds)/sizeof((exfinds)[0]));
    struct stack_st_sint *s = sk_sint_new_null();
    int i;
    int testresult = 0;

    if (!test_ptr("../test/stack_test.c", 87, "s", s)
        || (reserve > 0 && !test_true("../test/stack_test.c", 88, "sk_sint_reserve(s, 5 * reserve)", (sk_sint_reserve(s, 5 * reserve)) != 0)))
        goto end;


    for (i = 0; i < n; i++) {
        if (!test_int_eq("../test/stack_test.c", 93, "sk_sint_num(s)", "i", sk_sint_num(s), i)) {
            test_info("../test/stack_test.c", 94, "int stack size %d", i);
            goto end;
        }
        sk_sint_push(s, v + i);
    }
    if (!test_int_eq("../test/stack_test.c", 99, "sk_sint_num(s)", "n", sk_sint_num(s), n))
        goto end;


    for (i = 0; i < n; i++)
        if (!test_ptr_eq("../test/stack_test.c", 104, "sk_sint_value(s, i)", "v + i", sk_sint_value(s, i), v + i)) {
            test_info("../test/stack_test.c", 105, "int value %d", i);
            goto end;
        }
    ...
    for (i = 0; i < n_finds; i++) {
        ...
        if (!test_int_eq("../test/stack_test.c", 114, "sk_sint_find(s, val)", "finds[i].unsorted", sk_sint_find(s, val), finds[i].unsorted)) {
            test_info("../test/stack_test.c", 115, "int unsorted find %d", i);
            goto end;
        }
    }
    ...
    for (i = 0; i < n_finds; i++) {
        ...
        if (!test_int_eq("../test/stack_test.c", 125, "sk_sint_find_ex(s, val)", "finds[i].unsorted", sk_sint_find_ex(s, val), finds[i].unsorted)) {
            test_info("../test/stack_test.c", 126, "int unsorted find_ex %d", i);
            goto end;
        }
    }


    if (!test_false("../test/stack_test.c", 132, "sk_sint_is_sorted(s)", (sk_sint_is_sorted(s)) != 0))
        goto end;
    (void)sk_sint_set_cmp_func(s, &int_compare);
    sk_sint_sort(s);
    if (!test_true("../test/stack_test.c", 136, "sk_sint_is_sorted(s)", (sk_sint_is_sorted(s)) != 0))
        goto end;


    for (i = 0; i < n_finds; i++)
        if (!test_int_eq("../test/stack_test.c", 141, "sk_sint_find(s, &finds[i].value)", "finds[i].sorted", sk_sint_find(s, &finds[i].value), finds[i].sorted)) {
            test_info("../test/stack_test.c", 142, "int sorted find %d", i);
            goto end;
        }


    for (i = 0; i < n_finds; i++)
        if (!test_int_eq("../test/stack_test.c", 148, "sk_sint_find_ex(s, &finds[i].value)", "finds[i].ex", sk_sint_find_ex(s, &finds[i].value), finds[i].ex)) {
            test_info("../test/stack_test.c", 149, "int sorted find_ex present %d", i);
            goto end;
        }
    for (i = 0; i < n_exfinds; i++)
        if (!test_int_eq("../test/stack_test.c", 153, "sk_sint_find_ex(s, &exfinds[i].value)", "exfinds[i].ex", sk_sint_find_ex(s, &exfinds[i].value), exfinds[i].ex)) {
            test_info("../test/stack_test.c", 154, "int sorted find_ex absent %d", i);
            goto end;
        }


    if (!test_ptr_eq("../test/stack_test.c", 159, "sk_sint_shift(s)", "v + 6", sk_sint_shift(s), v + 6))
        goto end;
...
static int test_uchar_stack(int reserve)
{
    ...
    const int n = (sizeof(v)/sizeof((v)[0]));
    struct stack_st_uchar *s = sk_uchar_new(&uchar_compare), *r = 
# 178 "../test/stack_test.c" 3 4
                                                           ((void *)0)
# 178 "../test/stack_test.c"
                                                               ;
    int i;
    int testresult = 0;

    if (!test_ptr("../test/stack_test.c", 182, "s", s)
        || (reserve > 0 && !test_true("../test/stack_test.c", 183, "sk_uchar_reserve(s, 5 * reserve)", (sk_uchar_reserve(s, 5 * reserve)) != 0)))
        goto end;


    for (i = 0; i < n; i++) {
        if (!test_int_eq("../test/stack_test.c", 188, "sk_uchar_num(s)", "i", sk_uchar_num(s), i)) {
            test_info("../test/stack_test.c", 189, "uchar stack size %d", i);
            goto end;
        }
        sk_uchar_unshift(s, v + i);
    }
    if (!test_int_eq("../test/stack_test.c", 194, "sk_uchar_num(s)", "n", sk_uchar_num(s), n))
        goto end;


    r = sk_uchar_dup(
# 198 "../test/stack_test.c" 3 4
                    ((void *)0)
# 198 "../test/stack_test.c"
                        );
    if (sk_uchar_num(r) != 0)
        goto end;
    sk_uchar_free(r);
    r = sk_uchar_dup(s);
    if (!test_int_eq("../test/stack_test.c", 203, "sk_uchar_num(r)", "n", sk_uchar_num(r), n))
        goto end;
    sk_uchar_sort(r);


    for (i = 0; i < n; i++)
        if (!test_ptr_eq("../test/stack_test.c", 209, "sk_uchar_pop(s)", "v + i", sk_uchar_pop(s), v + i)) {
            test_info("../test/stack_test.c", 210, "uchar pop %d", i);
            goto end;
        }
    ...
    sk_uchar_free(s);
    s = 
# 216 "../test/stack_test.c" 3 4
       ((void *)0)
# 216 "../test/stack_test.c"
           ;


    if (!test_int_eq("../test/stack_test.c", 219, "sk_uchar_num(r)", "n", sk_uchar_num(r), n))
        goto end;


    sk_uchar_zero(r);
    if (!test_int_eq("../test/stack_test.c", 224, "sk_uchar_num(r)", "0", sk_uchar_num(r), 0))
        goto end;
    ...
    for (i = 0; i < 3; i++)
        if (!test_ptr_eq("../test/stack_test.c", 232, "sk_uchar_value(r, i)", "v + i", sk_uchar_value(r, i), v + i)) {
            test_info("../test/stack_test.c", 233, "uchar insert %d", i);
            goto end;
        }


    if (!test_ptr_null("../test/stack_test.c", 238, "sk_uchar_delete(r, 12)", sk_uchar_delete(r, 12)))
        goto end;
    if (!test_ptr_eq("../test/stack_test.c", 240, "sk_uchar_delete(r, 1)", "v + 1", sk_uchar_delete(r, 1), v + 1))
        goto end;


    (void)sk_uchar_set(r, 1, v + 1);
    for (i = 0; i < 2; i++)
        if (!test_ptr_eq("../test/stack_test.c", 246, "sk_uchar_value(r, i)", "v + i", sk_uchar_value(r, i), v + i)) {
            test_info("../test/stack_test.c", 247, "uchar set %d", i);
            goto end;
        }
...
{
    SS *q = CRYPTO_malloc(sizeof(*q), "../test/stack_test.c", 260);

    if (q != 
# 262 "../test/stack_test.c" 3 4
            ((void *)0)
# 262 "../test/stack_test.c"
                )
        memcpy(q, p, sizeof(*q));
    return q;
}
...
static void SS_free(SS *p) {
    CRYPTO_free(p, "../test/stack_test.c", 268);
}

static int test_SS_stack(void)
{
    struct stack_st_SS *s = sk_SS_new_null();
    struct stack_st_SS *r = 
# 274 "../test/stack_test.c" 3 4
                     ((void *)0)
# 274 "../test/stack_test.c"
                         ;
    SS *v[10], *p;
    const int n = (sizeof(v)/sizeof((v)[0]));
    int i;
    ...
    for (i = 0; i < n; i++) {
        v[i] = CRYPTO_malloc(sizeof(*v[i]), "../test/stack_test.c", 282);

        if (!test_ptr("../test/stack_test.c", 284, "v[i]", v[i]))
            goto end;
        v[i]->n = i;
        v[i]->c = 'A' + i;
        if (!test_int_eq("../test/stack_test.c", 288, "sk_SS_num(s)", "i", sk_SS_num(s), i)) {
            test_info("../test/stack_test.c", 289, "SS stack size %d", i);
            goto end;
        }
        sk_SS_push(s, v[i]);
    }
    if (!test_int_eq("../test/stack_test.c", 294, "sk_SS_num(s)", "n", sk_SS_num(s), n))
        goto end;


    r = sk_SS_deep_copy(
# 298 "../test/stack_test.c" 3 4
                       ((void *)0)
# 298 "../test/stack_test.c"
                           , &SS_copy, &SS_free);
    if (sk_SS_num(r) != 0)
        goto end;
    sk_SS_free(r);
    r = sk_SS_deep_copy(s, &SS_copy, &SS_free);
    if (!test_ptr("../test/stack_test.c", 303, "r", r))
        goto end;
    for (i = 0; i < n; i++) {
        p = sk_SS_value(r, i);
        if (!test_ptr_ne("../test/stack_test.c", 307, "p", "v[i]", p, v[i])) {
            test_info("../test/stack_test.c", 308, "SS deepcopy non-copy %d", i);
            goto end;
        }
        if (!test_int_eq("../test/stack_test.c", 311, "p->n", "v[i]->n", p->n, v[i]->n)) {
            test_info("../test/stack_test.c", 312, "test SS deepcopy int %d", i);
            goto end;
        }
        if (!test_char_eq("../test/stack_test.c", 315, "p->c", "v[i]->c", p->c, v[i]->c)) {
            test_info("../test/stack_test.c", 316, "SS deepcopy char %d", i);
            goto end;
        }
    }
    ...
    r = 
# 323 "../test/stack_test.c" 3 4
       ((void *)0)
# 323 "../test/stack_test.c"
           ;


    p = sk_SS_delete_ptr(s, v[3]);
    if (!test_ptr("../test/stack_test.c", 327, "p", p))
        goto end;
    SS_free(p);
    if (!test_int_eq("../test/stack_test.c", 330, "sk_SS_num(s)", "n - 1", sk_SS_num(s), n - 1))
        goto end;
    for (i = 0; i < n-1; i++)
        if (!test_ptr_eq("../test/stack_test.c", 333, "sk_SS_value(s, i)", "v[i<3 ? i : 1+i]", sk_SS_value(s, i), v[i<3 ? i : 1+i])) {
            test_info("../test/stack_test.c", 334, "SS delete ptr item %d", i);
            goto end;
        }
...
{
    struct stack_st_SU *s = sk_SU_new_null();
    SU v[10];
    const int n = (sizeof(v)/sizeof((v)[0]));
    int i;
    int testresult = 0;
    ...
    for (i = 0; i < n; i++) {
        if ((i & 1) == 0)
            ...
            v[i].c = 'A' + i;
        if (!test_int_eq("../test/stack_test.c", 359, "sk_SU_num(s)", "i", sk_SU_num(s), i)) {
            test_info("../test/stack_test.c", 360, "SU stack size %d", i);
            goto end;
        }
        sk_SU_push(s, v + i);
    }
    if (!test_int_eq("../test/stack_test.c", 365, "sk_SU_num(s)", "n", sk_SU_num(s), n))
        goto end;


    for (i = 0; i < n; i++)
        if (!test_ptr_eq("../test/stack_test.c", 370, "sk_SU_value(s, i)", "v + i", sk_SU_value(s, i), v + i)) {
            test_info("../test/stack_test.c", 371, "SU pointer check %d", i);
            goto end;
        }
