...
static unsigned char cipher_ecb2[34 - 1][8] = {
...
static char *pt(const unsigned char *p, char buf[20])
{
    char *ret;
    int i;
...
static int test_des_ecb(int i)
{
    ...
    DES_ecb_encrypt(&out, &outin, &ks, 0);

    if (!test_mem_eq("../test/destest.c", 321, "out", "cipher_data[i]", out, 8, cipher_data[i], 8)) {
        test_info("../test/destest.c", 322, "Encryption error %2d k=%s p=%s", i + 1, pt(key_data[i], b1), pt(in, b2))
                                                  ;
        return 0;
    }
    if (!test_mem_eq("../test/destest.c", 326, "in", "outin", in, 8, outin, 8)) {
        test_info("../test/destest.c", 327, "Decryption error %2d k=%s p=%s", i + 1, pt(key_data[i], b1), pt(out, b2))
                                                   ;
        return 0;
    }
    return 1;
...
static int test_des_ede_ecb(int i)
{
    ...
    memset(out, 0, 8);
    memset(outin, 0, 8);
    DES_ecb3_encrypt(&in, &out, &ks, &ks2, &ks, 1);
    DES_ecb3_encrypt(&out, &outin, &ks, &ks2, &ks, 0);

    if (!test_mem_eq("../test/destest.c", 349, "out", "cipher_ecb2[i]", out, 8, cipher_ecb2[i], 8)) {
        test_info("../test/destest.c", 350, "Encryption error %2d k=%s p=%s", i + 1, pt(key_data[i], b1), pt(in, b2))
                                                  ;
        return 0;
    }
    if (!test_mem_eq("../test/destest.c", 354, "in", "outin", in, 8, outin, 8)) {
        test_info("../test/destest.c", 355, "Decryption error %2d k=%s p=%s ", i + 1, pt(key_data[i], b1), pt(out, b2))
                                                   ;
        return 0;
    }
    return 1;
...
static int test_des_cbc(void)
{
    ...
    if (!test_int_eq("../test/destest.c", 370, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    ...
    DES_ncbc_encrypt(cbc_data, cbc_out, cbc_data_len + 1, &ks,
                     &iv3, 1);
    if (!test_mem_eq("../test/destest.c", 377, "cbc_out", "cbc_ok", cbc_out, 32, cbc_ok, 32))
        return 0;

    memcpy(iv3, cbc_iv, sizeof(cbc_iv));
    DES_ncbc_encrypt(cbc_out, cbc_in, cbc_data_len + 1, &ks,
                     &iv3, 0);
    return test_mem_eq("../test/destest.c", 383, "cbc_in", "cbc_data", cbc_in, cbc_data_len, cbc_data, cbc_data_len);
}
...
static int test_des_ede_cbc(void)
{
    ...
    if (!test_int_eq("../test/destest.c", 394, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    memset(cbc_out, 0, sizeof(cbc_out));
    memset(cbc_in, 0, sizeof(cbc_in));
    memcpy(iv3, cbc_iv, sizeof(cbc_iv));
    DES_xcbc_encrypt(cbc_data, cbc_out, n, &ks, &iv3, &cbc2_key, &cbc3_key,
                     1);
    if (!test_mem_eq("../test/destest.c", 401, "cbc_out", "xcbc_ok", cbc_out, sizeof(xcbc_ok), xcbc_ok, sizeof(xcbc_ok)))
        return 0;
    memcpy(iv3, cbc_iv, sizeof(cbc_iv));
    DES_xcbc_encrypt(cbc_out, cbc_in, n, &ks, &iv3, &cbc2_key, &cbc3_key,
                     0);
    return test_mem_eq("../test/destest.c", 406, "cbc_data", "cbc_data", cbc_data, n, cbc_data, n);
}
...
static int test_ede_cbc(void)
{
    ...
    if (!test_int_eq("../test/destest.c", 418, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    if (!test_int_eq("../test/destest.c", 420, "DES_set_key_checked(&cbc2_key, &ks2)", "0", DES_set_key_checked(&cbc2_key, &ks2), 0))
        return 0;
    if (!test_int_eq("../test/destest.c", 422, "DES_set_key_checked(&cbc3_key, &ks3)", "0", DES_set_key_checked(&cbc3_key, &ks3), 0))
        return 0;
    memset(cbc_out, 0, sizeof(cbc_out));
    memset(cbc_in, 0, sizeof(cbc_in));
    memcpy(iv3, cbc_iv, sizeof(cbc_iv));
    ...
    DES_ede3_cbc_encrypt(&cbc_data[16], &cbc_out[16], i - 16, &ks, &ks2,
                         &ks3, &iv3, 1);
    if (!test_mem_eq("../test/destest.c", 432, "cbc_out", "cbc3_ok", cbc_out, n, cbc3_ok, n))
        return 0;

    memcpy(iv3, cbc_iv, sizeof(cbc_iv));
    DES_ede3_cbc_encrypt(cbc_out, cbc_in, i, &ks, &ks2, &ks3, &iv3,
                         0);
    return test_mem_eq("../test/destest.c", 438, "cbc_in", "cbc_data", cbc_in, i, cbc_data, i);
}
...
static int test_input_align(int i)
{
    ...
    if (!test_int_eq("../test/destest.c", 450, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    DES_ncbc_encrypt(&cbc_data[i], cbc_out, n, &ks, &iv, 1);
    return 1;
}
...
static int test_output_align(int i)
{
    ...
    memset(cbc_out, 0, sizeof(cbc_out));
    memcpy(iv, cbc_iv, sizeof(cbc_iv));
    if (!test_int_eq("../test/destest.c", 465, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    DES_ncbc_encrypt(cbc_data, &cbc_out[i], n, &ks, &iv, 1);
    return 1;
}

static int test_des_crypt(void)
{
    if (!test_str_eq("../test/destest.c", 473, "\"efGnQx2725bI2\"", "DES_crypt(\"testing\", \"ef\")", "efGnQx2725bI2", DES_crypt("testing", "ef")))
        return 0;
    if (!test_str_eq("../test/destest.c", 475, "\"yA1Rp/1hZXIJk\"", "DES_crypt(\"bca76;23\", \"yA\")", "yA1Rp/1hZXIJk", DES_crypt("bca76;23", "yA")))
        return 0;

    if (!test_ptr_null("../test/destest.c", 478, "DES_crypt(\"testing\", \"y\\202\")", DES_crypt("testing", "y\202")))
        return 0;
    if (!test_ptr_null("../test/destest.c", 480, "DES_crypt(\"testing\", \"\\0A\")", DES_crypt("testing", "\0A")))
        return 0;
    if (!test_ptr_null("../test/destest.c", 482, "DES_crypt(\"testing\", \"A\")", DES_crypt("testing", "A")))
        return 0;
    return 1;
}
...
static int test_des_pcbc(void)
{
    ...
    if (!test_int_eq("../test/destest.c", 494, "DES_set_key_checked(&cbc_key, &ks)", "0", DES_set_key_checked(&cbc_key, &ks), 0))
        return 0;
    memset(cbc_out, 0, sizeof(cbc_out));
    memset(cbc_in, 0, sizeof(cbc_in));
    DES_pcbc_encrypt(cbc_data, cbc_out, n, &ks,
                     &cbc_iv, 1);
    if (!test_mem_eq("../test/destest.c", 500, "cbc_out", "pcbc_ok", cbc_out, sizeof(pcbc_ok), pcbc_ok, sizeof(pcbc_ok)))
        return 0;
    DES_pcbc_encrypt(cbc_out, cbc_in, n, &ks,
                     &cbc_iv, 0);
    return test_mem_eq("../test/destest.c", 504, "cbc_in", "cbc_data", cbc_in, n, cbc_data, n);
}
...
static int cfb_test(int bits, unsigned char *cfb_cipher)
{
    ...
    DES_cfb_encrypt(plain, cfb_buf1, bits, sizeof(plain), &ks, &cfb_tmp,
                    1);
    if (!test_mem_eq("../test/destest.c", 515, "cfb_cipher", "cfb_buf1", cfb_cipher, sizeof(plain), cfb_buf1, sizeof(plain)))
        return 0;
    memcpy(cfb_tmp, cfb_iv, sizeof(cfb_iv));
    DES_cfb_encrypt(cfb_buf1, cfb_buf2, bits, sizeof(plain), &ks, &cfb_tmp,
                    0);
    return test_mem_eq("../test/destest.c", 520, "plain", "cfb_buf2", plain, sizeof(plain), cfb_buf2, sizeof(plain));
}
...
static int test_des_cfb64(void)
{
    ...
    memcpy(cfb_tmp, cfb_iv, sizeof(cfb_iv));
    n = 0;
    DES_cfb64_encrypt(plain, cfb_buf1, 12, &ks, &cfb_tmp, &n, 1);
    DES_cfb64_encrypt(&plain[12], &cfb_buf1[12], sizeof(plain) - 12, &ks,
                      &cfb_tmp, &n, 1);
    if (!test_mem_eq("../test/destest.c", 558, "cfb_cipher64", "cfb_buf1", cfb_cipher64, sizeof(plain), cfb_buf1, sizeof(plain)))
        return 0;
    memcpy(cfb_tmp, cfb_iv, sizeof(cfb_iv));
    n = 0;
    DES_cfb64_encrypt(cfb_buf1, cfb_buf2, 17, &ks, &cfb_tmp, &n, 0);
    DES_cfb64_encrypt(&cfb_buf1[17], &cfb_buf2[17],
                      sizeof(plain) - 17, &ks, &cfb_tmp, &n, 0);
    if (!test_mem_eq("../test/destest.c", 565, "plain", "cfb_buf2", plain, sizeof(plain), cfb_buf2, sizeof(plain)))
        return 0;
    ...
    for (i = 0; i < sizeof(plain); i++)
        DES_cfb_encrypt(&plain[i], &cfb_buf1[i], 8, 1, &ks, &cfb_tmp,
                        1);
    if (!test_mem_eq("../test/destest.c", 572, "cfb_cipher8", "cfb_buf1", cfb_cipher8, sizeof(plain), cfb_buf1, sizeof(plain)))
        return 0;
    ...
    for (i = 0; i < sizeof(plain); i++)
        DES_cfb_encrypt(&cfb_buf1[i], &cfb_buf2[i], 8, 1, &ks, &cfb_tmp,
                        0);
    return test_mem_eq("../test/destest.c", 579, "plain", "cfb_buf2", plain, sizeof(plain), cfb_buf2, sizeof(plain));
}
...
static int test_des_ede_cfb64(void)
{
    ...
    DES_ede3_cfb64_encrypt(&plain[12], &cfb_buf1[12], sizeof(plain) - 12, &ks,
                           &ks, &ks, &cfb_tmp, &n, 1);
    if (!test_mem_eq("../test/destest.c", 594, "cfb_cipher64", "cfb_buf1", cfb_cipher64, sizeof(plain), cfb_buf1, sizeof(plain)))
        return 0;
    memcpy(cfb_tmp, cfb_iv, sizeof(cfb_iv));
    n = 0;
    ...
    DES_ede3_cfb64_encrypt(&cfb_buf1[17], &cfb_buf2[17], sizeof(plain) - 17,
                           &ks, &ks, &ks, &cfb_tmp, &n, 0);
    return test_mem_eq("../test/destest.c", 602, "plain", "cfb_buf2", plain, sizeof(plain), cfb_buf2, sizeof(plain));
}
...
static int test_des_ofb(void)
{
    ...
    if (!test_mem_eq("../test/destest.c", 612, "ofb_cipher", "ofb_buf1", ofb_cipher, sizeof(ofb_buf1), ofb_buf1, sizeof(ofb_buf1)))
        return 0;

    memcpy(ofb_tmp, ofb_iv, sizeof(ofb_iv));
    DES_ofb_encrypt(ofb_buf1, ofb_buf2, 64, sizeof(ofb_buf1) / 8, &ks,
                    &ofb_tmp);
    return test_mem_eq("../test/destest.c", 618, "plain", "ofb_buf2", plain, sizeof(ofb_buf2), ofb_buf2, sizeof(ofb_buf2));
}
...
static int test_des_ofb64(void)
{
    ...
    if (!test_mem_eq("../test/destest.c", 635, "ofb_cipher", "ofb_buf1", ofb_cipher, sizeof(ofb_buf1), ofb_buf1, sizeof(ofb_buf1)))
        return 0;
    memcpy(ofb_tmp, ofb_iv, sizeof(ofb_iv));
    num = 0;
    DES_ofb64_encrypt(ofb_buf1, ofb_buf2, sizeof(ofb_buf1), &ks, &ofb_tmp,
                      &num);
    return test_mem_eq("../test/destest.c", 641, "plain", "ofb_buf2", plain, sizeof(ofb_buf2), ofb_buf2, sizeof(ofb_buf2));
}
...
static int test_des_ede_ofb64(void)
{
    ...
    if (!test_mem_eq("../test/destest.c", 659, "ofb_cipher", "ofb_buf1", ofb_cipher, sizeof(ofb_buf1), ofb_buf1, sizeof(ofb_buf1)))
        return 0;
    memcpy(ofb_tmp, ofb_iv, sizeof(ofb_iv));
    num = 0;
    DES_ede3_ofb64_encrypt(ofb_buf1, ofb_buf2, sizeof(ofb_buf1), &ks, &ks, &ks,
                           &ofb_tmp, &num);
    return test_mem_eq("../test/destest.c", 665, "plain", "ofb_buf2", plain, sizeof(ofb_buf2), ofb_buf2, sizeof(ofb_buf2));
}
...
static int test_des_cbc_cksum(void)
{
    ...
    cs = DES_cbc_cksum(cbc_data, &cret, strlen((char *)cbc_data), &ks,
                       &cbc_iv);
    if (!test_uint_eq("../test/destest.c", 677, "cs", "cbc_cksum_ret", cs, cbc_cksum_ret))
        return 0;
    return test_mem_eq("../test/destest.c", 679, "cret", "cbc_cksum_data", cret, 8, cbc_cksum_data, 8);
}
...
static int test_des_quad_cksum(void)
{
    ...
    cs = DES_quad_cksum(cbc_data, (DES_cblock *)lqret,
                        ...
                        (DES_cblock *)cbc_iv);
    if (!test_uint_eq("../test/destest.c", 689, "cs", "0x70d7a63aL", cs, 0x70d7a63aL))
        return 0;
    if (!test_uint_eq("../test/destest.c", 691, "lqret[0]", "0x327eba8dL", lqret[0], 0x327eba8dL))
        return 0;
    if (!test_uint_eq("../test/destest.c", 693, "lqret[1]", "0x201a49ccL", lqret[1], 0x201a49ccL))
        return 0;
    if (!test_uint_eq("../test/destest.c", 695, "lqret[2]", "0x70d7a63aL", lqret[2], 0x70d7a63aL))
        return 0;
    if (!test_uint_eq("../test/destest.c", 697, "lqret[3]", "0x501c2c26L", lqret[3], 0x501c2c26L))
        return 0;
    return 1;
}
...
static int test_des_key_wrap(int idx)
{
    ...
    EVP_CIPHER *cipher = 
# 716 "../test/destest.c" 3 4
                        ((void *)0)
# 716 "../test/destest.c"
                            ;
    EVP_CIPHER_CTX *ctx = 
# 717 "../test/destest.c" 3 4
                         ((void *)0)
# 717 "../test/destest.c"
                             ;
    int res = 0;
    ...
    if (!test_size_t_le("../test/destest.c", 721, "in_bytes", "sizeof(in)", in_bytes, sizeof(in))
            || !test_ptr("../test/destest.c", 722, "cipher = EVP_CIPHER_fetch(NULL, \"DES3-WRAP\", NULL)", cipher = EVP_CIPHER_fetch(
# 722 "../test/destest.c" 3 4
               ((void *)0)
# 722 "../test/destest.c"
               , "DES3-WRAP", 
# 722 "../test/destest.c" 3 4
...
# 722 "../test/destest.c"
            ...
            || !test_int_eq("../test/destest.c", 723, "bs = EVP_CIPHER_get_block_size(cipher)", "8", bs = EVP_CIPHER_get_block_size(cipher), 8)
            || !test_size_t_eq("../test/destest.c", 724, "bs * 3u", "sizeof(key)", bs * 3u, sizeof(key))
            || !test_true("../test/destest.c", 725, "in_bytes % bs == 0", (in_bytes % bs == 0) != 0)
            || !test_ptr("../test/destest.c", 726, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new()))
        goto err;
    ...
    if (!test_true("../test/destest.c", 740, "EVP_EncryptInit(ctx, cipher, key, NULL)", (EVP_EncryptInit(ctx, cipher, key, 
# 740 "../test/destest.c" 3 4
        ((void *)0)
# 740 "../test/destest.c"
        )) != 0)
            || !test_true("../test/destest.c", 741, "EVP_EncryptUpdate(ctx, c_txt, &clen_upd, in, in_bytes)", (EVP_EncryptUpdate(ctx, c_txt, &clen_upd, in, in_bytes)) != 0)
                                                          )
        goto err;

    expect = (in_bytes + (bs - 1)) / bs * bs + 2 * bs;
    if (!test_int_eq("../test/destest.c", 746, "clen_upd", "expect", clen_upd, expect))
        goto err;

    clen_fin = sizeof(c_txt) - clen_upd;
    if (!test_true("../test/destest.c", 750, "EVP_EncryptFinal(ctx, c_txt + clen_upd, &clen_fin)", (EVP_EncryptFinal(ctx, c_txt + clen_upd, &clen_fin)) != 0)
            || !test_int_eq("../test/destest.c", 751, "clen_fin", "0", clen_fin, 0))
        goto err;
    clen = clen_upd + clen_fin;


    plen_upd = sizeof(p_txt);
    if (!test_true("../test/destest.c", 757, "EVP_DecryptInit(ctx, cipher, key, NULL)", (EVP_DecryptInit(ctx, cipher, key, 
# 757 "../test/destest.c" 3 4
        ((void *)0)
# 757 "../test/destest.c"
        )) != 0)
            || !test_true("../test/destest.c", 758, "EVP_DecryptUpdate(ctx, p_txt, &plen_upd, c_txt, clen)", (EVP_DecryptUpdate(ctx, p_txt, &plen_upd, c_txt, clen)) != 0)
                                                         )
        goto err;
    plen_fin = sizeof(p_txt) - plen_upd;
    if (!test_true("../test/destest.c", 762, "EVP_DecryptFinal(ctx, p_txt + plen_upd, &plen_fin)", (EVP_DecryptFinal(ctx, p_txt + plen_upd, &plen_fin)) != 0))
        goto err;
    plen = plen_upd + plen_fin;

    if (!test_mem_eq("../test/destest.c", 766, "in", "p_txt", in, in_bytes, p_txt, plen))
        goto err;
    res = 1;
 err:
...
static int test_des_weak_keys(int n)
{
    ...
    return test_int_eq("../test/destest.c", 813, "DES_is_weak_key(key)", "weak_keys[n].expect", DES_is_weak_key(key), weak_keys[n].expect);
}
...
static int test_des_check_bad_parity(int n)
{
    ...
    return test_int_eq("../test/destest.c", 839, "DES_check_key_parity(key)", "bad_parity_keys[n].expect", DES_check_key_parity(key), bad_parity_keys[n].expect);
}
...
static int test_des_two_key(void)
{
    int res = 0;
    EVP_CIPHER *cipher = 
# 846 "../test/destest.c" 3 4
                        ((void *)0)
# 846 "../test/destest.c"
                            ;
    EVP_CIPHER_CTX *ctx = 
# 847 "../test/destest.c" 3 4
                         ((void *)0)
# 847 "../test/destest.c"
                             ;
    unsigned char key[16];

    if (!test_ptr("../test/destest.c", 850, "cipher = EVP_CIPHER_fetch(NULL, \"DES-EDE-ECB\", NULL)", cipher = EVP_CIPHER_fetch(
# 850 "../test/destest.c" 3 4
        ((void *)0)
# 850 "../test/destest.c"
        , "DES-EDE-ECB", 
# 850 "../test/destest.c" 3 4
...
# 850 "../test/destest.c"
            ...
            || !test_ptr("../test/destest.c", 851, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
            || !EVP_CipherInit_ex(ctx, cipher, 
# 852 "../test/destest.c" 3 4
                                              ((void *)0)
# 852 "../test/destest.c"
                                                  , 
# 852 "../test/destest.c" 3 4
...
int setup_tests(void)
{
    ...
    add_all_tests("test_des_ecb", test_des_ecb, 34, 1);
    add_test("test_des_cbc", test_des_cbc);
    add_test("test_ede_cbc", test_ede_cbc);
    add_all_tests("test_des_ede_ecb", test_des_ede_ecb, 34 - 2, 1);
    ...
    add_all_tests("test_des_key_wrap", test_des_key_wrap, (sizeof(test_des_key_wrap_sizes)/sizeof((test_des_key_wrap_sizes)[0])), 1);
    add_all_tests("test_des_weak_keys", test_des_weak_keys, (sizeof(weak_keys)/sizeof((weak_keys)[0])), 1);
    add_all_tests("test_des_check_bad_parity", test_des_check_bad_parity, (sizeof(bad_parity_keys)/sizeof((bad_parity_keys)[0])), 1);
