# 0 "../test/bio_memleak_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_memleak_test.c"
# 9 "../test/bio_memleak_test.c"
...
static int test_bio_memleak(void)
{
    ...
    if (!test_ptr("../test/bio_memleak_test.c", 25, "bio", bio))
        goto finish;
    bufmem.length = sizeof(str);
    bufmem.data = (char *) str;
    bufmem.max = bufmem.length;
    BIO_ctrl(bio,114,0x00,(char *)(&bufmem));
    BIO_set_flags(bio, 0x200);
    if (!test_int_eq("../test/bio_memleak_test.c", 32, "BIO_read(bio, buf, sizeof(buf))", "sizeof(str)", BIO_read(bio, buf, sizeof(buf)), sizeof(str)))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 34, "buf", "str", buf, sizeof(str), str, sizeof(str)))
        goto finish;
    ok = 1;
...
static int test_bio_get_mem(void)
{
    int ok = 0;
    BIO *bio = 
# 46 "../test/bio_memleak_test.c" 3 4
              ((void *)0)
# 46 "../test/bio_memleak_test.c"
                  ;
    BUF_MEM *bufmem = 
# 47 "../test/bio_memleak_test.c" 3 4
                     ((void *)0)
# 47 "../test/bio_memleak_test.c"
                         ;

    bio = BIO_new(BIO_s_mem());
    if (!test_ptr("../test/bio_memleak_test.c", 50, "bio", bio))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 52, "BIO_puts(bio, \"Hello World\\n\")", "12", BIO_puts(bio, "Hello World\n"), 12))
        goto finish;
    BIO_ctrl(bio,115,0, (char *)(&bufmem));
    if (!test_ptr("../test/bio_memleak_test.c", 55, "bufmem", bufmem))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 57, "BIO_set_close(bio, BIO_NOCLOSE)", "0", (int)BIO_ctrl(bio,9,(0x00),
# 57 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 57 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;
    BIO_free(bio);
    bio = 
# 60 "../test/bio_memleak_test.c" 3 4
         ((void *)0)
# 60 "../test/bio_memleak_test.c"
             ;
    if (!test_mem_eq("../test/bio_memleak_test.c", 61, "bufmem->data", "\"Hello World\\n\"", bufmem->data, bufmem->length, "Hello World\n", 12))
        goto finish;
    ok = 1;
...
static int test_bio_new_mem_buf(void)
{
    ...
    if (!test_ptr("../test/bio_memleak_test.c", 79, "bio", bio))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 81, "BIO_read(bio, data, 5)", "5", BIO_read(bio, data, 5), 5))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 83, "data", "\"Hello\"", data, 5, "Hello", 5))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 85, "BIO_get_mem_ptr(bio, &bufmem)", "0", BIO_ctrl(bio,115,0, (char *)(&bufmem)), 0))
        goto finish;
    if (!test_int_lt("../test/bio_memleak_test.c", 87, "BIO_write(bio, \"test\", 4)", "0", BIO_write(bio, "test", 4), 0))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 89, "BIO_read(bio, data, 16)", "7", BIO_read(bio, data, 16), 7))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 91, "data", "\" World\\n\"", data, 7, " World\n", 7))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 93, "BIO_reset(bio)", "0", (int)BIO_ctrl(bio,1,0,
# 93 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 93 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 95, "BIO_read(bio, data, 16)", "12", BIO_read(bio, data, 16), 12))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 97, "data", "\"Hello World\\n\"", data, 12, "Hello World\n", 12))
        goto finish;
    ok = 1;
...
static int test_bio_rdonly_mem_buf(void)
{
    int ok = 0;
    BIO *bio, *bio2 = 
# 109 "../test/bio_memleak_test.c" 3 4
                     ((void *)0)
# 109 "../test/bio_memleak_test.c"
                         ;
    BUF_MEM *bufmem;
    char data[16];

    bio = BIO_new_mem_buf("Hello World\n", 12);
    if (!test_ptr("../test/bio_memleak_test.c", 114, "bio", bio))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 116, "BIO_read(bio, data, 5)", "5", BIO_read(bio, data, 5), 5))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 118, "data", "\"Hello\"", data, 5, "Hello", 5))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 120, "BIO_get_mem_ptr(bio, &bufmem)", "0", BIO_ctrl(bio,115,0, (char *)(&bufmem)), 0))
        goto finish;
    (void)(int)BIO_ctrl(bio,9,(0x00),
# 122 "../test/bio_memleak_test.c" 3 4
         ((void *)0)
# 122 "../test/bio_memleak_test.c"
         );

    bio2 = BIO_new(BIO_s_mem());
    if (!test_ptr("../test/bio_memleak_test.c", 125, "bio2", bio2))
        goto finish;
    BIO_ctrl(bio2,114,0x01,(char *)(bufmem));
    BIO_set_flags(bio2, 0x200);

    if (!test_int_eq("../test/bio_memleak_test.c", 130, "BIO_read(bio2, data, 16)", "7", BIO_read(bio2, data, 16), 7))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 132, "data", "\" World\\n\"", data, 7, " World\n", 7))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 134, "BIO_reset(bio2)", "0", (int)BIO_ctrl(bio2,1,0,
# 134 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 134 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 136, "BIO_read(bio2, data, 16)", "7", BIO_read(bio2, data, 16), 7))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 138, "data", "\" World\\n\"", data, 7, " World\n", 7))
        goto finish;
    ok = 1;
...
static int test_bio_rdwr_rdonly(void)
{
    int ok = 0;
    BIO *bio = 
# 151 "../test/bio_memleak_test.c" 3 4
              ((void *)0)
# 151 "../test/bio_memleak_test.c"
                  ;
    char data[16];

    bio = BIO_new(BIO_s_mem());
    if (!test_ptr("../test/bio_memleak_test.c", 155, "bio", bio))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 157, "BIO_puts(bio, \"Hello World\\n\")", "12", BIO_puts(bio, "Hello World\n"), 12))
        goto finish;

    BIO_set_flags(bio, 0x200);
    if (!test_int_eq("../test/bio_memleak_test.c", 161, "BIO_read(bio, data, 16)", "12", BIO_read(bio, data, 16), 12))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 163, "data", "\"Hello World\\n\"", data, 12, "Hello World\n", 12))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 165, "BIO_reset(bio)", "0", (int)BIO_ctrl(bio,1,0,
# 165 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 165 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;

    BIO_clear_flags(bio, 0x200);
    if (!test_int_eq("../test/bio_memleak_test.c", 169, "BIO_puts(bio, \"Hi!\\n\")", "4", BIO_puts(bio, "Hi!\n"), 4))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 171, "BIO_read(bio, data, 16)", "16", BIO_read(bio, data, 16), 16))
        goto finish;

    if (!test_mem_eq("../test/bio_memleak_test.c", 174, "data", "\"Hello World\\nHi!\\n\"", data, 16, "Hello World\nHi!\n", 16))
        goto finish;
...
static int test_bio_nonclear_rst(void)
{
    int ok = 0;
    BIO *bio = 
# 187 "../test/bio_memleak_test.c" 3 4
              ((void *)0)
# 187 "../test/bio_memleak_test.c"
                  ;
    char data[16];

    bio = BIO_new(BIO_s_mem());
    if (!test_ptr("../test/bio_memleak_test.c", 191, "bio", bio))
        goto finish;
    if (!test_int_eq("../test/bio_memleak_test.c", 193, "BIO_puts(bio, \"Hello World\\n\")", "12", BIO_puts(bio, "Hello World\n"), 12))
        goto finish;

    BIO_set_flags(bio, 0x400);

    if (!test_int_eq("../test/bio_memleak_test.c", 198, "BIO_read(bio, data, 16)", "12", BIO_read(bio, data, 16), 12))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 200, "data", "\"Hello World\\n\"", data, 12, "Hello World\n", 12))
        goto finish;
    if (!test_int_gt("../test/bio_memleak_test.c", 202, "BIO_reset(bio)", "0", (int)BIO_ctrl(bio,1,0,
# 202 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 202 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;

    if (!test_int_eq("../test/bio_memleak_test.c", 205, "BIO_read(bio, data, 16)", "12", BIO_read(bio, data, 16), 12))
        goto finish;
    if (!test_mem_eq("../test/bio_memleak_test.c", 207, "data", "\"Hello World\\n\"", data, 12, "Hello World\n", 12))
        goto finish;

    BIO_clear_flags(bio, 0x400);
    if (!test_int_gt("../test/bio_memleak_test.c", 211, "BIO_reset(bio)", "0", (int)BIO_ctrl(bio,1,0,
# 211 "../test/bio_memleak_test.c" 3 4
        ((void *)0)
# 211 "../test/bio_memleak_test.c"
        ), 0))
        goto finish;

    if (!test_int_lt("../test/bio_memleak_test.c", 214, "BIO_read(bio, data, 16)", "1", BIO_read(bio, data, 16), 1))
        goto finish;
...
static int test_bio_i2d_ASN1_mime(void)
{
    int ok = 0;
    BIO *bio = 
# 240 "../test/bio_memleak_test.c" 3 4
              ((void *)0)
# 240 "../test/bio_memleak_test.c"
                  , *out = 
# 240 "../test/bio_memleak_test.c" 3 4
                           ((void *)0)
# 240 "../test/bio_memleak_test.c"
    ...
    PKCS7 *p7 = 
# 243 "../test/bio_memleak_test.c" 3 4
               ((void *)0)
# 243 "../test/bio_memleak_test.c"
                   ;

    if (!test_ptr("../test/bio_memleak_test.c", 245, "bio = BIO_new(BIO_s_mem())", bio = BIO_new(BIO_s_mem())))
        goto finish;
    ...
    if (!test_ptr("../test/bio_memleak_test.c", 255, "out = BIO_new(BIO_s_mem())", out = BIO_new(BIO_s_mem())))
        goto finish;
    if (!test_ptr("../test/bio_memleak_test.c", 257, "p7 = PKCS7_new()", p7 = PKCS7_new()))
        goto finish;
    if (!test_true("../test/bio_memleak_test.c", 259, "PKCS7_set_type(p7, NID_pkcs7_data)", (PKCS7_set_type(p7, 21)) != 0))
        goto finish;

    error_callback_fired = 0;

    if (!test_false("../test/bio_memleak_test.c", 264, "i2d_ASN1_bio_stream(out, (ASN1_VALUE*) p7, bio, SMIME_STREAM | SMIME_BINARY, ASN1_ITEM_rptr(PKCS7))", (i2d_ASN1_bio_stream(out, (ASN1_VALUE*) p7, bio, 0x1000 | 0x80, (PKCS7_it()))) != 0)

                                                               )
        goto finish;

    if (!test_int_eq("../test/bio_memleak_test.c", 269, "error_callback_fired", "1", error_callback_fired, 1))
        goto finish;
