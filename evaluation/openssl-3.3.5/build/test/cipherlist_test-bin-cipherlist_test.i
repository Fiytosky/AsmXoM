# 0 "../test/cipherlist_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cipherlist_test.c"
# 11 "../test/cipherlist_test.c"
...
{
    if (fixture != 
# 33 "../test/cipherlist_test.c" 3 4
                  ((void *)0)
# 33 "../test/cipherlist_test.c"
                      ) {
        SSL_CTX_free(fixture->server);
        SSL_CTX_free(fixture->client);
        fixture->server = fixture->client = 
# 36 "../test/cipherlist_test.c" 3 4
                                           ((void *)0)
# 36 "../test/cipherlist_test.c"
                                               ;
        CRYPTO_free(fixture, "../test/cipherlist_test.c", 37);
    }
}
...
static CIPHERLIST_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cipherlist_test.c", 45, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cipherlist_test.c", 45)))
        return 
# 46 "../test/cipherlist_test.c" 3 4
              ((void *)0)
# 46 "../test/cipherlist_test.c"
                  ;
    fixture->test_case_name = test_case_name;
    if (!test_ptr("../test/cipherlist_test.c", 48, "fixture->server = SSL_CTX_new(TLS_server_method())", fixture->server = SSL_CTX_new(TLS_server_method()))
            || !test_ptr("../test/cipherlist_test.c", 49, "fixture->client = SSL_CTX_new(TLS_client_method())", fixture->client = SSL_CTX_new(TLS_client_method()))) {
        tear_down(fixture);
        return 
# 51 "../test/cipherlist_test.c" 3 4
              ((void *)0)
# 51 "../test/cipherlist_test.c"
                  ;
    }
    return fixture;
}
# 65 "../test/cipherlist_test.c"
...
# 150 "../test/cipherlist_test.c" 3 4
                                   ((void *)0)
# 150 "../test/cipherlist_test.c"
                                       ;
    SSL *ssl = 
# 151 "../test/cipherlist_test.c" 3 4
              ((void *)0)
# 151 "../test/cipherlist_test.c"
                  ;
    int i, ret = 0, num_expected_ciphers, num_ciphers;
    uint32_t expected_cipher_id, cipher_id;

    if (ctx == 
# 155 "../test/cipherlist_test.c" 3 4
              ((void *)0)
# 155 "../test/cipherlist_test.c"
                  )
        return 0;

    if (!test_ptr("../test/cipherlist_test.c", 158, "ssl = SSL_new(ctx)", ssl = SSL_new(ctx))
            || !test_ptr("../test/cipherlist_test.c", 159, "ciphers = SSL_get1_supported_ciphers(ssl)", ciphers = SSL_get1_supported_ciphers(ssl)))
        goto err;

    num_expected_ciphers = (sizeof(default_ciphers_in_order)/sizeof((default_ciphers_in_order)[0]));
    num_ciphers = OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(ciphers));
    if (!test_int_eq("../test/cipherlist_test.c", 164, "num_ciphers", "num_expected_ciphers", num_ciphers, num_expected_ciphers))
        goto err;

    for (i = 0; i < num_ciphers; i++) {
        expected_cipher_id = default_ciphers_in_order[i];
        cipher_id = SSL_CIPHER_get_id(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(ciphers), (i))));
        if (!test_int_eq("../test/cipherlist_test.c", 170, "cipher_id", "expected_cipher_id", cipher_id, expected_cipher_id)) {
            test_info("../test/cipherlist_test.c", 171, "Wrong cipher at position %d", i);
            goto err;
        }
    }
 ...
 err:
    OPENSSL_sk_free(ossl_check_SSL_CIPHER_sk_type(ciphers));
    SSL_free(ssl);
    return ret;
}
...
{
    return fixture != 
# 186 "../test/cipherlist_test.c" 3 4
                     ((void *)0)
        
# 187 "../test/cipherlist_test.c"
...
{
    CIPHERLIST_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 199 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 199 "../test/cipherlist_test.c"
   ) return 0;
    if (fixture != 
# 200 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 200 "../test/cipherlist_test.c"
...
{
    CIPHERLIST_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 206 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 206 "../test/cipherlist_test.c"
   ) return 0;
    if (!test_true("../test/cipherlist_test.c", 207, "SSL_CTX_set_cipher_list(fixture->server, \"DEFAULT\")", (SSL_CTX_set_cipher_list(fixture->server, "DEFAULT")) != 0)
            || !test_true("../test/cipherlist_test.c", 208, "SSL_CTX_set_cipher_list(fixture->client, \"DEFAULT\")", (SSL_CTX_set_cipher_list(fixture->client, "DEFAULT")) != 0)) {
        tear_down(fixture);
        fixture = 
# 210 "../test/cipherlist_test.c" 3 4
                 ((void *)0)
# 210 "../test/cipherlist_test.c"
                     ;
    }
    if (fixture != 
# 212 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 212 "../test/cipherlist_test.c"
   ) { result = execute_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    SSL *s = 
# 219 "../test/cipherlist_test.c" 3 4
            ((void *)0)
# 219 "../test/cipherlist_test.c"
                ;
    CIPHERLIST_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 220 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 220 "../test/cipherlist_test.c"
   ) return 0;

    if (!test_int_eq("../test/cipherlist_test.c", 222, "SSL_CTX_set_cipher_list(fixture->server, \"no-such\")", "0", SSL_CTX_set_cipher_list(fixture->server, "no-such"), 0))
        goto end;

    if (!test_int_eq("../test/cipherlist_test.c", 225, "ERR_GET_REASON(ERR_get_error())", "SSL_R_NO_CIPHER_MATCH", ERR_GET_REASON(ERR_get_error()), 185))
        goto end;

    s = SSL_new(fixture->client);

    if (!test_ptr("../test/cipherlist_test.c", 230, "s", s))
      goto end;

    if (!test_int_eq("../test/cipherlist_test.c", 233, "SSL_set_cipher_list(s, \"no-such\")", "0", SSL_set_cipher_list(s, "no-such"), 0))
        goto end;

    if (!test_int_eq("../test/cipherlist_test.c", 236, "ERR_GET_REASON(ERR_get_error())", "SSL_R_NO_CIPHER_MATCH", ERR_GET_REASON(ERR_get_error()), 185)
                                      )
        goto end;
...
{
    CIPHERLIST_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 250 "../test/cipherlist_test.c" 3 4
   ((void *)0)
# 250 "../test/cipherlist_test.c"
   ) return 0;
    if (!test_true("../test/cipherlist_test.c", 251, "SSL_CTX_set_cipher_list(fixture->server, TLS1_RFC_RSA_WITH_AES_128_SHA)", (SSL_CTX_set_cipher_list(fixture->server, "TLS_RSA_WITH_AES_128_CBC_SHA")) != 0)
            || !test_true("../test/cipherlist_test.c", 252, "SSL_CTX_set_cipher_list(fixture->client, TLS1_RFC_RSA_WITH_AES_128_SHA)", (SSL_CTX_set_cipher_list(fixture->client, "TLS_RSA_WITH_AES_128_CBC_SHA")) != 0)) {
        goto end;
    }
    result = 1;
end:
    tear_down(fixture);
    fixture = 
# 258 "../test/cipherlist_test.c" 3 4
             ((void *)0)
# 258 "../test/cipherlist_test.c"
                 ;
    return result;
}
