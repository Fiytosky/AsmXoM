# 0 "../test/asn1_dsa_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_dsa_internal_test.c"
# 10 "../test/asn1_dsa_internal_test.c"
...
# 11 "../test/asn1_dsa_internal_test.c" 2
...
# 12 "../test/asn1_dsa_internal_test.c" 2
...
# 14 "../test/asn1_dsa_internal_test.c" 2
...
size_t ossl_decode_der_dsa_sig(BIGNUM *r, BIGNUM *s, const unsigned char **ppin,
                               size_t len);
# 15 "../test/asn1_dsa_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 13 "../test/testutil.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
...
# 16 "../test/asn1_dsa_internal_test.c" 2
...
static int test_decode(void)
{
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_dsa_sig)) == 0
            || !test_ptr_eq("../test/asn1_dsa_internal_test.c", 97, "pder", "(t_dsa_sig + sizeof(t_dsa_sig))", pder, (t_dsa_sig + sizeof(t_dsa_sig)))
            || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 98, "r", "1", r, 1) || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 98, "s", "2", s, 2)) {
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_dsa_sig_extra)) == 0
            || !test_ptr_eq("../test/asn1_dsa_internal_test.c", 107, "pder", "(t_dsa_sig_extra + sizeof(t_dsa_sig_extra) - 2)", pder, (t_dsa_sig_extra + sizeof(t_dsa_sig_extra) - 2))

            || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 109, "r", "1", r, 1) || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 109, "s", "2", s, 2)) {
        test_info("../test/asn1_dsa_internal_test.c", 110, "asn1_dsa test_decode: t_dsa_sig_extra failed");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_dsa_sig_msb)) == 0
            || !test_ptr_eq("../test/asn1_dsa_internal_test.c", 118, "pder", "(t_dsa_sig_msb + sizeof(t_dsa_sig_msb))", pder, (t_dsa_sig_msb + sizeof(t_dsa_sig_msb)))
            || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 119, "r", "0x81", r, 0x81) || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 119, "s", "0x82", s, 0x82)) {
        test_info("../test/asn1_dsa_internal_test.c", 120, "asn1_dsa test_decode: t_dsa_sig_msb failed");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_dsa_sig_two)) == 0
            || !test_ptr_eq("../test/asn1_dsa_internal_test.c", 128, "pder", "(t_dsa_sig_two + sizeof(t_dsa_sig_two))", pder, (t_dsa_sig_two + sizeof(t_dsa_sig_two)))
            || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 129, "r", "0x100", r, 0x100) || !test_BN_eq_word("../test/asn1_dsa_internal_test.c", 129, "s", "0x200", s, 0x200)) {
        test_info("../test/asn1_dsa_internal_test.c", 130, "asn1_dsa test_decode: t_dsa_sig_two failed");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_invalid_int_zero)) != 0) {
        test_info("../test/asn1_dsa_internal_test.c", 137, "asn1_dsa test_decode: Expected t_invalid_int_zero to fail");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_invalid_int)) != 0) {
        test_info("../test/asn1_dsa_internal_test.c", 145, "asn1_dsa test_decode: Expected t_invalid_int to fail");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_neg_int)) != 0) {
        test_info("../test/asn1_dsa_internal_test.c", 153, "asn1_dsa test_decode: Expected t_neg_int to fail");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_trunc_der)) != 0) {
        test_info("../test/asn1_dsa_internal_test.c", 161, "asn1_dsa test_decode: Expected fail t_trunc_der");
        goto fail;
    }
    ...
    if (ossl_decode_der_dsa_sig(r, s, &pder, sizeof(t_trunc_seq)) != 0) {
        test_info("../test/asn1_dsa_internal_test.c", 169, "asn1_dsa test_decode: Expected fail t_trunc_seq");
        goto fail;
    }
