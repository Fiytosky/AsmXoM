# 0 "../test/evp_pkey_dparams_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/evp_pkey_dparams_test.c"
# 10 "../test/evp_pkey_dparams_test.c"
...
# 11 "../test/evp_pkey_dparams_test.c" 2
...
# 12 "../test/evp_pkey_dparams_test.c" 2
...
# 13 "../test/evp_pkey_dparams_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../test/evp_pkey_dparams_test.c" 2
...
# 16 "../test/evp_pkey_dparams_test.c" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 17 "../test/evp_pkey_dparams_test.c" 2
...
# 18 "../test/evp_pkey_dparams_test.c" 2
...
int RAND_poll(void);
# 19 "../test/evp_pkey_dparams_test.c" 2
...
# 20 "../test/evp_pkey_dparams_test.c" 2
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 22 "../test/evp_pkey_dparams_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 23 "../test/evp_pkey_dparams_test.c" 2
...
static const struct {
    ...
    struct pubkey keys[10];
} pkey_params [] = {

    { 28, dhparam_bin, sizeof(dhparam_bin),
    ...
    { 116, dsaparam_bin, sizeof(dsaparam_bin) },


    { 408, ecparam_bin, sizeof(ecparam_bin),
...
static int params_bio_test(int id)
{
    int ret, out_len;
    BIO *in = 
# 248 "../test/evp_pkey_dparams_test.c" 3 4
             ((void *)0)
# 248 "../test/evp_pkey_dparams_test.c"
                 , *out = 
# 248 "../test/evp_pkey_dparams_test.c" 3 4
                          ((void *)0)
# 248 "../test/evp_pkey_dparams_test.c"
                              ;
    EVP_PKEY *in_key = 
# 249 "../test/evp_pkey_dparams_test.c" 3 4
                      ((void *)0)
# 249 "../test/evp_pkey_dparams_test.c"
                          , *out_key = 
# 249 "../test/evp_pkey_dparams_test.c" 3 4
                                       ((void *)0)
# 249 "../test/evp_pkey_dparams_test.c"
    ...
    ret = test_ptr("../test/evp_pkey_dparams_test.c", 253, "in = BIO_new_mem_buf(pkey_params[id].param_bin, (int)pkey_params[id].param_bin_len)", in = BIO_new_mem_buf(pkey_params[id].param_bin, (int)pkey_params[id].param_bin_len))


        && test_ptr("../test/evp_pkey_dparams_test.c", 256, "d2i_KeyParams_bio(type, &in_key, in)", d2i_KeyParams_bio(type, &in_key, in))
        && test_ptr("../test/evp_pkey_dparams_test.c", 257, "out = BIO_new(BIO_s_mem())", out = BIO_new(BIO_s_mem()))

        && test_int_gt("../test/evp_pkey_dparams_test.c", 259, "i2d_KeyParams_bio(out, in_key)", "0", i2d_KeyParams_bio(out, in_key), 0)

        && test_int_gt("../test/evp_pkey_dparams_test.c", 261, "out_len = BIO_get_mem_data(out, &out_bin)", "0", out_len = BIO_ctrl(out,3,0,(char *)(&out_bin)), 0)
        && test_mem_eq("../test/evp_pkey_dparams_test.c", 262, "pkey_params[id].param_bin", "out_bin", pkey_params[id].param_bin, (int)pkey_params[id].param_bin_len, out_bin, out_len)
...
static int set_enc_pubkey_test(int id)
{
    int ret, i;
    BIO *in = 
# 276 "../test/evp_pkey_dparams_test.c" 3 4
             ((void *)0)
# 276 "../test/evp_pkey_dparams_test.c"
                 ;
    EVP_PKEY *in_key = 
# 277 "../test/evp_pkey_dparams_test.c" 3 4
                      ((void *)0)
# 277 "../test/evp_pkey_dparams_test.c"
                          ;
    int type = pkey_params[id].type;
    const struct pubkey *keys = pkey_params[id].keys;

    if (keys[0].key_bin == 
# 281 "../test/evp_pkey_dparams_test.c" 3 4
                          ((void *)0)
# 281 "../test/evp_pkey_dparams_test.c"
                              )
        return test_skip("../test/evp_pkey_dparams_test.c", 282, "Not applicable test");

    ret = test_ptr("../test/evp_pkey_dparams_test.c", 284, "in = BIO_new_mem_buf(pkey_params[id].param_bin, (int)pkey_params[id].param_bin_len)", in = BIO_new_mem_buf(pkey_params[id].param_bin, (int)pkey_params[id].param_bin_len))


        && test_ptr("../test/evp_pkey_dparams_test.c", 287, "d2i_KeyParams_bio(type, &in_key, in)", d2i_KeyParams_bio(type, &in_key, in));

    for (i = 0; ret && i < 10 && keys[i].key_bin != 
# 289 "../test/evp_pkey_dparams_test.c" 3 4
                                                         ((void *)0)
# 289 "../test/evp_pkey_dparams_test.c"
                                                             ; i++) {
        if (keys[i].bad) {
            ERR_set_mark();
            ret = ret
                && test_int_le("../test/evp_pkey_dparams_test.c", 293, "EVP_PKEY_set1_encoded_public_key(in_key, keys[i].key_bin, keys[i].key_bin_len)", "0", EVP_PKEY_set1_encoded_public_key(in_key, keys[i].key_bin, keys[i].key_bin_len), 0)
            ...
            ret = ret
                && test_int_gt("../test/evp_pkey_dparams_test.c", 300, "EVP_PKEY_set1_encoded_public_key(in_key, keys[i].key_bin, keys[i].key_bin_len)", "0", EVP_PKEY_set1_encoded_public_key(in_key, keys[i].key_bin, keys[i].key_bin_len), 0)


                                 ;
        }
        if (!ret)
            test_info("../test/evp_pkey_dparams_test.c", 306, "Test key index #%d", i);
    }
...
int setup_tests(void)
{
    ...
    add_all_tests("params_bio_test", params_bio_test, (sizeof(pkey_params)/sizeof((pkey_params)[0])), 1);
    add_all_tests("set_enc_pubkey_test", set_enc_pubkey_test, (sizeof(pkey_params)/sizeof((pkey_params)[0])), 1);
