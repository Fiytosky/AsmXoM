# 0 "../test/x509_dup_cert_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/x509_dup_cert_test.c"
# 11 "../test/x509_dup_cert_test.c"
...
# 12 "../test/x509_dup_cert_test.c" 2
...
# 13 "../test/x509_dup_cert_test.c" 2
...
# 14 "../test/x509_dup_cert_test.c" 2
...
# 16 "../test/x509_dup_cert_test.c" 2

static int test_509_dup_cert(int n)
{
    int ret = 0;
    X509_STORE *store = 
# 20 "../test/x509_dup_cert_test.c" 3 4
                       ((void *)0)
# 20 "../test/x509_dup_cert_test.c"
                           ;
    X509_LOOKUP *lookup = 
# 21 "../test/x509_dup_cert_test.c" 3 4
                         ((void *)0)
# 21 "../test/x509_dup_cert_test.c"
                             ;
    const char *cert_f = test_get_argument(n);

    if (test_ptr("../test/x509_dup_cert_test.c", 24, "store = X509_STORE_new()", store = X509_STORE_new())
        && test_ptr("../test/x509_dup_cert_test.c", 25, "lookup = X509_STORE_add_lookup(store, X509_LOOKUP_file())", lookup = X509_STORE_add_lookup(store, X509_LOOKUP_file()))
        && test_true("../test/x509_dup_cert_test.c", 26, "X509_load_cert_file(lookup, cert_f, X509_FILETYPE_PEM)", (X509_load_cert_file(lookup, cert_f, 1)) != 0)
        && test_true("../test/x509_dup_cert_test.c", 27, "X509_load_cert_file(lookup, cert_f, X509_FILETYPE_PEM)", (X509_load_cert_file(lookup, cert_f, 1)) != 0))
        ret = 1;
...
# 34 "../test/x509_dup_cert_test.c" 3 4
((void *)0) 
# 34 "../test/x509_dup_cert_test.c"
} }; return options; }
...
int setup_tests(void)
{
    ...
    if (!test_skip_common_options()) {
        test_error("../test/x509_dup_cert_test.c", 41, "Error parsing test options\n");
        return 0;
    }

    n = test_get_argument_count();
    if (!test_int_gt("../test/x509_dup_cert_test.c", 46, "n", "0", n, 0))
        return 0;

    add_all_tests("test_509_dup_cert", test_509_dup_cert, n, 1);
    return 1;
}
