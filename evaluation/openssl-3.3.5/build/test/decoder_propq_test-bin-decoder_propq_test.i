# 0 "../test/decoder_propq_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/decoder_propq_test.c"
# 10 "../test/decoder_propq_test.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 11 "../test/decoder_propq_test.c" 2
...
# 13 "../test/decoder_propq_test.c" 2

static OSSL_LIB_CTX *libctx = 
# 14 "../test/decoder_propq_test.c" 3 4
                             ((void *)0)
# 14 "../test/decoder_propq_test.c"
                                 ;
static OSSL_PROVIDER *nullprov = 
# 15 "../test/decoder_propq_test.c" 3 4
                                ((void *)0)
# 15 "../test/decoder_propq_test.c"
                                    ;
static OSSL_PROVIDER *libprov = 
# 16 "../test/decoder_propq_test.c" 3 4
                               ((void *)0)
# 16 "../test/decoder_propq_test.c"
                                   ;
static const char *filename = 
# 17 "../test/decoder_propq_test.c" 3 4
                             ((void *)0)
# 17 "../test/decoder_propq_test.c"
                                 ;
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 37 "../test/decoder_propq_test.c" 3 4
         ((void *)0) 
# 37 "../test/decoder_propq_test.c"
              }
    };
    return test_options;
}
...
static int test_decode_nonfipsalg(void)
{
    int ret = 0;
    EVP_PKEY *privkey = 
# 51 "../test/decoder_propq_test.c" 3 4
                       ((void *)0)
# 51 "../test/decoder_propq_test.c"
                           ;
    BIO *bio = 
# 52 "../test/decoder_propq_test.c" 3 4
              ((void *)0)
# 52 "../test/decoder_propq_test.c"
                  ;
    ...
    if (!test_ptr("../test/decoder_propq_test.c", 60, "bio = BIO_new_file(filename, \"r\")", bio = BIO_new_file(filename, "r")))
        goto err;
    ...
    if (!test_ptr_null("../test/decoder_propq_test.c", 67, "PEM_read_bio_PrivateKey_ex(bio, &privkey, &passcb, NULL, libctx, NULL)", PEM_read_bio_PrivateKey_ex(bio, &privkey, &passcb, 
# 67 "../test/decoder_propq_test.c" 3 4
        ((void *)0)
# 67 "../test/decoder_propq_test.c"
        , libctx, 
# 67 "../test/decoder_propq_test.c" 3 4
        ((void *)0)
# 67 "../test/decoder_propq_test.c"
    ...
    if (!test_ptr_null("../test/decoder_propq_test.c", 74, "PEM_read_bio_PrivateKey_ex(bio, &privkey, &passcb, NULL, libctx, \"?fips=true\")", PEM_read_bio_PrivateKey_ex(bio, &privkey, &passcb, 
# 74 "../test/decoder_propq_test.c" 3 4
        ((void *)0)
# 74 "../test/decoder_propq_test.c"
        , libctx, "?fips=true")))
        goto err;
...
int setup_tests(void)
{
    ...
    char *config_file = 
# 87 "../test/decoder_propq_test.c" 3 4
                       ((void *)0)
# 87 "../test/decoder_propq_test.c"
                           ;
    OPTION_CHOICE o;
    ...
    add_test("test_decode_nonfipsalg", test_decode_nonfipsalg);
    return 1;
}
