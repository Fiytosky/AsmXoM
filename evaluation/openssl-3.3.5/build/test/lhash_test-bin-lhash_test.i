...
# 17 "../test/lhash_test.c" 2


# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 20 "../test/lhash_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 21 "../test/lhash_test.c" 2
# 30 "../test/lhash_test.c"
struct lhash_st_int { union lh_int_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_int_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const int *) = (unsigned long (*)(const int *))hfn; return hfn_conv((const int *)data); } static int lh_int_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const int *, const int *) = (int (*)(const int *, const int *))cfn; return cfn_conv((const int *)da, (const int *)db); } static __attribute__((unused)) inline void lh_int_free(struct lhash_st_int *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_int_flush(struct lhash_st_int *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline int * lh_int_insert(struct lhash_st_int *lh, int *d) { return (int *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int * lh_int_delete(struct lhash_st_int *lh, const int *d) { return (int *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int * lh_int_retrieve(struct lhash_st_int *lh, const int *d) { return (int *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_int_error(struct lhash_st_int *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_int_num_items(struct lhash_st_int *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_int_get_down_load(struct lhash_st_int *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_int_set_down_load(struct lhash_st_int *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_int_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(int *) = (void (*)(int *))doall; doall_conv((int *)node); } static __attribute__((unused)) inline void lh_int_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(int *, void *) = (void (*)(int *, void *))doall; doall_conv((int *)node, arg); } static __attribute__((unused)) inline void lh_int_doall(struct lhash_st_int *lh, void (*doall)(int *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_int * lh_int_new(unsigned long (*hfn)(const int *), int (*cfn)(const int *, const int *)) { return (struct lhash_st_int *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_int_hfn_thunk, lh_int_cfn_thunk, lh_int_doall_thunk, lh_int_doall_arg_thunk); } static __attribute__((unused)) inline void lh_int_doall_arg(struct lhash_st_int *lh, void (*doallarg)(int *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_int;

static int int_tests[] = { 65537, 13, 1, 3, -5, 6, 7, 4, -10, -12, -14, 22, 9,
                           -17, 16, 17, -23, 35, 37, 173, 11 };
static const unsigned int n_int_tests = (sizeof(int_tests)/sizeof((int_tests)[0]));
static short int_found[(sizeof(int_tests)/sizeof((int_tests)[0]))];
...
static __attribute__((unused)) inline void lh_int_doall_short_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(int *, short *) = (void (*)(int *, short *))fn; fn_conv((int *)node, (short *)arg); } static __attribute__((unused)) inline void lh_int_doall_short(struct lhash_st_int *lh, void (*fn)(int *, short *), short *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_int_doall_short_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_int;
...
static int test_int_lhash(void)
{
    ...
    const unsigned int n_dels = (sizeof(dels)/sizeof((dels)[0]));
    struct lhash_st_int *h = lh_int_new(&int_hash, &int_cmp);
    unsigned int i;
    int testresult = 0, j, *p;

    if (!test_ptr("../test/lhash_test.c", 98, "h", h))
        goto end;


    for (i = 0; i < n_int_tests; i++)
        if (!test_ptr_null("../test/lhash_test.c", 103, "lh_int_insert(h, int_tests + i)", lh_int_insert(h, int_tests + i))) {
            test_info("../test/lhash_test.c", 104, "int insert %d", i);
            goto end;
        }


    if (!test_int_eq("../test/lhash_test.c", 109, "lh_int_num_items(h)", "n_int_tests", lh_int_num_items(h), n_int_tests))
        goto end;


    for (i = 0; i < n_int_tests; i++)
        if (!test_int_eq("../test/lhash_test.c", 114, "*lh_int_retrieve(h, int_tests + i)", "int_tests[i]", *lh_int_retrieve(h, int_tests + i), int_tests[i])) {
            test_info("../test/lhash_test.c", 115, "lhash int retrieve value %d", i);
            goto end;
        }
    for (i = 0; i < n_int_tests; i++)
        if (!test_ptr_eq("../test/lhash_test.c", 119, "lh_int_retrieve(h, int_tests + i)", "int_tests + i", lh_int_retrieve(h, int_tests + i), int_tests + i)) {
            test_info("../test/lhash_test.c", 120, "lhash int retrieve address %d", i);
            goto end;
        }
    j = 1;
    if (!test_ptr_eq("../test/lhash_test.c", 124, "lh_int_retrieve(h, &j)", "int_tests + 2", lh_int_retrieve(h, &j), int_tests + 2))
        goto end;


    j = 13;
    if (!test_ptr("../test/lhash_test.c", 129, "p = lh_int_insert(h, &j)", p = lh_int_insert(h, &j)))
        goto end;
    if (!test_ptr_eq("../test/lhash_test.c", 131, "p", "int_tests + 1", p, int_tests + 1))
        goto end;
    if (!test_ptr_eq("../test/lhash_test.c", 133, "lh_int_retrieve(h, int_tests + 1)", "&j", lh_int_retrieve(h, int_tests + 1), &j))
        goto end;
    ...
    if (!test_int_eq("../test/lhash_test.c", 140, "int_not_found", "0", int_not_found, 0)) {
        test_info("../test/lhash_test.c", 141, "lhash int doall encountered a not found condition");
        goto end;
    }
    for (i = 0; i < n_int_tests; i++)
        if (!test_int_eq("../test/lhash_test.c", 145, "int_found[i]", "1", int_found[i], 1)) {
            test_info("../test/lhash_test.c", 146, "lhash int doall %d", i);
            goto end;
        }
    ...
    if (!test_int_eq("../test/lhash_test.c", 154, "int_not_found", "0", int_not_found, 0)) {
        test_info("../test/lhash_test.c", 155, "lhash int doall arg encountered a not found condition");
        goto end;
    }
    for (i = 0; i < n_int_tests; i++)
        if (!test_int_eq("../test/lhash_test.c", 159, "int_found[i]", "1", int_found[i], 1)) {
            test_info("../test/lhash_test.c", 160, "lhash int doall arg %d", i);
            goto end;
        }


    for (i = 0; i < n_dels; i++) {
        const int b = lh_int_delete(h, &dels[i].data) == 
# 166 "../test/lhash_test.c" 3 4
                                                        ((void *)0)
# 166 "../test/lhash_test.c"
                                                            ;
        if (!test_int_eq("../test/lhash_test.c", 167, "b ^ dels[i].null", "0", b ^ dels[i].null, 0)) {
            test_info("../test/lhash_test.c", 168, "lhash int delete %d", i);
            goto end;
        }
    }


    if (!test_int_eq("../test/lhash_test.c", 174, "lh_int_error(h)", "0", lh_int_error(h), 0))
        goto end;
...
{
    struct lhash_st_int *h = lh_int_new(&stress_hash, &int_cmp);
    const unsigned int n = 2500000;
    unsigned int i;
    int testresult = 0, *p;

    if (!test_ptr("../test/lhash_test.c", 195, "h", h))
        goto end;


    for (i = 0; i < n; i++) {
        p = CRYPTO_malloc(sizeof(i), "../test/lhash_test.c", 200);
        if (!test_ptr("../test/lhash_test.c", 201, "p", p)) {
            test_info("../test/lhash_test.c", 202, "lhash stress out of memory %d", i);
            goto end;
        }
        *p = 3 * i + 1;
        lh_int_insert(h, p);
    ...
    if (!test_int_eq("../test/lhash_test.c", 210, "lh_int_num_items(h)", "n", lh_int_num_items(h), n))
            goto end;
    ...
    for (i = 0; i < n; i++) {
        ...
        if (!test_ptr("../test/lhash_test.c", 217, "p = lh_int_delete(h, &j)", p = lh_int_delete(h, &j))) {
            test_info("../test/lhash_test.c", 218, "lhash stress delete %d\n", i);
            goto end;
        }
        if (!test_int_eq("../test/lhash_test.c", 221, "*p", "j", *p, j)) {
            test_info("../test/lhash_test.c", 222, "lhash stress bad value %d", i);
            goto end;
        }
        CRYPTO_free(p, "../test/lhash_test.c", 225);
    }
