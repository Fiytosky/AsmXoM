...
# 14 "../test/drbgtest.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../test/drbgtest.c" 2
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 21 "../test/drbgtest.c" 2
# 1 "../test/../crypto/rand/rand_local.h" 1
# 15 "../test/../crypto/rand/rand_local.h"
...
# 16 "../test/../crypto/rand/rand_local.h" 2
...
# 17 "../test/../crypto/rand/rand_local.h" 2
...
extern void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 18 "../test/../crypto/rand/rand_local.h" 2
...
# 20 "../test/../crypto/rand/rand_local.h" 2
...
uint32_t ossl_rand_range_uint32(OSSL_LIB_CTX *ctx, uint32_t lower, uint32_t upper,
                                int *err);
# 21 "../test/../crypto/rand/rand_local.h" 2
# 30 "../test/../crypto/rand/rand_local.h"
extern RAND_METHOD ossl_rand_meth;
# 22 "../test/drbgtest.c" 2

# 1 "../test/../include/crypto/evp.h" 1
# 12 "../test/../include/crypto/evp.h"
...
# 17 "../test/../include/crypto/evp.h" 2
...
# 18 "../test/../include/crypto/evp.h" 2
# 40 "../test/../include/crypto/evp.h"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 24 "../test/drbgtest.c" 2
# 1 "../test/../providers/implementations/rands/drbg_local.h" 1
# 15 "../test/../providers/implementations/rands/drbg_local.h"
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../test/../providers/implementations/rands/drbg_local.h" 2
...
# 20 "../test/../providers/implementations/rands/drbg_local.h" 2
...
# 21 "../test/../providers/implementations/rands/drbg_local.h" 2
# 56 "../test/../providers/implementations/rands/drbg_local.h"
...
# 124 "../test/../providers/implementations/rands/drbg_local.h"
    unsigned int strength;
    size_t max_request;
...
# 158 "../test/../providers/implementations/rands/drbg_local.h"
    _Atomic unsigned int reseed_counter;
...
# 220 "../test/../providers/implementations/rands/drbg_local.h"
...
# 250 "../test/../providers/implementations/rands/drbg_local.h"
...
int ossl_drbg_verify_digest(__attribute__((unused)) OSSL_LIB_CTX *libctx, const EVP_MD *md);
# 25 "../test/drbgtest.c" 2
# 1 "../test/../crypto/evp/evp_local.h" 1
# 16 "../test/../crypto/evp/evp_local.h"
...
# 1 "../include/openssl/types.h" 1
# 265 "../test/../crypto/evp/evp_local.h" 2
...
int evp_cipher_set_asn1_aead_params(EVP_CIPHER_CTX *c, ASN1_TYPE *type,
                                    evp_cipher_aead_asn1_params *asn1_params);
# 331 "../test/../crypto/evp/evp_local.h"
...
# 362 "../test/../crypto/evp/evp_local.h"
...
static int gen_bytes(EVP_RAND_CTX *drbg, unsigned char *buf, int num)
{
    ...
    if (meth != 
# 47 "../test/drbgtest.c" 3 4
               ((void *)0) 
# 47 "../test/drbgtest.c"
                    && meth != RAND_OpenSSL()) {
        if (meth->bytes != 
# 48 "../test/drbgtest.c" 3 4
                          ((void *)0)
# 48 "../test/drbgtest.c"
                              )
    ...
    if (drbg != 
# 54 "../test/drbgtest.c" 3 4
               ((void *)0)
# 54 "../test/drbgtest.c"
                   )
        return EVP_RAND_generate(drbg, buf, num, 0, 0, 
# 55 "../test/drbgtest.c" 3 4
                                                      ((void *)0)
# 55 "../test/drbgtest.c"
                                                          , 0);
    return 0;
...
{
    return gen_bytes(RAND_get0_public(
# 61 "../test/drbgtest.c" 3 4
                                     ((void *)0)
# 61 "../test/drbgtest.c"
                                         ), buf, num);
}
...
{
    return gen_bytes(RAND_get0_private(
# 66 "../test/drbgtest.c" 3 4
                                      ((void *)0)
# 66 "../test/drbgtest.c"
                                          ), buf, num);
}
...
static unsigned int reseed_counter(EVP_RAND_CTX *drbg) { return query_rand_uint(drbg, "reseed_counter"); }
...
# 118 "../test/drbgtest.c"
    ...
    *params = OSSL_PARAM_construct_time_t("reseed_time", &t);
    if (EVP_RAND_CTX_get_params(drbg, params))
        return t;
    return 0;
}
...
{
    EVP_RAND_CTX *primary = RAND_get0_primary(
# 134 "../test/drbgtest.c" 3 4
                                             ((void *)0)
# 134 "../test/drbgtest.c"
                                                 );
    ...
    if (!test_ptr("../test/drbgtest.c", 138, "primary", primary))
        return 0;

    prov = EVP_RAND_get0_provider(EVP_RAND_CTX_get0_rand(primary));
    if (!test_ptr("../test/drbgtest.c", 142, "prov", prov))
        return 0;
...
# 194 "../test/drbgtest.c"
    ...
    if (!test_int_ne("../test/drbgtest.c", 202, "primary_reseed = reseed_counter(primary)", "0", primary_reseed = reseed_counter(primary), 0)
        || !test_int_ne("../test/drbgtest.c", 203, "public_reseed = reseed_counter(public)", "0", public_reseed = reseed_counter(public), 0)
        || !test_int_ne("../test/drbgtest.c", 204, "private_reseed = reseed_counter(private)", "0", private_reseed = reseed_counter(private), 0))
        return 0;
...
# 212 "../test/drbgtest.c"
    ...
    if (!test_int_eq("../test/drbgtest.c", 216, "rand_bytes((unsigned char*)public_random, RANDOM_SIZE)", "expect_success", rand_bytes((unsigned char*)public_random, 16), expect_success)

        || !test_int_eq("../test/drbgtest.c", 218, "rand_priv_bytes((unsigned char*) private_random, RANDOM_SIZE)", "expect_success", rand_priv_bytes((unsigned char*) private_random, 16), expect_success)
                                                                     )
        return 0;
    after_reseed = time(
# 221 "../test/drbgtest.c" 3 4
                       ((void *)0)
# 221 "../test/drbgtest.c"
                           );
    ...
    if (!test_int_eq("../test/drbgtest.c", 229, "state(primary)", "expected_state", state(primary), expected_state)
        || !test_int_eq("../test/drbgtest.c", 230, "state(public)", "expected_state", state(public), expected_state)
        || !test_int_eq("../test/drbgtest.c", 231, "state(private)", "expected_state", state(private), expected_state))
        return 0;

    if (expect_primary_reseed >= 0) {

        if (!test_int_ge("../test/drbgtest.c", 236, "reseed_counter(primary)", "primary_reseed", reseed_counter(primary), primary_reseed))
            return 0;
    }

    if (expect_public_reseed >= 0) {

        if (!test_int_ge("../test/drbgtest.c", 242, "reseed_counter(public)", "public_reseed", reseed_counter(public), public_reseed)
                || !test_uint_ge("../test/drbgtest.c", 243, "reseed_counter(public)", "reseed_counter(primary)", reseed_counter(public), reseed_counter(primary))
                                                         )
            return 0;
    }
    ...
    if (expect_private_reseed >= 0) {
        ...
        if (!test_int_ge("../test/drbgtest.c", 250, "reseed_counter(private)", "private_reseed", reseed_counter(private), private_reseed)
                || !test_uint_ge("../test/drbgtest.c", 251, "reseed_counter(private)", "reseed_counter(primary)", reseed_counter(private), reseed_counter(primary))
                                                         )
            return 0;
    }
    ...
    if (expect_success == 1) {
        ...
        if (!test_time_t_le("../test/drbgtest.c", 258, "before_reseed", "reseed_time(primary)", before_reseed, reseed_time(primary))
            || !test_time_t_le("../test/drbgtest.c", 259, "reseed_time(primary)", "after_reseed", reseed_time(primary), after_reseed))
            return 0;


        if (!test_time_t_ge("../test/drbgtest.c", 263, "reseed_time(public)", "reseed_time(primary)", reseed_time(public), reseed_time(primary))
            || !test_time_t_ge("../test/drbgtest.c", 264, "reseed_time(private)", "reseed_time(primary)", reseed_time(private), reseed_time(primary)))
            return 0;
    } else {
        ERR_clear_error();
    }
...
static int compare_drbg_fork_result(const void *left, const void *right)
{
    ...
    if (result == 0)
        result = memcmp(l->random, r->random, 16);
                                     ...
                                     drbg_fork_result result[2])
{
    ...
    int fd[2];
    pid_t pid;
    unsigned char random[2 * 16];

    if (!test_int_ge("../test/drbgtest.c", 340, "pipe(fd)", "0", pipe(fd), 0))
        return 0;

    if (!test_int_ge("../test/drbgtest.c", 343, "pid = fork()", "0", pid = fork(), 0)) {
        close(fd[0]);
        close(fd[1]);
        return 0;
    } else if (pid > 0) {
        ...
        if (test_int_eq("../test/drbgtest.c", 353, "waitpid(pid, &status, 0)", "pid", waitpid(pid, &status, 0), pid)
            && test_int_eq("../test/drbgtest.c", 354, "status", "0", status, 0)
            && test_true("../test/drbgtest.c", 355, "read(fd[0], &random[0], sizeof(random)) == sizeof(random)", (read(fd[0], &random[0], sizeof(random)) == sizeof(random)) != 0)
                                            ) {


            result[0].pid = pid;
            result[0].private = 0;
            memcpy(result[0].random, &random[0], 16);


            result[1].pid = pid;
            result[1].private = 1;
            memcpy(result[1].random, &random[16], 16);
        ...
        if (test_true("../test/drbgtest.c", 382, "test_drbg_reseed(1, primary, public, private, &random[0], &random[RANDOM_SIZE], 1, 1, 1, 0)", (test_drbg_reseed(1, primary, public, private, &random[0], &random[16], 1, 1, 1, 0)) != 0)


            && test_true("../test/drbgtest.c", 385, "write(fd[1], random, sizeof(random)) == sizeof(random)", (write(fd[1], random, sizeof(random)) == sizeof(random)) != 0)
                                           ) {
                                    ...
                                    EVP_RAND_CTX *private)
{
    unsigned int i;
    pid_t pid = getpid();
    int verbose = (getenv("V") != 
# 405 "../test/drbgtest.c" 3 4
                                 ((void *)0)
# 405 "../test/drbgtest.c"
                                     );
    int success = 1;
    int duplicate[2] = {0, 0};
    unsigned char random[2 * 16];
    unsigned char sample[(2 * (9 + 1)) * 16];
    unsigned char *psample = &sample[0];
    drbg_fork_result result[(2 * (9 + 1))];
    ...
    for (i = 1 ; i <= 9 ; ++i) {
        ...
        if (!test_true("../test/drbgtest.c", 424, "test_drbg_reseed_in_child(primary, public, private, presult)", (test_drbg_reseed_in_child(primary, public, private, presult)) != 0)
    ...
    if (!test_true("../test/drbgtest.c", 434, "test_drbg_reseed(1, primary, public, private, &random[0], &random[RANDOM_SIZE], 0, 0, 0, 0)", (test_drbg_reseed(1, primary, public, private, &random[0], &random[16], 0, 0, 0, 0)) != 0)
    ...
    for (i = 0 ; i < (2 * (9 + 1)) ; ++i) {
        memcpy(psample, &result[i].random[0], 16);
        psample += 16;
    }


    qsort(result, (2 * (9 + 1)), sizeof(drbg_fork_result),
    ...
    if (verbose || !success) {
        ...
        for (i = 0 ; i < (2 * (9 + 1)) ; ++i) {
            char *rand_hex = OPENSSL_buf2hexstr(result[i].random, 16);
            ...
            CRYPTO_free(rand_hex, "../test/drbgtest.c", 512);
        }
    }
...
static int test_rand_fork_safety(int i)
{
    ...
    if (!test_ptr("../test/drbgtest.c", 526, "primary = RAND_get0_primary(NULL)", primary = RAND_get0_primary(
# 526 "../test/drbgtest.c" 3 4
        ((void *)0)
# 526 "../test/drbgtest.c"
        ))
        || !test_ptr("../test/drbgtest.c", 527, "public = RAND_get0_public(NULL)", public = RAND_get0_public(
# 527 "../test/drbgtest.c" 3 4
           ((void *)0)
# 527 "../test/drbgtest.c"
           ))
        || !test_ptr("../test/drbgtest.c", 528, "private = RAND_get0_private(NULL)", private = RAND_get0_private(
# 528 "../test/drbgtest.c" 3 4
           ((void *)0)
# 528 "../test/drbgtest.c"
           )))
        return 0;
    ...
    if (!test_true("../test/drbgtest.c", 532, "test_rand_reseed_on_fork(primary, public, private)", (test_rand_reseed_on_fork(primary, public, private)) != 0))
        success = 0;


    if (!test_int_gt("../test/drbgtest.c", 536, "RAND_bytes(random, 1)", "0", RAND_bytes(random, 1), 0) || !test_int_gt("../test/drbgtest.c", 536, "RAND_priv_bytes(random, 1)", "0", RAND_priv_bytes(random, 1), 0))
        success = 0;
...
static int test_rand_reseed(void)
{
    ...
    if (using_fips_rng())
        return test_skip("../test/drbgtest.c", 556, "CRNGT cannot be disabled");



    if (!test_ptr_eq("../test/drbgtest.c", 560, "RAND_get_rand_method()", "RAND_OpenSSL()", RAND_get_rand_method(), RAND_OpenSSL()))
        return 0;



    if (!test_ptr("../test/drbgtest.c", 565, "primary = RAND_get0_primary(NULL)", primary = RAND_get0_primary(
# 565 "../test/drbgtest.c" 3 4
        ((void *)0)
# 565 "../test/drbgtest.c"
        ))
        || !test_ptr("../test/drbgtest.c", 566, "public = RAND_get0_public(NULL)", public = RAND_get0_public(
# 566 "../test/drbgtest.c" 3 4
           ((void *)0)
# 566 "../test/drbgtest.c"
           ))
        || !test_ptr("../test/drbgtest.c", 567, "private = RAND_get0_private(NULL)", private = RAND_get0_private(
# 567 "../test/drbgtest.c" 3 4
           ((void *)0)
# 567 "../test/drbgtest.c"
           )))
        return 0;
    ...
    if (!test_ptr_ne("../test/drbgtest.c", 571, "public", "private", public, private)
        || !test_ptr_ne("../test/drbgtest.c", 572, "public", "primary", public, primary)
        || !test_ptr_ne("../test/drbgtest.c", 573, "private", "primary", private, primary)
        || !test_ptr_eq("../test/drbgtest.c", 574, "prov_rand(public)->parent", "prov_rand(primary)", prov_rand(public)->parent, prov_rand(primary))
        || !test_ptr_eq("../test/drbgtest.c", 575, "prov_rand(private)->parent", "prov_rand(primary)", prov_rand(private)->parent, prov_rand(primary)))
        return 0;


    if (!test_true("../test/drbgtest.c", 579, "disable_crngt(primary)", (disable_crngt(primary)) != 0))
        return 0;
    ...
    if (!test_true("../test/drbgtest.c", 590, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 1, 1, 1, 0)", (test_drbg_reseed(1, primary, public, private, 
# 590 "../test/drbgtest.c" 3 4
        ((void *)0)
# 590 "../test/drbgtest.c"
        , 
# 590 "../test/drbgtest.c" 3 4
...
# 590 "../test/drbgtest.c"
    ...
    if (!test_true("../test/drbgtest.c", 599, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 0, 0, 0, 0)", (test_drbg_reseed(1, primary, public, private, 
# 599 "../test/drbgtest.c" 3 4
        ((void *)0)
# 599 "../test/drbgtest.c"
        , 
# 599 "../test/drbgtest.c" 3 4
...
# 599 "../test/drbgtest.c"
    ...
    if (!test_true("../test/drbgtest.c", 610, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 0, 1, 1, 0)", (test_drbg_reseed(1, primary, public, private, 
# 610 "../test/drbgtest.c" 3 4
        ((void *)0)
# 610 "../test/drbgtest.c"
        , 
# 610 "../test/drbgtest.c" 3 4
...
# 610 "../test/drbgtest.c"
    ...
    if (!test_true("../test/drbgtest.c", 622, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 0, 1, 0, 0)", (test_drbg_reseed(1, primary, public, private, 
# 622 "../test/drbgtest.c" 3 4
        ((void *)0)
# 622 "../test/drbgtest.c"
        , 
# 622 "../test/drbgtest.c" 3 4
...
# 622 "../test/drbgtest.c"
    ...
    if (!test_true("../test/drbgtest.c", 634, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 0, 0, 1, 0)", (test_drbg_reseed(1, primary, public, private, 
# 634 "../test/drbgtest.c" 3 4
        ((void *)0)
# 634 "../test/drbgtest.c"
        , 
# 634 "../test/drbgtest.c" 3 4
...
# 651 "../test/drbgtest.c"
    before_reseed = time(
# 651 "../test/drbgtest.c" 3 4
                        ((void *)0)
# 651 "../test/drbgtest.c"
                            );
    RAND_add(rand_add_buf, sizeof(rand_add_buf), sizeof(rand_add_buf));
    if (!test_true("../test/drbgtest.c", 653, "test_drbg_reseed(1, primary, public, private, NULL, NULL, 1, 1, 1, before_reseed)", (test_drbg_reseed(1, primary, public, private, 
# 653 "../test/drbgtest.c" 3 4
        ((void *)0)
# 653 "../test/drbgtest.c"
        , 
# 653 "../test/drbgtest.c" 3 4
...
static int set_reseed_time_interval(EVP_RAND_CTX *drbg, int t)
{
    ...
    params[0] = OSSL_PARAM_construct_int("reseed_time_interval",
                                         &t);
...
static void run_multi_thread_test(void)
{
    ...
    time_t start = time(
# 683 "../test/drbgtest.c" 3 4
                       ((void *)0)
# 683 "../test/drbgtest.c"
                           );
    EVP_RAND_CTX *public = 
# 684 "../test/drbgtest.c" 3 4
                          ((void *)0)
# 684 "../test/drbgtest.c"
                              , *private = 
# 684 "../test/drbgtest.c" 3 4
...
# 684 "../test/drbgtest.c"
    ...
    if (!test_ptr("../test/drbgtest.c", 686, "public = RAND_get0_public(NULL)", public = RAND_get0_public(
# 686 "../test/drbgtest.c" 3 4
        ((void *)0)
# 686 "../test/drbgtest.c"
        ))
            || !test_ptr("../test/drbgtest.c", 687, "private = RAND_get0_private(NULL)", private = RAND_get0_private(
# 687 "../test/drbgtest.c" 3 4
               ((void *)0)
# 687 "../test/drbgtest.c"
               ))
            || !test_true("../test/drbgtest.c", 688, "set_reseed_time_interval(private, 1)", (set_reseed_time_interval(private, 1)) != 0)
            || !test_true("../test/drbgtest.c", 689, "set_reseed_time_interval(public, 1)", (set_reseed_time_interval(public, 1)) != 0)) {
...
static int test_multi_thread(void)
{
    ...
    if (!test_true("../test/drbgtest.c", 773, "multi_thread_rand_bytes_succeeded", (multi_thread_rand_bytes_succeeded) != 0))
        return 0;
    if (!test_true("../test/drbgtest.c", 775, "multi_thread_rand_priv_bytes_succeeded", (multi_thread_rand_priv_bytes_succeeded) != 0))
        return 0;
...
static EVP_RAND_CTX *new_drbg(EVP_RAND_CTX *parent)
{
    OSSL_PARAM params[2];
    EVP_RAND *rand = 
# 785 "../test/drbgtest.c" 3 4
                    ((void *)0)
# 785 "../test/drbgtest.c"
                        ;
    EVP_RAND_CTX *drbg = 
# 786 "../test/drbgtest.c" 3 4
                        ((void *)0)
# 786 "../test/drbgtest.c"
                            ;
    ...
    if (!test_ptr("../test/drbgtest.c", 792, "rand = EVP_RAND_fetch(NULL, \"CTR-DRBG\", NULL)", rand = EVP_RAND_fetch(
# 792 "../test/drbgtest.c" 3 4
        ((void *)0)
# 792 "../test/drbgtest.c"
        , "CTR-DRBG", 
# 792 "../test/drbgtest.c" 3 4
...
# 792 "../test/drbgtest.c"
            ...
            || !test_ptr("../test/drbgtest.c", 793, "drbg = EVP_RAND_CTX_new(rand, parent)", drbg = EVP_RAND_CTX_new(rand, parent))
            || !test_true("../test/drbgtest.c", 794, "EVP_RAND_CTX_set_params(drbg, params)", (EVP_RAND_CTX_set_params(drbg, params)) != 0)) {
        EVP_RAND_CTX_free(drbg);
        drbg = 
# 796 "../test/drbgtest.c" 3 4
              ((void *)0)
# 796 "../test/drbgtest.c"
                  ;
    }
...
# 804 "../test/drbgtest.c"
    ...
    if (using_fips_rng())
        return test_skip("../test/drbgtest.c", 809, "CRNGT cannot be disabled");


    if (!test_ptr("../test/drbgtest.c", 812, "x = new_drbg(NULL)", x = new_drbg(
# 812 "../test/drbgtest.c" 3 4
        ((void *)0)
# 812 "../test/drbgtest.c"
        ))
        || !test_true("../test/drbgtest.c", 813, "disable_crngt(x)", (disable_crngt(x)) != 0)
        || !test_true("../test/drbgtest.c", 814, "EVP_RAND_instantiate(x, 0, 0, NULL, 0, NULL)", (EVP_RAND_instantiate(x, 0, 0, 
# 814 "../test/drbgtest.c" 3 4
           ((void *)0)
# 814 "../test/drbgtest.c"
           , 0, 
# 814 "../test/drbgtest.c" 3 4
...
# 814 "../test/drbgtest.c"
        ...
        || !test_ptr("../test/drbgtest.c", 815, "y = new_drbg(x)", y = new_drbg(x))
        || !test_true("../test/drbgtest.c", 816, "EVP_RAND_instantiate(y, 0, 0, NULL, 0, NULL)", (EVP_RAND_instantiate(y, 0, 0, 
# 816 "../test/drbgtest.c" 3 4
           ((void *)0)
# 816 "../test/drbgtest.c"
           , 0, 
# 816 "../test/drbgtest.c" 3 4
...
# 816 "../test/drbgtest.c"
        ...
        || !test_ptr("../test/drbgtest.c", 817, "z = new_drbg(y)", z = new_drbg(y))
        || !test_true("../test/drbgtest.c", 818, "EVP_RAND_instantiate(z, 0, 0, NULL, 0, NULL)", (EVP_RAND_instantiate(z, 0, 0, 
# 818 "../test/drbgtest.c" 3 4
           ((void *)0)
# 818 "../test/drbgtest.c"
           , 0, 
# 818 "../test/drbgtest.c" 3 4
...
# 818 "../test/drbgtest.c"
    ...
    if (!test_true("../test/drbgtest.c", 829, "EVP_RAND_reseed(z, 0, NULL, 0, NULL, 0)", (EVP_RAND_reseed(z, 0, 
# 829 "../test/drbgtest.c" 3 4
        ((void *)0)
# 829 "../test/drbgtest.c"
        , 0, 
# 829 "../test/drbgtest.c" 3 4
...
# 829 "../test/drbgtest.c"
        , 0)) != 0)
        || !test_int_eq("../test/drbgtest.c", 830, "reseed_counter(x)", "xreseed", reseed_counter(x), xreseed)
        || !test_int_eq("../test/drbgtest.c", 831, "reseed_counter(y)", "yreseed", reseed_counter(y), yreseed)
        || !test_int_gt("../test/drbgtest.c", 832, "reseed_counter(z)", "zreseed", reseed_counter(z), zreseed))
        goto err;
    ...
    zreseed = reseed_counter(z);
    if (!test_true("../test/drbgtest.c", 840, "EVP_RAND_reseed(z, 1, NULL, 0, NULL, 0)", (EVP_RAND_reseed(z, 1, 
# 840 "../test/drbgtest.c" 3 4
        ((void *)0)
# 840 "../test/drbgtest.c"
        , 0, 
# 840 "../test/drbgtest.c" 3 4
...
# 840 "../test/drbgtest.c"
        , 0)) != 0)
        || !test_int_gt("../test/drbgtest.c", 841, "reseed_counter(x)", "xreseed", reseed_counter(x), xreseed)
        || !test_int_gt("../test/drbgtest.c", 842, "reseed_counter(y)", "yreseed", reseed_counter(y), yreseed)
        || !test_int_gt("../test/drbgtest.c", 843, "reseed_counter(z)", "zreseed", reseed_counter(z), zreseed))
        goto err;
    ...
    yreseed = reseed_counter(y);
    zreseed = reseed_counter(z);
    if (!test_true("../test/drbgtest.c", 852, "EVP_RAND_generate(z, buf1, sizeof(buf1), 0, 0, NULL, 0)", (EVP_RAND_generate(z, buf1, sizeof(buf1), 0, 0, 
# 852 "../test/drbgtest.c" 3 4
        ((void *)0)
# 852 "../test/drbgtest.c"
        , 0)) != 0)
        || !test_int_eq("../test/drbgtest.c", 853, "reseed_counter(x)", "xreseed", reseed_counter(x), xreseed)
        || !test_int_eq("../test/drbgtest.c", 854, "reseed_counter(y)", "yreseed", reseed_counter(y), yreseed)
        || !test_int_gt("../test/drbgtest.c", 855, "reseed_counter(z)", "zreseed", reseed_counter(z), zreseed))
        goto err;
    ...
    zreseed = reseed_counter(z);
    if (!test_true("../test/drbgtest.c", 863, "EVP_RAND_generate(z, buf2, sizeof(buf2), 0, 1, NULL, 0)", (EVP_RAND_generate(z, buf2, sizeof(buf2), 0, 1, 
# 863 "../test/drbgtest.c" 3 4
        ((void *)0)
# 863 "../test/drbgtest.c"
        , 0)) != 0)
        || !test_int_gt("../test/drbgtest.c", 864, "reseed_counter(x)", "xreseed", reseed_counter(x), xreseed)
        || !test_int_gt("../test/drbgtest.c", 865, "reseed_counter(y)", "yreseed", reseed_counter(y), yreseed)
        || !test_int_gt("../test/drbgtest.c", 866, "reseed_counter(z)", "zreseed", reseed_counter(z), zreseed)
        || !test_mem_ne("../test/drbgtest.c", 867, "buf1", "buf2", buf1, sizeof(buf1), buf2, sizeof(buf2)))
        goto err;
    ...
    yreseed = reseed_counter(y);
    zreseed = reseed_counter(z);
    if (!test_true("../test/drbgtest.c", 875, "EVP_RAND_reseed(z, 0, NULL, 0, NULL, 0)", (EVP_RAND_reseed(z, 0, 
# 875 "../test/drbgtest.c" 3 4
        ((void *)0)
# 875 "../test/drbgtest.c"
        , 0, 
# 875 "../test/drbgtest.c" 3 4
...
# 875 "../test/drbgtest.c"
        , 0)) != 0)
        || !test_int_eq("../test/drbgtest.c", 876, "reseed_counter(x)", "xreseed", reseed_counter(x), xreseed)
        || !test_int_eq("../test/drbgtest.c", 877, "reseed_counter(y)", "yreseed", reseed_counter(y), yreseed)
        || !test_int_gt("../test/drbgtest.c", 878, "reseed_counter(z)", "zreseed", reseed_counter(z), zreseed))
        goto err;
...
int setup_tests(void)
{
    ...
    add_all_tests("test_rand_fork_safety", test_rand_fork_safety, 16, 1);
