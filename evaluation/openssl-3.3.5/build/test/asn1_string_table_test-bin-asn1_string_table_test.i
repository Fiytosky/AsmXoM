# 0 "../test/asn1_string_table_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/asn1_string_table_test.c"
# 12 "../test/asn1_string_table_test.c"
...
# 13 "../test/asn1_string_table_test.c" 2
...
# 14 "../test/asn1_string_table_test.c" 2
...
# 16 "../test/asn1_string_table_test.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
# 17 "../test/asn1_string_table_test.c" 2

static int test_string_tbl(void)
{
    const ASN1_STRING_TABLE *tmp = 
# 20 "../test/asn1_string_table_test.c" 3 4
                                  ((void *)0)
# 20 "../test/asn1_string_table_test.c"
                                      ;
    int nid = 12345678, nid2 = 87654321, rv = 0, ret = 0;

    tmp = ASN1_STRING_TABLE_get(nid);
    if (!test_ptr_null("../test/asn1_string_table_test.c", 24, "tmp", tmp)) {
        test_info("../test/asn1_string_table_test.c", 25, "asn1 string table: ASN1_STRING_TABLE_get non-exist nid");
        goto out;
    }

    ret = ASN1_STRING_TABLE_add(nid, -1, -1, (0x1000|1), 0);
    if (!test_true("../test/asn1_string_table_test.c", 30, "ret", (ret) != 0)) {
        test_info("../test/asn1_string_table_test.c", 31, "asn1 string table: add NID(%d) failed", nid);
        goto out;
    }

    ret = ASN1_STRING_TABLE_add(nid2, -1, -1, (0x1000|1), 0);
    if (!test_true("../test/asn1_string_table_test.c", 36, "ret", (ret) != 0)) {
        test_info("../test/asn1_string_table_test.c", 37, "asn1 string table: add NID(%d) failed", nid2);
        goto out;
    }

    tmp = ASN1_STRING_TABLE_get(nid);
    if (!test_ptr("../test/asn1_string_table_test.c", 42, "tmp", tmp)) {
        test_info("../test/asn1_string_table_test.c", 43, "asn1 string table: get NID(%d) failed", nid);
        goto out;
    }

    tmp = ASN1_STRING_TABLE_get(nid2);
    if (!test_ptr("../test/asn1_string_table_test.c", 48, "tmp", tmp)) {
        test_info("../test/asn1_string_table_test.c", 49, "asn1 string table: get NID(%d) failed", nid2);
        goto out;
    }
    ...
    tmp = ASN1_STRING_TABLE_get(nid);
    if (!test_ptr_null("../test/asn1_string_table_test.c", 57, "tmp", tmp)) {
        test_info("../test/asn1_string_table_test.c", 58, "asn1 string table: get NID(%d) failed", nid);
        goto out;
    }

    tmp = ASN1_STRING_TABLE_get(nid2);
    if (!test_ptr_null("../test/asn1_string_table_test.c", 63, "tmp", tmp)) {
        test_info("../test/asn1_string_table_test.c", 64, "asn1 string table: get NID(%d) failed", nid2);
        goto out;
    }
...
int setup_tests(void)
{
    add_test("test_string_tbl", test_string_tbl);
    return 1;
}
