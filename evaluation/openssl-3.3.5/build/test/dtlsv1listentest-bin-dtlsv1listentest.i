# 0 "../test/dtlsv1listentest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/dtlsv1listentest.c"
# 10 "../test/dtlsv1listentest.c"
...
# 14 "../test/dtlsv1listentest.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../test/dtlsv1listentest.c" 2
# 1 "../test/testutil.h" 1
# 14 "../test/testutil.h"
...
{
    SSL_CTX *ctx = 
# 291 "../test/dtlsv1listentest.c" 3 4
                  ((void *)0)
# 291 "../test/dtlsv1listentest.c"
                      ;
    SSL *ssl = 
# 292 "../test/dtlsv1listentest.c" 3 4
              ((void *)0)
# 292 "../test/dtlsv1listentest.c"
                  ;
    BIO *outbio = 
# 293 "../test/dtlsv1listentest.c" 3 4
                 ((void *)0)
# 293 "../test/dtlsv1listentest.c"
                     ;
    BIO *inbio = 
# 294 "../test/dtlsv1listentest.c" 3 4
                ((void *)0)
# 294 "../test/dtlsv1listentest.c"
                    ;
    BIO_ADDR *peer = 
# 295 "../test/dtlsv1listentest.c" 3 4
                    ((void *)0)
# 295 "../test/dtlsv1listentest.c"
                        ;
    ...
    if (!test_ptr("../test/dtlsv1listentest.c", 301, "ctx = SSL_CTX_new(DTLS_server_method())", ctx = SSL_CTX_new(DTLS_server_method()))
            || !test_ptr("../test/dtlsv1listentest.c", 302, "peer = BIO_ADDR_new()", peer = BIO_ADDR_new()))
        goto err;
    SSL_CTX_set_cookie_generate_cb(ctx, cookie_gen);
    SSL_CTX_set_cookie_verify_cb(ctx, cookie_verify);


    if (!test_ptr("../test/dtlsv1listentest.c", 308, "ssl = SSL_new(ctx)", ssl = SSL_new(ctx))
            || !test_ptr("../test/dtlsv1listentest.c", 309, "outbio = BIO_new(BIO_s_mem())", outbio = BIO_new(BIO_s_mem())))
        goto err;
    SSL_set0_wbio(ssl, outbio);


    if (!test_ptr("../test/dtlsv1listentest.c", 314, "inbio = BIO_new_mem_buf((char *)tp->in, tp->inlen)", inbio = BIO_new_mem_buf((char *)tp->in, tp->inlen)))
        goto err;
    BIO_ctrl(inbio,130,-1,
# 316 "../test/dtlsv1listentest.c" 3 4
   ((void *)0)
# 316 "../test/dtlsv1listentest.c"
   );
    SSL_set0_rbio(ssl, inbio);


    if (!test_int_ge("../test/dtlsv1listentest.c", 320, "ret = DTLSv1_listen(ssl, peer)", "0", ret = DTLSv1_listen(ssl, peer), 0))
        goto err;
    datalen = BIO_ctrl(outbio,3,0,(char *)(&data));

    if (tp->outtype == VERIFY) {
        if (!test_int_eq("../test/dtlsv1listentest.c", 325, "ret", "0", ret, 0)
                || !test_mem_eq("../test/dtlsv1listentest.c", 326, "data", "verify", data, datalen, verify, sizeof(verify)))
            goto err;
    } else if (datalen == 0) {
        if (!test_true("../test/dtlsv1listentest.c", 329, "(ret == 0 && tp->outtype == DROP) || (ret == 1 && tp->outtype == GOOD)", ((ret == 0 && tp->outtype == DROP) || (ret == 1 && tp->outtype == GOOD)) != 0)
                                                     )
            goto err;
    } else {
        test_info("../test/dtlsv1listentest.c", 333, "Test %d: unexpected data output", i);
        goto err;
    }
    (void)(int)BIO_ctrl(outbio,1,0,
# 336 "../test/dtlsv1listentest.c" 3 4
         ((void *)0)
# 336 "../test/dtlsv1listentest.c"
         );
    inbio = 
# 337 "../test/dtlsv1listentest.c" 3 4
           ((void *)0)
# 337 "../test/dtlsv1listentest.c"
               ;
    SSL_set0_rbio(ssl, 
# 338 "../test/dtlsv1listentest.c" 3 4
                      ((void *)0)
# 338 "../test/dtlsv1listentest.c"
                          );
    success = 1;
 ...
 err:
    ...
    SSL_CTX_free(ctx);
    BIO_free(inbio);
    CRYPTO_free(peer, "../test/dtlsv1listentest.c", 346);
    return success;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("dtls_listen_test", dtls_listen_test, (int)(sizeof(testpackets)/sizeof((testpackets)[0])), 1);
