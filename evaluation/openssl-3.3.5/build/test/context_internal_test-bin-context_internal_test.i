# 0 "../test/context_internal_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/context_internal_test.c"
# 12 "../test/context_internal_test.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 13 "../test/context_internal_test.c" 2
# 1 "../test/testutil.h" 1
# 16 "../test/testutil.h"
...
# 14 "../test/context_internal_test.c" 2
...
static int test_set0_default(void)
{
    ...
    if (!test_ptr("../test/context_internal_test.c", 22, "global", global)
            || !test_ptr("../test/context_internal_test.c", 23, "local", local)
            || !test_ptr_eq("../test/context_internal_test.c", 24, "global", "OSSL_LIB_CTX_set0_default(NULL)", global, OSSL_LIB_CTX_set0_default(
# 24 "../test/context_internal_test.c" 3 4
               ((void *)0)
# 24 "../test/context_internal_test.c"
               )))
        goto err;


    if (!test_ptr("../test/context_internal_test.c", 28, "prev = OSSL_LIB_CTX_set0_default(local)", prev = OSSL_LIB_CTX_set0_default(local))
            || !test_ptr_eq("../test/context_internal_test.c", 29, "global", "prev", global, prev))
        goto err;


    if (!test_ptr_eq("../test/context_internal_test.c", 33, "local", "OSSL_LIB_CTX_set0_default(NULL)", local, OSSL_LIB_CTX_set0_default(
# 33 "../test/context_internal_test.c" 3 4
        ((void *)0)
# 33 "../test/context_internal_test.c"
        )))
        goto err;


    if (!test_ptr_eq("../test/context_internal_test.c", 37, "global", "OSSL_LIB_CTX_get0_global_default()", global, OSSL_LIB_CTX_get0_global_default()))
        goto err;


    if (!test_ptr("../test/context_internal_test.c", 41, "prev = OSSL_LIB_CTX_set0_default(global)", prev = OSSL_LIB_CTX_set0_default(global))
            || !test_ptr_eq("../test/context_internal_test.c", 42, "local", "prev", local, prev))
        goto err;
