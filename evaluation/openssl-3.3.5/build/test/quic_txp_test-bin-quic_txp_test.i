# 0 "../test/quic_txp_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/quic_txp_test.c"
# 9 "../test/quic_txp_test.c"
...
# 15 "../include/internal/packet.h" 2
...
# 16 "../include/internal/packet.h" 2
...
# 17 "../include/internal/packet.h" 2
...
# 21 "../include/internal/packet.h" 2
...
# 14 "../include/internal/quic_txp.h" 2
...
# 15 "../include/internal/quic_types.h" 2
...
# 15 "../include/internal/quic_txp.h" 2
...
# 16 "../include/internal/quic_txp.h" 2
...
# 15 "../include/internal/quic_vlint.h" 2
...
int ossl_quic_calculate_retry_integrity_tag(OSSL_LIB_CTX *libctx,
                                            ...
                                            const QUIC_CONN_ID *client_initial_dcid,
                                            unsigned char *tag);
# 15 "../include/internal/quic_record_tx.h" 2
...
# 18 "../include/internal/quic_record_tx.h" 2
# 1 "../include/internal/qlog.h" 1
# 15 "../include/internal/qlog.h"
...
# 17 "../include/internal/quic_txp.h" 2
...
# 19 "../include/internal/quic_ackm.h" 2
...
# 18 "../include/internal/quic_txpim.h" 2
...
uint64_t ossl_qrx_get_max_forged_pkt_count(OSSL_QRX *qrx,
                                           uint32_t enc_level);
# 21 "../include/internal/quic_stream.h" 2
...
# 17 "../include/internal/quic_stream_map.h" 2
...
# 15 "../test/quic_txp_test.c" 2
# 1 "../test/quic_record_test_util.h" 1
# 13 "../test/quic_record_test_util.h"
                       ...
                       int cmp_data)
{
    ...
    if (b_data == 
# 19 "../test/quic_record_test_util.h" 3 4
                 ((void *)0)
# 19 "../test/quic_record_test_util.h"
                     ) {
        b_data = b->data;
        b_len = b->len;
    }

    if (!test_int_eq("../test/quic_record_test_util.h", 24, "a->type", "b->type", a->type, b->type)
        || !test_int_eq("../test/quic_record_test_util.h", 25, "a->spin_bit", "b->spin_bit", a->spin_bit, b->spin_bit)
        || !test_int_eq("../test/quic_record_test_util.h", 26, "a->key_phase", "b->key_phase", a->key_phase, b->key_phase)
        || !test_int_eq("../test/quic_record_test_util.h", 27, "a->pn_len", "b->pn_len", a->pn_len, b->pn_len)
        || !test_int_eq("../test/quic_record_test_util.h", 28, "a->partial", "b->partial", a->partial, b->partial)
        || !test_int_eq("../test/quic_record_test_util.h", 29, "a->fixed", "b->fixed", a->fixed, b->fixed)
        || !test_int_eq("../test/quic_record_test_util.h", 30, "a->unused", "b->unused", a->unused, b->unused)
        || !test_int_eq("../test/quic_record_test_util.h", 31, "a->reserved", "b->reserved", a->reserved, b->reserved)
        || !test_uint_eq("../test/quic_record_test_util.h", 32, "a->version", "b->version", a->version, b->version)
        || !test_true("../test/quic_record_test_util.h", 33, "ossl_quic_conn_id_eq(&a->dst_conn_id, &b->dst_conn_id)", (ossl_quic_conn_id_eq(&a->dst_conn_id, &b->dst_conn_id)) != 0)
        || !test_true("../test/quic_record_test_util.h", 34, "ossl_quic_conn_id_eq(&a->src_conn_id, &b->src_conn_id)", (ossl_quic_conn_id_eq(&a->src_conn_id, &b->src_conn_id)) != 0)
        || !test_mem_eq("../test/quic_record_test_util.h", 35, "a->pn", "b->pn", a->pn, sizeof(a->pn), b->pn, sizeof(b->pn))
        || !test_size_t_eq("../test/quic_record_test_util.h", 36, "a->token_len", "b->token_len", a->token_len, b->token_len)
        || !test_uint64_t_eq("../test/quic_record_test_util.h", 37, "a->len", "b->len", a->len, b->len))
        ok = 0;

    if (a->token_len > 0 && b->token_len > 0
        && !test_mem_eq("../test/quic_record_test_util.h", 41, "a->token", "b->token", a->token, a->token_len, b->token, b->token_len))
        ok = 0;

    if ((a->token_len == 0 && !test_ptr_null("../test/quic_record_test_util.h", 44, "a->token", a->token))
        || (b->token_len == 0 && !test_ptr_null("../test/quic_record_test_util.h", 45, "b->token", b->token)))
        ok = 0;

    if (cmp_data && !test_mem_eq("../test/quic_record_test_util.h", 48, "a->data", "b_data", a->data, a->len, b_data, b_len))
        ok = 0;

    return ok;
}
# 16 "../test/quic_txp_test.c" 2
...
static void helper_cleanup(struct helper *h)
{
    ...
    h->qrx_pkt = 
# 85 "../test/quic_txp_test.c" 3 4
                ((void *)0)
# 85 "../test/quic_txp_test.c"
                    ;
    ...
    if (h->cc_data != 
# 96 "../test/quic_txp_test.c" 3 4
                     ((void *)0)
# 96 "../test/quic_txp_test.c"
                         )
                                  ...
                                  const QUIC_CONN_ID *dcid)
{
    ...
    if (dcid == 
# 116 "../test/quic_txp_test.c" 3 4
               ((void *)0) 
# 116 "../test/quic_txp_test.c"
                    || !ossl_quic_conn_id_eq(dcid, &dcid_1))
        return;
...
static int helper_init(struct helper *h)
{
    ...
    if (!test_true("../test/quic_txp_test.c", 130, "BIO_new_bio_dgram_pair(&h->bio1, 0, &h->bio2, 0)", (BIO_new_bio_dgram_pair(&h->bio1, 0, &h->bio2, 0)) != 0))
        goto err;

    h->qtx_args.bio = h->bio1;
    h->qtx_args.mdpl = 1200;

    if (!test_ptr("../test/quic_txp_test.c", 136, "h->args.qtx = ossl_qtx_new(&h->qtx_args)", h->args.qtx = ossl_qtx_new(&h->qtx_args)))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 139, "h->args.txpim = ossl_quic_txpim_new()", h->args.txpim = ossl_quic_txpim_new()))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 142, "h->args.cfq = ossl_quic_cfq_new()", h->args.cfq = ossl_quic_cfq_new()))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 145, "ossl_quic_txfc_init(&h->conn_txfc, NULL)", (ossl_quic_txfc_init(&h->conn_txfc, 
# 145 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 145 "../test/quic_txp_test.c"
        )) != 0))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 148, "ossl_quic_rxfc_init(&h->conn_rxfc, NULL, 2 * 1024 * 1024, 10 * 1024 * 1024, fake_now, NULL)", (ossl_quic_rxfc_init(&h->conn_rxfc, 
# 148 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 148 "../test/quic_txp_test.c"
        , 2 * 1024 * 1024, 10 * 1024 * 1024, fake_now, 
# 148 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 148 "../test/quic_txp_test.c"
        )) != 0)
    ...
    if (!test_true("../test/quic_txp_test.c", 155, "ossl_quic_rxfc_init(&h->stream_rxfc, &h->conn_rxfc, 1 * 1024 * 1024, 5 * 1024 * 1024, fake_now, NULL)", (ossl_quic_rxfc_init(&h->stream_rxfc, &h->conn_rxfc, 1 * 1024 * 1024, 5 * 1024 * 1024, fake_now, 
# 155 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 155 "../test/quic_txp_test.c"
        )) != 0)
    ...
    if (!test_true("../test/quic_txp_test.c", 162, "ossl_quic_rxfc_init(&h->max_streams_bidi_rxfc, NULL, 100, 100, fake_now, NULL)", (ossl_quic_rxfc_init(&h->max_streams_bidi_rxfc, 
# 162 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 162 "../test/quic_txp_test.c"
        , 100, 100, fake_now, 
# 162 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 162 "../test/quic_txp_test.c"
    ...
    if (!test_true("../test/quic_txp_test.c", 168, "ossl_quic_rxfc_init(&h->max_streams_uni_rxfc, NULL, 100, 100, fake_now, NULL)", (ossl_quic_rxfc_init(&h->max_streams_uni_rxfc, 
# 168 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 168 "../test/quic_txp_test.c"
        , 100, 100, fake_now, 
# 168 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 168 "../test/quic_txp_test.c"
    ...
    if (!test_true("../test/quic_txp_test.c", 173, "ossl_statm_init(&h->statm)", (ossl_statm_init(&h->statm)) != 0))
        goto err;

    h->have_statm = 1;

    h->cc_method = &ossl_cc_dummy_method;
    if (!test_ptr("../test/quic_txp_test.c", 179, "h->cc_data = h->cc_method->new(fake_now, NULL)", h->cc_data = h->cc_method->new(fake_now, 
# 179 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 179 "../test/quic_txp_test.c"
        )))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 182, "h->args.ackm = ossl_ackm_new(fake_now, NULL, &h->statm, h->cc_method, h->cc_data, 0)", h->args.ackm = ossl_ackm_new(fake_now, 
# 182 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 182 "../test/quic_txp_test.c"
        , &h->statm, h->cc_method, h->cc_data, 0))
    ...
    if (!test_true("../test/quic_txp_test.c", 189, "ossl_quic_stream_map_init(&h->qsm, NULL, NULL, &h->max_streams_bidi_rxfc, &h->max_streams_uni_rxfc, 0)", (ossl_quic_stream_map_init(&h->qsm, 
# 189 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 189 "../test/quic_txp_test.c"
        , 
# 189 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 189 "../test/quic_txp_test.c"
        , &h->max_streams_bidi_rxfc, &h->max_streams_uni_rxfc, 0)) != 0)
    ...
    for (i = 0; i < QUIC_PN_SPACE_NUM; ++i)
        if (!test_ptr("../test/quic_txp_test.c", 198, "h->args.crypto[i] = ossl_quic_sstream_new(4096)", h->args.crypto[i] = ossl_quic_sstream_new(4096)))
            goto err;
    ...
    if (!test_ptr("../test/quic_txp_test.c", 212, "h->txp = ossl_quic_tx_packetiser_new(&h->args)", h->txp = ossl_quic_tx_packetiser_new(&h->args)))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 215, "h->demux = ossl_quic_demux_new(h->bio2, 8, fake_now, NULL)", h->demux = ossl_quic_demux_new(h->bio2, 8, fake_now, 
# 215 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 215 "../test/quic_txp_test.c"
        ))
                                                                 )
        goto err;
    ...
    if (!test_ptr("../test/quic_txp_test.c", 225, "h->qrx = ossl_qrx_new(&h->qrx_args)", h->qrx = ossl_qrx_new(&h->qrx_args)))
        goto err;
...
static const struct script_op script_1[] = {
    { 12, (QUIC_ENC_LEVEL_1RTT), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 9, 0, 0, 
# 336 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 336 "../test/quic_txp_test.c"
   , 0, (schedule_handshake_done) },
    { 1 },
    { 3 },
...
static const struct script_op script_2[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 353 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 353 "../test/quic_txp_test.c"
   , 0, (schedule_ack_eliciting_app) },
    { 1 },
    { 3 },
...
static int schedule_max_data(struct helper *h)
{
    ...
    if (!test_true("../test/quic_txp_test.c", 374, "ossl_quic_rxfc_on_rx_stream_frame(&h->stream_rxfc, cwm, 0)", (ossl_quic_rxfc_on_rx_stream_frame(&h->stream_rxfc, cwm, 0)) != 0)
        || !test_true("../test/quic_txp_test.c", 375, "ossl_quic_rxfc_on_retire(&h->stream_rxfc, cwm, ossl_ticks2time(OSSL_TIME_MS))", (ossl_quic_rxfc_on_retire(&h->stream_rxfc, cwm, ossl_ticks2time((((uint64_t)1000000000) / 1000)))) != 0)
                                                                              )
        return 0;
...
static const struct script_op script_3[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 385 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 385 "../test/quic_txp_test.c"
   , 0, (schedule_max_data) },
    { 1 },
    { 3 },
...
static int schedule_cfq_new_conn_id(struct helper *h)
{
    ...
    WPACKET wpkt;
    BUF_MEM *buf_mem = 
# 410 "../test/quic_txp_test.c" 3 4
                      ((void *)0)
# 410 "../test/quic_txp_test.c"
                          ;
    size_t l = 0;
    ...
    if (!test_ptr("../test/quic_txp_test.c", 419, "buf_mem = BUF_MEM_new()", buf_mem = BUF_MEM_new()))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 422, "WPACKET_init(&wpkt, buf_mem)", (WPACKET_init(&wpkt, buf_mem)) != 0))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 425, "ossl_quic_wire_encode_frame_new_conn_id(&wpkt, &ncid)", (ossl_quic_wire_encode_frame_new_conn_id(&wpkt, &ncid)) != 0)) {
    ...
    if (!test_true("../test/quic_txp_test.c", 432, "WPACKET_get_total_written(&wpkt, &l)", (WPACKET_get_total_written(&wpkt, &l)) != 0))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 435, "cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, OSSL_QUIC_FRAME_TYPE_NEW_CONN_ID, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem)", cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, 0x18, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem))
...
{
    if (!test_uint64_t_eq("../test/quic_txp_test.c", 452, "h->frame.new_conn_id.seq_num", "2345", h->frame.new_conn_id.seq_num, 2345)
        || !test_uint64_t_eq("../test/quic_txp_test.c", 453, "h->frame.new_conn_id.retire_prior_to", "1234", h->frame.new_conn_id.retire_prior_to, 1234)
        || !test_mem_eq("../test/quic_txp_test.c", 454, "&h->frame.new_conn_id.conn_id", "&cid_1", &h->frame.new_conn_id.conn_id, sizeof(cid_1), &cid_1, sizeof(cid_1))

        || !test_mem_eq("../test/quic_txp_test.c", 456, "&h->frame.new_conn_id.stateless_reset.token", "reset_token_1", &h->frame.new_conn_id.stateless_reset.token, sizeof(reset_token_1), reset_token_1, sizeof(reset_token_1))
...
static const struct script_op script_4[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 468 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 468 "../test/quic_txp_test.c"
   , 0, (schedule_cfq_new_conn_id) },
    { 1 },
    { 3 },
    { 5, (21), (128) },
    { 10 },
    { 6, (0x18) },
    { 9, 0, 0, 
# 474 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 474 "../test/quic_txp_test.c"
   , 0, (check_cfq_new_conn_id) },
    { 11 },
    { 4 },
    { 2 },
    { 0 }
...
static int schedule_cfq_new_token(struct helper *h)
{
    ...
    WPACKET wpkt;
    BUF_MEM *buf_mem = 
# 491 "../test/quic_txp_test.c" 3 4
                      ((void *)0)
# 491 "../test/quic_txp_test.c"
                          ;
    size_t l = 0;

    if (!test_ptr("../test/quic_txp_test.c", 494, "buf_mem = BUF_MEM_new()", buf_mem = BUF_MEM_new()))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 497, "WPACKET_init(&wpkt, buf_mem)", (WPACKET_init(&wpkt, buf_mem)) != 0))
        goto err;

    if (!test_true("../test/quic_txp_test.c", 500, "ossl_quic_wire_encode_frame_new_token(&wpkt, token_1, sizeof(token_1))", (ossl_quic_wire_encode_frame_new_token(&wpkt, token_1, sizeof(token_1))) != 0)
                                                                          ) {
        WPACKET_cleanup(&wpkt);
        goto err;
    }
    ...
    if (!test_true("../test/quic_txp_test.c", 508, "WPACKET_get_total_written(&wpkt, &l)", (WPACKET_get_total_written(&wpkt, &l)) != 0))
        goto err;

    if (!test_ptr("../test/quic_txp_test.c", 511, "cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, OSSL_QUIC_FRAME_TYPE_NEW_TOKEN, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem)", cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, 0x07, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem))
...
{
    if (!test_mem_eq("../test/quic_txp_test.c", 528, "h->frame.new_token.token", "token_1", h->frame.new_token.token, h->frame.new_token.token_len, token_1, sizeof(token_1))
...
static const struct script_op script_5[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 540 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 540 "../test/quic_txp_test.c"
   , 0, (schedule_cfq_new_token) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
    { 10 },
    { 6, (0x07) },
    { 9, 0, 0, 
# 546 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 546 "../test/quic_txp_test.c"
   , 0, (check_cfq_new_token) },
    { 11 },
    { 4 },
    { 2 },
    { 0 }
...
static int schedule_ack(struct helper *h)
{
    ...
    for (i = 0; i < 5; ++i) {
        rx_pkt.pkt_num = i;
        rx_pkt.time = fake_now(
# 562 "../test/quic_txp_test.c" 3 4
                                          ((void *)0)
# 562 "../test/quic_txp_test.c"
                                              );
        rx_pkt.pkt_space = QUIC_PN_SPACE_APP;
        rx_pkt.is_ack_eliciting = 1;

        if (!test_true("../test/quic_txp_test.c", 566, "ossl_ackm_on_rx_packet(h->args.ackm, &rx_pkt)", (ossl_ackm_on_rx_packet(h->args.ackm, &rx_pkt)) != 0))
            return 0;
    }
...
static const struct script_op script_6[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 576 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 576 "../test/quic_txp_test.c"
   , 0, (schedule_ack) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
...
static const struct script_op script_7[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 592 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 592 "../test/quic_txp_test.c"
   , 0, (schedule_cfq_new_token) },
    { 9, 0, 0, 
# 593 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 593 "../test/quic_txp_test.c"
   , 0, (schedule_ack) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
...
static const struct script_op script_8[] = {
    { 12, (QUIC_ENC_LEVEL_1RTT), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 14, (QUIC_PN_SPACE_APP), 0, (crypto_1), sizeof(crypto_1) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
    { 10 },
...
{
    if (!test_mem_eq("../test/quic_txp_test.c", 635, "h->frame.stream.data", "stream_9", h->frame.stream.data, (size_t)h->frame.stream.len, stream_9, sizeof(stream_9))
                                                )
        return 0;
...
static const struct script_op script_9[] = {
    ...
    { 2 },
    { 15, (42) },
    { 16, (42), 0, (stream_9), sizeof(stream_9) },
    ...
    { 6, (0x08) },
    { 9, 0, 0, 
# 658 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 658 "../test/quic_txp_test.c"
   , 0, (check_stream_9) },
    { 11 },
    { 4 },
    { 2 },
...
static int check_stream_10a(struct helper *h)
{
    ...
    if (!test_uint64_t_ge("../test/quic_txp_test.c", 899, "h->frame.stream.len", "1150", h->frame.stream.len, 1150)
        || !test_uint64_t_le("../test/quic_txp_test.c", 900, "h->frame.stream.len", "1200", h->frame.stream.len, 1200))
        return 0;

    if (!test_mem_eq("../test/quic_txp_test.c", 903, "h->frame.stream.data", "stream_10a", h->frame.stream.data, (size_t)h->frame.stream.len, stream_10a, (size_t)h->frame.stream.len)
                                                             )
        return 0;
...
{
    if (!test_uint64_t_ge("../test/quic_txp_test.c", 913, "h->frame.stream.len", "1150", h->frame.stream.len, 1150)
        || !test_uint64_t_le("../test/quic_txp_test.c", 914, "h->frame.stream.len", "1200", h->frame.stream.len, 1200))
        return 0;

    if (!test_mem_eq("../test/quic_txp_test.c", 917, "h->frame.stream.data", "stream_10b", h->frame.stream.data, (size_t)h->frame.stream.len, stream_10b, (size_t)h->frame.stream.len)
                                                             )
        return 0;
...
{
    if (!test_uint64_t_ge("../test/quic_txp_test.c", 927, "h->frame.stream.len", "5", h->frame.stream.len, 5)
        || !test_uint64_t_le("../test/quic_txp_test.c", 928, "h->frame.stream.len", "200", h->frame.stream.len, 200))
        return 0;

    if (!test_mem_eq("../test/quic_txp_test.c", 931, "h->frame.stream.data", "stream_10a + stream_10a_off", h->frame.stream.data, (size_t)h->frame.stream.len, stream_10a + stream_10a_off, (size_t)h->frame.stream.len)
                                                                              )
        return 0;
...
{
    if (!test_uint64_t_ge("../test/quic_txp_test.c", 940, "h->frame.stream.len", "5", h->frame.stream.len, 5)
        || !test_uint64_t_le("../test/quic_txp_test.c", 941, "h->frame.stream.len", "200", h->frame.stream.len, 200))
        return 0;

    if (!test_mem_eq("../test/quic_txp_test.c", 944, "h->frame.stream.data", "stream_10b + stream_10b_off", h->frame.stream.data, (size_t)h->frame.stream.len, stream_10b + stream_10b_off, (size_t)h->frame.stream.len)
                                                                              )
        return 0;
...
static const struct script_op script_10[] = {
    ...
    { 21, (5000), (42) },
    { 21, (5000), (43) },
    { 16, (42), 0, (stream_10a), sizeof(stream_10a) },
    { 16, (43), 0, (stream_10b), sizeof(stream_10b) },
    ...
    { 6, (0x08) },
    { 9, 0, 0, 
# 969 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 969 "../test/quic_txp_test.c"
   , 0, (check_stream_10a) },
    { 11 },
    ...
    { 6, (0x08) },
    { 9, 0, 0, 
# 978 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 978 "../test/quic_txp_test.c"
   , 0, (check_stream_10b) },
    { 11 },
    ...
    { 6, ((0x08 | 0x04 | 0x02)) },
    { 9, 0, 0, 
# 987 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 987 "../test/quic_txp_test.c"
   , 0, (check_stream_10c) },
    { 10 },
    { 6, ((0x08 | 0x04)) },
    { 9, 0, 0, 
# 990 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 990 "../test/quic_txp_test.c"
   , 0, (check_stream_10d) },
    { 11 },
...
static const struct script_op script_11[] = {
    { 12, (QUIC_ENC_LEVEL_INITIAL), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 14, (QUIC_PN_SPACE_INITIAL), 0, (crypto_1), sizeof(crypto_1) },
    { 1 },
    { 3 },
    { 5, (1200), (1200) },
    { 10 },
...
{
    if (!test_uint64_t_eq("../test/quic_txp_test.c", 1018, "h->frame.stop_sending.stream_id", "42", h->frame.stop_sending.stream_id, 42)
        || !test_uint64_t_eq("../test/quic_txp_test.c", 1019, "h->frame.stop_sending.app_error_code", "4568", h->frame.stop_sending.app_error_code, 4568))
        return 0;
...
static const struct script_op script_12[] = {
    ...
    { 6, (0x05) },
    { 9, 0, 0, 
# 1036 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1036 "../test/quic_txp_test.c"
   , 0, (check_stream_12) },
    { 11 },
    { 4 },
    { 2 },
...
static __attribute__((unused)) int check_stream_13(struct helper *h)
{
    if (!test_uint64_t_eq("../test/quic_txp_test.c", 1050, "h->frame.reset_stream.stream_id", "42", h->frame.reset_stream.stream_id, 42)
        || !test_uint64_t_eq("../test/quic_txp_test.c", 1051, "h->frame.reset_stream.app_error_code", "4568", h->frame.reset_stream.app_error_code, 4568)
        || !test_uint64_t_eq("../test/quic_txp_test.c", 1052, "h->frame.reset_stream.final_size", "0", h->frame.reset_stream.final_size, 0))
        return 0;
...
static const struct script_op script_13[] = {
    ...
    { 20, (8) },
    { 21, (8), (42) },
    { 16, (42), 0, (stream_13), sizeof(stream_13) },
    { 19, (42), (4568) },
    { 1 },
    { 3 },
    { 5, (21), (128) },
    ...
    { 6, (0x04) },
    { 9, 0, 0, 
# 1072 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1072 "../test/quic_txp_test.c"
   , 0, (check_stream_13) },
    { 10 },
    { 11 },
    { 4 },
...
static int gen_conn_close(struct helper *h)
{
    ...
    if (!test_true("../test/quic_txp_test.c", 1090, "ossl_quic_tx_packetiser_schedule_conn_close(h->txp, &f)", (ossl_quic_tx_packetiser_schedule_conn_close(h->txp, &f)) != 0))
        return 0;
...
{
    if (!test_int_eq("../test/quic_txp_test.c", 1098, "h->frame.conn_close.is_app", "0", h->frame.conn_close.is_app, 0)
        || !test_uint64_t_eq("../test/quic_txp_test.c", 1099, "h->frame.conn_close.frame_type", "OSSL_QUIC_FRAME_TYPE_HANDSHAKE_DONE", h->frame.conn_close.frame_type, 0x1E)

        || !test_uint64_t_eq("../test/quic_txp_test.c", 1101, "h->frame.conn_close.error_code", "2345", h->frame.conn_close.error_code, 2345)
        || !test_mem_eq("../test/quic_txp_test.c", 1102, "h->frame.conn_close.reason", "\"Reason string\"", h->frame.conn_close.reason, h->frame.conn_close.reason_len, "Reason string", 13)
                                            )
        return 0;
...
static const struct script_op script_14[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 1113 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1113 "../test/quic_txp_test.c"
   , 0, (gen_conn_close) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
    ...
    { 6, (0x1C) },
    { 9, 0, 0, 
# 1119 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1119 "../test/quic_txp_test.c"
   , 0, (check_14) },
    { 11 },
    { 4 },
    { 0 }
...
static const struct script_op script_15[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 1141 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1141 "../test/quic_txp_test.c"
   , 0, (gen_probe_initial) },
    { 1 },
    { 3 },
    { 5, (1200), (1200) },
...
static const struct script_op script_16[] = {
    { 13, (QUIC_ENC_LEVEL_INITIAL) },
    { 12, (QUIC_ENC_LEVEL_HANDSHAKE), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 9, 0, 0, 
# 1170 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1170 "../test/quic_txp_test.c"
   , 0, (gen_probe_handshake) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
    { 10 },
...
static const struct script_op script_17[] = {
    { 13, (QUIC_ENC_LEVEL_INITIAL) },
    { 13, (QUIC_ENC_LEVEL_HANDSHAKE) },
    { 12, (QUIC_ENC_LEVEL_1RTT), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 9, 0, 0, 
# 1200 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1200 "../test/quic_txp_test.c"
   , 0, (gen_probe_1rtt) },
    { 1 },
    { 3 },
    { 5, (21), (512) },
...
static int try_big_token(struct helper *h)
{
    ...
    if (!test_false("../test/quic_txp_test.c", 1220, "ossl_quic_tx_packetiser_set_initial_token(h->txp, big_token, sizeof(big_token), NULL, NULL)", (ossl_quic_tx_packetiser_set_initial_token(h->txp, big_token, sizeof(big_token), 
# 1220 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 1220 "../test/quic_txp_test.c"
        , 
# 1220 "../test/quic_txp_test.c" 3 4
        ((void *)0)
# 1220 "../test/quic_txp_test.c"
    ...
    for (i = sizeof(big_token) - 1;; --i) {
        if (!test_size_t_gt("../test/quic_txp_test.c", 1232, "i", "0", i, 0))
            return 0;

        if (ossl_quic_tx_packetiser_set_initial_token(h->txp, big_token, i,
                                                      
# 1236 "../test/quic_txp_test.c" 3 4
                                                     ((void *)0)
# 1236 "../test/quic_txp_test.c"
                                                         , 
# 1236 "../test/quic_txp_test.c" 3 4
                                                           ((void *)0)
# 1236 "../test/quic_txp_test.c"
...
static const struct script_op script_18[] = {
    ...
    { 2 },
    { 9, 0, 0, 
# 1246 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1246 "../test/quic_txp_test.c"
   , 0, (try_big_token) },
    { 2 },
    { 14, (QUIC_PN_SPACE_INITIAL), 0, (crypto_1), sizeof(crypto_1) },
    { 1 },
...
# 1285 "../test/quic_txp_test.c" 3 4
                                                               ((void *)0)
# 1285 "../test/quic_txp_test.c"
                                                                   ))
        return;
...
static int run_script(int script_idx, const struct script_op *script)
{
    ...
    have_helper = 1;
    for (op = script, opn = 0; op->opcode != 0; ++op, ++opn) {
        switch (op->opcode) {
        case 1:
            if (!test_true("../test/quic_txp_test.c", 1307, "ossl_quic_tx_packetiser_generate(h.txp, &status)", (ossl_quic_tx_packetiser_generate(h.txp, &status)) != 0)
                && !test_size_t_gt("../test/quic_txp_test.c", 1308, "status.sent_pkt", "0", status.sent_pkt, 0))
                goto err;
            ...
            break;
        case 2:
            if (!test_true("../test/quic_txp_test.c", 1315, "ossl_quic_tx_packetiser_generate(h.txp, &status)", (ossl_quic_tx_packetiser_generate(h.txp, &status)) != 0)
                && !test_size_t_eq("../test/quic_txp_test.c", 1316, "status.sent_pkt", "0", status.sent_pkt, 0))
                goto err;
        ...
        case 3:
            ...
            ossl_qrx_pkt_release(h.qrx_pkt);
            h.qrx_pkt = 
# 1323 "../test/quic_txp_test.c" 3 4
                       ((void *)0)
# 1323 "../test/quic_txp_test.c"
                           ;
            if (!test_true("../test/quic_txp_test.c", 1324, "ossl_qrx_read_pkt(h.qrx, &h.qrx_pkt)", (ossl_qrx_read_pkt(h.qrx, &h.qrx_pkt)) != 0))
                goto err;
            if (!test_true("../test/quic_txp_test.c", 1326, "PACKET_buf_init(&h.pkt, h.qrx_pkt->hdr->data, h.qrx_pkt->hdr->len)", (PACKET_buf_init(&h.pkt, h.qrx_pkt->hdr->data, h.qrx_pkt->hdr->len)) != 0)

                                                                )
                goto err;
            h.frame_type = 
# 1330 "../test/quic_txp_test.c" 3 4
                          (18446744073709551615UL)
# 1330 "../test/quic_txp_test.c"
                                    ;
            break;
        case 4:
            ossl_quic_demux_pump(h.demux);
            if (!test_false("../test/quic_txp_test.c", 1334, "ossl_qrx_read_pkt(h.qrx, &h.qrx_pkt)", (ossl_qrx_read_pkt(h.qrx, &h.qrx_pkt)) != 0))
                goto err;
            h.frame_type = 
# 1336 "../test/quic_txp_test.c" 3 4
                          (18446744073709551615UL)
# 1336 "../test/quic_txp_test.c"
                                    ;
            break;
        case 5:
            if (!test_size_t_ge("../test/quic_txp_test.c", 1339, "h.qrx_pkt->datagram_len", "(size_t)op->arg0", h.qrx_pkt->datagram_len, (size_t)op->arg0)
                || !test_size_t_le("../test/quic_txp_test.c", 1340, "h.qrx_pkt->datagram_len", "(size_t)op->arg1", h.qrx_pkt->datagram_len, (size_t)op->arg1))
                goto err;
            break;
        case 6:
            if (!test_uint64_t_eq("../test/quic_txp_test.c", 1344, "h.frame_type", "op->arg0", h.frame_type, op->arg0))
                goto err;
            break;
        case 7:
            if (!test_mem_eq("../test/quic_txp_test.c", 1348, "h.qrx_pkt->hdr->token", "op->buf", h.qrx_pkt->hdr->token, h.qrx_pkt->hdr->token_len, op->buf, (size_t)op->arg0)
                                                       )
                goto err;
            break;
        case 8:
            if (!test_true("../test/quic_txp_test.c", 1353, "cmp_pkt_hdr(h.qrx_pkt->hdr, op->buf, NULL, 0, 0)", (cmp_pkt_hdr(h.qrx_pkt->hdr, op->buf, 
# 1353 "../test/quic_txp_test.c" 3 4
                ((void *)0)
# 1353 "../test/quic_txp_test.c"
                , 0, 0)) != 0)
                                                   )
                goto err;
            break;
        case 9:
            if (!test_true("../test/quic_txp_test.c", 1358, "op->check_func(&h)", (op->check_func(&h)) != 0))
                goto err;
            break;
        case 10:
            skip_padding(&h);
            if (!ossl_quic_wire_peek_frame_header(&h.pkt, &h.frame_type, 
# 1363 "../test/quic_txp_test.c" 3 4
                                                                        ((void *)0)
# 1363 "../test/quic_txp_test.c"
                                                                            )) {
                h.frame_type = 
# 1364 "../test/quic_txp_test.c" 3 4
                              (18446744073709551615UL)
# 1364 "../test/quic_txp_test.c"
                                        ;
                break;
            }
            ...
            switch (h.frame_type) {
            case 0x1E:
                if (!test_true("../test/quic_txp_test.c", 1370, "ossl_quic_wire_decode_frame_handshake_done(&h.pkt)", (ossl_quic_wire_decode_frame_handshake_done(&h.pkt)) != 0))
                    goto err;
                break;
            case 0x01:
                if (!test_true("../test/quic_txp_test.c", 1374, "ossl_quic_wire_decode_frame_ping(&h.pkt)", (ossl_quic_wire_decode_frame_ping(&h.pkt)) != 0))
                    goto err;
                break;
            case 0x10:
                if (!test_true("../test/quic_txp_test.c", 1378, "ossl_quic_wire_decode_frame_max_data(&h.pkt, &h.frame.max_data)", (ossl_quic_wire_decode_frame_max_data(&h.pkt, &h.frame.max_data)) != 0)
                                                                                       )
                    goto err;
                break;
            case 0x18:
                if (!test_true("../test/quic_txp_test.c", 1383, "ossl_quic_wire_decode_frame_new_conn_id(&h.pkt, &h.frame.new_conn_id)", (ossl_quic_wire_decode_frame_new_conn_id(&h.pkt, &h.frame.new_conn_id)) != 0)
                                                                                             )
                    goto err;
                break;
            case 0x07:
                if (!test_true("../test/quic_txp_test.c", 1388, "ossl_quic_wire_decode_frame_new_token(&h.pkt, &h.frame.new_token.token, &h.frame.new_token.token_len)", (ossl_quic_wire_decode_frame_new_token(&h.pkt, &h.frame.new_token.token, &h.frame.new_token.token_len)) != 0)
            ...
            case 0x02:
                ...
                h.frame.ack.num_ack_ranges = (sizeof(h.ack_ranges)/sizeof((h.ack_ranges)[0]));
                if (!test_true("../test/quic_txp_test.c", 1397, "ossl_quic_wire_decode_frame_ack(&h.pkt, h.args.ack_delay_exponent, &h.frame.ack, NULL)", (ossl_quic_wire_decode_frame_ack(&h.pkt, h.args.ack_delay_exponent, &h.frame.ack, 
# 1397 "../test/quic_txp_test.c" 3 4
                    ((void *)0)
# 1397 "../test/quic_txp_test.c"
                    )) != 0)
                ...
                break;
            case 0x06:
                if (!test_true("../test/quic_txp_test.c", 1404, "ossl_quic_wire_decode_frame_crypto(&h.pkt, 0, &h.frame.crypto)", (ossl_quic_wire_decode_frame_crypto(&h.pkt, 0, &h.frame.crypto)) != 0))
                    goto err;
                break;
            ...
            case (0x08 | 0x04 | 0x02 | 0x01):
                if (!test_true("../test/quic_txp_test.c", 1416, "ossl_quic_wire_decode_frame_stream(&h.pkt, 0, &h.frame.stream)", (ossl_quic_wire_decode_frame_stream(&h.pkt, 0, &h.frame.stream)) != 0))
                    goto err;
                break;

            case 0x05:
                if (!test_true("../test/quic_txp_test.c", 1421, "ossl_quic_wire_decode_frame_stop_sending(&h.pkt, &h.frame.stop_sending)", (ossl_quic_wire_decode_frame_stop_sending(&h.pkt, &h.frame.stop_sending)) != 0)
                                                                                               )
                    goto err;
                break;

            case 0x04:
                if (!test_true("../test/quic_txp_test.c", 1427, "ossl_quic_wire_decode_frame_reset_stream(&h.pkt, &h.frame.reset_stream)", (ossl_quic_wire_decode_frame_reset_stream(&h.pkt, &h.frame.reset_stream)) != 0)
                                                                                               )
                    goto err;
                break;
            ...
            case 0x1C:
            case 0x1D:
                if (!test_true("../test/quic_txp_test.c", 1434, "ossl_quic_wire_decode_frame_conn_close(&h.pkt, &h.frame.conn_close)", (ossl_quic_wire_decode_frame_conn_close(&h.pkt, &h.frame.conn_close)) != 0)
                                                                                           )
                    goto err;
                break;

            default:
                test_error("../test/quic_txp_test.c", 1440, "unknown frame type");
                goto err;
            }
            break;
        case 11:
            skip_padding(&h);
            if (!test_size_t_eq("../test/quic_txp_test.c", 1446, "PACKET_remaining(&h.pkt)", "0", PACKET_remaining(&h.pkt), 0))
                goto err;
            break;
        case 12:
            if (!test_true("../test/quic_txp_test.c", 1450, "ossl_qtx_provide_secret(h.args.qtx, (uint32_t)op->arg0, (uint32_t)op->arg1, NULL, op->buf, op->buf_len)", (ossl_qtx_provide_secret(h.args.qtx, (uint32_t)op->arg0, (uint32_t)op->arg1, 
# 1450 "../test/quic_txp_test.c" 3 4
                ((void *)0)
# 1450 "../test/quic_txp_test.c"
                , op->buf, op->buf_len)) != 0)


                                                                               )
                goto err;
            if (!test_true("../test/quic_txp_test.c", 1455, "ossl_qrx_provide_secret(h.qrx, (uint32_t)op->arg0, (uint32_t)op->arg1, NULL, op->buf, op->buf_len)", (ossl_qrx_provide_secret(h.qrx, (uint32_t)op->arg0, (uint32_t)op->arg1, 
# 1455 "../test/quic_txp_test.c" 3 4
                ((void *)0)
# 1455 "../test/quic_txp_test.c"
                , op->buf, op->buf_len)) != 0)
            ...
            break;
        case 13:
            if (!test_true("../test/quic_txp_test.c", 1462, "ossl_quic_tx_packetiser_discard_enc_level(h.txp, (uint32_t)op->arg0)", (ossl_quic_tx_packetiser_discard_enc_level(h.txp, (uint32_t)op->arg0)) != 0)
                                                                                         )
                goto err;
        ...
        case 14:
            {
                ...
                if (!test_true("../test/quic_txp_test.c", 1475, "ossl_quic_sstream_append(h.args.crypto[op->arg0], op->buf, op->buf_len, &consumed)", (ossl_quic_sstream_append(h.args.crypto[op->arg0], op->buf, op->buf_len, &consumed)) != 0)

                                                                   )
                    goto err;

                if (!test_size_t_eq("../test/quic_txp_test.c", 1480, "consumed", "op->buf_len", consumed, op->buf_len))
                    goto err;
            }
            break;
        case 15:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1488, "s = ossl_quic_stream_map_alloc(h.args.qsm, op->arg0, QUIC_STREAM_DIR_BIDI)", s = ossl_quic_stream_map_alloc(h.args.qsm, op->arg0, 0))
                                                                                   )
                    goto err;

                if (!test_ptr("../test/quic_txp_test.c", 1492, "s->sstream = ossl_quic_sstream_new(512 * 1024)", s->sstream = ossl_quic_sstream_new(512 * 1024))
                    || !test_true("../test/quic_txp_test.c", 1493, "ossl_quic_txfc_init(&s->txfc, &h.conn_txfc)", (ossl_quic_txfc_init(&s->txfc, &h.conn_txfc)) != 0)
                    || !test_true("../test/quic_txp_test.c", 1494, "ossl_quic_rxfc_init(&s->rxfc, &h.conn_rxfc, 1 * 1024 * 1024, 16 * 1024 * 1024, fake_now, NULL)", (ossl_quic_rxfc_init(&s->rxfc, &h.conn_rxfc, 1 * 1024 * 1024, 16 * 1024 * 1024, fake_now, 
# 1494 "../test/quic_txp_test.c" 3 4
                       ((void *)0)
# 1494 "../test/quic_txp_test.c"
                       )) != 0)



                    || !test_ptr("../test/quic_txp_test.c", 1498, "s->rstream = ossl_quic_rstream_new(&s->rxfc, NULL, 1024)", s->rstream = ossl_quic_rstream_new(&s->rxfc, 
# 1498 "../test/quic_txp_test.c" 3 4
                       ((void *)0)
# 1498 "../test/quic_txp_test.c"
                       , 1024))
                                                                                ) {
        ...
        case 16:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1511, "s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0)", s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0))
                                                                           )
                    goto err;

                if (!test_true("../test/quic_txp_test.c", 1515, "ossl_quic_sstream_append(s->sstream, op->buf, op->buf_len, &consumed)", (ossl_quic_sstream_append(s->sstream, op->buf, op->buf_len, &consumed)) != 0)
                                                                                )
                    goto err;

                if (!test_size_t_eq("../test/quic_txp_test.c", 1519, "consumed", "op->buf_len", consumed, op->buf_len))
                    goto err;
        ...
        case 17:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1529, "s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0)", s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0))
                                                                           )
                    goto err;
        ...
        case 18:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1540, "s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0)", s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0))
                                                                           )
                    goto err;

                if (!test_true("../test/quic_txp_test.c", 1544, "ossl_quic_stream_map_stop_sending_recv_part(h.args.qsm, s, op->arg1)", (ossl_quic_stream_map_stop_sending_recv_part(h.args.qsm, s, op->arg1)) != 0)
                                                                                        )
                    goto err;

                ossl_quic_stream_map_update_state(h.args.qsm, s);

                if (!test_true("../test/quic_txp_test.c", 1550, "s->active", (s->active) != 0))
                    goto err;
            }
            break;
        case 19:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1558, "s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0)", s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg0))
                                                                           )
                    goto err;

                if (!test_true("../test/quic_txp_test.c", 1562, "ossl_quic_stream_map_reset_stream_send_part(h.args.qsm, s, op->arg1)", (ossl_quic_stream_map_reset_stream_send_part(h.args.qsm, s, op->arg1)) != 0)
                                                                                        )
                    goto err;

                ossl_quic_stream_map_update_state(h.args.qsm, s);

                if (!test_true("../test/quic_txp_test.c", 1568, "s->active", (s->active) != 0))
                    goto err;
            }
            break;
        case 20:
            if (!test_true("../test/quic_txp_test.c", 1573, "ossl_quic_txfc_bump_cwm(h.args.conn_txfc, op->arg0)", (ossl_quic_txfc_bump_cwm(h.args.conn_txfc, op->arg0)) != 0))
                goto err;
        ...
        case 21:
            {
                ...
                if (!test_ptr("../test/quic_txp_test.c", 1581, "s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg1)", s = ossl_quic_stream_map_get_by_id(h.args.qsm, op->arg1))
                                                                           )
                    goto err;

                if (!test_true("../test/quic_txp_test.c", 1585, "ossl_quic_txfc_bump_cwm(&s->txfc, op->arg0)", (ossl_quic_txfc_bump_cwm(&s->txfc, op->arg0)) != 0))
                    goto err;
        ...
        case 23:
            break;
        default:
            test_error("../test/quic_txp_test.c", 1597, "bad opcode");
            goto err;
        }
    }
...
err:
    if (!testresult)
        test_error("../test/quic_txp_test.c", 1605, "script %d failed at op %zu", script_idx + 1, opn + 1);
    if (have_helper)
        helper_cleanup(&h);
    return testresult;
}
...
{
    return h->qrx_pkt->hdr->type == 1;
}

static int check_is_handshake(struct helper *h)
{
    return h->qrx_pkt->hdr->type == 3;
}
...
static struct script_op dyn_script_1[] = {
    ...
    { 12, (QUIC_ENC_LEVEL_HANDSHAKE), (1), (secret_1), sizeof(secret_1) },
    { 2 },
    { 14, (QUIC_PN_SPACE_INITIAL), 0, (dyn_script_1_crypto_1a), sizeof(dyn_script_1_crypto_1a) },
    { 14, (QUIC_PN_SPACE_HANDSHAKE), 0, (dyn_script_1_crypto_1b), sizeof(dyn_script_1_crypto_1b) },
    { 1 },
    { 3 },
    { 5, (1200), (1200) },
    { 9, 0, 0, 
# 1662 "../test/quic_txp_test.c" 3 4
   ((void *)0)
# 1662 "../test/quic_txp_test.c"
   , 0, (check_is_initial) },
    { 23 },
    { 23 },
    { 0 }
...
static int test_dyn_script_1(int idx)
{
    ...
    if (expect_handshake_pkt_in_same_dgram) {
        dyn_script_1[dyn_script_1_pkt_idx].opcode = 3;
        dyn_script_1[dyn_script_1_check_idx].opcode = 9;
        dyn_script_1[dyn_script_1_check_idx].check_func = check_is_handshake;
    } else {
        dyn_script_1[dyn_script_1_pkt_idx].opcode = 4;
        dyn_script_1[dyn_script_1_check_idx].opcode = 23;
    }

    if (!run_script(idx, dyn_script_1)) {
        test_error("../test/quic_txp_test.c", 1690, "failed dyn script 1 with target size %zu", target_size);
        return 0;
    }
...
int setup_tests(void)
{
    add_all_tests("test_script", test_script, (sizeof(scripts)/sizeof((scripts)[0])), 1);
    add_all_tests("test_dyn_script_1", test_dyn_script_1, (sizeof(dyn_script_1_crypto_1a)/sizeof((dyn_script_1_crypto_1a)[0])) - dyn_script_1_start_from + 1, 1)
