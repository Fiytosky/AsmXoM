# 0 "../test/cmp_asn_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cmp_asn_test.c"
# 12 "../test/cmp_asn_test.c"
...
static CMP_ASN_TEST_FIXTURE *set_up(const char *const test_case_name)
{
    ...
    if (!test_ptr("../test/cmp_asn_test.c", 28, "fixture = OPENSSL_zalloc(sizeof(*fixture))", fixture = CRYPTO_zalloc(sizeof(*fixture), "../test/cmp_asn_test.c", 28)))
        return 
# 29 "../test/cmp_asn_test.c" 3 4
              ((void *)0)
# 29 "../test/cmp_asn_test.c"
                  ;
...
static void tear_down(CMP_ASN_TEST_FIXTURE *fixture)
{
    ...
    CRYPTO_free(fixture, "../test/cmp_asn_test.c", 40);
}
...
# 48 "../test/cmp_asn_test.c"
                                  ;

    if (!test_ptr("../test/cmp_asn_test.c", 50, "asn1integer", asn1integer))
        return res;

    if (!test_true("../test/cmp_asn_test.c", 53, "ASN1_INTEGER_set(asn1integer, good_int)", (ASN1_INTEGER_set(asn1integer, good_int)) != 0)) {
        ASN1_INTEGER_free(asn1integer);
        return 0;
    }
    res = test_int_eq("../test/cmp_asn_test.c", 57, "good_int", "ossl_cmp_asn1_get_int(asn1integer)", good_int, ossl_cmp_asn1_get_int(asn1integer));
    if (res == 0)
        goto err;

    res = 0;
    if (!test_true("../test/cmp_asn_test.c", 62, "ASN1_INTEGER_set_int64(asn1integer, max_int + 1)", (ASN1_INTEGER_set_int64(asn1integer, max_int + 1)) != 0))
        goto err;
    res = test_int_eq("../test/cmp_asn_test.c", 64, "-2", "ossl_cmp_asn1_get_int(asn1integer)", -2, ossl_cmp_asn1_get_int(asn1integer));
...
{
    CMP_ASN_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 73 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 73 "../test/cmp_asn_test.c"
   ) return 0;
    fixture->expected = 1;
    if (fixture != 
# 75 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 75 "../test/cmp_asn_test.c"
   ) { result = execute_cmp_asn1_get_int_test(fixture); tear_down(fixture); };
    return result;
}
...
static int execute_CMP_ASN1_OCTET_STRING_set1_test(CMP_ASN_TEST_FIXTURE *
                                                   fixture)
{
    if (!test_int_eq("../test/cmp_asn_test.c", 82, "fixture->expected", "ossl_cmp_asn1_octet_string_set1(&fixture->tgt_string, fixture->src_string)", fixture->expected, ossl_cmp_asn1_octet_string_set1(&fixture->tgt_string, fixture->src_string))

                                                                          )
        return 0;
    if (fixture->expected != 0)
        return test_int_eq("../test/cmp_asn_test.c", 87, "0", "ASN1_OCTET_STRING_cmp(fixture->tgt_string, fixture->src_string)", 0, ASN1_OCTET_STRING_cmp(fixture->tgt_string, fixture->src_string))
                                                                         ;
    return 1;
}
...
{
    CMP_ASN_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 94 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 94 "../test/cmp_asn_test.c"
   ) return 0;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_asn_test.c", 96, "fixture->tgt_string = ASN1_OCTET_STRING_new()", fixture->tgt_string = ASN1_OCTET_STRING_new())
            || !test_ptr("../test/cmp_asn_test.c", 97, "fixture->src_string = ASN1_OCTET_STRING_new()", fixture->src_string = ASN1_OCTET_STRING_new())
            || !test_true("../test/cmp_asn_test.c", 98, "ASN1_OCTET_STRING_set(fixture->src_string, rand_data, sizeof(rand_data))", (ASN1_OCTET_STRING_set(fixture->src_string, rand_data, sizeof(rand_data))) != 0)
                                                                   ) {
        tear_down(fixture);
        fixture = 
# 101 "../test/cmp_asn_test.c" 3 4
                 ((void *)0)
# 101 "../test/cmp_asn_test.c"
                     ;
    }
    if (fixture != 
# 103 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 103 "../test/cmp_asn_test.c"
   ) { result = execute_CMP_ASN1_OCTET_STRING_set1_test(fixture); tear_down(fixture); };
    return result;
}
...
{
    CMP_ASN_TEST_FIXTURE *fixture = set_up(__func__); int result = 0; if (fixture == 
# 109 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 109 "../test/cmp_asn_test.c"
   ) return 0;
    fixture->expected = 1;
    if (!test_ptr("../test/cmp_asn_test.c", 111, "fixture->src_string = ASN1_OCTET_STRING_new()", fixture->src_string = ASN1_OCTET_STRING_new())
            || !(fixture->tgt_string = fixture->src_string)
            || !test_true("../test/cmp_asn_test.c", 113, "ASN1_OCTET_STRING_set(fixture->src_string, rand_data, sizeof(rand_data))", (ASN1_OCTET_STRING_set(fixture->src_string, rand_data, sizeof(rand_data))) != 0)
                                                                   ) {
        tear_down(fixture);
        fixture = 
# 116 "../test/cmp_asn_test.c" 3 4
                 ((void *)0)
# 116 "../test/cmp_asn_test.c"
                     ;
    }
    if (fixture != 
# 118 "../test/cmp_asn_test.c" 3 4
   ((void *)0)
# 118 "../test/cmp_asn_test.c"
   ) { result = execute_CMP_ASN1_OCTET_STRING_set1_test(fixture); tear_down(fixture); };
    return result;
}
