# 0 "../test/conf_include_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/conf_include_test.c"
# 10 "../test/conf_include_test.c"
...
# 15 "../test/conf_include_test.c" 2
# 40 "../test/conf_include_test.c"
static char *change_path(const char *file)
{
    char *s = CRYPTO_strdup(file, "../test/conf_include_test.c", 42);
    char *p = s;
    char *last = 
# 44 "../test/conf_include_test.c" 3 4
                ((void *)0)
# 44 "../test/conf_include_test.c"
                    ;
    int ret = 0;
    char *new_config_name = 
# 46 "../test/conf_include_test.c" 3 4
                           ((void *)0)
# 46 "../test/conf_include_test.c"
                               ;

    if (s == 
# 48 "../test/conf_include_test.c" 3 4
            ((void *)0)
# 48 "../test/conf_include_test.c"
                )
        return 
# 49 "../test/conf_include_test.c" 3 4
              ((void *)0)
# 49 "../test/conf_include_test.c"
                  ;

    while ((p = strpbrk(p, "/")) != 
# 51 "../test/conf_include_test.c" 3 4
                                      ((void *)0)
# 51 "../test/conf_include_test.c"
                                          ) {
        last = p++;
    }
    if (last == 
# 54 "../test/conf_include_test.c" 3 4
               ((void *)0)
# 54 "../test/conf_include_test.c"
                   )
        goto err;
    ...
    ret = chdir(s);
    if (ret == 0)
        new_config_name = CRYPTO_strdup(last + 0 + 1, "../test/conf_include_test.c", 62);
 err:
    CRYPTO_free(s, "../test/conf_include_test.c", 64);
...
# 76 "../test/conf_include_test.c" 3 4
                             ((void *)0)
# 76 "../test/conf_include_test.c"
                                 ;
static char *rel_conf_file = 
# 77 "../test/conf_include_test.c" 3 4
                            ((void *)0)
# 77 "../test/conf_include_test.c"
                                ;
...
static int test_load_config(void)
{
    ...
    if (!test_int_gt("../test/conf_include_test.c", 86, "NCONF_load_bio(conf, in, &errline)", "0", NCONF_load_bio(conf, in, &errline), 0)
        || !test_int_eq("../test/conf_include_test.c", 87, "err = ERR_peek_error()", "0", err = ERR_peek_error(), 0)) {
        if (expect_failure)
            return 1;
    ...
    if (!test_int_gt("../test/conf_include_test.c", 98, "CONF_modules_load(conf, NULL, 0)", "0", CONF_modules_load(conf, 
# 98 "../test/conf_include_test.c" 3 4
        ((void *)0)
# 98 "../test/conf_include_test.c"
        , 0), 0)) {
    ...
    val = 0;
    if (!test_int_eq("../test/conf_include_test.c", 105, "NCONF_get_number(conf, \"CA_default\", \"default_days\", &val)", "1", NCONF_get_number_e(conf,"CA_default","default_days",&val), 1)
        || !test_int_eq("../test/conf_include_test.c", 106, "val", "365", val, 365)) {
    ...
    val = 0;
    if (!test_int_eq("../test/conf_include_test.c", 113, "NCONF_get_number(conf, \"req\", \"default_bits\", &val)", "1", NCONF_get_number_e(conf,"req","default_bits",&val), 1)
        || !test_int_eq("../test/conf_include_test.c", 114, "val", "2048", val, 2048)) {
    ...
    if (!test_ptr("../test/conf_include_test.c", 121, "str", str) || !test_str_eq("../test/conf_include_test.c", 121, "str", "\"AU\"", str, "AU")) {
    ...
    if (test_providers != 0) {
        ...
        val = 0;
        if (!test_int_eq("../test/conf_include_test.c", 129, "NCONF_get_number(conf, \"null_sect\", \"activate\", &val)", "1", NCONF_get_number_e(conf,"null_sect","activate",&val), 1)
            || !test_int_eq("../test/conf_include_test.c", 130, "val", "1", val, 1)) {
            test_note("null provider not activated");
            return 0;
        }
        val = 0;
        if (!test_int_eq("../test/conf_include_test.c", 135, "NCONF_get_number(conf, \"default_sect\", \"activate\", &val)", "1", NCONF_get_number_e(conf,"default_sect","activate",&val), 1)
            || !test_int_eq("../test/conf_include_test.c", 136, "val", "1", val, 1)) {
            test_note("default provider not activated");
            return 0;
        }
        val = 0;
        if (!test_int_eq("../test/conf_include_test.c", 141, "NCONF_get_number(conf, \"legacy_sect\", \"activate\", &val)", "1", NCONF_get_number_e(conf,"legacy_sect","activate",&val), 1)
            || !test_int_eq("../test/conf_include_test.c", 142, "val", "1", val, 1)) {
...
static int test_check_null_numbers(void)
{
    ...
    if (!test_int_eq("../test/conf_include_test.c", 160, "setenv(\"FNORD\", \"123\", 1)", "0", setenv("FNORD", "123", 1), 0)
            || !test_true("../test/conf_include_test.c", 161, "NCONF_get_number(NULL, \"missing\", \"FNORD\", &val)", (NCONF_get_number_e(
# 161 "../test/conf_include_test.c" 3 4
               ((void *)0)
# 161 "../test/conf_include_test.c"
               ,"missing","FNORD",&val)) != 0)
            || !test_long_eq("../test/conf_include_test.c", 162, "val", "123", val, 123)) {
    ...
    if (!test_int_eq("../test/conf_include_test.c", 171, "unsetenv(\"FNORD\")", "0", unsetenv("FNORD"), 0)
            || !test_false("../test/conf_include_test.c", 172, "NCONF_get_number(NULL, \"missing\", \"FNORD\", &val)", (NCONF_get_number_e(
# 172 "../test/conf_include_test.c" 3 4
               ((void *)0)
# 172 "../test/conf_include_test.c"
               ,"missing","FNORD",&val)) != 0)) {
...
static int test_check_overflow(void)
{
    ...
    p = max + BIO_snprintf(max, sizeof(max), "0%ld", 0x7fffffffffffffffL
# 189 "../test/conf_include_test.c"
                                                            ) - 1;
    setenv("FNORD", max, 1);
    if (!test_true("../test/conf_include_test.c", 191, "NCONF_get_number(NULL, \"missing\", \"FNORD\", &val)", (NCONF_get_number_e(
# 191 "../test/conf_include_test.c" 3 4
        ((void *)0)
# 191 "../test/conf_include_test.c"
        ,"missing","FNORD",&val)) != 0)
            || !test_long_eq("../test/conf_include_test.c", 192, "val", "LONG_MAX", val, 0x7fffffffffffffffL
# 192 "../test/conf_include_test.c"
               ))
        return 0;
    ...
    setenv("FNORD", max, 1);
    if (!test_false("../test/conf_include_test.c", 199, "NCONF_get_number(NULL, \"missing\", \"FNORD\", &val)", (NCONF_get_number_e(
# 199 "../test/conf_include_test.c" 3 4
        ((void *)0)
# 199 "../test/conf_include_test.c"
        ,"missing","FNORD",&val)) != 0))
        return 0;
...
static int test_available_providers(void)
{
    ...
    if (!test_ptr("../test/conf_include_test.c", 208, "libctx", libctx))
        return 0;

    if (!test_ptr("../test/conf_include_test.c", 211, "rel_conf_file", rel_conf_file) || !OSSL_LIB_CTX_load_config(libctx, rel_conf_file)) {
...
const OPTIONS *test_get_options(void)
{
    static const OPTIONS test_options[] = {
        ...
        { 
# 242 "../test/conf_include_test.c" 3 4
         ((void *)0) 
# 242 "../test/conf_include_test.c"
              }
    };
    return test_options;
}
...
{
    char *conf_file = 
# 249 "../test/conf_include_test.c" 3 4
                     ((void *)0)
# 249 "../test/conf_include_test.c"
                         ;
    OPTION_CHOICE o;

    if (!test_ptr("../test/conf_include_test.c", 252, "conf = NCONF_new(NULL)", conf = NCONF_new(
# 252 "../test/conf_include_test.c" 3 4
        ((void *)0)
# 252 "../test/conf_include_test.c"
        )))
        return 0;
    ...
    if (!test_ptr("../test/conf_include_test.c", 270, "conf_file", conf_file)
        || !test_ptr("../test/conf_include_test.c", 271, "in = BIO_new_file(conf_file, \"r\")", in = BIO_new_file(conf_file, "r"))) {
    ...
    if (!test_ptr("../test/conf_include_test.c", 281, "rel_conf_file", rel_conf_file)) {
    ...
    if (test_providers != 0)
        add_test("test_available_providers", test_available_providers);
...
void cleanup_tests(void)
{
    CRYPTO_free(rel_conf_file, "../test/conf_include_test.c", 297);
    BIO_vfree(in);
    NCONF_free(conf);
