...
{
    DH *dh = 
# 39 "../test/dhtest.c" 3 4
            ((void *)0)
# 39 "../test/dhtest.c"
                ;
    BIGNUM *p = 
# 40 "../test/dhtest.c" 3 4
               ((void *)0)
# 40 "../test/dhtest.c"
                   , *q = 
# 40 "../test/dhtest.c" 3 4
...
# 40 "../test/dhtest.c"
    ...
    BIGNUM *priv_key = 
# 42 "../test/dhtest.c" 3 4
                      ((void *)0)
# 42 "../test/dhtest.c"
                          ;
    const BIGNUM *pub_key2, *priv_key2;
    BN_GENCB *_cb = 
# 44 "../test/dhtest.c" 3 4
                   ((void *)0)
# 44 "../test/dhtest.c"
                       ;
    DH *a = 
# 45 "../test/dhtest.c" 3 4
           ((void *)0)
# 45 "../test/dhtest.c"
               ;
    DH *b = 
# 46 "../test/dhtest.c" 3 4
           ((void *)0)
# 46 "../test/dhtest.c"
               ;
    DH *c = 
# 47 "../test/dhtest.c" 3 4
           ((void *)0)
# 47 "../test/dhtest.c"
               ;
    const BIGNUM *ap = 
# 48 "../test/dhtest.c" 3 4
                      ((void *)0)
# 48 "../test/dhtest.c"
                          , *ag = 
# 48 "../test/dhtest.c" 3 4
...
# 48 "../test/dhtest.c"
                                                        ;
    const BIGNUM *bpub_key = 
# 49 "../test/dhtest.c" 3 4
                            ((void *)0)
# 49 "../test/dhtest.c"
                                , *bpriv_key = 
# 49 "../test/dhtest.c" 3 4
...
# 50 "../test/dhtest.c"
                                                   ;
    unsigned char *abuf = 
# 51 "../test/dhtest.c" 3 4
                         ((void *)0)
# 51 "../test/dhtest.c"
                             ;
    unsigned char *bbuf = 
# 52 "../test/dhtest.c" 3 4
                         ((void *)0)
# 52 "../test/dhtest.c"
                             ;
    unsigned char *cbuf = 
# 53 "../test/dhtest.c" 3 4
                         ((void *)0)
# 53 "../test/dhtest.c"
                             ;
    ...
    if (!test_ptr("../test/dhtest.c", 57, "dh = DH_new()", dh = DH_new())
        || !test_ptr("../test/dhtest.c", 58, "p = BN_new()", p = BN_new())
        || !test_ptr("../test/dhtest.c", 59, "q = BN_new()", q = BN_new())
        || !test_ptr("../test/dhtest.c", 60, "g = BN_new()", g = BN_new())
        || !test_ptr("../test/dhtest.c", 61, "priv_key = BN_new()", priv_key = BN_new()))
        goto err1;
    ...
    if (!test_true("../test/dhtest.c", 69, "BN_set_word(p, 4079L)", (BN_set_word(p, 4079L)) != 0)
        || !test_true("../test/dhtest.c", 70, "BN_set_word(q, 2039L)", (BN_set_word(q, 2039L)) != 0)
        || !test_true("../test/dhtest.c", 71, "BN_set_word(g, 3L)", (BN_set_word(g, 3L)) != 0)
        || !test_true("../test/dhtest.c", 72, "DH_set0_pqg(dh, p, q, g)", (DH_set0_pqg(dh, p, q, g)) != 0))
        goto err1;


    if (!test_true("../test/dhtest.c", 76, "DH_check(dh, &i)", (DH_check(dh, &i)) != 0))
        goto err2;
    i ^= 0x80;
    if (!test_false("../test/dhtest.c", 79, "i & DH_CHECK_P_NOT_PRIME", (i & 0x01) != 0)
            || !test_false("../test/dhtest.c", 80, "i & DH_CHECK_P_NOT_SAFE_PRIME", (i & 0x02) != 0)
            || !test_false("../test/dhtest.c", 81, "i & DH_UNABLE_TO_CHECK_GENERATOR", (i & 0x04) != 0)
            || !test_false("../test/dhtest.c", 82, "i & DH_NOT_SUITABLE_GENERATOR", (i & 0x08) != 0)
            || !test_false("../test/dhtest.c", 83, "i & DH_CHECK_Q_NOT_PRIME", (i & 0x10) != 0)
            || !test_false("../test/dhtest.c", 84, "i & DH_CHECK_INVALID_Q_VALUE", (i & 0x20) != 0)
            || !test_false("../test/dhtest.c", 85, "i & DH_CHECK_INVALID_J_VALUE", (i & 0x40) != 0)
            || !test_false("../test/dhtest.c", 86, "i & DH_MODULUS_TOO_SMALL", (i & 0x80) != 0)
            || !test_false("../test/dhtest.c", 87, "i & DH_MODULUS_TOO_LARGE", (i & 0x100) != 0)
            || !test_false("../test/dhtest.c", 88, "i", (i) != 0))
        goto err2;


    DH_get0_pqg(dh, &p2, &q2, &g2);
    if (!test_ptr_eq("../test/dhtest.c", 93, "p2", "p", p2, p)
        || !test_ptr_eq("../test/dhtest.c", 94, "q2", "q", q2, q)
        || !test_ptr_eq("../test/dhtest.c", 95, "g2", "g", g2, g))
        goto err2;


    if (!test_ptr_eq("../test/dhtest.c", 99, "DH_get0_p(dh)", "p2", DH_get0_p(dh), p2)
        || !test_ptr_eq("../test/dhtest.c", 100, "DH_get0_q(dh)", "q2", DH_get0_q(dh), q2)
        || !test_ptr_eq("../test/dhtest.c", 101, "DH_get0_g(dh)", "g2", DH_get0_g(dh), g2))
        goto err2;


    if (!test_true("../test/dhtest.c", 105, "BN_set_word(priv_key, 1234L)", (BN_set_word(priv_key, 1234L)) != 0)
        || !test_true("../test/dhtest.c", 106, "DH_set0_key(dh, NULL, priv_key)", (DH_set0_key(dh, 
# 106 "../test/dhtest.c" 3 4
           ((void *)0)
# 106 "../test/dhtest.c"
           , priv_key)) != 0))
        goto err2;
    ...
    if (!test_ptr_eq("../test/dhtest.c", 111, "pub_key2", "NULL", pub_key2, 
# 111 "../test/dhtest.c" 3 4
        ((void *)0)
# 111 "../test/dhtest.c"
        )
        || !test_ptr_eq("../test/dhtest.c", 112, "priv_key2", "priv_key", priv_key2, priv_key))
        goto err3;


    if (!test_ptr_eq("../test/dhtest.c", 116, "DH_get0_pub_key(dh)", "pub_key2", DH_get0_pub_key(dh), pub_key2)
        || !test_ptr_eq("../test/dhtest.c", 117, "DH_get0_priv_key(dh)", "priv_key2", DH_get0_priv_key(dh), priv_key2))
        goto err3;


    if (!test_false("../test/dhtest.c", 121, "DH_generate_key(dh)", (DH_generate_key(dh)) != 0))
        goto err3;


    ERR_clear_error();

    if (!test_ptr("../test/dhtest.c", 127, "BN_copy(q, p)", BN_copy(q, p)) || !test_true("../test/dhtest.c", 127, "BN_add(q, q, BN_value_one())", (BN_add(q, q, BN_value_one())) != 0))
        goto err3;

    if (!test_true("../test/dhtest.c", 130, "DH_check(dh, &i)", (DH_check(dh, &i)) != 0))
        goto err3;
    if (!test_true("../test/dhtest.c", 132, "i & DH_CHECK_INVALID_Q_VALUE", (i & 0x20) != 0)
        || !test_false("../test/dhtest.c", 133, "i & DH_CHECK_Q_NOT_PRIME", (i & 0x10) != 0))
        goto err3;


    if (!test_true("../test/dhtest.c", 137, "BN_set_word(p, 1)", (BN_set_word(p, 1)) != 0)
            || !test_true("../test/dhtest.c", 138, "BN_lshift(p, p, OPENSSL_DH_CHECK_MAX_MODULUS_BITS)", (BN_lshift(p, p, 32768)) != 0))
        goto err3;




    if (!test_false("../test/dhtest.c", 144, "DH_check(dh, &i)", (DH_check(dh, &i)) != 0))
        goto err3;
    ...
    if (!test_ptr("../test/dhtest.c", 155, "_cb = BN_GENCB_new()", _cb = BN_GENCB_new()))
        goto err3;
    BN_GENCB_set(_cb, &cb, 
# 157 "../test/dhtest.c" 3 4
                          ((void *)0)
# 157 "../test/dhtest.c"
                              );
    if (!test_ptr("../test/dhtest.c", 158, "a = DH_new()", a = DH_new())
            || !test_true("../test/dhtest.c", 159, "DH_generate_parameters_ex(a, 512, DH_GENERATOR_5, _cb)", (DH_generate_parameters_ex(a, 512, 5, _cb)) != 0)
                                                                         )
        goto err3;


    if (!test_true("../test/dhtest.c", 164, "DH_check(a, &i)", (DH_check(a, &i)) != 0))
        goto err3;
    if (!test_false("../test/dhtest.c", 166, "i & DH_CHECK_P_NOT_PRIME", (i & 0x01) != 0)
            || !test_false("../test/dhtest.c", 167, "i & DH_CHECK_P_NOT_SAFE_PRIME", (i & 0x02) != 0)
            || !test_false("../test/dhtest.c", 168, "i & DH_UNABLE_TO_CHECK_GENERATOR", (i & 0x04) != 0)
            || !test_false("../test/dhtest.c", 169, "i & DH_NOT_SUITABLE_GENERATOR", (i & 0x08) != 0)
            || !test_false("../test/dhtest.c", 170, "i & DH_CHECK_Q_NOT_PRIME", (i & 0x10) != 0)
            || !test_false("../test/dhtest.c", 171, "i & DH_CHECK_INVALID_Q_VALUE", (i & 0x20) != 0)
            || !test_false("../test/dhtest.c", 172, "i & DH_CHECK_INVALID_J_VALUE", (i & 0x40) != 0)
            || !test_false("../test/dhtest.c", 173, "i & DH_MODULUS_TOO_SMALL", (i & 0x80) != 0)
            || !test_false("../test/dhtest.c", 174, "i & DH_MODULUS_TOO_LARGE", (i & 0x100) != 0)
            || !test_false("../test/dhtest.c", 175, "i", (i) != 0))
        goto err3;

    DH_get0_pqg(a, &ap, 
# 178 "../test/dhtest.c" 3 4
                       ((void *)0)
# 178 "../test/dhtest.c"
                           , &ag);


    if (!test_ptr("../test/dhtest.c", 181, "b = DH_new()", b = DH_new()))
        goto err3;

    if (!test_ptr("../test/dhtest.c", 184, "bp = BN_dup(ap)", bp = BN_dup(ap))
            || !test_ptr("../test/dhtest.c", 185, "bg = BN_dup(ag)", bg = BN_dup(ag))
            || !test_true("../test/dhtest.c", 186, "DH_set0_pqg(b, bp, NULL, bg)", (DH_set0_pqg(b, bp, 
# 186 "../test/dhtest.c" 3 4
               ((void *)0)
# 186 "../test/dhtest.c"
               , bg)) != 0))
        goto err3;
    bp = bg = 
# 188 "../test/dhtest.c" 3 4
             ((void *)0)
# 188 "../test/dhtest.c"
                 ;
...
# 196 "../test/dhtest.c"
    ...
    if (!test_ptr("../test/dhtest.c", 203, "c = DHparams_dup(b)", c = DHparams_dup(b))
            || !test_ptr("../test/dhtest.c", 204, "cpriv_key = BN_dup(bpriv_key)", cpriv_key = BN_dup(bpriv_key))
            || !test_true("../test/dhtest.c", 205, "DH_set0_key(c, NULL, cpriv_key)", (DH_set0_key(c, 
# 205 "../test/dhtest.c" 3 4
               ((void *)0)
# 205 "../test/dhtest.c"
               , cpriv_key)) != 0))
        goto err3;
    cpriv_key = 
# 207 "../test/dhtest.c" 3 4
               ((void *)0)
# 207 "../test/dhtest.c"
                   ;

    alen = DH_size(a);
    if (!test_ptr("../test/dhtest.c", 210, "abuf = OPENSSL_malloc(alen)", abuf = CRYPTO_malloc(alen, "../test/dhtest.c", 210))
            || !test_int_gt("../test/dhtest.c", 211, "(aout = DH_compute_key(abuf, bpub_key, a))", "0", (aout = DH_compute_key(abuf, bpub_key, a)), 0))
        goto err3;

    blen = DH_size(b);
    if (!test_ptr("../test/dhtest.c", 215, "bbuf = OPENSSL_malloc(blen)", bbuf = CRYPTO_malloc(blen, "../test/dhtest.c", 215))
            || !test_int_gt("../test/dhtest.c", 216, "(bout = DH_compute_key(bbuf, apub_key, b))", "0", (bout = DH_compute_key(bbuf, apub_key, b)), 0))
        goto err3;

    clen = DH_size(c);
    if (!test_ptr("../test/dhtest.c", 220, "cbuf = OPENSSL_malloc(clen)", cbuf = CRYPTO_malloc(clen, "../test/dhtest.c", 220))
            || !test_int_gt("../test/dhtest.c", 221, "(cout = DH_compute_key(cbuf, apub_key, c))", "0", (cout = DH_compute_key(cbuf, apub_key, c)), 0))
        goto err3;

    if (!test_true("../test/dhtest.c", 224, "aout >= 20", (aout >= 20) != 0)
            || !test_mem_eq("../test/dhtest.c", 225, "abuf", "bbuf", abuf, aout, bbuf, bout)
            || !test_mem_eq("../test/dhtest.c", 226, "abuf", "cbuf", abuf, aout, cbuf, cout))
        goto err3;
 ...
 err3:
 success:
    CRYPTO_free(abuf, "../test/dhtest.c", 242);
    CRYPTO_free(bbuf, "../test/dhtest.c", 243);
    CRYPTO_free(cbuf, "../test/dhtest.c", 244);
    DH_free(b);
    DH_free(a);
    DH_free(c);
    BN_free(bp);
...
static int dh_computekey_range_test(void)
{
    int ret = 0, sz;
    DH *dh = 
# 265 "../test/dhtest.c" 3 4
            ((void *)0)
# 265 "../test/dhtest.c"
                ;
    BIGNUM *p = 
# 266 "../test/dhtest.c" 3 4
               ((void *)0)
# 266 "../test/dhtest.c"
                   , *q = 
# 266 "../test/dhtest.c" 3 4
...
# 266 "../test/dhtest.c"
                                                                    ;
    unsigned char *buf = 
# 267 "../test/dhtest.c" 3 4
                        ((void *)0)
# 267 "../test/dhtest.c"
                            ;

    if (!test_ptr("../test/dhtest.c", 269, "p = BN_dup(&ossl_bignum_ffdhe2048_p)", p = BN_dup(&ossl_bignum_ffdhe2048_p))
        || !test_ptr("../test/dhtest.c", 270, "q = BN_dup(&ossl_bignum_ffdhe2048_q)", q = BN_dup(&ossl_bignum_ffdhe2048_q))
        || !test_ptr("../test/dhtest.c", 271, "g = BN_dup(&ossl_bignum_const_2)", g = BN_dup(&ossl_bignum_const_2))
        || !test_ptr("../test/dhtest.c", 272, "dh = DH_new()", dh = DH_new())
        || !test_true("../test/dhtest.c", 273, "DH_set0_pqg(dh, p, q, g)", (DH_set0_pqg(dh, p, q, g)) != 0))
        goto err;
    p = q = g = 
# 275 "../test/dhtest.c" 3 4
               ((void *)0)
# 275 "../test/dhtest.c"
                   ;

    if (!test_int_gt("../test/dhtest.c", 277, "sz = DH_size(dh)", "0", sz = DH_size(dh), 0)
        || !test_ptr("../test/dhtest.c", 278, "buf = OPENSSL_malloc(sz)", buf = CRYPTO_malloc(sz, "../test/dhtest.c", 278))
        || !test_ptr("../test/dhtest.c", 279, "pub = BN_new()", pub = BN_new())
        || !test_ptr("../test/dhtest.c", 280, "priv = BN_new()", priv = BN_new()))
        goto err;

    if (!test_true("../test/dhtest.c", 283, "BN_set_word(priv, 1)", (BN_set_word(priv, 1)) != 0)
        || !test_true("../test/dhtest.c", 284, "DH_set0_key(dh, NULL, priv)", (DH_set0_key(dh, 
# 284 "../test/dhtest.c" 3 4
           ((void *)0)
# 284 "../test/dhtest.c"
           , priv)) != 0))
        goto err;
    priv = 
# 286 "../test/dhtest.c" 3 4
          ((void *)0)
# 286 "../test/dhtest.c"
              ;
    if (!test_true("../test/dhtest.c", 287, "BN_set_word(pub, 1)", (BN_set_word(pub, 1)) != 0))
        goto err;




    if (!test_int_le("../test/dhtest.c", 293, "ossl_dh_compute_key(buf, pub, dh)", "0", ossl_dh_compute_key(buf, pub, dh), 0))
        goto err;

    if (!test_ptr("../test/dhtest.c", 296, "BN_copy(pub, DH_get0_p(dh))", BN_copy(pub, DH_get0_p(dh)))
        || !test_int_le("../test/dhtest.c", 297, "ossl_dh_compute_key(buf, pub, dh)", "0", ossl_dh_compute_key(buf, pub, dh), 0))
        goto err;

    if (!test_true("../test/dhtest.c", 300, "BN_sub_word(pub, 1)", (BN_sub_word(pub, 1)) != 0)
        || !test_int_le("../test/dhtest.c", 301, "ossl_dh_compute_key(buf, pub, dh)", "0", ossl_dh_compute_key(buf, pub, dh), 0))
        goto err;

    if (!test_true("../test/dhtest.c", 304, "BN_sub_word(pub, 1)", (BN_sub_word(pub, 1)) != 0)
        || !test_int_eq("../test/dhtest.c", 305, "ossl_dh_compute_key(buf, pub, dh)", "sz", ossl_dh_compute_key(buf, pub, dh), sz))
        goto err;

    ret = 1;
err:
    CRYPTO_free(buf, "../test/dhtest.c", 310);
    BN_free(priv);
    BN_free(pub);
    BN_free(g);
    BN_free(q);
...
static const rfc5114_td rfctd[] = {
        { DH_get_1024_160, dhtest_1024_160_xA, sizeof(dhtest_1024_160_xA), dhtest_1024_160_yA, sizeof(dhtest_1024_160_yA), dhtest_1024_160_xB, sizeof(dhtest_1024_160_xB), dhtest_1024_160_yB, sizeof(dhtest_1024_160_yB), dhtest_1024_160_Z, sizeof(dhtest_1024_160_Z) },
        { DH_get_2048_224, dhtest_2048_224_xA, sizeof(dhtest_2048_224_xA), dhtest_2048_224_yA, sizeof(dhtest_2048_224_yA), dhtest_2048_224_xB, sizeof(dhtest_2048_224_xB), dhtest_2048_224_yB, sizeof(dhtest_2048_224_yB), dhtest_2048_224_Z, sizeof(dhtest_2048_224_Z) },
        { DH_get_2048_256, dhtest_2048_256_xA, sizeof(dhtest_2048_256_xA), dhtest_2048_256_yA, sizeof(dhtest_2048_256_yA), dhtest_2048_256_xB, sizeof(dhtest_2048_256_xB), dhtest_2048_256_yB, sizeof(dhtest_2048_256_yB), dhtest_2048_256_Z, sizeof(dhtest_2048_256_Z) }
};
...
static int rfc5114_test(void)
{
    int i;
    DH *dhA = 
# 580 "../test/dhtest.c" 3 4
             ((void *)0)
# 580 "../test/dhtest.c"
                 ;
    DH *dhB = 
# 581 "../test/dhtest.c" 3 4
             ((void *)0)
# 581 "../test/dhtest.c"
                 ;
    unsigned char *Z1 = 
# 582 "../test/dhtest.c" 3 4
                       ((void *)0)
# 582 "../test/dhtest.c"
                           ;
    unsigned char *Z2 = 
# 583 "../test/dhtest.c" 3 4
                       ((void *)0)
# 583 "../test/dhtest.c"
                           ;
    int szA, szB;
    const rfc5114_td *td = 
# 585 "../test/dhtest.c" 3 4
                          ((void *)0)
# 585 "../test/dhtest.c"
                              ;
    BIGNUM *priv_key = 
# 586 "../test/dhtest.c" 3 4
                      ((void *)0)
# 586 "../test/dhtest.c"
                          , *pub_key = 
# 586 "../test/dhtest.c" 3 4
...
# 586 "../test/dhtest.c"
    ...
    for (i = 0; i < (int)(sizeof(rfctd)/sizeof((rfctd)[0])); i++) {
        td = rfctd + i;

        if (!test_ptr("../test/dhtest.c", 592, "dhA = td->get_param()", dhA = td->get_param())
                || !test_ptr("../test/dhtest.c", 593, "dhB = td->get_param()", dhB = td->get_param()))
            goto bad_err;

        if (!test_ptr("../test/dhtest.c", 596, "priv_key = BN_bin2bn(td->xA, td->xA_len, NULL)", priv_key = BN_bin2bn(td->xA, td->xA_len, 
# 596 "../test/dhtest.c" 3 4
            ((void *)0)
# 596 "../test/dhtest.c"
            ))
                || !test_ptr("../test/dhtest.c", 597, "pub_key = BN_bin2bn(td->yA, td->yA_len, NULL)", pub_key = BN_bin2bn(td->yA, td->yA_len, 
# 597 "../test/dhtest.c" 3 4
                   ((void *)0)
# 597 "../test/dhtest.c"
                   ))
                || !test_true("../test/dhtest.c", 598, "DH_set0_key(dhA, pub_key, priv_key)", (DH_set0_key(dhA, pub_key, priv_key)) != 0))
            goto bad_err;

        if (!test_ptr("../test/dhtest.c", 601, "priv_key = BN_bin2bn(td->xB, td->xB_len, NULL)", priv_key = BN_bin2bn(td->xB, td->xB_len, 
# 601 "../test/dhtest.c" 3 4
            ((void *)0)
# 601 "../test/dhtest.c"
            ))
                || !test_ptr("../test/dhtest.c", 602, "pub_key = BN_bin2bn(td->yB, td->yB_len, NULL)", pub_key = BN_bin2bn(td->yB, td->yB_len, 
# 602 "../test/dhtest.c" 3 4
                   ((void *)0)
# 602 "../test/dhtest.c"
                   ))
                || !test_true("../test/dhtest.c", 603, "DH_set0_key(dhB, pub_key, priv_key)", (DH_set0_key(dhB, pub_key, priv_key)) != 0))
            goto bad_err;
        priv_key = pub_key = 
# 605 "../test/dhtest.c" 3 4
                            ((void *)0)
# 605 "../test/dhtest.c"
                                ;

        if (!test_int_gt("../test/dhtest.c", 607, "szA = DH_size(dhA)", "0", szA = DH_size(dhA), 0)
                || !test_int_gt("../test/dhtest.c", 608, "szB = DH_size(dhB)", "0", szB = DH_size(dhB), 0)
                || !test_size_t_eq("../test/dhtest.c", 609, "td->Z_len", "(size_t)szA", td->Z_len, (size_t)szA)
                || !test_size_t_eq("../test/dhtest.c", 610, "td->Z_len", "(size_t)szB", td->Z_len, (size_t)szB))
            goto err;

        if (!test_ptr("../test/dhtest.c", 613, "Z1 = OPENSSL_malloc((size_t)szA)", Z1 = CRYPTO_malloc((size_t)szA, "../test/dhtest.c", 613))
                || !test_ptr("../test/dhtest.c", 614, "Z2 = OPENSSL_malloc((size_t)szB)", Z2 = CRYPTO_malloc((size_t)szB, "../test/dhtest.c", 614)))
            goto bad_err;
...
# 620 "../test/dhtest.c" 3 4
                                      ((void *)0)
# 620 "../test/dhtest.c"
                                          );
        if (!test_int_ne("../test/dhtest.c", 621, "DH_compute_key(Z1, pub_key_tmp, dhA)", "-1", DH_compute_key(Z1, pub_key_tmp, dhA), -1))
            goto bad_err;

        DH_get0_key(dhA, &pub_key_tmp, 
# 624 "../test/dhtest.c" 3 4
                                      ((void *)0)
# 624 "../test/dhtest.c"
                                          );
        if (!test_int_ne("../test/dhtest.c", 625, "DH_compute_key(Z2, pub_key_tmp, dhB)", "-1", DH_compute_key(Z2, pub_key_tmp, dhB), -1))
            goto bad_err;

        if (!test_mem_eq("../test/dhtest.c", 628, "Z1", "td->Z", Z1, td->Z_len, td->Z, td->Z_len)
                || !test_mem_eq("../test/dhtest.c", 629, "Z2", "td->Z", Z2, td->Z_len, td->Z, td->Z_len))
            goto err;

        DH_free(dhA);
        dhA = 
# 633 "../test/dhtest.c" 3 4
             ((void *)0)
# 633 "../test/dhtest.c"
                 ;
        DH_free(dhB);
        dhB = 
# 635 "../test/dhtest.c" 3 4
             ((void *)0)
# 635 "../test/dhtest.c"
                 ;
        CRYPTO_free(Z1, "../test/dhtest.c", 636);
        Z1 = 
# 637 "../test/dhtest.c" 3 4
            ((void *)0)
# 637 "../test/dhtest.c"
                ;
        CRYPTO_free(Z2, "../test/dhtest.c", 638);
        Z2 = 
# 639 "../test/dhtest.c" 3 4
            ((void *)0)
# 639 "../test/dhtest.c"
                ;
    }
 ...
 bad_err:
    ...
    BN_free(pub_key);
    BN_free(priv_key);
    CRYPTO_free(Z1, "../test/dhtest.c", 648);
    CRYPTO_free(Z2, "../test/dhtest.c", 649);
    test_error("../test/dhtest.c", 650, "Initialisation error RFC5114 set %d\n", i + 1);
    return 0;

 err:
    DH_free(dhA);
    DH_free(dhB);
    CRYPTO_free(Z1, "../test/dhtest.c", 656);
    CRYPTO_free(Z2, "../test/dhtest.c", 657);
    test_error("../test/dhtest.c", 658, "Test failed RFC5114 set %d\n", i + 1);
    return 0;
}
...
# 664 "../test/dhtest.c"
                          ;
    const BIGNUM *apub_key = 
# 665 "../test/dhtest.c" 3 4
                            ((void *)0)
# 665 "../test/dhtest.c"
                                , *bpub_key = 
# 665 "../test/dhtest.c" 3 4
...
# 665 "../test/dhtest.c"
                                                  ;
    unsigned char *abuf = 
# 666 "../test/dhtest.c" 3 4
                         ((void *)0)
# 666 "../test/dhtest.c"
                             ;
    unsigned char *bbuf = 
# 667 "../test/dhtest.c" 3 4
                         ((void *)0)
# 667 "../test/dhtest.c"
                             ;
    ...
    if (!test_ptr("../test/dhtest.c", 671, "a = DH_new_by_nid(NID_ffdhe2048)", a = DH_new_by_nid(1126)))
         goto err;

    if (!DH_check(a, &i))
        goto err;
    if (!test_false("../test/dhtest.c", 676, "i & DH_CHECK_P_NOT_PRIME", (i & 0x01) != 0)
            || !test_false("../test/dhtest.c", 677, "i & DH_CHECK_P_NOT_SAFE_PRIME", (i & 0x02) != 0)
            || !test_false("../test/dhtest.c", 678, "i & DH_UNABLE_TO_CHECK_GENERATOR", (i & 0x04) != 0)
            || !test_false("../test/dhtest.c", 679, "i & DH_NOT_SUITABLE_GENERATOR", (i & 0x08) != 0)
            || !test_false("../test/dhtest.c", 680, "i", (i) != 0))
        goto err;

    if (!DH_generate_key(a))
        goto err;
    DH_get0_key(a, &apub_key, 
# 685 "../test/dhtest.c" 3 4
                             ((void *)0)
# 685 "../test/dhtest.c"
                                 );


    if (!test_ptr("../test/dhtest.c", 688, "b = DH_new_by_nid(NID_ffdhe2048)", b = DH_new_by_nid(1126)))
        goto err;

    if (!DH_generate_key(b))
        goto err;
    DH_get0_key(b, &bpub_key, 
# 693 "../test/dhtest.c" 3 4
                             ((void *)0)
# 693 "../test/dhtest.c"
                                 );

    alen = DH_size(a);
    if (!test_int_gt("../test/dhtest.c", 696, "alen", "0", alen, 0) || !test_ptr("../test/dhtest.c", 696, "abuf = OPENSSL_malloc(alen)", abuf = CRYPTO_malloc(alen, "../test/dhtest.c", 696))
            || !test_int_gt("../test/dhtest.c", 697, "(aout = DH_compute_key(abuf, bpub_key, a))", "0", (aout = DH_compute_key(abuf, bpub_key, a)), 0))
        goto err;

    blen = DH_size(b);
    if (!test_int_gt("../test/dhtest.c", 701, "blen", "0", blen, 0) || !test_ptr("../test/dhtest.c", 701, "bbuf = OPENSSL_malloc(blen)", bbuf = CRYPTO_malloc(blen, "../test/dhtest.c", 701))
            || !test_int_gt("../test/dhtest.c", 702, "(bout = DH_compute_key(bbuf, apub_key, b))", "0", (bout = DH_compute_key(bbuf, apub_key, b)), 0))
        goto err;

    if (!test_true("../test/dhtest.c", 705, "aout >= 20", (aout >= 20) != 0)
            || !test_mem_eq("../test/dhtest.c", 706, "abuf", "bbuf", abuf, aout, bbuf, bout))
        goto err;

    ret = 1;

 err:
    CRYPTO_free(abuf, "../test/dhtest.c", 712);
    CRYPTO_free(bbuf, "../test/dhtest.c", 713);
    DH_free(a);
    DH_free(b);
    return ret;
}
...
static int dh_test_prime_groups(int index)
{
    int ok = 0;
    DH *dh = 
# 734 "../test/dhtest.c" 3 4
            ((void *)0)
# 734 "../test/dhtest.c"
                ;
    const BIGNUM *p, *q, *g;

    if (!test_ptr("../test/dhtest.c", 737, "dh = DH_new_by_nid(prime_groups[index])", dh = DH_new_by_nid(prime_groups[index])))
        goto err;
    DH_get0_pqg(dh, &p, &q, &g);
    if (!test_ptr("../test/dhtest.c", 740, "p", p) || !test_ptr("../test/dhtest.c", 740, "q", q) || !test_ptr("../test/dhtest.c", 740, "g", g))
        goto err;

    if (!test_int_eq("../test/dhtest.c", 743, "DH_get_nid(dh)", "prime_groups[index]", DH_get_nid(dh), prime_groups[index]))
        goto err;


    if (!test_int_eq("../test/dhtest.c", 747, "(int)DH_get_length(dh)", "0", (int)DH_get_length(dh), 0))
        goto err;
...
static int dh_rfc5114_fix_nid_test(void)
{
    ...
    paramgen_ctx = EVP_PKEY_CTX_new_id(920, 0);
    if (!test_ptr("../test/dhtest.c", 763, "paramgen_ctx", paramgen_ctx))
        goto err;
    if (!test_int_eq("../test/dhtest.c", 765, "EVP_PKEY_paramgen_init(paramgen_ctx)", "1", EVP_PKEY_paramgen_init(paramgen_ctx), 1))
        goto err;

    if (!test_int_eq("../test/dhtest.c", 768, "EVP_PKEY_CTX_set_dhx_rfc5114(paramgen_ctx, 3)", "1", EVP_PKEY_CTX_set_dhx_rfc5114(paramgen_ctx, 3), 1))
        goto err;

    if (!test_int_eq("../test/dhtest.c", 771, "EVP_PKEY_CTX_set_dhx_rfc5114(paramgen_ctx, 99)", "0", EVP_PKEY_CTX_set_dhx_rfc5114(paramgen_ctx, 99), 0))
        goto err;
...
static int dh_set_dh_nid_test(void)
{
    ...
    paramgen_ctx = EVP_PKEY_CTX_new_id(28, 0);
    if (!test_ptr("../test/dhtest.c", 787, "paramgen_ctx", paramgen_ctx))
        goto err;
    if (!test_int_eq("../test/dhtest.c", 789, "EVP_PKEY_paramgen_init(paramgen_ctx)", "1", EVP_PKEY_paramgen_init(paramgen_ctx), 1))
        goto err;

    if (!test_int_eq("../test/dhtest.c", 792, "EVP_PKEY_CTX_set_dh_nid(paramgen_ctx, NID_ffdhe2048)", "1", EVP_PKEY_CTX_set_dh_nid(paramgen_ctx, 1126), 1))
        goto err;

    if (!test_int_eq("../test/dhtest.c", 795, "EVP_PKEY_CTX_set_dh_nid(paramgen_ctx, NID_secp521r1)", "0", EVP_PKEY_CTX_set_dh_nid(paramgen_ctx, 716), 0))
        goto err;
...
# 808 "../test/dhtest.c"
                                                  ;
    DH *dh1 = DH_new_by_nid(1126);
    DH *dh2 = DH_new();

    if (!test_ptr("../test/dhtest.c", 812, "dh1", dh1)
        || !test_ptr("../test/dhtest.c", 813, "dh2", dh2))
        goto err;


    DH_get0_pqg(dh1, &p, &q, &g);
    if (!test_ptr("../test/dhtest.c", 818, "p", p)
        || !test_ptr("../test/dhtest.c", 819, "q", q)
        || !test_ptr("../test/dhtest.c", 820, "g", g)
        || !test_ptr("../test/dhtest.c", 821, "pcpy = BN_dup(p)", pcpy = BN_dup(p))
        || !test_ptr("../test/dhtest.c", 822, "gcpy = BN_dup(g)", gcpy = BN_dup(g)))
        goto err;

    if (!test_true("../test/dhtest.c", 825, "DH_set0_pqg(dh2, pcpy, NULL, gcpy)", (DH_set0_pqg(dh2, pcpy, 
# 825 "../test/dhtest.c" 3 4
        ((void *)0)
# 825 "../test/dhtest.c"
        , gcpy)) != 0))
        goto err;
    pcpy = gcpy = 
# 827 "../test/dhtest.c" 3 4
                 ((void *)0)
# 827 "../test/dhtest.c"
                     ;

    if (!test_ptr("../test/dhtest.c", 829, "DH_get0_q(dh2)", DH_get0_q(dh2)))
        goto err;


    if (!test_int_eq("../test/dhtest.c", 833, "DH_get_nid(dh2)", "NID_ffdhe2048", DH_get_nid(dh2), 1126))
        goto err;


    if (!test_ptr("../test/dhtest.c", 837, "gcpy = BN_dup(BN_value_one())", gcpy = BN_dup(BN_value_one())))
       goto err;
    if (!test_true("../test/dhtest.c", 839, "DH_set0_pqg(dh2, NULL, NULL, gcpy)", (DH_set0_pqg(dh2, 
# 839 "../test/dhtest.c" 3 4
        ((void *)0)
# 839 "../test/dhtest.c"
        , 
# 839 "../test/dhtest.c" 3 4
...
# 839 "../test/dhtest.c"
       ...
       goto err;
    gcpy = 
# 841 "../test/dhtest.c" 3 4
          ((void *)0)
# 841 "../test/dhtest.c"
              ;
    if (!test_int_eq("../test/dhtest.c", 842, "DH_get_nid(dh2)", "NID_undef", DH_get_nid(dh2), 0))
        goto err;


    if (!test_ptr("../test/dhtest.c", 846, "pcpy = BN_dup(p)", pcpy = BN_dup(p))
        || !test_ptr("../test/dhtest.c", 847, "qcpy = BN_dup(q)", qcpy = BN_dup(q))
        || !test_ptr("../test/dhtest.c", 848, "gcpy = BN_dup(g)", gcpy = BN_dup(g))
        || !test_int_eq("../test/dhtest.c", 849, "BN_add_word(qcpy, 2)", "1", BN_add_word(qcpy, 2), 1)
        || !test_true("../test/dhtest.c", 850, "DH_set0_pqg(dh2, pcpy, qcpy, gcpy)", (DH_set0_pqg(dh2, pcpy, qcpy, gcpy)) != 0))
        goto err;
    pcpy = qcpy = gcpy = 
# 852 "../test/dhtest.c" 3 4
                        ((void *)0)
# 852 "../test/dhtest.c"
                            ;
    if (!test_int_eq("../test/dhtest.c", 853, "DH_get_nid(dh2)", "NID_undef", DH_get_nid(dh2), 0))
        goto err;
...
static int dh_load_pkcs3_namedgroup_privlen_test(void)
{
    int ret, privlen = 0;
    EVP_PKEY *pkey = 
# 923 "../test/dhtest.c" 3 4
                    ((void *)0)
# 923 "../test/dhtest.c"
                        ;
    const unsigned char *p = dh_pub_der;

    ret = test_ptr("../test/dhtest.c", 926, "pkey = d2i_PUBKEY_ex(NULL, &p, sizeof(dh_pub_der), NULL, NULL)", pkey = d2i_PUBKEY_ex(
# 926 "../test/dhtest.c" 3 4
         ((void *)0)
# 926 "../test/dhtest.c"
         , &p, sizeof(dh_pub_der), 
# 926 "../test/dhtest.c" 3 4
...
# 926 "../test/dhtest.c"
          ...
          && test_true("../test/dhtest.c", 928, "EVP_PKEY_get_int_param(pkey, OSSL_PKEY_PARAM_DH_PRIV_LEN, &privlen)", (EVP_PKEY_get_int_param(pkey, "priv_len", &privlen)) != 0)

          && test_int_eq("../test/dhtest.c", 930, "privlen", "1024", privlen, 1024);
...
int setup_tests(void)
{
    ...
    add_all_tests("dh_test_prime_groups", dh_test_prime_groups, (sizeof(prime_groups)/sizeof((prime_groups)[0])), 1);
