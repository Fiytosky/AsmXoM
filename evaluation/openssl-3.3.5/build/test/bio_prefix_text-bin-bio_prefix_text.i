# 0 "../test/bio_prefix_text.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/bio_prefix_text.c"
# 10 "../test/bio_prefix_text.c"
...
# 15 "../test/bio_prefix_text.c" 2

static BIO *bio_in = 
# 16 "../test/bio_prefix_text.c" 3 4
                    ((void *)0)
# 16 "../test/bio_prefix_text.c"
                        ;
static BIO *bio_out = 
# 17 "../test/bio_prefix_text.c" 3 4
                     ((void *)0)
# 17 "../test/bio_prefix_text.c"
                         ;
static BIO *bio_err = 
# 18 "../test/bio_prefix_text.c" 3 4
                     ((void *)0)
# 18 "../test/bio_prefix_text.c"
                         ;
# 39 "../test/bio_prefix_text.c"
static size_t amount = 0;
static BIO **chain = 
# 40 "../test/bio_prefix_text.c" 3 4
                    ((void *)0)
# 40 "../test/bio_prefix_text.c"
                        ;
...
static const OPTIONS options[] = {
    ...
    { 
# 58 "../test/bio_prefix_text.c" 3 4
     ((void *)0) 
# 58 "../test/bio_prefix_text.c"
          }
};
...
# 66 "../test/bio_prefix_text.c" 3 4
   __builtin_c23_va_start(
# 66 "../test/bio_prefix_text.c"
   ap, fmt
# 66 "../test/bio_prefix_text.c" 3 4
   )
# 66 "../test/bio_prefix_text.c"
...
# 68 "../test/bio_prefix_text.c" 3 4
   __builtin_va_end(
# 68 "../test/bio_prefix_text.c"
   ap
# 68 "../test/bio_prefix_text.c" 3 4
   )
# 68 "../test/bio_prefix_text.c"
...
static int run_pipe(void)
{
    ...
    while (!(int)BIO_ctrl(bio_in,2,0,
# 76 "../test/bio_prefix_text.c" 3 4
           ((void *)0)
# 76 "../test/bio_prefix_text.c"
           )) {
        size_t bytes_in;
        size_t bytes_out;
...
{
    BIO *next = 
# 96 "../test/bio_prefix_text.c" 3 4
               ((void *)0)
# 96 "../test/bio_prefix_text.c"
                   ;
    size_t n = amount;

    chain = CRYPTO_zalloc(sizeof(*chain) * n, "../test/bio_prefix_text.c", 99);

    if (chain != 
# 101 "../test/bio_prefix_text.c" 3 4
                ((void *)0)
# 101 "../test/bio_prefix_text.c"
                    ) {
        size_t i;
        ...
        for (i = 0; n > 0; i++, n--) {
            ...
            if (curr == 
# 110 "../test/bio_prefix_text.c" 3 4
                       ((void *)0)
# 110 "../test/bio_prefix_text.c"
                           )
                goto err;
            chain[i] = BIO_push(curr, next);
            if (chain[i] == 
# 113 "../test/bio_prefix_text.c" 3 4
                           ((void *)0)
# 113 "../test/bio_prefix_text.c"
                               )
                goto err;
            next = chain[i];
        }
    ...
    return chain != 
# 118 "../test/bio_prefix_text.c" 3 4
                   ((void *)0)
# 118 "../test/bio_prefix_text.c"
                       ;
 err:

    BIO_free_all(next);
    CRYPTO_free(chain, "../test/bio_prefix_text.c", 122);
    return 0;
}
...
{
    if (chain != 
# 128 "../test/bio_prefix_text.c" 3 4
                ((void *)0)
# 128 "../test/bio_prefix_text.c"
                    ) {
        BIO_free_all(chain[amount - 1]);
        CRYPTO_free(chain, "../test/bio_prefix_text.c", 130);
    }
...
static int setup(void)
{
    ...
    bio_in = BIO_new_fp(
# 147 "../test/bio_prefix_text.c" 3 4
                       stdin
# 147 "../test/bio_prefix_text.c"
                            , 0x00 | 0x10);
    bio_out = BIO_new_fp(
# 148 "../test/bio_prefix_text.c" 3 4
                        stdout
# 148 "../test/bio_prefix_text.c"
                              , 0x00 | 0x10);
    bio_err = BIO_new_fp(
# 149 "../test/bio_prefix_text.c" 3 4
                        stderr
# 149 "../test/bio_prefix_text.c"
                              , 0x00 | 0x10);
    ...
    (void)((bio_in != 
# 155 "../test/bio_prefix_text.c" 3 4
   ((void *)0)
# 155 "../test/bio_prefix_text.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "bio_in != NULL", "../test/bio_prefix_text.c", 155), 1));
    (void)((bio_out != 
# 156 "../test/bio_prefix_text.c" 3 4
   ((void *)0)
# 156 "../test/bio_prefix_text.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "bio_out != NULL", "../test/bio_prefix_text.c", 156), 1));
    (void)((bio_err != 
# 157 "../test/bio_prefix_text.c" 3 4
   ((void *)0)
# 157 "../test/bio_prefix_text.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "bio_err != NULL", "../test/bio_prefix_text.c", 157), 1));
    ...
    while ((o = opt_next()) != OPT_EOF) {
        ...
        case OPT_INDENT:
            if (chain == 
# 183 "../test/bio_prefix_text.c" 3 4
                        ((void *)0)
# 183 "../test/bio_prefix_text.c"
                            ) {
            ...
            idx = 0;
            if (colon != 
# 190 "../test/bio_prefix_text.c" 3 4
                        ((void *)0)
# 190 "../test/bio_prefix_text.c"
                            ) {
            ...
            if (BIO_ctrl((chain[idx]), 80, ((long)indent), 
# 214 "../test/bio_prefix_text.c" 3 4
               ((void *)0)
# 214 "../test/bio_prefix_text.c"
               ) <= 0) {
        ...
        case OPT_PREFIX:
            if (chain == 
# 221 "../test/bio_prefix_text.c" 3 4
                        ((void *)0)
# 221 "../test/bio_prefix_text.c"
                            ) {
            ...
            idx = 0;
            if (colon != 
# 228 "../test/bio_prefix_text.c" 3 4
                        ((void *)0)
# 228 "../test/bio_prefix_text.c"
                            ) {
                idx = strtoul(arg, &endptr, 10);
                if (endptr[0] != ':') {
                    BIO_printf(bio_err,
            ...
            if (BIO_ctrl((chain[idx]), 79, 0, (void *)(colon)) <= 0) {
...
{
    int rv = 
# 261 "../test/bio_prefix_text.c" 3 4
            0
# 261 "../test/bio_prefix_text.c"
                        ;

    opt_init(argc, argv, options);
    rv = (setup() && run_pipe()) ? 
# 264 "../test/bio_prefix_text.c" 3 4
                                  0 
# 264 "../test/bio_prefix_text.c"
                                               : 
# 264 "../test/bio_prefix_text.c" 3 4
                                                 1
# 264 "../test/bio_prefix_text.c"
