# 0 "../test/trace_api_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/trace_api_test.c"
# 10 "../test/trace_api_test.c"
...
# 13 "../test/trace_api_test.c" 2

static int test_trace_categories(void)
{
    int cat_num;

    for (cat_num = -1; cat_num <= 19 + 1; ++cat_num) {
        ...
        case 0: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 30, "cat_name", "\"ALL\"", cat_name, "ALL"); break;
        case 1: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 31, "cat_name", "\"TRACE\"", cat_name, "TRACE"); break;
        case 2: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 32, "cat_name", "\"INIT\"", cat_name, "INIT"); break;
        case 3: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 33, "cat_name", "\"TLS\"", cat_name, "TLS"); break;
        case 4: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 34, "cat_name", "\"TLS_CIPHER\"", cat_name, "TLS_CIPHER"); break;
        case 5: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 35, "cat_name", "\"CONF\"", cat_name, "CONF"); break;
        case 6: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 36, "cat_name", "\"ENGINE_TABLE\"", cat_name, "ENGINE_TABLE"); break;
        case 7: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 37, "cat_name", "\"ENGINE_REF_COUNT\"", cat_name, "ENGINE_REF_COUNT"); break;
        case 8: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 38, "cat_name", "\"PKCS5V2\"", cat_name, "PKCS5V2"); break;
        case 9: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 39, "cat_name", "\"PKCS12_KEYGEN\"", cat_name, "PKCS12_KEYGEN"); break;
        case 10: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 40, "cat_name", "\"PKCS12_DECRYPT\"", cat_name, "PKCS12_DECRYPT"); break;
        case 11: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 41, "cat_name", "\"X509V3_POLICY\"", cat_name, "X509V3_POLICY"); break;
        case 12: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 42, "cat_name", "\"BN_CTX\"", cat_name, "BN_CTX"); break;
        case 13: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 43, "cat_name", "\"CMP\"", cat_name, "CMP"); break;
        case 14: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 44, "cat_name", "\"STORE\"", cat_name, "STORE"); break;
        case 15: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 45, "cat_name", "\"DECODER\"", cat_name, "DECODER"); break;
        case 16: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 46, "cat_name", "\"ENCODER\"", cat_name, "ENCODER"); break;
        case 17: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 47, "cat_name", "\"REF_COUNT\"", cat_name, "REF_COUNT"); break;
        case 18: is_cat_name_eq = test_str_eq("../test/trace_api_test.c", 48, "cat_name", "\"HTTP\"", cat_name, "HTTP"); break;

        default:
            is_cat_name_eq = test_ptr_null("../test/trace_api_test.c", 51, "cat_name", cat_name);
            break;
        }

        if (!test_true("../test/trace_api_test.c", 55, "is_cat_name_eq", (is_cat_name_eq) != 0))
            return 0;
        ret_cat_num =
            OSSL_trace_get_category_num(cat_name);
        expected_ret = cat_name != 
# 59 "../test/trace_api_test.c" 3 4
                                  ((void *)0) 
# 59 "../test/trace_api_test.c"
                                       ? cat_num : -1;
        if (!test_int_eq("../test/trace_api_test.c", 60, "expected_ret", "ret_cat_num", expected_ret, ret_cat_num))
            return 0;
    }

    return 1;
}
# 173 "../test/trace_api_test.c"
const OPTIONS *test_get_options(void) { enum { OPT_TEST_HELP = 500, OPT_TEST_LIST, OPT_TEST_SINGLE, OPT_TEST_ITERATION, OPT_TEST_INDENT, OPT_TEST_SEED }; static const OPTIONS options[] = { { OPT_HELP_STR, 1, '-', "Usage: %s [options] " "\n" }, { OPT_HELP_STR, 1, '-', "Valid options are:\n" }, { "help", OPT_TEST_HELP, '-', "Display this summary" }, { "list", OPT_TEST_LIST, '-', "Display the list of tests available" }, { "test", OPT_TEST_SINGLE, 's', "Run a single test by id or name" }, { "iter", OPT_TEST_ITERATION, 'n', "Run a single iteration of a test" }, { "indent", OPT_TEST_INDENT,'p', "Number of tabs added to output" }, { "seed", OPT_TEST_SEED, 'n', "Seed value to randomize tests with" }, { 
# 173 "../test/trace_api_test.c" 3 4
((void *)0) 
# 173 "../test/trace_api_test.c"
} }; return options; }
...
int setup_tests(void)
{
    if (!test_skip_common_options()) {
        test_error("../test/trace_api_test.c", 178, "Error parsing test options\n");
        return 0;
    }

    add_test("test_trace_categories", test_trace_categories);
