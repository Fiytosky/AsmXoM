                      ...
                      unsigned char *tag, int *tag_len)
{
    int ret = 0;
    EVP_CIPHER_CTX *ctx = 
# 42 "../test/aesgcmtest.c" 3 4
                         ((void *)0)
# 42 "../test/aesgcmtest.c"
                             ;
    int outlen;
    unsigned char outbuf[64];

    *tag_len = 16;
    ret = test_ptr("../test/aesgcmtest.c", 47, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
          && test_true("../test/aesgcmtest.c", 48, "EVP_EncryptInit_ex(ctx, EVP_aes_256_gcm(), NULL, NULL, NULL) > 0", (EVP_EncryptInit_ex(ctx, EVP_aes_256_gcm(), 
# 48 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 48 "../test/aesgcmtest.c"
            , 
# 48 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 48 "../test/aesgcmtest.c"
...
# 48 "../test/aesgcmtest.c"
          ...
          && test_true("../test/aesgcmtest.c", 50, "EVP_EncryptInit_ex(ctx, NULL, NULL, gcm_key, iv_gen != NULL ? NULL : gcm_iv) > 0", (EVP_EncryptInit_ex(ctx, 
# 50 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 50 "../test/aesgcmtest.c"
            , 
# 50 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 50 "../test/aesgcmtest.c"
...
# 50 "../test/aesgcmtest.c"
          ...
          && test_true("../test/aesgcmtest.c", 52, "EVP_EncryptUpdate(ctx, NULL, &outlen, gcm_aad, sizeof(gcm_aad)) > 0", (EVP_EncryptUpdate(ctx, 
# 52 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 52 "../test/aesgcmtest.c"
            , &outlen, gcm_aad, sizeof(gcm_aad)) > 0) != 0)

          && test_true("../test/aesgcmtest.c", 54, "EVP_EncryptUpdate(ctx, ct, ct_len, gcm_pt, sizeof(gcm_pt)) > 0", (EVP_EncryptUpdate(ctx, ct, ct_len, gcm_pt, sizeof(gcm_pt)) > 0) != 0)

          && test_true("../test/aesgcmtest.c", 56, "EVP_EncryptFinal_ex(ctx, outbuf, &outlen) > 0", (EVP_EncryptFinal_ex(ctx, outbuf, &outlen) > 0) != 0)
          && test_int_eq("../test/aesgcmtest.c", 57, "EVP_CIPHER_CTX_get_tag_length(ctx)", "16", EVP_CIPHER_CTX_get_tag_length(ctx), 16)
          && test_true("../test/aesgcmtest.c", 58, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_GET_TAG, 16, tag) > 0", (EVP_CIPHER_CTX_ctrl(ctx, 0x10, 16, tag) > 0) != 0)

          && test_true("../test/aesgcmtest.c", 60, "iv_gen == NULL || EVP_CIPHER_CTX_get_original_iv(ctx, iv_gen, 12)", (iv_gen == 
# 60 "../test/aesgcmtest.c" 3 4
            ((void *)0) 
# 60 "../test/aesgcmtest.c"
                      ...
                      int ct_len, const unsigned char *tag, int tag_len)
{
    int ret = 0;
    EVP_CIPHER_CTX *ctx = 
# 70 "../test/aesgcmtest.c" 3 4
                         ((void *)0)
# 70 "../test/aesgcmtest.c"
                             ;
    int outlen, ptlen;
    unsigned char pt[32];
    unsigned char outbuf[32];

    ret = test_ptr("../test/aesgcmtest.c", 75, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
              && test_true("../test/aesgcmtest.c", 76, "EVP_DecryptInit_ex(ctx, EVP_aes_256_gcm(), NULL, NULL, NULL) > 0", (EVP_DecryptInit_ex(ctx, EVP_aes_256_gcm(), 
# 76 "../test/aesgcmtest.c" 3 4
                ((void *)0)
# 76 "../test/aesgcmtest.c"
                , 
# 76 "../test/aesgcmtest.c" 3 4
                ((void *)0)
# 76 "../test/aesgcmtest.c"
...
# 76 "../test/aesgcmtest.c"
              ...
              && test_true("../test/aesgcmtest.c", 78, "EVP_DecryptInit_ex(ctx, NULL, NULL, gcm_key, iv) > 0", (EVP_DecryptInit_ex(ctx, 
# 78 "../test/aesgcmtest.c" 3 4
                ((void *)0)
# 78 "../test/aesgcmtest.c"
                , 
# 78 "../test/aesgcmtest.c" 3 4
                ((void *)0)
# 78 "../test/aesgcmtest.c"
                , gcm_key, iv) > 0) != 0)
              && test_int_eq("../test/aesgcmtest.c", 79, "EVP_CIPHER_CTX_get_tag_length(ctx)", "16", EVP_CIPHER_CTX_get_tag_length(ctx), 16)
              && test_true("../test/aesgcmtest.c", 80, "EVP_DecryptUpdate(ctx, NULL, &outlen, gcm_aad, sizeof(gcm_aad)) > 0", (EVP_DecryptUpdate(ctx, 
# 80 "../test/aesgcmtest.c" 3 4
                ((void *)0)
# 80 "../test/aesgcmtest.c"
                , &outlen, gcm_aad, sizeof(gcm_aad)) > 0) != 0)

              && test_true("../test/aesgcmtest.c", 82, "EVP_DecryptUpdate(ctx, pt, &ptlen, ct, ct_len) > 0", (EVP_DecryptUpdate(ctx, pt, &ptlen, ct, ct_len) > 0) != 0)

              && test_true("../test/aesgcmtest.c", 84, "EVP_CIPHER_CTX_ctrl(ctx, EVP_CTRL_AEAD_SET_TAG, tag_len, (void *)tag) > 0", (EVP_CIPHER_CTX_ctrl(ctx, 0x11, tag_len, (void *)tag) > 0) != 0)

              && test_true("../test/aesgcmtest.c", 86, "EVP_DecryptFinal_ex(ctx, outbuf, &outlen) > 0", (EVP_DecryptFinal_ex(ctx, outbuf, &outlen) > 0) != 0)
              && test_mem_eq("../test/aesgcmtest.c", 87, "gcm_pt", "pt", gcm_pt, sizeof(gcm_pt), pt, ptlen);
...
static int kat_test(void)
{
    ...
    return do_encrypt(
# 99 "../test/aesgcmtest.c" 3 4
                     ((void *)0)
# 99 "../test/aesgcmtest.c"
                         , ct, &ctlen, tag, &taglen)
           && test_mem_eq("../test/aesgcmtest.c", 100, "gcm_ct", "ct", gcm_ct, sizeof(gcm_ct), ct, ctlen)
           && test_mem_eq("../test/aesgcmtest.c", 101, "gcm_tag", "tag", gcm_tag, sizeof(gcm_tag), tag, taglen)
...
static int badkeylen_test(void)
{
    int ret;
    EVP_CIPHER_CTX *ctx = 
# 108 "../test/aesgcmtest.c" 3 4
                         ((void *)0)
# 108 "../test/aesgcmtest.c"
                             ;
    const EVP_CIPHER *cipher;

    ret = test_ptr("../test/aesgcmtest.c", 111, "cipher = EVP_aes_192_gcm()", cipher = EVP_aes_192_gcm())
          && test_ptr("../test/aesgcmtest.c", 112, "ctx = EVP_CIPHER_CTX_new()", ctx = EVP_CIPHER_CTX_new())
          && test_true("../test/aesgcmtest.c", 113, "EVP_EncryptInit_ex(ctx, cipher, NULL, NULL, NULL)", (EVP_EncryptInit_ex(ctx, cipher, 
# 113 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 113 "../test/aesgcmtest.c"
            , 
# 113 "../test/aesgcmtest.c" 3 4
            ((void *)0)
# 113 "../test/aesgcmtest.c"
...
# 113 "../test/aesgcmtest.c"
          ...
          && test_int_le("../test/aesgcmtest.c", 114, "EVP_CIPHER_CTX_set_key_length(ctx, 2)", "0", EVP_CIPHER_CTX_set_key_length(ctx, 2), 0);
    EVP_CIPHER_CTX_free(ctx);
    return ret;
}
