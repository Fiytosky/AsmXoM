# 0 "test/buildtest_ripemd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "test/buildtest_ripemd.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int RIPEMD160_Init(RIPEMD160_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int RIPEMD160_Update(RIPEMD160_CTX *c, const void *data,
                                           size_t len);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int RIPEMD160_Final(unsigned char *md, RIPEMD160_CTX *c);
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned char *RIPEMD160(const unsigned char *d, size_t n,
                                               unsigned char *md);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void RIPEMD160_Transform(RIPEMD160_CTX *c,
                                               const unsigned char *b);
# 11 "test/buildtest_ripemd.c" 2
