# 0 "../test/cipherbytes_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/cipherbytes_test.c"
# 11 "../test/cipherbytes_test.c"
...
# 29 "../test/cipherbytes_test.c" 3 4
                              ((void *)0)
# 29 "../test/cipherbytes_test.c"
                                  , *scsv = 
# 29 "../test/cipherbytes_test.c" 3 4
                                            ((void *)0)
# 29 "../test/cipherbytes_test.c"
    ...
    if (!test_int_eq("../test/cipherbytes_test.c", 33, "SSL_bytes_to_cipher_list(s, bytes, 0, 0, &sk, &scsv)", "0", SSL_bytes_to_cipher_list(s, bytes, 0, 0, &sk, &scsv), 0)
            || !test_ptr_null("../test/cipherbytes_test.c", 34, "sk", sk)
            || !test_ptr_null("../test/cipherbytes_test.c", 35, "scsv", scsv))
        goto err;
    ret = 1;

err:
    OPENSSL_sk_free(ossl_check_SSL_CIPHER_sk_type(sk));
    OPENSSL_sk_free(ossl_check_SSL_CIPHER_sk_type(scsv));
    return ret;
}

static int test_unsupported(void)
{
    struct stack_st_SSL_CIPHER *sk, *scsv;

    const unsigned char bytes[] = {0xc0, 0x0f, 0x00, 0x2f, 0x01, 0x00};
    int ret = 0;

    if (!test_true("../test/cipherbytes_test.c", 52, "SSL_bytes_to_cipher_list(s, bytes, sizeof(bytes), 0, &sk, &scsv)", (SSL_bytes_to_cipher_list(s, bytes, sizeof(bytes), 0, &sk, &scsv)) != 0)

            || !test_ptr("../test/cipherbytes_test.c", 54, "sk", sk)
            || !test_int_eq("../test/cipherbytes_test.c", 55, "sk_SSL_CIPHER_num(sk)", "1", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)), 1)
            || !test_ptr("../test/cipherbytes_test.c", 56, "scsv", scsv)
            || !test_int_eq("../test/cipherbytes_test.c", 57, "sk_SSL_CIPHER_num(scsv)", "0", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(scsv)), 0)
            || !test_str_eq("../test/cipherbytes_test.c", 58, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(sk, 0))", "\"AES128-SHA\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (0)))), "AES128-SHA")
                                         )
        goto err;
...
static int test_v2(void)
{
    ...
    if (!test_true("../test/cipherbytes_test.c", 78, "SSL_bytes_to_cipher_list(s, bytes, sizeof(bytes), 1, &sk, &scsv)", (SSL_bytes_to_cipher_list(s, bytes, sizeof(bytes), 1, &sk, &scsv)) != 0)

            || !test_ptr("../test/cipherbytes_test.c", 80, "sk", sk)
            || !test_int_eq("../test/cipherbytes_test.c", 81, "sk_SSL_CIPHER_num(sk)", "2", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)), 2)
            || !test_ptr("../test/cipherbytes_test.c", 82, "scsv", scsv)
            || !test_int_eq("../test/cipherbytes_test.c", 83, "sk_SSL_CIPHER_num(scsv)", "0", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(scsv)), 0))
        goto err;
    if (strcmp(SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (0)))),
               "AES256-SHA") != 0 ||
        strcmp(SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (1)))),
...
{
    struct stack_st_SSL_CIPHER *sk = 
# 101 "../test/cipherbytes_test.c" 3 4
                              ((void *)0)
# 101 "../test/cipherbytes_test.c"
                                  , *scsv = 
# 101 "../test/cipherbytes_test.c" 3 4
                                            ((void *)0)
# 101 "../test/cipherbytes_test.c"
    ...
    if (!SSL_bytes_to_cipher_list(s, bytes, sizeof(bytes), 0, &sk, &scsv)
            || !test_ptr("../test/cipherbytes_test.c", 109, "sk", sk)
            || !test_int_eq("../test/cipherbytes_test.c", 110, "sk_SSL_CIPHER_num(sk)", "3", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(sk)), 3)
            || !test_ptr("../test/cipherbytes_test.c", 111, "scsv", scsv)
            || !test_int_eq("../test/cipherbytes_test.c", 112, "sk_SSL_CIPHER_num(scsv)", "2", OPENSSL_sk_num(ossl_check_const_SSL_CIPHER_sk_type(scsv)), 2)
            || !test_str_eq("../test/cipherbytes_test.c", 113, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(sk, 0))", "\"AES128-SHA\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (0)))), "AES128-SHA")

            || !test_str_eq("../test/cipherbytes_test.c", 115, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(sk, 1))", "\"DHE-RSA-AES128-SHA\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (1)))), "DHE-RSA-AES128-SHA")

            || !test_str_eq("../test/cipherbytes_test.c", 117, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(sk, 2))", "\"DHE-RSA-AES256-GCM-SHA384\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(sk), (2)))), "DHE-RSA-AES256-GCM-SHA384")

            || !test_str_eq("../test/cipherbytes_test.c", 119, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(scsv, 0))", "\"TLS_EMPTY_RENEGOTIATION_INFO_SCSV\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(scsv), (0)))), "TLS_EMPTY_RENEGOTIATION_INFO_SCSV")

            || !test_str_eq("../test/cipherbytes_test.c", 121, "SSL_CIPHER_get_name(sk_SSL_CIPHER_value(scsv, 1))", "\"TLS_FALLBACK_SCSV\"", SSL_CIPHER_get_name(((const SSL_CIPHER *)OPENSSL_sk_value(ossl_check_const_SSL_CIPHER_sk_type(scsv), (1)))), "TLS_FALLBACK_SCSV")
                                                )
        goto err;
...
int setup_tests(void)
{
    if (!test_ptr("../test/cipherbytes_test.c", 134, "ctx = SSL_CTX_new(TLS_server_method())", ctx = SSL_CTX_new(TLS_server_method()))
            || !test_ptr("../test/cipherbytes_test.c", 135, "s = SSL_new(ctx)", s = SSL_new(ctx)))
        return 0;

    add_test("test_empty", test_empty);
    add_test("test_unsupported", test_unsupported);
    add_test("test_v2", test_v2);
    add_test("test_v3", test_v3);
    return 1;
}
