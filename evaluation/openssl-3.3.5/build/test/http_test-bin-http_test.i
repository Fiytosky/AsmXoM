...
# 17 "../test/http_test.c" 2

static const ASN1_ITEM *x509_it = 
# 18 "../test/http_test.c" 3 4
                                 ((void *)0)
# 18 "../test/http_test.c"
                                     ;
static X509 *x509 = 
# 19 "../test/http_test.c" 3 4
                   ((void *)0)
# 19 "../test/http_test.c"
                       ;
...
{
    const char *req, *path;
    long count = BIO_ctrl(in,3,0,(char *)((unsigned char **)&req));
    const char *hdr = (char *)req;
    int len;
    int is_get = count >= 4 && ((strncmp(hdr, "GET " "", sizeof("GET ") - 1) == 0) ? ((hdr) += sizeof("GET ") - 1, 1) : 0);


    if (!is_get
            && !(test_true("../test/http_test.c", 49, "count >= 5 && CHECK_AND_SKIP_PREFIX(hdr, \"POST \")", (count >= 5 && ((strncmp(hdr, "POST " "", sizeof("POST ") - 1) == 0) ? ((hdr) += sizeof("POST ") - 1, 1) : 0)) != 0)))
        return 0;

    path = hdr;
    hdr = strchr(hdr, ' ');
    if (hdr == 
# 54 "../test/http_test.c" 3 4
              ((void *)0)
# 54 "../test/http_test.c"
                  )
        return 0;
    len = strlen("HTTP/1.");
    if (!test_strn_eq("../test/http_test.c", 57, "++hdr", "\"HTTP/1.\"", ++hdr, len, "HTTP/1.", len))
        return 0;
    hdr += len;

    if (!test_char_le("../test/http_test.c", 61, "'0'", "*hdr", '0', *hdr) || !test_char_le("../test/http_test.c", 61, "*hdr++", "'1'", *hdr++, '1'))
        return 0;
    if (!test_char_eq("../test/http_test.c", 63, "*hdr++", "'\\r'", *hdr++, '\r') || !test_char_eq("../test/http_test.c", 63, "*hdr++", "'\\n'", *hdr++, '\n'))
        return 0;
    count -= (hdr - req);
    if (count < 0 || out == 
# 66 "../test/http_test.c" 3 4
                           ((void *)0)
# 66 "../test/http_test.c"
                               )
        return 0;

    if (!(strncmp(path, "/path/result.crt" "", sizeof("/path/result.crt") - 1) == 0)) {
        if (!is_get)
            return 0;
        return BIO_printf(out, "HTTP/1.%c 301 Moved Permanently\r\n"
                          "Location: %s\r\n\r\n",
                          version, "/path/result.crt") > 0;
    }
    ...
    if (is_get) {
        if (txt != 
# 83 "../test/http_test.c" 3 4
                  ((void *)0)
# 83 "../test/http_test.c"
                      )
            len = strlen(txt);
        else if ((len = ASN1_item_i2d(rsp, 
# 85 "../test/http_test.c" 3 4
                                          ((void *)0)
# 85 "../test/http_test.c"
                                              , it)) <= 0)
            return 0;
...
# 90 "../test/http_test.c"
        ...
        if (((strncmp(hdr, "Connection: " "", sizeof("Connection: ") - 1) == 0) ? ((hdr) += sizeof("Connection: ") - 1, 1) : 0)) {

            hdr = strstr(hdr, "\r\n");
            if (hdr == 
# 97 "../test/http_test.c" 3 4
                      ((void *)0)
# 97 "../test/http_test.c"
                          )
                return 0;
...
static int test_http_method(int do_get, int do_txt)
{
    ...
    server_args mock_args = { 
# 127 "../test/http_test.c" 3 4
                             ((void *)0)
# 127 "../test/http_test.c"
                                 , 
# 127 "../test/http_test.c" 3 4
                                   ((void *)0)
# 127 "../test/http_test.c"
...
# 129 "../test/http_test.c" 3 4
                                   ((void *)0)
# 129 "../test/http_test.c"
                                       ;
    const char *content_type;
    int res = 0;
    ...
    if (do_txt) {
        ...
        if (req == 
# 137 "../test/http_test.c" 3 4
                  ((void *)0)
                
# 138 "../test/http_test.c"
               || BIO_puts(req, "test\n") != sizeof("test\n") - 1
                || BIO_puts(req, "more\n") != sizeof("more\n") - 1) {
            BIO_free(req);
            req = 
# 141 "../test/http_test.c" 3 4
                 ((void *)0)
# 141 "../test/http_test.c"
                     ;
        }
        mock_args.txt = "test\n";
    } else {
        ...
        mock_args.txt = 
# 147 "../test/http_test.c" 3 4
                       ((void *)0)
# 147 "../test/http_test.c"
                           ;
    }
    if (wbio == 
# 149 "../test/http_test.c" 3 4
               ((void *)0) 
# 149 "../test/http_test.c"
                    || rbio == 
# 149 "../test/http_test.c" 3 4
                               ((void *)0) 
# 149 "../test/http_test.c"
...
# 149 "../test/http_test.c"
    ...
    rsp = do_get ?
        OSSL_HTTP_get(real_server ? "http://httpbin.org/" :
                      do_txt ? "/path/result.crt" : "/will-be-redirected",
                      
# 160 "../test/http_test.c" 3 4
                     ((void *)0) 
# 160 "../test/http_test.c"
                                     , 
# 160 "../test/http_test.c" 3 4
                                       ((void *)0) 
# 160 "../test/http_test.c"
                                                          ,
                      real_server ? 
# 161 "../test/http_test.c" 3 4
                                   ((void *)0) 
# 161 "../test/http_test.c"
                                        : wbio,
                      real_server ? 
# 162 "../test/http_test.c" 3 4
                                   ((void *)0) 
# 162 "../test/http_test.c"
                                        : rbio,
                      
# 163 "../test/http_test.c" 3 4
                     ((void *)0) 
# 163 "../test/http_test.c"
                                             , 
# 163 "../test/http_test.c" 3 4
                                               ((void *)0) 
# 163 "../test/http_test.c"
                      ...
                      (100 * 1024), 0 )
        : OSSL_HTTP_transfer(
# 168 "../test/http_test.c" 3 4
                            ((void *)0)
# 168 "../test/http_test.c"
                                , 
# 168 "../test/http_test.c" 3 4
                                  ((void *)0) 
# 168 "../test/http_test.c"
...
# 168 "../test/http_test.c"
                                                                  , "/path/result.crt",
                             0 ,
# 169 "../test/http_test.c" 3 4
                                            ((void *)0) 
# 169 "../test/http_test.c"
                                                            , 
# 169 "../test/http_test.c" 3 4
                                                              ((void *)0) 
# 169 "../test/http_test.c"
                                                                              ,
                             wbio, rbio, 
# 170 "../test/http_test.c" 3 4
                                        ((void *)0) 
# 170 "../test/http_test.c"
                                                         , 
# 170 "../test/http_test.c" 3 4
                                                           ((void *)0) 
# 170 "../test/http_test.c"
                             ...
                             0 );
    if (rsp != 
# 175 "../test/http_test.c" 3 4
              ((void *)0)
# 175 "../test/http_test.c"
                  ) {
        if (do_get && real_server) {
            char rtext[sizeof("<!DOCTYPE html>\n")];

            res = test_int_eq("../test/http_test.c", 179, "BIO_gets(rsp, rtext, sizeof(rtext))", "sizeof(DOCTYPE_HTML) - 1", BIO_gets(rsp, rtext, sizeof(rtext)), sizeof("<!DOCTYPE html>\n") - 1)

                && test_str_eq("../test/http_test.c", 181, "rtext", "DOCTYPE_HTML", rtext, "<!DOCTYPE html>\n");
        } else if (do_txt) {
            char rtext[sizeof("test\n") + 1 ];

            res = test_int_eq("../test/http_test.c", 185, "BIO_gets(rsp, rtext, sizeof(rtext))", "sizeof(text1) - 1", BIO_gets(rsp, rtext, sizeof(rtext)), sizeof("test\n") - 1)

                && test_str_eq("../test/http_test.c", 187, "rtext", "text1", rtext, "test\n");
        } else {
            X509 *rcert = d2i_X509_bio(rsp, 
# 189 "../test/http_test.c" 3 4
                                           ((void *)0)
# 189 "../test/http_test.c"
                                               );

            res = test_ptr("../test/http_test.c", 191, "rcert", rcert) && test_int_eq("../test/http_test.c", 191, "X509_cmp(x509, rcert)", "0", X509_cmp(x509, rcert), 0);
            X509_free(rcert);
        }
        BIO_free(rsp);
    }
...
static int test_http_keep_alive(char version, int keep_alive, int kept_alive)
{
    ...
    server_args mock_args = { 
# 211 "../test/http_test.c" 3 4
                             ((void *)0)
# 211 "../test/http_test.c"
                                 , 
# 211 "../test/http_test.c" 3 4
                                   ((void *)0)
# 211 "../test/http_test.c"
...
# 212 "../test/http_test.c" 3 4
                             ((void *)0)
# 212 "../test/http_test.c"
                                 ;
    int i, res = 0;

    if (wbio == 
# 215 "../test/http_test.c" 3 4
               ((void *)0) 
# 215 "../test/http_test.c"
                    || rbio == 
# 215 "../test/http_test.c" 3 4
                               ((void *)0)
# 215 "../test/http_test.c"
    ...
    for (res = 1, i = 1; res && i <= 2; i++) {
        rsp = OSSL_HTTP_transfer(&rctx, 
# 225 "../test/http_test.c" 3 4
                                       ((void *)0) 
# 225 "../test/http_test.c"
                                                        , 
# 225 "../test/http_test.c" 3 4
                                                          ((void *)0) 
# 225 "../test/http_test.c"
...
# 227 "../test/http_test.c" 3 4
                                ((void *)0) 
# 227 "../test/http_test.c"
                                                , 
# 227 "../test/http_test.c" 3 4
                                                  ((void *)0) 
# 227 "../test/http_test.c"
                                                                     ,
                                 wbio, rbio, 
# 228 "../test/http_test.c" 3 4
                                            ((void *)0) 
# 228 "../test/http_test.c"
                                                                    , 
# 228 "../test/http_test.c" 3 4
                                                                      ((void *)0)
# 228 "../test/http_test.c"
                                                                          ,
                                 0 , 
# 229 "../test/http_test.c" 3 4
                                                  ((void *)0) 
# 229 "../test/http_test.c"
                                                                    ,
                                 
# 230 "../test/http_test.c" 3 4
                                ((void *)0) 
# 230 "../test/http_test.c"
                                                       , 
# 230 "../test/http_test.c" 3 4
                                                         ((void *)0) 
# 230 "../test/http_test.c"
        ...
        if (keep_alive == 2 && kept_alive == 0)
            res = res && test_ptr_null("../test/http_test.c", 235, "rsp", rsp)
                && test_int_eq("../test/http_test.c", 236, "OSSL_HTTP_is_alive(rctx)", "0", OSSL_HTTP_is_alive(rctx), 0);
        else
            res = res && test_ptr("../test/http_test.c", 238, "rsp", rsp)
                && test_int_eq("../test/http_test.c", 239, "OSSL_HTTP_is_alive(rctx)", "keep_alive > 0", OSSL_HTTP_is_alive(rctx), keep_alive > 0);
        BIO_free(rsp);
        (void)(int)BIO_ctrl(rbio,1,0,
# 241 "../test/http_test.c" 3 4
             ((void *)0)
# 241 "../test/http_test.c"
             );
        keep_alive = 0;
    }
                            ...
                            const char *exp_port, const char *exp_path)
{
    ...
    if (!test_int_eq("../test/http_test.c", 259, "sscanf(exp_port, \"%d\", &exp_num)", "1", sscanf(exp_port, "%d", &exp_num), 1))
        return 0;
    res = test_true("../test/http_test.c", 261, "OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)", (OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)) != 0)

        && test_str_eq("../test/http_test.c", 263, "host", "exp_host", host, exp_host)
        && test_str_eq("../test/http_test.c", 264, "port", "exp_port", port, exp_port)
        && test_int_eq("../test/http_test.c", 265, "num", "exp_num", num, exp_num)
        && test_str_eq("../test/http_test.c", 266, "path", "exp_path", path, exp_path)
        && test_int_eq("../test/http_test.c", 267, "ssl", "exp_ssl", ssl, exp_ssl);
    if (res && *user != '\0')
        res = test_str_eq("../test/http_test.c", 269, "user", "\"user:pass\"", user, "user:pass");
    if (res && *frag != '\0')
        res = test_str_eq("../test/http_test.c", 271, "frag", "\"fr\"", frag, "fr");
    if (res && *query != '\0')
        res = test_str_eq("../test/http_test.c", 273, "query", "\"q\"", query, "q");
    CRYPTO_free(user, "../test/http_test.c", 274);
    CRYPTO_free(host, "../test/http_test.c", 275);
    CRYPTO_free(port, "../test/http_test.c", 276);
    CRYPTO_free(path, "../test/http_test.c", 277);
    CRYPTO_free(query, "../test/http_test.c", 278);
    CRYPTO_free(frag, "../test/http_test.c", 279);
    return res;
}
...
static int test_http_url_path_query_ok(const char *url, const char *exp_path_qu)
{
    ...
    res = test_true("../test/http_test.c", 288, "OSSL_HTTP_parse_url(url, NULL, NULL, &host, NULL, NULL, &path, NULL, NULL)", (OSSL_HTTP_parse_url(url, 
# 288 "../test/http_test.c" 3 4
         ((void *)0)
# 288 "../test/http_test.c"
         , 
# 288 "../test/http_test.c" 3 4
         ((void *)0)
# 288 "../test/http_test.c"
...
# 288 "../test/http_test.c"
        ...
        && test_str_eq("../test/http_test.c", 290, "host", "\"host\"", host, "host")
        && test_str_eq("../test/http_test.c", 291, "path", "exp_path_qu", path, exp_path_qu);
    CRYPTO_free(host, "../test/http_test.c", 292);
    CRYPTO_free(path, "../test/http_test.c", 293);
    return res;
}
...
static int test_http_url_invalid(const char *url)
{
    ...
    res = test_false("../test/http_test.c", 340, "OSSL_HTTP_parse_url(url, &ssl, NULL, &host, &port, &num, &path, NULL, NULL)", (OSSL_HTTP_parse_url(url, &ssl, 
# 340 "../test/http_test.c" 3 4
         ((void *)0)
# 340 "../test/http_test.c"
         , &host, &port, &num, &path, 
# 340 "../test/http_test.c" 3 4
         ((void *)0)
# 340 "../test/http_test.c"
...
# 340 "../test/http_test.c"
        ...
        && test_ptr_null("../test/http_test.c", 342, "host", host)
        && test_ptr_null("../test/http_test.c", 343, "port", port)
        && test_ptr_null("../test/http_test.c", 344, "path", path);
    if (!res) {
        CRYPTO_free(host, "../test/http_test.c", 346);
        CRYPTO_free(port, "../test/http_test.c", 347);
        CRYPTO_free(path, "../test/http_test.c", 348);
    }
    return res;
}
...
static int test_http_resp_hdr_limit(size_t limit)
{
    ...
    BIO *rbio = BIO_new(BIO_s_mem());
    BIO *mem = 
# 433 "../test/http_test.c" 3 4
              ((void *)0)
# 433 "../test/http_test.c"
                  ;
    server_args mock_args = { 
# 434 "../test/http_test.c" 3 4
                             ((void *)0)
# 434 "../test/http_test.c"
                                 , 
# 434 "../test/http_test.c" 3 4
                                   ((void *)0)
# 434 "../test/http_test.c"
...
# 434 "../test/http_test.c"
    ...
    int res = 0;
    OSSL_HTTP_REQ_CTX *rctx = 
# 436 "../test/http_test.c" 3 4
                             ((void *)0)
# 436 "../test/http_test.c"
                                 ;

    if (test_ptr("../test/http_test.c", 438, "wbio", wbio) == 0 || test_ptr("../test/http_test.c", 438, "rbio", rbio) == 0)
        goto err;
    ...
    if (test_ptr("../test/http_test.c", 450, "rctx", rctx) == 0)
        goto err;

    if (!test_true("../test/http_test.c", 453, "OSSL_HTTP_REQ_CTX_set_request_line(rctx, 0 , NULL, NULL, RPATH)", (OSSL_HTTP_REQ_CTX_set_request_line(rctx, 0 , 
# 453 "../test/http_test.c" 3 4
        ((void *)0)
# 453 "../test/http_test.c"
        , 
# 453 "../test/http_test.c" 3 4
        ((void *)0)
# 453 "../test/http_test.c"
    ...
    if (limit == 1)
        res = test_ptr_null("../test/http_test.c", 465, "mem", mem);
    else
        res = test_ptr("../test/http_test.c", 467, "mem", mem);
...
# 497 "../test/http_test.c" 3 4
((void *)0) 
# 497 "../test/http_test.c"
} }; return options; }
...
int setup_tests(void)
{
    ...
    x509_it = (X509_it());
    if (!test_ptr("../test/http_test.c", 505, "(x509 = load_cert_pem(test_get_argument(0), NULL))", (x509 = load_cert_pem(test_get_argument(0), 
# 505 "../test/http_test.c" 3 4
        ((void *)0)
# 505 "../test/http_test.c"
        ))))
        return 0;

    add_test("test_http_url_dns", test_http_url_dns);
    add_test("test_http_url_timestamp", test_http_url_timestamp);
