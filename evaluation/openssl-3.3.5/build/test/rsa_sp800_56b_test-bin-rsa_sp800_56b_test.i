# 0 "../test/rsa_sp800_56b_test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../test/rsa_sp800_56b_test.c"
# 14 "../test/rsa_sp800_56b_test.c"
...
# 15 "../test/rsa_sp800_56b_test.c" 2
...
# 17 "../test/rsa_sp800_56b_test.c" 2
...
# 18 "../test/rsa_sp800_56b_test.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 20 "../test/rsa_sp800_56b_test.c" 2
...
# 22 "../test/rsa_sp800_56b_test.c" 2
...
# 23 "../test/rsa_sp800_56b_test.c" 2
...
int RAND_poll(void);
# 24 "../test/rsa_sp800_56b_test.c" 2
...
# 27 "../test/rsa_sp800_56b_test.c" 2

# 1 "../crypto/rsa/rsa_local.h" 1
# 13 "../crypto/rsa/rsa_local.h"
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 29 "../test/rsa_sp800_56b_test.c" 2
...
static BIGNUM *bn_load_new(const unsigned char *data, int sz)
{
    BIGNUM *ret = BN_new();
    if (ret != 
# 102 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 102 "../test/rsa_sp800_56b_test.c"
                  )
...
static int test_check_public_exponent(void)
{
    int ret = 0;
    BIGNUM *e = 
# 111 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 111 "../test/rsa_sp800_56b_test.c"
                   ;

    ret = test_ptr("../test/rsa_sp800_56b_test.c", 113, "e = BN_new()", e = BN_new())

          && test_true("../test/rsa_sp800_56b_test.c", 115, "BN_set_word(e, 1)", (BN_set_word(e, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 116, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 118, "BN_set_word(e, 65536)", (BN_set_word(e, 65536)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 119, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 121, "BN_set_word(e, 3)", (BN_set_word(e, 3)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 122, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 123, "BN_set_word(e, 17)", (BN_set_word(e, 17)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 124, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 125, "BN_set_word(e, 65537)", (BN_set_word(e, 65537)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 126, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 128, "BN_lshift(e, BN_value_one(), 256)", (BN_lshift(e, BN_value_one(), 256)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 129, "BN_add(e, e, BN_value_one())", (BN_add(e, e, BN_value_one())) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 130, "ossl_rsa_check_public_exponent(e)", (ossl_rsa_check_public_exponent(e)) != 0);
    BN_free(e);
    return ret;
}
...
static int test_check_prime_factor_range(void)
{
    int ret = 0;
    BN_CTX *ctx = 
# 138 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 138 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 139 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 139 "../test/rsa_sp800_56b_test.c"
                   ;
    BIGNUM *bn_p1 = 
# 140 "../test/rsa_sp800_56b_test.c" 3 4
                   ((void *)0)
# 140 "../test/rsa_sp800_56b_test.c"
                       , *bn_p2 = 
# 140 "../test/rsa_sp800_56b_test.c" 3 4
                                  ((void *)0)
# 140 "../test/rsa_sp800_56b_test.c"
...
# 140 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 151, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 152, "bn_p1 = bn_load_new(p1, sizeof(p1))", bn_p1 = bn_load_new(p1, sizeof(p1)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 153, "bn_p2 = bn_load_new(p2, sizeof(p2))", bn_p2 = bn_load_new(p2, sizeof(p2)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 154, "bn_p3 = bn_load_new(p3, sizeof(p3))", bn_p3 = bn_load_new(p3, sizeof(p3)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 155, "bn_p4 = bn_load_new(p4, sizeof(p4))", bn_p4 = bn_load_new(p4, sizeof(p4)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 156, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
          && test_true("../test/rsa_sp800_56b_test.c", 157, "BN_set_word(p, 0xA)", (BN_set_word(p, 0xA)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 158, "ossl_rsa_check_prime_factor_range(p, 8, ctx)", (ossl_rsa_check_prime_factor_range(p, 8, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 159, "BN_set_word(p, 0x10)", (BN_set_word(p, 0x10)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 160, "ossl_rsa_check_prime_factor_range(p, 8, ctx)", (ossl_rsa_check_prime_factor_range(p, 8, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 161, "BN_set_word(p, 0xB)", (BN_set_word(p, 0xB)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 162, "ossl_rsa_check_prime_factor_range(p, 8, ctx)", (ossl_rsa_check_prime_factor_range(p, 8, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 163, "BN_set_word(p, 0xC)", (BN_set_word(p, 0xC)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 164, "ossl_rsa_check_prime_factor_range(p, 8, ctx)", (ossl_rsa_check_prime_factor_range(p, 8, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 165, "BN_set_word(p, 0xF)", (BN_set_word(p, 0xF)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 166, "ossl_rsa_check_prime_factor_range(p, 8, ctx)", (ossl_rsa_check_prime_factor_range(p, 8, ctx)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 167, "ossl_rsa_check_prime_factor_range(bn_p1, 72, ctx)", (ossl_rsa_check_prime_factor_range(bn_p1, 72, ctx)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 168, "ossl_rsa_check_prime_factor_range(bn_p2, 72, ctx)", (ossl_rsa_check_prime_factor_range(bn_p2, 72, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 169, "ossl_rsa_check_prime_factor_range(bn_p3, 72, ctx)", (ossl_rsa_check_prime_factor_range(bn_p3, 72, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 170, "ossl_rsa_check_prime_factor_range(bn_p4, 72, ctx)", (ossl_rsa_check_prime_factor_range(bn_p4, 72, ctx)) != 0);
...
static int test_check_prime_factor(void)
{
    int ret = 0;
    BN_CTX *ctx = 
# 184 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 184 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 185 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 185 "../test/rsa_sp800_56b_test.c"
                   , *e = 
# 185 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 185 "../test/rsa_sp800_56b_test.c"
                              ;
    BIGNUM *bn_p1 = 
# 186 "../test/rsa_sp800_56b_test.c" 3 4
                   ((void *)0)
# 186 "../test/rsa_sp800_56b_test.c"
                       , *bn_p2 = 
# 186 "../test/rsa_sp800_56b_test.c" 3 4
                                  ((void *)0)
# 186 "../test/rsa_sp800_56b_test.c"
...
# 186 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 193, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 194, "bn_p1 = bn_load_new(p1, sizeof(p1))", bn_p1 = bn_load_new(p1, sizeof(p1)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 195, "bn_p2 = bn_load_new(p2, sizeof(p2))", bn_p2 = bn_load_new(p2, sizeof(p2)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 196, "bn_p3 = bn_load_new(p3, sizeof(p3))", bn_p3 = bn_load_new(p3, sizeof(p3)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 197, "e = BN_new()", e = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 198, "ctx = BN_CTX_new()", ctx = BN_CTX_new())

          && test_true("../test/rsa_sp800_56b_test.c", 200, "BN_set_word(e, 0x1)", (BN_set_word(e, 0x1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 201, "ossl_rsa_check_prime_factor(bn_p1, e, 72, ctx)", (ossl_rsa_check_prime_factor(bn_p1, e, 72, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 203, "ossl_rsa_check_prime_factor(bn_p2, e, 72, ctx)", (ossl_rsa_check_prime_factor(bn_p2, e, 72, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 205, "BN_set_word(e, 0x2)", (BN_set_word(e, 0x2)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 206, "ossl_rsa_check_prime_factor(p, e, 72, ctx)", (ossl_rsa_check_prime_factor(p, e, 72, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 208, "BN_set_word(e, 0x1)", (BN_set_word(e, 0x1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 209, "ossl_rsa_check_prime_factor(bn_p3, e, 72, ctx)", (ossl_rsa_check_prime_factor(bn_p3, e, 72, ctx)) != 0);
...
static int test_check_private_exponent(void)
{
    int ret = 0;
    RSA *key = 
# 224 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 224 "../test/rsa_sp800_56b_test.c"
                  ;
    BN_CTX *ctx = 
# 225 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 225 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 226 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 226 "../test/rsa_sp800_56b_test.c"
                   , *q = 
# 226 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 226 "../test/rsa_sp800_56b_test.c"
...
# 226 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 228, "key = RSA_new()", key = RSA_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 229, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 230, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 231, "q = BN_new()", q = BN_new())

          && test_true("../test/rsa_sp800_56b_test.c", 233, "BN_set_word(p, 15)", (BN_set_word(p, 15)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 234, "BN_set_word(q, 17)", (BN_set_word(q, 17)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 235, "RSA_set0_factors(key, p, q)", (RSA_set0_factors(key, p, q)) != 0);
    if (!ret) {
        BN_free(p);
        BN_free(q);
        goto end;
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 242, "e = BN_new()", e = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 243, "d = BN_new()", d = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 244, "n = BN_new()", n = BN_new())
          && test_true("../test/rsa_sp800_56b_test.c", 245, "BN_set_word(e, 5)", (BN_set_word(e, 5)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 246, "BN_set_word(d, 157)", (BN_set_word(d, 157)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 247, "BN_set_word(n, 15*17)", (BN_set_word(n, 15*17)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 248, "RSA_set0_key(key, n, e, d)", (RSA_set0_key(key, n, e, d)) != 0);
    if (!ret) {
        BN_free(e);
        BN_free(d);
        BN_free(n);
    ...
    ret = test_false("../test/rsa_sp800_56b_test.c", 256, "ossl_rsa_check_private_exponent(key, 8, ctx)", (ossl_rsa_check_private_exponent(key, 8, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 257, "BN_set_word(d, 45)", (BN_set_word(d, 45)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 259, "ossl_rsa_check_private_exponent(key, 8, ctx)", (ossl_rsa_check_private_exponent(key, 8, ctx)) != 0)

          && test_false("../test/rsa_sp800_56b_test.c", 261, "ossl_rsa_check_private_exponent(key, 16, ctx)", (ossl_rsa_check_private_exponent(key, 16, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 263, "BN_set_word(d, 16)", (BN_set_word(d, 16)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 264, "ossl_rsa_check_private_exponent(key, 8, ctx)", (ossl_rsa_check_private_exponent(key, 8, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 266, "BN_set_word(d, 46)", (BN_set_word(d, 46)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 267, "ossl_rsa_check_private_exponent(key, 8, ctx)", (ossl_rsa_check_private_exponent(key, 8, ctx)) != 0);
end:
    RSA_free(key);
    BN_CTX_free(ctx);
    return ret;
...
static int test_check_crt_components(void)
{
    ...
    int ret = 0;
    RSA *key = 
# 285 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 285 "../test/rsa_sp800_56b_test.c"
                  ;
    BN_CTX *ctx = 
# 286 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 286 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 287 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 287 "../test/rsa_sp800_56b_test.c"
                   , *q = 
# 287 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 287 "../test/rsa_sp800_56b_test.c"
...
# 287 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 289, "key = RSA_new()", key = RSA_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 290, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 291, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 292, "q = BN_new()", q = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 293, "e = BN_new()", e = BN_new())
          && test_true("../test/rsa_sp800_56b_test.c", 294, "BN_set_word(p, P)", (BN_set_word(p, P)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 295, "BN_set_word(q, Q)", (BN_set_word(q, Q)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 296, "BN_set_word(e, E)", (BN_set_word(e, E)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 297, "RSA_set0_factors(key, p, q)", (RSA_set0_factors(key, p, q)) != 0);
    if (!ret) {
        BN_free(p);
        BN_free(q);
        goto end;
    ...
    ret = test_int_eq("../test/rsa_sp800_56b_test.c", 304, "ossl_rsa_sp800_56b_derive_params_from_pq(key, 8, e, ctx)", "1", ossl_rsa_sp800_56b_derive_params_from_pq(key, 8, e, ctx), 1)
          && test_BN_eq_word("../test/rsa_sp800_56b_test.c", 305, "key->n", "N", key->n, N)
          && test_BN_eq_word("../test/rsa_sp800_56b_test.c", 306, "key->dmp1", "DP", key->dmp1, DP)
          && test_BN_eq_word("../test/rsa_sp800_56b_test.c", 307, "key->dmq1", "DQ", key->dmq1, DQ)
          && test_BN_eq_word("../test/rsa_sp800_56b_test.c", 308, "key->iqmp", "QINV", key->iqmp, QINV)
          && test_true("../test/rsa_sp800_56b_test.c", 309, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 311, "BN_set_word(key->dmp1, 1)", (BN_set_word(key->dmp1, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 312, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 313, "BN_set_word(key->dmp1, P-1)", (BN_set_word(key->dmp1, P-1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 314, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 315, "BN_set_word(key->dmp1, DP)", (BN_set_word(key->dmp1, DP)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 317, "BN_set_word(key->dmq1, 1)", (BN_set_word(key->dmq1, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 318, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 319, "BN_set_word(key->dmq1, Q-1)", (BN_set_word(key->dmq1, Q-1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 320, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 321, "BN_set_word(key->dmq1, DQ)", (BN_set_word(key->dmq1, DQ)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 323, "BN_set_word(key->iqmp, 1)", (BN_set_word(key->iqmp, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 324, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 325, "BN_set_word(key->iqmp, P)", (BN_set_word(key->iqmp, P)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 326, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 327, "BN_set_word(key->iqmp, QINV)", (BN_set_word(key->iqmp, QINV)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 329, "BN_set_word(key->dmp1, DP+1)", (BN_set_word(key->dmp1, DP+1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 330, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 331, "BN_set_word(key->dmp1, DP)", (BN_set_word(key->dmp1, DP)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 333, "BN_set_word(key->dmq1, DQ-1)", (BN_set_word(key->dmq1, DQ-1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 334, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 335, "BN_set_word(key->dmq1, DQ)", (BN_set_word(key->dmq1, DQ)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 337, "BN_set_word(key->iqmp, QINV+1)", (BN_set_word(key->iqmp, QINV+1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 338, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 339, "BN_set_word(key->iqmp, QINV)", (BN_set_word(key->iqmp, QINV)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 341, "ossl_rsa_check_crt_components(key, ctx)", (ossl_rsa_check_crt_components(key, ctx)) != 0);
end:
    BN_free(e);
    RSA_free(key);
    BN_CTX_free(ctx);
...
static int test_derive_params_from_pq_fail(int tst)
{
    int ret = 0;
    RSA *key = 
# 359 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 359 "../test/rsa_sp800_56b_test.c"
                  ;
    BN_CTX *ctx = 
# 360 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 360 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 361 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 361 "../test/rsa_sp800_56b_test.c"
                   , *q = 
# 361 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 361 "../test/rsa_sp800_56b_test.c"
...
# 361 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 363, "key = RSA_new()", key = RSA_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 364, "ctx = BN_CTX_new()", ctx = BN_CTX_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 365, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 366, "q = BN_new()", q = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 367, "e = BN_new()", e = BN_new())
          && test_true("../test/rsa_sp800_56b_test.c", 368, "BN_set_word(p, derive_from_pq_tests[tst].p)", (BN_set_word(p, derive_from_pq_tests[tst].p)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 369, "BN_set_word(q, derive_from_pq_tests[tst].q)", (BN_set_word(q, derive_from_pq_tests[tst].q)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 370, "BN_set_word(e, derive_from_pq_tests[tst].e)", (BN_set_word(e, derive_from_pq_tests[tst].e)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 371, "RSA_set0_factors(key, p, q)", (RSA_set0_factors(key, p, q)) != 0);
    if (!ret) {
        BN_free(p);
        BN_free(q);
        goto end;
    ...
    ret = test_int_le("../test/rsa_sp800_56b_test.c", 378, "ossl_rsa_sp800_56b_derive_params_from_pq(key, 8, e, ctx)", "0", ossl_rsa_sp800_56b_derive_params_from_pq(key, 8, e, ctx), 0);
end:
    BN_free(e);
    RSA_free(key);
    BN_CTX_free(ctx);
...
static int test_pq_diff(void)
{
    int ret = 0;
    BIGNUM *tmp = 
# 389 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 389 "../test/rsa_sp800_56b_test.c"
                     , *p = 
# 389 "../test/rsa_sp800_56b_test.c" 3 4
                            ((void *)0)
# 389 "../test/rsa_sp800_56b_test.c"
...
# 389 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 391, "tmp = BN_new()", tmp = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 392, "p = BN_new()", p = BN_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 393, "q = BN_new()", q = BN_new())

          && test_true("../test/rsa_sp800_56b_test.c", 395, "BN_set_word(p, 1)", (BN_set_word(p, 1)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 396, "BN_set_word(q, 1+2)", (BN_set_word(q, 1+2)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 397, "ossl_rsa_check_pminusq_diff(tmp, p, q, 202)", (ossl_rsa_check_pminusq_diff(tmp, p, q, 202)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 399, "BN_set_word(q, 1+3)", (BN_set_word(q, 1+3)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 400, "ossl_rsa_check_pminusq_diff(tmp, p, q, 202)", (ossl_rsa_check_pminusq_diff(tmp, p, q, 202)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 401, "BN_set_word(p, 1+3)", (BN_set_word(p, 1+3)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 402, "BN_set_word(q, 1)", (BN_set_word(q, 1)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 403, "ossl_rsa_check_pminusq_diff(tmp, p, q, 202)", (ossl_rsa_check_pminusq_diff(tmp, p, q, 202)) != 0);
    BN_free(p);
    BN_free(q);
    BN_free(tmp);
    return ret;
...
static int test_invalid_keypair(void)
{
    int ret = 0;
    RSA *key = 
# 413 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 413 "../test/rsa_sp800_56b_test.c"
                  ;
    BN_CTX *ctx = 
# 414 "../test/rsa_sp800_56b_test.c" 3 4
                 ((void *)0)
# 414 "../test/rsa_sp800_56b_test.c"
                     ;
    BIGNUM *p = 
# 415 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 415 "../test/rsa_sp800_56b_test.c"
                   , *q = 
# 415 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 415 "../test/rsa_sp800_56b_test.c"
...
# 415 "../test/rsa_sp800_56b_test.c"
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 417, "key = RSA_new()", key = RSA_new())
          && test_ptr("../test/rsa_sp800_56b_test.c", 418, "ctx = BN_CTX_new()", ctx = BN_CTX_new())

          && test_false("../test/rsa_sp800_56b_test.c", 420, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 420 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 420 "../test/rsa_sp800_56b_test.c"
            , -1, 2048)) != 0)

          && test_ptr("../test/rsa_sp800_56b_test.c", 422, "p = bn_load_new(cav_p, sizeof(cav_p))", p = bn_load_new(cav_p, sizeof(cav_p)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 423, "q = bn_load_new(cav_q, sizeof(cav_q))", q = bn_load_new(cav_q, sizeof(cav_q)))
          && test_true("../test/rsa_sp800_56b_test.c", 424, "RSA_set0_factors(key, p, q)", (RSA_set0_factors(key, p, q)) != 0);
    if (!ret) {
        BN_free(p);
        BN_free(q);
        goto end;
    ...
    ret = test_ptr("../test/rsa_sp800_56b_test.c", 431, "e = bn_load_new(cav_e, sizeof(cav_e))", e = bn_load_new(cav_e, sizeof(cav_e)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 432, "n = bn_load_new(cav_n, sizeof(cav_n))", n = bn_load_new(cav_n, sizeof(cav_n)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 433, "d = bn_load_new(cav_d, sizeof(cav_d))", d = bn_load_new(cav_d, sizeof(cav_d)))
          && test_true("../test/rsa_sp800_56b_test.c", 434, "RSA_set0_key(key, n, e, d)", (RSA_set0_key(key, n, e, d)) != 0);
    if (!ret) {
        BN_free(e);
        BN_free(n);
        BN_free(d);
    ...
    ret = test_false("../test/rsa_sp800_56b_test.c", 442, "ossl_rsa_sp800_56b_check_keypair(key, NULL, 100, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 442 "../test/rsa_sp800_56b_test.c" 3 4
         ((void *)0)
# 442 "../test/rsa_sp800_56b_test.c"
         , 100, 2048)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 443, "ossl_rsa_sp800_56b_check_keypair(key, NULL, 112, 1024)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 443 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 443 "../test/rsa_sp800_56b_test.c"
            , 112, 1024)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 444, "ossl_rsa_sp800_56b_check_keypair(key, NULL, 128, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 444 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 444 "../test/rsa_sp800_56b_test.c"
            , 128, 2048)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 445, "ossl_rsa_sp800_56b_check_keypair(key, NULL, 140, 3072)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 445 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 445 "../test/rsa_sp800_56b_test.c"
            , 140, 3072)) != 0)

          && test_false("../test/rsa_sp800_56b_test.c", 447, "ossl_rsa_sp800_56b_check_keypair(key, BN_value_one(), -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, BN_value_one(), -1, 2048)) != 0)


          && test_true("../test/rsa_sp800_56b_test.c", 450, "BN_add_word(e, 1)", (BN_add_word(e, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 451, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 451 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 451 "../test/rsa_sp800_56b_test.c"
            , -1, 2048)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 452, "BN_sub_word(e, 1)", (BN_sub_word(e, 1)) != 0)


          && test_false("../test/rsa_sp800_56b_test.c", 455, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 3072)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 455 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 455 "../test/rsa_sp800_56b_test.c"
            , -1, 3072)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 456, "ossl_rsa_sp800_56b_check_keypair(key, e, 112, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, e, 112, 2048)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 458, "BN_add_word(n, 1)", (BN_add_word(n, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 459, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 459 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 459 "../test/rsa_sp800_56b_test.c"
            , -1, 2048)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 460, "BN_sub_word(n, 1)", (BN_sub_word(n, 1)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 462, "BN_lshift1(n, n)", (BN_lshift1(n, n)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 463, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2049)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 463 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 463 "../test/rsa_sp800_56b_test.c"
            , -1, 2049)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 464, "BN_rshift1(n, n)", (BN_rshift1(n, n)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 466, "BN_sub_word(p, 2)", (BN_sub_word(p, 2)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 467, "BN_mul(n, p, q, ctx)", (BN_mul(n, p, q, ctx)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 468, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 468 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 468 "../test/rsa_sp800_56b_test.c"
            , -1, 2048)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 469, "BN_add_word(p, 2)", (BN_add_word(p, 2)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 470, "BN_mul(n, p, q, ctx)", (BN_mul(n, p, q, ctx)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 472, "BN_sub_word(q, 2)", (BN_sub_word(q, 2)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 473, "BN_mul(n, p, q, ctx)", (BN_mul(n, p, q, ctx)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 474, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, 2048)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 474 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 474 "../test/rsa_sp800_56b_test.c"
            , -1, 2048)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 475, "BN_add_word(q, 2)", (BN_add_word(q, 2)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 476, "BN_mul(n, p, q, ctx)", (BN_mul(n, p, q, ctx)) != 0);
end:
    RSA_free(key);
    BN_CTX_free(ctx);
    return ret;
...
{
    RSA *key = 
# 490 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 490 "../test/rsa_sp800_56b_test.c"
                  ;
    int ret;
    int sz = keygen_size[id];

    ret = test_ptr("../test/rsa_sp800_56b_test.c", 494, "key = RSA_new()", key = RSA_new())
          && test_true("../test/rsa_sp800_56b_test.c", 495, "ossl_rsa_sp800_56b_generate_key(key, sz, NULL, NULL)", (ossl_rsa_sp800_56b_generate_key(key, sz, 
# 495 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 495 "../test/rsa_sp800_56b_test.c"
            , 
# 495 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 495 "../test/rsa_sp800_56b_test.c"
            )) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 496, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 497, "ossl_rsa_sp800_56b_check_private(key)", (ossl_rsa_sp800_56b_check_private(key)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 498, "ossl_rsa_sp800_56b_check_keypair(key, NULL, -1, sz)", (ossl_rsa_sp800_56b_check_keypair(key, 
# 498 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 498 "../test/rsa_sp800_56b_test.c"
            , -1, sz)) != 0);
...
static int test_check_private_key(void)
{
    int ret = 0;
    BIGNUM *n = 
# 507 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 507 "../test/rsa_sp800_56b_test.c"
                   , *d = 
# 507 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 507 "../test/rsa_sp800_56b_test.c"
...
# 507 "../test/rsa_sp800_56b_test.c"
                                         ;
    RSA *key = 
# 508 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 508 "../test/rsa_sp800_56b_test.c"
                  ;

    ret = test_ptr("../test/rsa_sp800_56b_test.c", 510, "key = RSA_new()", key = RSA_new())

          && test_false("../test/rsa_sp800_56b_test.c", 512, "ossl_rsa_sp800_56b_check_private(key)", (ossl_rsa_sp800_56b_check_private(key)) != 0)

          && test_ptr("../test/rsa_sp800_56b_test.c", 514, "n = bn_load_new(cav_n, sizeof(cav_n))", n = bn_load_new(cav_n, sizeof(cav_n)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 515, "d = bn_load_new(cav_d, sizeof(cav_d))", d = bn_load_new(cav_d, sizeof(cav_d)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 516, "e = bn_load_new(cav_e, sizeof(cav_e))", e = bn_load_new(cav_e, sizeof(cav_e)))
          && test_true("../test/rsa_sp800_56b_test.c", 517, "RSA_set0_key(key, n, e, d)", (RSA_set0_key(key, n, e, d)) != 0);
    if (!ret) {
        BN_free(n);
        BN_free(e);
        BN_free(d);
    ...
    ret = test_true("../test/rsa_sp800_56b_test.c", 525, "ossl_rsa_sp800_56b_check_private(key)", (ossl_rsa_sp800_56b_check_private(key)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 527, "BN_set_word(d, 0)", (BN_set_word(d, 0)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 528, "ossl_rsa_sp800_56b_check_private(key)", (ossl_rsa_sp800_56b_check_private(key)) != 0)

          && test_ptr("../test/rsa_sp800_56b_test.c", 530, "BN_copy(d, n)", BN_copy(d, n))
          && test_false("../test/rsa_sp800_56b_test.c", 531, "ossl_rsa_sp800_56b_check_private(key)", (ossl_rsa_sp800_56b_check_private(key)) != 0);
end:
    RSA_free(key);
    return ret;
}
...
static int test_check_public_key(void)
{
    int ret = 0;
    BIGNUM *n = 
# 540 "../test/rsa_sp800_56b_test.c" 3 4
               ((void *)0)
# 540 "../test/rsa_sp800_56b_test.c"
                   , *e = 
# 540 "../test/rsa_sp800_56b_test.c" 3 4
                          ((void *)0)
# 540 "../test/rsa_sp800_56b_test.c"
                              ;
    RSA *key = 
# 541 "../test/rsa_sp800_56b_test.c" 3 4
              ((void *)0)
# 541 "../test/rsa_sp800_56b_test.c"
                  ;

    ret = test_ptr("../test/rsa_sp800_56b_test.c", 543, "key = RSA_new()", key = RSA_new())

          && test_false("../test/rsa_sp800_56b_test.c", 545, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)

          && test_ptr("../test/rsa_sp800_56b_test.c", 547, "e = bn_load_new(cav_e, sizeof(cav_e))", e = bn_load_new(cav_e, sizeof(cav_e)))
          && test_ptr("../test/rsa_sp800_56b_test.c", 548, "n = bn_load_new(cav_n, sizeof(cav_n))", n = bn_load_new(cav_n, sizeof(cav_n)))
          && test_true("../test/rsa_sp800_56b_test.c", 549, "RSA_set0_key(key, n, e, NULL)", (RSA_set0_key(key, n, e, 
# 549 "../test/rsa_sp800_56b_test.c" 3 4
            ((void *)0)
# 549 "../test/rsa_sp800_56b_test.c"
            )) != 0);
    if (!ret) {
        BN_free(e);
        BN_free(n);
    ...
    ret = test_true("../test/rsa_sp800_56b_test.c", 556, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 558, "BN_add_word(n, 1)", (BN_add_word(n, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 559, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 560, "BN_sub_word(n, 1)", (BN_sub_word(n, 1)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 562, "BN_lshift1(n, n)", (BN_lshift1(n, n)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 563, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 564, "BN_rshift1(n, n)", (BN_rshift1(n, n)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 566, "BN_add_word(e, 1)", (BN_add_word(e, 1)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 567, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0)
          && test_true("../test/rsa_sp800_56b_test.c", 568, "BN_sub_word(e, 1)", (BN_sub_word(e, 1)) != 0)

          && test_true("../test/rsa_sp800_56b_test.c", 570, "BN_add_word(n, 2)", (BN_add_word(n, 2)) != 0)
          && test_false("../test/rsa_sp800_56b_test.c", 571, "ossl_rsa_sp800_56b_check_public(key)", (ossl_rsa_sp800_56b_check_public(key)) != 0);
end:
    RSA_free(key);
    return ret;
}
...
int setup_tests(void)
{
    ...
    add_all_tests("test_derive_params_from_pq_fail", test_derive_params_from_pq_fail, (int)(sizeof(derive_from_pq_tests)/sizeof((derive_from_pq_tests)[0])), 1);
    ...
    add_all_tests("test_sp80056b_keygen", test_sp80056b_keygen, (int)(sizeof(keygen_size)/sizeof((keygen_size)[0])), 1);
    return 1;
}
