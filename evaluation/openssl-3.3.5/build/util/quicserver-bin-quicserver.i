...
# 23 "../util/quicserver.c" 2


static BIO *bio_err = 
# 25 "../util/quicserver.c" 3 4
                     ((void *)0)
# 25 "../util/quicserver.c"
                         ;
...
static void wait_for_activity(QUIC_TSERVER *qtserv)
{
    ...
    fd_set *readfdsp = 
# 30 "../util/quicserver.c" 3 4
                      ((void *)0)
# 30 "../util/quicserver.c"
                          , *writefdsp = 
# 30 "../util/quicserver.c" 3 4
                                         ((void *)0)
# 30 "../util/quicserver.c"
...
# 31 "../util/quicserver.c" 3 4
                                       ((void *)0)
# 31 "../util/quicserver.c"
                                           ;
    int width;
    int sock;
...
# 42 "../util/quicserver.c" 3 4
       ((void) (((
# 42 "../util/quicserver.c"
       readfdsp
# 42 "../util/quicserver.c" 3 4
       )->__fds_bits)[((
# 42 "../util/quicserver.c"
...
# 47 "../util/quicserver.c" 3 4
       do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 47 "../util/quicserver.c"
       writefdsp
# 47 "../util/quicserver.c" 3 4
       )->__fds_bits)[0]) : "memory"); } while (0)
# 47 "../util/quicserver.c"
...
# 48 "../util/quicserver.c" 3 4
       ((void) (((
# 48 "../util/quicserver.c"
       writefdsp
# 48 "../util/quicserver.c" 3 4
       )->__fds_bits)[((
# 48 "../util/quicserver.c"
...
# 48 "../util/quicserver.c"
    ...
    if (readfdsp == 
# 61 "../util/quicserver.c" 3 4
                   ((void *)0) 
# 61 "../util/quicserver.c"
                        && writefdsp == 
# 61 "../util/quicserver.c" 3 4
                                        ((void *)0) 
# 61 "../util/quicserver.c"
...
# 61 "../util/quicserver.c"
    ...
    select(width, readfdsp, writefdsp, 
# 64 "../util/quicserver.c" 3 4
                                      ((void *)0)
# 64 "../util/quicserver.c"
                                          , timeoutp);
}
...
# 72 "../util/quicserver.c" 3 4
                            ((void *)0)
# 72 "../util/quicserver.c"
                                ;
    BIO *bio;

    if (BIO_sock_init() != 1)
        return 
# 76 "../util/quicserver.c" 3 4
              ((void *)0)
# 76 "../util/quicserver.c"
                  ;




    if (!BIO_lookup_ex(hostname, port, BIO_LOOKUP_SERVER, family, 
# 81 "../util/quicserver.c" 3 4
                                                                 SOCK_DGRAM
# 81 "../util/quicserver.c"
                                                                           ,
                       0, &res))
        return 
# 83 "../util/quicserver.c" 3 4
              ((void *)0)
# 83 "../util/quicserver.c"
                  ;
    ...
    for (ai = res; ai != 
# 89 "../util/quicserver.c" 3 4
                        ((void *)0)
# 89 "../util/quicserver.c"
                            ; ai = BIO_ADDRINFO_next(ai)) {

        sock = BIO_socket(BIO_ADDRINFO_family(ai), 
# 91 "../util/quicserver.c" 3 4
                                                  SOCK_DGRAM
# 91 "../util/quicserver.c"
                                                            , 0, 0);
        if (sock == -1)
            continue;
    ...
    if (ai == 
# 114 "../util/quicserver.c" 3 4
             ((void *)0)
# 114 "../util/quicserver.c"
                 )
        return 
# 115 "../util/quicserver.c" 3 4
              ((void *)0)
# 115 "../util/quicserver.c"
                  ;


    bio = BIO_new(BIO_s_datagram());
    if (bio == 
# 119 "../util/quicserver.c" 3 4
              ((void *)0)
# 119 "../util/quicserver.c"
                  ) {
        BIO_closesocket(sock);
        return 
# 121 "../util/quicserver.c" 3 4
              ((void *)0)
# 121 "../util/quicserver.c"
                  ;
    }
# 131 "../util/quicserver.c"
    BIO_int_ctrl(bio,104,0x01,sock);
...
int main(int argc, char *argv[])
{
    ...
    QUIC_TSERVER *qtserv = 
# 144 "../util/quicserver.c" 3 4
                          ((void *)0)
# 144 "../util/quicserver.c"
                              ;
    int ipv6 = 0, trace = 0;
    int argnext = 1;
    BIO *bio = 
# 147 "../util/quicserver.c" 3 4
              ((void *)0)
# 147 "../util/quicserver.c"
                  ;
    char *hostname, *port, *certfile, *keyfile;
    int ret = 
# 149 "../util/quicserver.c" 3 4
             1
# 149 "../util/quicserver.c"
                         ;
    ...
    bio_err = BIO_new_fp(
# 166 "../util/quicserver.c" 3 4
                        stderr
# 166 "../util/quicserver.c"
                              , 0x00 | 0x10);
    if (argc == 0 || bio_err == 
# 167 "../util/quicserver.c" 3 4
                               ((void *)0)
# 167 "../util/quicserver.c"
                                   )
        goto end2;
    ...
    bio = create_dgram_bio(ipv6 ? 
# 194 "../util/quicserver.c" 3 4
                                 10 
# 194 "../util/quicserver.c"
                                          : 
# 194 "../util/quicserver.c" 3 4
                                            2
# 194 "../util/quicserver.c"
                                                   , hostname, port);
    if (bio == 
# 195 "../util/quicserver.c" 3 4
              ((void *)0) 
# 195 "../util/quicserver.c"
                   || !BIO_up_ref(bio)) {
    ...
    tserver_args.libctx = 
# 200 "../util/quicserver.c" 3 4
                         ((void *)0)
# 200 "../util/quicserver.c"
                             ;
    ...
    tserver_args.ctx = 
# 205 "../util/quicserver.c" 3 4
                      ((void *)0)
# 205 "../util/quicserver.c"
                          ;

    qtserv = ossl_quic_tserver_new(&tserver_args, certfile, keyfile);
    if (qtserv == 
# 208 "../util/quicserver.c" 3 4
                 ((void *)0)
# 208 "../util/quicserver.c"
                     ) {
    ...
    bio = 
# 220 "../util/quicserver.c" 3 4
         ((void *)0)
# 220 "../util/quicserver.c"
             ;
    ...
    while(!ossl_quic_tserver_is_handshake_confirmed(qtserv)) {
        ...
        if (ossl_quic_tserver_is_terminated(qtserv)) {
            ...
            ret = 
# 237 "../util/quicserver.c" 3 4
                 1
# 237 "../util/quicserver.c"
                             ;
            goto end;
        }
    }
    ...
    for (;; respnum++) {
        if (respnum >= (sizeof(response)/sizeof((response)[0])))
            goto end;

        do {
            streamid = ossl_quic_tserver_pop_incoming_stream(qtserv);
            if (streamid == 
# 248 "../util/quicserver.c" 3 4
                           (18446744073709551615UL)
# 248 "../util/quicserver.c"
                                     )
                wait_for_activity(qtserv);
            ossl_quic_tserver_tick(qtserv);
            if (ossl_quic_tserver_is_terminated(qtserv)) {
                ...
                ret = 
# 253 "../util/quicserver.c" 3 4
                     0
# 253 "../util/quicserver.c"
                                 ;
                goto end;
            }
        } while(streamid == 
# 256 "../util/quicserver.c" 3 4
                           (18446744073709551615UL)
# 256 "../util/quicserver.c"
                                     );
        ...
        do {
            ...
            if (ossl_quic_tserver_is_terminated(qtserv)) {
                ...
                ret = 
# 268 "../util/quicserver.c" 3 4
                     1
# 268 "../util/quicserver.c"
                                 ;
                goto end;
            }
            ...
            if (ossl_quic_tserver_read(qtserv, streamid, reqbuf + reqbytes,
                                    ...
                                    &numbytes)) {
                if (numbytes > 0)
                    fwrite(reqbuf + reqbytes, 1, numbytes, 
# 276 "../util/quicserver.c" 3 4
                                                          stdout
# 276 "../util/quicserver.c"
                                                                );
                reqbytes += numbytes;
            }
