...
int FuzzerInitialize(int *argc, char ***argv)
{
    ...
    if (bio_out == 
# 27 "../fuzz/asn1parse.c" 3 4
                  ((void *)0)
# 27 "../fuzz/asn1parse.c"
                      )
        return 0;
    OPENSSL_init_crypto(0x00000002L, 
# 29 "../fuzz/asn1parse.c" 3 4
                                                         ((void *)0)
# 29 "../fuzz/asn1parse.c"
                                                             );
    ERR_clear_error();
