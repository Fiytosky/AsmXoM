...
# 20 "../fuzz/dtlsclient.c" 2


static int idx;
# 36 "../fuzz/dtlsclient.c"
time_t time(time_t *t) { if (t != 
# 36 "../fuzz/dtlsclient.c" 3 4
                      ((void *)0)
# 36 "../fuzz/dtlsclient.c"
...
# 44 "../fuzz/dtlsclient.c" 3 4
                                                                              ((void *)0)
# 44 "../fuzz/dtlsclient.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 45 "../fuzz/dtlsclient.c" 3 4
                                                   ((void *)0)
# 45 "../fuzz/dtlsclient.c"
                                                       );
    ERR_clear_error();
    ...
    if (comp_methods != 
# 50 "../fuzz/dtlsclient.c" 3 4
                       ((void *)0)
# 50 "../fuzz/dtlsclient.c"
                           )
...
{
    SSL *client = 
# 58 "../fuzz/dtlsclient.c" 3 4
                 ((void *)0)
# 58 "../fuzz/dtlsclient.c"
                     ;
    BIO *in;
    BIO *out;
    SSL_CTX *ctx;
    ...
    if (ctx == 
# 68 "../fuzz/dtlsclient.c" 3 4
              ((void *)0)
# 68 "../fuzz/dtlsclient.c"
                  )
        goto end;

    client = SSL_new(ctx);
    if (client == 
# 72 "../fuzz/dtlsclient.c" 3 4
                 ((void *)0)
# 72 "../fuzz/dtlsclient.c"
                     )
        goto end;
    (void)((SSL_ctrl(client, 123, 0, 
# 74 "../fuzz/dtlsclient.c" 3 4
   ((void *)0)
# 74 "../fuzz/dtlsclient.c"
   ) == 1) ? 0 : (OPENSSL_die("assertion failed: " "SSL_set_min_proto_version(client, 0) == 1", "../fuzz/dtlsclient.c", 74), 1));
    (void)((SSL_set_cipher_list(client, "ALL:eNULL:@SECLEVEL=0") == 1) ? 0 : (OPENSSL_die("assertion failed: " "SSL_set_cipher_list(client, \"ALL:eNULL:@SECLEVEL=0\") == 1", "../fuzz/dtlsclient.c", 75), 1));
    SSL_ctrl(client,55,0, (void *)"localhost");
    in = BIO_new(BIO_s_mem());
    if (in == 
# 78 "../fuzz/dtlsclient.c" 3 4
             ((void *)0)
# 78 "../fuzz/dtlsclient.c"
                 )
        goto end;
    out = BIO_new(BIO_s_mem());
    if (out == 
# 81 "../fuzz/dtlsclient.c" 3 4
              ((void *)0)
# 81 "../fuzz/dtlsclient.c"
                  ) {
        BIO_free(in);
        goto end;
    }
    ...
    (void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "../fuzz/dtlsclient.c", 87), 1));
