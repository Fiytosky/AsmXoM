# 0 "../fuzz/quic-client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../fuzz/quic-client.c"
# 11 "../fuzz/quic-client.c"
...
int FuzzerInitialize(int *argc, char ***argv)
{
    ...
    FuzzerSetRand();
    OPENSSL_init_crypto(0x00000002L | 0x00000100L, 
# 34 "../fuzz/quic-client.c" 3 4
                                                                              ((void *)0)
# 34 "../fuzz/quic-client.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 35 "../fuzz/quic-client.c" 3 4
                                                   ((void *)0)
# 35 "../fuzz/quic-client.c"
                                                       );
    ERR_clear_error();
    ...
    if (comp_methods != 
# 40 "../fuzz/quic-client.c" 3 4
                       ((void *)0)
# 40 "../fuzz/quic-client.c"
                           )
        OPENSSL_sk_sort(ossl_check_SSL_COMP_sk_type(comp_methods));

    return 1;
}
# 53 "../fuzz/quic-client.c"
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    SSL *client = 
# 55 "../fuzz/quic-client.c" 3 4
                 ((void *)0)
# 55 "../fuzz/quic-client.c"
                     , *stream = 
# 55 "../fuzz/quic-client.c" 3 4
                                 ((void *)0)
# 55 "../fuzz/quic-client.c"
                                     ;
    SSL *allstreams[] = {
# 56 "../fuzz/quic-client.c" 3 4
                        ((void *)0)
# 56 "../fuzz/quic-client.c"
                            , 
# 56 "../fuzz/quic-client.c" 3 4
                              ((void *)0)
# 56 "../fuzz/quic-client.c"
...
# 56 "../fuzz/quic-client.c"
    ...
    SSL_CTX *ctx;
    BIO_ADDR *peer_addr = 
# 61 "../fuzz/quic-client.c" 3 4
                         ((void *)0)
# 61 "../fuzz/quic-client.c"
                             ;
    ...
    if (ctx == 
# 73 "../fuzz/quic-client.c" 3 4
              ((void *)0)
# 73 "../fuzz/quic-client.c"
                  )
        goto end;

    client = SSL_new(ctx);
    if (client == 
# 77 "../fuzz/quic-client.c" 3 4
                 ((void *)0)
# 77 "../fuzz/quic-client.c"
                     )
        goto end;

    fake_now = ossl_ticks2time((1) * (((uint64_t)1000000000) / 1000));
    if (!ossl_quic_conn_set_override_now_cb(client, fake_now_cb, 
# 81 "../fuzz/quic-client.c" 3 4
                                                                ((void *)0)
# 81 "../fuzz/quic-client.c"
                                                                    ))
        goto end;

    peer_addr = BIO_ADDR_new();
    if (peer_addr == 
# 85 "../fuzz/quic-client.c" 3 4
                    ((void *)0)
# 85 "../fuzz/quic-client.c"
                        )
        goto end;

    ina.s_addr = htonl(0x7f000001UL);

    if (!BIO_ADDR_rawmake(peer_addr, 
# 90 "../fuzz/quic-client.c" 3 4
                                    2
# 90 "../fuzz/quic-client.c"
                                           , &ina, sizeof(ina), htons(4433)))
       goto end;

    SSL_ctrl(client,55,0, (void *)"localhost");
    in = BIO_new(BIO_s_dgram_mem());
    if (in == 
# 95 "../fuzz/quic-client.c" 3 4
             ((void *)0)
# 95 "../fuzz/quic-client.c"
                 )
        goto end;
    out = BIO_new(BIO_s_dgram_mem());
    if (out == 
# 98 "../fuzz/quic-client.c" 3 4
              ((void *)0)
# 98 "../fuzz/quic-client.c"
                  ) {
        BIO_free(in);
        goto end;
    }
    if (!(int)BIO_ctrl((out), 87, (long)((1U << 1)), 
# 102 "../fuzz/quic-client.c" 3 4
        ((void *)0)
# 102 "../fuzz/quic-client.c"
        )) {
        BIO_free(in);
        BIO_free(out);
        goto end;
    ...
    for (;;) {
        ...
        if (len >= 2) {
            ...
            nxtpkt = ossl_time_add(fake_now, ossl_ticks2time((nxtpktms) * (((uint64_t)1000000000) / 1000)));
            len -= 2;
            buf += 2;
        }
...
# 167 "../fuzz/quic-client.c" 3 4
                   ((void) (0))
# 167 "../fuzz/quic-client.c"
                                                       ;
                }
                break;
            ...
            case 3:
                state = 1;
                ret = 1;
                if (numstreams == (sizeof(allstreams)/sizeof((allstreams)[0]))
                ...
                if (stream == 
# 186 "../fuzz/quic-client.c" 3 4
                             ((void *)0)
# 186 "../fuzz/quic-client.c"
                                 )
                    goto end;
                break;
            ...
            case 4:
                ...
                if (stream == 
# 196 "../fuzz/quic-client.c" 3 4
                             ((void *)0)
# 196 "../fuzz/quic-client.c"
                                 ) {
...
# 215 "../fuzz/quic-client.c" 3 4
           ((void) (0))
# 215 "../fuzz/quic-client.c"
                                 ;
            
# 216 "../fuzz/quic-client.c" 3 4
           ((void) (0))
# 216 "../fuzz/quic-client.c"
                                          ;
            if (ret <= 0) {
