...
{
    int *st = CRYPTO_malloc(sizeof(*st), "../fuzz/fuzz_rand.c", 28);

    if (st != 
# 30 "../fuzz/fuzz_rand.c" 3 4
             ((void *)0)
# 30 "../fuzz/fuzz_rand.c"
                 )
        *st = 0;
...
static void fuzz_rand_freectx(__attribute__((unused)) void *vrng)
{
    CRYPTO_free(vrng, "../fuzz/fuzz_rand.c", 37);
}

static int fuzz_rand_instantiate(__attribute__((unused)) void *vrng,
                                 __attribute__((unused)) unsigned int strength,
                                 __attribute__((unused)) int prediction_resistance,
                                 __attribute__((unused)) const unsigned char *pstr,
                                 __attribute__((unused)) size_t pstr_len,
...
static int fuzz_rand_uninstantiate(__attribute__((unused)) void *vrng)
{
    *(int *)vrng = 0;
    return 1;
}

static int fuzz_rand_generate(__attribute__((unused)) void *vdrbg,
                              unsigned char *out, size_t outlen,
                              __attribute__((unused)) unsigned int strength,
                              __attribute__((unused)) int prediction_resistance,
                              __attribute__((unused)) const unsigned char *adin,
                              __attribute__((unused)) size_t adinlen)
{
    unsigned char val = 1;
    size_t i;
...
static int fuzz_rand_enable_locking(__attribute__((unused)) void *vrng)
{
    return 1;
}
...
static int fuzz_rand_get_ctx_params(void *vrng, OSSL_PARAM params[])
{
    ...
    if (p != 
# 82 "../fuzz/fuzz_rand.c" 3 4
            ((void *)0) 
# 82 "../fuzz/fuzz_rand.c"
                 && !OSSL_PARAM_set_int(p, *(int *)vrng))
        return 0;

    p = OSSL_PARAM_locate(params, "strength");
    if (p != 
# 86 "../fuzz/fuzz_rand.c" 3 4
            ((void *)0) 
# 86 "../fuzz/fuzz_rand.c"
                 && !OSSL_PARAM_set_int(p, 500))
        return 0;

    p = OSSL_PARAM_locate(params, "max_request");
    if (p != 
# 90 "../fuzz/fuzz_rand.c" 3 4
            ((void *)0) 
# 90 "../fuzz/fuzz_rand.c"
...
static const OSSL_PARAM *fuzz_rand_gettable_ctx_params(__attribute__((unused)) void *vrng,
                                                       __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("state")), (1), ((
# 99 "../fuzz/fuzz_rand.c" 3 4
       ((void *)0)
# 99 "../fuzz/fuzz_rand.c"
       )), (sizeof(int)), ((size_t)-1) },
        { (("strength")), (2), ((
# 100 "../fuzz/fuzz_rand.c" 3 4
       ((void *)0)
# 100 "../fuzz/fuzz_rand.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("max_request")), (2), ((
# 101 "../fuzz/fuzz_rand.c" 3 4
       ((void *)0)
# 101 "../fuzz/fuzz_rand.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 102 "../fuzz/fuzz_rand.c" 3 4
       ((void *)0)
# 102 "../fuzz/fuzz_rand.c"
       , 0, 
# 102 "../fuzz/fuzz_rand.c" 3 4
       ((void *)0)
# 102 "../fuzz/fuzz_rand.c"
...
static const OSSL_DISPATCH fuzz_rand_functions[] = {
    { 1, (void (*)(void))fuzz_rand_newctx },
    { 2, (void (*)(void))fuzz_rand_freectx },
    { 3, (void (*)(void))fuzz_rand_instantiate },
    { 4, (void (*)(void))fuzz_rand_uninstantiate },
    { 5, (void (*)(void))fuzz_rand_generate },
    { 8, (void (*)(void))fuzz_rand_enable_locking },
    { 12,
      (void(*)(void))fuzz_rand_gettable_ctx_params },
    { 15, (void(*)(void))fuzz_rand_get_ctx_params },
    { 0, 
# 117 "../fuzz/fuzz_rand.c" 3 4
   ((void *)0) 
# 117 "../fuzz/fuzz_rand.c"
   }
};
...
static const OSSL_ALGORITHM fuzz_rand_rand[] = {
    ...
    { 
# 122 "../fuzz/fuzz_rand.c" 3 4
     ((void *)0)
# 122 "../fuzz/fuzz_rand.c"
         , 
# 122 "../fuzz/fuzz_rand.c" 3 4
           ((void *)0)
# 122 "../fuzz/fuzz_rand.c"
                                             ...
                                             int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 134 "../fuzz/fuzz_rand.c" 3 4
          ((void *)0)
# 134 "../fuzz/fuzz_rand.c"
              ;
}
...
static const OSSL_DISPATCH fuzz_rand_method[] = {
    ...
    { 1027, (void (*)(void))fuzz_rand_query },
    { 0, 
# 141 "../fuzz/fuzz_rand.c" 3 4
   ((void *)0) 
# 141 "../fuzz/fuzz_rand.c"
   }
};
                                   ...
                                   const OSSL_DISPATCH **out, void **provctx)
{
    *provctx = OSSL_LIB_CTX_new();
    if (*provctx == 
# 149 "../fuzz/fuzz_rand.c" 3 4
                   ((void *)0)
# 149 "../fuzz/fuzz_rand.c"
                       )
        return 0;
...
# 159 "../fuzz/fuzz_rand.c" 3 4
                                  ((void *)0)
# 159 "../fuzz/fuzz_rand.c"
                                      , "fuzz-rand", fuzz_rand_provider_init)
        || !RAND_set_DRBG_type(
# 160 "../fuzz/fuzz_rand.c" 3 4
                              ((void *)0)
# 160 "../fuzz/fuzz_rand.c"
                                  , "fuzz", 
# 160 "../fuzz/fuzz_rand.c" 3 4
                                            ((void *)0)
# 160 "../fuzz/fuzz_rand.c"
...
# 160 "../fuzz/fuzz_rand.c"
        ...
        || (r_prov = OSSL_PROVIDER_try_load(
# 161 "../fuzz/fuzz_rand.c" 3 4
                                           ((void *)0)
# 161 "../fuzz/fuzz_rand.c"
                                               , "fuzz-rand", 1)) == 
# 161 "../fuzz/fuzz_rand.c" 3 4
                                                                     ((void *)0)
# 161 "../fuzz/fuzz_rand.c"
