...
# 21 "../fuzz/quic-lcidm.c" 3 4
                                                                              ((void *)0)
# 21 "../fuzz/quic-lcidm.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 22 "../fuzz/quic-lcidm.c" 3 4
                                                   ((void *)0)
# 22 "../fuzz/quic-lcidm.c"
                                                       );
    ERR_clear_error();
    return 1;
}
# 41 "../fuzz/quic-lcidm.c"
enum {
    CMD_ENROL_ODCID,
    CMD_RETIRE_ODCID,
...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    int rc = 0;
    QUIC_LCIDM *lcidm = 
# 67 "../fuzz/quic-lcidm.c" 3 4
                       ((void *)0)
# 67 "../fuzz/quic-lcidm.c"
                           ;
    PACKET pkt;
    ...
    if ((lcidm = ossl_quic_lcidm_new(
# 85 "../fuzz/quic-lcidm.c" 3 4
                                    ((void *)0)
# 85 "../fuzz/quic-lcidm.c"
                                        , lcidl)) == 
# 85 "../fuzz/quic-lcidm.c" 3 4
                                                     ((void *)0)
# 85 "../fuzz/quic-lcidm.c"
...
# 144 "../fuzz/quic-lcidm.c" 3 4
                                  ((void *)0)
# 144 "../fuzz/quic-lcidm.c"
                                      , &cid_out,
