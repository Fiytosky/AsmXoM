...
# 21 "../fuzz/quic-rcidm.c" 3 4
                                                                              ((void *)0)
# 21 "../fuzz/quic-rcidm.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 22 "../fuzz/quic-rcidm.c" 3 4
                                                   ((void *)0)
# 22 "../fuzz/quic-rcidm.c"
                                                       );
    ERR_clear_error();
    return 1;
}
# 47 "../fuzz/quic-rcidm.c"
enum {
...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    int rc = 0;
    QUIC_RCIDM *rcidm = 
# 78 "../fuzz/quic-rcidm.c" 3 4
                       ((void *)0)
# 78 "../fuzz/quic-rcidm.c"
                           ;
    PACKET pkt;
    ...
    if ((rcidm = ossl_quic_rcidm_new(
# 88 "../fuzz/quic-rcidm.c" 3 4
                                    ((void *)0)
# 88 "../fuzz/quic-rcidm.c"
                                        )) == 
# 88 "../fuzz/quic-rcidm.c" 3 4
                                              ((void *)0)
# 88 "../fuzz/quic-rcidm.c"
    ...
    while (PACKET_remaining(&pkt) > 0) {
        ...
        case CMD_RESET_WITH_ODCID:
            ...
            if ((rcidm = ossl_quic_rcidm_new(&arg_cid)) == 
# 104 "../fuzz/quic-rcidm.c" 3 4
                                                          ((void *)0)
# 104 "../fuzz/quic-rcidm.c"
                                                              )
                goto err;
        ...
        case CMD_RESET_WITHOUT_ODCID:
            ...
            if ((rcidm = ossl_quic_rcidm_new(
# 112 "../fuzz/quic-rcidm.c" 3 4
                                            ((void *)0)
# 112 "../fuzz/quic-rcidm.c"
                                                )) == 
# 112 "../fuzz/quic-rcidm.c" 3 4
                                                      ((void *)0)
# 112 "../fuzz/quic-rcidm.c"
