...
# 44 "../fuzz/client.c" 3 4
                                                                              ((void *)0)
# 44 "../fuzz/client.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 45 "../fuzz/client.c" 3 4
                                                   ((void *)0)
# 45 "../fuzz/client.c"
                                                       );
    ERR_clear_error();
...
# 68 "../fuzz/client.c"
    ...
    client = SSL_new(ctx);
    if (client == 
# 72 "../fuzz/client.c" 3 4
                 ((void *)0)
# 72 "../fuzz/client.c"
                     )
        goto end;
    (void)((SSL_ctrl(client, 123, 0, 
# 74 "../fuzz/client.c" 3 4
   ((void *)0)
# 74 "../fuzz/client.c"
   ) == 1) ? 0 : (OPENSSL_die("assertion failed: " "SSL_set_min_proto_version(client, 0) == 1", "../fuzz/client.c", 74), 1));
    (void)((SSL_set_cipher_list(client, "ALL:eNULL:@SECLEVEL=0") == 1) ? 0 : (OPENSSL_die("assertion failed: " "SSL_set_cipher_list(client, \"ALL:eNULL:@SECLEVEL=0\") == 1", "../fuzz/client.c", 75), 1));
    SSL_ctrl(client,55,0, (void *)"localhost");
    in = BIO_new(BIO_s_mem());
    if (in == 
# 78 "../fuzz/client.c" 3 4
             ((void *)0)
# 78 "../fuzz/client.c"
                 )
        goto end;
...
# 81 "../fuzz/client.c"
    ...
    (void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "../fuzz/client.c", 87), 1));
