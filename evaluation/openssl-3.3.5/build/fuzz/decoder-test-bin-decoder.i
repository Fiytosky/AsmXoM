...
# 15 "../include/openssl/decoder.h" 2
...
# 24 "../include/openssl/decoder.h" 2
...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    EVP_PKEY *pkey = 
# 44 "../fuzz/decoder.c" 3 4
                    ((void *)0)
# 44 "../fuzz/decoder.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 45 "../fuzz/decoder.c" 3 4
                       ((void *)0)
# 45 "../fuzz/decoder.c"
                           ;
    BIO *bio;
...
# 50 "../fuzz/decoder.c" 3 4
                                               ((void *)0)
# 50 "../fuzz/decoder.c"
                                                   );
    if (dctx == 
# 51 "../fuzz/decoder.c" 3 4
               ((void *)0)
# 51 "../fuzz/decoder.c"
                   ) {
        return 0;
    ...
    if (OSSL_DECODER_from_data(dctx, &buf, &len)) {
        ...
        (void)((pkey2 != 
# 62 "../fuzz/decoder.c" 3 4
       ((void *)0)
# 62 "../fuzz/decoder.c"
       ) ? 0 : (OPENSSL_die("assertion failed: " "pkey2 != NULL", "../fuzz/decoder.c", 62), 1));
        EVP_PKEY_eq(pkey, pkey2);
        EVP_PKEY_free(pkey2);

        ctx = EVP_PKEY_CTX_new(pkey, 
# 66 "../fuzz/decoder.c" 3 4
                                    ((void *)0)
# 66 "../fuzz/decoder.c"
                                        );
        ...
        (void)((ctx != 
# 81 "../fuzz/decoder.c" 3 4
       ((void *)0)
# 81 "../fuzz/decoder.c"
       ) ? 0 : (OPENSSL_die("assertion failed: " "ctx != NULL", "../fuzz/decoder.c", 81), 1));
