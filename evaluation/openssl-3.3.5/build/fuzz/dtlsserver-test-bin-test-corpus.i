# 0 "../fuzz/test-corpus.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../fuzz/test-corpus.c"
# 17 "../fuzz/test-corpus.c"
...
# 24 "../fuzz/test-corpus.c" 2
# 37 "../fuzz/test-corpus.c"
...
# 44 "../fuzz/test-corpus.c" 3 4
                                   ((((
# 44 "../fuzz/test-corpus.c"
                                   st.st_mode
# 44 "../fuzz/test-corpus.c" 3 4
                                   )) & 0170000) == (0100000))
# 44 "../fuzz/test-corpus.c"
    ...
    printf("# %s\n", pathname);
    fflush(
# 47 "../fuzz/test-corpus.c" 3 4
          stdout
# 47 "../fuzz/test-corpus.c"
                );
    f = fopen(pathname, "rb");
    if (f == 
# 49 "../fuzz/test-corpus.c" 3 4
            ((void *)0)
# 49 "../fuzz/test-corpus.c"
                )
        return;
    buf = malloc(st.st_size);
    if (buf != 
# 52 "../fuzz/test-corpus.c" 3 4
              ((void *)0)
# 52 "../fuzz/test-corpus.c"
                  ) {
        s = fread(buf, 1, st.st_size, f);
        (void)((s == (size_t)st.st_size) ? 0 : (OPENSSL_die("assertion failed: " "s == (size_t)st.st_size", "../fuzz/test-corpus.c", 54), 1));
...
int main(int argc, char **argv) {
    ...
    for (n = 1; n < argc; ++n) {
        ...
        const char *filename = 
# 68 "../fuzz/test-corpus.c" 3 4
                              ((void *)0)
# 68 "../fuzz/test-corpus.c"
                                  ;
        char *pathname = 
# 69 "../fuzz/test-corpus.c" 3 4
                        ((void *)0)
# 69 "../fuzz/test-corpus.c"
                            ;
        OPENSSL_DIR_CTX *ctx = 
# 70 "../fuzz/test-corpus.c" 3 4
                              ((void *)0)
# 70 "../fuzz/test-corpus.c"
                                  ;
        int wasdir = 0;
        ...
        while ((filename = OPENSSL_DIR_read(&ctx, argv[n])) != 
# 76 "../fuzz/test-corpus.c" 3 4
                                                              ((void *)0)
# 76 "../fuzz/test-corpus.c"
                                                                  ) {
            wasdir = 1;
            if (pathname == 
# 78 "../fuzz/test-corpus.c" 3 4
                           ((void *)0)
# 78 "../fuzz/test-corpus.c"
                               ) {
                pathname = malloc(
# 79 "../fuzz/test-corpus.c" 3 4
                                 4096
# 79 "../fuzz/test-corpus.c"
                                         );
                if (pathname == 
# 80 "../fuzz/test-corpus.c" 3 4
                               ((void *)0)
# 80 "../fuzz/test-corpus.c"
                                   )
                    break;
