...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    (void)((BN_bin2bn(buf, l1, b1) == b1) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf, l1, b1) == b1", "../fuzz/bignum.c", 66), 1));
    BN_set_negative(b1, s1);
    (void)((BN_bin2bn(buf + l1, l2, b2) == b2) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf + l1, l2, b2) == b2", "../fuzz/bignum.c", 68), 1));
    (void)((BN_bin2bn(buf + l1 + l2, l3, b3) == b3) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf + l1 + l2, l3, b3) == b3", "../fuzz/bignum.c", 69), 1));
    ...
    (void)((BN_mod_exp(b4, b1, b2, b3, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_mod_exp(b4, b1, b2, b3, ctx)", "../fuzz/bignum.c", 78), 1));
    (void)((BN_mod_exp_simple(b5, b1, b2, b3, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_mod_exp_simple(b5, b1, b2, b3, ctx)", "../fuzz/bignum.c", 79), 1));

    success = BN_cmp(b4, b5) == 0;
    if (!success) {
        BN_print_fp(
# 83 "../fuzz/bignum.c" 3 4
                   stdout
# 83 "../fuzz/bignum.c"
                         , b1);
        putchar('\n');
        BN_print_fp(
# 85 "../fuzz/bignum.c" 3 4
                   stdout
# 85 "../fuzz/bignum.c"
                         , b2);
        putchar('\n');
        BN_print_fp(
# 87 "../fuzz/bignum.c" 3 4
                   stdout
# 87 "../fuzz/bignum.c"
                         , b3);
        putchar('\n');
        BN_print_fp(
# 89 "../fuzz/bignum.c" 3 4
                   stdout
# 89 "../fuzz/bignum.c"
                         , b4);
        putchar('\n');
        BN_print_fp(
# 91 "../fuzz/bignum.c" 3 4
                   stdout
# 91 "../fuzz/bignum.c"
                         , b5);
        putchar('\n');
    ...
    (void)((success) ? 0 : (OPENSSL_die("assertion failed: " "success", "../fuzz/bignum.c", 96), 1));
    BN_free(b1);
    BN_free(b2);
    BN_free(b3);
    BN_free(b4);
