...
# 497 "../fuzz/server.c" 3 4
                                                                              ((void *)0)
# 497 "../fuzz/server.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 498 "../fuzz/server.c" 3 4
                                                   ((void *)0)
# 498 "../fuzz/server.c"
                                                       );
    ERR_clear_error();
...
# 544 "../fuzz/server.c" 3 4
         ((void *)0)
# 544 "../fuzz/server.c"
         );
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 545), 1));
    ret = SSL_CTX_set_cipher_list(ctx, "ALL:eNULL:@SECLEVEL=0");
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 547), 1));



    bufp = kRSAPrivateKeyDER;
    privkey = d2i_RSAPrivateKey(
# 552 "../fuzz/server.c" 3 4
                               ((void *)0)
# 552 "../fuzz/server.c"
                                   , &bufp, sizeof(kRSAPrivateKeyDER));
    (void)((privkey != 
# 553 "../fuzz/server.c" 3 4
   ((void *)0)
# 553 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "privkey != NULL", "../fuzz/server.c", 553), 1));
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey),6, (privkey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 557), 1));
    EVP_PKEY_free(pkey);


    bufp = kCertificateDER;
    cert = d2i_X509(
# 562 "../fuzz/server.c" 3 4
                   ((void *)0)
# 562 "../fuzz/server.c"
                       , &bufp, sizeof(kCertificateDER));
    (void)((cert != 
# 563 "../fuzz/server.c" 3 4
   ((void *)0)
# 563 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/server.c", 563), 1));
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 565), 1));
    X509_free(cert);
    ...
    (void)(((size_t)BIO_write(bio_buf, ECDSAPrivateKeyPEM, sizeof(ECDSAPrivateKeyPEM)) == sizeof(ECDSAPrivateKeyPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, ECDSAPrivateKeyPEM, sizeof(ECDSAPrivateKeyPEM)) == sizeof(ECDSAPrivateKeyPEM)", "../fuzz/server.c", 572), 1));
    ecdsakey = PEM_read_bio_ECPrivateKey(bio_buf, 
# 573 "../fuzz/server.c" 3 4
                                                 ((void *)0)
# 573 "../fuzz/server.c"
                                                     , 
# 573 "../fuzz/server.c" 3 4
...
# 573 "../fuzz/server.c"
    ...
    ERR_print_errors_fp(
# 574 "../fuzz/server.c" 3 4
                       stderr
# 574 "../fuzz/server.c"
                             );
    (void)((ecdsakey != 
# 575 "../fuzz/server.c" 3 4
   ((void *)0)
# 575 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "ecdsakey != NULL", "../fuzz/server.c", 575), 1));
    BIO_free(bio_buf);
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey), 408, (ecdsakey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 580), 1));
    EVP_PKEY_free(pkey);

    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, ECDSACertPEM, sizeof(ECDSACertPEM)) == sizeof(ECDSACertPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, ECDSACertPEM, sizeof(ECDSACertPEM)) == sizeof(ECDSACertPEM)", "../fuzz/server.c", 584), 1));
    cert = PEM_read_bio_X509(bio_buf, 
# 585 "../fuzz/server.c" 3 4
                                     ((void *)0)
# 585 "../fuzz/server.c"
                                         , 
# 585 "../fuzz/server.c" 3 4
...
# 585 "../fuzz/server.c"
    ...
    (void)((cert != 
# 586 "../fuzz/server.c" 3 4
   ((void *)0)
# 586 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/server.c", 586), 1));
    BIO_free(bio_buf);
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 589), 1));
    X509_free(cert);
    ...
    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, DSAPrivateKeyPEM, sizeof(DSAPrivateKeyPEM)) == sizeof(DSAPrivateKeyPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, DSAPrivateKeyPEM, sizeof(DSAPrivateKeyPEM)) == sizeof(DSAPrivateKeyPEM)", "../fuzz/server.c", 596), 1));
    dsakey = PEM_read_bio_DSAPrivateKey(bio_buf, 
# 597 "../fuzz/server.c" 3 4
                                                ((void *)0)
# 597 "../fuzz/server.c"
                                                    , 
# 597 "../fuzz/server.c" 3 4
...
# 597 "../fuzz/server.c"
    ...
    ERR_print_errors_fp(
# 598 "../fuzz/server.c" 3 4
                       stderr
# 598 "../fuzz/server.c"
                             );
    (void)((dsakey != 
# 599 "../fuzz/server.c" 3 4
   ((void *)0)
# 599 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "dsakey != NULL", "../fuzz/server.c", 599), 1));
    BIO_free(bio_buf);
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey),116, (dsakey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 604), 1));
    EVP_PKEY_free(pkey);

    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, DSACertPEM, sizeof(DSACertPEM)) == sizeof(DSACertPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, DSACertPEM, sizeof(DSACertPEM)) == sizeof(DSACertPEM)", "../fuzz/server.c", 608), 1));
    cert = PEM_read_bio_X509(bio_buf, 
# 609 "../fuzz/server.c" 3 4
                                     ((void *)0)
# 609 "../fuzz/server.c"
                                         , 
# 609 "../fuzz/server.c" 3 4
...
# 609 "../fuzz/server.c"
    ...
    (void)((cert != 
# 610 "../fuzz/server.c" 3 4
   ((void *)0)
# 610 "../fuzz/server.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/server.c", 610), 1));
    BIO_free(bio_buf);
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/server.c", 613), 1));
    X509_free(cert);
    ...
    (void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "../fuzz/server.c", 626), 1));
