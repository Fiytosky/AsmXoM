...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    (void)((BN_bin2bn(buf, l1, b1) == b1) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf, l1, b1) == b1", "../fuzz/bndiv.c", 72), 1));
    BN_set_negative(b1, s1);
    (void)((BN_bin2bn(buf + l1, l2, b2) == b2) ? 0 : (OPENSSL_die("assertion failed: " "BN_bin2bn(buf + l1, l2, b2) == b2", "../fuzz/bndiv.c", 74), 1));
    ...
    (void)((BN_div(b3, b4, b1, b2, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_div(b3, b4, b1, b2, ctx)", "../fuzz/bndiv.c", 83), 1));
    if (BN_is_zero(b1))
        ...
        success = (BN_is_negative(b3) == BN_is_negative(b2) || BN_is_zero(b3))
            && (!BN_is_negative(b4) || BN_is_zero(b4));
    (void)((BN_mul(b5, b3, b2, ctx)) ? 0 : (OPENSSL_die("assertion failed: " "BN_mul(b5, b3, b2, ctx)", "../fuzz/bndiv.c", 92), 1));
    (void)((BN_add(b5, b5, b4)) ? 0 : (OPENSSL_die("assertion failed: " "BN_add(b5, b5, b4)", "../fuzz/bndiv.c", 93), 1));
...
# 99 "../fuzz/bndiv.c"
        ...
        putchar('\n');
        BN_print_fp(
# 101 "../fuzz/bndiv.c" 3 4
                   stdout
# 101 "../fuzz/bndiv.c"
                         , b3);
        putchar('\n');
        BN_print_fp(
# 103 "../fuzz/bndiv.c" 3 4
                   stdout
# 103 "../fuzz/bndiv.c"
                         , b4);
        putchar('\n');
        BN_print_fp(
# 105 "../fuzz/bndiv.c" 3 4
                   stdout
# 105 "../fuzz/bndiv.c"
                         , b5);
        putchar('\n');
    ...
    (void)((success) ? 0 : (OPENSSL_die("assertion failed: " "success", "../fuzz/bndiv.c", 117), 1));
    ERR_clear_error();
