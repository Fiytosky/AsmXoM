...
# 55 "../fuzz/x509.c"
    ...
    i2d_X509(x509_1, &der);
    CRYPTO_free(der, "../fuzz/x509.c", 65);
...
# 86 "../fuzz/x509.c"
    ...
    X509_VERIFY_PARAM_set_flags(param, 0x4);
...
# 98 "../fuzz/x509.c"
    ...
    X509_STORE_CTX_init(ctx, store, x509_1, 
# 101 "../fuzz/x509.c" 3 4
                                           ((void *)0)
# 101 "../fuzz/x509.c"
                                               );
...
# 103 "../fuzz/x509.c"
        ...
        crls = ((struct stack_st_X509_CRL *)OPENSSL_sk_new_null());
        if (crls == 
# 105 "../fuzz/x509.c" 3 4
                   ((void *)0)
# 105 "../fuzz/x509.c"
        ...
        OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(crls), ossl_check_X509_CRL_type(crl));
...
# 117 "../fuzz/x509.c"
        ...
        certs = ((struct stack_st_X509 *)OPENSSL_sk_new_null());
        if (certs == 
# 122 "../fuzz/x509.c" 3 4
                    ((void *)0)
# 122 "../fuzz/x509.c"
        ...
        OPENSSL_sk_push(ossl_check_X509_sk_type(certs), ossl_check_X509_type(x509_1));
        OPENSSL_sk_push(ossl_check_X509_sk_type(certs), ossl_check_X509_type(x509_2));

        OCSP_basic_verify(bs, certs, store, 0x1000);
...
err:
    ...
    OPENSSL_sk_free(ossl_check_X509_CRL_sk_type(crls));
    OPENSSL_sk_free(ossl_check_X509_sk_type(certs));
