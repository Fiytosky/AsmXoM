...
# 16 "../fuzz/cmp.c" 2
# 1 "../fuzz/../crypto/cmp/cmp_local.h" 1
# 15 "../fuzz/../crypto/cmp/cmp_local.h"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 16 "../fuzz/../crypto/cmp/cmp_local.h" 2
...
# 1 "../include/openssl/types.h" 1
# 23 "../fuzz/../crypto/cmp/cmp_local.h" 2
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 27 "../fuzz/../crypto/cmp/cmp_local.h" 2
...
struct ossl_cmp_ctx_st {
    ...
    void *http_cb_arg;
# 66 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 157 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 190 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 204 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 290 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 339 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 356 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 373 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 393 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 416 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 431 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 457 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 501 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 560 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 637 "../fuzz/../crypto/cmp/cmp_local.h"
        ASN1_TYPE *pkiconf;
...
# 686 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 761 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 815 "../fuzz/../crypto/cmp/cmp_local.h"
...
# 898 "../fuzz/../crypto/cmp/cmp_local.h"
...
{
    FuzzerSetRand();
    OPENSSL_init_crypto(0x00000002L, 
# 23 "../fuzz/cmp.c" 3 4
                                                         ((void *)0)
# 23 "../fuzz/cmp.c"
                                                             );
...
# 63 "../fuzz/cmp.c" 3 4
                      ((void *)0) 
# 63 "../fuzz/cmp.c"
                           || !X509_set_issuer_name(ctx->oldCert, name)
            || serial == 
# 64 "../fuzz/cmp.c" 3 4
                        ((void *)0) 
# 64 "../fuzz/cmp.c"
...
# 71 "../fuzz/cmp.c"
                             ? msg->body->type : -1) {
    case 1:
        (void)OSSL_CMP_exec_certreq(ctx, 0, 
# 73 "../fuzz/cmp.c" 3 4
             ((void *)0)
# 73 "../fuzz/cmp.c"
             );
        break;
    case 3:
        (void)OSSL_CMP_exec_certreq(ctx, 2, 
# 76 "../fuzz/cmp.c" 3 4
             ((void *)0)
# 76 "../fuzz/cmp.c"
             );
        (void)OSSL_CMP_exec_certreq(ctx, 4, 
# 77 "../fuzz/cmp.c" 3 4
             ((void *)0)
# 77 "../fuzz/cmp.c"
             );
        break;
    case 8:
        (void)OSSL_CMP_exec_certreq(ctx, 7, 
# 80 "../fuzz/cmp.c" 3 4
             ((void *)0)
# 80 "../fuzz/cmp.c"
             );
    ...
    case 26:
        ctx->status = 3;
        (void)OSSL_CMP_try_certreq(ctx, 2, 
# 84 "../fuzz/cmp.c" 3 4
                                                            ((void *)0)
# 84 "../fuzz/cmp.c"
                                                                , 
...
# 84 "../fuzz/cmp.c"
    ...
    case 12:
        ...
        break;
    case 22:
        OPENSSL_sk_pop_free(ossl_check_OSSL_CMP_ITAV_sk_type(OSSL_CMP_exec_GENM_ses(ctx)),ossl_check_OSSL_CMP_ITAV_freefunc_type(OSSL_CMP_ITAV_free))
                                                     ;
        break;
    default:
...
static OSSL_CMP_PKISI *process_cert_request(OSSL_CMP_SRV_CTX *srv_ctx,
                                            ...
                                            struct stack_st_X509 **caPubs)
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",111,__func__), ERR_set_error)((58),(158),
# 111 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 111 "../fuzz/cmp.c"
   );
...
static OSSL_CMP_PKISI *process_rr(OSSL_CMP_SRV_CTX *srv_ctx,
                                  ...
                                  const ASN1_INTEGER *serial)
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",120,__func__), ERR_set_error)((58),(158),
# 120 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 120 "../fuzz/cmp.c"
   );
...
static int process_genm(OSSL_CMP_SRV_CTX *srv_ctx,
                        ...
                        struct stack_st_OSSL_CMP_ITAV **out)
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",129,__func__), ERR_set_error)((58),(158),
# 129 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 129 "../fuzz/cmp.c"
   );
...
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",138,__func__), ERR_set_error)((58),(158),
# 138 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 138 "../fuzz/cmp.c"
   );
...
static int process_certConf(OSSL_CMP_SRV_CTX *srv_ctx,
                            ...
                            const OSSL_CMP_PKISI *si)
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",146,__func__), ERR_set_error)((58),(158),
# 146 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 146 "../fuzz/cmp.c"
   );
...
{
    (ERR_new(), ERR_set_debug("../fuzz/cmp.c",154,__func__), ERR_set_error)((58),(158),
# 154 "../fuzz/cmp.c" 3 4
   ((void *)0)
# 154 "../fuzz/cmp.c"
   );
...
static int clean_transaction(__attribute__((unused)) OSSL_CMP_SRV_CTX *srv_ctx,
                             __attribute__((unused)) const ASN1_OCTET_STRING *id)
{
    return 1;
}

static int delayed_delivery(__attribute__((unused)) OSSL_CMP_SRV_CTX *srv_ctx,
                            __attribute__((unused)) const OSSL_CMP_MSG *req)
{
    return 0;
}
...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    (void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "../fuzz/cmp.c", 179), 1));
    msg = d2i_OSSL_CMP_MSG_bio(in, 
# 180 "../fuzz/cmp.c" 3 4
                                  ((void *)0)
# 180 "../fuzz/cmp.c"
                                      );
