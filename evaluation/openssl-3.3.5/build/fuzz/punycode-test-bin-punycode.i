...
# 11 "../fuzz/punycode.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 12 "../fuzz/punycode.c" 2
...
{
    char *b;
    unsigned int out[16], outlen = (sizeof(out)/sizeof((out)[0]));
    char outc[16];

    b = CRYPTO_malloc(len + 1, "../fuzz/punycode.c", 29);
    if (b != 
# 30 "../fuzz/punycode.c" 3 4
            ((void *)0)
# 30 "../fuzz/punycode.c"
                ) {
        ...
        CRYPTO_free(b, "../fuzz/punycode.c", 35);
    }
    return 0;
}
