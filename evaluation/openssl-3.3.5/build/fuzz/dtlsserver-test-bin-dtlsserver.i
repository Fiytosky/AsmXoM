...
# 27 "../fuzz/dtlsserver.c" 2
# 52 "../fuzz/dtlsserver.c"
...
static int idx;
# 568 "../fuzz/dtlsserver.c"
time_t time(time_t *t) { if (t != 
# 568 "../fuzz/dtlsserver.c" 3 4
                      ((void *)0)
# 568 "../fuzz/dtlsserver.c"
                      ) *t = 1485898104; return 1485898104; }
...
# 576 "../fuzz/dtlsserver.c" 3 4
                                                                              ((void *)0)
# 576 "../fuzz/dtlsserver.c"
                                                                                  );
    OPENSSL_init_ssl(0x00200000L, 
# 577 "../fuzz/dtlsserver.c" 3 4
                                                   ((void *)0)
# 577 "../fuzz/dtlsserver.c"
                                                       );
    ERR_clear_error();
    ...
    if (comp_methods != 
# 582 "../fuzz/dtlsserver.c" 3 4
                       ((void *)0)
# 582 "../fuzz/dtlsserver.c"
                           )
...
int FuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    EC_KEY *ecdsakey = 
# 605 "../fuzz/dtlsserver.c" 3 4
                      ((void *)0)
# 605 "../fuzz/dtlsserver.c"
                          ;



    DSA *dsakey = 
# 609 "../fuzz/dtlsserver.c" 3 4
                 ((void *)0)
# 609 "../fuzz/dtlsserver.c"
                     ;
    ...
    ret = SSL_CTX_ctrl(ctx, 123, 0, 
# 618 "../fuzz/dtlsserver.c" 3 4
         ((void *)0)
# 618 "../fuzz/dtlsserver.c"
         );
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 619), 1));
    ret = SSL_CTX_set_cipher_list(ctx, "ALL:eNULL:@SECLEVEL=0");
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 621), 1));



    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, RSAPrivateKeyPEM, sizeof(RSAPrivateKeyPEM)) == sizeof(RSAPrivateKeyPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, RSAPrivateKeyPEM, sizeof(RSAPrivateKeyPEM)) == sizeof(RSAPrivateKeyPEM)", "../fuzz/dtlsserver.c", 626), 1));
    privkey = PEM_read_bio_RSAPrivateKey(bio_buf, 
# 627 "../fuzz/dtlsserver.c" 3 4
                                                 ((void *)0)
# 627 "../fuzz/dtlsserver.c"
                                                     , 
# 627 "../fuzz/dtlsserver.c" 3 4
                                                       ((void *)0)
# 627 "../fuzz/dtlsserver.c"
...
# 627 "../fuzz/dtlsserver.c"
    ...
    ERR_print_errors_fp(
# 628 "../fuzz/dtlsserver.c" 3 4
                       stderr
# 628 "../fuzz/dtlsserver.c"
                             );
    (void)((privkey != 
# 629 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 629 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "privkey != NULL", "../fuzz/dtlsserver.c", 629), 1));
    BIO_free(bio_buf);
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey),6, (privkey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 634), 1));
    EVP_PKEY_free(pkey);


    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, RSACertificatePEM, sizeof(RSACertificatePEM)) == sizeof(RSACertificatePEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, RSACertificatePEM, sizeof(RSACertificatePEM)) == sizeof(RSACertificatePEM)", "../fuzz/dtlsserver.c", 639), 1));
    cert = PEM_read_bio_X509(bio_buf, 
# 640 "../fuzz/dtlsserver.c" 3 4
                                     ((void *)0)
# 640 "../fuzz/dtlsserver.c"
                                         , 
# 640 "../fuzz/dtlsserver.c" 3 4
                                           ((void *)0)
# 640 "../fuzz/dtlsserver.c"
...
# 640 "../fuzz/dtlsserver.c"
    ...
    BIO_free(bio_buf);
    (void)((cert != 
# 642 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 642 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/dtlsserver.c", 642), 1));
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 644), 1));
    X509_free(cert);
    ...
    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, ECDSAPrivateKeyPEM, sizeof(ECDSAPrivateKeyPEM)) == sizeof(ECDSAPrivateKeyPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, ECDSAPrivateKeyPEM, sizeof(ECDSAPrivateKeyPEM)) == sizeof(ECDSAPrivateKeyPEM)", "../fuzz/dtlsserver.c", 651), 1));
    ecdsakey = PEM_read_bio_ECPrivateKey(bio_buf, 
# 652 "../fuzz/dtlsserver.c" 3 4
                                                 ((void *)0)
# 652 "../fuzz/dtlsserver.c"
                                                     , 
# 652 "../fuzz/dtlsserver.c" 3 4
                                                       ((void *)0)
# 652 "../fuzz/dtlsserver.c"
...
# 652 "../fuzz/dtlsserver.c"
    ...
    ERR_print_errors_fp(
# 653 "../fuzz/dtlsserver.c" 3 4
                       stderr
# 653 "../fuzz/dtlsserver.c"
                             );
    (void)((ecdsakey != 
# 654 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 654 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "ecdsakey != NULL", "../fuzz/dtlsserver.c", 654), 1));
    BIO_free(bio_buf);
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey), 408, (ecdsakey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 659), 1));
    EVP_PKEY_free(pkey);

    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, ECDSACertPEM, sizeof(ECDSACertPEM)) == sizeof(ECDSACertPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, ECDSACertPEM, sizeof(ECDSACertPEM)) == sizeof(ECDSACertPEM)", "../fuzz/dtlsserver.c", 663), 1));
    cert = PEM_read_bio_X509(bio_buf, 
# 664 "../fuzz/dtlsserver.c" 3 4
                                     ((void *)0)
# 664 "../fuzz/dtlsserver.c"
                                         , 
# 664 "../fuzz/dtlsserver.c" 3 4
                                           ((void *)0)
# 664 "../fuzz/dtlsserver.c"
...
# 664 "../fuzz/dtlsserver.c"
    ...
    (void)((cert != 
# 665 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 665 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/dtlsserver.c", 665), 1));
    BIO_free(bio_buf);
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 668), 1));
    X509_free(cert);
    ...
    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, DSAPrivateKeyPEM, sizeof(DSAPrivateKeyPEM)) == sizeof(DSAPrivateKeyPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, DSAPrivateKeyPEM, sizeof(DSAPrivateKeyPEM)) == sizeof(DSAPrivateKeyPEM)", "../fuzz/dtlsserver.c", 675), 1));
    dsakey = PEM_read_bio_DSAPrivateKey(bio_buf, 
# 676 "../fuzz/dtlsserver.c" 3 4
                                                ((void *)0)
# 676 "../fuzz/dtlsserver.c"
                                                    , 
# 676 "../fuzz/dtlsserver.c" 3 4
                                                      ((void *)0)
# 676 "../fuzz/dtlsserver.c"
...
# 676 "../fuzz/dtlsserver.c"
    ...
    ERR_print_errors_fp(
# 677 "../fuzz/dtlsserver.c" 3 4
                       stderr
# 677 "../fuzz/dtlsserver.c"
                             );
    (void)((dsakey != 
# 678 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 678 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "dsakey != NULL", "../fuzz/dtlsserver.c", 678), 1));
    BIO_free(bio_buf);
    pkey = EVP_PKEY_new();
    EVP_PKEY_assign((pkey),116, (dsakey));
    ret = SSL_CTX_use_PrivateKey(ctx, pkey);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 683), 1));
    EVP_PKEY_free(pkey);

    bio_buf = BIO_new(BIO_s_mem());
    (void)(((size_t)BIO_write(bio_buf, DSACertPEM, sizeof(DSACertPEM)) == sizeof(DSACertPEM)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(bio_buf, DSACertPEM, sizeof(DSACertPEM)) == sizeof(DSACertPEM)", "../fuzz/dtlsserver.c", 687), 1));
    cert = PEM_read_bio_X509(bio_buf, 
# 688 "../fuzz/dtlsserver.c" 3 4
                                     ((void *)0)
# 688 "../fuzz/dtlsserver.c"
                                         , 
# 688 "../fuzz/dtlsserver.c" 3 4
                                           ((void *)0)
# 688 "../fuzz/dtlsserver.c"
...
# 688 "../fuzz/dtlsserver.c"
    ...
    (void)((cert != 
# 689 "../fuzz/dtlsserver.c" 3 4
   ((void *)0)
# 689 "../fuzz/dtlsserver.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "cert != NULL", "../fuzz/dtlsserver.c", 689), 1));
    BIO_free(bio_buf);
    ret = SSL_CTX_use_certificate(ctx, cert);
    (void)((ret == 1) ? 0 : (OPENSSL_die("assertion failed: " "ret == 1", "../fuzz/dtlsserver.c", 692), 1));
    X509_free(cert);
    ...
    (void)(((size_t)BIO_write(in, buf, len) == len) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)BIO_write(in, buf, len) == len", "../fuzz/dtlsserver.c", 702), 1));
