...
# 321 "../fuzz/asn1.c"
            ...
            if (ASN1_item_i2d(o, &der, i) > 0) {
                CRYPTO_free(der, "../fuzz/asn1.c", 327);
            }
            ASN1_item_free(o, i);
        }
    }
    ...
    { const unsigned char *p = buf; unsigned char *der = 
# 334 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 334 "../fuzz/asn1.c"
   ; TS_REQ *type = d2i_TS_REQ(
# 334 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 334 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 334 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 334 "../fuzz/asn1.c"
   ) { int len2; BIO *bio = BIO_new(BIO_s_null()); if (bio != 
# 334 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 334 "../fuzz/asn1.c"
   ) { TS_REQ_print_bio(bio, type); BIO_free(bio); } len2 = i2d_TS_REQ(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 334); TS_REQ_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 335 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 335 "../fuzz/asn1.c"
   ; TS_MSG_IMPRINT *type = d2i_TS_MSG_IMPRINT(
# 335 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 335 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 335 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 335 "../fuzz/asn1.c"
   ) { TS_MSG_IMPRINT_print_bio(bio, type); BIO_free(bio); } len2 = i2d_TS_MSG_IMPRINT(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 335); TS_MSG_IMPRINT_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 336 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 336 "../fuzz/asn1.c"
   ; TS_RESP *type = d2i_TS_RESP(
# 336 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 336 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 336 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 336 "../fuzz/asn1.c"
   ) { TS_RESP_print_bio(bio, type); BIO_free(bio); } len2 = i2d_TS_RESP(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 336); TS_RESP_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 337 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 337 "../fuzz/asn1.c"
   ; TS_STATUS_INFO *type = d2i_TS_STATUS_INFO(
# 337 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 337 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 337 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 337 "../fuzz/asn1.c"
   ) { TS_STATUS_INFO_print_bio(bio, type); BIO_free(bio); } len2 = i2d_TS_STATUS_INFO(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 337); TS_STATUS_INFO_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 338 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 338 "../fuzz/asn1.c"
   ; TS_TST_INFO *type = d2i_TS_TST_INFO(
# 338 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 338 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 338 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 338 "../fuzz/asn1.c"
   ) { TS_TST_INFO_print_bio(bio, type); BIO_free(bio); } len2 = i2d_TS_TST_INFO(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 338); TS_TST_INFO_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 339 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 339 "../fuzz/asn1.c"
   ; TS_ACCURACY *type = d2i_TS_ACCURACY(
# 339 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 339 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 339 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 339 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_TS_ACCURACY(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 339); TS_ACCURACY_free(type); } };

    { const unsigned char *p = buf; unsigned char *der = 
# 341 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 341 "../fuzz/asn1.c"
   ; ESS_ISSUER_SERIAL *type = d2i_ESS_ISSUER_SERIAL(
# 341 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 341 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 341 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 341 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ESS_ISSUER_SERIAL(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 341); ESS_ISSUER_SERIAL_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 342 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 342 "../fuzz/asn1.c"
   ; ESS_CERT_ID *type = d2i_ESS_CERT_ID(
# 342 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 342 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 342 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 342 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ESS_CERT_ID(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 342); ESS_CERT_ID_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 343 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 343 "../fuzz/asn1.c"
   ; ESS_SIGNING_CERT *type = d2i_ESS_SIGNING_CERT(
# 343 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 343 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 343 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 343 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ESS_SIGNING_CERT(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 343); ESS_SIGNING_CERT_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 344 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 344 "../fuzz/asn1.c"
   ; ESS_CERT_ID_V2 *type = d2i_ESS_CERT_ID_V2(
# 344 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 344 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 344 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 344 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ESS_CERT_ID_V2(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 344); ESS_CERT_ID_V2_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 345 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 345 "../fuzz/asn1.c"
   ; ESS_SIGNING_CERT_V2 *type = d2i_ESS_SIGNING_CERT_V2(
# 345 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 345 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 345 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 345 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ESS_SIGNING_CERT_V2(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 345); ESS_SIGNING_CERT_V2_free(type); } };

    { const unsigned char *p = buf; unsigned char *der = 
# 347 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 347 "../fuzz/asn1.c"
   ; DH *type = d2i_DHparams(
# 347 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 347 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 347 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 347 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DHparams(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 347); DH_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 348 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 348 "../fuzz/asn1.c"
   ; DH *type = d2i_DHxparams(
# 348 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 348 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 348 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 348 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DHxparams(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 348); DH_free(type); } };
...
# 351 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 351 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DSA_SIG(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 351); DSA_SIG_free(type); } };

    { const unsigned char *p = buf; unsigned char *der = 
# 353 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 353 "../fuzz/asn1.c"
   ; DSA *type = d2i_DSAPrivateKey(
# 353 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 353 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 353 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 353 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DSAPrivateKey(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 353); DSA_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 354 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 354 "../fuzz/asn1.c"
   ; DSA *type = d2i_DSAPublicKey(
# 354 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 354 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 354 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 354 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DSAPublicKey(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 354); DSA_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 355 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 355 "../fuzz/asn1.c"
   ; DSA *type = d2i_DSAparams(
# 355 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 355 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 355 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 355 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_DSAparams(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 355); DSA_free(type); } };
...
# 359 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 359 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_RSAPublicKey(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 359); RSA_free(type); } };
...
# 363 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 363 "../fuzz/asn1.c"
   ; EC_GROUP *type = d2i_ECPKParameters(
# 363 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 363 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 363 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 363 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); if (bio != 
# 363 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 363 "../fuzz/asn1.c"
   ) { ECPKParameters_print(bio, type, 0); BIO_free(bio); } i2d_ECPKParameters(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 363); EC_GROUP_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 364 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 364 "../fuzz/asn1.c"
   ; EC_KEY *type = d2i_ECPrivateKey(
# 364 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 364 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 364 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 364 "../fuzz/asn1.c"
   ) { EC_KEY_print(bio, type, 0); BIO_free(bio); } i2d_ECPrivateKey(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 364); EC_KEY_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 365 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 365 "../fuzz/asn1.c"
   ; EC_KEY *type = d2i_ECParameters(
# 365 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 365 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 365 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 365 "../fuzz/asn1.c"
   ) { ECParameters_print(bio, type); BIO_free(bio); } len2 = i2d_ECParameters(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 365); EC_KEY_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 366 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 366 "../fuzz/asn1.c"
   ; ECDSA_SIG *type = d2i_ECDSA_SIG(
# 366 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 366 "../fuzz/asn1.c"
   , &p, len); if (type != 
# 366 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 366 "../fuzz/asn1.c"
   ) { BIO *bio = BIO_new(BIO_s_null()); BIO_free(bio); i2d_ECDSA_SIG(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 366); ECDSA_SIG_free(type); } };
...
# 369 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 369 "../fuzz/asn1.c"
   ; EVP_PKEY *type = d2i_AutoPrivateKey(
# 369 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 369 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 369 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 369 "../fuzz/asn1.c"
   ) { EVP_PKEY_print_private(bio, type, 0, pctx); BIO_free(bio); } i2d_PrivateKey(type, &der); CRYPTO_free(der, "../fuzz/asn1.c", 369); EVP_PKEY_free(type); } };
    { const unsigned char *p = buf; unsigned char *der = 
# 370 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 370 "../fuzz/asn1.c"
   ; SSL_SESSION *type = d2i_SSL_SESSION(
# 370 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 370 "../fuzz/asn1.c"
   , &p, len); if (type != 
...
# 370 "../fuzz/asn1.c" 3 4
   ((void *)0)
# 370 "../fuzz/asn1.c"
   ) { SSL_SESSION_print(bio, type); BIO_free(bio); } len2 = i2d_SSL_SESSION(type, &der); if (len2 != 0) {} CRYPTO_free(der, "../fuzz/asn1.c", 370); SSL_SESSION_free(type); } };
