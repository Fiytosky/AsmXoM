...
# 11 "../ssl/event_queue.c" 2
# 1 "../include/internal/event_queue.h" 1
# 12 "../include/internal/event_queue.h"
        

# 1 "../include/internal/priority_queue.h" 1
...
# 16 "../include/internal/priority_queue.h" 2
# 75 "../include/internal/priority_queue.h"
...
# 15 "../include/internal/event_queue.h" 2
...
# 16 "../include/internal/event_queue.h" 2
...
typedef struct ossl_priority_queue_st_OSSL_EVENT OSSL_PRIORITY_QUEUE_OSSL_EVENT; static __attribute__((unused)) inline OSSL_PRIORITY_QUEUE_OSSL_EVENT * ossl_pqueue_OSSL_EVENT_new(int (*compare)(const OSSL_EVENT *, const OSSL_EVENT *)) { return (OSSL_PRIORITY_QUEUE_OSSL_EVENT *)ossl_pqueue_new( (int (*)(const void *, const void *))compare); } static __attribute__((unused)) inline void ossl_pqueue_OSSL_EVENT_free(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq) { ossl_pqueue_free((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline void ossl_pqueue_OSSL_EVENT_pop_free(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq, void (*freefunc)(OSSL_EVENT *)) { ossl_pqueue_pop_free((OSSL_PQUEUE *)pq, (void (*)(void *))freefunc); } static __attribute__((unused)) inline int ossl_pqueue_OSSL_EVENT_reserve(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq, size_t n) { return ossl_pqueue_reserve((OSSL_PQUEUE *)pq, n); } static __attribute__((unused)) inline size_t ossl_pqueue_OSSL_EVENT_num(const OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq) { return ossl_pqueue_num((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline int ossl_pqueue_OSSL_EVENT_push(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq, OSSL_EVENT *data, size_t *elem) { return ossl_pqueue_push((OSSL_PQUEUE *)pq, (void *)data, elem); } static __attribute__((unused)) inline OSSL_EVENT * ossl_pqueue_OSSL_EVENT_peek(const OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq) { return (OSSL_EVENT *)ossl_pqueue_peek((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline OSSL_EVENT * ossl_pqueue_OSSL_EVENT_pop(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq) { return (OSSL_EVENT *)ossl_pqueue_pop((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline OSSL_EVENT * ossl_pqueue_OSSL_EVENT_remove(OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq, size_t elem) { return (OSSL_EVENT *)ossl_pqueue_remove((OSSL_PQUEUE *)pq, elem); } struct ossl_priority_queue_st_OSSL_EVENT;
...
struct ossl_event_st {
    ...
    OSSL_PRIORITY_QUEUE_OSSL_EVENT *queue;
    size_t ref;
...
{
    if (length != 
# 87 "../include/internal/event_queue.h" 3 4
                 ((void *)0)
# 87 "../include/internal/event_queue.h"
                     )
...
# 105 "../include/internal/event_queue.h"
OSSL_EVENT *ossl_event_queue_add_new(OSSL_EVENT_QUEUE *queue,
                                     uint32_t type, uint32_t priority,
                                     OSSL_TIME when, void *ctx,
                                     void *payload, size_t payload_size)
;
# 118 "../include/internal/event_queue.h"
int ossl_event_queue_add(OSSL_EVENT_QUEUE *queue, OSSL_EVENT *event,
                         uint32_t type, uint32_t priority,
                         OSSL_TIME when, void *ctx,
                         void *payload, size_t payload_size);
...
# 13 "../ssl/event_queue.c" 2

struct ossl_event_queue_st {
    OSSL_PRIORITY_QUEUE_OSSL_EVENT *timed_events;
    OSSL_PRIORITY_QUEUE_OSSL_EVENT *now_events;
};
...
OSSL_EVENT_QUEUE *ossl_event_queue_new(void)
{
    OSSL_EVENT_QUEUE *r = CRYPTO_malloc(sizeof(*r), "../ssl/event_queue.c", 35);

    if (r != 
# 37 "../ssl/event_queue.c" 3 4
            ((void *)0)
# 37 "../ssl/event_queue.c"
                ) {
        ...
        if (r->timed_events == 
# 40 "../ssl/event_queue.c" 3 4
                              ((void *)0) 
# 40 "../ssl/event_queue.c"
                                   || r->now_events == 
# 40 "../ssl/event_queue.c" 3 4
                                                       ((void *)0)
# 40 "../ssl/event_queue.c"
            ...
            return 
# 42 "../ssl/event_queue.c" 3 4
                  ((void *)0)
# 42 "../ssl/event_queue.c"
                      ;
        }
    }
    return r;
...
{
    if (event != 
# 50 "../ssl/event_queue.c" 3 4
                ((void *)0)
# 50 "../ssl/event_queue.c"
                    ) {
        if (event->flag_dynamic)
            CRYPTO_free(event, "../ssl/event_queue.c", 52);
        else
            event->queue = 
# 54 "../ssl/event_queue.c" 3 4
                          ((void *)0)
# 54 "../ssl/event_queue.c"
                              ;
    }
}

static void event_queue_free(OSSL_PRIORITY_QUEUE_OSSL_EVENT *queue)
{
    OSSL_EVENT *e;

    if (queue != 
# 62 "../ssl/event_queue.c" 3 4
                ((void *)0)
# 62 "../ssl/event_queue.c"
                    ) {
        while ((e = ossl_pqueue_OSSL_EVENT_pop(queue)) != 
# 63 "../ssl/event_queue.c" 3 4
                                                         ((void *)0)
# 63 "../ssl/event_queue.c"
                                                             )
            ossl_event_free(e);
...
{
    if (queue != 
# 71 "../ssl/event_queue.c" 3 4
                ((void *)0)
# 71 "../ssl/event_queue.c"
                    ) {
        event_queue_free(queue->now_events);
        event_queue_free(queue->timed_events);
        CRYPTO_free(queue, "../ssl/event_queue.c", 74);
    }
}
...
{
    OSSL_PRIORITY_QUEUE_OSSL_EVENT *pq =
...
OSSL_EVENT *ossl_event_queue_add_new(OSSL_EVENT_QUEUE *queue,
                                     ...
                                     void *payload, size_t payload_size)
{
    OSSL_EVENT *e = CRYPTO_malloc(sizeof(*e), "../ssl/event_queue.c", 111);

    if (e == 
# 113 "../ssl/event_queue.c" 3 4
            ((void *)0) 
# 113 "../ssl/event_queue.c"
                 || queue == 
# 113 "../ssl/event_queue.c" 3 4
                             ((void *)0)
# 113 "../ssl/event_queue.c"
                                 ) {
        CRYPTO_free(e, "../ssl/event_queue.c", 114);
        return 
# 115 "../ssl/event_queue.c" 3 4
              ((void *)0)
# 115 "../ssl/event_queue.c"
                  ;
    }
    ...
    if (event_queue_add(queue, e))
        return e;
    CRYPTO_free(e, "../ssl/event_queue.c", 122);
    return 
# 123 "../ssl/event_queue.c" 3 4
          ((void *)0)
# 123 "../ssl/event_queue.c"
              ;
}
...
{
    if (event == 
# 131 "../ssl/event_queue.c" 3 4
                ((void *)0) 
# 131 "../ssl/event_queue.c"
                     || queue == 
# 131 "../ssl/event_queue.c" 3 4
                                 ((void *)0)
# 131 "../ssl/event_queue.c"
...
{
    if (event != 
# 140 "../ssl/event_queue.c" 3 4
                ((void *)0) 
# 140 "../ssl/event_queue.c"
                     && event->queue != 
# 140 "../ssl/event_queue.c" 3 4
                                        ((void *)0)
# 140 "../ssl/event_queue.c"
        ...
        event->queue = 
# 142 "../ssl/event_queue.c" 3 4
                      ((void *)0)
# 142 "../ssl/event_queue.c"
                          ;
    }
    return 1;
}
...
{
    if (event == 
# 149 "../ssl/event_queue.c" 3 4
                ((void *)0)
# 149 "../ssl/event_queue.c"
                    )
...
{
    if (queue == 
# 156 "../ssl/event_queue.c" 3 4
                ((void *)0)
# 156 "../ssl/event_queue.c"
                    )
        return ossl_time_infinite();
                                     ...
                                     OSSL_EVENT **event)
{
    ...
    while ((e = ossl_pqueue_OSSL_EVENT_peek(queue->timed_events)) != 
# 181 "../ssl/event_queue.c" 3 4
                                                                    ((void *)0)
           
# 182 "../ssl/event_queue.c"
        ...
        if (!ossl_pqueue_OSSL_EVENT_push(queue->now_events, e, &e->ref)) {
            e->queue = 
# 185 "../ssl/event_queue.c" 3 4
                      ((void *)0)
# 185 "../ssl/event_queue.c"
                          ;
            return 0;
        }
    }
