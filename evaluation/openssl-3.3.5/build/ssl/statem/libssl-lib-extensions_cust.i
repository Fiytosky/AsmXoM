# 0 "../ssl/statem/extensions_cust.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/statem/extensions_cust.c"
# 12 "../ssl/statem/extensions_cust.c"
...
# 13 "../ssl/statem/extensions_cust.c" 2
# 1 "../ssl/statem/../ssl_local.h" 1
# 15 "../ssl/statem/../ssl_local.h"
...
# 37 "../ssl/statem/../ssl_local.h" 2
# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 38 "../ssl/statem/../ssl_local.h" 2
...
# 40 "../ssl/statem/../ssl_local.h" 2
# 1 "../ssl/statem/../record/record.h" 1
# 22 "../ssl/statem/../record/record.h"
...
# 136 "../ssl/statem/../record/record.h"
...
# 41 "../ssl/statem/../ssl_local.h" 2
# 386 "../ssl/statem/../ssl_local.h"
typedef enum {
    SSL_PHA_NONE = 0,
    SSL_PHA_EXT_SENT,
...
# 1835 "../ssl/statem/../ssl_local.h"
# 1 "../ssl/statem/../quic/quic_local.h" 1
# 14 "../ssl/statem/../quic/quic_local.h"
...
int ossl_quic_conn_poll_events(SSL *ssl, uint64_t events, int do_tick,
                               uint64_t *revents);
# 15 "../ssl/statem/../quic/quic_local.h" 2
...
void ossl_quic_tx_packetiser_set_ack_tx_cb(OSSL_QUIC_TX_PACKETISER *txp,
                                           void (*cb)(const OSSL_QUIC_FRAME_ACK *ack,
                                                      ...
                                                      void *arg),
                                           void *cb_arg);
# 16 "../ssl/statem/../quic/quic_local.h" 2
...
# 20 "../ssl/statem/../quic/quic_local.h" 2
...
int ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor,
                                       ...
                                       uint32_t flags,
                                       CRYPTO_MUTEX *mutex);
# 24 "../ssl/statem/../quic/quic_local.h" 2
...
# 25 "../ssl/statem/../quic/quic_local.h" 2
# 1 "../ssl/statem/../quic/../ssl_local.h" 1
# 26 "../ssl/statem/../quic/quic_local.h" 2
# 34 "../ssl/statem/../quic/quic_local.h"
struct quic_xso_st {
...
struct quic_conn_st {
    ...
    QUIC_PORT *port;
# 151 "../ssl/statem/../quic/quic_local.h"
    QUIC_CHANNEL *ch;
...
# 1836 "../ssl/statem/../ssl_local.h" 2
# 1858 "../ssl/statem/../ssl_local.h"
...
# 2182 "../ssl/statem/../ssl_local.h"
typedef enum downgrade_en {
    DOWNGRADE_NONE,
    DOWNGRADE_TO_1_2,
    DOWNGRADE_TO_1_1
} DOWNGRADE;
# 2246 "../ssl/statem/../ssl_local.h"
...
# 2424 "../ssl/statem/../ssl_local.h" 3 4
                                             ((void *)0)
        
# 2425 "../ssl/statem/../ssl_local.h"
       && sc->cert->pkeys[idx].x509 == 
# 2425 "../ssl/statem/../ssl_local.h" 3 4
                                       ((void *)0)
# 2425 "../ssl/statem/../ssl_local.h"
                                           ;
}
...
static inline int ssl_has_cert_type(const SSL_CONNECTION *sc, unsigned char ct)
{
    ...
    if (ptr == 
# 2441 "../ssl/statem/../ssl_local.h" 3 4
              ((void *)0)
# 2441 "../ssl/statem/../ssl_local.h"
                  )
        return 0;

    return memchr(ptr, ct, len) != 
# 2444 "../ssl/statem/../ssl_local.h" 3 4
                                  ((void *)0)
# 2444 "../ssl/statem/../ssl_local.h"
                                      ;
}
...
# 2455 "../ssl/statem/../ssl_local.h" 3 4
                                                ((void *)0)
# 2455 "../ssl/statem/../ssl_local.h"
                                                    ;

    return s->cert->pkeys[idx].x509 != 
# 2457 "../ssl/statem/../ssl_local.h" 3 4
                                      ((void *)0)
        
# 2458 "../ssl/statem/../ssl_local.h"
       && s->cert->pkeys[idx].privatekey != 
# 2458 "../ssl/statem/../ssl_local.h" 3 4
                                            ((void *)0)
# 2458 "../ssl/statem/../ssl_local.h"
                                                ;
}
...
# 2994 "../ssl/statem/../ssl_local.h" 3 4
       __atomic_fetch_add ((
# 2994 "../ssl/statem/../ssl_local.h"
       ((stat))
# 2994 "../ssl/statem/../ssl_local.h" 3 4
       ), (
# 2994 "../ssl/statem/../ssl_local.h"
...
# 14 "../ssl/statem/extensions_cust.c" 2

# 1 "../ssl/statem/statem_local.h" 1
# 46 "../ssl/statem/statem_local.h"
...
int tls_parse_stoc_server_cert_type(SSL_CONNECTION *s, PACKET *pkt,
                                    unsigned int context,
                                    X509 *x, size_t chainidx);
# 16 "../ssl/statem/extensions_cust.c" 2
                                      ...
                                      int *al, void *add_arg)
{
    ...
    if (add_cb_wrap->add_cb == 
# 39 "../ssl/statem/extensions_cust.c" 3 4
                              ((void *)0)
# 39 "../ssl/statem/extensions_cust.c"
                                  )
        return 1;
                                        ...
                                        const unsigned char *out, void *add_arg)
{
    ...
    if (add_cb_wrap->free_cb == 
# 52 "../ssl/statem/extensions_cust.c" 3 4
                               ((void *)0)
# 52 "../ssl/statem/extensions_cust.c"
                                   )
        return;
                                        ...
                                        int *al, void *parse_arg)
{
    ...
    if (parse_cb_wrap->parse_cb == 
# 67 "../ssl/statem/extensions_cust.c" 3 4
                                  ((void *)0)
# 67 "../ssl/statem/extensions_cust.c"
                                      )
        return 1;
...
# 81 "../ssl/statem/extensions_cust.c"
custom_ext_method *custom_ext_find(const custom_ext_methods *exts,
                                   ENDPOINT role, unsigned int ext_type,
                                   size_t *idx)
{
    ...
    for (i = 0; i < exts->meths_count; i++, meth++) {
        if (ext_type == meth->ext_type
            ...
            if (idx != 
# 92 "../ssl/statem/extensions_cust.c" 3 4
                      ((void *)0)
# 92 "../ssl/statem/extensions_cust.c"
                          )
                *idx = i;
            return meth;
        }
    ...
    return 
# 97 "../ssl/statem/extensions_cust.c" 3 4
          ((void *)0)
# 97 "../ssl/statem/extensions_cust.c"
              ;
}
                     ...
                     size_t chainidx)
{
    ...
    if ((context & (0x00080 | 0x00100)) != 0)
        role = s->server ? ENDPOINT_SERVER : ENDPOINT_CLIENT;

    meth = custom_ext_find(exts, role, ext_type, 
# 126 "../ssl/statem/extensions_cust.c" 3 4
                                                ((void *)0)
# 126 "../ssl/statem/extensions_cust.c"
                                                    );
    ...
    if ((context & (0x00100
        ...
        if ((meth->ext_flags & 0x2) == 0) {
            (ERR_new(), ERR_set_debug("../ssl/statem/extensions_cust.c", 143, __func__), ossl_statem_fatal)((s), (110), (110), 
# 143 "../ssl/statem/extensions_cust.c" 3 4
           ((void *)0)
# 143 "../ssl/statem/extensions_cust.c"
           );
            return 0;
        }
    }
    ...
    if ((context & (0x00080 | 0x04000))
            != 0)
        meth->ext_flags |= 0x1;


    if (meth->parse_cb == 
# 158 "../ssl/statem/extensions_cust.c" 3 4
                         ((void *)0)
# 158 "../ssl/statem/extensions_cust.c"
                             )
        return 1;

    if (meth->parse_cb(((s)->user_ssl), ext_type, context, ext_data,
                       ext_size, x, chainidx, &al, meth->parse_arg) <= 0) {
        (ERR_new(), ERR_set_debug("../ssl/statem/extensions_cust.c", 163, __func__), ossl_statem_fatal)((s), (al), (110), 
# 163 "../ssl/statem/extensions_cust.c" 3 4
       ((void *)0)
# 163 "../ssl/statem/extensions_cust.c"
       );
        return 0;
    }
                   ...
                   size_t chainidx, int maxversion)
{
    ...
    size_t i;
    int al;
    int for_comp = (context & 0x08000) != 0;

    for (i = 0; i < exts->meths_count; i++) {
        const unsigned char *out = 
# 184 "../ssl/statem/extensions_cust.c" 3 4
                                  ((void *)0)
# 184 "../ssl/statem/extensions_cust.c"
                                      ;
        size_t outlen = 0;
        ...
        if ((context & 0x00080) == 0 && meth->add_cb == 
# 206 "../ssl/statem/extensions_cust.c" 3 4
                                                                    ((void *)0)
# 206 "../ssl/statem/extensions_cust.c"
                                                                        )
            continue;

        if (meth->add_cb != 
# 209 "../ssl/statem/extensions_cust.c" 3 4
                           ((void *)0)
# 209 "../ssl/statem/extensions_cust.c"
                               ) {
            int cb_retval = meth->add_cb(((s)->user_ssl),
            ...
            if (cb_retval < 0) {
                if (!for_comp)
                    (ERR_new(), ERR_set_debug("../ssl/statem/extensions_cust.c", 217, __func__), ossl_statem_fatal)((s), (al), (234), 
# 217 "../ssl/statem/extensions_cust.c" 3 4
                   ((void *)0)
# 217 "../ssl/statem/extensions_cust.c"
                   );
                return 0;
            }
            if (cb_retval == 0)
        ...
        if (!WPACKET_put_bytes__((pkt), (meth->ext_type), 2)
                || !WPACKET_start_sub_packet_len__((pkt), 2)
                || (outlen > 0 && !WPACKET_memcpy(pkt, out, outlen))
                || !WPACKET_close(pkt)) {
            if (meth->free_cb != 
# 228 "../ssl/statem/extensions_cust.c" 3 4
                                ((void *)0)
# 228 "../ssl/statem/extensions_cust.c"
                                    )
                meth->free_cb(((s)->user_ssl), meth->ext_type,
                              context, out, meth->add_arg);
            if (!for_comp)
                (ERR_new(), ERR_set_debug("../ssl/statem/extensions_cust.c", 232, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 232 "../ssl/statem/extensions_cust.c" 3 4
               ((void *)0)
# 232 "../ssl/statem/extensions_cust.c"
               );
            return 0;
        }
        if ((context & 0x00080) != 0) {



            if (!__builtin_expect(!!(((meth->ext_flags & 0x2) == 0) != 0), 1)) {
                if (meth->free_cb != 
# 240 "../ssl/statem/extensions_cust.c" 3 4
                                    ((void *)0)
# 240 "../ssl/statem/extensions_cust.c"
                                        )
                    meth->free_cb(((s)->user_ssl), meth->ext_type,
                                  context, out, meth->add_arg);
                if (!for_comp)
                    (ERR_new(), ERR_set_debug("../ssl/statem/extensions_cust.c", 244, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 244 "../ssl/statem/extensions_cust.c" 3 4
                   ((void *)0)
# 244 "../ssl/statem/extensions_cust.c"
                   );
                return 0;
            }
        ...
        if (meth->free_cb != 
# 254 "../ssl/statem/extensions_cust.c" 3 4
                            ((void *)0)
# 254 "../ssl/statem/extensions_cust.c"
                                )
            meth->free_cb(((s)->user_ssl), meth->ext_type,
                          context, out, meth->add_arg);
    }
                           ...
                           const custom_ext_methods *src)
{
    ...
    for (i = 0; i < src->meths_count; i++, methsrc++) {
        custom_ext_method *methdst = custom_ext_find(dst, methsrc->role,
                                                     methsrc->ext_type, 
# 270 "../ssl/statem/extensions_cust.c" 3 4
                                                                       ((void *)0)
# 270 "../ssl/statem/extensions_cust.c"
                                                                           );

        if (methdst == 
# 272 "../ssl/statem/extensions_cust.c" 3 4
                      ((void *)0)
# 272 "../ssl/statem/extensions_cust.c"
                          )
            continue;
...
int custom_exts_copy(custom_ext_methods *dst, const custom_ext_methods *src)
{
    ...
    if (src->meths_count > 0) {
        dst->meths =
            CRYPTO_memdup((src->meths), sizeof(*src->meths) * src->meths_count, "../ssl/statem/extensions_cust.c", 289)
                                                                  ;
        if (dst->meths == 
# 291 "../ssl/statem/extensions_cust.c" 3 4
                         ((void *)0)
# 291 "../ssl/statem/extensions_cust.c"
                             )
            return 0;
        ...
        for (i = 0; i < src->meths_count; i++) {
            ...
            if (err) {
                methdst->add_arg = 
# 308 "../ssl/statem/extensions_cust.c" 3 4
                                  ((void *)0)
# 308 "../ssl/statem/extensions_cust.c"
                                      ;
                methdst->parse_arg = 
# 309 "../ssl/statem/extensions_cust.c" 3 4
                                    ((void *)0)
# 309 "../ssl/statem/extensions_cust.c"
                                        ;
                continue;
            }

            methdst->add_arg = CRYPTO_memdup((methsrc->add_arg), sizeof(custom_ext_add_cb_wrap), "../ssl/statem/extensions_cust.c", 313)
                                                                             ;
            methdst->parse_arg = CRYPTO_memdup((methsrc->parse_arg), sizeof(custom_ext_parse_cb_wrap), "../ssl/statem/extensions_cust.c", 315)
                                                                             ;

            if (methdst->add_arg == 
# 318 "../ssl/statem/extensions_cust.c" 3 4
                                   ((void *)0) 
# 318 "../ssl/statem/extensions_cust.c"
                                        || methdst->parse_arg == 
# 318 "../ssl/statem/extensions_cust.c" 3 4
                                                                 ((void *)0)
# 318 "../ssl/statem/extensions_cust.c"
...
void custom_exts_free(custom_ext_methods *exts)
{
    ...
    for (i = 0, meth = exts->meths; i < exts->meths_count; i++, meth++) {
        ...
        CRYPTO_free(meth->add_arg, "../ssl/statem/extensions_cust.c", 341);
        CRYPTO_free(meth->parse_arg, "../ssl/statem/extensions_cust.c", 342);
    }
    CRYPTO_free(exts->meths, "../ssl/statem/extensions_cust.c", 344);
    exts->meths = 
# 345 "../ssl/statem/extensions_cust.c" 3 4
                 ((void *)0)
# 345 "../ssl/statem/extensions_cust.c"
                     ;
    exts->meths_count = 0;
}
...
# 353 "../ssl/statem/extensions_cust.c" 3 4
                          ((void *)0)
# 353 "../ssl/statem/extensions_cust.c"
                              ) != 
# 353 "../ssl/statem/extensions_cust.c" 3 4
                                   ((void *)0)
# 353 "../ssl/statem/extensions_cust.c"
                                   ...
                                   void *parse_arg)
{
    ...
    if (add_cb == 
# 371 "../ssl/statem/extensions_cust.c" 3 4
                 ((void *)0) 
# 371 "../ssl/statem/extensions_cust.c"
                      && free_cb != 
# 371 "../ssl/statem/extensions_cust.c" 3 4
                                    ((void *)0)
# 371 "../ssl/statem/extensions_cust.c"
    ...
    if (exts == 
# 374 "../ssl/statem/extensions_cust.c" 3 4
               ((void *)0)
# 374 "../ssl/statem/extensions_cust.c"
                   )
    ...
    if (ext_type == 18
            && (context & 0x00080) != 0
            && ctx != 
# 385 "../ssl/statem/extensions_cust.c" 3 4
                     ((void *)0)
            
# 386 "../ssl/statem/extensions_cust.c"
    ...
    if (custom_ext_find(exts, role, ext_type, 
# 402 "../ssl/statem/extensions_cust.c" 3 4
                                             ((void *)0)
# 402 "../ssl/statem/extensions_cust.c"
                                                 ))
        return 0;
    tmp = CRYPTO_realloc(exts->meths, (exts->meths_count + 1) * sizeof(custom_ext_method), "../ssl/statem/extensions_cust.c", 404)
                                                                              ;
    if (tmp == 
# 406 "../ssl/statem/extensions_cust.c" 3 4
              ((void *)0)
# 406 "../ssl/statem/extensions_cust.c"
                  )
        return 0;
                              ...
                              custom_ext_parse_cb parse_cb, void *parse_arg)
{
    custom_ext_add_cb_wrap *add_cb_wrap
        = CRYPTO_malloc(sizeof(*add_cb_wrap), "../ssl/statem/extensions_cust.c", 433);
    custom_ext_parse_cb_wrap *parse_cb_wrap
        = CRYPTO_malloc(sizeof(*parse_cb_wrap), "../ssl/statem/extensions_cust.c", 435);
    int ret;

    if (add_cb_wrap == 
# 438 "../ssl/statem/extensions_cust.c" 3 4
                      ((void *)0) 
# 438 "../ssl/statem/extensions_cust.c"
                           || parse_cb_wrap == 
# 438 "../ssl/statem/extensions_cust.c" 3 4
                                               ((void *)0)
# 438 "../ssl/statem/extensions_cust.c"
                                                   ) {
        CRYPTO_free(add_cb_wrap, "../ssl/statem/extensions_cust.c", 439);
        CRYPTO_free(parse_cb_wrap, "../ssl/statem/extensions_cust.c", 440);
        return 0;
    }
    ...
    ret = ossl_tls_add_custom_ext_intern(ctx, 
# 450 "../ssl/statem/extensions_cust.c" 3 4
                                             ((void *)0)
# 450 "../ssl/statem/extensions_cust.c"
                                                 , role, ext_type,
                                         context,
    ...
    if (!ret) {
        CRYPTO_free(add_cb_wrap, "../ssl/statem/extensions_cust.c", 459);
        CRYPTO_free(parse_cb_wrap, "../ssl/statem/extensions_cust.c", 460);
    }
...
{
    return ossl_tls_add_custom_ext_intern(ctx, 
# 502 "../ssl/statem/extensions_cust.c" 3 4
                                              ((void *)0)
# 502 "../ssl/statem/extensions_cust.c"
                                                  , ENDPOINT_BOTH, ext_type,
