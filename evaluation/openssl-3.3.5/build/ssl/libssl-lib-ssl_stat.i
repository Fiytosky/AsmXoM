...
const char *SSL_state_string_long(const SSL *s)
{
    const SSL_CONNECTION *sc = ((s) == 
# 16 "../ssl/ssl_stat.c" 3 4
                              ((void *)0) 
# 16 "../ssl/ssl_stat.c"
                              ? 
# 16 "../ssl/ssl_stat.c" 3 4
                              ((void *)0) 
# 16 "../ssl/ssl_stat.c"
                              : ((s)->type == 0 ? (const SSL_CONNECTION *)(s) : ((s)->type == 1 ? (const SSL_CONNECTION *)((const QUIC_CONNECTION *)(s))->tls : 
# 16 "../ssl/ssl_stat.c" 3 4
                              ((void *)0)
# 16 "../ssl/ssl_stat.c"
                              )));
