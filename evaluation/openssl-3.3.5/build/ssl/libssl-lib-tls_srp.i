...
# 40 "../ssl/ssl_local.h" 2
# 1 "../ssl/record/record.h" 1
# 22 "../ssl/record/record.h"
...
# 1835 "../ssl/ssl_local.h"
# 1 "../ssl/quic/quic_local.h" 1
# 14 "../ssl/quic/quic_local.h"
...
# 25 "../ssl/quic/quic_local.h" 2
# 1 "../ssl/quic/../ssl_local.h" 1
# 26 "../ssl/quic/quic_local.h" 2
# 34 "../ssl/quic/quic_local.h"
struct quic_xso_st {
...
# 1836 "../ssl/ssl_local.h" 2
# 1858 "../ssl/ssl_local.h"
...
# 2182 "../ssl/ssl_local.h"
typedef enum downgrade_en {
    DOWNGRADE_NONE,
    DOWNGRADE_TO_1_2,
    DOWNGRADE_TO_1_1
} DOWNGRADE;
# 2246 "../ssl/ssl_local.h"
...
# 2424 "../ssl/ssl_local.h" 3 4
                                             ((void *)0)
        
# 2425 "../ssl/ssl_local.h"
       && sc->cert->pkeys[idx].x509 == 
# 2425 "../ssl/ssl_local.h" 3 4
                                       ((void *)0)
# 2425 "../ssl/ssl_local.h"
                                           ;
}
...
static inline int ssl_has_cert_type(const SSL_CONNECTION *sc, unsigned char ct)
{
    ...
    if (ptr == 
# 2441 "../ssl/ssl_local.h" 3 4
              ((void *)0)
# 2441 "../ssl/ssl_local.h"
                  )
        return 0;

    return memchr(ptr, ct, len) != 
# 2444 "../ssl/ssl_local.h" 3 4
                                  ((void *)0)
# 2444 "../ssl/ssl_local.h"
                                      ;
}
...
# 2455 "../ssl/ssl_local.h" 3 4
                                                ((void *)0)
# 2455 "../ssl/ssl_local.h"
                                                    ;

    return s->cert->pkeys[idx].x509 != 
# 2457 "../ssl/ssl_local.h" 3 4
                                      ((void *)0)
        
# 2458 "../ssl/ssl_local.h"
       && s->cert->pkeys[idx].privatekey != 
# 2458 "../ssl/ssl_local.h" 3 4
                                            ((void *)0)
# 2458 "../ssl/ssl_local.h"
                                                ;
}
...
# 2994 "../ssl/ssl_local.h" 3 4
       __atomic_fetch_add ((
# 2994 "../ssl/ssl_local.h"
       ((stat))
# 2994 "../ssl/ssl_local.h" 3 4
       ), (
# 2994 "../ssl/ssl_local.h"
...
{
    if (ctx == 
# 34 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 34 "../ssl/tls_srp.c"
                  )
        return 0;
    CRYPTO_free(ctx->srp_ctx.login, "../ssl/tls_srp.c", 36);
    CRYPTO_free(ctx->srp_ctx.info, "../ssl/tls_srp.c", 37);
...
{
    if (s == 
# 62 "../ssl/tls_srp.c" 3 4
            ((void *)0)
# 62 "../ssl/tls_srp.c"
                )
        return 0;
    CRYPTO_free(s->srp_ctx.login, "../ssl/tls_srp.c", 64);
    CRYPTO_free(s->srp_ctx.info, "../ssl/tls_srp.c", 65);
    BN_free(s->srp_ctx.N);
    BN_free(s->srp_ctx.g);
    BN_free(s->srp_ctx.s);
    BN_free(s->srp_ctx.B);
...
# 95 "../ssl/tls_srp.c"
    ...
    if (((ctx->srp_ctx.N != 
# 113 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 113 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.N = BN_dup(ctx->srp_ctx.N)) == 
# 114 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 114 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.g != 
# 115 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 115 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.g = BN_dup(ctx->srp_ctx.g)) == 
# 116 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 116 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.s != 
# 117 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 117 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.s = BN_dup(ctx->srp_ctx.s)) == 
# 118 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 118 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.B != 
# 119 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 119 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.B = BN_dup(ctx->srp_ctx.B)) == 
# 120 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 120 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.A != 
# 121 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 121 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.A = BN_dup(ctx->srp_ctx.A)) == 
# 122 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 122 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.a != 
# 123 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 123 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.a = BN_dup(ctx->srp_ctx.a)) == 
# 124 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 124 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.v != 
# 125 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 125 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.v = BN_dup(ctx->srp_ctx.v)) == 
# 126 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 126 "../ssl/tls_srp.c"
                                                        )) ||
        ((ctx->srp_ctx.b != 
# 127 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 127 "../ssl/tls_srp.c"
                               ) &&
         ((s->srp_ctx.b = BN_dup(ctx->srp_ctx.b)) == 
# 128 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 128 "../ssl/tls_srp.c"
                                                        ))) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c",129,__func__), ERR_set_error)((20),((3 | (0x2 << 18L))),
# 129 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 129 "../ssl/tls_srp.c"
       );
        goto err;
    }
    if ((ctx->srp_ctx.login != 
# 132 "../ssl/tls_srp.c" 3 4
                              ((void *)0)
# 132 "../ssl/tls_srp.c"
                                  ) &&
        ((s->srp_ctx.login = CRYPTO_strdup(ctx->srp_ctx.login, "../ssl/tls_srp.c", 133)) == 
# 133 "../ssl/tls_srp.c" 3 4
                                                                   ((void *)0)
# 133 "../ssl/tls_srp.c"
                                                                       )) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c",134,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 134 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 134 "../ssl/tls_srp.c"
       );
        goto err;
    ...
    if ((ctx->srp_ctx.info != 
# 137 "../ssl/tls_srp.c" 3 4
                             ((void *)0)
# 137 "../ssl/tls_srp.c"
                                 ) &&
        ((s->srp_ctx.info = CRYPTO_strdup(ctx->srp_ctx.info, "../ssl/tls_srp.c", 138)) == 
# 138 "../ssl/tls_srp.c" 3 4
                                                                 ((void *)0)
# 138 "../ssl/tls_srp.c"
                                                                     )) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c",139,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 139 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 139 "../ssl/tls_srp.c"
       );
        goto err;
    ...
    return 1;
 err:
    CRYPTO_free(s->srp_ctx.login, "../ssl/tls_srp.c", 146);
    CRYPTO_free(s->srp_ctx.info, "../ssl/tls_srp.c", 147);
    BN_free(s->srp_ctx.N);
    BN_free(s->srp_ctx.g);
    BN_free(s->srp_ctx.s);
    BN_free(s->srp_ctx.B);
...
int ssl_srp_server_param_with_username_intern(SSL_CONNECTION *s, int *ad)
{
    ...
    *ad = 115;
    if ((s->srp_ctx.TLS_ext_srp_username_callback != 
# 200 "../ssl/tls_srp.c" 3 4
                                                    ((void *)0)
# 200 "../ssl/tls_srp.c"
                                                        ) &&
        ((al =
          s->srp_ctx.TLS_ext_srp_username_callback(((s)->user_ssl),
                                                   ad,
    ...
    *ad = 80;
    if ((s->srp_ctx.N == 
# 209 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 209 "../ssl/tls_srp.c"
                            ) ||
        (s->srp_ctx.g == 
# 210 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 210 "../ssl/tls_srp.c"
                            ) ||
        (s->srp_ctx.s == 
# 211 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 211 "../ssl/tls_srp.c"
                            ) || (s->srp_ctx.v == 
# 211 "../ssl/tls_srp.c" 3 4
...
# 211 "../ssl/tls_srp.c"
    ...
    if (RAND_priv_bytes_ex(((s)->ssl.ctx)->libctx, b, sizeof(b),
                           0) <= 0)
        return 2;
    s->srp_ctx.b = BN_bin2bn(b, sizeof(b), 
# 217 "../ssl/tls_srp.c" 3 4
                                          ((void *)0)
# 217 "../ssl/tls_srp.c"
                                              );
...
# 252 "../ssl/tls_srp.c"
    ...
    sc->srp_ctx.v = 
# 257 "../ssl/tls_srp.c" 3 4
                   ((void *)0)
# 257 "../ssl/tls_srp.c"
                       ;
    BN_clear_free(sc->srp_ctx.s);
    sc->srp_ctx.s = 
# 259 "../ssl/tls_srp.c" 3 4
                   ((void *)0)
# 259 "../ssl/tls_srp.c"
                       ;
...
# 273 "../ssl/tls_srp.c"
    ...
    if (N != 
# 276 "../ssl/tls_srp.c" 3 4
            ((void *)0)
# 276 "../ssl/tls_srp.c"
                ) {
        if (sc->srp_ctx.N != 
# 277 "../ssl/tls_srp.c" 3 4
                            ((void *)0)
# 277 "../ssl/tls_srp.c"
                                ) {
...
# 280 "../ssl/tls_srp.c"
    ...
    if (g != 
# 285 "../ssl/tls_srp.c" 3 4
            ((void *)0)
# 285 "../ssl/tls_srp.c"
                ) {
        if (sc->srp_ctx.g != 
# 286 "../ssl/tls_srp.c" 3 4
                            ((void *)0)
# 286 "../ssl/tls_srp.c"
                                ) {
...
# 289 "../ssl/tls_srp.c"
    ...
    if (sa != 
# 294 "../ssl/tls_srp.c" 3 4
             ((void *)0)
# 294 "../ssl/tls_srp.c"
                 ) {
        if (sc->srp_ctx.s != 
# 295 "../ssl/tls_srp.c" 3 4
                            ((void *)0)
# 295 "../ssl/tls_srp.c"
                                ) {
...
# 298 "../ssl/tls_srp.c"
    ...
    if (v != 
# 303 "../ssl/tls_srp.c" 3 4
            ((void *)0)
# 303 "../ssl/tls_srp.c"
                ) {
        if (sc->srp_ctx.v != 
# 304 "../ssl/tls_srp.c" 3 4
                            ((void *)0)
# 304 "../ssl/tls_srp.c"
                                ) {
...
# 307 "../ssl/tls_srp.c"
    ...
    if (info != 
# 312 "../ssl/tls_srp.c" 3 4
               ((void *)0)
# 312 "../ssl/tls_srp.c"
                   ) {
        if (sc->srp_ctx.info)
            CRYPTO_free(sc->srp_ctx.info, "../ssl/tls_srp.c", 314);
        if ((sc->srp_ctx.info = CRYPTO_strdup(info, "../ssl/tls_srp.c", 315)) == 
# 315 "../ssl/tls_srp.c" 3 4
                                                        ((void *)0)
# 315 "../ssl/tls_srp.c"
                                                            )
            return -1;
...
# 336 "../ssl/tls_srp.c"
    ...
    if ((K = SRP_Calc_server_key(s->srp_ctx.A, s->srp_ctx.v, u, s->srp_ctx.b,
                                 s->srp_ctx.N)) == 
# 339 "../ssl/tls_srp.c" 3 4
                                                  ((void *)0)
# 339 "../ssl/tls_srp.c"
                                                      )
        goto err;

    tmp_len = ((BN_num_bits(K)+7)/8);
    if ((tmp = CRYPTO_malloc(tmp_len, "../ssl/tls_srp.c", 343)) == 
# 343 "../ssl/tls_srp.c" 3 4
                                          ((void *)0)
# 343 "../ssl/tls_srp.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 344, __func__), ossl_statem_fatal)((s), (80), ((15 | (0x2 << 18L))), 
# 344 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 344 "../ssl/tls_srp.c"
       );
        goto err;
...
# 359 "../ssl/tls_srp.c"
    ...
    int ret = 0, tmp_len = 0;
    char *passwd = 
# 361 "../ssl/tls_srp.c" 3 4
                  ((void *)0)
# 361 "../ssl/tls_srp.c"
                      ;
    unsigned char *tmp = 
# 362 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 362 "../ssl/tls_srp.c"
                            ;
    SSL_CTX *sctx = ((s)->ssl.ctx);
    ...
    if (SRP_Verify_B_mod_N(s->srp_ctx.B, s->srp_ctx.N) == 0
            || (u = SRP_Calc_u_ex(s->srp_ctx.A, s->srp_ctx.B, s->srp_ctx.N,
                                  sctx->libctx, sctx->propq))
               == 
# 371 "../ssl/tls_srp.c" 3 4
                 ((void *)0)
            
# 372 "../ssl/tls_srp.c"
           || s->srp_ctx.SRP_give_srp_client_pwd_callback == 
# 372 "../ssl/tls_srp.c" 3 4
                                                             ((void *)0)
# 372 "../ssl/tls_srp.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 373, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 373 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 373 "../ssl/tls_srp.c"
       );
        goto err;
    }
    if ((passwd = s->srp_ctx.SRP_give_srp_client_pwd_callback(((s)->user_ssl),
                                                              s->srp_ctx.SRP_cb_arg))
            == 
# 378 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 378 "../ssl/tls_srp.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 379, __func__), ossl_statem_fatal)((s), (80), (234), 
# 379 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 379 "../ssl/tls_srp.c"
       );
        goto err;
...
# 384 "../ssl/tls_srp.c"
           || (K = SRP_Calc_client_key_ex(s->srp_ctx.N, s->srp_ctx.B,
                                           ...
                                           sctx->libctx,
                                           sctx->propq)) == 
# 388 "../ssl/tls_srp.c" 3 4
                                                           ((void *)0)
# 388 "../ssl/tls_srp.c"
                                                               ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 389, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 389 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 389 "../ssl/tls_srp.c"
       );
        goto err;
    ...
    tmp_len = ((BN_num_bits(K)+7)/8);
    if ((tmp = CRYPTO_malloc(tmp_len, "../ssl/tls_srp.c", 394)) == 
# 394 "../ssl/tls_srp.c" 3 4
                                          ((void *)0)
# 394 "../ssl/tls_srp.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 395, __func__), ossl_statem_fatal)((s), (80), ((15 | (0x2 << 18L))), 
# 395 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 395 "../ssl/tls_srp.c"
       );
        goto err;
 ...
 err:
    ...
    BN_clear_free(x);
    if (passwd != 
# 404 "../ssl/tls_srp.c" 3 4
                 ((void *)0)
# 404 "../ssl/tls_srp.c"
                     )
        CRYPTO_clear_free(passwd, strlen(passwd), "../ssl/tls_srp.c", 405);
    BN_clear_free(u);
    return ret;
}
...
int srp_verify_server_param(SSL_CONNECTION *s)
{
    ...
    if (BN_ucmp(srp->g, srp->N) >= 0 || BN_ucmp(srp->B, srp->N) >= 0
        || BN_is_zero(srp->B)) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 419, __func__), ossl_statem_fatal)((s), (47), (390), 
# 419 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 419 "../ssl/tls_srp.c"
       );
        return 0;
    ...
    if (BN_num_bits(srp->N) < srp->strength) {
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 424, __func__), ossl_statem_fatal)((s), (71), (241), 
# 424 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 424 "../ssl/tls_srp.c"
       );
        return 0;
    ...
    if (srp->SRP_verify_param_callback) {
        if (srp->SRP_verify_param_callback(((s)->user_ssl),
                                           srp->SRP_cb_arg) <= 0) {
            (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 431, __func__), ossl_statem_fatal)((s), (71), (234), 
# 431 "../ssl/tls_srp.c" 3 4
           ((void *)0)
# 431 "../ssl/tls_srp.c"
           );
            return 0;
        ...
        (ERR_new(), ERR_set_debug("../ssl/tls_srp.c", 435, __func__), ossl_statem_fatal)((s), (71), (241), 
# 435 "../ssl/tls_srp.c" 3 4
       ((void *)0)
# 435 "../ssl/tls_srp.c"
       )
                                             ;
...
int ssl_srp_calc_a_param_intern(SSL_CONNECTION *s)
{
    unsigned char rnd[48];

    if (RAND_priv_bytes_ex(((s)->ssl.ctx)->libctx,
                           rnd, sizeof(rnd), 0) <= 0)
        return 0;
...
# 475 "../ssl/tls_srp.c"
    ...
    if (sc == 
# 477 "../ssl/tls_srp.c" 3 4
             ((void *)0)
# 477 "../ssl/tls_srp.c"
                 )
        return 
# 478 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 478 "../ssl/tls_srp.c"
                  ;

    if (sc->srp_ctx.g != 
# 480 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 480 "../ssl/tls_srp.c"
                            )
        return sc->srp_ctx.g;
...
# 487 "../ssl/tls_srp.c"
    ...
    if (sc == 
# 489 "../ssl/tls_srp.c" 3 4
             ((void *)0)
# 489 "../ssl/tls_srp.c"
                 )
        return 
# 490 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 490 "../ssl/tls_srp.c"
                  ;

    if (sc->srp_ctx.N != 
# 492 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 492 "../ssl/tls_srp.c"
                            )
        return sc->srp_ctx.N;
...
# 499 "../ssl/tls_srp.c"
    ...
    if (sc == 
# 501 "../ssl/tls_srp.c" 3 4
             ((void *)0)
# 501 "../ssl/tls_srp.c"
                 )
        return 
# 502 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 502 "../ssl/tls_srp.c"
                  ;

    if (sc->srp_ctx.login != 
# 504 "../ssl/tls_srp.c" 3 4
                            ((void *)0)
# 504 "../ssl/tls_srp.c"
                                )
...
# 511 "../ssl/tls_srp.c"
    ...
    if (sc == 
# 513 "../ssl/tls_srp.c" 3 4
             ((void *)0)
# 513 "../ssl/tls_srp.c"
                 )
        return 
# 514 "../ssl/tls_srp.c" 3 4
              ((void *)0)
# 514 "../ssl/tls_srp.c"
                  ;

    if (sc->srp_ctx.info != 
# 516 "../ssl/tls_srp.c" 3 4
                           ((void *)0)
# 516 "../ssl/tls_srp.c"
                               )
...
{
    return ssl3_ctx_ctrl(ctx, 79, 0, name);
}

int SSL_CTX_set_srp_password(SSL_CTX *ctx, char *password)
{
    return ssl3_ctx_ctrl(ctx, 81, 0, password);
}

int SSL_CTX_set_srp_strength(SSL_CTX *ctx, int strength)
{
    return ssl3_ctx_ctrl(ctx, 80, strength,
                         
# 537 "../ssl/tls_srp.c" 3 4
                        ((void *)0)
# 537 "../ssl/tls_srp.c"
                            );
}
...
int SSL_CTX_set_srp_verify_param_callback(SSL_CTX *ctx,
                                          int (*cb) (SSL *, void *))
{
    return ssl3_ctx_callback_ctrl(ctx, 76,
                                  (void (*)(void))cb);
}

int SSL_CTX_set_srp_cb_arg(SSL_CTX *ctx, void *arg)
{
    return ssl3_ctx_ctrl(ctx, 78, 0, arg);
}

int SSL_CTX_set_srp_username_callback(SSL_CTX *ctx,
                                      int (*cb) (SSL *, int *, void *))
{
    return ssl3_ctx_callback_ctrl(ctx, 75,
                                  (void (*)(void))cb);
}
...
int SSL_CTX_set_srp_client_pwd_callback(SSL_CTX *ctx,
                                        char *(*cb) (SSL *, void *))
{
    return ssl3_ctx_callback_ctrl(ctx, 77,
                                  (void (*)(void))cb);
}
