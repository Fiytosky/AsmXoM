                                    ...
                                    EVP_PKEY **ppkey)
{
    ...
    return ENGINE_load_ssl_client_cert(((s)->ssl.ctx)->client_cert_engine,
                                       ssl,
                                       SSL_get_client_CA_list(ssl),
                                       px509, ppkey, 
# 75 "../ssl/tls_depr.c" 3 4
                                                    ((void *)0)
# 75 "../ssl/tls_depr.c"
                                                        , 
# 75 "../ssl/tls_depr.c" 3 4
...
{
    if (!ENGINE_init(e)) {
        (ERR_new(), ERR_set_debug("../ssl/tls_depr.c",83,__func__), ERR_set_error)((20),((38 | (0x2 << 18L))),
# 83 "../ssl/tls_depr.c" 3 4
       ((void *)0)
# 83 "../ssl/tls_depr.c"
       );
        return 0;
    ...
    if (!ENGINE_get_ssl_client_cert_function(e)) {
        (ERR_new(), ERR_set_debug("../ssl/tls_depr.c",87,__func__), ERR_set_error)((20),(331),
# 87 "../ssl/tls_depr.c" 3 4
       ((void *)0)
# 87 "../ssl/tls_depr.c"
       );
        ENGINE_finish(e);
...
int ssl_hmac_old_init(SSL_HMAC *ctx, void *key, size_t len, char *md)
{
    return HMAC_Init_ex(ctx->old_ctx, key, len, EVP_get_digestbyname(md), 
# 121 "../ssl/tls_depr.c" 3 4
                                                                         ((void *)0)
# 121 "../ssl/tls_depr.c"
                                                                             );
}
...
EVP_PKEY *ssl_dh_to_pkey(DH *dh)
{
    ...
    if (dh == 
# 158 "../ssl/tls_depr.c" 3 4
             ((void *)0)
# 158 "../ssl/tls_depr.c"
                 )
        return 
# 159 "../ssl/tls_depr.c" 3 4
              ((void *)0)
# 159 "../ssl/tls_depr.c"
                  ;
    ret = EVP_PKEY_new();
                            ...
                            void *key)
{
    ...
    if (group == 
# 179 "../ssl/tls_depr.c" 3 4
                ((void *)0)
# 179 "../ssl/tls_depr.c"
                    ) {
        (ERR_new(), ERR_set_debug("../ssl/tls_depr.c",180,__func__), ERR_set_error)((20),(290),
# 180 "../ssl/tls_depr.c" 3 4
       ((void *)0)
# 180 "../ssl/tls_depr.c"
       );
        return 0;
