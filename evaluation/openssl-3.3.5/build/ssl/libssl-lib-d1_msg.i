...
# 18 "../ssl/d1_msg.c"
    ...
    if (SSL_in_init(s) && !ossl_statem_get_in_handshake(sc)) {
        ...
        if (i < 0)
            return i;
        if (i == 0) {
            (ERR_new(), ERR_set_debug("../ssl/d1_msg.c",26,__func__), ERR_set_error)((20),(229),
# 26 "../ssl/d1_msg.c" 3 4
           ((void *)0)
# 26 "../ssl/d1_msg.c"
           );
    ...
    if (len > 16384) {
        (ERR_new(), ERR_set_debug("../ssl/d1_msg.c",32,__func__), ERR_set_error)((20),(334),
# 32 "../ssl/d1_msg.c" 3 4
       ((void *)0)
# 32 "../ssl/d1_msg.c"
       );
...
# 48 "../ssl/d1_msg.c"
    ...
    *ptr++ = s->s3.send_alert[1];
    ...
    i = do_dtls1_write(s, 21, &buf[0], sizeof(buf), &written);
    if (i <= 0) {
...
# 62 "../ssl/d1_msg.c"
        ...
        if (s->msg_callback)
            s->msg_callback(1, s->version, 21, s->s3.send_alert,
