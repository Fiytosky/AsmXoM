# 0 "../ssl/ssl_rsa_legacy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/ssl_rsa_legacy.c"
# 13 "../ssl/ssl_rsa_legacy.c"
...
int SSL_use_RSAPrivateKey(SSL *ssl, RSA *rsa)
{
    ...
    if (rsa == 
# 22 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 22 "../ssl/ssl_rsa_legacy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",23,__func__), ERR_set_error)((20),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 23 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 23 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }
    if ((pkey = EVP_PKEY_new()) == 
# 26 "../ssl/ssl_rsa_legacy.c" 3 4
                                  ((void *)0)
# 26 "../ssl/ssl_rsa_legacy.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",27,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 27 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 27 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }

    RSA_up_ref(rsa);
    if (EVP_PKEY_assign((pkey),6, (rsa)) <= 0) {
        RSA_free(rsa);
        EVP_PKEY_free(pkey);
        return 0;
    }
...
int SSL_use_RSAPrivateKey_file(SSL *ssl, const char *file, int type)
{
    ...
    BIO *in;
    RSA *rsa = 
# 47 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 47 "../ssl/ssl_rsa_legacy.c"
                  ;

    in = BIO_new(BIO_s_file());
    if (in == 
# 50 "../ssl/ssl_rsa_legacy.c" 3 4
             ((void *)0)
# 50 "../ssl/ssl_rsa_legacy.c"
                 ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",51,__func__), ERR_set_error)((20),((7 | (0x2 << 18L))),
# 51 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 51 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }

    if ((int)BIO_ctrl(in,108, 0x01|0x02,(char *)(file)) <= 0) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",56,__func__), ERR_set_error)((20),((2 | (0x2 << 18L))),
# 56 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 56 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
    if (type == 2) {
...
# 61 "../ssl/ssl_rsa_legacy.c" 3 4
                                       ((void *)0)
# 61 "../ssl/ssl_rsa_legacy.c"
                                           );
    } else if (type == 1) {
        j = (9 | (0x2 << 18L));
        rsa = PEM_read_bio_RSAPrivateKey(in, 
# 64 "../ssl/ssl_rsa_legacy.c" 3 4
                                            ((void *)0)
# 64 "../ssl/ssl_rsa_legacy.c"
                                                ,
                                         SSL_get_default_passwd_cb(ssl),
                                         SSL_get_default_passwd_cb_userdata(ssl));
    } else {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",68,__func__), ERR_set_error)((20),(124),
# 68 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 68 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
    if (rsa == 
# 71 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 71 "../ssl/ssl_rsa_legacy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",72,__func__), ERR_set_error)((20),(j),
# 72 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 72 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
...
# 89 "../ssl/ssl_rsa_legacy.c" 3 4
                                ((void *)0)
# 89 "../ssl/ssl_rsa_legacy.c"
                                    , &p, (long)len)) == 
# 89 "../ssl/ssl_rsa_legacy.c" 3 4
                                                         ((void *)0)
# 89 "../ssl/ssl_rsa_legacy.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",90,__func__), ERR_set_error)((20),((13 | (0x2 << 18L))),
# 90 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 90 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }
...
int SSL_CTX_use_RSAPrivateKey(SSL_CTX *ctx, RSA *rsa)
{
    ...
    if (rsa == 
# 104 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 104 "../ssl/ssl_rsa_legacy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",105,__func__), ERR_set_error)((20),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 105 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 105 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }
    if ((pkey = EVP_PKEY_new()) == 
# 108 "../ssl/ssl_rsa_legacy.c" 3 4
                                  ((void *)0)
# 108 "../ssl/ssl_rsa_legacy.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",109,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 109 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 109 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }
...
int SSL_CTX_use_RSAPrivateKey_file(SSL_CTX *ctx, const char *file, int type)
{
    ...
    BIO *in;
    RSA *rsa = 
# 129 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 129 "../ssl/ssl_rsa_legacy.c"
                  ;

    in = BIO_new(BIO_s_file());
    if (in == 
# 132 "../ssl/ssl_rsa_legacy.c" 3 4
             ((void *)0)
# 132 "../ssl/ssl_rsa_legacy.c"
                 ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",133,__func__), ERR_set_error)((20),((7 | (0x2 << 18L))),
# 133 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 133 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }

    if ((int)BIO_ctrl(in,108, 0x01|0x02,(char *)(file)) <= 0) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",138,__func__), ERR_set_error)((20),((2 | (0x2 << 18L))),
# 138 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 138 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
    if (type == 2) {
        j = (13 | (0x2 << 18L));
        rsa = d2i_RSAPrivateKey_bio(in, 
# 143 "../ssl/ssl_rsa_legacy.c" 3 4
                                       ((void *)0)
# 143 "../ssl/ssl_rsa_legacy.c"
                                           );
    } else if (type == 1) {
        j = (9 | (0x2 << 18L));
        rsa = PEM_read_bio_RSAPrivateKey(in, 
# 146 "../ssl/ssl_rsa_legacy.c" 3 4
                                            ((void *)0)
# 146 "../ssl/ssl_rsa_legacy.c"
                                                ,
                                         SSL_CTX_get_default_passwd_cb(ctx),
                                         SSL_CTX_get_default_passwd_cb_userdata(ctx));
    } else {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",150,__func__), ERR_set_error)((20),(124),
# 150 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 150 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
    if (rsa == 
# 153 "../ssl/ssl_rsa_legacy.c" 3 4
              ((void *)0)
# 153 "../ssl/ssl_rsa_legacy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",154,__func__), ERR_set_error)((20),(j),
# 154 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 154 "../ssl/ssl_rsa_legacy.c"
       );
        goto end;
    }
                                   ...
                                   long len)
{
    ...
    p = d;
    if ((rsa = d2i_RSAPrivateKey(
# 172 "../ssl/ssl_rsa_legacy.c" 3 4
                                ((void *)0)
# 172 "../ssl/ssl_rsa_legacy.c"
                                    , &p, (long)len)) == 
# 172 "../ssl/ssl_rsa_legacy.c" 3 4
                                                         ((void *)0)
# 172 "../ssl/ssl_rsa_legacy.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_rsa_legacy.c",173,__func__), ERR_set_error)((20),((13 | (0x2 << 18L))),
# 173 "../ssl/ssl_rsa_legacy.c" 3 4
       ((void *)0)
# 173 "../ssl/ssl_rsa_legacy.c"
       );
        return 0;
    }
