# 0 "../ssl/rio/poll_immediate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/rio/poll_immediate.c"
# 10 "../ssl/rio/poll_immediate.c"
...
# 13 "../ssl/rio/poll_immediate.c" 2
# 1 "../ssl/rio/../ssl_local.h" 1
# 30 "../ssl/rio/../ssl_local.h"
...
# 40 "../ssl/rio/../ssl_local.h" 2
# 1 "../ssl/rio/../record/record.h" 1
# 22 "../ssl/rio/../record/record.h"
...
# 41 "../ssl/rio/../ssl_local.h" 2
# 386 "../ssl/rio/../ssl_local.h"
typedef enum {
    SSL_PHA_NONE = 0,
    SSL_PHA_EXT_SENT,
...
# 1835 "../ssl/rio/../ssl_local.h"
# 1 "../ssl/rio/../quic/quic_local.h" 1
# 14 "../ssl/rio/../quic/quic_local.h"
...
int ossl_quic_conn_poll_events(SSL *ssl, uint64_t events, int do_tick,
                               uint64_t *revents);
# 15 "../ssl/rio/../quic/quic_local.h" 2
...
void ossl_quic_tx_packetiser_set_ack_tx_cb(OSSL_QUIC_TX_PACKETISER *txp,
                                           void (*cb)(const OSSL_QUIC_FRAME_ACK *ack,
                                                      ...
                                                      void *arg),
                                           void *cb_arg);
# 16 "../ssl/rio/../quic/quic_local.h" 2
...
# 20 "../ssl/rio/../quic/quic_local.h" 2
...
int ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor,
                                       ...
                                       uint32_t flags,
                                       CRYPTO_MUTEX *mutex);
# 24 "../ssl/rio/../quic/quic_local.h" 2
...
# 25 "../ssl/rio/../quic/quic_local.h" 2
# 1 "../ssl/rio/../quic/../ssl_local.h" 1
# 26 "../ssl/rio/../quic/quic_local.h" 2
# 34 "../ssl/rio/../quic/quic_local.h"
struct quic_xso_st {
...
# 1836 "../ssl/rio/../ssl_local.h" 2
# 1858 "../ssl/rio/../ssl_local.h"
...
# 2182 "../ssl/rio/../ssl_local.h"
typedef enum downgrade_en {
    DOWNGRADE_NONE,
    DOWNGRADE_TO_1_2,
    DOWNGRADE_TO_1_1
} DOWNGRADE;
# 2246 "../ssl/rio/../ssl_local.h"
...
# 2424 "../ssl/rio/../ssl_local.h" 3 4
                                             ((void *)0)
        
# 2425 "../ssl/rio/../ssl_local.h"
       && sc->cert->pkeys[idx].x509 == 
# 2425 "../ssl/rio/../ssl_local.h" 3 4
                                       ((void *)0)
# 2425 "../ssl/rio/../ssl_local.h"
                                           ;
}
...
static inline int ssl_has_cert_type(const SSL_CONNECTION *sc, unsigned char ct)
{
    ...
    if (ptr == 
# 2441 "../ssl/rio/../ssl_local.h" 3 4
              ((void *)0)
# 2441 "../ssl/rio/../ssl_local.h"
                  )
        return 0;

    return memchr(ptr, ct, len) != 
# 2444 "../ssl/rio/../ssl_local.h" 3 4
                                  ((void *)0)
# 2444 "../ssl/rio/../ssl_local.h"
                                      ;
}
...
# 2455 "../ssl/rio/../ssl_local.h" 3 4
                                                ((void *)0)
# 2455 "../ssl/rio/../ssl_local.h"
                                                    ;

    return s->cert->pkeys[idx].x509 != 
# 2457 "../ssl/rio/../ssl_local.h" 3 4
                                      ((void *)0)
        
# 2458 "../ssl/rio/../ssl_local.h"
       && s->cert->pkeys[idx].privatekey != 
# 2458 "../ssl/rio/../ssl_local.h" 3 4
                                            ((void *)0)
# 2458 "../ssl/rio/../ssl_local.h"
                                                ;
}
...
# 2994 "../ssl/rio/../ssl_local.h" 3 4
       __atomic_fetch_add ((
# 2994 "../ssl/rio/../ssl_local.h"
       ((stat))
# 2994 "../ssl/rio/../ssl_local.h" 3 4
       ), (
# 2994 "../ssl/rio/../ssl_local.h"
...
# 14 "../ssl/rio/poll_immediate.c" 2
# 46 "../ssl/rio/poll_immediate.c"
int SSL_poll(SSL_POLL_ITEM *items,
             size_t num_items,
             size_t stride,
             const struct timeval *timeout,
             ...
             size_t *p_result_count)
{
    ...
    SSL *ssl;
    uint64_t revents;
    __attribute__((unused)) uint64_t events;
    __attribute__((unused)) int do_tick = ((flags & (1U << 0)) == 0);
    int is_immediate
        = (timeout != 
# 61 "../ssl/rio/poll_immediate.c" 3 4
                     ((void *)0)
           
# 62 "../ssl/rio/poll_immediate.c"
    ...
    if (!is_immediate) {
        (ERR_new(), ERR_set_debug("../ssl/rio/poll_immediate.c",69,__func__), ERR_set_error)(20, 418,
                       "SSL_poll does not currently support blocking "
                       "operation");
        do { size_t j; for (j = (0); j < num_items; ++j) (*(SSL_POLL_ITEM *)((char *)(items) + (j)*(stride))).revents = 0; ok = 0; goto out; } while (0);
    }
    ...
    for (i = 0; i < num_items; ++i) {
        item = &(*(SSL_POLL_ITEM *)((char *)(items) + (i)*(stride)));
        events = item->events;
        revents = 0;
        ...
        case 2:
            ...
            if (ssl == 
# 88 "../ssl/rio/poll_immediate.c" 3 4
                      ((void *)0)
# 88 "../ssl/rio/poll_immediate.c"
                          )
            ...
            case 2:
                if (!ossl_quic_conn_poll_events(ssl, events, do_tick, &revents))
                    ...
                    do { (*(SSL_POLL_ITEM *)((char *)(items) + (i)*(stride))).revents = (1U << 0); ++result_count; do { size_t j; for (j = (i + 1); j < num_items; ++j) (*(SSL_POLL_ITEM *)((char *)(items) + (j)*(stride))).revents = 0; ok = 0; goto out; } while (0); } while (0);
            ...
            default:
                (ERR_new(), ERR_set_debug("../ssl/rio/poll_immediate.c",107,__func__), ERR_set_error)(20, 418,
            ...
            break;
        case 1:
            (ERR_new(), ERR_set_debug("../ssl/rio/poll_immediate.c",114,__func__), ERR_set_error)(20, 418,
                           "SSL_poll currently does not support polling "
                           "sockets");
            do { (*(SSL_POLL_ITEM *)((char *)(items) + (i)*(stride))).revents = (1U << 0); ++result_count; do { size_t j; for (j = (i + 1); j < num_items; ++j) (*(SSL_POLL_ITEM *)((char *)(items) + (j)*(stride))).revents = 0; ok = 0; goto out; } while (0); } while (0);
        default:
            (ERR_new(), ERR_set_debug("../ssl/rio/poll_immediate.c",119,__func__), ERR_set_error)(20, 418,
...
out:
    if (p_result_count != 
# 132 "../ssl/rio/poll_immediate.c" 3 4
                         ((void *)0)
# 132 "../ssl/rio/poll_immediate.c"
                             )
