...
pitem *pitem_new(unsigned char *prio64be, void *data)
{
    pitem *item = CRYPTO_malloc(sizeof(*item), "../ssl/pqueue.c", 20);
...
void pitem_free(pitem *item)
{
    CRYPTO_free(item, "../ssl/pqueue.c", 33);
}

pqueue *pqueue_new(void)
{
    pqueue *pq = CRYPTO_zalloc(sizeof(*pq), "../ssl/pqueue.c", 38);
...
void pqueue_free(pqueue *pq)
{
    CRYPTO_free(pq, "../ssl/pqueue.c", 45);
}
...
pitem *pqueue_find(pqueue *pq, unsigned char *prio64be)
{
    pitem *next;
    pitem *found = 
# 102 "../ssl/pqueue.c" 3 4
                  ((void *)0)
# 102 "../ssl/pqueue.c"
                      ;

    if (pq->items == 
# 104 "../ssl/pqueue.c" 3 4
                    ((void *)0)
# 104 "../ssl/pqueue.c"
                        )
        return 
# 105 "../ssl/pqueue.c" 3 4
              ((void *)0)
# 105 "../ssl/pqueue.c"
                  ;

    for (next = pq->items; next->next != 
# 107 "../ssl/pqueue.c" 3 4
                                        ((void *)0)
# 107 "../ssl/pqueue.c"
                                            ; next = next->next) {
