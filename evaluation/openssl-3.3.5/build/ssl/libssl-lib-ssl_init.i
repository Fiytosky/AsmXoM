...
# 24 "../ssl/ssl_init.c" 3 4
                             0
# 24 "../ssl/ssl_init.c"
                                                    ;
static int ssl_base_inited = 0;
static int ossl_init_ssl_base(void); static int ossl_init_ssl_base_ossl_ret_ = 0; static void ossl_init_ssl_base_ossl_(void) { ossl_init_ssl_base_ossl_ret_ = ossl_init_ssl_base(); } static int ossl_init_ssl_base(void)
{
...
# 48 "../ssl/ssl_init.c" 3 4
                                0
# 48 "../ssl/ssl_init.c"
                                                       ;

static int ossl_init_load_ssl_strings(void); static int ossl_init_load_ssl_strings_ossl_ret_ = 0; static void ossl_init_load_ssl_strings_ossl_(void) { ossl_init_load_ssl_strings_ossl_ret_ = ossl_init_load_ssl_strings(); } static int ossl_init_load_ssl_strings(void)
{
...
static int ossl_init_no_load_ssl_strings(void); static void ossl_init_no_load_ssl_strings_ossl_(void) { ossl_init_load_ssl_strings_ossl_ret_ = ossl_init_no_load_ssl_strings(); } static int ossl_init_no_load_ssl_strings(void)
...
int OPENSSL_init_ssl(uint64_t opts, const OPENSSL_INIT_SETTINGS *settings)
{
    ...
    if (stopped) {
        if (!stoperrset) {
            ...
            stoperrset = 1;
            (ERR_new(), ERR_set_debug("../ssl/ssl_init.c",103,__func__), ERR_set_error)((20),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 103 "../ssl/ssl_init.c" 3 4
           ((void *)0)
# 103 "../ssl/ssl_init.c"
           );
        }
    ...
    if (!(CRYPTO_THREAD_run_once(&ssl_base, ossl_init_ssl_base_ossl_) ? ossl_init_ssl_base_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00100000L)
        && !(CRYPTO_THREAD_run_once(&ssl_strings, ossl_init_no_load_ssl_strings_ossl_) ? ossl_init_load_ssl_strings_ossl_ret_ : 0)
                                                    )
        return 0;

    if ((opts & 0x00200000L)
        && !(CRYPTO_THREAD_run_once(&ssl_strings, ossl_init_load_ssl_strings_ossl_) ? ossl_init_load_ssl_strings_ossl_ret_ : 0))
        return 0;
