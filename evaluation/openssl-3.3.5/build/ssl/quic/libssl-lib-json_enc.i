# 0 "../ssl/quic/json_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/json_enc.c"
# 10 "../ssl/quic/json_enc.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 14 "../include/internal/json_enc.h" 2
...
# 11 "../ssl/quic/json_enc.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 12 "../ssl/quic/json_enc.c" 2
...
{
    wbuf->buf = CRYPTO_malloc(alloc, "../ssl/quic/json_enc.c", 23);
    if (wbuf->buf == 
# 24 "../ssl/quic/json_enc.c" 3 4
                    ((void *)0)
# 24 "../ssl/quic/json_enc.c"
                        )
        return 0;
...
{
    CRYPTO_free(wbuf->buf, "../ssl/quic/json_enc.c", 35);
    wbuf->buf = 
# 36 "../ssl/quic/json_enc.c" 3 4
                 ((void *)0)
# 36 "../ssl/quic/json_enc.c"
                     ;
    wbuf->alloc = 0;
}
...
static int wbuf_flush(struct json_write_buf *wbuf, int full)
{
    ...
    if (full)
        (void)(int)BIO_ctrl(wbuf->bio,11,0,
# 106 "../ssl/quic/json_enc.c" 3 4
             ((void *)0)
# 106 "../ssl/quic/json_enc.c"
             );
...
static int json_ensure_stack_size(OSSL_JSON_ENC *json, size_t num_bytes)
{
    ...
    if (num_bytes <= (sizeof(json->stack_small)/sizeof((json->stack_small)[0]))) {
        stack = json->stack_small;
    } else {
        if (json->stack == json->stack_small)
            json->stack = 
# 127 "../ssl/quic/json_enc.c" 3 4
                         ((void *)0)
# 127 "../ssl/quic/json_enc.c"
                             ;

        stack = CRYPTO_realloc(json->stack, num_bytes, "../ssl/quic/json_enc.c", 129);
        if (stack == 
# 130 "../ssl/quic/json_enc.c" 3 4
                    ((void *)0)
# 130 "../ssl/quic/json_enc.c"
                        )
            return 0;
    }
...
static int json_push(OSSL_JSON_ENC *json, unsigned int v)
{
    ...
    if (json->stack_end_byte >= json->stack_bytes) {
        size_t new_size
            = (json->stack_bytes == 0)
            ? (sizeof(json->stack_small)/sizeof((json->stack_small)[0]))
            : (json->stack_bytes * 2);
    ...
    json->stack_end_bit = (json->stack_end_bit + 1) % 8
# 162 "../ssl/quic/json_enc.c"
                                                             ;
...
static int json_pop(OSSL_JSON_ENC *json)
{
    ...
    if (json->stack_end_bit == 0) {
        --json->stack_end_byte;
        json->stack_end_bit = 8 
# 180 "../ssl/quic/json_enc.c"
                                      - 1;
    } else {
        --json->stack_end_bit;
    }
...
void ossl_json_cleanup(OSSL_JSON_ENC *json)
{
    ...
    if (json->stack != json->stack_small)
        CRYPTO_free(json->stack, "../ssl/quic/json_enc.c", 253);

    json->stack = 
# 255 "../ssl/quic/json_enc.c" 3 4
                 ((void *)0)
# 255 "../ssl/quic/json_enc.c"
                     ;
}
...
static void json_u64(OSSL_JSON_ENC *json, uint64_t v, int noquote)
{
    ...
    int quote = !noquote && in_ijson(json) && v > (uint64_t)((((int64_t)1) << 53) - 1);
...
void ossl_json_i64(OSSL_JSON_ENC *json, int64_t value)
{
    ...
    quote = in_ijson(json)
        && (value > (((int64_t)1) << 53) - 1 || value < -(((int64_t)1) << 53) + 1);
    ...
    uv = (value == 
# 588 "../ssl/quic/json_enc.c" 3 4
                  (-9223372036854775807L -1)
# 588 "../ssl/quic/json_enc.c"
                           )
        ? ((uint64_t)-(
# 589 "../ssl/quic/json_enc.c" 3 4
                      (-9223372036854775807L -1) 
# 589 "../ssl/quic/json_enc.c"
                                + 1)) + 1
        : (uint64_t)-value;
    json_u64(json, uv, 1);
