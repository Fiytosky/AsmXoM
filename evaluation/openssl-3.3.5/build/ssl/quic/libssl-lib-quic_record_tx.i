# 0 "../ssl/quic/quic_record_tx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_record_tx.c"
# 10 "../ssl/quic/quic_record_tx.c"
...
# 14 "../include/internal/quic_record_tx.h" 2
...
# 17 "../include/internal/quic_record_tx.h" 2
...
# 11 "../ssl/quic/quic_record_tx.c" 2
# 1 "../include/internal/qlog_event_helpers.h" 1
...
# 17 "../include/internal/qlog_event_helpers.h" 2
...
QUIC_CFQ_ITEM *ossl_quic_cfq_item_get_priority_next(const QUIC_CFQ_ITEM *item,
                                                    uint32_t pn_space);
# 17 "../include/internal/quic_txpim.h" 2
...
# 18 "../include/internal/qlog_event_helpers.h" 2
...
void ossl_qlog_event_transport_packet_received(QLOG *qlog,
                                               ...
                                               size_t numn_iovec,
                                               uint64_t datagram_id);
# 12 "../ssl/quic/quic_record_tx.c" 2
...
# 13 "../ssl/quic/quic_record_tx.c" 2

# 1 "../ssl/quic/quic_record_shared.h" 1
# 38 "../ssl/quic/quic_record_shared.h"
...
void ossl_qrl_enc_level_set_discard(OSSL_QRL_ENC_LEVEL_SET *els,
                                    uint32_t enc_level);
# 15 "../ssl/quic/quic_record_tx.c" 2
...
int ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor,
                                       ...
                                       uint32_t flags,
                                       CRYPTO_MUTEX *mutex);
# 24 "../ssl/quic/../quic/quic_local.h" 2
...
# 17 "../ssl/quic/quic_record_tx.c" 2
...
struct txe_st {
    struct { TXE *next, *prev; } ossl_list_txe;
    size_t data_len, alloc_len;
...
typedef struct ossl_list_st_txe OSSL_LIST_txe; struct ossl_list_st_txe { TXE *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_txe_init(OSSL_LIST_txe *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_txe_init_elem(TXE *elem) { memset(&elem->ossl_list_txe, 0, sizeof(elem->ossl_list_txe)); } static __attribute__((unused)) inline int ossl_list_txe_is_empty(const OSSL_LIST_txe *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_txe_num(const OSSL_LIST_txe *list) { return list->num_elems; } static __attribute__((unused)) inline TXE * ossl_list_txe_head(const OSSL_LIST_txe *list) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; return list->alpha; } static __attribute__((unused)) inline TXE * ossl_list_txe_tail(const OSSL_LIST_txe *list) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; return list->omega; } static __attribute__((unused)) inline TXE * ossl_list_txe_next(const TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; return elem->ossl_list_txe.next; } static __attribute__((unused)) inline TXE * ossl_list_txe_prev(const TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; return elem->ossl_list_txe.prev; } static __attribute__((unused)) inline void ossl_list_txe_remove(OSSL_LIST_txe *list, TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_txe.next; if (list->omega == elem) list->omega = elem->ossl_list_txe.prev; if (elem->ossl_list_txe.prev != 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) elem->ossl_list_txe.prev->ossl_list_txe.next = elem->ossl_list_txe.next; if (elem->ossl_list_txe.next != 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) elem->ossl_list_txe.next->ossl_list_txe.prev = elem->ossl_list_txe.prev; list->num_elems--; memset(&elem->ossl_list_txe, 0, sizeof(elem->ossl_list_txe)); } static __attribute__((unused)) inline void ossl_list_txe_insert_head(OSSL_LIST_txe *list, TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; if (list->alpha != 
...
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) list->alpha->ossl_list_txe.prev = elem; elem->ossl_list_txe.next = list->alpha; elem->ossl_list_txe.prev = 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_txe_insert_tail(OSSL_LIST_txe *list, TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; if (list->omega != 
...
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) list->omega->ossl_list_txe.next = elem; elem->ossl_list_txe.prev = list->omega; elem->ossl_list_txe.next = 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_txe_insert_before(OSSL_LIST_txe *list, TXE *e, TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; elem->ossl_list_txe.next = e; elem->ossl_list_txe.prev = e->ossl_list_txe.prev; if (e->ossl_list_txe.prev != 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) e->ossl_list_txe.prev->ossl_list_txe.next = elem; e->ossl_list_txe.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_txe_insert_after(OSSL_LIST_txe *list, TXE *e, TXE *elem) { 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void) (0))
# 42 "../ssl/quic/quic_record_tx.c"
; elem->ossl_list_txe.prev = e; elem->ossl_list_txe.next = e->ossl_list_txe.next; if (e->ossl_list_txe.next != 
# 42 "../ssl/quic/quic_record_tx.c" 3 4
((void *)0)
# 42 "../ssl/quic/quic_record_tx.c"
) e->ossl_list_txe.next->ossl_list_txe.prev = elem; e->ossl_list_txe.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_txe;
typedef OSSL_LIST_txe TXE_LIST;
...
OSSL_QTX *ossl_qtx_new(const OSSL_QTX_ARGS *args)
{
    ...
    qtx = CRYPTO_zalloc(sizeof(OSSL_QTX), "../ssl/quic/quic_record_tx.c", 120);
    if (qtx == 
# 121 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 121 "../ssl/quic/quic_record_tx.c"
                  )
        return 0;
...
static void qtx_cleanup_txl(TXE_LIST *l)
{
    ...
    for (e = ossl_list_txe_head(l); e != 
# 138 "../ssl/quic/quic_record_tx.c" 3 4
                                        ((void *)0)
# 138 "../ssl/quic/quic_record_tx.c"
                                            ; e = enext) {
        enext = ossl_list_txe_next(e);
        CRYPTO_free(e, "../ssl/quic/quic_record_tx.c", 140);
    }
}
...
void ossl_qtx_free(OSSL_QTX *qtx)
{
    ...
    if (qtx == 
# 149 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 149 "../ssl/quic/quic_record_tx.c"
                  )
        return;
    ...
    CRYPTO_free(qtx->cons, "../ssl/quic/quic_record_tx.c", 155);


    for (i = 0; i < QUIC_ENC_LEVEL_NUM; ++i)
        ossl_qrl_enc_level_set_discard(&qtx->el_set, i);

    CRYPTO_free(qtx, "../ssl/quic/quic_record_tx.c", 161);
}
...
int ossl_qtx_is_enc_level_provisioned(OSSL_QTX *qtx, uint32_t enc_level)
{
    return ossl_qrl_enc_level_set_get(&qtx->el_set, enc_level, 1) != 
# 213 "../ssl/quic/quic_record_tx.c" 3 4
                                                                    ((void *)0)
# 213 "../ssl/quic/quic_record_tx.c"
                                                                        ;
}
...
static TXE *qtx_alloc_txe(size_t alloc_len)
{
    ...
    if (alloc_len >= 
# 221 "../ssl/quic/quic_record_tx.c" 3 4
                    (18446744073709551615UL) 
# 221 "../ssl/quic/quic_record_tx.c"
                             - sizeof(TXE))
        return 
# 222 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 222 "../ssl/quic/quic_record_tx.c"
                  ;

    txe = CRYPTO_malloc(sizeof(TXE) + alloc_len, "../ssl/quic/quic_record_tx.c", 224);
    if (txe == 
# 225 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 225 "../ssl/quic/quic_record_tx.c"
                  )
        return 
# 226 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 226 "../ssl/quic/quic_record_tx.c"
                  ;
...
static TXE *qtx_ensure_free_txe(OSSL_QTX *qtx, size_t alloc_len)
{
    ...
    if (txe != 
# 246 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 246 "../ssl/quic/quic_record_tx.c"
                  )
        return txe;

    txe = qtx_alloc_txe(alloc_len);
    if (txe == 
# 250 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 250 "../ssl/quic/quic_record_tx.c"
                  )
        return 
# 251 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 251 "../ssl/quic/quic_record_tx.c"
                  ;
...
static TXE *qtx_resize_txe(OSSL_QTX *qtx, TXE_LIST *txl, TXE *txe, size_t n)
{
    ...
    if (txe == 
# 267 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 267 "../ssl/quic/quic_record_tx.c"
                  )
        return 
# 268 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 268 "../ssl/quic/quic_record_tx.c"
                  ;

    if (n >= 
# 270 "../ssl/quic/quic_record_tx.c" 3 4
            (18446744073709551615UL) 
# 270 "../ssl/quic/quic_record_tx.c"
                     - sizeof(TXE))
        return 
# 271 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 271 "../ssl/quic/quic_record_tx.c"
                  ;
    ...
    txe2 = CRYPTO_realloc(txe, sizeof(TXE) + n, "../ssl/quic/quic_record_tx.c", 281);
    if (txe2 == 
# 282 "../ssl/quic/quic_record_tx.c" 3 4
               ((void *)0)
# 282 "../ssl/quic/quic_record_tx.c"
                   ) {
        if (p == 
# 283 "../ssl/quic/quic_record_tx.c" 3 4
                ((void *)0)
# 283 "../ssl/quic/quic_record_tx.c"
                    )
            ossl_list_txe_insert_head(txl, txe);
        else
            ossl_list_txe_insert_after(txl, p, txe);
        return 
# 287 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 287 "../ssl/quic/quic_record_tx.c"
                  ;
    }

    if (p == 
# 290 "../ssl/quic/quic_record_tx.c" 3 4
            ((void *)0)
# 290 "../ssl/quic/quic_record_tx.c"
                )
...
# 320 "../ssl/quic/quic_record_tx.c" 3 4
   ((void) (0))
# 320 "../ssl/quic/quic_record_tx.c"
                      ;
                                   ...
                                   size_t max_buf_len)
{
    ...
    if (max_buf_len == 0) {
        *buf = 
# 375 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 375 "../ssl/quic/quic_record_tx.c"
                  ;
        return 0;
    }
                                              ...
                                              size_t *ciphertext_len)
{
    ...
    if (el == 
# 412 "../ssl/quic/quic_record_tx.c" 3 4
             ((void *)0)
# 412 "../ssl/quic/quic_record_tx.c"
                 ) {
        *ciphertext_len = 0;
        return 0;
    }
                                             ...
                                             size_t *plaintext_len)
{
    ...
    if (el == 
# 436 "../ssl/quic/quic_record_tx.c" 3 4
             ((void *)0)
# 436 "../ssl/quic/quic_record_tx.c"
                 ) {
        *plaintext_len = 0;
        return 0;
    }
                         ...
                         QUIC_PKT_HDR_PTRS *ptrs)
{
    ...
    if (qtx->msg_callback != 
# 479 "../ssl/quic/quic_record_tx.c" 3 4
                            ((void *)0)
# 479 "../ssl/quic/quic_record_tx.c"
                                )
        qtx->msg_callback(1, 0x0000001, 0x201, data, l,
                                ...
                                QUIC_PKT_HDR_PTRS *ptrs)
{
    ...
    size_t i;
    EVP_CIPHER_CTX *cctx = 
# 498 "../ssl/quic/quic_record_tx.c" 3 4
                          ((void *)0)
# 498 "../ssl/quic/quic_record_tx.c"
                              ;


    if (!__builtin_expect(!!((el != 
# 501 "../ssl/quic/quic_record_tx.c" 3 4
        ((void *)0)
# 501 "../ssl/quic/quic_record_tx.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",502,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 502 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 502 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
    ...
    if (el->op_count >= ossl_qrl_get_suite_max_pkt(el->suite_id)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",511,__func__), ERR_set_error)((20),(395),
# 511 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 511 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
    ...
    cctx = el->cctx[0];
    if (!__builtin_expect(!!((cctx != 
# 521 "../ssl/quic/quic_record_tx.c" 3 4
        ((void *)0)
# 521 "../ssl/quic/quic_record_tx.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",522,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 522 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 522 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
    ...
    if (!__builtin_expect(!!((nonce_len >= (int)sizeof(QUIC_PN)) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",529,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 529 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 529 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
    ...
    if (EVP_CipherInit_ex(cctx, 
# 538 "../ssl/quic/quic_record_tx.c" 3 4
                               ((void *)0)
# 538 "../ssl/quic/quic_record_tx.c"
                                   , 
# 538 "../ssl/quic/quic_record_tx.c" 3 4
                                     ((void *)0)
# 538 "../ssl/quic/quic_record_tx.c"
...
# 538 "../ssl/quic/quic_record_tx.c"
                                               , nonce, 1) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",539,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 539 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 539 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }


    if (EVP_CipherUpdate(cctx, 
# 544 "../ssl/quic/quic_record_tx.c" 3 4
                              ((void *)0)
# 544 "../ssl/quic/quic_record_tx.c"
                                  , &l, hdr, hdr_len) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",545,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 545 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 545 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
    ...
    for (;;) {
        ...
        src_len = iovec_cur_get_buffer(cur, &src, 
# 554 "../ssl/quic/quic_record_tx.c" 3 4
                                                 (18446744073709551615UL)
# 554 "../ssl/quic/quic_record_tx.c"
                                                         );
        if (src_len == 0)
            break;
        ...
        if (EVP_CipherUpdate(cctx, txe_data(txe) + txe->data_len,
                             &l, src, src_len) != 1) {
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",560,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 560 "../ssl/quic/quic_record_tx.c" 3 4
           ((void *)0)
# 560 "../ssl/quic/quic_record_tx.c"
           );
            return 0;
        }
...
# 569 "../ssl/quic/quic_record_tx.c" 3 4
       ((void) (0))
# 569 "../ssl/quic/quic_record_tx.c"
                                            ;
        txe->data_len += src_len;
    }


    if (EVP_CipherFinal_ex(cctx, 
# 574 "../ssl/quic/quic_record_tx.c" 3 4
                                ((void *)0)
# 574 "../ssl/quic/quic_record_tx.c"
                                    , &l2) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",575,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 575 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 575 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }

    if (EVP_CIPHER_CTX_ctrl(cctx, 0x10,
                            el->tag_len, txe_data(txe) + txe->data_len) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_tx.c",581,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 581 "../ssl/quic/quic_record_tx.c" 3 4
       ((void *)0)
# 581 "../ssl/quic/quic_record_tx.c"
       );
        return 0;
    }
                     ...
                     const OSSL_QTX_IOVEC *iovec, size_t num_iovec)
{
    ...
    OSSL_QRL_ENC_LEVEL *el = 
# 609 "../ssl/quic/quic_record_tx.c" 3 4
                            ((void *)0)
# 609 "../ssl/quic/quic_record_tx.c"
                                ;
    ...
    if (!ossl_quic_pkt_type_is_encrypted(hdr->type)) {
        ...
        if (!__builtin_expect(!!((el != 
# 622 "../ssl/quic/quic_record_tx.c" 3 4
            ((void *)0)
# 622 "../ssl/quic/quic_record_tx.c"
            ) != 0), 1))
            return 0;
    }
    ...
    hdr->data = 
# 656 "../ssl/quic/quic_record_tx.c" 3 4
                ((void *)0)
# 656 "../ssl/quic/quic_record_tx.c"
                    ;
    hdr->len = payload_len;
...
# 690 "../ssl/quic/quic_record_tx.c" 3 4
   ((void) (0))
# 690 "../ssl/quic/quic_record_tx.c"
                                  ;
    ...
    if (!needs_encrypt) {
        ...
        for (;;) {
            ...
            src_len = iovec_cur_get_buffer(&cur, &src, 
# 699 "../ssl/quic/quic_record_tx.c" 3 4
                                                      (18446744073709551615UL)
# 699 "../ssl/quic/quic_record_tx.c"
                                                              );
            if (src_len == 0)
                break;
...
# 714 "../ssl/quic/quic_record_tx.c" 3 4
       ((void) (0))
# 714 "../ssl/quic/quic_record_tx.c"
                                                       ;
    }
...
static TXE *qtx_ensure_cons(OSSL_QTX *qtx)
{
    ...
    if (txe != 
# 732 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 732 "../ssl/quic/quic_record_tx.c"
                  )
        return txe;

    txe = qtx_ensure_free_txe(qtx, qtx->mdpl);
    if (txe == 
# 736 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 736 "../ssl/quic/quic_record_tx.c"
                  )
        return 
# 737 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 737 "../ssl/quic/quic_record_tx.c"
                  ;
...
{
    if (qtx->get_qlog_cb == 
# 748 "../ssl/quic/quic_record_tx.c" 3 4
                           ((void *)0)
# 748 "../ssl/quic/quic_record_tx.c"
                               )
        return 
# 749 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 749 "../ssl/quic/quic_record_tx.c"
                  ;
                            ...
                            uint32_t enc_level)
{
    ...
    if (qtx->mutatecb != 
# 763 "../ssl/quic/quic_record_tx.c" 3 4
                        ((void *)0)
# 763 "../ssl/quic/quic_record_tx.c"
                            ) {
    ...
    if (qtx->finishmutatecb != 
# 780 "../ssl/quic/quic_record_tx.c" 3 4
                              ((void *)0)
# 780 "../ssl/quic/quic_record_tx.c"
                                  )
...
{
    return ((a == 
# 788 "../ssl/quic/quic_record_tx.c" 3 4
                 ((void *)0) 
# 788 "../ssl/quic/quic_record_tx.c"
                      || BIO_ADDR_family(a) == 
# 788 "../ssl/quic/quic_record_tx.c" 3 4
                                               0
# 788 "../ssl/quic/quic_record_tx.c"
            ...
            && (b == 
# 789 "../ssl/quic/quic_record_tx.c" 3 4
                    ((void *)0) 
# 789 "../ssl/quic/quic_record_tx.c"
                         || BIO_ADDR_family(b) == 
# 789 "../ssl/quic/quic_record_tx.c" 3 4
                                                  0
# 789 "../ssl/quic/quic_record_tx.c"
        ...
        || (a != 
# 790 "../ssl/quic/quic_record_tx.c" 3 4
                ((void *)0) 
# 790 "../ssl/quic/quic_record_tx.c"
                     && b != 
# 790 "../ssl/quic/quic_record_tx.c" 3 4
                             ((void *)0) 
# 790 "../ssl/quic/quic_record_tx.c"
...
{
    int ret;
    int coalescing = (pkt->flags & (1U << 0)) != 0;
    int was_coalescing;
    TXE *txe;
    uint32_t enc_level;
    ...
    if (pkt->hdr == 
# 802 "../ssl/quic/quic_record_tx.c" 3 4
                   ((void *)0)
# 802 "../ssl/quic/quic_record_tx.c"
                       )
        return 0;
    ...
    was_coalescing = (qtx->cons != 
# 816 "../ssl/quic/quic_record_tx.c" 3 4
                                  ((void *)0) 
# 816 "../ssl/quic/quic_record_tx.c"
                                       && qtx->cons->data_len > 0);
    if (was_coalescing)
    ...
    for (;;) {
        ...
        if (txe == 
# 833 "../ssl/quic/quic_record_tx.c" 3 4
                  ((void *)0)
# 833 "../ssl/quic/quic_record_tx.c"
                      )
            return 0;
        ...
        if (!qtx_reserve_txe(qtx, 
# 840 "../ssl/quic/quic_record_tx.c" 3 4
                                 ((void *)0)
# 840 "../ssl/quic/quic_record_tx.c"
                                     , txe, qtx->mdpl))
            return 0;
        ...
        if (!was_coalescing) {
            ...
            if (pkt->peer != 
# 845 "../ssl/quic/quic_record_tx.c" 3 4
                            ((void *)0)
# 845 "../ssl/quic/quic_record_tx.c"
                                ) {
            ...
            if (pkt->local != 
# 852 "../ssl/quic/quic_record_tx.c" 3 4
                             ((void *)0)
# 852 "../ssl/quic/quic_record_tx.c"
                                 ) {
...
void ossl_qtx_finish_dgram(OSSL_QTX *qtx)
{
    ...
    if (txe == 
# 906 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 906 "../ssl/quic/quic_record_tx.c"
                  )
        return;
    ...
    qtx->cons = 
# 918 "../ssl/quic/quic_record_tx.c" 3 4
                     ((void *)0)
# 918 "../ssl/quic/quic_record_tx.c"
                         ;
    qtx->cons_count = 0;
    ++qtx->datagram_count;
}
...
static void txe_to_msg(TXE *txe, BIO_MSG *msg)
{
    ...
    msg->flags = 0;
    msg->peer
        = BIO_ADDR_family(&txe->peer) != 
# 929 "../ssl/quic/quic_record_tx.c" 3 4
                                        0 
# 929 "../ssl/quic/quic_record_tx.c"
                                                  ? &txe->peer : 
# 929 "../ssl/quic/quic_record_tx.c" 3 4
                                                                 ((void *)0)
# 929 "../ssl/quic/quic_record_tx.c"
                                                                     ;
    msg->local
        = BIO_ADDR_family(&txe->local) != 
# 931 "../ssl/quic/quic_record_tx.c" 3 4
                                         0 
# 931 "../ssl/quic/quic_record_tx.c"
                                                   ? &txe->local : 
# 931 "../ssl/quic/quic_record_tx.c" 3 4
                                                                   ((void *)0)
# 931 "../ssl/quic/quic_record_tx.c"
...
int ossl_qtx_flush_net(OSSL_QTX *qtx)
{
    ...
    if (ossl_list_txe_head(&qtx->pending) == 
# 943 "../ssl/quic/quic_record_tx.c" 3 4
                                            ((void *)0)
# 943 "../ssl/quic/quic_record_tx.c"
                                                )
        return 1;

    if (qtx->bio == 
# 946 "../ssl/quic/quic_record_tx.c" 3 4
                   ((void *)0)
# 946 "../ssl/quic/quic_record_tx.c"
                       )
        return (-2);
    ...
    for (;;) {
        for (txe = ossl_list_txe_head(&qtx->pending), i = 0;
             txe != 
# 951 "../ssl/quic/quic_record_tx.c" 3 4
                   ((void *)0) 
# 951 "../ssl/quic/quic_record_tx.c"
        ...
        for (i = 0; i < wr; ++i) {
            if (qtx->msg_callback != 
# 989 "../ssl/quic/quic_record_tx.c" 3 4
                                    ((void *)0)
# 989 "../ssl/quic/quic_record_tx.c"
                                        )
                qtx->msg_callback(1, 0x0000001, 0x200,
...
int ossl_qtx_pop_net(OSSL_QTX *qtx, BIO_MSG *msg)
{
    ...
    if (txe == 
# 1009 "../ssl/quic/quic_record_tx.c" 3 4
              ((void *)0)
# 1009 "../ssl/quic/quic_record_tx.c"
                  )
        return 0;
...
{
    return qtx->cons != 
# 1048 "../ssl/quic/quic_record_tx.c" 3 4
                       ((void *)0) 
# 1048 "../ssl/quic/quic_record_tx.c"
                            ? qtx->cons->data_len : 0;
}
...
uint64_t ossl_qtx_get_cur_epoch_pkt_count(OSSL_QTX *qtx, uint32_t enc_level)
{
    ...
    el = ossl_qrl_enc_level_set_get(&qtx->el_set, enc_level, 1);
    if (el == 
# 1067 "../ssl/quic/quic_record_tx.c" 3 4
             ((void *)0)
# 1067 "../ssl/quic/quic_record_tx.c"
                 )
        return 
# 1068 "../ssl/quic/quic_record_tx.c" 3 4
              (18446744073709551615UL)
# 1068 "../ssl/quic/quic_record_tx.c"
                        ;
...
uint64_t ossl_qtx_get_max_epoch_pkt_count(OSSL_QTX *qtx, uint32_t enc_level)
{
    ...
    el = ossl_qrl_enc_level_set_get(&qtx->el_set, enc_level, 1);
    if (el == 
# 1078 "../ssl/quic/quic_record_tx.c" 3 4
             ((void *)0)
# 1078 "../ssl/quic/quic_record_tx.c"
                 )
        return 
# 1079 "../ssl/quic/quic_record_tx.c" 3 4
              (18446744073709551615UL)
# 1079 "../ssl/quic/quic_record_tx.c"
                        ;
...
uint64_t ossl_qtx_get_key_epoch(OSSL_QTX *qtx)
{
    ...
    if (el == 
# 1101 "../ssl/quic/quic_record_tx.c" 3 4
             ((void *)0)
# 1101 "../ssl/quic/quic_record_tx.c"
                 )
        return 0;
