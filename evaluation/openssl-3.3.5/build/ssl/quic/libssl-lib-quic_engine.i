# 0 "../ssl/quic/quic_engine.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_engine.c"
# 10 "../ssl/quic/quic_engine.c"
...
# 13 "../include/internal/quic_engine.h" 2
...
# 15 "../include/internal/quic_engine.h" 2
...
# 16 "../include/internal/quic_engine.h" 2
...
# 24 "../ssl/quic/quic_engine.c" 3 4
((void) (0))
# 24 "../ssl/quic/quic_engine.c"
...
QUIC_ENGINE *ossl_quic_engine_new(const QUIC_ENGINE_ARGS *args)
{
    ...
    if ((qeng = CRYPTO_zalloc(sizeof(QUIC_ENGINE), "../ssl/quic/quic_engine.c", 30)) == 
# 30 "../ssl/quic/quic_engine.c" 3 4
                                                       ((void *)0)
# 30 "../ssl/quic/quic_engine.c"
                                                           )
        return 
# 31 "../ssl/quic/quic_engine.c" 3 4
              ((void *)0)
# 31 "../ssl/quic/quic_engine.c"
                  ;
    ...
    if (!qeng_init(qeng)) {
        CRYPTO_free(qeng, "../ssl/quic/quic_engine.c", 40);
        return 
# 41 "../ssl/quic/quic_engine.c" 3 4
              ((void *)0)
# 41 "../ssl/quic/quic_engine.c"
                  ;
    }
...
{
    if (qeng == 
# 49 "../ssl/quic/quic_engine.c" 3 4
               ((void *)0)
# 49 "../ssl/quic/quic_engine.c"
                   )
        return;

    qeng_cleanup(qeng);
    CRYPTO_free(qeng, "../ssl/quic/quic_engine.c", 53);
}
...
# 64 "../ssl/quic/quic_engine.c" 3 4
   ((void) (0))
# 64 "../ssl/quic/quic_engine.c"
                                                    ;
}
...
{
    if (qeng->now_cb == 
# 79 "../ssl/quic/quic_engine.c" 3 4
                       ((void *)0)
# 79 "../ssl/quic/quic_engine.c"
                           )
                                        ...
                                        const QUIC_PORT_ARGS *args)
{
    ...
    if (ossl_list_port_num(&qeng->port_list) > 0)
        ...
        return 
# 102 "../ssl/quic/quic_engine.c" 3 4
              ((void *)0)
# 102 "../ssl/quic/quic_engine.c"
                  ;

    if (largs.engine != 
# 104 "../ssl/quic/quic_engine.c" 3 4
                       ((void *)0)
# 104 "../ssl/quic/quic_engine.c"
                           )
        return 
# 105 "../ssl/quic/quic_engine.c" 3 4
              ((void *)0)
# 105 "../ssl/quic/quic_engine.c"
                  ;

    largs.engine = qeng;
    return ossl_quic_port_new(&largs);
}
# 121 "../ssl/quic/quic_engine.c"
static void qeng_tick(QUIC_TICK_RESULT *res, void *arg, uint32_t flags)
{
    ...
    for ((port) = (ossl_list_port_head(&qeng->port_list)); (port) != 
# 134 "../ssl/quic/quic_engine.c" 3 4
   ((void *)0)
# 134 "../ssl/quic/quic_engine.c"
   ; (port) = ossl_list_port_next(port)) {
