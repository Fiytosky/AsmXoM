# 0 "../ssl/quic/cc_newreno.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/cc_newreno.c"
...
# 13 "../include/internal/quic_cc.h" 2
...
# 5 "../ssl/quic/cc_newreno.c" 3 4
((void *)0) 
# 5 "../ssl/quic/cc_newreno.c"
                                 ...
                                 void *now_cb_arg)
{
    ...
    if ((nr = CRYPTO_zalloc(sizeof(*nr), "../ssl/quic/cc_newreno.c", 52)) == 
# 52 "../ssl/quic/cc_newreno.c" 3 4
                                             ((void *)0)
# 52 "../ssl/quic/cc_newreno.c"
                                                 )
        return 
# 53 "../ssl/quic/cc_newreno.c" 3 4
              ((void *)0)
# 53 "../ssl/quic/cc_newreno.c"
                  ;

    nr->now_cb = now_cb;
    nr->now_cb_arg = now_cb_arg;

    newreno_set_max_dgram_size(nr, 1200);
...
{
    CRYPTO_free(cc, "../ssl/quic/cc_newreno.c", 66);
}
...
# 104 "../ssl/quic/cc_newreno.c" 3 4
                                     (18446744073709551615UL)
# 104 "../ssl/quic/cc_newreno.c"
                                               ;
...
static int newreno_set_input_params(OSSL_CC_DATA *cc, const OSSL_PARAM *params)
{
    ...
    p = OSSL_PARAM_locate_const(params, "max_dgram_payload_len");
    if (p != 
# 119 "../ssl/quic/cc_newreno.c" 3 4
            ((void *)0)
# 119 "../ssl/quic/cc_newreno.c"
                ) {
                     ...
                     void **pp)
{
    ...
    *pp = 
# 136 "../ssl/quic/cc_newreno.c" 3 4
         ((void *)0)
# 136 "../ssl/quic/cc_newreno.c"
             ;

    if (p == 
# 138 "../ssl/quic/cc_newreno.c" 3 4
            ((void *)0)
# 138 "../ssl/quic/cc_newreno.c"
                )
        return 1;
...
static int newreno_bind_diagnostic(OSSL_CC_DATA *cc, OSSL_PARAM *params)
{
    ...
    if (!bind_diag(params, "max_dgram_payload_len",
                   sizeof(size_t), (void **)&new_p_max_dgram_payload_len)
        || !bind_diag(params, "cur_cwnd_size",
                      sizeof(uint64_t), (void **)&new_p_cur_cwnd_size)
        || !bind_diag(params, "min_cwnd_size",
                      sizeof(uint64_t), (void **)&new_p_min_cwnd_size)
        || !bind_diag(params, "bytes_in_flight",
                      sizeof(uint64_t), (void **)&new_p_cur_bytes_in_flight)
        || !bind_diag(params, "cur_state",
                      sizeof(uint32_t), (void **)&new_p_cur_state))
        return 0;

    if (new_p_max_dgram_payload_len != 
# 170 "../ssl/quic/cc_newreno.c" 3 4
                                      ((void *)0)
# 170 "../ssl/quic/cc_newreno.c"
                                          )
        nr->p_diag_max_dgram_payload_len = new_p_max_dgram_payload_len;

    if (new_p_cur_cwnd_size != 
# 173 "../ssl/quic/cc_newreno.c" 3 4
                              ((void *)0)
# 173 "../ssl/quic/cc_newreno.c"
                                  )
        nr->p_diag_cur_cwnd_size = new_p_cur_cwnd_size;

    if (new_p_min_cwnd_size != 
# 176 "../ssl/quic/cc_newreno.c" 3 4
                              ((void *)0)
# 176 "../ssl/quic/cc_newreno.c"
                                  )
        nr->p_diag_min_cwnd_size = new_p_min_cwnd_size;

    if (new_p_cur_bytes_in_flight != 
# 179 "../ssl/quic/cc_newreno.c" 3 4
                                    ((void *)0)
# 179 "../ssl/quic/cc_newreno.c"
                                        )
        nr->p_diag_cur_bytes_in_flight = new_p_cur_bytes_in_flight;

    if (new_p_cur_state != 
# 182 "../ssl/quic/cc_newreno.c" 3 4
                          ((void *)0)
# 182 "../ssl/quic/cc_newreno.c"
                              )
                        ...
                        void **pp)
{
    ...
    if (p != 
# 194 "../ssl/quic/cc_newreno.c" 3 4
            ((void *)0)
# 194 "../ssl/quic/cc_newreno.c"
                )
        *pp = 
# 195 "../ssl/quic/cc_newreno.c" 3 4
             ((void *)0)
# 195 "../ssl/quic/cc_newreno.c"
                 ;
}
...
static int newreno_unbind_diagnostic(OSSL_CC_DATA *cc, OSSL_PARAM *params)
{
    ...
    unbind_diag(params, "max_dgram_payload_len",
                (void **)&nr->p_diag_max_dgram_payload_len);
    unbind_diag(params, "cur_cwnd_size",
                (void **)&nr->p_diag_cur_cwnd_size);
    unbind_diag(params, "min_cwnd_size",
                (void **)&nr->p_diag_min_cwnd_size);
    unbind_diag(params, "bytes_in_flight",
                (void **)&nr->p_diag_cur_bytes_in_flight);
    unbind_diag(params, "cur_state",
...
static void newreno_update_diag(OSSL_CC_NEWRENO *nr)
{
    if (nr->p_diag_max_dgram_payload_len != 
# 217 "../ssl/quic/cc_newreno.c" 3 4
                                           ((void *)0)
# 217 "../ssl/quic/cc_newreno.c"
                                               )
        *nr->p_diag_max_dgram_payload_len = nr->max_dgram_size;

    if (nr->p_diag_cur_cwnd_size != 
# 220 "../ssl/quic/cc_newreno.c" 3 4
                                   ((void *)0)
# 220 "../ssl/quic/cc_newreno.c"
                                       )
        *nr->p_diag_cur_cwnd_size = nr->cong_wnd;

    if (nr->p_diag_min_cwnd_size != 
# 223 "../ssl/quic/cc_newreno.c" 3 4
                                   ((void *)0)
# 223 "../ssl/quic/cc_newreno.c"
                                       )
        *nr->p_diag_min_cwnd_size = nr->k_min_wnd;

    if (nr->p_diag_cur_bytes_in_flight != 
# 226 "../ssl/quic/cc_newreno.c" 3 4
                                         ((void *)0)
# 226 "../ssl/quic/cc_newreno.c"
                                             )
        *nr->p_diag_cur_bytes_in_flight = nr->bytes_in_flight;

    if (nr->p_diag_cur_state != 
# 229 "../ssl/quic/cc_newreno.c" 3 4
                               ((void *)0)
# 229 "../ssl/quic/cc_newreno.c"
                                   ) {
...
static void newreno_cong(OSSL_CC_NEWRENO *nr, OSSL_TIME tx_time)
{
    ...
    if (err)
        nr->slow_start_thresh = 
# 264 "../ssl/quic/cc_newreno.c" 3 4
                               (18446744073709551615UL)
# 264 "../ssl/quic/cc_newreno.c"
                                         ;
...
# 360 "../ssl/quic/cc_newreno.c"
    if (!newreno_is_cong_limited(nr))
        goto out;
# 377 "../ssl/quic/cc_newreno.c"
