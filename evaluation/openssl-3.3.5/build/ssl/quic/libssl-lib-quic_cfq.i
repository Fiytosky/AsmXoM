# 0 "../ssl/quic/quic_cfq.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_cfq.c"
# 10 "../ssl/quic/quic_cfq.c"
...
static void list_remove(QUIC_CFQ_ITEM_LIST *l, QUIC_CFQ_ITEM_EX *n)
{
    ...
    if (l->tail == n)
        l->tail = n->prev;
    if (n->prev != 
# 105 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 105 "../ssl/quic/quic_cfq.c"
                      )
        n->prev->next = n->next;
    if (n->next != 
# 107 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 107 "../ssl/quic/quic_cfq.c"
                      )
        n->next->prev = n->prev;
    n->prev = n->next = 
# 109 "../ssl/quic/quic_cfq.c" 3 4
                       ((void *)0)
# 109 "../ssl/quic/quic_cfq.c"
                           ;
}
...
static void list_insert_head(QUIC_CFQ_ITEM_LIST *l, QUIC_CFQ_ITEM_EX *n)
{
    n->next = l->head;
    n->prev = 
# 115 "../ssl/quic/quic_cfq.c" 3 4
             ((void *)0)
# 115 "../ssl/quic/quic_cfq.c"
                 ;
    l->head = n;
    if (n->next != 
# 117 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 117 "../ssl/quic/quic_cfq.c"
                      )
        n->next->prev = n;
    if (l->tail == 
# 119 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 119 "../ssl/quic/quic_cfq.c"
                      )
        l->tail = n;
}
...
static void list_insert_tail(QUIC_CFQ_ITEM_LIST *l, QUIC_CFQ_ITEM_EX *n)
{
    n->prev = l->tail;
    n->next = 
# 126 "../ssl/quic/quic_cfq.c" 3 4
             ((void *)0)
# 126 "../ssl/quic/quic_cfq.c"
                 ;
    l->tail = n;
    if (n->prev != 
# 128 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 128 "../ssl/quic/quic_cfq.c"
                      )
        n->prev->next = n;
    if (l->head == 
# 130 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0)
# 130 "../ssl/quic/quic_cfq.c"
                      )
        l->head = n;
}
                              ...
                              QUIC_CFQ_ITEM_EX *n)
{
    ...
    n->next = ref->next;
    if (ref->next != 
# 140 "../ssl/quic/quic_cfq.c" 3 4
                    ((void *)0)
# 140 "../ssl/quic/quic_cfq.c"
                        )
        ref->next->prev = n;
    ref->next = n;
    if (l->tail == ref)
...
{
    QUIC_CFQ_ITEM_EX *p = l->head, *pprev = 
# 151 "../ssl/quic/quic_cfq.c" 3 4
                                           ((void *)0)
# 151 "../ssl/quic/quic_cfq.c"
                                               ;

    if (p == 
# 153 "../ssl/quic/quic_cfq.c" 3 4
            ((void *)0)
# 153 "../ssl/quic/quic_cfq.c"
                ) {
        l->head = l->tail = n;
        n->prev = n->next = 
# 155 "../ssl/quic/quic_cfq.c" 3 4
                           ((void *)0)
# 155 "../ssl/quic/quic_cfq.c"
                               ;
        return;
    }

    for (; p != 
# 159 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0) 
# 159 "../ssl/quic/quic_cfq.c"
                    && cmp(p, n) < 0; pprev = p, p = p->next);

    if (p == 
# 161 "../ssl/quic/quic_cfq.c" 3 4
            ((void *)0)
# 161 "../ssl/quic/quic_cfq.c"
                )
        list_insert_tail(l, n);
    else if (pprev == 
# 163 "../ssl/quic/quic_cfq.c" 3 4
                     ((void *)0)
# 163 "../ssl/quic/quic_cfq.c"
                         )
...
QUIC_CFQ *ossl_quic_cfq_new(void)
{
    QUIC_CFQ *cfq = CRYPTO_zalloc(sizeof(*cfq), "../ssl/quic/quic_cfq.c", 171);

    if (cfq == 
# 173 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 173 "../ssl/quic/quic_cfq.c"
                  )
        return 
# 174 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 174 "../ssl/quic/quic_cfq.c"
                  ;
...
{
    if (item->free_cb != 
# 181 "../ssl/quic/quic_cfq.c" 3 4
                        ((void *)0)
# 181 "../ssl/quic/quic_cfq.c"
                            ) {
        item->free_cb(item->encoded, item->encoded_len, item->free_cb_arg);

        item->free_cb = 
# 184 "../ssl/quic/quic_cfq.c" 3 4
                             ((void *)0)
# 184 "../ssl/quic/quic_cfq.c"
                                 ;
        item->encoded = 
# 185 "../ssl/quic/quic_cfq.c" 3 4
                             ((void *)0)
# 185 "../ssl/quic/quic_cfq.c"
                                 ;
        item->encoded_len = 0;
    }
...
static void free_list_items(QUIC_CFQ_ITEM_LIST *l)
{
    ...
    for (p = l->head; p != 
# 196 "../ssl/quic/quic_cfq.c" 3 4
                          ((void *)0)
# 196 "../ssl/quic/quic_cfq.c"
                              ; p = pnext) {
        pnext = p->next;
        clear_item(p);
        CRYPTO_free(p, "../ssl/quic/quic_cfq.c", 199);
    }
}
...
{
    if (cfq == 
# 205 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 205 "../ssl/quic/quic_cfq.c"
                  )
        return;
    ...
    CRYPTO_free(cfq, "../ssl/quic/quic_cfq.c", 211);
}
...
static QUIC_CFQ_ITEM_EX *cfq_get_free(QUIC_CFQ *cfq)
{
    ...
    if (item != 
# 218 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0)
# 218 "../ssl/quic/quic_cfq.c"
                   )
        return item;

    item = CRYPTO_zalloc(sizeof(*item), "../ssl/quic/quic_cfq.c", 221);
    if (item == 
# 222 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0)
# 222 "../ssl/quic/quic_cfq.c"
                   )
        return 
# 223 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 223 "../ssl/quic/quic_cfq.c"
                  ;
                                       ...
                                       void *free_cb_arg)
{
    ...
    if (item == 
# 242 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0)
# 242 "../ssl/quic/quic_cfq.c"
                   )
        return 
# 243 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 243 "../ssl/quic/quic_cfq.c"
                  ;
...
# 273 "../ssl/quic/quic_cfq.c" 3 4
       ((void) (0))
# 273 "../ssl/quic/quic_cfq.c"
                ;
        break;
    }
}
                             ...
                             uint32_t priority)
{
    ...
    case 0:
        if (priority != 
# 290 "../ssl/quic/quic_cfq.c" 3 4
                       (4294967295U) 
# 290 "../ssl/quic/quic_cfq.c"
    ...
    case 1:
        if (priority != 
# 297 "../ssl/quic/quic_cfq.c" 3 4
                       (4294967295U)
# 297 "../ssl/quic/quic_cfq.c"
                                 )
            ex->priority = priority;
...
# 304 "../ssl/quic/quic_cfq.c" 3 4
       ((void) (0))
# 304 "../ssl/quic/quic_cfq.c"
                ;
        break;
    }
}
...
# 329 "../ssl/quic/quic_cfq.c" 3 4
       ((void) (0))
# 329 "../ssl/quic/quic_cfq.c"
                ;
        break;
    }
}
                                               ...
                                               uint32_t pn_space)
{
    ...
    for (; item != 
# 339 "../ssl/quic/quic_cfq.c" 3 4
                  ((void *)0) 
# 339 "../ssl/quic/quic_cfq.c"
                       && item->pn_space != pn_space; item = item->next);

    if (item == 
# 341 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0)
# 341 "../ssl/quic/quic_cfq.c"
                   )
        return 
# 342 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 342 "../ssl/quic/quic_cfq.c"
                  ;
                                                    ...
                                                    uint32_t pn_space)
{
    ...
    if (ex == 
# 352 "../ssl/quic/quic_cfq.c" 3 4
             ((void *)0)
# 352 "../ssl/quic/quic_cfq.c"
                 )
        return 
# 353 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 353 "../ssl/quic/quic_cfq.c"
                  ;

     ex = ex->next;

     for (; ex != 
# 357 "../ssl/quic/quic_cfq.c" 3 4
                 ((void *)0) 
# 357 "../ssl/quic/quic_cfq.c"
                      && ex->pn_space != pn_space; ex = ex->next);

     if (ex == 
# 359 "../ssl/quic/quic_cfq.c" 3 4
              ((void *)0)
# 359 "../ssl/quic/quic_cfq.c"
                  )
         return 
# 360 "../ssl/quic/quic_cfq.c" 3 4
               ((void *)0)
# 360 "../ssl/quic/quic_cfq.c"
                   ;
