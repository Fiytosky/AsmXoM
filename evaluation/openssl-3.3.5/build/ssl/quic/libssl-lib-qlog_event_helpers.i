# 0 "../ssl/quic/qlog_event_helpers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/qlog_event_helpers.c"
# 10 "../ssl/quic/qlog_event_helpers.c"
# 1 "../include/internal/qlog_event_helpers.h" 1
# 13 "../include/internal/qlog_event_helpers.h"
...
# 14 "../include/internal/qlog_event_helpers.h" 2
...
# 15 "../include/internal/qlog_event_helpers.h" 2
...
# 26 "../include/internal/quic_record_tx.h"
...
void ossl_qlog_event_transport_packet_received(QLOG *qlog,
                                               ...
                                               size_t numn_iovec,
                                               uint64_t datagram_id);
# 11 "../ssl/quic/qlog_event_helpers.c" 2
...
# 15 "../ssl/quic/qlog_event_helpers.c" 2

void ossl_qlog_event_connectivity_connection_started(QLOG *qlog,
                                                     const QUIC_CONN_ID *init_dcid)
{

    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_connectivity_connection_started; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "connectivity", "connection_started", "connectivity" ":" "connection_started")) {
        ossl_qlog_str(qlog_instance, ("protocol"), ("quic"));
        ossl_qlog_bin(qlog_instance, (("dst_cid")), ((init_dcid)->id), ((init_dcid)->id_len));
                                     ...
                                     int handshake_confirmed)
{
    ...
    case 0:
        return 
# 35 "../ssl/quic/qlog_event_helpers.c" 3 4
              ((void *)0)
# 35 "../ssl/quic/qlog_event_helpers.c"
                  ;
                                                           ...
                                                           int handshake_confirmed)
{
    ...
    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_connectivity_connection_state_updated; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "connectivity", "connection_state_updated", "connectivity" ":" "connection_state_updated")) {
        state_s = map_state_to_qlog(new_state,
                                    handshake_complete,
                                    handshake_confirmed);

        if (state_s != 
# 71 "../ssl/quic/qlog_event_helpers.c" 3 4
                      ((void *)0)
# 71 "../ssl/quic/qlog_event_helpers.c"
                          )
            ossl_qlog_str(qlog_instance, ("state"), (state_s));
    ossl_qlog_event_end(qlog_instance); } }
...
static const char *quic_err_to_qlog(uint64_t error_code)
{
    ...
    default:
        return 
# 114 "../ssl/quic/qlog_event_helpers.c" 3 4
              ((void *)0)
# 114 "../ssl/quic/qlog_event_helpers.c"
                  ;
    }
}
                                                    ...
                                                    const QUIC_TERMINATE_CAUSE *tcause)
{
    ...
    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_connectivity_connection_closed; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "connectivity", "connection_closed", "connectivity" ":" "connection_closed")) {
        ossl_qlog_str(qlog_instance, ("owner"), (tcause->remote ? "remote" : "local"));
        if (tcause->app) {
            ossl_qlog_u64(qlog_instance, ("application_code"), (tcause->error_code));
        } else {
            const char *m = quic_err_to_qlog(tcause->error_code);
            char ce[32];

            if (tcause->error_code >= 0x0100
                && tcause->error_code <= 0x01FF) {
            ...
            if (m != 
# 139 "../ssl/quic/qlog_event_helpers.c" 3 4
                    ((void *)0)
# 139 "../ssl/quic/qlog_event_helpers.c"
                        )
                ossl_qlog_str(qlog_instance, ("connection_code"), (m));
            else
                ossl_qlog_u64(qlog_instance, ("connection_code"), (tcause->error_code));
        }

        ossl_qlog_str_len(qlog_instance, ("reason"), (tcause->reason), (tcause->reason_len));
    ossl_qlog_event_end(qlog_instance); } }
                                          ...
                                          const QUIC_TXPIM_PKT *tpkt)
{
    ...
    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_recovery_packet_lost; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "recovery", "packet_lost", "recovery" ":" "packet_lost")) {
        { ossl_qlog_group_begin(qlog_instance, ("header"));
            ossl_qlog_str(qlog_instance, ("packet_type"), (quic_pkt_type_to_qlog(tpkt->pkt_type)));
            if (ossl_quic_pkt_type_has_pn(tpkt->pkt_type))
                ossl_qlog_u64(qlog_instance, ("packet_number"), (tpkt->ackm_pkt.pkt_num));
...
# 206 "../ssl/quic/qlog_event_helpers.c"
static int log_frame_actual(QLOG *qlog_instance, PACKET *pkt,
                            size_t *need_skip)
{
    uint64_t frame_type;
    OSSL_QUIC_FRAME_ACK ack;
    OSSL_QUIC_ACK_RANGE ack_ranges[32];
    uint64_t num_ranges, total_ranges;
    size_t i;
    PACKET orig_pkt = *pkt;

    if (!ossl_quic_wire_peek_frame_header(pkt, &frame_type, 
# 216 "../ssl/quic/qlog_event_helpers.c" 3 4
                                                           ((void *)0)
# 216 "../ssl/quic/qlog_event_helpers.c"
                                                               )) {
        *need_skip = 
# 217 "../ssl/quic/qlog_event_helpers.c" 3 4
                    (18446744073709551615UL)
# 217 "../ssl/quic/qlog_event_helpers.c"
                            ;
        return 0;
    }
    ...
    switch (frame_type) {
    case 0x00:
        ossl_qlog_str(qlog_instance, ("frame_type"), ("padding"));
        ossl_qlog_u64(qlog_instance, ("payload_length"), (ossl_quic_wire_decode_padding(pkt)))
                                                    ;
        break;
    case 0x01:
        ...
        ossl_qlog_str(qlog_instance, ("frame_type"), ("ping"));
        break;
    case 0x02:
    case 0x03:
        ...
        ack.num_ack_ranges = (sizeof(ack_ranges)/sizeof((ack_ranges)[0]));
        if (!ossl_quic_wire_decode_frame_ack(pkt, 3, &ack, &total_ranges))
            goto unknown;

        ossl_qlog_str(qlog_instance, ("frame_type"), ("ack"));
        ossl_qlog_u64(qlog_instance, ("ack_delay"), ((ossl_time2ticks(ack.delay_time) / (((uint64_t)1000000000) / 1000))));
        if (ack.ecn_present) {
            ossl_qlog_u64(qlog_instance, ("ect1"), (ack.ect0));
            ossl_qlog_u64(qlog_instance, ("ect0"), (ack.ect1));
            ossl_qlog_u64(qlog_instance, ("ce"), (ack.ecnce));
        }
        { ossl_qlog_array_begin(qlog_instance, ("acked_ranges"));;
        for (i = 0; i < ack.num_ack_ranges; ++i) {
            { ossl_qlog_array_begin(qlog_instance, (
# 257 "../ssl/quic/qlog_event_helpers.c" 3 4
           ((void *)0)
# 257 "../ssl/quic/qlog_event_helpers.c"
           ));
                ossl_qlog_u64(qlog_instance, (
# 258 "../ssl/quic/qlog_event_helpers.c" 3 4
               ((void *)0)
# 258 "../ssl/quic/qlog_event_helpers.c"
               ), (ack.ack_ranges[i].start));
                if (ack.ack_ranges[i].end != ack.ack_ranges[i].start)
                    ossl_qlog_u64(qlog_instance, (
# 260 "../ssl/quic/qlog_event_helpers.c" 3 4
                   ((void *)0)
# 260 "../ssl/quic/qlog_event_helpers.c"
                   ), (ack.ack_ranges[i].end));
    ...
    case 0x04:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("reset_stream"));
            ossl_qlog_u64(qlog_instance, ("stream_id"), (f.stream_id));
            ossl_qlog_u64(qlog_instance, ("error_code"), (f.app_error_code));
            ossl_qlog_u64(qlog_instance, ("final_size"), (f.final_size));
        }
        break;
    case 0x05:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("stop_sending"));
            ossl_qlog_u64(qlog_instance, ("stream_id"), (f.stream_id));
            ossl_qlog_u64(qlog_instance, ("error_code"), (f.app_error_code));
        }
        break;
    case 0x06:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("crypto"));
            ossl_qlog_u64(qlog_instance, ("offset"), (f.offset));
            ossl_qlog_u64(qlog_instance, ("payload_length"), (f.len));
    ...
    case (0x08 | 0x04 | 0x02 | 0x01):
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("stream"));
            ossl_qlog_u64(qlog_instance, ("stream_id"), (f.stream_id));
            ossl_qlog_u64(qlog_instance, ("offset"), (f.offset));
            ossl_qlog_u64(qlog_instance, ("payload_length"), (f.len));
            ossl_qlog_bool(qlog_instance, ("explicit_length"), (f.has_explicit_len));
            if (f.is_fin)
                ossl_qlog_bool(qlog_instance, ("fin"), (1));
            *need_skip = f.has_explicit_len
                ? *need_skip + (size_t)f.len : 
# 325 "../ssl/quic/qlog_event_helpers.c" 3 4
                                              (18446744073709551615UL)
# 325 "../ssl/quic/qlog_event_helpers.c"
                                                      ;
        }
        break;
    case 0x10:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("max_data"));
            ossl_qlog_u64(qlog_instance, ("maximum"), (x));
        }
        break;
    case 0x12:
    case 0x13:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("max_streams"));
            ossl_qlog_str(qlog_instance, ("stream_type"), (frame_type == 0x12 ? "bidirectional" : "unidirectional"))
    ...
    case 0x11:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("max_stream_data"));
            ossl_qlog_u64(qlog_instance, ("stream_id"), (stream_id));
            ossl_qlog_u64(qlog_instance, ("maximum"), (max_data));
        }
        break;
    case 0x1A:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("path_challenge"));
        }
        break;
    case 0x1B:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("path_response"));
        }
        break;
    case 0x1D:
    case 0x1C:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("connection_close"));
            ossl_qlog_str(qlog_instance, ("error_space"), (f.is_app ? "application" : "transport"));
            ossl_qlog_u64(qlog_instance, ("error_code_value"), (f.error_code));
            if (f.is_app)
                ossl_qlog_u64(qlog_instance, ("error_code"), (f.error_code));
            if (!f.is_app && f.frame_type != 0)
                ossl_qlog_u64(qlog_instance, ("trigger_frame_type"), (f.frame_type));
            ossl_qlog_str_len(qlog_instance, ("reason"), (f.reason), (f.reason_len));
        }
        break;
    case 0x1E:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("handshake_done"));
        }
        break;
    case 0x18:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("new_connection_id"));
            ossl_qlog_u64(qlog_instance, ("sequence_number"), (f.seq_num));
            ossl_qlog_u64(qlog_instance, ("retire_prior_to"), (f.retire_prior_to));
            ossl_qlog_bin(qlog_instance, (("connection_id")), ((&f.conn_id)->id), ((&f.conn_id)->id_len));
            ossl_qlog_bin(qlog_instance, ("stateless_reset_token"), (f.stateless_reset.token), (sizeof(f.stateless_reset.token)))
    ...
    case 0x19:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("retire_connection_id"));
            ossl_qlog_u64(qlog_instance, ("sequence_number"), (seq_num));
        }
        break;
    case 0x14:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("data_blocked"));
            ossl_qlog_u64(qlog_instance, ("limit"), (x));
        }
        break;
    case 0x15:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("stream_data_blocked"));
            ossl_qlog_u64(qlog_instance, ("stream_id"), (stream_id));
            ossl_qlog_u64(qlog_instance, ("limit"), (x));
        }
        break;
    ...
    case 0x17:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("streams_blocked"));
            ossl_qlog_str(qlog_instance, ("stream_type"), (frame_type == 0x16 ? "bidirectional" : "unidirectional"))
    ...
    case 0x07:
        {
            ...
            ossl_qlog_str(qlog_instance, ("frame_type"), ("new_token"));
            { ossl_qlog_group_begin(qlog_instance, ("token"));;
                { ossl_qlog_group_begin(qlog_instance, ("raw"));;
                    ossl_qlog_bin(qlog_instance, ("data"), (token), (token_len));
                ossl_qlog_group_end(qlog_instance); };
            ossl_qlog_group_end(qlog_instance); };
        }
        break;
    default:
unknown:
        ossl_qlog_str(qlog_instance, ("frame_type"), ("unknown"));
        ossl_qlog_u64(qlog_instance, ("frame_type_value"), (frame_type));
        ...
        { ossl_qlog_group_begin(qlog_instance, ("raw"));;
            ossl_qlog_bin(qlog_instance, ("data"), (PACKET_data(&orig_pkt)), (PACKET_remaining(&orig_pkt)))
                                                 ;
        ossl_qlog_group_end(qlog_instance); };
                      ...
                      size_t *need_skip)
{
    ...
    ossl_qlog_u64(qlog_instance, ("length"), (rem_before - rem_after));
}
                      ...
                      size_t num_iovec)
{
    ...
    for (i = 0; i < num_iovec; ++i) {
        ...
        while (PACKET_remaining(&pkt) > 0) {
            ...
            { ossl_qlog_group_begin(qlog_instance, (
# 557 "../ssl/quic/qlog_event_helpers.c" 3 4
           ((void *)0)
# 557 "../ssl/quic/qlog_event_helpers.c"
           ));
            {
                       ...
                       uint64_t datagram_id)
{
    ...
    { ossl_qlog_group_begin(qlog_instance, ("header"));
        ...
        if (type_s == 
# 579 "../ssl/quic/qlog_event_helpers.c" 3 4
                     ((void *)0)
# 579 "../ssl/quic/qlog_event_helpers.c"
                         )
            type_s = "unknown";

        ossl_qlog_str(qlog_instance, ("packet_type"), (type_s));
        if (ossl_quic_pkt_type_has_pn(hdr->type))
            ossl_qlog_u64(qlog_instance, ("packet_number"), (pn));

        ossl_qlog_bin(qlog_instance, (("dcid")), ((&hdr->dst_conn_id)->id), ((&hdr->dst_conn_id)->id_len));
        if (ossl_quic_pkt_type_has_scid(hdr->type))
            ossl_qlog_bin(qlog_instance, (("scid")), ((&hdr->src_conn_id)->id), ((&hdr->src_conn_id)->id_len));

        if (hdr->token_len > 0) {
            { ossl_qlog_group_begin(qlog_instance, ("token"));
                { ossl_qlog_group_begin(qlog_instance, ("raw"));
                    ossl_qlog_bin(qlog_instance, ("data"), (hdr->token), (hdr->token_len));
                ossl_qlog_group_end(qlog_instance); }
            ossl_qlog_group_end(qlog_instance); }
        }

    ossl_qlog_group_end(qlog_instance); }
    ossl_qlog_u64(qlog_instance, ("datagram_id"), (datagram_id));

    if (ossl_quic_pkt_type_is_encrypted(hdr->type)) {
        { ossl_qlog_array_begin(qlog_instance, ("frames"));
                                           ...
                                           uint64_t datagram_id)
{
    ...
    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_transport_packet_sent; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "transport", "packet_sent", "transport" ":" "packet_sent")) {
                                               ...
                                               uint64_t datagram_id)
{
    ...
    { QLOG *qlog_instance = (qlog); uint32_t qlog_event_type = QLOG_EVENT_TYPE_transport_packet_received; if (ossl_qlog_event_try_begin(qlog_instance, qlog_event_type, "transport", "packet_received", "transport" ":" "packet_received")) {
        log_packet(qlog, hdr, pn, iovec, num_iovec, datagram_id);
    ossl_qlog_event_end(qlog_instance); } }
