# 0 "../ssl/quic/quic_txpim.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_txpim.c"
# 10 "../ssl/quic/quic_txpim.c"
...
QUIC_TXPIM *ossl_quic_txpim_new(void)
{
    QUIC_TXPIM *txpim = CRYPTO_zalloc(sizeof(*txpim), "../ssl/quic/quic_txpim.c", 36);

    if (txpim == 
# 38 "../ssl/quic/quic_txpim.c" 3 4
                ((void *)0)
# 38 "../ssl/quic/quic_txpim.c"
                    )
        return 
# 39 "../ssl/quic/quic_txpim.c" 3 4
              ((void *)0)
# 39 "../ssl/quic/quic_txpim.c"
                  ;
...
static void free_list(QUIC_TXPIM_PKT_EX_LIST *l)
{
    ...
    for (n = l->head; n != 
# 48 "../ssl/quic/quic_txpim.c" 3 4
                          ((void *)0)
# 48 "../ssl/quic/quic_txpim.c"
                              ; n = nnext) {
        nnext = n->next;

        CRYPTO_free(n->chunks, "../ssl/quic/quic_txpim.c", 51);
        CRYPTO_free(n, "../ssl/quic/quic_txpim.c", 52);
    }

    l->head = l->tail = 
# 55 "../ssl/quic/quic_txpim.c" 3 4
                       ((void *)0)
# 55 "../ssl/quic/quic_txpim.c"
                           ;
}
...
{
    if (txpim == 
# 60 "../ssl/quic/quic_txpim.c" 3 4
                ((void *)0)
# 60 "../ssl/quic/quic_txpim.c"
                    )
        return;

    
# 63 "../ssl/quic/quic_txpim.c" 3 4
   ((void) (0))
# 63 "../ssl/quic/quic_txpim.c"
                             ;
    free_list(&txpim->free_list);
    CRYPTO_free(txpim, "../ssl/quic/quic_txpim.c", 65);
}
...
static void list_remove(QUIC_TXPIM_PKT_EX_LIST *l, QUIC_TXPIM_PKT_EX *n)
{
    ...
    if (l->tail == n)
        l->tail = n->prev;
    if (n->prev != 
# 74 "../ssl/quic/quic_txpim.c" 3 4
                  ((void *)0)
# 74 "../ssl/quic/quic_txpim.c"
                      )
        n->prev->next = n->next;
    if (n->next != 
# 76 "../ssl/quic/quic_txpim.c" 3 4
                  ((void *)0)
# 76 "../ssl/quic/quic_txpim.c"
                      )
        n->next->prev = n->prev;
    n->prev = n->next = 
# 78 "../ssl/quic/quic_txpim.c" 3 4
                       ((void *)0)
# 78 "../ssl/quic/quic_txpim.c"
                           ;
}
...
static void list_insert_tail(QUIC_TXPIM_PKT_EX_LIST *l, QUIC_TXPIM_PKT_EX *n)
{
    n->prev = l->tail;
    n->next = 
# 84 "../ssl/quic/quic_txpim.c" 3 4
             ((void *)0)
# 84 "../ssl/quic/quic_txpim.c"
                 ;
    l->tail = n;
    if (n->prev != 
# 86 "../ssl/quic/quic_txpim.c" 3 4
                  ((void *)0)
# 86 "../ssl/quic/quic_txpim.c"
                      )
        n->prev->next = n;
    if (l->head == 
# 88 "../ssl/quic/quic_txpim.c" 3 4
                  ((void *)0)
# 88 "../ssl/quic/quic_txpim.c"
                      )
        l->head = n;
}
...
static QUIC_TXPIM_PKT_EX *txpim_get_free(QUIC_TXPIM *txpim)
{
    ...
    if (ex != 
# 96 "../ssl/quic/quic_txpim.c" 3 4
             ((void *)0)
# 96 "../ssl/quic/quic_txpim.c"
                 )
        return ex;

    ex = CRYPTO_zalloc(sizeof(*ex), "../ssl/quic/quic_txpim.c", 99);
    if (ex == 
# 100 "../ssl/quic/quic_txpim.c" 3 4
             ((void *)0)
# 100 "../ssl/quic/quic_txpim.c"
                 )
        return 
# 101 "../ssl/quic/quic_txpim.c" 3 4
              ((void *)0)
# 101 "../ssl/quic/quic_txpim.c"
                  ;
...
static void txpim_clear(QUIC_TXPIM_PKT_EX *ex)
{
    ...
    ex->public.retx_head = 
# 111 "../ssl/quic/quic_txpim.c" 3 4
                                            ((void *)0)
# 111 "../ssl/quic/quic_txpim.c"
                                                ;
    ex->public.fifd = 
# 112 "../ssl/quic/quic_txpim.c" 3 4
                                            ((void *)0)
# 112 "../ssl/quic/quic_txpim.c"
                                                ;
...
QUIC_TXPIM_PKT *ossl_quic_txpim_pkt_alloc(QUIC_TXPIM *txpim)
{
    ...
    if (ex == 
# 125 "../ssl/quic/quic_txpim.c" 3 4
             ((void *)0)
# 125 "../ssl/quic/quic_txpim.c"
                 )
        return 
# 126 "../ssl/quic/quic_txpim.c" 3 4
              ((void *)0)
# 126 "../ssl/quic/quic_txpim.c"
                  ;
...
# 138 "../ssl/quic/quic_txpim.c" 3 4
   ((void) (0))
# 138 "../ssl/quic/quic_txpim.c"
                            ;
    --txpim->in_use;
    list_insert_tail(&txpim->free_list, ex);
}
                                      ...
                                      QUIC_CFQ_ITEM *item)
{
    ...
    item->pkt_prev = 
# 147 "../ssl/quic/quic_txpim.c" 3 4
                    ((void *)0)
# 147 "../ssl/quic/quic_txpim.c"
                        ;
    fpkt->retx_head = item;
}
                                     ...
                                     const QUIC_TXPIM_CHUNK *chunk)
{
    ...
    if (ex->num_chunks == ex->alloc_chunks) {
        ...
        if (new_alloc_chunks > 512)
            new_alloc_chunks = 512;
        if (ex->num_chunks == new_alloc_chunks)
            return 0;

        new_chunk = CRYPTO_realloc(ex->chunks, new_alloc_chunks * sizeof(QUIC_TXPIM_CHUNK), "../ssl/quic/quic_txpim.c", 172)
                                                                                ;
        if (new_chunk == 
# 174 "../ssl/quic/quic_txpim.c" 3 4
                        ((void *)0)
# 174 "../ssl/quic/quic_txpim.c"
                            )
            return 0;
