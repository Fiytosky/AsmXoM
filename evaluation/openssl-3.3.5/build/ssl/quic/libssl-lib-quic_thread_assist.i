# 0 "../ssl/quic/quic_thread_assist.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_thread_assist.c"
# 10 "../ssl/quic/quic_thread_assist.c"
...
# 11 "../ssl/quic/quic_thread_assist.c" 2
...
# 12 "../ssl/quic/quic_thread_assist.c" 2
# 20 "../ssl/quic/quic_thread_assist.c"
static unsigned int assist_thread_main(void *arg)
{
    ...
    for (;;) {
        ...
        if (qta->now_cb != 
# 37 "../ssl/quic/quic_thread_assist.c" 3 4
                          ((void *)0)
                
# 38 "../ssl/quic/quic_thread_assist.c"
...
# 61 "../ssl/quic/quic_thread_assist.c"
        if (qta->teardown)
            break;

        ossl_quic_reactor_tick(rtor, (1U << 0));
    }
                                       ...
                                       void *now_cb_arg)
{
    ...
    if (mutex == 
# 78 "../ssl/quic/quic_thread_assist.c" 3 4
                ((void *)0)
# 78 "../ssl/quic/quic_thread_assist.c"
                    )
        return 0;
    ...
    if (qta->cv == 
# 88 "../ssl/quic/quic_thread_assist.c" 3 4
                  ((void *)0)
# 88 "../ssl/quic/quic_thread_assist.c"
                      )
        return 0;
    ...
    qta->t = ossl_crypto_thread_native_start(assist_thread_main,
                                             qta, 1);
    if (qta->t == 
# 93 "../ssl/quic/quic_thread_assist.c" 3 4
                 ((void *)0)
# 93 "../ssl/quic/quic_thread_assist.c"
                     ) {
...
int ossl_quic_thread_assist_cleanup(QUIC_THREAD_ASSIST *qta)
{
    if (!__builtin_expect(!!((qta->joined) != 0), 1))
        return 0;
    ...
    qta->ch = 
# 143 "../ssl/quic/quic_thread_assist.c" 3 4
                 ((void *)0)
# 143 "../ssl/quic/quic_thread_assist.c"
                     ;
    qta->t = 
# 144 "../ssl/quic/quic_thread_assist.c" 3 4
                 ((void *)0)
# 144 "../ssl/quic/quic_thread_assist.c"
                     ;
    return 1;
}
