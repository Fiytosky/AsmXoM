# 0 "../ssl/quic/quic_sf_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_sf_list.c"
# 10 "../ssl/quic/quic_sf_list.c"
...
# 13 "../include/internal/uint_set.h" 2
...
# 15 "../include/internal/list.h" 2
# 1 "/usr/include/assert.h" 1 3 4
# 16 "../include/internal/list.h" 2
# 14 "../include/internal/uint_set.h" 2
...
# 12 "../ssl/quic/quic_sf_list.c" 2
# 1 "../include/internal/quic_sf_list.h" 1
# 15 "../include/internal/quic_sf_list.h"
...
# 14 "../include/internal/quic_record_rx.h" 2
...
uint64_t ossl_qrx_get_max_forged_pkt_count(OSSL_QRX *qrx,
                                           uint32_t enc_level);
# 16 "../include/internal/quic_sf_list.h" 2
...
{
    if (fl->cleanse && sf->data != 
# 23 "../ssl/quic/quic_sf_list.c" 3 4
                                  ((void *)0)
# 23 "../ssl/quic/quic_sf_list.c"
                                      )
        OPENSSL_cleanse((unsigned char *)sf->data,
                        (size_t)(sf->range.end - sf->range.start));
    ossl_qrx_pkt_release(sf->pkt);
    CRYPTO_free(sf, "../ssl/quic/quic_sf_list.c", 27);
}

static STREAM_FRAME *stream_frame_new(UINT_RANGE *range, OSSL_QRX_PKT *pkt,
                                      const unsigned char *data)
{
    STREAM_FRAME *sf = CRYPTO_zalloc(sizeof(*sf), "../ssl/quic/quic_sf_list.c", 33);

    if (sf == 
# 35 "../ssl/quic/quic_sf_list.c" 3 4
             ((void *)0)
# 35 "../ssl/quic/quic_sf_list.c"
                 )
        return 
# 36 "../ssl/quic/quic_sf_list.c" 3 4
              ((void *)0)
# 36 "../ssl/quic/quic_sf_list.c"
                  ;

    if (pkt != 
# 38 "../ssl/quic/quic_sf_list.c" 3 4
              ((void *)0)
# 38 "../ssl/quic/quic_sf_list.c"
                  )
...
void ossl_sframe_list_destroy(SFRAME_LIST *fl)
{
    ...
    for (sf = fl->head; sf != 
# 57 "../ssl/quic/quic_sf_list.c" 3 4
                             ((void *)0)
# 57 "../ssl/quic/quic_sf_list.c"
                                 ; sf = next_frame) {
        next_frame = sf->next;
                        ...
                        const unsigned char *data)
{
    ...
    if ((new_frame = stream_frame_new(range, pkt, data)) == 
# 69 "../ssl/quic/quic_sf_list.c" 3 4
                                                           ((void *)0)
# 69 "../ssl/quic/quic_sf_list.c"
                                                               )
        return 0;
    new_frame->prev = fl->tail;
    if (fl->tail != 
# 72 "../ssl/quic/quic_sf_list.c" 3 4
                   ((void *)0)
# 72 "../ssl/quic/quic_sf_list.c"
                       )
...
# 93 "../ssl/quic/quic_sf_list.c"
    if (fl->offset >= range->end)
        goto end;


    if (fl->tail == 
# 97 "../ssl/quic/quic_sf_list.c" 3 4
                   ((void *)0)
# 97 "../ssl/quic/quic_sf_list.c"
                       ) {
        fl->tail = fl->head = stream_frame_new(range, pkt, data);
        if (fl->tail == 
# 99 "../ssl/quic/quic_sf_list.c" 3 4
                       ((void *)0)
# 99 "../ssl/quic/quic_sf_list.c"
                           )
            return 0;
    ...
    prev_frame = 
# 116 "../ssl/quic/quic_sf_list.c" 3 4
                ((void *)0)
# 116 "../ssl/quic/quic_sf_list.c"
                    ;
    for (sf = fl->head; sf != 
# 117 "../ssl/quic/quic_sf_list.c" 3 4
                             ((void *)0) 
# 117 "../ssl/quic/quic_sf_list.c"
                                  && sf->range.start < range->start;
         sf = sf->next)
        prev_frame = sf;

    if (!__builtin_expect(!!((sf != 
# 121 "../ssl/quic/quic_sf_list.c" 3 4
        ((void *)0)
# 121 "../ssl/quic/quic_sf_list.c"
        ) != 0), 1))

        return 0;

    if (prev_frame != 
# 125 "../ssl/quic/quic_sf_list.c" 3 4
                     ((void *)0) 
# 125 "../ssl/quic/quic_sf_list.c"
                          && prev_frame->range.end >= range->end)
        goto end;
    ...
    if (new_frame == 
# 133 "../ssl/quic/quic_sf_list.c" 3 4
                    ((void *)0)
# 133 "../ssl/quic/quic_sf_list.c"
                        )
        return 0;

    for (next_frame = sf;
         next_frame != 
# 137 "../ssl/quic/quic_sf_list.c" 3 4
                      ((void *)0) 
# 137 "../ssl/quic/quic_sf_list.c"
                           && next_frame->range.end <= range->end;) {
        STREAM_FRAME *drop_frame = next_frame;

        next_frame = next_frame->next;
        if (next_frame != 
# 141 "../ssl/quic/quic_sf_list.c" 3 4
                         ((void *)0)
# 141 "../ssl/quic/quic_sf_list.c"
                             )
            next_frame->prev = drop_frame->prev;
        if (prev_frame != 
# 143 "../ssl/quic/quic_sf_list.c" 3 4
                         ((void *)0)
# 143 "../ssl/quic/quic_sf_list.c"
                             )
    ...
    if (next_frame != 
# 153 "../ssl/quic/quic_sf_list.c" 3 4
                     ((void *)0)
# 153 "../ssl/quic/quic_sf_list.c"
                         ) {

        if (prev_frame != 
# 155 "../ssl/quic/quic_sf_list.c" 3 4
                         ((void *)0)
            
# 156 "../ssl/quic/quic_sf_list.c"
    ...
    if (prev_frame != 
# 168 "../ssl/quic/quic_sf_list.c" 3 4
                     ((void *)0)
# 168 "../ssl/quic/quic_sf_list.c"
                         )
                          ...
                          int *fin)
{
    ...
    if (sf == 
# 188 "../ssl/quic/quic_sf_list.c" 3 4
             ((void *)0)
# 188 "../ssl/quic/quic_sf_list.c"
                 ) {
        start = fl->offset;
        sf = fl->head;
    } else {
    ...
    if (sf == 
# 198 "../ssl/quic/quic_sf_list.c" 3 4
             ((void *)0) 
# 198 "../ssl/quic/quic_sf_list.c"
                  || sf->range.start > start
        || !__builtin_expect(!!((start < sf->range.end) != 0), 1)) {
        range->end = start;
        *data = 
# 201 "../ssl/quic/quic_sf_list.c" 3 4
               ((void *)0)
# 201 "../ssl/quic/quic_sf_list.c"
                   ;
        *iter = 
# 202 "../ssl/quic/quic_sf_list.c" 3 4
               ((void *)0)
# 202 "../ssl/quic/quic_sf_list.c"
                   ;

        *fin = sf == 
# 204 "../ssl/quic/quic_sf_list.c" 3 4
                    ((void *)0) 
# 204 "../ssl/quic/quic_sf_list.c"
                         ? fl->fin : 0;
        return 0;
    }
    ...
    if (sf->data != 
# 209 "../ssl/quic/quic_sf_list.c" 3 4
                   ((void *)0)
# 209 "../ssl/quic/quic_sf_list.c"
                       )
        *data = sf->data + (start - sf->range.start);
    else
        *data = 
# 212 "../ssl/quic/quic_sf_list.c" 3 4
               ((void *)0)
# 212 "../ssl/quic/quic_sf_list.c"
                   ;
    *fin = sf->next == 
# 213 "../ssl/quic/quic_sf_list.c" 3 4
                      ((void *)0) 
# 213 "../ssl/quic/quic_sf_list.c"
                           ? fl->fin : 0;
    *iter = sf;
    return 1;
}
...
int ossl_sframe_list_drop_frames(SFRAME_LIST *fl, uint64_t limit)
{
    ...
    if (!__builtin_expect(!!((limit >= fl->offset) != 0), 1)
        || !__builtin_expect(!!((fl->tail == 
# 224 "../ssl/quic/quic_sf_list.c" 3 4
           ((void *)0) 
# 224 "../ssl/quic/quic_sf_list.c"
           || limit <= fl->tail->range.end) != 0), 1)

        || !__builtin_expect(!!((fl->tail != 
# 226 "../ssl/quic/quic_sf_list.c" 3 4
           ((void *)0) 
# 226 "../ssl/quic/quic_sf_list.c"
           || limit == fl->offset) != 0), 1)
                                               )
        return 0;
    ...
    for (sf = fl->head; sf != 
# 232 "../ssl/quic/quic_sf_list.c" 3 4
                             ((void *)0) 
# 232 "../ssl/quic/quic_sf_list.c"
                                  && sf->range.end <= limit;) {
    ...
    if (sf != 
# 241 "../ssl/quic/quic_sf_list.c" 3 4
             ((void *)0)
# 241 "../ssl/quic/quic_sf_list.c"
                 )
        sf->prev = 
# 242 "../ssl/quic/quic_sf_list.c" 3 4
                  ((void *)0)
# 242 "../ssl/quic/quic_sf_list.c"
                      ;
    else
        fl->tail = 
# 244 "../ssl/quic/quic_sf_list.c" 3 4
                  ((void *)0)
# 244 "../ssl/quic/quic_sf_list.c"
                      ;
                               ...
                               int *fin)
{
    int ret;
    void *iter = 
# 256 "../ssl/quic/quic_sf_list.c" 3 4
                ((void *)0)
# 256 "../ssl/quic/quic_sf_list.c"
                    ;
...
int ossl_sframe_list_move_data(SFRAME_LIST *fl,
                               ...
                               void *cb_arg)
{
    STREAM_FRAME *sf = fl->head, *prev_frame = 
# 276 "../ssl/quic/quic_sf_list.c" 3 4
                                              ((void *)0)
# 276 "../ssl/quic/quic_sf_list.c"
                                                  ;
    uint64_t limit = fl->offset;

    if (sf == 
# 279 "../ssl/quic/quic_sf_list.c" 3 4
             ((void *)0)
# 279 "../ssl/quic/quic_sf_list.c"
                 )
        return 1;
    ...
    for (; sf != 
# 285 "../ssl/quic/quic_sf_list.c" 3 4
                ((void *)0)
# 285 "../ssl/quic/quic_sf_list.c"
                    ; sf = sf->next) {
        size_t len;
        ...
        if (data != 
# 292 "../ssl/quic/quic_sf_list.c" 3 4
                   ((void *)0)
# 292 "../ssl/quic/quic_sf_list.c"
                       ) {
            if (limit > sf->range.start)
            ...
            sf->data = 
# 306 "../ssl/quic/quic_sf_list.c" 3 4
                      ((void *)0)
# 306 "../ssl/quic/quic_sf_list.c"
                          ;
            ossl_qrx_pkt_release(sf->pkt);
            sf->pkt = 
# 308 "../ssl/quic/quic_sf_list.c" 3 4
                     ((void *)0)
# 308 "../ssl/quic/quic_sf_list.c"
                         ;
        }
        ...
        if (prev_frame != 
# 314 "../ssl/quic/quic_sf_list.c" 3 4
                         ((void *)0)
            
# 315 "../ssl/quic/quic_sf_list.c"
           && prev_frame->range.end >= sf->range.start) {
            prev_frame->range.end = sf->range.end;
            prev_frame->next = sf->next;

            if (sf->next != 
# 319 "../ssl/quic/quic_sf_list.c" 3 4
                           ((void *)0)
# 319 "../ssl/quic/quic_sf_list.c"
                               )
