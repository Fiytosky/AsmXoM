...
# 14 "../include/internal/quic_ssl.h" 2
...
static inline __attribute__((unused)) uint64_t safe_add_uint64_t(uint64_t a, uint64_t b, int *err) { uint64_t r; if (!__builtin_add_overflow(a, b, &r)) return r; *err |= 1; return a + b; } static inline __attribute__((unused)) uint64_t safe_sub_uint64_t(uint64_t a, uint64_t b, int *err) { if (b > a) *err |= 1; return a - b; } static inline __attribute__((unused)) uint64_t safe_mul_uint64_t(uint64_t a, uint64_t b, int *err) { uint64_t r; if (!__builtin_mul_overflow(a, b, &r)) return r; *err |= 1; return a * b; } static inline __attribute__((unused)) uint64_t safe_div_uint64_t(uint64_t a, uint64_t b, int *err) { if (b != 0) return a / b; *err |= 1; return (~(uint64_t)0); } static inline __attribute__((unused)) uint64_t safe_mod_uint64_t(uint64_t a, uint64_t b, int *err) { if (b != 0) return a % b; *err |= 1; return 0; } static inline __attribute__((unused)) uint64_t safe_div_round_up_uint64_t (uint64_t a, uint64_t b, int *errp) { uint64_t x; int *err, err_local = 0; err = errp != 
# 17 "../ssl/quic/quic_wire.c" 3 4
((void *)0) 
# 17 "../ssl/quic/quic_wire.c"
? errp : &err_local; if (b > 0 && a > 0) { if (a < (~(uint64_t)0) - b) return (a + b - 1) / b; return a / b + (a % b != 0); } if (b == 0) { *err |= 1; return a == 0 ? 0 : (~(uint64_t)0); } if (a == 0) return 0; x = safe_mod_uint64_t(a, b, err); return safe_add_uint64_t(safe_div_uint64_t(a, b, err), x != 0, err); } static inline __attribute__((unused)) uint64_t safe_muldiv_uint64_t(uint64_t a, uint64_t b, uint64_t c, int *err) { int e2 = 0; uint64_t x, y; if (c == 0) { *err |= 1; return a == 0 || b == 0 ? 0 : (~(uint64_t)0); } x = safe_mul_uint64_t(a, b, &e2); if (!e2) return x / c; if (b > a) { x = b; b = a; a = x; } x = safe_mul_uint64_t(a % c, b, err); y = safe_mul_uint64_t(a / c, b, err); return safe_add_uint64_t(y, x / c, err); } static inline __attribute__((unused)) uint64_t safe_neg_uint64_t(uint64_t a, int *err) { if (a == 0) return a; *err |= 1; return 1 + ~a; } static inline __attribute__((unused)) uint64_t safe_abs_uint64_t(uint64_t a, int *err) { return a; }
...
int ossl_quic_wire_encode_frame_ping(WPACKET *pkt)
{
    return encode_frame_hdr(pkt, 0x01);
}
...
int ossl_quic_wire_encode_frame_ack(WPACKET *pkt,
                                    ...
                                    const OSSL_QUIC_FRAME_ACK *ack)
{
    uint64_t frame_type = ack->ecn_present ? 0x03
                                           : 0x02;
    ...
    delay = ossl_time_divide(ossl_time_divide(ack->delay_time, ((((uint64_t)1000000000) / 1000) / 1000)),
...
size_t ossl_quic_wire_get_encoded_frame_len_crypto_hdr(const OSSL_QUIC_FRAME_CRYPTO *f)
{
    ...
    a = ossl_quic_vlint_encode_len(0x06);
...
{
    unsigned char *p = 
# 153 "../ssl/quic/quic_wire.c" 3 4
                      ((void *)0)
# 153 "../ssl/quic/quic_wire.c"
                          ;

    if (!ossl_quic_wire_encode_frame_crypto_hdr(pkt, f)
            || f->len > 
# 156 "../ssl/quic/quic_wire.c" 3 4
                       (18446744073709551615UL)
            
# 157 "../ssl/quic/quic_wire.c"
           || !WPACKET_allocate_bytes(pkt, (size_t)f->len, &p))
        return 
# 158 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 158 "../ssl/quic/quic_wire.c"
                  ;

    if (f->data != 
# 160 "../ssl/quic/quic_wire.c" 3 4
                  ((void *)0)
# 160 "../ssl/quic/quic_wire.c"
                      )
...
size_t ossl_quic_wire_get_encoded_frame_len_stream_hdr(const OSSL_QUIC_FRAME_STREAM *f)
{
    ...
    a = ossl_quic_vlint_encode_len(0x08);
                                         ...
                                         const OSSL_QUIC_FRAME_STREAM *f)
{
    ...
    unsigned char *p = 
# 235 "../ssl/quic/quic_wire.c" 3 4
                      ((void *)0)
# 235 "../ssl/quic/quic_wire.c"
                          ;

    if (!ossl_quic_wire_encode_frame_stream_hdr(pkt, f)
            || f->len > 
# 238 "../ssl/quic/quic_wire.c" 3 4
                       (18446744073709551615UL) 
# 238 "../ssl/quic/quic_wire.c"
                                                                        )
        return 
# 239 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 239 "../ssl/quic/quic_wire.c"
                  ;

    if (!WPACKET_allocate_bytes(pkt, (size_t)f->len, &p))
        return 
# 242 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 242 "../ssl/quic/quic_wire.c"
                  ;

    if (f->data != 
# 244 "../ssl/quic/quic_wire.c" 3 4
                  ((void *)0)
# 244 "../ssl/quic/quic_wire.c"
                      )
        memcpy(p, f->data, (size_t)f->len);
...
int ossl_quic_wire_encode_frame_max_streams(WPACKET *pkt,
                                            ...
                                            uint64_t max_streams)
{
    if (!encode_frame_hdr(pkt, is_uni ? 0x13
                                      : 0x12)
...
int ossl_quic_wire_encode_frame_streams_blocked(WPACKET *pkt,
                                                ...
                                                uint64_t max_streams)
{
    if (!encode_frame_hdr(pkt, is_uni ? 0x17
                                      : 0x16)
            || !WPACKET_quic_write_vlint(pkt, max_streams))
        return 0;
...
int ossl_quic_wire_encode_frame_path_challenge(WPACKET *pkt,
                                               uint64_t data)
{
    if (!encode_frame_hdr(pkt, 0x1A)
            || !WPACKET_put_bytes__((pkt), (data), 8))
        return 0;
...
int ossl_quic_wire_encode_frame_conn_close(WPACKET *pkt,
                                           const OSSL_QUIC_FRAME_CONN_CLOSE *f)
{
    if (!encode_frame_hdr(pkt, f->is_app ? 0x1D
                                         : 0x1C)
...
int ossl_quic_wire_encode_frame_handshake_done(WPACKET *pkt)
{
    return encode_frame_hdr(pkt, 0x1E);
}
...
{
    unsigned char *b = 
# 400 "../ssl/quic/quic_wire.c" 3 4
                      ((void *)0)
# 400 "../ssl/quic/quic_wire.c"
                          ;

    if (!WPACKET_quic_write_vlint(pkt, id)
        || !WPACKET_quic_write_vlint(pkt, value_len))
        return 
# 404 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 404 "../ssl/quic/quic_wire.c"
                  ;
    ...
    if (value_len == 0)
        ...
        return 
# 409 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 409 "../ssl/quic/quic_wire.c"
                  ;

    if (value != 
# 411 "../ssl/quic/quic_wire.c" 3 4
                ((void *)0)
# 411 "../ssl/quic/quic_wire.c"
                    )
                                              ...
                                              const QUIC_CONN_ID *cid)
{
    ...
    if (ossl_quic_wire_encode_transport_param_bytes(wpkt, id,
                                                    cid->id,
                                                    cid->id_len) == 
# 438 "../ssl/quic/quic_wire.c" 3 4
                                                                   ((void *)0)
# 438 "../ssl/quic/quic_wire.c"
                                                                       )
        return 0;
                                    ...
                                    uint64_t *actual_frame_type)
{
    ...
    if (actual_frame_type != 
# 470 "../ssl/quic/quic_wire.c" 3 4
                            ((void *)0)
# 470 "../ssl/quic/quic_wire.c"
                                )
                                             ...
                                             uint64_t *total_ranges)
{
    ...
    if (!expect_frame_header_mask(&pkt, 0x02,
                                  1, 
# 494 "../ssl/quic/quic_wire.c" 3 4
                                    ((void *)0)
# 494 "../ssl/quic/quic_wire.c"
                                        )
...
int ossl_quic_wire_decode_frame_ack(PACKET *pkt,
    ...
    if (ack_range_count > 
# 536 "../ssl/quic/quic_wire.c" 3 4
                         (18446744073709551615UL) 
# 536 "../ssl/quic/quic_wire.c"
                                                                          )
        return 0;
    ...
    if (ack != 
# 541 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 541 "../ssl/quic/quic_wire.c"
                  ) {
        int err = 0;
        ack->delay_time
    ...
    for (i = 0; i < ack_range_count; ++i) {
        ...
        if (ack != 
# 568 "../ssl/quic/quic_wire.c" 3 4
                  ((void *)0) 
# 568 "../ssl/quic/quic_wire.c"
                       && i + 1 < ack->num_ack_ranges) {
    ...
    if (ack != 
# 574 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0) 
# 574 "../ssl/quic/quic_wire.c"
                   && ack_range_count + 1 < ack->num_ack_ranges)
        ack->num_ack_ranges = (size_t)ack_range_count + 1;

    if (total_ranges != 
# 577 "../ssl/quic/quic_wire.c" 3 4
                       ((void *)0)
# 577 "../ssl/quic/quic_wire.c"
                           )
        *total_ranges = ack_range_count + 1;
    ...
    if (frame_type == 0x03) {
        ...
        if (ack != 
# 588 "../ssl/quic/quic_wire.c" 3 4
                  ((void *)0)
# 588 "../ssl/quic/quic_wire.c"
                      ) {
            ack->ect0 = ect0;
            ack->ect1 = ect1;
            ack->ecnce = ecnce;
...
# 594 "../ssl/quic/quic_wire.c" 3 4
                     ((void *)0)
# 594 "../ssl/quic/quic_wire.c"
                         ) {
        ack->ecn_present = 0;
    }
...
int ossl_quic_wire_decode_frame_reset_stream(PACKET *pkt,
                                             OSSL_QUIC_FRAME_RESET_STREAM *f)
{
    if (!expect_frame_header(pkt, 0x04)
...
int ossl_quic_wire_decode_frame_stop_sending(PACKET *pkt,
                                             OSSL_QUIC_FRAME_STOP_SENDING *f)
{
    if (!expect_frame_header(pkt, 0x05)
            || !PACKET_get_quic_vlint(pkt, &f->stream_id)
            || !PACKET_get_quic_vlint(pkt, &f->app_error_code))
        return 0;
...
int ossl_quic_wire_decode_frame_crypto(PACKET *pkt,
                                       ...
                                       OSSL_QUIC_FRAME_CRYPTO *f)
{
    if (!expect_frame_header(pkt, 0x06)
            || !PACKET_get_quic_vlint(pkt, &f->offset)
            || !PACKET_get_quic_vlint(pkt, &f->len)
            || f->len > 
# 631 "../ssl/quic/quic_wire.c" 3 4
                       (18446744073709551615UL) 
# 631 "../ssl/quic/quic_wire.c"
                                                                        )
        return 0;
    ...
    if (nodata) {
        f->data = 
# 639 "../ssl/quic/quic_wire.c" 3 4
                 ((void *)0)
# 639 "../ssl/quic/quic_wire.c"
                     ;
    } else {
                                          ...
                                          size_t *token_len)
{
    ...
    if (!expect_frame_header(pkt, 0x07)
            || !PACKET_get_quic_vlint(pkt, &token_len_))
        return 0;

    if (token_len_ > 
# 663 "../ssl/quic/quic_wire.c" 3 4
                    (18446744073709551615UL)
# 663 "../ssl/quic/quic_wire.c"
                            )
        return 0;
                                       ...
                                       OSSL_QUIC_FRAME_STREAM *f)
{
    ...
    if (!expect_frame_header_mask(pkt, 0x08,
                                  ((uint64_t)0x07),
                                  &frame_type)
            || !PACKET_get_quic_vlint(pkt, &f->stream_id))
        return 0;
    ...
    f->has_explicit_len = ((frame_type & 0x02) != 0);
    f->is_fin = ((frame_type & 0x01) != 0);
    ...
    if (nodata) {
        f->data = 
# 717 "../ssl/quic/quic_wire.c" 3 4
                 ((void *)0)
# 717 "../ssl/quic/quic_wire.c"
                     ;
    } else {
        f->data = PACKET_data(pkt);

        if (f->len > 
# 721 "../ssl/quic/quic_wire.c" 3 4
                    (18446744073709551615UL)
            
# 722 "../ssl/quic/quic_wire.c"
...
int ossl_quic_wire_decode_frame_max_data(PACKET *pkt,
                                         uint64_t *max_data)
{
    if (!expect_frame_header(pkt, 0x10)
...
int ossl_quic_wire_decode_frame_max_stream_data(PACKET *pkt,
                                                ...
                                                uint64_t *max_stream_data)
{
    if (!expect_frame_header(pkt, 0x11)
                                            ...
                                            uint64_t *max_streams)
{
    ...
    if (!expect_frame_header_mask(pkt, 0x12,
                                  1, 
# 756 "../ssl/quic/quic_wire.c" 3 4
                                    ((void *)0)
# 756 "../ssl/quic/quic_wire.c"
                                        )
...
int ossl_quic_wire_decode_frame_data_blocked(PACKET *pkt,
                                             uint64_t *max_data)
{
    if (!expect_frame_header(pkt, 0x14)
            || !PACKET_get_quic_vlint(pkt, max_data))
        return 0;
...
int ossl_quic_wire_decode_frame_stream_data_blocked(PACKET *pkt,
                                                    ...
                                                    uint64_t *max_stream_data)
{
    if (!expect_frame_header(pkt, 0x15)
            || !PACKET_get_quic_vlint(pkt, stream_id)
            || !PACKET_get_quic_vlint(pkt, max_stream_data))
        return 0;
                                                ...
                                                uint64_t *max_streams)
{
    ...
    if (!expect_frame_header_mask(pkt, 0x16,
                                  1, 
# 790 "../ssl/quic/quic_wire.c" 3 4
                                    ((void *)0)
# 790 "../ssl/quic/quic_wire.c"
                                        )
            || !PACKET_get_quic_vlint(pkt, max_streams))
        return 0;
                                            ...
                                            OSSL_QUIC_FRAME_NEW_CONN_ID *f)
{
    ...
    if (!expect_frame_header(pkt, 0x18)
    ...
    if (len < 20)
        memset(f->conn_id.id + len, 0, 20 - len);
...
int ossl_quic_wire_decode_frame_retire_conn_id(PACKET *pkt,
                                               uint64_t *seq_num)
{
    if (!expect_frame_header(pkt, 0x19)
...
int ossl_quic_wire_decode_frame_path_challenge(PACKET *pkt,
                                               uint64_t *data)
{
    if (!expect_frame_header(pkt, 0x1A)
...
int ossl_quic_wire_decode_frame_path_response(PACKET *pkt,
                                              uint64_t *data)
{
    if (!expect_frame_header(pkt, 0x1B)
            || !PACKET_get_net_8(pkt, data))
        return 0;
                                           ...
                                           OSSL_QUIC_FRAME_CONN_CLOSE *f)
{
    ...
    if (!expect_frame_header_mask(pkt, 0x1C,
                                  1, &frame_type)
    ...
    if (!PACKET_get_quic_vlint(pkt, &reason_len)
            || reason_len > 
# 877 "../ssl/quic/quic_wire.c" 3 4
                           (18446744073709551615UL)
# 877 "../ssl/quic/quic_wire.c"
                                   )
        return 0;
...
int ossl_quic_wire_decode_frame_ping(PACKET *pkt)
{
    return expect_frame_header(pkt, 0x01);
}

int ossl_quic_wire_decode_frame_handshake_done(PACKET *pkt)
{
    return expect_frame_header(pkt, 0x1E);
}
...
# 922 "../ssl/quic/quic_wire.c" 3 4
                            ((void *)0)
# 922 "../ssl/quic/quic_wire.c"
                                ;
    uint64_t id_;
    ...
    if (!PACKET_get_quic_vlint(pkt, &id_)
        ...
        return 
# 927 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 927 "../ssl/quic/quic_wire.c"
                  ;

    if (len_ > 
# 929 "../ssl/quic/quic_wire.c" 3 4
              (18446744073709551615UL)
            
# 930 "../ssl/quic/quic_wire.c"
           || !PACKET_get_bytes(pkt, (const unsigned char **)&b, (size_t)len_))
        return 
# 931 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 931 "../ssl/quic/quic_wire.c"
                  ;

    *len = (size_t)len_;
    if (id != 
# 934 "../ssl/quic/quic_wire.c" 3 4
             ((void *)0)
# 934 "../ssl/quic/quic_wire.c"
                 )
        *id = id_;
    return b;
}
                                              ...
                                              uint64_t *value)
{
    ...
    sub.curr = ossl_quic_wire_decode_transport_param_bytes(pkt,
                                                           id, &sub.remaining);
    if (sub.curr == 
# 947 "../ssl/quic/quic_wire.c" 3 4
                   ((void *)0)
# 947 "../ssl/quic/quic_wire.c"
                       )
        return 0;
                                              ...
                                              QUIC_CONN_ID *cid)
{
    ...
    if (body == 
# 967 "../ssl/quic/quic_wire.c" 3 4
               ((void *)0) 
# 967 "../ssl/quic/quic_wire.c"
                    || len > 20)
        return 0;
                                                         ...
                                                         QUIC_PREFERRED_ADDR *p)
{
    ...
    body = ossl_quic_wire_decode_transport_param_bytes(pkt, &id, &len);
    if (body == 
# 985 "../ssl/quic/quic_wire.c" 3 4
               ((void *)0)
        
# 986 "../ssl/quic/quic_wire.c"
       || len < 41
        || len > 61
        || id != 0x0D)
        return 0;
...
ossl_quic_frame_type_to_string(uint64_t frame_type)
{
    ...
    case 0x02: return "ACK_WITHOUT_ECN";
    case 0x03: return "ACK_WITH_ECN";
    ...
    case 0x12: return "MAX_STREAMS_BIDI";
    case 0x13: return "MAX_STREAMS_UNI";
    case 0x14: return "DATA_BLOCKED";
    case 0x15: return "STREAM_DATA_BLOCKED";
    case 0x16: return "STREAMS_BLOCKED_BIDI";
    case 0x17: return "STREAMS_BLOCKED_UNI";
    case 0x18: return "NEW_CONN_ID";
    case 0x19: return "RETIRE_CONN_ID";
    case 0x1A: return "PATH_CHALLENGE";
    case 0x1B: return "PATH_RESPONSE";
    case 0x1C: return "CONN_CLOSE_TRANSPORT";
    case 0x1D: return "CONN_CLOSE_APP";
    case 0x1E: return "HANDSHAKE_DONE";
    case 0x08: return "STREAM";
    case (0x08 | 0x01): return "STREAM_FIN";
    case (0x08 | 0x02): return "STREAM_LEN";
    case (0x08 | 0x02 | 0x01): return "STREAM_LEN_FIN";
    case (0x08 | 0x04): return "STREAM_OFF";
    case (0x08 | 0x04 | 0x01): return "STREAM_OFF_FIN";
    case (0x08 | 0x04 | 0x02): return "STREAM_OFF_LEN";
    case (0x08 | 0x04 | 0x02 | 0x01): return "STREAM_OFF_LEN_FIN";

    default:
        return 
# 1049 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 1049 "../ssl/quic/quic_wire.c"
                  ;
    }
}
...
const char *ossl_quic_err_to_string(uint64_t error_code)
{
    ...
    default:
        return 
# 1076 "../ssl/quic/quic_wire.c" 3 4
              ((void *)0)
# 1076 "../ssl/quic/quic_wire.c"
                  ;
    }
}
