# 0 "../ssl/quic/quic_sstream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_sstream.c"
# 10 "../ssl/quic/quic_sstream.c"
...
QUIC_SSTREAM *ossl_quic_sstream_new(size_t init_buf_size)
{
    ...
    qss = CRYPTO_zalloc(sizeof(QUIC_SSTREAM), "../ssl/quic/quic_sstream.c", 64);
    if (qss == 
# 65 "../ssl/quic/quic_sstream.c" 3 4
              ((void *)0)
# 65 "../ssl/quic/quic_sstream.c"
                  )
        return 
# 66 "../ssl/quic/quic_sstream.c" 3 4
              ((void *)0)
# 66 "../ssl/quic/quic_sstream.c"
                  ;

    ring_buf_init(&qss->ring_buf);
    if (!ring_buf_resize(&qss->ring_buf, init_buf_size, 0)) {
        ring_buf_destroy(&qss->ring_buf, 0);
        CRYPTO_free(qss, "../ssl/quic/quic_sstream.c", 71);
        return 
# 72 "../ssl/quic/quic_sstream.c" 3 4
              ((void *)0)
# 72 "../ssl/quic/quic_sstream.c"
                  ;
    }
...
{
    if (qss == 
# 82 "../ssl/quic/quic_sstream.c" 3 4
              ((void *)0)
# 82 "../ssl/quic/quic_sstream.c"
                  )
        return;
    ...
    CRYPTO_free(qss, "../ssl/quic/quic_sstream.c", 88);
}
                                       ...
                                       size_t *num_iov)
{
    ...
    uint64_t max_len;
    const unsigned char *src = 
# 99 "../ssl/quic/quic_sstream.c" 3 4
                              ((void *)0)
# 99 "../ssl/quic/quic_sstream.c"
                                  ;
...
# 105 "../ssl/quic/quic_sstream.c" 3 4
                                    ((void *)0)
# 105 "../ssl/quic/quic_sstream.c"
                                        ; ++i)
        range = ossl_list_uint_set_next(range);

    if (range == 
# 108 "../ssl/quic/quic_sstream.c" 3 4
                ((void *)0)
# 108 "../ssl/quic/quic_sstream.c"
                    ) {
        if (i < skip)
...
# 145 "../ssl/quic/quic_sstream.c" 3 4
       ((void) (0))
# 145 "../ssl/quic/quic_sstream.c"
                    ;
...
int ossl_quic_sstream_get_final_size(QUIC_SSTREAM *qss, uint64_t *final_size)
{
    ...
    if (final_size != 
# 276 "../ssl/quic/quic_sstream.c" 3 4
                     ((void *)0)
# 276 "../ssl/quic/quic_sstream.c"
                         )
...
# 320 "../ssl/quic/quic_sstream.c" 3 4
       ((void) (0))
# 320 "../ssl/quic/quic_sstream.c"
                                                     ;
        if (!ossl_uint_set_insert(&qss->new_set, &r)) {
...
# 352 "../ssl/quic/quic_sstream.c"
    if (h != 
# 352 "../ssl/quic/quic_sstream.c" 3 4
            ((void *)0)
# 352 "../ssl/quic/quic_sstream.c"
                )
...
# 399 "../ssl/quic/quic_sstream.c" 3 4
   ((void) (0))
# 399 "../ssl/quic/quic_sstream.c"
                                ;
