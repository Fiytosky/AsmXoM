# 0 "../ssl/quic/quic_srtm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_srtm.c"
# 10 "../ssl/quic/quic_srtm.c"
...
# 12 "../ssl/quic/quic_srtm.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../ssl/quic/quic_srtm.c" 2
...
struct lhash_st_SRTM_ITEM { union lh_SRTM_ITEM_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_SRTM_ITEM_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const SRTM_ITEM *) = (unsigned long (*)(const SRTM_ITEM *))hfn; return hfn_conv((const SRTM_ITEM *)data); } static int lh_SRTM_ITEM_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const SRTM_ITEM *, const SRTM_ITEM *) = (int (*)(const SRTM_ITEM *, const SRTM_ITEM *))cfn; return cfn_conv((const SRTM_ITEM *)da, (const SRTM_ITEM *)db); } static __attribute__((unused)) inline void lh_SRTM_ITEM_free(struct lhash_st_SRTM_ITEM *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_SRTM_ITEM_flush(struct lhash_st_SRTM_ITEM *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline SRTM_ITEM * lh_SRTM_ITEM_insert(struct lhash_st_SRTM_ITEM *lh, SRTM_ITEM *d) { return (SRTM_ITEM *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline SRTM_ITEM * lh_SRTM_ITEM_delete(struct lhash_st_SRTM_ITEM *lh, const SRTM_ITEM *d) { return (SRTM_ITEM *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline SRTM_ITEM * lh_SRTM_ITEM_retrieve(struct lhash_st_SRTM_ITEM *lh, const SRTM_ITEM *d) { return (SRTM_ITEM *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_SRTM_ITEM_error(struct lhash_st_SRTM_ITEM *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_SRTM_ITEM_num_items(struct lhash_st_SRTM_ITEM *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_SRTM_ITEM_get_down_load(struct lhash_st_SRTM_ITEM *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_SRTM_ITEM_set_down_load(struct lhash_st_SRTM_ITEM *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_SRTM_ITEM_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(SRTM_ITEM *) = (void (*)(SRTM_ITEM *))doall; doall_conv((SRTM_ITEM *)node); } static __attribute__((unused)) inline void lh_SRTM_ITEM_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(SRTM_ITEM *, void *) = (void (*)(SRTM_ITEM *, void *))doall; doall_conv((SRTM_ITEM *)node, arg); } static __attribute__((unused)) inline void lh_SRTM_ITEM_doall(struct lhash_st_SRTM_ITEM *lh, void (*doall)(SRTM_ITEM *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_SRTM_ITEM * lh_SRTM_ITEM_new(unsigned long (*hfn)(const SRTM_ITEM *), int (*cfn)(const SRTM_ITEM *, const SRTM_ITEM *)) { return (struct lhash_st_SRTM_ITEM *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_SRTM_ITEM_hfn_thunk, lh_SRTM_ITEM_cfn_thunk, lh_SRTM_ITEM_doall_thunk, lh_SRTM_ITEM_doall_arg_thunk); } static __attribute__((unused)) inline void lh_SRTM_ITEM_doall_arg(struct lhash_st_SRTM_ITEM *lh, void (*doallarg)(SRTM_ITEM *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_SRTM_ITEM;
# 42 "../ssl/quic/quic_srtm.c"
struct srtm_item_st {
...
struct quic_srtm_st {
    ...
    EVP_CIPHER_CTX *blind_ctx;

    struct lhash_st_SRTM_ITEM *items_fwd;
    struct lhash_st_SRTM_ITEM *items_rev;
...
static int srtm_check_lh(QUIC_SRTM *srtm, struct lhash_st_SRTM_ITEM *lh)
{
...
{
    QUIC_SRTM *srtm = 
# 112 "../ssl/quic/quic_srtm.c" 3 4
                     ((void *)0)
# 112 "../ssl/quic/quic_srtm.c"
                         ;
    unsigned char key[16];
    EVP_CIPHER *ecb = 
# 114 "../ssl/quic/quic_srtm.c" 3 4
                     ((void *)0)
# 114 "../ssl/quic/quic_srtm.c"
                         ;

    if (RAND_priv_bytes_ex(libctx, key, sizeof(key), sizeof(key) * 8) != 1)
        goto err;

    if ((srtm = CRYPTO_zalloc(sizeof(*srtm), "../ssl/quic/quic_srtm.c", 119)) == 
# 119 "../ssl/quic/quic_srtm.c" 3 4
                                                 ((void *)0)
# 119 "../ssl/quic/quic_srtm.c"
                                                     )
        return 
# 120 "../ssl/quic/quic_srtm.c" 3 4
              ((void *)0)
# 120 "../ssl/quic/quic_srtm.c"
                  ;


    if ((ecb = EVP_CIPHER_fetch(libctx, "AES-128-ECB", propq)) == 
# 123 "../ssl/quic/quic_srtm.c" 3 4
                                                                 ((void *)0)
# 123 "../ssl/quic/quic_srtm.c"
                                                                     )
        goto err;

    if ((srtm->blind_ctx = EVP_CIPHER_CTX_new()) == 
# 126 "../ssl/quic/quic_srtm.c" 3 4
                                                   ((void *)0)
# 126 "../ssl/quic/quic_srtm.c"
                                                       )
        goto err;

    if (!EVP_EncryptInit_ex2(srtm->blind_ctx, ecb, key, 
# 129 "../ssl/quic/quic_srtm.c" 3 4
                                                       ((void *)0)
# 129 "../ssl/quic/quic_srtm.c"
                                                           , 
# 129 "../ssl/quic/quic_srtm.c" 3 4
                                                             ((void *)0)
# 129 "../ssl/quic/quic_srtm.c"
    ...
    EVP_CIPHER_free(ecb);
    ecb = 
# 133 "../ssl/quic/quic_srtm.c" 3 4
         ((void *)0)
# 133 "../ssl/quic/quic_srtm.c"
             ;


    if ((srtm->items_fwd = lh_SRTM_ITEM_new(items_fwd_hash, items_fwd_cmp)) == 
# 136 "../ssl/quic/quic_srtm.c" 3 4
                                                                              ((void *)0)
        
# 137 "../ssl/quic/quic_srtm.c"
       || (srtm->items_rev = lh_SRTM_ITEM_new(items_rev_hash, items_rev_cmp)) == 
# 137 "../ssl/quic/quic_srtm.c" 3 4
                                                                                 ((void *)0)
# 137 "../ssl/quic/quic_srtm.c"
                                                                                     )
        goto err;
...
err:
    ...
    EVP_CIPHER_free(ecb);
    return 
# 149 "../ssl/quic/quic_srtm.c" 3 4
          ((void *)0)
# 149 "../ssl/quic/quic_srtm.c"
              ;
}
...
static void srtm_free_each(SRTM_ITEM *ihead)
{
    ...
    for (item = item->next_by_seq_num; item != 
# 156 "../ssl/quic/quic_srtm.c" 3 4
                                              ((void *)0)
# 156 "../ssl/quic/quic_srtm.c"
                                                  ; item = inext) {
        inext = item->next_by_seq_num;
        CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 158);
    }

    CRYPTO_free(ihead, "../ssl/quic/quic_srtm.c", 161);
}

void ossl_quic_srtm_free(QUIC_SRTM *srtm)
{
    if (srtm == 
# 166 "../ssl/quic/quic_srtm.c" 3 4
               ((void *)0)
# 166 "../ssl/quic/quic_srtm.c"
                   )
        return;

    lh_SRTM_ITEM_free(srtm->items_rev);
    if (srtm->items_fwd != 
# 170 "../ssl/quic/quic_srtm.c" 3 4
                          ((void *)0)
# 170 "../ssl/quic/quic_srtm.c"
                              ) {
    ...
    CRYPTO_free(srtm, "../ssl/quic/quic_srtm.c", 176);
}
# 186 "../ssl/quic/quic_srtm.c"
static SRTM_ITEM *srtm_find(QUIC_SRTM *srtm, void *opaque, uint64_t seq_num,
                            SRTM_ITEM **head_p, SRTM_ITEM **prev_p)
{
    SRTM_ITEM key, *item = 
# 189 "../ssl/quic/quic_srtm.c" 3 4
                          ((void *)0)
# 189 "../ssl/quic/quic_srtm.c"
                              , *prev = 
# 189 "../ssl/quic/quic_srtm.c" 3 4
                                        ((void *)0)
# 189 "../ssl/quic/quic_srtm.c"
    ...
    if (head_p != 
# 194 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0)
# 194 "../ssl/quic/quic_srtm.c"
                     )
        *head_p = item;

    for (; item != 
# 197 "../ssl/quic/quic_srtm.c" 3 4
                  ((void *)0)
# 197 "../ssl/quic/quic_srtm.c"
                      ; prev = item, item = item->next_by_seq_num)
        if (item->seq_num == seq_num) {
            ...
            item = 
# 205 "../ssl/quic/quic_srtm.c" 3 4
                  ((void *)0)
# 205 "../ssl/quic/quic_srtm.c"
                      ;
            break;
        }

    if (prev_p != 
# 209 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0)
# 209 "../ssl/quic/quic_srtm.c"
                     )
        *prev_p = prev;
...
static void sorted_insert_seq_num(SRTM_ITEM *head, SRTM_ITEM *item, SRTM_ITEM **new_head)
{
    ...
    *new_head = head;
    ...
    while (cur != 
# 227 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0) 
# 227 "../ssl/quic/quic_srtm.c"
                      && cur->seq_num > seq_num) {
...
static void sorted_insert_srt(SRTM_ITEM *head, SRTM_ITEM *item, SRTM_ITEM **new_head)
{
    ...
    *new_head = head;
    ...
    while (cur != 
# 248 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0) 
# 248 "../ssl/quic/quic_srtm.c"
                      && (uintptr_t)cur->opaque > opaque) {
                                ...
                                const QUIC_STATELESS_RESET_TOKEN *token)
{
    ...
    if (!__builtin_expect(!!((outl == sizeof(*token)) != 0), 1))
        return 0;
...
{
    SRTM_ITEM *item = 
# 285 "../ssl/quic/quic_srtm.c" 3 4
                     ((void *)0)
# 285 "../ssl/quic/quic_srtm.c"
                         , *head = 
# 285 "../ssl/quic/quic_srtm.c" 3 4
                                   ((void *)0)
# 285 "../ssl/quic/quic_srtm.c"
    ...
    if ((item = srtm_find(srtm, opaque, seq_num, &head, 
# 291 "../ssl/quic/quic_srtm.c" 3 4
                                                       ((void *)0)
# 291 "../ssl/quic/quic_srtm.c"
                                                           )) != 
# 291 "../ssl/quic/quic_srtm.c" 3 4
                                                                 ((void *)0)
# 291 "../ssl/quic/quic_srtm.c"
    ...
    if ((item = CRYPTO_zalloc(sizeof(*item), "../ssl/quic/quic_srtm.c", 294)) == 
# 294 "../ssl/quic/quic_srtm.c" 3 4
                                                 ((void *)0)
# 294 "../ssl/quic/quic_srtm.c"
                                                     )
        return 0;
    ...
    if (!srtm_compute_blinded(srtm, item, &item->srt)) {
        CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 301);
        return 0;
    }


    if (head == 
# 306 "../ssl/quic/quic_srtm.c" 3 4
               ((void *)0)
# 306 "../ssl/quic/quic_srtm.c"
                   ) {

        lh_SRTM_ITEM_insert(srtm->items_fwd, item);
        if (!srtm_check_lh(srtm, srtm->items_fwd)) {
            CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 310);
            return 0;
        }
    } else {
        ...
        if (new_head != head) {
            ...
            if (!srtm_check_lh(srtm, srtm->items_fwd)) {
                CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 318);
                return 0;
            }
        }
    }
    ...
    if (r_item == 
# 326 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0)
# 326 "../ssl/quic/quic_srtm.c"
                     ) {
...
# 356 "../ssl/quic/quic_srtm.c" 3 4
   ((void) (0))
# 356 "../ssl/quic/quic_srtm.c"
                          ;
    if (rh_item == item) {
        ...
        if (item->next_by_srt_blinded != 
# 362 "../ssl/quic/quic_srtm.c" 3 4
                                        ((void *)0)
# 362 "../ssl/quic/quic_srtm.c"
                                            ) {
...
{
    SRTM_ITEM *item, *prev = 
# 381 "../ssl/quic/quic_srtm.c" 3 4
                            ((void *)0)
# 381 "../ssl/quic/quic_srtm.c"
                                ;

    if (srtm->alloc_failed)
        return 0;

    if ((item = srtm_find(srtm, opaque, seq_num, 
# 386 "../ssl/quic/quic_srtm.c" 3 4
                                                ((void *)0)
# 386 "../ssl/quic/quic_srtm.c"
                                                    , &prev)) == 
# 386 "../ssl/quic/quic_srtm.c" 3 4
                                                                 ((void *)0)
# 386 "../ssl/quic/quic_srtm.c"
    ...
    if (prev == 
# 391 "../ssl/quic/quic_srtm.c" 3 4
               ((void *)0)
# 391 "../ssl/quic/quic_srtm.c"
                   ) {




        if (item->next_by_seq_num != 
# 396 "../ssl/quic/quic_srtm.c" 3 4
                                    ((void *)0)
# 396 "../ssl/quic/quic_srtm.c"
                                        ) {
    ...
    CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 411);
    return 1;
}
...
{
    SRTM_ITEM key, *item = 
# 417 "../ssl/quic/quic_srtm.c" 3 4
                          ((void *)0)
# 417 "../ssl/quic/quic_srtm.c"
                              , *inext, *ihead;
    ...
    if ((ihead = lh_SRTM_ITEM_retrieve(srtm->items_fwd, &key)) == 
# 424 "../ssl/quic/quic_srtm.c" 3 4
                                                                 ((void *)0)
# 424 "../ssl/quic/quic_srtm.c"
                                                                     )
        return 1;

    for (item = ihead; item != 
# 427 "../ssl/quic/quic_srtm.c" 3 4
                              ((void *)0)
# 427 "../ssl/quic/quic_srtm.c"
                                  ; item = inext) {
        inext = item->next_by_seq_num;
        if (item != ihead) {
            srtm_remove_from_rev(srtm, item);
            CRYPTO_free(item, "../ssl/quic/quic_srtm.c", 431);
        }
    }

    lh_SRTM_ITEM_delete(srtm->items_fwd, ihead);
    srtm_remove_from_rev(srtm, ihead);
    CRYPTO_free(ihead, "../ssl/quic/quic_srtm.c", 437);
    return 1;
}
                          ...
                          void **opaque, uint64_t *seq_num)
{
    ...
    for (; idx > 0 && item != 
# 455 "../ssl/quic/quic_srtm.c" 3 4
                             ((void *)0)
# 455 "../ssl/quic/quic_srtm.c"
                                 ; --idx, item = item->next_by_srt_blinded);
    if (item == 
# 456 "../ssl/quic/quic_srtm.c" 3 4
               ((void *)0)
# 456 "../ssl/quic/quic_srtm.c"
                   )
        return 0;

    if (opaque != 
# 459 "../ssl/quic/quic_srtm.c" 3 4
                 ((void *)0)
# 459 "../ssl/quic/quic_srtm.c"
                     )
        *opaque = item->opaque;
    if (seq_num != 
# 461 "../ssl/quic/quic_srtm.c" 3 4
                  ((void *)0)
# 461 "../ssl/quic/quic_srtm.c"
                      )
        *seq_num = item->seq_num;

    return 1;
}
# 527 "../ssl/quic/quic_srtm.c"
void ossl_quic_srtm_check(const QUIC_SRTM *srtm)
{
# 565 "../ssl/quic/quic_srtm.c"
}
