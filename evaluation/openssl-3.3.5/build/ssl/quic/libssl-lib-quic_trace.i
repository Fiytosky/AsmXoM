...
static int frame_ack(BIO *bio, PACKET *pkt)
{
    OSSL_QUIC_FRAME_ACK ack;
    OSSL_QUIC_ACK_RANGE *ack_ranges = 
# 79 "../ssl/quic/quic_trace.c" 3 4
                                     ((void *)0)
# 79 "../ssl/quic/quic_trace.c"
                                         ;
    ...
    if (!ossl_quic_wire_peek_frame_ack_num_ranges(pkt, &total_ranges)
        ...
        || total_ranges > 
# 86 "../ssl/quic/quic_trace.c" 3 4
                         (18446744073709551615UL) 
# 86 "../ssl/quic/quic_trace.c"
                                  / sizeof(ack_ranges[0])
        || (ack_ranges = CRYPTO_zalloc(sizeof(ack_ranges[0]) * (size_t)total_ranges, "../ssl/quic/quic_trace.c", 87)
                                                               ) == 
# 88 "../ssl/quic/quic_trace.c" 3 4
                                                                   ((void *)0)
# 88 "../ssl/quic/quic_trace.c"
                                                                       )
        return ret;
    ...
    if (!ossl_quic_wire_decode_frame_ack(pkt, 0, &ack, 
# 95 "../ssl/quic/quic_trace.c" 3 4
                                                      ((void *)0)
# 95 "../ssl/quic/quic_trace.c"
                                                          ))
        goto end;
    ...
    CRYPTO_free(ack_ranges, "../ssl/quic/quic_trace.c", 118);
    return ret;
}
...
# 399 "../ssl/quic/quic_trace.c" 3 4
                                                           ((void *)0)
# 399 "../ssl/quic/quic_trace.c"
                                                               ))
        return 0;
...
# 588 "../ssl/quic/quic_trace.c" 3 4
                                                                  ((void *)0)
# 588 "../ssl/quic/quic_trace.c"
                                                                      ) != 1)
                return 0;
