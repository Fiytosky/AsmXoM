# 0 "../ssl/quic/quic_stream_map.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_stream_map.c"
# 10 "../ssl/quic/quic_stream_map.c"
...
# 15 "../include/internal/quic_stream_map.h" 2
...
# 16 "../include/internal/quic_stream_map.h" 2
...
# 18 "../include/internal/quic_stream_map.h" 2
...
# 19 "../include/internal/quic_stream_map.h" 2
...
# 11 "../ssl/quic/quic_stream_map.c" 2
...
struct lhash_st_QUIC_STREAM { union lh_QUIC_STREAM_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_QUIC_STREAM_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const QUIC_STREAM *) = (unsigned long (*)(const QUIC_STREAM *))hfn; return hfn_conv((const QUIC_STREAM *)data); } static int lh_QUIC_STREAM_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const QUIC_STREAM *, const QUIC_STREAM *) = (int (*)(const QUIC_STREAM *, const QUIC_STREAM *))cfn; return cfn_conv((const QUIC_STREAM *)da, (const QUIC_STREAM *)db); } static __attribute__((unused)) inline void lh_QUIC_STREAM_free(struct lhash_st_QUIC_STREAM *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_STREAM_flush(struct lhash_st_QUIC_STREAM *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline QUIC_STREAM * lh_QUIC_STREAM_insert(struct lhash_st_QUIC_STREAM *lh, QUIC_STREAM *d) { return (QUIC_STREAM *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_STREAM * lh_QUIC_STREAM_delete(struct lhash_st_QUIC_STREAM *lh, const QUIC_STREAM *d) { return (QUIC_STREAM *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_STREAM * lh_QUIC_STREAM_retrieve(struct lhash_st_QUIC_STREAM *lh, const QUIC_STREAM *d) { return (QUIC_STREAM *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_QUIC_STREAM_error(struct lhash_st_QUIC_STREAM *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_STREAM_num_items(struct lhash_st_QUIC_STREAM *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_STREAM_get_down_load(struct lhash_st_QUIC_STREAM *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_STREAM_set_down_load(struct lhash_st_QUIC_STREAM *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_QUIC_STREAM_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(QUIC_STREAM *) = (void (*)(QUIC_STREAM *))doall; doall_conv((QUIC_STREAM *)node); } static __attribute__((unused)) inline void lh_QUIC_STREAM_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(QUIC_STREAM *, void *) = (void (*)(QUIC_STREAM *, void *))doall; doall_conv((QUIC_STREAM *)node, arg); } static __attribute__((unused)) inline void lh_QUIC_STREAM_doall(struct lhash_st_QUIC_STREAM *lh, void (*doall)(QUIC_STREAM *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_QUIC_STREAM * lh_QUIC_STREAM_new(unsigned long (*hfn)(const QUIC_STREAM *), int (*cfn)(const QUIC_STREAM *, const QUIC_STREAM *)) { return (struct lhash_st_QUIC_STREAM *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_QUIC_STREAM_hfn_thunk, lh_QUIC_STREAM_cfn_thunk, lh_QUIC_STREAM_doall_thunk, lh_QUIC_STREAM_doall_arg_thunk); } static __attribute__((unused)) inline void lh_QUIC_STREAM_doall_arg(struct lhash_st_QUIC_STREAM *lh, void (*doallarg)(QUIC_STREAM *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_QUIC_STREAM;
...
# 26 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))
                                                 
# 27 "../ssl/quic/quic_stream_map.c"
                                                ;
...
# 38 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))
                                           
# 39 "../ssl/quic/quic_stream_map.c"
                                          ;

    n->prev->next = n->next;
    n->next->prev = n->prev;
    n->next = n->prev = 
# 43 "../ssl/quic/quic_stream_map.c" 3 4
                       ((void *)0)
# 43 "../ssl/quic/quic_stream_map.c"
                           ;
}
...
# 49 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))

                                                 
# 51 "../ssl/quic/quic_stream_map.c"
                                                ;
    ...
    if (n == l)
        return 
# 58 "../ssl/quic/quic_stream_map.c" 3 4
              ((void *)0)
# 58 "../ssl/quic/quic_stream_map.c"
                  ;

    
# 60 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))
# 60 "../ssl/quic/quic_stream_map.c"
                    ;

    return (QUIC_STREAM *)(((char *)n) - off);
}
# 76 "../ssl/quic/quic_stream_map.c"
                              ...
                              int is_server)
{
    ...
    qsm->rr_counter = 0;
    qsm->rr_cur = 
# 104 "../ssl/quic/quic_stream_map.c" 3 4
                      ((void *)0)
# 104 "../ssl/quic/quic_stream_map.c"
                          ;
...
void ossl_quic_stream_map_cleanup(QUIC_STREAM_MAP *qsm)
{
    ...
    qsm->map = 
# 130 "../ssl/quic/quic_stream_map.c" 3 4
              ((void *)0)
# 130 "../ssl/quic/quic_stream_map.c"
                  ;
}
                                        ...
                                        int type)
{
    ...
    if (s != 
# 150 "../ssl/quic/quic_stream_map.c" 3 4
            ((void *)0)
# 150 "../ssl/quic/quic_stream_map.c"
                )
        return 
# 151 "../ssl/quic/quic_stream_map.c" 3 4
              ((void *)0)
# 151 "../ssl/quic/quic_stream_map.c"
                  ;

    s = CRYPTO_zalloc(sizeof(*s), "../ssl/quic/quic_stream_map.c", 153);
    if (s == 
# 154 "../ssl/quic/quic_stream_map.c" 3 4
            ((void *)0)
# 154 "../ssl/quic/quic_stream_map.c"
                )
        return 
# 155 "../ssl/quic/quic_stream_map.c" 3 4
              ((void *)0)
# 155 "../ssl/quic/quic_stream_map.c"
                  ;
    ...
    s->send_final_size = 
# 169 "../ssl/quic/quic_stream_map.c" 3 4
                         (18446744073709551615UL)
# 169 "../ssl/quic/quic_stream_map.c"
                                   ;
...
{
    if (stream == 
# 177 "../ssl/quic/quic_stream_map.c" 3 4
                 ((void *)0)
# 177 "../ssl/quic/quic_stream_map.c"
                     )
        return;

    if (stream->active_node.next != 
# 180 "../ssl/quic/quic_stream_map.c" 3 4
                                   ((void *)0)
# 180 "../ssl/quic/quic_stream_map.c"
                                       )
        list_remove(&qsm->active_list, &stream->active_node);
    if (stream->accept_node.next != 
# 182 "../ssl/quic/quic_stream_map.c" 3 4
                                   ((void *)0)
# 182 "../ssl/quic/quic_stream_map.c"
                                       )
        list_remove(&qsm->accept_list, &stream->accept_node);
    if (stream->ready_for_gc_node.next != 
# 184 "../ssl/quic/quic_stream_map.c" 3 4
                                         ((void *)0)
# 184 "../ssl/quic/quic_stream_map.c"
                                             )
        list_remove(&qsm->ready_for_gc_list, &stream->ready_for_gc_node);

    ossl_quic_sstream_free(stream->sstream);
    stream->sstream = 
# 188 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 188 "../ssl/quic/quic_stream_map.c"
                         ;

    ossl_quic_rstream_free(stream->rstream);
    stream->rstream = 
# 191 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 191 "../ssl/quic/quic_stream_map.c"
                         ;

    lh_QUIC_STREAM_delete(qsm->map, stream);
    CRYPTO_free(stream, "../ssl/quic/quic_stream_map.c", 194);
}
...
static void stream_map_mark_active(QUIC_STREAM_MAP *qsm, QUIC_STREAM *s)
{
    ...
    if (qsm->rr_cur == 
# 214 "../ssl/quic/quic_stream_map.c" 3 4
                      ((void *)0)
# 214 "../ssl/quic/quic_stream_map.c"
                          )
        qsm->rr_cur = s;
...
static void stream_map_mark_inactive(QUIC_STREAM_MAP *qsm, QUIC_STREAM *s)
{
    ...
    if (qsm->rr_cur == s)
        qsm->rr_cur = list_next((&qsm->active_list), &(s)->active_node, 
# 226 "../ssl/quic/quic_stream_map.c" 3 4
                     __builtin_offsetof (
# 226 "../ssl/quic/quic_stream_map.c"
                     QUIC_STREAM
# 226 "../ssl/quic/quic_stream_map.c" 3 4
                     , 
# 226 "../ssl/quic/quic_stream_map.c"
...
# 226 "../ssl/quic/quic_stream_map.c"
    ...
    if (qsm->rr_cur == s)
        qsm->rr_cur = 
# 228 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 228 "../ssl/quic/quic_stream_map.c"
                         ;
...
# 268 "../ssl/quic/quic_stream_map.c"
...
static __attribute__((unused)) int qsm_send_part_permits_gc(const QUIC_STREAM *qs)
{
...
# 300 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))


                                                             
# 303 "../ssl/quic/quic_stream_map.c"
                                                            ;
                                                          ...
                                                          int is_uni)
{
    ...
    if (qsm->get_stream_limit_cb == 
# 321 "../ssl/quic/quic_stream_map.c" 3 4
                                   ((void *)0)
# 321 "../ssl/quic/quic_stream_map.c"
                                       )
        return 1;
...
# 425 "../ssl/quic/quic_stream_map.c" 3 4
   ((void) (0))
# 425 "../ssl/quic/quic_stream_map.c"
                                      ;
    qs->shutdown_flush = 0;
                                              ...
                                              QUIC_STREAM *qs)
{
    ...
    case 3:
        ...
        qs->sstream = 
# 444 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 444 "../ssl/quic/quic_stream_map.c"
                         ;
                                                ...
                                                uint64_t aec)
{
    ...
    case 2:
# 487 "../ssl/quic/quic_stream_map.c"
    ...
    case 3:
        ...
        ossl_quic_sstream_free(qs->sstream);
        qs->sstream = 
# 496 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 496 "../ssl/quic/quic_stream_map.c"
                         ;
                                             ...
                                             QUIC_STREAM *qs)
{
    ...
    case 3:
        ...
        qs->rstream = 
# 586 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 586 "../ssl/quic/quic_stream_map.c"
                         ;
        return 1;
    }
}
                                                ...
                                                uint64_t final_size)
{
    ...
    case 3:
        ...
        ossl_quic_rstream_free(qs->rstream);
        qs->rstream = 
# 620 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 620 "../ssl/quic/quic_stream_map.c"
                         ;
                                                ...
                                                uint64_t aec)
{
    ...
    case 1:
    case 2:
# 690 "../ssl/quic/quic_stream_map.c"
        break;
    }
...
int ossl_quic_stream_map_schedule_stop_sending(QUIC_STREAM_MAP *qsm, QUIC_STREAM *qs)
{
    ...
    case 1:
    case 2:
# 724 "../ssl/quic/quic_stream_map.c"
        break;
    }
...
QUIC_STREAM *ossl_quic_stream_map_peek_accept_queue(QUIC_STREAM_MAP *qsm)
{
    return list_next((&qsm->accept_list), (&qsm->accept_list), 
# 734 "../ssl/quic/quic_stream_map.c" 3 4
          __builtin_offsetof (
# 734 "../ssl/quic/quic_stream_map.c"
          QUIC_STREAM
# 734 "../ssl/quic/quic_stream_map.c" 3 4
          , 
# 734 "../ssl/quic/quic_stream_map.c"
                                                   ...
                                                   OSSL_TIME rtt)
{
    ...
    if ((max_streams_rxfc = qsm_get_max_streams_rxfc(qsm, s)) != 
# 766 "../ssl/quic/quic_stream_map.c" 3 4
                                                                ((void *)0)
# 766 "../ssl/quic/quic_stream_map.c"
                                                                    )
...
void ossl_quic_stream_map_gc(QUIC_STREAM_MAP *qsm)
{
    QUIC_STREAM *qs, *qs_head, *qsn = 
# 783 "../ssl/quic/quic_stream_map.c" 3 4
                                     ((void *)0)
# 783 "../ssl/quic/quic_stream_map.c"
                                         ;

    for (qs = qs_head = list_next((&qsm->ready_for_gc_list), (&qsm->ready_for_gc_list), 
# 785 "../ssl/quic/quic_stream_map.c" 3 4
                       __builtin_offsetof (
# 785 "../ssl/quic/quic_stream_map.c"
                       QUIC_STREAM
# 785 "../ssl/quic/quic_stream_map.c" 3 4
                       , 
# 785 "../ssl/quic/quic_stream_map.c"
...
# 785 "../ssl/quic/quic_stream_map.c"
         ...
         qs != 
# 786 "../ssl/quic/quic_stream_map.c" 3 4
              ((void *)0) 
# 786 "../ssl/quic/quic_stream_map.c"
                   && qs != qs_head;
         qs = qsn)
    {
         qsn = list_next((&qsm->ready_for_gc_list), &(qs)->ready_for_gc_node, 
# 789 "../ssl/quic/quic_stream_map.c" 3 4
              __builtin_offsetof (
# 789 "../ssl/quic/quic_stream_map.c"
              QUIC_STREAM
# 789 "../ssl/quic/quic_stream_map.c" 3 4
              , 
# 789 "../ssl/quic/quic_stream_map.c"
...
{
# 805 "../ssl/quic/quic_stream_map.c"
    switch (qs->send_state) {
    case 2:
    case 3:
                                ...
                                int advance_rr)
{
    ...
    if (advance_rr && it->stream != 
# 846 "../ssl/quic/quic_stream_map.c" 3 4
                                   ((void *)0)
        
# 847 "../ssl/quic/quic_stream_map.c"
       && ++qsm->rr_counter >= qsm->rr_stepping) {
        qsm->rr_counter = 0;
        qsm->rr_cur = list_next((&qsm->active_list), &(qsm->rr_cur)->active_node, 
# 849 "../ssl/quic/quic_stream_map.c" 3 4
                         __builtin_offsetof (
# 849 "../ssl/quic/quic_stream_map.c"
                         QUIC_STREAM
# 849 "../ssl/quic/quic_stream_map.c" 3 4
                         , 
# 849 "../ssl/quic/quic_stream_map.c"
...
{
    if (it->stream == 
# 855 "../ssl/quic/quic_stream_map.c" 3 4
                     ((void *)0)
# 855 "../ssl/quic/quic_stream_map.c"
                         )
        return;

    it->stream = list_next((&it->qsm->active_list), &(it->stream)->active_node, 
# 858 "../ssl/quic/quic_stream_map.c" 3 4
                __builtin_offsetof (
# 858 "../ssl/quic/quic_stream_map.c"
                QUIC_STREAM
# 858 "../ssl/quic/quic_stream_map.c" 3 4
                , 
# 858 "../ssl/quic/quic_stream_map.c"
...
# 858 "../ssl/quic/quic_stream_map.c"
    ...
    if (it->stream == it->first_stream)
        it->stream = 
# 860 "../ssl/quic/quic_stream_map.c" 3 4
                    ((void *)0)
# 860 "../ssl/quic/quic_stream_map.c"
                        ;
}
