# 0 "../ssl/quic/uint_set.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/uint_set.c"
# 10 "../ssl/quic/uint_set.c"
...
# 12 "../ssl/quic/uint_set.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 13 "../ssl/quic/uint_set.c" 2
# 60 "../ssl/quic/uint_set.c"
void ossl_uint_set_init(UINT_SET *s)
{
...
void ossl_uint_set_destroy(UINT_SET *s)
{
    ...
    for (x = ossl_list_uint_set_head(s); x != 
# 69 "../ssl/quic/uint_set.c" 3 4
                                             ((void *)0)
# 69 "../ssl/quic/uint_set.c"
                                                 ; x = xnext) {
        xnext = ossl_list_uint_set_next(x);
        CRYPTO_free(x, "../ssl/quic/uint_set.c", 71);
    }
}
...
static void uint_set_merge_adjacent(UINT_SET *s, UINT_SET_ITEM *x)
{
    ...
    if (xprev == 
# 80 "../ssl/quic/uint_set.c" 3 4
                ((void *)0)
# 80 "../ssl/quic/uint_set.c"
                    )
        return;
    ...
    CRYPTO_free(xprev, "../ssl/quic/uint_set.c", 88);
}
...
{
    UINT_SET_ITEM *x = CRYPTO_malloc(sizeof(UINT_SET_ITEM), "../ssl/quic/uint_set.c", 114);

    if (x == 
# 116 "../ssl/quic/uint_set.c" 3 4
            ((void *)0)
# 116 "../ssl/quic/uint_set.c"
                )
        return 
# 117 "../ssl/quic/uint_set.c" 3 4
              ((void *)0)
# 117 "../ssl/quic/uint_set.c"
                  ;
...
int ossl_uint_set_insert(UINT_SET *s, const UINT_RANGE *range)
{
    ...
    if (!__builtin_expect(!!((start <= end) != 0), 1))
        return 0;
    ...
    if (ossl_list_uint_set_is_empty(s)) {
        ...
        if (x == 
# 136 "../ssl/quic/uint_set.c" 3 4
                ((void *)0)
# 136 "../ssl/quic/uint_set.c"
                    )
            return 0;
    ...
    if (start > z->range.end) {
        ...
        x = create_set_item(start, end);
        if (x == 
# 157 "../ssl/quic/uint_set.c" 3 4
                ((void *)0)
# 157 "../ssl/quic/uint_set.c"
                    )
            return 0;
    ...
    if (start <= f->range.start && end >= z->range.end) {
        ...
        x->range.start = start;
        x->range.end = end;
        for (x = ossl_list_uint_set_next(x); x != 
# 174 "../ssl/quic/uint_set.c" 3 4
                                                 ((void *)0)
# 174 "../ssl/quic/uint_set.c"
                                                     ; x = xnext) {
            xnext = ossl_list_uint_set_next(x);
...
# 188 "../ssl/quic/uint_set.c"
    z = end < f->range.start ? f : z;

    for (; z != 
# 190 "../ssl/quic/uint_set.c" 3 4
               ((void *)0)
# 190 "../ssl/quic/uint_set.c"
                   ; z = zprev) {
        ...
        if (uint_range_overlaps(&z->range, range)) {
            ...
            while (zprev != 
# 207 "../ssl/quic/uint_set.c" 3 4
                           ((void *)0) 
# 207 "../ssl/quic/uint_set.c"
            ...
            while (z != ovend) {
                ...
                ossl_list_uint_set_remove(s, x);
                CRYPTO_free(x, "../ssl/quic/uint_set.c", 218);
            }
            break;
        } else if (end < z->range.start
                    && (zprev == 
# 222 "../ssl/quic/uint_set.c" 3 4
                                ((void *)0) 
# 222 "../ssl/quic/uint_set.c"
                                     || start > zprev->range.end)) {
...
# 232 "../ssl/quic/uint_set.c" 3 4
                               ((void *)0) 
# 232 "../ssl/quic/uint_set.c"
                ...
                x = create_set_item(start, end);
                if (x == 
# 247 "../ssl/quic/uint_set.c" 3 4
                        ((void *)0)
# 247 "../ssl/quic/uint_set.c"
                            )
                    return 0;
...
int ossl_uint_set_remove(UINT_SET *s, const UINT_RANGE *range)
{
    ...
    for (z = ossl_list_uint_set_tail(s); z != 
# 267 "../ssl/quic/uint_set.c" 3 4
                                             ((void *)0)
# 267 "../ssl/quic/uint_set.c"
                                                 ; z = zprev) {
        zprev = ossl_list_uint_set_prev(z);
        ...
        if (start <= z->range.start && end >= z->range.end) {
            ...
            CRYPTO_free(z, "../ssl/quic/uint_set.c", 280);
...
# 287 "../ssl/quic/uint_set.c" 3 4
           ((void) (0))
# 287 "../ssl/quic/uint_set.c"
                                     ;
            z->range.start = end + 1;
...
# 295 "../ssl/quic/uint_set.c" 3 4
           ((void) (0))
# 295 "../ssl/quic/uint_set.c"
                                         ;
            
# 296 "../ssl/quic/uint_set.c" 3 4
           ((void) (0))
# 296 "../ssl/quic/uint_set.c"
                            ;
            z->range.end = start - 1;
            break;
...
# 311 "../ssl/quic/uint_set.c" 3 4
           ((void) (0))
# 311 "../ssl/quic/uint_set.c"
                                                         ;
        }
    }
...
int ossl_uint_set_query(const UINT_SET *s, uint64_t v)
{
    ...
    for (x = ossl_list_uint_set_tail(s); x != 
# 325 "../ssl/quic/uint_set.c" 3 4
                                             ((void *)0)
# 325 "../ssl/quic/uint_set.c"
