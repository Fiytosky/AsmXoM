# 0 "../ssl/quic/quic_statm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_statm.c"
# 10 "../ssl/quic/quic_statm.c"
...
int ossl_statm_init(OSSL_STATM *statm)
{
    statm->smoothed_rtt = ossl_ticks2time((333) * (((uint64_t)1000000000) / 1000));
    statm->latest_rtt = ossl_time_zero();
    statm->min_rtt = ossl_time_infinite();
    statm->rtt_variance = ossl_time_divide(ossl_ticks2time((333) * (((uint64_t)1000000000) / 1000)), 2);
