# 0 "../ssl/quic/quic_fifd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_fifd.c"
# 10 "../ssl/quic/quic_fifd.c"
# 1 "../include/internal/quic_fifd.h" 1
# 13 "../include/internal/quic_fifd.h"
...
# 14 "../include/internal/quic_fifd.h" 2
...
# 15 "../include/internal/quic_fifd.h" 2
...
# 16 "../include/internal/quic_cfq.h" 2
...
QUIC_CFQ_ITEM *ossl_quic_cfq_item_get_priority_next(const QUIC_CFQ_ITEM *item,
                                                    uint32_t pn_space);
# 16 "../include/internal/quic_fifd.h" 2
...
# 17 "../include/internal/quic_fifd.h" 2
...
# 18 "../include/internal/quic_fifd.h" 2
...
# 14 "../ssl/quic/quic_fifd.c" 3 4
((void) (0))
# 14 "../ssl/quic/quic_fifd.c"
...
{
    if (cfq == 
# 42 "../ssl/quic/quic_fifd.c" 3 4
              ((void *)0) 
# 42 "../ssl/quic/quic_fifd.c"
                   || ackm == 
# 42 "../ssl/quic/quic_fifd.c" 3 4
                              ((void *)0) 
# 42 "../ssl/quic/quic_fifd.c"
...
# 43 "../ssl/quic/quic_fifd.c"
       || get_sstream_by_id == 
# 43 "../ssl/quic/quic_fifd.c" 3 4
                               ((void *)0) 
# 43 "../ssl/quic/quic_fifd.c"
                                    || regen_frame == 
# 43 "../ssl/quic/quic_fifd.c" 3 4
...
static void on_acked(void *arg)
{
    ...
    for (i = 0; i < num_chunks; ++i) {
        ...
        if (sstream == 
# 81 "../ssl/quic/quic_fifd.c" 3 4
                      ((void *)0)
# 81 "../ssl/quic/quic_fifd.c"
                          )
            continue;
        ...
        if (chunks[i].has_fin && chunks[i].stream_id != 
# 89 "../ssl/quic/quic_fifd.c" 3 4
                                                       (18446744073709551615UL)
# 89 "../ssl/quic/quic_fifd.c"
                                                                 )
            ossl_quic_sstream_mark_acked_fin(sstream);

        if (chunks[i].has_stop_sending && chunks[i].stream_id != 
# 92 "../ssl/quic/quic_fifd.c" 3 4
                                                                (18446744073709551615UL)
# 92 "../ssl/quic/quic_fifd.c"
                                                                          )
            fifd->confirm_frame(0x05,
                                chunks[i].stream_id, pkt,
                                fifd->confirm_frame_arg);

        if (chunks[i].has_reset_stream && chunks[i].stream_id != 
# 97 "../ssl/quic/quic_fifd.c" 3 4
                                                                (18446744073709551615UL)
# 97 "../ssl/quic/quic_fifd.c"
                                                                          )
            fifd->confirm_frame(0x04,
                                chunks[i].stream_id, pkt,
                                fifd->confirm_frame_arg);
    ...
    for (cfq_item = pkt->retx_head; cfq_item != 
# 107 "../ssl/quic/quic_fifd.c" 3 4
                                               ((void *)0)
# 107 "../ssl/quic/quic_fifd.c"
...
{
    if (fifd->get_qlog_cb == 
# 117 "../ssl/quic/quic_fifd.c" 3 4
                            ((void *)0)
# 117 "../ssl/quic/quic_fifd.c"
                                )
        return 
# 118 "../ssl/quic/quic_fifd.c" 3 4
              ((void *)0)
# 118 "../ssl/quic/quic_fifd.c"
                  ;
...
static void on_lost(void *arg)
{
    ...
    for (i = 0; i < num_chunks; ++i) {
        sstream = fifd->get_sstream_by_id(chunks[i].stream_id,
                                          ...
                                          fifd->get_sstream_by_id_arg);
        if (sstream == 
# 140 "../ssl/quic/quic_fifd.c" 3 4
                      ((void *)0)
# 140 "../ssl/quic/quic_fifd.c"
                          )
            continue;
        ...
        if (chunks[i].has_fin && chunks[i].stream_id != 
# 157 "../ssl/quic/quic_fifd.c" 3 4
                                                       (18446744073709551615UL)
# 157 "../ssl/quic/quic_fifd.c"
                                                                 ) {
        ...
        if (chunks[i].has_stop_sending && chunks[i].stream_id != 
# 162 "../ssl/quic/quic_fifd.c" 3 4
                                                                (18446744073709551615UL)
# 162 "../ssl/quic/quic_fifd.c"
                                                                          )
            fifd->regen_frame(0x05,
                              chunks[i].stream_id, pkt,
                              fifd->regen_frame_arg);

        if (chunks[i].has_reset_stream && chunks[i].stream_id != 
# 167 "../ssl/quic/quic_fifd.c" 3 4
                                                                (18446744073709551615UL)
# 167 "../ssl/quic/quic_fifd.c"
                                                                          )
            fifd->regen_frame(0x04,
                              chunks[i].stream_id, pkt,
                              fifd->regen_frame_arg);
# 182 "../ssl/quic/quic_fifd.c"
        fifd->regen_frame(0x11,
                          chunks[i].stream_id,
                          pkt,
                          fifd->regen_frame_arg);

        if (sstream_updated && chunks[i].stream_id != 
# 187 "../ssl/quic/quic_fifd.c" 3 4
                                                     (18446744073709551615UL)
# 187 "../ssl/quic/quic_fifd.c"
                                                               )
    ...
    for (cfq_item = pkt->retx_head; cfq_item != 
# 193 "../ssl/quic/quic_fifd.c" 3 4
                                               ((void *)0)
# 193 "../ssl/quic/quic_fifd.c"
                                                   ; cfq_item = cfq_item_next) {
        cfq_item_next = cfq_item->pkt_next;
        ossl_quic_cfq_mark_lost(fifd->cfq, cfq_item, 
# 195 "../ssl/quic/quic_fifd.c" 3 4
                                                    (4294967295U)
# 195 "../ssl/quic/quic_fifd.c"
                                                              );
    }


    if (pkt->had_handshake_done_frame)
        fifd->regen_frame(0x1E,
                          
# 201 "../ssl/quic/quic_fifd.c" 3 4
                         (18446744073709551615UL)
# 201 "../ssl/quic/quic_fifd.c"
                                   , pkt,
                          fifd->regen_frame_arg);

    if (pkt->had_max_data_frame)
        fifd->regen_frame(0x10,
                          
# 206 "../ssl/quic/quic_fifd.c" 3 4
                         (18446744073709551615UL)
# 206 "../ssl/quic/quic_fifd.c"
                                   , pkt,
                          fifd->regen_frame_arg);

    if (pkt->had_max_streams_bidi_frame)
        fifd->regen_frame(0x12,
                          
# 211 "../ssl/quic/quic_fifd.c" 3 4
                         (18446744073709551615UL)
# 211 "../ssl/quic/quic_fifd.c"
                                   , pkt,
                          fifd->regen_frame_arg);

    if (pkt->had_max_streams_uni_frame)
        fifd->regen_frame(0x13,
                          
# 216 "../ssl/quic/quic_fifd.c" 3 4
                         (18446744073709551615UL)
# 216 "../ssl/quic/quic_fifd.c"
                                   , pkt,
                          fifd->regen_frame_arg);
    ...
    if (pkt->had_ack_frame)
        ...
        fifd->regen_frame(0x03,
                          
# 226 "../ssl/quic/quic_fifd.c" 3 4
                         (18446744073709551615UL)
# 226 "../ssl/quic/quic_fifd.c"
                                   , pkt,
                          fifd->regen_frame_arg);
...
static void on_discarded(void *arg)
{
    ...
    for (cfq_item = pkt->retx_head; cfq_item != 
# 244 "../ssl/quic/quic_fifd.c" 3 4
                                               ((void *)0)
# 244 "../ssl/quic/quic_fifd.c"
                                                   ; cfq_item = cfq_item_next) {
        cfq_item_next = cfq_item->pkt_next;
        ossl_quic_cfq_release(fifd->cfq, cfq_item);
    }
...
int ossl_quic_fifd_pkt_commit(QUIC_FIFD *fifd, QUIC_TXPIM_PKT *pkt)
{
    ...
    pkt->ackm_pkt.anext = pkt->ackm_pkt.lnext = 
# 267 "../ssl/quic/quic_fifd.c" 3 4
                                               ((void *)0)
# 267 "../ssl/quic/quic_fifd.c"
                                                   ;
    ...
    for (cfq_item = pkt->retx_head;
         cfq_item != 
# 274 "../ssl/quic/quic_fifd.c" 3 4
                    ((void *)0)
# 274 "../ssl/quic/quic_fifd.c"
                        ;
    ...
    for (i = 0; i < num_chunks; ++i) {
        sstream = fifd->get_sstream_by_id(chunks[i].stream_id,
                                          ...
                                          fifd->get_sstream_by_id_arg);
        if (sstream == 
# 288 "../ssl/quic/quic_fifd.c" 3 4
                      ((void *)0)
# 288 "../ssl/quic/quic_fifd.c"
                          )
            continue;
