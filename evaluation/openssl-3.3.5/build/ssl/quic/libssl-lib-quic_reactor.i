# 0 "../ssl/quic/quic_reactor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_reactor.c"
# 9 "../ssl/quic/quic_reactor.c"
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 17 "../include/internal/quic_reactor.h" 2
...
{
    if (r == 
# 37 "../ssl/quic/quic_reactor.c" 3 4
            ((void *)0)
# 37 "../ssl/quic/quic_reactor.c"
                )
        rtor->poll_r.type = 0;
    else
        rtor->poll_r = *r;
...
{
    if (w == 
# 48 "../ssl/quic/quic_reactor.c" 3 4
            ((void *)0)
# 48 "../ssl/quic/quic_reactor.c"
                )
        rtor->poll_w.type = 0;
    else
        rtor->poll_w = *w;
...
# 242 "../ssl/quic/quic_reactor.c"
    ...
    if (rfd == wfd) {
        pfds[npfd].fd = rfd;
        pfds[npfd].events = (rfd_want_read ? 
# 249 "../ssl/quic/quic_reactor.c" 3 4
                                             0x001 
# 249 "../ssl/quic/quic_reactor.c"
                                                     : 0)
                          | (wfd_want_write ? 
# 250 "../ssl/quic/quic_reactor.c" 3 4
                                             0x004 
# 250 "../ssl/quic/quic_reactor.c"
                                                     : 0);
        ...
        pfds[npfd].fd = rfd;
        pfds[npfd].events = (rfd_want_read ? 
# 255 "../ssl/quic/quic_reactor.c" 3 4
                                            0x001 
# 255 "../ssl/quic/quic_reactor.c"
                                                   : 0);
        if (rfd >= 0 && pfds[npfd].events != 0)
            ++npfd;

        pfds[npfd].fd = wfd;
        pfds[npfd].events = (wfd_want_write ? 
# 260 "../ssl/quic/quic_reactor.c" 3 4
                                             0x004 
# 260 "../ssl/quic/quic_reactor.c"
                                                     : 0);
        if (wfd >= 0 && pfds[npfd].events != 0)
            ++npfd;
    }

    if (!__builtin_expect(!!((npfd != 0 || !ossl_time_is_infinite(deadline)) != 0), 1))

        return 0;


    if (mutex != 
# 270 "../ssl/quic/quic_reactor.c" 3 4
                ((void *)0)
# 270 "../ssl/quic/quic_reactor.c"
                    )
    ...
    do {
        if (ossl_time_is_infinite(deadline)) {
            ...
            timeout_ms = (ossl_time2ticks(timeout) / (((uint64_t)1000000000) / 1000));
        }

        pres = poll(pfds, npfd, timeout_ms);
    } while (pres == -1 && (
# 284 "../ssl/quic/quic_reactor.c" 3 4
                          (*__errno_location ()) 
# 284 "../ssl/quic/quic_reactor.c"
                          == 
# 284 "../ssl/quic/quic_reactor.c" 3 4
                          4
# 284 "../ssl/quic/quic_reactor.c"
    ...
    if (mutex != 
# 287 "../ssl/quic/quic_reactor.c" 3 4
                ((void *)0)
# 287 "../ssl/quic/quic_reactor.c"
                    )
...
{
    if (d == 
# 297 "../ssl/quic/quic_reactor.c" 3 4
            ((void *)0) 
# 297 "../ssl/quic/quic_reactor.c"
                 || d->type == 0) {
        *fd = (-1);
        return 1;
    }
