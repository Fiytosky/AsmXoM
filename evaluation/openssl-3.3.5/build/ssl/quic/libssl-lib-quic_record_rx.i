# 0 "../ssl/quic/quic_record_rx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_record_rx.c"
# 10 "../ssl/quic/quic_record_rx.c"
...
# 11 "../ssl/quic/quic_record_rx.c" 2
...
# 18 "../include/internal/quic_demux.h" 2
...
uint64_t ossl_qrx_get_max_forged_pkt_count(OSSL_QRX *qrx,
                                           uint32_t enc_level);
# 12 "../ssl/quic/quic_record_rx.c" 2
...
void ossl_qrl_enc_level_set_discard(OSSL_QRL_ENC_LEVEL_SET *els,
                                    uint32_t enc_level);
# 13 "../ssl/quic/quic_record_rx.c" 2
...
# 14 "../ssl/quic/quic_record_rx.c" 2

# 1 "../ssl/quic/../ssl_local.h" 1
# 25 "../ssl/quic/../ssl_local.h"
...
# 16 "../ssl/quic/quic_record_rx.c" 2
...
# 24 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 24 "../ssl/quic/quic_record_rx.c"
                                          ;
...
# 31 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 31 "../ssl/quic/quic_record_rx.c"
                                          ;
    return (*bitf & (((uint64_t)1) << pkt_idx)) != 0;
}
# 42 "../ssl/quic/quic_record_rx.c"
typedef struct rxe_st RXE;

struct rxe_st {
    OSSL_QRX_PKT pkt;
    struct { RXE *next, *prev; } ossl_list_rxe;
...
typedef struct ossl_list_st_rxe OSSL_LIST_rxe; struct ossl_list_st_rxe { RXE *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_rxe_init(OSSL_LIST_rxe *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_rxe_init_elem(RXE *elem) { memset(&elem->ossl_list_rxe, 0, sizeof(elem->ossl_list_rxe)); } static __attribute__((unused)) inline int ossl_list_rxe_is_empty(const OSSL_LIST_rxe *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_rxe_num(const OSSL_LIST_rxe *list) { return list->num_elems; } static __attribute__((unused)) inline RXE * ossl_list_rxe_head(const OSSL_LIST_rxe *list) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; return list->alpha; } static __attribute__((unused)) inline RXE * ossl_list_rxe_tail(const OSSL_LIST_rxe *list) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; return list->omega; } static __attribute__((unused)) inline RXE * ossl_list_rxe_next(const RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; return elem->ossl_list_rxe.next; } static __attribute__((unused)) inline RXE * ossl_list_rxe_prev(const RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; return elem->ossl_list_rxe.prev; } static __attribute__((unused)) inline void ossl_list_rxe_remove(OSSL_LIST_rxe *list, RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_rxe.next; if (list->omega == elem) list->omega = elem->ossl_list_rxe.prev; if (elem->ossl_list_rxe.prev != 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) elem->ossl_list_rxe.prev->ossl_list_rxe.next = elem->ossl_list_rxe.next; if (elem->ossl_list_rxe.next != 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) elem->ossl_list_rxe.next->ossl_list_rxe.prev = elem->ossl_list_rxe.prev; list->num_elems--; memset(&elem->ossl_list_rxe, 0, sizeof(elem->ossl_list_rxe)); } static __attribute__((unused)) inline void ossl_list_rxe_insert_head(OSSL_LIST_rxe *list, RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; if (list->alpha != 
...
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) list->alpha->ossl_list_rxe.prev = elem; elem->ossl_list_rxe.next = list->alpha; elem->ossl_list_rxe.prev = 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_rxe_insert_tail(OSSL_LIST_rxe *list, RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; if (list->omega != 
...
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) list->omega->ossl_list_rxe.next = elem; elem->ossl_list_rxe.prev = list->omega; elem->ossl_list_rxe.next = 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_rxe_insert_before(OSSL_LIST_rxe *list, RXE *e, RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; elem->ossl_list_rxe.next = e; elem->ossl_list_rxe.prev = e->ossl_list_rxe.prev; if (e->ossl_list_rxe.prev != 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) e->ossl_list_rxe.prev->ossl_list_rxe.next = elem; e->ossl_list_rxe.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_rxe_insert_after(OSSL_LIST_rxe *list, RXE *e, RXE *elem) { 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void) (0))
# 82 "../ssl/quic/quic_record_rx.c"
; elem->ossl_list_rxe.prev = e; elem->ossl_list_rxe.next = e->ossl_list_rxe.next; if (e->ossl_list_rxe.next != 
# 82 "../ssl/quic/quic_record_rx.c" 3 4
((void *)0)
# 82 "../ssl/quic/quic_record_rx.c"
) e->ossl_list_rxe.next->ossl_list_rxe.prev = elem; e->ossl_list_rxe.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_rxe;
typedef OSSL_LIST_rxe RXE_LIST;
...
OSSL_QRX *ossl_qrx_new(const OSSL_QRX_ARGS *args)
{
    ...
    if (args->demux == 
# 181 "../ssl/quic/quic_record_rx.c" 3 4
                      ((void *)0) 
# 181 "../ssl/quic/quic_record_rx.c"
                           || args->max_deferred == 0)
        return 
# 182 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 182 "../ssl/quic/quic_record_rx.c"
                  ;

    qrx = CRYPTO_zalloc(sizeof(OSSL_QRX), "../ssl/quic/quic_record_rx.c", 184);
    if (qrx == 
# 185 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 185 "../ssl/quic/quic_record_rx.c"
                  )
        return 
# 186 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 186 "../ssl/quic/quic_record_rx.c"
                  ;

    for (i = 0; i < (sizeof(qrx->largest_pn)/sizeof((qrx->largest_pn)[0])); ++i)
...
static void qrx_cleanup_rxl(RXE_LIST *l)
{
    ...
    for (e = ossl_list_rxe_head(l); e != 
# 204 "../ssl/quic/quic_record_rx.c" 3 4
                                        ((void *)0)
# 204 "../ssl/quic/quic_record_rx.c"
                                            ; e = enext) {
        enext = ossl_list_rxe_next(e);
        ossl_list_rxe_remove(l, e);
        CRYPTO_free(e, "../ssl/quic/quic_record_rx.c", 207);
    }
}
...
static void qrx_cleanup_urxl(OSSL_QRX *qrx, QUIC_URXE_LIST *l)
{
    ...
    for (e = ossl_list_urxe_head(l); e != 
# 215 "../ssl/quic/quic_record_rx.c" 3 4
                                         ((void *)0)
# 215 "../ssl/quic/quic_record_rx.c"
                                             ; e = enext) {
...
void ossl_qrx_free(OSSL_QRX *qrx)
{
    ...
    if (qrx == 
# 226 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 226 "../ssl/quic/quic_record_rx.c"
                  )
        return;
    ...
    CRYPTO_free(qrx, "../ssl/quic/quic_record_rx.c", 239);
}
...
void ossl_qrx_inject_urxe(OSSL_QRX *qrx, QUIC_URXE *urxe)
{
    ...
    if (qrx->msg_callback != 
# 250 "../ssl/quic/quic_record_rx.c" 3 4
                            ((void *)0)
# 250 "../ssl/quic/quic_record_rx.c"
                                )
        qrx->msg_callback(0, 0x0000001, 0x200, urxe + 1,
...
static void qrx_requeue_deferred(OSSL_QRX *qrx)
{
    ...
    while ((e = ossl_list_urxe_head(&qrx->urx_deferred)) != 
# 260 "../ssl/quic/quic_record_rx.c" 3 4
                                                           ((void *)0)
# 260 "../ssl/quic/quic_record_rx.c"
                                                               ) {
...
static RXE *qrx_pop_pending_rxe(OSSL_QRX *qrx)
{
    ...
    if (rxe == 
# 321 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 321 "../ssl/quic/quic_record_rx.c"
                  )
        return 
# 322 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 322 "../ssl/quic/quic_record_rx.c"
                  ;
...
static RXE *qrx_alloc_rxe(size_t alloc_len)
{
    ...
    if (alloc_len >= 
# 333 "../ssl/quic/quic_record_rx.c" 3 4
                    (18446744073709551615UL) 
# 333 "../ssl/quic/quic_record_rx.c"
                             - sizeof(RXE))
        return 
# 334 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 334 "../ssl/quic/quic_record_rx.c"
                  ;

    rxe = CRYPTO_malloc(sizeof(RXE) + alloc_len, "../ssl/quic/quic_record_rx.c", 336);
    if (rxe == 
# 337 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 337 "../ssl/quic/quic_record_rx.c"
                  )
        return 
# 338 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 338 "../ssl/quic/quic_record_rx.c"
                  ;
...
# 354 "../ssl/quic/quic_record_rx.c"
static RXE *qrx_ensure_free_rxe(OSSL_QRX *qrx, size_t alloc_len)
{
    RXE *rxe;

    if (ossl_list_rxe_head(&qrx->rx_free) != 
# 358 "../ssl/quic/quic_record_rx.c" 3 4
                                            ((void *)0)
# 358 "../ssl/quic/quic_record_rx.c"
                                                )
        return ossl_list_rxe_head(&qrx->rx_free);

    rxe = qrx_alloc_rxe(alloc_len);
    if (rxe == 
# 362 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 362 "../ssl/quic/quic_record_rx.c"
                  )
        return 
# 363 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 363 "../ssl/quic/quic_record_rx.c"
                  ;
...
static RXE *qrx_resize_rxe(RXE_LIST *rxl, RXE *rxe, size_t n)
{
    ...
    if (rxe == 
# 379 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 379 "../ssl/quic/quic_record_rx.c"
                  )
        return 
# 380 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 380 "../ssl/quic/quic_record_rx.c"
                  ;

    if (n >= 
# 382 "../ssl/quic/quic_record_rx.c" 3 4
            (18446744073709551615UL) 
# 382 "../ssl/quic/quic_record_rx.c"
                     - sizeof(RXE))
        return 
# 383 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 383 "../ssl/quic/quic_record_rx.c"
                  ;
    ...
    if (!__builtin_expect(!!((rxe->refcount == 0) != 0), 1))
        return 
# 391 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 391 "../ssl/quic/quic_record_rx.c"
                  ;
    ...
    rxe2 = CRYPTO_realloc(rxe, sizeof(RXE) + n, "../ssl/quic/quic_record_rx.c", 397);
    if (rxe2 == 
# 398 "../ssl/quic/quic_record_rx.c" 3 4
               ((void *)0)
# 398 "../ssl/quic/quic_record_rx.c"
                   ) {

        if (p == 
# 400 "../ssl/quic/quic_record_rx.c" 3 4
                ((void *)0)
# 400 "../ssl/quic/quic_record_rx.c"
                    )
            ossl_list_rxe_insert_head(rxl, rxe);
        else
            ossl_list_rxe_insert_after(rxl, p, rxe);
        return 
# 404 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 404 "../ssl/quic/quic_record_rx.c"
                  ;
    }

    if (p == 
# 407 "../ssl/quic/quic_record_rx.c" 3 4
            ((void *)0)
# 407 "../ssl/quic/quic_record_rx.c"
                )
...
# 433 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 433 "../ssl/quic/quic_record_rx.c"
                                                                             ;
    rxe->pkt.hdr = 
# 434 "../ssl/quic/quic_record_rx.c" 3 4
                     ((void *)0)
# 434 "../ssl/quic/quic_record_rx.c"
                         ;
    rxe->pkt.peer = 
# 435 "../ssl/quic/quic_record_rx.c" 3 4
                     ((void *)0)
# 435 "../ssl/quic/quic_record_rx.c"
                         ;
    rxe->pkt.local = 
# 436 "../ssl/quic/quic_record_rx.c" 3 4
                     ((void *)0)
# 436 "../ssl/quic/quic_record_rx.c"
                         ;
    ossl_list_rxe_insert_tail(&qrx->rx_free, rxe);
}
# 447 "../ssl/quic/quic_record_rx.c"
...
# 456 "../ssl/quic/quic_record_rx.c" 3 4
                                                                       ((void *)0)
# 456 "../ssl/quic/quic_record_rx.c"
                                                                           )
        return 0;
...
# 481 "../ssl/quic/quic_record_rx.c" 3 4
           ((void) (0))
# 481 "../ssl/quic/quic_record_rx.c"
                    ;
        case 4:
        case 6:
            return QUIC_ENC_LEVEL_INITIAL;
                                  ...
                                  const QUIC_CONN_ID *first_dcid)
{
    ...
    if (rxe->hdr.version != ((uint32_t)1)
        && rxe->hdr.version != ((uint32_t)0))
        return 0;
    ...
    if (first_dcid != 
# 509 "../ssl/quic/quic_record_rx.c" 3 4
                     ((void *)0) 
# 509 "../ssl/quic/quic_record_rx.c"
    ...
    if (first_dcid != 
# 516 "../ssl/quic/quic_record_rx.c" 3 4
                     ((void *)0)
# 516 "../ssl/quic/quic_record_rx.c"
                         ) {
        if (!__builtin_expect(!!((first_dcid->id_len < 20) != 0), 1)
...
static int qrx_validate_hdr_late(OSSL_QRX *qrx, RXE *rxe)
{
    ...
    if (qrx->validation_cb != 
# 548 "../ssl/quic/quic_record_rx.c" 3 4
                             ((void *)0)
        
# 549 "../ssl/quic/quic_record_rx.c"
                                     ...
                                     int *is_old_key)
{
    ...
    *is_old_key = 0;
    ...
    if (!__builtin_expect(!!((key_phase_bit <= 1) != 0), 1))
        return 
# 575 "../ssl/quic/quic_record_rx.c" 3 4
              (18446744073709551615UL)
# 575 "../ssl/quic/quic_record_rx.c"
                      ;
# 600 "../ssl/quic/quic_record_rx.c"
    idx = (el->state == 3 ? el->key_epoch & 1
                                                   : key_phase_bit);
...
# 678 "../ssl/quic/quic_record_rx.c" 3 4
        ((void *)0)
# 678 "../ssl/quic/quic_record_rx.c"
        ) != 0), 1))
        return 0;
    ...
    if (!__builtin_expect(!!((cctx_idx < (sizeof(el->cctx)/sizeof((el->cctx)[0]))) != 0), 1))
        return 0;

    if (is_old_key && pn >= qrx->cur_epoch_start_pn)
# 707 "../ssl/quic/quic_record_rx.c"
        return 0;
...
# 721 "../ssl/quic/quic_record_rx.c" 3 4
                               ((void *)0)
# 721 "../ssl/quic/quic_record_rx.c"
                                   ,
                          
# 722 "../ssl/quic/quic_record_rx.c" 3 4
                         ((void *)0)
# 722 "../ssl/quic/quic_record_rx.c"
                             , 
# 722 "../ssl/quic/quic_record_rx.c" 3 4
                               ((void *)0)
# 722 "../ssl/quic/quic_record_rx.c"
    ...
    if (EVP_CIPHER_CTX_ctrl(cctx, 0x11,
                            el->tag_len,
...
# 732 "../ssl/quic/quic_record_rx.c" 3 4
                              ((void *)0)
# 732 "../ssl/quic/quic_record_rx.c"
                                  , &l, aad, aad_len) != 1)
        return 0;
    ...
    if (EVP_CipherUpdate(cctx, dst, &l, src, src_len - el->tag_len) != 1)
        return 0;
# 752 "../ssl/quic/quic_record_rx.c"
    if (EVP_CipherFinal_ex(cctx, 
# 752 "../ssl/quic/quic_record_rx.c" 3 4
                                ((void *)0)
# 752 "../ssl/quic/quic_record_rx.c"
                                    , &l2) != 1) {
...
static void qrx_key_update_initiated(OSSL_QRX *qrx, QUIC_PN pn)
{
    ...
    if (qrx->key_update_cb != 
# 776 "../ssl/quic/quic_record_rx.c" 3 4
                             ((void *)0)
# 776 "../ssl/quic/quic_record_rx.c"
                                 )
...
# 787 "../ssl/quic/quic_record_rx.c" 3 4
                              ((void *)0)
# 787 "../ssl/quic/quic_record_rx.c"
                                  ;
...
# 795 "../ssl/quic/quic_record_rx.c" 3 4
                            ((void *)0)
# 795 "../ssl/quic/quic_record_rx.c"
                                ;
    uint64_t rx_key_epoch = 
# 796 "../ssl/quic/quic_record_rx.c" 3 4
                           (18446744073709551615UL)
# 796 "../ssl/quic/quic_record_rx.c"
                                     ;
    ...
    if (rxe == 
# 803 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 803 "../ssl/quic/quic_record_rx.c"
                  )
        return 0;
    ...
    if (already_processed
        || !qrx_validate_hdr_early(qrx, rxe, pkt_idx == 0 ? 
# 839 "../ssl/quic/quic_record_rx.c" 3 4
                                                           ((void *)0) 
# 839 "../ssl/quic/quic_record_rx.c"
                                                                : first_dcid))
...
# 854 "../ssl/quic/quic_record_rx.c" 3 4
                                                                        ((void *)0)
# 854 "../ssl/quic/quic_record_rx.c"
                                                                            )
        ...
        rxe->pn = 
# 866 "../ssl/quic/quic_record_rx.c" 3 4
                         (18446744073709551615UL)
# 866 "../ssl/quic/quic_record_rx.c"
                                        ;
...
# 940 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 940 "../ssl/quic/quic_record_rx.c"
                     ;
    ...
    if (need_second_decode) {
        ...
        if (ossl_quic_wire_decode_pkt_hdr(pkt, qrx->short_conn_id_len,
                                          0, 0, &rxe->hdr, 
# 954 "../ssl/quic/quic_record_rx.c" 3 4
                                                          ((void *)0)
# 954 "../ssl/quic/quic_record_rx.c"
                                                              ) != 1)
            goto malformed;
    }
    ...
    if (qrx->msg_callback != 
# 962 "../ssl/quic/quic_record_rx.c" 3 4
                            ((void *)0)
# 962 "../ssl/quic/quic_record_rx.c"
                                )
        qrx->msg_callback(0, 0x0000001, 0x201, sop,
...
# 975 "../ssl/quic/quic_record_rx.c" 3 4
                                                                        ((void *)0)
# 975 "../ssl/quic/quic_record_rx.c"
                                                                            ) {
        ...
        eop = 
# 981 "../ssl/quic/quic_record_rx.c" 3 4
             ((void *)0)
# 981 "../ssl/quic/quic_record_rx.c"
                 ;
        goto malformed;
    }
# 998 "../ssl/quic/quic_record_rx.c"
    ...
    if (!qrx_decrypt_pkt_body(qrx, dst, rxe->hdr.data, rxe->hdr.len,
        ...
        goto malformed;
# 1015 "../ssl/quic/quic_record_rx.c"
...
# 1038 "../ssl/quic/quic_record_rx.c"
    pkt_mark(&urxe->processed, pkt_idx);
...
# 1072 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 1072 "../ssl/quic/quic_record_rx.c"
                                                 ;
...
malformed:
    if (eop != 
# 1081 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 1081 "../ssl/quic/quic_record_rx.c"
                  ) {
# 1090 "../ssl/quic/quic_record_rx.c"
        
# 1090 "../ssl/quic/quic_record_rx.c" 3 4
       ((void) (0))
# 1090 "../ssl/quic/quic_record_rx.c"
                                      ;
        pkt_mark(&urxe->processed, pkt_idx);
...
# 1104 "../ssl/quic/quic_record_rx.c"
        pkt_mark(&urxe->processed, pkt_idx);
                                ...
                                size_t data_len)
{
    ...
    for (; PACKET_remaining(&pkt) > 0; ++pkt_idx) {
        ...
        if (PACKET_remaining(&pkt) < 7
            || pkt_idx >= (sizeof(uint64_t) * 8))
            break;
# 1149 "../ssl/quic/quic_record_rx.c"
...
static int qrx_process_one_urxe(OSSL_QRX *qrx, QUIC_URXE *e)
{
    ...
    if (!__builtin_expect(!!((e == ossl_list_urxe_head(&qrx->urx_pending)) != 0), 1))
        return 0;
...
static int qrx_process_pending_urxl(OSSL_QRX *qrx)
{
    ...
    while ((e = ossl_list_urxe_head(&qrx->urx_pending)) != 
# 1203 "../ssl/quic/quic_record_rx.c" 3 4
                                                          ((void *)0)
# 1203 "../ssl/quic/quic_record_rx.c"
                                                              )
...
int ossl_qrx_read_pkt(OSSL_QRX *qrx, OSSL_QRX_PKT **ppkt)
{
    ...
    if (!__builtin_expect(!!((rxe != 
# 1223 "../ssl/quic/quic_record_rx.c" 3 4
        ((void *)0)
# 1223 "../ssl/quic/quic_record_rx.c"
        ) != 0), 1))
        return 0;

    
# 1226 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 1226 "../ssl/quic/quic_record_rx.c"
                             ;
    rxe->refcount = 1;
    ...
    rxe->pkt.peer
        = BIO_ADDR_family(&rxe->peer) != 
# 1234 "../ssl/quic/quic_record_rx.c" 3 4
                                        0 
# 1234 "../ssl/quic/quic_record_rx.c"
                                                  ? &rxe->peer : 
# 1234 "../ssl/quic/quic_record_rx.c" 3 4
                                                                 ((void *)0)
# 1234 "../ssl/quic/quic_record_rx.c"
                                                                     ;
    rxe->pkt.local
        = BIO_ADDR_family(&rxe->local) != 
# 1236 "../ssl/quic/quic_record_rx.c" 3 4
                                         0 
# 1236 "../ssl/quic/quic_record_rx.c"
                                                   ? &rxe->local : 
# 1236 "../ssl/quic/quic_record_rx.c" 3 4
                                                                   ((void *)0)
# 1236 "../ssl/quic/quic_record_rx.c"
...
void ossl_qrx_pkt_release(OSSL_QRX_PKT *pkt)
{
    ...
    if (pkt == 
# 1249 "../ssl/quic/quic_record_rx.c" 3 4
              ((void *)0)
# 1249 "../ssl/quic/quic_record_rx.c"
                  )
        return;

    rxe = (RXE *)pkt;
    
# 1253 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 1253 "../ssl/quic/quic_record_rx.c"
                            ;
    if (--rxe->refcount == 0)
...
# 1262 "../ssl/quic/quic_record_rx.c" 3 4
   ((void) (0))
# 1262 "../ssl/quic/quic_record_rx.c"
                            ;
    ++rxe->refcount;
}
...
uint64_t ossl_qrx_get_key_epoch(OSSL_QRX *qrx)
{
    ...
    return el == 
# 1299 "../ssl/quic/quic_record_rx.c" 3 4
                ((void *)0) 
# 1299 "../ssl/quic/quic_record_rx.c"
                     ? 
# 1299 "../ssl/quic/quic_record_rx.c" 3 4
                       (18446744073709551615UL) 
# 1299 "../ssl/quic/quic_record_rx.c"
...
int ossl_qrx_key_update_timeout(OSSL_QRX *qrx, int normal)
{
    ...
    if (el == 
# 1307 "../ssl/quic/quic_record_rx.c" 3 4
             ((void *)0)
# 1307 "../ssl/quic/quic_record_rx.c"
                 )
        return 0;
                                           ...
                                           uint32_t enc_level)
{
    ...
    return el == 
# 1334 "../ssl/quic/quic_record_rx.c" 3 4
                ((void *)0) 
# 1334 "../ssl/quic/quic_record_rx.c"
                     ? 
# 1334 "../ssl/quic/quic_record_rx.c" 3 4
                       (18446744073709551615UL)
        
# 1335 "../ssl/quic/quic_record_rx.c"
