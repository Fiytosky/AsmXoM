# 0 "../ssl/quic/quic_port.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_port.c"
# 10 "../ssl/quic/quic_port.c"
# 1 "../include/internal/quic_port.h" 1
...
# 13 "../include/internal/quic_port.h" 2
...
# 14 "../include/internal/quic_port.h" 2
...
# 13 "../include/internal/quic_reactor.h" 2
...
# 14 "../include/internal/quic_reactor.h" 2
...
# 15 "../include/internal/quic_reactor.h" 2
...
# 16 "../include/internal/quic_reactor.h" 2
...
int ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor,
                                       ...
                                       uint32_t flags,
                                       CRYPTO_MUTEX *mutex);
# 15 "../include/internal/quic_port.h" 2
...
# 16 "../include/internal/quic_port.h" 2
# 41 "../include/internal/quic_port.h"
...
void ossl_quic_port_subtick(QUIC_PORT *port, QUIC_TICK_RESULT *r,
                            uint32_t flags);
# 137 "../include/internal/quic_port.h"
void ossl_quic_port_raise_net_error(QUIC_PORT *port,
                                    QUIC_CHANNEL *triggering_ch);
# 11 "../ssl/quic/quic_port.c" 2
...
# 17 "../include/internal/quic_channel.h" 2
...
# 12 "../ssl/quic/quic_port.c" 2
# 1 "../include/internal/quic_lcidm.h" 1
# 12 "../include/internal/quic_lcidm.h"
        
# 106 "../include/internal/quic_lcidm.h"
...
# 233 "../include/internal/quic_lcidm.h"
...
int ossl_quic_lcidm_debug_add(QUIC_LCIDM *lcidm, void *opaque,
                              const QUIC_CONN_ID *lcid,
                              uint64_t seq_num);
# 13 "../ssl/quic/quic_port.c" 2
# 1 "../include/internal/quic_srtm.h" 1
# 12 "../include/internal/quic_srtm.h"
        
# 59 "../include/internal/quic_srtm.h"
...
# 99 "../include/internal/quic_srtm.h"
...
# 14 "../ssl/quic/quic_port.c" 2
# 1 "../ssl/quic/quic_port_local.h" 1
# 28 "../ssl/quic/quic_port_local.h"
typedef struct ossl_list_st_ch OSSL_LIST_ch; struct ossl_list_st_ch { QUIC_CHANNEL *alpha, *omega; size_t num_elems; };
...
struct quic_port_st {
    ...
    struct { QUIC_PORT *next, *prev; } ossl_list_port;
...
# 15 "../ssl/quic/quic_port.c" 2
# 1 "../ssl/quic/quic_channel_local.h" 1
# 11 "../ssl/quic/quic_channel_local.h"
...
# 12 "../ssl/quic/quic_channel_local.h" 2
...
# 26 "../include/internal/quic_record_rx.h"
...
# 20 "../include/internal/quic_stream_map.h" 2
...
# 13 "../ssl/quic/quic_channel_local.h" 2
# 30 "../ssl/quic/quic_channel_local.h"
struct quic_channel_st {
    ...
    struct { struct quic_channel_st *next, *prev; } ossl_list_ch;
    ...
    uint64_t rx_max_ack_delay;
    unsigned char rx_ack_delay_exp;


    uint16_t diag_num_rx_ack;
...
# 248 "../ssl/quic/quic_channel_local.h"
    QUIC_PN txku_pn;
...
# 266 "../ssl/quic/quic_channel_local.h"
...
# 307 "../ssl/quic/quic_channel_local.h"
...
# 340 "../ssl/quic/quic_channel_local.h"
...
# 401 "../ssl/quic/quic_channel_local.h"
    unsigned int rxku_in_progress : 1;
# 410 "../ssl/quic/quic_channel_local.h"
...
# 16 "../ssl/quic/quic_port.c" 2
# 1 "../ssl/quic/quic_engine_local.h" 1
# 13 "../ssl/quic/quic_engine_local.h"
# 1 "../include/internal/quic_engine.h" 1
# 39 "../include/internal/quic_engine.h"
typedef struct quic_engine_args_st {
    OSSL_LIB_CTX *libctx;
    const char *propq;
# 54 "../include/internal/quic_engine.h"
    CRYPTO_MUTEX *mutex;
...
# 14 "../ssl/quic/quic_engine_local.h" 2
# 28 "../ssl/quic/quic_engine_local.h"
typedef struct ossl_list_st_port OSSL_LIST_port; struct ossl_list_st_port { QUIC_PORT *alpha, *omega; size_t num_elems; };
...
struct quic_engine_st {
    ...
    OSSL_LIST_port port_list;


    unsigned int inhibit_tick : 1;
};
# 17 "../ssl/quic/quic_port.c" 2
# 1 "../ssl/quic/../ssl_local.h" 1
# 30 "../ssl/quic/../ssl_local.h"
...
# 37 "../ssl/quic/../ssl_local.h" 2
# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 38 "../ssl/quic/../ssl_local.h" 2


# 1 "../ssl/quic/../record/record.h" 1
# 22 "../ssl/quic/../record/record.h"
...
# 41 "../ssl/quic/../ssl_local.h" 2
# 386 "../ssl/quic/../ssl_local.h"
typedef enum {
    SSL_PHA_NONE = 0,
    SSL_PHA_EXT_SENT,
...
# 1835 "../ssl/quic/../ssl_local.h"
# 1 "../ssl/quic/../quic/quic_local.h" 1
# 14 "../ssl/quic/../quic/quic_local.h"
...
int ossl_quic_conn_poll_events(SSL *ssl, uint64_t events, int do_tick,
                               uint64_t *revents);
# 15 "../ssl/quic/../quic/quic_local.h" 2
...
void ossl_quic_tx_packetiser_set_ack_tx_cb(OSSL_QUIC_TX_PACKETISER *txp,
                                           void (*cb)(const OSSL_QUIC_FRAME_ACK *ack,
                                                      ...
                                                      void *arg),
                                           void *cb_arg);
# 16 "../ssl/quic/../quic/quic_local.h" 2
...
# 20 "../ssl/quic/../quic/quic_local.h" 2
...
# 25 "../ssl/quic/../quic/quic_local.h" 2
# 1 "../ssl/quic/../quic/../ssl_local.h" 1
# 26 "../ssl/quic/../quic/quic_local.h" 2
# 34 "../ssl/quic/../quic/quic_local.h"
struct quic_xso_st {
...
struct quic_conn_st {
    ...
    QUIC_PORT *port;
# 151 "../ssl/quic/../quic/quic_local.h"
    QUIC_CHANNEL *ch;
...
# 1836 "../ssl/quic/../ssl_local.h" 2
# 1858 "../ssl/quic/../ssl_local.h"
...
# 2182 "../ssl/quic/../ssl_local.h"
typedef enum downgrade_en {
    DOWNGRADE_NONE,
    DOWNGRADE_TO_1_2,
    DOWNGRADE_TO_1_1
} DOWNGRADE;
# 2246 "../ssl/quic/../ssl_local.h"
...
# 2424 "../ssl/quic/../ssl_local.h" 3 4
                                             ((void *)0)
        
# 2425 "../ssl/quic/../ssl_local.h"
       && sc->cert->pkeys[idx].x509 == 
# 2425 "../ssl/quic/../ssl_local.h" 3 4
                                       ((void *)0)
# 2425 "../ssl/quic/../ssl_local.h"
                                           ;
}
...
static inline int ssl_has_cert_type(const SSL_CONNECTION *sc, unsigned char ct)
{
    ...
    if (ptr == 
# 2441 "../ssl/quic/../ssl_local.h" 3 4
              ((void *)0)
# 2441 "../ssl/quic/../ssl_local.h"
                  )
        return 0;

    return memchr(ptr, ct, len) != 
# 2444 "../ssl/quic/../ssl_local.h" 3 4
                                  ((void *)0)
# 2444 "../ssl/quic/../ssl_local.h"
                                      ;
}
...
# 2455 "../ssl/quic/../ssl_local.h" 3 4
                                                ((void *)0)
# 2455 "../ssl/quic/../ssl_local.h"
                                                    ;

    return s->cert->pkeys[idx].x509 != 
# 2457 "../ssl/quic/../ssl_local.h" 3 4
                                      ((void *)0)
        
# 2458 "../ssl/quic/../ssl_local.h"
       && s->cert->pkeys[idx].privatekey != 
# 2458 "../ssl/quic/../ssl_local.h" 3 4
                                            ((void *)0)
# 2458 "../ssl/quic/../ssl_local.h"
                                                ;
}
...
# 2994 "../ssl/quic/../ssl_local.h" 3 4
       __atomic_fetch_add ((
# 2994 "../ssl/quic/../ssl_local.h"
       ((stat))
# 2994 "../ssl/quic/../ssl_local.h" 3 4
       ), (
# 2994 "../ssl/quic/../ssl_local.h"
...
static __attribute__((unused)) inline void ossl_list_ch_init(OSSL_LIST_ch *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_ch_init_elem(QUIC_CHANNEL *elem) { memset(&elem->ossl_list_ch, 0, sizeof(elem->ossl_list_ch)); } static __attribute__((unused)) inline int ossl_list_ch_is_empty(const OSSL_LIST_ch *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_ch_num(const OSSL_LIST_ch *list) { return list->num_elems; } static __attribute__((unused)) inline QUIC_CHANNEL * ossl_list_ch_head(const OSSL_LIST_ch *list) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; return list->alpha; } static __attribute__((unused)) inline QUIC_CHANNEL * ossl_list_ch_tail(const OSSL_LIST_ch *list) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; return list->omega; } static __attribute__((unused)) inline QUIC_CHANNEL * ossl_list_ch_next(const QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; return elem->ossl_list_ch.next; } static __attribute__((unused)) inline QUIC_CHANNEL * ossl_list_ch_prev(const QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; return elem->ossl_list_ch.prev; } static __attribute__((unused)) inline void ossl_list_ch_remove(OSSL_LIST_ch *list, QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_ch.next; if (list->omega == elem) list->omega = elem->ossl_list_ch.prev; if (elem->ossl_list_ch.prev != 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) elem->ossl_list_ch.prev->ossl_list_ch.next = elem->ossl_list_ch.next; if (elem->ossl_list_ch.next != 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) elem->ossl_list_ch.next->ossl_list_ch.prev = elem->ossl_list_ch.prev; list->num_elems--; memset(&elem->ossl_list_ch, 0, sizeof(elem->ossl_list_ch)); } static __attribute__((unused)) inline void ossl_list_ch_insert_head(OSSL_LIST_ch *list, QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; if (list->alpha != 
...
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) list->alpha->ossl_list_ch.prev = elem; elem->ossl_list_ch.next = list->alpha; elem->ossl_list_ch.prev = 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_ch_insert_tail(OSSL_LIST_ch *list, QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; if (list->omega != 
...
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) list->omega->ossl_list_ch.next = elem; elem->ossl_list_ch.prev = list->omega; elem->ossl_list_ch.next = 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_ch_insert_before(OSSL_LIST_ch *list, QUIC_CHANNEL *e, QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; elem->ossl_list_ch.next = e; elem->ossl_list_ch.prev = e->ossl_list_ch.prev; if (e->ossl_list_ch.prev != 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) e->ossl_list_ch.prev->ossl_list_ch.next = elem; e->ossl_list_ch.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_ch_insert_after(OSSL_LIST_ch *list, QUIC_CHANNEL *e, QUIC_CHANNEL *elem) { 
# 32 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 32 "../ssl/quic/quic_port.c"
; elem->ossl_list_ch.prev = e; elem->ossl_list_ch.next = e->ossl_list_ch.next; if (e->ossl_list_ch.next != 
# 32 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 32 "../ssl/quic/quic_port.c"
) e->ossl_list_ch.next->ossl_list_ch.prev = elem; e->ossl_list_ch.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_ch;
static __attribute__((unused)) inline void ossl_list_port_init(OSSL_LIST_port *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_port_init_elem(QUIC_PORT *elem) { memset(&elem->ossl_list_port, 0, sizeof(elem->ossl_list_port)); } static __attribute__((unused)) inline int ossl_list_port_is_empty(const OSSL_LIST_port *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_port_num(const OSSL_LIST_port *list) { return list->num_elems; } static __attribute__((unused)) inline QUIC_PORT * ossl_list_port_head(const OSSL_LIST_port *list) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; return list->alpha; } static __attribute__((unused)) inline QUIC_PORT * ossl_list_port_tail(const OSSL_LIST_port *list) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; return list->omega; } static __attribute__((unused)) inline QUIC_PORT * ossl_list_port_next(const QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; return elem->ossl_list_port.next; } static __attribute__((unused)) inline QUIC_PORT * ossl_list_port_prev(const QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; return elem->ossl_list_port.prev; } static __attribute__((unused)) inline void ossl_list_port_remove(OSSL_LIST_port *list, QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_port.next; if (list->omega == elem) list->omega = elem->ossl_list_port.prev; if (elem->ossl_list_port.prev != 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) elem->ossl_list_port.prev->ossl_list_port.next = elem->ossl_list_port.next; if (elem->ossl_list_port.next != 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) elem->ossl_list_port.next->ossl_list_port.prev = elem->ossl_list_port.prev; list->num_elems--; memset(&elem->ossl_list_port, 0, sizeof(elem->ossl_list_port)); } static __attribute__((unused)) inline void ossl_list_port_insert_head(OSSL_LIST_port *list, QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; if (list->alpha != 
...
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) list->alpha->ossl_list_port.prev = elem; elem->ossl_list_port.next = list->alpha; elem->ossl_list_port.prev = 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
; list->alpha = elem; if (list->omega == 
...
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_port_insert_tail(OSSL_LIST_port *list, QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; if (list->omega != 
...
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) list->omega->ossl_list_port.next = elem; elem->ossl_list_port.prev = list->omega; elem->ossl_list_port.next = 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
; list->omega = elem; if (list->alpha == 
...
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_port_insert_before(OSSL_LIST_port *list, QUIC_PORT *e, QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; elem->ossl_list_port.next = e; elem->ossl_list_port.prev = e->ossl_list_port.prev; if (e->ossl_list_port.prev != 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) e->ossl_list_port.prev->ossl_list_port.next = elem; e->ossl_list_port.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_port_insert_after(OSSL_LIST_port *list, QUIC_PORT *e, QUIC_PORT *elem) { 
# 33 "../ssl/quic/quic_port.c" 3 4
((void) (0))
# 33 "../ssl/quic/quic_port.c"
; elem->ossl_list_port.prev = e; elem->ossl_list_port.next = e->ossl_list_port.next; if (e->ossl_list_port.next != 
# 33 "../ssl/quic/quic_port.c" 3 4
((void *)0)
# 33 "../ssl/quic/quic_port.c"
) e->ossl_list_port.next->ossl_list_port.prev = elem; e->ossl_list_port.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_port;

QUIC_PORT *ossl_quic_port_new(const QUIC_PORT_ARGS *args)
{
    QUIC_PORT *port;

    if ((port = CRYPTO_zalloc(sizeof(QUIC_PORT), "../ssl/quic/quic_port.c", 39)) == 
# 39 "../ssl/quic/quic_port.c" 3 4
                                                     ((void *)0)
# 39 "../ssl/quic/quic_port.c"
                                                         )
        return 
# 40 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 40 "../ssl/quic/quic_port.c"
                  ;
    ...
    if (!port_init(port)) {
        CRYPTO_free(port, "../ssl/quic/quic_port.c", 47);
        return 
# 48 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 48 "../ssl/quic/quic_port.c"
                  ;
    }
...
{
    if (port == 
# 56 "../ssl/quic/quic_port.c" 3 4
               ((void *)0)
# 56 "../ssl/quic/quic_port.c"
                   )
        return;

    port_cleanup(port);
    CRYPTO_free(port, "../ssl/quic/quic_port.c", 60);
}

static int port_init(QUIC_PORT *port)
{
    size_t rx_short_dcid_len = (port->is_multi_conn ? 8 : 0);

    if (port->engine == 
# 67 "../ssl/quic/quic_port.c" 3 4
                       ((void *)0) 
# 67 "../ssl/quic/quic_port.c"
                            || port->channel_ctx == 
# 67 "../ssl/quic/quic_port.c" 3 4
                                                    ((void *)0)
# 67 "../ssl/quic/quic_port.c"
    ...
    if ((port->err_state = OSSL_ERR_STATE_new()) == 
# 70 "../ssl/quic/quic_port.c" 3 4
                                                   ((void *)0)
# 70 "../ssl/quic/quic_port.c"
                                                       )
        goto err;

    if ((port->demux = ossl_quic_demux_new( 
# 73 "../ssl/quic/quic_port.c" 3 4
                                                  ((void *)0)
# 73 "../ssl/quic/quic_port.c"
                                                      ,
                                                             rx_short_dcid_len,
                                           get_time, port)) == 
# 75 "../ssl/quic/quic_port.c" 3 4
                                                              ((void *)0)
# 75 "../ssl/quic/quic_port.c"
                                                                  )
        goto err;
    ...
    if ((port->srtm = ossl_quic_srtm_new(port->engine->libctx,
                                         port->engine->propq)) == 
# 83 "../ssl/quic/quic_port.c" 3 4
                                                                 ((void *)0)
# 83 "../ssl/quic/quic_port.c"
                                                                     )
        goto err;

    if ((port->lcidm = ossl_quic_lcidm_new(port->engine->libctx,
                                           rx_short_dcid_len)) == 
# 87 "../ssl/quic/quic_port.c" 3 4
                                                                 ((void *)0)
# 87 "../ssl/quic/quic_port.c"
                                                                     )
        goto err;

    port->rx_short_dcid_len = (unsigned char)rx_short_dcid_len;
    port->tx_init_dcid_len = 8;
...
# 105 "../ssl/quic/quic_port.c" 3 4
   ((void) (0))
# 105 "../ssl/quic/quic_port.c"
                                                     ;

    ossl_quic_demux_free(port->demux);
    port->demux = 
# 108 "../ssl/quic/quic_port.c" 3 4
                 ((void *)0)
# 108 "../ssl/quic/quic_port.c"
                     ;

    ossl_quic_srtm_free(port->srtm);
    port->srtm = 
# 111 "../ssl/quic/quic_port.c" 3 4
                ((void *)0)
# 111 "../ssl/quic/quic_port.c"
                    ;

    ossl_quic_lcidm_free(port->lcidm);
    port->lcidm = 
# 114 "../ssl/quic/quic_port.c" 3 4
                 ((void *)0)
# 114 "../ssl/quic/quic_port.c"
                     ;

    OSSL_ERR_STATE_free(port->err_state);
    port->err_state = 
# 117 "../ssl/quic/quic_port.c" 3 4
                     ((void *)0)
# 117 "../ssl/quic/quic_port.c"
                         ;
...
{
    if (d->type == 1 && d->value.fd < 0) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_port.c",187,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 187 "../ssl/quic/quic_port.c" 3 4
       ((void *)0)
# 187 "../ssl/quic/quic_port.c"
       );
        return 0;
    }
...
static int port_update_poll_desc(QUIC_PORT *port, BIO *net_bio, int for_write)
{
    ...
    if (net_bio == 
# 208 "../ssl/quic/quic_port.c" 3 4
                  ((void *)0)
        
# 209 "../ssl/quic/quic_port.c"
...
int ossl_quic_port_set_net_wbio(QUIC_PORT *port, BIO *net_wbio)
{
    ...
    for ((ch) = (ossl_list_ch_head(&port->channel_list)); (ch) != 
# 276 "../ssl/quic/quic_port.c" 3 4
   ((void *)0)
# 276 "../ssl/quic/quic_port.c"
   ; (ch) = ossl_list_ch_next(ch))
...
{
    SSL *tls = 
# 290 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 290 "../ssl/quic/quic_port.c"
                  ;
    SSL_CONNECTION *tls_conn = 
# 291 "../ssl/quic/quic_port.c" 3 4
                              ((void *)0)
# 291 "../ssl/quic/quic_port.c"
                                  ;

    tls = ossl_ssl_connection_new_int(port->channel_ctx, 
# 293 "../ssl/quic/quic_port.c" 3 4
                                                        ((void *)0)
# 293 "../ssl/quic/quic_port.c"
                                                            , TLS_method());
    if (tls == 
# 294 "../ssl/quic/quic_port.c" 3 4
              ((void *)0) 
# 294 "../ssl/quic/quic_port.c"
                   || (tls_conn = ((tls) == 
# 294 "../ssl/quic/quic_port.c" 3 4
                                  ((void *)0) 
# 294 "../ssl/quic/quic_port.c"
...
# 294 "../ssl/quic/quic_port.c" 3 4
                                  ((void *)0) 
# 294 "../ssl/quic/quic_port.c"
                                  : ((tls)->type == 0 ? ( SSL_CONNECTION *)(tls) : ((tls)->type == 1 ? ( SSL_CONNECTION *)(( QUIC_CONNECTION *)(tls))->tls : 
# 294 "../ssl/quic/quic_port.c" 3 4
                                  ((void *)0)
# 294 "../ssl/quic/quic_port.c"
                                  )))) == 
...
# 294 "../ssl/quic/quic_port.c"
        ...
        return 
# 295 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 295 "../ssl/quic/quic_port.c"
                  ;


    tls_conn->s3.flags |= 0x2000;


    tls_conn->options &= ((0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 | 0x0 ) | (((uint64_t)1 << (uint64_t)31) | ((uint64_t)1 << (uint64_t)11) | ((uint64_t)1 << (uint64_t)8) | ((uint64_t)1 << (uint64_t)18) | ((uint64_t)1 << (uint64_t)17) | ((uint64_t)1 << (uint64_t)25) | ((uint64_t)1 << (uint64_t)26) | ((uint64_t)1 << (uint64_t)28) | ((uint64_t)1 << (uint64_t)27) | ((uint64_t)1 << (uint64_t)26) | ((uint64_t)1 << (uint64_t)27) | ((uint64_t)1 << (uint64_t)16) | ((uint64_t)1 << (uint64_t)15) | ((uint64_t)1 << (uint64_t)30) | ((uint64_t)1 << (uint64_t)0) | ((uint64_t)1 << (uint64_t)19) | ((uint64_t)1 << (uint64_t)13) | ((uint64_t)1 << (uint64_t)2) | ((uint64_t)1 << (uint64_t)7) ) | ((uint64_t)1 << (uint64_t)22) | ((uint64_t)1 << (uint64_t)9) | ((uint64_t)1 << (uint64_t)32) | ((uint64_t)1 << (uint64_t)33) | ((uint64_t)1 << (uint64_t)21) | ((uint64_t)1 << (uint64_t)12) | ((uint64_t)1 << (uint64_t)14) | ((uint64_t)1 << (uint64_t)24) );
...
static QUIC_CHANNEL *port_make_channel(QUIC_PORT *port, SSL *tls, int is_server)
{
    ...
    args.tls = (tls != 
# 313 "../ssl/quic/quic_port.c" 3 4
                             ((void *)0) 
# 313 "../ssl/quic/quic_port.c"
                                  ? tls : port_new_handshake_layer(port));
    args.lcidm = port->lcidm;
    args.srtm = port->srtm;
    if (args.tls == 
# 316 "../ssl/quic/quic_port.c" 3 4
                   ((void *)0)
# 316 "../ssl/quic/quic_port.c"
                       )
        return 
# 317 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 317 "../ssl/quic/quic_port.c"
                  ;
    ...
    if (ch == 
# 325 "../ssl/quic/quic_port.c" 3 4
             ((void *)0)
# 325 "../ssl/quic/quic_port.c"
                 ) {
        if (tls == 
# 326 "../ssl/quic/quic_port.c" 3 4
                  ((void *)0)
# 326 "../ssl/quic/quic_port.c"
                      )
            SSL_free(args.tls);

        return 
# 329 "../ssl/quic/quic_port.c" 3 4
              ((void *)0)
# 329 "../ssl/quic/quic_port.c"
                  ;
    }
...
QUIC_CHANNEL *ossl_quic_port_create_outgoing(QUIC_PORT *port, SSL *tls)
{
    return port_make_channel(port, tls, 0);
}
...
# 344 "../ssl/quic/quic_port.c" 3 4
   ((void) (0))
# 344 "../ssl/quic/quic_port.c"
                                   ;

    ch = port_make_channel(port, tls, 1);
    port->tserver_ch = ch;
    port->is_server = 1;
    return ch;
}
# 361 "../ssl/quic/quic_port.c"
                            ...
                            uint32_t flags)
{
    ...
    if (!port->engine->inhibit_tick) {
        ...
        for ((ch) = (ossl_list_ch_head(&port->channel_list)); (ch) != 
# 376 "../ssl/quic/quic_port.c" 3 4
       ((void *)0)
# 376 "../ssl/quic/quic_port.c"
       ; (ch) = ossl_list_ch_next(ch)) {
...
# 421 "../ssl/quic/quic_port.c" 3 4
                                            ((void *)0)
# 421 "../ssl/quic/quic_port.c"
                                                );
}
...
{
    if (port->tserver_ch != 
# 434 "../ssl/quic/quic_port.c" 3 4
                           ((void *)0)
# 434 "../ssl/quic/quic_port.c"
                               ) {
        ...
        *new_ch = port->tserver_ch;
        port->tserver_ch = 
# 440 "../ssl/quic/quic_port.c" 3 4
                          ((void *)0)
# 440 "../ssl/quic/quic_port.c"
                              ;
        return;
    }
}
...
static int port_try_handle_stateless_reset(QUIC_PORT *port, const QUIC_URXE *e)
{
    ...
    void *opaque = 
# 449 "../ssl/quic/quic_port.c" 3 4
                  ((void *)0)
# 449 "../ssl/quic/quic_port.c"
                      ;
# 473 "../ssl/quic/quic_port.c"
    if (e->data_len < 16 + 5
        || (0100 & *data) != 0100)
        return 0;
    ...
    for (i = 0;; ++i) {
        if (!ossl_quic_srtm_lookup(port->srtm,
                                   ...
                                   i, &opaque, 
# 481 "../ssl/quic/quic_port.c" 3 4
                                              ((void *)0)
# 481 "../ssl/quic/quic_port.c"
                                                  ))
            break;

        
# 484 "../ssl/quic/quic_port.c" 3 4
       ((void) (0))
# 484 "../ssl/quic/quic_port.c"
                             ;
                                        ...
                                        const QUIC_CONN_ID *dcid)
{
    ...
    QUIC_PKT_HDR hdr;
    QUIC_CHANNEL *ch = 
# 501 "../ssl/quic/quic_port.c" 3 4
                      ((void *)0)
# 501 "../ssl/quic/quic_port.c"
                          , *new_ch = 
# 501 "../ssl/quic/quic_port.c" 3 4
                                      ((void *)0)
# 501 "../ssl/quic/quic_port.c"
    ...
    if (dcid != 
# 510 "../ssl/quic/quic_port.c" 3 4
               ((void *)0)
        
# 511 "../ssl/quic/quic_port.c"
       && ossl_quic_lcidm_lookup(port->lcidm, dcid, 
# 511 "../ssl/quic/quic_port.c" 3 4
                                                    ((void *)0)
# 511 "../ssl/quic/quic_port.c"
                                                        ,
                                  (void **)&ch)) {
        
# 513 "../ssl/quic/quic_port.c" 3 4
       ((void) (0))
# 513 "../ssl/quic/quic_port.c"
                         ;
        ossl_quic_channel_inject(ch, e);
        return;
    }
# 527 "../ssl/quic/quic_port.c"
    if (port->tserver_ch == 
# 527 "../ssl/quic/quic_port.c" 3 4
                           ((void *)0)
# 527 "../ssl/quic/quic_port.c"
                               )
        goto undesirable;
...
# 545 "../ssl/quic/quic_port.c" 3 4
                                            (18446744073709551615UL)
# 545 "../ssl/quic/quic_port.c"
                                                    , 1, 0, &hdr, 
# 545 "../ssl/quic/quic_port.c" 3 4
                                                                  ((void *)0)
# 545 "../ssl/quic/quic_port.c"
    ...
    if (hdr.type != 1)
        goto undesirable;
# 573 "../ssl/quic/quic_port.c"
    port_on_new_conn(port, &e->peer, &hdr.src_conn_id, &hdr.dst_conn_id,
                     &new_ch);
    if (new_ch != 
# 575 "../ssl/quic/quic_port.c" 3 4
                 ((void *)0)
# 575 "../ssl/quic/quic_port.c"
                     )
                                    ...
                                    QUIC_CHANNEL *triggering_ch)
{
    ...
    (ERR_new(), ERR_set_debug("../ssl/quic/quic_port.c",596,__func__), ERR_set_error)(20, 387,
    ...
    if (triggering_ch != 
# 603 "../ssl/quic/quic_port.c" 3 4
                        ((void *)0)
# 603 "../ssl/quic/quic_port.c"
                            )
        ossl_quic_channel_raise_net_error(triggering_ch);

    for ((ch) = (ossl_list_ch_head(&port->channel_list)); (ch) != 
# 606 "../ssl/quic/quic_port.c" 3 4
   ((void *)0)
# 606 "../ssl/quic/quic_port.c"
   ; (ch) = ossl_list_ch_next(ch))
        if (ch != triggering_ch)
