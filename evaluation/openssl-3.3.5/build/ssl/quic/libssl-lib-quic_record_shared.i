# 0 "../ssl/quic/quic_record_shared.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_record_shared.c"
# 1 "../ssl/quic/quic_record_shared.h" 1
# 13 "../ssl/quic/quic_record_shared.h"
...
# 14 "../ssl/quic/quic_record_shared.h" 2
...
# 15 "../ssl/quic/quic_record_shared.h" 2
...
int ossl_quic_calculate_retry_integrity_tag(OSSL_LIB_CTX *libctx,
                                            ...
                                            const QUIC_CONN_ID *client_initial_dcid,
                                            unsigned char *tag);
# 16 "../ssl/quic/quic_record_shared.h" 2
...
void ossl_qrl_enc_level_set_discard(OSSL_QRL_ENC_LEVEL_SET *els,
                                    uint32_t enc_level);
# 2 "../ssl/quic/quic_record_shared.c" 2
...
# 3 "../ssl/quic/quic_record_shared.c" 2
...
# 4 "../ssl/quic/quic_record_shared.c" 2
# 1 "../ssl/quic/../ssl_local.h" 1
# 18 "../ssl/quic/../ssl_local.h"
...
# 5 "../ssl/quic/quic_record_shared.c" 2


static const unsigned char quic_v1_iv_label[] = {
    0x71, 0x75, 0x69, 0x63, 0x20, 0x69, 0x76
};
static const unsigned char quic_v1_key_label[] = {
    0x71, 0x75, 0x69, 0x63, 0x20, 0x6b, 0x65, 0x79
};
static const unsigned char quic_v1_hp_label[] = {
    0x71, 0x75, 0x69, 0x63, 0x20, 0x68, 0x70
};
static const unsigned char quic_v1_ku_label[] = {
    0x71, 0x75, 0x69, 0x63, 0x20, 0x6b, 0x75
};
                                               ...
                                               int require_prov)
{
    ...
    if (!__builtin_expect(!!((enc_level < QUIC_ENC_LEVEL_NUM) != 0), 1))
        return 
# 27 "../ssl/quic/quic_record_shared.c" 3 4
              ((void *)0)
# 27 "../ssl/quic/quic_record_shared.c"
                  ;
    ...
    if (require_prov)
        switch (el->state) {
            ...
            default:
                return 
# 38 "../ssl/quic/quic_record_shared.c" 3 4
                      ((void *)0)
# 38 "../ssl/quic/quic_record_shared.c"
                          ;
        }
...
# 69 "../ssl/quic/quic_record_shared.c" 3 4
        ((void *)0) 
# 69 "../ssl/quic/quic_record_shared.c"
        && keyslot < 2) != 0), 1))
        return 0;
...
# 77 "../ssl/quic/quic_record_shared.c" 3 4
           ((void) (0))
# 77 "../ssl/quic/quic_record_shared.c"
                                                   ;
                                ...
                                size_t keyslot)
{
    ...
    if (el->cctx[keyslot] != 
# 93 "../ssl/quic/quic_record_shared.c" 3 4
                            ((void *)0)
# 93 "../ssl/quic/quic_record_shared.c"
                                ) {
        EVP_CIPHER_CTX_free(el->cctx[keyslot]);
        el->cctx[keyslot] = 
# 95 "../ssl/quic/quic_record_shared.c" 3 4
                           ((void *)0)
# 95 "../ssl/quic/quic_record_shared.c"
                               ;
    }
...
# 111 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 111 "../ssl/quic/quic_record_shared.c"
                                 ;
    EVP_CIPHER *cipher = 
# 112 "../ssl/quic/quic_record_shared.c" 3 4
                        ((void *)0)
# 112 "../ssl/quic/quic_record_shared.c"
                            ;
    EVP_CIPHER_CTX *cctx = 
# 113 "../ssl/quic/quic_record_shared.c" 3 4
                          ((void *)0)
# 113 "../ssl/quic/quic_record_shared.c"
                              ;

    if (!__builtin_expect(!!((el != 
# 115 "../ssl/quic/quic_record_shared.c" 3 4
        ((void *)0) 
# 115 "../ssl/quic/quic_record_shared.c"
        && ossl_qrl_enc_level_set_has_keyslot(els, enc_level, tgt_state, keyslot)) != 0), 1)

                                                                               ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",118,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 118 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 118 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
    ...
    if (cipher_name == 
# 125 "../ssl/quic/quic_record_shared.c" 3 4
                      ((void *)0)
# 125 "../ssl/quic/quic_record_shared.c"
                          ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",126,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 126 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 126 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
    ...
    if (secret_len != ossl_qrl_get_suite_secret_len(el->suite_id)
        || secret_len > 64) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",132,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 132 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 132 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }

    
# 136 "../ssl/quic/quic_record_shared.c" 3 4
   ((void) (0))
# 136 "../ssl/quic/quic_record_shared.c"
                                    ;
...
# 144 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 144 "../ssl/quic/quic_record_shared.c"
                                 , 0,
...
# 154 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 154 "../ssl/quic/quic_record_shared.c"
                                 , 0,
                              key, key_len, 1))
        goto err;
...
# 159 "../ssl/quic/quic_record_shared.c" 3 4
                                                                          ((void *)0)
# 159 "../ssl/quic/quic_record_shared.c"
                                                                              ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",160,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 160 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 160 "../ssl/quic/quic_record_shared.c"
       );
        goto err;
    }

    if ((cctx = EVP_CIPHER_CTX_new()) == 
# 164 "../ssl/quic/quic_record_shared.c" 3 4
                                        ((void *)0)
# 164 "../ssl/quic/quic_record_shared.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",165,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 165 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 165 "../ssl/quic/quic_record_shared.c"
       );
        goto err;
    }

    if (!__builtin_expect(!!((iv_len == (size_t)EVP_CIPHER_get_iv_length(cipher)) != 0), 1)
        || !__builtin_expect(!!((key_len == (size_t)EVP_CIPHER_get_key_length(cipher)) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",171,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 171 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 171 "../ssl/quic/quic_record_shared.c"
       );
        goto err;
    }
...
# 176 "../ssl/quic/quic_record_shared.c" 3 4
                                        ((void *)0)
# 176 "../ssl/quic/quic_record_shared.c"
                                            , key, el->iv[keyslot], 0)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",177,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 177 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 177 "../ssl/quic/quic_record_shared.c"
       );
        goto err;
    }
...
{
    OSSL_QRL_ENC_LEVEL *el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
    unsigned char ku_key[64], hpr_key[64];
    int have_ks0 = 0, have_ks1 = 0, own_md = 0;
    const char *md_name = ossl_qrl_get_suite_md_name(suite_id);
    size_t hpr_key_len, init_keyslot;

    if (el == 
# 213 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0)
        
# 214 "../ssl/quic/quic_record_shared.c"
       || md_name == 
# 214 "../ssl/quic/quic_record_shared.c" 3 4
                     ((void *)0)
        
# 215 "../ssl/quic/quic_record_shared.c"
       || init_key_phase_bit > 1 || is_tx < 0 || is_tx > 1
        || (init_key_phase_bit > 0 && enc_level != QUIC_ENC_LEVEL_1RTT)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",217,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 217 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 217 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
    ...
    if (el->state != 0) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",234,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 234 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 234 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
    ...
    if (hpr_key_len == 0) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",241,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 241 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 241 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }

    if (md == 
# 245 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0)
# 245 "../ssl/quic/quic_record_shared.c"
                 ) {
        md = EVP_MD_fetch(libctx, md_name, propq);
        if (md == 
# 247 "../ssl/quic/quic_record_shared.c" 3 4
                 ((void *)0)
# 247 "../ssl/quic/quic_record_shared.c"
                     ) {
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",248,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 248 "../ssl/quic/quic_record_shared.c" 3 4
           ((void *)0)
# 248 "../ssl/quic/quic_record_shared.c"
           );
            return 0;
        }
...
# 270 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 270 "../ssl/quic/quic_record_shared.c"
                                 , 0,
                              hpr_key, hpr_key_len, 1))
        goto err;


    if (!el_setup_keyslot(els, enc_level, 1,
...
# 288 "../ssl/quic/quic_record_shared.c" 3 4
                                 ((void *)0)
# 288 "../ssl/quic/quic_record_shared.c"
                                     , 0,
...
# 306 "../ssl/quic/quic_record_shared.c" 3 4
                                     ((void *)0)
# 306 "../ssl/quic/quic_record_shared.c"
                                         , 0,
                                      el->ku, secret_len, 1))
                goto err;
        }
 ...
 err:
    el->suite_id = 0;
    el->md = 
# 332 "../ssl/quic/quic_record_shared.c" 3 4
            ((void *)0)
# 332 "../ssl/quic/quic_record_shared.c"
                ;
    OPENSSL_cleanse(hpr_key, sizeof(hpr_key));
    OPENSSL_cleanse(ku_key, sizeof(ku_key));
                                      ...
                                      uint32_t enc_level)
{
    OSSL_QRL_ENC_LEVEL *el = ossl_qrl_enc_level_set_get(els, enc_level, 0);
    size_t secret_len;
    unsigned char new_ku[64];

    if (el == 
# 352 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0) 
# 352 "../ssl/quic/quic_record_shared.c"
                  || !__builtin_expect(!!((enc_level == QUIC_ENC_LEVEL_1RTT) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",353,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 353 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 353 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }

    if (el->state != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",358,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 358 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 358 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
...
# 382 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 382 "../ssl/quic/quic_record_shared.c"
                                 , 0,
                              new_ku, secret_len, 1))
        return 0;
                                           ...
                                           uint32_t enc_level)
{
    ...
    if (el == 
# 406 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0) 
# 406 "../ssl/quic/quic_record_shared.c"
                  || !__builtin_expect(!!((enc_level == QUIC_ENC_LEVEL_1RTT) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",407,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 407 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 407 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
                                             ...
                                             uint32_t enc_level)
{
    ...
    if (el == 
# 428 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0) 
# 428 "../ssl/quic/quic_record_shared.c"
                  || !__builtin_expect(!!((enc_level == QUIC_ENC_LEVEL_1RTT) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",429,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 429 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 429 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
    ...
    if (el->state == 2
        ...
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",435,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 435 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 435 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }

    if (el->state != 3) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_record_shared.c",440,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 440 "../ssl/quic/quic_record_shared.c" 3 4
       ((void *)0)
# 440 "../ssl/quic/quic_record_shared.c"
       );
        return 0;
    }
...
# 456 "../ssl/quic/quic_record_shared.c" 3 4
                             ((void *)0)
# 456 "../ssl/quic/quic_record_shared.c"
                                 , 0,
                              new_ku, secret_len, 1)) {
        el_teardown_keyslot(els, enc_level, ~el->key_epoch & 1);
        return 0;
                                    ...
                                    uint32_t enc_level)
{
    ...
    if (el == 
# 476 "../ssl/quic/quic_record_shared.c" 3 4
             ((void *)0) 
# 476 "../ssl/quic/quic_record_shared.c"
                  || el->state == 4)
        return;
    ...
    EVP_MD_free(el->md);
    el->md = 
# 487 "../ssl/quic/quic_record_shared.c" 3 4
                 ((void *)0)
# 487 "../ssl/quic/quic_record_shared.c"
                     ;
    el->state = 4;
}
