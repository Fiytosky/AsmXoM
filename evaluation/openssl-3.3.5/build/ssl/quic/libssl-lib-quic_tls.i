# 0 "../ssl/quic/quic_tls.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_tls.c"
# 9 "../ssl/quic/quic_tls.c"
...
# 15 "../include/internal/quic_tls.h" 2
...
# 12 "../ssl/quic/quic_tls.c" 2
# 1 "../ssl/quic/../ssl_local.h" 1
# 19 "../ssl/quic/../ssl_local.h"
...
{
    OSSL_RECORD_LAYER *rl = CRYPTO_zalloc(sizeof(*rl), "../ssl/quic/quic_tls.c", 105);
    uint32_t enc_level;
    int qdir;
    uint32_t suite_id = 0;

    if (rl == 
# 110 "../ssl/quic/quic_tls.c" 3 4
             ((void *)0)
# 110 "../ssl/quic/quic_tls.c"
                 ) {
        do { if ((rl) != 
# 111 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 111 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",111,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 111 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 111 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 111 "../ssl/quic/quic_tls.c"
    ...
    if (!quic_set1_bio(rl, transport)) {
        do { if ((rl) != 
# 118 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 118 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",118,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 118 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 118 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 118 "../ssl/quic/quic_tls.c"
    ...
    *retrl = rl;
    ...
    if (fns != 
# 124 "../ssl/quic/quic_tls.c" 3 4
              ((void *)0)
# 124 "../ssl/quic/quic_tls.c"
                  ) {
    ...
    default:
        do { if ((rl) != 
# 155 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 155 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",155,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 155 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 155 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 155 "../ssl/quic/quic_tls.c"
    ...
    if (EVP_CIPHER_is_a(ciph, "AES-128-GCM")) {
        ...
        do { if ((rl) != 
# 171 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 171 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",171,__func__), ERR_set_error)((20),((249)),
# 171 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 171 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 171 "../ssl/quic/quic_tls.c"
    ...
    if (!EVP_MD_up_ref((EVP_MD *)kdfdigest)) {
        do { if ((rl) != 
# 178 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 178 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",178,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 178 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 178 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 178 "../ssl/quic/quic_tls.c"
    ...
    if (!rl->qtls->args.yield_secret_cb(enc_level, qdir, suite_id,
        ...
        do { if ((rl) != 
# 185 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 185 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",185,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 185 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 185 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 185 "../ssl/quic/quic_tls.c"
 ...
 err:
    *retrl = 
# 192 "../ssl/quic/quic_tls.c" 3 4
            ((void *)0)
# 192 "../ssl/quic/quic_tls.c"
                ;
    quic_free(rl);
    return 0;
}
...
{
    if (rl == 
# 199 "../ssl/quic/quic_tls.c" 3 4
             ((void *)0)
# 199 "../ssl/quic/quic_tls.c"
                 )
        return 1;

    BIO_free(rl->dummybio);
    CRYPTO_free(rl, "../ssl/quic/quic_tls.c", 203);
    return 1;
}
                              ...
                              size_t numtempl)
{
    ...
    if (!__builtin_expect(!!((numtempl == 1) != 0), 1)) {

        do { if ((rl) != 
# 250 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 250 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",250,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 250 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 250 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 250 "../ssl/quic/quic_tls.c"
    ...
    BIO_clear_flags(rl->dummybio, ((0x01|0x02|0x04)|0x08));

    if (rl->msg_callback != 
# 256 "../ssl/quic/quic_tls.c" 3 4
                           ((void *)0)
# 256 "../ssl/quic/quic_tls.c"
                               ) {
        unsigned char dummyrec[5];





        dummyrec[0] = (rl->level == 0)
                        ? template->type
                        : 23;
        ...
        rl->msg_callback(1, 0x0304, 0x100, dummyrec,
                            5, rl->cbarg);

        if (rl->level != 0) {
            rl->msg_callback(1, 0x0304, 0x101,
    ...
    case 21:
        if (template->buflen != 2) {
            ...
            do { if ((rl) != 
# 294 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 294 "../ssl/quic/quic_tls.c"
           ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",294,__func__), ERR_set_error)((20),((384)),
# 294 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 294 "../ssl/quic/quic_tls.c"
           ); if ((rl) != 
...
# 294 "../ssl/quic/quic_tls.c"
        ...
        if (!rl->qtls->args.alert_cb(rl->qtls->args.alert_cb_arg, alert)) {
            do { if ((rl) != 
# 304 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 304 "../ssl/quic/quic_tls.c"
           ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",304,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 304 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 304 "../ssl/quic/quic_tls.c"
           ); if ((rl) != 
...
# 304 "../ssl/quic/quic_tls.c"
    ...
    case 22:
        ...
        if (!rl->qtls->args.crypto_send_cb(template->buf + rl->written,
            ...
            do { if ((rl) != 
# 318 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 318 "../ssl/quic/quic_tls.c"
           ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",318,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 318 "../ssl/quic/quic_tls.c" 3 4
           ((void *)0)
# 318 "../ssl/quic/quic_tls.c"
           ); if ((rl) != 
...
# 318 "../ssl/quic/quic_tls.c"
        ...
        if (consumed + rl->written != template->buflen) {
            if (!__builtin_expect(!!((consumed + rl->written < template->buflen) != 0), 1)) {
                do { if ((rl) != 
# 327 "../ssl/quic/quic_tls.c" 3 4
               ((void *)0)
# 327 "../ssl/quic/quic_tls.c"
               ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",327,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 327 "../ssl/quic/quic_tls.c" 3 4
               ((void *)0)
# 327 "../ssl/quic/quic_tls.c"
               ); if ((rl) != 
...
# 327 "../ssl/quic/quic_tls.c"
            ...
            BIO_set_flags(rl->dummybio, (0x02|0x08));
    ...
    default:
        ...
        do { if ((rl) != 
# 348 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 348 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",348,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 348 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 348 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
                            ...
                            unsigned char *seq_num)
{
    ...
    if (!rl->qtls->args.crypto_recv_rcd_cb(data, datalen,
        ...
        do { if ((rl) != 
# 372 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 372 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",372,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 372 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 372 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 372 "../ssl/quic/quic_tls.c"
    ...
    if (*datalen == 0) {
        BIO_set_flags(rl->dummybio, (0x01|0x08));
        return 0;
    }
    ...
    *type = 22;
    ...
    if (rl->msg_callback != 
# 387 "../ssl/quic/quic_tls.c" 3 4
                           ((void *)0)
# 387 "../ssl/quic/quic_tls.c"
                               ) {
        unsigned char dummyrec[5];
        ...
        dummyrec[0] = (rl->level == 0)
                      ? 22
                      : 23;
        dummyrec[1] = (unsigned char)((0x0303 >> 8) & 0xff);
        dummyrec[2] = (unsigned char)(0x0303 & 0xff);
        ...
        rl->msg_callback(0, 0x0304, 0x100, dummyrec,
                         5, rl->cbarg);
        rl->msg_callback(0, 0x0304, 0x101, type, 1,
                         rl->cbarg);
    }
...
static int quic_release_record(OSSL_RECORD_LAYER *rl, void *rechandle,
                               size_t length)
{
    if (!__builtin_expect(!!((rl->recread > 0) != 0), 1)
            || !__builtin_expect(!!((rl->recunreleased <= rl->recread) != 0), 1)
            || !__builtin_expect(!!((rl == rechandle) != 0), 1)
            || !__builtin_expect(!!((length <= rl->recunreleased) != 0), 1)) {
        do { if ((rl) != 
# 422 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 422 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",422,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 422 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 422 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
# 422 "../ssl/quic/quic_tls.c"
    ...
    if (!rl->qtls->args.crypto_release_rcd_cb(rl->recread,
        ...
        do { if ((rl) != 
# 433 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 433 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",433,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 433 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 433 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
...
static int quic_set_protocol_version(OSSL_RECORD_LAYER *rl, int version)
{
    ...
    if (!__builtin_expect(!!((version == 0x0304) != 0), 1)) {
        do { if ((rl) != 
# 450 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 450 "../ssl/quic/quic_tls.c"
       ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",450,__func__), ERR_set_error)((20),(((259|((0x1 << 18L)|(0x2 << 18L))))),
# 450 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 450 "../ssl/quic/quic_tls.c"
       ); if ((rl) != 
                    ...
                    const char **longstr)
{
    ...
    if (rl->qtls->inerror) {
        if (shortstr != 
# 483 "../ssl/quic/quic_tls.c" 3 4
                       ((void *)0)
# 483 "../ssl/quic/quic_tls.c"
                           )
            *shortstr = "unknown";
        if (longstr != 
# 485 "../ssl/quic/quic_tls.c" 3 4
                      ((void *)0)
# 485 "../ssl/quic/quic_tls.c"
                          )
            *longstr = "unknown";
    } else {
        if (shortstr != 
# 488 "../ssl/quic/quic_tls.c" 3 4
                       ((void *)0)
# 488 "../ssl/quic/quic_tls.c"
                           )
            *shortstr = "RH";
        if (longstr != 
# 490 "../ssl/quic/quic_tls.c" 3 4
                      ((void *)0)
# 490 "../ssl/quic/quic_tls.c"
                          )
            *longstr = "read header";
    }
}
...
static const COMP_METHOD *quic_get_compression(OSSL_RECORD_LAYER *rl)
{
    ...
    return 
# 507 "../ssl/quic/quic_tls.c" 3 4
          ((void *)0)
# 507 "../ssl/quic/quic_tls.c"
              ;
}
...
{
    if (bio != 
# 535 "../ssl/quic/quic_tls.c" 3 4
              ((void *)0) 
# 535 "../ssl/quic/quic_tls.c"
                   && !BIO_up_ref(bio))
        return 0;
    BIO_free(rl->dummybio);
    rl->dummybio = bio;
...
# 550 "../ssl/quic/quic_tls.c"
static size_t quic_app_data_pending(OSSL_RECORD_LAYER *rl)
{
    do { if ((rl) != 
# 552 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 552 "../ssl/quic/quic_tls.c"
   ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",552,__func__), ERR_set_error)((20),(((257|((0x1 << 18L)|(0x2 << 18L))))),
# 552 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 552 "../ssl/quic/quic_tls.c"
   ); if ((rl) != 
...
# 552 "../ssl/quic/quic_tls.c"
    ...
    return (size_t)__builtin_expect(!!((0) != 0), 1);
}

static size_t quic_get_max_record_overhead(OSSL_RECORD_LAYER *rl)
{
    do { if ((rl) != 
# 558 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 558 "../ssl/quic/quic_tls.c"
   ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",558,__func__), ERR_set_error)((20),(((257|((0x1 << 18L)|(0x2 << 18L))))),
# 558 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 558 "../ssl/quic/quic_tls.c"
   ); if ((rl) != 
...
{
    do { if ((rl) != 
# 564 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 564 "../ssl/quic/quic_tls.c"
   ) (rl)->alert = (80); (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",564,__func__), ERR_set_error)((20),(((257|((0x1 << 18L)|(0x2 << 18L))))),
# 564 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 564 "../ssl/quic/quic_tls.c"
   ); if ((rl) != 
...
# 587 "../ssl/quic/quic_tls.c" 3 4
   ((void *)0)
# 587 "../ssl/quic/quic_tls.c"
       ,
    quic_get_state,
    quic_set_options,
...
QUIC_TLS *ossl_quic_tls_new(const QUIC_TLS_ARGS *args)
{
    ...
    if (args->crypto_send_cb == 
# 635 "../ssl/quic/quic_tls.c" 3 4
                               ((void *)0)
        
# 636 "../ssl/quic/quic_tls.c"
       || args->crypto_recv_rcd_cb == 
# 636 "../ssl/quic/quic_tls.c" 3 4
                                      ((void *)0)
        
# 637 "../ssl/quic/quic_tls.c"
       || args->crypto_release_rcd_cb == 
# 637 "../ssl/quic/quic_tls.c" 3 4
                                         ((void *)0)
# 637 "../ssl/quic/quic_tls.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_tls.c",638,__func__), ERR_set_error)((20),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 638 "../ssl/quic/quic_tls.c" 3 4
       ((void *)0)
# 638 "../ssl/quic/quic_tls.c"
       );
        return 
# 639 "../ssl/quic/quic_tls.c" 3 4
              ((void *)0)
# 639 "../ssl/quic/quic_tls.c"
                  ;
    }

    qtls = CRYPTO_zalloc(sizeof(*qtls), "../ssl/quic/quic_tls.c", 642);
    if (qtls == 
# 643 "../ssl/quic/quic_tls.c" 3 4
               ((void *)0)
# 643 "../ssl/quic/quic_tls.c"
                   )
        return 
# 644 "../ssl/quic/quic_tls.c" 3 4
              ((void *)0)
# 644 "../ssl/quic/quic_tls.c"
                  ;

    if ((qtls->error_state = OSSL_ERR_STATE_new()) == 
# 646 "../ssl/quic/quic_tls.c" 3 4
                                                     ((void *)0)
# 646 "../ssl/quic/quic_tls.c"
                                                         ) {
        CRYPTO_free(qtls, "../ssl/quic/quic_tls.c", 647);
        return 
# 648 "../ssl/quic/quic_tls.c" 3 4
              ((void *)0)
# 648 "../ssl/quic/quic_tls.c"
                  ;
    }
...
{
    if (qtls == 
# 657 "../ssl/quic/quic_tls.c" 3 4
               ((void *)0)
# 657 "../ssl/quic/quic_tls.c"
                   )
        return;
    OSSL_ERR_STATE_free(qtls->error_state);
    CRYPTO_free(qtls, "../ssl/quic/quic_tls.c", 660);
}
...
int ossl_quic_tls_tick(QUIC_TLS *qtls)
{
    ...
    if (qtls->inerror)
        return 0;
# 731 "../ssl/quic/quic_tls.c"
    ERR_set_mark();

    if (!qtls->configured) {
        SSL_CONNECTION *sc = ((qtls->args.s) == 
# 734 "../ssl/quic/quic_tls.c" 3 4
                            ((void *)0) 
# 734 "../ssl/quic/quic_tls.c"
                            ? 
# 734 "../ssl/quic/quic_tls.c" 3 4
                            ((void *)0) 
# 734 "../ssl/quic/quic_tls.c"
                            : ((qtls->args.s)->type == 0 ? ( SSL_CONNECTION *)(qtls->args.s) : ((qtls->args.s)->type == 1 ? ( SSL_CONNECTION *)(( QUIC_CONNECTION *)(qtls->args.s))->tls : 
# 734 "../ssl/quic/quic_tls.c" 3 4
                            ((void *)0)
# 734 "../ssl/quic/quic_tls.c"
                            )));
        SSL_CTX *sctx = ((sc)->ssl.ctx);
        BIO *nullbio;
        ...
        if (qtls->args.is_server) {
            if (sctx->ext.alpn_select_cb == 
# 745 "../ssl/quic/quic_tls.c" 3 4
                                           ((void *)0)
# 745 "../ssl/quic/quic_tls.c"
                                               )
                return raise_error(((qtls)), (0x01), ("internal error"), "../ssl/quic/quic_tls.c", 746, __func__);
        } else {
            if (sc->ext.alpn == 
# 748 "../ssl/quic/quic_tls.c" 3 4
                               ((void *)0) 
# 748 "../ssl/quic/quic_tls.c"
                                    || sc->ext.alpn_len == 0)
                return raise_error((qtls), ((0x0100 + (120))), ("ALPN must be configured when using QUIC"), "../ssl/quic/quic_tls.c", 749, __func__)
                                                                             ;
        }
        if (!SSL_ctrl(qtls->args.s, 123, 0x0304, 
# 752 "../ssl/quic/quic_tls.c" 3 4
            ((void *)0)
# 752 "../ssl/quic/quic_tls.c"
            ))
            return raise_error(((qtls)), (0x01), ("internal error"), "../ssl/quic/quic_tls.c", 753, __func__);

        SSL_clear_options(qtls->args.s, ((uint64_t)1 << (uint64_t)20));
        ossl_ssl_set_custom_record_layer(sc, &quic_tls_record_method, qtls);

        if (!ossl_tls_add_custom_ext_intern(
# 758 "../ssl/quic/quic_tls.c" 3 4
                                           ((void *)0)
# 758 "../ssl/quic/quic_tls.c"
                                               , &sc->cert->custext,
            ...
            return raise_error(((qtls)), (0x01), ("internal error"), "../ssl/quic/quic_tls.c", 768, __func__);

        nullbio = BIO_new(BIO_s_null());
        if (nullbio == 
# 771 "../ssl/quic/quic_tls.c" 3 4
                      ((void *)0)
# 771 "../ssl/quic/quic_tls.c"
                          )
            return raise_error(((qtls)), (0x01), ("internal error"), "../ssl/quic/quic_tls.c", 772, __func__);
    ...
    if (qtls->complete)
        ...
        ret = SSL_read(qtls->args.s, 
# 793 "../ssl/quic/quic_tls.c" 3 4
                                    ((void *)0)
# 793 "../ssl/quic/quic_tls.c"
                                        , 0);
    else
    ...
    if (ret <= 0) {
        ...
        default:
            return raise_error(((qtls)), (0x01), ("internal error"), "../ssl/quic/quic_tls.c", 811, __func__);
        }
    }
    ...
    if (!qtls->complete) {
        ...
        if (alpn == 
# 818 "../ssl/quic/quic_tls.c" 3 4
                   ((void *)0) 
# 818 "../ssl/quic/quic_tls.c"
                        || alpnlen == 0)
            return raise_error((qtls), ((0x0100 + (120))), ("no application protocol negotiated"), "../ssl/quic/quic_tls.c", 819, __func__)
                                                                    ;
...
{
    SSL_CONNECTION *sc = ((qtls->args.s) == 
# 860 "../ssl/quic/quic_tls.c" 3 4
                        ((void *)0) 
# 860 "../ssl/quic/quic_tls.c"
                        ? 
# 860 "../ssl/quic/quic_tls.c" 3 4
                        ((void *)0) 
# 860 "../ssl/quic/quic_tls.c"
...
# 860 "../ssl/quic/quic_tls.c"
    ...
    return sc->s3.tmp.message_type == 13;
}
...
int ossl_quic_tls_has_bad_max_early_data(QUIC_TLS *qtls)
{
    uint32_t max_early_data = SSL_get_session(qtls->args.s)->ext.max_early_data;
