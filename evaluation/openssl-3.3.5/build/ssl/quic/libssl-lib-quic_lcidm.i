# 0 "../ssl/quic/quic_lcidm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_lcidm.c"
# 10 "../ssl/quic/quic_lcidm.c"
...
struct lhash_st_QUIC_LCID { union lh_QUIC_LCID_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_QUIC_LCID_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const QUIC_LCID *) = (unsigned long (*)(const QUIC_LCID *))hfn; return hfn_conv((const QUIC_LCID *)data); } static int lh_QUIC_LCID_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const QUIC_LCID *, const QUIC_LCID *) = (int (*)(const QUIC_LCID *, const QUIC_LCID *))cfn; return cfn_conv((const QUIC_LCID *)da, (const QUIC_LCID *)db); } static __attribute__((unused)) inline void lh_QUIC_LCID_free(struct lhash_st_QUIC_LCID *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_LCID_flush(struct lhash_st_QUIC_LCID *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline QUIC_LCID * lh_QUIC_LCID_insert(struct lhash_st_QUIC_LCID *lh, QUIC_LCID *d) { return (QUIC_LCID *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_LCID * lh_QUIC_LCID_delete(struct lhash_st_QUIC_LCID *lh, const QUIC_LCID *d) { return (QUIC_LCID *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_LCID * lh_QUIC_LCID_retrieve(struct lhash_st_QUIC_LCID *lh, const QUIC_LCID *d) { return (QUIC_LCID *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_QUIC_LCID_error(struct lhash_st_QUIC_LCID *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_LCID_num_items(struct lhash_st_QUIC_LCID *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_LCID_get_down_load(struct lhash_st_QUIC_LCID *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_LCID_set_down_load(struct lhash_st_QUIC_LCID *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_QUIC_LCID_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(QUIC_LCID *) = (void (*)(QUIC_LCID *))doall; doall_conv((QUIC_LCID *)node); } static __attribute__((unused)) inline void lh_QUIC_LCID_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(QUIC_LCID *, void *) = (void (*)(QUIC_LCID *, void *))doall; doall_conv((QUIC_LCID *)node, arg); } static __attribute__((unused)) inline void lh_QUIC_LCID_doall(struct lhash_st_QUIC_LCID *lh, void (*doall)(QUIC_LCID *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_QUIC_LCID * lh_QUIC_LCID_new(unsigned long (*hfn)(const QUIC_LCID *), int (*cfn)(const QUIC_LCID *, const QUIC_LCID *)) { return (struct lhash_st_QUIC_LCID *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_QUIC_LCID_hfn_thunk, lh_QUIC_LCID_cfn_thunk, lh_QUIC_LCID_doall_thunk, lh_QUIC_LCID_doall_arg_thunk); } static __attribute__((unused)) inline void lh_QUIC_LCID_doall_arg(struct lhash_st_QUIC_LCID *lh, void (*doallarg)(QUIC_LCID *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_QUIC_LCID;
struct lhash_st_QUIC_LCIDM_CONN { union lh_QUIC_LCIDM_CONN_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_QUIC_LCIDM_CONN_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const QUIC_LCIDM_CONN *) = (unsigned long (*)(const QUIC_LCIDM_CONN *))hfn; return hfn_conv((const QUIC_LCIDM_CONN *)data); } static int lh_QUIC_LCIDM_CONN_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const QUIC_LCIDM_CONN *, const QUIC_LCIDM_CONN *) = (int (*)(const QUIC_LCIDM_CONN *, const QUIC_LCIDM_CONN *))cfn; return cfn_conv((const QUIC_LCIDM_CONN *)da, (const QUIC_LCIDM_CONN *)db); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_free(struct lhash_st_QUIC_LCIDM_CONN *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_flush(struct lhash_st_QUIC_LCIDM_CONN *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline QUIC_LCIDM_CONN * lh_QUIC_LCIDM_CONN_insert(struct lhash_st_QUIC_LCIDM_CONN *lh, QUIC_LCIDM_CONN *d) { return (QUIC_LCIDM_CONN *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_LCIDM_CONN * lh_QUIC_LCIDM_CONN_delete(struct lhash_st_QUIC_LCIDM_CONN *lh, const QUIC_LCIDM_CONN *d) { return (QUIC_LCIDM_CONN *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline QUIC_LCIDM_CONN * lh_QUIC_LCIDM_CONN_retrieve(struct lhash_st_QUIC_LCIDM_CONN *lh, const QUIC_LCIDM_CONN *d) { return (QUIC_LCIDM_CONN *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_QUIC_LCIDM_CONN_error(struct lhash_st_QUIC_LCIDM_CONN *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_LCIDM_CONN_num_items(struct lhash_st_QUIC_LCIDM_CONN *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_QUIC_LCIDM_CONN_get_down_load(struct lhash_st_QUIC_LCIDM_CONN *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_set_down_load(struct lhash_st_QUIC_LCIDM_CONN *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(QUIC_LCIDM_CONN *) = (void (*)(QUIC_LCIDM_CONN *))doall; doall_conv((QUIC_LCIDM_CONN *)node); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(QUIC_LCIDM_CONN *, void *) = (void (*)(QUIC_LCIDM_CONN *, void *))doall; doall_conv((QUIC_LCIDM_CONN *)node, arg); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_doall(struct lhash_st_QUIC_LCIDM_CONN *lh, void (*doall)(QUIC_LCIDM_CONN *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_QUIC_LCIDM_CONN * lh_QUIC_LCIDM_CONN_new(unsigned long (*hfn)(const QUIC_LCIDM_CONN *), int (*cfn)(const QUIC_LCIDM_CONN *, const QUIC_LCIDM_CONN *)) { return (struct lhash_st_QUIC_LCIDM_CONN *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_QUIC_LCIDM_CONN_hfn_thunk, lh_QUIC_LCIDM_CONN_cfn_thunk, lh_QUIC_LCIDM_CONN_doall_thunk, lh_QUIC_LCIDM_CONN_doall_arg_thunk); } static __attribute__((unused)) inline void lh_QUIC_LCIDM_CONN_doall_arg(struct lhash_st_QUIC_LCIDM_CONN *lh, void (*doallarg)(QUIC_LCIDM_CONN *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_QUIC_LCIDM_CONN;

struct quic_lcidm_conn_st {
    size_t num_active_lcid;
    struct lhash_st_QUIC_LCID *lcids;
    void *opaque;
...
struct quic_lcidm_st {
    OSSL_LIB_CTX *libctx;
    struct lhash_st_QUIC_LCID *lcids;
    struct lhash_st_QUIC_LCIDM_CONN *conns;
    size_t lcid_len;
...
{
    QUIC_LCIDM *lcidm = 
# 99 "../ssl/quic/quic_lcidm.c" 3 4
                       ((void *)0)
# 99 "../ssl/quic/quic_lcidm.c"
                           ;

    if (lcid_len > 20)
        goto err;

    if ((lcidm = CRYPTO_zalloc(sizeof(*lcidm), "../ssl/quic/quic_lcidm.c", 104)) == 
# 104 "../ssl/quic/quic_lcidm.c" 3 4
                                                   ((void *)0)
# 104 "../ssl/quic/quic_lcidm.c"
                                                       )
        goto err;

    if ((lcidm->lcids = lh_QUIC_LCID_new(lcid_hash, lcid_comp)) == 
# 107 "../ssl/quic/quic_lcidm.c" 3 4
                                                                  ((void *)0)
# 107 "../ssl/quic/quic_lcidm.c"
                                                                      )
        goto err;

    if ((lcidm->conns = lh_QUIC_LCIDM_CONN_new(lcidm_conn_hash,
                                               lcidm_conn_comp)) == 
# 111 "../ssl/quic/quic_lcidm.c" 3 4
                                                                   ((void *)0)
# 111 "../ssl/quic/quic_lcidm.c"
                                                                       )
        goto err;
...
err:
    if (lcidm != 
# 119 "../ssl/quic/quic_lcidm.c" 3 4
                ((void *)0)
# 119 "../ssl/quic/quic_lcidm.c"
                    ) {
        lh_QUIC_LCID_free(lcidm->lcids);
        lh_QUIC_LCIDM_CONN_free(lcidm->conns);
        CRYPTO_free(lcidm, "../ssl/quic/quic_lcidm.c", 122);
    }
    return 
# 124 "../ssl/quic/quic_lcidm.c" 3 4
          ((void *)0)
# 124 "../ssl/quic/quic_lcidm.c"
              ;
}
...
{
    if (lcidm == 
# 136 "../ssl/quic/quic_lcidm.c" 3 4
                ((void *)0)
# 136 "../ssl/quic/quic_lcidm.c"
                    )
        return;
# 156 "../ssl/quic/quic_lcidm.c"
    ...
    lh_QUIC_LCID_free(lcidm->lcids);
    lh_QUIC_LCIDM_CONN_free(lcidm->conns);
    CRYPTO_free(lcidm, "../ssl/quic/quic_lcidm.c", 162);
}
...
static QUIC_LCID *lcidm_get0_lcid(const QUIC_LCIDM *lcidm, const QUIC_CONN_ID *lcid)
{
    ...
    if (key.cid.id_len > 20)
        return 
# 172 "../ssl/quic/quic_lcidm.c" 3 4
              ((void *)0)
# 172 "../ssl/quic/quic_lcidm.c"
                  ;
...
static QUIC_LCIDM_CONN *lcidm_upsert_conn(const QUIC_LCIDM *lcidm, void *opaque)
{
    ...
    if (conn != 
# 190 "../ssl/quic/quic_lcidm.c" 3 4
               ((void *)0)
# 190 "../ssl/quic/quic_lcidm.c"
                   )
        return conn;

    if ((conn = CRYPTO_zalloc(sizeof(*conn), "../ssl/quic/quic_lcidm.c", 193)) == 
# 193 "../ssl/quic/quic_lcidm.c" 3 4
                                                 ((void *)0)
# 193 "../ssl/quic/quic_lcidm.c"
                                                     )
        goto err;

    if ((conn->lcids = lh_QUIC_LCID_new(lcid_hash, lcid_comp)) == 
# 196 "../ssl/quic/quic_lcidm.c" 3 4
                                                                 ((void *)0)
# 196 "../ssl/quic/quic_lcidm.c"
                                                                     )
        goto err;
...
err:
    if (conn != 
# 208 "../ssl/quic/quic_lcidm.c" 3 4
               ((void *)0)
# 208 "../ssl/quic/quic_lcidm.c"
                   ) {
        lh_QUIC_LCID_free(conn->lcids);
        CRYPTO_free(conn, "../ssl/quic/quic_lcidm.c", 210);
    }
    return 
# 212 "../ssl/quic/quic_lcidm.c" 3 4
          ((void *)0)
# 212 "../ssl/quic/quic_lcidm.c"
              ;
}
...
# 219 "../ssl/quic/quic_lcidm.c" 3 4
   ((void) (0))
# 219 "../ssl/quic/quic_lcidm.c"
                                              ;
    --lcid_obj->conn->num_active_lcid;
    CRYPTO_free(lcid_obj, "../ssl/quic/quic_lcidm.c", 221);
}
...
static void lcidm_delete_conn(QUIC_LCIDM *lcidm, QUIC_LCIDM_CONN *conn)
{
    ...
    lh_QUIC_LCID_free(conn->lcids);
    CRYPTO_free(conn, "../ssl/quic/quic_lcidm.c", 238);
}
...
{
    QUIC_LCID *lcid_obj = 
# 244 "../ssl/quic/quic_lcidm.c" 3 4
                         ((void *)0)
# 244 "../ssl/quic/quic_lcidm.c"
                             ;

    if (lcid->id_len > 20)
        return 
# 247 "../ssl/quic/quic_lcidm.c" 3 4
              ((void *)0)
# 247 "../ssl/quic/quic_lcidm.c"
                  ;

    if ((lcid_obj = CRYPTO_zalloc(sizeof(*lcid_obj), "../ssl/quic/quic_lcidm.c", 249)) == 
# 249 "../ssl/quic/quic_lcidm.c" 3 4
                                                         ((void *)0)
# 249 "../ssl/quic/quic_lcidm.c"
                                                             )
        goto err;
...
err:
    CRYPTO_free(lcid_obj, "../ssl/quic/quic_lcidm.c", 269);
    return 
# 270 "../ssl/quic/quic_lcidm.c" 3 4
          ((void *)0)
# 270 "../ssl/quic/quic_lcidm.c"
              ;
}
                                           ...
                                           void *opaque)
{
    ...
    if (conn == 
# 284 "../ssl/quic/quic_lcidm.c" 3 4
               ((void *)0)
# 284 "../ssl/quic/quic_lcidm.c"
                   )
        return 0;
                          ...
                          uint64_t *seq_num)
{
    ...
    if ((conn = lcidm_upsert_conn(lcidm, opaque)) == 
# 320 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 320 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    if ((type == LCID_TYPE_INITIAL && conn->next_seq_num > 0)
        || conn->next_seq_num > (((uint64_t)1 << 62) - 1))
        return 0;
    ...
    } while (lh_QUIC_LCID_retrieve(lcidm->lcids, &key) != 
# 341 "../ssl/quic/quic_lcidm.c" 3 4
                                                         ((void *)0)
# 341 "../ssl/quic/quic_lcidm.c"
                                                             );

    if ((lcid_obj = lcidm_conn_new_lcid(lcidm, conn, lcid_out)) == 
# 343 "../ssl/quic/quic_lcidm.c" 3 4
                                                                  ((void *)0)
# 343 "../ssl/quic/quic_lcidm.c"
                                                                      )
        return 0;
    ...
    if (seq_num != 
# 349 "../ssl/quic/quic_lcidm.c" 3 4
                  ((void *)0)
# 349 "../ssl/quic/quic_lcidm.c"
                      )
                                ...
                                const QUIC_CONN_ID *initial_odcid)
{
    ...
    if (initial_odcid == 
# 363 "../ssl/quic/quic_lcidm.c" 3 4
                        ((void *)0) 
# 363 "../ssl/quic/quic_lcidm.c"
                             || initial_odcid->id_len < 8
        || initial_odcid->id_len > 20)
        return 0;

    if ((conn = lcidm_upsert_conn(lcidm, opaque)) == 
# 367 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 367 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;
    ...
    if (lh_QUIC_LCID_retrieve(lcidm->lcids, &key) != 
# 374 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 374 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    if ((lcid_obj = lcidm_conn_new_lcid(lcidm, conn, initial_odcid)) == 
# 377 "../ssl/quic/quic_lcidm.c" 3 4
                                                                       ((void *)0)
# 377 "../ssl/quic/quic_lcidm.c"
                                                                           )
        return 0;

    lcid_obj->seq_num = 
# 380 "../ssl/quic/quic_lcidm.c" 3 4
                             (18446744073709551615UL)
# 380 "../ssl/quic/quic_lcidm.c"
                                                ;
                                     ...
                                     QUIC_CONN_ID *initial_lcid)
{
    return lcidm_generate(lcidm, opaque, LCID_TYPE_INITIAL,
                          initial_lcid, 
# 393 "../ssl/quic/quic_lcidm.c" 3 4
                                       ((void *)0)
# 393 "../ssl/quic/quic_lcidm.c"
                                           );
}
...
int ossl_quic_lcidm_retire_odcid(QUIC_LCIDM *lcidm, void *opaque)
{
    ...
    if ((conn = lcidm_upsert_conn(lcidm, opaque)) == 
# 412 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 412 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    if (conn->odcid_lcid_obj == 
# 415 "../ssl/quic/quic_lcidm.c" 3 4
                               ((void *)0)
# 415 "../ssl/quic/quic_lcidm.c"
                                   )
        return 0;

    lcidm_delete_conn_lcid(lcidm, conn->odcid_lcid_obj);
    conn->odcid_lcid_obj = 
# 419 "../ssl/quic/quic_lcidm.c" 3 4
                          ((void *)0)
# 419 "../ssl/quic/quic_lcidm.c"
                              ;
    return 1;
}
                           ...
                           int *did_retire)
{
    ...
    if (did_retire == 
# 456 "../ssl/quic/quic_lcidm.c" 3 4
                     ((void *)0)
# 456 "../ssl/quic/quic_lcidm.c"
                         )
        return 0;

    *did_retire = 0;
    if ((conn = lh_QUIC_LCIDM_CONN_retrieve(lcidm->conns, &key)) == 
# 460 "../ssl/quic/quic_lcidm.c" 3 4
                                                                   ((void *)0)
# 460 "../ssl/quic/quic_lcidm.c"
                                                                       )
        return 1;

    args.retire_prior_to = retire_prior_to;
    args.earliest_seq_num = 
# 464 "../ssl/quic/quic_lcidm.c" 3 4
                             (18446744073709551615UL)
# 464 "../ssl/quic/quic_lcidm.c"
                                       ;

    lh_QUIC_LCID_doall_arg(conn->lcids, retire_for_conn, &args);
    if (args.earliest_seq_num_lcid_obj == 
# 467 "../ssl/quic/quic_lcidm.c" 3 4
                                         ((void *)0)
# 467 "../ssl/quic/quic_lcidm.c"
                                             )
        return 1;

    if (containing_pkt_dcid != 
# 470 "../ssl/quic/quic_lcidm.c" 3 4
                              ((void *)0)
        
# 471 "../ssl/quic/quic_lcidm.c"
    ...
    *did_retire = 1;
    if (retired_lcid != 
# 476 "../ssl/quic/quic_lcidm.c" 3 4
                       ((void *)0)
# 476 "../ssl/quic/quic_lcidm.c"
                           )
        *retired_lcid = args.earliest_seq_num_lcid_obj->cid;
    if (retired_seq_num != 
# 478 "../ssl/quic/quic_lcidm.c" 3 4
                          ((void *)0)
# 478 "../ssl/quic/quic_lcidm.c"
                              )
...
int ossl_quic_lcidm_cull(QUIC_LCIDM *lcidm, void *opaque)
{
    ...
    if ((conn = lh_QUIC_LCIDM_CONN_retrieve(lcidm->conns, &key)) == 
# 491 "../ssl/quic/quic_lcidm.c" 3 4
                                                                   ((void *)0)
# 491 "../ssl/quic/quic_lcidm.c"
                                                                       )
        return 0;
                           ...
                           void **opaque)
{
    ...
    if (lcid == 
# 505 "../ssl/quic/quic_lcidm.c" 3 4
               ((void *)0)
# 505 "../ssl/quic/quic_lcidm.c"
                   )
        return 0;

    if ((lcid_obj = lcidm_get0_lcid(lcidm, lcid)) == 
# 508 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 508 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    if (seq_num != 
# 511 "../ssl/quic/quic_lcidm.c" 3 4
                  ((void *)0)
# 511 "../ssl/quic/quic_lcidm.c"
                      )
        *seq_num = lcid_obj->seq_num;

    if (opaque != 
# 514 "../ssl/quic/quic_lcidm.c" 3 4
                 ((void *)0)
# 514 "../ssl/quic/quic_lcidm.c"
                     )
                                 ...
                                 const QUIC_CONN_ID *lcid)
{
    ...
    key.cid = *lcid;
    if ((lcid_obj = lh_QUIC_LCID_retrieve(lcidm->lcids, &key)) == 
# 526 "../ssl/quic/quic_lcidm.c" 3 4
                                                                 ((void *)0)
# 526 "../ssl/quic/quic_lcidm.c"
                                                                     )
        return 0;
                              ...
                              uint64_t seq_num)
{
    ...
    if (lcid == 
# 540 "../ssl/quic/quic_lcidm.c" 3 4
               ((void *)0) 
# 540 "../ssl/quic/quic_lcidm.c"
                    || lcid->id_len > 20)
        return 0;

    if ((conn = lcidm_upsert_conn(lcidm, opaque)) == 
# 543 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 543 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    key.cid = *lcid;
    if (lh_QUIC_LCID_retrieve(lcidm->lcids, &key) != 
# 547 "../ssl/quic/quic_lcidm.c" 3 4
                                                    ((void *)0)
# 547 "../ssl/quic/quic_lcidm.c"
                                                        )
        return 0;

    if ((lcid_obj = lcidm_conn_new_lcid(lcidm, conn, lcid)) == 
# 550 "../ssl/quic/quic_lcidm.c" 3 4
                                                              ((void *)0)
# 550 "../ssl/quic/quic_lcidm.c"
                                                                  )
        return 0;
