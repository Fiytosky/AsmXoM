# 0 "../ssl/quic/quic_wire_pkt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_wire_pkt.c"
# 10 "../ssl/quic/quic_wire_pkt.c"
...
# 14 "../include/internal/quic_wire_pkt.h" 2
...
# 21 "../ssl/quic/quic_wire_pkt.c" 3 4
                             ((void *)0)
# 21 "../ssl/quic/quic_wire_pkt.c"
                                 ;
    ...
    switch (cipher_id) {
        ...
        case 3:
            ...
            break;
        default:
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",34,__func__), ERR_set_error)((20),((268|(0x2 << 18L))),
# 34 "../ssl/quic/quic_wire_pkt.c" 3 4
           ((void *)0)
# 34 "../ssl/quic/quic_wire_pkt.c"
           );
            return 0;
    }
    ...
    if (hpr->cipher_ctx == 
# 39 "../ssl/quic/quic_wire_pkt.c" 3 4
                          ((void *)0)
# 39 "../ssl/quic/quic_wire_pkt.c"
                              ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",40,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 40 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 40 "../ssl/quic/quic_wire_pkt.c"
       );
        return 0;
    }
    ...
    if (hpr->cipher == 
# 45 "../ssl/quic/quic_wire_pkt.c" 3 4
                      ((void *)0)
        
# 46 "../ssl/quic/quic_wire_pkt.c"
       || quic_hp_key_len != (size_t)EVP_CIPHER_get_key_length(hpr->cipher)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",47,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 47 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 47 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }

    if (!EVP_CipherInit_ex(hpr->cipher_ctx, hpr->cipher, 
# 51 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                        ((void *)0)
# 51 "../ssl/quic/quic_wire_pkt.c"
                                                            ,
                           quic_hp_key, 
# 52 "../ssl/quic/quic_wire_pkt.c" 3 4
                                       ((void *)0)
# 52 "../ssl/quic/quic_wire_pkt.c"
                                           , 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",53,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 53 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 53 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
...
void ossl_quic_hdr_protector_cleanup(QUIC_HDR_PROTECTOR *hpr)
{
    ...
    hpr->cipher_ctx = 
# 70 "../ssl/quic/quic_wire_pkt.c" 3 4
                     ((void *)0)
# 70 "../ssl/quic/quic_wire_pkt.c"
                         ;

    EVP_CIPHER_free(hpr->cipher);
    hpr->cipher = 
# 73 "../ssl/quic/quic_wire_pkt.c" 3 4
                 ((void *)0)
# 73 "../ssl/quic/quic_wire_pkt.c"
                     ;
}
                             ...
                             unsigned char *mask)
{
    ...
    if (hpr->cipher_id == 1
        || hpr->cipher_id == 2) {
        if (sample_len < 16) {
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",88,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 88 "../ssl/quic/quic_wire_pkt.c" 3 4
           ((void *)0)
# 88 "../ssl/quic/quic_wire_pkt.c"
           );
            return 0;
        }

        if (!EVP_CipherInit_ex(hpr->cipher_ctx, 
# 92 "../ssl/quic/quic_wire_pkt.c" 3 4
                                               ((void *)0)
# 92 "../ssl/quic/quic_wire_pkt.c"
                                                   , 
# 92 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                     ((void *)0)
# 92 "../ssl/quic/quic_wire_pkt.c"
...
# 92 "../ssl/quic/quic_wire_pkt.c"
            ...
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",94,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 94 "../ssl/quic/quic_wire_pkt.c" 3 4
           ((void *)0)
# 94 "../ssl/quic/quic_wire_pkt.c"
           );
            return 0;
        }
        ...
        for (i = 0; i < 5; ++i)
            mask[i] = dst[i];
    } else if (hpr->cipher_id == 3) {
        if (sample_len < 16) {
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",102,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 102 "../ssl/quic/quic_wire_pkt.c" 3 4
           ((void *)0)
# 102 "../ssl/quic/quic_wire_pkt.c"
           );
            return 0;
        }

        if (!EVP_CipherInit_ex(hpr->cipher_ctx, 
# 106 "../ssl/quic/quic_wire_pkt.c" 3 4
                                               ((void *)0)
# 106 "../ssl/quic/quic_wire_pkt.c"
                                                   , 
# 106 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                     ((void *)0)
# 106 "../ssl/quic/quic_wire_pkt.c"
...
# 106 "../ssl/quic/quic_wire_pkt.c"
            ...
            (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",109,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 109 "../ssl/quic/quic_wire_pkt.c" 3 4
           ((void *)0)
# 109 "../ssl/quic/quic_wire_pkt.c"
           );
            return 0;
        }
    } else {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",113,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 113 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 113 "../ssl/quic/quic_wire_pkt.c"
       );
        
# 114 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void) (0))
# 114 "../ssl/quic/quic_wire_pkt.c"
                ;
        return 0;
    }
                                  ...
                                  QUIC_PKT_HDR_PTRS *ptrs)
{
    unsigned int b0;
    unsigned char *pn = 
# 193 "../ssl/quic/quic_wire_pkt.c" 3 4
                       ((void *)0)
# 193 "../ssl/quic/quic_wire_pkt.c"
                           ;
    size_t l = PACKET_remaining(pkt);

    if (ptrs != 
# 196 "../ssl/quic/quic_wire_pkt.c" 3 4
               ((void *)0)
# 196 "../ssl/quic/quic_wire_pkt.c"
                   ) {
        ptrs->raw_start = (unsigned char *)PACKET_data(pkt);
        ptrs->raw_sample = 
# 198 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 198 "../ssl/quic/quic_wire_pkt.c"
                                     ;
        ptrs->raw_sample_len = 0;
        ptrs->raw_pn = 
# 200 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 200 "../ssl/quic/quic_wire_pkt.c"
                                     ;
    }
    ...
    if ((b0 & 0x80) == 0) {
        ...
        hdr->token = 
# 258 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 258 "../ssl/quic/quic_wire_pkt.c"
                                     ;
        hdr->token_len = 0;
        ...
        if (version == 0) {
            ...
            hdr->key_phase = 0;
            hdr->token = 
# 328 "../ssl/quic/quic_wire_pkt.c" 3 4
                                     ((void *)0)
# 328 "../ssl/quic/quic_wire_pkt.c"
                                         ;
            hdr->token_len = 0;
            memset(hdr->pn, 0, sizeof(hdr->pn));
            ...
            if (hdr->type == 1) {
                ...
                if (!PACKET_get_quic_vlint(pkt, &token_len)
                    || token_len > 
# 371 "../ssl/quic/quic_wire_pkt.c" 3 4
                                  (18446744073709551615UL)
                    
# 372 "../ssl/quic/quic_wire_pkt.c"
                ...
                if (token_len == 0)
                    hdr->token = 
# 377 "../ssl/quic/quic_wire_pkt.c" 3 4
                                ((void *)0)
# 377 "../ssl/quic/quic_wire_pkt.c"
                                    ;
            } else {
                hdr->token = 
# 379 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 379 "../ssl/quic/quic_wire_pkt.c"
                                     ;
                hdr->token_len = 0;
            }
            ...
            if (hdr->type == 4) {
                ...
                if (nodata) {
                    hdr->data = 
# 434 "../ssl/quic/quic_wire_pkt.c" 3 4
                               ((void *)0)
# 434 "../ssl/quic/quic_wire_pkt.c"
                                   ;
                } else {
                    hdr->data = PACKET_data(pkt);
    ...
    if (ptrs != 
# 446 "../ssl/quic/quic_wire_pkt.c" 3 4
               ((void *)0)
# 446 "../ssl/quic/quic_wire_pkt.c"
                   ) {
        ptrs->raw_pn = pn;
        if (pn != 
# 448 "../ssl/quic/quic_wire_pkt.c" 3 4
                 ((void *)0)
# 448 "../ssl/quic/quic_wire_pkt.c"
                     ) {
                                  ...
                                  QUIC_PKT_HDR_PTRS *ptrs)
{
    ...
    if (ptrs != 
# 469 "../ssl/quic/quic_wire_pkt.c" 3 4
               ((void *)0)
# 469 "../ssl/quic/quic_wire_pkt.c"
                   ) {

        if (!__builtin_expect(!!((pkt->staticbuf != 
# 471 "../ssl/quic/quic_wire_pkt.c" 3 4
            ((void *)0)
# 471 "../ssl/quic/quic_wire_pkt.c"
            ) != 0), 1))
            return 0;
        ptrs->raw_start = 
# 473 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 473 "../ssl/quic/quic_wire_pkt.c"
                                     ;
        ptrs->raw_sample = 
# 474 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0)
# 474 "../ssl/quic/quic_wire_pkt.c"
                                     ;
        ptrs->raw_sample_len = 0;
        ptrs->raw_pn = 0;
    }
    ...
    if (hdr->type == 5) {
        ...
        if (!WPACKET_put_bytes__((pkt), (b0), 1)
        ...
        if (hdr->dst_conn_id.id_len > 20
            || hdr->src_conn_id.id_len > 20)
            return 0;
        ...
        switch (hdr->type) {
            ...
            case 1: raw_type = 0; break;
            case 2: raw_type = 1; break;
            case 3: raw_type = 2; break;
            case 4: raw_type = 3; break;
            default:
                return 0;
        }

        b0 = (raw_type << 4) | 0x80;
        if (hdr->type != 6 || hdr->fixed)
            b0 |= 0x40;
        if (ossl_quic_pkt_type_has_pn(hdr->type)) {
            b0 |= hdr->pn_len - 1;
            b0 |= (hdr->reserved << 2);
        ...
        if (!WPACKET_put_bytes__((pkt), (b0), 1)
            || !WPACKET_put_bytes__((pkt), (hdr->version), 4)
            || !WPACKET_put_bytes__((pkt), (hdr->dst_conn_id.id_len), 1)
            || !WPACKET_memcpy(pkt, hdr->dst_conn_id.id,
                               hdr->dst_conn_id.id_len)
            || !WPACKET_put_bytes__((pkt), (hdr->src_conn_id.id_len), 1)
        ...
        if (hdr->type == 6
            || hdr->type == 4) {
            if (hdr->len > 0 && !WPACKET_reserve_bytes(pkt, hdr->len, 
# 559 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                                     ((void *)0)
# 559 "../ssl/quic/quic_wire_pkt.c"
                                                                         ))
                return 0;
    ...
    if (hdr->len > 0 && !WPACKET_reserve_bytes(pkt, hdr->len, 
# 577 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                             ((void *)0)
# 577 "../ssl/quic/quic_wire_pkt.c"
                                                                 ))
        return 0;
    ...
    if (ptrs != 
# 582 "../ssl/quic/quic_wire_pkt.c" 3 4
               ((void *)0)
# 582 "../ssl/quic/quic_wire_pkt.c"
                   ) {
...
# 679 "../ssl/quic/quic_wire_pkt.c"
        ...
        if (buf_len < 21 + short_conn_id_len)
            return 0;
                                    ...
                                    QUIC_PN largest_acked)
{
    uint64_t num_unacked
        = (largest_acked == 
# 757 "../ssl/quic/quic_wire_pkt.c" 3 4
                           (18446744073709551615UL)
# 757 "../ssl/quic/quic_wire_pkt.c"
                                          ) ? pn + 1 : pn - largest_acked;
# 766 "../ssl/quic/quic_wire_pkt.c"
                                           ...
                                           const QUIC_CONN_ID *client_initial_dcid)
{
    ...
    if (hdr == 
# 810 "../ssl/quic/quic_wire_pkt.c" 3 4
              ((void *)0) 
# 810 "../ssl/quic/quic_wire_pkt.c"
                   || hdr->len < 16)
        return 0;
    ...
    actual_tag = hdr->data + hdr->len - 16;
...
{
    EVP_CIPHER *cipher = 
# 841 "../ssl/quic/quic_wire_pkt.c" 3 4
                        ((void *)0)
# 841 "../ssl/quic/quic_wire_pkt.c"
                            ;
    EVP_CIPHER_CTX *cctx = 
# 842 "../ssl/quic/quic_wire_pkt.c" 3 4
                          ((void *)0)
# 842 "../ssl/quic/quic_wire_pkt.c"
                              ;
    ...
    if (hdr->type != 4 || hdr->version == 0
        || hdr->len < 16
        || hdr->data == 
# 852 "../ssl/quic/quic_wire_pkt.c" 3 4
                       ((void *)0)
        
# 853 "../ssl/quic/quic_wire_pkt.c"
       || client_initial_dcid == 
# 853 "../ssl/quic/quic_wire_pkt.c" 3 4
                                 ((void *)0) 
# 853 "../ssl/quic/quic_wire_pkt.c"
                                      || tag == 
# 853 "../ssl/quic/quic_wire_pkt.c" 3 4
...
# 854 "../ssl/quic/quic_wire_pkt.c"
       || client_initial_dcid->id_len > 20) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",855,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 855 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 855 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if (!WPACKET_init_static_len(&wpkt, buf, sizeof(buf), 0)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",869,__func__), ERR_set_error)((20),((15 | (0x2 << 18L))),
# 869 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 869 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if (!WPACKET_put_bytes__((&wpkt), (client_initial_dcid->id_len), 1)
        || !WPACKET_memcpy(&wpkt, client_initial_dcid->id,
                           client_initial_dcid->id_len)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",879,__func__), ERR_set_error)((20),((15 | (0x2 << 18L))),
# 879 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 879 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if (!ossl_quic_wire_encode_pkt_hdr(&wpkt, hdr2.dst_conn_id.id_len,
                                       &hdr2, 
# 885 "../ssl/quic/quic_wire_pkt.c" 3 4
                                             ((void *)0)
# 885 "../ssl/quic/quic_wire_pkt.c"
                                                 ))
        goto err;

    if (!WPACKET_get_total_written(&wpkt, &hdr_enc_len)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",889,__func__), ERR_set_error)((20),((15 | (0x2 << 18L))),
# 889 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 889 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if ((cipher = EVP_CIPHER_fetch(libctx, "AES-128-GCM", propq)) == 
# 895 "../ssl/quic/quic_wire_pkt.c" 3 4
                                                                    ((void *)0)
# 895 "../ssl/quic/quic_wire_pkt.c"
                                                                        ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",896,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 896 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 896 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }

    if ((cctx = EVP_CIPHER_CTX_new()) == 
# 900 "../ssl/quic/quic_wire_pkt.c" 3 4
                                        ((void *)0)
# 900 "../ssl/quic/quic_wire_pkt.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",901,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 901 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 901 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }

    if (!EVP_CipherInit_ex(cctx, cipher, 
# 905 "../ssl/quic/quic_wire_pkt.c" 3 4
                                        ((void *)0)
# 905 "../ssl/quic/quic_wire_pkt.c"
                                            ,
                           retry_integrity_key, retry_integrity_nonce, 1)) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",907,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 907 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 907 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
...
# 912 "../ssl/quic/quic_wire_pkt.c" 3 4
                              ((void *)0)
# 912 "../ssl/quic/quic_wire_pkt.c"
                                  , &l, buf, hdr_enc_len) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",913,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 913 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 913 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if (EVP_CipherUpdate(cctx, 
# 918 "../ssl/quic/quic_wire_pkt.c" 3 4
                              ((void *)0)
# 918 "../ssl/quic/quic_wire_pkt.c"
                                  , &l, hdr->data,
                         hdr->len - 16) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",920,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 920 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 920 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
...
# 925 "../ssl/quic/quic_wire_pkt.c" 3 4
                                ((void *)0)
# 925 "../ssl/quic/quic_wire_pkt.c"
                                    , &l2) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",926,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 926 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 926 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
    ...
    if (EVP_CIPHER_CTX_ctrl(cctx, 0x10,
                            16,
                            tag) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_wire_pkt.c",933,__func__), ERR_set_error)((20),((6 | (0x2 << 18L))),
# 933 "../ssl/quic/quic_wire_pkt.c" 3 4
       ((void *)0)
# 933 "../ssl/quic/quic_wire_pkt.c"
       );
        goto err;
    }
