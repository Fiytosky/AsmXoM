# 0 "../ssl/quic/quic_types.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_types.c"
# 10 "../ssl/quic/quic_types.c"
                               ...
                               QUIC_CONN_ID *cid)
{
    ...
    if (RAND_bytes_ex(libctx, cid->id, len, len * 8) != 1) {
        (ERR_new(), ERR_set_debug("../ssl/quic/quic_types.c",23,__func__), ERR_set_error)((20),((36 | (0x2 << 18L))),
# 23 "../ssl/quic/quic_types.c" 3 4
       ((void *)0)
# 23 "../ssl/quic/quic_types.c"
       );
        cid->id_len = 0;
        return 0;
    }
