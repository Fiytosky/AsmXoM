# 0 "../ssl/quic/quic_rcidm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_rcidm.c"
# 10 "../ssl/quic/quic_rcidm.c"
...
typedef struct rcid_st {
    struct { struct rcid_st *next, *prev; } ossl_list_retiring;
...
typedef struct ossl_priority_queue_st_RCID OSSL_PRIORITY_QUEUE_RCID; static __attribute__((unused)) inline OSSL_PRIORITY_QUEUE_RCID * ossl_pqueue_RCID_new(int (*compare)(const RCID *, const RCID *)) { return (OSSL_PRIORITY_QUEUE_RCID *)ossl_pqueue_new( (int (*)(const void *, const void *))compare); } static __attribute__((unused)) inline void ossl_pqueue_RCID_free(OSSL_PRIORITY_QUEUE_RCID *pq) { ossl_pqueue_free((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline void ossl_pqueue_RCID_pop_free(OSSL_PRIORITY_QUEUE_RCID *pq, void (*freefunc)(RCID *)) { ossl_pqueue_pop_free((OSSL_PQUEUE *)pq, (void (*)(void *))freefunc); } static __attribute__((unused)) inline int ossl_pqueue_RCID_reserve(OSSL_PRIORITY_QUEUE_RCID *pq, size_t n) { return ossl_pqueue_reserve((OSSL_PQUEUE *)pq, n); } static __attribute__((unused)) inline size_t ossl_pqueue_RCID_num(const OSSL_PRIORITY_QUEUE_RCID *pq) { return ossl_pqueue_num((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline int ossl_pqueue_RCID_push(OSSL_PRIORITY_QUEUE_RCID *pq, RCID *data, size_t *elem) { return ossl_pqueue_push((OSSL_PQUEUE *)pq, (void *)data, elem); } static __attribute__((unused)) inline RCID * ossl_pqueue_RCID_peek(const OSSL_PRIORITY_QUEUE_RCID *pq) { return (RCID *)ossl_pqueue_peek((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline RCID * ossl_pqueue_RCID_pop(OSSL_PRIORITY_QUEUE_RCID *pq) { return (RCID *)ossl_pqueue_pop((OSSL_PQUEUE *)pq); } static __attribute__((unused)) inline RCID * ossl_pqueue_RCID_remove(OSSL_PRIORITY_QUEUE_RCID *pq, size_t elem) { return (RCID *)ossl_pqueue_remove((OSSL_PQUEUE *)pq, elem); } struct ossl_priority_queue_st_RCID;
typedef struct ossl_list_st_retiring OSSL_LIST_retiring; struct ossl_list_st_retiring { RCID *alpha, *omega; size_t num_elems; }; static __attribute__((unused)) inline void ossl_list_retiring_init(OSSL_LIST_retiring *list) { memset(list, 0, sizeof(*list)); } static __attribute__((unused)) inline void ossl_list_retiring_init_elem(RCID *elem) { memset(&elem->ossl_list_retiring, 0, sizeof(elem->ossl_list_retiring)); } static __attribute__((unused)) inline int ossl_list_retiring_is_empty(const OSSL_LIST_retiring *list) { return list->num_elems == 0; } static __attribute__((unused)) inline size_t ossl_list_retiring_num(const OSSL_LIST_retiring *list) { return list->num_elems; } static __attribute__((unused)) inline RCID * ossl_list_retiring_head(const OSSL_LIST_retiring *list) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; return list->alpha; } static __attribute__((unused)) inline RCID * ossl_list_retiring_tail(const OSSL_LIST_retiring *list) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; return list->omega; } static __attribute__((unused)) inline RCID * ossl_list_retiring_next(const RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; return elem->ossl_list_retiring.next; } static __attribute__((unused)) inline RCID * ossl_list_retiring_prev(const RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; return elem->ossl_list_retiring.prev; } static __attribute__((unused)) inline void ossl_list_retiring_remove(OSSL_LIST_retiring *list, RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; if (list->alpha == elem) list->alpha = elem->ossl_list_retiring.next; if (list->omega == elem) list->omega = elem->ossl_list_retiring.prev; if (elem->ossl_list_retiring.prev != 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) elem->ossl_list_retiring.prev->ossl_list_retiring.next = elem->ossl_list_retiring.next; if (elem->ossl_list_retiring.next != 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) elem->ossl_list_retiring.next->ossl_list_retiring.prev = elem->ossl_list_retiring.prev; list->num_elems--; memset(&elem->ossl_list_retiring, 0, sizeof(elem->ossl_list_retiring)); } static __attribute__((unused)) inline void ossl_list_retiring_insert_head(OSSL_LIST_retiring *list, RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; if (list->alpha != 
...
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) list->alpha->ossl_list_retiring.prev = elem; elem->ossl_list_retiring.next = list->alpha; elem->ossl_list_retiring.prev = 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
...
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) list->omega = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_retiring_insert_tail(OSSL_LIST_retiring *list, RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; if (list->omega != 
...
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) list->omega->ossl_list_retiring.next = elem; elem->ossl_list_retiring.prev = list->omega; elem->ossl_list_retiring.next = 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
...
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_retiring_insert_before(OSSL_LIST_retiring *list, RCID *e, RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; elem->ossl_list_retiring.next = e; elem->ossl_list_retiring.prev = e->ossl_list_retiring.prev; if (e->ossl_list_retiring.prev != 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) e->ossl_list_retiring.prev->ossl_list_retiring.next = elem; e->ossl_list_retiring.prev = elem; if (list->alpha == e) list->alpha = elem; list->num_elems++; } static __attribute__((unused)) inline void ossl_list_retiring_insert_after(OSSL_LIST_retiring *list, RCID *e, RCID *elem) { 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void) (0))
# 137 "../ssl/quic/quic_rcidm.c"
; elem->ossl_list_retiring.prev = e; elem->ossl_list_retiring.next = e->ossl_list_retiring.next; if (e->ossl_list_retiring.next != 
# 137 "../ssl/quic/quic_rcidm.c" 3 4
((void *)0)
# 137 "../ssl/quic/quic_rcidm.c"
) e->ossl_list_retiring.next->ossl_list_retiring.prev = elem; e->ossl_list_retiring.next = elem; if (list->omega == e) list->omega = elem; list->num_elems++; } struct ossl_list_st_retiring;
# 161 "../ssl/quic/quic_rcidm.c"
struct quic_rcidm_st {
# 171 "../ssl/quic/quic_rcidm.c"
    ...
    OSSL_PRIORITY_QUEUE_RCID *rcids;
# 203 "../ssl/quic/quic_rcidm.c"
    RCID *cur_rcid;
# 213 "../ssl/quic/quic_rcidm.c"
    OSSL_LIST_retiring retiring_list;
...
# 251 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))

                                                 
# 253 "../ssl/quic/quic_rcidm.c"
                                                ;
    
# 254 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
                                         
# 255 "../ssl/quic/quic_rcidm.c"
                                        ;
    
# 256 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
                                        
# 257 "../ssl/quic/quic_rcidm.c"
                                       ;
    
# 258 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))


                                                   
# 261 "../ssl/quic/quic_rcidm.c"
                                                  ;
    
# 262 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 262 "../ssl/quic/quic_rcidm.c"
                                                                ;
    
# 263 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 263 "../ssl/quic/quic_rcidm.c"
                                                                  ;
    
# 264 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 264 "../ssl/quic/quic_rcidm.c"
                                               ;
    
# 265 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 265 "../ssl/quic/quic_rcidm.c"
                                                                           ;
    
# 266 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
                                                  
# 267 "../ssl/quic/quic_rcidm.c"
                                                 ;
    
# 268 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 268 "../ssl/quic/quic_rcidm.c"
                                                               ;
    
# 269 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 269 "../ssl/quic/quic_rcidm.c"
                                                                        ;
}
...
QUIC_RCIDM *ossl_quic_rcidm_new(const QUIC_CONN_ID *initial_odcid)
{
    ...
    if ((rcidm = CRYPTO_zalloc(sizeof(*rcidm), "../ssl/quic/quic_rcidm.c", 285)) == 
# 285 "../ssl/quic/quic_rcidm.c" 3 4
                                                   ((void *)0)
# 285 "../ssl/quic/quic_rcidm.c"
                                                       )
        return 
# 286 "../ssl/quic/quic_rcidm.c" 3 4
              ((void *)0)
# 286 "../ssl/quic/quic_rcidm.c"
                  ;

    if ((rcidm->rcids = ossl_pqueue_RCID_new(rcid_cmp)) == 
# 288 "../ssl/quic/quic_rcidm.c" 3 4
                                                          ((void *)0)
# 288 "../ssl/quic/quic_rcidm.c"
                                                              ) {
        CRYPTO_free(rcidm, "../ssl/quic/quic_rcidm.c", 289);
        return 
# 290 "../ssl/quic/quic_rcidm.c" 3 4
              ((void *)0)
# 290 "../ssl/quic/quic_rcidm.c"
                  ;
    }

    if (initial_odcid != 
# 293 "../ssl/quic/quic_rcidm.c" 3 4
                        ((void *)0)
# 293 "../ssl/quic/quic_rcidm.c"
                            ) {
...
void ossl_quic_rcidm_free(QUIC_RCIDM *rcidm)
{
    ...
    if (rcidm == 
# 306 "../ssl/quic/quic_rcidm.c" 3 4
                ((void *)0)
# 306 "../ssl/quic/quic_rcidm.c"
                    )
        return;

    CRYPTO_free(rcidm->cur_rcid, "../ssl/quic/quic_rcidm.c", 309);
    while ((rcid = ossl_pqueue_RCID_pop(rcidm->rcids)) != 
# 310 "../ssl/quic/quic_rcidm.c" 3 4
                                                         ((void *)0)
# 310 "../ssl/quic/quic_rcidm.c"
                                                             )
        CRYPTO_free(rcid, "../ssl/quic/quic_rcidm.c", 311);

    for ((rcid) = (ossl_list_retiring_head(&rcidm->retiring_list)); (rcid) != 
# 313 "../ssl/quic/quic_rcidm.c" 3 4
   ((void *)0) 
# 313 "../ssl/quic/quic_rcidm.c"
   && (((rnext) = ossl_list_retiring_next(rcid)), 1); (rcid) = (rnext))
        CRYPTO_free(rcid, "../ssl/quic/quic_rcidm.c", 314);

    ossl_pqueue_RCID_free(rcidm->rcids);
    CRYPTO_free(rcidm, "../ssl/quic/quic_rcidm.c", 317);
}
...
{
    if (rcid == 
# 323 "../ssl/quic/quic_rcidm.c" 3 4
               ((void *)0)
# 323 "../ssl/quic/quic_rcidm.c"
                   ) {
                               ...
                               unsigned int type)
{
    ...
    if (cid->id_len < 1 || cid->id_len > 20
        || seq_num > (((uint64_t)1 << 62) - 1)
        || ossl_pqueue_RCID_num(rcidm->rcids) + rcidm->num_retiring
            > (
# 350 "../ssl/quic/quic_rcidm.c" 3 4
             (18446744073709551615UL) 
# 350 "../ssl/quic/quic_rcidm.c"
             / 2))
        return 
# 351 "../ssl/quic/quic_rcidm.c" 3 4
              ((void *)0)
# 351 "../ssl/quic/quic_rcidm.c"
                  ;

    if ((rcid = CRYPTO_zalloc(sizeof(*rcid), "../ssl/quic/quic_rcidm.c", 353)) == 
# 353 "../ssl/quic/quic_rcidm.c" 3 4
                                                 ((void *)0)
# 353 "../ssl/quic/quic_rcidm.c"
                                                     )
        return 
# 354 "../ssl/quic/quic_rcidm.c" 3 4
              ((void *)0)
# 354 "../ssl/quic/quic_rcidm.c"
                  ;
    ...
    if (rcid->seq_num >= rcidm->retire_prior_to) {
        ...
        if (!ossl_pqueue_RCID_push(rcidm->rcids, rcid, &rcid->pq_idx)) {
            CRYPTO_free(rcid, "../ssl/quic/quic_rcidm.c", 364);
            return 
# 365 "../ssl/quic/quic_rcidm.c" 3 4
                  ((void *)0)
# 365 "../ssl/quic/quic_rcidm.c"
                      ;
        }
    } else {
        ...
        rcid->pq_idx = 
# 370 "../ssl/quic/quic_rcidm.c" 3 4
                         (18446744073709551615UL)
# 370 "../ssl/quic/quic_rcidm.c"
                                 ;
...
# 384 "../ssl/quic/quic_rcidm.c" 3 4
   ((void) (0))
# 384 "../ssl/quic/quic_rcidm.c"
                                                             ;
    rcidm_check_rcid(rcidm, rcid);
    if (state == old_state)
        return;
    ...
    if (rcidm->cur_rcid != 
# 389 "../ssl/quic/quic_rcidm.c" 3 4
                          ((void *)0) 
# 389 "../ssl/quic/quic_rcidm.c"
                               && state == RCID_STATE_CUR) {
        rcidm_transition_rcid(rcidm, rcidm->cur_rcid, RCID_STATE_RETIRING);
        
# 391 "../ssl/quic/quic_rcidm.c" 3 4
       ((void) (0))
# 391 "../ssl/quic/quic_rcidm.c"
                                      ;
    }
    ...
    if (old_state == RCID_STATE_PENDING) {
        ...
        rcid->pq_idx = 
# 396 "../ssl/quic/quic_rcidm.c" 3 4
                      (18446744073709551615UL)
# 396 "../ssl/quic/quic_rcidm.c"
                              ;
    }
    ...
    if (state == RCID_STATE_CUR) {
        ...
        if (old_state == RCID_STATE_CUR)
            rcidm->cur_rcid = 
# 405 "../ssl/quic/quic_rcidm.c" 3 4
                             ((void *)0)
# 405 "../ssl/quic/quic_rcidm.c"
                                 ;
...
{
    if (rcid == 
# 416 "../ssl/quic/quic_rcidm.c" 3 4
               ((void *)0)
# 416 "../ssl/quic/quic_rcidm.c"
                   )
        return;
    ...
    case RCID_STATE_CUR:
        rcidm->cur_rcid = 
# 426 "../ssl/quic/quic_rcidm.c" 3 4
                         ((void *)0)
# 426 "../ssl/quic/quic_rcidm.c"
                             ;
        break;
...
# 433 "../ssl/quic/quic_rcidm.c" 3 4
       ((void) (0))
# 433 "../ssl/quic/quic_rcidm.c"
                ;
        break;
    }

    CRYPTO_free(rcid, "../ssl/quic/quic_rcidm.c", 437);
}
                                         ...
                                         uint64_t retire_prior_to)
{
    ...
    if (rcidm->cur_rcid != 
# 451 "../ssl/quic/quic_rcidm.c" 3 4
                          ((void *)0) 
# 451 "../ssl/quic/quic_rcidm.c"
                               && rcidm->cur_rcid->seq_num < retire_prior_to)
        rcidm_transition_rcid(rcidm, rcidm->cur_rcid, RCID_STATE_RETIRING);
    ...
    while ((rcid = ossl_pqueue_RCID_peek(rcidm->rcids)) != 
# 459 "../ssl/quic/quic_rcidm.c" 3 4
                                                          ((void *)0)
           
# 460 "../ssl/quic/quic_rcidm.c"
...
static void rcidm_roll(QUIC_RCIDM *rcidm)
{
    ...
    if ((rcid = ossl_pqueue_RCID_peek(rcidm->rcids)) == 
# 475 "../ssl/quic/quic_rcidm.c" 3 4
                                                       ((void *)0)
# 475 "../ssl/quic/quic_rcidm.c"
                                                           )
        return;
    ...
    if (rcidm->packets_sent >= 10000)
        rcidm->packets_sent %= 10000;
    else
...
static void rcidm_update(QUIC_RCIDM *rcidm)
{
    ...
    if (rcidm->cur_rcid == 
# 496 "../ssl/quic/quic_rcidm.c" 3 4
                          ((void *)0)
        
# 497 "../ssl/quic/quic_rcidm.c"
       && (rcid = ossl_pqueue_RCID_peek(rcidm->rcids)) != 
# 497 "../ssl/quic/quic_rcidm.c" 3 4
                                                          ((void *)0)
# 497 "../ssl/quic/quic_rcidm.c"
                                                              ) {
        rcidm_transition_rcid(rcidm, rcid, RCID_STATE_CUR);
        
# 499 "../ssl/quic/quic_rcidm.c" 3 4
       ((void) (0))
# 499 "../ssl/quic/quic_rcidm.c"
                                      ;
    }


    if (rcidm->cur_rcid != 
# 503 "../ssl/quic/quic_rcidm.c" 3 4
                          ((void *)0)
# 503 "../ssl/quic/quic_rcidm.c"
                              ) {
...
# 524 "../ssl/quic/quic_rcidm.c" 3 4
                                   ((void *)0)
# 524 "../ssl/quic/quic_rcidm.c"
                                       );
}
                                     ...
                                     const QUIC_CONN_ID *rcid)
{
    ...
    rcid_obj = rcidm_create_rcid(rcidm, 0,
                                 rcid, RCID_TYPE_INITIAL);
    if (rcid_obj == 
# 590 "../ssl/quic/quic_rcidm.c" 3 4
                   ((void *)0)
# 590 "../ssl/quic/quic_rcidm.c"
                       )
        return 0;
                                  ...
                                  const OSSL_QUIC_FRAME_NEW_CONN_ID *ncid)
{
    ...
    if (rcid == 
# 616 "../ssl/quic/quic_rcidm.c" 3 4
               ((void *)0)
# 616 "../ssl/quic/quic_rcidm.c"
                   )
        return 0;
...
static int rcidm_get_retire(QUIC_RCIDM *rcidm, uint64_t *seq_num, int peek)
{
    ...
    if (rcid == 
# 633 "../ssl/quic/quic_rcidm.c" 3 4
               ((void *)0)
# 633 "../ssl/quic/quic_rcidm.c"
                   )
        return 0;

    if (seq_num != 
# 636 "../ssl/quic/quic_rcidm.c" 3 4
                  ((void *)0)
# 636 "../ssl/quic/quic_rcidm.c"
                      )
...
size_t ossl_quic_rcidm_get_num_active(const QUIC_RCIDM *rcidm)
{
    return ossl_pqueue_RCID_num(rcidm->rcids)
        + (rcidm->cur_rcid != 
# 681 "../ssl/quic/quic_rcidm.c" 3 4
                             ((void *)0) 
# 681 "../ssl/quic/quic_rcidm.c"
                                  ? 1 : 0)
