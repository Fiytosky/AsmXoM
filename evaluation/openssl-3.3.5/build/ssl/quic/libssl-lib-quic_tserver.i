# 0 "../ssl/quic/quic_tserver.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_tserver.c"
# 10 "../ssl/quic/quic_tserver.c"
...
# 14 "../include/internal/quic_tserver.h" 2
...
void ossl_quic_tserver_set_psk_find_session_cb(QUIC_TSERVER *srv,
                                               SSL_psk_find_session_cb_func cb);
# 11 "../ssl/quic/quic_tserver.c" 2


# 1 "../include/internal/quic_port.h" 1
# 14 "../include/internal/quic_port.h"
                          ...
                          unsigned int inlen, void *arg)
{
    ...
    if (srv->args.alpn == 
# 64 "../ssl/quic/quic_tserver.c" 3 4
                         ((void *)0)
# 64 "../ssl/quic/quic_tserver.c"
                             ) {
        alpn = alpndeflt;
...
{
    QUIC_TSERVER *srv = 
# 82 "../ssl/quic/quic_tserver.c" 3 4
                       ((void *)0)
# 82 "../ssl/quic/quic_tserver.c"
                           ;
    QUIC_ENGINE_ARGS engine_args = {0};
    QUIC_PORT_ARGS port_args = {0};
    QUIC_CONNECTION *qc = 
# 85 "../ssl/quic/quic_tserver.c" 3 4
                         ((void *)0)
# 85 "../ssl/quic/quic_tserver.c"
                             ;

    if (args->net_rbio == 
# 87 "../ssl/quic/quic_tserver.c" 3 4
                         ((void *)0) 
# 87 "../ssl/quic/quic_tserver.c"
                              || args->net_wbio == 
# 87 "../ssl/quic/quic_tserver.c" 3 4
                                                   ((void *)0)
# 87 "../ssl/quic/quic_tserver.c"
    ...
    if ((srv = CRYPTO_zalloc(sizeof(*srv), "../ssl/quic/quic_tserver.c", 90)) == 
# 90 "../ssl/quic/quic_tserver.c" 3 4
                                               ((void *)0)
# 90 "../ssl/quic/quic_tserver.c"
                                                   )
        goto err;
    ...
    if ((srv->mutex = ossl_crypto_mutex_new()) == 
# 96 "../ssl/quic/quic_tserver.c" 3 4
                                                 ((void *)0)
# 96 "../ssl/quic/quic_tserver.c"
                                                     )
        goto err;


    if (args->ctx != 
# 100 "../ssl/quic/quic_tserver.c" 3 4
                    ((void *)0)
# 100 "../ssl/quic/quic_tserver.c"
                        )
        srv->ctx = args->ctx;
    else
        srv->ctx = SSL_CTX_new_ex(srv->args.libctx, srv->args.propq,
                                  TLS_method());
    if (srv->ctx == 
# 105 "../ssl/quic/quic_tserver.c" 3 4
                   ((void *)0)
# 105 "../ssl/quic/quic_tserver.c"
                       )
        goto err;

    if (certfile != 
# 108 "../ssl/quic/quic_tserver.c" 3 4
                   ((void *)0)
            
# 109 "../ssl/quic/quic_tserver.c"
           && SSL_CTX_use_certificate_file(srv->ctx, certfile, 1) <= 0)
        goto err;

    if (keyfile != 
# 112 "../ssl/quic/quic_tserver.c" 3 4
                  ((void *)0)
            
# 113 "../ssl/quic/quic_tserver.c"
           && SSL_CTX_use_PrivateKey_file(srv->ctx, keyfile, 1) <= 0)
        goto err;
    ...
    if (srv->tls == 
# 119 "../ssl/quic/quic_tserver.c" 3 4
                   ((void *)0)
# 119 "../ssl/quic/quic_tserver.c"
                       )
        goto err;
    ...
    if ((srv->engine = ossl_quic_engine_new(&engine_args)) == 
# 128 "../ssl/quic/quic_tserver.c" 3 4
                                                             ((void *)0)
# 128 "../ssl/quic/quic_tserver.c"
                                                                 )
        goto err;
...
# 134 "../ssl/quic/quic_tserver.c" 3 4
                                                                              ((void *)0)
# 134 "../ssl/quic/quic_tserver.c"
                                                                                  )
        goto err;

    if ((srv->ch = ossl_quic_port_create_incoming(srv->port, srv->tls)) == 
# 137 "../ssl/quic/quic_tserver.c" 3 4
                                                                          ((void *)0)
# 137 "../ssl/quic/quic_tserver.c"
                                                                              )
        goto err;
    ...
    qc = CRYPTO_zalloc(sizeof(*qc), "../ssl/quic/quic_tserver.c", 144);
    if (qc == 
# 145 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 145 "../ssl/quic/quic_tserver.c"
                 )
        goto err;
    srv->ssl = (SSL *)qc;
    qc->ch = srv->ch;
...
err:
    if (srv != 
# 154 "../ssl/quic/quic_tserver.c" 3 4
              ((void *)0)
# 154 "../ssl/quic/quic_tserver.c"
                  ) {
        if (args->ctx == 
# 155 "../ssl/quic/quic_tserver.c" 3 4
                        ((void *)0)
# 155 "../ssl/quic/quic_tserver.c"
                            )
        ...
        CRYPTO_free(qc, "../ssl/quic/quic_tserver.c", 164);
    }

    CRYPTO_free(srv, "../ssl/quic/quic_tserver.c", 167);
    return 
# 168 "../ssl/quic/quic_tserver.c" 3 4
          ((void *)0)
# 168 "../ssl/quic/quic_tserver.c"
              ;
}
...
{
    if (srv == 
# 173 "../ssl/quic/quic_tserver.c" 3 4
              ((void *)0)
# 173 "../ssl/quic/quic_tserver.c"
                  )
        return;
    ...
    CRYPTO_free(srv->ssl, "../ssl/quic/quic_tserver.c", 182);
    SSL_CTX_free(srv->ctx);

    ossl_crypto_mutex_free(&srv->mutex);

    CRYPTO_free(srv, "../ssl/quic/quic_tserver.c", 187);
}
                           ...
                           size_t *bytes_read)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 260 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 260 "../ssl/quic/quic_tserver.c"
                 ) {
        int is_client_init
            = ((stream_id & 1)
               == 0);
...
int ossl_quic_tserver_has_read_ended(QUIC_TSERVER *srv, uint64_t stream_id)
{
    ...
    if (qs == 
# 322 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 322 "../ssl/quic/quic_tserver.c"
                 )
        return 0;
...
# 348 "../ssl/quic/quic_tserver.c" 3 4
       ((void) (0))
# 348 "../ssl/quic/quic_tserver.c"
                                        ;
        
# 349 "../ssl/quic/quic_tserver.c" 3 4
       ((void) (0))
# 349 "../ssl/quic/quic_tserver.c"
                                                              ;
                            ...
                            size_t *bytes_written)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 373 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0) 
# 373 "../ssl/quic/quic_tserver.c"
...
int ossl_quic_tserver_conclude(QUIC_TSERVER *srv, uint64_t stream_id)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 401 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0) 
# 401 "../ssl/quic/quic_tserver.c"
                  || !ossl_quic_stream_has_send_buffer(qs))
        return 0;

    if (!ossl_quic_sstream_get_final_size(qs->sstream, 
# 404 "../ssl/quic/quic_tserver.c" 3 4
                                                      ((void *)0)
# 404 "../ssl/quic/quic_tserver.c"
                                                          )) {
                                 ...
                                 uint64_t *stream_id)
{
    ...
    if ((qs = ossl_quic_channel_new_stream_local(srv->ch, is_uni)) == 
# 422 "../ssl/quic/quic_tserver.c" 3 4
                                                                     ((void *)0)
# 422 "../ssl/quic/quic_tserver.c"
                                                                         )
        return 0;
                                                   ...
                                                   uint64_t *app_error_code)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 447 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 447 "../ssl/quic/quic_tserver.c"
                 )
        return 0;

    if (qs->peer_stop_sending && app_error_code != 
# 450 "../ssl/quic/quic_tserver.c" 3 4
                                                  ((void *)0)
# 450 "../ssl/quic/quic_tserver.c"
                                                      )
                                                   ...
                                                   uint64_t *app_error_code)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 464 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 464 "../ssl/quic/quic_tserver.c"
                 )
        return 0;

    if (ossl_quic_stream_recv_is_reset(qs) && app_error_code != 
# 467 "../ssl/quic/quic_tserver.c" 3 4
                                                               ((void *)0)
# 467 "../ssl/quic/quic_tserver.c"
                                                                   )
...
uint64_t ossl_quic_tserver_pop_incoming_stream(QUIC_TSERVER *srv)
{
    ...
    if (qs == 
# 485 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 485 "../ssl/quic/quic_tserver.c"
                 )
        return 
# 486 "../ssl/quic/quic_tserver.c" 3 4
              (18446744073709551615UL)
# 486 "../ssl/quic/quic_tserver.c"
                        ;
                                              ...
                                              uint64_t stream_id)
{
    ...
    qs = ossl_quic_stream_map_get_by_id(ossl_quic_channel_get_qsm(srv->ch),
                                        stream_id);
    if (qs == 
# 500 "../ssl/quic/quic_tserver.c" 3 4
             ((void *)0)
# 500 "../ssl/quic/quic_tserver.c"
                 )
        return 1;
...
int ossl_quic_tserver_shutdown(QUIC_TSERVER *srv, uint64_t app_error_code)
{
    ossl_quic_channel_local_close(srv->ch, app_error_code, 
# 526 "../ssl/quic/quic_tserver.c" 3 4
                                                          ((void *)0)
# 526 "../ssl/quic/quic_tserver.c"
                                                              );
