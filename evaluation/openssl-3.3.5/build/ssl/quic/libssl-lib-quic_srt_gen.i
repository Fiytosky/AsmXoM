# 0 "../ssl/quic/quic_srt_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_srt_gen.c"
# 9 "../ssl/quic/quic_srt_gen.c"
...
# 10 "../ssl/quic/quic_srt_gen.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 11 "../ssl/quic/quic_srt_gen.c" 2
                                    ...
                                    const unsigned char *key, size_t key_len)
{
    ...
    if ((srt_gen = CRYPTO_zalloc(sizeof(*srt_gen), "../ssl/quic/quic_srt_gen.c", 28)) == 
# 28 "../ssl/quic/quic_srt_gen.c" 3 4
                                                       ((void *)0)
# 28 "../ssl/quic/quic_srt_gen.c"
                                                           )
        return 
# 29 "../ssl/quic/quic_srt_gen.c" 3 4
              ((void *)0)
# 29 "../ssl/quic/quic_srt_gen.c"
                  ;

    if ((srt_gen->mac = EVP_MAC_fetch(libctx, "HMAC", propq)) == 
# 31 "../ssl/quic/quic_srt_gen.c" 3 4
                                                                ((void *)0)
# 31 "../ssl/quic/quic_srt_gen.c"
                                                                    )
        goto err;

    if ((srt_gen->mac_ctx = EVP_MAC_CTX_new(srt_gen->mac)) == 
# 34 "../ssl/quic/quic_srt_gen.c" 3 4
                                                             ((void *)0)
# 34 "../ssl/quic/quic_srt_gen.c"
                                                                 )
        goto err;

    *p++ = OSSL_PARAM_construct_utf8_string("digest", "SHA256", 7);
    if (propq != 
# 38 "../ssl/quic/quic_srt_gen.c" 3 4
                ((void *)0)
# 38 "../ssl/quic/quic_srt_gen.c"
                    )
...
err:
    ...
    return 
# 50 "../ssl/quic/quic_srt_gen.c" 3 4
          ((void *)0)
# 50 "../ssl/quic/quic_srt_gen.c"
              ;
}
...
{
    if (srt_gen == 
# 55 "../ssl/quic/quic_srt_gen.c" 3 4
                  ((void *)0)
# 55 "../ssl/quic/quic_srt_gen.c"
                      )
        return;

    EVP_MAC_CTX_free(srt_gen->mac_ctx);
    EVP_MAC_free(srt_gen->mac);
    CRYPTO_free(srt_gen, "../ssl/quic/quic_srt_gen.c", 60);
}
                                      ...
                                      QUIC_STATELESS_RESET_TOKEN *token)
{
    ...
    if (!EVP_MAC_init(srt_gen->mac_ctx, 
# 70 "../ssl/quic/quic_srt_gen.c" 3 4
                                       ((void *)0)
# 70 "../ssl/quic/quic_srt_gen.c"
                                           , 0, 
# 70 "../ssl/quic/quic_srt_gen.c" 3 4
                                                ((void *)0)
# 70 "../ssl/quic/quic_srt_gen.c"
...
# 81 "../ssl/quic/quic_srt_gen.c" 3 4
   ((void) (0))
# 81 "../ssl/quic/quic_srt_gen.c"
                                              ;
