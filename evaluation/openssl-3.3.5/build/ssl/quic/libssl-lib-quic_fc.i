# 0 "../ssl/quic/quic_fc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/quic/quic_fc.c"
# 10 "../ssl/quic/quic_fc.c"
...
# 13 "../ssl/quic/quic_fc.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 15 "../ssl/quic/quic_fc.c" 2
...
# 16 "../ssl/quic/quic_fc.c" 3 4
((void *)0) 
# 16 "../ssl/quic/quic_fc.c"
...
{
    if (conn_txfc != 
# 25 "../ssl/quic/quic_fc.c" 3 4
                    ((void *)0) 
# 25 "../ssl/quic/quic_fc.c"
                         && conn_txfc->parent != 
# 25 "../ssl/quic/quic_fc.c" 3 4
                                                 ((void *)0)
# 25 "../ssl/quic/quic_fc.c"
...
# 51 "../ssl/quic/quic_fc.c" 3 4
   ((void) (0))
# 51 "../ssl/quic/quic_fc.c"
                                              ;
...
uint64_t ossl_quic_txfc_get_credit(QUIC_TXFC *txfc, uint64_t consumed)
{
    ...
    if (txfc->parent != 
# 61 "../ssl/quic/quic_fc.c" 3 4
                       ((void *)0)
# 61 "../ssl/quic/quic_fc.c"
                           ) {
        
# 62 "../ssl/quic/quic_fc.c" 3 4
       ((void) (0))
# 62 "../ssl/quic/quic_fc.c"
                                           ;
...
int ossl_quic_txfc_consume_credit(QUIC_TXFC *txfc, uint64_t num_bytes)
{
    ...
    if (txfc->parent != 
# 92 "../ssl/quic/quic_fc.c" 3 4
                       ((void *)0)
# 92 "../ssl/quic/quic_fc.c"
                           ) {
        
# 93 "../ssl/quic/quic_fc.c" 3 4
       ((void) (0))
# 93 "../ssl/quic/quic_fc.c"
                                           ;
...
{
    if (conn_rxfc != 
# 132 "../ssl/quic/quic_fc.c" 3 4
                    ((void *)0) 
# 132 "../ssl/quic/quic_fc.c"
                         && conn_rxfc->parent != 
# 132 "../ssl/quic/quic_fc.c" 3 4
                                                 ((void *)0)
# 132 "../ssl/quic/quic_fc.c"
...
int ossl_quic_rxfc_init_standalone(QUIC_RXFC *rxfc,
                                   ...
                                   void *now_arg)
{
    if (!ossl_quic_rxfc_init(rxfc, 
# 158 "../ssl/quic/quic_fc.c" 3 4
                                  ((void *)0)
# 158 "../ssl/quic/quic_fc.c"
                                      ,
...
int ossl_quic_rxfc_on_rx_stream_frame(QUIC_RXFC *rxfc, uint64_t end, int is_fin)
{
    ...
    if (!rxfc->standalone && rxfc->parent == 
# 203 "../ssl/quic/quic_fc.c" 3 4
                                            ((void *)0)
# 203 "../ssl/quic/quic_fc.c"
                                                )
        return 0;

    if (rxfc->is_fin && ((is_fin && rxfc->hwm != end) || end > rxfc->hwm)) {

        rxfc->error_code = 0x06;
        return 1;
    }
    ...
    if (end > rxfc->hwm) {
        ...
        if (rxfc->parent != 
# 220 "../ssl/quic/quic_fc.c" 3 4
                           ((void *)0)
# 220 "../ssl/quic/quic_fc.c"
                               )
...
{
    if (rxfc->parent == 
# 344 "../ssl/quic/quic_fc.c" 3 4
                       ((void *)0) 
# 344 "../ssl/quic/quic_fc.c"
                            && !rxfc->standalone)
        return 0;
...
int ossl_quic_rxfc_get_final_size(const QUIC_RXFC *rxfc, uint64_t *final_size)
{
    ...
    if (final_size != 
# 407 "../ssl/quic/quic_fc.c" 3 4
                     ((void *)0)
# 407 "../ssl/quic/quic_fc.c"
                         )
        *final_size = rxfc->hwm;
