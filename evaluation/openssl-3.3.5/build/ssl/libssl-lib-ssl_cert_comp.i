# 0 "../ssl/ssl_cert_comp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/ssl_cert_comp.c"
# 10 "../ssl/ssl_cert_comp.c"
...
int ossl_comp_has_alg(int a)
{
# 55 "../ssl/ssl_cert_comp.c"
    return 0;
}
# 360 "../ssl/ssl_cert_comp.c"
int SSL_CTX_set1_cert_comp_preference(SSL_CTX *ctx, int *algs, size_t len)
{
...
{
    int ret = 0;
# 407 "../ssl/ssl_cert_comp.c"
    return ret;
}

size_t SSL_get1_compressed_cert(SSL *ssl, int alg, unsigned char **data, size_t *orig_len)
{
# 423 "../ssl/ssl_cert_comp.c"
    return 0;
