...
# 20 "../ssl/s3_enc.c"
    ...
    k = 0;
    md5 = ssl_evp_md_fetch(sctx->libctx, 4, sctx->propq);
    sha1 = ssl_evp_md_fetch(sctx->libctx, 64, sctx->propq);
    m5 = EVP_MD_CTX_new();
    s1 = EVP_MD_CTX_new();
    if (md5 == 
# 37 "../ssl/s3_enc.c" 3 4
...
# 37 "../ssl/s3_enc.c"
        ...
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 38, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 38 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 38 "../ssl/s3_enc.c"
       );
    ...
    for (i = 0; (int)i < num; i += 16) {
        k++;
        if (k > sizeof(buf)) {

            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 45, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 45 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 45 "../ssl/s3_enc.c"
           );
...
# 51 "../ssl/s3_enc.c"
            ...
            || !EVP_DigestUpdate(s1, s->s3.server_random, 32)
            || !EVP_DigestUpdate(s1, s->s3.client_random, 32)
            || !EVP_DigestFinal_ex(s1, smd, 
# 57 "../ssl/s3_enc.c" 3 4
                                           ((void *)0)
# 57 "../ssl/s3_enc.c"
                                               )
            || !EVP_DigestInit_ex(m5, md5, 
# 58 "../ssl/s3_enc.c" 3 4
                                          ((void *)0)
# 58 "../ssl/s3_enc.c"
                                              )
            || !EVP_DigestUpdate(m5, s->session->master_key,
                                 s->session->master_key_length)
            || !EVP_DigestUpdate(m5, smd, 20)) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 62, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 62 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 62 "../ssl/s3_enc.c"
           );
        ...
        if ((int)(i + 16) > num) {
            if (!EVP_DigestFinal_ex(m5, smd, 
# 66 "../ssl/s3_enc.c" 3 4
                                            ((void *)0)
# 66 "../ssl/s3_enc.c"
                                                )) {
                (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 67, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 67 "../ssl/s3_enc.c" 3 4
               ((void *)0)
# 67 "../ssl/s3_enc.c"
               );
            ...
            if (!EVP_DigestFinal_ex(m5, km, 
# 72 "../ssl/s3_enc.c" 3 4
                                           ((void *)0)
# 72 "../ssl/s3_enc.c"
                                               )) {
                (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 73, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 73 "../ssl/s3_enc.c" 3 4
               ((void *)0)
# 73 "../ssl/s3_enc.c"
               );
...
# 96 "../ssl/s3_enc.c"
    ...
    if (!__builtin_expect(!!((md != 
# 106 "../ssl/s3_enc.c" 3 4
        ((void *)0)
# 106 "../ssl/s3_enc.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 107, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 107 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 107 "../ssl/s3_enc.c"
       );
        goto err;
    ...
    if (mdi < 0) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 117, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 117 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 117 "../ssl/s3_enc.c"
       );
        goto err;
    ...
    if (n > s->s3.tmp.key_block_length) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 143, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 143 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 143 "../ssl/s3_enc.c"
       );
        goto err;
    ...
    if (!ssl_set_new_record_layer(s, 0x0300,
                                  direction,
                                  3,
                                  
# 150 "../ssl/s3_enc.c" 3 4
                                 ((void *)0)
# 150 "../ssl/s3_enc.c"
                                     , 0, key, key_len, iv, iv_len, mac_secret,
                                  md_len, ciph, 0, 0, md, comp, 
# 151 "../ssl/s3_enc.c" 3 4
                                                                       ((void *)0)
# 151 "../ssl/s3_enc.c"
                                                                           )) {
...
# 174 "../ssl/s3_enc.c"
    ...
    if ((p = CRYPTO_malloc(num, "../ssl/s3_enc.c", 199)) == 
# 199 "../ssl/s3_enc.c" 3 4
                                    ((void *)0)
# 199 "../ssl/s3_enc.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 200, __func__), ossl_statem_fatal)((s), (80), ((15 | (0x2 << 18L))), 
# 200 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 200 "../ssl/s3_enc.c"
       );
        return 0;
...
void ssl3_cleanup_key_block(SSL_CONNECTION *s)
{
    CRYPTO_clear_free(s->s3.tmp.key_block, s->s3.tmp.key_block_length, "../ssl/s3_enc.c", 215);
    s->s3.tmp.key_block = 
# 216 "../ssl/s3_enc.c" 3 4
                         ((void *)0)
# 216 "../ssl/s3_enc.c"
                             ;
...
int ssl3_init_finished_mac(SSL_CONNECTION *s)
{
    ...
    if (buf == 
# 224 "../ssl/s3_enc.c" 3 4
              ((void *)0)
# 224 "../ssl/s3_enc.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 225, __func__), ossl_statem_fatal)((s), (80), ((32 | (0x2 << 18L))), 
# 225 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 225 "../ssl/s3_enc.c"
       );
        return 0;
...
# 242 "../ssl/s3_enc.c" 3 4
                            ((void *)0)
# 242 "../ssl/s3_enc.c"
                                ;
    EVP_MD_CTX_free(s->s3.handshake_dgst);
    s->s3.handshake_dgst = 
# 244 "../ssl/s3_enc.c" 3 4
                          ((void *)0)
# 244 "../ssl/s3_enc.c"
                              ;
}
...
# 253 "../ssl/s3_enc.c"
            ...
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 254, __func__), ossl_statem_fatal)((s), (80), (237), 
# 254 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 254 "../ssl/s3_enc.c"
           );
            return 0;
        ...
        if (ret <= 0 || ret != (int)len) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 259, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 259 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 259 "../ssl/s3_enc.c"
           );
            return 0;
        ...
        if (!ret) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 265, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 265 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 265 "../ssl/s3_enc.c"
           );
            return 0;
...
int ssl3_digest_cached_records(SSL_CONNECTION *s, int keep)
{
    ...
    if (s->s3.handshake_dgst == 
# 278 "../ssl/s3_enc.c" 3 4
                               ((void *)0)
# 278 "../ssl/s3_enc.c"
                                   ) {
        hdatalen = BIO_ctrl(s->s3.handshake_buffer,3,0,(char *)(&hdata));
        if (hdatalen <= 0) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 281, __func__), ossl_statem_fatal)((s), (80), (332), 
# 281 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 281 "../ssl/s3_enc.c"
           );
            return 0;
        ...
        if (s->s3.handshake_dgst == 
# 286 "../ssl/s3_enc.c" 3 4
                                   ((void *)0)
# 286 "../ssl/s3_enc.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 287, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 287 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 287 "../ssl/s3_enc.c"
           );
            return 0;
        ...
        if (md == 
# 292 "../ssl/s3_enc.c" 3 4
                 ((void *)0)
# 292 "../ssl/s3_enc.c"
                     ) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 293, __func__), ossl_statem_fatal)((s), (80), (297), 
# 293 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 293 "../ssl/s3_enc.c"
           )
                                                        ;
        ...
        if (!EVP_DigestInit_ex(s->s3.handshake_dgst, md, 
# 297 "../ssl/s3_enc.c" 3 4
                                                        ((void *)0)
# 297 "../ssl/s3_enc.c"
                                                            )
            || !EVP_DigestUpdate(s->s3.handshake_dgst, hdata, hdatalen)) {
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 299, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 299 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 299 "../ssl/s3_enc.c"
           );
            return 0;
...
{
    int n = 0;
    params[n++] = OSSL_PARAM_construct_octet_string("ssl3-ms",
...
# 325 "../ssl/s3_enc.c"
    ...
    if (EVP_MD_get_type(EVP_MD_CTX_get0_md(s->s3.handshake_dgst)) != 114) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 333, __func__), ossl_statem_fatal)((s), (80), (324), 
# 333 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 333 "../ssl/s3_enc.c"
       );
        return 0;
    ...
    ctx = EVP_MD_CTX_new();
    if (ctx == 
# 338 "../ssl/s3_enc.c" 3 4
              ((void *)0)
# 338 "../ssl/s3_enc.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 339, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 339 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 339 "../ssl/s3_enc.c"
       );
        return 0;
    ...
    if (!EVP_MD_CTX_copy_ex(ctx, s->s3.handshake_dgst)) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 343, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 343 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 343 "../ssl/s3_enc.c"
       );
        ret = 0;
    ...
    ret = EVP_MD_get_size(EVP_MD_CTX_get0_md(ctx));
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 350, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 350 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 350 "../ssl/s3_enc.c"
       );
        ret = 0;
...
# 355 "../ssl/s3_enc.c"
        ...
        if (EVP_DigestUpdate(ctx, sender, len) <= 0
            ...
            || EVP_DigestFinal_ex(ctx, p, 
# 362 "../ssl/s3_enc.c" 3 4
                                         ((void *)0)
# 362 "../ssl/s3_enc.c"
                                             ) <= 0) {
                (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 363, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 363 "../ssl/s3_enc.c" 3 4
               ((void *)0)
# 363 "../ssl/s3_enc.c"
               );
                ret = 0;
                                ...
                                size_t len, size_t *secret_size)
{
    ...
    if (ctx == 
# 395 "../ssl/s3_enc.c" 3 4
              ((void *)0)
# 395 "../ssl/s3_enc.c"
                  ) {
        (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 396, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 396 "../ssl/s3_enc.c" 3 4
       ((void *)0)
# 396 "../ssl/s3_enc.c"
       );
        return 0;
    ...
    for (i = 0; i < 3; i++) {
        if (EVP_DigestInit_ex(ctx, ((s)->ssl.ctx)->sha1, 
# 400 "../ssl/s3_enc.c" 3 4
                                                                   ((void *)0)
# 400 "../ssl/s3_enc.c"
                                                                       ) <= 0
            ...
            || EVP_DigestInit_ex(ctx, ((s)->ssl.ctx)->md5, 
# 409 "../ssl/s3_enc.c" 3 4
                                                                     ((void *)0)
# 409 "../ssl/s3_enc.c"
                                                                         ) <= 0
            || EVP_DigestUpdate(ctx, p, len) <= 0
            ...
            (ERR_new(), ERR_set_debug("../ssl/s3_enc.c", 413, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 413 "../ssl/s3_enc.c" 3 4
           ((void *)0)
# 413 "../ssl/s3_enc.c"
           );
            ret = 0;
