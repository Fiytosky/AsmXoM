...
const SSL3_ENC_METHOD DTLSv1_enc_data = {
    ...
    "\x63\x6c\x69\x65\x6e\x74\x20\x66\x69\x6e\x69\x73\x68\x65\x64", 15,
    "\x73\x65\x72\x76\x65\x72\x20\x66\x69\x6e\x69\x73\x68\x65\x64", 15,
    tls1_alert_code,
...
OSSL_TIME dtls1_default_timeout(void)
{
    ...
    return ossl_ticks2time((60 * 60 * 2) * ((uint64_t)1000000000));
}

int dtls1_new(SSL *ssl)
{
    DTLS1_STATE *d1;
    SSL_CONNECTION *s = ((ssl) == 
# 66 "../ssl/d1_lib.c" 3 4
                       ((void *)0) 
# 66 "../ssl/d1_lib.c"
                       ? 
...
# 68 "../ssl/d1_lib.c"
    ...
    if (!ssl3_new(ssl))
        return 0;
    if ((d1 = CRYPTO_zalloc(sizeof(*d1), "../ssl/d1_lib.c", 77)) == 
# 77 "../ssl/d1_lib.c" 3 4
                                             ((void *)0)
# 77 "../ssl/d1_lib.c"
                                                 ) {
...
# 92 "../ssl/d1_lib.c"
        ...
        CRYPTO_free(d1, "../ssl/d1_lib.c", 95);
        ssl3_free(ssl);
        return 0;
    }
...
{
    pitem *item = 
# 116 "../ssl/d1_lib.c" 3 4
                 ((void *)0)
# 116 "../ssl/d1_lib.c"
                     ;
    hm_fragment *frag = 
# 117 "../ssl/d1_lib.c" 3 4
                       ((void *)0)
# 117 "../ssl/d1_lib.c"
                           ;

    while ((item = pqueue_pop(s->d1->buffered_messages)) != 
# 119 "../ssl/d1_lib.c" 3 4
                                                           ((void *)0)
# 119 "../ssl/d1_lib.c"
                                                               ) {
...
{
    pitem *item = 
# 128 "../ssl/d1_lib.c" 3 4
                 ((void *)0)
# 128 "../ssl/d1_lib.c"
                     ;
    hm_fragment *frag = 
# 129 "../ssl/d1_lib.c" 3 4
                       ((void *)0)
# 129 "../ssl/d1_lib.c"
                           ;

    while ((item = pqueue_pop(s->d1->sent_messages)) != 
# 131 "../ssl/d1_lib.c" 3 4
                                                       ((void *)0)
# 131 "../ssl/d1_lib.c"
                                                           ) {
        frag = (hm_fragment *)item->data;
        ...
        if (frag->msg_header.is_ccs
                && frag->msg_header.saved_retransmit_state.wrlmethod != 
# 135 "../ssl/d1_lib.c" 3 4
                                                                       ((void *)0)
...
# 157 "../ssl/d1_lib.c"
    ...
    CRYPTO_free(s->d1, "../ssl/d1_lib.c", 167);
    s->d1 = 
# 168 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 168 "../ssl/d1_lib.c"
               ;
}
...
# 180 "../ssl/d1_lib.c"
    ...
    if (s->d1) {
        ...
        if (SSL_get_options(ssl) & ((uint64_t)1 << (uint64_t)12)) {
            s->d1->mtu = mtu;
    ...
    if (ssl->method->version == 0x1FFFF)
        s->version = 0xFEFD;

    else if (s->options & ((uint64_t)1 << (uint64_t)15))
        s->client_version = s->version = 0x0100;
...
# 234 "../ssl/d1_lib.c"
    ...
    case 17:
        ...
        if (larg < (long)dtls1_link_min_mtu() - 48)
            return 0;
        s->d1->mtu = larg;
        return larg;
    default:
...
# 295 "../ssl/d1_lib.c"
    ...
    duration = ossl_ticks2time((s->d1->timeout_duration_us) * ((((uint64_t)1000000000) / 1000) / 1000));
...
int dtls1_get_timeout(const SSL_CONNECTION *s, OSSL_TIME *timeleft)
{
    ...
    *timeleft = ossl_time_subtract(s->d1->next_timeout, timenow);
    if (ossl_time_compare(*timeleft, ossl_ticks2time((15) * (((uint64_t)1000000000) / 1000))) <= 0)
...
int dtls1_check_timeout_num(SSL_CONNECTION *s)
{
    ...
    if (s->d1->timeout_num_alerts > 2
        && !(SSL_get_options(ssl) & ((uint64_t)1 << (uint64_t)12))) {
        mtu =
            BIO_ctrl(SSL_get_wbio(ssl), 47, 0, 
# 376 "../ssl/d1_lib.c" 3 4
                                                                           ((void *)0)
# 376 "../ssl/d1_lib.c"
                                                                               );
        if (mtu < s->d1->mtu)
    ...
    if (s->d1->timeout_num_alerts > 12) {

        (ERR_new(), ERR_set_debug("../ssl/d1_lib.c", 383, __func__), ossl_statem_fatal)((s), (-1), (312), 
# 383 "../ssl/d1_lib.c" 3 4
       ((void *)0)
# 383 "../ssl/d1_lib.c"
       );
        return -1;
...
int dtls1_handle_timeout(SSL_CONNECTION *s)
{
    ...
    if (s->d1->timer_cb != 
# 397 "../ssl/d1_lib.c" 3 4
                          ((void *)0)
# 397 "../ssl/d1_lib.c"
                              )
        s->d1->timeout_duration_us = s->d1->timer_cb(((s)->user_ssl),
...
# 423 "../ssl/d1_lib.c"
    ...
    BIO *rbio, *wbio;
    BIO_ADDR *tmpclient = 
# 427 "../ssl/d1_lib.c" 3 4
                         ((void *)0)
# 427 "../ssl/d1_lib.c"
                             ;
    PACKET pkt, msgpkt, msgpayload, session, cookiepkt;
    SSL_CONNECTION *s = ((ssl) == 
# 429 "../ssl/d1_lib.c" 3 4
                       ((void *)0) 
# 429 "../ssl/d1_lib.c"
                       ? 
# 429 "../ssl/d1_lib.c" 3 4
...
# 434 "../ssl/d1_lib.c"
    ...
    if (!rbio || !wbio) {
        (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",449,__func__), ERR_set_error)((20),(128),
# 449 "../ssl/d1_lib.c" 3 4
       ((void *)0)
# 449 "../ssl/d1_lib.c"
       );
        return -1;
...
# 460 "../ssl/d1_lib.c"
    if ((s->version & 0xff00) != (0xFEFF & 0xff00)) {
        (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",461,__func__), ERR_set_error)((20),(259),
# 461 "../ssl/d1_lib.c" 3 4
       ((void *)0)
# 461 "../ssl/d1_lib.c"
       );
        return -1;
    ...
    buf = CRYPTO_malloc(13 + 16384, "../ssl/d1_lib.c", 465);
    if (buf == 
# 466 "../ssl/d1_lib.c" 3 4
              ((void *)0)
# 466 "../ssl/d1_lib.c"
                  )
        return -1;
    wbuf = CRYPTO_malloc(13 + 16384, "../ssl/d1_lib.c", 468);
    if (wbuf == 
# 469 "../ssl/d1_lib.c" 3 4
               ((void *)0)
# 469 "../ssl/d1_lib.c"
                   ) {
        CRYPTO_free(buf, "../ssl/d1_lib.c", 470);
        return -1;
    }
...
# 477 "../ssl/d1_lib.c" 3 4
       (*__errno_location ())
# 477 "../ssl/d1_lib.c"
       =0;
        n = BIO_read(rbio, buf, 16384
                                + 13);
        if (n <= 0) {
            if (BIO_test_flags(rbio, 0x08)) {
        ...
        if (!PACKET_buf_init(&pkt, buf, n)) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",490,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 490 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 490 "../ssl/d1_lib.c"
           );
            ret = -1;
...
# 505 "../ssl/d1_lib.c"
        if (n < 13) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",506,__func__), ERR_set_error)((20),(298),
# 506 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 506 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (!PACKET_get_1(&pkt, &rectype)
            ...
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",514,__func__), ERR_set_error)((20),(159),
# 514 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 514 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (s->msg_callback)
            s->msg_callback(0, (versmajor << 8) | versminor, 0x100, buf,
                            13, ssl, s->msg_callback_arg);

        if (rectype != 22) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",523,__func__), ERR_set_error)((20),(244),
# 523 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 523 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (versmajor != 0xFE) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",532,__func__), ERR_set_error)((20),(116),
# 532 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 532 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (!PACKET_copy_bytes(&pkt, seq, 8)
            || !PACKET_get_length_prefixed_2(&pkt, &msgpkt)) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",539,__func__), ERR_set_error)((20),(159),
# 539 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 539 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (seq[0] != 0 || seq[1] != 0) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",549,__func__), ERR_set_error)((20),(244),
# 549 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 549 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (!PACKET_get_1(&msgpkt, &msgtype)
            ...
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",564,__func__), ERR_set_error)((20),(159),
# 564 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 564 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (msgtype != 1) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",569,__func__), ERR_set_error)((20),(244),
# 569 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 569 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (msgseq > 2) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",575,__func__), ERR_set_error)((20),(402),
# 575 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 575 "../ssl/d1_lib.c"
           );
            goto end;
...
# 586 "../ssl/d1_lib.c"
        if (fragoff != 0 || fraglen > msglen) {
            ...
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",588,__func__), ERR_set_error)((20),(401),
# 588 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 588 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (s->msg_callback)
            s->msg_callback(0, s->version, 22, data,
                            fraglen + 12, ssl,
                            s->msg_callback_arg);

        if (!PACKET_get_net_2(&msgpayload, &clientvers)) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",598,__func__), ERR_set_error)((20),(159),
# 598 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 598 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (((((clientvers) == 0x0100) ? 0xff00 : (clientvers)) > ((((unsigned int)ssl->method->version) == 0x0100) ? 0xff00 : ((unsigned int)ssl->method->version))) &&
            ssl->method->version != 0x1FFFF) {
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",607,__func__), ERR_set_error)((20),(267),
# 607 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 607 "../ssl/d1_lib.c"
           );
            goto end;
        ...
        if (!PACKET_forward(&msgpayload, 32)
            ...
            (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",618,__func__), ERR_set_error)((20),(159),
# 618 "../ssl/d1_lib.c" 3 4
           ((void *)0)
# 618 "../ssl/d1_lib.c"
           );
            goto end;
...
# 632 "../ssl/d1_lib.c" 3 4
                                                 ((void *)0)
# 632 "../ssl/d1_lib.c"
                                                     ) {
                (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",633,__func__), ERR_set_error)((20),(403),
# 633 "../ssl/d1_lib.c" 3 4
               ((void *)0)
# 633 "../ssl/d1_lib.c"
               );
        ...
        if (next == 1) {
            ...
            size_t wreclen;
# 663 "../ssl/d1_lib.c"
            if (ssl->ctx->app_gen_cookie_cb == 
# 663 "../ssl/d1_lib.c" 3 4
                                              ((void *)0) 
# 663 "../ssl/d1_lib.c"
                                                   ||
                ssl->ctx->app_gen_cookie_cb(ssl, cookie, &cookielen) == 0 ||
                cookielen > 255) {
                (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",666,__func__), ERR_set_error)((20),(400),
# 666 "../ssl/d1_lib.c" 3 4
               ((void *)0)
# 666 "../ssl/d1_lib.c"
               );
            ...
            version = (ssl->method->version == 0x1FFFF) ? 0xFEFF
                                                                 : s->version;
            ...
            if (!WPACKET_init_static_len(&wpkt,
                                         ...
                                         + 13,
                                         0)
                    || !WPACKET_put_bytes__((&wpkt), (22), 1)
                    || !WPACKET_put_bytes__((&wpkt), (version), 2)




                    || !WPACKET_memcpy(&wpkt, seq, 8)

                    || !WPACKET_start_sub_packet_len__((&wpkt), 2)

                    || !WPACKET_put_bytes__((&wpkt), (3), 1)
                    ...
                    || !WPACKET_put_bytes__((&wpkt), (0), 3)




                    || !WPACKET_put_bytes__((&wpkt), (0), 2)
                    ...
                    || !WPACKET_start_sub_packet_len__((&wpkt), 3)
                    ...
                    || !WPACKET_finish(&wpkt)) {
                (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",730,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 730 "../ssl/d1_lib.c" 3 4
               ((void *)0)
# 730 "../ssl/d1_lib.c"
               );
...
# 744 "../ssl/d1_lib.c"
            ...
            if (s->msg_callback)
                s->msg_callback(1, 0, 0x100, buf,
                                13, ssl,
                                s->msg_callback_arg);

            if ((tmpclient = BIO_ADDR_new()) == 
# 753 "../ssl/d1_lib.c" 3 4
                                               ((void *)0)
# 753 "../ssl/d1_lib.c"
                                                   ) {
                (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",754,__func__), ERR_set_error)((20),((32 | (0x2 << 18L))),
# 754 "../ssl/d1_lib.c" 3 4
               ((void *)0)
# 754 "../ssl/d1_lib.c"
               );
                goto end;
            ...
            if ((int)BIO_ctrl(rbio, 46, 0, (char *)(tmpclient)) > 0) {
                (void)(int)BIO_ctrl(wbio, 44, 0, (char *)(tmpclient));
            }
            BIO_ADDR_free(tmpclient);
            tmpclient = 
# 767 "../ssl/d1_lib.c" 3 4
                       ((void *)0)
# 767 "../ssl/d1_lib.c"
                           ;

            if (BIO_write(wbio, wbuf, wreclen) < (int)wreclen) {
                if (BIO_test_flags(wbio, 0x08)) {
...
# 781 "../ssl/d1_lib.c"
    ...
    SSL_set_options(ssl, ((uint64_t)1 << (uint64_t)13));
    ...
    if ((int)BIO_ctrl(rbio, 46, 0, (char *)(client)) <= 0)
        BIO_ADDR_clear(client);


    if (BIO_write(s->rlayer.rrlnext, buf, n) != n) {
        (ERR_new(), ERR_set_debug("../ssl/d1_lib.c",823,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 823 "../ssl/d1_lib.c" 3 4
       ((void *)0)
# 823 "../ssl/d1_lib.c"
       );
        ret = -1;
    ...
    if (!ssl_set_new_record_layer(s,
                                  ...
                                  0,
                                  0, 
# 835 "../ssl/d1_lib.c" 3 4
                                                                    ((void *)0)
# 835 "../ssl/d1_lib.c"
                                                                        , 0,
                                  
# 836 "../ssl/d1_lib.c" 3 4
                                 ((void *)0)
# 836 "../ssl/d1_lib.c"
                                     , 0, 
# 836 "../ssl/d1_lib.c" 3 4
...
# 837 "../ssl/d1_lib.c"
    ...
    BIO_ADDR_free(tmpclient);
    CRYPTO_free(buf, "../ssl/d1_lib.c", 846);
    CRYPTO_free(wbuf, "../ssl/d1_lib.c", 847);
    return ret;
}
...
int dtls1_query_mtu(SSL_CONNECTION *s)
{
    ...
    if (s->d1->link_mtu) {
        s->d1->mtu =
            s->d1->link_mtu - (unsigned int)BIO_ctrl((SSL_get_wbio(ssl)), 49, 0, 
# 892 "../ssl/d1_lib.c" 3 4
                             ((void *)0)
# 892 "../ssl/d1_lib.c"
                             );
        s->d1->link_mtu = 0;
    ...
    if (s->d1->mtu < dtls1_min_mtu(s)) {
        if (!(SSL_get_options(ssl) & ((uint64_t)1 << (uint64_t)12))) {
            s->d1->mtu =
                BIO_ctrl(SSL_get_wbio(ssl), 40, 0, 
# 900 "../ssl/d1_lib.c" 3 4
                                                                        ((void *)0)
# 900 "../ssl/d1_lib.c"
                                                                            );
            ...
            if (s->d1->mtu < dtls1_min_mtu(s)) {
                ...
                BIO_ctrl(SSL_get_wbio(ssl), 42,
                         (long)s->d1->mtu, 
# 910 "../ssl/d1_lib.c" 3 4
                                          ((void *)0)
# 910 "../ssl/d1_lib.c"
                                              );
            }
...
size_t dtls1_min_mtu(SSL_CONNECTION *s)
{
    ...
    return dtls1_link_min_mtu() - (unsigned int)BIO_ctrl((SSL_get_wbio(ssl)), 49, 0, 
# 928 "../ssl/d1_lib.c" 3 4
                                 ((void *)0)
# 928 "../ssl/d1_lib.c"
                                 );
}
...
size_t DTLS_get_data_mtu(const SSL *ssl)
{
    ...
    size_t mtu;
    const SSL_CONNECTION *s = ((ssl) == 
# 936 "../ssl/d1_lib.c" 3 4
                             ((void *)0) 
# 936 "../ssl/d1_lib.c"
                             ? 
# 936 "../ssl/d1_lib.c" 3 4
                             ((void *)0) 
# 936 "../ssl/d1_lib.c"
                             : ((ssl)->type == 0 ? (const SSL_CONNECTION *)(ssl) : 
# 936 "../ssl/d1_lib.c" 3 4
                             ((void *)0)
# 936 "../ssl/d1_lib.c"
                             ));
...
# 943 "../ssl/d1_lib.c"
    ...
    if ((s->s3.flags & 0x0100))
        ext_overhead += mac_overhead;
    else
        int_overhead += mac_overhead;


    if (ext_overhead + 13 >= mtu)
        return 0;
    mtu -= ext_overhead + 13;
