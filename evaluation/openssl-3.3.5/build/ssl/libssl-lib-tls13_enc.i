...
{
    EVP_KDF *kdf = EVP_KDF_fetch(libctx, "TLS13-KDF", propq);
    EVP_KDF_CTX *kctx;
...
# 49 "../ssl/tls13_enc.c"
    ...
    if (labellen > 249) {
        if (raise_error)
            ...
            (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c",58,__func__), ERR_set_error)((20),(367),
# 58 "../ssl/tls13_enc.c" 3 4
           ((void *)0)
# 58 "../ssl/tls13_enc.c"
           );
    ...
    if ((ret = EVP_MD_get_size(md)) <= 0) {
        EVP_KDF_CTX_free(kctx);
        if (raise_error)
            (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c",67,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 67 "../ssl/tls13_enc.c" 3 4
           ((void *)0)
# 67 "../ssl/tls13_enc.c"
           );
        return 0;
...
# 82 "../ssl/tls13_enc.c"
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    if (ret != 0) {
        if (raise_error)
            (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c",93,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 93 "../ssl/tls13_enc.c" 3 4
           ((void *)0)
# 93 "../ssl/tls13_enc.c"
           );
    }
                      ...
                      unsigned char *out, size_t outlen, int fatal)
{
    ...
    ret = tls13_hkdf_expand_ex(sctx->libctx, sctx->propq, md,
                               ...
                               out, outlen, !fatal);
    if (ret == 0 && fatal)
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 112, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 112 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 112 "../ssl/tls13_enc.c"
       );
                             ...
                             unsigned char *fin, size_t finlen)
{
    ...
    return tls13_hkdf_expand(s, md, secret, finishedlabel,
                             sizeof(finishedlabel) - 1, 
# 155 "../ssl/tls13_enc.c" 3 4
                                                       ((void *)0)
# 155 "../ssl/tls13_enc.c"
                                                           , 0, fin, finlen, 1);
}
                          ...
                          unsigned char *outsecret)
{
    ...
    kdf = EVP_KDF_fetch(sctx->libctx, "TLS13-KDF", sctx->propq);
    kctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kctx == 
# 184 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 184 "../ssl/tls13_enc.c"
                   ) {
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 185, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 185 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 185 "../ssl/tls13_enc.c"
       );
        return 0;
    ...
    if (!__builtin_expect(!!((mdleni >= 0) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 192, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 192 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 192 "../ssl/tls13_enc.c"
       );
        EVP_KDF_CTX_free(kctx);
...
# 205 "../ssl/tls13_enc.c"
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    if (ret != 0)
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 219, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 219 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 219 "../ssl/tls13_enc.c"
       );
                             ...
                             unsigned char *out)
{
    ...
    unsigned char finsecret[64];
    unsigned char *key = 
# 267 "../ssl/tls13_enc.c" 3 4
                        ((void *)0)
# 267 "../ssl/tls13_enc.c"
                            ;
...
# 276 "../ssl/tls13_enc.c"
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    if (str == (&(s)->ssl)->method->ssl3_enc->server_finished_label) {
        key = s->server_finished_secret;
    } else if (((s)->s3.tmp.finish_md_len == 0 || (s)->s3.tmp.peer_finish_md_len == 0)) {
    ...
    if (!EVP_Q_mac(sctx->libctx, "HMAC", sctx->propq, mdname,
                   ...
                   out, 64 * 2, &len)) {
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 303, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 303 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 303 "../ssl/tls13_enc.c"
       );
        goto err;
...
int tls13_setup_key_block(SSL_CONNECTION *s)
{
    ...
    if (!ssl_cipher_get_evp(((s)->ssl.ctx), s->session, &c, &hash,
                            
# 323 "../ssl/tls13_enc.c" 3 4
                           ((void *)0)
# 323 "../ssl/tls13_enc.c"
                               , 
# 323 "../ssl/tls13_enc.c" 3 4
                                    ...
                                    size_t *taglen)
{
    ...
    if (!__builtin_expect(!!((hashleni >= 0) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 353, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 353 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 353 "../ssl/tls13_enc.c"
       );
        return 0;
...
# 371 "../ssl/tls13_enc.c" 3 4
                                   ((void *)0)
# 371 "../ssl/tls13_enc.c"
                                       ) {
            algenc = s->s3.tmp.new_cipher->algorithm_enc;
        } else if (s->session->cipher != 
# 373 "../ssl/tls13_enc.c" 3 4
                                        ((void *)0)
# 373 "../ssl/tls13_enc.c"
                                            ) {

            algenc = s->session->cipher->algorithm_enc;
        } else if (s->psksession != 
# 376 "../ssl/tls13_enc.c" 3 4
                                   ((void *)0) 
# 376 "../ssl/tls13_enc.c"
                                        && s->psksession->cipher != 
# 376 "../ssl/tls13_enc.c" 3 4
...
# 376 "../ssl/tls13_enc.c"
            ...
            (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 380, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 380 "../ssl/tls13_enc.c" 3 4
           ((void *)0)
# 380 "../ssl/tls13_enc.c"
           );
            return 0;
        }
        if (algenc & (0x00010000U | 0x00020000U))
            *taglen = 8;
         else
            *taglen = 16;
    } else {
        ...
        if (iivlen < 0) {
            (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 398, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 398 "../ssl/tls13_enc.c" 3 4
           ((void *)0)
# 398 "../ssl/tls13_enc.c"
           );
            return 0;
...
int tls13_change_cipher_state(SSL_CONNECTION *s, int which)
{
    ...
    unsigned char *insecret;
    unsigned char *finsecret = 
# 437 "../ssl/tls13_enc.c" 3 4
                              ((void *)0)
# 437 "../ssl/tls13_enc.c"
                                  ;
    const char *log_label = 
# 438 "../ssl/tls13_enc.c" 3 4
                           ((void *)0)
# 438 "../ssl/tls13_enc.c"
                               ;
    ...
    int ret = 0;
    const EVP_MD *md = 
# 443 "../ssl/tls13_enc.c" 3 4
                      ((void *)0)
# 443 "../ssl/tls13_enc.c"
                          ;
    const EVP_CIPHER *cipher = 
# 444 "../ssl/tls13_enc.c" 3 4
                              ((void *)0)
# 444 "../ssl/tls13_enc.c"
                                  ;
    SSL_CTX *sctx = ((s)->ssl.ctx);
    ...
    int level;
    int direction = (which & 0x001) != 0 ? 0
                                                : 1;

    if (((which & 0x010) && (which & 0x002))
            || ((which & 0x020) && (which & 0x001))) {
        if (which & 0x040) {
            EVP_MD_CTX *mdctx = 
# 454 "../ssl/tls13_enc.c" 3 4
                               ((void *)0)
# 454 "../ssl/tls13_enc.c"
                                   ;
            long handlen;
            ...
            log_label = "CLIENT_EARLY_TRAFFIC_SECRET";

            handlen = BIO_ctrl(s->s3.handshake_buffer,3,0,(char *)(&hdata));
            if (handlen <= 0) {
                (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 467, __func__), ossl_statem_fatal)((s), (80), (332), 
# 467 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 467 "../ssl/tls13_enc.c"
               );
                goto err;
            ...
            if (s->early_data_state == SSL_EARLY_DATA_CONNECTING
                ...
                if (!__builtin_expect(!!((s->psksession != 
# 479 "../ssl/tls13_enc.c" 3 4
                    ((void *)0) 
# 479 "../ssl/tls13_enc.c"
                    && s->max_early_data == s->psksession->ext.max_early_data) != 0), 1)

                                                             ) {
                    (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 482, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 482 "../ssl/tls13_enc.c" 3 4
                   ((void *)0)
# 482 "../ssl/tls13_enc.c"
                   );
                    goto err;
            ...
            if (sslcipher == 
# 487 "../ssl/tls13_enc.c" 3 4
                            ((void *)0)
# 487 "../ssl/tls13_enc.c"
                                ) {
                (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 488, __func__), ossl_statem_fatal)((s), (80), (219), 
# 488 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 488 "../ssl/tls13_enc.c"
               );
                goto err;
            ...
            if (mdctx == 
# 498 "../ssl/tls13_enc.c" 3 4
                        ((void *)0)
# 498 "../ssl/tls13_enc.c"
                            ) {
                (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 499, __func__), ossl_statem_fatal)((s), (80), ((6 | (0x2 << 18L))), 
# 499 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 499 "../ssl/tls13_enc.c"
               );
                goto err;
            ...
            if (md == 
# 515 "../ssl/tls13_enc.c" 3 4
                     ((void *)0) 
# 515 "../ssl/tls13_enc.c"
                          || !EVP_DigestInit_ex(mdctx, md, 
# 515 "../ssl/tls13_enc.c" 3 4
                                                           ((void *)0)
# 515 "../ssl/tls13_enc.c"
                                                               )
                ...
                (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 518, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 518 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 518 "../ssl/tls13_enc.c"
               );
                EVP_MD_CTX_free(mdctx);
            ...
            if (!tls13_hkdf_expand(s, md, insecret,
                                   ...
                                   1)) {
                (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 531, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 531 "../ssl/tls13_enc.c" 3 4
               ((void *)0)
# 531 "../ssl/tls13_enc.c"
               );
                goto err;
            ...
            log_label = "CLIENT_HANDSHAKE_TRAFFIC_SECRET";
# 556 "../ssl/tls13_enc.c"
            ...
            log_label = "CLIENT_TRAFFIC_SECRET_0";
        ...
        if (which & 0x080) {
            ...
            log_label = "SERVER_HANDSHAKE_TRAFFIC_SECRET";
        } else {
            insecret = s->master_secret;
    ...
    if (!__builtin_expect(!!((cipher != 
# 623 "../ssl/tls13_enc.c" 3 4
        ((void *)0)
# 623 "../ssl/tls13_enc.c"
        ) != 0), 1))
        goto err;
...
# 659 "../ssl/tls13_enc.c"
    ...
    if (!ssl_set_new_record_layer(s, s->version,
                                  ...
                                  ivlen, 
# 681 "../ssl/tls13_enc.c" 3 4
                                        ((void *)0)
# 681 "../ssl/tls13_enc.c"
                                            , 0, cipher, taglen, 0,
                                  
# 682 "../ssl/tls13_enc.c" 3 4
                                 ((void *)0)
# 682 "../ssl/tls13_enc.c"
                                     , 
# 682 "../ssl/tls13_enc.c" 3 4
...
int tls13_update_key(SSL_CONNECTION *s, int sending)
{
    ...
    size_t keylen, ivlen, taglen;
    int ret = 0, l;
    int direction = sending ? 1
                            : 0;
    unsigned char iv[16];

    if ((l = EVP_MD_get_size(md)) <= 0) {
        (ERR_new(), ERR_set_debug("../ssl/tls13_enc.c", 715, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 715 "../ssl/tls13_enc.c" 3 4
       ((void *)0)
# 715 "../ssl/tls13_enc.c"
       );
        return 0;
...
# 726 "../ssl/tls13_enc.c"
    ...
    if (!ssl_set_new_record_layer(s, s->version,
                            direction,
                            3,
                            insecret, hashlen, key, keylen, iv, ivlen, 
# 739 "../ssl/tls13_enc.c" 3 4
                                                                      ((void *)0)
# 739 "../ssl/tls13_enc.c"
                                                                          , 0,
                            s->s3.tmp.new_sym_enc, taglen, 0, 
# 740 "../ssl/tls13_enc.c" 3 4
                                                                     ((void *)0)
# 740 "../ssl/tls13_enc.c"
                                                                         ,
                            
# 741 "../ssl/tls13_enc.c" 3 4
                           ((void *)0)
# 741 "../ssl/tls13_enc.c"
                               , md)) {
    ...
    log_label = s->server == sending ? "SERVER_TRAFFIC_SECRET_N" : "CLIENT_TRAFFIC_SECRET_N";
    if (!ssl_log_secret(s, log_label, secret, hashlen)) {
...
# 850 "../ssl/tls13_enc.c"
    if (md == 
# 850 "../ssl/tls13_enc.c" 3 4
             ((void *)0)
            
# 851 "../ssl/tls13_enc.c"
           || EVP_DigestInit_ex(ctx, md, 
# 851 "../ssl/tls13_enc.c" 3 4
                                         ((void *)0)
# 851 "../ssl/tls13_enc.c"
                                             ) <= 0
            || EVP_DigestUpdate(ctx, context, contextlen) <= 0
