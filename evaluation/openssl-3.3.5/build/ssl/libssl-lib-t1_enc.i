...
# 40 "../ssl/t1_enc.c"
        ...
        if (fatal)
            (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 43, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 43 "../ssl/t1_enc.c" 3 4
           ((void *)0)
# 43 "../ssl/t1_enc.c"
           );
        else
            (ERR_new(), ERR_set_debug("../ssl/t1_enc.c",45,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 45 "../ssl/t1_enc.c" 3 4
           ((void *)0)
# 45 "../ssl/t1_enc.c"
           );
    ...
    kdf = EVP_KDF_fetch(((s)->ssl.ctx)->libctx,
                        "TLS1-PRF",
                        ((s)->ssl.ctx)->propq);
    if (kdf == 
# 51 "../ssl/t1_enc.c" 3 4
...
# 55 "../ssl/t1_enc.c"
 ...
 err:
    if (fatal)
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 81, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 81 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 81 "../ssl/t1_enc.c"
       );
    else
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c",83,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 83 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 83 "../ssl/t1_enc.c"
       );
                                   ...
                                   size_t num)
{
    ...
    ret = tls1_PRF(s,
                   ...
                   13, s->s3.server_random,
                   32, s->s3.client_random, 32,
...
static int tls_iv_length_within_key_block(const EVP_CIPHER *c)
{
    ...
    if (EVP_CIPHER_get_mode(c) == 0x6)
        return 4;
    else if (EVP_CIPHER_get_mode(c) == 0x7)
        return 4;
    else
...
# 120 "../ssl/t1_enc.c"
    ...
    if (iivlen < 0) {
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 147, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 147 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 147 "../ssl/t1_enc.c"
       );
        goto err;
    ...
    if (n > s->s3.tmp.key_block_length) {
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 170, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 170 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 170 "../ssl/t1_enc.c"
       );
        goto err;
    ...
    if (which & 0x001) {
        ...
        if (s->s3.tmp.new_cipher->algorithm2 & 0x10000)
            s->mac_flags |= 1;
        else
            s->mac_flags &= ~1;

        if (s->s3.tmp.new_cipher->algorithm2 & 0x20000)
            s->mac_flags |= 4;
        else
            s->mac_flags &= ~4;
...
int tls1_setup_key_block(SSL_CONNECTION *s)
{
    ...
    if (ivlen < 0) {
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 285, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 285 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 285 "../ssl/t1_enc.c"
       );
        return 0;
    ...
    if ((p = CRYPTO_malloc(num, "../ssl/t1_enc.c", 293)) == 
# 293 "../ssl/t1_enc.c" 3 4
                                    ((void *)0)
# 293 "../ssl/t1_enc.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c", 294, __func__), ossl_statem_fatal)((s), (80), ((15 | (0x2 << 18L))), 
# 294 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 294 "../ssl/t1_enc.c"
       );
        goto err;
    ...
    do { BIO *trc_out = 
# 301 "../ssl/t1_enc.c" 3 4
   ((void *)0)
# 301 "../ssl/t1_enc.c"
   ; if (0) {
        BIO_printf(trc_out, "key block length: %zu\n", num);
        BIO_printf(trc_out, "client random\n");
        BIO_dump_indent(trc_out, s->s3.client_random, 32, 4);
        BIO_printf(trc_out, "server random\n");
        BIO_dump_indent(trc_out, s->s3.server_random, 32, 4);
                             ...
                             size_t slen, unsigned char *out)
{
    ...
    size_t finished_size = 12;

    if (s->s3.tmp.new_cipher->algorithm_mkey & 0x00000200U)
        finished_size = 32;
    ...
    if (!tls1_PRF(s, str, slen, hash, hashlen, 
# 348 "../ssl/t1_enc.c" 3 4
                                              ((void *)0)
# 348 "../ssl/t1_enc.c"
                                                  , 0, 
# 348 "../ssl/t1_enc.c" 3 4
...
int tls1_generate_master_secret(SSL_CONNECTION *s, unsigned char *out,
                                ...
                                size_t *secret_size)
{
    if (s->session->flags & 0x1) {
        unsigned char hash[64 * 2];
        size_t hashlen;
...
# 383 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 383 "../ssl/t1_enc.c"
                         , 0,
                      
# 384 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 384 "../ssl/t1_enc.c"
                         , 0,
                      
# 385 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 385 "../ssl/t1_enc.c"
                         , 0, p, len, out,
                      48, 1)) {
...
# 396 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 396 "../ssl/t1_enc.c"
                         , 0,
                      s->s3.server_random, 32,
                      
# 398 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 398 "../ssl/t1_enc.c"
                         , 0, p, len, out,
                      48, 1)) {
...
# 427 "../ssl/t1_enc.c"
    ...
    if (contextlen > 0xffff) {
        (ERR_new(), ERR_set_debug("../ssl/t1_enc.c",436,__func__), ERR_set_error)((20),((262|(0x2 << 18L))),
# 436 "../ssl/t1_enc.c" 3 4
       ((void *)0)
# 436 "../ssl/t1_enc.c"
       );
        return 0;
    ...
    val = CRYPTO_malloc(vallen, "../ssl/t1_enc.c", 450);
    if (val == 
# 451 "../ssl/t1_enc.c" 3 4
              ((void *)0)
# 451 "../ssl/t1_enc.c"
                  )
        goto ret;
...
# 466 "../ssl/t1_enc.c"
    ...
    if (memcmp(val, "\x63\x6c\x69\x65\x6e\x74\x20\x66\x69\x6e\x69\x73\x68\x65\x64",
               15) == 0)
        goto err1;
    if (memcmp(val, "\x73\x65\x72\x76\x65\x72\x20\x66\x69\x6e\x69\x73\x68\x65\x64",
               15) == 0)
        goto err1;
    if (memcmp(val, "\x6d\x61\x73\x74\x65\x72\x20\x73\x65\x63\x72\x65\x74",
               13) == 0)
        goto err1;
    if (memcmp(val, "\x65\x78\x74\x65\x6e\x64\x65\x64\x20\x6d\x61\x73\x74\x65\x72\x20\x73\x65\x63\x72\x65\x74",
               22) == 0)
        goto err1;
    if (memcmp(val, "\x6b\x65\x79\x20\x65\x78\x70\x61\x6e\x73\x69\x6f\x6e",
               13) == 0)
        goto err1;
...
# 494 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 494 "../ssl/t1_enc.c"
                     , 0,
                  
# 495 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 495 "../ssl/t1_enc.c"
                     , 0,
                  
# 496 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 496 "../ssl/t1_enc.c"
                     , 0,
                  
# 497 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 497 "../ssl/t1_enc.c"
                     , 0,
                  s->session->master_key, s->session->master_key_length,
    ...
    goto ret;
 err1:
    (ERR_new(), ERR_set_debug("../ssl/t1_enc.c",503,__func__), ERR_set_error)((20),(367),
# 503 "../ssl/t1_enc.c" 3 4
   ((void *)0)
# 503 "../ssl/t1_enc.c"
   );
 ret:
    CRYPTO_clear_free(val, vallen, "../ssl/t1_enc.c", 505);
    return rv;
}
