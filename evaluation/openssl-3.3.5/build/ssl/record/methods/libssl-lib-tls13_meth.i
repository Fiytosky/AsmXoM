# 0 "../ssl/record/methods/tls13_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/tls13_meth.c"
# 10 "../ssl/record/methods/tls13_meth.c"
...
# 11 "../ssl/record/methods/tls13_meth.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../ssl/record/methods/tls13_meth.c" 2
...
# 13 "../ssl/record/methods/tls13_meth.c" 2
# 1 "../ssl/record/methods/../record_local.h" 1
# 14 "../ssl/record/methods/tls13_meth.c" 2
...
# 15 "../ssl/record/methods/tls13_meth.c" 2
                                  ...
                                  COMP_METHOD *comp)
{
    ...
    if (ivlen > sizeof(rl->iv)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c",31,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 31 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 31 "../ssl/record/methods/tls13_meth.c"
       );
        return -2;
    }
    ...
    if (ciph_ctx == 
# 37 "../ssl/record/methods/tls13_meth.c" 3 4
                   ((void *)0)
# 37 "../ssl/record/methods/tls13_meth.c"
                       ) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c",38,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 38 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 38 "../ssl/record/methods/tls13_meth.c"
       );
        return -2;
    }
...
# 44 "../ssl/record/methods/tls13_meth.c" 3 4
                                         ((void *)0)
# 44 "../ssl/record/methods/tls13_meth.c"
                                             , 
# 44 "../ssl/record/methods/tls13_meth.c" 3 4
                                               ((void *)0)
# 44 "../ssl/record/methods/tls13_meth.c"
...
# 44 "../ssl/record/methods/tls13_meth.c"
                                                         , enc) <= 0
        || EVP_CIPHER_CTX_ctrl(ciph_ctx, 0x9, ivlen,
                               
# 46 "../ssl/record/methods/tls13_meth.c" 3 4
                              ((void *)0)
# 46 "../ssl/record/methods/tls13_meth.c"
                                  ) <= 0
        || (mode == 0x7
            && EVP_CIPHER_CTX_ctrl(ciph_ctx, 0x11, taglen,
                                   
# 49 "../ssl/record/methods/tls13_meth.c" 3 4
                                  ((void *)0)
# 49 "../ssl/record/methods/tls13_meth.c"
                                      ) <= 0)
        || EVP_CipherInit_ex(ciph_ctx, 
# 50 "../ssl/record/methods/tls13_meth.c" 3 4
                                      ((void *)0)
# 50 "../ssl/record/methods/tls13_meth.c"
                                          , 
# 50 "../ssl/record/methods/tls13_meth.c" 3 4
                                            ((void *)0)
# 50 "../ssl/record/methods/tls13_meth.c"
...
# 50 "../ssl/record/methods/tls13_meth.c"
                                                           , enc) <= 0) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c",51,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 51 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 51 "../ssl/record/methods/tls13_meth.c"
       );
        return -2;
    }
...
{
    EVP_CIPHER_CTX *ctx;
    unsigned char iv[16], recheader[5];
    ...
    if (n_recs != 1) {
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 75, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 75 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 75 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
    ...
    if (cipher == 
# 83 "../ssl/record/methods/tls13_meth.c" 3 4
                 ((void *)0)
# 83 "../ssl/record/methods/tls13_meth.c"
                     ) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 84, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 84 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 84 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
    ...
    if (ctx == 
# 95 "../ssl/record/methods/tls13_meth.c" 3 4
              ((void *)0) 
# 95 "../ssl/record/methods/tls13_meth.c"
                   || rec->type == 21) {
    ...
    if (ivlen < 8) {
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 116, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 116 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 116 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
    offset = ivlen - 8;
...
# 129 "../ssl/record/methods/tls13_meth.c" 3 4
                              ((void *)0)
# 129 "../ssl/record/methods/tls13_meth.c"
                                  , 
# 129 "../ssl/record/methods/tls13_meth.c" 3 4
                                    ((void *)0)
# 129 "../ssl/record/methods/tls13_meth.c"
...
# 129 "../ssl/record/methods/tls13_meth.c"
                                              , iv, sending) <= 0
            || (!sending && EVP_CIPHER_CTX_ctrl(ctx, 0x11,
                                                rl->taglen,
                                                rec->data + rec->length) <= 0)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 133, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 133 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 133 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
    ...
    if (!WPACKET_init_static_len(&wpkt, recheader, sizeof(recheader), 0)
            || !WPACKET_put_bytes__((&wpkt), (rec->type), 1)
            || !WPACKET_put_bytes__((&wpkt), (rec->rec_version), 2)
            || !WPACKET_put_bytes__((&wpkt), (rec->length + rl->taglen), 2)
            || !WPACKET_get_total_written(&wpkt, &hdrlen)
            || hdrlen != 5
            || !WPACKET_finish(&wpkt)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 145, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 145 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 145 "../ssl/record/methods/tls13_meth.c"
       );
...
# 155 "../ssl/record/methods/tls13_meth.c" 3 4
                                         ((void *)0)
# 155 "../ssl/record/methods/tls13_meth.c"
                                             , &lenu, 
# 155 "../ssl/record/methods/tls13_meth.c" 3 4
                                                      ((void *)0)
# 155 "../ssl/record/methods/tls13_meth.c"
            ...
            || EVP_CipherUpdate(ctx, 
# 157 "../ssl/record/methods/tls13_meth.c" 3 4
                                    ((void *)0)
# 157 "../ssl/record/methods/tls13_meth.c"
                                        , &lenu, recheader,
                                sizeof(recheader)) <= 0
    ...
    if (sending) {
        ...
        if (EVP_CIPHER_CTX_ctrl(ctx, 0x10, rl->taglen,
                                rec->data + rec->length) <= 0) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 169, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 169 "../ssl/record/methods/tls13_meth.c" 3 4
           ((void *)0)
# 169 "../ssl/record/methods/tls13_meth.c"
           );
            return 0;
        }
        rec->length += rl->taglen;
                                        ...
                                        TLS_RL_RECORD *rec)
{
    if (rec->type != 23
            ...
            && (rec->type != 21 || !rl->allow_plain_alerts)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 185, __func__), ossl_rlayer_fatal)((rl), (10), (443), 
# 185 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 185 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }

    if (rec->rec_version != 0x0303) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 190, __func__), ossl_rlayer_fatal)((rl), (50), (267), 
# 190 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 190 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }

    if (rec->length > (16384 + 256)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 195, __func__), ossl_rlayer_fatal)((rl), (22), (150), 
# 195 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 195 "../ssl/record/methods/tls13_meth.c"
       )
                                                    ;
        return 0;
    }
...
static int tls13_post_process_record(OSSL_RECORD_LAYER *rl, TLS_RL_RECORD *rec)
{
    ...
    if (rec->type != 21) {
        ...
        if (rec->length == 0
                || rec->type != 23) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 210, __func__), ossl_rlayer_fatal)((rl), (10), (443), 
# 210 "../ssl/record/methods/tls13_meth.c" 3 4
           ((void *)0)
# 210 "../ssl/record/methods/tls13_meth.c"
           )
                                              ;
            return 0;
        }
    ...
    if (rec->length > 16384) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 224, __func__), ossl_rlayer_fatal)((rl), (22), (146), 
# 224 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 224 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
...
static uint8_t tls13_get_record_type(OSSL_RECORD_LAYER *rl,
                                     OSSL_RECORD_TEMPLATE *template)
{
    if (rl->allow_plain_alerts && template->type == 21)
        return 21;
                                    ...
                                    TLS_RL_RECORD *thiswr)
{
    ...
    if (rl->allow_plain_alerts && thistempl->type != 21)
        return 1;

    if (!WPACKET_put_bytes__((thispkt), (thistempl->type), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 262, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 262 "../ssl/record/methods/tls13_meth.c" 3 4
       ((void *)0)
# 262 "../ssl/record/methods/tls13_meth.c"
       );
        return 0;
    }
    ((thiswr)->length += (1));
    ...
    if (rlen < rl->max_frag_len) {
        ...
        if (rl->padding != 
# 273 "../ssl/record/methods/tls13_meth.c" 3 4
                          ((void *)0)
# 273 "../ssl/record/methods/tls13_meth.c"
                              ) {
        ...
        if (padding > 0) {
            ...
            if (!WPACKET_memset(thispkt, 0, padding)) {
                (ERR_new(), ERR_set_debug("../ssl/record/methods/tls13_meth.c", 295, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 295 "../ssl/record/methods/tls13_meth.c" 3 4
               ((void *)0)
# 295 "../ssl/record/methods/tls13_meth.c"
               )
                                                 ;
                return 0;
            }
            ((thiswr)->length += (padding));
        }
    }
...
# 309 "../ssl/record/methods/tls13_meth.c" 3 4
   ((void *)0)
# 309 "../ssl/record/methods/tls13_meth.c"
       ,
...
# 324 "../ssl/record/methods/tls13_meth.c" 3 4
   ((void *)0)

# 325 "../ssl/record/methods/tls13_meth.c"
};
