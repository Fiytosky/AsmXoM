# 0 "../ssl/record/methods/ssl3_cbc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/ssl3_cbc.c"
# 23 "../ssl/record/methods/ssl3_cbc.c"
...
# 24 "../ssl/record/methods/ssl3_cbc.c" 2
...
# 26 "../ssl/record/methods/ssl3_cbc.c" 2
...
# 28 "../ssl/record/methods/ssl3_cbc.c" 2
...
# 30 "../ssl/record/methods/ssl3_cbc.c" 2
...
# 32 "../ssl/record/methods/ssl3_cbc.c" 2
...
# 33 "../ssl/record/methods/ssl3_cbc.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 34 "../ssl/record/methods/ssl3_cbc.c" 2
# 64 "../ssl/record/methods/ssl3_cbc.c"
...
# 126 "../ssl/record/methods/ssl3_cbc.c"
int ssl3_cbc_digest_record(const EVP_MD *md,
                           unsigned char *md_out,
                           size_t *md_out_size,
                           const unsigned char *header,
                           ...
                           size_t mac_secret_length, char is_sslv3)
{
    ...
    EVP_MD_CTX *md_ctx = 
# 154 "../ssl/record/methods/ssl3_cbc.c" 3 4
                        ((void *)0)
# 154 "../ssl/record/methods/ssl3_cbc.c"
                            ;
    ...
    if (!__builtin_expect(!!((data_plus_mac_plus_padding_size < 1024 * 1024) != 0), 1))
        return 0;
    ...
    if (EVP_MD_is_a(md, "MD5")) {
        ...
        if (md_out_size != 
# 227 "../ssl/record/methods/ssl3_cbc.c" 3 4
                          ((void *)0)
# 227 "../ssl/record/methods/ssl3_cbc.c"
                              )
            *md_out_size = 0;
        return __builtin_expect(!!((0) != 0), 1);
    }

    if (!__builtin_expect(!!((md_length_size <= 16) != 0), 1)
            || !__builtin_expect(!!((md_block_size <= 128) != 0), 1)
            || !__builtin_expect(!!((md_size <= 64) != 0), 1))
        return 0;
...
# 261 "../ssl/record/methods/ssl3_cbc.c"
    ...
    num_blocks =
        (max_mac_bytes + 1 + md_length_size + md_block_size -
         1) / md_block_size;
# 287 "../ssl/record/methods/ssl3_cbc.c"
...
# 321 "../ssl/record/methods/ssl3_cbc.c"
    ...
    if (!is_sslv3) {
        ...
        if (!__builtin_expect(!!((mac_secret_length <= sizeof(hmac_pad)) != 0), 1))
            return 0;
    ...
    if (k > 0) {
        if (is_sslv3) {
            size_t overhang;
# 371 "../ssl/record/methods/ssl3_cbc.c"
    ...
    if (md_ctx == 
# 456 "../ssl/record/methods/ssl3_cbc.c" 3 4
                 ((void *)0)
# 456 "../ssl/record/methods/ssl3_cbc.c"
                     )
        goto err;

    if (EVP_DigestInit_ex(md_ctx, md, 
# 459 "../ssl/record/methods/ssl3_cbc.c" 3 4
                                     ((void *)0) 
# 459 "../ssl/record/methods/ssl3_cbc.c"
                                                      ) <= 0)
        goto err;
    if (is_sslv3) {
