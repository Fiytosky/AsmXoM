# 0 "../ssl/record/methods/ssl3_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/ssl3_meth.c"
# 10 "../ssl/record/methods/ssl3_meth.c"
...
# 11 "../ssl/record/methods/ssl3_meth.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../ssl/record/methods/ssl3_meth.c" 2
...
# 13 "../ssl/record/methods/ssl3_meth.c" 2
...
# 14 "../ssl/record/methods/ssl3_meth.c" 2
# 1 "../ssl/record/methods/../record_local.h" 1
# 15 "../ssl/record/methods/ssl3_meth.c" 2
...
# 16 "../ssl/record/methods/ssl3_meth.c" 2
                                 ...
                                 COMP_METHOD *comp)
{
    ...
    if (md == 
# 30 "../ssl/record/methods/ssl3_meth.c" 3 4
             ((void *)0)
# 30 "../ssl/record/methods/ssl3_meth.c"
                 ) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",31,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 31 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 31 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }

    if ((rl->enc_ctx = EVP_CIPHER_CTX_new()) == 
# 35 "../ssl/record/methods/ssl3_meth.c" 3 4
                                               ((void *)0)
# 35 "../ssl/record/methods/ssl3_meth.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",36,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 36 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 36 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }
    ciph_ctx = rl->enc_ctx;
    ...
    if (rl->md_ctx == 
# 42 "../ssl/record/methods/ssl3_meth.c" 3 4
                     ((void *)0)
# 42 "../ssl/record/methods/ssl3_meth.c"
                         ) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",43,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 43 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 43 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }

    if ((md != 
# 47 "../ssl/record/methods/ssl3_meth.c" 3 4
              ((void *)0) 
# 47 "../ssl/record/methods/ssl3_meth.c"
                   && EVP_DigestInit_ex(rl->md_ctx, md, 
# 47 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                        ((void *)0)
# 47 "../ssl/record/methods/ssl3_meth.c"
                                                            ) <= 0)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",48,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 48 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 48 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }
    ...
    if (comp != 
# 53 "../ssl/record/methods/ssl3_meth.c" 3 4
               ((void *)0)
# 53 "../ssl/record/methods/ssl3_meth.c"
                   ) {
        rl->compctx = COMP_CTX_new(comp);
        if (rl->compctx == 
# 55 "../ssl/record/methods/ssl3_meth.c" 3 4
                          ((void *)0)
# 55 "../ssl/record/methods/ssl3_meth.c"
                              ) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",56,__func__), ERR_set_error)((20),(142),
# 56 "../ssl/record/methods/ssl3_meth.c" 3 4
           ((void *)0)
# 56 "../ssl/record/methods/ssl3_meth.c"
           );
            return -2;
        }
    }
...
# 62 "../ssl/record/methods/ssl3_meth.c" 3 4
                                          ((void *)0)
# 62 "../ssl/record/methods/ssl3_meth.c"
                                              , key, iv, enc)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",63,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 63 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 63 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }
...
# 71 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                                         ((void *)0)
            
# 72 "../ssl/record/methods/ssl3_meth.c"
    ...
    if (mackeylen > sizeof(rl->mac_secret)) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c",78,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 78 "../ssl/record/methods/ssl3_meth.c" 3 4
       ((void *)0)
# 78 "../ssl/record/methods/ssl3_meth.c"
       );
        return -2;
    }
...
# 95 "../ssl/record/methods/ssl3_meth.c"
                       ...
                       size_t macsize)
{
    ...
    ds = rl->enc_ctx;
    if (ds == 
# 114 "../ssl/record/methods/ssl3_meth.c" 3 4
             ((void *)0) 
# 114 "../ssl/record/methods/ssl3_meth.c"
                  || (enc = EVP_CIPHER_CTX_get0_cipher(ds)) == 
# 114 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                               ((void *)0)
# 114 "../ssl/record/methods/ssl3_meth.c"
                                                                   )
...
# 117 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                ((void *)0)
# 117 "../ssl/record/methods/ssl3_meth.c"
                                                    );
    ...
    if (provided) {
        ...
        if (!sending && mac != 
# 161 "../ssl/record/methods/ssl3_meth.c" 3 4
                              ((void *)0)
# 161 "../ssl/record/methods/ssl3_meth.c"
                                  ) {
            ...
            *p = OSSL_PARAM_construct_end();
            ...
            if (!EVP_CIPHER_CTX_get_params(ds, params)) {
                ...
                (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c", 175, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 175 "../ssl/record/methods/ssl3_meth.c" 3 4
               ((void *)0)
# 175 "../ssl/record/methods/ssl3_meth.c"
               );
                return 0;
            }
        }
        ...
        if (EVP_Cipher(ds, rec->data, rec->input, (unsigned int)l) < 1) {
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/methods/ssl3_meth.c", 182, __func__), ossl_rlayer_fatal)((rl), (20), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 182 "../ssl/record/methods/ssl3_meth.c" 3 4
           ((void *)0)
# 182 "../ssl/record/methods/ssl3_meth.c"
           );
            return 0;
        }
        ...
        if (!sending)
            return ssl3_cbc_remove_padding_and_mac(&rec->length,
                                        ...
                                        rec->data,
                                        (mac != 
# 190 "../ssl/record/methods/ssl3_meth.c" 3 4
                                               ((void *)0)
# 190 "../ssl/record/methods/ssl3_meth.c"
                                                   ) ? &mac->mac : 
# 190 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                                   ((void *)0)
# 190 "../ssl/record/methods/ssl3_meth.c"
                                                                       ,
                                        (mac != 
# 191 "../ssl/record/methods/ssl3_meth.c" 3 4
                                               ((void *)0)
# 191 "../ssl/record/methods/ssl3_meth.c"
                                                   ) ? &mac->alloced : 
# 191 "../ssl/record/methods/ssl3_meth.c" 3 4
                                                                       ((void *)0)
# 191 "../ssl/record/methods/ssl3_meth.c"
...
# 257 "../ssl/record/methods/ssl3_meth.c"
        ...
        if (md_ctx == 
# 282 "../ssl/record/methods/ssl3_meth.c" 3 4
                     ((void *)0)
# 282 "../ssl/record/methods/ssl3_meth.c"
                         )
            return 0;

        rec_char = rec->type;
        p = md;
        (((p)[0]=(unsigned char)(((rec->length)>> 8)&0xff), (p)[1]=(unsigned char)(((rec->length) )&0xff)),(p)+=2);
...
# 295 "../ssl/record/methods/ssl3_meth.c" 3 4
                                             ((void *)0)
# 295 "../ssl/record/methods/ssl3_meth.c"
                                                 ) <= 0
...
# 328 "../ssl/record/methods/ssl3_meth.c" 3 4
   ((void *)0)
# 328 "../ssl/record/methods/ssl3_meth.c"
       ,
    tls_prepare_record_header_default,
    
# 330 "../ssl/record/methods/ssl3_meth.c" 3 4
   ((void *)0)
# 330 "../ssl/record/methods/ssl3_meth.c"
       ,
    tls_prepare_for_encryption_default,
    tls_post_encryption_processing_default,
    
# 333 "../ssl/record/methods/ssl3_meth.c" 3 4
   ((void *)0)

# 334 "../ssl/record/methods/ssl3_meth.c"
};
