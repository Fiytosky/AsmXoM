# 0 "../ssl/record/methods/dtls_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/dtls_meth.c"
# 10 "../ssl/record/methods/dtls_meth.c"
...
# 11 "../ssl/record/methods/dtls_meth.c" 2
...
# 22 "../ssl/record/methods/../../ssl_local.h" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 23 "../ssl/record/methods/../../ssl_local.h" 2
...
# 24 "../ssl/record/methods/../../ssl_local.h" 2
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int DSA_meth_set_keygen(DSA_METHOD *dsam,
                                              int (*keygen) (DSA *));
# 25 "../ssl/record/methods/../../ssl_local.h" 2
...
# 27 "../ssl/record/methods/../../ssl_local.h" 2
...
# 12 "../ssl/record/methods/dtls_meth.c" 2
# 1 "../ssl/record/methods/../record_local.h" 1
# 13 "../ssl/record/methods/dtls_meth.c" 2
...
# 14 "../ssl/record/methods/dtls_meth.c" 2
...
static int satsub64be(const unsigned char *v1, const unsigned char *v2)
{
    ...
    (l1 =((uint64_t)(*((v1)++)))<<56, l1|=((uint64_t)(*((v1)++)))<<48, l1|=((uint64_t)(*((v1)++)))<<40, l1|=((uint64_t)(*((v1)++)))<<32, l1|=((uint64_t)(*((v1)++)))<<24, l1|=((uint64_t)(*((v1)++)))<<16, l1|=((uint64_t)(*((v1)++)))<< 8, l1|=((uint64_t)(*((v1)++))));
    (l2 =((uint64_t)(*((v2)++)))<<56, l2|=((uint64_t)(*((v2)++)))<<48, l2|=((uint64_t)(*((v2)++)))<<40, l2|=((uint64_t)(*((v2)++)))<<32, l2|=((uint64_t)(*((v2)++)))<<24, l2|=((uint64_t)(*((v2)++)))<<16, l2|=((uint64_t)(*((v2)++)))<< 8, l2|=((uint64_t)(*((v2)++))));
                                    ...
                                    unsigned int *is_next_epoch)
{
    *is_next_epoch = 0;
    ...
    return 
# 100 "../ssl/record/methods/dtls_meth.c" 3 4
          ((void *)0)
# 100 "../ssl/record/methods/dtls_meth.c"
              ;
}
...
static int dtls_process_record(OSSL_RECORD_LAYER *rl, DTLS_BITMAP *bitmap)
{
    ...
    unsigned char md[64];
    SSL_MAC_BUF macbuf = { 
# 116 "../ssl/record/methods/dtls_meth.c" 3 4
                          ((void *)0)
# 116 "../ssl/record/methods/dtls_meth.c"
                              , 0 };
    int ret = 0;
    ...
    rr->input = &(rl->packet[13]);
# 140 "../ssl/record/methods/dtls_meth.c"
    if (rr->length > ((256 + 64)+(16384 +1024))) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 141, __func__), ossl_rlayer_fatal)((rl), (22), (150), 
# 141 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 141 "../ssl/record/methods/dtls_meth.c"
       );
        return 0;
    }
    ...
    if (rl->md_ctx != 
# 149 "../ssl/record/methods/dtls_meth.c" 3 4
                     ((void *)0)
# 149 "../ssl/record/methods/dtls_meth.c"
                         ) {
        const EVP_MD *tmpmd = EVP_MD_CTX_get0_md(rl->md_ctx);

        if (tmpmd != 
# 152 "../ssl/record/methods/dtls_meth.c" 3 4
                    ((void *)0)
# 152 "../ssl/record/methods/dtls_meth.c"
                        ) {
            imac_size = EVP_MD_get_size(tmpmd);
            if (!__builtin_expect(!!((imac_size >= 0 && imac_size <= 64) != 0), 1)) {
                (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 155, __func__), ossl_rlayer_fatal)((rl), (80), ((6 | (0x2 << 18L))), 
# 155 "../ssl/record/methods/dtls_meth.c" 3 4
               ((void *)0)
# 155 "../ssl/record/methods/dtls_meth.c"
               );
                return 0;
            }
...
# 162 "../ssl/record/methods/dtls_meth.c" 3 4
                                    ((void *)0)
# 162 "../ssl/record/methods/dtls_meth.c"
                                        ) {
        unsigned char *mac;

        if (rr->orig_len < mac_size) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 166, __func__), ossl_rlayer_fatal)((rl), (50), (160), 
# 166 "../ssl/record/methods/dtls_meth.c" 3 4
           ((void *)0)
# 166 "../ssl/record/methods/dtls_meth.c"
           );
            return 0;
        }
        rr->length -= mac_size;
        mac = rr->data + rr->length;
        i = rl->funcs->mac(rl, rr, md, 0 );
        if (i == 0 || CRYPTO_memcmp(md, mac, (size_t)mac_size) != 0) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 173, __func__), ossl_rlayer_fatal)((rl), (20), (281), 
# 173 "../ssl/record/methods/dtls_meth.c" 3 4
           ((void *)0)
# 173 "../ssl/record/methods/dtls_meth.c"
           )
                                                                  ;
            return 0;
        }
    ...
    ERR_clear_last_mark();
    do { BIO *trc_out = 
# 210 "../ssl/record/methods/dtls_meth.c" 3 4
   ((void *)0)
# 210 "../ssl/record/methods/dtls_meth.c"
   ; if (0) {
    ...
    if (!rl->use_etm
            && (rl->enc_ctx != 
# 217 "../ssl/record/methods/dtls_meth.c" 3 4
                              ((void *)0)
# 217 "../ssl/record/methods/dtls_meth.c"
                                  )
            && (EVP_MD_CTX_get0_md(rl->md_ctx) != 
# 218 "../ssl/record/methods/dtls_meth.c" 3 4
                                                 ((void *)0)
# 218 "../ssl/record/methods/dtls_meth.c"
                                                     )) {


        i = rl->funcs->mac(rl, rr, md, 0 );
        if (i == 0 || macbuf.mac == 
# 222 "../ssl/record/methods/dtls_meth.c" 3 4
                                   ((void *)0)
            
# 223 "../ssl/record/methods/dtls_meth.c"
           || CRYPTO_memcmp(md, macbuf.mac, mac_size) != 0)
            enc_err = 0;
        if (rr->length > (16384 +1024) + mac_size)
            enc_err = 0;
    }
    ...
    if (rl->compctx != 
# 237 "../ssl/record/methods/dtls_meth.c" 3 4
                      ((void *)0)
# 237 "../ssl/record/methods/dtls_meth.c"
                          ) {
        if (rr->length > (16384 +1024)) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 239, __func__), ossl_rlayer_fatal)((rl), (22), (140), 
# 239 "../ssl/record/methods/dtls_meth.c" 3 4
           ((void *)0)
# 239 "../ssl/record/methods/dtls_meth.c"
           )
                                                         ;
            goto end;
        }
        if (!tls_do_uncompress(rl, rr)) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 244, __func__), ossl_rlayer_fatal)((rl), (30), (107), 
# 244 "../ssl/record/methods/dtls_meth.c" 3 4
           ((void *)0)
# 244 "../ssl/record/methods/dtls_meth.c"
           );
            goto end;
        }
    }
    ...
    if (rr->length > rl->max_frag_len) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 254, __func__), ossl_rlayer_fatal)((rl), (22), (146), 
# 254 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 254 "../ssl/record/methods/dtls_meth.c"
       );
        goto end;
    }

    rr->off = 0;
# 269 "../ssl/record/methods/dtls_meth.c"
    rl->packet_length = 0;
    ...
    if (macbuf.alloced)
        CRYPTO_free(macbuf.mac, "../ssl/record/methods/dtls_meth.c", 277);
    return ret;
}
                                     ...
                                     unsigned char *priority)
{
    ...
    rdata = CRYPTO_malloc(sizeof(*rdata), "../ssl/record/methods/dtls_meth.c", 291);
    item = pitem_new(priority, rdata);
    if (rdata == 
# 293 "../ssl/record/methods/dtls_meth.c" 3 4
                ((void *)0) 
# 293 "../ssl/record/methods/dtls_meth.c"
                     || item == 
# 293 "../ssl/record/methods/dtls_meth.c" 3 4
                                ((void *)0)
# 293 "../ssl/record/methods/dtls_meth.c"
                                    ) {
        CRYPTO_free(rdata, "../ssl/record/methods/dtls_meth.c", 294);
        pitem_free(item);
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 296, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 296 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 296 "../ssl/record/methods/dtls_meth.c"
       );
        return -1;
    }
    ...
    rl->packet = 
# 307 "../ssl/record/methods/dtls_meth.c" 3 4
                ((void *)0)
# 307 "../ssl/record/methods/dtls_meth.c"
                    ;
    rl->packet_length = 0;
    ...
    if (!tls_setup_read_buffer(rl)) {
        ...
        CRYPTO_free(rdata->rbuf.buf, "../ssl/record/methods/dtls_meth.c", 314);
        CRYPTO_free(rdata, "../ssl/record/methods/dtls_meth.c", 315);
        pitem_free(item);
        return -1;
    }

    if (pqueue_insert(queue, item) == 
# 320 "../ssl/record/methods/dtls_meth.c" 3 4
                                     ((void *)0)
# 320 "../ssl/record/methods/dtls_meth.c"
                                         ) {

        CRYPTO_free(rdata->rbuf.buf, "../ssl/record/methods/dtls_meth.c", 322);
        CRYPTO_free(rdata, "../ssl/record/methods/dtls_meth.c", 323);
        pitem_free(item);
    }
                                                ...
                                                struct pqueue_st *queue)
{
    ...
    if (item) {
        ...
        CRYPTO_free(item->data, "../ssl/record/methods/dtls_meth.c", 359);
        pitem_free(item);
...
# 377 "../ssl/record/methods/dtls_meth.c"
int dtls_get_more_records(OSSL_RECORD_LAYER *rl)
{
    ...
    TLS_RL_RECORD *rr;
    unsigned char *p = 
# 383 "../ssl/record/methods/dtls_meth.c" 3 4
                      ((void *)0)
# 383 "../ssl/record/methods/dtls_meth.c"
                          ;
    DTLS_BITMAP *bitmap;
    unsigned int is_next_epoch;
    ...
    if (rl->rbuf.buf == 
# 393 "../ssl/record/methods/dtls_meth.c" 3 4
                       ((void *)0)
# 393 "../ssl/record/methods/dtls_meth.c"
                           ) {
        if (!tls_setup_read_buffer(rl)) {
 ...
 again:
    ...
    if ((rl->rstate != 0xF1) ||
        ...
        ((rr->epoch=(((unsigned int)((p)[0]))<< 8)| (((unsigned int)((p)[1])) )),(p)+=2);

        memcpy(&(rl->sequence[2]), p, 6);
        p += 6;

        ((rr->length=(((unsigned int)((p)[0]))<< 8)| (((unsigned int)((p)[1])) )),(p)+=2);

        if (rl->msg_callback != 
# 444 "../ssl/record/methods/dtls_meth.c" 3 4
                               ((void *)0)
# 444 "../ssl/record/methods/dtls_meth.c"
                                   )
            rl->msg_callback(0, rr->rec_version, 0x100, rl->packet, 13,
                             rl->cbarg);
        ...
        if (!rl->is_first_record && rr->type != 21) {
        ...
        if (rr->length > rl->max_frag_len + (256 + 64)) {
    ...
    if (rr->length > rl->packet_length - 13) {
    ...
    if (bitmap == 
# 518 "../ssl/record/methods/dtls_meth.c" 3 4
                 ((void *)0)
# 518 "../ssl/record/methods/dtls_meth.c"
                     ) {
        rr->length = 0;
        rl->packet_length = 0;
        goto again;
...
static int dtls_free(OSSL_RECORD_LAYER *rl)
{
    ...
    if (rl->unprocessed_rcds != 
# 604 "../ssl/record/methods/dtls_meth.c" 3 4
                               ((void *)0)
# 604 "../ssl/record/methods/dtls_meth.c"
                                   ) {
        while ((item = pqueue_pop(rl->unprocessed_rcds)) != 
# 605 "../ssl/record/methods/dtls_meth.c" 3 4
                                                           ((void *)0)
# 605 "../ssl/record/methods/dtls_meth.c"
                                                               ) {
            rdata = (DTLS_RLAYER_RECORD_DATA *)item->data;

            ret &= BIO_write_ex(rl->next, rdata->packet, rdata->packet_length,
                                &written);
            CRYPTO_free(rdata->rbuf.buf, "../ssl/record/methods/dtls_meth.c", 610);
            CRYPTO_free(item->data, "../ssl/record/methods/dtls_meth.c", 611);
            pitem_free(item);
        }
        pqueue_free(rl->unprocessed_rcds);
    }

    if (rl->processed_rcds!= 
# 617 "../ssl/record/methods/dtls_meth.c" 3 4
                            ((void *)0)
# 617 "../ssl/record/methods/dtls_meth.c"
                                ) {
        while ((item = pqueue_pop(rl->processed_rcds)) != 
# 618 "../ssl/record/methods/dtls_meth.c" 3 4
                                                         ((void *)0)
# 618 "../ssl/record/methods/dtls_meth.c"
                                                             ) {
            rdata = (DTLS_RLAYER_RECORD_DATA *)item->data;
            CRYPTO_free(rdata->rbuf.buf, "../ssl/record/methods/dtls_meth.c", 620);
            CRYPTO_free(item->data, "../ssl/record/methods/dtls_meth.c", 621);
            pitem_free(item);
        }
                      ...
                      OSSL_RECORD_LAYER **retrl)
{
    ...
    if ((*retrl)->unprocessed_rcds == 
# 658 "../ssl/record/methods/dtls_meth.c" 3 4
                                     ((void *)0)
            
# 659 "../ssl/record/methods/dtls_meth.c"
           || (*retrl)->processed_rcds == 
# 659 "../ssl/record/methods/dtls_meth.c" 3 4
                                          ((void *)0)
# 659 "../ssl/record/methods/dtls_meth.c"
                                              ) {
        dtls_free(*retrl);
        *retrl = 
# 661 "../ssl/record/methods/dtls_meth.c" 3 4
                ((void *)0)
# 661 "../ssl/record/methods/dtls_meth.c"
                    ;
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c",662,__func__), ERR_set_error)((20),((20 | (0x2 << 18L))),
# 662 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 662 "../ssl/record/methods/dtls_meth.c"
       );
        return -2;
    }
    ...
    default:
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c",681,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 681 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 681 "../ssl/record/methods/dtls_meth.c"
       );
        ret = -2;
        goto err;
    }
 ...
 err:
    if (ret != 1) {
        dtls_free(*retrl);
        *retrl = 
# 693 "../ssl/record/methods/dtls_meth.c" 3 4
                ((void *)0)
# 693 "../ssl/record/methods/dtls_meth.c"
                    ;
    }
    return ret;
}
                               ...
                               unsigned char **recdata)
{
    ...
    *recdata = 
# 706 "../ssl/record/methods/dtls_meth.c" 3 4
              ((void *)0)
# 706 "../ssl/record/methods/dtls_meth.c"
                  ;

    maxcomplen = templ->buflen;
    if (rl->compctx != 
# 709 "../ssl/record/methods/dtls_meth.c" 3 4
                      ((void *)0)
# 709 "../ssl/record/methods/dtls_meth.c"
                          )
        maxcomplen += 1024;

    if (!WPACKET_put_bytes__((thispkt), (rectype), 1)
            || !WPACKET_put_bytes__((thispkt), (templ->version), 2)
            || !WPACKET_put_bytes__((thispkt), (rl->epoch), 2)
            || !WPACKET_memcpy(thispkt, &(rl->sequence[2]), 6)
            || !WPACKET_start_sub_packet_len__((thispkt), 2)
            || (rl->eivlen > 0
                && !WPACKET_allocate_bytes(thispkt, rl->eivlen, 
# 718 "../ssl/record/methods/dtls_meth.c" 3 4
                                                               ((void *)0)
# 718 "../ssl/record/methods/dtls_meth.c"
                                                                   ))
            || (maxcomplen > 0
                && !WPACKET_reserve_bytes(thispkt, maxcomplen,
                                          recdata))) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/dtls_meth.c", 722, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 722 "../ssl/record/methods/dtls_meth.c" 3 4
       ((void *)0)
# 722 "../ssl/record/methods/dtls_meth.c"
       );
        return 0;
    }
...
static size_t dtls_get_max_record_overhead(OSSL_RECORD_LAYER *rl)
{
    ...
    if (rl->enc_ctx != 
# 748 "../ssl/record/methods/dtls_meth.c" 3 4
                      ((void *)0) 
# 748 "../ssl/record/methods/dtls_meth.c"
                           &&
        (EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(rl->enc_ctx)) == 0x2))
        blocksize = EVP_CIPHER_CTX_get_block_size(rl->enc_ctx);
# 759 "../ssl/record/methods/dtls_meth.c"
    
# 759 "../ssl/record/methods/dtls_meth.c" 3 4
   ((void) (0))
                                                       
# 760 "../ssl/record/methods/dtls_meth.c"
                                                      ;
    
# 761 "../ssl/record/methods/dtls_meth.c" 3 4
   ((void) (0))
# 761 "../ssl/record/methods/dtls_meth.c"
                                                                   ;
# 774 "../ssl/record/methods/dtls_meth.c"
    return 13 + rl->eivlen + blocksize + rl->taglen;
}
...
# 791 "../ssl/record/methods/dtls_meth.c" 3 4
   ((void *)0)
# 791 "../ssl/record/methods/dtls_meth.c"
       ,
