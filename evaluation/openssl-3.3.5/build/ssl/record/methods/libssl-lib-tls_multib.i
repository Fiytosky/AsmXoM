# 0 "../ssl/record/methods/tls_multib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/tls_multib.c"
# 10 "../ssl/record/methods/tls_multib.c"
...
# 11 "../ssl/record/methods/tls_multib.c" 2
# 1 "../ssl/record/methods/../record_local.h" 1
# 12 "../ssl/record/methods/tls_multib.c" 2
...
# 13 "../ssl/record/methods/tls_multib.c" 2
# 23 "../ssl/record/methods/tls_multib.c"
                                     ...
                                     size_t len, size_t fraglen)
{
    ...
    if (type == 23
            && len >= 4 * fraglen
            && rl->compctx == 
# 29 "../ssl/record/methods/tls_multib.c" 3 4
                             ((void *)0)
            
# 30 "../ssl/record/methods/tls_multib.c"
           && rl->msg_callback == 
# 30 "../ssl/record/methods/tls_multib.c" 3 4
                                  ((void *)0)
            
# 31 "../ssl/record/methods/tls_multib.c"
           && !rl->use_etm
            && ((rl)->version == 0x0302 || (rl)->version == 0x0303 || (rl)->version == 0x0100 || (rl)->version == 0xFEFF || (rl)->version == 0xFEFD)
            && !(0)
                                            ...
                                            size_t numtempl)
{
    ...
    if (!tls_is_multiblock_capable(rl, templates[0].type, totlen,
                                   templates[0].buflen))
        return 0;
# 111 "../ssl/record/methods/tls_multib.c"
    packlen = EVP_CIPHER_CTX_ctrl(rl->enc_ctx,
                                  0x1c,
                                  (int)templates[0].buflen, 
# 113 "../ssl/record/methods/tls_multib.c" 3 4
                                                           ((void *)0)
# 113 "../ssl/record/methods/tls_multib.c"
                                                               );
    packlen *= numtempl;
    ...
    aad[12] = 0;
    mb_param.out = 
# 128 "../ssl/record/methods/tls_multib.c" 3 4
                  ((void *)0)
# 128 "../ssl/record/methods/tls_multib.c"
                      ;
    mb_param.inp = aad;
    mb_param.len = totlen;
    ...
    if (packleni <= 0 || packlen > wb->len) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls_multib.c", 137, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 137 "../ssl/record/methods/tls_multib.c" 3 4
       ((void *)0)
# 137 "../ssl/record/methods/tls_multib.c"
       );
        return -1;
    }
    ...
    if (EVP_CIPHER_CTX_ctrl(rl->enc_ctx,
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tls_multib.c", 148, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 148 "../ssl/record/methods/tls_multib.c" 3 4
       ((void *)0)
# 148 "../ssl/record/methods/tls_multib.c"
       );
        return -1;
    }
