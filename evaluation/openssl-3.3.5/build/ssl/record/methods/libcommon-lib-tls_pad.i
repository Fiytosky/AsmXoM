# 0 "../ssl/record/methods/tls_pad.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/tls_pad.c"
# 10 "../ssl/record/methods/tls_pad.c"
...
int RAND_poll(void);
# 11 "../ssl/record/methods/tls_pad.c" 2
...
# 14 "../ssl/record/methods/tls_pad.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 15 "../ssl/record/methods/tls_pad.c" 2
...
# 16 "../ssl/record/methods/tls_pad.c" 2
# 26 "../ssl/record/methods/tls_pad.c"
static int ssl3_cbc_copy_mac(size_t *reclen,
                             ...
                             size_t good,
                             OSSL_LIB_CTX *libctx);
# 53 "../ssl/record/methods/tls_pad.c"
int ssl3_cbc_remove_padding_and_mac(size_t *reclen,
                                    size_t origreclen,
                                    unsigned char *recdata,
                                    unsigned char **mac,
...
# 98 "../ssl/record/methods/tls_pad.c"
int tls1_cbc_remove_padding_and_mac(size_t *reclen,
                                    size_t origreclen,
                                    unsigned char *recdata,
                                    unsigned char **mac,
...
# 139 "../ssl/record/methods/tls_pad.c"
        to_check = 256;
        if (to_check > *reclen)
            to_check = *reclen;
...
# 182 "../ssl/record/methods/tls_pad.c"
static int ssl3_cbc_copy_mac(size_t *reclen,
                             size_t origreclen,
                             unsigned char *recdata,
                             unsigned char **mac,
                             ...
                             OSSL_LIB_CTX *libctx)
{
    ...
    if (!__builtin_expect(!!((origreclen >= mac_size && mac_size <= 64) != 0), 1)
                                                    )
        return 0;
    ...
    *reclen -= mac_size;
    ...
    if (block_size == 1) {
        ...
        if (mac != 
# 232 "../ssl/record/methods/tls_pad.c" 3 4
                  ((void *)0)
# 232 "../ssl/record/methods/tls_pad.c"
                      )
            *mac = &recdata[*reclen];
        if (alloced != 
# 234 "../ssl/record/methods/tls_pad.c" 3 4
                      ((void *)0)
# 234 "../ssl/record/methods/tls_pad.c"
                          )
            *alloced = 0;
        return 1;
    }
    ...
    if (!__builtin_expect(!!((mac != 
# 243 "../ssl/record/methods/tls_pad.c" 3 4
        ((void *)0) 
# 243 "../ssl/record/methods/tls_pad.c"
        && alloced != 
# 243 "../ssl/record/methods/tls_pad.c" 3 4
        ((void *)0)
# 243 "../ssl/record/methods/tls_pad.c"
        ...
        return 0;
    *mac = out = CRYPTO_malloc(mac_size, "../ssl/record/methods/tls_pad.c", 245);
    if (*mac == 
# 246 "../ssl/record/methods/tls_pad.c" 3 4
               ((void *)0)
# 246 "../ssl/record/methods/tls_pad.c"
                   )
        return 0;
    *alloced = 1;
...
# 309 "../ssl/record/methods/tls_pad.c"
    return 1;
}
