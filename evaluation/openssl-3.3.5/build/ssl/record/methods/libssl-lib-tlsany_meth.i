# 0 "../ssl/record/methods/tlsany_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/methods/tlsany_meth.c"
# 10 "../ssl/record/methods/tlsany_meth.c"
...
# 11 "../ssl/record/methods/tlsany_meth.c" 2
...
# 12 "../ssl/record/methods/tlsany_meth.c" 2
# 1 "../ssl/record/methods/../record_local.h" 1
# 13 "../ssl/record/methods/tlsany_meth.c" 2
...
# 14 "../ssl/record/methods/tlsany_meth.c" 2
...
{
    if (level != 0) {
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c",28,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 28 "../ssl/record/methods/tlsany_meth.c" 3 4
       ((void *)0)
# 28 "../ssl/record/methods/tlsany_meth.c"
       );
        return -2;
    }
...
{
    if (rec->rec_version == 0x0002) {

        if (!__builtin_expect(!!((rl->version == 0x10000) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 49, __func__), ossl_rlayer_fatal)((rl), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 49 "../ssl/record/methods/tlsany_meth.c" 3 4
           ((void *)0)
# 49 "../ssl/record/methods/tlsany_meth.c"
           );
            return 0;
        }
        if (rec->length < 9) {
            (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 53, __func__), ossl_rlayer_fatal)((rl), (50), (160), 
# 53 "../ssl/record/methods/tlsany_meth.c" 3 4
           ((void *)0)
# 53 "../ssl/record/methods/tlsany_meth.c"
           );
            return 0;
        }
    } else {
        if (rl->version == 0x10000) {
            if ((rec->rec_version >> 8) != 0x03) {
                if (rl->is_first_record) {
                    ...
                    p = rl->packet;
                    if ((strncmp((char *)p, "GET " "", sizeof("GET ") - 1) == 0) ||
                        (strncmp((char *)p, "POST " "", sizeof("POST ") - 1) == 0) ||
                        (strncmp((char *)p, "HEAD " "", sizeof("HEAD ") - 1) == 0) ||
                        (strncmp((char *)p, "PUT " "", sizeof("PUT ") - 1) == 0)) {
                        (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 71, __func__), ossl_rlayer_fatal)((rl), (-1), (156), 
# 71 "../ssl/record/methods/tlsany_meth.c" 3 4
                       ((void *)0)
# 71 "../ssl/record/methods/tlsany_meth.c"
                       );
                        return 0;
                    } else if ((strncmp((char *)p, "CONNE" "", sizeof("CONNE") - 1) == 0)) {
                        (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 74, __func__), ossl_rlayer_fatal)((rl), (-1), (155), 
# 74 "../ssl/record/methods/tlsany_meth.c" 3 4
                       ((void *)0)
# 74 "../ssl/record/methods/tlsany_meth.c"
                       )
                                                              ;
                        return 0;
                    }
                    ...
                    (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 80, __func__), ossl_rlayer_fatal)((rl), (-1), (267), 
# 80 "../ssl/record/methods/tlsany_meth.c" 3 4
                   ((void *)0)
# 80 "../ssl/record/methods/tlsany_meth.c"
                   )
                                                           ;
                    return 0;
                } else {
                    (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 84, __func__), ossl_rlayer_fatal)((rl), (70), (267), 
# 84 "../ssl/record/methods/tlsany_meth.c" 3 4
                   ((void *)0)
# 84 "../ssl/record/methods/tlsany_meth.c"
                   )
                                                           ;
                    return 0;
                }
            }
        } else if (rl->version == 0x0304) {
            ...
            if ((rl->version & 0xFF00) == (rec->rec_version & 0xFF00)) {
                if (rec->type == 21) {
# 106 "../ssl/record/methods/tlsany_meth.c"
                    (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 106, __func__), ossl_rlayer_fatal)((rl), (-1), (267), 
# 106 "../ssl/record/methods/tlsany_meth.c" 3 4
                   ((void *)0)
# 106 "../ssl/record/methods/tlsany_meth.c"
                   )
                                                           ;
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 113, __func__), ossl_rlayer_fatal)((rl), (70), (267), 
# 113 "../ssl/record/methods/tlsany_meth.c" 3 4
           ((void *)0)
# 113 "../ssl/record/methods/tlsany_meth.c"
           )
                                                   ;
            return 0;
        }
    ...
    if (rec->length > 16384) {
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/methods/tlsany_meth.c", 124, __func__), ossl_rlayer_fatal)((rl), (22), (146), 
# 124 "../ssl/record/methods/tlsany_meth.c" 3 4
       ((void *)0)
# 124 "../ssl/record/methods/tlsany_meth.c"
       );
        return 0;
    }
    return 1;
...
{
    if (rl->version != 0x10000 && rl->version != vers)
        return 0;
    rl->version = vers;
...
# 151 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 151 "../ssl/record/methods/tlsany_meth.c"
       ,
...
# 161 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 161 "../ssl/record/methods/tlsany_meth.c"
       ,
    tls_prepare_record_header_default,
    
# 163 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 163 "../ssl/record/methods/tlsany_meth.c"
       ,
    tls_any_prepare_for_encryption,
    tls_post_encryption_processing_default,
    
# 166 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)

# 167 "../ssl/record/methods/tlsany_meth.c"
};

static int dtls_any_set_protocol_version(OSSL_RECORD_LAYER *rl, int vers)
{
    if (rl->version != 0x1FFFF && rl->version != vers)
        return 0;
    rl->version = vers;
...
# 181 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 181 "../ssl/record/methods/tlsany_meth.c"
       ,
    dtls_any_set_protocol_version,
    tls_default_read_n,
    dtls_get_more_records,
    
# 185 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 185 "../ssl/record/methods/tlsany_meth.c"
       ,
    
# 186 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 186 "../ssl/record/methods/tlsany_meth.c"
       ,
    
# 187 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 187 "../ssl/record/methods/tlsany_meth.c"
       ,
    tls_write_records_default,
    tls_allocate_write_buffers_default,
    tls_initialise_write_packets_default,
    
# 191 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 191 "../ssl/record/methods/tlsany_meth.c"
       ,
    dtls_prepare_record_header,
    
# 193 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)
# 193 "../ssl/record/methods/tlsany_meth.c"
       ,
    tls_prepare_for_encryption_default,
    dtls_post_encryption_processing,
    
# 196 "../ssl/record/methods/tlsany_meth.c" 3 4
   ((void *)0)

# 197 "../ssl/record/methods/tlsany_meth.c"
};
