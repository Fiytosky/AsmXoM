# 0 "../ssl/record/rec_layer_d1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/record/rec_layer_d1.c"
# 10 "../ssl/record/rec_layer_d1.c"
...
# 11 "../ssl/record/rec_layer_d1.c" 2
...
# 12 "../ssl/record/rec_layer_d1.c" 2
# 1 "../ssl/record/../ssl_local.h" 1
# 15 "../ssl/record/../ssl_local.h"
...
# 37 "../ssl/record/../ssl_local.h" 2
# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 38 "../ssl/record/../ssl_local.h" 2
...
# 40 "../ssl/record/../ssl_local.h" 2
# 1 "../ssl/record/../record/record.h" 1
# 22 "../ssl/record/../record/record.h"
...
# 136 "../ssl/record/../record/record.h"
...
# 41 "../ssl/record/../ssl_local.h" 2
# 386 "../ssl/record/../ssl_local.h"
typedef enum {
    SSL_PHA_NONE = 0,
    SSL_PHA_EXT_SENT,
...
# 1835 "../ssl/record/../ssl_local.h"
# 1 "../ssl/record/../quic/quic_local.h" 1
# 14 "../ssl/record/../quic/quic_local.h"
...
int ossl_quic_conn_poll_events(SSL *ssl, uint64_t events, int do_tick,
                               uint64_t *revents);
# 15 "../ssl/record/../quic/quic_local.h" 2
...
void ossl_quic_tx_packetiser_set_ack_tx_cb(OSSL_QUIC_TX_PACKETISER *txp,
                                           void (*cb)(const OSSL_QUIC_FRAME_ACK *ack,
                                                      ...
                                                      void *arg),
                                           void *cb_arg);
# 16 "../ssl/record/../quic/quic_local.h" 2
...
# 20 "../ssl/record/../quic/quic_local.h" 2
...
int ossl_quic_reactor_block_until_pred(QUIC_REACTOR *rtor,
                                       ...
                                       uint32_t flags,
                                       CRYPTO_MUTEX *mutex);
# 24 "../ssl/record/../quic/quic_local.h" 2
...
# 25 "../ssl/record/../quic/quic_local.h" 2
# 1 "../ssl/record/../quic/../ssl_local.h" 1
# 26 "../ssl/record/../quic/quic_local.h" 2
# 34 "../ssl/record/../quic/quic_local.h"
struct quic_xso_st {
...
struct quic_conn_st {
    ...
    QUIC_PORT *port;
# 151 "../ssl/record/../quic/quic_local.h"
    QUIC_CHANNEL *ch;
...
# 1836 "../ssl/record/../ssl_local.h" 2
# 1858 "../ssl/record/../ssl_local.h"
...
# 2182 "../ssl/record/../ssl_local.h"
typedef enum downgrade_en {
    DOWNGRADE_NONE,
    DOWNGRADE_TO_1_2,
    DOWNGRADE_TO_1_1
} DOWNGRADE;
# 2246 "../ssl/record/../ssl_local.h"
...
# 2424 "../ssl/record/../ssl_local.h" 3 4
                                             ((void *)0)
        
# 2425 "../ssl/record/../ssl_local.h"
       && sc->cert->pkeys[idx].x509 == 
# 2425 "../ssl/record/../ssl_local.h" 3 4
                                       ((void *)0)
# 2425 "../ssl/record/../ssl_local.h"
                                           ;
}
...
static inline int ssl_has_cert_type(const SSL_CONNECTION *sc, unsigned char ct)
{
    ...
    if (ptr == 
# 2441 "../ssl/record/../ssl_local.h" 3 4
              ((void *)0)
# 2441 "../ssl/record/../ssl_local.h"
                  )
        return 0;

    return memchr(ptr, ct, len) != 
# 2444 "../ssl/record/../ssl_local.h" 3 4
                                  ((void *)0)
# 2444 "../ssl/record/../ssl_local.h"
                                      ;
}
...
# 2455 "../ssl/record/../ssl_local.h" 3 4
                                                ((void *)0)
# 2455 "../ssl/record/../ssl_local.h"
                                                    ;

    return s->cert->pkeys[idx].x509 != 
# 2457 "../ssl/record/../ssl_local.h" 3 4
                                      ((void *)0)
        
# 2458 "../ssl/record/../ssl_local.h"
       && s->cert->pkeys[idx].privatekey != 
# 2458 "../ssl/record/../ssl_local.h" 3 4
                                            ((void *)0)
# 2458 "../ssl/record/../ssl_local.h"
                                                ;
}
...
# 2994 "../ssl/record/../ssl_local.h" 3 4
       __atomic_fetch_add ((
# 2994 "../ssl/record/../ssl_local.h"
       ((stat))
# 2994 "../ssl/record/../ssl_local.h" 3 4
       ), (
# 2994 "../ssl/record/../ssl_local.h"
...
# 13 "../ssl/record/rec_layer_d1.c" 2


# 1 "../ssl/record/record_local.h" 1
# 16 "../ssl/record/rec_layer_d1.c" 2
...
int DTLS_RECORD_LAYER_new(RECORD_LAYER *rl)
{
    ...
    if ((d = CRYPTO_malloc(sizeof(*d), "../ssl/record/rec_layer_d1.c", 23)) == 
# 23 "../ssl/record/rec_layer_d1.c" 3 4
                                           ((void *)0)
# 23 "../ssl/record/rec_layer_d1.c"
                                               )
        return 0;
    ...
    if (d->buffered_app_data == 
# 30 "../ssl/record/rec_layer_d1.c" 3 4
                               ((void *)0)
# 30 "../ssl/record/rec_layer_d1.c"
                                   ) {
        CRYPTO_free(d, "../ssl/record/rec_layer_d1.c", 31);
        rl->d = 
# 32 "../ssl/record/rec_layer_d1.c" 3 4
               ((void *)0)
# 32 "../ssl/record/rec_layer_d1.c"
                   ;
        return 0;
    }
...
{
    if (rl->d == 
# 41 "../ssl/record/rec_layer_d1.c" 3 4
                ((void *)0)
# 41 "../ssl/record/rec_layer_d1.c"
                    )
        return;

    DTLS_RECORD_LAYER_clear(rl);
    pqueue_free(rl->d->buffered_app_data);
    CRYPTO_free(rl->d, "../ssl/record/rec_layer_d1.c", 46);
    rl->d = 
# 47 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 47 "../ssl/record/rec_layer_d1.c"
               ;
}
...
void DTLS_RECORD_LAYER_clear(RECORD_LAYER *rl)
{
    DTLS_RECORD_LAYER *d;
    pitem *item = 
# 53 "../ssl/record/rec_layer_d1.c" 3 4
                 ((void *)0)
# 53 "../ssl/record/rec_layer_d1.c"
                     ;
    TLS_RECORD *rec;
    ...
    while ((item = pqueue_pop(d->buffered_app_data)) != 
# 59 "../ssl/record/rec_layer_d1.c" 3 4
                                                       ((void *)0)
# 59 "../ssl/record/rec_layer_d1.c"
                                                           ) {
        rec = (TLS_RECORD *)item->data;

        if (rl->s->options & ((uint64_t)1 << (uint64_t)1))
            OPENSSL_cleanse(rec->allocdata, rec->length);
        CRYPTO_free(rec->allocdata, "../ssl/record/rec_layer_d1.c", 64);
        CRYPTO_free(item->data, "../ssl/record/rec_layer_d1.c", 65);
        pitem_free(item);
    }
...
static int dtls_buffer_record(SSL_CONNECTION *s, TLS_RECORD *rec)
{
    ...
    if (!__builtin_expect(!!((rec->off == 0) != 0), 1))
        return -1;

    rdata = CRYPTO_malloc(sizeof(*rdata), "../ssl/record/rec_layer_d1.c", 88);
    item = pitem_new(rec->seq_num, rdata);
    if (rdata == 
# 90 "../ssl/record/rec_layer_d1.c" 3 4
                ((void *)0) 
# 90 "../ssl/record/rec_layer_d1.c"
                     || item == 
# 90 "../ssl/record/rec_layer_d1.c" 3 4
                                ((void *)0)
# 90 "../ssl/record/rec_layer_d1.c"
                                    ) {
        CRYPTO_free(rdata, "../ssl/record/rec_layer_d1.c", 91);
        pitem_free(item);
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 93, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 93 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 93 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    }
    ...
    *rdata = *rec;
    ...
    rdata->data = rdata->allocdata = CRYPTO_memdup((rec->data), rec->length, "../ssl/record/rec_layer_d1.c", 103);
    if (rdata->data == 
# 104 "../ssl/record/rec_layer_d1.c" 3 4
                      ((void *)0)
# 104 "../ssl/record/rec_layer_d1.c"
                          ) {
        CRYPTO_free(rdata, "../ssl/record/rec_layer_d1.c", 105);
        pitem_free(item);
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 107, __func__), ossl_statem_fatal)((s), (80), ((15 | (0x2 << 18L))), 
# 107 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 107 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    }
    ...
    rdata->rechandle = 
# 114 "../ssl/record/rec_layer_d1.c" 3 4
                      ((void *)0)
# 114 "../ssl/record/rec_layer_d1.c"
                          ;

    item->data = rdata;
# 128 "../ssl/record/rec_layer_d1.c"
    if (pqueue_insert(queue, item) == 
# 128 "../ssl/record/rec_layer_d1.c" 3 4
                                     ((void *)0)
# 128 "../ssl/record/rec_layer_d1.c"
                                         ) {

        CRYPTO_free(rdata->allocdata, "../ssl/record/rec_layer_d1.c", 130);
        CRYPTO_free(rdata, "../ssl/record/rec_layer_d1.c", 131);
        pitem_free(item);
    }
...
static void dtls_unbuffer_record(SSL_CONNECTION *s)
{
    ...
    if (item != 
# 149 "../ssl/record/rec_layer_d1.c" 3 4
               ((void *)0)
# 149 "../ssl/record/rec_layer_d1.c"
                   ) {
        ...
        s->rlayer.num_recs = 1;
        s->rlayer.curr_rec = 0;
# 164 "../ssl/record/rec_layer_d1.c"
        CRYPTO_free(item->data, "../ssl/record/rec_layer_d1.c", 164);
        pitem_free(item);
    }
}
# 198 "../ssl/record/rec_layer_d1.c"
int dtls1_read_bytes(SSL *s, uint8_t type, uint8_t *recvd_type,
                     unsigned char *buf, size_t len,
...
# 205 "../ssl/record/rec_layer_d1.c" 3 4
                                                     ((void *)0)
# 205 "../ssl/record/rec_layer_d1.c"
                                                         ;
    SSL_CONNECTION *sc = ((s) == 
# 206 "../ssl/record/rec_layer_d1.c" 3 4
                        ((void *)0) 
# 206 "../ssl/record/rec_layer_d1.c"
                        ? 
# 206 "../ssl/record/rec_layer_d1.c" 3 4
                        ((void *)0) 
# 206 "../ssl/record/rec_layer_d1.c"
...
# 206 "../ssl/record/rec_layer_d1.c"
    ...
    if (sc == 
# 208 "../ssl/record/rec_layer_d1.c" 3 4
             ((void *)0)
# 208 "../ssl/record/rec_layer_d1.c"
                 )
        return -1;
    ...
    if ((type && (type != 23) &&
         (type != 22)) ||
        (peek && (type != 23))) {
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 214, __func__), ossl_statem_fatal)((sc), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 214 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 214 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    }
 ...
 start:
    ...
    if (sc->rlayer.curr_rec >= sc->rlayer.num_recs) {
        ...
        do {
            ...
            ret = ossl_tls_handle_rlayer_return(sc, 0, sc->rlayer.rrlmethod->read_record(sc->rlayer.rrl, &rr->rechandle, &rr->version, &rr->type, &rr->data, &rr->length, &rr->epoch, rr->seq_num), "../ssl/record/rec_layer_d1.c", 252)
    ...
    if (type == rr->type
        || (rr->type == 20
            && type == 22 && recvd_type != 
# 315 "../ssl/record/rec_layer_d1.c" 3 4
                                                         ((void *)0)
# 315 "../ssl/record/rec_layer_d1.c"
                                                             )) {
# 325 "../ssl/record/rec_layer_d1.c"
        if (SSL_in_init(s) && (type == 23)
                && (((sc)->s3.tmp.finish_md_len == 0 || (sc)->s3.tmp.peer_finish_md_len == 0))) {
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 327, __func__), ossl_statem_fatal)((sc), (10), (100), 
# 327 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 327 "../ssl/record/rec_layer_d1.c"
           )
                                                 ;
            return -1;
        }
        ...
        if (recvd_type != 
# 332 "../ssl/record/rec_layer_d1.c" 3 4
                         ((void *)0)
# 332 "../ssl/record/rec_layer_d1.c"
                             )
            *recvd_type = rr->type;
...
# 372 "../ssl/record/rec_layer_d1.c"
    ...
    if (rr->type == 21) {
        ...
        if (!PACKET_buf_init(&alert, alert_bytes, rr->length)
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 390, __func__), ossl_statem_fatal)((sc), (10), (205), 
# 390 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 390 "../ssl/record/rec_layer_d1.c"
           );
            return -1;
        }

        if (sc->msg_callback)
            sc->msg_callback(0, sc->version, 21, alert_bytes, 2, s,
                             sc->msg_callback_arg);

        if (sc->info_callback != 
# 398 "../ssl/record/rec_layer_d1.c" 3 4
                                ((void *)0)
# 398 "../ssl/record/rec_layer_d1.c"
                                    )
            cb = sc->info_callback;
        else if (s->ctx->info_callback != 
# 400 "../ssl/record/rec_layer_d1.c" 3 4
                                         ((void *)0)
# 400 "../ssl/record/rec_layer_d1.c"
                                             )
            cb = s->ctx->info_callback;

        if (cb != 
# 403 "../ssl/record/rec_layer_d1.c" 3 4
                 ((void *)0)
# 403 "../ssl/record/rec_layer_d1.c"
                     ) {
        ...
        if (alert_level == 1) {
            ...
            if (sc->rlayer.alert_count == 5) {
                (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 415, __func__), ossl_statem_fatal)((sc), (10), (409), 
# 415 "../ssl/record/rec_layer_d1.c" 3 4
               ((void *)0)
# 415 "../ssl/record/rec_layer_d1.c"
               )
                                                    ;
                return -1;
            }
            ...
            if (alert_descr == 0) {
# 436 "../ssl/record/rec_layer_d1.c"
                sc->shutdown |= 2;
                return 0;
            } else if (alert_descr == 100) {
# 447 "../ssl/record/rec_layer_d1.c"
                (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 447, __func__), ossl_statem_fatal)((sc), (40), (339), 
# 447 "../ssl/record/rec_layer_d1.c" 3 4
               ((void *)0)
# 447 "../ssl/record/rec_layer_d1.c"
               );
                return -1;
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 453, __func__), ossl_statem_fatal)(sc, -1,
                          1000 + alert_descr,
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 462, __func__), ossl_statem_fatal)((sc), (47), (246), 
# 462 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 462 "../ssl/record/rec_layer_d1.c"
           );
            return -1;
        }
    ...
    if (rr->type == 22 && !ossl_statem_get_in_handshake(sc)) {
        struct hm_header_st msg_hdr;
        ...
        if (!__builtin_expect(!!((SSL_is_init_finished(s)) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 545, __func__), ossl_statem_fatal)((sc), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 545 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 545 "../ssl/record/rec_layer_d1.c"
           );
            return -1;
        }
    ...
    switch (rr->type) {
    default:
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 581, __func__), ossl_statem_fatal)((sc), (10), (245), 
# 581 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 581 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    case 20:
    case 21:
    case 22:
        ...
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 591, __func__), ossl_statem_fatal)((sc), (10), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 591 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 591 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    case 23:
        ...
        if (sc->s3.in_read_app_data &&
            ...
            (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 607, __func__), ossl_statem_fatal)((sc), (10), (245), 
# 607 "../ssl/record/rec_layer_d1.c" 3 4
           ((void *)0)
# 607 "../ssl/record/rec_layer_d1.c"
           );
            return -1;
        }
    }
                      ...
                      size_t len, size_t *written)
{
    ...
    if (!__builtin_expect(!!((len <= 16384) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 624, __func__), ossl_statem_fatal)((s), (80), ((259|((0x1 << 18L)|(0x2 << 18L)))), 
# 624 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 624 "../ssl/record/rec_layer_d1.c"
       );
        return -1;
    }
    s->rwstate = 1;
                   ...
                   size_t len, size_t *written)
{
    ...
    if (len > ssl_get_max_send_fragment(sc)) {
        (ERR_new(), ERR_set_debug("../ssl/record/rec_layer_d1.c", 652, __func__), ossl_statem_fatal)((sc), (80), (194), 
# 652 "../ssl/record/rec_layer_d1.c" 3 4
       ((void *)0)
# 652 "../ssl/record/rec_layer_d1.c"
       );
        return 0;
    }
    ...
    if (s->method->version == 0x1FFFF
            && sc->max_proto_version != 0x0100)
        tmpl.version = 0xFEFF;
    else
    ...
    ret = ossl_tls_handle_rlayer_return(sc, 1, sc->rlayer.wrlmethod->write_records(sc->rlayer.wrl, &tmpl, 1), "../ssl/record/rec_layer_d1.c", 670)
                                                                            ;
