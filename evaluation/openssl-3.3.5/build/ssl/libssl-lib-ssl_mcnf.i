...
# 14 "../ssl/ssl_mcnf.c" 2
# 1 "../include/internal/sslconf.h" 1
# 12 "../include/internal/sslconf.h"
...
# 31 "../ssl/ssl_mcnf.c" 3 4
                               ((void *)0)
# 31 "../ssl/ssl_mcnf.c"
                                   ;
    OSSL_LIB_CTX *libctx = 
# 32 "../ssl/ssl_mcnf.c" 3 4
                          ((void *)0)
# 32 "../ssl/ssl_mcnf.c"
                              ;

    if (s == 
# 34 "../ssl/ssl_mcnf.c" 3 4
            ((void *)0) 
# 34 "../ssl/ssl_mcnf.c"
                 && ctx == 
# 34 "../ssl/ssl_mcnf.c" 3 4
...
# 34 "../ssl/ssl_mcnf.c"
        ...
        (ERR_new(), ERR_set_debug("../ssl/ssl_mcnf.c",35,__func__), ERR_set_error)((20),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 35 "../ssl/ssl_mcnf.c" 3 4
       ((void *)0)
# 35 "../ssl/ssl_mcnf.c"
       );
        goto err;
...
# 39 "../ssl/ssl_mcnf.c"
    ...
    if (!conf_ssl_name_find(name, &idx)) {
        if (!system)
            (ERR_new(), ERR_set_debug("../ssl/ssl_mcnf.c",43,__func__), ERR_set_error)(20, 113,
                           "name=%s", name);
        goto err;
    }
...
int SSL_config(SSL *s, const char *name)
{
    return ssl_do_config(s, 
# 89 "../ssl/ssl_mcnf.c" 3 4
                           ((void *)0)
# 89 "../ssl/ssl_mcnf.c"
                               , name, 0);
}
...
int SSL_CTX_config(SSL_CTX *ctx, const char *name)
{
    return ssl_do_config(
# 94 "../ssl/ssl_mcnf.c" 3 4
                        ((void *)0)
# 94 "../ssl/ssl_mcnf.c"
                            , ctx, name, 0);
}
