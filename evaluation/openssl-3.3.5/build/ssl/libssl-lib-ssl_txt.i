...
# 21 "../ssl/ssl_txt.c" 3 4
                                      ((void *)0)
# 21 "../ssl/ssl_txt.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../ssl/ssl_txt.c",22,__func__), ERR_set_error)((20),((7 | (0x2 << 18L))),
# 22 "../ssl/ssl_txt.c" 3 4
       ((void *)0)
# 22 "../ssl/ssl_txt.c"
       );
        return 0;
...
int SSL_SESSION_print(BIO *bp, const SSL_SESSION *x)
{
    ...
    if (x == 
# 38 "../ssl/ssl_txt.c" 3 4
            ((void *)0)
# 38 "../ssl/ssl_txt.c"
                )
        goto err;
    istls13 = (x->ssl_version == 0x0304);
...
# 59 "../ssl/ssl_txt.c"
    ...
    if (x->compress_meth != 0) {
        SSL_COMP *comp = 
# 117 "../ssl/ssl_txt.c" 3 4
                        ((void *)0)
# 117 "../ssl/ssl_txt.c"
                            ;

        if (!ssl_cipher_get_evp(
# 119 "../ssl/ssl_txt.c" 3 4
                               ((void *)0)
# 119 "../ssl/ssl_txt.c"
                                   , x, 
# 119 "../ssl/ssl_txt.c" 3 4
...
# 121 "../ssl/ssl_txt.c"
    ...
    if (!ossl_time_is_zero(x->timeout)) {
        if (BIO_printf(bp, "\n    Timeout   : %lld (sec)",
                       (long long)(ossl_time2ticks(x->timeout) / ((uint64_t)1000000000))) <= 0)
            goto err;
    }
    if (BIO_puts(bp, "\n") <= 0)
        goto err;
