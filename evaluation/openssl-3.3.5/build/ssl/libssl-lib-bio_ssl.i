...
# 44 "../ssl/bio_ssl.c" 3 4
   ((void *)0)
# 44 "../ssl/bio_ssl.c"
       ,
    ssl_read,
    
# 46 "../ssl/bio_ssl.c" 3 4
   ((void *)0)
# 46 "../ssl/bio_ssl.c"
       ,
    ssl_puts,
    
# 48 "../ssl/bio_ssl.c" 3 4
   ((void *)0)
# 48 "../ssl/bio_ssl.c"
       ,
    ssl_ctrl,
...
{
    BIO_SSL *bs = CRYPTO_zalloc(sizeof(*bs), "../ssl/bio_ssl.c", 62);

    if (bs == 
# 64 "../ssl/bio_ssl.c" 3 4
             ((void *)0)
# 64 "../ssl/bio_ssl.c"
                 )
        return 0;
...
# 82 "../ssl/bio_ssl.c"
    ...
    CRYPTO_free(bs, "../ssl/bio_ssl.c", 89);
    return 1;
}
...
# 101 "../ssl/bio_ssl.c"
    ...
    case 0:
        ...
        if ((sb->renegotiate_timeout > 0) && (!r)) {
            ...
            tm = (unsigned long)time(
# 124 "../ssl/bio_ssl.c" 3 4
                                    ((void *)0)
# 124 "../ssl/bio_ssl.c"
                                        );
...
# 242 "../ssl/bio_ssl.c"
        ...
        if (next != 
# 257 "../ssl/bio_ssl.c" 3 4
                   ((void *)0)
# 257 "../ssl/bio_ssl.c"
                       )
            ret = BIO_ctrl(next, cmd, num, ptr);
        else if (sc->rbio != 
# 259 "../ssl/bio_ssl.c" 3 4
                            ((void *)0)
# 259 "../ssl/bio_ssl.c"
                                )
    ...
    case 127:
        ...
        bs->last_time = (unsigned long)time(
# 278 "../ssl/bio_ssl.c" 3 4
                                           ((void *)0)
# 278 "../ssl/bio_ssl.c"
                                               );
        break;
...
# 289 "../ssl/bio_ssl.c"
        ...
        if (bio != 
# 299 "../ssl/bio_ssl.c" 3 4
                  ((void *)0)
# 299 "../ssl/bio_ssl.c"
                      ) {
            if (next != 
# 300 "../ssl/bio_ssl.c" 3 4
                       ((void *)0)
# 300 "../ssl/bio_ssl.c"
                           )
                BIO_push(bio, next);
...
# 308 "../ssl/bio_ssl.c"
    ...
    case 10:
        ret = SSL_pending(ssl);
        if (ret == 0)
            ret = (int)BIO_ctrl(SSL_get_rbio(ssl),10,0,
# 326 "../ssl/bio_ssl.c" 3 4
                 ((void *)0)
# 326 "../ssl/bio_ssl.c"
                 );
        break;
    ...
    case 6:
        if ((next != 
# 334 "../ssl/bio_ssl.c" 3 4
                    ((void *)0)
# 334 "../ssl/bio_ssl.c"
                        ) && (next != SSL_get_rbio(ssl))) {
...
# 439 "../ssl/bio_ssl.c"
    ...
    if (ctx != 
# 442 "../ssl/bio_ssl.c" 3 4
              ((void *)0) 
# 442 "../ssl/bio_ssl.c"
                   && (((ctx)->method) == OSSL_QUIC_client_method() || ((ctx)->method) == OSSL_QUIC_client_thread_method()))

        return BIO_new_ssl_connect(ctx);


    if ((buf = BIO_new(BIO_f_buffer())) == 
# 447 "../ssl/bio_ssl.c" 3 4
                                          ((void *)0)
# 447 "../ssl/bio_ssl.c"
                                              )
        return 
# 448 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 448 "../ssl/bio_ssl.c"
                  ;
    if ((ssl = BIO_new_ssl_connect(ctx)) == 
# 449 "../ssl/bio_ssl.c" 3 4
                                           ((void *)0)
# 449 "../ssl/bio_ssl.c"
                                               )
        goto err;
    if ((ret = BIO_push(buf, ssl)) == 
# 451 "../ssl/bio_ssl.c" 3 4
                                     ((void *)0)
# 451 "../ssl/bio_ssl.c"
                                         )
        goto err;
...
# 466 "../ssl/bio_ssl.c" 3 4
                                           ((void *)0)
# 466 "../ssl/bio_ssl.c"
                                               )
        return 
# 467 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 467 "../ssl/bio_ssl.c"
                  ;
    ...
    if (ctx != 
# 470 "../ssl/bio_ssl.c" 3 4
              ((void *)0) 
# 470 "../ssl/bio_ssl.c"
                   && (((ctx)->method) == OSSL_QUIC_client_method() || ((ctx)->method) == OSSL_QUIC_client_thread_method()))
        if (!BIO_ctrl(con,157,(
# 471 "../ssl/bio_ssl.c" 3 4
            SOCK_DGRAM
# 471 "../ssl/bio_ssl.c"
            ),
# 471 "../ssl/bio_ssl.c" 3 4
...
# 475 "../ssl/bio_ssl.c" 3 4
                                      ((void *)0)
# 475 "../ssl/bio_ssl.c"
                                          )
        goto err;
    if ((ret = BIO_push(ssl, con)) == 
# 477 "../ssl/bio_ssl.c" 3 4
                                     ((void *)0)
# 477 "../ssl/bio_ssl.c"
                                         )
        goto err;
...
# 492 "../ssl/bio_ssl.c" 3 4
                                       ((void *)0)
# 492 "../ssl/bio_ssl.c"
                                           )
        return 
# 493 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 493 "../ssl/bio_ssl.c"
                  ;
    if ((ssl = SSL_new(ctx)) == 
# 494 "../ssl/bio_ssl.c" 3 4
                               ((void *)0)
# 494 "../ssl/bio_ssl.c"
                                   ) {
        BIO_free(ret);
        return 
# 496 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 496 "../ssl/bio_ssl.c"
                  ;
    }
...
# 527 "../ssl/bio_ssl.c"
                   ; b = BIO_next(b)) {
        if (BIO_method_type(b) != ( 7|0x0200))
            continue;
        bdata = BIO_get_data(b);
        if (bdata != 
# 531 "../ssl/bio_ssl.c" 3 4
                    ((void *)0) 
# 531 "../ssl/bio_ssl.c"
                         && bdata->ssl != 
# 531 "../ssl/bio_ssl.c" 3 4
