# 0 "../ssl/priority_queue.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../ssl/priority_queue.c"
# 10 "../ssl/priority_queue.c"
...
# 12 "../ssl/priority_queue.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 13 "../ssl/priority_queue.c" 2
...
# 17 "../ssl/priority_queue.c" 3 4
((void *)0) 
# 17 "../ssl/priority_queue.c"
...
# 64 "../ssl/priority_queue.c" 3 4
       (18446744073709551615UL) 
# 64 "../ssl/priority_queue.c"
                / (sizeof(struct pq_heap_st) > sizeof(struct pq_elem_st)
                    ? sizeof(struct pq_heap_st) : sizeof(struct pq_elem_st));
# 89 "../ssl/priority_queue.c"
...
int ossl_pqueue_push(OSSL_PQUEUE *pq, void *data, size_t *elem)
{
    ...
    if (elem != 
# 217 "../ssl/priority_queue.c" 3 4
               ((void *)0)
# 217 "../ssl/priority_queue.c"
                   )
        *elem = m;
    return 1;
}
...
void *ossl_pqueue_peek(const OSSL_PQUEUE *pq)
{
    ...
    return 
# 228 "../ssl/priority_queue.c" 3 4
          ((void *)0)
# 228 "../ssl/priority_queue.c"
              ;
}
...
void *ossl_pqueue_pop(OSSL_PQUEUE *pq)
{
    ...
    if (pq == 
# 236 "../ssl/priority_queue.c" 3 4
             ((void *)0) 
# 236 "../ssl/priority_queue.c"
                  || pq->htop == 0)
        return 
# 237 "../ssl/priority_queue.c" 3 4
              ((void *)0)
# 237 "../ssl/priority_queue.c"
                  ;
...
void *ossl_pqueue_remove(OSSL_PQUEUE *pq, size_t elem)
{
    ...
    if (pq == 
# 260 "../ssl/priority_queue.c" 3 4
             ((void *)0) 
# 260 "../ssl/priority_queue.c"
                  || elem >= pq->hmax || pq->htop == 0)
        return 0;
...
int ossl_pqueue_reserve(OSSL_PQUEUE *pq, size_t n)
{
    ...
    if (pq == 
# 302 "../ssl/priority_queue.c" 3 4
             ((void *)0)
# 302 "../ssl/priority_queue.c"
                 )
        return 0;
    cur_max = pq->hmax;
    ...
    if (new_max == 0) {
        (ERR_new(), ERR_set_debug("../ssl/priority_queue.c",310,__func__), ERR_set_error)((20),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 310 "../ssl/priority_queue.c" 3 4
       ((void *)0)
# 310 "../ssl/priority_queue.c"
       );
        return 0;
    }

    h = CRYPTO_realloc(pq->heap, new_max * sizeof(*pq->heap), "../ssl/priority_queue.c", 314);
    if (h == 
# 315 "../ssl/priority_queue.c" 3 4
            ((void *)0)
# 315 "../ssl/priority_queue.c"
                )
        return 0;
    pq->heap = h;

    e = CRYPTO_realloc(pq->elements, new_max * sizeof(*pq->elements), "../ssl/priority_queue.c", 319);
    if (e == 
# 320 "../ssl/priority_queue.c" 3 4
            ((void *)0)
# 320 "../ssl/priority_queue.c"
                )
        return 0;
    pq->elements = e;
...
OSSL_PQUEUE *ossl_pqueue_new(int (*compare)(const void *, const void *))
{
    ...
    if (compare == 
# 333 "../ssl/priority_queue.c" 3 4
                  ((void *)0)
# 333 "../ssl/priority_queue.c"
                      )
        return 
# 334 "../ssl/priority_queue.c" 3 4
              ((void *)0)
# 334 "../ssl/priority_queue.c"
                  ;

    pq = CRYPTO_malloc(sizeof(*pq), "../ssl/priority_queue.c", 336);
    if (pq == 
# 337 "../ssl/priority_queue.c" 3 4
             ((void *)0)
# 337 "../ssl/priority_queue.c"
                 )
        return 
# 338 "../ssl/priority_queue.c" 3 4
              ((void *)0)
# 338 "../ssl/priority_queue.c"
                  ;
    pq->compare = compare;
    pq->hmax = min_nodes;
    pq->htop = 0;
    pq->freelist = 0;
    pq->heap = CRYPTO_malloc(sizeof(*pq->heap) * min_nodes, "../ssl/priority_queue.c", 343);
    pq->elements = CRYPTO_malloc(sizeof(*pq->elements) * min_nodes, "../ssl/priority_queue.c", 344);
    if (pq->heap == 
# 345 "../ssl/priority_queue.c" 3 4
                   ((void *)0) 
# 345 "../ssl/priority_queue.c"
                        || pq->elements == 
# 345 "../ssl/priority_queue.c" 3 4
                                           ((void *)0)
# 345 "../ssl/priority_queue.c"
        ...
        ossl_pqueue_free(pq);
        return 
# 347 "../ssl/priority_queue.c" 3 4
              ((void *)0)
# 347 "../ssl/priority_queue.c"
                  ;
    }
...
{
    if (pq != 
# 355 "../ssl/priority_queue.c" 3 4
             ((void *)0)
# 355 "../ssl/priority_queue.c"
                 ) {
        CRYPTO_free(pq->heap, "../ssl/priority_queue.c", 356);
        CRYPTO_free(pq->elements, "../ssl/priority_queue.c", 357);
        CRYPTO_free(pq, "../ssl/priority_queue.c", 358);
    }
}
...
void ossl_pqueue_pop_free(OSSL_PQUEUE *pq, void (*freefunc)(void *))
{
    ...
    if (pq != 
# 366 "../ssl/priority_queue.c" 3 4
             ((void *)0)
# 366 "../ssl/priority_queue.c"
                 ) {
        for (i = 0; i < pq->htop; i++)
...
{
    return pq != 
# 375 "../ssl/priority_queue.c" 3 4
                ((void *)0) 
# 375 "../ssl/priority_queue.c"
                     ? pq->htop : 0;
}
