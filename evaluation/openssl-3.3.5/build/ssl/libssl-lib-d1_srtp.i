                                 ...
                                 struct stack_st_SRTP_PROTECTION_PROFILE **out)
{
    ...
    if ((profiles = ((struct stack_st_SRTP_PROTECTION_PROFILE *)OPENSSL_sk_new_null())) == 
# 103 "../ssl/d1_srtp.c" 3 4
                                                             ((void *)0)
# 103 "../ssl/d1_srtp.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../ssl/d1_srtp.c",104,__func__), ERR_set_error)((20),(362),
# 104 "../ssl/d1_srtp.c" 3 4
       ((void *)0)
# 104 "../ssl/d1_srtp.c"
       );
        return 1;
    ...
    do {
        ...
        if (!find_profile_by_name(ptr, &p, col ? (size_t)(col - ptr)
                                               : strlen(ptr))) {
            if (OPENSSL_sk_find(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(profiles), ossl_check_SRTP_PROTECTION_PROFILE_type((SRTP_PROTECTION_PROFILE *)p))
                                                                              >= 0) {
                (ERR_new(), ERR_set_debug("../ssl/d1_srtp.c",115,__func__), ERR_set_error)((20),(353),
# 115 "../ssl/d1_srtp.c" 3 4
               ((void *)0)
# 115 "../ssl/d1_srtp.c"
               );
                goto err;
            ...
            if (!OPENSSL_sk_push(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(profiles), ossl_check_SRTP_PROTECTION_PROFILE_type((SRTP_PROTECTION_PROFILE *)p))
                                                                              ) {
                (ERR_new(), ERR_set_debug("../ssl/d1_srtp.c",121,__func__), ERR_set_error)((20),(362),
# 121 "../ssl/d1_srtp.c" 3 4
               ((void *)0)
# 121 "../ssl/d1_srtp.c"
               );
                goto err;
            ...
            (ERR_new(), ERR_set_debug("../ssl/d1_srtp.c",125,__func__), ERR_set_error)((20),(364),
# 125 "../ssl/d1_srtp.c" 3 4
           ((void *)0)
# 125 "../ssl/d1_srtp.c"
           );
            goto err;
    ...
    OPENSSL_sk_free(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(*out));

    *out = profiles;

    return 0;
 err:
    OPENSSL_sk_free(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(profiles));
    return 1;
}

int SSL_CTX_set_tlsext_use_srtp(SSL_CTX *ctx, const char *profiles)
{
    if (((ctx->method) == OSSL_QUIC_client_method() || (ctx->method) == OSSL_QUIC_client_thread_method()))
        return 1;
...
struct stack_st_SRTP_PROTECTION_PROFILE *SSL_get_srtp_profiles(SSL *s)
{
    SSL_CONNECTION *sc = ((s) == 
# 163 "../ssl/d1_srtp.c" 3 4
                        ((void *)0) 
# 163 "../ssl/d1_srtp.c"
                        ? 
# 163 "../ssl/d1_srtp.c" 3 4
...
# 163 "../ssl/d1_srtp.c"
    ...
    if (sc != 
# 165 "../ssl/d1_srtp.c" 3 4
             ((void *)0)
# 165 "../ssl/d1_srtp.c"
                 ) {
        if (sc->srtp_profiles != 
# 166 "../ssl/d1_srtp.c" 3 4
                                ((void *)0)
# 166 "../ssl/d1_srtp.c"
                                    ) {
            return sc->srtp_profiles;
        } else if ((s->ctx != 
# 168 "../ssl/d1_srtp.c" 3 4
                             ((void *)0)
# 168 "../ssl/d1_srtp.c"
                                 ) && (s->ctx->srtp_profiles != 
# 168 "../ssl/d1_srtp.c" 3 4
