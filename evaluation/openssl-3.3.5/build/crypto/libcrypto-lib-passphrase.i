# 0 "../crypto/passphrase.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/passphrase.c"
# 10 "../crypto/passphrase.c"
...
# 12 "../crypto/passphrase.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../crypto/passphrase.c" 2
...
# 15 "../crypto/passphrase.c" 2

void ossl_pw_clear_passphrase_data(struct ossl_passphrase_data_st *data)
{
    if (data != 
# 18 "../crypto/passphrase.c" 3 4
               ((void *)0)
# 18 "../crypto/passphrase.c"
                   ) {
        if (data->type == is_expl_passphrase)
            CRYPTO_clear_free(data->_.expl_passphrase.passphrase_copy, data->_.expl_passphrase.passphrase_len, "../crypto/passphrase.c", 20)
                                                                      ;
...
void ossl_pw_clear_passphrase_cache(struct ossl_passphrase_data_st *data)
{
    CRYPTO_clear_free(data->cached_passphrase, data->cached_passphrase_len, "../crypto/passphrase.c", 29);
    data->cached_passphrase = 
# 30 "../crypto/passphrase.c" 3 4
                             ((void *)0)
# 30 "../crypto/passphrase.c"
                                 ;
}
...
# 37 "../crypto/passphrase.c" 3 4
        ((void *)0) 
# 37 "../crypto/passphrase.c"
        && passphrase != 
# 37 "../crypto/passphrase.c" 3 4
        ((void *)0)
# 37 "../crypto/passphrase.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",38,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 38 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 38 "../crypto/passphrase.c"
       );
        return 0;
    }
    ...
    data->_.expl_passphrase.passphrase_copy =
        passphrase_len != 0 ? CRYPTO_memdup((passphrase), passphrase_len, "../crypto/passphrase.c", 44)
                            : CRYPTO_malloc(1, "../crypto/passphrase.c", 45);
    if (data->_.expl_passphrase.passphrase_copy == 
# 46 "../crypto/passphrase.c" 3 4
                                                  ((void *)0)
# 46 "../crypto/passphrase.c"
                                                      )
        return 0;
...
{
    if (!__builtin_expect(!!((data != 
# 55 "../crypto/passphrase.c" 3 4
        ((void *)0) 
# 55 "../crypto/passphrase.c"
        && cb != 
# 55 "../crypto/passphrase.c" 3 4
        ((void *)0)
# 55 "../crypto/passphrase.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",56,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 56 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 56 "../crypto/passphrase.c"
       );
        return 0;
    }
    ossl_pw_clear_passphrase_data(data);
...
{
    if (!__builtin_expect(!!((data != 
# 69 "../crypto/passphrase.c" 3 4
        ((void *)0) 
# 69 "../crypto/passphrase.c"
        && cb != 
# 69 "../crypto/passphrase.c" 3 4
        ((void *)0)
# 69 "../crypto/passphrase.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",70,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 70 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 70 "../crypto/passphrase.c"
       );
        return 0;
    }
    ossl_pw_clear_passphrase_data(data);
...
{
    if (!__builtin_expect(!!((data != 
# 83 "../crypto/passphrase.c" 3 4
        ((void *)0) 
# 83 "../crypto/passphrase.c"
        && ui_method != 
# 83 "../crypto/passphrase.c" 3 4
        ((void *)0)
# 83 "../crypto/passphrase.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",84,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 84 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 84 "../crypto/passphrase.c"
       );
        return 0;
    }
    ossl_pw_clear_passphrase_data(data);
...
# 120 "../crypto/passphrase.c"
    ...
    UI *ui = 
# 122 "../crypto/passphrase.c" 3 4
            ((void *)0)
# 122 "../crypto/passphrase.c"
                ;
    int ret = 0;

    if (!__builtin_expect(!!((pass != 
# 125 "../crypto/passphrase.c" 3 4
        ((void *)0) 
# 125 "../crypto/passphrase.c"
        && pass_size != 0 && pass_len != 
# 125 "../crypto/passphrase.c" 3 4
        ((void *)0)
# 125 "../crypto/passphrase.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",126,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 126 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 126 "../crypto/passphrase.c"
       );
        return 0;
    }

    if ((ui = UI_new()) == 
# 130 "../crypto/passphrase.c" 3 4
                          ((void *)0)
# 130 "../crypto/passphrase.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",131,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 131 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 131 "../crypto/passphrase.c"
       );
        return 0;
    }

    if (ui_method != 
# 135 "../crypto/passphrase.c" 3 4
                    ((void *)0)
# 135 "../crypto/passphrase.c"
                        ) {
        UI_set_method(ui, ui_method);
        if (ui_data != 
# 137 "../crypto/passphrase.c" 3 4
                      ((void *)0)
# 137 "../crypto/passphrase.c"
                          )
    ...
    if (prompt == 
# 143 "../crypto/passphrase.c" 3 4
                 ((void *)0)
# 143 "../crypto/passphrase.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",144,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 144 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 144 "../crypto/passphrase.c"
       );
        goto end;
    }


    ipass = CRYPTO_zalloc(pass_size + 1, "../crypto/passphrase.c", 149);
    if (ipass == 
# 150 "../crypto/passphrase.c" 3 4
                ((void *)0)
# 150 "../crypto/passphrase.c"
                    )
        goto end;
    ...
    prompt_idx = UI_add_input_string(ui, prompt,
                                     ...
                                     ipass, 0, pass_size) - 1;
    if (prompt_idx < 0) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",157,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 157 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 157 "../crypto/passphrase.c"
       );
        goto end;
    }
    ...
    if (verify) {
        ...
        vpass = CRYPTO_zalloc(pass_size + 1, "../crypto/passphrase.c", 163);
        if (vpass == 
# 164 "../crypto/passphrase.c" 3 4
                    ((void *)0)
# 164 "../crypto/passphrase.c"
                        )
            goto end;
        verify_idx = UI_add_verify_string(ui, prompt,
                                          ...
                                          ipass) - 1;
        if (verify_idx < 0) {
            (ERR_new(), ERR_set_debug("../crypto/passphrase.c",171,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 171 "../crypto/passphrase.c" 3 4
           ((void *)0)
# 171 "../crypto/passphrase.c"
           );
            goto end;
        }
    }
    ...
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",178,__func__), ERR_set_error)((15),((265|(0x2 << 18L))),
# 178 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 178 "../crypto/passphrase.c"
       );
        break;
    case -1:
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",181,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 181 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 181 "../crypto/passphrase.c"
       );
        break;
    default:
        res = UI_get_result_length(ui, prompt_idx);
        if (res < 0) {
            (ERR_new(), ERR_set_debug("../crypto/passphrase.c",186,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 186 "../crypto/passphrase.c" 3 4
           ((void *)0)
# 186 "../crypto/passphrase.c"
           );
            break;
        }
        *pass_len = (size_t)res;
    ...
    CRYPTO_clear_free(vpass, pass_size + 1, "../crypto/passphrase.c", 196);
    CRYPTO_clear_free(ipass, pass_size + 1, "../crypto/passphrase.c", 197);
    CRYPTO_free(prompt, "../crypto/passphrase.c", 198);
    UI_free(ui);
    return ret;
}
...
{
    const char *source = 
# 208 "../crypto/passphrase.c" 3 4
                        ((void *)0)
# 208 "../crypto/passphrase.c"
                            ;
    size_t source_len = 0;
    const char *prompt_info = 
# 210 "../crypto/passphrase.c" 3 4
                             ((void *)0)
# 210 "../crypto/passphrase.c"
                                 ;
    const UI_METHOD *ui_method = 
# 211 "../crypto/passphrase.c" 3 4
                                ((void *)0)
# 211 "../crypto/passphrase.c"
                                    ;
    UI_METHOD *allocated_ui_method = 
# 212 "../crypto/passphrase.c" 3 4
                                    ((void *)0)
# 212 "../crypto/passphrase.c"
                                        ;
    void *ui_data = 
# 213 "../crypto/passphrase.c" 3 4
                   ((void *)0)
# 213 "../crypto/passphrase.c"
                       ;
    const OSSL_PARAM *p = 
# 214 "../crypto/passphrase.c" 3 4
                         ((void *)0)
# 214 "../crypto/passphrase.c"
                             ;
    int ret;
...
# 222 "../crypto/passphrase.c" 3 4
                                                                        ((void *)0)
# 222 "../crypto/passphrase.c"
                                                                            ) {
    ...
    if (source != 
# 227 "../crypto/passphrase.c" 3 4
                 ((void *)0)
# 227 "../crypto/passphrase.c"
                     ) {
    ...
    if ((p = OSSL_PARAM_locate_const(params,
                                     "info")) != 
# 248 "../crypto/passphrase.c" 3 4
                                                                    ((void *)0)
# 248 "../crypto/passphrase.c"
                                                                        ) {
        if (p->data_type != 4) {
            (ERR_new(), ERR_set_debug("../crypto/passphrase.c",250,__func__), ERR_set_error)(15, (262|(0x2 << 18L)),
    ...
    if (data->type == is_pem_password) {
        ...
        if (ui_method == 
# 265 "../crypto/passphrase.c" 3 4
                        ((void *)0)
# 265 "../crypto/passphrase.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/passphrase.c",266,__func__), ERR_set_error)((15),((40 | (0x2 << 18L))),
# 266 "../crypto/passphrase.c" 3 4
           ((void *)0)
# 266 "../crypto/passphrase.c"
           );
            return 0;
        }
    ...
    if (ui_method == 
# 274 "../crypto/passphrase.c" 3 4
                    ((void *)0)
# 274 "../crypto/passphrase.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/passphrase.c",275,__func__), ERR_set_error)(15, (262|(0x2 << 18L)),
 ...
 do_cache:
    if (ret && data->flag_cache_passphrase) {
        if (data->cached_passphrase == 
# 287 "../crypto/passphrase.c" 3 4
                                      ((void *)0)
            
# 288 "../crypto/passphrase.c"
           || *pass_len > data->cached_passphrase_len) {
            void *new_cache =
                CRYPTO_clear_realloc(data->cached_passphrase, data->cached_passphrase_len, *pass_len + 1, "../crypto/passphrase.c", 290)

                                                    ;

            if (new_cache == 
# 294 "../crypto/passphrase.c" 3 4
                            ((void *)0)
# 294 "../crypto/passphrase.c"
                                ) {
                                ...
                                void *userdata, const char *info)
{
    ...
    OSSL_PARAM params[] = {
        { (("info")), (4), ((
# 313 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 313 "../crypto/passphrase.c"
       )), (0), ((size_t)-1) },
        { 
# 314 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 314 "../crypto/passphrase.c"
       , 0, 
# 314 "../crypto/passphrase.c" 3 4
       ((void *)0)
# 314 "../crypto/passphrase.c"
