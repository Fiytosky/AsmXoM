...
# 21 "../crypto/init.c" 2
# 1 "../include/crypto/async.h" 1
# 12 "../include/crypto/async.h"
...
# 23 "../crypto/init.c" 2
# 1 "../include/internal/comp.h" 1
# 10 "../include/internal/comp.h"
...
# 26 "../crypto/init.c" 2
# 1 "../include/crypto/objects.h" 1
# 12 "../include/crypto/objects.h"
...
# 30 "../crypto/init.c" 2
# 1 "include/crypto/dso_conf.h" 1
# 14 "include/crypto/dso_conf.h"
...
static OPENSSL_INIT_STOP *stop_handlers = 
# 46 "../crypto/init.c" 3 4
                                         ((void *)0)
# 46 "../crypto/init.c"
                                             ;

static CRYPTO_RWLOCK *optsdone_lock = 
# 48 "../crypto/init.c" 3 4
                                     ((void *)0)
# 48 "../crypto/init.c"
                                         ;

static CRYPTO_RWLOCK *init_lock = 
# 50 "../crypto/init.c" 3 4
                                 ((void *)0)
# 50 "../crypto/init.c"
                                     ;
...
# 53 "../crypto/init.c" 3 4
                         0
# 53 "../crypto/init.c"
                                                ;
static int base_inited = 0;
static int ossl_init_base(void); static int ossl_init_base_ossl_ret_ = 0; static void ossl_init_base_ossl_(void) { ossl_init_base_ossl_ret_ = ossl_init_base(); } static int ossl_init_base(void)
{
    ...
    if ((optsdone_lock = CRYPTO_THREAD_lock_new()) == 
# 64 "../crypto/init.c" 3 4
                                                     ((void *)0)
        
# 65 "../crypto/init.c"
       || (init_lock = CRYPTO_THREAD_lock_new()) == 
# 65 "../crypto/init.c" 3 4
                                                    ((void *)0)
# 65 "../crypto/init.c"
                                                        )
        goto err;
    ...
    if (!CRYPTO_THREAD_init_local(&in_init_config_local, 
# 73 "../crypto/init.c" 3 4
                                                        ((void *)0)
# 73 "../crypto/init.c"
                                                            ))
        goto err;
...
err:
    ...
    optsdone_lock = 
# 82 "../crypto/init.c" 3 4
                   ((void *)0)
# 82 "../crypto/init.c"
                       ;
    CRYPTO_THREAD_lock_free(init_lock);
    init_lock = 
# 84 "../crypto/init.c" 3 4
               ((void *)0)
# 84 "../crypto/init.c"
                   ;
...
# 89 "../crypto/init.c" 3 4
                                    0
# 89 "../crypto/init.c"
                                                           ;
# 98 "../crypto/init.c"
static int ossl_init_register_atexit(void); static int ossl_init_register_atexit_ossl_ret_ = 0; static void ossl_init_register_atexit_ossl_(void) { ossl_init_register_atexit_ossl_ret_ = ossl_init_register_atexit(); } static int ossl_init_register_atexit(void)
{
# 110 "../crypto/init.c"
...
static int ossl_init_no_register_atexit(void); static void ossl_init_no_register_atexit_ossl_(void) { ossl_init_register_atexit_ossl_ret_ = ossl_init_no_register_atexit(); } static int ossl_init_no_register_atexit(void)
...
# 129 "../crypto/init.c" 3 4
                                         0
# 129 "../crypto/init.c"
                                                                ;
static int ossl_init_load_crypto_nodelete(void); static int ossl_init_load_crypto_nodelete_ossl_ret_ = 0; static void ossl_init_load_crypto_nodelete_ossl_(void) { ossl_init_load_crypto_nodelete_ossl_ret_ = ossl_init_load_crypto_nodelete(); } static int ossl_init_load_crypto_nodelete(void)
{
    ((void)0);
# 178 "../crypto/init.c"
    return 1;
...
# 181 "../crypto/init.c" 3 4
                                        0
# 181 "../crypto/init.c"
                                                               ;

static int ossl_init_load_crypto_strings(void); static int ossl_init_load_crypto_strings_ossl_ret_ = 0; static void ossl_init_load_crypto_strings_ossl_(void) { ossl_init_load_crypto_strings_ossl_ret_ = ossl_init_load_crypto_strings(); } static int ossl_init_load_crypto_strings(void)
{
    int ret = 1;
...
static int ossl_init_no_load_crypto_strings(void); static void ossl_init_no_load_crypto_strings_ossl_(void) { ossl_init_load_crypto_strings_ossl_ret_ = ossl_init_no_load_crypto_strings(); } static int ossl_init_no_load_crypto_strings(void)
...
# 211 "../crypto/init.c" 3 4
                                    0
# 211 "../crypto/init.c"
                                                           ;
static int ossl_init_add_all_ciphers(void); static int ossl_init_add_all_ciphers_ossl_ret_ = 0; static void ossl_init_add_all_ciphers_ossl_(void) { ossl_init_add_all_ciphers_ossl_ret_ = ossl_init_add_all_ciphers(); } static int ossl_init_add_all_ciphers(void)
{
...
static int ossl_init_no_add_all_ciphers(void); static void ossl_init_no_add_all_ciphers_ossl_(void) { ossl_init_add_all_ciphers_ossl_ret_ = ossl_init_no_add_all_ciphers(); } static int ossl_init_no_add_all_ciphers(void)
...
# 232 "../crypto/init.c" 3 4
                                    0
# 232 "../crypto/init.c"
                                                           ;
static int ossl_init_add_all_digests(void); static int ossl_init_add_all_digests_ossl_ret_ = 0; static void ossl_init_add_all_digests_ossl_(void) { ossl_init_add_all_digests_ossl_ret_ = ossl_init_add_all_digests(); } static int ossl_init_add_all_digests(void)
{
...
static int ossl_init_no_add_all_digests(void); static void ossl_init_no_add_all_digests_ossl_(void) { ossl_init_add_all_digests_ossl_ret_ = ossl_init_no_add_all_digests(); } static int ossl_init_no_add_all_digests(void)
...
# 253 "../crypto/init.c" 3 4
                           0
# 253 "../crypto/init.c"
                                                  ;
static int config_inited = 0;
static const OPENSSL_INIT_SETTINGS *conf_settings = 
# 255 "../crypto/init.c" 3 4
                                                   ((void *)0)
# 255 "../crypto/init.c"
                                                       ;
static int ossl_init_config(void); static int ossl_init_config_ossl_ret_ = 0; static void ossl_init_config_ossl_(void) { ossl_init_config_ossl_ret_ = ossl_init_config(); } static int ossl_init_config(void)
{
    int ret = ossl_config_int(
# 258 "../crypto/init.c" 3 4
                             ((void *)0)
# 258 "../crypto/init.c"
                                 );
...
static int ossl_init_config_settings(void); static void ossl_init_config_settings_ossl_(void) { ossl_init_config_ossl_ret_ = ossl_init_config_settings(); } static int ossl_init_config_settings(void)
{
...
static int ossl_init_no_config(void); static void ossl_init_no_config_ossl_(void) { ossl_init_config_ossl_ret_ = ossl_init_no_config(); } static int ossl_init_no_config(void)
{
    ((void)0);
    ossl_no_config_int();
    config_inited = 1;
...
# 278 "../crypto/init.c" 3 4
                          0
# 278 "../crypto/init.c"
                                                 ;
static int async_inited = 0;
static int ossl_init_async(void); static int ossl_init_async_ossl_ret_ = 0; static void ossl_init_async_ossl_(void) { ossl_init_async_ossl_ret_ = ossl_init_async(); } static int ossl_init_async(void)
{
    ((void)0);
    if (!async_init())
        return 0;
...
# 290 "../crypto/init.c" 3 4
                                   0
# 290 "../crypto/init.c"
                                                          ;
static int ossl_init_engine_openssl(void); static int ossl_init_engine_openssl_ossl_ret_ = 0; static void ossl_init_engine_openssl_ossl_(void) { ossl_init_engine_openssl_ossl_ret_ = ossl_init_engine_openssl(); } static int ossl_init_engine_openssl(void)
{
    ((void)0);
...
# 298 "../crypto/init.c" 3 4
                                  0
# 298 "../crypto/init.c"
                                                         ;
static int ossl_init_engine_rdrand(void); static int ossl_init_engine_rdrand_ossl_ret_ = 0; static void ossl_init_engine_rdrand_ossl_(void) { ossl_init_engine_rdrand_ossl_ret_ = ossl_init_engine_rdrand(); } static int ossl_init_engine_rdrand(void)
{
    ((void)0);
...
static CRYPTO_ONCE engine_dynamic = 
# 306 "../crypto/init.c" 3 4
                                   0
# 306 "../crypto/init.c"
                                                          ;
static int ossl_init_engine_dynamic(void); static int ossl_init_engine_dynamic_ossl_ret_ = 0; static void ossl_init_engine_dynamic_ossl_(void) { ossl_init_engine_dynamic_ossl_ret_ = ossl_init_engine_dynamic(); } static int ossl_init_engine_dynamic(void)
{
    ((void)0);
...
# 324 "../crypto/init.c"
static CRYPTO_ONCE engine_padlock = 
# 324 "../crypto/init.c" 3 4
                                   0
# 324 "../crypto/init.c"
                                                          ;
static int ossl_init_engine_padlock(void); static int ossl_init_engine_padlock_ossl_ret_ = 0; static void ossl_init_engine_padlock_ossl_(void) { ossl_init_engine_padlock_ossl_ret_ = ossl_init_engine_padlock(); } static int ossl_init_engine_padlock(void)
{
    ((void)0);
...
# 342 "../crypto/init.c"
static CRYPTO_ONCE engine_afalg = 
# 342 "../crypto/init.c" 3 4
                                 0
# 342 "../crypto/init.c"
                                                        ;
static int ossl_init_engine_afalg(void); static int ossl_init_engine_afalg_ossl_ret_ = 0; static void ossl_init_engine_afalg_ossl_(void) { ossl_init_engine_afalg_ossl_ret_ = ossl_init_engine_afalg(); } static int ossl_init_engine_afalg(void)
{
    ((void)0);
...
# 378 "../crypto/init.c"
        ...
        CRYPTO_free(lasthandler, "../crypto/init.c", 382);
    }
    stop_handlers = 
# 384 "../crypto/init.c" 3 4
                   ((void *)0)
# 384 "../crypto/init.c"
                       ;
    ...
    CRYPTO_THREAD_lock_free(optsdone_lock);
    optsdone_lock = 
# 387 "../crypto/init.c" 3 4
                   ((void *)0)
# 387 "../crypto/init.c"
                       ;
    CRYPTO_THREAD_lock_free(init_lock);
    init_lock = 
# 389 "../crypto/init.c" 3 4
               ((void *)0)
# 389 "../crypto/init.c"
                   ;
...
int OPENSSL_init_crypto(uint64_t opts, const OPENSSL_INIT_SETTINGS *settings)
{
    ...
    if (stopped) {
        if (!(opts & 0x00040000L))
            (ERR_new(), ERR_set_debug("../crypto/init.c",483,__func__), ERR_set_error)((15),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 483 "../crypto/init.c" 3 4
           ((void *)0)
# 483 "../crypto/init.c"
           );
        return 0;
...
# 500 "../crypto/init.c"
    if (CRYPTO_atomic_load(&optsdone, &tmp, 
# 500 "../crypto/init.c" 3 4
                                           ((void *)0)
# 500 "../crypto/init.c"
                                               )) {
        if ((tmp & opts) == opts)
...
# 520 "../crypto/init.c"
    if (!(CRYPTO_THREAD_run_once(&base, ossl_init_base_ossl_) ? ossl_init_base_ossl_ret_ : 0))
        return 0;
    ...
    if ((opts & 0x00080000L) != 0) {
        if (!(CRYPTO_THREAD_run_once(&register_atexit, ossl_init_no_register_atexit_ossl_) ? ossl_init_register_atexit_ossl_ret_ : 0)
                                                    )
            return 0;
    } else if (!(CRYPTO_THREAD_run_once(&register_atexit, ossl_init_register_atexit_ossl_) ? ossl_init_register_atexit_ossl_ret_ : 0)) {
        return 0;
    }

    if (!(CRYPTO_THREAD_run_once(&load_crypto_nodelete, ossl_init_load_crypto_nodelete_ossl_) ? ossl_init_load_crypto_nodelete_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00000001L)
            && !(CRYPTO_THREAD_run_once(&load_crypto_strings, ossl_init_no_load_crypto_strings_ossl_) ? ossl_init_load_crypto_strings_ossl_ret_ : 0)

                                                           )
        return 0;

    if ((opts & 0x00000002L)
            && !(CRYPTO_THREAD_run_once(&load_crypto_strings, ossl_init_load_crypto_strings_ossl_) ? ossl_init_load_crypto_strings_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00000010L)
            && !(CRYPTO_THREAD_run_once(&add_all_ciphers, ossl_init_no_add_all_ciphers_ossl_) ? ossl_init_add_all_ciphers_ossl_ret_ : 0)
                                                       )
        return 0;

    if ((opts & 0x00000004L)
            && !(CRYPTO_THREAD_run_once(&add_all_ciphers, ossl_init_add_all_ciphers_ossl_) ? ossl_init_add_all_ciphers_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00000020L)
            && !(CRYPTO_THREAD_run_once(&add_all_digests, ossl_init_no_add_all_digests_ossl_) ? ossl_init_add_all_digests_ossl_ret_ : 0)
                                                       )
        return 0;

    if ((opts & 0x00000008L)
            && !(CRYPTO_THREAD_run_once(&add_all_digests, ossl_init_add_all_digests_ossl_) ? ossl_init_add_all_digests_ossl_ret_ : 0))
        return 0;
    ...
    if ((opts & 0x00000080L)
            && !(CRYPTO_THREAD_run_once(&config, ossl_init_no_config_ossl_) ? ossl_init_config_ossl_ret_ : 0))
        return 0;

    if (opts & 0x00000040L) {
        int loading = CRYPTO_THREAD_get_local(&in_init_config_local) != 
# 592 "../crypto/init.c" 3 4
                                                                       ((void *)0)
# 592 "../crypto/init.c"
                                                                           ;
        ...
        if (!loading) {
            ...
            if (!CRYPTO_THREAD_set_local(&in_init_config_local, (void *)-1))
                return 0;
            if (settings == 
# 600 "../crypto/init.c" 3 4
                           ((void *)0)
# 600 "../crypto/init.c"
                               ) {
                ret = (CRYPTO_THREAD_run_once(&config, ossl_init_config_ossl_) ? ossl_init_config_ossl_ret_ : 0);
            } else {
                if (!CRYPTO_THREAD_write_lock(init_lock))
                    return 0;
                conf_settings = settings;
                ret = (CRYPTO_THREAD_run_once(&config, ossl_init_config_settings_ossl_) ? ossl_init_config_ossl_ret_ : 0)
                                                    ;
                conf_settings = 
# 608 "../crypto/init.c" 3 4
                               ((void *)0)
# 608 "../crypto/init.c"
                                   ;
    ...
    if ((opts & 0x00000100L)
            && !(CRYPTO_THREAD_run_once(&async, ossl_init_async_ossl_) ? ossl_init_async_ossl_ret_ : 0))
        return 0;


    if ((opts & 0x00000800L)
            && !(CRYPTO_THREAD_run_once(&engine_openssl, ossl_init_engine_openssl_ossl_) ? ossl_init_engine_openssl_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00000200L)
            && !(CRYPTO_THREAD_run_once(&engine_rdrand, ossl_init_engine_rdrand_ossl_) ? ossl_init_engine_rdrand_ossl_ret_ : 0))
        return 0;

    if ((opts & 0x00000400L)
            && !(CRYPTO_THREAD_run_once(&engine_dynamic, ossl_init_engine_dynamic_ossl_) ? ossl_init_engine_dynamic_ossl_ret_ : 0))
        return 0;
    ...
    if ((opts & 0x00004000L)
            && !(CRYPTO_THREAD_run_once(&engine_padlock, ossl_init_engine_padlock_ossl_) ? ossl_init_engine_padlock_ossl_ret_ : 0))
        return 0;
    ...
    if ((opts & 0x00008000L)
            && !(CRYPTO_THREAD_run_once(&engine_afalg, ossl_init_engine_afalg_ossl_) ? ossl_init_engine_afalg_ossl_ret_ : 0))
        return 0;


    if (opts & ((0x00000200L | 0x00000400L | 0x00001000L | 0x00002000L | 0x00004000L)
                | 0x00000800L
                | 0x00008000L)) {
...
# 722 "../crypto/init.c"
    if ((newhand = CRYPTO_malloc(sizeof(*newhand), "../crypto/init.c", 722)) == 
# 722 "../crypto/init.c" 3 4
                                                       ((void *)0)
# 722 "../crypto/init.c"
                                                           )
        return 0;
