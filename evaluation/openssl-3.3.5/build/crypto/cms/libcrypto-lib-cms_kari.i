# 0 "../crypto/cms/cms_kari.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_kari.c"
# 14 "../crypto/cms/cms_kari.c"
...
{
    if (ri->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",33,__func__), ERR_set_error)((46),(181),
# 33 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 33 "../crypto/cms/cms_kari.c"
       );
        return 0;
    }
    if (palg)
...
{
    if (ri->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",49,__func__), ERR_set_error)((46),(181),
# 49 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 49 "../crypto/cms/cms_kari.c"
       );
        return 
# 50 "../crypto/cms/cms_kari.c" 3 4
              ((void *)0)
# 50 "../crypto/cms/cms_kari.c"
                  ;
    }
                                        ...
                                        ASN1_INTEGER **sno)
{
    ...
    if (ri->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",65,__func__), ERR_set_error)((46),(181),
# 65 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 65 "../crypto/cms/cms_kari.c"
       );
        return 0;
    }
    ...
    if (issuer)
        *issuer = 
# 70 "../crypto/cms/cms_kari.c" 3 4
                 ((void *)0)
# 70 "../crypto/cms/cms_kari.c"
                     ;
    if (sno)
        *sno = 
# 72 "../crypto/cms/cms_kari.c" 3 4
              ((void *)0)
# 72 "../crypto/cms/cms_kari.c"
                  ;
    if (keyid)
        *keyid = 
# 74 "../crypto/cms/cms_kari.c" 3 4
                ((void *)0)
# 74 "../crypto/cms/cms_kari.c"
                    ;
    if (pubalg)
        *pubalg = 
# 76 "../crypto/cms/cms_kari.c" 3 4
                 ((void *)0)
# 76 "../crypto/cms/cms_kari.c"
                     ;
    if (pubkey)
        *pubkey = 
# 78 "../crypto/cms/cms_kari.c" 3 4
                 ((void *)0)
# 78 "../crypto/cms/cms_kari.c"
                     ;
    if (oik->type == 0) {
        if (issuer)
...
int CMS_RecipientInfo_kari_orig_id_cmp(CMS_RecipientInfo *ri, X509 *cert)
{
    ...
    if (ri->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",102,__func__), ERR_set_error)((46),(181),
# 102 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 102 "../crypto/cms/cms_kari.c"
       );
        return -2;
    }
    oik = ri->d.kari->originator;
                                      ...
                                      X509_NAME **issuer, ASN1_INTEGER **sno)
{
    ...
    if (rid->type == 0) {
        ...
        if (keyid)
            *keyid = 
# 127 "../crypto/cms/cms_kari.c" 3 4
                    ((void *)0)
# 127 "../crypto/cms/cms_kari.c"
                        ;
        if (tm)
            *tm = 
# 129 "../crypto/cms/cms_kari.c" 3 4
                 ((void *)0)
# 129 "../crypto/cms/cms_kari.c"
                     ;
        if (other)
            *other = 
# 131 "../crypto/cms/cms_kari.c" 3 4
                    ((void *)0)
# 131 "../crypto/cms/cms_kari.c"
                        ;
    } else if (rid->type == 1) {
        if (keyid)
        ...
        if (issuer)
            *issuer = 
# 140 "../crypto/cms/cms_kari.c" 3 4
                     ((void *)0)
# 140 "../crypto/cms/cms_kari.c"
                         ;
        if (sno)
            *sno = 
# 142 "../crypto/cms/cms_kari.c" 3 4
                  ((void *)0)
# 142 "../crypto/cms/cms_kari.c"
                      ;
    } else
        return 0;
    return 1;
                                              ...
                                              EVP_PKEY *pk, X509 *peer)
{
    ...
    kari->pctx = 
# 169 "../crypto/cms/cms_kari.c" 3 4
                ((void *)0)
# 169 "../crypto/cms/cms_kari.c"
                    ;
    if (pk == 
# 170 "../crypto/cms/cms_kari.c" 3 4
             ((void *)0)
# 170 "../crypto/cms/cms_kari.c"
                 )
        return 1;
    ...
    if (pctx == 
# 176 "../crypto/cms/cms_kari.c" 3 4
               ((void *)0) 
# 176 "../crypto/cms/cms_kari.c"
                    || EVP_PKEY_derive_init(pctx) <= 0)
        goto err;

    if (peer != 
# 179 "../crypto/cms/cms_kari.c" 3 4
               ((void *)0)
# 179 "../crypto/cms/cms_kari.c"
                   ) {
...
int CMS_RecipientInfo_kari_set0_pkey(CMS_RecipientInfo *ri, EVP_PKEY *pk)
{
    return CMS_RecipientInfo_kari_set0_pkey_and_peer(ri, pk, 
# 195 "../crypto/cms/cms_kari.c" 3 4
                                                            ((void *)0)
# 195 "../crypto/cms/cms_kari.c"
                                                                );
}
...
EVP_CIPHER_CTX *CMS_RecipientInfo_kari_get0_ctx(CMS_RecipientInfo *ri)
{
    ...
    return 
# 202 "../crypto/cms/cms_kari.c" 3 4
          ((void *)0)
# 202 "../crypto/cms/cms_kari.c"
              ;
}
                          ...
                          CMS_KeyAgreeRecipientInfo *kari, int enc)
{
    ...
    int rv = 0;
    unsigned char *out = 
# 218 "../crypto/cms/cms_kari.c" 3 4
                        ((void *)0)
# 218 "../crypto/cms/cms_kari.c"
                            ;
    int outlen;
    ...
    if (!EVP_CipherInit_ex(kari->ctx, 
# 228 "../crypto/cms/cms_kari.c" 3 4
                                     ((void *)0)
# 228 "../crypto/cms/cms_kari.c"
                                         , 
# 228 "../crypto/cms/cms_kari.c" 3 4
                                           ((void *)0)
# 228 "../crypto/cms/cms_kari.c"
...
# 228 "../crypto/cms/cms_kari.c"
    ...
    if (!EVP_CipherUpdate(kari->ctx, 
# 231 "../crypto/cms/cms_kari.c" 3 4
                                    ((void *)0)
# 231 "../crypto/cms/cms_kari.c"
                                        , &outlen, in, inlen))
        goto err;
    out = CRYPTO_malloc(outlen, "../crypto/cms/cms_kari.c", 233);
    if (out == 
# 234 "../crypto/cms/cms_kari.c" 3 4
              ((void *)0)
# 234 "../crypto/cms/cms_kari.c"
                  )
        goto err;
 ...
 err:
    ...
    if (!rv)
        CRYPTO_free(out, "../crypto/cms/cms_kari.c", 245);
    EVP_CIPHER_CTX_reset(kari->ctx);

    EVP_PKEY_CTX_free(kari->pctx);
    kari->pctx = 
# 249 "../crypto/cms/cms_kari.c" 3 4
                ((void *)0)
# 249 "../crypto/cms/cms_kari.c"
                    ;
    return rv;
}
...
# 258 "../crypto/cms/cms_kari.c" 3 4
                           ((void *)0)
# 258 "../crypto/cms/cms_kari.c"
                               , *cek = 
# 258 "../crypto/cms/cms_kari.c" 3 4
                                        ((void *)0)
# 258 "../crypto/cms/cms_kari.c"
    ...
    CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_kari.c", 272);
    ec->key = cek;
    ec->keylen = ceklen;
    cek = 
# 275 "../crypto/cms/cms_kari.c" 3 4
         ((void *)0)
# 275 "../crypto/cms/cms_kari.c"
             ;
    rv = 1;
 err:
    CRYPTO_free(cek, "../crypto/cms/cms_kari.c", 278);
    return rv;
}
...
{
    EVP_PKEY_CTX *pctx = 
# 286 "../crypto/cms/cms_kari.c" 3 4
                        ((void *)0)
# 286 "../crypto/cms/cms_kari.c"
                            ;
    EVP_PKEY *ekey = 
# 287 "../crypto/cms/cms_kari.c" 3 4
                    ((void *)0)
# 287 "../crypto/cms/cms_kari.c"
                        ;
    int rv = 0;
    ...
    if (pctx == 
# 294 "../crypto/cms/cms_kari.c" 3 4
               ((void *)0)
# 294 "../crypto/cms/cms_kari.c"
                   )
        goto err;
    ...
    if (pctx == 
# 302 "../crypto/cms/cms_kari.c" 3 4
               ((void *)0)
# 302 "../crypto/cms/cms_kari.c"
                   )
        goto err;
...
{
    EVP_PKEY_CTX *pctx = 
# 319 "../crypto/cms/cms_kari.c" 3 4
                        ((void *)0)
# 319 "../crypto/cms/cms_kari.c"
                            ;
    int rv = 0;
    const CMS_CTX *ctx = kari->cms_ctx;
    ...
    if (pctx == 
# 326 "../crypto/cms/cms_kari.c" 3 4
               ((void *)0)
# 326 "../crypto/cms/cms_kari.c"
                   )
        goto err;
    if (EVP_PKEY_derive_init(pctx) <= 0)
         goto err;
                                     ...
                                     unsigned int flags, const CMS_CTX *ctx)
{
    CMS_KeyAgreeRecipientInfo *kari;
    CMS_RecipientEncryptedKey *rek = 
# 347 "../crypto/cms/cms_kari.c" 3 4
                                    ((void *)0)
# 347 "../crypto/cms/cms_kari.c"
                                        ;

    ri->d.kari = (CMS_KeyAgreeRecipientInfo *)ASN1_item_new((CMS_KeyAgreeRecipientInfo_it()));
    if (ri->d.kari == 
# 350 "../crypto/cms/cms_kari.c" 3 4
                     ((void *)0)
# 350 "../crypto/cms/cms_kari.c"
                         )
        return 0;
    ri->type = 1;
    ...
    if (rek == 
# 359 "../crypto/cms/cms_kari.c" 3 4
              ((void *)0)
# 359 "../crypto/cms/cms_kari.c"
                  )
        return 0;

    if (!OPENSSL_sk_push(ossl_check_CMS_RecipientEncryptedKey_sk_type(kari->recipientEncryptedKeys), ossl_check_CMS_RecipientEncryptedKey_type(rek))) {
        ASN1_item_free(((void*) (1 ? rek : (CMS_RecipientEncryptedKey*)0)), (CMS_RecipientEncryptedKey_it()));
        return 0;
    }
    ...
    if (flags & 0x10000) {
        ...
        if (rek->rid->d.rKeyId == 
# 370 "../crypto/cms/cms_kari.c" 3 4
                                 ((void *)0)
# 370 "../crypto/cms/cms_kari.c"
                                     )
            return 0;
    ...
    if (originatorPrivKey == 
# 380 "../crypto/cms/cms_kari.c" 3 4
                            ((void *)0) 
# 380 "../crypto/cms/cms_kari.c"
                                 && originator == 
# 380 "../crypto/cms/cms_kari.c" 3 4
                                                  ((void *)0)
# 380 "../crypto/cms/cms_kari.c"
        ...
        if (originatorPrivKey == 
# 388 "../crypto/cms/cms_kari.c" 3 4
                                ((void *)0) 
# 388 "../crypto/cms/cms_kari.c"
                                     || originator == 
# 388 "../crypto/cms/cms_kari.c" 3 4
                                                      ((void *)0)
# 388 "../crypto/cms/cms_kari.c"
        ...
        if (flags & 0x200000) {
             ...
             if (oik->d.subjectKeyIdentifier == 
# 394 "../crypto/cms/cms_kari.c" 3 4
                                               ((void *)0)
# 394 "../crypto/cms/cms_kari.c"
                                                   )
                  return 0;
                         ...
                         const EVP_CIPHER *cipher)
{
    ...
    if (kekcipher != 
# 426 "../crypto/cms/cms_kari.c" 3 4
                    ((void *)0)
# 426 "../crypto/cms/cms_kari.c"
                        ) {
        if (EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(ctx)) != 0x10002)
            return 0;
        return 1;
    }
    if (cipher == 
# 431 "../crypto/cms/cms_kari.c" 3 4
                 ((void *)0)
# 431 "../crypto/cms/cms_kari.c"
                     )
        return 0;
    keylen = EVP_CIPHER_get_key_length(cipher);
    if ((EVP_CIPHER_get_flags(cipher) & 0x4000000) != 0) {
        ret = EVP_CIPHER_meth_get_ctrl(cipher)(
# 435 "../crypto/cms/cms_kari.c" 3 4
                                              ((void *)0)
# 435 "../crypto/cms/cms_kari.c"
                                                  , 0x29,
                                               0, &kekcipher);
        if (ret <= 0)
             return 0;
        ...
        if (kekcipher != 
# 440 "../crypto/cms/cms_kari.c" 3 4
                        ((void *)0)
# 440 "../crypto/cms/cms_kari.c"
                            ) {
             if (EVP_CIPHER_get_mode(kekcipher) != 0x10002)
                 return 0;
    ...
    if (EVP_CIPHER_get_type(cipher) == 44)
        kekcipher_name = "id-smime-alg-CMS3DESwrap";
    else

    if (keylen <= 16)
        kekcipher_name = "id-aes128-wrap";
    else if (keylen <= 24)
        kekcipher_name = "id-aes192-wrap";
    else
        kekcipher_name = "id-aes256-wrap";
enc:
    fetched_kekcipher = EVP_CIPHER_fetch(ossl_cms_ctx_get0_libctx(cms_ctx),
                                         kekcipher_name,
                                         ossl_cms_ctx_get0_propq(cms_ctx));
    if (fetched_kekcipher == 
# 467 "../crypto/cms/cms_kari.c" 3 4
                            ((void *)0)
# 467 "../crypto/cms/cms_kari.c"
                                )
        return 0;
    ret = EVP_EncryptInit_ex(ctx, fetched_kekcipher, 
# 469 "../crypto/cms/cms_kari.c" 3 4
                                                    ((void *)0)
# 469 "../crypto/cms/cms_kari.c"
                                                        , 
# 469 "../crypto/cms/cms_kari.c" 3 4
                                                          ((void *)0)
# 469 "../crypto/cms/cms_kari.c"
                                        ...
                                        CMS_RecipientInfo *ri)
{
    ...
    if (ri->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",486,__func__), ERR_set_error)((46),(181),
# 486 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 486 "../crypto/cms/cms_kari.c"
       );
        return 0;
    }
    kari = ri->d.kari;
    ...
    if (kari->originator->type == -1) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_kari.c",510,__func__), ERR_set_error)((46),(196),
# 510 "../crypto/cms/cms_kari.c" 3 4
       ((void *)0)
# 510 "../crypto/cms/cms_kari.c"
       );
        return 0;
    }
