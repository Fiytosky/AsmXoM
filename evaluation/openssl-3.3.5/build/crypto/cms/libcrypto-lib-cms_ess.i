# 0 "../crypto/cms/cms_ess.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_ess.c"
# 10 "../crypto/cms/cms_ess.c"
...
# 21 "../crypto/cms/cms_ess.c" 2

CMS_ReceiptRequest *d2i_CMS_ReceiptRequest(CMS_ReceiptRequest **a, const unsigned char **in, long len) { return (CMS_ReceiptRequest *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (CMS_ReceiptRequest_it())); } int i2d_CMS_ReceiptRequest(const CMS_ReceiptRequest *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (CMS_ReceiptRequest_it())); } CMS_ReceiptRequest *CMS_ReceiptRequest_new(void) { return (CMS_ReceiptRequest *)ASN1_item_new((CMS_ReceiptRequest_it())); } void CMS_ReceiptRequest_free(CMS_ReceiptRequest *a) { ASN1_item_free((ASN1_VALUE *)a, (CMS_ReceiptRequest_it())); }
...
int CMS_get1_ReceiptRequest(CMS_SignerInfo *si, CMS_ReceiptRequest **prr)
{
    ...
    ASN1_OBJECT *obj = OBJ_nid2obj(212);

    if (prr != 
# 32 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 32 "../crypto/cms/cms_ess.c"
                  )
        *prr = 
# 33 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 33 "../crypto/cms/cms_ess.c"
                  ;
    str = CMS_signed_get0_data_by_OBJ(si, obj, -3, 16);
    if (str == 
# 35 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 35 "../crypto/cms/cms_ess.c"
                  )
        return 0;

    rr = ASN1_item_unpack(str, (CMS_ReceiptRequest_it()));
    if (rr == 
# 39 "../crypto/cms/cms_ess.c" 3 4
             ((void *)0)
# 39 "../crypto/cms/cms_ess.c"
                 )
        return -1;
    if (prr != 
# 41 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 41 "../crypto/cms/cms_ess.c"
                  )
        *prr = rr;
    else
                                                ...
                                                ESS_SIGNING_CERT **psc)
{
    ASN1_STRING *str;
    ESS_SIGNING_CERT *sc;
    ASN1_OBJECT *obj = OBJ_nid2obj(223);

    if (psc != 
# 59 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 59 "../crypto/cms/cms_ess.c"
                  )
        *psc = 
# 60 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 60 "../crypto/cms/cms_ess.c"
                  ;
    str = CMS_signed_get0_data_by_OBJ(si, obj, -3, 16);
    if (str == 
# 62 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 62 "../crypto/cms/cms_ess.c"
                  )
        return 0;

    sc = ASN1_item_unpack(str, (ESS_SIGNING_CERT_it()));
    if (sc == 
# 66 "../crypto/cms/cms_ess.c" 3 4
             ((void *)0)
# 66 "../crypto/cms/cms_ess.c"
                 )
        return -1;
    if (psc != 
# 68 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 68 "../crypto/cms/cms_ess.c"
                  )
        *psc = sc;
    else
                                                   ...
                                                   ESS_SIGNING_CERT_V2 **psc)
{
    ...
    ASN1_OBJECT *obj = OBJ_nid2obj(1086);

    if (psc != 
# 86 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 86 "../crypto/cms/cms_ess.c"
                  )
        *psc = 
# 87 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 87 "../crypto/cms/cms_ess.c"
                  ;
    str = CMS_signed_get0_data_by_OBJ(si, obj, -3, 16);
    if (str == 
# 89 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 89 "../crypto/cms/cms_ess.c"
                  )
        return 0;

    sc = ASN1_item_unpack(str, (ESS_SIGNING_CERT_V2_it()));
    if (sc == 
# 93 "../crypto/cms/cms_ess.c" 3 4
             ((void *)0)
# 93 "../crypto/cms/cms_ess.c"
                 )
        return -1;
    if (psc != 
# 95 "../crypto/cms/cms_ess.c" 3 4
              ((void *)0)
# 95 "../crypto/cms/cms_ess.c"
                  )
        *psc = sc;
    else
...
{
    ESS_SIGNING_CERT *ss = 
# 105 "../crypto/cms/cms_ess.c" 3 4
                          ((void *)0)
# 105 "../crypto/cms/cms_ess.c"
                              ;
    ESS_SIGNING_CERT_V2 *ssv2 = 
# 106 "../crypto/cms/cms_ess.c" 3 4
                               ((void *)0)
# 106 "../crypto/cms/cms_ess.c"
                                   ;
...
CMS_ReceiptRequest *CMS_ReceiptRequest_create0_ex(
    unsigned char *id, int idlen, int allorfirst,
    struct stack_st_GENERAL_NAMES *receiptList, struct stack_st_GENERAL_NAMES *receiptsTo,
    OSSL_LIB_CTX *libctx)
{
    CMS_ReceiptRequest *rr;
    ...
    if (rr == 
# 124 "../crypto/cms/cms_ess.c" 3 4
             ((void *)0)
# 124 "../crypto/cms/cms_ess.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",125,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 125 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 125 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    if (id)
...
# 131 "../crypto/cms/cms_ess.c" 3 4
                                                         ((void *)0)
# 131 "../crypto/cms/cms_ess.c"
                                                             , 32)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",132,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 132 "../crypto/cms/cms_ess.c" 3 4
           ((void *)0)
# 132 "../crypto/cms/cms_ess.c"
           );
            goto err;
        }
    ...
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(rr->receiptsTo),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));
    rr->receiptsTo = receiptsTo;

    if (receiptList != 
# 143 "../crypto/cms/cms_ess.c" 3 4
                      ((void *)0)
# 143 "../crypto/cms/cms_ess.c"
                          ) {
 ...
 err:
    CMS_ReceiptRequest_free(rr);
    return 
# 155 "../crypto/cms/cms_ess.c" 3 4
          ((void *)0)
# 155 "../crypto/cms/cms_ess.c"
              ;
    ...
    struct stack_st_GENERAL_NAMES *receiptList, struct stack_st_GENERAL_NAMES *receiptsTo)
{
    return CMS_ReceiptRequest_create0_ex(id, idlen, allorfirst, receiptList,
                                         receiptsTo, 
# 164 "../crypto/cms/cms_ess.c" 3 4
                                                    ((void *)0)
# 164 "../crypto/cms/cms_ess.c"
                                                        );
}
...
{
    unsigned char *rrder = 
# 169 "../crypto/cms/cms_ess.c" 3 4
                          ((void *)0)
# 169 "../crypto/cms/cms_ess.c"
                              ;
    int rrderlen, r = 0;

    rrderlen = i2d_CMS_ReceiptRequest(rr, &rrder);
    if (rrderlen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",174,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 174 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 174 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }

    if (!CMS_signed_add1_attr_by_NID(si, 212,
                                     16, rrder, rrderlen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",180,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 180 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 180 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
 ...
 err:
    CRYPTO_free(rrder, "../crypto/cms/cms_ess.c", 187);
...
{
    if (pcid != 
# 199 "../crypto/cms/cms_ess.c" 3 4
               ((void *)0)
# 199 "../crypto/cms/cms_ess.c"
                   )
        *pcid = rr->signedContentIdentifier;
    if (rr->receiptsFrom->type == 0) {
        if (pallorfirst != 
# 202 "../crypto/cms/cms_ess.c" 3 4
                          ((void *)0)
# 202 "../crypto/cms/cms_ess.c"
                              )
            *pallorfirst = (int)rr->receiptsFrom->d.allOrFirstTier;
        if (plist != 
# 204 "../crypto/cms/cms_ess.c" 3 4
                    ((void *)0)
# 204 "../crypto/cms/cms_ess.c"
                        )
            *plist = 
# 205 "../crypto/cms/cms_ess.c" 3 4
                    ((void *)0)
# 205 "../crypto/cms/cms_ess.c"
                        ;
    } else {
        if (pallorfirst != 
# 207 "../crypto/cms/cms_ess.c" 3 4
                          ((void *)0)
# 207 "../crypto/cms/cms_ess.c"
                              )
            *pallorfirst = -1;
        if (plist != 
# 209 "../crypto/cms/cms_ess.c" 3 4
                    ((void *)0)
# 209 "../crypto/cms/cms_ess.c"
                        )
            *plist = rr->receiptsFrom->d.receiptList;
    }
    if (prto != 
# 212 "../crypto/cms/cms_ess.c" 3 4
               ((void *)0)
# 212 "../crypto/cms/cms_ess.c"
                   )
        *prto = rr->receiptsTo;
}
...
{
    const EVP_MD *md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(si->digestAlgorithm->algorithm)));

    if (md == 
# 223 "../crypto/cms/cms_ess.c" 3 4
             ((void *)0)
# 223 "../crypto/cms/cms_ess.c"
                 )
        return 0;
    if (!ossl_asn1_item_digest_ex((CMS_Attributes_Verify_it()), md,
...
int ossl_cms_msgSigDigest_add1(CMS_SignerInfo *dest, CMS_SignerInfo *src)
{
    ...
    if (!cms_msgSigDigest(src, dig, &diglen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",241,__func__), ERR_set_error)((46),(172),
# 241 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 241 "../crypto/cms/cms_ess.c"
       );
        return 0;
    }
    if (!CMS_signed_add1_attr_by_NID(dest, 216,
                                     4, dig, diglen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",246,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 246 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 246 "../crypto/cms/cms_ess.c"
       );
        return 0;
    }
    return 1;
...
int ossl_cms_Receipt_verify(CMS_ContentInfo *cms, CMS_ContentInfo *req_cms)
{
    int r = 0, i;
    CMS_ReceiptRequest *rr = 
# 257 "../crypto/cms/cms_ess.c" 3 4
                            ((void *)0)
# 257 "../crypto/cms/cms_ess.c"
                                ;
    CMS_Receipt *rct = 
# 258 "../crypto/cms/cms_ess.c" 3 4
                      ((void *)0)
# 258 "../crypto/cms/cms_ess.c"
                          ;
    struct stack_st_CMS_SignerInfo *sis, *osis;
    CMS_SignerInfo *si, *osi = 
# 260 "../crypto/cms/cms_ess.c" 3 4
                              ((void *)0)
# 260 "../crypto/cms/cms_ess.c"
                                  ;
    ...
    if (OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sis)) != 1) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",273,__func__), ERR_set_error)((46),(164),
# 273 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 273 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }


    if (OBJ_obj2nid(CMS_get0_eContentType(cms)) != 204) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",279,__func__), ERR_set_error)((46),(165),
# 279 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 279 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (pcont == 
# 285 "../crypto/cms/cms_ess.c" 3 4
                ((void *)0) 
# 285 "../crypto/cms/cms_ess.c"
                     || *pcont == 
# 285 "../crypto/cms/cms_ess.c" 3 4
                                  ((void *)0)
# 285 "../crypto/cms/cms_ess.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",286,__func__), ERR_set_error)((46),(127),
# 286 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 286 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (!rct) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",293,__func__), ERR_set_error)((46),(169),
# 293 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 293 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(osis)); i++) {
        osi = ((CMS_SignerInfo *)OPENSSL_sk_value(ossl_check_const_CMS_SignerInfo_sk_type(osis), (i)));
        if (!ASN1_STRING_cmp(osi->signature, rct->originatorSignatureValue))
            break;
    }

    if (i == OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(osis))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",306,__func__), ERR_set_error)((46),(166),
# 306 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 306 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (!msig) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",320,__func__), ERR_set_error)((46),(167),
# 320 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 320 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }

    if (!cms_msgSigDigest(osi, dig, &diglen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",325,__func__), ERR_set_error)((46),(172),
# 325 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 325 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }

    if (diglen != (unsigned int)msig->length) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",330,__func__), ERR_set_error)((46),(163),
# 330 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 330 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }

    if (memcmp(dig, msig->data, diglen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",335,__func__), ERR_set_error)((46),(162),
# 335 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 335 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    octype = CMS_signed_get0_data_by_OBJ(osi,
                                         ...
                                         -3, 6);
    if (!octype) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",345,__func__), ERR_set_error)((46),(173),
# 345 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 345 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (OBJ_cmp(octype, rct->contentType)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",352,__func__), ERR_set_error)((46),(171),
# 352 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 352 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (CMS_get1_ReceiptRequest(osi, &rr) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",359,__func__), ERR_set_error)((46),(168),
# 359 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 359 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    if (ASN1_STRING_cmp(rr->signedContentIdentifier,
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",365,__func__), ERR_set_error)((46),(170),
# 365 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 365 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
 ...
 err:
    CMS_ReceiptRequest_free(rr);
    ASN1_item_free(((void*) (1 ? rct : (CMS_Receipt*)0)), (CMS_Receipt_it()));
    return r;
...
ASN1_OCTET_STRING *ossl_cms_encode_Receipt(CMS_SignerInfo *si)
{
    CMS_Receipt rct;
    CMS_ReceiptRequest *rr = 
# 386 "../crypto/cms/cms_ess.c" 3 4
                            ((void *)0)
# 386 "../crypto/cms/cms_ess.c"
                                ;
    ASN1_OBJECT *ctype;
    ASN1_OCTET_STRING *os = 
# 388 "../crypto/cms/cms_ess.c" 3 4
                           ((void *)0)
# 388 "../crypto/cms/cms_ess.c"
                               ;
    ...
    if (CMS_get1_ReceiptRequest(si, &rr) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",395,__func__), ERR_set_error)((46),(168),
# 395 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 395 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    ctype = CMS_signed_get0_data_by_OBJ(si,
                                        ...
                                        -3, 6);
    if (!ctype) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ess.c",405,__func__), ERR_set_error)((46),(173),
# 405 "../crypto/cms/cms_ess.c" 3 4
       ((void *)0)
# 405 "../crypto/cms/cms_ess.c"
       );
        goto err;
    }
    ...
    os = ASN1_item_pack(&rct, (CMS_Receipt_it()), 
# 414 "../crypto/cms/cms_ess.c" 3 4
                                                          ((void *)0)
# 414 "../crypto/cms/cms_ess.c"
                                                              );
