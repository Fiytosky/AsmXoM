# 0 "../crypto/cms/cms_io.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_io.c"
# 10 "../crypto/cms/cms_io.c"
...
int CMS_stream(unsigned char ***boundary, CMS_ContentInfo *cms)
{
    ...
    if (pos == 
# 23 "../crypto/cms/cms_io.c" 3 4
              ((void *)0)
# 23 "../crypto/cms/cms_io.c"
                  )
        return 0;
    if (*pos == 
# 25 "../crypto/cms/cms_io.c" 3 4
               ((void *)0)
# 25 "../crypto/cms/cms_io.c"
                   )
        *pos = ASN1_OCTET_STRING_new();
    if (*pos != 
# 27 "../crypto/cms/cms_io.c" 3 4
               ((void *)0)
# 27 "../crypto/cms/cms_io.c"
                   ) {
        (*pos)->flags |= 0x010;
        (*pos)->flags &= ~0x020;
        *boundary = &(*pos)->data;
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_io.c",33,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 33 "../crypto/cms/cms_io.c" 3 4
   ((void *)0)
# 33 "../crypto/cms/cms_io.c"
   );
    return 0;
}
...
# 40 "../crypto/cms/cms_io.c" 3 4
                                                    ((void *)0) 
# 40 "../crypto/cms/cms_io.c"
                                                         ? 
# 40 "../crypto/cms/cms_io.c" 3 4
                                                           ((void *)0) 
# 40 "../crypto/cms/cms_io.c"
    ...
    ci = ASN1_item_d2i_bio_ex((CMS_ContentInfo_it()), bp, cms,
                              ossl_cms_ctx_get0_libctx(ctx),
                              ossl_cms_ctx_get0_propq(ctx));
    if (ci != 
# 45 "../crypto/cms/cms_io.c" 3 4
             ((void *)0)
# 45 "../crypto/cms/cms_io.c"
                 ) {
        ERR_set_mark();
...
CMS_ContentInfo *PEM_read_bio_CMS(BIO *bp, CMS_ContentInfo **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read_bio((d2i_of_void *)d2i_CMS_ContentInfo, "CMS", bp, (void **)x, cb, u); } CMS_ContentInfo *PEM_read_CMS(FILE *fp, CMS_ContentInfo **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read((d2i_of_void *)d2i_CMS_ContentInfo, "CMS", fp, (void **)x, cb, u); } int PEM_write_bio_CMS(BIO *out, const CMS_ContentInfo *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_CMS_ContentInfo, "CMS", out, x, 
# 58 "../crypto/cms/cms_io.c" 3 4
((void *)0)
# 58 "../crypto/cms/cms_io.c"
,
# 58 "../crypto/cms/cms_io.c" 3 4
((void *)0)
# 58 "../crypto/cms/cms_io.c"
...
((void *)0)
# 58 "../crypto/cms/cms_io.c"
); } int PEM_write_CMS(FILE *out, const CMS_ContentInfo *x) { return PEM_ASN1_write((i2d_of_void *)i2d_CMS_ContentInfo, "CMS", out, x, 
# 58 "../crypto/cms/cms_io.c" 3 4
((void *)0)
# 58 "../crypto/cms/cms_io.c"
, 
...
int SMIME_write_CMS(BIO *bio, CMS_ContentInfo *cms, BIO *data, int flags)
{
    ...
    if (ctype_nid == 22)
        ...
        mdalgs = 
# 91 "../crypto/cms/cms_io.c" 3 4
                ((void *)0)
# 91 "../crypto/cms/cms_io.c"
                    ;
                                   ...
                                   CMS_ContentInfo **cms)
{
    CMS_ContentInfo *ci;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(cms == 
# 104 "../crypto/cms/cms_io.c" 3 4
                                                    ((void *)0) 
# 104 "../crypto/cms/cms_io.c"
                                                         ? 
# 104 "../crypto/cms/cms_io.c" 3 4
                                                           ((void *)0) 
# 104 "../crypto/cms/cms_io.c"
    ...
    ci = (CMS_ContentInfo *)SMIME_read_ASN1_ex(bio, flags, bcont,
                                               ...
                                               ossl_cms_ctx_get0_propq(ctx));
    if (ci != 
# 111 "../crypto/cms/cms_io.c" 3 4
             ((void *)0)
# 111 "../crypto/cms/cms_io.c"
                 ) {
        ERR_set_mark();
        ossl_cms_resolve_libctx(ci);
        ERR_pop_to_mark();
...
CMS_ContentInfo *SMIME_read_CMS(BIO *bio, BIO **bcont)
{
    return SMIME_read_CMS_ex(bio, 0, bcont, 
# 121 "../crypto/cms/cms_io.c" 3 4
                                           ((void *)0)
# 121 "../crypto/cms/cms_io.c"
                                               );
}
