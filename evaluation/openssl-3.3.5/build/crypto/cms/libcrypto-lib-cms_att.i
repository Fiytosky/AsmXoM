# 0 "../crypto/cms/cms_att.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_att.c"
# 10 "../crypto/cms/cms_att.c"
...
# 15 "../crypto/cms/cms_att.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../crypto/cms/cms_att.c" 2
...
# 18 "../crypto/cms/cms_att.c" 2
# 39 "../crypto/cms/cms_att.c"
static const struct {
    int nid;
    int flags;
                                      ...
                                      int *lastpos)
{
    ...
    if (loc < 0)
        return 
# 220 "../crypto/cms/cms_att.c" 3 4
              ((void *)0)
# 220 "../crypto/cms/cms_att.c"
                  ;
                               ...
                               int have_attrs)
{
    ...
    if (at != 
# 234 "../crypto/cms/cms_att.c" 3 4
             ((void *)0)
# 234 "../crypto/cms/cms_att.c"
                 ) {
        ...
        if (((flags & type) == 0)
            ...
            || (((flags & 0x20) != 0)
                && cms_attrib_get(nid, attrs, &lastpos) != 
# 241 "../crypto/cms/cms_att.c" 3 4
                                                          ((void *)0)
# 241 "../crypto/cms/cms_att.c"
                                                              )
...
int ossl_cms_si_check_attributes(const CMS_SignerInfo *si)
{
    ...
    for (i = 0; i < (int)(sizeof(cms_attribute_properties)/sizeof((cms_attribute_properties)[0])); ++i) {
        int nid = cms_attribute_properties[i].nid;
        int flags = cms_attribute_properties[i].flags;

        if (!cms_check_attribute(nid, flags, 0x01,
                                 si->signedAttrs, have_signed_attrs)
            || !cms_check_attribute(nid, flags, 0x02,
                                    si->unsignedAttrs, have_unsigned_attrs)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_att.c",282,__func__), ERR_set_error)((46),(161),
# 282 "../crypto/cms/cms_att.c" 3 4
           ((void *)0)
# 282 "../crypto/cms/cms_att.c"
           );
            return 0;
        }
    }
