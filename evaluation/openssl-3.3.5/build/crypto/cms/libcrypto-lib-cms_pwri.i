# 0 "../crypto/cms/cms_pwri.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_pwri.c"
# 10 "../crypto/cms/cms_pwri.c"
                                    ...
                                    unsigned char *pass, ssize_t passlen)
{
    CMS_PasswordRecipientInfo *pwri;
    if (ri->type != 3) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",27,__func__), ERR_set_error)((46),(177),
# 27 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 27 "../crypto/cms/cms_pwri.c"
       );
        return 0;
    }
                                               ...
                                               const EVP_CIPHER *kekciph)
{
    ...
    CMS_RecipientInfo *ri = 
# 47 "../crypto/cms/cms_pwri.c" 3 4
                           ((void *)0)
# 47 "../crypto/cms/cms_pwri.c"
                               ;
    CMS_EncryptedContentInfo *ec;
    CMS_PasswordRecipientInfo *pwri;
    EVP_CIPHER_CTX *ctx = 
# 50 "../crypto/cms/cms_pwri.c" 3 4
                         ((void *)0)
# 50 "../crypto/cms/cms_pwri.c"
                             ;
    X509_ALGOR *encalg = 
# 51 "../crypto/cms/cms_pwri.c" 3 4
                        ((void *)0)
# 51 "../crypto/cms/cms_pwri.c"
                            ;
    unsigned char iv[16];
    int ivlen;
    ...
    if (ec == 
# 57 "../crypto/cms/cms_pwri.c" 3 4
             ((void *)0)
# 57 "../crypto/cms/cms_pwri.c"
                 )
        return 
# 58 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 58 "../crypto/cms/cms_pwri.c"
                  ;
    ris = CMS_get0_RecipientInfos(cms);
    if (ris == 
# 60 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 60 "../crypto/cms/cms_pwri.c"
                  )
        return 
# 61 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 61 "../crypto/cms/cms_pwri.c"
                  ;
    ...
    if (kekciph == 
# 70 "../crypto/cms/cms_pwri.c" 3 4
                  ((void *)0)
# 70 "../crypto/cms/cms_pwri.c"
                      )
        kekciph = ec->cipher;

    if (kekciph == 
# 73 "../crypto/cms/cms_pwri.c" 3 4
                  ((void *)0)
# 73 "../crypto/cms/cms_pwri.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",74,__func__), ERR_set_error)((46),(126),
# 74 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 74 "../crypto/cms/cms_pwri.c"
       );
        return 
# 75 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 75 "../crypto/cms/cms_pwri.c"
                  ;
    }
    if (wrap_nid != 893) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",78,__func__), ERR_set_error)((46),(179),
# 78 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 78 "../crypto/cms/cms_pwri.c"
       );
        return 
# 79 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 79 "../crypto/cms/cms_pwri.c"
                  ;
    }
    ...
    if (encalg == 
# 84 "../crypto/cms/cms_pwri.c" 3 4
                 ((void *)0)
# 84 "../crypto/cms/cms_pwri.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",85,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 85 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 85 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ctx = EVP_CIPHER_CTX_new();
    if (ctx == 
# 89 "../crypto/cms/cms_pwri.c" 3 4
              ((void *)0)
# 89 "../crypto/cms/cms_pwri.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",90,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 90 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 90 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }

    if (EVP_EncryptInit_ex(ctx, kekciph, 
# 94 "../crypto/cms/cms_pwri.c" 3 4
                                        ((void *)0)
# 94 "../crypto/cms/cms_pwri.c"
                                            , 
# 94 "../crypto/cms/cms_pwri.c" 3 4
                                              ((void *)0)
# 94 "../crypto/cms/cms_pwri.c"
...
# 94 "../crypto/cms/cms_pwri.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",95,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 95 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 95 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (ivlen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",101,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 101 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 101 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
...
# 108 "../crypto/cms/cms_pwri.c" 3 4
                                   ((void *)0)
# 108 "../crypto/cms/cms_pwri.c"
                                       , 
# 108 "../crypto/cms/cms_pwri.c" 3 4
                                         ((void *)0)
# 108 "../crypto/cms/cms_pwri.c"
...
# 108 "../crypto/cms/cms_pwri.c"
                                                   , iv) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",109,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 109 "../crypto/cms/cms_pwri.c" 3 4
           ((void *)0)
# 109 "../crypto/cms/cms_pwri.c"
           );
            goto err;
        }
        encalg->parameter = ASN1_TYPE_new();
        if (!encalg->parameter) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",114,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 114 "../crypto/cms/cms_pwri.c" 3 4
           ((void *)0)
# 114 "../crypto/cms/cms_pwri.c"
           );
            goto err;
        }
        if (EVP_CIPHER_param_to_asn1(ctx, encalg->parameter) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",118,__func__), ERR_set_error)((46),(102),
# 118 "../crypto/cms/cms_pwri.c" 3 4
           ((void *)0)
# 118 "../crypto/cms/cms_pwri.c"
           );
            goto err;
        }
    }

    encalg->algorithm = OBJ_nid2obj(EVP_CIPHER_get_type(EVP_CIPHER_CTX_get0_cipher(ctx)));

    EVP_CIPHER_CTX_free(ctx);
    ctx = 
# 126 "../crypto/cms/cms_pwri.c" 3 4
         ((void *)0)
# 126 "../crypto/cms/cms_pwri.c"
             ;


    ri = (CMS_RecipientInfo *)ASN1_item_new((CMS_RecipientInfo_it()));
    if (ri == 
# 130 "../crypto/cms/cms_pwri.c" 3 4
             ((void *)0)
# 130 "../crypto/cms/cms_pwri.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",131,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 131 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 131 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (ri->d.pwri == 
# 136 "../crypto/cms/cms_pwri.c" 3 4
                     ((void *)0)
# 136 "../crypto/cms/cms_pwri.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",137,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 137 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 137 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ri->type = 3;
...
# 147 "../crypto/cms/cms_pwri.c" 3 4
                                       ((void *)0)
# 147 "../crypto/cms/cms_pwri.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",148,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 148 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 148 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
...
# 153 "../crypto/cms/cms_pwri.c" 3 4
                                                  ((void *)0)
# 153 "../crypto/cms/cms_pwri.c"
                                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",154,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 154 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 154 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (!ASN1_item_pack(encalg, (X509_ALGOR_it()),
                        ...
                        value.sequence)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",161,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 161 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 161 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    pwri->keyEncryptionAlgorithm->parameter->type = 16;

    X509_ALGOR_free(encalg);
    encalg = 
# 167 "../crypto/cms/cms_pwri.c" 3 4
            ((void *)0)
# 167 "../crypto/cms/cms_pwri.c"
                ;



    pwri->keyDerivationAlgorithm = PKCS5_pbkdf2_set_ex(iter, 
# 171 "../crypto/cms/cms_pwri.c" 3 4
                                                            ((void *)0)
# 171 "../crypto/cms/cms_pwri.c"
                                                                , 0, -1, -1,
                                                       cms_ctx->libctx);

    if (pwri->keyDerivationAlgorithm == 
# 174 "../crypto/cms/cms_pwri.c" 3 4
                                       ((void *)0)
# 174 "../crypto/cms/cms_pwri.c"
                                           )
        goto err;
    ...
    if (!OPENSSL_sk_push(ossl_check_CMS_RecipientInfo_sk_type(ris), ossl_check_CMS_RecipientInfo_type(ri))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",181,__func__), ERR_set_error)((46),((15 | (0x2 << 18L))),
# 181 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 181 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
 ...
 err:
    ...
    X509_ALGOR_free(encalg);
    return 
# 192 "../crypto/cms/cms_pwri.c" 3 4
          ((void *)0)
# 192 "../crypto/cms/cms_pwri.c"
              ;
                          ...
                          EVP_CIPHER_CTX *ctx)
{
    ...
    if ((tmp = CRYPTO_malloc(inlen, "../crypto/cms/cms_pwri.c", 220)) == 
# 220 "../crypto/cms/cms_pwri.c" 3 4
                                        ((void *)0)
# 220 "../crypto/cms/cms_pwri.c"
                                            )
        return 0;
...
# 236 "../crypto/cms/cms_pwri.c" 3 4
                                   ((void *)0)
# 236 "../crypto/cms/cms_pwri.c"
                                       , 
# 236 "../crypto/cms/cms_pwri.c" 3 4
                                         ((void *)0)
# 236 "../crypto/cms/cms_pwri.c"
...
# 236 "../crypto/cms/cms_pwri.c"
    ...
    *outlen = (size_t)tmp[0];
    ...
    rv = 1;
 err:
    CRYPTO_clear_free(tmp, inlen, "../crypto/cms/cms_pwri.c", 253);
    return rv;
...
# 314 "../crypto/cms/cms_pwri.c" 3 4
                                 ((void *)0)
# 314 "../crypto/cms/cms_pwri.c"
                                     ;
    EVP_CIPHER_CTX *kekctx = 
# 315 "../crypto/cms/cms_pwri.c" 3 4
                            ((void *)0)
# 315 "../crypto/cms/cms_pwri.c"
                                ;
    char name[50];
    EVP_CIPHER *kekcipher;
    unsigned char *key = 
# 318 "../crypto/cms/cms_pwri.c" 3 4
                        ((void *)0)
# 318 "../crypto/cms/cms_pwri.c"
                            ;
    size_t keylen;
    const CMS_CTX *cms_ctx = ossl_cms_get0_cmsctx(cms);
    ...
    if (pwri->pass == 
# 326 "../crypto/cms/cms_pwri.c" 3 4
                     ((void *)0)
# 326 "../crypto/cms/cms_pwri.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",327,__func__), ERR_set_error)((46),(178),
# 327 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 327 "../crypto/cms/cms_pwri.c"
       );
        return 0;
    }
    algtmp = pwri->keyEncryptionAlgorithm;

    if (!algtmp || OBJ_obj2nid(algtmp->algorithm) != 893) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",333,__func__), ERR_set_error)((46),(179),
# 333 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 333 "../crypto/cms/cms_pwri.c"
       );
        return 0;
    }
    ...
    if (kekalg == 
# 340 "../crypto/cms/cms_pwri.c" 3 4
                 ((void *)0)
# 340 "../crypto/cms/cms_pwri.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",341,__func__), ERR_set_error)((46),(176),
# 341 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 341 "../crypto/cms/cms_pwri.c"
       );
        return 0;
    }
    ...
    if (kekcipher == 
# 349 "../crypto/cms/cms_pwri.c" 3 4
                    ((void *)0)
# 349 "../crypto/cms/cms_pwri.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",350,__func__), ERR_set_error)((46),(148),
# 350 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 350 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (kekctx == 
# 355 "../crypto/cms/cms_pwri.c" 3 4
                 ((void *)0)
# 355 "../crypto/cms/cms_pwri.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",356,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 356 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 356 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }

    if (!EVP_CipherInit_ex(kekctx, kekcipher, 
# 360 "../crypto/cms/cms_pwri.c" 3 4
                                             ((void *)0)
# 360 "../crypto/cms/cms_pwri.c"
                                                 , 
# 360 "../crypto/cms/cms_pwri.c" 3 4
                                                   ((void *)0)
# 360 "../crypto/cms/cms_pwri.c"
...
# 360 "../crypto/cms/cms_pwri.c"
    ...
    if (EVP_CIPHER_asn1_to_param(kekctx, kekalg->parameter) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",364,__func__), ERR_set_error)((46),(102),
# 364 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 364 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (EVP_PBE_CipherInit_ex(algtmp->algorithm,
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",376,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 376 "../crypto/cms/cms_pwri.c" 3 4
       ((void *)0)
# 376 "../crypto/cms/cms_pwri.c"
       );
        goto err;
    }
    ...
    if (en_de) {
        ...
        if (!kek_wrap_key(
# 384 "../crypto/cms/cms_pwri.c" 3 4
                         ((void *)0)
# 384 "../crypto/cms/cms_pwri.c"
                             , &keylen, ec->key, ec->keylen, kekctx, cms_ctx))
            goto err;

        key = CRYPTO_malloc(keylen, "../crypto/cms/cms_pwri.c", 387);

        if (key == 
# 389 "../crypto/cms/cms_pwri.c" 3 4
                  ((void *)0)
# 389 "../crypto/cms/cms_pwri.c"
                      )
            goto err;
        ...
        key = CRYPTO_malloc(pwri->encryptedKey->length, "../crypto/cms/cms_pwri.c", 397);
        if (key == 
# 398 "../crypto/cms/cms_pwri.c" 3 4
                  ((void *)0)
# 398 "../crypto/cms/cms_pwri.c"
                      )
            goto err;
        if (!kek_unwrap_key(key, &keylen,
                            pwri->encryptedKey->data,
                            pwri->encryptedKey->length, kekctx)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_pwri.c",403,__func__), ERR_set_error)((46),(180),
# 403 "../crypto/cms/cms_pwri.c" 3 4
           ((void *)0)
# 403 "../crypto/cms/cms_pwri.c"
           );
            goto err;
        }

        CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_pwri.c", 407);
        ec->key = key;
        ec->keylen = keylen;
 ...
 err:
    ...
    if (!r)
        CRYPTO_free(key, "../crypto/cms/cms_pwri.c", 420);
