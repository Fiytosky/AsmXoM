# 0 "../crypto/cms/cms_dh.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_dh.c"
# 10 "../crypto/cms/cms_dh.c"
...
# 26 "../crypto/cms/cms_dh.c" 3 4
                              ((void *)0)
# 26 "../crypto/cms/cms_dh.c"
                                  ;
    int rv = 0;
    EVP_PKEY *pkpeer = 
# 28 "../crypto/cms/cms_dh.c" 3 4
                      ((void *)0)
# 28 "../crypto/cms/cms_dh.c"
                          , *pk = 
# 28 "../crypto/cms/cms_dh.c" 3 4
                                  ((void *)0)
# 28 "../crypto/cms/cms_dh.c"
                                      ;
    BIGNUM *bnpub = 
# 29 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 29 "../crypto/cms/cms_dh.c"
                       ;
    const unsigned char *p;
    unsigned char *buf = 
# 31 "../crypto/cms/cms_dh.c" 3 4
                        ((void *)0)
# 31 "../crypto/cms/cms_dh.c"
                            ;
    int plen;

    X509_ALGOR_get0(&aoid, &atype, &aval, alg);
    if (OBJ_obj2nid(aoid) != 920)
        goto err;
    ...
    if (pk == 
# 42 "../crypto/cms/cms_dh.c" 3 4
             ((void *)0) 
# 42 "../crypto/cms/cms_dh.c"
                  || !EVP_PKEY_is_a(pk, "DHX"))
        goto err;
    ...
    if (p == 
# 48 "../crypto/cms/cms_dh.c" 3 4
            ((void *)0) 
# 48 "../crypto/cms/cms_dh.c"
                 || plen == 0)
        goto err;

    if ((public_key = d2i_ASN1_INTEGER(
# 51 "../crypto/cms/cms_dh.c" 3 4
                                      ((void *)0)
# 51 "../crypto/cms/cms_dh.c"
                                          , &p, plen)) == 
# 51 "../crypto/cms/cms_dh.c" 3 4
                                                          ((void *)0)
# 51 "../crypto/cms/cms_dh.c"
    ...
    if ((bnpub = ASN1_INTEGER_to_BN(public_key, 
# 58 "../crypto/cms/cms_dh.c" 3 4
                                               ((void *)0)
# 58 "../crypto/cms/cms_dh.c"
                                                   )) == 
# 58 "../crypto/cms/cms_dh.c" 3 4
                                                         ((void *)0)
# 58 "../crypto/cms/cms_dh.c"
        ...
        goto err;
    if ((buf = CRYPTO_malloc(plen, "../crypto/cms/cms_dh.c", 60)) == 
# 60 "../crypto/cms/cms_dh.c" 3 4
                                       ((void *)0)
# 60 "../crypto/cms/cms_dh.c"
                                           )
        goto err;
    ...
    pkpeer = EVP_PKEY_new();
    if (pkpeer == 
# 66 "../crypto/cms/cms_dh.c" 3 4
                 ((void *)0)
            
# 67 "../crypto/cms/cms_dh.c"
 ...
 err:
    ...
    BN_free(bnpub);
    CRYPTO_free(buf, "../crypto/cms/cms_dh.c", 76);
...
# 84 "../crypto/cms/cms_dh.c" 3 4
                              ((void *)0)
# 84 "../crypto/cms/cms_dh.c"
                                  ;
    ASN1_OCTET_STRING *ukm;
    const unsigned char *p;
    unsigned char *dukm = 
# 87 "../crypto/cms/cms_dh.c" 3 4
                         ((void *)0)
# 87 "../crypto/cms/cms_dh.c"
                             ;
    size_t dukmlen = 0;
    int keylen, plen;
    EVP_CIPHER *kekcipher = 
# 90 "../crypto/cms/cms_dh.c" 3 4
                           ((void *)0)
# 90 "../crypto/cms/cms_dh.c"
                               ;
    ...
    if (OBJ_obj2nid(alg->algorithm) != 245) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_dh.c",102,__func__), ERR_set_error)((46),(186),
# 102 "../crypto/cms/cms_dh.c" 3 4
       ((void *)0)
# 102 "../crypto/cms/cms_dh.c"
       );
        goto err;
    }

    if (EVP_PKEY_CTX_set_dh_kdf_type(pctx, 2) <= 0
...
# 115 "../crypto/cms/cms_dh.c" 3 4
                           ((void *)0)
# 115 "../crypto/cms/cms_dh.c"
                               , &p, plen);
    if (kekalg == 
# 116 "../crypto/cms/cms_dh.c" 3 4
                 ((void *)0)
# 116 "../crypto/cms/cms_dh.c"
                     )
        goto err;
    kekctx = CMS_RecipientInfo_kari_get0_ctx(ri);
    if (kekctx == 
# 119 "../crypto/cms/cms_dh.c" 3 4
                 ((void *)0)
# 119 "../crypto/cms/cms_dh.c"
                     )
        goto err;
    ...
    if (kekcipher == 
# 126 "../crypto/cms/cms_dh.c" 3 4
                    ((void *)0)
        
# 127 "../crypto/cms/cms_dh.c"
       || EVP_CIPHER_get_mode(kekcipher) != 0x10002)
        goto err;
    if (!EVP_EncryptInit_ex(kekctx, kekcipher, 
# 129 "../crypto/cms/cms_dh.c" 3 4
                                              ((void *)0)
# 129 "../crypto/cms/cms_dh.c"
                                                  , 
# 129 "../crypto/cms/cms_dh.c" 3 4
                                                    ((void *)0)
# 129 "../crypto/cms/cms_dh.c"
...
# 129 "../crypto/cms/cms_dh.c"
    ...
    if (ukm != 
# 143 "../crypto/cms/cms_dh.c" 3 4
              ((void *)0)
# 143 "../crypto/cms/cms_dh.c"
                  ) {
        dukmlen = ASN1_STRING_length(ukm);
        dukm = CRYPTO_memdup((ASN1_STRING_get0_data(ukm)), dukmlen, "../crypto/cms/cms_dh.c", 145);
        if (dukm == 
# 146 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 146 "../crypto/cms/cms_dh.c"
                       )
            goto err;
    }
    ...
    if (EVP_PKEY_CTX_set0_dh_kdf_ukm(pctx, dukm, dukmlen) <= 0)
        goto err;
    dukm = 
# 152 "../crypto/cms/cms_dh.c" 3 4
          ((void *)0)
# 152 "../crypto/cms/cms_dh.c"
              ;
 ...
 err:
    ...
    CRYPTO_free(dukm, "../crypto/cms/cms_dh.c", 158);
    return rv;
}
...
static int dh_cms_decrypt(CMS_RecipientInfo *ri)
{
    ...
    if (pctx == 
# 166 "../crypto/cms/cms_dh.c" 3 4
               ((void *)0)
# 166 "../crypto/cms/cms_dh.c"
                   )
        return 0;
...
# 174 "../crypto/cms/cms_dh.c" 3 4
                                                ((void *)0)
# 174 "../crypto/cms/cms_dh.c"
                                                    , 
# 174 "../crypto/cms/cms_dh.c" 3 4
                                                      ((void *)0)
# 174 "../crypto/cms/cms_dh.c"
...
# 174 "../crypto/cms/cms_dh.c"
            ...
            return 0;
        if (alg == 
# 176 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0) 
# 176 "../crypto/cms/cms_dh.c"
                        || pubkey == 
# 176 "../crypto/cms/cms_dh.c" 3 4
                                     ((void *)0)
# 176 "../crypto/cms/cms_dh.c"
        ...
        if (!dh_cms_set_peerkey(pctx, alg, pubkey)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_dh.c",179,__func__), ERR_set_error)((46),(188),
# 179 "../crypto/cms/cms_dh.c" 3 4
           ((void *)0)
# 179 "../crypto/cms/cms_dh.c"
           );
            return 0;
        }
    }
    ...
    if (!dh_cms_set_shared_info(pctx, ri)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_dh.c",185,__func__), ERR_set_error)((46),(189),
# 185 "../crypto/cms/cms_dh.c" 3 4
       ((void *)0)
# 185 "../crypto/cms/cms_dh.c"
       );
        return 0;
    }
    return 1;
...
# 197 "../crypto/cms/cms_dh.c" 3 4
                                 ((void *)0)
# 197 "../crypto/cms/cms_dh.c"
                                     ;
    const ASN1_OBJECT *aoid;
    ASN1_BIT_STRING *pubkey;
    ...
    ASN1_OCTET_STRING *ukm;
    unsigned char *penc = 
# 202 "../crypto/cms/cms_dh.c" 3 4
                         ((void *)0)
# 202 "../crypto/cms/cms_dh.c"
                             , *dukm = 
# 202 "../crypto/cms/cms_dh.c" 3 4
                                       ((void *)0)
# 202 "../crypto/cms/cms_dh.c"
    ...
    if (pctx == 
# 210 "../crypto/cms/cms_dh.c" 3 4
               ((void *)0)
# 210 "../crypto/cms/cms_dh.c"
                   )
        return 0;
...
# 215 "../crypto/cms/cms_dh.c" 3 4
                                            ((void *)0)
# 215 "../crypto/cms/cms_dh.c"
                                                , 
# 215 "../crypto/cms/cms_dh.c" 3 4
                                                  ((void *)0)
# 215 "../crypto/cms/cms_dh.c"
...
# 219 "../crypto/cms/cms_dh.c" 3 4
                          ((void *)0)
# 219 "../crypto/cms/cms_dh.c"
                              , 
# 219 "../crypto/cms/cms_dh.c" 3 4
                                ((void *)0)
# 219 "../crypto/cms/cms_dh.c"
    ...
    if (aoid == OBJ_nid2obj(0)) {
        BIGNUM *bn_pub_key = 
# 221 "../crypto/cms/cms_dh.c" 3 4
                            ((void *)0)
# 221 "../crypto/cms/cms_dh.c"
                                ;
        ASN1_INTEGER *pubk;

        if (!EVP_PKEY_get_bn_param(pkey, "pub", &bn_pub_key))
            goto err;

        pubk = BN_to_ASN1_INTEGER(bn_pub_key, 
# 227 "../crypto/cms/cms_dh.c" 3 4
                                             ((void *)0)
# 227 "../crypto/cms/cms_dh.c"
                                                 );
        BN_free(bn_pub_key);
        if (pubk == 
# 229 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 229 "../crypto/cms/cms_dh.c"
                       )
            goto err;
        ...
        penc = 
# 240 "../crypto/cms/cms_dh.c" 3 4
              ((void *)0)
# 240 "../crypto/cms/cms_dh.c"
                  ;
        (void)X509_ALGOR_set0(talg, OBJ_nid2obj(920),
                              -1, 
# 242 "../crypto/cms/cms_dh.c" 3 4
                                           ((void *)0)
# 242 "../crypto/cms/cms_dh.c"
                                               );
    }
    ...
    if (kdf_type == 1) {
        ...
        goto err;
    if (kdf_md == 
# 257 "../crypto/cms/cms_dh.c" 3 4
                 ((void *)0)
# 257 "../crypto/cms/cms_dh.c"
                     ) {

        kdf_md = EVP_sha1();
        if (EVP_PKEY_CTX_set_dh_kdf_md(pctx, kdf_md) <= 0)
            goto err;
    } else if (EVP_MD_get_type(kdf_md) != 64)
    ...
    if (wrap_alg == 
# 279 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 279 "../crypto/cms/cms_dh.c"
                       )
        goto err;
    wrap_alg->algorithm = OBJ_nid2obj(wrap_nid);
    wrap_alg->parameter = ASN1_TYPE_new();
    if (wrap_alg->parameter == 
# 283 "../crypto/cms/cms_dh.c" 3 4
                              ((void *)0)
# 283 "../crypto/cms/cms_dh.c"
                                  )
        goto err;
    ...
    if (ASN1_TYPE_get(wrap_alg->parameter) == 0) {
        ...
        wrap_alg->parameter = 
# 289 "../crypto/cms/cms_dh.c" 3 4
                             ((void *)0)
# 289 "../crypto/cms/cms_dh.c"
                                 ;
    }
    ...
    if (ukm != 
# 295 "../crypto/cms/cms_dh.c" 3 4
              ((void *)0)
# 295 "../crypto/cms/cms_dh.c"
                  ) {
        dukmlen = ASN1_STRING_length(ukm);
        dukm = CRYPTO_memdup((ASN1_STRING_get0_data(ukm)), dukmlen, "../crypto/cms/cms_dh.c", 297);
        if (dukm == 
# 298 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 298 "../crypto/cms/cms_dh.c"
                       )
            goto err;
    }
    ...
    if (EVP_PKEY_CTX_set0_dh_kdf_ukm(pctx, dukm, dukmlen) <= 0)
        goto err;
    dukm = 
# 304 "../crypto/cms/cms_dh.c" 3 4
          ((void *)0)
# 304 "../crypto/cms/cms_dh.c"
              ;
    ...
    penc = 
# 310 "../crypto/cms/cms_dh.c" 3 4
          ((void *)0)
# 310 "../crypto/cms/cms_dh.c"
              ;
    ...
    if (wrap_str == 
# 315 "../crypto/cms/cms_dh.c" 3 4
                   ((void *)0)
# 315 "../crypto/cms/cms_dh.c"
                       )
        goto err;
    ASN1_STRING_set0(wrap_str, penc, penclen);
    penc = 
# 318 "../crypto/cms/cms_dh.c" 3 4
          ((void *)0)
# 318 "../crypto/cms/cms_dh.c"
              ;
    rv = X509_ALGOR_set0(talg, OBJ_nid2obj(245),
                         16, wrap_str);
    if (!rv)
        ASN1_STRING_free(wrap_str);

 err:
    CRYPTO_free(penc, "../crypto/cms/cms_dh.c", 325);
    X509_ALGOR_free(wrap_alg);
    CRYPTO_free(dukm, "../crypto/cms/cms_dh.c", 327);
    return rv;
}
...
# 333 "../crypto/cms/cms_dh.c" 3 4
   ((void) (0))
# 333 "../crypto/cms/cms_dh.c"
                                       ;
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_dh.c",341,__func__), ERR_set_error)((46),(125),
# 341 "../crypto/cms/cms_dh.c" 3 4
   ((void *)0)
# 341 "../crypto/cms/cms_dh.c"
   );
    return 0;
}
