# 0 "../crypto/cms/cms_smime.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_smime.c"
# 10 "../crypto/cms/cms_smime.c"
...
static BIO *cms_get_text_bio(BIO *out, unsigned int flags)
{
    ...
    if (out == 
# 23 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 23 "../crypto/cms/cms_smime.c"
                  )
        rbio = BIO_new(BIO_s_null());
    else if (flags & 0x1) {
        rbio = BIO_new(BIO_s_mem());
        BIO_ctrl(rbio,130,0,
# 27 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 27 "../crypto/cms/cms_smime.c"
       );
    } else
        rbio = out;
    return rbio;
...
static int cms_copy_content(BIO *out, BIO *in, unsigned int flags)
{
    ...
    if (tmpout == 
# 41 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
# 41 "../crypto/cms/cms_smime.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",42,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 42 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 42 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    ...
    for (;;) {
        ...
        if (i <= 0) {
            if (BIO_method_type(in) == (10|0x0200)) {
                if (BIO_ctrl(in,113,0,
# 51 "../crypto/cms/cms_smime.c" 3 4
                   ((void *)0)
# 51 "../crypto/cms/cms_smime.c"
                   ) <= 0)
                    goto err;
            }
            if (i < 0)
        ...
        if (tmpout != 
# 59 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0) 
# 59 "../crypto/cms/cms_smime.c"
    ...
    if (flags & 0x1) {
        if (!SMIME_text(tmpout, out)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",65,__func__), ERR_set_error)((46),(140),
# 65 "../crypto/cms/cms_smime.c" 3 4
           ((void *)0)
# 65 "../crypto/cms/cms_smime.c"
           );
            goto err;
        }
    }
...
static int check_content(CMS_ContentInfo *cms)
{
    ...
    if (pos == 
# 82 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0) 
# 82 "../crypto/cms/cms_smime.c"
                   || *pos == 
# 82 "../crypto/cms/cms_smime.c" 3 4
                              ((void *)0)
# 82 "../crypto/cms/cms_smime.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",83,__func__), ERR_set_error)((46),(127),
# 83 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 83 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }
    return 1;
...
{
    if (upto != 
# 91 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 91 "../crypto/cms/cms_smime.c"
                   ) {
        BIO *tbio;
...
# 98 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0) 
# 98 "../crypto/cms/cms_smime.c"
                          && f != upto);
    } else {
        BIO_free_all(f);
    }
...
int CMS_data(CMS_ContentInfo *cms, BIO *out, unsigned int flags)
{
    ...
    if (OBJ_obj2nid(CMS_get0_type(cms)) != 21) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",110,__func__), ERR_set_error)((46),(143),
# 110 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 110 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }
    cont = CMS_dataInit(cms, 
# 113 "../crypto/cms/cms_smime.c" 3 4
                            ((void *)0)
# 113 "../crypto/cms/cms_smime.c"
                                );
    if (cont == 
# 114 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 114 "../crypto/cms/cms_smime.c"
                   )
        return 0;
                                    ...
                                    OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (cms == 
# 126 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 126 "../crypto/cms/cms_smime.c"
                  )
        return 
# 127 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 127 "../crypto/cms/cms_smime.c"
                  ;

    if ((flags & 0x1000) || CMS_final(cms, in, 
# 129 "../crypto/cms/cms_smime.c" 3 4
                                                  ((void *)0)
# 129 "../crypto/cms/cms_smime.c"
                                                      , flags))
        return cms;

    CMS_ContentInfo_free(cms);
    return 
# 133 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 133 "../crypto/cms/cms_smime.c"
              ;
}

CMS_ContentInfo *CMS_data_create(BIO *in, unsigned int flags)
{
    return CMS_data_create_ex(in, flags, 
# 138 "../crypto/cms/cms_smime.c" 3 4
                                        ((void *)0)
# 138 "../crypto/cms/cms_smime.c"
                                            , 
# 138 "../crypto/cms/cms_smime.c" 3 4
                                              ((void *)0)
# 138 "../crypto/cms/cms_smime.c"
                      ...
                      unsigned int flags)
{
    ...
    if (OBJ_obj2nid(CMS_get0_type(cms)) != 25) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",148,__func__), ERR_set_error)((46),(144),
# 148 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 148 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }

    if (dcont == 
# 152 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 152 "../crypto/cms/cms_smime.c"
                     && !check_content(cms))
        return 0;

    cont = CMS_dataInit(cms, dcont);
    if (cont == 
# 156 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 156 "../crypto/cms/cms_smime.c"
                   )
        return 0;
                                      ...
                                      const char *propq)
{
    ...
    if (md == 
# 176 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0)
# 176 "../crypto/cms/cms_smime.c"
                 )
        md = EVP_sha1();
    cms = ossl_cms_DigestedData_create(md, ctx, propq);
    if (cms == 
# 179 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 179 "../crypto/cms/cms_smime.c"
                  )
        return 
# 180 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 180 "../crypto/cms/cms_smime.c"
                  ;
    ...
    if ((flags & 0x1000) || CMS_final(cms, in, 
# 185 "../crypto/cms/cms_smime.c" 3 4
                                                  ((void *)0)
# 185 "../crypto/cms/cms_smime.c"
                                                      , flags))
        return cms;

    CMS_ContentInfo_free(cms);
    return 
# 189 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 189 "../crypto/cms/cms_smime.c"
              ;
}
...
CMS_ContentInfo *CMS_digest_create(BIO *in, const EVP_MD *md,
                                   unsigned int flags)
{
    return CMS_digest_create_ex(in, md, flags, 
# 195 "../crypto/cms/cms_smime.c" 3 4
                                              ((void *)0)
# 195 "../crypto/cms/cms_smime.c"
                                                  , 
# 195 "../crypto/cms/cms_smime.c" 3 4
                                                    ((void *)0)
# 195 "../crypto/cms/cms_smime.c"
                              ...
                              BIO *dcont, BIO *out, unsigned int flags)
{
    ...
    if (OBJ_obj2nid(CMS_get0_type(cms)) != 26) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",206,__func__), ERR_set_error)((46),(145),
# 206 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 206 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }

    if (dcont == 
# 210 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 210 "../crypto/cms/cms_smime.c"
                     && !check_content(cms))
        return 0;

    if (CMS_EncryptedData_set1_key(cms, 
# 213 "../crypto/cms/cms_smime.c" 3 4
                                       ((void *)0)
# 213 "../crypto/cms/cms_smime.c"
                                           , key, keylen) <= 0)
        return 0;
    cont = CMS_dataInit(cms, dcont);
    if (cont == 
# 216 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 216 "../crypto/cms/cms_smime.c"
                   )
        return 0;
    r = cms_copy_content(out, cont, flags);
    do_free_upto(cont, dcont);
                                              ...
                                              const char *propq)
{
    ...
    if (cipher == 
# 231 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
# 231 "../crypto/cms/cms_smime.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",232,__func__), ERR_set_error)((46),(126),
# 232 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 232 "../crypto/cms/cms_smime.c"
       );
        return 
# 233 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 233 "../crypto/cms/cms_smime.c"
                  ;
    }
    cms = CMS_ContentInfo_new_ex(libctx, propq);
    if (cms == 
# 236 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 236 "../crypto/cms/cms_smime.c"
                  )
        return 
# 237 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 237 "../crypto/cms/cms_smime.c"
                  ;
    ...
    if ((flags & (0x1000 | 0x4000))
        || CMS_final(cms, in, 
# 245 "../crypto/cms/cms_smime.c" 3 4
                             ((void *)0)
# 245 "../crypto/cms/cms_smime.c"
                                 , flags))
        return cms;
 ...
 err:
    CMS_ContentInfo_free(cms);
    return 
# 250 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 250 "../crypto/cms/cms_smime.c"
              ;
}
...
# 257 "../crypto/cms/cms_smime.c" 3 4
                                                                       ((void *)0)
# 257 "../crypto/cms/cms_smime.c"
                                                                           ,
                                        
# 258 "../crypto/cms/cms_smime.c" 3 4
                                       ((void *)0)
# 258 "../crypto/cms/cms_smime.c"
                                           );
}
                                      ...
                                      const CMS_CTX *cms_ctx)
{
    ...
    if (ctx == 
# 274 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 274 "../crypto/cms/cms_smime.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",275,__func__), ERR_set_error)((46),((11 | (0x2 << 18L))),
# 275 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 275 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    CMS_SignerInfo_get0_algs(si, 
# 278 "../crypto/cms/cms_smime.c" 3 4
                                ((void *)0)
# 278 "../crypto/cms/cms_smime.c"
                                    , &signer, 
# 278 "../crypto/cms/cms_smime.c" 3 4
                                               ((void *)0)
# 278 "../crypto/cms/cms_smime.c"
...
# 278 "../crypto/cms/cms_smime.c"
    ...
    if (!X509_STORE_CTX_init(ctx, store, signer, untrusted)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",280,__func__), ERR_set_error)((46),(141),
# 280 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 280 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    X509_STORE_CTX_set_default(ctx, "smime_sign");
    if (crls != 
# 284 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 284 "../crypto/cms/cms_smime.c"
                   )
    ...
    if (i <= 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",290,__func__), ERR_set_error)(46, 100,
    ...
    if (chain != 
# 297 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0)
# 297 "../crypto/cms/cms_smime.c"
                    )
               ...
               X509_STORE *store, BIO *dcont, BIO *out, unsigned int flags)
{
    ...
    struct stack_st_X509 *cms_certs = 
# 311 "../crypto/cms/cms_smime.c" 3 4
                               ((void *)0)
# 311 "../crypto/cms/cms_smime.c"
                                   ;
    struct stack_st_X509_CRL *crls = 
# 312 "../crypto/cms/cms_smime.c" 3 4
                              ((void *)0)
# 312 "../crypto/cms/cms_smime.c"
                                  ;
    struct stack_st_X509 **si_chains = 
# 313 "../crypto/cms/cms_smime.c" 3 4
                                ((void *)0)
# 313 "../crypto/cms/cms_smime.c"
                                    ;
    X509 *signer;
    int i, scount = 0, ret = 0;
    BIO *cmsbio = 
# 316 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
# 316 "../crypto/cms/cms_smime.c"
                     , *tmpin = 
# 316 "../crypto/cms/cms_smime.c" 3 4
                                ((void *)0)
# 316 "../crypto/cms/cms_smime.c"
...
# 316 "../crypto/cms/cms_smime.c"
                                                    ;
    int cadesVerify = (flags & 0x100000) != 0;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(cms);

    if (dcont == 
# 320 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 320 "../crypto/cms/cms_smime.c"
                     && !check_content(cms))
        return 0;
    if (dcont != 
# 322 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 322 "../crypto/cms/cms_smime.c"
                     && !(flags & 0x80)) {
        const ASN1_OBJECT *coid = CMS_get0_eContentType(cms);

        if (OBJ_obj2nid(coid) == 787)
            flags |= 0x80000;
    }
    ...
    if (OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sinfos)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",334,__func__), ERR_set_error)((46),(135),
# 334 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 334 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sinfos)); i++) {
        ...
        CMS_SignerInfo_get0_algs(si, 
# 340 "../crypto/cms/cms_smime.c" 3 4
                                    ((void *)0)
# 340 "../crypto/cms/cms_smime.c"
                                        , &signer, 
# 340 "../crypto/cms/cms_smime.c" 3 4
                                                   ((void *)0)
# 340 "../crypto/cms/cms_smime.c"
...
# 340 "../crypto/cms/cms_smime.c"
        ...
        if (signer != 
# 341 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 341 "../crypto/cms/cms_smime.c"
                         )
            scount++;
    }

    if (scount != OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sinfos)))
        scount += CMS_set1_signers_certs(cms, certs, flags);

    if (scount != OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sinfos))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",349,__func__), ERR_set_error)((46),(138),
# 349 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 349 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    ...
    if ((flags & 0x20) == 0 || cadesVerify) {
        if (cadesVerify) {

            si_chains = CRYPTO_zalloc(scount * sizeof(si_chains[0]), "../crypto/cms/cms_smime.c", 359);
            if (si_chains == 
# 360 "../crypto/cms/cms_smime.c" 3 4
                            ((void *)0)
# 360 "../crypto/cms/cms_smime.c"
                                )
                goto err;
        }
        ...
        for (i = 0; i < scount; i++) {
            ...
            if (!cms_signerinfo_verify_cert(si, store, cms_certs, crls,
                                            si_chains ? &si_chains[i] : 
# 370 "../crypto/cms/cms_smime.c" 3 4
                                                                       ((void *)0)
# 370 "../crypto/cms/cms_smime.c"
                                                                           ,
                                            ctx))
                goto err;
        }
    ...
    if ((flags & 0x8) == 0 || cadesVerify) {
        for (i = 0; i < scount; i++) {
            ...
            if (CMS_SignerInfo_verify(si) <= 0)
                goto err;
            if (cadesVerify) {
                struct stack_st_X509 *si_chain = si_chains ? si_chains[i] : 
# 386 "../crypto/cms/cms_smime.c" 3 4
                                                                     ((void *)0)
# 386 "../crypto/cms/cms_smime.c"
                                                                         ;
...
# 401 "../crypto/cms/cms_smime.c"
    if (dcont != 
# 401 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 401 "../crypto/cms/cms_smime.c"
        ...
        len = BIO_ctrl(dcont,3,0,(char *)(&ptr));
        tmpin = (len == 0) ? dcont : BIO_new_mem_buf(ptr, len);
        if (tmpin == 
# 407 "../crypto/cms/cms_smime.c" 3 4
                    ((void *)0)
# 407 "../crypto/cms/cms_smime.c"
                        ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",408,__func__), ERR_set_error)((46),((32 | (0x2 << 18L))),
# 408 "../crypto/cms/cms_smime.c" 3 4
           ((void *)0)
# 408 "../crypto/cms/cms_smime.c"
           );
            goto err2;
        }
    } else {
    ...
    if (!(flags & 0x80) && dcont) {
        ...
        tmpout = cms_get_text_bio(out, flags);
        if (tmpout == 
# 424 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 424 "../crypto/cms/cms_smime.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",425,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 425 "../crypto/cms/cms_smime.c" 3 4
           ((void *)0)
# 425 "../crypto/cms/cms_smime.c"
           );
            goto err;
        }
        cmsbio = CMS_dataInit(cms, tmpout);
        if (cmsbio == 
# 429 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 429 "../crypto/cms/cms_smime.c"
                         )
            goto err;
        ...
        if (!SMIME_crlf_copy(dcont, cmsbio, flags & ~0x1))
            goto err;

        if (flags & 0x1) {
            if (!SMIME_text(tmpout, out)) {
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",440,__func__), ERR_set_error)((46),(140),
# 440 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 440 "../crypto/cms/cms_smime.c"
               );
                goto err;
            }
        }
        ...
        if (cmsbio == 
# 446 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 446 "../crypto/cms/cms_smime.c"
                         )
            goto err;
    ...
    if (!(flags & 0x4)) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_SignerInfo_sk_type(sinfos)); i++) {
            ...
            if (CMS_SignerInfo_verify_content(si, cmsbio) <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",457,__func__), ERR_set_error)((46),(109),
# 457 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 457 "../crypto/cms/cms_smime.c"
               );
                goto err;
            }
        }
 ...
 err2:
    if (si_chains != 
# 480 "../crypto/cms/cms_smime.c" 3 4
                    ((void *)0)
# 480 "../crypto/cms/cms_smime.c"
                        ) {
        for (i = 0; i < scount; ++i)
            OSSL_STACK_OF_X509_free(si_chains[i]);
        CRYPTO_free(si_chains, "../crypto/cms/cms_smime.c", 483);
    }
    OSSL_STACK_OF_X509_free(cms_certs);
    OPENSSL_sk_pop_free(ossl_check_X509_CRL_sk_type(crls),ossl_check_X509_CRL_freefunc_type(X509_CRL_free));
                       ...
                       X509_STORE *store, unsigned int flags)
{
    ...
    flags &= ~(0x40 | 0x1);
    r = CMS_verify(rcms, certs, store, 
# 498 "../crypto/cms/cms_smime.c" 3 4
                                      ((void *)0)
# 498 "../crypto/cms/cms_smime.c"
                                          , 
# 498 "../crypto/cms/cms_smime.c" 3 4
                                            ((void *)0)
# 498 "../crypto/cms/cms_smime.c"
                             ...
                             const char *propq)
{
    ...
    cms = CMS_ContentInfo_new_ex(libctx, propq);
    if (cms == 
# 513 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0) 
# 513 "../crypto/cms/cms_smime.c"
                   || !CMS_SignedData_init(cms)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",514,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 514 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 514 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    if (flags & 0x80000
        && !CMS_set1_eContentType(cms,
                                  OBJ_nid2obj(787))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",520,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 520 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 520 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }

    if (pkey != 
# 524 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0) 
# 524 "../crypto/cms/cms_smime.c"
                    && !CMS_add1_signer(cms, signcert, pkey, 
# 524 "../crypto/cms/cms_smime.c" 3 4
                                                             ((void *)0)
# 524 "../crypto/cms/cms_smime.c"
                                                                 , flags)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",525,__func__), ERR_set_error)((46),(99),
# 525 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 525 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));

        if (!CMS_add1_cert(cms, x)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",533,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 533 "../crypto/cms/cms_smime.c" 3 4
           ((void *)0)
# 533 "../crypto/cms/cms_smime.c"
           );
            goto err;
        }
    }
    ...
    if ((flags & (0x1000 | 0x4000))
        || CMS_final(cms, data, 
# 542 "../crypto/cms/cms_smime.c" 3 4
                               ((void *)0)
# 542 "../crypto/cms/cms_smime.c"
                                   , flags))
        return cms;
    else
        goto err;
 ...
 err:
    CMS_ContentInfo_free(cms);
    return 
# 549 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 549 "../crypto/cms/cms_smime.c"
              ;
}
...
{
    return CMS_sign_ex(signcert, pkey, certs, data, flags, 
# 555 "../crypto/cms/cms_smime.c" 3 4
                                                          ((void *)0)
# 555 "../crypto/cms/cms_smime.c"
                                                              , 
# 555 "../crypto/cms/cms_smime.c" 3 4
                                                                ((void *)0)
# 555 "../crypto/cms/cms_smime.c"
                                  ...
                                  struct stack_st_X509 *certs, unsigned int flags)
{
    ...
    CMS_ContentInfo *cms = 
# 563 "../crypto/cms/cms_smime.c" 3 4
                          ((void *)0)
# 563 "../crypto/cms/cms_smime.c"
                              ;
    ASN1_OCTET_STRING **pos, *os = 
# 564 "../crypto/cms/cms_smime.c" 3 4
                                  ((void *)0)
# 564 "../crypto/cms/cms_smime.c"
                                      ;
    BIO *rct_cont = 
# 565 "../crypto/cms/cms_smime.c" 3 4
                   ((void *)0)
# 565 "../crypto/cms/cms_smime.c"
                       ;
    int r = 0;
    ...
    flags |= 0x4000 | 0x80 | 0x40;
    if (pkey == 
# 572 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0) 
# 572 "../crypto/cms/cms_smime.c"
                    || signcert == 
# 572 "../crypto/cms/cms_smime.c" 3 4
                                   ((void *)0)
# 572 "../crypto/cms/cms_smime.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",573,__func__), ERR_set_error)((46),(174),
# 573 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 573 "../crypto/cms/cms_smime.c"
       );
        return 
# 574 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 574 "../crypto/cms/cms_smime.c"
                  ;
    }
    ...
    cms = CMS_sign_ex(
# 579 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 579 "../crypto/cms/cms_smime.c"
                         , 
# 579 "../crypto/cms/cms_smime.c" 3 4
                           ((void *)0)
# 579 "../crypto/cms/cms_smime.c"
...
# 579 "../crypto/cms/cms_smime.c"
    ...
    if (cms == 
# 582 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 582 "../crypto/cms/cms_smime.c"
                  )
        goto err;


    if (!CMS_set1_eContentType(cms, OBJ_nid2obj(204)))
        goto err;

    rct_si = CMS_add1_signer(cms, signcert, pkey, 
# 589 "../crypto/cms/cms_smime.c" 3 4
                                                 ((void *)0)
# 589 "../crypto/cms/cms_smime.c"
                                                     , flags);
    if (!rct_si) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",591,__func__), ERR_set_error)((46),(99),
# 591 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 591 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    ...
    if (os == 
# 596 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0)
# 596 "../crypto/cms/cms_smime.c"
                 )
        goto err;
    ...
    if (rct_cont == 
# 601 "../crypto/cms/cms_smime.c" 3 4
                   ((void *)0)
# 601 "../crypto/cms/cms_smime.c"
                       )
        goto err;
    ...
    if (!CMS_final(cms, rct_cont, 
# 610 "../crypto/cms/cms_smime.c" 3 4
                                 ((void *)0)
# 610 "../crypto/cms/cms_smime.c"
                                     , flags))
        goto err;
    ...
    if (pos == 
# 615 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 615 "../crypto/cms/cms_smime.c"
                  )
        goto err;
    *pos = os;
 ...
 err:
    ...
    return 
# 627 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 627 "../crypto/cms/cms_smime.c"
              ;

}

CMS_ContentInfo *CMS_encrypt_ex(struct stack_st_X509 *certs, BIO *data,
                                const EVP_CIPHER *cipher, unsigned int flags,
                                OSSL_LIB_CTX *libctx, const char *propq)
{
    CMS_ContentInfo *cms;
    ...
    cms = (EVP_CIPHER_get_flags(cipher) & 0x200000)
          ? CMS_AuthEnvelopedData_create_ex(cipher, libctx, propq)
          : CMS_EnvelopedData_create_ex(cipher, libctx, propq);
    if (cms == 
# 643 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0)
# 643 "../crypto/cms/cms_smime.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",644,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 644 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 644 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        recip = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));
        if (!CMS_add1_recipient_cert(cms, recip, flags)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",650,__func__), ERR_set_error)((46),(137),
# 650 "../crypto/cms/cms_smime.c" 3 4
           ((void *)0)
# 650 "../crypto/cms/cms_smime.c"
           );
            goto err;
        }
    }
    ...
    if ((flags & (0x1000 | 0x4000))
        || CMS_final(cms, data, 
# 659 "../crypto/cms/cms_smime.c" 3 4
                               ((void *)0)
# 659 "../crypto/cms/cms_smime.c"
                                   , flags))
        return cms;
    else
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",662,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 662 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 662 "../crypto/cms/cms_smime.c"
       );

 err:
    CMS_ContentInfo_free(cms);
    return 
# 666 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 666 "../crypto/cms/cms_smime.c"
              ;
}

CMS_ContentInfo *CMS_encrypt(struct stack_st_X509 *certs, BIO *data,
                             const EVP_CIPHER *cipher, unsigned int flags)
{
    return CMS_encrypt_ex(certs, data, cipher, flags, 
# 672 "../crypto/cms/cms_smime.c" 3 4
                                                     ((void *)0)
# 672 "../crypto/cms/cms_smime.c"
                                                         , 
# 672 "../crypto/cms/cms_smime.c" 3 4
                                                           ((void *)0)
# 672 "../crypto/cms/cms_smime.c"
...
{
    int i;
    struct stack_st_CMS_RecipientEncryptedKey *reks;
    CMS_RecipientEncryptedKey *rek;

    reks = CMS_RecipientInfo_kari_get0_reks(ri);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientEncryptedKey_sk_type(reks)); i++) {
        int rv;

        rek = ((CMS_RecipientEncryptedKey *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientEncryptedKey_sk_type(reks), (i)));
        if (cert != 
# 688 "../crypto/cms/cms_smime.c" 3 4
                   ((void *)0) 
# 688 "../crypto/cms/cms_smime.c"
                        && CMS_RecipientEncryptedKey_cert_cmp(rek, cert))
            continue;
        CMS_RecipientInfo_kari_set0_pkey_and_peer(ri, pk, peer);
        rv = CMS_RecipientInfo_kari_decrypt(cms, ri, rek);
        CMS_RecipientInfo_kari_set0_pkey(ri, 
# 692 "../crypto/cms/cms_smime.c" 3 4
                                            ((void *)0)
# 692 "../crypto/cms/cms_smime.c"
                                                );
        if (rv > 0)
            return 1;
        return cert == 
# 695 "../crypto/cms/cms_smime.c" 3 4
                      ((void *)0) 
# 695 "../crypto/cms/cms_smime.c"
                           ? 0 : -1;
    }
    return 0;
}
...
int CMS_decrypt_set1_pkey(CMS_ContentInfo *cms, EVP_PKEY *pk, X509 *cert)
{
     return CMS_decrypt_set1_pkey_and_peer(cms, pk, cert, 
# 702 "../crypto/cms/cms_smime.c" 3 4
                                                         ((void *)0)
# 702 "../crypto/cms/cms_smime.c"
                                                             );
}
                                   ...
                                   X509 *cert, X509 *peer)
{
    ...
    if (ec != 
# 715 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0)
# 715 "../crypto/cms/cms_smime.c"
                 ) {
        CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_smime.c", 716);
        ec->key = 
# 717 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
# 717 "../crypto/cms/cms_smime.c"
                     ;
        ec->keylen = 0;
    }

    if (ris != 
# 721 "../crypto/cms/cms_smime.c" 3 4
              ((void *)0) 
# 721 "../crypto/cms/cms_smime.c"
                   && ec != 
# 721 "../crypto/cms/cms_smime.c" 3 4
                            ((void *)0)
# 721 "../crypto/cms/cms_smime.c"
    ...
    if (cms_pkey_ri_type == -1) {
         (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",726,__func__), ERR_set_error)((46),(125),
# 726 "../crypto/cms/cms_smime.c" 3 4
        ((void *)0)
# 726 "../crypto/cms/cms_smime.c"
        );
         return 0;
    }
...
# 746 "../crypto/cms/cms_smime.c" 3 4
                        ((void *)0) 
# 746 "../crypto/cms/cms_smime.c"
                             || !CMS_RecipientInfo_ktri_cert_cmp(ri, cert)) {
            EVP_PKEY_up_ref(pk);
            CMS_RecipientInfo_set0_pkey(ri, pk);
            r = CMS_RecipientInfo_decrypt(cms, ri);
            CMS_RecipientInfo_set0_pkey(ri, 
# 750 "../crypto/cms/cms_smime.c" 3 4
                                           ((void *)0)
# 750 "../crypto/cms/cms_smime.c"
                                               );
            if (cert != 
# 751 "../crypto/cms/cms_smime.c" 3 4
                       ((void *)0)
# 751 "../crypto/cms/cms_smime.c"
                           ) {
                ...
                if (r > 0)
                    return 1;
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",762,__func__), ERR_set_error)((46),(112),
# 762 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 762 "../crypto/cms/cms_smime.c"
               );
                return 0;
            }
            ...
            else if (r > 0 && (debug || cms_pkey_ri_type != 0))
                return 1;
        }
    }

    if (cert == 
# 775 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
        
# 776 "../crypto/cms/cms_smime.c"
       && cms_pkey_ri_type == 0
        && match_ri
        && !debug) {
        ERR_clear_error();
    ...
    if (!match_ri)
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",784,__func__), ERR_set_error)((46),(132),
# 784 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 784 "../crypto/cms/cms_smime.c"
       );
    return 0;
                         ...
                         const unsigned char *id, size_t idlen)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(ris)); i++) {
        ri = ((CMS_RecipientInfo *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientInfo_sk_type(ris), (i)));
        if (CMS_RecipientInfo_type(ri) != 2)
            continue;


        if (id == 
# 804 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
                
# 805 "../crypto/cms/cms_smime.c"
               || (CMS_RecipientInfo_kekri_id_cmp(ri, id, idlen) == 0)) {
            match_ri = 1;
            CMS_RecipientInfo_set0_key(ri, key, keylen);
            r = CMS_RecipientInfo_decrypt(cms, ri);
            CMS_RecipientInfo_set0_key(ri, 
# 809 "../crypto/cms/cms_smime.c" 3 4
                                          ((void *)0)
# 809 "../crypto/cms/cms_smime.c"
                                              , 0);
            if (r > 0)
                return 1;
            if (id != 
# 812 "../crypto/cms/cms_smime.c" 3 4
                     ((void *)0)
# 812 "../crypto/cms/cms_smime.c"
                         ) {
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",813,__func__), ERR_set_error)((46),(112),
# 813 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 813 "../crypto/cms/cms_smime.c"
               );
                return 0;
            }
            ERR_clear_error();
    ...
    if (!match_ri)
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",821,__func__), ERR_set_error)((46),(132),
# 821 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 821 "../crypto/cms/cms_smime.c"
       );
    return 0;
                              ...
                              unsigned char *pass, ssize_t passlen)
{
    ...
    if (ec != 
# 835 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0)
# 835 "../crypto/cms/cms_smime.c"
                 ) {
        CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_smime.c", 836);
        ec->key = 
# 837 "../crypto/cms/cms_smime.c" 3 4
                 ((void *)0)
# 837 "../crypto/cms/cms_smime.c"
                     ;
        ec->keylen = 0;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(ris)); i++) {
        ri = ((CMS_RecipientInfo *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientInfo_sk_type(ris), (i)));
        if (CMS_RecipientInfo_type(ri) != 3)
            continue;
        ...
        r = CMS_RecipientInfo_decrypt(cms, ri);
        CMS_RecipientInfo_set0_password(ri, 
# 850 "../crypto/cms/cms_smime.c" 3 4
                                           ((void *)0)
# 850 "../crypto/cms/cms_smime.c"
                                               , 0);
        if (r > 0)
            return 1;
    }
    ...
    if (!match_ri)
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",856,__func__), ERR_set_error)((46),(132),
# 856 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 856 "../crypto/cms/cms_smime.c"
       );
    return 0;
                ...
                BIO *dcont, BIO *out, unsigned int flags)
{
    ...
    if (nid != 23
            && nid != 1059) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",871,__func__), ERR_set_error)((46),(146),
# 871 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 871 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }
    if (dcont == 
# 874 "../crypto/cms/cms_smime.c" 3 4
                ((void *)0) 
# 874 "../crypto/cms/cms_smime.c"
                     && !check_content(cms))
        return 0;
    ec = ossl_cms_get0_env_enc_content(cms);
    ec->debug = (flags & 0x20000) != 0;
    ec->havenocert = cert == 
# 878 "../crypto/cms/cms_smime.c" 3 4
                            ((void *)0)
# 878 "../crypto/cms/cms_smime.c"
                                ;
    if (pk == 
# 879 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0) 
# 879 "../crypto/cms/cms_smime.c"
                  && cert == 
# 879 "../crypto/cms/cms_smime.c" 3 4
                             ((void *)0) 
# 879 "../crypto/cms/cms_smime.c"
...
# 879 "../crypto/cms/cms_smime.c"
        ...
        return 1;
    if (pk != 
# 881 "../crypto/cms/cms_smime.c" 3 4
             ((void *)0) 
# 881 "../crypto/cms/cms_smime.c"
                  && !CMS_decrypt_set1_pkey(cms, pk, cert))
        return 0;
    cont = CMS_dataInit(cms, dcont);
    if (cont == 
# 884 "../crypto/cms/cms_smime.c" 3 4
               ((void *)0)
# 884 "../crypto/cms/cms_smime.c"
                   )
        return 0;
    r = cms_copy_content(out, cont, flags);
    do_free_upto(cont, dcont);
...
# 896 "../crypto/cms/cms_smime.c" 3 4
                                              ((void *)0)
# 896 "../crypto/cms/cms_smime.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",897,__func__), ERR_set_error)((46),(104),
# 897 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 897 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }
    ...
    (void)(int)BIO_ctrl(cmsbio,11,0,
# 905 "../crypto/cms/cms_smime.c" 3 4
         ((void *)0)
# 905 "../crypto/cms/cms_smime.c"
         );

    if (!CMS_dataFinal(cms, cmsbio)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",908,__func__), ERR_set_error)((46),(103),
# 908 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 908 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
                     ...
                     BIO *dcont, unsigned int flags)
{
    ...
    if ((cmsbio = CMS_dataInit(cms, dcont)) == 
# 928 "../crypto/cms/cms_smime.c" 3 4
                                              ((void *)0)
# 928 "../crypto/cms/cms_smime.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",929,__func__), ERR_set_error)((46),(104),
# 929 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 929 "../crypto/cms/cms_smime.c"
       );
        return 0;
    }

    (void)(int)BIO_ctrl(cmsbio,11,0,
# 933 "../crypto/cms/cms_smime.c" 3 4
         ((void *)0)
# 933 "../crypto/cms/cms_smime.c"
         );

    if (!ossl_cms_DataFinal(cms, cmsbio, md, mdlen)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",936,__func__), ERR_set_error)((46),(103),
# 936 "../crypto/cms/cms_smime.c" 3 4
       ((void *)0)
# 936 "../crypto/cms/cms_smime.c"
       );
        goto err;
    }
    ret = 1;
...
# 992 "../crypto/cms/cms_smime.c"
int CMS_uncompress(CMS_ContentInfo *cms, BIO *dcont, BIO *out,
                   unsigned int flags)
{
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",995,__func__), ERR_set_error)((46),(151),
# 995 "../crypto/cms/cms_smime.c" 3 4
   ((void *)0)
# 995 "../crypto/cms/cms_smime.c"
   );
    return 0;
}
...
CMS_ContentInfo *CMS_compress(BIO *in, int comp_nid, unsigned int flags)
{
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_smime.c",1001,__func__), ERR_set_error)((46),(151),
# 1001 "../crypto/cms/cms_smime.c" 3 4
   ((void *)0)
# 1001 "../crypto/cms/cms_smime.c"
   );
    return 
# 1002 "../crypto/cms/cms_smime.c" 3 4
          ((void *)0)
# 1002 "../crypto/cms/cms_smime.c"
              ;
}
