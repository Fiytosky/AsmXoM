# 0 "../crypto/cms/cms_env.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_env.c"
# 10 "../crypto/cms/cms_env.c"
...
static int cms_get_enveloped_type(const CMS_ContentInfo *cms)
{
    ...
    if (ret == 0)
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",50,__func__), ERR_set_error)((46),(107),
# 50 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 50 "../crypto/cms/cms_env.c"
       );
    return ret;
}
...
CMS_EnvelopedData *ossl_cms_get0_enveloped(CMS_ContentInfo *cms)
{
    if (OBJ_obj2nid(cms->contentType) != 23) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",57,__func__), ERR_set_error)((46),(107),
# 57 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 57 "../crypto/cms/cms_env.c"
       );
        return 
# 58 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 58 "../crypto/cms/cms_env.c"
                  ;
    }
...
CMS_AuthEnvelopedData *ossl_cms_get0_auth_enveloped(CMS_ContentInfo *cms)
{
    if (OBJ_obj2nid(cms->contentType) != 1059) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",66,__func__), ERR_set_error)((46),(107),
# 66 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 66 "../crypto/cms/cms_env.c"
       );
        return 
# 67 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 67 "../crypto/cms/cms_env.c"
                  ;
    }
...
{
    if (cms->d.other == 
# 74 "../crypto/cms/cms_env.c" 3 4
                       ((void *)0)
# 74 "../crypto/cms/cms_env.c"
                           ) {
        cms->d.envelopedData = (CMS_EnvelopedData *)ASN1_item_new((CMS_EnvelopedData_it()));
        if (cms->d.envelopedData == 
# 76 "../crypto/cms/cms_env.c" 3 4
                                   ((void *)0)
# 76 "../crypto/cms/cms_env.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",77,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 77 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 77 "../crypto/cms/cms_env.c"
           );
            return 
# 78 "../crypto/cms/cms_env.c" 3 4
                  ((void *)0)
# 78 "../crypto/cms/cms_env.c"
                      ;
        }
        ...
        cms->contentType = OBJ_nid2obj(23);
        return cms->d.envelopedData;
    }
...
{
    if (cms->d.other == 
# 93 "../crypto/cms/cms_env.c" 3 4
                       ((void *)0)
# 93 "../crypto/cms/cms_env.c"
                           ) {
        cms->d.authEnvelopedData = (CMS_AuthEnvelopedData *)ASN1_item_new((CMS_AuthEnvelopedData_it()));
        if (cms->d.authEnvelopedData == 
# 95 "../crypto/cms/cms_env.c" 3 4
                                       ((void *)0)
# 95 "../crypto/cms/cms_env.c"
                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",96,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 96 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 96 "../crypto/cms/cms_env.c"
           );
            return 
# 97 "../crypto/cms/cms_env.c" 3 4
                  ((void *)0)
# 97 "../crypto/cms/cms_env.c"
                      ;
        }
        ...
        cms->d.authEnvelopedData->authEncryptedContentInfo->contentType =
            OBJ_nid2obj(21);
        ASN1_OBJECT_free(cms->contentType);
        cms->contentType = OBJ_nid2obj(1059);
        return cms->d.authEnvelopedData;
    }
...
int ossl_cms_env_asn1_ctrl(CMS_RecipientInfo *ri, int cmd)
{
    ...
    if (ri->type == 0)
        ...
        if (pctx == 
# 119 "../crypto/cms/cms_env.c" 3 4
                   ((void *)0)
# 119 "../crypto/cms/cms_env.c"
                       )
            return 0;
        pkey = EVP_PKEY_CTX_get0_pkey(pctx);
        if (pkey == 
# 122 "../crypto/cms/cms_env.c" 3 4
                   ((void *)0)
# 122 "../crypto/cms/cms_env.c"
                       )
            return 0;
    } else
        return 0;
    ...
    if (pkey->ameth == 
# 135 "../crypto/cms/cms_env.c" 3 4
                      ((void *)0) 
# 135 "../crypto/cms/cms_env.c"
...
# 135 "../crypto/cms/cms_env.c"
        ...
        return 1;
    i = pkey->ameth->pkey_ctrl(pkey, 0x7, cmd, ri);
    if (i == -2) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",139,__func__), ERR_set_error)((46),(125),
# 139 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 139 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    if (i <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",143,__func__), ERR_set_error)((46),(111),
# 143 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 143 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    return 1;
...
CMS_EncryptedContentInfo *ossl_cms_get0_env_enc_content(const CMS_ContentInfo *cms)
{
    ...
    case 1:
        return cms->d.envelopedData == 
# 153 "../crypto/cms/cms_env.c" 3 4
                                      ((void *)0) 
# 153 "../crypto/cms/cms_env.c"
                                           ? 
# 153 "../crypto/cms/cms_env.c" 3 4
                                             ((void *)0)
            
# 154 "../crypto/cms/cms_env.c"
           : cms->d.envelopedData->encryptedContentInfo;

    case 2:
        return cms->d.authEnvelopedData == 
# 157 "../crypto/cms/cms_env.c" 3 4
                                          ((void *)0) 
# 157 "../crypto/cms/cms_env.c"
                                               ? 
# 157 "../crypto/cms/cms_env.c" 3 4
                                                 ((void *)0)
            
# 158 "../crypto/cms/cms_env.c"
           : cms->d.authEnvelopedData->authEncryptedContentInfo;

    default:
        return 
# 161 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 161 "../crypto/cms/cms_env.c"
                  ;
    }
}
...
struct stack_st_CMS_RecipientInfo *CMS_get0_RecipientInfos(CMS_ContentInfo *cms)
{
    ...
    default:
        return 
# 175 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 175 "../crypto/cms/cms_env.c"
                  ;
    }
}
...
void ossl_cms_RecipientInfos_set_cmsctx(CMS_ContentInfo *cms)
{
    ...
    struct stack_st_CMS_RecipientInfo *rinfos = CMS_get0_RecipientInfos(cms);

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(rinfos)); i++) {
        ri = ((CMS_RecipientInfo *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientInfo_sk_type(rinfos), (i)));
        if (ri != 
# 188 "../crypto/cms/cms_env.c" 3 4
                 ((void *)0)
# 188 "../crypto/cms/cms_env.c"
                     ) {
            switch (ri->type) {
            case 1:
...
EVP_PKEY_CTX *CMS_RecipientInfo_get0_pkey_ctx(CMS_RecipientInfo *ri)
{
    ...
    return 
# 223 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 223 "../crypto/cms/cms_env.c"
              ;
}
                                             ...
                                             const char *propq)
{
    ...
    if (cms == 
# 234 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 234 "../crypto/cms/cms_env.c"
                  )
        goto err;
    env = cms_enveloped_data_init(cms);
    if (env == 
# 237 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 237 "../crypto/cms/cms_env.c"
                  )
        goto err;

    if (!ossl_cms_EncryptedContent_init(env->encryptedContentInfo, cipher, 
# 240 "../crypto/cms/cms_env.c" 3 4
                                                                          ((void *)0)
# 240 "../crypto/cms/cms_env.c"
                                                                              ,
 ...
 err:
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",246,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 246 "../crypto/cms/cms_env.c" 3 4
   ((void *)0)
# 246 "../crypto/cms/cms_env.c"
   );
    return 
# 247 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 247 "../crypto/cms/cms_env.c"
              ;
}

CMS_ContentInfo *CMS_EnvelopedData_create(const EVP_CIPHER *cipher)
{
    return CMS_EnvelopedData_create_ex(cipher, 
# 252 "../crypto/cms/cms_env.c" 3 4
                                              ((void *)0)
# 252 "../crypto/cms/cms_env.c"
                                                  , 
# 252 "../crypto/cms/cms_env.c" 3 4
                                                    ((void *)0)
# 252 "../crypto/cms/cms_env.c"
                               ...
                               OSSL_LIB_CTX *libctx, const char *propq)
{
    CMS_ContentInfo *ci;
    BIO *bio = 
# 261 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 261 "../crypto/cms/cms_env.c"
                  ;
    int res = 0;

    if (env == 
# 264 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 264 "../crypto/cms/cms_env.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",265,__func__), ERR_set_error)((46),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 265 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 265 "../crypto/cms/cms_env.c"
       );
        return 
# 266 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 266 "../crypto/cms/cms_env.c"
                  ;
    }

    if ((ci = CMS_ContentInfo_new_ex(libctx, propq)) == 
# 269 "../crypto/cms/cms_env.c" 3 4
                                                       ((void *)0)
            
# 270 "../crypto/cms/cms_env.c"
           || (bio = BIO_new(BIO_s_mem())) == 
# 270 "../crypto/cms/cms_env.c" 3 4
                                              ((void *)0)
# 270 "../crypto/cms/cms_env.c"
                                                  )
        goto end;
    ci->contentType = OBJ_nid2obj(23);
    ci->d.envelopedData = env;
    if (secret != 
# 274 "../crypto/cms/cms_env.c" 3 4
                 ((void *)0)
        
# 275 "../crypto/cms/cms_env.c"
       && CMS_decrypt_set1_password(ci, (unsigned char *)
                                     ASN1_STRING_get0_data(secret),
                                     ASN1_STRING_length(secret)) != 1)
        goto end;
    res = CMS_decrypt(ci, secret == 
# 279 "../crypto/cms/cms_env.c" 3 4
                                   ((void *)0) 
# 279 "../crypto/cms/cms_env.c"
                                        ? pkey : 
# 279 "../crypto/cms/cms_env.c" 3 4
                                                 ((void *)0)
# 279 "../crypto/cms/cms_env.c"
                                                     ,
                      secret == 
# 280 "../crypto/cms/cms_env.c" 3 4
                               ((void *)0) 
# 280 "../crypto/cms/cms_env.c"
                                    ? cert : 
# 280 "../crypto/cms/cms_env.c" 3 4
                                             ((void *)0)
# 280 "../crypto/cms/cms_env.c"
                                                 , detached_data, bio, flags);

 end:
    if (ci != 
# 283 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 283 "../crypto/cms/cms_env.c"
                 ) {
        ci->d.envelopedData = 
# 284 "../crypto/cms/cms_env.c" 3 4
                             ((void *)0)
# 284 "../crypto/cms/cms_env.c"
                                 ;
        ci->contentType = 
# 285 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 285 "../crypto/cms/cms_env.c"
    ...
    if (!res) {
        BIO_free(bio);
        bio = 
# 290 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 290 "../crypto/cms/cms_env.c"
                 ;
    }
    return bio;
}
                                ...
                                const char *propq)
{
    ...
    cms = CMS_ContentInfo_new_ex(libctx, propq);
    if (cms == 
# 303 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 303 "../crypto/cms/cms_env.c"
                  )
        goto merr;
    aenv = cms_auth_enveloped_data_init(cms);
    if (aenv == 
# 306 "../crypto/cms/cms_env.c" 3 4
               ((void *)0)
# 306 "../crypto/cms/cms_env.c"
                   )
        goto merr;
    if (!ossl_cms_EncryptedContent_init(aenv->authEncryptedContentInfo,
                                        cipher, 
# 309 "../crypto/cms/cms_env.c" 3 4
                                               ((void *)0)
# 309 "../crypto/cms/cms_env.c"
                                                   , 0,
 ...
 merr:
    CMS_ContentInfo_free(cms);
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",315,__func__), ERR_set_error)((46),((46 | (0x2 << 18L))),
# 315 "../crypto/cms/cms_env.c" 3 4
   ((void *)0)
# 315 "../crypto/cms/cms_env.c"
   );
    return 
# 316 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 316 "../crypto/cms/cms_env.c"
              ;
}
...
CMS_ContentInfo *CMS_AuthEnvelopedData_create(const EVP_CIPHER *cipher)
{
    return CMS_AuthEnvelopedData_create_ex(cipher, 
# 322 "../crypto/cms/cms_env.c" 3 4
                                                  ((void *)0)
# 322 "../crypto/cms/cms_env.c"
                                                      , 
# 322 "../crypto/cms/cms_env.c" 3 4
                                                        ((void *)0)
# 322 "../crypto/cms/cms_env.c"
                                       ...
                                       const CMS_CTX *ctx)
{
    ...
    if (flags & 0x40000) {
        ktri->pctx = EVP_PKEY_CTX_new_from_pkey(ossl_cms_ctx_get0_libctx(ctx),
                                                ...
                                                ossl_cms_ctx_get0_propq(ctx));
        if (ktri->pctx == 
# 370 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 370 "../crypto/cms/cms_env.c"
                             )
            return 0;
...
{
    CMS_RecipientInfo *ri = 
# 387 "../crypto/cms/cms_env.c" 3 4
                           ((void *)0)
# 387 "../crypto/cms/cms_env.c"
                               ;
    struct stack_st_CMS_RecipientInfo *ris;
    EVP_PKEY *pk = 
# 389 "../crypto/cms/cms_env.c" 3 4
                  ((void *)0)
# 389 "../crypto/cms/cms_env.c"
                      ;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(cms);

    ris = CMS_get0_RecipientInfos(cms);
    if (ris == 
# 393 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 393 "../crypto/cms/cms_env.c"
                  )
        goto err;
    ...
    if (ri == 
# 398 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 398 "../crypto/cms/cms_env.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",399,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 399 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 399 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    if (pk == 
# 404 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 404 "../crypto/cms/cms_env.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",405,__func__), ERR_set_error)((46),(113),
# 405 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 405 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",423,__func__), ERR_set_error)((46),(125),
# 423 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 423 "../crypto/cms/cms_env.c"
       );
        goto err;

    }

    if (!OPENSSL_sk_push(ossl_check_CMS_RecipientInfo_sk_type(ris), ossl_check_CMS_RecipientInfo_type(ri))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",429,__func__), ERR_set_error)((46),((15 | (0x2 << 18L))),
# 429 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 429 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
 ...
 err:
    ASN1_item_free(((void*) (1 ? ri : (CMS_RecipientInfo*)0)), (CMS_RecipientInfo_it()));
    return 
# 437 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 437 "../crypto/cms/cms_env.c"
              ;
...
CMS_RecipientInfo *CMS_add1_recipient_cert(CMS_ContentInfo *cms, X509 *recip,
                                           unsigned int flags)
{
     return CMS_add1_recipient(cms, recip, 
# 444 "../crypto/cms/cms_env.c" 3 4
                                          ((void *)0)
# 444 "../crypto/cms/cms_env.c"
                                              , 
# 444 "../crypto/cms/cms_env.c" 3 4
                                                ((void *)0)
# 444 "../crypto/cms/cms_env.c"
                                     ...
                                     X509_ALGOR **palg)
{
    CMS_KeyTransRecipientInfo *ktri;
    if (ri->type != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",453,__func__), ERR_set_error)((46),(124),
# 453 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 453 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
                                          ...
                                          ASN1_INTEGER **sno)
{
    CMS_KeyTransRecipientInfo *ktri;
    if (ri->type != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",475,__func__), ERR_set_error)((46),(124),
# 475 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 475 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ktri = ri->d.ktri;
...
{
    if (ri->type != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",487,__func__), ERR_set_error)((46),(124),
# 487 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 487 "../crypto/cms/cms_env.c"
       );
        return -2;
    }
...
{
    if (ri->type != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",496,__func__), ERR_set_error)((46),(124),
# 496 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 496 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
                                          ...
                                          CMS_RecipientInfo *ri)
{
    ...
    EVP_PKEY_CTX *pctx;
    unsigned char *ek = 
# 512 "../crypto/cms/cms_env.c" 3 4
                       ((void *)0)
# 512 "../crypto/cms/cms_env.c"
                           ;
    size_t eklen;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(cms);
    ...
    if (ri->type != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",519,__func__), ERR_set_error)((46),(124),
# 519 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 519 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ktri = ri->d.ktri;
    ...
    if (pctx) {
        ...
        pctx = EVP_PKEY_CTX_new_from_pkey(ossl_cms_ctx_get0_libctx(ctx),
                                          ...
                                          ossl_cms_ctx_get0_propq(ctx));
        if (pctx == 
# 534 "../crypto/cms/cms_env.c" 3 4
                   ((void *)0)
# 534 "../crypto/cms/cms_env.c"
                       )
            return 0;
...
# 541 "../crypto/cms/cms_env.c" 3 4
                              ((void *)0)
# 541 "../crypto/cms/cms_env.c"
                                  , &eklen, ec->key, ec->keylen) <= 0)
        goto err;

    ek = CRYPTO_malloc(eklen, "../crypto/cms/cms_env.c", 544);
    if (ek == 
# 545 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 545 "../crypto/cms/cms_env.c"
                 )
        goto err;
    ...
    ek = 
# 552 "../crypto/cms/cms_env.c" 3 4
        ((void *)0)
# 552 "../crypto/cms/cms_env.c"
            ;
 ...
 err:
    ...
    ktri->pctx = 
# 558 "../crypto/cms/cms_env.c" 3 4
                ((void *)0)
# 558 "../crypto/cms/cms_env.c"
                    ;
    CRYPTO_free(ek, "../crypto/cms/cms_env.c", 559);
    return ret;
}
                                          ...
                                          CMS_RecipientInfo *ri)
{
    ...
    unsigned char *ek = 
# 570 "../crypto/cms/cms_env.c" 3 4
                       ((void *)0)
# 570 "../crypto/cms/cms_env.c"
                           ;
    size_t eklen;
    int ret = 0;
    size_t fixlen = 0;
    const EVP_CIPHER *cipher = 
# 574 "../crypto/cms/cms_env.c" 3 4
                              ((void *)0)
# 574 "../crypto/cms/cms_env.c"
                                  ;
    EVP_CIPHER *fetched_cipher = 
# 575 "../crypto/cms/cms_env.c" 3 4
                                ((void *)0)
# 575 "../crypto/cms/cms_env.c"
                                    ;
    CMS_EncryptedContentInfo *ec;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(cms);
    ...
    if (ktri->pkey == 
# 583 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 583 "../crypto/cms/cms_env.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",584,__func__), ERR_set_error)((46),(133),
# 584 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 584 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ...
    if (cms->d.envelopedData->encryptedContentInfo->havenocert
        ...
        if (fetched_cipher != 
# 598 "../crypto/cms/cms_env.c" 3 4
                             ((void *)0)
# 598 "../crypto/cms/cms_env.c"
                                 )
            cipher = fetched_cipher;
        else
            cipher = EVP_get_cipherbyname(OBJ_nid2sn(OBJ_obj2nid(calg->algorithm)));
        if (cipher == 
# 602 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 602 "../crypto/cms/cms_env.c"
                         ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",604,__func__), ERR_set_error)((46),(148),
# 604 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 604 "../crypto/cms/cms_env.c"
           );
            return 0;
        }
    ...
    if (ktri->pctx == 
# 614 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 614 "../crypto/cms/cms_env.c"
                         )
        goto err;
    ...
    CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_env.c", 637);
    ec->key = ek;
    ec->keylen = eklen;
 ...
 err:
    ...
    ktri->pctx = 
# 643 "../crypto/cms/cms_env.c" 3 4
                ((void *)0)
# 643 "../crypto/cms/cms_env.c"
                    ;
    if (!ret)
        CRYPTO_free(ek, "../crypto/cms/cms_env.c", 645);
                                   ...
                                   const unsigned char *id, size_t idlen)
{
    ...
    CMS_KEKRecipientInfo *kekri;
    if (ri->type != 2) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",658,__func__), ERR_set_error)((46),(123),
# 658 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 658 "../crypto/cms/cms_env.c"
       );
        return -2;
    }
    kekri = ri->d.kekri;
...
{
    CMS_RecipientInfo *ri = 
# 695 "../crypto/cms/cms_env.c" 3 4
                           ((void *)0)
# 695 "../crypto/cms/cms_env.c"
                               ;
    CMS_KEKRecipientInfo *kekri;
    struct stack_st_CMS_RecipientInfo *ris = CMS_get0_RecipientInfos(cms);

    if (ris == 
# 699 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 699 "../crypto/cms/cms_env.c"
                  )
        goto err;
    ...
    if (nid == 0) {
        ...
        default:
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",717,__func__), ERR_set_error)((46),(118),
# 717 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 717 "../crypto/cms/cms_env.c"
           );
            goto err;
        }
        ...
        if (!exp_keylen) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",726,__func__), ERR_set_error)((46),(153),
# 726 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 726 "../crypto/cms/cms_env.c"
           );
            goto err;
        }

        if (keylen != exp_keylen) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",731,__func__), ERR_set_error)((46),(118),
# 731 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 731 "../crypto/cms/cms_env.c"
           );
            goto err;
        }
    ...
    ri = (CMS_RecipientInfo *)ASN1_item_new((CMS_RecipientInfo_it()));
    if (!ri) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",740,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 740 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 740 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    if (!ri->d.kekri) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",746,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 746 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 746 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ri->type = 2;
...
# 755 "../crypto/cms/cms_env.c" 3 4
                                  ((void *)0)
# 755 "../crypto/cms/cms_env.c"
                                      ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",756,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 756 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 756 "../crypto/cms/cms_env.c"
           );
            goto err;
        }
    }
    ...
    if (!OPENSSL_sk_push(ossl_check_CMS_RecipientInfo_sk_type(ris), ossl_check_CMS_RecipientInfo_type(ri))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",762,__func__), ERR_set_error)((46),((15 | (0x2 << 18L))),
# 762 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 762 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    (void)X509_ALGOR_set0(kekri->keyEncryptionAlgorithm, OBJ_nid2obj(nid),
                          -1, 
# 783 "../crypto/cms/cms_env.c" 3 4
                                       ((void *)0)
# 783 "../crypto/cms/cms_env.c"
                                           );
 ...
 err:
    ASN1_item_free(((void*) (1 ? ri : (CMS_RecipientInfo*)0)), (CMS_RecipientInfo_it()));
    return 
# 789 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 789 "../crypto/cms/cms_env.c"
              ;
}
                                    ...
                                    ASN1_TYPE **pothertype)
{
    ...
    if (ri->type != 2) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",801,__func__), ERR_set_error)((46),(123),
# 801 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 801 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ...
    if (potherid) {
        if (rkid->other)
            ...
            *potherid = 
# 815 "../crypto/cms/cms_env.c" 3 4
                       ((void *)0)
# 815 "../crypto/cms/cms_env.c"
                           ;
    }
    if (pothertype) {
        if (rkid->other)
            ...
            *pothertype = 
# 821 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 821 "../crypto/cms/cms_env.c"
                             ;
    }
    return 1;
}
                               ...
                               unsigned char *key, size_t keylen)
{
    CMS_KEKRecipientInfo *kekri;
    if (ri->type != 2) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",831,__func__), ERR_set_error)((46),(123),
# 831 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 831 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
...
{
    const char *alg = 
# 843 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 843 "../crypto/cms/cms_env.c"
                         ;
    ...
    default:
        return 
# 856 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 856 "../crypto/cms/cms_env.c"
                  ;
    }
                                           ...
                                           CMS_RecipientInfo *ri)
{
    ...
    CMS_KEKRecipientInfo *kekri;
    unsigned char *wkey = 
# 870 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 870 "../crypto/cms/cms_env.c"
                             ;
    int wkeylen;
    int r = 0;
    EVP_CIPHER *cipher = 
# 873 "../crypto/cms/cms_env.c" 3 4
                        ((void *)0)
# 873 "../crypto/cms/cms_env.c"
                            ;
    int outlen = 0;
    EVP_CIPHER_CTX *ctx = 
# 875 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 875 "../crypto/cms/cms_env.c"
                             ;
    const CMS_CTX *cms_ctx = ossl_cms_get0_cmsctx(cms);

    ec = ossl_cms_get0_env_enc_content(cms);
    if (ec == 
# 879 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 879 "../crypto/cms/cms_env.c"
                 )
        return 0;
    ...
    if (kekri->key == 
# 884 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 884 "../crypto/cms/cms_env.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",885,__func__), ERR_set_error)((46),(130),
# 885 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 885 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ...
    if (cipher == 
# 890 "../crypto/cms/cms_env.c" 3 4
                 ((void *)0)
# 890 "../crypto/cms/cms_env.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",891,__func__), ERR_set_error)((46),(118),
# 891 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 891 "../crypto/cms/cms_env.c"
       );
        goto err;
    }


    wkey = CRYPTO_malloc(ec->keylen + 8, "../crypto/cms/cms_env.c", 896);
    if (wkey == 
# 897 "../crypto/cms/cms_env.c" 3 4
               ((void *)0)
# 897 "../crypto/cms/cms_env.c"
                   )
        goto err;

    ctx = EVP_CIPHER_CTX_new();
    if (ctx == 
# 901 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 901 "../crypto/cms/cms_env.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",902,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 902 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 902 "../crypto/cms/cms_env.c"
       );
        goto err;
    }

    EVP_CIPHER_CTX_set_flags(ctx, 0x1);
    if (!EVP_EncryptInit_ex(ctx, cipher, 
# 907 "../crypto/cms/cms_env.c" 3 4
                                        ((void *)0)
# 907 "../crypto/cms/cms_env.c"
                                            , kekri->key, 
# 907 "../crypto/cms/cms_env.c" 3 4
                                                          ((void *)0)
# 907 "../crypto/cms/cms_env.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",910,__func__), ERR_set_error)((46),(159),
# 910 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 910 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    wkeylen += outlen;
    if (!__builtin_expect(!!(((size_t)wkeylen == ec->keylen + 8) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",915,__func__), ERR_set_error)((46),(159),
# 915 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 915 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
 ...
 err:
    ...
    if (!r)
        CRYPTO_free(wkey, "../crypto/cms/cms_env.c", 926);
                                           ...
                                           CMS_RecipientInfo *ri)
{
    ...
    CMS_KEKRecipientInfo *kekri;
    unsigned char *ukey = 
# 939 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 939 "../crypto/cms/cms_env.c"
                             ;
    int ukeylen;
    int r = 0, wrap_nid;
    EVP_CIPHER *cipher = 
# 942 "../crypto/cms/cms_env.c" 3 4
                        ((void *)0)
# 942 "../crypto/cms/cms_env.c"
                            ;
    int outlen = 0;
    EVP_CIPHER_CTX *ctx = 
# 944 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 944 "../crypto/cms/cms_env.c"
                             ;
    const CMS_CTX *cms_ctx = ossl_cms_get0_cmsctx(cms);

    ec = ossl_cms_get0_env_enc_content(cms);
    if (ec == 
# 948 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 948 "../crypto/cms/cms_env.c"
                 )
        return 0;
    ...
    if (!kekri->key) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",954,__func__), ERR_set_error)((46),(130),
# 954 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 954 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ...
    if (aes_wrap_keylen(wrap_nid) != kekri->keylen) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",960,__func__), ERR_set_error)((46),(118),
# 960 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 960 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
    ...
    if (kekri->encryptedKey->length < 16) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",967,__func__), ERR_set_error)((46),(117),
# 967 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 967 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    cipher = cms_get_key_wrap_cipher(kekri->keylen, cms_ctx);
    if (cipher == 
# 972 "../crypto/cms/cms_env.c" 3 4
                 ((void *)0)
# 972 "../crypto/cms/cms_env.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",973,__func__), ERR_set_error)((46),(118),
# 973 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 973 "../crypto/cms/cms_env.c"
       );
        goto err;
    }

    ukey = CRYPTO_malloc(kekri->encryptedKey->length - 8, "../crypto/cms/cms_env.c", 977);
    if (ukey == 
# 978 "../crypto/cms/cms_env.c" 3 4
               ((void *)0)
# 978 "../crypto/cms/cms_env.c"
                   )
        goto err;

    ctx = EVP_CIPHER_CTX_new();
    if (ctx == 
# 982 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 982 "../crypto/cms/cms_env.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",983,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 983 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 983 "../crypto/cms/cms_env.c"
       );
        goto err;
    }

    if (!EVP_DecryptInit_ex(ctx, cipher, 
# 987 "../crypto/cms/cms_env.c" 3 4
                                        ((void *)0)
# 987 "../crypto/cms/cms_env.c"
                                            , kekri->key, 
# 987 "../crypto/cms/cms_env.c" 3 4
                                                          ((void *)0)
# 987 "../crypto/cms/cms_env.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",992,__func__), ERR_set_error)((46),(157),
# 992 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 992 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ukeylen += outlen;

    CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_env.c", 997);
    ec->key = ukey;
    ec->keylen = ukeylen;
 ...
 err:
    EVP_CIPHER_free(cipher);
    if (!r)
        CRYPTO_free(ukey, "../crypto/cms/cms_env.c", 1006);
    EVP_CIPHER_CTX_free(ctx);
...
int CMS_RecipientInfo_decrypt(CMS_ContentInfo *cms, CMS_RecipientInfo *ri)
{
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1025,__func__), ERR_set_error)((46),(155),
# 1025 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1025 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
}
...
int CMS_RecipientInfo_encrypt(const CMS_ContentInfo *cms, CMS_RecipientInfo *ri)
{
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1046,__func__), ERR_set_error)((46),(154),
# 1046 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1046 "../crypto/cms/cms_env.c"
       );
        return 0;
    }
}
...
static void cms_env_set_originfo_version(CMS_EnvelopedData *env)
{
    ...
    int i;
    if (org == 
# 1057 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1057 "../crypto/cms/cms_env.c"
                  )
        return;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RevocationInfoChoice_sk_type(org->crls)); i++) {
        CMS_RevocationInfoChoice *rch;
        rch = ((CMS_RevocationInfoChoice *)OPENSSL_sk_value(ossl_check_const_CMS_RevocationInfoChoice_sk_type(org->crls), (i)));
        if (rch->type == 1) {
            env->version = 4;
            return;
        }
...
static void cms_env_set_version(CMS_EnvelopedData *env)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(env->recipientInfos)); i++) {
        ri = ((CMS_RecipientInfo *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientInfo_sk_type(env->recipientInfos), (i)));
        if (ri->type == 3 || ri->type == 4) {
            env->version = 3;
            return;
        } else if (ri->type != 0
                   || ri->d.ktri->version != 0) {
                                       ...
                                       struct stack_st_CMS_RecipientInfo *ris)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RecipientInfo_sk_type(ris)); i++) {
        ri = ((CMS_RecipientInfo *)OPENSSL_sk_value(ossl_check_const_CMS_RecipientInfo_sk_type(ris), (i)));
...
{
    ec->cipher = 
# 1130 "../crypto/cms/cms_env.c" 3 4
                ((void *)0)
# 1130 "../crypto/cms/cms_env.c"
                    ;
    CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_env.c", 1131);
    ec->key = 
# 1132 "../crypto/cms/cms_env.c" 3 4
             ((void *)0)
# 1132 "../crypto/cms/cms_env.c"
                 ;
    ec->keylen = 0;
}
...
static BIO *cms_EnvelopedData_Decryption_init_bio(CMS_ContentInfo *cms)
{
    ...
    BIO *contentBio = ossl_cms_EncryptedContent_init_bio(ec,
                                                         ossl_cms_get0_cmsctx(cms));
    EVP_CIPHER_CTX *ctx = 
# 1141 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 1141 "../crypto/cms/cms_env.c"
                             ;

    if (contentBio == 
# 1143 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 1143 "../crypto/cms/cms_env.c"
                         )
        return 
# 1144 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1144 "../crypto/cms/cms_env.c"
                  ;

    BIO_ctrl(contentBio,129,0,(&ctx));
    if (ctx == 
# 1147 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1147 "../crypto/cms/cms_env.c"
                  ) {
        BIO_free(contentBio);
        return 
# 1149 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1149 "../crypto/cms/cms_env.c"
                  ;
    }
    ...
    if ((EVP_CIPHER_get_flags(EVP_CIPHER_CTX_get0_cipher(ctx))
                & 0x2000000) != 0
         && EVP_CIPHER_CTX_ctrl(ctx, 0x28, 0,
                                cms->d.envelopedData->unprotectedAttrs) <= 0) {
        BIO_free(contentBio);
        return 
# 1160 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1160 "../crypto/cms/cms_env.c"
                  ;
    }
    return contentBio;
}
...
{
    CMS_EncryptedContentInfo *ec;
    struct stack_st_CMS_RecipientInfo *rinfos;
    int ok = 0;
    BIO *ret;
    ...
    if (cms_env_encrypt_content_key(cms, rinfos) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1185,__func__), ERR_set_error)((46),(116),
# 1185 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1185 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
 ...
 err:
    ...
    BIO_free(ret);
    return 
# 1199 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 1199 "../crypto/cms/cms_env.c"
              ;
}
...
# 1204 "../crypto/cms/cms_env.c" 3 4
                                                             ((void *)0)
# 1204 "../crypto/cms/cms_env.c"
                                                                 ) {
...
BIO *ossl_cms_AuthEnvelopedData_init_bio(CMS_ContentInfo *cms)
{
    ...
    if (ec->cipher == 
# 1224 "../crypto/cms/cms_env.c" 3 4
                     ((void *)0)
# 1224 "../crypto/cms/cms_env.c"
                         ) {
    ...
    if (ret == 
# 1231 "../crypto/cms/cms_env.c" 3 4
              ((void *)0) 
# 1231 "../crypto/cms/cms_env.c"
                   || ec->cipher == 
# 1231 "../crypto/cms/cms_env.c" 3 4
                                    ((void *)0)
# 1231 "../crypto/cms/cms_env.c"
    ...
    if (cms_env_encrypt_content_key(cms, rinfos) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1237,__func__), ERR_set_error)((46),(116),
# 1237 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1237 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
 ...
 err:
    ...
    BIO_free(ret);
    return 
# 1251 "../crypto/cms/cms_env.c" 3 4
          ((void *)0)
# 1251 "../crypto/cms/cms_env.c"
              ;
}
...
{
    CMS_EnvelopedData *env = 
# 1256 "../crypto/cms/cms_env.c" 3 4
                            ((void *)0)
# 1256 "../crypto/cms/cms_env.c"
                                ;
    EVP_CIPHER_CTX *ctx = 
# 1257 "../crypto/cms/cms_env.c" 3 4
                         ((void *)0)
# 1257 "../crypto/cms/cms_env.c"
                             ;
    BIO *mbio = BIO_find_type(chain, (10|0x0200));

    env = ossl_cms_get0_enveloped(cms);
    if (env == 
# 1261 "../crypto/cms/cms_env.c" 3 4
              ((void *)0)
# 1261 "../crypto/cms/cms_env.c"
                  )
        return 0;

    if (mbio == 
# 1264 "../crypto/cms/cms_env.c" 3 4
               ((void *)0)
# 1264 "../crypto/cms/cms_env.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1265,__func__), ERR_set_error)((46),(105),
# 1265 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1265 "../crypto/cms/cms_env.c"
       );
        return 0;
    }

    BIO_ctrl(mbio,129,0,(&ctx));
    ...
    if ((EVP_CIPHER_get_flags(EVP_CIPHER_CTX_get0_cipher(ctx))
            & 0x2000000) != 0) {
        if (env->unprotectedAttrs == 
# 1277 "../crypto/cms/cms_env.c" 3 4
                                    ((void *)0)
# 1277 "../crypto/cms/cms_env.c"
                                        )
            env->unprotectedAttrs = ((struct stack_st_X509_ATTRIBUTE *)OPENSSL_sk_new_null());

        if (env->unprotectedAttrs == 
# 1280 "../crypto/cms/cms_env.c" 3 4
                                    ((void *)0)
# 1280 "../crypto/cms/cms_env.c"
                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1281,__func__), ERR_set_error)((46),((15 | (0x2 << 18L))),
# 1281 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 1281 "../crypto/cms/cms_env.c"
           );
            return 0;
        }

        if (EVP_CIPHER_CTX_ctrl(ctx, 0x28,
                                1, env->unprotectedAttrs) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1287,__func__), ERR_set_error)((46),(111),
# 1287 "../crypto/cms/cms_env.c" 3 4
           ((void *)0)
# 1287 "../crypto/cms/cms_env.c"
           );
            return 0;
        }
    }
...
int ossl_cms_AuthEnvelopedData_final(CMS_ContentInfo *cms, BIO *cmsbio)
{
    EVP_CIPHER_CTX *ctx;
    unsigned char *tag = 
# 1299 "../crypto/cms/cms_env.c" 3 4
                        ((void *)0)
# 1299 "../crypto/cms/cms_env.c"
                            ;
    int taglen, ok = 0;

    BIO_ctrl(cmsbio,129,0,(&ctx));
    ...
    if (taglen <= 0
            || (tag = CRYPTO_malloc(taglen, "../crypto/cms/cms_env.c", 1313)) == 
# 1313 "../crypto/cms/cms_env.c" 3 4
                                                ((void *)0)
            
# 1314 "../crypto/cms/cms_env.c"
           || EVP_CIPHER_CTX_ctrl(ctx, 0x10, taglen,
                                   tag) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_env.c",1316,__func__), ERR_set_error)((46),(185),
# 1316 "../crypto/cms/cms_env.c" 3 4
       ((void *)0)
# 1316 "../crypto/cms/cms_env.c"
       );
        goto err;
    }
    ...
    ok = 1;
err:
    CRYPTO_free(tag, "../crypto/cms/cms_env.c", 1325);
    return ok;
}
...
int ossl_cms_pkey_get_ri_type(EVP_PKEY *pk)
{
    ...
    if (pk->ameth && pk->ameth->pkey_ctrl) {
        int i, r;
        i = pk->ameth->pkey_ctrl(pk, 0x8, 0, &r);
        if (i > 0)
            return r;
    }
    return 0;
...
int ossl_cms_pkey_is_ri_type_supported(EVP_PKEY *pk, int ri_type)
{
    ...
    if (pk->ameth != 
# 1365 "../crypto/cms/cms_env.c" 3 4
                    ((void *)0) 
# 1365 "../crypto/cms/cms_env.c"
                         && pk->ameth->pkey_ctrl != 
# 1365 "../crypto/cms/cms_env.c" 3 4
                                                    ((void *)0)
# 1365 "../crypto/cms/cms_env.c"
