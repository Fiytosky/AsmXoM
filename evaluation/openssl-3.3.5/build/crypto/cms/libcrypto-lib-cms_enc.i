# 0 "../crypto/cms/cms_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_enc.c"
# 10 "../crypto/cms/cms_enc.c"
                                        ...
                                        const CMS_CTX *cms_ctx)
{
    BIO *b;
    EVP_CIPHER_CTX *ctx;
    EVP_CIPHER *fetched_ciph = 
# 30 "../crypto/cms/cms_enc.c" 3 4
                              ((void *)0)
# 30 "../crypto/cms/cms_enc.c"
                                  ;
    const EVP_CIPHER *cipher = 
# 31 "../crypto/cms/cms_enc.c" 3 4
                              ((void *)0)
# 31 "../crypto/cms/cms_enc.c"
                                  ;
    X509_ALGOR *calg = ec->contentEncryptionAlgorithm;
    evp_cipher_aead_asn1_params aparams;
    unsigned char iv[16], *piv = 
# 34 "../crypto/cms/cms_enc.c" 3 4
                                               ((void *)0)
# 34 "../crypto/cms/cms_enc.c"
                                                   ;
    unsigned char *tkey = 
# 35 "../crypto/cms/cms_enc.c" 3 4
                         ((void *)0)
# 35 "../crypto/cms/cms_enc.c"
                             ;
    int len;
    int ivlen = 0;
    size_t tkeylen = 0;
    ...
    if (b == 
# 47 "../crypto/cms/cms_enc.c" 3 4
            ((void *)0)
# 47 "../crypto/cms/cms_enc.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",48,__func__), ERR_set_error)((46),((32 | (0x2 << 18L))),
# 48 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 48 "../crypto/cms/cms_enc.c"
       );
        return 
# 49 "../crypto/cms/cms_enc.c" 3 4
              ((void *)0)
# 49 "../crypto/cms/cms_enc.c"
                  ;
    }

    BIO_ctrl(b,129,0,(&ctx));
    ...
    if (enc) {
        ...
        if (ec->key != 
# 60 "../crypto/cms/cms_enc.c" 3 4
                      ((void *)0)
# 60 "../crypto/cms/cms_enc.c"
                          )
            ec->cipher = 
# 61 "../crypto/cms/cms_enc.c" 3 4
                        ((void *)0)
# 61 "../crypto/cms/cms_enc.c"
                            ;
    } else {
        cipher = EVP_get_cipherbyname(OBJ_nid2sn(OBJ_obj2nid(calg->algorithm)));
    }
    if (cipher != 
# 65 "../crypto/cms/cms_enc.c" 3 4
                 ((void *)0)
# 65 "../crypto/cms/cms_enc.c"
                     ) {
        fetched_ciph = EVP_CIPHER_fetch(libctx, EVP_CIPHER_get0_name(cipher),
                                        propq);
        if (fetched_ciph != 
# 68 "../crypto/cms/cms_enc.c" 3 4
                           ((void *)0)
# 68 "../crypto/cms/cms_enc.c"
                               )
            cipher = fetched_ciph;
    }
    if (cipher == 
# 71 "../crypto/cms/cms_enc.c" 3 4
                 ((void *)0)
# 71 "../crypto/cms/cms_enc.c"
                     ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",73,__func__), ERR_set_error)((46),(148),
# 73 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 73 "../crypto/cms/cms_enc.c"
       );
        goto err;
    }
...
# 78 "../crypto/cms/cms_enc.c" 3 4
                                      ((void *)0)
# 78 "../crypto/cms/cms_enc.c"
                                          , 
# 78 "../crypto/cms/cms_enc.c" 3 4
                                            ((void *)0)
# 78 "../crypto/cms/cms_enc.c"
...
# 78 "../crypto/cms/cms_enc.c"
                                                      , enc) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",79,__func__), ERR_set_error)((46),(101),
# 79 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 79 "../crypto/cms/cms_enc.c"
       );
        goto err;
    }

    if (enc) {
        calg->algorithm = OBJ_nid2obj(EVP_CIPHER_get_type(EVP_CIPHER_CTX_get0_cipher(ctx)));
        if (calg->algorithm == 
# 85 "../crypto/cms/cms_enc.c" 3 4
                              ((void *)0) 
# 85 "../crypto/cms/cms_enc.c"
                                   || calg->algorithm->nid == 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",86,__func__), ERR_set_error)((46),(194),
# 86 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 86 "../crypto/cms/cms_enc.c"
           );
            goto err;
        }
        ...
        if (ivlen < 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",92,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 92 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 92 "../crypto/cms/cms_enc.c"
           );
            goto err;
        }
        ...
        if (evp_cipher_asn1_to_param_ex(ctx, calg->parameter, &aparams) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",103,__func__), ERR_set_error)((46),(102),
# 103 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 103 "../crypto/cms/cms_enc.c"
           );
            goto err;
        }
        if ((EVP_CIPHER_get_flags(cipher) & 0x200000)) {
            ...
            if (ec->taglen > 0
                    && EVP_CIPHER_CTX_ctrl(ctx, 0x11,
                                           ec->taglen, ec->tag) <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",111,__func__), ERR_set_error)((46),(184),
# 111 "../crypto/cms/cms_enc.c" 3 4
               ((void *)0)
# 111 "../crypto/cms/cms_enc.c"
               );
                goto err;
            }
        }
    ...
    if (!enc || !ec->key) {
        tkey = CRYPTO_malloc(tkeylen, "../crypto/cms/cms_enc.c", 123);
        if (tkey == 
# 124 "../crypto/cms/cms_enc.c" 3 4
                   ((void *)0)
# 124 "../crypto/cms/cms_enc.c"
                       )
            goto err;
    ...
    if (!ec->key) {
        ...
        ec->keylen = tkeylen;
        tkey = 
# 133 "../crypto/cms/cms_enc.c" 3 4
              ((void *)0)
# 133 "../crypto/cms/cms_enc.c"
                  ;
        if (enc)
            keep_key = 1;
        else
    ...
    if (ec->keylen != tkeylen) {
        ...
        if (EVP_CIPHER_CTX_set_key_length(ctx, ec->keylen) <= 0) {
            ...
            if (enc || ec->debug) {
                (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",149,__func__), ERR_set_error)((46),(118),
# 149 "../crypto/cms/cms_enc.c" 3 4
               ((void *)0)
# 149 "../crypto/cms/cms_enc.c"
               );
                goto err;
            } else {

                CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_enc.c", 153);
                ec->key = tkey;
                ec->keylen = tkeylen;
                tkey = 
# 156 "../crypto/cms/cms_enc.c" 3 4
                      ((void *)0)
# 156 "../crypto/cms/cms_enc.c"
                          ;
                ERR_clear_error();
            }
        }
...
# 162 "../crypto/cms/cms_enc.c" 3 4
                              ((void *)0)
# 162 "../crypto/cms/cms_enc.c"
                                  , 
# 162 "../crypto/cms/cms_enc.c" 3 4
                                    ((void *)0)
# 162 "../crypto/cms/cms_enc.c"
                                        , ec->key, piv, enc) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",163,__func__), ERR_set_error)((46),(101),
# 163 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 163 "../crypto/cms/cms_enc.c"
       );
        goto err;
    }
    if (enc) {
        ...
        if (calg->parameter == 
# 168 "../crypto/cms/cms_enc.c" 3 4
                              ((void *)0)
# 168 "../crypto/cms/cms_enc.c"
                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",169,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 169 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 169 "../crypto/cms/cms_enc.c"
           );
            goto err;
        }
        if ((EVP_CIPHER_get_flags(cipher) & 0x200000)) {
        ...
        if (evp_cipher_param_to_asn1_ex(ctx, calg->parameter, &aparams) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",181,__func__), ERR_set_error)((46),(102),
# 181 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 181 "../crypto/cms/cms_enc.c"
           );
            goto err;
        }

        if (calg->parameter->type == -1) {
            ASN1_TYPE_free(calg->parameter);
            calg->parameter = 
# 187 "../crypto/cms/cms_enc.c" 3 4
                             ((void *)0)
# 187 "../crypto/cms/cms_enc.c"
                                 ;
        }
    }
    ok = 1;
 ...
 err:
    ...
    if (!keep_key || !ok) {
        CRYPTO_clear_free(ec->key, ec->keylen, "../crypto/cms/cms_enc.c", 195);
        ec->key = 
# 196 "../crypto/cms/cms_enc.c" 3 4
                 ((void *)0)
# 196 "../crypto/cms/cms_enc.c"
                     ;
    }
    CRYPTO_clear_free(tkey, tkeylen, "../crypto/cms/cms_enc.c", 198);
    if (ok)
        return b;
    BIO_free(b);
    return 
# 202 "../crypto/cms/cms_enc.c" 3 4
          ((void *)0)
# 202 "../crypto/cms/cms_enc.c"
              ;
}
                                   ...
                                   const CMS_CTX *cms_ctx)
{
    ec->cipher = cipher;
    if (key) {
        if ((ec->key = CRYPTO_malloc(keylen, "../crypto/cms/cms_enc.c", 212)) == 
# 212 "../crypto/cms/cms_enc.c" 3 4
                                                 ((void *)0)
# 212 "../crypto/cms/cms_enc.c"
                                                     )
            return 0;
    ...
    ec->keylen = keylen;
    if (cipher != 
# 217 "../crypto/cms/cms_enc.c" 3 4
                 ((void *)0)
# 217 "../crypto/cms/cms_enc.c"
                     )
        ec->contentType = OBJ_nid2obj(21);
    return 1;
}
                               ...
                               const unsigned char *key, size_t keylen)
{
    ...
    if (!key || !keylen) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",228,__func__), ERR_set_error)((46),(130),
# 228 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 228 "../crypto/cms/cms_enc.c"
       );
        return 0;
    }
    if (ciph) {
        ...
        if (!cms->d.encryptedData) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",234,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 234 "../crypto/cms/cms_enc.c" 3 4
           ((void *)0)
# 234 "../crypto/cms/cms_enc.c"
           );
            return 0;
        }
        cms->contentType = OBJ_nid2obj(26);
        cms->d.encryptedData->version = 0;
    } else if (OBJ_obj2nid(cms->contentType) != 26) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_enc.c",240,__func__), ERR_set_error)((46),(122),
# 240 "../crypto/cms/cms_enc.c" 3 4
       ((void *)0)
# 240 "../crypto/cms/cms_enc.c"
       );
        return 0;
    }
