# 0 "../crypto/cms/cms_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_lib.c"
# 10 "../crypto/cms/cms_lib.c"
...
# 20 "../crypto/cms/cms_lib.c" 2

static struct stack_st_CMS_CertificateChoices
**cms_get0_certificate_choices(CMS_ContentInfo *cms);

CMS_ContentInfo *CMS_ContentInfo_new(void) { return (CMS_ContentInfo *)ASN1_item_new((CMS_ContentInfo_it())); } void CMS_ContentInfo_free(CMS_ContentInfo *a) { ASN1_item_free((ASN1_VALUE *)a, (CMS_ContentInfo_it())); }
int CMS_ContentInfo_print_ctx(BIO *out, const CMS_ContentInfo *x, int indent, const ASN1_PCTX *pctx) { return ASN1_item_print(out, (const ASN1_VALUE *)x, indent, (CMS_ContentInfo_it()), pctx); }

CMS_ContentInfo *d2i_CMS_ContentInfo(CMS_ContentInfo **a,
                                     const unsigned char **in, long len)
{
    CMS_ContentInfo *ci;
    const CMS_CTX *ctx = ossl_cms_get0_cmsctx(a == 
# 31 "../crypto/cms/cms_lib.c" 3 4
                                                  ((void *)0) 
# 31 "../crypto/cms/cms_lib.c"
                                                       ? 
# 31 "../crypto/cms/cms_lib.c" 3 4
                                                         ((void *)0) 
# 31 "../crypto/cms/cms_lib.c"
    ...
    if (ci != 
# 37 "../crypto/cms/cms_lib.c" 3 4
             ((void *)0)
# 37 "../crypto/cms/cms_lib.c"
                 ) {
        ERR_set_mark();
...
CMS_ContentInfo *CMS_ContentInfo_new_ex(OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    ci = (CMS_ContentInfo *)ASN1_item_new_ex((CMS_ContentInfo_it()),
                                             libctx, propq);
    if (ci != 
# 56 "../crypto/cms/cms_lib.c" 3 4
             ((void *)0)
# 56 "../crypto/cms/cms_lib.c"
                 ) {
        ci->ctx.libctx = libctx;
        ci->ctx.propq = 
# 58 "../crypto/cms/cms_lib.c" 3 4
                       ((void *)0)
# 58 "../crypto/cms/cms_lib.c"
                           ;
        if (propq != 
# 59 "../crypto/cms/cms_lib.c" 3 4
                    ((void *)0)
# 59 "../crypto/cms/cms_lib.c"
                        ) {
            ci->ctx.propq = CRYPTO_strdup(propq, "../crypto/cms/cms_lib.c", 60);
            if (ci->ctx.propq == 
# 61 "../crypto/cms/cms_lib.c" 3 4
                                ((void *)0)
# 61 "../crypto/cms/cms_lib.c"
                                    ) {
                CMS_ContentInfo_free(ci);
                ci = 
# 63 "../crypto/cms/cms_lib.c" 3 4
                    ((void *)0)
# 63 "../crypto/cms/cms_lib.c"
                        ;
            }
        }
    }
...
{
    return cms != 
# 72 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0) 
# 72 "../crypto/cms/cms_lib.c"
                      ? &cms->ctx : 
# 72 "../crypto/cms/cms_lib.c" 3 4
                                    ((void *)0)
# 72 "../crypto/cms/cms_lib.c"
...
{
    return ctx != 
# 77 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0) 
# 77 "../crypto/cms/cms_lib.c"
                      ? ctx->libctx : 
# 77 "../crypto/cms/cms_lib.c" 3 4
                                      ((void *)0)
# 77 "../crypto/cms/cms_lib.c"
...
{
    return ctx != 
# 82 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0) 
# 82 "../crypto/cms/cms_lib.c"
                      ? ctx->propq : 
# 82 "../crypto/cms/cms_lib.c" 3 4
                                     ((void *)0)
# 82 "../crypto/cms/cms_lib.c"
...
void ossl_cms_resolve_libctx(CMS_ContentInfo *ci)
{
    ...
    if (pcerts != 
# 98 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 98 "../crypto/cms/cms_lib.c"
                     ) {
...
CMS_ContentInfo *ossl_cms_Data_create(OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (cms != 
# 116 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 116 "../crypto/cms/cms_lib.c"
                  ) {
...
BIO *ossl_cms_content_bio(CMS_ContentInfo *cms)
{
    ...
    if (pos == 
# 128 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 128 "../crypto/cms/cms_lib.c"
                  )
        return 
# 129 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 129 "../crypto/cms/cms_lib.c"
                  ;

    if (*pos == 
# 131 "../crypto/cms/cms_lib.c" 3 4
               ((void *)0)
# 131 "../crypto/cms/cms_lib.c"
                   )
    ...
    if (*pos == 
# 136 "../crypto/cms/cms_lib.c" 3 4
               ((void *)0) 
# 136 "../crypto/cms/cms_lib.c"
                    || ((*pos)->flags == 0x020))
...
BIO *CMS_dataInit(CMS_ContentInfo *cms, BIO *icont)
{
    ...
    if (!cont) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",150,__func__), ERR_set_error)((46),(127),
# 150 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 150 "../crypto/cms/cms_lib.c"
       );
        return 
# 151 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 151 "../crypto/cms/cms_lib.c"
                  ;
    }
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",184,__func__), ERR_set_error)((46),(156),
# 184 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 184 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
...
err:
    if (!icont)
        BIO_free(cont);
    return 
# 193 "../crypto/cms/cms_lib.c" 3 4
          ((void *)0)
# 193 "../crypto/cms/cms_lib.c"
              ;
...
{
    return ossl_cms_DataFinal(cms, cmsbio, 
# 200 "../crypto/cms/cms_lib.c" 3 4
                                          ((void *)0)
# 200 "../crypto/cms/cms_lib.c"
                                              , 0);
}
                       ...
                       unsigned int precomp_mdlen)
{
    ...
    if (pos == 
# 209 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 209 "../crypto/cms/cms_lib.c"
                  )
        return 0;
    ...
    if (*pos && ((*pos)->flags & 0x020)) {
        ...
        if (!mbio) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",218,__func__), ERR_set_error)((46),(105),
# 218 "../crypto/cms/cms_lib.c" 3 4
           ((void *)0)
# 218 "../crypto/cms/cms_lib.c"
           );
            return 0;
        }
        ...
        BIO_ctrl(mbio,130,0,
# 224 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 224 "../crypto/cms/cms_lib.c"
       );
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",250,__func__), ERR_set_error)((46),(156),
# 250 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 250 "../crypto/cms/cms_lib.c"
       );
        return 0;
    }
}
...
ASN1_OCTET_STRING **CMS_get0_content(CMS_ContentInfo *cms)
{
    ...
    default:
        ...
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",292,__func__), ERR_set_error)((46),(152),
# 292 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 292 "../crypto/cms/cms_lib.c"
       );
        return 
# 293 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 293 "../crypto/cms/cms_lib.c"
                  ;
...
static ASN1_OBJECT **cms_get0_econtent_type(CMS_ContentInfo *cms)
{
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",329,__func__), ERR_set_error)((46),(152),
# 329 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 329 "../crypto/cms/cms_lib.c"
       );
        return 
# 330 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 330 "../crypto/cms/cms_lib.c"
                  ;
...
const ASN1_OBJECT *CMS_get0_eContentType(CMS_ContentInfo *cms)
{
    ...
    if (petype)
        return *petype;
    return 
# 341 "../crypto/cms/cms_lib.c" 3 4
          ((void *)0)
# 341 "../crypto/cms/cms_lib.c"
              ;
}
...
int CMS_set1_eContentType(CMS_ContentInfo *cms, const ASN1_OBJECT *oid)
{
    ...
    petype = cms_get0_econtent_type(cms);
    if (petype == 
# 349 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 349 "../crypto/cms/cms_lib.c"
                     )
        return 0;
    if (oid == 
# 351 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 351 "../crypto/cms/cms_lib.c"
                  )
        return 1;
    etype = OBJ_dup(oid);
    if (etype == 
# 354 "../crypto/cms/cms_lib.c" 3 4
                ((void *)0)
# 354 "../crypto/cms/cms_lib.c"
                    )
        return 0;
...
int CMS_is_detached(CMS_ContentInfo *cms)
{
    ...
    if (pos == 
# 366 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 366 "../crypto/cms/cms_lib.c"
                  )
        return -1;
    if (*pos != 
# 368 "../crypto/cms/cms_lib.c" 3 4
               ((void *)0)
# 368 "../crypto/cms/cms_lib.c"
                   )
        return 0;
    return 1;
}
...
int CMS_set_detached(CMS_ContentInfo *cms, int detached)
{
    ...
    pos = CMS_get0_content(cms);
    if (pos == 
# 378 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 378 "../crypto/cms/cms_lib.c"
                  )
        return 0;
    if (detached) {
        ASN1_OCTET_STRING_free(*pos);
        *pos = 
# 382 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 382 "../crypto/cms/cms_lib.c"
                  ;
        return 1;
    }
    if (*pos == 
# 385 "../crypto/cms/cms_lib.c" 3 4
               ((void *)0)
# 385 "../crypto/cms/cms_lib.c"
                   )
        *pos = ASN1_OCTET_STRING_new();
    if (*pos != 
# 387 "../crypto/cms/cms_lib.c" 3 4
               ((void *)0)
# 387 "../crypto/cms/cms_lib.c"
                   ) {
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",394,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 394 "../crypto/cms/cms_lib.c" 3 4
   ((void *)0)
# 394 "../crypto/cms/cms_lib.c"
   );
    return 0;
}
...
{
    BIO *mdbio = 
# 403 "../crypto/cms/cms_lib.c" 3 4
                ((void *)0)
# 403 "../crypto/cms/cms_lib.c"
                    ;
    const ASN1_OBJECT *digestoid;
    const EVP_MD *digest = 
# 405 "../crypto/cms/cms_lib.c" 3 4
                          ((void *)0)
# 405 "../crypto/cms/cms_lib.c"
                              ;
    EVP_MD *fetched_digest = 
# 406 "../crypto/cms/cms_lib.c" 3 4
                            ((void *)0)
# 406 "../crypto/cms/cms_lib.c"
                                ;
    char alg[50];

    X509_ALGOR_get0(&digestoid, 
# 409 "../crypto/cms/cms_lib.c" 3 4
                               ((void *)0)
# 409 "../crypto/cms/cms_lib.c"
                                   , 
# 409 "../crypto/cms/cms_lib.c" 3 4
                                     ((void *)0)
# 409 "../crypto/cms/cms_lib.c"
    ...
    if (fetched_digest != 
# 416 "../crypto/cms/cms_lib.c" 3 4
                         ((void *)0)
# 416 "../crypto/cms/cms_lib.c"
                             )
        digest = fetched_digest;
    else
        digest = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(digestoid)));
    if (digest == 
# 420 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 420 "../crypto/cms/cms_lib.c"
                     ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",422,__func__), ERR_set_error)((46),(149),
# 422 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 422 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
    ...
    if (mdbio == 
# 428 "../crypto/cms/cms_lib.c" 3 4
                ((void *)0) 
# 428 "../crypto/cms/cms_lib.c"
                     || BIO_ctrl(mdbio,111,0,(void *)(digest)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",429,__func__), ERR_set_error)((46),(119),
# 429 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 429 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
 ...
 err:
    ...
    BIO_free(mdbio);
    return 
# 437 "../crypto/cms/cms_lib.c" 3 4
          ((void *)0)
# 437 "../crypto/cms/cms_lib.c"
              ;
}
                                      ...
                                      X509_ALGOR *mdalg)
{
    ...
    X509_ALGOR_get0(&mdoid, 
# 447 "../crypto/cms/cms_lib.c" 3 4
                           ((void *)0)
# 447 "../crypto/cms/cms_lib.c"
                               , 
# 447 "../crypto/cms/cms_lib.c" 3 4
                                 ((void *)0)
# 447 "../crypto/cms/cms_lib.c"
    ...
    for (;;) {
        ...
        if (chain == 
# 453 "../crypto/cms/cms_lib.c" 3 4
                    ((void *)0)
# 453 "../crypto/cms/cms_lib.c"
                        ) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",454,__func__), ERR_set_error)((46),(131),
# 454 "../crypto/cms/cms_lib.c" 3 4
           ((void *)0)
# 454 "../crypto/cms/cms_lib.c"
           );
            return 0;
        }
        BIO_ctrl(chain,120,0,(&mtmp));
        if (EVP_MD_get_type(EVP_MD_CTX_get0_md(mtmp)) == nid
...
**cms_get0_certificate_choices(CMS_ContentInfo *cms)
{
    ...
    case 23:
        if (cms->d.envelopedData->originatorInfo == 
# 478 "../crypto/cms/cms_lib.c" 3 4
                                                   ((void *)0)
# 478 "../crypto/cms/cms_lib.c"
                                                       )
            return 
# 479 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 479 "../crypto/cms/cms_lib.c"
                      ;
        return &cms->d.envelopedData->originatorInfo->certificates;

    case 1059:
        if (cms->d.authEnvelopedData->originatorInfo == 
# 483 "../crypto/cms/cms_lib.c" 3 4
                                                       ((void *)0)
# 483 "../crypto/cms/cms_lib.c"
                                                           )
            return 
# 484 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 484 "../crypto/cms/cms_lib.c"
                      ;
        return &cms->d.authEnvelopedData->originatorInfo->certificates;

    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",488,__func__), ERR_set_error)((46),(152),
# 488 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 488 "../crypto/cms/cms_lib.c"
       );
        return 
# 489 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 489 "../crypto/cms/cms_lib.c"
                  ;
...
CMS_CertificateChoices *CMS_add0_CertificateChoices(CMS_ContentInfo *cms)
{
    ...
    if (pcerts == 
# 500 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 500 "../crypto/cms/cms_lib.c"
                     )
        return 
# 501 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 501 "../crypto/cms/cms_lib.c"
                  ;
    if (*pcerts == 
# 502 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 502 "../crypto/cms/cms_lib.c"
                      )
        *pcerts = sk_CMS_CertificateChoices_new_null();
    if (*pcerts == 
# 504 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 504 "../crypto/cms/cms_lib.c"
                      )
        return 
# 505 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 505 "../crypto/cms/cms_lib.c"
                  ;
    cch = (CMS_CertificateChoices *)ASN1_item_new((CMS_CertificateChoices_it()));
    if (!cch)
        return 
# 508 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 508 "../crypto/cms/cms_lib.c"
                  ;
    if (!sk_CMS_CertificateChoices_push(*pcerts, cch)) {
        ASN1_item_free(((void*) (1 ? cch : (CMS_CertificateChoices*)0)), (CMS_CertificateChoices_it()));
        return 
# 511 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 511 "../crypto/cms/cms_lib.c"
                  ;
    }
    return cch;
}
...
int CMS_add0_cert(CMS_ContentInfo *cms, X509 *cert)
{
    ...
    pcerts = cms_get0_certificate_choices(cms);
    if (pcerts == 
# 523 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 523 "../crypto/cms/cms_lib.c"
                     )
        return 0;
    for (i = 0; i < sk_CMS_CertificateChoices_num(*pcerts); i++) {
        cch = sk_CMS_CertificateChoices_value(*pcerts, i);
...
**cms_get0_revocation_choices(CMS_ContentInfo *cms)
{
    ...
    case 23:
        if (cms->d.envelopedData->originatorInfo == 
# 561 "../crypto/cms/cms_lib.c" 3 4
                                                   ((void *)0)
# 561 "../crypto/cms/cms_lib.c"
                                                       )
            return 
# 562 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 562 "../crypto/cms/cms_lib.c"
                      ;
        return &cms->d.envelopedData->originatorInfo->crls;

    case 1059:
        if (cms->d.authEnvelopedData->originatorInfo == 
# 566 "../crypto/cms/cms_lib.c" 3 4
                                                       ((void *)0)
# 566 "../crypto/cms/cms_lib.c"
                                                           )
            return 
# 567 "../crypto/cms/cms_lib.c" 3 4
                  ((void *)0)
# 567 "../crypto/cms/cms_lib.c"
                      ;
        return &cms->d.authEnvelopedData->originatorInfo->crls;

    default:
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",571,__func__), ERR_set_error)((46),(152),
# 571 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 571 "../crypto/cms/cms_lib.c"
       );
        return 
# 572 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 572 "../crypto/cms/cms_lib.c"
                  ;
...
CMS_RevocationInfoChoice *CMS_add0_RevocationInfoChoice(CMS_ContentInfo *cms)
{
    ...
    if (pcrls == 
# 583 "../crypto/cms/cms_lib.c" 3 4
                ((void *)0)
# 583 "../crypto/cms/cms_lib.c"
                    )
        return 
# 584 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 584 "../crypto/cms/cms_lib.c"
                  ;
    if (*pcrls == 
# 585 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 585 "../crypto/cms/cms_lib.c"
                     )
        *pcrls = ((struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_new_null());
    if (*pcrls == 
# 587 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 587 "../crypto/cms/cms_lib.c"
                     )
        return 
# 588 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 588 "../crypto/cms/cms_lib.c"
                  ;
    rch = (CMS_RevocationInfoChoice *)ASN1_item_new((CMS_RevocationInfoChoice_it()));
    if (rch == 
# 590 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 590 "../crypto/cms/cms_lib.c"
                  )
        return 
# 591 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 591 "../crypto/cms/cms_lib.c"
                  ;
    if (!OPENSSL_sk_push(ossl_check_CMS_RevocationInfoChoice_sk_type(*pcrls), ossl_check_CMS_RevocationInfoChoice_type(rch))) {
        ASN1_item_free(((void*) (1 ? rch : (CMS_RevocationInfoChoice*)0)), (CMS_RevocationInfoChoice_it()));
        return 
# 594 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 594 "../crypto/cms/cms_lib.c"
                  ;
    }
    return rch;
}
...
int CMS_add0_crl(CMS_ContentInfo *cms, X509_CRL *crl)
{
    ...
    if (rch == 
# 603 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 603 "../crypto/cms/cms_lib.c"
                  )
        return 0;
    rch->type = 0;
    rch->d.crl = crl;
...
{
    struct stack_st_X509 *certs = 
# 622 "../crypto/cms/cms_lib.c" 3 4
                           ((void *)0)
# 622 "../crypto/cms/cms_lib.c"
                               ;
    CMS_CertificateChoices *cch;
    struct stack_st_CMS_CertificateChoices **pcerts;
    int i;
    ...
    pcerts = cms_get0_certificate_choices(cms);
    if (pcerts == 
# 628 "../crypto/cms/cms_lib.c" 3 4
                 ((void *)0)
# 628 "../crypto/cms/cms_lib.c"
                     )
        return 
# 629 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 629 "../crypto/cms/cms_lib.c"
                  ;
    for (i = 0; i < sk_CMS_CertificateChoices_num(*pcerts); i++) {
        cch = sk_CMS_CertificateChoices_value(*pcerts, i);
        if (cch->type == 0) {
            if (!ossl_x509_add_cert_new(&certs, cch->d.certificate,
                ...
                return 
# 636 "../crypto/cms/cms_lib.c" 3 4
                      ((void *)0)
# 636 "../crypto/cms/cms_lib.c"
                          ;
            }
        }
    }
...
{
    struct stack_st_X509_CRL *crls = 
# 646 "../crypto/cms/cms_lib.c" 3 4
                              ((void *)0)
# 646 "../crypto/cms/cms_lib.c"
                                  ;
    struct stack_st_CMS_RevocationInfoChoice **pcrls;
    CMS_RevocationInfoChoice *rch;
    int i;
    ...
    pcrls = cms_get0_revocation_choices(cms);
    if (pcrls == 
# 652 "../crypto/cms/cms_lib.c" 3 4
                ((void *)0)
# 652 "../crypto/cms/cms_lib.c"
                    )
        return 
# 653 "../crypto/cms/cms_lib.c" 3 4
              ((void *)0)
# 653 "../crypto/cms/cms_lib.c"
                  ;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CMS_RevocationInfoChoice_sk_type(*pcrls)); i++) {
        rch = ((CMS_RevocationInfoChoice *)OPENSSL_sk_value(ossl_check_const_CMS_RevocationInfoChoice_sk_type(*pcrls), (i)));
        if (rch->type == 0) {
            if (crls == 
# 657 "../crypto/cms/cms_lib.c" 3 4
                       ((void *)0)
# 657 "../crypto/cms/cms_lib.c"
                           ) {
                if ((crls = ((struct stack_st_X509_CRL *)OPENSSL_sk_new_null())) == 
# 658 "../crypto/cms/cms_lib.c" 3 4
                                                      ((void *)0)
# 658 "../crypto/cms/cms_lib.c"
                                                          )
                    return 
# 659 "../crypto/cms/cms_lib.c" 3 4
                          ((void *)0)
# 659 "../crypto/cms/cms_lib.c"
                              ;
            }
            if (!OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(crls), ossl_check_X509_CRL_type(rch->d.crl))
                    || !X509_CRL_up_ref(rch->d.crl)) {
                OPENSSL_sk_pop_free(ossl_check_X509_CRL_sk_type(crls),ossl_check_X509_CRL_freefunc_type(X509_CRL_free));
                return 
# 664 "../crypto/cms/cms_lib.c" 3 4
                      ((void *)0)
# 664 "../crypto/cms/cms_lib.c"
                          ;
            }
        }
    }
...
int ossl_cms_keyid_cert_cmp(ASN1_OCTET_STRING *keyid, X509 *cert)
{
    ...
    if (cert_keyid == 
# 684 "../crypto/cms/cms_lib.c" 3 4
                     ((void *)0)
# 684 "../crypto/cms/cms_lib.c"
                         )
        return -1;
...
int ossl_cms_set1_ias(CMS_IssuerAndSerialNumber **pias, X509 *cert)
{
    ...
    if (!ias) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",694,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 694 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 694 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
    if (!X509_NAME_set(&ias->issuer, X509_get_issuer_name(cert))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",698,__func__), ERR_set_error)((46),((11 | (0x2 << 18L))),
# 698 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 698 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
    if (!ASN1_STRING_copy(ias->serialNumber, X509_get0_serialNumber(cert))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",702,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 702 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 702 "../crypto/cms/cms_lib.c"
       );
        goto err;
    }
...
{
    ASN1_OCTET_STRING *keyid = 
# 715 "../crypto/cms/cms_lib.c" 3 4
                              ((void *)0)
# 715 "../crypto/cms/cms_lib.c"
                                  ;
    const ASN1_OCTET_STRING *cert_keyid;
    cert_keyid = X509_get0_subject_key_id(cert);
    if (cert_keyid == 
# 718 "../crypto/cms/cms_lib.c" 3 4
                     ((void *)0)
# 718 "../crypto/cms/cms_lib.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",719,__func__), ERR_set_error)((46),(160),
# 719 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 719 "../crypto/cms/cms_lib.c"
       );
        return 0;
    }
    keyid = ASN1_STRING_dup(cert_keyid);
    if (!keyid) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_lib.c",724,__func__), ERR_set_error)((46),((13 | (0x2 << 18L))),
# 724 "../crypto/cms/cms_lib.c" 3 4
       ((void *)0)
# 724 "../crypto/cms/cms_lib.c"
       );
        return 0;
    }
