# 0 "../crypto/cms/cms_ec.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_ec.c"
# 10 "../crypto/cms/cms_ec.c"
...
# 19 "../crypto/cms/cms_ec.c" 2

static EVP_PKEY *pkey_type2param(int ptype, const void *pval,
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    EVP_PKEY *pkey = 
# 23 "../crypto/cms/cms_ec.c" 3 4
                    ((void *)0)
# 23 "../crypto/cms/cms_ec.c"
                        ;
    EVP_PKEY_CTX *pctx = 
# 24 "../crypto/cms/cms_ec.c" 3 4
                        ((void *)0)
# 24 "../crypto/cms/cms_ec.c"
                            ;
    OSSL_DECODER_CTX *ctx = 
# 25 "../crypto/cms/cms_ec.c" 3 4
                           ((void *)0)
# 25 "../crypto/cms/cms_ec.c"
                               ;
    ...
    if (ptype == 16) {
        ...
        int selection = ( 0x04 | 0x80);

        ctx = OSSL_DECODER_CTX_new_for_pkey(&pkey, "DER", 
# 33 "../crypto/cms/cms_ec.c" 3 4
                                                         ((void *)0)
# 33 "../crypto/cms/cms_ec.c"
                                                             , "EC",
                                            selection, libctx, propq);
        if (ctx == 
# 35 "../crypto/cms/cms_ec.c" 3 4
                  ((void *)0)
# 35 "../crypto/cms/cms_ec.c"
                      )
            goto err;

        if (!OSSL_DECODER_from_data(ctx, &pm, &pmlen)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",39,__func__), ERR_set_error)((46),(187),
# 39 "../crypto/cms/cms_ec.c" 3 4
           ((void *)0)
# 39 "../crypto/cms/cms_ec.c"
           );
            goto err;
        }
        ...
        if (pctx == 
# 50 "../crypto/cms/cms_ec.c" 3 4
                   ((void *)0) 
# 50 "../crypto/cms/cms_ec.c"
                        || EVP_PKEY_paramgen_init(pctx) <= 0)
            goto err;
        if (OBJ_obj2txt(groupname, sizeof(groupname), poid, 0) <= 0
                || EVP_PKEY_CTX_set_group_name(pctx, groupname) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",54,__func__), ERR_set_error)((46),(187),
# 54 "../crypto/cms/cms_ec.c" 3 4
           ((void *)0)
# 54 "../crypto/cms/cms_ec.c"
           );
            goto err;
        }
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",63,__func__), ERR_set_error)((46),(187),
# 63 "../crypto/cms/cms_ec.c" 3 4
   ((void *)0)
# 63 "../crypto/cms/cms_ec.c"
   );
    return 
# 64 "../crypto/cms/cms_ec.c" 3 4
          ((void *)0)
# 64 "../crypto/cms/cms_ec.c"
              ;
 ...
 err:
    ...
    OSSL_DECODER_CTX_free(ctx);
    return 
# 70 "../crypto/cms/cms_ec.c" 3 4
          ((void *)0)
# 70 "../crypto/cms/cms_ec.c"
              ;
}
                                ...
                                X509_ALGOR *alg, ASN1_BIT_STRING *pubkey)
{
    ...
    int rv = 0;
    EVP_PKEY *pkpeer = 
# 80 "../crypto/cms/cms_ec.c" 3 4
                      ((void *)0)
# 80 "../crypto/cms/cms_ec.c"
                          ;
    const unsigned char *p;
    int plen;

    X509_ALGOR_get0(&aoid, &atype, &aval, alg);
    if (OBJ_obj2nid(aoid) != 408)
        goto err;
    ...
    if (atype == -1 || atype == 5) {
        ...
        if (pk == 
# 93 "../crypto/cms/cms_ec.c" 3 4
                 ((void *)0)
# 93 "../crypto/cms/cms_ec.c"
                     )
            goto err;

        pkpeer = EVP_PKEY_new();
        if (pkpeer == 
# 97 "../crypto/cms/cms_ec.c" 3 4
                     ((void *)0)
# 97 "../crypto/cms/cms_ec.c"
                         )
            goto err;
        ...
        if (pkpeer == 
# 105 "../crypto/cms/cms_ec.c" 3 4
                     ((void *)0)
# 105 "../crypto/cms/cms_ec.c"
                         )
            goto err;
    }
    ...
    if (p == 
# 111 "../crypto/cms/cms_ec.c" 3 4
            ((void *)0) 
# 111 "../crypto/cms/cms_ec.c"
                 || plen == 0)
        goto err;
...
static int ecdh_cms_set_kdf_param(EVP_PKEY_CTX *pctx, int eckdf_nid)
{
    ...
    if (EVP_PKEY_CTX_set_ecdh_kdf_type(pctx, 2) <= 0)
        return 0;

    kdf_md = EVP_get_digestbyname(OBJ_nid2sn(kdfmd_nid));
    if (!kdf_md)
        return 0;
...
{
    int rv = 0;
    X509_ALGOR *alg, *kekalg = 
# 162 "../crypto/cms/cms_ec.c" 3 4
                              ((void *)0)
# 162 "../crypto/cms/cms_ec.c"
                                  ;
    ASN1_OCTET_STRING *ukm;
    const unsigned char *p;
    unsigned char *der = 
# 165 "../crypto/cms/cms_ec.c" 3 4
                        ((void *)0)
# 165 "../crypto/cms/cms_ec.c"
                            ;
    int plen, keylen;
    EVP_CIPHER *kekcipher = 
# 167 "../crypto/cms/cms_ec.c" 3 4
                           ((void *)0)
# 167 "../crypto/cms/cms_ec.c"
                               ;
    ...
    if (!ecdh_cms_set_kdf_param(pctx, OBJ_obj2nid(alg->algorithm))) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",175,__func__), ERR_set_error)((46),(186),
# 175 "../crypto/cms/cms_ec.c" 3 4
       ((void *)0)
# 175 "../crypto/cms/cms_ec.c"
       );
        return 0;
    }

    if (alg->parameter->type != 16)
        return 0;

    p = alg->parameter->value.sequence->data;
    plen = alg->parameter->value.sequence->length;
    kekalg = d2i_X509_ALGOR(
# 184 "../crypto/cms/cms_ec.c" 3 4
                           ((void *)0)
# 184 "../crypto/cms/cms_ec.c"
                               , &p, plen);
    if (kekalg == 
# 185 "../crypto/cms/cms_ec.c" 3 4
                 ((void *)0)
# 185 "../crypto/cms/cms_ec.c"
                     )
        goto err;
    kekctx = CMS_RecipientInfo_kari_get0_ctx(ri);
    if (kekctx == 
# 188 "../crypto/cms/cms_ec.c" 3 4
                 ((void *)0)
# 188 "../crypto/cms/cms_ec.c"
                     )
        goto err;
    OBJ_obj2txt(name, sizeof(name), kekalg->algorithm, 0);
    kekcipher = EVP_CIPHER_fetch(pctx->libctx, name, pctx->propquery);
    if (kekcipher == 
# 192 "../crypto/cms/cms_ec.c" 3 4
                    ((void *)0) 
# 192 "../crypto/cms/cms_ec.c"
                         || EVP_CIPHER_get_mode(kekcipher) != 0x10002)
        goto err;
    if (!EVP_EncryptInit_ex(kekctx, kekcipher, 
# 194 "../crypto/cms/cms_ec.c" 3 4
                                              ((void *)0)
# 194 "../crypto/cms/cms_ec.c"
                                                  , 
# 194 "../crypto/cms/cms_ec.c" 3 4
                                                    ((void *)0)
# 194 "../crypto/cms/cms_ec.c"
...
# 194 "../crypto/cms/cms_ec.c"
    ...
    if (EVP_PKEY_CTX_set0_ecdh_kdf_ukm(pctx, der, plen) <= 0)
        goto err;
    der = 
# 210 "../crypto/cms/cms_ec.c" 3 4
         ((void *)0)
# 210 "../crypto/cms/cms_ec.c"
             ;
 ...
 err:
    ...
    CRYPTO_free(der, "../crypto/cms/cms_ec.c", 216);
    return rv;
}
...
static int ecdh_cms_decrypt(CMS_RecipientInfo *ri)
{
    ...
    if (pctx == 
# 225 "../crypto/cms/cms_ec.c" 3 4
               ((void *)0)
# 225 "../crypto/cms/cms_ec.c"
                   )
        return 0;
...
# 233 "../crypto/cms/cms_ec.c" 3 4
                                                ((void *)0)
# 233 "../crypto/cms/cms_ec.c"
                                                    , 
# 233 "../crypto/cms/cms_ec.c" 3 4
                                                      ((void *)0)
# 233 "../crypto/cms/cms_ec.c"
...
# 233 "../crypto/cms/cms_ec.c"
            ...
            return 0;
        if (alg == 
# 235 "../crypto/cms/cms_ec.c" 3 4
                  ((void *)0) 
# 235 "../crypto/cms/cms_ec.c"
                       || pubkey == 
# 235 "../crypto/cms/cms_ec.c" 3 4
                                    ((void *)0)
# 235 "../crypto/cms/cms_ec.c"
        ...
        if (!ecdh_cms_set_peerkey(pctx, alg, pubkey)) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",238,__func__), ERR_set_error)((46),(188),
# 238 "../crypto/cms/cms_ec.c" 3 4
           ((void *)0)
# 238 "../crypto/cms/cms_ec.c"
           );
            return 0;
        }
    }
    ...
    if (!ecdh_cms_set_shared_info(pctx, ri)) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",244,__func__), ERR_set_error)((46),(189),
# 244 "../crypto/cms/cms_ec.c" 3 4
       ((void *)0)
# 244 "../crypto/cms/cms_ec.c"
       );
        return 0;
    }
    return 1;
...
static int ecdh_cms_encrypt(CMS_RecipientInfo *ri)
{
    ...
    EVP_CIPHER_CTX *ctx;
    int keylen;
    X509_ALGOR *talg, *wrap_alg = 
# 256 "../crypto/cms/cms_ec.c" 3 4
                                 ((void *)0)
# 256 "../crypto/cms/cms_ec.c"
                                     ;
    const ASN1_OBJECT *aoid;
    ASN1_BIT_STRING *pubkey;
    ...
    ASN1_OCTET_STRING *ukm;
    unsigned char *penc = 
# 261 "../crypto/cms/cms_ec.c" 3 4
                         ((void *)0)
# 261 "../crypto/cms/cms_ec.c"
                             ;
    int penclen;
    int rv = 0;
    ...
    pctx = CMS_RecipientInfo_get0_pkey_ctx(ri);
    if (pctx == 
# 268 "../crypto/cms/cms_ec.c" 3 4
               ((void *)0)
# 268 "../crypto/cms/cms_ec.c"
                   )
        return 0;
...
# 273 "../crypto/cms/cms_ec.c" 3 4
                                            ((void *)0)
# 273 "../crypto/cms/cms_ec.c"
                                                , 
# 273 "../crypto/cms/cms_ec.c" 3 4
                                                  ((void *)0)
# 273 "../crypto/cms/cms_ec.c"
...
# 275 "../crypto/cms/cms_ec.c" 3 4
                          ((void *)0)
# 275 "../crypto/cms/cms_ec.c"
                              , 
# 275 "../crypto/cms/cms_ec.c" 3 4
                                ((void *)0)
# 275 "../crypto/cms/cms_ec.c"
    ...
    if (aoid == OBJ_nid2obj(0)) {

        size_t enckeylen;

        enckeylen = EVP_PKEY_get1_encoded_public_key(pkey, &penc);
        if (enckeylen > 0x7fffffff 
# 282 "../crypto/cms/cms_ec.c"
                               || enckeylen == 0)
            goto err;
        ...
        penc = 
# 287 "../crypto/cms/cms_ec.c" 3 4
              ((void *)0)
# 287 "../crypto/cms/cms_ec.c"
                  ;
        (void)X509_ALGOR_set0(talg, OBJ_nid2obj(408),
                              -1, 
# 289 "../crypto/cms/cms_ec.c" 3 4
                                           ((void *)0)
# 289 "../crypto/cms/cms_ec.c"
                                               );
    }
    ...
    if (kdf_type == 1) {
        ...
        goto err;
    if (kdf_md == 
# 313 "../crypto/cms/cms_ec.c" 3 4
                 ((void *)0)
# 313 "../crypto/cms/cms_ec.c"
                     ) {
    ...
    wrap_nid = EVP_CIPHER_get_type(EVP_CIPHER_CTX_get0_cipher(ctx));
    ...
    if (wrap_alg == 
# 335 "../crypto/cms/cms_ec.c" 3 4
                   ((void *)0)
# 335 "../crypto/cms/cms_ec.c"
                       )
        goto err;
    wrap_alg->algorithm = OBJ_nid2obj(wrap_nid);
    wrap_alg->parameter = ASN1_TYPE_new();
    if (wrap_alg->parameter == 
# 339 "../crypto/cms/cms_ec.c" 3 4
                              ((void *)0)
# 339 "../crypto/cms/cms_ec.c"
                                  )
        goto err;
    if (EVP_CIPHER_param_to_asn1(ctx, wrap_alg->parameter) <= 0)
        goto err;
    if (ASN1_TYPE_get(wrap_alg->parameter) == 0) {
        ASN1_TYPE_free(wrap_alg->parameter);
        wrap_alg->parameter = 
# 345 "../crypto/cms/cms_ec.c" 3 4
                             ((void *)0)
# 345 "../crypto/cms/cms_ec.c"
                                 ;
    }
    ...
    if (EVP_PKEY_CTX_set0_ecdh_kdf_ukm(pctx, penc, penclen) <= 0)
        goto err;
    penc = 
# 358 "../crypto/cms/cms_ec.c" 3 4
          ((void *)0)
# 358 "../crypto/cms/cms_ec.c"
              ;
    ...
    if (wrap_str == 
# 368 "../crypto/cms/cms_ec.c" 3 4
                   ((void *)0)
# 368 "../crypto/cms/cms_ec.c"
                       )
        goto err;
    ASN1_STRING_set0(wrap_str, penc, penclen);
    penc = 
# 371 "../crypto/cms/cms_ec.c" 3 4
          ((void *)0)
# 371 "../crypto/cms/cms_ec.c"
              ;
    rv = X509_ALGOR_set0(talg, OBJ_nid2obj(kdf_nid), 16, wrap_str);
    if (!rv)
        ASN1_STRING_free(wrap_str);

 err:
    CRYPTO_free(penc, "../crypto/cms/cms_ec.c", 377);
...
# 384 "../crypto/cms/cms_ec.c" 3 4
   ((void) (0))
# 384 "../crypto/cms/cms_ec.c"
                                       ;
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_ec.c",392,__func__), ERR_set_error)((46),(125),
# 392 "../crypto/cms/cms_ec.c" 3 4
   ((void *)0)
# 392 "../crypto/cms/cms_ec.c"
   );
    return 0;
}
