# 0 "../crypto/cms/cms_rsa.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_rsa.c"
# 10 "../crypto/cms/cms_rsa.c"
...
# 13 "../crypto/cms/cms_rsa.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/cms/cms_rsa.c" 2
...
# 18 "../crypto/cms/cms_rsa.c" 2

static RSA_OAEP_PARAMS *rsa_oaep_decode(const X509_ALGOR *alg)
{
    RSA_OAEP_PARAMS *oaep;

    oaep = ASN1_TYPE_unpack_sequence((RSA_OAEP_PARAMS_it()),
                                     alg->parameter);

    if (oaep == 
# 26 "../crypto/cms/cms_rsa.c" 3 4
               ((void *)0)
# 26 "../crypto/cms/cms_rsa.c"
                   )
        return 
# 27 "../crypto/cms/cms_rsa.c" 3 4
              ((void *)0)
# 27 "../crypto/cms/cms_rsa.c"
                  ;

    if (oaep->maskGenFunc != 
# 29 "../crypto/cms/cms_rsa.c" 3 4
                            ((void *)0)
# 29 "../crypto/cms/cms_rsa.c"
                                ) {
        oaep->maskHash = ossl_x509_algor_mgf1_decode(oaep->maskGenFunc);
        if (oaep->maskHash == 
# 31 "../crypto/cms/cms_rsa.c" 3 4
                             ((void *)0)
# 31 "../crypto/cms/cms_rsa.c"
                                 ) {
            RSA_OAEP_PARAMS_free(oaep);
            return 
# 33 "../crypto/cms/cms_rsa.c" 3 4
                  ((void *)0)
# 33 "../crypto/cms/cms_rsa.c"
                      ;
        }
    }
    return oaep;
...
static int rsa_cms_decrypt(CMS_RecipientInfo *ri)
{
    ...
    int rv = -1;
    unsigned char *label = 
# 45 "../crypto/cms/cms_rsa.c" 3 4
                          ((void *)0)
# 45 "../crypto/cms/cms_rsa.c"
                              ;
    int labellen = 0;
    const EVP_MD *mgf1md = 
# 47 "../crypto/cms/cms_rsa.c" 3 4
                          ((void *)0)
# 47 "../crypto/cms/cms_rsa.c"
                              , *md = 
# 47 "../crypto/cms/cms_rsa.c" 3 4
                                      ((void *)0)
# 47 "../crypto/cms/cms_rsa.c"
    ...
    if (pkctx == 
# 51 "../crypto/cms/cms_rsa.c" 3 4
                ((void *)0)
# 51 "../crypto/cms/cms_rsa.c"
                    )
        return 0;
    if (!CMS_RecipientInfo_ktri_get0_algs(ri, 
# 53 "../crypto/cms/cms_rsa.c" 3 4
                                             ((void *)0)
# 53 "../crypto/cms/cms_rsa.c"
                                                 , 
# 53 "../crypto/cms/cms_rsa.c" 3 4
                                                   ((void *)0)
# 53 "../crypto/cms/cms_rsa.c"
    ...
    if (nid == 6)
        return 1;
    if (nid != 919) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",59,__func__), ERR_set_error)((46),(192),
# 59 "../crypto/cms/cms_rsa.c" 3 4
       ((void *)0)
# 59 "../crypto/cms/cms_rsa.c"
       );
        return -1;
    }
    ...
    if (oaep == 
# 65 "../crypto/cms/cms_rsa.c" 3 4
               ((void *)0)
# 65 "../crypto/cms/cms_rsa.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",66,__func__), ERR_set_error)((46),(191),
# 66 "../crypto/cms/cms_rsa.c" 3 4
       ((void *)0)
# 66 "../crypto/cms/cms_rsa.c"
       );
        goto err;
    }
    ...
    if (mgf1md == 
# 71 "../crypto/cms/cms_rsa.c" 3 4
                 ((void *)0)
# 71 "../crypto/cms/cms_rsa.c"
                     )
        goto err;
    md = ossl_x509_algor_get_md(oaep->hashFunc);
    if (md == 
# 74 "../crypto/cms/cms_rsa.c" 3 4
             ((void *)0)
# 74 "../crypto/cms/cms_rsa.c"
                 )
        goto err;

    if (oaep->pSourceFunc != 
# 77 "../crypto/cms/cms_rsa.c" 3 4
                            ((void *)0)
# 77 "../crypto/cms/cms_rsa.c"
                                ) {
        X509_ALGOR *plab = oaep->pSourceFunc;

        if (OBJ_obj2nid(plab->algorithm) != 935) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",81,__func__), ERR_set_error)((46),(193),
# 81 "../crypto/cms/cms_rsa.c" 3 4
           ((void *)0)
# 81 "../crypto/cms/cms_rsa.c"
           );
            goto err;
        }
        if (plab->parameter->type != 4) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",85,__func__), ERR_set_error)((46),(190),
# 85 "../crypto/cms/cms_rsa.c" 3 4
           ((void *)0)
# 85 "../crypto/cms/cms_rsa.c"
           );
            goto err;
        }
        ...
        plab->parameter->value.octet_string->data = 
# 91 "../crypto/cms/cms_rsa.c" 3 4
                                                   ((void *)0)
# 91 "../crypto/cms/cms_rsa.c"
                                                       ;
        labellen = plab->parameter->value.octet_string->length;
    }

    if (EVP_PKEY_CTX_set_rsa_padding(pkctx, 4) <= 0)
        goto err;
    ...
    if (EVP_PKEY_CTX_set_rsa_mgf1_md(pkctx, mgf1md) <= 0)
        goto err;
    if (label != 
# 101 "../crypto/cms/cms_rsa.c" 3 4
                ((void *)0)
            
# 102 "../crypto/cms/cms_rsa.c"
           && EVP_PKEY_CTX_set0_rsa_oaep_label(pkctx, label, labellen) <= 0) {
        CRYPTO_free(label, "../crypto/cms/cms_rsa.c", 103);
        goto err;
    }
...
static int rsa_cms_encrypt(CMS_RecipientInfo *ri)
{
    ...
    RSA_OAEP_PARAMS *oaep = 
# 117 "../crypto/cms/cms_rsa.c" 3 4
                           ((void *)0)
# 117 "../crypto/cms/cms_rsa.c"
                               ;
    ASN1_STRING *os = 
# 118 "../crypto/cms/cms_rsa.c" 3 4
                     ((void *)0)
# 118 "../crypto/cms/cms_rsa.c"
                         ;
    ASN1_OCTET_STRING *los = 
# 119 "../crypto/cms/cms_rsa.c" 3 4
                            ((void *)0)
# 119 "../crypto/cms/cms_rsa.c"
                                ;
    X509_ALGOR *alg;
    EVP_PKEY_CTX *pkctx = CMS_RecipientInfo_get0_pkey_ctx(ri);
    int pad_mode = 1, rv = 0, labellen;
    unsigned char *label;

    if (CMS_RecipientInfo_ktri_get0_algs(ri, 
# 125 "../crypto/cms/cms_rsa.c" 3 4
                                            ((void *)0)
# 125 "../crypto/cms/cms_rsa.c"
                                                , 
# 125 "../crypto/cms/cms_rsa.c" 3 4
                                                  ((void *)0)
# 125 "../crypto/cms/cms_rsa.c"
        ...
        return 0;
    if (pkctx != 
# 127 "../crypto/cms/cms_rsa.c" 3 4
                ((void *)0)
# 127 "../crypto/cms/cms_rsa.c"
                    ) {
        if (EVP_PKEY_CTX_get_rsa_padding(pkctx, &pad_mode) <= 0)
            return 0;
    }
    if (pad_mode == 1)
        return X509_ALGOR_set0(alg, OBJ_nid2obj(6),
                               5, 
# 133 "../crypto/cms/cms_rsa.c" 3 4
                                           ((void *)0)
# 133 "../crypto/cms/cms_rsa.c"
                                               );
    ...
    if (oaep == 
# 146 "../crypto/cms/cms_rsa.c" 3 4
               ((void *)0)
# 146 "../crypto/cms/cms_rsa.c"
                   )
        goto err;
    ...
    if (labellen > 0) {
        ...
        if (los == 
# 155 "../crypto/cms/cms_rsa.c" 3 4
                  ((void *)0)
# 155 "../crypto/cms/cms_rsa.c"
                      )
            goto err;
        if (!ASN1_OCTET_STRING_set(los, label, labellen))
            goto err;

        oaep->pSourceFunc = ossl_X509_ALGOR_from_nid(935,
                                                     4, los);
        if (oaep->pSourceFunc == 
# 162 "../crypto/cms/cms_rsa.c" 3 4
                                ((void *)0)
# 162 "../crypto/cms/cms_rsa.c"
                                    )
            goto err;

        los = 
# 165 "../crypto/cms/cms_rsa.c" 3 4
             ((void *)0)
# 165 "../crypto/cms/cms_rsa.c"
                 ;
    }

    if (!ASN1_item_pack(oaep, (RSA_OAEP_PARAMS_it()), &os))
        goto err;
    if (!X509_ALGOR_set0(alg, OBJ_nid2obj(919), 16, os))
        goto err;
    os = 
# 172 "../crypto/cms/cms_rsa.c" 3 4
        ((void *)0)
# 172 "../crypto/cms/cms_rsa.c"
            ;
    rv = 1;
 err:
    RSA_OAEP_PARAMS_free(oaep);
...
# 183 "../crypto/cms/cms_rsa.c" 3 4
   ((void) (0))
# 183 "../crypto/cms/cms_rsa.c"
                                       ;
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",191,__func__), ERR_set_error)((46),(125),
# 191 "../crypto/cms/cms_rsa.c" 3 4
   ((void *)0)
# 191 "../crypto/cms/cms_rsa.c"
   );
    return 0;
}
...
# 205 "../crypto/cms/cms_rsa.c" 3 4
                                ((void *)0)
# 205 "../crypto/cms/cms_rsa.c"
                                    , 
# 205 "../crypto/cms/cms_rsa.c" 3 4
                                      ((void *)0)
# 205 "../crypto/cms/cms_rsa.c"
...
# 205 "../crypto/cms/cms_rsa.c"
                                                , &alg);
    if (pkctx != 
# 206 "../crypto/cms/cms_rsa.c" 3 4
                ((void *)0)
# 206 "../crypto/cms/cms_rsa.c"
                    ) {
        if (EVP_PKEY_CTX_get_rsa_padding(pkctx, &pad_mode) <= 0)
            return 0;
    }
    if (pad_mode == 1)
        return X509_ALGOR_set0(alg, OBJ_nid2obj(6),
                               5, 
# 212 "../crypto/cms/cms_rsa.c" 3 4
                                           ((void *)0)
# 212 "../crypto/cms/cms_rsa.c"
                                               );
    ...
    if (((pkctx)->keymgmt == 
# 218 "../crypto/cms/cms_rsa.c" 3 4
       ((void *)0)
# 218 "../crypto/cms/cms_rsa.c"
       )) {

        ASN1_STRING *os = 
# 220 "../crypto/cms/cms_rsa.c" 3 4
                         ((void *)0)
# 220 "../crypto/cms/cms_rsa.c"
                             ;

        os = ossl_rsa_ctx_to_pss_string(pkctx);
        if (os == 
# 223 "../crypto/cms/cms_rsa.c" 3 4
                 ((void *)0)
# 223 "../crypto/cms/cms_rsa.c"
                     )
            return 0;
        if (X509_ALGOR_set0(alg, OBJ_nid2obj(912), 16, os))
            return 1;
        ASN1_STRING_free(os);
        return 0;
    }
...
# 239 "../crypto/cms/cms_rsa.c" 3 4
                                             ((void *)0)
# 239 "../crypto/cms/cms_rsa.c"
                                                 )
        return 0;
    return 1;
}
...
static int rsa_cms_verify(CMS_SignerInfo *si)
{
    ...
    CMS_SignerInfo_get0_algs(si, 
# 251 "../crypto/cms/cms_rsa.c" 3 4
                                ((void *)0)
# 251 "../crypto/cms/cms_rsa.c"
                                    , 
# 251 "../crypto/cms/cms_rsa.c" 3 4
                                      ((void *)0)
# 251 "../crypto/cms/cms_rsa.c"
...
# 251 "../crypto/cms/cms_rsa.c"
    ...
    if (nid == 912)
        return ossl_rsa_pss_to_ctx(
# 254 "../crypto/cms/cms_rsa.c" 3 4
                                  ((void *)0)
# 254 "../crypto/cms/cms_rsa.c"
                                      , pkctx, alg, 
# 254 "../crypto/cms/cms_rsa.c" 3 4
                                                    ((void *)0)
# 254 "../crypto/cms/cms_rsa.c"
    ...
    if (EVP_PKEY_is_a(pkey, "RSA-PSS")) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",257,__func__), ERR_set_error)((4),(144),
# 257 "../crypto/cms/cms_rsa.c" 3 4
       ((void *)0)
# 257 "../crypto/cms/cms_rsa.c"
       );
        return 0;
    }
    if (nid == 6)
    ...
    if (OBJ_find_sigid_algs(nid, 
# 263 "../crypto/cms/cms_rsa.c" 3 4
                                ((void *)0)
# 263 "../crypto/cms/cms_rsa.c"
                                    , &nid2)) {
        if (nid2 == 6)
            return 1;
    }
...
# 272 "../crypto/cms/cms_rsa.c" 3 4
   ((void) (0))
# 272 "../crypto/cms/cms_rsa.c"
                                     ;
    ...
    (ERR_new(), ERR_set_debug("../crypto/cms/cms_rsa.c",280,__func__), ERR_set_error)((46),(125),
# 280 "../crypto/cms/cms_rsa.c" 3 4
   ((void *)0)
# 280 "../crypto/cms/cms_rsa.c"
   );
    return 0;
}
