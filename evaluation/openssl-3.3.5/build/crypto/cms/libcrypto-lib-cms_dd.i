# 0 "../crypto/cms/cms_dd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cms/cms_dd.c"
# 10 "../crypto/cms/cms_dd.c"
                                              ...
                                              const char *propq)
{
    ...
    if (cms == 
# 28 "../crypto/cms/cms_dd.c" 3 4
              ((void *)0)
# 28 "../crypto/cms/cms_dd.c"
                  )
        return 
# 29 "../crypto/cms/cms_dd.c" 3 4
              ((void *)0)
# 29 "../crypto/cms/cms_dd.c"
                  ;

    dd = (CMS_DigestedData *)ASN1_item_new((CMS_DigestedData_it()));

    if (dd == 
# 33 "../crypto/cms/cms_dd.c" 3 4
             ((void *)0)
# 33 "../crypto/cms/cms_dd.c"
                 )
        goto err;

    cms->contentType = OBJ_nid2obj(25);
    cms->d.digestedData = dd;

    dd->version = 0;
    dd->encapContentInfo->eContentType = OBJ_nid2obj(21);
 ...
 err:
    ...
    return 
# 48 "../crypto/cms/cms_dd.c" 3 4
          ((void *)0)
# 48 "../crypto/cms/cms_dd.c"
              ;
}
                                   ...
                                   int verify)
{
    ...
    if (mctx == 
# 68 "../crypto/cms/cms_dd.c" 3 4
               ((void *)0)
# 68 "../crypto/cms/cms_dd.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/cms/cms_dd.c",69,__func__), ERR_set_error)((46),((6 | (0x2 << 18L))),
# 69 "../crypto/cms/cms_dd.c" 3 4
       ((void *)0)
# 69 "../crypto/cms/cms_dd.c"
       );
        goto err;
    }
    ...
    if (verify) {
        if (mdlen != (unsigned int)dd->digest->length) {
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_dd.c",83,__func__), ERR_set_error)((46),(121),
# 83 "../crypto/cms/cms_dd.c" 3 4
           ((void *)0)
# 83 "../crypto/cms/cms_dd.c"
           );
            goto err;
        }

        if (memcmp(md, dd->digest->data, mdlen))
            (ERR_new(), ERR_set_debug("../crypto/cms/cms_dd.c",88,__func__), ERR_set_error)((46),(158),
# 88 "../crypto/cms/cms_dd.c" 3 4
           ((void *)0)
# 88 "../crypto/cms/cms_dd.c"
           );
        else
            r = 1;
    } else {
