...
void ossl_sm4_encrypt(const uint8_t *in, uint8_t *out, const SM4_KEY *ks)
{
    ...
    do { B0 ^= SM4_T_slow(B1 ^ B2 ^ B3 ^ ks->rk[0]); B1 ^= SM4_T_slow(B0 ^ B2 ^ B3 ^ ks->rk[1]); B2 ^= SM4_T_slow(B0 ^ B1 ^ B3 ^ ks->rk[2]); B3 ^= SM4_T_slow(B0 ^ B1 ^ B2 ^ ks->rk[3]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[4]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[5]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[6]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[7]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[8]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[9]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[10]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[11]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[12]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[13]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[14]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[15]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[16]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[17]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[18]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[19]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[20]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[21]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[22]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[23]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[24]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[25]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[26]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[27]); } while(0);
    do { B0 ^= SM4_T_slow(B1 ^ B2 ^ B3 ^ ks->rk[28]); B1 ^= SM4_T_slow(B0 ^ B2 ^ B3 ^ ks->rk[29]); B2 ^= SM4_T_slow(B0 ^ B1 ^ B3 ^ ks->rk[30]); B3 ^= SM4_T_slow(B0 ^ B1 ^ B2 ^ ks->rk[31]); } while(0);
...
void ossl_sm4_decrypt(const uint8_t *in, uint8_t *out, const SM4_KEY *ks)
{
    ...
    do { B0 ^= SM4_T_slow(B1 ^ B2 ^ B3 ^ ks->rk[31]); B1 ^= SM4_T_slow(B0 ^ B2 ^ B3 ^ ks->rk[30]); B2 ^= SM4_T_slow(B0 ^ B1 ^ B3 ^ ks->rk[29]); B3 ^= SM4_T_slow(B0 ^ B1 ^ B2 ^ ks->rk[28]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[27]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[26]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[25]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[24]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[23]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[22]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[21]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[20]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[19]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[18]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[17]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[16]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[15]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[14]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[13]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[12]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[11]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[10]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[9]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[8]); } while(0);
    do { B0 ^= SM4_T(B1 ^ B2 ^ B3 ^ ks->rk[7]); B1 ^= SM4_T(B0 ^ B2 ^ B3 ^ ks->rk[6]); B2 ^= SM4_T(B0 ^ B1 ^ B3 ^ ks->rk[5]); B3 ^= SM4_T(B0 ^ B1 ^ B2 ^ ks->rk[4]); } while(0);
    do { B0 ^= SM4_T_slow(B1 ^ B2 ^ B3 ^ ks->rk[3]); B1 ^= SM4_T_slow(B0 ^ B2 ^ B3 ^ ks->rk[2]); B2 ^= SM4_T_slow(B0 ^ B1 ^ B3 ^ ks->rk[1]); B3 ^= SM4_T_slow(B0 ^ B1 ^ B2 ^ ks->rk[0]); } while(0);
