# 0 "../crypto/evp/e_xcbc_d.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_xcbc_d.c"
# 14 "../crypto/evp/e_xcbc_d.c"
...
# 47 "../crypto/evp/e_xcbc_d.c" 3 4
   ((void *)0)
# 47 "../crypto/evp/e_xcbc_d.c"
       ,
    sizeof(DESX_CBC_KEY),
    EVP_CIPHER_set_asn1_iv,
    EVP_CIPHER_get_asn1_iv,
    
# 51 "../crypto/evp/e_xcbc_d.c" 3 4
   ((void *)0)
# 51 "../crypto/evp/e_xcbc_d.c"
       ,
    
# 52 "../crypto/evp/e_xcbc_d.c" 3 4
   ((void *)0)

# 53 "../crypto/evp/e_xcbc_d.c"
};
                             ...
                             const unsigned char *iv, int enc)
{
    ...
    DES_set_key_unchecked(deskey, &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks);
    memcpy(&((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->inw[0], &key[8], 8);
    memcpy(&((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->outw[0], &key[16], 8);
                           ...
                           const unsigned char *in, size_t inl)
{
    while (inl >= ((size_t)1 << 30)) {
        DES_xcbc_encrypt(in, out, (long)((size_t)1 << 30), &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks,
                         (DES_cblock *)ctx->iv,
                         &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->inw, &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->outw,
    ...
    if (inl)
        DES_xcbc_encrypt(in, out, (long)inl, &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks,
                         (DES_cblock *)ctx->iv,
                         &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->inw, &((DESX_CBC_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->outw,
                         EVP_CIPHER_CTX_is_encrypting(ctx));
    return 1;
