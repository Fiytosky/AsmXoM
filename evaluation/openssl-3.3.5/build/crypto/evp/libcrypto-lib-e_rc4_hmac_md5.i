# 0 "../crypto/evp/e_rc4_hmac_md5.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_rc4_hmac_md5.c"
# 14 "../crypto/evp/e_rc4_hmac_md5.c"
...
# 15 "../crypto/evp/e_rc4_hmac_md5.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 17 "../crypto/evp/e_rc4_hmac_md5.c" 2
# 25 "../crypto/evp/e_rc4_hmac_md5.c"
...
# 26 "../crypto/evp/e_rc4_hmac_md5.c" 2
...
# 29 "../crypto/evp/e_rc4_hmac_md5.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 30 "../crypto/evp/e_rc4_hmac_md5.c" 2
...
# 76 "../crypto/evp/e_rc4_hmac_md5.c"
                               ...
                               const unsigned char *in, size_t len)
{
    ...
    if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
        ...
        if (plen > md5_off && (blocks = (plen - md5_off) / 64) &&
        ...
        if (len > rc4_off && (blocks = (len - rc4_off) / 64) &&
            (OPENSSL_ia32cap_P[0] & (1 << 20)) == 0) {
            RC4(&key->ks, rc4_off, in, out);
...
# 261 "../crypto/evp/e_rc4_hmac_md5.c" 3 4
   ((void *)0)
# 261 "../crypto/evp/e_rc4_hmac_md5.c"
       ,
    sizeof(EVP_RC4_HMAC_MD5),
    
# 263 "../crypto/evp/e_rc4_hmac_md5.c" 3 4
   ((void *)0)
# 263 "../crypto/evp/e_rc4_hmac_md5.c"
       ,
    
# 264 "../crypto/evp/e_rc4_hmac_md5.c" 3 4
   ((void *)0)
# 264 "../crypto/evp/e_rc4_hmac_md5.c"
       ,
    rc4_hmac_md5_ctrl,
    
# 266 "../crypto/evp/e_rc4_hmac_md5.c" 3 4
   ((void *)0)

# 267 "../crypto/evp/e_rc4_hmac_md5.c"
};
