...
# 51 "../crypto/evp/evp_fetch.c" 3 4
                              ((void *)0)
# 51 "../crypto/evp/evp_fetch.c"
                                  )
...
{
    if (store != 
# 58 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
# 58 "../crypto/evp/evp_fetch.c"
                    )
...
static int reserve_evp_method_store(void *store, void *data)
{
    ...
    if (store == 
# 71 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
        
# 72 "../crypto/evp/evp_fetch.c"
       && (store = get_evp_method_store(methdata->libctx)) == 
# 72 "../crypto/evp/evp_fetch.c" 3 4
                                                              ((void *)0)
# 72 "../crypto/evp/evp_fetch.c"
                                                                  )
        return 0;
...
static int unreserve_evp_method_store(void *store, void *data)
{
    ...
    if (store == 
# 82 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
        
# 83 "../crypto/evp/evp_fetch.c"
       && (store = get_evp_method_store(methdata->libctx)) == 
# 83 "../crypto/evp/evp_fetch.c" 3 4
                                                              ((void *)0)
# 83 "../crypto/evp/evp_fetch.c"
                                                                  )
        return 0;
...
{
    if (!__builtin_expect(!!((name_id > 0 && name_id <= ((1 << 23) - 1)) != 0), 1)
        || !__builtin_expect(!!((operation_id > 0 && operation_id <= ((1 << 8) - 1)) != 0), 1)
                                                                   )
        return 0;
    return (((name_id << 8) & 0x7FFFFF00)
            | (operation_id & 0x000000FF));
}
                                       ...
                                       void *data)
{
    struct evp_method_data_st *methdata = data;
    void *method = 
# 125 "../crypto/evp/evp_fetch.c" 3 4
                  ((void *)0)
# 125 "../crypto/evp/evp_fetch.c"
                      ;
    int name_id;
    uint32_t meth_id;
    ...
    if ((name_id = methdata->name_id) == 0 && methdata->names != 
# 134 "../crypto/evp/evp_fetch.c" 3 4
                                                                ((void *)0)
# 134 "../crypto/evp/evp_fetch.c"
                                                                    ) {
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(methdata->libctx);
        const char *names = methdata->names;
        const char *q = strchr(names, ':');
        size_t l = (q == 
# 138 "../crypto/evp/evp_fetch.c" 3 4
                        ((void *)0) 
# 138 "../crypto/evp/evp_fetch.c"
                             ? strlen(names) : (size_t)(q - names));

        if (namemap == 0)
            return 
# 141 "../crypto/evp/evp_fetch.c" 3 4
                  ((void *)0)
# 141 "../crypto/evp/evp_fetch.c"
                      ;
    ...
    if (name_id == 0
        ...
        return 
# 147 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 147 "../crypto/evp/evp_fetch.c"
                  ;

    if (store == 
# 149 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
        
# 150 "../crypto/evp/evp_fetch.c"
       && (store = get_evp_method_store(methdata->libctx)) == 
# 150 "../crypto/evp/evp_fetch.c" 3 4
                                                              ((void *)0)
# 150 "../crypto/evp/evp_fetch.c"
                                                                  )
        return 
# 151 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 151 "../crypto/evp/evp_fetch.c"
                  ;

    if (!ossl_method_store_fetch(store, meth_id, methdata->propquery, prov,
                                 &method))
        return 
# 155 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 155 "../crypto/evp/evp_fetch.c"
                  ;
    return method;
}
                                   ...
                                   void *data)
{
    ...
    if (names != 
# 176 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
# 176 "../crypto/evp/evp_fetch.c"
                    ) {
        const char *q = strchr(names, ':');

        l = (q == 
# 179 "../crypto/evp/evp_fetch.c" 3 4
                 ((void *)0) 
# 179 "../crypto/evp/evp_fetch.c"
                      ? strlen(names) : (size_t)(q - names));
    }

    if ((namemap = ossl_namemap_stored(methdata->libctx)) == 
# 182 "../crypto/evp/evp_fetch.c" 3 4
                                                            ((void *)0)
        
# 183 "../crypto/evp/evp_fetch.c"
       || (name_id = ossl_namemap_name2num_n(namemap, names, l)) == 0
        || (meth_id = evp_method_id(name_id, methdata->operation_id)) == 0)
        return 0;

    if (store == 
# 187 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
        
# 188 "../crypto/evp/evp_fetch.c"
       && (store = get_evp_method_store(methdata->libctx)) == 
# 188 "../crypto/evp/evp_fetch.c" 3 4
                                                              ((void *)0)
# 188 "../crypto/evp/evp_fetch.c"
                                                                  )
        return 0;
                                  ...
                                  OSSL_PROVIDER *prov, void *data)
{
    ...
    int name_id = ossl_namemap_add_names(namemap, 0, names, ':');
    void *method;

    if (name_id == 0)
        return 
# 218 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 218 "../crypto/evp/evp_fetch.c"
                  ;
    ...
    if (method == 
# 227 "../crypto/evp/evp_fetch.c" 3 4
                 ((void *)0)
# 227 "../crypto/evp/evp_fetch.c"
                     )
...
# 252 "../crypto/evp/evp_fetch.c" 3 4
                                           ((void *)0) 
# 252 "../crypto/evp/evp_fetch.c"
                                                ? properties : "";
    uint32_t meth_id = 0;
    void *method = 
# 254 "../crypto/evp/evp_fetch.c" 3 4
                  ((void *)0)
# 254 "../crypto/evp/evp_fetch.c"
                      ;
    int unsupported, name_id;

    if (store == 
# 257 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0) 
# 257 "../crypto/evp/evp_fetch.c"
                     || namemap == 
# 257 "../crypto/evp/evp_fetch.c" 3 4
                                   ((void *)0)
# 257 "../crypto/evp/evp_fetch.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",258,__func__), ERR_set_error)((6),((262|(0x2 << 18L))),
# 258 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 258 "../crypto/evp/evp_fetch.c"
       );
        return 
# 259 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 259 "../crypto/evp/evp_fetch.c"
                  ;
    }
    ...
    if (!__builtin_expect(!!((operation_id > 0) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",267,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 267 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 267 "../crypto/evp/evp_fetch.c"
       );
        return 
# 268 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 268 "../crypto/evp/evp_fetch.c"
                  ;
    }


    name_id = name != 
# 272 "../crypto/evp/evp_fetch.c" 3 4
                     ((void *)0) 
# 272 "../crypto/evp/evp_fetch.c"
                          ? ossl_namemap_name2num(namemap, name) : 0;
# 282 "../crypto/evp/evp_fetch.c"
    if (name_id != 0 && (meth_id = evp_method_id(name_id, operation_id)) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",283,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 283 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 283 "../crypto/evp/evp_fetch.c"
       );
        return 
# 284 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 284 "../crypto/evp/evp_fetch.c"
                  ;
    }
    ...
    if (meth_id == 0
        ...
        if ((method = ossl_method_construct(methdata->libctx, operation_id,
                                            &prov, 0 ,
                                            &mcm, methdata)) != 
# 315 "../crypto/evp/evp_fetch.c" 3 4
                                                               ((void *)0)
# 315 "../crypto/evp/evp_fetch.c"
                                                                   ) {
# 328 "../crypto/evp/evp_fetch.c"
            if (name_id == 0)
                name_id = ossl_namemap_name2num(namemap, name);
            if (name_id == 0) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",331,__func__), ERR_set_error)(6, (269|(0x2 << 18L)),
                               "Algorithm %s cannot be found", name);
                free_method(method);
                method = 
# 334 "../crypto/evp/evp_fetch.c" 3 4
                        ((void *)0)
# 334 "../crypto/evp/evp_fetch.c"
                            ;
            } else {
    ...
    if ((name_id != 0 || name != 
# 350 "../crypto/evp/evp_fetch.c" 3 4
                                ((void *)0)
# 350 "../crypto/evp/evp_fetch.c"
                                    ) && method == 
# 350 "../crypto/evp/evp_fetch.c" 3 4
                                                   ((void *)0)
# 350 "../crypto/evp/evp_fetch.c"
        ...
        if (name == 
# 353 "../crypto/evp/evp_fetch.c" 3 4
                   ((void *)0)
# 353 "../crypto/evp/evp_fetch.c"
                       )
            name = ossl_namemap_num2name(namemap, name_id, 0);
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",355,__func__), ERR_set_error)(6, code,
                       "%s, Algorithm (%s : %d), Properties (%s)",
                       ossl_lib_ctx_get_descriptor(methdata->libctx),
                       name == 
# 358 "../crypto/evp/evp_fetch.c" 3 4
                              ((void *)0) 
# 358 "../crypto/evp/evp_fetch.c"
                                   ? "<null>" : name, name_id,
                       properties == 
# 359 "../crypto/evp/evp_fetch.c" 3 4
                                    ((void *)0) 
# 359 "../crypto/evp/evp_fetch.c"
                                         ? "<null>" : properties);
    }
                        ...
                        void (*free_method)(void *))
{
    ...
    methdata.tmp_store = 
# 377 "../crypto/evp/evp_fetch.c" 3 4
                        ((void *)0)
# 377 "../crypto/evp/evp_fetch.c"
                            ;
    method = inner_evp_generic_fetch(&methdata, 
# 378 "../crypto/evp/evp_fetch.c" 3 4
                                               ((void *)0)
# 378 "../crypto/evp/evp_fetch.c"
                                                   , operation_id,
                                     name, properties,
                                  ...
                                  void (*free_method)(void *))
{
    ...
    methdata.tmp_store = 
# 403 "../crypto/evp/evp_fetch.c" 3 4
                        ((void *)0)
# 403 "../crypto/evp/evp_fetch.c"
                            ;
...
int evp_method_store_cache_flush(OSSL_LIB_CTX *libctx)
{
    ...
    if (store != 
# 415 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
# 415 "../crypto/evp/evp_fetch.c"
                    )
...
int evp_method_store_remove_all_provided(const OSSL_PROVIDER *prov)
{
    ...
    if (store != 
# 425 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
# 425 "../crypto/evp/evp_fetch.c"
                    )
                                             ...
                                             int mirrored)
{
    ...
    if (plp != 
# 438 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0) 
# 438 "../crypto/evp/evp_fetch.c"
                   && store != 
# 438 "../crypto/evp/evp_fetch.c" 3 4
                               ((void *)0)
# 438 "../crypto/evp/evp_fetch.c"
        ...
        char *propstr = 
# 441 "../crypto/evp/evp_fetch.c" 3 4
                       ((void *)0)
# 441 "../crypto/evp/evp_fetch.c"
                           ;
        size_t strsz;
        ...
        strsz = ossl_property_list_to_string(libctx, def_prop, 
# 455 "../crypto/evp/evp_fetch.c" 3 4
                                                              ((void *)0)
# 455 "../crypto/evp/evp_fetch.c"
                                                                  , 0);
        if (strsz > 0)
            propstr = CRYPTO_malloc(strsz, "../crypto/evp/evp_fetch.c", 457);
        if (propstr == 
# 458 "../crypto/evp/evp_fetch.c" 3 4
                      ((void *)0)
# 458 "../crypto/evp/evp_fetch.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",459,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 459 "../crypto/evp/evp_fetch.c" 3 4
           ((void *)0)
# 459 "../crypto/evp/evp_fetch.c"
           );
            return 0;
        }
        if (ossl_property_list_to_string(libctx, def_prop, propstr,
                                         strsz) == 0) {
            CRYPTO_free(propstr, "../crypto/evp/evp_fetch.c", 464);
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",465,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 465 "../crypto/evp/evp_fetch.c" 3 4
           ((void *)0)
# 465 "../crypto/evp/evp_fetch.c"
           );
            return 0;
        }
        ossl_provider_default_props_update(libctx, propstr);
        CRYPTO_free(propstr, "../crypto/evp/evp_fetch.c", 469);
    ...
    (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",480,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 480 "../crypto/evp/evp_fetch.c" 3 4
   ((void *)0)
# 480 "../crypto/evp/evp_fetch.c"
   );
    return 0;
}
...
# 487 "../crypto/evp/evp_fetch.c" 3 4
                            ((void *)0)
# 487 "../crypto/evp/evp_fetch.c"
                                ;

    if (propq != 
# 489 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0) 
# 489 "../crypto/evp/evp_fetch.c"
                     && (pl = ossl_parse_query(libctx, propq, 1)) == 
# 489 "../crypto/evp/evp_fetch.c" 3 4
                                                                     ((void *)0)
# 489 "../crypto/evp/evp_fetch.c"
                                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",490,__func__), ERR_set_error)((6),(210),
# 490 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 490 "../crypto/evp/evp_fetch.c"
       );
        return 0;
    }
                                        ...
                                        int loadconfig)
{
    ...
    if (propq == 
# 511 "../crypto/evp/evp_fetch.c" 3 4
                ((void *)0)
# 511 "../crypto/evp/evp_fetch.c"
                    )
        return 1;
    if (plp == 
# 513 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0) 
# 513 "../crypto/evp/evp_fetch.c"
                   || *plp == 
# 513 "../crypto/evp/evp_fetch.c" 3 4
                              ((void *)0)
# 513 "../crypto/evp/evp_fetch.c"
    ...
    if ((pl1 = ossl_parse_query(libctx, propq, 1)) == 
# 515 "../crypto/evp/evp_fetch.c" 3 4
                                                     ((void *)0)
# 515 "../crypto/evp/evp_fetch.c"
                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",516,__func__), ERR_set_error)((6),(210),
# 516 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 516 "../crypto/evp/evp_fetch.c"
       );
        return 0;
    }
    ...
    if (pl2 == 
# 521 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 521 "../crypto/evp/evp_fetch.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",522,__func__), ERR_set_error)((6),((15 | (0x2 << 18L))),
# 522 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 522 "../crypto/evp/evp_fetch.c"
       );
        return 0;
    }
                                           ...
                                           const char *prop_name)
{
    ...
    return plp != 
# 537 "../crypto/evp/evp_fetch.c" 3 4
                 ((void *)0) 
# 537 "../crypto/evp/evp_fetch.c"
                      && ossl_property_is_enabled(libctx, prop_name, *plp);
}
...
char *evp_get_global_properties_str(OSSL_LIB_CTX *libctx, int loadconfig)
{
    OSSL_PROPERTY_LIST **plp = ossl_ctx_global_properties(libctx, loadconfig);
    char *propstr = 
# 561 "../crypto/evp/evp_fetch.c" 3 4
                   ((void *)0)
# 561 "../crypto/evp/evp_fetch.c"
                       ;
    size_t sz;

    if (plp == 
# 564 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 564 "../crypto/evp/evp_fetch.c"
                  )
        return CRYPTO_strdup("", "../crypto/evp/evp_fetch.c", 565);

    sz = ossl_property_list_to_string(libctx, *plp, 
# 567 "../crypto/evp/evp_fetch.c" 3 4
                                                   ((void *)0)
# 567 "../crypto/evp/evp_fetch.c"
                                                       , 0);
    if (sz == 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",569,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 569 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 569 "../crypto/evp/evp_fetch.c"
       );
        return 
# 570 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 570 "../crypto/evp/evp_fetch.c"
                  ;
    }

    propstr = CRYPTO_malloc(sz, "../crypto/evp/evp_fetch.c", 573);
    if (propstr == 
# 574 "../crypto/evp/evp_fetch.c" 3 4
                  ((void *)0)
# 574 "../crypto/evp/evp_fetch.c"
                      )
        return 
# 575 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 575 "../crypto/evp/evp_fetch.c"
                  ;
    if (ossl_property_list_to_string(libctx, *plp, propstr, sz) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_fetch.c",577,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 577 "../crypto/evp/evp_fetch.c" 3 4
       ((void *)0)
# 577 "../crypto/evp/evp_fetch.c"
       );
        CRYPTO_free(propstr, "../crypto/evp/evp_fetch.c", 578);
        return 
# 579 "../crypto/evp/evp_fetch.c" 3 4
              ((void *)0)
# 579 "../crypto/evp/evp_fetch.c"
                  ;
    }
    return propstr;
}
...
static void filter_on_operation_id(int id, void *method, void *arg)
{
    ...
    if ((id & 0x000000FF) == data->operation_id)
                        ...
                        void (*free_method)(void *))
{
    ...
    methdata.libctx = libctx;
    methdata.tmp_store = 
# 611 "../crypto/evp/evp_fetch.c" 3 4
                        ((void *)0)
# 611 "../crypto/evp/evp_fetch.c"
                            ;
    (void)inner_evp_generic_fetch(&methdata, 
# 612 "../crypto/evp/evp_fetch.c" 3 4
                                            ((void *)0)
# 612 "../crypto/evp/evp_fetch.c"
                                                , operation_id, 
# 612 "../crypto/evp/evp_fetch.c" 3 4
                                                                ((void *)0)
# 612 "../crypto/evp/evp_fetch.c"
...
# 612 "../crypto/evp/evp_fetch.c"
    ...
    if (methdata.tmp_store != 
# 618 "../crypto/evp/evp_fetch.c" 3 4
                             ((void *)0)
# 618 "../crypto/evp/evp_fetch.c"
                                 )
             ...
             const char *legacy_name, const char *name)
{
    ...
    if (prov == 
# 635 "../crypto/evp/evp_fetch.c" 3 4
               ((void *)0)
# 635 "../crypto/evp/evp_fetch.c"
                   )
