# 0 "../crypto/evp/kdf_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/kdf_meth.c"
# 10 "../crypto/evp/kdf_meth.c"
...
static void evp_kdf_free(void *vkdf)
{
    ...
    if (kdf == 
# 34 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 34 "../crypto/evp/kdf_meth.c"
                  )
        return;
    ...
    if (ref > 0)
        return;
    CRYPTO_free(kdf->type_name, "../crypto/evp/kdf_meth.c", 40);
    ossl_provider_free(kdf->prov);
    CRYPTO_FREE_REF(&kdf->refcnt);
    CRYPTO_free(kdf, "../crypto/evp/kdf_meth.c", 43);
}

static void *evp_kdf_new(void)
{
    EVP_KDF *kdf = 
# 48 "../crypto/evp/kdf_meth.c" 3 4
                  ((void *)0)
# 48 "../crypto/evp/kdf_meth.c"
                      ;

    if ((kdf = CRYPTO_zalloc(sizeof(*kdf), "../crypto/evp/kdf_meth.c", 50)) == 
# 50 "../crypto/evp/kdf_meth.c" 3 4
                                               ((void *)0)
        
# 51 "../crypto/evp/kdf_meth.c"
       || !CRYPTO_NEW_REF(&kdf->refcnt, 1)) {
        CRYPTO_free(kdf, "../crypto/evp/kdf_meth.c", 52);
        return 
# 53 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 53 "../crypto/evp/kdf_meth.c"
                  ;
    }
    return kdf;
}
                                    ...
                                    OSSL_PROVIDER *prov)
{
    ...
    EVP_KDF *kdf = 
# 63 "../crypto/evp/kdf_meth.c" 3 4
                  ((void *)0)
# 63 "../crypto/evp/kdf_meth.c"
                      ;
    int fnkdfcnt = 0, fnctxcnt = 0;

    if ((kdf = evp_kdf_new()) == 
# 66 "../crypto/evp/kdf_meth.c" 3 4
                                ((void *)0)
# 66 "../crypto/evp/kdf_meth.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kdf_meth.c",67,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 67 "../crypto/evp/kdf_meth.c" 3 4
       ((void *)0)
# 67 "../crypto/evp/kdf_meth.c"
       );
        return 
# 68 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 68 "../crypto/evp/kdf_meth.c"
                  ;
    }
    kdf->name_id = name_id;
    if ((kdf->type_name = ossl_algorithm_get1_first_name(algodef)) == 
# 71 "../crypto/evp/kdf_meth.c" 3 4
                                                                     ((void *)0)
# 71 "../crypto/evp/kdf_meth.c"
                                                                         ) {
        evp_kdf_free(kdf);
        return 
# 73 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 73 "../crypto/evp/kdf_meth.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (kdf->newctx != 
# 80 "../crypto/evp/kdf_meth.c" 3 4
                              ((void *)0)
# 80 "../crypto/evp/kdf_meth.c"
                                  )
                break;
        ...
        case 2:
            if (kdf->dupctx != 
# 86 "../crypto/evp/kdf_meth.c" 3 4
                              ((void *)0)
# 86 "../crypto/evp/kdf_meth.c"
                                  )
                break;
        ...
        case 3:
            if (kdf->freectx != 
# 91 "../crypto/evp/kdf_meth.c" 3 4
                               ((void *)0)
# 91 "../crypto/evp/kdf_meth.c"
                                   )
                break;
        ...
        case 4:
            if (kdf->reset != 
# 97 "../crypto/evp/kdf_meth.c" 3 4
                             ((void *)0)
# 97 "../crypto/evp/kdf_meth.c"
                                 )
                break;
        ...
        case 5:
            if (kdf->derive != 
# 102 "../crypto/evp/kdf_meth.c" 3 4
                              ((void *)0)
# 102 "../crypto/evp/kdf_meth.c"
                                  )
                break;
            ...
            break;
        case 6:
            if (kdf->gettable_params != 
# 108 "../crypto/evp/kdf_meth.c" 3 4
                                       ((void *)0)
# 108 "../crypto/evp/kdf_meth.c"
                                           )
                break;
            kdf->gettable_params =
            ...
            break;
        case 7:
            if (kdf->gettable_ctx_params != 
# 114 "../crypto/evp/kdf_meth.c" 3 4
                                           ((void *)0)
# 114 "../crypto/evp/kdf_meth.c"
                                               )
                break;
...
# 120 "../crypto/evp/kdf_meth.c" 3 4
                                           ((void *)0)
# 120 "../crypto/evp/kdf_meth.c"
                                               )
                break;
        ...
        case 9:
            if (kdf->get_params != 
# 126 "../crypto/evp/kdf_meth.c" 3 4
                                  ((void *)0)
# 126 "../crypto/evp/kdf_meth.c"
                                      )
                break;
            kdf->get_params = OSSL_FUNC_kdf_get_params(fns);
            break;
        case 10:
            if (kdf->get_ctx_params != 
# 131 "../crypto/evp/kdf_meth.c" 3 4
                                      ((void *)0)
# 131 "../crypto/evp/kdf_meth.c"
                                          )
                break;
            kdf->get_ctx_params = OSSL_FUNC_kdf_get_ctx_params(fns);
            break;
        case 11:
            if (kdf->set_ctx_params != 
# 136 "../crypto/evp/kdf_meth.c" 3 4
                                      ((void *)0)
# 136 "../crypto/evp/kdf_meth.c"
                                          )
                break;
    ...
    if (fnkdfcnt != 1 || fnctxcnt != 2) {
        ...
        evp_kdf_free(kdf);
        (ERR_new(), ERR_set_debug("../crypto/evp/kdf_meth.c",149,__func__), ERR_set_error)((6),(193),
# 149 "../crypto/evp/kdf_meth.c" 3 4
       ((void *)0)
# 149 "../crypto/evp/kdf_meth.c"
       );
        return 
# 150 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 150 "../crypto/evp/kdf_meth.c"
                  ;
    }
    kdf->prov = prov;
    if (prov != 
# 153 "../crypto/evp/kdf_meth.c" 3 4
               ((void *)0)
# 153 "../crypto/evp/kdf_meth.c"
                   )
...
EVP_KDF *EVP_KDF_fetch(OSSL_LIB_CTX *libctx, const char *algorithm,
                       const char *properties)
{
    return evp_generic_fetch(libctx, 4, algorithm, properties,
...
{
    if (kdf->gettable_params == 
# 179 "../crypto/evp/kdf_meth.c" 3 4
                               ((void *)0)
# 179 "../crypto/evp/kdf_meth.c"
                                   )
        return 
# 180 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
...
const OSSL_PARAM *EVP_KDF_gettable_ctx_params(const EVP_KDF *kdf)
{
    ...
    if (kdf->gettable_ctx_params == 
# 188 "../crypto/evp/kdf_meth.c" 3 4
                                   ((void *)0)
# 188 "../crypto/evp/kdf_meth.c"
                                       )
        return 
# 189 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 189 "../crypto/evp/kdf_meth.c"
                  ;
    alg = ossl_provider_ctx(EVP_KDF_get0_provider(kdf));
    return kdf->gettable_ctx_params(
# 191 "../crypto/evp/kdf_meth.c" 3 4
                                   ((void *)0)
# 191 "../crypto/evp/kdf_meth.c"
                                       , alg);
}
...
const OSSL_PARAM *EVP_KDF_settable_ctx_params(const EVP_KDF *kdf)
{
    ...
    if (kdf->settable_ctx_params == 
# 198 "../crypto/evp/kdf_meth.c" 3 4
                                   ((void *)0)
# 198 "../crypto/evp/kdf_meth.c"
                                       )
        return 
# 199 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 199 "../crypto/evp/kdf_meth.c"
                  ;
    alg = ossl_provider_ctx(EVP_KDF_get0_provider(kdf));
    return kdf->settable_ctx_params(
# 201 "../crypto/evp/kdf_meth.c" 3 4
                                   ((void *)0)
# 201 "../crypto/evp/kdf_meth.c"
                                       , alg);
}
...
# 208 "../crypto/evp/kdf_meth.c" 3 4
                                         ((void *)0)
# 208 "../crypto/evp/kdf_meth.c"
                                             )
        return 
# 209 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
# 209 "../crypto/evp/kdf_meth.c"
                  ;
...
# 218 "../crypto/evp/kdf_meth.c" 3 4
                                         ((void *)0)
# 218 "../crypto/evp/kdf_meth.c"
                                             )
        return 
# 219 "../crypto/evp/kdf_meth.c" 3 4
              ((void *)0)
