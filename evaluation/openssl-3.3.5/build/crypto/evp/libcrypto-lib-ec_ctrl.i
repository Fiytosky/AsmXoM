# 0 "../crypto/evp/ec_ctrl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/ec_ctrl.c"
# 10 "../crypto/evp/ec_ctrl.c"
...
# 11 "../crypto/evp/ec_ctrl.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../crypto/evp/ec_ctrl.c" 2
...
{
    if (ctx == 
# 26 "../crypto/evp/ec_ctrl.c" 3 4
              ((void *)0) 
# 26 "../crypto/evp/ec_ctrl.c"
                   || !((ctx)->operation == (1<<11))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",27,__func__), ERR_set_error)((6),(147),
# 27 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 27 "../crypto/evp/ec_ctrl.c"
       );
    ...
    if (((ctx)->keymgmt == 
# 33 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 33 "../crypto/evp/ec_ctrl.c"
       )
        && ctx->pmeth != 
# 34 "../crypto/evp/ec_ctrl.c" 3 4
                        ((void *)0) 
# 34 "../crypto/evp/ec_ctrl.c"
                             && ctx->pmeth->pkey_id != 408)
        return -1;
...
int EVP_PKEY_CTX_set_ecdh_cofactor_mode(EVP_PKEY_CTX *ctx, int cofactor_mode)
{
    ...
    *p++ = OSSL_PARAM_construct_int("ecdh-cofactor-mode",
                                    &cofactor_mode);
    *p++ = OSSL_PARAM_construct_end();

    ret = evp_pkey_ctx_set_params_strict(ctx, params);
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",66,__func__), ERR_set_error)((6),(147),
# 66 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 66 "../crypto/evp/ec_ctrl.c"
       );
    return ret;
}
...
int EVP_PKEY_CTX_get_ecdh_cofactor_mode(EVP_PKEY_CTX *ctx)
{
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    switch (ret) {
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",87,__func__), ERR_set_error)((6),(147),
# 87 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 87 "../crypto/evp/ec_ctrl.c"
       );
        break;
    case 1:
        ret = mode;
...
int EVP_PKEY_CTX_set_ecdh_kdf_type(EVP_PKEY_CTX *ctx, int kdf)
{
    return EVP_PKEY_CTX_ctrl(ctx, 408, (1<<11),
                             (0x1000 + 4), kdf, 
# 114 "../crypto/evp/ec_ctrl.c" 3 4
                                                            ((void *)0)
# 114 "../crypto/evp/ec_ctrl.c"
                                                                );
}
...
int EVP_PKEY_CTX_get_ecdh_kdf_type(EVP_PKEY_CTX *ctx)
{
    return EVP_PKEY_CTX_ctrl(ctx, 408, (1<<11),
                             (0x1000 + 4), -2, 
# 124 "../crypto/evp/ec_ctrl.c" 3 4
                                                           ((void *)0)
# 124 "../crypto/evp/ec_ctrl.c"
                                                               );
}
...
int EVP_PKEY_CTX_set_ecdh_kdf_outlen(EVP_PKEY_CTX *ctx, int outlen)
{
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    ret = evp_pkey_ctx_set_params_strict(ctx, params);
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",172,__func__), ERR_set_error)((6),(147),
# 172 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 172 "../crypto/evp/ec_ctrl.c"
       );
    return ret;
}
...
{
    size_t len = 
# 178 "../crypto/evp/ec_ctrl.c" 3 4
                (0x7fffffff * 2U + 1U)
# 178 "../crypto/evp/ec_ctrl.c"
                        ;
    int ret;
    OSSL_PARAM params[2], *p = params;
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    switch (ret) {
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",194,__func__), ERR_set_error)((6),(147),
# 194 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 194 "../crypto/evp/ec_ctrl.c"
       );
        break;
    case 1:
        if (len <= 0x7fffffff
# 197 "../crypto/evp/ec_ctrl.c"
                         )
            *plen = (int)len;
        else
            ret = -1;
...
int EVP_PKEY_CTX_set0_ecdh_kdf_ukm(EVP_PKEY_CTX *ctx, unsigned char *ukm, int len)
{
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    switch (ret) {
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",232,__func__), ERR_set_error)((6),(147),
# 232 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 232 "../crypto/evp/ec_ctrl.c"
       );
        break;
    case 1:
        CRYPTO_free(ukm, "../crypto/evp/ec_ctrl.c", 235);
        break;
    }
...
int EVP_PKEY_CTX_get0_ecdh_kdf_ukm(EVP_PKEY_CTX *ctx, unsigned char **pukm)
{
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    switch (ret) {
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/evp/ec_ctrl.c",261,__func__), ERR_set_error)((6),(147),
# 261 "../crypto/evp/ec_ctrl.c" 3 4
       ((void *)0)
# 261 "../crypto/evp/ec_ctrl.c"
       );
        break;
    case 1:
        ret = -1;
...
# 284 "../crypto/evp/ec_ctrl.c"
int EVP_PKEY_CTX_set_ec_paramgen_curve_nid(EVP_PKEY_CTX *ctx, int nid)
{
    int keytype = nid == 1172 ? 1172 : 408;

    return EVP_PKEY_CTX_ctrl(ctx, keytype, ((1<<1) | (1<<2)),
                             (0x1000 + 1),
                             nid, 
# 290 "../crypto/evp/ec_ctrl.c" 3 4
                                 ((void *)0)
# 290 "../crypto/evp/ec_ctrl.c"
                                     );
}
...
int EVP_PKEY_CTX_set_ec_param_enc(EVP_PKEY_CTX *ctx, int param_enc)
{
    return EVP_PKEY_CTX_ctrl(ctx, 408, ((1<<1) | (1<<2)),
                             (0x1000 + 2), param_enc, 
# 300 "../crypto/evp/ec_ctrl.c" 3 4
                                                                   ((void *)0)
# 300 "../crypto/evp/ec_ctrl.c"
                                                                       );
}
