# 0 "../crypto/evp/pbe_scrypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/pbe_scrypt.c"
# 10 "../crypto/evp/pbe_scrypt.c"
...
# 13 "../crypto/evp/pbe_scrypt.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/evp/pbe_scrypt.c" 2
...
# 15 "../crypto/evp/pbe_scrypt.c" 2
# 37 "../crypto/evp/pbe_scrypt.c"
int EVP_PBE_scrypt_ex(const char *pass, size_t passlen,
                      const unsigned char *salt, size_t saltlen,
                      uint64_t N, uint64_t r, uint64_t p, uint64_t maxmem,
                      unsigned char *key, size_t keylen,
                      OSSL_LIB_CTX *ctx, const char *propq)
{
    ...
    if (r > 
# 49 "../crypto/evp/pbe_scrypt.c" 3 4
           (4294967295U) 
# 49 "../crypto/evp/pbe_scrypt.c"
                      || p > 
# 49 "../crypto/evp/pbe_scrypt.c" 3 4
                             (4294967295U)
# 49 "../crypto/evp/pbe_scrypt.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pbe_scrypt.c",50,__func__), ERR_set_error)((6),(187),
# 50 "../crypto/evp/pbe_scrypt.c" 3 4
       ((void *)0)
# 50 "../crypto/evp/pbe_scrypt.c"
       );
        return 0;
    }
    ...
    if (pass == 
# 55 "../crypto/evp/pbe_scrypt.c" 3 4
               ((void *)0)
# 55 "../crypto/evp/pbe_scrypt.c"
                   ) {
        pass = empty;
        passlen = 0;
    }
    if (salt == 
# 59 "../crypto/evp/pbe_scrypt.c" 3 4
               ((void *)0)
# 59 "../crypto/evp/pbe_scrypt.c"
                   ) {
    ...
    kdf = EVP_KDF_fetch(ctx, "SCRYPT", propq);
    kctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kctx == 
# 70 "../crypto/evp/pbe_scrypt.c" 3 4
               ((void *)0)
# 70 "../crypto/evp/pbe_scrypt.c"
                   )
        return 0;

    *z++ = OSSL_PARAM_construct_octet_string("pass",
                                              (unsigned char *)pass,
                                                      passlen);
    *z++ = OSSL_PARAM_construct_octet_string("salt",
                                             (unsigned char *)salt, saltlen);
    *z++ = OSSL_PARAM_construct_uint64("n", &N);
    *z++ = OSSL_PARAM_construct_uint64("r", &r);
    *z++ = OSSL_PARAM_construct_uint64("p", &p);
    *z++ = OSSL_PARAM_construct_uint64("maxmem_bytes", &maxmem);
                   ...
                   unsigned char *key, size_t keylen)
{
    return EVP_PBE_scrypt_ex(pass, passlen, salt, saltlen, N, r, p, maxmem,
                             key, keylen, 
# 96 "../crypto/evp/pbe_scrypt.c" 3 4
                                         ((void *)0)
# 96 "../crypto/evp/pbe_scrypt.c"
                                             , 
# 96 "../crypto/evp/pbe_scrypt.c" 3 4
                                               ((void *)0)
# 96 "../crypto/evp/pbe_scrypt.c"
