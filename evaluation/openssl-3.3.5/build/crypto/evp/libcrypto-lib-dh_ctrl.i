# 0 "../crypto/evp/dh_ctrl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/dh_ctrl.c"
# 10 "../crypto/evp/dh_ctrl.c"
...
# 11 "../crypto/evp/dh_ctrl.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../crypto/evp/dh_ctrl.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../crypto/evp/dh_ctrl.c" 2

static int dh_paramgen_check(EVP_PKEY_CTX *ctx)
{
    if (ctx == 
# 21 "../crypto/evp/dh_ctrl.c" 3 4
              ((void *)0) 
# 21 "../crypto/evp/dh_ctrl.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",22,__func__), ERR_set_error)((6),(147),
# 22 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 22 "../crypto/evp/dh_ctrl.c"
       );
    ...
    if (((ctx)->keymgmt == 
# 27 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 27 "../crypto/evp/dh_ctrl.c"
       )
        && ctx->pmeth->pkey_id != 28
        && ctx->pmeth->pkey_id != 920)
        return -1;
    return 1;
}
...
{
    if (ctx == 
# 36 "../crypto/evp/dh_ctrl.c" 3 4
              ((void *)0) 
# 36 "../crypto/evp/dh_ctrl.c"
                   || !((ctx)->operation == (1<<11))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",37,__func__), ERR_set_error)((6),(147),
# 37 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 37 "../crypto/evp/dh_ctrl.c"
       );
    ...
    if (((ctx)->keymgmt == 
# 42 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 42 "../crypto/evp/dh_ctrl.c"
       )
        && ctx->pmeth->pkey_id != 28
        && ctx->pmeth->pkey_id != 920)
        return -1;
...
int EVP_PKEY_CTX_set_dh_paramgen_gindex(EVP_PKEY_CTX *ctx, int gindex)
{
    ...
    *p++ = OSSL_PARAM_construct_int("gindex", &gindex);
...
int EVP_PKEY_CTX_set_dh_paramgen_type(EVP_PKEY_CTX *ctx, int typ)
{
    return EVP_PKEY_CTX_ctrl(ctx, 28, (1<<1),
                             (0x1000 + 5), typ, 
# 87 "../crypto/evp/dh_ctrl.c" 3 4
                                                                 ((void *)0)
# 87 "../crypto/evp/dh_ctrl.c"
                                                                     );
}
...
int EVP_PKEY_CTX_set_dh_paramgen_prime_len(EVP_PKEY_CTX *ctx, int pbits)
{
    ...
    *p++ = OSSL_PARAM_construct_size_t("pbits", &bits);
    *p = OSSL_PARAM_construct_end();
    return evp_pkey_ctx_set_params_strict(ctx, params);
}
...
int EVP_PKEY_CTX_set_dh_paramgen_subprime_len(EVP_PKEY_CTX *ctx, int qbits)
{
    ...
    *p++ = OSSL_PARAM_construct_size_t("qbits", &bits2);
    *p = OSSL_PARAM_construct_end();
...
int EVP_PKEY_CTX_set_dh_paramgen_generator(EVP_PKEY_CTX *ctx, int gen)
{
    ...
    *p++ = OSSL_PARAM_construct_int("safeprime-generator", &gen);
    *p = OSSL_PARAM_construct_end();
...
int EVP_PKEY_CTX_set_dh_rfc5114(EVP_PKEY_CTX *ctx, int gen)
{
    return EVP_PKEY_CTX_ctrl(ctx, 920, (1<<1),
                             (0x1000 + 3), gen, 
# 140 "../crypto/evp/dh_ctrl.c" 3 4
                                                           ((void *)0)
# 140 "../crypto/evp/dh_ctrl.c"
                                                               );
}
...
int EVP_PKEY_CTX_set_dh_nid(EVP_PKEY_CTX *ctx, int nid)
{
    return EVP_PKEY_CTX_ctrl(ctx, 28,
                             (1<<1) | (1<<2),
                             (0x1000 + 15), nid, 
# 156 "../crypto/evp/dh_ctrl.c" 3 4
                                                       ((void *)0)
# 156 "../crypto/evp/dh_ctrl.c"
                                                           );
}
...
int EVP_PKEY_CTX_set_dh_pad(EVP_PKEY_CTX *ctx, int pad)
{
    ...
    if (ctx == 
# 165 "../crypto/evp/dh_ctrl.c" 3 4
              ((void *)0) 
# 165 "../crypto/evp/dh_ctrl.c"
                   || !((ctx)->operation == (1<<11))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",166,__func__), ERR_set_error)((6),(147),
# 166 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 166 "../crypto/evp/dh_ctrl.c"
       );
        return -2;
    }

    dh_pad_params[0] = OSSL_PARAM_construct_uint("pad", &upad);
...
int EVP_PKEY_CTX_set_dh_kdf_type(EVP_PKEY_CTX *ctx, int kdf)
{
    return EVP_PKEY_CTX_ctrl(ctx, 920, (1<<11),
                             (0x1000 + 6), kdf, 
# 183 "../crypto/evp/dh_ctrl.c" 3 4
                                                            ((void *)0)
# 183 "../crypto/evp/dh_ctrl.c"
                                                                );
}
...
int EVP_PKEY_CTX_get_dh_kdf_type(EVP_PKEY_CTX *ctx)
{
    return EVP_PKEY_CTX_ctrl(ctx, 920, (1<<11),
                             (0x1000 + 6), -2, 
# 193 "../crypto/evp/dh_ctrl.c" 3 4
                                                           ((void *)0)
# 193 "../crypto/evp/dh_ctrl.c"
                                                               );
}
...
int EVP_PKEY_CTX_set_dh_kdf_outlen(EVP_PKEY_CTX *ctx, int outlen)
{
    ...
    *p++ = OSSL_PARAM_construct_size_t("kdf-outlen",
                                       &len);
    *p = OSSL_PARAM_construct_end();

    ret = evp_pkey_ctx_set_params_strict(ctx, params);
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",261,__func__), ERR_set_error)((6),(147),
# 261 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 261 "../crypto/evp/dh_ctrl.c"
       );
    return ret;
}
...
int EVP_PKEY_CTX_get_dh_kdf_outlen(EVP_PKEY_CTX *ctx, int *plen)
{
    int ret;
    size_t len = 
# 268 "../crypto/evp/dh_ctrl.c" 3 4
                (0x7fffffff * 2U + 1U)
# 268 "../crypto/evp/dh_ctrl.c"
                        ;
    OSSL_PARAM params[2], *p = params;
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",281,__func__), ERR_set_error)((6),(147),
# 281 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 281 "../crypto/evp/dh_ctrl.c"
       );
    if (ret != 1 || len > 0x7fffffff
# 282 "../crypto/evp/dh_ctrl.c"
                                )
        return -1;
...
int EVP_PKEY_CTX_set0_dh_kdf_ukm(EVP_PKEY_CTX *ctx, unsigned char *ukm, int len)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_string("kdf-ukm",
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    ret = evp_pkey_ctx_set_params_strict(ctx, params);
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",313,__func__), ERR_set_error)((6),(147),
# 313 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 313 "../crypto/evp/dh_ctrl.c"
       );
    if (ret == 1)
        CRYPTO_free(ukm, "../crypto/evp/dh_ctrl.c", 315);
    return ret;
}
...
int EVP_PKEY_CTX_get0_dh_kdf_ukm(EVP_PKEY_CTX *ctx, unsigned char **pukm)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_ptr("kdf-ukm",
                                          (void **)pukm, 0);
    *p = OSSL_PARAM_construct_end();

    ret = evp_pkey_ctx_get_params_strict(ctx, params);
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/dh_ctrl.c",336,__func__), ERR_set_error)((6),(147),
# 336 "../crypto/evp/dh_ctrl.c" 3 4
       ((void *)0)
# 336 "../crypto/evp/dh_ctrl.c"
       );
    if (ret != 1)
        return -1;

    ukmlen = params[0].return_size;
    if (ukmlen > 0x7fffffff
# 341 "../crypto/evp/dh_ctrl.c"
                       )
        return -1;
