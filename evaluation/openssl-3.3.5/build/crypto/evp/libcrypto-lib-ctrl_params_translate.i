# 0 "../crypto/evp/ctrl_params_translate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/ctrl_params_translate.c"
# 16 "../crypto/evp/ctrl_params_translate.c"
...
# 17 "../crypto/evp/ctrl_params_translate.c" 2
...
# 19 "../crypto/evp/ctrl_params_translate.c" 2
...
extern DH *DH_generate_parameters(int prime_len, int generator,
                                                   void (*callback) (int, int,
                                                                void *),
                                                   void *cb_arg);
# 22 "../crypto/evp/ctrl_params_translate.c" 2
...
extern int DSA_meth_set_keygen(DSA_METHOD *dsam,
                                              int (*keygen) (DSA *));
# 23 "../crypto/evp/ctrl_params_translate.c" 2
...
extern void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 24 "../crypto/evp/ctrl_params_translate.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 25 "../crypto/evp/ctrl_params_translate.c" 2
...
# 26 "../crypto/evp/ctrl_params_translate.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 29 "../crypto/evp/ctrl_params_translate.c" 2
...
# 31 "../crypto/evp/ctrl_params_translate.c" 2
# 1 "../include/openssl/evperr.h" 1
# 13 "../include/openssl/evperr.h"
        
# 32 "../crypto/evp/ctrl_params_translate.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 34 "../crypto/evp/ctrl_params_translate.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 35 "../crypto/evp/ctrl_params_translate.c" 2
...
# 36 "../crypto/evp/ctrl_params_translate.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 37 "../crypto/evp/ctrl_params_translate.c" 2
...
# 38 "../crypto/evp/ctrl_params_translate.c" 2
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst, int dlen,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq);
# 39 "../crypto/evp/ctrl_params_translate.c" 2

struct translation_ctx_st;
struct translation_st;
# 146 "../crypto/evp/ctrl_params_translate.c"
enum state {
    PKEY,
...
struct translation_ctx_st {
    ...
    OSSL_PARAM *params;
# 206 "../crypto/evp/ctrl_params_translate.c"
    void *orig_p2;
...
struct translation_st {
# 227 "../crypto/evp/ctrl_params_translate.c"
    enum action action_type;
# 237 "../crypto/evp/ctrl_params_translate.c"
    int keytype1;
    int keytype2;
    int optype;
# 259 "../crypto/evp/ctrl_params_translate.c"
    int ctrl_num;
    const char *ctrl_str;
    const char *ctrl_hexstr;
...
# 289 "../crypto/evp/ctrl_params_translate.c"
                         ...
                         const struct translation_ctx_st *ctx)
{
    ...
    case PRE_CTRL_TO_PARAMS:
        if (!__builtin_expect(!!((translation != 
# 297 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0)
# 297 "../crypto/evp/ctrl_params_translate.c"
            ) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",298,__func__), ERR_set_error)((6),(147),
# 298 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 298 "../crypto/evp/ctrl_params_translate.c"
           );
            return -2;
        }
        if (!__builtin_expect(!!((translation->param_key != 0) != 0), 1)
            || !__builtin_expect(!!((translation->param_data_type != 0) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",303,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 303 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 303 "../crypto/evp/ctrl_params_translate.c"
           );
            return -1;
        }
        break;
    case PRE_CTRL_STR_TO_PARAMS:
        ...
        if (translation != 
# 314 "../crypto/evp/ctrl_params_translate.c" 3 4
                          ((void *)0)
# 314 "../crypto/evp/ctrl_params_translate.c"
                              ) {
            if (!__builtin_expect(!!((translation->action_type != GET) != 0), 1)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",316,__func__), ERR_set_error)((6),(147),
# 316 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 316 "../crypto/evp/ctrl_params_translate.c"
               );
                return -2;
            }
            if (!__builtin_expect(!!((translation->param_key != 
# 319 "../crypto/evp/ctrl_params_translate.c" 3 4
                ((void *)0)
# 319 "../crypto/evp/ctrl_params_translate.c"
                ) != 0), 1)
                || !__builtin_expect(!!((translation->param_data_type != 0) != 0), 1)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",321,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 321 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 321 "../crypto/evp/ctrl_params_translate.c"
               );
                return 0;
            }
        }
    ...
    case POST_PARAMS_TO_CTRL:
        if (!__builtin_expect(!!((translation != 
# 328 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0)
# 328 "../crypto/evp/ctrl_params_translate.c"
            ) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",329,__func__), ERR_set_error)((6),(147),
# 329 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 329 "../crypto/evp/ctrl_params_translate.c"
           );
            return -2;
        }
        if (!__builtin_expect(!!((translation->ctrl_num != 0) != 0), 1)
            || !__builtin_expect(!!((translation->param_data_type != 0) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",334,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 334 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 334 "../crypto/evp/ctrl_params_translate.c"
           );
            return -1;
        }
    }
...
# 384 "../crypto/evp/ctrl_params_translate.c"
                              ...
                              struct translation_ctx_st *ctx)
{
    ...
    default:
        ...
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",396,__func__), ERR_set_error)(6, (257|((0x1 << 18L)|(0x2 << 18L))),
    ...
    case PRE_CTRL_TO_PARAMS:
        ...
        if (ctx->action_type == NONE) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",413,__func__), ERR_set_error)(6, (268|(0x2 << 18L)),
                           "[action:%d, state:%d]", ctx->action_type, state);
            return 0;
        }

        if (translation->optype != 0) {
            if ((((ctx->pctx)->operation == (1<<4) || (ctx->pctx)->operation == (1<<7) || (ctx->pctx)->operation == (1<<5) || (ctx->pctx)->operation == (1<<8) || (ctx->pctx)->operation == (1<<6))
                 && ctx->pctx->op.sig.algctx == 
# 420 "../crypto/evp/ctrl_params_translate.c" 3 4
                                               ((void *)0)
# 420 "../crypto/evp/ctrl_params_translate.c"
                                                   )
                || (((ctx->pctx)->operation == (1<<11))
                    && ctx->pctx->op.kex.algctx == 
# 422 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                  ((void *)0)
# 422 "../crypto/evp/ctrl_params_translate.c"
                                                      )
                || (((ctx->pctx)->operation == (1<<9) || (ctx->pctx)->operation == (1<<10))
                    && ctx->pctx->op.ciph.algctx == 
# 424 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                   ((void *)0)
# 424 "../crypto/evp/ctrl_params_translate.c"
                                                       )
                || (((ctx->pctx)->operation == (1<<12) || (ctx->pctx)->operation == (1<<13))
                    && ctx->pctx->op.encap.algctx == 
# 426 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                    ((void *)0)
# 426 "../crypto/evp/ctrl_params_translate.c"
                                                        )




                || (((ctx->pctx)->operation == (1<<1) || (ctx->pctx)->operation == (1<<2))
                    && ctx->pctx->op.keymgmt.genctx == 
# 432 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                      ((void *)0)
# 432 "../crypto/evp/ctrl_params_translate.c"
                                                          )
                || (((ctx->pctx)->operation == (1<<3))
                    && ctx->pctx->op.keymgmt.genctx == 
# 434 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                      ((void *)0)
# 434 "../crypto/evp/ctrl_params_translate.c"
                                                          )) {
                (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",435,__func__), ERR_set_error)((6),(147),
# 435 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 435 "../crypto/evp/ctrl_params_translate.c"
               );
        ...
        case 1:
            *ctx->params = OSSL_PARAM_construct_int(translation->param_key,
            ...
            break;
        case 2:
# 458 "../crypto/evp/ctrl_params_translate.c"
            if (ctx->p2 != 
# 458 "../crypto/evp/ctrl_params_translate.c" 3 4
                          ((void *)0)
# 458 "../crypto/evp/ctrl_params_translate.c"
                              ) {
                if (ctx->action_type == SET) {
                    ctx->buflen = ((BN_num_bits(ctx->p2)+7)/8);
                    if ((ctx->allocated_buf
                         = CRYPTO_malloc(ctx->buflen, "../crypto/evp/ctrl_params_translate.c", 462)) == 
# 462 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                          ((void *)0)
# 462 "../crypto/evp/ctrl_params_translate.c"
                                                              )
                        return 0;
                    if (BN_bn2nativepad(ctx->p2,
                                         ctx->allocated_buf, ctx->buflen) < 0) {
                        CRYPTO_free(ctx->allocated_buf, "../crypto/evp/ctrl_params_translate.c", 466);
                        ctx->allocated_buf = 
# 467 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 467 "../crypto/evp/ctrl_params_translate.c"
                                                ;
                        return 0;
                    }
                    *ctx->params =
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",479,__func__), ERR_set_error)(6, (268|(0x2 << 18L)),
...
# 543 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 543 "../crypto/evp/ctrl_params_translate.c"
                                            ;
            int exists = 0;


            if (ctx->action_type != SET) {
                (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",548,__func__), ERR_set_error)(6, 147,
            ...
            if (translation != 
# 558 "../crypto/evp/ctrl_params_translate.c" 3 4
                              ((void *)0)
# 558 "../crypto/evp/ctrl_params_translate.c"
                                  ) {
                ...
                if (ctx->ishex) {
                    ...
                    if (OPENSSL_strlcat(ctx->name_buf, tmp_ctrl_str,
                        ...
                        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",565,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 565 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 565 "../crypto/evp/ctrl_params_translate.c"
                       );
                        return -1;
                    }
            ...
            if (!OSSL_PARAM_allocate_from_text(ctx->params, settable,
                                               ...
                                               &exists)) {
                if (!exists) {
                    (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",578,__func__), ERR_set_error)(6, 147,
    ...
    case POST_CTRL_STR_TO_PARAMS:
        ...
        break;
# 606 "../crypto/evp/ctrl_params_translate.c"
    case PKEY:
    case POST_PARAMS_TO_CTRL:
        ret = ctx->p1;
    ...
    case PRE_PARAMS_TO_CTRL:
        {
            ...
            if (state == PRE_PARAMS_TO_CTRL && ctx->action_type == SET) {
                ...
                case 2:
                    if (ctx->p2 != 
# 621 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 621 "../crypto/evp/ctrl_params_translate.c"
                                      ) {
                ...
                case 7:
                    return OSSL_PARAM_get_octet_ptr(ctx->params,
                                                    ctx->p2, &ctx->sz);
                default:
                    (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",643,__func__), ERR_set_error)(6, (268|(0x2 << 18L)),
                                   "[action:%d, state:%d] "
                ...
                if (param_data_type == 0) {
                    ...
                    if (!__builtin_expect(!!((translation->fixup_args != 
# 660 "../crypto/evp/ctrl_params_translate.c" 3 4
                        ((void *)0)
# 660 "../crypto/evp/ctrl_params_translate.c"
                        ) != 0), 1)) {
                        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",661,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 661 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 661 "../crypto/evp/ctrl_params_translate.c"
                       );
                        return 0;
                    }
                ...
                case 2:
                    if (ctx->p2 != 
# 671 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 671 "../crypto/evp/ctrl_params_translate.c"
                                      ) {
                ...
                case 7:
                    return OSSL_PARAM_set_octet_ptr(ctx->params, *(void **)ctx->p2,
                                                    size);
                default:
                    (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",689,__func__), ERR_set_error)(6, (268|(0x2 << 18L)),
                                   "[action:%d, state:%d] "
                ...
                if (translation->param_data_type == 7)
                    ctx->p2 = &ctx->bufp;
            }
        }
...
{
    if (ctx->allocated_buf != 
# 712 "../crypto/evp/ctrl_params_translate.c" 3 4
                             ((void *)0)
# 712 "../crypto/evp/ctrl_params_translate.c"
                                 )
        CRYPTO_free(ctx->allocated_buf, "../crypto/evp/ctrl_params_translate.c", 713);
    ctx->allocated_buf = 
# 714 "../crypto/evp/ctrl_params_translate.c" 3 4
                        ((void *)0)
# 714 "../crypto/evp/ctrl_params_translate.c"
                            ;
    return 1;
}
                                                         ...
                                                         const char *name))
{
    ...
    if (state == PRE_CTRL_TO_PARAMS && ctx->action_type == GET) {
        ...
        ctx->p2 = (char *)(ctx->p2 == 
# 771 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
                           
# 772 "../crypto/evp/ctrl_params_translate.c"
                          ? OBJ_nid2sn(ctx->p1)
                           : get_name(ctx->p2));
        ctx->p1 = strlen(ctx->p2);
    } else if (state == POST_PARAMS_TO_CTRL && ctx->action_type == GET) {
        ctx->p2 = (ctx->p2 == 
# 776 "../crypto/evp/ctrl_params_translate.c" 3 4
                             ((void *)0) 
# 776 "../crypto/evp/ctrl_params_translate.c"
                                  ? "" : (char *)get_name(ctx->p2));
        ctx->p1 = strlen(ctx->p2);
    }
                        ...
                        const struct kdf_type_map_st *kdf_type_map)
{
    ...
    if (state == PRE_CTRL_TO_PARAMS) {
        ...
        if (!__builtin_expect(!!((ctx->action_type == NONE) != 0), 1))
            return 0;


        if (ctx->p1 == -2) {
# 872 "../crypto/evp/ctrl_params_translate.c"
            ctx->p2 = ctx->name_buf;
            ctx->p1 = sizeof(ctx->name_buf);
            ctx->action_type = GET;
        } else {
    ...
    if ((state == PRE_CTRL_TO_PARAMS && ctx->action_type == SET)
        ...
        for (; kdf_type_map->kdf_type_str != 
# 887 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 887 "../crypto/evp/ctrl_params_translate.c"
                                                ; kdf_type_map++)
    ...
    if ((state == POST_CTRL_TO_PARAMS && ctx->action_type == GET)
        ...
        for (; kdf_type_map->kdf_type_str != 
# 906 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 906 "../crypto/evp/ctrl_params_translate.c"
                                                ; kdf_type_map++)
        ...
        ctx->p2 = 
# 912 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 912 "../crypto/evp/ctrl_params_translate.c"
                     ;
    } else if (state == PRE_PARAMS_TO_CTRL && ctx->action_type == GET) {
        ctx->p1 = -2;
    }
                           ...
                           struct translation_ctx_st *ctx)
{
    static const struct kdf_type_map_st kdf_type_map[] = {
        ...
        { 2, "X942KDF-ASN1" },
        { 0, 
# 928 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0) 
# 928 "../crypto/evp/ctrl_params_translate.c"
                 }
    };
                           ...
                           struct translation_ctx_st *ctx)
{
    static const struct kdf_type_map_st kdf_type_map[] = {
        ...
        { 2, "X963KDF" },
        { 0, 
# 942 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0) 
# 942 "../crypto/evp/ctrl_params_translate.c"
                 }
    };
                   ...
                   struct translation_ctx_st *ctx)
{
    ...
    if ((state == PRE_CTRL_TO_PARAMS && ctx->action_type == SET)
        || (state == POST_PARAMS_TO_CTRL && ctx->action_type == GET)) {
# 968 "../crypto/evp/ctrl_params_translate.c"
...
# 1007 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                          ((void *)0)
# 1007 "../crypto/evp/ctrl_params_translate.c"
                                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1008,__func__), ERR_set_error)((6),(222),
# 1008 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1008 "../crypto/evp/ctrl_params_translate.c"
           );
            return 0;
        }
        ctx->p1 = 0;
                          ...
                          struct translation_ctx_st *ctx)
{
    ...
    case PRE_CTRL_TO_PARAMS:
        if ((ctx->p2 = (char *)ossl_ffc_named_group_get_name
             (ossl_ffc_uid_to_dh_named_group(ctx->p1))) == 
# 1034 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                          ((void *)0)
# 1034 "../crypto/evp/ctrl_params_translate.c"
                                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1035,__func__), ERR_set_error)((6),(222),
# 1035 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1035 "../crypto/evp/ctrl_params_translate.c"
           );
            return 0;
        }
    ...
    case PRE_CTRL_STR_TO_PARAMS:
        if (ctx->p2 == 
# 1043 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1043 "../crypto/evp/ctrl_params_translate.c"
                          )
            return 0;
        if ((ctx->p2 = (char *)ossl_ffc_named_group_get_name
             (ossl_ffc_uid_to_dh_named_group(atoi(ctx->p2)))) == 
# 1046 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                ((void *)0)
# 1046 "../crypto/evp/ctrl_params_translate.c"
                                                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1047,__func__), ERR_set_error)((6),(222),
# 1047 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1047 "../crypto/evp/ctrl_params_translate.c"
           );
            return 0;
        }
                                ...
                                struct translation_ctx_st *ctx)
{
    ...
    if (state == PRE_CTRL_STR_TO_PARAMS) {
        if ((ctx->p2 = (char *)ossl_dh_gen_type_id2name(atoi(ctx->p2)))
             == 
# 1077 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 1077 "../crypto/evp/ctrl_params_translate.c"
                   ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1078,__func__), ERR_set_error)((6),(222),
# 1078 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1078 "../crypto/evp/ctrl_params_translate.c"
           );
            return 0;
        }
        ctx->p1 = strlen(ctx->p2);
                            ...
                            struct translation_ctx_st *ctx)
{
    ...
    if (state == PRE_PARAMS_TO_CTRL) {
        if (strcmp(ctx->p2, "explicit") == 0)
            ctx->p1 = 0x000;
        else if (strcmp(ctx->p2, "named_curve") == 0)
            ctx->p1 = 0x001;
        else
            ctx->p1 = ret = -2;
        ctx->p2 = 
# 1126 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 1126 "../crypto/evp/ctrl_params_translate.c"
                     ;
    }

 end:
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1131,__func__), ERR_set_error)((6),(147),
# 1131 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1131 "../crypto/evp/ctrl_params_translate.c"
       );
    return ret;
}
...
{
    char *p2 = 
# 1140 "../crypto/evp/ctrl_params_translate.c" 3 4
              ((void *)0)
# 1140 "../crypto/evp/ctrl_params_translate.c"
                  ;
    int ret;
...
# 1162 "../crypto/evp/ctrl_params_translate.c"
        p2 = ctx->name_buf;
        ctx->p2 = &p2;
    ...
    if (state == PRE_PARAMS_TO_CTRL) {
        ...
        ctx->p2 = 
# 1172 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 1172 "../crypto/evp/ctrl_params_translate.c"
                     ;
    }
                                ...
                                struct translation_ctx_st *ctx)
{
    static const OSSL_ITEM str_value_map[] = {
        ...
        { 7, 
# 1258 "../crypto/evp/ctrl_params_translate.c" 3 4
                                       ((void *)0) 
# 1258 "../crypto/evp/ctrl_params_translate.c"
                                                }
    };
    int ret;
    ...
    if (state == PRE_CTRL_TO_PARAMS && ctx->action_type == GET) {
# 1277 "../crypto/evp/ctrl_params_translate.c"
        ctx->orig_p2 = ctx->p2;
        ctx->p2 = ctx->name_buf;
        ctx->p1 = sizeof(ctx->name_buf);
    } else if (state == PRE_CTRL_TO_PARAMS && ctx->action_type == SET) {
# 1298 "../crypto/evp/ctrl_params_translate.c"
        ...
        for (i = 0; i < (sizeof(str_value_map)/sizeof((str_value_map)[0])); i++) {
            if (ctx->p1 == (int)str_value_map[i].id)
                break;
        }
        if (i == (sizeof(str_value_map)/sizeof((str_value_map)[0]))) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1324,__func__), ERR_set_error)(4, 118,
        ...
        if (str_value_map[i].ptr == 
# 1333 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 1333 "../crypto/evp/ctrl_params_translate.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1334,__func__), ERR_set_error)((6),(147),
# 1334 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1334 "../crypto/evp/ctrl_params_translate.c"
           );
            return -2;
        }
    ...
    if ((ctx->action_type == SET && state == PRE_PARAMS_TO_CTRL)
        ...
        if (i == (sizeof(str_value_map)/sizeof((str_value_map)[0]))) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1354,__func__), ERR_set_error)(4, 118,
        ...
        ctx->p2 = 
# 1364 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 1364 "../crypto/evp/ctrl_params_translate.c"
                     ;
    }
                               ...
                               struct translation_ctx_st *ctx)
{
    ...
    if (state == PRE_CTRL_TO_PARAMS && ctx->action_type == GET) {
# 1398 "../crypto/evp/ctrl_params_translate.c"
        ctx->orig_p2 = ctx->p2;
        ctx->p2 = ctx->name_buf;
        ctx->p1 = sizeof(ctx->name_buf);
    ...
    if ((ctx->action_type == SET && state == PRE_PARAMS_TO_CTRL)
        ...
        val = i == (sizeof(str_value_map)/sizeof((str_value_map)[0])) ? atoi(ctx->p2)
        ...
        ctx->p2 = 
# 1444 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 1444 "../crypto/evp/ctrl_params_translate.c"
                     ;
    }
                         ...
                         struct translation_ctx_st *ctx)
{
    ...
    if ((ctx->action_type == SET && state == PRE_PARAMS_TO_CTRL)
        ...
        if (state == POST_CTRL_TO_PARAMS)
            ...
            ctx->p1 = str_value_map[i].id;
        ctx->p2 = 
# 1496 "../crypto/evp/ctrl_params_translate.c" 3 4
                 ((void *)0)
# 1496 "../crypto/evp/ctrl_params_translate.c"
                     ;
    }

    return 1;
}
# 1512 "../crypto/evp/ctrl_params_translate.c"
                                  ...
                                  struct translation_ctx_st *ctx)
{
    ...
    ctx->p2 = 
# 1518 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1518 "../crypto/evp/ctrl_params_translate.c"
                 ;
    ...
    case 408:
        {
            ...
            if (grp != 
# 1542 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1542 "../crypto/evp/ctrl_params_translate.c"
                          )
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1550,__func__), ERR_set_error)((6),(224),
# 1550 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1550 "../crypto/evp/ctrl_params_translate.c"
       );
        return 0;
    }
    ...
    if (ctx->p2 == 
# 1558 "../crypto/evp/ctrl_params_translate.c" 3 4
                  ((void *)0)
# 1558 "../crypto/evp/ctrl_params_translate.c"
                      )
        return 1;
                                   ...
                                   struct translation_ctx_st *ctx)
{
    ...
    ctx->p2 = 
# 1571 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1571 "../crypto/evp/ctrl_params_translate.c"
                 ;
    if (ctx->params->data_type != 2)
        return 0;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1595,__func__), ERR_set_error)((6),(224),
# 1595 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1595 "../crypto/evp/ctrl_params_translate.c"
       );
        return 0;
    }
                                  ...
                                  struct translation_ctx_st *ctx)
{
    EVP_PKEY *pkey = ctx->p2;
    unsigned char *buf = 
# 1607 "../crypto/evp/ctrl_params_translate.c" 3 4
                        ((void *)0)
# 1607 "../crypto/evp/ctrl_params_translate.c"
                            ;
    int ret;

    ctx->p2 = 
# 1610 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1610 "../crypto/evp/ctrl_params_translate.c"
                 ;
    switch (EVP_PKEY_get_base_id(pkey)) {
    ...
    case 408:
        if (ctx->params->data_type == 5) {
            ...
            if (bnctx == 
# 1644 "../crypto/evp/ctrl_params_translate.c" 3 4
                        ((void *)0)
# 1644 "../crypto/evp/ctrl_params_translate.c"
                            )
                return 0;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1656,__func__), ERR_set_error)((6),(224),
# 1656 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1656 "../crypto/evp/ctrl_params_translate.c"
       );
        return 0;
    }

    ret = default_fixup_args(state, translation, ctx);
    CRYPTO_free(buf, "../crypto/evp/ctrl_params_translate.c", 1661);
    return ret;
}
                                     ...
                                     struct translation_ctx_st *ctx)
{
    ...
    const EC_GROUP *ecg;
    BIGNUM *x = 
# 1675 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 1675 "../crypto/evp/ctrl_params_translate.c"
                   ;
    BIGNUM *y = 
# 1676 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 1676 "../crypto/evp/ctrl_params_translate.c"
                   ;
    int ret = 0;

    ctx->p2 = 
# 1679 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1679 "../crypto/evp/ctrl_params_translate.c"
                 ;

    if (eckey == 
# 1681 "../crypto/evp/ctrl_params_translate.c" 3 4
                ((void *)0)
# 1681 "../crypto/evp/ctrl_params_translate.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1682,__func__), ERR_set_error)((6),(224),
# 1682 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1682 "../crypto/evp/ctrl_params_translate.c"
       );
        return 0;
    }
    ...
    if (bnctx == 
# 1687 "../crypto/evp/ctrl_params_translate.c" 3 4
                ((void *)0)
# 1687 "../crypto/evp/ctrl_params_translate.c"
                    )
        return 0;
    ...
    y = BN_CTX_get(bnctx);
    if (y == 
# 1699 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0)
# 1699 "../crypto/evp/ctrl_params_translate.c"
                )
        goto out;
    ...
    if (strncmp(ctx->params->key, "qx", 2) == 0)
        ctx->p2 = x;
    else if (strncmp(ctx->params->key, "qy", 2) == 0)
        ctx->p2 = y;
    else
        goto out;
...
{
    if (bn == 
# 1727 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1727 "../crypto/evp/ctrl_params_translate.c"
                 )
        return 0;
    if (ctx->params->data_type != 2)
        return 0;
...
{
    const BIGNUM *bn = 
# 1740 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1740 "../crypto/evp/ctrl_params_translate.c"
                          ;
    EVP_PKEY *pkey = ctx->p2;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1755,__func__), ERR_set_error)((6),(224),
# 1755 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1755 "../crypto/evp/ctrl_params_translate.c"
       );
    }
...
{
    const BIGNUM *bn = 
# 1765 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1765 "../crypto/evp/ctrl_params_translate.c"
                          ;
...
{
    const BIGNUM *bn = 
# 1787 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1787 "../crypto/evp/ctrl_params_translate.c"
                          ;
...
static int get_payload_int(enum state state,
                           ...
                           const int val)
{
    if (ctx->params->data_type != 1)
        return 0;
    ctx->p1 = val;
    ctx->p2 = 
# 1813 "../crypto/evp/ctrl_params_translate.c" 3 4
             ((void *)0)
# 1813 "../crypto/evp/ctrl_params_translate.c"
                 ;
                                               ...
                                               struct translation_ctx_st *ctx)
{
    ...
    case 408:
        ...
        if (val < 0) {
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1830,__func__), ERR_set_error)((6),(163),
# 1830 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 1830 "../crypto/evp/ctrl_params_translate.c"
           );
            return 0;
        }
        break;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",1836,__func__), ERR_set_error)((6),(224),
# 1836 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 1836 "../crypto/evp/ctrl_params_translate.c"
       );
        return 0;
    }
...
{
    const BIGNUM *bn = 
# 1847 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1847 "../crypto/evp/ctrl_params_translate.c"
                          ;

    if (EVP_PKEY_get_base_id(ctx->p2) != 6
        && EVP_PKEY_get_base_id(ctx->p2) != 912)
        return 0;
...
{
    const BIGNUM *bn = 
# 1861 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1861 "../crypto/evp/ctrl_params_translate.c"
                          ;
...
{
    const BIGNUM *bn = 
# 1875 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1875 "../crypto/evp/ctrl_params_translate.c"
                          ;
                                  ...
                                  size_t factornum)
{
    ...
    const BIGNUM *bn = 
# 1891 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1891 "../crypto/evp/ctrl_params_translate.c"
                          ;
                                    ...
                                    size_t exponentnum)
{
    const RSA *r = EVP_PKEY_get0_RSA(ctx->p2);
    const BIGNUM *bn = 
# 1921 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1921 "../crypto/evp/ctrl_params_translate.c"
                          ;
                                       ...
                                       size_t coefficientnum)
{
    const RSA *r = EVP_PKEY_get0_RSA(ctx->p2);
    const BIGNUM *bn = 
# 1951 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 1951 "../crypto/evp/ctrl_params_translate.c"
                          ;
...
# 2010 "../crypto/evp/ctrl_params_translate.c"
static int get_rsa_payload_f1(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 1 - 1); }
static int get_rsa_payload_f2(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 2 - 1); }
static int get_rsa_payload_f3(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 3 - 1); }
static int get_rsa_payload_f4(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 4 - 1); }
static int get_rsa_payload_f5(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 5 - 1); }
static int get_rsa_payload_f6(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 6 - 1); }
static int get_rsa_payload_f7(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 7 - 1); }
static int get_rsa_payload_f8(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 8 - 1); }
static int get_rsa_payload_f9(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 9 - 1); }
static int get_rsa_payload_f10(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_factor(state, translation, ctx, 10 - 1); }
static int get_rsa_payload_e1(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 1 - 1); }
static int get_rsa_payload_e2(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 2 - 1); }
static int get_rsa_payload_e3(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 3 - 1); }
static int get_rsa_payload_e4(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 4 - 1); }
static int get_rsa_payload_e5(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 5 - 1); }
static int get_rsa_payload_e6(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 6 - 1); }
static int get_rsa_payload_e7(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 7 - 1); }
static int get_rsa_payload_e8(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 8 - 1); }
static int get_rsa_payload_e9(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 9 - 1); }
static int get_rsa_payload_e10(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_exponent(state, translation, ctx, 10 - 1); }
static int get_rsa_payload_c1(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 1 - 1); }
static int get_rsa_payload_c2(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 2 - 1); }
static int get_rsa_payload_c3(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 3 - 1); }
static int get_rsa_payload_c4(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 4 - 1); }
static int get_rsa_payload_c5(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 5 - 1); }
static int get_rsa_payload_c6(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 6 - 1); }
static int get_rsa_payload_c7(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 7 - 1); }
static int get_rsa_payload_c8(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 8 - 1); }
static int get_rsa_payload_c9(enum state state, const struct translation_st *translation, struct translation_ctx_st *ctx) { if (EVP_PKEY_get_base_id(ctx->p2) != 6 && EVP_PKEY_get_base_id(ctx->p2) != 912) return 0; return get_rsa_payload_coefficient(state, translation, ctx, 9 - 1); }
...
{
    const char *value = 
# 2044 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 2044 "../crypto/evp/ctrl_params_translate.c"
                           ;

    switch (state) {
    case PRE_PARAMS_TO_CTRL:
        if (!((ctx->pctx)->operation == (1<<1) || (ctx->pctx)->operation == (1<<2)))
            return 0;
    ...
    case POST_PARAMS_TO_CTRL:
        if (OSSL_PARAM_get_utf8_string_ptr(ctx->params, &value) == 0 ||
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",2055,__func__), ERR_set_error)((6),((262|(0x2 << 18L))),
# 2055 "../crypto/evp/ctrl_params_translate.c" 3 4
           ((void *)0)
# 2055 "../crypto/evp/ctrl_params_translate.c"
           );
            ctx->p1 = 0;
            return 0;
        }
...
# 2080 "../crypto/evp/ctrl_params_translate.c"
    { SET, -1, -1, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      15, "distid", "hexdistid",
      "distid", 5, 
# 2082 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0) 
# 2082 "../crypto/evp/ctrl_params_translate.c"
                                                            },
    { GET, -1, -1, -1,
      16, "distid", "hexdistid",
      "distid", 7, 
# 2085 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                    ((void *)0) 
# 2085 "../crypto/evp/ctrl_params_translate.c"
                                                         },
    { GET, -1, -1, -1,
      17, 
# 2087 "../crypto/evp/ctrl_params_translate.c" 3 4
                                ((void *)0)
# 2087 "../crypto/evp/ctrl_params_translate.c"
                                    , 
# 2087 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2087 "../crypto/evp/ctrl_params_translate.c"
                                          ,
      "distid", 7, fix_distid_len },
# 2099 "../crypto/evp/ctrl_params_translate.c"
    { NONE, 920, 0, (1<<11),
      (0x1000 + 6), 
# 2100 "../crypto/evp/ctrl_params_translate.c" 3 4
                                ((void *)0)
# 2100 "../crypto/evp/ctrl_params_translate.c"
                                    , 
# 2100 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2100 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 920, 0, (1<<11),
      (0x1000 + 7), 
# 2104 "../crypto/evp/ctrl_params_translate.c" 3 4
                              ((void *)0)
# 2104 "../crypto/evp/ctrl_params_translate.c"
                                  , 
# 2104 "../crypto/evp/ctrl_params_translate.c" 3 4
                                    ((void *)0)
# 2104 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, 920, 0, (1<<11),
      (0x1000 + 8), 
# 2107 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2107 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2107 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2107 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 920, 0, (1<<11),
      (0x1000 + 9), 
# 2110 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2110 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2110 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2110 "../crypto/evp/ctrl_params_translate.c"
                                            ,
      "kdf-outlen", 2, 
# 2111 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2111 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { GET, 920, 0, (1<<11),
      (0x1000 + 10), 
# 2113 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2113 "../crypto/evp/ctrl_params_translate.c"
                                          , 
# 2113 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 2113 "../crypto/evp/ctrl_params_translate.c"
                                                ,
      "kdf-outlen", 2, 
# 2114 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2114 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { SET, 920, 0, (1<<11),
      (0x1000 + 11), 
# 2116 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2116 "../crypto/evp/ctrl_params_translate.c"
                                   , 
# 2116 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2116 "../crypto/evp/ctrl_params_translate.c"
                                         ,
      "kdf-ukm", 5, 
# 2117 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2117 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { GET, 920, 0, (1<<11),
      (0x1000 + 12), 
# 2119 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 2119 "../crypto/evp/ctrl_params_translate.c"
                                       , 
# 2119 "../crypto/evp/ctrl_params_translate.c" 3 4
                                         ((void *)0)
# 2119 "../crypto/evp/ctrl_params_translate.c"
                                             ,
      "kdf-ukm", 7, 
# 2120 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                        ((void *)0) 
# 2120 "../crypto/evp/ctrl_params_translate.c"
                                                             },
    { SET, 920, 0, (1<<11),
      (0x1000 + 13), 
# 2122 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2122 "../crypto/evp/ctrl_params_translate.c"
                                   , 
# 2122 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2122 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, 920, 0, (1<<11),
      (0x1000 + 14), 
# 2125 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 2125 "../crypto/evp/ctrl_params_translate.c"
                                       , 
# 2125 "../crypto/evp/ctrl_params_translate.c" 3 4
                                         ((void *)0)
# 2125 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 920, 0, (1<<1),
      (0x1000 + 5), "dh_paramgen_type", 
# 2130 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                         ((void *)0)
# 2130 "../crypto/evp/ctrl_params_translate.c"
                                                             ,
      "type", 4, fix_dh_paramgen_type },
    { SET, 920, 0, (1<<1),
      (0x1000 + 1), "dh_paramgen_prime_len", 
# 2133 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                   ((void *)0)
# 2133 "../crypto/evp/ctrl_params_translate.c"
                                                                       ,
      "pbits", 2, 
# 2134 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                             ((void *)0) 
# 2134 "../crypto/evp/ctrl_params_translate.c"
                                                                  },
    { SET, 920, 0, (1<<1) | (1<<2),
      (0x1000 + 15), "dh_param", 
# 2136 "../crypto/evp/ctrl_params_translate.c" 3 4
                                       ((void *)0)
# 2136 "../crypto/evp/ctrl_params_translate.c"
                                           ,
      "group", 4, 
# 2137 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                         ((void *)0) 
# 2137 "../crypto/evp/ctrl_params_translate.c"
                                                              },
    { SET, 920, 0, (1<<1) | (1<<2),
      (0x1000 + 3), "dh_rfc5114", 
# 2139 "../crypto/evp/ctrl_params_translate.c" 3 4
                                             ((void *)0)
# 2139 "../crypto/evp/ctrl_params_translate.c"
                                                 ,
      "group", 4, fix_dh_nid5114 },


    { SET, 28, 0, (1<<1),
      (0x1000 + 5), "dh_paramgen_type", 
# 2144 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                         ((void *)0)
# 2144 "../crypto/evp/ctrl_params_translate.c"
                                                             ,
      "type", 4, fix_dh_paramgen_type },
    { SET, 28, 0, (1<<1),
      (0x1000 + 1), "dh_paramgen_prime_len", 
# 2147 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                   ((void *)0)
# 2147 "../crypto/evp/ctrl_params_translate.c"
                                                                       ,
      "pbits", 2, 
# 2148 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                             ((void *)0) 
# 2148 "../crypto/evp/ctrl_params_translate.c"
                                                                  },
    { SET, 28, 0, (1<<1) | (1<<2),
      (0x1000 + 15), "dh_param", 
# 2150 "../crypto/evp/ctrl_params_translate.c" 3 4
                                       ((void *)0)
# 2150 "../crypto/evp/ctrl_params_translate.c"
                                           ,
      "group", 4, fix_dh_nid },
    { SET, 28, 0, (1<<1) | (1<<2),
      (0x1000 + 3), "dh_rfc5114", 
# 2153 "../crypto/evp/ctrl_params_translate.c" 3 4
                                             ((void *)0)
# 2153 "../crypto/evp/ctrl_params_translate.c"
                                                 ,
      "group", 4, fix_dh_nid5114 },


    { SET, 28, 0, (1<<1),
      (0x1000 + 2), "dh_paramgen_generator", 
# 2158 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                   ((void *)0)
# 2158 "../crypto/evp/ctrl_params_translate.c"
                                                                       ,
      "safeprime-generator", 1, 
# 2159 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0) 
# 2159 "../crypto/evp/ctrl_params_translate.c"
                                                            },


    { SET, 920, 0, (1<<1),
      (0x1000 + 4), "dh_paramgen_subprime_len", 
# 2163 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                         ((void *)0)
# 2163 "../crypto/evp/ctrl_params_translate.c"
                                                                             ,
      "qbits", 2, 
# 2164 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                             ((void *)0) 
# 2164 "../crypto/evp/ctrl_params_translate.c"
                                                                  },

    { SET, 28, 0, (1<<11),
      (0x1000 + 16), "dh_pad", 
# 2167 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2167 "../crypto/evp/ctrl_params_translate.c"
                                         ,
      "pad", 2, 
# 2168 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2168 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    ...
    { SET, 116, 0, (1<<1),
      (0x1000 + 1), "dsa_paramgen_bits", 
# 2175 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0)
# 2175 "../crypto/evp/ctrl_params_translate.c"
                                                               ,
      "pbits", 2, 
# 2176 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                             ((void *)0) 
# 2176 "../crypto/evp/ctrl_params_translate.c"
                                                                  },
    { SET, 116, 0, (1<<1),
      (0x1000 + 2), "dsa_paramgen_q_bits", 
# 2178 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                               ((void *)0)
# 2178 "../crypto/evp/ctrl_params_translate.c"
                                                                   ,
      "qbits", 2, 
# 2179 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                             ((void *)0) 
# 2179 "../crypto/evp/ctrl_params_translate.c"
                                                                  },
    { SET, 116, 0, (1<<1),
      (0x1000 + 3), "dsa_paramgen_md", 
# 2181 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0)
# 2181 "../crypto/evp/ctrl_params_translate.c"
                                                           ,
      "digest", 4, fix_md },
    ...
    { SET, 408, 0, (1<<1) | (1<<2),
      (0x1000 + 2), "ec_param_enc", 
# 2189 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                 ((void *)0)
# 2189 "../crypto/evp/ctrl_params_translate.c"
                                                     ,
      "encoding", 4, fix_ec_param_enc },
    { SET, 408, 0, (1<<1) | (1<<2),
      (0x1000 + 1), "ec_paramgen_curve", 
# 2192 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                               ((void *)0)
# 2192 "../crypto/evp/ctrl_params_translate.c"
                                                                   ,
      "group", 4,
    ...
    { NONE, 408, 0, (1<<11),
      (0x1000 + 3), "ecdh_cofactor_mode", 
# 2200 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0)
# 2200 "../crypto/evp/ctrl_params_translate.c"
                                                               ,
      "ecdh-cofactor-mode", 1,
      fix_ecdh_cofactor },
    { NONE, 408, 0, (1<<11),
      (0x1000 + 4), 
# 2204 "../crypto/evp/ctrl_params_translate.c" 3 4
                                ((void *)0)
# 2204 "../crypto/evp/ctrl_params_translate.c"
                                    , 
# 2204 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2204 "../crypto/evp/ctrl_params_translate.c"
                                          ,
      "kdf-type", 4, fix_ec_kdf_type },
    { SET, 408, 0, (1<<11),
      (0x1000 + 5), "ecdh_kdf_md", 
# 2207 "../crypto/evp/ctrl_params_translate.c" 3 4
                                             ((void *)0)
# 2207 "../crypto/evp/ctrl_params_translate.c"
                                                 ,
      "kdf-digest", 4, fix_md },
    { GET, 408, 0, (1<<11),
      (0x1000 + 6), 
# 2210 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2210 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2210 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2210 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 408, 0, (1<<11),
      (0x1000 + 7), 
# 2213 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2213 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2213 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2213 "../crypto/evp/ctrl_params_translate.c"
                                            ,
      "kdf-outlen", 2, 
# 2214 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2214 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { GET, 408, 0, (1<<11),
      (0x1000 + 8), 
# 2216 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2216 "../crypto/evp/ctrl_params_translate.c"
                                          , 
# 2216 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 2216 "../crypto/evp/ctrl_params_translate.c"
                                                ,
      "kdf-outlen", 2, 
# 2217 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2217 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { SET, 408, 0, (1<<11),
      (0x1000 + 9), 
# 2219 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2219 "../crypto/evp/ctrl_params_translate.c"
                                   , 
# 2219 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2219 "../crypto/evp/ctrl_params_translate.c"
                                         ,
      "kdf-ukm", 5, 
# 2220 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2220 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { GET, 408, 0, (1<<11),
      (0x1000 + 10), 
# 2222 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 2222 "../crypto/evp/ctrl_params_translate.c"
                                       , 
# 2222 "../crypto/evp/ctrl_params_translate.c" 3 4
                                         ((void *)0)
# 2222 "../crypto/evp/ctrl_params_translate.c"
                                             ,
      "kdf-ukm", 7, 
# 2223 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                        ((void *)0) 
# 2223 "../crypto/evp/ctrl_params_translate.c"
                                                             },
    ...
    { SET, 1172, 0, (1<<1) | (1<<2),
      (0x1000 + 2), "ec_param_enc", 
# 2230 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                 ((void *)0)
# 2230 "../crypto/evp/ctrl_params_translate.c"
                                                     ,
      "encoding", 4, fix_ec_param_enc },
    { SET, 1172, 0, (1<<1) | (1<<2),
      (0x1000 + 1), "ec_paramgen_curve", 
# 2233 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                               ((void *)0)
# 2233 "../crypto/evp/ctrl_params_translate.c"
                                                                   ,
      "group", 4,
      fix_ec_paramgen_curve_nid },
    ...
    { NONE, 1172, 0, (1<<11),
      (0x1000 + 3), "ecdh_cofactor_mode", 
# 2241 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0)
# 2241 "../crypto/evp/ctrl_params_translate.c"
                                                               ,
      "ecdh-cofactor-mode", 1,
      fix_ecdh_cofactor },
    { NONE, 1172, 0, (1<<11),
      (0x1000 + 4), 
# 2245 "../crypto/evp/ctrl_params_translate.c" 3 4
                                ((void *)0)
# 2245 "../crypto/evp/ctrl_params_translate.c"
                                    , 
# 2245 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2245 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 1172, 0, (1<<11),
      (0x1000 + 5), "ecdh_kdf_md", 
# 2248 "../crypto/evp/ctrl_params_translate.c" 3 4
                                             ((void *)0)
# 2248 "../crypto/evp/ctrl_params_translate.c"
                                                 ,
      "kdf-digest", 4, fix_md },
    { GET, 1172, 0, (1<<11),
      (0x1000 + 6), 
# 2251 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2251 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2251 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2251 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 1172, 0, (1<<11),
      (0x1000 + 7), 
# 2254 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2254 "../crypto/evp/ctrl_params_translate.c"
                                      , 
# 2254 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2254 "../crypto/evp/ctrl_params_translate.c"
                                            ,
      "kdf-outlen", 2, 
# 2255 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2255 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { GET, 1172, 0, (1<<11),
      (0x1000 + 8), 
# 2257 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2257 "../crypto/evp/ctrl_params_translate.c"
                                          , 
# 2257 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 2257 "../crypto/evp/ctrl_params_translate.c"
                                                ,
      "kdf-outlen", 2, 
# 2258 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0) 
# 2258 "../crypto/evp/ctrl_params_translate.c"
                                                                       },
    { SET, 1172, 0, (1<<11),
      (0x1000 + 9), 
# 2260 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2260 "../crypto/evp/ctrl_params_translate.c"
                                   , 
# 2260 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2260 "../crypto/evp/ctrl_params_translate.c"
                                         ,
      "kdf-ukm", 5, 
# 2261 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2261 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { GET, 1172, 0, (1<<11),
      (0x1000 + 10), 
# 2263 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 2263 "../crypto/evp/ctrl_params_translate.c"
                                       , 
# 2263 "../crypto/evp/ctrl_params_translate.c" 3 4
                                         ((void *)0)
# 2263 "../crypto/evp/ctrl_params_translate.c"
                                             ,
      "kdf-ukm", 7, 
# 2264 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                        ((void *)0) 
# 2264 "../crypto/evp/ctrl_params_translate.c"
                                                             },
# 2276 "../crypto/evp/ctrl_params_translate.c"
    { SET, 6, 912,
      ((1<<9) | (1<<10)) | ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 1), "rsa_padding_mode", 
# 2278 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                    ((void *)0)
# 2278 "../crypto/evp/ctrl_params_translate.c"
                                                        ,
      "pad-mode", 4, fix_rsa_padding_mode },
    { GET, 6, 912,
      ((1<<9) | (1<<10)) | ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 6), 
# 2282 "../crypto/evp/ctrl_params_translate.c" 3 4
                                    ((void *)0)
# 2282 "../crypto/evp/ctrl_params_translate.c"
                                        , 
# 2282 "../crypto/evp/ctrl_params_translate.c" 3 4
                                          ((void *)0)
# 2282 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 6, 912,
      ((1<<9) | (1<<10)) | ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 5), "rsa_mgf1_md", 
# 2287 "../crypto/evp/ctrl_params_translate.c" 3 4
                                               ((void *)0)
# 2287 "../crypto/evp/ctrl_params_translate.c"
                                                   ,
      "mgf1-digest", 4, fix_md },
    { GET, 6, 912,
      ((1<<9) | (1<<10)) | ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 8), 
# 2291 "../crypto/evp/ctrl_params_translate.c" 3 4
                                    ((void *)0)
# 2291 "../crypto/evp/ctrl_params_translate.c"
                                        , 
# 2291 "../crypto/evp/ctrl_params_translate.c" 3 4
                                          ((void *)0)
# 2291 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 6, 912, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 2), "rsa_pss_saltlen", 
# 2301 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0)
# 2301 "../crypto/evp/ctrl_params_translate.c"
                                                           ,
      "saltlen", 4,
      fix_rsa_pss_saltlen },
    { GET, 6, 912, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      (0x1000 + 7), 
# 2305 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2305 "../crypto/evp/ctrl_params_translate.c"
                                            , 
# 2305 "../crypto/evp/ctrl_params_translate.c" 3 4
                                              ((void *)0)
# 2305 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 6, 0, ((1<<9) | (1<<10)),
      (0x1000 + 9), "rsa_oaep_md", 
# 2310 "../crypto/evp/ctrl_params_translate.c" 3 4
                                               ((void *)0)
# 2310 "../crypto/evp/ctrl_params_translate.c"
                                                   ,
      "digest", 4, fix_md },
    { GET, 6, 0, ((1<<9) | (1<<10)),
      (0x1000 + 11), 
# 2313 "../crypto/evp/ctrl_params_translate.c" 3 4
                                    ((void *)0)
# 2313 "../crypto/evp/ctrl_params_translate.c"
                                        , 
# 2313 "../crypto/evp/ctrl_params_translate.c" 3 4
                                          ((void *)0)
# 2313 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 6, 0, ((1<<9) | (1<<10)),
      (0x1000 + 10), 
# 2322 "../crypto/evp/ctrl_params_translate.c" 3 4
                                   ((void *)0)
# 2322 "../crypto/evp/ctrl_params_translate.c"
                                       , "rsa_oaep_label",
      "oaep-label", 5, 
# 2323 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                 ((void *)0) 
# 2323 "../crypto/evp/ctrl_params_translate.c"
                                                                      },
    { GET, 6, 0, ((1<<9) | (1<<10)),
      (0x1000 + 12), 
# 2325 "../crypto/evp/ctrl_params_translate.c" 3 4
                                       ((void *)0)
# 2325 "../crypto/evp/ctrl_params_translate.c"
                                           , 
# 2325 "../crypto/evp/ctrl_params_translate.c" 3 4
                                             ((void *)0)
# 2325 "../crypto/evp/ctrl_params_translate.c"
                                                 ,
      "oaep-label", 7, 
# 2326 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                              ((void *)0) 
# 2326 "../crypto/evp/ctrl_params_translate.c"
                                                                   },

    { SET, 6, 0, ((1<<9) | (1<<10)),
      (0x1000 + 14), 
# 2329 "../crypto/evp/ctrl_params_translate.c" 3 4
                                           ((void *)0)
# 2329 "../crypto/evp/ctrl_params_translate.c"
                                               ,
      "rsa_pkcs1_implicit_rejection",
      "implicit-rejection", 2,
      
# 2332 "../crypto/evp/ctrl_params_translate.c" 3 4
     ((void *)0) 
# 2332 "../crypto/evp/ctrl_params_translate.c"
          },

    { SET, 912, 0, ((1<<1) | (1<<2)),
      1, "rsa_pss_keygen_md", 
# 2335 "../crypto/evp/ctrl_params_translate.c" 3 4
                                            ((void *)0)
# 2335 "../crypto/evp/ctrl_params_translate.c"
                                                ,
      "digest", 4, fix_md },
    { SET, 912, 0, ((1<<1) | (1<<2)),
      (0x1000 + 5), "rsa_pss_keygen_mgf1_md", 
# 2338 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                          ((void *)0)
# 2338 "../crypto/evp/ctrl_params_translate.c"
                                                              ,
      "mgf1-digest", 4, fix_md },
    { SET, 912, 0, ((1<<1) | (1<<2)),
      (0x1000 + 2), "rsa_pss_keygen_saltlen", 
# 2341 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                              ((void *)0)
# 2341 "../crypto/evp/ctrl_params_translate.c"
                                                                  ,
      "saltlen", 1, 
# 2342 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2342 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { SET, 6, 912, (1<<2),
      (0x1000 + 3), "rsa_keygen_bits", 
# 2344 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0)
# 2344 "../crypto/evp/ctrl_params_translate.c"
                                                           ,
      "bits", 2, 
# 2345 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                            ((void *)0) 
# 2345 "../crypto/evp/ctrl_params_translate.c"
                                                                 },
    { SET, 6, 912, (1<<2),
      (0x1000 + 4), "rsa_keygen_pubexp", 
# 2347 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0)
# 2347 "../crypto/evp/ctrl_params_translate.c"
                                                               ,
      "e", 2, 
# 2348 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                         ((void *)0) 
# 2348 "../crypto/evp/ctrl_params_translate.c"
                                                              },
    { SET, 6, 912, (1<<2),
      (0x1000 + 13), "rsa_keygen_primes", 
# 2350 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0)
# 2350 "../crypto/evp/ctrl_params_translate.c"
                                                               ,
      "primes", 2, 
# 2351 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                              ((void *)0) 
# 2351 "../crypto/evp/ctrl_params_translate.c"
                                                                   },
    ...
    { SET, -1, -1, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      14, "digestsize", 
# 2358 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                  ((void *)0)
# 2358 "../crypto/evp/ctrl_params_translate.c"
                                                      ,
      "size", 2, 
# 2359 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0) 
# 2359 "../crypto/evp/ctrl_params_translate.c"
                                                            },
    ...
    { SET, -1, -1, (1<<11),
      (0x1000), "md", 
# 2366 "../crypto/evp/ctrl_params_translate.c" 3 4
                                 ((void *)0)
# 2366 "../crypto/evp/ctrl_params_translate.c"
                                     ,
      "digest", 4, fix_md },
    { SET, -1, -1, (1<<11),
      (0x1000 + 1), "secret", "hexsecret",
      "secret", 5, 
# 2370 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                     ((void *)0) 
# 2370 "../crypto/evp/ctrl_params_translate.c"
                                                          },
    { SET, -1, -1, (1<<11),
      (0x1000 + 2), "seed", "hexseed",
      "seed", 5, 
# 2373 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                   ((void *)0) 
# 2373 "../crypto/evp/ctrl_params_translate.c"
                                                        },
    ...
    { SET, -1, -1, (1<<11),
      (0x1000 + 3), "md", 
# 2380 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2380 "../crypto/evp/ctrl_params_translate.c"
                                      ,
      "digest", 4, fix_md },
    { SET, -1, -1, (1<<11),
      (0x1000 + 4), "salt", "hexsalt",
      "salt", 5, 
# 2384 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                   ((void *)0) 
# 2384 "../crypto/evp/ctrl_params_translate.c"
                                                        },
    { SET, -1, -1, (1<<11),
      (0x1000 + 5), "key", "hexkey",
      "key", 5, 
# 2387 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                  ((void *)0) 
# 2387 "../crypto/evp/ctrl_params_translate.c"
                                                       },
    { SET, -1, -1, (1<<11),
      (0x1000 + 6), "info", "hexinfo",
      "info", 5, 
# 2390 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                   ((void *)0) 
# 2390 "../crypto/evp/ctrl_params_translate.c"
                                                        },
    { SET, -1, -1, (1<<11),
      (0x1000 + 7), "mode", 
# 2392 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2392 "../crypto/evp/ctrl_params_translate.c"
                                          ,
      "mode", 1, fix_hkdf_mode },
    ...
    { SET, -1, -1, (1<<11),
      (0x1000 + 8), "pass", "hexpass",
      "pass", 5, 
# 2401 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                       ((void *)0) 
# 2401 "../crypto/evp/ctrl_params_translate.c"
                                                            },
    { SET, -1, -1, (1<<11),
      (0x1000 + 9), "salt", "hexsalt",
      "salt", 5, 
# 2404 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                   ((void *)0) 
# 2404 "../crypto/evp/ctrl_params_translate.c"
                                                        },
    { SET, -1, -1, (1<<11),
      (0x1000 + 10), "N", 
# 2406 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2406 "../crypto/evp/ctrl_params_translate.c"
                                      ,
      "n", 2, 
# 2407 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2407 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { SET, -1, -1, (1<<11),
      (0x1000 + 11), "r", 
# 2409 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2409 "../crypto/evp/ctrl_params_translate.c"
                                      ,
      "r", 2, 
# 2410 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2410 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { SET, -1, -1, (1<<11),
      (0x1000 + 12), "p", 
# 2412 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2412 "../crypto/evp/ctrl_params_translate.c"
                                      ,
      "p", 2, 
# 2413 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                           ((void *)0) 
# 2413 "../crypto/evp/ctrl_params_translate.c"
                                                                },
    { SET, -1, -1, (1<<11),
      (0x1000 + 13), "maxmem_bytes", 
# 2415 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                        ((void *)0)
# 2415 "../crypto/evp/ctrl_params_translate.c"
                                                            ,
      "maxmem_bytes", 2, 
# 2416 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                ((void *)0) 
# 2416 "../crypto/evp/ctrl_params_translate.c"
                                                                     },

    { SET, -1, -1, (1<<2) | ((1<<9) | (1<<10)),
      12, 
# 2419 "../crypto/evp/ctrl_params_translate.c" 3 4
                           ((void *)0)
# 2419 "../crypto/evp/ctrl_params_translate.c"
                               , 
# 2419 "../crypto/evp/ctrl_params_translate.c" 3 4
                                 ((void *)0)
# 2419 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, -1, -1, (1<<2),
      6, "key", "hexkey",
      "priv", 5, 
# 2423 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                        ((void *)0) 
# 2423 "../crypto/evp/ctrl_params_translate.c"
                                                             },

    { SET, -1, -1, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      1, 
# 2426 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 2426 "../crypto/evp/ctrl_params_translate.c"
                           , 
# 2426 "../crypto/evp/ctrl_params_translate.c" 3 4
                             ((void *)0)
# 2426 "../crypto/evp/ctrl_params_translate.c"
                                 ,
      "digest", 4, fix_md },
    { GET, -1, -1, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
      13, 
# 2429 "../crypto/evp/ctrl_params_translate.c" 3 4
                           ((void *)0)
# 2429 "../crypto/evp/ctrl_params_translate.c"
                               , 
# 2429 "../crypto/evp/ctrl_params_translate.c" 3 4
                                 ((void *)0)
# 2429 "../crypto/evp/ctrl_params_translate.c"
    ...
    { SET, 1034, 1034, (1<<2), -1, 
# 2436 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                    ((void *)0)
# 2436 "../crypto/evp/ctrl_params_translate.c"
                                                                        , 
# 2436 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                          ((void *)0)
# 2436 "../crypto/evp/ctrl_params_translate.c"
                                                                              ,
      "group", 4, fix_group_ecx },
    { SET, 1034, 1034, (1<<1), -1, 
# 2438 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                      ((void *)0)
# 2438 "../crypto/evp/ctrl_params_translate.c"
                                                                          , 
# 2438 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                            ((void *)0)
# 2438 "../crypto/evp/ctrl_params_translate.c"
      ...
      "group", 4, fix_group_ecx },
    { SET, 1035, 1035, (1<<2), -1, 
# 2440 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                ((void *)0)
# 2440 "../crypto/evp/ctrl_params_translate.c"
                                                                    , 
# 2440 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                      ((void *)0)
# 2440 "../crypto/evp/ctrl_params_translate.c"
      ...
      "group", 4, fix_group_ecx },
    { SET, 1035, 1035, (1<<1), -1, 
# 2442 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                  ((void *)0)
# 2442 "../crypto/evp/ctrl_params_translate.c"
                                                                      , 
# 2442 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                                        ((void *)0)
# 2442 "../crypto/evp/ctrl_params_translate.c"
...
# 2455 "../crypto/evp/ctrl_params_translate.c"
    { GET, -1, -1, -1, 0, 
# 2455 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2455 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2455 "../crypto/evp/ctrl_params_translate.c" 3 4
...
# 2455 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2458 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2458 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2458 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2458 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2461 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2461 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2461 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2461 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2465 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2465 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2465 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2465 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2468 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2468 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2468 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2468 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2473 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2473 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2473 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2473 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2476 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2476 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2476 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2476 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2479 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2479 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2479 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2479 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2484 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2484 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2484 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2484 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_n },
    { GET, -1, -1, -1, 0, 
# 2487 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2487 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2487 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2487 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e },
    { GET, -1, -1, -1, 0, 
# 2490 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2490 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2490 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2490 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_d },
    { GET, -1, -1, -1, 0, 
# 2493 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2493 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2493 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2493 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f1 },
    { GET, -1, -1, -1, 0, 
# 2496 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2496 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2496 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2496 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f2 },
    { GET, -1, -1, -1, 0, 
# 2499 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2499 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2499 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2499 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f3 },
    { GET, -1, -1, -1, 0, 
# 2502 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2502 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2502 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2502 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f4 },
    { GET, -1, -1, -1, 0, 
# 2505 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2505 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2505 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2505 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f5 },
    { GET, -1, -1, -1, 0, 
# 2508 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2508 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2508 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2508 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f6 },
    { GET, -1, -1, -1, 0, 
# 2511 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2511 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2511 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2511 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f7 },
    { GET, -1, -1, -1, 0, 
# 2514 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2514 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2514 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2514 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f8 },
    { GET, -1, -1, -1, 0, 
# 2517 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2517 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2517 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2517 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f9 },
    { GET, -1, -1, -1, 0, 
# 2520 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2520 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2520 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2520 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_f10 },
    { GET, -1, -1, -1, 0, 
# 2523 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2523 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2523 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2523 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e1 },
    { GET, -1, -1, -1, 0, 
# 2526 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2526 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2526 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2526 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e2 },
    { GET, -1, -1, -1, 0, 
# 2529 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2529 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2529 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2529 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e3 },
    { GET, -1, -1, -1, 0, 
# 2532 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2532 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2532 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2532 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e4 },
    { GET, -1, -1, -1, 0, 
# 2535 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2535 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2535 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2535 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e5 },
    { GET, -1, -1, -1, 0, 
# 2538 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2538 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2538 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2538 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e6 },
    { GET, -1, -1, -1, 0, 
# 2541 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2541 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2541 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2541 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e7 },
    { GET, -1, -1, -1, 0, 
# 2544 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2544 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2544 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2544 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e8 },
    { GET, -1, -1, -1, 0, 
# 2547 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2547 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2547 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2547 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e9 },
    { GET, -1, -1, -1, 0, 
# 2550 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2550 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2550 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2550 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_e10 },
    { GET, -1, -1, -1, 0, 
# 2553 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2553 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2553 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2553 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c1 },
    { GET, -1, -1, -1, 0, 
# 2556 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2556 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2556 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2556 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c2 },
    { GET, -1, -1, -1, 0, 
# 2559 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2559 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2559 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2559 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c3 },
    { GET, -1, -1, -1, 0, 
# 2562 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2562 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2562 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2562 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c4 },
    { GET, -1, -1, -1, 0, 
# 2565 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2565 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2565 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2565 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c5 },
    { GET, -1, -1, -1, 0, 
# 2568 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2568 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2568 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2568 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c6 },
    { GET, -1, -1, -1, 0, 
# 2571 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2571 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2571 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2571 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c7 },
    { GET, -1, -1, -1, 0, 
# 2574 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2574 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2574 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2574 "../crypto/evp/ctrl_params_translate.c"
      ...
      get_rsa_payload_c8 },
    { GET, -1, -1, -1, 0, 
# 2577 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2577 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2577 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2577 "../crypto/evp/ctrl_params_translate.c"
    ...
    { GET, -1, -1, -1, 0, 
# 2582 "../crypto/evp/ctrl_params_translate.c" 3 4
                         ((void *)0)
# 2582 "../crypto/evp/ctrl_params_translate.c"
                             , 
# 2582 "../crypto/evp/ctrl_params_translate.c" 3 4
                               ((void *)0)
# 2582 "../crypto/evp/ctrl_params_translate.c"
                                   ,
      "decoded-from-explicit", 1,
                   ...
                   size_t translations_num)
{
    ...
    for (i = 0; i < translations_num; i++) {
        ...
        if (!__builtin_expect(!!(((item->keytype1 == -1) == (item->keytype2 == -1)) != 0), 1))
            continue;
        ...
        if (tmpl->ctrl_num != 0) {
            if (tmpl->ctrl_num != item->ctrl_num)
                continue;
        } else if (tmpl->ctrl_str != 
# 2630 "../crypto/evp/ctrl_params_translate.c" 3 4
                                    ((void *)0)
# 2630 "../crypto/evp/ctrl_params_translate.c"
                                        ) {
            const char *ctrl_str = 
# 2631 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2631 "../crypto/evp/ctrl_params_translate.c"
                                      ;
            const char *ctrl_hexstr = 
# 2632 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2632 "../crypto/evp/ctrl_params_translate.c"
                                         ;
            ...
            if (item->ctrl_str != 
# 2646 "../crypto/evp/ctrl_params_translate.c" 3 4
                                 ((void *)0)
                
# 2647 "../crypto/evp/ctrl_params_translate.c"
               && OPENSSL_strcasecmp(tmpl->ctrl_str, item->ctrl_str) == 0)
                ctrl_str = tmpl->ctrl_str;
            else if (item->ctrl_hexstr != 
# 2649 "../crypto/evp/ctrl_params_translate.c" 3 4
                                         ((void *)0)
                     
# 2650 "../crypto/evp/ctrl_params_translate.c"
        ...
        } else if (tmpl->param_key != 
# 2659 "../crypto/evp/ctrl_params_translate.c" 3 4
                                     ((void *)0)
# 2659 "../crypto/evp/ctrl_params_translate.c"
                                         ) {
# 2676 "../crypto/evp/ctrl_params_translate.c"
            if ((item->action_type != NONE
                 && tmpl->action_type != item->action_type)
                || (item->param_key != 
# 2678 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
                    
# 2679 "../crypto/evp/ctrl_params_translate.c"
                   && OPENSSL_strcasecmp(tmpl->param_key,
                                          item->param_key) != 0))
                continue;
        } else {
            return 
# 2683 "../crypto/evp/ctrl_params_translate.c" 3 4
                  ((void *)0)
# 2683 "../crypto/evp/ctrl_params_translate.c"
                      ;
        }
    ...
    return 
# 2689 "../crypto/evp/ctrl_params_translate.c" 3 4
          ((void *)0)
# 2689 "../crypto/evp/ctrl_params_translate.c"
              ;
}
...
lookup_evp_pkey_ctx_translation(struct translation_st *tmpl)
{
    return lookup_translation(tmpl, evp_pkey_ctx_translations,
                              (sizeof(evp_pkey_ctx_translations)/sizeof((evp_pkey_ctx_translations)[0])));
}
...
lookup_evp_pkey_translation(struct translation_st *tmpl)
{
    return lookup_translation(tmpl, evp_pkey_translations,
                              (sizeof(evp_pkey_translations)/sizeof((evp_pkey_translations)[0])));
}
                               ...
                               int cmd, int p1, void *p2)
{
    ...
    const struct translation_st *translation = 
# 2713 "../crypto/evp/ctrl_params_translate.c" 3 4
                                              ((void *)0)
# 2713 "../crypto/evp/ctrl_params_translate.c"
                                                  ;
    OSSL_PARAM params[2] = { { 
# 2714 "../crypto/evp/ctrl_params_translate.c" 3 4
                            ((void *)0)
# 2714 "../crypto/evp/ctrl_params_translate.c"
                            , 0, 
# 2714 "../crypto/evp/ctrl_params_translate.c" 3 4
                            ((void *)0)
# 2714 "../crypto/evp/ctrl_params_translate.c"
...
# 2714 "../crypto/evp/ctrl_params_translate.c"
    ...
    if (translation == 
# 2725 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 2725 "../crypto/evp/ctrl_params_translate.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/ctrl_params_translate.c",2726,__func__), ERR_set_error)((6),(147),
# 2726 "../crypto/evp/ctrl_params_translate.c" 3 4
       ((void *)0)
# 2726 "../crypto/evp/ctrl_params_translate.c"
       );
        return -2;
    }

    if (pctx->pmeth != 
# 2730 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
        
# 2731 "../crypto/evp/ctrl_params_translate.c"
       && pctx->pmeth->pkey_id != translation->keytype1
        && pctx->pmeth->pkey_id != translation->keytype2)
        return -1;

    if (translation->fixup_args != 
# 2735 "../crypto/evp/ctrl_params_translate.c" 3 4
                                  ((void *)0)
# 2735 "../crypto/evp/ctrl_params_translate.c"
                                      )
                                   ...
                                   const char *name, const char *value)
{
    ...
    struct translation_st tmpl = { 0, };
    const struct translation_st *translation = 
# 2781 "../crypto/evp/ctrl_params_translate.c" 3 4
                                              ((void *)0)
# 2781 "../crypto/evp/ctrl_params_translate.c"
                                                  ;
    OSSL_PARAM params[2] = { { 
# 2782 "../crypto/evp/ctrl_params_translate.c" 3 4
                            ((void *)0)
# 2782 "../crypto/evp/ctrl_params_translate.c"
                            , 0, 
# 2782 "../crypto/evp/ctrl_params_translate.c" 3 4
                            ((void *)0)
# 2782 "../crypto/evp/ctrl_params_translate.c"
...
# 2782 "../crypto/evp/ctrl_params_translate.c"
    ...
    if (translation != 
# 2795 "../crypto/evp/ctrl_params_translate.c" 3 4
                      ((void *)0)
# 2795 "../crypto/evp/ctrl_params_translate.c"
                          ) {
        if (translation->fixup_args != 
# 2796 "../crypto/evp/ctrl_params_translate.c" 3 4
                                      ((void *)0)
# 2796 "../crypto/evp/ctrl_params_translate.c"
                                          )
            fixup = translation->fixup_args;
        ctx.action_type = translation->action_type;
        ctx.ishex = (tmpl.ctrl_hexstr != 
# 2799 "../crypto/evp/ctrl_params_translate.c" 3 4
                                        ((void *)0)
# 2799 "../crypto/evp/ctrl_params_translate.c"
                                            );
    } else {
                                              ...
                                              OSSL_PARAM *params)
{
    ...
    for (; params != 
# 2845 "../crypto/evp/ctrl_params_translate.c" 3 4
                    ((void *)0) 
# 2845 "../crypto/evp/ctrl_params_translate.c"
                         && params->key != 
# 2845 "../crypto/evp/ctrl_params_translate.c" 3 4
                                           ((void *)0)
# 2845 "../crypto/evp/ctrl_params_translate.c"
        ...
        struct translation_st tmpl = { 0, };
        const struct translation_st *translation = 
# 2848 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                  ((void *)0)
# 2848 "../crypto/evp/ctrl_params_translate.c"
                                                      ;
        fixup_args_fn *fixup = default_fixup_args;
        int ret;
        ...
        if (translation != 
# 2858 "../crypto/evp/ctrl_params_translate.c" 3 4
                          ((void *)0)
# 2858 "../crypto/evp/ctrl_params_translate.c"
                              ) {
            if (translation->fixup_args != 
# 2859 "../crypto/evp/ctrl_params_translate.c" 3 4
                                          ((void *)0)
# 2859 "../crypto/evp/ctrl_params_translate.c"
                                              )
                fixup = translation->fixup_args;
...
# 2882 "../crypto/evp/ctrl_params_translate.c"
        if (ret >= 0) {
            ctx.p1 = ret;
...
{
    if (ctx->keymgmt != 
# 2898 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 2898 "../crypto/evp/ctrl_params_translate.c"
                           )
        return 0;
...
{
    if (ctx->keymgmt != 
# 2905 "../crypto/evp/ctrl_params_translate.c" 3 4
                       ((void *)0)
# 2905 "../crypto/evp/ctrl_params_translate.c"
                           )
        return 0;
                                          ...
                                          OSSL_PARAM *params)
{
    ...
    for (; params != 
# 2917 "../crypto/evp/ctrl_params_translate.c" 3 4
                    ((void *)0) 
# 2917 "../crypto/evp/ctrl_params_translate.c"
                         && params->key != 
# 2917 "../crypto/evp/ctrl_params_translate.c" 3 4
                                           ((void *)0)
# 2917 "../crypto/evp/ctrl_params_translate.c"
        ...
        struct translation_st tmpl = { 0, };
        const struct translation_st *translation = 
# 2920 "../crypto/evp/ctrl_params_translate.c" 3 4
                                                  ((void *)0)
# 2920 "../crypto/evp/ctrl_params_translate.c"
                                                      ;
        fixup_args_fn *fixup = default_fixup_args;
        ...
        if (translation != 
# 2927 "../crypto/evp/ctrl_params_translate.c" 3 4
                          ((void *)0)
# 2927 "../crypto/evp/ctrl_params_translate.c"
                              ) {
            if (translation->fixup_args != 
# 2928 "../crypto/evp/ctrl_params_translate.c" 3 4
                                          ((void *)0)
# 2928 "../crypto/evp/ctrl_params_translate.c"
                                              )
                fixup = translation->fixup_args;
            ctx.action_type = translation->action_type;
        }
        ...
        if (!__builtin_expect(!!((translation != 
# 2940 "../crypto/evp/ctrl_params_translate.c" 3 4
            ((void *)0)
# 2940 "../crypto/evp/ctrl_params_translate.c"
            ) != 0), 1)
            || !__builtin_expect(!!((translation->action_type == GET) != 0), 1)
            || !__builtin_expect(!!((translation->fixup_args != 
# 2942 "../crypto/evp/ctrl_params_translate.c" 3 4
               ((void *)0)
# 2942 "../crypto/evp/ctrl_params_translate.c"
               ) != 0), 1)) {
            return -2;
        }
