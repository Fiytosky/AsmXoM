# 0 "../crypto/evp/legacy_ripemd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_ripemd.c"
# 14 "../crypto/evp/legacy_ripemd.c"
...
# 15 "../crypto/evp/legacy_ripemd.c" 2
...
# 17 "../crypto/evp/legacy_ripemd.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../crypto/evp/legacy_ripemd.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 19 "../crypto/evp/legacy_ripemd.c" 2

static int ripe_init(EVP_MD_CTX *ctx) { return RIPEMD160_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int ripe_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return RIPEMD160_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int ripe_final(EVP_MD_CTX *ctx, unsigned char *md) { return RIPEMD160_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
...
static const EVP_MD ripemd160_md = {
    ...
    0,
    1,
    ripe_init, ripe_update, ripe_final, 
# 28 "../crypto/evp/legacy_ripemd.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_ripemd.c"
   , 
# 28 "../crypto/evp/legacy_ripemd.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_ripemd.c"
