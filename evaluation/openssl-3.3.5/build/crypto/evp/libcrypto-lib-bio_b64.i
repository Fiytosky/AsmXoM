# 0 "../crypto/evp/bio_b64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/bio_b64.c"
# 10 "../crypto/evp/bio_b64.c"
...
typedef struct b64_struct {
    ...
    unsigned char buf[((((1024)+2)/3*4)+((1024)/48+1)*2+80) + 10];
...
# 54 "../crypto/evp/bio_b64.c" 3 4
   ((void *)0)
# 54 "../crypto/evp/bio_b64.c"
       ,
    b64_ctrl,
    b64_new,
    b64_free,
...
static int b64_new(BIO *bi)
{
    ...
    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/evp/bio_b64.c", 70)) == 
# 70 "../crypto/evp/bio_b64.c" 3 4
                                               ((void *)0)
# 70 "../crypto/evp/bio_b64.c"
                                                   )
        return 0;
    ...
    if (ctx->base64 == 
# 76 "../crypto/evp/bio_b64.c" 3 4
                      ((void *)0)
# 76 "../crypto/evp/bio_b64.c"
                          ) {
        CRYPTO_free(ctx, "../crypto/evp/bio_b64.c", 77);
        return 0;
    }
...
static int b64_free(BIO *a)
{
    ...
    if (a == 
# 91 "../crypto/evp/bio_b64.c" 3 4
            ((void *)0)
# 91 "../crypto/evp/bio_b64.c"
                )
        return 0;

    ctx = BIO_get_data(a);
    if (ctx == 
# 95 "../crypto/evp/bio_b64.c" 3 4
              ((void *)0)
# 95 "../crypto/evp/bio_b64.c"
                  )
        return 0;

    EVP_ENCODE_CTX_free(ctx->base64);
    CRYPTO_free(ctx, "../crypto/evp/bio_b64.c", 99);
    BIO_set_data(a, 
# 100 "../crypto/evp/bio_b64.c" 3 4
                   ((void *)0)
# 100 "../crypto/evp/bio_b64.c"
                       );
    BIO_set_init(a, 0);
...
static int b64_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 113 "../crypto/evp/bio_b64.c" 3 4
              ((void *)0)
# 113 "../crypto/evp/bio_b64.c"
                  )
        return 0;
    ...
    next = BIO_next(b);
    if (ctx == 
# 118 "../crypto/evp/bio_b64.c" 3 4
              ((void *)0) 
# 118 "../crypto/evp/bio_b64.c"
                   || next == 
# 118 "../crypto/evp/bio_b64.c" 3 4
                              ((void *)0)
# 118 "../crypto/evp/bio_b64.c"
    ...
    if (ctx->buf_len > 0) {
        (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 133), 1));
        i = ctx->buf_len - ctx->buf_off;
        if (i > outl)
            i = outl;
        (void)((ctx->buf_off + i < (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_off + i < (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 137), 1));
    ...
    while (outl > 0) {
        ...
        if (ctx->start && (BIO_test_flags(b, ~(0x0)) & 0x100) != 0) {
            ctx->tmp_len = 0;
        } else if (ctx->start) {
            q = p = ctx->tmp;
            num = 0;
        ...
        if ((BIO_test_flags(b, ~(0x0)) & 0x100) != 0) {
            int z, jj;
...
static int b64_write(BIO *b, const char *in, int inl)
{
    ...
    next = BIO_next(b);
    if (ctx == 
# 327 "../crypto/evp/bio_b64.c" 3 4
              ((void *)0) 
# 327 "../crypto/evp/bio_b64.c"
                   || next == 
# 327 "../crypto/evp/bio_b64.c" 3 4
                              ((void *)0)
# 327 "../crypto/evp/bio_b64.c"
    ...
    (void)((ctx->buf_off < (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_off < (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 340), 1));
    (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 341), 1));
    (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 342), 1));
    ...
    while (n > 0) {
        ...
        (void)((i <= n) ? 0 : (OPENSSL_die("assertion failed: " "i <= n", "../crypto/evp/bio_b64.c", 350), 1));
        ctx->buf_off += i;
        (void)((ctx->buf_off <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_off <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 352), 1));
        (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 353), 1));
        n -= i;
    }
    ...
    if (in == 
# 360 "../crypto/evp/bio_b64.c" 3 4
             ((void *)0) 
# 360 "../crypto/evp/bio_b64.c"
                  || inl <= 0)
        return 0;
    ...
    while (inl > 0) {
        ...
        if ((BIO_test_flags(b, ~(0x0)) & 0x100) != 0) {
            if (ctx->tmp_len > 0) {
                (void)((ctx->tmp_len <= 3) ? 0 : (OPENSSL_die("assertion failed: " "ctx->tmp_len <= 3", "../crypto/evp/bio_b64.c", 368), 1));
                n = 3 - ctx->tmp_len;
                ...
                (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 382), 1));
                (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 383), 1));
                ...
                (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 399), 1));
                (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 400), 1));
                ret += n;
            }
        } else {
            if (!EVP_EncodeUpdate(ctx->base64, ctx->buf, &ctx->buf_len,
                                  (unsigned char *)in, n))
                return ret == 0 ? -1 : ret;
            (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 407), 1));
            (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 408), 1));
            ret += n;
        }
        inl -= n;
        in += n;
        ...
        while (n > 0) {
            ...
            (void)((i <= n) ? 0 : (OPENSSL_die("assertion failed: " "i <= n", "../crypto/evp/bio_b64.c", 422), 1));
            n -= i;
            ctx->buf_off += i;
            (void)((ctx->buf_off <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_off <= (int)sizeof(ctx->buf)", "../crypto/evp/bio_b64.c", 425), 1));
            (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 426), 1));
        }
        ctx->buf_len = 0;
        ctx->buf_off = 0;
    }
...
static long b64_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    next = BIO_next(b);
    if (ctx == 
# 443 "../crypto/evp/bio_b64.c" 3 4
              ((void *)0) 
# 443 "../crypto/evp/bio_b64.c"
                   || next == 
# 443 "../crypto/evp/bio_b64.c" 3 4
                              ((void *)0)
# 443 "../crypto/evp/bio_b64.c"
    ...
    case 2:
        ...
        break;
    case 13:
        (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 460), 1));
        ...
        break;
    case 10:
        (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OPENSSL_die("assertion failed: " "ctx->buf_len >= ctx->buf_off", "../crypto/evp/bio_b64.c", 469), 1));
        ret = ctx->buf_len - ctx->buf_off;
        if (ret <= 0)
            ret = BIO_ctrl(next, cmd, num, ptr);
        break;
 ...
 again:
        while (ctx->buf_len != ctx->buf_off) {
            i = b64_write(b, 
# 478 "../crypto/evp/bio_b64.c" 3 4
                            ((void *)0)
# 478 "../crypto/evp/bio_b64.c"
                                , 0);
            if (i < 0)
                return i;
        }
...
static long b64_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    ...
    if (next == 
# 524 "../crypto/evp/bio_b64.c" 3 4
               ((void *)0)
# 524 "../crypto/evp/bio_b64.c"
                   )
        return 0;
