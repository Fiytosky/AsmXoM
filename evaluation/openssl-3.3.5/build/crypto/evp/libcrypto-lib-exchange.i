# 0 "../crypto/evp/exchange.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/exchange.c"
# 10 "../crypto/evp/exchange.c"
...
# 20 "../crypto/evp/exchange.c" 2

static EVP_KEYEXCH *evp_keyexch_new(OSSL_PROVIDER *prov)
{
    EVP_KEYEXCH *exchange = CRYPTO_zalloc(sizeof(EVP_KEYEXCH), "../crypto/evp/exchange.c", 23);

    if (exchange == 
# 25 "../crypto/evp/exchange.c" 3 4
                   ((void *)0)
# 25 "../crypto/evp/exchange.c"
                       )
        return 
# 26 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 26 "../crypto/evp/exchange.c"
                  ;

    if (!CRYPTO_NEW_REF(&exchange->refcnt, 1)) {
        CRYPTO_free(exchange, "../crypto/evp/exchange.c", 29);
        return 
# 30 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 30 "../crypto/evp/exchange.c"
                  ;
    }
    exchange->prov = prov;
                                        ...
                                        OSSL_PROVIDER *prov)
{
    ...
    EVP_KEYEXCH *exchange = 
# 43 "../crypto/evp/exchange.c" 3 4
                           ((void *)0)
# 43 "../crypto/evp/exchange.c"
                               ;
    int fncnt = 0, sparamfncnt = 0, gparamfncnt = 0;

    if ((exchange = evp_keyexch_new(prov)) == 
# 46 "../crypto/evp/exchange.c" 3 4
                                             ((void *)0)
# 46 "../crypto/evp/exchange.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",47,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 47 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 47 "../crypto/evp/exchange.c"
       );
        goto err;
    }
...
# 52 "../crypto/evp/exchange.c" 3 4
                                                                          ((void *)0)
# 52 "../crypto/evp/exchange.c"
                                                                              )
        goto err;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (exchange->newctx != 
# 59 "../crypto/evp/exchange.c" 3 4
                                   ((void *)0)
# 59 "../crypto/evp/exchange.c"
                                       )
                break;
        ...
        case 2:
            if (exchange->init != 
# 65 "../crypto/evp/exchange.c" 3 4
                                 ((void *)0)
# 65 "../crypto/evp/exchange.c"
                                     )
                break;
            ...
            break;
        case 4:
            if (exchange->set_peer != 
# 71 "../crypto/evp/exchange.c" 3 4
                                     ((void *)0)
# 71 "../crypto/evp/exchange.c"
                                         )
                break;
        ...
        case 3:
            if (exchange->derive != 
# 76 "../crypto/evp/exchange.c" 3 4
                                   ((void *)0)
# 76 "../crypto/evp/exchange.c"
                                       )
                break;
        ...
        case 5:
            if (exchange->freectx != 
# 82 "../crypto/evp/exchange.c" 3 4
                                    ((void *)0)
# 82 "../crypto/evp/exchange.c"
                                        )
                break;
        ...
        case 6:
            if (exchange->dupctx != 
# 88 "../crypto/evp/exchange.c" 3 4
                                   ((void *)0)
# 88 "../crypto/evp/exchange.c"
                                       )
                break;
            exchange->dupctx = OSSL_FUNC_keyexch_dupctx(fns);
            break;
        case 9:
            if (exchange->get_ctx_params != 
# 93 "../crypto/evp/exchange.c" 3 4
                                           ((void *)0)
# 93 "../crypto/evp/exchange.c"
                                               )
                break;
            ...
            break;
        case 10:
            if (exchange->gettable_ctx_params != 
# 99 "../crypto/evp/exchange.c" 3 4
                                                ((void *)0)
# 99 "../crypto/evp/exchange.c"
                                                    )
                break;
            ...
            break;
        case 7:
            if (exchange->set_ctx_params != 
# 106 "../crypto/evp/exchange.c" 3 4
                                           ((void *)0)
# 106 "../crypto/evp/exchange.c"
                                               )
                break;
            ...
            break;
        case 8:
            if (exchange->settable_ctx_params != 
# 112 "../crypto/evp/exchange.c" 3 4
                                                ((void *)0)
# 112 "../crypto/evp/exchange.c"
                                                    )
                break;
...
# 131 "../crypto/evp/exchange.c"
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",131,__func__), ERR_set_error)((6),(193),
# 131 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 131 "../crypto/evp/exchange.c"
       );
        goto err;
 ...
 err:
    ...
    return 
# 139 "../crypto/evp/exchange.c" 3 4
          ((void *)0)
# 139 "../crypto/evp/exchange.c"
              ;
}
...
void EVP_KEYEXCH_free(EVP_KEYEXCH *exchange)
{
    ...
    if (exchange == 
# 146 "../crypto/evp/exchange.c" 3 4
                   ((void *)0)
# 146 "../crypto/evp/exchange.c"
                       )
        return;
    CRYPTO_DOWN_REF(&exchange->refcnt, &i);
    if (i > 0)
        return;
    CRYPTO_free(exchange->type_name, "../crypto/evp/exchange.c", 151);
    ossl_provider_free(exchange->prov);
    CRYPTO_FREE_REF(&exchange->refcnt);
    CRYPTO_free(exchange, "../crypto/evp/exchange.c", 154);
}
...
EVP_KEYEXCH *EVP_KEYEXCH_fetch(OSSL_LIB_CTX *ctx, const char *algorithm,
                               const char *properties)
{
    return evp_generic_fetch(ctx, 11, algorithm, properties,
...
EVP_KEYEXCH *evp_keyexch_fetch_from_prov(OSSL_PROVIDER *prov,
                                         ...
                                         const char *properties)
{
    return evp_generic_fetch_from_prov(prov, 11,
...
int EVP_PKEY_derive_init(EVP_PKEY_CTX *ctx)
{
    return EVP_PKEY_derive_init_ex(ctx, 
# 192 "../crypto/evp/exchange.c" 3 4
                                       ((void *)0)
# 192 "../crypto/evp/exchange.c"
                                           );
}
...
int EVP_PKEY_derive_init_ex(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    int ret;
    void *provkey = 
# 198 "../crypto/evp/exchange.c" 3 4
                   ((void *)0)
# 198 "../crypto/evp/exchange.c"
                       ;
    EVP_KEYEXCH *exchange = 
# 199 "../crypto/evp/exchange.c" 3 4
                           ((void *)0)
# 199 "../crypto/evp/exchange.c"
                               ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 200 "../crypto/evp/exchange.c" 3 4
                              ((void *)0)
# 200 "../crypto/evp/exchange.c"
                                  ;
    const OSSL_PROVIDER *tmp_prov = 
# 201 "../crypto/evp/exchange.c" 3 4
                                   ((void *)0)
# 201 "../crypto/evp/exchange.c"
                                       ;
    const char *supported_exch = 
# 202 "../crypto/evp/exchange.c" 3 4
                                ((void *)0)
# 202 "../crypto/evp/exchange.c"
    ...
    if (ctx == 
# 205 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 205 "../crypto/evp/exchange.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",206,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 206 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 206 "../crypto/evp/exchange.c"
       );
        return -2;
    }
    ...
    if (((ctx)->keymgmt == 
# 215 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 215 "../crypto/evp/exchange.c"
       ))
        goto legacy;
    ...
    if (ctx->pkey == 
# 222 "../crypto/evp/exchange.c" 3 4
                    ((void *)0)
# 222 "../crypto/evp/exchange.c"
                        ) {
        EVP_PKEY *pkey = EVP_PKEY_new();

        if (pkey == 
# 225 "../crypto/evp/exchange.c" 3 4
                   ((void *)0)
            
# 226 "../crypto/evp/exchange.c"
           || !EVP_PKEY_set_type_by_keymgmt(pkey, ctx->keymgmt)
            || (pkey->keydata = evp_keymgmt_newdata(ctx->keymgmt)) == 
# 227 "../crypto/evp/exchange.c" 3 4
                                                                     ((void *)0)
# 227 "../crypto/evp/exchange.c"
                                                                         ) {
            ERR_clear_last_mark();
            EVP_PKEY_free(pkey);
            (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",230,__func__), ERR_set_error)((6),(134),
# 230 "../crypto/evp/exchange.c" 3 4
           ((void *)0)
# 230 "../crypto/evp/exchange.c"
           );
            goto err;
        }
        ctx->pkey = pkey;
...
# 239 "../crypto/evp/exchange.c" 3 4
        ((void *)0) 
# 239 "../crypto/evp/exchange.c"
        || ctx->pkey->keymgmt == ctx->keymgmt) != 0), 1)
                                                           ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",242,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 242 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 242 "../crypto/evp/exchange.c"
       );
        goto err;
    }
    supported_exch = evp_keymgmt_util_query_operation_name(ctx->keymgmt,
                                                           11);
    if (supported_exch == 
# 247 "../crypto/evp/exchange.c" 3 4
                         ((void *)0)
# 247 "../crypto/evp/exchange.c"
                             ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",249,__func__), ERR_set_error)((6),(134),
# 249 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 249 "../crypto/evp/exchange.c"
       );
        goto err;
    }
# 271 "../crypto/evp/exchange.c"
    for (iter = 1, provkey = 
# 271 "../crypto/evp/exchange.c" 3 4
                            ((void *)0)
# 271 "../crypto/evp/exchange.c"
                                ; iter < 3 && provkey == 
# 271 "../crypto/evp/exchange.c" 3 4
...
# 272 "../crypto/evp/exchange.c" 3 4
                                         ((void *)0)
# 272 "../crypto/evp/exchange.c"
                                             ;
        ...
        case 1:
            ...
            if (exchange != 
# 286 "../crypto/evp/exchange.c" 3 4
                           ((void *)0)
# 286 "../crypto/evp/exchange.c"
                               )
        ...
        case 2:
            ...
            if (exchange == 
# 294 "../crypto/evp/exchange.c" 3 4
                           ((void *)0)
# 294 "../crypto/evp/exchange.c"
                               )
                goto legacy;
            break;
        }
        if (exchange == 
# 298 "../crypto/evp/exchange.c" 3 4
                       ((void *)0)
# 298 "../crypto/evp/exchange.c"
                           )
            continue;
# 310 "../crypto/evp/exchange.c"
        tmp_keymgmt_tofree = tmp_keymgmt =
            evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)tmp_prov,
                                        EVP_KEYMGMT_get0_name(ctx->keymgmt),
                                        ctx->propquery);
        if (tmp_keymgmt != 
# 314 "../crypto/evp/exchange.c" 3 4
                          ((void *)0)
# 314 "../crypto/evp/exchange.c"
                              )
            provkey = evp_pkey_export_to_provider(ctx->pkey, ctx->libctx,
                                                  &tmp_keymgmt, ctx->propquery);
        if (tmp_keymgmt == 
# 317 "../crypto/evp/exchange.c" 3 4
                          ((void *)0)
# 317 "../crypto/evp/exchange.c"
                              )
            EVP_KEYMGMT_free(tmp_keymgmt_tofree);
    }

    if (provkey == 
# 321 "../crypto/evp/exchange.c" 3 4
                  ((void *)0)
# 321 "../crypto/evp/exchange.c"
                      ) {
        EVP_KEYEXCH_free(exchange);
        goto legacy;
    }
...
# 336 "../crypto/evp/exchange.c" 3 4
                             ((void *)0)
# 336 "../crypto/evp/exchange.c"
                                 ) {

        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",338,__func__), ERR_set_error)((6),(134),
# 338 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 338 "../crypto/evp/exchange.c"
       );
        goto err;
    }
 ...
 legacy:
    ...
    if (ctx->pmeth == 
# 361 "../crypto/evp/exchange.c" 3 4
                     ((void *)0) 
# 361 "../crypto/evp/exchange.c"
                          || ctx->pmeth->derive == 
# 361 "../crypto/evp/exchange.c" 3 4
                                                   ((void *)0)
# 361 "../crypto/evp/exchange.c"
                                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",362,__func__), ERR_set_error)((6),(150),
# 362 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 362 "../crypto/evp/exchange.c"
       );
        return -2;
    }

    if (ctx->pmeth->derive_init == 
# 366 "../crypto/evp/exchange.c" 3 4
                                  ((void *)0)
# 366 "../crypto/evp/exchange.c"
                                      )
        return 1;
                                ...
                                int validate_peer)
{
    int ret = 0, check;
    void *provkey = 
# 380 "../crypto/evp/exchange.c" 3 4
                   ((void *)0)
# 380 "../crypto/evp/exchange.c"
                       ;
    EVP_PKEY_CTX *check_ctx = 
# 381 "../crypto/evp/exchange.c" 3 4
                             ((void *)0)
# 381 "../crypto/evp/exchange.c"
                                 ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 382 "../crypto/evp/exchange.c" 3 4
                              ((void *)0)
# 382 "../crypto/evp/exchange.c"
                                  , *tmp_keymgmt_tofree = 
# 382 "../crypto/evp/exchange.c" 3 4
                                                          ((void *)0)
# 382 "../crypto/evp/exchange.c"
    ...
    if (ctx == 
# 384 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 384 "../crypto/evp/exchange.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",385,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 385 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 385 "../crypto/evp/exchange.c"
       );
        return -1;
    }

    if (!((ctx)->operation == (1<<11)) || ctx->op.kex.algctx == 
# 389 "../crypto/evp/exchange.c" 3 4
                                                                ((void *)0)
# 389 "../crypto/evp/exchange.c"
                                                                    )
        goto legacy;

    if (ctx->op.kex.exchange->set_peer == 
# 392 "../crypto/evp/exchange.c" 3 4
                                         ((void *)0)
# 392 "../crypto/evp/exchange.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",393,__func__), ERR_set_error)((6),(150),
# 393 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 393 "../crypto/evp/exchange.c"
       );
        return -2;
    }
    ...
    if (validate_peer) {
        ...
        if (check_ctx == 
# 399 "../crypto/evp/exchange.c" 3 4
                        ((void *)0)
# 399 "../crypto/evp/exchange.c"
                            )
            return -1;
...
# 416 "../crypto/evp/exchange.c"
    tmp_keymgmt_tofree = tmp_keymgmt =
        evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)
                                    ...
                                    ctx->propquery);
    if (tmp_keymgmt != 
# 421 "../crypto/evp/exchange.c" 3 4
                      ((void *)0)
# 421 "../crypto/evp/exchange.c"
                          )
    ...
    if (provkey == 
# 432 "../crypto/evp/exchange.c" 3 4
                  ((void *)0)
# 432 "../crypto/evp/exchange.c"
                      )
        goto legacy;
 ...
 legacy:
    ...
    if (ctx->pmeth == 
# 446 "../crypto/evp/exchange.c" 3 4
                     ((void *)0)
        
# 447 "../crypto/evp/exchange.c"
       || !(ctx->pmeth->derive != 
# 447 "../crypto/evp/exchange.c" 3 4
                                  ((void *)0)
             
# 448 "../crypto/evp/exchange.c"
            || ctx->pmeth->encrypt != 
# 448 "../crypto/evp/exchange.c" 3 4
                                      ((void *)0)
             
# 449 "../crypto/evp/exchange.c"
            || ctx->pmeth->decrypt != 
# 449 "../crypto/evp/exchange.c" 3 4
                                      ((void *)0)
# 449 "../crypto/evp/exchange.c"
                                          )
        || ctx->pmeth->ctrl == 
# 450 "../crypto/evp/exchange.c" 3 4
                              ((void *)0)
# 450 "../crypto/evp/exchange.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",451,__func__), ERR_set_error)((6),(150),
# 451 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 451 "../crypto/evp/exchange.c"
       );
        return -2;
    }
    if (ctx->operation != (1<<11)
        && ctx->operation != (1<<9)
        && ctx->operation != (1<<10)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",457,__func__), ERR_set_error)((6),(151),
# 457 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 457 "../crypto/evp/exchange.c"
       );
        return -1;
    }
    ...
    if (ctx->pkey == 
# 469 "../crypto/evp/exchange.c" 3 4
                    ((void *)0)
# 469 "../crypto/evp/exchange.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",470,__func__), ERR_set_error)((6),(154),
# 470 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 470 "../crypto/evp/exchange.c"
       );
        return -1;
    }

    if (ctx->pkey->type != peer->type) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",475,__func__), ERR_set_error)((6),(101),
# 475 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 475 "../crypto/evp/exchange.c"
       );
        return -1;
    }
# 486 "../crypto/evp/exchange.c"
    if (!EVP_PKEY_missing_parameters(peer) &&
        !EVP_PKEY_parameters_eq(ctx->pkey, peer)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",488,__func__), ERR_set_error)((6),(153),
# 488 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 488 "../crypto/evp/exchange.c"
       );
        return -1;
    }
    ...
    if (ret <= 0) {
        ctx->peerkey = 
# 498 "../crypto/evp/exchange.c" 3 4
                      ((void *)0)
# 498 "../crypto/evp/exchange.c"
                          ;
        return ret;
    }
...
int EVP_PKEY_derive(EVP_PKEY_CTX *ctx, unsigned char *key, size_t *pkeylen)
{
    ...
    if (ctx == 
# 516 "../crypto/evp/exchange.c" 3 4
              ((void *)0) 
# 516 "../crypto/evp/exchange.c"
                   || pkeylen == 
# 516 "../crypto/evp/exchange.c" 3 4
                                 ((void *)0)
# 516 "../crypto/evp/exchange.c"
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",517,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 517 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 517 "../crypto/evp/exchange.c"
       );
        return -1;
    }

    if (!((ctx)->operation == (1<<11))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",522,__func__), ERR_set_error)((6),(151),
# 522 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 522 "../crypto/evp/exchange.c"
       );
        return -1;
    }

    if (ctx->op.kex.algctx == 
# 526 "../crypto/evp/exchange.c" 3 4
                             ((void *)0)
# 526 "../crypto/evp/exchange.c"
                                 )
        goto legacy;

    ret = ctx->op.kex.exchange->derive(ctx->op.kex.algctx, key, pkeylen,
                                       key != 
# 530 "../crypto/evp/exchange.c" 3 4
                                             ((void *)0) 
# 530 "../crypto/evp/exchange.c"
                                                  ? *pkeylen : 0);

    return ret;
 legacy:
    if (ctx->pmeth == 
# 534 "../crypto/evp/exchange.c" 3 4
                     ((void *)0) 
# 534 "../crypto/evp/exchange.c"
                          || ctx->pmeth->derive == 
# 534 "../crypto/evp/exchange.c" 3 4
                                                   ((void *)0)
# 534 "../crypto/evp/exchange.c"
                                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",535,__func__), ERR_set_error)((6),(150),
# 535 "../crypto/evp/exchange.c" 3 4
       ((void *)0)
# 535 "../crypto/evp/exchange.c"
       );
        return -2;
    }

    if (ctx->pmeth->flags & 2) { size_t pksize = (size_t)EVP_PKEY_get_size(ctx->pkey); if (pksize == 0) { (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",539,__func__), ERR_set_error)((6),(163),
# 539 "../crypto/evp/exchange.c" 3 4
   ((void *)0)
# 539 "../crypto/evp/exchange.c"
   ); return 0; } if (key == 
# 539 "../crypto/evp/exchange.c" 3 4
   ((void *)0)
# 539 "../crypto/evp/exchange.c"
   ) { *pkeylen = pksize; return 1; } if (*pkeylen < pksize) { (ERR_new(), ERR_set_debug("../crypto/evp/exchange.c",539,__func__), ERR_set_error)((6),(155),
# 539 "../crypto/evp/exchange.c" 3 4
   ((void *)0)
# 539 "../crypto/evp/exchange.c"
   ); return 0; } }
...
{
    return keyexch != 
# 560 "../crypto/evp/exchange.c" 3 4
                     ((void *)0)
           
# 561 "../crypto/evp/exchange.c"
          && evp_is_a(keyexch->prov, keyexch->name_id, 
# 561 "../crypto/evp/exchange.c" 3 4
                                                       ((void *)0)
# 561 "../crypto/evp/exchange.c"
                                                           , name);
}
...
{
    if (keyexch->prov != 
# 579 "../crypto/evp/exchange.c" 3 4
                        ((void *)0)
# 579 "../crypto/evp/exchange.c"
                            )
...
const OSSL_PARAM *EVP_KEYEXCH_gettable_ctx_params(const EVP_KEYEXCH *keyexch)
{
    ...
    if (keyexch == 
# 589 "../crypto/evp/exchange.c" 3 4
                  ((void *)0) 
# 589 "../crypto/evp/exchange.c"
                       || keyexch->gettable_ctx_params == 
# 589 "../crypto/evp/exchange.c" 3 4
                                                          ((void *)0)
# 589 "../crypto/evp/exchange.c"
                                                              )
        return 
# 590 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 590 "../crypto/evp/exchange.c"
                  ;

    provctx = ossl_provider_ctx(EVP_KEYEXCH_get0_provider(keyexch));
    return keyexch->gettable_ctx_params(
# 593 "../crypto/evp/exchange.c" 3 4
                                       ((void *)0)
# 593 "../crypto/evp/exchange.c"
                                           , provctx);
}
...
const OSSL_PARAM *EVP_KEYEXCH_settable_ctx_params(const EVP_KEYEXCH *keyexch)
{
    ...
    if (keyexch == 
# 600 "../crypto/evp/exchange.c" 3 4
                  ((void *)0) 
# 600 "../crypto/evp/exchange.c"
                       || keyexch->settable_ctx_params == 
# 600 "../crypto/evp/exchange.c" 3 4
                                                          ((void *)0)
# 600 "../crypto/evp/exchange.c"
                                                              )
        return 
# 601 "../crypto/evp/exchange.c" 3 4
              ((void *)0)
# 601 "../crypto/evp/exchange.c"
                  ;
    provctx = ossl_provider_ctx(EVP_KEYEXCH_get0_provider(keyexch));
    return keyexch->settable_ctx_params(
# 603 "../crypto/evp/exchange.c" 3 4
                                       ((void *)0)
# 603 "../crypto/evp/exchange.c"
                                           , provctx);
}
