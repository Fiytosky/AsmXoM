# 0 "../crypto/evp/m_sigver.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/m_sigver.c"
# 10 "../crypto/evp/m_sigver.c"
...
# 18 "../crypto/evp/m_sigver.c" 2



static int update(EVP_MD_CTX *ctx, const void *data, size_t datalen)
{
    (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",23,__func__), ERR_set_error)((6),(177),
# 23 "../crypto/evp/m_sigver.c" 3 4
   ((void *)0)
# 23 "../crypto/evp/m_sigver.c"
   );
    return 0;
}
...
{
    if (mdname != 
# 33 "../crypto/evp/m_sigver.c" 3 4
                 ((void *)0) 
# 33 "../crypto/evp/m_sigver.c"
                      && strcmp(mdname, "UNDEF") == 0)
        return 
# 34 "../crypto/evp/m_sigver.c" 3 4
              ((void *)0)
# 34 "../crypto/evp/m_sigver.c"
                  ;
...
static int do_sigver_init(EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
                          ...
                          const OSSL_PARAM params[])
{
    EVP_PKEY_CTX *locpctx = 
# 45 "../crypto/evp/m_sigver.c" 3 4
                           ((void *)0)
# 45 "../crypto/evp/m_sigver.c"
                               ;
    EVP_SIGNATURE *signature = 
# 46 "../crypto/evp/m_sigver.c" 3 4
                              ((void *)0)
# 46 "../crypto/evp/m_sigver.c"
                                  ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 47 "../crypto/evp/m_sigver.c" 3 4
                              ((void *)0)
# 47 "../crypto/evp/m_sigver.c"
                                  ;
    const OSSL_PROVIDER *tmp_prov = 
# 48 "../crypto/evp/m_sigver.c" 3 4
                                   ((void *)0)
# 48 "../crypto/evp/m_sigver.c"
                                       ;
    const char *supported_sig = 
# 49 "../crypto/evp/m_sigver.c" 3 4
                               ((void *)0)
# 49 "../crypto/evp/m_sigver.c"
                                   ;
    char locmdname[80] = "";
    void *provkey = 
# 51 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 51 "../crypto/evp/m_sigver.c"
                       ;
    ...
    if (ctx->pctx == 
# 57 "../crypto/evp/m_sigver.c" 3 4
                    ((void *)0)
# 57 "../crypto/evp/m_sigver.c"
                        ) {
        reinit = 0;
        if (e == 
# 59 "../crypto/evp/m_sigver.c" 3 4
                ((void *)0)
# 59 "../crypto/evp/m_sigver.c"
                    )
    ...
    if (ctx->pctx == 
# 64 "../crypto/evp/m_sigver.c" 3 4
                    ((void *)0)
# 64 "../crypto/evp/m_sigver.c"
                        )
        return 0;

    EVP_MD_CTX_clear_flags(ctx, 0x0800);

    locpctx = ctx->pctx;
    ERR_set_mark();

    if (((locpctx)->keymgmt == 
# 72 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 72 "../crypto/evp/m_sigver.c"
       ))
        goto legacy;
    ...
    if (reinit
        && (pkey != 
# 77 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
            
# 78 "../crypto/evp/m_sigver.c"
           || locpctx->operation != (ver ? (1<<8)
                                          : (1<<7))
            || (signature = locpctx->op.sig.signature) == 
# 80 "../crypto/evp/m_sigver.c" 3 4
                                                         ((void *)0)
            
# 81 "../crypto/evp/m_sigver.c"
           || locpctx->op.sig.algctx == 
# 81 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 81 "../crypto/evp/m_sigver.c"
                                            ))
        reinit = 0;
    ...
    if (props == 
# 84 "../crypto/evp/m_sigver.c" 3 4
                ((void *)0)
# 84 "../crypto/evp/m_sigver.c"
                    )
        props = locpctx->propquery;

    if (locpctx->pkey == 
# 87 "../crypto/evp/m_sigver.c" 3 4
                        ((void *)0)
# 87 "../crypto/evp/m_sigver.c"
                            ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",89,__func__), ERR_set_error)((6),(154),
# 89 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 89 "../crypto/evp/m_sigver.c"
       );
        goto err;
    }
    ...
    if (!reinit) {
        ...
        if (mdname == 
# 96 "../crypto/evp/m_sigver.c" 3 4
                     ((void *)0) 
# 96 "../crypto/evp/m_sigver.c"
                          && type == 
# 96 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
# 96 "../crypto/evp/m_sigver.c"
    ...
    if (!__builtin_expect(!!((locpctx->pkey->keymgmt == 
# 104 "../crypto/evp/m_sigver.c" 3 4
        ((void *)0) 
# 104 "../crypto/evp/m_sigver.c"
        || locpctx->pkey->keymgmt == locpctx->keymgmt) != 0), 1)
                                                                   ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",107,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 107 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 107 "../crypto/evp/m_sigver.c"
       );
        goto err;
    }
    supported_sig = evp_keymgmt_util_query_operation_name(locpctx->keymgmt,
                                                          12);
    if (supported_sig == 
# 112 "../crypto/evp/m_sigver.c" 3 4
                        ((void *)0)
# 112 "../crypto/evp/m_sigver.c"
                            ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",114,__func__), ERR_set_error)((6),(134),
# 114 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 114 "../crypto/evp/m_sigver.c"
       );
        goto err;
    }
# 135 "../crypto/evp/m_sigver.c"
    for (iter = 1, provkey = 
# 135 "../crypto/evp/m_sigver.c" 3 4
                            ((void *)0)
# 135 "../crypto/evp/m_sigver.c"
                                ; iter < 3 && provkey == 
# 135 "../crypto/evp/m_sigver.c" 3 4
...
# 136 "../crypto/evp/m_sigver.c" 3 4
                                         ((void *)0)
# 136 "../crypto/evp/m_sigver.c"
                                             ;
        ...
        case 1:
            signature = EVP_SIGNATURE_fetch(locpctx->libctx, supported_sig,
                                            locpctx->propquery);
            if (signature != 
# 150 "../crypto/evp/m_sigver.c" 3 4
                            ((void *)0)
# 150 "../crypto/evp/m_sigver.c"
                                )
        ...
        case 2:
            ...
            if (signature == 
# 158 "../crypto/evp/m_sigver.c" 3 4
                            ((void *)0)
# 158 "../crypto/evp/m_sigver.c"
                                )
                goto legacy;
            break;
        }
        if (signature == 
# 162 "../crypto/evp/m_sigver.c" 3 4
                        ((void *)0)
# 162 "../crypto/evp/m_sigver.c"
                            )
            continue;
# 175 "../crypto/evp/m_sigver.c"
        tmp_keymgmt_tofree = tmp_keymgmt =
            evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)tmp_prov,
                                        EVP_KEYMGMT_get0_name(locpctx->keymgmt),
                                        locpctx->propquery);
        if (tmp_keymgmt != 
# 179 "../crypto/evp/m_sigver.c" 3 4
                          ((void *)0)
# 179 "../crypto/evp/m_sigver.c"
                              )
            provkey = evp_pkey_export_to_provider(locpctx->pkey, locpctx->libctx,
                                                  &tmp_keymgmt, locpctx->propquery);
        if (tmp_keymgmt == 
# 182 "../crypto/evp/m_sigver.c" 3 4
                          ((void *)0)
# 182 "../crypto/evp/m_sigver.c"
    ...
    if (provkey == 
# 186 "../crypto/evp/m_sigver.c" 3 4
                  ((void *)0)
# 186 "../crypto/evp/m_sigver.c"
                      ) {
        EVP_SIGNATURE_free(signature);
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",189,__func__), ERR_set_error)((6),(134),
# 189 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 189 "../crypto/evp/m_sigver.c"
       );
        goto err;
    }
    ...
    if (locpctx->op.sig.algctx == 
# 202 "../crypto/evp/m_sigver.c" 3 4
                                 ((void *)0)
# 202 "../crypto/evp/m_sigver.c"
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",203,__func__), ERR_set_error)((6),(134),
# 203 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 203 "../crypto/evp/m_sigver.c"
       );
        goto err;
    }
...
# 208 "../crypto/evp/m_sigver.c"
    ...
    if (type != 
# 211 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 211 "../crypto/evp/m_sigver.c"
                   ) {
        ctx->reqdigest = type;
        if (mdname == 
# 213 "../crypto/evp/m_sigver.c" 3 4
                     ((void *)0)
# 213 "../crypto/evp/m_sigver.c"
                         )
            mdname = canon_mdname(EVP_MD_get0_name(type));
    } else {
        if (mdname == 
# 216 "../crypto/evp/m_sigver.c" 3 4
                     ((void *)0) 
# 216 "../crypto/evp/m_sigver.c"
                          && !reinit) {
        ...
        if (mdname != 
# 224 "../crypto/evp/m_sigver.c" 3 4
                     ((void *)0)
# 224 "../crypto/evp/m_sigver.c"
                         ) {
            ...
            if (ctx->fetched_digest != 
# 241 "../crypto/evp/m_sigver.c" 3 4
                                      ((void *)0)
# 241 "../crypto/evp/m_sigver.c"
                                          ) {
                ...
                if (ctx->digest == 
# 246 "../crypto/evp/m_sigver.c" 3 4
                                  ((void *)0)
# 246 "../crypto/evp/m_sigver.c"
                                      ) {
                    (void)ERR_clear_last_mark();
                    (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",248,__func__), ERR_set_error)((6),(134),
# 248 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 248 "../crypto/evp/m_sigver.c"
                   );
                    goto err;
                }
            }
...
# 257 "../crypto/evp/m_sigver.c" 3 4
                                            ((void *)0)
# 257 "../crypto/evp/m_sigver.c"
                                                ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",258,__func__), ERR_set_error)((6),(134),
# 258 "../crypto/evp/m_sigver.c" 3 4
           ((void *)0)
# 258 "../crypto/evp/m_sigver.c"
           );
            goto err;
        }
...
# 264 "../crypto/evp/m_sigver.c" 3 4
                                          ((void *)0)
# 264 "../crypto/evp/m_sigver.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",265,__func__), ERR_set_error)((6),(134),
# 265 "../crypto/evp/m_sigver.c" 3 4
           ((void *)0)
# 265 "../crypto/evp/m_sigver.c"
           );
            goto err;
        }
    ...
    if (ret > 0 || mdname != 
# 276 "../crypto/evp/m_sigver.c" 3 4
                            ((void *)0)
# 276 "../crypto/evp/m_sigver.c"
                                )
        goto end;
    if (type == 
# 278 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 278 "../crypto/evp/m_sigver.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",279,__func__), ERR_set_error)((6),(158),
# 279 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 279 "../crypto/evp/m_sigver.c"
       );
 ...
 legacy:
    ...
    EVP_KEYMGMT_free(tmp_keymgmt);
    tmp_keymgmt = 
# 294 "../crypto/evp/m_sigver.c" 3 4
                 ((void *)0)
# 294 "../crypto/evp/m_sigver.c"
                     ;

    if (type == 
# 296 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0) 
# 296 "../crypto/evp/m_sigver.c"
                    && mdname != 
# 296 "../crypto/evp/m_sigver.c" 3 4
                                 ((void *)0)
# 296 "../crypto/evp/m_sigver.c"
    ...
    if (ctx->pctx->pmeth == 
# 299 "../crypto/evp/m_sigver.c" 3 4
                           ((void *)0)
# 299 "../crypto/evp/m_sigver.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",300,__func__), ERR_set_error)((6),(150),
# 300 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 300 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (!(ctx->pctx->pmeth->flags & 4)) {

        if (type == 
# 306 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 306 "../crypto/evp/m_sigver.c"
                       ) {
            int def_nid;
        ...
        if (type == 
# 312 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 312 "../crypto/evp/m_sigver.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",313,__func__), ERR_set_error)((6),(158),
# 313 "../crypto/evp/m_sigver.c" 3 4
           ((void *)0)
# 313 "../crypto/evp/m_sigver.c"
           );
            return 0;
        }
    }
    ...
    if (ver) {
        if (ctx->pctx->pmeth->verifyctx_init) {
            if (ctx->pctx->pmeth->verifyctx_init(ctx->pctx, ctx) <= 0)
                return 0;
            ctx->pctx->operation = (1<<8);
        } else if (ctx->pctx->pmeth->digestverify != 0) {
            ctx->pctx->operation = (1<<5);
            ctx->update = update;
...
# 354 "../crypto/evp/m_sigver.c" 3 4
                                          ((void *)0)
# 354 "../crypto/evp/m_sigver.c"
                                              )
...
int EVP_DigestSignInit_ex(EVP_MD_CTX *ctx, EVP_PKEY_CTX **pctx,
                          ...
                          const OSSL_PARAM params[])
{
    return do_sigver_init(ctx, pctx, 
# 374 "../crypto/evp/m_sigver.c" 3 4
                                    ((void *)0)
# 374 "../crypto/evp/m_sigver.c"
                                        , mdname, libctx, props, 
# 374 "../crypto/evp/m_sigver.c" 3 4
                                                                 ((void *)0)
# 374 "../crypto/evp/m_sigver.c"
...
# 381 "../crypto/evp/m_sigver.c" 3 4
                                          ((void *)0)
# 381 "../crypto/evp/m_sigver.c"
                                              , 
# 381 "../crypto/evp/m_sigver.c" 3 4
                                                ((void *)0)
# 381 "../crypto/evp/m_sigver.c"
...
# 382 "../crypto/evp/m_sigver.c" 3 4
                         ((void *)0)
# 382 "../crypto/evp/m_sigver.c"
                             );
}
...
{
    return do_sigver_init(ctx, pctx, 
# 390 "../crypto/evp/m_sigver.c" 3 4
                                    ((void *)0)
# 390 "../crypto/evp/m_sigver.c"
                                        , mdname, libctx, props, 
# 390 "../crypto/evp/m_sigver.c" 3 4
                                                                 ((void *)0)
# 390 "../crypto/evp/m_sigver.c"
...
{
    return do_sigver_init(ctx, pctx, type, 
# 397 "../crypto/evp/m_sigver.c" 3 4
                                          ((void *)0)
# 397 "../crypto/evp/m_sigver.c"
                                              , 
# 397 "../crypto/evp/m_sigver.c" 3 4
                                                ((void *)0)
# 397 "../crypto/evp/m_sigver.c"
...
# 398 "../crypto/evp/m_sigver.c" 3 4
                         ((void *)0)
# 398 "../crypto/evp/m_sigver.c"
                             );
}
...
int EVP_DigestSignUpdate(EVP_MD_CTX *ctx, const void *data, size_t dsize)
{
    ...
    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",407,__func__), ERR_set_error)((6),(189),
# 407 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 407 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx == 
# 411 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
            
# 412 "../crypto/evp/m_sigver.c"
           || pctx->operation != (1<<7)
            || pctx->op.sig.algctx == 
# 413 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 414 "../crypto/evp/m_sigver.c"
           || pctx->op.sig.signature == 
# 414 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 414 "../crypto/evp/m_sigver.c"
                                            )
        goto legacy;

    if (pctx->op.sig.signature->digest_sign_update == 
# 417 "../crypto/evp/m_sigver.c" 3 4
                                                     ((void *)0)
# 417 "../crypto/evp/m_sigver.c"
                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",418,__func__), ERR_set_error)((6),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 418 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 418 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }
 ...
 legacy:
    if (pctx != 
# 426 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 426 "../crypto/evp/m_sigver.c"
                   ) {
...
int EVP_DigestVerifyUpdate(EVP_MD_CTX *ctx, const void *data, size_t dsize)
{
    ...
    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",442,__func__), ERR_set_error)((6),(189),
# 442 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 442 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx == 
# 446 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
            
# 447 "../crypto/evp/m_sigver.c"
           || pctx->operation != (1<<8)
            || pctx->op.sig.algctx == 
# 448 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 449 "../crypto/evp/m_sigver.c"
           || pctx->op.sig.signature == 
# 449 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 449 "../crypto/evp/m_sigver.c"
                                            )
        goto legacy;

    if (pctx->op.sig.signature->digest_verify_update == 
# 452 "../crypto/evp/m_sigver.c" 3 4
                                                       ((void *)0)
# 452 "../crypto/evp/m_sigver.c"
                                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",453,__func__), ERR_set_error)((6),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 453 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 453 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }
 ...
 legacy:
    if (pctx != 
# 461 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 461 "../crypto/evp/m_sigver.c"
                   ) {
                        ...
                        size_t *siglen)
{
    int sctx = 0, r = 0;
    EVP_PKEY_CTX *dctx = 
# 477 "../crypto/evp/m_sigver.c" 3 4
                        ((void *)0)
# 477 "../crypto/evp/m_sigver.c"
                            , *pctx = ctx->pctx;

    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",480,__func__), ERR_set_error)((6),(188),
# 480 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 480 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx == 
# 484 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
            
# 485 "../crypto/evp/m_sigver.c"
           || pctx->operation != (1<<7)
            || pctx->op.sig.algctx == 
# 486 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 487 "../crypto/evp/m_sigver.c"
           || pctx->op.sig.signature == 
# 487 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 487 "../crypto/evp/m_sigver.c"
                                            )
        goto legacy;
    ...
    if (sigret != 
# 490 "../crypto/evp/m_sigver.c" 3 4
                 ((void *)0) 
# 490 "../crypto/evp/m_sigver.c"
                      && (ctx->flags & 0x0200) == 0) {

        dctx = EVP_PKEY_CTX_dup(pctx);
        if (dctx != 
# 493 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 493 "../crypto/evp/m_sigver.c"
                       )
            pctx = dctx;
    }
    r = pctx->op.sig.signature->digest_sign_final(pctx->op.sig.algctx,
                                                  sigret, siglen,
                                                  sigret == 
# 498 "../crypto/evp/m_sigver.c" 3 4
                                                           ((void *)0) 
# 498 "../crypto/evp/m_sigver.c"
                                                                ? 0 : *siglen);
    if (dctx == 
# 499 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0) 
# 499 "../crypto/evp/m_sigver.c"
                    && sigret != 
# 499 "../crypto/evp/m_sigver.c" 3 4
                                 ((void *)0)
# 499 "../crypto/evp/m_sigver.c"
 ...
 legacy:
    if (pctx == 
# 506 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0) 
# 506 "../crypto/evp/m_sigver.c"
                    || pctx->pmeth == 
# 506 "../crypto/evp/m_sigver.c" 3 4
                                      ((void *)0)
# 506 "../crypto/evp/m_sigver.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",507,__func__), ERR_set_error)((6),(134),
# 507 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 507 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }
    ...
    if (pctx->pmeth->flags & 4) {
        if (sigret == 
# 518 "../crypto/evp/m_sigver.c" 3 4
                     ((void *)0)
# 518 "../crypto/evp/m_sigver.c"
                         )
            return pctx->pmeth->signctx(pctx, sigret, siglen, ctx);
        if ((ctx->flags & 0x0200) != 0) {
            r = pctx->pmeth->signctx(pctx, sigret, siglen, ctx);
            ctx->flags |= 0x0800;
        } else {
            dctx = EVP_PKEY_CTX_dup(pctx);
            if (dctx == 
# 525 "../crypto/evp/m_sigver.c" 3 4
                       ((void *)0)
# 525 "../crypto/evp/m_sigver.c"
                           )
                return 0;
...
# 532 "../crypto/evp/m_sigver.c" 3 4
                               ((void *)0)
# 532 "../crypto/evp/m_sigver.c"
                                   )
        sctx = 1;
    else
        sctx = 0;
    if (sigret != 
# 536 "../crypto/evp/m_sigver.c" 3 4
                 ((void *)0)
# 536 "../crypto/evp/m_sigver.c"
                     ) {
        unsigned char md[64];
        ...
        if (ctx->flags & 0x0200) {
            ...
            if (tmp_ctx == 
# 548 "../crypto/evp/m_sigver.c" 3 4
                          ((void *)0)
# 548 "../crypto/evp/m_sigver.c"
                              )
                return 0;
        ...
        if (sctx) {
            ...
            if (s < 0 || EVP_PKEY_sign(pctx, sigret, siglen, 
# 572 "../crypto/evp/m_sigver.c" 3 4
                                                            ((void *)0)
# 572 "../crypto/evp/m_sigver.c"
                                                                , s) <= 0)
                return 0;
        }
    }
                   ...
                   const unsigned char *tbs, size_t tbslen)
{
    ...
    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",585,__func__), ERR_set_error)((6),(188),
# 585 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 585 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx != 
# 589 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
            
# 590 "../crypto/evp/m_sigver.c"
           && pctx->operation == (1<<7)
            && pctx->op.sig.algctx != 
# 591 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 592 "../crypto/evp/m_sigver.c"
           && pctx->op.sig.signature != 
# 592 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 592 "../crypto/evp/m_sigver.c"
                                            ) {
        if (pctx->op.sig.signature->digest_sign != 
# 593 "../crypto/evp/m_sigver.c" 3 4
                                                  ((void *)0)
# 593 "../crypto/evp/m_sigver.c"
                                                      ) {
            if (sigret != 
# 594 "../crypto/evp/m_sigver.c" 3 4
                         ((void *)0)
# 594 "../crypto/evp/m_sigver.c"
                             )
                ctx->flags |= 0x0800;
            return pctx->op.sig.signature->digest_sign(pctx->op.sig.algctx,
                                                       sigret, siglen,
                                                       sigret == 
# 598 "../crypto/evp/m_sigver.c" 3 4
                                                                ((void *)0) 
# 598 "../crypto/evp/m_sigver.c"
                                                                     ? 0 : *siglen,
                                                       tbs, tbslen);
        }
    } else {
        ...
        if (ctx->pctx->pmeth != 
# 603 "../crypto/evp/m_sigver.c" 3 4
                               ((void *)0) 
# 603 "../crypto/evp/m_sigver.c"
                                    && ctx->pctx->pmeth->digestsign != 
# 603 "../crypto/evp/m_sigver.c" 3 4
                                                                       ((void *)0)
# 603 "../crypto/evp/m_sigver.c"
                                                                           )
    ...
    if (sigret != 
# 607 "../crypto/evp/m_sigver.c" 3 4
                 ((void *)0) 
# 607 "../crypto/evp/m_sigver.c"
                      && EVP_DigestSignUpdate(ctx, tbs, tbslen) <= 0)
        return 0;
                          ...
                          size_t siglen)
{
    ...
    int vctx = 0;
    EVP_PKEY_CTX *dctx = 
# 619 "../crypto/evp/m_sigver.c" 3 4
                        ((void *)0)
# 619 "../crypto/evp/m_sigver.c"
                            , *pctx = ctx->pctx;

    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",622,__func__), ERR_set_error)((6),(188),
# 622 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 622 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx == 
# 626 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
            
# 627 "../crypto/evp/m_sigver.c"
           || pctx->operation != (1<<8)
            || pctx->op.sig.algctx == 
# 628 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 629 "../crypto/evp/m_sigver.c"
           || pctx->op.sig.signature == 
# 629 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 629 "../crypto/evp/m_sigver.c"
                                            )
        goto legacy;
    ...
    if ((ctx->flags & 0x0200) == 0) {
        ...
        dctx = EVP_PKEY_CTX_dup(pctx);
        if (dctx != 
# 635 "../crypto/evp/m_sigver.c" 3 4
                   ((void *)0)
# 635 "../crypto/evp/m_sigver.c"
                       )
            pctx = dctx;
    }
    r = pctx->op.sig.signature->digest_verify_final(pctx->op.sig.algctx,
                                                    sig, siglen);
    if (dctx == 
# 640 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 640 "../crypto/evp/m_sigver.c"
                   )
        ctx->flags |= 0x0800;
    else
        EVP_PKEY_CTX_free(dctx);
 ...
 legacy:
    if (pctx == 
# 647 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0) 
# 647 "../crypto/evp/m_sigver.c"
                    || pctx->pmeth == 
# 647 "../crypto/evp/m_sigver.c" 3 4
                                      ((void *)0)
# 647 "../crypto/evp/m_sigver.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",648,__func__), ERR_set_error)((6),(134),
# 648 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 648 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }
...
# 658 "../crypto/evp/m_sigver.c" 3 4
                                 ((void *)0)
# 658 "../crypto/evp/m_sigver.c"
                                     )
        vctx = 1;
    else
        vctx = 0;
    if (ctx->flags & 0x0200) {
        ...
        EVP_MD_CTX *tmp_ctx = EVP_MD_CTX_new();
        if (tmp_ctx == 
# 670 "../crypto/evp/m_sigver.c" 3 4
                      ((void *)0)
# 670 "../crypto/evp/m_sigver.c"
                          )
            return -1;
        if (!EVP_MD_CTX_copy_ex(tmp_ctx, ctx)) {
            EVP_MD_CTX_free(tmp_ctx);
                     ...
                     size_t siglen, const unsigned char *tbs, size_t tbslen)
{
    ...
    if (pctx == 
# 693 "../crypto/evp/m_sigver.c" 3 4
               ((void *)0)
# 693 "../crypto/evp/m_sigver.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",694,__func__), ERR_set_error)((6),(134),
# 694 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 694 "../crypto/evp/m_sigver.c"
       );
        return -1;
    }

    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/m_sigver.c",699,__func__), ERR_set_error)((6),(188),
# 699 "../crypto/evp/m_sigver.c" 3 4
       ((void *)0)
# 699 "../crypto/evp/m_sigver.c"
       );
        return 0;
    }

    if (pctx->operation == (1<<8)
            && pctx->op.sig.algctx != 
# 704 "../crypto/evp/m_sigver.c" 3 4
                                     ((void *)0)
            
# 705 "../crypto/evp/m_sigver.c"
           && pctx->op.sig.signature != 
# 705 "../crypto/evp/m_sigver.c" 3 4
                                        ((void *)0)
# 705 "../crypto/evp/m_sigver.c"
                                            ) {
        if (pctx->op.sig.signature->digest_verify != 
# 706 "../crypto/evp/m_sigver.c" 3 4
                                                    ((void *)0)
# 706 "../crypto/evp/m_sigver.c"
                                                        ) {
            ctx->flags |= 0x0800;
        ...
        if (pctx->pmeth != 
# 714 "../crypto/evp/m_sigver.c" 3 4
                          ((void *)0) 
# 714 "../crypto/evp/m_sigver.c"
                               && pctx->pmeth->digestverify != 
# 714 "../crypto/evp/m_sigver.c" 3 4
                                                               ((void *)0)
# 714 "../crypto/evp/m_sigver.c"
                                                                   )
