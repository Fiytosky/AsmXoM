# 0 "../crypto/evp/e_aria.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_aria.c"
# 11 "../crypto/evp/e_aria.c"
...
int RAND_poll(void);
# 18 "../crypto/evp/e_aria.c" 2
# 1 "../include/crypto/aria.h" 1
# 15 "../include/crypto/aria.h"
        
# 29 "../include/crypto/aria.h"
typedef union {
    unsigned char c[16];
    unsigned int u[16 / sizeof(unsigned int)];
} ARIA_u128;

typedef unsigned char ARIA_c128[16];
...
{
    int ret;
    int mode = EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(ctx));

    if (enc || (mode != 0x1 && mode != 0x2))
        ...
        ret = ossl_aria_set_decrypt_key(key,
                                        ...
                                        EVP_CIPHER_CTX_get_cipher_data(ctx));
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/e_aria.c",76,__func__), ERR_set_error)((6),(176),
# 76 "../crypto/evp/e_aria.c" 3 4
       ((void *)0)
# 76 "../crypto/evp/e_aria.c"
       );
        return 0;
    }
    return 1;
...
static int aria_128_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { aria_cbc_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) aria_cbc_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_128_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (128 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int aria_128_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) aria_ecb_encrypt(in + i, out + i, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_128_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER aria_128_cbc = { 1066, 16, 16, 16, 0 | 0x2, 1, aria_init_key, aria_128_cbc_cipher, 
# 134 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 134 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 134 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 134 "../crypto/evp/e_aria.c"
, 
...
((void *)0) 
# 134 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_cbc(void) { return &aria_128_cbc; } static const EVP_CIPHER aria_128_cfb128 = { 1067, 1, 16, 16, 0 | 0x3, 1, aria_init_key, aria_128_cfb128_cipher, 
# 134 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 134 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 134 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_cfb128(void) { return &aria_128_cfb128; } static const EVP_CIPHER aria_128_ofb = { 1068, 1, 16, 16, 0 | 0x4, 1, aria_init_key, aria_128_ofb_cipher, 
# 134 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 134 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 134 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_ofb(void) { return &aria_128_ofb; } static const EVP_CIPHER aria_128_ecb = { 1065, 16, 16, 0, 0 | 0x1, 1, aria_init_key, aria_128_ecb_cipher, 
# 134 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 134 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
static int aria_192_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { aria_cbc_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) aria_cbc_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_192_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (128 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int aria_192_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) aria_ecb_encrypt(in + i, out + i, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_192_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER aria_192_cbc = { 1071, 16, 24, 16, 0 | 0x2, 1, aria_init_key, aria_192_cbc_cipher, 
# 140 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 140 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 140 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 140 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 140 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_cbc(void) { return &aria_192_cbc; } static const EVP_CIPHER aria_192_cfb128 = { 1072, 1, 24, 16, 0 | 0x3, 1, aria_init_key, aria_192_cfb128_cipher, 
# 140 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 140 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 140 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_cfb128(void) { return &aria_192_cfb128; } static const EVP_CIPHER aria_192_ofb = { 1073, 1, 24, 16, 0 | 0x4, 1, aria_init_key, aria_192_ofb_cipher, 
# 140 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 140 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 140 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_ofb(void) { return &aria_192_ofb; } static const EVP_CIPHER aria_192_ecb = { 1070, 16, 24, 0, 0 | 0x1, 1, aria_init_key, aria_192_ecb_cipher, 
# 140 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 140 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
static int aria_256_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { aria_cbc_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) aria_cbc_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_256_cfb128_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (128 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb128_encrypt(in, out, (long) ((128 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int aria_256_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) aria_ecb_encrypt(in + i, out + i, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int aria_256_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_ofb128_encrypt(in, out, (long)inl, &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER aria_256_cbc = { 1076, 16, 32, 16, 0 | 0x2, 1, aria_init_key, aria_256_cbc_cipher, 
# 146 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 146 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 146 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 146 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 146 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_cbc(void) { return &aria_256_cbc; } static const EVP_CIPHER aria_256_cfb128 = { 1077, 1, 32, 16, 0 | 0x3, 1, aria_init_key, aria_256_cfb128_cipher, 
# 146 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 146 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 146 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_cfb128(void) { return &aria_256_cfb128; } static const EVP_CIPHER aria_256_ofb = { 1078, 1, 32, 16, 0 | 0x4, 1, aria_init_key, aria_256_ofb_cipher, 
# 146 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 146 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 146 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_ofb(void) { return &aria_256_ofb; } static const EVP_CIPHER aria_256_ecb = { 1075, 16, 32, 0, 0 | 0x1, 1, aria_init_key, aria_256_ecb_cipher, 
# 146 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 146 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
# 155 "../crypto/evp/e_aria.c"
static int aria_128_cfb1_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (1 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb1_encrypt(in, out, (long) ((1 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_128_cfb1 = { 1080, 1, 128/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_128_cfb1_cipher, 
# 155 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 155 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 155 "../crypto/evp/e_aria.c" 3 4
...
((void *)0) 
# 155 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_cfb1(void) { return &aria_128_cfb1; }
static int aria_192_cfb1_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (1 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb1_encrypt(in, out, (long) ((1 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_192_cfb1 = { 1081, 1, 192/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_192_cfb1_cipher, 
# 156 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 156 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 156 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 156 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 156 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_cfb1(void) { return &aria_192_cfb1; }
static int aria_256_cfb1_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (1 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb1_encrypt(in, out, (long) ((1 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_256_cfb1 = { 1082, 1, 256/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_256_cfb1_cipher, 
# 157 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 157 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 157 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 157 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 157 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_cfb1(void) { return &aria_256_cfb1; }
static int aria_128_cfb8_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (8 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb8_encrypt(in, out, (long) ((8 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_128_cfb8 = { 1083, 1, 128/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_128_cfb8_cipher, 
# 158 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 158 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 158 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 158 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 158 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_cfb8(void) { return &aria_128_cfb8; }
static int aria_192_cfb8_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (8 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb8_encrypt(in, out, (long) ((8 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_192_cfb8 = { 1084, 1, 192/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_192_cfb8_cipher, 
# 159 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 159 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 159 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 159 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 159 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_cfb8(void) { return &aria_192_cfb8; }
static int aria_256_cfb8_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (8 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); aria_cfb8_encrypt(in, out, (long) ((8 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static const EVP_CIPHER aria_256_cfb8 = { 1085, 1, 256/8, 16, (0)|0 | 0x3, 1, aria_init_key, aria_256_cfb8_cipher, 
# 160 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 160 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 160 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 160 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 160 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_cfb8(void) { return &aria_256_cfb8; }
# 175 "../crypto/evp/e_aria.c"
static int aria_ctr_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
                               const unsigned char *in, size_t len)
{
    int n = EVP_CIPHER_CTX_get_num(ctx);
    unsigned int num;
    EVP_ARIA_KEY *dat = ((EVP_ARIA_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx));
...
static const EVP_CIPHER aria_128_ctr = { 1069,1,128/8,16, 0|0x5, 1, aria_init_key, aria_ctr_cipher, 
# 193 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 193 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 193 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 193 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 193 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_ctr(void) { return &aria_128_ctr; }
static const EVP_CIPHER aria_192_ctr = { 1074,1,192/8,16, 0|0x5, 1, aria_init_key, aria_ctr_cipher, 
# 194 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 194 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 194 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 194 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 194 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_ctr(void) { return &aria_192_ctr; }
static const EVP_CIPHER aria_256_ctr = { 1079,1,256/8,16, 0|0x5, 1, aria_init_key, aria_ctr_cipher, 
# 195 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 195 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_KEY), 
# 195 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 195 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 195 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_ctr(void) { return &aria_256_ctr; }
...
{
    int ret;
    EVP_ARIA_GCM_CTX *gctx = ((EVP_ARIA_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
    ...
    if (key) {
        ...
        CRYPTO_gcm128_init(&gctx->gcm, &gctx->ks,
                           (block128_f) ossl_aria_encrypt);
        if (ret < 0) {
            (ERR_new(), ERR_set_debug("../crypto/evp/e_aria.c",230,__func__), ERR_set_error)((6),(176),
# 230 "../crypto/evp/e_aria.c" 3 4
           ((void *)0)
# 230 "../crypto/evp/e_aria.c"
           );
            return 0;
        }
        ...
        if (iv == 
# 237 "../crypto/evp/e_aria.c" 3 4
                 ((void *)0) 
# 237 "../crypto/evp/e_aria.c"
                      && gctx->iv_set)
            iv = gctx->iv;
        if (iv) {
...
{
    EVP_ARIA_GCM_CTX *gctx = ((EVP_ARIA_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
    ...
    case 0x9:
        ...
        if ((arg > 16) && (arg > gctx->ivlen)) {
            if (gctx->iv != c->iv)
                CRYPTO_free(gctx->iv, "../crypto/evp/e_aria.c", 281);
            if ((gctx->iv = CRYPTO_malloc(arg, "../crypto/evp/e_aria.c", 282)) == 
# 282 "../crypto/evp/e_aria.c" 3 4
                                                   ((void *)0)
# 282 "../crypto/evp/e_aria.c"
                                                       )
                return 0;
        }
        gctx->ivlen = arg;
    ...
    case 0x8:
        {
            ...
            EVP_ARIA_GCM_CTX *gctx_out = ((EVP_ARIA_GCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(out));
            if (gctx->gcm.key) {
            ...
            if (gctx->iv == c->iv)
                ...
                if ((gctx_out->iv = CRYPTO_malloc(gctx->ivlen, "../crypto/evp/e_aria.c", 385)) == 
# 385 "../crypto/evp/e_aria.c" 3 4
                                                                   ((void *)0)
# 385 "../crypto/evp/e_aria.c"
                                                                       )
                    return 0;
                          ...
                          const unsigned char *in, size_t len)
{
    ...
    if (in) {
        if (out == 
# 469 "../crypto/evp/e_aria.c" 3 4
                  ((void *)0)
# 469 "../crypto/evp/e_aria.c"
                      ) {
...
static int aria_gcm_cleanup(EVP_CIPHER_CTX *ctx)
{
    ...
    if (gctx->iv != ctx->iv)
        CRYPTO_free(gctx->iv, "../crypto/evp/e_aria.c", 503);
...
{
    int ret;
    EVP_ARIA_CCM_CTX *cctx = ((EVP_ARIA_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(ctx));
    ...
    if (key) {
        ...
        if (ret < 0) {
            (ERR_new(), ERR_set_debug("../crypto/evp/e_aria.c",524,__func__), ERR_set_error)((6),(176),
# 524 "../crypto/evp/e_aria.c" 3 4
           ((void *)0)
# 524 "../crypto/evp/e_aria.c"
           );
            return 0;
        }
        cctx->str = 
# 527 "../crypto/evp/e_aria.c" 3 4
                   ((void *)0)
# 527 "../crypto/evp/e_aria.c"
                       ;
        cctx->key_set = 1;
    }
    if (iv) {
...
{
    EVP_ARIA_CCM_CTX *cctx = ((EVP_ARIA_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(c));
    ...
    case 0x8:
        {
            EVP_CIPHER_CTX *out = ptr;
            EVP_ARIA_CCM_CTX *cctx_out = ((EVP_ARIA_CCM_CTX *)EVP_CIPHER_CTX_get_cipher_data(out));
            if (cctx->ccm.key) {
                          ...
                          const unsigned char *in, size_t len)
{
    ...
    if (in == 
# 699 "../crypto/evp/e_aria.c" 3 4
             ((void *)0) 
# 699 "../crypto/evp/e_aria.c"
                  && out != 
# 699 "../crypto/evp/e_aria.c" 3 4
                            ((void *)0)
# 699 "../crypto/evp/e_aria.c"
...
# 778 "../crypto/evp/e_aria.c"
static const EVP_CIPHER aria_128_gcm = { 1123, 1, 128/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x6, 1, aria_gcm_init_key, aria_gcm_cipher, aria_gcm_cleanup, sizeof(EVP_ARIA_GCM_CTX), 
# 778 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 778 "../crypto/evp/e_aria.c"
,
# 778 "../crypto/evp/e_aria.c" 3 4
...
((void *)0) 
# 778 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_gcm(void) { return (EVP_CIPHER*)&aria_128_gcm; }
static const EVP_CIPHER aria_192_gcm = { 1124, 1, 192/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x6, 1, aria_gcm_init_key, aria_gcm_cipher, aria_gcm_cleanup, sizeof(EVP_ARIA_GCM_CTX), 
# 779 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 779 "../crypto/evp/e_aria.c"
,
# 779 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 779 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 779 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_gcm(void) { return (EVP_CIPHER*)&aria_192_gcm; }
static const EVP_CIPHER aria_256_gcm = { 1125, 1, 256/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x6, 1, aria_gcm_init_key, aria_gcm_cipher, aria_gcm_cleanup, sizeof(EVP_ARIA_GCM_CTX), 
# 780 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 780 "../crypto/evp/e_aria.c"
,
# 780 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 780 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 780 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_gcm(void) { return (EVP_CIPHER*)&aria_256_gcm; }

static const EVP_CIPHER aria_128_ccm = { 1120, 1, 128/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x7, 1, aria_ccm_init_key, aria_ccm_cipher, 
# 782 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 782 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_CCM_CTX), 
# 782 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 782 "../crypto/evp/e_aria.c"
,
...
((void *)0) 
# 782 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_128_ccm(void) { return (EVP_CIPHER*)&aria_128_ccm; }
static const EVP_CIPHER aria_192_ccm = { 1121, 1, 192/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x7, 1, aria_ccm_init_key, aria_ccm_cipher, 
# 783 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 783 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_CCM_CTX), 
# 783 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 783 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 783 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_192_ccm(void) { return (EVP_CIPHER*)&aria_192_ccm; }
static const EVP_CIPHER aria_256_ccm = { 1122, 1, 256/8, 12, (0 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 | 0x200000 | 0x800)|0x7, 1, aria_ccm_init_key, aria_ccm_cipher, 
# 784 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 784 "../crypto/evp/e_aria.c"
, sizeof(EVP_ARIA_CCM_CTX), 
# 784 "../crypto/evp/e_aria.c" 3 4
((void *)0)
# 784 "../crypto/evp/e_aria.c"
...
((void *)0) 
# 784 "../crypto/evp/e_aria.c"
}; const EVP_CIPHER *EVP_aria_256_ccm(void) { return (EVP_CIPHER*)&aria_256_ccm; }
