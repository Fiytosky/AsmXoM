# 0 "../crypto/evp/evp_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_key.c"
# 10 "../crypto/evp/evp_key.c"
...
{
    if (prompt == 
# 26 "../crypto/evp/evp_key.c" 3 4
                 ((void *)0)
# 26 "../crypto/evp/evp_key.c"
                     )
        prompt_string[0] = '\0';
    else {
...
char *EVP_get_pw_prompt(void)
{
    if (prompt_string[0] == '\0')
        return 
# 37 "../crypto/evp/evp_key.c" 3 4
              ((void *)0)
# 37 "../crypto/evp/evp_key.c"
                  ;
    else
                           ...
                           int verify)
{
    int ret = -1;
    char buff[
# 56 "../crypto/evp/evp_key.c" 3 4
             8192
# 56 "../crypto/evp/evp_key.c"
                   ];
    UI *ui;

    if ((prompt == 
# 59 "../crypto/evp/evp_key.c" 3 4
                  ((void *)0)
# 59 "../crypto/evp/evp_key.c"
                      ) && (prompt_string[0] != '\0'))
        prompt = prompt_string;
    ui = UI_new();
    if (ui == 
# 62 "../crypto/evp/evp_key.c" 3 4
             ((void *)0)
# 62 "../crypto/evp/evp_key.c"
                 )
        return ret;
    if (UI_add_input_string(ui, prompt, 0, buf, min,
                            (len >= 
# 65 "../crypto/evp/evp_key.c" 3 4
                                   8192
# 65 "../crypto/evp/evp_key.c"
                                         ) ? 
# 65 "../crypto/evp/evp_key.c" 3 4
                                             8192 
# 65 "../crypto/evp/evp_key.c"
        ...
        || (verify
            && UI_add_verify_string(ui, prompt, 0, buff, min,
                                    (len >= 
# 68 "../crypto/evp/evp_key.c" 3 4
                                           8192
# 68 "../crypto/evp/evp_key.c"
                                                 ) ? 
# 68 "../crypto/evp/evp_key.c" 3 4
                                                     8192 
# 68 "../crypto/evp/evp_key.c"
...
# 72 "../crypto/evp/evp_key.c" 3 4
                         8192
# 72 "../crypto/evp/evp_key.c"
                               );
 end:
    UI_free(ui);
    return ret;
                   ...
                   unsigned char *iv)
{
    ...
    (void)((nkey <= 64) ? 0 : (OPENSSL_die("assertion failed: " "nkey <= EVP_MAX_KEY_LENGTH", "../crypto/evp/evp_key.c", 90), 1));
    (void)((niv >= 0 && niv <= 16) ? 0 : (OPENSSL_die("assertion failed: " "niv >= 0 && niv <= EVP_MAX_IV_LENGTH", "../crypto/evp/evp_key.c", 91), 1));

    if (data == 
# 93 "../crypto/evp/evp_key.c" 3 4
               ((void *)0)
# 93 "../crypto/evp/evp_key.c"
                   )
        return nkey;

    c = EVP_MD_CTX_new();
    if (c == 
# 97 "../crypto/evp/evp_key.c" 3 4
            ((void *)0)
# 97 "../crypto/evp/evp_key.c"
                )
        goto err;
    for (;;) {
        if (!EVP_DigestInit_ex(c, md, 
# 100 "../crypto/evp/evp_key.c" 3 4
                                     ((void *)0)
# 100 "../crypto/evp/evp_key.c"
                                         ))
            goto err;
        if (addmd++)
        ...
        if (!EVP_DigestUpdate(c, data, datal))
            goto err;
        if (salt != 
# 107 "../crypto/evp/evp_key.c" 3 4
                   ((void *)0)
# 107 "../crypto/evp/evp_key.c"
                       )
        ...
        for (i = 1; i < (unsigned int)count; i++) {
            if (!EVP_DigestInit_ex(c, md, 
# 114 "../crypto/evp/evp_key.c" 3 4
                                         ((void *)0)
# 114 "../crypto/evp/evp_key.c"
                                             ))
                goto err;
            if (!EVP_DigestUpdate(c, &(md_buf[0]), mds))
                goto err;
        ...
        if (nkey) {
            for (;;) {
                ...
                if (i == mds)
                    break;
                if (key != 
# 128 "../crypto/evp/evp_key.c" 3 4
                          ((void *)0)
# 128 "../crypto/evp/evp_key.c"
                              )
                    *(key++) = md_buf[i];
                nkey--;
                i++;
        ...
        if (niv && (i != mds)) {
            for (;;) {
                ...
                if (i == mds)
                    break;
                if (iv != 
# 140 "../crypto/evp/evp_key.c" 3 4
                         ((void *)0)
# 140 "../crypto/evp/evp_key.c"
                             )
                    *(iv++) = md_buf[i];
                niv--;
                i++;
