# 0 "../crypto/evp/dh_support.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/dh_support.c"
# 10 "../crypto/evp/dh_support.c"
...
__attribute__((deprecated("Since OpenSSL " "0.9.8"))) DH *DH_generate_parameters(int prime_len, int generator,
                                                   void (*callback) (int, int,
                                                                void *),
                                                   void *cb_arg);
# 12 "../crypto/evp/dh_support.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 13 "../crypto/evp/dh_support.c" 2
...
const char *ossl_dh_gen_type_id2name(int id)
{
    ...
    for (i = 0; i < (sizeof(dhtype2id)/sizeof((dhtype2id)[0])); ++i) {
        if (dhtype2id[i].id == id)
            return dhtype2id[i].name;
    }
    return 
# 47 "../crypto/evp/dh_support.c" 3 4
          ((void *)0)
# 47 "../crypto/evp/dh_support.c"
              ;
}
