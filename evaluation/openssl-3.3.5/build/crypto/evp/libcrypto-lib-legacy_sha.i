# 0 "../crypto/evp/legacy_sha.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_sha.c"
# 14 "../crypto/evp/legacy_sha.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 19 "../crypto/evp/legacy_sha.c" 2

# 1 "../include/crypto/sha.h" 1
...
# 21 "../crypto/evp/legacy_sha.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 22 "../crypto/evp/legacy_sha.c" 2
...
# 23 "../crypto/evp/legacy_sha.c" 2
# 57 "../crypto/evp/legacy_sha.c"
static int sha1_init(EVP_MD_CTX *ctx) { return SHA1_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha1_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA1_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha1_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA1_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha224_init(EVP_MD_CTX *ctx) { return SHA224_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha224_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA224_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha224_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA224_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha256_init(EVP_MD_CTX *ctx) { return SHA256_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha256_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA256_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha256_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA256_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha384_init(EVP_MD_CTX *ctx) { return SHA384_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha384_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA384_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha384_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA384_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha512_init(EVP_MD_CTX *ctx) { return SHA512_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha512_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA512_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha512_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA512_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha512_224_int_init(EVP_MD_CTX *ctx) { return sha512_224_init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha512_224_int_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA512_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha512_224_int_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA512_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha512_256_int_init(EVP_MD_CTX *ctx) { return sha512_256_init(EVP_MD_CTX_get0_md_data(ctx)); } static int sha512_256_int_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return SHA512_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha512_256_int_final(EVP_MD_CTX *ctx, unsigned char *md) { return SHA512_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int sha3_int_init(EVP_MD_CTX *ctx) { return ossl_sha3_init(EVP_MD_CTX_get0_md_data(ctx), '\x06', ctx->digest->md_size * 8); } static int sha3_int_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return ossl_sha3_update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int sha3_int_final(EVP_MD_CTX *ctx, unsigned char *md) { KECCAK1600_CTX *kctx = EVP_MD_CTX_get0_md_data(ctx); return ossl_sha3_final(kctx, md, kctx->md_size); }
static int shake_init(EVP_MD_CTX *ctx) { return ossl_sha3_init(EVP_MD_CTX_get0_md_data(ctx), '\x1f', ctx->digest->md_size * 8); }

static int sha1_int_ctrl(EVP_MD_CTX *ctx, int cmd, int p1, void *p2)
{
    return ossl_sha1_ctrl(ctx != 
# 69 "../crypto/evp/legacy_sha.c" 3 4
                                ((void *)0) 
# 69 "../crypto/evp/legacy_sha.c"
                                     ? EVP_MD_CTX_get0_md_data(ctx) : 
# 69 "../crypto/evp/legacy_sha.c" 3 4
                                                                      ((void *)0)
# 69 "../crypto/evp/legacy_sha.c"
                                                                          ,
...
static int shake_ctrl(EVP_MD_CTX *evp_ctx, int cmd, int p1, void *p2)
{
    ...
    if (evp_ctx == 
# 77 "../crypto/evp/legacy_sha.c" 3 4
                  ((void *)0)
# 77 "../crypto/evp/legacy_sha.c"
                      )
        return 0;
    ctx = evp_ctx->md_data;
...
# 98 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 98 "../crypto/evp/legacy_sha.c"
   , 
# 98 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 98 "../crypto/evp/legacy_sha.c"
   , (16*4), 0, sha1_int_ctrl
                                        ,
};
...
# 113 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 113 "../crypto/evp/legacy_sha.c"
   , 
# 113 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 113 "../crypto/evp/legacy_sha.c"
...
# 128 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 128 "../crypto/evp/legacy_sha.c"
   , 
# 128 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 128 "../crypto/evp/legacy_sha.c"
...
static const EVP_MD sha512_224_md = {
    ...
    0x0008,
    1,
    sha512_224_int_init, sha512_224_int_update, sha512_224_int_final, 
# 143 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 143 "../crypto/evp/legacy_sha.c"
   , 
# 143 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 143 "../crypto/evp/legacy_sha.c"
...
static const EVP_MD sha512_256_md = {
    ...
    0x0008,
    1,
    sha512_256_int_init, sha512_256_int_update, sha512_256_int_final, 
# 158 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 158 "../crypto/evp/legacy_sha.c"
   , 
# 158 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 158 "../crypto/evp/legacy_sha.c"
...
# 173 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 173 "../crypto/evp/legacy_sha.c"
   , 
# 173 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 173 "../crypto/evp/legacy_sha.c"
...
# 188 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 188 "../crypto/evp/legacy_sha.c"
   , 
# 188 "../crypto/evp/legacy_sha.c" 3 4
   ((void *)0)
# 188 "../crypto/evp/legacy_sha.c"
...
# 227 "../crypto/evp/legacy_sha.c"
const EVP_MD *EVP_sha3_224(void) { static const EVP_MD sha3_224_md = { 1096, 1116, 224 / 8, 0x0008, 1, sha3_int_init, sha3_int_update, sha3_int_final, 
# 227 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 227 "../crypto/evp/legacy_sha.c"
, 
# 227 "../crypto/evp/legacy_sha.c" 3 4
...
# 227 "../crypto/evp/legacy_sha.c"
, }; return &sha3_224_md; }
const EVP_MD *EVP_sha3_256(void) { static const EVP_MD sha3_256_md = { 1097, 1117, 256 / 8, 0x0008, 1, sha3_int_init, sha3_int_update, sha3_int_final, 
# 228 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 228 "../crypto/evp/legacy_sha.c"
, 
# 228 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 228 "../crypto/evp/legacy_sha.c"
...
# 228 "../crypto/evp/legacy_sha.c"
, }; return &sha3_256_md; }
const EVP_MD *EVP_sha3_384(void) { static const EVP_MD sha3_384_md = { 1098, 1118, 384 / 8, 0x0008, 1, sha3_int_init, sha3_int_update, sha3_int_final, 
# 229 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 229 "../crypto/evp/legacy_sha.c"
, 
# 229 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 229 "../crypto/evp/legacy_sha.c"
...
# 229 "../crypto/evp/legacy_sha.c"
, }; return &sha3_384_md; }
const EVP_MD *EVP_sha3_512(void) { static const EVP_MD sha3_512_md = { 1099, 1119, 512 / 8, 0x0008, 1, sha3_int_init, sha3_int_update, sha3_int_final, 
# 230 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 230 "../crypto/evp/legacy_sha.c"
, 
# 230 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 230 "../crypto/evp/legacy_sha.c"
...
const EVP_MD *EVP_shake128(void) { static const EVP_MD shake128_md = { 1100, 0, 128 / 8, 0x0002 | 0x0008, 1, shake_init, sha3_int_update, sha3_int_final, 
# 232 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 232 "../crypto/evp/legacy_sha.c"
, 
# 232 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 232 "../crypto/evp/legacy_sha.c"
, (1600 - 128 * 2) / 8, 0, shake_ctrl, }; return &shake128_md; }
const EVP_MD *EVP_shake256(void) { static const EVP_MD shake256_md = { 1101, 0, 256 / 8, 0x0002 | 0x0008, 1, shake_init, sha3_int_update, sha3_int_final, 
# 233 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 233 "../crypto/evp/legacy_sha.c"
, 
# 233 "../crypto/evp/legacy_sha.c" 3 4
((void *)0)
# 233 "../crypto/evp/legacy_sha.c"
, (1600 - 256 * 2) / 8, 0, shake_ctrl, }; return &shake256_md; }
