# 0 "../crypto/evp/e_des3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_des3.c"
# 14 "../crypto/evp/e_des3.c"
...
# 69 "../crypto/evp/e_des3.c"
static int des_ede_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
                              const unsigned char *in, size_t inl)
{
    size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl)
        DES_ecb3_encrypt((const_DES_cblock *)(in + i),
                         (DES_cblock *)(out + i),
                         &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[0], &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[1],
                         &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[2], EVP_CIPHER_CTX_is_encrypting(ctx));
    return 1;
}
...
static int des_ede_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
                              const unsigned char *in, size_t inl)
{
    while (inl >= ((size_t)1 << 30)) {
        int num = EVP_CIPHER_CTX_get_num(ctx);
        DES_ede3_ofb64_encrypt(in, out, (long)((size_t)1 << 30),
                               &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[0], &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[1],
                               &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[2],
                               (DES_cblock *)ctx->iv,
                               &num);
...
static int des_ede_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
                              const unsigned char *in, size_t inl)
{
    DES_EDE_KEY *dat = ((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx));

    if (dat->stream.cbc != 
# 112 "../crypto/evp/e_des3.c" 3 4
                          ((void *)0)
# 112 "../crypto/evp/e_des3.c"
                              ) {
    ...
    while (inl >= ((size_t)1 << 30)) {
        DES_ede3_cbc_encrypt(in, out, (long)((size_t)1 << 30),
                                ...
                                const unsigned char *in, size_t inl)
{
    while (inl >= ((size_t)1 << 30)) {
        int num = EVP_CIPHER_CTX_get_num(ctx);
        DES_ede3_cfb64_encrypt(in, out, (long)((size_t)1 << 30),
                               &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[0], &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[1],
                               &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[2], (DES_cblock *)ctx->iv,
...
{
    while (inl >= ((size_t)1 << 30)) {
        DES_ede3_cfb_encrypt(in, out, 8, (long)((size_t)1 << 30),
                             &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[0], &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[1],
                             &((DES_EDE_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks.ks[2], (DES_cblock *)ctx->iv,
                             EVP_CIPHER_CTX_is_encrypting(ctx));
        inl -= ((size_t)1 << 30);
...
static const EVP_CIPHER des_ede_cbc = { 43, 8, 16, 8, 0x200 | 0 | 0x2, 1, des_ede_init_key, des_ede_cbc_cipher, 
# 206 "../crypto/evp/e_des3.c" 3 4
((void *)0)
# 206 "../crypto/evp/e_des3.c"
, sizeof(DES_EDE_KEY), 
# 206 "../crypto/evp/e_des3.c" 3 4
((void *)0)
# 206 "../crypto/evp/e_des3.c"
...
((void *)0) 
# 206 "../crypto/evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_cbc(void) { return &des_ede_cbc; } static const EVP_CIPHER des_ede_cfb64 = { 60, 1, 16, 8, 0x200 | 0 | 0x3, 1, des_ede_init_key, des_ede_cfb64_cipher, 
# 206 "../crypto/evp/e_des3.c" 3 4
((void *)0)
# 206 "../crypto/evp/e_des3.c"
, sizeof(DES_EDE_KEY), 
...
((void *)0) 
# 206 "../crypto/evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_cfb64(void) { return &des_ede_cfb64; } static const EVP_CIPHER des_ede_ofb = { 62, 1, 16, 8, 0x200 | 0 | 0x4, 1, des_ede_init_key, des_ede_ofb_cipher, 
# 206 "../crypto/evp/e_des3.c" 3 4
((void *)0)
# 206 "../crypto/evp/e_des3.c"
, sizeof(DES_EDE_KEY), 
...
((void *)0) 
# 206 "../crypto/evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_ofb(void) { return &des_ede_ofb; } static const EVP_CIPHER des_ede_ecb = { 32, 8, 16, 0, 0x200 | 0 | 0x1, 1, des_ede_init_key, des_ede_ecb_cipher, 
# 206 "../crypto/evp/e_des3.c" 3 4
((void *)0)
# 206 "../crypto/evp/e_des3.c"
, sizeof(DES_EDE_KEY), 
...
# 206 "../crypto/evp/e_des3.c"
    ...
    static const EVP_CIPHER des_ede3_cbc = { 44, 8, 24, 8, 0x200 | 0 | 0x2, 1, des_ede3_init_key, des_ede_cbc_cipher, 
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 213 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 213 "../crypto/evp/e_des3.c"
...
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0) 
# 213 "../crypto/evp/e_des3.c"
   }; const EVP_CIPHER *EVP_des_ede3_cbc(void) { return &des_ede3_cbc; } static const EVP_CIPHER des_ede3_cfb64 = { 61, 1, 24, 8, 0x200 | 0 | 0x3, 1, des_ede3_init_key, des_ede_cfb64_cipher, 
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 213 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
...
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0) 
# 213 "../crypto/evp/e_des3.c"
   }; const EVP_CIPHER *EVP_des_ede3_cfb64(void) { return &des_ede3_cfb64; } static const EVP_CIPHER des_ede3_ofb = { 63, 1, 24, 8, 0x200 | 0 | 0x4, 1, des_ede3_init_key, des_ede_ofb_cipher, 
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 213 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
...
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0) 
# 213 "../crypto/evp/e_des3.c"
   }; const EVP_CIPHER *EVP_des_ede3_ofb(void) { return &des_ede3_ofb; } static const EVP_CIPHER des_ede3_ecb = { 33, 8, 24, 0, 0x200 | 0 | 0x1, 1, des_ede3_init_key, des_ede_ecb_cipher, 
# 213 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 213 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
...
# 213 "../crypto/evp/e_des3.c"
    ...
    static const EVP_CIPHER des_ede3_cfb1 = { 658, 1, 24, 8, 0x200 | 0 | 0x3, 1, des_ede3_init_key, des_ede3_cfb1_cipher, 
# 217 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 217 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
# 217 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 217 "../crypto/evp/e_des3.c"
...
# 217 "../crypto/evp/e_des3.c"
    ...
    static const EVP_CIPHER des_ede3_cfb8 = { 659, 1, 24, 8, 0x200 | 0 | 0x3, 1, des_ede3_init_key, des_ede3_cfb8_cipher, 
# 221 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 221 "../crypto/evp/e_des3.c"
   , sizeof(DES_EDE_KEY), 
# 221 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 221 "../crypto/evp/e_des3.c"
                            ...
                            const unsigned char *iv, int enc)
{
    ...
    dat->stream.cbc = 
# 231 "../crypto/evp/e_des3.c" 3 4
                     ((void *)0)
# 231 "../crypto/evp/e_des3.c"
                         ;
# 246 "../crypto/evp/e_des3.c"
    DES_set_key_unchecked(&deskey[0], &dat->ks.ks[0]);
    DES_set_key_unchecked(&deskey[1], &dat->ks.ks[1]);
    memcpy(&dat->ks.ks[2], &dat->ks.ks[0], sizeof(dat->ks.ks[0]));
    return 1;
}
                             ...
                             const unsigned char *iv, int enc)
{
    ...
    dat->stream.cbc = 
# 258 "../crypto/evp/e_des3.c" 3 4
                     ((void *)0)
# 258 "../crypto/evp/e_des3.c"
                         ;
# 273 "../crypto/evp/e_des3.c"
    DES_set_key_unchecked(&deskey[0], &dat->ks.ks[0]);
    DES_set_key_unchecked(&deskey[1], &dat->ks.ks[1]);
...
static int des_ede3_unwrap(EVP_CIPHER_CTX *ctx, unsigned char *out,
                           const unsigned char *in, size_t inl)
{
    unsigned char icv[8], iv[8], sha1tmp[20];
    int rv = -1;
    if (inl < 24)
        return -1;
    if (out == 
# 325 "../crypto/evp/e_des3.c" 3 4
              ((void *)0)
# 325 "../crypto/evp/e_des3.c"
                  )
        return inl - 16;
    ...
    BUF_reverse(icv, 
# 343 "../crypto/evp/e_des3.c" 3 4
                    ((void *)0)
# 343 "../crypto/evp/e_des3.c"
                        , 8);
    BUF_reverse(out, 
# 344 "../crypto/evp/e_des3.c" 3 4
                    ((void *)0)
# 344 "../crypto/evp/e_des3.c"
                        , inl - 16);
    BUF_reverse(ctx->iv, iv, 8);

    des_ede_cbc_cipher(ctx, out, out, inl - 16);
    des_ede_cbc_cipher(ctx, icv, icv, 8);
    if (ossl_sha1(out, inl - 16, sha1tmp)
            && CRYPTO_memcmp(sha1tmp, icv, 8) == 0)
        rv = inl - 16;
    OPENSSL_cleanse(icv, 8);
    OPENSSL_cleanse(sha1tmp, 20);
                         ...
                         const unsigned char *in, size_t inl)
{
    ...
    if (out == 
# 366 "../crypto/evp/e_des3.c" 3 4
              ((void *)0)
# 366 "../crypto/evp/e_des3.c"
                  )
        return inl + 16;
    ...
    BUF_reverse(out, 
# 381 "../crypto/evp/e_des3.c" 3 4
                    ((void *)0)
# 381 "../crypto/evp/e_des3.c"
                        , inl + 16);
    memcpy(ctx->iv, wrap_iv, 8);
    des_ede_cbc_cipher(ctx, out, out, inl + 16);
    return inl + 16;
                                ...
                                const unsigned char *in, size_t inl)
{
    ...
    if (inl >= ((size_t)1 << 30) || inl % 8)
        return -1;

    if (ossl_is_partially_overlapping(out, in, inl)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/e_des3.c",399,__func__), ERR_set_error)((6),(162),
# 399 "../crypto/evp/e_des3.c" 3 4
       ((void *)0)
# 399 "../crypto/evp/e_des3.c"
       );
        return 0;
    }
...
static const EVP_CIPHER des3_wrap = {
    246,
    8, 24, 0,
    0x10002 | 0x10 | 0x100000
        | 0,
    1,
    des_ede3_init_key, des_ede3_wrap_cipher,
    
# 416 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 416 "../crypto/evp/e_des3.c"
       ,
    sizeof(DES_EDE_KEY),
    
# 418 "../crypto/evp/e_des3.c" 3 4
   ((void *)0)
# 418 "../crypto/evp/e_des3.c"
       , 
# 418 "../crypto/evp/e_des3.c" 3 4
         ((void *)0)
# 418 "../crypto/evp/e_des3.c"
