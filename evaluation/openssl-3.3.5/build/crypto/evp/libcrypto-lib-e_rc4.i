# 0 "../crypto/evp/e_rc4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_rc4.c"
# 14 "../crypto/evp/e_rc4.c"
...
# 44 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 44 "../crypto/evp/e_rc4.c"
       ,
    sizeof(EVP_RC4_KEY),
    
# 46 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 46 "../crypto/evp/e_rc4.c"
       ,
    
# 47 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 47 "../crypto/evp/e_rc4.c"
       ,
    
# 48 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 48 "../crypto/evp/e_rc4.c"
       ,
    
# 49 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)

# 50 "../crypto/evp/e_rc4.c"
};
...
# 59 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 59 "../crypto/evp/e_rc4.c"
       ,
    sizeof(EVP_RC4_KEY),
    
# 61 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 61 "../crypto/evp/e_rc4.c"
       ,
    
# 62 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 62 "../crypto/evp/e_rc4.c"
       ,
    
# 63 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)
# 63 "../crypto/evp/e_rc4.c"
       ,
    
# 64 "../crypto/evp/e_rc4.c" 3 4
   ((void *)0)

# 65 "../crypto/evp/e_rc4.c"
};
                        ...
                        const unsigned char *iv, int enc)
{
    ...
    if ((keylen = EVP_CIPHER_CTX_get_key_length(ctx)) <= 0)
        return 0;
    RC4_set_key(&((EVP_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, keylen, key);
    return 1;
}
...
static int rc4_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
                      const unsigned char *in, size_t inl)
{
    RC4(&((EVP_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, inl, in, out);
    return 1;
}
