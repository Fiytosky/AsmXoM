# 0 "../crypto/evp/kdf_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/kdf_lib.c"
# 11 "../crypto/evp/kdf_lib.c"
...
# 16 "../crypto/evp/kdf_lib.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/evp/kdf_lib.c" 2
...
# 22 "../crypto/evp/kdf_lib.c" 2

EVP_KDF_CTX *EVP_KDF_CTX_new(EVP_KDF *kdf)
{
    EVP_KDF_CTX *ctx = 
# 25 "../crypto/evp/kdf_lib.c" 3 4
                      ((void *)0)
# 25 "../crypto/evp/kdf_lib.c"
                          ;

    if (kdf == 
# 27 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 27 "../crypto/evp/kdf_lib.c"
                  )
        return 
# 28 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 28 "../crypto/evp/kdf_lib.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(EVP_KDF_CTX), "../crypto/evp/kdf_lib.c", 30);
    if (ctx == 
# 31 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
        
# 32 "../crypto/evp/kdf_lib.c"
       || (ctx->algctx = kdf->newctx(ossl_provider_ctx(kdf->prov))) == 
# 32 "../crypto/evp/kdf_lib.c" 3 4
                                                                       ((void *)0)
        
# 33 "../crypto/evp/kdf_lib.c"
       || !EVP_KDF_up_ref(kdf)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kdf_lib.c",34,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 34 "../crypto/evp/kdf_lib.c" 3 4
       ((void *)0)
# 34 "../crypto/evp/kdf_lib.c"
       );
        if (ctx != 
# 35 "../crypto/evp/kdf_lib.c" 3 4
                  ((void *)0)
# 35 "../crypto/evp/kdf_lib.c"
                      )
            kdf->freectx(ctx->algctx);
        CRYPTO_free(ctx, "../crypto/evp/kdf_lib.c", 37);
        ctx = 
# 38 "../crypto/evp/kdf_lib.c" 3 4
             ((void *)0)
# 38 "../crypto/evp/kdf_lib.c"
                 ;
    } else {
        ctx->meth = kdf;
    }
...
{
    if (ctx == 
# 47 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 47 "../crypto/evp/kdf_lib.c"
                  )
        return;
    ctx->meth->freectx(ctx->algctx);
    ctx->algctx = 
# 50 "../crypto/evp/kdf_lib.c" 3 4
                 ((void *)0)
# 50 "../crypto/evp/kdf_lib.c"
                     ;
    EVP_KDF_free(ctx->meth);
    CRYPTO_free(ctx, "../crypto/evp/kdf_lib.c", 52);
}
...
EVP_KDF_CTX *EVP_KDF_CTX_dup(const EVP_KDF_CTX *src)
{
    ...
    if (src == 
# 59 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0) 
# 59 "../crypto/evp/kdf_lib.c"
                   || src->algctx == 
# 59 "../crypto/evp/kdf_lib.c" 3 4
                                     ((void *)0) 
# 59 "../crypto/evp/kdf_lib.c"
...
# 59 "../crypto/evp/kdf_lib.c"
        ...
        return 
# 60 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 60 "../crypto/evp/kdf_lib.c"
                  ;

    dst = CRYPTO_malloc(sizeof(*dst), "../crypto/evp/kdf_lib.c", 62);
    if (dst == 
# 63 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 63 "../crypto/evp/kdf_lib.c"
                  )
        return 
# 64 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 64 "../crypto/evp/kdf_lib.c"
                  ;

    memcpy(dst, src, sizeof(*dst));
    if (!EVP_KDF_up_ref(dst->meth)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kdf_lib.c",68,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 68 "../crypto/evp/kdf_lib.c" 3 4
       ((void *)0)
# 68 "../crypto/evp/kdf_lib.c"
       );
        CRYPTO_free(dst, "../crypto/evp/kdf_lib.c", 69);
        return 
# 70 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 70 "../crypto/evp/kdf_lib.c"
                  ;
    }

    dst->algctx = src->meth->dupctx(src->algctx);
    if (dst->algctx == 
# 74 "../crypto/evp/kdf_lib.c" 3 4
                      ((void *)0)
# 74 "../crypto/evp/kdf_lib.c"
                          ) {
        EVP_KDF_CTX_free(dst);
        return 
# 76 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 76 "../crypto/evp/kdf_lib.c"
                  ;
    }
    return dst;
}
...
{
    return kdf != 
# 98 "../crypto/evp/kdf_lib.c" 3 4
                 ((void *)0) 
# 98 "../crypto/evp/kdf_lib.c"
                      && evp_is_a(kdf->prov, kdf->name_id, 
# 98 "../crypto/evp/kdf_lib.c" 3 4
                                                           ((void *)0)
# 98 "../crypto/evp/kdf_lib.c"
                                                               , name);
...
{
    if (ctx == 
# 113 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 113 "../crypto/evp/kdf_lib.c"
                  )
        return;

    if (ctx->meth->reset != 
# 116 "../crypto/evp/kdf_lib.c" 3 4
                           ((void *)0)
# 116 "../crypto/evp/kdf_lib.c"
                               )
...
{
    OSSL_PARAM params[2] = { { 
# 122 "../crypto/evp/kdf_lib.c" 3 4
                            ((void *)0)
# 122 "../crypto/evp/kdf_lib.c"
                            , 0, 
# 122 "../crypto/evp/kdf_lib.c" 3 4
                            ((void *)0)
# 122 "../crypto/evp/kdf_lib.c"
...
# 122 "../crypto/evp/kdf_lib.c"
    ...
    if (ctx == 
# 125 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 125 "../crypto/evp/kdf_lib.c"
                  )
        return 0;

    *params = OSSL_PARAM_construct_size_t("size", &s);
    if (ctx->meth->get_ctx_params != 
# 129 "../crypto/evp/kdf_lib.c" 3 4
                                    ((void *)0)
        
# 130 "../crypto/evp/kdf_lib.c"
       && ctx->meth->get_ctx_params(ctx->algctx, params))
            return s;
    if (ctx->meth->get_params != 
# 132 "../crypto/evp/kdf_lib.c" 3 4
                                ((void *)0)
        
# 133 "../crypto/evp/kdf_lib.c"
...
{
    if (ctx == 
# 141 "../crypto/evp/kdf_lib.c" 3 4
              ((void *)0)
# 141 "../crypto/evp/kdf_lib.c"
                  )
        return 0;
...
{
    if (kdf->get_params != 
# 155 "../crypto/evp/kdf_lib.c" 3 4
                          ((void *)0)
# 155 "../crypto/evp/kdf_lib.c"
                              )
...
{
    if (ctx->meth->get_ctx_params != 
# 162 "../crypto/evp/kdf_lib.c" 3 4
                                    ((void *)0)
# 162 "../crypto/evp/kdf_lib.c"
                                        )
...
# 169 "../crypto/evp/kdf_lib.c" 3 4
                                    ((void *)0)
# 169 "../crypto/evp/kdf_lib.c"
                                        )
...
{
    if (kdf->prov != 
# 178 "../crypto/evp/kdf_lib.c" 3 4
                    ((void *)0)
# 178 "../crypto/evp/kdf_lib.c"
                        )
