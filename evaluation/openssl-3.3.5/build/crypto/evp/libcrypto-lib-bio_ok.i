# 0 "../crypto/evp/bio_ok.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/bio_ok.c"
# 71 "../crypto/evp/bio_ok.c"
...
# 73 "../crypto/evp/bio_ok.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 74 "../crypto/evp/bio_ok.c" 2
...
typedef struct ok_struct {
    ...
    int blockout;
    int sigio;
    unsigned char buf[((1024*4)+ 4 + 3*64)];
} BIO_OK_CTX;
...
# 118 "../crypto/evp/bio_ok.c" 3 4
   ((void *)0)
# 118 "../crypto/evp/bio_ok.c"
       ,
    
# 119 "../crypto/evp/bio_ok.c" 3 4
   ((void *)0)
# 119 "../crypto/evp/bio_ok.c"
       ,
    ok_ctrl,
    ok_new,
    ok_free,
...
static int ok_new(BIO *bi)
{
    ...
    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/evp/bio_ok.c", 135)) == 
# 135 "../crypto/evp/bio_ok.c" 3 4
                                               ((void *)0)
# 135 "../crypto/evp/bio_ok.c"
                                                   )
        return 0;
    ...
    if (ctx->md == 
# 141 "../crypto/evp/bio_ok.c" 3 4
                  ((void *)0)
# 141 "../crypto/evp/bio_ok.c"
                      ) {
        CRYPTO_free(ctx, "../crypto/evp/bio_ok.c", 142);
        return 0;
    }
    BIO_set_init(bi, 0);
    BIO_set_data(bi, ctx);
...
static int ok_free(BIO *a)
{
    ...
    if (a == 
# 155 "../crypto/evp/bio_ok.c" 3 4
            ((void *)0)
# 155 "../crypto/evp/bio_ok.c"
                )
        return 0;
    ...
    CRYPTO_clear_free(ctx, sizeof(BIO_OK_CTX), "../crypto/evp/bio_ok.c", 161);
    BIO_set_data(a, 
# 162 "../crypto/evp/bio_ok.c" 3 4
                   ((void *)0)
# 162 "../crypto/evp/bio_ok.c"
                       );
    BIO_set_init(a, 0);
...
static int ok_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 174 "../crypto/evp/bio_ok.c" 3 4
              ((void *)0)
# 174 "../crypto/evp/bio_ok.c"
                  )
        return 0;
    ...
    if ((ctx == 
# 180 "../crypto/evp/bio_ok.c" 3 4
               ((void *)0)
# 180 "../crypto/evp/bio_ok.c"
                   ) || (next == 
# 180 "../crypto/evp/bio_ok.c" 3 4
                                 ((void *)0)
# 180 "../crypto/evp/bio_ok.c"
...
static int ok_write(BIO *b, const char *in, int inl)
{
    ...
    if ((ctx == 
# 267 "../crypto/evp/bio_ok.c" 3 4
               ((void *)0)
# 267 "../crypto/evp/bio_ok.c"
                   ) || (next == 
# 267 "../crypto/evp/bio_ok.c" 3 4
                                 ((void *)0)
# 267 "../crypto/evp/bio_ok.c"
    ...
    do {
        ...
        if ((in == 
# 295 "../crypto/evp/bio_ok.c" 3 4
                  ((void *)0)
# 295 "../crypto/evp/bio_ok.c"
                      ) || (inl <= 0))
            return 0;

        n = (inl + ctx->buf_len > (1024*4) + 4) ?
            (int)((1024*4) + 4 - ctx->buf_len) : inl;
...
static long ok_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 11:
        ...
        while (ctx->blockout) {
            i = ok_write(b, 
# 362 "../crypto/evp/bio_ok.c" 3 4
                           ((void *)0)
# 362 "../crypto/evp/bio_ok.c"
                               , 0);
            if (i < 0) {
                ret = i;
                break;
    ...
    case 111:
        md = ptr;
        if (!EVP_DigestInit_ex(ctx->md, md, 
# 387 "../crypto/evp/bio_ok.c" 3 4
                                           ((void *)0)
# 387 "../crypto/evp/bio_ok.c"
                                               ))
            return 0;
        BIO_set_init(b, 1);
        break;
...
static long ok_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    ...
    if (next == 
# 411 "../crypto/evp/bio_ok.c" 3 4
               ((void *)0)
# 411 "../crypto/evp/bio_ok.c"
                   )
        return 0;
...
static int sig_out(BIO *b)
{
    ...
    if (ctx->buf_len + 2 * md_size > (1024*4))
        return 1;

    if (!EVP_DigestInit_ex(md, digest, 
# 449 "../crypto/evp/bio_ok.c" 3 4
                                      ((void *)0)
# 449 "../crypto/evp/bio_ok.c"
                                          ))
        goto berr;
    ...
    if (!EVP_DigestUpdate(md, "The quick brown fox jumped over the lazy dog's back.", strlen("The quick brown fox jumped over the lazy dog's back.")))
        goto berr;
    if (!EVP_DigestFinal_ex(md, &(ctx->buf[ctx->buf_len]), 
# 463 "../crypto/evp/bio_ok.c" 3 4
                                                          ((void *)0)
# 463 "../crypto/evp/bio_ok.c"
                                                              ))
        goto berr;
    ctx->buf_len += md_size;
    ctx->blockout = 1;
...
static int sig_in(BIO *b)
{
    ...
    ctx = BIO_get_data(b);
    if ((md = ctx->md) == 
# 485 "../crypto/evp/bio_ok.c" 3 4
                         ((void *)0)
# 485 "../crypto/evp/bio_ok.c"
                             )
        goto berr;
    digest = EVP_MD_CTX_get0_md(md);
    ...
    if (!EVP_DigestInit_ex(md, digest, 
# 495 "../crypto/evp/bio_ok.c" 3 4
                                      ((void *)0)
# 495 "../crypto/evp/bio_ok.c"
                                          ))
        goto berr;
    ...
    if (!EVP_DigestUpdate(md, "The quick brown fox jumped over the lazy dog's back.", strlen("The quick brown fox jumped over the lazy dog's back.")))
        goto berr;
    if (!EVP_DigestFinal_ex(md, tmp, 
# 503 "../crypto/evp/bio_ok.c" 3 4
                                    ((void *)0)
# 503 "../crypto/evp/bio_ok.c"
                                        ))
        goto berr;
...
static int block_out(BIO *b)
{
    ...
    if (!EVP_DigestUpdate(md,
                          (unsigned char *)&(ctx->buf[4]), tl))
        goto berr;
    if (!EVP_DigestFinal_ex(md, &(ctx->buf[ctx->buf_len]), 
# 545 "../crypto/evp/bio_ok.c" 3 4
                                                          ((void *)0)
# 545 "../crypto/evp/bio_ok.c"
                                                              ))
        goto berr;
    ctx->buf_len += md_size;
    ctx->blockout = 1;
...
# 569 "../crypto/evp/bio_ok.c" 3 4
   ((void) (0))
# 569 "../crypto/evp/bio_ok.c"
                                       ;
    ...
    if (tl > 
# 578 "../crypto/evp/bio_ok.c" 3 4
            (18446744073709551615UL) 
# 578 "../crypto/evp/bio_ok.c"
                     - 4 - (size_t)md_size)
        goto berr;

    if (ctx->buf_len < tl + 4 + (size_t)md_size)
        return 1;
    ...
    if (!EVP_DigestUpdate(md,
        ...
        goto berr;
    if (!EVP_DigestFinal_ex(md, tmp, 
# 587 "../crypto/evp/bio_ok.c" 3 4
                                    ((void *)0)
# 587 "../crypto/evp/bio_ok.c"
                                        ))
        goto berr;
    if (memcmp(&(ctx->buf[tl + 4]), tmp, (size_t)md_size) == 0) {

        ctx->buf_off_save = tl + 4 + md_size;
