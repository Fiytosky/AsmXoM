# 0 "../crypto/evp/p_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_enc.c"
# 13 "../crypto/evp/p_enc.c"
                         ...
                         int key_len, EVP_PKEY *pubk)
{
    int ret = 0;
    RSA *rsa = 
# 25 "../crypto/evp/p_enc.c" 3 4
              ((void *)0)
# 25 "../crypto/evp/p_enc.c"
                  ;

    if (EVP_PKEY_get_id(pubk) != 6) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_enc.c",28,__func__), ERR_set_error)((6),(106),
# 28 "../crypto/evp/p_enc.c" 3 4
       ((void *)0)
# 28 "../crypto/evp/p_enc.c"
       );
        goto err;
    }
    ...
    if (rsa == 
# 33 "../crypto/evp/p_enc.c" 3 4
              ((void *)0)
# 33 "../crypto/evp/p_enc.c"
                  )
        goto err;

    ret =
        RSA_public_encrypt(key_len, key, ek, rsa, 1);
 err:
    return ret;
}
