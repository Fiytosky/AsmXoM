# 0 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
# 15 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
...
# 16 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 18 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 19 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 21 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 23 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 24 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
int RAND_poll(void);
# 25 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 26 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 27 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 28 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 29 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 30 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 2
...
# 49 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                        ...
                                        const unsigned char *iv, int enc)
{
    ...
    if (keylen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/e_aes_cbc_hmac_sha1.c",78,__func__), ERR_set_error)((6),(130),
# 78 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
       ((void *)0)
# 78 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
       );
        return 0;
    }
    if (enc)
...
# 102 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
...
# 142 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
typedef struct {
...
# 266 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
    ...
    for (i = 0; i < x4; i++) {
        ...
        ctx->E[i] = key->tail.h4;
        blocks[i].c[20] = 0x80;
        blocks[i].d[15] = ({ u32 ret_=((64 + 20) * 8); asm ("bswapl %0" : "+r"(ret_)); ret_; });
# 355 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
        edges[i].ptr = blocks[i].c;
        edges[i].blocks = 1;
    }
...
# 508 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            if ((key->aux.tls_aad[plen - 4] << 8 | key->aux.tls_aad[plen - 3])
                ...
                return 0;
# 534 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
...
# 586 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            len -= 20;
            if (len >= (256 + (16*4))) {
...
# 608 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            pmac->u[0] = 0;
            pmac->u[1] = 0;
            pmac->u[2] = 0;
            pmac->u[3] = 0;
...
# 678 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            len += 20;
# 699 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            key->md = key->tail;
            ...
            {
                unsigned char *p = out + len - 1 - maxpad - 20;
                size_t off = out - p;
                unsigned int c, cmask;

                for (res = 0, i = 0, j = 0; j < maxpad + 20; j++) {
                    c = p[j];
                    cmask =
                        ((int)(j - off - 20)) >> (sizeof(int) *
                                                                 8 - 1);
                    res |= (c ^ pad) & ~cmask;
...
# 741 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
            return ret;
        } else {
# 768 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                aesni_cbc_encrypt(in, out, len, &key->ks,
                                  ctx->iv, 0);
...
# 927 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
   ((void *)0)
# 927 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
       ,
    sizeof(EVP_AES_HMAC_SHA1),
    0 ? 
# 929 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                ((void *)0) 
# 929 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                     : EVP_CIPHER_set_asn1_iv,
    0 ? 
# 930 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                ((void *)0) 
# 930 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                     : EVP_CIPHER_get_asn1_iv,
    aesni_cbc_hmac_sha1_ctrl,
    
# 932 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
   ((void *)0)

# 933 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
};
...
# 947 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
   ((void *)0)
# 947 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
       ,
    sizeof(EVP_AES_HMAC_SHA1),
    0 ? 
# 949 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                ((void *)0) 
# 949 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                     : EVP_CIPHER_set_asn1_iv,
    0 ? 
# 950 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                ((void *)0) 
# 950 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                     : EVP_CIPHER_get_asn1_iv,
    aesni_cbc_hmac_sha1_ctrl,
    
# 952 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
   ((void *)0)

# 953 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
};
...
# 958 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                             ((void *)0)
# 958 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                                 );
}
...
# 964 "../crypto/evp/e_aes_cbc_hmac_sha1.c" 3 4
                                             ((void *)0)
# 964 "../crypto/evp/e_aes_cbc_hmac_sha1.c"
                                                 );
}
