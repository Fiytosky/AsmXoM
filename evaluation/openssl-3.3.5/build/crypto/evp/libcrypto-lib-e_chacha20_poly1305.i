# 0 "../crypto/evp/e_chacha20_poly1305.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_chacha20_poly1305.c"
# 10 "../crypto/evp/e_chacha20_poly1305.c"
...
# 11 "../crypto/evp/e_chacha20_poly1305.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/evp/e_chacha20_poly1305.c" 2
# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 13 "../crypto/evp/e_chacha20_poly1305.c" 2
...
# 17 "../crypto/evp/e_chacha20_poly1305.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 19 "../crypto/evp/e_chacha20_poly1305.c" 2
...
# 20 "../crypto/evp/e_chacha20_poly1305.c" 2
# 1 "../include/crypto/chacha.h" 1
# 12 "../include/crypto/chacha.h"
        

# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 15 "../include/crypto/chacha.h" 2
# 27 "../include/crypto/chacha.h"
void ChaCha20_ctr32(unsigned char *out, const unsigned char *inp,
                    size_t len, const unsigned int key[8],
                    const unsigned int counter[4]);
# 21 "../crypto/evp/e_chacha20_poly1305.c" 2
...
static int chacha_init_key(EVP_CIPHER_CTX *ctx,
                           const unsigned char user_key[32],
                           const unsigned char iv[16], int enc)
{
    EVP_CHACHA_KEY *key = ((EVP_CHACHA_KEY *)(ctx)->cipher_data);
    unsigned int i;
                         ...
                         const unsigned char *inp, size_t len)
{
    ...
    if (rem) {
        ...
        ChaCha20_ctr32(key->buf, key->buf, 64,
...
# 137 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 137 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    sizeof(EVP_CHACHA_KEY),
    
# 139 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 139 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    
# 140 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 140 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    
# 141 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 141 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    
# 142 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)

# 143 "../crypto/evp/e_chacha20_poly1305.c"
};
...
# 1 "../include/crypto/poly1305.h" 1
# 12 "../include/crypto/poly1305.h"
        

# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 15 "../include/crypto/poly1305.h" 2
...
# 152 "../crypto/evp/e_chacha20_poly1305.c" 2
...
static int chacha20_poly1305_init_key(EVP_CIPHER_CTX *ctx,
                                      ...
                                      const unsigned char *iv, int enc)
{
    EVP_CHACHA_AEAD_CTX *actx = ((EVP_CHACHA_AEAD_CTX *)(ctx)->cipher_data);
    ...
    actx->aad = 0;
    actx->mac_inited = 0;
    actx->tls_payload_length = ((size_t)-1);

    if (iv != 
# 182 "../crypto/evp/e_chacha20_poly1305.c" 3 4
             ((void *)0)
# 182 "../crypto/evp/e_chacha20_poly1305.c"
                 ) {
        unsigned char temp[16] = { 0 };


        if (actx->nonce_len <= 16)
            memcpy(temp + 16 - actx->nonce_len, iv,
                   actx->nonce_len);
        ...
        chacha_init_key(ctx, inkey, 
# 196 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                                   ((void *)0)
# 196 "../crypto/evp/e_chacha20_poly1305.c"
                                       , enc);
    }
...
static const unsigned char zero[4 * 64] = { 0 };
                                        ...
                                        const unsigned char *in, size_t len)
{
    ...
    buf = storage + ((0 - (size_t)storage) & 15);
    ctr = buf + 64;
    tohash = buf + 64 - 16;
    ...
    if (plen <= 3 * 64) {
        ...
        buf_len = (plen + 2 * 64 - 1) & (0 - 64);
        ChaCha20_ctr32(buf, zero, buf_len, actx->key.key.d,
                       actx->key.counter);
        Poly1305_Init(((POLY1305 *)(actx + 1)), buf);
        actx->key.partial_len = 0;
        memcpy(tohash, actx->tls_aad, 16);
        tohash_len = 16;
        actx->len.aad = 13;
        actx->len.text = plen;
...
# 287 "../crypto/evp/e_chacha20_poly1305.c"
    else {
        actx->key.counter[0] = 0;
        ChaCha20_ctr32(buf, zero, (buf_len = 64),
                       actx->key.key.d, actx->key.counter);
        Poly1305_Init(((POLY1305 *)(actx + 1)), buf);
        actx->key.counter[0] = 1;
        actx->key.partial_len = 0;
        Poly1305_Update(((POLY1305 *)(actx + 1)), actx->tls_aad, 16);
        tohash = ctr;
        tohash_len = 0;
        actx->len.aad = 13;
        actx->len.text = plen;
        ...
        if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
            ...
            Poly1305_Update(((POLY1305 *)(actx + 1)), out, plen);
        } else {
            Poly1305_Update(((POLY1305 *)(actx + 1)), in, plen);
            ChaCha20_ctr32(out, in, plen, actx->key.key.d, actx->key.counter);
        }
        ...
        out += plen;
        tail = (0 - plen) & (16 - 1);
        Poly1305_Update(((POLY1305 *)(actx + 1)), zero, tail);
    }

    {
        ...
        if ((ossl_is_little_endian)) {
            memcpy(ctr, (unsigned char *)&actx->len, 16);
        } else {
    ...
    Poly1305_Update(((POLY1305 *)(actx + 1)), tohash, tohash_len);
    OPENSSL_cleanse(buf, buf_len);
    Poly1305_Final(((POLY1305 *)(actx + 1)),
                   EVP_CIPHER_CTX_is_encrypting(ctx) ? actx->tag : tohash);

    actx->tls_payload_length = ((size_t)-1);

    if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
        memcpy(out, actx->tag, 16);
    } else {
        if (CRYPTO_memcmp(tohash, in, 16)) {
            memset(out - (len - 16), 0,
                   len - 16);
            return -1;
        }
                                    ...
                                    const unsigned char *in, size_t len)
{
    ...
    if (!actx->mac_inited) {
        ...
        if (plen != ((size_t)-1) && out != 
# 372 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                                                   ((void *)0)
# 372 "../crypto/evp/e_chacha20_poly1305.c"
                                                       )
            return chacha20_poly1305_tls_cipher(ctx, out, in, len);

        actx->key.counter[0] = 0;
        ChaCha20_ctr32(actx->key.buf, zero, 64,
                       actx->key.key.d, actx->key.counter);
        Poly1305_Init(((POLY1305 *)(actx + 1)), actx->key.buf);
        actx->key.counter[0] = 1;
        actx->key.partial_len = 0;
        actx->len.aad = actx->len.text = 0;
        actx->mac_inited = 1;
        if (plen != ((size_t)-1)) {
            Poly1305_Update(((POLY1305 *)(actx + 1)), actx->tls_aad,
                            13);
            actx->len.aad = 13;
            actx->aad = 1;
        }
    ...
    if (in) {
        if (out == 
# 392 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                  ((void *)0)
# 392 "../crypto/evp/e_chacha20_poly1305.c"
                      ) {
            Poly1305_Update(((POLY1305 *)(actx + 1)), in, len);
            actx->len.aad += len;
            actx->aad = 1;
            return len;
        } else {
            if (actx->aad) {
                if ((rem = (size_t)actx->len.aad % 16))
                    Poly1305_Update(((POLY1305 *)(actx + 1)), zero,
                                    16 - rem);
                actx->aad = 0;
            }
    ...
    if (in == 
# 426 "../crypto/evp/e_chacha20_poly1305.c" 3 4
             ((void *)0)
        
# 427 "../crypto/evp/e_chacha20_poly1305.c"
       || plen != len) {
        const int ossl_is_little_endian = 1234 == 1234;
        ...
        if ((rem = (size_t)actx->len.text % 16))
            Poly1305_Update(((POLY1305 *)(actx + 1)), zero,
                            16 - rem);

        if ((ossl_is_little_endian)) {
            Poly1305_Update(((POLY1305 *)(actx + 1)),
                            (unsigned char *)&actx->len, 16);
        } else {
            ...
            Poly1305_Update(((POLY1305 *)(actx + 1)), temp, 16);
        }
        Poly1305_Final(((POLY1305 *)(actx + 1)),
        ...
        if (in != 
# 470 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                 ((void *)0) 
# 470 "../crypto/evp/e_chacha20_poly1305.c"
                      && len != plen) {
            if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
                memcpy(out, actx->tag, 16);
            } else {
                if (CRYPTO_memcmp(temp, in, 16)) {
                                  ...
                                  void *ptr)
{
    ...
    case 0x0:
        if (actx == 
# 503 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                   ((void *)0)
# 503 "../crypto/evp/e_chacha20_poly1305.c"
                       )
            actx = ctx->cipher_data
                 = CRYPTO_zalloc(sizeof(*actx) + Poly1305_ctx_size(), "../crypto/evp/e_chacha20_poly1305.c", 505);
        if (actx == 
# 506 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                   ((void *)0)
# 506 "../crypto/evp/e_chacha20_poly1305.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/e_chacha20_poly1305.c",507,__func__), ERR_set_error)((6),(134),
# 507 "../crypto/evp/e_chacha20_poly1305.c" 3 4
           ((void *)0)
# 507 "../crypto/evp/e_chacha20_poly1305.c"
           );
            return 0;
        }
        actx->len.aad = 0;
    ...
    case 0x8:
        if (actx) {
            ...
            dst->cipher_data =
                   CRYPTO_memdup((actx), sizeof(*actx) + Poly1305_ctx_size(), "../crypto/evp/e_chacha20_poly1305.c", 525);
            if (dst->cipher_data == 
# 526 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                                   ((void *)0)
# 526 "../crypto/evp/e_chacha20_poly1305.c"
                                       ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/e_chacha20_poly1305.c",527,__func__), ERR_set_error)((6),(173),
# 527 "../crypto/evp/e_chacha20_poly1305.c" 3 4
               ((void *)0)
# 527 "../crypto/evp/e_chacha20_poly1305.c"
               );
                return 0;
            }
        }
    ...
    case 0x12:
        if (arg != 12)
            return 0;
        actx->nonce[0] = actx->key.counter[1]
                       = ( ((unsigned int)((unsigned char *)ptr)[0]) | ((unsigned int)((unsigned char *)ptr)[1]<<8) | ((unsigned int)((unsigned char *)ptr)[2]<<16) | ((unsigned int)((unsigned char *)ptr)[3]<<24) );
        actx->nonce[1] = actx->key.counter[2]
                       = ( ((unsigned int)((unsigned char *)ptr+4)[0]) | ((unsigned int)((unsigned char *)ptr+4)[1]<<8) | ((unsigned int)((unsigned char *)ptr+4)[2]<<16) | ((unsigned int)((unsigned char *)ptr+4)[3]<<24) );
        actx->nonce[2] = actx->key.counter[3]
                       = ( ((unsigned int)((unsigned char *)ptr+8)[0]) | ((unsigned int)((unsigned char *)ptr+8)[1]<<8) | ((unsigned int)((unsigned char *)ptr+8)[2]<<16) | ((unsigned int)((unsigned char *)ptr+8)[3]<<24) );
        return 1;
    ...
    case 0x11:
        if (arg <= 0 || arg > 16)
            return 0;
        if (ptr != 
# 557 "../crypto/evp/e_chacha20_poly1305.c" 3 4
                  ((void *)0)
# 557 "../crypto/evp/e_chacha20_poly1305.c"
                      ) {
            ...
            return 0;
        {
            ...
            if (!EVP_CIPHER_CTX_is_encrypting(ctx)) {
                if (len < 16)
                    return 0;
                len -= 16;
                aad[13 - 2] = (unsigned char)(len >> 8);
                aad[13 - 1] = (unsigned char)len;
            }
            ...
            actx->key.counter[2] = actx->nonce[1] ^ ( ((unsigned int)(aad)[0]) | ((unsigned int)(aad)[1]<<8) | ((unsigned int)(aad)[2]<<16) | ((unsigned int)(aad)[3]<<24) );
            actx->key.counter[3] = actx->nonce[2] ^ ( ((unsigned int)(aad+4)[0]) | ((unsigned int)(aad+4)[1]<<8) | ((unsigned int)(aad+4)[2]<<16) | ((unsigned int)(aad+4)[3]<<24) );
            actx->mac_inited = 0;
...
# 624 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 624 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    
# 625 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)
# 625 "../crypto/evp/e_chacha20_poly1305.c"
       ,
    chacha20_poly1305_ctrl,
    
# 627 "../crypto/evp/e_chacha20_poly1305.c" 3 4
   ((void *)0)

# 628 "../crypto/evp/e_chacha20_poly1305.c"
};
