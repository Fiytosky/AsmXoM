# 0 "../crypto/evp/bio_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/bio_enc.c"
# 12 "../crypto/evp/bio_enc.c"
...
typedef struct enc_struct {
    ...
    unsigned char buf[((256) + 32) + (1024*4)];
} BIO_ENC_CTX;
...
# 51 "../crypto/evp/bio_enc.c" 3 4
   ((void *)0)
# 51 "../crypto/evp/bio_enc.c"
       ,
    
# 52 "../crypto/evp/bio_enc.c" 3 4
   ((void *)0)
# 52 "../crypto/evp/bio_enc.c"
       ,
    enc_ctrl,
    enc_new,
    enc_free,
...
static int enc_new(BIO *bi)
{
    ...
    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/evp/bio_enc.c", 68)) == 
# 68 "../crypto/evp/bio_enc.c" 3 4
                                               ((void *)0)
# 68 "../crypto/evp/bio_enc.c"
                                                   )
        return 0;

    ctx->cipher = EVP_CIPHER_CTX_new();
    if (ctx->cipher == 
# 72 "../crypto/evp/bio_enc.c" 3 4
                      ((void *)0)
# 72 "../crypto/evp/bio_enc.c"
                          ) {
        CRYPTO_free(ctx, "../crypto/evp/bio_enc.c", 73);
        return 0;
    }
    ctx->cont = 1;
    ctx->ok = 1;
    ctx->read_end = ctx->read_start = &(ctx->buf[((256) + 32)]);
    BIO_set_data(bi, ctx);
    BIO_set_init(bi, 1);
...
static int enc_free(BIO *a)
{
    ...
    if (a == 
# 89 "../crypto/evp/bio_enc.c" 3 4
            ((void *)0)
# 89 "../crypto/evp/bio_enc.c"
                )
        return 0;

    b = BIO_get_data(a);
    if (b == 
# 93 "../crypto/evp/bio_enc.c" 3 4
            ((void *)0)
# 93 "../crypto/evp/bio_enc.c"
                )
        return 0;

    EVP_CIPHER_CTX_free(b->cipher);
    CRYPTO_clear_free(b, sizeof(BIO_ENC_CTX), "../crypto/evp/bio_enc.c", 97);
    BIO_set_data(a, 
# 98 "../crypto/evp/bio_enc.c" 3 4
                   ((void *)0)
# 98 "../crypto/evp/bio_enc.c"
                       );
    BIO_set_init(a, 0);
...
static int enc_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 110 "../crypto/evp/bio_enc.c" 3 4
              ((void *)0)
# 110 "../crypto/evp/bio_enc.c"
                  )
        return 0;
    ctx = BIO_get_data(b);
    ...
    next = BIO_next(b);
    if ((ctx == 
# 115 "../crypto/evp/bio_enc.c" 3 4
               ((void *)0)
# 115 "../crypto/evp/bio_enc.c"
                   ) || (next == 
# 115 "../crypto/evp/bio_enc.c" 3 4
                                 ((void *)0)
# 115 "../crypto/evp/bio_enc.c"
    ...
    while (outl > 0) {
        ...
        if (ctx->read_start == ctx->read_end) {
            ctx->read_end = ctx->read_start = &(ctx->buf[((256) + 32)]);
            i = BIO_read(next, ctx->read_start, (1024*4));
            if (i > 0)
                ctx->read_end += i;
        } else {
...
static int enc_write(BIO *b, const char *in, int inl)
{
    ...
    next = BIO_next(b);
    if ((ctx == 
# 245 "../crypto/evp/bio_enc.c" 3 4
               ((void *)0)
# 245 "../crypto/evp/bio_enc.c"
                   ) || (next == 
# 245 "../crypto/evp/bio_enc.c" 3 4
                                 ((void *)0)
# 245 "../crypto/evp/bio_enc.c"
    ...
    if ((in == 
# 263 "../crypto/evp/bio_enc.c" 3 4
              ((void *)0)
# 263 "../crypto/evp/bio_enc.c"
                  ) || (inl <= 0))
        return 0;
...
static long enc_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    next = BIO_next(b);
    if (ctx == 
# 309 "../crypto/evp/bio_enc.c" 3 4
              ((void *)0)
# 309 "../crypto/evp/bio_enc.c"
                  )
        return 0;
...
# 316 "../crypto/evp/bio_enc.c" 3 4
                                           ((void *)0)
# 316 "../crypto/evp/bio_enc.c"
                                               , 
# 316 "../crypto/evp/bio_enc.c" 3 4
                                                 ((void *)0)
# 316 "../crypto/evp/bio_enc.c"
...
# 316 "../crypto/evp/bio_enc.c"
 ...
 again:
        while (ctx->buf_len != ctx->buf_off) {
            ...
            i = enc_write(b, 
# 342 "../crypto/evp/bio_enc.c" 3 4
                            ((void *)0)
# 342 "../crypto/evp/bio_enc.c"
                                , 0);
    ...
    case 12:
        ...
        if (dctx->cipher == 
# 387 "../crypto/evp/bio_enc.c" 3 4
                           ((void *)0)
# 387 "../crypto/evp/bio_enc.c"
                               )
            return 0;
...
static long enc_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    ...
    if (next == 
# 404 "../crypto/evp/bio_enc.c" 3 4
               ((void *)0)
# 404 "../crypto/evp/bio_enc.c"
                   )
        return 0;
...
# 416 "../crypto/evp/bio_enc.c" 3 4
                                                                            ((void *)0)
# 416 "../crypto/evp/bio_enc.c"
                                                                                ;


    ctx = BIO_get_data(b);
    if (ctx == 
# 420 "../crypto/evp/bio_enc.c" 3 4
              ((void *)0)
# 420 "../crypto/evp/bio_enc.c"
                  )
        return 0;

    if ((callback_ex = BIO_get_callback_ex(b)) != 
# 423 "../crypto/evp/bio_enc.c" 3 4
                                                 ((void *)0)
# 423 "../crypto/evp/bio_enc.c"
                                                     ) {
        if (callback_ex(b, 0x06, (const char *)c, 0, 4,
                        e, 1, 
# 425 "../crypto/evp/bio_enc.c" 3 4
                             ((void *)0)
# 425 "../crypto/evp/bio_enc.c"
                                 ) <= 0)
            return 0;
    }
        ...
        if ((callback != 
# 432 "../crypto/evp/bio_enc.c" 3 4
                        ((void *)0)
# 432 "../crypto/evp/bio_enc.c"
                            ) &&
    ...
    if (!EVP_CipherInit_ex(ctx->cipher, c, 
# 441 "../crypto/evp/bio_enc.c" 3 4
                                          ((void *)0)
# 441 "../crypto/evp/bio_enc.c"
                                              , k, i, e))
        return 0;

    if (callback_ex != 
# 444 "../crypto/evp/bio_enc.c" 3 4
                      ((void *)0)
# 444 "../crypto/evp/bio_enc.c"
                          )
        return callback_ex(b, 0x06 | 0x80, (const char *)c, 0,
                           4, e, 1, 
# 446 "../crypto/evp/bio_enc.c" 3 4
                                              ((void *)0)
# 446 "../crypto/evp/bio_enc.c"
                                                  );

    else if (callback != 
# 448 "../crypto/evp/bio_enc.c" 3 4
                        ((void *)0)
# 448 "../crypto/evp/bio_enc.c"
                            )
        return callback(b, 0x06, (const char *)c, 4, e, 1L);
