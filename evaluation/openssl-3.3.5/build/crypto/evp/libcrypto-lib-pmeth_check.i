# 0 "../crypto/evp/pmeth_check.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/pmeth_check.c"
# 10 "../crypto/evp/pmeth_check.c"
...
static int try_provided_check(EVP_PKEY_CTX *ctx, int selection, int checktype)
{
    ...
    if (((ctx)->keymgmt == 
# 33 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 33 "../crypto/evp/pmeth_check.c"
       ))
        return -1;
    ...
    if (keydata == 
# 39 "../crypto/evp/pmeth_check.c" 3 4
                  ((void *)0)
# 39 "../crypto/evp/pmeth_check.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",40,__func__), ERR_set_error)((6),(134),
# 40 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 40 "../crypto/evp/pmeth_check.c"
       );
        return 0;
    }
...
static int evp_pkey_public_check_combined(EVP_PKEY_CTX *ctx, int checktype)
{
    ...
    if (pkey == 
# 52 "../crypto/evp/pmeth_check.c" 3 4
               ((void *)0)
# 52 "../crypto/evp/pmeth_check.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",53,__func__), ERR_set_error)((6),(154),
# 53 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 53 "../crypto/evp/pmeth_check.c"
       );
        return 0;
    }

    if ((ok = try_provided_check(ctx, 0x02,
                                 checktype)) != -1)
        return ok;
    ...
    if (ctx->pmeth->public_check != 
# 67 "../crypto/evp/pmeth_check.c" 3 4
                                   ((void *)0)
# 67 "../crypto/evp/pmeth_check.c"
                                       )
        return ctx->pmeth->public_check(pkey);


    if (pkey->ameth == 
# 71 "../crypto/evp/pmeth_check.c" 3 4
                      ((void *)0) 
# 71 "../crypto/evp/pmeth_check.c"
                           || pkey->ameth->pkey_public_check == 
# 71 "../crypto/evp/pmeth_check.c" 3 4
                                                                ((void *)0)
# 71 "../crypto/evp/pmeth_check.c"
                                                                    )
 ...
 not_supported:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",77,__func__), ERR_set_error)((6),(150),
# 77 "../crypto/evp/pmeth_check.c" 3 4
   ((void *)0)
# 77 "../crypto/evp/pmeth_check.c"
   );
    return -2;
}
...
int EVP_PKEY_public_check(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_public_check_combined(ctx, 0);
}

int EVP_PKEY_public_check_quick(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_public_check_combined(ctx, 1);
}
...
static int evp_pkey_param_check_combined(EVP_PKEY_CTX *ctx, int checktype)
{
    ...
    if (pkey == 
# 96 "../crypto/evp/pmeth_check.c" 3 4
               ((void *)0)
# 96 "../crypto/evp/pmeth_check.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",97,__func__), ERR_set_error)((6),(154),
# 97 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 97 "../crypto/evp/pmeth_check.c"
       );
        return 0;
    }
    ...
    if (ctx->pmeth->param_check != 
# 112 "../crypto/evp/pmeth_check.c" 3 4
                                  ((void *)0)
# 112 "../crypto/evp/pmeth_check.c"
                                      )
        return ctx->pmeth->param_check(pkey);


    if (pkey->ameth == 
# 116 "../crypto/evp/pmeth_check.c" 3 4
                      ((void *)0) 
# 116 "../crypto/evp/pmeth_check.c"
                           || pkey->ameth->pkey_param_check == 
# 116 "../crypto/evp/pmeth_check.c" 3 4
                                                               ((void *)0)
# 116 "../crypto/evp/pmeth_check.c"
                                                                   )
 ...
 not_supported:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",122,__func__), ERR_set_error)((6),(150),
# 122 "../crypto/evp/pmeth_check.c" 3 4
   ((void *)0)
# 122 "../crypto/evp/pmeth_check.c"
   );
    return -2;
}
...
int EVP_PKEY_param_check(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_param_check_combined(ctx, 0);
}

int EVP_PKEY_param_check_quick(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_param_check_combined(ctx, 1);
}
...
int EVP_PKEY_private_check(EVP_PKEY_CTX *ctx)
{
    ...
    if (pkey == 
# 141 "../crypto/evp/pmeth_check.c" 3 4
               ((void *)0)
# 141 "../crypto/evp/pmeth_check.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",142,__func__), ERR_set_error)((6),(154),
# 142 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 142 "../crypto/evp/pmeth_check.c"
       );
        return 0;
    }

    if ((ok = try_provided_check(ctx, 0x01,
                                 0)) != -1)
        return ok;


    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",151,__func__), ERR_set_error)((6),(150),
# 151 "../crypto/evp/pmeth_check.c" 3 4
   ((void *)0)
# 151 "../crypto/evp/pmeth_check.c"
   );
    return -2;
}
...
int EVP_PKEY_pairwise_check(EVP_PKEY_CTX *ctx)
{
    ...
    if (pkey == 
# 165 "../crypto/evp/pmeth_check.c" 3 4
               ((void *)0)
# 165 "../crypto/evp/pmeth_check.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",166,__func__), ERR_set_error)((6),(154),
# 166 "../crypto/evp/pmeth_check.c" 3 4
       ((void *)0)
# 166 "../crypto/evp/pmeth_check.c"
       );
        return 0;
    }

    if ((ok = try_provided_check(ctx, ( 0x01 | 0x02 ),
                                 0)) != -1)
        return ok;
    ...
    if (ctx->pmeth->check != 
# 180 "../crypto/evp/pmeth_check.c" 3 4
                            ((void *)0)
# 180 "../crypto/evp/pmeth_check.c"
                                )
        return ctx->pmeth->check(pkey);


    if (pkey->ameth == 
# 184 "../crypto/evp/pmeth_check.c" 3 4
                      ((void *)0) 
# 184 "../crypto/evp/pmeth_check.c"
                           || pkey->ameth->pkey_check == 
# 184 "../crypto/evp/pmeth_check.c" 3 4
                                                         ((void *)0)
# 184 "../crypto/evp/pmeth_check.c"
                                                             )
 ...
 not_supported:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_check.c",190,__func__), ERR_set_error)((6),(150),
# 190 "../crypto/evp/pmeth_check.c" 3 4
   ((void *)0)
# 190 "../crypto/evp/pmeth_check.c"
   );
    return -2;
}
