                        ...
                        const OSSL_PARAM params[], EVP_PKEY *authkey)
{
    int ret = 0;
    EVP_KEM *kem = 
# 24 "../crypto/evp/kem.c" 3 4
                  ((void *)0)
# 24 "../crypto/evp/kem.c"
                      ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 25 "../crypto/evp/kem.c" 3 4
                              ((void *)0)
# 25 "../crypto/evp/kem.c"
                                  ;
    const OSSL_PROVIDER *tmp_prov = 
# 26 "../crypto/evp/kem.c" 3 4
                                   ((void *)0)
# 26 "../crypto/evp/kem.c"
                                       ;
    void *provkey = 
# 27 "../crypto/evp/kem.c" 3 4
                   ((void *)0)
# 27 "../crypto/evp/kem.c"
                       , *provauthkey = 
# 27 "../crypto/evp/kem.c" 3 4
...
# 27 "../crypto/evp/kem.c"
                                            ;
    const char *supported_kem = 
# 28 "../crypto/evp/kem.c" 3 4
                               ((void *)0)
# 28 "../crypto/evp/kem.c"
                                   ;
    int iter;
...
# 31 "../crypto/evp/kem.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",32,__func__), ERR_set_error)((6),(134),
# 32 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 32 "../crypto/evp/kem.c"
       );
        return 0;
    ...
    if (ctx->pkey == 
# 39 "../crypto/evp/kem.c" 3 4
                    ((void *)0)
# 39 "../crypto/evp/kem.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",40,__func__), ERR_set_error)((6),(154),
# 40 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 40 "../crypto/evp/kem.c"
       );
        goto err;
    ...
    if (authkey != 
# 43 "../crypto/evp/kem.c" 3 4
                  ((void *)0) 
# 43 "../crypto/evp/kem.c"
                       && authkey->type != ctx->pkey->type) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",44,__func__), ERR_set_error)((6),(101),
# 44 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 44 "../crypto/evp/kem.c"
       );
        return 0;
...
# 50 "../crypto/evp/kem.c" 3 4
        ((void *)0) 
# 50 "../crypto/evp/kem.c"
        || ctx->pkey->keymgmt == ctx->keymgmt) != 0), 1)
                                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",52,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 52 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 52 "../crypto/evp/kem.c"
       );
        goto err;
    ...
    supported_kem = evp_keymgmt_util_query_operation_name(ctx->keymgmt,
                                                          14);
    if (supported_kem == 
# 57 "../crypto/evp/kem.c" 3 4
                        ((void *)0)
# 57 "../crypto/evp/kem.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",58,__func__), ERR_set_error)((6),(134),
# 58 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 58 "../crypto/evp/kem.c"
       );
        goto err;
...
# 95 "../crypto/evp/kem.c"
        ...
        case 2:
            ...
            if (kem == 
# 103 "../crypto/evp/kem.c" 3 4
                      ((void *)0)
# 103 "../crypto/evp/kem.c"
                          ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",104,__func__), ERR_set_error)((6),(150),
# 104 "../crypto/evp/kem.c" 3 4
               ((void *)0)
# 104 "../crypto/evp/kem.c"
               )
                                                                         ;
                ret = -2;
                goto err;
        ...
        if (kem == 
# 110 "../crypto/evp/kem.c" 3 4
                  ((void *)0)
# 110 "../crypto/evp/kem.c"
                      )
            continue;
# 122 "../crypto/evp/kem.c"
        tmp_keymgmt_tofree = tmp_keymgmt =
            evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)tmp_prov,
                                        EVP_KEYMGMT_get0_name(ctx->keymgmt),
                                        ctx->propquery);
        if (tmp_keymgmt != 
# 126 "../crypto/evp/kem.c" 3 4
                          ((void *)0)
# 126 "../crypto/evp/kem.c"
                              ) {
            provkey = evp_pkey_export_to_provider(ctx->pkey, ctx->libctx,
                                                  &tmp_keymgmt, ctx->propquery);
            if (provkey != 
# 129 "../crypto/evp/kem.c" 3 4
                          ((void *)0) 
# 129 "../crypto/evp/kem.c"
                               && authkey != 
# 129 "../crypto/evp/kem.c" 3 4
                                             ((void *)0)
# 129 "../crypto/evp/kem.c"
                ...
                provauthkey = evp_pkey_export_to_provider(authkey, ctx->libctx,
                                                          ...
                                                          ctx->propquery);
                if (provauthkey == 
# 133 "../crypto/evp/kem.c" 3 4
                                  ((void *)0)
# 133 "../crypto/evp/kem.c"
                                      ) {
                    EVP_KEM_free(kem);
                    (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",135,__func__), ERR_set_error)((6),(134),
# 135 "../crypto/evp/kem.c" 3 4
                   ((void *)0)
# 135 "../crypto/evp/kem.c"
                   );
                    goto err;
                }
            }
        ...
        if (tmp_keymgmt == 
# 140 "../crypto/evp/kem.c" 3 4
                          ((void *)0)
# 140 "../crypto/evp/kem.c"
                              )
            EVP_KEYMGMT_free(tmp_keymgmt_tofree);
    }

    if (provkey == 
# 144 "../crypto/evp/kem.c" 3 4
                  ((void *)0)
# 144 "../crypto/evp/kem.c"
                      ) {
        EVP_KEM_free(kem);
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",146,__func__), ERR_set_error)((6),(134),
# 146 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 146 "../crypto/evp/kem.c"
       );
        goto err;
    }
...
# 152 "../crypto/evp/kem.c" 3 4
                               ((void *)0)
# 152 "../crypto/evp/kem.c"
                                   ) {

        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",154,__func__), ERR_set_error)((6),(134),
# 154 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 154 "../crypto/evp/kem.c"
       );
        goto err;
    }
    ...
    case (1<<12):
        if (provauthkey != 
# 160 "../crypto/evp/kem.c" 3 4
                          ((void *)0) 
# 160 "../crypto/evp/kem.c"
...
# 163 "../crypto/evp/kem.c" 3 4
                                 ((void *)0) 
# 163 "../crypto/evp/kem.c"
...
# 163 "../crypto/evp/kem.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",166,__func__), ERR_set_error)((6),(150),
# 166 "../crypto/evp/kem.c" 3 4
           ((void *)0)
# 166 "../crypto/evp/kem.c"
           );
            ret = -2;
            goto err;
        }
    ...
    case (1<<13):
        if (provauthkey != 
# 172 "../crypto/evp/kem.c" 3 4
                          ((void *)0) 
# 172 "../crypto/evp/kem.c"
...
# 175 "../crypto/evp/kem.c" 3 4
                                 ((void *)0) 
# 175 "../crypto/evp/kem.c"
                                      && kem->encapsulate_init != 
# 175 "../crypto/evp/kem.c" 3 4
                                                                  ((void *)0)
# 175 "../crypto/evp/kem.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",178,__func__), ERR_set_error)((6),(150),
# 178 "../crypto/evp/kem.c" 3 4
           ((void *)0)
# 178 "../crypto/evp/kem.c"
           );
            ret = -2;
            goto err;
        }
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",184,__func__), ERR_set_error)((6),(134),
# 184 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 184 "../crypto/evp/kem.c"
       );
        goto err;
    }
    ...
    EVP_KEYMGMT_free(tmp_keymgmt);
    tmp_keymgmt = 
# 189 "../crypto/evp/kem.c" 3 4
                 ((void *)0)
# 189 "../crypto/evp/kem.c"
                     ;
...
{
    if (authpriv == 
# 205 "../crypto/evp/kem.c" 3 4
                   ((void *)0)
# 205 "../crypto/evp/kem.c"
                       )
        return 0;
    return evp_kem_init(ctx, (1<<12), params, authpriv);
}

int EVP_PKEY_encapsulate_init(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_kem_init(ctx, (1<<12), params, 
# 212 "../crypto/evp/kem.c" 3 4
                                                             ((void *)0)
...
{
    if (ctx == 
# 219 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 219 "../crypto/evp/kem.c"
                  )
        return 0;

    if (ctx->operation != (1<<12)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",223,__func__), ERR_set_error)((6),(151),
# 223 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 223 "../crypto/evp/kem.c"
       );
        return -1;
    }

    if (ctx->op.encap.algctx == 
# 227 "../crypto/evp/kem.c" 3 4
                               ((void *)0)
# 227 "../crypto/evp/kem.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",228,__func__), ERR_set_error)((6),(150),
# 228 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 228 "../crypto/evp/kem.c"
       );
        return -2;
    }

    if (out != 
# 232 "../crypto/evp/kem.c" 3 4
              ((void *)0) 
# 232 "../crypto/evp/kem.c"
                   && secret == 
# 232 "../crypto/evp/kem.c" 3 4
                                ((void *)0)
# 232 "../crypto/evp/kem.c"
...
int EVP_PKEY_decapsulate_init(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_kem_init(ctx, (1<<13), params, 
# 241 "../crypto/evp/kem.c" 3 4
                                                             ((void *)0)
# 241 "../crypto/evp/kem.c"
                                                                 );
}
...
{
    if (authpub == 
# 247 "../crypto/evp/kem.c" 3 4
                  ((void *)0)
# 247 "../crypto/evp/kem.c"
                      )
        return 0;
    return evp_kem_init(ctx, (1<<13), params, authpub);
}
...
{
    if (ctx == 
# 256 "../crypto/evp/kem.c" 3 4
              ((void *)0)
        
# 257 "../crypto/evp/kem.c"
       || (in == 
# 257 "../crypto/evp/kem.c" 3 4
                 ((void *)0) 
# 257 "../crypto/evp/kem.c"
                      || inlen == 0)
        || (secret == 
# 258 "../crypto/evp/kem.c" 3 4
                     ((void *)0) 
# 258 "../crypto/evp/kem.c"
                          && secretlen == 
# 258 "../crypto/evp/kem.c" 3 4
                                          ((void *)0)
# 258 "../crypto/evp/kem.c"
    ...
    if (ctx->operation != (1<<13)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",262,__func__), ERR_set_error)((6),(151),
# 262 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 262 "../crypto/evp/kem.c"
       );
        return -1;
    }

    if (ctx->op.encap.algctx == 
# 266 "../crypto/evp/kem.c" 3 4
                               ((void *)0)
# 266 "../crypto/evp/kem.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",267,__func__), ERR_set_error)((6),(150),
# 267 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 267 "../crypto/evp/kem.c"
       );
        return -2;
    }
...
{
    EVP_KEM *kem = CRYPTO_zalloc(sizeof(EVP_KEM), "../crypto/evp/kem.c", 276);

    if (kem == 
# 278 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 278 "../crypto/evp/kem.c"
                  )
        return 
# 279 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 279 "../crypto/evp/kem.c"
                  ;

    if (!CRYPTO_NEW_REF(&kem->refcnt, 1)) {
        CRYPTO_free(kem, "../crypto/evp/kem.c", 282);
        return 
# 283 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 283 "../crypto/evp/kem.c"
                  ;
    }
    kem->prov = prov;
                                    ...
                                    OSSL_PROVIDER *prov)
{
    ...
    EVP_KEM *kem = 
# 295 "../crypto/evp/kem.c" 3 4
                  ((void *)0)
# 295 "../crypto/evp/kem.c"
                      ;
    int ctxfncnt = 0, encfncnt = 0, decfncnt = 0;
    int gparamfncnt = 0, sparamfncnt = 0;

    if ((kem = evp_kem_new(prov)) == 
# 299 "../crypto/evp/kem.c" 3 4
                                    ((void *)0)
# 299 "../crypto/evp/kem.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",300,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 300 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 300 "../crypto/evp/kem.c"
       );
        goto err;
    }

    kem->name_id = name_id;
    if ((kem->type_name = ossl_algorithm_get1_first_name(algodef)) == 
# 305 "../crypto/evp/kem.c" 3 4
                                                                     ((void *)0)
# 305 "../crypto/evp/kem.c"
                                                                         )
        goto err;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (kem->newctx != 
# 312 "../crypto/evp/kem.c" 3 4
                              ((void *)0)
# 312 "../crypto/evp/kem.c"
                                  )
                break;
            ...
            break;
        case 2:
            if (kem->encapsulate_init != 
# 318 "../crypto/evp/kem.c" 3 4
                                        ((void *)0)
# 318 "../crypto/evp/kem.c"
                                            )
                break;
            ...
            break;
        case 12:
            if (kem->auth_encapsulate_init != 
# 324 "../crypto/evp/kem.c" 3 4
                                             ((void *)0)
# 324 "../crypto/evp/kem.c"
                                                 )
                break;
        ...
        case 3:
            if (kem->encapsulate != 
# 330 "../crypto/evp/kem.c" 3 4
                                   ((void *)0)
# 330 "../crypto/evp/kem.c"
                                       )
                break;
            ...
            break;
        case 4:
            if (kem->decapsulate_init != 
# 336 "../crypto/evp/kem.c" 3 4
                                        ((void *)0)
# 336 "../crypto/evp/kem.c"
                                            )
                break;
            ...
            break;
        case 13:
            if (kem->auth_decapsulate_init != 
# 342 "../crypto/evp/kem.c" 3 4
                                             ((void *)0)
# 342 "../crypto/evp/kem.c"
                                                 )
                break;
        ...
        case 5:
            if (kem->decapsulate != 
# 348 "../crypto/evp/kem.c" 3 4
                                   ((void *)0)
# 348 "../crypto/evp/kem.c"
                                       )
                break;
        ...
        case 6:
            if (kem->freectx != 
# 354 "../crypto/evp/kem.c" 3 4
                               ((void *)0)
# 354 "../crypto/evp/kem.c"
                                   )
                break;
        ...
        case 7:
            if (kem->dupctx != 
# 360 "../crypto/evp/kem.c" 3 4
                              ((void *)0)
# 360 "../crypto/evp/kem.c"
                                  )
                break;
            kem->dupctx = OSSL_FUNC_kem_dupctx(fns);
            break;
        case 8:
            if (kem->get_ctx_params != 
# 365 "../crypto/evp/kem.c" 3 4
                                      ((void *)0)
# 365 "../crypto/evp/kem.c"
                                          )
                break;
            kem->get_ctx_params
            ...
            break;
        case 9:
            if (kem->gettable_ctx_params != 
# 372 "../crypto/evp/kem.c" 3 4
                                           ((void *)0)
# 372 "../crypto/evp/kem.c"
                                               )
                break;
            ...
            break;
        case 10:
            if (kem->set_ctx_params != 
# 379 "../crypto/evp/kem.c" 3 4
                                      ((void *)0)
# 379 "../crypto/evp/kem.c"
                                          )
                break;
            kem->set_ctx_params
            ...
            break;
        case 11:
            if (kem->settable_ctx_params != 
# 386 "../crypto/evp/kem.c" 3 4
                                           ((void *)0)
# 386 "../crypto/evp/kem.c"
                                               )
                break;
...
# 411 "../crypto/evp/kem.c"
        (ERR_new(), ERR_set_debug("../crypto/evp/kem.c",411,__func__), ERR_set_error)((6),(193),
# 411 "../crypto/evp/kem.c" 3 4
       ((void *)0)
# 411 "../crypto/evp/kem.c"
       );
        goto err;
 ...
 err:
    EVP_KEM_free(kem);
    return 
# 418 "../crypto/evp/kem.c" 3 4
          ((void *)0)
# 418 "../crypto/evp/kem.c"
              ;
}
...
void EVP_KEM_free(EVP_KEM *kem)
{
    ...
    if (kem == 
# 425 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 425 "../crypto/evp/kem.c"
                  )
        return;
    ...
    if (i > 0)
        return;
    CRYPTO_free(kem->type_name, "../crypto/evp/kem.c", 431);
    ossl_provider_free(kem->prov);
    CRYPTO_FREE_REF(&kem->refcnt);
    CRYPTO_free(kem, "../crypto/evp/kem.c", 434);
}
...
EVP_KEM *EVP_KEM_fetch(OSSL_LIB_CTX *ctx, const char *algorithm,
                       const char *properties)
{
    return evp_generic_fetch(ctx, 14, algorithm, properties,
...
EVP_KEM *evp_kem_fetch_from_prov(OSSL_PROVIDER *prov, const char *algorithm,
                                 const char *properties)
{
    return evp_generic_fetch_from_prov(prov, 14, algorithm, properties,
                                       evp_kem_from_algorithm,
                                       (int (*)(void *))EVP_KEM_up_ref,
                                       (void (*)(void *))EVP_KEM_free);
}
...
{
    return kem != 
# 470 "../crypto/evp/kem.c" 3 4
                 ((void *)0) 
# 470 "../crypto/evp/kem.c"
                      && evp_is_a(kem->prov, kem->name_id, 
# 470 "../crypto/evp/kem.c" 3 4
                                                           ((void *)0)
# 470 "../crypto/evp/kem.c"
                                                               , name);
...
void EVP_KEM_do_all_provided(OSSL_LIB_CTX *libctx,
                             ...
                             void *arg)
{
    evp_generic_do_all(libctx, 14, (void (*)(void *, void *))fn, arg,
                       evp_kem_from_algorithm,
                       (int (*)(void *))EVP_KEM_up_ref,
                       (void (*)(void *))EVP_KEM_free);
}
...
{
    if (kem->prov != 
# 502 "../crypto/evp/kem.c" 3 4
                    ((void *)0)
# 502 "../crypto/evp/kem.c"
                        )
...
const OSSL_PARAM *EVP_KEM_gettable_ctx_params(const EVP_KEM *kem)
{
    ...
    if (kem == 
# 512 "../crypto/evp/kem.c" 3 4
              ((void *)0) 
# 512 "../crypto/evp/kem.c"
                   || kem->gettable_ctx_params == 
# 512 "../crypto/evp/kem.c" 3 4
                                                  ((void *)0)
# 512 "../crypto/evp/kem.c"
        ...
        return 
# 513 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 513 "../crypto/evp/kem.c"
                  ;

    provctx = ossl_provider_ctx(EVP_KEM_get0_provider(kem));
    return kem->gettable_ctx_params(
# 516 "../crypto/evp/kem.c" 3 4
                                   ((void *)0)
# 516 "../crypto/evp/kem.c"
                                       , provctx);
}
...
const OSSL_PARAM *EVP_KEM_settable_ctx_params(const EVP_KEM *kem)
{
    ...
    if (kem == 
# 523 "../crypto/evp/kem.c" 3 4
              ((void *)0) 
# 523 "../crypto/evp/kem.c"
                   || kem->settable_ctx_params == 
# 523 "../crypto/evp/kem.c" 3 4
                                                  ((void *)0)
# 523 "../crypto/evp/kem.c"
        ...
        return 
# 524 "../crypto/evp/kem.c" 3 4
              ((void *)0)
# 524 "../crypto/evp/kem.c"
                  ;

    provctx = ossl_provider_ctx(EVP_KEM_get0_provider(kem));
    return kem->settable_ctx_params(
# 527 "../crypto/evp/kem.c" 3 4
                                   ((void *)0)
# 527 "../crypto/evp/kem.c"
                                       , provctx);
}
