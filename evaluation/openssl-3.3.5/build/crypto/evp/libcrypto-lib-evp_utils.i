# 0 "../crypto/evp/evp_utils.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_utils.c"
# 12 "../crypto/evp/evp_utils.c"
...
# 19 "../crypto/evp/evp_utils.c" 2
# 63 "../crypto/evp/evp_utils.c"
static void geterr(void)
{
    (ERR_new(), ERR_set_debug("../crypto/evp/evp_utils.c",65,__func__), ERR_set_error)((6),(197),
# 65 "../crypto/evp/evp_utils.c" 3 4
   ((void *)0)
# 65 "../crypto/evp/evp_utils.c"
   );
}

static void seterr(void)
{
    (ERR_new(), ERR_set_debug("../crypto/evp/evp_utils.c",70,__func__), ERR_set_error)((6),(198),
# 70 "../crypto/evp/evp_utils.c" 3 4
   ((void *)0)
# 70 "../crypto/evp/evp_utils.c"
   );
}

int evp_do_ciph_getparams (const EVP_CIPHER *obj, OSSL_PARAM params[]) { if (obj == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return -1; if (obj->get_params == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) { geterr(); return 0; } return obj->get_params(params); } int evp_do_ciph_ctx_getparams (const EVP_CIPHER *obj, void *algctx, OSSL_PARAM params[]) { if (obj == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
...
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return -1; if (obj->get_ctx_params == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) { geterr(); return 0; } return obj->get_ctx_params(algctx, params); } int evp_do_ciph_ctx_setparams (const EVP_CIPHER *obj, void *algctx, OSSL_PARAM params[]) { if (obj == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
...
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) return -1; if (obj->set_ctx_params == 
# 73 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 73 "../crypto/evp/evp_utils.c"
) { seterr(); return 0; } return obj->set_ctx_params(algctx, params); }




int evp_do_md_getparams (const EVP_MD *obj, OSSL_PARAM params[]) { if (obj == 
# 78 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
# 78 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
...
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
) { geterr(); return 0; } return obj->get_params(params); } int evp_do_md_ctx_getparams (const EVP_MD *obj, void *algctx, OSSL_PARAM params[]) { if (obj == 
# 78 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
...
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
) { geterr(); return 0; } return obj->get_ctx_params(algctx, params); } int evp_do_md_ctx_setparams (const EVP_MD *obj, void *algctx, OSSL_PARAM params[]) { if (obj == 
# 78 "../crypto/evp/evp_utils.c" 3 4
((void *)0)
# 78 "../crypto/evp/evp_utils.c"
) return 0; if (obj->prov == 
