# 0 "../crypto/evp/p5_crpt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p5_crpt.c"
# 10 "../crypto/evp/p5_crpt.c"
...
# 14 "../crypto/evp/p5_crpt.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../crypto/evp/p5_crpt.c" 2
                          ...
                          const char *propq)
{
    ...
    int ivl, kl;
    PBEPARAM *pbe = 
# 34 "../crypto/evp/p5_crpt.c" 3 4
                   ((void *)0)
# 34 "../crypto/evp/p5_crpt.c"
                       ;
    int saltlen, iter;
    unsigned char *salt;
    int mdsize;
    ...
    EVP_KDF *kdf;
    EVP_KDF_CTX *kctx = 
# 40 "../crypto/evp/p5_crpt.c" 3 4
                       ((void *)0)
# 40 "../crypto/evp/p5_crpt.c"
                           ;
    ...
    if (param == 
# 45 "../crypto/evp/p5_crpt.c" 3 4
                ((void *)0) 
# 45 "../crypto/evp/p5_crpt.c"
                     || param->type != 16 ||
        param->value.sequence == 
# 46 "../crypto/evp/p5_crpt.c" 3 4
                                ((void *)0)
# 46 "../crypto/evp/p5_crpt.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt.c",47,__func__), ERR_set_error)((6),(114),
# 47 "../crypto/evp/p5_crpt.c" 3 4
       ((void *)0)
# 47 "../crypto/evp/p5_crpt.c"
       );
        return 0;
    }
    ...
    if (pbe == 
# 52 "../crypto/evp/p5_crpt.c" 3 4
              ((void *)0)
# 52 "../crypto/evp/p5_crpt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt.c",53,__func__), ERR_set_error)((6),(114),
# 53 "../crypto/evp/p5_crpt.c" 3 4
       ((void *)0)
# 53 "../crypto/evp/p5_crpt.c"
       );
        return 0;
    }
    ...
    if (ivl < 0 || ivl > 16) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt.c",59,__func__), ERR_set_error)((6),(194),
# 59 "../crypto/evp/p5_crpt.c" 3 4
       ((void *)0)
# 59 "../crypto/evp/p5_crpt.c"
       );
        goto err;
    }
    kl = EVP_CIPHER_get_key_length(cipher);
    if (kl < 0 || kl > (int)sizeof(md_tmp)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt.c",64,__func__), ERR_set_error)((6),(130),
# 64 "../crypto/evp/p5_crpt.c" 3 4
       ((void *)0)
# 64 "../crypto/evp/p5_crpt.c"
       );
        goto err;
    }

    if (pbe->iter == 
# 68 "../crypto/evp/p5_crpt.c" 3 4
                    ((void *)0)
# 68 "../crypto/evp/p5_crpt.c"
                        )
        iter = 1;
    else
    ...
    if (pass == 
# 75 "../crypto/evp/p5_crpt.c" 3 4
               ((void *)0)
# 75 "../crypto/evp/p5_crpt.c"
                   )
        passlen = 0;
    else if (passlen == -1)
        passlen = strlen(pass);
    ...
    kdf = EVP_KDF_fetch(libctx, "PBKDF1", propq);
    kctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kctx == 
# 87 "../crypto/evp/p5_crpt.c" 3 4
               ((void *)0)
# 87 "../crypto/evp/p5_crpt.c"
                   )
        goto err;
...
# 101 "../crypto/evp/p5_crpt.c" 3 4
                                        ((void *)0)
# 101 "../crypto/evp/p5_crpt.c"
                                            , key, iv, en_de))
        goto err;
...
# 118 "../crypto/evp/p5_crpt.c" 3 4
                                ((void *)0)
# 118 "../crypto/evp/p5_crpt.c"
                                    , 
# 118 "../crypto/evp/p5_crpt.c" 3 4
                                      ((void *)0)
# 118 "../crypto/evp/p5_crpt.c"
