# 0 "../crypto/evp/signature.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/signature.c"
# 10 "../crypto/evp/signature.c"
...
# 20 "../crypto/evp/signature.c" 2

static EVP_SIGNATURE *evp_signature_new(OSSL_PROVIDER *prov)
{
    EVP_SIGNATURE *signature = CRYPTO_zalloc(sizeof(EVP_SIGNATURE), "../crypto/evp/signature.c", 23);

    if (signature == 
# 25 "../crypto/evp/signature.c" 3 4
                    ((void *)0)
# 25 "../crypto/evp/signature.c"
                        )
        return 
# 26 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 26 "../crypto/evp/signature.c"
                  ;

    if (!CRYPTO_NEW_REF(&signature->refcnt, 1)) {
        CRYPTO_free(signature, "../crypto/evp/signature.c", 29);
        return 
# 30 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 30 "../crypto/evp/signature.c"
                  ;
    }
                                          ...
                                          OSSL_PROVIDER *prov)
{
    ...
    EVP_SIGNATURE *signature = 
# 44 "../crypto/evp/signature.c" 3 4
                              ((void *)0)
# 44 "../crypto/evp/signature.c"
                                  ;
    int ctxfncnt = 0, signfncnt = 0, verifyfncnt = 0, verifyrecfncnt = 0;
    int digsignfncnt = 0, digverifyfncnt = 0;
    int gparamfncnt = 0, sparamfncnt = 0, gmdparamfncnt = 0, smdparamfncnt = 0;

    if ((signature = evp_signature_new(prov)) == 
# 49 "../crypto/evp/signature.c" 3 4
                                                ((void *)0)
# 49 "../crypto/evp/signature.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",50,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 50 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 50 "../crypto/evp/signature.c"
       );
        goto err;
    }
...
# 55 "../crypto/evp/signature.c" 3 4
                                                                           ((void *)0)
# 55 "../crypto/evp/signature.c"
                                                                               )
        goto err;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (signature->newctx != 
# 62 "../crypto/evp/signature.c" 3 4
                                    ((void *)0)
# 62 "../crypto/evp/signature.c"
                                        )
                break;
            ...
            break;
        case 2:
            if (signature->sign_init != 
# 68 "../crypto/evp/signature.c" 3 4
                                       ((void *)0)
# 68 "../crypto/evp/signature.c"
                                           )
                break;
        ...
        case 3:
            if (signature->sign != 
# 74 "../crypto/evp/signature.c" 3 4
                                  ((void *)0)
# 74 "../crypto/evp/signature.c"
                                      )
                break;
            ...
            break;
        case 4:
            if (signature->verify_init != 
# 80 "../crypto/evp/signature.c" 3 4
                                         ((void *)0)
# 80 "../crypto/evp/signature.c"
                                             )
                break;
        ...
        case 5:
            if (signature->verify != 
# 86 "../crypto/evp/signature.c" 3 4
                                    ((void *)0)
# 86 "../crypto/evp/signature.c"
                                        )
                break;
            ...
            break;
        case 6:
            if (signature->verify_recover_init != 
# 92 "../crypto/evp/signature.c" 3 4
                                                 ((void *)0)
# 92 "../crypto/evp/signature.c"
                                                     )
                break;
            ...
            break;
        case 7:
            if (signature->verify_recover != 
# 99 "../crypto/evp/signature.c" 3 4
                                            ((void *)0)
# 99 "../crypto/evp/signature.c"
                                                )
                break;
            ...
            break;
        case 8:
            if (signature->digest_sign_init != 
# 106 "../crypto/evp/signature.c" 3 4
                                              ((void *)0)
# 106 "../crypto/evp/signature.c"
                                                  )
                break;
            ...
            break;
        case 9:
            if (signature->digest_sign_update != 
# 112 "../crypto/evp/signature.c" 3 4
                                                ((void *)0)
# 112 "../crypto/evp/signature.c"
                                                    )
                break;
            ...
            break;
        case 10:
            if (signature->digest_sign_final != 
# 119 "../crypto/evp/signature.c" 3 4
                                               ((void *)0)
# 119 "../crypto/evp/signature.c"
                                                   )
                break;
            ...
            break;
        case 11:
            if (signature->digest_sign != 
# 126 "../crypto/evp/signature.c" 3 4
                                         ((void *)0)
# 126 "../crypto/evp/signature.c"
                                             )
                break;
...
# 132 "../crypto/evp/signature.c" 3 4
                                                ((void *)0)
# 132 "../crypto/evp/signature.c"
                                                    )
                break;
            ...
            break;
        case 13:
            if (signature->digest_verify_update != 
# 138 "../crypto/evp/signature.c" 3 4
                                                  ((void *)0)
# 138 "../crypto/evp/signature.c"
                                                      )
                break;
            ...
            break;
        case 14:
            if (signature->digest_verify_final != 
# 145 "../crypto/evp/signature.c" 3 4
                                                 ((void *)0)
# 145 "../crypto/evp/signature.c"
                                                     )
                break;
            ...
            break;
        case 15:
            if (signature->digest_verify != 
# 152 "../crypto/evp/signature.c" 3 4
                                           ((void *)0)
# 152 "../crypto/evp/signature.c"
                                               )
                break;
            ...
            break;
        case 16:
            if (signature->freectx != 
# 158 "../crypto/evp/signature.c" 3 4
                                     ((void *)0)
# 158 "../crypto/evp/signature.c"
                                         )
                break;
        ...
        case 17:
            if (signature->dupctx != 
# 164 "../crypto/evp/signature.c" 3 4
                                    ((void *)0)
# 164 "../crypto/evp/signature.c"
                                        )
                break;
            signature->dupctx = OSSL_FUNC_signature_dupctx(fns);
            break;
        case 18:
            if (signature->get_ctx_params != 
# 169 "../crypto/evp/signature.c" 3 4
                                            ((void *)0)
# 169 "../crypto/evp/signature.c"
                                                )
                break;
            ...
            break;
        case 19:
            if (signature->gettable_ctx_params != 
# 176 "../crypto/evp/signature.c" 3 4
                                                 ((void *)0)
# 176 "../crypto/evp/signature.c"
                                                     )
                break;
            ...
            break;
        case 20:
            if (signature->set_ctx_params != 
# 183 "../crypto/evp/signature.c" 3 4
                                            ((void *)0)
# 183 "../crypto/evp/signature.c"
                                                )
                break;
            ...
            break;
        case 21:
            if (signature->settable_ctx_params != 
# 190 "../crypto/evp/signature.c" 3 4
                                                 ((void *)0)
# 190 "../crypto/evp/signature.c"
                                                     )
                break;
            ...
            break;
        case 22:
            if (signature->get_ctx_md_params != 
# 197 "../crypto/evp/signature.c" 3 4
                                               ((void *)0)
# 197 "../crypto/evp/signature.c"
                                                   )
                break;
            ...
            break;
        case 23:
            if (signature->gettable_ctx_md_params != 
# 204 "../crypto/evp/signature.c" 3 4
                                                    ((void *)0)
# 204 "../crypto/evp/signature.c"
                                                        )
                break;
            ...
            break;
        case 24:
            if (signature->set_ctx_md_params != 
# 211 "../crypto/evp/signature.c" 3 4
                                               ((void *)0)
# 211 "../crypto/evp/signature.c"
                                                   )
                break;
            ...
            break;
        case 25:
            if (signature->settable_ctx_md_params != 
# 218 "../crypto/evp/signature.c" 3 4
                                                    ((void *)0)
# 218 "../crypto/evp/signature.c"
                                                        )
                break;
    ...
    if (ctxfncnt != 2
        || (signfncnt == 0
            ...
            && digverifyfncnt == 0
            && signature->digest_sign == 
# 232 "../crypto/evp/signature.c" 3 4
                                        ((void *)0)
            
# 233 "../crypto/evp/signature.c"
           && signature->digest_verify == 
# 233 "../crypto/evp/signature.c" 3 4
                                          ((void *)0)
# 233 "../crypto/evp/signature.c"
                                              )
        ...
        || (digsignfncnt == 2 && signature->digest_sign_init == 
# 238 "../crypto/evp/signature.c" 3 4
                                                               ((void *)0)
# 238 "../crypto/evp/signature.c"
                                                                   )
        || (digverifyfncnt != 0 && digverifyfncnt != 2)
        || (digverifyfncnt == 2 && signature->digest_verify_init == 
# 240 "../crypto/evp/signature.c" 3 4
                                                                   ((void *)0)
# 240 "../crypto/evp/signature.c"
                                                                       )
        || (signature->digest_sign != 
# 241 "../crypto/evp/signature.c" 3 4
                                     ((void *)0)
            
# 242 "../crypto/evp/signature.c"
           && signature->digest_sign_init == 
# 242 "../crypto/evp/signature.c" 3 4
                                             ((void *)0)
# 242 "../crypto/evp/signature.c"
                                                 )
        || (signature->digest_verify != 
# 243 "../crypto/evp/signature.c" 3 4
                                       ((void *)0)
            
# 244 "../crypto/evp/signature.c"
           && signature->digest_verify_init == 
# 244 "../crypto/evp/signature.c" 3 4
                                               ((void *)0)
# 244 "../crypto/evp/signature.c"
                                                   )
...
# 266 "../crypto/evp/signature.c"
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",266,__func__), ERR_set_error)((6),(193),
# 266 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 266 "../crypto/evp/signature.c"
       );
        goto err;
 ...
 err:
    ...
    return 
# 273 "../crypto/evp/signature.c" 3 4
          ((void *)0)
# 273 "../crypto/evp/signature.c"
              ;
}
...
void EVP_SIGNATURE_free(EVP_SIGNATURE *signature)
{
    ...
    if (signature == 
# 280 "../crypto/evp/signature.c" 3 4
                    ((void *)0)
# 280 "../crypto/evp/signature.c"
                        )
        return;
    CRYPTO_DOWN_REF(&signature->refcnt, &i);
    if (i > 0)
        return;
    CRYPTO_free(signature->type_name, "../crypto/evp/signature.c", 285);
    ossl_provider_free(signature->prov);
    CRYPTO_FREE_REF(&signature->refcnt);
    CRYPTO_free(signature, "../crypto/evp/signature.c", 288);
}
...
EVP_SIGNATURE *EVP_SIGNATURE_fetch(OSSL_LIB_CTX *ctx, const char *algorithm,
                                   const char *properties)
{
    return evp_generic_fetch(ctx, 12, algorithm, properties,
...
EVP_SIGNATURE *evp_signature_fetch_from_prov(OSSL_PROVIDER *prov,
                                             ...
                                             const char *properties)
{
    return evp_generic_fetch_from_prov(prov, 12,
...
{
    return signature != 
# 326 "../crypto/evp/signature.c" 3 4
                       ((void *)0)
           
# 327 "../crypto/evp/signature.c"
          && evp_is_a(signature->prov, signature->name_id, 
# 327 "../crypto/evp/signature.c" 3 4
                                                           ((void *)0)
# 327 "../crypto/evp/signature.c"
                                                               , name);
}
...
{
    if (signature->prov != 
# 362 "../crypto/evp/signature.c" 3 4
                          ((void *)0)
# 362 "../crypto/evp/signature.c"
                              )
...
const OSSL_PARAM *EVP_SIGNATURE_gettable_ctx_params(const EVP_SIGNATURE *sig)
{
    ...
    if (sig == 
# 372 "../crypto/evp/signature.c" 3 4
              ((void *)0) 
# 372 "../crypto/evp/signature.c"
                   || sig->gettable_ctx_params == 
# 372 "../crypto/evp/signature.c" 3 4
                                                  ((void *)0)
# 372 "../crypto/evp/signature.c"
                                                      )
        return 
# 373 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 373 "../crypto/evp/signature.c"
                  ;

    provctx = ossl_provider_ctx(EVP_SIGNATURE_get0_provider(sig));
    return sig->gettable_ctx_params(
# 376 "../crypto/evp/signature.c" 3 4
                                   ((void *)0)
# 376 "../crypto/evp/signature.c"
                                       , provctx);
}
...
const OSSL_PARAM *EVP_SIGNATURE_settable_ctx_params(const EVP_SIGNATURE *sig)
{
    ...
    if (sig == 
# 383 "../crypto/evp/signature.c" 3 4
              ((void *)0) 
# 383 "../crypto/evp/signature.c"
                   || sig->settable_ctx_params == 
# 383 "../crypto/evp/signature.c" 3 4
                                                  ((void *)0)
# 383 "../crypto/evp/signature.c"
                                                      )
        return 
# 384 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 384 "../crypto/evp/signature.c"
                  ;

    provctx = ossl_provider_ctx(EVP_SIGNATURE_get0_provider(sig));
    return sig->settable_ctx_params(
# 387 "../crypto/evp/signature.c" 3 4
                                   ((void *)0)
# 387 "../crypto/evp/signature.c"
                                       , provctx);
}
                                   ...
                                   const OSSL_PARAM params[])
{
    int ret = 0;
    void *provkey = 
# 394 "../crypto/evp/signature.c" 3 4
                   ((void *)0)
# 394 "../crypto/evp/signature.c"
                       ;
    EVP_SIGNATURE *signature = 
# 395 "../crypto/evp/signature.c" 3 4
                              ((void *)0)
# 395 "../crypto/evp/signature.c"
                                  ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 396 "../crypto/evp/signature.c" 3 4
                              ((void *)0)
# 396 "../crypto/evp/signature.c"
                                  ;
    const OSSL_PROVIDER *tmp_prov = 
# 397 "../crypto/evp/signature.c" 3 4
                                   ((void *)0)
# 397 "../crypto/evp/signature.c"
                                       ;
    const char *supported_sig = 
# 398 "../crypto/evp/signature.c" 3 4
                               ((void *)0)
# 398 "../crypto/evp/signature.c"
                                   ;
    int iter;

    if (ctx == 
# 401 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 401 "../crypto/evp/signature.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",402,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 402 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 402 "../crypto/evp/signature.c"
       );
        return -1;
    }
    ...
    if (((ctx)->keymgmt == 
# 411 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 411 "../crypto/evp/signature.c"
       ))
        goto legacy;

    if (ctx->pkey == 
# 414 "../crypto/evp/signature.c" 3 4
                    ((void *)0)
# 414 "../crypto/evp/signature.c"
                        ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",416,__func__), ERR_set_error)((6),(154),
# 416 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 416 "../crypto/evp/signature.c"
       );
        goto err;
    }
    ...
    if (!__builtin_expect(!!((ctx->pkey->keymgmt == 
# 423 "../crypto/evp/signature.c" 3 4
        ((void *)0) 
# 423 "../crypto/evp/signature.c"
        || ctx->pkey->keymgmt == ctx->keymgmt) != 0), 1)
                                                           ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",426,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 426 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 426 "../crypto/evp/signature.c"
       );
        goto err;
    }
    supported_sig = evp_keymgmt_util_query_operation_name(ctx->keymgmt,
                                                          12);
    if (supported_sig == 
# 431 "../crypto/evp/signature.c" 3 4
                        ((void *)0)
# 431 "../crypto/evp/signature.c"
                            ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",433,__func__), ERR_set_error)((6),(134),
# 433 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 433 "../crypto/evp/signature.c"
       );
        goto err;
    }
# 454 "../crypto/evp/signature.c"
    for (iter = 1; iter < 3 && provkey == 
# 454 "../crypto/evp/signature.c" 3 4
                                         ((void *)0)
# 454 "../crypto/evp/signature.c"
                                             ; iter++) {
        EVP_KEYMGMT *tmp_keymgmt_tofree = 
# 455 "../crypto/evp/signature.c" 3 4
                                         ((void *)0)
# 455 "../crypto/evp/signature.c"
                                             ;
        ...
        case 1:
            ...
            if (signature != 
# 469 "../crypto/evp/signature.c" 3 4
                            ((void *)0)
# 469 "../crypto/evp/signature.c"
                                )
        ...
        case 2:
            ...
            if (signature == 
# 477 "../crypto/evp/signature.c" 3 4
                            ((void *)0)
# 477 "../crypto/evp/signature.c"
                                )
                goto legacy;
            break;
        }
        if (signature == 
# 481 "../crypto/evp/signature.c" 3 4
                        ((void *)0)
# 481 "../crypto/evp/signature.c"
                            )
            continue;
# 494 "../crypto/evp/signature.c"
        tmp_keymgmt_tofree = tmp_keymgmt =
            evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)tmp_prov,
                                        EVP_KEYMGMT_get0_name(ctx->keymgmt),
                                        ctx->propquery);
        if (tmp_keymgmt != 
# 498 "../crypto/evp/signature.c" 3 4
                          ((void *)0)
# 498 "../crypto/evp/signature.c"
                              )
            provkey = evp_pkey_export_to_provider(ctx->pkey, ctx->libctx,
                                                  &tmp_keymgmt, ctx->propquery);
        if (tmp_keymgmt == 
# 501 "../crypto/evp/signature.c" 3 4
                          ((void *)0)
# 501 "../crypto/evp/signature.c"
                              )
            EVP_KEYMGMT_free(tmp_keymgmt_tofree);
    }

    if (provkey == 
# 505 "../crypto/evp/signature.c" 3 4
                  ((void *)0)
# 505 "../crypto/evp/signature.c"
                      ) {
        EVP_SIGNATURE_free(signature);
        goto legacy;
    }
...
# 517 "../crypto/evp/signature.c" 3 4
                             ((void *)0)
# 517 "../crypto/evp/signature.c"
                                 ) {

        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",519,__func__), ERR_set_error)((6),(134),
# 519 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 519 "../crypto/evp/signature.c"
       );
        goto err;
    }
    ...
    case (1<<4):
        if (signature->sign_init == 
# 525 "../crypto/evp/signature.c" 3 4
                                   ((void *)0)
# 525 "../crypto/evp/signature.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",526,__func__), ERR_set_error)((6),(150),
# 526 "../crypto/evp/signature.c" 3 4
           ((void *)0)
# 526 "../crypto/evp/signature.c"
           );
            ret = -2;
            goto err;
        }
    ...
    case (1<<5):
        if (signature->verify_init == 
# 533 "../crypto/evp/signature.c" 3 4
                                     ((void *)0)
# 533 "../crypto/evp/signature.c"
                                         ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",534,__func__), ERR_set_error)((6),(150),
# 534 "../crypto/evp/signature.c" 3 4
           ((void *)0)
# 534 "../crypto/evp/signature.c"
           );
            ret = -2;
            goto err;
        }
    ...
    case (1<<6):
        if (signature->verify_recover_init == 
# 541 "../crypto/evp/signature.c" 3 4
                                             ((void *)0)
# 541 "../crypto/evp/signature.c"
                                                 ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",542,__func__), ERR_set_error)((6),(150),
# 542 "../crypto/evp/signature.c" 3 4
           ((void *)0)
# 542 "../crypto/evp/signature.c"
           );
            ret = -2;
            goto err;
        }
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",550,__func__), ERR_set_error)((6),(134),
# 550 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 550 "../crypto/evp/signature.c"
       );
        goto err;
    }
    ...
    if (ret <= 0) {
        ...
        ctx->op.sig.algctx = 
# 556 "../crypto/evp/signature.c" 3 4
                            ((void *)0)
# 556 "../crypto/evp/signature.c"
                                ;
        goto err;
    }
    goto end;
 ...
 legacy:
    ...
    EVP_KEYMGMT_free(tmp_keymgmt);
    tmp_keymgmt = 
# 568 "../crypto/evp/signature.c" 3 4
                 ((void *)0)
# 568 "../crypto/evp/signature.c"
                     ;

    if (ctx->pmeth == 
# 570 "../crypto/evp/signature.c" 3 4
                     ((void *)0)
            
# 571 "../crypto/evp/signature.c"
           || (operation == (1<<4) && ctx->pmeth->sign == 
# 571 "../crypto/evp/signature.c" 3 4
                                                                    ((void *)0)
# 571 "../crypto/evp/signature.c"
                                                                        )
            || (operation == (1<<5) && ctx->pmeth->verify == 
# 572 "../crypto/evp/signature.c" 3 4
                                                                        ((void *)0)
# 572 "../crypto/evp/signature.c"
                                                                            )
            || (operation == (1<<6)
                && ctx->pmeth->verify_recover == 
# 574 "../crypto/evp/signature.c" 3 4
                                                ((void *)0)
# 574 "../crypto/evp/signature.c"
                                                    )) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",575,__func__), ERR_set_error)((6),(150),
# 575 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 575 "../crypto/evp/signature.c"
       );
        return -2;
    }
...
# 581 "../crypto/evp/signature.c" 3 4
                                    ((void *)0)
# 581 "../crypto/evp/signature.c"
                                        )
            return 1;
...
# 586 "../crypto/evp/signature.c" 3 4
                                      ((void *)0)
# 586 "../crypto/evp/signature.c"
                                          )
            return 1;
...
# 591 "../crypto/evp/signature.c" 3 4
                                              ((void *)0)
# 591 "../crypto/evp/signature.c"
                                                  )
            return 1;
        ret = ctx->pmeth->verify_recover_init(ctx);
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",596,__func__), ERR_set_error)((6),(134),
# 596 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 596 "../crypto/evp/signature.c"
       );
        goto err;
    }
    if (ret <= 0)
...
int EVP_PKEY_sign_init(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_signature_init(ctx, (1<<4), 
# 618 "../crypto/evp/signature.c" 3 4
                                                         ((void *)0)
# 618 "../crypto/evp/signature.c"
                                                             );
}

int EVP_PKEY_sign_init_ex(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_pkey_signature_init(ctx, (1<<4), params);
}
                  ...
                  const unsigned char *tbs, size_t tbslen)
{
    ...
    if (ctx == 
# 632 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 632 "../crypto/evp/signature.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",633,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 633 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 633 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->operation != (1<<4)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",638,__func__), ERR_set_error)((6),(151),
# 638 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 638 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->op.sig.algctx == 
# 642 "../crypto/evp/signature.c" 3 4
                             ((void *)0)
# 642 "../crypto/evp/signature.c"
                                 )
        goto legacy;

    if (ctx->op.sig.signature->sign == 
# 645 "../crypto/evp/signature.c" 3 4
                                      ((void *)0)
# 645 "../crypto/evp/signature.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",646,__func__), ERR_set_error)((6),(150),
# 646 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 646 "../crypto/evp/signature.c"
       );
        return -2;
    }
    ...
    ret = ctx->op.sig.signature->sign(ctx->op.sig.algctx, sig, siglen,
                                      (sig == 
# 651 "../crypto/evp/signature.c" 3 4
                                             ((void *)0)
# 651 "../crypto/evp/signature.c"
                                                 ) ? 0 : *siglen, tbs, tbslen);
 ...
 legacy:
    ...
    if (ctx->pmeth == 
# 656 "../crypto/evp/signature.c" 3 4
                     ((void *)0) 
# 656 "../crypto/evp/signature.c"
                          || ctx->pmeth->sign == 
# 656 "../crypto/evp/signature.c" 3 4
                                                 ((void *)0)
# 656 "../crypto/evp/signature.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",657,__func__), ERR_set_error)((6),(150),
# 657 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 657 "../crypto/evp/signature.c"
       );
        return -2;
    }

    if (ctx->pmeth->flags & 2) { size_t pksize = (size_t)EVP_PKEY_get_size(ctx->pkey); if (pksize == 0) { (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",661,__func__), ERR_set_error)((6),(163),
# 661 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 661 "../crypto/evp/signature.c"
   ); return 0; } if (sig == 
# 661 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 661 "../crypto/evp/signature.c"
   ) { *siglen = pksize; return 1; } if (*siglen < pksize) { (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",661,__func__), ERR_set_error)((6),(155),
# 661 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 661 "../crypto/evp/signature.c"
   ); return 0; } }
...
int EVP_PKEY_verify_init(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_signature_init(ctx, (1<<5), 
# 667 "../crypto/evp/signature.c" 3 4
                                                           ((void *)0)
# 667 "../crypto/evp/signature.c"
                                                               );
}

int EVP_PKEY_verify_init_ex(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_pkey_signature_init(ctx, (1<<5), params);
}
                    ...
                    const unsigned char *tbs, size_t tbslen)
{
    ...
    if (ctx == 
# 681 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 681 "../crypto/evp/signature.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",682,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 682 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 682 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->operation != (1<<5)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",687,__func__), ERR_set_error)((6),(151),
# 687 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 687 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->op.sig.algctx == 
# 691 "../crypto/evp/signature.c" 3 4
                             ((void *)0)
# 691 "../crypto/evp/signature.c"
                                 )
        goto legacy;

    if (ctx->op.sig.signature->verify == 
# 694 "../crypto/evp/signature.c" 3 4
                                        ((void *)0)
# 694 "../crypto/evp/signature.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",695,__func__), ERR_set_error)((6),(150),
# 695 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 695 "../crypto/evp/signature.c"
       );
        return -2;
    }
 ...
 legacy:
    if (ctx->pmeth == 
# 704 "../crypto/evp/signature.c" 3 4
                     ((void *)0) 
# 704 "../crypto/evp/signature.c"
                          || ctx->pmeth->verify == 
# 704 "../crypto/evp/signature.c" 3 4
                                                   ((void *)0)
# 704 "../crypto/evp/signature.c"
                                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",705,__func__), ERR_set_error)((6),(150),
# 705 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 705 "../crypto/evp/signature.c"
       );
        return -2;
    }
...
int EVP_PKEY_verify_recover_init(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_signature_init(ctx, (1<<6), 
# 714 "../crypto/evp/signature.c" 3 4
                                                                  ((void *)0)
# 714 "../crypto/evp/signature.c"
                                                                      );
}
...
int EVP_PKEY_verify_recover_init_ex(EVP_PKEY_CTX *ctx,
                                    const OSSL_PARAM params[])
{
    return evp_pkey_signature_init(ctx, (1<<6), params);
}
                            ...
                            const unsigned char *sig, size_t siglen)
{
    ...
    if (ctx == 
# 729 "../crypto/evp/signature.c" 3 4
              ((void *)0)
# 729 "../crypto/evp/signature.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",730,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 730 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 730 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->operation != (1<<6)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",735,__func__), ERR_set_error)((6),(151),
# 735 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 735 "../crypto/evp/signature.c"
       );
        return -1;
    }

    if (ctx->op.sig.algctx == 
# 739 "../crypto/evp/signature.c" 3 4
                             ((void *)0)
# 739 "../crypto/evp/signature.c"
                                 )
        goto legacy;

    if (ctx->op.sig.signature->verify_recover == 
# 742 "../crypto/evp/signature.c" 3 4
                                                ((void *)0)
# 742 "../crypto/evp/signature.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",743,__func__), ERR_set_error)((6),(150),
# 743 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 743 "../crypto/evp/signature.c"
       );
        return -2;
    }
    ...
    ret = ctx->op.sig.signature->verify_recover(ctx->op.sig.algctx, rout,
                                                routlen,
                                                (rout == 
# 749 "../crypto/evp/signature.c" 3 4
                                                        ((void *)0) 
# 749 "../crypto/evp/signature.c"
                                                             ? 0 : *routlen),
                                                sig, siglen);
    return ret;
 legacy:
    if (ctx->pmeth == 
# 753 "../crypto/evp/signature.c" 3 4
                     ((void *)0) 
# 753 "../crypto/evp/signature.c"
                          || ctx->pmeth->verify_recover == 
# 753 "../crypto/evp/signature.c" 3 4
                                                           ((void *)0)
# 753 "../crypto/evp/signature.c"
                                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",754,__func__), ERR_set_error)((6),(150),
# 754 "../crypto/evp/signature.c" 3 4
       ((void *)0)
# 754 "../crypto/evp/signature.c"
       );
        return -2;
    }
    if (ctx->pmeth->flags & 2) { size_t pksize = (size_t)EVP_PKEY_get_size(ctx->pkey); if (pksize == 0) { (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",757,__func__), ERR_set_error)((6),(163),
# 757 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 757 "../crypto/evp/signature.c"
   ); return 0; } if (rout == 
# 757 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 757 "../crypto/evp/signature.c"
   ) { *routlen = pksize; return 1; } if (*routlen < pksize) { (ERR_new(), ERR_set_debug("../crypto/evp/signature.c",757,__func__), ERR_set_error)((6),(155),
# 757 "../crypto/evp/signature.c" 3 4
   ((void *)0)
# 757 "../crypto/evp/signature.c"
   ); return 0; } }
