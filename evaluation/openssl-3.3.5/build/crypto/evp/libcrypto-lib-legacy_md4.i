# 0 "../crypto/evp/legacy_md4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_md4.c"
# 14 "../crypto/evp/legacy_md4.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../crypto/evp/legacy_md4.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 19 "../crypto/evp/legacy_md4.c" 2

static int md4_init(EVP_MD_CTX *ctx) { return MD4_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int md4_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return MD4_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int md4_final(EVP_MD_CTX *ctx, unsigned char *md) { return MD4_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
...
# 28 "../crypto/evp/legacy_md4.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_md4.c"
   , 
# 28 "../crypto/evp/legacy_md4.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_md4.c"
