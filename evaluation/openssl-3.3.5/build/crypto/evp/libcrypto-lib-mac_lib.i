# 0 "../crypto/evp/mac_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/mac_lib.c"
# 10 "../crypto/evp/mac_lib.c"
...
# 14 "../crypto/evp/mac_lib.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../crypto/evp/mac_lib.c" 2
# 1 "../include/openssl/types.h" 1
# 17 "../crypto/evp/mac_lib.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 18 "../crypto/evp/mac_lib.c" 2
...
# 21 "../crypto/evp/mac_lib.c" 2

EVP_MAC_CTX *EVP_MAC_CTX_new(EVP_MAC *mac)
{
    EVP_MAC_CTX *ctx = CRYPTO_zalloc(sizeof(EVP_MAC_CTX), "../crypto/evp/mac_lib.c", 24);

    if (ctx != 
# 26 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 26 "../crypto/evp/mac_lib.c"
                  ) {
        ctx->meth = mac;
        if ((ctx->algctx = mac->newctx(ossl_provider_ctx(mac->prov))) == 
# 28 "../crypto/evp/mac_lib.c" 3 4
                                                                        ((void *)0)
            
# 29 "../crypto/evp/mac_lib.c"
           || !EVP_MAC_up_ref(mac)) {
            mac->freectx(ctx->algctx);
            (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",31,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 31 "../crypto/evp/mac_lib.c" 3 4
           ((void *)0)
# 31 "../crypto/evp/mac_lib.c"
           );
            CRYPTO_free(ctx, "../crypto/evp/mac_lib.c", 32);
            ctx = 
# 33 "../crypto/evp/mac_lib.c" 3 4
                 ((void *)0)
# 33 "../crypto/evp/mac_lib.c"
                     ;
        }
    }
    return ctx;
...
{
    if (ctx == 
# 41 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 41 "../crypto/evp/mac_lib.c"
                  )
        return;
    ctx->meth->freectx(ctx->algctx);
    ctx->algctx = 
# 44 "../crypto/evp/mac_lib.c" 3 4
                 ((void *)0)
# 44 "../crypto/evp/mac_lib.c"
                     ;

    EVP_MAC_free(ctx->meth);
    CRYPTO_free(ctx, "../crypto/evp/mac_lib.c", 47);
}
...
EVP_MAC_CTX *EVP_MAC_CTX_dup(const EVP_MAC_CTX *src)
{
    ...
    if (src->algctx == 
# 54 "../crypto/evp/mac_lib.c" 3 4
                      ((void *)0)
# 54 "../crypto/evp/mac_lib.c"
                          )
        return 
# 55 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 55 "../crypto/evp/mac_lib.c"
                  ;

    dst = CRYPTO_malloc(sizeof(*dst), "../crypto/evp/mac_lib.c", 57);
    if (dst == 
# 58 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 58 "../crypto/evp/mac_lib.c"
                  )
        return 
# 59 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 59 "../crypto/evp/mac_lib.c"
                  ;

    *dst = *src;
    if (!EVP_MAC_up_ref(dst->meth)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",63,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 63 "../crypto/evp/mac_lib.c" 3 4
       ((void *)0)
# 63 "../crypto/evp/mac_lib.c"
       );
        CRYPTO_free(dst, "../crypto/evp/mac_lib.c", 64);
        return 
# 65 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 65 "../crypto/evp/mac_lib.c"
                  ;
    }

    dst->algctx = src->meth->dupctx(src->algctx);
    if (dst->algctx == 
# 69 "../crypto/evp/mac_lib.c" 3 4
                      ((void *)0)
# 69 "../crypto/evp/mac_lib.c"
                          ) {
        EVP_MAC_CTX_free(dst);
        return 
# 71 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 71 "../crypto/evp/mac_lib.c"
                  ;
    }
...
static size_t get_size_t_ctx_param(EVP_MAC_CTX *ctx, const char *name)
{
    ...
    if (ctx->algctx != 
# 86 "../crypto/evp/mac_lib.c" 3 4
                      ((void *)0)
# 86 "../crypto/evp/mac_lib.c"
                          ) {
        OSSL_PARAM params[2] = { { 
# 87 "../crypto/evp/mac_lib.c" 3 4
                                ((void *)0)
# 87 "../crypto/evp/mac_lib.c"
                                , 0, 
# 87 "../crypto/evp/mac_lib.c" 3 4
                                ((void *)0)
# 87 "../crypto/evp/mac_lib.c"
...
# 87 "../crypto/evp/mac_lib.c"
        ...
        if (ctx->meth->get_ctx_params != 
# 90 "../crypto/evp/mac_lib.c" 3 4
                                        ((void *)0)
# 90 "../crypto/evp/mac_lib.c"
                                            ) {
            if (ctx->meth->get_ctx_params(ctx->algctx, params))
                return sz;
        } else if (ctx->meth->get_params != 
# 93 "../crypto/evp/mac_lib.c" 3 4
                                           ((void *)0)
# 93 "../crypto/evp/mac_lib.c"
                                               ) {
...
size_t EVP_MAC_CTX_get_mac_size(EVP_MAC_CTX *ctx)
{
    return get_size_t_ctx_param(ctx, "size");
}

size_t EVP_MAC_CTX_get_block_size(EVP_MAC_CTX *ctx)
{
    return get_size_t_ctx_param(ctx, "block-size");
}
                         ...
                         unsigned char *out, size_t *outl, size_t outsize)
{
    ...
    if (ctx == 
# 134 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0) 
# 134 "../crypto/evp/mac_lib.c"
                   || ctx->meth == 
# 134 "../crypto/evp/mac_lib.c" 3 4
                                   ((void *)0)
# 134 "../crypto/evp/mac_lib.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",135,__func__), ERR_set_error)((6),(218),
# 135 "../crypto/evp/mac_lib.c" 3 4
       ((void *)0)
# 135 "../crypto/evp/mac_lib.c"
       );
        return 0;
    }
    if (ctx->meth->final == 
# 138 "../crypto/evp/mac_lib.c" 3 4
                           ((void *)0)
# 138 "../crypto/evp/mac_lib.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",139,__func__), ERR_set_error)((6),(188),
# 139 "../crypto/evp/mac_lib.c" 3 4
       ((void *)0)
# 139 "../crypto/evp/mac_lib.c"
       );
        return 0;
    }
    ...
    if (out == 
# 144 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 144 "../crypto/evp/mac_lib.c"
                  ) {
        if (outl == 
# 145 "../crypto/evp/mac_lib.c" 3 4
                   ((void *)0)
# 145 "../crypto/evp/mac_lib.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",146,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 146 "../crypto/evp/mac_lib.c" 3 4
           ((void *)0)
# 146 "../crypto/evp/mac_lib.c"
           );
            return 0;
        }
        *outl = macsize;
    ...
    if (outsize < macsize) {
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",153,__func__), ERR_set_error)((6),(155),
# 153 "../crypto/evp/mac_lib.c" 3 4
       ((void *)0)
# 153 "../crypto/evp/mac_lib.c"
       );
        return 0;
    }
    if (xof) {
        params[0] = OSSL_PARAM_construct_int("xof", &xof);
        params[1] = OSSL_PARAM_construct_end();

        if (EVP_MAC_CTX_set_params(ctx, params) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",161,__func__), ERR_set_error)((6),(227),
# 161 "../crypto/evp/mac_lib.c" 3 4
           ((void *)0)
# 161 "../crypto/evp/mac_lib.c"
           );
            return 0;
        }
    }
    ...
    if (outl != 
# 166 "../crypto/evp/mac_lib.c" 3 4
               ((void *)0)
# 166 "../crypto/evp/mac_lib.c"
                   )
        *outl = l;
    return res;
}
...
int EVP_MAC_finalXOF(EVP_MAC_CTX *ctx, unsigned char *out, size_t outsize)
{
    return evp_mac_final(ctx, 1, out, 
# 179 "../crypto/evp/mac_lib.c" 3 4
                                     ((void *)0)
# 179 "../crypto/evp/mac_lib.c"
                                         , outsize);
}
...
{
    if (mac->get_params != 
# 190 "../crypto/evp/mac_lib.c" 3 4
                          ((void *)0)
# 190 "../crypto/evp/mac_lib.c"
                              )
...
{
    if (ctx->meth->get_ctx_params != 
# 197 "../crypto/evp/mac_lib.c" 3 4
                                    ((void *)0)
# 197 "../crypto/evp/mac_lib.c"
                                        )
...
# 204 "../crypto/evp/mac_lib.c" 3 4
                                    ((void *)0)
# 204 "../crypto/evp/mac_lib.c"
                                        )
...
{
    return mac != 
# 226 "../crypto/evp/mac_lib.c" 3 4
                 ((void *)0) 
# 226 "../crypto/evp/mac_lib.c"
                      && evp_is_a(mac->prov, mac->name_id, 
# 226 "../crypto/evp/mac_lib.c" 3 4
                                                           ((void *)0)
# 226 "../crypto/evp/mac_lib.c"
                                                               , name);
...
{
    if (mac->prov != 
# 233 "../crypto/evp/mac_lib.c" 3 4
                    ((void *)0)
# 233 "../crypto/evp/mac_lib.c"
                        )
...
# 247 "../crypto/evp/mac_lib.c" 3 4
                                 ((void *)0)
# 247 "../crypto/evp/mac_lib.c"
                                 , 0, 
# 247 "../crypto/evp/mac_lib.c" 3 4
                                 ((void *)0)
# 247 "../crypto/evp/mac_lib.c"
...
# 247 "../crypto/evp/mac_lib.c"
                                                 , 0, 0 } };
    EVP_MAC_CTX *ctx = 
# 248 "../crypto/evp/mac_lib.c" 3 4
                       ((void *)0)
# 248 "../crypto/evp/mac_lib.c"
                           ;
    size_t len = 0;
    unsigned char *res = 
# 250 "../crypto/evp/mac_lib.c" 3 4
                        ((void *)0)
# 250 "../crypto/evp/mac_lib.c"
                            ;

    if (outlen != 
# 252 "../crypto/evp/mac_lib.c" 3 4
                 ((void *)0)
# 252 "../crypto/evp/mac_lib.c"
                     )
        *outlen = 0;
    if (mac == 
# 254 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 254 "../crypto/evp/mac_lib.c"
                  )
        return 
# 255 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0)
# 255 "../crypto/evp/mac_lib.c"
                  ;
    if (subalg != 
# 256 "../crypto/evp/mac_lib.c" 3 4
                 ((void *)0)
# 256 "../crypto/evp/mac_lib.c"
                     ) {
        const OSSL_PARAM *defined_params = EVP_MAC_settable_ctx_params(mac);
        const char *param_name = "digest";
        ...
        if (OSSL_PARAM_locate_const(defined_params, param_name) == 
# 265 "../crypto/evp/mac_lib.c" 3 4
                                                                  ((void *)0)
# 265 "../crypto/evp/mac_lib.c"
                                                                      ) {
            param_name = "cipher";
            if (OSSL_PARAM_locate_const(defined_params, param_name) == 
# 267 "../crypto/evp/mac_lib.c" 3 4
                                                                      ((void *)0)
# 267 "../crypto/evp/mac_lib.c"
                                                                          ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/mac_lib.c",268,__func__), ERR_set_error)((6),((262|(0x2 << 18L))),
# 268 "../crypto/evp/mac_lib.c" 3 4
               ((void *)0)
# 268 "../crypto/evp/mac_lib.c"
               );
                goto err;
            }
        }
    ...
    if (key == 
# 276 "../crypto/evp/mac_lib.c" 3 4
              ((void *)0) 
# 276 "../crypto/evp/mac_lib.c"
                   && keylen == 0)
        key = data;
    if ((ctx = EVP_MAC_CTX_new(mac)) != 
# 278 "../crypto/evp/mac_lib.c" 3 4
                                       ((void *)0)
            
# 279 "../crypto/evp/mac_lib.c"
        ...
        if (out == 
# 284 "../crypto/evp/mac_lib.c" 3 4
                  ((void *)0)
# 284 "../crypto/evp/mac_lib.c"
                      ) {
            out = CRYPTO_malloc(len, "../crypto/evp/mac_lib.c", 285);
            if (out != 
# 286 "../crypto/evp/mac_lib.c" 3 4
                      ((void *)0) 
# 286 "../crypto/evp/mac_lib.c"
                           && !EVP_MAC_final(ctx, out, 
# 286 "../crypto/evp/mac_lib.c" 3 4
                                                       ((void *)0)
# 286 "../crypto/evp/mac_lib.c"
                                                           , len)) {
                CRYPTO_free(out, "../crypto/evp/mac_lib.c", 287);
                out = 
# 288 "../crypto/evp/mac_lib.c" 3 4
                     ((void *)0)
# 288 "../crypto/evp/mac_lib.c"
                         ;
            }
        }
        res = out;
        if (res != 
# 292 "../crypto/evp/mac_lib.c" 3 4
                  ((void *)0) 
# 292 "../crypto/evp/mac_lib.c"
                       && outlen != 
# 292 "../crypto/evp/mac_lib.c" 3 4
                                    ((void *)0)
# 292 "../crypto/evp/mac_lib.c"
