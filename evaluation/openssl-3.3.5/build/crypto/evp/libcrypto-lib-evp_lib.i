# 0 "../crypto/evp/evp_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_lib.c"
# 14 "../crypto/evp/evp_lib.c"
...
# 20 "../crypto/evp/evp_lib.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 23 "../crypto/evp/evp_lib.c" 2
...
# 33 "../crypto/evp/evp_lib.c" 2

int EVP_CIPHER_param_to_asn1(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
    return evp_cipher_param_to_asn1_ex(c, type, 
# 36 "../crypto/evp/evp_lib.c" 3 4
                                               ((void *)0)
# 36 "../crypto/evp/evp_lib.c"
                                                   );
}

int EVP_CIPHER_asn1_to_param(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
    return evp_cipher_asn1_to_param_ex(c, type, 
# 41 "../crypto/evp/evp_lib.c" 3 4
                                               ((void *)0)
# 41 "../crypto/evp/evp_lib.c"
                                                   );
}
...
int EVP_CIPHER_get_asn1_iv(EVP_CIPHER_CTX *ctx, ASN1_TYPE *type)
{
    ...
    if (type != 
# 49 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0)
# 49 "../crypto/evp/evp_lib.c"
                   ) {
        unsigned char iv[16];

        l = EVP_CIPHER_CTX_get_iv_length(ctx);
        if (!__builtin_expect(!!((l <= sizeof(iv)) != 0), 1))
            return -1;
...
# 59 "../crypto/evp/evp_lib.c" 3 4
                                   ((void *)0)
# 59 "../crypto/evp/evp_lib.c"
                                       , 
# 59 "../crypto/evp/evp_lib.c" 3 4
                                         ((void *)0)
# 59 "../crypto/evp/evp_lib.c"
...
int EVP_CIPHER_set_asn1_iv(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
    ...
    unsigned int j;
    unsigned char *oiv = 
# 69 "../crypto/evp/evp_lib.c" 3 4
                        ((void *)0)
# 69 "../crypto/evp/evp_lib.c"
                            ;

    if (type != 
# 71 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0)
# 71 "../crypto/evp/evp_lib.c"
                   ) {
        oiv = (unsigned char *)EVP_CIPHER_CTX_original_iv(c);
        j = EVP_CIPHER_CTX_get_iv_length(c);
        (void)((j <= sizeof(c->iv)) ? 0 : (OPENSSL_die("assertion failed: " "j <= sizeof(c->iv)", "../crypto/evp/evp_lib.c", 74), 1));
                                ...
                                evp_cipher_aead_asn1_params *asn1_params)
{
    ...
    if (c == 
# 86 "../crypto/evp/evp_lib.c" 3 4
            ((void *)0) 
# 86 "../crypto/evp/evp_lib.c"
                 || c->cipher == 
# 86 "../crypto/evp/evp_lib.c" 3 4
                                 ((void *)0)
# 86 "../crypto/evp/evp_lib.c"
    ...
    cipher = c->cipher;
# 106 "../crypto/evp/evp_lib.c"
    if (cipher->set_asn1_parameters != 
# 106 "../crypto/evp/evp_lib.c" 3 4
                                      ((void *)0)
# 106 "../crypto/evp/evp_lib.c"
                                          ) {
        ret = cipher->set_asn1_parameters(c, type);
    } else if ((EVP_CIPHER_get_flags(cipher) & 0x1000000) == 0) {
        switch (EVP_CIPHER_get_mode(cipher)) {
        case 0x10002:
            if (EVP_CIPHER_is_a(cipher, "id-smime-alg-CMS3DESwrap"))
                ASN1_TYPE_set(type, 5, 
# 112 "../crypto/evp/evp_lib.c" 3 4
                                                ((void *)0)
# 112 "../crypto/evp/evp_lib.c"
                                                    );
            ret = 1;
            break;
...
# 129 "../crypto/evp/evp_lib.c" 3 4
                              ((void *)0)
# 129 "../crypto/evp/evp_lib.c"
                                  ) {
        OSSL_PARAM params[3], *p = params;
        unsigned char *der = 
# 131 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 131 "../crypto/evp/evp_lib.c"
                                , *derp;
...
# 139 "../crypto/evp/evp_lib.c" 3 4
                      ((void *)0)
# 139 "../crypto/evp/evp_lib.c"
                          , 0);
        *p = OSSL_PARAM_construct_end();
        ...
        if (OSSL_PARAM_modified(params)
            ...
            && (der = CRYPTO_malloc(params[0].return_size, "../crypto/evp/evp_lib.c", 148)) != 
# 148 "../crypto/evp/evp_lib.c" 3 4
                                                               ((void *)0)
# 148 "../crypto/evp/evp_lib.c"
                                                                   ) {
            params[0].data = der;
...
# 156 "../crypto/evp/evp_lib.c" 3 4
                                                          ((void *)0)
# 156 "../crypto/evp/evp_lib.c"
                                                              ) {
                ret = 1;
            }
            CRYPTO_free(der, "../crypto/evp/evp_lib.c", 159);
        }
    } else {
        ret = -2;
    }
 ...
 err:
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",167,__func__), ERR_set_error)((6),(107),
# 167 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 167 "../crypto/evp/evp_lib.c"
       );
    else if (ret <= 0)
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",169,__func__), ERR_set_error)((6),(122),
# 169 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 169 "../crypto/evp/evp_lib.c"
       );
    if (ret < -1)
        ret = -1;
    return ret;
                                ...
                                evp_cipher_aead_asn1_params *asn1_params)
{
    ...
    if (c == 
# 181 "../crypto/evp/evp_lib.c" 3 4
            ((void *)0) 
# 181 "../crypto/evp/evp_lib.c"
                 || c->cipher == 
# 181 "../crypto/evp/evp_lib.c" 3 4
                                 ((void *)0)
# 181 "../crypto/evp/evp_lib.c"
    ...
    cipher = c->cipher;
# 201 "../crypto/evp/evp_lib.c"
    if (cipher->get_asn1_parameters != 
# 201 "../crypto/evp/evp_lib.c" 3 4
                                      ((void *)0)
# 201 "../crypto/evp/evp_lib.c"
                                          ) {
...
# 222 "../crypto/evp/evp_lib.c" 3 4
                              ((void *)0)
# 222 "../crypto/evp/evp_lib.c"
                                  ) {
        OSSL_PARAM params[3], *p = params;
        unsigned char *der = 
# 224 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 224 "../crypto/evp/evp_lib.c"
                                ;
        int derl = -1;
        ...
        if ((derl = i2d_ASN1_TYPE(type, &der)) >= 0) {
            ...
            *p = OSSL_PARAM_construct_end();
            if (EVP_CIPHER_CTX_set_params(c, params))
                ret = 1;
            CRYPTO_free(der, "../crypto/evp/evp_lib.c", 235);
        }
    } else {
        ret = -2;
    }
...
err:
    if (ret == -2)
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",243,__func__), ERR_set_error)((6),(107),
# 243 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 243 "../crypto/evp/evp_lib.c"
       );
    else if (ret <= 0)
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",245,__func__), ERR_set_error)((6),(122),
# 245 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 245 "../crypto/evp/evp_lib.c"
       );
    if (ret < -1)
        ret = -1;
    return ret;
                                    ...
                                    evp_cipher_aead_asn1_params *asn1_params)
{
    ...
    if (type == 
# 258 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0) 
# 258 "../crypto/evp/evp_lib.c"
                    || asn1_params == 
# 258 "../crypto/evp/evp_lib.c" 3 4
                                      ((void *)0)
# 258 "../crypto/evp/evp_lib.c"
    ...
    i = ossl_asn1_type_get_octetstring_int(type, &tl, 
# 261 "../crypto/evp/evp_lib.c" 3 4
                                                     ((void *)0)
# 261 "../crypto/evp/evp_lib.c"
                                                         , 16);
    if (i <= 0)
        return -1;
...
{
    if (type == 
# 275 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0) 
# 275 "../crypto/evp/evp_lib.c"
                    || asn1_params == 
# 275 "../crypto/evp/evp_lib.c" 3 4
                                      ((void *)0)
# 275 "../crypto/evp/evp_lib.c"
...
int EVP_CIPHER_get_type(const EVP_CIPHER *cipher)
{
    ...
    default:
...

        {
            ...
            if (OBJ_get0_data(otmp) == 
# 341 "../crypto/evp/evp_lib.c" 3 4
                                      ((void *)0)
# 341 "../crypto/evp/evp_lib.c"
                                          )
                nid = 0;
...
int evp_cipher_cache_constants(EVP_CIPHER *cipher)
{
    ...
    params[1] = OSSL_PARAM_construct_size_t("ivlen", &ivlen);
    params[2] = OSSL_PARAM_construct_size_t("keylen", &keylen);
    params[3] = OSSL_PARAM_construct_uint("mode", &mode);
    params[4] = OSSL_PARAM_construct_int("aead", &aead);
    params[5] = OSSL_PARAM_construct_int("custom-iv",
                                         &custom_iv);
    params[6] = OSSL_PARAM_construct_int("cts", &cts);
    params[7] = OSSL_PARAM_construct_int("tls-multi",
                                         &multiblock);
    params[8] = OSSL_PARAM_construct_int("has-randkey",
                                         &randkey);
    ...
    if (ok) {
        ...
        cipher->flags = mode;
        if (aead)
            cipher->flags |= 0x200000;
        if (custom_iv)
            cipher->flags |= 0x10;
        if (cts)
            cipher->flags |= 0x4000;
        if (multiblock)
            cipher->flags |= 0x400000;
        if (cipher->ccipher != 
# 386 "../crypto/evp/evp_lib.c" 3 4
                              ((void *)0)
# 386 "../crypto/evp/evp_lib.c"
                                  )
            cipher->flags |= 0x100000;
        if (randkey)
            cipher->flags |= 0x200;
        if (OSSL_PARAM_locate_const(EVP_CIPHER_gettable_ctx_params(cipher),
                                    "alg_id_param"))
            cipher->flags |= 0x1000000;
    }
    return ok;
}
...
{
    return (cipher == 
# 399 "../crypto/evp/evp_lib.c" 3 4
                     ((void *)0)
# 399 "../crypto/evp/evp_lib.c"
                         ) ? 0 : cipher->block_size;
}
...
{
    if (ctx == 
# 415 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0) 
# 415 "../crypto/evp/evp_lib.c"
                   || ctx->cipher == 
# 415 "../crypto/evp/evp_lib.c" 3 4
                                     ((void *)0)
# 415 "../crypto/evp/evp_lib.c"
    ...
    if (ctx->cipher->prov != 
# 418 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 418 "../crypto/evp/evp_lib.c"
                                ) {
...
# 433 "../crypto/evp/evp_lib.c" 3 4
                                   ((void *)0)
# 433 "../crypto/evp/evp_lib.c"
                                       )
...
# 438 "../crypto/evp/evp_lib.c" 3 4
                      ((void *)0)
# 438 "../crypto/evp/evp_lib.c"
                          )
...
{
    if (ctx == 
# 455 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 455 "../crypto/evp/evp_lib.c"
                  )
        return 
# 456 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 456 "../crypto/evp/evp_lib.c"
                  ;
    return ctx->cipher;
}
...
{
    if (ctx == 
# 463 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 463 "../crypto/evp/evp_lib.c"
                  )
        return 
# 464 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 464 "../crypto/evp/evp_lib.c"
                  ;
    return ctx->cipher;
}
...
EVP_CIPHER *EVP_CIPHER_CTX_get1_cipher(EVP_CIPHER_CTX *ctx)
{
    ...
    if (ctx == 
# 472 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0) 
# 472 "../crypto/evp/evp_lib.c"
                   || ctx->cipher == 
# 472 "../crypto/evp/evp_lib.c" 3 4
                                     ((void *)0)
# 472 "../crypto/evp/evp_lib.c"
        ...
        return 
# 473 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 473 "../crypto/evp/evp_lib.c"
                  ;
    cipher = (EVP_CIPHER *)ctx->cipher;
    if (!EVP_CIPHER_up_ref(cipher))
        return 
# 476 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 476 "../crypto/evp/evp_lib.c"
                  ;
    return cipher;
}
...
{
    return cipher == 
# 487 "../crypto/evp/evp_lib.c" 3 4
                    ((void *)0) 
# 487 "../crypto/evp/evp_lib.c"
                         ? 0 : cipher->flags;
}
...
{
    return (cipher == 
# 517 "../crypto/evp/evp_lib.c" 3 4
                     ((void *)0)
# 517 "../crypto/evp/evp_lib.c"
                         ) ? 0 : cipher->iv_len;
}
...
{
    if (ctx->cipher == 
# 522 "../crypto/evp/evp_lib.c" 3 4
                      ((void *)0)
# 522 "../crypto/evp/evp_lib.c"
                          )
        return 0;
    ...
    if (ctx->iv_len < 0) {
        ...
        size_t v = len;
        OSSL_PARAM params[2] = { { 
# 528 "../crypto/evp/evp_lib.c" 3 4
                                ((void *)0)
# 528 "../crypto/evp/evp_lib.c"
                                , 0, 
# 528 "../crypto/evp/evp_lib.c" 3 4
                                ((void *)0)
# 528 "../crypto/evp/evp_lib.c"
...
# 530 "../crypto/evp/evp_lib.c" 3 4
                                          ((void *)0)
# 530 "../crypto/evp/evp_lib.c"
                                              ) {
            ...
            if (rv > 0) {
                ...
                return -1;
                  ...
                  & 0x800) != 0) {
            rv = EVP_CIPHER_CTX_ctrl((EVP_CIPHER_CTX *)ctx, 0x25,
                                     0, &len);
            if (rv <= 0)
                return -1;
        }
...
int EVP_CIPHER_CTX_get_tag_length(const EVP_CIPHER_CTX *ctx)
{
    ...
    size_t v = 0;
    OSSL_PARAM params[2] = { { 
# 563 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 563 "../crypto/evp/evp_lib.c"
                            , 0, 
# 563 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 563 "../crypto/evp/evp_lib.c"
...
# 563 "../crypto/evp/evp_lib.c"
    ...
    params[0] = OSSL_PARAM_construct_size_t("taglen", &v);
...
const unsigned char *EVP_CIPHER_CTX_original_iv(const EVP_CIPHER_CTX *ctx)
{
    ...
    OSSL_PARAM params[2] = { { 
# 575 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 575 "../crypto/evp/evp_lib.c"
                            , 0, 
# 575 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 575 "../crypto/evp/evp_lib.c"
...
# 575 "../crypto/evp/evp_lib.c"
    ...
    params[0] =
        OSSL_PARAM_construct_octet_ptr("iv",
                                       (void **)&v, sizeof(ctx->oiv));
    ok = evp_do_ciph_ctx_getparams(ctx->cipher, ctx->algctx, params);

    return ok != 0 ? v : 
# 582 "../crypto/evp/evp_lib.c" 3 4
                        ((void *)0)
# 582 "../crypto/evp/evp_lib.c"
                            ;
}
...
const unsigned char *EVP_CIPHER_CTX_iv(const EVP_CIPHER_CTX *ctx)
{
    ...
    OSSL_PARAM params[2] = { { 
# 592 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 592 "../crypto/evp/evp_lib.c"
                            , 0, 
# 592 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 592 "../crypto/evp/evp_lib.c"
...
# 592 "../crypto/evp/evp_lib.c"
    ...
    params[0] =
        OSSL_PARAM_construct_octet_ptr("updated-iv",
                                       (void **)&v, sizeof(ctx->iv));
    ok = evp_do_ciph_ctx_getparams(ctx->cipher, ctx->algctx, params);

    return ok != 0 ? v : 
# 599 "../crypto/evp/evp_lib.c" 3 4
                        ((void *)0)
# 599 "../crypto/evp/evp_lib.c"
                            ;
}
...
unsigned char *EVP_CIPHER_CTX_iv_noconst(EVP_CIPHER_CTX *ctx)
{
    ...
    OSSL_PARAM params[2] = { { 
# 606 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 606 "../crypto/evp/evp_lib.c"
                            , 0, 
# 606 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 606 "../crypto/evp/evp_lib.c"
...
# 606 "../crypto/evp/evp_lib.c"
    ...
    return ok != 0 ? v : 
# 613 "../crypto/evp/evp_lib.c" 3 4
                        ((void *)0)
# 613 "../crypto/evp/evp_lib.c"
                            ;
}
...
{
    OSSL_PARAM params[2] = { { 
# 619 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 619 "../crypto/evp/evp_lib.c"
                            , 0, 
# 619 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 619 "../crypto/evp/evp_lib.c"
...
# 619 "../crypto/evp/evp_lib.c"
    ...
    params[0] =
        OSSL_PARAM_construct_octet_string("updated-iv", buf, len);
...
{
    OSSL_PARAM params[2] = { { 
# 628 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 628 "../crypto/evp/evp_lib.c"
                            , 0, 
# 628 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 628 "../crypto/evp/evp_lib.c"
...
# 628 "../crypto/evp/evp_lib.c"
    ...
    params[0] =
        OSSL_PARAM_construct_octet_string("iv", buf, len);
    return evp_do_ciph_ctx_getparams(ctx->cipher, ctx->algctx, params) > 0;
}
...
int EVP_CIPHER_CTX_get_num(const EVP_CIPHER_CTX *ctx)
{
    ...
    OSSL_PARAM params[2] = { { 
# 644 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 644 "../crypto/evp/evp_lib.c"
                            , 0, 
# 644 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 644 "../crypto/evp/evp_lib.c"
...
# 644 "../crypto/evp/evp_lib.c"
    ...
    params[0] = OSSL_PARAM_construct_uint("num", &v);
    ok = evp_do_ciph_ctx_getparams(ctx->cipher, ctx->algctx, params);
...
int EVP_CIPHER_CTX_set_num(EVP_CIPHER_CTX *ctx, int num)
{
    ...
    OSSL_PARAM params[2] = { { 
# 656 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 656 "../crypto/evp/evp_lib.c"
                            , 0, 
# 656 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 656 "../crypto/evp/evp_lib.c"
...
# 656 "../crypto/evp/evp_lib.c"
    ...
    params[0] = OSSL_PARAM_construct_uint("num", &n);
...
int EVP_CIPHER_CTX_get_key_length(const EVP_CIPHER_CTX *ctx)
{
    if (ctx->key_len <= 0 && ctx->cipher->prov != 
# 673 "../crypto/evp/evp_lib.c" 3 4
                                                 ((void *)0)
# 673 "../crypto/evp/evp_lib.c"
                                                     ) {
        int ok;
        OSSL_PARAM params[2] = { { 
# 675 "../crypto/evp/evp_lib.c" 3 4
                                ((void *)0)
# 675 "../crypto/evp/evp_lib.c"
                                , 0, 
# 675 "../crypto/evp/evp_lib.c" 3 4
                                ((void *)0)
# 675 "../crypto/evp/evp_lib.c"
...
{
    return (cipher == 
# 699 "../crypto/evp/evp_lib.c" 3 4
                     ((void *)0)
# 699 "../crypto/evp/evp_lib.c"
                         ) ? 0 : cipher->nid;
}
...
{
    if (cipher == 
# 709 "../crypto/evp/evp_lib.c" 3 4
                 ((void *)0)
# 709 "../crypto/evp/evp_lib.c"
                     )
        return 0;
    if (cipher->prov != 
# 711 "../crypto/evp/evp_lib.c" 3 4
                       ((void *)0)
# 711 "../crypto/evp/evp_lib.c"
                           )
        return evp_is_a(cipher->prov, cipher->name_id, 
# 712 "../crypto/evp/evp_lib.c" 3 4
                                                      ((void *)0)
# 712 "../crypto/evp/evp_lib.c"
                                                          , name);
    return evp_is_a(
# 713 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 713 "../crypto/evp/evp_lib.c"
                       , 0, EVP_CIPHER_get0_name(cipher), name);
}
...
{
    if (cipher->type_name != 
# 723 "../crypto/evp/evp_lib.c" 3 4
                            ((void *)0)
# 723 "../crypto/evp/evp_lib.c"
                                )
...
# 734 "../crypto/evp/evp_lib.c" 3 4
                              ((void *)0)
# 734 "../crypto/evp/evp_lib.c"
                                  )
...
{
    if (cipher->prov != 
# 747 "../crypto/evp/evp_lib.c" 3 4
                       ((void *)0)
# 747 "../crypto/evp/evp_lib.c"
                           )
...
int EVP_CIPHER_get_mode(const EVP_CIPHER *cipher)
{
    return EVP_CIPHER_get_flags(cipher) & 0xF0007;
}

int EVP_MD_is_a(const EVP_MD *md, const char *name)
{
    if (md == 
# 765 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0)
# 765 "../crypto/evp/evp_lib.c"
                 )
        return 0;
    if (md->prov != 
# 767 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 767 "../crypto/evp/evp_lib.c"
                       )
        return evp_is_a(md->prov, md->name_id, 
# 768 "../crypto/evp/evp_lib.c" 3 4
                                              ((void *)0)
# 768 "../crypto/evp/evp_lib.c"
                                                  , name);
    return evp_is_a(
# 769 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 769 "../crypto/evp/evp_lib.c"
                       , 0, EVP_MD_get0_name(md), name);
}
...
{
    if (md->description != 
# 779 "../crypto/evp/evp_lib.c" 3 4
                          ((void *)0)
# 779 "../crypto/evp/evp_lib.c"
                              )
        return md->description;

    return OBJ_nid2ln(EVP_MD_get_type(md));
...
{
    if (md == 
# 790 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0)
# 790 "../crypto/evp/evp_lib.c"
                 )
        return 
# 791 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 791 "../crypto/evp/evp_lib.c"
                  ;
    if (md->type_name != 
# 792 "../crypto/evp/evp_lib.c" 3 4
                        ((void *)0)
# 792 "../crypto/evp/evp_lib.c"
                            )
        return md->type_name;

    return OBJ_nid2sn(EVP_MD_get_type(md));
...
{
    if (md->prov != 
# 805 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 805 "../crypto/evp/evp_lib.c"
                       )
...
{
    if (md == 
# 828 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0)
# 828 "../crypto/evp/evp_lib.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",829,__func__), ERR_set_error)((6),(159),
# 829 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 829 "../crypto/evp/evp_lib.c"
       );
        return -1;
    }
...
{
    if (md == 
# 837 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0)
# 837 "../crypto/evp/evp_lib.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",838,__func__), ERR_set_error)((6),(159),
# 838 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 838 "../crypto/evp/evp_lib.c"
       );
        return -1;
    }
    return md->md_size;
...
EVP_MD *EVP_MD_meth_new(int md_type, int pkey_type)
{
    ...
    if (md != 
# 853 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0)
# 853 "../crypto/evp/evp_lib.c"
                 ) {
        md->type = md_type;
...
{
    EVP_MD *to = 
# 863 "../crypto/evp/evp_lib.c" 3 4
                ((void *)0)
# 863 "../crypto/evp/evp_lib.c"
                    ;
    ...
    if (md->prov != 
# 869 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 869 "../crypto/evp/evp_lib.c"
                       )
        return 
# 870 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 870 "../crypto/evp/evp_lib.c"
                  ;

    if ((to = EVP_MD_meth_new(md->type, md->pkey_type)) != 
# 872 "../crypto/evp/evp_lib.c" 3 4
                                                          ((void *)0)
# 872 "../crypto/evp/evp_lib.c"
                                                              ) {
...
void evp_md_free_int(EVP_MD *md)
{
    CRYPTO_free(md->type_name, "../crypto/evp/evp_lib.c", 884);
    ossl_provider_free(md->prov);
    CRYPTO_FREE_REF(&md->refcnt);
    CRYPTO_free(md, "../crypto/evp/evp_lib.c", 887);
}

void EVP_MD_meth_free(EVP_MD *md)
{
    if (md == 
# 892 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0) 
# 892 "../crypto/evp/evp_lib.c"
                  || md->origin != 2)
       return;
...
{
    if (md->init != 
# 932 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 932 "../crypto/evp/evp_lib.c"
                       )
        return 0;
...
{
    if (md->update != 
# 942 "../crypto/evp/evp_lib.c" 3 4
                     ((void *)0)
# 942 "../crypto/evp/evp_lib.c"
                         )
        return 0;
...
{
    if (md->final != 
# 951 "../crypto/evp/evp_lib.c" 3 4
                    ((void *)0)
# 951 "../crypto/evp/evp_lib.c"
                        )
        return 0;
...
{
    if (md->copy != 
# 960 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 960 "../crypto/evp/evp_lib.c"
                       )
        return 0;
...
{
    if (md->cleanup != 
# 968 "../crypto/evp/evp_lib.c" 3 4
                      ((void *)0)
# 968 "../crypto/evp/evp_lib.c"
                          )
        return 0;
...
{
    if (md->md_ctrl != 
# 977 "../crypto/evp/evp_lib.c" 3 4
                      ((void *)0)
# 977 "../crypto/evp/evp_lib.c"
                          )
        return 0;
...
{
    if (ctx == 
# 1033 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1033 "../crypto/evp/evp_lib.c"
                  )
        return 
# 1034 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1034 "../crypto/evp/evp_lib.c"
                  ;
...
{
    if (ctx == 
# 1041 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1041 "../crypto/evp/evp_lib.c"
                  )
        return 
# 1042 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1042 "../crypto/evp/evp_lib.c"
                  ;
    return ctx->reqdigest;
}
...
EVP_MD *EVP_MD_CTX_get1_md(EVP_MD_CTX *ctx)
{
    ...
    if (ctx == 
# 1050 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1050 "../crypto/evp/evp_lib.c"
                  )
        return 
# 1051 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1051 "../crypto/evp/evp_lib.c"
                  ;
    md = (EVP_MD *)ctx->reqdigest;
    if (md == 
# 1053 "../crypto/evp/evp_lib.c" 3 4
             ((void *)0) 
# 1053 "../crypto/evp/evp_lib.c"
                  || !EVP_MD_up_ref(md))
        return 
# 1054 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
# 1054 "../crypto/evp/evp_lib.c"
                  ;
    return md;
}
...
void EVP_MD_CTX_set_pkey_ctx(EVP_MD_CTX *ctx, EVP_PKEY_CTX *pctx)
{
    ...
    if (pctx != 
# 1075 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0)
# 1075 "../crypto/evp/evp_lib.c"
                   ) {

        EVP_MD_CTX_set_flags(ctx, 0x0400);
    } else {
        EVP_MD_CTX_clear_flags(ctx, 0x0400);
    }
}
...
{
    OSSL_PARAM params[] = { { 
# 1120 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1120 "../crypto/evp/evp_lib.c"
                           , 0, 
# 1120 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1120 "../crypto/evp/evp_lib.c"
...
# 1120 "../crypto/evp/evp_lib.c"
    ...
    params[0] = OSSL_PARAM_construct_uint("use-bits", &enable);
...
void EVP_CIPHER_CTX_set_flags(EVP_CIPHER_CTX *ctx, int flags)
{
    ...
    ctx->flags |= flags;
    if (((oldflags ^ ctx->flags) & 0x2000) != 0)
...
{
    OSSL_PARAM params[] = { { 
# 1153 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1153 "../crypto/evp/evp_lib.c"
                           , 0, 
# 1153 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1153 "../crypto/evp/evp_lib.c"
...
# 1153 "../crypto/evp/evp_lib.c"
    ...
    if (ctx == 
# 1155 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0) 
# 1155 "../crypto/evp/evp_lib.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",1156,__func__), ERR_set_error)((6),(147),
# 1156 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 1156 "../crypto/evp/evp_lib.c"
       );
    ...
    if (name == 
# 1161 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0)
# 1161 "../crypto/evp/evp_lib.c"
                   )
        return -1;
...
{
    OSSL_PARAM params[] = { { 
# 1171 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1171 "../crypto/evp/evp_lib.c"
                           , 0, 
# 1171 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1171 "../crypto/evp/evp_lib.c"
...
# 1171 "../crypto/evp/evp_lib.c"
    ...
    if (ctx == 
# 1174 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0) 
# 1174 "../crypto/evp/evp_lib.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {

        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",1176,__func__), ERR_set_error)((6),(147),
# 1176 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 1176 "../crypto/evp/evp_lib.c"
       );
    ...
    if (name == 
# 1181 "../crypto/evp/evp_lib.c" 3 4
               ((void *)0)
# 1181 "../crypto/evp/evp_lib.c"
                   )
        return -1;
...
# 1200 "../crypto/evp/evp_lib.c"
static EVP_PKEY *evp_pkey_keygen(OSSL_LIB_CTX *libctx, const char *name,
                                 const char *propq, const OSSL_PARAM *params)
{
    EVP_PKEY *pkey = 
# 1203 "../crypto/evp/evp_lib.c" 3 4
                    ((void *)0)
# 1203 "../crypto/evp/evp_lib.c"
                        ;
    EVP_PKEY_CTX *ctx = EVP_PKEY_CTX_new_from_name(libctx, name, propq);

    if (ctx != 
# 1206 "../crypto/evp/evp_lib.c" 3 4
              ((void *)0)
            
# 1207 "../crypto/evp/evp_lib.c"
                            ...
                            const char *type, ...)
{
    ...
    char *name;
    OSSL_PARAM params[] = { { 
# 1221 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1221 "../crypto/evp/evp_lib.c"
                           , 0, 
# 1221 "../crypto/evp/evp_lib.c" 3 4
                           ((void *)0)
# 1221 "../crypto/evp/evp_lib.c"
...
# 1221 "../crypto/evp/evp_lib.c"
                                           , 0, 0 } };
    EVP_PKEY *ret = 
# 1222 "../crypto/evp/evp_lib.c" 3 4
                   ((void *)0)
# 1222 "../crypto/evp/evp_lib.c"
                       ;

    
# 1224 "../crypto/evp/evp_lib.c" 3 4
   __builtin_c23_va_start(
# 1224 "../crypto/evp/evp_lib.c"
   args, type
# 1224 "../crypto/evp/evp_lib.c" 3 4
   )
# 1224 "../crypto/evp/evp_lib.c"
    ...
    if (OPENSSL_strcasecmp(type, "RSA") == 0) {
        bits = 
# 1227 "../crypto/evp/evp_lib.c" 3 4
              __builtin_va_arg(
# 1227 "../crypto/evp/evp_lib.c"
              args
# 1227 "../crypto/evp/evp_lib.c" 3 4
              ,
# 1227 "../crypto/evp/evp_lib.c"
...
# 1227 "../crypto/evp/evp_lib.c"
                                  ;
        params[0] = OSSL_PARAM_construct_size_t("bits", &bits);
    } else if (OPENSSL_strcasecmp(type, "EC") == 0) {
        name = 
# 1230 "../crypto/evp/evp_lib.c" 3 4
              __builtin_va_arg(
...
# 1230 "../crypto/evp/evp_lib.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_lib.c",1238,__func__), ERR_set_error)((6),((262|(0x2 << 18L))),
# 1238 "../crypto/evp/evp_lib.c" 3 4
       ((void *)0)
# 1238 "../crypto/evp/evp_lib.c"
       );
        goto end;
    }
...
# 1244 "../crypto/evp/evp_lib.c" 3 4
   __builtin_va_end(
# 1244 "../crypto/evp/evp_lib.c"
   args
# 1244 "../crypto/evp/evp_lib.c" 3 4
   )
# 1244 "../crypto/evp/evp_lib.c"
