# 0 "../crypto/evp/mac_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/mac_meth.c"
# 10 "../crypto/evp/mac_meth.c"
...
static void evp_mac_free(void *vmac)
{
    ...
    if (mac == 
# 33 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 33 "../crypto/evp/mac_meth.c"
                  )
        return;
    ...
    if (ref > 0)
        return;
    CRYPTO_free(mac->type_name, "../crypto/evp/mac_meth.c", 39);
    ossl_provider_free(mac->prov);
    CRYPTO_FREE_REF(&mac->refcnt);
    CRYPTO_free(mac, "../crypto/evp/mac_meth.c", 42);
}

static void *evp_mac_new(void)
{
    EVP_MAC *mac = 
# 47 "../crypto/evp/mac_meth.c" 3 4
                  ((void *)0)
# 47 "../crypto/evp/mac_meth.c"
                      ;

    if ((mac = CRYPTO_zalloc(sizeof(*mac), "../crypto/evp/mac_meth.c", 49)) == 
# 49 "../crypto/evp/mac_meth.c" 3 4
                                               ((void *)0)
        
# 50 "../crypto/evp/mac_meth.c"
       || !CRYPTO_NEW_REF(&mac->refcnt, 1)) {
        evp_mac_free(mac);
        return 
# 52 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 52 "../crypto/evp/mac_meth.c"
                  ;
    }
    return mac;
}
                                    ...
                                    OSSL_PROVIDER *prov)
{
    ...
    EVP_MAC *mac = 
# 62 "../crypto/evp/mac_meth.c" 3 4
                  ((void *)0)
# 62 "../crypto/evp/mac_meth.c"
                      ;
    int fnmaccnt = 0, fnctxcnt = 0;

    if ((mac = evp_mac_new()) == 
# 65 "../crypto/evp/mac_meth.c" 3 4
                                ((void *)0)
# 65 "../crypto/evp/mac_meth.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_meth.c",66,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 66 "../crypto/evp/mac_meth.c" 3 4
       ((void *)0)
# 66 "../crypto/evp/mac_meth.c"
       );
        return 
# 67 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 67 "../crypto/evp/mac_meth.c"
                  ;
    }
    mac->name_id = name_id;
    if ((mac->type_name = ossl_algorithm_get1_first_name(algodef)) == 
# 70 "../crypto/evp/mac_meth.c" 3 4
                                                                     ((void *)0)
# 70 "../crypto/evp/mac_meth.c"
                                                                         ) {
        evp_mac_free(mac);
        return 
# 72 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 72 "../crypto/evp/mac_meth.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (mac->newctx != 
# 79 "../crypto/evp/mac_meth.c" 3 4
                              ((void *)0)
# 79 "../crypto/evp/mac_meth.c"
                                  )
                break;
        ...
        case 2:
            if (mac->dupctx != 
# 85 "../crypto/evp/mac_meth.c" 3 4
                              ((void *)0)
# 85 "../crypto/evp/mac_meth.c"
                                  )
                break;
        ...
        case 3:
            if (mac->freectx != 
# 90 "../crypto/evp/mac_meth.c" 3 4
                               ((void *)0)
# 90 "../crypto/evp/mac_meth.c"
                                   )
                break;
        ...
        case 4:
            if (mac->init != 
# 96 "../crypto/evp/mac_meth.c" 3 4
                            ((void *)0)
# 96 "../crypto/evp/mac_meth.c"
                                )
                break;
        ...
        case 5:
            if (mac->update != 
# 102 "../crypto/evp/mac_meth.c" 3 4
                              ((void *)0)
# 102 "../crypto/evp/mac_meth.c"
                                  )
                break;
        ...
        case 6:
            if (mac->final != 
# 108 "../crypto/evp/mac_meth.c" 3 4
                             ((void *)0)
# 108 "../crypto/evp/mac_meth.c"
                                 )
                break;
            ...
            break;
        case 10:
            if (mac->gettable_params != 
# 114 "../crypto/evp/mac_meth.c" 3 4
                                       ((void *)0)
# 114 "../crypto/evp/mac_meth.c"
                                           )
                break;
            mac->gettable_params =
            ...
            break;
        case 11:
            if (mac->gettable_ctx_params != 
# 120 "../crypto/evp/mac_meth.c" 3 4
                                           ((void *)0)
# 120 "../crypto/evp/mac_meth.c"
                                               )
                break;
            ...
            break;
        case 12:
            if (mac->settable_ctx_params != 
# 126 "../crypto/evp/mac_meth.c" 3 4
                                           ((void *)0)
# 126 "../crypto/evp/mac_meth.c"
                                               )
                break;
        ...
        case 7:
            if (mac->get_params != 
# 132 "../crypto/evp/mac_meth.c" 3 4
                                  ((void *)0)
# 132 "../crypto/evp/mac_meth.c"
                                      )
                break;
            mac->get_params = OSSL_FUNC_mac_get_params(fns);
            break;
        case 8:
            if (mac->get_ctx_params != 
# 137 "../crypto/evp/mac_meth.c" 3 4
                                      ((void *)0)
# 137 "../crypto/evp/mac_meth.c"
                                          )
                break;
            mac->get_ctx_params = OSSL_FUNC_mac_get_ctx_params(fns);
            break;
        case 9:
            if (mac->set_ctx_params != 
# 142 "../crypto/evp/mac_meth.c" 3 4
                                      ((void *)0)
# 142 "../crypto/evp/mac_meth.c"
                                          )
                break;
    ...
    if (fnmaccnt != 3
        ...
        evp_mac_free(mac);
        (ERR_new(), ERR_set_debug("../crypto/evp/mac_meth.c",156,__func__), ERR_set_error)((6),(193),
# 156 "../crypto/evp/mac_meth.c" 3 4
       ((void *)0)
# 156 "../crypto/evp/mac_meth.c"
       );
        return 
# 157 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 157 "../crypto/evp/mac_meth.c"
                  ;
    }
    mac->prov = prov;
    if (prov != 
# 160 "../crypto/evp/mac_meth.c" 3 4
               ((void *)0)
# 160 "../crypto/evp/mac_meth.c"
                   )
...
EVP_MAC *EVP_MAC_fetch(OSSL_LIB_CTX *libctx, const char *algorithm,
                       const char *properties)
{
    return evp_generic_fetch(libctx, 3, algorithm, properties,
...
{
    if (mac->gettable_params == 
# 191 "../crypto/evp/mac_meth.c" 3 4
                               ((void *)0)
# 191 "../crypto/evp/mac_meth.c"
                                   )
        return 
# 192 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 192 "../crypto/evp/mac_meth.c"
                  ;
...
const OSSL_PARAM *EVP_MAC_gettable_ctx_params(const EVP_MAC *mac)
{
    ...
    if (mac->gettable_ctx_params == 
# 200 "../crypto/evp/mac_meth.c" 3 4
                                   ((void *)0)
# 200 "../crypto/evp/mac_meth.c"
                                       )
        return 
# 201 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 201 "../crypto/evp/mac_meth.c"
                  ;
    alg = ossl_provider_ctx(EVP_MAC_get0_provider(mac));
    return mac->gettable_ctx_params(
# 203 "../crypto/evp/mac_meth.c" 3 4
                                   ((void *)0)
# 203 "../crypto/evp/mac_meth.c"
                                       , alg);
}
...
const OSSL_PARAM *EVP_MAC_settable_ctx_params(const EVP_MAC *mac)
{
    ...
    if (mac->settable_ctx_params == 
# 210 "../crypto/evp/mac_meth.c" 3 4
                                   ((void *)0)
# 210 "../crypto/evp/mac_meth.c"
                                       )
        return 
# 211 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 211 "../crypto/evp/mac_meth.c"
                  ;
    alg = ossl_provider_ctx(EVP_MAC_get0_provider(mac));
    return mac->settable_ctx_params(
# 213 "../crypto/evp/mac_meth.c" 3 4
                                   ((void *)0)
# 213 "../crypto/evp/mac_meth.c"
                                       , alg);
}
...
# 220 "../crypto/evp/mac_meth.c" 3 4
                                         ((void *)0)
# 220 "../crypto/evp/mac_meth.c"
                                             )
        return 
# 221 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 221 "../crypto/evp/mac_meth.c"
                  ;
...
# 230 "../crypto/evp/mac_meth.c" 3 4
                                         ((void *)0)
# 230 "../crypto/evp/mac_meth.c"
                                             )
        return 
# 231 "../crypto/evp/mac_meth.c" 3 4
              ((void *)0)
# 231 "../crypto/evp/mac_meth.c"
                  ;
    alg = ossl_provider_ctx(EVP_MAC_get0_provider(ctx->meth));
