# 0 "../crypto/evp/digest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/digest.c"
# 13 "../crypto/evp/digest.c"
...
# 15 "../include/openssl/objects.h" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 21 "../include/openssl/objects.h" 2
...
# 19 "../crypto/evp/digest.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 22 "../crypto/evp/digest.c" 2
...
# 27 "../crypto/evp/digest.c" 2

static void cleanup_old_md_data(EVP_MD_CTX *ctx, int force)
{
    if (ctx->digest != 
# 30 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 30 "../crypto/evp/digest.c"
                          ) {
        if (ctx->digest->cleanup != 
# 31 "../crypto/evp/digest.c" 3 4
                                   ((void *)0)
                
# 32 "../crypto/evp/digest.c"
               && !EVP_MD_CTX_test_flags(ctx, 0x0002))
            ctx->digest->cleanup(ctx);
        if (ctx->md_data != 
# 34 "../crypto/evp/digest.c" 3 4
                           ((void *)0) 
# 34 "../crypto/evp/digest.c"
                                && ctx->digest->ctx_size > 0
                && (!EVP_MD_CTX_test_flags(ctx, 0x0004)
                    || force)) {
            CRYPTO_clear_free(ctx->md_data, ctx->digest->ctx_size, "../crypto/evp/digest.c", 37);
            ctx->md_data = 
# 38 "../crypto/evp/digest.c" 3 4
                          ((void *)0)
# 38 "../crypto/evp/digest.c"
                              ;
        }
    }
}
...
{
    if (ctx->algctx != 
# 45 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 45 "../crypto/evp/digest.c"
                          ) {
        if (ctx->digest != 
# 46 "../crypto/evp/digest.c" 3 4
                          ((void *)0) 
# 46 "../crypto/evp/digest.c"
                               && ctx->digest->freectx != 
# 46 "../crypto/evp/digest.c" 3 4
                                                          ((void *)0)
# 46 "../crypto/evp/digest.c"
        ...
        ctx->algctx = 
# 48 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 48 "../crypto/evp/digest.c"
                         ;
    ...
    if (force)
        ctx->digest = 
# 60 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 60 "../crypto/evp/digest.c"
                         ;


    ENGINE_finish(ctx->engine);
    ctx->engine = 
# 64 "../crypto/evp/digest.c" 3 4
                 ((void *)0)
# 64 "../crypto/evp/digest.c"
                     ;
    ...
    if (!keep_fetched) {
        ...
        ctx->fetched_digest = 
# 70 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 70 "../crypto/evp/digest.c"
                                 ;
        ctx->reqdigest = 
# 71 "../crypto/evp/digest.c" 3 4
                        ((void *)0)
# 71 "../crypto/evp/digest.c"
                            ;
    }
}
...
{
    if (ctx == 
# 77 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 77 "../crypto/evp/digest.c"
                  )
        return 1;
    ...
    if (!EVP_MD_CTX_test_flags(ctx, 0x0400)) {
        EVP_PKEY_CTX_free(ctx->pctx);
        ctx->pctx = 
# 87 "../crypto/evp/digest.c" 3 4
                   ((void *)0)
# 87 "../crypto/evp/digest.c"
                       ;
    }
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    EVP_MD_CTX *ctx;
    EVP_PKEY_CTX *pctx = 
# 109 "../crypto/evp/digest.c" 3 4
                        ((void *)0)
# 109 "../crypto/evp/digest.c"
                            ;

    if ((ctx = EVP_MD_CTX_new()) == 
# 111 "../crypto/evp/digest.c" 3 4
                                   ((void *)0)
        
# 112 "../crypto/evp/digest.c"
       || (pctx = EVP_PKEY_CTX_new_from_pkey(libctx, pkey, propq)) == 
# 112 "../crypto/evp/digest.c" 3 4
                                                                      ((void *)0)
# 112 "../crypto/evp/digest.c"
                                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",113,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 113 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 113 "../crypto/evp/digest.c"
       );
        goto err;
    }

    if (id != 
# 117 "../crypto/evp/digest.c" 3 4
             ((void *)0) 
# 117 "../crypto/evp/digest.c"
 ...
 err:
    ...
    EVP_MD_CTX_free(ctx);
    return 
# 126 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 126 "../crypto/evp/digest.c"
              ;
}
...
EVP_MD_CTX *EVP_MD_CTX_new(void)
{
    return CRYPTO_zalloc(sizeof(EVP_MD_CTX), "../crypto/evp/digest.c", 132);
}

void EVP_MD_CTX_free(EVP_MD_CTX *ctx)
{
    if (ctx == 
# 137 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 137 "../crypto/evp/digest.c"
                  )
        return;

    EVP_MD_CTX_reset(ctx);
    CRYPTO_free(ctx, "../crypto/evp/digest.c", 141);
}

int evp_md_ctx_free_algctx(EVP_MD_CTX *ctx)
{
    if (ctx->algctx != 
# 146 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 146 "../crypto/evp/digest.c"
                          ) {
        if (!__builtin_expect(!!((ctx->digest != 
# 147 "../crypto/evp/digest.c" 3 4
            ((void *)0)
# 147 "../crypto/evp/digest.c"
            ) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",148,__func__), ERR_set_error)((6),(134),
# 148 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 148 "../crypto/evp/digest.c"
           );
            return 0;
        }
        if (ctx->digest->freectx != 
# 151 "../crypto/evp/digest.c" 3 4
                                   ((void *)0)
# 151 "../crypto/evp/digest.c"
                                       )
            ctx->digest->freectx(ctx->algctx);
        ctx->algctx = 
# 153 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 153 "../crypto/evp/digest.c"
                         ;
    }
    return 1;
}
                                ...
                                const OSSL_PARAM params[], ENGINE *impl)
{
    ...
    ENGINE *tmpimpl = 
# 162 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 162 "../crypto/evp/digest.c"
                         ;



    if (ctx->pctx != 
# 166 "../crypto/evp/digest.c" 3 4
                    ((void *)0)
            
# 167 "../crypto/evp/digest.c"
           && ((ctx->pctx)->operation == (1<<4) || (ctx->pctx)->operation == (1<<7) || (ctx->pctx)->operation == (1<<5) || (ctx->pctx)->operation == (1<<8) || (ctx->pctx)->operation == (1<<6))
            && ctx->pctx->op.sig.algctx != 
# 168 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 168 "../crypto/evp/digest.c"
                                              ) {
        ...
        if (ctx->pctx->operation == (1<<7))
            return EVP_DigestSignInit(ctx, 
# 176 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 176 "../crypto/evp/digest.c"
                                              , type, impl, 
# 176 "../crypto/evp/digest.c" 3 4
                                                            ((void *)0)
# 176 "../crypto/evp/digest.c"
                                                                );
        if (ctx->pctx->operation == (1<<8))
            return EVP_DigestVerifyInit(ctx, 
# 178 "../crypto/evp/digest.c" 3 4
                                            ((void *)0)
# 178 "../crypto/evp/digest.c"
                                                , type, impl, 
# 178 "../crypto/evp/digest.c" 3 4
                                                              ((void *)0)
# 178 "../crypto/evp/digest.c"
                                                                  );
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",179,__func__), ERR_set_error)((6),(189),
# 179 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 179 "../crypto/evp/digest.c"
       );
        return 0;
    }
    ...
    if (type != 
# 187 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 187 "../crypto/evp/digest.c"
                   ) {
        ctx->reqdigest = type;
    } else {
        if (ctx->digest == 
# 190 "../crypto/evp/digest.c" 3 4
                          ((void *)0)
# 190 "../crypto/evp/digest.c"
                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",191,__func__), ERR_set_error)((6),(139),
# 191 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 191 "../crypto/evp/digest.c"
           );
            return 0;
        }
        type = ctx->digest;
    }
# 205 "../crypto/evp/digest.c"
    if (ctx->engine != 
# 205 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
            
# 206 "../crypto/evp/digest.c"
           && ctx->digest != 
# 206 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
            
# 207 "../crypto/evp/digest.c"
    ...
    ENGINE_finish(ctx->engine);
    ctx->engine = 
# 216 "../crypto/evp/digest.c" 3 4
                 ((void *)0)
# 216 "../crypto/evp/digest.c"
                     ;

    if (impl == 
# 218 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 218 "../crypto/evp/digest.c"
                   )
    ...
    if (impl != 
# 226 "../crypto/evp/digest.c" 3 4
               ((void *)0)

            
# 228 "../crypto/evp/digest.c"
           || ctx->engine != 
# 228 "../crypto/evp/digest.c" 3 4
                             ((void *)0)

            
# 230 "../crypto/evp/digest.c"
           || tmpimpl != 
# 230 "../crypto/evp/digest.c" 3 4
                         ((void *)0)


            
# 233 "../crypto/evp/digest.c"
           || (ctx->flags & 0x0100) != 0
            || (type != 
# 234 "../crypto/evp/digest.c" 3 4
                       ((void *)0) 
# 234 "../crypto/evp/digest.c"
                            && type->origin == 2)
            || (type == 
# 235 "../crypto/evp/digest.c" 3 4
                       ((void *)0) 
# 235 "../crypto/evp/digest.c"
                            && ctx->digest != 
# 235 "../crypto/evp/digest.c" 3 4
                                              ((void *)0)
                             
# 236 "../crypto/evp/digest.c"
                            && ctx->digest->origin == 2)) {
        ...
        if (ctx->digest == ctx->fetched_digest)
            ctx->digest = 
# 241 "../crypto/evp/digest.c" 3 4
                         ((void *)0)
# 241 "../crypto/evp/digest.c"
                             ;
        EVP_MD_free(ctx->fetched_digest);
        ctx->fetched_digest = 
# 243 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 243 "../crypto/evp/digest.c"
                                 ;
        goto legacy;
    }
    ...
    if (ctx->digest == type) {
        if (!__builtin_expect(!!((type->prov != 
# 251 "../crypto/evp/digest.c" 3 4
            ((void *)0)
# 251 "../crypto/evp/digest.c"
            ) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",252,__func__), ERR_set_error)((6),(134),
# 252 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 252 "../crypto/evp/digest.c"
           );
            return 0;
        }
    } else {
    ...
    if (type->prov == 
# 260 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 260 "../crypto/evp/digest.c"
                         ) {
...
# 267 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
# 267 "../crypto/evp/digest.c"
                                         ,
                                      type->type != 0 ? OBJ_nid2sn(type->type)
                                                              : "NULL", "");

        if (provmd == 
# 271 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 271 "../crypto/evp/digest.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",272,__func__), ERR_set_error)((6),(134),
# 272 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 272 "../crypto/evp/digest.c"
           );
            return 0;
        }
        type = provmd;
    ...
    if (type->prov != 
# 281 "../crypto/evp/digest.c" 3 4
                     ((void *)0) 
# 281 "../crypto/evp/digest.c"
                          && ctx->fetched_digest != type) {
        if (!EVP_MD_up_ref((EVP_MD *)type)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",283,__func__), ERR_set_error)((6),(134),
# 283 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 283 "../crypto/evp/digest.c"
           );
            return 0;
        }
        EVP_MD_free(ctx->fetched_digest);
    ...
    ctx->digest = type;
    if (ctx->algctx == 
# 290 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 290 "../crypto/evp/digest.c"
                          ) {
        ctx->algctx = ctx->digest->newctx(ossl_provider_ctx(type->prov));
        if (ctx->algctx == 
# 292 "../crypto/evp/digest.c" 3 4
                          ((void *)0)
# 292 "../crypto/evp/digest.c"
                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",293,__func__), ERR_set_error)((6),(134),
# 293 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 293 "../crypto/evp/digest.c"
           );
            return 0;
        }
    }
    ...
    if (ctx->digest->dinit == 
# 298 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 298 "../crypto/evp/digest.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",299,__func__), ERR_set_error)((6),(134),
# 299 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 299 "../crypto/evp/digest.c"
       );
        return 0;
    }
 ...
 legacy:
    ...
    if (type) {
        if (impl != 
# 310 "../crypto/evp/digest.c" 3 4
                   ((void *)0)
# 310 "../crypto/evp/digest.c"
                       ) {
            if (!ENGINE_init(impl)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",312,__func__), ERR_set_error)((6),(134),
# 312 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 312 "../crypto/evp/digest.c"
               );
                return 0;
            }
        } else {
        ...
        if (impl != 
# 319 "../crypto/evp/digest.c" 3 4
                   ((void *)0)
# 319 "../crypto/evp/digest.c"
                       ) {

            const EVP_MD *d = ENGINE_get_digest(impl, type->type);

            if (d == 
# 323 "../crypto/evp/digest.c" 3 4
                    ((void *)0)
# 323 "../crypto/evp/digest.c"
                        ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",324,__func__), ERR_set_error)((6),(134),
# 324 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 324 "../crypto/evp/digest.c"
               );
                ENGINE_finish(impl);
                return 0;
            }
            ...
            ctx->engine = 
# 336 "../crypto/evp/digest.c" 3 4
                         ((void *)0)
# 336 "../crypto/evp/digest.c"
                             ;
    }
    ...
    if (ctx->digest != type) {
        ...
        if (!(ctx->flags & 0x0100) && type->ctx_size) {
            ...
            ctx->md_data = CRYPTO_zalloc(type->ctx_size, "../crypto/evp/digest.c", 345);
            if (ctx->md_data == 
# 346 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 346 "../crypto/evp/digest.c"
                                   )
                return 0;
        }
    }
 ...
 skip_to_init:
    ...
    if (ctx->pctx != 
# 354 "../crypto/evp/digest.c" 3 4
                    ((void *)0)
            
# 355 "../crypto/evp/digest.c"
           && (!((ctx->pctx)->operation == (1<<4) || (ctx->pctx)->operation == (1<<7) || (ctx->pctx)->operation == (1<<5) || (ctx->pctx)->operation == (1<<8) || (ctx->pctx)->operation == (1<<6))
                 || ctx->pctx->op.sig.signature == 
# 356 "../crypto/evp/digest.c" 3 4
                                                  ((void *)0)
# 356 "../crypto/evp/digest.c"
                                                      )) {
        int r;
        r = EVP_PKEY_CTX_ctrl(ctx->pctx, -1, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
                              7, 0, ctx);
        if (r <= 0 && (r != -2))
            return 0;
    }
...
# 372 "../crypto/evp/digest.c" 3 4
                                                  ((void *)0)
# 372 "../crypto/evp/digest.c"
                                                      );
}
...
{
    EVP_MD_CTX_reset(ctx);
    return evp_md_init_internal(ctx, type, 
# 378 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 378 "../crypto/evp/digest.c"
                                              , 
# 378 "../crypto/evp/digest.c" 3 4
                                                ((void *)0)
# 378 "../crypto/evp/digest.c"
...
{
    return evp_md_init_internal(ctx, type, 
# 383 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 383 "../crypto/evp/digest.c"
                                              , impl);
}
...
int EVP_DigestUpdate(EVP_MD_CTX *ctx, const void *data, size_t count)
{
    ...
    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",392,__func__), ERR_set_error)((6),(189),
# 392 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 392 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->pctx != 
# 396 "../crypto/evp/digest.c" 3 4
                    ((void *)0)
            
# 397 "../crypto/evp/digest.c"
           && ((ctx->pctx)->operation == (1<<4) || (ctx->pctx)->operation == (1<<7) || (ctx->pctx)->operation == (1<<5) || (ctx->pctx)->operation == (1<<8) || (ctx->pctx)->operation == (1<<6))
            && ctx->pctx->op.sig.algctx != 
# 398 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 398 "../crypto/evp/digest.c"
                                              ) {
# 407 "../crypto/evp/digest.c"
        if (ctx->pctx->operation == (1<<7))
            return EVP_DigestSignUpdate(ctx, data, count);
        if (ctx->pctx->operation == (1<<8))
            return EVP_DigestVerifyUpdate(ctx, data, count);
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",411,__func__), ERR_set_error)((6),(189),
# 411 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 411 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->digest == 
# 415 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
            
# 416 "../crypto/evp/digest.c"
           || ctx->digest->prov == 
# 416 "../crypto/evp/digest.c" 3 4
                                   ((void *)0)
            
# 417 "../crypto/evp/digest.c"
           || (ctx->flags & 0x0100) != 0)
        goto legacy;

    if (ctx->digest->dupdate == 
# 420 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 420 "../crypto/evp/digest.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",421,__func__), ERR_set_error)((6),(189),
# 421 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 421 "../crypto/evp/digest.c"
       );
        return 0;
    }
 ...
 legacy:
    return ctx->update != 
# 428 "../crypto/evp/digest.c" 3 4
                         ((void *)0) 
# 428 "../crypto/evp/digest.c"
                              ? ctx->update(ctx, data, count) : 0;
}
...
int EVP_DigestFinal_ex(EVP_MD_CTX *ctx, unsigned char *md, unsigned int *isize)
{
    ...
    if (ctx->digest == 
# 447 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 447 "../crypto/evp/digest.c"
                          )
        return 0;
    ...
    mdsize = sz;
    if (ctx->digest->prov == 
# 454 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 454 "../crypto/evp/digest.c"
                                )
        goto legacy;

    if (ctx->digest->gettable_ctx_params != 
# 457 "../crypto/evp/digest.c" 3 4
                                           ((void *)0)
# 457 "../crypto/evp/digest.c"
                                               ) {
        OSSL_PARAM params[] = { { 
# 458 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 458 "../crypto/evp/digest.c"
                               , 0, 
# 458 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 458 "../crypto/evp/digest.c"
...
# 458 "../crypto/evp/digest.c"
        ...
        params[0] = OSSL_PARAM_construct_size_t("size",
                                                &mdsize);
        if (!EVP_MD_CTX_get_params(ctx, params))
            return 0;
    }

    if (ctx->digest->dfinal == 
# 466 "../crypto/evp/digest.c" 3 4
                              ((void *)0)
# 466 "../crypto/evp/digest.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",467,__func__), ERR_set_error)((6),(188),
# 467 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 467 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",472,__func__), ERR_set_error)((6),(188),
# 472 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 472 "../crypto/evp/digest.c"
       );
        return 0;
    }
    ...
    if (isize != 
# 480 "../crypto/evp/digest.c" 3 4
                ((void *)0)
# 480 "../crypto/evp/digest.c"
                    ) {
        if (size <= 
# 481 "../crypto/evp/digest.c" 3 4
                   (0x7fffffff * 2U + 1U)
# 481 "../crypto/evp/digest.c"
                           ) {
            *isize = (unsigned int)size;
        } else {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",484,__func__), ERR_set_error)((6),(188),
# 484 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 484 "../crypto/evp/digest.c"
           );
            ret = 0;
        }
    }
 ...
 legacy:
    (void)((mdsize <= 64) ? 0 : (OPENSSL_die("assertion failed: " "mdsize <= EVP_MAX_MD_SIZE", "../crypto/evp/digest.c", 493), 1));
    ret = ctx->digest->final(ctx, md);
    if (isize != 
# 495 "../crypto/evp/digest.c" 3 4
                ((void *)0)
# 495 "../crypto/evp/digest.c"
                    )
        *isize = mdsize;
    if (ctx->digest->cleanup) {
        ctx->digest->cleanup(ctx);
...
int EVP_DigestFinalXOF(EVP_MD_CTX *ctx, unsigned char *md, size_t size)
{
    ...
    if (ctx->digest == 
# 512 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 512 "../crypto/evp/digest.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",513,__func__), ERR_set_error)((6),(218),
# 513 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 513 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->digest->prov == 
# 517 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 517 "../crypto/evp/digest.c"
                                )
        goto legacy;

    if (ctx->digest->dfinal == 
# 520 "../crypto/evp/digest.c" 3 4
                              ((void *)0)
# 520 "../crypto/evp/digest.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",521,__func__), ERR_set_error)((6),(188),
# 521 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 521 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if ((ctx->flags & 0x0800) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",526,__func__), ERR_set_error)((6),(188),
# 526 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 526 "../crypto/evp/digest.c"
       );
        return 0;
    }
    ...
    params[i++] = OSSL_PARAM_construct_size_t("xoflen", &size);
...
legacy:
    if (ctx->digest->flags & 0x0002
        && size <= 0x7fffffff
        
# 548 "../crypto/evp/digest.c"
       && ctx->digest->md_ctrl(ctx, 0x3, (int)size, 
# 548 "../crypto/evp/digest.c" 3 4
                                                                    ((void *)0)
# 548 "../crypto/evp/digest.c"
                                                                        )) {
        ret = ctx->digest->final(ctx, md);
        if (ctx->digest->cleanup != 
# 550 "../crypto/evp/digest.c" 3 4
                                   ((void *)0)
# 550 "../crypto/evp/digest.c"
                                       ) {
            ctx->digest->cleanup(ctx);
            EVP_MD_CTX_set_flags(ctx, 0x0002);
        }
        ...
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",556,__func__), ERR_set_error)((6),(178),
# 556 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 556 "../crypto/evp/digest.c"
       );
    }
...
{
    if (ctx->digest == 
# 565 "../crypto/evp/digest.c" 3 4
                      ((void *)0)
# 565 "../crypto/evp/digest.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",566,__func__), ERR_set_error)((6),(218),
# 566 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 566 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->digest->prov == 
# 570 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 570 "../crypto/evp/digest.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",571,__func__), ERR_set_error)((6),(148),
# 571 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 571 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->digest->dsqueeze == 
# 575 "../crypto/evp/digest.c" 3 4
                                ((void *)0)
# 575 "../crypto/evp/digest.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",576,__func__), ERR_set_error)((6),(144),
# 576 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 576 "../crypto/evp/digest.c"
       );
        return 0;
    }
...
EVP_MD_CTX *EVP_MD_CTX_dup(const EVP_MD_CTX *in)
{
    ...
    if (out != 
# 587 "../crypto/evp/digest.c" 3 4
              ((void *)0) 
# 587 "../crypto/evp/digest.c"
                   && !EVP_MD_CTX_copy_ex(out, in)) {
        EVP_MD_CTX_free(out);
        out = 
# 589 "../crypto/evp/digest.c" 3 4
             ((void *)0)
# 589 "../crypto/evp/digest.c"
                 ;
    }
    return out;
}
...
int EVP_MD_CTX_copy_ex(EVP_MD_CTX *out, const EVP_MD_CTX *in)
{
    ...
    if (in == 
# 605 "../crypto/evp/digest.c" 3 4
             ((void *)0)
# 605 "../crypto/evp/digest.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",606,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 606 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 606 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (in->digest == 
# 610 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 610 "../crypto/evp/digest.c"
                         ) {

        EVP_MD_CTX_reset(out);
        if (out->fetched_digest != 
# 613 "../crypto/evp/digest.c" 3 4
                                  ((void *)0)
# 613 "../crypto/evp/digest.c"
                                      )
    ...
    if (in->digest->prov == 
# 619 "../crypto/evp/digest.c" 3 4
                           ((void *)0)
            
# 620 "../crypto/evp/digest.c"
           || (in->flags & 0x0100) != 0)
        goto legacy;

    if (in->digest->dupctx == 
# 623 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 623 "../crypto/evp/digest.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",624,__func__), ERR_set_error)((6),(190),
# 624 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 624 "../crypto/evp/digest.c"
       );
        return 0;
    }
    ...
    if (digest_change && out->fetched_digest != 
# 630 "../crypto/evp/digest.c" 3 4
                                               ((void *)0)
# 630 "../crypto/evp/digest.c"
                                                   )
        EVP_MD_free(out->fetched_digest);
    *out = *in;

    out->pctx = 
# 634 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 634 "../crypto/evp/digest.c"
                   ;
    out->algctx = 
# 635 "../crypto/evp/digest.c" 3 4
                 ((void *)0)
# 635 "../crypto/evp/digest.c"
                     ;

    if (digest_change && in->fetched_digest != 
# 637 "../crypto/evp/digest.c" 3 4
                                              ((void *)0)
# 637 "../crypto/evp/digest.c"
                                                  )
        EVP_MD_up_ref(in->fetched_digest);

    if (in->algctx != 
# 640 "../crypto/evp/digest.c" 3 4
                     ((void *)0)
# 640 "../crypto/evp/digest.c"
                         ) {
        out->algctx = in->digest->dupctx(in->algctx);
        if (out->algctx == 
# 642 "../crypto/evp/digest.c" 3 4
                          ((void *)0)
# 642 "../crypto/evp/digest.c"
                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",643,__func__), ERR_set_error)((6),(190),
# 643 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 643 "../crypto/evp/digest.c"
           );
            return 0;
        }
    }
 ...
 clone_pkey:
    ...
    EVP_MD_CTX_clear_flags(out, 0x0400);

    if (in->pctx != 
# 652 "../crypto/evp/digest.c" 3 4
                   ((void *)0)
# 652 "../crypto/evp/digest.c"
                       ) {
        out->pctx = EVP_PKEY_CTX_dup(in->pctx);
        if (out->pctx == 
# 654 "../crypto/evp/digest.c" 3 4
                        ((void *)0)
# 654 "../crypto/evp/digest.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",655,__func__), ERR_set_error)((6),(190),
# 655 "../crypto/evp/digest.c" 3 4
           ((void *)0)
# 655 "../crypto/evp/digest.c"
           );
            EVP_MD_CTX_reset(out);
            return 0;
        }
 ...
 legacy:
    ...
    if (in->engine && !ENGINE_init(in->engine)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",669,__func__), ERR_set_error)((6),((38 | (0x2 << 18L))),
# 669 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 669 "../crypto/evp/digest.c"
       );
        return 0;
    }
    ...
    if (out->digest == in->digest) {
        ...
        tmp_buf = 
# 678 "../crypto/evp/digest.c" 3 4
                 ((void *)0)
# 678 "../crypto/evp/digest.c"
                     ;
    EVP_MD_CTX_reset(out);
    ...
    out->md_data = 
# 689 "../crypto/evp/digest.c" 3 4
                  ((void *)0)
# 689 "../crypto/evp/digest.c"
                      ;
    out->pctx = 
# 690 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 690 "../crypto/evp/digest.c"
                   ;
    ...
    if (in->md_data && out->digest->ctx_size) {
        if (tmp_buf)
            ...
            out->md_data = CRYPTO_malloc(out->digest->ctx_size, "../crypto/evp/digest.c", 696);
            if (out->md_data == 
# 697 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 697 "../crypto/evp/digest.c"
                                   )
                return 0;
        }
               ...
               ENGINE *impl)
{
    ...
    if (ctx == 
# 728 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 728 "../crypto/evp/digest.c"
                  )
        return 0;
                 ...
                 unsigned char *md, size_t *mdlen)
{
    ...
    if (digest != 
# 747 "../crypto/evp/digest.c" 3 4
                 ((void *)0)
# 747 "../crypto/evp/digest.c"
                     ) {
        ret = EVP_Digest(data, datalen, md, &temp, digest, 
# 748 "../crypto/evp/digest.c" 3 4
                                                          ((void *)0)
# 748 "../crypto/evp/digest.c"
                                                              );
        EVP_MD_free(digest);
    }
    if (mdlen != 
# 751 "../crypto/evp/digest.c" 3 4
                ((void *)0)
# 751 "../crypto/evp/digest.c"
                    )
        *mdlen = temp;
    return ret;
}
...
{
    if (digest != 
# 758 "../crypto/evp/digest.c" 3 4
                 ((void *)0) 
# 758 "../crypto/evp/digest.c"
                      && digest->get_params != 
# 758 "../crypto/evp/digest.c" 3 4
                                               ((void *)0)
# 758 "../crypto/evp/digest.c"
...
{
    if (digest != 
# 765 "../crypto/evp/digest.c" 3 4
                 ((void *)0) 
# 765 "../crypto/evp/digest.c"
                      && digest->gettable_params != 
# 765 "../crypto/evp/digest.c" 3 4
                                                    ((void *)0)
# 765 "../crypto/evp/digest.c"
                                                        )
    ...
    return 
# 768 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 768 "../crypto/evp/digest.c"
              ;
}
...
int EVP_MD_CTX_set_params(EVP_MD_CTX *ctx, const OSSL_PARAM params[])
{
    ...
    if (pctx != 
# 776 "../crypto/evp/digest.c" 3 4
               ((void *)0)
            
# 777 "../crypto/evp/digest.c"
           && (pctx->operation == (1<<8)
                || pctx->operation == (1<<7))
            && pctx->op.sig.algctx != 
# 779 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
            
# 780 "../crypto/evp/digest.c"
           && pctx->op.sig.signature->set_ctx_md_params != 
# 780 "../crypto/evp/digest.c" 3 4
                                                           ((void *)0)
# 780 "../crypto/evp/digest.c"
                                                               )
    ...
    if (ctx->digest != 
# 784 "../crypto/evp/digest.c" 3 4
                      ((void *)0) 
# 784 "../crypto/evp/digest.c"
                           && ctx->digest->set_ctx_params != 
# 784 "../crypto/evp/digest.c" 3 4
                                                             ((void *)0)
# 784 "../crypto/evp/digest.c"
                                                                 )
...
const OSSL_PARAM *EVP_MD_settable_ctx_params(const EVP_MD *md)
{
    ...
    if (md != 
# 794 "../crypto/evp/digest.c" 3 4
             ((void *)0) 
# 794 "../crypto/evp/digest.c"
...
# 796 "../crypto/evp/digest.c" 3 4
                                      ((void *)0)
# 796 "../crypto/evp/digest.c"
                                          , provctx);
    }
    return 
# 798 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 798 "../crypto/evp/digest.c"
              ;
}
...
const OSSL_PARAM *EVP_MD_CTX_settable_params(EVP_MD_CTX *ctx)
{
    ...
    if (ctx == 
# 806 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 806 "../crypto/evp/digest.c"
                  )
        return 
# 807 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 807 "../crypto/evp/digest.c"
                  ;


    pctx = ctx->pctx;
    if (pctx != 
# 811 "../crypto/evp/digest.c" 3 4
               ((void *)0)
            
# 812 "../crypto/evp/digest.c"
           && (pctx->operation == (1<<8)
                || pctx->operation == (1<<7))
            && pctx->op.sig.algctx != 
# 814 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
            
# 815 "../crypto/evp/digest.c"
           && pctx->op.sig.signature->settable_ctx_md_params != 
# 815 "../crypto/evp/digest.c" 3 4
                                                                ((void *)0)
# 815 "../crypto/evp/digest.c"
                                                                    )
    ...
    if (ctx->digest != 
# 819 "../crypto/evp/digest.c" 3 4
                      ((void *)0) 
# 819 "../crypto/evp/digest.c"
                           && ctx->digest->settable_ctx_params != 
# 819 "../crypto/evp/digest.c" 3 4
                                                                  ((void *)0)
# 819 "../crypto/evp/digest.c"
                                                                      ) {
    ...
    return 
# 824 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 824 "../crypto/evp/digest.c"
              ;
}
...
int EVP_MD_CTX_get_params(EVP_MD_CTX *ctx, OSSL_PARAM params[])
{
    ...
    if (pctx != 
# 832 "../crypto/evp/digest.c" 3 4
               ((void *)0)
            
# 833 "../crypto/evp/digest.c"
           && (pctx->operation == (1<<8)
                || pctx->operation == (1<<7))
            && pctx->op.sig.algctx != 
# 835 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
            
# 836 "../crypto/evp/digest.c"
           && pctx->op.sig.signature->get_ctx_md_params != 
# 836 "../crypto/evp/digest.c" 3 4
                                                           ((void *)0)
# 836 "../crypto/evp/digest.c"
                                                               )
    ...
    if (ctx->digest != 
# 840 "../crypto/evp/digest.c" 3 4
                      ((void *)0) 
# 840 "../crypto/evp/digest.c"
                           && ctx->digest->get_ctx_params != 
# 840 "../crypto/evp/digest.c" 3 4
                                                             ((void *)0)
# 840 "../crypto/evp/digest.c"
                                                                 )
...
const OSSL_PARAM *EVP_MD_gettable_ctx_params(const EVP_MD *md)
{
    ...
    if (md != 
# 850 "../crypto/evp/digest.c" 3 4
             ((void *)0) 
# 850 "../crypto/evp/digest.c"
...
# 852 "../crypto/evp/digest.c" 3 4
                                      ((void *)0)
# 852 "../crypto/evp/digest.c"
                                          , provctx);
    }
    return 
# 854 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 854 "../crypto/evp/digest.c"
              ;
}
...
const OSSL_PARAM *EVP_MD_CTX_gettable_params(EVP_MD_CTX *ctx)
{
    ...
    if (ctx == 
# 862 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 862 "../crypto/evp/digest.c"
                  )
        return 
# 863 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 863 "../crypto/evp/digest.c"
                  ;


    pctx = ctx->pctx;
    if (pctx != 
# 867 "../crypto/evp/digest.c" 3 4
               ((void *)0)
            
# 868 "../crypto/evp/digest.c"
           && (pctx->operation == (1<<8)
                || pctx->operation == (1<<7))
            && pctx->op.sig.algctx != 
# 870 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
            
# 871 "../crypto/evp/digest.c"
           && pctx->op.sig.signature->gettable_ctx_md_params != 
# 871 "../crypto/evp/digest.c" 3 4
                                                                ((void *)0)
# 871 "../crypto/evp/digest.c"
                                                                    )
    ...
    if (ctx->digest != 
# 875 "../crypto/evp/digest.c" 3 4
                      ((void *)0) 
# 875 "../crypto/evp/digest.c"
                           && ctx->digest->gettable_ctx_params != 
# 875 "../crypto/evp/digest.c" 3 4
                                                                  ((void *)0)
# 875 "../crypto/evp/digest.c"
                                                                      ) {
    ...
    return 
# 879 "../crypto/evp/digest.c" 3 4
          ((void *)0)
# 879 "../crypto/evp/digest.c"
              ;
}
...
int EVP_MD_CTX_ctrl(EVP_MD_CTX *ctx, int cmd, int p1, void *p2)
{
    ...
    size_t sz;
    OSSL_PARAM params[2] = { { 
# 887 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 887 "../crypto/evp/digest.c"
                            , 0, 
# 887 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 887 "../crypto/evp/digest.c"
...
# 887 "../crypto/evp/digest.c"
    ...
    if (ctx == 
# 889 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 889 "../crypto/evp/digest.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",890,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 890 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 890 "../crypto/evp/digest.c"
       );
        return 0;
    }

    if (ctx->digest != 
# 894 "../crypto/evp/digest.c" 3 4
                      ((void *)0) 
# 894 "../crypto/evp/digest.c"
                           && ctx->digest->prov == 
# 894 "../crypto/evp/digest.c" 3 4
                                                   ((void *)0)
# 894 "../crypto/evp/digest.c"
    ...
    case 0x3:
        sz = (size_t)p1;
        params[0] = OSSL_PARAM_construct_size_t("xoflen", &sz);
        break;
    case 0x2:
        set_params = 0;
        params[0] = OSSL_PARAM_construct_utf8_string("micalg",
                                                     p2, p1 ? p1 : 9999);
        break;
    case 0x1d:
        params[0] = OSSL_PARAM_construct_octet_string("ssl3-ms",
                                                      p2, p1);
        break;
    default:
        goto conclude;
...
# 924 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 924 "../crypto/evp/digest.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",925,__func__), ERR_set_error)((6),(132),
# 925 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 925 "../crypto/evp/digest.c"
       );
        return 0;
    }
...
EVP_MD *evp_md_new(void)
{
    EVP_MD *md = CRYPTO_zalloc(sizeof(*md), "../crypto/evp/digest.c", 938);

    if (md != 
# 940 "../crypto/evp/digest.c" 3 4
             ((void *)0) 
# 940 "../crypto/evp/digest.c"
                  && !CRYPTO_NEW_REF(&md->refcnt, 1)) {
        CRYPTO_free(md, "../crypto/evp/digest.c", 941);
        return 
# 942 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 942 "../crypto/evp/digest.c"
                  ;
    }
    return md;
}
...
static void set_legacy_nid(const char *name, void *vlegacy_nid)
{
    ...
    const void *legacy_method = OBJ_NAME_get(name, 0x01);

    if (*legacy_nid == -1)
        return;

    if (legacy_method == 
# 967 "../crypto/evp/digest.c" 3 4
                        ((void *)0)
# 967 "../crypto/evp/digest.c"
                            )
        return;
    nid = EVP_MD_get_type(legacy_method);
...
static int evp_md_cache_constants(EVP_MD *md)
{
    ...
    params[0] = OSSL_PARAM_construct_size_t("blocksize", &blksz);
    params[1] = OSSL_PARAM_construct_size_t("size", &mdsize);
    params[2] = OSSL_PARAM_construct_int("xof", &xof);
    params[3] = OSSL_PARAM_construct_int("algid-absent",
                                         &algid_absent);
    params[4] = OSSL_PARAM_construct_end();
    ok = evp_do_md_getparams(md, params) > 0;
    if (mdsize > 0x7fffffff 
# 992 "../crypto/evp/digest.c"
                        || blksz > 0x7fffffff
# 992 "../crypto/evp/digest.c"
                                          )
        ok = 0;
                                   ...
                                   OSSL_PROVIDER *prov)
{
    ...
    EVP_MD *md = 
# 1010 "../crypto/evp/digest.c" 3 4
                ((void *)0)
# 1010 "../crypto/evp/digest.c"
                    ;
    int fncnt = 0;


    if ((md = evp_md_new()) == 
# 1014 "../crypto/evp/digest.c" 3 4
                              ((void *)0)
# 1014 "../crypto/evp/digest.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",1015,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 1015 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 1015 "../crypto/evp/digest.c"
       );
        return 
# 1016 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 1016 "../crypto/evp/digest.c"
                  ;
    }
    ...
    if (!evp_names_do_all(prov, name_id, set_legacy_nid, &md->type)
            || md->type == -1) {
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",1023,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1023 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 1023 "../crypto/evp/digest.c"
       );
        EVP_MD_free(md);
        return 
# 1025 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 1025 "../crypto/evp/digest.c"
                  ;
    }


    md->name_id = name_id;
    if ((md->type_name = ossl_algorithm_get1_first_name(algodef)) == 
# 1030 "../crypto/evp/digest.c" 3 4
                                                                    ((void *)0)
# 1030 "../crypto/evp/digest.c"
                                                                        ) {
        EVP_MD_free(md);
        return 
# 1032 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 1032 "../crypto/evp/digest.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (md->newctx == 
# 1039 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 1039 "../crypto/evp/digest.c"
                                 ) {
        ...
        case 2:
            if (md->dinit == 
# 1045 "../crypto/evp/digest.c" 3 4
                            ((void *)0)
# 1045 "../crypto/evp/digest.c"
                                ) {
        ...
        case 3:
            if (md->dupdate == 
# 1051 "../crypto/evp/digest.c" 3 4
                              ((void *)0)
# 1051 "../crypto/evp/digest.c"
                                  ) {
        ...
        case 4:
            if (md->dfinal == 
# 1057 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 1057 "../crypto/evp/digest.c"
                                 ) {
        ...
        case 14:
            if (md->dsqueeze == 
# 1063 "../crypto/evp/digest.c" 3 4
                               ((void *)0)
# 1063 "../crypto/evp/digest.c"
                                   ) {
        ...
        case 5:
            if (md->digest == 
# 1069 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 1069 "../crypto/evp/digest.c"
                                 )
        ...
        case 6:
            if (md->freectx == 
# 1074 "../crypto/evp/digest.c" 3 4
                              ((void *)0)
# 1074 "../crypto/evp/digest.c"
                                  ) {
        ...
        case 7:
            if (md->dupctx == 
# 1080 "../crypto/evp/digest.c" 3 4
                             ((void *)0)
# 1080 "../crypto/evp/digest.c"
                                 )
                md->dupctx = OSSL_FUNC_digest_dupctx(fns);
            break;
        case 8:
            if (md->get_params == 
# 1084 "../crypto/evp/digest.c" 3 4
                                 ((void *)0)
# 1084 "../crypto/evp/digest.c"
                                     )
                md->get_params = OSSL_FUNC_digest_get_params(fns);
            break;
        case 9:
            if (md->set_ctx_params == 
# 1088 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
# 1088 "../crypto/evp/digest.c"
                                         )
                md->set_ctx_params = OSSL_FUNC_digest_set_ctx_params(fns);
            break;
        case 10:
            if (md->get_ctx_params == 
# 1092 "../crypto/evp/digest.c" 3 4
                                     ((void *)0)
# 1092 "../crypto/evp/digest.c"
                                         )
                md->get_ctx_params = OSSL_FUNC_digest_get_ctx_params(fns);
            break;
        case 11:
            if (md->gettable_params == 
# 1096 "../crypto/evp/digest.c" 3 4
                                      ((void *)0)
# 1096 "../crypto/evp/digest.c"
                                          )
                md->gettable_params = OSSL_FUNC_digest_gettable_params(fns);
            break;
        case 12:
            if (md->settable_ctx_params == 
# 1100 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 1100 "../crypto/evp/digest.c"
                                              )
                md->settable_ctx_params =
                    OSSL_FUNC_digest_settable_ctx_params(fns);
            break;
        case 13:
            if (md->gettable_ctx_params == 
# 1105 "../crypto/evp/digest.c" 3 4
                                          ((void *)0)
# 1105 "../crypto/evp/digest.c"
                                              )
                md->gettable_ctx_params =
    ...
    if ((fncnt != 0 && fncnt != 5 && fncnt != 6)
        || (fncnt == 0 && md->digest == 
# 1112 "../crypto/evp/digest.c" 3 4
                                       ((void *)0)
# 1112 "../crypto/evp/digest.c"
                                           )) {
        ...
        EVP_MD_free(md);
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",1120,__func__), ERR_set_error)((6),(193),
# 1120 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 1120 "../crypto/evp/digest.c"
       );
        return 
# 1121 "../crypto/evp/digest.c" 3 4
              ((void *)0)
# 1121 "../crypto/evp/digest.c"
                  ;
    }
    md->prov = prov;
    if (prov != 
# 1124 "../crypto/evp/digest.c" 3 4
               ((void *)0)
# 1124 "../crypto/evp/digest.c"
                   )
        ossl_provider_up_ref(prov);

    if (!evp_md_cache_constants(md)) {
        EVP_MD_free(md);
        (ERR_new(), ERR_set_debug("../crypto/evp/digest.c",1129,__func__), ERR_set_error)((6),(225),
# 1129 "../crypto/evp/digest.c" 3 4
       ((void *)0)
# 1129 "../crypto/evp/digest.c"
       );
        md = 
# 1130 "../crypto/evp/digest.c" 3 4
            ((void *)0)
# 1130 "../crypto/evp/digest.c"
                ;
    }
...
{
    EVP_MD *md =
        evp_generic_fetch(ctx, 1, algorithm, properties,
...
void EVP_MD_free(EVP_MD *md)
{
    ...
    if (md == 
# 1169 "../crypto/evp/digest.c" 3 4
             ((void *)0) 
# 1169 "../crypto/evp/digest.c"
                  || md->origin != 0)
        return;
