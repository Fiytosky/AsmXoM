# 0 "../crypto/evp/p_open.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_open.c"
# 10 "../crypto/evp/p_open.c"
...
{
    unsigned char *key = 
# 22 "../crypto/evp/p_open.c" 3 4
                        ((void *)0)
# 22 "../crypto/evp/p_open.c"
                            ;
    size_t keylen = 0;
    int ret = 0;
    EVP_PKEY_CTX *pctx = 
# 25 "../crypto/evp/p_open.c" 3 4
                        ((void *)0)
# 25 "../crypto/evp/p_open.c"
                            ;

    if (type) {
        EVP_CIPHER_CTX_reset(ctx);
        if (!EVP_DecryptInit_ex(ctx, type, 
# 29 "../crypto/evp/p_open.c" 3 4
                                          ((void *)0)
# 29 "../crypto/evp/p_open.c"
                                              , 
# 29 "../crypto/evp/p_open.c" 3 4
                                                ((void *)0)
# 29 "../crypto/evp/p_open.c"
...
# 29 "../crypto/evp/p_open.c"
    ...
    if (priv == 
# 33 "../crypto/evp/p_open.c" 3 4
               ((void *)0)
# 33 "../crypto/evp/p_open.c"
                   )
        return 1;

    if ((pctx = EVP_PKEY_CTX_new(priv, 
# 36 "../crypto/evp/p_open.c" 3 4
                                      ((void *)0)
# 36 "../crypto/evp/p_open.c"
                                          )) == 
# 36 "../crypto/evp/p_open.c" 3 4
                                                ((void *)0)
# 36 "../crypto/evp/p_open.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_open.c",37,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 37 "../crypto/evp/p_open.c" 3 4
       ((void *)0)
# 37 "../crypto/evp/p_open.c"
       );
        goto err;
    }
...
# 42 "../crypto/evp/p_open.c" 3 4
                                 ((void *)0)
# 42 "../crypto/evp/p_open.c"
                                     , &keylen, ek, ekl) <= 0)
        goto err;

    if ((key = CRYPTO_malloc(keylen, "../crypto/evp/p_open.c", 45)) == 
# 45 "../crypto/evp/p_open.c" 3 4
                                         ((void *)0)
# 45 "../crypto/evp/p_open.c"
                                             )
        goto err;
...
# 52 "../crypto/evp/p_open.c" 3 4
                                   ((void *)0)
# 52 "../crypto/evp/p_open.c"
                                       , 
# 52 "../crypto/evp/p_open.c" 3 4
                                         ((void *)0)
# 52 "../crypto/evp/p_open.c"
 ...
 err:
    ...
    CRYPTO_clear_free(key, keylen, "../crypto/evp/p_open.c", 58);
    return ret;
}
...
# 68 "../crypto/evp/p_open.c" 3 4
                                   ((void *)0)
# 68 "../crypto/evp/p_open.c"
                                       , 
# 68 "../crypto/evp/p_open.c" 3 4
                                         ((void *)0)
# 68 "../crypto/evp/p_open.c"
