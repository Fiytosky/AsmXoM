# 0 "../crypto/evp/p5_crpt2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p5_crpt2.c"
# 10 "../crypto/evp/p5_crpt2.c"
...
# 18 "../crypto/evp/p5_crpt2.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 19 "../crypto/evp/p5_crpt2.c" 2
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (pass == 
# 35 "../crypto/evp/p5_crpt2.c" 3 4
               ((void *)0)
# 35 "../crypto/evp/p5_crpt2.c"
                   ) {
        pass = empty;
        passlen = 0;
    } else if (passlen == -1) {
    ...
    if (salt == 
# 41 "../crypto/evp/p5_crpt2.c" 3 4
               ((void *)0) 
# 41 "../crypto/evp/p5_crpt2.c"
                    && saltlen == 0)
        salt = (unsigned char *)empty;

    kdf = EVP_KDF_fetch(libctx, "PBKDF2", propq);
    if (kdf == 
# 45 "../crypto/evp/p5_crpt2.c" 3 4
              ((void *)0)
# 45 "../crypto/evp/p5_crpt2.c"
                  )
         return 0;
    kctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kctx == 
# 49 "../crypto/evp/p5_crpt2.c" 3 4
               ((void *)0)
# 49 "../crypto/evp/p5_crpt2.c"
                   )
        return 0;
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    do { BIO *trc_out = 
# 65 "../crypto/evp/p5_crpt2.c" 3 4
   ((void *)0)
# 65 "../crypto/evp/p5_crpt2.c"
   ; if (0) {
                      ...
                      unsigned char *out)
{
    return ossl_pkcs5_pbkdf2_hmac_ex(pass, passlen, salt, saltlen, iter, digest,
                                     keylen, out, 
# 88 "../crypto/evp/p5_crpt2.c" 3 4
                                                 ((void *)0)
# 88 "../crypto/evp/p5_crpt2.c"
                                                     , 
# 88 "../crypto/evp/p5_crpt2.c" 3 4
                                                       ((void *)0)
# 88 "../crypto/evp/p5_crpt2.c"
                           ...
                           int keylen, unsigned char *out)
{
    ...
    if ((digest = EVP_MD_fetch(
# 99 "../crypto/evp/p5_crpt2.c" 3 4
                              ((void *)0)
# 99 "../crypto/evp/p5_crpt2.c"
                                  , "SHA1", 
# 99 "../crypto/evp/p5_crpt2.c" 3 4
                                             ((void *)0)
# 99 "../crypto/evp/p5_crpt2.c"
...
# 99 "../crypto/evp/p5_crpt2.c"
        ...
        r = ossl_pkcs5_pbkdf2_hmac_ex(pass, passlen, salt, saltlen, iter,
                                      digest, keylen, out, 
# 101 "../crypto/evp/p5_crpt2.c" 3 4
                                                          ((void *)0)
# 101 "../crypto/evp/p5_crpt2.c"
                                                              , 
# 101 "../crypto/evp/p5_crpt2.c" 3 4
                                                                ((void *)0)
# 101 "../crypto/evp/p5_crpt2.c"
...
{
    PBE2PARAM *pbe2 = 
# 117 "../crypto/evp/p5_crpt2.c" 3 4
                     ((void *)0)
# 117 "../crypto/evp/p5_crpt2.c"
                         ;
    char ciph_name[80];
    const EVP_CIPHER *cipher = 
# 119 "../crypto/evp/p5_crpt2.c" 3 4
                              ((void *)0)
# 119 "../crypto/evp/p5_crpt2.c"
                                  ;
    EVP_CIPHER *cipher_fetch = 
# 120 "../crypto/evp/p5_crpt2.c" 3 4
                              ((void *)0)
# 120 "../crypto/evp/p5_crpt2.c"
                                  ;
    ...
    if (pbe2 == 
# 126 "../crypto/evp/p5_crpt2.c" 3 4
               ((void *)0)
# 126 "../crypto/evp/p5_crpt2.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",127,__func__), ERR_set_error)((6),(114),
# 127 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 127 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }


    if (!EVP_PBE_find_ex(0x2, OBJ_obj2nid(pbe2->keyfunc->algorithm),
                         
# 133 "../crypto/evp/p5_crpt2.c" 3 4
                        ((void *)0)
# 133 "../crypto/evp/p5_crpt2.c"
                            , 
# 133 "../crypto/evp/p5_crpt2.c" 3 4
                              ((void *)0)
# 133 "../crypto/evp/p5_crpt2.c"
...
# 133 "../crypto/evp/p5_crpt2.c"
                                        , &kdf)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",134,__func__), ERR_set_error)((6),(124),
# 134 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 134 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    ...
    if (OBJ_obj2txt(ciph_name, sizeof(ciph_name), pbe2->encryption->algorithm, 0) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",142,__func__), ERR_set_error)((6),(107),
# 142 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 142 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    ...
    if (cipher == 
# 149 "../crypto/evp/p5_crpt2.c" 3 4
                 ((void *)0)
# 149 "../crypto/evp/p5_crpt2.c"
                     )
        cipher = EVP_get_cipherbyname(ciph_name);

    if (cipher == 
# 152 "../crypto/evp/p5_crpt2.c" 3 4
                 ((void *)0)
# 152 "../crypto/evp/p5_crpt2.c"
                     ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",154,__func__), ERR_set_error)((6),(107),
# 154 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 154 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
...
# 160 "../crypto/evp/p5_crpt2.c" 3 4
                                       ((void *)0)
# 160 "../crypto/evp/p5_crpt2.c"
                                           , 
# 160 "../crypto/evp/p5_crpt2.c" 3 4
                                             ((void *)0)
# 160 "../crypto/evp/p5_crpt2.c"
...
# 160 "../crypto/evp/p5_crpt2.c"
    ...
    if (EVP_CIPHER_asn1_to_param(ctx, pbe2->encryption->parameter) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",163,__func__), ERR_set_error)((6),(122),
# 163 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 163 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    rv = kdf(ctx, pass, passlen, pbe2->keyfunc->parameter, 
# 166 "../crypto/evp/p5_crpt2.c" 3 4
                                                          ((void *)0)
# 166 "../crypto/evp/p5_crpt2.c"
                                                              , 
# 166 "../crypto/evp/p5_crpt2.c" 3 4
                                                                ((void *)0)
# 166 "../crypto/evp/p5_crpt2.c"
...
# 177 "../crypto/evp/p5_crpt2.c" 3 4
                                                                            ((void *)0)
# 177 "../crypto/evp/p5_crpt2.c"
                                                                                , 
# 177 "../crypto/evp/p5_crpt2.c" 3 4
                                                                                  ((void *)0)
# 177 "../crypto/evp/p5_crpt2.c"
                                ...
                                OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    PBKDF2PARAM *kdf = 
# 190 "../crypto/evp/p5_crpt2.c" 3 4
                      ((void *)0)
# 190 "../crypto/evp/p5_crpt2.c"
                          ;
    const EVP_MD *prfmd = 
# 191 "../crypto/evp/p5_crpt2.c" 3 4
                         ((void *)0)
# 191 "../crypto/evp/p5_crpt2.c"
                             ;
    EVP_MD *prfmd_fetch = 
# 192 "../crypto/evp/p5_crpt2.c" 3 4
                         ((void *)0)
# 192 "../crypto/evp/p5_crpt2.c"
                             ;

    if (EVP_CIPHER_CTX_get0_cipher(ctx) == 
# 194 "../crypto/evp/p5_crpt2.c" 3 4
                                          ((void *)0)
# 194 "../crypto/evp/p5_crpt2.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",195,__func__), ERR_set_error)((6),(131),
# 195 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 195 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    keylen = EVP_CIPHER_CTX_get_key_length(ctx);
    (void)((keylen <= sizeof(key)) ? 0 : (OPENSSL_die("assertion failed: " "keylen <= sizeof(key)", "../crypto/evp/p5_crpt2.c", 199), 1));
    ...
    if (kdf == 
# 205 "../crypto/evp/p5_crpt2.c" 3 4
              ((void *)0)
# 205 "../crypto/evp/p5_crpt2.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",206,__func__), ERR_set_error)((6),(114),
# 206 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 206 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    ...
    if (t < 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",212,__func__), ERR_set_error)((6),(130),
# 212 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 212 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    keylen = t;
    ...
    if (kdf->keylength && (ASN1_INTEGER_get(kdf->keylength) != (int)keylen)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",220,__func__), ERR_set_error)((6),(123),
# 220 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 220 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
...
# 229 "../crypto/evp/p5_crpt2.c" 3 4
                                                ((void *)0)
# 229 "../crypto/evp/p5_crpt2.c"
                                                    , &hmac_md_nid, 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",230,__func__), ERR_set_error)((6),(125),
# 230 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 230 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    ...
    if (prfmd == 
# 236 "../crypto/evp/p5_crpt2.c" 3 4
                ((void *)0)
# 236 "../crypto/evp/p5_crpt2.c"
                    )
        prfmd = EVP_get_digestbyname(OBJ_nid2sn(hmac_md_nid));
    if (prfmd == 
# 238 "../crypto/evp/p5_crpt2.c" 3 4
                ((void *)0)
# 238 "../crypto/evp/p5_crpt2.c"
                    ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",240,__func__), ERR_set_error)((6),(125),
# 240 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 240 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
    (void)ERR_pop_to_mark();
    ...
    if (kdf->salt->type != 4) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p5_crpt2.c",246,__func__), ERR_set_error)((6),(126),
# 246 "../crypto/evp/p5_crpt2.c" 3 4
       ((void *)0)
# 246 "../crypto/evp/p5_crpt2.c"
       );
        goto err;
    }
...
# 257 "../crypto/evp/p5_crpt2.c" 3 4
                               ((void *)0)
# 257 "../crypto/evp/p5_crpt2.c"
                                   , 
# 257 "../crypto/evp/p5_crpt2.c" 3 4
                                     ((void *)0)
# 257 "../crypto/evp/p5_crpt2.c"
...
# 270 "../crypto/evp/p5_crpt2.c" 3 4
                                      ((void *)0)
# 270 "../crypto/evp/p5_crpt2.c"
                                          , 
# 270 "../crypto/evp/p5_crpt2.c" 3 4
                                            ((void *)0)
# 270 "../crypto/evp/p5_crpt2.c"
