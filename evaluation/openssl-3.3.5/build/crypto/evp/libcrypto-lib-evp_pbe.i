# 0 "../crypto/evp/evp_pbe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_pbe.c"
# 10 "../crypto/evp/evp_pbe.c"
...
# 13 "../crypto/evp/evp_pbe.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../crypto/evp/evp_pbe.c" 2
...
static const EVP_PBE_CTL builtin_pbe[] = {
    {0x0, 9,
     31, 3, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},
    {0x0, 10,
     31, 4, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},
    {0x0, 68,
     166, 64, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},

    {0x0, 69, -1, -1, PKCS5_v2_PBKDF2_keyivgen,
     PKCS5_v2_PBKDF2_keyivgen_ex},

    {0x0, 144,
     5, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},
    {0x0, 145,
     97, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},
    {0x0, 146,
     44, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},
    {0x0, 147,
     43, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},
    {0x0, 148,
     37, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},
    {0x0, 149,
     98, 64, PKCS12_PBE_keyivgen, &PKCS12_PBE_keyivgen_ex},

    {0x0, 161, -1, -1, PKCS5_v2_PBE_keyivgen, &PKCS5_v2_PBE_keyivgen_ex},

    {0x0, 168,
     166, 3, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},
    {0x0, 169,
     166, 4, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},
    {0x0, 170,
     31, 64, PKCS5_PBE_keyivgen, PKCS5_PBE_keyivgen_ex},
    ...
    {0x2, 69, -1, -1, PKCS5_v2_PBKDF2_keyivgen, &PKCS5_v2_PBKDF2_keyivgen_ex},

    {0x2, 973, -1, -1, PKCS5_v2_scrypt_keyivgen, &PKCS5_v2_scrypt_keyivgen_ex}
...
{
    const EVP_CIPHER *cipher = 
# 101 "../crypto/evp/evp_pbe.c" 3 4
                              ((void *)0)
# 101 "../crypto/evp/evp_pbe.c"
                                  ;
    EVP_CIPHER *cipher_fetch = 
# 102 "../crypto/evp/evp_pbe.c" 3 4
                              ((void *)0)
# 102 "../crypto/evp/evp_pbe.c"
                                  ;
    const EVP_MD *md = 
# 103 "../crypto/evp/evp_pbe.c" 3 4
                      ((void *)0)
# 103 "../crypto/evp/evp_pbe.c"
                          ;
    EVP_MD *md_fetch = 
# 104 "../crypto/evp/evp_pbe.c" 3 4
                      ((void *)0)
# 104 "../crypto/evp/evp_pbe.c"
                          ;
    int ret = 0, cipher_nid, md_nid;
    EVP_PBE_KEYGEN_EX *keygen_ex;
    EVP_PBE_KEYGEN *keygen;

    if (!EVP_PBE_find_ex(0x0, OBJ_obj2nid(pbe_obj),
                         &cipher_nid, &md_nid, &keygen, &keygen_ex)) {
        char obj_tmp[80];

        if (pbe_obj == 
# 113 "../crypto/evp/evp_pbe.c" 3 4
                      ((void *)0)
# 113 "../crypto/evp/evp_pbe.c"
                          )
            OPENSSL_strlcpy(obj_tmp, "NULL", sizeof(obj_tmp));
        else
            i2t_ASN1_OBJECT(obj_tmp, sizeof(obj_tmp), pbe_obj);
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_pbe.c",117,__func__), ERR_set_error)(6, 121,
                       "TYPE=%s", obj_tmp);
        goto err;
    }

    if (pass == 
# 122 "../crypto/evp/evp_pbe.c" 3 4
               ((void *)0)
# 122 "../crypto/evp/evp_pbe.c"
                   )
        passlen = 0;
    else if (passlen == -1)
        passlen = strlen(pass);
    ...
    if (cipher_nid != -1) {
        ...
        if (cipher == 
# 131 "../crypto/evp/evp_pbe.c" 3 4
                     ((void *)0)
# 131 "../crypto/evp/evp_pbe.c"
                         )
            cipher = EVP_get_cipherbyname(OBJ_nid2sn(cipher_nid));
        if (cipher == 
# 133 "../crypto/evp/evp_pbe.c" 3 4
                     ((void *)0)
# 133 "../crypto/evp/evp_pbe.c"
                         ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_pbe.c",135,__func__), ERR_set_error)(6, 160,
    ...
    if (md_nid != -1) {
        ...
        if (md == 
# 146 "../crypto/evp/evp_pbe.c" 3 4
                 ((void *)0)
# 146 "../crypto/evp/evp_pbe.c"
                     )
            md = EVP_get_digestbyname(OBJ_nid2sn(md_nid));

        if (md == 
# 149 "../crypto/evp/evp_pbe.c" 3 4
                 ((void *)0)
# 149 "../crypto/evp/evp_pbe.c"
                     ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_pbe.c",151,__func__), ERR_set_error)((6),(161),
# 151 "../crypto/evp/evp_pbe.c" 3 4
           ((void *)0)
# 151 "../crypto/evp/evp_pbe.c"
           );
            goto err;
        }
        (void)ERR_pop_to_mark();
    ...
    if (keygen_ex != 
# 158 "../crypto/evp/evp_pbe.c" 3 4
                    ((void *)0)
# 158 "../crypto/evp/evp_pbe.c"
                        )
...
# 173 "../crypto/evp/evp_pbe.c" 3 4
                                                                           ((void *)0)
# 173 "../crypto/evp/evp_pbe.c"
                                                                               , 
# 173 "../crypto/evp/evp_pbe.c" 3 4
                                                                                 ((void *)0)
# 173 "../crypto/evp/evp_pbe.c"
...
{
    EVP_PBE_CTL *pbe_tmp = 
# 203 "../crypto/evp/evp_pbe.c" 3 4
                          ((void *)0)
# 203 "../crypto/evp/evp_pbe.c"
                              ;

    if (pbe_algs == 
# 205 "../crypto/evp/evp_pbe.c" 3 4
                   ((void *)0)
# 205 "../crypto/evp/evp_pbe.c"
                       ) {
        pbe_algs = sk_EVP_PBE_CTL_new(pbe_cmp);
        if (pbe_algs == 
# 207 "../crypto/evp/evp_pbe.c" 3 4
                       ((void *)0)
# 207 "../crypto/evp/evp_pbe.c"
                           ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_pbe.c",208,__func__), ERR_set_error)((6),((15 | (0x2 << 18L))),
# 208 "../crypto/evp/evp_pbe.c" 3 4
           ((void *)0)
# 208 "../crypto/evp/evp_pbe.c"
           );
            goto err;
        }
    }

    if ((pbe_tmp = CRYPTO_zalloc(sizeof(*pbe_tmp), "../crypto/evp/evp_pbe.c", 213)) == 
# 213 "../crypto/evp/evp_pbe.c" 3 4
                                                       ((void *)0)
# 213 "../crypto/evp/evp_pbe.c"
                                                           )
        goto err;
    ...
    if (!sk_EVP_PBE_CTL_push(pbe_algs, pbe_tmp)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_pbe.c",223,__func__), ERR_set_error)((6),((15 | (0x2 << 18L))),
# 223 "../crypto/evp/evp_pbe.c" 3 4
       ((void *)0)
# 223 "../crypto/evp/evp_pbe.c"
       );
        goto err;
    }
    return 1;
 ...
 err:
    CRYPTO_free(pbe_tmp, "../crypto/evp/evp_pbe.c", 229);
    return 0;
}
...
{
    EVP_PBE_CTL *pbetmp = 
# 254 "../crypto/evp/evp_pbe.c" 3 4
                         ((void *)0)
# 254 "../crypto/evp/evp_pbe.c"
                             , pbelu;
    int i;
    if (pbe_nid == 0)
        return 0;
    ...
    if (pbe_algs != 
# 262 "../crypto/evp/evp_pbe.c" 3 4
                   ((void *)0)
# 262 "../crypto/evp/evp_pbe.c"
                       ) {
    ...
    if (pbetmp == 
# 268 "../crypto/evp/evp_pbe.c" 3 4
                 ((void *)0)
# 268 "../crypto/evp/evp_pbe.c"
                     ) {
        pbetmp = OBJ_bsearch_pbe2(&pbelu, builtin_pbe, (sizeof(builtin_pbe)/sizeof((builtin_pbe)[0])));
    }
    if (pbetmp == 
# 271 "../crypto/evp/evp_pbe.c" 3 4
                 ((void *)0)
# 271 "../crypto/evp/evp_pbe.c"
                     )
        return 0;
    if (pcnid != 
# 273 "../crypto/evp/evp_pbe.c" 3 4
                ((void *)0)
# 273 "../crypto/evp/evp_pbe.c"
                    )
        *pcnid = pbetmp->cipher_nid;
    if (pmnid != 
# 275 "../crypto/evp/evp_pbe.c" 3 4
                ((void *)0)
# 275 "../crypto/evp/evp_pbe.c"
                    )
        *pmnid = pbetmp->md_nid;
    if (pkeygen != 
# 277 "../crypto/evp/evp_pbe.c" 3 4
                  ((void *)0)
# 277 "../crypto/evp/evp_pbe.c"
                      )
        *pkeygen = pbetmp->keygen;
    if (pkeygen_ex != 
# 279 "../crypto/evp/evp_pbe.c" 3 4
                     ((void *)0)
# 279 "../crypto/evp/evp_pbe.c"
                         )
...
{
    return EVP_PBE_find_ex(type, pbe_nid, pcnid, pmnid, pkeygen, 
# 287 "../crypto/evp/evp_pbe.c" 3 4
                                                                ((void *)0)
# 287 "../crypto/evp/evp_pbe.c"
                                                                    );
}

static void free_evp_pbe_ctl(EVP_PBE_CTL *pbe)
{
    CRYPTO_free(pbe, "../crypto/evp/evp_pbe.c", 292);
}
...
void EVP_PBE_cleanup(void)
{
    ...
    pbe_algs = 
# 298 "../crypto/evp/evp_pbe.c" 3 4
              ((void *)0)
# 298 "../crypto/evp/evp_pbe.c"
                  ;
}
...
int EVP_PBE_get(int *ptype, int *ppbe_nid, size_t num)
{
    ...
    if (num >= (sizeof(builtin_pbe)/sizeof((builtin_pbe)[0])))
        return 0;
