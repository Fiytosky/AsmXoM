# 0 "../crypto/evp/p_verify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_verify.c"
# 10 "../crypto/evp/p_verify.c"
                       ...
                       const char *propq)
{
    ...
    int i = 0;
    EVP_PKEY_CTX *pkctx = 
# 24 "../crypto/evp/p_verify.c" 3 4
                         ((void *)0)
# 24 "../crypto/evp/p_verify.c"
                             ;

    if (EVP_MD_CTX_test_flags(ctx, 0x0200)) {
        ...
        if (tmp_ctx == 
# 33 "../crypto/evp/p_verify.c" 3 4
                      ((void *)0)
# 33 "../crypto/evp/p_verify.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_verify.c",34,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 34 "../crypto/evp/p_verify.c" 3 4
           ((void *)0)
# 34 "../crypto/evp/p_verify.c"
           );
            return 0;
        }
    ...
    if (pkctx == 
# 49 "../crypto/evp/p_verify.c" 3 4
                ((void *)0)
# 49 "../crypto/evp/p_verify.c"
                    )
        goto err;
...
int EVP_VerifyFinal(EVP_MD_CTX *ctx, const unsigned char *sigbuf,
                    unsigned int siglen, EVP_PKEY *pkey)
{
    return EVP_VerifyFinal_ex(ctx, sigbuf, siglen, pkey, 
# 64 "../crypto/evp/p_verify.c" 3 4
                                                        ((void *)0)
# 64 "../crypto/evp/p_verify.c"
                                                            , 
# 64 "../crypto/evp/p_verify.c" 3 4
                                                              ((void *)0)
# 64 "../crypto/evp/p_verify.c"
