# 0 "../crypto/evp/legacy_mdc2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_mdc2.c"
# 14 "../crypto/evp/legacy_mdc2.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../crypto/evp/legacy_mdc2.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 19 "../crypto/evp/legacy_mdc2.c" 2

static int mdc2_init(EVP_MD_CTX *ctx) { return MDC2_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int mdc2_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return MDC2_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int mdc2_final(EVP_MD_CTX *ctx, unsigned char *md) { return MDC2_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
...
# 28 "../crypto/evp/legacy_mdc2.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_mdc2.c"
   , 
# 28 "../crypto/evp/legacy_mdc2.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_mdc2.c"
