# 0 "../crypto/evp/names.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/names.c"
# 10 "../crypto/evp/names.c"
...
int EVP_add_cipher(const EVP_CIPHER *c)
{
    ...
    if (c == 
# 23 "../crypto/evp/names.c" 3 4
            ((void *)0)
# 23 "../crypto/evp/names.c"
                )
        return 0;
...
static void cipher_from_name(const char *name, void *data)
{
    ...
    if (*cipher != 
# 64 "../crypto/evp/names.c" 3 4
                  ((void *)0)
# 64 "../crypto/evp/names.c"
                      )
        return;

    *cipher = (const EVP_CIPHER *)OBJ_NAME_get(name, 0x02);
}

const EVP_CIPHER *EVP_get_cipherbyname(const char *name)
{
    return evp_get_cipherbyname_ex(
# 72 "../crypto/evp/names.c" 3 4
                                  ((void *)0)
# 72 "../crypto/evp/names.c"
                                      , name);
}
                                          ...
                                          const char *name)
{
    ...
    if (!OPENSSL_init_crypto(0x00000004L, 
# 83 "../crypto/evp/names.c" 3 4
                                                          ((void *)0)
# 83 "../crypto/evp/names.c"
                                                              ))
        return 
# 84 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 84 "../crypto/evp/names.c"
                  ;

    cp = (const EVP_CIPHER *)OBJ_NAME_get(name, 0x02);

    if (cp != 
# 88 "../crypto/evp/names.c" 3 4
             ((void *)0)
# 88 "../crypto/evp/names.c"
                 )
        return cp;
 ...
 retry:
    ...
    if (id == 0) {
        ...
        if (!do_retry)
            return 
# 105 "../crypto/evp/names.c" 3 4
                  ((void *)0)
# 105 "../crypto/evp/names.c"
                      ;
        do_retry = 0;
        ERR_set_mark();
        fetched_cipher = EVP_CIPHER_fetch(libctx, name, 
# 108 "../crypto/evp/names.c" 3 4
                                                       ((void *)0)
# 108 "../crypto/evp/names.c"
                                                           );
    ...
    if (!ossl_namemap_doall_names(namemap, id, cipher_from_name, &cp))
        return 
# 115 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 115 "../crypto/evp/names.c"
                  ;
...
static void digest_from_name(const char *name, void *data)
{
    ...
    if (*md != 
# 124 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 124 "../crypto/evp/names.c"
                  )
        return;

    *md = (const EVP_MD *)OBJ_NAME_get(name, 0x01);
}

const EVP_MD *EVP_get_digestbyname(const char *name)
{
    return evp_get_digestbyname_ex(
# 132 "../crypto/evp/names.c" 3 4
                                  ((void *)0)
# 132 "../crypto/evp/names.c"
                                      , name);
}
...
const EVP_MD *evp_get_digestbyname_ex(OSSL_LIB_CTX *libctx, const char *name)
{
    ...
    if (!OPENSSL_init_crypto(0x00000008L, 
# 142 "../crypto/evp/names.c" 3 4
                                                          ((void *)0)
# 142 "../crypto/evp/names.c"
                                                              ))
        return 
# 143 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 143 "../crypto/evp/names.c"
                  ;

    dp = (const EVP_MD *)OBJ_NAME_get(name, 0x01);

    if (dp != 
# 147 "../crypto/evp/names.c" 3 4
             ((void *)0)
# 147 "../crypto/evp/names.c"
                 )
        return dp;
 ...
 retry:
    ...
    if (id == 0) {
        ...
        if (!do_retry)
            return 
# 164 "../crypto/evp/names.c" 3 4
                  ((void *)0)
# 164 "../crypto/evp/names.c"
                      ;
        do_retry = 0;
        ERR_set_mark();
        fetched_md = EVP_MD_fetch(libctx, name, 
# 167 "../crypto/evp/names.c" 3 4
                                               ((void *)0)
# 167 "../crypto/evp/names.c"
                                                   );
    ...
    if (!ossl_namemap_doall_names(namemap, id, digest_from_name, &dp))
        return 
# 174 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 174 "../crypto/evp/names.c"
                  ;
...
static void do_all_cipher_fn(const OBJ_NAME *nm, void *arg)
{
    ...
    if (nm->alias)
        dc->fn(
# 207 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 207 "../crypto/evp/names.c"
                  , nm->name, nm->data, dc->arg);
    else
        dc->fn((const EVP_CIPHER *)nm->data, nm->name, 
# 209 "../crypto/evp/names.c" 3 4
                                                      ((void *)0)
# 209 "../crypto/evp/names.c"
                                                          , dc->arg);
}
                       ...
                       void *arg)
{
    ...
    OPENSSL_init_crypto(0x00000004L, 
# 219 "../crypto/evp/names.c" 3 4
                                                     ((void *)0)
# 219 "../crypto/evp/names.c"
                                                         );
                                          ...
                                          void *x), void *arg)
{
    ...
    OPENSSL_init_crypto(0x00000004L, 
# 233 "../crypto/evp/names.c" 3 4
                                                     ((void *)0)
# 233 "../crypto/evp/names.c"
                                                         );

    dc.fn = fn;
    dc.arg = arg;
    OBJ_NAME_do_all_sorted(0x02, do_all_cipher_fn, &dc);
}
...
static void do_all_md_fn(const OBJ_NAME *nm, void *arg)
{
    ...
    if (nm->alias)
        dc->fn(
# 250 "../crypto/evp/names.c" 3 4
              ((void *)0)
# 250 "../crypto/evp/names.c"
                  , nm->name, nm->data, dc->arg);
    else
        dc->fn((const EVP_MD *)nm->data, nm->name, 
# 252 "../crypto/evp/names.c" 3 4
                                                  ((void *)0)
# 252 "../crypto/evp/names.c"
                                                      , dc->arg);
}
                   ...
                   void *arg)
{
    ...
    OPENSSL_init_crypto(0x00000008L, 
# 262 "../crypto/evp/names.c" 3 4
                                                     ((void *)0)
# 262 "../crypto/evp/names.c"
                                                         );
                                      ...
                                      void *x), void *arg)
{
    ...
    OPENSSL_init_crypto(0x00000008L, 
# 275 "../crypto/evp/names.c" 3 4
                                                     ((void *)0)
# 275 "../crypto/evp/names.c"
                                                         );
