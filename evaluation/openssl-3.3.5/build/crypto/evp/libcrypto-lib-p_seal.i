# 0 "../crypto/evp/p_seal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_seal.c"
# 10 "../crypto/evp/p_seal.c"
                 ...
                 EVP_PKEY **pubk, int npubk)
{
    ...
    OSSL_LIB_CTX *libctx = 
# 25 "../crypto/evp/p_seal.c" 3 4
                          ((void *)0)
# 25 "../crypto/evp/p_seal.c"
                              ;
    EVP_PKEY_CTX *pctx = 
# 26 "../crypto/evp/p_seal.c" 3 4
                        ((void *)0)
# 26 "../crypto/evp/p_seal.c"
                            ;
    const EVP_CIPHER *cipher;
    int i, len;
    int rv = 0;
    ...
    if (type != 
# 31 "../crypto/evp/p_seal.c" 3 4
               ((void *)0)
# 31 "../crypto/evp/p_seal.c"
                   ) {
        EVP_CIPHER_CTX_reset(ctx);
        if (!EVP_EncryptInit_ex(ctx, type, 
# 33 "../crypto/evp/p_seal.c" 3 4
                                          ((void *)0)
# 33 "../crypto/evp/p_seal.c"
                                              , 
# 33 "../crypto/evp/p_seal.c" 3 4
                                                ((void *)0)
# 33 "../crypto/evp/p_seal.c"
...
# 33 "../crypto/evp/p_seal.c"
    ...
    if ((cipher = EVP_CIPHER_CTX_get0_cipher(ctx)) != 
# 36 "../crypto/evp/p_seal.c" 3 4
                                                     ((void *)0)
            
# 37 "../crypto/evp/p_seal.c"
           && (prov = EVP_CIPHER_get0_provider(cipher)) != 
# 37 "../crypto/evp/p_seal.c" 3 4
                                                           ((void *)0)
# 37 "../crypto/evp/p_seal.c"
                                                               )
...
# 53 "../crypto/evp/p_seal.c" 3 4
                                ((void *)0)
# 53 "../crypto/evp/p_seal.c"
                                    , 
# 53 "../crypto/evp/p_seal.c" 3 4
                                      ((void *)0)
# 53 "../crypto/evp/p_seal.c"
    ...
    for (i = 0; i < npubk; i++) {
        ...
        pctx = EVP_PKEY_CTX_new_from_pkey(libctx, pubk[i], 
# 60 "../crypto/evp/p_seal.c" 3 4
                                                          ((void *)0)
# 60 "../crypto/evp/p_seal.c"
                                                              );
        if (pctx == 
# 61 "../crypto/evp/p_seal.c" 3 4
                   ((void *)0)
# 61 "../crypto/evp/p_seal.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_seal.c",62,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 62 "../crypto/evp/p_seal.c" 3 4
           ((void *)0)
# 62 "../crypto/evp/p_seal.c"
           );
            goto err;
        }
    ...
    pctx = 
# 72 "../crypto/evp/p_seal.c" 3 4
          ((void *)0)
# 72 "../crypto/evp/p_seal.c"
              ;
    rv = npubk;
err:
    EVP_PKEY_CTX_free(pctx);
...
# 85 "../crypto/evp/p_seal.c" 3 4
                                   ((void *)0)
# 85 "../crypto/evp/p_seal.c"
                                       , 
# 85 "../crypto/evp/p_seal.c" 3 4
                                         ((void *)0)
# 85 "../crypto/evp/p_seal.c"
