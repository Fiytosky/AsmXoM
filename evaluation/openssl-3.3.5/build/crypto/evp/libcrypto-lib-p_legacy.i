# 0 "../crypto/evp/p_legacy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_legacy.c"
# 14 "../crypto/evp/p_legacy.c"
...
# 24 "../crypto/evp/p_legacy.c" 2

int EVP_PKEY_set1_RSA(EVP_PKEY *pkey, RSA *key)
{
    int ret = EVP_PKEY_assign((pkey),6, (key));
...
RSA *evp_pkey_get0_RSA_int(const EVP_PKEY *pkey)
{
    if (pkey->type != 6 && pkey->type != 912) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_legacy.c",37,__func__), ERR_set_error)((6),(127),
# 37 "../crypto/evp/p_legacy.c" 3 4
       ((void *)0)
# 37 "../crypto/evp/p_legacy.c"
       );
        return 
# 38 "../crypto/evp/p_legacy.c" 3 4
              ((void *)0)
# 38 "../crypto/evp/p_legacy.c"
                  ;
    }
...
RSA *EVP_PKEY_get1_RSA(EVP_PKEY *pkey)
{
    ...
    if (ret != 
# 52 "../crypto/evp/p_legacy.c" 3 4
              ((void *)0)
# 52 "../crypto/evp/p_legacy.c"
                  )
        RSA_up_ref(ret);
    return ret;
}
...
int EVP_PKEY_set1_EC_KEY(EVP_PKEY *pkey, EC_KEY *key)
{
    if (!EC_KEY_up_ref(key))
        return 0;
    if (!EVP_PKEY_assign((pkey), 408, (key))) {
        EC_KEY_free(key);
        return 0;
    }
    return 1;
...
EC_KEY *evp_pkey_get0_EC_KEY_int(const EVP_PKEY *pkey)
{
    if (EVP_PKEY_get_base_id(pkey) != 408) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_legacy.c",72,__func__), ERR_set_error)((6),(142),
# 72 "../crypto/evp/p_legacy.c" 3 4
       ((void *)0)
# 72 "../crypto/evp/p_legacy.c"
       );
        return 
# 73 "../crypto/evp/p_legacy.c" 3 4
              ((void *)0)
# 73 "../crypto/evp/p_legacy.c"
                  ;
    }
    return evp_pkey_get_legacy((EVP_PKEY *)pkey);
}
...
EC_KEY *EVP_PKEY_get1_EC_KEY(EVP_PKEY *pkey)
{
    ...
    if (ret != 
# 87 "../crypto/evp/p_legacy.c" 3 4
              ((void *)0) 
# 87 "../crypto/evp/p_legacy.c"
                   && !EC_KEY_up_ref(ret))
        ret = 
# 88 "../crypto/evp/p_legacy.c" 3 4
             ((void *)0)
# 88 "../crypto/evp/p_legacy.c"
                 ;
    return ret;
}
