# 0 "../crypto/evp/ec_support.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/ec_support.c"
# 10 "../crypto/evp/ec_support.c"
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst, int dlen,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq);
# 13 "../crypto/evp/ec_support.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 14 "../crypto/evp/ec_support.c" 2
...
static const EC_NAME2NID curve_list[] = {
    ...
    {"wap-wsg-idm-ecid-wtls1", 735 },
    {"wap-wsg-idm-ecid-wtls3", 736 },
    {"wap-wsg-idm-ecid-wtls4", 737 },
    {"wap-wsg-idm-ecid-wtls5", 738 },
    {"wap-wsg-idm-ecid-wtls6", 739 },
    {"wap-wsg-idm-ecid-wtls7", 740 },
    {"wap-wsg-idm-ecid-wtls8", 741 },
    {"wap-wsg-idm-ecid-wtls9", 742 },
    {"wap-wsg-idm-ecid-wtls10", 743 },
    {"wap-wsg-idm-ecid-wtls11", 744 },
    {"wap-wsg-idm-ecid-wtls12", 745 },
...
const char *OSSL_EC_curve_nid2name(int nid)
{
    ...
    if (nid <= 0)
        return 
# 123 "../crypto/evp/ec_support.c" 3 4
              ((void *)0)
# 123 "../crypto/evp/ec_support.c"
                  ;
    ...
    return 
# 129 "../crypto/evp/ec_support.c" 3 4
          ((void *)0)
# 129 "../crypto/evp/ec_support.c"
              ;
}
...
int ossl_ec_curve_name2nid(const char *name)
{
    ...
    if (name != 
# 137 "../crypto/evp/ec_support.c" 3 4
               ((void *)0)
# 137 "../crypto/evp/ec_support.c"
                   ) {
        if ((nid = ossl_ec_curve_nist2nid_int(name)) != 0)
            return nid;
...
const char *ossl_ec_curve_nid2nist_int(int nid)
{
    ...
    return 
# 177 "../crypto/evp/ec_support.c" 3 4
          ((void *)0)
# 177 "../crypto/evp/ec_support.c"
              ;
}
