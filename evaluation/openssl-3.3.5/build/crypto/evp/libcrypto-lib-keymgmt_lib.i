# 0 "../crypto/evp/keymgmt_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/keymgmt_lib.c"
# 10 "../crypto/evp/keymgmt_lib.c"
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 11 "../crypto/evp/keymgmt_lib.c" 2
...
int evp_keymgmt_util_try_import(const OSSL_PARAM params[], void *arg)
{
    ...
    if (data->keydata == 
# 35 "../crypto/evp/keymgmt_lib.c" 3 4
                        ((void *)0)
# 35 "../crypto/evp/keymgmt_lib.c"
                            ) {
        if ((data->keydata = evp_keymgmt_newdata(data->keymgmt)) == 
# 36 "../crypto/evp/keymgmt_lib.c" 3 4
                                                                   ((void *)0)
# 36 "../crypto/evp/keymgmt_lib.c"
                                                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/keymgmt_lib.c",37,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 37 "../crypto/evp/keymgmt_lib.c" 3 4
           ((void *)0)
# 37 "../crypto/evp/keymgmt_lib.c"
           );
            return 0;
        }
        delete_on_error = 1;
    ...
    if (params[0].key == 
# 47 "../crypto/evp/keymgmt_lib.c" 3 4
                        ((void *)0)
# 47 "../crypto/evp/keymgmt_lib.c"
                            )
        return 1;
    ...
    if (delete_on_error) {
        ...
        data->keydata = 
# 55 "../crypto/evp/keymgmt_lib.c" 3 4
                       ((void *)0)
# 55 "../crypto/evp/keymgmt_lib.c"
                           ;
    }
    return 0;
}
...
{
    if (pkey == 
# 63 "../crypto/evp/keymgmt_lib.c" 3 4
               ((void *)0) 
# 63 "../crypto/evp/keymgmt_lib.c"
                    || keymgmt == 
# 63 "../crypto/evp/keymgmt_lib.c" 3 4
                                  ((void *)0) 
# 63 "../crypto/evp/keymgmt_lib.c"
...
# 64 "../crypto/evp/keymgmt_lib.c"
       || !EVP_PKEY_set_type_by_keymgmt(pkey, keymgmt)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/keymgmt_lib.c",65,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 65 "../crypto/evp/keymgmt_lib.c" 3 4
       ((void *)0)
# 65 "../crypto/evp/keymgmt_lib.c"
       );
        return 0;
    }
...
{
    EVP_PKEY *pkey = 
# 75 "../crypto/evp/keymgmt_lib.c" 3 4
                    ((void *)0)
# 75 "../crypto/evp/keymgmt_lib.c"
                        ;

    if (keymgmt == 
# 77 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0)
        
# 78 "../crypto/evp/keymgmt_lib.c"
       || keydata == 
# 78 "../crypto/evp/keymgmt_lib.c" 3 4
                     ((void *)0)
        
# 79 "../crypto/evp/keymgmt_lib.c"
       || (pkey = EVP_PKEY_new()) == 
# 79 "../crypto/evp/keymgmt_lib.c" 3 4
                                     ((void *)0)
        
# 80 "../crypto/evp/keymgmt_lib.c"
       || !evp_keymgmt_util_assign_pkey(pkey, keymgmt, keydata)) {
        EVP_PKEY_free(pkey);
        return 
# 82 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 82 "../crypto/evp/keymgmt_lib.c"
                  ;
    }
    return pkey;
}
...
{
    if (pk == 
# 90 "../crypto/evp/keymgmt_lib.c" 3 4
             ((void *)0) 
# 90 "../crypto/evp/keymgmt_lib.c"
                  || export_cb == 
# 90 "../crypto/evp/keymgmt_lib.c" 3 4
                                  ((void *)0)
# 90 "../crypto/evp/keymgmt_lib.c"
                                          ...
                                          int selection)
{
    ...
    if (keymgmt == 
# 103 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0)
# 103 "../crypto/evp/keymgmt_lib.c"
                      )
        return 
# 104 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 104 "../crypto/evp/keymgmt_lib.c"
                  ;


    if (pk->keydata == 
# 107 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
# 107 "../crypto/evp/keymgmt_lib.c"
                          )
        return 
# 108 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 108 "../crypto/evp/keymgmt_lib.c"
                  ;
# 117 "../crypto/evp/keymgmt_lib.c"
    ...
    if (!CRYPTO_THREAD_read_lock(pk->lock))
        return 
# 123 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 123 "../crypto/evp/keymgmt_lib.c"
                  ;
    ...
    if (pk->dirty_cnt == pk->dirty_cnt_copy) {
        ...
        if (op != 
# 132 "../crypto/evp/keymgmt_lib.c" 3 4
                 ((void *)0) 
# 132 "../crypto/evp/keymgmt_lib.c"
                      && op->keymgmt != 
# 132 "../crypto/evp/keymgmt_lib.c" 3 4
                                        ((void *)0)
# 132 "../crypto/evp/keymgmt_lib.c"
    ...
    if (pk->keymgmt->export == 
# 142 "../crypto/evp/keymgmt_lib.c" 3 4
                              ((void *)0)
# 142 "../crypto/evp/keymgmt_lib.c"
                                  )
        return 
# 143 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 143 "../crypto/evp/keymgmt_lib.c"
                  ;
    ...
    if (!__builtin_expect(!!((match_type(pk->keymgmt, keymgmt)) != 0), 1))
        return 
# 150 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 150 "../crypto/evp/keymgmt_lib.c"
                  ;
# 159 "../crypto/evp/keymgmt_lib.c"
    import_data.keydata = 
# 159 "../crypto/evp/keymgmt_lib.c" 3 4
                         ((void *)0)
# 159 "../crypto/evp/keymgmt_lib.c"
                             ;
    ...
    if (!evp_keymgmt_util_export(pk, selection,
        ...
        return 
# 170 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 170 "../crypto/evp/keymgmt_lib.c"
                  ;

    if (!CRYPTO_THREAD_write_lock(pk->lock)) {
        evp_keymgmt_freedata(keymgmt, import_data.keydata);
        return 
# 174 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 174 "../crypto/evp/keymgmt_lib.c"
                  ;
    }

    op = evp_keymgmt_util_find_operation_cache(pk, keymgmt, selection);
    if (op != 
# 178 "../crypto/evp/keymgmt_lib.c" 3 4
             ((void *)0) 
# 178 "../crypto/evp/keymgmt_lib.c"
                  && op->keydata != 
# 178 "../crypto/evp/keymgmt_lib.c" 3 4
                                    ((void *)0)
# 178 "../crypto/evp/keymgmt_lib.c"
    ...
    if (!evp_keymgmt_util_cache_keydata(pk, keymgmt, import_data.keydata,
        ...
        evp_keymgmt_freedata(keymgmt, import_data.keydata);
        return 
# 204 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0)
# 204 "../crypto/evp/keymgmt_lib.c"
                  ;
    }
...
static void op_cache_free(OP_CACHE_ELEM *e)
{
    ...
    CRYPTO_free(e, "../crypto/evp/keymgmt_lib.c", 219);
}

int evp_keymgmt_util_clear_operation_cache(EVP_PKEY *pk)
{
    if (pk != 
# 224 "../crypto/evp/keymgmt_lib.c" 3 4
             ((void *)0)
# 224 "../crypto/evp/keymgmt_lib.c"
                 ) {
        sk_OP_CACHE_ELEM_pop_free(pk->operation_cache, op_cache_free);
        pk->operation_cache = 
# 226 "../crypto/evp/keymgmt_lib.c" 3 4
                             ((void *)0)
# 226 "../crypto/evp/keymgmt_lib.c"
                                 ;
    }
                                                     ...
                                                     int selection)
{
    ...
    return 
# 253 "../crypto/evp/keymgmt_lib.c" 3 4
          ((void *)0)
# 253 "../crypto/evp/keymgmt_lib.c"
              ;
}
...
{
    OP_CACHE_ELEM *p = 
# 259 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
# 259 "../crypto/evp/keymgmt_lib.c"
                          ;

    if (keydata != 
# 261 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0)
# 261 "../crypto/evp/keymgmt_lib.c"
                      ) {
        if (pk->operation_cache == 
# 262 "../crypto/evp/keymgmt_lib.c" 3 4
                                  ((void *)0)
# 262 "../crypto/evp/keymgmt_lib.c"
                                      ) {
            pk->operation_cache = sk_OP_CACHE_ELEM_new_null();
            if (pk->operation_cache == 
# 264 "../crypto/evp/keymgmt_lib.c" 3 4
                                      ((void *)0)
# 264 "../crypto/evp/keymgmt_lib.c"
                                          )
                return 0;
        }

        p = CRYPTO_malloc(sizeof(*p), "../crypto/evp/keymgmt_lib.c", 268);
        if (p == 
# 269 "../crypto/evp/keymgmt_lib.c" 3 4
                ((void *)0)
# 269 "../crypto/evp/keymgmt_lib.c"
                    )
            return 0;
        p->keydata = keydata;
        p->keymgmt = keymgmt;
        ...
        if (!EVP_KEYMGMT_up_ref(keymgmt)) {
            CRYPTO_free(p, "../crypto/evp/keymgmt_lib.c", 276);
            return 0;
        }

        if (!sk_OP_CACHE_ELEM_push(pk->operation_cache, p)) {
            EVP_KEYMGMT_free(keymgmt);
            CRYPTO_free(p, "../crypto/evp/keymgmt_lib.c", 282);
            return 0;
        }
    }
    return 1;
...
void evp_keymgmt_util_cache_keyinfo(EVP_PKEY *pk)
{
    ...
    if (pk->keydata != 
# 296 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
# 296 "../crypto/evp/keymgmt_lib.c"
                          ) {
        int bits = 0;
        int security_bits = 0;
        int size = 0;
        ...
        params[1] = OSSL_PARAM_construct_int("security-bits",
                                             &security_bits);
        params[2] = OSSL_PARAM_construct_int("max-size", &size);
...
{
    void *keydata = 
# 318 "../crypto/evp/keymgmt_lib.c" 3 4
                   ((void *)0)
# 318 "../crypto/evp/keymgmt_lib.c"
                       ;

    if ((keydata = evp_keymgmt_newdata(keymgmt)) == 
# 320 "../crypto/evp/keymgmt_lib.c" 3 4
                                                   ((void *)0)
        
# 321 "../crypto/evp/keymgmt_lib.c"
       || !evp_keymgmt_import(keymgmt, keydata, selection, params)
        || !evp_keymgmt_util_assign_pkey(target, keymgmt, keydata)) {
        evp_keymgmt_freedata(keymgmt, keydata);
        keydata = 
# 324 "../crypto/evp/keymgmt_lib.c" 3 4
                 ((void *)0)
# 324 "../crypto/evp/keymgmt_lib.c"
                     ;
    }
    return keydata;
}
...
int evp_keymgmt_util_has(EVP_PKEY *pk, int selection)
{
    ...
    if (pk->keymgmt == 
# 332 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
# 332 "../crypto/evp/keymgmt_lib.c"
                          )
        return 0;

    return evp_keymgmt_has(pk->keymgmt, pk->keydata, selection);
}
# 351 "../crypto/evp/keymgmt_lib.c"
int evp_keymgmt_util_match(EVP_PKEY *pk1, EVP_PKEY *pk2, int selection)
{
    EVP_KEYMGMT *keymgmt1 = 
# 353 "../crypto/evp/keymgmt_lib.c" 3 4
                           ((void *)0)
# 353 "../crypto/evp/keymgmt_lib.c"
                               , *keymgmt2 = 
# 353 "../crypto/evp/keymgmt_lib.c" 3 4
                                             ((void *)0)
# 353 "../crypto/evp/keymgmt_lib.c"
                                                 ;
    void *keydata1 = 
# 354 "../crypto/evp/keymgmt_lib.c" 3 4
                    ((void *)0)
# 354 "../crypto/evp/keymgmt_lib.c"
                        , *keydata2 = 
# 354 "../crypto/evp/keymgmt_lib.c" 3 4
                                      ((void *)0)
# 354 "../crypto/evp/keymgmt_lib.c"
    ...
    if (pk1 == 
# 356 "../crypto/evp/keymgmt_lib.c" 3 4
              ((void *)0) 
# 356 "../crypto/evp/keymgmt_lib.c"
                   || pk2 == 
# 356 "../crypto/evp/keymgmt_lib.c" 3 4
                             ((void *)0)
# 356 "../crypto/evp/keymgmt_lib.c"
        ...
        if (pk1 == 
# 357 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0) 
# 357 "../crypto/evp/keymgmt_lib.c"
                       && pk2 == 
# 357 "../crypto/evp/keymgmt_lib.c" 3 4
                                 ((void *)0)
# 357 "../crypto/evp/keymgmt_lib.c"
...
# 378 "../crypto/evp/keymgmt_lib.c"
        int ok = 0;


        if (keymgmt1 != 
# 381 "../crypto/evp/keymgmt_lib.c" 3 4
                       ((void *)0)
            
# 382 "../crypto/evp/keymgmt_lib.c"
           && keymgmt2 != 
# 382 "../crypto/evp/keymgmt_lib.c" 3 4
                          ((void *)0)
            
# 383 "../crypto/evp/keymgmt_lib.c"
           && !match_type(keymgmt1, keymgmt2)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/keymgmt_lib.c",384,__func__), ERR_set_error)((6),(101),
# 384 "../crypto/evp/keymgmt_lib.c" 3 4
           ((void *)0)
# 384 "../crypto/evp/keymgmt_lib.c"
           );
            return -1;
        }
        ...
        if (keymgmt2 != 
# 392 "../crypto/evp/keymgmt_lib.c" 3 4
                       ((void *)0)
            
# 393 "../crypto/evp/keymgmt_lib.c"
           && keymgmt2->match != 
# 393 "../crypto/evp/keymgmt_lib.c" 3 4
                                 ((void *)0)
# 393 "../crypto/evp/keymgmt_lib.c"
                                     ) {
            void *tmp_keydata = 
# 394 "../crypto/evp/keymgmt_lib.c" 3 4
                               ((void *)0)
# 394 "../crypto/evp/keymgmt_lib.c"
                                   ;

            ok = 1;
            if (keydata1 != 
# 397 "../crypto/evp/keymgmt_lib.c" 3 4
                           ((void *)0)
# 397 "../crypto/evp/keymgmt_lib.c"
                               ) {
                tmp_keydata =
                    evp_keymgmt_util_export_to_provider(pk1, keymgmt2,
                                                        selection);
                ok = (tmp_keydata != 
# 401 "../crypto/evp/keymgmt_lib.c" 3 4
                                    ((void *)0)
# 401 "../crypto/evp/keymgmt_lib.c"
                                        );
            }
            if (ok) {
                keymgmt1 = keymgmt2;
        ...
        if (!ok
            && keymgmt1 != 
# 413 "../crypto/evp/keymgmt_lib.c" 3 4
                          ((void *)0)
            
# 414 "../crypto/evp/keymgmt_lib.c"
           && keymgmt1->match != 
# 414 "../crypto/evp/keymgmt_lib.c" 3 4
                                 ((void *)0)
# 414 "../crypto/evp/keymgmt_lib.c"
                                     ) {
            void *tmp_keydata = 
# 415 "../crypto/evp/keymgmt_lib.c" 3 4
                               ((void *)0)
# 415 "../crypto/evp/keymgmt_lib.c"
                                   ;

            ok = 1;
            if (keydata2 != 
# 418 "../crypto/evp/keymgmt_lib.c" 3 4
                           ((void *)0)
# 418 "../crypto/evp/keymgmt_lib.c"
                               ) {
                tmp_keydata =
                    evp_keymgmt_util_export_to_provider(pk2, keymgmt1,
                                                        selection);
                ok = (tmp_keydata != 
# 422 "../crypto/evp/keymgmt_lib.c" 3 4
                                    ((void *)0)
# 422 "../crypto/evp/keymgmt_lib.c"
                                        );
            }
            if (ok) {
                keymgmt2 = keymgmt1;
    ...
    if (keydata1 == 
# 436 "../crypto/evp/keymgmt_lib.c" 3 4
                   ((void *)0) 
# 436 "../crypto/evp/keymgmt_lib.c"
                        && keydata2 == 
# 436 "../crypto/evp/keymgmt_lib.c" 3 4
                                       ((void *)0)
# 436 "../crypto/evp/keymgmt_lib.c"
    ...
    if (keydata1 == 
# 439 "../crypto/evp/keymgmt_lib.c" 3 4
                   ((void *)0) 
# 439 "../crypto/evp/keymgmt_lib.c"
                        || keydata2 == 
# 439 "../crypto/evp/keymgmt_lib.c" 3 4
                                       ((void *)0)
# 439 "../crypto/evp/keymgmt_lib.c"
...
int evp_keymgmt_util_copy(EVP_PKEY *to, EVP_PKEY *from, int selection)
{
    ...
    void *to_keydata = to->keydata, *alloc_keydata = 
# 449 "../crypto/evp/keymgmt_lib.c" 3 4
                                                    ((void *)0)
# 449 "../crypto/evp/keymgmt_lib.c"
                                                        ;


    if (from == 
# 452 "../crypto/evp/keymgmt_lib.c" 3 4
               ((void *)0) 
# 452 "../crypto/evp/keymgmt_lib.c"
                    || from->keydata == 
# 452 "../crypto/evp/keymgmt_lib.c" 3 4
                                        ((void *)0)
# 452 "../crypto/evp/keymgmt_lib.c"
    ...
    if (to_keymgmt == 
# 460 "../crypto/evp/keymgmt_lib.c" 3 4
                     ((void *)0)
# 460 "../crypto/evp/keymgmt_lib.c"
                         )
        to_keymgmt = from->keymgmt;

    if (to_keymgmt == from->keymgmt && to_keymgmt->dup != 
# 463 "../crypto/evp/keymgmt_lib.c" 3 4
                                                         ((void *)0)
        
# 464 "../crypto/evp/keymgmt_lib.c"
       && to_keydata == 
# 464 "../crypto/evp/keymgmt_lib.c" 3 4
                        ((void *)0)
# 464 "../crypto/evp/keymgmt_lib.c"
                            ) {
        to_keydata = alloc_keydata = evp_keymgmt_dup(to_keymgmt,
                                                     ...
                                                     selection);
        if (to_keydata == 
# 468 "../crypto/evp/keymgmt_lib.c" 3 4
                         ((void *)0)
# 468 "../crypto/evp/keymgmt_lib.c"
                             )
            return 0;
        ...
        if (to_keydata == 
# 486 "../crypto/evp/keymgmt_lib.c" 3 4
                         ((void *)0)
# 486 "../crypto/evp/keymgmt_lib.c"
                             )
            to_keydata = alloc_keydata = import_data.keydata;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/evp/keymgmt_lib.c",489,__func__), ERR_set_error)((6),(101),
# 489 "../crypto/evp/keymgmt_lib.c" 3 4
       ((void *)0)
# 489 "../crypto/evp/keymgmt_lib.c"
       );
        return 0;
    }
# 502 "../crypto/evp/keymgmt_lib.c"
    if (to->keymgmt == 
# 502 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
        
# 503 "../crypto/evp/keymgmt_lib.c"
...
{
    void *keydata = 
# 516 "../crypto/evp/keymgmt_lib.c" 3 4
                   ((void *)0)
# 516 "../crypto/evp/keymgmt_lib.c"
                       ;

    if ((keydata = evp_keymgmt_gen(keymgmt, genctx, cb, cbarg)) == 
# 518 "../crypto/evp/keymgmt_lib.c" 3 4
                                                                  ((void *)0)
        
# 519 "../crypto/evp/keymgmt_lib.c"
       || !evp_keymgmt_util_assign_pkey(target, keymgmt, keydata)) {
        evp_keymgmt_freedata(keymgmt, keydata);
        keydata = 
# 521 "../crypto/evp/keymgmt_lib.c" 3 4
                 ((void *)0)
# 521 "../crypto/evp/keymgmt_lib.c"
                     ;
    }
                                           ...
                                           char *mdname, size_t mdname_sz)
{
    ...
    char *result = 
# 540 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0)
# 540 "../crypto/evp/keymgmt_lib.c"
                      ;
    int rv = -2;

    params[0] =
        OSSL_PARAM_construct_utf8_string("default-digest",
                                         mddefault, sizeof(mddefault));
    params[1] =
        OSSL_PARAM_construct_utf8_string("mandatory-digest",
                                         mdmandatory,
                                         sizeof(mdmandatory));
...
{
    const char *name = 
# 581 "../crypto/evp/keymgmt_lib.c" 3 4
                      ((void *)0)
# 581 "../crypto/evp/keymgmt_lib.c"
                          ;

    if (keymgmt != 
# 583 "../crypto/evp/keymgmt_lib.c" 3 4
                  ((void *)0)
# 583 "../crypto/evp/keymgmt_lib.c"
                      ) {
        if (keymgmt->query_operation_name != 
# 584 "../crypto/evp/keymgmt_lib.c" 3 4
                                            ((void *)0)
# 584 "../crypto/evp/keymgmt_lib.c"
                                                )
            name = keymgmt->query_operation_name(op_id);
        if (name == 
# 586 "../crypto/evp/keymgmt_lib.c" 3 4
                   ((void *)0)
# 586 "../crypto/evp/keymgmt_lib.c"
                       )
