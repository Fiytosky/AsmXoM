...
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_blake2.c"
# 10 "../crypto/evp/legacy_blake2.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 11 "../crypto/evp/legacy_blake2.c" 2
...
# 12 "../crypto/evp/legacy_blake2.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 13 "../crypto/evp/legacy_blake2.c" 2
...
static int blake2s_int_init(EVP_MD_CTX *ctx) { return blake2s_init(EVP_MD_CTX_get0_md_data(ctx)); } static int blake2s_int_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return ossl_blake2s_update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int blake2s_int_final(EVP_MD_CTX *ctx, unsigned char *md) { return ossl_blake2s_final(md, EVP_MD_CTX_get0_md_data(ctx)); }
static int blake2b_int_init(EVP_MD_CTX *ctx) { return blake2b_init(EVP_MD_CTX_get0_md_data(ctx)); } static int blake2b_int_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return ossl_blake2b_update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int blake2b_int_final(EVP_MD_CTX *ctx, unsigned char *md) { return ossl_blake2b_final(md, EVP_MD_CTX_get0_md_data(ctx)); }
...
static const EVP_MD blake2b_md = {
    ...
    0,
    1,
    blake2b_int_init, blake2b_int_update, blake2b_int_final, 
# 46 "../crypto/evp/legacy_blake2.c" 3 4
   ((void *)0)
# 46 "../crypto/evp/legacy_blake2.c"
   , 
# 46 "../crypto/evp/legacy_blake2.c" 3 4
   ((void *)0)
# 46 "../crypto/evp/legacy_blake2.c"
...
static const EVP_MD blake2s_md = {
    ...
    0,
    1,
    blake2s_int_init, blake2s_int_update, blake2s_int_final, 
# 61 "../crypto/evp/legacy_blake2.c" 3 4
   ((void *)0)
# 61 "../crypto/evp/legacy_blake2.c"
   , 
# 61 "../crypto/evp/legacy_blake2.c" 3 4
   ((void *)0)
# 61 "../crypto/evp/legacy_blake2.c"
