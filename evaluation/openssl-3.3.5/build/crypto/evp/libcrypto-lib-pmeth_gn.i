# 0 "../crypto/evp/pmeth_gn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/pmeth_gn.c"
# 10 "../crypto/evp/pmeth_gn.c"
...
# 13 "../crypto/evp/pmeth_gn.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/evp/pmeth_gn.c" 2
...
static int gen_init(EVP_PKEY_CTX *ctx, int operation)
{
    ...
    if (ctx == 
# 29 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0)
# 29 "../crypto/evp/pmeth_gn.c"
                  )
        goto not_supported;
    ...
    if (ctx->keymgmt == 
# 35 "../crypto/evp/pmeth_gn.c" 3 4
                       ((void *)0) 
# 35 "../crypto/evp/pmeth_gn.c"
                            || ctx->keymgmt->gen_init == 
# 35 "../crypto/evp/pmeth_gn.c" 3 4
                                                         ((void *)0)
# 35 "../crypto/evp/pmeth_gn.c"
                                                             )
    ...
    case (1<<1):
        ctx->op.keymgmt.genctx =
            evp_keymgmt_gen_init(ctx->keymgmt,
                                 ( 0x04 | 0x80), 
# 42 "../crypto/evp/pmeth_gn.c" 3 4
                                                                    ((void *)0)
# 42 "../crypto/evp/pmeth_gn.c"
                                                                        );
        break;
    case (1<<2):
        ctx->op.keymgmt.genctx =
            evp_keymgmt_gen_init(ctx->keymgmt, ( 0x01 | 0x02 ),
                                 
# 47 "../crypto/evp/pmeth_gn.c" 3 4
                                ((void *)0)
# 47 "../crypto/evp/pmeth_gn.c"
                                    );
        break;
    }

    if (ctx->op.keymgmt.genctx == 
# 51 "../crypto/evp/pmeth_gn.c" 3 4
                                 ((void *)0)
# 51 "../crypto/evp/pmeth_gn.c"
                                     )
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",52,__func__), ERR_set_error)((6),(134),
# 52 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 52 "../crypto/evp/pmeth_gn.c"
       );
    else
        ret = 1;
    goto end;
 ...
 legacy:
    ...
    if (ctx->pmeth == 
# 61 "../crypto/evp/pmeth_gn.c" 3 4
                     ((void *)0)
        
# 62 "../crypto/evp/pmeth_gn.c"
       || (operation == (1<<1)
            && ctx->pmeth->paramgen == 
# 63 "../crypto/evp/pmeth_gn.c" 3 4
                                      ((void *)0)
# 63 "../crypto/evp/pmeth_gn.c"
                                          )
        || (operation == (1<<2)
            && ctx->pmeth->keygen == 
# 65 "../crypto/evp/pmeth_gn.c" 3 4
                                    ((void *)0)
# 65 "../crypto/evp/pmeth_gn.c"
                                        ))
        goto not_supported;
...
# 71 "../crypto/evp/pmeth_gn.c" 3 4
                                        ((void *)0)
# 71 "../crypto/evp/pmeth_gn.c"
                                            )
            ret = ctx->pmeth->paramgen_init(ctx);
        break;
    case (1<<2):
        if (ctx->pmeth->keygen_init != 
# 75 "../crypto/evp/pmeth_gn.c" 3 4
                                      ((void *)0)
# 75 "../crypto/evp/pmeth_gn.c"
                                          )
    ...
    if (ret <= 0 && ctx != 
# 82 "../crypto/evp/pmeth_gn.c" 3 4
                          ((void *)0)
# 82 "../crypto/evp/pmeth_gn.c"
                              ) {
        evp_pkey_ctx_free_old_ops(ctx);
        ctx->operation = 0;
    }
 ...
 not_supported:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",89,__func__), ERR_set_error)((6),(150),
# 89 "../crypto/evp/pmeth_gn.c" 3 4
   ((void *)0)
# 89 "../crypto/evp/pmeth_gn.c"
   );
    ret = -2;
    goto end;
}
...
int EVP_PKEY_paramgen_init(EVP_PKEY_CTX *ctx)
{
    return gen_init(ctx, (1<<1));
}

int EVP_PKEY_keygen_init(EVP_PKEY_CTX *ctx)
{
    return gen_init(ctx, (1<<2));
}
...
# 107 "../crypto/evp/pmeth_gn.c" 3 4
                             ((void *)0)
# 107 "../crypto/evp/pmeth_gn.c"
                                 ;
    int p = -1, n = -1;

    if (ctx->pkey_gencb == 
# 110 "../crypto/evp/pmeth_gn.c" 3 4
                          ((void *)0)
# 110 "../crypto/evp/pmeth_gn.c"
                              )
        return 1;

    if ((param = OSSL_PARAM_locate_const(params, "potential"))
        == 
# 114 "../crypto/evp/pmeth_gn.c" 3 4
          ((void *)0)
        
# 115 "../crypto/evp/pmeth_gn.c"
       || !OSSL_PARAM_get_int(param, &p))
        return 0;
    if ((param = OSSL_PARAM_locate_const(params, "iteration"))
        == 
# 118 "../crypto/evp/pmeth_gn.c" 3 4
          ((void *)0)
        
# 119 "../crypto/evp/pmeth_gn.c"
...
# 131 "../crypto/evp/pmeth_gn.c" 3 4
                              ((void *)0)
# 131 "../crypto/evp/pmeth_gn.c"
                                  ;

    int gentmp[2];

    if (ppkey == 
# 135 "../crypto/evp/pmeth_gn.c" 3 4
                ((void *)0)
# 135 "../crypto/evp/pmeth_gn.c"
                    )
        return -1;

    if (ctx == 
# 138 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0)
# 138 "../crypto/evp/pmeth_gn.c"
                  )
        goto not_supported;

    if ((ctx->operation & ((1<<1) | (1<<2))) == 0)
        goto not_initialized;

    if (*ppkey == 
# 144 "../crypto/evp/pmeth_gn.c" 3 4
                 ((void *)0)
# 144 "../crypto/evp/pmeth_gn.c"
                     )
        *ppkey = allocated_pkey = EVP_PKEY_new();

    if (*ppkey == 
# 147 "../crypto/evp/pmeth_gn.c" 3 4
                 ((void *)0)
# 147 "../crypto/evp/pmeth_gn.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",148,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 148 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 148 "../crypto/evp/pmeth_gn.c"
       );
        return -1;
    }

    if (ctx->op.keymgmt.genctx == 
# 152 "../crypto/evp/pmeth_gn.c" 3 4
                                 ((void *)0)
# 152 "../crypto/evp/pmeth_gn.c"
                                     )
        goto legacy;
# 164 "../crypto/evp/pmeth_gn.c"
    ctx->keygen_info = gentmp;
    ctx->keygen_info_count = 2;

    ret = 1;
    if (ctx->pkey != 
# 168 "../crypto/evp/pmeth_gn.c" 3 4
                    ((void *)0)
# 168 "../crypto/evp/pmeth_gn.c"
                        ) {
        ...
        if (tmp_keymgmt == 
# 174 "../crypto/evp/pmeth_gn.c" 3 4
                          ((void *)0)
# 174 "../crypto/evp/pmeth_gn.c"
                              )
            goto not_supported;
    ...
    ret = ret
        && (evp_keymgmt_util_gen(*ppkey, ctx->keymgmt, ctx->op.keymgmt.genctx,
            ...
            != 
# 191 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0)
# 191 "../crypto/evp/pmeth_gn.c"
                  );

    ctx->keygen_info = 
# 193 "../crypto/evp/pmeth_gn.c" 3 4
                      ((void *)0)
# 193 "../crypto/evp/pmeth_gn.c"
                          ;
...
# 220 "../crypto/evp/pmeth_gn.c"
    if (ctx->pkey != 
# 220 "../crypto/evp/pmeth_gn.c" 3 4
                    ((void *)0) 
# 220 "../crypto/evp/pmeth_gn.c"
                         && !__builtin_expect(!!((!((ctx->pkey)->keymgmt != 
# 220 "../crypto/evp/pmeth_gn.c" 3 4
                             ((void *)0)
# 220 "../crypto/evp/pmeth_gn.c"
                             )) != 0), 1))
    ...
    if (ret <= 0) {
        if (allocated_pkey != 
# 237 "../crypto/evp/pmeth_gn.c" 3 4
                             ((void *)0)
# 237 "../crypto/evp/pmeth_gn.c"
                                 )
            *ppkey = 
# 238 "../crypto/evp/pmeth_gn.c" 3 4
                    ((void *)0)
# 238 "../crypto/evp/pmeth_gn.c"
                        ;
 ...
 not_supported:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",244,__func__), ERR_set_error)((6),(150),
# 244 "../crypto/evp/pmeth_gn.c" 3 4
   ((void *)0)
# 244 "../crypto/evp/pmeth_gn.c"
   );
    ret = -2;
    goto end;
 not_initialized:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",248,__func__), ERR_set_error)((6),(151),
# 248 "../crypto/evp/pmeth_gn.c" 3 4
   ((void *)0)
# 248 "../crypto/evp/pmeth_gn.c"
   );
    ret = -1;
    goto end;

 not_accessible:
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",253,__func__), ERR_set_error)((6),(204),
# 253 "../crypto/evp/pmeth_gn.c" 3 4
   ((void *)0)
# 253 "../crypto/evp/pmeth_gn.c"
   );
    ret = -1;
    goto end;
...
int EVP_PKEY_paramgen(EVP_PKEY_CTX *ctx, EVP_PKEY **ppkey)
{
    if (ctx->operation != (1<<1)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",262,__func__), ERR_set_error)((6),(151),
# 262 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 262 "../crypto/evp/pmeth_gn.c"
       );
        return -1;
    }
...
int EVP_PKEY_keygen(EVP_PKEY_CTX *ctx, EVP_PKEY **ppkey)
{
    if (ctx->operation != (1<<2)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",271,__func__), ERR_set_error)((6),(151),
# 271 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 271 "../crypto/evp/pmeth_gn.c"
       );
        return -1;
    }
    return EVP_PKEY_generate(ctx, ppkey);
...
# 319 "../crypto/evp/pmeth_gn.c" 3 4
                           ((void *)0)
# 319 "../crypto/evp/pmeth_gn.c"
                               ;
    EVP_PKEY *mac_key = 
# 320 "../crypto/evp/pmeth_gn.c" 3 4
                       ((void *)0)
# 320 "../crypto/evp/pmeth_gn.c"
                           ;
    mac_ctx = EVP_PKEY_CTX_new_id(type, e);
    if (!mac_ctx)
        return 
# 323 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0)
# 323 "../crypto/evp/pmeth_gn.c"
                  ;
...
{
    if (ctx == 
# 341 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0) 
# 341 "../crypto/evp/pmeth_gn.c"
                   || ctx->keytype == 
# 341 "../crypto/evp/pmeth_gn.c" 3 4
                                      ((void *)0)
# 341 "../crypto/evp/pmeth_gn.c"
    ...
    evp_pkey_ctx_free_old_ops(ctx);
    if (ctx->keymgmt == 
# 345 "../crypto/evp/pmeth_gn.c" 3 4
                       ((void *)0)
# 345 "../crypto/evp/pmeth_gn.c"
                           )
        goto not_supported;
 ...
 not_supported:
    if (ctx != 
# 352 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0)
# 352 "../crypto/evp/pmeth_gn.c"
                  )
        ctx->operation = 0;
    (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",354,__func__), ERR_set_error)((6),(150),
# 354 "../crypto/evp/pmeth_gn.c" 3 4
   ((void *)0)
# 354 "../crypto/evp/pmeth_gn.c"
   );
    return -2;
}
...
{
    void *keydata = 
# 366 "../crypto/evp/pmeth_gn.c" 3 4
                   ((void *)0)
# 366 "../crypto/evp/pmeth_gn.c"
                       ;
    EVP_PKEY *allocated_pkey = 
# 367 "../crypto/evp/pmeth_gn.c" 3 4
                              ((void *)0)
# 367 "../crypto/evp/pmeth_gn.c"
                                  ;

    if (ctx == 
# 369 "../crypto/evp/pmeth_gn.c" 3 4
              ((void *)0) 
# 369 "../crypto/evp/pmeth_gn.c"
                   || (ctx->operation & (1<<3)) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",370,__func__), ERR_set_error)((6),(150),
# 370 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 370 "../crypto/evp/pmeth_gn.c"
       );
        return -2;
    }

    if (ppkey == 
# 374 "../crypto/evp/pmeth_gn.c" 3 4
                ((void *)0)
# 374 "../crypto/evp/pmeth_gn.c"
                    )
        return -1;

    if (*ppkey == 
# 377 "../crypto/evp/pmeth_gn.c" 3 4
                 ((void *)0)
# 377 "../crypto/evp/pmeth_gn.c"
                     )
        allocated_pkey = *ppkey = EVP_PKEY_new();

    if (*ppkey == 
# 380 "../crypto/evp/pmeth_gn.c" 3 4
                 ((void *)0)
# 380 "../crypto/evp/pmeth_gn.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",381,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 381 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 381 "../crypto/evp/pmeth_gn.c"
       );
        return -1;
    }
    ...
    if (keydata == 
# 386 "../crypto/evp/pmeth_gn.c" 3 4
                  ((void *)0)
# 386 "../crypto/evp/pmeth_gn.c"
                      ) {
        if (allocated_pkey != 
# 387 "../crypto/evp/pmeth_gn.c" 3 4
                             ((void *)0)
# 387 "../crypto/evp/pmeth_gn.c"
                                 ) {
            *ppkey = 
# 388 "../crypto/evp/pmeth_gn.c" 3 4
                    ((void *)0)
# 388 "../crypto/evp/pmeth_gn.c"
                        ;
            EVP_PKEY_free(allocated_pkey);
        }
        return 0;
...
const OSSL_PARAM *EVP_PKEY_fromdata_settable(EVP_PKEY_CTX *ctx, int selection)
{
    ...
    if (fromdata_init(ctx, 0) == 1)
        return evp_keymgmt_import_types(ctx->keymgmt, selection);
    return 
# 402 "../crypto/evp/pmeth_gn.c" 3 4
          ((void *)0)
# 402 "../crypto/evp/pmeth_gn.c"
              ;
}
...
{
    if (params == 
# 417 "../crypto/evp/pmeth_gn.c" 3 4
                 ((void *)0)
# 417 "../crypto/evp/pmeth_gn.c"
                     )
        return 0;
...
{
    if (pkey == 
# 441 "../crypto/evp/pmeth_gn.c" 3 4
               ((void *)0)
# 441 "../crypto/evp/pmeth_gn.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/pmeth_gn.c",442,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 442 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 442 "../crypto/evp/pmeth_gn.c"
       );
        return 0;
    }

    if (((pkey)->type != 0 && (pkey)->keymgmt == 
# 446 "../crypto/evp/pmeth_gn.c" 3 4
       ((void *)0)
# 446 "../crypto/evp/pmeth_gn.c"
       )) {
...
# 457 "../crypto/evp/pmeth_gn.c" 3 4
                                     ((void *)0)
# 457 "../crypto/evp/pmeth_gn.c"
                                         , 
# 457 "../crypto/evp/pmeth_gn.c" 3 4
                                           ((void *)0)
# 457 "../crypto/evp/pmeth_gn.c"
