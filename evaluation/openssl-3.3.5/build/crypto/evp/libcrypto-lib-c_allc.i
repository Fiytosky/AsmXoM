# 0 "../crypto/evp/c_allc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/c_allc.c"
# 10 "../crypto/evp/c_allc.c"
...
void openssl_add_all_ciphers_int(void)
{
    ...
    OBJ_NAME_add(("DES-EDE-ECB"),0x02|0x8000,("DES-EDE"));
    OBJ_NAME_add(("des-ede-ecb"),0x02|0x8000,("DES-EDE"));
    EVP_add_cipher(EVP_des_ede3());
    OBJ_NAME_add(("DES-EDE3-ECB"),0x02|0x8000,("DES-EDE3"));
    OBJ_NAME_add(("des-ede3-ecb"),0x02|0x8000,("DES-EDE3"));
    EVP_add_cipher(EVP_des_ede3_wrap());
    OBJ_NAME_add(("des3-wrap"),0x02|0x8000,("id-smime-alg-CMS3DESwrap"));
    ...
    EVP_add_cipher(EVP_seed_cfb128());
    EVP_add_cipher(EVP_seed_ofb());
    EVP_add_cipher(EVP_seed_cbc());
    OBJ_NAME_add(("SEED"),0x02|0x8000,("SEED-CBC"));
    OBJ_NAME_add(("seed"),0x02|0x8000,("SEED-CBC"));
    ...
    OBJ_NAME_add(("SM4"),0x02|0x8000,("SM4-CBC"));
    OBJ_NAME_add(("sm4"),0x02|0x8000,("SM4-CBC"));
    ...
    OBJ_NAME_add(("rc2"),0x02|0x8000,("RC2-CBC"));
    OBJ_NAME_add(("rc2-128"),0x02|0x8000,("RC2-CBC"));
    OBJ_NAME_add(("rc2-64"),0x02|0x8000,("RC2-64-CBC"));
    OBJ_NAME_add(("rc2-40"),0x02|0x8000,("RC2-40-CBC"));
...
# 136 "../crypto/evp/c_allc.c"
    ...
    OBJ_NAME_add(("aes128-wrap"),0x02|0x8000,("id-aes128-wrap"));
    EVP_add_cipher(EVP_aes_128_wrap_pad());
    OBJ_NAME_add(("aes128-wrap-pad"),0x02|0x8000,("id-aes128-wrap-pad"));
    ...
    OBJ_NAME_add(("aes192-wrap"),0x02|0x8000,("id-aes192-wrap"));
    EVP_add_cipher(EVP_aes_192_wrap_pad());
    OBJ_NAME_add(("aes192-wrap-pad"),0x02|0x8000,("id-aes192-wrap-pad"));
    ...
    OBJ_NAME_add(("aes256-wrap"),0x02|0x8000,("id-aes256-wrap"));
    EVP_add_cipher(EVP_aes_256_wrap_pad());
    OBJ_NAME_add(("aes256-wrap-pad"),0x02|0x8000,("id-aes256-wrap-pad"));
    ...
    EVP_add_cipher(EVP_aria_128_cfb128());
    ...
    OBJ_NAME_add(("ARIA128"),0x02|0x8000,("ARIA-128-CBC"));
    OBJ_NAME_add(("aria128"),0x02|0x8000,("ARIA-128-CBC"));
    EVP_add_cipher(EVP_aria_192_ecb());
    EVP_add_cipher(EVP_aria_192_cbc());
    EVP_add_cipher(EVP_aria_192_cfb128());
    ...
    OBJ_NAME_add(("ARIA192"),0x02|0x8000,("ARIA-192-CBC"));
    OBJ_NAME_add(("aria192"),0x02|0x8000,("ARIA-192-CBC"));
    EVP_add_cipher(EVP_aria_256_ecb());
    EVP_add_cipher(EVP_aria_256_cbc());
    EVP_add_cipher(EVP_aria_256_cfb128());
    ...
    OBJ_NAME_add(("ARIA256"),0x02|0x8000,("ARIA-256-CBC"));
    OBJ_NAME_add(("aria256"),0x02|0x8000,("ARIA-256-CBC"));
