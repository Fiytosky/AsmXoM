# 0 "../crypto/evp/evp_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_enc.c"
# 13 "../crypto/evp/evp_enc.c"
...
# 15 "../crypto/evp/evp_enc.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 16 "../crypto/evp/evp_enc.c" 2
...
# 21 "../crypto/evp/evp_enc.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 24 "../crypto/evp/evp_enc.c" 2
...
# 30 "../crypto/evp/evp_enc.c" 2

static inline __attribute__((unused)) int safe_add_int(int a, int b, int *err) { int r; if (!__builtin_add_overflow(a, b, &r)) return r; *err |= 1; return a < 0 ? ((int)1 << (sizeof(int) * 8 - 1)) : (~((int)1 << (sizeof(int) * 8 - 1))); } static inline __attribute__((unused)) int safe_sub_int(int a, int b, int *err) { int r; if (!__builtin_sub_overflow(a, b, &r)) return r; *err |= 1; return a < 0 ? ((int)1 << (sizeof(int) * 8 - 1)) : (~((int)1 << (sizeof(int) * 8 - 1))); } static inline __attribute__((unused)) int safe_mul_int(int a, int b, int *err) { int r; if (!__builtin_mul_overflow(a, b, &r)) return r; *err |= 1; return (a < 0) ^ (b < 0) ? ((int)1 << (sizeof(int) * 8 - 1)) : (~((int)1 << (sizeof(int) * 8 - 1))); } static inline __attribute__((unused)) int safe_div_int(int a, int b, int *err) { if (b == 0) { *err |= 1; return a < 0 ? ((int)1 << (sizeof(int) * 8 - 1)) : (~((int)1 << (sizeof(int) * 8 - 1))); } if (b == -1 && a == ((int)1 << (sizeof(int) * 8 - 1))) { *err |= 1; return (~((int)1 << (sizeof(int) * 8 - 1))); } return a / b; } static inline __attribute__((unused)) int safe_mod_int(int a, int b, int *err) { if (b == 0) { *err |= 1; return 0; } if (b == -1 && a == ((int)1 << (sizeof(int) * 8 - 1))) { *err |= 1; return (~((int)1 << (sizeof(int) * 8 - 1))); } return a % b; } static inline __attribute__((unused)) int safe_div_round_up_int (int a, int b, int *errp) { int x; int *err, err_local = 0; err = errp != 
# 31 "../crypto/evp/evp_enc.c" 3 4
((void *)0) 
# 31 "../crypto/evp/evp_enc.c"
? errp : &err_local; if (b > 0 && a > 0) { if (a < (~((int)1 << (sizeof(int) * 8 - 1))) - b) return (a + b - 1) / b; return a / b + (a % b != 0); } if (b == 0) { *err |= 1; return a == 0 ? 0 : (~((int)1 << (sizeof(int) * 8 - 1))); } if (a == 0) return 0; x = safe_mod_int(a, b, err); return safe_add_int(safe_div_int(a, b, err), x != 0, err); } static inline __attribute__((unused)) int safe_muldiv_int(int a, int b, int c, int *err) { int e2 = 0; int q, r, x, y; if (c == 0) { *err |= 1; return a == 0 || b == 0 ? 0 : (~((int)1 << (sizeof(int) * 8 - 1))); } x = safe_mul_int(a, b, &e2); if (!e2) return safe_div_int(x, c, err); if (b > a) { x = b; b = a; a = x; } q = safe_div_int(a, c, err); r = safe_mod_int(a, c, err); x = safe_mul_int(r, b, err); y = safe_mul_int(q, b, err); q = safe_div_int(x, c, err); return safe_add_int(y, q, err); } static inline __attribute__((unused)) int safe_neg_int(int a, int *err) { if (a != ((int)1 << (sizeof(int) * 8 - 1))) return -a; *err |= 1; return ((int)1 << (sizeof(int) * 8 - 1)); } static inline __attribute__((unused)) int safe_abs_int(int a, int *err) { if (a != ((int)1 << (sizeof(int) * 8 - 1))) return a < 0 ? -a : a; *err |= 1; return ((int)1 << (sizeof(int) * 8 - 1)); }

int EVP_CIPHER_CTX_reset(EVP_CIPHER_CTX *ctx)
{
    if (ctx == 
# 35 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 35 "../crypto/evp/evp_enc.c"
                  )
        return 1;

    if (ctx->cipher == 
# 38 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0) 
# 38 "../crypto/evp/evp_enc.c"
                           || ctx->cipher->prov == 
# 38 "../crypto/evp/evp_enc.c" 3 4
                                                   ((void *)0)
# 38 "../crypto/evp/evp_enc.c"
    ...
    if (ctx->algctx != 
# 41 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 41 "../crypto/evp/evp_enc.c"
                          ) {
        if (ctx->cipher->freectx != 
# 42 "../crypto/evp/evp_enc.c" 3 4
                                   ((void *)0)
# 42 "../crypto/evp/evp_enc.c"
                                       )
            ctx->cipher->freectx(ctx->algctx);
        ctx->algctx = 
# 44 "../crypto/evp/evp_enc.c" 3 4
                     ((void *)0)
# 44 "../crypto/evp/evp_enc.c"
                         ;
    }
    if (ctx->fetched_cipher != 
# 46 "../crypto/evp/evp_enc.c" 3 4
                              ((void *)0)
# 46 "../crypto/evp/evp_enc.c"
                                  )
 ...
 legacy:
    ...
    if (ctx->cipher != 
# 56 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 56 "../crypto/evp/evp_enc.c"
                          ) {
    ...
    CRYPTO_free(ctx->cipher_data, "../crypto/evp/evp_enc.c", 63);
...
EVP_CIPHER_CTX *EVP_CIPHER_CTX_new(void)
{
    ...
    ctx = CRYPTO_zalloc(sizeof(EVP_CIPHER_CTX), "../crypto/evp/evp_enc.c", 76);
    if (ctx == 
# 77 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 77 "../crypto/evp/evp_enc.c"
                  )
        return 
# 78 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 78 "../crypto/evp/evp_enc.c"
                  ;
...
{
    if (ctx == 
# 86 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 86 "../crypto/evp/evp_enc.c"
                  )
        return;
    EVP_CIPHER_CTX_reset(ctx);
    CRYPTO_free(ctx, "../crypto/evp/evp_enc.c", 89);
}
                                    ...
                                    const OSSL_PARAM params[])
{
    ...
    ENGINE *tmpimpl = 
# 100 "../crypto/evp/evp_enc.c" 3 4
                     ((void *)0)
# 100 "../crypto/evp/evp_enc.c"
                         ;
    ...
    if (cipher == 
# 116 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 116 "../crypto/evp/evp_enc.c"
                      && ctx->cipher == 
# 116 "../crypto/evp/evp_enc.c" 3 4
                                        ((void *)0)
# 116 "../crypto/evp/evp_enc.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",117,__func__), ERR_set_error)((6),(131),
# 117 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 117 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
# 130 "../crypto/evp/evp_enc.c"
    if (ctx->engine && ctx->cipher
        && (cipher == 
# 131 "../crypto/evp/evp_enc.c" 3 4
                     ((void *)0) 
# 131 "../crypto/evp/evp_enc.c"
                          || cipher->nid == ctx->cipher->nid))
        goto skip_to_init;

    if (cipher != 
# 134 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 134 "../crypto/evp/evp_enc.c"
                      && impl == 
# 134 "../crypto/evp/evp_enc.c" 3 4
                                 ((void *)0)
# 134 "../crypto/evp/evp_enc.c"
    ...
    if (ctx->engine != 
# 143 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)

            
# 145 "../crypto/evp/evp_enc.c"
           || tmpimpl != 
# 145 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0)

            
# 147 "../crypto/evp/evp_enc.c"
           || impl != 
# 147 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
            
# 148 "../crypto/evp/evp_enc.c"
           || (cipher != 
# 148 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0) 
# 148 "../crypto/evp/evp_enc.c"
                              && cipher->origin == 2)
            || (cipher == 
# 149 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0) 
# 149 "../crypto/evp/evp_enc.c"
                              && ctx->cipher != 
# 149 "../crypto/evp/evp_enc.c" 3 4
                                                ((void *)0)
                               
# 150 "../crypto/evp/evp_enc.c"
                              && ctx->cipher->origin == 2)) {
        if (ctx->cipher == ctx->fetched_cipher)
            ctx->cipher = 
# 152 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0)
# 152 "../crypto/evp/evp_enc.c"
                             ;
        EVP_CIPHER_free(ctx->fetched_cipher);
        ctx->fetched_cipher = 
# 154 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 154 "../crypto/evp/evp_enc.c"
                                 ;
        goto legacy;
    }
    ...
    if (cipher != 
# 161 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 161 "../crypto/evp/evp_enc.c"
                      && ctx->cipher != 
# 161 "../crypto/evp/evp_enc.c" 3 4
                                        ((void *)0)
# 161 "../crypto/evp/evp_enc.c"
...
# 162 "../crypto/evp/evp_enc.c" 3 4
                                   ((void *)0) 
# 162 "../crypto/evp/evp_enc.c"
                                        && !ctx->cipher->cleanup(ctx))
            return 0;
        CRYPTO_clear_free(ctx->cipher_data, ctx->cipher->ctx_size, "../crypto/evp/evp_enc.c", 164);
        ctx->cipher_data = 
# 165 "../crypto/evp/evp_enc.c" 3 4
                          ((void *)0)
# 165 "../crypto/evp/evp_enc.c"
                              ;
    }
...
# 171 "../crypto/evp/evp_enc.c"
    ...
    if (cipher == 
# 180 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 180 "../crypto/evp/evp_enc.c"
                     )
        cipher = ctx->cipher;

    if (cipher->prov == 
# 183 "../crypto/evp/evp_enc.c" 3 4
                       ((void *)0)
# 183 "../crypto/evp/evp_enc.c"
                           ) {
        ...
        EVP_CIPHER *provciph =
            EVP_CIPHER_fetch(
# 190 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 190 "../crypto/evp/evp_enc.c"
                                ,
                             cipher->nid == 0 ? "NULL"
        ...
        if (provciph == 
# 195 "../crypto/evp/evp_enc.c" 3 4
                       ((void *)0)
# 195 "../crypto/evp/evp_enc.c"
                           )
            return 0;
        cipher = provciph;
        EVP_CIPHER_free(ctx->fetched_cipher);
    ...
    if (!__builtin_expect(!!((cipher->prov != 
# 203 "../crypto/evp/evp_enc.c" 3 4
        ((void *)0)
# 203 "../crypto/evp/evp_enc.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",204,__func__), ERR_set_error)((6),(134),
# 204 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 204 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (cipher != ctx->fetched_cipher) {
        if (!EVP_CIPHER_up_ref((EVP_CIPHER *)cipher)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",210,__func__), ERR_set_error)((6),(134),
# 210 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 210 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        EVP_CIPHER_free(ctx->fetched_cipher);
    ...
    ctx->cipher = cipher;
    if (ctx->algctx == 
# 219 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 219 "../crypto/evp/evp_enc.c"
                          ) {
        ctx->algctx = ctx->cipher->newctx(ossl_provider_ctx(cipher->prov));
        if (ctx->algctx == 
# 221 "../crypto/evp/evp_enc.c" 3 4
                          ((void *)0)
# 221 "../crypto/evp/evp_enc.c"
                              ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",222,__func__), ERR_set_error)((6),(134),
# 222 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 222 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
    }
...
# 245 "../crypto/evp/evp_enc.c"
    if (params != 
# 245 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 245 "../crypto/evp/evp_enc.c"
                     ) {
        OSSL_PARAM param_lens[3] = { { 
# 246 "../crypto/evp/evp_enc.c" 3 4
                                    ((void *)0)
# 246 "../crypto/evp/evp_enc.c"
                                    , 0, 
# 246 "../crypto/evp/evp_enc.c" 3 4
                                    ((void *)0)
# 246 "../crypto/evp/evp_enc.c"
...
# 246 "../crypto/evp/evp_enc.c"
                                                    , 0, 0 },
                                     { 
# 247 "../crypto/evp/evp_enc.c" 3 4
                                    ((void *)0)
# 247 "../crypto/evp/evp_enc.c"
                                    , 0, 
# 247 "../crypto/evp/evp_enc.c" 3 4
                                    ((void *)0)
# 247 "../crypto/evp/evp_enc.c"
        ...
        p = OSSL_PARAM_locate_const(params, "keylen");
        if (p != 
# 252 "../crypto/evp/evp_enc.c" 3 4
                ((void *)0)
# 252 "../crypto/evp/evp_enc.c"
                    )
            memcpy(q++, p, sizeof(*q));
        ...
        p = OSSL_PARAM_locate_const(params, "ivlen");
        if (p != 
# 260 "../crypto/evp/evp_enc.c" 3 4
                ((void *)0)
# 260 "../crypto/evp/evp_enc.c"
                    )
            memcpy(q++, p, sizeof(*q));

        if (q != param_lens) {
            if (!EVP_CIPHER_CTX_set_params(ctx, param_lens)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",265,__func__), ERR_set_error)((6),(221),
# 265 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 265 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
        }
    ...
    if (enc) {
        if (ctx->cipher->einit == 
# 273 "../crypto/evp/evp_enc.c" 3 4
                                 ((void *)0)
# 273 "../crypto/evp/evp_enc.c"
                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",274,__func__), ERR_set_error)((6),(134),
# 274 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 274 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        ...
        return ctx->cipher->einit(ctx->algctx,
                                  key,
                                  key == 
# 280 "../crypto/evp/evp_enc.c" 3 4
                                        ((void *)0) 
# 280 "../crypto/evp/evp_enc.c"
                                             ? 0
                                              : EVP_CIPHER_CTX_get_key_length(ctx),
                                  iv,
                                  iv == 
# 283 "../crypto/evp/evp_enc.c" 3 4
                                       ((void *)0) 
# 283 "../crypto/evp/evp_enc.c"
                                            ? 0
    ...
    if (ctx->cipher->dinit == 
# 288 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 288 "../crypto/evp/evp_enc.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",289,__func__), ERR_set_error)((6),(134),
# 289 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 289 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    return ctx->cipher->dinit(ctx->algctx,
                              key,
                              key == 
# 295 "../crypto/evp/evp_enc.c" 3 4
                                    ((void *)0) 
# 295 "../crypto/evp/evp_enc.c"
                                         ? 0
                                          : EVP_CIPHER_CTX_get_key_length(ctx),
                              iv,
                              iv == 
# 298 "../crypto/evp/evp_enc.c" 3 4
                                   ((void *)0) 
# 298 "../crypto/evp/evp_enc.c"
                                        ? 0
                                         : EVP_CIPHER_CTX_get_iv_length(ctx),
                                  params);
 ...
 legacy:
    ...
    if (cipher != 
# 305 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 305 "../crypto/evp/evp_enc.c"
                     ) {
        ...
        if (impl != 
# 319 "../crypto/evp/evp_enc.c" 3 4
                   ((void *)0)
# 319 "../crypto/evp/evp_enc.c"
                       ) {
            if (!ENGINE_init(impl)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",321,__func__), ERR_set_error)((6),(134),
# 321 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 321 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
        } else {
        ...
        if (impl != 
# 327 "../crypto/evp/evp_enc.c" 3 4
                   ((void *)0)
# 327 "../crypto/evp/evp_enc.c"
                       ) {

            const EVP_CIPHER *c = ENGINE_get_cipher(impl, cipher->nid);

            if (c == 
# 331 "../crypto/evp/evp_enc.c" 3 4
                    ((void *)0)
# 331 "../crypto/evp/evp_enc.c"
                        ) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",337,__func__), ERR_set_error)((6),(134),
# 337 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 337 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
            ...
            ctx->engine = 
# 348 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0)
# 348 "../crypto/evp/evp_enc.c"
                             ;
        }
        ...
        if (ctx->cipher->ctx_size) {
            ctx->cipher_data = CRYPTO_zalloc(ctx->cipher->ctx_size, "../crypto/evp/evp_enc.c", 354);
            if (ctx->cipher_data == 
# 355 "../crypto/evp/evp_enc.c" 3 4
                                   ((void *)0)
# 355 "../crypto/evp/evp_enc.c"
                                       ) {
                ctx->cipher = 
# 356 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 356 "../crypto/evp/evp_enc.c"
                                 ;
                return 0;
            }
        } else {
            ctx->cipher_data = 
# 360 "../crypto/evp/evp_enc.c" 3 4
                              ((void *)0)
# 360 "../crypto/evp/evp_enc.c"
                                  ;
        }
...
# 366 "../crypto/evp/evp_enc.c" 3 4
                                                          ((void *)0)
# 366 "../crypto/evp/evp_enc.c"
                                                              ) <= 0) {
                ctx->cipher = 
# 367 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 367 "../crypto/evp/evp_enc.c"
                                 ;
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",368,__func__), ERR_set_error)((6),(134),
# 368 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 368 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
        }
 ...
 skip_to_init:
    ...
    if (ctx->cipher == 
# 376 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 376 "../crypto/evp/evp_enc.c"
                          )
        return 0;


    (void)((ctx->cipher->block_size == 1 || ctx->cipher->block_size == 8 || ctx->cipher->block_size == 16) ? 0 : (OPENSSL_die("assertion failed: " "ctx->cipher->block_size == 1 || ctx->cipher->block_size == 8 || ctx->cipher->block_size == 16", "../crypto/evp/evp_enc.c", 380), 1))

                                                    ;

    if (!(ctx->flags & 0x1)
        && EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(ctx)) == 0x10002) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",386,__func__), ERR_set_error)((6),(170),
# 386 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 386 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if ((EVP_CIPHER_get_flags(EVP_CIPHER_CTX_get0_cipher(ctx))
                & 0x10) == 0) {
        switch (EVP_CIPHER_get_mode(EVP_CIPHER_CTX_get0_cipher(ctx))) {
        ...
        case 0x2:
            ...
            if (n < 0 || n > (int)sizeof(ctx->iv)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",407,__func__), ERR_set_error)((6),(194),
# 407 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 407 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
            if (iv != 
# 410 "../crypto/evp/evp_enc.c" 3 4
                     ((void *)0)
# 410 "../crypto/evp/evp_enc.c"
                         )
                memcpy(ctx->oiv, iv, n);
        ...
        case 0x5:
            ...
            if (iv != 
# 418 "../crypto/evp/evp_enc.c" 3 4
                     ((void *)0)
# 418 "../crypto/evp/evp_enc.c"
                         ) {
                n = EVP_CIPHER_CTX_get_iv_length(ctx);
                if (n <= 0 || n > (int)sizeof(ctx->iv)) {
                    (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",421,__func__), ERR_set_error)((6),(194),
# 421 "../crypto/evp/evp_enc.c" 3 4
                   ((void *)0)
# 421 "../crypto/evp/evp_enc.c"
                   );
                    return 0;
                }
                memcpy(ctx->iv, iv, n);
    ...
    if (key != 
# 433 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0) 
# 433 "../crypto/evp/evp_enc.c"
...
int EVP_CipherInit_ex2(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                       ...
                       int enc, const OSSL_PARAM params[])
{
    return evp_cipher_init_internal(ctx, cipher, 
# 447 "../crypto/evp/evp_enc.c" 3 4
                                                ((void *)0)
# 447 "../crypto/evp/evp_enc.c"
                                                    , key, iv, enc, params);
}
...
{
    if (cipher != 
# 453 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 453 "../crypto/evp/evp_enc.c"
                     )
        EVP_CIPHER_CTX_reset(ctx);
    return evp_cipher_init_internal(ctx, cipher, 
# 455 "../crypto/evp/evp_enc.c" 3 4
                                                ((void *)0)
# 455 "../crypto/evp/evp_enc.c"
                                                    , key, iv, enc, 
# 455 "../crypto/evp/evp_enc.c" 3 4
                                                                    ((void *)0)
# 455 "../crypto/evp/evp_enc.c"
...
int EVP_CipherInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *cipher,
                      ...
                      const unsigned char *iv, int enc)
{
    return evp_cipher_init_internal(ctx, cipher, impl, key, iv, enc, 
# 462 "../crypto/evp/evp_enc.c" 3 4
                                                                    ((void *)0)
# 462 "../crypto/evp/evp_enc.c"
                                                                        );
}
                                    ...
                                    const unsigned char *in, int inl)
{
    ...
    if (EVP_CIPHER_CTX_test_flags(ctx, 0x2000))
        cmpl = safe_div_round_up_int(cmpl, 8, 
# 574 "../crypto/evp/evp_enc.c" 3 4
                                             ((void *)0)
# 574 "../crypto/evp/evp_enc.c"
                                                 );
    ...
    if (ctx->cipher->flags & 0x100000) {
        ...
        if (bl == 1 && ossl_is_partially_overlapping(out, in, cmpl)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",581,__func__), ERR_set_error)((6),(162),
# 581 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 581 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
    ...
    if (ossl_is_partially_overlapping(out + ctx->buf_len, in, cmpl)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",598,__func__), ERR_set_error)((6),(162),
# 598 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 598 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    i = ctx->buf_len;
    (void)((bl <= (int)sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "bl <= (int)sizeof(ctx->buf)", "../crypto/evp/evp_enc.c", 612), 1));
    if (i != 0) {
        if (bl - i > inl) {
            ...
            *outl = 0;
            ...
            j = bl - i;
# 629 "../crypto/evp/evp_enc.c"
            if (((inl - j) & ~(bl - 1)) > 0x7fffffff 
# 629 "../crypto/evp/evp_enc.c"
                                                 - bl) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",630,__func__), ERR_set_error)((6),(202),
# 630 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 630 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
                      ...
                      const unsigned char *in, int inl)
{
    ...
    if (__builtin_expect(!!(outl != 
# 665 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 665 "../crypto/evp/evp_enc.c"
       ), 1)) {
        *outl = 0;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",668,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 668 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 668 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }


    if (__builtin_expect(!!(!ctx->encrypt), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",674,__func__), ERR_set_error)((6),(148),
# 674 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 674 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (__builtin_expect(!!(ctx->cipher == 
# 678 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 678 "../crypto/evp/evp_enc.c"
       ), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",679,__func__), ERR_set_error)((6),(131),
# 679 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 679 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (__builtin_expect(!!(ctx->cipher->prov == 
# 683 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 683 "../crypto/evp/evp_enc.c"
       ), 0))
        goto legacy;

    blocksize = ctx->cipher->block_size;

    if (__builtin_expect(!!(ctx->cipher->cupdate == 
# 688 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0) 
# 688 "../crypto/evp/evp_enc.c"
       || blocksize < 1), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",689,__func__), ERR_set_error)((6),(189),
# 689 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 689 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (__builtin_expect(!!(ret), 1)) {
        if (soutl > 0x7fffffff
# 698 "../crypto/evp/evp_enc.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",699,__func__), ERR_set_error)((6),(189),
# 699 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 699 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = soutl;
...
int EVP_EncryptFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl)
{
    ...
    if (outl != 
# 727 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 727 "../crypto/evp/evp_enc.c"
                   ) {
        *outl = 0;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",730,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 730 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 730 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (!ctx->encrypt) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",736,__func__), ERR_set_error)((6),(148),
# 736 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 736 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (ctx->cipher == 
# 740 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 740 "../crypto/evp/evp_enc.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",741,__func__), ERR_set_error)((6),(131),
# 741 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 741 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    if (ctx->cipher->prov == 
# 744 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 744 "../crypto/evp/evp_enc.c"
                                )
        goto legacy;

    blocksize = EVP_CIPHER_CTX_get_block_size(ctx);

    if (blocksize < 1 || ctx->cipher->cfinal == 
# 749 "../crypto/evp/evp_enc.c" 3 4
                                               ((void *)0)
# 749 "../crypto/evp/evp_enc.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",750,__func__), ERR_set_error)((6),(188),
# 750 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 750 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (ret) {
        if (soutl > 0x7fffffff
# 758 "../crypto/evp/evp_enc.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",759,__func__), ERR_set_error)((6),(188),
# 759 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 759 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = soutl;
...
# 771 "../crypto/evp/evp_enc.c" 3 4
                                              ((void *)0)
# 771 "../crypto/evp/evp_enc.c"
                                                  , 0);
        if (ret < 0)
            return 0;
        else
    ...
    (void)((b <= sizeof(ctx->buf)) ? 0 : (OPENSSL_die("assertion failed: " "b <= sizeof(ctx->buf)", "../crypto/evp/evp_enc.c", 780), 1));
    if (b == 1) {
        *outl = 0;
        return 1;
    }
    ...
    if (ctx->flags & 0x100) {
        if (bl) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",788,__func__), ERR_set_error)((6),(138),
# 788 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 788 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = 0;
                      ...
                      const unsigned char *in, int inl)
{
    ...
    if (__builtin_expect(!!(outl != 
# 814 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 814 "../crypto/evp/evp_enc.c"
       ), 1)) {
        *outl = 0;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",817,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 817 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 817 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (__builtin_expect(!!(ctx->encrypt), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",823,__func__), ERR_set_error)((6),(148),
# 823 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 823 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (__builtin_expect(!!(ctx->cipher == 
# 827 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 827 "../crypto/evp/evp_enc.c"
       ), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",828,__func__), ERR_set_error)((6),(131),
# 828 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 828 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    if (__builtin_expect(!!(ctx->cipher->prov == 
# 831 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 831 "../crypto/evp/evp_enc.c"
       ), 0))
        goto legacy;
    ...
    if (__builtin_expect(!!(ctx->cipher->cupdate == 
# 836 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0) 
# 836 "../crypto/evp/evp_enc.c"
       || blocksize < 1), 0)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",837,__func__), ERR_set_error)((6),(189),
# 837 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 837 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ret = ctx->cipher->cupdate(ctx->algctx, out, &soutl,
    ...
    if (__builtin_expect(!!(ret), 1)) {
        if (soutl > 0x7fffffff
# 845 "../crypto/evp/evp_enc.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",846,__func__), ERR_set_error)((6),(189),
# 846 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 846 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = soutl;
 ...
 legacy:
    ...
    if (EVP_CIPHER_CTX_test_flags(ctx, 0x2000))
        cmpl = safe_div_round_up_int(cmpl, 8, 
# 860 "../crypto/evp/evp_enc.c" 3 4
                                             ((void *)0)
# 860 "../crypto/evp/evp_enc.c"
                                                 );

    if (ctx->cipher->flags & 0x100000) {
        if (b == 1 && ossl_is_partially_overlapping(out, in, cmpl)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",864,__func__), ERR_set_error)((6),(162),
# 864 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 864 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
    ...
    (void)((b <= sizeof(ctx->final)) ? 0 : (OPENSSL_die("assertion failed: " "b <= sizeof(ctx->final)", "../crypto/evp/evp_enc.c", 885), 1));

    if (ctx->final_used) {

        if (((size_t)out == (size_t)in)
            || ossl_is_partially_overlapping(out, in, b)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",891,__func__), ERR_set_error)((6),(162),
# 891 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 891 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
# 903 "../crypto/evp/evp_enc.c"
        if ((inl & ~(b - 1)) > 0x7fffffff 
# 903 "../crypto/evp/evp_enc.c"
                                      - b) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",904,__func__), ERR_set_error)((6),(202),
# 904 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 904 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
...
int EVP_DecryptFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl)
{
    ...
    if (outl != 
# 948 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 948 "../crypto/evp/evp_enc.c"
                   ) {
        *outl = 0;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",951,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 951 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 951 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (ctx->encrypt) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",957,__func__), ERR_set_error)((6),(148),
# 957 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 957 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (ctx->cipher == 
# 961 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 961 "../crypto/evp/evp_enc.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",962,__func__), ERR_set_error)((6),(131),
# 962 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 962 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (ctx->cipher->prov == 
# 966 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 966 "../crypto/evp/evp_enc.c"
                                )
        goto legacy;
    ...
    if (blocksize < 1 || ctx->cipher->cfinal == 
# 971 "../crypto/evp/evp_enc.c" 3 4
                                               ((void *)0)
# 971 "../crypto/evp/evp_enc.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",972,__func__), ERR_set_error)((6),(188),
# 972 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 972 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (ret) {
        if (soutl > 0x7fffffff
# 980 "../crypto/evp/evp_enc.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",981,__func__), ERR_set_error)((6),(188),
# 981 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 981 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = soutl;
...
# 994 "../crypto/evp/evp_enc.c" 3 4
                                            ((void *)0)
# 994 "../crypto/evp/evp_enc.c"
                                                , 0);
        if (i < 0)
            return 0;
        else
    ...
    if (ctx->flags & 0x100) {
        if (ctx->buf_len) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1005,__func__), ERR_set_error)((6),(138),
# 1005 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 1005 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        *outl = 0;
    ...
    if (b > 1) {
        if (ctx->buf_len || !ctx->final_used) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1013,__func__), ERR_set_error)((6),(109),
# 1013 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 1013 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        (void)((b <= sizeof(ctx->final)) ? 0 : (OPENSSL_die("assertion failed: " "b <= sizeof(ctx->final)", "../crypto/evp/evp_enc.c", 1016), 1));
        ...
        n = ctx->final[b - 1];
        if (n == 0 || n > (int)b) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1024,__func__), ERR_set_error)((6),(100),
# 1024 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 1024 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
        for (i = 0; i < n; i++) {
            if (ctx->final[--b] != n) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1029,__func__), ERR_set_error)((6),(100),
# 1029 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 1029 "../crypto/evp/evp_enc.c"
               );
                return 0;
            }
        }
...
{
    if (c->cipher->prov != 
# 1044 "../crypto/evp/evp_enc.c" 3 4
                          ((void *)0)
# 1044 "../crypto/evp/evp_enc.c"
                              ) {
        int ok;
        OSSL_PARAM params[2] = { { 
# 1046 "../crypto/evp/evp_enc.c" 3 4
                                ((void *)0)
# 1046 "../crypto/evp/evp_enc.c"
                                , 0, 
# 1046 "../crypto/evp/evp_enc.c" 3 4
                                ((void *)0)
# 1046 "../crypto/evp/evp_enc.c"
...
# 1046 "../crypto/evp/evp_enc.c"
        ...
        if (OSSL_PARAM_locate_const(EVP_CIPHER_settable_ctx_params(c->cipher),
                                    "keylen") == 
# 1054 "../crypto/evp/evp_enc.c" 3 4
                                                                ((void *)0)
# 1054 "../crypto/evp/evp_enc.c"
                                                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1055,__func__), ERR_set_error)((6),(130),
# 1055 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 1055 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }

        params[0] = OSSL_PARAM_construct_size_t("keylen", &len);
    ...
    if (c->cipher->flags & 0x80)
        return EVP_CIPHER_CTX_ctrl(c, 0x1, keylen, 
# 1076 "../crypto/evp/evp_enc.c" 3 4
                                                                      ((void *)0)
# 1076 "../crypto/evp/evp_enc.c"
                                                                          );
    if (EVP_CIPHER_CTX_get_key_length(c) == keylen)
        return 1;
    ...
    (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1083,__func__), ERR_set_error)((6),(130),
# 1083 "../crypto/evp/evp_enc.c" 3 4
   ((void *)0)
# 1083 "../crypto/evp/evp_enc.c"
   );
    return 0;
}
...
int EVP_CIPHER_CTX_set_padding(EVP_CIPHER_CTX *ctx, int pad)
{
    int ok;
    OSSL_PARAM params[2] = { { 
# 1090 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 1090 "../crypto/evp/evp_enc.c"
                            , 0, 
# 1090 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 1090 "../crypto/evp/evp_enc.c"
...
# 1090 "../crypto/evp/evp_enc.c"
    ...
    if (ctx->cipher != 
# 1098 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0) 
# 1098 "../crypto/evp/evp_enc.c"
                           && ctx->cipher->prov == 
# 1098 "../crypto/evp/evp_enc.c" 3 4
                                                   ((void *)0)
# 1098 "../crypto/evp/evp_enc.c"
        ...
        return 1;
    params[0] = OSSL_PARAM_construct_uint("padding", &pd);
...
int EVP_CIPHER_CTX_ctrl(EVP_CIPHER_CTX *ctx, int type, int arg, void *ptr)
{
    ...
    OSSL_PARAM params[4] = {
        { 
# 1113 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1113 "../crypto/evp/evp_enc.c"
       , 0, 
# 1113 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1113 "../crypto/evp/evp_enc.c"
...
# 1113 "../crypto/evp/evp_enc.c"
    ...
    if (ctx == 
# 1116 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0) 
# 1116 "../crypto/evp/evp_enc.c"
                   || ctx->cipher == 
# 1116 "../crypto/evp/evp_enc.c" 3 4
                                     ((void *)0)
# 1116 "../crypto/evp/evp_enc.c"
                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1117,__func__), ERR_set_error)((6),(131),
# 1117 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1117 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (ctx->cipher->prov == 
# 1121 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 1121 "../crypto/evp/evp_enc.c"
                                )
        goto legacy;
    ...
    case 0x1:
        ...
        if (ctx->key_len == arg)
            ...
            return 1;
        params[0] = OSSL_PARAM_construct_size_t("keylen", &sz);
        ctx->key_len = -1;
        break;
    case 0x6:
        set_params = 0;
        params[0] =
            OSSL_PARAM_construct_octet_string("randkey",
                                              ptr, sz);
        break;
    ...
    case 0x9:
        ...
        if (ctx->iv_len == arg)
            ...
            return 1;
        params[0] = OSSL_PARAM_construct_size_t("ivlen", &sz);
        ctx->iv_len = -1;
        break;
    case 0x14:
        if (arg < 2 || arg > 8)
    ...
    case 0x5:
        if (arg < 0)
            return 0;
        i = (unsigned int)arg;
        params[0] = OSSL_PARAM_construct_uint("rounds", &i);
        break;
    case 0x27:
        if (arg < 0)
            return 0;
        i = (unsigned int)arg;
        params[0] = OSSL_PARAM_construct_uint("speed", &i);
        break;
    case 0x10:
        set_params = 0;
    case 0x11:
    ...
    case 0x16:
        ...
        params[0] =
            OSSL_PARAM_construct_octet_string("tlsaad",
                                              ptr, sz);
        ret = evp_do_ciph_ctx_setparams(ctx->cipher, ctx->algctx, params);
        if (ret <= 0)
            goto end;
        params[0] =
            OSSL_PARAM_construct_size_t("tlsaadpad", &sz);
    ...
    case 0x2:
        set_params = 0;
    case 0x3:
        params[0] = OSSL_PARAM_construct_size_t("keybits", &sz);
        break;


    case 0x1c:
        params[0] = OSSL_PARAM_construct_size_t(
                "tls1multi_maxsndfrag", &sz);
        ret = evp_do_ciph_ctx_setparams(ctx->cipher, ctx->algctx, params);
        if (ret <= 0)
            return 0;

        params[0] = OSSL_PARAM_construct_size_t(
                "tls1multi_maxbufsz", &sz);
    ...
    case 0x19: {
        ...
        params[0] = OSSL_PARAM_construct_octet_string(
                "tls1multi_aad", (void*)p->inp, p->len);
        params[1] = OSSL_PARAM_construct_uint(
                "tls1multi_interleave", &p->interleave);
        ret = evp_do_ciph_ctx_setparams(ctx->cipher, ctx->algctx, params);
        if (ret <= 0)
            return ret;

        params[0] = OSSL_PARAM_construct_size_t(
                "tls1multi_aadpacklen", &sz);
        params[1] = OSSL_PARAM_construct_uint(
                "tls1multi_interleave", &p->interleave);
    ...
    case 0x1a: {
        ...
        params[0] = OSSL_PARAM_construct_octet_string(
                        "tls1multi_enc", p->out, p->len);

        params[1] = OSSL_PARAM_construct_octet_string(
                "tls1multi_encin", (void*)p->inp,
                p->len);
...
legacy:
    if (ctx->cipher->ctrl == 
# 1307 "../crypto/evp/evp_enc.c" 3 4
                            ((void *)0)
# 1307 "../crypto/evp/evp_enc.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1308,__func__), ERR_set_error)((6),(132),
# 1308 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1308 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (ret == -1) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1316,__func__), ERR_set_error)((6),(133),
# 1316 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1316 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    return ret;
...
{
    if (cipher != 
# 1324 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1324 "../crypto/evp/evp_enc.c"
                      && cipher->get_params != 
# 1324 "../crypto/evp/evp_enc.c" 3 4
                                               ((void *)0)
# 1324 "../crypto/evp/evp_enc.c"
...
int EVP_CIPHER_CTX_set_params(EVP_CIPHER_CTX *ctx, const OSSL_PARAM params[])
{
    ...
    if (ctx->cipher != 
# 1334 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0) 
# 1334 "../crypto/evp/evp_enc.c"
...
# 1334 "../crypto/evp/evp_enc.c"
        ...
        if (r > 0) {
            p = OSSL_PARAM_locate_const(params, "keylen");
            if (p != 
# 1338 "../crypto/evp/evp_enc.c" 3 4
                    ((void *)0) 
# 1338 "../crypto/evp/evp_enc.c"
                         && !OSSL_PARAM_get_int(p, &ctx->key_len)) {
                r = 0;
                ctx->key_len = -1;
            }
        }
        if (r > 0) {
            p = OSSL_PARAM_locate_const(params, "ivlen");
            if (p != 
# 1345 "../crypto/evp/evp_enc.c" 3 4
                    ((void *)0) 
# 1345 "../crypto/evp/evp_enc.c"
                         && !OSSL_PARAM_get_int(p, &ctx->iv_len)) {
                r = 0;
                ctx->iv_len = -1;
            }
        }
...
{
    if (ctx->cipher != 
# 1356 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0) 
# 1356 "../crypto/evp/evp_enc.c"
                           && ctx->cipher->get_ctx_params != 
# 1356 "../crypto/evp/evp_enc.c" 3 4
                                                             ((void *)0)
# 1356 "../crypto/evp/evp_enc.c"
                                                                 )
...
{
    if (cipher != 
# 1363 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1363 "../crypto/evp/evp_enc.c"
...
# 1363 "../crypto/evp/evp_enc.c"
    ...
    return 
# 1366 "../crypto/evp/evp_enc.c" 3 4
          ((void *)0)
# 1366 "../crypto/evp/evp_enc.c"
              ;
}
...
const OSSL_PARAM *EVP_CIPHER_settable_ctx_params(const EVP_CIPHER *cipher)
{
    ...
    if (cipher != 
# 1373 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1373 "../crypto/evp/evp_enc.c"
...
# 1375 "../crypto/evp/evp_enc.c" 3 4
                                          ((void *)0)
# 1375 "../crypto/evp/evp_enc.c"
                                              , provctx);
    }
    return 
# 1377 "../crypto/evp/evp_enc.c" 3 4
          ((void *)0)
# 1377 "../crypto/evp/evp_enc.c"
              ;
}
...
const OSSL_PARAM *EVP_CIPHER_gettable_ctx_params(const EVP_CIPHER *cipher)
{
    ...
    if (cipher != 
# 1384 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1384 "../crypto/evp/evp_enc.c"
...
# 1386 "../crypto/evp/evp_enc.c" 3 4
                                          ((void *)0)
# 1386 "../crypto/evp/evp_enc.c"
                                              , provctx);
    }
    return 
# 1388 "../crypto/evp/evp_enc.c" 3 4
          ((void *)0)
# 1388 "../crypto/evp/evp_enc.c"
              ;
}
...
const OSSL_PARAM *EVP_CIPHER_CTX_settable_params(EVP_CIPHER_CTX *cctx)
{
    ...
    if (cctx != 
# 1395 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0) 
# 1395 "../crypto/evp/evp_enc.c"
                    && cctx->cipher->settable_ctx_params != 
# 1395 "../crypto/evp/evp_enc.c" 3 4
                                                            ((void *)0)
# 1395 "../crypto/evp/evp_enc.c"
                                                                ) {
    ...
    return 
# 1399 "../crypto/evp/evp_enc.c" 3 4
          ((void *)0)
# 1399 "../crypto/evp/evp_enc.c"
              ;
}
...
const OSSL_PARAM *EVP_CIPHER_CTX_gettable_params(EVP_CIPHER_CTX *cctx)
{
    ...
    if (cctx != 
# 1406 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0) 
# 1406 "../crypto/evp/evp_enc.c"
                    && cctx->cipher->gettable_ctx_params != 
# 1406 "../crypto/evp/evp_enc.c" 3 4
                                                            ((void *)0)
# 1406 "../crypto/evp/evp_enc.c"
                                                                ) {
    ...
    return 
# 1410 "../crypto/evp/evp_enc.c" 3 4
          ((void *)0)
# 1410 "../crypto/evp/evp_enc.c"
              ;
}
...
static OSSL_LIB_CTX *EVP_CIPHER_CTX_get_libctx(EVP_CIPHER_CTX *ctx)
{
    ...
    if (cipher == 
# 1419 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 1419 "../crypto/evp/evp_enc.c"
                     )
        return 
# 1420 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1420 "../crypto/evp/evp_enc.c"
                  ;
...
EVP_CIPHER_CTX *EVP_CIPHER_CTX_dup(const EVP_CIPHER_CTX *in)
{
    ...
    if (out != 
# 1451 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0) 
# 1451 "../crypto/evp/evp_enc.c"
                   && !EVP_CIPHER_CTX_copy(out, in)) {
        EVP_CIPHER_CTX_free(out);
        out = 
# 1453 "../crypto/evp/evp_enc.c" 3 4
             ((void *)0)
# 1453 "../crypto/evp/evp_enc.c"
                 ;
    }
    return out;
}
...
{
    if ((in == 
# 1460 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1460 "../crypto/evp/evp_enc.c"
                  ) || (in->cipher == 
# 1460 "../crypto/evp/evp_enc.c" 3 4
                                      ((void *)0)
# 1460 "../crypto/evp/evp_enc.c"
                                          )) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1461,__func__), ERR_set_error)((6),(111),
# 1461 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1461 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }

    if (in->cipher->prov == 
# 1465 "../crypto/evp/evp_enc.c" 3 4
                           ((void *)0)
# 1465 "../crypto/evp/evp_enc.c"
                               )
        goto legacy;

    if (in->cipher->dupctx == 
# 1468 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 1468 "../crypto/evp/evp_enc.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1469,__func__), ERR_set_error)((6),(190),
# 1469 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1469 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    *out = *in;
    out->algctx = 
# 1476 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0)
# 1476 "../crypto/evp/evp_enc.c"
                     ;

    if (in->fetched_cipher != 
# 1478 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0) 
# 1478 "../crypto/evp/evp_enc.c"
                                  && !EVP_CIPHER_up_ref(in->fetched_cipher)) {
        out->fetched_cipher = 
# 1479 "../crypto/evp/evp_enc.c" 3 4
                             ((void *)0)
# 1479 "../crypto/evp/evp_enc.c"
                                 ;
        return 0;
    }
    ...
    if (out->algctx == 
# 1484 "../crypto/evp/evp_enc.c" 3 4
                      ((void *)0)
# 1484 "../crypto/evp/evp_enc.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1485,__func__), ERR_set_error)((6),(190),
# 1485 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1485 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
 ...
 legacy:
    ...
    if (in->engine && !ENGINE_init(in->engine)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1497,__func__), ERR_set_error)((6),((38 | (0x2 << 18L))),
# 1497 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1497 "../crypto/evp/evp_enc.c"
       );
        return 0;
    }
    ...
    if (in->cipher_data && in->cipher->ctx_size) {
        out->cipher_data = CRYPTO_malloc(in->cipher->ctx_size, "../crypto/evp/evp_enc.c", 1506);
        if (out->cipher_data == 
# 1507 "../crypto/evp/evp_enc.c" 3 4
                               ((void *)0)
# 1507 "../crypto/evp/evp_enc.c"
                                   ) {
            out->cipher = 
# 1508 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0)
# 1508 "../crypto/evp/evp_enc.c"
                             ;
            return 0;
        }
    ...
    if (in->cipher->flags & 0x400)
        if (!in->cipher->ctrl((EVP_CIPHER_CTX *)in, 0x8, 0, out)) {
            out->cipher = 
# 1516 "../crypto/evp/evp_enc.c" 3 4
                         ((void *)0)
# 1516 "../crypto/evp/evp_enc.c"
                             ;
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1517,__func__), ERR_set_error)((6),(134),
# 1517 "../crypto/evp/evp_enc.c" 3 4
           ((void *)0)
# 1517 "../crypto/evp/evp_enc.c"
           );
            return 0;
        }
    return 1;
...
EVP_CIPHER *evp_cipher_new(void)
{
    EVP_CIPHER *cipher = CRYPTO_zalloc(sizeof(EVP_CIPHER), "../crypto/evp/evp_enc.c", 1525);

    if (cipher != 
# 1527 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1527 "../crypto/evp/evp_enc.c"
                      && !CRYPTO_NEW_REF(&cipher->refcnt, 1)) {
        CRYPTO_free(cipher, "../crypto/evp/evp_enc.c", 1528);
        return 
# 1529 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1529 "../crypto/evp/evp_enc.c"
                  ;
    }
    return cipher;
}
# 1541 "../crypto/evp/evp_enc.c"
static void set_legacy_nid(const char *name, void *vlegacy_nid)
{
    ...
    const void *legacy_method = OBJ_NAME_get(name, 0x02);

    if (*legacy_nid == -1)
        return;
    if (legacy_method == 
# 1554 "../crypto/evp/evp_enc.c" 3 4
                        ((void *)0)
# 1554 "../crypto/evp/evp_enc.c"
                            )
        return;
    nid = EVP_CIPHER_get_nid(legacy_method);
    if (*legacy_nid != 0 && *legacy_nid != nid) {
        *legacy_nid = -1;
        return;
    }
    *legacy_nid = nid;
                                       ...
                                       OSSL_PROVIDER *prov)
{
    ...
    EVP_CIPHER *cipher = 
# 1570 "../crypto/evp/evp_enc.c" 3 4
                        ((void *)0)
# 1570 "../crypto/evp/evp_enc.c"
                            ;
    int fnciphcnt = 0, fnctxcnt = 0;

    if ((cipher = evp_cipher_new()) == 
# 1573 "../crypto/evp/evp_enc.c" 3 4
                                      ((void *)0)
# 1573 "../crypto/evp/evp_enc.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1574,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 1574 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1574 "../crypto/evp/evp_enc.c"
       );
        return 
# 1575 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1575 "../crypto/evp/evp_enc.c"
                  ;
    }
    ...
    if (!evp_names_do_all(prov, name_id, set_legacy_nid, &cipher->nid)
            || cipher->nid == -1) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1582,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1582 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1582 "../crypto/evp/evp_enc.c"
       );
        EVP_CIPHER_free(cipher);
        return 
# 1584 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1584 "../crypto/evp/evp_enc.c"
                  ;
    }


    cipher->name_id = name_id;
    if ((cipher->type_name = ossl_algorithm_get1_first_name(algodef)) == 
# 1589 "../crypto/evp/evp_enc.c" 3 4
                                                                        ((void *)0)
# 1589 "../crypto/evp/evp_enc.c"
                                                                            ) {
        EVP_CIPHER_free(cipher);
        return 
# 1591 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1591 "../crypto/evp/evp_enc.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (cipher->newctx != 
# 1598 "../crypto/evp/evp_enc.c" 3 4
                                 ((void *)0)
# 1598 "../crypto/evp/evp_enc.c"
                                     )
                break;
        ...
        case 2:
            if (cipher->einit != 
# 1604 "../crypto/evp/evp_enc.c" 3 4
                                ((void *)0)
# 1604 "../crypto/evp/evp_enc.c"
                                    )
                break;
        ...
        case 3:
            if (cipher->dinit != 
# 1610 "../crypto/evp/evp_enc.c" 3 4
                                ((void *)0)
# 1610 "../crypto/evp/evp_enc.c"
                                    )
                break;
        ...
        case 4:
            if (cipher->cupdate != 
# 1616 "../crypto/evp/evp_enc.c" 3 4
                                  ((void *)0)
# 1616 "../crypto/evp/evp_enc.c"
                                      )
                break;
        ...
        case 5:
            if (cipher->cfinal != 
# 1622 "../crypto/evp/evp_enc.c" 3 4
                                 ((void *)0)
# 1622 "../crypto/evp/evp_enc.c"
                                     )
                break;
        ...
        case 6:
            if (cipher->ccipher != 
# 1628 "../crypto/evp/evp_enc.c" 3 4
                                  ((void *)0)
# 1628 "../crypto/evp/evp_enc.c"
                                      )
                break;
        ...
        case 7:
            if (cipher->freectx != 
# 1633 "../crypto/evp/evp_enc.c" 3 4
                                  ((void *)0)
# 1633 "../crypto/evp/evp_enc.c"
                                      )
                break;
        ...
        case 8:
            if (cipher->dupctx != 
# 1639 "../crypto/evp/evp_enc.c" 3 4
                                 ((void *)0)
# 1639 "../crypto/evp/evp_enc.c"
                                     )
                break;
...
# 1644 "../crypto/evp/evp_enc.c" 3 4
                                     ((void *)0)
# 1644 "../crypto/evp/evp_enc.c"
                                         )
                break;
...
# 1649 "../crypto/evp/evp_enc.c" 3 4
                                         ((void *)0)
# 1649 "../crypto/evp/evp_enc.c"
                                             )
                break;
...
# 1654 "../crypto/evp/evp_enc.c" 3 4
                                         ((void *)0)
# 1654 "../crypto/evp/evp_enc.c"
                                             )
                break;
            cipher->set_ctx_params = OSSL_FUNC_cipher_set_ctx_params(fns);
            break;
        case 12:
            if (cipher->gettable_params != 
# 1659 "../crypto/evp/evp_enc.c" 3 4
                                          ((void *)0)
# 1659 "../crypto/evp/evp_enc.c"
                                              )
                break;
...
# 1664 "../crypto/evp/evp_enc.c" 3 4
                                              ((void *)0)
# 1664 "../crypto/evp/evp_enc.c"
                                                  )
                break;
            cipher->gettable_ctx_params =
...
# 1670 "../crypto/evp/evp_enc.c" 3 4
                                              ((void *)0)
# 1670 "../crypto/evp/evp_enc.c"
                                                  )
                break;
            cipher->settable_ctx_params =
    ...
    if ((fnciphcnt != 0 && fnciphcnt != 3 && fnciphcnt != 4)
            || (fnciphcnt == 0 && cipher->ccipher == 
# 1678 "../crypto/evp/evp_enc.c" 3 4
                                                    ((void *)0)
# 1678 "../crypto/evp/evp_enc.c"
                                                        )
            || fnctxcnt != 2) {
        ...
        EVP_CIPHER_free(cipher);
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1687,__func__), ERR_set_error)((6),(193),
# 1687 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1687 "../crypto/evp/evp_enc.c"
       );
        return 
# 1688 "../crypto/evp/evp_enc.c" 3 4
              ((void *)0)
# 1688 "../crypto/evp/evp_enc.c"
                  ;
    }
    cipher->prov = prov;
    if (prov != 
# 1691 "../crypto/evp/evp_enc.c" 3 4
               ((void *)0)
# 1691 "../crypto/evp/evp_enc.c"
                   )
        ossl_provider_up_ref(prov);

    if (!evp_cipher_cache_constants(cipher)) {
        EVP_CIPHER_free(cipher);
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_enc.c",1696,__func__), ERR_set_error)((6),(225),
# 1696 "../crypto/evp/evp_enc.c" 3 4
       ((void *)0)
# 1696 "../crypto/evp/evp_enc.c"
       );
        cipher = 
# 1697 "../crypto/evp/evp_enc.c" 3 4
                ((void *)0)
# 1697 "../crypto/evp/evp_enc.c"
                    ;
    }
...
{
    EVP_CIPHER *cipher =
        evp_generic_fetch(ctx, 2, algorithm, properties,
...
{
    CRYPTO_free(cipher->type_name, "../crypto/evp/evp_enc.c", 1735);
    ossl_provider_free(cipher->prov);
    CRYPTO_FREE_REF(&cipher->refcnt);
    CRYPTO_free(cipher, "../crypto/evp/evp_enc.c", 1738);
}
...
void EVP_CIPHER_free(EVP_CIPHER *cipher)
{
    ...
    if (cipher == 
# 1745 "../crypto/evp/evp_enc.c" 3 4
                 ((void *)0) 
# 1745 "../crypto/evp/evp_enc.c"
                      || cipher->origin != 0)
        return;
