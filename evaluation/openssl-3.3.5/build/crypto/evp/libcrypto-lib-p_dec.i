# 0 "../crypto/evp/p_dec.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_dec.c"
# 13 "../crypto/evp/p_dec.c"
                         ...
                         EVP_PKEY *priv)
{
    int ret = -1;
    RSA *rsa = 
# 25 "../crypto/evp/p_dec.c" 3 4
              ((void *)0)
# 25 "../crypto/evp/p_dec.c"
                  ;

    if (EVP_PKEY_get_id(priv) != 6) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_dec.c",28,__func__), ERR_set_error)((6),(106),
# 28 "../crypto/evp/p_dec.c" 3 4
       ((void *)0)
# 28 "../crypto/evp/p_dec.c"
       );
        goto err;
    }
    ...
    if (rsa == 
# 33 "../crypto/evp/p_dec.c" 3 4
              ((void *)0)
# 33 "../crypto/evp/p_dec.c"
                  )
        goto err;

    ret =
        RSA_private_decrypt(ekl, ek, key, rsa, 1);
 err:
    return ret;
}
