# 0 "../crypto/evp/encode.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/encode.c"
# 10 "../crypto/evp/encode.c"
...
# 127 "../crypto/evp/encode.c"
EVP_ENCODE_CTX *EVP_ENCODE_CTX_new(void)
{
    return CRYPTO_zalloc(sizeof(EVP_ENCODE_CTX), "../crypto/evp/encode.c", 129);
}

void EVP_ENCODE_CTX_free(EVP_ENCODE_CTX *ctx)
{
    CRYPTO_free(ctx, "../crypto/evp/encode.c", 134);
}
                      ...
                      const unsigned char *in, int inl)
{
    ...
    *outl = 0;
    if (inl <= 0)
        return 0;
    (void)((ctx->length <= (int)sizeof(ctx->enc_data)) ? 0 : (OPENSSL_die("assertion failed: " "ctx->length <= (int)sizeof(ctx->enc_data)", "../crypto/evp/encode.c", 171), 1));
                               ...
                               const unsigned char *f, int dlen)
{
    ...
    if (ctx != 
# 238 "../crypto/evp/encode.c" 3 4
              ((void *)0) 
# 238 "../crypto/evp/encode.c"
                   && (ctx->flags & 2) != 0)
...
{
    return evp_encodeblock_int(
# 271 "../crypto/evp/encode.c" 3 4
                              ((void *)0)
# 271 "../crypto/evp/encode.c"
                                  , t, f, dlen);
}
                     ...
                     const unsigned char *in, int inl)
{
    ...
    for (i = 0; i < inl; i++) {
        ...
        if ((!(((v)|0x13) == 0xF3))) {
            ...
            (void)((n < (int)sizeof(ctx->enc_data)) ? 0 : (OPENSSL_die("assertion failed: " "n < (int)sizeof(ctx->enc_data)", "../crypto/evp/encode.c", 367), 1));
            d[n++] = tmp;
        }
                               ...
                               const unsigned char *f, int n)
{
    ...
    if (ctx != 
# 420 "../crypto/evp/encode.c" 3 4
              ((void *)0) 
# 420 "../crypto/evp/encode.c"
                   && (ctx->flags & 2) != 0)
        table = srpdata_ascii2bin;
    else
        table = data_ascii2bin;
    ...
    while ((n > 0) && (conv_ascii2bin(*f, table) == 0xE0)) {
        f++;
        n--;
    }
    ...
    while ((n > 3) && ((((conv_ascii2bin(f[n - 1], table))|0x13) == 0xF3)))
        n--;
...
int EVP_DecodeBlock(unsigned char *t, const unsigned char *f, int n)
{
    return evp_decodeblock_int(
# 461 "../crypto/evp/encode.c" 3 4
                              ((void *)0)
# 461 "../crypto/evp/encode.c"
                                  , t, f, n);
}
