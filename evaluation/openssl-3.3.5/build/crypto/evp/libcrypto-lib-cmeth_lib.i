# 0 "../crypto/evp/cmeth_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/cmeth_lib.c"
# 14 "../crypto/evp/cmeth_lib.c"
...
EVP_CIPHER *EVP_CIPHER_meth_new(int cipher_type, int block_size, int key_len)
{
    ...
    if (cipher != 
# 27 "../crypto/evp/cmeth_lib.c" 3 4
                 ((void *)0)
# 27 "../crypto/evp/cmeth_lib.c"
                     ) {
...
{
    EVP_CIPHER *to = 
# 38 "../crypto/evp/cmeth_lib.c" 3 4
                    ((void *)0)
# 38 "../crypto/evp/cmeth_lib.c"
                        ;
    ...
    if (cipher->prov != 
# 44 "../crypto/evp/cmeth_lib.c" 3 4
                       ((void *)0)
# 44 "../crypto/evp/cmeth_lib.c"
                           )
        return 
# 45 "../crypto/evp/cmeth_lib.c" 3 4
              ((void *)0)
# 45 "../crypto/evp/cmeth_lib.c"
                  ;

    if ((to = EVP_CIPHER_meth_new(cipher->nid, cipher->block_size,
                                  cipher->key_len)) != 
# 48 "../crypto/evp/cmeth_lib.c" 3 4
                                                      ((void *)0)
# 48 "../crypto/evp/cmeth_lib.c"
                                                          ) {
...
{
    if (cipher == 
# 60 "../crypto/evp/cmeth_lib.c" 3 4
                 ((void *)0) 
# 60 "../crypto/evp/cmeth_lib.c"
                      || cipher->origin != 2)
       return;
...
{
    if (cipher->init != 
# 99 "../crypto/evp/cmeth_lib.c" 3 4
                       ((void *)0)
# 99 "../crypto/evp/cmeth_lib.c"
                           )
        return 0;
...
{
    if (cipher->do_cipher != 
# 112 "../crypto/evp/cmeth_lib.c" 3 4
                            ((void *)0)
# 112 "../crypto/evp/cmeth_lib.c"
                                )
        return 0;
...
{
    if (cipher->cleanup != 
# 122 "../crypto/evp/cmeth_lib.c" 3 4
                          ((void *)0)
# 122 "../crypto/evp/cmeth_lib.c"
                              )
        return 0;
...
# 133 "../crypto/evp/cmeth_lib.c" 3 4
                                      ((void *)0)
# 133 "../crypto/evp/cmeth_lib.c"
                                          )
        return 0;
...
# 144 "../crypto/evp/cmeth_lib.c" 3 4
                                      ((void *)0)
# 144 "../crypto/evp/cmeth_lib.c"
                                          )
        return 0;
...
{
    if (cipher->ctrl != 
# 155 "../crypto/evp/cmeth_lib.c" 3 4
                       ((void *)0)
# 155 "../crypto/evp/cmeth_lib.c"
                           )
        return 0;
