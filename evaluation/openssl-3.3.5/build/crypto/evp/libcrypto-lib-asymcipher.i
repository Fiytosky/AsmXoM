# 0 "../crypto/evp/asymcipher.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/asymcipher.c"
# 10 "../crypto/evp/asymcipher.c"
                                     ...
                                     const OSSL_PARAM params[])
{
    int ret = 0;
    void *provkey = 
# 24 "../crypto/evp/asymcipher.c" 3 4
                   ((void *)0)
# 24 "../crypto/evp/asymcipher.c"
                       ;
    EVP_ASYM_CIPHER *cipher = 
# 25 "../crypto/evp/asymcipher.c" 3 4
                             ((void *)0)
# 25 "../crypto/evp/asymcipher.c"
                                 ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 26 "../crypto/evp/asymcipher.c" 3 4
                              ((void *)0)
# 26 "../crypto/evp/asymcipher.c"
                                  ;
    const OSSL_PROVIDER *tmp_prov = 
# 27 "../crypto/evp/asymcipher.c" 3 4
                                   ((void *)0)
# 27 "../crypto/evp/asymcipher.c"
                                       ;
    const char *supported_ciph = 
# 28 "../crypto/evp/asymcipher.c" 3 4
                                ((void *)0)
# 28 "../crypto/evp/asymcipher.c"
                                    ;
    int iter;

    if (ctx == 
# 31 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 31 "../crypto/evp/asymcipher.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",32,__func__), ERR_set_error)((6),(150),
# 32 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 32 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }
    ...
    if (((ctx)->keymgmt == 
# 41 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 41 "../crypto/evp/asymcipher.c"
       ))
        goto legacy;

    if (ctx->pkey == 
# 44 "../crypto/evp/asymcipher.c" 3 4
                    ((void *)0)
# 44 "../crypto/evp/asymcipher.c"
                        ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",46,__func__), ERR_set_error)((6),(154),
# 46 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 46 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
...
# 53 "../crypto/evp/asymcipher.c" 3 4
        ((void *)0) 
# 53 "../crypto/evp/asymcipher.c"
        || ctx->pkey->keymgmt == ctx->keymgmt) != 0), 1)
                                                           ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",56,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 56 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 56 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
    supported_ciph
        = evp_keymgmt_util_query_operation_name(ctx->keymgmt,
                                                13);
    if (supported_ciph == 
# 62 "../crypto/evp/asymcipher.c" 3 4
                         ((void *)0)
# 62 "../crypto/evp/asymcipher.c"
                             ) {
        ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",64,__func__), ERR_set_error)((6),(134),
# 64 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 64 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
# 85 "../crypto/evp/asymcipher.c"
    for (iter = 1, provkey = 
# 85 "../crypto/evp/asymcipher.c" 3 4
                            ((void *)0)
# 85 "../crypto/evp/asymcipher.c"
                                ; iter < 3 && provkey == 
# 85 "../crypto/evp/asymcipher.c" 3 4
...
# 85 "../crypto/evp/asymcipher.c"
        ...
        case 1:
            cipher = EVP_ASYM_CIPHER_fetch(ctx->libctx, supported_ciph,
                                           ctx->propquery);
            if (cipher != 
# 100 "../crypto/evp/asymcipher.c" 3 4
                         ((void *)0)
# 100 "../crypto/evp/asymcipher.c"
                             )
        ...
        case 2:
            ...
            if (cipher == 
# 108 "../crypto/evp/asymcipher.c" 3 4
                         ((void *)0)
# 108 "../crypto/evp/asymcipher.c"
                             )
                goto legacy;
            break;
        }
        if (cipher == 
# 112 "../crypto/evp/asymcipher.c" 3 4
                     ((void *)0)
# 112 "../crypto/evp/asymcipher.c"
                         )
            continue;
# 124 "../crypto/evp/asymcipher.c"
        tmp_keymgmt_tofree = tmp_keymgmt
            = evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)tmp_prov,
                                          EVP_KEYMGMT_get0_name(ctx->keymgmt),
                                          ctx->propquery);
        if (tmp_keymgmt != 
# 128 "../crypto/evp/asymcipher.c" 3 4
                          ((void *)0)
# 128 "../crypto/evp/asymcipher.c"
                              )
            provkey = evp_pkey_export_to_provider(ctx->pkey, ctx->libctx,
                                                  &tmp_keymgmt, ctx->propquery);
        if (tmp_keymgmt == 
# 131 "../crypto/evp/asymcipher.c" 3 4
                          ((void *)0)
# 131 "../crypto/evp/asymcipher.c"
                              )
            EVP_KEYMGMT_free(tmp_keymgmt_tofree);
    }

    if (provkey == 
# 135 "../crypto/evp/asymcipher.c" 3 4
                  ((void *)0)
# 135 "../crypto/evp/asymcipher.c"
                      ) {
        EVP_ASYM_CIPHER_free(cipher);
        goto legacy;
    }
...
# 146 "../crypto/evp/asymcipher.c" 3 4
                              ((void *)0)
# 146 "../crypto/evp/asymcipher.c"
                                  ) {

        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",148,__func__), ERR_set_error)((6),(134),
# 148 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 148 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
...
# 154 "../crypto/evp/asymcipher.c" 3 4
                                   ((void *)0)
# 154 "../crypto/evp/asymcipher.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",155,__func__), ERR_set_error)((6),(150),
# 155 "../crypto/evp/asymcipher.c" 3 4
           ((void *)0)
# 155 "../crypto/evp/asymcipher.c"
           );
            ret = -2;
            goto err;
        }
...
# 162 "../crypto/evp/asymcipher.c" 3 4
                                   ((void *)0)
# 162 "../crypto/evp/asymcipher.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",163,__func__), ERR_set_error)((6),(150),
# 163 "../crypto/evp/asymcipher.c" 3 4
           ((void *)0)
# 163 "../crypto/evp/asymcipher.c"
           );
            ret = -2;
            goto err;
        }
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",170,__func__), ERR_set_error)((6),(134),
# 170 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 170 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
 ...
 legacy:
    ...
    EVP_KEYMGMT_free(tmp_keymgmt);
    tmp_keymgmt = 
# 186 "../crypto/evp/asymcipher.c" 3 4
                 ((void *)0)
# 186 "../crypto/evp/asymcipher.c"
                     ;

    if (ctx->pmeth == 
# 188 "../crypto/evp/asymcipher.c" 3 4
                     ((void *)0) 
# 188 "../crypto/evp/asymcipher.c"
                          || ctx->pmeth->encrypt == 
# 188 "../crypto/evp/asymcipher.c" 3 4
                                                    ((void *)0)
# 188 "../crypto/evp/asymcipher.c"
                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",189,__func__), ERR_set_error)((6),(150),
# 189 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 189 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }
...
# 194 "../crypto/evp/asymcipher.c" 3 4
                                       ((void *)0)
# 194 "../crypto/evp/asymcipher.c"
                                           )
            return 1;
...
# 199 "../crypto/evp/asymcipher.c" 3 4
                                       ((void *)0)
# 199 "../crypto/evp/asymcipher.c"
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",204,__func__), ERR_set_error)((6),(134),
# 204 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 204 "../crypto/evp/asymcipher.c"
       );
        ret = -1;
    }
...
int EVP_PKEY_encrypt_init(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_asym_cipher_init(ctx, (1<<9), 
# 219 "../crypto/evp/asymcipher.c" 3 4
                                                              ((void *)0)
# 219 "../crypto/evp/asymcipher.c"
                                                                  );
}

int EVP_PKEY_encrypt_init_ex(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_pkey_asym_cipher_init(ctx, (1<<9), params);
}
                     ...
                     const unsigned char *in, size_t inlen)
{
    ...
    if (ctx == 
# 233 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 233 "../crypto/evp/asymcipher.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",234,__func__), ERR_set_error)((6),(150),
# 234 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 234 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }

    if (ctx->operation != (1<<9)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",239,__func__), ERR_set_error)((6),(151),
# 239 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 239 "../crypto/evp/asymcipher.c"
       );
        return -1;
    }

    if (ctx->op.ciph.algctx == 
# 243 "../crypto/evp/asymcipher.c" 3 4
                              ((void *)0)
# 243 "../crypto/evp/asymcipher.c"
                                  )
        goto legacy;

    ret = ctx->op.ciph.cipher->encrypt(ctx->op.ciph.algctx, out, outlen,
                                       (out == 
# 247 "../crypto/evp/asymcipher.c" 3 4
                                              ((void *)0) 
# 247 "../crypto/evp/asymcipher.c"
                                                   ? 0 : *outlen), in, inlen);
    return ret;

 legacy:
    if (ctx->pmeth == 
# 251 "../crypto/evp/asymcipher.c" 3 4
                     ((void *)0) 
# 251 "../crypto/evp/asymcipher.c"
                          || ctx->pmeth->encrypt == 
# 251 "../crypto/evp/asymcipher.c" 3 4
                                                    ((void *)0)
# 251 "../crypto/evp/asymcipher.c"
                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",252,__func__), ERR_set_error)((6),(150),
# 252 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 252 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }
    if (ctx->pmeth->flags & 2) { size_t pksize = (size_t)EVP_PKEY_get_size(ctx->pkey); if (pksize == 0) { (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",255,__func__), ERR_set_error)((6),(163),
# 255 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 255 "../crypto/evp/asymcipher.c"
   ); return 0; } if (out == 
# 255 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 255 "../crypto/evp/asymcipher.c"
   ) { *outlen = pksize; return 1; } if (*outlen < pksize) { (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",255,__func__), ERR_set_error)((6),(155),
# 255 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 255 "../crypto/evp/asymcipher.c"
   ); return 0; } }
...
int EVP_PKEY_decrypt_init(EVP_PKEY_CTX *ctx)
{
    return evp_pkey_asym_cipher_init(ctx, (1<<10), 
# 261 "../crypto/evp/asymcipher.c" 3 4
                                                              ((void *)0)
# 261 "../crypto/evp/asymcipher.c"
                                                                  );
}

int EVP_PKEY_decrypt_init_ex(EVP_PKEY_CTX *ctx, const OSSL_PARAM params[])
{
    return evp_pkey_asym_cipher_init(ctx, (1<<10), params);
}
                     ...
                     const unsigned char *in, size_t inlen)
{
    ...
    if (ctx == 
# 275 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 275 "../crypto/evp/asymcipher.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",276,__func__), ERR_set_error)((6),(150),
# 276 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 276 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }

    if (ctx->operation != (1<<10)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",281,__func__), ERR_set_error)((6),(151),
# 281 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 281 "../crypto/evp/asymcipher.c"
       );
        return -1;
    }

    if (ctx->op.ciph.algctx == 
# 285 "../crypto/evp/asymcipher.c" 3 4
                              ((void *)0)
# 285 "../crypto/evp/asymcipher.c"
                                  )
        goto legacy;

    ret = ctx->op.ciph.cipher->decrypt(ctx->op.ciph.algctx, out, outlen,
                                       (out == 
# 289 "../crypto/evp/asymcipher.c" 3 4
                                              ((void *)0) 
# 289 "../crypto/evp/asymcipher.c"
                                                   ? 0 : *outlen), in, inlen);
    return ret;

 legacy:
    if (ctx->pmeth == 
# 293 "../crypto/evp/asymcipher.c" 3 4
                     ((void *)0) 
# 293 "../crypto/evp/asymcipher.c"
                          || ctx->pmeth->decrypt == 
# 293 "../crypto/evp/asymcipher.c" 3 4
                                                    ((void *)0)
# 293 "../crypto/evp/asymcipher.c"
                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",294,__func__), ERR_set_error)((6),(150),
# 294 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 294 "../crypto/evp/asymcipher.c"
       );
        return -2;
    }
    if (ctx->pmeth->flags & 2) { size_t pksize = (size_t)EVP_PKEY_get_size(ctx->pkey); if (pksize == 0) { (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",297,__func__), ERR_set_error)((6),(163),
# 297 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 297 "../crypto/evp/asymcipher.c"
   ); return 0; } if (out == 
# 297 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 297 "../crypto/evp/asymcipher.c"
   ) { *outlen = pksize; return 1; } if (*outlen < pksize) { (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",297,__func__), ERR_set_error)((6),(155),
# 297 "../crypto/evp/asymcipher.c" 3 4
   ((void *)0)
# 297 "../crypto/evp/asymcipher.c"
   ); return 0; } }
...
# 306 "../crypto/evp/asymcipher.c" 3 4
                             ((void *)0)
# 306 "../crypto/evp/asymcipher.c"
                                 , outlenp, in, inlen) <= 0
            || (*outp = CRYPTO_malloc(*outlenp, "../crypto/evp/asymcipher.c", 307)) == 
# 307 "../crypto/evp/asymcipher.c" 3 4
                                                    ((void *)0)
# 307 "../crypto/evp/asymcipher.c"
                                                        )
        return -1;
    if (EVP_PKEY_decrypt(ctx, *outp, outlenp, in, inlen) <= 0
            || *outlenp == 0
            || (expected_outlen != 0 && *outlenp != expected_outlen)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",312,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 312 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 312 "../crypto/evp/asymcipher.c"
       );
        CRYPTO_clear_free(*outp, *outlenp, "../crypto/evp/asymcipher.c", 313);
        *outp = 
# 314 "../crypto/evp/asymcipher.c" 3 4
               ((void *)0)
# 314 "../crypto/evp/asymcipher.c"
                   ;
        return 0;
    }
    return 1;
...
{
    EVP_ASYM_CIPHER *cipher = CRYPTO_zalloc(sizeof(EVP_ASYM_CIPHER), "../crypto/evp/asymcipher.c", 322);

    if (cipher == 
# 324 "../crypto/evp/asymcipher.c" 3 4
                 ((void *)0)
# 324 "../crypto/evp/asymcipher.c"
                     )
        return 
# 325 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 325 "../crypto/evp/asymcipher.c"
                  ;

    if (!CRYPTO_NEW_REF(&cipher->refcnt, 1)) {
        CRYPTO_free(cipher, "../crypto/evp/asymcipher.c", 328);
        return 
# 329 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 329 "../crypto/evp/asymcipher.c"
                  ;
    }
    cipher->prov = prov;
                                            ...
                                            OSSL_PROVIDER *prov)
{
    ...
    EVP_ASYM_CIPHER *cipher = 
# 342 "../crypto/evp/asymcipher.c" 3 4
                             ((void *)0)
# 342 "../crypto/evp/asymcipher.c"
                                 ;
    int ctxfncnt = 0, encfncnt = 0, decfncnt = 0;
    int gparamfncnt = 0, sparamfncnt = 0;

    if ((cipher = evp_asym_cipher_new(prov)) == 
# 346 "../crypto/evp/asymcipher.c" 3 4
                                               ((void *)0)
# 346 "../crypto/evp/asymcipher.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",347,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 347 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 347 "../crypto/evp/asymcipher.c"
       );
        goto err;
    }
...
# 352 "../crypto/evp/asymcipher.c" 3 4
                                                                        ((void *)0)
# 352 "../crypto/evp/asymcipher.c"
                                                                            )
        goto err;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (cipher->newctx != 
# 359 "../crypto/evp/asymcipher.c" 3 4
                                 ((void *)0)
# 359 "../crypto/evp/asymcipher.c"
                                     )
                break;
        ...
        case 2:
            if (cipher->encrypt_init != 
# 365 "../crypto/evp/asymcipher.c" 3 4
                                       ((void *)0)
# 365 "../crypto/evp/asymcipher.c"
                                           )
                break;
        ...
        case 3:
            if (cipher->encrypt != 
# 371 "../crypto/evp/asymcipher.c" 3 4
                                  ((void *)0)
# 371 "../crypto/evp/asymcipher.c"
                                      )
                break;
        ...
        case 4:
            if (cipher->decrypt_init != 
# 377 "../crypto/evp/asymcipher.c" 3 4
                                       ((void *)0)
# 377 "../crypto/evp/asymcipher.c"
                                           )
                break;
        ...
        case 5:
            if (cipher->decrypt != 
# 383 "../crypto/evp/asymcipher.c" 3 4
                                  ((void *)0)
# 383 "../crypto/evp/asymcipher.c"
                                      )
                break;
        ...
        case 6:
            if (cipher->freectx != 
# 389 "../crypto/evp/asymcipher.c" 3 4
                                  ((void *)0)
# 389 "../crypto/evp/asymcipher.c"
                                      )
                break;
        ...
        case 7:
            if (cipher->dupctx != 
# 395 "../crypto/evp/asymcipher.c" 3 4
                                 ((void *)0)
# 395 "../crypto/evp/asymcipher.c"
                                     )
                break;
...
# 400 "../crypto/evp/asymcipher.c" 3 4
                                         ((void *)0)
# 400 "../crypto/evp/asymcipher.c"
                                             )
                break;
...
# 407 "../crypto/evp/asymcipher.c" 3 4
                                              ((void *)0)
# 407 "../crypto/evp/asymcipher.c"
                                                  )
                break;
...
# 414 "../crypto/evp/asymcipher.c" 3 4
                                         ((void *)0)
# 414 "../crypto/evp/asymcipher.c"
                                             )
                break;
...
# 421 "../crypto/evp/asymcipher.c" 3 4
                                              ((void *)0)
# 421 "../crypto/evp/asymcipher.c"
                                                  )
                break;
...
# 444 "../crypto/evp/asymcipher.c"
        (ERR_new(), ERR_set_debug("../crypto/evp/asymcipher.c",444,__func__), ERR_set_error)((6),(193),
# 444 "../crypto/evp/asymcipher.c" 3 4
       ((void *)0)
# 444 "../crypto/evp/asymcipher.c"
       );
        goto err;
 ...
 err:
    EVP_ASYM_CIPHER_free(cipher);
    return 
# 451 "../crypto/evp/asymcipher.c" 3 4
          ((void *)0)
# 451 "../crypto/evp/asymcipher.c"
              ;
}
...
void EVP_ASYM_CIPHER_free(EVP_ASYM_CIPHER *cipher)
{
    ...
    if (cipher == 
# 458 "../crypto/evp/asymcipher.c" 3 4
                 ((void *)0)
# 458 "../crypto/evp/asymcipher.c"
                     )
        return;
    CRYPTO_DOWN_REF(&cipher->refcnt, &i);
    if (i > 0)
        return;
    CRYPTO_free(cipher->type_name, "../crypto/evp/asymcipher.c", 463);
    ossl_provider_free(cipher->prov);
    CRYPTO_FREE_REF(&cipher->refcnt);
    CRYPTO_free(cipher, "../crypto/evp/asymcipher.c", 466);
}
...
EVP_ASYM_CIPHER *EVP_ASYM_CIPHER_fetch(OSSL_LIB_CTX *ctx, const char *algorithm,
                                       const char *properties)
{
    return evp_generic_fetch(ctx, 13, algorithm, properties,
...
EVP_ASYM_CIPHER *evp_asym_cipher_fetch_from_prov(OSSL_PROVIDER *prov,
                                                 ...
                                                 const char *properties)
{
    return evp_generic_fetch_from_prov(prov, 13,
...
# 504 "../crypto/evp/asymcipher.c" 3 4
                                                  ((void *)0)
# 504 "../crypto/evp/asymcipher.c"
                                                      , name);
}
...
{
    if (cipher->prov != 
# 539 "../crypto/evp/asymcipher.c" 3 4
                       ((void *)0)
# 539 "../crypto/evp/asymcipher.c"
                           )
...
const OSSL_PARAM *EVP_ASYM_CIPHER_gettable_ctx_params(const EVP_ASYM_CIPHER *cip)
{
    ...
    if (cip == 
# 549 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0) 
# 549 "../crypto/evp/asymcipher.c"
                   || cip->gettable_ctx_params == 
# 549 "../crypto/evp/asymcipher.c" 3 4
                                                  ((void *)0)
# 549 "../crypto/evp/asymcipher.c"
                                                      )
        return 
# 550 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 550 "../crypto/evp/asymcipher.c"
                  ;

    provctx = ossl_provider_ctx(EVP_ASYM_CIPHER_get0_provider(cip));
    return cip->gettable_ctx_params(
# 553 "../crypto/evp/asymcipher.c" 3 4
                                   ((void *)0)
# 553 "../crypto/evp/asymcipher.c"
                                       , provctx);
}
...
const OSSL_PARAM *EVP_ASYM_CIPHER_settable_ctx_params(const EVP_ASYM_CIPHER *cip)
{
    ...
    if (cip == 
# 560 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0) 
# 560 "../crypto/evp/asymcipher.c"
                   || cip->settable_ctx_params == 
# 560 "../crypto/evp/asymcipher.c" 3 4
                                                  ((void *)0)
# 560 "../crypto/evp/asymcipher.c"
                                                      )
        return 
# 561 "../crypto/evp/asymcipher.c" 3 4
              ((void *)0)
# 561 "../crypto/evp/asymcipher.c"
                  ;

    provctx = ossl_provider_ctx(EVP_ASYM_CIPHER_get0_provider(cip));
    return cip->settable_ctx_params(
# 564 "../crypto/evp/asymcipher.c" 3 4
                                   ((void *)0)
# 564 "../crypto/evp/asymcipher.c"
                                       , provctx);
}
