# 0 "../crypto/evp/e_rc2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_rc2.c"
# 14 "../crypto/evp/e_rc2.c"
...
static int rc2_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { RC2_cbc_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) RC2_cbc_encrypt(in, out, (long)inl, &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int rc2_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (64 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); RC2_cfb64_encrypt(in, out, (long) ((64 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int rc2_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) RC2_ecb_encrypt(in + i, out + i, &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int rc2_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { int num = EVP_CIPHER_CTX_get_num(ctx); RC2_ofb64_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) { int num = EVP_CIPHER_CTX_get_num(ctx); RC2_ofb64_encrypt(in, out, (long)inl, &((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER rc2_cbc = { 37, 8, 16, 8, 0x8 | 0x40 | 0x2, 1, rc2_init_key, rc2_cbc_cipher, 
# 42 "../crypto/evp/e_rc2.c" 3 4
((void *)0)
# 42 "../crypto/evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
# 42 "../crypto/evp/e_rc2.c" 3 4
((void *)0) 
# 42 "../crypto/evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_cbc(void) { return &rc2_cbc; } static const EVP_CIPHER rc2_cfb64 = { 39, 1, 16, 8, 0x8 | 0x40 | 0x3, 1, rc2_init_key, rc2_cfb64_cipher, 
# 42 "../crypto/evp/e_rc2.c" 3 4
((void *)0)
# 42 "../crypto/evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
((void *)0) 
# 42 "../crypto/evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_cfb64(void) { return &rc2_cfb64; } static const EVP_CIPHER rc2_ofb = { 40, 1, 16, 8, 0x8 | 0x40 | 0x4, 1, rc2_init_key, rc2_ofb_cipher, 
# 42 "../crypto/evp/e_rc2.c" 3 4
((void *)0)
# 42 "../crypto/evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
((void *)0) 
# 42 "../crypto/evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_ofb(void) { return &rc2_ofb; } static const EVP_CIPHER rc2_ecb = { 38, 8, 16, 0, 0x8 | 0x40 | 0x1, 1, rc2_init_key, rc2_ecb_cipher, 
# 42 "../crypto/evp/e_rc2.c" 3 4
((void *)0)
# 42 "../crypto/evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
# 59 "../crypto/evp/e_rc2.c" 3 4
   ((void *)0)
# 59 "../crypto/evp/e_rc2.c"
       ,
    sizeof(EVP_RC2_KEY),
...
# 64 "../crypto/evp/e_rc2.c" 3 4
   ((void *)0)

# 65 "../crypto/evp/e_rc2.c"
};
...
# 74 "../crypto/evp/e_rc2.c" 3 4
   ((void *)0)
# 74 "../crypto/evp/e_rc2.c"
       ,
    sizeof(EVP_RC2_KEY),
    rc2_set_asn1_type_and_iv,
    rc2_get_asn1_type_and_iv,
...
# 79 "../crypto/evp/e_rc2.c" 3 4
   ((void *)0)

# 80 "../crypto/evp/e_rc2.c"
};
...
static int rc2_init_key(EVP_CIPHER_CTX *ctx, const unsigned char *key,
                        const unsigned char *iv, int enc)
{
    RC2_set_key(&((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_get_key_length(ctx),
                key, ((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->key_bits);
    return 1;
}
...
static int rc2_meth_to_magic(EVP_CIPHER_CTX *e)
{
    ...
    if (EVP_CIPHER_CTX_ctrl(e, 0x2, 0, &i) <= 0)
        return 0;
    if (i == 128)
        return 0x3a;
    else if (i == 64)
...
static int rc2_magic_to_meth(int i)
{
    if (i == 0x3a)
        ...
        (ERR_new(), ERR_set_debug("../crypto/evp/e_rc2.c",125,__func__), ERR_set_error)((6),(108),
# 125 "../crypto/evp/e_rc2.c" 3 4
       ((void *)0)
# 125 "../crypto/evp/e_rc2.c"
       );
        return 0;
    }
}
...
static int rc2_get_asn1_type_and_iv(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
    ...
    if (type != 
# 138 "../crypto/evp/e_rc2.c" 3 4
               ((void *)0)
# 138 "../crypto/evp/e_rc2.c"
                   ) {
        l = EVP_CIPHER_CTX_get_iv_length(c);
        (void)((l <= sizeof(iv)) ? 0 : (OPENSSL_die("assertion failed: " "l <= sizeof(iv)", "../crypto/evp/e_rc2.c", 140), 1));
...
# 147 "../crypto/evp/e_rc2.c" 3 4
                                          ((void *)0)
# 147 "../crypto/evp/e_rc2.c"
                                              , 
# 147 "../crypto/evp/e_rc2.c" 3 4
                                                ((void *)0)
# 147 "../crypto/evp/e_rc2.c"
...
# 147 "../crypto/evp/e_rc2.c"
                                                          , iv, -1))
            return -1;
        if (EVP_CIPHER_CTX_ctrl(c, 0x3, key_bits,
                                
# 150 "../crypto/evp/e_rc2.c" 3 4
                               ((void *)0)
# 150 "../crypto/evp/e_rc2.c"
                                   ) <= 0
...
static int rc2_set_asn1_type_and_iv(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
    ...
    if (type != 
# 162 "../crypto/evp/e_rc2.c" 3 4
               ((void *)0)
# 162 "../crypto/evp/e_rc2.c"
                   ) {
...
static int rc2_ctrl(EVP_CIPHER_CTX *c, int type, int arg, void *ptr)
{
    switch (type) {
    case 0x0:
        ((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(c))->key_bits = EVP_CIPHER_CTX_get_key_length(c) * 8;
        return 1;

    case 0x2:
        *(int *)ptr = ((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(c))->key_bits;
        return 1;

    case 0x3:
        if (arg > 0) {
            ((EVP_RC2_KEY *)EVP_CIPHER_CTX_get_cipher_data(c))->key_bits = arg;
            return 1;
        }
        return 0;
