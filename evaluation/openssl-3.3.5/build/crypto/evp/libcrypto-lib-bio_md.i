# 0 "../crypto/evp/bio_md.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/bio_md.c"
# 10 "../crypto/evp/bio_md.c"
...
# 35 "../crypto/evp/bio_md.c" 3 4
   ((void *)0)
# 35 "../crypto/evp/bio_md.c"
       ,
    md_gets,
    md_ctrl,
    md_new,
...
static int md_new(BIO *bi)
{
    ...
    ctx = EVP_MD_CTX_new();
    if (ctx == 
# 53 "../crypto/evp/bio_md.c" 3 4
              ((void *)0)
# 53 "../crypto/evp/bio_md.c"
                  )
        return 0;
...
{
    if (a == 
# 64 "../crypto/evp/bio_md.c" 3 4
            ((void *)0)
# 64 "../crypto/evp/bio_md.c"
                )
        return 0;
    EVP_MD_CTX_free(BIO_get_data(a));
    BIO_set_data(a, 
# 67 "../crypto/evp/bio_md.c" 3 4
                   ((void *)0)
# 67 "../crypto/evp/bio_md.c"
                       );
    BIO_set_init(a, 0);
...
static int md_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 79 "../crypto/evp/bio_md.c" 3 4
              ((void *)0)
# 79 "../crypto/evp/bio_md.c"
                  )
        return 0;
    ...
    if ((ctx == 
# 85 "../crypto/evp/bio_md.c" 3 4
               ((void *)0)
# 85 "../crypto/evp/bio_md.c"
                   ) || (next == 
# 85 "../crypto/evp/bio_md.c" 3 4
                                 ((void *)0)
# 85 "../crypto/evp/bio_md.c"
...
static int md_write(BIO *b, const char *in, int inl)
{
    ...
    if ((in == 
# 107 "../crypto/evp/bio_md.c" 3 4
              ((void *)0)
# 107 "../crypto/evp/bio_md.c"
                  ) || (inl <= 0))
        return 0;
    ...
    next = BIO_next(b);
    if ((ctx != 
# 112 "../crypto/evp/bio_md.c" 3 4
               ((void *)0)
# 112 "../crypto/evp/bio_md.c"
                   ) && (next != 
# 112 "../crypto/evp/bio_md.c" 3 4
                                 ((void *)0)
# 112 "../crypto/evp/bio_md.c"
    ...
    if (next != 
# 124 "../crypto/evp/bio_md.c" 3 4
               ((void *)0)
# 124 "../crypto/evp/bio_md.c"
                   ) {
        BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
        BIO_copy_next_retry(b);
    }
...
static long md_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 1:
        if (BIO_get_init(b))
            ret = EVP_DigestInit_ex(ctx, EVP_MD_CTX_get0_md(ctx), 
# 146 "../crypto/evp/bio_md.c" 3 4
                                                                 ((void *)0)
# 146 "../crypto/evp/bio_md.c"
                                                                     );
        else
            ret = 0;
        if (ret > 0)
...
# 178 "../crypto/evp/bio_md.c" 3 4
                                        ((void *)0)
# 178 "../crypto/evp/bio_md.c"
                                            );
        if (ret > 0)
            BIO_set_init(b, 1);
        break;
...
static long md_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    ...
    if (next == 
# 202 "../crypto/evp/bio_md.c" 3 4
               ((void *)0)
# 202 "../crypto/evp/bio_md.c"
                   )
        return 0;
...
static int md_gets(BIO *bp, char *buf, int size)
{
    ...
    if (size < EVP_MD_get_size(EVP_MD_CTX_get0_md(ctx)))
        return 0;
