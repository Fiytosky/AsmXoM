# 0 "../crypto/evp/dsa_ctrl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/dsa_ctrl.c"
# 10 "../crypto/evp/dsa_ctrl.c"
...
# 11 "../crypto/evp/dsa_ctrl.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../crypto/evp/dsa_ctrl.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 16 "../crypto/evp/dsa_ctrl.c" 2

static int dsa_paramgen_check(EVP_PKEY_CTX *ctx)
{
    if (ctx == 
# 19 "../crypto/evp/dsa_ctrl.c" 3 4
              ((void *)0) 
# 19 "../crypto/evp/dsa_ctrl.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/evp/dsa_ctrl.c",20,__func__), ERR_set_error)((6),(147),
# 20 "../crypto/evp/dsa_ctrl.c" 3 4
       ((void *)0)
# 20 "../crypto/evp/dsa_ctrl.c"
       );
    ...
    if (ctx->pmeth != 
# 25 "../crypto/evp/dsa_ctrl.c" 3 4
                     ((void *)0) 
# 25 "../crypto/evp/dsa_ctrl.c"
                          && ctx->pmeth->pkey_id != 116)
        return -1;
    return 1;
}
                                           ...
                                           const char *md_properties)
{
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)md_name, 0);
    if (md_properties != 
# 118 "../crypto/evp/dsa_ctrl.c" 3 4
                        ((void *)0)
# 118 "../crypto/evp/dsa_ctrl.c"
                            )
...
int EVP_PKEY_CTX_set_dsa_paramgen_md(EVP_PKEY_CTX *ctx, const EVP_MD *md)
{
    return EVP_PKEY_CTX_ctrl(ctx, 116, (1<<1),
                             (0x1000 + 3), 0, (void *)(md));
}
