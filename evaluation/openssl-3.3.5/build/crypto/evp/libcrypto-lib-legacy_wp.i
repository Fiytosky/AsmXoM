# 0 "../crypto/evp/legacy_wp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/legacy_wp.c"
# 14 "../crypto/evp/legacy_wp.c"
...
# 23 "../include/openssl/whrlpool.h" 2
...
# 24 "../include/openssl/whrlpool.h" 2
# 35 "../include/openssl/whrlpool.h"
...
extern int WHIRLPOOL_Init(WHIRLPOOL_CTX *c);
extern int WHIRLPOOL_Update(WHIRLPOOL_CTX *c,
                                           const void *inp, size_t bytes);
extern void WHIRLPOOL_BitUpdate(WHIRLPOOL_CTX *c,
                                               const void *inp, size_t bits);
extern int WHIRLPOOL_Final(unsigned char *md, WHIRLPOOL_CTX *c);
extern unsigned char *WHIRLPOOL(const void *inp, size_t bytes,
                                               unsigned char *md);
# 17 "../crypto/evp/legacy_wp.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../crypto/evp/legacy_wp.c" 2
# 1 "../crypto/evp/legacy_meth.h" 1
# 19 "../crypto/evp/legacy_wp.c" 2

static int wp_init(EVP_MD_CTX *ctx) { return WHIRLPOOL_Init(EVP_MD_CTX_get0_md_data(ctx)); } static int wp_update(EVP_MD_CTX *ctx, const void *data, size_t count) { return WHIRLPOOL_Update(EVP_MD_CTX_get0_md_data(ctx), data, count); } static int wp_final(EVP_MD_CTX *ctx, unsigned char *md) { return WHIRLPOOL_Final(md, EVP_MD_CTX_get0_md_data(ctx)); }
...
static const EVP_MD whirlpool_md = {
    ...
    0,
    1,
    wp_init, wp_update, wp_final, 
# 28 "../crypto/evp/legacy_wp.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_wp.c"
   , 
# 28 "../crypto/evp/legacy_wp.c" 3 4
   ((void *)0)
# 28 "../crypto/evp/legacy_wp.c"
