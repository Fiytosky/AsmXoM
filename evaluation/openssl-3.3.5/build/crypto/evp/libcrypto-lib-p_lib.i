# 0 "../crypto/evp/p_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_lib.c"
# 14 "../crypto/evp/p_lib.c"
...
# 20 "../crypto/evp/p_lib.c" 2
# 1 "../include/internal/namemap.h" 1
...
extern CMAC_CTX *CMAC_CTX_new(void);
extern void CMAC_CTX_cleanup(CMAC_CTX *ctx);
extern void CMAC_CTX_free(CMAC_CTX *ctx);
extern EVP_CIPHER_CTX *CMAC_CTX_get0_cipher_ctx(CMAC_CTX *ctx);
extern int CMAC_CTX_copy(CMAC_CTX *out, const CMAC_CTX *in);
extern int CMAC_Init(CMAC_CTX *ctx,
                                    const void *key, size_t keylen,
                                    const EVP_CIPHER *cipher, ENGINE *impl);
extern int CMAC_Update(CMAC_CTX *ctx,
                                      const void *data, size_t dlen);
extern int CMAC_Final(CMAC_CTX *ctx,
                                     unsigned char *out, size_t *poutlen);
extern int CMAC_resume(CMAC_CTX *ctx);
# 30 "../crypto/evp/p_lib.c" 2
...
OSSL_ENCODER_CTX *OSSL_ENCODER_CTX_new_for_pkey(const EVP_PKEY *pkey,
                                                ...
                                                const char *propquery);
# 36 "../crypto/evp/p_lib.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 37 "../crypto/evp/p_lib.c" 2


# 1 "../include/internal/ffc.h" 1
...
# 21 "../include/internal/ffc.h" 2
# 90 "../include/internal/ffc.h"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 41 "../crypto/evp/p_lib.c" 2
# 1 "../include/crypto/dh.h" 1
...
# 42 "../crypto/evp/p_lib.c" 2
# 1 "../include/crypto/dsa.h" 1
# 12 "../include/crypto/dsa.h"
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst, int dlen,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq);
# 44 "../crypto/evp/p_lib.c" 2

# 1 "../include/crypto/rsa.h" 1
...
int ossl_rsa_set0_all_params(RSA *r, struct stack_st_BIGNUM *primes,
                             struct stack_st_BIGNUM *exps,
                             struct stack_st_BIGNUM *coeffs);
int ossl_rsa_get0_all_params(RSA *r, struct stack_st_BIGNUM_const *primes,
                             struct stack_st_BIGNUM_const *exps,
                             struct stack_st_BIGNUM_const *coeffs);
...
# 131 "../include/crypto/rsa.h"
RSA *evp_pkey_get1_RSA_PSS(EVP_PKEY *pkey);
# 46 "../crypto/evp/p_lib.c" 2
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 49 "../crypto/evp/p_lib.c" 2

# 1 "../include/internal/provider.h" 1
# 12 "../include/internal/provider.h"
        



# 1 "../include/internal/dso.h" 1
# 12 "../include/internal/dso.h"
        


# 1 "../include/internal/dsoerr.h" 1
# 13 "../include/internal/dsoerr.h"
        
# 22 "../include/internal/dsoerr.h"
int ossl_err_load_DSO_strings(void);
# 16 "../include/internal/dso.h" 2
# 55 "../include/internal/dso.h"
typedef void (*DSO_FUNC_TYPE) (void);

typedef struct dso_st DSO;
typedef struct dso_meth_st DSO_METHOD;
# 68 "../include/internal/dso.h"
typedef char *(*DSO_NAME_CONVERTER_FUNC)(DSO *, const char *);
# 84 "../include/internal/dso.h"
...
# 162 "../include/internal/dso.h"
void *DSO_global_lookup(const char *name);
# 17 "../include/internal/provider.h" 2
# 1 "../include/internal/symhacks.h" 1
# 12 "../include/internal/symhacks.h"
        
# 18 "../include/internal/provider.h" 2
...
# 51 "../crypto/evp/p_lib.c" 2
# 1 "../crypto/evp/evp_local.h" 1
# 16 "../crypto/evp/evp_local.h"
...
struct stack_st_EVP_PBE_CTL; typedef int (*sk_EVP_PBE_CTL_compfunc)(const EVP_PBE_CTL * const *a, const EVP_PBE_CTL *const *b); typedef void (*sk_EVP_PBE_CTL_freefunc)(EVP_PBE_CTL *a); typedef EVP_PBE_CTL * (*sk_EVP_PBE_CTL_copyfunc)(const EVP_PBE_CTL *a); static __attribute__((unused)) inline int sk_EVP_PBE_CTL_num(const struct stack_st_EVP_PBE_CTL *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_value(const struct stack_st_EVP_PBE_CTL *sk, int idx) { return (EVP_PBE_CTL *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_new(sk_EVP_PBE_CTL_compfunc compare) { return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_new_null(void) { return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_new_reserve(sk_EVP_PBE_CTL_compfunc compare, int n) { return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_reserve(struct stack_st_EVP_PBE_CTL *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_EVP_PBE_CTL_free(struct stack_st_EVP_PBE_CTL *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_PBE_CTL_zero(struct stack_st_EVP_PBE_CTL *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_delete(struct stack_st_EVP_PBE_CTL *sk, int i) { return (EVP_PBE_CTL *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_delete_ptr(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr) { return (EVP_PBE_CTL *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_push(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_unshift(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_pop(struct stack_st_EVP_PBE_CTL *sk) { return (EVP_PBE_CTL *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_shift(struct stack_st_EVP_PBE_CTL *sk) { return (EVP_PBE_CTL *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_EVP_PBE_CTL_pop_free(struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_insert(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline EVP_PBE_CTL *sk_EVP_PBE_CTL_set(struct stack_st_EVP_PBE_CTL *sk, int idx, EVP_PBE_CTL *ptr) { return (EVP_PBE_CTL *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_find(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_find_ex(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_find_all(struct stack_st_EVP_PBE_CTL *sk, EVP_PBE_CTL *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_EVP_PBE_CTL_sort(struct stack_st_EVP_PBE_CTL *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_EVP_PBE_CTL_is_sorted(const struct stack_st_EVP_PBE_CTL *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_PBE_CTL * sk_EVP_PBE_CTL_dup(const struct stack_st_EVP_PBE_CTL *sk) { return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_EVP_PBE_CTL *sk_EVP_PBE_CTL_deep_copy(const struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_copyfunc copyfunc, sk_EVP_PBE_CTL_freefunc freefunc) { return (struct stack_st_EVP_PBE_CTL *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_EVP_PBE_CTL_compfunc sk_EVP_PBE_CTL_set_cmp_func(struct stack_st_EVP_PBE_CTL *sk, sk_EVP_PBE_CTL_compfunc compare) { return (sk_EVP_PBE_CTL_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }

int ossl_is_partially_overlapping(const void *ptr1, const void *ptr2, int len);

# 1 "../include/openssl/types.h" 1
# 265 "../crypto/evp/evp_local.h" 2
...
int EVP_PKEY_get_bits(const EVP_PKEY *pkey)
{
    ...
    if (pkey != 
# 66 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 66 "../crypto/evp/p_lib.c"
                   ) {
        size = pkey->cache.bits;
        if (pkey->ameth != 
# 68 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0) 
# 68 "../crypto/evp/p_lib.c"
...
# 68 "../crypto/evp/p_lib.c"
    ...
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",72,__func__), ERR_set_error)((6),(166),
# 72 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 72 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
    return size;
...
int EVP_PKEY_get_security_bits(const EVP_PKEY *pkey)
{
    ...
    if (pkey != 
# 82 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 82 "../crypto/evp/p_lib.c"
                   ) {
        size = pkey->cache.security_bits;
        if (pkey->ameth != 
# 84 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0) 
# 84 "../crypto/evp/p_lib.c"
...
# 84 "../crypto/evp/p_lib.c"
    ...
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",88,__func__), ERR_set_error)((6),(168),
# 88 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 88 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
    return size;
...
int EVP_PKEY_copy_parameters(EVP_PKEY *to, const EVP_PKEY *from)
{
    ...
    EVP_PKEY *downgraded_from = 
# 133 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0)
# 133 "../crypto/evp/p_lib.c"
                                   ;
    int ok = 0;
    ...
    if (((to)->type != 0 && (to)->keymgmt == 
# 140 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 140 "../crypto/evp/p_lib.c"
       ) && ((from)->keymgmt != 
# 140 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 140 "../crypto/evp/p_lib.c"
...
# 158 "../crypto/evp/p_lib.c"
    if (((to)->type == 0 && (to)->keymgmt == 
# 158 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 158 "../crypto/evp/p_lib.c"
       )) {
        if (((from)->type != 0 && (from)->keymgmt == 
# 159 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 159 "../crypto/evp/p_lib.c"
           )) {
    ...
    } else if (((to)->type != 0 && (to)->keymgmt == 
# 166 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 166 "../crypto/evp/p_lib.c"
              )) {
        if (to->type != from->type) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",168,__func__), ERR_set_error)((6),(101),
# 168 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 168 "../crypto/evp/p_lib.c"
           );
            goto end;
        }
    }
    ...
    if (EVP_PKEY_missing_parameters(from)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",174,__func__), ERR_set_error)((6),(103),
# 174 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 174 "../crypto/evp/p_lib.c"
       );
        goto end;
    }
    ...
    if (!EVP_PKEY_missing_parameters(to)) {
        if (EVP_PKEY_parameters_eq(to, from) == 1)
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",182,__func__), ERR_set_error)((6),(153),
# 182 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 182 "../crypto/evp/p_lib.c"
           );
        goto end;
    }
...
# 187 "../crypto/evp/p_lib.c"
        ...
        ok = evp_keymgmt_util_copy(to, (EVP_PKEY *)from, 0x04);
        goto end;
    }
# 199 "../crypto/evp/p_lib.c"
    if (to->keymgmt != 
# 199 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0) 
# 199 "../crypto/evp/p_lib.c"
                           && to->keydata == 
# 199 "../crypto/evp/p_lib.c" 3 4
...
# 199 "../crypto/evp/p_lib.c"
        ...
        void *from_keydata =
            evp_pkey_export_to_provider((EVP_PKEY *)from, 
# 202 "../crypto/evp/p_lib.c" 3 4
                                                         ((void *)0)
# 202 "../crypto/evp/p_lib.c"
                                                             , &to_keymgmt,
                                        
# 203 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 203 "../crypto/evp/p_lib.c"
                                           );
        ...
        if (from_keydata == 
# 209 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 209 "../crypto/evp/p_lib.c"
                               )
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",210,__func__), ERR_set_error)((6),(101),
# 210 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 210 "../crypto/evp/p_lib.c"
           );
        else
            ok = (to->keydata = evp_keymgmt_dup(to->keymgmt,
                                                from_keydata,
                                                0x04)) != 
# 214 "../crypto/evp/p_lib.c" 3 4
                                                                      ((void *)0)
# 214 "../crypto/evp/p_lib.c"
                                                                          ;
        goto end;
    }
    ...
    if (from->ameth != 
# 219 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0) 
# 219 "../crypto/evp/p_lib.c"
...
{
    if (pkey != 
# 228 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 228 "../crypto/evp/p_lib.c"
                   ) {
        if (pkey->keymgmt != 
# 229 "../crypto/evp/p_lib.c" 3 4
                            ((void *)0)
# 229 "../crypto/evp/p_lib.c"
                                )
            return !evp_keymgmt_util_has((EVP_PKEY *)pkey, 0x04);
        else if (pkey->ameth != 
# 231 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0) 
# 231 "../crypto/evp/p_lib.c"
...
static int evp_pkey_cmp_any(const EVP_PKEY *a, const EVP_PKEY *b,
                            int selection)
{
    EVP_KEYMGMT *keymgmt1 = 
# 245 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 245 "../crypto/evp/p_lib.c"
                               , *keymgmt2 = 
# 245 "../crypto/evp/p_lib.c" 3 4
                                             ((void *)0)
# 245 "../crypto/evp/p_lib.c"
                                                 ;
    void *keydata1 = 
# 246 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 246 "../crypto/evp/p_lib.c"
                        , *keydata2 = 
# 246 "../crypto/evp/p_lib.c" 3 4
                                      ((void *)0)
# 246 "../crypto/evp/p_lib.c"
...
# 246 "../crypto/evp/p_lib.c"
    ...
    if (!__builtin_expect(!!((((a)->keymgmt != 
# 249 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 249 "../crypto/evp/p_lib.c"
        ) || ((b)->keymgmt != 
# 249 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 249 "../crypto/evp/p_lib.c"
    ...
    if (((a)->keymgmt != 
# 253 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 253 "../crypto/evp/p_lib.c"
       ) && ((b)->keymgmt != 
# 253 "../crypto/evp/p_lib.c" 3 4
                                  ((void *)0)
# 253 "../crypto/evp/p_lib.c"
    ...
    if (((a)->type != 0 && (a)->keymgmt == 
# 260 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 260 "../crypto/evp/p_lib.c"
       )
        && !EVP_KEYMGMT_is_a(b->keymgmt, OBJ_nid2sn(a->type)))
        return -1;
    if (((b)->type != 0 && (b)->keymgmt == 
# 263 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 263 "../crypto/evp/p_lib.c"
       )
    ...
    if (keymgmt2 != 
# 277 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0) 
# 277 "../crypto/evp/p_lib.c"
                        && keymgmt2->match != 
# 277 "../crypto/evp/p_lib.c" 3 4
                                              ((void *)0)
# 277 "../crypto/evp/p_lib.c"
        ...
        tmp_keydata =
            evp_pkey_export_to_provider((EVP_PKEY *)a, 
# 279 "../crypto/evp/p_lib.c" 3 4
                                                      ((void *)0)
# 279 "../crypto/evp/p_lib.c"
                                                          , &keymgmt2, 
# 279 "../crypto/evp/p_lib.c" 3 4
                                                                       ((void *)0)
# 279 "../crypto/evp/p_lib.c"
        ...
        if (tmp_keydata != 
# 280 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 280 "../crypto/evp/p_lib.c"
                              ) {
            keymgmt1 = keymgmt2;
    ...
    if (tmp_keydata == 
# 285 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0) 
# 285 "../crypto/evp/p_lib.c"
                           && keymgmt1 != 
# 285 "../crypto/evp/p_lib.c" 3 4
                                          ((void *)0) 
# 285 "../crypto/evp/p_lib.c"
...
# 285 "../crypto/evp/p_lib.c"
        ...
        tmp_keydata =
            evp_pkey_export_to_provider((EVP_PKEY *)b, 
# 287 "../crypto/evp/p_lib.c" 3 4
                                                      ((void *)0)
# 287 "../crypto/evp/p_lib.c"
                                                          , &keymgmt1, 
# 287 "../crypto/evp/p_lib.c" 3 4
                                                                       ((void *)0)
# 287 "../crypto/evp/p_lib.c"
        ...
        if (tmp_keydata != 
# 288 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 288 "../crypto/evp/p_lib.c"
                              ) {
            keymgmt2 = keymgmt1;
    ...
    if (keymgmt1 == 
# 299 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 299 "../crypto/evp/p_lib.c"
                       )
        return -2;
...
int EVP_PKEY_parameters_eq(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (a->keymgmt != 
# 319 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0) 
# 319 "../crypto/evp/p_lib.c"
                          || b->keymgmt != 
# 319 "../crypto/evp/p_lib.c" 3 4
                                           ((void *)0)
# 319 "../crypto/evp/p_lib.c"
                                               )
        return evp_pkey_cmp_any(a, b, 0x04);


    if (a->type != b->type)
        return -1;
    if (a->ameth != 
# 325 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0) 
# 325 "../crypto/evp/p_lib.c"
                        && a->ameth->param_cmp != 
# 325 "../crypto/evp/p_lib.c" 3 4
                                                  ((void *)0)
# 325 "../crypto/evp/p_lib.c"
...
int EVP_PKEY_eq(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (a == b)
        return 1;
    if (a == 
# 347 "../crypto/evp/p_lib.c" 3 4
            ((void *)0) 
# 347 "../crypto/evp/p_lib.c"
                 || b == 
# 347 "../crypto/evp/p_lib.c" 3 4
                         ((void *)0)
# 347 "../crypto/evp/p_lib.c"
    ...
    if (a->keymgmt != 
# 350 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0) 
# 350 "../crypto/evp/p_lib.c"
                          || b->keymgmt != 
# 350 "../crypto/evp/p_lib.c" 3 4
                                           ((void *)0)
# 350 "../crypto/evp/p_lib.c"
        ...
        if (evp_keymgmt_util_has((EVP_PKEY *)a, 0x02)
            && evp_keymgmt_util_has((EVP_PKEY *)b, 0x02))
            selection |= 0x02;
        else
            selection |= ( 0x01 | 0x02 );
    ...
    if (a->ameth != 
# 365 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 365 "../crypto/evp/p_lib.c"
                       ) {
        int ret;

        if (a->ameth->param_cmp != 
# 368 "../crypto/evp/p_lib.c" 3 4
                                  ((void *)0)
# 368 "../crypto/evp/p_lib.c"
                                      ) {
        ...
        if (a->ameth->pub_cmp != 
# 374 "../crypto/evp/p_lib.c" 3 4
                                ((void *)0)
# 374 "../crypto/evp/p_lib.c"
                                    )
...
{
    EVP_PKEY *pkey = 
# 391 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 391 "../crypto/evp/p_lib.c"
                        ;
    EVP_PKEY_CTX *ctx = 
# 392 "../crypto/evp/p_lib.c" 3 4
                       ((void *)0)
# 392 "../crypto/evp/p_lib.c"
                           ;
    const EVP_PKEY_ASN1_METHOD *ameth = 
# 393 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 393 "../crypto/evp/p_lib.c"
                                           ;
    int result = 0;
    ...
    if (e == 
# 398 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 398 "../crypto/evp/p_lib.c"
                ) {
        ENGINE *tmpe = 
# 399 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 399 "../crypto/evp/p_lib.c"
                          ;

        if (strtype != 
# 401 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 401 "../crypto/evp/p_lib.c"
                          )
        ...
        if (tmpe == 
# 407 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 407 "../crypto/evp/p_lib.c"
                       )
            ameth = 
# 408 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 408 "../crypto/evp/p_lib.c"
                       ;
    ...
    if (e == 
# 414 "../crypto/evp/p_lib.c" 3 4
            ((void *)0) 
# 414 "../crypto/evp/p_lib.c"
                 && ameth == 
# 414 "../crypto/evp/p_lib.c" 3 4
                             ((void *)0)
# 414 "../crypto/evp/p_lib.c"
        ...
        ctx = EVP_PKEY_CTX_new_from_name(libctx,
                                         strtype != 
# 420 "../crypto/evp/p_lib.c" 3 4
                                                   ((void *)0) 
# 420 "../crypto/evp/p_lib.c"
                                                        ? strtype
                                                         : OBJ_nid2sn(nidtype),
                                         propq);
        if (ctx == 
# 423 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 423 "../crypto/evp/p_lib.c"
                      )
            goto err;
        ...
        if (EVP_PKEY_fromdata_init(ctx) == 1) {
            OSSL_PARAM params[] = { { 
# 428 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 428 "../crypto/evp/p_lib.c"
                                   , 0, 
# 428 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 428 "../crypto/evp/p_lib.c"
...
# 428 "../crypto/evp/p_lib.c"
            ...
            if (EVP_PKEY_fromdata(ctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params) != 1) {
                (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",437,__func__), ERR_set_error)((6),(180),
# 437 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 437 "../crypto/evp/p_lib.c"
               );
                goto err;
            }
    ...
    pkey = EVP_PKEY_new();
    if (pkey == 
# 452 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 452 "../crypto/evp/p_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",453,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 453 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 453 "../crypto/evp/p_lib.c"
       );
        goto err;
    }

    if (!pkey_set_type(pkey, e, nidtype, strtype, -1, 
# 457 "../crypto/evp/p_lib.c" 3 4
                                                     ((void *)0)
# 457 "../crypto/evp/p_lib.c"
                                                         )) {

        goto err;
    }

    if (!__builtin_expect(!!((pkey->ameth != 
# 462 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 462 "../crypto/evp/p_lib.c"
        ) != 0), 1))
        goto err;

    if (key_is_priv) {
        if (pkey->ameth->set_priv_key == 
# 466 "../crypto/evp/p_lib.c" 3 4
                                        ((void *)0)
# 466 "../crypto/evp/p_lib.c"
                                            ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",467,__func__), ERR_set_error)((6),(150),
# 467 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 467 "../crypto/evp/p_lib.c"
           );
            goto err;
        }

        if (!pkey->ameth->set_priv_key(pkey, key, len)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",472,__func__), ERR_set_error)((6),(180),
# 472 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 472 "../crypto/evp/p_lib.c"
           );
            goto err;
        }
    } else {
        if (pkey->ameth->set_pub_key == 
# 476 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 476 "../crypto/evp/p_lib.c"
                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",477,__func__), ERR_set_error)((6),(150),
# 477 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 477 "../crypto/evp/p_lib.c"
           );
            goto err;
        }

        if (!pkey->ameth->set_pub_key(pkey, key, len)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",482,__func__), ERR_set_error)((6),(180),
# 482 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 482 "../crypto/evp/p_lib.c"
           );
            goto err;
        }
    }
 ...
 err:
    if (!result) {
        EVP_PKEY_free(pkey);
        pkey = 
# 491 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 491 "../crypto/evp/p_lib.c"
                  ;
    }
    EVP_PKEY_CTX_free(ctx);
    return pkey;
...
EVP_PKEY *EVP_PKEY_new_raw_private_key_ex(OSSL_LIB_CTX *libctx,
                                          ...
                                          const unsigned char *priv, size_t len)
{
    return new_raw_key_int(libctx, keytype, propq, 0, 
# 502 "../crypto/evp/p_lib.c" 3 4
                                                                 ((void *)0)
# 502 "../crypto/evp/p_lib.c"
                                                                     , priv,
                           len, 1);
}
...
EVP_PKEY *EVP_PKEY_new_raw_private_key(int type, ENGINE *e,
                                       ...
                                       size_t len)
{
    return new_raw_key_int(
# 510 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 510 "../crypto/evp/p_lib.c"
                              , 
# 510 "../crypto/evp/p_lib.c" 3 4
                                ((void *)0)
# 510 "../crypto/evp/p_lib.c"
...
{
    return new_raw_key_int(libctx, keytype, propq, 0, 
# 517 "../crypto/evp/p_lib.c" 3 4
                                                                 ((void *)0)
# 517 "../crypto/evp/p_lib.c"
                                                                     , pub,
                           len, 0);
}
...
{
    return new_raw_key_int(
# 525 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 525 "../crypto/evp/p_lib.c"
                              , 
# 525 "../crypto/evp/p_lib.c" 3 4
                                ((void *)0)
# 525 "../crypto/evp/p_lib.c"
...
{
    const OSSL_PARAM *p = 
# 538 "../crypto/evp/p_lib.c" 3 4
                         ((void *)0)
# 538 "../crypto/evp/p_lib.c"
                             ;
    struct raw_key_details_st *raw_key = arg;

    if (raw_key->selection == 0x01) {
        if ((p = OSSL_PARAM_locate_const(params, "priv"))
                != 
# 543 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 543 "../crypto/evp/p_lib.c"
                      )
            return OSSL_PARAM_get_octet_string(p, (void **)raw_key->key,
                                               raw_key->key == 
# 545 "../crypto/evp/p_lib.c" 3 4
                                                              ((void *)0) 
# 545 "../crypto/evp/p_lib.c"
                                                                   ? 0 : *raw_key->len,
                                               raw_key->len);
    } else if (raw_key->selection == 0x02) {
        if ((p = OSSL_PARAM_locate_const(params, "pub"))
                != 
# 549 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 549 "../crypto/evp/p_lib.c"
                      )
            return OSSL_PARAM_get_octet_string(p, (void **)raw_key->key,
                                               raw_key->key == 
# 551 "../crypto/evp/p_lib.c" 3 4
                                                              ((void *)0) 
# 551 "../crypto/evp/p_lib.c"
                                                                   ? 0 : *raw_key->len,
                                               raw_key->len);
    }
...
{
    if (pkey->keymgmt != 
# 561 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 561 "../crypto/evp/p_lib.c"
                            ) {
        struct raw_key_details_st raw_key;

        raw_key.key = priv == 
# 564 "../crypto/evp/p_lib.c" 3 4
                             ((void *)0) 
# 564 "../crypto/evp/p_lib.c"
                                  ? 
# 564 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0) 
# 564 "../crypto/evp/p_lib.c"
                                         : &priv;
        raw_key.len = len;
        raw_key.selection = 0x01;

        return evp_keymgmt_util_export(pkey, 0x01,
                                       get_raw_key_details, &raw_key);
    }

    if (pkey->ameth == 
# 572 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 572 "../crypto/evp/p_lib.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",573,__func__), ERR_set_error)((6),(150),
# 573 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 573 "../crypto/evp/p_lib.c"
       );
        return 0;
    }

    if (pkey->ameth->get_priv_key == 
# 577 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0)
# 577 "../crypto/evp/p_lib.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",578,__func__), ERR_set_error)((6),(150),
# 578 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 578 "../crypto/evp/p_lib.c"
       );
        return 0;
    }

    if (!pkey->ameth->get_priv_key(pkey, priv, len)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",583,__func__), ERR_set_error)((6),(182),
# 583 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 583 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
...
{
    if (pkey->keymgmt != 
# 593 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 593 "../crypto/evp/p_lib.c"
                            ) {
        struct raw_key_details_st raw_key;

        raw_key.key = pub == 
# 596 "../crypto/evp/p_lib.c" 3 4
                            ((void *)0) 
# 596 "../crypto/evp/p_lib.c"
                                 ? 
# 596 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0) 
# 596 "../crypto/evp/p_lib.c"
                                        : &pub;
        raw_key.len = len;
        raw_key.selection = 0x02;

        return evp_keymgmt_util_export(pkey, 0x02,
                                       get_raw_key_details, &raw_key);
    }

    if (pkey->ameth == 
# 604 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 604 "../crypto/evp/p_lib.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",605,__func__), ERR_set_error)((6),(150),
# 605 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 605 "../crypto/evp/p_lib.c"
       );
        return 0;
    }

     if (pkey->ameth->get_pub_key == 
# 609 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0)
# 609 "../crypto/evp/p_lib.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",610,__func__), ERR_set_error)((6),(150),
# 610 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 610 "../crypto/evp/p_lib.c"
       );
        return 0;
    }

    if (!pkey->ameth->get_pub_key(pkey, pub, len)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",615,__func__), ERR_set_error)((6),(182),
# 615 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 615 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
                                  ...
                                  const char *propq, ENGINE *e)
{
    ...
    const char *engine_id = e != 
# 630 "../crypto/evp/p_lib.c" 3 4
                                ((void *)0) 
# 630 "../crypto/evp/p_lib.c"
                                     ? ENGINE_get_id(e) : 
# 630 "../crypto/evp/p_lib.c" 3 4
                                                          ((void *)0)
# 630 "../crypto/evp/p_lib.c"
    ...
    EVP_PKEY *pkey = 
# 633 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 633 "../crypto/evp/p_lib.c"
                        ;
    EVP_PKEY_CTX *ctx;

    if (cipher != 
# 636 "../crypto/evp/p_lib.c" 3 4
                 ((void *)0)
# 636 "../crypto/evp/p_lib.c"
                     )
        cipher_name = EVP_CIPHER_get0_name(cipher);

    if (cipher_name == 
# 639 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 639 "../crypto/evp/p_lib.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",640,__func__), ERR_set_error)((6),(180),
# 640 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 640 "../crypto/evp/p_lib.c"
       );
        return 
# 641 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 641 "../crypto/evp/p_lib.c"
                  ;
    }

    ctx = EVP_PKEY_CTX_new_from_name(libctx, "CMAC", propq);
    if (ctx == 
# 645 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 645 "../crypto/evp/p_lib.c"
                  )
        goto err;

    if (EVP_PKEY_fromdata_init(ctx) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",649,__func__), ERR_set_error)((6),(180),
# 649 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 649 "../crypto/evp/p_lib.c"
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("cipher",
                                            (char *)cipher_name, 0);
    if (propq != 
# 657 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
# 657 "../crypto/evp/p_lib.c"
                    )
        *p++ = OSSL_PARAM_construct_utf8_string("properties",
                                                (char *)propq, 0);

    if (engine_id != 
# 661 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 661 "../crypto/evp/p_lib.c"
                        )
        *p++ = OSSL_PARAM_construct_utf8_string("engine",
                                                (char *)engine_id, 0);

    *p = OSSL_PARAM_construct_end();

    if (EVP_PKEY_fromdata(ctx, &pkey, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), params) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",668,__func__), ERR_set_error)((6),(180),
# 668 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 668 "../crypto/evp/p_lib.c"
       );
        goto err;
    }
...
EVP_PKEY *EVP_PKEY_new_CMAC_key(ENGINE *e, const unsigned char *priv,
                                size_t len, const EVP_CIPHER *cipher)
{
    return new_cmac_key_int(priv, len, 
# 685 "../crypto/evp/p_lib.c" 3 4
                                      ((void *)0)
# 685 "../crypto/evp/p_lib.c"
                                          , cipher, 
# 685 "../crypto/evp/p_lib.c" 3 4
                                                    ((void *)0)
# 685 "../crypto/evp/p_lib.c"
...
int EVP_PKEY_set_type(EVP_PKEY *pkey, int type)
{
    return pkey_set_type(pkey, 
# 690 "../crypto/evp/p_lib.c" 3 4
                              ((void *)0)
# 690 "../crypto/evp/p_lib.c"
                                  , type, 
# 690 "../crypto/evp/p_lib.c" 3 4
                                          ((void *)0)
# 690 "../crypto/evp/p_lib.c"
...
{
    return pkey_set_type(pkey, 
# 695 "../crypto/evp/p_lib.c" 3 4
                              ((void *)0)
# 695 "../crypto/evp/p_lib.c"
                                  , 0, str, len, 
# 695 "../crypto/evp/p_lib.c" 3 4
                                                             ((void *)0)
# 695 "../crypto/evp/p_lib.c"
...
{
    if (e != 
# 701 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 701 "../crypto/evp/p_lib.c"
                ) {
        if (!ENGINE_init(e)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",703,__func__), ERR_set_error)((6),((38 | (0x2 << 18L))),
# 703 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 703 "../crypto/evp/p_lib.c"
           );
            return 0;
        }
        if (ENGINE_get_pkey_meth(e, pkey->type) == 
# 706 "../crypto/evp/p_lib.c" 3 4
                                                  ((void *)0)
# 706 "../crypto/evp/p_lib.c"
                                                      ) {
            ENGINE_finish(e);
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",708,__func__), ERR_set_error)((6),(156),
# 708 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 708 "../crypto/evp/p_lib.c"
           );
            return 0;
        }
    }
...
static void detect_foreign_key(EVP_PKEY *pkey)
{
    ...
    case 6:
    case 912:
        pkey->foreign = pkey->pkey.rsa != 
# 729 "../crypto/evp/p_lib.c" 3 4
                                         ((void *)0)
                        
# 730 "../crypto/evp/p_lib.c"
    ...
    case 1172:
        break;
    case 408:
        pkey->foreign = pkey->pkey.ec != 
# 736 "../crypto/evp/p_lib.c" 3 4
                                        ((void *)0)
                        
# 737 "../crypto/evp/p_lib.c"
...
# 742 "../crypto/evp/p_lib.c" 3 4
                                         ((void *)0)
                        
# 743 "../crypto/evp/p_lib.c"
                       && ossl_dsa_is_foreign(pkey->pkey.dsa);
        break;


    case 28:
        pkey->foreign = pkey->pkey.dh != 
# 748 "../crypto/evp/p_lib.c" 3 4
                                        ((void *)0)
                        
# 749 "../crypto/evp/p_lib.c"
...
int EVP_PKEY_assign(EVP_PKEY *pkey, int type, void *key)
{
    ...
    if ((key != 
# 764 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 764 "../crypto/evp/p_lib.c"
                   ) && (pktype == 408 || pktype == 1172)) {
        const EC_GROUP *group = EC_KEY_get0_group(key);

        if (group != 
# 767 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 767 "../crypto/evp/p_lib.c"
                        ) {
            ...
            if (curve == 1172 && pktype == 408)
                type = 1172;
            else if(curve != 1172 && pktype == 1172)
                type = 408;
        }
    }
    ...
    if (pkey == 
# 782 "../crypto/evp/p_lib.c" 3 4
               ((void *)0) 
# 782 "../crypto/evp/p_lib.c"
                    || !EVP_PKEY_set_type(pkey, type))
        return 0;
    ...
    return (key != 
# 788 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 788 "../crypto/evp/p_lib.c"
                      );
}
...
{
    if (pkey == 
# 794 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 794 "../crypto/evp/p_lib.c"
                   )
        return 
# 795 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 795 "../crypto/evp/p_lib.c"
                  ;

    if (!((pkey)->keymgmt != 
# 797 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 797 "../crypto/evp/p_lib.c"
        ))
        return pkey->pkey.ptr;

    return 
# 800 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 800 "../crypto/evp/p_lib.c"
              ;
}
...
# 805 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 805 "../crypto/evp/p_lib.c"
                                     ;
    if (pkey->type != 855) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",807,__func__), ERR_set_error)((6),(174),
# 807 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 807 "../crypto/evp/p_lib.c"
       );
        return 
# 808 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 808 "../crypto/evp/p_lib.c"
                  ;
    }
    os = evp_pkey_get_legacy((EVP_PKEY *)pkey);
    if (os != 
# 811 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 811 "../crypto/evp/p_lib.c"
                 ) {
        *len = os->length;
        return os->data;
    }
    return 
# 815 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 815 "../crypto/evp/p_lib.c"
              ;
}
...
{
    const ASN1_OCTET_STRING *os = 
# 821 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 821 "../crypto/evp/p_lib.c"
                                     ;
    if (pkey->type != 1061) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",823,__func__), ERR_set_error)((6),(164),
# 823 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 823 "../crypto/evp/p_lib.c"
       );
        return 
# 824 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 824 "../crypto/evp/p_lib.c"
                  ;
    }
    os = evp_pkey_get_legacy((EVP_PKEY *)pkey);
    if (os != 
# 827 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 827 "../crypto/evp/p_lib.c"
                 ) {
        *len = os->length;
        return os->data;
    }
    return 
# 831 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 831 "../crypto/evp/p_lib.c"
              ;
}
...
{
    const ASN1_OCTET_STRING *os = 
# 838 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 838 "../crypto/evp/p_lib.c"
                                     ;

    if (pkey->type != 1062) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",841,__func__), ERR_set_error)((6),(175),
# 841 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 841 "../crypto/evp/p_lib.c"
       );
        return 
# 842 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 842 "../crypto/evp/p_lib.c"
                  ;
    }
    os = evp_pkey_get_legacy((EVP_PKEY *)pkey);
    if (os != 
# 845 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 845 "../crypto/evp/p_lib.c"
                 ) {
        *len = os->length;
        return os->data;
    }
    return 
# 849 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 849 "../crypto/evp/p_lib.c"
              ;
}
...
{
    if (pkey->type != 116) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",857,__func__), ERR_set_error)((6),(129),
# 857 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 857 "../crypto/evp/p_lib.c"
       );
        return 
# 858 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 858 "../crypto/evp/p_lib.c"
                  ;
    }
...
{
    int ret = EVP_PKEY_assign((pkey),116, (key));
    if (ret)
        DSA_up_ref(key);
    return ret;
}
DSA *EVP_PKEY_get1_DSA(EVP_PKEY *pkey)
{
    ...
    if (ret != 
# 879 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 879 "../crypto/evp/p_lib.c"
                  )
        DSA_up_ref(ret);
    return ret;
}
...
static const ECX_KEY *evp_pkey_get0_ECX_KEY(const EVP_PKEY *pkey, int type)
{
    if (EVP_PKEY_get_base_id(pkey) != type) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",889,__func__), ERR_set_error)((6),(219),
# 889 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 889 "../crypto/evp/p_lib.c"
       );
        return 
# 890 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 890 "../crypto/evp/p_lib.c"
                  ;
    }
    return evp_pkey_get_legacy((EVP_PKEY *)pkey);
}
...
static ECX_KEY *evp_pkey_get1_ECX_KEY(EVP_PKEY *pkey, int type)
{
    ...
    if (ret != 
# 899 "../crypto/evp/p_lib.c" 3 4
              ((void *)0) 
# 899 "../crypto/evp/p_lib.c"
                   && !ossl_ecx_key_up_ref(ret))
        ret = 
# 900 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 900 "../crypto/evp/p_lib.c"
                 ;
    return ret;
}
...
ECX_KEY *ossl_evp_pkey_get1_X25519(EVP_PKEY *pkey) { return evp_pkey_get1_ECX_KEY(pkey, 1034); }
ECX_KEY *ossl_evp_pkey_get1_X448(EVP_PKEY *pkey) { return evp_pkey_get1_ECX_KEY(pkey, 1035); }
ECX_KEY *ossl_evp_pkey_get1_ED25519(EVP_PKEY *pkey) { return evp_pkey_get1_ECX_KEY(pkey, 1087); }
ECX_KEY *ossl_evp_pkey_get1_ED448(EVP_PKEY *pkey) { return evp_pkey_get1_ECX_KEY(pkey, 1088); }
...
{
    int ret, type;
# 941 "../crypto/evp/p_lib.c"
    if (ossl_dh_is_named_safe_prime_group(dhkey))
        type = 28;
    else
        type = DH_get0_q(dhkey) == 
# 944 "../crypto/evp/p_lib.c" 3 4
                                  ((void *)0) 
# 944 "../crypto/evp/p_lib.c"
                                       ? 28 : 920;
...
DH *evp_pkey_get0_DH_int(const EVP_PKEY *pkey)
{
    if (pkey->type != 28 && pkey->type != 920) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",956,__func__), ERR_set_error)((6),(128),
# 956 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 956 "../crypto/evp/p_lib.c"
       );
        return 
# 957 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 957 "../crypto/evp/p_lib.c"
                  ;
    }
    return evp_pkey_get_legacy((EVP_PKEY *)pkey);
}
...
DH *EVP_PKEY_get1_DH(EVP_PKEY *pkey)
{
    ...
    if (ret != 
# 971 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 971 "../crypto/evp/p_lib.c"
                  )
        DH_up_ref(ret);
    return ret;
}
...
int evp_pkey_name2type(const char *name)
{
    ...
    for (i = 0; i < (sizeof(standard_name2type)/sizeof((standard_name2type)[0])); i++) {
        if (OPENSSL_strcasecmp(name, standard_name2type[i].ptr) == 0)
            return (int)standard_name2type[i].id;
    }

    if ((type = EVP_PKEY_type(OBJ_sn2nid(name))) != 0)
        return type;
...
{
    if (pkey == 
# 1059 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1059 "../crypto/evp/p_lib.c"
                   )
        return 0;
    if (pkey->keymgmt == 
# 1061 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 1061 "../crypto/evp/p_lib.c"
                            )
...
int EVP_PKEY_type_names_do_all(const EVP_PKEY *pkey,
                               ...
                               void *data)
{
    if (!((pkey)->type != 0 || (pkey)->keymgmt != 
# 1070 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 1070 "../crypto/evp/p_lib.c"
        ))
        return 0;

    if (!((pkey)->keymgmt != 
# 1073 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 1073 "../crypto/evp/p_lib.c"
        )) {
...
{
    if (pkey->keymgmt == 
# 1084 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 1084 "../crypto/evp/p_lib.c"
                            ) {
        ...
        name = evp_keymgmt_util_query_operation_name(pkey->keymgmt,
                                                     12);
        sig = EVP_SIGNATURE_fetch(libctx, name, 
# 1111 "../crypto/evp/p_lib.c" 3 4
                                               ((void *)0)
# 1111 "../crypto/evp/p_lib.c"
                                                   );
        if (sig != 
# 1112 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1112 "../crypto/evp/p_lib.c"
                      ) {
...
{
    BIO_ctrl((*out), 80, (saved_indent), 
# 1122 "../crypto/evp/p_lib.c" 3 4
   ((void *)0)
# 1122 "../crypto/evp/p_lib.c"
   );
    if (pop_f_prefix) {
                            ...
                            long indent)
{
    ...
    *saved_indent = 0;
    if (indent > 0) {
        long i = BIO_ctrl((*out), 81, 0, 
# 1138 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
# 1138 "../crypto/evp/p_lib.c"
                );

        *saved_indent = (i < 0 ? 0 : i);
        if (BIO_ctrl((*out), 80, (indent), 
# 1141 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1141 "../crypto/evp/p_lib.c"
           ) <= 0) {
            BIO *prefbio = BIO_new(BIO_f_prefix());

            if (prefbio == 
# 1144 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 1144 "../crypto/evp/p_lib.c"
                              )
                return 0;
        ...
        if (BIO_ctrl((*out), 80, (indent), 
# 1149 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1149 "../crypto/evp/p_lib.c"
           ) <= 0) {
...
static int print_pkey(const EVP_PKEY *pkey, BIO *out, int indent,
                      ...
                      int (*legacy_print)(BIO *out, const EVP_PKEY *pkey,
                                          int indent, ASN1_PCTX *pctx),
                      ASN1_PCTX *legacy_pctx )
{
    int pop_f_prefix;
    long saved_indent;
    OSSL_ENCODER_CTX *ctx = 
# 1174 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 1174 "../crypto/evp/p_lib.c"
                               ;
    int ret = -2;
    ...
    ctx = OSSL_ENCODER_CTX_new_for_pkey(pkey, selection, "TEXT", 
# 1180 "../crypto/evp/p_lib.c" 3 4
                                                                ((void *)0)
# 1180 "../crypto/evp/p_lib.c"
                                                                    ,
                                        propquery);
    ...
    if (legacy_print != 
# 1190 "../crypto/evp/p_lib.c" 3 4
                       ((void *)0)
# 1190 "../crypto/evp/p_lib.c"
                           )
...
int EVP_PKEY_print_public(BIO *out, const EVP_PKEY *pkey,
                          int indent, ASN1_PCTX *pctx)
{
    return print_pkey(pkey, out, indent, ( ( ( 0x04 | 0x80) ) | 0x02 ), 
# 1203 "../crypto/evp/p_lib.c" 3 4
                                                             ((void *)0)
# 1203 "../crypto/evp/p_lib.c"
                                                                 ,
                      (pkey->ameth != 
# 1204 "../crypto/evp/p_lib.c" 3 4
                                     ((void *)0) 
...
int EVP_PKEY_print_private(BIO *out, const EVP_PKEY *pkey,
                           int indent, ASN1_PCTX *pctx)
{
    return print_pkey(pkey, out, indent, ( ( ( 0x04 | 0x80) ) | 0x01 ), 
# 1211 "../crypto/evp/p_lib.c" 3 4
                                                              ((void *)0)
# 1211 "../crypto/evp/p_lib.c"
                                                                  ,
                      (pkey->ameth != 
# 1212 "../crypto/evp/p_lib.c" 3 4
                                     ((void *)0) 
# 1212 "../crypto/evp/p_lib.c"
...
int EVP_PKEY_print_params(BIO *out, const EVP_PKEY *pkey,
                          int indent, ASN1_PCTX *pctx)
{
    return print_pkey(pkey, out, indent, ( ( 0x04 | 0x80) ), 
# 1219 "../crypto/evp/p_lib.c" 3 4
                                                                 ((void *)0)
# 1219 "../crypto/evp/p_lib.c"
                                                                     ,
                      (pkey->ameth != 
# 1220 "../crypto/evp/p_lib.c" 3 4
                                     ((void *)0) 
# 1220 "../crypto/evp/p_lib.c"
...
{
    int ret;
    BIO *b = BIO_new_fp(fp, 0x00);

    if (b == 
# 1231 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 1231 "../crypto/evp/p_lib.c"
                )
        return 0;
                              ...
                              int indent, ASN1_PCTX *pctx)
{
    ...
    if (b == 
# 1244 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 1244 "../crypto/evp/p_lib.c"
                )
        return 0;
                             ...
                             int indent, ASN1_PCTX *pctx)
{
    ...
    if (b == 
# 1257 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 1257 "../crypto/evp/p_lib.c"
                )
        return 0;
...
{
    if (pkey->keymgmt == 
# 1280 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 1280 "../crypto/evp/p_lib.c"
                            )
        return 0;
    switch (op) {
    case 0x3:
        {
            ...
            if (rv > 0) {
                ...
                (void)ERR_set_mark();
                md = EVP_MD_fetch(libctx, mdname, 
# 1298 "../crypto/evp/p_lib.c" 3 4
                                                 ((void *)0)
# 1298 "../crypto/evp/p_lib.c"
                                                     );
...
{
    if (pkey->ameth == 
# 1328 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1328 "../crypto/evp/p_lib.c"
                          )
        return legacy_asn1_ctrl_to_param(pkey, op, arg1, arg2);
    if (pkey->ameth->pkey_ctrl == 
# 1330 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 1330 "../crypto/evp/p_lib.c"
                                     )
        return -2;
...
{
    if (pkey == 
# 1337 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1337 "../crypto/evp/p_lib.c"
                   )
        return 0;
    return evp_pkey_asn1_ctrl(pkey, 0x3, 0, pnid);
}
...
{
    if (pkey->ameth == 
# 1345 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1345 "../crypto/evp/p_lib.c"
                          )
...

    {
        ...
        const char *name = rv > 0 ? OBJ_nid2sn(nid) : 
# 1353 "../crypto/evp/p_lib.c" 3 4
                                                     ((void *)0)
# 1353 "../crypto/evp/p_lib.c"
                                                         ;
...
int EVP_PKEY_get_group_name(const EVP_PKEY *pkey, char *gname, size_t gname_sz,
                            size_t *gname_len)
{
    return EVP_PKEY_get_utf8_string_param(pkey, "group",
                                        ...
                                        const char *name, const char *propq)
{
    int rv;
    EVP_MD_CTX *ctx = 
# 1372 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1372 "../crypto/evp/p_lib.c"
                         ;

    if ((ctx = EVP_MD_CTX_new()) == 
# 1374 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 1374 "../crypto/evp/p_lib.c"
                                       )
        return -1;

    ERR_set_mark();
    rv = EVP_DigestSignInit_ex(ctx, 
# 1378 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 1378 "../crypto/evp/p_lib.c"
                                       , name, libctx,
                               propq, pkey, 
# 1379 "../crypto/evp/p_lib.c" 3 4
                                           ((void *)0)
# 1379 "../crypto/evp/p_lib.c"
                                               );
    ERR_pop_to_mark();
...
{
    if (pkey == 
# 1389 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1389 "../crypto/evp/p_lib.c"
                   )
        return 0;
    if (((pkey)->keymgmt != 
# 1391 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1391 "../crypto/evp/p_lib.c"
       ))
        return
    ...
    if (publen > 0x7fffffff
# 1397 "../crypto/evp/p_lib.c"
                       )
        return 0;

    if (evp_pkey_asn1_ctrl(pkey, 0x9, publen,
                           (void *)pub) <= 0)
        return 0;
    return 1;
}
...
size_t EVP_PKEY_get1_encoded_public_key(EVP_PKEY *pkey, unsigned char **ppub)
{
    ...
    if (pkey == 
# 1410 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1410 "../crypto/evp/p_lib.c"
                   )
        return 0;
    if (((pkey)->keymgmt != 
# 1412 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1412 "../crypto/evp/p_lib.c"
       )) {
        size_t return_size = ((size_t)-1);
        unsigned char *buf;
...
# 1422 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 1422 "../crypto/evp/p_lib.c"
                                           , 0, &return_size);
        if (return_size == ((size_t)-1))
            return 0;

        *ppub = 
# 1426 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1426 "../crypto/evp/p_lib.c"
                   ;
        buf = CRYPTO_malloc(return_size, "../crypto/evp/p_lib.c", 1427);
        if (buf == 
# 1428 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1428 "../crypto/evp/p_lib.c"
                      )
            return 0;
        ...
        if (!EVP_PKEY_get_octet_string_param(pkey,
                                             "encoded-pub-key",
                                             buf, return_size, 
# 1433 "../crypto/evp/p_lib.c" 3 4
                                                              ((void *)0)
# 1433 "../crypto/evp/p_lib.c"
                                                                  )) {
            CRYPTO_free(buf, "../crypto/evp/p_lib.c", 1434);
            return 0;
        }
        *ppub = buf;
        return return_size;
    ...
    rv = evp_pkey_asn1_ctrl(pkey, 0xa, 0, ppub);
    if (rv <= 0)
        return 0;
    return rv;
}
...
EVP_PKEY *EVP_PKEY_new(void)
{
    EVP_PKEY *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/evp/p_lib.c", 1454);

    if (ret == 
# 1456 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1456 "../crypto/evp/p_lib.c"
                  )
        return 
# 1457 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1457 "../crypto/evp/p_lib.c"
                  ;
    ...
    if (ret->lock == 
# 1466 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 1466 "../crypto/evp/p_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1467,__func__), ERR_set_error)((6),((15 | (0x2 << 18L))),
# 1467 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1467 "../crypto/evp/p_lib.c"
       );
        goto err;
    }
    ...
    if (!CRYPTO_new_ex_data(17, ret, &ret->ex_data)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1474,__func__), ERR_set_error)((6),((15 | (0x2 << 18L))),
# 1474 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1474 "../crypto/evp/p_lib.c"
       );
        goto err;
    }
 ...
 err:
    ...
    CRYPTO_free(ret, "../crypto/evp/p_lib.c", 1483);
    return 
# 1484 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 1484 "../crypto/evp/p_lib.c"
              ;
}
# 1500 "../crypto/evp/p_lib.c"
static int pkey_set_type(EVP_PKEY *pkey, ENGINE *e, int type, const char *str,
                         int len, EVP_KEYMGMT *keymgmt)
{

    const EVP_PKEY_ASN1_METHOD *ameth = 
# 1504 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 1504 "../crypto/evp/p_lib.c"
                                           ;
    ENGINE **eptr = (e == 
# 1505 "../crypto/evp/p_lib.c" 3 4
                         ((void *)0)
# 1505 "../crypto/evp/p_lib.c"
                             ) ? &e : 
# 1505 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 1505 "../crypto/evp/p_lib.c"
    ...
    if (!__builtin_expect(!!((type == 0 || keymgmt == 
# 1512 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 1512 "../crypto/evp/p_lib.c"
        ) != 0), 1)
        || !__builtin_expect(!!((e == 
# 1513 "../crypto/evp/p_lib.c" 3 4
           ((void *)0) 
# 1513 "../crypto/evp/p_lib.c"
           || keymgmt == 
# 1513 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1513 "../crypto/evp/p_lib.c"
           ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1514,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1514 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1514 "../crypto/evp/p_lib.c"
       );
        return 0;
    }

    if (pkey != 
# 1518 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1518 "../crypto/evp/p_lib.c"
                   ) {
        int free_it = 0;


        free_it = free_it || pkey->pkey.ptr != 
# 1522 "../crypto/evp/p_lib.c" 3 4
                                              ((void *)0)
# 1522 "../crypto/evp/p_lib.c"
                                                  ;

        free_it = free_it || pkey->keydata != 
# 1524 "../crypto/evp/p_lib.c" 3 4
                                             ((void *)0)
# 1524 "../crypto/evp/p_lib.c"
                                                 ;
        if (free_it)
        ...
        if (pkey->type != 0
            && type == pkey->save_type
            && pkey->ameth != 
# 1534 "../crypto/evp/p_lib.c" 3 4
                             ((void *)0)
# 1534 "../crypto/evp/p_lib.c"
                                 )
            return 1;
        ...
        pkey->engine = 
# 1539 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1539 "../crypto/evp/p_lib.c"
                          ;
        ENGINE_finish(pkey->pmeth_engine);
        pkey->pmeth_engine = 
# 1541 "../crypto/evp/p_lib.c" 3 4
                            ((void *)0)
# 1541 "../crypto/evp/p_lib.c"
                                ;
    ...
    if (str != 
# 1546 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1546 "../crypto/evp/p_lib.c"
                  )
    ...
    if (pkey == 
# 1551 "../crypto/evp/p_lib.c" 3 4
               ((void *)0) 
# 1551 "../crypto/evp/p_lib.c"
                    && eptr != 
# 1551 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0)
# 1551 "../crypto/evp/p_lib.c"
...

    {
        ...
        check = check && ameth == 
# 1561 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
# 1561 "../crypto/evp/p_lib.c"
                                     ;

        check = check && keymgmt == 
# 1563 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 1563 "../crypto/evp/p_lib.c"
                                       ;
        if (check) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1565,__func__), ERR_set_error)((6),(156),
# 1565 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1565 "../crypto/evp/p_lib.c"
           );
            return 0;
        }
    }
    if (pkey != 
# 1569 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1569 "../crypto/evp/p_lib.c"
                   ) {
        if (keymgmt != 
# 1570 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0) 
# 1570 "../crypto/evp/p_lib.c"
                           && !EVP_KEYMGMT_up_ref(keymgmt)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1571,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1571 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1571 "../crypto/evp/p_lib.c"
           );
            return 0;
        }
        ...
        if (keymgmt == 
# 1586 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1586 "../crypto/evp/p_lib.c"
                          )
            pkey->ameth = ameth;
# 1597 "../crypto/evp/p_lib.c"
        if (ameth != 
# 1597 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 1597 "../crypto/evp/p_lib.c"
                        ) {
            if (type == 0)
        ...
        if (eptr == 
# 1604 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0) 
# 1604 "../crypto/evp/p_lib.c"
                        && e != 
# 1604 "../crypto/evp/p_lib.c" 3 4
                                ((void *)0) 
# 1604 "../crypto/evp/p_lib.c"
                                     && !ENGINE_init(e)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1605,__func__), ERR_set_error)((6),(134),
# 1605 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1605 "../crypto/evp/p_lib.c"
           );
            return 0;
        }
...
static void find_ameth(const char *name, void *data)
{
    ...
    if (pkey_set_type(
# 1626 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1626 "../crypto/evp/p_lib.c"
                         , 
# 1626 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 1626 "../crypto/evp/p_lib.c"
...
# 1627 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1627 "../crypto/evp/p_lib.c"
                         )) {
        if (str[0] == 
# 1628 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1628 "../crypto/evp/p_lib.c"
                         )
            str[0] = name;
        else if (str[1] == 
# 1630 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 1630 "../crypto/evp/p_lib.c"
                              )
            str[1] = name;
    }
...
int EVP_PKEY_set_type_by_keymgmt(EVP_PKEY *pkey, EVP_KEYMGMT *keymgmt)
{
# 1648 "../crypto/evp/p_lib.c"
    const char *str[2] = { 
# 1648 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 1648 "../crypto/evp/p_lib.c"
                              , 
# 1648 "../crypto/evp/p_lib.c" 3 4
...
# 1648 "../crypto/evp/p_lib.c"
    ...
    if (!EVP_KEYMGMT_names_do_all(keymgmt, find_ameth, &str)
            || str[1] != 
# 1651 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 1651 "../crypto/evp/p_lib.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1652,__func__), ERR_set_error)((6),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1652 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1652 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
    ...
    return pkey_set_type(pkey, 
# 1659 "../crypto/evp/p_lib.c" 3 4
                              ((void *)0)
# 1659 "../crypto/evp/p_lib.c"
                                  , 0,
                         str[0], (str[0] == 
# 1660 "../crypto/evp/p_lib.c" 3 4
                                           ((void *)0) 
# 1660 "../crypto/evp/p_lib.c"
                                           ? -1 : (int)strlen(str[0])),
                         keymgmt);
...
EVP_PKEY *EVP_PKEY_dup(EVP_PKEY *pkey)
{
    ...
    if (pkey == 
# 1684 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1684 "../crypto/evp/p_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1685,__func__), ERR_set_error)((6),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1685 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1685 "../crypto/evp/p_lib.c"
       );
        return 
# 1686 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1686 "../crypto/evp/p_lib.c"
                  ;
    }

    if ((dup_pk = EVP_PKEY_new()) == 
# 1689 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0)
# 1689 "../crypto/evp/p_lib.c"
                                        )
        return 
# 1690 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1690 "../crypto/evp/p_lib.c"
                  ;

    if (((pkey)->type == 0 && (pkey)->keymgmt == 
# 1692 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1692 "../crypto/evp/p_lib.c"
       ))
        goto done;

    if (((pkey)->keymgmt != 
# 1695 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1695 "../crypto/evp/p_lib.c"
       )) {
    ...
    if (((pkey)->type != 0 && (pkey)->keymgmt == 
# 1702 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1702 "../crypto/evp/p_lib.c"
       )) {
        const EVP_PKEY_ASN1_METHOD *ameth = pkey->ameth;

        if (ameth == 
# 1705 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0) 
# 1705 "../crypto/evp/p_lib.c"
                         || ameth->copy == 
# 1705 "../crypto/evp/p_lib.c" 3 4
                                           ((void *)0)
# 1705 "../crypto/evp/p_lib.c"
            ...
            if (pkey->pkey.ptr == 
# 1706 "../crypto/evp/p_lib.c" 3 4
                                 ((void *)0)
                
# 1707 "../crypto/evp/p_lib.c"
               && EVP_PKEY_set_type(dup_pk, pkey->type) != 0)
                goto done;
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1709,__func__), ERR_set_error)((6),(224),
# 1709 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 1709 "../crypto/evp/p_lib.c"
           );
            goto err;
        }
    ...
    if (!CRYPTO_dup_ex_data(17,
                            &dup_pk->ex_data, &pkey->ex_data))
        goto err;

    if (pkey->attributes != 
# 1724 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 1724 "../crypto/evp/p_lib.c"
                               ) {
        if ((dup_pk->attributes = ossl_x509at_dup(pkey->attributes)) == 
# 1725 "../crypto/evp/p_lib.c" 3 4
                                                                       ((void *)0)
# 1725 "../crypto/evp/p_lib.c"
                                                                           )
            goto err;
    }
    return dup_pk;
err:
    ...
    return 
# 1731 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 1731 "../crypto/evp/p_lib.c"
              ;
}
...
void evp_pkey_free_legacy(EVP_PKEY *x)
{
    ...
    ENGINE *tmpe = 
# 1737 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1737 "../crypto/evp/p_lib.c"
                      ;

    if (ameth == 
# 1739 "../crypto/evp/p_lib.c" 3 4
                ((void *)0) 
# 1739 "../crypto/evp/p_lib.c"
                     && x->legacy_cache_pkey.ptr != 
# 1739 "../crypto/evp/p_lib.c" 3 4
                                                    ((void *)0)
# 1739 "../crypto/evp/p_lib.c"
                                                        )
    ...
    if (ameth != 
# 1742 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
# 1742 "../crypto/evp/p_lib.c"
                    ) {
        if (x->legacy_cache_pkey.ptr != 
# 1743 "../crypto/evp/p_lib.c" 3 4
                                       ((void *)0)
# 1743 "../crypto/evp/p_lib.c"
                                           ) {
...
# 1748 "../crypto/evp/p_lib.c" 3 4
           ((void) (0))
# 1748 "../crypto/evp/p_lib.c"
                                      ;
            ...
            x->legacy_cache_pkey.ptr = 
# 1754 "../crypto/evp/p_lib.c" 3 4
                                      ((void *)0)
# 1754 "../crypto/evp/p_lib.c"
                                          ;
        }
        if (ameth->pkey_free != 
# 1756 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0)
# 1756 "../crypto/evp/p_lib.c"
                                   )
            ameth->pkey_free(x);
        x->pkey.ptr = 
# 1758 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1758 "../crypto/evp/p_lib.c"
                         ;
    }
    ...
    x->engine = 
# 1763 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1763 "../crypto/evp/p_lib.c"
                   ;
    ENGINE_finish(x->pmeth_engine);
    x->pmeth_engine = 
# 1765 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1765 "../crypto/evp/p_lib.c"
                         ;
...
static void evp_pkey_free_it(EVP_PKEY *x)
{
    ...
    if (x->keymgmt != 
# 1778 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1778 "../crypto/evp/p_lib.c"
                         ) {
        evp_keymgmt_freedata(x->keymgmt, x->keydata);
        EVP_KEYMGMT_free(x->keymgmt);
        x->keymgmt = 
# 1781 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 1781 "../crypto/evp/p_lib.c"
                        ;
        x->keydata = 
# 1782 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 1782 "../crypto/evp/p_lib.c"
                        ;
    }
    x->type = 0;
}
...
void EVP_PKEY_free(EVP_PKEY *x)
{
    ...
    if (x == 
# 1791 "../crypto/evp/p_lib.c" 3 4
            ((void *)0)
# 1791 "../crypto/evp/p_lib.c"
                )
        return;
    ...
    CRYPTO_free_ex_data(17, x, &x->ex_data);

    CRYPTO_THREAD_lock_free(x->lock);
    CRYPTO_FREE_REF(&x->references);

    OPENSSL_sk_pop_free(ossl_check_X509_ATTRIBUTE_sk_type(x->attributes),ossl_check_X509_ATTRIBUTE_freefunc_type(X509_ATTRIBUTE_free));

    CRYPTO_free(x, "../crypto/evp/p_lib.c", 1808);
}
...
int EVP_PKEY_get_size(const EVP_PKEY *pkey)
{
    ...
    if (pkey != 
# 1815 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 1815 "../crypto/evp/p_lib.c"
                   ) {
        size = pkey->cache.size;

        if (pkey->ameth != 
# 1818 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0) 
# 1818 "../crypto/evp/p_lib.c"
...
# 1818 "../crypto/evp/p_lib.c"
    ...
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",1823,__func__), ERR_set_error)((6),(167),
# 1823 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1823 "../crypto/evp/p_lib.c"
       );
        return 0;
    }
    return size;
...
{
    if (!((pkey)->pkey.ptr != 
# 1831 "../crypto/evp/p_lib.c" 3 4
        ((void *)0) 
# 1831 "../crypto/evp/p_lib.c"
        || (pkey)->keydata != 
# 1831 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 1831 "../crypto/evp/p_lib.c"
        ...
        return 
# 1832 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1832 "../crypto/evp/p_lib.c"
                  ;

    if (((pkey)->keymgmt != 
# 1834 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 1834 "../crypto/evp/p_lib.c"
       ) && pkey->keymgmt->description != 
# 1834 "../crypto/evp/p_lib.c" 3 4
                                                                   ((void *)0)
# 1834 "../crypto/evp/p_lib.c"
                                                                       )
    ...
    if (pkey->ameth != 
# 1837 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1837 "../crypto/evp/p_lib.c"
                          )
        return pkey->ameth->info;

    return 
# 1840 "../crypto/evp/p_lib.c" 3 4
          ((void *)0)
# 1840 "../crypto/evp/p_lib.c"
              ;
}
...
void *evp_pkey_export_to_provider(EVP_PKEY *pk, OSSL_LIB_CTX *libctx,
                                  ...
                                  const char *propquery)
{
    EVP_KEYMGMT *allocated_keymgmt = 
# 1847 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0)
# 1847 "../crypto/evp/p_lib.c"
                                        ;
    EVP_KEYMGMT *tmp_keymgmt = 
# 1848 "../crypto/evp/p_lib.c" 3 4
                              ((void *)0)
# 1848 "../crypto/evp/p_lib.c"
                                  ;
    int selection = ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) );
    void *keydata = 
# 1850 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 1850 "../crypto/evp/p_lib.c"
                       ;
    int check;

    if (pk == 
# 1853 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 1853 "../crypto/evp/p_lib.c"
                 )
        return 
# 1854 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1854 "../crypto/evp/p_lib.c"
                  ;


    check = 1;

    check = check && pk->pkey.ptr == 
# 1859 "../crypto/evp/p_lib.c" 3 4
                                    ((void *)0)
# 1859 "../crypto/evp/p_lib.c"
                                        ;

    check = check && pk->keydata == 
# 1861 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0)
# 1861 "../crypto/evp/p_lib.c"
                                       ;
    if (check)
        return 
# 1863 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 1863 "../crypto/evp/p_lib.c"
                  ;


    if (pk->pkey.ptr != 
# 1866 "../crypto/evp/p_lib.c" 3 4
                       ((void *)0)
# 1866 "../crypto/evp/p_lib.c"
                           ) {




        if (pk->ameth->dirty_cnt == 
# 1871 "../crypto/evp/p_lib.c" 3 4
                                   ((void *)0) 
# 1871 "../crypto/evp/p_lib.c"
                                        || pk->ameth->export_to == 
# 1871 "../crypto/evp/p_lib.c" 3 4
                                                                   ((void *)0)
# 1871 "../crypto/evp/p_lib.c"
            ...
            return 
# 1872 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1872 "../crypto/evp/p_lib.c"
                      ;
    }


    if (keymgmt != 
# 1876 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1876 "../crypto/evp/p_lib.c"
                      ) {
        tmp_keymgmt = *keymgmt;
        *keymgmt = 
# 1878 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1878 "../crypto/evp/p_lib.c"
                      ;
    }
    ...
    if (tmp_keymgmt == 
# 1885 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1885 "../crypto/evp/p_lib.c"
                          ) {
        EVP_PKEY_CTX *ctx = EVP_PKEY_CTX_new_from_pkey(libctx, pk, propquery);

        if (ctx == 
# 1888 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 1888 "../crypto/evp/p_lib.c"
                      )
            goto end;
        allocated_keymgmt = tmp_keymgmt = ctx->keymgmt;
        ctx->keymgmt = 
# 1891 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1891 "../crypto/evp/p_lib.c"
                          ;
        EVP_PKEY_CTX_free(ctx);
    }
    ...
    if (tmp_keymgmt == 
# 1896 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 1896 "../crypto/evp/p_lib.c"
                          )
        goto end;


    if (pk->pkey.ptr != 
# 1900 "../crypto/evp/p_lib.c" 3 4
                       ((void *)0)
# 1900 "../crypto/evp/p_lib.c"
                           ) {
        OP_CACHE_ELEM *op;
        ...
        if (pk->ameth->dirty_cnt(pk) == pk->dirty_cnt_copy) {
            ...
            op = evp_keymgmt_util_find_operation_cache(pk, tmp_keymgmt,
                                                       selection);
# 1928 "../crypto/evp/p_lib.c"
            if (op != 
# 1928 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0) 
# 1928 "../crypto/evp/p_lib.c"
                          && op->keymgmt != 
# 1928 "../crypto/evp/p_lib.c" 3 4
...
# 1928 "../crypto/evp/p_lib.c"
        ...
        if ((keydata = evp_keymgmt_newdata(tmp_keymgmt)) == 
# 1940 "../crypto/evp/p_lib.c" 3 4
                                                           ((void *)0)
# 1940 "../crypto/evp/p_lib.c"
                                                               )
            goto end;
        ...
        if (!pk->ameth->export_to(pk, keydata, tmp_keymgmt->import,
            ...
            keydata = 
# 1946 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1946 "../crypto/evp/p_lib.c"
                         ;
            goto end;
        }
        ...
        if (!EVP_KEYMGMT_up_ref(tmp_keymgmt)) {
            evp_keymgmt_freedata(tmp_keymgmt, keydata);
            keydata = 
# 1958 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1958 "../crypto/evp/p_lib.c"
                         ;
            goto end;
        }
        ...
        if (pk->ameth->dirty_cnt(pk) != pk->dirty_cnt_copy
            ...
            evp_keymgmt_freedata(tmp_keymgmt, keydata);
            keydata = 
# 1968 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1968 "../crypto/evp/p_lib.c"
                         ;
        ...
        if (op != 
# 1976 "../crypto/evp/p_lib.c" 3 4
                 ((void *)0) 
# 1976 "../crypto/evp/p_lib.c"
                      && op->keymgmt != 
# 1976 "../crypto/evp/p_lib.c" 3 4
                                        ((void *)0)
# 1976 "../crypto/evp/p_lib.c"
        ...
        if (!evp_keymgmt_util_cache_keydata(pk, tmp_keymgmt, keydata,
            ...
            evp_keymgmt_freedata(tmp_keymgmt, keydata);
            keydata = 
# 1990 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 1990 "../crypto/evp/p_lib.c"
                         ;
            goto end;
        }
    ...
    if (keydata == 
# 2010 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 2010 "../crypto/evp/p_lib.c"
                      )
        tmp_keymgmt = 
# 2011 "../crypto/evp/p_lib.c" 3 4
                     ((void *)0)
# 2011 "../crypto/evp/p_lib.c"
                         ;

    if (keymgmt != 
# 2013 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0) 
# 2013 "../crypto/evp/p_lib.c"
                       && tmp_keymgmt != 
# 2013 "../crypto/evp/p_lib.c" 3 4
                                         ((void *)0)
# 2013 "../crypto/evp/p_lib.c"
        ...
        *keymgmt = tmp_keymgmt;
        allocated_keymgmt = 
# 2015 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 2015 "../crypto/evp/p_lib.c"
                               ;
    }
...
{
    EVP_PKEY *allocpkey = 
# 2025 "../crypto/evp/p_lib.c" 3 4
                         ((void *)0)
# 2025 "../crypto/evp/p_lib.c"
                             ;

    if (!__builtin_expect(!!((dest != 
# 2027 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 2027 "../crypto/evp/p_lib.c"
        ) != 0), 1))
        return 0;

    if (((src)->pkey.ptr != 
# 2030 "../crypto/evp/p_lib.c" 3 4
       ((void *)0) 
# 2030 "../crypto/evp/p_lib.c"
       || (src)->keydata != 
# 2030 "../crypto/evp/p_lib.c" 3 4
       ((void *)0)
# 2030 "../crypto/evp/p_lib.c"
...
# 2030 "../crypto/evp/p_lib.c"
        ...
        int type = src->type;
        const char *keytype = 
# 2034 "../crypto/evp/p_lib.c" 3 4
                             ((void *)0)
# 2034 "../crypto/evp/p_lib.c"
                                 ;
        ...
        if (!__builtin_expect(!!((type != 0) != 0), 1)) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2045,__func__), ERR_set_error)(6, (259|((0x1 << 18L)|(0x2 << 18L))),
        ...
        if (*dest == 
# 2056 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 2056 "../crypto/evp/p_lib.c"
                        ) {
            allocpkey = *dest = EVP_PKEY_new();
            if (*dest == 
# 2058 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 2058 "../crypto/evp/p_lib.c"
                            ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2059,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 2059 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2059 "../crypto/evp/p_lib.c"
               );
                return 0;
            }
        } else {
        ...
        if (EVP_PKEY_set_type(*dest, type)) {
            ...
            if (keydata == 
# 2068 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 2068 "../crypto/evp/p_lib.c"
                              )
                return 1;

            if ((*dest)->ameth->import_from == 
# 2071 "../crypto/evp/p_lib.c" 3 4
                                              ((void *)0)
# 2071 "../crypto/evp/p_lib.c"
                                                  ) {
                (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2072,__func__), ERR_set_error)(6, 206,
                               "key type = %s", keytype);
            } else {
                ...
                EVP_PKEY_CTX *pctx =
                    EVP_PKEY_CTX_new_from_pkey(libctx, *dest, 
# 2082 "../crypto/evp/p_lib.c" 3 4
                                                             ((void *)0)
# 2082 "../crypto/evp/p_lib.c"
                                                                 );

                if (pctx == 
# 2084 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 2084 "../crypto/evp/p_lib.c"
                               )
                    (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2085,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 2085 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2085 "../crypto/evp/p_lib.c"
                   );

                if (pctx != 
# 2087 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
                    
# 2088 "../crypto/evp/p_lib.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2101,__func__), ERR_set_error)(6, 205,
                           "key type = %s", keytype);
        }
    }

    if (allocpkey != 
# 2106 "../crypto/evp/p_lib.c" 3 4
                    ((void *)0)
# 2106 "../crypto/evp/p_lib.c"
                        ) {
        EVP_PKEY_free(allocpkey);
        *dest = 
# 2108 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2108 "../crypto/evp/p_lib.c"
                   ;
    }
    return 0;
}
...
{
    EVP_PKEY *tmp_copy = 
# 2115 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 2115 "../crypto/evp/p_lib.c"
                            ;
    void *ret = 
# 2116 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2116 "../crypto/evp/p_lib.c"
                   ;

    if (!__builtin_expect(!!((pk != 
# 2118 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 2118 "../crypto/evp/p_lib.c"
        ) != 0), 1))
        return 
# 2119 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2119 "../crypto/evp/p_lib.c"
                  ;
    ...
    if (!((pk)->pkey.ptr != 
# 2125 "../crypto/evp/p_lib.c" 3 4
        ((void *)0) 
# 2125 "../crypto/evp/p_lib.c"
        || (pk)->keydata != 
# 2125 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 2125 "../crypto/evp/p_lib.c"
        ...
        return 
# 2126 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2126 "../crypto/evp/p_lib.c"
                  ;
    if (!((pk)->keymgmt != 
# 2127 "../crypto/evp/p_lib.c" 3 4
        ((void *)0)
# 2127 "../crypto/evp/p_lib.c"
        ))
        return pk->pkey.ptr;

    if (!CRYPTO_THREAD_read_lock(pk->lock))
        return 
# 2131 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2131 "../crypto/evp/p_lib.c"
                  ;
    ...
    if (!CRYPTO_THREAD_unlock(pk->lock))
        return 
# 2136 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2136 "../crypto/evp/p_lib.c"
                  ;

    if (ret != 
# 2138 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2138 "../crypto/evp/p_lib.c"
                  )
        return ret;
    ...
    ret = pk->legacy_cache_pkey.ptr;
    if (ret == 
# 2149 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2149 "../crypto/evp/p_lib.c"
                  ) {

        ret = pk->legacy_cache_pkey.ptr = tmp_copy->pkey.ptr;
        tmp_copy->pkey.ptr = 
# 2152 "../crypto/evp/p_lib.c" 3 4
                            ((void *)0)
# 2152 "../crypto/evp/p_lib.c"
                                ;
    }

    if (!CRYPTO_THREAD_unlock(pk->lock)) {
        ret = 
# 2156 "../crypto/evp/p_lib.c" 3 4
             ((void *)0)
# 2156 "../crypto/evp/p_lib.c"
                 ;
        goto err;
    }
                          ...
                          BIGNUM **bn)
{
    ...
    unsigned char *buf = 
# 2173 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
# 2173 "../crypto/evp/p_lib.c"
                            ;
    size_t buf_sz = 0;

    if (key_name == 
# 2176 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
        
# 2177 "../crypto/evp/p_lib.c"
       || bn == 
# 2177 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
# 2177 "../crypto/evp/p_lib.c"
                    )
        return 0;
    ...
    if (!EVP_PKEY_get_params(pkey, params)) {
        ...
        buf = CRYPTO_zalloc(buf_sz, "../crypto/evp/p_lib.c", 2191);
        if (buf == 
# 2192 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 2192 "../crypto/evp/p_lib.c"
                      )
            return 0;
        params[0].data = buf;
...
err:
    if (buf != 
# 2205 "../crypto/evp/p_lib.c" 3 4
              ((void *)0)
# 2205 "../crypto/evp/p_lib.c"
                  ) {
        if (OSSL_PARAM_modified(params))
            CRYPTO_clear_free(buf, buf_sz, "../crypto/evp/p_lib.c", 2207);
        else
            CRYPTO_free(buf, "../crypto/evp/p_lib.c", 2209);
                                    ...
                                    size_t *out_len)
{
    ...
    if (key_name == 
# 2223 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2223 "../crypto/evp/p_lib.c"
                       )
        return 0;
    ...
    if (ret2 && out_len != 
# 2230 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 2230 "../crypto/evp/p_lib.c"
                              )
                                    ...
                                    size_t *out_len)
{
    ...
    if (key_name == 
# 2242 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2242 "../crypto/evp/p_lib.c"
                       )
        return 0;
    ...
    if ((ret1 = EVP_PKEY_get_params(pkey, params)))
        ret2 = OSSL_PARAM_modified(params);
    if (ret2 && out_len != 
# 2249 "../crypto/evp/p_lib.c" 3 4
                          ((void *)0)
# 2249 "../crypto/evp/p_lib.c"
                              )
        *out_len = params[0].return_size;
    ...
    if (ret2 && str != 
# 2256 "../crypto/evp/p_lib.c" 3 4
                      ((void *)0)
# 2256 "../crypto/evp/p_lib.c"
                          )
                           ...
                           int *out)
{
    ...
    if (key_name == 
# 2267 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2267 "../crypto/evp/p_lib.c"
                       )
        return 0;
                              ...
                              size_t *out)
{
    ...
    if (key_name == 
# 2281 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2281 "../crypto/evp/p_lib.c"
                       )
        return 0;
...
int EVP_PKEY_set_int_param(EVP_PKEY *pkey, const char *key_name, int in)
{
    ...
    if (key_name == 
# 2294 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2294 "../crypto/evp/p_lib.c"
                       )
        return 0;
...
int EVP_PKEY_set_size_t_param(EVP_PKEY *pkey, const char *key_name, size_t in)
{
    ...
    if (key_name == 
# 2306 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2306 "../crypto/evp/p_lib.c"
                       )
        return 0;
                          ...
                          const BIGNUM *bn)
{
    ...
    if (key_name == 
# 2321 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
        
# 2322 "../crypto/evp/p_lib.c"
       || bn == 
# 2322 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
        
# 2323 "../crypto/evp/p_lib.c"
       || pkey == 
# 2323 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
        
# 2324 "../crypto/evp/p_lib.c"
       || !((pkey)->pkey.ptr != 
# 2324 "../crypto/evp/p_lib.c" 3 4
           ((void *)0) 
# 2324 "../crypto/evp/p_lib.c"
           || (pkey)->keydata != 
# 2324 "../crypto/evp/p_lib.c" 3 4
...
# 2324 "../crypto/evp/p_lib.c"
    ...
    bsize = ((BN_num_bits(bn)+7)/8);
    if (!__builtin_expect(!!((bsize <= (int)sizeof(buffer)) != 0), 1))
        return 0;
                                   ...
                                   const char *str)
{
    ...
    if (key_name == 
# 2343 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2343 "../crypto/evp/p_lib.c"
                       )
        return 0;
                                    ...
                                    const unsigned char *buf, size_t bsize)
{
    ...
    if (key_name == 
# 2356 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0)
# 2356 "../crypto/evp/p_lib.c"
                       )
        return 0;
...
{
    return (pkey != 
# 2367 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0) 
# 2367 "../crypto/evp/p_lib.c"
                        && ((pkey)->keymgmt != 
# 2367 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 2367 "../crypto/evp/p_lib.c"
        ...
        : 
# 2369 "../crypto/evp/p_lib.c" 3 4
         ((void *)0)
# 2369 "../crypto/evp/p_lib.c"
             ;
}
...
{
    if (pkey != 
# 2374 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2374 "../crypto/evp/p_lib.c"
                   ) {
        if (((pkey)->keymgmt != 
# 2375 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 2375 "../crypto/evp/p_lib.c"
           )) {
            pkey->dirty_cnt++;
            return evp_keymgmt_set_params(pkey->keymgmt, pkey->keydata, params);
        }
# 2392 "../crypto/evp/p_lib.c"
    }
    (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2393,__func__), ERR_set_error)((6),(163),
# 2393 "../crypto/evp/p_lib.c" 3 4
   ((void *)0)
# 2393 "../crypto/evp/p_lib.c"
   );
    return 0;
}
...
{
    return (pkey != 
# 2399 "../crypto/evp/p_lib.c" 3 4
                   ((void *)0) 
# 2399 "../crypto/evp/p_lib.c"
                        && ((pkey)->keymgmt != 
# 2399 "../crypto/evp/p_lib.c" 3 4
                           ((void *)0)
# 2399 "../crypto/evp/p_lib.c"
        ...
        : 
# 2401 "../crypto/evp/p_lib.c" 3 4
         ((void *)0)
# 2401 "../crypto/evp/p_lib.c"
             ;
}
...
{
    if (pkey != 
# 2406 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2406 "../crypto/evp/p_lib.c"
                   ) {
        if (((pkey)->keymgmt != 
# 2407 "../crypto/evp/p_lib.c" 3 4
           ((void *)0)
# 2407 "../crypto/evp/p_lib.c"
           ))
            return evp_keymgmt_get_params(pkey->keymgmt, pkey->keydata, params) > 0;

        else if (((pkey)->type != 0 && (pkey)->keymgmt == 
# 2410 "../crypto/evp/p_lib.c" 3 4
                ((void *)0)
# 2410 "../crypto/evp/p_lib.c"
                ))
            return evp_pkey_get_params_to_ctrl(pkey, params) > 0;

    }
    (ERR_new(), ERR_set_debug("../crypto/evp/p_lib.c",2414,__func__), ERR_set_error)((6),(163),
# 2414 "../crypto/evp/p_lib.c" 3 4
   ((void *)0)
# 2414 "../crypto/evp/p_lib.c"
   );
    return 0;
}
...
int EVP_PKEY_get_ec_point_conv_form(const EVP_PKEY *pkey)
{
    ...
    if (pkey == 
# 2424 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2424 "../crypto/evp/p_lib.c"
                   )
        return 0;

    if (pkey->keymgmt == 
# 2427 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
            
# 2428 "../crypto/evp/p_lib.c"
           || pkey->keydata == 
# 2428 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0)
# 2428 "../crypto/evp/p_lib.c"
                                   ) {
        ...
        if (ec == 
# 2433 "../crypto/evp/p_lib.c" 3 4
                 ((void *)0)
# 2433 "../crypto/evp/p_lib.c"
                     )
            return 0;
...
int EVP_PKEY_get_field_type(const EVP_PKEY *pkey)
{
    ...
    if (pkey == 
# 2464 "../crypto/evp/p_lib.c" 3 4
               ((void *)0)
# 2464 "../crypto/evp/p_lib.c"
                   )
        return 0;

    if (pkey->keymgmt == 
# 2467 "../crypto/evp/p_lib.c" 3 4
                        ((void *)0)
            
# 2468 "../crypto/evp/p_lib.c"
           || pkey->keydata == 
# 2468 "../crypto/evp/p_lib.c" 3 4
                               ((void *)0)
# 2468 "../crypto/evp/p_lib.c"
                                   ) {
        ...
        if (ec == 
# 2474 "../crypto/evp/p_lib.c" 3 4
                 ((void *)0)
# 2474 "../crypto/evp/p_lib.c"
                     )
            return 0;
        grp = EC_KEY_get0_group(ec);
        if (grp == 
# 2477 "../crypto/evp/p_lib.c" 3 4
                  ((void *)0)
# 2477 "../crypto/evp/p_lib.c"
                      )
            return 0;
    ...
    if (!EVP_PKEY_get_utf8_string_param(pkey, "field-type",
                                        fstr, sizeof(fstr), &fstrlen))
        return 0;

    if (strcmp(fstr, "prime-field") == 0)
        return 406;
    else if (strcmp(fstr, "characteristic-two-field"))
        return 407;
