# 0 "../crypto/evp/p_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/p_sign.c"
# 10 "../crypto/evp/p_sign.c"
                     ...
                     const char *propq)
{
    ...
    size_t sltmp;
    EVP_PKEY_CTX *pkctx = 
# 25 "../crypto/evp/p_sign.c" 3 4
                         ((void *)0)
# 25 "../crypto/evp/p_sign.c"
                             ;
    ...
    *siglen = 0;
    if (EVP_MD_CTX_test_flags(ctx, 0x0200)) {
        ...
        if (tmp_ctx == 
# 35 "../crypto/evp/p_sign.c" 3 4
                      ((void *)0)
# 35 "../crypto/evp/p_sign.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/evp/p_sign.c",36,__func__), ERR_set_error)((6),((6 | (0x2 << 18L))),
# 36 "../crypto/evp/p_sign.c" 3 4
           ((void *)0)
# 36 "../crypto/evp/p_sign.c"
           );
            return 0;
        }
    ...
    if (pkctx == 
# 52 "../crypto/evp/p_sign.c" 3 4
                ((void *)0)
# 52 "../crypto/evp/p_sign.c"
                    )
        goto err;
...
int EVP_SignFinal(EVP_MD_CTX *ctx, unsigned char *sigret,
                  unsigned int *siglen, EVP_PKEY *pkey)
{
    return EVP_SignFinal_ex(ctx, sigret, siglen, pkey, 
# 70 "../crypto/evp/p_sign.c" 3 4
                                                      ((void *)0)
# 70 "../crypto/evp/p_sign.c"
                                                          , 
# 70 "../crypto/evp/p_sign.c" 3 4
                                                            ((void *)0)
# 70 "../crypto/evp/p_sign.c"
