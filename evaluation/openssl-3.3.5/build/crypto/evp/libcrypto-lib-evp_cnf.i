# 0 "../crypto/evp/evp_cnf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/evp_cnf.c"
# 10 "../crypto/evp/evp_cnf.c"
...
# 32 "../crypto/evp/evp_cnf.c" 3 4
                                                        ((void *)0)
# 32 "../crypto/evp/evp_cnf.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/evp/evp_cnf.c",33,__func__), ERR_set_error)((6),(165),
# 33 "../crypto/evp/evp_cnf.c" 3 4
       ((void *)0)
# 33 "../crypto/evp/evp_cnf.c"
       );
        return 0;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sktmp)); i++) {
        oval = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sktmp), (i)));
        if (strcmp(oval->name, "fips_mode") == 0) {
            ...
            if (!evp_default_properties_enable_fips_int(
                ...
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_cnf.c",51,__func__), ERR_set_error)((6),(209),
# 51 "../crypto/evp/evp_cnf.c" 3 4
               ((void *)0)
# 51 "../crypto/evp/evp_cnf.c"
               );
                return 0;
            }
            ...
            if (!evp_set_default_properties_int(NCONF_get0_libctx((CONF *)cnf),
                        oval->value, 0, 0)) {
                (ERR_new(), ERR_set_debug("../crypto/evp/evp_cnf.c",57,__func__), ERR_set_error)((6),(209),
# 57 "../crypto/evp/evp_cnf.c" 3 4
               ((void *)0)
# 57 "../crypto/evp/evp_cnf.c"
               );
                return 0;
            }
        } else {
            (ERR_new(), ERR_set_debug("../crypto/evp/evp_cnf.c",61,__func__), ERR_set_error)(6, 169,
