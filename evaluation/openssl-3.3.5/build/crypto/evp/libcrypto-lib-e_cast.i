# 0 "../crypto/evp/e_cast.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/evp/e_cast.c"
# 14 "../crypto/evp/e_cast.c"
...
static int cast5_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { CAST_cbc_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) CAST_cbc_encrypt(in, out, (long)inl, &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int cast5_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk = ((size_t)1 << 30); if (64 == 1) chunk >>= 3; if (inl < chunk) chunk = inl; while (inl && inl >= chunk) { int num = EVP_CIPHER_CTX_get_num(ctx); CAST_cfb64_encrypt(in, out, (long) ((64 == 1) && !EVP_CIPHER_CTX_test_flags(ctx, 0x2000) ? chunk*8 : chunk), &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num, EVP_CIPHER_CTX_is_encrypting(ctx)); EVP_CIPHER_CTX_set_num(ctx, num); inl -= chunk; in += chunk; out += chunk; if (inl < chunk) chunk = inl; } return 1;} static int cast5_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = EVP_CIPHER_CTX_get0_cipher(ctx)->block_size; if (inl < bl) return 1; inl -= bl; for (i=0; i <= inl; i+=bl) CAST_ecb_encrypt(in + i, out + i, &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, EVP_CIPHER_CTX_is_encrypting(ctx)); return 1;} static int cast5_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1 << 30)) { int num = EVP_CIPHER_CTX_get_num(ctx); CAST_ofb64_encrypt(in, out, (long)((size_t)1 << 30), &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); inl-=((size_t)1 << 30); in +=((size_t)1 << 30); out+=((size_t)1 << 30); } if (inl) { int num = EVP_CIPHER_CTX_get_num(ctx); CAST_ofb64_encrypt(in, out, (long)inl, &((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, ctx->iv, &num); EVP_CIPHER_CTX_set_num(ctx, num); } return 1;} static const EVP_CIPHER cast5_cbc = { 108, 8, 16, 8, 0x8 | 0x2, 1, cast_init_key, cast5_cbc_cipher, 
# 35 "../crypto/evp/e_cast.c" 3 4
((void *)0)
# 35 "../crypto/evp/e_cast.c"
...
((void *)0) 
# 35 "../crypto/evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_cbc(void) { return &cast5_cbc; } static const EVP_CIPHER cast5_cfb64 = { 110, 1, 16, 8, 0x8 | 0x3, 1, cast_init_key, cast5_cfb64_cipher, 
# 35 "../crypto/evp/e_cast.c" 3 4
((void *)0)
# 35 "../crypto/evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 35 "../crypto/evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_cfb64(void) { return &cast5_cfb64; } static const EVP_CIPHER cast5_ofb = { 111, 1, 16, 8, 0x8 | 0x4, 1, cast_init_key, cast5_ofb_cipher, 
# 35 "../crypto/evp/e_cast.c" 3 4
((void *)0)
# 35 "../crypto/evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 35 "../crypto/evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_ofb(void) { return &cast5_ofb; } static const EVP_CIPHER cast5_ecb = { 109, 8, 16, 0, 0x8 | 0x1, 1, cast_init_key, cast5_ecb_cipher, 
# 35 "../crypto/evp/e_cast.c" 3 4
((void *)0)
# 35 "../crypto/evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
                         ...
                         const unsigned char *iv, int enc)
{
    ...
    if (keylen <= 0)
        return 0;
    CAST_set_key(&((EVP_CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, keylen, key);
    return 1;
}
