...
char *CRYPTO_strdup(const char *str, const char* file, int line)
{
    ...
    if (str == 
# 25 "../crypto/o_str.c" 3 4
              ((void *)0)
# 25 "../crypto/o_str.c"
                  )
        return 
# 26 "../crypto/o_str.c" 3 4
              ((void *)0)
# 26 "../crypto/o_str.c"
                  ;
    ret = CRYPTO_malloc(strlen(str) + 1, file, line);
    if (ret != 
# 28 "../crypto/o_str.c" 3 4
              ((void *)0)
# 28 "../crypto/o_str.c"
                  )
        strcpy(ret, str);
...
char *CRYPTO_strndup(const char *str, size_t s, const char* file, int line)
{
    ...
    if (str == 
# 38 "../crypto/o_str.c" 3 4
              ((void *)0)
# 38 "../crypto/o_str.c"
                  )
        return 
# 39 "../crypto/o_str.c" 3 4
              ((void *)0)
# 39 "../crypto/o_str.c"
                  ;
...
# 56 "../crypto/o_str.c"
    ...
    if (ret == 
# 59 "../crypto/o_str.c" 3 4
              ((void *)0)
# 59 "../crypto/o_str.c"
                  )
        return 
# 60 "../crypto/o_str.c" 3 4
              ((void *)0)
# 60 "../crypto/o_str.c"
                  ;
                          ...
                          const char *str, const char sep)
{
    ...
    for (p = (const unsigned char *)str, q = buf, cnt = 0; *p; ) {
        ...
        cl = *p++;
        if (!cl) {
            (ERR_new(), ERR_set_debug("../crypto/o_str.c",152,__func__), ERR_set_error)((15),(103),
# 152 "../crypto/o_str.c" 3 4
           ((void *)0)
# 152 "../crypto/o_str.c"
           );
            return 0;
        ...
        if (cli < 0 || chi < 0) {
            (ERR_new(), ERR_set_debug("../crypto/o_str.c",158,__func__), ERR_set_error)((15),(102),
# 158 "../crypto/o_str.c" 3 4
           ((void *)0)
# 158 "../crypto/o_str.c"
           );
            return 0;
        ...
        cnt++;
        if (q != 
# 162 "../crypto/o_str.c" 3 4
                ((void *)0)
# 162 "../crypto/o_str.c"
                    ) {
            if (cnt > buf_n) {
                (ERR_new(), ERR_set_debug("../crypto/o_str.c",164,__func__), ERR_set_error)((15),(116),
# 164 "../crypto/o_str.c" 3 4
               ((void *)0)
# 164 "../crypto/o_str.c"
               );
                return 0;
                                   ...
                                   const char sep)
{
    ...
    buf_n = strlen(str);
    if (buf_n <= 1) {
        (ERR_new(), ERR_set_debug("../crypto/o_str.c",193,__func__), ERR_set_error)((15),(121),
# 193 "../crypto/o_str.c" 3 4
       ((void *)0)
# 193 "../crypto/o_str.c"
       );
        return 
# 194 "../crypto/o_str.c" 3 4
              ((void *)0)
# 194 "../crypto/o_str.c"
                  ;
    }
    buf_n /= 2;
    if ((buf = CRYPTO_malloc(buf_n, "../crypto/o_str.c", 197)) == 
# 197 "../crypto/o_str.c" 3 4
                                        ((void *)0)
# 197 "../crypto/o_str.c"
                                            )
        return 
# 198 "../crypto/o_str.c" 3 4
              ((void *)0)
# 198 "../crypto/o_str.c"
                  ;

    if (buflen != 
# 200 "../crypto/o_str.c" 3 4
                 ((void *)0)
# 200 "../crypto/o_str.c"
                     )
        *buflen = 0;
...
# 204 "../crypto/o_str.c"
    ...
    CRYPTO_free(buf, "../crypto/o_str.c", 208);
    return 
# 209 "../crypto/o_str.c" 3 4
          ((void *)0)
# 209 "../crypto/o_str.c"
              ;
}
...
unsigned char *OPENSSL_hexstr2buf(const char *str, long *buflen)
{
    return ossl_hexstr2buf_sep(str, buflen, ':');
}
                          ...
                          const char sep)
{
    ...
    if (len == 0)
        ++len;
    if (strlength != 
# 230 "../crypto/o_str.c" 3 4
                    ((void *)0)
# 230 "../crypto/o_str.c"
                        )
        *strlength = len;
    if (str == 
# 232 "../crypto/o_str.c" 3 4
              ((void *)0)
# 232 "../crypto/o_str.c"
                  )
        return 1;
    ...
    if (str_n < len) {
        (ERR_new(), ERR_set_debug("../crypto/o_str.c",236,__func__), ERR_set_error)((15),(116),
# 236 "../crypto/o_str.c" 3 4
       ((void *)0)
# 236 "../crypto/o_str.c"
       );
        return 0;
...
char *ossl_buf2hexstr_sep(const unsigned char *buf, long buflen, char sep)
{
    ...
    if (buflen == 0)
        return CRYPTO_zalloc(1, "../crypto/o_str.c", 270);

    tmp_n = (sep != '\0') ? buflen * 3 : 1 + buflen * 2;
    if ((tmp = CRYPTO_malloc(tmp_n, "../crypto/o_str.c", 273)) == 
# 273 "../crypto/o_str.c" 3 4
                                        ((void *)0)
# 273 "../crypto/o_str.c"
                                            )
        return 
# 274 "../crypto/o_str.c" 3 4
              ((void *)0)
# 274 "../crypto/o_str.c"
                  ;

    if (buf2hexstr_sep(tmp, tmp_n, 
# 276 "../crypto/o_str.c" 3 4
                                  ((void *)0)
# 276 "../crypto/o_str.c"
                                      , buf, buflen, sep))
        return tmp;
    CRYPTO_free(tmp, "../crypto/o_str.c", 278);
    return 
# 279 "../crypto/o_str.c" 3 4
          ((void *)0)
# 279 "../crypto/o_str.c"
              ;
}
