# 0 "../crypto/ui/ui_openssl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ui/ui_openssl.c"
# 10 "../crypto/ui/ui_openssl.c"
...
# 14 "../crypto/ui/ui_openssl.c" 2
# 31 "../crypto/ui/ui_openssl.c"
...
# 32 "../crypto/ui/ui_openssl.c" 2
# 52 "../crypto/ui/ui_openssl.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 54 "../crypto/ui/ui_openssl.c" 2
# 107 "../crypto/ui/ui_openssl.c"
...
# 108 "../crypto/ui/ui_openssl.c" 2
# 131 "../crypto/ui/ui_openssl.c"
...
# 132 "../crypto/ui/ui_openssl.c" 2
# 156 "../crypto/ui/ui_openssl.c"

# 156 "../crypto/ui/ui_openssl.c"
static struct sigaction savsig[32];
# 173 "../crypto/ui/ui_openssl.c"
...
# 269 "../crypto/ui/ui_openssl.c" 3 4
                                 ((void *)0)
# 269 "../crypto/ui/ui_openssl.c"
                                     );
    return 1;
}
...
static int read_string_inner(UI *ui, UI_STRING *uis, int echo, int strip_nl)
{
    ...
    int ok;
    char result[
# 280 "../crypto/ui/ui_openssl.c" 3 4
               8192
# 280 "../crypto/ui/ui_openssl.c"
                     ];
    int maxsize = 
# 281 "../crypto/ui/ui_openssl.c" 3 4
                 8192 
# 281 "../crypto/ui/ui_openssl.c"
                        - 1;

    char *p = 
# 283 "../crypto/ui/ui_openssl.c" 3 4
             ((void *)0)
# 283 "../crypto/ui/ui_openssl.c"
                 ;
    int echo_eol = !echo;
    ...
    result[0] = '\0';
# 339 "../crypto/ui/ui_openssl.c"
    p = fgets(result, maxsize, tty_in);
    if (p == 
# 340 "../crypto/ui/ui_openssl.c" 3 4
            ((void *)0)
# 340 "../crypto/ui/ui_openssl.c"
                )
        goto error;
    if (feof(tty_in))
        goto error;
...
# 346 "../crypto/ui/ui_openssl.c" 3 4
                                             ((void *)0)
# 346 "../crypto/ui/ui_openssl.c"
                                                 ) {
        if (strip_nl)
            *p = '\0';
 ...
 error:
    if (intr_signal == 
# 355 "../crypto/ui/ui_openssl.c" 3 4
                      2
# 355 "../crypto/ui/ui_openssl.c"
                            )
        ok = -1;
    if (echo_eol)
        fprintf(tty_out, "\n");
    ...
    OPENSSL_cleanse(result, 
# 368 "../crypto/ui/ui_openssl.c" 3 4
                           8192
# 368 "../crypto/ui/ui_openssl.c"
                                 );
    return ok;
}
...
static int open_console(UI *ui)
{
    if (!CRYPTO_THREAD_write_lock(ui->lock))
        return 0;
    is_a_tty = 1;
# 399 "../crypto/ui/ui_openssl.c"
    if ((tty_in = fopen("/dev/tty", "r")) == 
# 399 "../crypto/ui/ui_openssl.c" 3 4
                                         ((void *)0)
# 399 "../crypto/ui/ui_openssl.c"
                                             )
        tty_in = 
# 400 "../crypto/ui/ui_openssl.c" 3 4
                stdin
# 400 "../crypto/ui/ui_openssl.c"
                     ;
    if ((tty_out = fopen("/dev/tty", "w")) == 
# 401 "../crypto/ui/ui_openssl.c" 3 4
                                          ((void *)0)
# 401 "../crypto/ui/ui_openssl.c"
                                              )
        tty_out = 
# 402 "../crypto/ui/ui_openssl.c" 3 4
                 stderr
# 402 "../crypto/ui/ui_openssl.c"
                       ;
    ...
    if (tcgetattr(fileno(tty_in),&tty_orig) == -1) {
        ...
        if (
# 408 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 408 "../crypto/ui/ui_openssl.c"
                 == 
# 408 "../crypto/ui/ui_openssl.c" 3 4
                    25
# 408 "../crypto/ui/ui_openssl.c"
        ...
        if (
# 417 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 417 "../crypto/ui/ui_openssl.c"
                 == 
# 417 "../crypto/ui/ui_openssl.c" 3 4
                    22
# 417 "../crypto/ui/ui_openssl.c"
        ...
        if (
# 426 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 426 "../crypto/ui/ui_openssl.c"
                 == 
# 426 "../crypto/ui/ui_openssl.c" 3 4
                    6
# 426 "../crypto/ui/ui_openssl.c"
        ...
        if (
# 435 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 435 "../crypto/ui/ui_openssl.c"
                 == 
# 435 "../crypto/ui/ui_openssl.c" 3 4
                    5
# 435 "../crypto/ui/ui_openssl.c"
        ...
        if (
# 445 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 445 "../crypto/ui/ui_openssl.c"
                 == 
# 445 "../crypto/ui/ui_openssl.c" 3 4
                    1
# 445 "../crypto/ui/ui_openssl.c"
        ...
        if (
# 454 "../crypto/ui/ui_openssl.c" 3 4
           (*__errno_location ()) 
# 454 "../crypto/ui/ui_openssl.c"
                 == 
# 454 "../crypto/ui/ui_openssl.c" 3 4
                    19
# 454 "../crypto/ui/ui_openssl.c"
            ...
            {
                (ERR_new(), ERR_set_debug("../crypto/ui/ui_openssl.c",459,__func__), ERR_set_error)(40, 108,
                               "errno=%d", 
# 460 "../crypto/ui/ui_openssl.c" 3 4
                                          (*__errno_location ())
# 460 "../crypto/ui/ui_openssl.c"
                                               );
                return 0;
            }
    }
# 482 "../crypto/ui/ui_openssl.c"
    return 1;
}
...
static int noecho_console(UI *ui)
{
    ...
    tty_new.c_lflag &= ~
# 489 "../crypto/ui/ui_openssl.c" 3 4
                         0000010
# 489 "../crypto/ui/ui_openssl.c"
                             ;



    if (is_a_tty && (tcsetattr(fileno(tty_in),
# 493 "../crypto/ui/ui_openssl.c" 3 4
                    0
# 493 "../crypto/ui/ui_openssl.c"
                    ,&tty_new) == -1))
        return 0;
# 518 "../crypto/ui/ui_openssl.c"
    return 1;
}
...
static int echo_console(UI *ui)
{
    ...
    memcpy(&(tty_new), &(tty_orig), sizeof(tty_orig));
    if (is_a_tty && (tcsetattr(fileno(tty_in),
# 525 "../crypto/ui/ui_openssl.c" 3 4
                    0
# 525 "../crypto/ui/ui_openssl.c"
                    ,&tty_new) == -1))
        return 0;
# 549 "../crypto/ui/ui_openssl.c"
    return 1;
}
...
static int close_console(UI *ui)
{
    ...
    if (tty_in != 
# 556 "../crypto/ui/ui_openssl.c" 3 4
                 stdin
# 556 "../crypto/ui/ui_openssl.c"
                      )
        fclose(tty_in);
    if (tty_out != 
# 558 "../crypto/ui/ui_openssl.c" 3 4
                  stderr
# 558 "../crypto/ui/ui_openssl.c"
                        )
        fclose(tty_out);
# 568 "../crypto/ui/ui_openssl.c"
...
static void pushsig(void)
{
    ...
    sa.
# 584 "../crypto/ui/ui_openssl.c" 3 4
      __sigaction_handler.sa_handler 
# 584 "../crypto/ui/ui_openssl.c"
                 = recsig;
# 595 "../crypto/ui/ui_openssl.c"
    for (i = 1; i < 32; i++) {

        if (i == 
# 597 "../crypto/ui/ui_openssl.c" 3 4
                10
# 597 "../crypto/ui/ui_openssl.c"
                       )
            continue;


        if (i == 
# 601 "../crypto/ui/ui_openssl.c" 3 4
                12
# 601 "../crypto/ui/ui_openssl.c"
                       )
            continue;


        if (i == 
# 605 "../crypto/ui/ui_openssl.c" 3 4
                9
# 605 "../crypto/ui/ui_openssl.c"
                       )
            continue;
    ...
    signal(
# 617 "../crypto/ui/ui_openssl.c" 3 4
          28
# 617 "../crypto/ui/ui_openssl.c"
                  , 
# 617 "../crypto/ui/ui_openssl.c" 3 4
                    ((__sighandler_t) 0)
# 617 "../crypto/ui/ui_openssl.c"
...
static void popsig(void)
{
# 631 "../crypto/ui/ui_openssl.c"
    int i;
    for (i = 1; i < 32; i++) {

        if (i == 
# 634 "../crypto/ui/ui_openssl.c" 3 4
                10
# 634 "../crypto/ui/ui_openssl.c"
                       )
            continue;


        if (i == 
# 638 "../crypto/ui/ui_openssl.c" 3 4
                12
# 638 "../crypto/ui/ui_openssl.c"
                       )
            continue;


        sigaction(i, &savsig[i], 
# 642 "../crypto/ui/ui_openssl.c" 3 4
                                ((void *)0)
# 642 "../crypto/ui/ui_openssl.c"
                                    );
...
# 700 "../crypto/ui/ui_openssl.c"
static UI_METHOD ui_openssl = {
    "OpenSSL default user interface",
    open_console,
    write_string,
    
# 704 "../crypto/ui/ui_openssl.c" 3 4
   ((void *)0)
# 704 "../crypto/ui/ui_openssl.c"
       ,
    read_string,
    close_console,
    
# 707 "../crypto/ui/ui_openssl.c" 3 4
   ((void *)0)

# 708 "../crypto/ui/ui_openssl.c"
};
