# 0 "../crypto/ui/ui_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ui/ui_lib.c"
# 10 "../crypto/ui/ui_lib.c"
...
# 15 "../crypto/ui/ui_lib.c" 2

# 1 "../crypto/ui/ui_local.h" 1
# 20 "../crypto/ui/ui_local.h"
struct ui_method_st {
    char *name;
# 31 "../crypto/ui/ui_local.h"
...
# 17 "../crypto/ui/ui_lib.c" 2

UI *UI_new(void)
{
    return UI_new_method(
# 20 "../crypto/ui/ui_lib.c" 3 4
                        ((void *)0)
# 20 "../crypto/ui/ui_lib.c"
                            );
}

UI *UI_new_method(const UI_METHOD *method)
{
    UI *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ui/ui_lib.c", 25);

    if (ret == 
# 27 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 27 "../crypto/ui/ui_lib.c"
                  )
        return 
# 28 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 28 "../crypto/ui/ui_lib.c"
                  ;

    ret->lock = CRYPTO_THREAD_lock_new();
    if (ret->lock == 
# 31 "../crypto/ui/ui_lib.c" 3 4
                    ((void *)0)
# 31 "../crypto/ui/ui_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",32,__func__), ERR_set_error)((40),((15 | (0x2 << 18L))),
# 32 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 32 "../crypto/ui/ui_lib.c"
       );
        CRYPTO_free(ret, "../crypto/ui/ui_lib.c", 33);
        return 
# 34 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 34 "../crypto/ui/ui_lib.c"
                  ;
    }

    if (method == 
# 37 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 37 "../crypto/ui/ui_lib.c"
                     )
        method = UI_get_default_method();
    if (method == 
# 39 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 39 "../crypto/ui/ui_lib.c"
                     )
        method = UI_null();
    ret->meth = method;

    if (!CRYPTO_new_ex_data(11, ret, &ret->ex_data)) {
        UI_free(ret);
        return 
# 45 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 45 "../crypto/ui/ui_lib.c"
                  ;
    }
    return ret;
}
...
{
    if (uis->flags & 0x01) {
        CRYPTO_free((char *)uis->out_string, "../crypto/ui/ui_lib.c", 53);
        switch (uis->type) {
        case UIT_BOOLEAN:
            CRYPTO_free((char *)uis->_.boolean_data.action_desc, "../crypto/ui/ui_lib.c", 56);
            CRYPTO_free((char *)uis->_.boolean_data.ok_chars, "../crypto/ui/ui_lib.c", 57);
            CRYPTO_free((char *)uis->_.boolean_data.cancel_chars, "../crypto/ui/ui_lib.c", 58);
            break;
        case UIT_NONE:
        case UIT_PROMPT:
        case UIT_VERIFY:
    ...
    CRYPTO_free(uis, "../crypto/ui/ui_lib.c", 68);
}

void UI_free(UI *ui)
{
    if (ui == 
# 73 "../crypto/ui/ui_lib.c" 3 4
             ((void *)0)
# 73 "../crypto/ui/ui_lib.c"
                 )
        return;
    if ((ui->flags & 0x0002) != 0) {
        ui->meth->ui_destroy_data(ui, ui->user_data);
    }
    OPENSSL_sk_pop_free(ossl_check_UI_STRING_sk_type(ui->strings),ossl_check_UI_STRING_freefunc_type(free_string));
    CRYPTO_free_ex_data(11, ui, &ui->ex_data);
    CRYPTO_THREAD_lock_free(ui->lock);
    CRYPTO_free(ui, "../crypto/ui/ui_lib.c", 81);
}

static int allocate_string_stack(UI *ui)
{
    if (ui->strings == 
# 86 "../crypto/ui/ui_lib.c" 3 4
                      ((void *)0)
# 86 "../crypto/ui/ui_lib.c"
                          ) {
        ui->strings = ((struct stack_st_UI_STRING *)OPENSSL_sk_new_null());
        if (ui->strings == 
# 88 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 88 "../crypto/ui/ui_lib.c"
                              ) {
            return -1;
        }
    }
...
{
    UI_STRING *ret = 
# 100 "../crypto/ui/ui_lib.c" 3 4
                    ((void *)0)
# 100 "../crypto/ui/ui_lib.c"
                        ;

    if (prompt == 
# 102 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 102 "../crypto/ui/ui_lib.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",103,__func__), ERR_set_error)((40),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 103 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 103 "../crypto/ui/ui_lib.c"
       );
    } else if ((type == UIT_PROMPT || type == UIT_VERIFY
                || type == UIT_BOOLEAN) && result_buf == 
# 105 "../crypto/ui/ui_lib.c" 3 4
                                                        ((void *)0)
# 105 "../crypto/ui/ui_lib.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",106,__func__), ERR_set_error)((40),(105),
# 106 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 106 "../crypto/ui/ui_lib.c"
       );
    } else if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ui/ui_lib.c", 107)) != 
# 107 "../crypto/ui/ui_lib.c" 3 4
                                                      ((void *)0)
# 107 "../crypto/ui/ui_lib.c"
                                                          ) {
                                   ...
                                   const char *test_buf)
{
    ...
    if (s != 
# 127 "../crypto/ui/ui_lib.c" 3 4
            ((void *)0)
# 127 "../crypto/ui/ui_lib.c"
                ) {
        if (allocate_string_stack(ui) >= 0) {
            s->_.string_data.result_minsize = minsize;
            s->_.string_data.result_maxsize = maxsize;
            s->_.string_data.test_buf = test_buf;
            ret = OPENSSL_sk_push(ossl_check_UI_STRING_sk_type(ui->strings), ossl_check_UI_STRING_type(s));
                                    ...
                                    int input_flags, char *result_buf)
{
    ...
    if (ok_chars == 
# 157 "../crypto/ui/ui_lib.c" 3 4
                   ((void *)0)
# 157 "../crypto/ui/ui_lib.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",158,__func__), ERR_set_error)((40),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 158 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 158 "../crypto/ui/ui_lib.c"
       );
    } else if (cancel_chars == 
# 159 "../crypto/ui/ui_lib.c" 3 4
                              ((void *)0)
# 159 "../crypto/ui/ui_lib.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",160,__func__), ERR_set_error)((40),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 160 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 160 "../crypto/ui/ui_lib.c"
       );
    } else {
        for (p = ok_chars; *p != '\0'; p++) {
            if (strchr(cancel_chars, *p) != 
# 163 "../crypto/ui/ui_lib.c" 3 4
                                           ((void *)0)
# 163 "../crypto/ui/ui_lib.c"
                                               ) {
                (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",164,__func__), ERR_set_error)((40),(104),
# 164 "../crypto/ui/ui_lib.c" 3 4
               ((void *)0)
# 164 "../crypto/ui/ui_lib.c"
               );
            }
        }
        ...
        if (s != 
# 171 "../crypto/ui/ui_lib.c" 3 4
                ((void *)0)
# 171 "../crypto/ui/ui_lib.c"
                    ) {
            if (allocate_string_stack(ui) >= 0) {
                        ...
                        char *result_buf, int minsize, int maxsize)
{
    return general_allocate_string(ui, prompt, 0,
                                   ...
                                   maxsize, 
# 200 "../crypto/ui/ui_lib.c" 3 4
                                           ((void *)0)
# 200 "../crypto/ui/ui_lib.c"
                                               );
}
...
{
    char *prompt_copy = 
# 207 "../crypto/ui/ui_lib.c" 3 4
                       ((void *)0)
# 207 "../crypto/ui/ui_lib.c"
                           ;
    int ret;

    if (prompt != 
# 210 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 210 "../crypto/ui/ui_lib.c"
                     ) {
        prompt_copy = CRYPTO_strdup(prompt, "../crypto/ui/ui_lib.c", 211);
        if (prompt_copy == 
# 212 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 212 "../crypto/ui/ui_lib.c"
                              )
            return 0;
    }
    ...
    ret = general_allocate_string(ui, prompt_copy, 1,
                                  UIT_PROMPT, flags, result_buf, minsize,
                                  maxsize, 
# 218 "../crypto/ui/ui_lib.c" 3 4
                                          ((void *)0)
# 218 "../crypto/ui/ui_lib.c"
                                              );
    if (ret <= 0)
        CRYPTO_free(prompt_copy, "../crypto/ui/ui_lib.c", 220);
...
{
    char *prompt_copy = 
# 238 "../crypto/ui/ui_lib.c" 3 4
                       ((void *)0)
# 238 "../crypto/ui/ui_lib.c"
                           ;
    int ret;

    if (prompt != 
# 241 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 241 "../crypto/ui/ui_lib.c"
                     ) {
        prompt_copy = CRYPTO_strdup(prompt, "../crypto/ui/ui_lib.c", 242);
        if (prompt_copy == 
# 243 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 243 "../crypto/ui/ui_lib.c"
                              )
            return -1;
    }
    ...
    ret = general_allocate_string(ui, prompt_copy, 1,
                                  ...
                                  maxsize, test_buf);
    if (ret <= 0)
        CRYPTO_free(prompt_copy, "../crypto/ui/ui_lib.c", 251);
    return ret;
}
...
{
    char *prompt_copy = 
# 268 "../crypto/ui/ui_lib.c" 3 4
                       ((void *)0)
# 268 "../crypto/ui/ui_lib.c"
                           ;
    char *action_desc_copy = 
# 269 "../crypto/ui/ui_lib.c" 3 4
                            ((void *)0)
# 269 "../crypto/ui/ui_lib.c"
                                ;
    char *ok_chars_copy = 
# 270 "../crypto/ui/ui_lib.c" 3 4
                         ((void *)0)
# 270 "../crypto/ui/ui_lib.c"
                             ;
    char *cancel_chars_copy = 
# 271 "../crypto/ui/ui_lib.c" 3 4
                             ((void *)0)
# 271 "../crypto/ui/ui_lib.c"
                                 ;
    int ret;

    if (prompt != 
# 274 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 274 "../crypto/ui/ui_lib.c"
                     ) {
        prompt_copy = CRYPTO_strdup(prompt, "../crypto/ui/ui_lib.c", 275);
        if (prompt_copy == 
# 276 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 276 "../crypto/ui/ui_lib.c"
                              )
            goto err;
    }

    if (action_desc != 
# 280 "../crypto/ui/ui_lib.c" 3 4
                      ((void *)0)
# 280 "../crypto/ui/ui_lib.c"
                          ) {
        action_desc_copy = CRYPTO_strdup(action_desc, "../crypto/ui/ui_lib.c", 281);
        if (action_desc_copy == 
# 282 "../crypto/ui/ui_lib.c" 3 4
                               ((void *)0)
# 282 "../crypto/ui/ui_lib.c"
                                   )
            goto err;
    }

    if (ok_chars != 
# 286 "../crypto/ui/ui_lib.c" 3 4
                   ((void *)0)
# 286 "../crypto/ui/ui_lib.c"
                       ) {
        ok_chars_copy = CRYPTO_strdup(ok_chars, "../crypto/ui/ui_lib.c", 287);
        if (ok_chars_copy == 
# 288 "../crypto/ui/ui_lib.c" 3 4
                            ((void *)0)
# 288 "../crypto/ui/ui_lib.c"
                                )
            goto err;
    }

    if (cancel_chars != 
# 292 "../crypto/ui/ui_lib.c" 3 4
                       ((void *)0)
# 292 "../crypto/ui/ui_lib.c"
                           ) {
        cancel_chars_copy = CRYPTO_strdup(cancel_chars, "../crypto/ui/ui_lib.c", 293);
        if (cancel_chars_copy == 
# 294 "../crypto/ui/ui_lib.c" 3 4
                                ((void *)0)
# 294 "../crypto/ui/ui_lib.c"
                                    )
            goto err;
    }
 ...
 err:
    CRYPTO_free(prompt_copy, "../crypto/ui/ui_lib.c", 307);
    CRYPTO_free(action_desc_copy, "../crypto/ui/ui_lib.c", 308);
    CRYPTO_free(ok_chars_copy, "../crypto/ui/ui_lib.c", 309);
    CRYPTO_free(cancel_chars_copy, "../crypto/ui/ui_lib.c", 310);
    return -1;
}
...
# 316 "../crypto/ui/ui_lib.c" 3 4
                                                            ((void *)0)
# 316 "../crypto/ui/ui_lib.c"
                                                                , 0, 0,
                                   
# 317 "../crypto/ui/ui_lib.c" 3 4
                                  ((void *)0)
# 317 "../crypto/ui/ui_lib.c"
                                      );
}
...
{
    char *text_copy = 
# 322 "../crypto/ui/ui_lib.c" 3 4
                     ((void *)0)
# 322 "../crypto/ui/ui_lib.c"
                         ;
    int ret;

    if (text != 
# 325 "../crypto/ui/ui_lib.c" 3 4
               ((void *)0)
# 325 "../crypto/ui/ui_lib.c"
                   ) {
        text_copy = CRYPTO_strdup(text, "../crypto/ui/ui_lib.c", 326);
        if (text_copy == 
# 327 "../crypto/ui/ui_lib.c" 3 4
                        ((void *)0)
# 327 "../crypto/ui/ui_lib.c"
                            )
            return -1;
    }

    ret = general_allocate_string(ui, text_copy, 1, UIT_INFO, 0, 
# 331 "../crypto/ui/ui_lib.c" 3 4
                                                                ((void *)0)
# 331 "../crypto/ui/ui_lib.c"
                                                                    ,
                                  0, 0, 
# 332 "../crypto/ui/ui_lib.c" 3 4
                                       ((void *)0)
# 332 "../crypto/ui/ui_lib.c"
                                           );
    if (ret <= 0)
        CRYPTO_free(text_copy, "../crypto/ui/ui_lib.c", 334);
    return ret;
}
...
# 340 "../crypto/ui/ui_lib.c" 3 4
                                                             ((void *)0)
# 340 "../crypto/ui/ui_lib.c"
                                                                 , 0, 0,
                                   
# 341 "../crypto/ui/ui_lib.c" 3 4
                                  ((void *)0)
# 341 "../crypto/ui/ui_lib.c"
                                      );
}
...
{
    char *text_copy = 
# 346 "../crypto/ui/ui_lib.c" 3 4
                     ((void *)0)
# 346 "../crypto/ui/ui_lib.c"
                         ;
    int ret;

    if (text != 
# 349 "../crypto/ui/ui_lib.c" 3 4
               ((void *)0)
# 349 "../crypto/ui/ui_lib.c"
                   ) {
        text_copy = CRYPTO_strdup(text, "../crypto/ui/ui_lib.c", 350);
        if (text_copy == 
# 351 "../crypto/ui/ui_lib.c" 3 4
                        ((void *)0)
# 351 "../crypto/ui/ui_lib.c"
                            )
            return -1;
    }

    ret = general_allocate_string(ui, text_copy, 1, UIT_ERROR, 0, 
# 355 "../crypto/ui/ui_lib.c" 3 4
                                                                 ((void *)0)
# 355 "../crypto/ui/ui_lib.c"
                                                                     ,
                                  0, 0, 
# 356 "../crypto/ui/ui_lib.c" 3 4
                                       ((void *)0)
# 356 "../crypto/ui/ui_lib.c"
                                           );
    if (ret <= 0)
        CRYPTO_free(text_copy, "../crypto/ui/ui_lib.c", 358);
    return ret;
}
...
{
    char *prompt = 
# 365 "../crypto/ui/ui_lib.c" 3 4
                  ((void *)0)
# 365 "../crypto/ui/ui_lib.c"
                      ;

    if (ui != 
# 367 "../crypto/ui/ui_lib.c" 3 4
             ((void *)0) 
# 367 "../crypto/ui/ui_lib.c"
                  && ui->meth != 
# 367 "../crypto/ui/ui_lib.c" 3 4
                                 ((void *)0) 
# 367 "../crypto/ui/ui_lib.c"
...
# 367 "../crypto/ui/ui_lib.c"
        ...
        if (phrase_desc == 
# 375 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 375 "../crypto/ui/ui_lib.c"
                              )
            return 
# 376 "../crypto/ui/ui_lib.c" 3 4
                  ((void *)0)
# 376 "../crypto/ui/ui_lib.c"
                      ;
        len = sizeof(prompt1) - 1 + strlen(phrase_desc);
        if (object_name != 
# 378 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 378 "../crypto/ui/ui_lib.c"
                              )
            len += sizeof(prompt2) - 1 + strlen(object_name);
        len += sizeof(prompt3) - 1;

        if ((prompt = CRYPTO_malloc(len + 1, "../crypto/ui/ui_lib.c", 382)) == 
# 382 "../crypto/ui/ui_lib.c" 3 4
                                                 ((void *)0)
# 382 "../crypto/ui/ui_lib.c"
                                                     )
            return 
# 383 "../crypto/ui/ui_lib.c" 3 4
                  ((void *)0)
# 383 "../crypto/ui/ui_lib.c"
                      ;
        OPENSSL_strlcpy(prompt, prompt1, len + 1);
        OPENSSL_strlcat(prompt, phrase_desc, len + 1);
        if (object_name != 
# 386 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 386 "../crypto/ui/ui_lib.c"
                              ) {
...
void *UI_add_user_data(UI *ui, void *user_data)
{
    ...
    if ((ui->flags & 0x0002) != 0) {
        ...
        old_data = 
# 401 "../crypto/ui/ui_lib.c" 3 4
                  ((void *)0)
# 401 "../crypto/ui/ui_lib.c"
                      ;
    }
...
{
    void *duplicate = 
# 410 "../crypto/ui/ui_lib.c" 3 4
                     ((void *)0)
# 410 "../crypto/ui/ui_lib.c"
                         ;

    if (ui->meth->ui_duplicate_data == 
# 412 "../crypto/ui/ui_lib.c" 3 4
                                      ((void *)0)
        
# 413 "../crypto/ui/ui_lib.c"
       || ui->meth->ui_destroy_data == 
# 413 "../crypto/ui/ui_lib.c" 3 4
                                       ((void *)0)
# 413 "../crypto/ui/ui_lib.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",414,__func__), ERR_set_error)((40),(112),
# 414 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 414 "../crypto/ui/ui_lib.c"
       );
        return -1;
    }
    ...
    if (duplicate == 
# 419 "../crypto/ui/ui_lib.c" 3 4
                    ((void *)0)
# 419 "../crypto/ui/ui_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",420,__func__), ERR_set_error)((40),((40 | (0x2 << 18L))),
# 420 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 420 "../crypto/ui/ui_lib.c"
       );
        return -1;
    }
...
{
    if (i < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",438,__func__), ERR_set_error)((40),(103),
# 438 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 438 "../crypto/ui/ui_lib.c"
       );
        return 
# 439 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 439 "../crypto/ui/ui_lib.c"
                  ;
    }
    if (i >= OPENSSL_sk_num(ossl_check_const_UI_STRING_sk_type(ui->strings))) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",442,__func__), ERR_set_error)((40),(102),
# 442 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 442 "../crypto/ui/ui_lib.c"
       );
        return 
# 443 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 443 "../crypto/ui/ui_lib.c"
                  ;
    }
    return UI_get0_result_string(((UI_STRING *)OPENSSL_sk_value(ossl_check_const_UI_STRING_sk_type(ui->strings), (i))));
}

int UI_get_result_length(UI *ui, int i)
{
    if (i < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",451,__func__), ERR_set_error)((40),(103),
# 451 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 451 "../crypto/ui/ui_lib.c"
       );
        return -1;
    }
    if (i >= OPENSSL_sk_num(ossl_check_const_UI_STRING_sk_type(ui->strings))) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",455,__func__), ERR_set_error)((40),(102),
# 455 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 455 "../crypto/ui/ui_lib.c"
       );
        return -1;
    }
    return UI_get_result_string_length(((UI_STRING *)OPENSSL_sk_value(ossl_check_const_UI_STRING_sk_type(ui->strings), (i))));
}
...
# 469 "../crypto/ui/ui_lib.c" 3 4
                                    ((void *)0)
        
# 470 "../crypto/ui/ui_lib.c"
...
int UI_process(UI *ui)
{
    ...
    if (ui->meth->ui_open_session != 
# 480 "../crypto/ui/ui_lib.c" 3 4
                                    ((void *)0)
        
# 481 "../crypto/ui/ui_lib.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_UI_STRING_sk_type(ui->strings)); i++) {
        if (ui->meth->ui_write_string != 
# 492 "../crypto/ui/ui_lib.c" 3 4
                                        ((void *)0)
            
# 493 "../crypto/ui/ui_lib.c"
           && (ui->meth->ui_write_string(ui,
                                          ((UI_STRING *)OPENSSL_sk_value(ossl_check_const_UI_STRING_sk_type(ui->strings), (i))))
                <= 0))
        {
    ...
    if (ui->meth->ui_flush != 
# 503 "../crypto/ui/ui_lib.c" 3 4
                             ((void *)0)
# 503 "../crypto/ui/ui_lib.c"
                                 )
...
# 519 "../crypto/ui/ui_lib.c" 3 4
                                       ((void *)0)
# 519 "../crypto/ui/ui_lib.c"
                                           ) {
    ...
    state = 
# 542 "../crypto/ui/ui_lib.c" 3 4
           ((void *)0)
# 542 "../crypto/ui/ui_lib.c"
               ;
 err:
    if (ui->meth->ui_close_session != 
# 544 "../crypto/ui/ui_lib.c" 3 4
                                     ((void *)0)
        
# 545 "../crypto/ui/ui_lib.c"
       && ui->meth->ui_close_session(ui) <= 0) {
        if (state == 
# 546 "../crypto/ui/ui_lib.c" 3 4
                    ((void *)0)
# 546 "../crypto/ui/ui_lib.c"
                        )
    ...
    if (ok == -1)
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",552,__func__), ERR_set_error)(40, 107, "while %s", state);
    return ok;
}
...
{
    if (ui == 
# 558 "../crypto/ui/ui_lib.c" 3 4
             ((void *)0)
# 558 "../crypto/ui/ui_lib.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",559,__func__), ERR_set_error)((40),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 559 "../crypto/ui/ui_lib.c" 3 4
       ((void *)0)
# 559 "../crypto/ui/ui_lib.c"
       );
        return -1;
    }
    switch (cmd) {
    ...
    (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",577,__func__), ERR_set_error)((40),(106),
# 577 "../crypto/ui/ui_lib.c" 3 4
   ((void *)0)
# 577 "../crypto/ui/ui_lib.c"
   );
    return -1;
}
...
{
    UI_METHOD *ui_method = 
# 604 "../crypto/ui/ui_lib.c" 3 4
                          ((void *)0)
# 604 "../crypto/ui/ui_lib.c"
                              ;

    if ((ui_method = CRYPTO_zalloc(sizeof(*ui_method), "../crypto/ui/ui_lib.c", 606)) == 
# 606 "../crypto/ui/ui_lib.c" 3 4
                                                           ((void *)0)
        
# 607 "../crypto/ui/ui_lib.c"
       || (ui_method->name = CRYPTO_strdup(name, "../crypto/ui/ui_lib.c", 607)) == 
# 607 "../crypto/ui/ui_lib.c" 3 4
                                                      ((void *)0)
        
# 608 "../crypto/ui/ui_lib.c"
       || !CRYPTO_new_ex_data(14, ui_method,
                               &ui_method->ex_data)) {

        if (ui_method != 
# 611 "../crypto/ui/ui_lib.c" 3 4
                        ((void *)0)
# 611 "../crypto/ui/ui_lib.c"
                            ) {
            if (ui_method->name != 
# 612 "../crypto/ui/ui_lib.c" 3 4
                                  ((void *)0)
# 612 "../crypto/ui/ui_lib.c"
                                      )




                (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",617,__func__), ERR_set_error)((40),((15 | (0x2 << 18L))),
# 617 "../crypto/ui/ui_lib.c" 3 4
               ((void *)0)
# 617 "../crypto/ui/ui_lib.c"
               );
            CRYPTO_free(ui_method->name, "../crypto/ui/ui_lib.c", 618);
        }
        CRYPTO_free(ui_method, "../crypto/ui/ui_lib.c", 620);
        return 
# 621 "../crypto/ui/ui_lib.c" 3 4
              ((void *)0)
# 621 "../crypto/ui/ui_lib.c"
                  ;
    }
    return ui_method;
}
...
{
    if (ui_method == 
# 633 "../crypto/ui/ui_lib.c" 3 4
                    ((void *)0)
# 633 "../crypto/ui/ui_lib.c"
                        )
        return;
    CRYPTO_free_ex_data(14, ui_method,
                        &ui_method->ex_data);
    CRYPTO_free(ui_method->name, "../crypto/ui/ui_lib.c", 637);
    ui_method->name = 
# 638 "../crypto/ui/ui_lib.c" 3 4
                     ((void *)0)
# 638 "../crypto/ui/ui_lib.c"
                         ;
    CRYPTO_free(ui_method, "../crypto/ui/ui_lib.c", 639);
}

int UI_method_set_opener(UI_METHOD *method, int (*opener) (UI *ui))
{
    if (method != 
# 644 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 644 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 654 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 654 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 663 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 663 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 673 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 673 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 682 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 682 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 693 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 693 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 706 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 706 "../crypto/ui/ui_lib.c"
                     ) {
...
{
    if (method != 
# 720 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 720 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_open_session;
    return 
# 722 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 722 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 727 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 727 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_write_string;
    return 
# 729 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 729 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 734 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 734 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_flush;
    return 
# 736 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 736 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 741 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 741 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_read_string;
    return 
# 743 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 743 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 748 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 748 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_close_session;
    return 
# 750 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 750 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 756 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 756 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_construct_prompt;
    return 
# 758 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
...
{
    if (method != 
# 763 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 763 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_duplicate_data;
    return 
# 765 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 765 "../crypto/ui/ui_lib.c"
              ;
}
...
{
    if (method != 
# 770 "../crypto/ui/ui_lib.c" 3 4
                 ((void *)0)
# 770 "../crypto/ui/ui_lib.c"
                     )
        return method->ui_destroy_data;
    return 
# 772 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 772 "../crypto/ui/ui_lib.c"
              ;
}
...
const char *UI_get0_action_string(UI_STRING *uis)
{
    ...
    return 
# 807 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 807 "../crypto/ui/ui_lib.c"
              ;
}
...
const char *UI_get0_result_string(UI_STRING *uis)
{
    ...
    return 
# 822 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 822 "../crypto/ui/ui_lib.c"
              ;
}
...
const char *UI_get0_test_string(UI_STRING *uis)
{
    ...
    return 
# 852 "../crypto/ui/ui_lib.c" 3 4
          ((void *)0)
# 852 "../crypto/ui/ui_lib.c"
              ;
}
...
int UI_set_result_ex(UI *ui, UI_STRING *uis, const char *result, int len)
{
    ...
    case UIT_VERIFY:
        if (len < uis->_.string_data.result_minsize) {
            ui->flags |= 0x0001;
            (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",899,__func__), ERR_set_error)(40, 101,
        ...
        if (len > uis->_.string_data.result_maxsize) {
            ui->flags |= 0x0001;
            (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",907,__func__), ERR_set_error)(40, 100,
                           "You must type in %d to %d characters",
                           uis->_.string_data.result_minsize,
                           uis->_.string_data.result_maxsize);
            return -1;
        ...
        if (uis->result_buf == 
# 914 "../crypto/ui/ui_lib.c" 3 4
                              ((void *)0)
# 914 "../crypto/ui/ui_lib.c"
                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",915,__func__), ERR_set_error)((40),(105),
# 915 "../crypto/ui/ui_lib.c" 3 4
           ((void *)0)
# 915 "../crypto/ui/ui_lib.c"
           );
            return -1;
        }
    ...
    case UIT_BOOLEAN:
        {
            ...
            if (uis->result_buf == 
# 928 "../crypto/ui/ui_lib.c" 3 4
                                  ((void *)0)
# 928 "../crypto/ui/ui_lib.c"
                                      ) {
                (ERR_new(), ERR_set_debug("../crypto/ui/ui_lib.c",929,__func__), ERR_set_error)((40),(105),
# 929 "../crypto/ui/ui_lib.c" 3 4
               ((void *)0)
# 929 "../crypto/ui/ui_lib.c"
               );
                return -1;
            }
