# 0 "../crypto/ui/ui_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ui/ui_util.c"
# 10 "../crypto/ui/ui_util.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 12 "../crypto/ui/ui_util.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 13 "../crypto/ui/ui_util.c" 2
# 1 "../crypto/ui/ui_local.h" 1
# 13 "../crypto/ui/ui_local.h"
...
{
    char buff[
# 22 "../crypto/ui/ui_util.c" 3 4
             8192
# 22 "../crypto/ui/ui_util.c"
                   ];
    int ret;

    ret =
        UI_UTIL_read_pw(buf, buff, (length > 
# 26 "../crypto/ui/ui_util.c" 3 4
                                            8192
# 26 "../crypto/ui/ui_util.c"
                                                  ) ? 
# 26 "../crypto/ui/ui_util.c" 3 4
                                                      8192 
# 26 "../crypto/ui/ui_util.c"
...
# 28 "../crypto/ui/ui_util.c" 3 4
                         8192
# 28 "../crypto/ui/ui_util.c"
                               );
    return ret;
}
                    ...
                    int verify)
{
    ...
    ui = UI_new();
    if (ui != 
# 42 "../crypto/ui/ui_util.c" 3 4
             ((void *)0)
# 42 "../crypto/ui/ui_util.c"
                 ) {
...
{
    if (*pptr != 
# 74 "../crypto/ui/ui_util.c" 3 4
                ((void *)0)
# 74 "../crypto/ui/ui_util.c"
                    ) {
        *pptr = CRYPTO_memdup((*pptr), sizeof(struct pem_password_cb_data), "../crypto/ui/ui_util.c", 75);
        if (*pptr != 
# 76 "../crypto/ui/ui_util.c" 3 4
                    ((void *)0)
# 76 "../crypto/ui/ui_util.c"
                        )
            return 1;
    }
    return 0;
...
static void ui_free_method_data(void *parent, void *ptr, CRYPTO_EX_DATA *ad,
                                int idx, long argl, void *argp)
{
    CRYPTO_free(ptr, "../crypto/ui/ui_util.c", 85);
}

static CRYPTO_ONCE get_index_once = 
# 88 "../crypto/ui/ui_util.c" 3 4
                                   0
# 88 "../crypto/ui/ui_util.c"
                                                          ;
static int ui_method_data_index = -1;
static int ui_method_data_index_init(void); static int ui_method_data_index_init_ossl_ret_ = 0; static void ui_method_data_index_init_ossl_(void) { ui_method_data_index_init_ossl_ret_ = ui_method_data_index_init(); } static int ui_method_data_index_init(void)
{
    ui_method_data_index = CRYPTO_get_ex_new_index(14,
                                                   0, 
# 93 "../crypto/ui/ui_util.c" 3 4
                                                     ((void *)0)
# 93 "../crypto/ui/ui_util.c"
                                                         , ui_new_method_data,
                                                   ui_dup_method_data,
                                                   ui_free_method_data);
    return 1;
...
UI_METHOD *UI_UTIL_wrap_read_pem_callback(pem_password_cb *cb, int rwflag)
{
    struct pem_password_cb_data *data = 
# 148 "../crypto/ui/ui_util.c" 3 4
                                       ((void *)0)
# 148 "../crypto/ui/ui_util.c"
                                           ;
    UI_METHOD *ui_method = 
# 149 "../crypto/ui/ui_util.c" 3 4
                          ((void *)0)
# 149 "../crypto/ui/ui_util.c"
                              ;

    if ((data = CRYPTO_zalloc(sizeof(*data), "../crypto/ui/ui_util.c", 151)) == 
# 151 "../crypto/ui/ui_util.c" 3 4
                                                 ((void *)0)
        
# 152 "../crypto/ui/ui_util.c"
       || (ui_method = UI_create_method("PEM password callback wrapper")) == 
# 152 "../crypto/ui/ui_util.c" 3 4
                                                                             ((void *)0)
        
# 153 "../crypto/ui/ui_util.c"
       || UI_method_set_opener(ui_method, ui_open) < 0
        ...
        || !(CRYPTO_THREAD_run_once(&get_index_once, ui_method_data_index_init_ossl_) ? ui_method_data_index_init_ossl_ret_ : 0)
        || !UI_method_set_ex_data(ui_method, ui_method_data_index, data)) {
        UI_destroy_method(ui_method);
        CRYPTO_free(data, "../crypto/ui/ui_util.c", 160);
        return 
# 161 "../crypto/ui/ui_util.c" 3 4
              ((void *)0)
# 161 "../crypto/ui/ui_util.c"
                  ;
    }
    data->rwflag = rwflag;
    data->cb = cb != 
# 164 "../crypto/ui/ui_util.c" 3 4
                    ((void *)0) 
# 164 "../crypto/ui/ui_util.c"
                         ? cb : PEM_def_callback;
