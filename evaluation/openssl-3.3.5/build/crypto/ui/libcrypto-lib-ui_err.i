# 0 "../crypto/ui/ui_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ui/ui_err.c"
# 11 "../crypto/ui/ui_err.c"
...
# 12 "../crypto/ui/ui_err.c" 2
# 1 "../include/openssl/uierr.h" 1
# 13 "../include/openssl/uierr.h"
        
# 13 "../crypto/ui/ui_err.c" 2
# 1 "../include/crypto/uierr.h" 1
# 13 "../include/crypto/uierr.h"
        
# 22 "../include/crypto/uierr.h"
int ossl_err_load_UI_strings(void);
# 14 "../crypto/ui/ui_err.c" 2



static const ERR_STRING_DATA UI_str_reasons[] = {
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "common ok and cancel characters"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "index too large"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "index too small"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "no result buffer"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "processing error"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "result too large"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "result too small"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "sys$assign error"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "sys$dassgn error"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "sys$qiow error"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "unknown control command"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "unknown ttyget errno value"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "user data duplication unsupported"},
    {0, 
# 35 "../crypto/ui/ui_err.c" 3 4
       ((void *)0)
# 35 "../crypto/ui/ui_err.c"
           }
};
...
int ossl_err_load_UI_strings(void)
{
    ...
    if (ERR_reason_error_string(UI_str_reasons[0].error) == 
# 43 "../crypto/ui/ui_err.c" 3 4
                                                           ((void *)0)
# 43 "../crypto/ui/ui_err.c"
                                                               )
