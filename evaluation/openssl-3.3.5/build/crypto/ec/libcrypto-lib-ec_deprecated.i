# 0 "../crypto/ec/ec_deprecated.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_deprecated.c"
# 16 "../crypto/ec/ec_deprecated.c"
...
# 17 "../crypto/ec/ec_deprecated.c" 2
...
# 18 "../crypto/ec/ec_deprecated.c" 2
...
extern void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 19 "../crypto/ec/ec_deprecated.c" 2
                          ...
                          BIGNUM *ret, BN_CTX *ctx)
{
    ...
    if (buf_len == 0)
        return 
# 32 "../crypto/ec/ec_deprecated.c" 3 4
              ((void *)0)
# 32 "../crypto/ec/ec_deprecated.c"
                  ;

    ret = BN_bin2bn(buf, buf_len, ret);

    CRYPTO_free(buf, "../crypto/ec/ec_deprecated.c", 36);
                            ...
                            const BIGNUM *bn, EC_POINT *point, BN_CTX *ctx)
{
    ...
    if ((buf_len = ((BN_num_bits(bn)+7)/8)) == 0)
        buf_len = 1;
    if ((buf = CRYPTO_malloc(buf_len, "../crypto/ec/ec_deprecated.c", 50)) == 
# 50 "../crypto/ec/ec_deprecated.c" 3 4
                                          ((void *)0)
# 50 "../crypto/ec/ec_deprecated.c"
                                              )
        return 
# 51 "../crypto/ec/ec_deprecated.c" 3 4
              ((void *)0)
# 51 "../crypto/ec/ec_deprecated.c"
                  ;

    if (BN_bn2binpad(bn, buf, buf_len) < 0) {
        CRYPTO_free(buf, "../crypto/ec/ec_deprecated.c", 54);
        return 
# 55 "../crypto/ec/ec_deprecated.c" 3 4
              ((void *)0)
# 55 "../crypto/ec/ec_deprecated.c"
                  ;
    }

    if (point == 
# 58 "../crypto/ec/ec_deprecated.c" 3 4
                ((void *)0)
# 58 "../crypto/ec/ec_deprecated.c"
                    ) {
        if ((ret = EC_POINT_new(group)) == 
# 59 "../crypto/ec/ec_deprecated.c" 3 4
                                          ((void *)0)
# 59 "../crypto/ec/ec_deprecated.c"
                                              ) {
            CRYPTO_free(buf, "../crypto/ec/ec_deprecated.c", 60);
            return 
# 61 "../crypto/ec/ec_deprecated.c" 3 4
                  ((void *)0)
# 61 "../crypto/ec/ec_deprecated.c"
                      ;
        }
    } else
        ret = point;
    ...
    if (!EC_POINT_oct2point(group, ret, buf, buf_len, ctx)) {
        ...
        CRYPTO_free(buf, "../crypto/ec/ec_deprecated.c", 69);
        return 
# 70 "../crypto/ec/ec_deprecated.c" 3 4
              ((void *)0)
# 70 "../crypto/ec/ec_deprecated.c"
                  ;
    }

    CRYPTO_free(buf, "../crypto/ec/ec_deprecated.c", 73);
    return ret;
}
