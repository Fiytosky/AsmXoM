# 0 "../crypto/ec/ecp_mont.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecp_mont.c"
# 15 "../crypto/ec/ecp_mont.c"
...
int ossl_ec_GFp_mont_group_init(EC_GROUP *group)
{
    ...
    group->field_data1 = 
# 88 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 88 "../crypto/ec/ecp_mont.c"
                            ;
    group->field_data2 = 
# 89 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 89 "../crypto/ec/ecp_mont.c"
                            ;
    return ok;
}
...
void ossl_ec_GFp_mont_group_finish(EC_GROUP *group)
{
    ...
    group->field_data1 = 
# 96 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 96 "../crypto/ec/ecp_mont.c"
                            ;
    BN_free(group->field_data2);
    group->field_data2 = 
# 98 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 98 "../crypto/ec/ecp_mont.c"
                            ;
...
void ossl_ec_GFp_mont_group_clear_finish(EC_GROUP *group)
{
    BN_MONT_CTX_free(group->field_data1);
    group->field_data1 = 
# 105 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 105 "../crypto/ec/ecp_mont.c"
                            ;
    BN_clear_free(group->field_data2);
    group->field_data2 = 
# 107 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 107 "../crypto/ec/ecp_mont.c"
                            ;
...
int ossl_ec_GFp_mont_group_copy(EC_GROUP *dest, const EC_GROUP *src)
{
    ...
    dest->field_data1 = 
# 114 "../crypto/ec/ecp_mont.c" 3 4
                       ((void *)0)
# 114 "../crypto/ec/ecp_mont.c"
                           ;
    BN_clear_free(dest->field_data2);
    dest->field_data2 = 
# 116 "../crypto/ec/ecp_mont.c" 3 4
                       ((void *)0)
# 116 "../crypto/ec/ecp_mont.c"
                           ;
    ...
    if (src->field_data1 != 
# 121 "../crypto/ec/ecp_mont.c" 3 4
                           ((void *)0)
# 121 "../crypto/ec/ecp_mont.c"
                               ) {
        dest->field_data1 = BN_MONT_CTX_new();
        if (dest->field_data1 == 
# 123 "../crypto/ec/ecp_mont.c" 3 4
                                ((void *)0)
# 123 "../crypto/ec/ecp_mont.c"
                                    )
            return 0;
    ...
    if (src->field_data2 != 
# 128 "../crypto/ec/ecp_mont.c" 3 4
                           ((void *)0)
# 128 "../crypto/ec/ecp_mont.c"
                               ) {
        dest->field_data2 = BN_dup(src->field_data2);
        if (dest->field_data2 == 
# 130 "../crypto/ec/ecp_mont.c" 3 4
                                ((void *)0)
# 130 "../crypto/ec/ecp_mont.c"
                                    )
            goto err;
    }
 ...
 err:
    BN_MONT_CTX_free(dest->field_data1);
    dest->field_data1 = 
# 138 "../crypto/ec/ecp_mont.c" 3 4
                       ((void *)0)
# 138 "../crypto/ec/ecp_mont.c"
                           ;
    return 0;
}
...
{
    BN_CTX *new_ctx = 
# 146 "../crypto/ec/ecp_mont.c" 3 4
                     ((void *)0)
# 146 "../crypto/ec/ecp_mont.c"
                         ;
    BN_MONT_CTX *mont = 
# 147 "../crypto/ec/ecp_mont.c" 3 4
                       ((void *)0)
# 147 "../crypto/ec/ecp_mont.c"
                           ;
    BIGNUM *one = 
# 148 "../crypto/ec/ecp_mont.c" 3 4
                 ((void *)0)
# 148 "../crypto/ec/ecp_mont.c"
                     ;
    int ret = 0;

    BN_MONT_CTX_free(group->field_data1);
    group->field_data1 = 
# 152 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 152 "../crypto/ec/ecp_mont.c"
                            ;
    BN_free(group->field_data2);
    group->field_data2 = 
# 154 "../crypto/ec/ecp_mont.c" 3 4
                        ((void *)0)
# 154 "../crypto/ec/ecp_mont.c"
                            ;

    if (ctx == 
# 156 "../crypto/ec/ecp_mont.c" 3 4
              ((void *)0)
# 156 "../crypto/ec/ecp_mont.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(group->libctx);
        if (ctx == 
# 158 "../crypto/ec/ecp_mont.c" 3 4
                  ((void *)0)
# 158 "../crypto/ec/ecp_mont.c"
                      )
            return 0;
    }
    ...
    if (mont == 
# 163 "../crypto/ec/ecp_mont.c" 3 4
               ((void *)0)
# 163 "../crypto/ec/ecp_mont.c"
                   )
        goto err;
    if (!BN_MONT_CTX_set(mont, p, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",166,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 166 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 166 "../crypto/ec/ecp_mont.c"
       );
        goto err;
    }
    one = BN_new();
    if (one == 
# 170 "../crypto/ec/ecp_mont.c" 3 4
              ((void *)0)
# 170 "../crypto/ec/ecp_mont.c"
                  )
        goto err;
    ...
    mont = 
# 176 "../crypto/ec/ecp_mont.c" 3 4
          ((void *)0)
# 176 "../crypto/ec/ecp_mont.c"
              ;
    group->field_data2 = one;
    one = 
# 178 "../crypto/ec/ecp_mont.c" 3 4
         ((void *)0)
# 178 "../crypto/ec/ecp_mont.c"
             ;
    ...
    if (!ret) {
        BN_MONT_CTX_free(group->field_data1);
        group->field_data1 = 
# 184 "../crypto/ec/ecp_mont.c" 3 4
                            ((void *)0)
# 184 "../crypto/ec/ecp_mont.c"
                                ;
        BN_free(group->field_data2);
        group->field_data2 = 
# 186 "../crypto/ec/ecp_mont.c" 3 4
                            ((void *)0)
# 186 "../crypto/ec/ecp_mont.c"
                                ;
    }
...
# 199 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 199 "../crypto/ec/ecp_mont.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",200,__func__), ERR_set_error)((16),(111),
# 200 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 200 "../crypto/ec/ecp_mont.c"
       );
        return 0;
    }
...
{
    if (group->field_data1 == 
# 210 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 210 "../crypto/ec/ecp_mont.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",211,__func__), ERR_set_error)((16),(111),
# 211 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 211 "../crypto/ec/ecp_mont.c"
       );
        return 0;
    }
...
{
    BIGNUM *e = 
# 226 "../crypto/ec/ecp_mont.c" 3 4
               ((void *)0)
# 226 "../crypto/ec/ecp_mont.c"
                   ;
    BN_CTX *new_ctx = 
# 227 "../crypto/ec/ecp_mont.c" 3 4
                     ((void *)0)
# 227 "../crypto/ec/ecp_mont.c"
                         ;
    int ret = 0;

    if (group->field_data1 == 
# 230 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 230 "../crypto/ec/ecp_mont.c"
                                 )
        return 0;

    if (ctx == 
# 233 "../crypto/ec/ecp_mont.c" 3 4
              ((void *)0)
            
# 234 "../crypto/ec/ecp_mont.c"
           && (ctx = new_ctx = BN_CTX_secure_new_ex(group->libctx)) == 
# 234 "../crypto/ec/ecp_mont.c" 3 4
                                                                       ((void *)0)
# 234 "../crypto/ec/ecp_mont.c"
                                                                           )
        return 0;
    ...
    BN_CTX_start(ctx);
    if ((e = BN_CTX_get(ctx)) == 
# 238 "../crypto/ec/ecp_mont.c" 3 4
                                ((void *)0)
# 238 "../crypto/ec/ecp_mont.c"
                                    )
        goto err;
    ...
    if (BN_is_zero(r)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",255,__func__), ERR_set_error)((16),(165),
# 255 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 255 "../crypto/ec/ecp_mont.c"
       );
        goto err;
    }
...
{
    if (group->field_data1 == 
# 270 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 270 "../crypto/ec/ecp_mont.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",271,__func__), ERR_set_error)((16),(111),
# 271 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 271 "../crypto/ec/ecp_mont.c"
       );
        return 0;
    }
...
{
    if (group->field_data1 == 
# 281 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 281 "../crypto/ec/ecp_mont.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",282,__func__), ERR_set_error)((16),(111),
# 282 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 282 "../crypto/ec/ecp_mont.c"
       );
        return 0;
    }
...
# 292 "../crypto/ec/ecp_mont.c" 3 4
                             ((void *)0)
# 292 "../crypto/ec/ecp_mont.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_mont.c",293,__func__), ERR_set_error)((16),(111),
# 293 "../crypto/ec/ecp_mont.c" 3 4
       ((void *)0)
# 293 "../crypto/ec/ecp_mont.c"
       );
        return 0;
    }
