# 0 "../crypto/ec/ecx_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecx_meth.c"
# 14 "../crypto/ec/ecx_meth.c"
...
# 18 "../crypto/ec/ecx_meth.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../crypto/ec/ecx_meth.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 26 "../crypto/ec/ecx_meth.c" 2

# 1 "../crypto/ec/ec_local.h" 1
# 17 "../crypto/ec/ec_local.h"
...
# 28 "../crypto/ec/ecx_meth.c" 2
# 1 "../crypto/ec/curve448/curve448_local.h" 1
# 11 "../crypto/ec/curve448/curve448_local.h"
...
# 12 "../crypto/ec/curve448/curve448_local.h" 2
# 29 "../crypto/ec/ecx_meth.c" 2
# 1 "../crypto/ec/ecx_backend.h" 1
# 30 "../crypto/ec/ecx_meth.c" 2
...
static int ecx_pub_encode(X509_PUBKEY *pk, const EVP_PKEY *pkey)
{
    ...
    if (ecxkey == 
# 36 "../crypto/ec/ecx_meth.c" 3 4
                 ((void *)0)
# 36 "../crypto/ec/ecx_meth.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",37,__func__), ERR_set_error)((16),(116),
# 37 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 37 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }

    penc = CRYPTO_memdup((ecxkey->pubkey), ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57)), "../crypto/ec/ecx_meth.c", 41);
    if (penc == 
# 42 "../crypto/ec/ecx_meth.c" 3 4
               ((void *)0)
# 42 "../crypto/ec/ecx_meth.c"
                   )
        return 0;

    if (!X509_PUBKEY_set0_param(pk, OBJ_nid2obj(pkey->ameth->pkey_id),
                                -1, 
# 46 "../crypto/ec/ecx_meth.c" 3 4
                                             ((void *)0)
# 46 "../crypto/ec/ecx_meth.c"
                                                 , penc, ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57)))) {
        CRYPTO_free(penc, "../crypto/ec/ecx_meth.c", 47);
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",48,__func__), ERR_set_error)((16),((11 | (0x2 << 18L))),
# 48 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 48 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
    return 1;
...
# 62 "../crypto/ec/ecx_meth.c" 3 4
                               ((void *)0)
# 62 "../crypto/ec/ecx_meth.c"
                                   , &p, &pklen, &palg, pubkey))
        return 0;
    ecx = ossl_ecx_key_op(palg, p, pklen, pkey->ameth->pkey_id,
                          KEY_OP_PUBLIC, 
# 65 "../crypto/ec/ecx_meth.c" 3 4
                                        ((void *)0)
# 65 "../crypto/ec/ecx_meth.c"
                                            , 
# 65 "../crypto/ec/ecx_meth.c" 3 4
                                              ((void *)0)
# 65 "../crypto/ec/ecx_meth.c"
    ...
    if (ecx != 
# 66 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 66 "../crypto/ec/ecx_meth.c"
                  ) {
        ret = 1;
...
static int ecx_pub_cmp(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (akey == 
# 78 "../crypto/ec/ecx_meth.c" 3 4
               ((void *)0) 
# 78 "../crypto/ec/ecx_meth.c"
                    || bkey == 
# 78 "../crypto/ec/ecx_meth.c" 3 4
                               ((void *)0)
# 78 "../crypto/ec/ecx_meth.c"
    ...
    return CRYPTO_memcmp(akey->pubkey, bkey->pubkey, ((((a)->ameth->pkey_id) == 1034 || ((a)->ameth->pkey_id) == 1087) ? 32 : (((a)->ameth->pkey_id) == 1035 ? 56 : 57))) == 0;
}
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (ecx != 
# 90 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 90 "../crypto/ec/ecx_meth.c"
                  ) {
        ret = 1;
        EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, ecx);
    }
...
static int ecx_priv_encode(PKCS8_PRIV_KEY_INFO *p8, const EVP_PKEY *pkey)
{
    ...
    ASN1_OCTET_STRING oct;
    unsigned char *penc = 
# 102 "../crypto/ec/ecx_meth.c" 3 4
                         ((void *)0)
# 102 "../crypto/ec/ecx_meth.c"
                             ;
    int penclen;

    if (ecxkey == 
# 105 "../crypto/ec/ecx_meth.c" 3 4
                 ((void *)0) 
# 105 "../crypto/ec/ecx_meth.c"
                      || ecxkey->privkey == 
# 105 "../crypto/ec/ecx_meth.c" 3 4
                                            ((void *)0)
# 105 "../crypto/ec/ecx_meth.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",106,__func__), ERR_set_error)((16),(123),
# 106 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 106 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }

    oct.data = ecxkey->privkey;
    oct.length = ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57));
    oct.flags = 0;

    penclen = i2d_ASN1_OCTET_STRING(&oct, &penc);
    if (penclen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",116,__func__), ERR_set_error)((16),((13 | (0x2 << 18L))),
# 116 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 116 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
    ...
    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(pkey->ameth->pkey_id), 0,
                         -1, 
# 121 "../crypto/ec/ecx_meth.c" 3 4
                                      ((void *)0)
# 121 "../crypto/ec/ecx_meth.c"
                                          , penc, penclen)) {
        CRYPTO_clear_free(penc, penclen, "../crypto/ec/ecx_meth.c", 122);
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",123,__func__), ERR_set_error)((16),((13 | (0x2 << 18L))),
# 123 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 123 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
...
{
    return ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57));
}

static int ecx_bits(const EVP_PKEY *pkey)
{
    if (((pkey->ameth->pkey_id) == 1034 || (pkey->ameth->pkey_id) == 1087)) {
        return 253;
    } else if (((pkey->ameth->pkey_id) == 1035)) {
        return 448;
    } else {
        return 456;
    }
                         ...
                         ASN1_PCTX *ctx, ecx_key_op_t op)
{
    ...
    if (op == KEY_OP_PRIVATE) {
        if (ecxkey == 
# 173 "../crypto/ec/ecx_meth.c" 3 4
                     ((void *)0) 
# 173 "../crypto/ec/ecx_meth.c"
                          || ecxkey->privkey == 
# 173 "../crypto/ec/ecx_meth.c" 3 4
                                                ((void *)0)
# 173 "../crypto/ec/ecx_meth.c"
        ...
        if (BIO_printf(bp, "%*spriv:\n", indent, "") <= 0)
            return 0;
        if (ASN1_buf_print(bp, ecxkey->privkey, ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57)),
                           indent + 4) == 0)
            return 0;
    } else {
        if (ecxkey == 
# 186 "../crypto/ec/ecx_meth.c" 3 4
                     ((void *)0)
# 186 "../crypto/ec/ecx_meth.c"
                         ) {
    ...
    if (ASN1_buf_print(bp, ecxkey->pubkey, ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57)),
                       indent + 4) == 0)
        return 0;
    return 1;
}
...
static int ecx_ctrl(EVP_PKEY *pkey, int op, long arg1, void *arg2)
{
    ...
    case 0x9: {
        ECX_KEY *ecx = ossl_ecx_key_op(
# 220 "../crypto/ec/ecx_meth.c" 3 4
                                      ((void *)0)
# 220 "../crypto/ec/ecx_meth.c"
                                          , arg2, arg1, pkey->ameth->pkey_id,
                                       KEY_OP_PUBLIC, 
# 221 "../crypto/ec/ecx_meth.c" 3 4
                                                     ((void *)0)
# 221 "../crypto/ec/ecx_meth.c"
                                                         , 
# 221 "../crypto/ec/ecx_meth.c" 3 4
                                                           ((void *)0)
# 221 "../crypto/ec/ecx_meth.c"
        ...
        if (ecx != 
# 223 "../crypto/ec/ecx_meth.c" 3 4
                  ((void *)0)
# 223 "../crypto/ec/ecx_meth.c"
                      ) {
            EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, ecx);
            return 1;
        }
    ...
    case 0xa:
        if (pkey->pkey.ecx != 
# 230 "../crypto/ec/ecx_meth.c" 3 4
                             ((void *)0)
# 230 "../crypto/ec/ecx_meth.c"
                                 ) {
            unsigned char **ppt = arg2;

            *ppt = CRYPTO_memdup((pkey->pkey.ecx->pubkey), ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57)), "../crypto/ec/ecx_meth.c", 233);
            if (*ppt != 
# 234 "../crypto/ec/ecx_meth.c" 3 4
                       ((void *)0)
# 234 "../crypto/ec/ecx_meth.c"
                           )
                return ((((pkey)->ameth->pkey_id) == 1034 || ((pkey)->ameth->pkey_id) == 1087) ? 32 : (((pkey)->ameth->pkey_id) == 1035 ? 56 : 57));
        }
        return 0;
...
{
    OSSL_LIB_CTX *libctx = 
# 262 "../crypto/ec/ecx_meth.c" 3 4
                          ((void *)0)
# 262 "../crypto/ec/ecx_meth.c"
                              ;
    ECX_KEY *ecx = 
# 263 "../crypto/ec/ecx_meth.c" 3 4
                  ((void *)0)
# 263 "../crypto/ec/ecx_meth.c"
                      ;

    if (pkey->keymgmt != 
# 265 "../crypto/ec/ecx_meth.c" 3 4
                        ((void *)0)
# 265 "../crypto/ec/ecx_meth.c"
                            )
        libctx = ossl_provider_libctx(EVP_KEYMGMT_get0_provider(pkey->keymgmt));

    ecx = ossl_ecx_key_op(
# 268 "../crypto/ec/ecx_meth.c" 3 4
                         ((void *)0)
# 268 "../crypto/ec/ecx_meth.c"
                             , priv, len, pkey->ameth->pkey_id,
                          KEY_OP_PRIVATE, libctx, 
# 269 "../crypto/ec/ecx_meth.c" 3 4
                                                 ((void *)0)
# 269 "../crypto/ec/ecx_meth.c"
                                                     );

    if (ecx != 
# 271 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 271 "../crypto/ec/ecx_meth.c"
                  ) {
        EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, ecx);
        return 1;
    }
...
{
    OSSL_LIB_CTX *libctx = 
# 280 "../crypto/ec/ecx_meth.c" 3 4
                          ((void *)0)
# 280 "../crypto/ec/ecx_meth.c"
                              ;
    ECX_KEY *ecx = 
# 281 "../crypto/ec/ecx_meth.c" 3 4
                  ((void *)0)
# 281 "../crypto/ec/ecx_meth.c"
                      ;

    if (pkey->keymgmt != 
# 283 "../crypto/ec/ecx_meth.c" 3 4
                        ((void *)0)
# 283 "../crypto/ec/ecx_meth.c"
                            )
        libctx = ossl_provider_libctx(EVP_KEYMGMT_get0_provider(pkey->keymgmt));

    ecx = ossl_ecx_key_op(
# 286 "../crypto/ec/ecx_meth.c" 3 4
                         ((void *)0)
# 286 "../crypto/ec/ecx_meth.c"
                             , pub, len, pkey->ameth->pkey_id,
                          KEY_OP_PUBLIC, libctx, 
# 287 "../crypto/ec/ecx_meth.c" 3 4
                                                ((void *)0)
# 287 "../crypto/ec/ecx_meth.c"
                                                    );

    if (ecx != 
# 289 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 289 "../crypto/ec/ecx_meth.c"
                  ) {
        EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, ecx);
        return 1;
    }
                            ...
                            size_t *len)
{
    ...
    if (priv == 
# 301 "../crypto/ec/ecx_meth.c" 3 4
               ((void *)0)
# 301 "../crypto/ec/ecx_meth.c"
                   ) {
        *len = (((pkey->ameth->pkey_id) == 1034 || (pkey->ameth->pkey_id) == 1087) ? 32 : ((pkey->ameth->pkey_id) == 1035 ? 56 : 57));
        return 1;
    }

    if (key == 
# 306 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
            
# 307 "../crypto/ec/ecx_meth.c"
           || key->privkey == 
# 307 "../crypto/ec/ecx_meth.c" 3 4
                              ((void *)0)
            
# 308 "../crypto/ec/ecx_meth.c"
                           ...
                           size_t *len)
{
    ...
    if (pub == 
# 322 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 322 "../crypto/ec/ecx_meth.c"
                  ) {
        *len = (((pkey->ameth->pkey_id) == 1034 || (pkey->ameth->pkey_id) == 1087) ? 32 : ((pkey->ameth->pkey_id) == 1035 ? 56 : 57));
        return 1;
    }
    ...
    if (key == 
# 327 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
            
# 328 "../crypto/ec/ecx_meth.c"
           || *len < (size_t)(((pkey->ameth->pkey_id) == 1034 || (pkey->ameth->pkey_id) == 1087) ? 32 : ((pkey->ameth->pkey_id) == 1035 ? 56 : 57)))
        return 0;
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    OSSL_PARAM *params = 
# 352 "../crypto/ec/ecx_meth.c" 3 4
                        ((void *)0)
# 352 "../crypto/ec/ecx_meth.c"
                            ;
    int selection = 0;
    int rv = 0;

    if (tmpl == 
# 356 "../crypto/ec/ecx_meth.c" 3 4
               ((void *)0)
# 356 "../crypto/ec/ecx_meth.c"
                   )
        return 0;


    if (!OSSL_PARAM_BLD_push_octet_string(tmpl, "pub",
                                          key->pubkey, key->keylen))
        goto err;
    selection |= 0x02;

    if (key->privkey != 
# 365 "../crypto/ec/ecx_meth.c" 3 4
                       ((void *)0)
# 365 "../crypto/ec/ecx_meth.c"
                           ) {
                                   ...
                                   int keytype)
{
    ...
    ECX_KEY *ecx = ossl_ecx_key_new(pctx->libctx, (((keytype) == 1034 || (keytype) == 1087) ? ((keytype) == 1034 ? ECX_KEY_TYPE_X25519 : ECX_KEY_TYPE_ED25519) : ((keytype) == 1035 ? ECX_KEY_TYPE_X448 : ECX_KEY_TYPE_ED448)), 0,
                                    pctx->propquery);

    if (ecx == 
# 392 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 392 "../crypto/ec/ecx_meth.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",393,__func__), ERR_set_error)((5),((16 | (0x2 << 18L))),
# 393 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 393 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
...
{
    ECX_KEY *ecx = from->pkey.ecx, *dupkey = 
# 407 "../crypto/ec/ecx_meth.c" 3 4
                                            ((void *)0)
# 407 "../crypto/ec/ecx_meth.c"
                                                ;
    int ret;

    if (ecx != 
# 410 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 410 "../crypto/ec/ecx_meth.c"
                  ) {
        dupkey = ossl_ecx_key_dup(ecx, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ));
        if (dupkey == 
# 412 "../crypto/ec/ecx_meth.c" 3 4
                     ((void *)0)
# 412 "../crypto/ec/ecx_meth.c"
                         )
            return 0;
    }
...
{
    return ecx_generic_import_from(params, vpctx, 1034);
}
...
# 439 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 439 "../crypto/ec/ecx_meth.c"
       ,
    ecx_priv_encode,
    ecx_priv_print,
...
# 453 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 453 "../crypto/ec/ecx_meth.c"
       ,
    
# 454 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 454 "../crypto/ec/ecx_meth.c"
       ,

    
# 456 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 456 "../crypto/ec/ecx_meth.c"
       ,
    
# 457 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 457 "../crypto/ec/ecx_meth.c"
       ,
    
# 458 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 458 "../crypto/ec/ecx_meth.c"
       ,

    
# 460 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 460 "../crypto/ec/ecx_meth.c"
       ,
    
# 461 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 461 "../crypto/ec/ecx_meth.c"
       ,
    
# 462 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 462 "../crypto/ec/ecx_meth.c"
       ,
...
{
    return ecx_generic_import_from(params, vpctx, 1035);
}
...
# 493 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 493 "../crypto/ec/ecx_meth.c"
       ,
    ecx_priv_encode,
    ecx_priv_print,
...
# 507 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 507 "../crypto/ec/ecx_meth.c"
       ,
    
# 508 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 508 "../crypto/ec/ecx_meth.c"
       ,

    
# 510 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 510 "../crypto/ec/ecx_meth.c"
       ,
    
# 511 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 511 "../crypto/ec/ecx_meth.c"
       ,
    
# 512 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 512 "../crypto/ec/ecx_meth.c"
       ,

    
# 514 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 514 "../crypto/ec/ecx_meth.c"
       ,
    
# 515 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 515 "../crypto/ec/ecx_meth.c"
       ,
    
# 516 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 516 "../crypto/ec/ecx_meth.c"
       ,
                           ...
                           const ASN1_BIT_STRING *str, EVP_PKEY *pkey)
{
    ...
    X509_ALGOR_get0(&obj, &ptype, 
# 549 "../crypto/ec/ecx_meth.c" 3 4
                                 ((void *)0)
# 549 "../crypto/ec/ecx_meth.c"
                                     , sigalg);
    nid = OBJ_obj2nid(obj);
    if ((nid != 1087 && nid != 1088) || ptype != -1) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",552,__func__), ERR_set_error)((16),(102),
# 552 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 552 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }

    if (!EVP_DigestVerifyInit(ctx, 
# 556 "../crypto/ec/ecx_meth.c" 3 4
                                  ((void *)0)
# 556 "../crypto/ec/ecx_meth.c"
                                      , 
# 556 "../crypto/ec/ecx_meth.c" 3 4
                                        ((void *)0)
# 556 "../crypto/ec/ecx_meth.c"
...
static int ecd_item_sign(X509_ALGOR *alg1, X509_ALGOR *alg2, int nid)
{
    ...
    (void)X509_ALGOR_set0(alg1, OBJ_nid2obj(nid), -1, 
# 566 "../crypto/ec/ecx_meth.c" 3 4
                                                               ((void *)0)
# 566 "../crypto/ec/ecx_meth.c"
                                                                   );
    if (alg2 != 
# 567 "../crypto/ec/ecx_meth.c" 3 4
               ((void *)0)
# 567 "../crypto/ec/ecx_meth.c"
                   )
        (void)X509_ALGOR_set0(alg2, OBJ_nid2obj(nid), -1, 
# 568 "../crypto/ec/ecx_meth.c" 3 4
                                                                   ((void *)0)
# 568 "../crypto/ec/ecx_meth.c"
                                                                       );
...
{
    return ecx_generic_import_from(params, vpctx, 1087);
}
...
# 622 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 622 "../crypto/ec/ecx_meth.c"
       ,
    ecx_priv_encode,
    ecx_priv_print,
...
# 636 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 636 "../crypto/ec/ecx_meth.c"
       ,
    
# 637 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 637 "../crypto/ec/ecx_meth.c"
       ,
    ecd_item_verify,
    ecd_item_sign25519,
...
# 642 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 642 "../crypto/ec/ecx_meth.c"
       ,
    
# 643 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 643 "../crypto/ec/ecx_meth.c"
       ,
    
# 644 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 644 "../crypto/ec/ecx_meth.c"
       ,
...
{
    return ecx_generic_import_from(params, vpctx, 1088);
}
...
# 675 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 675 "../crypto/ec/ecx_meth.c"
       ,
    ecx_priv_encode,
    ecx_priv_print,
...
# 689 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 689 "../crypto/ec/ecx_meth.c"
       ,
    
# 690 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 690 "../crypto/ec/ecx_meth.c"
       ,
    ecd_item_verify,
    ecd_item_sign448,
    ecd_sig_info_set448,
...
# 695 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 695 "../crypto/ec/ecx_meth.c"
       ,
    
# 696 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 696 "../crypto/ec/ecx_meth.c"
       ,
    
# 697 "../crypto/ec/ecx_meth.c" 3 4
   ((void *)0)
# 697 "../crypto/ec/ecx_meth.c"
       ,
...
{
    ECX_KEY *ecx = ossl_ecx_key_op(
# 713 "../crypto/ec/ecx_meth.c" 3 4
                                  ((void *)0)
# 713 "../crypto/ec/ecx_meth.c"
                                      , 
# 713 "../crypto/ec/ecx_meth.c" 3 4
                                        ((void *)0)
# 713 "../crypto/ec/ecx_meth.c"
                                            , 0, ctx->pmeth->pkey_id,
                                   KEY_OP_KEYGEN, 
# 714 "../crypto/ec/ecx_meth.c" 3 4
                                                 ((void *)0)
# 714 "../crypto/ec/ecx_meth.c"
                                                     , 
# 714 "../crypto/ec/ecx_meth.c" 3 4
                                                       ((void *)0)
# 714 "../crypto/ec/ecx_meth.c"
    ...
    if (ecx != 
# 716 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 716 "../crypto/ec/ecx_meth.c"
                  ) {
                                          ...
                                          const unsigned char **pubkey)
{
    ...
    if (ctx->pkey == 
# 730 "../crypto/ec/ecx_meth.c" 3 4
                    ((void *)0) 
# 730 "../crypto/ec/ecx_meth.c"
                         || ctx->peerkey == 
# 730 "../crypto/ec/ecx_meth.c" 3 4
                                            ((void *)0)
# 730 "../crypto/ec/ecx_meth.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",731,__func__), ERR_set_error)((16),(140),
# 731 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 731 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
    ...
    if (ecxkey == 
# 736 "../crypto/ec/ecx_meth.c" 3 4
                 ((void *)0) 
# 736 "../crypto/ec/ecx_meth.c"
                      || ecxkey->privkey == 
# 736 "../crypto/ec/ecx_meth.c" 3 4
                                            ((void *)0)
# 736 "../crypto/ec/ecx_meth.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",737,__func__), ERR_set_error)((16),(123),
# 737 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 737 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
    if (peerkey == 
# 740 "../crypto/ec/ecx_meth.c" 3 4
                  ((void *)0)
# 740 "../crypto/ec/ecx_meth.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",741,__func__), ERR_set_error)((16),(133),
# 741 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 741 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
                                ...
                                size_t *keylen)
{
    ...
    if (!validate_ecx_derive(ctx, key, keylen, &privkey, &pubkey)
            || (key != 
# 756 "../crypto/ec/ecx_meth.c" 3 4
                      ((void *)0)
                
# 757 "../crypto/ec/ecx_meth.c"
                              ...
                              size_t *keylen)
{
    ...
    if (!validate_ecx_derive(ctx, key, keylen, &privkey, &pubkey)
            || (key != 
# 769 "../crypto/ec/ecx_meth.c" 3 4
                      ((void *)0)
                
# 770 "../crypto/ec/ecx_meth.c"
                                    ...
                                    size_t tbslen)
{
    ...
    if (edkey == 
# 810 "../crypto/ec/ecx_meth.c" 3 4
                ((void *)0)
# 810 "../crypto/ec/ecx_meth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",811,__func__), ERR_set_error)((16),(116),
# 811 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 811 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }

    if (sig == 
# 815 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 815 "../crypto/ec/ecx_meth.c"
                  ) {
        *siglen = 64;
        return 1;
    }
    if (*siglen < 64) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",820,__func__), ERR_set_error)((16),(100),
# 820 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 820 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
...
# 826 "../crypto/ec/ecx_meth.c" 3 4
                         ((void *)0)
# 826 "../crypto/ec/ecx_meth.c"
                             , 0,
                          
# 827 "../crypto/ec/ecx_meth.c" 3 4
                         ((void *)0)
# 827 "../crypto/ec/ecx_meth.c"
                             , 
# 827 "../crypto/ec/ecx_meth.c" 3 4
                               ((void *)0)
# 827 "../crypto/ec/ecx_meth.c"
                                  ...
                                  size_t tbslen)
{
    ...
    if (edkey == 
# 839 "../crypto/ec/ecx_meth.c" 3 4
                ((void *)0)
# 839 "../crypto/ec/ecx_meth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",840,__func__), ERR_set_error)((16),(116),
# 840 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 840 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }

    if (sig == 
# 844 "../crypto/ec/ecx_meth.c" 3 4
              ((void *)0)
# 844 "../crypto/ec/ecx_meth.c"
                  ) {
        *siglen = 114;
        return 1;
    }
    if (*siglen < 114) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",849,__func__), ERR_set_error)((16),(100),
# 849 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 849 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
    ...
    if (ossl_ed448_sign(edkey->libctx, sig, tbs, tbslen, edkey->pubkey,
                        edkey->privkey, 
# 854 "../crypto/ec/ecx_meth.c" 3 4
                                       ((void *)0)
# 854 "../crypto/ec/ecx_meth.c"
                                           , 0, 0, edkey->propq) == 0)
        return 0;
    *siglen = 114;
    return 1;
                                      ...
                                      size_t tbslen)
{
    ...
    if (edkey == 
# 866 "../crypto/ec/ecx_meth.c" 3 4
                ((void *)0)
# 866 "../crypto/ec/ecx_meth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",867,__func__), ERR_set_error)((16),(116),
# 867 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 867 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
...
# 876 "../crypto/ec/ecx_meth.c" 3 4
                              ((void *)0)
# 876 "../crypto/ec/ecx_meth.c"
                                  , 0,
                                    ...
                                    size_t tbslen)
{
    ...
    if (edkey == 
# 886 "../crypto/ec/ecx_meth.c" 3 4
                ((void *)0)
# 886 "../crypto/ec/ecx_meth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",887,__func__), ERR_set_error)((16),(116),
# 887 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 887 "../crypto/ec/ecx_meth.c"
       );
        return 0;
    }
...
# 895 "../crypto/ec/ecx_meth.c" 3 4
                            ((void *)0)
# 895 "../crypto/ec/ecx_meth.c"
                                , 0, 0, edkey->propq);
}
...
static int pkey_ecd_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2)
{
    ...
    case 1:
        ...
        if (p2 == 
# 903 "../crypto/ec/ecx_meth.c" 3 4
                 ((void *)0) 
# 903 "../crypto/ec/ecx_meth.c"
                      || (const EVP_MD *)p2 == EVP_md_null())
            return 1;
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_meth.c",905,__func__), ERR_set_error)((16),(138),
# 905 "../crypto/ec/ecx_meth.c" 3 4
       ((void *)0)
# 905 "../crypto/ec/ecx_meth.c"
       );
        return 0;
