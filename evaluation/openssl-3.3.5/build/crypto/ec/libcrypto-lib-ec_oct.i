# 0 "../crypto/ec/ec_oct.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_oct.c"
# 15 "../crypto/ec/ec_oct.c"
...
# 23 "../crypto/ec/ec_oct.c" 2

int EC_POINT_set_compressed_coordinates(const EC_GROUP *group, EC_POINT *point,
                                        const BIGNUM *x, int y_bit, BN_CTX *ctx)
{
    if (group->meth->point_set_compressed_coordinates == 
# 27 "../crypto/ec/ec_oct.c" 3 4
                                                        ((void *)0)
        
# 28 "../crypto/ec/ec_oct.c"
       && !(group->meth->flags & 0x1)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",29,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 29 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 29 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",33,__func__), ERR_set_error)((16),(101),
# 33 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 33 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
...
{
    if (point == 
# 77 "../crypto/ec/ec_oct.c" 3 4
                ((void *)0)
# 77 "../crypto/ec/ec_oct.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",78,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 78 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 78 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (group->meth->point2oct == 0
        && !(group->meth->flags & 0x1)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",83,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 83 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 83 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",87,__func__), ERR_set_error)((16),(101),
# 87 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 87 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (group->meth->flags & 0x1) {
                       ...
                       const unsigned char *buf, size_t len, BN_CTX *ctx)
{
    if (group->meth->oct2point == 0
        && !(group->meth->flags & 0x1)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",114,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 114 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 114 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_oct.c",118,__func__), ERR_set_error)((16),(101),
# 118 "../crypto/ec/ec_oct.c" 3 4
       ((void *)0)
# 118 "../crypto/ec/ec_oct.c"
       );
        return 0;
    }
    if (group->meth->flags & 0x1) {
...
# 144 "../crypto/ec/ec_oct.c" 3 4
                                                ((void *)0)
# 144 "../crypto/ec/ec_oct.c"
                                                    , 0, 
# 144 "../crypto/ec/ec_oct.c" 3 4
                                                         ((void *)0)
# 144 "../crypto/ec/ec_oct.c"
    ...
    if (len == 0)
        return 0;
    if ((buf = CRYPTO_malloc(len, "../crypto/ec/ec_oct.c", 147)) == 
# 147 "../crypto/ec/ec_oct.c" 3 4
                                      ((void *)0)
# 147 "../crypto/ec/ec_oct.c"
                                          )
        return 0;
    len = EC_POINT_point2oct(group, point, form, buf, len, ctx);
    if (len == 0) {
        CRYPTO_free(buf, "../crypto/ec/ec_oct.c", 151);
        return 0;
    }
    *pbuf = buf;
    return len;
