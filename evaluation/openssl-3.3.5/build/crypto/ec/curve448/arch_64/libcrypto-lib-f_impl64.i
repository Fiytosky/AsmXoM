# 0 "../crypto/ec/curve448/arch_64/f_impl64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/curve448/arch_64/f_impl64.c"
# 13 "../crypto/ec/curve448/arch_64/f_impl64.c"
...
# 14 "../crypto/ec/curve448/arch_64/f_impl64.c" 2
# 22 "../crypto/ec/curve448/arch_64/f_impl64.c"
# 1 "../crypto/ec/curve448/arch_64/../field.h" 1
# 16 "../crypto/ec/curve448/arch_64/../field.h"
...
# 17 "../crypto/ec/curve448/arch_64/../field.h" 2

# 1 "/usr/include/assert.h" 1 3 4
# 19 "../crypto/ec/curve448/arch_64/../field.h" 2
# 1 "../crypto/ec/curve448/arch_64/../word.h" 1
# 17 "../crypto/ec/curve448/arch_64/../word.h"
# 1 "/usr/include/assert.h" 1 3 4
# 18 "../crypto/ec/curve448/arch_64/../word.h" 2


# 1 "../crypto/ec/curve448/arch_64/../curve448utils.h" 1
# 40 "../crypto/ec/curve448/arch_64/../curve448utils.h"
...
# 71 "../crypto/ec/curve448/arch_64/../curve448utils.h"
typedef enum {
    C448_SUCCESS = -1,
    C448_FAILURE = 0
} c448_error_t;
...
# 21 "../crypto/ec/curve448/arch_64/../word.h" 2


# 1 "../crypto/ec/curve448/arch_64/../arch_64/arch_intrinsics.h" 1
# 22 "../crypto/ec/curve448/arch_64/../arch_64/arch_intrinsics.h"
static inline uint128_t widemul(uint64_t a, uint64_t b)
{
    return ((uint128_t) a) * b;
}
# 24 "../crypto/ec/curve448/arch_64/../word.h" 2
...
# 66 "../crypto/ec/curve448/arch_64/../word.h"
...
# 20 "../crypto/ec/curve448/arch_64/../field.h" 2
# 35 "../crypto/ec/curve448/arch_64/../field.h"
typedef struct gf_s {
...
# 1 "../crypto/ec/curve448/arch_64/../arch_64/f_impl.h" 1
# 21 "../crypto/ec/curve448/arch_64/../arch_64/f_impl.h"
...
# 76 "../crypto/ec/curve448/arch_64/../field.h" 2
...
# 86 "../crypto/ec/curve448/arch_64/../field.h" 3 4
   ((void) (0))
# 86 "../crypto/ec/curve448/arch_64/../field.h"
                ;
    if (n & 1) {
        ossl_gf_sqr(y, x);
        n--;
...
# 23 "../crypto/ec/curve448/arch_64/f_impl64.c" 2

void ossl_gf_mul(gf_s * __restrict__ cs, const gf as, const gf bs)
{
...
void ossl_gf_mulw_unsigned(gf_s * __restrict__ cs, const gf as, uint32_t b)
{
...
void ossl_gf_sqr(gf_s * __restrict__ cs, const gf as)
{
    const uint64_t *a = as->limb;
    uint64_t *c = cs->limb;
    uint128_t accum0 = 0, accum1 = 0, accum2;
