# 0 "../crypto/ec/curve448/eddsa.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/curve448/eddsa.c"
# 12 "../crypto/ec/curve448/eddsa.c"
...
# 13 "../crypto/ec/curve448/eddsa.c" 2
...
# 14 "../crypto/ec/curve448/eddsa.c" 2
...
# 15 "../crypto/ec/curve448/eddsa.c" 2
...
# 16 "../crypto/ec/curve448/eddsa.c" 2
...
# 17 "../crypto/ec/curve448/eddsa.c" 2
...
# 18 "../crypto/ec/curve448/eddsa.c" 2
# 1 "../crypto/ec/curve448/ed448.h" 1
# 16 "../crypto/ec/curve448/ed448.h"
# 1 "../crypto/ec/curve448/point_448.h" 1
# 17 "../crypto/ec/curve448/point_448.h"
...
# 18 "../crypto/ec/curve448/point_448.h" 2
...
# 17 "../crypto/ec/curve448/ed448.h" 2
...
ossl_c448_ed448_convert_private_key_to_x448(
                                    ...
                                    const uint8_t ed[57],
                                    const char *propq);
# 19 "../crypto/ec/curve448/eddsa.c" 2
                                 ...
                                 const char *propq)
{
    ...
    EVP_MD *shake256 = 
# 28 "../crypto/ec/curve448/eddsa.c" 3 4
                      ((void *)0)
# 28 "../crypto/ec/curve448/eddsa.c"
                          ;
    c448_error_t ret = C448_FAILURE;

    if (hashctx == 
# 31 "../crypto/ec/curve448/eddsa.c" 3 4
                  ((void *)0)
# 31 "../crypto/ec/curve448/eddsa.c"
                      )
        return C448_FAILURE;

    shake256 = EVP_MD_fetch(ctx, "SHAKE256", propq);
    if (shake256 == 
# 35 "../crypto/ec/curve448/eddsa.c" 3 4
                   ((void *)0)
# 35 "../crypto/ec/curve448/eddsa.c"
                       )
        goto err;

    if (!EVP_DigestInit_ex(hashctx, shake256, 
# 38 "../crypto/ec/curve448/eddsa.c" 3 4
                                             ((void *)0)
# 38 "../crypto/ec/curve448/eddsa.c"
                                                 )
...
static void clamp(uint8_t secret_scalar_ser[57])
{
    secret_scalar_ser[0] &= -4;
    secret_scalar_ser[57 - 1] = 0;
    secret_scalar_ser[57 - 2] |= 0x80;
}
                                       ...
                                       const char *propq)
{
    ...
    uint8_t dom[2];
    EVP_MD *shake256 = 
# 67 "../crypto/ec/curve448/eddsa.c" 3 4
                      ((void *)0)
# 67 "../crypto/ec/curve448/eddsa.c"
                          ;

    if (context_len > 
# 69 "../crypto/ec/curve448/eddsa.c" 3 4
                     (255)
# 69 "../crypto/ec/curve448/eddsa.c"
                              )
        return C448_FAILURE;
    ...
    shake256 = EVP_MD_fetch(ctx, "SHAKE256", propq);
    if (shake256 == 
# 77 "../crypto/ec/curve448/eddsa.c" 3 4
                   ((void *)0)
# 77 "../crypto/ec/curve448/eddsa.c"
                       )
        return C448_FAILURE;

    if (!EVP_DigestInit_ex(hashctx, shake256, 
# 80 "../crypto/ec/curve448/eddsa.c" 3 4
                                             ((void *)0)
# 80 "../crypto/ec/curve448/eddsa.c"
                                                 )
                            ...
                            const char *propq)
{
    ...
    return oneshot_hash(ctx, x, 56, ed,
                        57, propq);
}
...
# 138 "../crypto/ec/curve448/eddsa.c"
    for (c = 1; c < 4; c <<= 1)
                     ...
                     size_t context_len, const char *propq)
{
    ...
    uint8_t nonce_point[57] = { 0 };
    unsigned int c;
    curve448_scalar_t challenge_scalar;

    if (hashctx == 
# 171 "../crypto/ec/curve448/eddsa.c" 3 4
                  ((void *)0)
# 171 "../crypto/ec/curve448/eddsa.c"
                      )
        return C448_FAILURE;
    ...
    OPENSSL_cleanse(signature, (57 + 57));
    memcpy(signature, nonce_point, sizeof(nonce_point));
    ossl_curve448_scalar_encode(&signature[57],
                                challenge_scalar);
                    ...
                    uint8_t context_len, const char *propq)
{
...

    {
        ...
        if (hashctx == 
# 329 "../crypto/ec/curve448/eddsa.c" 3 4
                      ((void *)0)
                
# 330 "../crypto/ec/curve448/eddsa.c"
               || !hash_init_with_dom(ctx, hashctx, prehashed, 0, context,
                                       context_len, propq)
                || !EVP_DigestUpdate(hashctx, signature, 57)
                || !EVP_DigestUpdate(hashctx, pubkey, 57)
                || !EVP_DigestUpdate(hashctx, message, message_len)
                || !EVP_DigestFinalXOF(hashctx, challenge, sizeof(challenge))) {
            EVP_MD_CTX_free(hashctx);
