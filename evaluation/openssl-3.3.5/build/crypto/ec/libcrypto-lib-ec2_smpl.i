# 0 "../crypto/ec/ec2_smpl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec2_smpl.c"
# 15 "../crypto/ec/ec2_smpl.c"
...
int ossl_ec_GF2m_simple_group_init(EC_GROUP *group)
{
    ...
    if (group->field == 
# 34 "../crypto/ec/ec2_smpl.c" 3 4
                       ((void *)0) 
# 34 "../crypto/ec/ec2_smpl.c"
                            || group->a == 
# 34 "../crypto/ec/ec2_smpl.c" 3 4
                                           ((void *)0) 
# 34 "../crypto/ec/ec2_smpl.c"
...
int ossl_ec_GF2m_simple_group_copy(EC_GROUP *dest, const EC_GROUP *src)
{
    ...
    if (bn_wexpand(dest->a, (int)(dest->poly[0] + (8 * 8) - 1) / (8 * 8)) ==
        
# 90 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 90 "../crypto/ec/ec2_smpl.c"
           )
        return 0;
    if (bn_wexpand(dest->b, (int)(dest->poly[0] + (8 * 8) - 1) / (8 * 8)) ==
        
# 93 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 93 "../crypto/ec/ec2_smpl.c"
           )
        return 0;
                                        ...
                                        const BIGNUM *b, BN_CTX *ctx)
{
    ...
    if ((i != 5) && (i != 3)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",112,__func__), ERR_set_error)((16),(131),
# 112 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 112 "../crypto/ec/ec2_smpl.c"
       );
        goto err;
    }
    ...
    if (!BN_GF2m_mod_arr(group->a, a, group->poly))
        goto err;
    if (bn_wexpand(group->a, (int)(group->poly[0] + (8 * 8) - 1) / (8 * 8))
        == 
# 120 "../crypto/ec/ec2_smpl.c" 3 4
          ((void *)0)
# 120 "../crypto/ec/ec2_smpl.c"
              )
        goto err;
    ...
    if (!BN_GF2m_mod_arr(group->b, b, group->poly))
        goto err;
    if (bn_wexpand(group->b, (int)(group->poly[0] + (8 * 8) - 1) / (8 * 8))
        == 
# 128 "../crypto/ec/ec2_smpl.c" 3 4
          ((void *)0)
# 128 "../crypto/ec/ec2_smpl.c"
              )
        goto err;
                                        ...
                                        BIGNUM *a, BIGNUM *b, BN_CTX *ctx)
{
    ...
    if (p != 
# 146 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 146 "../crypto/ec/ec2_smpl.c"
                ) {
    ...
    if (a != 
# 151 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 151 "../crypto/ec/ec2_smpl.c"
                ) {
    ...
    if (b != 
# 156 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 156 "../crypto/ec/ec2_smpl.c"
                ) {
                                                 ...
                                                 BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 186 "../crypto/ec/ec2_smpl.c" 3 4
                     ((void *)0)
# 186 "../crypto/ec/ec2_smpl.c"
                         ;

    if (ctx == 
# 188 "../crypto/ec/ec2_smpl.c" 3 4
              ((void *)0)
# 188 "../crypto/ec/ec2_smpl.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 190 "../crypto/ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 190 "../crypto/ec/ec2_smpl.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",191,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 191 "../crypto/ec/ec2_smpl.c" 3 4
           ((void *)0)
# 191 "../crypto/ec/ec2_smpl.c"
           );
            goto err;
        }
    }
    ...
    b = BN_CTX_get(ctx);
    if (b == 
# 198 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 198 "../crypto/ec/ec2_smpl.c"
                )
        goto err;
...
int ossl_ec_GF2m_simple_point_init(EC_POINT *point)
{
    ...
    if (point->X == 
# 228 "../crypto/ec/ec2_smpl.c" 3 4
                   ((void *)0) 
# 228 "../crypto/ec/ec2_smpl.c"
                        || point->Y == 
# 228 "../crypto/ec/ec2_smpl.c" 3 4
                                       ((void *)0) 
# 228 "../crypto/ec/ec2_smpl.c"
                                                     ...
                                                     BN_CTX *ctx)
{
    int ret = 0;
    if (x == 
# 295 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0) 
# 295 "../crypto/ec/ec2_smpl.c"
                 || y == 
# 295 "../crypto/ec/ec2_smpl.c" 3 4
                         ((void *)0)
# 295 "../crypto/ec/ec2_smpl.c"
                             ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",296,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 296 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 296 "../crypto/ec/ec2_smpl.c"
       );
        return 0;
    }
                                                     ...
                                                     BN_CTX *ctx)
{
    ...
    if (EC_POINT_is_at_infinity(group, point)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",328,__func__), ERR_set_error)((16),(106),
# 328 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 328 "../crypto/ec/ec2_smpl.c"
       );
        return 0;
    }

    if (BN_cmp(point->Z, BN_value_one())) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",333,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 333 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 333 "../crypto/ec/ec2_smpl.c"
       );
        return 0;
    }
    if (x != 
# 336 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 336 "../crypto/ec/ec2_smpl.c"
                ) {
    ...
    if (y != 
# 341 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 341 "../crypto/ec/ec2_smpl.c"
                ) {
                            ...
                            const EC_POINT *a, const EC_POINT *b, BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 362 "../crypto/ec/ec2_smpl.c" 3 4
                     ((void *)0)
# 362 "../crypto/ec/ec2_smpl.c"
                         ;
    ...
    if (ctx == 
# 378 "../crypto/ec/ec2_smpl.c" 3 4
              ((void *)0)
# 378 "../crypto/ec/ec2_smpl.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 380 "../crypto/ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 380 "../crypto/ec/ec2_smpl.c"
    ...
    t = BN_CTX_get(ctx);
    if (t == 
# 394 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 394 "../crypto/ec/ec2_smpl.c"
                )
        goto err;
...
# 490 "../crypto/ec/ec2_smpl.c" 3 4
                                   ((void *)0)
        
# 491 "../crypto/ec/ec2_smpl.c"
                                    ...
                                    BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 517 "../crypto/ec/ec2_smpl.c" 3 4
                     ((void *)0)
# 517 "../crypto/ec/ec2_smpl.c"
                         ;
    ...
    if (ctx == 
# 531 "../crypto/ec/ec2_smpl.c" 3 4
              ((void *)0)
# 531 "../crypto/ec/ec2_smpl.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 533 "../crypto/ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 533 "../crypto/ec/ec2_smpl.c"
                      )
            return -1;
    }
    ...
    lh = BN_CTX_get(ctx);
    if (lh == 
# 541 "../crypto/ec/ec2_smpl.c" 3 4
             ((void *)0)
# 541 "../crypto/ec/ec2_smpl.c"
                 )
        goto err;
                            ...
                            const EC_POINT *b, BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 587 "../crypto/ec/ec2_smpl.c" 3 4
                     ((void *)0)
# 587 "../crypto/ec/ec2_smpl.c"
                         ;
    ...
    if (ctx == 
# 602 "../crypto/ec/ec2_smpl.c" 3 4
              ((void *)0)
# 602 "../crypto/ec/ec2_smpl.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 604 "../crypto/ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 604 "../crypto/ec/ec2_smpl.c"
                      )
            return -1;
    }
    ...
    bY = BN_CTX_get(ctx);
    if (bY == 
# 614 "../crypto/ec/ec2_smpl.c" 3 4
             ((void *)0)
# 614 "../crypto/ec/ec2_smpl.c"
                 )
        goto err;
                                    ...
                                    BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 638 "../crypto/ec/ec2_smpl.c" 3 4
                     ((void *)0)
# 638 "../crypto/ec/ec2_smpl.c"
                         ;
    ...
    if (ctx == 
# 645 "../crypto/ec/ec2_smpl.c" 3 4
              ((void *)0)
# 645 "../crypto/ec/ec2_smpl.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 647 "../crypto/ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 647 "../crypto/ec/ec2_smpl.c"
                      )
            return 0;
    }
    ...
    y = BN_CTX_get(ctx);
    if (y == 
# 655 "../crypto/ec/ec2_smpl.c" 3 4
            ((void *)0)
# 655 "../crypto/ec/ec2_smpl.c"
                )
        goto err;
                              ...
                              EC_POINT *p, BN_CTX *ctx)
{
    ...
    do {
        if (!BN_priv_rand_ex(s->Z, BN_num_bits(group->field) - 1,
                             -1, 0, 0, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",734,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 734 "../crypto/ec/ec2_smpl.c" 3 4
           ((void *)0)
# 734 "../crypto/ec/ec2_smpl.c"
           );
            return 0;
        }
...
# 740 "../crypto/ec/ec2_smpl.c" 3 4
                                     ((void *)0)
         
# 741 "../crypto/ec/ec2_smpl.c"
    ...
    do {
        if (!BN_priv_rand_ex(r->Y, BN_num_bits(group->field) - 1,
                             -1, 0, 0, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",749,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 749 "../crypto/ec/ec2_smpl.c" 3 4
           ((void *)0)
# 749 "../crypto/ec/ec2_smpl.c"
           );
            return 0;
        }
    ...
    if ((group->meth->field_encode != 
# 754 "../crypto/ec/ec2_smpl.c" 3 4
                                     ((void *)0)
         
# 755 "../crypto/ec/ec2_smpl.c"
                               ...
                               EC_POINT *p, BN_CTX *ctx)
{
    int ret = 0;
    BIGNUM *t0, *t1, *t2 = 
# 810 "../crypto/ec/ec2_smpl.c" 3 4
                          ((void *)0)
# 810 "../crypto/ec/ec2_smpl.c"
                              ;
    ...
    if (BN_is_zero(s->Z)) {
        if (!EC_POINT_copy(r, p)
            ...
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",818,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 818 "../crypto/ec/ec2_smpl.c" 3 4
           ((void *)0)
# 818 "../crypto/ec/ec2_smpl.c"
           );
            return 0;
        }
        return 1;
    ...
    t2 = BN_CTX_get(ctx);
    if (t2 == 
# 828 "../crypto/ec/ec2_smpl.c" 3 4
             ((void *)0)
# 828 "../crypto/ec/ec2_smpl.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",829,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 829 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 829 "../crypto/ec/ec2_smpl.c"
       );
        goto err;
    }
                              ...
                              BN_CTX *ctx)
{
    int ret = 0;
    EC_POINT *t = 
# 875 "../crypto/ec/ec2_smpl.c" 3 4
                 ((void *)0)
# 875 "../crypto/ec/ec2_smpl.c"
                     ;
# 891 "../crypto/ec/ec2_smpl.c"
    if (num > 1 || BN_is_zero(group->order) || BN_is_zero(group->cofactor))
        return ossl_ec_wNAF_mul(group, r, scalar, num, points, scalars, ctx);

    if (scalar != 
# 894 "../crypto/ec/ec2_smpl.c" 3 4
                 ((void *)0) 
# 894 "../crypto/ec/ec2_smpl.c"
                      && num == 0)

        return ossl_ec_scalar_mul_ladder(group, r, scalar, 
# 896 "../crypto/ec/ec2_smpl.c" 3 4
                                                          ((void *)0)
# 896 "../crypto/ec/ec2_smpl.c"
                                                              , ctx);

    if (scalar == 
# 898 "../crypto/ec/ec2_smpl.c" 3 4
                 ((void *)0) 
# 898 "../crypto/ec/ec2_smpl.c"
                      && num == 1)
...
# 907 "../crypto/ec/ec2_smpl.c" 3 4
                                    ((void *)0)
# 907 "../crypto/ec/ec2_smpl.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",908,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 908 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 908 "../crypto/ec/ec2_smpl.c"
       );
        return 0;
    }

    if (!ossl_ec_scalar_mul_ladder(group, t, scalar, 
# 912 "../crypto/ec/ec2_smpl.c" 3 4
                                                    ((void *)0)
# 912 "../crypto/ec/ec2_smpl.c"
                                                        , ctx)
                                    ...
                                    const BIGNUM *a, BN_CTX *ctx)
{
    ...
    if (!(ret = BN_GF2m_mod_inv(r, a, group->field, ctx)))
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_smpl.c",935,__func__), ERR_set_error)((16),(165),
# 935 "../crypto/ec/ec2_smpl.c" 3 4
       ((void *)0)
# 935 "../crypto/ec/ec2_smpl.c"
       );
    return ret;
}
