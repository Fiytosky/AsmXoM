# 0 "../crypto/ec/ecp_nistz256.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecp_nistz256.c"
# 25 "../crypto/ec/ecp_nistz256.c"
...
# 32 "../crypto/ec/ecp_nistz256.c" 2
# 43 "../crypto/ec/ecp_nistz256.c"
typedef unsigned short u16;

typedef struct {
    unsigned long X[(256/(8 * 8))];
    unsigned long Y[(256/(8 * 8))];
    unsigned long Z[(256/(8 * 8))];
} P256_POINT;
...
# 90 "../crypto/ec/ecp_nistz256.c"
void ecp_nistz256_add(unsigned long res[(256/(8 * 8))],
                      const unsigned long a[(256/(8 * 8))],
                      const unsigned long b[(256/(8 * 8))]);

void ecp_nistz256_mul_by_2(unsigned long res[(256/(8 * 8))],
                           const unsigned long a[(256/(8 * 8))]);

void ecp_nistz256_mul_by_3(unsigned long res[(256/(8 * 8))],
                           const unsigned long a[(256/(8 * 8))]);


void ecp_nistz256_div_by_2(unsigned long res[(256/(8 * 8))],
                           const unsigned long a[(256/(8 * 8))]);

void ecp_nistz256_sub(unsigned long res[(256/(8 * 8))],
                      const unsigned long a[(256/(8 * 8))],
                      const unsigned long b[(256/(8 * 8))]);

void ecp_nistz256_neg(unsigned long res[(256/(8 * 8))], const unsigned long a[(256/(8 * 8))]);

void ecp_nistz256_mul_mont(unsigned long res[(256/(8 * 8))],
                           const unsigned long a[(256/(8 * 8))],
                           const unsigned long b[(256/(8 * 8))]);

void ecp_nistz256_sqr_mont(unsigned long res[(256/(8 * 8))],
                           const unsigned long a[(256/(8 * 8))]);

void ecp_nistz256_from_mont(unsigned long res[(256/(8 * 8))],
                            const unsigned long in[(256/(8 * 8))]);

void ecp_nistz256_to_mont(unsigned long res[(256/(8 * 8))],
                          const unsigned long in[(256/(8 * 8))]);
...
static const unsigned long ONE[(256/(8 * 8))] = {
    ((unsigned long)0x00000000<<32|0x00000001), ((unsigned long)0xffffffff<<32|0x00000000),
    ((unsigned long)0xffffffff<<32|0xffffffff), ((unsigned long)0x00000000<<32|0xfffffffe)
};
...
static void copy_conditional(unsigned long dst[(256/(8 * 8))],
                             const unsigned long src[(256/(8 * 8))], unsigned long move)
{
    unsigned long mask1 = 0-move;
    unsigned long mask2 = ~mask1;
...
static unsigned long is_zero(unsigned long in)
{
    in |= (0 - in);
    in = ~in;
    in >>= (8 * 8) - 1;
...
static unsigned long is_equal(const unsigned long a[(256/(8 * 8))],
                         const unsigned long b[(256/(8 * 8))])
{
    unsigned long res;
...
static unsigned long is_one(const BIGNUM *z)
{
    unsigned long res = 0;
    unsigned long *a = bn_get_words(z);

    if (bn_get_top(z) == ((256/(8 * 8)) - (256/(8 * 8)) / 8)) {
        res = a[0] ^ ONE[0];
        res |= a[1] ^ ONE[1];
        res |= a[2] ^ ONE[2];
        res |= a[3] ^ ONE[3];
...
# 520 "../crypto/ec/ecp_nistz256.c"
static void ecp_nistz256_mod_inverse(unsigned long r[(256/(8 * 8))],
                                     const unsigned long in[(256/(8 * 8))])
{
    ...
    unsigned long p2[(256/(8 * 8))];
    unsigned long p4[(256/(8 * 8))];
    unsigned long p8[(256/(8 * 8))];
    unsigned long p16[(256/(8 * 8))];
    unsigned long p32[(256/(8 * 8))];
    unsigned long res[(256/(8 * 8))];
    int i;
 ...
 static int ecp_nistz256_bignum_to_field_elem(unsigned long out[(256/(8 * 8))],
                                                    const BIGNUM *in)
{
    return bn_copy_words(out, in, (256/(8 * 8)));
}
...
# 616 "../crypto/ec/ecp_nistz256.c" 3 4
                                ((void *)0)
# 616 "../crypto/ec/ecp_nistz256.c"
                                    ;
...
# 621 "../crypto/ec/ecp_nistz256.c" 3 4
                            ((void *)0)
# 621 "../crypto/ec/ecp_nistz256.c"
                                ;
    P256_POINT (*table)[16] = 
# 622 "../crypto/ec/ecp_nistz256.c" 3 4
                             ((void *)0)
# 622 "../crypto/ec/ecp_nistz256.c"
                                 ;
    void *table_storage = 
# 623 "../crypto/ec/ecp_nistz256.c" 3 4
                         ((void *)0)
# 623 "../crypto/ec/ecp_nistz256.c"
                             ;

    if ((num * 16 + 6) > (((1U<<(sizeof(int)*8-1))-1)/sizeof(P256_POINT))
        || (table_storage =
            CRYPTO_malloc((num * 16 + 5) * sizeof(P256_POINT) + 64, "../crypto/ec/ecp_nistz256.c", 627)) == 
# 627 "../crypto/ec/ecp_nistz256.c" 3 4
                                                                        ((void *)0)
        
# 628 "../crypto/ec/ecp_nistz256.c"
       || (p_str =
            CRYPTO_malloc(num * 33 * sizeof(unsigned char), "../crypto/ec/ecp_nistz256.c", 629)) == 
# 629 "../crypto/ec/ecp_nistz256.c" 3 4
                                                                ((void *)0)
        
# 630 "../crypto/ec/ecp_nistz256.c"
       || (scalars = CRYPTO_malloc(num * sizeof(BIGNUM *), "../crypto/ec/ecp_nistz256.c", 630)) == 
# 630 "../crypto/ec/ecp_nistz256.c" 3 4
                                                                ((void *)0)
# 630 "../crypto/ec/ecp_nistz256.c"
                                                                    )
        goto err;

    table = (void *)((unsigned char *)table_storage+64 -(size_t)table_storage%64);
    ...
    for (i = 0; i < num; i++) {
        ...
        if ((BN_num_bits(scalar[i]) > 256) || BN_is_negative(scalar[i])) {
            ...
            if ((mod = BN_CTX_get(ctx)) == 
# 643 "../crypto/ec/ecp_nistz256.c" 3 4
                                          ((void *)0)
# 643 "../crypto/ec/ecp_nistz256.c"
                                              )
                goto err;
            if (!BN_nnmod(mod, scalar[i], group->order, ctx)) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",646,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 646 "../crypto/ec/ecp_nistz256.c" 3 4
               ((void *)0)
# 646 "../crypto/ec/ecp_nistz256.c"
               );
                goto err;
            }
            scalars[i] = mod;
        ...
        for (j = 0; j < bn_get_top(scalars[i]) * 8; j += 8) {
            unsigned long d = bn_get_words(scalars[i])[j / 8];
        ...
        if (!ecp_nistz256_bignum_to_field_elem(temp[0].X, point[i]->X)
            ...
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",674,__func__), ERR_set_error)((16),(146),
# 674 "../crypto/ec/ecp_nistz256.c" 3 4
           ((void *)0)
# 674 "../crypto/ec/ecp_nistz256.c"
           );
            goto err;
        }
    ...
    ret = 1;
 err:
    CRYPTO_free(table_storage, "../crypto/ec/ecp_nistz256.c", 772);
    CRYPTO_free(p_str, "../crypto/ec/ecp_nistz256.c", 773);
    CRYPTO_free(scalars, "../crypto/ec/ecp_nistz256.c", 774);
    return ret;
}


static const unsigned long def_xG[(256/(8 * 8))] = {
    ((unsigned long)0x79e730d4<<32|0x18a9143c), ((unsigned long)0x75ba95fc<<32|0x5fedb601),
    ((unsigned long)0x79fb732b<<32|0x77622510), ((unsigned long)0x18905f76<<32|0xa53755c6)
};

static const unsigned long def_yG[(256/(8 * 8))] = {
    ((unsigned long)0xddf25357<<32|0xce95560a), ((unsigned long)0x8b4ab8e4<<32|0xba19e45c),
    ((unsigned long)0xd2e88688<<32|0xdd21f325), ((unsigned long)0x8571ff18<<32|0x25885d85)
};
...
{
    return (bn_get_top(generator->X) == (256/(8 * 8))) &&
        (bn_get_top(generator->Y) == (256/(8 * 8))) &&
 ...
 static int ecp_nistz256_mult_precompute(EC_GROUP *group, BN_CTX *ctx)
{
    ...
    const BIGNUM *order;
    EC_POINT *P = 
# 811 "../crypto/ec/ecp_nistz256.c" 3 4
                 ((void *)0)
# 811 "../crypto/ec/ecp_nistz256.c"
                     , *T = 
# 811 "../crypto/ec/ecp_nistz256.c" 3 4
                            ((void *)0)
# 811 "../crypto/ec/ecp_nistz256.c"
    ...
    BN_CTX *new_ctx = 
# 814 "../crypto/ec/ecp_nistz256.c" 3 4
                     ((void *)0)
# 814 "../crypto/ec/ecp_nistz256.c"
                         ;
    int i, j, k, ret = 0;
    size_t w;

    PRECOMP256_ROW *preComputedTable = 
# 818 "../crypto/ec/ecp_nistz256.c" 3 4
                                      ((void *)0)
# 818 "../crypto/ec/ecp_nistz256.c"
                                          ;
    unsigned char *precomp_storage = 
# 819 "../crypto/ec/ecp_nistz256.c" 3 4
                                    ((void *)0)
# 819 "../crypto/ec/ecp_nistz256.c"
                                        ;
    ...
    if (generator == 
# 824 "../crypto/ec/ecp_nistz256.c" 3 4
                    ((void *)0)
# 824 "../crypto/ec/ecp_nistz256.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",825,__func__), ERR_set_error)((16),(113),
# 825 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 825 "../crypto/ec/ecp_nistz256.c"
       );
        return 0;
    }
    ...
    if ((pre_comp = ecp_nistz256_pre_comp_new(group)) == 
# 837 "../crypto/ec/ecp_nistz256.c" 3 4
                                                        ((void *)0)
# 837 "../crypto/ec/ecp_nistz256.c"
                                                            )
        return 0;

    if (ctx == 
# 840 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 840 "../crypto/ec/ecp_nistz256.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(group->libctx);
        if (ctx == 
# 842 "../crypto/ec/ecp_nistz256.c" 3 4
                  ((void *)0)
# 842 "../crypto/ec/ecp_nistz256.c"
                      )
            goto err;
    }
    ...
    if (order == 
# 849 "../crypto/ec/ecp_nistz256.c" 3 4
                ((void *)0)
# 849 "../crypto/ec/ecp_nistz256.c"
                    )
        goto err;

    if (BN_is_zero(order)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",853,__func__), ERR_set_error)((16),(114),
# 853 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 853 "../crypto/ec/ecp_nistz256.c"
       );
        goto err;
    }
    ...
    if ((precomp_storage =
         CRYPTO_malloc(37 * 64 * sizeof(P256_POINT_AFFINE) + 64, "../crypto/ec/ecp_nistz256.c", 860)) == 
# 860 "../crypto/ec/ecp_nistz256.c" 3 4
                                                                     ((void *)0)
# 860 "../crypto/ec/ecp_nistz256.c"
                                                                         )
        goto err;

    preComputedTable = (void *)((unsigned char *)precomp_storage+64 -(size_t)precomp_storage%64);

    P = EC_POINT_new(group);
    T = EC_POINT_new(group);
    if (P == 
# 867 "../crypto/ec/ecp_nistz256.c" 3 4
            ((void *)0) 
# 867 "../crypto/ec/ecp_nistz256.c"
                 || T == 
# 867 "../crypto/ec/ecp_nistz256.c" 3 4
                         ((void *)0)
# 867 "../crypto/ec/ecp_nistz256.c"
    ...
    for (k = 0; k < 64; k++) {
        ...
        for (j = 0; j < 37; j++) {
            ...
            if (group->meth->make_affine == 
# 886 "../crypto/ec/ecp_nistz256.c" 3 4
                                           ((void *)0)
                
# 887 "../crypto/ec/ecp_nistz256.c"
               || !group->meth->make_affine(group, P, ctx))
                goto err;
            if (!ecp_nistz256_bignum_to_field_elem(temp.X, P->X) ||
                !ecp_nistz256_bignum_to_field_elem(temp.Y, P->Y)) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",891,__func__), ERR_set_error)((16),(146),
# 891 "../crypto/ec/ecp_nistz256.c" 3 4
               ((void *)0)
# 891 "../crypto/ec/ecp_nistz256.c"
               );
                goto err;
            }
    ...
    precomp_storage = 
# 908 "../crypto/ec/ecp_nistz256.c" 3 4
                     ((void *)0)
# 908 "../crypto/ec/ecp_nistz256.c"
                         ;
    group->pre_comp_type = PCT_nistz256, group->pre_comp.nistz256 = pre_comp;
    pre_comp = 
# 910 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 910 "../crypto/ec/ecp_nistz256.c"
                  ;
    ret = 1;
 ...
 err:
    ...
    CRYPTO_free(precomp_storage, "../crypto/ec/ecp_nistz256.c", 918);
    EC_POINT_free(P);
    EC_POINT_free(T);
    return ret;
}
                                               ...
                                               BN_CTX *ctx)
{
    ...
    if ((ret = bn_set_words(out->X, in->X, (256/(8 * 8))))
        && (ret = bn_set_words(out->Y, in->Y, (256/(8 * 8))))
        && (ret = bn_set_words(out->Z, ONE, (256/(8 * 8)))))
        out->Z_is_one = 1;
...
# 948 "../crypto/ec/ecp_nistz256.c" 3 4
                                            ((void *)0)
# 948 "../crypto/ec/ecp_nistz256.c"
                                                ;
    const NISTZ256_PRE_COMP *pre_comp = 
# 949 "../crypto/ec/ecp_nistz256.c" 3 4
                                       ((void *)0)
# 949 "../crypto/ec/ecp_nistz256.c"
                                           ;
    const EC_POINT *generator = 
# 950 "../crypto/ec/ecp_nistz256.c" 3 4
                               ((void *)0)
# 950 "../crypto/ec/ecp_nistz256.c"
                                   ;
    const BIGNUM **new_scalars = 
# 951 "../crypto/ec/ecp_nistz256.c" 3 4
                                ((void *)0)
# 951 "../crypto/ec/ecp_nistz256.c"
                                    ;
    const EC_POINT **new_points = 
# 952 "../crypto/ec/ecp_nistz256.c" 3 4
                                 ((void *)0)
# 952 "../crypto/ec/ecp_nistz256.c"
                                     ;
    unsigned int idx = 0;
    ...
    if ((num + 1) == 0 || (num + 1) > (((1U<<(sizeof(int)*8-1))-1)/sizeof(void *))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",964,__func__), ERR_set_error)((16),((262|(0x2 << 18L))),
# 964 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 964 "../crypto/ec/ecp_nistz256.c"
       );
        return 0;
    }
    ...
    if (scalar) {
        generator = EC_GROUP_get0_generator(group);
        if (generator == 
# 973 "../crypto/ec/ecp_nistz256.c" 3 4
                        ((void *)0)
# 973 "../crypto/ec/ecp_nistz256.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",974,__func__), ERR_set_error)((16),(113),
# 974 "../crypto/ec/ecp_nistz256.c" 3 4
           ((void *)0)
# 974 "../crypto/ec/ecp_nistz256.c"
           );
            goto err;
        }
        ...
        if (pre_comp) {
            ...
            if (pre_comp_generator == 
# 987 "../crypto/ec/ecp_nistz256.c" 3 4
                                     ((void *)0)
# 987 "../crypto/ec/ecp_nistz256.c"
                                         )
                goto err;
        ...
        if (preComputedTable == 
# 1003 "../crypto/ec/ecp_nistz256.c" 3 4
                               ((void *)0) 
# 1003 "../crypto/ec/ecp_nistz256.c"
        ...
        if (preComputedTable) {
            ...
            if ((BN_num_bits(scalar) > 256)
                ...
                if ((tmp_scalar = BN_CTX_get(ctx)) == 
# 1018 "../crypto/ec/ecp_nistz256.c" 3 4
                                                     ((void *)0)
# 1018 "../crypto/ec/ecp_nistz256.c"
                                                         )
                    goto err;

                if (!BN_nnmod(tmp_scalar, scalar, group->order, ctx)) {
                    (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1022,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1022 "../crypto/ec/ecp_nistz256.c" 3 4
                   ((void *)0)
# 1022 "../crypto/ec/ecp_nistz256.c"
                   );
                    goto err;
                }
                scalar = tmp_scalar;
            ...
            for (i = 0; i < bn_get_top(scalar) * 8; i += 8) {
                unsigned long d = bn_get_words(scalar)[i / 8];
    ...
    if (no_precomp_for_generator) {
        ...
        new_scalars = CRYPTO_malloc((num + 1) * sizeof(BIGNUM *), "../crypto/ec/ecp_nistz256.c", 1112);
        if (new_scalars == 
# 1113 "../crypto/ec/ecp_nistz256.c" 3 4
                          ((void *)0)
# 1113 "../crypto/ec/ecp_nistz256.c"
                              )
            goto err;

        new_points = CRYPTO_malloc((num + 1) * sizeof(EC_POINT *), "../crypto/ec/ecp_nistz256.c", 1116);
        if (new_points == 
# 1117 "../crypto/ec/ecp_nistz256.c" 3 4
                         ((void *)0)
# 1117 "../crypto/ec/ecp_nistz256.c"
                             )
            goto err;
    ...
    if (!bn_set_words(r->X, p.p.X, (256/(8 * 8))) ||
        !bn_set_words(r->Y, p.p.Y, (256/(8 * 8))) ||
        !bn_set_words(r->Z, p.p.Z, (256/(8 * 8)))) {
        goto err;
    }
...
err:
    BN_CTX_end(ctx);
    CRYPTO_free(new_points, "../crypto/ec/ecp_nistz256.c", 1154);
    CRYPTO_free(new_scalars, "../crypto/ec/ecp_nistz256.c", 1155);
    return ret;
}
 ...
 static int ecp_nistz256_get_affine(const EC_GROUP *group,
                                          ...
                                          BIGNUM *x, BIGNUM *y, BN_CTX *ctx)
{
    unsigned long z_inv2[(256/(8 * 8))];
    unsigned long z_inv3[(256/(8 * 8))];
    unsigned long x_aff[(256/(8 * 8))];
    unsigned long y_aff[(256/(8 * 8))];
    unsigned long point_x[(256/(8 * 8))], point_y[(256/(8 * 8))], point_z[(256/(8 * 8))];
    unsigned long x_ret[(256/(8 * 8))], y_ret[(256/(8 * 8))];

    if (EC_POINT_is_at_infinity(group, point)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1171,__func__), ERR_set_error)((16),(106),
# 1171 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 1171 "../crypto/ec/ecp_nistz256.c"
       );
        return 0;
    }
    ...
    if (!ecp_nistz256_bignum_to_field_elem(point_x, point->X) ||
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1178,__func__), ERR_set_error)((16),(146),
# 1178 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 1178 "../crypto/ec/ecp_nistz256.c"
       );
        return 0;
    }
    ...
    if (x != 
# 1186 "../crypto/ec/ecp_nistz256.c" 3 4
            ((void *)0)
# 1186 "../crypto/ec/ecp_nistz256.c"
                ) {
        ecp_nistz256_from_mont(x_ret, x_aff);
        if (!bn_set_words(x, x_ret, (256/(8 * 8))))
            return 0;
    }

    if (y != 
# 1192 "../crypto/ec/ecp_nistz256.c" 3 4
            ((void *)0)
# 1192 "../crypto/ec/ecp_nistz256.c"
                ) {
        ecp_nistz256_mul_mont(z_inv3, z_inv3, z_inv2);
        ecp_nistz256_mul_mont(y_aff, z_inv3, point_y);
        ecp_nistz256_from_mont(y_ret, y_aff);
        if (!bn_set_words(y, y_ret, (256/(8 * 8))))
            return 0;
    }
...
static NISTZ256_PRE_COMP *ecp_nistz256_pre_comp_new(const EC_GROUP *group)
{
    NISTZ256_PRE_COMP *ret = 
# 1205 "../crypto/ec/ecp_nistz256.c" 3 4
                            ((void *)0)
# 1205 "../crypto/ec/ecp_nistz256.c"
                                ;

    if (!group)
        return 
# 1208 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 1208 "../crypto/ec/ecp_nistz256.c"
                  ;

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ecp_nistz256.c", 1210);

    if (ret == 
# 1212 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 1212 "../crypto/ec/ecp_nistz256.c"
                  )
        return ret;
    ...
    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_free(ret, "../crypto/ec/ecp_nistz256.c", 1219);
        return 
# 1220 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 1220 "../crypto/ec/ecp_nistz256.c"
                  ;
    }
    return ret;
}
...
NISTZ256_PRE_COMP *EC_nistz256_pre_comp_dup(NISTZ256_PRE_COMP *p)
{
    int i;
    if (p != 
# 1228 "../crypto/ec/ecp_nistz256.c" 3 4
            ((void *)0)
# 1228 "../crypto/ec/ecp_nistz256.c"
                )
...
void EC_nistz256_pre_comp_free(NISTZ256_PRE_COMP *pre)
{
    ...
    if (pre == 
# 1237 "../crypto/ec/ecp_nistz256.c" 3 4
              ((void *)0)
# 1237 "../crypto/ec/ecp_nistz256.c"
                  )
        return;
    ...
    CRYPTO_free(pre->precomp_storage, "../crypto/ec/ecp_nistz256.c", 1246);
    CRYPTO_FREE_REF(&pre->references);
    CRYPTO_free(pre, "../crypto/ec/ecp_nistz256.c", 1248);
}
...
static int ecp_nistz256_window_have_precompute_mult(const EC_GROUP *group)
{
    ...
    if (generator != 
# 1257 "../crypto/ec/ecp_nistz256.c" 3 4
                    ((void *)0) 
# 1257 "../crypto/ec/ecp_nistz256.c"
                         && ecp_nistz256_is_affine_G(generator)) {

        return 1;
    }

    return group->pre_comp_type == PCT_nistz256 && group->pre_comp.nistz256 != 
# 1262 "../crypto/ec/ecp_nistz256.c" 3 4
          ((void *)0)
# 1262 "../crypto/ec/ecp_nistz256.c"
                                      ;
}
# 1272 "../crypto/ec/ecp_nistz256.c"
void ecp_nistz256_ord_mul_mont(unsigned long res[(256/(8 * 8))],
                               const unsigned long a[(256/(8 * 8))],
                               const unsigned long b[(256/(8 * 8))]);
void ecp_nistz256_ord_sqr_mont(unsigned long res[(256/(8 * 8))],
                               const unsigned long a[(256/(8 * 8))],
                               unsigned long rep);
                                    ...
                                    const BIGNUM *x, BN_CTX *ctx)
{
    ...
    static const unsigned long RR[(256/(8 * 8))] = {
        ((unsigned long)0x83244c95<<32|0xbe79eea2), ((unsigned long)0x4699799c<<32|0x49bd6fa6),
        ((unsigned long)0x2845b239<<32|0x2b6bec59), ((unsigned long)0x66e12d94<<32|0xf3d95620)
    };

    static const unsigned long one[(256/(8 * 8))] = {
        ((unsigned long)0<<32|1), ((unsigned long)0<<32|0), ((unsigned long)0<<32|0), ((unsigned long)0<<32|0)
    };




    unsigned long table[15][(256/(8 * 8))];
    unsigned long out[(256/(8 * 8))], t[(256/(8 * 8))];
    int i, ret = 0;
    enum {
    ...
    if (bn_wexpand(r, (256/(8 * 8))) == 
# 1306 "../crypto/ec/ecp_nistz256.c" 3 4
                                    ((void *)0)
# 1306 "../crypto/ec/ecp_nistz256.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1307,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1307 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 1307 "../crypto/ec/ecp_nistz256.c"
       );
        goto err;
    }
...
# 1314 "../crypto/ec/ecp_nistz256.c" 3 4
                                      ((void *)0)
            
# 1315 "../crypto/ec/ecp_nistz256.c"
           || !BN_nnmod(tmp, x, group->order, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1316,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1316 "../crypto/ec/ecp_nistz256.c" 3 4
           ((void *)0)
# 1316 "../crypto/ec/ecp_nistz256.c"
           );
            goto err;
        }
        x = tmp;
    ...
    if (!ecp_nistz256_bignum_to_field_elem(t, x)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nistz256.c",1323,__func__), ERR_set_error)((16),(146),
# 1323 "../crypto/ec/ecp_nistz256.c" 3 4
       ((void *)0)
# 1323 "../crypto/ec/ecp_nistz256.c"
       );
        goto err;
    }

    ecp_nistz256_ord_mul_mont(table[0], t, RR);
# 1381 "../crypto/ec/ecp_nistz256.c"
