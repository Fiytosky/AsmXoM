# 0 "../crypto/ec/ec_print.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_print.c"
# 10 "../crypto/ec/ec_print.c"
                         ...
                         point_conversion_form_t form, BN_CTX *ctx)
{
    ...
    size_t buf_len = 0, i;
    unsigned char *buf = 
# 23 "../crypto/ec/ec_print.c" 3 4
                        ((void *)0)
# 23 "../crypto/ec/ec_print.c"
                            , *pbuf;
    ...
    if (buf_len == 0)
        return 
# 28 "../crypto/ec/ec_print.c" 3 4
              ((void *)0)
# 28 "../crypto/ec/ec_print.c"
                  ;

    ret = CRYPTO_malloc(buf_len * 2 + 2, "../crypto/ec/ec_print.c", 30);
    if (ret == 
# 31 "../crypto/ec/ec_print.c" 3 4
              ((void *)0)
# 31 "../crypto/ec/ec_print.c"
                  ) {
        CRYPTO_free(buf, "../crypto/ec/ec_print.c", 32);
        return 
# 33 "../crypto/ec/ec_print.c" 3 4
              ((void *)0)
# 33 "../crypto/ec/ec_print.c"
                  ;
    }
    p = ret;
    pbuf = buf;
    ...
    *p = '\0';
    ...
    CRYPTO_free(buf, "../crypto/ec/ec_print.c", 44);
...
{
    int ok = 0;
    unsigned char *oct_buf = 
# 53 "../crypto/ec/ec_print.c" 3 4
                            ((void *)0)
# 53 "../crypto/ec/ec_print.c"
                                ;
    size_t len, oct_buf_len = 0;
    EC_POINT *pt = 
# 55 "../crypto/ec/ec_print.c" 3 4
                  ((void *)0)
# 55 "../crypto/ec/ec_print.c"
                      ;

    if (group == 
# 57 "../crypto/ec/ec_print.c" 3 4
                ((void *)0) 
# 57 "../crypto/ec/ec_print.c"
                     || hex == 
# 57 "../crypto/ec/ec_print.c" 3 4
                               ((void *)0)
# 57 "../crypto/ec/ec_print.c"
        ...
        return 
# 58 "../crypto/ec/ec_print.c" 3 4
              ((void *)0)
# 58 "../crypto/ec/ec_print.c"
                  ;

    if (point == 
# 60 "../crypto/ec/ec_print.c" 3 4
                ((void *)0)
# 60 "../crypto/ec/ec_print.c"
                    ) {
        pt = EC_POINT_new(group);
        if (pt == 
# 62 "../crypto/ec/ec_print.c" 3 4
                 ((void *)0)
# 62 "../crypto/ec/ec_print.c"
                     )
            goto err;
    } else {
        pt = point;
    ...
    len = strlen(hex) / 2;
    oct_buf = CRYPTO_malloc(len, "../crypto/ec/ec_print.c", 69);
    if (oct_buf == 
# 70 "../crypto/ec/ec_print.c" 3 4
                  ((void *)0)
# 70 "../crypto/ec/ec_print.c"
                      )
        goto err;
    ...
    ok = 1;
err:
    CRYPTO_clear_free(oct_buf, oct_buf_len, "../crypto/ec/ec_print.c", 78);
    if (!ok) {
        if (pt != point)
            EC_POINT_clear_free(pt);
        pt = 
# 82 "../crypto/ec/ec_print.c" 3 4
            ((void *)0)
# 82 "../crypto/ec/ec_print.c"
                ;
    }
    return pt;
}
