# 0 "../crypto/ec/ecdh_kdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecdh_kdf.c"
# 14 "../crypto/ec/ecdh_kdf.c"
...
# 17 "../crypto/ec/ecdh_kdf.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/ec/ecdh_kdf.c" 2
                        ...
                        OSSL_LIB_CTX *libctx, const char *propq)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 31 "../crypto/ec/ecdh_kdf.c" 3 4
                       ((void *)0)
# 31 "../crypto/ec/ecdh_kdf.c"
                           ;
    OSSL_PARAM params[4], *p = params;
    const char *mdname = EVP_MD_get0_name(md);
    EVP_KDF *kdf = EVP_KDF_fetch(libctx, "X963KDF", propq);

    if ((kctx = EVP_KDF_CTX_new(kdf)) != 
# 36 "../crypto/ec/ecdh_kdf.c" 3 4
                                        ((void *)0)
# 36 "../crypto/ec/ecdh_kdf.c"
                                            ) {
...
# 62 "../crypto/ec/ecdh_kdf.c" 3 4
                                                                         ((void *)0)
# 62 "../crypto/ec/ecdh_kdf.c"
                                                                             ,
                               
# 63 "../crypto/ec/ecdh_kdf.c" 3 4
                              ((void *)0)
# 63 "../crypto/ec/ecdh_kdf.c"
                                  );
}
