# 0 "../crypto/ec/ecx_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecx_backend.c"
# 10 "../crypto/ec/ecx_backend.c"
...
# 11 "../crypto/ec/ecx_backend.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../crypto/ec/ecx_backend.c" 2
...
# 20 "../crypto/ec/ecx_backend.c" 2
# 1 "../crypto/ec/ecx_backend.h" 1
# 21 "../crypto/ec/ecx_backend.c" 2
...
int ossl_ecx_public_from_private(ECX_KEY *key)
{
    ...
    case ECX_KEY_TYPE_ED25519:
        if (!ossl_ed25519_public_from_private(key->libctx, key->pubkey,
            ...
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",37,__func__), ERR_set_error)((16),(166),
# 37 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 37 "../crypto/ec/ecx_backend.c"
           );
            return 0;
        }
        break;
    ...
    case ECX_KEY_TYPE_ED448:
        if (!ossl_ed448_public_from_private(key->libctx, key->pubkey,
                                            key->privkey, key->propq)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",47,__func__), ERR_set_error)((16),(166),
# 47 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 47 "../crypto/ec/ecx_backend.c"
           );
            return 0;
        }
        break;
...
# 59 "../crypto/ec/ecx_backend.c" 3 4
                                      ((void *)0)
# 59 "../crypto/ec/ecx_backend.c"
                                          , *param_pub_key;
    unsigned char *pubkey;

    if (ecx == 
# 62 "../crypto/ec/ecx_backend.c" 3 4
              ((void *)0)
# 62 "../crypto/ec/ecx_backend.c"
                  )
        return 0;
    ...
    if (param_pub_key == 
# 70 "../crypto/ec/ecx_backend.c" 3 4
                        ((void *)0) 
# 70 "../crypto/ec/ecx_backend.c"
                             && param_priv_key == 
# 70 "../crypto/ec/ecx_backend.c" 3 4
                                                  ((void *)0)
# 70 "../crypto/ec/ecx_backend.c"
    ...
    if (param_priv_key != 
# 73 "../crypto/ec/ecx_backend.c" 3 4
                         ((void *)0)
# 73 "../crypto/ec/ecx_backend.c"
                             ) {
        ...
        if (privkeylen != ecx->keylen) {
            ...
            CRYPTO_secure_clear_free(ecx->privkey, privkeylen, "../crypto/ec/ecx_backend.c", 84);
            ecx->privkey = 
# 85 "../crypto/ec/ecx_backend.c" 3 4
                          ((void *)0)
# 85 "../crypto/ec/ecx_backend.c"
                              ;
            return 0;
        }
    }
    ...
    pubkey = ecx->pubkey;
    if (param_pub_key != 
# 92 "../crypto/ec/ecx_backend.c" 3 4
                        ((void *)0)
        
# 93 "../crypto/ec/ecx_backend.c"
    ...
    if ((param_pub_key != 
# 98 "../crypto/ec/ecx_backend.c" 3 4
                         ((void *)0) 
# 98 "../crypto/ec/ecx_backend.c"
                              && pubkeylen != ecx->keylen))
        return 0;

    if (param_pub_key == 
# 101 "../crypto/ec/ecx_backend.c" 3 4
                        ((void *)0) 
# 101 "../crypto/ec/ecx_backend.c"
...
ECX_KEY *ossl_ecx_key_dup(const ECX_KEY *key, int selection)
{
    ECX_KEY *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ecx_backend.c", 111);

    if (ret == 
# 113 "../crypto/ec/ecx_backend.c" 3 4
              ((void *)0)
# 113 "../crypto/ec/ecx_backend.c"
                  )
        return 
# 114 "../crypto/ec/ecx_backend.c" 3 4
              ((void *)0)
# 114 "../crypto/ec/ecx_backend.c"
                  ;
    ...
    if (key->propq != 
# 124 "../crypto/ec/ecx_backend.c" 3 4
                     ((void *)0)
# 124 "../crypto/ec/ecx_backend.c"
                         ) {
        ret->propq = CRYPTO_strdup(key->propq, "../crypto/ec/ecx_backend.c", 125);
        if (ret->propq == 
# 126 "../crypto/ec/ecx_backend.c" 3 4
                         ((void *)0)
# 126 "../crypto/ec/ecx_backend.c"
                             )
            goto err;
    }
    ...
    if ((selection & 0x01) != 0
        && key->privkey != 
# 137 "../crypto/ec/ecx_backend.c" 3 4
                          ((void *)0)
# 137 "../crypto/ec/ecx_backend.c"
                              ) {
        if (ossl_ecx_key_allocate_privkey(ret) == 
# 138 "../crypto/ec/ecx_backend.c" 3 4
                                                 ((void *)0)
# 138 "../crypto/ec/ecx_backend.c"
                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",139,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 139 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 139 "../crypto/ec/ecx_backend.c"
           );
            goto err;
        }
...
err:
    ...
    return 
# 150 "../crypto/ec/ecx_backend.c" 3 4
          ((void *)0)
# 150 "../crypto/ec/ecx_backend.c"
              ;
}
...
{
    ECX_KEY *key = 
# 159 "../crypto/ec/ecx_backend.c" 3 4
                  ((void *)0)
# 159 "../crypto/ec/ecx_backend.c"
                      ;
    unsigned char *privkey, *pubkey;

    if (op != KEY_OP_KEYGEN) {
        if (palg != 
# 163 "../crypto/ec/ecx_backend.c" 3 4
                   ((void *)0)
# 163 "../crypto/ec/ecx_backend.c"
                       ) {
            int ptype;


            X509_ALGOR_get0(
# 167 "../crypto/ec/ecx_backend.c" 3 4
                           ((void *)0)
# 167 "../crypto/ec/ecx_backend.c"
                               , &ptype, 
# 167 "../crypto/ec/ecx_backend.c" 3 4
                                         ((void *)0)
# 167 "../crypto/ec/ecx_backend.c"
                                             , palg);
            if (ptype != -1) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",169,__func__), ERR_set_error)((16),(102),
# 169 "../crypto/ec/ecx_backend.c" 3 4
               ((void *)0)
# 169 "../crypto/ec/ecx_backend.c"
               );
                return 0;
            }
            if (id == 0)
                ...
                (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",175,__func__), ERR_set_error)((16),(102),
# 175 "../crypto/ec/ecx_backend.c" 3 4
               ((void *)0)
# 175 "../crypto/ec/ecx_backend.c"
               );
                return 0;
            }
        }
        ...
        if (p == 
# 180 "../crypto/ec/ecx_backend.c" 3 4
                ((void *)0) 
# 180 "../crypto/ec/ecx_backend.c"
                     || id == 0 || plen != (((id) == 1034 || (id) == 1087) ? 32 : ((id) == 1035 ? 56 : 57))) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",181,__func__), ERR_set_error)((16),(102),
# 181 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 181 "../crypto/ec/ecx_backend.c"
           );
            return 0;
        }
    }

    key = ossl_ecx_key_new(libctx, (((id) == 1034 || (id) == 1087) ? ((id) == 1034 ? ECX_KEY_TYPE_X25519 : ECX_KEY_TYPE_ED25519) : ((id) == 1035 ? ECX_KEY_TYPE_X448 : ECX_KEY_TYPE_ED448)), 1, propq);
    if (key == 
# 187 "../crypto/ec/ecx_backend.c" 3 4
              ((void *)0)
# 187 "../crypto/ec/ecx_backend.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",188,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 188 "../crypto/ec/ecx_backend.c" 3 4
       ((void *)0)
# 188 "../crypto/ec/ecx_backend.c"
       );
        return 0;
    }
    pubkey = key->pubkey;
    ...
    if (op == KEY_OP_PUBLIC) {
        ...
        if (privkey == 
# 197 "../crypto/ec/ecx_backend.c" 3 4
                      ((void *)0)
# 197 "../crypto/ec/ecx_backend.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",198,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 198 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 198 "../crypto/ec/ecx_backend.c"
        ...
        if (op == KEY_OP_KEYGEN) {
            if (id != 0) {
                if (RAND_priv_bytes_ex(libctx, privkey, (((id) == 1034 || (id) == 1087) ? 32 : ((id) == 1035 ? 56 : 57)), 0) <= 0)
                    goto err;
                if (id == 1034) {
                    privkey[0] &= 248;
                    privkey[32 - 1] &= 127;
            ...
            memcpy(privkey, p, (((id) == 1034 || (id) == 1087) ? 32 : ((id) == 1035 ? 56 : 57)));
        }
        if (!ossl_ecx_public_from_private(key)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_backend.c",218,__func__), ERR_set_error)((16),(166),
# 218 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 218 "../crypto/ec/ecx_backend.c"
           );
            goto err;
        }
    }
 ...
 err:
    ...
    return 
# 226 "../crypto/ec/ecx_backend.c" 3 4
          ((void *)0)
# 226 "../crypto/ec/ecx_backend.c"
              ;
}
...
{
    ECX_KEY *ecx = 
# 232 "../crypto/ec/ecx_backend.c" 3 4
                  ((void *)0)
# 232 "../crypto/ec/ecx_backend.c"
                      ;
    const unsigned char *p;
    int plen;
    ASN1_OCTET_STRING *oct = 
# 235 "../crypto/ec/ecx_backend.c" 3 4
                            ((void *)0)
# 235 "../crypto/ec/ecx_backend.c"
                                ;
    const X509_ALGOR *palg;

    if (!PKCS8_pkey_get0(
# 238 "../crypto/ec/ecx_backend.c" 3 4
                        ((void *)0)
# 238 "../crypto/ec/ecx_backend.c"
                            , &p, &plen, &palg, p8inf))
        return 0;

    oct = d2i_ASN1_OCTET_STRING(
# 241 "../crypto/ec/ecx_backend.c" 3 4
                               ((void *)0)
# 241 "../crypto/ec/ecx_backend.c"
                                   , &p, plen);
    if (oct == 
# 242 "../crypto/ec/ecx_backend.c" 3 4
              ((void *)0)
# 242 "../crypto/ec/ecx_backend.c"
                  ) {
        p = 
# 243 "../crypto/ec/ecx_backend.c" 3 4
           ((void *)0)
# 243 "../crypto/ec/ecx_backend.c"
               ;
        plen = 0;
    } else {
    ...
    ecx = ossl_ecx_key_op(palg, p, plen, 0, KEY_OP_PRIVATE,
                          libctx, propq);
