# 0 "../crypto/ec/ec_kmeth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_kmeth.c"
# 14 "../crypto/ec/ec_kmeth.c"
...
{
    if (meth == 
# 52 "../crypto/ec/ec_kmeth.c" 3 4
               ((void *)0)
# 52 "../crypto/ec/ec_kmeth.c"
                   )
...
int EC_KEY_set_method(EC_KEY *key, const EC_KEY_METHOD *meth)
{
    ...
    if (finish != 
# 67 "../crypto/ec/ec_kmeth.c" 3 4
                 ((void *)0)
# 67 "../crypto/ec/ec_kmeth.c"
                     )
        finish(key);
    ...
    key->engine = 
# 72 "../crypto/ec/ec_kmeth.c" 3 4
                 ((void *)0)
# 72 "../crypto/ec/ec_kmeth.c"
                     ;


    key->meth = meth;
    if (meth->init != 
# 76 "../crypto/ec/ec_kmeth.c" 3 4
                     ((void *)0)
# 76 "../crypto/ec/ec_kmeth.c"
                         )
...
EC_KEY *ossl_ec_key_new_method_int(OSSL_LIB_CTX *libctx, const char *propq,
                                   ENGINE *engine)
{
    EC_KEY *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ec_kmeth.c", 84);

    if (ret == 
# 86 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 86 "../crypto/ec/ec_kmeth.c"
                  )
        return 
# 87 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 87 "../crypto/ec/ec_kmeth.c"
                  ;

    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_free(ret, "../crypto/ec/ec_kmeth.c", 90);
        return 
# 91 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 91 "../crypto/ec/ec_kmeth.c"
                  ;
    }

    ret->libctx = libctx;
    if (propq != 
# 95 "../crypto/ec/ec_kmeth.c" 3 4
                ((void *)0)
# 95 "../crypto/ec/ec_kmeth.c"
                    ) {
        ret->propq = CRYPTO_strdup(propq, "../crypto/ec/ec_kmeth.c", 96);
        if (ret->propq == 
# 97 "../crypto/ec/ec_kmeth.c" 3 4
                         ((void *)0)
# 97 "../crypto/ec/ec_kmeth.c"
                             )
            goto err;
    }
    ...
    if (engine != 
# 103 "../crypto/ec/ec_kmeth.c" 3 4
                 ((void *)0)
# 103 "../crypto/ec/ec_kmeth.c"
                     ) {
        if (!ENGINE_init(engine)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",105,__func__), ERR_set_error)((16),((38 | (0x2 << 18L))),
# 105 "../crypto/ec/ec_kmeth.c" 3 4
           ((void *)0)
# 105 "../crypto/ec/ec_kmeth.c"
           );
            goto err;
        }
        ret->engine = engine;
    ...
    if (ret->engine != 
# 111 "../crypto/ec/ec_kmeth.c" 3 4
                      ((void *)0)
# 111 "../crypto/ec/ec_kmeth.c"
                          ) {
        ret->meth = ENGINE_get_EC(ret->engine);
        if (ret->meth == 
# 113 "../crypto/ec/ec_kmeth.c" 3 4
                        ((void *)0)
# 113 "../crypto/ec/ec_kmeth.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",114,__func__), ERR_set_error)((16),((38 | (0x2 << 18L))),
# 114 "../crypto/ec/ec_kmeth.c" 3 4
           ((void *)0)
# 114 "../crypto/ec/ec_kmeth.c"
           );
            goto err;
        }
    }
    ...
    if (!CRYPTO_new_ex_data(8, ret, &ret->ex_data)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",126,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 126 "../crypto/ec/ec_kmeth.c" 3 4
       ((void *)0)
# 126 "../crypto/ec/ec_kmeth.c"
       );
        goto err;
    }
    ...
    if (ret->meth->init != 
# 131 "../crypto/ec/ec_kmeth.c" 3 4
                          ((void *)0) 
# 131 "../crypto/ec/ec_kmeth.c"
                               && ret->meth->init(ret) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",132,__func__), ERR_set_error)((16),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 132 "../crypto/ec/ec_kmeth.c" 3 4
       ((void *)0)
# 132 "../crypto/ec/ec_kmeth.c"
       );
        goto err;
    }
    return ret;
 ...
 err:
    EC_KEY_free(ret);
    return 
# 139 "../crypto/ec/ec_kmeth.c" 3 4
          ((void *)0)
# 139 "../crypto/ec/ec_kmeth.c"
              ;
}
...
# 145 "../crypto/ec/ec_kmeth.c" 3 4
                                     ((void *)0)
# 145 "../crypto/ec/ec_kmeth.c"
                                         , 
# 145 "../crypto/ec/ec_kmeth.c" 3 4
                                           ((void *)0)
# 145 "../crypto/ec/ec_kmeth.c"
...
{
    unsigned char *sec = 
# 154 "../crypto/ec/ec_kmeth.c" 3 4
                        ((void *)0)
# 154 "../crypto/ec/ec_kmeth.c"
                            ;
    size_t seclen;
    if (eckey->meth->compute_key == 
# 156 "../crypto/ec/ec_kmeth.c" 3 4
                                   ((void *)0)
# 156 "../crypto/ec/ec_kmeth.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",157,__func__), ERR_set_error)((16),(152),
# 157 "../crypto/ec/ec_kmeth.c" 3 4
       ((void *)0)
# 157 "../crypto/ec/ec_kmeth.c"
       );
        return 0;
    }
    if (outlen > 0x7fffffff
# 160 "../crypto/ec/ec_kmeth.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_kmeth.c",161,__func__), ERR_set_error)((16),(161),
# 161 "../crypto/ec/ec_kmeth.c" 3 4
       ((void *)0)
# 161 "../crypto/ec/ec_kmeth.c"
       );
        return 0;
    }
    if (!eckey->meth->compute_key(&sec, &seclen, pub_key, eckey))
        return 0;
    if (KDF != 
# 166 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 166 "../crypto/ec/ec_kmeth.c"
                  ) {
    ...
    CRYPTO_clear_free(sec, seclen, "../crypto/ec/ec_kmeth.c", 173);
    return outlen;
}

EC_KEY_METHOD *EC_KEY_METHOD_new(const EC_KEY_METHOD *meth)
{
    EC_KEY_METHOD *ret = CRYPTO_zalloc(sizeof(*meth), "../crypto/ec/ec_kmeth.c", 179);

    if (ret == 
# 181 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 181 "../crypto/ec/ec_kmeth.c"
                  )
        return 
# 182 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 182 "../crypto/ec/ec_kmeth.c"
                  ;
    if (meth != 
# 183 "../crypto/ec/ec_kmeth.c" 3 4
               ((void *)0)
...
{
    if (meth->flags & 1)
        CRYPTO_free(meth, "../crypto/ec/ec_kmeth.c", 192);
}
...
{
    if (pinit != 
# 272 "../crypto/ec/ec_kmeth.c" 3 4
                ((void *)0)
# 272 "../crypto/ec/ec_kmeth.c"
                    )
        *pinit = meth->init;
    if (pfinish != 
# 274 "../crypto/ec/ec_kmeth.c" 3 4
                  ((void *)0)
# 274 "../crypto/ec/ec_kmeth.c"
                      )
        *pfinish = meth->finish;
    if (pcopy != 
# 276 "../crypto/ec/ec_kmeth.c" 3 4
                ((void *)0)
# 276 "../crypto/ec/ec_kmeth.c"
                    )
        *pcopy = meth->copy;
    if (pset_group != 
# 278 "../crypto/ec/ec_kmeth.c" 3 4
                     ((void *)0)
# 278 "../crypto/ec/ec_kmeth.c"
                         )
        *pset_group = meth->set_group;
    if (pset_private != 
# 280 "../crypto/ec/ec_kmeth.c" 3 4
                       ((void *)0)
# 280 "../crypto/ec/ec_kmeth.c"
                           )
        *pset_private = meth->set_private;
    if (pset_public != 
# 282 "../crypto/ec/ec_kmeth.c" 3 4
                      ((void *)0)
# 282 "../crypto/ec/ec_kmeth.c"
                          )
...
{
    if (pkeygen != 
# 289 "../crypto/ec/ec_kmeth.c" 3 4
                  ((void *)0)
# 289 "../crypto/ec/ec_kmeth.c"
                      )
        *pkeygen = meth->keygen;
}
...
{
    if (pck != 
# 299 "../crypto/ec/ec_kmeth.c" 3 4
              ((void *)0)
# 299 "../crypto/ec/ec_kmeth.c"
                  )
...
{
    if (psign != 
# 317 "../crypto/ec/ec_kmeth.c" 3 4
                ((void *)0)
# 317 "../crypto/ec/ec_kmeth.c"
                    )
        *psign = meth->sign;
    if (psign_setup != 
# 319 "../crypto/ec/ec_kmeth.c" 3 4
                      ((void *)0)
# 319 "../crypto/ec/ec_kmeth.c"
                          )
        *psign_setup = meth->sign_setup;
    if (psign_sig != 
# 321 "../crypto/ec/ec_kmeth.c" 3 4
                    ((void *)0)
# 321 "../crypto/ec/ec_kmeth.c"
                        )
...
{
    if (pverify != 
# 335 "../crypto/ec/ec_kmeth.c" 3 4
                  ((void *)0)
# 335 "../crypto/ec/ec_kmeth.c"
                      )
        *pverify = meth->verify;
    if (pverify_sig != 
# 337 "../crypto/ec/ec_kmeth.c" 3 4
                      ((void *)0)
# 337 "../crypto/ec/ec_kmeth.c"
                          )
