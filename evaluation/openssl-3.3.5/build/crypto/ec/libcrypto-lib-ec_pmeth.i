# 0 "../crypto/ec/ec_pmeth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_pmeth.c"
# 14 "../crypto/ec/ec_pmeth.c"
...
static int pkey_ec_init(EVP_PKEY_CTX *ctx)
{
    ...
    if ((dctx = CRYPTO_zalloc(sizeof(*dctx), "../crypto/ec/ec_pmeth.c", 51)) == 
# 51 "../crypto/ec/ec_pmeth.c" 3 4
                                                 ((void *)0)
# 51 "../crypto/ec/ec_pmeth.c"
                                                     )
        return 0;
...
static int pkey_ec_copy(EVP_PKEY_CTX *dst, const EVP_PKEY_CTX *src)
{
    ...
    if (sctx->kdf_ukm) {
        dctx->kdf_ukm = CRYPTO_memdup((sctx->kdf_ukm), sctx->kdf_ukmlen, "../crypto/ec/ec_pmeth.c", 83);
        if (!dctx->kdf_ukm)
            return 0;
    } else
        dctx->kdf_ukm = 
# 87 "../crypto/ec/ec_pmeth.c" 3 4
                       ((void *)0)
# 87 "../crypto/ec/ec_pmeth.c"
                           ;
...
static void pkey_ec_cleanup(EVP_PKEY_CTX *ctx)
{
    ...
    if (dctx != 
# 95 "../crypto/ec/ec_pmeth.c" 3 4
               ((void *)0)
# 95 "../crypto/ec/ec_pmeth.c"
                   ) {
        EC_GROUP_free(dctx->gen_group);
        EC_KEY_free(dctx->co_key);
        CRYPTO_free(dctx->kdf_ukm, "../crypto/ec/ec_pmeth.c", 98);
        CRYPTO_free(dctx, "../crypto/ec/ec_pmeth.c", 99);
        ctx->data = 
# 100 "../crypto/ec/ec_pmeth.c" 3 4
                   ((void *)0)
# 100 "../crypto/ec/ec_pmeth.c"
                       ;
    }
}
                        ...
                        const unsigned char *tbs, size_t tbslen)
{
    ...
    if (!__builtin_expect(!!((sig_sz > 0) != 0), 1))
        return 0;

    if (sig == 
# 122 "../crypto/ec/ec_pmeth.c" 3 4
              ((void *)0)
# 122 "../crypto/ec/ec_pmeth.c"
                  ) {
    ...
    if (*siglen < (size_t)sig_sz) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",128,__func__), ERR_set_error)((16),(100),
# 128 "../crypto/ec/ec_pmeth.c" 3 4
       ((void *)0)
# 128 "../crypto/ec/ec_pmeth.c"
       );
        return 0;
    }

    type = (dctx->md != 
# 132 "../crypto/ec/ec_pmeth.c" 3 4
                       ((void *)0)
# 132 "../crypto/ec/ec_pmeth.c"
                           ) ? EVP_MD_get_type(dctx->md) : 64;
...
# 170 "../crypto/ec/ec_pmeth.c" 3 4
                            ((void *)0)
# 170 "../crypto/ec/ec_pmeth.c"
                                ;
    EC_KEY *eckey;
    ...
    if (ctx->pkey == 
# 175 "../crypto/ec/ec_pmeth.c" 3 4
                    ((void *)0) 
# 175 "../crypto/ec/ec_pmeth.c"
                         || ctx->peerkey == 
# 175 "../crypto/ec/ec_pmeth.c" 3 4
                                            ((void *)0)
# 175 "../crypto/ec/ec_pmeth.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",176,__func__), ERR_set_error)((16),(140),
# 176 "../crypto/ec/ec_pmeth.c" 3 4
       ((void *)0)
# 176 "../crypto/ec/ec_pmeth.c"
       );
        return 0;
    }
    eckeypub = EVP_PKEY_get0_EC_KEY(ctx->peerkey);
    if (eckeypub == 
# 180 "../crypto/ec/ec_pmeth.c" 3 4
                   ((void *)0)
# 180 "../crypto/ec/ec_pmeth.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",181,__func__), ERR_set_error)((16),(140),
# 181 "../crypto/ec/ec_pmeth.c" 3 4
       ((void *)0)
# 181 "../crypto/ec/ec_pmeth.c"
       );
        return 0;
    }
    ...
    if (!key) {
        ...
        if (group == 
# 192 "../crypto/ec/ec_pmeth.c" 3 4
                    ((void *)0)
# 192 "../crypto/ec/ec_pmeth.c"
                        )
            return 0;
                              ...
                              unsigned char *key, size_t *keylen)
{
    EC_PKEY_CTX *dctx = ctx->data;
    unsigned char *ktmp = 
# 217 "../crypto/ec/ec_pmeth.c" 3 4
                         ((void *)0)
# 217 "../crypto/ec/ec_pmeth.c"
                             ;
    size_t ktmplen;
    int rv = 0;
    if (dctx->kdf_type == 1)
    ...
    if (*keylen != dctx->kdf_outlen)
        return 0;
    if (!pkey_ec_derive(ctx, 
# 228 "../crypto/ec/ec_pmeth.c" 3 4
                            ((void *)0)
# 228 "../crypto/ec/ec_pmeth.c"
                                , &ktmplen))
        return 0;
    if ((ktmp = CRYPTO_malloc(ktmplen, "../crypto/ec/ec_pmeth.c", 230)) == 
# 230 "../crypto/ec/ec_pmeth.c" 3 4
                                           ((void *)0)
# 230 "../crypto/ec/ec_pmeth.c"
                                               )
        return 0;
 ...
 err:
    CRYPTO_clear_free(ktmp, ktmplen, "../crypto/ec/ec_pmeth.c", 242);
    return rv;
}
...
static int pkey_ec_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2)
{
    ...
    case (0x1000 + 1):
        ...
        if (group == 
# 254 "../crypto/ec/ec_pmeth.c" 3 4
                    ((void *)0)
# 254 "../crypto/ec/ec_pmeth.c"
                        ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",255,__func__), ERR_set_error)((16),(141),
# 255 "../crypto/ec/ec_pmeth.c" 3 4
           ((void *)0)
# 255 "../crypto/ec/ec_pmeth.c"
           );
            return 0;
        }
        EC_GROUP_free(dctx->gen_group);
    ...
    case (0x1000 + 2):
        if (!dctx->gen_group) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",264,__func__), ERR_set_error)((16),(139),
# 264 "../crypto/ec/ec_pmeth.c" 3 4
           ((void *)0)
# 264 "../crypto/ec/ec_pmeth.c"
           );
            return 0;
        }
    ...
    case (0x1000 + 3):
        if (p1 == -2) {
            if (dctx->cofactor_mode != -1)
                ...
                return EC_KEY_get_flags(ec_key) & 0x1000 ? 1 : 0;
            }
        } else if (p1 < -1 || p1 > 1)
            return -2;
        ...
        if (p1 != -1) {
            ...
            if (((ctx->pkey)->keymgmt != 
# 289 "../crypto/ec/ec_pmeth.c" 3 4
               ((void *)0)
# 289 "../crypto/ec/ec_pmeth.c"
               )) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",290,__func__), ERR_set_error)((16),((268|(0x2 << 18L))),
# 290 "../crypto/ec/ec_pmeth.c" 3 4
               ((void *)0)
# 290 "../crypto/ec/ec_pmeth.c"
               );
                return 0;
            }
            if (!ec_key->group)
            ...
            if (p1)
                EC_KEY_set_flags(dctx->co_key, 0x1000);
            else
                EC_KEY_clear_flags(dctx->co_key, 0x1000);
        } else {
            EC_KEY_free(dctx->co_key);
            dctx->co_key = 
# 309 "../crypto/ec/ec_pmeth.c" 3 4
                          ((void *)0)
# 309 "../crypto/ec/ec_pmeth.c"
                              ;
        }
        return 1;
    ...
    case (0x1000 + 9):
        CRYPTO_free(dctx->kdf_ukm, "../crypto/ec/ec_pmeth.c", 341);
        dctx->kdf_ukm = p2;
        if (p2)
            dctx->kdf_ukmlen = p1;
        else
    ...
    case 1:
        if (EVP_MD_get_type((const EVP_MD *)p2) != 64 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 416 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 675 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 672 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 673 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 674 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 1096 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 1097 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 1098 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 1099 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 1143) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",365,__func__), ERR_set_error)((16),(138),
# 365 "../crypto/ec/ec_pmeth.c" 3 4
           ((void *)0)
# 365 "../crypto/ec/ec_pmeth.c"
           );
            return 0;
        }
        dctx->md = p2;
                            ...
                            const char *type, const char *value)
{
    if (strcmp(type, "ec_paramgen_curve") == 0) {
        ...
        if (nid == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",399,__func__), ERR_set_error)((16),(141),
# 399 "../crypto/ec/ec_pmeth.c" 3 4
           ((void *)0)
# 399 "../crypto/ec/ec_pmeth.c"
           );
            return 0;
        }
...
# 414 "../crypto/ec/ec_pmeth.c" 3 4
                                                 ((void *)0)
# 414 "../crypto/ec/ec_pmeth.c"
                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",415,__func__), ERR_set_error)((16),(151),
# 415 "../crypto/ec/ec_pmeth.c" 3 4
           ((void *)0)
# 415 "../crypto/ec/ec_pmeth.c"
           );
            return 0;
        }
...
{
    EC_KEY *ec = 
# 430 "../crypto/ec/ec_pmeth.c" 3 4
                ((void *)0)
# 430 "../crypto/ec/ec_pmeth.c"
                    ;
    EC_PKEY_CTX *dctx = ctx->data;
    int ret;

    if (dctx->gen_group == 
# 434 "../crypto/ec/ec_pmeth.c" 3 4
                          ((void *)0)
# 434 "../crypto/ec/ec_pmeth.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",435,__func__), ERR_set_error)((16),(139),
# 435 "../crypto/ec/ec_pmeth.c" 3 4
       ((void *)0)
# 435 "../crypto/ec/ec_pmeth.c"
       );
        return 0;
    }
    ec = EC_KEY_new();
    if (ec == 
# 439 "../crypto/ec/ec_pmeth.c" 3 4
             ((void *)0)
# 439 "../crypto/ec/ec_pmeth.c"
                 )
        return 0;
    if (!(ret = EC_KEY_set_group(ec, dctx->gen_group))
        || !__builtin_expect(!!((ret = EVP_PKEY_assign((pkey), 408, (ec))) != 0), 1))
        EC_KEY_free(ec);
    return ret;
}
...
{
    EC_KEY *ec = 
# 449 "../crypto/ec/ec_pmeth.c" 3 4
                ((void *)0)
# 449 "../crypto/ec/ec_pmeth.c"
                    ;
    EC_PKEY_CTX *dctx = ctx->data;
    int ret;

    if (ctx->pkey == 
# 453 "../crypto/ec/ec_pmeth.c" 3 4
                    ((void *)0) 
# 453 "../crypto/ec/ec_pmeth.c"
                         && dctx->gen_group == 
# 453 "../crypto/ec/ec_pmeth.c" 3 4
                                               ((void *)0)
# 453 "../crypto/ec/ec_pmeth.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_pmeth.c",454,__func__), ERR_set_error)((16),(139),
# 454 "../crypto/ec/ec_pmeth.c" 3 4
       ((void *)0)
# 454 "../crypto/ec/ec_pmeth.c"
       );
        return 0;
    }
    ec = EC_KEY_new();
    if (ec == 
# 458 "../crypto/ec/ec_pmeth.c" 3 4
             ((void *)0)
# 458 "../crypto/ec/ec_pmeth.c"
                 )
        return 0;
    if (!__builtin_expect(!!((EVP_PKEY_assign((pkey), 408, (ec))) != 0), 1)) {
        EC_KEY_free(ec);
        return 0;
    }

    if (ctx->pkey != 
# 465 "../crypto/ec/ec_pmeth.c" 3 4
                    ((void *)0)
# 465 "../crypto/ec/ec_pmeth.c"
                        )
