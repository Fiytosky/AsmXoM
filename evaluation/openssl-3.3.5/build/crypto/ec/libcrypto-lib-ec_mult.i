# 0 "../crypto/ec/ec_mult.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_mult.c"
# 15 "../crypto/ec/ec_mult.c"
...
# 23 "../crypto/ec/ec_mult.c" 2
# 37 "../crypto/ec/ec_mult.c"
...
{
    EC_PRE_COMP *ret = 
# 52 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 52 "../crypto/ec/ec_mult.c"
                          ;

    if (!group)
        return 
# 55 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 55 "../crypto/ec/ec_mult.c"
                  ;

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ec_mult.c", 57);
    if (ret == 
# 58 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 58 "../crypto/ec/ec_mult.c"
                  )
        return ret;
    ...
    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_free(ret, "../crypto/ec/ec_mult.c", 66);
        return 
# 67 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 67 "../crypto/ec/ec_mult.c"
                  ;
    }
    return ret;
}
...
EC_PRE_COMP *EC_ec_pre_comp_dup(EC_PRE_COMP *pre)
{
    int i;
    if (pre != 
# 75 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 75 "../crypto/ec/ec_mult.c"
                  )
...
void EC_ec_pre_comp_free(EC_PRE_COMP *pre)
{
    ...
    if (pre == 
# 84 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 84 "../crypto/ec/ec_mult.c"
                  )
        return;
    ...
    if (pre->points != 
# 93 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 93 "../crypto/ec/ec_mult.c"
                          ) {
        EC_POINT **pts;

        for (pts = pre->points; *pts != 
# 96 "../crypto/ec/ec_mult.c" 3 4
                                       ((void *)0)
# 96 "../crypto/ec/ec_mult.c"
                                           ; pts++)
            EC_POINT_free(*pts);
        CRYPTO_free(pre->points, "../crypto/ec/ec_mult.c", 98);
    }
    CRYPTO_FREE_REF(&pre->references);
    CRYPTO_free(pre, "../crypto/ec/ec_mult.c", 101);
}
# 139 "../crypto/ec/ec_mult.c"
int ossl_ec_scalar_mul_ladder(const EC_GROUP *group, EC_POINT *r,
                              const BIGNUM *scalar, const EC_POINT *point,
                              BN_CTX *ctx)
{
    ...
    EC_POINT *p = 
# 144 "../crypto/ec/ec_mult.c" 3 4
                 ((void *)0)
# 144 "../crypto/ec/ec_mult.c"
                     ;
    EC_POINT *s = 
# 145 "../crypto/ec/ec_mult.c" 3 4
                 ((void *)0)
# 145 "../crypto/ec/ec_mult.c"
                     ;
    BIGNUM *k = 
# 146 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 146 "../crypto/ec/ec_mult.c"
                   ;
    BIGNUM *lambda = 
# 147 "../crypto/ec/ec_mult.c" 3 4
                    ((void *)0)
# 147 "../crypto/ec/ec_mult.c"
                        ;
    BIGNUM *cardinality = 
# 148 "../crypto/ec/ec_mult.c" 3 4
                         ((void *)0)
# 148 "../crypto/ec/ec_mult.c"
                             ;
    int ret = 0;


    if (point != 
# 152 "../crypto/ec/ec_mult.c" 3 4
                ((void *)0) 
# 152 "../crypto/ec/ec_mult.c"
                     && EC_POINT_is_at_infinity(group, point))
        return EC_POINT_set_to_infinity(group, r);

    if (BN_is_zero(group->order)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",156,__func__), ERR_set_error)((16),(114),
# 156 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 156 "../crypto/ec/ec_mult.c"
       );
        return 0;
    }
    if (BN_is_zero(group->cofactor)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",160,__func__), ERR_set_error)((16),(164),
# 160 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 160 "../crypto/ec/ec_mult.c"
       );
        return 0;
    }
...
# 166 "../crypto/ec/ec_mult.c" 3 4
                                     ((void *)0)
# 166 "../crypto/ec/ec_mult.c"
                                         )
        || ((s = EC_POINT_new(group)) == 
# 167 "../crypto/ec/ec_mult.c" 3 4
                                        ((void *)0)
# 167 "../crypto/ec/ec_mult.c"
                                            )) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",168,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 168 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 168 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }

    if (point == 
# 172 "../crypto/ec/ec_mult.c" 3 4
                ((void *)0)
# 172 "../crypto/ec/ec_mult.c"
                    ) {
        if (!EC_POINT_copy(p, group->generator)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",174,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 174 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 174 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
    } else {
        if (!EC_POINT_copy(p, point)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",179,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 179 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 179 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
    }

    do { BN_set_flags((p)->X, (0x04)); BN_set_flags((p)->Y, (0x04)); BN_set_flags((p)->Z, (0x04)); } while(0);
    do { BN_set_flags((r)->X, (0x04)); BN_set_flags((r)->Y, (0x04)); BN_set_flags((r)->Z, (0x04)); } while(0);
    do { BN_set_flags((s)->X, (0x04)); BN_set_flags((s)->Y, (0x04)); BN_set_flags((s)->Z, (0x04)); } while(0);

    cardinality = BN_CTX_get(ctx);
    lambda = BN_CTX_get(ctx);
    k = BN_CTX_get(ctx);
    if (k == 
# 191 "../crypto/ec/ec_mult.c" 3 4
            ((void *)0)
# 191 "../crypto/ec/ec_mult.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",192,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 192 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 192 "../crypto/ec/ec_mult.c"
    ...
    if (!BN_mul(cardinality, group->order, group->cofactor, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",197,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 197 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 197 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
...
# 209 "../crypto/ec/ec_mult.c" 3 4
                                        ((void *)0)
# 209 "../crypto/ec/ec_mult.c"
                                            )
        || (bn_wexpand(lambda, group_top + 2) == 
# 210 "../crypto/ec/ec_mult.c" 3 4
                                                ((void *)0)
# 210 "../crypto/ec/ec_mult.c"
                                                    )) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",211,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 211 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 211 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }

    if (!BN_copy(k, scalar)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",216,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 216 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 216 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    ...
    if ((BN_num_bits(k) > cardinality_bits) || (BN_is_negative(k))) {
        ...
        if (!BN_nnmod(k, k, cardinality, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",228,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 228 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 228 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
    }
    ...
    if (!BN_add(lambda, k, cardinality)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",234,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 234 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 234 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    BN_set_flags(lambda, 0x04);
    if (!BN_add(k, lambda, cardinality)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",239,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 239 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 239 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
...
# 250 "../crypto/ec/ec_mult.c" 3 4
                                       ((void *)0)
# 250 "../crypto/ec/ec_mult.c"
                                           )
        || (bn_wexpand(s->Y, group_top) == 
# 251 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 251 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(s->Z, group_top) == 
# 252 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 252 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(r->X, group_top) == 
# 253 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 253 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(r->Y, group_top) == 
# 254 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 254 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(r->Z, group_top) == 
# 255 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 255 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(p->X, group_top) == 
# 256 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 256 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(p->Y, group_top) == 
# 257 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 257 "../crypto/ec/ec_mult.c"
                                              )
        || (bn_wexpand(p->Z, group_top) == 
# 258 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 258 "../crypto/ec/ec_mult.c"
                                              )) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",259,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 259 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 259 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }


    if (!p->Z_is_one && (group->meth->make_affine == 
# 264 "../crypto/ec/ec_mult.c" 3 4
                                                    ((void *)0)
                         
# 265 "../crypto/ec/ec_mult.c"
                        || !group->meth->make_affine(group, p, ctx))) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",266,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 266 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 266 "../crypto/ec/ec_mult.c"
           );
            goto err;
    }
    ...
    if (!ec_point_ladder_pre(group, r, s, p, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",272,__func__), ERR_set_error)((16),(153),
# 272 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 272 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    ...
    pbit = 1;
# 346 "../crypto/ec/ec_mult.c"
    for (i = cardinality_bits - 1; i >= 0; i--) {
        kbit = BN_is_bit_set(k, i) ^ pbit;
        do { BN_consttime_swap(kbit, (r)->X, (s)->X, group_top); BN_consttime_swap(kbit, (r)->Y, (s)->Y, group_top); BN_consttime_swap(kbit, (r)->Z, (s)->Z, group_top); Z_is_one = ((r)->Z_is_one ^ (s)->Z_is_one) & (kbit); (r)->Z_is_one ^= (Z_is_one); (s)->Z_is_one ^= (Z_is_one); } while(0);


        if (!ec_point_ladder_step(group, r, s, p, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",352,__func__), ERR_set_error)((16),(162),
# 352 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 352 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
    ...
    do { BN_consttime_swap(pbit, (r)->X, (s)->X, group_top); BN_consttime_swap(pbit, (r)->Y, (s)->Y, group_top); BN_consttime_swap(pbit, (r)->Z, (s)->Z, group_top); Z_is_one = ((r)->Z_is_one ^ (s)->Z_is_one) & (pbit); (r)->Z_is_one ^= (Z_is_one); (s)->Z_is_one ^= (Z_is_one); } while(0);



    if (!ec_point_ladder_post(group, r, s, p, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",367,__func__), ERR_set_error)((16),(136),
# 367 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 367 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
...
# 404 "../crypto/ec/ec_mult.c"
int ossl_ec_wNAF_mul(const EC_GROUP *group, EC_POINT *r, const BIGNUM *scalar,
                     size_t num, const EC_POINT *points[],
                     const BIGNUM *scalars[], BN_CTX *ctx)
{
    const EC_POINT *generator = 
# 408 "../crypto/ec/ec_mult.c" 3 4
                               ((void *)0)
# 408 "../crypto/ec/ec_mult.c"
                                   ;
    EC_POINT *tmp = 
# 409 "../crypto/ec/ec_mult.c" 3 4
                   ((void *)0)
# 409 "../crypto/ec/ec_mult.c"
                       ;
    size_t totalnum;
    ...
    size_t *wsize = 
# 417 "../crypto/ec/ec_mult.c" 3 4
                   ((void *)0)
# 417 "../crypto/ec/ec_mult.c"
                       ;
    signed char **wNAF = 
# 418 "../crypto/ec/ec_mult.c" 3 4
                        ((void *)0)
# 418 "../crypto/ec/ec_mult.c"
                            ;
    size_t *wNAF_len = 
# 419 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 419 "../crypto/ec/ec_mult.c"
                          ;
    size_t max_len = 0;
    size_t num_val;
    EC_POINT **val = 
# 422 "../crypto/ec/ec_mult.c" 3 4
                    ((void *)0)
# 422 "../crypto/ec/ec_mult.c"
                        ;
    EC_POINT **v;
    EC_POINT ***val_sub = 
# 424 "../crypto/ec/ec_mult.c" 3 4
                         ((void *)0)
# 424 "../crypto/ec/ec_mult.c"
                             ;

    const EC_PRE_COMP *pre_comp = 
# 426 "../crypto/ec/ec_mult.c" 3 4
                                 ((void *)0)
# 426 "../crypto/ec/ec_mult.c"
                                     ;
    int num_scalar = 0;
    ...
    if (!BN_is_zero(group->order) && !BN_is_zero(group->cofactor)) {
        ...
        if ((scalar != group->order) && (scalar != 
# 438 "../crypto/ec/ec_mult.c" 3 4
                                                  ((void *)0)
# 438 "../crypto/ec/ec_mult.c"
                                                      ) && (num == 0)) {
# 447 "../crypto/ec/ec_mult.c"
            return ossl_ec_scalar_mul_ladder(group, r, scalar, 
# 447 "../crypto/ec/ec_mult.c" 3 4
                                                              ((void *)0)
# 447 "../crypto/ec/ec_mult.c"
                                                                  , ctx);
        }
        if ((scalar == 
# 449 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 449 "../crypto/ec/ec_mult.c"
                          ) && (num == 1) && (scalars[0] != group->order)) {
    ...
    if (scalar != 
# 462 "../crypto/ec/ec_mult.c" 3 4
                 ((void *)0)
# 462 "../crypto/ec/ec_mult.c"
                     ) {
        generator = EC_GROUP_get0_generator(group);
        if (generator == 
# 464 "../crypto/ec/ec_mult.c" 3 4
                        ((void *)0)
# 464 "../crypto/ec/ec_mult.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",465,__func__), ERR_set_error)((16),(113),
# 465 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 465 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
        ...
        if (pre_comp && pre_comp->numblocks
            ...
            if (pre_comp->num != (pre_comp->numblocks * pre_points_per_block)) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",493,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 493 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 493 "../crypto/ec/ec_mult.c"
               );
                goto err;
            }
        } else {
            ...
            pre_comp = 
# 498 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 498 "../crypto/ec/ec_mult.c"
                          ;
            numblocks = 1;
            num_scalar = 1;
    ...
    wsize = CRYPTO_malloc(totalnum * sizeof(wsize[0]), "../crypto/ec/ec_mult.c", 507);
    wNAF_len = CRYPTO_malloc(totalnum * sizeof(wNAF_len[0]), "../crypto/ec/ec_mult.c", 508);

    wNAF = CRYPTO_malloc((totalnum + 1) * sizeof(wNAF[0]), "../crypto/ec/ec_mult.c", 510);
    val_sub = CRYPTO_malloc(totalnum * sizeof(val_sub[0]), "../crypto/ec/ec_mult.c", 511);


    if (wNAF != 
# 514 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 514 "../crypto/ec/ec_mult.c"
                   )
        wNAF[0] = 
# 515 "../crypto/ec/ec_mult.c" 3 4
                 ((void *)0)
# 515 "../crypto/ec/ec_mult.c"
                     ;

    if (wsize == 
# 517 "../crypto/ec/ec_mult.c" 3 4
                ((void *)0) 
# 517 "../crypto/ec/ec_mult.c"
                     || wNAF_len == 
# 517 "../crypto/ec/ec_mult.c" 3 4
                                    ((void *)0) 
# 517 "../crypto/ec/ec_mult.c"
...
# 517 "../crypto/ec/ec_mult.c"
    ...
    for (i = 0; i < num + num_scalar; i++) {
        ...
        wNAF[i + 1] = 
# 531 "../crypto/ec/ec_mult.c" 3 4
                     ((void *)0)
# 531 "../crypto/ec/ec_mult.c"
                         ;
        wNAF[i] =
            bn_compute_wNAF((i < num ? scalars[i] : scalar), wsize[i],
                            &wNAF_len[i]);
        if (wNAF[i] == 
# 535 "../crypto/ec/ec_mult.c" 3 4
                      ((void *)0)
# 535 "../crypto/ec/ec_mult.c"
                          )
            goto err;
    ...
    if (numblocks) {
        ...
        if (pre_comp == 
# 544 "../crypto/ec/ec_mult.c" 3 4
                       ((void *)0)
# 544 "../crypto/ec/ec_mult.c"
                           ) {
            if (num_scalar != 1) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",546,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 546 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 546 "../crypto/ec/ec_mult.c"
               );
                goto err;
            }
...
# 551 "../crypto/ec/ec_mult.c" 3 4
                                   ((void *)0)
# 551 "../crypto/ec/ec_mult.c"
                                       ;
            size_t tmp_len = 0;

            if (num_scalar != 0) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",555,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 555 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 555 "../crypto/ec/ec_mult.c"
               );
                goto err;
            }
            ...
            if (tmp_len <= max_len) {
                ...
                wNAF[num] = tmp_wNAF;
                wNAF[num + 1] = 
# 577 "../crypto/ec/ec_mult.c" 3 4
                               ((void *)0)
# 577 "../crypto/ec/ec_mult.c"
                                   ;
                ...
                if (tmp_len < numblocks * blocksize) {
                    ...
                    if (numblocks > pre_comp->numblocks) {
                        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",598,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 598 "../crypto/ec/ec_mult.c" 3 4
                       ((void *)0)
# 598 "../crypto/ec/ec_mult.c"
                       );
                        CRYPTO_free(tmp_wNAF, "../crypto/ec/ec_mult.c", 599);
                        goto err;
                    }
                    totalnum = num + numblocks;
                }
                ...
                for (i = num; i < totalnum; i++) {
                    if (i < totalnum - 1) {
                        ...
                        if (tmp_len < blocksize) {
                            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",613,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 613 "../crypto/ec/ec_mult.c" 3 4
                           ((void *)0)
# 613 "../crypto/ec/ec_mult.c"
                           );
                            CRYPTO_free(tmp_wNAF, "../crypto/ec/ec_mult.c", 614);
                            goto err;
                        }
                        tmp_len -= blocksize;
                    } else
                    ...
                    wNAF[i + 1] = 
# 625 "../crypto/ec/ec_mult.c" 3 4
                                 ((void *)0)
# 625 "../crypto/ec/ec_mult.c"
                                     ;
                    wNAF[i] = CRYPTO_malloc(wNAF_len[i], "../crypto/ec/ec_mult.c", 626);
                    if (wNAF[i] == 
# 627 "../crypto/ec/ec_mult.c" 3 4
                                  ((void *)0)
# 627 "../crypto/ec/ec_mult.c"
                                      ) {
                        CRYPTO_free(tmp_wNAF, "../crypto/ec/ec_mult.c", 628);
                        goto err;
                    }
                    ...
                    if (*tmp_points == 
# 635 "../crypto/ec/ec_mult.c" 3 4
                                      ((void *)0)
# 635 "../crypto/ec/ec_mult.c"
                                          ) {
                        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",636,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 636 "../crypto/ec/ec_mult.c" 3 4
                       ((void *)0)
# 636 "../crypto/ec/ec_mult.c"
                       );
                        CRYPTO_free(tmp_wNAF, "../crypto/ec/ec_mult.c", 637);
                        goto err;
                    }
                ...
                CRYPTO_free(tmp_wNAF, "../crypto/ec/ec_mult.c", 644);
            }
        }
    }
    ...
    val = CRYPTO_malloc((num_val + 1) * sizeof(val[0]), "../crypto/ec/ec_mult.c", 654);
    if (val == 
# 655 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 655 "../crypto/ec/ec_mult.c"
                  )
        goto err;
    val[num_val] = 
# 657 "../crypto/ec/ec_mult.c" 3 4
                  ((void *)0)
# 657 "../crypto/ec/ec_mult.c"
                      ;
    ...
    for (i = 0; i < num + num_scalar; i++) {
        ...
        for (j = 0; j < ((size_t)1 << (wsize[i] - 1)); j++) {
            *v = EC_POINT_new(group);
            if (*v == 
# 665 "../crypto/ec/ec_mult.c" 3 4
                     ((void *)0)
# 665 "../crypto/ec/ec_mult.c"
                         )
                goto err;
            v++;
        }
    ...
    if (!(v == val + num_val)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",671,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 671 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 671 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }

    if ((tmp = EC_POINT_new(group)) == 
# 675 "../crypto/ec/ec_mult.c" 3 4
                                      ((void *)0)
# 675 "../crypto/ec/ec_mult.c"
                                          )
        goto err;
# 685 "../crypto/ec/ec_mult.c"
    for (i = 0; i < num + num_scalar; i++) {
        if (i < num) {
...
# 705 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
        
# 706 "../crypto/ec/ec_mult.c"
                ...
                if (digit) {
                    ...
                    if (r_is_at_infinity) {
                        if (!EC_POINT_copy(r, val_sub[i][digit >> 1]))
                            goto err;
# 750 "../crypto/ec/ec_mult.c"
                        if (!ossl_ec_point_blind_coordinates(group, r, ctx)) {
                            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",751,__func__), ERR_set_error)((16),(163),
# 751 "../crypto/ec/ec_mult.c" 3 4
                           ((void *)0)
# 751 "../crypto/ec/ec_mult.c"
                           );
                            goto err;
                        }
 ...
 err:
    EC_POINT_free(tmp);
    CRYPTO_free(wsize, "../crypto/ec/ec_mult.c", 779);
    CRYPTO_free(wNAF_len, "../crypto/ec/ec_mult.c", 780);
    if (wNAF != 
# 781 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 781 "../crypto/ec/ec_mult.c"
                   ) {
        signed char **w;

        for (w = wNAF; *w != 
# 784 "../crypto/ec/ec_mult.c" 3 4
                            ((void *)0)
# 784 "../crypto/ec/ec_mult.c"
                                ; w++)
            CRYPTO_free(*w, "../crypto/ec/ec_mult.c", 785);

        CRYPTO_free(wNAF, "../crypto/ec/ec_mult.c", 787);
    }
    if (val != 
# 789 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 789 "../crypto/ec/ec_mult.c"
                  ) {
        for (v = val; *v != 
# 790 "../crypto/ec/ec_mult.c" 3 4
                           ((void *)0)
# 790 "../crypto/ec/ec_mult.c"
                               ; v++)
            EC_POINT_clear_free(*v);

        CRYPTO_free(val, "../crypto/ec/ec_mult.c", 793);
    }
    CRYPTO_free(val_sub, "../crypto/ec/ec_mult.c", 795);
    return ret;
}
# 819 "../crypto/ec/ec_mult.c"
int ossl_ec_wNAF_precompute_mult(EC_GROUP *group, BN_CTX *ctx)
{
    const EC_POINT *generator;
    EC_POINT *tmp_point = 
# 822 "../crypto/ec/ec_mult.c" 3 4
                         ((void *)0)
# 822 "../crypto/ec/ec_mult.c"
                             , *base = 
# 822 "../crypto/ec/ec_mult.c" 3 4
                                       ((void *)0)
# 822 "../crypto/ec/ec_mult.c"
    ...
    EC_POINT **points = 
# 825 "../crypto/ec/ec_mult.c" 3 4
                       ((void *)0)
# 825 "../crypto/ec/ec_mult.c"
                           ;
    ...
    BN_CTX *new_ctx = 
# 830 "../crypto/ec/ec_mult.c" 3 4
                     ((void *)0)
# 830 "../crypto/ec/ec_mult.c"
                         ;
...
# 835 "../crypto/ec/ec_mult.c" 3 4
                                              ((void *)0)
# 835 "../crypto/ec/ec_mult.c"
                                                  )
        return 0;

    generator = EC_GROUP_get0_generator(group);
    if (generator == 
# 839 "../crypto/ec/ec_mult.c" 3 4
                    ((void *)0)
# 839 "../crypto/ec/ec_mult.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",840,__func__), ERR_set_error)((16),(113),
# 840 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 840 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    ...
    if (ctx == 
# 845 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 845 "../crypto/ec/ec_mult.c"
                  )
        ctx = new_ctx = BN_CTX_new();

    if (ctx == 
# 848 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 848 "../crypto/ec/ec_mult.c"
                  )
        goto err;
    ...
    if (order == 
# 855 "../crypto/ec/ec_mult.c" 3 4
                ((void *)0)
# 855 "../crypto/ec/ec_mult.c"
                    )
        goto err;
    if (BN_is_zero(order)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",858,__func__), ERR_set_error)((16),(114),
# 858 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 858 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    ...
    points = CRYPTO_malloc(sizeof(*points) * (num + 1), "../crypto/ec/ec_mult.c", 884);
    if (points == 
# 885 "../crypto/ec/ec_mult.c" 3 4
                 ((void *)0)
# 885 "../crypto/ec/ec_mult.c"
                     )
        goto err;

    var = points;
    var[num] = 
# 889 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 889 "../crypto/ec/ec_mult.c"
                  ;
    for (i = 0; i < num; i++) {
        if ((var[i] = EC_POINT_new(group)) == 
# 891 "../crypto/ec/ec_mult.c" 3 4
                                             ((void *)0)
# 891 "../crypto/ec/ec_mult.c"
                                                 ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",892,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 892 "../crypto/ec/ec_mult.c" 3 4
           ((void *)0)
# 892 "../crypto/ec/ec_mult.c"
           );
            goto err;
        }
    }
...
# 897 "../crypto/ec/ec_mult.c" 3 4
                                            ((void *)0)
        
# 898 "../crypto/ec/ec_mult.c"
       || (base = EC_POINT_new(group)) == 
# 898 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
# 898 "../crypto/ec/ec_mult.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",899,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 899 "../crypto/ec/ec_mult.c" 3 4
       ((void *)0)
# 899 "../crypto/ec/ec_mult.c"
       );
        goto err;
    }
    ...
    for (i = 0; i < numblocks; i++) {
        ...
        if (i < numblocks - 1) {
            ...
            if (blocksize <= 2) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_mult.c",931,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 931 "../crypto/ec/ec_mult.c" 3 4
               ((void *)0)
# 931 "../crypto/ec/ec_mult.c"
               );
                goto err;
            }
    ...
    if (group->meth->points_make_affine == 
# 944 "../crypto/ec/ec_mult.c" 3 4
                                          ((void *)0)
        
# 945 "../crypto/ec/ec_mult.c"
    ...
    points = 
# 953 "../crypto/ec/ec_mult.c" 3 4
            ((void *)0)
# 953 "../crypto/ec/ec_mult.c"
                ;
    pre_comp->num = num;
    group->pre_comp_type = PCT_ec, group->pre_comp.ec = pre_comp;
    pre_comp = 
# 956 "../crypto/ec/ec_mult.c" 3 4
              ((void *)0)
# 956 "../crypto/ec/ec_mult.c"
                  ;
    ret = 1;
 ...
 err:
    ...
    if (points) {
        ...
        for (p = points; *p != 
# 969 "../crypto/ec/ec_mult.c" 3 4
                              ((void *)0)
# 969 "../crypto/ec/ec_mult.c"
                                  ; p++)
            EC_POINT_free(*p);
        CRYPTO_free(points, "../crypto/ec/ec_mult.c", 971);
    }
...
int ossl_ec_wNAF_have_precompute_mult(const EC_GROUP *group)
{
    return group->pre_comp_type == PCT_ec && group->pre_comp.ec != 
# 980 "../crypto/ec/ec_mult.c" 3 4
          ((void *)0)
# 980 "../crypto/ec/ec_mult.c"
                                ;
}
