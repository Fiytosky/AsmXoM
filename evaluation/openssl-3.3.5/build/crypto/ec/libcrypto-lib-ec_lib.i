# 0 "../crypto/ec/ec_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_lib.c"
# 15 "../crypto/ec/ec_lib.c"
...
# 19 "../crypto/ec/ec_lib.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../crypto/ec/ec_lib.c" 2
...
# 25 "../crypto/ec/ec_lib.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 26 "../crypto/ec/ec_lib.c" 2
# 1 "../crypto/ec/ec_local.h" 1
# 16 "../crypto/ec/ec_local.h"
                               ...
                               const EC_METHOD *meth)
{
    ...
    if (meth == 
# 35 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 35 "../crypto/ec/ec_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",36,__func__), ERR_set_error)((16),(108),
# 36 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 36 "../crypto/ec/ec_lib.c"
       );
        return 
# 37 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 37 "../crypto/ec/ec_lib.c"
                  ;
    }
    if (meth->group_init == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",40,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 40 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 40 "../crypto/ec/ec_lib.c"
       );
        return 
# 41 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 41 "../crypto/ec/ec_lib.c"
                  ;
    }

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ec_lib.c", 44);
    if (ret == 
# 45 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 45 "../crypto/ec/ec_lib.c"
                  )
        return 
# 46 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 46 "../crypto/ec/ec_lib.c"
                  ;

    ret->libctx = libctx;
    if (propq != 
# 49 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 49 "../crypto/ec/ec_lib.c"
                    ) {
        ret->propq = CRYPTO_strdup(propq, "../crypto/ec/ec_lib.c", 50);
        if (ret->propq == 
# 51 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 51 "../crypto/ec/ec_lib.c"
                             )
            goto err;
    }
    ret->meth = meth;
    if ((ret->meth->flags & 0x2) == 0) {
        ret->order = BN_new();
        if (ret->order == 
# 57 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 57 "../crypto/ec/ec_lib.c"
                             )
            goto err;
        ret->cofactor = BN_new();
        if (ret->cofactor == 
# 60 "../crypto/ec/ec_lib.c" 3 4
                            ((void *)0)
# 60 "../crypto/ec/ec_lib.c"
                                )
            goto err;
    }
    ret->asn1_flag = 0x000;
 ...
 err:
    ...
    CRYPTO_free(ret->propq, "../crypto/ec/ec_lib.c", 72);
    CRYPTO_free(ret, "../crypto/ec/ec_lib.c", 73);
    return 
# 74 "../crypto/ec/ec_lib.c" 3 4
          ((void *)0)
# 74 "../crypto/ec/ec_lib.c"
              ;
}
...
{
    return ossl_ec_group_new_ex(
# 81 "../crypto/ec/ec_lib.c" 3 4
                               ((void *)0)
# 81 "../crypto/ec/ec_lib.c"
                                   , 
# 81 "../crypto/ec/ec_lib.c" 3 4
                                     ((void *)0)
# 81 "../crypto/ec/ec_lib.c"
...
# 110 "../crypto/ec/ec_lib.c"
    ...
    group->pre_comp.ec = 
# 120 "../crypto/ec/ec_lib.c" 3 4
                        ((void *)0)
# 120 "../crypto/ec/ec_lib.c"
                            ;
}
...
void EC_GROUP_free(EC_GROUP *group)
{
    ...
    CRYPTO_free(group->seed, "../crypto/ec/ec_lib.c", 136);
    CRYPTO_free(group->propq, "../crypto/ec/ec_lib.c", 137);
    CRYPTO_free(group, "../crypto/ec/ec_lib.c", 138);
}
...
void EC_GROUP_clear_free(EC_GROUP *group)
{
    ...
    CRYPTO_clear_free(group->seed, group->seed_len, "../crypto/ec/ec_lib.c", 157);
    CRYPTO_clear_free(group, sizeof(*group), "../crypto/ec/ec_lib.c", 158);
}
...
int EC_GROUP_copy(EC_GROUP *dest, const EC_GROUP *src)
{
    if (dest->meth->group_copy == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",165,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 165 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 165 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (dest->meth != src->meth) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",169,__func__), ERR_set_error)((16),(101),
# 169 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 169 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (dest == src)
...
# 203 "../crypto/ec/ec_lib.c"
    ...
    if (src->mont_data != 
# 214 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 214 "../crypto/ec/ec_lib.c"
                             ) {
        if (dest->mont_data == 
# 215 "../crypto/ec/ec_lib.c" 3 4
                              ((void *)0)
# 215 "../crypto/ec/ec_lib.c"
                                  ) {
            dest->mont_data = BN_MONT_CTX_new();
            if (dest->mont_data == 
# 217 "../crypto/ec/ec_lib.c" 3 4
                                  ((void *)0)
# 217 "../crypto/ec/ec_lib.c"
                                      )
                return 0;
        }
        ...
        dest->mont_data = 
# 225 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 225 "../crypto/ec/ec_lib.c"
                             ;
    }

    if (src->generator != 
# 228 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 228 "../crypto/ec/ec_lib.c"
                             ) {
        if (dest->generator == 
# 229 "../crypto/ec/ec_lib.c" 3 4
                              ((void *)0)
# 229 "../crypto/ec/ec_lib.c"
                                  ) {
            dest->generator = EC_POINT_new(dest);
            if (dest->generator == 
# 231 "../crypto/ec/ec_lib.c" 3 4
                                  ((void *)0)
# 231 "../crypto/ec/ec_lib.c"
                                      )
                return 0;
        }
        ...
        dest->generator = 
# 239 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 239 "../crypto/ec/ec_lib.c"
                             ;
    }

    if ((src->meth->flags & 0x2) == 0) {
    ...
    if (src->seed) {
        CRYPTO_free(dest->seed, "../crypto/ec/ec_lib.c", 254);
        if ((dest->seed = CRYPTO_malloc(src->seed_len, "../crypto/ec/ec_lib.c", 255)) == 
# 255 "../crypto/ec/ec_lib.c" 3 4
                                                           ((void *)0)
# 255 "../crypto/ec/ec_lib.c"
        ...
        CRYPTO_free(dest->seed, "../crypto/ec/ec_lib.c", 261);
        dest->seed = 
# 262 "../crypto/ec/ec_lib.c" 3 4
                    ((void *)0)
# 262 "../crypto/ec/ec_lib.c"
                        ;
        dest->seed_len = 0;
    }
...
{
    EC_GROUP *t = 
# 271 "../crypto/ec/ec_lib.c" 3 4
                 ((void *)0)
# 271 "../crypto/ec/ec_lib.c"
                     ;
    int ok = 0;

    if (a == 
# 274 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 274 "../crypto/ec/ec_lib.c"
                )
        return 
# 275 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 275 "../crypto/ec/ec_lib.c"
                  ;

    if ((t = ossl_ec_group_new_ex(a->libctx, a->propq, a->meth)) == 
# 277 "../crypto/ec/ec_lib.c" 3 4
                                                                   ((void *)0)
# 277 "../crypto/ec/ec_lib.c"
                                                                       )
        return 
# 278 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 278 "../crypto/ec/ec_lib.c"
                  ;
 ...
 err:
    if (!ok) {
        EC_GROUP_free(t);
        return 
# 287 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 287 "../crypto/ec/ec_lib.c"
                  ;
    }
        return t;
}
...
# 319 "../crypto/ec/ec_lib.c"
static int ec_guess_cofactor(EC_GROUP *group) {
    int ret = 0;
    BN_CTX *ctx = 
# 321 "../crypto/ec/ec_lib.c" 3 4
                 ((void *)0)
# 321 "../crypto/ec/ec_lib.c"
                     ;
    BIGNUM *q = 
# 322 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 322 "../crypto/ec/ec_lib.c"
                   ;
    ...
    if (BN_num_bits(group->order) <= (BN_num_bits(group->field) + 1) / 2 + 3) {
        ...
        BN_zero_ex(group->cofactor);

        return 1;
    }

    if ((ctx = BN_CTX_new_ex(group->libctx)) == 
# 335 "../crypto/ec/ec_lib.c" 3 4
                                               ((void *)0)
# 335 "../crypto/ec/ec_lib.c"
                                                   )
        return 0;

    BN_CTX_start(ctx);
    if ((q = BN_CTX_get(ctx)) == 
# 339 "../crypto/ec/ec_lib.c" 3 4
                                ((void *)0)
# 339 "../crypto/ec/ec_lib.c"
                                    )
        goto err;


    if (group->meth->field_type == 407) {
        BN_zero_ex(q);
...
# 358 "../crypto/ec/ec_lib.c" 3 4
                                   ((void *)0)
# 358 "../crypto/ec/ec_lib.c"
                                       , group->cofactor, group->order, ctx))
        goto err;
    ret = 1;
 err:
    BN_CTX_end(ctx);
...
{
    if (generator == 
# 370 "../crypto/ec/ec_lib.c" 3 4
                    ((void *)0)
# 370 "../crypto/ec/ec_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",371,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 371 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 371 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    ...
    if (group->field == 
# 376 "../crypto/ec/ec_lib.c" 3 4
                       ((void *)0) 
# 376 "../crypto/ec/ec_lib.c"
                            || BN_is_zero(group->field)
        || BN_is_negative(group->field)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",378,__func__), ERR_set_error)((16),(103),
# 378 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 378 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    ...
    if (order == 
# 387 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0) 
# 387 "../crypto/ec/ec_lib.c"
                     || BN_is_zero(order) || BN_is_negative(order)
        || BN_num_bits(order) > BN_num_bits(group->field) + 1) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",389,__func__), ERR_set_error)((16),(122),
# 389 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 389 "../crypto/ec/ec_lib.c"
    ...
    if (cofactor != 
# 398 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0) 
# 398 "../crypto/ec/ec_lib.c"
                        && BN_is_negative(cofactor)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",399,__func__), ERR_set_error)((16),(164),
# 399 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 399 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }

    if (group->generator == 
# 403 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 403 "../crypto/ec/ec_lib.c"
                               ) {
        group->generator = EC_POINT_new(group);
        if (group->generator == 
# 405 "../crypto/ec/ec_lib.c" 3 4
                               ((void *)0)
# 405 "../crypto/ec/ec_lib.c"
                                   )
            return 0;
    }
    ...
    if (cofactor != 
# 415 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0) 
# 415 "../crypto/ec/ec_lib.c"
                        && !BN_is_zero(cofactor)) {
    ...
    BN_MONT_CTX_free(group->mont_data);
    group->mont_data = 
# 433 "../crypto/ec/ec_lib.c" 3 4
                      ((void *)0)
# 433 "../crypto/ec/ec_lib.c"
                          ;
    return 1;
}
...
{
    if (group->order == 
# 449 "../crypto/ec/ec_lib.c" 3 4
                       ((void *)0)
# 449 "../crypto/ec/ec_lib.c"
                           )
        return 0;
                          ...
                          BN_CTX *ctx)
{
    ...
    if (group->cofactor == 
# 471 "../crypto/ec/ec_lib.c" 3 4
                          ((void *)0)
# 471 "../crypto/ec/ec_lib.c"
                              )
        return 0;
...
{
    CRYPTO_free(group->seed, "../crypto/ec/ec_lib.c", 532);
    group->seed = 
# 533 "../crypto/ec/ec_lib.c" 3 4
                 ((void *)0)
# 533 "../crypto/ec/ec_lib.c"
                     ;
    group->seed_len = 0;
    ...
    if ((group->seed = CRYPTO_malloc(len, "../crypto/ec/ec_lib.c", 539)) == 
# 539 "../crypto/ec/ec_lib.c" 3 4
                                              ((void *)0)
# 539 "../crypto/ec/ec_lib.c"
                                                  )
        return 0;
                       ...
                       const BIGNUM *b, BN_CTX *ctx)
{
    if (group->meth->group_set_curve == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",561,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 561 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 561 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
# 570 "../crypto/ec/ec_lib.c" 3 4
                                       ((void *)0)
# 570 "../crypto/ec/ec_lib.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",571,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 571 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 571 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_GROUP_get_degree(const EC_GROUP *group)
{
    if (group->meth->group_get_degree == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",608,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 608 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 608 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_GROUP_check_discriminant(const EC_GROUP *group, BN_CTX *ctx)
{
    if (group->meth->group_check_discriminant == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",617,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 617 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 617 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_GROUP_cmp(const EC_GROUP *a, const EC_GROUP *b, BN_CTX *ctx)
{
    ...
    BN_CTX *ctx_new = 
# 628 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 628 "../crypto/ec/ec_lib.c"
                         ;
    ...
    if (ctx == 
# 642 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 642 "../crypto/ec/ec_lib.c"
                  )
        ctx_new = ctx = BN_CTX_new();

    if (ctx == 
# 645 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 645 "../crypto/ec/ec_lib.c"
                  )
        return -1;
    ...
    b3 = BN_CTX_get(ctx);
    if (b3 == 
# 655 "../crypto/ec/ec_lib.c" 3 4
             ((void *)0)
# 655 "../crypto/ec/ec_lib.c"
                 ) {
        BN_CTX_end(ctx);
    ...
    if (!r) {
        ...
        if (ao == 
# 686 "../crypto/ec/ec_lib.c" 3 4
                 ((void *)0) 
# 686 "../crypto/ec/ec_lib.c"
                      || bo == 
# 686 "../crypto/ec/ec_lib.c" 3 4
                               ((void *)0)
# 686 "../crypto/ec/ec_lib.c"
...
EC_POINT *EC_POINT_new(const EC_GROUP *group)
{
    ...
    if (group == 
# 721 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 721 "../crypto/ec/ec_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",722,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 722 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 722 "../crypto/ec/ec_lib.c"
       );
        return 
# 723 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 723 "../crypto/ec/ec_lib.c"
                  ;
    }
    if (group->meth->point_init == 
# 725 "../crypto/ec/ec_lib.c" 3 4
                                  ((void *)0)
# 725 "../crypto/ec/ec_lib.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",726,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 726 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 726 "../crypto/ec/ec_lib.c"
       );
        return 
# 727 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 727 "../crypto/ec/ec_lib.c"
                  ;
    }

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ec_lib.c", 730);
    if (ret == 
# 731 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 731 "../crypto/ec/ec_lib.c"
                  )
        return 
# 732 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 732 "../crypto/ec/ec_lib.c"
                  ;
    ...
    if (!ret->meth->point_init(ret)) {
        CRYPTO_free(ret, "../crypto/ec/ec_lib.c", 738);
        return 
# 739 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 739 "../crypto/ec/ec_lib.c"
                  ;
    }
...
{
    if (point == 
# 747 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 747 "../crypto/ec/ec_lib.c"
                    )
        return;

    if (point->meth->point_finish != 0)
        point->meth->point_finish(point);
    CRYPTO_free(point, "../crypto/ec/ec_lib.c", 752);
}

void EC_POINT_clear_free(EC_POINT *point)
{
    if (point == 
# 757 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 757 "../crypto/ec/ec_lib.c"
                    )
        return;
    ...
    if (point->meth->point_clear_finish != 0)
        ...
        point->meth->point_finish(point);
    CRYPTO_clear_free(point, sizeof(*point), "../crypto/ec/ec_lib.c", 764);
}

int EC_POINT_copy(EC_POINT *dest, const EC_POINT *src)
{
    if (dest->meth->point_copy == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",770,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 770 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 770 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (dest->meth != src->meth
            || (dest->curve_name != src->curve_name
                 && dest->curve_name != 0
                 && src->curve_name != 0)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",777,__func__), ERR_set_error)((16),(101),
# 777 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 777 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (dest == src)
...
EC_POINT *EC_POINT_dup(const EC_POINT *a, const EC_GROUP *group)
{
    ...
    if (a == 
# 790 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 790 "../crypto/ec/ec_lib.c"
                )
        return 
# 791 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 791 "../crypto/ec/ec_lib.c"
                  ;

    t = EC_POINT_new(group);
    if (t == 
# 794 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 794 "../crypto/ec/ec_lib.c"
                )
        return 
# 795 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 795 "../crypto/ec/ec_lib.c"
                  ;
    r = EC_POINT_copy(t, a);
    if (!r) {
        EC_POINT_free(t);
        return 
# 799 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 799 "../crypto/ec/ec_lib.c"
                  ;
    }
    return t;
}
...
int EC_POINT_set_to_infinity(const EC_GROUP *group, EC_POINT *point)
{
    if (group->meth->point_set_to_infinity == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",814,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 814 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 814 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (group->meth != point->meth) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",818,__func__), ERR_set_error)((16),(101),
# 818 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 818 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
                                             ...
                                             BN_CTX *ctx)
{
    if (group->meth->field_type != 406) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",831,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 831 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 831 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",835,__func__), ERR_set_error)((16),(101),
# 835 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 835 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
{
    if (group->meth->field_type != 406) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",848,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 848 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 848 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",852,__func__), ERR_set_error)((16),(101),
# 852 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 852 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_POINT_set_affine_coordinates(const EC_GROUP *group, EC_POINT *point,
                                    ...
                                    BN_CTX *ctx)
{
    if (group->meth->point_set_affine_coordinates == 
# 864 "../crypto/ec/ec_lib.c" 3 4
                                                    ((void *)0)
# 864 "../crypto/ec/ec_lib.c"
                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",865,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 865 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 865 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",869,__func__), ERR_set_error)((16),(101),
# 869 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 869 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    ...
    if (EC_POINT_is_on_curve(group, point, ctx) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",876,__func__), ERR_set_error)((16),(107),
# 876 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 876 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    return 1;
...
# 904 "../crypto/ec/ec_lib.c" 3 4
                                                    ((void *)0)
# 904 "../crypto/ec/ec_lib.c"
                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",905,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 905 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 905 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",909,__func__), ERR_set_error)((16),(101),
# 909 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 909 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (EC_POINT_is_at_infinity(group, point)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",913,__func__), ERR_set_error)((16),(106),
# 913 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 913 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
{
    if (group->meth->add == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",941,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 941 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 941 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(r, group) || !ec_point_is_compat(a, group)
        || !ec_point_is_compat(b, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",946,__func__), ERR_set_error)((16),(101),
# 946 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
...
{
    if (group->meth->dbl == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",956,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 956 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 956 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(r, group) || !ec_point_is_compat(a, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",960,__func__), ERR_set_error)((16),(101),
# 960 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 960 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_POINT_invert(const EC_GROUP *group, EC_POINT *a, BN_CTX *ctx)
{
    if (group->meth->invert == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",969,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 969 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 969 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(a, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",973,__func__), ERR_set_error)((16),(101),
# 973 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 973 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
int EC_POINT_is_at_infinity(const EC_GROUP *group, const EC_POINT *point)
{
    if (group->meth->is_at_infinity == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",982,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 982 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 982 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",986,__func__), ERR_set_error)((16),(101),
# 986 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 986 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    return group->meth->is_at_infinity(group, point);
}
# 999 "../crypto/ec/ec_lib.c"
int EC_POINT_is_on_curve(const EC_GROUP *group, const EC_POINT *point,
                         BN_CTX *ctx)
{
    if (group->meth->is_on_curve == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1003,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1003 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1003 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1007,__func__), ERR_set_error)((16),(101),
# 1007 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1007 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
                 ...
                 BN_CTX *ctx)
{
    if (group->meth->point_cmp == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1017,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1017 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1017 "../crypto/ec/ec_lib.c"
       );
        return -1;
    }
    if (!ec_point_is_compat(a, group) || !ec_point_is_compat(b, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1021,__func__), ERR_set_error)((16),(101),
# 1021 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1021 "../crypto/ec/ec_lib.c"
       );
        return -1;
    }
...
int EC_POINT_make_affine(const EC_GROUP *group, EC_POINT *point, BN_CTX *ctx)
{
    if (group->meth->make_affine == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1031,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1031 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1031 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    if (!ec_point_is_compat(point, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1035,__func__), ERR_set_error)((16),(101),
# 1035 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1035 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
                          ...
                          EC_POINT *points[], BN_CTX *ctx)
{
    ...
    if (group->meth->points_make_affine == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1047,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1047 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1047 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    for (i = 0; i < num; i++) {
        if (!ec_point_is_compat(points[i], group)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1052,__func__), ERR_set_error)((16),(101),
# 1052 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1052 "../crypto/ec/ec_lib.c"
           );
            return 0;
        }
    }
                  ...
                  const BIGNUM *scalars[], BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 1074 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 1074 "../crypto/ec/ec_lib.c"
                         ;


    if (!ec_point_is_compat(r, group)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1078,__func__), ERR_set_error)((16),(101),
# 1078 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1078 "../crypto/ec/ec_lib.c"
    ...
    if (scalar == 
# 1082 "../crypto/ec/ec_lib.c" 3 4
                 ((void *)0) 
# 1082 "../crypto/ec/ec_lib.c"
                      && num == 0)
        return EC_POINT_set_to_infinity(group, r);

    for (i = 0; i < num; i++) {
        if (!ec_point_is_compat(points[i], group)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1087,__func__), ERR_set_error)((16),(101),
# 1087 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1087 "../crypto/ec/ec_lib.c"
           );
            return 0;
        }
    }
    ...
    if (ctx == 
# 1093 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1093 "../crypto/ec/ec_lib.c"
                  )
        ctx = new_ctx = BN_CTX_secure_new();

    if (ctx == 
# 1096 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1096 "../crypto/ec/ec_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1097,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1097 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1097 "../crypto/ec/ec_lib.c"
    ...
    if (group->meth->mul != 
# 1101 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1101 "../crypto/ec/ec_lib.c"
                               )
                 ...
                 const EC_POINT *point, const BIGNUM *p_scalar, BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 1120 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 1120 "../crypto/ec/ec_lib.c"
                         ;


    if (!ec_point_is_compat(r, group)
        || (point != 
# 1124 "../crypto/ec/ec_lib.c" 3 4
                    ((void *)0) 
# 1124 "../crypto/ec/ec_lib.c"
                         && !ec_point_is_compat(point, group))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1125,__func__), ERR_set_error)((16),(101),
# 1125 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1125 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }

    if (g_scalar == 
# 1129 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0) 
# 1129 "../crypto/ec/ec_lib.c"
                        && p_scalar == 
# 1129 "../crypto/ec/ec_lib.c" 3 4
                                       ((void *)0)
# 1129 "../crypto/ec/ec_lib.c"
    ...
    if (ctx == 
# 1133 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1133 "../crypto/ec/ec_lib.c"
                  )
        ctx = new_ctx = BN_CTX_secure_new();

    if (ctx == 
# 1136 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1136 "../crypto/ec/ec_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1137,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1137 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1137 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }

    num = (point != 
# 1141 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0) 
# 1141 "../crypto/ec/ec_lib.c"
                        && p_scalar != 
# 1141 "../crypto/ec/ec_lib.c" 3 4
                                       ((void *)0)
# 1141 "../crypto/ec/ec_lib.c"
    ...
    if (group->meth->mul != 
# 1142 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1142 "../crypto/ec/ec_lib.c"
                               )
...
static int ec_precompute_mont_data(EC_GROUP *group)
{
    ...
    BN_MONT_CTX_free(group->mont_data);
    group->mont_data = 
# 1191 "../crypto/ec/ec_lib.c" 3 4
                      ((void *)0)
# 1191 "../crypto/ec/ec_lib.c"
                          ;

    if (ctx == 
# 1193 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1193 "../crypto/ec/ec_lib.c"
                  )
        goto err;

    group->mont_data = BN_MONT_CTX_new();
    if (group->mont_data == 
# 1197 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1197 "../crypto/ec/ec_lib.c"
                               )
        goto err;
    ...
    if (!BN_MONT_CTX_set(group->mont_data, group->order, ctx)) {
        BN_MONT_CTX_free(group->mont_data);
        group->mont_data = 
# 1202 "../crypto/ec/ec_lib.c" 3 4
                          ((void *)0)
# 1202 "../crypto/ec/ec_lib.c"
                              ;
        goto err;
    }
...
{
    if (group->order == 
# 1228 "../crypto/ec/ec_lib.c" 3 4
                       ((void *)0)
# 1228 "../crypto/ec/ec_lib.c"
                           )
        return 0;
...
{
    BIGNUM *e = 
# 1236 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1236 "../crypto/ec/ec_lib.c"
                   ;
    int ret = 0;

    BN_CTX *new_ctx = 
# 1239 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 1239 "../crypto/ec/ec_lib.c"
                         ;


    if (group->mont_data == 
# 1242 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1242 "../crypto/ec/ec_lib.c"
                               )
        return 0;


    if (ctx == 
# 1246 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1246 "../crypto/ec/ec_lib.c"
                  )
        ctx = new_ctx = BN_CTX_secure_new();

    if (ctx == 
# 1249 "../crypto/ec/ec_lib.c" 3 4
              ((void *)0)
# 1249 "../crypto/ec/ec_lib.c"
                  )
        return 0;

    BN_CTX_start(ctx);
    if ((e = BN_CTX_get(ctx)) == 
# 1253 "../crypto/ec/ec_lib.c" 3 4
                                ((void *)0)
...
# 1294 "../crypto/ec/ec_lib.c"
int ossl_ec_group_do_inverse_ord(const EC_GROUP *group, BIGNUM *res,
                                 const BIGNUM *x, BN_CTX *ctx)
{
    if (group->meth->field_inverse_mod_ord != 
# 1297 "../crypto/ec/ec_lib.c" 3 4
                                             ((void *)0)
# 1297 "../crypto/ec/ec_lib.c"
                                                 )
        return group->meth->field_inverse_mod_ord(group, res, x, ctx);
    else
        return ec_field_inverse_mod_ord(group, res, x, ctx);
}
# 1313 "../crypto/ec/ec_lib.c"
int ossl_ec_point_blind_coordinates(const EC_GROUP *group, EC_POINT *p,
                                    BN_CTX *ctx)
{
    if (group->meth->blind_coordinates == 
# 1316 "../crypto/ec/ec_lib.c" 3 4
                                         ((void *)0)
# 1316 "../crypto/ec/ec_lib.c"
                                             )
        return 1;
...
int EC_GROUP_get_basis_type(const EC_GROUP *group)
{
    ...
    for (i = 0;
         i < (int)(sizeof(group->poly)/sizeof((group->poly)[0])) && group->poly[i] != 0;
         i++)
        continue;
...
{
    if (group == 
# 1348 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1348 "../crypto/ec/ec_lib.c"
                    )
        return 0;
    ...
    if (EC_GROUP_get_field_type(group) != 407
        || !((group->poly[0] != 0) && (group->poly[1] != 0)
             && (group->poly[2] == 0))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1354,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1354 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1354 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
{
    if (group == 
# 1367 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1367 "../crypto/ec/ec_lib.c"
                    )
        return 0;
    ...
    if (EC_GROUP_get_field_type(group) != 407
        || !((group->poly[0] != 0) && (group->poly[1] != 0)
             ...
             && (group->poly[4] == 0))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1374,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1374 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1374 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
...
{
    EC_GROUP *ret_group = 
# 1406 "../crypto/ec/ec_lib.c" 3 4
                         ((void *)0)
# 1406 "../crypto/ec/ec_lib.c"
                             , *dup = 
# 1406 "../crypto/ec/ec_lib.c" 3 4
                                      ((void *)0)
# 1406 "../crypto/ec/ec_lib.c"
    ...
    int no_seed = (EC_GROUP_get0_seed(group) == 
# 1411 "../crypto/ec/ec_lib.c" 3 4
                                               ((void *)0)
# 1411 "../crypto/ec/ec_lib.c"
                                                   );

    if ((dup = EC_GROUP_dup(group)) == 
# 1413 "../crypto/ec/ec_lib.c" 3 4
                                      ((void *)0)
            
# 1414 "../crypto/ec/ec_lib.c"
           || EC_GROUP_set_seed(dup, 
# 1414 "../crypto/ec/ec_lib.c" 3 4
                                     ((void *)0)
# 1414 "../crypto/ec/ec_lib.c"
                                         , 0) != 1
            || !EC_GROUP_set_generator(dup, point, order, 
# 1415 "../crypto/ec/ec_lib.c" 3 4
                                                         ((void *)0)
# 1415 "../crypto/ec/ec_lib.c"
                                                             ))
        goto err;
    if ((curve_name_nid = ossl_ec_curve_nid_from_params(dup, ctx)) != 0) {
# 1437 "../crypto/ec/ec_lib.c"
        ret_group = EC_GROUP_new_by_curve_name_ex(libctx, propq, curve_name_nid);
        if (ret_group == 
# 1438 "../crypto/ec/ec_lib.c" 3 4
                        ((void *)0)
# 1438 "../crypto/ec/ec_lib.c"
                            )
            goto err;
        ...
        EC_GROUP_set_asn1_flag(ret_group, 0x000);
# 1456 "../crypto/ec/ec_lib.c"
        if (no_seed) {
            if (EC_GROUP_set_seed(ret_group, 
# 1457 "../crypto/ec/ec_lib.c" 3 4
                                            ((void *)0)
# 1457 "../crypto/ec/ec_lib.c"
                                                , 0) != 1)
                goto err;
        }
    } else {
...
err:
    ...
    return 
# 1468 "../crypto/ec/ec_lib.c" 3 4
          ((void *)0)
# 1468 "../crypto/ec/ec_lib.c"
              ;
}
...
# 1476 "../crypto/ec/ec_lib.c" 3 4
                            ((void *)0)
# 1476 "../crypto/ec/ec_lib.c"
                                ;
    ...
    case 4:
        ...
        curve_name = p->data;
        ok = (curve_name != 
# 1482 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1482 "../crypto/ec/ec_lib.c"
                               );
        break;
    case 6:
    ...
    if (ok) {
        ...
        if (nid == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1492,__func__), ERR_set_error)((16),(141),
# 1492 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1492 "../crypto/ec/ec_lib.c"
           );
            return 
# 1493 "../crypto/ec/ec_lib.c" 3 4
                  ((void *)0)
# 1493 "../crypto/ec/ec_lib.c"
                      ;
        } else {
    ...
    return 
# 1498 "../crypto/ec/ec_lib.c" 3 4
          ((void *)0)
# 1498 "../crypto/ec/ec_lib.c"
              ;
}
...
int ossl_ec_group_set_params(EC_GROUP *group, const OSSL_PARAM params[])
{
    ...
    p = OSSL_PARAM_locate_const(params, "point-format");
    if (p != 
# 1508 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 1508 "../crypto/ec/ec_lib.c"
                ) {
        if (!ossl_ec_pt_format_param2id(p, &format)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1510,__func__), ERR_set_error)((16),(104),
# 1510 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1510 "../crypto/ec/ec_lib.c"
           );
            return 0;
        }
    ...
    p = OSSL_PARAM_locate_const(params, "encoding");
    if (p != 
# 1517 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 1517 "../crypto/ec/ec_lib.c"
                ) {
        if (!ossl_ec_encoding_param2id(p, &encoding_flag)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1519,__func__), ERR_set_error)((16),(104),
# 1519 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1519 "../crypto/ec/ec_lib.c"
           );
            return 0;
        }
    ...
    if (p != 
# 1526 "../crypto/ec/ec_lib.c" 3 4
            ((void *)0)
# 1526 "../crypto/ec/ec_lib.c"
                ) {

        if (p->data_type != 5
            || !EC_GROUP_set_seed(group, p->data, p->data_size)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1530,__func__), ERR_set_error)((16),(175),
# 1530 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1530 "../crypto/ec/ec_lib.c"
           );
            return 0;
        }
    }
                                   ...
                                   OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    EC_GROUP *group = 
# 1541 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 1541 "../crypto/ec/ec_lib.c"
                         ;
...
# 1546 "../crypto/ec/ec_lib.c" 3 4
                           ((void *)0)
# 1546 "../crypto/ec/ec_lib.c"
                               ;
    BIGNUM *p = 
# 1547 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1547 "../crypto/ec/ec_lib.c"
                   , *a = 
# 1547 "../crypto/ec/ec_lib.c" 3 4
                          ((void *)0)
# 1547 "../crypto/ec/ec_lib.c"
...
# 1547 "../crypto/ec/ec_lib.c"
                                                                          ;
    EC_POINT *point = 
# 1548 "../crypto/ec/ec_lib.c" 3 4
                     ((void *)0)
# 1548 "../crypto/ec/ec_lib.c"
                         ;
    int field_bits = 0;
    int is_prime_field = 1;
    BN_CTX *bnctx = 
# 1551 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0)
# 1551 "../crypto/ec/ec_lib.c"
                       ;
    const unsigned char *buf = 
# 1552 "../crypto/ec/ec_lib.c" 3 4
                              ((void *)0)
# 1552 "../crypto/ec/ec_lib.c"
                                  ;
    int encoding_flag = -1;



    ptmp = OSSL_PARAM_locate_const(params, "group");
    if (ptmp != 
# 1558 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1558 "../crypto/ec/ec_lib.c"
                   ) {
        int decoded = 0;

        if ((group = group_new_from_name(ptmp, libctx, propq)) == 
# 1561 "../crypto/ec/ec_lib.c" 3 4
                                                                 ((void *)0)
# 1561 "../crypto/ec/ec_lib.c"
                                                                     )
            return 
# 1562 "../crypto/ec/ec_lib.c" 3 4
                  ((void *)0)
# 1562 "../crypto/ec/ec_lib.c"
                      ;
        if (!ossl_ec_group_set_params(group, params)) {
            EC_GROUP_free(group);
            return 
# 1565 "../crypto/ec/ec_lib.c" 3 4
                  ((void *)0)
# 1565 "../crypto/ec/ec_lib.c"
                      ;
        }
        ...
        if (ptmp != 
# 1570 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0) 
# 1570 "../crypto/ec/ec_lib.c"
                        && !OSSL_PARAM_get_int(ptmp, &decoded)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1571,__func__), ERR_set_error)((16),(145),
# 1571 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1571 "../crypto/ec/ec_lib.c"
           );
            EC_GROUP_free(group);
            return 
# 1573 "../crypto/ec/ec_lib.c" 3 4
                  ((void *)0)
# 1573 "../crypto/ec/ec_lib.c"
                      ;
        }
    ...
    if (bnctx == 
# 1584 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1584 "../crypto/ec/ec_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1585,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1585 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1585 "../crypto/ec/ec_lib.c"
       );
        return 0;
    }
    BN_CTX_start(bnctx);
    ...
    if (order == 
# 1594 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1594 "../crypto/ec/ec_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1595,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1595 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1595 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }

    ptmp = OSSL_PARAM_locate_const(params, "field-type");
    if (ptmp == 
# 1600 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0) 
# 1600 "../crypto/ec/ec_lib.c"
                    || ptmp->data_type != 4) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1601,__func__), ERR_set_error)((16),(103),
# 1601 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1601 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    if (OPENSSL_strcasecmp(ptmp->data, "prime-field") == 0) {
        is_prime_field = 1;
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1611,__func__), ERR_set_error)((16),(131),
# 1611 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1611 "../crypto/ec/ec_lib.c"
    ...
    pa = OSSL_PARAM_locate_const(params, "a");
    if (!OSSL_PARAM_get_BN(pa, &a)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1617,__func__), ERR_set_error)((16),(168),
# 1617 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1617 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    pb = OSSL_PARAM_locate_const(params, "b");
    if (!OSSL_PARAM_get_BN(pb, &b)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1622,__func__), ERR_set_error)((16),(169),
# 1622 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1622 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }


    ptmp = OSSL_PARAM_locate_const(params, "p");
    if (!OSSL_PARAM_get_BN(ptmp, &p)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1629,__func__), ERR_set_error)((16),(172),
# 1629 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1629 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    ...
    if (is_prime_field) {
        if (BN_is_negative(p) || BN_is_zero(p)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1635,__func__), ERR_set_error)((16),(172),
# 1635 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1635 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
        field_bits = BN_num_bits(p);
        if (field_bits > 661) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1640,__func__), ERR_set_error)((16),(143),
# 1640 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1640 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
        ...
        group = EC_GROUP_new_curve_GF2m(p, a, b, 
# 1652 "../crypto/ec/ec_lib.c" 3 4
                                                ((void *)0)
# 1652 "../crypto/ec/ec_lib.c"
                                                    );
        if (group != 
# 1653 "../crypto/ec/ec_lib.c" 3 4
                    ((void *)0)
# 1653 "../crypto/ec/ec_lib.c"
                        ) {
            field_bits = EC_GROUP_get_degree(group);
            if (field_bits > 661) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1656,__func__), ERR_set_error)((16),(143),
# 1656 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1656 "../crypto/ec/ec_lib.c"
               );
                goto err;
            }
        }
    ...
    if (group == 
# 1663 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1663 "../crypto/ec/ec_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1664,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 1664 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1664 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }


    ptmp = OSSL_PARAM_locate_const(params, "seed");
    if (ptmp != 
# 1670 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1670 "../crypto/ec/ec_lib.c"
                   ) {
        if (ptmp->data_type != 5) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1672,__func__), ERR_set_error)((16),(175),
# 1672 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1672 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
    ...
    ptmp = OSSL_PARAM_locate_const(params, "generator");
    if (ptmp == 
# 1681 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
        
# 1682 "../crypto/ec/ec_lib.c"
       || ptmp->data_type != 5) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1683,__func__), ERR_set_error)((16),(173),
# 1683 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1683 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    buf = (const unsigned char *)(ptmp->data);
    if ((point = EC_POINT_new(group)) == 
# 1687 "../crypto/ec/ec_lib.c" 3 4
                                        ((void *)0)
# 1687 "../crypto/ec/ec_lib.c"
                                            )
        goto err;
    ...
    if (!EC_POINT_oct2point(group, point, buf, ptmp->data_size, bnctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1692,__func__), ERR_set_error)((16),(173),
# 1692 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1692 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }


    ptmp = OSSL_PARAM_locate_const(params, "order");
    if (!OSSL_PARAM_get_BN(ptmp, &order)
        || (BN_is_negative(order) || BN_is_zero(order))
        || (BN_num_bits(order) > (int)field_bits + 1)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1701,__func__), ERR_set_error)((16),(122),
# 1701 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1701 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }


    ptmp = OSSL_PARAM_locate_const(params, "cofactor");
    if (ptmp != 
# 1707 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1707 "../crypto/ec/ec_lib.c"
                   ) {
        cofactor = BN_CTX_get(bnctx);
        if (cofactor == 
# 1709 "../crypto/ec/ec_lib.c" 3 4
                       ((void *)0) 
# 1709 "../crypto/ec/ec_lib.c"
                            || !OSSL_PARAM_get_BN(ptmp, &cofactor)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1710,__func__), ERR_set_error)((16),(171),
# 1710 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1710 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
    }
    ...
    if (!EC_GROUP_set_generator(group, point, order, cofactor)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1717,__func__), ERR_set_error)((16),(173),
# 1717 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1717 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    ...
    if (named_group == 
# 1722 "../crypto/ec/ec_lib.c" 3 4
                      ((void *)0)
# 1722 "../crypto/ec/ec_lib.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1723,__func__), ERR_set_error)((16),(174),
# 1723 "../crypto/ec/ec_lib.c" 3 4
       ((void *)0)
# 1723 "../crypto/ec/ec_lib.c"
       );
        goto err;
    }
    if (named_group == group) {
        ...
        ptmp = OSSL_PARAM_locate_const(params, "encoding");
        if (ptmp != 
# 1732 "../crypto/ec/ec_lib.c" 3 4
                   ((void *)0)
            
# 1733 "../crypto/ec/ec_lib.c"
           && !ossl_ec_encoding_param2id(ptmp, &encoding_flag)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1734,__func__), ERR_set_error)((16),(102),
# 1734 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1734 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
        if (encoding_flag == 0x001) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_lib.c",1738,__func__), ERR_set_error)((16),(102),
# 1738 "../crypto/ec/ec_lib.c" 3 4
           ((void *)0)
# 1738 "../crypto/ec/ec_lib.c"
           );
            goto err;
        }
 ...
 err:
    if (!ok) {
        EC_GROUP_free(group);
        group = 
# 1752 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1752 "../crypto/ec/ec_lib.c"
                   ;
    }
    EC_POINT_free(point);
    BN_CTX_end(bnctx);
...
{
    OSSL_PARAM_BLD *tmpl = 
# 1765 "../crypto/ec/ec_lib.c" 3 4
                          ((void *)0)
# 1765 "../crypto/ec/ec_lib.c"
                              ;
    BN_CTX *new_bnctx = 
# 1766 "../crypto/ec/ec_lib.c" 3 4
                       ((void *)0)
# 1766 "../crypto/ec/ec_lib.c"
                           ;
    unsigned char *gen_buf = 
# 1767 "../crypto/ec/ec_lib.c" 3 4
                            ((void *)0)
# 1767 "../crypto/ec/ec_lib.c"
                                ;
    OSSL_PARAM *params = 
# 1768 "../crypto/ec/ec_lib.c" 3 4
                        ((void *)0)
# 1768 "../crypto/ec/ec_lib.c"
                            ;

    if (group == 
# 1770 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1770 "../crypto/ec/ec_lib.c"
                    )
        goto err;

    tmpl = OSSL_PARAM_BLD_new();
    if (tmpl == 
# 1774 "../crypto/ec/ec_lib.c" 3 4
               ((void *)0)
# 1774 "../crypto/ec/ec_lib.c"
                   )
        goto err;

    if (bnctx == 
# 1777 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1777 "../crypto/ec/ec_lib.c"
                    )
        bnctx = new_bnctx = BN_CTX_new_ex(libctx);
    if (bnctx == 
# 1779 "../crypto/ec/ec_lib.c" 3 4
                ((void *)0)
# 1779 "../crypto/ec/ec_lib.c"
                    )
        goto err;
    BN_CTX_start(bnctx);
    ...
    if (!ossl_ec_group_todata(
            group, tmpl, 
# 1784 "../crypto/ec/ec_lib.c" 3 4
                        ((void *)0)
# 1784 "../crypto/ec/ec_lib.c"
 ...
 err:
    ...
    CRYPTO_free(gen_buf, "../crypto/ec/ec_lib.c", 1791);
    BN_CTX_end(bnctx);
