# 0 "../crypto/ec/ec_cvt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_cvt.c"
# 15 "../crypto/ec/ec_cvt.c"
...
# 49 "../crypto/ec/ec_cvt.c"
    ...
    ret = ossl_ec_group_new_ex(ossl_bn_get_libctx(ctx), 
# 57 "../crypto/ec/ec_cvt.c" 3 4
                                                       ((void *)0)
# 57 "../crypto/ec/ec_cvt.c"
                                                           , meth);
    if (ret == 
# 58 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 58 "../crypto/ec/ec_cvt.c"
                  )
        return 
# 59 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 59 "../crypto/ec/ec_cvt.c"
                  ;

    if (!EC_GROUP_set_curve(ret, p, a, b, ctx)) {
        EC_GROUP_free(ret);
        return 
# 63 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 63 "../crypto/ec/ec_cvt.c"
                  ;
    }
                                  ...
                                  const BIGNUM *b, BN_CTX *ctx)
{
    ...
    ret = ossl_ec_group_new_ex(ossl_bn_get_libctx(ctx), 
# 78 "../crypto/ec/ec_cvt.c" 3 4
                                                       ((void *)0)
# 78 "../crypto/ec/ec_cvt.c"
                                                           , meth);
    if (ret == 
# 79 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 79 "../crypto/ec/ec_cvt.c"
                  )
        return 
# 80 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 80 "../crypto/ec/ec_cvt.c"
                  ;

    if (!EC_GROUP_set_curve(ret, p, a, b, ctx)) {
        EC_GROUP_free(ret);
        return 
# 84 "../crypto/ec/ec_cvt.c" 3 4
              ((void *)0)
# 84 "../crypto/ec/ec_cvt.c"
                  ;
    }
