# 0 "../crypto/ec/ecdsa_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecdsa_sign.c"
# 14 "../crypto/ec/ecdsa_sign.c"
...
# 18 "../crypto/ec/ecdsa_sign.c" 2


ECDSA_SIG *ECDSA_do_sign(const unsigned char *dgst, int dlen, EC_KEY *eckey)
{
    return ECDSA_do_sign_ex(dgst, dlen, 
# 22 "../crypto/ec/ecdsa_sign.c" 3 4
                                       ((void *)0)
# 22 "../crypto/ec/ecdsa_sign.c"
                                           , 
# 22 "../crypto/ec/ecdsa_sign.c" 3 4
                                             ((void *)0)
# 22 "../crypto/ec/ecdsa_sign.c"
...
# 29 "../crypto/ec/ecdsa_sign.c" 3 4
                                ((void *)0)
# 29 "../crypto/ec/ecdsa_sign.c"
                                    )
        return eckey->meth->sign_sig(dgst, dlen, kinv, rp, eckey);
    (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_sign.c",31,__func__), ERR_set_error)((16),(152),
# 31 "../crypto/ec/ecdsa_sign.c" 3 4
   ((void *)0)
# 31 "../crypto/ec/ecdsa_sign.c"
   );
    return 
# 32 "../crypto/ec/ecdsa_sign.c" 3 4
          ((void *)0)
# 32 "../crypto/ec/ecdsa_sign.c"
              ;
}
...
# 38 "../crypto/ec/ecdsa_sign.c" 3 4
                                                       ((void *)0)
# 38 "../crypto/ec/ecdsa_sign.c"
                                                           , 
# 38 "../crypto/ec/ecdsa_sign.c" 3 4
                                                             ((void *)0)
# 38 "../crypto/ec/ecdsa_sign.c"
...
{
    if (eckey->meth->sign != 
# 45 "../crypto/ec/ecdsa_sign.c" 3 4
                            ((void *)0)
# 45 "../crypto/ec/ecdsa_sign.c"
                                )
        return eckey->meth->sign(type, dgst, dlen, sig, siglen, kinv, r, eckey);
    (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_sign.c",47,__func__), ERR_set_error)((16),(152),
# 47 "../crypto/ec/ecdsa_sign.c" 3 4
   ((void *)0)
# 47 "../crypto/ec/ecdsa_sign.c"
   );
    return 0;
}
...
# 54 "../crypto/ec/ecdsa_sign.c" 3 4
                                  ((void *)0)
# 54 "../crypto/ec/ecdsa_sign.c"
                                      )
        return eckey->meth->sign_setup(eckey, ctx_in, kinvp, rp);
    (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_sign.c",56,__func__), ERR_set_error)((16),(152),
# 56 "../crypto/ec/ecdsa_sign.c" 3 4
   ((void *)0)
# 56 "../crypto/ec/ecdsa_sign.c"
   );
    return 0;
}
