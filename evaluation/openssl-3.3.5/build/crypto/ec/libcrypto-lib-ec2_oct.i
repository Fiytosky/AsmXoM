# 0 "../crypto/ec/ec2_oct.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec2_oct.c"
# 15 "../crypto/ec/ec2_oct.c"
...
# 20 "../crypto/ec/ec2_oct.c" 2
# 39 "../crypto/ec/ec2_oct.c"
                                                   ...
                                                   BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 47 "../crypto/ec/ec2_oct.c" 3 4
                     ((void *)0)
# 47 "../crypto/ec/ec2_oct.c"
                         ;

    if (ctx == 
# 49 "../crypto/ec/ec2_oct.c" 3 4
              ((void *)0)
# 49 "../crypto/ec/ec2_oct.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 51 "../crypto/ec/ec2_oct.c" 3 4
                  ((void *)0)
# 51 "../crypto/ec/ec2_oct.c"
                      )
            return 0;
    }
    ...
    z = BN_CTX_get(ctx);
    if (z == 
# 63 "../crypto/ec/ec2_oct.c" 3 4
            ((void *)0)
# 63 "../crypto/ec/ec2_oct.c"
                )
        goto err;
    ...
    if (BN_is_zero(x)) {
        ...
        if (!BN_GF2m_mod_solve_quad_arr(z, tmp, group->poly, ctx)) {
            ...
            if (ERR_GET_LIB(err) == 3
                && ERR_GET_REASON(err) == 116) {
                ERR_pop_to_mark();
                (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",88,__func__), ERR_set_error)((16),(110),
# 88 "../crypto/ec/ec2_oct.c" 3 4
               ((void *)0)
# 88 "../crypto/ec/ec2_oct.c"
               );
            } else

            {
                ERR_clear_last_mark();
                (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",93,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 93 "../crypto/ec/ec2_oct.c" 3 4
               ((void *)0)
# 93 "../crypto/ec/ec2_oct.c"
               );
            }
            goto err;
        }
                                     ...
                                     unsigned char *buf, size_t len, BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 135 "../crypto/ec/ec2_oct.c" 3 4
                     ((void *)0)
# 135 "../crypto/ec/ec2_oct.c"
                         ;
    ...
    if ((form != POINT_CONVERSION_COMPRESSED)
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",141,__func__), ERR_set_error)((16),(104),
# 141 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 141 "../crypto/ec/ec2_oct.c"
       );
        goto err;
    }
    ...
    if (EC_POINT_is_at_infinity(group, point)) {
        ...
        if (buf != 
# 147 "../crypto/ec/ec2_oct.c" 3 4
                  ((void *)0)
# 147 "../crypto/ec/ec2_oct.c"
                      ) {
            if (len < 1) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",149,__func__), ERR_set_error)((16),(100),
# 149 "../crypto/ec/ec2_oct.c" 3 4
               ((void *)0)
# 149 "../crypto/ec/ec2_oct.c"
               );
                return 0;
            }
            buf[0] = 0;
    ...
    if (buf != 
# 164 "../crypto/ec/ec2_oct.c" 3 4
              ((void *)0)
# 164 "../crypto/ec/ec2_oct.c"
                  ) {
        if (len < ret) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",166,__func__), ERR_set_error)((16),(100),
# 166 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 166 "../crypto/ec/ec2_oct.c"
        ...
        if (ctx == 
# 171 "../crypto/ec/ec2_oct.c" 3 4
                  ((void *)0)
# 171 "../crypto/ec/ec2_oct.c"
                      ) {
            ctx = new_ctx = BN_CTX_new();
            if (ctx == 
# 173 "../crypto/ec/ec2_oct.c" 3 4
                      ((void *)0)
# 173 "../crypto/ec/ec2_oct.c"
        ...
        yxi = BN_CTX_get(ctx);
        if (yxi == 
# 183 "../crypto/ec/ec2_oct.c" 3 4
                  ((void *)0)
# 183 "../crypto/ec/ec2_oct.c"
                      )
            goto err;
        ...
        if (skip > field_len) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",201,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 201 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 201 "../crypto/ec/ec2_oct.c"
           );
            goto err;
        }
        while (skip > 0) {
        ...
        i += skip;
        if (i != 1 + field_len) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",211,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 211 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 211 "../crypto/ec/ec2_oct.c"
           );
            goto err;
        }
        ...
        if (form == POINT_CONVERSION_UNCOMPRESSED
            ...
            if (skip > field_len) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",219,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 219 "../crypto/ec/ec2_oct.c" 3 4
               ((void *)0)
# 219 "../crypto/ec/ec2_oct.c"
               );
                goto err;
            }
            while (skip > 0) {
        ...
        if (i != ret) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",231,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 231 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 231 "../crypto/ec/ec2_oct.c"
           );
            goto err;
        }
    }
                                  ...
                                  BN_CTX *ctx)
{
    ...
    BN_CTX *new_ctx = 
# 266 "../crypto/ec/ec2_oct.c" 3 4
                     ((void *)0)
# 266 "../crypto/ec/ec2_oct.c"
                         ;


    if (len == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",270,__func__), ERR_set_error)((16),(100),
# 270 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 270 "../crypto/ec/ec2_oct.c"
       );
        return 0;
    }
# 285 "../crypto/ec/ec2_oct.c"
    y_bit = buf[0] & 1;
    form = buf[0] & ~1U;
    ...
    if ((form != 0) && (form != POINT_CONVERSION_COMPRESSED)
        && (form != POINT_CONVERSION_UNCOMPRESSED)
        && (form != POINT_CONVERSION_HYBRID)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",291,__func__), ERR_set_error)((16),(102),
# 291 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 291 "../crypto/ec/ec2_oct.c"
       );
        return 0;
    }
    if ((form == 0 || form == POINT_CONVERSION_UNCOMPRESSED) && y_bit) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",295,__func__), ERR_set_error)((16),(102),
# 295 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 295 "../crypto/ec/ec2_oct.c"
       );
        return 0;
    }
    ...
    if (form == 0) {
        if (len != 1) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",302,__func__), ERR_set_error)((16),(102),
# 302 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 302 "../crypto/ec/ec2_oct.c"
           );
            return 0;
        }
    ...
    if (len != enc_len) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",316,__func__), ERR_set_error)((16),(102),
# 316 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 316 "../crypto/ec/ec2_oct.c"
       );
        return 0;
    }
    ...
    if (ctx == 
# 321 "../crypto/ec/ec2_oct.c" 3 4
              ((void *)0)
# 321 "../crypto/ec/ec2_oct.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 323 "../crypto/ec/ec2_oct.c" 3 4
                  ((void *)0)
# 323 "../crypto/ec/ec2_oct.c"
                      )
            return 0;
    }
    ...
    yxi = BN_CTX_get(ctx);
    if (yxi == 
# 332 "../crypto/ec/ec2_oct.c" 3 4
              ((void *)0)
# 332 "../crypto/ec/ec2_oct.c"
                  )
        goto err;
    ...
    if (!BN_bin2bn(buf + 1, field_len, x))
        goto err;
    if (BN_num_bits(x) > m) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",338,__func__), ERR_set_error)((16),(102),
# 338 "../crypto/ec/ec2_oct.c" 3 4
       ((void *)0)
# 338 "../crypto/ec/ec2_oct.c"
       );
        goto err;
    }
    ...
    if (form == POINT_CONVERSION_COMPRESSED) {
        ...
        if (!BN_bin2bn(buf + 1 + field_len, field_len, y))
            goto err;
        if (BN_num_bits(y) > m) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",349,__func__), ERR_set_error)((16),(102),
# 349 "../crypto/ec/ec2_oct.c" 3 4
           ((void *)0)
# 349 "../crypto/ec/ec2_oct.c"
           );
            goto err;
        }
        if (form == POINT_CONVERSION_HYBRID) {
            ...
            if (BN_is_zero(x)) {
                if (y_bit != 0) {
                    (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",360,__func__), ERR_set_error)((16),(102),
# 360 "../crypto/ec/ec2_oct.c" 3 4
                   ((void *)0)
# 360 "../crypto/ec/ec2_oct.c"
                   );
                    goto err;
                }
            } else {
                ...
                if (y_bit != BN_is_odd(yxi)) {
                    (ERR_new(), ERR_set_debug("../crypto/ec/ec2_oct.c",367,__func__), ERR_set_error)((16),(102),
# 367 "../crypto/ec/ec2_oct.c" 3 4
                   ((void *)0)
# 367 "../crypto/ec/ec2_oct.c"
                   );
                    goto err;
                }
            }
