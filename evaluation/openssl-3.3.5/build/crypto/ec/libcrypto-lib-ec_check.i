# 0 "../crypto/ec/ec_check.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_check.c"
# 14 "../crypto/ec/ec_check.c"
                               ...
                               BN_CTX *ctx)
{
    int nid;
    BN_CTX *new_ctx = 
# 23 "../crypto/ec/ec_check.c" 3 4
                     ((void *)0)
# 23 "../crypto/ec/ec_check.c"
                         ;

    if (group == 
# 25 "../crypto/ec/ec_check.c" 3 4
                ((void *)0)
# 25 "../crypto/ec/ec_check.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",26,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 26 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 26 "../crypto/ec/ec_check.c"
       );
        return 0;
    }

    if (ctx == 
# 30 "../crypto/ec/ec_check.c" 3 4
              ((void *)0)
# 30 "../crypto/ec/ec_check.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(
# 31 "../crypto/ec/ec_check.c" 3 4
                                     ((void *)0)
# 31 "../crypto/ec/ec_check.c"
                                         );
        if (ctx == 
# 32 "../crypto/ec/ec_check.c" 3 4
                  ((void *)0)
# 32 "../crypto/ec/ec_check.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",33,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 33 "../crypto/ec/ec_check.c" 3 4
           ((void *)0)
# 33 "../crypto/ec/ec_check.c"
           );
            return 0;
        }
    }
    ...
    if (nid > 0 && nist_only && EC_curve_nid2nist(nid) == 
# 39 "../crypto/ec/ec_check.c" 3 4
                                                         ((void *)0)
# 39 "../crypto/ec/ec_check.c"
                                                             )
        nid = 0;
...
int EC_GROUP_check(const EC_GROUP *group, BN_CTX *ctx)
{
    ...
    const BIGNUM *order;
    BN_CTX *new_ctx = 
# 57 "../crypto/ec/ec_check.c" 3 4
                     ((void *)0)
# 57 "../crypto/ec/ec_check.c"
                         ;
    EC_POINT *point = 
# 58 "../crypto/ec/ec_check.c" 3 4
                     ((void *)0)
# 58 "../crypto/ec/ec_check.c"
                         ;

    if (group == 
# 60 "../crypto/ec/ec_check.c" 3 4
                ((void *)0) 
# 60 "../crypto/ec/ec_check.c"
                     || group->meth == 
# 60 "../crypto/ec/ec_check.c" 3 4
                                       ((void *)0)
# 60 "../crypto/ec/ec_check.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",61,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 61 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 61 "../crypto/ec/ec_check.c"
       );
        return 0;
    }


    if ((group->meth->flags & 0x2) != 0)
        return 1;

    if (ctx == 
# 69 "../crypto/ec/ec_check.c" 3 4
              ((void *)0)
# 69 "../crypto/ec/ec_check.c"
                  ) {
        ctx = new_ctx = BN_CTX_new();
        if (ctx == 
# 71 "../crypto/ec/ec_check.c" 3 4
                  ((void *)0)
# 71 "../crypto/ec/ec_check.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",72,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 72 "../crypto/ec/ec_check.c" 3 4
           ((void *)0)
# 72 "../crypto/ec/ec_check.c"
           );
            goto err;
        }
    }
    ...
    if (!EC_GROUP_check_discriminant(group, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",79,__func__), ERR_set_error)((16),(118),
# 79 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 79 "../crypto/ec/ec_check.c"
       );
        goto err;
    }
    ...
    if (group->generator == 
# 84 "../crypto/ec/ec_check.c" 3 4
                           ((void *)0)
# 84 "../crypto/ec/ec_check.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",85,__func__), ERR_set_error)((16),(113),
# 85 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 85 "../crypto/ec/ec_check.c"
       );
        goto err;
    }
    if (EC_POINT_is_on_curve(group, group->generator, ctx) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",89,__func__), ERR_set_error)((16),(107),
# 89 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 89 "../crypto/ec/ec_check.c"
       );
        goto err;
    }
...
# 94 "../crypto/ec/ec_check.c" 3 4
                                        ((void *)0)
# 94 "../crypto/ec/ec_check.c"
                                            )
        goto err;
    order = EC_GROUP_get0_order(group);
    if (order == 
# 97 "../crypto/ec/ec_check.c" 3 4
                ((void *)0)
# 97 "../crypto/ec/ec_check.c"
                    )
        goto err;
    if (BN_is_zero(order)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",100,__func__), ERR_set_error)((16),(128),
# 100 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 100 "../crypto/ec/ec_check.c"
       );
        goto err;
    }

    if (!EC_POINT_mul(group, point, order, 
# 104 "../crypto/ec/ec_check.c" 3 4
                                          ((void *)0)
# 104 "../crypto/ec/ec_check.c"
                                              , 
# 104 "../crypto/ec/ec_check.c" 3 4
                                                ((void *)0)
# 104 "../crypto/ec/ec_check.c"
    ...
    if (!EC_POINT_is_at_infinity(group, point)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_check.c",107,__func__), ERR_set_error)((16),(122),
# 107 "../crypto/ec/ec_check.c" 3 4
       ((void *)0)
# 107 "../crypto/ec/ec_check.c"
       );
        goto err;
    }
