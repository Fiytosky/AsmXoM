# 0 "../crypto/ec/ecx_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecx_key.c"
# 10 "../crypto/ec/ecx_key.c"
...
ECX_KEY *ossl_ecx_key_new(OSSL_LIB_CTX *libctx, ECX_KEY_TYPE type, int haspubkey,
                          const char *propq)
{
    ECX_KEY *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ec/ecx_key.c", 23);

    if (ret == 
# 25 "../crypto/ec/ecx_key.c" 3 4
              ((void *)0)
# 25 "../crypto/ec/ecx_key.c"
                  )
        return 
# 26 "../crypto/ec/ecx_key.c" 3 4
              ((void *)0)
# 26 "../crypto/ec/ecx_key.c"
                  ;
    ...
    if (propq != 
# 49 "../crypto/ec/ecx_key.c" 3 4
                ((void *)0)
# 49 "../crypto/ec/ecx_key.c"
                    ) {
        ret->propq = CRYPTO_strdup(propq, "../crypto/ec/ecx_key.c", 50);
        if (ret->propq == 
# 51 "../crypto/ec/ecx_key.c" 3 4
                         ((void *)0)
# 51 "../crypto/ec/ecx_key.c"
                             )
            goto err;
    }
    return ret;
err:
    if (ret != 
# 56 "../crypto/ec/ecx_key.c" 3 4
              ((void *)0)
# 56 "../crypto/ec/ecx_key.c"
                  ) {
        CRYPTO_free(ret->propq, "../crypto/ec/ecx_key.c", 57);
        CRYPTO_FREE_REF(&ret->references);
    }
    CRYPTO_free(ret, "../crypto/ec/ecx_key.c", 60);
    return 
# 61 "../crypto/ec/ecx_key.c" 3 4
          ((void *)0)
# 61 "../crypto/ec/ecx_key.c"
              ;
}
...
void ossl_ecx_key_free(ECX_KEY *key)
{
    ...
    if (key == 
# 68 "../crypto/ec/ecx_key.c" 3 4
              ((void *)0)
# 68 "../crypto/ec/ecx_key.c"
                  )
        return;
    ...
    CRYPTO_free(key->propq, "../crypto/ec/ecx_key.c", 77);
    CRYPTO_secure_clear_free(key->privkey, key->keylen, "../crypto/ec/ecx_key.c", 78);
    CRYPTO_FREE_REF(&key->references);
    CRYPTO_free(key, "../crypto/ec/ecx_key.c", 80);
}
...
unsigned char *ossl_ecx_key_allocate_privkey(ECX_KEY *key)
{
    key->privkey = CRYPTO_secure_zalloc(key->keylen, "../crypto/ec/ecx_key.c", 102);
...
{
    if (priv == 
# 110 "../crypto/ec/ecx_key.c" 3 4
               ((void *)0)
            
# 111 "../crypto/ec/ecx_key.c"
           || priv->privkey == 
# 111 "../crypto/ec/ecx_key.c" 3 4
                               ((void *)0)
            
# 112 "../crypto/ec/ecx_key.c"
           || peer == 
# 112 "../crypto/ec/ecx_key.c" 3 4
                      ((void *)0)
# 112 "../crypto/ec/ecx_key.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_key.c",113,__func__), ERR_set_error)((57),(128),
# 113 "../crypto/ec/ecx_key.c" 3 4
       ((void *)0)
# 113 "../crypto/ec/ecx_key.c"
       );
        return 0;
    }

    if (!__builtin_expect(!!((keylen == 32 || keylen == 56) != 0), 1)
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_key.c",119,__func__), ERR_set_error)((57),(105),
# 119 "../crypto/ec/ecx_key.c" 3 4
       ((void *)0)
# 119 "../crypto/ec/ecx_key.c"
       );
        return 0;
    }

    if (secret == 
# 123 "../crypto/ec/ecx_key.c" 3 4
                 ((void *)0)
# 123 "../crypto/ec/ecx_key.c"
                     ) {
        *secretlen = keylen;
        return 1;
    }
    if (outlen < keylen) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecx_key.c",128,__func__), ERR_set_error)((57),(106),
# 128 "../crypto/ec/ecx_key.c" 3 4
       ((void *)0)
# 128 "../crypto/ec/ecx_key.c"
       );
        return 0;
    }

    if (keylen == 32) {
# 142 "../crypto/ec/ecx_key.c"
        if (ossl_x25519(secret, priv->privkey, peer->pubkey) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_key.c",143,__func__), ERR_set_error)((57),(164),
# 143 "../crypto/ec/ecx_key.c" 3 4
           ((void *)0)
# 143 "../crypto/ec/ecx_key.c"
           );
            return 0;
        }
    } else {
# 156 "../crypto/ec/ecx_key.c"
        if (ossl_x448(secret, priv->privkey, peer->pubkey) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecx_key.c",157,__func__), ERR_set_error)((57),(164),
# 157 "../crypto/ec/ecx_key.c" 3 4
           ((void *)0)
# 157 "../crypto/ec/ecx_key.c"
           );
            return 0;
        }
    }
