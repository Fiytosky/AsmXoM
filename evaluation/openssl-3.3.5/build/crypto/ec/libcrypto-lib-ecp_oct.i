# 0 "../crypto/ec/ecp_oct.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecp_oct.c"
# 15 "../crypto/ec/ecp_oct.c"
...
{
    BN_CTX *new_ctx = 
# 27 "../crypto/ec/ecp_oct.c" 3 4
                     ((void *)0)
# 27 "../crypto/ec/ecp_oct.c"
                         ;
    BIGNUM *tmp1, *tmp2, *x, *y;
    int ret = 0;

    if (ctx == 
# 31 "../crypto/ec/ecp_oct.c" 3 4
              ((void *)0)
# 31 "../crypto/ec/ecp_oct.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(group->libctx);
        if (ctx == 
# 33 "../crypto/ec/ecp_oct.c" 3 4
                  ((void *)0)
# 33 "../crypto/ec/ecp_oct.c"
                      )
            return 0;
    }
    ...
    y = BN_CTX_get(ctx);
    if (y == 
# 44 "../crypto/ec/ecp_oct.c" 3 4
            ((void *)0)
# 44 "../crypto/ec/ecp_oct.c"
                )
        goto err;
# 54 "../crypto/ec/ecp_oct.c"
    ...
    if (!BN_mod_sqrt(y, tmp1, group->field, ctx)) {
        ...
        if (ERR_GET_LIB(err) == 3
            && ERR_GET_REASON(err) == 111) {
            ERR_pop_to_mark();
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",112,__func__), ERR_set_error)((16),(110),
# 112 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 112 "../crypto/ec/ecp_oct.c"
           );
        } else

        {
            ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",117,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 117 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 117 "../crypto/ec/ecp_oct.c"
    ...
    if (y_bit != BN_is_odd(y)) {
        if (BN_is_zero(y)) {
            ...
            if (kron == 1)
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",132,__func__), ERR_set_error)((16),(109),
# 132 "../crypto/ec/ecp_oct.c" 3 4
               ((void *)0)
# 132 "../crypto/ec/ecp_oct.c"
               );
            else



                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",137,__func__), ERR_set_error)((16),(110),
# 137 "../crypto/ec/ecp_oct.c" 3 4
               ((void *)0)
# 137 "../crypto/ec/ecp_oct.c"
               );
            goto err;
        }
    ...
    if (y_bit != BN_is_odd(y)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",144,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 144 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 144 "../crypto/ec/ecp_oct.c"
       );
        goto err;
    }
...
# 164 "../crypto/ec/ecp_oct.c"
    ...
    if ((form != POINT_CONVERSION_COMPRESSED)
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",172,__func__), ERR_set_error)((16),(104),
# 172 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 172 "../crypto/ec/ecp_oct.c"
       );
        goto err;
    }
    ...
    if (EC_POINT_is_at_infinity(group, point)) {
        ...
        if (buf != 
# 178 "../crypto/ec/ecp_oct.c" 3 4
                  ((void *)0)
# 178 "../crypto/ec/ecp_oct.c"
                      ) {
            if (len < 1) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",180,__func__), ERR_set_error)((16),(100),
# 180 "../crypto/ec/ecp_oct.c" 3 4
               ((void *)0)
# 180 "../crypto/ec/ecp_oct.c"
               );
                return 0;
            }
            buf[0] = 0;
    ...
    if (buf != 
# 195 "../crypto/ec/ecp_oct.c" 3 4
              ((void *)0)
# 195 "../crypto/ec/ecp_oct.c"
                  ) {
        if (len < ret) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",197,__func__), ERR_set_error)((16),(100),
# 197 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 197 "../crypto/ec/ecp_oct.c"
           );
            goto err;
        }

        if (ctx == 
# 201 "../crypto/ec/ecp_oct.c" 3 4
                  ((void *)0)
# 201 "../crypto/ec/ecp_oct.c"
                      ) {
            ctx = new_ctx = BN_CTX_new_ex(group->libctx);
            if (ctx == 
# 203 "../crypto/ec/ecp_oct.c" 3 4
                      ((void *)0)
# 203 "../crypto/ec/ecp_oct.c"
                          )
                return 0;
        }
        ...
        y = BN_CTX_get(ctx);
        if (y == 
# 211 "../crypto/ec/ecp_oct.c" 3 4
                ((void *)0)
# 211 "../crypto/ec/ecp_oct.c"
                    )
            goto err;
        ...
        if (skip > field_len) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",227,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 227 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 227 "../crypto/ec/ecp_oct.c"
           );
            goto err;
        }
        while (skip > 0) {
        ...
        i += skip;
        if (i != 1 + field_len) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",237,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 237 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 237 "../crypto/ec/ecp_oct.c"
           );
            goto err;
        }
        ...
        if (form == POINT_CONVERSION_UNCOMPRESSED
            ...
            if (skip > field_len) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",245,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 245 "../crypto/ec/ecp_oct.c" 3 4
               ((void *)0)
# 245 "../crypto/ec/ecp_oct.c"
               );
                goto err;
            }
            while (skip > 0) {
        ...
        if (i != ret) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",257,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 257 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 257 "../crypto/ec/ecp_oct.c"
           );
            goto err;
        }
    }
                                 ...
                                 BN_CTX *ctx)
{
    ...
    int y_bit;
    BN_CTX *new_ctx = 
# 280 "../crypto/ec/ecp_oct.c" 3 4
                     ((void *)0)
# 280 "../crypto/ec/ecp_oct.c"
                         ;
    BIGNUM *x, *y;
    ...
    if (len == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",286,__func__), ERR_set_error)((16),(100),
# 286 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 286 "../crypto/ec/ecp_oct.c"
       );
        return 0;
    }
    form = buf[0];
    ...
    if ((form != 0) && (form != POINT_CONVERSION_COMPRESSED)
        && (form != POINT_CONVERSION_UNCOMPRESSED)
        && (form != POINT_CONVERSION_HYBRID)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",295,__func__), ERR_set_error)((16),(102),
# 295 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 295 "../crypto/ec/ecp_oct.c"
       );
        return 0;
    }
    if ((form == 0 || form == POINT_CONVERSION_UNCOMPRESSED) && y_bit) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",299,__func__), ERR_set_error)((16),(102),
# 299 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 299 "../crypto/ec/ecp_oct.c"
       );
        return 0;
    }
    ...
    if (form == 0) {
        if (len != 1) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",305,__func__), ERR_set_error)((16),(102),
# 305 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 305 "../crypto/ec/ecp_oct.c"
           );
            return 0;
        }
    ...
    if (len != enc_len) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",318,__func__), ERR_set_error)((16),(102),
# 318 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 318 "../crypto/ec/ecp_oct.c"
       );
        return 0;
    }

    if (ctx == 
# 322 "../crypto/ec/ecp_oct.c" 3 4
              ((void *)0)
# 322 "../crypto/ec/ecp_oct.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(group->libctx);
        if (ctx == 
# 324 "../crypto/ec/ecp_oct.c" 3 4
                  ((void *)0)
# 324 "../crypto/ec/ecp_oct.c"
                      )
            return 0;
    }
    ...
    y = BN_CTX_get(ctx);
    if (y == 
# 331 "../crypto/ec/ecp_oct.c" 3 4
            ((void *)0)
# 331 "../crypto/ec/ecp_oct.c"
                )
        goto err;
    ...
    if (BN_ucmp(x, group->field) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",337,__func__), ERR_set_error)((16),(102),
# 337 "../crypto/ec/ecp_oct.c" 3 4
       ((void *)0)
# 337 "../crypto/ec/ecp_oct.c"
       );
        goto err;
    }
    ...
    if (form == POINT_CONVERSION_COMPRESSED) {
        ...
        if (BN_ucmp(y, group->field) >= 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",348,__func__), ERR_set_error)((16),(102),
# 348 "../crypto/ec/ecp_oct.c" 3 4
           ((void *)0)
# 348 "../crypto/ec/ecp_oct.c"
           );
            goto err;
        }
        if (form == POINT_CONVERSION_HYBRID) {
            if (y_bit != BN_is_odd(y)) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecp_oct.c",353,__func__), ERR_set_error)((16),(102),
# 353 "../crypto/ec/ecp_oct.c" 3 4
               ((void *)0)
# 353 "../crypto/ec/ecp_oct.c"
               );
                goto err;
            }
        }
