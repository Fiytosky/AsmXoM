# 0 "../crypto/ec/ecdsa_ossl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecdsa_ossl.c"
# 14 "../crypto/ec/ecdsa_ossl.c"
...
# 21 "../crypto/ec/ecdsa_ossl.c" 2
# 1 "../crypto/ec/ec_local.h" 1
# 14 "../crypto/ec/ec_local.h"
...
int ossl_gen_deterministic_nonce_rfc6979(BIGNUM *out, const BIGNUM *q,
                                         ...
                                         OSSL_LIB_CTX *libctx,
                                         const char *propq);
# 23 "../crypto/ec/ecdsa_ossl.c" 2
# 33 "../crypto/ec/ecdsa_ossl.c"
...
int ossl_ecdsa_sign_setup(EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp,
                          BIGNUM **rp)
{
    if (eckey->group->meth->ecdsa_sign_setup == 
# 42 "../crypto/ec/ecdsa_ossl.c" 3 4
                                               ((void *)0)
# 42 "../crypto/ec/ecdsa_ossl.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",43,__func__), ERR_set_error)((16),(170),
# 43 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 43 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }
...
ECDSA_SIG *ossl_ecdsa_sign_sig(const unsigned char *dgst, int dgst_len,
                               ...
                               EC_KEY *eckey)
{
    if (eckey->group->meth->ecdsa_sign_sig == 
# 54 "../crypto/ec/ecdsa_ossl.c" 3 4
                                             ((void *)0)
# 54 "../crypto/ec/ecdsa_ossl.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",55,__func__), ERR_set_error)((16),(170),
# 55 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 55 "../crypto/ec/ecdsa_ossl.c"
       );
        return 
# 56 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 56 "../crypto/ec/ecdsa_ossl.c"
                  ;
    }
...
int ossl_ecdsa_verify_sig(const unsigned char *dgst, int dgst_len,
                          const ECDSA_SIG *sig, EC_KEY *eckey)
{
    if (eckey->group->meth->ecdsa_verify_sig == 
# 66 "../crypto/ec/ecdsa_ossl.c" 3 4
                                               ((void *)0)
# 66 "../crypto/ec/ecdsa_ossl.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",67,__func__), ERR_set_error)((16),(170),
# 67 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 67 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }
                    ...
                    const BIGNUM *kinv, const BIGNUM *r, EC_KEY *eckey)
{
    ...
    if (sig == 
# 80 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0) 
# 80 "../crypto/ec/ecdsa_ossl.c"
                   && (kinv == 
# 80 "../crypto/ec/ecdsa_ossl.c" 3 4
                               ((void *)0) 
# 80 "../crypto/ec/ecdsa_ossl.c"
...
# 80 "../crypto/ec/ecdsa_ossl.c"
    ...
    if (s == 
# 86 "../crypto/ec/ecdsa_ossl.c" 3 4
            ((void *)0)
# 86 "../crypto/ec/ecdsa_ossl.c"
                ) {
        *siglen = 0;
        return 0;
    }
    *siglen = i2d_ECDSA_SIG(s, sig != 
# 90 "../crypto/ec/ecdsa_ossl.c" 3 4
                                     ((void *)0) 
# 90 "../crypto/ec/ecdsa_ossl.c"
                                          ? &sig : 
# 90 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                   ((void *)0)
# 90 "../crypto/ec/ecdsa_ossl.c"
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq)
{
    ECDSA_SIG *s;
    BIGNUM *kinv = 
# 102 "../crypto/ec/ecdsa_ossl.c" 3 4
                  ((void *)0)
# 102 "../crypto/ec/ecdsa_ossl.c"
                      , *r = 
# 102 "../crypto/ec/ecdsa_ossl.c" 3 4
                             ((void *)0)
# 102 "../crypto/ec/ecdsa_ossl.c"
    ...
    if (sig == 
# 105 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 105 "../crypto/ec/ecdsa_ossl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",106,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 106 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 106 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }
    if (digestname == 
# 109 "../crypto/ec/ecdsa_ossl.c" 3 4
                     ((void *)0)
# 109 "../crypto/ec/ecdsa_ossl.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",110,__func__), ERR_set_error)((16),(151),
# 110 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 110 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }
...
# 115 "../crypto/ec/ecdsa_ossl.c" 3 4
                                ((void *)0)
# 115 "../crypto/ec/ecdsa_ossl.c"
                                    , &kinv, &r, dgst, dlen,
    ...
    s = ECDSA_do_sign_ex(dgst, dlen, kinv, r, eckey);
    if (s == 
# 120 "../crypto/ec/ecdsa_ossl.c" 3 4
            ((void *)0)
# 120 "../crypto/ec/ecdsa_ossl.c"
                )
        goto end;
...
{
    BN_CTX *ctx = 
# 138 "../crypto/ec/ecdsa_ossl.c" 3 4
                 ((void *)0)
# 138 "../crypto/ec/ecdsa_ossl.c"
                     ;
    BIGNUM *k = 
# 139 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 139 "../crypto/ec/ecdsa_ossl.c"
                   , *r = 
# 139 "../crypto/ec/ecdsa_ossl.c" 3 4
                          ((void *)0)
# 139 "../crypto/ec/ecdsa_ossl.c"
...
# 139 "../crypto/ec/ecdsa_ossl.c"
    ...
    const BIGNUM *order;
    EC_POINT *tmp_point = 
# 141 "../crypto/ec/ecdsa_ossl.c" 3 4
                         ((void *)0)
# 141 "../crypto/ec/ecdsa_ossl.c"
                             ;
    const EC_GROUP *group;
    int ret = 0;
    int order_bits;
    ...
    if (eckey == 
# 147 "../crypto/ec/ecdsa_ossl.c" 3 4
                ((void *)0) 
# 147 "../crypto/ec/ecdsa_ossl.c"
                     || (group = EC_KEY_get0_group(eckey)) == 
# 147 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                              ((void *)0)
# 147 "../crypto/ec/ecdsa_ossl.c"
                                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",148,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 148 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 148 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }
    if ((priv_key = EC_KEY_get0_private_key(eckey)) == 
# 151 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                      ((void *)0)
# 151 "../crypto/ec/ecdsa_ossl.c"
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",152,__func__), ERR_set_error)((16),(125),
# 152 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 152 "../crypto/ec/ecdsa_ossl.c"
       );
        return 0;
    }

    if (!EC_KEY_can_sign(eckey)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",157,__func__), ERR_set_error)((16),(159),
# 157 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 157 "../crypto/ec/ecdsa_ossl.c"
    ...
    if ((ctx = ctx_in) == 
# 161 "../crypto/ec/ecdsa_ossl.c" 3 4
                         ((void *)0)
# 161 "../crypto/ec/ecdsa_ossl.c"
                             ) {
        if ((ctx = BN_CTX_new_ex(eckey->libctx)) == 
# 162 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                   ((void *)0)
# 162 "../crypto/ec/ecdsa_ossl.c"
                                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",163,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 163 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 163 "../crypto/ec/ecdsa_ossl.c"
           );
            return 0;
        }
    }
    ...
    X = BN_new();
    if (k == 
# 171 "../crypto/ec/ecdsa_ossl.c" 3 4
            ((void *)0) 
# 171 "../crypto/ec/ecdsa_ossl.c"
                 || r == 
# 171 "../crypto/ec/ecdsa_ossl.c" 3 4
                         ((void *)0) 
# 171 "../crypto/ec/ecdsa_ossl.c"
...
# 171 "../crypto/ec/ecdsa_ossl.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",172,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 172 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 172 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    if ((tmp_point = EC_POINT_new(group)) == 
# 175 "../crypto/ec/ecdsa_ossl.c" 3 4
                                            ((void *)0)
# 175 "../crypto/ec/ecdsa_ossl.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",176,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 176 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 176 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if ((order = EC_GROUP_get0_order(group)) == 
# 180 "../crypto/ec/ecdsa_ossl.c" 3 4
                                               ((void *)0)
# 180 "../crypto/ec/ecdsa_ossl.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",181,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 181 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 181 "../crypto/ec/ecdsa_ossl.c"
    ...
    do {
        ...
        do {
            ...
            if (dgst != 
# 199 "../crypto/ec/ecdsa_ossl.c" 3 4
                       ((void *)0)
# 199 "../crypto/ec/ecdsa_ossl.c"
                           ) {
                if (nonce_type == 1) {
            ...
            if (!res) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",216,__func__), ERR_set_error)((16),(158),
# 216 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 216 "../crypto/ec/ecdsa_ossl.c"
               );
                goto err;
            }
...
# 222 "../crypto/ec/ecdsa_ossl.c" 3 4
                                              ((void *)0)
# 222 "../crypto/ec/ecdsa_ossl.c"
                                                  , 
# 222 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                    ((void *)0)
# 222 "../crypto/ec/ecdsa_ossl.c"
                                                        , ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",223,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 223 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 223 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }

        if (!EC_POINT_get_affine_coordinates(group, tmp_point, X, 
# 227 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                                 ((void *)0)
# 227 "../crypto/ec/ecdsa_ossl.c"
                                                                     , ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",228,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 228 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 228 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }

        if (!BN_nnmod(r, X, order, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",233,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 233 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 233 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }
    } while (BN_is_zero(r));
    ...
    if (!ossl_ec_group_do_inverse_ord(group, k, k, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",240,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 240 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 240 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
...
# 266 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                     ((void *)0)
# 266 "../crypto/ec/ecdsa_ossl.c"
                                                         , 0,
                            0, 
# 267 "../crypto/ec/ecdsa_ossl.c" 3 4
                              ((void *)0)
# 267 "../crypto/ec/ecdsa_ossl.c"
                                  , 
# 267 "../crypto/ec/ecdsa_ossl.c" 3 4
                                    ((void *)0)
# 267 "../crypto/ec/ecdsa_ossl.c"
                                      ...
                                      EC_KEY *eckey)
{
    ...
    int retries = 0;
    BIGNUM *kinv = 
# 276 "../crypto/ec/ecdsa_ossl.c" 3 4
                  ((void *)0)
# 276 "../crypto/ec/ecdsa_ossl.c"
                      , *s, *m = 
# 276 "../crypto/ec/ecdsa_ossl.c" 3 4
                                 ((void *)0)
# 276 "../crypto/ec/ecdsa_ossl.c"
    ...
    BN_CTX *ctx = 
# 278 "../crypto/ec/ecdsa_ossl.c" 3 4
                 ((void *)0)
# 278 "../crypto/ec/ecdsa_ossl.c"
                     ;
    const EC_GROUP *group;
    ECDSA_SIG *ret;
    const BIGNUM *priv_key;
    ...
    if (group == 
# 286 "../crypto/ec/ecdsa_ossl.c" 3 4
                ((void *)0)
# 286 "../crypto/ec/ecdsa_ossl.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",287,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 287 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 287 "../crypto/ec/ecdsa_ossl.c"
       );
        return 
# 288 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 288 "../crypto/ec/ecdsa_ossl.c"
                  ;
    }
    if (priv_key == 
# 290 "../crypto/ec/ecdsa_ossl.c" 3 4
                   ((void *)0)
# 290 "../crypto/ec/ecdsa_ossl.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",291,__func__), ERR_set_error)((16),(125),
# 291 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 291 "../crypto/ec/ecdsa_ossl.c"
       );
        return 
# 292 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 292 "../crypto/ec/ecdsa_ossl.c"
                  ;
    }

    if (!EC_KEY_can_sign(eckey)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",296,__func__), ERR_set_error)((16),(159),
# 296 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 296 "../crypto/ec/ecdsa_ossl.c"
       );
        return 
# 297 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 297 "../crypto/ec/ecdsa_ossl.c"
                  ;
    }

    ret = ECDSA_SIG_new();
    if (ret == 
# 301 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 301 "../crypto/ec/ecdsa_ossl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",302,__func__), ERR_set_error)((16),((42 | (0x2 << 18L))),
# 302 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 302 "../crypto/ec/ecdsa_ossl.c"
       );
        return 
# 303 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 303 "../crypto/ec/ecdsa_ossl.c"
                  ;
    }
    ret->r = BN_new();
    ret->s = BN_new();
    if (ret->r == 
# 307 "../crypto/ec/ecdsa_ossl.c" 3 4
                 ((void *)0) 
# 307 "../crypto/ec/ecdsa_ossl.c"
                      || ret->s == 
# 307 "../crypto/ec/ecdsa_ossl.c" 3 4
                                   ((void *)0)
# 307 "../crypto/ec/ecdsa_ossl.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",308,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 308 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 308 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    s = ret->s;
    ...
    if ((ctx = BN_CTX_new_ex(eckey->libctx)) == 
# 313 "../crypto/ec/ecdsa_ossl.c" 3 4
                                               ((void *)0)
        
# 314 "../crypto/ec/ecdsa_ossl.c"
       || (m = BN_new()) == 
# 314 "../crypto/ec/ecdsa_ossl.c" 3 4
                            ((void *)0)
# 314 "../crypto/ec/ecdsa_ossl.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",315,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 315 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 315 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if ((order = EC_GROUP_get0_order(group)) == 
# 319 "../crypto/ec/ecdsa_ossl.c" 3 4
                                               ((void *)0)
# 319 "../crypto/ec/ecdsa_ossl.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",320,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 320 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 320 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    ...
    if (!BN_bin2bn(dgst, dgst_len, m)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",331,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 331 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 331 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if ((8 * dgst_len > i) && !BN_rshift(m, m, 8 - (i & 0x7))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",336,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 336 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 336 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    do {
        if (in_kinv == 
# 340 "../crypto/ec/ecdsa_ossl.c" 3 4
                      ((void *)0) 
# 340 "../crypto/ec/ecdsa_ossl.c"
                           || in_r == 
# 340 "../crypto/ec/ecdsa_ossl.c" 3 4
                                      ((void *)0)
# 340 "../crypto/ec/ecdsa_ossl.c"
            ...
            if (!ecdsa_sign_setup(eckey, ctx, &kinv, &ret->r, dgst, dgst_len,
                                  0, 
# 342 "../crypto/ec/ecdsa_ossl.c" 3 4
                                    ((void *)0)
# 342 "../crypto/ec/ecdsa_ossl.c"
                                        , 
# 342 "../crypto/ec/ecdsa_ossl.c" 3 4
                                          ((void *)0)
# 342 "../crypto/ec/ecdsa_ossl.c"
...
# 342 "../crypto/ec/ecdsa_ossl.c"
                ...
                (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",343,__func__), ERR_set_error)((16),((42 | (0x2 << 18L))),
# 343 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 343 "../crypto/ec/ecdsa_ossl.c"
               );
                goto err;
            }
            ckinv = kinv;
...
# 349 "../crypto/ec/ecdsa_ossl.c" 3 4
                                        ((void *)0)
# 349 "../crypto/ec/ecdsa_ossl.c"
                                            ) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",350,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 350 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 350 "../crypto/ec/ecdsa_ossl.c"
               );
                goto err;
            }
        }
# 362 "../crypto/ec/ecdsa_ossl.c"
        if (!bn_to_mont_fixed_top(s, ret->r, group->mont_data, ctx)
            || !bn_mul_mont_fixed_top(s, s, priv_key, group->mont_data, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",364,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 364 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 364 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }
        if (!bn_mod_add_fixed_top(s, s, m, order)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",368,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 368 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 368 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }
        ...
        if (!bn_to_mont_fixed_top(s, s, group->mont_data, ctx)
            ...
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",377,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 377 "../crypto/ec/ecdsa_ossl.c" 3 4
           ((void *)0)
# 377 "../crypto/ec/ecdsa_ossl.c"
           );
            goto err;
        }
        ...
        if (BN_is_zero(s)) {
            ...
            if (in_kinv != 
# 386 "../crypto/ec/ecdsa_ossl.c" 3 4
                          ((void *)0) 
# 386 "../crypto/ec/ecdsa_ossl.c"
                               && in_r != 
# 386 "../crypto/ec/ecdsa_ossl.c" 3 4
                                          ((void *)0)
# 386 "../crypto/ec/ecdsa_ossl.c"
                                              ) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",387,__func__), ERR_set_error)((16),(157),
# 387 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 387 "../crypto/ec/ecdsa_ossl.c"
               );
                goto err;
            }

            if (retries++ > 8) {
                (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",392,__func__), ERR_set_error)((16),(176),
# 392 "../crypto/ec/ecdsa_ossl.c" 3 4
               ((void *)0)
# 392 "../crypto/ec/ecdsa_ossl.c"
               );
                goto err;
            }
        } else {
 ...
 err:
    if (!ok) {
        ECDSA_SIG_free(ret);
        ret = 
# 405 "../crypto/ec/ecdsa_ossl.c" 3 4
             ((void *)0)
# 405 "../crypto/ec/ecdsa_ossl.c"
                 ;
    }
    BN_CTX_free(ctx);
    BN_clear_free(m);
                      ...
                      const unsigned char *sigbuf, int sig_len, EC_KEY *eckey)
{
    ...
    unsigned char *der = 
# 424 "../crypto/ec/ecdsa_ossl.c" 3 4
                        ((void *)0)
# 424 "../crypto/ec/ecdsa_ossl.c"
                            ;
    int derlen = -1;
    int ret = -1;
    ...
    s = ECDSA_SIG_new();
    if (s == 
# 429 "../crypto/ec/ecdsa_ossl.c" 3 4
            ((void *)0)
# 429 "../crypto/ec/ecdsa_ossl.c"
                )
        return ret;
    if (d2i_ECDSA_SIG(&s, &p, sig_len) == 
# 431 "../crypto/ec/ecdsa_ossl.c" 3 4
                                         ((void *)0)
# 431 "../crypto/ec/ecdsa_ossl.c"
                                             )
        goto err;
 ...
 err:
    CRYPTO_free(der, "../crypto/ec/ecdsa_ossl.c", 439);
    ECDSA_SIG_free(s);
    return ret;
}
                                 ...
                                 const ECDSA_SIG *sig, EC_KEY *eckey)
{
    ...
    BIGNUM *u1, *u2, *m, *X;
    EC_POINT *point = 
# 451 "../crypto/ec/ecdsa_ossl.c" 3 4
                     ((void *)0)
# 451 "../crypto/ec/ecdsa_ossl.c"
                         ;
    const EC_GROUP *group;
    const EC_POINT *pub_key;
    ...
    if (eckey == 
# 456 "../crypto/ec/ecdsa_ossl.c" 3 4
                ((void *)0) 
# 456 "../crypto/ec/ecdsa_ossl.c"
                     || (group = EC_KEY_get0_group(eckey)) == 
# 456 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                              ((void *)0) 
# 456 "../crypto/ec/ecdsa_ossl.c"
...
# 457 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                    ((void *)0) 
# 457 "../crypto/ec/ecdsa_ossl.c"
                                                         || sig == 
# 457 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                                   ((void *)0)
# 457 "../crypto/ec/ecdsa_ossl.c"
                                                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",458,__func__), ERR_set_error)((16),(124),
# 458 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 458 "../crypto/ec/ecdsa_ossl.c"
       );
        return -1;
    }

    if (!EC_KEY_can_sign(eckey)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",463,__func__), ERR_set_error)((16),(159),
# 463 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 463 "../crypto/ec/ecdsa_ossl.c"
       );
        return -1;
    }
    ...
    if (ctx == 
# 468 "../crypto/ec/ecdsa_ossl.c" 3 4
              ((void *)0)
# 468 "../crypto/ec/ecdsa_ossl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",469,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 469 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 469 "../crypto/ec/ecdsa_ossl.c"
       );
        return -1;
    }
    BN_CTX_start(ctx);
    ...
    X = BN_CTX_get(ctx);
    if (X == 
# 477 "../crypto/ec/ecdsa_ossl.c" 3 4
            ((void *)0)
# 477 "../crypto/ec/ecdsa_ossl.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",478,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 478 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 478 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    ...
    if (order == 
# 483 "../crypto/ec/ecdsa_ossl.c" 3 4
                ((void *)0)
# 483 "../crypto/ec/ecdsa_ossl.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",484,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 484 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 484 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    ...
    if (BN_is_zero(sig->r) || BN_is_negative(sig->r) ||
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",491,__func__), ERR_set_error)((16),(156),
# 491 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 491 "../crypto/ec/ecdsa_ossl.c"
       );
        ret = 0;
        goto err;
    }
    ...
    if (!ossl_ec_group_do_inverse_ord(group, u2, sig->s, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",497,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 497 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 497 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    ...
    if (8 * dgst_len > i)
        dgst_len = (i + 7) / 8;
    if (!BN_bin2bn(dgst, dgst_len, m)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",508,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 508 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 508 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if ((8 * dgst_len > i) && !BN_rshift(m, m, 8 - (i & 0x7))) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",513,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 513 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 513 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if (!BN_mod_mul(u1, m, u2, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",518,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 518 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 518 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if (!BN_mod_mul(u2, sig->r, u2, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",523,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 523 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 523 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if ((point = EC_POINT_new(group)) == 
# 527 "../crypto/ec/ecdsa_ossl.c" 3 4
                                        ((void *)0)
# 527 "../crypto/ec/ecdsa_ossl.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",528,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 528 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 528 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
    if (!EC_POINT_mul(group, point, u1, pub_key, u2, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",532,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 532 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 532 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if (!EC_POINT_get_affine_coordinates(group, point, X, 
# 536 "../crypto/ec/ecdsa_ossl.c" 3 4
                                                         ((void *)0)
# 536 "../crypto/ec/ecdsa_ossl.c"
                                                             , ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",537,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 537 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 537 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }

    if (!BN_nnmod(u1, X, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_ossl.c",542,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 542 "../crypto/ec/ecdsa_ossl.c" 3 4
       ((void *)0)
# 542 "../crypto/ec/ecdsa_ossl.c"
       );
        goto err;
    }
