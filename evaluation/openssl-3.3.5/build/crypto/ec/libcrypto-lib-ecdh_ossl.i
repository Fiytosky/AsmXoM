# 0 "../crypto/ec/ecdh_ossl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecdh_ossl.c"
# 15 "../crypto/ec/ecdh_ossl.c"
...
# 27 "../crypto/ec/ecdh_ossl.c" 2

int ossl_ecdh_compute_key(unsigned char **psec, size_t *pseclen,
                          const EC_POINT *pub_key, const EC_KEY *ecdh)
{
    if (ecdh->group->meth->ecdh_compute_key == 
# 31 "../crypto/ec/ecdh_ossl.c" 3 4
                                              ((void *)0)
# 31 "../crypto/ec/ecdh_ossl.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",32,__func__), ERR_set_error)((16),(160),
# 32 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 32 "../crypto/ec/ecdh_ossl.c"
       );
        return 0;
    }
...
# 49 "../crypto/ec/ecdh_ossl.c"
int ossl_ecdh_simple_compute_key(unsigned char **pout, size_t *poutlen,
                                 const EC_POINT *pub_key, const EC_KEY *ecdh)
{
    BN_CTX *ctx;
    EC_POINT *tmp = 
# 53 "../crypto/ec/ecdh_ossl.c" 3 4
                   ((void *)0)
# 53 "../crypto/ec/ecdh_ossl.c"
                       ;
    BIGNUM *x = 
# 54 "../crypto/ec/ecdh_ossl.c" 3 4
               ((void *)0)
# 54 "../crypto/ec/ecdh_ossl.c"
                   ;
    ...
    size_t buflen, len;
    unsigned char *buf = 
# 59 "../crypto/ec/ecdh_ossl.c" 3 4
                        ((void *)0)
# 59 "../crypto/ec/ecdh_ossl.c"
                            ;

    if ((ctx = BN_CTX_new_ex(ecdh->libctx)) == 
# 61 "../crypto/ec/ecdh_ossl.c" 3 4
                                              ((void *)0)
# 61 "../crypto/ec/ecdh_ossl.c"
                                                  )
        goto err;
    BN_CTX_start(ctx);
    x = BN_CTX_get(ctx);
    if (x == 
# 65 "../crypto/ec/ecdh_ossl.c" 3 4
            ((void *)0)
# 65 "../crypto/ec/ecdh_ossl.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",66,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 66 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 66 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    ...
    if (priv_key == 
# 71 "../crypto/ec/ecdh_ossl.c" 3 4
                   ((void *)0)
# 71 "../crypto/ec/ecdh_ossl.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",72,__func__), ERR_set_error)((16),(125),
# 72 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 72 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    ...
    if (EC_KEY_get_flags(ecdh) & 0x1000) {
        if (!EC_GROUP_get_cofactor(group, x, 
# 83 "../crypto/ec/ecdh_ossl.c" 3 4
                                            ((void *)0)
# 83 "../crypto/ec/ecdh_ossl.c"
                                                )) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",84,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 84 "../crypto/ec/ecdh_ossl.c" 3 4
           ((void *)0)
# 84 "../crypto/ec/ecdh_ossl.c"
           );
            goto err;
        }
        if (!BN_mul(x, x, priv_key, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",88,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 88 "../crypto/ec/ecdh_ossl.c" 3 4
           ((void *)0)
# 88 "../crypto/ec/ecdh_ossl.c"
           );
            goto err;
        }
        priv_key = x;
...
# 94 "../crypto/ec/ecdh_ossl.c" 3 4
                                      ((void *)0)
# 94 "../crypto/ec/ecdh_ossl.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",95,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 95 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 95 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }

    if (!EC_POINT_mul(group, tmp, 
# 99 "../crypto/ec/ecdh_ossl.c" 3 4
                                 ((void *)0)
# 99 "../crypto/ec/ecdh_ossl.c"
                                     , pub_key, priv_key, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",100,__func__), ERR_set_error)((16),(155),
# 100 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 100 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    ...
    if (!EC_POINT_get_affine_coordinates(group, tmp, x, 
# 109 "../crypto/ec/ecdh_ossl.c" 3 4
                                                       ((void *)0)
# 109 "../crypto/ec/ecdh_ossl.c"
                                                           , ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",110,__func__), ERR_set_error)((16),(155),
# 110 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 110 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    ...
    if (len > buflen) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",121,__func__), ERR_set_error)((16),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 121 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 121 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    if ((buf = CRYPTO_malloc(buflen, "../crypto/ec/ecdh_ossl.c", 124)) == 
# 124 "../crypto/ec/ecdh_ossl.c" 3 4
                                         ((void *)0)
# 124 "../crypto/ec/ecdh_ossl.c"
                                             )
        goto err;

    memset(buf, 0, buflen - len);
    if (len != (size_t)BN_bn2bin(x, buf + buflen - len)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecdh_ossl.c",129,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 129 "../crypto/ec/ecdh_ossl.c" 3 4
       ((void *)0)
# 129 "../crypto/ec/ecdh_ossl.c"
       );
        goto err;
    }
    ...
    *poutlen = buflen;
    buf = 
# 135 "../crypto/ec/ecdh_ossl.c" 3 4
         ((void *)0)
# 135 "../crypto/ec/ecdh_ossl.c"
             ;
 ...
 err:
    ...
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_free(buf, "../crypto/ec/ecdh_ossl.c", 145);
    return ret;
}
