# 0 "../crypto/ec/ec_ameth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_ameth.c"
# 14 "../crypto/ec/ec_ameth.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 25 "../crypto/ec/ec_ameth.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 26 "../crypto/ec/ec_ameth.c" 2
...
static int eckey_param2type(int *pptype, void **ppval, const EC_KEY *ec_key)
{
    ...
    if (ec_key == 
# 34 "../crypto/ec/ec_ameth.c" 3 4
                 ((void *)0) 
# 34 "../crypto/ec/ec_ameth.c"
                      || (group = EC_KEY_get0_group(ec_key)) == 
# 34 "../crypto/ec/ec_ameth.c" 3 4
                                                                ((void *)0)
# 34 "../crypto/ec/ec_ameth.c"
                                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",35,__func__), ERR_set_error)((16),(124),
# 35 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 35 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }
...

    {
        ...
        if (asn1obj == 
# 44 "../crypto/ec/ec_ameth.c" 3 4
                      ((void *)0) 
# 44 "../crypto/ec/ec_ameth.c"
                           || OBJ_length(asn1obj) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",45,__func__), ERR_set_error)((16),(167),
# 45 "../crypto/ec/ec_ameth.c" 3 4
           ((void *)0)
# 45 "../crypto/ec/ec_ameth.c"
           );
            return 0;
        }
        *ppval = asn1obj;
        *pptype = 6;
        ...
        ASN1_STRING *pstr = 
# 52 "../crypto/ec/ec_ameth.c" 3 4
                           ((void *)0)
# 52 "../crypto/ec/ec_ameth.c"
                               ;
        pstr = ASN1_STRING_new();
        if (pstr == 
# 54 "../crypto/ec/ec_ameth.c" 3 4
                   ((void *)0)
# 54 "../crypto/ec/ec_ameth.c"
                       )
            return 0;
        pstr->length = i2d_ECParameters(ec_key, &pstr->data);
        if (pstr->length <= 0) {
            ASN1_STRING_free(pstr);
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",59,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 59 "../crypto/ec/ec_ameth.c" 3 4
           ((void *)0)
# 59 "../crypto/ec/ec_ameth.c"
           );
            return 0;
        }
        *ppval = pstr;
...
static int eckey_pub_encode(X509_PUBKEY *pk, const EVP_PKEY *pkey)
{
    ...
    void *pval = 
# 71 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0)
# 71 "../crypto/ec/ec_ameth.c"
                    ;
    int ptype;
    unsigned char *penc = 
# 73 "../crypto/ec/ec_ameth.c" 3 4
                         ((void *)0)
# 73 "../crypto/ec/ec_ameth.c"
                             , *p;
    int penclen;

    if (!eckey_param2type(&ptype, &pval, ec_key)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",77,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 77 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 77 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }
    penclen = i2o_ECPublicKey(ec_key, 
# 80 "../crypto/ec/ec_ameth.c" 3 4
                                     ((void *)0)
# 80 "../crypto/ec/ec_ameth.c"
                                         );
    if (penclen <= 0)
        goto err;
    penc = CRYPTO_malloc(penclen, "../crypto/ec/ec_ameth.c", 83);
    if (penc == 
# 84 "../crypto/ec/ec_ameth.c" 3 4
               ((void *)0)
# 84 "../crypto/ec/ec_ameth.c"
                   )
        goto err;
    p = penc;
 ...
 err:
    ...
    CRYPTO_free(penc, "../crypto/ec/ec_ameth.c", 96);
    return 0;
}
...
# 102 "../crypto/ec/ec_ameth.c" 3 4
                            ((void *)0)
# 102 "../crypto/ec/ec_ameth.c"
                                ;
    int pklen;
    EC_KEY *eckey = 
# 104 "../crypto/ec/ec_ameth.c" 3 4
                   ((void *)0)
# 104 "../crypto/ec/ec_ameth.c"
                       ;
    X509_ALGOR *palg;
    OSSL_LIB_CTX *libctx = 
# 106 "../crypto/ec/ec_ameth.c" 3 4
                          ((void *)0)
# 106 "../crypto/ec/ec_ameth.c"
                              ;
    const char *propq = 
# 107 "../crypto/ec/ec_ameth.c" 3 4
                       ((void *)0)
# 107 "../crypto/ec/ec_ameth.c"
                           ;

    if (!ossl_x509_PUBKEY_get0_libctx(&libctx, &propq, pubkey)
        || !X509_PUBKEY_get0_param(
# 110 "../crypto/ec/ec_ameth.c" 3 4
                                  ((void *)0)
# 110 "../crypto/ec/ec_ameth.c"
                                      , &p, &pklen, &palg, pubkey))
        return 0;
    ...
    if (!o2i_ECPublicKey(&eckey, &p, pklen)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",119,__func__), ERR_set_error)((16),(142),
# 119 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 119 "../crypto/ec/ec_ameth.c"
       );
        goto ecerr;
    }

    EVP_PKEY_assign((pkey), 408, (eckey));
    return 1;
...
static int eckey_pub_cmp(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (group == 
# 138 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0) 
# 138 "../crypto/ec/ec_ameth.c"
                     || pa == 
# 138 "../crypto/ec/ec_ameth.c" 3 4
                              ((void *)0) 
# 138 "../crypto/ec/ec_ameth.c"
...
# 140 "../crypto/ec/ec_ameth.c" 3 4
                                   ((void *)0)
# 140 "../crypto/ec/ec_ameth.c"
                                       );
    if (r == 0)
        return 1;
    if (r == 1)
                                ...
                                OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (eckey != 
# 154 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0)
# 154 "../crypto/ec/ec_ameth.c"
                    ) {
        ret = 1;
        EVP_PKEY_assign((pkey), 408, (eckey));
    }
...
static int eckey_priv_encode(PKCS8_PRIV_KEY_INFO *p8, const EVP_PKEY *pkey)
{
    ...
    unsigned char *ep = 
# 165 "../crypto/ec/ec_ameth.c" 3 4
                       ((void *)0)
# 165 "../crypto/ec/ec_ameth.c"
                           ;
    int eplen, ptype;
    void *pval;
    ...
    if (!eckey_param2type(&ptype, &pval, &ec_key)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",171,__func__), ERR_set_error)((16),(142),
# 171 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 171 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }
    ...
    EC_KEY_set_enc_flags(&ec_key, old_flags | 0x001);

    eplen = i2d_ECPrivateKey(&ec_key, &ep);
    if (eplen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",186,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 186 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 186 "../crypto/ec/ec_ameth.c"
       );
        goto err;
    }
    ...
    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(408), 0,
                         ptype, pval, ep, eplen)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",192,__func__), ERR_set_error)((16),((13 | (0x2 << 18L))),
# 192 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 192 "../crypto/ec/ec_ameth.c"
       );
        CRYPTO_clear_free(ep, eplen, "../crypto/ec/ec_ameth.c", 193);
        goto err;
    }
...
{
    if (pkey->pkey.ec == 
# 234 "../crypto/ec/ec_ameth.c" 3 4
                        ((void *)0) 
# 234 "../crypto/ec/ec_ameth.c"
                             || EC_KEY_get0_group(pkey->pkey.ec) == 
# 234 "../crypto/ec/ec_ameth.c" 3 4
                                                                    ((void *)0)
# 234 "../crypto/ec/ec_ameth.c"
                                                                        )
...
static int ec_copy_parameters(EVP_PKEY *to, const EVP_PKEY *from)
{
    ...
    if (group == 
# 243 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0)
# 243 "../crypto/ec/ec_ameth.c"
                    )
        return 0;
    if (to->pkey.ec == 
# 245 "../crypto/ec/ec_ameth.c" 3 4
                      ((void *)0)
# 245 "../crypto/ec/ec_ameth.c"
                          ) {
        to->pkey.ec = EC_KEY_new();
        if (to->pkey.ec == 
# 247 "../crypto/ec/ec_ameth.c" 3 4
                          ((void *)0)
# 247 "../crypto/ec/ec_ameth.c"
                              )
            goto err;
    }
...
static int ec_cmp_parameters(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (group_a == 
# 264 "../crypto/ec/ec_ameth.c" 3 4
                  ((void *)0) 
# 264 "../crypto/ec/ec_ameth.c"
                       || group_b == 
# 264 "../crypto/ec/ec_ameth.c" 3 4
                                     ((void *)0)
# 264 "../crypto/ec/ec_ameth.c"
...
# 266 "../crypto/ec/ec_ameth.c" 3 4
                                      ((void *)0)
# 266 "../crypto/ec/ec_ameth.c"
                                          ))
        return 0;
    else
        return 1;
...
static int do_EC_KEY_print(BIO *bp, const EC_KEY *x, int off, ec_print_t ktype)
{
    const char *ecstr;
    unsigned char *priv = 
# 286 "../crypto/ec/ec_ameth.c" 3 4
                         ((void *)0)
# 286 "../crypto/ec/ec_ameth.c"
                             , *pub = 
# 286 "../crypto/ec/ec_ameth.c" 3 4
                                      ((void *)0)
# 286 "../crypto/ec/ec_ameth.c"
    ...
    if (x == 
# 291 "../crypto/ec/ec_ameth.c" 3 4
            ((void *)0) 
# 291 "../crypto/ec/ec_ameth.c"
                 || (group = EC_KEY_get0_group(x)) == 
# 291 "../crypto/ec/ec_ameth.c" 3 4
                                                      ((void *)0)
# 291 "../crypto/ec/ec_ameth.c"
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",292,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 292 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 292 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }

    if (ktype != EC_KEY_PRINT_PARAM && EC_KEY_get0_public_key(x) != 
# 296 "../crypto/ec/ec_ameth.c" 3 4
                                                                   ((void *)0)
# 296 "../crypto/ec/ec_ameth.c"
                                                                       ) {
        publen = EC_KEY_key2buf(x, EC_KEY_get_conv_form(x), &pub, 
# 297 "../crypto/ec/ec_ameth.c" 3 4
                                                                 ((void *)0)
# 297 "../crypto/ec/ec_ameth.c"
                                                                     );
        if (publen == 0)
            goto err;
    }

    if (ktype == EC_KEY_PRINT_PRIVATE && EC_KEY_get0_private_key(x) != 
# 302 "../crypto/ec/ec_ameth.c" 3 4
                                                                      ((void *)0)
# 302 "../crypto/ec/ec_ameth.c"
                                                                          ) {
 ...
 err:
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",340,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 340 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 340 "../crypto/ec/ec_ameth.c"
       );
    CRYPTO_clear_free(priv, privlen, "../crypto/ec/ec_ameth.c", 341);
    CRYPTO_free(pub, "../crypto/ec/ec_ameth.c", 342);
    return ret;
}
...
# 351 "../crypto/ec/ec_ameth.c" 3 4
                                 ((void *)0)
# 351 "../crypto/ec/ec_ameth.c"
                                     , pder, derlen)) == 
# 351 "../crypto/ec/ec_ameth.c" 3 4
                                                         ((void *)0)
# 351 "../crypto/ec/ec_ameth.c"
...
# 385 "../crypto/ec/ec_ameth.c" 3 4
                              ((void *)0)
# 385 "../crypto/ec/ec_ameth.c"
                                  , pder, derlen)) == 
# 385 "../crypto/ec/ec_ameth.c" 3 4
                                                      ((void *)0)
# 385 "../crypto/ec/ec_ameth.c"
...
static int ec_pkey_ctrl(EVP_PKEY *pkey, int op, long arg1, void *arg2)
{
    ...
    case 0x9:
        ...
        if (!__builtin_expect(!!((((pkey)->type != 0 && (pkey)->keymgmt == 
# 410 "../crypto/ec/ec_ameth.c" 3 4
            ((void *)0)
# 410 "../crypto/ec/ec_ameth.c"
            )) != 0), 1))
            return 0;
        return EC_KEY_oct2key(evp_pkey_get0_EC_KEY_int(pkey), arg2, arg1, 
# 412 "../crypto/ec/ec_ameth.c" 3 4
                                                                         ((void *)0)
# 412 "../crypto/ec/ec_ameth.c"
                                                                             );

    case 0xa:
        return EC_KEY_key2buf(EVP_PKEY_get0_EC_KEY(pkey),
                              POINT_CONVERSION_UNCOMPRESSED, arg2, 
# 416 "../crypto/ec/ec_ameth.c" 3 4
                                                                  ((void *)0)
# 416 "../crypto/ec/ec_ameth.c"
                                                                      );
...
static int ec_pkey_check(const EVP_PKEY *pkey)
{
    ...
    if (eckey->priv_key == 
# 428 "../crypto/ec/ec_ameth.c" 3 4
                          ((void *)0)
# 428 "../crypto/ec/ec_ameth.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",429,__func__), ERR_set_error)((16),(125),
# 429 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 429 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }
...
static int ec_pkey_param_check(const EVP_PKEY *pkey)
{
    ...
    if (eckey->group == 
# 457 "../crypto/ec/ec_ameth.c" 3 4
                       ((void *)0)
# 457 "../crypto/ec/ec_ameth.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",458,__func__), ERR_set_error)((16),(124),
# 458 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 458 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }

    return EC_GROUP_check(eckey->group, 
# 462 "../crypto/ec/ec_ameth.c" 3 4
                                       ((void *)0)
# 462 "../crypto/ec/ec_ameth.c"
                                           );
}
...
{
    const EC_KEY *eckey = 
# 476 "../crypto/ec/ec_ameth.c" 3 4
                         ((void *)0)
# 476 "../crypto/ec/ec_ameth.c"
                             ;
    const EC_GROUP *ecg = 
# 477 "../crypto/ec/ec_ameth.c" 3 4
                         ((void *)0)
# 477 "../crypto/ec/ec_ameth.c"
                             ;
    unsigned char *pub_key_buf = 
# 478 "../crypto/ec/ec_ameth.c" 3 4
                                ((void *)0)
# 478 "../crypto/ec/ec_ameth.c"
                                    , *gen_buf = 
# 478 "../crypto/ec/ec_ameth.c" 3 4
                                                 ((void *)0)
# 478 "../crypto/ec/ec_ameth.c"
    ...
    OSSL_PARAM_BLD *tmpl;
    OSSL_PARAM *params = 
# 481 "../crypto/ec/ec_ameth.c" 3 4
                        ((void *)0)
# 481 "../crypto/ec/ec_ameth.c"
                            ;
    const BIGNUM *priv_key = 
# 482 "../crypto/ec/ec_ameth.c" 3 4
                            ((void *)0)
# 482 "../crypto/ec/ec_ameth.c"
                                ;
    const EC_POINT *pub_point = 
# 483 "../crypto/ec/ec_ameth.c" 3 4
                               ((void *)0)
# 483 "../crypto/ec/ec_ameth.c"
                                   ;
    int selection = 0;
    int rv = 0;
    BN_CTX *bnctx = 
# 486 "../crypto/ec/ec_ameth.c" 3 4
                   ((void *)0)
# 486 "../crypto/ec/ec_ameth.c"
                       ;

    if (from == 
# 488 "../crypto/ec/ec_ameth.c" 3 4
               ((void *)0)
            
# 489 "../crypto/ec/ec_ameth.c"
           || (eckey = from->pkey.ec) == 
# 489 "../crypto/ec/ec_ameth.c" 3 4
                                         ((void *)0)
            
# 490 "../crypto/ec/ec_ameth.c"
           || (ecg = EC_KEY_get0_group(eckey)) == 
# 490 "../crypto/ec/ec_ameth.c" 3 4
                                                  ((void *)0)
# 490 "../crypto/ec/ec_ameth.c"
                                                      )
        return 0;
    ...
    if (tmpl == 
# 494 "../crypto/ec/ec_ameth.c" 3 4
               ((void *)0)
# 494 "../crypto/ec/ec_ameth.c"
                   )
        return 0;
    ...
    if (bnctx == 
# 502 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0)
# 502 "../crypto/ec/ec_ameth.c"
                    )
        goto err;
    BN_CTX_start(bnctx);


    if (!ossl_ec_group_todata(ecg, tmpl, 
# 507 "../crypto/ec/ec_ameth.c" 3 4
                                        ((void *)0)
# 507 "../crypto/ec/ec_ameth.c"
                                            , libctx, propq, bnctx, &gen_buf))
        goto err;
    selection |= 0x04;
    ...
    if (pub_point != 
# 514 "../crypto/ec/ec_ameth.c" 3 4
                    ((void *)0)
# 514 "../crypto/ec/ec_ameth.c"
                        ) {
    ...
    if (priv_key != 
# 529 "../crypto/ec/ec_ameth.c" 3 4
                   ((void *)0)
# 529 "../crypto/ec/ec_ameth.c"
                       ) {
        size_t sz;
        int ecbits;
        int ecdh_cofactor_mode;
# 567 "../crypto/ec/ec_ameth.c"
        ...
        ecdh_cofactor_mode =
            (EC_KEY_get_flags(eckey) & 0x1000) ? 1 : 0;
 ...
 err:
    ...
    CRYPTO_free(pub_key_buf, "../crypto/ec/ec_ameth.c", 602);
    CRYPTO_free(gen_buf, "../crypto/ec/ec_ameth.c", 603);
    BN_CTX_end(bnctx);
    BN_CTX_free(bnctx);
    return rv;
}
...
static int ec_pkey_import_from(const OSSL_PARAM params[], void *vpctx)
{
    ...
    if (ec == 
# 615 "../crypto/ec/ec_ameth.c" 3 4
             ((void *)0)
# 615 "../crypto/ec/ec_ameth.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_ameth.c",616,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 616 "../crypto/ec/ec_ameth.c" 3 4
       ((void *)0)
# 616 "../crypto/ec/ec_ameth.c"
       );
        return 0;
    }
...
static int ec_pkey_copy(EVP_PKEY *to, EVP_PKEY *from)
{
    ...
    EC_KEY *dupkey = 
# 633 "../crypto/ec/ec_ameth.c" 3 4
                    ((void *)0)
# 633 "../crypto/ec/ec_ameth.c"
                        ;
    int ret;

    if (eckey != 
# 636 "../crypto/ec/ec_ameth.c" 3 4
                ((void *)0)
# 636 "../crypto/ec/ec_ameth.c"
                    ) {
        dupkey = EC_KEY_dup(eckey);
        if (dupkey == 
# 638 "../crypto/ec/ec_ameth.c" 3 4
                     ((void *)0)
# 638 "../crypto/ec/ec_ameth.c"
                         )
            return 0;
    } else {
    ...
    ret = EVP_PKEY_assign((to), 408, (dupkey));
    if (!ret)
        EC_KEY_free(dupkey);
    return ret;
}
...
# 663 "../crypto/ec/ec_ameth.c" 3 4
   ((void *)0)
# 663 "../crypto/ec/ec_ameth.c"
       ,
    eckey_priv_encode,
    eckey_priv_print,
...
{
    int private = EC_KEY_get0_private_key(x) != 
# 712 "../crypto/ec/ec_ameth.c" 3 4
                                               ((void *)0)
# 712 "../crypto/ec/ec_ameth.c"
                                                   ;
