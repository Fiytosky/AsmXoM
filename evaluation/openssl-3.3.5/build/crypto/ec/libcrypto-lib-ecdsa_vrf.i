# 0 "../crypto/ec/ecdsa_vrf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecdsa_vrf.c"
# 14 "../crypto/ec/ecdsa_vrf.c"
...
# 18 "../crypto/ec/ecdsa_vrf.c" 2
# 26 "../crypto/ec/ecdsa_vrf.c"
int ECDSA_do_verify(const unsigned char *dgst, int dgst_len,
                    const ECDSA_SIG *sig, EC_KEY *eckey)
{
    if (eckey->meth->verify_sig != 
# 29 "../crypto/ec/ecdsa_vrf.c" 3 4
                                  ((void *)0)
# 29 "../crypto/ec/ecdsa_vrf.c"
                                      )
        return eckey->meth->verify_sig(dgst, dgst_len, sig, eckey);
    (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_vrf.c",31,__func__), ERR_set_error)((16),(152),
# 31 "../crypto/ec/ecdsa_vrf.c" 3 4
   ((void *)0)
# 31 "../crypto/ec/ecdsa_vrf.c"
   );
    return -1;
}
...
# 44 "../crypto/ec/ecdsa_vrf.c" 3 4
                              ((void *)0)
# 44 "../crypto/ec/ecdsa_vrf.c"
                                  )
        return eckey->meth->verify(type, dgst, dgst_len, sigbuf, sig_len,
                                   eckey);
    (ERR_new(), ERR_set_debug("../crypto/ec/ecdsa_vrf.c",47,__func__), ERR_set_error)((16),(152),
# 47 "../crypto/ec/ecdsa_vrf.c" 3 4
   ((void *)0)
# 47 "../crypto/ec/ecdsa_vrf.c"
   );
    return -1;
}
