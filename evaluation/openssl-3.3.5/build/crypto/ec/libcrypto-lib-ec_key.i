# 0 "../crypto/ec/ec_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_key.c"
# 15 "../crypto/ec/ec_key.c"
...
# 27 "../crypto/ec/ec_key.c" 2
# 1 "../providers/implementations/include/prov/ecx.h" 1
# 27 "../providers/implementations/include/prov/ecx.h"
...
# 36 "../crypto/ec/ec_key.c" 3 4
                                     ((void *)0)
# 36 "../crypto/ec/ec_key.c"
                                         , 
# 36 "../crypto/ec/ec_key.c" 3 4
                                           ((void *)0)
# 36 "../crypto/ec/ec_key.c"
...
# 42 "../crypto/ec/ec_key.c" 3 4
                                                 ((void *)0)
# 42 "../crypto/ec/ec_key.c"
                                                     );
}
                                    ...
                                    int nid)
{
    ...
    if (ret == 
# 49 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 49 "../crypto/ec/ec_key.c"
                  )
        return 
# 50 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 50 "../crypto/ec/ec_key.c"
                  ;
    ret->group = EC_GROUP_new_by_curve_name_ex(ctx, propq, nid);
    if (ret->group == 
# 52 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 52 "../crypto/ec/ec_key.c"
                         ) {
        EC_KEY_free(ret);
        return 
# 54 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 54 "../crypto/ec/ec_key.c"
                  ;
    }
    if (ret->meth->set_group != 
# 56 "../crypto/ec/ec_key.c" 3 4
                               ((void *)0)
        
# 57 "../crypto/ec/ec_key.c"
       && ret->meth->set_group(ret, ret->group) == 0) {
        EC_KEY_free(ret);
        return 
# 59 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 59 "../crypto/ec/ec_key.c"
                  ;
    }
    return ret;
}
...
{
    return EC_KEY_new_by_curve_name_ex(
# 67 "../crypto/ec/ec_key.c" 3 4
                                      ((void *)0)
# 67 "../crypto/ec/ec_key.c"
                                          , 
# 67 "../crypto/ec/ec_key.c" 3 4
                                            ((void *)0)
# 67 "../crypto/ec/ec_key.c"
...
void EC_KEY_free(EC_KEY *r)
{
    ...
    if (r == 
# 75 "../crypto/ec/ec_key.c" 3 4
            ((void *)0)
# 75 "../crypto/ec/ec_key.c"
                )
        return;
    ...
    if (r->meth != 
# 84 "../crypto/ec/ec_key.c" 3 4
                  ((void *)0) 
# 84 "../crypto/ec/ec_key.c"
                       && r->meth->finish != 
# 84 "../crypto/ec/ec_key.c" 3 4
                                             ((void *)0)
# 84 "../crypto/ec/ec_key.c"
    ...
    CRYPTO_free(r->propq, "../crypto/ec/ec_key.c", 101);

    CRYPTO_clear_free((void *)r, sizeof(EC_KEY), "../crypto/ec/ec_key.c", 103);
}

EC_KEY *EC_KEY_copy(EC_KEY *dest, const EC_KEY *src)
{
    if (dest == 
# 108 "../crypto/ec/ec_key.c" 3 4
               ((void *)0) 
...
# 108 "../crypto/ec/ec_key.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",109,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 109 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 109 "../crypto/ec/ec_key.c"
       );
        return 
# 110 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 110 "../crypto/ec/ec_key.c"
                  ;
    }
    if (src->meth != dest->meth) {
        if (dest->meth->finish != 
# 113 "../crypto/ec/ec_key.c" 3 4
                                 ((void *)0)
# 113 "../crypto/ec/ec_key.c"
                                     )
        ...
        if (ENGINE_finish(dest->engine) == 0)
            return 0;
        dest->engine = 
# 120 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 120 "../crypto/ec/ec_key.c"
                          ;
    ...
    if (src->group != 
# 125 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 125 "../crypto/ec/ec_key.c"
                         ) {
        ...
        dest->group = ossl_ec_group_new_ex(src->libctx, src->propq,
                                           src->group->meth);
        if (dest->group == 
# 130 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 130 "../crypto/ec/ec_key.c"
                              )
            return 
# 131 "../crypto/ec/ec_key.c" 3 4
                  ((void *)0)
# 131 "../crypto/ec/ec_key.c"
                      ;
        if (!EC_GROUP_copy(dest->group, src->group))
            return 
# 133 "../crypto/ec/ec_key.c" 3 4
                  ((void *)0)
# 133 "../crypto/ec/ec_key.c"
                      ;


        if (src->pub_key != 
# 136 "../crypto/ec/ec_key.c" 3 4
                           ((void *)0)
# 136 "../crypto/ec/ec_key.c"
                               ) {
            EC_POINT_free(dest->pub_key);
            dest->pub_key = EC_POINT_new(src->group);
            if (dest->pub_key == 
# 139 "../crypto/ec/ec_key.c" 3 4
                                ((void *)0)
# 139 "../crypto/ec/ec_key.c"
                                    )
                return 
# 140 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 140 "../crypto/ec/ec_key.c"
                          ;
            if (!EC_POINT_copy(dest->pub_key, src->pub_key))
                return 
# 142 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 142 "../crypto/ec/ec_key.c"
                          ;
        }

        if (src->priv_key != 
# 145 "../crypto/ec/ec_key.c" 3 4
                            ((void *)0)
# 145 "../crypto/ec/ec_key.c"
                                ) {
            if (dest->priv_key == 
# 146 "../crypto/ec/ec_key.c" 3 4
                                 ((void *)0)
# 146 "../crypto/ec/ec_key.c"
                                     ) {
                dest->priv_key = BN_new();
                if (dest->priv_key == 
# 148 "../crypto/ec/ec_key.c" 3 4
                                     ((void *)0)
# 148 "../crypto/ec/ec_key.c"
                                         )
                    return 
# 149 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 149 "../crypto/ec/ec_key.c"
                              ;
            }
            if (!BN_copy(dest->priv_key, src->priv_key))
                return 
# 152 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 152 "../crypto/ec/ec_key.c"
                          ;
            if (src->group->meth->keycopy
                && src->group->meth->keycopy(dest, src) == 0)
                return 
# 155 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 155 "../crypto/ec/ec_key.c"
                          ;
        }
    }
    ...
    if (!CRYPTO_dup_ex_data(8,
                            &dest->ex_data, &src->ex_data))
        return 
# 168 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 168 "../crypto/ec/ec_key.c"
    ...
    if (src->meth != dest->meth) {
        ...
        if (src->engine != 
# 173 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0) 
# 173 "../crypto/ec/ec_key.c"
                               && ENGINE_init(src->engine) == 0)
            return 
# 174 "../crypto/ec/ec_key.c" 3 4
                  ((void *)0)
# 174 "../crypto/ec/ec_key.c"
                      ;
    ...
    if (src->meth->copy != 
# 180 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0) 
# 180 "../crypto/ec/ec_key.c"
                               && src->meth->copy(dest, src) == 0)
        return 
# 181 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 181 "../crypto/ec/ec_key.c"
                  ;
...
{
    return ossl_ec_key_dup(ec_key, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ));
}
...
{
    if (eckey == 
# 212 "../crypto/ec/ec_key.c" 3 4
                ((void *)0) 
# 212 "../crypto/ec/ec_key.c"
                     || eckey->group == 
# 212 "../crypto/ec/ec_key.c" 3 4
                                        ((void *)0)
# 212 "../crypto/ec/ec_key.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",213,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 213 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 213 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    if (eckey->meth->keygen != 
# 216 "../crypto/ec/ec_key.c" 3 4
                              ((void *)0)
# 216 "../crypto/ec/ec_key.c"
                                  ) {
        int ret;
    ...
    (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",225,__func__), ERR_set_error)((16),(152),
# 225 "../crypto/ec/ec_key.c" 3 4
   ((void *)0)
# 225 "../crypto/ec/ec_key.c"
   );
    return 0;
}
...
# 253 "../crypto/ec/ec_key.c"
static int ecdsa_keygen_knownanswer_test(EC_KEY *eckey, BN_CTX *ctx,
                                         OSSL_CALLBACK *cb, void *cbarg)
{
    int len, ret = 0;
    OSSL_SELF_TEST *st = 
# 257 "../crypto/ec/ec_key.c" 3 4
                        ((void *)0)
# 257 "../crypto/ec/ec_key.c"
                            ;
    unsigned char bytes[512] = {0};
    EC_POINT *pub_key2 = 
# 259 "../crypto/ec/ec_key.c" 3 4
                        ((void *)0)
# 259 "../crypto/ec/ec_key.c"
                            ;

    st = OSSL_SELF_TEST_new(cb, cbarg);
    if (st == 
# 262 "../crypto/ec/ec_key.c" 3 4
             ((void *)0)
# 262 "../crypto/ec/ec_key.c"
                 )
        return 0;

    OSSL_SELF_TEST_onbegin(st, "Conditional_KAT",
                               "ECDSA");

    if ((pub_key2 = EC_POINT_new(eckey->group)) == 
# 268 "../crypto/ec/ec_key.c" 3 4
                                                  ((void *)0)
# 268 "../crypto/ec/ec_key.c"
                                                      )
        goto err;


    if (!EC_POINT_mul(eckey->group, pub_key2, eckey->priv_key, 
# 272 "../crypto/ec/ec_key.c" 3 4
                                                              ((void *)0)
# 272 "../crypto/ec/ec_key.c"
                                                                  , 
# 272 "../crypto/ec/ec_key.c" 3 4
                                                                    ((void *)0)
# 272 "../crypto/ec/ec_key.c"
    ...
    if (((BN_num_bits(pub_key2->X)+7)/8) > (int)sizeof(bytes))
        goto err;
    len = BN_bn2bin(pub_key2->X, bytes);
    if (OSSL_SELF_TEST_oncorrupt_byte(st, bytes)
            && BN_bin2bn(bytes, len, pub_key2->X) == 
# 279 "../crypto/ec/ec_key.c" 3 4
                                                    ((void *)0)
# 279 "../crypto/ec/ec_key.c"
                                                        )
        goto err;
...
# 302 "../crypto/ec/ec_key.c"
static int ec_generate_key(EC_KEY *eckey, int pairwise_test)
{
    int ok = 0;
    BIGNUM *priv_key = 
# 305 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 305 "../crypto/ec/ec_key.c"
                          ;
    const BIGNUM *tmp = 
# 306 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 306 "../crypto/ec/ec_key.c"
                           ;
    BIGNUM *order = 
# 307 "../crypto/ec/ec_key.c" 3 4
                   ((void *)0)
# 307 "../crypto/ec/ec_key.c"
                       ;
    EC_POINT *pub_key = 
# 308 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 308 "../crypto/ec/ec_key.c"
                           ;
    const EC_GROUP *group = eckey->group;
    BN_CTX *ctx = BN_CTX_secure_new_ex(eckey->libctx);
    int sm2 = EC_KEY_get_flags(eckey) & 0x0004 ? 1 : 0;

    if (ctx == 
# 313 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 313 "../crypto/ec/ec_key.c"
                  )
        goto err;

    if (eckey->priv_key == 
# 316 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 316 "../crypto/ec/ec_key.c"
                              ) {
        priv_key = BN_secure_new();
        if (priv_key == 
# 318 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 318 "../crypto/ec/ec_key.c"
                           )
            goto err;
    } else
    ...
    if (tmp == 
# 330 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 330 "../crypto/ec/ec_key.c"
                  )
        goto err;
# 343 "../crypto/ec/ec_key.c"
    if (sm2) {
        order = BN_new();
        if (order == 
# 345 "../crypto/ec/ec_key.c" 3 4
                    ((void *)0) 
# 345 "../crypto/ec/ec_key.c"
                         || !BN_sub(order, tmp, BN_value_one()))
            goto err;
    } else {
        order = BN_dup(tmp);
        if (order == 
# 349 "../crypto/ec/ec_key.c" 3 4
                    ((void *)0)
# 349 "../crypto/ec/ec_key.c"
                        )
            goto err;
    }
    ...
    if (eckey->pub_key == 
# 358 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 358 "../crypto/ec/ec_key.c"
                             ) {
        pub_key = EC_POINT_new(group);
        if (pub_key == 
# 360 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 360 "../crypto/ec/ec_key.c"
                          )
            goto err;
    } else
...
# 366 "../crypto/ec/ec_key.c" 3 4
                                               ((void *)0)
# 366 "../crypto/ec/ec_key.c"
                                                   , 
# 366 "../crypto/ec/ec_key.c" 3 4
                                                     ((void *)0)
# 366 "../crypto/ec/ec_key.c"
    ...
    priv_key = 
# 371 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 371 "../crypto/ec/ec_key.c"
                  ;
    pub_key = 
# 372 "../crypto/ec/ec_key.c" 3 4
             ((void *)0)
# 372 "../crypto/ec/ec_key.c"
                 ;
    ...
    if (pairwise_test) {
        OSSL_CALLBACK *cb = 
# 382 "../crypto/ec/ec_key.c" 3 4
                           ((void *)0)
# 382 "../crypto/ec/ec_key.c"
                               ;
        void *cbarg = 
# 383 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 383 "../crypto/ec/ec_key.c"
                         ;
...
err:
    ...
    if (!ok) {
        ...
        if (eckey->pub_key != 
# 394 "../crypto/ec/ec_key.c" 3 4
                             ((void *)0)
# 394 "../crypto/ec/ec_key.c"
                                 )
                               ...
                               const unsigned char *ikm, size_t ikmlen)
{
    ...
    if (eckey->priv_key == 
# 415 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 415 "../crypto/ec/ec_key.c"
                              ) {
        eckey->priv_key = BN_secure_new();
        if (eckey->priv_key == 
# 417 "../crypto/ec/ec_key.c" 3 4
                              ((void *)0)
# 417 "../crypto/ec/ec_key.c"
                                  )
            goto err;
    }
    if (ossl_ec_dhkem_derive_private(eckey, eckey->priv_key, ikm, ikmlen) <= 0)
        goto err;
    if (eckey->pub_key == 
# 422 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 422 "../crypto/ec/ec_key.c"
                             ) {
        eckey->pub_key = EC_POINT_new(eckey->group);
        if (eckey->pub_key == 
# 424 "../crypto/ec/ec_key.c" 3 4
                             ((void *)0)
# 424 "../crypto/ec/ec_key.c"
                                 )
            goto err;
    }
...
err:
    if (!ok) {
        ...
        eckey->priv_key = 
# 434 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 434 "../crypto/ec/ec_key.c"
                             ;
        if (eckey->pub_key != 
# 435 "../crypto/ec/ec_key.c" 3 4
                             ((void *)0)
# 435 "../crypto/ec/ec_key.c"
                                 )
...
int ossl_ec_key_simple_generate_public_key(EC_KEY *eckey)
{
    ...
    if (ctx == 
# 452 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 452 "../crypto/ec/ec_key.c"
                  )
        return 0;
    ...
    ret = EC_POINT_mul(eckey->group, eckey->pub_key, eckey->priv_key, 
# 459 "../crypto/ec/ec_key.c" 3 4
                                                                     ((void *)0)
# 459 "../crypto/ec/ec_key.c"
                                                                         ,
                       
# 460 "../crypto/ec/ec_key.c" 3 4
                      ((void *)0)
# 460 "../crypto/ec/ec_key.c"
                          , ctx);
...
{
    if (eckey == 
# 471 "../crypto/ec/ec_key.c" 3 4
                ((void *)0) 
# 471 "../crypto/ec/ec_key.c"
                     || eckey->group == 
# 471 "../crypto/ec/ec_key.c" 3 4
                                        ((void *)0) 
# 471 "../crypto/ec/ec_key.c"
...
# 471 "../crypto/ec/ec_key.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",472,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 472 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 472 "../crypto/ec/ec_key.c"
       );
        return 0;
    }

    if (eckey->group->meth->keycheck == 
# 476 "../crypto/ec/ec_key.c" 3 4
                                       ((void *)0)
# 476 "../crypto/ec/ec_key.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",477,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 477 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 477 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
...
static int ec_key_public_range_check(BN_CTX *ctx, const EC_KEY *key)
{
    ...
    y = BN_CTX_get(ctx);
    if (y == 
# 501 "../crypto/ec/ec_key.c" 3 4
            ((void *)0)
# 501 "../crypto/ec/ec_key.c"
                )
        goto err;
    ...
    if (EC_GROUP_get_field_type(key->group) == 406) {
        if (BN_is_negative(x)
...
{
    if (eckey == 
# 532 "../crypto/ec/ec_key.c" 3 4
                ((void *)0) 
# 532 "../crypto/ec/ec_key.c"
                     || eckey->group == 
# 532 "../crypto/ec/ec_key.c" 3 4
                                        ((void *)0) 
# 532 "../crypto/ec/ec_key.c"
...
# 532 "../crypto/ec/ec_key.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",533,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 533 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 533 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    ...
    if (EC_POINT_is_at_infinity(eckey->group, eckey->pub_key)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",539,__func__), ERR_set_error)((16),(106),
# 539 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 539 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    ...
    if (!ec_key_public_range_check(ctx, eckey)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",545,__func__), ERR_set_error)((16),(146),
# 545 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 545 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    ...
    if (EC_POINT_is_on_curve(eckey->group, eckey->pub_key, ctx) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",551,__func__), ERR_set_error)((16),(107),
# 551 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 551 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    return 1;
...
int ossl_ec_key_public_check(const EC_KEY *eckey, BN_CTX *ctx)
{
    int ret = 0;
    EC_POINT *point = 
# 564 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 564 "../crypto/ec/ec_key.c"
                         ;
    const BIGNUM *order = 
# 565 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 565 "../crypto/ec/ec_key.c"
                             ;
    ...
    if (point == 
# 571 "../crypto/ec/ec_key.c" 3 4
                ((void *)0)
# 571 "../crypto/ec/ec_key.c"
                    )
        return 0;

    order = eckey->group->order;
    if (BN_is_zero(order)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",576,__func__), ERR_set_error)((16),(122),
# 576 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 576 "../crypto/ec/ec_key.c"
       );
        goto err;
    }

    if (!EC_POINT_mul(eckey->group, point, 
# 580 "../crypto/ec/ec_key.c" 3 4
                                          ((void *)0)
# 580 "../crypto/ec/ec_key.c"
                                              , eckey->pub_key, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",581,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 581 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 581 "../crypto/ec/ec_key.c"
       );
        goto err;
    }
    if (!EC_POINT_is_at_infinity(eckey->group, point)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",585,__func__), ERR_set_error)((16),(130),
# 585 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 585 "../crypto/ec/ec_key.c"
       );
        goto err;
    }
    ret = 1;
...
{
    if (eckey == 
# 601 "../crypto/ec/ec_key.c" 3 4
                ((void *)0) 
# 601 "../crypto/ec/ec_key.c"
                     || eckey->group == 
# 601 "../crypto/ec/ec_key.c" 3 4
                                        ((void *)0) 
# 601 "../crypto/ec/ec_key.c"
...
# 601 "../crypto/ec/ec_key.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",602,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 602 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 602 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    if (BN_cmp(eckey->priv_key, BN_value_one()) < 0
        || BN_cmp(eckey->priv_key, eckey->group->order) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",607,__func__), ERR_set_error)((16),(123),
# 607 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 607 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    return 1;
...
int ossl_ec_key_pairwise_check(const EC_KEY *eckey, BN_CTX *ctx)
{
    int ret = 0;
    EC_POINT *point = 
# 621 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 621 "../crypto/ec/ec_key.c"
                         ;

    if (eckey == 
# 623 "../crypto/ec/ec_key.c" 3 4
                ((void *)0)
       
# 624 "../crypto/ec/ec_key.c"
      || eckey->group == 
# 624 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
       
# 625 "../crypto/ec/ec_key.c"
      || eckey->pub_key == 
# 625 "../crypto/ec/ec_key.c" 3 4
                           ((void *)0)
       
# 626 "../crypto/ec/ec_key.c"
      || eckey->priv_key == 
# 626 "../crypto/ec/ec_key.c" 3 4
                            ((void *)0)
# 626 "../crypto/ec/ec_key.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",627,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 627 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 627 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    ...
    point = EC_POINT_new(eckey->group);
    if (point == 
# 632 "../crypto/ec/ec_key.c" 3 4
                ((void *)0)
# 632 "../crypto/ec/ec_key.c"
                    )
        goto err;


    if (!EC_POINT_mul(eckey->group, point, eckey->priv_key, 
# 636 "../crypto/ec/ec_key.c" 3 4
                                                           ((void *)0)
# 636 "../crypto/ec/ec_key.c"
                                                               , 
# 636 "../crypto/ec/ec_key.c" 3 4
                                                                 ((void *)0)
# 636 "../crypto/ec/ec_key.c"
                                                                     , ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",637,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 637 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 637 "../crypto/ec/ec_key.c"
       );
        goto err;
    }
    if (EC_POINT_cmp(eckey->group, point, eckey->pub_key, ctx) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",641,__func__), ERR_set_error)((16),(123),
# 641 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 641 "../crypto/ec/ec_key.c"
       );
        goto err;
    }
    ret = 1;
...
# 661 "../crypto/ec/ec_key.c"
int ossl_ec_key_simple_check_key(const EC_KEY *eckey)
{
    int ok = 0;
    BN_CTX *ctx = 
# 664 "../crypto/ec/ec_key.c" 3 4
                 ((void *)0)
# 664 "../crypto/ec/ec_key.c"
                     ;

    if (eckey == 
# 666 "../crypto/ec/ec_key.c" 3 4
                ((void *)0)
# 666 "../crypto/ec/ec_key.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",667,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 667 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 667 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    if ((ctx = BN_CTX_new_ex(eckey->libctx)) == 
# 670 "../crypto/ec/ec_key.c" 3 4
                                               ((void *)0)
# 670 "../crypto/ec/ec_key.c"
                                                   )
        return 0;
    ...
    if (eckey->priv_key != 
# 676 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 676 "../crypto/ec/ec_key.c"
                              ) {
...
{
    BN_CTX *ctx = 
# 690 "../crypto/ec/ec_key.c" 3 4
                 ((void *)0)
# 690 "../crypto/ec/ec_key.c"
                     ;
    BIGNUM *tx, *ty;
    EC_POINT *point = 
# 692 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 692 "../crypto/ec/ec_key.c"
                         ;
    int ok = 0;

    if (key == 
# 695 "../crypto/ec/ec_key.c" 3 4
              ((void *)0) 
# 695 "../crypto/ec/ec_key.c"
                   || key->group == 
# 695 "../crypto/ec/ec_key.c" 3 4
                                    ((void *)0) 
# 695 "../crypto/ec/ec_key.c"
...
# 695 "../crypto/ec/ec_key.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",696,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 696 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 696 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    ctx = BN_CTX_new_ex(key->libctx);
    if (ctx == 
# 700 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 700 "../crypto/ec/ec_key.c"
                  )
        return 0;
    ...
    if (point == 
# 706 "../crypto/ec/ec_key.c" 3 4
                ((void *)0)
# 706 "../crypto/ec/ec_key.c"
                    )
        goto err;
    ...
    ty = BN_CTX_get(ctx);
    if (ty == 
# 711 "../crypto/ec/ec_key.c" 3 4
             ((void *)0)
# 711 "../crypto/ec/ec_key.c"
                 )
        goto err;
    ...
    if (BN_cmp(x, tx) || BN_cmp(y, ty)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",724,__func__), ERR_set_error)((16),(146),
# 724 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 724 "../crypto/ec/ec_key.c"
       );
        goto err;
    }
...
{
    if (key->meth->set_group != 
# 768 "../crypto/ec/ec_key.c" 3 4
                               ((void *)0) 
# 768 "../crypto/ec/ec_key.c"
                                    && key->meth->set_group(key, group) == 0)
        return 0;
    EC_GROUP_free(key->group);
    key->group = EC_GROUP_dup(group);
    if (key->group != 
# 772 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0) 
# 772 "../crypto/ec/ec_key.c"
                          && EC_GROUP_get_curve_name(key->group) == 1172)
        EC_KEY_set_flags(key, 0x0004);

    key->dirty_cnt++;
    return (key->group == 
# 776 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 776 "../crypto/ec/ec_key.c"
                             ) ? 0 : 1;
}
...
int EC_KEY_set_private_key(EC_KEY *key, const BIGNUM *priv_key)
{
    int fixed_top;
    const BIGNUM *order = 
# 787 "../crypto/ec/ec_key.c" 3 4
                         ((void *)0)
# 787 "../crypto/ec/ec_key.c"
                             ;
    BIGNUM *tmp_key = 
# 788 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 788 "../crypto/ec/ec_key.c"
                         ;

    if (key->group == 
# 790 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0) 
# 790 "../crypto/ec/ec_key.c"
                          || key->group->meth == 
# 790 "../crypto/ec/ec_key.c" 3 4
                                                 ((void *)0)
# 790 "../crypto/ec/ec_key.c"
        ...
        return 0;
# 801 "../crypto/ec/ec_key.c"
    order = EC_GROUP_get0_order(key->group);
    if (order == 
# 802 "../crypto/ec/ec_key.c" 3 4
                ((void *)0) 
# 802 "../crypto/ec/ec_key.c"
                     || BN_is_zero(order))
        return 0;

    if (key->group->meth->set_private != 
# 805 "../crypto/ec/ec_key.c" 3 4
                                        ((void *)0)
        
# 806 "../crypto/ec/ec_key.c"
       && key->group->meth->set_private(key, priv_key) == 0)
        return 0;
    if (key->meth->set_private != 
# 808 "../crypto/ec/ec_key.c" 3 4
                                 ((void *)0)
        
# 809 "../crypto/ec/ec_key.c"
    ...
    if (priv_key == 
# 816 "../crypto/ec/ec_key.c" 3 4
                   ((void *)0)
# 816 "../crypto/ec/ec_key.c"
                       ) {
        BN_clear_free(key->priv_key);
        key->priv_key = 
# 818 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 818 "../crypto/ec/ec_key.c"
                           ;
        return 0;
    }
# 860 "../crypto/ec/ec_key.c"
    tmp_key = BN_dup(priv_key);
    if (tmp_key == 
# 861 "../crypto/ec/ec_key.c" 3 4
                  ((void *)0)
# 861 "../crypto/ec/ec_key.c"
                      )
        return 0;

    BN_set_flags(tmp_key, 0x04);

    fixed_top = bn_get_top(order) + 2;
    if (bn_wexpand(tmp_key, fixed_top) == 
# 867 "../crypto/ec/ec_key.c" 3 4
                                         ((void *)0)
# 867 "../crypto/ec/ec_key.c"
                                             ) {
...
{
    if (key->meth->set_public != 
# 886 "../crypto/ec/ec_key.c" 3 4
                                ((void *)0)
        
# 887 "../crypto/ec/ec_key.c"
    ...
    key->dirty_cnt++;
    return (key->pub_key == 
# 892 "../crypto/ec/ec_key.c" 3 4
                           ((void *)0)
# 892 "../crypto/ec/ec_key.c"
                               ) ? 0 : 1;
}
...
void EC_KEY_set_conv_form(EC_KEY *key, point_conversion_form_t cform)
{
    key->conv_form = cform;
    if (key->group != 
# 913 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 913 "../crypto/ec/ec_key.c"
                         )
...
{
    if (key->group != 
# 919 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 919 "../crypto/ec/ec_key.c"
                         )
...
{
    if (key->group == 
# 926 "../crypto/ec/ec_key.c" 3 4
                     ((void *)0)
# 926 "../crypto/ec/ec_key.c"
                         )
        return 0;
...
{
    if (key == 
# 951 "../crypto/ec/ec_key.c" 3 4
              ((void *)0) 
# 951 "../crypto/ec/ec_key.c"
                   || key->group == 
# 951 "../crypto/ec/ec_key.c" 3 4
                                    ((void *)0)
# 951 "../crypto/ec/ec_key.c"
...
{
    if (key == 
# 959 "../crypto/ec/ec_key.c" 3 4
              ((void *)0) 
# 959 "../crypto/ec/ec_key.c"
                   || key->pub_key == 
# 959 "../crypto/ec/ec_key.c" 3 4
                                      ((void *)0) 
# 959 "../crypto/ec/ec_key.c"
...
{
    if (key == 
# 967 "../crypto/ec/ec_key.c" 3 4
              ((void *)0) 
# 967 "../crypto/ec/ec_key.c"
                   || key->group == 
# 967 "../crypto/ec/ec_key.c" 3 4
                                    ((void *)0)
# 967 "../crypto/ec/ec_key.c"
        ...
        return 0;
    if (key->pub_key == 
# 969 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 969 "../crypto/ec/ec_key.c"
                           )
        key->pub_key = EC_POINT_new(key->group);
    if (key->pub_key == 
# 971 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0)
# 971 "../crypto/ec/ec_key.c"
                           )
        return 0;
...
{
    if (eckey->group == 
# 991 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0) 
# 991 "../crypto/ec/ec_key.c"
                            || eckey->group->meth == 
# 991 "../crypto/ec/ec_key.c" 3 4
                                                     ((void *)0)
# 991 "../crypto/ec/ec_key.c"
...
# 993 "../crypto/ec/ec_key.c" 3 4
                                       ((void *)0)
# 993 "../crypto/ec/ec_key.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",994,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 994 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 994 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
                                   ...
                                   unsigned char *buf, size_t len)
{
    ...
    if (eckey->priv_key == 
# 1007 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 1007 "../crypto/ec/ec_key.c"
                              )
        return 0;
    if (buf == 
# 1009 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 1009 "../crypto/ec/ec_key.c"
                  )
        return buf_len;
    else if (len < buf_len)
        return 0;
    ...
    if (BN_bn2binpad(eckey->priv_key, buf, buf_len) == -1) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",1017,__func__), ERR_set_error)((16),(100),
# 1017 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 1017 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
...
int EC_KEY_oct2priv(EC_KEY *eckey, const unsigned char *buf, size_t len)
{
    ...
    if (eckey->group == 
# 1028 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0) 
# 1028 "../crypto/ec/ec_key.c"
                            || eckey->group->meth == 
# 1028 "../crypto/ec/ec_key.c" 3 4
                                                     ((void *)0)
# 1028 "../crypto/ec/ec_key.c"
...
# 1030 "../crypto/ec/ec_key.c" 3 4
                                       ((void *)0)
# 1030 "../crypto/ec/ec_key.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",1031,__func__), ERR_set_error)((16),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1031 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 1031 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
...
{
    if (eckey->priv_key == 
# 1043 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 1043 "../crypto/ec/ec_key.c"
                              )
        eckey->priv_key = BN_secure_new();
    if (eckey->priv_key == 
# 1045 "../crypto/ec/ec_key.c" 3 4
                          ((void *)0)
# 1045 "../crypto/ec/ec_key.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",1046,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1046 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 1046 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    if (BN_bin2bn(buf, len, eckey->priv_key) == 
# 1049 "../crypto/ec/ec_key.c" 3 4
                                               ((void *)0)
# 1049 "../crypto/ec/ec_key.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_key.c",1050,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 1050 "../crypto/ec/ec_key.c" 3 4
       ((void *)0)
# 1050 "../crypto/ec/ec_key.c"
       );
        return 0;
    }
    eckey->dirty_cnt++;
...
size_t EC_KEY_priv2buf(const EC_KEY *eckey, unsigned char **pbuf)
{
    ...
    len = EC_KEY_priv2oct(eckey, 
# 1062 "../crypto/ec/ec_key.c" 3 4
                                ((void *)0)
# 1062 "../crypto/ec/ec_key.c"
                                    , 0);
    if (len == 0)
        return 0;
    if ((buf = CRYPTO_malloc(len, "../crypto/ec/ec_key.c", 1065)) == 
# 1065 "../crypto/ec/ec_key.c" 3 4
                                      ((void *)0)
# 1065 "../crypto/ec/ec_key.c"
                                          )
        return 0;
    len = EC_KEY_priv2oct(eckey, buf, len);
    if (len == 0) {
        CRYPTO_free(buf, "../crypto/ec/ec_key.c", 1069);
        return 0;
    }
    *pbuf = buf;
    return len;
...
{
    if (eckey->group == 
# 1078 "../crypto/ec/ec_key.c" 3 4
                       ((void *)0) 
# 1078 "../crypto/ec/ec_key.c"
                            || eckey->group->meth == 
# 1078 "../crypto/ec/ec_key.c" 3 4
                                                     ((void *)0)
        
# 1079 "../crypto/ec/ec_key.c"
       || (eckey->group->meth->flags & 0x4))
        return 0;
    return 1;
}
# 1093 "../crypto/ec/ec_key.c"
static int ecdsa_keygen_pairwise_test(EC_KEY *eckey, OSSL_CALLBACK *cb,
                                      void *cbarg)
{
    int ret = 0;
    ...
    ECDSA_SIG *sig = 
# 1099 "../crypto/ec/ec_key.c" 3 4
                    ((void *)0)
# 1099 "../crypto/ec/ec_key.c"
                        ;
    OSSL_SELF_TEST *st = 
# 1100 "../crypto/ec/ec_key.c" 3 4
                        ((void *)0)
# 1100 "../crypto/ec/ec_key.c"
                            ;

    st = OSSL_SELF_TEST_new(cb, cbarg);
    if (st == 
# 1103 "../crypto/ec/ec_key.c" 3 4
             ((void *)0)
# 1103 "../crypto/ec/ec_key.c"
                 )
        return 0;

    OSSL_SELF_TEST_onbegin(st, "Conditional_PCT",
                           "ECDSA");

    sig = ECDSA_do_sign(dgst, dgst_len, eckey);
    if (sig == 
# 1110 "../crypto/ec/ec_key.c" 3 4
              ((void *)0)
# 1110 "../crypto/ec/ec_key.c"
                  )
        goto err;
