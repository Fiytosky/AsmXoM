# 0 "../crypto/ec/ecp_nist.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ecp_nist.c"
# 15 "../crypto/ec/ecp_nist.c"
                                     ...
                                     BN_CTX *ctx)
{
    int ret = 0;
    BN_CTX *new_ctx = 
# 97 "../crypto/ec/ecp_nist.c" 3 4
                     ((void *)0)
# 97 "../crypto/ec/ecp_nist.c"
                         ;

    if (ctx == 
# 99 "../crypto/ec/ecp_nist.c" 3 4
              ((void *)0)
# 99 "../crypto/ec/ecp_nist.c"
                  )
        if ((ctx = new_ctx = BN_CTX_new_ex(group->libctx)) == 
# 100 "../crypto/ec/ecp_nist.c" 3 4
                                                             ((void *)0)
# 100 "../crypto/ec/ecp_nist.c"
                                                                 )
            return 0;
    ...
    if (BN_ucmp(BN_get0_nist_prime_192(), p) == 0)
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nist.c",116,__func__), ERR_set_error)((16),(135),
# 116 "../crypto/ec/ecp_nist.c" 3 4
       ((void *)0)
                               ...
                               const BIGNUM *b, BN_CTX *ctx)
{
    int ret = 0;
    BN_CTX *ctx_new = 
# 132 "../crypto/ec/ecp_nist.c" 3 4
                     ((void *)0)
# 132 "../crypto/ec/ecp_nist.c"
                         ;

    if (!group || !r || !a || !b) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nist.c",135,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 135 "../crypto/ec/ecp_nist.c" 3 4
       ((void *)0)
# 135 "../crypto/ec/ecp_nist.c"
       );
        goto err;
    }
    if (!ctx)
        if ((ctx_new = ctx = BN_CTX_new_ex(group->libctx)) == 
# 139 "../crypto/ec/ecp_nist.c" 3 4
                                                             ((void *)0)
# 139 "../crypto/ec/ecp_nist.c"
                                                                 )
            goto err;
                               ...
                               BN_CTX *ctx)
{
    int ret = 0;
    BN_CTX *ctx_new = 
# 157 "../crypto/ec/ecp_nist.c" 3 4
                     ((void *)0)
# 157 "../crypto/ec/ecp_nist.c"
                         ;

    if (!group || !r || !a) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ecp_nist.c",160,__func__), ERR_set_error)((16),(134),
# 160 "../crypto/ec/ecp_nist.c" 3 4
       ((void *)0)
# 160 "../crypto/ec/ecp_nist.c"
       );
        goto err;
    }
    if (!ctx)
        if ((ctx_new = ctx = BN_CTX_new_ex(group->libctx)) == 
# 164 "../crypto/ec/ecp_nist.c" 3 4
                                                             ((void *)0)
# 164 "../crypto/ec/ecp_nist.c"
                                                                 )
            goto err;
