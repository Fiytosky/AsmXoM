# 0 "../crypto/ec/eck_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/eck_prn.c"
# 11 "../crypto/ec/eck_prn.c"
...
# 26 "../crypto/ec/eck_prn.c" 3 4
                                      ((void *)0)
# 26 "../crypto/ec/eck_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/eck_prn.c",27,__func__), ERR_set_error)((16),((7 | (0x2 << 18L))),
# 27 "../crypto/ec/eck_prn.c" 3 4
       ((void *)0)
# 27 "../crypto/ec/eck_prn.c"
       );
        return 0;
    }
...
int EC_KEY_print_fp(FILE *fp, const EC_KEY *x, int off)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 41 "../crypto/ec/eck_prn.c" 3 4
                                      ((void *)0)
# 41 "../crypto/ec/eck_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/eck_prn.c",42,__func__), ERR_set_error)((16),((32 | (0x2 << 18L))),
# 42 "../crypto/ec/eck_prn.c" 3 4
       ((void *)0)
# 42 "../crypto/ec/eck_prn.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
int ECParameters_print_fp(FILE *fp, const EC_KEY *x)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 56 "../crypto/ec/eck_prn.c" 3 4
                                      ((void *)0)
# 56 "../crypto/ec/eck_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/eck_prn.c",57,__func__), ERR_set_error)((16),((32 | (0x2 << 18L))),
# 57 "../crypto/ec/eck_prn.c" 3 4
       ((void *)0)
# 57 "../crypto/ec/eck_prn.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
{
    int ret = 0, reason = (32 | (0x2 << 18L));
    BN_CTX *ctx = 
# 73 "../crypto/ec/eck_prn.c" 3 4
                 ((void *)0)
# 73 "../crypto/ec/eck_prn.c"
                     ;
    const EC_POINT *point = 
# 74 "../crypto/ec/eck_prn.c" 3 4
                           ((void *)0)
# 74 "../crypto/ec/eck_prn.c"
                               ;
    BIGNUM *p = 
# 75 "../crypto/ec/eck_prn.c" 3 4
               ((void *)0)
# 75 "../crypto/ec/eck_prn.c"
                   , *a = 
# 75 "../crypto/ec/eck_prn.c" 3 4
                          ((void *)0)
# 75 "../crypto/ec/eck_prn.c"
...
# 76 "../crypto/ec/eck_prn.c" 3 4
                            ((void *)0)
# 76 "../crypto/ec/eck_prn.c"
                                ;
    const BIGNUM *order = 
# 77 "../crypto/ec/eck_prn.c" 3 4
                         ((void *)0)
# 77 "../crypto/ec/eck_prn.c"
                             , *cofactor = 
# 77 "../crypto/ec/eck_prn.c" 3 4
                                           ((void *)0)
# 77 "../crypto/ec/eck_prn.c"
    ...
    ctx = BN_CTX_new();
    if (ctx == 
# 91 "../crypto/ec/eck_prn.c" 3 4
              ((void *)0)
# 91 "../crypto/ec/eck_prn.c"
                  ) {
        reason = (3 | (0x2 << 18L));
        goto err;
    }
    ...
    if (EC_GROUP_get_asn1_flag(x)) {
        ...
        if ((p = BN_new()) == 
# 128 "../crypto/ec/eck_prn.c" 3 4
                             ((void *)0) 
# 128 "../crypto/ec/eck_prn.c"
                                  || (a = BN_new()) == 
# 128 "../crypto/ec/eck_prn.c" 3 4
                                                       ((void *)0) 
# 128 "../crypto/ec/eck_prn.c"
                                                            ||
            (b = BN_new()) == 
# 129 "../crypto/ec/eck_prn.c" 3 4
                             ((void *)0)
# 129 "../crypto/ec/eck_prn.c"
                                 ) {
            reason = (3 | (0x2 << 18L));
            goto err;
        }
...
# 139 "../crypto/ec/eck_prn.c" 3 4
                                                   ((void *)0)
# 139 "../crypto/ec/eck_prn.c"
                                                       ) {
            reason = (16 | (0x2 << 18L));
            goto err;
        }
        ...
        if (order == 
# 145 "../crypto/ec/eck_prn.c" 3 4
                    ((void *)0)
# 145 "../crypto/ec/eck_prn.c"
                        ) {
            reason = (16 | (0x2 << 18L));
            goto err;
        }
...
# 158 "../crypto/ec/eck_prn.c" 3 4
                                             ((void *)0)
# 158 "../crypto/ec/eck_prn.c"
                                                 )
        ...
        if (is_char_two) {
            ...
            if ((p != 
# 183 "../crypto/ec/eck_prn.c" 3 4
                     ((void *)0)
# 183 "../crypto/ec/eck_prn.c"
...
# 183 "../crypto/ec/eck_prn.c"
            ...
            if ((p != 
# 187 "../crypto/ec/eck_prn.c" 3 4
                     ((void *)0)
# 187 "../crypto/ec/eck_prn.c"
...
# 187 "../crypto/ec/eck_prn.c"
        ...
        if ((a != 
# 190 "../crypto/ec/eck_prn.c" 3 4
                 ((void *)0)
# 190 "../crypto/ec/eck_prn.c"
...
# 190 "../crypto/ec/eck_prn.c"
            ...
            goto err;
        if ((b != 
# 192 "../crypto/ec/eck_prn.c" 3 4
                 ((void *)0)
# 192 "../crypto/ec/eck_prn.c"
...
# 192 "../crypto/ec/eck_prn.c"
        ...
        if (form == POINT_CONVERSION_COMPRESSED)
            ...
            form_str = gen_hybrid;
        if (gen_buf != 
# 201 "../crypto/ec/eck_prn.c" 3 4
                      ((void *)0)
            
# 202 "../crypto/ec/eck_prn.c"
           && !print_bin(bp, form_str, gen_buf, gen_buf_len, off))
            goto err;

        if ((order != 
# 205 "../crypto/ec/eck_prn.c" 3 4
                     ((void *)0)
# 205 "../crypto/ec/eck_prn.c"
...
# 205 "../crypto/ec/eck_prn.c"
            ...
            goto err;
        if ((cofactor != 
# 207 "../crypto/ec/eck_prn.c" 3 4
                        ((void *)0)
# 207 "../crypto/ec/eck_prn.c"
                            ) && !ASN1_bn_print(bp, "Cofactor: ", cofactor,
                                                 
# 208 "../crypto/ec/eck_prn.c" 3 4
                                                ((void *)0)
# 208 "../crypto/ec/eck_prn.c"
                                                    , off))
            goto err;
 ...
 err:
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/ec/eck_prn.c",216,__func__), ERR_set_error)((16),(reason),
# 216 "../crypto/ec/eck_prn.c" 3 4
       ((void *)0)
# 216 "../crypto/ec/eck_prn.c"
       );
    BN_free(p);
    BN_free(a);
    BN_free(b);
    CRYPTO_clear_free(gen_buf, gen_buf_len, "../crypto/ec/eck_prn.c", 220);
    BN_CTX_free(ctx);
    return ret;
}
                     ...
                     size_t len, int off)
{
    ...
    if (buf == 
# 231 "../crypto/ec/eck_prn.c" 3 4
              ((void *)0)
# 231 "../crypto/ec/eck_prn.c"
                  )
        return 1;
    if (off > 0) {
        if (off > 128)
