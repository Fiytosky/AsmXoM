# 0 "../crypto/ec/ec_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ec/ec_backend.c"
# 14 "../crypto/ec/ec_backend.c"
...
# 15 "../crypto/ec/ec_backend.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../crypto/ec/ec_backend.c" 2
...
# 28 "../crypto/ec/ec_backend.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 29 "../crypto/ec/ec_backend.c" 2
...
static const OSSL_ITEM format_nameid_map[] = {
    { (int)POINT_CONVERSION_UNCOMPRESSED, "uncompressed" },
    { (int)POINT_CONVERSION_COMPRESSED, "compressed" },
    { (int)POINT_CONVERSION_HYBRID, "hybrid" },
};
...
int ossl_ec_encoding_name2id(const char *name)
{
    ...
    if (name == 
# 54 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0)
# 54 "../crypto/ec/ec_backend.c"
                   )
        return 0x001;

    for (i = 0, sz = (sizeof(encoding_nameid_map)/sizeof((encoding_nameid_map)[0])); i < sz; i++) {
...
static char *ec_param_encoding_id2name(int id)
{
    ...
    return 
# 72 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 72 "../crypto/ec/ec_backend.c"
              ;
}
...
char *ossl_ec_check_group_type_id2name(int id)
{
    ...
    for (i = 0, sz = (sizeof(check_group_type_nameid_map)/sizeof((check_group_type_nameid_map)[0])); i < sz; i++) {
        if (id == (int)check_group_type_nameid_map[i].id)
            return check_group_type_nameid_map[i].ptr;
    }
    return 
# 83 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 83 "../crypto/ec/ec_backend.c"
              ;
}
...
static int ec_check_group_type_name2id(const char *name)
{
    ...
    if (name == 
# 91 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0)
# 91 "../crypto/ec/ec_backend.c"
                   )
        return 0;
...
int ossl_ec_set_check_group_type_from_name(EC_KEY *ec, const char *name)
{
    ...
    if (flags == -1)
        return 0;
    EC_KEY_clear_flags(ec, (0x2000 | 0x4000));
...
{
    const char *name = 
# 114 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 114 "../crypto/ec/ec_backend.c"
                          ;
    int status = 0;
    ...
    case 4:
        name = p->data;
        status = (name != 
# 120 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 120 "../crypto/ec/ec_backend.c"
                             );
        break;
    case 6:
...
int ossl_ec_pt_format_name2id(const char *name)
{
    ...
    if (name == 
# 136 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0)
# 136 "../crypto/ec/ec_backend.c"
                   )
        return (int)POINT_CONVERSION_UNCOMPRESSED;

    for (i = 0, sz = (sizeof(format_nameid_map)/sizeof((format_nameid_map)[0])); i < sz; i++) {
...
char *ossl_ec_pt_format_id2name(int id)
{
    ...
    return 
# 154 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 154 "../crypto/ec/ec_backend.c"
              ;
}
...
# 163 "../crypto/ec/ec_backend.c" 3 4
                             ((void *)0)
# 163 "../crypto/ec/ec_backend.c"
                                 ;
    const OSSL_PARAM *param_p = 
# 164 "../crypto/ec/ec_backend.c" 3 4
                               ((void *)0)
# 164 "../crypto/ec/ec_backend.c"
                                   ;
    const OSSL_PARAM *param_a = 
# 165 "../crypto/ec/ec_backend.c" 3 4
                               ((void *)0)
# 165 "../crypto/ec/ec_backend.c"
                                   ;
    const OSSL_PARAM *param_b = 
# 166 "../crypto/ec/ec_backend.c" 3 4
                               ((void *)0)
# 166 "../crypto/ec/ec_backend.c"
                                   ;
    ...
    if (fid == 406) {
        ...
        field_type = "characteristic-two-field";

    } else {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",180,__func__), ERR_set_error)((16),(103),
# 180 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 180 "../crypto/ec/ec_backend.c"
       );
        return 0;
    }

    param_p = OSSL_PARAM_locate_const(params, "p");
    param_a = OSSL_PARAM_locate_const(params, "a");
    param_b = OSSL_PARAM_locate_const(params, "b");
    if (tmpl != 
# 187 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 187 "../crypto/ec/ec_backend.c"
                    || param_p != 
# 187 "../crypto/ec/ec_backend.c" 3 4
                                  ((void *)0) 
# 187 "../crypto/ec/ec_backend.c"
...
# 187 "../crypto/ec/ec_backend.c"
                                                                            )
    {
        ...
        if (b == 
# 193 "../crypto/ec/ec_backend.c" 3 4
                ((void *)0)
# 193 "../crypto/ec/ec_backend.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",194,__func__), ERR_set_error)((16),((3 | (0x2 << 18L))),
# 194 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 194 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }

        if (!EC_GROUP_get_curve(group, p, a, b, bnctx)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",199,__func__), ERR_set_error)((16),(141),
# 199 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 199 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
        if (!ossl_param_build_set_bn(tmpl, params, "p", p)
            || !ossl_param_build_set_bn(tmpl, params, "a", a)
            || !ossl_param_build_set_bn(tmpl, params, "b", b)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",205,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 205 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 205 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }

    param = OSSL_PARAM_locate_const(params, "order");
    if (tmpl != 
# 211 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 211 "../crypto/ec/ec_backend.c"
                    || param != 
# 211 "../crypto/ec/ec_backend.c" 3 4
                                ((void *)0)
# 211 "../crypto/ec/ec_backend.c"
        ...
        if (order == 
# 214 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0)
# 214 "../crypto/ec/ec_backend.c"
                        ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",215,__func__), ERR_set_error)((16),(122),
# 215 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 215 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
        if (!ossl_param_build_set_bn(tmpl, params, "order",
                                    order)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",220,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 220 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 220 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }

    param = OSSL_PARAM_locate_const(params, "field-type");
    if (tmpl != 
# 226 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 226 "../crypto/ec/ec_backend.c"
                    || param != 
# 226 "../crypto/ec/ec_backend.c" 3 4
                                ((void *)0)
# 226 "../crypto/ec/ec_backend.c"
        ...
        if (!ossl_param_build_set_utf8_string(tmpl, params,
                                              "field-type",
                                              field_type)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",230,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 230 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 230 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }

    param = OSSL_PARAM_locate_const(params, "generator");
    if (tmpl != 
# 236 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 236 "../crypto/ec/ec_backend.c"
                    || param != 
# 236 "../crypto/ec/ec_backend.c" 3 4
                                ((void *)0)
# 236 "../crypto/ec/ec_backend.c"
        ...
        if (genpt == 
# 241 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0)
# 241 "../crypto/ec/ec_backend.c"
                        ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",242,__func__), ERR_set_error)((16),(173),
# 242 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 242 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
        genbuf_len = EC_POINT_point2buf(group, genpt, genform, genbuf, bnctx);
        if (genbuf_len == 0) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",247,__func__), ERR_set_error)((16),(173),
# 247 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 247 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
        if (!ossl_param_build_set_octet_string(tmpl, params,
                                               "generator",
                                               *genbuf, genbuf_len)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",253,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 253 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 253 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }

    param = OSSL_PARAM_locate_const(params, "cofactor");
    if (tmpl != 
# 259 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 259 "../crypto/ec/ec_backend.c"
                    || param != 
# 259 "../crypto/ec/ec_backend.c" 3 4
                                ((void *)0)
# 259 "../crypto/ec/ec_backend.c"
        ...
        if (cofactor != 
# 262 "../crypto/ec/ec_backend.c" 3 4
                       ((void *)0)
            
# 263 "../crypto/ec/ec_backend.c"
           && !ossl_param_build_set_bn(tmpl, params,
                                        "cofactor", cofactor)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",265,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 265 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 265 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }

    param = OSSL_PARAM_locate_const(params, "seed");
    if (tmpl != 
# 271 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 271 "../crypto/ec/ec_backend.c"
                    || param != 
# 271 "../crypto/ec/ec_backend.c" 3 4
                                ((void *)0)
# 271 "../crypto/ec/ec_backend.c"
        ...
        if (seed != 
# 275 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
            
# 276 "../crypto/ec/ec_backend.c"
           && seed_len > 0
            && !ossl_param_build_set_octet_string(tmpl, params,
                                                  "seed",
                                                  seed, seed_len)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",280,__func__), ERR_set_error)((16),((15 | (0x2 << 18L))),
# 280 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 280 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }
                         ...
                         BN_CTX *bnctx, unsigned char **genbuf)
{
    ...
    if (group == 
# 298 "../crypto/ec/ec_backend.c" 3 4
                ((void *)0)
# 298 "../crypto/ec/ec_backend.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",299,__func__), ERR_set_error)((16),(134),
# 299 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 299 "../crypto/ec/ec_backend.c"
       );
        return 0;
    }
    ...
    if (pt_form_name == 
# 305 "../crypto/ec/ec_backend.c" 3 4
                       ((void *)0)
        
# 306 "../crypto/ec/ec_backend.c"
       || !ossl_param_build_set_utf8_string(
                tmpl, params,
                "point-format", pt_form_name)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",309,__func__), ERR_set_error)((16),(104),
# 309 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 309 "../crypto/ec/ec_backend.c"
       );
        return 0;
    }
    encoding_flag = EC_GROUP_get_asn1_flag(group) & 0x001;
    encoding_name = ec_param_encoding_id2name(encoding_flag);
    if (encoding_name == 
# 314 "../crypto/ec/ec_backend.c" 3 4
                        ((void *)0)
        
# 315 "../crypto/ec/ec_backend.c"
       || !ossl_param_build_set_utf8_string(tmpl, params,
                                             "encoding",
                                             encoding_name)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",318,__func__), ERR_set_error)((16),(102),
# 318 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 318 "../crypto/ec/ec_backend.c"
       );
        return 0;
    }
    ...
    if (tmpl == 
# 334 "../crypto/ec/ec_backend.c" 3 4
               ((void *)0) 
# 334 "../crypto/ec/ec_backend.c"
                    || curve_nid == 0)
    ...
    if (curve_nid != 0) {
        ...
        if (curve_name == 
# 342 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
            
# 343 "../crypto/ec/ec_backend.c"
           || !ossl_param_build_set_utf8_string(tmpl, params,
                                                 "group",
                                                 curve_name)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",346,__func__), ERR_set_error)((16),(141),
# 346 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 346 "../crypto/ec/ec_backend.c"
           );
            goto err;
        }
    }
...
int ossl_ec_set_ecdh_cofactor_mode(EC_KEY *ec, int mode)
{
    ...
    if ((cofactor = EC_GROUP_get0_cofactor(ecg)) == 
# 374 "../crypto/ec/ec_backend.c" 3 4
                                                   ((void *)0) 
# 374 "../crypto/ec/ec_backend.c"
                                                        )
        return 0;
    ...
    if (mode == 1)
        EC_KEY_set_flags(ec, 0x1000);
    else if (mode == 0)
        EC_KEY_clear_flags(ec, 0x1000);

    return 1;
}
# 397 "../crypto/ec/ec_backend.c"
int ossl_ec_key_fromdata(EC_KEY *ec, const OSSL_PARAM params[], int include_private)
{
    const OSSL_PARAM *param_priv_key = 
# 399 "../crypto/ec/ec_backend.c" 3 4
                                      ((void *)0)
# 399 "../crypto/ec/ec_backend.c"
                                          , *param_pub_key = 
# 399 "../crypto/ec/ec_backend.c" 3 4
                                                             ((void *)0)
# 399 "../crypto/ec/ec_backend.c"
                                                                 ;
    BN_CTX *ctx = 
# 400 "../crypto/ec/ec_backend.c" 3 4
                 ((void *)0)
# 400 "../crypto/ec/ec_backend.c"
                     ;
    BIGNUM *priv_key = 
# 401 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 401 "../crypto/ec/ec_backend.c"
                          ;
    unsigned char *pub_key = 
# 402 "../crypto/ec/ec_backend.c" 3 4
                            ((void *)0)
# 402 "../crypto/ec/ec_backend.c"
                                ;
    size_t pub_key_len;
    const EC_GROUP *ecg = 
# 404 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 404 "../crypto/ec/ec_backend.c"
                             ;
    EC_POINT *pub_point = 
# 405 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 405 "../crypto/ec/ec_backend.c"
                             ;
    int ok = 0;

    ecg = EC_KEY_get0_group(ec);
    if (ecg == 
# 409 "../crypto/ec/ec_backend.c" 3 4
              ((void *)0)
# 409 "../crypto/ec/ec_backend.c"
                  )
        return 0;

    param_pub_key =
        OSSL_PARAM_locate_const(params, "pub");
    if (include_private)
        param_priv_key =
            OSSL_PARAM_locate_const(params, "priv");

    ctx = BN_CTX_new_ex(ossl_ec_key_get_libctx(ec));
    if (ctx == 
# 419 "../crypto/ec/ec_backend.c" 3 4
              ((void *)0)
# 419 "../crypto/ec/ec_backend.c"
                  )
        goto err;

    if (param_pub_key != 
# 422 "../crypto/ec/ec_backend.c" 3 4
                        ((void *)0)
# 422 "../crypto/ec/ec_backend.c"
                            )
        if (!OSSL_PARAM_get_octet_string(param_pub_key,
                                         (void **)&pub_key, 0, &pub_key_len)
            || (pub_point = EC_POINT_new(ecg)) == 
# 425 "../crypto/ec/ec_backend.c" 3 4
                                                 ((void *)0)
            
# 426 "../crypto/ec/ec_backend.c"
           || !EC_POINT_oct2point(ecg, pub_point, pub_key, pub_key_len, ctx))
        goto err;

    if (param_priv_key != 
# 429 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0) 
# 429 "../crypto/ec/ec_backend.c"
                              && include_private) {
        int fixed_words;
        const BIGNUM *order;
# 466 "../crypto/ec/ec_backend.c"
        order = EC_GROUP_get0_order(ecg);
        if (order == 
# 467 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0) 
# 467 "../crypto/ec/ec_backend.c"
                         || BN_is_zero(order))
            goto err;

        fixed_words = bn_get_top(order) + 2;

        if ((priv_key = BN_secure_new()) == 
# 472 "../crypto/ec/ec_backend.c" 3 4
                                           ((void *)0)
# 472 "../crypto/ec/ec_backend.c"
                                               )
            goto err;
        if (bn_wexpand(priv_key, fixed_words) == 
# 474 "../crypto/ec/ec_backend.c" 3 4
                                                ((void *)0)
# 474 "../crypto/ec/ec_backend.c"
                                                    )
            goto err;
    ...
    if (priv_key != 
# 482 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
        
# 483 "../crypto/ec/ec_backend.c"
       && !EC_KEY_set_private_key(ec, priv_key))
        goto err;

    if (pub_point != 
# 486 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0)
        
# 487 "../crypto/ec/ec_backend.c"
 ...
 err:
    ...
    CRYPTO_free(pub_key, "../crypto/ec/ec_backend.c", 495);
...
int ossl_ec_group_fromdata(EC_KEY *ec, const OSSL_PARAM params[])
{
    int ok = 0;
    EC_GROUP *group = 
# 503 "../crypto/ec/ec_backend.c" 3 4
                     ((void *)0)
# 503 "../crypto/ec/ec_backend.c"
                         ;

    if (ec == 
# 505 "../crypto/ec/ec_backend.c" 3 4
             ((void *)0)
# 505 "../crypto/ec/ec_backend.c"
                 )
        return 0;
...
static int ec_key_point_format_fromdata(EC_KEY *ec, const OSSL_PARAM params[])
{
    ...
    if (p != 
# 525 "../crypto/ec/ec_backend.c" 3 4
            ((void *)0)
# 525 "../crypto/ec/ec_backend.c"
                ) {
        if (!ossl_ec_pt_format_param2id(p, &format)) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",527,__func__), ERR_set_error)((16),(104),
# 527 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 527 "../crypto/ec/ec_backend.c"
           );
            return 0;
        }
...
static int ec_key_group_check_fromdata(EC_KEY *ec, const OSSL_PARAM params[])
{
    ...
    p = OSSL_PARAM_locate_const(params, "group-check");
    if (p != 
# 540 "../crypto/ec/ec_backend.c" 3 4
            ((void *)0)
# 540 "../crypto/ec/ec_backend.c"
                )
...
int ossl_ec_key_otherparams_fromdata(EC_KEY *ec, const OSSL_PARAM params[])
{
    ...
    if (ec == 
# 561 "../crypto/ec/ec_backend.c" 3 4
             ((void *)0)
# 561 "../crypto/ec/ec_backend.c"
                 )
        return 0;

    p = OSSL_PARAM_locate_const(params, "use-cofactor-flag");
    if (p != 
# 565 "../crypto/ec/ec_backend.c" 3 4
            ((void *)0)
# 565 "../crypto/ec/ec_backend.c"
                ) {
        int mode;
    ...
    p = OSSL_PARAM_locate_const(params, "include-public");
    if (p != 
# 574 "../crypto/ec/ec_backend.c" 3 4
            ((void *)0)
# 574 "../crypto/ec/ec_backend.c"
                ) {
        int include = 1;
...
int ossl_ec_key_is_foreign(const EC_KEY *ec)
{
    ...
    if (ec->engine != 
# 591 "../crypto/ec/ec_backend.c" 3 4
                     ((void *)0) 
# 591 "../crypto/ec/ec_backend.c"
                          || EC_KEY_get_method(ec) != EC_KEY_OpenSSL())
        return 1;
...
EC_KEY *ossl_ec_key_dup(const EC_KEY *src, int selection)
{
    ...
    if (src == 
# 602 "../crypto/ec/ec_backend.c" 3 4
              ((void *)0)
# 602 "../crypto/ec/ec_backend.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",603,__func__), ERR_set_error)((16),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 603 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 603 "../crypto/ec/ec_backend.c"
       );
        return 
# 604 "../crypto/ec/ec_backend.c" 3 4
              ((void *)0)
# 604 "../crypto/ec/ec_backend.c"
                  ;
    }

    if ((ret = ossl_ec_key_new_method_int(src->libctx, src->propq,
                                          src->engine)) == 
# 608 "../crypto/ec/ec_backend.c" 3 4
                                                          ((void *)0)
# 608 "../crypto/ec/ec_backend.c"
                                                              )
        return 
# 609 "../crypto/ec/ec_backend.c" 3 4
              ((void *)0)
# 609 "../crypto/ec/ec_backend.c"
                  ;


    if (src->group != 
# 612 "../crypto/ec/ec_backend.c" 3 4
                     ((void *)0)
        
# 613 "../crypto/ec/ec_backend.c"
       && (selection & 0x04) != 0) {
        ret->group = ossl_ec_group_new_ex(src->libctx, src->propq,
                                          src->group->meth);
        if (ret->group == 
# 616 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
            
# 617 "../crypto/ec/ec_backend.c"
           || !EC_GROUP_copy(ret->group, src->group))
            goto err;

        if (src->meth != 
# 620 "../crypto/ec/ec_backend.c" 3 4
                        ((void *)0)
# 620 "../crypto/ec/ec_backend.c"
                            )
            ret->meth = src->meth;
    }
    ...
    if (src->pub_key != 
# 625 "../crypto/ec/ec_backend.c" 3 4
                       ((void *)0)
        
# 626 "../crypto/ec/ec_backend.c"
       && (selection & 0x02) != 0) {
        if (ret->group == 
# 627 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 627 "../crypto/ec/ec_backend.c"
                             )

            goto err;
        ret->pub_key = EC_POINT_new(ret->group);
        if (ret->pub_key == 
# 631 "../crypto/ec/ec_backend.c" 3 4
                           ((void *)0)
            
# 632 "../crypto/ec/ec_backend.c"
    ...
    if (src->priv_key != 
# 637 "../crypto/ec/ec_backend.c" 3 4
                        ((void *)0)
        
# 638 "../crypto/ec/ec_backend.c"
       && (selection & 0x01) != 0) {
        if (ret->group == 
# 639 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 639 "../crypto/ec/ec_backend.c"
                             )

            goto err;
        ret->priv_key = BN_new();
        if (ret->priv_key == 
# 643 "../crypto/ec/ec_backend.c" 3 4
                            ((void *)0) 
# 643 "../crypto/ec/ec_backend.c"
    ...
    if (ret->meth != 
# 665 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0) 
# 665 "../crypto/ec/ec_backend.c"
                         && ret->meth->copy != 
# 665 "../crypto/ec/ec_backend.c" 3 4
                                               ((void *)0)
# 665 "../crypto/ec/ec_backend.c"
 ...
 err:
    EC_KEY_free(ret);
    return 
# 676 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 676 "../crypto/ec/ec_backend.c"
              ;
}
...
{
    const char *name = 
# 681 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 681 "../crypto/ec/ec_backend.c"
                          ;
    int status = 0;
    ...
    case 4:
        ...
        name = p->data;
        status = (name != 
# 688 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 688 "../crypto/ec/ec_backend.c"
                             );
        break;
    case 6:
        status = OSSL_PARAM_get_utf8_ptr(p, &name);
...
{
    const char *name = 
# 707 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 707 "../crypto/ec/ec_backend.c"
                          ;
    int status = 0;
    ...
    case 4:
        ...
        name = p->data;
        status = (name != 
# 714 "../crypto/ec/ec_backend.c" 3 4
                         ((void *)0)
# 714 "../crypto/ec/ec_backend.c"
                             );
        break;
    case 6:
        status = OSSL_PARAM_get_utf8_ptr(p, &name);
...
int ossl_x509_algor_is_sm2(const X509_ALGOR *palg)
{
    int ptype = 0;
    const void *pval = 
# 735 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 735 "../crypto/ec/ec_backend.c"
                          ;

    X509_ALGOR_get0(
# 737 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
# 737 "../crypto/ec/ec_backend.c"
                       , &ptype, &pval, palg);

    if (ptype == 6)
        return OBJ_obj2nid((ASN1_OBJECT *)pval) == 1172;
    ...
    if (ptype == 16) {
        ...
        if ((group = d2i_ECPKParameters(
# 749 "../crypto/ec/ec_backend.c" 3 4
                                       ((void *)0)
# 749 "../crypto/ec/ec_backend.c"
                                           , &der, derlen)) == 
# 749 "../crypto/ec/ec_backend.c" 3 4
                                                               ((void *)0)
# 749 "../crypto/ec/ec_backend.c"
            ...
            ret = (EC_GROUP_get_curve_name(group) == 1172);
                                     ...
                                     OSSL_LIB_CTX *libctx, const char *propq)
{
    int ptype = 0;
    const void *pval = 
# 765 "../crypto/ec/ec_backend.c" 3 4
                      ((void *)0)
# 765 "../crypto/ec/ec_backend.c"
                          ;
    EC_KEY *eckey = 
# 766 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
# 766 "../crypto/ec/ec_backend.c"
                       ;
    EC_GROUP *group = 
# 767 "../crypto/ec/ec_backend.c" 3 4
                     ((void *)0)
# 767 "../crypto/ec/ec_backend.c"
                         ;

    X509_ALGOR_get0(
# 769 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
# 769 "../crypto/ec/ec_backend.c"
                       , &ptype, &pval, palg);
    if ((eckey = EC_KEY_new_ex(libctx, propq)) == 
# 770 "../crypto/ec/ec_backend.c" 3 4
                                                 ((void *)0)
# 770 "../crypto/ec/ec_backend.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",771,__func__), ERR_set_error)((16),((16 | (0x2 << 18L))),
# 771 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 771 "../crypto/ec/ec_backend.c"
       );
        goto ecerr;
    }
    ...
    if (ptype == 16) {
        ...
        if (d2i_ECParameters(&eckey, &pm, pmlen) == 
# 781 "../crypto/ec/ec_backend.c" 3 4
                                                   ((void *)0)
# 781 "../crypto/ec/ec_backend.c"
                                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",782,__func__), ERR_set_error)((16),(142),
# 782 "../crypto/ec/ec_backend.c" 3 4
           ((void *)0)
# 782 "../crypto/ec/ec_backend.c"
           );
            goto ecerr;
        }
    } else if (ptype == 6) {
        ...
        if (group == 
# 793 "../crypto/ec/ec_backend.c" 3 4
                    ((void *)0)
# 793 "../crypto/ec/ec_backend.c"
                        )
            goto ecerr;
        ...
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",800,__func__), ERR_set_error)((16),(142),
# 800 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 800 "../crypto/ec/ec_backend.c"
       );
        goto ecerr;
    }
 ...
 ecerr:
    ...
    EC_GROUP_free(group);
    return 
# 809 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 809 "../crypto/ec/ec_backend.c"
              ;
}
...
# 815 "../crypto/ec/ec_backend.c" 3 4
                            ((void *)0)
# 815 "../crypto/ec/ec_backend.c"
                                ;
    int pklen;
    EC_KEY *eckey = 
# 817 "../crypto/ec/ec_backend.c" 3 4
                   ((void *)0)
# 817 "../crypto/ec/ec_backend.c"
                       ;
    const X509_ALGOR *palg;

    if (!PKCS8_pkey_get0(
# 820 "../crypto/ec/ec_backend.c" 3 4
                        ((void *)0)
# 820 "../crypto/ec/ec_backend.c"
                            , &p, &pklen, &palg, p8inf))
        return 0;
    eckey = ossl_ec_key_param_from_x509_algor(palg, libctx, propq);
    if (eckey == 
# 823 "../crypto/ec/ec_backend.c" 3 4
                ((void *)0)
# 823 "../crypto/ec/ec_backend.c"
                    )
        goto err;


    if (!d2i_ECPrivateKey(&eckey, &p, pklen)) {
        (ERR_new(), ERR_set_debug("../crypto/ec/ec_backend.c",828,__func__), ERR_set_error)((16),(142),
# 828 "../crypto/ec/ec_backend.c" 3 4
       ((void *)0)
# 828 "../crypto/ec/ec_backend.c"
       );
        goto err;
    }
 ...
 err:
    EC_KEY_free(eckey);
    return 
# 835 "../crypto/ec/ec_backend.c" 3 4
          ((void *)0)
# 835 "../crypto/ec/ec_backend.c"
              ;
}
