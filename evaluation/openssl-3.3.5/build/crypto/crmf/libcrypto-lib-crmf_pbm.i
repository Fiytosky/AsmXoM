# 0 "../crypto/crmf/crmf_pbm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/crmf/crmf_pbm.c"
# 14 "../crypto/crmf/crmf_pbm.c"
...
# 30 "../crypto/crmf/crmf_pbm.c" 2
# 39 "../crypto/crmf/crmf_pbm.c"
OSSL_CRMF_PBMPARAMETER *OSSL_CRMF_pbmp_new(OSSL_LIB_CTX *libctx, size_t slen,
                                           int owfnid, size_t itercnt,
                                           int macnid)
{
    OSSL_CRMF_PBMPARAMETER *pbm = 
# 43 "../crypto/crmf/crmf_pbm.c" 3 4
                                 ((void *)0)
# 43 "../crypto/crmf/crmf_pbm.c"
                                     ;
    unsigned char *salt = 
# 44 "../crypto/crmf/crmf_pbm.c" 3 4
                         ((void *)0)
# 44 "../crypto/crmf/crmf_pbm.c"
                             ;

    if ((pbm = OSSL_CRMF_PBMPARAMETER_new()) == 
# 46 "../crypto/crmf/crmf_pbm.c" 3 4
                                               ((void *)0)
# 46 "../crypto/crmf/crmf_pbm.c"
                                                   )
        goto err;
    ...
    if ((salt = CRYPTO_malloc(slen, "../crypto/crmf/crmf_pbm.c", 54)) == 
# 54 "../crypto/crmf/crmf_pbm.c" 3 4
                                        ((void *)0)
# 54 "../crypto/crmf/crmf_pbm.c"
                                            )
        goto err;
    if (RAND_bytes_ex(libctx, salt, slen, 0) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",57,__func__), ERR_set_error)((56),(107),
# 57 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 57 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
    ...
    if (!X509_ALGOR_set0(pbm->owf, OBJ_nid2obj(owfnid), -1, 
# 68 "../crypto/crmf/crmf_pbm.c" 3 4
                                                                     ((void *)0)
# 68 "../crypto/crmf/crmf_pbm.c"
                                                                         )) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",69,__func__), ERR_set_error)((56),(111),
# 69 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 69 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
# 83 "../crypto/crmf/crmf_pbm.c"
    if (itercnt < 100) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",84,__func__), ERR_set_error)((56),(108),
# 84 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 84 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
    if (itercnt > 100000) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",88,__func__), ERR_set_error)((56),(100),
# 88 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 88 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }

    if (!ASN1_INTEGER_set(pbm->iterationCount, itercnt)) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",93,__func__), ERR_set_error)((56),(102),
# 93 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 93 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
    ...
    if (!X509_ALGOR_set0(pbm->mac, OBJ_nid2obj(macnid), -1, 
# 102 "../crypto/crmf/crmf_pbm.c" 3 4
                                                                     ((void *)0)
# 102 "../crypto/crmf/crmf_pbm.c"
                                                                         )) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",103,__func__), ERR_set_error)((56),(110),
# 103 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 103 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }

    CRYPTO_free(salt, "../crypto/crmf/crmf_pbm.c", 107);
    return pbm;
 err:
    CRYPTO_free(salt, "../crypto/crmf/crmf_pbm.c", 110);
    OSSL_CRMF_PBMPARAMETER_free(pbm);
    return 
# 112 "../crypto/crmf/crmf_pbm.c" 3 4
          ((void *)0)
# 112 "../crypto/crmf/crmf_pbm.c"
              ;
}
# 127 "../crypto/crmf/crmf_pbm.c"
int OSSL_CRMF_pbm_new(OSSL_LIB_CTX *libctx, const char *propq,
                      const OSSL_CRMF_PBMPARAMETER *pbmp,
                      const unsigned char *msg, size_t msglen,
                      const unsigned char *sec, size_t seclen,
                      unsigned char **out, size_t *outlen)
{
    int mac_nid, hmac_md_nid = 0;
    char mdname[50];
    char hmac_mdname[50];
    EVP_MD *owf = 
# 136 "../crypto/crmf/crmf_pbm.c" 3 4
                 ((void *)0)
# 136 "../crypto/crmf/crmf_pbm.c"
                     ;
    EVP_MD_CTX *ctx = 
# 137 "../crypto/crmf/crmf_pbm.c" 3 4
                     ((void *)0)
# 137 "../crypto/crmf/crmf_pbm.c"
                         ;
    unsigned char basekey[64];
    unsigned int bklen = 64;
    int64_t iterations;
    unsigned char *mac_res = 0;
    int ok = 0;

    if (out == 
# 144 "../crypto/crmf/crmf_pbm.c" 3 4
              ((void *)0) 
# 144 "../crypto/crmf/crmf_pbm.c"
                   || pbmp == 
# 144 "../crypto/crmf/crmf_pbm.c" 3 4
                              ((void *)0) 
# 144 "../crypto/crmf/crmf_pbm.c"
...
# 145 "../crypto/crmf/crmf_pbm.c"
           || pbmp->mac->algorithm == 
# 145 "../crypto/crmf/crmf_pbm.c" 3 4
                                      ((void *)0) 
# 145 "../crypto/crmf/crmf_pbm.c"
                                           || msg == 
# 145 "../crypto/crmf/crmf_pbm.c" 3 4
...
# 145 "../crypto/crmf/crmf_pbm.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",146,__func__), ERR_set_error)((56),(109),
# 146 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 146 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
    if ((mac_res = CRYPTO_malloc(64, "../crypto/crmf/crmf_pbm.c", 149)) == 
# 149 "../crypto/crmf/crmf_pbm.c" 3 4
                                                      ((void *)0)
# 149 "../crypto/crmf/crmf_pbm.c"
                                                          )
        goto err;
    ...
    if ((owf = EVP_MD_fetch(libctx, mdname, propq)) == 
# 158 "../crypto/crmf/crmf_pbm.c" 3 4
                                                      ((void *)0)
# 158 "../crypto/crmf/crmf_pbm.c"
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",159,__func__), ERR_set_error)((56),(112),
# 159 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 159 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }

    if ((ctx = EVP_MD_CTX_new()) == 
# 163 "../crypto/crmf/crmf_pbm.c" 3 4
                                   ((void *)0)
# 163 "../crypto/crmf/crmf_pbm.c"
                                       )
        goto err;


    if (!EVP_DigestInit_ex(ctx, owf, 
# 167 "../crypto/crmf/crmf_pbm.c" 3 4
                                    ((void *)0)
# 167 "../crypto/crmf/crmf_pbm.c"
                                        ))
        goto err;
    ...
    if (!ASN1_INTEGER_get_int64(&iterations, pbmp->iterationCount)
            || iterations < 100
            || iterations > 100000) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",180,__func__), ERR_set_error)((56),(100),
# 180 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 180 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }
    ...
    while (--iterations > 0) {
        if (!EVP_DigestInit_ex(ctx, owf, 
# 186 "../crypto/crmf/crmf_pbm.c" 3 4
                                        ((void *)0)
# 186 "../crypto/crmf/crmf_pbm.c"
                                            ))
            goto err;
    ...
    if (!EVP_PBE_find(0x1, mac_nid, 
# 201 "../crypto/crmf/crmf_pbm.c" 3 4
                                                ((void *)0)
# 201 "../crypto/crmf/crmf_pbm.c"
                                                    , &hmac_md_nid, 
# 201 "../crypto/crmf/crmf_pbm.c" 3 4
                                                                    ((void *)0)
# 201 "../crypto/crmf/crmf_pbm.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_pbm.c",204,__func__), ERR_set_error)((56),(112),
# 204 "../crypto/crmf/crmf_pbm.c" 3 4
       ((void *)0)
# 204 "../crypto/crmf/crmf_pbm.c"
       );
        goto err;
    }

    if (EVP_Q_mac(libctx, "HMAC", propq, hmac_mdname, 
# 208 "../crypto/crmf/crmf_pbm.c" 3 4
                                                     ((void *)0)
# 208 "../crypto/crmf/crmf_pbm.c"
                                                         , basekey, bklen,
                  msg, msglen, mac_res, 64, outlen) == 
# 209 "../crypto/crmf/crmf_pbm.c" 3 4
                                                                   ((void *)0)
# 209 "../crypto/crmf/crmf_pbm.c"
                                                                       )
        goto err;
 ...
 err:
    ...
    CRYPTO_free(mac_res, "../crypto/crmf/crmf_pbm.c", 224);

    if (pbmp != 
# 226 "../crypto/crmf/crmf_pbm.c" 3 4
               ((void *)0) 
# 226 "../crypto/crmf/crmf_pbm.c"
                    && pbmp->mac != 
# 226 "../crypto/crmf/crmf_pbm.c" 3 4
                                    ((void *)0)
# 226 "../crypto/crmf/crmf_pbm.c"
