# 0 "../crypto/crmf/crmf_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/crmf/crmf_err.c"
# 11 "../crypto/crmf/crmf_err.c"
...
static const ERR_STRING_DATA CRMF_str_reasons[] = {
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "bad pbm iterationcount"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "crmferror"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "error"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "error decoding certificate"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "error decrypting certificate"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "error decrypting symmetric key"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "failure obtaining random"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "iterationcount below 100"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "malformed iv"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "null argument"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "poposkinput not supported"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "popo inconsistent public key"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ), "popo missing"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "popo missing public key"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "popo missing subject"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "popo raverified not accepted"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "setting mac algor failure"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "setting owf algor failure"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "unsupported algorithm"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "unsupported cipher"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "unsupported method for creating popo"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "unsupported popo method"},
    {0, 
# 59 "../crypto/crmf/crmf_err.c" 3 4
       ((void *)0)
# 59 "../crypto/crmf/crmf_err.c"
           }
};
...
int ossl_err_load_CRMF_strings(void)
{
    ...
    if (ERR_reason_error_string(CRMF_str_reasons[0].error) == 
# 67 "../crypto/crmf/crmf_err.c" 3 4
                                                             ((void *)0)
# 67 "../crypto/crmf/crmf_err.c"
                                                                 )
