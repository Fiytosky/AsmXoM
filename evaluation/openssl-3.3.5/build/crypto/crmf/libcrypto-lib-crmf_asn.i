# 0 "../crypto/crmf/crmf_asn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/crmf/crmf_asn.c"
# 14 "../crypto/crmf/crmf_asn.c"
...
# 17 "../crypto/crmf/crmf_asn.c" 2




static const ASN1_TEMPLATE OSSL_CRMF_PRIVATEKEYINFO_seq_tt[] = {
    { (0), (0), 
# 22 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 22 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PRIVATEKEYINFO
# 22 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 22 "../crypto/crmf/crmf_asn.c"
...
# 22 "../crypto/crmf/crmf_asn.c"
   , "version", (ASN1_INTEGER_it) },
    { (0), (0), 
# 23 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 23 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PRIVATEKEYINFO
# 23 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 23 "../crypto/crmf/crmf_asn.c"
...
# 23 "../crypto/crmf/crmf_asn.c"
   , "privateKeyAlgorithm", (X509_ALGOR_it) },
    { (0), (0), 
# 24 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 24 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PRIVATEKEYINFO
# 24 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 24 "../crypto/crmf/crmf_asn.c"
...
# 24 "../crypto/crmf/crmf_asn.c"
   , "privateKey", (ASN1_OCTET_STRING_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1 << 1)|(0x1))), (0), 
# 25 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 25 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PRIVATEKEYINFO
# 25 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 25 "../crypto/crmf/crmf_asn.c"
...
# 25 "../crypto/crmf/crmf_asn.c"
   , "attributes", (X509_ATTRIBUTE_it) }
} ; const ASN1_ITEM * OSSL_CRMF_PRIVATEKEYINFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_PRIVATEKEYINFO_seq_tt, sizeof(OSSL_CRMF_PRIVATEKEYINFO_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 26 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 26 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_PRIVATEKEYINFO), "OSSL_CRMF_PRIVATEKEYINFO" }; return &local_it; }
OSSL_CRMF_PRIVATEKEYINFO *d2i_OSSL_CRMF_PRIVATEKEYINFO(OSSL_CRMF_PRIVATEKEYINFO **a, const unsigned char **in, long len) { return (OSSL_CRMF_PRIVATEKEYINFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_PRIVATEKEYINFO_it())); } int i2d_OSSL_CRMF_PRIVATEKEYINFO(const OSSL_CRMF_PRIVATEKEYINFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_PRIVATEKEYINFO_it())); } OSSL_CRMF_PRIVATEKEYINFO *OSSL_CRMF_PRIVATEKEYINFO_new(void) { return (OSSL_CRMF_PRIVATEKEYINFO *)ASN1_item_new((OSSL_CRMF_PRIVATEKEYINFO_it())); } void OSSL_CRMF_PRIVATEKEYINFO_free(OSSL_CRMF_PRIVATEKEYINFO *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_PRIVATEKEYINFO_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_ch_tt[] = {
    { (0), (0), 
# 30 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 30 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCKEYWITHID_IDENTIFIER
# 30 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 30 "../crypto/crmf/crmf_asn.c"
...
# 30 "../crypto/crmf/crmf_asn.c"
   , "value.string", (ASN1_UTF8STRING_it) }
                                              ,
    { (0), (0), 
# 32 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 32 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCKEYWITHID_IDENTIFIER
# 32 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 32 "../crypto/crmf/crmf_asn.c"
...
# 32 "../crypto/crmf/crmf_asn.c"
   , "value.generalName", (GENERAL_NAME_it) }

} ; const ASN1_ITEM * OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 34 "../crypto/crmf/crmf_asn.c" 3 4
 __builtin_offsetof (
# 34 "../crypto/crmf/crmf_asn.c"
 OSSL_CRMF_ENCKEYWITHID_IDENTIFIER
# 34 "../crypto/crmf/crmf_asn.c" 3 4
 , 
# 34 "../crypto/crmf/crmf_asn.c"
...
# 34 "../crypto/crmf/crmf_asn.c"
 , OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_ch_tt, sizeof(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_ch_tt) / sizeof(ASN1_TEMPLATE), 
# 34 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 34 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER), "OSSL_CRMF_ENCKEYWITHID_IDENTIFIER" }; return &local_it; }
OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *d2i_OSSL_CRMF_ENCKEYWITHID_IDENTIFIER(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER **a, const unsigned char **in, long len) { return (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it())); } int i2d_OSSL_CRMF_ENCKEYWITHID_IDENTIFIER(const OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it())); } OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_new(void) { return (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *)ASN1_item_new((OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it())); } void OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_free(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_ENCKEYWITHID_seq_tt[] = {
    { (0), (0), 
# 38 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 38 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCKEYWITHID
# 38 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 38 "../crypto/crmf/crmf_asn.c"
...
# 38 "../crypto/crmf/crmf_asn.c"
   , "privateKey", (OSSL_CRMF_PRIVATEKEYINFO_it) },
    { ((0x1)), (0), 
# 39 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 39 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCKEYWITHID
# 39 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 39 "../crypto/crmf/crmf_asn.c"
...
# 39 "../crypto/crmf/crmf_asn.c"
   , "identifier", (OSSL_CRMF_ENCKEYWITHID_IDENTIFIER_it) }

} ; const ASN1_ITEM * OSSL_CRMF_ENCKEYWITHID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_ENCKEYWITHID_seq_tt, sizeof(OSSL_CRMF_ENCKEYWITHID_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 41 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 41 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_ENCKEYWITHID), "OSSL_CRMF_ENCKEYWITHID" }; return &local_it; }
OSSL_CRMF_ENCKEYWITHID *d2i_OSSL_CRMF_ENCKEYWITHID(OSSL_CRMF_ENCKEYWITHID **a, const unsigned char **in, long len) { return (OSSL_CRMF_ENCKEYWITHID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_ENCKEYWITHID_it())); } int i2d_OSSL_CRMF_ENCKEYWITHID(const OSSL_CRMF_ENCKEYWITHID *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_ENCKEYWITHID_it())); } OSSL_CRMF_ENCKEYWITHID *OSSL_CRMF_ENCKEYWITHID_new(void) { return (OSSL_CRMF_ENCKEYWITHID *)ASN1_item_new((OSSL_CRMF_ENCKEYWITHID_it())); } void OSSL_CRMF_ENCKEYWITHID_free(OSSL_CRMF_ENCKEYWITHID *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_ENCKEYWITHID_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_CERTID_seq_tt[] = {
    { (0), (0), 
# 45 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 45 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTID
# 45 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 45 "../crypto/crmf/crmf_asn.c"
...
# 45 "../crypto/crmf/crmf_asn.c"
   , "issuer", (GENERAL_NAME_it) },
    { (0), (0), 
# 46 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 46 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTID
# 46 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 46 "../crypto/crmf/crmf_asn.c"
...
# 46 "../crypto/crmf/crmf_asn.c"
   , "serialNumber", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * OSSL_CRMF_CERTID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_CERTID_seq_tt, sizeof(OSSL_CRMF_CERTID_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 47 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 47 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_CERTID), "OSSL_CRMF_CERTID" }; return &local_it; }
OSSL_CRMF_CERTID *d2i_OSSL_CRMF_CERTID(OSSL_CRMF_CERTID **a, const unsigned char **in, long len) { return (OSSL_CRMF_CERTID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_CERTID_it())); } int i2d_OSSL_CRMF_CERTID(const OSSL_CRMF_CERTID *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_CERTID_it())); } OSSL_CRMF_CERTID *OSSL_CRMF_CERTID_new(void) { return (OSSL_CRMF_CERTID *)ASN1_item_new((OSSL_CRMF_CERTID_it())); } void OSSL_CRMF_CERTID_free(OSSL_CRMF_CERTID *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_CERTID_it())); }
OSSL_CRMF_CERTID * OSSL_CRMF_CERTID_dup(const OSSL_CRMF_CERTID *x) { return ASN1_item_dup((OSSL_CRMF_CERTID_it()), x); }

static const ASN1_TEMPLATE OSSL_CRMF_ENCRYPTEDVALUE_seq_tt[] = {
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 52 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 52 "../crypto/crmf/crmf_asn.c"
...
# 52 "../crypto/crmf/crmf_asn.c"
   , "intendedAlg", (X509_ALGOR_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 53 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 53 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCRYPTEDVALUE
# 53 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 53 "../crypto/crmf/crmf_asn.c"
...
# 53 "../crypto/crmf/crmf_asn.c"
   , "symmAlg", (X509_ALGOR_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 54 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 54 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCRYPTEDVALUE
# 54 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 54 "../crypto/crmf/crmf_asn.c"
...
# 54 "../crypto/crmf/crmf_asn.c"
   , "encSymmKey", (ASN1_BIT_STRING_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (3), 
# 55 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 55 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCRYPTEDVALUE
# 55 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 55 "../crypto/crmf/crmf_asn.c"
...
# 55 "../crypto/crmf/crmf_asn.c"
   , "keyAlg", (X509_ALGOR_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (4), 
# 56 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 56 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCRYPTEDVALUE
# 56 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 56 "../crypto/crmf/crmf_asn.c"
...
# 56 "../crypto/crmf/crmf_asn.c"
   , "valueHint", (ASN1_OCTET_STRING_it) },
    { (0), (0), 
# 57 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 57 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ENCRYPTEDVALUE
# 57 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 57 "../crypto/crmf/crmf_asn.c"
...
# 57 "../crypto/crmf/crmf_asn.c"
   , "encValue", (ASN1_BIT_STRING_it) }
} ; const ASN1_ITEM * OSSL_CRMF_ENCRYPTEDVALUE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_ENCRYPTEDVALUE_seq_tt, sizeof(OSSL_CRMF_ENCRYPTEDVALUE_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 58 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 58 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_ENCRYPTEDVALUE), "OSSL_CRMF_ENCRYPTEDVALUE" }; return &local_it; }
OSSL_CRMF_ENCRYPTEDVALUE *d2i_OSSL_CRMF_ENCRYPTEDVALUE(OSSL_CRMF_ENCRYPTEDVALUE **a, const unsigned char **in, long len) { return (OSSL_CRMF_ENCRYPTEDVALUE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_ENCRYPTEDVALUE_it())); } int i2d_OSSL_CRMF_ENCRYPTEDVALUE(const OSSL_CRMF_ENCRYPTEDVALUE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_ENCRYPTEDVALUE_it())); } OSSL_CRMF_ENCRYPTEDVALUE *OSSL_CRMF_ENCRYPTEDVALUE_new(void) { return (OSSL_CRMF_ENCRYPTEDVALUE *)ASN1_item_new((OSSL_CRMF_ENCRYPTEDVALUE_it())); } void OSSL_CRMF_ENCRYPTEDVALUE_free(OSSL_CRMF_ENCRYPTEDVALUE *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_ENCRYPTEDVALUE_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_SINGLEPUBINFO_seq_tt[] = {
    { (0), (0), 
# 62 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 62 "../crypto/crmf/crmf_asn.c"
...
# 62 "../crypto/crmf/crmf_asn.c"
   , "pubMethod", (ASN1_INTEGER_it) },
    { (0), (0), 
# 63 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 63 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_SINGLEPUBINFO
# 63 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 63 "../crypto/crmf/crmf_asn.c"
...
# 63 "../crypto/crmf/crmf_asn.c"
   , "pubLocation", (GENERAL_NAME_it) }
} ; const ASN1_ITEM * OSSL_CRMF_SINGLEPUBINFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_SINGLEPUBINFO_seq_tt, sizeof(OSSL_CRMF_SINGLEPUBINFO_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 64 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 64 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_SINGLEPUBINFO), "OSSL_CRMF_SINGLEPUBINFO" }; return &local_it; }
OSSL_CRMF_SINGLEPUBINFO *d2i_OSSL_CRMF_SINGLEPUBINFO(OSSL_CRMF_SINGLEPUBINFO **a, const unsigned char **in, long len) { return (OSSL_CRMF_SINGLEPUBINFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_SINGLEPUBINFO_it())); } int i2d_OSSL_CRMF_SINGLEPUBINFO(const OSSL_CRMF_SINGLEPUBINFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_SINGLEPUBINFO_it())); } OSSL_CRMF_SINGLEPUBINFO *OSSL_CRMF_SINGLEPUBINFO_new(void) { return (OSSL_CRMF_SINGLEPUBINFO *)ASN1_item_new((OSSL_CRMF_SINGLEPUBINFO_it())); } void OSSL_CRMF_SINGLEPUBINFO_free(OSSL_CRMF_SINGLEPUBINFO *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_SINGLEPUBINFO_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_PKIPUBLICATIONINFO_seq_tt[] = {
    { (0), (0), 
# 68 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 68 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PKIPUBLICATIONINFO
# 68 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 68 "../crypto/crmf/crmf_asn.c"
...
# 68 "../crypto/crmf/crmf_asn.c"
   , "action", (ASN1_INTEGER_it) },
    { ((0x2 << 1)|(0x1)), (0), 
# 69 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 69 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PKIPUBLICATIONINFO
# 69 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 69 "../crypto/crmf/crmf_asn.c"
...
# 69 "../crypto/crmf/crmf_asn.c"
   , "pubInfos", (OSSL_CRMF_SINGLEPUBINFO_it) }

} ; const ASN1_ITEM * OSSL_CRMF_PKIPUBLICATIONINFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_PKIPUBLICATIONINFO_seq_tt, sizeof(OSSL_CRMF_PKIPUBLICATIONINFO_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 71 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 71 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_PKIPUBLICATIONINFO), "OSSL_CRMF_PKIPUBLICATIONINFO" }; return &local_it; }
OSSL_CRMF_PKIPUBLICATIONINFO *d2i_OSSL_CRMF_PKIPUBLICATIONINFO(OSSL_CRMF_PKIPUBLICATIONINFO **a, const unsigned char **in, long len) { return (OSSL_CRMF_PKIPUBLICATIONINFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_PKIPUBLICATIONINFO_it())); } int i2d_OSSL_CRMF_PKIPUBLICATIONINFO(const OSSL_CRMF_PKIPUBLICATIONINFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_PKIPUBLICATIONINFO_it())); } OSSL_CRMF_PKIPUBLICATIONINFO *OSSL_CRMF_PKIPUBLICATIONINFO_new(void) { return (OSSL_CRMF_PKIPUBLICATIONINFO *)ASN1_item_new((OSSL_CRMF_PKIPUBLICATIONINFO_it())); } void OSSL_CRMF_PKIPUBLICATIONINFO_free(OSSL_CRMF_PKIPUBLICATIONINFO *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_PKIPUBLICATIONINFO_it())); }
OSSL_CRMF_PKIPUBLICATIONINFO * OSSL_CRMF_PKIPUBLICATIONINFO_dup(const OSSL_CRMF_PKIPUBLICATIONINFO *x) { return ASN1_item_dup((OSSL_CRMF_PKIPUBLICATIONINFO_it()), x); }

static const ASN1_TEMPLATE OSSL_CRMF_PKMACVALUE_seq_tt[] = {
    { (0), (0), 
# 76 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 76 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PKMACVALUE
# 76 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 76 "../crypto/crmf/crmf_asn.c"
...
# 76 "../crypto/crmf/crmf_asn.c"
   , "algId", (X509_ALGOR_it) },
    { (0), (0), 
# 77 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 77 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PKMACVALUE
# 77 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 77 "../crypto/crmf/crmf_asn.c"
...
# 77 "../crypto/crmf/crmf_asn.c"
   , "value", (ASN1_BIT_STRING_it) }
} ; const ASN1_ITEM * OSSL_CRMF_PKMACVALUE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_PKMACVALUE_seq_tt, sizeof(OSSL_CRMF_PKMACVALUE_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 78 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 78 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_PKMACVALUE), "OSSL_CRMF_PKMACVALUE" }; return &local_it; }
OSSL_CRMF_PKMACVALUE *d2i_OSSL_CRMF_PKMACVALUE(OSSL_CRMF_PKMACVALUE **a, const unsigned char **in, long len) { return (OSSL_CRMF_PKMACVALUE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_PKMACVALUE_it())); } int i2d_OSSL_CRMF_PKMACVALUE(const OSSL_CRMF_PKMACVALUE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_PKMACVALUE_it())); } OSSL_CRMF_PKMACVALUE *OSSL_CRMF_PKMACVALUE_new(void) { return (OSSL_CRMF_PKMACVALUE *)ASN1_item_new((OSSL_CRMF_PKMACVALUE_it())); } void OSSL_CRMF_PKMACVALUE_free(OSSL_CRMF_PKMACVALUE *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_PKMACVALUE_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_POPOPRIVKEY_ch_tt[] = {
    { (((0x1 << 3)|(0x2<<6)) | (0)), (0), 
# 82 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 82 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOPRIVKEY
# 82 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 82 "../crypto/crmf/crmf_asn.c"
...
# 82 "../crypto/crmf/crmf_asn.c"
   , "value.thisMessage", (ASN1_BIT_STRING_it) },
    { (((0x1 << 3)|(0x2<<6)) | (0)), (1), 
# 83 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 83 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOPRIVKEY
# 83 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 83 "../crypto/crmf/crmf_asn.c"
...
# 83 "../crypto/crmf/crmf_asn.c"
   , "value.subsequentMessage", (ASN1_INTEGER_it) },
    { (((0x1 << 3)|(0x2<<6)) | (0)), (2), 
# 84 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 84 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOPRIVKEY
# 84 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 84 "../crypto/crmf/crmf_asn.c"
...
# 84 "../crypto/crmf/crmf_asn.c"
   , "value.dhMAC", (ASN1_BIT_STRING_it) },
    { (((0x1 << 3)|(0x2<<6)) | (0)), (3), 
# 85 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 85 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOPRIVKEY
# 85 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 85 "../crypto/crmf/crmf_asn.c"
...
# 85 "../crypto/crmf/crmf_asn.c"
   , "value.agreeMAC", (OSSL_CRMF_PKMACVALUE_it) },
    { (((0x1 << 3)|(0x2<<6)) | (0)), (4), 
# 86 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 86 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOPRIVKEY
# 86 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 86 "../crypto/crmf/crmf_asn.c"
...
# 86 "../crypto/crmf/crmf_asn.c"
   , "value.encryptedKey", (ASN1_NULL_it) },

} ; const ASN1_ITEM * OSSL_CRMF_POPOPRIVKEY_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 88 "../crypto/crmf/crmf_asn.c" 3 4
 __builtin_offsetof (
# 88 "../crypto/crmf/crmf_asn.c"
 OSSL_CRMF_POPOPRIVKEY
# 88 "../crypto/crmf/crmf_asn.c" 3 4
 , 
# 88 "../crypto/crmf/crmf_asn.c"
...
# 88 "../crypto/crmf/crmf_asn.c"
 , OSSL_CRMF_POPOPRIVKEY_ch_tt, sizeof(OSSL_CRMF_POPOPRIVKEY_ch_tt) / sizeof(ASN1_TEMPLATE), 
# 88 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 88 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_POPOPRIVKEY), "OSSL_CRMF_POPOPRIVKEY" }; return &local_it; }
OSSL_CRMF_POPOPRIVKEY *d2i_OSSL_CRMF_POPOPRIVKEY(OSSL_CRMF_POPOPRIVKEY **a, const unsigned char **in, long len) { return (OSSL_CRMF_POPOPRIVKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_POPOPRIVKEY_it())); } int i2d_OSSL_CRMF_POPOPRIVKEY(const OSSL_CRMF_POPOPRIVKEY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_POPOPRIVKEY_it())); } OSSL_CRMF_POPOPRIVKEY *OSSL_CRMF_POPOPRIVKEY_new(void) { return (OSSL_CRMF_POPOPRIVKEY *)ASN1_item_new((OSSL_CRMF_POPOPRIVKEY_it())); } void OSSL_CRMF_POPOPRIVKEY_free(OSSL_CRMF_POPOPRIVKEY *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_POPOPRIVKEY_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_PBMPARAMETER_seq_tt[] = {
    { (0), (0), 
# 92 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 92 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PBMPARAMETER
# 92 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 92 "../crypto/crmf/crmf_asn.c"
...
# 92 "../crypto/crmf/crmf_asn.c"
   , "salt", (ASN1_OCTET_STRING_it) },
    { (0), (0), 
# 93 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 93 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PBMPARAMETER
# 93 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 93 "../crypto/crmf/crmf_asn.c"
...
# 93 "../crypto/crmf/crmf_asn.c"
   , "owf", (X509_ALGOR_it) },
    { (0), (0), 
# 94 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 94 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PBMPARAMETER
# 94 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 94 "../crypto/crmf/crmf_asn.c"
...
# 94 "../crypto/crmf/crmf_asn.c"
   , "iterationCount", (ASN1_INTEGER_it) },
    { (0), (0), 
# 95 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 95 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_PBMPARAMETER
# 95 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 95 "../crypto/crmf/crmf_asn.c"
...
# 95 "../crypto/crmf/crmf_asn.c"
   , "mac", (X509_ALGOR_it) }
} ; const ASN1_ITEM * OSSL_CRMF_PBMPARAMETER_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_PBMPARAMETER_seq_tt, sizeof(OSSL_CRMF_PBMPARAMETER_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 96 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 96 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_PBMPARAMETER), "OSSL_CRMF_PBMPARAMETER" }; return &local_it; }
OSSL_CRMF_PBMPARAMETER *d2i_OSSL_CRMF_PBMPARAMETER(OSSL_CRMF_PBMPARAMETER **a, const unsigned char **in, long len) { return (OSSL_CRMF_PBMPARAMETER *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_PBMPARAMETER_it())); } int i2d_OSSL_CRMF_PBMPARAMETER(const OSSL_CRMF_PBMPARAMETER *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_PBMPARAMETER_it())); } OSSL_CRMF_PBMPARAMETER *OSSL_CRMF_PBMPARAMETER_new(void) { return (OSSL_CRMF_PBMPARAMETER *)ASN1_item_new((OSSL_CRMF_PBMPARAMETER_it())); } void OSSL_CRMF_PBMPARAMETER_free(OSSL_CRMF_PBMPARAMETER *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_PBMPARAMETER_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_ch_tt[] = {
    { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 100 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 100 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO
# 100 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 100 "../crypto/crmf/crmf_asn.c"
...
# 100 "../crypto/crmf/crmf_asn.c"
   , "value.sender", (GENERAL_NAME_it) }
                             ,
    { (0), (0), 
# 102 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 102 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO
# 102 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 102 "../crypto/crmf/crmf_asn.c"
...
# 102 "../crypto/crmf/crmf_asn.c"
   , "value.publicKeyMAC", (OSSL_CRMF_PKMACVALUE_it) }

} ; const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 104 "../crypto/crmf/crmf_asn.c" 3 4
 __builtin_offsetof (
# 104 "../crypto/crmf/crmf_asn.c"
 OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO
# 104 "../crypto/crmf/crmf_asn.c" 3 4
 , 
# 104 "../crypto/crmf/crmf_asn.c"
...
# 104 "../crypto/crmf/crmf_asn.c"
 , OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_ch_tt, sizeof(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_ch_tt) / sizeof(ASN1_TEMPLATE), 
# 104 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 104 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO), "OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO" }; return &local_it; }
OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *d2i_OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO **a, const unsigned char **in, long len) { return (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it())); } int i2d_OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO(const OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it())); } OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_new(void) { return (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *)ASN1_item_new((OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it())); } void OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_free(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_POPOSIGNINGKEYINPUT_seq_tt[] = {
    { (0), (0), 
# 108 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 108 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEYINPUT
# 108 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 108 "../crypto/crmf/crmf_asn.c"
...
# 108 "../crypto/crmf/crmf_asn.c"
   , "authInfo", (OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO_it) }
                                                       ,
    { (0), (0), 
# 110 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 110 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEYINPUT
# 110 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 110 "../crypto/crmf/crmf_asn.c"
...
# 110 "../crypto/crmf/crmf_asn.c"
   , "publicKey", (X509_PUBKEY_it) }
} ; const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEYINPUT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_POPOSIGNINGKEYINPUT_seq_tt, sizeof(OSSL_CRMF_POPOSIGNINGKEYINPUT_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 111 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 111 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_POPOSIGNINGKEYINPUT), "OSSL_CRMF_POPOSIGNINGKEYINPUT" }; return &local_it; }
OSSL_CRMF_POPOSIGNINGKEYINPUT *d2i_OSSL_CRMF_POPOSIGNINGKEYINPUT(OSSL_CRMF_POPOSIGNINGKEYINPUT **a, const unsigned char **in, long len) { return (OSSL_CRMF_POPOSIGNINGKEYINPUT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_POPOSIGNINGKEYINPUT_it())); } int i2d_OSSL_CRMF_POPOSIGNINGKEYINPUT(const OSSL_CRMF_POPOSIGNINGKEYINPUT *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_POPOSIGNINGKEYINPUT_it())); } OSSL_CRMF_POPOSIGNINGKEYINPUT *OSSL_CRMF_POPOSIGNINGKEYINPUT_new(void) { return (OSSL_CRMF_POPOSIGNINGKEYINPUT *)ASN1_item_new((OSSL_CRMF_POPOSIGNINGKEYINPUT_it())); } void OSSL_CRMF_POPOSIGNINGKEYINPUT_free(OSSL_CRMF_POPOSIGNINGKEYINPUT *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_POPOSIGNINGKEYINPUT_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_POPOSIGNINGKEY_seq_tt[] = {
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 115 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 115 "../crypto/crmf/crmf_asn.c"
...
# 115 "../crypto/crmf/crmf_asn.c"
   , "poposkInput", (OSSL_CRMF_POPOSIGNINGKEYINPUT_it) }
                                                  ,
    { (0), (0), 
# 117 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 117 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEY
# 117 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 117 "../crypto/crmf/crmf_asn.c"
...
# 117 "../crypto/crmf/crmf_asn.c"
   , "algorithmIdentifier", (X509_ALGOR_it) },
    { (0), (0), 
# 118 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 118 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPOSIGNINGKEY
# 118 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 118 "../crypto/crmf/crmf_asn.c"
...
# 118 "../crypto/crmf/crmf_asn.c"
   , "signature", (ASN1_BIT_STRING_it) }
} ; const ASN1_ITEM * OSSL_CRMF_POPOSIGNINGKEY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_POPOSIGNINGKEY_seq_tt, sizeof(OSSL_CRMF_POPOSIGNINGKEY_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 119 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 119 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_POPOSIGNINGKEY), "OSSL_CRMF_POPOSIGNINGKEY" }; return &local_it; }
OSSL_CRMF_POPOSIGNINGKEY *d2i_OSSL_CRMF_POPOSIGNINGKEY(OSSL_CRMF_POPOSIGNINGKEY **a, const unsigned char **in, long len) { return (OSSL_CRMF_POPOSIGNINGKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_POPOSIGNINGKEY_it())); } int i2d_OSSL_CRMF_POPOSIGNINGKEY(const OSSL_CRMF_POPOSIGNINGKEY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_POPOSIGNINGKEY_it())); } OSSL_CRMF_POPOSIGNINGKEY *OSSL_CRMF_POPOSIGNINGKEY_new(void) { return (OSSL_CRMF_POPOSIGNINGKEY *)ASN1_item_new((OSSL_CRMF_POPOSIGNINGKEY_it())); } void OSSL_CRMF_POPOSIGNINGKEY_free(OSSL_CRMF_POPOSIGNINGKEY *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_POPOSIGNINGKEY_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_POPO_ch_tt[] = {
    { (((0x1 << 3)|(0x2<<6)) | (0)), (0), 
# 123 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 123 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPO
# 123 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 123 "../crypto/crmf/crmf_asn.c"
...
# 123 "../crypto/crmf/crmf_asn.c"
   , "value.raVerified", (ASN1_NULL_it) },
    { (((0x1 << 3)|(0x2<<6)) | (0)), (1), 
# 124 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 124 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPO
# 124 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 124 "../crypto/crmf/crmf_asn.c"
...
# 124 "../crypto/crmf/crmf_asn.c"
   , "value.signature", (OSSL_CRMF_POPOSIGNINGKEY_it) },
    { (((0x2 << 3)|(0x2<<6)) | (0)), (2), 
# 125 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 125 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPO
# 125 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 125 "../crypto/crmf/crmf_asn.c"
...
# 125 "../crypto/crmf/crmf_asn.c"
   , "value.keyEncipherment", (OSSL_CRMF_POPOPRIVKEY_it) },
    { (((0x2 << 3)|(0x2<<6)) | (0)), (3), 
# 126 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 126 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_POPO
# 126 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 126 "../crypto/crmf/crmf_asn.c"
...
# 126 "../crypto/crmf/crmf_asn.c"
   , "value.keyAgreement", (OSSL_CRMF_POPOPRIVKEY_it) }
} ; const ASN1_ITEM * OSSL_CRMF_POPO_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 127 "../crypto/crmf/crmf_asn.c" 3 4
 __builtin_offsetof (
# 127 "../crypto/crmf/crmf_asn.c"
 OSSL_CRMF_POPO
# 127 "../crypto/crmf/crmf_asn.c" 3 4
 , 
# 127 "../crypto/crmf/crmf_asn.c"
...
# 127 "../crypto/crmf/crmf_asn.c"
 , OSSL_CRMF_POPO_ch_tt, sizeof(OSSL_CRMF_POPO_ch_tt) / sizeof(ASN1_TEMPLATE), 
# 127 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 127 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_POPO), "OSSL_CRMF_POPO" }; return &local_it; }
OSSL_CRMF_POPO *d2i_OSSL_CRMF_POPO(OSSL_CRMF_POPO **a, const unsigned char **in, long len) { return (OSSL_CRMF_POPO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_POPO_it())); } int i2d_OSSL_CRMF_POPO(const OSSL_CRMF_POPO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_POPO_it())); } OSSL_CRMF_POPO *OSSL_CRMF_POPO_new(void) { return (OSSL_CRMF_POPO *)ASN1_item_new((OSSL_CRMF_POPO_it())); } void OSSL_CRMF_POPO_free(OSSL_CRMF_POPO *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_POPO_it())); }

static const ASN1_TEMPLATE attributetypeandvalue_default_tt =
    { ((0x1)), (0), 
# 131 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 131 "../crypto/crmf/crmf_asn.c"
...
# 131 "../crypto/crmf/crmf_asn.c"
   , "value.other", (ASN1_ANY_it) };
static const ASN1_ADB_TABLE OSSL_CRMF_ATTRIBUTETYPEANDVALUE_adbtbl[] = {
    {315, { (0), (0), 
# 133 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 133 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 133 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 133 "../crypto/crmf/crmf_asn.c"
...
# 133 "../crypto/crmf/crmf_asn.c"
   , "value.regToken", (ASN1_UTF8STRING_it) }}

                                                           ,
    {316, { (0), (0), 
# 136 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 136 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 136 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 136 "../crypto/crmf/crmf_asn.c"
...
# 136 "../crypto/crmf/crmf_asn.c"
   , "value.authenticator", (ASN1_UTF8STRING_it) }}

                                                                ,
    {317, { (0), (0), 
# 139 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 139 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 139 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 139 "../crypto/crmf/crmf_asn.c"
...
# 139 "../crypto/crmf/crmf_asn.c"
   , "value.pkiPublicationInfo", (OSSL_CRMF_PKIPUBLICATIONINFO_it) }}


                                                        ,
    {319, { (0), (0), 
# 143 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 143 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 143 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 143 "../crypto/crmf/crmf_asn.c"
...
# 143 "../crypto/crmf/crmf_asn.c"
   , "value.oldCertID", (OSSL_CRMF_CERTID_it) }}

                                                             ,
    {320, { (0), (0), 
# 146 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 146 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 146 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 146 "../crypto/crmf/crmf_asn.c"
...
# 146 "../crypto/crmf/crmf_asn.c"
   , "value.protocolEncrKey", (X509_PUBKEY_it) }}

                                                              ,
    {321, { (0), (0), 
# 149 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 149 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 149 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 149 "../crypto/crmf/crmf_asn.c"
...
# 149 "../crypto/crmf/crmf_asn.c"
   , "value.utf8Pairs", (ASN1_UTF8STRING_it) }}

                                                            ,
    {322, { (0), (0), 
# 152 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 152 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 152 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 152 "../crypto/crmf/crmf_asn.c"
...
# 152 "../crypto/crmf/crmf_asn.c"
   , "value.certReq", (OSSL_CRMF_CERTREQUEST_it) }}

                                                                ,
} ; static const ASN1_ITEM *OSSL_CRMF_ATTRIBUTETYPEANDVALUE_adb(void) { static const ASN1_ADB internal_adb = { 0, 
# 155 "../crypto/crmf/crmf_asn.c" 3 4
 __builtin_offsetof (
# 155 "../crypto/crmf/crmf_asn.c"
 OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 155 "../crypto/crmf/crmf_asn.c" 3 4
 , 
# 155 "../crypto/crmf/crmf_asn.c"
...
# 155 "../crypto/crmf/crmf_asn.c"
 , 0, OSSL_CRMF_ATTRIBUTETYPEANDVALUE_adbtbl, sizeof(OSSL_CRMF_ATTRIBUTETYPEANDVALUE_adbtbl) / sizeof(ASN1_ADB_TABLE), &attributetypeandvalue_default_tt, 
# 155 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0) 
# 155 "../crypto/crmf/crmf_asn.c"
...
static const ASN1_TEMPLATE OSSL_CRMF_ATTRIBUTETYPEANDVALUE_seq_tt[] = {
    { (0), (0), 
# 159 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 159 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_ATTRIBUTETYPEANDVALUE
# 159 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 159 "../crypto/crmf/crmf_asn.c"
...
# 159 "../crypto/crmf/crmf_asn.c"
   , "type", (ASN1_OBJECT_it) },
    { (0x1<<8), -1, 0, "OSSL_CRMF_ATTRIBUTETYPEANDVALUE", OSSL_CRMF_ATTRIBUTETYPEANDVALUE_adb }
} ; const ASN1_ITEM * OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_ATTRIBUTETYPEANDVALUE_seq_tt, sizeof(OSSL_CRMF_ATTRIBUTETYPEANDVALUE_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 161 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 161 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_ATTRIBUTETYPEANDVALUE), "OSSL_CRMF_ATTRIBUTETYPEANDVALUE" }; return &local_it; }

OSSL_CRMF_ATTRIBUTETYPEANDVALUE *d2i_OSSL_CRMF_ATTRIBUTETYPEANDVALUE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE **a, const unsigned char **in, long len) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it())); } int i2d_OSSL_CRMF_ATTRIBUTETYPEANDVALUE(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it())); } OSSL_CRMF_ATTRIBUTETYPEANDVALUE *OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new(void) { return (OSSL_CRMF_ATTRIBUTETYPEANDVALUE *)ASN1_item_new((OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it())); } void OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(OSSL_CRMF_ATTRIBUTETYPEANDVALUE *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it())); }
OSSL_CRMF_ATTRIBUTETYPEANDVALUE * OSSL_CRMF_ATTRIBUTETYPEANDVALUE_dup(const OSSL_CRMF_ATTRIBUTETYPEANDVALUE *x) { return ASN1_item_dup((OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it()), x); }

static const ASN1_TEMPLATE OSSL_CRMF_OPTIONALVALIDITY_seq_tt[] = {
    { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 167 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 167 "../crypto/crmf/crmf_asn.c"
...
# 167 "../crypto/crmf/crmf_asn.c"
   , "notBefore", (ASN1_TIME_it) },
    { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 168 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 168 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_OPTIONALVALIDITY
# 168 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 168 "../crypto/crmf/crmf_asn.c"
...
# 168 "../crypto/crmf/crmf_asn.c"
   , "notAfter", (ASN1_TIME_it) }
} ; const ASN1_ITEM * OSSL_CRMF_OPTIONALVALIDITY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_OPTIONALVALIDITY_seq_tt, sizeof(OSSL_CRMF_OPTIONALVALIDITY_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 169 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 169 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_OPTIONALVALIDITY), "OSSL_CRMF_OPTIONALVALIDITY" }; return &local_it; }
OSSL_CRMF_OPTIONALVALIDITY *d2i_OSSL_CRMF_OPTIONALVALIDITY(OSSL_CRMF_OPTIONALVALIDITY **a, const unsigned char **in, long len) { return (OSSL_CRMF_OPTIONALVALIDITY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_OPTIONALVALIDITY_it())); } int i2d_OSSL_CRMF_OPTIONALVALIDITY(const OSSL_CRMF_OPTIONALVALIDITY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_OPTIONALVALIDITY_it())); } OSSL_CRMF_OPTIONALVALIDITY *OSSL_CRMF_OPTIONALVALIDITY_new(void) { return (OSSL_CRMF_OPTIONALVALIDITY *)ASN1_item_new((OSSL_CRMF_OPTIONALVALIDITY_it())); } void OSSL_CRMF_OPTIONALVALIDITY_free(OSSL_CRMF_OPTIONALVALIDITY *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_OPTIONALVALIDITY_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_CERTTEMPLATE_seq_tt[] = {
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 173 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 173 "../crypto/crmf/crmf_asn.c"
...
# 173 "../crypto/crmf/crmf_asn.c"
   , "version", (ASN1_INTEGER_it) },
    ...
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 178 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 178 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 178 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 178 "../crypto/crmf/crmf_asn.c"
...
# 178 "../crypto/crmf/crmf_asn.c"
   , "serialNumber", (ASN1_INTEGER_it) },
    ...
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 183 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 183 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 183 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 183 "../crypto/crmf/crmf_asn.c"
...
# 183 "../crypto/crmf/crmf_asn.c"
   , "signingAlg", (X509_ALGOR_it) },
    { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (3), 
# 184 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 184 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 184 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 184 "../crypto/crmf/crmf_asn.c"
...
# 184 "../crypto/crmf/crmf_asn.c"
   , "issuer", (X509_NAME_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (4), 
# 185 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 185 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 185 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 185 "../crypto/crmf/crmf_asn.c"
...
# 185 "../crypto/crmf/crmf_asn.c"
   , "validity", (OSSL_CRMF_OPTIONALVALIDITY_it) }
                                               ,
    { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (5), 
# 187 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 187 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 187 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 187 "../crypto/crmf/crmf_asn.c"
...
# 187 "../crypto/crmf/crmf_asn.c"
   , "subject", (X509_NAME_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (6), 
# 188 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 188 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 188 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 188 "../crypto/crmf/crmf_asn.c"
...
# 188 "../crypto/crmf/crmf_asn.c"
   , "publicKey", (X509_PUBKEY_it) },
    ...
    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (7), 
# 190 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 190 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 190 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 190 "../crypto/crmf/crmf_asn.c"
...
# 190 "../crypto/crmf/crmf_asn.c"
   , "issuerUID", (ASN1_BIT_STRING_it) },

    { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (8), 
# 192 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 192 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 192 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 192 "../crypto/crmf/crmf_asn.c"
...
# 192 "../crypto/crmf/crmf_asn.c"
   , "subjectUID", (ASN1_BIT_STRING_it) },
    { (((0x1 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (9), 
# 193 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 193 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTTEMPLATE
# 193 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 193 "../crypto/crmf/crmf_asn.c"
...
# 193 "../crypto/crmf/crmf_asn.c"
   , "extensions", (X509_EXTENSION_it) }
                                               ,
} ; const ASN1_ITEM * OSSL_CRMF_CERTTEMPLATE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_CERTTEMPLATE_seq_tt, sizeof(OSSL_CRMF_CERTTEMPLATE_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 195 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 195 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_CERTTEMPLATE), "OSSL_CRMF_CERTTEMPLATE" }; return &local_it; }
OSSL_CRMF_CERTTEMPLATE *d2i_OSSL_CRMF_CERTTEMPLATE(OSSL_CRMF_CERTTEMPLATE **a, const unsigned char **in, long len) { return (OSSL_CRMF_CERTTEMPLATE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_CERTTEMPLATE_it())); } int i2d_OSSL_CRMF_CERTTEMPLATE(const OSSL_CRMF_CERTTEMPLATE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_CERTTEMPLATE_it())); } OSSL_CRMF_CERTTEMPLATE *OSSL_CRMF_CERTTEMPLATE_new(void) { return (OSSL_CRMF_CERTTEMPLATE *)ASN1_item_new((OSSL_CRMF_CERTTEMPLATE_it())); } void OSSL_CRMF_CERTTEMPLATE_free(OSSL_CRMF_CERTTEMPLATE *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_CERTTEMPLATE_it())); }

static const ASN1_TEMPLATE OSSL_CRMF_CERTREQUEST_seq_tt[] = {
    { (0), (0), 
# 199 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 199 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTREQUEST
# 199 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 199 "../crypto/crmf/crmf_asn.c"
...
# 199 "../crypto/crmf/crmf_asn.c"
   , "certReqId", (ASN1_INTEGER_it) },
    { (0), (0), 
# 200 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 200 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTREQUEST
# 200 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 200 "../crypto/crmf/crmf_asn.c"
...
# 200 "../crypto/crmf/crmf_asn.c"
   , "certTemplate", (OSSL_CRMF_CERTTEMPLATE_it) },
    { ((0x2 << 1)|(0x1)), (0), 
# 201 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 201 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_CERTREQUEST
# 201 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 201 "../crypto/crmf/crmf_asn.c"
...
# 201 "../crypto/crmf/crmf_asn.c"
   , "controls", (OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it) }

} ; const ASN1_ITEM * OSSL_CRMF_CERTREQUEST_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_CERTREQUEST_seq_tt, sizeof(OSSL_CRMF_CERTREQUEST_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 203 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 203 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_CERTREQUEST), "OSSL_CRMF_CERTREQUEST" }; return &local_it; }
OSSL_CRMF_CERTREQUEST *d2i_OSSL_CRMF_CERTREQUEST(OSSL_CRMF_CERTREQUEST **a, const unsigned char **in, long len) { return (OSSL_CRMF_CERTREQUEST *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_CERTREQUEST_it())); } int i2d_OSSL_CRMF_CERTREQUEST(const OSSL_CRMF_CERTREQUEST *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_CERTREQUEST_it())); } OSSL_CRMF_CERTREQUEST *OSSL_CRMF_CERTREQUEST_new(void) { return (OSSL_CRMF_CERTREQUEST *)ASN1_item_new((OSSL_CRMF_CERTREQUEST_it())); } void OSSL_CRMF_CERTREQUEST_free(OSSL_CRMF_CERTREQUEST *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_CERTREQUEST_it())); }
OSSL_CRMF_CERTREQUEST * OSSL_CRMF_CERTREQUEST_dup(const OSSL_CRMF_CERTREQUEST *x) { return ASN1_item_dup((OSSL_CRMF_CERTREQUEST_it()), x); }

static const ASN1_TEMPLATE OSSL_CRMF_MSG_seq_tt[] = {
    { (0), (0), 
# 208 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 208 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_MSG
# 208 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 208 "../crypto/crmf/crmf_asn.c"
...
# 208 "../crypto/crmf/crmf_asn.c"
   , "certReq", (OSSL_CRMF_CERTREQUEST_it) },
    { ((0x1)), (0), 
# 209 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 209 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_MSG
# 209 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 209 "../crypto/crmf/crmf_asn.c"
...
# 209 "../crypto/crmf/crmf_asn.c"
   , "popo", (OSSL_CRMF_POPO_it) },
    { ((0x2 << 1)|(0x1)), (0), 
# 210 "../crypto/crmf/crmf_asn.c" 3 4
   __builtin_offsetof (
# 210 "../crypto/crmf/crmf_asn.c"
   OSSL_CRMF_MSG
# 210 "../crypto/crmf/crmf_asn.c" 3 4
   , 
# 210 "../crypto/crmf/crmf_asn.c"
...
# 210 "../crypto/crmf/crmf_asn.c"
   , "regInfo", (OSSL_CRMF_ATTRIBUTETYPEANDVALUE_it) }

} ; const ASN1_ITEM * OSSL_CRMF_MSG_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OSSL_CRMF_MSG_seq_tt, sizeof(OSSL_CRMF_MSG_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 212 "../crypto/crmf/crmf_asn.c" 3 4
 ((void *)0)
# 212 "../crypto/crmf/crmf_asn.c"
 , sizeof(OSSL_CRMF_MSG), "OSSL_CRMF_MSG" }; return &local_it; }
OSSL_CRMF_MSG *d2i_OSSL_CRMF_MSG(OSSL_CRMF_MSG **a, const unsigned char **in, long len) { return (OSSL_CRMF_MSG *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_MSG_it())); } int i2d_OSSL_CRMF_MSG(const OSSL_CRMF_MSG *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_MSG_it())); } OSSL_CRMF_MSG *OSSL_CRMF_MSG_new(void) { return (OSSL_CRMF_MSG *)ASN1_item_new((OSSL_CRMF_MSG_it())); } void OSSL_CRMF_MSG_free(OSSL_CRMF_MSG *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_MSG_it())); }
OSSL_CRMF_MSG * OSSL_CRMF_MSG_dup(const OSSL_CRMF_MSG *x) { return ASN1_item_dup((OSSL_CRMF_MSG_it()), x); }

static const ASN1_TEMPLATE OSSL_CRMF_MSGS_item_tt =
    { ((0x2 << 1)), (0), 0, "OSSL_CRMF_MSGS", (OSSL_CRMF_MSG_it) }

; const ASN1_ITEM * OSSL_CRMF_MSGS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &OSSL_CRMF_MSGS_item_tt, 0, 
# 219 "../crypto/crmf/crmf_asn.c" 3 4
((void *)0)
# 219 "../crypto/crmf/crmf_asn.c"
, 0, "OSSL_CRMF_MSGS" }; return &local_it; }
OSSL_CRMF_MSGS *d2i_OSSL_CRMF_MSGS(OSSL_CRMF_MSGS **a, const unsigned char **in, long len) { return (OSSL_CRMF_MSGS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OSSL_CRMF_MSGS_it())); } int i2d_OSSL_CRMF_MSGS(const OSSL_CRMF_MSGS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OSSL_CRMF_MSGS_it())); } OSSL_CRMF_MSGS *OSSL_CRMF_MSGS_new(void) { return (OSSL_CRMF_MSGS *)ASN1_item_new((OSSL_CRMF_MSGS_it())); } void OSSL_CRMF_MSGS_free(OSSL_CRMF_MSGS *a) { ASN1_item_free((ASN1_VALUE *)a, (OSSL_CRMF_MSGS_it())); }
