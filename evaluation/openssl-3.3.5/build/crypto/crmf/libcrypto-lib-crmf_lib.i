# 0 "../crypto/crmf/crmf_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/crmf/crmf_lib.c"
# 29 "../crypto/crmf/crmf_lib.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 30 "../crypto/crmf/crmf_lib.c" 2

# 1 "../crypto/crmf/crmf_local.h" 1
# 17 "../crypto/crmf/crmf_local.h"
...
# 19 "../crypto/crmf/crmf_local.h" 2


# 1 "../include/openssl/types.h" 1
# 22 "../crypto/crmf/crmf_local.h" 2
# 45 "../crypto/crmf/crmf_local.h"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 35 "../crypto/crmf/crmf_lib.c" 2
# 89 "../crypto/crmf/crmf_lib.c"
                                       ...
                                       OSSL_CRMF_ATTRIBUTETYPEANDVALUE *ctrl)
{
    ...
    if (crm == 
# 94 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 94 "../crypto/crmf/crmf_lib.c"
                   || crm->certReq == 
# 94 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0) 
# 94 "../crypto/crmf/crmf_lib.c"
...
# 94 "../crypto/crmf/crmf_lib.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",95,__func__), ERR_set_error)((56),(109),
# 95 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 95 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if (crm->certReq->controls == 
# 99 "../crypto/crmf/crmf_lib.c" 3 4
                                 ((void *)0)
# 99 "../crypto/crmf/crmf_lib.c"
                                     ) {
        crm->certReq->controls = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_null();
        if (crm->certReq->controls == 
# 101 "../crypto/crmf/crmf_lib.c" 3 4
                                     ((void *)0)
# 101 "../crypto/crmf/crmf_lib.c"
                                         )
            goto err;
        new = 1;
    }
...
# 112 "../crypto/crmf/crmf_lib.c" 3 4
                                ((void *)0)
# 112 "../crypto/crmf/crmf_lib.c"
                                    ;
    }
    return 0;
}
...
ASN1_STRING *OSSL_CRMF_MSG_get0_regCtrl_regToken(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 118 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 315) return atav->value.regToken; } return 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regCtrl_regToken(OSSL_CRMF_MSG *msg, const ASN1_STRING *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav = OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new()) == 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(315)) == 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.regToken = ASN1_STRING_dup(in)) == 
# 118 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 118 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regCtrl(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }



ASN1_UTF8STRING *OSSL_CRMF_MSG_get0_regCtrl_authenticator(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 122 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 316) return atav->value.authenticator; } return 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regCtrl_authenticator(OSSL_CRMF_MSG *msg, const ASN1_UTF8STRING *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(316)) == 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.authenticator = ASN1_STRING_dup(in)) == 
# 122 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 122 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regCtrl(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }
...
{
    if (spi == 
# 127 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0)
            
# 128 "../crypto/crmf/crmf_lib.c"
           || method < 0
            || method > 3) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",130,__func__), ERR_set_error)((56),((262|(0x2 << 18L))),
# 130 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 130 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
...
{
    if (pi == 
# 145 "../crypto/crmf/crmf_lib.c" 3 4
             ((void *)0) 
# 145 "../crypto/crmf/crmf_lib.c"
                  || spi == 
# 145 "../crypto/crmf/crmf_lib.c" 3 4
                            ((void *)0)
# 145 "../crypto/crmf/crmf_lib.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",146,__func__), ERR_set_error)((56),(109),
# 146 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 146 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    if (pi->pubInfos == 
# 149 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 149 "../crypto/crmf/crmf_lib.c"
                           )
        pi->pubInfos = sk_OSSL_CRMF_SINGLEPUBINFO_new_null();
    if (pi->pubInfos == 
# 151 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 151 "../crypto/crmf/crmf_lib.c"
                           )
        return 0;
...
{
    if (pi == 
# 160 "../crypto/crmf/crmf_lib.c" 3 4
             ((void *)0)
            
# 161 "../crypto/crmf/crmf_lib.c"
           || action < 0
            || action > 1) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",163,__func__), ERR_set_error)((56),((262|(0x2 << 18L))),
# 163 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 163 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
...
OSSL_CRMF_PKIPUBLICATIONINFO *OSSL_CRMF_MSG_get0_regCtrl_pkiPublicationInfo(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 171 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 317) return atav->value.pkiPublicationInfo; } return 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regCtrl_pkiPublicationInfo(OSSL_CRMF_MSG *msg, const OSSL_CRMF_PKIPUBLICATIONINFO *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(317)) == 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.pkiPublicationInfo = OSSL_CRMF_PKIPUBLICATIONINFO_dup(in)) == 
# 171 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 171 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regCtrl(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }
...
OSSL_CRMF_CERTID *OSSL_CRMF_MSG_get0_regCtrl_oldCertID(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 175 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 319) return atav->value.oldCertID; } return 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regCtrl_oldCertID(OSSL_CRMF_MSG *msg, const OSSL_CRMF_CERTID *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(319)) == 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.oldCertID = OSSL_CRMF_CERTID_dup(in)) == 
# 175 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 175 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regCtrl(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }
...
# 180 "../crypto/crmf/crmf_lib.c" 3 4
                           ((void *)0)
# 180 "../crypto/crmf/crmf_lib.c"
                               ;

    if (issuer == 
# 182 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0) 
# 182 "../crypto/crmf/crmf_lib.c"
                      || serial == 
# 182 "../crypto/crmf/crmf_lib.c" 3 4
                                   ((void *)0)
# 182 "../crypto/crmf/crmf_lib.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",183,__func__), ERR_set_error)((56),(109),
# 183 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 183 "../crypto/crmf/crmf_lib.c"
       );
        return 
# 184 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0)
# 184 "../crypto/crmf/crmf_lib.c"
                  ;
    }

    if ((cid = OSSL_CRMF_CERTID_new()) == 
# 187 "../crypto/crmf/crmf_lib.c" 3 4
                                         ((void *)0)
# 187 "../crypto/crmf/crmf_lib.c"
                                             )
        goto err;
    ...
    if ((cid->serialNumber = ASN1_INTEGER_dup(serial)) == 
# 195 "../crypto/crmf/crmf_lib.c" 3 4
                                                         ((void *)0)
# 195 "../crypto/crmf/crmf_lib.c"
                                                             )
        goto err;
 ...
 err:
    ...
    return 
# 202 "../crypto/crmf/crmf_lib.c" 3 4
          ((void *)0)
# 202 "../crypto/crmf/crmf_lib.c"
              ;
}
...
X509_PUBKEY *OSSL_CRMF_MSG_get0_regCtrl_protocolEncrKey(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 208 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 320) return atav->value.protocolEncrKey; } return 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regCtrl_protocolEncrKey(OSSL_CRMF_MSG *msg, const X509_PUBKEY *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(320)) == 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.protocolEncrKey = X509_PUBKEY_dup(in)) == 
# 208 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 208 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regCtrl(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }
...
{
    struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *info = 
# 218 "../crypto/crmf/crmf_lib.c" 3 4
                                                     ((void *)0)
# 218 "../crypto/crmf/crmf_lib.c"
                                                         ;

    if (crm == 
# 220 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 220 "../crypto/crmf/crmf_lib.c"
                   || ri == 
# 220 "../crypto/crmf/crmf_lib.c" 3 4
                            ((void *)0)
# 220 "../crypto/crmf/crmf_lib.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",221,__func__), ERR_set_error)((56),(109),
# 221 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 221 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if (crm->regInfo == 
# 225 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 225 "../crypto/crmf/crmf_lib.c"
                           )
        crm->regInfo = info = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_null();
    if (crm->regInfo == 
# 227 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 227 "../crypto/crmf/crmf_lib.c"
                           )
        goto err;
 ...
 err:
    if (info != 
# 234 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 234 "../crypto/crmf/crmf_lib.c"
                   )
        crm->regInfo = 
# 235 "../crypto/crmf/crmf_lib.c" 3 4
                      ((void *)0)
# 235 "../crypto/crmf/crmf_lib.c"
                          ;
...
ASN1_UTF8STRING *OSSL_CRMF_MSG_get0_regInfo_utf8Pairs(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 241 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 321) return atav->value.utf8Pairs; } return 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regInfo_utf8Pairs(OSSL_CRMF_MSG *msg, const ASN1_UTF8STRING *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(321)) == 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.utf8Pairs = ASN1_STRING_dup(in)) == 
# 241 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 241 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regInfo(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }


OSSL_CRMF_CERTREQUEST *OSSL_CRMF_MSG_get0_regInfo_certReq(const OSSL_CRMF_MSG *msg) { int i; struct stack_st_OSSL_CRMF_ATTRIBUTETYPEANDVALUE *controls; OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
; if (msg == 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0) 
# 244 "../crypto/crmf/crmf_lib.c"
...
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
; controls = msg->certReq->controls; for (i = 0; i < sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_num(controls); i++) { atav = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_value(controls, i); if (OBJ_obj2nid(atav->type) == 322) return atav->value.certReq; } return 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
; } int OSSL_CRMF_MSG_set1_regInfo_certReq(OSSL_CRMF_MSG *msg, const OSSL_CRMF_CERTREQUEST *in) { OSSL_CRMF_ATTRIBUTETYPEANDVALUE *atav = 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
; if (msg == 
...
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->type = OBJ_nid2obj(322)) == 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
) goto err; if ((atav->value.certReq = OSSL_CRMF_CERTREQUEST_dup(in)) == 
# 244 "../crypto/crmf/crmf_lib.c" 3 4
((void *)0)
# 244 "../crypto/crmf/crmf_lib.c"
) goto err; if (!OSSL_CRMF_MSG_push0_regInfo(msg, atav)) goto err; return 1; err: OSSL_CRMF_ATTRIBUTETYPEANDVALUE_free(atav); return 0; }
...
{
    if (crm == 
# 249 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 249 "../crypto/crmf/crmf_lib.c"
                   || crm->certReq == 
# 249 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0)
# 249 "../crypto/crmf/crmf_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",250,__func__), ERR_set_error)((56),(109),
# 250 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 250 "../crypto/crmf/crmf_lib.c"
       );
        return 
# 251 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0)
# 251 "../crypto/crmf/crmf_lib.c"
                  ;
    }
                                ...
                                ASN1_TIME *notBefore, ASN1_TIME *notAfter)
{
    ...
    if (tmpl == 
# 262 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 262 "../crypto/crmf/crmf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",263,__func__), ERR_set_error)((56),(109),
# 263 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 263 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if ((vld = OSSL_CRMF_OPTIONALVALIDITY_new()) == 
# 267 "../crypto/crmf/crmf_lib.c" 3 4
                                                   ((void *)0)
# 267 "../crypto/crmf/crmf_lib.c"
                                                       )
        return 0;
...
{
    if (crm == 
# 277 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 277 "../crypto/crmf/crmf_lib.c"
                   || crm->certReq == 
# 277 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0) 
# 277 "../crypto/crmf/crmf_lib.c"
...
# 277 "../crypto/crmf/crmf_lib.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",278,__func__), ERR_set_error)((56),(109),
# 278 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 278 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
...
static int crmf_asn1_get_int(const ASN1_INTEGER *a)
{
    ...
    if (!ASN1_INTEGER_get_int64(&res, a)) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",291,__func__), ERR_set_error)((56),(187),
# 291 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 291 "../crypto/crmf/crmf_lib.c"
       );
        return -1;
    }
    if (res < 
# 294 "../crypto/crmf/crmf_lib.c" 3 4
             (-0x7fffffff - 1)
# 294 "../crypto/crmf/crmf_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",295,__func__), ERR_set_error)((56),(224),
# 295 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 295 "../crypto/crmf/crmf_lib.c"
       );
        return -1;
    }
    if (res > 0x7fffffff
# 298 "../crypto/crmf/crmf_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",299,__func__), ERR_set_error)((56),(223),
# 299 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 299 "../crypto/crmf/crmf_lib.c"
       );
        return -1;
    }
    return (int)res;
...
{
    if (crm == 
# 307 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 307 "../crypto/crmf/crmf_lib.c"
                   || crm->certReq == 
# 307 "../crypto/crmf/crmf_lib.c" 3 4
                                                               ((void *)0)
# 307 "../crypto/crmf/crmf_lib.c"
                                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",308,__func__), ERR_set_error)((56),(109),
# 308 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 308 "../crypto/crmf/crmf_lib.c"
       );
        return -1;
    }
                                  ...
                                  X509_EXTENSIONS *exts)
{
    ...
    if (tmpl == 
# 319 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 319 "../crypto/crmf/crmf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",320,__func__), ERR_set_error)((56),(109),
# 320 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 320 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if (OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts)) == 0) {
        OPENSSL_sk_free(ossl_check_X509_EXTENSION_sk_type(exts));
        exts = 
# 326 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0)
# 326 "../crypto/crmf/crmf_lib.c"
                  ;
    }

    OPENSSL_sk_pop_free(ossl_check_X509_EXTENSION_sk_type(tmpl->extensions),ossl_check_X509_EXTENSION_freefunc_type(X509_EXTENSION_free));
                                  ...
                                  X509_EXTENSION *ext)
{
    ...
    if (tmpl == 
# 340 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0) 
# 340 "../crypto/crmf/crmf_lib.c"
                    || ext == 
# 340 "../crypto/crmf/crmf_lib.c" 3 4
                              ((void *)0)
# 340 "../crypto/crmf/crmf_lib.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",341,__func__), ERR_set_error)((56),(109),
# 341 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 341 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if (tmpl->extensions == 
# 345 "../crypto/crmf/crmf_lib.c" 3 4
                           ((void *)0)
# 345 "../crypto/crmf/crmf_lib.c"
                               ) {
        if ((tmpl->extensions = ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_null())) == 
# 346 "../crypto/crmf/crmf_lib.c" 3 4
                                                                ((void *)0)
# 346 "../crypto/crmf/crmf_lib.c"
                                                                    )
            goto err;
        new = 1;
    }

    if (!OPENSSL_sk_push(ossl_check_X509_EXTENSION_sk_type(tmpl->extensions), ossl_check_X509_EXTENSION_type(ext)))
        goto err;
    return 1;
 err:
    if (new != 0) {
        OPENSSL_sk_free(ossl_check_X509_EXTENSION_sk_type(tmpl->extensions));
        tmpl->extensions = 
# 357 "../crypto/crmf/crmf_lib.c" 3 4
                          ((void *)0)
# 357 "../crypto/crmf/crmf_lib.c"
                              ;
    }
    return 0;
}
                                 ...
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (ps == 
# 370 "../crypto/crmf/crmf_lib.c" 3 4
             ((void *)0) 
# 370 "../crypto/crmf/crmf_lib.c"
                  || cr == 
# 370 "../crypto/crmf/crmf_lib.c" 3 4
                           ((void *)0) 
# 370 "../crypto/crmf/crmf_lib.c"
...
# 370 "../crypto/crmf/crmf_lib.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",371,__func__), ERR_set_error)((56),(109),
# 371 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 371 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    ...
    if (ps->poposkInput != 
# 378 "../crypto/crmf/crmf_lib.c" 3 4
                          ((void *)0)
# 378 "../crypto/crmf/crmf_lib.c"
                              ) {

        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",380,__func__), ERR_set_error)((56),(113),
# 380 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 380 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    ...
    if (EVP_PKEY_get_default_digest_name(pkey, name, sizeof(name)) > 0
            && strcmp(name, "UNDEF") == 0)
        digest = 
# 386 "../crypto/crmf/crmf_lib.c" 3 4
                ((void *)0)
# 386 "../crypto/crmf/crmf_lib.c"
                    ;

    return ASN1_item_sign_ex((OSSL_CRMF_CERTREQUEST_it()),
                             ps->algorithmIdentifier,
                             
# 390 "../crypto/crmf/crmf_lib.c" 3 4
                            ((void *)0)
# 390 "../crypto/crmf/crmf_lib.c"
                                , ps->signature,
                             cr, 
# 391 "../crypto/crmf/crmf_lib.c" 3 4
                                ((void *)0)
# 391 "../crypto/crmf/crmf_lib.c"
                                    , pkey, digest, libctx, propq);
}
...
{
    OSSL_CRMF_POPO *pp = 
# 398 "../crypto/crmf/crmf_lib.c" 3 4
                        ((void *)0)
# 398 "../crypto/crmf/crmf_lib.c"
                            ;
    ASN1_INTEGER *tag = 
# 399 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 399 "../crypto/crmf/crmf_lib.c"
                           ;

    if (crm == 
# 401 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0) 
# 401 "../crypto/crmf/crmf_lib.c"
                   || (meth == 1 && pkey == 
# 401 "../crypto/crmf/crmf_lib.c" 3 4
                                                                   ((void *)0)
# 401 "../crypto/crmf/crmf_lib.c"
                                                                       )) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",402,__func__), ERR_set_error)((56),(109),
# 402 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 402 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    ...
    if (meth == -1)
        goto end;
    if ((pp = OSSL_CRMF_POPO_new()) == 
# 408 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0)
# 408 "../crypto/crmf/crmf_lib.c"
                                          )
        goto err;
    pp->type = meth;
    ...
    switch (meth) {
    case 0:
        if ((pp->value.raVerified = ASN1_NULL_new()) == 
# 414 "../crypto/crmf/crmf_lib.c" 3 4
                                                       ((void *)0)
# 414 "../crypto/crmf/crmf_lib.c"
                                                           )
            goto err;
        break;
    ...
    case 1:
        {
            ...
            if (ps == 
# 422 "../crypto/crmf/crmf_lib.c" 3 4
                     ((void *)0)
# 422 "../crypto/crmf/crmf_lib.c"
                         )
                goto err;
...
# 434 "../crypto/crmf/crmf_lib.c" 3 4
                                                                        ((void *)0)
# 434 "../crypto/crmf/crmf_lib.c"
                                                                            )
            goto err;
        ...
        if (tag == 
# 440 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0)
                
# 441 "../crypto/crmf/crmf_lib.c"
               || !ASN1_INTEGER_set(tag, 0))
            goto err;
        break;

    default:
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",446,__func__), ERR_set_error)((56),(115),
# 446 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 446 "../crypto/crmf/crmf_lib.c"
       );
        goto err;
    }
...
{
    OSSL_CRMF_MSG *req = 
# 465 "../crypto/crmf/crmf_lib.c" 3 4
                        ((void *)0)
# 465 "../crypto/crmf/crmf_lib.c"
                            ;
    X509_PUBKEY *pubkey = 
# 466 "../crypto/crmf/crmf_lib.c" 3 4
                         ((void *)0)
# 466 "../crypto/crmf/crmf_lib.c"
                             ;
    OSSL_CRMF_POPOSIGNINGKEY *sig = 
# 467 "../crypto/crmf/crmf_lib.c" 3 4
                                   ((void *)0)
# 467 "../crypto/crmf/crmf_lib.c"
                                       ;
    const ASN1_ITEM *it;
    void *asn;

    if (reqs == 
# 471 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0) 
# 471 "../crypto/crmf/crmf_lib.c"
                    || (req = ((OSSL_CRMF_MSG *)OPENSSL_sk_value(ossl_check_const_OSSL_CRMF_MSG_sk_type(reqs), (rid)))) == 
# 471 "../crypto/crmf/crmf_lib.c" 3 4
                                                                    ((void *)0)
# 471 "../crypto/crmf/crmf_lib.c"
                                                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",472,__func__), ERR_set_error)((56),(109),
# 472 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 472 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }

    if (req->popo == 
# 476 "../crypto/crmf/crmf_lib.c" 3 4
                    ((void *)0)
# 476 "../crypto/crmf/crmf_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",477,__func__), ERR_set_error)((56),(121),
# 477 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 477 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    ...
    case 0:
        if (!acceptRAVerified) {
            (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",484,__func__), ERR_set_error)((56),(120),
# 484 "../crypto/crmf/crmf_lib.c" 3 4
           ((void *)0)
# 484 "../crypto/crmf/crmf_lib.c"
           );
            return 0;
        }
        break;
    case 1:
        ...
        if (pubkey == 
# 490 "../crypto/crmf/crmf_lib.c" 3 4
                     ((void *)0)
# 490 "../crypto/crmf/crmf_lib.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",491,__func__), ERR_set_error)((56),(118),
# 491 "../crypto/crmf/crmf_lib.c" 3 4
           ((void *)0)
# 491 "../crypto/crmf/crmf_lib.c"
           );
            return 0;
        }
        sig = req->popo->value.signature;
        if (sig->poposkInput != 
# 495 "../crypto/crmf/crmf_lib.c" 3 4
                               ((void *)0)
# 495 "../crypto/crmf/crmf_lib.c"
                                   ) {
            ...
            if (sig->poposkInput->publicKey == 
# 501 "../crypto/crmf/crmf_lib.c" 3 4
                                              ((void *)0)
# 501 "../crypto/crmf/crmf_lib.c"
                                                  ) {
                (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",502,__func__), ERR_set_error)((56),(118),
# 502 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 502 "../crypto/crmf/crmf_lib.c"
               );
                return 0;
            }
            if (X509_PUBKEY_eq(pubkey, sig->poposkInput->publicKey) != 1) {
                (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",506,__func__), ERR_set_error)((56),(117),
# 506 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 506 "../crypto/crmf/crmf_lib.c"
               );
                return 0;
            }
            ...
            it = (OSSL_CRMF_POPOSIGNINGKEYINPUT_it());
            asn = sig->poposkInput;
        } else {
            if (req->certReq->certTemplate->subject == 
# 518 "../crypto/crmf/crmf_lib.c" 3 4
                                                      ((void *)0)
# 518 "../crypto/crmf/crmf_lib.c"
                                                          ) {
                (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",519,__func__), ERR_set_error)((56),(119),
# 519 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 519 "../crypto/crmf/crmf_lib.c"
               );
                return 0;
            }
            it = (OSSL_CRMF_CERTREQUEST_it());
            asn = req->certReq;
        }
        if (ASN1_item_verify_ex(it, sig->algorithmIdentifier, sig->signature,
                                asn, 
# 526 "../crypto/crmf/crmf_lib.c" 3 4
                                    ((void *)0)
# 526 "../crypto/crmf/crmf_lib.c"
                                        , X509_PUBKEY_get0(pubkey), libctx,
                                propq) < 1)
            return 0;
        break;
    case 2:
    ...
    case 3:
    default:
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",539,__func__), ERR_set_error)((56),(116),
# 539 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 539 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    return 1;
...
{
    return tmpl != 
# 548 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 548 "../crypto/crmf/crmf_lib.c"
                       ? tmpl->publicKey : 
# 548 "../crypto/crmf/crmf_lib.c" 3 4
                                           ((void *)0)
# 548 "../crypto/crmf/crmf_lib.c"
...
{
    return tmpl != 
# 554 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 554 "../crypto/crmf/crmf_lib.c"
                       ? tmpl->serialNumber : 
# 554 "../crypto/crmf/crmf_lib.c" 3 4
                                              ((void *)0)
# 554 "../crypto/crmf/crmf_lib.c"
...
{
    return tmpl != 
# 560 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 560 "../crypto/crmf/crmf_lib.c"
                       ? tmpl->subject : 
# 560 "../crypto/crmf/crmf_lib.c" 3 4
                                         ((void *)0)
# 560 "../crypto/crmf/crmf_lib.c"
...
{
    return tmpl != 
# 566 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 566 "../crypto/crmf/crmf_lib.c"
                       ? tmpl->issuer : 
# 566 "../crypto/crmf/crmf_lib.c" 3 4
                                        ((void *)0)
# 566 "../crypto/crmf/crmf_lib.c"
...
{
    return tmpl != 
# 572 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 572 "../crypto/crmf/crmf_lib.c"
                       ? tmpl->extensions : 
# 572 "../crypto/crmf/crmf_lib.c" 3 4
                                            ((void *)0)
# 572 "../crypto/crmf/crmf_lib.c"
...
{
    return cid != 
# 577 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0) 
# 577 "../crypto/crmf/crmf_lib.c"
                      && cid->issuer->type == 4 ?
        cid->issuer->d.directoryName : 
# 578 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0)
# 578 "../crypto/crmf/crmf_lib.c"
                                          ;
}
...
{
    return cid != 
# 584 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0) 
# 584 "../crypto/crmf/crmf_lib.c"
                      ? cid->serialNumber : 
# 584 "../crypto/crmf/crmf_lib.c" 3 4
                                            ((void *)0)
# 584 "../crypto/crmf/crmf_lib.c"
...
{
    if (tmpl == 
# 597 "../crypto/crmf/crmf_lib.c" 3 4
               ((void *)0)
# 597 "../crypto/crmf/crmf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",598,__func__), ERR_set_error)((56),(109),
# 598 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 598 "../crypto/crmf/crmf_lib.c"
       );
        return 0;
    }
    if (subject != 
# 601 "../crypto/crmf/crmf_lib.c" 3 4
                  ((void *)0) 
# 601 "../crypto/crmf/crmf_lib.c"
                       && !X509_NAME_set((X509_NAME **)&tmpl->subject, subject))
        return 0;
    if (issuer != 
# 603 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0) 
# 603 "../crypto/crmf/crmf_lib.c"
                      && !X509_NAME_set((X509_NAME **)&tmpl->issuer, issuer))
        return 0;
    if (serial != 
# 605 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0)
# 605 "../crypto/crmf/crmf_lib.c"
                     ) {
        ASN1_INTEGER_free(tmpl->serialNumber);
        if ((tmpl->serialNumber = ASN1_INTEGER_dup(serial)) == 
# 607 "../crypto/crmf/crmf_lib.c" 3 4
                                                              ((void *)0)
# 607 "../crypto/crmf/crmf_lib.c"
                                                                  )
            return 0;
    }
    if (pubkey != 
# 610 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0) 
# 610 "../crypto/crmf/crmf_lib.c"
                      && !X509_PUBKEY_set(&tmpl->publicKey, pubkey))
        return 0;
    return 1;
}
# 622 "../crypto/crmf/crmf_lib.c"
X509
*OSSL_CRMF_ENCRYPTEDVALUE_get1_encCert(const OSSL_CRMF_ENCRYPTEDVALUE *ecert,
                                       OSSL_LIB_CTX *libctx, const char *propq,
                                       EVP_PKEY *pkey)
{
    X509 *cert = 
# 627 "../crypto/crmf/crmf_lib.c" 3 4
                ((void *)0)
# 627 "../crypto/crmf/crmf_lib.c"
                    ;
    EVP_CIPHER_CTX *evp_ctx = 
# 628 "../crypto/crmf/crmf_lib.c" 3 4
                             ((void *)0)
# 628 "../crypto/crmf/crmf_lib.c"
                                 ;
    unsigned char *ek = 
# 629 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 629 "../crypto/crmf/crmf_lib.c"
                           ;
    size_t eksize = 0;
    EVP_CIPHER *cipher = 
# 631 "../crypto/crmf/crmf_lib.c" 3 4
                        ((void *)0)
# 631 "../crypto/crmf/crmf_lib.c"
                            ;
    int cikeysize = 0;
    unsigned char *iv = 
# 633 "../crypto/crmf/crmf_lib.c" 3 4
                       ((void *)0)
# 633 "../crypto/crmf/crmf_lib.c"
                           ;
    unsigned char *outbuf = 
# 634 "../crypto/crmf/crmf_lib.c" 3 4
                           ((void *)0)
# 634 "../crypto/crmf/crmf_lib.c"
                               ;
    const unsigned char *p = 
# 635 "../crypto/crmf/crmf_lib.c" 3 4
                            ((void *)0)
# 635 "../crypto/crmf/crmf_lib.c"
                                ;
    int n, outlen = 0;
    EVP_PKEY_CTX *pkctx = 
# 637 "../crypto/crmf/crmf_lib.c" 3 4
                         ((void *)0)
# 637 "../crypto/crmf/crmf_lib.c"
                             ;
    char name[50];

    if (ecert == 
# 640 "../crypto/crmf/crmf_lib.c" 3 4
                ((void *)0) 
# 640 "../crypto/crmf/crmf_lib.c"
                     || ecert->symmAlg == 
# 640 "../crypto/crmf/crmf_lib.c" 3 4
                                          ((void *)0) 
# 640 "../crypto/crmf/crmf_lib.c"
...
# 641 "../crypto/crmf/crmf_lib.c"
           || ecert->encValue == 
# 641 "../crypto/crmf/crmf_lib.c" 3 4
                                 ((void *)0) 
# 641 "../crypto/crmf/crmf_lib.c"
                                      || pkey == 
# 641 "../crypto/crmf/crmf_lib.c" 3 4
...
# 641 "../crypto/crmf/crmf_lib.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",642,__func__), ERR_set_error)((56),(109),
# 642 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 642 "../crypto/crmf/crmf_lib.c"
       );
        return 
# 643 "../crypto/crmf/crmf_lib.c" 3 4
              ((void *)0)
# 643 "../crypto/crmf/crmf_lib.c"
                  ;
    }
...
# 650 "../crypto/crmf/crmf_lib.c" 3 4
                             ((void *)0)
# 650 "../crypto/crmf/crmf_lib.c"
                                 , name, 
# 650 "../crypto/crmf/crmf_lib.c" 3 4
                                         ((void *)0)
# 650 "../crypto/crmf/crmf_lib.c"
    ...
    if (cipher == 
# 652 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0)
# 652 "../crypto/crmf/crmf_lib.c"
                     )
        cipher = (EVP_CIPHER *)EVP_get_cipherbyname(name);

    if (cipher == 
# 655 "../crypto/crmf/crmf_lib.c" 3 4
                 ((void *)0)
# 655 "../crypto/crmf/crmf_lib.c"
                     ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",657,__func__), ERR_set_error)((56),(114),
# 657 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 657 "../crypto/crmf/crmf_lib.c"
       );
        goto end;
    }
    ...
    if (pkctx == 
# 665 "../crypto/crmf/crmf_lib.c" 3 4
                ((void *)0) 
# 665 "../crypto/crmf/crmf_lib.c"
                     || EVP_PKEY_decrypt_init(pkctx) <= 0
        || evp_pkey_decrypt_alloc(pkctx, &ek, &eksize, (size_t)cikeysize,
                                  ecert->encSymmKey->data,
                                  ecert->encSymmKey->length) <= 0)
        goto end;

    if ((iv = CRYPTO_malloc(EVP_CIPHER_get_iv_length(cipher), "../crypto/crmf/crmf_lib.c", 671)) == 
# 671 "../crypto/crmf/crmf_lib.c" 3 4
                                                                  ((void *)0)
# 671 "../crypto/crmf/crmf_lib.c"
                                                                      )
        goto end;
    if (ASN1_TYPE_get_octetstring(ecert->symmAlg->parameter, iv,
                                  EVP_CIPHER_get_iv_length(cipher))
        != EVP_CIPHER_get_iv_length(cipher)) {
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",676,__func__), ERR_set_error)((56),(101),
# 676 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 676 "../crypto/crmf/crmf_lib.c"
       );
        goto end;
    }
    ...
    if ((p = outbuf = CRYPTO_malloc(ecert->encValue->length + EVP_CIPHER_get_block_size(cipher), "../crypto/crmf/crmf_lib.c", 684)
                                                                       ) == 
# 685 "../crypto/crmf/crmf_lib.c" 3 4
                                                                           ((void *)0)
            
# 686 "../crypto/crmf/crmf_lib.c"
           || (evp_ctx = EVP_CIPHER_CTX_new()) == 
# 686 "../crypto/crmf/crmf_lib.c" 3 4
                                                  ((void *)0)
# 686 "../crypto/crmf/crmf_lib.c"
                                                      )
        goto end;
    ...
    if (!EVP_DecryptInit(evp_ctx, cipher, ek, iv)
        ...
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",695,__func__), ERR_set_error)((56),(105),
# 695 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 695 "../crypto/crmf/crmf_lib.c"
       );
        goto end;
    }
    outlen += n;
    ...
    if ((cert = X509_new_ex(libctx, propq)) == 
# 701 "../crypto/crmf/crmf_lib.c" 3 4
                                              ((void *)0)
# 701 "../crypto/crmf/crmf_lib.c"
                                                  )
        goto end;
    if (d2i_X509(&cert, &p, outlen) == 
# 703 "../crypto/crmf/crmf_lib.c" 3 4
                                      ((void *)0)
# 703 "../crypto/crmf/crmf_lib.c"
                                          )
        (ERR_new(), ERR_set_debug("../crypto/crmf/crmf_lib.c",704,__func__), ERR_set_error)((56),(104),
# 704 "../crypto/crmf/crmf_lib.c" 3 4
       ((void *)0)
# 704 "../crypto/crmf/crmf_lib.c"
       );
 end:
    EVP_PKEY_CTX_free(pkctx);
    CRYPTO_free(outbuf, "../crypto/crmf/crmf_lib.c", 707);
    EVP_CIPHER_CTX_free(evp_ctx);
    EVP_CIPHER_free(cipher);
    CRYPTO_clear_free(ek, eksize, "../crypto/crmf/crmf_lib.c", 710);
    CRYPTO_free(iv, "../crypto/crmf/crmf_lib.c", 711);
    return cert;
}
