...
# 203 "../crypto/mem.c"
 ...
 err:
    ...
    if (file != 
# 210 "../crypto/mem.c" 3 4
               ((void *)0) 
# 210 "../crypto/mem.c"
                    || line != 0) {
        ERR_new();
        ERR_set_debug(file, line, 
# 212 "../crypto/mem.c" 3 4
                                 ((void *)0)
# 212 "../crypto/mem.c"
                                     );
        ERR_set_error(15, (256|((0x1 << 18L)|(0x2 << 18L))), 
# 213 "../crypto/mem.c" 3 4
                                                           ((void *)0)
# 213 "../crypto/mem.c"
                                                               );
    }
    return 
# 215 "../crypto/mem.c" 3 4
          ((void *)0)
# 215 "../crypto/mem.c"
              ;
}
...
{
    void *ret = 
# 250 "../crypto/mem.c" 3 4
               ((void *)0)
# 250 "../crypto/mem.c"
                   ;

    if (str == 
# 252 "../crypto/mem.c" 3 4
              ((void *)0)
# 252 "../crypto/mem.c"
                  )
        return CRYPTO_malloc(num, file, line);
