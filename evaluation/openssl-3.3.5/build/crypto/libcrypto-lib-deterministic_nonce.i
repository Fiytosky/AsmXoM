# 0 "../crypto/deterministic_nonce.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/deterministic_nonce.c"
# 10 "../crypto/deterministic_nonce.c"
...
# 11 "../crypto/deterministic_nonce.c" 2
...
# 12 "../crypto/deterministic_nonce.c" 2
...
# 13 "../crypto/deterministic_nonce.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/deterministic_nonce.c" 2
...
# 15 "../crypto/deterministic_nonce.c" 2
...
int ossl_gen_deterministic_nonce_rfc6979(BIGNUM *out, const BIGNUM *q,
                                         ...
                                         OSSL_LIB_CTX *libctx,
                                         const char *propq);
# 16 "../crypto/deterministic_nonce.c" 2
...
# 17 "../crypto/deterministic_nonce.c" 2
# 28 "../crypto/deterministic_nonce.c"
                    ...
                    const unsigned char *in, size_t inlen)
{
    ...
    if (BN_bin2bn(in, (int)inlen, out) == 
# 34 "../crypto/deterministic_nonce.c" 3 4
                                         ((void *)0)
# 34 "../crypto/deterministic_nonce.c"
                                             )
        return 0;
...
# 55 "../crypto/deterministic_nonce.c"
static int bits2int_consttime(BIGNUM *out, int qlen_bits,
                              const unsigned char *in, size_t inlen)
{
    int blen_bits = (inlen - sizeof(unsigned long)) * 8;
    int shift;

    if (BN_bin2bn(in, (int)inlen, out) == 
# 61 "../crypto/deterministic_nonce.c" 3 4
                                         ((void *)0)
# 61 "../crypto/deterministic_nonce.c"
                                             )
        return 0;
                       ...
                       int rlen, const unsigned char *in, size_t inlen)
{
   ...
   if (z == 
# 105 "../crypto/deterministic_nonce.c" 3 4
           ((void *)0)
           
# 106 "../crypto/deterministic_nonce.c"
...
# 131 "../crypto/deterministic_nonce.c"
...
{
    EVP_KDF_CTX *ctx = 
# 136 "../crypto/deterministic_nonce.c" 3 4
                      ((void *)0)
# 136 "../crypto/deterministic_nonce.c"
                          ;
    EVP_KDF *kdf = 
# 137 "../crypto/deterministic_nonce.c" 3 4
                  ((void *)0)
# 137 "../crypto/deterministic_nonce.c"
                      ;
    ...
    EVP_KDF_free(kdf);
    if (ctx == 
# 143 "../crypto/deterministic_nonce.c" 3 4
              ((void *)0)
# 143 "../crypto/deterministic_nonce.c"
                  )
        goto err;
    ...
    *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                            (char *)digestname, 0);
    if (propq != 
# 149 "../crypto/deterministic_nonce.c" 3 4
                ((void *)0)
# 149 "../crypto/deterministic_nonce.c"
                    )
        *p++ = OSSL_PARAM_construct_utf8_string("properties",
                                                (char *)propq, 0);
    *p++ = OSSL_PARAM_construct_octet_string("entropy",
                                             (void *)entropy, entropylen);
    *p++ = OSSL_PARAM_construct_octet_string("nonce",
                                             (void *)nonce, noncelen);
...
err:
    ...
    return 
# 164 "../crypto/deterministic_nonce.c" 3 4
          ((void *)0)
# 164 "../crypto/deterministic_nonce.c"
              ;
}
# 181 "../crypto/deterministic_nonce.c"
int ossl_gen_deterministic_nonce_rfc6979(BIGNUM *out, const BIGNUM *q,
                                         const BIGNUM *priv,
...
{
    EVP_KDF_CTX *kdfctx = 
# 188 "../crypto/deterministic_nonce.c" 3 4
                         ((void *)0)
# 188 "../crypto/deterministic_nonce.c"
                             ;
    int ret = 0, rlen = 0, qlen_bits = 0;
    unsigned char *entropyx = 
# 190 "../crypto/deterministic_nonce.c" 3 4
                             ((void *)0)
# 190 "../crypto/deterministic_nonce.c"
                                 , *nonceh = 
# 190 "../crypto/deterministic_nonce.c" 3 4
                                             ((void *)0)
# 190 "../crypto/deterministic_nonce.c"
...
# 190 "../crypto/deterministic_nonce.c"
                                                                           ;
    size_t allocsz = 0;
    const size_t prefsz = sizeof(unsigned long);

    if (out == 
# 194 "../crypto/deterministic_nonce.c" 3 4
              ((void *)0)
# 194 "../crypto/deterministic_nonce.c"
                  )
        return 0;
    ...
    T = (unsigned char *)CRYPTO_zalloc(allocsz, "../crypto/deterministic_nonce.c", 206);
    if (T == 
# 207 "../crypto/deterministic_nonce.c" 3 4
            ((void *)0)
# 207 "../crypto/deterministic_nonce.c"
                )
        return 0;
    rbits = T + prefsz;
    nonceh = rbits + rlen;
    ...
    if (kdfctx == 
# 220 "../crypto/deterministic_nonce.c" 3 4
                 ((void *)0)
# 220 "../crypto/deterministic_nonce.c"
                     )
        goto end;

    do {
        if (!EVP_KDF_derive(kdfctx, rbits, rlen, 
# 224 "../crypto/deterministic_nonce.c" 3 4
                                                ((void *)0)
# 224 "../crypto/deterministic_nonce.c"
                                                    )
    ...
    CRYPTO_clear_free(T, allocsz, "../crypto/deterministic_nonce.c", 238);
    return ret;
}
