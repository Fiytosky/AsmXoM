# 0 "../crypto/rand/randfile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rand/randfile.c"
# 19 "../crypto/rand/randfile.c"
...
# 38 "../crypto/rand/randfile.c" 2
# 85 "../crypto/rand/randfile.c"

# 85 "../crypto/rand/randfile.c"
int RAND_load_file(const char *file, long bytes)
{
# 95 "../crypto/rand/randfile.c"
    ...
    if ((in = openssl_fopen(file, "rb")) == 
# 106 "../crypto/rand/randfile.c" 3 4
                                           ((void *)0)
# 106 "../crypto/rand/randfile.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",107,__func__), ERR_set_error)(36, 121,
                       "Filename=%s", file);
        return -1;
    }
    ...
    if (fstat(fileno(in), &sb) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",114,__func__), ERR_set_error)(36, 113,
                       "Filename=%s", file);
        fclose(in);
        return -1;
    }
    ...
    if (bytes < 0) {
        if (
# 121 "../crypto/rand/randfile.c" 3 4
           ((((
# 121 "../crypto/rand/randfile.c"
           sb.st_mode
# 121 "../crypto/rand/randfile.c" 3 4
           )) & 0170000) == (0100000))
# 121 "../crypto/rand/randfile.c"
...
# 143 "../crypto/rand/randfile.c"
    setbuf(in, 
# 143 "../crypto/rand/randfile.c" 3 4
              ((void *)0)
# 143 "../crypto/rand/randfile.c"
                  );
    ...
    for (;;) {
        if (bytes > 0)
            n = (bytes <= (1024 + 256)) ? (int)bytes : 1024;
        else
            n = (1024 + 256);
        i = fread(buf, 1, n, in);

        if (ferror(in) && 
# 155 "../crypto/rand/randfile.c" 3 4
                         (*__errno_location ()) 
# 155 "../crypto/rand/randfile.c"
                               == 
# 155 "../crypto/rand/randfile.c" 3 4
                                  4
# 155 "../crypto/rand/randfile.c"
...
# 172 "../crypto/rand/randfile.c"
    ...
    fclose(in);
    if (!RAND_status()) {
        (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",179,__func__), ERR_set_error)(36, 118, "Filename=%s", file);
        return -1;
    }
...
int RAND_write_file(const char *file)
{
    ...
    int ret = -1;
    FILE *out = 
# 190 "../crypto/rand/randfile.c" 3 4
               ((void *)0)
# 190 "../crypto/rand/randfile.c"
                   ;

    struct stat sb;

    if (stat(file, &sb) >= 0 && !
# 194 "../crypto/rand/randfile.c" 3 4
                                ((((
# 194 "../crypto/rand/randfile.c"
                                sb.st_mode
# 194 "../crypto/rand/randfile.c" 3 4
                                )) & 0170000) == (0100000))
# 194 "../crypto/rand/randfile.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",195,__func__), ERR_set_error)(36, 122,
                       "Filename=%s", file);
        return -1;
    }
...

    {
        ...
        int fd = open(file, 
# 215 "../crypto/rand/randfile.c" 3 4
                           01 
# 215 "../crypto/rand/randfile.c"
                                    | 
# 215 "../crypto/rand/randfile.c" 3 4
                                      0100 
# 215 "../crypto/rand/randfile.c"
        ...
        if (fd != -1) {
            out = fdopen(fd, "wb");
            if (out == 
# 219 "../crypto/rand/randfile.c" 3 4
                      ((void *)0)
# 219 "../crypto/rand/randfile.c"
                          ) {
                close(fd);
                (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",221,__func__), ERR_set_error)(36, 121,
                               "Filename=%s", file);
                return -1;
            }
        }
    }
# 250 "../crypto/rand/randfile.c"
    if (out == 
# 250 "../crypto/rand/randfile.c" 3 4
              ((void *)0)
# 250 "../crypto/rand/randfile.c"
                  )
        out = openssl_fopen(file, "wb");
    if (out == 
# 252 "../crypto/rand/randfile.c" 3 4
              ((void *)0)
# 252 "../crypto/rand/randfile.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/randfile.c",253,__func__), ERR_set_error)(36, 121,
                       "Filename=%s", file);
        return -1;
    }
...
{
    char *s = 
# 273 "../crypto/rand/randfile.c" 3 4
             ((void *)0)
# 273 "../crypto/rand/randfile.c"
                 ;
    size_t len;
    int use_randfile = 1;
# 305 "../crypto/rand/randfile.c"
    if ((s = ossl_safe_getenv("RANDFILE")) == 
# 305 "../crypto/rand/randfile.c" 3 4
                                             ((void *)0) 
# 305 "../crypto/rand/randfile.c"
                                                  || *s == '\0') {
        use_randfile = 0;
    ...
    if (s == 
# 315 "../crypto/rand/randfile.c" 3 4
            ((void *)0) 
# 315 "../crypto/rand/randfile.c"
                 || *s == '\0')
        return 
# 316 "../crypto/rand/randfile.c" 3 4
              ((void *)0)
# 316 "../crypto/rand/randfile.c"
                  ;
    ...
    if (use_randfile) {
        if (len + 1 >= size)
            return 
# 321 "../crypto/rand/randfile.c" 3 4
                  ((void *)0)
# 321 "../crypto/rand/randfile.c"
                      ;
        strcpy(buf, s);
    } else {
        if (len + 1 + strlen(".rnd") + 1 >= size)
            return 
# 325 "../crypto/rand/randfile.c" 3 4
                  ((void *)0)
# 325 "../crypto/rand/randfile.c"
                      ;
        strcpy(buf, s);
