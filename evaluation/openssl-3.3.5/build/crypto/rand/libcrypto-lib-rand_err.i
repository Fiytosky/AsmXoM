# 0 "../crypto/rand/rand_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rand/rand_err.c"
# 11 "../crypto/rand/rand_err.c"
...
# 12 "../crypto/rand/rand_err.c" 2
# 1 "../include/openssl/randerr.h" 1
# 13 "../include/openssl/randerr.h"
        
# 13 "../crypto/rand/rand_err.c" 2
# 1 "../include/crypto/randerr.h" 1
# 13 "../include/crypto/randerr.h"
        
# 22 "../include/crypto/randerr.h"
int ossl_err_load_RAND_strings(void);
# 14 "../crypto/rand/rand_err.c" 2



static const ERR_STRING_DATA RAND_str_reasons[] = {
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "additional input too long"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "already instantiated"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "argument out of range"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ), "Cannot open file"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "drbg already initialized"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "drbg not initialised"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "entropy input too long"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "entropy out of range"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "error entropy pool was ignored"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "error initialising drbg"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "error instantiating drbg"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "error retrieving additional input"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "error retrieving entropy"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "error retrieving nonce"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "failed to create lock"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "Function not implemented"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ), "Error writing file"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "generate error"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ),
    "insufficient drbg strength"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "internal error"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ),
    "invalid property query"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "in error state"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "Not a regular file"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "not instantiated"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "no drbg implementation selected"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "parent locking not enabled"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "parent strength too weak"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "personalisation string too long"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ),
    "prediction resistance not supported"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "PRNG not seeded"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "random pool overflow"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ),
    "random pool underflow"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "request too large for drbg"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ), "reseed error"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "selftest failure"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ),
    "too little nonce requested"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "too much nonce requested"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ),
    "unable to create drbg"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "unable to fetch drbg"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(141) & 0X7FFFFF)) ),
    "unable to get parent reseed prop counter"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ),
    "unable to get parent strength"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(140) & 0X7FFFFF)) ),
    "unable to lock parent"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ),
    "unsupported drbg flags"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "unsupported drbg type"},
    {0, 
# 97 "../crypto/rand/rand_err.c" 3 4
       ((void *)0)
# 97 "../crypto/rand/rand_err.c"
           }
};
...
int ossl_err_load_RAND_strings(void)
{
    ...
    if (ERR_reason_error_string(RAND_str_reasons[0].error) == 
# 105 "../crypto/rand/rand_err.c" 3 4
                                                             ((void *)0)
# 105 "../crypto/rand/rand_err.c"
                                                                 )
