# 0 "../crypto/rand/rand_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rand/rand_meth.c"
# 10 "../crypto/rand/rand_meth.c"
...
# 13 "../crypto/rand/rand_meth.c" 2


static int drbg_add(const void *buf, int num, double randomness)
{
    EVP_RAND_CTX *drbg = RAND_get0_primary(
# 17 "../crypto/rand/rand_meth.c" 3 4
                                          ((void *)0)
# 17 "../crypto/rand/rand_meth.c"
                                              );

    if (drbg == 
# 19 "../crypto/rand/rand_meth.c" 3 4
               ((void *)0) 
# 19 "../crypto/rand/rand_meth.c"
                    || num <= 0)
        return 0;

    return EVP_RAND_reseed(drbg, 0, 
# 22 "../crypto/rand/rand_meth.c" 3 4
                                   ((void *)0)
# 22 "../crypto/rand/rand_meth.c"
                                       , 0, buf, num);
}
...
{
    EVP_RAND_CTX *drbg = RAND_get0_primary(
# 34 "../crypto/rand/rand_meth.c" 3 4
                                          ((void *)0)
# 34 "../crypto/rand/rand_meth.c"
                                              );

    if (drbg == 
# 36 "../crypto/rand/rand_meth.c" 3 4
               ((void *)0)
# 36 "../crypto/rand/rand_meth.c"
                   )
        return 0;

    return EVP_RAND_get_state(drbg) == 1 ? 1 : 0;
}


static int drbg_bytes(unsigned char *out, int count)
{
    EVP_RAND_CTX *drbg = RAND_get0_public(
# 45 "../crypto/rand/rand_meth.c" 3 4
                                         ((void *)0)
# 45 "../crypto/rand/rand_meth.c"
                                             );

    if (drbg == 
# 47 "../crypto/rand/rand_meth.c" 3 4
               ((void *)0)
# 47 "../crypto/rand/rand_meth.c"
                   )
        return 0;

    return EVP_RAND_generate(drbg, out, count, 0, 0, 
# 50 "../crypto/rand/rand_meth.c" 3 4
                                                    ((void *)0)
# 50 "../crypto/rand/rand_meth.c"
                                                        , 0);
}
...
# 56 "../crypto/rand/rand_meth.c" 3 4
   ((void *)0)
# 56 "../crypto/rand/rand_meth.c"
       ,
    drbg_add,
    drbg_bytes,
    drbg_status
