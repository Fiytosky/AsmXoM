# 0 "../crypto/rand/rand_pool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rand/rand_pool.c"
# 10 "../crypto/rand/rand_pool.c"
...
# 16 "../crypto/rand/rand_pool.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 17 "../crypto/rand/rand_pool.c" 2
...
RAND_POOL *ossl_rand_pool_new(int entropy_requested, int secure,
                              size_t min_len, size_t max_len)
{
    RAND_POOL *pool = CRYPTO_zalloc(sizeof(*pool), "../crypto/rand/rand_pool.c", 25);
    size_t min_alloc_size = ((secure) ? 16 : 48);

    if (pool == 
# 28 "../crypto/rand/rand_pool.c" 3 4
               ((void *)0)
# 28 "../crypto/rand/rand_pool.c"
                   )
        return 
# 29 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 29 "../crypto/rand/rand_pool.c"
                  ;

    pool->min_len = min_len;
    pool->max_len = (max_len > (256 * 3 * (256 / 16))) ?
        (256 * 3 * (256 / 16)) : max_len;
    pool->alloc_len = min_len < min_alloc_size ? min_alloc_size : min_len;
    if (pool->alloc_len > pool->max_len)
        pool->alloc_len = pool->max_len;

    if (secure)
        pool->buffer = CRYPTO_secure_zalloc(pool->alloc_len, "../crypto/rand/rand_pool.c", 39);
    else
        pool->buffer = CRYPTO_zalloc(pool->alloc_len, "../crypto/rand/rand_pool.c", 41);

    if (pool->buffer == 
# 43 "../crypto/rand/rand_pool.c" 3 4
                       ((void *)0)
# 43 "../crypto/rand/rand_pool.c"
                           )
        goto err;
...
err:
    CRYPTO_free(pool, "../crypto/rand/rand_pool.c", 51);
    return 
# 52 "../crypto/rand/rand_pool.c" 3 4
          ((void *)0)
# 52 "../crypto/rand/rand_pool.c"
              ;
}
...
RAND_POOL *ossl_rand_pool_attach(const unsigned char *buffer, size_t len,
                                 size_t entropy)
{
    RAND_POOL *pool = CRYPTO_zalloc(sizeof(*pool), "../crypto/rand/rand_pool.c", 64);

    if (pool == 
# 66 "../crypto/rand/rand_pool.c" 3 4
               ((void *)0)
# 66 "../crypto/rand/rand_pool.c"
                   )
        return 
# 67 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 67 "../crypto/rand/rand_pool.c"
                  ;
...
{
    if (pool == 
# 90 "../crypto/rand/rand_pool.c" 3 4
               ((void *)0)
# 90 "../crypto/rand/rand_pool.c"
                   )
        return;
    ...
    if (!pool->attached) {
        if (pool->secure)
            CRYPTO_secure_clear_free(pool->buffer, pool->alloc_len, "../crypto/rand/rand_pool.c", 101);
        else
            CRYPTO_clear_free(pool->buffer, pool->alloc_len, "../crypto/rand/rand_pool.c", 103);
    }

    CRYPTO_free(pool, "../crypto/rand/rand_pool.c", 106);
}
...
unsigned char *ossl_rand_pool_detach(RAND_POOL *pool)
{
    ...
    pool->buffer = 
# 142 "../crypto/rand/rand_pool.c" 3 4
                  ((void *)0)
# 142 "../crypto/rand/rand_pool.c"
                      ;
    pool->entropy = 0;
    return ret;
}
...
static int rand_pool_grow(RAND_POOL *pool, size_t len)
{
    if (len > pool->alloc_len - pool->len) {
        ...
        if (pool->attached || len > pool->max_len - pool->len) {
            (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",207,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 207 "../crypto/rand/rand_pool.c" 3 4
           ((void *)0)
# 207 "../crypto/rand/rand_pool.c"
           );
            return 0;
        }
        ...
        if (pool->secure)
            p = CRYPTO_secure_zalloc(newlen, "../crypto/rand/rand_pool.c", 216);
        else
            p = CRYPTO_zalloc(newlen, "../crypto/rand/rand_pool.c", 218);
        if (p == 
# 219 "../crypto/rand/rand_pool.c" 3 4
                ((void *)0)
# 219 "../crypto/rand/rand_pool.c"
                    )
            return 0;
        memcpy(p, pool->buffer, pool->len);
        if (pool->secure)
            CRYPTO_secure_clear_free(pool->buffer, pool->alloc_len, "../crypto/rand/rand_pool.c", 223);
        else
            CRYPTO_clear_free(pool->buffer, pool->alloc_len, "../crypto/rand/rand_pool.c", 225);
        pool->buffer = p;
...
size_t ossl_rand_pool_bytes_needed(RAND_POOL *pool, unsigned int entropy_factor)
{
    ...
    if (entropy_factor < 1) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",244,__func__), ERR_set_error)((36),(105),
# 244 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 244 "../crypto/rand/rand_pool.c"
       );
        return 0;
    }

    bytes_needed = (((entropy_needed) * (entropy_factor) + 7) / 8);

    if (bytes_needed > pool->max_len - pool->len) {

        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",252,__func__), ERR_set_error)(36, 125,
...
# 301 "../crypto/rand/rand_pool.c"
int ossl_rand_pool_add(RAND_POOL *pool,
                  const unsigned char *buffer, size_t len, size_t entropy)
{
    if (len > pool->max_len - pool->len) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",305,__func__), ERR_set_error)((36),(106),
# 305 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 305 "../crypto/rand/rand_pool.c"
       );
        return 0;
    }

    if (pool->buffer == 
# 309 "../crypto/rand/rand_pool.c" 3 4
                       ((void *)0)
# 309 "../crypto/rand/rand_pool.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",310,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 310 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 310 "../crypto/rand/rand_pool.c"
       );
        return 0;
    }

    if (len > 0) {
# 323 "../crypto/rand/rand_pool.c"
        if (pool->alloc_len > pool->len && pool->buffer + pool->len == buffer) {
            (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",324,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 324 "../crypto/rand/rand_pool.c" 3 4
           ((void *)0)
# 324 "../crypto/rand/rand_pool.c"
           );
            return 0;
        }
...
# 356 "../crypto/rand/rand_pool.c"
unsigned char *ossl_rand_pool_add_begin(RAND_POOL *pool, size_t len)
{
    if (len == 0)
        return 
# 359 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 359 "../crypto/rand/rand_pool.c"
                  ;

    if (len > pool->max_len - pool->len) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",362,__func__), ERR_set_error)((36),(125),
# 362 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 362 "../crypto/rand/rand_pool.c"
       );
        return 
# 363 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 363 "../crypto/rand/rand_pool.c"
                  ;
    }

    if (pool->buffer == 
# 366 "../crypto/rand/rand_pool.c" 3 4
                       ((void *)0)
# 366 "../crypto/rand/rand_pool.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",367,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 367 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 367 "../crypto/rand/rand_pool.c"
       );
        return 
# 368 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 368 "../crypto/rand/rand_pool.c"
                  ;
    }
# 380 "../crypto/rand/rand_pool.c"
    if (!rand_pool_grow(pool, len))
        return 
# 381 "../crypto/rand/rand_pool.c" 3 4
              ((void *)0)
# 381 "../crypto/rand/rand_pool.c"
                  ;

    return pool->buffer + pool->len;
}
# 395 "../crypto/rand/rand_pool.c"
int ossl_rand_pool_add_end(RAND_POOL *pool, size_t len, size_t entropy)
{
    if (len > pool->alloc_len - pool->len) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_pool.c",398,__func__), ERR_set_error)((36),(125),
# 398 "../crypto/rand/rand_pool.c" 3 4
       ((void *)0)
# 398 "../crypto/rand/rand_pool.c"
       );
        return 0;
    }
