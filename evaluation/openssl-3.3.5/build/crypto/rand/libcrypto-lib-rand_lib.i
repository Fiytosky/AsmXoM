...
# 1 "../crypto/rand/rand_local.h" 1
# 13 "../crypto/rand/rand_local.h"
...
# 20 "../crypto/rand/rand_local.h" 2
# 30 "../crypto/rand/rand_local.h"
...
# 10 "../providers/implementations/include/prov/seeding.h"
...
# 11 "../providers/implementations/include/prov/seeding.h" 2
...
# 44 "../crypto/rand/rand_lib.c" 3 4
                              0
# 44 "../crypto/rand/rand_lib.c"
                                                     ;

static int rand_inited = 0;

static int do_rand_init(void); static int do_rand_init_ossl_ret_ = 0; static void do_rand_init_ossl_(void) { do_rand_init_ossl_ret_ = do_rand_init(); } static int do_rand_init(void)
{

    rand_engine_lock = CRYPTO_THREAD_lock_new();
    if (rand_engine_lock == 
# 52 "../crypto/rand/rand_lib.c" 3 4
                           ((void *)0)
# 52 "../crypto/rand/rand_lib.c"
                               )
        return 0;
    ...
    if (rand_meth_lock == 
# 58 "../crypto/rand/rand_lib.c" 3 4
                         ((void *)0)
# 58 "../crypto/rand/rand_lib.c"
                             )
        goto err;
 ...
 err:
    ...
    rand_meth_lock = 
# 71 "../crypto/rand/rand_lib.c" 3 4
                    ((void *)0)
# 71 "../crypto/rand/rand_lib.c"
                        ;


    CRYPTO_THREAD_lock_free(rand_engine_lock);
    rand_engine_lock = 
# 75 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 75 "../crypto/rand/rand_lib.c"
                          ;
...
void ossl_rand_cleanup_int(void)
{
    ...
    if (meth != 
# 88 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 88 "../crypto/rand/rand_lib.c"
                    && meth->cleanup != 
# 88 "../crypto/rand/rand_lib.c" 3 4
                                        ((void *)0)
# 88 "../crypto/rand/rand_lib.c"
...
# 90 "../crypto/rand/rand_lib.c" 3 4
                        ((void *)0)
# 90 "../crypto/rand/rand_lib.c"
                            );
    ...
    CRYPTO_THREAD_lock_free(rand_engine_lock);
    rand_engine_lock = 
# 95 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 95 "../crypto/rand/rand_lib.c"
                          ;


    CRYPTO_THREAD_lock_free(rand_meth_lock);
    rand_meth_lock = 
# 99 "../crypto/rand/rand_lib.c" 3 4
                    ((void *)0)
# 99 "../crypto/rand/rand_lib.c"
                        ;
...
void RAND_keep_random_devices_open(int keep)
{
    if ((CRYPTO_THREAD_run_once(&rand_init, do_rand_init_ossl_) ? do_rand_init_ossl_ret_ : 0))
...
int RAND_poll(void)
{
    ...
    if (meth == 
# 131 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 131 "../crypto/rand/rand_lib.c"
                   )
        return 0;

    if (!ret) {

        RAND_POOL *pool = ossl_rand_pool_new(256, 1,
                                             (256 + 7) / 8,
                                             (256 * 3 * (256 / 16)));

        if (pool == 
# 140 "../crypto/rand/rand_lib.c" 3 4
                   ((void *)0)
# 140 "../crypto/rand/rand_lib.c"
                       )
            return 0;
        ...
        if (meth->add == 
# 146 "../crypto/rand/rand_lib.c" 3 4
                        ((void *)0)
            
# 147 "../crypto/rand/rand_lib.c"
...
{
    return rand_set_rand_method_internal(meth, 
# 183 "../crypto/rand/rand_lib.c" 3 4
                                              ((void *)0)
# 183 "../crypto/rand/rand_lib.c"
                                                  );
}
...
# 188 "../crypto/rand/rand_lib.c" 3 4
                                 ((void *)0)
# 188 "../crypto/rand/rand_lib.c"
                                     ;

    if (!(CRYPTO_THREAD_run_once(&rand_init, do_rand_init_ossl_) ? do_rand_init_ossl_ret_ : 0))
        return 
# 191 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 191 "../crypto/rand/rand_lib.c"
                  ;

    if (!CRYPTO_THREAD_read_lock(rand_meth_lock))
        return 
# 194 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 194 "../crypto/rand/rand_lib.c"
                  ;
    tmp_meth = default_RAND_meth;
    CRYPTO_THREAD_unlock(rand_meth_lock);
    if (tmp_meth != 
# 197 "../crypto/rand/rand_lib.c" 3 4
                   ((void *)0)
# 197 "../crypto/rand/rand_lib.c"
                       )
        return tmp_meth;

    if (!CRYPTO_THREAD_write_lock(rand_meth_lock))
        return 
# 201 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 201 "../crypto/rand/rand_lib.c"
                  ;
    if (default_RAND_meth == 
# 202 "../crypto/rand/rand_lib.c" 3 4
                            ((void *)0)
# 202 "../crypto/rand/rand_lib.c"
                                ) {

        ENGINE *e;


        if ((e = ENGINE_get_default_RAND()) != 
# 207 "../crypto/rand/rand_lib.c" 3 4
                                              ((void *)0)
                
# 208 "../crypto/rand/rand_lib.c"
               && (tmp_meth = ENGINE_get_RAND(e)) != 
# 208 "../crypto/rand/rand_lib.c" 3 4
                                                     ((void *)0)
# 208 "../crypto/rand/rand_lib.c"
                                                         ) {
            funct_ref = e;
...
{
    const RAND_METHOD *tmp_meth = 
# 227 "../crypto/rand/rand_lib.c" 3 4
                                 ((void *)0)
# 227 "../crypto/rand/rand_lib.c"
                                     ;
    ...
    if (engine != 
# 232 "../crypto/rand/rand_lib.c" 3 4
                 ((void *)0)
# 232 "../crypto/rand/rand_lib.c"
                     ) {
        if (!ENGINE_init(engine))
            return 0;
        tmp_meth = ENGINE_get_RAND(engine);
        if (tmp_meth == 
# 236 "../crypto/rand/rand_lib.c" 3 4
                       ((void *)0)
# 236 "../crypto/rand/rand_lib.c"
                           ) {
...
void RAND_seed(const void *buf, int num)
{
    ...
    if (meth != 
# 260 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 260 "../crypto/rand/rand_lib.c"
                    && meth->seed != 
# 260 "../crypto/rand/rand_lib.c" 3 4
                                     ((void *)0)
# 260 "../crypto/rand/rand_lib.c"
    ...
    drbg = RAND_get0_primary(
# 266 "../crypto/rand/rand_lib.c" 3 4
                            ((void *)0)
# 266 "../crypto/rand/rand_lib.c"
                                );
    if (drbg != 
# 267 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 267 "../crypto/rand/rand_lib.c"
                    && num > 0)
        EVP_RAND_reseed(drbg, 0, 
# 268 "../crypto/rand/rand_lib.c" 3 4
                                ((void *)0)
# 268 "../crypto/rand/rand_lib.c"
                                    , 0, buf, num);
}
...
void RAND_add(const void *buf, int num, double randomness)
{
    ...
    if (meth != 
# 277 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 277 "../crypto/rand/rand_lib.c"
                    && meth->add != 
# 277 "../crypto/rand/rand_lib.c" 3 4
                                    ((void *)0)
# 277 "../crypto/rand/rand_lib.c"
    ...
    drbg = RAND_get0_primary(
# 282 "../crypto/rand/rand_lib.c" 3 4
                            ((void *)0)
# 282 "../crypto/rand/rand_lib.c"
                                );
    if (drbg != 
# 283 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 283 "../crypto/rand/rand_lib.c"
        ...
        EVP_RAND_reseed(drbg, 0, 
# 289 "../crypto/rand/rand_lib.c" 3 4
                                ((void *)0)
# 289 "../crypto/rand/rand_lib.c"
                                    , 0, buf, num);
...
int RAND_pseudo_bytes(unsigned char *buf, int num)
{
    ...
    if (meth != 
# 298 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 298 "../crypto/rand/rand_lib.c"
                    && meth->pseudorand != 
# 298 "../crypto/rand/rand_lib.c" 3 4
                                           ((void *)0)
# 298 "../crypto/rand/rand_lib.c"
    ...
    (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",300,__func__), ERR_set_error)((36),(101),
# 300 "../crypto/rand/rand_lib.c" 3 4
   ((void *)0)
# 300 "../crypto/rand/rand_lib.c"
   );
    return -1;
}
...
int RAND_status(void)
{
    ...
    if (meth != 
# 311 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 311 "../crypto/rand/rand_lib.c"
                    && meth != RAND_OpenSSL())
        return meth->status != 
# 312 "../crypto/rand/rand_lib.c" 3 4
                              ((void *)0) 
# 312 "../crypto/rand/rand_lib.c"
                                   ? meth->status() : 0;


    if ((rand = RAND_get0_primary(
# 315 "../crypto/rand/rand_lib.c" 3 4
                                 ((void *)0)
...
# 315 "../crypto/rand/rand_lib.c"
        ...
        return 0;
    return EVP_RAND_get_state(rand) == 1;
}
                       ...
                       unsigned int strength)
{
    ...
    if (meth != 
# 341 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 341 "../crypto/rand/rand_lib.c"
                    && meth != RAND_OpenSSL()) {
        if (meth->bytes != 
# 342 "../crypto/rand/rand_lib.c" 3 4
                          ((void *)0)
# 342 "../crypto/rand/rand_lib.c"
                              )
            return meth->bytes(buf, num);
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",344,__func__), ERR_set_error)((36),(101),
# 344 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 344 "../crypto/rand/rand_lib.c"
       );
        return -1;
    }
    ...
    if (rand != 
# 350 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 350 "../crypto/rand/rand_lib.c"
                   )
        return EVP_RAND_generate(rand, buf, num, strength, 0, 
# 351 "../crypto/rand/rand_lib.c" 3 4
                                                             ((void *)0)
# 351 "../crypto/rand/rand_lib.c"
                                                                 , 0);
...
# 360 "../crypto/rand/rand_lib.c" 3 4
                             ((void *)0)
# 360 "../crypto/rand/rand_lib.c"
                                 , buf, (size_t)num, 0);
}
                  ...
                  unsigned int strength)
{
    ...
    if (meth != 
# 370 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0) 
# 370 "../crypto/rand/rand_lib.c"
                    && meth != RAND_OpenSSL()) {
        if (meth->bytes != 
# 371 "../crypto/rand/rand_lib.c" 3 4
                          ((void *)0)
# 371 "../crypto/rand/rand_lib.c"
                              )
            return meth->bytes(buf, num);
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",373,__func__), ERR_set_error)((36),(101),
# 373 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 373 "../crypto/rand/rand_lib.c"
       );
        return -1;
    }
    ...
    if (rand != 
# 379 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 379 "../crypto/rand/rand_lib.c"
                   )
        return EVP_RAND_generate(rand, buf, num, strength, 0, 
# 380 "../crypto/rand/rand_lib.c" 3 4
                                                             ((void *)0)
# 380 "../crypto/rand/rand_lib.c"
                                                                 , 0);
...
int RAND_bytes(unsigned char *buf, int num)
{
    if (num < 0)
        return 0;
    return RAND_bytes_ex(
# 389 "../crypto/rand/rand_lib.c" 3 4
                        ((void *)0)
# 389 "../crypto/rand/rand_lib.c"
                            , buf, (size_t)num, 0);
}
...
void *ossl_rand_ctx_new(OSSL_LIB_CTX *libctx)
{
    ...
    if (dgbl == 
# 457 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 457 "../crypto/rand/rand_lib.c"
                   )
        return 
# 458 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 458 "../crypto/rand/rand_lib.c"
                  ;
     ...
     OPENSSL_init_crypto(0x00040000L, 
# 465 "../crypto/rand/rand_lib.c" 3 4
                                                ((void *)0)
# 465 "../crypto/rand/rand_lib.c"
                                                    );


    dgbl->lock = CRYPTO_THREAD_lock_new();
    if (dgbl->lock == 
# 469 "../crypto/rand/rand_lib.c" 3 4
                     ((void *)0)
# 469 "../crypto/rand/rand_lib.c"
                         )
        goto err1;

    if (!CRYPTO_THREAD_init_local(&dgbl->private, 
# 472 "../crypto/rand/rand_lib.c" 3 4
                                                 ((void *)0)
# 472 "../crypto/rand/rand_lib.c"
                                                     ))
        goto err1;

    if (!CRYPTO_THREAD_init_local(&dgbl->public, 
# 475 "../crypto/rand/rand_lib.c" 3 4
                                                ((void *)0)
# 475 "../crypto/rand/rand_lib.c"
                                                    ))
        goto err2;
 ...
 err1:
    ...
    return 
# 485 "../crypto/rand/rand_lib.c" 3 4
          ((void *)0)
# 485 "../crypto/rand/rand_lib.c"
              ;
}
...
void ossl_rand_ctx_free(void *vdgbl)
{
    ...
    if (dgbl == 
# 492 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 492 "../crypto/rand/rand_lib.c"
                   )
        return;
...
{
    return ossl_lib_ctx_get_data(libctx, 5);
}
...
static void rand_delete_thread_state(void *arg)
{
    ...
    if (dgbl == 
# 521 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 521 "../crypto/rand/rand_lib.c"
                   )
        return;

    rand = CRYPTO_THREAD_get_local(&dgbl->public);
    CRYPTO_THREAD_set_local(&dgbl->public, 
# 525 "../crypto/rand/rand_lib.c" 3 4
                                          ((void *)0)
# 525 "../crypto/rand/rand_lib.c"
                                              );
    EVP_RAND_CTX_free(rand);

    rand = CRYPTO_THREAD_get_local(&dgbl->private);
    CRYPTO_THREAD_set_local(&dgbl->private, 
# 529 "../crypto/rand/rand_lib.c" 3 4
                                           ((void *)0)
# 529 "../crypto/rand/rand_lib.c"
                                               );
    EVP_RAND_CTX_free(rand);
}
...
static EVP_RAND_CTX *rand_new_seed(OSSL_LIB_CTX *libctx)
{
    ...
    EVP_RAND_CTX *ctx = 
# 538 "../crypto/rand/rand_lib.c" 3 4
                       ((void *)0)
# 538 "../crypto/rand/rand_lib.c"
                           ;
    const char *propq;
    char *name, *props = 
# 540 "../crypto/rand/rand_lib.c" 3 4
                        ((void *)0)
# 540 "../crypto/rand/rand_lib.c"
                            ;
    size_t props_len;
    OSSL_PROPERTY_LIST *pl1, *pl2, *pl3 = 
# 542 "../crypto/rand/rand_lib.c" 3 4
                                         ((void *)0)
# 542 "../crypto/rand/rand_lib.c"
                                             ;

    if (dgbl == 
# 544 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 544 "../crypto/rand/rand_lib.c"
                   )
        return 
# 545 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 545 "../crypto/rand/rand_lib.c"
                  ;
    propq = dgbl->seed_propq;
    if (dgbl->seed_name != 
# 547 "../crypto/rand/rand_lib.c" 3 4
                          ((void *)0)
# 547 "../crypto/rand/rand_lib.c"
                              ) {
        name = dgbl->seed_name;
    } else {
        ...
        if (propq == 
# 554 "../crypto/rand/rand_lib.c" 3 4
                    ((void *)0) 
# 554 "../crypto/rand/rand_lib.c"
                         || *propq == '\0') {
            propq = "-fips";
        } else {
            pl1 = ossl_parse_query(libctx, propq, 1);
            if (pl1 == 
# 558 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 558 "../crypto/rand/rand_lib.c"
                          ) {
                (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",559,__func__), ERR_set_error)((36),(137),
# 559 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 559 "../crypto/rand/rand_lib.c"
               );
                return 
# 560 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 560 "../crypto/rand/rand_lib.c"
                          ;
            }
            pl2 = ossl_parse_query(libctx, "-fips", 1);
            if (pl2 == 
# 563 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 563 "../crypto/rand/rand_lib.c"
                          ) {
                ossl_property_free(pl1);
                (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",565,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 565 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 565 "../crypto/rand/rand_lib.c"
               );
                return 
# 566 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 566 "../crypto/rand/rand_lib.c"
                          ;
            }
            ...
            if (pl3 == 
# 571 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 571 "../crypto/rand/rand_lib.c"
                          ) {
                (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",572,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 572 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 572 "../crypto/rand/rand_lib.c"
               );
                return 
# 573 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 573 "../crypto/rand/rand_lib.c"
                          ;
            }
            props_len = ossl_property_list_to_string(libctx, pl3, 
# 575 "../crypto/rand/rand_lib.c" 3 4
                                                                 ((void *)0)
# 575 "../crypto/rand/rand_lib.c"
                                                                     , 0);
            if (props_len == 0) {

                (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",578,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 578 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 578 "../crypto/rand/rand_lib.c"
               );
                goto err;
            } else {
                props = CRYPTO_malloc(props_len, "../crypto/rand/rand_lib.c", 581);
                if (props == 
# 582 "../crypto/rand/rand_lib.c" 3 4
                            ((void *)0)
# 582 "../crypto/rand/rand_lib.c"
                                ) {
                    (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",583,__func__), ERR_set_error)((36),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 583 "../crypto/rand/rand_lib.c" 3 4
                   ((void *)0)
# 583 "../crypto/rand/rand_lib.c"
                   );
                    goto err;
                }
                if (ossl_property_list_to_string(libctx, pl3,
                                                 props, props_len) == 0) {
                    (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",588,__func__), ERR_set_error)((36),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 588 "../crypto/rand/rand_lib.c" 3 4
                   ((void *)0)
# 588 "../crypto/rand/rand_lib.c"
                   );
                    goto err;
                }
                ossl_property_free(pl3);
                pl3 = 
# 592 "../crypto/rand/rand_lib.c" 3 4
                     ((void *)0)
# 592 "../crypto/rand/rand_lib.c"
                         ;
                propq = props;
            }
        }
    ...
    if (rand == 
# 600 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 600 "../crypto/rand/rand_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",601,__func__), ERR_set_error)((36),(144),
# 601 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 601 "../crypto/rand/rand_lib.c"
       );
        goto err;
    }
    ctx = EVP_RAND_CTX_new(rand, 
# 604 "../crypto/rand/rand_lib.c" 3 4
                                ((void *)0)
# 604 "../crypto/rand/rand_lib.c"
                                    );
    EVP_RAND_free(rand);
    if (ctx == 
# 606 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 606 "../crypto/rand/rand_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",607,__func__), ERR_set_error)((36),(143),
# 607 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 607 "../crypto/rand/rand_lib.c"
       );
        goto err;
    }
    if (!EVP_RAND_instantiate(ctx, 0, 0, 
# 610 "../crypto/rand/rand_lib.c" 3 4
                                        ((void *)0)
# 610 "../crypto/rand/rand_lib.c"
                                            , 0, 
# 610 "../crypto/rand/rand_lib.c" 3 4
                                                 ((void *)0)
# 610 "../crypto/rand/rand_lib.c"
                                                     )) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",611,__func__), ERR_set_error)((36),(108),
# 611 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 611 "../crypto/rand/rand_lib.c"
       );
        goto err;
    }
    CRYPTO_free(props, "../crypto/rand/rand_lib.c", 614);
    return ctx;
 err:
    EVP_RAND_CTX_free(ctx);
    ossl_property_free(pl3);
    CRYPTO_free(props, "../crypto/rand/rand_lib.c", 619);
    return 
# 620 "../crypto/rand/rand_lib.c" 3 4
          ((void *)0)
# 620 "../crypto/rand/rand_lib.c"
              ;
}
...
EVP_RAND_CTX *ossl_rand_get0_seed_noncreating(OSSL_LIB_CTX *ctx)
{
    ...
    if (dgbl == 
# 628 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 628 "../crypto/rand/rand_lib.c"
                   )
        return 
# 629 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 629 "../crypto/rand/rand_lib.c"
                  ;

    if (!CRYPTO_THREAD_read_lock(dgbl->lock))
        return 
# 632 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 632 "../crypto/rand/rand_lib.c"
                  ;
    ret = dgbl->seed;
                                   ...
                                   time_t reseed_time_interval, int use_df)
{
    ...
    if (dgbl == 
# 650 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 650 "../crypto/rand/rand_lib.c"
                   )
        return 
# 651 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 651 "../crypto/rand/rand_lib.c"
                  ;
    name = dgbl->rng_name != 
# 652 "../crypto/rand/rand_lib.c" 3 4
                            ((void *)0) 
# 652 "../crypto/rand/rand_lib.c"
                                 ? dgbl->rng_name : "CTR-DRBG";
    rand = EVP_RAND_fetch(libctx, name, dgbl->rng_propq);
    if (rand == 
# 654 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 654 "../crypto/rand/rand_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",655,__func__), ERR_set_error)((36),(144),
# 655 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 655 "../crypto/rand/rand_lib.c"
       );
        return 
# 656 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 656 "../crypto/rand/rand_lib.c"
                  ;
    }
    ctx = EVP_RAND_CTX_new(rand, parent);
    EVP_RAND_free(rand);
    if (ctx == 
# 660 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 660 "../crypto/rand/rand_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",661,__func__), ERR_set_error)((36),(143),
# 661 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 661 "../crypto/rand/rand_lib.c"
       );
        return 
# 662 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 662 "../crypto/rand/rand_lib.c"
                  ;
    }

    settables = EVP_RAND_CTX_settable_params(ctx);
    if (OSSL_PARAM_locate_const(settables, "cipher")) {
        cipher = dgbl->rng_cipher != 
# 667 "../crypto/rand/rand_lib.c" 3 4
                                    ((void *)0) 
# 667 "../crypto/rand/rand_lib.c"
                                         ? dgbl->rng_cipher : "AES-256-CTR";
        *p++ = OSSL_PARAM_construct_utf8_string("cipher",
                                                cipher, 0);
    }
    if (dgbl->rng_digest != 
# 671 "../crypto/rand/rand_lib.c" 3 4
                           ((void *)0)
            
# 672 "../crypto/rand/rand_lib.c"
           && OSSL_PARAM_locate_const(settables, "digest"))
        *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                                dgbl->rng_digest, 0);
    if (dgbl->rng_propq != 
# 675 "../crypto/rand/rand_lib.c" 3 4
                          ((void *)0)
# 675 "../crypto/rand/rand_lib.c"
                              )
        *p++ = OSSL_PARAM_construct_utf8_string("properties",
                                                dgbl->rng_propq, 0);
    if (OSSL_PARAM_locate_const(settables, "mac"))
        *p++ = OSSL_PARAM_construct_utf8_string("mac", "HMAC", 0);
    if (OSSL_PARAM_locate_const(settables, "use_derivation_function"))
        *p++ = OSSL_PARAM_construct_int("use_derivation_function", &use_df);
    *p++ = OSSL_PARAM_construct_uint("reseed_requests",
                                     &reseed_interval);
    *p++ = OSSL_PARAM_construct_time_t("reseed_time_interval",
                                       &reseed_time_interval);
    *p = OSSL_PARAM_construct_end();
    if (!EVP_RAND_instantiate(ctx, 0, 0, 
# 687 "../crypto/rand/rand_lib.c" 3 4
                                        ((void *)0)
# 687 "../crypto/rand/rand_lib.c"
                                            , 0, params)) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",688,__func__), ERR_set_error)((36),(108),
# 688 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 688 "../crypto/rand/rand_lib.c"
       );
        EVP_RAND_CTX_free(ctx);
        return 
# 690 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 690 "../crypto/rand/rand_lib.c"
                  ;
    }
    return ctx;
}
...
EVP_RAND_CTX *RAND_get0_primary(OSSL_LIB_CTX *ctx)
{
    ...
    if (dgbl == 
# 705 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 705 "../crypto/rand/rand_lib.c"
                   )
        return 
# 706 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 706 "../crypto/rand/rand_lib.c"
                  ;

    if (!CRYPTO_THREAD_read_lock(dgbl->lock))
        return 
# 709 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 709 "../crypto/rand/rand_lib.c"
                  ;
    ...
    if (ret != 
# 714 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 714 "../crypto/rand/rand_lib.c"
                  )
        return ret;

    if (!CRYPTO_THREAD_write_lock(dgbl->lock))
        return 
# 718 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 718 "../crypto/rand/rand_lib.c"
                  ;

    ret = dgbl->primary;
    if (ret != 
# 721 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 721 "../crypto/rand/rand_lib.c"
                  ) {
        CRYPTO_THREAD_unlock(dgbl->lock);
        return ret;
    }
    ...
    if (dgbl->seed == 
# 727 "../crypto/rand/rand_lib.c" 3 4
                     ((void *)0)
# 727 "../crypto/rand/rand_lib.c"
    ...
    if (ret != 
# 741 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0) 
# 741 "../crypto/rand/rand_lib.c"
                   && !EVP_RAND_enable_locking(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",742,__func__), ERR_set_error)((6),(212),
# 742 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 742 "../crypto/rand/rand_lib.c"
       );
        EVP_RAND_CTX_free(ret);
        ret = dgbl->primary = 
# 744 "../crypto/rand/rand_lib.c" 3 4
                             ((void *)0)
# 744 "../crypto/rand/rand_lib.c"
                                 ;
    }
    CRYPTO_THREAD_unlock(dgbl->lock);
...
EVP_RAND_CTX *RAND_get0_public(OSSL_LIB_CTX *ctx)
{
    ...
    if (dgbl == 
# 760 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 760 "../crypto/rand/rand_lib.c"
                   )
        return 
# 761 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 761 "../crypto/rand/rand_lib.c"
                  ;

    rand = CRYPTO_THREAD_get_local(&dgbl->public);
    if (rand == 
# 764 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 764 "../crypto/rand/rand_lib.c"
                   ) {
        primary = RAND_get0_primary(ctx);
        if (primary == 
# 766 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 766 "../crypto/rand/rand_lib.c"
                          )
            return 
# 767 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 767 "../crypto/rand/rand_lib.c"
                      ;

        ctx = ossl_lib_ctx_get_concrete(ctx);

        if (ctx == 
# 771 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 771 "../crypto/rand/rand_lib.c"
                      )
            return 
# 772 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 772 "../crypto/rand/rand_lib.c"
                      ;




        if (CRYPTO_THREAD_get_local(&dgbl->private) == 
# 777 "../crypto/rand/rand_lib.c" 3 4
                                                      ((void *)0)
                
# 778 "../crypto/rand/rand_lib.c"
               && !ossl_init_thread_start(
# 778 "../crypto/rand/rand_lib.c" 3 4
                                          ((void *)0)
# 778 "../crypto/rand/rand_lib.c"
                                              , ctx, rand_delete_thread_state))
            return 
# 779 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 779 "../crypto/rand/rand_lib.c"
                      ;
        rand = rand_new_drbg(ctx, primary, (1 << 16),
                             (7 * 60), 0);
...
EVP_RAND_CTX *RAND_get0_private(OSSL_LIB_CTX *ctx)
{
    ...
    if (dgbl == 
# 796 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 796 "../crypto/rand/rand_lib.c"
                   )
        return 
# 797 "../crypto/rand/rand_lib.c" 3 4
              ((void *)0)
# 797 "../crypto/rand/rand_lib.c"
                  ;

    rand = CRYPTO_THREAD_get_local(&dgbl->private);
    if (rand == 
# 800 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 800 "../crypto/rand/rand_lib.c"
                   ) {
        primary = RAND_get0_primary(ctx);
        if (primary == 
# 802 "../crypto/rand/rand_lib.c" 3 4
                      ((void *)0)
# 802 "../crypto/rand/rand_lib.c"
                          )
            return 
# 803 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 803 "../crypto/rand/rand_lib.c"
                      ;

        ctx = ossl_lib_ctx_get_concrete(ctx);

        if (ctx == 
# 807 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 807 "../crypto/rand/rand_lib.c"
                      )
            return 
# 808 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 808 "../crypto/rand/rand_lib.c"
                      ;




        if (CRYPTO_THREAD_get_local(&dgbl->public) == 
# 813 "../crypto/rand/rand_lib.c" 3 4
                                                     ((void *)0)
                
# 814 "../crypto/rand/rand_lib.c"
               && !ossl_init_thread_start(
# 814 "../crypto/rand/rand_lib.c" 3 4
                                          ((void *)0)
# 814 "../crypto/rand/rand_lib.c"
                                              , ctx, rand_delete_thread_state))
            return 
# 815 "../crypto/rand/rand_lib.c" 3 4
                  ((void *)0)
# 815 "../crypto/rand/rand_lib.c"
                      ;
        rand = rand_new_drbg(ctx, primary, (1 << 16),
                             (7 * 60), 0);
...
int RAND_set0_public(OSSL_LIB_CTX *ctx, EVP_RAND_CTX *rand)
{
    ...
    if (dgbl == 
# 841 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 841 "../crypto/rand/rand_lib.c"
                   )
        return 0;
...
int RAND_set0_private(OSSL_LIB_CTX *ctx, EVP_RAND_CTX *rand)
{
    ...
    if (dgbl == 
# 855 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 855 "../crypto/rand/rand_lib.c"
                   )
        return 0;
...
{
    char *d = 
# 866 "../crypto/rand/rand_lib.c" 3 4
             ((void *)0)
# 866 "../crypto/rand/rand_lib.c"
                 ;

    if (s != 
# 868 "../crypto/rand/rand_lib.c" 3 4
            ((void *)0)
# 868 "../crypto/rand/rand_lib.c"
                ) {
        d = CRYPTO_strdup(s, "../crypto/rand/rand_lib.c", 869);
        if (d == 
# 870 "../crypto/rand/rand_lib.c" 3 4
                ((void *)0)
# 870 "../crypto/rand/rand_lib.c"
                    )
            return 0;
    }
    CRYPTO_free(*p, "../crypto/rand/rand_lib.c", 873);
    *p = d;
    return 1;
}
...
static int random_conf_init(CONF_IMODULE *md, const CONF *cnf)
{
    ...
    if (elist == 
# 893 "../crypto/rand/rand_lib.c" 3 4
                ((void *)0)
# 893 "../crypto/rand/rand_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",894,__func__), ERR_set_error)((15),(119),
# 894 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 894 "../crypto/rand/rand_lib.c"
       );
        return 0;
    }

    if (dgbl == 
# 898 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 898 "../crypto/rand/rand_lib.c"
                   )
        return 0;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(elist)); i++) {
        ...
        if (OPENSSL_strcasecmp(cval->name, "random") == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",922,__func__), ERR_set_error)(15,
                           120,
                       ...
                       const char *cipher, const char *digest)
{
    ...
    if (dgbl == 
# 948 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 948 "../crypto/rand/rand_lib.c"
                   )
        return 0;
    if (dgbl->primary != 
# 950 "../crypto/rand/rand_lib.c" 3 4
                        ((void *)0)
# 950 "../crypto/rand/rand_lib.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",951,__func__), ERR_set_error)((15),(103),
# 951 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 951 "../crypto/rand/rand_lib.c"
       );
        return 0;
    }
                              ...
                              const char *propq)
{
    ...
    if (dgbl == 
# 965 "../crypto/rand/rand_lib.c" 3 4
               ((void *)0)
# 965 "../crypto/rand/rand_lib.c"
                   )
        return 0;
    if (dgbl->seed != 
# 967 "../crypto/rand/rand_lib.c" 3 4
                     ((void *)0)
# 967 "../crypto/rand/rand_lib.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/rand_lib.c",968,__func__), ERR_set_error)((15),(103),
# 968 "../crypto/rand/rand_lib.c" 3 4
       ((void *)0)
# 968 "../crypto/rand/rand_lib.c"
       );
        return 0;
    }
