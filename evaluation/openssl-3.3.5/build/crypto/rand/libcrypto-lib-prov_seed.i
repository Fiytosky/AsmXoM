# 0 "../crypto/rand/prov_seed.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rand/prov_seed.c"
# 10 "../crypto/rand/prov_seed.c"
...
# 15 "../crypto/rand/prov_seed.c" 2



size_t ossl_rand_get_entropy(__attribute__((unused)) OSSL_LIB_CTX *ctx,
                             unsigned char **pout, int entropy,
                             size_t min_len, size_t max_len)
{
    size_t ret = 0;
    ...
    if (pool == 
# 27 "../crypto/rand/prov_seed.c" 3 4
               ((void *)0)
# 27 "../crypto/rand/prov_seed.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/prov_seed.c",28,__func__), ERR_set_error)((36),((36 | (0x2 << 18L))),
# 28 "../crypto/rand/prov_seed.c" 3 4
       ((void *)0)
# 28 "../crypto/rand/prov_seed.c"
       );
        return 0;
    }
                                  ...
                                  size_t min_len, size_t max_len)
{
    ...
    if (rng != 
# 50 "../crypto/rand/prov_seed.c" 3 4
              ((void *)0) 
# 50 "../crypto/rand/prov_seed.c"
                   && evp_rand_can_seed(rng))
        return evp_rand_get_seed(rng, pout, entropy, min_len, max_len,
                                 0, 
# 52 "../crypto/rand/prov_seed.c" 3 4
                                   ((void *)0)
# 52 "../crypto/rand/prov_seed.c"
                                       , 0);
    else
        return ossl_rand_get_entropy(ctx, pout, entropy, min_len, max_len);
}

void ossl_rand_cleanup_entropy(__attribute__((unused)) OSSL_LIB_CTX *ctx,
                               unsigned char *buf, size_t len)
{
    CRYPTO_secure_clear_free(buf, len, "../crypto/rand/prov_seed.c", 60);
}
                                    ...
                                    unsigned char *buf, size_t len)
{
    ...
    if (rng != 
# 68 "../crypto/rand/prov_seed.c" 3 4
              ((void *)0) 
# 68 "../crypto/rand/prov_seed.c"
                   && evp_rand_can_seed(rng))
        evp_rand_clear_seed(rng, buf, len);
    else
        CRYPTO_secure_clear_free(buf, len, "../crypto/rand/prov_seed.c", 71);
}

size_t ossl_rand_get_nonce(__attribute__((unused)) OSSL_LIB_CTX *ctx,
                           unsigned char **pout,
                           size_t min_len, __attribute__((unused)) size_t max_len,
                           const void *salt, size_t salt_len)
{
    size_t ret = 0;
    RAND_POOL *pool;
    ...
    if (pool == 
# 83 "../crypto/rand/prov_seed.c" 3 4
               ((void *)0)
# 83 "../crypto/rand/prov_seed.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rand/prov_seed.c",84,__func__), ERR_set_error)((36),((36 | (0x2 << 18L))),
# 84 "../crypto/rand/prov_seed.c" 3 4
       ((void *)0)
# 84 "../crypto/rand/prov_seed.c"
       );
        return 0;
    }
    ...
    if (salt != 
# 91 "../crypto/rand/prov_seed.c" 3 4
               ((void *)0) 
# 91 "../crypto/rand/prov_seed.c"
                    && !ossl_rand_pool_add(pool, salt, salt_len, 0))
        goto err;
    ret = ossl_rand_pool_length(pool);
    *pout = ossl_rand_pool_detach(pool);
 err:
                                ...
                                const void *salt, size_t salt_len)
{
    ...
    if (rng == 
# 108 "../crypto/rand/prov_seed.c" 3 4
              ((void *)0)
# 108 "../crypto/rand/prov_seed.c"
                  )
        return ossl_rand_get_nonce(ctx, pout, min_len, max_len, salt, salt_len);

    if ((buf = CRYPTO_malloc(min_len, "../crypto/rand/prov_seed.c", 111)) == 
# 111 "../crypto/rand/prov_seed.c" 3 4
                                          ((void *)0)
# 111 "../crypto/rand/prov_seed.c"
                                              )
        return 0;

    if (!EVP_RAND_generate(rng, buf, min_len, 0, 0, salt, salt_len)) {
        CRYPTO_free(buf, "../crypto/rand/prov_seed.c", 115);
        return 0;
    }
    *pout = buf;
    return min_len;
...
void ossl_rand_cleanup_nonce(__attribute__((unused)) OSSL_LIB_CTX *ctx,
                             unsigned char *buf, size_t len)
{
    CRYPTO_clear_free(buf, len, "../crypto/rand/prov_seed.c", 125);
}

void ossl_rand_cleanup_user_nonce(__attribute__((unused)) OSSL_LIB_CTX *ctx,
                                  unsigned char *buf, size_t len)
{
    CRYPTO_clear_free(buf, len, "../crypto/rand/prov_seed.c", 131);
}
