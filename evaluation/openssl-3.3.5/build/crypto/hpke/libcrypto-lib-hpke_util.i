# 0 "../crypto/hpke/hpke_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/hpke/hpke_util.c"
# 10 "../crypto/hpke/hpke_util.c"
...
# 11 "../crypto/hpke/hpke_util.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../crypto/hpke/hpke_util.c" 2
...
# 23 "../crypto/hpke/hpke_util.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 24 "../crypto/hpke/hpke_util.c" 2
...
# 25 "../crypto/hpke/hpke_util.c" 2
# 37 "../crypto/hpke/hpke_util.c"
typedef struct {
    uint16_t id;
    char *synonyms[4];
} synonymttab_t;
...
# 63 "../crypto/hpke/hpke_util.c"
static const OSSL_HPKE_KEM_INFO hpke_kem_tab[] = {

    { 0x0010, "EC", "P-256",
      "sha256", 32, 65, 65, 32, 0xFF },
    { 0x0011, "EC", "P-384",
      "sha384", 48, 97, 97, 48, 0xFF },
    { 0x0012, "EC", "P-521",
      "sha512", 64, 133, 133, 66, 0x01 },

    { 0x0020, "X25519", 
# 72 "../crypto/hpke/hpke_util.c" 3 4
                                                       ((void *)0)
# 72 "../crypto/hpke/hpke_util.c"
                                                           ,
      "sha256", 32,
      32, 32, 32, 0x00 },
    { 0x0021, "X448", 
# 75 "../crypto/hpke/hpke_util.c" 3 4
                                                   ((void *)0)
# 75 "../crypto/hpke/hpke_util.c"
                                                       ,
      "sha512", 64,
      56, 56, 56, 0x00 }
...
static const OSSL_HPKE_AEAD_INFO hpke_aead_tab[] = {
    { 0x0001, "aes-128-gcm", 16, 16,
      12 },
    { 0x0002, "aes-256-gcm", 16, 32,
      12 },

    { 0x0003, "chacha20-poly1305", 16, 32,
      12 },

    { 0xFFFF, 
# 97 "../crypto/hpke/hpke_util.c" 3 4
                                   ((void *)0)
# 97 "../crypto/hpke/hpke_util.c"
                                       , 0, 0, 0 }
};
...
const OSSL_HPKE_KEM_INFO *ossl_HPKE_KEM_INFO_find_curve(const char *curve)
{
    int i, sz = (sizeof(hpke_kem_tab)/sizeof((hpke_kem_tab)[0]));

    for (i = 0; i < sz; ++i) {
        const char *group = hpke_kem_tab[i].groupname;

        if (group == 
# 163 "../crypto/hpke/hpke_util.c" 3 4
                    ((void *)0)
# 163 "../crypto/hpke/hpke_util.c"
                        )
            group = hpke_kem_tab[i].keytype;
        if (OPENSSL_strcasecmp(curve, group) == 0)
            return &hpke_kem_tab[i];
    }
    (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",168,__func__), ERR_set_error)((57),(176),
# 168 "../crypto/hpke/hpke_util.c" 3 4
   ((void *)0)
# 168 "../crypto/hpke/hpke_util.c"
   );
    return 
# 169 "../crypto/hpke/hpke_util.c" 3 4
          ((void *)0)
# 169 "../crypto/hpke/hpke_util.c"
              ;
}
...
const OSSL_HPKE_KEM_INFO *ossl_HPKE_KEM_INFO_find_id(uint16_t kemid)
{
    ...
    if (kemid == 0x0000) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",181,__func__), ERR_set_error)((57),(176),
# 181 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 181 "../crypto/hpke/hpke_util.c"
       );
        return 
# 182 "../crypto/hpke/hpke_util.c" 3 4
              ((void *)0)
# 182 "../crypto/hpke/hpke_util.c"
                  ;
    }
    for (i = 0; i != sz; ++i) {
    ...
    (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",188,__func__), ERR_set_error)((57),(176),
# 188 "../crypto/hpke/hpke_util.c" 3 4
   ((void *)0)
# 188 "../crypto/hpke/hpke_util.c"
   );
    return 
# 189 "../crypto/hpke/hpke_util.c" 3 4
          ((void *)0)
# 189 "../crypto/hpke/hpke_util.c"
              ;
}
...
const OSSL_HPKE_KEM_INFO *ossl_HPKE_KEM_INFO_find_random(OSSL_LIB_CTX *ctx)
{
    uint32_t rval = 0;
    int err = 0;
    size_t sz = (sizeof(hpke_kem_tab)/sizeof((hpke_kem_tab)[0]));

    rval = ossl_rand_uniform_uint32(ctx, sz, &err);
    return (err == 1 ? 
# 199 "../crypto/hpke/hpke_util.c" 3 4
                      ((void *)0) 
# 199 "../crypto/hpke/hpke_util.c"
                           : &hpke_kem_tab[rval]);
}

const OSSL_HPKE_KDF_INFO *ossl_HPKE_KDF_INFO_find_id(uint16_t kdfid)
{
    int i, sz = (sizeof(hpke_kdf_tab)/sizeof((hpke_kdf_tab)[0]));

    for (i = 0; i != sz; ++i) {
        if (hpke_kdf_tab[i].kdf_id == kdfid)
            return &hpke_kdf_tab[i];
    }
    (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",210,__func__), ERR_set_error)((57),(232),
# 210 "../crypto/hpke/hpke_util.c" 3 4
   ((void *)0)
# 210 "../crypto/hpke/hpke_util.c"
   );
    return 
# 211 "../crypto/hpke/hpke_util.c" 3 4
          ((void *)0)
# 211 "../crypto/hpke/hpke_util.c"
              ;
}
...
const OSSL_HPKE_KDF_INFO *ossl_HPKE_KDF_INFO_find_random(OSSL_LIB_CTX *ctx)
{
    uint32_t rval = 0;
    int err = 0;
    size_t sz = (sizeof(hpke_kdf_tab)/sizeof((hpke_kdf_tab)[0]));

    rval = ossl_rand_uniform_uint32(ctx, sz, &err);
    return (err == 1 ? 
# 221 "../crypto/hpke/hpke_util.c" 3 4
                      ((void *)0) 
# 221 "../crypto/hpke/hpke_util.c"
                           : &hpke_kdf_tab[rval]);
}

const OSSL_HPKE_AEAD_INFO *ossl_HPKE_AEAD_INFO_find_id(uint16_t aeadid)
{
    int i, sz = (sizeof(hpke_aead_tab)/sizeof((hpke_aead_tab)[0]));

    for (i = 0; i != sz; ++i) {
        if (hpke_aead_tab[i].aead_id == aeadid)
            return &hpke_aead_tab[i];
    }
    (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",232,__func__), ERR_set_error)((57),(231),
# 232 "../crypto/hpke/hpke_util.c" 3 4
   ((void *)0)
# 232 "../crypto/hpke/hpke_util.c"
   );
    return 
# 233 "../crypto/hpke/hpke_util.c" 3 4
          ((void *)0)
# 233 "../crypto/hpke/hpke_util.c"
              ;
}
...
const OSSL_HPKE_AEAD_INFO *ossl_HPKE_AEAD_INFO_find_random(OSSL_LIB_CTX *ctx)
{
    ...
    size_t sz = (sizeof(hpke_aead_tab)/sizeof((hpke_aead_tab)[0])) - 1;

    rval = ossl_rand_uniform_uint32(ctx, sz, &err);
    return (err == 1 ? 
# 244 "../crypto/hpke/hpke_util.c" 3 4
                      ((void *)0) 
# 244 "../crypto/hpke/hpke_util.c"
                           : &hpke_aead_tab[rval]);
}
                      ...
                      const unsigned char *info, size_t infolen)
{
    ...
    *p++ = OSSL_PARAM_construct_int("mode", &mode);
    if (salt != 
# 257 "../crypto/hpke/hpke_util.c" 3 4
               ((void *)0)
# 257 "../crypto/hpke/hpke_util.c"
                   )
        *p++ = OSSL_PARAM_construct_octet_string("salt",
                                                 (char *)salt, saltlen);
    if (ikm != 
# 260 "../crypto/hpke/hpke_util.c" 3 4
              ((void *)0)
# 260 "../crypto/hpke/hpke_util.c"
                  )
        *p++ = OSSL_PARAM_construct_octet_string("key",
                                                 (char *)ikm, ikmlen);
    if (info != 
# 263 "../crypto/hpke/hpke_util.c" 3 4
               ((void *)0)
# 263 "../crypto/hpke/hpke_util.c"
                   )
    ...
    *p = OSSL_PARAM_construct_end();
    ...
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",269,__func__), ERR_set_error)((57),(164),
# 269 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 269 "../crypto/hpke/hpke_util.c"
       );
    return ret;
}
...
int ossl_hpke_kdf_extract(EVP_KDF_CTX *kctx,
                          ...
                          const unsigned char *ikm, size_t ikmlen)
{
    return kdf_derive(kctx, prk, prklen, 1,
                      salt, saltlen, ikm, ikmlen, 
# 279 "../crypto/hpke/hpke_util.c" 3 4
                                                 ((void *)0)
# 279 "../crypto/hpke/hpke_util.c"
                                                     , 0);
}
...
int ossl_hpke_kdf_expand(EVP_KDF_CTX *kctx,
                         ...
                         const unsigned char *info, size_t infolen)
{
    return kdf_derive(kctx, okm, okmlen, 2,
                      
# 289 "../crypto/hpke/hpke_util.c" 3 4
                     ((void *)0)
# 289 "../crypto/hpke/hpke_util.c"
                         , 0, prk, prklen, info, infolen);
}
...
# 308 "../crypto/hpke/hpke_util.c" 3 4
                                ((void *)0)
# 308 "../crypto/hpke/hpke_util.c"
                                    ;
    WPACKET pkt;
    ...
    labeled_ikm = CRYPTO_malloc(labeled_ikmlen, "../crypto/hpke/hpke_util.c", 316);
    if (labeled_ikm == 
# 317 "../crypto/hpke/hpke_util.c" 3 4
                      ((void *)0)
# 317 "../crypto/hpke/hpke_util.c"
                          )
        return 0;
    ...
    if (!WPACKET_init_static_len(&pkt, labeled_ikm, labeled_ikmlen, 0)
            ...
            || !WPACKET_finish(&pkt)) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",329,__func__), ERR_set_error)((57),(106),
# 329 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 329 "../crypto/hpke/hpke_util.c"
       );
        goto end;
    }
    ...
    CRYPTO_free(labeled_ikm, "../crypto/hpke/hpke_util.c", 338);
    return ret;
}
...
# 358 "../crypto/hpke/hpke_util.c" 3 4
                                 ((void *)0)
# 358 "../crypto/hpke/hpke_util.c"
                                     ;
    WPACKET pkt;
    ...
    labeled_info = CRYPTO_malloc(labeled_infolen, "../crypto/hpke/hpke_util.c", 366);
    if (labeled_info == 
# 367 "../crypto/hpke/hpke_util.c" 3 4
                       ((void *)0)
# 367 "../crypto/hpke/hpke_util.c"
                           )
        return 0;


    if (!WPACKET_init_static_len(&pkt, labeled_info, labeled_infolen, 0)
            || !WPACKET_put_bytes__((&pkt), (okmlen), 2)
            || !WPACKET_memcpy(&pkt, LABEL_HPKEV1, label_hpkev1len)
            || !WPACKET_memcpy(&pkt, protocol_label, protocol_labellen)
            || !WPACKET_memcpy(&pkt, suiteid, suiteidlen)
            || !WPACKET_memcpy(&pkt, label, labellen)
            ...
            || !WPACKET_finish(&pkt)) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",380,__func__), ERR_set_error)((57),(106),
# 380 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 380 "../crypto/hpke/hpke_util.c"
       );
        goto end;
    }
    ...
    WPACKET_cleanup(&pkt);
    CRYPTO_free(labeled_info, "../crypto/hpke/hpke_util.c", 388);
    return ret;
}
                                 ...
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    EVP_KDF *kdf;
    EVP_KDF_CTX *kctx = 
# 397 "../crypto/hpke/hpke_util.c" 3 4
                       ((void *)0)
# 397 "../crypto/hpke/hpke_util.c"
                           ;

    kdf = EVP_KDF_fetch(libctx, kdfname, propq);
    if (kdf == 
# 400 "../crypto/hpke/hpke_util.c" 3 4
              ((void *)0)
# 400 "../crypto/hpke/hpke_util.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",401,__func__), ERR_set_error)((15),((269|(0x2 << 18L))),
# 401 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 401 "../crypto/hpke/hpke_util.c"
       );
        return 
# 402 "../crypto/hpke/hpke_util.c" 3 4
              ((void *)0)
# 402 "../crypto/hpke/hpke_util.c"
                  ;
    }
    kctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (kctx != 
# 406 "../crypto/hpke/hpke_util.c" 3 4
               ((void *)0) 
# 406 "../crypto/hpke/hpke_util.c"
                    && mdname != 
# 406 "../crypto/hpke/hpke_util.c" 3 4
                                 ((void *)0)
# 406 "../crypto/hpke/hpke_util.c"
        ...
        if (mdname != 
# 409 "../crypto/hpke/hpke_util.c" 3 4
                     ((void *)0)
# 409 "../crypto/hpke/hpke_util.c"
                         )
            *p++ = OSSL_PARAM_construct_utf8_string("digest",
                                                    (char *)mdname, 0);
        if (propq != 
# 412 "../crypto/hpke/hpke_util.c" 3 4
                    ((void *)0)
# 412 "../crypto/hpke/hpke_util.c"
                        )
        ...
        *p = OSSL_PARAM_construct_end();
        if (EVP_KDF_CTX_set_params(kctx, params) <= 0) {
            ...
            return 
# 418 "../crypto/hpke/hpke_util.c" 3 4
                  ((void *)0)
# 418 "../crypto/hpke/hpke_util.c"
                      ;
        }
    }
    return kctx;
}
# 431 "../crypto/hpke/hpke_util.c"
                                 ...
                                 size_t arrsize)
{
    ...
    for (i = 0; i < arrsize; ++i) {
        for (j = 0; j < (sizeof(synp[i].synonyms)/sizeof((synp[i].synonyms)[0])); ++j) {
...
int ossl_hpke_str2suite(const char *suitestr, OSSL_HPKE_SUITE *suite)
{
    ...
    char *st = 
# 454 "../crypto/hpke/hpke_util.c" 3 4
              ((void *)0)
# 454 "../crypto/hpke/hpke_util.c"
                  , *instrcp = 
# 454 "../crypto/hpke/hpke_util.c" 3 4
                               ((void *)0)
# 454 "../crypto/hpke/hpke_util.c"
    ...
    if (suitestr == 
# 459 "../crypto/hpke/hpke_util.c" 3 4
                   ((void *)0) 
# 459 "../crypto/hpke/hpke_util.c"
                        || suitestr[0] == 0x00 || suite == 
# 459 "../crypto/hpke/hpke_util.c" 3 4
                                                           ((void *)0)
# 459 "../crypto/hpke/hpke_util.c"
                                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",460,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 460 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 460 "../crypto/hpke/hpke_util.c"
       );
        return 0;
    }
    inplen = OPENSSL_strnlen(suitestr, 38);
    if (inplen >= 38) {
        (ERR_new(), ERR_set_debug("../crypto/hpke/hpke_util.c",465,__func__), ERR_set_error)((15),((262|(0x2 << 18L))),
# 465 "../crypto/hpke/hpke_util.c" 3 4
       ((void *)0)
# 465 "../crypto/hpke/hpke_util.c"
       );
        return 0;
    }
    ...
    instrcp = CRYPTO_memdup((suitestr), inplen + 1, "../crypto/hpke/hpke_util.c", 484);
    if (instrcp == 
# 485 "../crypto/hpke/hpke_util.c" 3 4
                  ((void *)0)
# 485 "../crypto/hpke/hpke_util.c"
                      )
        goto fail;
    ...
    while (st != 
# 491 "../crypto/hpke/hpke_util.c" 3 4
                ((void *)0) 
# 491 "../crypto/hpke/hpke_util.c"
                     && labels < 3) {
        char *cp = strchr(st, ',');


        if (cp != 
# 495 "../crypto/hpke/hpke_util.c" 3 4
                 ((void *)0)
# 495 "../crypto/hpke/hpke_util.c"
                     )
            *cp = '\0';
        ...
        if (labels == 0
            && (kem = synonyms_name2id(st, kemstrtab,
                                       (sizeof(kemstrtab)/sizeof((kemstrtab)[0])))) == 0)
            goto fail;
        else if (labels == 1
                 && (kdf = synonyms_name2id(st, kdfstrtab,
                                            (sizeof(kdfstrtab)/sizeof((kdfstrtab)[0])))) == 0)
            goto fail;
        else if (labels == 2
                 && (aead = synonyms_name2id(st, aeadstrtab,
                                             (sizeof(aeadstrtab)/sizeof((aeadstrtab)[0])))) == 0)
            goto fail;

        if (cp == 
# 512 "../crypto/hpke/hpke_util.c" 3 4
                 ((void *)0)
# 512 "../crypto/hpke/hpke_util.c"
                     )
            st = 
# 513 "../crypto/hpke/hpke_util.c" 3 4
                ((void *)0)
# 513 "../crypto/hpke/hpke_util.c"
                    ;
        else
            st = cp + 1;
        ++labels;
    ...
    if (st != 
# 518 "../crypto/hpke/hpke_util.c" 3 4
             ((void *)0) 
# 518 "../crypto/hpke/hpke_util.c"
                  || labels != 3)
        goto fail;
    suite->kem_id = kem;
    suite->kdf_id = kdf;
...
fail:
    CRYPTO_free(instrcp, "../crypto/hpke/hpke_util.c", 526);
    return result;
}
