# 0 "../crypto/thread/api.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/thread/api.c"
# 10 "../crypto/thread/api.c"
# 1 "include/openssl/configuration.h" 1
# 16 "include/openssl/configuration.h"
        
# 11 "../crypto/thread/api.c" 2
...
uint64_t OSSL_get_max_threads(OSSL_LIB_CTX *ctx)
{
    ...
    if (tdata == 
# 47 "../crypto/thread/api.c" 3 4
                ((void *)0)
# 47 "../crypto/thread/api.c"
                    )
        goto fail;
...
int OSSL_set_max_threads(OSSL_LIB_CTX *ctx, uint64_t max_threads)
{
    ...
    tdata = ossl_lib_ctx_get_data(ctx, 19);;
    if (tdata == 
# 63 "../crypto/thread/api.c" 3 4
                ((void *)0)
# 63 "../crypto/thread/api.c"
                    )
        return 0;
