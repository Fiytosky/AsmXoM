# 0 "../crypto/thread/arch/thread_posix.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 13 "../include/internal/thread_arch.h" 2
...
# 14 "../include/internal/thread_arch.h" 2
...
# 18 "../crypto/thread/arch/thread_posix.c"
static void *thread_start_thunk(void *vthread)
{
    ...
    return 
# 32 "../crypto/thread/arch/thread_posix.c" 3 4
          ((void *)0)
# 32 "../crypto/thread/arch/thread_posix.c"
              ;
}
...
int ossl_crypto_thread_native_spawn(CRYPTO_THREAD *thread)
{
    ...
    if (handle == 
# 42 "../crypto/thread/arch/thread_posix.c" 3 4
                 ((void *)0)
# 42 "../crypto/thread/arch/thread_posix.c"
                     )
        goto fail;
...
# 47 "../crypto/thread/arch/thread_posix.c" 3 4
                                          PTHREAD_CREATE_DETACHED
# 47 "../crypto/thread/arch/thread_posix.c"
                                                                 );
...
fail:
    thread->handle = 
# 58 "../crypto/thread/arch/thread_posix.c" 3 4
                    ((void *)0)
# 58 "../crypto/thread/arch/thread_posix.c"
                        ;
...
int ossl_crypto_thread_native_perform_join(CRYPTO_THREAD *thread, CRYPTO_THREAD_RETVAL *retval)
{
    ...
    if (thread == 
# 68 "../crypto/thread/arch/thread_posix.c" 3 4
                 ((void *)0) 
# 68 "../crypto/thread/arch/thread_posix.c"
                      || thread->handle == 
# 68 "../crypto/thread/arch/thread_posix.c" 3 4
                                           ((void *)0)
# 68 "../crypto/thread/arch/thread_posix.c"
    ...
    if (thread_retval != 
# 79 "../crypto/thread/arch/thread_posix.c" 3 4
                        ((void *)0)
# 79 "../crypto/thread/arch/thread_posix.c"
                            )
        return 0;
...
{
    pthread_exit(
# 87 "../crypto/thread/arch/thread_posix.c" 3 4
                ((void *)0)
# 87 "../crypto/thread/arch/thread_posix.c"
                    );
    return 1;
}
...
CRYPTO_MUTEX *ossl_crypto_mutex_new(void)
{
    ...
    if ((mutex = CRYPTO_zalloc(sizeof(*mutex), "../crypto/thread/arch/thread_posix.c", 100)) == 
# 100 "../crypto/thread/arch/thread_posix.c" 3 4
                                                   ((void *)0)
# 100 "../crypto/thread/arch/thread_posix.c"
                                                       )
        return 
# 101 "../crypto/thread/arch/thread_posix.c" 3 4
              ((void *)0)
# 101 "../crypto/thread/arch/thread_posix.c"
                  ;
    if (pthread_mutex_init(mutex, 
# 102 "../crypto/thread/arch/thread_posix.c" 3 4
                                 ((void *)0)
# 102 "../crypto/thread/arch/thread_posix.c"
                                     ) != 0) {
        CRYPTO_free(mutex, "../crypto/thread/arch/thread_posix.c", 103);
        return 
# 104 "../crypto/thread/arch/thread_posix.c" 3 4
              ((void *)0)
# 104 "../crypto/thread/arch/thread_posix.c"
                  ;
    }
...
int ossl_crypto_mutex_try_lock(CRYPTO_MUTEX *mutex)
{
    ...
    if (pthread_mutex_trylock(mutex_p) == 
# 115 "../crypto/thread/arch/thread_posix.c" 3 4
                                         16
# 115 "../crypto/thread/arch/thread_posix.c"
                                              )
        return 0;
...
void ossl_crypto_mutex_free(CRYPTO_MUTEX **mutex)
{
    ...
    if (mutex == 
# 145 "../crypto/thread/arch/thread_posix.c" 3 4
                ((void *)0)
# 145 "../crypto/thread/arch/thread_posix.c"
                    )
        return;

    mutex_p = (pthread_mutex_t **)mutex;
    if (*mutex_p != 
# 149 "../crypto/thread/arch/thread_posix.c" 3 4
                   ((void *)0)
# 149 "../crypto/thread/arch/thread_posix.c"
                       )
        pthread_mutex_destroy(*mutex_p);
    CRYPTO_free(*mutex_p, "../crypto/thread/arch/thread_posix.c", 151);
    *mutex = 
# 152 "../crypto/thread/arch/thread_posix.c" 3 4
            ((void *)0)
# 152 "../crypto/thread/arch/thread_posix.c"
                ;
}
...
CRYPTO_CONDVAR *ossl_crypto_condvar_new(void)
{
    ...
    if ((cv_p = CRYPTO_zalloc(sizeof(*cv_p), "../crypto/thread/arch/thread_posix.c", 159)) == 
# 159 "../crypto/thread/arch/thread_posix.c" 3 4
                                                 ((void *)0)
# 159 "../crypto/thread/arch/thread_posix.c"
                                                     )
        return 
# 160 "../crypto/thread/arch/thread_posix.c" 3 4
              ((void *)0)
# 160 "../crypto/thread/arch/thread_posix.c"
                  ;
    if (pthread_cond_init(cv_p, 
# 161 "../crypto/thread/arch/thread_posix.c" 3 4
                               ((void *)0)
# 161 "../crypto/thread/arch/thread_posix.c"
                                   ) != 0) {
        CRYPTO_free(cv_p, "../crypto/thread/arch/thread_posix.c", 162);
        return 
# 163 "../crypto/thread/arch/thread_posix.c" 3 4
              ((void *)0)
# 163 "../crypto/thread/arch/thread_posix.c"
                  ;
    }
                                      ...
                                      OSSL_TIME deadline)
{
    ...
    if (ossl_time_is_infinite(deadline)) {
        ...
        deadline_ts.tv_sec
            = (ossl_time2ticks(deadline) / ((uint64_t)1000000000));
        deadline_ts.tv_nsec
            = (ossl_time2ticks(deadline) % ((uint64_t)1000000000)) / (((((uint64_t)1000000000) / 1000) / 1000) / 1000);
...
void ossl_crypto_condvar_free(CRYPTO_CONDVAR **cv)
{
    ...
    if (cv == 
# 223 "../crypto/thread/arch/thread_posix.c" 3 4
             ((void *)0)
# 223 "../crypto/thread/arch/thread_posix.c"
                 )
        return;

    cv_p = (pthread_cond_t **)cv;
    if (*cv_p != 
# 227 "../crypto/thread/arch/thread_posix.c" 3 4
                ((void *)0)
# 227 "../crypto/thread/arch/thread_posix.c"
                    )
        pthread_cond_destroy(*cv_p);
    CRYPTO_free(*cv_p, "../crypto/thread/arch/thread_posix.c", 229);
    *cv_p = 
# 230 "../crypto/thread/arch/thread_posix.c" 3 4
           ((void *)0)
# 230 "../crypto/thread/arch/thread_posix.c"
               ;
}
