...
uint64_t ossl_get_avail_threads(OSSL_LIB_CTX *ctx)
{
    ...
    if (tdata == 
# 30 "../crypto/thread/internal.c" 3 4
                ((void *)0)
# 30 "../crypto/thread/internal.c"
                    )
        return retval;
                               ...
                               void *data)
{
    ...
    if (tdata == 
# 46 "../crypto/thread/internal.c" 3 4
                ((void *)0)
# 46 "../crypto/thread/internal.c"
                    )
        return 
# 47 "../crypto/thread/internal.c" 3 4
              ((void *)0)
# 47 "../crypto/thread/internal.c"
                  ;

    ossl_crypto_mutex_lock(tdata->lock);
    if (tdata == 
# 50 "../crypto/thread/internal.c" 3 4
                ((void *)0) 
# 50 "../crypto/thread/internal.c"
                     || tdata->max_threads == 0) {
        ossl_crypto_mutex_unlock(tdata->lock);
        return 
# 52 "../crypto/thread/internal.c" 3 4
              ((void *)0)
# 52 "../crypto/thread/internal.c"
                  ;
    }
    ...
    if (thread == 
# 61 "../crypto/thread/internal.c" 3 4
                 ((void *)0)
# 61 "../crypto/thread/internal.c"
                     ) {
        ossl_crypto_mutex_lock(tdata->lock);
        tdata->active_threads--;
        ossl_crypto_mutex_unlock(tdata->lock);
...
int ossl_crypto_thread_join(void *vhandle, CRYPTO_THREAD_RETVAL *retval)
{
    ...
    if (vhandle == 
# 78 "../crypto/thread/internal.c" 3 4
                  ((void *)0)
# 78 "../crypto/thread/internal.c"
                      )
        return 0;

    tdata = ossl_lib_ctx_get_data(handle->ctx, 19);;
    if (tdata == 
# 82 "../crypto/thread/internal.c" 3 4
                ((void *)0)
# 82 "../crypto/thread/internal.c"
                    )
        return 0;
...
void *ossl_threads_ctx_new(OSSL_LIB_CTX *ctx)
{
    ...
    if (t == 
# 131 "../crypto/thread/internal.c" 3 4
            ((void *)0)
# 131 "../crypto/thread/internal.c"
                )
        return 
# 132 "../crypto/thread/internal.c" 3 4
              ((void *)0)
# 132 "../crypto/thread/internal.c"
                  ;
    ...
    if (t->lock == 
# 137 "../crypto/thread/internal.c" 3 4
                  ((void *)0) 
# 137 "../crypto/thread/internal.c"
                       || t->cond_finished == 
# 137 "../crypto/thread/internal.c" 3 4
                                              ((void *)0)
# 137 "../crypto/thread/internal.c"
...
fail:
    ...
    return 
# 144 "../crypto/thread/internal.c" 3 4
          ((void *)0)
# 144 "../crypto/thread/internal.c"
              ;
}
...
void ossl_threads_ctx_free(void *vdata)
{
    ...
    if (t == 
# 151 "../crypto/thread/internal.c" 3 4
            ((void *)0)
# 151 "../crypto/thread/internal.c"
                )
        return;
