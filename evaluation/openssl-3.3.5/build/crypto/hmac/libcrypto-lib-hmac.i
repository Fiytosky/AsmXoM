# 0 "../crypto/hmac/hmac.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/hmac/hmac.c"
# 14 "../crypto/hmac/hmac.c"
...
# 22 "../crypto/hmac/hmac.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 23 "../crypto/hmac/hmac.c" 2
# 1 "../crypto/hmac/hmac_local.h" 1
# 16 "../crypto/hmac/hmac_local.h"
struct hmac_ctx_st {
    const EVP_MD *md;
    EVP_MD_CTX *md_ctx;
    EVP_MD_CTX *i_ctx;
                 ...
                 const EVP_MD *md, ENGINE *impl)
{
    ...
    if (md != 
# 35 "../crypto/hmac/hmac.c" 3 4
             ((void *)0) 
# 35 "../crypto/hmac/hmac.c"
                  && md != ctx->md && (key == 
# 35 "../crypto/hmac/hmac.c" 3 4
                                              ((void *)0) 
# 35 "../crypto/hmac/hmac.c"
    ...
    if (md != 
# 38 "../crypto/hmac/hmac.c" 3 4
             ((void *)0)
# 38 "../crypto/hmac/hmac.c"
                 )
        ctx->md = md;
    else if (ctx->md != 
# 40 "../crypto/hmac/hmac.c" 3 4
                       ((void *)0)
# 40 "../crypto/hmac/hmac.c"
                           )
        md = ctx->md;
    else
        return 0;
    ...
    if (key != 
# 52 "../crypto/hmac/hmac.c" 3 4
              ((void *)0)
# 52 "../crypto/hmac/hmac.c"
                  ) {
        reset = 1;

        j = EVP_MD_get_block_size(md);
        if (!__builtin_expect(!!((j <= (int)sizeof(keytmp)) != 0), 1))
            return 0;
        if (j < 0)
            return 0;
        if (j < len) {
...
# 106 "../crypto/hmac/hmac.c" 3 4
                                          ((void *)0)
# 106 "../crypto/hmac/hmac.c"
                                              );
}
...
{
    HMAC_CTX *ctx = CRYPTO_zalloc(sizeof(HMAC_CTX), "../crypto/hmac/hmac.c", 147);

    if (ctx != 
# 149 "../crypto/hmac/hmac.c" 3 4
              ((void *)0)
# 149 "../crypto/hmac/hmac.c"
                  ) {
        if (!HMAC_CTX_reset(ctx)) {
            HMAC_CTX_free(ctx);
            return 
# 152 "../crypto/hmac/hmac.c" 3 4
                  ((void *)0)
# 152 "../crypto/hmac/hmac.c"
                      ;
        }
    }
    return ctx;
...
static void hmac_ctx_cleanup(HMAC_CTX *ctx)
{
    ...
    ctx->md = 
# 163 "../crypto/hmac/hmac.c" 3 4
             ((void *)0)
# 163 "../crypto/hmac/hmac.c"
                 ;
}
...
{
    if (ctx != 
# 168 "../crypto/hmac/hmac.c" 3 4
              ((void *)0)
# 168 "../crypto/hmac/hmac.c"
                  ) {
        hmac_ctx_cleanup(ctx);
        EVP_MD_CTX_free(ctx->i_ctx);
        EVP_MD_CTX_free(ctx->o_ctx);
        EVP_MD_CTX_free(ctx->md_ctx);
        CRYPTO_free(ctx, "../crypto/hmac/hmac.c", 173);
    }
}
...
{
    if (ctx->i_ctx == 
# 179 "../crypto/hmac/hmac.c" 3 4
                     ((void *)0)
# 179 "../crypto/hmac/hmac.c"
                         )
        ctx->i_ctx = EVP_MD_CTX_new();
    if (ctx->i_ctx == 
# 181 "../crypto/hmac/hmac.c" 3 4
                     ((void *)0)
# 181 "../crypto/hmac/hmac.c"
                         )
        return 0;
    if (ctx->o_ctx == 
# 183 "../crypto/hmac/hmac.c" 3 4
                     ((void *)0)
# 183 "../crypto/hmac/hmac.c"
                         )
        ctx->o_ctx = EVP_MD_CTX_new();
    if (ctx->o_ctx == 
# 185 "../crypto/hmac/hmac.c" 3 4
                     ((void *)0)
# 185 "../crypto/hmac/hmac.c"
                         )
        return 0;
    if (ctx->md_ctx == 
# 187 "../crypto/hmac/hmac.c" 3 4
                      ((void *)0)
# 187 "../crypto/hmac/hmac.c"
                          )
        ctx->md_ctx = EVP_MD_CTX_new();
    if (ctx->md_ctx == 
# 189 "../crypto/hmac/hmac.c" 3 4
                      ((void *)0)
# 189 "../crypto/hmac/hmac.c"
                          )
        return 0;
    return 1;
}
                    ...
                    unsigned char *md, unsigned int *md_len)
{
    ...
    unsigned char *ret = 
# 228 "../crypto/hmac/hmac.c" 3 4
                        ((void *)0)
# 228 "../crypto/hmac/hmac.c"
                            ;

    if (size >= 0) {
        ret = EVP_Q_mac(
# 231 "../crypto/hmac/hmac.c" 3 4
                       ((void *)0)
...
# 231 "../crypto/hmac/hmac.c"
                        ...
                        md == 
# 233 "../crypto/hmac/hmac.c" 3 4
                             ((void *)0) 
# 233 "../crypto/hmac/hmac.c"
                                  ? static_md : md, size, &temp_md_len);
        if (md_len != 
# 234 "../crypto/hmac/hmac.c" 3 4
                     ((void *)0)
# 234 "../crypto/hmac/hmac.c"
                         )
