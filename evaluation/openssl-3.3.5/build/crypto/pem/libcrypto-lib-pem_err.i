# 0 "../crypto/pem/pem_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_err.c"
# 11 "../crypto/pem/pem_err.c"
...
# 12 "../crypto/pem/pem_err.c" 2
# 1 "../include/openssl/pemerr.h" 1
# 13 "../include/openssl/pemerr.h"
        
# 13 "../crypto/pem/pem_err.c" 2
# 1 "../include/crypto/pemerr.h" 1
# 13 "../include/crypto/pemerr.h"
        
# 22 "../include/crypto/pemerr.h"
int ossl_err_load_PEM_strings(void);
# 14 "../crypto/pem/pem_err.c" 2



static const ERR_STRING_DATA PEM_str_reasons[] = {
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "bad base64 decode"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad decrypt"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "bad end line"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "bad iv chars"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ), "bad magic number"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "bad password read"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ), "bad version number"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ), "bio write failure"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ), "cipher is null"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "error converting private key"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "expecting dss key blob"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "expecting private key blob"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "expecting public key blob"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ),
    "expecting rsa key blob"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ), "header too long"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "inconsistent header"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "keyblob header parse error"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ), "keyblob too short"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "missing dek iv"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "not dek info"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "not encrypted"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "not proc type"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "no start line"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "problems getting password"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ), "pvk data too short"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "pvk too short"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "read key"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "short header"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "unexpected dek iv"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "unsupported cipher"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "unsupported encryption"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "unsupported key components"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "unsupported public key type"},
    {0, 
# 62 "../crypto/pem/pem_err.c" 3 4
       ((void *)0)
# 62 "../crypto/pem/pem_err.c"
           }
};
...
int ossl_err_load_PEM_strings(void)
{
    ...
    if (ERR_reason_error_string(PEM_str_reasons[0].error) == 
# 70 "../crypto/pem/pem_err.c" 3 4
                                                            ((void *)0)
# 70 "../crypto/pem/pem_err.c"
                                                                )
