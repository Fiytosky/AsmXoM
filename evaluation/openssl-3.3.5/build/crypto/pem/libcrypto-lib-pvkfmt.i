# 0 "../crypto/pem/pvkfmt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pvkfmt.c"
# 19 "../crypto/pem/pvkfmt.c"
...
# 27 "../crypto/pem/pvkfmt.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 28 "../crypto/pem/pvkfmt.c" 2
...
{
    *r = BN_lebin2bn(*in, nbyte, 
# 57 "../crypto/pem/pvkfmt.c" 3 4
                                ((void *)0)
# 57 "../crypto/pem/pvkfmt.c"
                                    );
    if (*r == 
# 58 "../crypto/pem/pvkfmt.c" 3 4
             ((void *)0)
# 58 "../crypto/pem/pvkfmt.c"
                 )
        return 0;
    *in += nbyte;
    return 1;
}
# 72 "../crypto/pem/pvkfmt.c"
static EVP_PKEY *evp_pkey_new0_key(void *key, int evp_type)
{
    EVP_PKEY *pkey = 
# 74 "../crypto/pem/pvkfmt.c" 3 4
                    ((void *)0)
# 74 "../crypto/pem/pvkfmt.c"
                        ;
    ...
    if (key == 
# 80 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 80 "../crypto/pem/pvkfmt.c"
                  )
        return 
# 81 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 81 "../crypto/pem/pvkfmt.c"
                  ;

    if (!__builtin_expect(!!((evp_type == 6 || evp_type == 116) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",84,__func__), ERR_set_error)((9),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 84 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 84 "../crypto/pem/pvkfmt.c"
       );
        return 
# 85 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 85 "../crypto/pem/pvkfmt.c"
                  ;
    }

    if ((pkey = EVP_PKEY_new()) != 
# 88 "../crypto/pem/pvkfmt.c" 3 4
                                  ((void *)0)
# 88 "../crypto/pem/pvkfmt.c"
                                      ) {
        switch (evp_type) {
        case 6:
            if (EVP_PKEY_set1_RSA(pkey, key))
                break;
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",93,__func__), ERR_set_error)((9),((6 | (0x2 << 18L))),
# 93 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 93 "../crypto/pem/pvkfmt.c"
           );
            EVP_PKEY_free(pkey);
            pkey = 
# 95 "../crypto/pem/pvkfmt.c" 3 4
                  ((void *)0)
# 95 "../crypto/pem/pvkfmt.c"
                      ;
            break;
        ...
        case 116:
            if (EVP_PKEY_set1_DSA(pkey, key))
                break;
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",101,__func__), ERR_set_error)((9),((6 | (0x2 << 18L))),
# 101 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 101 "../crypto/pem/pvkfmt.c"
           );
            EVP_PKEY_free(pkey);
            pkey = 
# 103 "../crypto/pem/pvkfmt.c" 3 4
                  ((void *)0)
# 103 "../crypto/pem/pvkfmt.c"
                      ;
            break;

        }
    } else {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",108,__func__), ERR_set_error)((9),((6 | (0x2 << 18L))),
# 108 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 108 "../crypto/pem/pvkfmt.c"
       );
    }
                        ...
                        int *pisdss, int *pispub)
{
    ...
    case 0x6:
        if (*pispub == 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",175,__func__), ERR_set_error)((9),(119),
# 175 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 175 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        *pispub = 1;
    ...
    case 0x7:
        if (*pispub == 1) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",183,__func__), ERR_set_error)((9),(120),
# 183 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 183 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        *pispub = 0;
    ...
    if (*p++ != 0x2) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",195,__func__), ERR_set_error)((9),(117),
# 195 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 195 "../crypto/pem/pvkfmt.c"
       );
        return 0;
    }
    ...
    *pbitlen = read_ledword(&p);
    ...
    case 0x31415352L:
        if (*pispub == 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",208,__func__), ERR_set_error)((9),(119),
# 208 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 208 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        break;
    ...
    case 0x32415352L:
        if (*pispub == 1) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",216,__func__), ERR_set_error)((9),(120),
# 216 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 216 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        break;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",222,__func__), ERR_set_error)((9),(116),
# 222 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 222 "../crypto/pem/pvkfmt.c"
       );
        return -1;
    }
    ...
    case 0x32535344L:
        if (*pisdss == 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",231,__func__), ERR_set_error)((9),(131),
# 231 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 231 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        *pisdss = 1;
    ...
    case 0x32415352L:
        if (*pisdss == 1) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",239,__func__), ERR_set_error)((9),(132),
# 239 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 239 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        *pisdss = 0;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",246,__func__), ERR_set_error)((9),(116),
# 246 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 246 "../crypto/pem/pvkfmt.c"
       );
        return -1;
    }
    *in = p;
                        ...
                        int *isdss, int *ispub)
{
    ...
    void *key = 
# 291 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 291 "../crypto/pem/pvkfmt.c"
                   ;

    if (ossl_do_blob_header(&p, length, &magic, &bitlen, isdss, ispub) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",294,__func__), ERR_set_error)((9),(122),
# 294 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 294 "../crypto/pem/pvkfmt.c"
       );
        return 
# 295 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 295 "../crypto/pem/pvkfmt.c"
                  ;
    }
    length -= 16;
    if (length < ossl_blob_length(bitlen, *isdss, *ispub)) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",299,__func__), ERR_set_error)((9),(123),
# 299 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 299 "../crypto/pem/pvkfmt.c"
       );
        return 
# 300 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 300 "../crypto/pem/pvkfmt.c"
                  ;
    }
    if (!*isdss)
    ...
    if (key == 
# 309 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 309 "../crypto/pem/pvkfmt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",310,__func__), ERR_set_error)((9),(110),
# 310 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 310 "../crypto/pem/pvkfmt.c"
       );
        return 
# 311 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 311 "../crypto/pem/pvkfmt.c"
                  ;
    }
...
EVP_PKEY *ossl_b2i(const unsigned char **in, unsigned int length, int *ispub)
{
    ...
    return evp_pkey_new0_key(key, (isdss == 0 ? 6 : isdss == 1 ? 116 : 0));
}
...
# 328 "../crypto/pem/pvkfmt.c" 3 4
                                     ((void *)0)
# 328 "../crypto/pem/pvkfmt.c"
                                         ;
    unsigned int bitlen, magic, length;
    int isdss = -1;
    void *key = 
# 331 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 331 "../crypto/pem/pvkfmt.c"
                   ;
    EVP_PKEY *pkey = 
# 332 "../crypto/pem/pvkfmt.c" 3 4
                    ((void *)0)
# 332 "../crypto/pem/pvkfmt.c"
                        ;

    if (BIO_read(in, hdr_buf, 16) != 16) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",335,__func__), ERR_set_error)((9),(123),
# 335 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 335 "../crypto/pem/pvkfmt.c"
       );
        return 
# 336 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 336 "../crypto/pem/pvkfmt.c"
                  ;
    }
    p = hdr_buf;
    if (ossl_do_blob_header(&p, 16, &magic, &bitlen, &isdss, ispub) <= 0)
        return 
# 340 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 340 "../crypto/pem/pvkfmt.c"
                  ;

    length = ossl_blob_length(bitlen, isdss, *ispub);
    if (length > 102400) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",344,__func__), ERR_set_error)((9),(128),
# 344 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 344 "../crypto/pem/pvkfmt.c"
       );
        return 
# 345 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 345 "../crypto/pem/pvkfmt.c"
                  ;
    }
    buf = CRYPTO_malloc(length, "../crypto/pem/pvkfmt.c", 347);
    if (buf == 
# 348 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 348 "../crypto/pem/pvkfmt.c"
                  )
        goto err;
    p = buf;
    if (BIO_read(in, buf, length) != (int)length) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",352,__func__), ERR_set_error)((9),(123),
# 352 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 352 "../crypto/pem/pvkfmt.c"
       );
        goto err;
    }
    ...
    if (key == 
# 363 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 363 "../crypto/pem/pvkfmt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",364,__func__), ERR_set_error)((9),(110),
# 364 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 364 "../crypto/pem/pvkfmt.c"
       );
        goto err;
    }

    pkey = evp_pkey_new0_key(key, (isdss == 0 ? 6 : isdss == 1 ? 116 : 0));
 err:
    CRYPTO_free(buf, "../crypto/pem/pvkfmt.c", 370);
    return pkey;
}
                               ...
                               int ispub)
{
    const unsigned char *p = *in;
    DSA *dsa = 
# 379 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 379 "../crypto/pem/pvkfmt.c"
                  ;
    BN_CTX *ctx = 
# 380 "../crypto/pem/pvkfmt.c" 3 4
                 ((void *)0)
# 380 "../crypto/pem/pvkfmt.c"
                     ;
    BIGNUM *pbn = 
# 381 "../crypto/pem/pvkfmt.c" 3 4
                 ((void *)0)
# 381 "../crypto/pem/pvkfmt.c"
                     , *qbn = 
# 381 "../crypto/pem/pvkfmt.c" 3 4
                              ((void *)0)
# 381 "../crypto/pem/pvkfmt.c"
...
# 381 "../crypto/pem/pvkfmt.c"
                                                                 ;
    BIGNUM *pub_key = 
# 382 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 382 "../crypto/pem/pvkfmt.c"
                         ;
    unsigned int nbyte = (bitlen + 7) >> 3;

    dsa = DSA_new();
    if (dsa == 
# 386 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 386 "../crypto/pem/pvkfmt.c"
                  )
        goto dsaerr;
    ...
    if (ispub) {
        ...
        BN_set_flags(priv_key, 0x04);


        pub_key = BN_new();
        if (pub_key == 
# 409 "../crypto/pem/pvkfmt.c" 3 4
                      ((void *)0)
# 409 "../crypto/pem/pvkfmt.c"
                          )
            goto bnerr;
        if ((ctx = BN_CTX_new()) == 
# 411 "../crypto/pem/pvkfmt.c" 3 4
                                   ((void *)0)
# 411 "../crypto/pem/pvkfmt.c"
                                       )
            goto bnerr;
        ...
        BN_CTX_free(ctx);
        ctx = 
# 418 "../crypto/pem/pvkfmt.c" 3 4
             ((void *)0)
# 418 "../crypto/pem/pvkfmt.c"
                 ;
    }
    if (!DSA_set0_pqg(dsa, pbn, qbn, gbn))
        goto dsaerr;
    pbn = qbn = gbn = 
# 422 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 422 "../crypto/pem/pvkfmt.c"
                         ;
    if (!DSA_set0_key(dsa, pub_key, priv_key))
        goto dsaerr;
    pub_key = priv_key = 
# 425 "../crypto/pem/pvkfmt.c" 3 4
                        ((void *)0)
# 425 "../crypto/pem/pvkfmt.c"
                            ;
 ...
 dsaerr:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",431,__func__), ERR_set_error)((9),((10 | (0x2 << 18L))),
# 431 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 431 "../crypto/pem/pvkfmt.c"
   );
    goto err;
 bnerr:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",434,__func__), ERR_set_error)((9),((3 | (0x2 << 18L))),
# 434 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 434 "../crypto/pem/pvkfmt.c"
   );
 ...
 err:
    ...
    BN_CTX_free(ctx);
    return 
# 444 "../crypto/pem/pvkfmt.c" 3 4
          ((void *)0)
# 444 "../crypto/pem/pvkfmt.c"
              ;
}
                               ...
                               int ispub)
{
    ...
    BIGNUM *e = 
# 452 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 452 "../crypto/pem/pvkfmt.c"
                   , *n = 
# 452 "../crypto/pem/pvkfmt.c" 3 4
                          ((void *)0)
# 452 "../crypto/pem/pvkfmt.c"
...
# 452 "../crypto/pem/pvkfmt.c"
                                         ;
    BIGNUM *p = 
# 453 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 453 "../crypto/pem/pvkfmt.c"
                   , *q = 
# 453 "../crypto/pem/pvkfmt.c" 3 4
                          ((void *)0)
# 453 "../crypto/pem/pvkfmt.c"
...
# 453 "../crypto/pem/pvkfmt.c"
                                                                        ;
    RSA *rsa = 
# 454 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 454 "../crypto/pem/pvkfmt.c"
                  ;
    unsigned int nbyte = (bitlen + 7) >> 3;
    unsigned int hnbyte = (bitlen + 15) >> 4;
    ...
    rsa = RSA_new();
    if (rsa == 
# 459 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 459 "../crypto/pem/pvkfmt.c"
                  )
        goto rsaerr;
    e = BN_new();
    if (e == 
# 462 "../crypto/pem/pvkfmt.c" 3 4
            ((void *)0)
# 462 "../crypto/pem/pvkfmt.c"
                )
        goto bnerr;
    ...
    if (!ispub) {
        ...
        if (!RSA_set0_factors(rsa, p, q))
            goto rsaerr;
        p = q = 
# 483 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 483 "../crypto/pem/pvkfmt.c"
                   ;
        if (!RSA_set0_crt_params(rsa, dmp1, dmq1, iqmp))
            goto rsaerr;
        dmp1 = dmq1 = iqmp = 
# 486 "../crypto/pem/pvkfmt.c" 3 4
                            ((void *)0)
# 486 "../crypto/pem/pvkfmt.c"
                                ;
    }
    if (!RSA_set0_key(rsa, n, e, d))
        goto rsaerr;
    n = e = d = 
# 490 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 490 "../crypto/pem/pvkfmt.c"
                   ;
 ...
 rsaerr:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",496,__func__), ERR_set_error)((9),((4 | (0x2 << 18L))),
# 496 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 496 "../crypto/pem/pvkfmt.c"
   );
    goto err;
 bnerr:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",499,__func__), ERR_set_error)((9),((3 | (0x2 << 18L))),
# 499 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 499 "../crypto/pem/pvkfmt.c"
   );
 ...
 err:
    ...
    RSA_free(rsa);
    return 
# 511 "../crypto/pem/pvkfmt.c" 3 4
          ((void *)0)
# 511 "../crypto/pem/pvkfmt.c"
              ;
}
...
static int do_i2b(unsigned char **out, const EVP_PKEY *pk, int ispub)
{
    ...
    outlen = 16
        + ossl_blob_length(bitlen, keyalg == 0x2200 ? 1 : 0, ispub);
    if (out == 
# 587 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 587 "../crypto/pem/pvkfmt.c"
                  )
        goto end;
    if (*out)
        p = *out;
    else {
        if ((p = CRYPTO_malloc(outlen, "../crypto/pem/pvkfmt.c", 592)) == 
# 592 "../crypto/pem/pvkfmt.c" 3 4
                                           ((void *)0)
# 592 "../crypto/pem/pvkfmt.c"
                                               ) {
            outlen = -1;
            goto end;
        }
...
{
    unsigned char *tmp = 
# 623 "../crypto/pem/pvkfmt.c" 3 4
                        ((void *)0)
# 623 "../crypto/pem/pvkfmt.c"
                            ;
    int outlen, wrlen;
    ...
    CRYPTO_free(tmp, "../crypto/pem/pvkfmt.c", 630);
    if (wrlen == outlen)
        return outlen;
    return -1;
}
...
static int check_bitlen_rsa(const RSA *rsa, int ispub, unsigned int *pmagic)
{
    ...
    RSA_get0_key(rsa, 
# 641 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 641 "../crypto/pem/pvkfmt.c"
                         , &e, 
# 641 "../crypto/pem/pvkfmt.c" 3 4
                               ((void *)0)
# 641 "../crypto/pem/pvkfmt.c"
    ...
    if (ispub) {
        ...
        *pmagic = 0x32415352L;
        ...
        RSA_get0_key(rsa, 
# 658 "../crypto/pem/pvkfmt.c" 3 4
                         ((void *)0)
# 658 "../crypto/pem/pvkfmt.c"
                             , 
# 658 "../crypto/pem/pvkfmt.c" 3 4
                               ((void *)0)
# 658 "../crypto/pem/pvkfmt.c"
                                   , &d);
        if (((BN_num_bits(d)+7)/8) > nbyte)
            goto badkey;
        RSA_get0_factors(rsa, &p, &q);
        RSA_get0_crt_params(rsa, &dmp1, &dmq1, &iqmp);
        if ((((BN_num_bits(iqmp)+7)/8) > hnbyte)
    ...
    return bitlen;
 badkey:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",672,__func__), ERR_set_error)((9),(126),
# 672 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
...
static int check_bitlen_dsa(const DSA *dsa, int ispub, unsigned int *pmagic)
{
    int bitlen;
    const BIGNUM *p = 
# 702 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 702 "../crypto/pem/pvkfmt.c"
                         , *q = 
# 702 "../crypto/pem/pvkfmt.c" 3 4
                                ((void *)0)
# 702 "../crypto/pem/pvkfmt.c"
...
# 702 "../crypto/pem/pvkfmt.c"
                                               ;
    const BIGNUM *pub_key = 
# 703 "../crypto/pem/pvkfmt.c" 3 4
                           ((void *)0)
# 703 "../crypto/pem/pvkfmt.c"
                               , *priv_key = 
# 703 "../crypto/pem/pvkfmt.c" 3 4
                                             ((void *)0)
# 703 "../crypto/pem/pvkfmt.c"
    ...
    return bitlen;
 badkey:
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",723,__func__), ERR_set_error)((9),(126),
# 723 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 723 "../crypto/pem/pvkfmt.c"
   );
    return 0;
}
...
static void write_dsa(unsigned char **out, const DSA *dsa, int ispub)
{
    int nbyte;
    const BIGNUM *p = 
# 730 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 730 "../crypto/pem/pvkfmt.c"
                         , *q = 
# 730 "../crypto/pem/pvkfmt.c" 3 4
                                ((void *)0)
# 730 "../crypto/pem/pvkfmt.c"
...
# 730 "../crypto/pem/pvkfmt.c"
                                               ;
    const BIGNUM *pub_key = 
# 731 "../crypto/pem/pvkfmt.c" 3 4
                           ((void *)0)
# 731 "../crypto/pem/pvkfmt.c"
                               , *priv_key = 
# 731 "../crypto/pem/pvkfmt.c" 3 4
                                             ((void *)0)
# 731 "../crypto/pem/pvkfmt.c"
                       ...
                       unsigned int *psaltlen, unsigned int *pkeylen)
{
    ...
    if (skip_magic) {
        if (length < 20) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",769,__func__), ERR_set_error)((9),(125),
# 769 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 769 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
    } else {
        if (length < 24) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",774,__func__), ERR_set_error)((9),(125),
# 774 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 774 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
        pvk_magic = read_ledword(&p);
        if (pvk_magic != 0xb0b5f11eL) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",779,__func__), ERR_set_error)((9),(116),
# 779 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 779 "../crypto/pem/pvkfmt.c"
           );
            return 0;
        }
    }
    ...
    *pkeylen = read_ledword(&p);
    ...
    if (*pkeylen > 102400 || *psaltlen > 10240)
        return 0;

    if (is_encrypted && *psaltlen == 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",796,__func__), ERR_set_error)((9),(121),
# 796 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 796 "../crypto/pem/pvkfmt.c"
       );
        return 0;
    }
                          ...
                          OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if ((kdf = EVP_KDF_fetch(libctx, "PVKKDF", propq)) == 
# 815 "../crypto/pem/pvkfmt.c" 3 4
                                                         ((void *)0)
# 815 "../crypto/pem/pvkfmt.c"
                                                             )
        return 0;
    ctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (ctx == 
# 819 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 819 "../crypto/pem/pvkfmt.c"
                  )
        return 0;
...
# 844 "../crypto/pem/pvkfmt.c" 3 4
                           ((void *)0)
# 844 "../crypto/pem/pvkfmt.c"
                               ;
    unsigned char keybuf[20];
    void *key = 
# 846 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 846 "../crypto/pem/pvkfmt.c"
                   ;

    EVP_CIPHER *rc4 = 
# 848 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 848 "../crypto/pem/pvkfmt.c"
                         ;

    EVP_CIPHER_CTX *cctx = EVP_CIPHER_CTX_new();

    if (cctx == 
# 852 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 852 "../crypto/pem/pvkfmt.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",853,__func__), ERR_set_error)((9),((6 | (0x2 << 18L))),
# 853 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 853 "../crypto/pem/pvkfmt.c"
       );
        goto err;
    }
    ...
    if (saltlen) {
        ...
        if (inlen < 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",869,__func__), ERR_set_error)((9),(104),
# 869 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 869 "../crypto/pem/pvkfmt.c"
           );
            goto err;
        }
        enctmp = CRYPTO_malloc(keylen + 8, "../crypto/pem/pvkfmt.c", 872);
        if (enctmp == 
# 873 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 873 "../crypto/pem/pvkfmt.c"
                         )
            goto err;
        ...
        p += 8;
        if (keylen < 8) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",883,__func__), ERR_set_error)((9),(125),
# 883 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 883 "../crypto/pem/pvkfmt.c"
           );
            goto err;
        }
        inlen = keylen - 8;
        q = enctmp + 8;
        if ((rc4 = EVP_CIPHER_fetch(libctx, "RC4", propq)) == 
# 888 "../crypto/pem/pvkfmt.c" 3 4
                                                             ((void *)0)
# 888 "../crypto/pem/pvkfmt.c"
                                                                 )
            goto err;
        if (!EVP_DecryptInit_ex(cctx, rc4, 
# 890 "../crypto/pem/pvkfmt.c" 3 4
                                          ((void *)0)
# 890 "../crypto/pem/pvkfmt.c"
                                              , keybuf, 
# 890 "../crypto/pem/pvkfmt.c" 3 4
                                                        ((void *)0)
# 890 "../crypto/pem/pvkfmt.c"
        ...
        if (magic != 0x32415352L && magic != 0x32535344L) {
            ...
            if (!EVP_DecryptInit_ex(cctx, rc4, 
# 900 "../crypto/pem/pvkfmt.c" 3 4
                                              ((void *)0)
# 900 "../crypto/pem/pvkfmt.c"
                                                  , keybuf, 
# 900 "../crypto/pem/pvkfmt.c" 3 4
                                                            ((void *)0)
# 900 "../crypto/pem/pvkfmt.c"
            ...
            magic = read_ledword((const unsigned char **)&q);
            if (magic != 0x32415352L && magic != 0x32535344L) {
                (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",908,__func__), ERR_set_error)((9),(101),
# 908 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 908 "../crypto/pem/pvkfmt.c"
               );
                goto err;
            }
        }
 ...
 err:
    ...
    if (enctmp != 
# 925 "../crypto/pem/pvkfmt.c" 3 4
                 ((void *)0)
# 925 "../crypto/pem/pvkfmt.c"
                     ) {
        OPENSSL_cleanse(keybuf, sizeof(keybuf));
        CRYPTO_free(enctmp, "../crypto/pem/pvkfmt.c", 927);
    }
    return key;
}
...
# 936 "../crypto/pem/pvkfmt.c" 3 4
                                     ((void *)0)
# 936 "../crypto/pem/pvkfmt.c"
                                         ;
    const unsigned char *p;
    int buflen;
    void *key = 
# 939 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 939 "../crypto/pem/pvkfmt.c"
                   ;
    unsigned int saltlen, keylen;

    if (BIO_read(in, pvk_hdr, 24) != 24) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",943,__func__), ERR_set_error)((9),(124),
# 943 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 943 "../crypto/pem/pvkfmt.c"
       );
        return 
# 944 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 944 "../crypto/pem/pvkfmt.c"
                  ;
    }
    p = pvk_hdr;
    ...
    buf = CRYPTO_malloc(buflen, "../crypto/pem/pvkfmt.c", 951);
    if (buf == 
# 952 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 952 "../crypto/pem/pvkfmt.c"
                  )
        return 0;
    p = buf;
    if (BIO_read(in, buf, buflen) != buflen) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",956,__func__), ERR_set_error)((9),(124),
# 956 "../crypto/pem/pvkfmt.c" 3 4
       ((void *)0)
# 956 "../crypto/pem/pvkfmt.c"
       );
        goto err;
    }
 ...
 err:
    CRYPTO_clear_free(buf, buflen, "../crypto/pem/pvkfmt.c", 962);
    return key;
}
...
DSA *b2i_DSA_PVK_bio(BIO *in, pem_password_cb *cb, void *u)
{
    return b2i_DSA_PVK_bio_ex(in, cb, u, 
# 978 "../crypto/pem/pvkfmt.c" 3 4
                                        ((void *)0)
# 978 "../crypto/pem/pvkfmt.c"
                                            , 
# 978 "../crypto/pem/pvkfmt.c" 3 4
                                              ((void *)0)
# 978 "../crypto/pem/pvkfmt.c"
...
RSA *b2i_RSA_PVK_bio(BIO *in, pem_password_cb *cb, void *u)
{
    return b2i_RSA_PVK_bio_ex(in, cb, u, 
# 993 "../crypto/pem/pvkfmt.c" 3 4
                                        ((void *)0)
# 993 "../crypto/pem/pvkfmt.c"
                                            , 
# 993 "../crypto/pem/pvkfmt.c" 3 4
                                              ((void *)0)
# 993 "../crypto/pem/pvkfmt.c"
...
# 1001 "../crypto/pem/pvkfmt.c" 3 4
                                                         ((void *)0)
# 1001 "../crypto/pem/pvkfmt.c"
                                                             , 
# 1001 "../crypto/pem/pvkfmt.c" 3 4
                                                               ((void *)0)
# 1001 "../crypto/pem/pvkfmt.c"
...
EVP_PKEY *b2i_PVK_bio(BIO *in, pem_password_cb *cb, void *u)
{
    return b2i_PVK_bio_ex(in, cb, u, 
# 1008 "../crypto/pem/pvkfmt.c" 3 4
                                    ((void *)0)
# 1008 "../crypto/pem/pvkfmt.c"
                                        , 
# 1008 "../crypto/pem/pvkfmt.c" 3 4
                                          ((void *)0)
# 1008 "../crypto/pem/pvkfmt.c"
                   ...
                   const char *propq)
{
    ...
    int outlen = 24, pklen;
    unsigned char *p = 
# 1017 "../crypto/pem/pvkfmt.c" 3 4
                      ((void *)0)
# 1017 "../crypto/pem/pvkfmt.c"
                          , *start = 
# 1017 "../crypto/pem/pvkfmt.c" 3 4
                                     ((void *)0)
# 1017 "../crypto/pem/pvkfmt.c"
                                         ;
    EVP_CIPHER_CTX *cctx = 
# 1018 "../crypto/pem/pvkfmt.c" 3 4
                          ((void *)0)
# 1018 "../crypto/pem/pvkfmt.c"
                              ;

    unsigned char *salt = 
# 1020 "../crypto/pem/pvkfmt.c" 3 4
                         ((void *)0)
# 1020 "../crypto/pem/pvkfmt.c"
                             ;
    EVP_CIPHER *rc4 = 
# 1021 "../crypto/pem/pvkfmt.c" 3 4
                     ((void *)0)
# 1021 "../crypto/pem/pvkfmt.c"
                         ;
    ...
    if (enclevel)
        outlen += 0x10;
    pklen = do_i2b(
# 1026 "../crypto/pem/pvkfmt.c" 3 4
                  ((void *)0)
# 1026 "../crypto/pem/pvkfmt.c"
                      , pk, 0);
    if (pklen < 0)
        return -1;
    outlen += pklen;
    if (out == 
# 1030 "../crypto/pem/pvkfmt.c" 3 4
              ((void *)0)
# 1030 "../crypto/pem/pvkfmt.c"
                  )
        return outlen;
    if (*out != 
# 1032 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 1032 "../crypto/pem/pvkfmt.c"
                   ) {
        p = *out;
    } else {
        start = p = CRYPTO_malloc(outlen, "../crypto/pem/pvkfmt.c", 1035);
        if (p == 
# 1036 "../crypto/pem/pvkfmt.c" 3 4
                ((void *)0)
# 1036 "../crypto/pem/pvkfmt.c"
                    )
            return -1;
    }
    ...
    if (cctx == 
# 1041 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 1041 "../crypto/pem/pvkfmt.c"
                   )
        goto error;

    write_ledword(&p, 0xb0b5f11eL);
    write_ledword(&p, 0);
    if (EVP_PKEY_get_id(pk) == 6)
        write_ledword(&p, 0x1);
    ...
    if (enclevel) {
        ...
        if (RAND_bytes_ex(libctx, p, 0x10, 0) <= 0)
            goto error;
        salt = p;
        p += 0x10;
    ...
    if (enclevel != 0) {
        ...
        if (inlen <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",1074,__func__), ERR_set_error)((9),(104),
# 1074 "../crypto/pem/pvkfmt.c" 3 4
           ((void *)0)
# 1074 "../crypto/pem/pvkfmt.c"
           );
            goto error;
        }
        if (!derive_pvk_key(keybuf, sizeof(keybuf), salt, 0x10,
                            (unsigned char *)psbuf, inlen, libctx, propq))
            goto error;
        if ((rc4 = EVP_CIPHER_fetch(libctx, "RC4", propq)) == 
# 1080 "../crypto/pem/pvkfmt.c" 3 4
                                                             ((void *)0)
# 1080 "../crypto/pem/pvkfmt.c"
                                                                 )
            goto error;
        if (enclevel == 1)
            memset(keybuf + 5, 0, 11);
        p = salt + 0x10 + 8;
        if (!EVP_EncryptInit_ex(cctx, rc4, 
# 1085 "../crypto/pem/pvkfmt.c" 3 4
                                          ((void *)0)
# 1085 "../crypto/pem/pvkfmt.c"
                                              , keybuf, 
# 1085 "../crypto/pem/pvkfmt.c" 3 4
                                                        ((void *)0)
# 1085 "../crypto/pem/pvkfmt.c"
    ...
    if (*out == 
# 1098 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 1098 "../crypto/pem/pvkfmt.c"
                   )
        *out = start;
    ret = outlen;
 error:
    ...
    if (*out == 
# 1106 "../crypto/pem/pvkfmt.c" 3 4
               ((void *)0)
# 1106 "../crypto/pem/pvkfmt.c"
                   )
        CRYPTO_free(start, "../crypto/pem/pvkfmt.c", 1107);
...
{
    unsigned char *tmp = 
# 1116 "../crypto/pem/pvkfmt.c" 3 4
                        ((void *)0)
# 1116 "../crypto/pem/pvkfmt.c"
                            ;
    int outlen, wrlen;
    ...
    if (outlen < 0)
        return -1;
    wrlen = BIO_write(out, tmp, outlen);
    CRYPTO_free(tmp, "../crypto/pem/pvkfmt.c", 1123);
    if (wrlen == outlen) {
        return outlen;
    }
    (ERR_new(), ERR_set_debug("../crypto/pem/pvkfmt.c",1127,__func__), ERR_set_error)((9),(118),
# 1127 "../crypto/pem/pvkfmt.c" 3 4
   ((void *)0)
# 1127 "../crypto/pem/pvkfmt.c"
   );
    return -1;
}
...
int i2b_PVK_bio(BIO *out, const EVP_PKEY *pk, int enclevel,
                pem_password_cb *cb, void *u)
{
    return i2b_PVK_bio_ex(out, pk, enclevel, cb, u, 
# 1134 "../crypto/pem/pvkfmt.c" 3 4
                                                   ((void *)0)
# 1134 "../crypto/pem/pvkfmt.c"
                                                       , 
# 1134 "../crypto/pem/pvkfmt.c" 3 4
                                                         ((void *)0)
# 1134 "../crypto/pem/pvkfmt.c"
