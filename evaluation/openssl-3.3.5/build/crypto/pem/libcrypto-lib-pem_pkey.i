# 0 "../crypto/pem/pem_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_pkey.c"
# 13 "../crypto/pem/pem_pkey.c"
...
{
    EVP_PKEY *pkey = 
# 39 "../crypto/pem/pem_pkey.c" 3 4
                    ((void *)0)
# 39 "../crypto/pem/pem_pkey.c"
                        ;
    OSSL_DECODER_CTX *dctx = 
# 40 "../crypto/pem/pem_pkey.c" 3 4
                            ((void *)0)
# 40 "../crypto/pem/pem_pkey.c"
                                ;
    int pos, newpos;

    if ((pos = (int)BIO_ctrl(bp,133,0,
# 43 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 43 "../crypto/pem/pem_pkey.c"
              )) < 0)

        return 
# 45 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 45 "../crypto/pem/pem_pkey.c"
                  ;

    dctx = OSSL_DECODER_CTX_new_for_pkey(&pkey, "PEM", 
# 47 "../crypto/pem/pem_pkey.c" 3 4
                                                      ((void *)0)
# 47 "../crypto/pem/pem_pkey.c"
                                                          , 
# 47 "../crypto/pem/pem_pkey.c" 3 4
                                                            ((void *)0)
# 47 "../crypto/pem/pem_pkey.c"
    ...
    if (dctx == 
# 50 "../crypto/pem/pem_pkey.c" 3 4
               ((void *)0)
# 50 "../crypto/pem/pem_pkey.c"
                   )
        return 
# 51 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 51 "../crypto/pem/pem_pkey.c"
                  ;

    if (cb == 
# 53 "../crypto/pem/pem_pkey.c" 3 4
             ((void *)0)
# 53 "../crypto/pem/pem_pkey.c"
                 )
        cb = PEM_def_callback;
    ...
    ERR_set_mark();
    while (!OSSL_DECODER_from_bio(dctx, bp) || pkey == 
# 60 "../crypto/pem/pem_pkey.c" 3 4
                                                      ((void *)0)
# 60 "../crypto/pem/pem_pkey.c"
                                                          )
        if ((int)BIO_ctrl(bp,2,0,
# 61 "../crypto/pem/pem_pkey.c" 3 4
           ((void *)0)
# 61 "../crypto/pem/pem_pkey.c"
           ) != 0 || (newpos = (int)BIO_ctrl(bp,133,0,
# 61 "../crypto/pem/pem_pkey.c" 3 4
                                         ((void *)0)
# 61 "../crypto/pem/pem_pkey.c"
                                         )) < 0 || newpos <= pos) {
            ...
            if (ERR_GET_REASON(ERR_peek_error()) == (268|(0x2 << 18L))) {
    ...
    if ((selection & 0x01) != 0)
        selection = selection & ~0x02;

    if (!evp_keymgmt_util_has(pkey, selection)) {
        EVP_PKEY_free(pkey);
        pkey = 
# 84 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 84 "../crypto/pem/pem_pkey.c"
                  ;
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",85,__func__), ERR_set_error)((9),(126),
# 85 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 85 "../crypto/pem/pem_pkey.c"
       );
        goto err;
    }

    if (x != 
# 89 "../crypto/pem/pem_pkey.c" 3 4
            ((void *)0)
# 89 "../crypto/pem/pem_pkey.c"
                ) {
        EVP_PKEY_free(*x);
        *x = pkey;
    }
...
{
    char *nm = 
# 105 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 105 "../crypto/pem/pem_pkey.c"
                  ;
    const unsigned char *p = 
# 106 "../crypto/pem/pem_pkey.c" 3 4
                            ((void *)0)
# 106 "../crypto/pem/pem_pkey.c"
                                ;
    unsigned char *data = 
# 107 "../crypto/pem/pem_pkey.c" 3 4
                         ((void *)0)
# 107 "../crypto/pem/pem_pkey.c"
                             ;
    long len;
    int slen;
    EVP_PKEY *ret = 
# 110 "../crypto/pem/pem_pkey.c" 3 4
                   ((void *)0)
# 110 "../crypto/pem/pem_pkey.c"
                       ;
    ...
    if ((selection & 0x01) != 0) {
        if (!PEM_bytes_read_bio_secmem(&data, &len, &nm,
            ...
            ERR_pop_to_mark();
            return 
# 118 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 118 "../crypto/pem/pem_pkey.c"
                      ;
         }
    } else {
        const char *pem_string = "PARAMETERS";

        if ((selection & 0x02) != 0)
            pem_string = "PUBLIC KEY";
        if (!PEM_bytes_read_bio(&data, &len, &nm,
                                pem_string,
                                bp, cb, u)) {
            ERR_pop_to_mark();
            return 
# 129 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 129 "../crypto/pem/pem_pkey.c"
                      ;
        }
    }
    ERR_clear_last_mark();
    ...
    if (strcmp(nm, "PRIVATE KEY") == 0) {
        PKCS8_PRIV_KEY_INFO *p8inf;

        if ((p8inf = d2i_PKCS8_PRIV_KEY_INFO(
# 138 "../crypto/pem/pem_pkey.c" 3 4
                                            ((void *)0)
# 138 "../crypto/pem/pem_pkey.c"
                                                , &p, len)) == 
# 138 "../crypto/pem/pem_pkey.c" 3 4
                                                               ((void *)0)
# 138 "../crypto/pem/pem_pkey.c"
        ...
        if (x != 
# 141 "../crypto/pem/pem_pkey.c" 3 4
                ((void *)0)
# 141 "../crypto/pem/pem_pkey.c"
                    ) {
            EVP_PKEY_free(*x);
            *x = ret;
        }
        PKCS8_PRIV_KEY_INFO_free(p8inf);
    } else if (strcmp(nm, "ENCRYPTED PRIVATE KEY") == 0) {
        PKCS8_PRIV_KEY_INFO *p8inf;
        X509_SIG *p8;
        int klen;
        char psbuf[1024];
        ...
        if ((p8 = d2i_X509_SIG(
# 152 "../crypto/pem/pem_pkey.c" 3 4
                              ((void *)0)
# 152 "../crypto/pem/pem_pkey.c"
                                  , &p, len)) == 
# 152 "../crypto/pem/pem_pkey.c" 3 4
                                                 ((void *)0)
# 152 "../crypto/pem/pem_pkey.c"
            ...
            goto p8err;
        if (cb != 
# 154 "../crypto/pem/pem_pkey.c" 3 4
                 ((void *)0)
# 154 "../crypto/pem/pem_pkey.c"
                     )
            klen = cb(psbuf, 1024, 0, u);
        else
            klen = PEM_def_callback(psbuf, 1024, 0, u);
        if (klen < 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",159,__func__), ERR_set_error)((9),(104),
# 159 "../crypto/pem/pem_pkey.c" 3 4
           ((void *)0)
# 159 "../crypto/pem/pem_pkey.c"
           );
            X509_SIG_free(p8);
            goto err;
        }
        ...
        if (p8inf == 
# 166 "../crypto/pem/pem_pkey.c" 3 4
                    ((void *)0)
# 166 "../crypto/pem/pem_pkey.c"
                        )
            goto p8err;
        ret = evp_pkcs82pkey_legacy(p8inf, libctx, propq);
        if (x != 
# 169 "../crypto/pem/pem_pkey.c" 3 4
                ((void *)0)
# 169 "../crypto/pem/pem_pkey.c"
                    ) {
            EVP_PKEY_free(*x);
            *x = ret;
        }
...
# 176 "../crypto/pem/pem_pkey.c" 3 4
                                      ((void *)0)
# 176 "../crypto/pem/pem_pkey.c"
                                          , nm, slen);
        if (ameth == 
# 177 "../crypto/pem/pem_pkey.c" 3 4
                    ((void *)0) 
# 177 "../crypto/pem/pem_pkey.c"
...
# 177 "../crypto/pem/pem_pkey.c"
        ...
        ret = ossl_d2i_PrivateKey_legacy(ameth->pkey_id, x, &p, len, libctx,
                                         propq);
    } else if ((selection & 0x01) == 0
               && (selection & 0x02) != 0) {

        ret = ossl_d2i_PUBKEY_legacy(x, &p, len);
    } else if ((selection & ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 )) == 0
               && (slen = ossl_pem_check_suffix(nm, "PARAMETERS")) > 0) {

        ret = EVP_PKEY_new();
        if (ret == 
# 189 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 189 "../crypto/pem/pem_pkey.c"
                      )
            goto err;
        if (!EVP_PKEY_set_type_str(ret, nm, slen)
            ...
            EVP_PKEY_free(ret);
            ret = 
# 195 "../crypto/pem/pem_pkey.c" 3 4
                 ((void *)0)
# 195 "../crypto/pem/pem_pkey.c"
                     ;
            goto err;
        }
        if (x) {
 ...
 p8err:
    if (ret == 
# 205 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0) 
# 205 "../crypto/pem/pem_pkey.c"
                   && ERR_peek_last_error() == 0)

        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",207,__func__), ERR_set_error)((9),((13 | (0x2 << 18L))),
# 207 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 207 "../crypto/pem/pem_pkey.c"
       );
 err:
    CRYPTO_secure_free(nm, "../crypto/pem/pem_pkey.c", 209);
    CRYPTO_secure_clear_free(data, len, "../crypto/pem/pem_pkey.c", 210);
    return ret;
}
...
{
    EVP_PKEY *ret = 
# 220 "../crypto/pem/pem_pkey.c" 3 4
                   ((void *)0)
# 220 "../crypto/pem/pem_pkey.c"
                       ;
    BIO *new_bio = 
# 221 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 221 "../crypto/pem/pem_pkey.c"
                      ;
    int pos;
    struct ossl_passphrase_data_st pwdata = { 0 };

    if ((pos = (int)BIO_ctrl(bp,133,0,
# 225 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
# 225 "../crypto/pem/pem_pkey.c"
              )) < 0) {
        new_bio = BIO_new(BIO_f_readbuffer());
        if (new_bio == 
# 227 "../crypto/pem/pem_pkey.c" 3 4
                      ((void *)0)
# 227 "../crypto/pem/pem_pkey.c"
                          )
            return 
# 228 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 228 "../crypto/pem/pem_pkey.c"
                      ;
        bp = BIO_push(new_bio, bp);
        pos = (int)BIO_ctrl(bp,133,0,
# 230 "../crypto/pem/pem_pkey.c" 3 4
             ((void *)0)
# 230 "../crypto/pem/pem_pkey.c"
             );
    }

    if (cb == 
# 233 "../crypto/pem/pem_pkey.c" 3 4
             ((void *)0)
# 233 "../crypto/pem/pem_pkey.c"
                 )
        cb = PEM_def_callback;
    ...
    if (ret == 
# 243 "../crypto/pem/pem_pkey.c" 3 4
              ((void *)0)
        
# 244 "../crypto/pem/pem_pkey.c"
       && ((int)BIO_ctrl(bp,128,pos,
# 244 "../crypto/pem/pem_pkey.c" 3 4
           ((void *)0)
# 244 "../crypto/pem/pem_pkey.c"
           ) < 0
            || (ret = pem_read_bio_key_legacy(bp, x,
                                              ...
                                              libctx, propq,
                                              selection)) == 
# 248 "../crypto/pem/pem_pkey.c" 3 4
                                                            ((void *)0)
# 248 "../crypto/pem/pem_pkey.c"
                                                                ))
        ERR_clear_last_mark();
    else
        ERR_pop_to_mark();
 ...
 err:
    ...
    if (new_bio != 
# 255 "../crypto/pem/pem_pkey.c" 3 4
                  ((void *)0)
# 255 "../crypto/pem/pem_pkey.c"
                      ) {
        BIO_pop(new_bio);
        BIO_free(new_bio);
    }
...
EVP_PKEY *PEM_read_bio_PUBKEY(BIO *bp, EVP_PKEY **x, pem_password_cb *cb,
                              void *u)
{
    return PEM_read_bio_PUBKEY_ex(bp, x, cb, u, 
# 273 "../crypto/pem/pem_pkey.c" 3 4
                                               ((void *)0)
# 273 "../crypto/pem/pem_pkey.c"
                                                   , 
# 273 "../crypto/pem/pem_pkey.c" 3 4
                                                     ((void *)0)
# 273 "../crypto/pem/pem_pkey.c"
...
# 284 "../crypto/pem/pem_pkey.c" 3 4
                                      ((void *)0)
# 284 "../crypto/pem/pem_pkey.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",285,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 285 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 285 "../crypto/pem/pem_pkey.c"
       );
        return 0;
    }
...
{
    return PEM_read_PUBKEY_ex(fp, x, cb, u, 
# 296 "../crypto/pem/pem_pkey.c" 3 4
                                           ((void *)0)
# 296 "../crypto/pem/pem_pkey.c"
                                               , 
# 296 "../crypto/pem/pem_pkey.c" 3 4
                                                 ((void *)0)
# 296 "../crypto/pem/pem_pkey.c"
...
EVP_PKEY *PEM_read_bio_PrivateKey(BIO *bp, EVP_PKEY **x, pem_password_cb *cb,
                                  void *u)
{
    return PEM_read_bio_PrivateKey_ex(bp, x, cb, u, 
# 312 "../crypto/pem/pem_pkey.c" 3 4
                                                   ((void *)0)
# 312 "../crypto/pem/pem_pkey.c"
                                                       , 
# 312 "../crypto/pem/pem_pkey.c" 3 4
                                                         ((void *)0)
# 312 "../crypto/pem/pem_pkey.c"
...
int PEM_write_bio_PrivateKey_ex(BIO *out, const EVP_PKEY *x, const EVP_CIPHER *enc, const unsigned char *kstr, int klen, pem_password_cb *cb, void *u, OSSL_LIB_CTX *libctx, const char *propq)
{
    int ret = 0; OSSL_ENCODER_CTX *ctx = OSSL_ENCODER_CTX_new_for_pkey(x, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), "PEM", "PrivateKeyInfo", (propq)); if (OSSL_ENCODER_CTX_get_num_encoders(ctx) == 0) { OSSL_ENCODER_CTX_free(ctx); goto legacy; };

    ret = 1; if (kstr == 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0) 
# 319 "../crypto/pem/pem_pkey.c"
   && cb == 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0)
# 319 "../crypto/pem/pem_pkey.c"
...
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0)
# 319 "../crypto/pem/pem_pkey.c"
   ) { kstr = u; klen = strlen(u); } else { cb = PEM_def_callback; } } if (enc != 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0)
# 319 "../crypto/pem/pem_pkey.c"
   ) { ret = 0; if (OSSL_ENCODER_CTX_set_cipher(ctx, EVP_CIPHER_get0_name(enc), 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0)
# 319 "../crypto/pem/pem_pkey.c"
   )) { ret = 1; if (kstr != 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0) 
# 319 "../crypto/pem/pem_pkey.c"
   && !OSSL_ENCODER_CTX_set_passphrase(ctx, kstr, klen)) ret = 0; else if (cb != 
# 319 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0) 
# 319 "../crypto/pem/pem_pkey.c"
   && !OSSL_ENCODER_CTX_set_pem_password_cb(ctx, cb, u)) ret = 0; } } if (!ret) { OSSL_ENCODER_CTX_free(ctx); return 0; };
    ret = OSSL_ENCODER_to_bio(ctx, out); OSSL_ENCODER_CTX_free(ctx); return ret;

 legacy:
    if (x != 
# 323 "../crypto/pem/pem_pkey.c" 3 4
            ((void *)0) 
# 323 "../crypto/pem/pem_pkey.c"
                 && (x->ameth == 
# 323 "../crypto/pem/pem_pkey.c" 3 4
                                 ((void *)0) 
# 323 "../crypto/pem/pem_pkey.c"
...
int PEM_write_bio_PrivateKey(BIO *out, const EVP_PKEY *x, const EVP_CIPHER *enc, const unsigned char *kstr, int klen, pem_password_cb *cb, void *u)
{
    return PEM_write_bio_PrivateKey_ex(out, x, enc, kstr, klen, cb, u,
                                       
# 332 "../crypto/pem/pem_pkey.c" 3 4
                                      ((void *)0)
# 332 "../crypto/pem/pem_pkey.c"
                                          , 
# 332 "../crypto/pem/pem_pkey.c" 3 4
                                            ((void *)0)
# 332 "../crypto/pem/pem_pkey.c"
                                         ...
                                         pem_password_cb *cb, void *u)
{
    char pem_str[80];
    EVP_PKEY *copy = 
# 345 "../crypto/pem/pem_pkey.c" 3 4
                    ((void *)0)
# 345 "../crypto/pem/pem_pkey.c"
                        ;
    int ret;

    if (x == 
# 348 "../crypto/pem/pem_pkey.c" 3 4
            ((void *)0)
# 348 "../crypto/pem/pem_pkey.c"
                )
        return 0;

    if (((x)->pkey.ptr != 
# 351 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0) 
# 351 "../crypto/pem/pem_pkey.c"
       || (x)->keydata != 
# 351 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 351 "../crypto/pem/pem_pkey.c"
        ...
        && ((x)->keymgmt != 
# 352 "../crypto/pem/pem_pkey.c" 3 4
          ((void *)0)
# 352 "../crypto/pem/pem_pkey.c"
          )
        && evp_pkey_copy_downgraded(&copy, x))
        x = copy;

    if (x->ameth == 
# 356 "../crypto/pem/pem_pkey.c" 3 4
                   ((void *)0) 
# 356 "../crypto/pem/pem_pkey.c"
                        || x->ameth->old_priv_encode == 
# 356 "../crypto/pem/pem_pkey.c" 3 4
                                                        ((void *)0)
# 356 "../crypto/pem/pem_pkey.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",357,__func__), ERR_set_error)((9),(110),
# 357 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 357 "../crypto/pem/pem_pkey.c"
       );
        EVP_PKEY_free(copy);
        return 0;
    }
                                     ...
                                     OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    return pem_read_bio_key(bp, x, no_password_cb, 
# 381 "../crypto/pem/pem_pkey.c" 3 4
                                                  ((void *)0)
# 381 "../crypto/pem/pem_pkey.c"
                                                      , libctx, propq,
                            ( ( 0x04 | 0x80) ));
}
...
EVP_PKEY *PEM_read_bio_Parameters(BIO *bp, EVP_PKEY **x)
{
    return PEM_read_bio_Parameters_ex(bp, x, 
# 387 "../crypto/pem/pem_pkey.c" 3 4
                                            ((void *)0)
...
int PEM_write_bio_Parameters(BIO *out, const EVP_PKEY *x)
{
    char pem_str[80];
    int ret = 0; OSSL_ENCODER_CTX *ctx = OSSL_ENCODER_CTX_new_for_pkey(x, ( ( 0x04 | 0x80) ), "PEM", "type-specific", (
# 393 "../crypto/pem/pem_pkey.c" 3 4
   ((void *)0)
# 393 "../crypto/pem/pem_pkey.c"
   )); if (OSSL_ENCODER_CTX_get_num_encoders(ctx) == 0) { OSSL_ENCODER_CTX_free(ctx); goto legacy; };
 ...
 legacy:
    ...
    return PEM_ASN1_write_bio((i2d_of_void *)x->ameth->param_encode,
                              pem_str, out, x, 
# 403 "../crypto/pem/pem_pkey.c" 3 4
                                              ((void *)0)
# 403 "../crypto/pem/pem_pkey.c"
                                                  , 
# 403 "../crypto/pem/pem_pkey.c" 3 4
                                                    ((void *)0)
# 403 "../crypto/pem/pem_pkey.c"
                                 ...
                                 const char *propq)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 414 "../crypto/pem/pem_pkey.c" 3 4
                                      ((void *)0)
# 414 "../crypto/pem/pem_pkey.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",415,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 415 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 415 "../crypto/pem/pem_pkey.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
EVP_PKEY *PEM_read_PrivateKey(FILE *fp, EVP_PKEY **x, pem_password_cb *cb,
                              void *u)
{
    return PEM_read_PrivateKey_ex(fp, x, cb, u, 
# 427 "../crypto/pem/pem_pkey.c" 3 4
                                               ((void *)0)
# 427 "../crypto/pem/pem_pkey.c"
                                                   , 
# 427 "../crypto/pem/pem_pkey.c" 3 4
                                                     ((void *)0)
# 427 "../crypto/pem/pem_pkey.c"
...
int PEM_write_PrivateKey_ex(FILE *out, const EVP_PKEY *x, const EVP_CIPHER *enc, const unsigned char *kstr, int klen, pem_password_cb *cb, void *u, OSSL_LIB_CTX *libctx, const char *propq)
{
    BIO *b;
    int ret;

    if ((b = BIO_new_fp(out, 0x00)) == 
# 435 "../crypto/pem/pem_pkey.c" 3 4
                                             ((void *)0)
# 435 "../crypto/pem/pem_pkey.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pkey.c",436,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 436 "../crypto/pem/pem_pkey.c" 3 4
       ((void *)0)
# 436 "../crypto/pem/pem_pkey.c"
       );
        return 0;
    }
...
int PEM_write_PrivateKey(FILE *out, const EVP_PKEY *x, const EVP_CIPHER *enc, const unsigned char *kstr, int klen, pem_password_cb *cb, void *u)
{
    return PEM_write_PrivateKey_ex(out, x, enc, kstr, klen, cb, u, 
# 447 "../crypto/pem/pem_pkey.c" 3 4
                                                                  ((void *)0)
# 447 "../crypto/pem/pem_pkey.c"
                                                                      , 
# 447 "../crypto/pem/pem_pkey.c" 3 4
                                                                        ((void *)0)
# 447 "../crypto/pem/pem_pkey.c"
