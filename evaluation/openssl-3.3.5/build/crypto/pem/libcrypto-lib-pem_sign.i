# 0 "../crypto/pem/pem_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_sign.c"
# 10 "../crypto/pem/pem_sign.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 16 "../crypto/pem/pem_sign.c" 2

int PEM_SignInit(EVP_MD_CTX *ctx, EVP_MD *type)
{
    return EVP_DigestInit_ex(ctx, type, 
# 19 "../crypto/pem/pem_sign.c" 3 4
                                       ((void *)0)
# 19 "../crypto/pem/pem_sign.c"
                                           );
}
                  ...
                  unsigned int *siglen, EVP_PKEY *pkey)
{
    ...
    m = CRYPTO_malloc(EVP_PKEY_get_size(pkey), "../crypto/pem/pem_sign.c", 35);
    if (m == 
# 36 "../crypto/pem/pem_sign.c" 3 4
            ((void *)0)
# 36 "../crypto/pem/pem_sign.c"
                )
        goto err;
 ...
 err:
    ...
    CRYPTO_free(m, "../crypto/pem/pem_sign.c", 47);
    return ret;
}
