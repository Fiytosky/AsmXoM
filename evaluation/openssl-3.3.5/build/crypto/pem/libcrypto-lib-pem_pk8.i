# 0 "../crypto/pem/pem_pk8.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_pk8.c"
# 10 "../crypto/pem/pem_pk8.c"
...
static int do_pk8pkey_fp(FILE *bp, const EVP_PKEY *x, int isder,
                         ...
                         pem_password_cb *cb, void *u,
                         const char *propq);
# 41 "../crypto/pem/pem_pk8.c"
int PEM_write_bio_PKCS8PrivateKey_nid(BIO *bp, const EVP_PKEY *x, int nid,
                                      const char *kstr, int klen,
                                      pem_password_cb *cb, void *u)
{
    return do_pk8pkey(bp, x, 0, nid, 
# 45 "../crypto/pem/pem_pk8.c" 3 4
                                    ((void *)0)
# 45 "../crypto/pem/pem_pk8.c"
                                        , kstr, klen, cb, u, 
# 45 "../crypto/pem/pem_pk8.c" 3 4
                                                             ((void *)0)
# 45 "../crypto/pem/pem_pk8.c"
...
# 52 "../crypto/pem/pem_pk8.c" 3 4
                                                           ((void *)0)
# 52 "../crypto/pem/pem_pk8.c"
                                                               );
}
...
# 59 "../crypto/pem/pem_pk8.c" 3 4
                                                           ((void *)0)
# 59 "../crypto/pem/pem_pk8.c"
                                                               );
}
...
# 66 "../crypto/pem/pem_pk8.c" 3 4
                                    ((void *)0)
# 66 "../crypto/pem/pem_pk8.c"
                                        , kstr, klen, cb, u, 
# 66 "../crypto/pem/pem_pk8.c" 3 4
                                                             ((void *)0)
# 66 "../crypto/pem/pem_pk8.c"
                      ...
                      pem_password_cb *cb, void *u, const char *propq)
{
    ...
    OSSL_ENCODER_CTX *ctx =
        OSSL_ENCODER_CTX_new_for_pkey(x, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ),
                                      outtype, "PrivateKeyInfo", propq);

    if (ctx == 
# 79 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 79 "../crypto/pem/pem_pk8.c"
                  )
        return 0;
    ...
    if (kstr == 
# 87 "../crypto/pem/pem_pk8.c" 3 4
               ((void *)0) 
# 87 "../crypto/pem/pem_pk8.c"
                    && cb == 
# 87 "../crypto/pem/pem_pk8.c" 3 4
                             ((void *)0)
# 87 "../crypto/pem/pem_pk8.c"
        ...
        if (u != 
# 88 "../crypto/pem/pem_pk8.c" 3 4
                ((void *)0)
# 88 "../crypto/pem/pem_pk8.c"
                    ) {
            kstr = u;
            klen = strlen(u);
        } else {
    ...
    if (nid == -1 && OSSL_ENCODER_CTX_get_num_encoders(ctx) != 0) {
        ret = 1;
        if (enc != 
# 104 "../crypto/pem/pem_pk8.c" 3 4
                  ((void *)0)
# 104 "../crypto/pem/pem_pk8.c"
                      ) {
            ret = 0;
            if (OSSL_ENCODER_CTX_set_cipher(ctx, EVP_CIPHER_get0_name(enc),
                                            
# 107 "../crypto/pem/pem_pk8.c" 3 4
                                           ((void *)0)
# 107 "../crypto/pem/pem_pk8.c"
                                               )) {
                ...
                ret = 1;
                if (kstr != 
# 117 "../crypto/pem/pem_pk8.c" 3 4
                           ((void *)0)
                    
# 118 "../crypto/pem/pem_pk8.c"
                   && !OSSL_ENCODER_CTX_set_passphrase(ctx, ukstr, klen))
                    ret = 0;
                else if (cb != 
# 120 "../crypto/pem/pem_pk8.c" 3 4
                              ((void *)0)
                         
# 121 "../crypto/pem/pem_pk8.c"
...
# 132 "../crypto/pem/pem_pk8.c" 3 4
                                          ((void *)0)
# 132 "../crypto/pem/pem_pk8.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_pk8.c",133,__func__), ERR_set_error)((9),(115),
# 133 "../crypto/pem/pem_pk8.c" 3 4
           ((void *)0)
# 133 "../crypto/pem/pem_pk8.c"
           );
            goto legacy_end;
        }
        if (enc || (nid != -1)) {
            if (kstr == 
# 137 "../crypto/pem/pem_pk8.c" 3 4
                       ((void *)0)
# 137 "../crypto/pem/pem_pk8.c"
                           ) {
                klen = cb(buf, 1024, 1, u);
                if (klen < 0) {
                    (ERR_new(), ERR_set_debug("../crypto/pem/pem_pk8.c",140,__func__), ERR_set_error)((9),(111),
# 140 "../crypto/pem/pem_pk8.c" 3 4
                   ((void *)0)
# 140 "../crypto/pem/pem_pk8.c"
                   );
                    goto legacy_end;
                }
...
# 146 "../crypto/pem/pem_pk8.c" 3 4
                                                    ((void *)0)
# 146 "../crypto/pem/pem_pk8.c"
                                                        , 0, 0, p8inf);
            if (kstr == buf)
                OPENSSL_cleanse(buf, klen);
            if (p8 == 
# 149 "../crypto/pem/pem_pk8.c" 3 4
                     ((void *)0)
# 149 "../crypto/pem/pem_pk8.c"
                         )
                goto legacy_end;
            if (isder)
...
{
    PKCS8_PRIV_KEY_INFO *p8inf = 
# 172 "../crypto/pem/pem_pk8.c" 3 4
                                ((void *)0)
# 172 "../crypto/pem/pem_pk8.c"
                                    ;
    X509_SIG *p8 = 
# 173 "../crypto/pem/pem_pk8.c" 3 4
                  ((void *)0)
# 173 "../crypto/pem/pem_pk8.c"
                      ;
    int klen;
    EVP_PKEY *ret;
    char psbuf[1024 + 1];
    ...
    p8 = d2i_PKCS8_bio(bp, 
# 178 "../crypto/pem/pem_pk8.c" 3 4
                          ((void *)0)
# 178 "../crypto/pem/pem_pk8.c"
                              );
    if (p8 == 
# 179 "../crypto/pem/pem_pk8.c" 3 4
             ((void *)0)
# 179 "../crypto/pem/pem_pk8.c"
                 )
        return 
# 180 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 180 "../crypto/pem/pem_pk8.c"
                  ;
    if (cb != 
# 181 "../crypto/pem/pem_pk8.c" 3 4
             ((void *)0)
# 181 "../crypto/pem/pem_pk8.c"
                 )
        klen = cb(psbuf, 1024, 0, u);
    else
        klen = PEM_def_callback(psbuf, 1024, 0, u);
    if (klen < 0 || klen > 1024) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pk8.c",186,__func__), ERR_set_error)((9),(104),
# 186 "../crypto/pem/pem_pk8.c" 3 4
       ((void *)0)
# 186 "../crypto/pem/pem_pk8.c"
       );
        X509_SIG_free(p8);
        return 
# 188 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 188 "../crypto/pem/pem_pk8.c"
                  ;
    }
    ...
    if (p8inf == 
# 193 "../crypto/pem/pem_pk8.c" 3 4
                ((void *)0)
# 193 "../crypto/pem/pem_pk8.c"
                    )
        return 
# 194 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 194 "../crypto/pem/pem_pk8.c"
                  ;
    ret = EVP_PKCS82PKEY(p8inf);
    PKCS8_PRIV_KEY_INFO_free(p8inf);
    if (!ret)
        return 
# 198 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 198 "../crypto/pem/pem_pk8.c"
                  ;
    if (x != 
# 199 "../crypto/pem/pem_pk8.c" 3 4
            ((void *)0)
# 199 "../crypto/pem/pem_pk8.c"
                ) {
        EVP_PKEY_free(*x);
        *x = ret;
    }
...
# 212 "../crypto/pem/pem_pk8.c" 3 4
                                                              ((void *)0)
# 212 "../crypto/pem/pem_pk8.c"
                                                                  );
}
...
# 219 "../crypto/pem/pem_pk8.c" 3 4
                                       ((void *)0)
# 219 "../crypto/pem/pem_pk8.c"
                                           , kstr, klen, cb, u, 
# 219 "../crypto/pem/pem_pk8.c" 3 4
                                                                ((void *)0)
# 219 "../crypto/pem/pem_pk8.c"
...
# 226 "../crypto/pem/pem_pk8.c" 3 4
                                       ((void *)0)
# 226 "../crypto/pem/pem_pk8.c"
                                           , kstr, klen, cb, u, 
# 226 "../crypto/pem/pem_pk8.c" 3 4
                                                                ((void *)0)
# 226 "../crypto/pem/pem_pk8.c"
...
# 233 "../crypto/pem/pem_pk8.c" 3 4
                                                              ((void *)0)
# 233 "../crypto/pem/pem_pk8.c"
                                                                  );
}
...
# 243 "../crypto/pem/pem_pk8.c" 3 4
                                             ((void *)0)
# 243 "../crypto/pem/pem_pk8.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pk8.c",244,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 244 "../crypto/pem/pem_pk8.c" 3 4
       ((void *)0)
# 244 "../crypto/pem/pem_pk8.c"
       );
        return 0;
    }
                                 ...
                                 void *u)
{
    ...
    if ((bp = BIO_new_fp(fp, 0x00)) == 
# 258 "../crypto/pem/pem_pk8.c" 3 4
                                             ((void *)0)
# 258 "../crypto/pem/pem_pk8.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_pk8.c",259,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 259 "../crypto/pem/pem_pk8.c" 3 4
       ((void *)0)
# 259 "../crypto/pem/pem_pk8.c"
       );
        return 
# 260 "../crypto/pem/pem_pk8.c" 3 4
              ((void *)0)
# 260 "../crypto/pem/pem_pk8.c"
                  ;
    }
...
X509_SIG *PEM_read_bio_PKCS8(BIO *bp, X509_SIG **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read_bio((d2i_of_void *)d2i_X509_SIG, "ENCRYPTED PRIVATE KEY", bp, (void **)x, cb, u); } X509_SIG *PEM_read_PKCS8(FILE *fp, X509_SIG **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read((d2i_of_void *)d2i_X509_SIG, "ENCRYPTED PRIVATE KEY", fp, (void **)x, cb, u); } int PEM_write_bio_PKCS8(BIO *out, const X509_SIG *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_X509_SIG, "ENCRYPTED PRIVATE KEY", out, x, 
# 269 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 269 "../crypto/pem/pem_pk8.c"
,
# 269 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 269 "../crypto/pem/pem_pk8.c"
...
((void *)0)
# 269 "../crypto/pem/pem_pk8.c"
); } int PEM_write_PKCS8(FILE *out, const X509_SIG *x) { return PEM_ASN1_write((i2d_of_void *)i2d_X509_SIG, "ENCRYPTED PRIVATE KEY", out, x, 
# 269 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 269 "../crypto/pem/pem_pk8.c"
, 
...
PKCS8_PRIV_KEY_INFO *PEM_read_bio_PKCS8_PRIV_KEY_INFO(BIO *bp, PKCS8_PRIV_KEY_INFO **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read_bio((d2i_of_void *)d2i_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY", bp, (void **)x, cb, u); } PKCS8_PRIV_KEY_INFO *PEM_read_PKCS8_PRIV_KEY_INFO(FILE *fp, PKCS8_PRIV_KEY_INFO **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read((d2i_of_void *)d2i_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY", fp, (void **)x, cb, u); } int PEM_write_bio_PKCS8_PRIV_KEY_INFO(BIO *out, const PKCS8_PRIV_KEY_INFO *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY", out, x, 
# 272 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 272 "../crypto/pem/pem_pk8.c"
,
# 272 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 272 "../crypto/pem/pem_pk8.c"
...
((void *)0)
# 272 "../crypto/pem/pem_pk8.c"
); } int PEM_write_PKCS8_PRIV_KEY_INFO(FILE *out, const PKCS8_PRIV_KEY_INFO *x) { return PEM_ASN1_write((i2d_of_void *)i2d_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY", out, x, 
# 272 "../crypto/pem/pem_pk8.c" 3 4
((void *)0)
# 272 "../crypto/pem/pem_pk8.c"
, 
