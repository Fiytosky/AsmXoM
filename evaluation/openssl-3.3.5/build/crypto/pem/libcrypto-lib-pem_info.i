# 0 "../crypto/pem/pem_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_info.c"
# 14 "../crypto/pem/pem_info.c"
...
# 35 "../crypto/pem/pem_info.c" 3 4
                                      ((void *)0)
# 35 "../crypto/pem/pem_info.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",36,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 36 "../crypto/pem/pem_info.c" 3 4
       ((void *)0)
# 36 "../crypto/pem/pem_info.c"
       );
        return 0;
    }
...
struct stack_st_X509_INFO *PEM_X509_INFO_read(FILE *fp, struct stack_st_X509_INFO *sk,
                                        pem_password_cb *cb, void *u)
{
    return PEM_X509_INFO_read_ex(fp, sk, cb, u, 
# 48 "../crypto/pem/pem_info.c" 3 4
                                               ((void *)0)
# 48 "../crypto/pem/pem_info.c"
                                                   , 
# 48 "../crypto/pem/pem_info.c" 3 4
                                                     ((void *)0)
# 48 "../crypto/pem/pem_info.c"
...
{
    X509_INFO *xi = 
# 57 "../crypto/pem/pem_info.c" 3 4
                   ((void *)0)
# 57 "../crypto/pem/pem_info.c"
                       ;
    char *name = 
# 58 "../crypto/pem/pem_info.c" 3 4
                ((void *)0)
# 58 "../crypto/pem/pem_info.c"
                    , *header = 
# 58 "../crypto/pem/pem_info.c" 3 4
                                ((void *)0)
# 58 "../crypto/pem/pem_info.c"
    ...
    void *pp;
    unsigned char *data = 
# 60 "../crypto/pem/pem_info.c" 3 4
                         ((void *)0)
# 60 "../crypto/pem/pem_info.c"
                             ;
    const unsigned char *p;
    long len, error = 0;
    int ok = 0;
    struct stack_st_X509_INFO *ret = 
# 64 "../crypto/pem/pem_info.c" 3 4
                              ((void *)0)
# 64 "../crypto/pem/pem_info.c"
                                  ;
    unsigned int i, raw, ptype;
    d2i_of_void *d2i = 0;

    if (sk == 
# 68 "../crypto/pem/pem_info.c" 3 4
             ((void *)0)
# 68 "../crypto/pem/pem_info.c"
                 ) {
        if ((ret = ((struct stack_st_X509_INFO *)OPENSSL_sk_new_null())) == 
# 69 "../crypto/pem/pem_info.c" 3 4
                                              ((void *)0)
# 69 "../crypto/pem/pem_info.c"
                                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",70,__func__), ERR_set_error)((9),((15 | (0x2 << 18L))),
# 70 "../crypto/pem/pem_info.c" 3 4
           ((void *)0)
# 70 "../crypto/pem/pem_info.c"
           );
            goto err;
        }
    } else
    ...
    if ((xi = X509_INFO_new()) == 
# 76 "../crypto/pem/pem_info.c" 3 4
                                 ((void *)0)
# 76 "../crypto/pem/pem_info.c"
                                     )
        goto err;
    for (;;) {
        raw = 0;
 ...
 start:
        if (strcmp(name, "CERTIFICATE") == 0
            ...
            if (xi->x509 != 
# 97 "../crypto/pem/pem_info.c" 3 4
                           ((void *)0)
# 97 "../crypto/pem/pem_info.c"
                               ) {
                if (!OPENSSL_sk_push(ossl_check_X509_INFO_sk_type(ret), ossl_check_X509_INFO_type(xi)))
                    goto err;
                if ((xi = X509_INFO_new()) == 
# 100 "../crypto/pem/pem_info.c" 3 4
                                             ((void *)0)
# 100 "../crypto/pem/pem_info.c"
                                                 )
                    goto err;
                goto start;
            }
            if ((strcmp(name, "TRUSTED CERTIFICATE") == 0))
            ...
            if (xi->x509 == 
# 109 "../crypto/pem/pem_info.c" 3 4
                           ((void *)0)
# 109 "../crypto/pem/pem_info.c"
                               )
                goto err;
            pp = &(xi->x509);
            ...
            if (xi->crl != 
# 114 "../crypto/pem/pem_info.c" 3 4
                          ((void *)0)
# 114 "../crypto/pem/pem_info.c"
                              ) {
                if (!OPENSSL_sk_push(ossl_check_X509_INFO_sk_type(ret), ossl_check_X509_INFO_type(xi)))
                    goto err;
                if ((xi = X509_INFO_new()) == 
# 117 "../crypto/pem/pem_info.c" 3 4
                                             ((void *)0)
# 117 "../crypto/pem/pem_info.c"
                                                 )
                    goto err;
                goto start;
            }
            pp = &(xi->crl);
        } else if ((str = strstr(name, "PRIVATE KEY")) != 
# 122 "../crypto/pem/pem_info.c" 3 4
                                                               ((void *)0)
# 122 "../crypto/pem/pem_info.c"
                                                                   ) {
            if (xi->x_pkey != 
# 123 "../crypto/pem/pem_info.c" 3 4
                             ((void *)0)
# 123 "../crypto/pem/pem_info.c"
                                 ) {
                if (!OPENSSL_sk_push(ossl_check_X509_INFO_sk_type(ret), ossl_check_X509_INFO_type(xi)))
                    goto err;
                if ((xi = X509_INFO_new()) == 
# 126 "../crypto/pem/pem_info.c" 3 4
                                             ((void *)0)
# 126 "../crypto/pem/pem_info.c"
                                                 )
                    goto err;
                goto start;
            }
            if (str == name || strcmp(name, "ENCRYPTED PRIVATE KEY") == 0) {
                ptype = 0;
            } else {
            ...
            xi->enc_data = 
# 137 "../crypto/pem/pem_info.c" 3 4
                          ((void *)0)
# 137 "../crypto/pem/pem_info.c"
                              ;
            xi->enc_len = 0;

            d2i = (void *(*)(void **,const unsigned char **,long)) d2i_AutoPrivateKey;
            xi->x_pkey = X509_PKEY_new();
            if (xi->x_pkey == 
# 142 "../crypto/pem/pem_info.c" 3 4
                             ((void *)0)
# 142 "../crypto/pem/pem_info.c"
                                 )
                goto err;
            pp = &xi->x_pkey->dec_pkey;
            if ((int)strlen(header) > 10
                   || strcmp(name, "ENCRYPTED PRIVATE KEY") == 0)
                raw = 1;
        } else {
            d2i = 
# 149 "../crypto/pem/pem_info.c" 3 4
                 ((void *)0)
# 149 "../crypto/pem/pem_info.c"
                     ;
            pp = 
# 150 "../crypto/pem/pem_info.c" 3 4
                ((void *)0)
# 150 "../crypto/pem/pem_info.c"
                    ;
        }

        if (d2i != 
# 153 "../crypto/pem/pem_info.c" 3 4
                  ((void *)0)
# 153 "../crypto/pem/pem_info.c"
                      ) {
            if (!raw) {
                EVP_CIPHER_INFO cipher;
                ...
                if (ptype) {
                    if (d2i_PrivateKey_ex(ptype, pp, &p, len,
                                          libctx, propq) == 
# 164 "../crypto/pem/pem_info.c" 3 4
                                                           ((void *)0)
# 164 "../crypto/pem/pem_info.c"
                                                               ) {
                        (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",165,__func__), ERR_set_error)((9),((13 | (0x2 << 18L))),
# 165 "../crypto/pem/pem_info.c" 3 4
                       ((void *)0)
# 165 "../crypto/pem/pem_info.c"
                       );
                        goto err;
                    }
                } else if (d2i(pp, &p, len) == 
# 168 "../crypto/pem/pem_info.c" 3 4
                                              ((void *)0)
# 168 "../crypto/pem/pem_info.c"
                                                  ) {
                    (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",169,__func__), ERR_set_error)((9),((13 | (0x2 << 18L))),
# 169 "../crypto/pem/pem_info.c" 3 4
                   ((void *)0)
# 169 "../crypto/pem/pem_info.c"
                   );
                    goto err;
                }
            } else {
                ...
                xi->enc_len = (int)len;
                data = 
# 177 "../crypto/pem/pem_info.c" 3 4
                      ((void *)0)
# 177 "../crypto/pem/pem_info.c"
                          ;
            }
        }
        CRYPTO_free(name, "../crypto/pem/pem_info.c", 180);
        name = 
# 181 "../crypto/pem/pem_info.c" 3 4
              ((void *)0)
# 181 "../crypto/pem/pem_info.c"
                  ;
        CRYPTO_free(header, "../crypto/pem/pem_info.c", 182);
        header = 
# 183 "../crypto/pem/pem_info.c" 3 4
                ((void *)0)
# 183 "../crypto/pem/pem_info.c"
                    ;
        CRYPTO_free(data, "../crypto/pem/pem_info.c", 184);
        data = 
# 185 "../crypto/pem/pem_info.c" 3 4
              ((void *)0)
# 185 "../crypto/pem/pem_info.c"
                  ;
    }
    ...
    if ((xi->x509 != 
# 192 "../crypto/pem/pem_info.c" 3 4
                    ((void *)0)
# 192 "../crypto/pem/pem_info.c"
                        ) || (xi->crl != 
# 192 "../crypto/pem/pem_info.c" 3 4
                                         ((void *)0)
# 192 "../crypto/pem/pem_info.c"
        ...
        (xi->x_pkey != 
# 193 "../crypto/pem/pem_info.c" 3 4
                      ((void *)0)
# 193 "../crypto/pem/pem_info.c"
                          ) || (xi->enc_data != 
# 193 "../crypto/pem/pem_info.c" 3 4
                                                ((void *)0)
# 193 "../crypto/pem/pem_info.c"
        ...
        if (!OPENSSL_sk_push(ossl_check_X509_INFO_sk_type(ret), ossl_check_X509_INFO_type(xi)))
            goto err;
        xi = 
# 196 "../crypto/pem/pem_info.c" 3 4
            ((void *)0)
# 196 "../crypto/pem/pem_info.c"
                ;
    }
    ok = 1;
 err:
    X509_INFO_free(xi);
    if (!ok) {
        for (i = 0; ((int)i) < OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(ret)); i++) {
            xi = ((X509_INFO *)OPENSSL_sk_value(ossl_check_const_X509_INFO_sk_type(ret), (i)));
            X509_INFO_free(xi);
        }
        if (ret != sk)
            OPENSSL_sk_free(ossl_check_X509_INFO_sk_type(ret));
        ret = 
# 208 "../crypto/pem/pem_info.c" 3 4
             ((void *)0)
# 208 "../crypto/pem/pem_info.c"
                 ;
    }

    CRYPTO_free(name, "../crypto/pem/pem_info.c", 211);
    CRYPTO_free(header, "../crypto/pem/pem_info.c", 212);
    CRYPTO_free(data, "../crypto/pem/pem_info.c", 213);
    return ret;
}
...
struct stack_st_X509_INFO *PEM_X509_INFO_read_bio(BIO *bp, struct stack_st_X509_INFO *sk,
                                            pem_password_cb *cb, void *u)
{
    return PEM_X509_INFO_read_bio_ex(bp, sk, cb, u, 
# 220 "../crypto/pem/pem_info.c" 3 4
                                                   ((void *)0)
# 220 "../crypto/pem/pem_info.c"
                                                       , 
# 220 "../crypto/pem/pem_info.c" 3 4
                                                         ((void *)0)
# 220 "../crypto/pem/pem_info.c"
                            ...
                            pem_password_cb *cb, void *u)
{
    int i, ret = 0;
    unsigned char *data = 
# 229 "../crypto/pem/pem_info.c" 3 4
                         ((void *)0)
# 229 "../crypto/pem/pem_info.c"
                             ;
    const char *objstr = 
# 230 "../crypto/pem/pem_info.c" 3 4
                        ((void *)0)
# 230 "../crypto/pem/pem_info.c"
                            ;
    char buf[1024];
    const unsigned char *iv = 
# 232 "../crypto/pem/pem_info.c" 3 4
                             ((void *)0)
# 232 "../crypto/pem/pem_info.c"
                                 ;

    if (enc != 
# 234 "../crypto/pem/pem_info.c" 3 4
              ((void *)0)
# 234 "../crypto/pem/pem_info.c"
                  ) {
        objstr = EVP_CIPHER_get0_name(enc);
        if (objstr == 
# 236 "../crypto/pem/pem_info.c" 3 4
                     ((void *)0)
...
# 241 "../crypto/pem/pem_info.c"
           || strlen(objstr) + 23 + 2 * EVP_CIPHER_get_iv_length(enc) + 13
               > sizeof(buf)) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",243,__func__), ERR_set_error)((9),(113),
# 243 "../crypto/pem/pem_info.c" 3 4
           ((void *)0)
# 243 "../crypto/pem/pem_info.c"
           );
            goto err;
        }
    }
    ...
    if (xi->x_pkey != 
# 253 "../crypto/pem/pem_info.c" 3 4
                     ((void *)0)
# 253 "../crypto/pem/pem_info.c"
                         ) {
        if ((xi->enc_data != 
# 254 "../crypto/pem/pem_info.c" 3 4
                            ((void *)0)
# 254 "../crypto/pem/pem_info.c"
                                ) && (xi->enc_len > 0)) {
            if (enc == 
# 255 "../crypto/pem/pem_info.c" 3 4
                      ((void *)0)
# 255 "../crypto/pem/pem_info.c"
                          ) {
                (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",256,__func__), ERR_set_error)((9),(127),
# 256 "../crypto/pem/pem_info.c" 3 4
               ((void *)0)
# 256 "../crypto/pem/pem_info.c"
               );
                goto err;
            }
            ...
            if (objstr == 
# 271 "../crypto/pem/pem_info.c" 3 4
                         ((void *)0)
# 271 "../crypto/pem/pem_info.c"
                             ) {
                (ERR_new(), ERR_set_debug("../crypto/pem/pem_info.c",272,__func__), ERR_set_error)((9),(113),
# 272 "../crypto/pem/pem_info.c" 3 4
               ((void *)0)
# 272 "../crypto/pem/pem_info.c"
               );
                goto err;
            }
    ...
    if ((xi->x509 != 
# 297 "../crypto/pem/pem_info.c" 3 4
                    ((void *)0)
# 297 "../crypto/pem/pem_info.c"
