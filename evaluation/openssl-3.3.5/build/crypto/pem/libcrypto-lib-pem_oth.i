# 0 "../crypto/pem/pem_oth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_oth.c"
# 10 "../crypto/pem/pem_oth.c"
...
# 23 "../crypto/pem/pem_oth.c" 3 4
                            ((void *)0)
# 23 "../crypto/pem/pem_oth.c"
                                ;
    unsigned char *data = 
# 24 "../crypto/pem/pem_oth.c" 3 4
                         ((void *)0)
# 24 "../crypto/pem/pem_oth.c"
                             ;
    long len;
    char *ret = 
# 26 "../crypto/pem/pem_oth.c" 3 4
               ((void *)0)
# 26 "../crypto/pem/pem_oth.c"
                   ;

    if (!PEM_bytes_read_bio(&data, &len, 
# 28 "../crypto/pem/pem_oth.c" 3 4
                                        ((void *)0)
# 28 "../crypto/pem/pem_oth.c"
                                            , name, bp, cb, u))
        return 
# 29 "../crypto/pem/pem_oth.c" 3 4
              ((void *)0)
# 29 "../crypto/pem/pem_oth.c"
                  ;
    p = data;
    ret = d2i(x, &p, len);
    if (ret == 
# 32 "../crypto/pem/pem_oth.c" 3 4
              ((void *)0)
# 32 "../crypto/pem/pem_oth.c"
                  )
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_oth.c",33,__func__), ERR_set_error)((9),((13 | (0x2 << 18L))),
# 33 "../crypto/pem/pem_oth.c" 3 4
       ((void *)0)
# 33 "../crypto/pem/pem_oth.c"
       );
    CRYPTO_free(data, "../crypto/pem/pem_oth.c", 34);
    return ret;
}
