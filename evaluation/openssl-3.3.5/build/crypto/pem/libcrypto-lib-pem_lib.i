...
extern const char *DES_options(void);
extern
...
extern int DES_random_key(DES_cblock *ret);
extern void DES_set_odd_parity(DES_cblock *key);
extern int DES_check_key_parity(const_DES_cblock *key);
...
extern void DES_string_to_key(const char *str, DES_cblock *key);
extern
...
int PEM_def_callback(char *buf, int num, int rwflag, void *userdata)
{
    ...
    if (prompt == 
# 48 "../crypto/pem/pem_lib.c" 3 4
                 ((void *)0)
# 48 "../crypto/pem/pem_lib.c"
                     )
        prompt = "Enter PEM pass phrase:";
# 58 "../crypto/pem/pem_lib.c"
    min_len = rwflag ? 4 : 0;

    i = EVP_read_pw_string_min(buf, min_len, num, prompt, rwflag);
    if (i != 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",62,__func__), ERR_set_error)((9),(109),
# 62 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 62 "../crypto/pem/pem_lib.c"
       );
...
void PEM_proc_type(char *buf, int type)
{
    ...
    BIO_snprintf(p, 1024 - (size_t)(p - buf), "Proc-Type: 4,%s\n", str);
}
...
# 115 "../crypto/pem/pem_lib.c" 3 4
                                      ((void *)0)
# 115 "../crypto/pem/pem_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",116,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 116 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 116 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
...
static int check_pem(const char *nm, const char *name)
{
    ...
    if (strcmp(name, "ANY PRIVATE KEY") == 0) {
        int slen;
        const EVP_PKEY_ASN1_METHOD *ameth;
        if (strcmp(nm, "ENCRYPTED PRIVATE KEY") == 0)
            return 1;
...
# 147 "../crypto/pem/pem_lib.c" 3 4
                                          ((void *)0)
# 147 "../crypto/pem/pem_lib.c"
                                              , nm, slen);
    ...
    if (strcmp(nm, "X9.42 DH PARAMETERS") == 0
        && strcmp(name, "DH PARAMETERS") == 0)
        return 1;



    if (strcmp(nm, "X509 CERTIFICATE") == 0
        && strcmp(name, "CERTIFICATE") == 0)
        return 1;

    if (strcmp(nm, "NEW CERTIFICATE REQUEST") == 0
        && strcmp(name, "CERTIFICATE REQUEST") == 0)
        return 1;


    if (strcmp(nm, "CERTIFICATE") == 0
    ...
    if (strcmp(nm, "PKCS #7 SIGNED DATA") == 0
        && strcmp(name, "PKCS7") == 0)
        return 1;
...
static void *pem_malloc(int num, unsigned int flags,
                        const char *file, int line)
{
    return (flags & 0x1) ? CRYPTO_secure_malloc(num, file, line)
                                    ...
                                    unsigned int flags)
{
    EVP_CIPHER_INFO cipher;
    char *nm = 
# 248 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 248 "../crypto/pem/pem_lib.c"
                  , *header = 
# 248 "../crypto/pem/pem_lib.c" 3 4
                              ((void *)0)
# 248 "../crypto/pem/pem_lib.c"
                                  ;
    unsigned char *data = 
# 249 "../crypto/pem/pem_lib.c" 3 4
                         ((void *)0)
# 249 "../crypto/pem/pem_lib.c"
                             ;
    long len = 0;
    int ret = 0;

    do {
        pem_free((nm), (flags), (0), "../crypto/pem/pem_lib.c", 254);
        pem_free((header), (flags), (0), "../crypto/pem/pem_lib.c", 255);
        pem_free((data), (flags), (len), "../crypto/pem/pem_lib.c", 256);
        if (!PEM_read_bio_ex(bp, &nm, &header, &data, &len, flags)) {
            if (ERR_GET_REASON(ERR_peek_error()) == 108)
    ...
    *plen = len;
    ...
    if (pnm != 
# 271 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 271 "../crypto/pem/pem_lib.c"
                  )
        *pnm = nm;
 ...
 err:
    if (!ret || pnm == 
# 277 "../crypto/pem/pem_lib.c" 3 4
                      ((void *)0)
# 277 "../crypto/pem/pem_lib.c"
                          )
        pem_free((nm), (flags), (0), "../crypto/pem/pem_lib.c", 278);
    pem_free((header), (flags), (0), "../crypto/pem/pem_lib.c", 279);
    if (!ret)
        pem_free((data), (flags), (len), "../crypto/pem/pem_lib.c", 281);
    return ret;
}
                   ...
                   pem_password_cb *callback, void *u)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 308 "../crypto/pem/pem_lib.c" 3 4
                                      ((void *)0)
# 308 "../crypto/pem/pem_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",309,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 309 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 309 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
{
    EVP_CIPHER_CTX *ctx = 
# 324 "../crypto/pem/pem_lib.c" 3 4
                         ((void *)0)
# 324 "../crypto/pem/pem_lib.c"
                             ;
    int dsize = 0, i = 0, j = 0, ret = 0;
    unsigned char *p, *data = 
# 326 "../crypto/pem/pem_lib.c" 3 4
                             ((void *)0)
# 326 "../crypto/pem/pem_lib.c"
                                 ;
    const char *objstr = 
# 327 "../crypto/pem/pem_lib.c" 3 4
                        ((void *)0)
# 327 "../crypto/pem/pem_lib.c"
                            ;
    char buf[1024];
    ...
    if (enc != 
# 332 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 332 "../crypto/pem/pem_lib.c"
                  ) {
        objstr = EVP_CIPHER_get0_name(enc);
        if (objstr == 
# 334 "../crypto/pem/pem_lib.c" 3 4
                     ((void *)0) 
# 334 "../crypto/pem/pem_lib.c"
                ...
                || strlen(objstr) + 23 + 2 * EVP_CIPHER_get_iv_length(enc) + 13
                   > sizeof(buf)) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",342,__func__), ERR_set_error)((9),(113),
# 342 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 342 "../crypto/pem/pem_lib.c"
           );
            goto err;
        }
    }
    ...
    if ((dsize = i2d(x, 
# 347 "../crypto/pem/pem_lib.c" 3 4
                       ((void *)0)
# 347 "../crypto/pem/pem_lib.c"
                           )) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",348,__func__), ERR_set_error)((9),((13 | (0x2 << 18L))),
# 348 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 348 "../crypto/pem/pem_lib.c"
       );
        dsize = 0;
        goto err;
    }
    ...
    data = CRYPTO_malloc((unsigned int)dsize + 20, "../crypto/pem/pem_lib.c", 354);
    if (data == 
# 355 "../crypto/pem/pem_lib.c" 3 4
               ((void *)0)
# 355 "../crypto/pem/pem_lib.c"
                   )
        goto err;
    p = data;
    i = i2d(x, &p);
    ...
    if (enc != 
# 360 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 360 "../crypto/pem/pem_lib.c"
                  ) {
        if (kstr == 
# 361 "../crypto/pem/pem_lib.c" 3 4
                   ((void *)0)
# 361 "../crypto/pem/pem_lib.c"
                       ) {
            if (callback == 
# 362 "../crypto/pem/pem_lib.c" 3 4
                           ((void *)0)
# 362 "../crypto/pem/pem_lib.c"
                               )
                klen = PEM_def_callback(buf, 1024, 1, u);
            else
                klen = (*callback) (buf, 1024, 1, u);
            if (klen <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",367,__func__), ERR_set_error)((9),(111),
# 367 "../crypto/pem/pem_lib.c" 3 4
               ((void *)0)
# 367 "../crypto/pem/pem_lib.c"
               );
                goto err;
            }
        ...
        if (!EVP_BytesToKey(enc, EVP_md5(), iv, kstr, klen, 1, key, 
# 383 "../crypto/pem/pem_lib.c" 3 4
                                                                   ((void *)0)
...
# 395 "../crypto/pem/pem_lib.c" 3 4
                                           ((void *)0)
            
# 396 "../crypto/pem/pem_lib.c"
           || !EVP_EncryptInit_ex(ctx, enc, 
# 396 "../crypto/pem/pem_lib.c" 3 4
                                            ((void *)0)
# 396 "../crypto/pem/pem_lib.c"
                                                , key, iv)
 ...
 err:
    ...
    OPENSSL_cleanse(buf, 1024);
    CRYPTO_clear_free(data, (unsigned int)dsize, "../crypto/pem/pem_lib.c", 415);
    return ret;
}
                  ...
                  pem_password_cb *callback, void *u)
{
    ...
    if (len > 0x7fffffff
# 432 "../crypto/pem/pem_lib.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",433,__func__), ERR_set_error)((9),(128),
# 433 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 433 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    ...
    if (cipher->cipher == 
# 438 "../crypto/pem/pem_lib.c" 3 4
                         ((void *)0)
# 438 "../crypto/pem/pem_lib.c"
                             )
        return 1;
    if (callback == 
# 440 "../crypto/pem/pem_lib.c" 3 4
                   ((void *)0)
# 440 "../crypto/pem/pem_lib.c"
                       )
        keylen = PEM_def_callback(buf, 1024, 0, u);
    else
        keylen = callback(buf, 1024, 0, u);
    if (keylen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",445,__func__), ERR_set_error)((9),(104),
# 445 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 445 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    ...
    if (!EVP_BytesToKey(cipher->cipher, EVP_md5(), &(cipher->iv[0]),
                        (unsigned char *)buf, keylen, 1, key, 
# 454 "../crypto/pem/pem_lib.c" 3 4
                                                             ((void *)0)
# 454 "../crypto/pem/pem_lib.c"
                                                                 ))
        return 0;

    ctx = EVP_CIPHER_CTX_new();
    if (ctx == 
# 458 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 458 "../crypto/pem/pem_lib.c"
                  )
        return 0;

    ok = EVP_DecryptInit_ex(ctx, cipher->cipher, 
# 461 "../crypto/pem/pem_lib.c" 3 4
                                                ((void *)0)
# 461 "../crypto/pem/pem_lib.c"
                                                    , key, &(cipher->iv[0]));
    if (ok)
    ...
    if (ok)
        *plen += ilen;
        ...
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",472,__func__), ERR_set_error)((9),(101),
# 472 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 472 "../crypto/pem/pem_lib.c"
       );
...
# 495 "../crypto/pem/pem_lib.c"
int PEM_get_EVP_CIPHER_INFO(char *header, EVP_CIPHER_INFO *cipher)
{
    const EVP_CIPHER *enc = 
# 497 "../crypto/pem/pem_lib.c" 3 4
                           ((void *)0)
# 497 "../crypto/pem/pem_lib.c"
                               ;
    int ivlen;
    char *dekinfostart, c;

    cipher->cipher = 
# 501 "../crypto/pem/pem_lib.c" 3 4
                    ((void *)0)
# 501 "../crypto/pem/pem_lib.c"
                        ;
    memset(cipher->iv, 0, sizeof(cipher->iv));
    if ((header == 
# 503 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0)
# 503 "../crypto/pem/pem_lib.c"
                      ) || (*header == '\0') || (*header == '\n'))
        return 1;

    if (!((strncmp(header, "Proc-Type:" "", sizeof("Proc-Type:") - 1) == 0) ? ((header) += sizeof("Proc-Type:") - 1, 1) : 0)) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",507,__func__), ERR_set_error)((9),(107),
# 507 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 507 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    ...
    if (!((strncmp(header, "ENCRYPTED" "", sizeof("ENCRYPTED") - 1) == 0) ? ((header) += sizeof("ENCRYPTED") - 1, 1) : 0) ||
        strspn(header, " \t\r\n") == 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",519,__func__), ERR_set_error)((9),(106),
# 519 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 519 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    header += strspn(header, " \t\r");
    if (*header++ != '\n') {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",524,__func__), ERR_set_error)((9),(112),
# 524 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 524 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    ...
    if (!((strncmp(header, "DEK-Info:" "", sizeof("DEK-Info:") - 1) == 0) ? ((header) += sizeof("DEK-Info:") - 1, 1) : 0)) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",533,__func__), ERR_set_error)((9),(105),
# 533 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 533 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    header += strspn(header, " \t");
    ...
    *header = c;
    ...
    if (enc == 
# 550 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 550 "../crypto/pem/pem_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",551,__func__), ERR_set_error)((9),(114),
# 551 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 551 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    ivlen = EVP_CIPHER_get_iv_length(enc);
    if (ivlen > 0 && *header++ != ',') {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",556,__func__), ERR_set_error)((9),(129),
# 556 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 556 "../crypto/pem/pem_lib.c"
       );
        return 0;
    } else if (ivlen == 0 && *header == ',') {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",559,__func__), ERR_set_error)((9),(130),
# 559 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 559 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
...
static int load_iv(char **fromp, unsigned char *to, int num)
{
    ...
    for (i = 0; i < num; i++) {
        ...
        if (v < 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",581,__func__), ERR_set_error)((9),(103),
# 581 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 581 "../crypto/pem/pem_lib.c"
           );
            return 0;
        }
        from++;
              ...
              const unsigned char *data, long len)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 599 "../crypto/pem/pem_lib.c" 3 4
                                      ((void *)0)
# 599 "../crypto/pem/pem_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",600,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 600 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 600 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
                  ...
                  const unsigned char *data, long len)
{
    int nlen, n, i, j, outl;
    unsigned char *buf = 
# 614 "../crypto/pem/pem_lib.c" 3 4
                        ((void *)0)
# 614 "../crypto/pem/pem_lib.c"
                            ;
    ...
    if (ctx == 
# 619 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 619 "../crypto/pem/pem_lib.c"
                  ) {
        reason = (6 | (0x2 << 18L));
        goto err;
    }
    ...
    i = header != 
# 634 "../crypto/pem/pem_lib.c" 3 4
                 ((void *)0) 
# 634 "../crypto/pem/pem_lib.c"
                      ? strlen(header) : 0;
    if (i > 0) {
    ...
    buf = CRYPTO_malloc(1024 * 8, "../crypto/pem/pem_lib.c", 642);
    if (buf == 
# 643 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 643 "../crypto/pem/pem_lib.c"
                  )
        goto err;
 ...
 err:
    if (retval == 0 && reason != 0)
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",676,__func__), ERR_set_error)((9),(reason),
# 676 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 676 "../crypto/pem/pem_lib.c"
       );
    EVP_ENCODE_CTX_free(ctx);
    CRYPTO_clear_free(buf, 1024 * 8, "../crypto/pem/pem_lib.c", 678);
    return retval;
}
             ...
             long *len)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 689 "../crypto/pem/pem_lib.c" 3 4
                                      ((void *)0)
# 689 "../crypto/pem/pem_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",690,__func__), ERR_set_error)((9),((7 | (0x2 << 18L))),
# 690 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 690 "../crypto/pem/pem_lib.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
static int sanitize_line(char *linebuf, int len, unsigned int flags, int first_call)
{
    ...
    if (flags & 0x2) {
        ...
        for (i = 0; i < len; ++i) {
            if (!(ossl_ctype_check((linebuf[i]), 0x400)) || linebuf[i] == '\n'
                || linebuf[i] == '\r')
                break;
        }
        len = i;
        ...
        for (i = 0; i < len; ++i) {
            if (linebuf[i] == '\n' || linebuf[i] == '\r')
                break;
            if ((ossl_ctype_check((linebuf[i]), 0x40)))
                linebuf[i] = ' ';
        }
        len = i;
    }
...
static int get_name(BIO *bp, char **name, unsigned int flags)
{
    ...
    linebuf = pem_malloc((255 + 1), (flags), "../crypto/pem/pem_lib.c", 765);
    if (linebuf == 
# 766 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0)
# 766 "../crypto/pem/pem_lib.c"
                      )
        return 0;

    do {
        len = BIO_gets(bp, linebuf, 255);

        if (len <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",773,__func__), ERR_set_error)((9),(108),
# 773 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 773 "../crypto/pem/pem_lib.c"
           );
            goto err;
        }


        len = sanitize_line(linebuf, len, flags & ~0x4, first_call);
        first_call = 0;


    } while (!(strncmp(linebuf, "-----BEGIN " "", sizeof("-----BEGIN ") - 1) == 0)
             || len < ((int)(sizeof("-----\n") - 1))
             || !(strncmp(linebuf + len - ((int)(sizeof("-----\n") - 1)), "-----\n" "", sizeof("-----\n") - 1) == 0));
    linebuf[len - ((int)(sizeof("-----\n") - 1))] = '\0';
    len = len - ((int)(sizeof("-----BEGIN ") - 1)) - ((int)(sizeof("-----\n") - 1)) + 1;
    *name = pem_malloc((len), (flags), "../crypto/pem/pem_lib.c", 787);
    if (*name == 
# 788 "../crypto/pem/pem_lib.c" 3 4
                ((void *)0)
# 788 "../crypto/pem/pem_lib.c"
                    )
        goto err;
    memcpy(*name, linebuf + ((int)(sizeof("-----BEGIN ") - 1)), len);
    ret = 1;

err:
    pem_free((linebuf), (flags), (255 + 1), "../crypto/pem/pem_lib.c", 794);
    return ret;
}
                               ...
                               unsigned int flags)
{
    ...
    linebuf = pem_malloc((255 + 1), (flags), "../crypto/pem/pem_lib.c", 829);
    if (linebuf == 
# 830 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0)
# 830 "../crypto/pem/pem_lib.c"
                      )
        return 0;
    ...
    while(1) {
        ...
        len = BIO_gets(bp, linebuf, 255);
        if (len <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",837,__func__), ERR_set_error)((9),(102),
# 837 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 837 "../crypto/pem/pem_lib.c"
           );
            goto err;
        }
        ...
        partial_line_read = len == 255 -1 && linebuf[255 -2] != '\n';

        if (got_header == MAYBE_HEADER) {
            if (memchr(linebuf, ':', len) != 
# 850 "../crypto/pem/pem_lib.c" 3 4
                                            ((void *)0)
# 850 "../crypto/pem/pem_lib.c"
                                                )
                got_header = IN_HEADER;
        }
        if ((strncmp(linebuf, "-----END " "", sizeof("-----END ") - 1) == 0) || got_header == IN_HEADER)
            flags_mask &= ~0x4;
        ...
        if (linebuf[0] == '\n') {
            ...
            if (!prev_partial_line_read) {
                if (got_header == POST_HEADER) {
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",866,__func__), ERR_set_error)((9),(102),
# 866 "../crypto/pem/pem_lib.c" 3 4
                   ((void *)0)
# 866 "../crypto/pem/pem_lib.c"
                   );
                    goto err;
                }
        ...
        p = linebuf;
        if (((strncmp(p, "-----END " "", sizeof("-----END ") - 1) == 0) ? ((p) += sizeof("-----END ") - 1, 1) : 0)) {
            namelen = strlen(name);
            if (strncmp(p, name, namelen) != 0 ||
                !(strncmp(p + namelen, "-----\n" "", sizeof("-----\n") - 1) == 0)) {
                (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",881,__func__), ERR_set_error)((9),(102),
# 881 "../crypto/pem/pem_lib.c" 3 4
               ((void *)0)
# 881 "../crypto/pem/pem_lib.c"
               );
                goto err;
            }
            if (got_header == MAYBE_HEADER) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",891,__func__), ERR_set_error)((9),(102),
# 891 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 891 "../crypto/pem/pem_lib.c"
           );
            goto err;
        }
    ...
    ret = 1;
err:
    pem_free((linebuf), (flags), (255 + 1), "../crypto/pem/pem_lib.c", 914);
    return ret;
}
...
{
    EVP_ENCODE_CTX *ctx = 
# 927 "../crypto/pem/pem_lib.c" 3 4
                         ((void *)0)
# 927 "../crypto/pem/pem_lib.c"
                             ;
    const BIO_METHOD *bmeth;
    BIO *headerB = 
# 929 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0)
# 929 "../crypto/pem/pem_lib.c"
                      , *dataB = 
# 929 "../crypto/pem/pem_lib.c" 3 4
                                 ((void *)0)
# 929 "../crypto/pem/pem_lib.c"
                                     ;
    char *name = 
# 930 "../crypto/pem/pem_lib.c" 3 4
                ((void *)0)
# 930 "../crypto/pem/pem_lib.c"
                    ;
    ...
    *len_out = 0;
    *name_out = *header = 
# 935 "../crypto/pem/pem_lib.c" 3 4
                         ((void *)0)
# 935 "../crypto/pem/pem_lib.c"
                             ;
    *data = 
# 936 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 936 "../crypto/pem/pem_lib.c"
               ;
    if ((flags & 0x2) && (flags & 0x4)) {

        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",939,__func__), ERR_set_error)((9),((262|(0x2 << 18L))),
# 939 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 939 "../crypto/pem/pem_lib.c"
       );
        goto end;
    }
    bmeth = (flags & 0x1) ? BIO_s_secmem() : BIO_s_mem();

    headerB = BIO_new(bmeth);
    dataB = BIO_new(bmeth);
    if (headerB == 
# 946 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0) 
# 946 "../crypto/pem/pem_lib.c"
                       || dataB == 
# 946 "../crypto/pem/pem_lib.c" 3 4
                                   ((void *)0)
# 946 "../crypto/pem/pem_lib.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",947,__func__), ERR_set_error)((9),((32 | (0x2 << 18L))),
# 947 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 947 "../crypto/pem/pem_lib.c"
       );
        goto end;
    }
    ...
    BIO_ctrl(dataB,115,0, (char *)(&buf_mem));
    len = buf_mem->length;
    ...
    if (ctx == 
# 964 "../crypto/pem/pem_lib.c" 3 4
              ((void *)0)
# 964 "../crypto/pem/pem_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",965,__func__), ERR_set_error)((9),((6 | (0x2 << 18L))),
# 965 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 965 "../crypto/pem/pem_lib.c"
       );
        goto end;
    }
    ...
    if (EVP_DecodeUpdate(ctx, (unsigned char*)buf_mem->data, &len,
            ...
            || EVP_DecodeFinal(ctx, (unsigned char*)&(buf_mem->data[len]),
                               &taillen) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/pem/pem_lib.c",974,__func__), ERR_set_error)((9),(100),
# 974 "../crypto/pem/pem_lib.c" 3 4
       ((void *)0)
# 974 "../crypto/pem/pem_lib.c"
       );
        goto end;
    }
    len += taillen;
    ...
    headerlen = BIO_ctrl(headerB,3,0,(char *)(
# 980 "../crypto/pem/pem_lib.c" 3 4
               ((void *)0)
# 980 "../crypto/pem/pem_lib.c"
               ));
    *header = pem_malloc((headerlen + 1), (flags), "../crypto/pem/pem_lib.c", 981);
    *data = pem_malloc((len), (flags), "../crypto/pem/pem_lib.c", 982);
    if (*header == 
# 983 "../crypto/pem/pem_lib.c" 3 4
                  ((void *)0) 
# 983 "../crypto/pem/pem_lib.c"
                       || *data == 
# 983 "../crypto/pem/pem_lib.c" 3 4
                                   ((void *)0)
# 983 "../crypto/pem/pem_lib.c"
    ...
    *name_out = name;
    name = 
# 992 "../crypto/pem/pem_lib.c" 3 4
          ((void *)0)
# 992 "../crypto/pem/pem_lib.c"
              ;
    ret = 1;
    goto end;

out_free:
    pem_free((*header), (flags), (0), "../crypto/pem/pem_lib.c", 997);
    *header = 
# 998 "../crypto/pem/pem_lib.c" 3 4
             ((void *)0)
# 998 "../crypto/pem/pem_lib.c"
                 ;
    pem_free((*data), (flags), (0), "../crypto/pem/pem_lib.c", 999);
    *data = 
# 1000 "../crypto/pem/pem_lib.c" 3 4
           ((void *)0)
# 1000 "../crypto/pem/pem_lib.c"
               ;
end:
    EVP_ENCODE_CTX_free(ctx);
    pem_free((name), (flags), (0), "../crypto/pem/pem_lib.c", 1003);
    BIO_free(headerB);
    BIO_free(dataB);
    return ret;
}
...
int PEM_read_bio(BIO *bp, char **name, char **header, unsigned char **data,
                 long *len)
{
    return PEM_read_bio_ex(bp, name, header, data, len, 0x2);
}
