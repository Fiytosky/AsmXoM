# 0 "../crypto/pem/pem_xaux.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pem/pem_xaux.c"
# 10 "../crypto/pem/pem_xaux.c"
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 17 "../crypto/pem/pem_xaux.c" 2

X509 *PEM_read_bio_X509_AUX(BIO *bp, X509 **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read_bio((d2i_of_void *)d2i_X509_AUX, "TRUSTED CERTIFICATE", bp, (void **)x, cb, u); } X509 *PEM_read_X509_AUX(FILE *fp, X509 **x, pem_password_cb *cb, void *u) { return PEM_ASN1_read((d2i_of_void *)d2i_X509_AUX, "TRUSTED CERTIFICATE", fp, (void **)x, cb, u); } int PEM_write_bio_X509_AUX(BIO *out, const X509 *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_X509_AUX, "TRUSTED CERTIFICATE", out, x, 
# 18 "../crypto/pem/pem_xaux.c" 3 4
((void *)0)
# 18 "../crypto/pem/pem_xaux.c"
,
# 18 "../crypto/pem/pem_xaux.c" 3 4
((void *)0)
# 18 "../crypto/pem/pem_xaux.c"
...
((void *)0)
# 18 "../crypto/pem/pem_xaux.c"
); } int PEM_write_X509_AUX(FILE *out, const X509 *x) { return PEM_ASN1_write((i2d_of_void *)i2d_X509_AUX, "TRUSTED CERTIFICATE", out, x, 
# 18 "../crypto/pem/pem_xaux.c" 3 4
((void *)0)
# 18 "../crypto/pem/pem_xaux.c"
, 
