...
# 18 "../crypto/ex_data.c"
    ...
    return global->ex_data_lock != 
# 22 "../crypto/ex_data.c" 3 4
                                  ((void *)0)
# 22 "../crypto/ex_data.c"
                                      ;
}
                                  ...
                                  int read)
{
    ...
    if (class_index < 0 || class_index >= 18) {
        (ERR_new(), ERR_set_debug("../crypto/ex_data.c",37,__func__), ERR_set_error)((15),((262|(0x2 << 18L))),
# 37 "../crypto/ex_data.c" 3 4
       ((void *)0)
# 37 "../crypto/ex_data.c"
       );
        return 
# 38 "../crypto/ex_data.c" 3 4
              ((void *)0)
# 38 "../crypto/ex_data.c"
                  ;
    }

    if (global->ex_data_lock == 
# 41 "../crypto/ex_data.c" 3 4
                               ((void *)0)
# 41 "../crypto/ex_data.c"
                                   ) {
...
int ossl_crypto_free_ex_index_ex(OSSL_LIB_CTX *ctx, int class_index, int idx)
{
    ...
    if (global == 
# 120 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 120 "../crypto/ex_data.c"
                     )
        return 0;

    ip = get_and_lock(global, class_index, 0);
    if (ip == 
# 124 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 124 "../crypto/ex_data.c"
                 )
        return 0;
    ...
    if (a == 
# 130 "../crypto/ex_data.c" 3 4
            ((void *)0)
# 130 "../crypto/ex_data.c"
                )
        goto err;
...
int CRYPTO_free_ex_index(int class_index, int idx)
{
    return ossl_crypto_free_ex_index_ex(
# 143 "../crypto/ex_data.c" 3 4
                                       ((void *)0)
# 143 "../crypto/ex_data.c"
                                           , class_index, idx);
}
                                    ...
                                    int priority)
{
    ...
    if (global == 
# 161 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 161 "../crypto/ex_data.c"
                     )
        return -1;

    ip = get_and_lock(global, class_index, 0);
    if (ip == 
# 165 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 165 "../crypto/ex_data.c"
                 )
        return -1;

    if (ip->meth == 
# 168 "../crypto/ex_data.c" 3 4
                   ((void *)0)
# 168 "../crypto/ex_data.c"
                       ) {
        ip->meth = sk_EX_CALLBACK_new_null();


        if (ip->meth == 
# 172 "../crypto/ex_data.c" 3 4
                       ((void *)0)
            
# 173 "../crypto/ex_data.c"
           || !sk_EX_CALLBACK_push(ip->meth, 
# 173 "../crypto/ex_data.c" 3 4
                                             ((void *)0)
# 173 "../crypto/ex_data.c"
                                                 )) {
            sk_EX_CALLBACK_free(ip->meth);
            ip->meth = 
# 175 "../crypto/ex_data.c" 3 4
                      ((void *)0)
# 175 "../crypto/ex_data.c"
                          ;
            (ERR_new(), ERR_set_debug("../crypto/ex_data.c",176,__func__), ERR_set_error)((15),((15 | (0x2 << 18L))),
# 176 "../crypto/ex_data.c" 3 4
           ((void *)0)
# 176 "../crypto/ex_data.c"
           );
            goto err;
        }
    }

    a = (EX_CALLBACK *)CRYPTO_malloc(sizeof(*a), "../crypto/ex_data.c", 181);
    if (a == 
# 182 "../crypto/ex_data.c" 3 4
            ((void *)0)
# 182 "../crypto/ex_data.c"
                )
        goto err;
    a->argl = argl;
    a->argp = argp;
    ...
    if (!sk_EX_CALLBACK_push(ip->meth, 
# 191 "../crypto/ex_data.c" 3 4
                                      ((void *)0)
# 191 "../crypto/ex_data.c"
                                          )) {
        (ERR_new(), ERR_set_debug("../crypto/ex_data.c",192,__func__), ERR_set_error)((15),((15 | (0x2 << 18L))),
# 192 "../crypto/ex_data.c" 3 4
       ((void *)0)
# 192 "../crypto/ex_data.c"
       );
        CRYPTO_free(a, "../crypto/ex_data.c", 193);
        goto err;
    }
...
int CRYPTO_get_ex_new_index(int class_index, long argl, void *argp,
                            ...
                            CRYPTO_EX_free *free_func)
{
    return ossl_crypto_get_ex_new_index_ex(
# 208 "../crypto/ex_data.c" 3 4
                                          ((void *)0)
# 208 "../crypto/ex_data.c"
                                              , class_index, argl, argp,
                               ...
                               CRYPTO_EX_DATA *ad)
{
    ...
    void *ptr;
    EX_CALLBACK **storage = 
# 224 "../crypto/ex_data.c" 3 4
                           ((void *)0)
# 224 "../crypto/ex_data.c"
                               ;
    ...
    if (global == 
# 229 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 229 "../crypto/ex_data.c"
                     )
        return 0;

    ip = get_and_lock(global, class_index, 1);
    if (ip == 
# 233 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 233 "../crypto/ex_data.c"
                 )
        return 0;

    ad->ctx = ctx;
    ad->sk = 
# 237 "../crypto/ex_data.c" 3 4
            ((void *)0)
# 237 "../crypto/ex_data.c"
                ;
    mx = sk_EX_CALLBACK_num(ip->meth);
    if (mx > 0) {
        if (mx < (int)(sizeof(stack)/sizeof((stack)[0])))
            storage = stack;
        else
            storage = CRYPTO_malloc(sizeof(*storage) * mx, "../crypto/ex_data.c", 243);
        if (storage != 
# 244 "../crypto/ex_data.c" 3 4
                      ((void *)0)
# 244 "../crypto/ex_data.c"
                          )
            for (i = 0; i < mx; i++)
    ...
    if (mx > 0 && storage == 
# 250 "../crypto/ex_data.c" 3 4
                            ((void *)0)
# 250 "../crypto/ex_data.c"
                                )
        return 0;
    for (i = 0; i < mx; i++) {
        if (storage[i] != 
# 253 "../crypto/ex_data.c" 3 4
                         ((void *)0) 
# 253 "../crypto/ex_data.c"
                              && storage[i]->new_func != 
# 253 "../crypto/ex_data.c" 3 4
                                                         ((void *)0)
# 253 "../crypto/ex_data.c"
    ...
    if (storage != stack)
        CRYPTO_free(storage, "../crypto/ex_data.c", 260);
    return 1;
}

int CRYPTO_new_ex_data(int class_index, void *obj, CRYPTO_EX_DATA *ad)
{
    return ossl_crypto_new_ex_data_ex(
# 266 "../crypto/ex_data.c" 3 4
                                     ((void *)0)
# 266 "../crypto/ex_data.c"
                                         , class_index, obj, ad);
}
                       ...
                       const CRYPTO_EX_DATA *from)
{
    ...
    EX_CALLBACK *stack[10];
    EX_CALLBACK **storage = 
# 279 "../crypto/ex_data.c" 3 4
                           ((void *)0)
# 279 "../crypto/ex_data.c"
                               ;
    EX_CALLBACKS *ip;
    int toret = 0;
    ...
    to->ctx = from->ctx;
    if (from->sk == 
# 285 "../crypto/ex_data.c" 3 4
                   ((void *)0)
# 285 "../crypto/ex_data.c"
                       )
    ...
    if (global == 
# 290 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 290 "../crypto/ex_data.c"
                     )
        return 0;

    ip = get_and_lock(global, class_index, 1);
    if (ip == 
# 294 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 294 "../crypto/ex_data.c"
                 )
        return 0;

    mx = sk_EX_CALLBACK_num(ip->meth);
    j = OPENSSL_sk_num(ossl_check_const_void_sk_type(from->sk));
    if (j < mx)
        mx = j;
    if (mx > 0) {
        if (mx < (int)(sizeof(stack)/sizeof((stack)[0])))
            ...
            storage = CRYPTO_malloc(sizeof(*storage) * mx, "../crypto/ex_data.c", 305);
        if (storage != 
# 306 "../crypto/ex_data.c" 3 4
                      ((void *)0)
# 306 "../crypto/ex_data.c"
    ...
    if (mx == 0)
        return 1;
    if (storage == 
# 314 "../crypto/ex_data.c" 3 4
                  ((void *)0)
# 314 "../crypto/ex_data.c"
                      )
        return 0;
    ...
    for (i = 0; i < mx; i++) {
        ...
        if (storage[i] != 
# 328 "../crypto/ex_data.c" 3 4
                         ((void *)0) 
# 328 "../crypto/ex_data.c"
                              && storage[i]->dup_func != 
# 328 "../crypto/ex_data.c" 3 4
                                                         ((void *)0)
# 328 "../crypto/ex_data.c"
 ...
 err:
    if (storage != stack)
        CRYPTO_free(storage, "../crypto/ex_data.c", 337);
    return toret;
}
...
static int ex_callback_compare(const void *a, const void *b)
{
    ...
    if (ap->excb == 
# 354 "../crypto/ex_data.c" 3 4
                   ((void *)0)
# 354 "../crypto/ex_data.c"
                       )
        return 1;
    if (bp->excb == 
# 356 "../crypto/ex_data.c" 3 4
                   ((void *)0)
# 356 "../crypto/ex_data.c"
                       )
        return -1;
...
void CRYPTO_free_ex_data(int class_index, void *obj, CRYPTO_EX_DATA *ad)
{
    ...
    struct ex_callback_entry *storage = 
# 374 "../crypto/ex_data.c" 3 4
                                       ((void *)0)
# 374 "../crypto/ex_data.c"
                                           ;
    OSSL_EX_DATA_GLOBAL *global = ossl_lib_ctx_get_ex_data_global(ad->ctx);

    if (global == 
# 377 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 377 "../crypto/ex_data.c"
                     )
        goto err;

    ip = get_and_lock(global, class_index, 1);
    if (ip == 
# 381 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 381 "../crypto/ex_data.c"
                 )
        goto err;
    ...
    if (mx > 0) {
        if (mx < (int)(sizeof(stack)/sizeof((stack)[0])))
            ...
            storage = CRYPTO_malloc(sizeof(*storage) * mx, "../crypto/ex_data.c", 389);
        if (storage != 
# 390 "../crypto/ex_data.c" 3 4
                      ((void *)0)
# 390 "../crypto/ex_data.c"
                          )
            for (i = 0; i < mx; i++) {
    ...
    if (storage != 
# 398 "../crypto/ex_data.c" 3 4
                  ((void *)0)
# 398 "../crypto/ex_data.c"
                      ) {
        ...
        for (i = 0; i < mx; i++) {
            ...
            if (f != 
# 404 "../crypto/ex_data.c" 3 4
                    ((void *)0) 
# 404 "../crypto/ex_data.c"
                         && f->free_func != 
# 404 "../crypto/ex_data.c" 3 4
                                            ((void *)0)
# 404 "../crypto/ex_data.c"
    ...
    if (storage != stack)
        CRYPTO_free(storage, "../crypto/ex_data.c", 412);
 err:
    OPENSSL_sk_free(ossl_check_void_sk_type(ad->sk));
    ad->sk = 
# 415 "../crypto/ex_data.c" 3 4
            ((void *)0)
# 415 "../crypto/ex_data.c"
                ;
    ad->ctx = 
# 416 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 416 "../crypto/ex_data.c"
                 ;
}
                         ...
                         int idx)
{
    ...
    if (curval != 
# 430 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 430 "../crypto/ex_data.c"
                     )
        return 1;
                                     ...
                                     CRYPTO_EX_DATA *ad, int idx)
{
    ...
    if (global == 
# 444 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 444 "../crypto/ex_data.c"
                     )
        return 0;

    ip = get_and_lock(global, class_index, 1);
    if (ip == 
# 448 "../crypto/ex_data.c" 3 4
             ((void *)0)
# 448 "../crypto/ex_data.c"
                 )
        return 0;
    ...
    if (f->new_func == 
# 457 "../crypto/ex_data.c" 3 4
                      ((void *)0)
# 457 "../crypto/ex_data.c"
                          )
        return 0;

    f->new_func(obj, 
# 460 "../crypto/ex_data.c" 3 4
                    ((void *)0)
# 460 "../crypto/ex_data.c"
...
int CRYPTO_set_ex_data(CRYPTO_EX_DATA *ad, int idx, void *val)
{
    ...
    if (ad->sk == 
# 473 "../crypto/ex_data.c" 3 4
                 ((void *)0)
# 473 "../crypto/ex_data.c"
                     ) {
        if ((ad->sk = ((struct stack_st_void *)OPENSSL_sk_new_null())) == 
# 474 "../crypto/ex_data.c" 3 4
                                            ((void *)0)
# 474 "../crypto/ex_data.c"
                                                ) {
            (ERR_new(), ERR_set_debug("../crypto/ex_data.c",475,__func__), ERR_set_error)((15),((15 | (0x2 << 18L))),
# 475 "../crypto/ex_data.c" 3 4
           ((void *)0)
# 475 "../crypto/ex_data.c"
           );
            return 0;
        }
    }

    for (i = OPENSSL_sk_num(ossl_check_const_void_sk_type(ad->sk)); i <= idx; ++i) {
        if (!OPENSSL_sk_push(ossl_check_void_sk_type(ad->sk), ossl_check_void_type(
# 481 "../crypto/ex_data.c" 3 4
            ((void *)0)
# 481 "../crypto/ex_data.c"
            ))) {
            (ERR_new(), ERR_set_debug("../crypto/ex_data.c",482,__func__), ERR_set_error)((15),((15 | (0x2 << 18L))),
# 482 "../crypto/ex_data.c" 3 4
           ((void *)0)
# 482 "../crypto/ex_data.c"
           );
            return 0;
        }
    }
    if (((void *)OPENSSL_sk_set(ossl_check_void_sk_type(ad->sk), (idx), ossl_check_void_type(val))) != val) {

        (ERR_new(), ERR_set_debug("../crypto/ex_data.c",488,__func__), ERR_set_error)((15),((262|(0x2 << 18L))),
# 488 "../crypto/ex_data.c" 3 4
       ((void *)0)
# 488 "../crypto/ex_data.c"
       );
        return 0;
    }
    return 1;
...
{
    if (ad->sk == 
# 500 "../crypto/ex_data.c" 3 4
                 ((void *)0) 
# 500 "../crypto/ex_data.c"
                      || idx >= OPENSSL_sk_num(ossl_check_const_void_sk_type(ad->sk)))
        return 
# 501 "../crypto/ex_data.c" 3 4
              ((void *)0)
# 501 "../crypto/ex_data.c"
                  ;
    return ((void *)OPENSSL_sk_value(ossl_check_const_void_sk_type(ad->sk), (idx)));
}
