# 0 "../crypto/ess/ess_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ess/ess_lib.c"
# 10 "../crypto/ess/ess_lib.c"
...
{
    ESS_CERT_ID *cid = 
# 28 "../crypto/ess/ess_lib.c" 3 4
                      ((void *)0)
# 28 "../crypto/ess/ess_lib.c"
                          ;
    ESS_SIGNING_CERT *sc;
    int i;

    if ((sc = ESS_SIGNING_CERT_new()) == 
# 32 "../crypto/ess/ess_lib.c" 3 4
                                        ((void *)0)
# 32 "../crypto/ess/ess_lib.c"
                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",33,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 33 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 33 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (sc->cert_ids == 
# 36 "../crypto/ess/ess_lib.c" 3 4
                       ((void *)0)
        
# 37 "../crypto/ess/ess_lib.c"
       && (sc->cert_ids = ((struct stack_st_ESS_CERT_ID *)OPENSSL_sk_new_null())) == 
# 37 "../crypto/ess/ess_lib.c" 3 4
                                                        ((void *)0)
# 37 "../crypto/ess/ess_lib.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",38,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 38 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 38 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }

    if ((cid = ESS_CERT_ID_new_init(signcert, set_issuer_serial)) == 
# 42 "../crypto/ess/ess_lib.c" 3 4
                                                                    ((void *)0)
        
# 43 "../crypto/ess/ess_lib.c"
       || !OPENSSL_sk_push(ossl_check_ESS_CERT_ID_sk_type(sc->cert_ids), ossl_check_ESS_CERT_ID_type(cid))) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",44,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 44 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 44 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
...
# 50 "../crypto/ess/ess_lib.c" 3 4
                                                    ((void *)0)
# 50 "../crypto/ess/ess_lib.c"
                                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",51,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 51 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 51 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
        if (!OPENSSL_sk_push(ossl_check_ESS_CERT_ID_sk_type(sc->cert_ids), ossl_check_ESS_CERT_ID_type(cid))) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",55,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 55 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 55 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
    }
 ...
 err:
    ...
    return 
# 64 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 64 "../crypto/ess/ess_lib.c"
              ;
}
...
{
    ESS_CERT_ID *cid = 
# 70 "../crypto/ess/ess_lib.c" 3 4
                      ((void *)0)
# 70 "../crypto/ess/ess_lib.c"
                          ;
    GENERAL_NAME *name = 
# 71 "../crypto/ess/ess_lib.c" 3 4
                        ((void *)0)
# 71 "../crypto/ess/ess_lib.c"
                            ;
    unsigned char cert_sha1[20];

    if ((cid = ESS_CERT_ID_new()) == 
# 74 "../crypto/ess/ess_lib.c" 3 4
                                    ((void *)0)
# 74 "../crypto/ess/ess_lib.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",75,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 75 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 75 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (!X509_digest(cert, EVP_sha1(), cert_sha1, 
# 78 "../crypto/ess/ess_lib.c" 3 4
                                                 ((void *)0)
# 78 "../crypto/ess/ess_lib.c"
                                                     )) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",79,__func__), ERR_set_error)((54),((11 | (0x2 << 18L))),
# 79 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 79 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (!ASN1_OCTET_STRING_set(cid->hash, cert_sha1, 20)) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",83,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 83 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 83 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
...
# 91 "../crypto/ess/ess_lib.c" 3 4
                             ((void *)0)
        
# 92 "../crypto/ess/ess_lib.c"
       && (cid->issuer_serial = ESS_ISSUER_SERIAL_new()) == 
# 92 "../crypto/ess/ess_lib.c" 3 4
                                                            ((void *)0)
# 92 "../crypto/ess/ess_lib.c"
                                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",93,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 93 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 93 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if ((name = GENERAL_NAME_new()) == 
# 96 "../crypto/ess/ess_lib.c" 3 4
                                      ((void *)0)
# 96 "../crypto/ess/ess_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",97,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 97 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 97 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    name->type = 4;
    if ((name->d.dirn = X509_NAME_dup(X509_get_issuer_name(cert))) == 
# 101 "../crypto/ess/ess_lib.c" 3 4
                                                                     ((void *)0)
# 101 "../crypto/ess/ess_lib.c"
                                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",102,__func__), ERR_set_error)((54),((11 | (0x2 << 18L))),
# 102 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 102 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (!OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(cid->issuer_serial->issuer), ossl_check_GENERAL_NAME_type(name))) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",106,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 106 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 106 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    name = 
# 109 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 109 "../crypto/ess/ess_lib.c"
              ;
    ASN1_INTEGER_free(cid->issuer_serial->serial);
    if ((cid->issuer_serial->serial
         = ASN1_INTEGER_dup(X509_get0_serialNumber(cert))) == 
# 112 "../crypto/ess/ess_lib.c" 3 4
                                                             ((void *)0)
# 112 "../crypto/ess/ess_lib.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",113,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 113 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 113 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
 ...
 err:
    ...
    ESS_CERT_ID_free(cid);
    return 
# 121 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 121 "../crypto/ess/ess_lib.c"
              ;
}
...
{
    ESS_CERT_ID_V2 *cid = 
# 130 "../crypto/ess/ess_lib.c" 3 4
                         ((void *)0)
# 130 "../crypto/ess/ess_lib.c"
                             ;
    ESS_SIGNING_CERT_V2 *sc;
    int i;

    if ((sc = ESS_SIGNING_CERT_V2_new()) == 
# 134 "../crypto/ess/ess_lib.c" 3 4
                                           ((void *)0)
# 134 "../crypto/ess/ess_lib.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",135,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 135 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 135 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    cid = ESS_CERT_ID_V2_new_init(hash_alg, signcert, set_issuer_serial);
    if (cid == 
# 139 "../crypto/ess/ess_lib.c" 3 4
              ((void *)0)
# 139 "../crypto/ess/ess_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",140,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 140 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 140 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (!OPENSSL_sk_push(ossl_check_ESS_CERT_ID_V2_sk_type(sc->cert_ids), ossl_check_ESS_CERT_ID_V2_type(cid))) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",144,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 144 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 144 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    cid = 
# 147 "../crypto/ess/ess_lib.c" 3 4
         ((void *)0)
# 147 "../crypto/ess/ess_lib.c"
             ;
...
# 152 "../crypto/ess/ess_lib.c" 3 4
                                                                 ((void *)0)
# 152 "../crypto/ess/ess_lib.c"
                                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",153,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 153 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 153 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
        if (!OPENSSL_sk_push(ossl_check_ESS_CERT_ID_V2_sk_type(sc->cert_ids), ossl_check_ESS_CERT_ID_V2_type(cid))) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",157,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 157 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 157 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
        cid = 
# 160 "../crypto/ess/ess_lib.c" 3 4
             ((void *)0)
# 160 "../crypto/ess/ess_lib.c"
                 ;
    }
 ...
 err:
    ...
    return 
# 167 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 167 "../crypto/ess/ess_lib.c"
              ;
}
                                               ...
                                               int set_issuer_serial)
{
    ESS_CERT_ID_V2 *cid;
    GENERAL_NAME *name = 
# 175 "../crypto/ess/ess_lib.c" 3 4
                        ((void *)0)
# 175 "../crypto/ess/ess_lib.c"
                            ;
    unsigned char hash[64];
    unsigned int hash_len = sizeof(hash);
    X509_ALGOR *alg = 
# 178 "../crypto/ess/ess_lib.c" 3 4
                     ((void *)0)
# 178 "../crypto/ess/ess_lib.c"
                         ;

    memset(hash, 0, sizeof(hash));

    if ((cid = ESS_CERT_ID_V2_new()) == 
# 182 "../crypto/ess/ess_lib.c" 3 4
                                       ((void *)0)
# 182 "../crypto/ess/ess_lib.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",183,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 183 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 183 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }

    if (!EVP_MD_is_a(hash_alg, "SHA256")) {
        alg = X509_ALGOR_new();
        if (alg == 
# 189 "../crypto/ess/ess_lib.c" 3 4
                  ((void *)0)
# 189 "../crypto/ess/ess_lib.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",190,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 190 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 190 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
        X509_ALGOR_set_md(alg, hash_alg);
        if (alg->algorithm == 
# 194 "../crypto/ess/ess_lib.c" 3 4
                             ((void *)0)
# 194 "../crypto/ess/ess_lib.c"
                                 ) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",195,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 195 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 195 "../crypto/ess/ess_lib.c"
           );
            goto err;
        }
        cid->hash_alg = alg;
        alg = 
# 199 "../crypto/ess/ess_lib.c" 3 4
             ((void *)0)
# 199 "../crypto/ess/ess_lib.c"
                 ;
    } else {
        cid->hash_alg = 
# 201 "../crypto/ess/ess_lib.c" 3 4
                       ((void *)0)
# 201 "../crypto/ess/ess_lib.c"
                           ;
    }

    if (!X509_digest(cert, hash_alg, hash, &hash_len)) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",205,__func__), ERR_set_error)((54),((11 | (0x2 << 18L))),
# 205 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 205 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }

    if (!ASN1_OCTET_STRING_set(cid->hash, hash, hash_len)) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",210,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 210 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 210 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
...
# 217 "../crypto/ess/ess_lib.c" 3 4
                                                         ((void *)0)
# 217 "../crypto/ess/ess_lib.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",218,__func__), ERR_set_error)((54),((54 | (0x2 << 18L))),
# 218 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 218 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if ((name = GENERAL_NAME_new()) == 
# 221 "../crypto/ess/ess_lib.c" 3 4
                                      ((void *)0)
# 221 "../crypto/ess/ess_lib.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",222,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 222 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 222 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    name->type = 4;
    if ((name->d.dirn = X509_NAME_dup(X509_get_issuer_name(cert))) == 
# 226 "../crypto/ess/ess_lib.c" 3 4
                                                                     ((void *)0)
# 226 "../crypto/ess/ess_lib.c"
                                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",227,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 227 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 227 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    if (!OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(cid->issuer_serial->issuer), ossl_check_GENERAL_NAME_type(name))) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",231,__func__), ERR_set_error)((54),((15 | (0x2 << 18L))),
# 231 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 231 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
    name = 
# 234 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 234 "../crypto/ess/ess_lib.c"
              ;
    ASN1_INTEGER_free(cid->issuer_serial->serial);
    cid->issuer_serial->serial = ASN1_INTEGER_dup(X509_get0_serialNumber(cert));
    if (cid->issuer_serial->serial == 
# 237 "../crypto/ess/ess_lib.c" 3 4
                                     ((void *)0)
# 237 "../crypto/ess/ess_lib.c"
                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",238,__func__), ERR_set_error)((54),((13 | (0x2 << 18L))),
# 238 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 238 "../crypto/ess/ess_lib.c"
       );
        goto err;
    }
 ...
 err:
    ...
    ESS_CERT_ID_V2_free(cid);
    return 
# 247 "../crypto/ess/ess_lib.c" 3 4
          ((void *)0)
# 247 "../crypto/ess/ess_lib.c"
              ;
}
...
static int ess_issuer_serial_cmp(const ESS_ISSUER_SERIAL *is, const X509 *cert)
{
    ...
    if (is == 
# 254 "../crypto/ess/ess_lib.c" 3 4
             ((void *)0) 
# 254 "../crypto/ess/ess_lib.c"
                  || cert == 
# 254 "../crypto/ess/ess_lib.c" 3 4
                             ((void *)0) 
# 254 "../crypto/ess/ess_lib.c"
                                  || OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(is->issuer)) != 1)
        return -1;

    issuer = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(is->issuer), (0)));
    if (issuer->type != 4
...
static int find(const ESS_CERT_ID *cid, const ESS_CERT_ID_V2 *cid_v2,
                int index, const struct stack_st_X509 *certs)
{
    const X509 *cert;
    EVP_MD *md = 
# 274 "../crypto/ess/ess_lib.c" 3 4
                ((void *)0)
# 274 "../crypto/ess/ess_lib.c"
                    ;
    char name[50];
    ...
    if (cid == 
# 282 "../crypto/ess/ess_lib.c" 3 4
              ((void *)0) 
# 282 "../crypto/ess/ess_lib.c"
                   && cid_v2 == 
# 282 "../crypto/ess/ess_lib.c" 3 4
                                ((void *)0)
# 282 "../crypto/ess/ess_lib.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",283,__func__), ERR_set_error)((54),((262|(0x2 << 18L))),
# 283 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 283 "../crypto/ess/ess_lib.c"
       );
        return -1;
    }

    if (cid != 
# 287 "../crypto/ess/ess_lib.c" 3 4
              ((void *)0)
# 287 "../crypto/ess/ess_lib.c"
                  )
        strcpy(name, "SHA1");
    else if (cid_v2->hash_alg == 
# 289 "../crypto/ess/ess_lib.c" 3 4
                                ((void *)0)
# 289 "../crypto/ess/ess_lib.c"
                                    )
        strcpy(name, "SHA256");
    else
    ...
    (void)ERR_set_mark();
    md = EVP_MD_fetch(
# 295 "../crypto/ess/ess_lib.c" 3 4
                     ((void *)0)
# 295 "../crypto/ess/ess_lib.c"
                         , name, 
# 295 "../crypto/ess/ess_lib.c" 3 4
                                 ((void *)0)
# 295 "../crypto/ess/ess_lib.c"
    ...
    if (md == 
# 297 "../crypto/ess/ess_lib.c" 3 4
             ((void *)0)
# 297 "../crypto/ess/ess_lib.c"
                 )
        md = (EVP_MD *)EVP_get_digestbyname(name);

    if (md == 
# 300 "../crypto/ess/ess_lib.c" 3 4
             ((void *)0)
# 300 "../crypto/ess/ess_lib.c"
                 ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",302,__func__), ERR_set_error)((54),(106),
# 302 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 302 "../crypto/ess/ess_lib.c"
       );
        goto end;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); ++i) {
        cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));

        cid_hash_len = cid != 
# 310 "../crypto/ess/ess_lib.c" 3 4
                             ((void *)0) 
# 310 "../crypto/ess/ess_lib.c"
                                  ? cid->hash->length : cid_v2->hash->length;
        if (!X509_digest(cert, md, cert_digest, &len)
                || cid_hash_len != len) {
            (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",313,__func__), ERR_set_error)((54),(103),
# 313 "../crypto/ess/ess_lib.c" 3 4
           ((void *)0)
# 313 "../crypto/ess/ess_lib.c"
           );
            goto end;
        }

        if (memcmp(cid != 
# 317 "../crypto/ess/ess_lib.c" 3 4
                         ((void *)0) 
# 317 "../crypto/ess/ess_lib.c"
                              ? cid->hash->data : cid_v2->hash->data,
                   cert_digest, len) == 0) {
            is = cid != 
# 319 "../crypto/ess/ess_lib.c" 3 4
                       ((void *)0) 
# 319 "../crypto/ess/ess_lib.c"
                            ? cid->issuer_serial : cid_v2->issuer_serial;

            if (is == 
# 321 "../crypto/ess/ess_lib.c" 3 4
                     ((void *)0) 
# 321 "../crypto/ess/ess_lib.c"
                          || ess_issuer_serial_cmp(is, cert) == 0) {
                if ((i == 0) == (index == 0)) {
                    ret = i + 1;
                    goto end;
                }
                (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",326,__func__), ERR_set_error)((54),(105),
# 326 "../crypto/ess/ess_lib.c" 3 4
               ((void *)0)
# 326 "../crypto/ess/ess_lib.c"
               );
                goto end;
            }
        }
    ...
    ret = 0;
    (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",333,__func__), ERR_set_error)((54),(104),
# 333 "../crypto/ess/ess_lib.c" 3 4
   ((void *)0)
# 333 "../crypto/ess/ess_lib.c"
   );
end:
    EVP_MD_free(md);
    return ret;
...
{
    int n_v1 = ss == 
# 344 "../crypto/ess/ess_lib.c" 3 4
                    ((void *)0) 
# 344 "../crypto/ess/ess_lib.c"
                         ? -1 : OPENSSL_sk_num(ossl_check_const_ESS_CERT_ID_sk_type(ss->cert_ids));
    int n_v2 = ssv2 == 
# 345 "../crypto/ess/ess_lib.c" 3 4
                      ((void *)0) 
# 345 "../crypto/ess/ess_lib.c"
                           ? -1 : OPENSSL_sk_num(ossl_check_const_ESS_CERT_ID_V2_sk_type(ssv2->cert_ids));
    int i, ret;

    if (require_signing_cert && ss == 
# 348 "../crypto/ess/ess_lib.c" 3 4
                                     ((void *)0) 
# 348 "../crypto/ess/ess_lib.c"
                                          && ssv2 == 
# 348 "../crypto/ess/ess_lib.c" 3 4
                                                     ((void *)0)
# 348 "../crypto/ess/ess_lib.c"
                                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",349,__func__), ERR_set_error)((54),(108),
# 349 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 349 "../crypto/ess/ess_lib.c"
       );
        return -1;
    }
    if (n_v1 == 0 || n_v2 == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ess/ess_lib.c",353,__func__), ERR_set_error)((54),(107),
# 353 "../crypto/ess/ess_lib.c" 3 4
       ((void *)0)
# 353 "../crypto/ess/ess_lib.c"
       );
        return -1;
    }

    for (i = 0; i < n_v1; i++) {
        ret = find(((ESS_CERT_ID *)OPENSSL_sk_value(ossl_check_const_ESS_CERT_ID_sk_type(ss->cert_ids), (i))), 
# 358 "../crypto/ess/ess_lib.c" 3 4
                                                         ((void *)0)
# 358 "../crypto/ess/ess_lib.c"
                                                             , i, chain);
        if (ret <= 0)
            return ret;
    }
    for (i = 0; i < n_v2; i++) {
        ret = find(
# 363 "../crypto/ess/ess_lib.c" 3 4
                  ((void *)0)
# 363 "../crypto/ess/ess_lib.c"
                      , ((ESS_CERT_ID_V2 *)OPENSSL_sk_value(ossl_check_const_ESS_CERT_ID_V2_sk_type(ssv2->cert_ids), (i))), i, chain);
        if (ret <= 0)
            return ret;
    }
    return 1;
