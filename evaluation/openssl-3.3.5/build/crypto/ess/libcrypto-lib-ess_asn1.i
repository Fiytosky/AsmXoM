# 0 "../crypto/ess/ess_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ess/ess_asn1.c"
# 10 "../crypto/ess/ess_asn1.c"
...
# 16 "../crypto/ess/ess_asn1.c" 2



static const ASN1_TEMPLATE ESS_ISSUER_SERIAL_seq_tt[] = {
        { ((0x2 << 1)), (0), 
# 20 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/ess/ess_asn1.c"
       ESS_ISSUER_SERIAL
# 20 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 20 "../crypto/ess/ess_asn1.c"
...
# 20 "../crypto/ess/ess_asn1.c"
       , "issuer", (GENERAL_NAME_it) },
        { (0), (0), 
# 21 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 21 "../crypto/ess/ess_asn1.c"
       ESS_ISSUER_SERIAL
# 21 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 21 "../crypto/ess/ess_asn1.c"
...
# 21 "../crypto/ess/ess_asn1.c"
       , "serial", (ASN1_INTEGER_it) }
} ; static const ASN1_ITEM * ESS_ISSUER_SERIAL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_ISSUER_SERIAL_seq_tt, sizeof(ESS_ISSUER_SERIAL_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 22 "../crypto/ess/ess_asn1.c" 3 4
 ((void *)0)
# 22 "../crypto/ess/ess_asn1.c"
 , sizeof(ESS_ISSUER_SERIAL), "ESS_ISSUER_SERIAL" }; return &local_it; }

ESS_ISSUER_SERIAL *d2i_ESS_ISSUER_SERIAL(ESS_ISSUER_SERIAL **a, const unsigned char **in, long len) { return (ESS_ISSUER_SERIAL *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_ISSUER_SERIAL_it())); } int i2d_ESS_ISSUER_SERIAL(const ESS_ISSUER_SERIAL *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ESS_ISSUER_SERIAL_it())); } ESS_ISSUER_SERIAL *ESS_ISSUER_SERIAL_new(void) { return (ESS_ISSUER_SERIAL *)ASN1_item_new((ESS_ISSUER_SERIAL_it())); } void ESS_ISSUER_SERIAL_free(ESS_ISSUER_SERIAL *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_ISSUER_SERIAL_it())); }
ESS_ISSUER_SERIAL * ESS_ISSUER_SERIAL_dup(const ESS_ISSUER_SERIAL *x) { return ASN1_item_dup((ESS_ISSUER_SERIAL_it()), x); }

static const ASN1_TEMPLATE ESS_CERT_ID_seq_tt[] = {
        { (0), (0), 
# 28 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 28 "../crypto/ess/ess_asn1.c"
       ESS_CERT_ID
# 28 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 28 "../crypto/ess/ess_asn1.c"
...
# 28 "../crypto/ess/ess_asn1.c"
       , "hash", (ASN1_OCTET_STRING_it) },
        { ((0x1)), (0), 
# 29 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 29 "../crypto/ess/ess_asn1.c"
       ESS_CERT_ID
# 29 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 29 "../crypto/ess/ess_asn1.c"
...
# 29 "../crypto/ess/ess_asn1.c"
       , "issuer_serial", (ESS_ISSUER_SERIAL_it) }
} ; static const ASN1_ITEM * ESS_CERT_ID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_CERT_ID_seq_tt, sizeof(ESS_CERT_ID_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 30 "../crypto/ess/ess_asn1.c" 3 4
 ((void *)0)
# 30 "../crypto/ess/ess_asn1.c"
 , sizeof(ESS_CERT_ID), "ESS_CERT_ID" }; return &local_it; }

ESS_CERT_ID *d2i_ESS_CERT_ID(ESS_CERT_ID **a, const unsigned char **in, long len) { return (ESS_CERT_ID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_CERT_ID_it())); } int i2d_ESS_CERT_ID(const ESS_CERT_ID *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ESS_CERT_ID_it())); } ESS_CERT_ID *ESS_CERT_ID_new(void) { return (ESS_CERT_ID *)ASN1_item_new((ESS_CERT_ID_it())); } void ESS_CERT_ID_free(ESS_CERT_ID *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_CERT_ID_it())); }
ESS_CERT_ID * ESS_CERT_ID_dup(const ESS_CERT_ID *x) { return ASN1_item_dup((ESS_CERT_ID_it()), x); }

static const ASN1_TEMPLATE ESS_SIGNING_CERT_seq_tt[] = {
        { ((0x2 << 1)), (0), 
# 36 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 36 "../crypto/ess/ess_asn1.c"
       ESS_SIGNING_CERT
# 36 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 36 "../crypto/ess/ess_asn1.c"
...
# 36 "../crypto/ess/ess_asn1.c"
       , "cert_ids", (ESS_CERT_ID_it) },
        { ((0x2 << 1)|(0x1)), (0), 
# 37 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 37 "../crypto/ess/ess_asn1.c"
       ESS_SIGNING_CERT
# 37 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 37 "../crypto/ess/ess_asn1.c"
...
# 37 "../crypto/ess/ess_asn1.c"
       , "policy_info", (POLICYINFO_it) }
} ; const ASN1_ITEM * ESS_SIGNING_CERT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_SIGNING_CERT_seq_tt, sizeof(ESS_SIGNING_CERT_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 38 "../crypto/ess/ess_asn1.c" 3 4
 ((void *)0)
# 38 "../crypto/ess/ess_asn1.c"
 , sizeof(ESS_SIGNING_CERT), "ESS_SIGNING_CERT" }; return &local_it; }

ESS_SIGNING_CERT *d2i_ESS_SIGNING_CERT(ESS_SIGNING_CERT **a, const unsigned char **in, long len) { return (ESS_SIGNING_CERT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_SIGNING_CERT_it())); } int i2d_ESS_SIGNING_CERT(const ESS_SIGNING_CERT *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ESS_SIGNING_CERT_it())); } ESS_SIGNING_CERT *ESS_SIGNING_CERT_new(void) { return (ESS_SIGNING_CERT *)ASN1_item_new((ESS_SIGNING_CERT_it())); } void ESS_SIGNING_CERT_free(ESS_SIGNING_CERT *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_SIGNING_CERT_it())); }
ESS_SIGNING_CERT * ESS_SIGNING_CERT_dup(const ESS_SIGNING_CERT *x) { return ASN1_item_dup((ESS_SIGNING_CERT_it()), x); }

static const ASN1_TEMPLATE ESS_CERT_ID_V2_seq_tt[] = {
        { ((0x1)), (0), 
# 44 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 44 "../crypto/ess/ess_asn1.c"
       ESS_CERT_ID_V2
# 44 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 44 "../crypto/ess/ess_asn1.c"
...
# 44 "../crypto/ess/ess_asn1.c"
       , "hash_alg", (X509_ALGOR_it) },
        { (0), (0), 
# 45 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 45 "../crypto/ess/ess_asn1.c"
       ESS_CERT_ID_V2
# 45 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 45 "../crypto/ess/ess_asn1.c"
...
# 45 "../crypto/ess/ess_asn1.c"
       , "hash", (ASN1_OCTET_STRING_it) },
        { ((0x1)), (0), 
# 46 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 46 "../crypto/ess/ess_asn1.c"
       ESS_CERT_ID_V2
# 46 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 46 "../crypto/ess/ess_asn1.c"
...
# 46 "../crypto/ess/ess_asn1.c"
       , "issuer_serial", (ESS_ISSUER_SERIAL_it) }
} ; static const ASN1_ITEM * ESS_CERT_ID_V2_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_CERT_ID_V2_seq_tt, sizeof(ESS_CERT_ID_V2_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 47 "../crypto/ess/ess_asn1.c" 3 4
 ((void *)0)
# 47 "../crypto/ess/ess_asn1.c"
 , sizeof(ESS_CERT_ID_V2), "ESS_CERT_ID_V2" }; return &local_it; }

ESS_CERT_ID_V2 *d2i_ESS_CERT_ID_V2(ESS_CERT_ID_V2 **a, const unsigned char **in, long len) { return (ESS_CERT_ID_V2 *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_CERT_ID_V2_it())); } int i2d_ESS_CERT_ID_V2(const ESS_CERT_ID_V2 *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ESS_CERT_ID_V2_it())); } ESS_CERT_ID_V2 *ESS_CERT_ID_V2_new(void) { return (ESS_CERT_ID_V2 *)ASN1_item_new((ESS_CERT_ID_V2_it())); } void ESS_CERT_ID_V2_free(ESS_CERT_ID_V2 *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_CERT_ID_V2_it())); }
ESS_CERT_ID_V2 * ESS_CERT_ID_V2_dup(const ESS_CERT_ID_V2 *x) { return ASN1_item_dup((ESS_CERT_ID_V2_it()), x); }

static const ASN1_TEMPLATE ESS_SIGNING_CERT_V2_seq_tt[] = {
        { ((0x2 << 1)), (0), 
# 53 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 53 "../crypto/ess/ess_asn1.c"
       ESS_SIGNING_CERT_V2
# 53 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 53 "../crypto/ess/ess_asn1.c"
...
# 53 "../crypto/ess/ess_asn1.c"
       , "cert_ids", (ESS_CERT_ID_V2_it) },
        { ((0x2 << 1)|(0x1)), (0), 
# 54 "../crypto/ess/ess_asn1.c" 3 4
       __builtin_offsetof (
# 54 "../crypto/ess/ess_asn1.c"
       ESS_SIGNING_CERT_V2
# 54 "../crypto/ess/ess_asn1.c" 3 4
       , 
# 54 "../crypto/ess/ess_asn1.c"
...
# 54 "../crypto/ess/ess_asn1.c"
       , "policy_info", (POLICYINFO_it) }
} ; const ASN1_ITEM * ESS_SIGNING_CERT_V2_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ESS_SIGNING_CERT_V2_seq_tt, sizeof(ESS_SIGNING_CERT_V2_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 55 "../crypto/ess/ess_asn1.c" 3 4
 ((void *)0)
# 55 "../crypto/ess/ess_asn1.c"
 , sizeof(ESS_SIGNING_CERT_V2), "ESS_SIGNING_CERT_V2" }; return &local_it; }

ESS_SIGNING_CERT_V2 *d2i_ESS_SIGNING_CERT_V2(ESS_SIGNING_CERT_V2 **a, const unsigned char **in, long len) { return (ESS_SIGNING_CERT_V2 *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ESS_SIGNING_CERT_V2_it())); } int i2d_ESS_SIGNING_CERT_V2(const ESS_SIGNING_CERT_V2 *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ESS_SIGNING_CERT_V2_it())); } ESS_SIGNING_CERT_V2 *ESS_SIGNING_CERT_V2_new(void) { return (ESS_SIGNING_CERT_V2 *)ASN1_item_new((ESS_SIGNING_CERT_V2_it())); } void ESS_SIGNING_CERT_V2_free(ESS_SIGNING_CERT_V2 *a) { ASN1_item_free((ASN1_VALUE *)a, (ESS_SIGNING_CERT_V2_it())); }
ESS_SIGNING_CERT_V2 * ESS_SIGNING_CERT_V2_dup(const ESS_SIGNING_CERT_V2 *x) { return ASN1_item_dup((ESS_SIGNING_CERT_V2_it()), x); }
