...
size_t ossl_decode_der_dsa_sig(BIGNUM *r, BIGNUM *s, const unsigned char **ppin,
                               size_t len);
# 27 "../crypto/asn1_dsa.c" 2
# 39 "../crypto/asn1_dsa.c"
int ossl_encode_der_length(WPACKET *pkt, size_t cont_len)
{
    if (cont_len > 0xffff)
        return 0;
    ...
    if (cont_len > 0xff) {
        if (!WPACKET_put_bytes__((pkt), (0x82), 1)
                || !WPACKET_put_bytes__((pkt), (cont_len), 2))
            return 0;
    } else {
        if (cont_len > 0x7f
                && !WPACKET_put_bytes__((pkt), (0x81), 1))
            return 0;
        if (!WPACKET_put_bytes__((pkt), (cont_len), 1))
            return 0;
    }

    return 1;
}
# 66 "../crypto/asn1_dsa.c"
int ossl_encode_der_integer(WPACKET *pkt, const BIGNUM *n)
{
...
# 83 "../crypto/asn1_dsa.c"
    ...
    if (bnbytes != 
# 92 "../crypto/asn1_dsa.c" 3 4
                  ((void *)0)
            
# 93 "../crypto/asn1_dsa.c"
           && BN_bn2binpad(n, bnbytes, (int)cont_len) != (int)cont_len)
        return 0;

    return 1;
}
# 106 "../crypto/asn1_dsa.c"
int ossl_encode_der_dsa_sig(WPACKET *pkt, const BIGNUM *r, const BIGNUM *s)
{
    ...
    if (!WPACKET_put_bytes__((pkt), (0x30), 1)
            || !ossl_encode_der_length(pkt, cont_len)
...
# 212 "../crypto/asn1_dsa.c" 3 4
                                                        ((void *)0)
# 212 "../crypto/asn1_dsa.c"
                                                            )
        return 0;

    return 1;
}
# 233 "../crypto/asn1_dsa.c"
