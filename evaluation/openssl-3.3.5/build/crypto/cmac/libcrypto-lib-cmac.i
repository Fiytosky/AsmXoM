# 0 "../crypto/cmac/cmac.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmac/cmac.c"
# 14 "../crypto/cmac/cmac.c"
...
CMAC_CTX *CMAC_CTX_new(void)
{
    ...
    if ((ctx = CRYPTO_malloc(sizeof(*ctx), "../crypto/cmac/cmac.c", 57)) == 
# 57 "../crypto/cmac/cmac.c" 3 4
                                               ((void *)0)
# 57 "../crypto/cmac/cmac.c"
                                                   )
        return 
# 58 "../crypto/cmac/cmac.c" 3 4
              ((void *)0)
# 58 "../crypto/cmac/cmac.c"
                  ;
    ctx->cctx = EVP_CIPHER_CTX_new();
    if (ctx->cctx == 
# 60 "../crypto/cmac/cmac.c" 3 4
                    ((void *)0)
# 60 "../crypto/cmac/cmac.c"
                        ) {
        CRYPTO_free(ctx, "../crypto/cmac/cmac.c", 61);
        return 
# 62 "../crypto/cmac/cmac.c" 3 4
              ((void *)0)
# 62 "../crypto/cmac/cmac.c"
                  ;
    }
    ctx->nlast_block = -1;
    return ctx;
...
void CMAC_CTX_cleanup(CMAC_CTX *ctx)
{
    ...
    OPENSSL_cleanse(ctx->tbl, 32);
    OPENSSL_cleanse(ctx->k1, 32);
    OPENSSL_cleanse(ctx->k2, 32);
    OPENSSL_cleanse(ctx->last_block, 32);
    ctx->nlast_block = -1;
}
...
void CMAC_CTX_free(CMAC_CTX *ctx)
{
    ...
    CRYPTO_free(ctx, "../crypto/cmac/cmac.c", 89);
}
...
# 121 "../crypto/cmac/cmac.c" 3 4
                                          ((void *)0)
# 121 "../crypto/cmac/cmac.c"
                                              , 
# 121 "../crypto/cmac/cmac.c" 3 4
                                                ((void *)0)
# 121 "../crypto/cmac/cmac.c"
...
# 121 "../crypto/cmac/cmac.c"
    ...
    if (cipher != 
# 131 "../crypto/cmac/cmac.c" 3 4
                 ((void *)0)
# 131 "../crypto/cmac/cmac.c"
                     ) {

        ctx->nlast_block = -1;
        if (!EVP_EncryptInit_ex(ctx->cctx, cipher, impl, 
# 134 "../crypto/cmac/cmac.c" 3 4
                                                        ((void *)0)
# 134 "../crypto/cmac/cmac.c"
                                                            , 
# 134 "../crypto/cmac/cmac.c" 3 4
                                                              ((void *)0)
# 134 "../crypto/cmac/cmac.c"
    ...
    if (key != 
# 138 "../crypto/cmac/cmac.c" 3 4
              ((void *)0)
# 138 "../crypto/cmac/cmac.c"
                  ) {
        int bl;
...
# 143 "../crypto/cmac/cmac.c" 3 4
                                                    ((void *)0)
# 143 "../crypto/cmac/cmac.c"
                                                        )
            return 0;
        if (EVP_CIPHER_CTX_set_key_length(ctx->cctx, keylen) <= 0)
            return 0;
        if (!EVP_EncryptInit_ex(ctx->cctx, 
# 147 "../crypto/cmac/cmac.c" 3 4
                                          ((void *)0)
# 147 "../crypto/cmac/cmac.c"
                                              , 
# 147 "../crypto/cmac/cmac.c" 3 4
                                                ((void *)0)
# 147 "../crypto/cmac/cmac.c"
        ...
        if (!EVP_EncryptInit_ex(ctx->cctx, 
# 157 "../crypto/cmac/cmac.c" 3 4
                                          ((void *)0)
# 157 "../crypto/cmac/cmac.c"
                                              , 
# 157 "../crypto/cmac/cmac.c" 3 4
                                                ((void *)0)
# 157 "../crypto/cmac/cmac.c"
...
int CMAC_Final(CMAC_CTX *ctx, unsigned char *out, size_t *poutlen)
{
    ...
    if ((bl = EVP_CIPHER_CTX_get_block_size(ctx->cctx)) == 0)
        return 0;
    if (poutlen != 
# 243 "../crypto/cmac/cmac.c" 3 4
                  ((void *)0)
# 243 "../crypto/cmac/cmac.c"
                      )
        *poutlen = (size_t)bl;
    if (!out)
        return 1;
...
# 277 "../crypto/cmac/cmac.c" 3 4
                                        ((void *)0)
# 277 "../crypto/cmac/cmac.c"
                                            , 
# 277 "../crypto/cmac/cmac.c" 3 4
                                              ((void *)0)
# 277 "../crypto/cmac/cmac.c"
