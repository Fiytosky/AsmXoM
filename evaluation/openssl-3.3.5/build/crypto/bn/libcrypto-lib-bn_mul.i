# 0 "../crypto/bn/bn_mul.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_mul.c"
# 10 "../crypto/bn/bn_mul.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 13 "../crypto/bn/bn_mul.c" 2
# 27 "../crypto/bn/bn_mul.c"
unsigned long bn_sub_part_words(unsigned long *r,
...
# 33 "../crypto/bn/bn_mul.c" 3 4
   ((void) (0))
# 33 "../crypto/bn/bn_mul.c"
                  ;
...
void bn_mul_part_recursive(unsigned long *r, unsigned long *a, unsigned long *b, int n,
                           int tna, int tnb, unsigned long *t)
{
    int i, j, n2 = n * 2;
    int c1, c2, neg;
    unsigned long ln, lo, *p;
...
int bn_mul_fixed_top(BIGNUM *r, const BIGNUM *a, const BIGNUM *b, BN_CTX *ctx)
{
    ...
    BIGNUM *t = 
# 516 "../crypto/bn/bn_mul.c" 3 4
               ((void *)0)
# 516 "../crypto/bn/bn_mul.c"
                   ;
    int j = 0, k;
...
# 535 "../crypto/bn/bn_mul.c" 3 4
                                     ((void *)0)
# 535 "../crypto/bn/bn_mul.c"
                                         )
            goto err;
    } else
        rr = r;
    ...
    if (i == 0) {
# 554 "../crypto/bn/bn_mul.c"
        if (al == 8) {
            if (bn_wexpand(rr, 16) == 
# 555 "../crypto/bn/bn_mul.c" 3 4
                                     ((void *)0)
# 555 "../crypto/bn/bn_mul.c"
                                         )
                goto err;
            rr->top = 16;
...
# 577 "../crypto/bn/bn_mul.c" 3 4
           ((void) (0))
# 577 "../crypto/bn/bn_mul.c"
                                     ;
            k = j + j;
            t = BN_CTX_get(ctx);
            if (t == 
# 580 "../crypto/bn/bn_mul.c" 3 4
                    ((void *)0)
# 580 "../crypto/bn/bn_mul.c"
                        )
                goto err;
            if (al > j || bl > j) {
                if (bn_wexpand(t, k * 4) == 
# 583 "../crypto/bn/bn_mul.c" 3 4
                                           ((void *)0)
# 583 "../crypto/bn/bn_mul.c"
                                               )
                    goto err;
                if (bn_wexpand(rr, k * 4) == 
# 585 "../crypto/bn/bn_mul.c" 3 4
                                            ((void *)0)
# 585 "../crypto/bn/bn_mul.c"
                                                )
                    goto err;
                ...
                if (bn_wexpand(t, k * 2) == 
# 591 "../crypto/bn/bn_mul.c" 3 4
                                           ((void *)0)
# 591 "../crypto/bn/bn_mul.c"
                                               )
                    goto err;
                if (bn_wexpand(rr, k * 2) == 
# 593 "../crypto/bn/bn_mul.c" 3 4
                                            ((void *)0)
# 593 "../crypto/bn/bn_mul.c"
                                                )
                    goto err;
...
# 602 "../crypto/bn/bn_mul.c" 3 4
                              ((void *)0)
# 602 "../crypto/bn/bn_mul.c"
                                  )
        goto err;
    rr->top = top;
...
# 612 "../crypto/bn/bn_mul.c" 3 4
                                    ((void *)0)
# 612 "../crypto/bn/bn_mul.c"
                                        )
        goto err;
