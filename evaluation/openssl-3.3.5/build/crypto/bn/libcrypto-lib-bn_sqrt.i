# 0 "../crypto/bn/bn_sqrt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_sqrt.c"
# 10 "../crypto/bn/bn_sqrt.c"
...

{
    ...
    if (!BN_is_odd(p) || BN_abs_is_word(p, 1)) {
        if (BN_abs_is_word(p, 2)) {
            if (ret == 
# 30 "../crypto/bn/bn_sqrt.c" 3 4
                      ((void *)0)
# 30 "../crypto/bn/bn_sqrt.c"
                          )
                ret = BN_new();
            if (ret == 
# 32 "../crypto/bn/bn_sqrt.c" 3 4
                      ((void *)0)
# 32 "../crypto/bn/bn_sqrt.c"
                          )
                goto end;
            if (!BN_set_word(ret, BN_is_bit_set(a, 0))) {
                if (ret != in)
                    BN_free(ret);
                return 
# 37 "../crypto/bn/bn_sqrt.c" 3 4
                      ((void *)0)
# 37 "../crypto/bn/bn_sqrt.c"
                          ;
            }
            ;
            return ret;
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",43,__func__), ERR_set_error)((3),(112),
# 43 "../crypto/bn/bn_sqrt.c" 3 4
       ((void *)0)
# 43 "../crypto/bn/bn_sqrt.c"
       );
        return 
# 44 "../crypto/bn/bn_sqrt.c" 3 4
              ((void *)0)
# 44 "../crypto/bn/bn_sqrt.c"
                  ;
    }

    if (BN_is_zero(a) || BN_is_one(a)) {
        if (ret == 
# 48 "../crypto/bn/bn_sqrt.c" 3 4
                  ((void *)0)
# 48 "../crypto/bn/bn_sqrt.c"
                      )
            ret = BN_new();
        if (ret == 
# 50 "../crypto/bn/bn_sqrt.c" 3 4
                  ((void *)0)
# 50 "../crypto/bn/bn_sqrt.c"
                      )
            goto end;
        if (!BN_set_word(ret, BN_is_one(a))) {
            if (ret != in)
                BN_free(ret);
            return 
# 55 "../crypto/bn/bn_sqrt.c" 3 4
                  ((void *)0)
# 55 "../crypto/bn/bn_sqrt.c"
                      ;
        }
        ;
        return ret;
    ...
    y = BN_CTX_get(ctx);
    if (y == 
# 69 "../crypto/bn/bn_sqrt.c" 3 4
            ((void *)0)
# 69 "../crypto/bn/bn_sqrt.c"
                )
        goto end;

    if (ret == 
# 72 "../crypto/bn/bn_sqrt.c" 3 4
              ((void *)0)
# 72 "../crypto/bn/bn_sqrt.c"
                  )
        ret = BN_new();
    if (ret == 
# 74 "../crypto/bn/bn_sqrt.c" 3 4
              ((void *)0)
# 74 "../crypto/bn/bn_sqrt.c"
                  )
        goto end;
...
# 137 "../crypto/bn/bn_sqrt.c"
    ...
    do {
        ...
        if (r == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",203,__func__), ERR_set_error)((3),(112),
# 203 "../crypto/bn/bn_sqrt.c" 3 4
           ((void *)0)
# 203 "../crypto/bn/bn_sqrt.c"
           );
            goto end;
        }
    }
    ...
    if (r != -1) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",215,__func__), ERR_set_error)((3),(113),
# 215 "../crypto/bn/bn_sqrt.c" 3 4
       ((void *)0)
# 215 "../crypto/bn/bn_sqrt.c"
       );
        goto end;
    }
    ...
    if (!BN_mod_exp(y, y, q, p, ctx))
        goto end;
    if (BN_is_one(y)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",230,__func__), ERR_set_error)((3),(112),
# 230 "../crypto/bn/bn_sqrt.c" 3 4
       ((void *)0)
# 230 "../crypto/bn/bn_sqrt.c"
       );
        goto end;
    }
# 254 "../crypto/bn/bn_sqrt.c"
    if (!BN_rshift1(t, q))
        goto end;
...
# 300 "../crypto/bn/bn_sqrt.c"
        ...
        if (i >= e) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",322,__func__), ERR_set_error)((3),(111),
# 322 "../crypto/bn/bn_sqrt.c" 3 4
           ((void *)0)
# 322 "../crypto/bn/bn_sqrt.c"
           );
            goto end;
        }
 ...
 vrfy:
    if (!err) {
        ...
        if (!err && 0 != BN_cmp(x, A)) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_sqrt.c",353,__func__), ERR_set_error)((3),(111),
# 353 "../crypto/bn/bn_sqrt.c" 3 4
           ((void *)0)
# 353 "../crypto/bn/bn_sqrt.c"
           );
            err = 1;
        }
    }
    ...
    if (err) {
        if (ret != in)
            BN_clear_free(ret);
        ret = 
# 362 "../crypto/bn/bn_sqrt.c" 3 4
             ((void *)0)
# 362 "../crypto/bn/bn_sqrt.c"
                 ;
    }
    if (used_ctx)
        BN_CTX_end(ctx);
