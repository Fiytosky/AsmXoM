# 0 "../crypto/bn/bn_exp2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_exp2.c"
# 10 "../crypto/bn/bn_exp2.c"
                     ...
                     BN_CTX *ctx, BN_MONT_CTX *in_mont)
{
    ...
    BN_MONT_CTX *mont = 
# 27 "../crypto/bn/bn_exp2.c" 3 4
                       ((void *)0)
# 27 "../crypto/bn/bn_exp2.c"
                           ;
    ...
    if (!BN_is_odd(m)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp2.c",36,__func__), ERR_set_error)((3),(102),
# 36 "../crypto/bn/bn_exp2.c" 3 4
       ((void *)0)
# 36 "../crypto/bn/bn_exp2.c"
       );
        return 0;
    }
    ...
    if (val2[0] == 
# 53 "../crypto/bn/bn_exp2.c" 3 4
                  ((void *)0)
# 53 "../crypto/bn/bn_exp2.c"
                      )
        goto err;

    if (in_mont != 
# 56 "../crypto/bn/bn_exp2.c" 3 4
                  ((void *)0)
# 56 "../crypto/bn/bn_exp2.c"
                      )
        mont = in_mont;
    else {
        if ((mont = BN_MONT_CTX_new()) == 
# 59 "../crypto/bn/bn_exp2.c" 3 4
                                         ((void *)0)
# 59 "../crypto/bn/bn_exp2.c"
                                             )
            goto err;
    ...
    if (a1->neg || BN_ucmp(a1, m) >= 0) {
        if (!BN_div(
# 72 "../crypto/bn/bn_exp2.c" 3 4
            ((void *)0)
# 72 "../crypto/bn/bn_exp2.c"
            ,(val1[0]),(a1),(m),(ctx)))
            goto err;
        a_mod_m = val1[0];
    } else
...
# 91 "../crypto/bn/bn_exp2.c" 3 4
                                               ((void *)0)
# 91 "../crypto/bn/bn_exp2.c"
                                                   ) ||
    ...
    if (a2->neg || BN_ucmp(a2, m) >= 0) {
        if (!BN_div(
# 101 "../crypto/bn/bn_exp2.c" 3 4
            ((void *)0)
# 101 "../crypto/bn/bn_exp2.c"
            ,(val2[0]),(a2),(m),(ctx)))
            goto err;
        a_mod_m = val2[0];
    } else
...
# 119 "../crypto/bn/bn_exp2.c" 3 4
                                               ((void *)0)
# 119 "../crypto/bn/bn_exp2.c"
                                                   ) ||
 ...
 err:
    if (in_mont == 
# 196 "../crypto/bn/bn_exp2.c" 3 4
                  ((void *)0)
# 196 "../crypto/bn/bn_exp2.c"
                      )
