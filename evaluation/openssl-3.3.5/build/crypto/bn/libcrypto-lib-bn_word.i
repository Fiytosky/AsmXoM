# 0 "../crypto/bn/bn_word.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_word.c"
# 10 "../crypto/bn/bn_word.c"
...
unsigned long BN_mod_word(const BIGNUM *a, unsigned long w)
{
    ...
    if (w > ((unsigned long)1 << 32)) {
        BIGNUM *tmp = BN_dup(a);
        if (tmp == 
# 32 "../crypto/bn/bn_word.c" 3 4
                  ((void *)0)
# 32 "../crypto/bn/bn_word.c"
                      )
            return (unsigned long)-1;
    ...
    for (i = a->top - 1; i >= 0; i--) {
        ...
        ret = ((ret << 32) | ((a->d[i] >> 32) & (0xffffffffL))) % w;
...
# 125 "../crypto/bn/bn_word.c" 3 4
                                        ((void *)0)
# 125 "../crypto/bn/bn_word.c"
                                            )
            return 0;
        a->top++;
        a->d[i] = w;
...
int BN_mul_word(BIGNUM *a, unsigned long w)
{
    ...
    if (a->top) {
        if (w == 0)
            ...
            if (ll) {
                if (bn_wexpand(a, a->top + 1) == 
# 193 "../crypto/bn/bn_word.c" 3 4
                                                ((void *)0)
# 193 "../crypto/bn/bn_word.c"
                                                    )
                    return 0;
                a->d[a->top++] = ll;
            }
