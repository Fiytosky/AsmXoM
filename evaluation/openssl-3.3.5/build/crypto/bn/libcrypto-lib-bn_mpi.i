# 0 "../crypto/bn/bn_mpi.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_mpi.c"
# 10 "../crypto/bn/bn_mpi.c"
...
int BN_bn2mpi(const BIGNUM *a, unsigned char *d)
{
    ...
    if (d == 
# 26 "../crypto/bn/bn_mpi.c" 3 4
            ((void *)0)
# 26 "../crypto/bn/bn_mpi.c"
                )
        return (num + 4 + ext);
...
BIGNUM *BN_mpi2bn(const unsigned char *d, int n, BIGNUM *ain)
{
    ...
    int neg = 0;
    BIGNUM *a = 
# 46 "../crypto/bn/bn_mpi.c" 3 4
               ((void *)0)
# 46 "../crypto/bn/bn_mpi.c"
                   ;

    if (n < 4 || (d[0] & 0x80) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_mpi.c",49,__func__), ERR_set_error)((3),(106),
# 49 "../crypto/bn/bn_mpi.c" 3 4
       ((void *)0)
# 49 "../crypto/bn/bn_mpi.c"
       );
        return 
# 50 "../crypto/bn/bn_mpi.c" 3 4
              ((void *)0)
# 50 "../crypto/bn/bn_mpi.c"
                  ;
    }
    len = ((long)d[0] << 24) | ((long)d[1] << 16) | ((int)d[2] << 8) | (int)
        d[3];
    if ((len + 4) != n) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_mpi.c",55,__func__), ERR_set_error)((3),(104),
# 55 "../crypto/bn/bn_mpi.c" 3 4
       ((void *)0)
# 55 "../crypto/bn/bn_mpi.c"
       );
        return 
# 56 "../crypto/bn/bn_mpi.c" 3 4
              ((void *)0)
# 56 "../crypto/bn/bn_mpi.c"
                  ;
    }

    if (ain == 
# 59 "../crypto/bn/bn_mpi.c" 3 4
              ((void *)0)
# 59 "../crypto/bn/bn_mpi.c"
                  )
        a = BN_new();
    else
        a = ain;
    ...
    if (a == 
# 64 "../crypto/bn/bn_mpi.c" 3 4
            ((void *)0)
# 64 "../crypto/bn/bn_mpi.c"
                )
        return 
# 65 "../crypto/bn/bn_mpi.c" 3 4
              ((void *)0)
# 65 "../crypto/bn/bn_mpi.c"
                  ;
...
# 75 "../crypto/bn/bn_mpi.c" 3 4
                                    ((void *)0)
# 75 "../crypto/bn/bn_mpi.c"
                                        ) {
        if (ain == 
# 76 "../crypto/bn/bn_mpi.c" 3 4
                  ((void *)0)
# 76 "../crypto/bn/bn_mpi.c"
                      )
            BN_free(a);
        return 
# 78 "../crypto/bn/bn_mpi.c" 3 4
              ((void *)0)
# 78 "../crypto/bn/bn_mpi.c"
                  ;
    }
    a->neg = neg;
    if (neg) {
