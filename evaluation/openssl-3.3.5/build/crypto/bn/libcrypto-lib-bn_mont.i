# 0 "../crypto/bn/bn_mont.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_mont.c"
# 17 "../crypto/bn/bn_mont.c"
                          ...
                          BN_MONT_CTX *mont, BN_CTX *ctx)
{
    ...
    if (num > 1 && num <= (4096 / 8) && a->top == num && b->top == num) {
        if (bn_wexpand(r, num) == 
# 46 "../crypto/bn/bn_mont.c" 3 4
                                 ((void *)0)
# 46 "../crypto/bn/bn_mont.c"
                                     )
            return 0;
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 62 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 62 "../crypto/bn/bn_mont.c"
                  )
        goto err;
...
# 133 "../crypto/bn/bn_mont.c" 3 4
                              ((void *)0)
# 133 "../crypto/bn/bn_mont.c"
                                  )
        return 0;
    ret->top = nl;
    ret->flags |= 0;
...
BN_MONT_CTX *BN_MONT_CTX_new(void)
{
    ...
    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/bn/bn_mont.c", 232)) == 
# 232 "../crypto/bn/bn_mont.c" 3 4
                                               ((void *)0)
# 232 "../crypto/bn/bn_mont.c"
                                                   )
        return 
# 233 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 233 "../crypto/bn/bn_mont.c"
                  ;
...
{
    if (mont == 
# 252 "../crypto/bn/bn_mont.c" 3 4
               ((void *)0)
# 252 "../crypto/bn/bn_mont.c"
                   )
        return;
    ...
    if (mont->flags & 0x01)
        CRYPTO_free(mont, "../crypto/bn/bn_mont.c", 258);
}
...
# 270 "../crypto/bn/bn_mont.c" 3 4
                                 ((void *)0)
# 270 "../crypto/bn/bn_mont.c"
                                     )
        goto err;
    R = &(mont->RR);
...

    {
        ...
        if (BN_get_flags(mod, 0x04) != 0)
            BN_set_flags(&tmod, 0x04);

        mont->ri = (BN_num_bits(mod) + ((8 * 8) - 1)) / (8 * 8) * (8 * 8);
# 339 "../crypto/bn/bn_mont.c"
        BN_zero_ex(R);
        if (!(BN_set_bit(R, (8 * 8))))
            goto err;
        ...
        if (BN_is_one(&tmod))
            BN_zero_ex(Ri);
        else if ((BN_mod_inverse(Ri, R, &tmod, ctx)) == 
# 349 "../crypto/bn/bn_mont.c" 3 4
                                                       ((void *)0)
# 349 "../crypto/bn/bn_mont.c"
                                                           )
            goto err;
        if (!BN_lshift(Ri, Ri, (8 * 8)))
            goto err;
        if (!BN_is_zero(Ri)) {
            if (!BN_sub_word(Ri, 1))
                goto err;
        ...
        if (!BN_div(Ri, 
# 361 "../crypto/bn/bn_mont.c" 3 4
                       ((void *)0)
# 361 "../crypto/bn/bn_mont.c"
                           , Ri, &tmod, ctx))
            goto err;
...
# 392 "../crypto/bn/bn_mont.c"
    BN_zero_ex(&(mont->RR));
    if (!BN_set_bit(&(mont->RR), mont->ri * 2))
        goto err;
    if (!BN_div(
# 395 "../crypto/bn/bn_mont.c" 3 4
        ((void *)0)
# 395 "../crypto/bn/bn_mont.c"
...
BN_MONT_CTX *BN_MONT_CTX_copy(BN_MONT_CTX *to, BN_MONT_CTX *from)
{
    ...
    if (!BN_copy(&(to->RR), &(from->RR)))
        return 
# 415 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 415 "../crypto/bn/bn_mont.c"
                  ;
    if (!BN_copy(&(to->N), &(from->N)))
        return 
# 417 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 417 "../crypto/bn/bn_mont.c"
                  ;
    if (!BN_copy(&(to->Ni), &(from->Ni)))
        return 
# 419 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 419 "../crypto/bn/bn_mont.c"
                  ;
    to->ri = from->ri;
    to->n0[0] = from->n0[0];
    to->n0[1] = from->n0[1];
                                    ...
                                    const BIGNUM *mod, BN_CTX *ctx)
{
    ...
    if (!CRYPTO_THREAD_read_lock(lock))
        return 
# 432 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 432 "../crypto/bn/bn_mont.c"
                  ;
    ret = *pmont;
    CRYPTO_THREAD_unlock(lock);
    if (ret)
        return ret;
# 446 "../crypto/bn/bn_mont.c"
    ret = BN_MONT_CTX_new();
    if (ret == 
# 447 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 447 "../crypto/bn/bn_mont.c"
                  )
        return 
# 448 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 448 "../crypto/bn/bn_mont.c"
                  ;
    if (!BN_MONT_CTX_set(ret, mod, ctx)) {
        BN_MONT_CTX_free(ret);
        return 
# 451 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 451 "../crypto/bn/bn_mont.c"
                  ;
    }
    ...
    if (!CRYPTO_THREAD_write_lock(lock)) {
        BN_MONT_CTX_free(ret);
        return 
# 457 "../crypto/bn/bn_mont.c" 3 4
              ((void *)0)
# 457 "../crypto/bn/bn_mont.c"
                  ;
    }
