# 0 "../crypto/bn/bn_srp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_srp.c"
# 10 "../crypto/bn/bn_srp.c"
...
# 16 "../crypto/bn/bn_srp.c" 2
# 1 "../include/crypto/bn_srp.h" 1
# 12 "../include/crypto/bn_srp.h"
...
# 17 "../crypto/bn/bn_srp.c" 2
# 32 "../crypto/bn/bn_srp.c"
static const unsigned long bn_group_1024_value[] = {
    ((0x9FC6ULL<<48)|(0x1D2FULL<<32)|(0xC0EBULL<<16)|0x06E3ULL),
    ((0xFD51ULL<<48)|(0x38FEULL<<32)|(0x8376ULL<<16)|0x435BULL),
    ((0x2FD4ULL<<48)|(0xCBF4ULL<<32)|(0x976EULL<<16)|0xAA9AULL),
    ((0x68EDULL<<48)|(0xBC3CULL<<32)|(0x0572ULL<<16)|0x6CC0ULL),
    ((0xC529ULL<<48)|(0xF566ULL<<32)|(0x660EULL<<16)|0x57ECULL),
    ((0x8255ULL<<48)|(0x9B29ULL<<32)|(0x7BCFULL<<16)|0x1885ULL),
    ((0xCE8EULL<<48)|(0xF4ADULL<<32)|(0x69B1ULL<<16)|0x5D49ULL),
    ((0x5DC7ULL<<48)|(0xD7B4ULL<<32)|(0x6154ULL<<16)|0xD6B6ULL),
    ((0x8E49ULL<<48)|(0x5C1DULL<<32)|(0x6089ULL<<16)|0xDAD1ULL),
    ((0xE0D5ULL<<48)|(0xD8E2ULL<<32)|(0x50B9ULL<<16)|0x8BE4ULL),
    ((0x383BULL<<48)|(0x4813ULL<<32)|(0xD692ULL<<16)|0xC6E0ULL),
    ((0xD674ULL<<48)|(0xDF74ULL<<32)|(0x96EAULL<<16)|0x81D3ULL),
    ((0x9EA2ULL<<48)|(0x314CULL<<32)|(0x9C25ULL<<16)|0x6576ULL),
    ((0x6072ULL<<48)|(0x6187ULL<<32)|(0x75FFULL<<16)|0x3C0BULL),
    ((0x9C33ULL<<48)|(0xF80AULL<<32)|(0xFA8FULL<<16)|0xC5E8ULL),
    ((0xEEAFULL<<48)|(0x0AB9ULL<<32)|(0xADB3ULL<<16)|0x8DD6ULL)
};

const BIGNUM ossl_bn_group_1024 = {
    (unsigned long *)bn_group_1024_value,
    (sizeof(bn_group_1024_value)/sizeof((bn_group_1024_value)[0])),
    (sizeof(bn_group_1024_value)/sizeof((bn_group_1024_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_1536_value[] = {
    ((0xCF76ULL<<48)|(0xE3FEULL<<32)|(0xD135ULL<<16)|0xF9BBULL),
    ((0x1518ULL<<48)|(0x0F93ULL<<32)|(0x499AULL<<16)|0x234DULL),
    ((0x8CE7ULL<<48)|(0xA28CULL<<32)|(0x2442ULL<<16)|0xC6F3ULL),
    ((0x5A02ULL<<48)|(0x1FFFULL<<32)|(0x5E91ULL<<16)|0x479EULL),
    ((0x7F8AULL<<48)|(0x2FE9ULL<<32)|(0xB8B5ULL<<16)|0x292EULL),
    ((0x837CULL<<48)|(0x264AULL<<32)|(0xE3A9ULL<<16)|0xBEB8ULL),
    ((0xE442ULL<<48)|(0x734AULL<<32)|(0xF7CCULL<<16)|0xB7AEULL),
    ((0x6577ULL<<48)|(0x2E43ULL<<32)|(0x7D6CULL<<16)|0x7F8CULL),
    ((0xDB2FULL<<48)|(0xD53DULL<<32)|(0x24B7ULL<<16)|0xC486ULL),
    ((0x6EDFULL<<48)|(0x0195ULL<<32)|(0x3934ULL<<16)|0x9627ULL),
    ((0x158BULL<<48)|(0xFD3EULL<<32)|(0x2B9CULL<<16)|0x8CF5ULL),
    ((0x764EULL<<48)|(0x3F4BULL<<32)|(0x53DDULL<<16)|0x9DA1ULL),
    ((0x4754ULL<<48)|(0x8381ULL<<32)|(0xDBC5ULL<<16)|0xB1FCULL),
    ((0x9B60ULL<<48)|(0x9E0BULL<<32)|(0xE3BAULL<<16)|0xB63DULL),
    ((0x8134ULL<<48)|(0xB1C8ULL<<32)|(0xB979ULL<<16)|0x8914ULL),
    ((0xDF02ULL<<48)|(0x8A7CULL<<32)|(0xEC67ULL<<16)|0xF0D0ULL),
    ((0x80B6ULL<<48)|(0x55BBULL<<32)|(0x9A22ULL<<16)|0xE8DCULL),
    ((0x1558ULL<<48)|(0x903BULL<<32)|(0xA0D0ULL<<16)|0xF843ULL),
    ((0x51C6ULL<<48)|(0xA94BULL<<32)|(0xE460ULL<<16)|0x7A29ULL),
    ((0x5F4FULL<<48)|(0x5F55ULL<<32)|(0x6E27ULL<<16)|0xCBDEULL),
    ((0xBEEEULL<<48)|(0xA961ULL<<32)|(0x4B19ULL<<16)|0xCC4DULL),
    ((0xDBA5ULL<<48)|(0x1DF4ULL<<32)|(0x99ACULL<<16)|0x4C80ULL),
    ((0xB1F1ULL<<48)|(0x2A86ULL<<32)|(0x17A4ULL<<16)|0x7BBBULL),
    ((0x9DEFULL<<48)|(0x3CAFULL<<32)|(0xB939ULL<<16)|0x277AULL)
};

const BIGNUM ossl_bn_group_1536 = {
    (unsigned long *)bn_group_1536_value,
    (sizeof(bn_group_1536_value)/sizeof((bn_group_1536_value)[0])),
    (sizeof(bn_group_1536_value)/sizeof((bn_group_1536_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_2048_value[] = {
    ((0x0FA7ULL<<48)|(0x111FULL<<32)|(0x9E4AULL<<16)|0xFF73ULL),
    ((0x9B65ULL<<48)|(0xE372ULL<<32)|(0xFCD6ULL<<16)|0x8EF2ULL),
    ((0x35DEULL<<48)|(0x236DULL<<32)|(0x525FULL<<16)|0x5475ULL),
    ((0x94B5ULL<<48)|(0xC803ULL<<32)|(0xD89FULL<<16)|0x7AE4ULL),
    ((0x71AEULL<<48)|(0x35F8ULL<<32)|(0xE9DBULL<<16)|0xFBB6ULL),
    ((0x2A56ULL<<48)|(0x98F3ULL<<32)|(0xA8D0ULL<<16)|0xC382ULL),
    ((0x9CCCULL<<48)|(0x041CULL<<32)|(0x7BC3ULL<<16)|0x08D8ULL),
    ((0xAF87ULL<<48)|(0x4E73ULL<<32)|(0x03CEULL<<16)|0x5329ULL),
    ((0x6160ULL<<48)|(0x2790ULL<<32)|(0x04E5ULL<<16)|0x7AE6ULL),
    ((0x032CULL<<48)|(0xFBDBULL<<32)|(0xF52FULL<<16)|0xB378ULL),
    ((0x5EA7ULL<<48)|(0x7A27ULL<<32)|(0x75D2ULL<<16)|0xECFAULL),
    ((0x5445ULL<<48)|(0x23B5ULL<<32)|(0x24B0ULL<<16)|0xD57DULL),
    ((0x5B9DULL<<48)|(0x32E6ULL<<32)|(0x88F8ULL<<16)|0x7748ULL),
    ((0xF1D2ULL<<48)|(0xB907ULL<<32)|(0x8717ULL<<16)|0x461AULL),
    ((0x76BDULL<<48)|(0x207AULL<<32)|(0x436CULL<<16)|0x6481ULL),
    ((0xCA97ULL<<48)|(0xB43AULL<<32)|(0x23FBULL<<16)|0x8016ULL),
    ((0x1D28ULL<<48)|(0x1E44ULL<<32)|(0x6B14ULL<<16)|0x773BULL),
    ((0x7359ULL<<48)|(0xD041ULL<<32)|(0xD5C3ULL<<16)|0x3EA7ULL),
    ((0xA80DULL<<48)|(0x740AULL<<32)|(0xDBF4ULL<<16)|0xFF74ULL),
    ((0x55F9ULL<<48)|(0x7993ULL<<32)|(0xEC97ULL<<16)|0x5EEAULL),
    ((0x2918ULL<<48)|(0xA996ULL<<32)|(0x2F0BULL<<16)|0x93B8ULL),
    ((0x661AULL<<48)|(0x05FBULL<<32)|(0xD5FAULL<<16)|0xAAE8ULL),
    ((0xCF60ULL<<48)|(0x9517ULL<<32)|(0x9A16ULL<<16)|0x3AB3ULL),
    ((0xE808ULL<<48)|(0x3969ULL<<32)|(0xEDB7ULL<<16)|0x67B0ULL),
    ((0xCD7FULL<<48)|(0x48A9ULL<<32)|(0xDA04ULL<<16)|0xFD50ULL),
    ((0xD523ULL<<48)|(0x12ABULL<<32)|(0x4B03ULL<<16)|0x310DULL),
    ((0x8193ULL<<48)|(0xE075ULL<<32)|(0x7767ULL<<16)|0xA13DULL),
    ((0xA373ULL<<48)|(0x29CBULL<<32)|(0xB4A0ULL<<16)|0x99EDULL),
    ((0xFC31ULL<<48)|(0x9294ULL<<32)|(0x3DB5ULL<<16)|0x6050ULL),
    ((0xAF72ULL<<48)|(0xB665ULL<<32)|(0x1987ULL<<16)|0xEE07ULL),
    ((0xF166ULL<<48)|(0xDE5EULL<<32)|(0x1389ULL<<16)|0x582FULL),
    ((0xAC6BULL<<48)|(0xDB41ULL<<32)|(0x324AULL<<16)|0x9A9BULL)
};

const BIGNUM ossl_bn_group_2048 = {
    (unsigned long *)bn_group_2048_value,
    (sizeof(bn_group_2048_value)/sizeof((bn_group_2048_value)[0])),
    (sizeof(bn_group_2048_value)/sizeof((bn_group_2048_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_3072_value[] = {
    ((0xFFFFULL<<48)|(0xFFFFULL<<32)|(0xFFFFULL<<16)|0xFFFFULL),
    ((0x4B82ULL<<48)|(0xD120ULL<<32)|(0xA93AULL<<16)|0xD2CAULL),
    ((0x43DBULL<<48)|(0x5BFCULL<<32)|(0xE0FDULL<<16)|0x108EULL),
    ((0x08E2ULL<<48)|(0x4FA0ULL<<32)|(0x74E5ULL<<16)|0xAB31ULL),
    ((0x7709ULL<<48)|(0x88C0ULL<<32)|(0xBAD9ULL<<16)|0x46E2ULL),
    ((0xBBE1ULL<<48)|(0x1757ULL<<32)|(0x7A61ULL<<16)|0x5D6CULL),
    ((0x521FULL<<48)|(0x2B18ULL<<32)|(0x177BULL<<16)|0x200CULL),
    ((0xD876ULL<<48)|(0x0273ULL<<32)|(0x3EC8ULL<<16)|0x6A64ULL),
    ((0xF12FULL<<48)|(0xFA06ULL<<32)|(0xD98AULL<<16)|0x0864ULL),
    ((0xCEE3ULL<<48)|(0xD226ULL<<32)|(0x1AD2ULL<<16)|0xEE6BULL),
    ((0x1E8CULL<<48)|(0x94E0ULL<<32)|(0x4A25ULL<<16)|0x619DULL),
    ((0xABF5ULL<<48)|(0xAE8CULL<<32)|(0xDB09ULL<<16)|0x33D7ULL),
    ((0xB397ULL<<48)|(0x0F85ULL<<32)|(0xA6E1ULL<<16)|0xE4C7ULL),
    ((0x8AEAULL<<48)|(0x7157ULL<<32)|(0x5D06ULL<<16)|0x0C7DULL),
    ((0xECFBULL<<48)|(0x8504ULL<<32)|(0x58DBULL<<16)|0xEF0AULL),
    ((0xA855ULL<<48)|(0x21ABULL<<32)|(0xDF1CULL<<16)|0xBA64ULL),
    ((0xAD33ULL<<48)|(0x170DULL<<32)|(0x0450ULL<<16)|0x7A33ULL),
    ((0x1572ULL<<48)|(0x8E5AULL<<32)|(0x8AAAULL<<16)|0xC42DULL),
    ((0x15D2ULL<<48)|(0x2618ULL<<32)|(0x98FAULL<<16)|0x0510ULL),
    ((0x3995ULL<<48)|(0x497CULL<<32)|(0xEA95ULL<<16)|0x6AE5ULL),
    ((0xDE2BULL<<48)|(0xCBF6ULL<<32)|(0x9558ULL<<16)|0x1718ULL),
    ((0xB5C5ULL<<48)|(0x5DF0ULL<<32)|(0x6F4CULL<<16)|0x52C9ULL),
    ((0x9B27ULL<<48)|(0x83A2ULL<<32)|(0xEC07ULL<<16)|0xA28FULL),
    ((0xE39EULL<<48)|(0x772CULL<<32)|(0x180EULL<<16)|0x8603ULL),
    ((0x3290ULL<<48)|(0x5E46ULL<<32)|(0x2E36ULL<<16)|0xCE3BULL),
    ((0xF174ULL<<48)|(0x6C08ULL<<32)|(0xCA18ULL<<16)|0x217CULL),
    ((0x670CULL<<48)|(0x354EULL<<32)|(0x4ABCULL<<16)|0x9804ULL),
    ((0x9ED5ULL<<48)|(0x2907ULL<<32)|(0x7096ULL<<16)|0x966DULL),
    ((0x1C62ULL<<48)|(0xF356ULL<<32)|(0x2085ULL<<16)|0x52BBULL),
    ((0x8365ULL<<48)|(0x5D23ULL<<32)|(0xDCA3ULL<<16)|0xAD96ULL),
    ((0x6916ULL<<48)|(0x3FA8ULL<<32)|(0xFD24ULL<<16)|0xCF5FULL),
    ((0x98DAULL<<48)|(0x4836ULL<<32)|(0x1C55ULL<<16)|0xD39AULL),
    ((0xC200ULL<<48)|(0x7CB8ULL<<32)|(0xA163ULL<<16)|0xBF05ULL),
    ((0x4928ULL<<48)|(0x6651ULL<<32)|(0xECE4ULL<<16)|0x5B3DULL),
    ((0xAE9FULL<<48)|(0x2411ULL<<32)|(0x7C4BULL<<16)|0x1FE6ULL),
    ((0xEE38ULL<<48)|(0x6BFBULL<<32)|(0x5A89ULL<<16)|0x9FA5ULL),
    ((0x0BFFULL<<48)|(0x5CB6ULL<<32)|(0xF406ULL<<16)|0xB7EDULL),
    ((0xF44CULL<<48)|(0x42E9ULL<<32)|(0xA637ULL<<16)|0xED6BULL),
    ((0xE485ULL<<48)|(0xB576ULL<<32)|(0x625EULL<<16)|0x7EC6ULL),
    ((0x4FE1ULL<<48)|(0x356DULL<<32)|(0x6D51ULL<<16)|0xC245ULL),
    ((0x302BULL<<48)|(0x0A6DULL<<32)|(0xF25FULL<<16)|0x1437ULL),
    ((0xEF95ULL<<48)|(0x19B3ULL<<32)|(0xCD3AULL<<16)|0x431BULL),
    ((0x514AULL<<48)|(0x0879ULL<<32)|(0x8E34ULL<<16)|0x04DDULL),
    ((0x020BULL<<48)|(0xBEA6ULL<<32)|(0x3B13ULL<<16)|0x9B22ULL),
    ((0x2902ULL<<48)|(0x4E08ULL<<32)|(0x8A67ULL<<16)|0xCC74ULL),
    ((0xC4C6ULL<<48)|(0x628BULL<<32)|(0x80DCULL<<16)|0x1CD1ULL),
    ((0xC90FULL<<48)|(0xDAA2ULL<<32)|(0x2168ULL<<16)|0xC234ULL),
    ((0xFFFFULL<<48)|(0xFFFFULL<<32)|(0xFFFFULL<<16)|0xFFFFULL)
};

const BIGNUM ossl_bn_group_3072 = {
    (unsigned long *)bn_group_3072_value,
    (sizeof(bn_group_3072_value)/sizeof((bn_group_3072_value)[0])),
    (sizeof(bn_group_3072_value)/sizeof((bn_group_3072_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_4096_value[] = {
    ((0xFFFFULL<<48)|(0xFFFFULL<<32)|(0xFFFFULL<<16)|0xFFFFULL),
    ((0x4DF4ULL<<48)|(0x35C9ULL<<32)|(0x3406ULL<<16)|0x3199ULL),
    ((0x86FFULL<<48)|(0xB7DCULL<<32)|(0x90A6ULL<<16)|0xC08FULL),
    ((0x93B4ULL<<48)|(0xEA98ULL<<32)|(0x8D8FULL<<16)|0xDDC1ULL),
    ((0xD006ULL<<48)|(0x9127ULL<<32)|(0xD5B0ULL<<16)|0x5AA9ULL),
    ((0xB81BULL<<48)|(0xDD76ULL<<32)|(0x2170ULL<<16)|0x481CULL),
    ((0x1F61ULL<<48)|(0x2970ULL<<32)|(0xCEE2ULL<<16)|0xD7AFULL),
    ((0x233BULL<<48)|(0xA186ULL<<32)|(0x515BULL<<16)|0xE7EDULL),
    ((0x99B2ULL<<48)|(0x964FULL<<32)|(0xA090ULL<<16)|0xC3A2ULL),
    ((0x287CULL<<48)|(0x5947ULL<<32)|(0x4E6BULL<<16)|0xC05DULL),
    ((0x2E8EULL<<48)|(0xFC14ULL<<32)|(0x1FBEULL<<16)|0xCAA6ULL),
    ((0xDBBBULL<<48)|(0xC2DBULL<<32)|(0x04DEULL<<16)|0x8EF9ULL),
    ((0x2583ULL<<48)|(0xE9CAULL<<32)|(0x2AD4ULL<<16)|0x4CE8ULL),
    ((0x1A94ULL<<48)|(0x6834ULL<<32)|(0xB615ULL<<16)|0x0BDAULL),
    ((0x99C3ULL<<48)|(0x2718ULL<<32)|(0x6AF4ULL<<16)|0xE23CULL),
    ((0x8871ULL<<48)|(0x9A10ULL<<32)|(0xBDBAULL<<16)|0x5B26ULL),
    ((0x1A72ULL<<48)|(0x3C12ULL<<32)|(0xA787ULL<<16)|0xE6D7ULL),
    ((0x4B82ULL<<48)|(0xD120ULL<<32)|(0xA921ULL<<16)|0x0801ULL),
    ((0x43DBULL<<48)|(0x5BFCULL<<32)|(0xE0FDULL<<16)|0x108EULL),
    ((0x08E2ULL<<48)|(0x4FA0ULL<<32)|(0x74E5ULL<<16)|0xAB31ULL),
    ((0x7709ULL<<48)|(0x88C0ULL<<32)|(0xBAD9ULL<<16)|0x46E2ULL),
    ((0xBBE1ULL<<48)|(0x1757ULL<<32)|(0x7A61ULL<<16)|0x5D6CULL),
...
const BIGNUM ossl_bn_group_4096 = {
    (unsigned long *)bn_group_4096_value,
    (sizeof(bn_group_4096_value)/sizeof((bn_group_4096_value)[0])),
    (sizeof(bn_group_4096_value)/sizeof((bn_group_4096_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_6144_value[] = {
    ((0xFFFFULL<<48)|(0xFFFFULL<<32)|(0xFFFFULL<<16)|0xFFFFULL),
    ((0xE694ULL<<48)|(0xF91EULL<<32)|(0x6DCCULL<<16)|0x4024ULL),
    ((0x12BFULL<<48)|(0x2D5BULL<<32)|(0x0B74ULL<<16)|0x74D6ULL),
    ((0x043EULL<<48)|(0x8F66ULL<<32)|(0x3F48ULL<<16)|0x60EEULL),
    ((0x387FULL<<48)|(0xE8D7ULL<<32)|(0x6E3CULL<<16)|0x0468ULL),
    ((0xDA56ULL<<48)|(0xC9ECULL<<32)|(0x2EF2ULL<<16)|0x9632ULL),
    ((0xEB19ULL<<48)|(0xCCB1ULL<<32)|(0xA313ULL<<16)|0xD55CULL),
    ((0xF550ULL<<48)|(0xAA3DULL<<32)|(0x8A1FULL<<16)|0xBFF0ULL),
    ((0x06A1ULL<<48)|(0xD58BULL<<32)|(0xB7C5ULL<<16)|0xDA76ULL),
    ((0xA797ULL<<48)|(0x15EEULL<<32)|(0xF29BULL<<16)|0xE328ULL),
    ((0x14CCULL<<48)|(0x5ED2ULL<<32)|(0x0F80ULL<<16)|0x37E0ULL),
    ((0xCC8FULL<<48)|(0x6D7EULL<<32)|(0xBF48ULL<<16)|0xE1D8ULL),
    ((0x4BD4ULL<<48)|(0x07B2ULL<<32)|(0x2B41ULL<<16)|0x54AAULL),
    ((0x0F1DULL<<48)|(0x45B7ULL<<32)|(0xFF58ULL<<16)|0x5AC5ULL),
    ((0x23A9ULL<<48)|(0x7A7EULL<<32)|(0x36CCULL<<16)|0x88BEULL),
    ((0x59E7ULL<<48)|(0xC97FULL<<32)|(0xBEC7ULL<<16)|0xE8F3ULL),
    ((0xB5A8ULL<<48)|(0x4031ULL<<32)|(0x900BULL<<16)|0x1C9EULL),
    ((0xD55EULL<<48)|(0x702FULL<<32)|(0x4698ULL<<16)|0x0C82ULL),
    ((0xF482ULL<<48)|(0xD7CEULL<<32)|(0x6E74ULL<<16)|0xFEF6ULL),
    ((0xF032ULL<<48)|(0xEA15ULL<<32)|(0xD172ULL<<16)|0x1D03ULL),
    ((0x5983ULL<<48)|(0xCA01ULL<<32)|(0xC64BULL<<16)|0x92ECULL),
    ((0x6FB8ULL<<48)|(0xF401ULL<<32)|(0x378CULL<<16)|0xD2BFULL),
    ((0x3320ULL<<48)|(0x5151ULL<<32)|(0x2BD7ULL<<16)|0xAF42ULL),
    ((0xDB7FULL<<48)|(0x1447ULL<<32)|(0xE6CCULL<<16)|0x254BULL),
    ((0x44CEULL<<48)|(0x6CBAULL<<32)|(0xCED4ULL<<16)|0xBB1BULL),
    ((0xDA3EULL<<48)|(0xDBEBULL<<32)|(0xCF9BULL<<16)|0x14EDULL),
    ((0x1797ULL<<48)|(0x27B0ULL<<32)|(0x865AULL<<16)|0x8918ULL),
    ((0xB06AULL<<48)|(0x53EDULL<<32)|(0x9027ULL<<16)|0xD831ULL),
    ((0xE5DBULL<<48)|(0x382FULL<<32)|(0x4130ULL<<16)|0x01AEULL),
    ((0xF8FFULL<<48)|(0x9406ULL<<32)|(0xAD9EULL<<16)|0x530EULL),
    ((0xC975ULL<<48)|(0x1E76ULL<<32)|(0x3DBAULL<<16)|0x37BDULL),
    ((0xC1D4ULL<<48)|(0xDCB2ULL<<32)|(0x6026ULL<<16)|0x46DEULL),
    ((0x36C3ULL<<48)|(0xFAB4ULL<<32)|(0xD27CULL<<16)|0x7026ULL),
    ((0x4DF4ULL<<48)|(0x35C9ULL<<32)|(0x3402ULL<<16)|0x8492ULL),
    ((0x86FFULL<<48)|(0xB7DCULL<<32)|(0x90A6ULL<<16)|0xC08FULL),
    ((0x93B4ULL<<48)|(0xEA98ULL<<32)|(0x8D8FULL<<16)|0xDDC1ULL),
    ((0xD006ULL<<48)|(0x9127ULL<<32)|(0xD5B0ULL<<16)|0x5AA9ULL),
    ((0xB81BULL<<48)|(0xDD76ULL<<32)|(0x2170ULL<<16)|0x481CULL),
...
const BIGNUM ossl_bn_group_6144 = {
    (unsigned long *)bn_group_6144_value,
    (sizeof(bn_group_6144_value)/sizeof((bn_group_6144_value)[0])),
    (sizeof(bn_group_6144_value)/sizeof((bn_group_6144_value)[0])),
    0,
    0x02
};

static const unsigned long bn_group_8192_value[] = {
    ((0xFFFFULL<<48)|(0xFFFFULL<<32)|(0xFFFFULL<<16)|0xFFFFULL),
    ((0x60C9ULL<<48)|(0x80DDULL<<32)|(0x98EDULL<<16)|0xD3DFULL),
    ((0xC81FULL<<48)|(0x56E8ULL<<32)|(0x80B9ULL<<16)|0x6E71ULL),
    ((0x9E30ULL<<48)|(0x50E2ULL<<32)|(0x7656ULL<<16)|0x94DFULL),
    ((0x9558ULL<<48)|(0xE447ULL<<32)|(0x5677ULL<<16)|0xE9AAULL),
    ((0xC919ULL<<48)|(0x0DA6ULL<<32)|(0xFC02ULL<<16)|0x6E47ULL),
    ((0x889AULL<<48)|(0x002EULL<<32)|(0xD5EEULL<<16)|0x382BULL),
    ((0x4009ULL<<48)|(0x438BULL<<32)|(0x481CULL<<16)|0x6CD7ULL),
    ((0x3590ULL<<48)|(0x46F4ULL<<32)|(0xEB87ULL<<16)|0x9F92ULL),
    ((0xFAF3ULL<<48)|(0x6BC3ULL<<32)|(0x1ECFULL<<16)|0xA268ULL),
    ((0xB1D5ULL<<48)|(0x10BDULL<<32)|(0x7EE7ULL<<16)|0x4D73ULL),
    ((0xF9ABULL<<48)|(0x4819ULL<<32)|(0x5DEDULL<<16)|0x7EA1ULL),
    ((0x64F3ULL<<48)|(0x1CC5ULL<<32)|(0x0846ULL<<16)|0x851DULL),
    ((0x4597ULL<<48)|(0xE899ULL<<32)|(0xA025ULL<<16)|0x5DC1ULL),
    ((0xDF31ULL<<48)|(0x0EE0ULL<<32)|(0x74ABULL<<16)|0x6A36ULL),
    ((0x6D2AULL<<48)|(0x13F8ULL<<32)|(0x3F44ULL<<16)|0xF82DULL),
    ((0x062BULL<<48)|(0x3CF5ULL<<32)|(0xB3A2ULL<<16)|0x78A6ULL),
    ((0x7968ULL<<48)|(0x3303ULL<<32)|(0xED5BULL<<16)|0xDD3AULL),
    ((0xFA9DULL<<48)|(0x4B7FULL<<32)|(0xA2C0ULL<<16)|0x87E8ULL),
    ((0x4BCBULL<<48)|(0xC886ULL<<32)|(0x2F83ULL<<16)|0x85DDULL),
    ((0x3473ULL<<48)|(0xFC64ULL<<32)|(0x6CEAULL<<16)|0x306BULL),
    ((0x13EBULL<<48)|(0x57A8ULL<<32)|(0x1A23ULL<<16)|0xF0C7ULL),
    ((0x2222ULL<<48)|(0x2E04ULL<<32)|(0xA403ULL<<16)|0x7C07ULL),
    ((0xE3FDULL<<48)|(0xB8BEULL<<32)|(0xFC84ULL<<16)|0x8AD9ULL),
    ((0x238FULL<<48)|(0x16CBULL<<32)|(0xE39DULL<<16)|0x652DULL),
    ((0x3423ULL<<48)|(0xB474ULL<<32)|(0x2BF1ULL<<16)|0xC978ULL),
    ((0x3AABULL<<48)|(0x639CULL<<32)|(0x5AE4ULL<<16)|0xF568ULL),
    ((0x2576ULL<<48)|(0xF693ULL<<32)|(0x6BA4ULL<<16)|0x2466ULL),
    ((0x741FULL<<48)|(0xA7BFULL<<32)|(0x8AFCULL<<16)|0x47EDULL),
    ((0x3BC8ULL<<48)|(0x32B6ULL<<32)|(0x8D9DULL<<16)|0xD300ULL),
    ((0xD8BEULL<<48)|(0xC4D0ULL<<32)|(0x73B9ULL<<16)|0x31BAULL),
    ((0x3877ULL<<48)|(0x7CB6ULL<<32)|(0xA932ULL<<16)|0xDF8CULL),
    ((0x74A3ULL<<48)|(0x926FULL<<32)|(0x12FEULL<<16)|0xE5E4ULL),
    ((0xE694ULL<<48)|(0xF91EULL<<32)|(0x6DBEULL<<16)|0x1159ULL),
    ((0x12BFULL<<48)|(0x2D5BULL<<32)|(0x0B74ULL<<16)|0x74D6ULL),
    ((0x043EULL<<48)|(0x8F66ULL<<32)|(0x3F48ULL<<16)|0x60EEULL),
    ((0x387FULL<<48)|(0xE8D7ULL<<32)|(0x6E3CULL<<16)|0x0468ULL),
    ((0xDA56ULL<<48)|(0xC9ECULL<<32)|(0x2EF2ULL<<16)|0x9632ULL),
...
const BIGNUM ossl_bn_group_8192 = {
    (unsigned long *)bn_group_8192_value,
    (sizeof(bn_group_8192_value)/sizeof((bn_group_8192_value)[0])),
    (sizeof(bn_group_8192_value)/sizeof((bn_group_8192_value)[0])),
    0,
    0x02
};

static const unsigned long bn_generator_19_value[] = { 19 };

const BIGNUM ossl_bn_generator_19 = {
    (unsigned long *)bn_generator_19_value,
    1,
    1,
    0,
    0x02
};
static const unsigned long bn_generator_5_value[] = { 5 };

const BIGNUM ossl_bn_generator_5 = {
    (unsigned long *)bn_generator_5_value,
    1,
    1,
    0,
    0x02
};
static const unsigned long bn_generator_2_value[] = { 2 };

const BIGNUM ossl_bn_generator_2 = {
    (unsigned long *)bn_generator_2_value,
    1,
    1,
    0,
    0x02
