# 0 "../crypto/bn/bn_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_lib.c"
# 10 "../crypto/bn/bn_lib.c"
...
# 17 "../crypto/bn/bn_lib.c" 2
# 30 "../crypto/bn/bn_lib.c"
...
# 193 "../crypto/bn/bn_lib.c"
    ...
    return ((i * (8 * 8)) + BN_num_bits_word(a->d[i]));
}

static void bn_free_d(BIGNUM *a, int clear)
{
    if (BN_get_flags(a, 0x08))
        CRYPTO_secure_clear_free(a->d, a->dmax * sizeof(a->d[0]), "../crypto/bn/bn_lib.c", 205);
    else if (clear != 0)
        CRYPTO_clear_free(a->d, a->dmax * sizeof(a->d[0]), "../crypto/bn/bn_lib.c", 207);
    else
        CRYPTO_free(a->d, "../crypto/bn/bn_lib.c", 209);
}
...
{
    if (a == 
# 215 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 215 "../crypto/bn/bn_lib.c"
                )
        return;
    if (a->d != 
# 217 "../crypto/bn/bn_lib.c" 3 4
               ((void *)0) 
# 217 "../crypto/bn/bn_lib.c"
                    && !BN_get_flags(a, 0x02))
        bn_free_d(a, 1);
    if (BN_get_flags(a, 0x01)) {
        OPENSSL_cleanse(a, sizeof(*a));
        CRYPTO_free(a, "../crypto/bn/bn_lib.c", 221);
    }
}
...
{
    if (a == 
# 227 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 227 "../crypto/bn/bn_lib.c"
                )
        return;
    if (!BN_get_flags(a, 0x02))
        bn_free_d(a, 0);
    if (a->flags & 0x01)
        CRYPTO_free(a, "../crypto/bn/bn_lib.c", 232);
}
...
BIGNUM *BN_new(void)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bn/bn_lib.c", 247)) == 
# 247 "../crypto/bn/bn_lib.c" 3 4
                                               ((void *)0)
# 247 "../crypto/bn/bn_lib.c"
                                                   )
        return 
# 248 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 248 "../crypto/bn/bn_lib.c"
                  ;
    ret->flags = 0x01;
    ;
    return ret;
 ...
 BIGNUM *BN_secure_new(void)
 {
     BIGNUM *ret = BN_new();
     if (ret != 
# 257 "../crypto/bn/bn_lib.c" 3 4
               ((void *)0)
# 257 "../crypto/bn/bn_lib.c"
                   )
         ret->flags |= 0x08;
     return ret;
 }
...
static unsigned long *bn_expand_internal(const BIGNUM *b, int words)
{
    unsigned long *a = 
# 266 "../crypto/bn/bn_lib.c" 3 4
                 ((void *)0)
# 266 "../crypto/bn/bn_lib.c"
                     ;

    if (words > (0x7fffffff 
# 268 "../crypto/bn/bn_lib.c"
                        / (4 * (8 * 8)))) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_lib.c",269,__func__), ERR_set_error)((3),(114),
# 269 "../crypto/bn/bn_lib.c" 3 4
       ((void *)0)
# 269 "../crypto/bn/bn_lib.c"
       );
        return 
# 270 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 270 "../crypto/bn/bn_lib.c"
                  ;
    }
    if (BN_get_flags(b, 0x02)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_lib.c",273,__func__), ERR_set_error)((3),(105),
# 273 "../crypto/bn/bn_lib.c" 3 4
       ((void *)0)
# 273 "../crypto/bn/bn_lib.c"
       );
        return 
# 274 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 274 "../crypto/bn/bn_lib.c"
                  ;
    }
    if (BN_get_flags(b, 0x08))
        a = CRYPTO_secure_zalloc(words * sizeof(*a), "../crypto/bn/bn_lib.c", 277);
    else
        a = CRYPTO_zalloc(words * sizeof(*a), "../crypto/bn/bn_lib.c", 279);
    if (a == 
# 280 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 280 "../crypto/bn/bn_lib.c"
                )
        return 
# 281 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 281 "../crypto/bn/bn_lib.c"
                  ;

    
# 283 "../crypto/bn/bn_lib.c" 3 4
   ((void) (0))
# 283 "../crypto/bn/bn_lib.c"
                          ;
    if (b->top > 0)
...
BIGNUM *bn_expand2(BIGNUM *b, int words)
{
    if (words > b->dmax) {
        ...
        if (!a)
            return 
# 303 "../crypto/bn/bn_lib.c" 3 4
                  ((void *)0)
# 303 "../crypto/bn/bn_lib.c"
                      ;
        if (b->d != 
# 304 "../crypto/bn/bn_lib.c" 3 4
                   ((void *)0)
# 304 "../crypto/bn/bn_lib.c"
                       )
            bn_free_d(b, 1);
        b->d = a;
        b->dmax = words;
...
BIGNUM *BN_dup(const BIGNUM *a)
{
    ...
    if (a == 
# 317 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 317 "../crypto/bn/bn_lib.c"
                )
        return 
# 318 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 318 "../crypto/bn/bn_lib.c"
                  ;
    ;

    t = BN_get_flags(a, 0x08) ? BN_secure_new() : BN_new();
    if (t == 
# 322 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 322 "../crypto/bn/bn_lib.c"
                )
        return 
# 323 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 323 "../crypto/bn/bn_lib.c"
                  ;
    if (!BN_copy(t, a)) {
        BN_free(t);
        return 
# 326 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 326 "../crypto/bn/bn_lib.c"
                  ;
    }
    ;
    return t;
...
BIGNUM *BN_copy(BIGNUM *a, const BIGNUM *b)
{
    ...
    bn_words = BN_get_flags(b, 0x04) ? b->dmax : b->top;

    if (a == b)
        return a;
    if (bn_wexpand(a, bn_words) == 
# 342 "../crypto/bn/bn_lib.c" 3 4
                                  ((void *)0)
# 342 "../crypto/bn/bn_lib.c"
                                      )
        return 
# 343 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 343 "../crypto/bn/bn_lib.c"
                  ;
...
void BN_swap(BIGNUM *a, BIGNUM *b)
{
    ...
    a->flags = ((flags_old_a) & (0x01)) | ((flags_old_b) & (0x02 | 0x04 | 0x08 | 0));
    b->flags = ((flags_old_b) & (0x01)) | ((flags_old_a) & (0x02 | 0x04 | 0x08 | 0));
    ;
    ;
}
...
{
    if (a == 
# 396 "../crypto/bn/bn_lib.c" 3 4
            ((void *)0)
# 396 "../crypto/bn/bn_lib.c"
                )
        return;
    ;
    if (a->d != 
# 399 "../crypto/bn/bn_lib.c" 3 4
               ((void *)0)
# 399 "../crypto/bn/bn_lib.c"
                   )
...
# 419 "../crypto/bn/bn_lib.c" 3 4
                                                  ((void *)0)
# 419 "../crypto/bn/bn_lib.c"
                                                      )
        return 0;
    a->neg = 0;
    a->d[0] = w;
                      ...
                      endianness_t endianness, signedness_t signedness)
{
    ...
    unsigned int n;
    BIGNUM *bn = 
# 441 "../crypto/bn/bn_lib.c" 3 4
                ((void *)0)
# 441 "../crypto/bn/bn_lib.c"
                    ;


    if (len < 0)
        return 
# 445 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 445 "../crypto/bn/bn_lib.c"
                  ;

    if (ret == 
# 447 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 447 "../crypto/bn/bn_lib.c"
                  )
        ret = bn = BN_new();
    if (ret == 
# 449 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 449 "../crypto/bn/bn_lib.c"
                  )
        return 
# 450 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 450 "../crypto/bn/bn_lib.c"
                  ;
    ;
    ...
    n = ((len - 1) / 8) + 1;
    if (bn_wexpand(ret, (int)n) == 
# 507 "../crypto/bn/bn_lib.c" 3 4
                                  ((void *)0)
# 507 "../crypto/bn/bn_lib.c"
                                      ) {
        BN_free(bn);
        return 
# 509 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 509 "../crypto/bn/bn_lib.c"
                  ;
    }
    ret->top = n;
    ret->neg = neg;
    for (i = 0; n-- > 0; i++) {
        ...
        for (; len > 0 && m < 8 * 8; len--, s += inc, m += 8) {
            ...
            unsigned long byte = (byte_xored + carry) & 0xff;
...
int BN_cmp(const BIGNUM *a, const BIGNUM *b)
{
    ...
    if ((a == 
# 749 "../crypto/bn/bn_lib.c" 3 4
             ((void *)0)
# 749 "../crypto/bn/bn_lib.c"
                 ) || (b == 
# 749 "../crypto/bn/bn_lib.c" 3 4
                            ((void *)0)
# 749 "../crypto/bn/bn_lib.c"
        ...
        if (a != 
# 750 "../crypto/bn/bn_lib.c" 3 4
                ((void *)0)
# 750 "../crypto/bn/bn_lib.c"
                    )
            return -1;
        else if (b != 
# 752 "../crypto/bn/bn_lib.c" 3 4
                     ((void *)0)
# 752 "../crypto/bn/bn_lib.c"
                         )
            return 1;
        else
            return 0;
...
int BN_set_bit(BIGNUM *a, int n)
{
    ...
    if (a->top <= i) {
        if (bn_wexpand(a, i + 1) == 
# 800 "../crypto/bn/bn_lib.c" 3 4
                                   ((void *)0)
# 800 "../crypto/bn/bn_lib.c"
                                       )
            return 0;
        for (k = a->top; k < i + 1; k++)
            a->d[k] = 0;
...
# 942 "../crypto/bn/bn_lib.c"
void BN_consttime_swap(unsigned long condition, BIGNUM *a, BIGNUM *b, int nwords)
{
    unsigned long t;
    int i;
    ...
    condition = ((~condition & ((condition - 1))) >> ((8 * 8) - 1)) - 1;
    ...
    a->neg ^= t;
    b->neg ^= t;
# 984 "../crypto/bn/bn_lib.c"
    t = ((a->flags ^ b->flags) & (0x04 | 0)) & condition;
    a->flags ^= t;
    b->flags ^= t;
...
BN_GENCB *BN_GENCB_new(void)
{
    ...
    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/bn/bn_lib.c", 1097)) == 
# 1097 "../crypto/bn/bn_lib.c" 3 4
                                               ((void *)0)
# 1097 "../crypto/bn/bn_lib.c"
                                                   )
        return 
# 1098 "../crypto/bn/bn_lib.c" 3 4
              ((void *)0)
# 1098 "../crypto/bn/bn_lib.c"
                  ;
...
{
    if (cb == 
# 1105 "../crypto/bn/bn_lib.c" 3 4
             ((void *)0)
# 1105 "../crypto/bn/bn_lib.c"
                 )
        return;
    CRYPTO_free(cb, "../crypto/bn/bn_lib.c", 1107);
}
