# 0 "../crypto/bn/bn_depr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_depr.c"
# 15 "../crypto/bn/bn_depr.c"
                          ...
                          void (*callback) (int, int, void *), void *cb_arg)
{
    BN_GENCB cb;
    BIGNUM *rnd = 
# 27 "../crypto/bn/bn_depr.c" 3 4
                 ((void *)0)
# 27 "../crypto/bn/bn_depr.c"
                     ;

    BN_GENCB_set_old(&cb, callback, cb_arg);

    if (ret == 
# 31 "../crypto/bn/bn_depr.c" 3 4
              ((void *)0)
# 31 "../crypto/bn/bn_depr.c"
                  ) {
        if ((rnd = BN_new()) == 
# 32 "../crypto/bn/bn_depr.c" 3 4
                               ((void *)0)
# 32 "../crypto/bn/bn_depr.c"
                                   )
            goto err;
    } else
        rnd = ret;
 ...
 err:
    BN_free(rnd);
    return 
# 43 "../crypto/bn/bn_depr.c" 3 4
          ((void *)0)
# 43 "../crypto/bn/bn_depr.c"
              ;
}
