# 0 "../crypto/bn/bn_shift.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_shift.c"
# 10 "../crypto/bn/bn_shift.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 13 "../crypto/bn/bn_shift.c" 2

int BN_lshift1(BIGNUM *r, const BIGNUM *a)
{
    register unsigned long *ap, *rp, t, c;
    int i;
...
# 24 "../crypto/bn/bn_shift.c" 3 4
                                        ((void *)0)
# 24 "../crypto/bn/bn_shift.c"
                                            )
            return 0;
        r->top = a->top;
    } else {
        if (bn_wexpand(r, a->top + 1) == 
# 28 "../crypto/bn/bn_shift.c" 3 4
                                        ((void *)0)
# 28 "../crypto/bn/bn_shift.c"
                                            )
            return 0;
    }
    ap = a->d;
...
int BN_rshift1(BIGNUM *r, const BIGNUM *a)
{
    ...
    if (a != r) {
        if (bn_wexpand(r, i) == 
# 60 "../crypto/bn/bn_shift.c" 3 4
                               ((void *)0)
# 60 "../crypto/bn/bn_shift.c"
                                   )
            return 0;
        r->neg = a->neg;
    }
...
int BN_lshift(BIGNUM *r, const BIGNUM *a, int n)
{
    ...
    if (n < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_shift.c",86,__func__), ERR_set_error)((3),(119),
# 86 "../crypto/bn/bn_shift.c" 3 4
       ((void *)0)
# 86 "../crypto/bn/bn_shift.c"
       );
        return 0;
    }
...
int bn_lshift_fixed_top(BIGNUM *r, const BIGNUM *a, int n)
{
    ...
    unsigned int lb, rb;
    unsigned long *t, *f;
    unsigned long l, m, rmask = 0;

    
# 111 "../crypto/bn/bn_shift.c" 3 4
   ((void) (0))
# 111 "../crypto/bn/bn_shift.c"
                 ;
...
# 117 "../crypto/bn/bn_shift.c" 3 4
                                         ((void *)0)
# 117 "../crypto/bn/bn_shift.c"
                                             )
        return 0;

    if (a->top != 0) {
        lb = (unsigned int)n % (8 * 8);
        rb = (8 * 8) - lb;
        rb %= (8 * 8);
        rmask = (unsigned long)0 - rb;
        rmask |= rmask >> 8;
        f = &(a->d[0]);
        t = &(r->d[nw]);
        l = f[a->top - 1];
        ...
        for (i = a->top - 1; i > 0; i--) {
            m = l << lb;
            l = f[i - 1];
            t[i] = (m | ((l >> rb) & rmask)) & (0xffffffffffffffffL);
        }
        t[0] = (l << lb) & (0xffffffffffffffffL);
    } else {
...
int BN_rshift(BIGNUM *r, const BIGNUM *a, int n)
{
    ...
    if (n < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_shift.c",155,__func__), ERR_set_error)((3),(119),
# 155 "../crypto/bn/bn_shift.c" 3 4
       ((void *)0)
# 155 "../crypto/bn/bn_shift.c"
       );
        return 0;
    }
...
int bn_rshift_fixed_top(BIGNUM *r, const BIGNUM *a, int n)
{
    ...
    unsigned int lb, rb;
    unsigned long *t, *f;
    unsigned long l, m, mask;

    
# 183 "../crypto/bn/bn_shift.c" 3 4
   ((void) (0))
# 183 "../crypto/bn/bn_shift.c"
                 ;
    ...
    rb = (unsigned int)n % (8 * 8);
    lb = (8 * 8) - rb;
    lb %= (8 * 8);
    mask = (unsigned long)0 - lb;
    mask |= mask >> 8;
    top = a->top - nw;
    if (r != a && bn_wexpand(r, top) == 
# 198 "../crypto/bn/bn_shift.c" 3 4
                                       ((void *)0)
# 198 "../crypto/bn/bn_shift.c"
                                           )
        return 0;
