# 0 "../crypto/bn/bn_gcd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_gcd.c"
# 10 "../crypto/bn/bn_gcd.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 12 "../crypto/bn/bn_gcd.c" 2
# 20 "../crypto/bn/bn_gcd.c"
static inline
...
# 25 "../crypto/bn/bn_gcd.c" 3 4
                                           ((void *)0)
# 25 "../crypto/bn/bn_gcd.c"
                                               ;
    BIGNUM *ret = 
# 26 "../crypto/bn/bn_gcd.c" 3 4
                 ((void *)0)
# 26 "../crypto/bn/bn_gcd.c"
                     ;
    int sign;
    ...
    T = BN_CTX_get(ctx);
    if (T == 
# 40 "../crypto/bn/bn_gcd.c" 3 4
            ((void *)0)
# 40 "../crypto/bn/bn_gcd.c"
                )
        goto err;

    if (in == 
# 43 "../crypto/bn/bn_gcd.c" 3 4
             ((void *)0)
# 43 "../crypto/bn/bn_gcd.c"
                 )
        R = BN_new();
    else
        R = in;
    if (R == 
# 47 "../crypto/bn/bn_gcd.c" 3 4
            ((void *)0)
# 47 "../crypto/bn/bn_gcd.c"
                )
        goto err;
    ...
    BN_zero_ex(Y);
    if (BN_copy(B, a) == 
# 53 "../crypto/bn/bn_gcd.c" 3 4
                        ((void *)0)
# 53 "../crypto/bn/bn_gcd.c"
                            )
        goto err;
    if (BN_copy(A, n) == 
# 55 "../crypto/bn/bn_gcd.c" 3 4
                        ((void *)0)
# 55 "../crypto/bn/bn_gcd.c"
                            )
        goto err;
    A->neg = 0;
...
# 82 "../crypto/bn/bn_gcd.c"
    while (!BN_is_zero(B)) {
        BIGNUM *tmp;
# 95 "../crypto/bn/bn_gcd.c"
        {
            BIGNUM local_A;
            bn_init(&local_A);
            BN_with_flags(&local_A, A, 0x04);
...
# 161 "../crypto/bn/bn_gcd.c"
 ...
 err:
    if ((ret == 
# 186 "../crypto/bn/bn_gcd.c" 3 4
               ((void *)0)
# 186 "../crypto/bn/bn_gcd.c"
                   ) && (in == 
# 186 "../crypto/bn/bn_gcd.c" 3 4
                               ((void *)0)
# 186 "../crypto/bn/bn_gcd.c"
...
{
    BIGNUM *A, *B, *X, *Y, *M, *D, *T, *R = 
# 201 "../crypto/bn/bn_gcd.c" 3 4
                                           ((void *)0)
# 201 "../crypto/bn/bn_gcd.c"
                                               ;
    BIGNUM *ret = 
# 202 "../crypto/bn/bn_gcd.c" 3 4
                 ((void *)0)
# 202 "../crypto/bn/bn_gcd.c"
                     ;
    int sign;
    ...
    if (BN_abs_is_word(n, 1) || BN_is_zero(n)) {
        *pnoinv = 1;
        return 
# 208 "../crypto/bn/bn_gcd.c" 3 4
              ((void *)0)
# 208 "../crypto/bn/bn_gcd.c"
                  ;
    }

    *pnoinv = 0;

    if ((BN_get_flags(a, 0x04) != 0)
    ...
    T = BN_CTX_get(ctx);
    if (T == 
# 229 "../crypto/bn/bn_gcd.c" 3 4
            ((void *)0)
# 229 "../crypto/bn/bn_gcd.c"
                )
        goto err;

    if (in == 
# 232 "../crypto/bn/bn_gcd.c" 3 4
             ((void *)0)
# 232 "../crypto/bn/bn_gcd.c"
                 )
        R = BN_new();
    else
        R = in;
    if (R == 
# 236 "../crypto/bn/bn_gcd.c" 3 4
            ((void *)0)
# 236 "../crypto/bn/bn_gcd.c"
                )
        goto err;
    ...
    BN_zero_ex(Y);
    if (BN_copy(B, a) == 
# 242 "../crypto/bn/bn_gcd.c" 3 4
                        ((void *)0)
# 242 "../crypto/bn/bn_gcd.c"
                            )
        goto err;
    if (BN_copy(A, n) == 
# 244 "../crypto/bn/bn_gcd.c" 3 4
                        ((void *)0)
# 244 "../crypto/bn/bn_gcd.c"
                            )
        goto err;
    A->neg = 0;
    if (B->neg || (BN_ucmp(B, A) >= 0)) {
...
# 418 "../crypto/bn/bn_gcd.c"
            tmp = A;


            A = B;
            B = M;
# 448 "../crypto/bn/bn_gcd.c"
            if (BN_is_one(D)) {
                if (!BN_add(tmp, X, Y))
                    goto err;
            } else {
...
# 486 "../crypto/bn/bn_gcd.c"
 ...
 err:
    if ((ret == 
# 507 "../crypto/bn/bn_gcd.c" 3 4
               ((void *)0)
# 507 "../crypto/bn/bn_gcd.c"
                   ) && (in == 
# 507 "../crypto/bn/bn_gcd.c" 3 4
                               ((void *)0)
# 507 "../crypto/bn/bn_gcd.c"
...
{
    BN_CTX *new_ctx = 
# 518 "../crypto/bn/bn_gcd.c" 3 4
                     ((void *)0)
# 518 "../crypto/bn/bn_gcd.c"
                         ;
    BIGNUM *rv;
    int noinv = 0;

    if (ctx == 
# 522 "../crypto/bn/bn_gcd.c" 3 4
              ((void *)0)
# 522 "../crypto/bn/bn_gcd.c"
                  ) {
        ctx = new_ctx = BN_CTX_new_ex(
# 523 "../crypto/bn/bn_gcd.c" 3 4
                                     ((void *)0)
# 523 "../crypto/bn/bn_gcd.c"
                                         );
        if (ctx == 
# 524 "../crypto/bn/bn_gcd.c" 3 4
                  ((void *)0)
# 524 "../crypto/bn/bn_gcd.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_gcd.c",525,__func__), ERR_set_error)((3),((3 | (0x2 << 18L))),
# 525 "../crypto/bn/bn_gcd.c" 3 4
           ((void *)0)
# 525 "../crypto/bn/bn_gcd.c"
           );
            return 
# 526 "../crypto/bn/bn_gcd.c" 3 4
                  ((void *)0)
# 526 "../crypto/bn/bn_gcd.c"
                      ;
        }
    }
    ...
    if (noinv)
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gcd.c",532,__func__), ERR_set_error)((3),(108),
# 532 "../crypto/bn/bn_gcd.c" 3 4
       ((void *)0)
# 532 "../crypto/bn/bn_gcd.c"
       );
    BN_CTX_free(new_ctx);
    return rv;
}
# 548 "../crypto/bn/bn_gcd.c"
int BN_are_coprime(BIGNUM *a, const BIGNUM *b, BN_CTX *ctx)
{
    int ret = 0;
    BIGNUM *tmp;
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 555 "../crypto/bn/bn_gcd.c" 3 4
              ((void *)0)
# 555 "../crypto/bn/bn_gcd.c"
                  )
        goto end;

    ERR_set_mark();
    BN_set_flags(a, 0x04);
    ret = (BN_mod_inverse(tmp, a, b, ctx) != 
# 560 "../crypto/bn/bn_gcd.c" 3 4
                                            ((void *)0)
# 560 "../crypto/bn/bn_gcd.c"
                                                );
...
# 580 "../crypto/bn/bn_gcd.c"
int BN_gcd(BIGNUM *r, const BIGNUM *in_a, const BIGNUM *in_b, BN_CTX *ctx)
{
    BIGNUM *g, *temp = 
# 582 "../crypto/bn/bn_gcd.c" 3 4
                      ((void *)0)
# 582 "../crypto/bn/bn_gcd.c"
                          ;
    ...
    if (BN_is_zero(in_b)) {
        ret = BN_copy(r, in_a) != 
# 590 "../crypto/bn/bn_gcd.c" 3 4
                                 ((void *)0)
# 590 "../crypto/bn/bn_gcd.c"
                                     ;
        r->neg = 0;
        return ret;
    }
    if (BN_is_zero(in_a)) {
        ret = BN_copy(r, in_b) != 
# 595 "../crypto/bn/bn_gcd.c" 3 4
                                 ((void *)0)
# 595 "../crypto/bn/bn_gcd.c"
                                     ;
        r->neg = 0;
        return ret;
    }
    ...
    if (g == 
# 608 "../crypto/bn/bn_gcd.c" 3 4
            ((void *)0)
        
# 609 "../crypto/bn/bn_gcd.c"
       || !BN_lshift1(g, in_b)
        || !BN_lshift1(r, in_a))
        goto err;
    ...
    if (bn_wexpand(r, top) == 
# 630 "../crypto/bn/bn_gcd.c" 3 4
                             ((void *)0)
        
# 631 "../crypto/bn/bn_gcd.c"
       || bn_wexpand(g, top) == 
# 631 "../crypto/bn/bn_gcd.c" 3 4
                                ((void *)0)
        
# 632 "../crypto/bn/bn_gcd.c"
       || bn_wexpand(temp, top) == 
# 632 "../crypto/bn/bn_gcd.c" 3 4
                                   ((void *)0)
# 632 "../crypto/bn/bn_gcd.c"
                                       )
        goto err;
