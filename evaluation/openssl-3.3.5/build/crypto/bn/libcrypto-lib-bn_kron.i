# 0 "../crypto/bn/bn_kron.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_kron.c"
# 10 "../crypto/bn/bn_kron.c"
...
int BN_kronecker(const BIGNUM *a, const BIGNUM *b, BN_CTX *ctx)
{
    ...
    B = BN_CTX_get(ctx);
    if (B == 
# 38 "../crypto/bn/bn_kron.c" 3 4
            ((void *)0)
# 38 "../crypto/bn/bn_kron.c"
                )
        goto end;
