# 0 "../crypto/bn/bn_gf2m.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_gf2m.c"
# 11 "../crypto/bn/bn_gf2m.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 19 "../crypto/bn/bn_gf2m.c" 2
# 245 "../crypto/bn/bn_gf2m.c"
...
# 269 "../crypto/bn/bn_gf2m.c" 3 4
                                 ((void *)0)
# 269 "../crypto/bn/bn_gf2m.c"
                                     )
        return 0;
...
int BN_GF2m_mod(BIGNUM *r, const BIGNUM *a, const BIGNUM *p)
{
    ...
    if (!ret || ret > (int)(sizeof(arr)/sizeof((arr)[0]))) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",399,__func__), ERR_set_error)((3),(106),
# 399 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 399 "../crypto/bn/bn_gf2m.c"
       );
        return 0;
    }
                        ...
                        const int p[], BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((s = BN_CTX_get(ctx)) == 
# 426 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 426 "../crypto/bn/bn_gf2m.c"
                                    )
        goto err;
                    ...
                    const BIGNUM *p, BN_CTX *ctx)
{
    ...
    arr = CRYPTO_malloc(sizeof(*arr) * max, "../crypto/bn/bn_gf2m.c", 477);
    if (arr == 
# 478 "../crypto/bn/bn_gf2m.c" 3 4
              ((void *)0)
# 478 "../crypto/bn/bn_gf2m.c"
                  )
        return 0;
    ret = BN_GF2m_poly2arr(p, arr, max);
    if (!ret || ret > max) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",482,__func__), ERR_set_error)((3),(106),
# 482 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 482 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
    ...
    ;
 err:
    CRYPTO_free(arr, "../crypto/bn/bn_gf2m.c", 488);
    return ret;
}
                        ...
                        BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((s = BN_CTX_get(ctx)) == 
# 501 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 501 "../crypto/bn/bn_gf2m.c"
                                    )
        goto err;
...
int BN_GF2m_mod_sqr(BIGNUM *r, const BIGNUM *a, const BIGNUM *p, BN_CTX *ctx)
{
    ...
    arr = CRYPTO_malloc(sizeof(*arr) * max, "../crypto/bn/bn_gf2m.c", 537);
    if (arr == 
# 538 "../crypto/bn/bn_gf2m.c" 3 4
              ((void *)0)
# 538 "../crypto/bn/bn_gf2m.c"
                  )
        return 0;
    ret = BN_GF2m_poly2arr(p, arr, max);
    if (!ret || ret > max) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",542,__func__), ERR_set_error)((3),(106),
# 542 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 542 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
    ...
    ;
 err:
    CRYPTO_free(arr, "../crypto/bn/bn_gf2m.c", 548);
    return ret;
}
...
{
    BIGNUM *b, *c = 
# 561 "../crypto/bn/bn_gf2m.c" 3 4
                   ((void *)0)
# 561 "../crypto/bn/bn_gf2m.c"
                       , *u = 
# 561 "../crypto/bn/bn_gf2m.c" 3 4
                              ((void *)0)
# 561 "../crypto/bn/bn_gf2m.c"
...
# 561 "../crypto/bn/bn_gf2m.c"
    ...
    v = BN_CTX_get(ctx);
    if (v == 
# 573 "../crypto/bn/bn_gf2m.c" 3 4
            ((void *)0)
# 573 "../crypto/bn/bn_gf2m.c"
                )
        goto err;
...
# 619 "../crypto/bn/bn_gf2m.c"
    {
        ...
        while (1) {
            while (ubits && !(udp[0] & 1)) {
                ...
                for (i = 0; i < top - 1; i++) {
                    u1 = udp[i + 1];
                    udp[i] = ((u0 >> 1) | (u1 << ((8 * 8) - 1))) & (0xffffffffffffffffL);
                    u0 = u1;
                    b1 = bdp[i + 1] ^ (p->d[i + 1] & mask);
                    bdp[i] = ((b0 >> 1) | (b1 << ((8 * 8) - 1))) & (0xffffffffffffffffL);
                    b0 = b1;
                }
                udp[i] = u0 >> 1;
                bdp[i] = b0 >> 1;
            ...
            if (ubits == vbits) {
                unsigned long ul;
                int utop = (ubits - 1) / (8 * 8);

                while ((ul = udp[utop]) == 0 && utop)
                    utop--;
                ubits = utop * (8 * 8) + BN_num_bits_word(ul);
            }
        }
        bn_correct_top(b);
    }
...
{
    BIGNUM *b = 
# 732 "../crypto/bn/bn_gf2m.c" 3 4
               ((void *)0)
# 732 "../crypto/bn/bn_gf2m.c"
                   ;
    int ret = 0;
    int numbits;
    ...
    BN_CTX_start(ctx);
    if ((b = BN_CTX_get(ctx)) == 
# 737 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 737 "../crypto/bn/bn_gf2m.c"
                                    )
        goto err;
...
# 785 "../crypto/bn/bn_gf2m.c" 3 4
                                    ((void *)0)
# 785 "../crypto/bn/bn_gf2m.c"
                                        )
        goto err;
...
{
    BIGNUM *xinv = 
# 805 "../crypto/bn/bn_gf2m.c" 3 4
                  ((void *)0)
# 805 "../crypto/bn/bn_gf2m.c"
                      ;
    int ret = 0;
    ...
    xinv = BN_CTX_get(ctx);
    if (xinv == 
# 814 "../crypto/bn/bn_gf2m.c" 3 4
               ((void *)0)
# 814 "../crypto/bn/bn_gf2m.c"
                   )
        goto err;
                        ...
                        const int p[], BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((field = BN_CTX_get(ctx)) == 
# 845 "../crypto/bn/bn_gf2m.c" 3 4
                                    ((void *)0)
# 845 "../crypto/bn/bn_gf2m.c"
                                        )
        goto err;
    if (!BN_GF2m_arr2poly(p, field))
        goto err;
                        ...
                        const int p[], BN_CTX *ctx)
{
    ...
    if (BN_abs_is_word(b, 1))
        return (BN_copy(r, a) != 
# 876 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 876 "../crypto/bn/bn_gf2m.c"
                                    );

    BN_CTX_start(ctx);
    if ((u = BN_CTX_get(ctx)) == 
# 879 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 879 "../crypto/bn/bn_gf2m.c"
                                    )
        goto err;
                    ...
                    const BIGNUM *p, BN_CTX *ctx)
{
    ...
    arr = CRYPTO_malloc(sizeof(*arr) * max, "../crypto/bn/bn_gf2m.c", 920);
    if (arr == 
# 921 "../crypto/bn/bn_gf2m.c" 3 4
              ((void *)0)
# 921 "../crypto/bn/bn_gf2m.c"
                  )
        return 0;
    ret = BN_GF2m_poly2arr(p, arr, max);
    if (!ret || ret > max) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",925,__func__), ERR_set_error)((3),(106),
# 925 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 925 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
    ...
    ;
 err:
    CRYPTO_free(arr, "../crypto/bn/bn_gf2m.c", 931);
    return ret;
}
                         ...
                         BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((u = BN_CTX_get(ctx)) == 
# 954 "../crypto/bn/bn_gf2m.c" 3 4
                                ((void *)0)
# 954 "../crypto/bn/bn_gf2m.c"
                                    )
        goto err;
...
int BN_GF2m_mod_sqrt(BIGNUM *r, const BIGNUM *a, const BIGNUM *p, BN_CTX *ctx)
{
    ...
    arr = CRYPTO_malloc(sizeof(*arr) * max, "../crypto/bn/bn_gf2m.c", 982);
    if (arr == 
# 983 "../crypto/bn/bn_gf2m.c" 3 4
              ((void *)0)
# 983 "../crypto/bn/bn_gf2m.c"
                  )
        return 0;
    ret = BN_GF2m_poly2arr(p, arr, max);
    if (!ret || ret > max) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",987,__func__), ERR_set_error)((3),(106),
# 987 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 987 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
    ...
    ;
 err:
    CRYPTO_free(arr, "../crypto/bn/bn_gf2m.c", 993);
    return ret;
}
                               ...
                               BN_CTX *ctx)
{
    ...
    w = BN_CTX_get(ctx);
    if (w == 
# 1019 "../crypto/bn/bn_gf2m.c" 3 4
            ((void *)0)
# 1019 "../crypto/bn/bn_gf2m.c"
                )
        goto err;
    ...
    if (p[0] & 0x1) {
        ...
        tmp = BN_CTX_get(ctx);
        if (tmp == 
# 1049 "../crypto/bn/bn_gf2m.c" 3 4
                  ((void *)0)
# 1049 "../crypto/bn/bn_gf2m.c"
                      )
            goto err;
        do {
            if (!BN_priv_rand_ex(rho, p[0], 0, 0,
                                 0, ctx))
                goto err;
        ...
        if (BN_is_zero(w)) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",1075,__func__), ERR_set_error)((3),(113),
# 1075 "../crypto/bn/bn_gf2m.c" 3 4
           ((void *)0)
# 1075 "../crypto/bn/bn_gf2m.c"
           );
            goto err;
        }
    }
    ...
    if (!BN_GF2m_add(w, z, w))
        goto err;
    if (BN_ucmp((w), (a))) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",1085,__func__), ERR_set_error)((3),(116),
# 1085 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 1085 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
                           ...
                           BN_CTX *ctx)
{
    ...
    arr = CRYPTO_malloc(sizeof(*arr) * max, "../crypto/bn/bn_gf2m.c", 1116);
    if (arr == 
# 1117 "../crypto/bn/bn_gf2m.c" 3 4
              ((void *)0)
# 1117 "../crypto/bn/bn_gf2m.c"
                  )
        goto err;
    ret = BN_GF2m_poly2arr(p, arr, max);
    if (!ret || ret > max) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_gf2m.c",1121,__func__), ERR_set_error)((3),(106),
# 1121 "../crypto/bn/bn_gf2m.c" 3 4
       ((void *)0)
# 1121 "../crypto/bn/bn_gf2m.c"
       );
        goto err;
    }
    ...
    ;
 err:
    CRYPTO_free(arr, "../crypto/bn/bn_gf2m.c", 1127);
    return ret;
}
# 1148 "../crypto/bn/bn_gf2m.c"
int BN_GF2m_poly2arr(const BIGNUM *a, int p[], int max)
{
    int i, j, k = 0;
    unsigned long mask;
