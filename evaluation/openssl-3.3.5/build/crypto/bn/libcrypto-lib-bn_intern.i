# 0 "../crypto/bn/bn_intern.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_intern.c"
# 10 "../crypto/bn/bn_intern.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 12 "../crypto/bn/bn_intern.c" 2
# 22 "../crypto/bn/bn_intern.c"
signed char *bn_compute_wNAF(const BIGNUM *scalar, int w, size_t *ret_len)
{
    int window_val;
    signed char *r = 
# 25 "../crypto/bn/bn_intern.c" 3 4
                    ((void *)0)
# 25 "../crypto/bn/bn_intern.c"
                        ;
    int sign = 1;
    ...
    if (BN_is_zero(scalar)) {
        r = CRYPTO_malloc(1, "../crypto/bn/bn_intern.c", 31);
        if (r == 
# 32 "../crypto/bn/bn_intern.c" 3 4
                ((void *)0)
# 32 "../crypto/bn/bn_intern.c"
                    )
            goto err;
        r[0] = 0;
        *ret_len = 1;
    ...
    if (w <= 0 || w > 7) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",41,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 41 "../crypto/bn/bn_intern.c" 3 4
       ((void *)0)
# 41 "../crypto/bn/bn_intern.c"
       );
        goto err;
    }
    bit = 1 << w;
    ...
    if (scalar->d == 
# 52 "../crypto/bn/bn_intern.c" 3 4
                    ((void *)0) 
# 52 "../crypto/bn/bn_intern.c"
                         || scalar->top == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",53,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 53 "../crypto/bn/bn_intern.c" 3 4
       ((void *)0)
# 53 "../crypto/bn/bn_intern.c"
       );
        goto err;
    }

    len = BN_num_bits(scalar);
    r = CRYPTO_malloc(len + 1, "../crypto/bn/bn_intern.c", 58);




    if (r == 
# 63 "../crypto/bn/bn_intern.c" 3 4
            ((void *)0)
# 63 "../crypto/bn/bn_intern.c"
                )
        goto err;
    ...
    while ((window_val != 0) || (j + w + 1 < len)) {
        ...
        if (window_val & 1) {
            ...
            if (digit <= -bit || digit >= bit || !(digit & 1)) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",97,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 97 "../crypto/bn/bn_intern.c" 3 4
               ((void *)0)
# 97 "../crypto/bn/bn_intern.c"
               );
                goto err;
            }
            ...
            if (window_val != 0 && window_val != next_bit
                && window_val != bit) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",109,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 109 "../crypto/bn/bn_intern.c" 3 4
               ((void *)0)
# 109 "../crypto/bn/bn_intern.c"
               );
                goto err;
            }
        }
        ...
        if (window_val > next_bit) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",120,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 120 "../crypto/bn/bn_intern.c" 3 4
           ((void *)0)
# 120 "../crypto/bn/bn_intern.c"
           );
            goto err;
        }
    }
    ...
    if (j > len + 1) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",126,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 126 "../crypto/bn/bn_intern.c" 3 4
       ((void *)0)
# 126 "../crypto/bn/bn_intern.c"
       );
        goto err;
    }
    *ret_len = j;
 ...
 err:
    CRYPTO_free(r, "../crypto/bn/bn_intern.c", 133);
    return 
# 134 "../crypto/bn/bn_intern.c" 3 4
          ((void *)0)
# 134 "../crypto/bn/bn_intern.c"
              ;
}
...
int bn_copy_words(unsigned long *out, const BIGNUM *in, int size)
{
    ...
    if (in->d != 
# 161 "../crypto/bn/bn_intern.c" 3 4
                ((void *)0)
# 161 "../crypto/bn/bn_intern.c"
                    )
...
int bn_set_words(BIGNUM *a, const unsigned long *words, int num_words)
{
    if (bn_wexpand(a, num_words) == 
# 186 "../crypto/bn/bn_intern.c" 3 4
                                   ((void *)0)
# 186 "../crypto/bn/bn_intern.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_intern.c",187,__func__), ERR_set_error)((3),((3 | (0x2 << 18L))),
# 187 "../crypto/bn/bn_intern.c" 3 4
       ((void *)0)
# 187 "../crypto/bn/bn_intern.c"
       );
        return 0;
    }

    memcpy(a->d, words, sizeof(unsigned long) * num_words);
    a->top = num_words;
    bn_correct_top(a);
    return 1;
}
