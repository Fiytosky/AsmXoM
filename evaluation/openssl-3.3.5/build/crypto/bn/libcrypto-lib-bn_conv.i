# 0 "../crypto/bn/bn_conv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_conv.c"
# 10 "../crypto/bn/bn_conv.c"
...
char *BN_bn2hex(const BIGNUM *a)
{
    ...
    if (BN_is_zero(a))
        return CRYPTO_strdup("0", "../crypto/bn/bn_conv.c", 24);
    buf = CRYPTO_malloc(a->top * 8 * 2 + 2, "../crypto/bn/bn_conv.c", 25);
    if (buf == 
# 26 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0)
# 26 "../crypto/bn/bn_conv.c"
                  )
        goto err;
    p = buf;
    if (a->neg)
...
char *BN_bn2dec(const BIGNUM *a)
{
    ...
    char *buf = 
# 53 "../crypto/bn/bn_conv.c" 3 4
               ((void *)0)
# 53 "../crypto/bn/bn_conv.c"
                   ;
    char *p;
    BIGNUM *t = 
# 55 "../crypto/bn/bn_conv.c" 3 4
               ((void *)0)
# 55 "../crypto/bn/bn_conv.c"
                   ;
    unsigned long *bn_data = 
# 56 "../crypto/bn/bn_conv.c" 3 4
                       ((void *)0)
# 56 "../crypto/bn/bn_conv.c"
                           , *lp;
    int bn_data_num;
    ...
    num = (i / 10 + i / 1000 + 1) + 1;
    tbytes = num + 3;
    bn_data_num = num / 19 + 1;
    bn_data = CRYPTO_malloc(bn_data_num * sizeof(unsigned long), "../crypto/bn/bn_conv.c", 69);
    buf = CRYPTO_malloc(tbytes, "../crypto/bn/bn_conv.c", 70);
    if (buf == 
# 71 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0) 
...
# 71 "../crypto/bn/bn_conv.c"
        ...
        goto err;
    if ((t = BN_dup(a)) == 
# 73 "../crypto/bn/bn_conv.c" 3 4
                          ((void *)0)
# 73 "../crypto/bn/bn_conv.c"
                              )
        goto err;
    ...
    if (BN_is_zero(t)) {
        ...
        *p++ = '\0';
        ...
        n = BIO_snprintf(p, tbytes - (size_t)(p - buf), "%lu", *lp);
        if (n < 0)
            goto err;
        p += n;
        while (lp != bn_data) {
            lp--;
            n = BIO_snprintf(p, tbytes - (size_t)(p - buf), "%019lu", *lp);
            if (n < 0)
                goto err;
            p += n;
        }
    ...
    ok = 1;
 err:
    CRYPTO_free(bn_data, "../crypto/bn/bn_conv.c", 113);
    BN_free(t);
    if (ok)
        return buf;
    CRYPTO_free(buf, "../crypto/bn/bn_conv.c", 117);
    return 
# 118 "../crypto/bn/bn_conv.c" 3 4
          ((void *)0)
# 118 "../crypto/bn/bn_conv.c"
              ;
}
...
{
    BIGNUM *ret = 
# 124 "../crypto/bn/bn_conv.c" 3 4
                 ((void *)0)
# 124 "../crypto/bn/bn_conv.c"
                     ;
    unsigned long l = 0;
    ...
    if (a == 
# 129 "../crypto/bn/bn_conv.c" 3 4
            ((void *)0) 
# 129 "../crypto/bn/bn_conv.c"
                 || *a == '\0')
        return 0;
    ...
    for (i = 0; i <= 0x7fffffff 
# 137 "../crypto/bn/bn_conv.c"
                            / 4 && (ossl_ctype_check((a[i]), 0x10)); i++)
        continue;

    if (i == 0 || i > 0x7fffffff 
# 140 "../crypto/bn/bn_conv.c"
                             / 4)
        return 0;

    num = i + neg;
    if (bn == 
# 144 "../crypto/bn/bn_conv.c" 3 4
             ((void *)0)
# 144 "../crypto/bn/bn_conv.c"
                 )
        return num;


    if (*bn == 
# 148 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0)
# 148 "../crypto/bn/bn_conv.c"
                  ) {
        if ((ret = BN_new()) == 
# 149 "../crypto/bn/bn_conv.c" 3 4
                               ((void *)0)
# 149 "../crypto/bn/bn_conv.c"
                                   )
            return 0;
    } else {
        ret = *bn;
        if (BN_get_flags(ret, 0x02)) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_conv.c",154,__func__), ERR_set_error)((3),((262|(0x2 << 18L))),
# 154 "../crypto/bn/bn_conv.c" 3 4
           ((void *)0)
# 154 "../crypto/bn/bn_conv.c"
           );
            return 0;
        }
        BN_zero_ex(ret);
...
# 161 "../crypto/bn/bn_conv.c" 3 4
                                ((void *)0)
# 161 "../crypto/bn/bn_conv.c"
                                    )
        goto err;
 ...
 err:
    if (*bn == 
# 194 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0)
# 194 "../crypto/bn/bn_conv.c"
                  )
        BN_free(ret);
    return 0;
}
...
{
    BIGNUM *ret = 
# 201 "../crypto/bn/bn_conv.c" 3 4
                 ((void *)0)
# 201 "../crypto/bn/bn_conv.c"
                     ;
    unsigned long l = 0;
    int neg = 0, i, j;
    int num;
    ...
    if (a == 
# 206 "../crypto/bn/bn_conv.c" 3 4
            ((void *)0) 
# 206 "../crypto/bn/bn_conv.c"
                 || *a == '\0')
        return 0;
    if (*a == '-') {
        neg = 1;
    ...
    for (i = 0; i <= 0x7fffffff 
# 213 "../crypto/bn/bn_conv.c"
                            / 4 && ossl_isdigit(a[i]); i++)
        continue;

    if (i == 0 || i > 0x7fffffff 
# 216 "../crypto/bn/bn_conv.c"
                             / 4)
        goto err;

    num = i + neg;
    if (bn == 
# 220 "../crypto/bn/bn_conv.c" 3 4
             ((void *)0)
# 220 "../crypto/bn/bn_conv.c"
                 )
        return num;
    ...
    if (*bn == 
# 227 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0)
# 227 "../crypto/bn/bn_conv.c"
                  ) {
        if ((ret = BN_new()) == 
# 228 "../crypto/bn/bn_conv.c" 3 4
                               ((void *)0)
# 228 "../crypto/bn/bn_conv.c"
                                   )
            return 0;
    } else {
        ret = *bn;
    ...
    if (bn_expand(ret, i * 4) == 
# 236 "../crypto/bn/bn_conv.c" 3 4
                                ((void *)0)
# 236 "../crypto/bn/bn_conv.c"
                                    )
        goto err;
    ...
    while (--i >= 0) {
        ...
        a++;
        if (++j == 19) {
            if (!BN_mul_word(ret, (10000000000000000000UL))
                || !BN_add_word(ret, l))
                goto err;
            l = 0;
            j = 0;
 ...
 err:
    if (*bn == 
# 264 "../crypto/bn/bn_conv.c" 3 4
              ((void *)0)
# 264 "../crypto/bn/bn_conv.c"
                  )
        BN_free(ret);
    return 0;
}
