# 0 "../crypto/bn/bn_rsa_fips186_4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_rsa_fips186_4.c"
# 25 "../crypto/bn/bn_rsa_fips186_4.c"
...
# 26 "../crypto/bn/bn_rsa_fips186_4.c" 2
...
# 27 "../crypto/bn/bn_rsa_fips186_4.c" 2
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 28 "../crypto/bn/bn_rsa_fips186_4.c" 2
# 38 "../crypto/bn/bn_rsa_fips186_4.c"
static const unsigned long inv_sqrt_2_val[] = {
    (unsigned long)0xED17AC85UL<<32|0x83339916UL, (unsigned long)0x1D6F60BAUL<<32|0x893BA84CUL,
    (unsigned long)0x597D89B3UL<<32|0x754ABE9FUL, (unsigned long)0xB504F333UL<<32|0xF9DE6484UL
};

const BIGNUM ossl_bn_inv_sqrt_2 = {
    (unsigned long *)inv_sqrt_2_val,
    (sizeof(inv_sqrt_2_val)/sizeof((inv_sqrt_2_val)[0])),
    (sizeof(inv_sqrt_2_val)/sizeof((inv_sqrt_2_val)[0])),
    0,
    0x02
};
...
# 88 "../crypto/bn/bn_rsa_fips186_4.c"
...
# 108 "../crypto/bn/bn_rsa_fips186_4.c"
...
# 132 "../crypto/bn/bn_rsa_fips186_4.c"
                                                ...
                                                BN_GENCB *cb)
{
    ...
    if (BN_copy(p1, Xp1) == 
# 141 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                           ((void *)0)
# 141 "../crypto/bn/bn_rsa_fips186_4.c"
                               )
        return 0;
...
# 184 "../crypto/bn/bn_rsa_fips186_4.c"
int ossl_bn_rsa_fips186_4_gen_prob_primes(BIGNUM *p, BIGNUM *Xpout,
                                          BIGNUM *p1, BIGNUM *p2,
                                          const BIGNUM *Xp, const BIGNUM *Xp1,
                                          const BIGNUM *Xp2, int nlen,
                                          ...
                                          BN_GENCB *cb)
{
    int ret = 0;
    BIGNUM *p1i = 
# 192 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                 ((void *)0)
# 192 "../crypto/bn/bn_rsa_fips186_4.c"
                     , *p2i = 
# 192 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                              ((void *)0)
# 192 "../crypto/bn/bn_rsa_fips186_4.c"
...
# 192 "../crypto/bn/bn_rsa_fips186_4.c"
    ...
    if (p == 
# 195 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
            ((void *)0) 
# 195 "../crypto/bn/bn_rsa_fips186_4.c"
                 || Xpout == 
# 195 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                             ((void *)0)
# 195 "../crypto/bn/bn_rsa_fips186_4.c"
    ...
    p1i = (p1 != 
# 200 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                ((void *)0)
# 200 "../crypto/bn/bn_rsa_fips186_4.c"
                    ) ? p1 : BN_CTX_get(ctx);
    p2i = (p2 != 
# 201 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                ((void *)0)
# 201 "../crypto/bn/bn_rsa_fips186_4.c"
                    ) ? p2 : BN_CTX_get(ctx);
    Xp1i = (Xp1 != 
# 202 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                  ((void *)0)
# 202 "../crypto/bn/bn_rsa_fips186_4.c"
                      ) ? (BIGNUM *)Xp1 : BN_CTX_get(ctx);
    Xp2i = (Xp2 != 
# 203 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                  ((void *)0)
# 203 "../crypto/bn/bn_rsa_fips186_4.c"
                      ) ? (BIGNUM *)Xp2 : BN_CTX_get(ctx);
    if (p1i == 
# 204 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0) 
# 204 "../crypto/bn/bn_rsa_fips186_4.c"
                   || p2i == 
# 204 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                             ((void *)0) 
# 204 "../crypto/bn/bn_rsa_fips186_4.c"
...
# 204 "../crypto/bn/bn_rsa_fips186_4.c"
    ...
    if (Xp1 == 
# 213 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0)
# 213 "../crypto/bn/bn_rsa_fips186_4.c"
                  ) {

        if (!BN_priv_rand_ex(Xp1i, bitlen, 0, 1,
                             0, ctx))
            goto err;
    }

    if (Xp2 == 
# 220 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0)
# 220 "../crypto/bn/bn_rsa_fips186_4.c"
                  ) {

        if (!BN_priv_rand_ex(Xp2i, bitlen, 0, 1,
                             0, ctx))
            goto err;
    }
...
err:
    ...
    if (p1 == 
# 242 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
             ((void *)0)
# 242 "../crypto/bn/bn_rsa_fips186_4.c"
                 )
        BN_clear(p1i);
    if (p2 == 
# 244 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
             ((void *)0)
# 244 "../crypto/bn/bn_rsa_fips186_4.c"
                 )
        BN_clear(p2i);
    if (Xp1 == 
# 246 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0)
# 246 "../crypto/bn/bn_rsa_fips186_4.c"
                  )
        BN_clear(Xp1i);
    if (Xp2 == 
# 248 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0)
# 248 "../crypto/bn/bn_rsa_fips186_4.c"
                  )
        BN_clear(Xp2i);
    BN_CTX_end(ctx);
    return ret;
}
# 275 "../crypto/bn/bn_rsa_fips186_4.c"
int ossl_bn_rsa_fips186_4_derive_prime(BIGNUM *Y, BIGNUM *X, const BIGNUM *Xin,
                                       const BIGNUM *r1, const BIGNUM *r2,
                                       ...
                                       BN_CTX *ctx, BN_GENCB *cb)
{
    ...
    r1x2 = BN_CTX_get(ctx);
    if (r1x2 == 
# 295 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
               ((void *)0)
# 295 "../crypto/bn/bn_rsa_fips186_4.c"
                   )
        goto err;

    if (Xin != 
# 298 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0) 
# 298 "../crypto/bn/bn_rsa_fips186_4.c"
                   && BN_copy(X, Xin) == 
# 298 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                                         ((void *)0)
# 298 "../crypto/bn/bn_rsa_fips186_4.c"
        ...
        goto err;
# 310 "../crypto/bn/bn_rsa_fips186_4.c"
    if (Xin == 
# 310 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
              ((void *)0)
# 310 "../crypto/bn/bn_rsa_fips186_4.c"
                  ) {
...
# 329 "../crypto/bn/bn_rsa_fips186_4.c"
    if (!(BN_lshift1(r1x2, r1)
            && (BN_mod_inverse(tmp, r1x2, r2, ctx) != 
# 330 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                                                     ((void *)0)
# 330 "../crypto/bn/bn_rsa_fips186_4.c"
                                                         )

            && (BN_mod_inverse(R, r2, r1x2, ctx) != 
# 332 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                                                   ((void *)0)
# 332 "../crypto/bn/bn_rsa_fips186_4.c"
                                                       )
            && BN_mul(R, R, r2, ctx)
    ...
    if (BN_is_negative(R) && !BN_add(R, R, r1r2x2))
        goto err;
# 351 "../crypto/bn/bn_rsa_fips186_4.c"
    rounds = bn_rsa_fips186_5_prime_MR_rounds(nlen);
    imax = 20 * bits;
    for (;;) {
        if (Xin == 
# 354 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                  ((void *)0)
# 354 "../crypto/bn/bn_rsa_fips186_4.c"
                      ) {
        ...
        for (;;) {
            ...
            if (BN_num_bits(Y) > bits) {
                if (Xin == 
# 370 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                          ((void *)0)
# 370 "../crypto/bn/bn_rsa_fips186_4.c"
                              )
                    break;
                else
                    goto err;
            ...
            if (BN_copy(y1, Y) == 
# 378 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
                                 ((void *)0)
                    
# 379 "../crypto/bn/bn_rsa_fips186_4.c"
                   || !BN_sub_word(y1, 1))
                goto err;
            ...
            if (++i >= imax) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_rsa_fips186_4.c",392,__func__), ERR_set_error)((3),(121),
# 392 "../crypto/bn/bn_rsa_fips186_4.c" 3 4
               ((void *)0)
# 392 "../crypto/bn/bn_rsa_fips186_4.c"
               );
                goto err;
            }
