# 0 "../crypto/bn/bn_x931p.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_x931p.c"
# 12 "../crypto/bn/bn_x931p.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 15 "../crypto/bn/bn_x931p.c" 2
# 23 "../crypto/bn/bn_x931p.c"
                            ...
                            BN_GENCB *cb)
{
    ...
    BN_CTX_start(ctx);
    if (p1 == 
# 67 "../crypto/bn/bn_x931p.c" 3 4
             ((void *)0)
# 67 "../crypto/bn/bn_x931p.c"
                 )
        p1 = BN_CTX_get(ctx);

    if (p2 == 
# 70 "../crypto/bn/bn_x931p.c" 3 4
             ((void *)0)
# 70 "../crypto/bn/bn_x931p.c"
                 )
        p2 = BN_CTX_get(ctx);
    ...
    if (pm1 == 
# 79 "../crypto/bn/bn_x931p.c" 3 4
              ((void *)0)
# 79 "../crypto/bn/bn_x931p.c"
                  )
        goto err;
...
int BN_X931_generate_Xpq(BIGNUM *Xp, BIGNUM *Xq, int nbits, BN_CTX *ctx)
{
    ...
    if (!BN_priv_rand_ex(Xp, nbits, 1, 0, 0,
                         ctx))
        return 0;
    ...
    t = BN_CTX_get(ctx);
    if (t == 
# 184 "../crypto/bn/bn_x931p.c" 3 4
            ((void *)0)
# 184 "../crypto/bn/bn_x931p.c"
                )
        goto err;

    for (i = 0; i < 1000; i++) {
        if (!BN_priv_rand_ex(Xq, nbits, 1, 0, 0,
                             ctx))
            goto err;
                              ...
                              const BIGNUM *e, BN_CTX *ctx, BN_GENCB *cb)
{
    ...
    BN_CTX_start(ctx);
    if (Xp1 == 
# 227 "../crypto/bn/bn_x931p.c" 3 4
              ((void *)0)
# 227 "../crypto/bn/bn_x931p.c"
                  )
        Xp1 = BN_CTX_get(ctx);
    if (Xp2 == 
# 229 "../crypto/bn/bn_x931p.c" 3 4
              ((void *)0)
# 229 "../crypto/bn/bn_x931p.c"
                  )
        Xp2 = BN_CTX_get(ctx);
    if (Xp1 == 
# 231 "../crypto/bn/bn_x931p.c" 3 4
              ((void *)0) 
# 231 "../crypto/bn/bn_x931p.c"
                   || Xp2 == 
# 231 "../crypto/bn/bn_x931p.c" 3 4
                             ((void *)0)
# 231 "../crypto/bn/bn_x931p.c"
    ...
    if (!BN_priv_rand_ex(Xp1, 101, 0, 0, 0, ctx))
        goto error;
    if (!BN_priv_rand_ex(Xp2, 101, 0, 0, 0, ctx))
        goto error;
