# 0 "../crypto/bn/bn_mod.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_mod.c"
# 10 "../crypto/bn/bn_mod.c"
...
int BN_nnmod(BIGNUM *r, const BIGNUM *m, const BIGNUM *d, BN_CTX *ctx)
{
    ...
    if (r == d) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_mod.c",21,__func__), ERR_set_error)((3),((262|(0x2 << 18L))),
# 21 "../crypto/bn/bn_mod.c" 3 4
       ((void *)0)
# 21 "../crypto/bn/bn_mod.c"
       );
        return 0;
    }

    if (!(BN_div(
# 25 "../crypto/bn/bn_mod.c" 3 4
         ((void *)0)
# 25 "../crypto/bn/bn_mod.c"
         ,(r),(m),(d),(ctx))))
        return 0;
    if (!r->neg)
        return 1;
...
# 53 "../crypto/bn/bn_mod.c"
int bn_mod_add_fixed_top(BIGNUM *r, const BIGNUM *a, const BIGNUM *b,
                         const BIGNUM *m)
{
    size_t i, ai, bi, mtop = m->top;
    unsigned long storage[1024 / (8 * 8)];
    unsigned long carry, temp, mask, *rp, *tp = storage;
    const unsigned long *ap, *bp;

    if (bn_wexpand(r, mtop) == 
# 61 "../crypto/bn/bn_mod.c" 3 4
                              ((void *)0)
# 61 "../crypto/bn/bn_mod.c"
                                  )
        return 0;

    if (mtop > sizeof(storage) / sizeof(storage[0])) {
        tp = CRYPTO_malloc(mtop * sizeof(unsigned long), "../crypto/bn/bn_mod.c", 65);
        if (tp == 
# 66 "../crypto/bn/bn_mod.c" 3 4
                 ((void *)0)
# 66 "../crypto/bn/bn_mod.c"
                     )
            return 0;
    }

    ap = a->d != 
# 70 "../crypto/bn/bn_mod.c" 3 4
                ((void *)0) 
# 70 "../crypto/bn/bn_mod.c"
                     ? a->d : tp;
    bp = b->d != 
# 71 "../crypto/bn/bn_mod.c" 3 4
                ((void *)0) 
# 71 "../crypto/bn/bn_mod.c"
                     ? b->d : tp;

    for (i = 0, ai = 0, bi = 0, carry = 0; i < mtop;) {
        mask = (unsigned long)0 - ((i - a->top) >> (8 * sizeof(i) - 1));
        temp = ((ap[ai] & mask) + carry) & (0xffffffffffffffffL);
        carry = (temp < carry);

        mask = (unsigned long)0 - ((i - b->top) >> (8 * sizeof(i) - 1));
        tp[i] = ((bp[bi] & mask) + temp) & (0xffffffffffffffffL);
        carry += (tp[i] < temp);
    ...
    if (tp != storage)
        CRYPTO_free(tp, "../crypto/bn/bn_mod.c", 97);
...
# 135 "../crypto/bn/bn_mod.c"
int bn_mod_sub_fixed_top(BIGNUM *r, const BIGNUM *a, const BIGNUM *b,
                         const BIGNUM *m)
{
    size_t i, ai, bi, mtop = m->top;
    unsigned long borrow, carry, ta, tb, mask, *rp;
    const unsigned long *ap, *bp;

    if (bn_wexpand(r, mtop) == 
# 142 "../crypto/bn/bn_mod.c" 3 4
                              ((void *)0)
# 142 "../crypto/bn/bn_mod.c"
                                  )
        return 0;

    rp = r->d;
    ap = a->d != 
# 146 "../crypto/bn/bn_mod.c" 3 4
                ((void *)0) 
# 146 "../crypto/bn/bn_mod.c"
                     ? a->d : rp;
    bp = b->d != 
# 147 "../crypto/bn/bn_mod.c" 3 4
                ((void *)0) 
# 147 "../crypto/bn/bn_mod.c"
                     ? b->d : rp;
    ...
    for (i = 0, mask = 0 - borrow, carry = 0; i < mtop; i++) {
        ta = ((ap[i] & mask) + carry) & (0xffffffffffffffffL);
        carry = (ta < carry);
        rp[i] = (rp[i] + ta) & (0xffffffffffffffffL);
        carry += (rp[i] < ta);
    }
    borrow -= carry;
    for (i = 0, mask = 0 - borrow, carry = 0; i < mtop; i++) {
...
{
    if (r == m) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_mod.c",193,__func__), ERR_set_error)((3),((262|(0x2 << 18L))),
# 193 "../crypto/bn/bn_mod.c" 3 4
       ((void *)0)
# 193 "../crypto/bn/bn_mod.c"
       );
        return 0;
    }
               ...
               BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((t = BN_CTX_get(ctx)) == 
# 216 "../crypto/bn/bn_mod.c" 3 4
                                ((void *)0)
# 216 "../crypto/bn/bn_mod.c"
                                    )
        goto err;
    if (a == b) {
        if (!BN_sqr(t, a, ctx))
...
int BN_mod_sqr(BIGNUM *r, const BIGNUM *a, const BIGNUM *m, BN_CTX *ctx)
{
    ...
    return BN_div(
# 239 "../crypto/bn/bn_mod.c" 3 4
          ((void *)0)
# 239 "../crypto/bn/bn_mod.c"
          ,(r),(r),(m),(ctx));
}
...
{
    BIGNUM *abs_m = 
# 267 "../crypto/bn/bn_mod.c" 3 4
                   ((void *)0)
# 267 "../crypto/bn/bn_mod.c"
                       ;
    int ret;
    ...
    if (m->neg) {
        abs_m = BN_dup(m);
        if (abs_m == 
# 275 "../crypto/bn/bn_mod.c" 3 4
                    ((void *)0)
# 275 "../crypto/bn/bn_mod.c"
                        )
            return 0;
        abs_m->neg = 0;
    }
...
int BN_mod_lshift_quick(BIGNUM *r, const BIGNUM *a, int n, const BIGNUM *m)
{
    if (r != a) {
        if (BN_copy(r, a) == 
# 294 "../crypto/bn/bn_mod.c" 3 4
                            ((void *)0)
# 294 "../crypto/bn/bn_mod.c"
                                )
            return 0;
    }
    ...
    while (n > 0) {
        ...
        if (max_shift < 0) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_mod.c",306,__func__), ERR_set_error)((3),(110),
# 306 "../crypto/bn/bn_mod.c" 3 4
           ((void *)0)
# 306 "../crypto/bn/bn_mod.c"
           );
            return 0;
        }
