# 0 "../crypto/bn/bn_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_err.c"
# 11 "../crypto/bn/bn_err.c"
...
# 12 "../crypto/bn/bn_err.c" 2
# 1 "../include/openssl/bnerr.h" 1
# 13 "../include/openssl/bnerr.h"
        
# 13 "../crypto/bn/bn_err.c" 2
# 1 "../include/crypto/bnerr.h" 1
# 13 "../include/crypto/bnerr.h"
        
# 22 "../include/crypto/bnerr.h"
int ossl_err_load_BN_strings(void);
# 14 "../crypto/bn/bn_err.c" 2



static const ERR_STRING_DATA BN_str_reasons[] = {
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "arg2 lt arg3"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad reciprocal"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "bignum too long"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ), "bits too small"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "called with even modulus"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "div by zero"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "encoding error"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "expand on static bignum data"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "input not reduced"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "invalid length"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "invalid range"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "invalid shift"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "not a square"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "not initialized"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "no inverse"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ), "no prime candidate"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ), "no solution"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "no suitable digest"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "private key too large"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "p is not prime"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "too many iterations"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "too many temporary variables"},
    {0, 
# 44 "../crypto/bn/bn_err.c" 3 4
       ((void *)0)
# 44 "../crypto/bn/bn_err.c"
           }
};
...
int ossl_err_load_BN_strings(void)
{
    ...
    if (ERR_reason_error_string(BN_str_reasons[0].error) == 
# 52 "../crypto/bn/bn_err.c" 3 4
                                                           ((void *)0)
# 52 "../crypto/bn/bn_err.c"
                                                               )
