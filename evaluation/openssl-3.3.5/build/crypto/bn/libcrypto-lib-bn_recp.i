# 0 "../crypto/bn/bn_recp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_recp.c"
# 10 "../crypto/bn/bn_recp.c"
...
BN_RECP_CTX *BN_RECP_CTX_new(void)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bn/bn_recp.c", 24)) == 
# 24 "../crypto/bn/bn_recp.c" 3 4
                                               ((void *)0)
# 24 "../crypto/bn/bn_recp.c"
                                                   )
        return 
# 25 "../crypto/bn/bn_recp.c" 3 4
              ((void *)0)
# 25 "../crypto/bn/bn_recp.c"
                  ;
...
{
    if (recp == 
# 35 "../crypto/bn/bn_recp.c" 3 4
               ((void *)0)
# 35 "../crypto/bn/bn_recp.c"
                   )
        return;
    BN_free(&recp->N);
    BN_free(&recp->Nr);
    if (recp->flags & 0x01)
        CRYPTO_free(recp, "../crypto/bn/bn_recp.c", 40);
}
                          ...
                          BN_RECP_CTX *recp, BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((a = BN_CTX_get(ctx)) == 
# 61 "../crypto/bn/bn_recp.c" 3 4
                                ((void *)0)
# 61 "../crypto/bn/bn_recp.c"
                                    )
        goto err;
    if (y != 
# 63 "../crypto/bn/bn_recp.c" 3 4
            ((void *)0)
# 63 "../crypto/bn/bn_recp.c"
                ) {
        if (x == y) {
            if (!BN_sqr(a, x, ctx))
                goto err;
    ...
    ret = BN_div_recp(
# 75 "../crypto/bn/bn_recp.c" 3 4
                     ((void *)0)
# 75 "../crypto/bn/bn_recp.c"
                         , r, ca, recp, ctx);
 err:
    BN_CTX_end(ctx);
    ;
                ...
                BN_RECP_CTX *recp, BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    d = (dv != 
# 89 "../crypto/bn/bn_recp.c" 3 4
              ((void *)0)
# 89 "../crypto/bn/bn_recp.c"
                  ) ? dv : BN_CTX_get(ctx);
    r = (rem != 
# 90 "../crypto/bn/bn_recp.c" 3 4
               ((void *)0)
# 90 "../crypto/bn/bn_recp.c"
                   ) ? rem : BN_CTX_get(ctx);
    a = BN_CTX_get(ctx);
    b = BN_CTX_get(ctx);
    if (b == 
# 93 "../crypto/bn/bn_recp.c" 3 4
            ((void *)0)
# 93 "../crypto/bn/bn_recp.c"
                )
        goto err;
    ...
    while (BN_ucmp(r, &(recp->N)) >= 0) {
        if (j++ > 2) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_recp.c",147,__func__), ERR_set_error)((3),(101),
# 147 "../crypto/bn/bn_recp.c" 3 4
           ((void *)0)
# 147 "../crypto/bn/bn_recp.c"
           );
            goto err;
        }
...
int BN_reciprocal(BIGNUM *r, const BIGNUM *m, int len, BN_CTX *ctx)
{
    ...
    BN_CTX_start(ctx);
    if ((t = BN_CTX_get(ctx)) == 
# 178 "../crypto/bn/bn_recp.c" 3 4
                                ((void *)0)
# 178 "../crypto/bn/bn_recp.c"
                                    )
        goto err;
    ...
    if (!BN_div(r, 
# 184 "../crypto/bn/bn_recp.c" 3 4
                  ((void *)0)
# 184 "../crypto/bn/bn_recp.c"
                      , t, m, ctx))
        goto err;
