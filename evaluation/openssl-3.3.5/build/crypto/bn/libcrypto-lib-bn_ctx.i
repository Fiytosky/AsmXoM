# 0 "../crypto/bn/bn_ctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_ctx.c"
# 10 "../crypto/bn/bn_ctx.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 13 "../crypto/bn/bn_ctx.c" 2
# 24 "../crypto/bn/bn_ctx.c"
...
# 118 "../crypto/bn/bn_ctx.c"
BN_CTX *BN_CTX_new_ex(OSSL_LIB_CTX *ctx)
{
    BN_CTX *ret;

    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bn/bn_ctx.c", 122)) == 
# 122 "../crypto/bn/bn_ctx.c" 3 4
                                               ((void *)0)
# 122 "../crypto/bn/bn_ctx.c"
                                                   )
        return 
# 123 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 123 "../crypto/bn/bn_ctx.c"
                  ;
...
BN_CTX *BN_CTX_new(void)
{
    return BN_CTX_new_ex(
# 134 "../crypto/bn/bn_ctx.c" 3 4
                        ((void *)0)
# 134 "../crypto/bn/bn_ctx.c"
                            );
}
...
BN_CTX *BN_CTX_secure_new_ex(OSSL_LIB_CTX *ctx)
{
    ...
    if (ret != 
# 142 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 142 "../crypto/bn/bn_ctx.c"
                  )
        ret->flags = 0x08;
    return ret;
}
...
BN_CTX *BN_CTX_secure_new(void)
{
    return BN_CTX_secure_new_ex(
# 150 "../crypto/bn/bn_ctx.c" 3 4
                               ((void *)0)
# 150 "../crypto/bn/bn_ctx.c"
                                   );
}
...
{
    if (ctx == 
# 156 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 156 "../crypto/bn/bn_ctx.c"
                  )
        return;

    do { BIO *trc_out = 
# 159 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 159 "../crypto/bn/bn_ctx.c"
   ; if (0) {
    ...
    CRYPTO_free(ctx, "../crypto/bn/bn_ctx.c", 176);
}

void BN_CTX_start(BN_CTX *ctx)
{
    do { BIO *trc_out = 
# 181 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 181 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "ENTER BN_CTX_start()", ctx); } } while(0);

    if (ctx->err_stack || ctx->too_many)
        ctx->err_stack++;

    else if (!BN_STACK_push(&ctx->stack, ctx->used)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_ctx.c",187,__func__), ERR_set_error)((3),(109),
# 187 "../crypto/bn/bn_ctx.c" 3 4
       ((void *)0)
# 187 "../crypto/bn/bn_ctx.c"
       );
        ctx->err_stack++;
    }
    do { BIO *trc_out = 
# 190 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 190 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "LEAVE BN_CTX_start()", ctx); } } while(0);
}

void BN_CTX_end(BN_CTX *ctx)
{
    if (ctx == 
# 195 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 195 "../crypto/bn/bn_ctx.c"
                  )
        return;
    do { BIO *trc_out = 
# 197 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 197 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "ENTER BN_CTX_end()", ctx); } } while(0);
    if (ctx->err_stack)
        ctx->err_stack--;
    else {
    ...
    do { BIO *trc_out = 
# 209 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 209 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "LEAVE BN_CTX_end()", ctx); } } while(0);
}
...
BIGNUM *BN_CTX_get(BN_CTX *ctx)
{
    ...
    do { BIO *trc_out = 
# 216 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 216 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "ENTER BN_CTX_get()", ctx); } } while(0);
    if (ctx->err_stack || ctx->too_many)
        return 
# 218 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 218 "../crypto/bn/bn_ctx.c"
                  ;
    if ((ret = BN_POOL_get(&ctx->pool, ctx->flags)) == 
# 219 "../crypto/bn/bn_ctx.c" 3 4
                                                      ((void *)0)
# 219 "../crypto/bn/bn_ctx.c"
                                                          ) {
        ...
        ctx->too_many = 1;
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_ctx.c",225,__func__), ERR_set_error)((3),(109),
# 225 "../crypto/bn/bn_ctx.c" 3 4
       ((void *)0)
# 225 "../crypto/bn/bn_ctx.c"
       );
        return 
# 226 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 226 "../crypto/bn/bn_ctx.c"
                  ;
    }
    ...
    ctx->used++;
    do { BIO *trc_out = 
# 233 "../crypto/bn/bn_ctx.c" 3 4
   ((void *)0)
# 233 "../crypto/bn/bn_ctx.c"
   ; if (0) { ctxdbg(trc_out, "LEAVE BN_CTX_get()", ctx); } } while(0);
    return ret;
}
...
{
    if (ctx == 
# 239 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 239 "../crypto/bn/bn_ctx.c"
                  )
        return 
# 240 "../crypto/bn/bn_ctx.c" 3 4
              ((void *)0)
# 240 "../crypto/bn/bn_ctx.c"
                  ;
    return ctx->libctx;
}
...
{
    st->indexes = 
# 250 "../crypto/bn/bn_ctx.c" 3 4
                 ((void *)0)
# 250 "../crypto/bn/bn_ctx.c"
                     ;
    st->depth = st->size = 0;
}
...
{
    CRYPTO_free(st->indexes, "../crypto/bn/bn_ctx.c", 256);
    st->indexes = 
# 257 "../crypto/bn/bn_ctx.c" 3 4
                 ((void *)0)
# 257 "../crypto/bn/bn_ctx.c"
                     ;
}
...
static int BN_STACK_push(BN_STACK *st, unsigned int idx)
{
    if (st->depth == st->size) {
        ...
        if ((newitems = CRYPTO_malloc(sizeof(*newitems) * newsize, "../crypto/bn/bn_ctx.c", 269)) == 
# 269 "../crypto/bn/bn_ctx.c" 3 4
                                                                       ((void *)0)
# 269 "../crypto/bn/bn_ctx.c"
                                                                           )
            return 0;
        if (st->depth)
            memcpy(newitems, st->indexes, sizeof(*newitems) * st->depth);
        CRYPTO_free(st->indexes, "../crypto/bn/bn_ctx.c", 273);
        st->indexes = newitems;
        st->size = newsize;
    }
...
# 292 "../crypto/bn/bn_ctx.c" 3 4
                                    ((void *)0)
# 292 "../crypto/bn/bn_ctx.c"
                                        ;
    p->used = p->size = 0;
}
...
static void BN_POOL_finish(BN_POOL *p)
{
    ...
    while (p->head) {
        for (loop = 0, bn = p->head->vals; loop++ < 16; bn++)
            if (bn->d)
                BN_clear_free(bn);
        p->current = p->head->next;
        CRYPTO_free(p->head, "../crypto/bn/bn_ctx.c", 306);
        p->head = p->current;
    }
}
...
static BIGNUM *BN_POOL_get(BN_POOL *p, int flag)
{
    ...
    if (p->used == p->size) {
        ...
        if ((item = CRYPTO_malloc(sizeof(*item), "../crypto/bn/bn_ctx.c", 321)) == 
# 321 "../crypto/bn/bn_ctx.c" 3 4
                                                     ((void *)0)
# 321 "../crypto/bn/bn_ctx.c"
                                                         )
            return 
# 322 "../crypto/bn/bn_ctx.c" 3 4
                  ((void *)0)
# 322 "../crypto/bn/bn_ctx.c"
                      ;
        ...
        item->prev = p->tail;
        item->next = 
# 329 "../crypto/bn/bn_ctx.c" 3 4
                    ((void *)0)
# 329 "../crypto/bn/bn_ctx.c"
                        ;

        if (p->head == 
# 331 "../crypto/bn/bn_ctx.c" 3 4
                      ((void *)0)
# 331 "../crypto/bn/bn_ctx.c"
                          )
