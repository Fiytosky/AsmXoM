# 0 "../crypto/bn/bn_blind.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_blind.c"
# 10 "../crypto/bn/bn_blind.c"
...
{
    BN_BLINDING *ret = 
# 32 "../crypto/bn/bn_blind.c" 3 4
                      ((void *)0)
# 32 "../crypto/bn/bn_blind.c"
                          ;

    ;

    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bn/bn_blind.c", 36)) == 
# 36 "../crypto/bn/bn_blind.c" 3 4
                                               ((void *)0)
# 36 "../crypto/bn/bn_blind.c"
                                                   )
        return 
# 37 "../crypto/bn/bn_blind.c" 3 4
              ((void *)0)
# 37 "../crypto/bn/bn_blind.c"
                  ;

    ret->lock = CRYPTO_THREAD_lock_new();
    if (ret->lock == 
# 40 "../crypto/bn/bn_blind.c" 3 4
                    ((void *)0)
# 40 "../crypto/bn/bn_blind.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_blind.c",41,__func__), ERR_set_error)((3),((15 | (0x2 << 18L))),
# 41 "../crypto/bn/bn_blind.c" 3 4
       ((void *)0)
# 41 "../crypto/bn/bn_blind.c"
       );
        CRYPTO_free(ret, "../crypto/bn/bn_blind.c", 42);
        return 
# 43 "../crypto/bn/bn_blind.c" 3 4
              ((void *)0)
# 43 "../crypto/bn/bn_blind.c"
                  ;
    }
    ...
    if (A != 
# 48 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0)
# 48 "../crypto/bn/bn_blind.c"
                ) {
        if ((ret->A = BN_dup(A)) == 
# 49 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 49 "../crypto/bn/bn_blind.c"
                                       )
            goto err;
    }

    if (Ai != 
# 53 "../crypto/bn/bn_blind.c" 3 4
             ((void *)0)
# 53 "../crypto/bn/bn_blind.c"
                 ) {
        if ((ret->Ai = BN_dup(Ai)) == 
# 54 "../crypto/bn/bn_blind.c" 3 4
                                     ((void *)0)
# 54 "../crypto/bn/bn_blind.c"
                                         )
            goto err;
    }
...
# 59 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 59 "../crypto/bn/bn_blind.c"
                                       )
        goto err;

    if (BN_get_flags(mod, 0x04) != 0)
        BN_set_flags(ret->mod, 0x04);
 ...
 err:
    ...
    return 
# 76 "../crypto/bn/bn_blind.c" 3 4
          ((void *)0)
# 76 "../crypto/bn/bn_blind.c"
              ;
}
...
# 81 "../crypto/bn/bn_blind.c"
    ...
    CRYPTO_free(r, "../crypto/bn/bn_blind.c", 88);
}
...
int BN_BLINDING_update(BN_BLINDING *b, BN_CTX *ctx)
{
    ...
    if ((b->A == 
# 95 "../crypto/bn/bn_blind.c" 3 4
                ((void *)0)
# 95 "../crypto/bn/bn_blind.c"
                    ) || (b->Ai == 
# 95 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 95 "../crypto/bn/bn_blind.c"
                                       )) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_blind.c",96,__func__), ERR_set_error)((3),(107),
# 96 "../crypto/bn/bn_blind.c" 3 4
       ((void *)0)
# 96 "../crypto/bn/bn_blind.c"
       );
        goto err;
    }
    ...
    if (++b->counter == 32 && b->e != 
# 103 "../crypto/bn/bn_blind.c" 3 4
                                                      ((void *)0) 
# 103 "../crypto/bn/bn_blind.c"
                                                           &&
        !(b->flags & 0x00000002)) {

        if (!BN_BLINDING_create_param(b, 
# 106 "../crypto/bn/bn_blind.c" 3 4
                                        ((void *)0)
# 106 "../crypto/bn/bn_blind.c"
                                            , 
# 106 "../crypto/bn/bn_blind.c" 3 4
                                              ((void *)0)
# 106 "../crypto/bn/bn_blind.c"
...
# 106 "../crypto/bn/bn_blind.c"
        ...
        if (b->m_ctx != 
# 109 "../crypto/bn/bn_blind.c" 3 4
                       ((void *)0)
# 109 "../crypto/bn/bn_blind.c"
                           ) {
...
# 129 "../crypto/bn/bn_blind.c" 3 4
                                    ((void *)0)
# 129 "../crypto/bn/bn_blind.c"
                                        , b, ctx);
}
...
int BN_BLINDING_convert_ex(BIGNUM *n, BIGNUM *r, BN_BLINDING *b, BN_CTX *ctx)
{
    ...
    if ((b->A == 
# 138 "../crypto/bn/bn_blind.c" 3 4
                ((void *)0)
# 138 "../crypto/bn/bn_blind.c"
                    ) || (b->Ai == 
# 138 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 138 "../crypto/bn/bn_blind.c"
                                       )) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_blind.c",139,__func__), ERR_set_error)((3),(107),
# 139 "../crypto/bn/bn_blind.c" 3 4
       ((void *)0)
# 139 "../crypto/bn/bn_blind.c"
       );
        return 0;
    }
    ...
    if (r != 
# 149 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0) 
# 149 "../crypto/bn/bn_blind.c"
                 && (BN_copy(r, b->Ai) == 
# 149 "../crypto/bn/bn_blind.c" 3 4
                                          ((void *)0)
# 149 "../crypto/bn/bn_blind.c"
    ...
    if (b->m_ctx != 
# 152 "../crypto/bn/bn_blind.c" 3 4
                   ((void *)0)
# 152 "../crypto/bn/bn_blind.c"
                       )
...
# 162 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 162 "../crypto/bn/bn_blind.c"
                                       , b, ctx);
}
                          ...
                          BN_CTX *ctx)
{
    ...
    if (r == 
# 172 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0) 
# 172 "../crypto/bn/bn_blind.c"
                 && (r = b->Ai) == 
# 172 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 172 "../crypto/bn/bn_blind.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_blind.c",173,__func__), ERR_set_error)((3),(107),
# 173 "../crypto/bn/bn_blind.c" 3 4
       ((void *)0)
# 173 "../crypto/bn/bn_blind.c"
       );
        return 0;
    }

    if (b->m_ctx != 
# 177 "../crypto/bn/bn_blind.c" 3 4
                   ((void *)0)
# 177 "../crypto/bn/bn_blind.c"
                       ) {
        ...
        if (n->dmax >= r->top) {
            ...
            mask = (unsigned long)0 - ((rtop - ntop) >> (8 * sizeof(ntop) - 1));
                                      ...
                                      BN_MONT_CTX *m_ctx)
{
    ...
    BN_BLINDING *ret = 
# 243 "../crypto/bn/bn_blind.c" 3 4
                      ((void *)0)
# 243 "../crypto/bn/bn_blind.c"
                          ;

    if (b == 
# 245 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0)
# 245 "../crypto/bn/bn_blind.c"
                )
        ret = BN_BLINDING_new(
# 246 "../crypto/bn/bn_blind.c" 3 4
                             ((void *)0)
# 246 "../crypto/bn/bn_blind.c"
                                 , 
# 246 "../crypto/bn/bn_blind.c" 3 4
                                   ((void *)0)
# 246 "../crypto/bn/bn_blind.c"
    ...
    if (ret == 
# 250 "../crypto/bn/bn_blind.c" 3 4
              ((void *)0)
# 250 "../crypto/bn/bn_blind.c"
                  )
        goto err;

    if (ret->A == 
# 253 "../crypto/bn/bn_blind.c" 3 4
                 ((void *)0) 
# 253 "../crypto/bn/bn_blind.c"
                      && (ret->A = BN_new()) == 
# 253 "../crypto/bn/bn_blind.c" 3 4
                                                ((void *)0)
# 253 "../crypto/bn/bn_blind.c"
        ...
        goto err;
    if (ret->Ai == 
# 255 "../crypto/bn/bn_blind.c" 3 4
                  ((void *)0) 
# 255 "../crypto/bn/bn_blind.c"
                       && (ret->Ai = BN_new()) == 
# 255 "../crypto/bn/bn_blind.c" 3 4
                                                  ((void *)0)
# 255 "../crypto/bn/bn_blind.c"
    ...
    if (e != 
# 258 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0)
# 258 "../crypto/bn/bn_blind.c"
                ) {
        BN_free(ret->e);
        ret->e = BN_dup(e);
    }
    if (ret->e == 
# 262 "../crypto/bn/bn_blind.c" 3 4
                 ((void *)0)
# 262 "../crypto/bn/bn_blind.c"
                     )
        goto err;

    if (bn_mod_exp != 
# 265 "../crypto/bn/bn_blind.c" 3 4
                     ((void *)0)
# 265 "../crypto/bn/bn_blind.c"
                         )
        ret->bn_mod_exp = bn_mod_exp;
    if (m_ctx != 
# 267 "../crypto/bn/bn_blind.c" 3 4
                ((void *)0)
# 267 "../crypto/bn/bn_blind.c"
                    )
        ret->m_ctx = m_ctx;
    ...
    do {
        ...
        if (retry_counter-- == 0) {
            (ERR_new(), ERR_set_debug("../crypto/bn/bn_blind.c",284,__func__), ERR_set_error)((3),(113),
# 284 "../crypto/bn/bn_blind.c" 3 4
           ((void *)0)
# 284 "../crypto/bn/bn_blind.c"
           );
            goto err;
        }
    } while (1);
    ...
    if (ret->bn_mod_exp != 
# 289 "../crypto/bn/bn_blind.c" 3 4
                          ((void *)0) 
# 289 "../crypto/bn/bn_blind.c"
                               && ret->m_ctx != 
# 289 "../crypto/bn/bn_blind.c" 3 4
                                                ((void *)0)
# 289 "../crypto/bn/bn_blind.c"
    ...
    if (ret->m_ctx != 
# 297 "../crypto/bn/bn_blind.c" 3 4
                     ((void *)0)
# 297 "../crypto/bn/bn_blind.c"
                         ) {
 ...
 err:
    if (b == 
# 305 "../crypto/bn/bn_blind.c" 3 4
            ((void *)0)
# 305 "../crypto/bn/bn_blind.c"
                ) {
        BN_BLINDING_free(ret);
        ret = 
# 307 "../crypto/bn/bn_blind.c" 3 4
             ((void *)0)
# 307 "../crypto/bn/bn_blind.c"
                 ;
    }
