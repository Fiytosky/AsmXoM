...
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_dh.c"
# 10 "../crypto/bn/bn_dh.c"
# 1 "../crypto/bn/bn_local.h" 1
# 18 "../crypto/bn/bn_local.h"
...
# 19 "../crypto/bn/bn_local.h" 2


# 1 "include/crypto/bn_conf.h" 1
# 14 "include/crypto/bn_conf.h"
        
# 22 "../crypto/bn/bn_local.h" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 26 "../crypto/bn/bn_local.h" 2
# 235 "../crypto/bn/bn_local.h"
...
int bn_cmp_part_words(const unsigned long *a, const unsigned long *b, int cl, int dl);
...
{
    if (bits > (0x7fffffff 
# 671 "../crypto/bn/bn_local.h"
                       - (8 * 8) + 1))
        return 
# 672 "../crypto/bn/bn_local.h" 3 4
              ((void *)0)
# 672 "../crypto/bn/bn_local.h"
                  ;

    if (((bits+(8 * 8)-1)/(8 * 8)) <= (a)->dmax)
        return a;

    return bn_expand2((a),(bits+(8 * 8)-1)/(8 * 8));
}

int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 11 "../crypto/bn/bn_dh.c" 2
...
# 15 "../crypto/bn/bn_dh.c" 2
# 33 "../crypto/bn/bn_dh.c"
static const unsigned long modp_1536_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xF1746C08 << 32 | 0xCA237327,
    (unsigned long)0x670C354E << 32 | 0x4ABC9804, (unsigned long)0x9ED52907 << 32 | 0x7096966D,
    (unsigned long)0x1C62F356 << 32 | 0x208552BB, (unsigned long)0x83655D23 << 32 | 0xDCA3AD96,
    (unsigned long)0x69163FA8 << 32 | 0xFD24CF5F, (unsigned long)0x98DA4836 << 32 | 0x1C55D39A,
    (unsigned long)0xC2007CB8 << 32 | 0xA163BF05, (unsigned long)0x49286651 << 32 | 0xECE45B3D,
    (unsigned long)0xAE9F2411 << 32 | 0x7C4B1FE6, (unsigned long)0xEE386BFB << 32 | 0x5A899FA5,
    (unsigned long)0x0BFF5CB6 << 32 | 0xF406B7ED, (unsigned long)0xF44C42E9 << 32 | 0xA637ED6B,
    (unsigned long)0xE485B576 << 32 | 0x625E7EC6, (unsigned long)0x4FE1356D << 32 | 0x6D51C245,
    (unsigned long)0x302B0A6D << 32 | 0xF25F1437, (unsigned long)0xEF9519B3 << 32 | 0xCD3A431B,
    (unsigned long)0x514A0879 << 32 | 0x8E3404DD, (unsigned long)0x020BBEA6 << 32 | 0x3B139B22,
    (unsigned long)0x29024E08 << 32 | 0x8A67CC74, (unsigned long)0xC4C6628B << 32 | 0x80DC1CD1,
    (unsigned long)0xC90FDAA2 << 32 | 0x2168C234, (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF
};

static const unsigned long modp_1536_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x78BA3604 << 32 | 0x6511B993,
    (unsigned long)0xB3861AA7 << 32 | 0x255E4C02, (unsigned long)0xCF6A9483 << 32 | 0xB84B4B36,
    (unsigned long)0x0E3179AB << 32 | 0x1042A95D, (unsigned long)0xC1B2AE91 << 32 | 0xEE51D6CB,
    (unsigned long)0x348B1FD4 << 32 | 0x7E9267AF, (unsigned long)0xCC6D241B << 32 | 0x0E2AE9CD,
    (unsigned long)0xE1003E5C << 32 | 0x50B1DF82, (unsigned long)0x24943328 << 32 | 0xF6722D9E,
    (unsigned long)0xD74F9208 << 32 | 0xBE258FF3, (unsigned long)0xF71C35FD << 32 | 0xAD44CFD2,
    (unsigned long)0x85FFAE5B << 32 | 0x7A035BF6, (unsigned long)0x7A262174 << 32 | 0xD31BF6B5,
    (unsigned long)0xF242DABB << 32 | 0x312F3F63, (unsigned long)0xA7F09AB6 << 32 | 0xB6A8E122,
    (unsigned long)0x98158536 << 32 | 0xF92F8A1B, (unsigned long)0xF7CA8CD9 << 32 | 0xE69D218D,
    (unsigned long)0x28A5043C << 32 | 0xC71A026E, (unsigned long)0x0105DF53 << 32 | 0x1D89CD91,
    (unsigned long)0x94812704 << 32 | 0x4533E63A, (unsigned long)0x62633145 << 32 | 0xC06E0E68,
    (unsigned long)0xE487ED51 << 32 | 0x10B4611A, (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF
};
# 71 "../crypto/bn/bn_dh.c"
static const unsigned long modp_2048_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x15728E5A << 32 | 0x8AACAA68,
    (unsigned long)0x15D22618 << 32 | 0x98FA0510, (unsigned long)0x3995497C << 32 | 0xEA956AE5,
    (unsigned long)0xDE2BCBF6 << 32 | 0x95581718, (unsigned long)0xB5C55DF0 << 32 | 0x6F4C52C9,
    (unsigned long)0x9B2783A2 << 32 | 0xEC07A28F, (unsigned long)0xE39E772C << 32 | 0x180E8603,
    (unsigned long)0x32905E46 << 32 | 0x2E36CE3B, (unsigned long)0xF1746C08 << 32 | 0xCA18217C,
    (unsigned long)0x670C354E << 32 | 0x4ABC9804, (unsigned long)0x9ED52907 << 32 | 0x7096966D,
    (unsigned long)0x1C62F356 << 32 | 0x208552BB, (unsigned long)0x83655D23 << 32 | 0xDCA3AD96,
    (unsigned long)0x69163FA8 << 32 | 0xFD24CF5F, (unsigned long)0x98DA4836 << 32 | 0x1C55D39A,
    (unsigned long)0xC2007CB8 << 32 | 0xA163BF05, (unsigned long)0x49286651 << 32 | 0xECE45B3D,
...
static const unsigned long modp_2048_q[] = {
    (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x0AB9472D << 32 | 0x45565534,
    (unsigned long)0x8AE9130C << 32 | 0x4C7D0288, (unsigned long)0x1CCAA4BE << 32 | 0x754AB572,
    (unsigned long)0xEF15E5FB << 32 | 0x4AAC0B8C, (unsigned long)0xDAE2AEF8 << 32 | 0x37A62964,
    (unsigned long)0xCD93C1D1 << 32 | 0x7603D147, (unsigned long)0xF1CF3B96 << 32 | 0x0C074301,
    (unsigned long)0x19482F23 << 32 | 0x171B671D, (unsigned long)0x78BA3604 << 32 | 0x650C10BE,
    (unsigned long)0xB3861AA7 << 32 | 0x255E4C02, (unsigned long)0xCF6A9483 << 32 | 0xB84B4B36,
    (unsigned long)0x0E3179AB << 32 | 0x1042A95D, (unsigned long)0xC1B2AE91 << 32 | 0xEE51D6CB,
    (unsigned long)0x348B1FD4 << 32 | 0x7E9267AF, (unsigned long)0xCC6D241B << 32 | 0x0E2AE9CD,
    (unsigned long)0xE1003E5C << 32 | 0x50B1DF82, (unsigned long)0x24943328 << 32 | 0xF6722D9E,
...
# 116 "../crypto/bn/bn_dh.c"
static const unsigned long modp_3072_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x4B82D120 << 32 | 0xA93AD2CA,
    (unsigned long)0x43DB5BFC << 32 | 0xE0FD108E, (unsigned long)0x08E24FA0 << 32 | 0x74E5AB31,
    (unsigned long)0x770988C0 << 32 | 0xBAD946E2, (unsigned long)0xBBE11757 << 32 | 0x7A615D6C,
    (unsigned long)0x521F2B18 << 32 | 0x177B200C, (unsigned long)0xD8760273 << 32 | 0x3EC86A64,
    (unsigned long)0xF12FFA06 << 32 | 0xD98A0864, (unsigned long)0xCEE3D226 << 32 | 0x1AD2EE6B,
    (unsigned long)0x1E8C94E0 << 32 | 0x4A25619D, (unsigned long)0xABF5AE8C << 32 | 0xDB0933D7,
    (unsigned long)0xB3970F85 << 32 | 0xA6E1E4C7, (unsigned long)0x8AEA7157 << 32 | 0x5D060C7D,
    (unsigned long)0xECFB8504 << 32 | 0x58DBEF0A, (unsigned long)0xA85521AB << 32 | 0xDF1CBA64,
    (unsigned long)0xAD33170D << 32 | 0x04507A33, (unsigned long)0x15728E5A << 32 | 0x8AAAC42D,
    (unsigned long)0x15D22618 << 32 | 0x98FA0510, (unsigned long)0x3995497C << 32 | 0xEA956AE5,
    (unsigned long)0xDE2BCBF6 << 32 | 0x95581718, (unsigned long)0xB5C55DF0 << 32 | 0x6F4C52C9,
    (unsigned long)0x9B2783A2 << 32 | 0xEC07A28F, (unsigned long)0xE39E772C << 32 | 0x180E8603,
    (unsigned long)0x32905E46 << 32 | 0x2E36CE3B, (unsigned long)0xF1746C08 << 32 | 0xCA18217C,
...
static const unsigned long modp_3072_q[] = {
    (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x25C16890 << 32 | 0x549D6965,
    (unsigned long)0xA1EDADFE << 32 | 0x707E8847, (unsigned long)0x047127D0 << 32 | 0x3A72D598,
    (unsigned long)0x3B84C460 << 32 | 0x5D6CA371, (unsigned long)0x5DF08BAB << 32 | 0xBD30AEB6,
    (unsigned long)0x290F958C << 32 | 0x0BBD9006, (unsigned long)0x6C3B0139 << 32 | 0x9F643532,
    (unsigned long)0xF897FD03 << 32 | 0x6CC50432, (unsigned long)0xE771E913 << 32 | 0x0D697735,
    (unsigned long)0x8F464A70 << 32 | 0x2512B0CE, (unsigned long)0xD5FAD746 << 32 | 0x6D8499EB,
    (unsigned long)0xD9CB87C2 << 32 | 0xD370F263, (unsigned long)0x457538AB << 32 | 0xAE83063E,
    (unsigned long)0x767DC282 << 32 | 0x2C6DF785, (unsigned long)0xD42A90D5 << 32 | 0xEF8E5D32,
    (unsigned long)0xD6998B86 << 32 | 0x82283D19, (unsigned long)0x0AB9472D << 32 | 0x45556216,
    (unsigned long)0x8AE9130C << 32 | 0x4C7D0288, (unsigned long)0x1CCAA4BE << 32 | 0x754AB572,
    (unsigned long)0xEF15E5FB << 32 | 0x4AAC0B8C, (unsigned long)0xDAE2AEF8 << 32 | 0x37A62964,
    (unsigned long)0xCD93C1D1 << 32 | 0x7603D147, (unsigned long)0xF1CF3B96 << 32 | 0x0C074301,
    (unsigned long)0x19482F23 << 32 | 0x171B671D, (unsigned long)0x78BA3604 << 32 | 0x650C10BE,
...
# 177 "../crypto/bn/bn_dh.c"
static const unsigned long modp_4096_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x4DF435C9 << 32 | 0x34063199,
    (unsigned long)0x86FFB7DC << 32 | 0x90A6C08F, (unsigned long)0x93B4EA98 << 32 | 0x8D8FDDC1,
    (unsigned long)0xD0069127 << 32 | 0xD5B05AA9, (unsigned long)0xB81BDD76 << 32 | 0x2170481C,
    (unsigned long)0x1F612970 << 32 | 0xCEE2D7AF, (unsigned long)0x233BA186 << 32 | 0x515BE7ED,
    (unsigned long)0x99B2964F << 32 | 0xA090C3A2, (unsigned long)0x287C5947 << 32 | 0x4E6BC05D,
    (unsigned long)0x2E8EFC14 << 32 | 0x1FBECAA6, (unsigned long)0xDBBBC2DB << 32 | 0x04DE8EF9,
    (unsigned long)0x2583E9CA << 32 | 0x2AD44CE8, (unsigned long)0x1A946834 << 32 | 0xB6150BDA,
    (unsigned long)0x99C32718 << 32 | 0x6AF4E23C, (unsigned long)0x88719A10 << 32 | 0xBDBA5B26,
    (unsigned long)0x1A723C12 << 32 | 0xA787E6D7, (unsigned long)0x4B82D120 << 32 | 0xA9210801,
    (unsigned long)0x43DB5BFC << 32 | 0xE0FD108E, (unsigned long)0x08E24FA0 << 32 | 0x74E5AB31,
    (unsigned long)0x770988C0 << 32 | 0xBAD946E2, (unsigned long)0xBBE11757 << 32 | 0x7A615D6C,
    (unsigned long)0x521F2B18 << 32 | 0x177B200C, (unsigned long)0xD8760273 << 32 | 0x3EC86A64,
    (unsigned long)0xF12FFA06 << 32 | 0xD98A0864, (unsigned long)0xCEE3D226 << 32 | 0x1AD2EE6B,
...
static const unsigned long modp_4096_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xA6FA1AE4 << 32 | 0x9A0318CC,
    (unsigned long)0xC37FDBEE << 32 | 0x48536047, (unsigned long)0xC9DA754C << 32 | 0x46C7EEE0,
    (unsigned long)0x68034893 << 32 | 0xEAD82D54, (unsigned long)0xDC0DEEBB << 32 | 0x10B8240E,
    (unsigned long)0x8FB094B8 << 32 | 0x67716BD7, (unsigned long)0x119DD0C3 << 32 | 0x28ADF3F6,
    (unsigned long)0xCCD94B27 << 32 | 0xD04861D1, (unsigned long)0x143E2CA3 << 32 | 0xA735E02E,
    (unsigned long)0x97477E0A << 32 | 0x0FDF6553, (unsigned long)0x6DDDE16D << 32 | 0x826F477C,
    (unsigned long)0x12C1F4E5 << 32 | 0x156A2674, (unsigned long)0x0D4A341A << 32 | 0x5B0A85ED,
    (unsigned long)0x4CE1938C << 32 | 0x357A711E, (unsigned long)0xC438CD08 << 32 | 0x5EDD2D93,
    (unsigned long)0x8D391E09 << 32 | 0x53C3F36B, (unsigned long)0x25C16890 << 32 | 0x54908400,
    (unsigned long)0xA1EDADFE << 32 | 0x707E8847, (unsigned long)0x047127D0 << 32 | 0x3A72D598,
    (unsigned long)0x3B84C460 << 32 | 0x5D6CA371, (unsigned long)0x5DF08BAB << 32 | 0xBD30AEB6,
    (unsigned long)0x290F958C << 32 | 0x0BBD9006, (unsigned long)0x6C3B0139 << 32 | 0x9F643532,
    (unsigned long)0xF897FD03 << 32 | 0x6CC50432, (unsigned long)0xE771E913 << 32 | 0x0D697735,
...
# 254 "../crypto/bn/bn_dh.c"
static const unsigned long modp_6144_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xE694F91E << 32 | 0x6DCC4024,
    (unsigned long)0x12BF2D5B << 32 | 0x0B7474D6, (unsigned long)0x043E8F66 << 32 | 0x3F4860EE,
    (unsigned long)0x387FE8D7 << 32 | 0x6E3C0468, (unsigned long)0xDA56C9EC << 32 | 0x2EF29632,
    (unsigned long)0xEB19CCB1 << 32 | 0xA313D55C, (unsigned long)0xF550AA3D << 32 | 0x8A1FBFF0,
    (unsigned long)0x06A1D58B << 32 | 0xB7C5DA76, (unsigned long)0xA79715EE << 32 | 0xF29BE328,
    (unsigned long)0x14CC5ED2 << 32 | 0x0F8037E0, (unsigned long)0xCC8F6D7E << 32 | 0xBF48E1D8,
    (unsigned long)0x4BD407B2 << 32 | 0x2B4154AA, (unsigned long)0x0F1D45B7 << 32 | 0xFF585AC5,
    (unsigned long)0x23A97A7E << 32 | 0x36CC88BE, (unsigned long)0x59E7C97F << 32 | 0xBEC7E8F3,
    (unsigned long)0xB5A84031 << 32 | 0x900B1C9E, (unsigned long)0xD55E702F << 32 | 0x46980C82,
    (unsigned long)0xF482D7CE << 32 | 0x6E74FEF6, (unsigned long)0xF032EA15 << 32 | 0xD1721D03,
    (unsigned long)0x5983CA01 << 32 | 0xC64B92EC, (unsigned long)0x6FB8F401 << 32 | 0x378CD2BF,
    (unsigned long)0x33205151 << 32 | 0x2BD7AF42, (unsigned long)0xDB7F1447 << 32 | 0xE6CC254B,
    (unsigned long)0x44CE6CBA << 32 | 0xCED4BB1B, (unsigned long)0xDA3EDBEB << 32 | 0xCF9B14ED,
    (unsigned long)0x179727B0 << 32 | 0x865A8918, (unsigned long)0xB06A53ED << 32 | 0x9027D831,
    (unsigned long)0xE5DB382F << 32 | 0x413001AE, (unsigned long)0xF8FF9406 << 32 | 0xAD9E530E,
    (unsigned long)0xC9751E76 << 32 | 0x3DBA37BD, (unsigned long)0xC1D4DCB2 << 32 | 0x602646DE,
    (unsigned long)0x36C3FAB4 << 32 | 0xD27C7026, (unsigned long)0x4DF435C9 << 32 | 0x34028492,
    (unsigned long)0x86FFB7DC << 32 | 0x90A6C08F, (unsigned long)0x93B4EA98 << 32 | 0x8D8FDDC1,
    (unsigned long)0xD0069127 << 32 | 0xD5B05AA9, (unsigned long)0xB81BDD76 << 32 | 0x2170481C,
    (unsigned long)0x1F612970 << 32 | 0xCEE2D7AF, (unsigned long)0x233BA186 << 32 | 0x515BE7ED,
    (unsigned long)0x99B2964F << 32 | 0xA090C3A2, (unsigned long)0x287C5947 << 32 | 0x4E6BC05D,
...
static const unsigned long modp_6144_q[] = {
    (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x734A7C8F << 32 | 0x36E62012,
    (unsigned long)0x095F96AD << 32 | 0x85BA3A6B, (unsigned long)0x021F47B3 << 32 | 0x1FA43077,
    (unsigned long)0x1C3FF46B << 32 | 0xB71E0234, (unsigned long)0x6D2B64F6 << 32 | 0x17794B19,
    (unsigned long)0x758CE658 << 32 | 0xD189EAAE, (unsigned long)0x7AA8551E << 32 | 0xC50FDFF8,
    (unsigned long)0x0350EAC5 << 32 | 0xDBE2ED3B, (unsigned long)0x53CB8AF7 << 32 | 0x794DF194,
    (unsigned long)0x0A662F69 << 32 | 0x07C01BF0, (unsigned long)0x6647B6BF << 32 | 0x5FA470EC,
    (unsigned long)0xA5EA03D9 << 32 | 0x15A0AA55, (unsigned long)0x078EA2DB << 32 | 0xFFAC2D62,
    (unsigned long)0x91D4BD3F << 32 | 0x1B66445F, (unsigned long)0x2CF3E4BF << 32 | 0xDF63F479,
    (unsigned long)0x5AD42018 << 32 | 0xC8058E4F, (unsigned long)0x6AAF3817 << 32 | 0xA34C0641,
    (unsigned long)0xFA416BE7 << 32 | 0x373A7F7B, (unsigned long)0x7819750A << 32 | 0xE8B90E81,
    (unsigned long)0xACC1E500 << 32 | 0xE325C976, (unsigned long)0x37DC7A00 << 32 | 0x9BC6695F,
    (unsigned long)0x999028A8 << 32 | 0x95EBD7A1, (unsigned long)0xEDBF8A23 << 32 | 0xF36612A5,
    (unsigned long)0xA267365D << 32 | 0x676A5D8D, (unsigned long)0x6D1F6DF5 << 32 | 0xE7CD8A76,
    (unsigned long)0x8BCB93D8 << 32 | 0x432D448C, (unsigned long)0x583529F6 << 32 | 0xC813EC18,
    (unsigned long)0x72ED9C17 << 32 | 0xA09800D7, (unsigned long)0xFC7FCA03 << 32 | 0x56CF2987,
    (unsigned long)0x64BA8F3B << 32 | 0x1EDD1BDE, (unsigned long)0x60EA6E59 << 32 | 0x3013236F,
    (unsigned long)0x1B61FD5A << 32 | 0x693E3813, (unsigned long)0xA6FA1AE4 << 32 | 0x9A014249,
    (unsigned long)0xC37FDBEE << 32 | 0x48536047, (unsigned long)0xC9DA754C << 32 | 0x46C7EEE0,
    (unsigned long)0x68034893 << 32 | 0xEAD82D54, (unsigned long)0xDC0DEEBB << 32 | 0x10B8240E,
    (unsigned long)0x8FB094B8 << 32 | 0x67716BD7, (unsigned long)0x119DD0C3 << 32 | 0x28ADF3F6,
    (unsigned long)0xCCD94B27 << 32 | 0xD04861D1, (unsigned long)0x143E2CA3 << 32 | 0xA735E02E,
...
# 363 "../crypto/bn/bn_dh.c"
static const unsigned long modp_8192_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x60C980DD << 32 | 0x98EDD3DF,
    (unsigned long)0xC81F56E8 << 32 | 0x80B96E71, (unsigned long)0x9E3050E2 << 32 | 0x765694DF,
    (unsigned long)0x9558E447 << 32 | 0x5677E9AA, (unsigned long)0xC9190DA6 << 32 | 0xFC026E47,
    (unsigned long)0x889A002E << 32 | 0xD5EE382B, (unsigned long)0x4009438B << 32 | 0x481C6CD7,
    (unsigned long)0x359046F4 << 32 | 0xEB879F92, (unsigned long)0xFAF36BC3 << 32 | 0x1ECFA268,
    (unsigned long)0xB1D510BD << 32 | 0x7EE74D73, (unsigned long)0xF9AB4819 << 32 | 0x5DED7EA1,
    (unsigned long)0x64F31CC5 << 32 | 0x0846851D, (unsigned long)0x4597E899 << 32 | 0xA0255DC1,
    (unsigned long)0xDF310EE0 << 32 | 0x74AB6A36, (unsigned long)0x6D2A13F8 << 32 | 0x3F44F82D,
    (unsigned long)0x062B3CF5 << 32 | 0xB3A278A6, (unsigned long)0x79683303 << 32 | 0xED5BDD3A,
    (unsigned long)0xFA9D4B7F << 32 | 0xA2C087E8, (unsigned long)0x4BCBC886 << 32 | 0x2F8385DD,
    (unsigned long)0x3473FC64 << 32 | 0x6CEA306B, (unsigned long)0x13EB57A8 << 32 | 0x1A23F0C7,
    (unsigned long)0x22222E04 << 32 | 0xA4037C07, (unsigned long)0xE3FDB8BE << 32 | 0xFC848AD9,
    (unsigned long)0x238F16CB << 32 | 0xE39D652D, (unsigned long)0x3423B474 << 32 | 0x2BF1C978,
    (unsigned long)0x3AAB639C << 32 | 0x5AE4F568, (unsigned long)0x2576F693 << 32 | 0x6BA42466,
    (unsigned long)0x741FA7BF << 32 | 0x8AFC47ED, (unsigned long)0x3BC832B6 << 32 | 0x8D9DD300,
    (unsigned long)0xD8BEC4D0 << 32 | 0x73B931BA, (unsigned long)0x38777CB6 << 32 | 0xA932DF8C,
    (unsigned long)0x74A3926F << 32 | 0x12FEE5E4, (unsigned long)0xE694F91E << 32 | 0x6DBE1159,
    (unsigned long)0x12BF2D5B << 32 | 0x0B7474D6, (unsigned long)0x043E8F66 << 32 | 0x3F4860EE,
    (unsigned long)0x387FE8D7 << 32 | 0x6E3C0468, (unsigned long)0xDA56C9EC << 32 | 0x2EF29632,
    (unsigned long)0xEB19CCB1 << 32 | 0xA313D55C, (unsigned long)0xF550AA3D << 32 | 0x8A1FBFF0,
    (unsigned long)0x06A1D58B << 32 | 0xB7C5DA76, (unsigned long)0xA79715EE << 32 | 0xF29BE328,
...
static const unsigned long modp_8192_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xB064C06E << 32 | 0xCC76E9EF,
    (unsigned long)0xE40FAB74 << 32 | 0x405CB738, (unsigned long)0x4F182871 << 32 | 0x3B2B4A6F,
    (unsigned long)0xCAAC7223 << 32 | 0xAB3BF4D5, (unsigned long)0xE48C86D3 << 32 | 0x7E013723,
    (unsigned long)0xC44D0017 << 32 | 0x6AF71C15, (unsigned long)0x2004A1C5 << 32 | 0xA40E366B,
    (unsigned long)0x1AC8237A << 32 | 0x75C3CFC9, (unsigned long)0xFD79B5E1 << 32 | 0x8F67D134,
    (unsigned long)0xD8EA885E << 32 | 0xBF73A6B9, (unsigned long)0xFCD5A40C << 32 | 0xAEF6BF50,
    (unsigned long)0xB2798E62 << 32 | 0x8423428E, (unsigned long)0x22CBF44C << 32 | 0xD012AEE0,
    (unsigned long)0xEF988770 << 32 | 0x3A55B51B, (unsigned long)0x369509FC << 32 | 0x1FA27C16,
    (unsigned long)0x03159E7A << 32 | 0xD9D13C53, (unsigned long)0x3CB41981 << 32 | 0xF6ADEE9D,
    (unsigned long)0xFD4EA5BF << 32 | 0xD16043F4, (unsigned long)0xA5E5E443 << 32 | 0x17C1C2EE,
    (unsigned long)0x9A39FE32 << 32 | 0x36751835, (unsigned long)0x89F5ABD4 << 32 | 0x0D11F863,
    (unsigned long)0x91111702 << 32 | 0x5201BE03, (unsigned long)0xF1FEDC5F << 32 | 0x7E42456C,
    (unsigned long)0x11C78B65 << 32 | 0xF1CEB296, (unsigned long)0x1A11DA3A << 32 | 0x15F8E4BC,
    (unsigned long)0x1D55B1CE << 32 | 0x2D727AB4, (unsigned long)0x92BB7B49 << 32 | 0xB5D21233,
    (unsigned long)0x3A0FD3DF << 32 | 0xC57E23F6, (unsigned long)0x1DE4195B << 32 | 0x46CEE980,
    (unsigned long)0x6C5F6268 << 32 | 0x39DC98DD, (unsigned long)0x1C3BBE5B << 32 | 0x54996FC6,
    (unsigned long)0xBA51C937 << 32 | 0x897F72F2, (unsigned long)0x734A7C8F << 32 | 0x36DF08AC,
    (unsigned long)0x095F96AD << 32 | 0x85BA3A6B, (unsigned long)0x021F47B3 << 32 | 0x1FA43077,
    (unsigned long)0x1C3FF46B << 32 | 0xB71E0234, (unsigned long)0x6D2B64F6 << 32 | 0x17794B19,
    (unsigned long)0x758CE658 << 32 | 0xD189EAAE, (unsigned long)0x7AA8551E << 32 | 0xC50FDFF8,
    (unsigned long)0x0350EAC5 << 32 | 0xDBE2ED3B, (unsigned long)0x53CB8AF7 << 32 | 0x794DF194,
...
static const unsigned long dh1024_160_p[] = {
    (unsigned long)0xDF1FB2BC << 32 | 0x2E4A4371, (unsigned long)0xE68CFDA7 << 32 | 0x6D4DA708,
    (unsigned long)0x45BF37DF << 32 | 0x365C1A65, (unsigned long)0xA151AF5F << 32 | 0x0DC8B4BD,
    (unsigned long)0xFAA31A4F << 32 | 0xF55BCCC0, (unsigned long)0x4EFFD6FA << 32 | 0xE5644738,
    (unsigned long)0x98488E9C << 32 | 0x219A7372, (unsigned long)0xACCBDD7D << 32 | 0x90C4BD70,
    (unsigned long)0x24975C3C << 32 | 0xD49B83BF, (unsigned long)0x13ECB4AE << 32 | 0xA9061123,
    (unsigned long)0x9838EF1E << 32 | 0x2EE652C0, (unsigned long)0x6073E286 << 32 | 0x75A23D18,
    (unsigned long)0x9A6A9DCA << 32 | 0x52D23B61, (unsigned long)0x52C99FBC << 32 | 0xFB06A3C6,
    (unsigned long)0xDE92DE5E << 32 | 0xAE5D54EC, (unsigned long)0xB10B8F96 << 32 | 0xA080E01D
};
static const unsigned long dh1024_160_q[] = {
    (unsigned long)0x64B7CB9D << 32 | 0x49462353, (unsigned long)0x81A8DF27 << 32 | 0x8ABA4E7D,
    (unsigned long)0xF518AA87
};
static const unsigned long dh1024_160_g[] = {
    (unsigned long)0x855E6EEB << 32 | 0x22B3B2E5, (unsigned long)0x858F4DCE << 32 | 0xF97C2A24,
    (unsigned long)0x2D779D59 << 32 | 0x18D08BC8, (unsigned long)0xD662A4D1 << 32 | 0x8E73AFA3,
    (unsigned long)0x1DBF0A01 << 32 | 0x69B6A28A, (unsigned long)0xA6A24C08 << 32 | 0x7A091F53,
    (unsigned long)0x909D0D22 << 32 | 0x63F80A76, (unsigned long)0xD7FBD7D3 << 32 | 0xB9A92EE1,
    (unsigned long)0x5E91547F << 32 | 0x9E2749F4, (unsigned long)0x160217B4 << 32 | 0xB01B886A,
    (unsigned long)0x777E690F << 32 | 0x5504F213, (unsigned long)0x266FEA1E << 32 | 0x5C41564B,
    (unsigned long)0xD6406CFF << 32 | 0x14266D31, (unsigned long)0xF8104DD2 << 32 | 0x58AC507F,
    (unsigned long)0x6765A442 << 32 | 0xEFB99905, (unsigned long)0xA4D1CBD5 << 32 | 0xC3FD3412
};

static const unsigned long dh2048_224_p[] = {
    (unsigned long)0x0AC4DFFE << 32 | 0x0C10E64F, (unsigned long)0xCF9DE538 << 32 | 0x4E71B81C,
    (unsigned long)0x7EF363E2 << 32 | 0xFFA31F71, (unsigned long)0xE3FB73C1 << 32 | 0x6B8E75B9,
    (unsigned long)0xC9B53DCF << 32 | 0x4BA80A29, (unsigned long)0x23F10B0E << 32 | 0x16E79763,
    (unsigned long)0xC52172E4 << 32 | 0x13042E9B, (unsigned long)0xBE60E69C << 32 | 0xC928B2B9,
    (unsigned long)0x80CD86A1 << 32 | 0xB9E587E8, (unsigned long)0x315D75E1 << 32 | 0x98C641A4,
    (unsigned long)0xCDF93ACC << 32 | 0x44328387, (unsigned long)0x15987D9A << 32 | 0xDC0A486D,
    (unsigned long)0x7310F712 << 32 | 0x1FD5A074, (unsigned long)0x278273C7 << 32 | 0xDE31EFDC,
    (unsigned long)0x1602E714 << 32 | 0x415D9330, (unsigned long)0x81286130 << 32 | 0xBC8985DB,
    (unsigned long)0xB3BF8A31 << 32 | 0x70918836, (unsigned long)0x6A00E0A0 << 32 | 0xB9C49708,
    (unsigned long)0xC6BA0B2C << 32 | 0x8BBC27BE, (unsigned long)0xC9F98D11 << 32 | 0xED34DBF6,
    (unsigned long)0x7AD5B7D0 << 32 | 0xB6C12207, (unsigned long)0xD91E8FEF << 32 | 0x55B7394B,
    (unsigned long)0x9037C9ED << 32 | 0xEFDA4DF8, (unsigned long)0x6D3F8152 << 32 | 0xAD6AC212,
    (unsigned long)0x1DE6B85A << 32 | 0x1274A0A6, (unsigned long)0xEB3D688A << 32 | 0x309C180E,
    (unsigned long)0xAF9A3C40 << 32 | 0x7BA1DF15, (unsigned long)0xE6FA141D << 32 | 0xF95A56DB,
    (unsigned long)0xB54B1597 << 32 | 0xB61D0A75, (unsigned long)0xA20D64E5 << 32 | 0x683B9FD1,
    (unsigned long)0xD660FAA7 << 32 | 0x9559C51F, (unsigned long)0xAD107E1E << 32 | 0x9123A9D0
};
static const unsigned long dh2048_224_q[] = {
    (unsigned long)0xBF389A99 << 32 | 0xB36371EB, (unsigned long)0x1F80535A << 32 | 0x4738CEBC,
    (unsigned long)0xC58D93FE << 32 | 0x99717710, (unsigned long)0x801C0D34
};
static const unsigned long dh2048_224_g[] = {
    (unsigned long)0x84B890D3 << 32 | 0x191F2BFA, (unsigned long)0x81BC087F << 32 | 0x2A7065B3,
    (unsigned long)0x19C418E1 << 32 | 0xF6EC0179, (unsigned long)0x7B5A0F1C << 32 | 0x71CFFF4C,
    (unsigned long)0xEDFE72FE << 32 | 0x9B6AA4BD, (unsigned long)0x81E1BCFE << 32 | 0x94B30269,
    (unsigned long)0x566AFBB4 << 32 | 0x8D6C0191, (unsigned long)0xB539CCE3 << 32 | 0x409D13CD,
    (unsigned long)0x6AA21E7F << 32 | 0x5F2FF381, (unsigned long)0xD9E263E4 << 32 | 0x770589EF,
    (unsigned long)0x10E183ED << 32 | 0xD19963DD, (unsigned long)0xB70A8137 << 32 | 0x150B8EEB,
    (unsigned long)0x051AE3D4 << 32 | 0x28C8F8AC, (unsigned long)0xBB77A86F << 32 | 0x0C1AB15B,
    (unsigned long)0x6E3025E3 << 32 | 0x16A330EF, (unsigned long)0x19529A45 << 32 | 0xD6F83456,
    (unsigned long)0xF180EB34 << 32 | 0x118E98D1, (unsigned long)0xB5F6C6B2 << 32 | 0x50717CBE,
    (unsigned long)0x09939D54 << 32 | 0xDA7460CD, (unsigned long)0xE2471504 << 32 | 0x22EA1ED4,
    (unsigned long)0xB8A762D0 << 32 | 0x521BC98A, (unsigned long)0xF4D02727 << 32 | 0x5AC1348B,
    (unsigned long)0xC1766910 << 32 | 0x1999024A, (unsigned long)0xBE5E9001 << 32 | 0xA8D66AD7,
    (unsigned long)0xC57DB17C << 32 | 0x620A8652, (unsigned long)0xAB739D77 << 32 | 0x00C29F52,
    (unsigned long)0xDD921F01 << 32 | 0xA70C4AFA, (unsigned long)0xA6824A4E << 32 | 0x10B9A6F0,
    (unsigned long)0x74866A08 << 32 | 0xCFE4FFE3, (unsigned long)0x6CDEBE7B << 32 | 0x89998CAF,
    (unsigned long)0x9DF30B5C << 32 | 0x8FFDAC50, (unsigned long)0xAC4032EF << 32 | 0x4F2D9AE3
};

static const unsigned long dh2048_256_p[] = {
    (unsigned long)0xDB094AE9 << 32 | 0x1E1A1597, (unsigned long)0x693877FA << 32 | 0xD7EF09CA,
    (unsigned long)0x6116D227 << 32 | 0x6E11715F, (unsigned long)0xA4B54330 << 32 | 0xC198AF12,
    (unsigned long)0x75F26375 << 32 | 0xD7014103, (unsigned long)0xC3A3960A << 32 | 0x54E710C3,
    (unsigned long)0xDED4010A << 32 | 0xBD0BE621, (unsigned long)0xC0B857F6 << 32 | 0x89962856,
    (unsigned long)0xB3CA3F79 << 32 | 0x71506026, (unsigned long)0x1CCACB83 << 32 | 0xE6B486F6,
    (unsigned long)0x67E144E5 << 32 | 0x14056425, (unsigned long)0xF6A167B5 << 32 | 0xA41825D9,
    (unsigned long)0x3AD83477 << 32 | 0x96524D8E, (unsigned long)0xF13C6D9A << 32 | 0x51BFA4AB,
    (unsigned long)0x2D525267 << 32 | 0x35488A0E, (unsigned long)0xB63ACAE1 << 32 | 0xCAA6B790,
    (unsigned long)0x4FDB70C5 << 32 | 0x81B23F76, (unsigned long)0xBC39A0BF << 32 | 0x12307F5C,
    (unsigned long)0xB941F54E << 32 | 0xB1E59BB8, (unsigned long)0x6C5BFC11 << 32 | 0xD45F9088,
    (unsigned long)0x22E0B1EF << 32 | 0x4275BF7B, (unsigned long)0x91F9E672 << 32 | 0x5B4758C0,
    (unsigned long)0x5A8A9D30 << 32 | 0x6BCF67ED, (unsigned long)0x209E0C64 << 32 | 0x97517ABD,
    (unsigned long)0x3BF4296D << 32 | 0x830E9A7C, (unsigned long)0x16C3D911 << 32 | 0x34096FAA,
    (unsigned long)0xFAF7DF45 << 32 | 0x61B2AA30, (unsigned long)0xE00DF8F1 << 32 | 0xD61957D4,
    (unsigned long)0x5D2CEED4 << 32 | 0x435E3B00, (unsigned long)0x8CEEF608 << 32 | 0x660DD0F2,
    (unsigned long)0xFFBBD19C << 32 | 0x65195999, (unsigned long)0x87A8E61D << 32 | 0xB4B6663C
};
static const unsigned long dh2048_256_q[] = {
    (unsigned long)0xA308B0FE << 32 | 0x64F5FBD3, (unsigned long)0x99B1A47D << 32 | 0x1EB3750B,
    (unsigned long)0xB4479976 << 32 | 0x40129DA2, (unsigned long)0x8CF83642 << 32 | 0xA709A097
};
static const unsigned long dh2048_256_g[] = {
    (unsigned long)0x664B4C0F << 32 | 0x6CC41659, (unsigned long)0x5E2327CF << 32 | 0xEF98C582,
    (unsigned long)0xD647D148 << 32 | 0xD4795451, (unsigned long)0x2F630784 << 32 | 0x90F00EF8,
    (unsigned long)0x184B523D << 32 | 0x1DB246C3, (unsigned long)0xC7891428 << 32 | 0xCDC67EB6,
    (unsigned long)0x7FD02837 << 32 | 0x0DF92B52, (unsigned long)0xB3353BBB << 32 | 0x64E0EC37,
    (unsigned long)0xECD06E15 << 32 | 0x57CD0915, (unsigned long)0xB7D2BBD2 << 32 | 0xDF016199,
    (unsigned long)0xC8484B1E << 32 | 0x052588B9, (unsigned long)0xDB2A3B73 << 32 | 0x13D3FE14,
    (unsigned long)0xD052B985 << 32 | 0xD182EA0A, (unsigned long)0xA4BD1BFF << 32 | 0xE83B9C80,
    (unsigned long)0xDFC967C1 << 32 | 0xFB3F2E55, (unsigned long)0xB5045AF2 << 32 | 0x767164E1,
    (unsigned long)0x1D14348F << 32 | 0x6F2F9193, (unsigned long)0x64E67982 << 32 | 0x428EBC83,
    (unsigned long)0x8AC376D2 << 32 | 0x82D6ED38, (unsigned long)0x777DE62A << 32 | 0xAAB8A862,
    (unsigned long)0xDDF463E5 << 32 | 0xE9EC144B, (unsigned long)0x0196F931 << 32 | 0xC77A57F2,
    (unsigned long)0xA55AE313 << 32 | 0x41000A65, (unsigned long)0x901228F8 << 32 | 0xC28CBB18,
    (unsigned long)0xBC3773BF << 32 | 0x7E8C6F62, (unsigned long)0xBE3A6C1B << 32 | 0x0C6B47B1,
    (unsigned long)0xFF4FED4A << 32 | 0xAC0BB555, (unsigned long)0x10DBC150 << 32 | 0x77BE463F,
    (unsigned long)0x07F4793A << 32 | 0x1A0BA125, (unsigned long)0x4CA7B18F << 32 | 0x21EF2054,
    (unsigned long)0x2E775066 << 32 | 0x60EDBD48, (unsigned long)0x3FB32C9B << 32 | 0x73134D0B
};


static const unsigned long ffdhe2048_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x886B4238 << 32 | 0x61285C97,
    (unsigned long)0xC6F34A26 << 32 | 0xC1B2EFFA, (unsigned long)0xC58EF183 << 32 | 0x7D1683B2,
    (unsigned long)0x3BB5FCBC << 32 | 0x2EC22005, (unsigned long)0xC3FE3B1B << 32 | 0x4C6FAD73,
    (unsigned long)0x8E4F1232 << 32 | 0xEEF28183, (unsigned long)0x9172FE9C << 32 | 0xE98583FF,
    (unsigned long)0xC03404CD << 32 | 0x28342F61, (unsigned long)0x9E02FCE1 << 32 | 0xCDF7E2EC,
    (unsigned long)0x0B07A7C8 << 32 | 0xEE0A6D70, (unsigned long)0xAE56EDE7 << 32 | 0x6372BB19,
    (unsigned long)0x1D4F42A3 << 32 | 0xDE394DF4, (unsigned long)0xB96ADAB7 << 32 | 0x60D7F468,
    (unsigned long)0xD108A94B << 32 | 0xB2C8E3FB, (unsigned long)0xBC0AB182 << 32 | 0xB324FB61,
    (unsigned long)0x30ACCA4F << 32 | 0x483A797A, (unsigned long)0x1DF158A1 << 32 | 0x36ADE735,
    (unsigned long)0xE2A689DA << 32 | 0xF3EFE872, (unsigned long)0x984F0C70 << 32 | 0xE0E68B77,
    (unsigned long)0xB557135E << 32 | 0x7F57C935, (unsigned long)0x85636555 << 32 | 0x3DED1AF3,
    (unsigned long)0x2433F51F << 32 | 0x5F066ED0, (unsigned long)0xD3DF1ED5 << 32 | 0xD5FD6561,
    (unsigned long)0xF681B202 << 32 | 0xAEC4617A, (unsigned long)0x7D2FE363 << 32 | 0x630C75D8,
    (unsigned long)0xCC939DCE << 32 | 0x249B3EF9, (unsigned long)0xA9E13641 << 32 | 0x146433FB,
    (unsigned long)0xD8B9C583 << 32 | 0xCE2D3695, (unsigned long)0xAFDC5620 << 32 | 0x273D3CF1,
    (unsigned long)0xADF85458 << 32 | 0xA2BB4A9A, (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF
};

static const unsigned long ffdhe2048_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x4435A11C << 32 | 0x30942E4B,
    (unsigned long)0x6379A513 << 32 | 0x60D977FD, (unsigned long)0xE2C778C1 << 32 | 0xBE8B41D9,
    (unsigned long)0x9DDAFE5E << 32 | 0x17611002, (unsigned long)0xE1FF1D8D << 32 | 0xA637D6B9,
    (unsigned long)0xC7278919 << 32 | 0x777940C1, (unsigned long)0xC8B97F4E << 32 | 0x74C2C1FF,
    (unsigned long)0x601A0266 << 32 | 0x941A17B0, (unsigned long)0x4F017E70 << 32 | 0xE6FBF176,
    (unsigned long)0x8583D3E4 << 32 | 0x770536B8, (unsigned long)0x572B76F3 << 32 | 0xB1B95D8C,
    (unsigned long)0x0EA7A151 << 32 | 0xEF1CA6FA, (unsigned long)0xDCB56D5B << 32 | 0xB06BFA34,
    (unsigned long)0xE88454A5 << 32 | 0xD96471FD, (unsigned long)0x5E0558C1 << 32 | 0x59927DB0,
    (unsigned long)0x98566527 << 32 | 0xA41D3CBD, (unsigned long)0x0EF8AC50 << 32 | 0x9B56F39A,
    (unsigned long)0xF15344ED << 32 | 0x79F7F439, (unsigned long)0xCC278638 << 32 | 0x707345BB,
    (unsigned long)0xDAAB89AF << 32 | 0x3FABE49A, (unsigned long)0x42B1B2AA << 32 | 0x9EF68D79,
    (unsigned long)0x9219FA8F << 32 | 0xAF833768, (unsigned long)0x69EF8F6A << 32 | 0xEAFEB2B0,
    (unsigned long)0x7B40D901 << 32 | 0x576230BD, (unsigned long)0xBE97F1B1 << 32 | 0xB1863AEC,
    (unsigned long)0xE649CEE7 << 32 | 0x124D9F7C, (unsigned long)0xD4F09B20 << 32 | 0x8A3219FD,
    (unsigned long)0xEC5CE2C1 << 32 | 0xE7169B4A, (unsigned long)0x57EE2B10 << 32 | 0x139E9E78,
    (unsigned long)0xD6FC2A2C << 32 | 0x515DA54D, (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF,
};

static const unsigned long ffdhe3072_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x25E41D2B << 32 | 0x66C62E37,
    (unsigned long)0x3C1B20EE << 32 | 0x3FD59D7C, (unsigned long)0x0ABCD06B << 32 | 0xFA53DDEF,
    (unsigned long)0x1DBF9A42 << 32 | 0xD5C4484E, (unsigned long)0xABC52197 << 32 | 0x9B0DEADA,
    (unsigned long)0xE86D2BC5 << 32 | 0x22363A0D, (unsigned long)0x5CAE82AB << 32 | 0x9C9DF69E,
    (unsigned long)0x64F2E21E << 32 | 0x71F54BFF, (unsigned long)0xF4FD4452 << 32 | 0xE2D74DD3,
    (unsigned long)0xB4130C93 << 32 | 0xBC437944, (unsigned long)0xAEFE1309 << 32 | 0x85139270,
    (unsigned long)0x598CB0FA << 32 | 0xC186D91C, (unsigned long)0x7AD91D26 << 32 | 0x91F7F7EE,
    (unsigned long)0x61B46FC9 << 32 | 0xD6E6C907, (unsigned long)0xBC34F4DE << 32 | 0xF99C0238,
    (unsigned long)0xDE355B3B << 32 | 0x6519035B, (unsigned long)0x886B4238 << 32 | 0x611FCFDC,
    (unsigned long)0xC6F34A26 << 32 | 0xC1B2EFFA, (unsigned long)0xC58EF183 << 32 | 0x7D1683B2,
    (unsigned long)0x3BB5FCBC << 32 | 0x2EC22005, (unsigned long)0xC3FE3B1B << 32 | 0x4C6FAD73,
    (unsigned long)0x8E4F1232 << 32 | 0xEEF28183, (unsigned long)0x9172FE9C << 32 | 0xE98583FF,
    (unsigned long)0xC03404CD << 32 | 0x28342F61, (unsigned long)0x9E02FCE1 << 32 | 0xCDF7E2EC,
...
static const unsigned long ffdhe3072_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x12F20E95 << 32 | 0xB363171B,
    (unsigned long)0x9E0D9077 << 32 | 0x1FEACEBE, (unsigned long)0x055E6835 << 32 | 0xFD29EEF7,
    (unsigned long)0x0EDFCD21 << 32 | 0x6AE22427, (unsigned long)0xD5E290CB << 32 | 0xCD86F56D,
    (unsigned long)0x743695E2 << 32 | 0x911B1D06, (unsigned long)0xAE574155 << 32 | 0xCE4EFB4F,
    (unsigned long)0xB279710F << 32 | 0x38FAA5FF, (unsigned long)0x7A7EA229 << 32 | 0x716BA6E9,
    (unsigned long)0x5A098649 << 32 | 0xDE21BCA2, (unsigned long)0x577F0984 << 32 | 0xC289C938,
    (unsigned long)0x2CC6587D << 32 | 0x60C36C8E, (unsigned long)0xBD6C8E93 << 32 | 0x48FBFBF7,
    (unsigned long)0x30DA37E4 << 32 | 0xEB736483, (unsigned long)0xDE1A7A6F << 32 | 0x7CCE011C,
    (unsigned long)0x6F1AAD9D << 32 | 0xB28C81AD, (unsigned long)0x4435A11C << 32 | 0x308FE7EE,
    (unsigned long)0x6379A513 << 32 | 0x60D977FD, (unsigned long)0xE2C778C1 << 32 | 0xBE8B41D9,
    (unsigned long)0x9DDAFE5E << 32 | 0x17611002, (unsigned long)0xE1FF1D8D << 32 | 0xA637D6B9,
    (unsigned long)0xC7278919 << 32 | 0x777940C1, (unsigned long)0xC8B97F4E << 32 | 0x74C2C1FF,
    (unsigned long)0x601A0266 << 32 | 0x941A17B0, (unsigned long)0x4F017E70 << 32 | 0xE6FBF176,
...
static const unsigned long ffdhe4096_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xC68A007E << 32 | 0x5E655F6A,
    (unsigned long)0x4DB5A851 << 32 | 0xF44182E1, (unsigned long)0x8EC9B55A << 32 | 0x7F88A46B,
    (unsigned long)0x0A8291CD << 32 | 0xCEC97DCF, (unsigned long)0x2A4ECEA9 << 32 | 0xF98D0ACC,
    (unsigned long)0x1A1DB93D << 32 | 0x7140003C, (unsigned long)0x092999A3 << 32 | 0x33CB8B7A,
    (unsigned long)0x6DC778F9 << 32 | 0x71AD0038, (unsigned long)0xA907600A << 32 | 0x918130C4,
    (unsigned long)0xED6A1E01 << 32 | 0x2D9E6832, (unsigned long)0x7135C886 << 32 | 0xEFB4318A,
    (unsigned long)0x87F55BA5 << 32 | 0x7E31CC7A, (unsigned long)0x7763CF1D << 32 | 0x55034004,
    (unsigned long)0xAC7D5F42 << 32 | 0xD69F6D18, (unsigned long)0x7930E9E4 << 32 | 0xE58857B6,
    (unsigned long)0x6E6F52C3 << 32 | 0x164DF4FB, (unsigned long)0x25E41D2B << 32 | 0x669E1EF1,
    (unsigned long)0x3C1B20EE << 32 | 0x3FD59D7C, (unsigned long)0x0ABCD06B << 32 | 0xFA53DDEF,
    (unsigned long)0x1DBF9A42 << 32 | 0xD5C4484E, (unsigned long)0xABC52197 << 32 | 0x9B0DEADA,
    (unsigned long)0xE86D2BC5 << 32 | 0x22363A0D, (unsigned long)0x5CAE82AB << 32 | 0x9C9DF69E,
    (unsigned long)0x64F2E21E << 32 | 0x71F54BFF, (unsigned long)0xF4FD4452 << 32 | 0xE2D74DD3,
...
static const unsigned long ffdhe4096_q[] = {
    (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xE345003F << 32 | 0x2F32AFB5,
    (unsigned long)0xA6DAD428 << 32 | 0xFA20C170, (unsigned long)0xC764DAAD << 32 | 0x3FC45235,
    (unsigned long)0x054148E6 << 32 | 0xE764BEE7, (unsigned long)0x15276754 << 32 | 0xFCC68566,
    (unsigned long)0x0D0EDC9E << 32 | 0xB8A0001E, (unsigned long)0x0494CCD1 << 32 | 0x99E5C5BD,
    (unsigned long)0x36E3BC7C << 32 | 0xB8D6801C, (unsigned long)0x5483B005 << 32 | 0x48C09862,
    (unsigned long)0x76B50F00 << 32 | 0x96CF3419, (unsigned long)0x389AE443 << 32 | 0x77DA18C5,
    (unsigned long)0x43FAADD2 << 32 | 0xBF18E63D, (unsigned long)0x3BB1E78E << 32 | 0xAA81A002,
    (unsigned long)0x563EAFA1 << 32 | 0x6B4FB68C, (unsigned long)0xBC9874F2 << 32 | 0x72C42BDB,
    (unsigned long)0xB737A961 << 32 | 0x8B26FA7D, (unsigned long)0x12F20E95 << 32 | 0xB34F0F78,
    (unsigned long)0x9E0D9077 << 32 | 0x1FEACEBE, (unsigned long)0x055E6835 << 32 | 0xFD29EEF7,
    (unsigned long)0x0EDFCD21 << 32 | 0x6AE22427, (unsigned long)0xD5E290CB << 32 | 0xCD86F56D,
    (unsigned long)0x743695E2 << 32 | 0x911B1D06, (unsigned long)0xAE574155 << 32 | 0xCE4EFB4F,
    (unsigned long)0xB279710F << 32 | 0x38FAA5FF, (unsigned long)0x7A7EA229 << 32 | 0x716BA6E9,
...
static const unsigned long ffdhe6144_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xA40E329C << 32 | 0xD0E40E65,
    (unsigned long)0xA41D570D << 32 | 0x7938DAD4, (unsigned long)0x62A69526 << 32 | 0xD43161C1,
    (unsigned long)0x3FDD4A8E << 32 | 0x9ADB1E69, (unsigned long)0x5B3B71F9 << 32 | 0xDC6B80D6,
    (unsigned long)0xEC9D1810 << 32 | 0xC6272B04, (unsigned long)0x8CCF2DD5 << 32 | 0xCACEF403,
    (unsigned long)0xE49F5235 << 32 | 0xC95B9117, (unsigned long)0x505DC82D << 32 | 0xB854338A,
    (unsigned long)0x62292C31 << 32 | 0x1562A846, (unsigned long)0xD72B0374 << 32 | 0x6AE77F5E,
    (unsigned long)0xF9C9091B << 32 | 0x462D538C, (unsigned long)0x0AE8DB58 << 32 | 0x47A67CBE,
    (unsigned long)0xB3A739C1 << 32 | 0x22611682, (unsigned long)0xEEAAC023 << 32 | 0x2A281BF6,
    (unsigned long)0x94C6651E << 32 | 0x77CAF992, (unsigned long)0x763E4E4B << 32 | 0x94B2BBC1,
    (unsigned long)0x587E38DA << 32 | 0x0077D9B4, (unsigned long)0x7FB29F8C << 32 | 0x183023C3,
    (unsigned long)0x0ABEC1FF << 32 | 0xF9E3A26E, (unsigned long)0xA00EF092 << 32 | 0x350511E3,
    (unsigned long)0xB855322E << 32 | 0xDB6340D8, (unsigned long)0xA52471F7 << 32 | 0xA9A96910,
    (unsigned long)0x388147FB << 32 | 0x4CFDB477, (unsigned long)0x9B1F5C3E << 32 | 0x4E46041F,
    (unsigned long)0xCDAD0657 << 32 | 0xFCCFEC71, (unsigned long)0xB38E8C33 << 32 | 0x4C701C3A,
    (unsigned long)0x917BDD64 << 32 | 0xB1C0FD4C, (unsigned long)0x3BB45432 << 32 | 0x9B7624C8,
    (unsigned long)0x23BA4442 << 32 | 0xCAF53EA6, (unsigned long)0x4E677D2C << 32 | 0x38532A3A,
    (unsigned long)0x0BFD64B6 << 32 | 0x45036C7A, (unsigned long)0xC68A007E << 32 | 0x5E0DD902,
    (unsigned long)0x4DB5A851 << 32 | 0xF44182E1, (unsigned long)0x8EC9B55A << 32 | 0x7F88A46B,
    (unsigned long)0x0A8291CD << 32 | 0xCEC97DCF, (unsigned long)0x2A4ECEA9 << 32 | 0xF98D0ACC,
    (unsigned long)0x1A1DB93D << 32 | 0x7140003C, (unsigned long)0x092999A3 << 32 | 0x33CB8B7A,
    (unsigned long)0x6DC778F9 << 32 | 0x71AD0038, (unsigned long)0xA907600A << 32 | 0x918130C4,
...
static const unsigned long ffdhe6144_q[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x5207194E << 32 | 0x68720732,
    (unsigned long)0xD20EAB86 << 32 | 0xBC9C6D6A, (unsigned long)0xB1534A93 << 32 | 0x6A18B0E0,
    (unsigned long)0x1FEEA547 << 32 | 0x4D6D8F34, (unsigned long)0x2D9DB8FC << 32 | 0xEE35C06B,
    (unsigned long)0xF64E8C08 << 32 | 0x63139582, (unsigned long)0xC66796EA << 32 | 0xE5677A01,
    (unsigned long)0x724FA91A << 32 | 0xE4ADC88B, (unsigned long)0x282EE416 << 32 | 0xDC2A19C5,
    (unsigned long)0x31149618 << 32 | 0x8AB15423, (unsigned long)0x6B9581BA << 32 | 0x3573BFAF,
    (unsigned long)0x7CE4848D << 32 | 0xA316A9C6, (unsigned long)0x05746DAC << 32 | 0x23D33E5F,
    (unsigned long)0x59D39CE0 << 32 | 0x91308B41, (unsigned long)0x77556011 << 32 | 0x95140DFB,
    (unsigned long)0xCA63328F << 32 | 0x3BE57CC9, (unsigned long)0x3B1F2725 << 32 | 0xCA595DE0,
    (unsigned long)0xAC3F1C6D << 32 | 0x003BECDA, (unsigned long)0x3FD94FC6 << 32 | 0x0C1811E1,
    (unsigned long)0x855F60FF << 32 | 0xFCF1D137, (unsigned long)0x50077849 << 32 | 0x1A8288F1,
    (unsigned long)0x5C2A9917 << 32 | 0x6DB1A06C, (unsigned long)0xD29238FB << 32 | 0xD4D4B488,
    (unsigned long)0x9C40A3FD << 32 | 0xA67EDA3B, (unsigned long)0xCD8FAE1F << 32 | 0x2723020F,
    (unsigned long)0x66D6832B << 32 | 0xFE67F638, (unsigned long)0x59C74619 << 32 | 0xA6380E1D,
    (unsigned long)0x48BDEEB2 << 32 | 0x58E07EA6, (unsigned long)0x1DDA2A19 << 32 | 0x4DBB1264,
    (unsigned long)0x11DD2221 << 32 | 0x657A9F53, (unsigned long)0x2733BE96 << 32 | 0x1C29951D,
    (unsigned long)0x05FEB25B << 32 | 0x2281B63D, (unsigned long)0xE345003F << 32 | 0x2F06EC81,
    (unsigned long)0xA6DAD428 << 32 | 0xFA20C170, (unsigned long)0xC764DAAD << 32 | 0x3FC45235,
    (unsigned long)0x054148E6 << 32 | 0xE764BEE7, (unsigned long)0x15276754 << 32 | 0xFCC68566,
    (unsigned long)0x0D0EDC9E << 32 | 0xB8A0001E, (unsigned long)0x0494CCD1 << 32 | 0x99E5C5BD,
    (unsigned long)0x36E3BC7C << 32 | 0xB8D6801C, (unsigned long)0x5483B005 << 32 | 0x48C09862,
...
static const unsigned long ffdhe8192_p[] = {
    (unsigned long)0xFFFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0xD68C8BB7 << 32 | 0xC5C6424C,
    (unsigned long)0x011E2A94 << 32 | 0x838FF88C, (unsigned long)0x0822E506 << 32 | 0xA9F4614E,
    (unsigned long)0x97D11D49 << 32 | 0xF7A8443D, (unsigned long)0xA6BBFDE5 << 32 | 0x30677F0D,
    (unsigned long)0x2F741EF8 << 32 | 0xC1FE86FE, (unsigned long)0xFAFABE1C << 32 | 0x5D71A87E,
    (unsigned long)0xDED2FBAB << 32 | 0xFBE58A30, (unsigned long)0xB6855DFE << 32 | 0x72B0A66E,
    (unsigned long)0x1EFC8CE0 << 32 | 0xBA8A4FE8, (unsigned long)0x83F81D4A << 32 | 0x3F2FA457,
    (unsigned long)0xA1FE3075 << 32 | 0xA577E231, (unsigned long)0xD5B80194 << 32 | 0x88D9C0A0,
    (unsigned long)0x624816CD << 32 | 0xAD9A95F9, (unsigned long)0x99E9E316 << 32 | 0x50C1217B,
    (unsigned long)0x51AA691E << 32 | 0x0E423CFC, (unsigned long)0x1C217E6C << 32 | 0x3826E52C,
    (unsigned long)0x51A8A931 << 32 | 0x09703FEE, (unsigned long)0xBB709987 << 32 | 0x6A460E74,
    (unsigned long)0x541FC68C << 32 | 0x9C86B022, (unsigned long)0x59160CC0 << 32 | 0x46FD8251,
    (unsigned long)0x2846C0BA << 32 | 0x35C35F5C, (unsigned long)0x54504AC7 << 32 | 0x8B758282,
    (unsigned long)0x29388839 << 32 | 0xD2AF05E4, (unsigned long)0xCB2C0F1C << 32 | 0xC01BD702,
    (unsigned long)0x555B2F74 << 32 | 0x7C932665, (unsigned long)0x86B63142 << 32 | 0xA3AB8829,
    (unsigned long)0x0B8CC3BD << 32 | 0xF64B10EF, (unsigned long)0x687FEB69 << 32 | 0xEDD1CC5E,
    (unsigned long)0xFDB23FCE << 32 | 0xC9509D43, (unsigned long)0x1E425A31 << 32 | 0xD951AE64,
    (unsigned long)0x36AD004C << 32 | 0xF600C838, (unsigned long)0xA40E329C << 32 | 0xCFF46AAA,
    (unsigned long)0xA41D570D << 32 | 0x7938DAD4, (unsigned long)0x62A69526 << 32 | 0xD43161C1,
    (unsigned long)0x3FDD4A8E << 32 | 0x9ADB1E69, (unsigned long)0x5B3B71F9 << 32 | 0xDC6B80D6,
    (unsigned long)0xEC9D1810 << 32 | 0xC6272B04, (unsigned long)0x8CCF2DD5 << 32 | 0xCACEF403,
    (unsigned long)0xE49F5235 << 32 | 0xC95B9117, (unsigned long)0x505DC82D << 32 | 0xB854338A,
...
static const unsigned long ffdhe8192_q[] = {
    (unsigned long)0x7FFFFFFF << 32 | 0xFFFFFFFF, (unsigned long)0x6B4645DB << 32 | 0xE2E32126,
    (unsigned long)0x008F154A << 32 | 0x41C7FC46, (unsigned long)0x84117283 << 32 | 0x54FA30A7,
    (unsigned long)0xCBE88EA4 << 32 | 0xFBD4221E, (unsigned long)0x535DFEF2 << 32 | 0x9833BF86,
    (unsigned long)0x17BA0F7C << 32 | 0x60FF437F, (unsigned long)0x7D7D5F0E << 32 | 0x2EB8D43F,
    (unsigned long)0x6F697DD5 << 32 | 0xFDF2C518, (unsigned long)0x5B42AEFF << 32 | 0x39585337,
    (unsigned long)0x8F7E4670 << 32 | 0x5D4527F4, (unsigned long)0xC1FC0EA5 << 32 | 0x1F97D22B,
    (unsigned long)0x50FF183A << 32 | 0xD2BBF118, (unsigned long)0xEADC00CA << 32 | 0x446CE050,
    (unsigned long)0xB1240B66 << 32 | 0xD6CD4AFC, (unsigned long)0x4CF4F18B << 32 | 0x286090BD,
    (unsigned long)0x28D5348F << 32 | 0x07211E7E, (unsigned long)0x0E10BF36 << 32 | 0x1C137296,
    (unsigned long)0x28D45498 << 32 | 0x84B81FF7, (unsigned long)0x5DB84CC3 << 32 | 0xB523073A,
    (unsigned long)0xAA0FE346 << 32 | 0x4E435811, (unsigned long)0x2C8B0660 << 32 | 0x237EC128,
    (unsigned long)0x1423605D << 32 | 0x1AE1AFAE, (unsigned long)0x2A282563 << 32 | 0xC5BAC141,
    (unsigned long)0x149C441C << 32 | 0xE95782F2, (unsigned long)0xE596078E << 32 | 0x600DEB81,
    (unsigned long)0xAAAD97BA << 32 | 0x3E499332, (unsigned long)0xC35B18A1 << 32 | 0x51D5C414,
    (unsigned long)0x05C661DE << 32 | 0xFB258877, (unsigned long)0xB43FF5B4 << 32 | 0xF6E8E62F,
    (unsigned long)0x7ED91FE7 << 32 | 0x64A84EA1, (unsigned long)0x0F212D18 << 32 | 0xECA8D732,
    (unsigned long)0x1B568026 << 32 | 0x7B00641C, (unsigned long)0x5207194E << 32 | 0x67FA3555,
    (unsigned long)0xD20EAB86 << 32 | 0xBC9C6D6A, (unsigned long)0xB1534A93 << 32 | 0x6A18B0E0,
    (unsigned long)0x1FEEA547 << 32 | 0x4D6D8F34, (unsigned long)0x2D9DB8FC << 32 | 0xEE35C06B,
    (unsigned long)0xF64E8C08 << 32 | 0x63139582, (unsigned long)0xC66796EA << 32 | 0xE5677A01,
    (unsigned long)0x724FA91A << 32 | 0xE4ADC88B, (unsigned long)0x282EE416 << 32 | 0xDC2A19C5,
...
# 1014 "../crypto/bn/bn_dh.c"
static const unsigned long value_2 = 2;

const BIGNUM ossl_bignum_const_2 = {
    (unsigned long *)&value_2, 1, 1, 0, 0x02
};

extern const BIGNUM ossl_bignum_dh1024_160_p; const BIGNUM ossl_bignum_dh1024_160_p = { (unsigned long *) dh1024_160_p, (sizeof(dh1024_160_p)/sizeof((dh1024_160_p)[0])), (sizeof(dh1024_160_p)/sizeof((dh1024_160_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh1024_160_q; const BIGNUM ossl_bignum_dh1024_160_q = { (unsigned long *) dh1024_160_q, (sizeof(dh1024_160_q)/sizeof((dh1024_160_q)[0])), (sizeof(dh1024_160_q)/sizeof((dh1024_160_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh1024_160_g; const BIGNUM ossl_bignum_dh1024_160_g = { (unsigned long *) dh1024_160_g, (sizeof(dh1024_160_g)/sizeof((dh1024_160_g)[0])), (sizeof(dh1024_160_g)/sizeof((dh1024_160_g)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_224_p; const BIGNUM ossl_bignum_dh2048_224_p = { (unsigned long *) dh2048_224_p, (sizeof(dh2048_224_p)/sizeof((dh2048_224_p)[0])), (sizeof(dh2048_224_p)/sizeof((dh2048_224_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_224_q; const BIGNUM ossl_bignum_dh2048_224_q = { (unsigned long *) dh2048_224_q, (sizeof(dh2048_224_q)/sizeof((dh2048_224_q)[0])), (sizeof(dh2048_224_q)/sizeof((dh2048_224_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_224_g; const BIGNUM ossl_bignum_dh2048_224_g = { (unsigned long *) dh2048_224_g, (sizeof(dh2048_224_g)/sizeof((dh2048_224_g)[0])), (sizeof(dh2048_224_g)/sizeof((dh2048_224_g)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_256_p; const BIGNUM ossl_bignum_dh2048_256_p = { (unsigned long *) dh2048_256_p, (sizeof(dh2048_256_p)/sizeof((dh2048_256_p)[0])), (sizeof(dh2048_256_p)/sizeof((dh2048_256_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_256_q; const BIGNUM ossl_bignum_dh2048_256_q = { (unsigned long *) dh2048_256_q, (sizeof(dh2048_256_q)/sizeof((dh2048_256_q)[0])), (sizeof(dh2048_256_q)/sizeof((dh2048_256_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_dh2048_256_g; const BIGNUM ossl_bignum_dh2048_256_g = { (unsigned long *) dh2048_256_g, (sizeof(dh2048_256_g)/sizeof((dh2048_256_g)[0])), (sizeof(dh2048_256_g)/sizeof((dh2048_256_g)[0])), 0, 0x02 };

extern const BIGNUM ossl_bignum_ffdhe2048_p; const BIGNUM ossl_bignum_ffdhe2048_p = { (unsigned long *) ffdhe2048_p, (sizeof(ffdhe2048_p)/sizeof((ffdhe2048_p)[0])), (sizeof(ffdhe2048_p)/sizeof((ffdhe2048_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe2048_q; const BIGNUM ossl_bignum_ffdhe2048_q = { (unsigned long *) ffdhe2048_q, (sizeof(ffdhe2048_q)/sizeof((ffdhe2048_q)[0])), (sizeof(ffdhe2048_q)/sizeof((ffdhe2048_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe3072_p; const BIGNUM ossl_bignum_ffdhe3072_p = { (unsigned long *) ffdhe3072_p, (sizeof(ffdhe3072_p)/sizeof((ffdhe3072_p)[0])), (sizeof(ffdhe3072_p)/sizeof((ffdhe3072_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe3072_q; const BIGNUM ossl_bignum_ffdhe3072_q = { (unsigned long *) ffdhe3072_q, (sizeof(ffdhe3072_q)/sizeof((ffdhe3072_q)[0])), (sizeof(ffdhe3072_q)/sizeof((ffdhe3072_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe4096_p; const BIGNUM ossl_bignum_ffdhe4096_p = { (unsigned long *) ffdhe4096_p, (sizeof(ffdhe4096_p)/sizeof((ffdhe4096_p)[0])), (sizeof(ffdhe4096_p)/sizeof((ffdhe4096_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe4096_q; const BIGNUM ossl_bignum_ffdhe4096_q = { (unsigned long *) ffdhe4096_q, (sizeof(ffdhe4096_q)/sizeof((ffdhe4096_q)[0])), (sizeof(ffdhe4096_q)/sizeof((ffdhe4096_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe6144_p; const BIGNUM ossl_bignum_ffdhe6144_p = { (unsigned long *) ffdhe6144_p, (sizeof(ffdhe6144_p)/sizeof((ffdhe6144_p)[0])), (sizeof(ffdhe6144_p)/sizeof((ffdhe6144_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe6144_q; const BIGNUM ossl_bignum_ffdhe6144_q = { (unsigned long *) ffdhe6144_q, (sizeof(ffdhe6144_q)/sizeof((ffdhe6144_q)[0])), (sizeof(ffdhe6144_q)/sizeof((ffdhe6144_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe8192_p; const BIGNUM ossl_bignum_ffdhe8192_p = { (unsigned long *) ffdhe8192_p, (sizeof(ffdhe8192_p)/sizeof((ffdhe8192_p)[0])), (sizeof(ffdhe8192_p)/sizeof((ffdhe8192_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_ffdhe8192_q; const BIGNUM ossl_bignum_ffdhe8192_q = { (unsigned long *) ffdhe8192_q, (sizeof(ffdhe8192_q)/sizeof((ffdhe8192_q)[0])), (sizeof(ffdhe8192_q)/sizeof((ffdhe8192_q)[0])), 0, 0x02 };


extern const BIGNUM ossl_bignum_modp_1536_p; const BIGNUM ossl_bignum_modp_1536_p = { (unsigned long *) modp_1536_p, (sizeof(modp_1536_p)/sizeof((modp_1536_p)[0])), (sizeof(modp_1536_p)/sizeof((modp_1536_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_1536_q; const BIGNUM ossl_bignum_modp_1536_q = { (unsigned long *) modp_1536_q, (sizeof(modp_1536_q)/sizeof((modp_1536_q)[0])), (sizeof(modp_1536_q)/sizeof((modp_1536_q)[0])), 0, 0x02 };

extern const BIGNUM ossl_bignum_modp_2048_p; const BIGNUM ossl_bignum_modp_2048_p = { (unsigned long *) modp_2048_p, (sizeof(modp_2048_p)/sizeof((modp_2048_p)[0])), (sizeof(modp_2048_p)/sizeof((modp_2048_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_2048_q; const BIGNUM ossl_bignum_modp_2048_q = { (unsigned long *) modp_2048_q, (sizeof(modp_2048_q)/sizeof((modp_2048_q)[0])), (sizeof(modp_2048_q)/sizeof((modp_2048_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_3072_p; const BIGNUM ossl_bignum_modp_3072_p = { (unsigned long *) modp_3072_p, (sizeof(modp_3072_p)/sizeof((modp_3072_p)[0])), (sizeof(modp_3072_p)/sizeof((modp_3072_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_3072_q; const BIGNUM ossl_bignum_modp_3072_q = { (unsigned long *) modp_3072_q, (sizeof(modp_3072_q)/sizeof((modp_3072_q)[0])), (sizeof(modp_3072_q)/sizeof((modp_3072_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_4096_p; const BIGNUM ossl_bignum_modp_4096_p = { (unsigned long *) modp_4096_p, (sizeof(modp_4096_p)/sizeof((modp_4096_p)[0])), (sizeof(modp_4096_p)/sizeof((modp_4096_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_4096_q; const BIGNUM ossl_bignum_modp_4096_q = { (unsigned long *) modp_4096_q, (sizeof(modp_4096_q)/sizeof((modp_4096_q)[0])), (sizeof(modp_4096_q)/sizeof((modp_4096_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_6144_p; const BIGNUM ossl_bignum_modp_6144_p = { (unsigned long *) modp_6144_p, (sizeof(modp_6144_p)/sizeof((modp_6144_p)[0])), (sizeof(modp_6144_p)/sizeof((modp_6144_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_6144_q; const BIGNUM ossl_bignum_modp_6144_q = { (unsigned long *) modp_6144_q, (sizeof(modp_6144_q)/sizeof((modp_6144_q)[0])), (sizeof(modp_6144_q)/sizeof((modp_6144_q)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_8192_p; const BIGNUM ossl_bignum_modp_8192_p = { (unsigned long *) modp_8192_p, (sizeof(modp_8192_p)/sizeof((modp_8192_p)[0])), (sizeof(modp_8192_p)/sizeof((modp_8192_p)[0])), 0, 0x02 };
extern const BIGNUM ossl_bignum_modp_8192_q; const BIGNUM ossl_bignum_modp_8192_q = { (unsigned long *) modp_8192_q, (sizeof(modp_8192_q)/sizeof((modp_8192_q)[0])), (sizeof(modp_8192_q)/sizeof((modp_8192_q)[0])), 0, 0x02 };
