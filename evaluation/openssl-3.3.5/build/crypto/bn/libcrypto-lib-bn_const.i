# 0 "../crypto/bn/bn_const.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_const.c"
# 10 "../crypto/bn/bn_const.c"
...
# 12 "../crypto/bn/bn_const.c" 2
# 25 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc2409_prime_768(BIGNUM *bn)
{
...
# 85 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_1536(BIGNUM *bn)
{
    return (bn != 
# 87 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 87 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_1536_p) : BN_dup(&ossl_bignum_modp_1536_p);
}
# 98 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_2048(BIGNUM *bn)
{
    return (bn != 
# 100 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 100 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_2048_p) : BN_dup(&ossl_bignum_modp_2048_p);
}
# 111 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_3072(BIGNUM *bn)
{
    return (bn != 
# 113 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 113 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_3072_p) : BN_dup(&ossl_bignum_modp_3072_p);
}
# 124 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_4096(BIGNUM *bn)
{
    return (bn != 
# 126 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 126 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_4096_p) : BN_dup(&ossl_bignum_modp_4096_p);
}
# 137 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_6144(BIGNUM *bn)
{
    return (bn != 
# 139 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 139 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_6144_p) : BN_dup(&ossl_bignum_modp_6144_p);
}
# 150 "../crypto/bn/bn_const.c"
BIGNUM *BN_get_rfc3526_prime_8192(BIGNUM *bn)
{
    return (bn != 
# 152 "../crypto/bn/bn_const.c" 3 4
          ((void *)0)
# 152 "../crypto/bn/bn_const.c"
          ) ? BN_copy(bn, &ossl_bignum_modp_8192_p) : BN_dup(&ossl_bignum_modp_8192_p);
}
