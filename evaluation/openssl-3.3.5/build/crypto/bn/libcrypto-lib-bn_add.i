# 0 "../crypto/bn/bn_add.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_add.c"
# 10 "../crypto/bn/bn_add.c"
...
# 96 "../crypto/bn/bn_add.c" 3 4
                                 ((void *)0)
# 96 "../crypto/bn/bn_add.c"
                                     )
        return 0;
    ...
    while (dif) {
        dif--;
        t1 = *(ap++);
        t2 = (t1 + carry) & (0xffffffffffffffffL);
        *(rp++) = t2;
        carry &= (t2 == 0);
    }
    *rp = carry;
...
int BN_usub(BIGNUM *r, const BIGNUM *a, const BIGNUM *b)
{
    ...
    if (dif < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_add.c",139,__func__), ERR_set_error)((3),(100),
# 139 "../crypto/bn/bn_add.c" 3 4
       ((void *)0)
# 139 "../crypto/bn/bn_add.c"
       );
        return 0;
    }

    if (bn_wexpand(r, max) == 
# 143 "../crypto/bn/bn_add.c" 3 4
                             ((void *)0)
# 143 "../crypto/bn/bn_add.c"
                                 )
        return 0;
    ...
    while (dif) {
        dif--;
        t1 = *(ap++);
        t2 = (t1 - borrow) & (0xffffffffffffffffL);
        *(rp++) = t2;
        borrow &= (t1 == 0);
    }
