# 0 "../crypto/bn/rsaz_exp_x2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/rsaz_exp_x2.c"
# 17 "../crypto/bn/rsaz_exp_x2.c"
...
# 19 "../crypto/bn/rsaz_exp_x2.c" 2
# 1 "../crypto/bn/rsaz_exp.h" 1
# 24 "../crypto/bn/rsaz_exp.h"
...
# 26 "../crypto/bn/rsaz_exp.h" 2
# 1 "../crypto/bn/bn_local.h" 1
# 21 "../crypto/bn/bn_local.h"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 27 "../crypto/bn/rsaz_exp.h" 2

void RSAZ_1024_mod_exp_avx2(unsigned long result[16],
                            const unsigned long base_norm[16],
                            const unsigned long exponent[16],
                            const unsigned long m_norm[16], const unsigned long RR[16],
                            unsigned long k0);
int rsaz_avx2_eligible(void);

void RSAZ_512_mod_exp(unsigned long result[8],
                      const unsigned long base_norm[8], const unsigned long exponent[8],
                      const unsigned long m_norm[8], unsigned long k0,
                      const unsigned long RR[8]);


int ossl_rsaz_avx512ifma_eligible(void);

int ossl_rsaz_mod_exp_avx512_x2(unsigned long *res1,
                                const unsigned long *base1,
                                const unsigned long *exponent1,
                                const unsigned long *m1,
                                const unsigned long *RR1,
                                unsigned long k0_1,
                                unsigned long *res2,
                                const unsigned long *base2,
                                const unsigned long *exponent2,
                                const unsigned long *m2,
                                const unsigned long *RR2,
                                unsigned long k0_2,
                                int factor_size);

static inline void bn_select_words(unsigned long *r, unsigned long mask,
                                        const unsigned long *a,
                                        const unsigned long *b, size_t num)
{
    size_t i;
...
static inline unsigned long bn_reduce_once_in_place(unsigned long *r,
                                                    unsigned long carry,
                                                    const unsigned long *m,
                                                    unsigned long *tmp, size_t num)
{
    carry -= bn_sub_words(tmp, r, m, num);
    bn_select_words(r, carry, r , tmp , num);
    return carry;
}
# 20 "../crypto/bn/rsaz_exp_x2.c" 2




# 1 "/usr/include/assert.h" 1 3 4
# 25 "../crypto/bn/rsaz_exp_x2.c" 2
# 42 "../crypto/bn/rsaz_exp_x2.c"
...
static void to_words52(unsigned long *out, int out_len, const unsigned long *in,
                       int in_bitsize);
static void from_words52(unsigned long *bn_out, int out_bitsize, const unsigned long *in);
static inline void set_bit(unsigned long *a, int idx);
...
# 67 "../crypto/bn/rsaz_exp_x2.c"
void ossl_rsaz_amm52x20_x1_ifma256(unsigned long *res, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   unsigned long k0);
void ossl_rsaz_amm52x20_x2_ifma256(unsigned long *out, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   const unsigned long k0[2]);
void ossl_extract_multiplier_2x20_win5(unsigned long *red_Y,
                                       const unsigned long *red_table,
                                       int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x30_x1_ifma256(unsigned long *res, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   unsigned long k0);
void ossl_rsaz_amm52x30_x2_ifma256(unsigned long *out, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   const unsigned long k0[2]);
void ossl_extract_multiplier_2x30_win5(unsigned long *red_Y,
                                       const unsigned long *red_table,
                                       int red_table_idx1, int red_table_idx2);

void ossl_rsaz_amm52x40_x1_ifma256(unsigned long *res, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   unsigned long k0);
void ossl_rsaz_amm52x40_x2_ifma256(unsigned long *out, const unsigned long *a,
                                   const unsigned long *b, const unsigned long *m,
                                   const unsigned long k0[2]);
void ossl_extract_multiplier_2x40_win5(unsigned long *red_Y,
                                       const unsigned long *red_table,
                                       int red_table_idx1, int red_table_idx2);

static int RSAZ_mod_exp_x2_ifma256(unsigned long *res, const unsigned long *base,
                                   const unsigned long *exp[2], const unsigned long *m,
                                   const unsigned long *rr, const unsigned long k0[2],
                                   int modulus_bitsize);
# 131 "../crypto/bn/rsaz_exp_x2.c"
int ossl_rsaz_mod_exp_avx512_x2(unsigned long *res1,
                                const unsigned long *base1,
                                const unsigned long *exp1,
                                const unsigned long *m1,
                                const unsigned long *rr1,
                                unsigned long k0_1,
                                unsigned long *res2,
                                const unsigned long *base2,
                                const unsigned long *exp2,
                                const unsigned long *m2,
                                const unsigned long *rr2,
                                unsigned long k0_2,
                                int factor_size)
{
    typedef void (*AMM)(unsigned long *res, const unsigned long *a,
                        const unsigned long *b, const unsigned long *m, unsigned long k0);
    int ret = 0;
    ...
    int exp_digits = number_of_digits(factor_size + 2, (52));
    int coeff_pow = 4 * ((52) * exp_digits - factor_size);


    int ymm_regs_num = (((exp_digits) * 64 + (256) - 1) / (256));

    int regs_capacity = ymm_regs_num * 4;

    unsigned long *base1_red, *m1_red, *rr1_red;
    unsigned long *base2_red, *m2_red, *rr2_red;
    unsigned long *coeff_red;
    unsigned long *storage = 
# 164 "../crypto/bn/rsaz_exp_x2.c" 3 4
                       ((void *)0)
# 164 "../crypto/bn/rsaz_exp_x2.c"
                           ;
    unsigned long *storage_aligned = 
# 165 "../crypto/bn/rsaz_exp_x2.c" 3 4
                               ((void *)0)
# 165 "../crypto/bn/rsaz_exp_x2.c"
                                   ;
    int storage_len_bytes = 7 * regs_capacity * sizeof(unsigned long)
                           + 64 ;

    const unsigned long *exp[2] = {0};
    unsigned long k0[2] = {0};

    AMM amm = 
# 172 "../crypto/bn/rsaz_exp_x2.c" 3 4
             ((void *)0)
# 172 "../crypto/bn/rsaz_exp_x2.c"
                 ;
    ...
    storage = (unsigned long *)CRYPTO_malloc(storage_len_bytes, "../crypto/bn/rsaz_exp_x2.c", 188);
    if (storage == 
# 189 "../crypto/bn/rsaz_exp_x2.c" 3 4
                  ((void *)0)
# 189 "../crypto/bn/rsaz_exp_x2.c"
                      )
        goto err;
    storage_aligned = (unsigned long *)((unsigned char *)(storage) + (64 - (((size_t)(storage)) & (64 - 1))));
...
# 226 "../crypto/bn/rsaz_exp_x2.c"
    memset(coeff_red, 0, exp_digits * sizeof(unsigned long));
    ...
    factor_size /= sizeof(unsigned long) * 8;
...
err:
    if (storage != 
# 259 "../crypto/bn/rsaz_exp_x2.c" 3 4
                  ((void *)0)
# 259 "../crypto/bn/rsaz_exp_x2.c"
                      ) {
        OPENSSL_cleanse(storage, storage_len_bytes);
        CRYPTO_free(storage, "../crypto/bn/rsaz_exp_x2.c", 261);
    }
    return ret;
}
# 288 "../crypto/bn/rsaz_exp_x2.c"
int RSAZ_mod_exp_x2_ifma256(unsigned long *out,
                            const unsigned long *base,
                            const unsigned long *exp[2],
                            const unsigned long *m,
                            const unsigned long *rr,
                            const unsigned long k0[2],
                            int modulus_bitsize)
{
    typedef void (*DAMM)(unsigned long *res, const unsigned long *a,
                         const unsigned long *b, const unsigned long *m,
                         const unsigned long k0[2]);
    typedef void (*DEXTRACT)(unsigned long *res, const unsigned long *red_table,
    ...
    unsigned long *storage = 
# 316 "../crypto/bn/rsaz_exp_x2.c" 3 4
                       ((void *)0)
# 316 "../crypto/bn/rsaz_exp_x2.c"
                           ;
    unsigned long *storage_aligned = 
# 317 "../crypto/bn/rsaz_exp_x2.c" 3 4
                               ((void *)0)
# 317 "../crypto/bn/rsaz_exp_x2.c"
                                   ;
    int storage_len_bytes = 0;


    unsigned long *red_Y = 
# 321 "../crypto/bn/rsaz_exp_x2.c" 3 4
                     ((void *)0)
# 321 "../crypto/bn/rsaz_exp_x2.c"
                         ;
    unsigned long *red_X = 
# 322 "../crypto/bn/rsaz_exp_x2.c" 3 4
                     ((void *)0)
# 322 "../crypto/bn/rsaz_exp_x2.c"
                         ;

    unsigned long *red_table = 
# 324 "../crypto/bn/rsaz_exp_x2.c" 3 4
                         ((void *)0)
# 324 "../crypto/bn/rsaz_exp_x2.c"
                             ;

    unsigned long *expz = 
# 326 "../crypto/bn/rsaz_exp_x2.c" 3 4
                    ((void *)0)
# 326 "../crypto/bn/rsaz_exp_x2.c"
                        ;


    DAMM damm = 
# 329 "../crypto/bn/rsaz_exp_x2.c" 3 4
               ((void *)0)
# 329 "../crypto/bn/rsaz_exp_x2.c"
                   ;

    DEXTRACT extract = 
# 331 "../crypto/bn/rsaz_exp_x2.c" 3 4
                      ((void *)0)
# 331 "../crypto/bn/rsaz_exp_x2.c"
                          ;
    ...
    storage = (unsigned long *)CRYPTO_zalloc(storage_len_bytes, "../crypto/bn/rsaz_exp_x2.c", 370);
    if (storage == 
# 371 "../crypto/bn/rsaz_exp_x2.c" 3 4
                  ((void *)0)
# 371 "../crypto/bn/rsaz_exp_x2.c"
                      )
        goto err;
    storage_aligned = (unsigned long *)((unsigned char *)(storage) + (64 - (((size_t)(storage)) & (64 - 1))));
    ...
    damm(&red_table[0 * 2 * red_digits], (const unsigned long*)red_X, rr, m, k0);
    damm(&red_table[1 * 2 * red_digits], base, rr, m, k0);

    for (idx = 1; idx < (int)((1U << exp_win_size) / 2); idx++) {
        damm((&red_table[(2 * idx + 0) * 2 * red_digits]),(&red_table[(1 * idx) * 2 * red_digits]),(&red_table[(1 * idx) * 2 * red_digits]),(m),(k0))
                                                               ;
    ...
    memcpy(&expz[0 * (exp_digits + 1)], exp[0], exp_digits * sizeof(unsigned long));
    expz[1 * (exp_digits + 1) - 1] = 0;
    memcpy(&expz[1 * (exp_digits + 1)], exp[1], exp_digits * sizeof(unsigned long));
    expz[2 * (exp_digits + 1) - 1] = 0;


    {
        const int rem = modulus_bitsize % exp_win_size;
        const unsigned long table_idx_mask = exp_win_mask;

        int exp_bit_no = modulus_bitsize - rem;
        int exp_chunk_no = exp_bit_no / 64;
        int exp_chunk_shift = exp_bit_no % 64;

        unsigned long red_table_idx_0, red_table_idx_1;
# 423 "../crypto/bn/rsaz_exp_x2.c"
        (void)((rem != 0) ? 0 : (OPENSSL_die("assertion failed: " "rem != 0", "../crypto/bn/rsaz_exp_x2.c", 423), 1));
        ...
        extract(&red_Y[0 * red_digits], (const unsigned long*)red_table, (int)red_table_idx_0, (int)red_table_idx_1);
        ...
        for (exp_bit_no -= exp_win_size; exp_bit_no >= 0; exp_bit_no -= exp_win_size) {

            {
                ...
                extract(&red_X[0 * red_digits], (const unsigned long*)red_table, (int)red_table_idx_0, (int)red_table_idx_1);
            }


            damm(((unsigned long*)red_Y),((const unsigned long*)red_Y),((const unsigned long*)red_Y),(m),(k0));
            damm(((unsigned long*)red_Y),((const unsigned long*)red_Y),((const unsigned long*)red_Y),(m),(k0));
            damm(((unsigned long*)red_Y),((const unsigned long*)red_Y),((const unsigned long*)red_Y),(m),(k0));
            damm(((unsigned long*)red_Y),((const unsigned long*)red_Y),((const unsigned long*)red_Y),(m),(k0));
            damm(((unsigned long*)red_Y),((const unsigned long*)red_Y),((const unsigned long*)red_Y),(m),(k0));

            damm((unsigned long*)red_Y, (const unsigned long*)red_Y, (const unsigned long*)red_X, m, k0);
        }
    }
# 503 "../crypto/bn/rsaz_exp_x2.c"
    memset(red_X, 0, 2 * red_digits * sizeof(unsigned long));
    red_X[0 * red_digits] = 1;
    red_X[1 * red_digits] = 1;
    damm(out, (const unsigned long*)red_Y, (const unsigned long*)red_X, m, k0);

    ret = 1;

err:
    if (storage != 
# 511 "../crypto/bn/rsaz_exp_x2.c" 3 4
                  ((void *)0)
# 511 "../crypto/bn/rsaz_exp_x2.c"
                      ) {

        OPENSSL_cleanse(storage, storage_len_bytes);
        CRYPTO_free(storage, "../crypto/bn/rsaz_exp_x2.c", 514);
    }
...
# 525 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 525 "../crypto/bn/rsaz_exp_x2.c"
                     ;
    
# 526 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 526 "../crypto/bn/rsaz_exp_x2.c"
                      ;
...
static void to_words52(unsigned long *out, int out_len,
                       const unsigned long *in, int in_bitsize)
{
    uint8_t *in_str = 
# 542 "../crypto/bn/rsaz_exp_x2.c" 3 4
                     ((void *)0)
# 542 "../crypto/bn/rsaz_exp_x2.c"
                         ;

    
# 544 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 544 "../crypto/bn/rsaz_exp_x2.c"
                      ;
    
# 545 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 545 "../crypto/bn/rsaz_exp_x2.c"
                     ;

    
# 547 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 547 "../crypto/bn/rsaz_exp_x2.c"
                                                              ;

    in_str = (uint8_t *)in;

    for (; in_bitsize >= (2 * (52)); in_bitsize -= (2 * (52)), out += 2) {
        uint64_t digit;

        memcpy(&digit, in_str, sizeof(digit));
        out[0] = digit & ((uint64_t)0xFFFFFFFFFFFFF);
        in_str += 6;
        memcpy(&digit, in_str, sizeof(digit));
        out[1] = (digit >> 4) & ((uint64_t)0xFFFFFFFFFFFFF);
        in_str += 7;
        out_len -= 2;
    }
    ...
    if (in_bitsize > (52)) {
        ...
        in_str += 6;
        in_bitsize -= (52);
        digit = get_digit(in_str, (((in_bitsize) + 7) >> 3));
        out[1] = digit >> 4;
        out += 2;
        out_len -= 2;
    } else if (in_bitsize > 0) {
        out[0] = get_digit(in_str, (((in_bitsize) + 7) >> 3));
        out++;
        out_len--;
    }

    memset(out, 0, out_len * sizeof(unsigned long));
}

static inline void put_digit(uint8_t *out, int out_len, uint64_t digit)
{
    
# 584 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 584 "../crypto/bn/rsaz_exp_x2.c"
                      ;
    
# 585 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 585 "../crypto/bn/rsaz_exp_x2.c"
                       ;
...
static void from_words52(unsigned long *out, int out_bitsize, const unsigned long *in)
{
    int i;
    int out_len = (((out_bitsize) + 63) >> 6);

    
# 602 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 602 "../crypto/bn/rsaz_exp_x2.c"
                      ;
    
# 603 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 603 "../crypto/bn/rsaz_exp_x2.c"
                     ;
...

    {
        ...
        for (; out_bitsize >= (2 * (52));
               out_bitsize -= (2 * (52)), in += 2) {
            uint64_t digit;
        ...
        if (out_bitsize > (52)) {
            ...
            out_str += 6;
            out_bitsize -= (52);
            put_digit(out_str, (((out_bitsize) + 7) >> 3),
                        (in[1] << 4 | in[0] >> 48));
        } else if (out_bitsize) {
            put_digit(out_str, (((out_bitsize) + 7) >> 3), in[0]);
        }
    }
}
...
# 642 "../crypto/bn/rsaz_exp_x2.c" 3 4
   ((void) (0))
# 642 "../crypto/bn/rsaz_exp_x2.c"
                    ;
