# 0 "../crypto/bn/bn_rand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_rand.c"
# 10 "../crypto/bn/bn_rand.c"
...
{
    unsigned char *buf = 
# 26 "../crypto/bn/bn_rand.c" 3 4
                        ((void *)0)
# 26 "../crypto/bn/bn_rand.c"
                            ;
    ...
    buf = CRYPTO_malloc(bytes, "../crypto/bn/bn_rand.c", 43);
    if (buf == 
# 44 "../crypto/bn/bn_rand.c" 3 4
              ((void *)0)
# 44 "../crypto/bn/bn_rand.c"
                  )
        goto err;
    ...
    ret = 1;
 err:
    CRYPTO_clear_free(buf, bytes, "../crypto/bn/bn_rand.c", 91);
    ;
    return ret;

toosmall:
    (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",96,__func__), ERR_set_error)((3),(118),
# 96 "../crypto/bn/bn_rand.c" 3 4
   ((void *)0)
# 96 "../crypto/bn/bn_rand.c"
   );
    return 0;
}
...
int BN_rand(BIGNUM *rnd, int bits, int top, int bottom)
{
    return bnrand(NORMAL, rnd, bits, top, bottom, 0, 
# 108 "../crypto/bn/bn_rand.c" 3 4
                                                    ((void *)0)
# 108 "../crypto/bn/bn_rand.c"
                                                        );
}

int BN_bntest_rand(BIGNUM *rnd, int bits, int top, int bottom)
{
    return bnrand(TESTING, rnd, bits, top, bottom, 0, 
# 113 "../crypto/bn/bn_rand.c" 3 4
                                                     ((void *)0)
# 113 "../crypto/bn/bn_rand.c"
                                                         );
}
...
int BN_priv_rand(BIGNUM *rnd, int bits, int top, int bottom)
{
    return bnrand(PRIVATE, rnd, bits, top, bottom, 0, 
# 126 "../crypto/bn/bn_rand.c" 3 4
                                                     ((void *)0)
# 126 "../crypto/bn/bn_rand.c"
                                                         );
}
                        ...
                        unsigned int strength, BN_CTX *ctx)
{
    ...
    if (r == 
# 137 "../crypto/bn/bn_rand.c" 3 4
            ((void *)0)
# 137 "../crypto/bn/bn_rand.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",138,__func__), ERR_set_error)((3),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 138 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 138 "../crypto/bn/bn_rand.c"
       );
        return 0;
    }

    if (range->neg || BN_is_zero(range)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",143,__func__), ERR_set_error)((3),(115),
# 143 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 143 "../crypto/bn/bn_rand.c"
       );
        return 0;
    }
    ...
    if (n == 1)
        ...
        do {
            ...
            if (!--count) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",178,__func__), ERR_set_error)((3),(113),
# 178 "../crypto/bn/bn_rand.c" 3 4
               ((void *)0)
# 178 "../crypto/bn/bn_rand.c"
               );
                return 0;
            }
        ...
        do {
            ...
            if (!bnrand(flag, r, n, -1, 0,
                        strength, ctx))
                return 0;

            if (!--count) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",192,__func__), ERR_set_error)((3),(113),
# 192 "../crypto/bn/bn_rand.c" 3 4
               ((void *)0)
# 192 "../crypto/bn/bn_rand.c"
               );
                return 0;
            }
        }
...
{
    return bnrand_range(NORMAL, r, range, 0, 
# 212 "../crypto/bn/bn_rand.c" 3 4
                                            ((void *)0)
# 212 "../crypto/bn/bn_rand.c"
                                                );
}
...
{
    return bnrand_range(PRIVATE, r, range, 0, 
# 225 "../crypto/bn/bn_rand.c" 3 4
                                             ((void *)0)
# 225 "../crypto/bn/bn_rand.c"
                                                 );
}
                                      ...
                                      unsigned int strength, BN_CTX *ctx)
{
    ...
    if (r == 
# 247 "../crypto/bn/bn_rand.c" 3 4
            ((void *)0)
# 247 "../crypto/bn/bn_rand.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",248,__func__), ERR_set_error)((3),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 248 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 248 "../crypto/bn/bn_rand.c"
       );
        return 0;
    }

    if (range->neg || BN_is_zero(range)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",253,__func__), ERR_set_error)((3),(115),
# 253 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 253 "../crypto/bn/bn_rand.c"
       );
        return 0;
    }
    ...
    if (n == 1) {
        ...
        BN_set_flags(r, 0x04);
        do {
            if (!bnrand(PRIVATE, r, n + 1, 0, 0,
                        strength, ctx))
                return 0;

            if (!--count) {
                (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",271,__func__), ERR_set_error)((3),(113),
# 271 "../crypto/bn/bn_rand.c" 3 4
               ((void *)0)
# 271 "../crypto/bn/bn_rand.c"
               );
                return 0;
            }
                                    ...
                                    size_t message_len, BN_CTX *ctx)
{
    ...
    const unsigned num_k_bytes = ((BN_num_bits(range)+7)/8) + 1;
    unsigned char private_bytes[96];
    unsigned char *k_bytes = 
# 310 "../crypto/bn/bn_rand.c" 3 4
                            ((void *)0)
# 310 "../crypto/bn/bn_rand.c"
                                ;
    const int max_n = 64;
    int n;
    int ret = 0;
    EVP_MD *md = 
# 314 "../crypto/bn/bn_rand.c" 3 4
                ((void *)0)
# 314 "../crypto/bn/bn_rand.c"
                    ;
    OSSL_LIB_CTX *libctx = ossl_bn_get_libctx(ctx);

    if (mdctx == 
# 317 "../crypto/bn/bn_rand.c" 3 4
                ((void *)0)
# 317 "../crypto/bn/bn_rand.c"
                    )
        goto end;

    k_bytes = CRYPTO_malloc(num_k_bytes, "../crypto/bn/bn_rand.c", 320);
    if (k_bytes == 
# 321 "../crypto/bn/bn_rand.c" 3 4
                  ((void *)0)
# 321 "../crypto/bn/bn_rand.c"
                      )
        goto end;
    ...
    if (BN_bn2binpad(priv, private_bytes, sizeof(private_bytes)) < 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",333,__func__), ERR_set_error)((3),(117),
# 333 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 333 "../crypto/bn/bn_rand.c"
       );
        goto end;
    }

    md = EVP_MD_fetch(libctx, "SHA512", 
# 337 "../crypto/bn/bn_rand.c" 3 4
                                       ((void *)0)
# 337 "../crypto/bn/bn_rand.c"
                                           );
    if (md == 
# 338 "../crypto/bn/bn_rand.c" 3 4
             ((void *)0)
# 338 "../crypto/bn/bn_rand.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",339,__func__), ERR_set_error)((3),(120),
# 339 "../crypto/bn/bn_rand.c" 3 4
       ((void *)0)
# 339 "../crypto/bn/bn_rand.c"
       );
        goto end;
    }
    for (n = 0; n < max_n; n++) {
        ...
        for (done = 1; done < num_k_bytes;) {
            ...
            if (!EVP_DigestInit_ex(mdctx, md, 
# 350 "../crypto/bn/bn_rand.c" 3 4
                                             ((void *)0)
# 350 "../crypto/bn/bn_rand.c"
                                                 )
...
# 357 "../crypto/bn/bn_rand.c" 3 4
                                                         ((void *)0)
# 357 "../crypto/bn/bn_rand.c"
                                                             ))
                goto end;
    ...
    (ERR_new(), ERR_set_debug("../crypto/bn/bn_rand.c",385,__func__), ERR_set_error)((3),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 385 "../crypto/bn/bn_rand.c" 3 4
   ((void *)0)
# 385 "../crypto/bn/bn_rand.c"
   );

 end:
    EVP_MD_CTX_free(mdctx);
    EVP_MD_free(md);
    CRYPTO_clear_free(k_bytes, num_k_bytes, "../crypto/bn/bn_rand.c", 390);
