# 0 "../crypto/bn/bn_exp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_exp.c"
# 10 "../crypto/bn/bn_exp.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 13 "../crypto/bn/bn_exp.c" 2
# 28 "../crypto/bn/bn_exp.c"
# 1 "../crypto/bn/rsaz_exp.h" 1
# 28 "../crypto/bn/rsaz_exp.h"
...
# 29 "../crypto/bn/bn_exp.c" 2
# 49 "../crypto/bn/bn_exp.c"
int BN_exp(BIGNUM *r, const BIGNUM *a, const BIGNUM *p, BN_CTX *ctx)
{
    int i, bits, ret = 0;
    BIGNUM *v, *rr;

    if (BN_get_flags(p, 0x04) != 0
            || BN_get_flags(a, 0x04) != 0) {

        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",57,__func__), ERR_set_error)((3),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 57 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 57 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
    ...
    v = BN_CTX_get(ctx);
    if (rr == 
# 64 "../crypto/bn/bn_exp.c" 3 4
             ((void *)0) 
# 64 "../crypto/bn/bn_exp.c"
                  || v == 
# 64 "../crypto/bn/bn_exp.c" 3 4
                          ((void *)0)
# 64 "../crypto/bn/bn_exp.c"
    ...
    if (BN_copy(v, a) == 
# 67 "../crypto/bn/bn_exp.c" 3 4
                        ((void *)0)
# 67 "../crypto/bn/bn_exp.c"
                            )
        goto err;
    bits = BN_num_bits(p);
    ...
    if (BN_is_odd(p)) {
        if (BN_copy(rr, a) == 
# 72 "../crypto/bn/bn_exp.c" 3 4
                             ((void *)0)
# 72 "../crypto/bn/bn_exp.c"
                                 )
            goto err;
    } else {
        if (!(BN_set_word((rr),1)))
                    ...
                    const BIGNUM *m, BN_CTX *ctx)
{
    ...
    if (BN_get_flags(p, 0x04) != 0
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",183,__func__), ERR_set_error)((3),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 183 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 183 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
    ...
    if (val[0] == 
# 204 "../crypto/bn/bn_exp.c" 3 4
                 ((void *)0)
# 204 "../crypto/bn/bn_exp.c"
                     )
        goto err;
...
# 233 "../crypto/bn/bn_exp.c" 3 4
                                              ((void *)0)
# 233 "../crypto/bn/bn_exp.c"
                                                  ) ||
    ...
    if (r == p) {
        ...
        if (p_dup == 
# 248 "../crypto/bn/bn_exp.c" 3 4
                    ((void *)0) 
# 248 "../crypto/bn/bn_exp.c"
                         || BN_copy(p_dup, p) == 
# 248 "../crypto/bn/bn_exp.c" 3 4
                                                 ((void *)0)
# 248 "../crypto/bn/bn_exp.c"
                    ...
                    const BIGNUM *m, BN_CTX *ctx, BN_MONT_CTX *in_mont)
{
    ...
    BIGNUM *val[32];
    BN_MONT_CTX *mont = 
# 321 "../crypto/bn/bn_exp.c" 3 4
                       ((void *)0)
# 321 "../crypto/bn/bn_exp.c"
                           ;
    ...
    if (!BN_is_odd(m)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",328,__func__), ERR_set_error)((3),(102),
# 328 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 328 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }

    if (m->top <= (0x7fffffff 
# 332 "../crypto/bn/bn_exp.c"
                 / 8 / 256)
        && (BN_get_flags(p, 0x04) != 0
            || BN_get_flags(a, 0x04) != 0
            || BN_get_flags(m, 0x04) != 0)) {
    ...
    val[0] = BN_CTX_get(ctx);
    if (val[0] == 
# 355 "../crypto/bn/bn_exp.c" 3 4
                 ((void *)0)
# 355 "../crypto/bn/bn_exp.c"
                     )
        goto err;
    ...
    if (in_mont != 
# 362 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 362 "../crypto/bn/bn_exp.c"
                      )
        mont = in_mont;
    else {
        if ((mont = BN_MONT_CTX_new()) == 
# 365 "../crypto/bn/bn_exp.c" 3 4
                                         ((void *)0)
# 365 "../crypto/bn/bn_exp.c"
                                             )
            goto err;
    ...
    if (window > 1) {
        ...
        for (i = 1; i < j; i++) {
            if (((val[i] = BN_CTX_get(ctx)) == 
# 386 "../crypto/bn/bn_exp.c" 3 4
                                              ((void *)0)
# 386 "../crypto/bn/bn_exp.c"
                                                  ) ||
    ...
    j = m->top;
    if (m->d[j - 1] & (((unsigned long)1) << ((8 * 8) - 1))) {
        if (bn_wexpand(r, j) == 
# 401 "../crypto/bn/bn_exp.c" 3 4
                               ((void *)0)
# 401 "../crypto/bn/bn_exp.c"
                                   )
            goto err;

        r->d[0] = (0 - m->d[0]) & (0xffffffffffffffffL);
        for (i = 1; i < j; i++)
            r->d[i] = (~m->d[i]) & (0xffffffffffffffffL);
        r->top = j;
        r->flags |= 0;
    } else
...
# 478 "../crypto/bn/bn_exp.c"
    if (!BN_from_montgomery(rr, r, mont, ctx))
        goto err;
    ret = 1;
 err:
    if (in_mont == 
# 482 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 482 "../crypto/bn/bn_exp.c"
                      )
...
static unsigned long bn_get_bits(const BIGNUM *a, int bitpos)
{
    unsigned long ret = 0;
    int wordpos;
    ...
    if (wordpos >= 0 && wordpos < a->top) {
        ret = a->d[wordpos] & (0xffffffffffffffffL);
        if (bitpos) {
            ret >>= bitpos;
            if (++wordpos < a->top)
                ret |= a->d[wordpos] << ((8 * 8) - bitpos);
        }
    }

    return ret & (0xffffffffffffffffL);
}
# 515 "../crypto/bn/bn_exp.c"
                                          ...
                                          int window)
{
    int i, j;
    int width = 1 << window;
# 547 "../crypto/bn/bn_exp.c"
    volatile unsigned long *table = (volatile unsigned long *)buf;

    if (bn_wexpand(b, top) == 
# 549 "../crypto/bn/bn_exp.c" 3 4
                             ((void *)0)
# 549 "../crypto/bn/bn_exp.c"
                                 )
        return 0;
    ...
    if (window <= 3) {
        for (i = 0; i < top; i++, table += width) {
            ...
            for (j = 0; j < width; j++) {
                acc |= table[j] &
                       ((unsigned long)0 - (constant_time_eq_int(j,idx)&1));
            }
        ...
        y0 = (unsigned long)0 - (constant_time_eq_int(i,0)&1);
        y1 = (unsigned long)0 - (constant_time_eq_int(i,1)&1);
        y2 = (unsigned long)0 - (constant_time_eq_int(i,2)&1);
        y3 = (unsigned long)0 - (constant_time_eq_int(i,3)&1);
                              ...
                              BN_MONT_CTX *in_mont)
{
    ...
    int top;
    BN_MONT_CTX *mont = 
# 615 "../crypto/bn/bn_exp.c" 3 4
                       ((void *)0)
# 615 "../crypto/bn/bn_exp.c"
                           ;

    int numPowers;
    unsigned char *powerbufFree = 
# 618 "../crypto/bn/bn_exp.c" 3 4
                                 ((void *)0)
# 618 "../crypto/bn/bn_exp.c"
                                     ;
    int powerbufLen = 0;
    unsigned char *powerbuf = 
# 620 "../crypto/bn/bn_exp.c" 3 4
                             ((void *)0)
# 620 "../crypto/bn/bn_exp.c"
                                 ;
    BIGNUM tmp, am;
    ...
    if (!BN_is_odd(m)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",627,__func__), ERR_set_error)((3),(102),
# 627 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 627 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
...
# 633 "../crypto/bn/bn_exp.c"
    ...
    if (in_mont != 
# 660 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 660 "../crypto/bn/bn_exp.c"
                      )
        mont = in_mont;
    else {
        if ((mont = BN_MONT_CTX_new()) == 
# 663 "../crypto/bn/bn_exp.c" 3 4
                                         ((void *)0)
# 663 "../crypto/bn/bn_exp.c"
                                             )
            goto err;
        if (!BN_MONT_CTX_set(mont, m, ctx))
            goto err;
    ...
    if (a->neg || BN_ucmp(a, m) >= 0) {
        ...
        if (reduced == 
# 671 "../crypto/bn/bn_exp.c" 3 4
                      ((void *)0)
            
# 672 "../crypto/bn/bn_exp.c"
    ...
    if ((16 == a->top) && (16 == p->top) && (BN_num_bits(m) == 1024)
        && rsaz_avx2_eligible()) {
        if (
# 686 "../crypto/bn/bn_exp.c" 3 4
           ((void *)0) 
# 686 "../crypto/bn/bn_exp.c"
                == bn_wexpand(rr, 16))
            goto err;
        ...
        if (
# 696 "../crypto/bn/bn_exp.c" 3 4
           ((void *)0) 
# 696 "../crypto/bn/bn_exp.c"
                == bn_wexpand(rr, 8))
            goto err;
...
# 717 "../crypto/bn/bn_exp.c"
    if (window >= 5 && top <= (4096 / 8)) {
        window = 5;
...
# 737 "../crypto/bn/bn_exp.c" 3 4
           __builtin_alloca (
# 737 "../crypto/bn/bn_exp.c"
           powerbufLen + ( 64 )
# 737 "../crypto/bn/bn_exp.c" 3 4
           )
# 737 "../crypto/bn/bn_exp.c"
        ...
        if ((powerbufFree =
             CRYPTO_malloc(powerbufLen + ( 64 ), "../crypto/bn/bn_exp.c", 741))
            == 
# 742 "../crypto/bn/bn_exp.c" 3 4
              ((void *)0)
# 742 "../crypto/bn/bn_exp.c"
                  )
        goto err;
    ...
    if (powerbufLen < 3072)
        powerbufFree = 
# 750 "../crypto/bn/bn_exp.c" 3 4
                      ((void *)0)
# 750 "../crypto/bn/bn_exp.c"
                          ;
    ...
    if (m->d[top - 1] & (((unsigned long)1) << ((8 * 8) - 1))) {

        tmp.d[0] = (0 - m->d[0]) & (0xffffffffffffffffL);
        for (i = 1; i < top; i++)
            tmp.d[i] = (~m->d[i]) & (0xffffffffffffffffL);
        tmp.top = top;
    } else
    ...
    if (top > (4096 / 8))
        goto fallback;
# 921 "../crypto/bn/bn_exp.c"
    if (window == 5 && top > 1) {
# 939 "../crypto/bn/bn_exp.c"
        ...
        void bn_gather5(unsigned long *out, size_t num, void *table, size_t power);
        void bn_power5(unsigned long *rp, const unsigned long *ap,
                       const void *table, const unsigned long *np,
                       const unsigned long *n0, int num, int power);
        int bn_get_bits5(const unsigned long *ap, int off);

        unsigned long *n0 = mont->n0, *np;
...
# 1145 "../crypto/bn/bn_exp.c"
    if (!bn_from_mont_fixed_top(rr, &tmp, mont, ctx))
        goto err;
    ret = 1;
 err:
    if (in_mont == 
# 1149 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 1149 "../crypto/bn/bn_exp.c"
                      )
        BN_MONT_CTX_free(mont);
    if (powerbuf != 
# 1151 "../crypto/bn/bn_exp.c" 3 4
                   ((void *)0)
# 1151 "../crypto/bn/bn_exp.c"
                       ) {
        OPENSSL_cleanse(powerbuf, powerbufLen);
        CRYPTO_free(powerbufFree, "../crypto/bn/bn_exp.c", 1153);
    }
    BN_CTX_end(ctx);
    return ret;
}
...
int BN_mod_exp_mont_word(BIGNUM *rr, unsigned long a, const BIGNUM *p,
                         const BIGNUM *m, BN_CTX *ctx, BN_MONT_CTX *in_mont)
{
    BN_MONT_CTX *mont = 
# 1175 "../crypto/bn/bn_exp.c" 3 4
                       ((void *)0)
# 1175 "../crypto/bn/bn_exp.c"
                           ;
    int b, bits, ret = 0;
    int r_is_one;
    ...
    BIGNUM *r, *t;
    BIGNUM *swap_tmp;
# 1198 "../crypto/bn/bn_exp.c"
    if (BN_get_flags(p, 0x04) != 0
            || BN_get_flags(m, 0x04) != 0) {

        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",1201,__func__), ERR_set_error)((3),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1201 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 1201 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
    ...
    if (!BN_is_odd(m)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",1209,__func__), ERR_set_error)((3),(102),
# 1209 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 1209 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
    if (m->top == 1)
    ...
    t = BN_CTX_get(ctx);
    if (t == 
# 1235 "../crypto/bn/bn_exp.c" 3 4
            ((void *)0)
# 1235 "../crypto/bn/bn_exp.c"
                )
        goto err;

    if (in_mont != 
# 1238 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 1238 "../crypto/bn/bn_exp.c"
                      )
        mont = in_mont;
    else {
        if ((mont = BN_MONT_CTX_new()) == 
# 1241 "../crypto/bn/bn_exp.c" 3 4
                                         ((void *)0)
# 1241 "../crypto/bn/bn_exp.c"
                                             )
            goto err;
        if (!BN_MONT_CTX_set(mont, m, ctx))
            goto err;
...
# 1262 "../crypto/bn/bn_exp.c" 3 4
                    ((void *)0)
# 1262 "../crypto/bn/bn_exp.c"
        ...
        if (BN_is_bit_set(p, b)) {
            ...
            if ((next_w / a) != w) {
                if (r_is_one) {
                    ...
                    if (!(BN_mul_word(r, (w)) && ( (BN_div(
# 1282 "../crypto/bn/bn_exp.c" 3 4
                        ((void *)0)
# 1282 "../crypto/bn/bn_exp.c"
                        ,(t),(r),(m),(ctx)) && (swap_tmp = r, r = t, t = swap_tmp, 1)))))
                        goto err;
                }
                next_w = a;
    ...
    if (w != 1) {
        if (r_is_one) {
            ...
            if (!(BN_mul_word(r, (w)) && ( (BN_div(
# 1298 "../crypto/bn/bn_exp.c" 3 4
                ((void *)0)
# 1298 "../crypto/bn/bn_exp.c"
                ,(t),(r),(m),(ctx)) && (swap_tmp = r, r = t, t = swap_tmp, 1)))))
                goto err;
        }
    }
 ...
 err:
    if (in_mont == 
# 1312 "../crypto/bn/bn_exp.c" 3 4
                  ((void *)0)
# 1312 "../crypto/bn/bn_exp.c"
                      )
        BN_MONT_CTX_free(mont);
    BN_CTX_end(ctx);
    ;
                      ...
                      const BIGNUM *m, BN_CTX *ctx)
{
    ...
    if (BN_get_flags(p, 0x04) != 0
        ...
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",1333,__func__), ERR_set_error)((3),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 1333 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 1333 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }

    if (r == m) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_exp.c",1338,__func__), ERR_set_error)((3),((262|(0x2 << 18L))),
# 1338 "../crypto/bn/bn_exp.c" 3 4
       ((void *)0)
# 1338 "../crypto/bn/bn_exp.c"
       );
        return 0;
    }
    ...
    val[0] = BN_CTX_get(ctx);
    if (val[0] == 
# 1357 "../crypto/bn/bn_exp.c" 3 4
                 ((void *)0)
# 1357 "../crypto/bn/bn_exp.c"
                     )
        goto err;
    ...
    if (window > 1) {
        ...
        for (i = 1; i < j; i++) {
            if (((val[i] = BN_CTX_get(ctx)) == 
# 1374 "../crypto/bn/bn_exp.c" 3 4
                                              ((void *)0)
# 1374 "../crypto/bn/bn_exp.c"
                                                  ) ||
    ...
    if (r == p) {
        ...
        if (p_dup == 
# 1389 "../crypto/bn/bn_exp.c" 3 4
                    ((void *)0) 
# 1389 "../crypto/bn/bn_exp.c"
                         || BN_copy(p_dup, p) == 
# 1389 "../crypto/bn/bn_exp.c" 3 4
                                                 ((void *)0)
# 1389 "../crypto/bn/bn_exp.c"
                                 ...
                                 BN_CTX *ctx)
{
    ...
    BN_MONT_CTX *mont1 = 
# 1468 "../crypto/bn/bn_exp.c" 3 4
                        ((void *)0)
# 1468 "../crypto/bn/bn_exp.c"
                            ;
    BN_MONT_CTX *mont2 = 
# 1469 "../crypto/bn/bn_exp.c" 3 4
                        ((void *)0)
# 1469 "../crypto/bn/bn_exp.c"
                            ;
    ...
    if (ossl_rsaz_avx512ifma_eligible() &&
        ...
        if (bn_wexpand(rr1, topn) == 
# 1483 "../crypto/bn/bn_exp.c" 3 4
                                    ((void *)0)
# 1483 "../crypto/bn/bn_exp.c"
                                        )
            goto err;
        if (bn_wexpand(rr2, topn) == 
# 1485 "../crypto/bn/bn_exp.c" 3 4
                                    ((void *)0)
# 1485 "../crypto/bn/bn_exp.c"
                                        )
            goto err;


        if (in_mont1 != 
# 1489 "../crypto/bn/bn_exp.c" 3 4
                       ((void *)0)
# 1489 "../crypto/bn/bn_exp.c"
                           ) {
            mont1 = in_mont1;
        } else {
            if ((mont1 = BN_MONT_CTX_new()) == 
# 1492 "../crypto/bn/bn_exp.c" 3 4
                                              ((void *)0)
# 1492 "../crypto/bn/bn_exp.c"
                                                  )
                goto err;
        ...
        if (in_mont2 != 
# 1497 "../crypto/bn/bn_exp.c" 3 4
                       ((void *)0)
# 1497 "../crypto/bn/bn_exp.c"
                           ) {
            mont2 = in_mont2;
        } else {
            if ((mont2 = BN_MONT_CTX_new()) == 
# 1500 "../crypto/bn/bn_exp.c" 3 4
                                              ((void *)0)
# 1500 "../crypto/bn/bn_exp.c"
                                                  )
                goto err;
...
err:
    if (in_mont2 == 
# 1533 "../crypto/bn/bn_exp.c" 3 4
                   ((void *)0)
# 1533 "../crypto/bn/bn_exp.c"
                       )
        BN_MONT_CTX_free(mont2);
    if (in_mont1 == 
# 1535 "../crypto/bn/bn_exp.c" 3 4
                   ((void *)0)
# 1535 "../crypto/bn/bn_exp.c"
                       )
