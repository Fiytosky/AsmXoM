# 0 "../crypto/bn/bn_div.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bn/bn_div.c"
# 10 "../crypto/bn/bn_div.c"
...
int ossl_bn_check_prime(const BIGNUM *w, int checks, BN_CTX *ctx,
                        int do_trial_division, BN_GENCB *cb);
# 14 "../crypto/bn/bn_div.c" 2
# 141 "../crypto/bn/bn_div.c"
static int bn_left_align(BIGNUM *num)
{
    unsigned long *d = num->d, n, m, rmask;
    int top = num->top;
    int rshift = BN_num_bits_word(d[top - 1]), lshift, i;

    lshift = (8 * 8) - rshift;
    rshift %= (8 * 8);
    rmask = (unsigned long)0 - rshift;
    rmask |= rmask >> 8;

    for (i = 0, m = 0; i < top; i++) {
        n = d[i];
        d[i] = ((n << lshift) | m) & (0xffffffffffffffffL);
        m = (n >> rshift) & rmask;
    }

    return lshift;
}
# 209 "../crypto/bn/bn_div.c"
           ...
           BN_CTX *ctx)
{
    ...
    if (BN_is_zero(divisor)) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_div.c",215,__func__), ERR_set_error)((3),(103),
# 215 "../crypto/bn/bn_div.c" 3 4
       ((void *)0)
# 215 "../crypto/bn/bn_div.c"
       );
        return 0;
    }
    ...
    if (divisor->d[divisor->top - 1] == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bn/bn_div.c",225,__func__), ERR_set_error)((3),(107),
# 225 "../crypto/bn/bn_div.c" 3 4
       ((void *)0)
# 225 "../crypto/bn/bn_div.c"
       );
        return 0;
    }
    ...
    if (ret) {
        if (dv != 
# 232 "../crypto/bn/bn_div.c" 3 4
                 ((void *)0)
# 232 "../crypto/bn/bn_div.c"
                     )
            bn_correct_top(dv);
        if (rm != 
# 234 "../crypto/bn/bn_div.c" 3 4
                 ((void *)0)
# 234 "../crypto/bn/bn_div.c"
                     )
            bn_correct_top(rm);
    }
...
# 264 "../crypto/bn/bn_div.c"
int bn_div_fixed_top(BIGNUM *dv, BIGNUM *rm, const BIGNUM *num,
                     const BIGNUM *divisor, BN_CTX *ctx)
{
    int norm_shift, i, j, loop;
    BIGNUM *tmp, *snum, *sdiv, *res;
    unsigned long *resp, *wnum, *wnumtop;
    unsigned long d0, d1;
    int num_n, div_n, num_neg;

    
# 273 "../crypto/bn/bn_div.c" 3 4
   ((void) (0))
# 273 "../crypto/bn/bn_div.c"
                                                                ;
    ...
    BN_CTX_start(ctx);
    res = (dv == 
# 281 "../crypto/bn/bn_div.c" 3 4
                ((void *)0)
# 281 "../crypto/bn/bn_div.c"
                    ) ? BN_CTX_get(ctx) : dv;
    tmp = BN_CTX_get(ctx);
    snum = BN_CTX_get(ctx);
    sdiv = BN_CTX_get(ctx);
    if (sdiv == 
# 285 "../crypto/bn/bn_div.c" 3 4
               ((void *)0)
# 285 "../crypto/bn/bn_div.c"
                   )
        goto err;
    ...
    if (num_n <= div_n) {
        ...
        if (bn_wexpand(snum, div_n + 1) == 
# 308 "../crypto/bn/bn_div.c" 3 4
                                          ((void *)0)
# 308 "../crypto/bn/bn_div.c"
                                              )
            goto err;
        memset(&(snum->d[num_n]), 0, (div_n - num_n + 1) * sizeof(unsigned long));
    ...
    for (i = 0; i < loop; i++, wnumtop--) {
        ...
        if (n0 == d0)
            ...
            unsigned long n2 = (wnumtop == wnum) ? 0 : wnumtop[-2];
# 384 "../crypto/bn/bn_div.c"
            unsigned long t2l, t2h;

            q = ({ asm volatile ( "divq   %4" : "=a"(q), "=d"(rem) : "a"(n1), "d"(n0), "r"(d0) : "cc"); q; });





            ({ uint128_t ret=(uint128_t)(d1)*(q); (t2h)=ret>>64; (t2l)=ret; });
# 407 "../crypto/bn/bn_div.c"
            for (;;) {
...
# 440 "../crypto/bn/bn_div.c" 3 4
       ((void) (0))
# 440 "../crypto/bn/bn_div.c"
                              ;
    ...
    if (rm != 
# 450 "../crypto/bn/bn_div.c" 3 4
             ((void *)0) 
# 450 "../crypto/bn/bn_div.c"
                  && bn_rshift_fixed_top(rm, snum, norm_shift) == 0)
        goto err;
