...
{
    OSSL_FUNC_core_get_libctx_fn *c_get_libctx = 
# 57 "../crypto/provider_child.c" 3 4
                                                ((void *)0)
# 57 "../crypto/provider_child.c"
                                                    ;
    OSSL_LIB_CTX *ctx;
    ...
    if (c_get_libctx == 
# 72 "../crypto/provider_child.c" 3 4
                       ((void *)0)
# 72 "../crypto/provider_child.c"
                           )
        return 0;
    ...
    gbl = ossl_lib_ctx_get_data(ctx, 18);
    if (gbl == 
# 83 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 83 "../crypto/provider_child.c"
                  )
        return 0;
...
static int provider_create_child_cb(const OSSL_CORE_HANDLE *prov, void *cbdata)
{
    ...
    gbl = ossl_lib_ctx_get_data(ctx, 18);
    if (gbl == 
# 101 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 101 "../crypto/provider_child.c"
                  )
        return 0;
    ...
    if ((cprov = ossl_provider_find(ctx, provname, 1)) != 
# 115 "../crypto/provider_child.c" 3 4
                                                         ((void *)0)
# 115 "../crypto/provider_child.c"
                                                             ) {
...
# 135 "../crypto/provider_child.c" 3 4
                                      ((void *)0)
# 135 "../crypto/provider_child.c"
                                          , 1)) == 
# 135 "../crypto/provider_child.c" 3 4
                                                   ((void *)0)
# 135 "../crypto/provider_child.c"
...
# 144 "../crypto/provider_child.c" 3 4
                                                 ((void *)0)
# 144 "../crypto/provider_child.c"
                                                     , 0)) {
...
static int provider_remove_child_cb(const OSSL_CORE_HANDLE *prov, void *cbdata)
{
    ...
    gbl = ossl_lib_ctx_get_data(ctx, 18);
    if (gbl == 
# 165 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 165 "../crypto/provider_child.c"
                  )
        return 0;
    ...
    if (cprov == 
# 170 "../crypto/provider_child.c" 3 4
                ((void *)0)
# 170 "../crypto/provider_child.c"
                    )
        return 0;
                                ...
                                const OSSL_DISPATCH *in)
{
    ...
    if (ctx == 
# 197 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 197 "../crypto/provider_child.c"
                  )
        return 0;

    gbl = ossl_lib_ctx_get_data(ctx, 18);
    if (gbl == 
# 201 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 201 "../crypto/provider_child.c"
                  )
        return 0;
    ...
    if (gbl->c_get_libctx == 
# 241 "../crypto/provider_child.c" 3 4
                            ((void *)0)
            
# 242 "../crypto/provider_child.c"
           || gbl->c_provider_register_child_cb == 
# 242 "../crypto/provider_child.c" 3 4
                                                   ((void *)0)
            
# 243 "../crypto/provider_child.c"
           || gbl->c_prov_name == 
# 243 "../crypto/provider_child.c" 3 4
                                  ((void *)0)
            
# 244 "../crypto/provider_child.c"
           || gbl->c_prov_get0_provider_ctx == 
# 244 "../crypto/provider_child.c" 3 4
                                               ((void *)0)
            
# 245 "../crypto/provider_child.c"
           || gbl->c_prov_get0_dispatch == 
# 245 "../crypto/provider_child.c" 3 4
                                           ((void *)0)
            
# 246 "../crypto/provider_child.c"
           || gbl->c_prov_up_ref == 
# 246 "../crypto/provider_child.c" 3 4
                                    ((void *)0)
            
# 247 "../crypto/provider_child.c"
           || gbl->c_prov_free == 
# 247 "../crypto/provider_child.c" 3 4
                                  ((void *)0)
# 247 "../crypto/provider_child.c"
                                      )
        return 0;
    ...
    if (gbl->lock == 
# 251 "../crypto/provider_child.c" 3 4
                    ((void *)0)
# 251 "../crypto/provider_child.c"
                        )
        return 0;
...
{
    struct child_prov_globals *gbl
        = ossl_lib_ctx_get_data(ctx, 18);
    if (gbl == 
# 268 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 268 "../crypto/provider_child.c"
                  )
        return;
...
int ossl_provider_up_ref_parent(OSSL_PROVIDER *prov, int activate)
{
    ...
    gbl = ossl_lib_ctx_get_data(ossl_provider_libctx(prov),
                                18);
    if (gbl == 
# 293 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 293 "../crypto/provider_child.c"
                  )
        return 0;
...
int ossl_provider_free_parent(OSSL_PROVIDER *prov, int deactivate)
{
    ...
    gbl = ossl_lib_ctx_get_data(ossl_provider_libctx(prov),
                                18);
    if (gbl == 
# 309 "../crypto/provider_child.c" 3 4
              ((void *)0)
# 309 "../crypto/provider_child.c"
                  )
        return 0;
