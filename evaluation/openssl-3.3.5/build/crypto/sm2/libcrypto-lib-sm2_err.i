# 0 "../crypto/sm2/sm2_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sm2/sm2_err.c"
# 11 "../crypto/sm2/sm2_err.c"
...
static const ERR_STRING_DATA SM2_str_reasons[] = {
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "asn1 error"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad signature"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "buffer too small"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "dist id too large"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "id not set"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "id too large"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "invalid curve"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "invalid digest"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "invalid digest type"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "invalid encoding"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "invalid field"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "invalid private key"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "no parameters set"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "user id too large"},
    {0, 
# 35 "../crypto/sm2/sm2_err.c" 3 4
       ((void *)0)
# 35 "../crypto/sm2/sm2_err.c"
           }
};
...
int ossl_err_load_SM2_strings(void)
{
    ...
    if (ERR_reason_error_string(SM2_str_reasons[0].error) == 
# 43 "../crypto/sm2/sm2_err.c" 3 4
                                                            ((void *)0)
# 43 "../crypto/sm2/sm2_err.c"
                                                                )
