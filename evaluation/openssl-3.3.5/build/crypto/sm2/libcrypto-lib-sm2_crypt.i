# 0 "../crypto/sm2/sm2_crypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sm2/sm2_crypt.c"
# 16 "../crypto/sm2/sm2_crypt.c"
...
const unsigned char *ossl_sm2_algorithmidentifier_encoding(int md_nid,
                                                           size_t *len);
# 19 "../crypto/sm2/sm2_crypt.c" 2
# 1 "../include/crypto/sm2err.h" 1
# 13 "../include/crypto/sm2err.h"
        
# 24 "../include/crypto/sm2err.h"
int ossl_err_load_SM2_strings(void);
# 20 "../crypto/sm2/sm2_crypt.c" 2
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 26 "../crypto/sm2/sm2_crypt.c" 2


typedef struct SM2_Ciphertext_st SM2_Ciphertext;
extern SM2_Ciphertext *SM2_Ciphertext_new(void); extern void SM2_Ciphertext_free(SM2_Ciphertext *a); extern SM2_Ciphertext *d2i_SM2_Ciphertext(SM2_Ciphertext **a, const unsigned char **in, long len); extern int i2d_SM2_Ciphertext(const SM2_Ciphertext *a, unsigned char **out); extern const ASN1_ITEM * SM2_Ciphertext_it(void);
...
static const ASN1_TEMPLATE SM2_Ciphertext_seq_tt[] = {
    { (0), (0), 
# 39 "../crypto/sm2/sm2_crypt.c" 3 4
   __builtin_offsetof (
# 39 "../crypto/sm2/sm2_crypt.c"
   SM2_Ciphertext
# 39 "../crypto/sm2/sm2_crypt.c" 3 4
   , 
# 39 "../crypto/sm2/sm2_crypt.c"
...
# 39 "../crypto/sm2/sm2_crypt.c"
   , "C1x", (BIGNUM_it) },
    { (0), (0), 
# 40 "../crypto/sm2/sm2_crypt.c" 3 4
   __builtin_offsetof (
# 40 "../crypto/sm2/sm2_crypt.c"
   SM2_Ciphertext
# 40 "../crypto/sm2/sm2_crypt.c" 3 4
   , 
# 40 "../crypto/sm2/sm2_crypt.c"
...
# 40 "../crypto/sm2/sm2_crypt.c"
   , "C1y", (BIGNUM_it) },
    { (0), (0), 
# 41 "../crypto/sm2/sm2_crypt.c" 3 4
   __builtin_offsetof (
# 41 "../crypto/sm2/sm2_crypt.c"
   SM2_Ciphertext
# 41 "../crypto/sm2/sm2_crypt.c" 3 4
   , 
# 41 "../crypto/sm2/sm2_crypt.c"
...
# 41 "../crypto/sm2/sm2_crypt.c"
   , "C3", (ASN1_OCTET_STRING_it) },
    { (0), (0), 
# 42 "../crypto/sm2/sm2_crypt.c" 3 4
   __builtin_offsetof (
# 42 "../crypto/sm2/sm2_crypt.c"
   SM2_Ciphertext
# 42 "../crypto/sm2/sm2_crypt.c" 3 4
   , 
# 42 "../crypto/sm2/sm2_crypt.c"
...
# 42 "../crypto/sm2/sm2_crypt.c"
   , "C2", (ASN1_OCTET_STRING_it) },
} ; const ASN1_ITEM * SM2_Ciphertext_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, SM2_Ciphertext_seq_tt, sizeof(SM2_Ciphertext_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 43 "../crypto/sm2/sm2_crypt.c" 3 4
 ((void *)0)
# 43 "../crypto/sm2/sm2_crypt.c"
 , sizeof(SM2_Ciphertext), "SM2_Ciphertext" }; return &local_it; }

SM2_Ciphertext *d2i_SM2_Ciphertext(SM2_Ciphertext **a, const unsigned char **in, long len) { return (SM2_Ciphertext *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (SM2_Ciphertext_it())); } int i2d_SM2_Ciphertext(const SM2_Ciphertext *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (SM2_Ciphertext_it())); } SM2_Ciphertext *SM2_Ciphertext_new(void) { return (SM2_Ciphertext *)ASN1_item_new((SM2_Ciphertext_it())); } void SM2_Ciphertext_free(SM2_Ciphertext *a) { ASN1_item_free((ASN1_VALUE *)a, (SM2_Ciphertext_it())); }
...
static size_t ec_field_size(const EC_GROUP *group)
{
    ...
    if (p == 
# 51 "../crypto/sm2/sm2_crypt.c" 3 4
            ((void *)0)
# 51 "../crypto/sm2/sm2_crypt.c"
                )
        return 0;

    return ((BN_num_bits(p)+7)/8);
}
...
int ossl_sm2_plaintext_size(const unsigned char *ct, size_t ct_size,
                            size_t *pt_size)
{
    struct SM2_Ciphertext_st *sm2_ctext = 
# 72 "../crypto/sm2/sm2_crypt.c" 3 4
                                         ((void *)0)
# 72 "../crypto/sm2/sm2_crypt.c"
                                             ;

    sm2_ctext = d2i_SM2_Ciphertext(
# 74 "../crypto/sm2/sm2_crypt.c" 3 4
                                  ((void *)0)
# 74 "../crypto/sm2/sm2_crypt.c"
                                      , &ct, ct_size);

    if (sm2_ctext == 
# 76 "../crypto/sm2/sm2_crypt.c" 3 4
                    ((void *)0)
# 76 "../crypto/sm2/sm2_crypt.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",77,__func__), ERR_set_error)((53),(104),
# 77 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 77 "../crypto/sm2/sm2_crypt.c"
       );
        return 0;
    }
                             ...
                             size_t msg_len, size_t *ct_size)
{
    ...
    sz = 2 * ASN1_object_size(0, field_size + 1, 2)
         + ASN1_object_size(0, md_size, 4)
         + ASN1_object_size(0, msg_len, 4);

    *ct_size = ASN1_object_size(1, sz, 16);
                     ...
                     uint8_t *ciphertext_buf, size_t *ciphertext_len)
{
    ...
    size_t i;
    BN_CTX *ctx = 
# 114 "../crypto/sm2/sm2_crypt.c" 3 4
                 ((void *)0)
# 114 "../crypto/sm2/sm2_crypt.c"
                     ;
    BIGNUM *k = 
# 115 "../crypto/sm2/sm2_crypt.c" 3 4
               ((void *)0)
# 115 "../crypto/sm2/sm2_crypt.c"
                   ;
    BIGNUM *x1 = 
# 116 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 116 "../crypto/sm2/sm2_crypt.c"
                    ;
    BIGNUM *y1 = 
# 117 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 117 "../crypto/sm2/sm2_crypt.c"
                    ;
    BIGNUM *x2 = 
# 118 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 118 "../crypto/sm2/sm2_crypt.c"
                    ;
    BIGNUM *y2 = 
# 119 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 119 "../crypto/sm2/sm2_crypt.c"
                    ;
    ...
    EC_POINT *kG = 
# 125 "../crypto/sm2/sm2_crypt.c" 3 4
                  ((void *)0)
# 125 "../crypto/sm2/sm2_crypt.c"
                      ;
    EC_POINT *kP = 
# 126 "../crypto/sm2/sm2_crypt.c" 3 4
                  ((void *)0)
# 126 "../crypto/sm2/sm2_crypt.c"
                      ;
    uint8_t *msg_mask = 
# 127 "../crypto/sm2/sm2_crypt.c" 3 4
                       ((void *)0)
# 127 "../crypto/sm2/sm2_crypt.c"
                           ;
    uint8_t *x2y2 = 
# 128 "../crypto/sm2/sm2_crypt.c" 3 4
                   ((void *)0)
# 128 "../crypto/sm2/sm2_crypt.c"
                       ;
    uint8_t *C3 = 
# 129 "../crypto/sm2/sm2_crypt.c" 3 4
                 ((void *)0)
# 129 "../crypto/sm2/sm2_crypt.c"
                     ;
    size_t field_size;
    const int C3_size = EVP_MD_get_size(digest);
    EVP_MD *fetched_digest = 
# 132 "../crypto/sm2/sm2_crypt.c" 3 4
                            ((void *)0)
# 132 "../crypto/sm2/sm2_crypt.c"
                                ;
    ...
    ctext_struct.C2 = 
# 137 "../crypto/sm2/sm2_crypt.c" 3 4
                     ((void *)0)
# 137 "../crypto/sm2/sm2_crypt.c"
                         ;
    ctext_struct.C3 = 
# 138 "../crypto/sm2/sm2_crypt.c" 3 4
                     ((void *)0)
# 138 "../crypto/sm2/sm2_crypt.c"
                         ;

    if (hash == 
# 140 "../crypto/sm2/sm2_crypt.c" 3 4
               ((void *)0) 
# 140 "../crypto/sm2/sm2_crypt.c"
                    || C3_size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",141,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 141 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 141 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (field_size == 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",147,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 147 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 147 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (kG == 
# 153 "../crypto/sm2/sm2_crypt.c" 3 4
             ((void *)0) 
# 153 "../crypto/sm2/sm2_crypt.c"
                  || kP == 
# 153 "../crypto/sm2/sm2_crypt.c" 3 4
                           ((void *)0)
# 153 "../crypto/sm2/sm2_crypt.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",154,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 154 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 154 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ctx = BN_CTX_new_ex(libctx);
    if (ctx == 
# 158 "../crypto/sm2/sm2_crypt.c" 3 4
              ((void *)0)
# 158 "../crypto/sm2/sm2_crypt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",159,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 159 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 159 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (y2 == 
# 170 "../crypto/sm2/sm2_crypt.c" 3 4
             ((void *)0)
# 170 "../crypto/sm2/sm2_crypt.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",171,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 171 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 171 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    x2y2 = CRYPTO_zalloc(2 * field_size, "../crypto/sm2/sm2_crypt.c", 175);
    C3 = CRYPTO_zalloc(C3_size, "../crypto/sm2/sm2_crypt.c", 176);

    if (x2y2 == 
# 178 "../crypto/sm2/sm2_crypt.c" 3 4
               ((void *)0) 
# 178 "../crypto/sm2/sm2_crypt.c"
                    || C3 == 
# 178 "../crypto/sm2/sm2_crypt.c" 3 4
                             ((void *)0)
# 178 "../crypto/sm2/sm2_crypt.c"
    ...
    msg_mask = CRYPTO_zalloc(msg_len, "../crypto/sm2/sm2_crypt.c", 183);
    if (msg_mask == 
# 184 "../crypto/sm2/sm2_crypt.c" 3 4
                   ((void *)0)
# 184 "../crypto/sm2/sm2_crypt.c"
                       )
       goto done;

again:
    if (!BN_priv_rand_range_ex(k, order, 0, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",189,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 189 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 189 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    if (!EC_POINT_mul(group, kG, k, 
# 193 "../crypto/sm2/sm2_crypt.c" 3 4
                                   ((void *)0)
# 193 "../crypto/sm2/sm2_crypt.c"
                                       , 
# 193 "../crypto/sm2/sm2_crypt.c" 3 4
                                         ((void *)0)
# 193 "../crypto/sm2/sm2_crypt.c"
            ...
            || !EC_POINT_mul(group, kP, 
# 195 "../crypto/sm2/sm2_crypt.c" 3 4
                                       ((void *)0)
# 195 "../crypto/sm2/sm2_crypt.c"
                                           , P, k, ctx)
            || !EC_POINT_get_affine_coordinates(group, kP, x2, y2, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",197,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 197 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 197 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (BN_bn2binpad(x2, x2y2, field_size) < 0
        ...
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",203,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 203 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 203 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
...
# 208 "../crypto/sm2/sm2_crypt.c" 3 4
                                                                     ((void *)0)
# 208 "../crypto/sm2/sm2_crypt.c"
                                                                         , 0,
                             digest, libctx, propq)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",210,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 210 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 210 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (fetched_digest == 
# 223 "../crypto/sm2/sm2_crypt.c" 3 4
                         ((void *)0)
# 223 "../crypto/sm2/sm2_crypt.c"
                             ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",224,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 224 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 224 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    if (EVP_DigestInit(hash, fetched_digest) == 0
            ...
            || EVP_DigestFinal(hash, C3, 
# 231 "../crypto/sm2/sm2_crypt.c" 3 4
                                        ((void *)0)
# 231 "../crypto/sm2/sm2_crypt.c"
                                            ) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",232,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 232 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 232 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (ctext_struct.C3 == 
# 241 "../crypto/sm2/sm2_crypt.c" 3 4
                          ((void *)0) 
# 241 "../crypto/sm2/sm2_crypt.c"
                               || ctext_struct.C2 == 
# 241 "../crypto/sm2/sm2_crypt.c" 3 4
                                                     ((void *)0)
# 241 "../crypto/sm2/sm2_crypt.c"
                                                         ) {
       (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",242,__func__), ERR_set_error)((53),((13 | (0x2 << 18L))),
# 242 "../crypto/sm2/sm2_crypt.c" 3 4
      ((void *)0)
# 242 "../crypto/sm2/sm2_crypt.c"
      );
       goto done;
    }
    if (!ASN1_OCTET_STRING_set(ctext_struct.C3, C3, C3_size)
            || !ASN1_OCTET_STRING_set(ctext_struct.C2, msg_mask, msg_len)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",247,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 247 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 247 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (ciphertext_leni < 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",254,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 254 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 254 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    *ciphertext_len = (size_t)ciphertext_leni;
    ...
    CRYPTO_free(msg_mask, "../crypto/sm2/sm2_crypt.c", 265);
    CRYPTO_free(x2y2, "../crypto/sm2/sm2_crypt.c", 266);
    CRYPTO_free(C3, "../crypto/sm2/sm2_crypt.c", 267);
                     ...
                     uint8_t *ptext_buf, size_t *ptext_len)
{
    ...
    int i;
    BN_CTX *ctx = 
# 282 "../crypto/sm2/sm2_crypt.c" 3 4
                 ((void *)0)
# 282 "../crypto/sm2/sm2_crypt.c"
                     ;
    const EC_GROUP *group = EC_KEY_get0_group(key);
    EC_POINT *C1 = 
# 284 "../crypto/sm2/sm2_crypt.c" 3 4
                  ((void *)0)
# 284 "../crypto/sm2/sm2_crypt.c"
                      ;
    struct SM2_Ciphertext_st *sm2_ctext = 
# 285 "../crypto/sm2/sm2_crypt.c" 3 4
                                         ((void *)0)
# 285 "../crypto/sm2/sm2_crypt.c"
                                             ;
    BIGNUM *x2 = 
# 286 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 286 "../crypto/sm2/sm2_crypt.c"
                    ;
    BIGNUM *y2 = 
# 287 "../crypto/sm2/sm2_crypt.c" 3 4
                ((void *)0)
# 287 "../crypto/sm2/sm2_crypt.c"
                    ;
    uint8_t *x2y2 = 
# 288 "../crypto/sm2/sm2_crypt.c" 3 4
                   ((void *)0)
# 288 "../crypto/sm2/sm2_crypt.c"
                       ;
    uint8_t *computed_C3 = 
# 289 "../crypto/sm2/sm2_crypt.c" 3 4
                          ((void *)0)
# 289 "../crypto/sm2/sm2_crypt.c"
                              ;
    const size_t field_size = ec_field_size(group);
    const int hash_size = EVP_MD_get_size(digest);
    uint8_t *msg_mask = 
# 292 "../crypto/sm2/sm2_crypt.c" 3 4
                       ((void *)0)
# 292 "../crypto/sm2/sm2_crypt.c"
                           ;
    const uint8_t *C2 = 
# 293 "../crypto/sm2/sm2_crypt.c" 3 4
                       ((void *)0)
# 293 "../crypto/sm2/sm2_crypt.c"
                           ;
    const uint8_t *C3 = 
# 294 "../crypto/sm2/sm2_crypt.c" 3 4
                       ((void *)0)
# 294 "../crypto/sm2/sm2_crypt.c"
                           ;
    int msg_len = 0;
    EVP_MD_CTX *hash = 
# 296 "../crypto/sm2/sm2_crypt.c" 3 4
                      ((void *)0)
# 296 "../crypto/sm2/sm2_crypt.c"
                          ;
    OSSL_LIB_CTX *libctx = ossl_ec_key_get_libctx(key);
    const char *propq = ossl_ec_key_get0_propq(key);
    ...
    sm2_ctext = d2i_SM2_Ciphertext(
# 305 "../crypto/sm2/sm2_crypt.c" 3 4
                                  ((void *)0)
# 305 "../crypto/sm2/sm2_crypt.c"
                                      , &ciphertext, ciphertext_len);

    if (sm2_ctext == 
# 307 "../crypto/sm2/sm2_crypt.c" 3 4
                    ((void *)0)
# 307 "../crypto/sm2/sm2_crypt.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",308,__func__), ERR_set_error)((53),(100),
# 308 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 308 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    if (sm2_ctext->C3->length != hash_size) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",313,__func__), ERR_set_error)((53),(104),
# 313 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 313 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (*ptext_len < (size_t)msg_len) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",321,__func__), ERR_set_error)((53),(107),
# 321 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 321 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    ctx = BN_CTX_new_ex(libctx);
    if (ctx == 
# 326 "../crypto/sm2/sm2_crypt.c" 3 4
              ((void *)0)
# 326 "../crypto/sm2/sm2_crypt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",327,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 327 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 327 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (y2 == 
# 335 "../crypto/sm2/sm2_crypt.c" 3 4
             ((void *)0)
# 335 "../crypto/sm2/sm2_crypt.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",336,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 336 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 336 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    msg_mask = CRYPTO_zalloc(msg_len, "../crypto/sm2/sm2_crypt.c", 340);
    x2y2 = CRYPTO_zalloc(2 * field_size, "../crypto/sm2/sm2_crypt.c", 341);
    computed_C3 = CRYPTO_zalloc(hash_size, "../crypto/sm2/sm2_crypt.c", 342);

    if (msg_mask == 
# 344 "../crypto/sm2/sm2_crypt.c" 3 4
                   ((void *)0) 
# 344 "../crypto/sm2/sm2_crypt.c"
                        || x2y2 == 
# 344 "../crypto/sm2/sm2_crypt.c" 3 4
                                   ((void *)0) 
# 344 "../crypto/sm2/sm2_crypt.c"
...
# 344 "../crypto/sm2/sm2_crypt.c"
    ...
    if (C1 == 
# 348 "../crypto/sm2/sm2_crypt.c" 3 4
             ((void *)0)
# 348 "../crypto/sm2/sm2_crypt.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",349,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 349 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 349 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (!EC_POINT_set_affine_coordinates(group, C1, sm2_ctext->C1x,
                                         sm2_ctext->C1y, ctx)
            || !EC_POINT_mul(group, C1, 
# 355 "../crypto/sm2/sm2_crypt.c" 3 4
                                       ((void *)0)
# 355 "../crypto/sm2/sm2_crypt.c"
                                           , C1, EC_KEY_get0_private_key(key),
                             ctx)
            || !EC_POINT_get_affine_coordinates(group, C1, x2, y2, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",358,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 358 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 358 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
...
# 365 "../crypto/sm2/sm2_crypt.c" 3 4
                                   ((void *)0)
# 365 "../crypto/sm2/sm2_crypt.c"
                                       , 0, digest, libctx, propq)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",366,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 366 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 366 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    if (is_all_zeros(msg_mask, msg_len)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",371,__func__), ERR_set_error)((53),(104),
# 371 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 371 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    hash = EVP_MD_CTX_new();
    if (hash == 
# 379 "../crypto/sm2/sm2_crypt.c" 3 4
               ((void *)0)
# 379 "../crypto/sm2/sm2_crypt.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",380,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 380 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 380 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    if (!EVP_DigestInit(hash, digest)
            ...
            || !EVP_DigestFinal(hash, computed_C3, 
# 388 "../crypto/sm2/sm2_crypt.c" 3 4
                                                  ((void *)0)
# 388 "../crypto/sm2/sm2_crypt.c"
                                                      )) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",389,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 389 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 389 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }

    if (CRYPTO_memcmp(computed_C3, C3, hash_size) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_crypt.c",394,__func__), ERR_set_error)((53),(102),
# 394 "../crypto/sm2/sm2_crypt.c" 3 4
       ((void *)0)
# 394 "../crypto/sm2/sm2_crypt.c"
       );
        goto done;
    }
    ...
    *ptext_len = msg_len;
    ...
    CRYPTO_free(msg_mask, "../crypto/sm2/sm2_crypt.c", 405);
    CRYPTO_free(x2y2, "../crypto/sm2/sm2_crypt.c", 406);
    CRYPTO_free(computed_C3, "../crypto/sm2/sm2_crypt.c", 407);
    EC_POINT_free(C1);
    BN_CTX_free(ctx);
    SM2_Ciphertext_free(sm2_ctext);
    EVP_MD_CTX_free(hash);
