# 0 "../crypto/sm2/sm2_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sm2/sm2_key.c"
# 10 "../crypto/sm2/sm2_key.c"
...
int ossl_sm2_key_private_check(const EC_KEY *eckey)
{
    int ret = 0;
    BIGNUM *max = 
# 25 "../crypto/sm2/sm2_key.c" 3 4
                 ((void *)0)
# 25 "../crypto/sm2/sm2_key.c"
                     ;
    const EC_GROUP *group = 
# 26 "../crypto/sm2/sm2_key.c" 3 4
                           ((void *)0)
# 26 "../crypto/sm2/sm2_key.c"
                               ;
    const BIGNUM *priv_key = 
# 27 "../crypto/sm2/sm2_key.c" 3 4
                            ((void *)0)
# 27 "../crypto/sm2/sm2_key.c"
                                , *order = 
# 27 "../crypto/sm2/sm2_key.c" 3 4
                                           ((void *)0)
# 27 "../crypto/sm2/sm2_key.c"
    ...
    if (eckey == 
# 29 "../crypto/sm2/sm2_key.c" 3 4
                ((void *)0)
            
# 30 "../crypto/sm2/sm2_key.c"
           || (group = EC_KEY_get0_group(eckey)) == 
# 30 "../crypto/sm2/sm2_key.c" 3 4
                                                    ((void *)0)
            
# 31 "../crypto/sm2/sm2_key.c"
           || (priv_key = EC_KEY_get0_private_key(eckey)) == 
# 31 "../crypto/sm2/sm2_key.c" 3 4
                                                             ((void *)0)
            
# 32 "../crypto/sm2/sm2_key.c"
           || (order = EC_GROUP_get0_order(group)) == 
# 32 "../crypto/sm2/sm2_key.c" 3 4
                                                      ((void *)0)
# 32 "../crypto/sm2/sm2_key.c"
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_key.c",33,__func__), ERR_set_error)((53),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 33 "../crypto/sm2/sm2_key.c" 3 4
       ((void *)0)
# 33 "../crypto/sm2/sm2_key.c"
       );
        return 0;
    }
    ...
    max = BN_dup(order);
    if (max == 
# 39 "../crypto/sm2/sm2_key.c" 3 4
              ((void *)0) 
# 39 "../crypto/sm2/sm2_key.c"
                   || !BN_sub_word(max, 1))
        goto end;
    if (BN_cmp(priv_key, BN_value_one()) < 0
        || BN_cmp(priv_key, max) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_key.c",43,__func__), ERR_set_error)((53),(113),
# 43 "../crypto/sm2/sm2_key.c" 3 4
       ((void *)0)
# 43 "../crypto/sm2/sm2_key.c"
       );
        goto end;
    }
    ret = 1;
