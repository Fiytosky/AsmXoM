# 0 "../crypto/sm2/sm2_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sm2/sm2_sign.c"
# 12 "../crypto/sm2/sm2_sign.c"
                              ...
                              const EC_KEY *key)
{
    ...
    BN_CTX *ctx = 
# 32 "../crypto/sm2/sm2_sign.c" 3 4
                 ((void *)0)
# 32 "../crypto/sm2/sm2_sign.c"
                     ;
    EVP_MD_CTX *hash = 
# 33 "../crypto/sm2/sm2_sign.c" 3 4
                      ((void *)0)
# 33 "../crypto/sm2/sm2_sign.c"
                          ;
    BIGNUM *p = 
# 34 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 34 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *a = 
# 35 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 35 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *b = 
# 36 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 36 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *xG = 
# 37 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 37 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *yG = 
# 38 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 38 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *xA = 
# 39 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 39 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *yA = 
# 40 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 40 "../crypto/sm2/sm2_sign.c"
                    ;
    int p_bytes = 0;
    uint8_t *buf = 
# 42 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 42 "../crypto/sm2/sm2_sign.c"
                      ;
    uint16_t entl = 0;
    uint8_t e_byte = 0;
    ...
    if (pubkey == 
# 47 "../crypto/sm2/sm2_sign.c" 3 4
                 ((void *)0)
# 47 "../crypto/sm2/sm2_sign.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",48,__func__), ERR_set_error)((53),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 48 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 48 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    hash = EVP_MD_CTX_new();
    if (hash == 
# 53 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 53 "../crypto/sm2/sm2_sign.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",54,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 54 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 54 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ctx = BN_CTX_new_ex(ossl_ec_key_get_libctx(key));
    if (ctx == 
# 58 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 58 "../crypto/sm2/sm2_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",59,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 59 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 59 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (yA == 
# 71 "../crypto/sm2/sm2_sign.c" 3 4
             ((void *)0)
# 71 "../crypto/sm2/sm2_sign.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",72,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 72 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 72 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (!EVP_DigestInit(hash, digest)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",77,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 77 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 77 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (id_len >= (
# 83 "../crypto/sm2/sm2_sign.c" 3 4
                  (65535) 
# 83 "../crypto/sm2/sm2_sign.c"
                             / 8)) {

        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",85,__func__), ERR_set_error)((53),(111),
# 85 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 85 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (!EVP_DigestUpdate(hash, &e_byte, 1)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",93,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 93 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 93 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    e_byte = entl & 0xFF;
    if (!EVP_DigestUpdate(hash, &e_byte, 1)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",98,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 98 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 98 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (id_len > 0 && !EVP_DigestUpdate(hash, id, id_len)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",103,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 103 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 103 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (!EC_GROUP_get_curve(group, p, a, b, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",108,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 108 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 108 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    p_bytes = ((BN_num_bits(p)+7)/8);
    buf = CRYPTO_zalloc(p_bytes, "../crypto/sm2/sm2_sign.c", 113);
    if (buf == 
# 114 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 114 "../crypto/sm2/sm2_sign.c"
                  )
        goto done;
    ...
    if (BN_bn2binpad(a, buf, p_bytes) < 0
            ...
            || !EVP_DigestUpdate(hash, buf, p_bytes)
            || !EVP_DigestFinal(hash, out, 
# 135 "../crypto/sm2/sm2_sign.c" 3 4
                                          ((void *)0)
# 135 "../crypto/sm2/sm2_sign.c"
                                              )) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",136,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 136 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 136 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    CRYPTO_free(buf, "../crypto/sm2/sm2_sign.c", 143);
    BN_CTX_free(ctx);
                                    ...
                                    const uint8_t *msg, size_t msg_len)
{
    ...
    uint8_t *z = 
# 157 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 157 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *e = 
# 158 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 158 "../crypto/sm2/sm2_sign.c"
                   ;
    EVP_MD *fetched_digest = 
# 159 "../crypto/sm2/sm2_sign.c" 3 4
                            ((void *)0)
# 159 "../crypto/sm2/sm2_sign.c"
                                ;
    OSSL_LIB_CTX *libctx = ossl_ec_key_get_libctx(key);
    const char *propq = ossl_ec_key_get0_propq(key);

    if (md_size < 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",164,__func__), ERR_set_error)((53),(102),
# 164 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 164 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    if (hash == 
# 167 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 167 "../crypto/sm2/sm2_sign.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",168,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 168 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 168 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    z = CRYPTO_zalloc(md_size, "../crypto/sm2/sm2_sign.c", 172);
    if (z == 
# 173 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 173 "../crypto/sm2/sm2_sign.c"
                )
        goto done;

    fetched_digest = EVP_MD_fetch(libctx, EVP_MD_get0_name(digest), propq);
    if (fetched_digest == 
# 177 "../crypto/sm2/sm2_sign.c" 3 4
                         ((void *)0)
# 177 "../crypto/sm2/sm2_sign.c"
                             ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",178,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 178 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 178 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (!EVP_DigestInit(hash, fetched_digest)
            ...
            || !EVP_DigestFinal(hash, z, 
# 191 "../crypto/sm2/sm2_sign.c" 3 4
                                        ((void *)0)
# 191 "../crypto/sm2/sm2_sign.c"
                                            )) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",192,__func__), ERR_set_error)((53),((6 | (0x2 << 18L))),
# 192 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 192 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    e = BN_bin2bn(z, md_size, 
# 196 "../crypto/sm2/sm2_sign.c" 3 4
                             ((void *)0)
# 196 "../crypto/sm2/sm2_sign.c"
                                 );
    if (e == 
# 197 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 197 "../crypto/sm2/sm2_sign.c"
                )
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",198,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 198 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 198 "../crypto/sm2/sm2_sign.c"
       );

 done:
    EVP_MD_free(fetched_digest);
    CRYPTO_free(z, "../crypto/sm2/sm2_sign.c", 202);
    EVP_MD_CTX_free(hash);
    return e;
}
...
static ECDSA_SIG *sm2_sig_gen(const EC_KEY *key, const BIGNUM *e)
{
    ...
    ECDSA_SIG *sig = 
# 212 "../crypto/sm2/sm2_sign.c" 3 4
                    ((void *)0)
# 212 "../crypto/sm2/sm2_sign.c"
                        ;
    EC_POINT *kG = 
# 213 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 213 "../crypto/sm2/sm2_sign.c"
                      ;
    BN_CTX *ctx = 
# 214 "../crypto/sm2/sm2_sign.c" 3 4
                 ((void *)0)
# 214 "../crypto/sm2/sm2_sign.c"
                     ;
    BIGNUM *k = 
# 215 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 215 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *rk = 
# 216 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 216 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *r = 
# 217 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 217 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *s = 
# 218 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 218 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *x1 = 
# 219 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 219 "../crypto/sm2/sm2_sign.c"
                    ;
    BIGNUM *tmp = 
# 220 "../crypto/sm2/sm2_sign.c" 3 4
                 ((void *)0)
# 220 "../crypto/sm2/sm2_sign.c"
                     ;
    OSSL_LIB_CTX *libctx = ossl_ec_key_get_libctx(key);

    if (dA == 
# 223 "../crypto/sm2/sm2_sign.c" 3 4
             ((void *)0)
# 223 "../crypto/sm2/sm2_sign.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",224,__func__), ERR_set_error)((53),(113),
# 224 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 224 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    kG = EC_POINT_new(group);
    if (kG == 
# 228 "../crypto/sm2/sm2_sign.c" 3 4
             ((void *)0)
# 228 "../crypto/sm2/sm2_sign.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",229,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 229 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 229 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ctx = BN_CTX_new_ex(libctx);
    if (ctx == 
# 233 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 233 "../crypto/sm2/sm2_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",234,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 234 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 234 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 243 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 243 "../crypto/sm2/sm2_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",244,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 244 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 244 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (r == 
# 255 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0) 
# 255 "../crypto/sm2/sm2_sign.c"
                 || s == 
# 255 "../crypto/sm2/sm2_sign.c" 3 4
                         ((void *)0)
# 255 "../crypto/sm2/sm2_sign.c"
                             ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",256,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 256 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 256 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
# 269 "../crypto/sm2/sm2_sign.c"
    for (;;) {
        if (!BN_priv_rand_range_ex(k, order, 0, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",271,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 271 "../crypto/sm2/sm2_sign.c" 3 4
           ((void *)0)
# 271 "../crypto/sm2/sm2_sign.c"
           );
            goto done;
        }

        if (!EC_POINT_mul(group, kG, k, 
# 275 "../crypto/sm2/sm2_sign.c" 3 4
                                       ((void *)0)
# 275 "../crypto/sm2/sm2_sign.c"
                                           , 
# 275 "../crypto/sm2/sm2_sign.c" 3 4
                                             ((void *)0)
# 275 "../crypto/sm2/sm2_sign.c"
                                                 , ctx)
                || !EC_POINT_get_affine_coordinates(group, kG, x1, 
# 276 "../crypto/sm2/sm2_sign.c" 3 4
                                                                  ((void *)0)
# 276 "../crypto/sm2/sm2_sign.c"
                                                                      ,
                                                    ctx)
                || !BN_mod_add(r, e, x1, order, ctx)) {
            (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",279,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 279 "../crypto/sm2/sm2_sign.c" 3 4
           ((void *)0)
# 279 "../crypto/sm2/sm2_sign.c"
           );
            goto done;
        }
        ...
        if (!BN_add(rk, r, k)) {
            (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",288,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 288 "../crypto/sm2/sm2_sign.c" 3 4
           ((void *)0)
# 288 "../crypto/sm2/sm2_sign.c"
           );
            goto done;
        }
        ...
        if (!BN_add(s, dA, BN_value_one())
            ...
            (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",300,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 300 "../crypto/sm2/sm2_sign.c" 3 4
           ((void *)0)
# 300 "../crypto/sm2/sm2_sign.c"
           );
            goto done;
        }
        ...
        sig = ECDSA_SIG_new();
        if (sig == 
# 309 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 309 "../crypto/sm2/sm2_sign.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",310,__func__), ERR_set_error)((53),((42 | (0x2 << 18L))),
# 310 "../crypto/sm2/sm2_sign.c" 3 4
           ((void *)0)
# 310 "../crypto/sm2/sm2_sign.c"
           );
            goto done;
        }
    ...
    if (sig == 
# 320 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 320 "../crypto/sm2/sm2_sign.c"
                  ) {
        BN_free(r);
        BN_free(s);
    }
                          ...
                          const BIGNUM *e)
{
    ...
    const BIGNUM *order = EC_GROUP_get0_order(group);
    BN_CTX *ctx = 
# 336 "../crypto/sm2/sm2_sign.c" 3 4
                 ((void *)0)
# 336 "../crypto/sm2/sm2_sign.c"
                     ;
    EC_POINT *pt = 
# 337 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 337 "../crypto/sm2/sm2_sign.c"
                      ;
    BIGNUM *t = 
# 338 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 338 "../crypto/sm2/sm2_sign.c"
                   ;
    BIGNUM *x1 = 
# 339 "../crypto/sm2/sm2_sign.c" 3 4
                ((void *)0)
# 339 "../crypto/sm2/sm2_sign.c"
                    ;
    const BIGNUM *r = 
# 340 "../crypto/sm2/sm2_sign.c" 3 4
                     ((void *)0)
# 340 "../crypto/sm2/sm2_sign.c"
                         ;
    const BIGNUM *s = 
# 341 "../crypto/sm2/sm2_sign.c" 3 4
                     ((void *)0)
# 341 "../crypto/sm2/sm2_sign.c"
                         ;
    OSSL_LIB_CTX *libctx = ossl_ec_key_get_libctx(key);

    ctx = BN_CTX_new_ex(libctx);
    if (ctx == 
# 345 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 345 "../crypto/sm2/sm2_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",346,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 346 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 346 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    BN_CTX_start(ctx);
    ...
    x1 = BN_CTX_get(ctx);
    if (x1 == 
# 352 "../crypto/sm2/sm2_sign.c" 3 4
             ((void *)0)
# 352 "../crypto/sm2/sm2_sign.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",353,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 353 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 353 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (pt == 
# 358 "../crypto/sm2/sm2_sign.c" 3 4
             ((void *)0)
# 358 "../crypto/sm2/sm2_sign.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",359,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 359 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 359 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
# 373 "../crypto/sm2/sm2_sign.c"
    ...
    if (BN_cmp(r, BN_value_one()) < 0
            ...
            || BN_cmp(order, r) <= 0
            || BN_cmp(order, s) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",379,__func__), ERR_set_error)((53),(101),
# 379 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 379 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (!BN_mod_add(t, r, s, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",384,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 384 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 384 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (BN_is_zero(t)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",389,__func__), ERR_set_error)((53),(101),
# 389 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 389 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (!EC_POINT_mul(group, pt, s, EC_KEY_get0_public_key(key), t, ctx)
            || !EC_POINT_get_affine_coordinates(group, pt, x1, 
# 394 "../crypto/sm2/sm2_sign.c" 3 4
                                                              ((void *)0)
# 394 "../crypto/sm2/sm2_sign.c"
                                                                  , ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",395,__func__), ERR_set_error)((53),((16 | (0x2 << 18L))),
# 395 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 395 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    if (!BN_mod_add(t, e, x1, order, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",400,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 400 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 400 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
...
{
    BIGNUM *e = 
# 420 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 420 "../crypto/sm2/sm2_sign.c"
                   ;
    ECDSA_SIG *sig = 
# 421 "../crypto/sm2/sm2_sign.c" 3 4
                    ((void *)0)
# 421 "../crypto/sm2/sm2_sign.c"
                        ;

    e = sm2_compute_msg_hash(digest, key, id, id_len, msg, msg_len);
    if (e == 
# 424 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 424 "../crypto/sm2/sm2_sign.c"
                ) {
...
{
    BIGNUM *e = 
# 443 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 443 "../crypto/sm2/sm2_sign.c"
                   ;
    int ret = 0;

    e = sm2_compute_msg_hash(digest, key, id, id_len, msg, msg_len);
    if (e == 
# 447 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 447 "../crypto/sm2/sm2_sign.c"
                ) {
...
{
    BIGNUM *e = 
# 463 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 463 "../crypto/sm2/sm2_sign.c"
                   ;
    ECDSA_SIG *s = 
# 464 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 464 "../crypto/sm2/sm2_sign.c"
                      ;
    int sigleni;
    int ret = -1;

    if (sig == 
# 468 "../crypto/sm2/sm2_sign.c" 3 4
              ((void *)0)
# 468 "../crypto/sm2/sm2_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",469,__func__), ERR_set_error)((53),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 469 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 469 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    e = BN_bin2bn(dgst, dgstlen, 
# 473 "../crypto/sm2/sm2_sign.c" 3 4
                                ((void *)0)
# 473 "../crypto/sm2/sm2_sign.c"
                                    );
    if (e == 
# 474 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 474 "../crypto/sm2/sm2_sign.c"
                ) {
       (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",475,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 475 "../crypto/sm2/sm2_sign.c" 3 4
      ((void *)0)
# 475 "../crypto/sm2/sm2_sign.c"
      );
       goto done;
    }
    ...
    if (s == 
# 480 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 480 "../crypto/sm2/sm2_sign.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",481,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 481 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 481 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (sigleni < 0) {
       (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",487,__func__), ERR_set_error)((53),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 487 "../crypto/sm2/sm2_sign.c" 3 4
      ((void *)0)
# 487 "../crypto/sm2/sm2_sign.c"
      );
       goto done;
    }
...
{
    ECDSA_SIG *s = 
# 504 "../crypto/sm2/sm2_sign.c" 3 4
                  ((void *)0)
# 504 "../crypto/sm2/sm2_sign.c"
                      ;
    BIGNUM *e = 
# 505 "../crypto/sm2/sm2_sign.c" 3 4
               ((void *)0)
# 505 "../crypto/sm2/sm2_sign.c"
                   ;
    const unsigned char *p = sig;
    unsigned char *der = 
# 507 "../crypto/sm2/sm2_sign.c" 3 4
                        ((void *)0)
# 507 "../crypto/sm2/sm2_sign.c"
                            ;
    int derlen = -1;
    int ret = -1;
    ...
    s = ECDSA_SIG_new();
    if (s == 
# 512 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 512 "../crypto/sm2/sm2_sign.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",513,__func__), ERR_set_error)((53),((42 | (0x2 << 18L))),
# 513 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 513 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    if (d2i_ECDSA_SIG(&s, &p, sig_len) == 
# 516 "../crypto/sm2/sm2_sign.c" 3 4
                                         ((void *)0)
# 516 "../crypto/sm2/sm2_sign.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",517,__func__), ERR_set_error)((53),(104),
# 517 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 517 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    if (derlen != sig_len || memcmp(sig, der, derlen) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",523,__func__), ERR_set_error)((53),(104),
# 523 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 523 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }

    e = BN_bin2bn(dgst, dgstlen, 
# 527 "../crypto/sm2/sm2_sign.c" 3 4
                                ((void *)0)
# 527 "../crypto/sm2/sm2_sign.c"
                                    );
    if (e == 
# 528 "../crypto/sm2/sm2_sign.c" 3 4
            ((void *)0)
# 528 "../crypto/sm2/sm2_sign.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/sm2/sm2_sign.c",529,__func__), ERR_set_error)((53),((3 | (0x2 << 18L))),
# 529 "../crypto/sm2/sm2_sign.c" 3 4
       ((void *)0)
# 529 "../crypto/sm2/sm2_sign.c"
       );
        goto done;
    }
    ...
    CRYPTO_free(der, "../crypto/sm2/sm2_sign.c", 536);
    BN_free(e);
    ECDSA_SIG_free(s);
    return ret;
}
