...
int ossl_lib_ctx_write_lock(OSSL_LIB_CTX *ctx)
{
    if ((ctx = ossl_lib_ctx_get_concrete(ctx)) == 
# 57 "../crypto/context.c" 3 4
                                                 ((void *)0)
# 57 "../crypto/context.c"
                                                     )
        return 0;
...
static int context_init(OSSL_LIB_CTX *ctx)
{
    ...
    if (!CRYPTO_THREAD_init_local(&ctx->rcu_local_key, 
# 91 "../crypto/context.c" 3 4
                                                      ((void *)0)
# 91 "../crypto/context.c"
                                                          ))
        return 0;
...
# 95 "../crypto/context.c"
    ...
    if (ctx->rand_crngt_lock == 
# 99 "../crypto/context.c" 3 4
                               ((void *)0)
# 99 "../crypto/context.c"
                                   )
        goto err;
    ...
    if (ctx->evp_method_store == 
# 109 "../crypto/context.c" 3 4
                                ((void *)0)
# 109 "../crypto/context.c"
    ...
    if (ctx->provider_conf == 
# 115 "../crypto/context.c" 3 4
                             ((void *)0)
# 115 "../crypto/context.c"
                                 )
        goto err;
    ...
    if (ctx->drbg == 
# 121 "../crypto/context.c" 3 4
                    ((void *)0)
# 121 "../crypto/context.c"
                        )
        goto err;
    ...
    if (ctx->decoder_store == 
# 130 "../crypto/context.c" 3 4
                             ((void *)0)
# 130 "../crypto/context.c"
                                 )
        goto err;
    ctx->decoder_cache = ossl_decoder_cache_new(ctx);
    if (ctx->decoder_cache == 
# 133 "../crypto/context.c" 3 4
                             ((void *)0)
# 133 "../crypto/context.c"
                                 )
        goto err;


    ctx->encoder_store = ossl_method_store_new(ctx);
    if (ctx->encoder_store == 
# 138 "../crypto/context.c" 3 4
                             ((void *)0)
# 138 "../crypto/context.c"
                                 )
        goto err;


    ctx->store_loader_store = ossl_method_store_new(ctx);
    if (ctx->store_loader_store == 
# 143 "../crypto/context.c" 3 4
                                  ((void *)0)
# 143 "../crypto/context.c"
                                      )
        goto err;
    ...
    if (ctx->provider_store == 
# 149 "../crypto/context.c" 3 4
                              ((void *)0)
# 149 "../crypto/context.c"
                                  )
        goto err;


    ctx->property_string_data = ossl_property_string_data_new(ctx);
    if (ctx->property_string_data == 
# 154 "../crypto/context.c" 3 4
                                    ((void *)0)
# 154 "../crypto/context.c"
                                        )
        goto err;

    ctx->namemap = ossl_stored_namemap_new(ctx);
    if (ctx->namemap == 
# 158 "../crypto/context.c" 3 4
                       ((void *)0)
# 158 "../crypto/context.c"
                           )
        goto err;

    ctx->property_defns = ossl_property_defns_new(ctx);
    if (ctx->property_defns == 
# 162 "../crypto/context.c" 3 4
                              ((void *)0)
# 162 "../crypto/context.c"
                                  )
        goto err;

    ctx->global_properties = ossl_ctx_global_properties_new(ctx);
    if (ctx->global_properties == 
# 166 "../crypto/context.c" 3 4
                                 ((void *)0)
# 166 "../crypto/context.c"
                                     )
        goto err;
    ...
    if (ctx->bio_core == 
# 171 "../crypto/context.c" 3 4
                        ((void *)0)
# 171 "../crypto/context.c"
                            )
        goto err;
    ...
    if (ctx->drbg_nonce == 
# 176 "../crypto/context.c" 3 4
                          ((void *)0)
# 176 "../crypto/context.c"
                              )
        goto err;
    ...
    if (ctx->self_test_cb == 
# 181 "../crypto/context.c" 3 4
                            ((void *)0)
# 181 "../crypto/context.c"
                                )
        goto err;
# 196 "../crypto/context.c"
    ctx->threads = ossl_threads_ctx_new(ctx);
    if (ctx->threads == 
# 197 "../crypto/context.c" 3 4
                       ((void *)0)
# 197 "../crypto/context.c"
                           )
        goto err;
    ...
    if (ctx->child_provider == 
# 204 "../crypto/context.c" 3 4
                              ((void *)0)
# 204 "../crypto/context.c"
                                  )
        goto err;
...
static void context_deinit_objs(OSSL_LIB_CTX *ctx)
{
    ...
    if (ctx->evp_method_store != 
# 230 "../crypto/context.c" 3 4
                                ((void *)0)
# 230 "../crypto/context.c"
                                    ) {
        ossl_method_store_free(ctx->evp_method_store);
        ctx->evp_method_store = 
# 232 "../crypto/context.c" 3 4
                               ((void *)0)
# 232 "../crypto/context.c"
                                   ;
    }


    if (ctx->drbg != 
# 236 "../crypto/context.c" 3 4
                    ((void *)0)
# 236 "../crypto/context.c"
                        ) {
        ossl_rand_ctx_free(ctx->drbg);
        ctx->drbg = 
# 238 "../crypto/context.c" 3 4
                   ((void *)0)
# 238 "../crypto/context.c"
                       ;
    }
    ...
    if (ctx->provider_conf != 
# 243 "../crypto/context.c" 3 4
                             ((void *)0)
# 243 "../crypto/context.c"
                                 ) {
        ossl_prov_conf_ctx_free(ctx->provider_conf);
        ctx->provider_conf = 
# 245 "../crypto/context.c" 3 4
                            ((void *)0)
# 245 "../crypto/context.c"
                                ;
    }
    ...
    if (ctx->decoder_store != 
# 252 "../crypto/context.c" 3 4
                             ((void *)0)
# 252 "../crypto/context.c"
                                 ) {
        ossl_method_store_free(ctx->decoder_store);
        ctx->decoder_store = 
# 254 "../crypto/context.c" 3 4
                            ((void *)0)
# 254 "../crypto/context.c"
                                ;
    }
    if (ctx->decoder_cache != 
# 256 "../crypto/context.c" 3 4
                             ((void *)0)
# 256 "../crypto/context.c"
                                 ) {
        ossl_decoder_cache_free(ctx->decoder_cache);
        ctx->decoder_cache = 
# 258 "../crypto/context.c" 3 4
                            ((void *)0)
# 258 "../crypto/context.c"
                                ;
    }
    ...
    if (ctx->encoder_store != 
# 263 "../crypto/context.c" 3 4
                             ((void *)0)
# 263 "../crypto/context.c"
                                 ) {
        ossl_method_store_free(ctx->encoder_store);
        ctx->encoder_store = 
# 265 "../crypto/context.c" 3 4
                            ((void *)0)
# 265 "../crypto/context.c"
                                ;
    }


    if (ctx->store_loader_store != 
# 269 "../crypto/context.c" 3 4
                                  ((void *)0)
# 269 "../crypto/context.c"
                                      ) {
        ossl_method_store_free(ctx->store_loader_store);
        ctx->store_loader_store = 
# 271 "../crypto/context.c" 3 4
                                 ((void *)0)
# 271 "../crypto/context.c"
                                     ;
    }
    ...
    if (ctx->provider_store != 
# 276 "../crypto/context.c" 3 4
                              ((void *)0)
# 276 "../crypto/context.c"
                                  ) {
        ossl_provider_store_free(ctx->provider_store);
        ctx->provider_store = 
# 278 "../crypto/context.c" 3 4
                             ((void *)0)
# 278 "../crypto/context.c"
                                 ;
    }


    if (ctx->property_string_data != 
# 282 "../crypto/context.c" 3 4
                                    ((void *)0)
# 282 "../crypto/context.c"
                                        ) {
        ossl_property_string_data_free(ctx->property_string_data);
        ctx->property_string_data = 
# 284 "../crypto/context.c" 3 4
                                   ((void *)0)
# 284 "../crypto/context.c"
                                       ;
    }

    if (ctx->namemap != 
# 287 "../crypto/context.c" 3 4
                       ((void *)0)
# 287 "../crypto/context.c"
                           ) {
        ossl_stored_namemap_free(ctx->namemap);
        ctx->namemap = 
# 289 "../crypto/context.c" 3 4
                      ((void *)0)
# 289 "../crypto/context.c"
                          ;
    }

    if (ctx->property_defns != 
# 292 "../crypto/context.c" 3 4
                              ((void *)0)
# 292 "../crypto/context.c"
                                  ) {
        ossl_property_defns_free(ctx->property_defns);
        ctx->property_defns = 
# 294 "../crypto/context.c" 3 4
                             ((void *)0)
# 294 "../crypto/context.c"
                                 ;
    }

    if (ctx->global_properties != 
# 297 "../crypto/context.c" 3 4
                                 ((void *)0)
# 297 "../crypto/context.c"
                                     ) {
        ossl_ctx_global_properties_free(ctx->global_properties);
        ctx->global_properties = 
# 299 "../crypto/context.c" 3 4
                                ((void *)0)
# 299 "../crypto/context.c"
                                    ;
    }


    if (ctx->bio_core != 
# 303 "../crypto/context.c" 3 4
                        ((void *)0)
# 303 "../crypto/context.c"
                            ) {
        ossl_bio_core_globals_free(ctx->bio_core);
        ctx->bio_core = 
# 305 "../crypto/context.c" 3 4
                       ((void *)0)
# 305 "../crypto/context.c"
                           ;
    }


    if (ctx->drbg_nonce != 
# 309 "../crypto/context.c" 3 4
                          ((void *)0)
# 309 "../crypto/context.c"
                              ) {
        ossl_prov_drbg_nonce_ctx_free(ctx->drbg_nonce);
        ctx->drbg_nonce = 
# 311 "../crypto/context.c" 3 4
                         ((void *)0)
# 311 "../crypto/context.c"
                             ;
    }


    if (ctx->self_test_cb != 
# 315 "../crypto/context.c" 3 4
                            ((void *)0)
# 315 "../crypto/context.c"
                                ) {
        ossl_self_test_set_callback_free(ctx->self_test_cb);
        ctx->self_test_cb = 
# 317 "../crypto/context.c" 3 4
                           ((void *)0)
# 317 "../crypto/context.c"
                               ;
    }


    if (ctx->rand_crngt != 
# 321 "../crypto/context.c" 3 4
                          ((void *)0)
# 321 "../crypto/context.c"
                              ) {
        ossl_rand_crng_ctx_free(ctx->rand_crngt);
        ctx->rand_crngt = 
# 323 "../crypto/context.c" 3 4
                         ((void *)0)
# 323 "../crypto/context.c"
                             ;
    }
# 339 "../crypto/context.c"
    if (ctx->threads != 
# 339 "../crypto/context.c" 3 4
                       ((void *)0)
# 339 "../crypto/context.c"
                           ) {
        ossl_threads_ctx_free(ctx->threads);
        ctx->threads = 
# 341 "../crypto/context.c" 3 4
                      ((void *)0)
# 341 "../crypto/context.c"
                          ;
    }
    ...
    if (ctx->child_provider != 
# 347 "../crypto/context.c" 3 4
                              ((void *)0)
# 347 "../crypto/context.c"
                                  ) {
        ossl_child_prov_ctx_free(ctx->child_provider);
        ctx->child_provider = 
# 349 "../crypto/context.c" 3 4
                             ((void *)0)
# 349 "../crypto/context.c"
                                 ;
    }
...
{
    if (ctx == 
# 356 "../crypto/context.c" 3 4
              ((void *)0)
# 356 "../crypto/context.c"
                  )
        return 1;
    ...
    CRYPTO_THREAD_lock_free(ctx->lock);
    ctx->rand_crngt_lock = 
# 367 "../crypto/context.c" 3 4
                          ((void *)0)
# 367 "../crypto/context.c"
                              ;
    ctx->lock = 
# 368 "../crypto/context.c" 3 4
               ((void *)0)
# 368 "../crypto/context.c"
                   ;
    CRYPTO_THREAD_cleanup_local(&ctx->rcu_local_key);
    return 1;
}
...
static CRYPTO_ONCE default_context_init = 
# 377 "../crypto/context.c" 3 4
                                         0
# 377 "../crypto/context.c"
                                                                ;
...
{
    if (!CRYPTO_THREAD_init_local(&default_context_thread_local, 
# 383 "../crypto/context.c" 3 4
                                                                ((void *)0)
# 383 "../crypto/context.c"
                                                                    ))
        goto err;
...
static OSSL_LIB_CTX *get_thread_default_context(void)
{
    if (!(CRYPTO_THREAD_run_once(&default_context_init, default_context_do_init_ossl_) ? default_context_do_init_ossl_ret_ : 0))
        return 
# 410 "../crypto/context.c" 3 4
              ((void *)0)
# 410 "../crypto/context.c"
                  ;
...
static OSSL_LIB_CTX *get_default_context(void)
{
    ...
    if (current_defctx == 
# 419 "../crypto/context.c" 3 4
                         ((void *)0) 
# 419 "../crypto/context.c"
...
static int set_default_context(OSSL_LIB_CTX *defctx)
{
    if (defctx == &default_context_int)
        defctx = 
# 427 "../crypto/context.c" 3 4
                ((void *)0)
# 427 "../crypto/context.c"
                    ;
...
OSSL_LIB_CTX *OSSL_LIB_CTX_new(void)
{
    OSSL_LIB_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/context.c", 435);

    if (ctx != 
# 437 "../crypto/context.c" 3 4
              ((void *)0) 
# 437 "../crypto/context.c"
                   && !context_init(ctx)) {
        CRYPTO_free(ctx, "../crypto/context.c", 438);
        ctx = 
# 439 "../crypto/context.c" 3 4
             ((void *)0)
# 439 "../crypto/context.c"
                 ;
    }
    return ctx;
}
                                             ...
                                             const OSSL_DISPATCH *in)
{
    ...
    if (ctx == 
# 450 "../crypto/context.c" 3 4
              ((void *)0)
# 450 "../crypto/context.c"
                  )
        return 
# 451 "../crypto/context.c" 3 4
              ((void *)0)
# 451 "../crypto/context.c"
                  ;

    if (!ossl_bio_init_core(ctx, in)) {
        OSSL_LIB_CTX_free(ctx);
        return 
# 455 "../crypto/context.c" 3 4
              ((void *)0)
# 455 "../crypto/context.c"
                  ;
    }
                                     ...
                                     const OSSL_DISPATCH *in)
{
    ...
    if (ctx == 
# 466 "../crypto/context.c" 3 4
              ((void *)0)
# 466 "../crypto/context.c"
                  )
        return 
# 467 "../crypto/context.c" 3 4
              ((void *)0)
# 467 "../crypto/context.c"
                  ;

    if (!ossl_provider_init_as_child(ctx, handle, in)) {
        OSSL_LIB_CTX_free(ctx);
        return 
# 471 "../crypto/context.c" 3 4
              ((void *)0)
# 471 "../crypto/context.c"
                  ;
    }
    ctx->ischild = 1;
...
int OSSL_LIB_CTX_load_config(OSSL_LIB_CTX *ctx, const char *config_file)
{
    return CONF_modules_load_file_ex(ctx, config_file, 
# 480 "../crypto/context.c" 3 4
                                                      ((void *)0)
# 480 "../crypto/context.c"
                                                          , 0) > 0;
}
...
{
    if (ctx == 
# 486 "../crypto/context.c" 3 4
              ((void *)0) 
# 486 "../crypto/context.c"
    ...
    context_deinit(ctx);
    CRYPTO_free(ctx, "../crypto/context.c", 494);
}
...
OSSL_LIB_CTX *OSSL_LIB_CTX_get0_global_default(void)
{
    if (!(CRYPTO_THREAD_run_once(&default_context_init, default_context_do_init_ossl_) ? default_context_do_init_ossl_ret_ : 0))
        return 
# 501 "../crypto/context.c" 3 4
              ((void *)0)
# 501 "../crypto/context.c"
                  ;
...
OSSL_LIB_CTX *OSSL_LIB_CTX_set0_default(OSSL_LIB_CTX *libctx)
{
    ...
    if ((current_defctx = get_default_context()) != 
# 510 "../crypto/context.c" 3 4
                                                   ((void *)0)
# 510 "../crypto/context.c"
                                                       ) {
        if (libctx != 
# 511 "../crypto/context.c" 3 4
                     ((void *)0)
# 511 "../crypto/context.c"
                         )
    ...
    return 
# 516 "../crypto/context.c" 3 4
          ((void *)0)
# 516 "../crypto/context.c"
              ;
}
...
void ossl_release_default_drbg_ctx(void)
{
    ...
    if (default_context_int.drbg != 
# 522 "../crypto/context.c" 3 4
                                   ((void *)0)
# 522 "../crypto/context.c"
                                       ) {
        ossl_rand_ctx_free(default_context_int.drbg);
        default_context_int.drbg = 
# 524 "../crypto/context.c" 3 4
                                  ((void *)0)
# 524 "../crypto/context.c"
                                      ;
    }
}
...
OSSL_LIB_CTX *ossl_lib_ctx_get_concrete(OSSL_LIB_CTX *ctx)
{
    ...
    if (ctx == 
# 532 "../crypto/context.c" 3 4
              ((void *)0)
# 532 "../crypto/context.c"
                  )
...
int ossl_lib_ctx_is_default(OSSL_LIB_CTX *ctx)
{
    ...
    if (ctx == 
# 541 "../crypto/context.c" 3 4
              ((void *)0) 
# 541 "../crypto/context.c"
...
void *ossl_lib_ctx_get_data(OSSL_LIB_CTX *ctx, int index)
{
    ...
    ctx = ossl_lib_ctx_get_concrete(ctx);
    if (ctx == 
# 561 "../crypto/context.c" 3 4
              ((void *)0)
# 561 "../crypto/context.c"
                  )
        return 
# 562 "../crypto/context.c" 3 4
              ((void *)0)
# 562 "../crypto/context.c"
                  ;
    ...
    case 7: {
# 614 "../crypto/context.c"
        if (CRYPTO_THREAD_read_lock(ctx->rand_crngt_lock) != 1)
            return 
# 615 "../crypto/context.c" 3 4
                  ((void *)0)
# 615 "../crypto/context.c"
                      ;

        if (ctx->rand_crngt == 
# 617 "../crypto/context.c" 3 4
                              ((void *)0)
# 617 "../crypto/context.c"
                                  ) {
            CRYPTO_THREAD_unlock(ctx->rand_crngt_lock);

            if (CRYPTO_THREAD_write_lock(ctx->rand_crngt_lock) != 1)
                return 
# 621 "../crypto/context.c" 3 4
                      ((void *)0)
# 621 "../crypto/context.c"
                          ;

            if (ctx->rand_crngt == 
# 623 "../crypto/context.c" 3 4
                                  ((void *)0)
# 623 "../crypto/context.c"
                                      )
...
# 642 "../crypto/context.c"
    default:
        return 
# 643 "../crypto/context.c" 3 4
              ((void *)0)
# 643 "../crypto/context.c"
                  ;
    }
}
...
OSSL_EX_DATA_GLOBAL *ossl_lib_ctx_get_ex_data_global(OSSL_LIB_CTX *ctx)
{
    ctx = ossl_lib_ctx_get_concrete(ctx);
    if (ctx == 
# 650 "../crypto/context.c" 3 4
              ((void *)0)
# 650 "../crypto/context.c"
                  )
        return 
# 651 "../crypto/context.c" 3 4
              ((void *)0)
# 651 "../crypto/context.c"
                  ;
    return &ctx->global;
}
...
CRYPTO_THREAD_LOCAL *ossl_lib_ctx_get_rcukey(OSSL_LIB_CTX *libctx)
{
    ...
    if (libctx == 
# 671 "../crypto/context.c" 3 4
                 ((void *)0)
# 671 "../crypto/context.c"
                     )
        return 
# 672 "../crypto/context.c" 3 4
              ((void *)0)
# 672 "../crypto/context.c"
                  ;
