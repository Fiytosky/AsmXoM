# 0 "../crypto/x509/v3err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3err.c"
# 11 "../crypto/x509/v3err.c"
...
# 12 "../crypto/x509/v3err.c" 2
# 1 "../include/openssl/x509v3err.h" 1
# 13 "../include/openssl/x509v3err.h"
        
# 13 "../crypto/x509/v3err.c" 2
# 1 "../include/crypto/x509v3err.h" 1
# 13 "../include/crypto/x509v3err.h"
        
# 22 "../include/crypto/x509v3err.h"
int ossl_err_load_X509V3_strings(void);
# 14 "../crypto/x509/v3err.c" 2



static const ERR_STRING_DATA X509V3_str_reasons[] = {
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ), "bad ip address"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "bad object"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(170) & 0X7FFFFF)) ), "bad option"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(171) & 0X7FFFFF)) ), "bad value"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "bn dec2bn error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "bn to asn1 integer error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(149) & 0X7FFFFF)) ), "dirname error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(160) & 0X7FFFFF)) ),
    "distpoint already set"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ),
    "duplicate zone id"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(169) & 0X7FFFFF)) ), "empty key usage"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "error converting zone"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "error creating extension"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "error in extension"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ),
    "expected a section name"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(145) & 0X7FFFFF)) ),
    "extension exists"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "extension name error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "extension not found"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "extension setting not supported"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "extension value error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(151) & 0X7FFFFF)) ),
    "illegal empty extension"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(152) & 0X7FFFFF)) ),
    "incorrect policy syntax tag"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(162) & 0X7FFFFF)) ),
    "invalid asnumber"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(163) & 0X7FFFFF)) ), "invalid asrange"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "invalid boolean string"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(158) & 0X7FFFFF)) ),
    "invalid certificate"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "invalid empty name"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "invalid extension string"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(165) & 0X7FFFFF)) ),
    "invalid inheritance"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(166) & 0X7FFFFF)) ),
    "invalid ipaddress"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(161) & 0X7FFFFF)) ),
    "invalid multiple rdns"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "invalid name"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "invalid null argument"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "invalid null value"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(140) & 0X7FFFFF)) ), "invalid number"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(141) & 0X7FFFFF)) ), "invalid numbers"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "invalid object identifier"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ), "invalid option"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ),
    "invalid policy identifier"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(153) & 0X7FFFFF)) ),
    "invalid proxy policy setting"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(146) & 0X7FFFFF)) ), "invalid purpose"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(164) & 0X7FFFFF)) ), "invalid safi"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ), "invalid section"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ), "invalid syntax"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "issuer decode error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ), "missing value"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(142) & 0X7FFFFF)) ),
    "need organization and numbers"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(168) & 0X7FFFFF)) ),
    "negative pathlen"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "no config database"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "no issuer certificate"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "no issuer details"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ),
    "no policy identifier"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(154) & 0X7FFFFF)) ),
    "no proxy cert policy language defined"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "no public key"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "no subject details"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(148) & 0X7FFFFF)) ),
    "operation not defined"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(147) & 0X7FFFFF)) ), "othername error"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(155) & 0X7FFFFF)) ),
    "policy language already defined"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(156) & 0X7FFFFF)) ),
    "policy path length"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(157) & 0X7FFFFF)) ),
    "policy path length already defined"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(159) & 0X7FFFFF)) ),
    "policy when proxy language requires no policy"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ),
    "section not found"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "unable to get issuer details"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "unable to get issuer keyid"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "unknown bit string argument"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "unknown extension"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "unknown extension name"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "unknown option"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(172) & 0X7FFFFF)) ), "unknown value"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "unsupported option"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(167) & 0X7FFFFF)) ),
    "unsupported type"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ), "user too long"},
    {0, 
# 138 "../crypto/x509/v3err.c" 3 4
       ((void *)0)
# 138 "../crypto/x509/v3err.c"
           }
};
...
int ossl_err_load_X509V3_strings(void)
{
    ...
    if (ERR_reason_error_string(X509V3_str_reasons[0].error) == 
# 146 "../crypto/x509/v3err.c" 3 4
                                                               ((void *)0)
# 146 "../crypto/x509/v3err.c"
                                                                   )
