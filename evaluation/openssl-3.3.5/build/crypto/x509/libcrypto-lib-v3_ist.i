# 0 "../crypto/x509/v3_ist.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_ist.c"
# 10 "../crypto/x509/v3_ist.c"
...
# 17 "../crypto/x509/v3_ist.c" 2
# 25 "../crypto/x509/v3_ist.c"
static const ASN1_TEMPLATE ISSUER_SIGN_TOOL_seq_tt[] = {
        { (0), (0), 
# 26 "../crypto/x509/v3_ist.c" 3 4
       __builtin_offsetof (
# 26 "../crypto/x509/v3_ist.c"
       ISSUER_SIGN_TOOL
# 26 "../crypto/x509/v3_ist.c" 3 4
       , 
# 26 "../crypto/x509/v3_ist.c"
...
# 26 "../crypto/x509/v3_ist.c"
       , "signTool", (ASN1_UTF8STRING_it) },
        { (0), (0), 
# 27 "../crypto/x509/v3_ist.c" 3 4
       __builtin_offsetof (
# 27 "../crypto/x509/v3_ist.c"
       ISSUER_SIGN_TOOL
# 27 "../crypto/x509/v3_ist.c" 3 4
       , 
# 27 "../crypto/x509/v3_ist.c"
...
# 27 "../crypto/x509/v3_ist.c"
       , "cATool", (ASN1_UTF8STRING_it) },
        { (0), (0), 
# 28 "../crypto/x509/v3_ist.c" 3 4
       __builtin_offsetof (
# 28 "../crypto/x509/v3_ist.c"
       ISSUER_SIGN_TOOL
# 28 "../crypto/x509/v3_ist.c" 3 4
       , 
# 28 "../crypto/x509/v3_ist.c"
...
# 28 "../crypto/x509/v3_ist.c"
       , "signToolCert", (ASN1_UTF8STRING_it) },
        { (0), (0), 
# 29 "../crypto/x509/v3_ist.c" 3 4
       __builtin_offsetof (
# 29 "../crypto/x509/v3_ist.c"
       ISSUER_SIGN_TOOL
# 29 "../crypto/x509/v3_ist.c" 3 4
       , 
# 29 "../crypto/x509/v3_ist.c"
...
} ; const ASN1_ITEM * ISSUER_SIGN_TOOL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ISSUER_SIGN_TOOL_seq_tt, sizeof(ISSUER_SIGN_TOOL_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 30 "../crypto/x509/v3_ist.c" 3 4
 ((void *)0)
# 30 "../crypto/x509/v3_ist.c"
 , sizeof(ISSUER_SIGN_TOOL), "ISSUER_SIGN_TOOL" }; return &local_it; }

ISSUER_SIGN_TOOL *d2i_ISSUER_SIGN_TOOL(ISSUER_SIGN_TOOL **a, const unsigned char **in, long len) { return (ISSUER_SIGN_TOOL *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ISSUER_SIGN_TOOL_it())); } int i2d_ISSUER_SIGN_TOOL(const ISSUER_SIGN_TOOL *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ISSUER_SIGN_TOOL_it())); } ISSUER_SIGN_TOOL *ISSUER_SIGN_TOOL_new(void) { return (ISSUER_SIGN_TOOL *)ASN1_item_new((ISSUER_SIGN_TOOL_it())); } void ISSUER_SIGN_TOOL_free(ISSUER_SIGN_TOOL *a) { ASN1_item_free((ASN1_VALUE *)a, (ISSUER_SIGN_TOOL_it())); }
                        ...
                        struct stack_st_CONF_VALUE *nval)
{
    ...
    if (ist == 
# 41 "../crypto/x509/v3_ist.c" 3 4
              ((void *)0)
# 41 "../crypto/x509/v3_ist.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",42,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 42 "../crypto/x509/v3_ist.c" 3 4
       ((void *)0)
# 42 "../crypto/x509/v3_ist.c"
       );
        return 
# 43 "../crypto/x509/v3_ist.c" 3 4
              ((void *)0)
# 43 "../crypto/x509/v3_ist.c"
                  ;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); ++i) {
        ...
        if (cnf == 
# 48 "../crypto/x509/v3_ist.c" 3 4
                  ((void *)0)
# 48 "../crypto/x509/v3_ist.c"
                      ) {
            continue;
        }
        if (strcmp(cnf->name, "signTool") == 0) {
            ...
            if (ist->signTool == 
# 53 "../crypto/x509/v3_ist.c" 3 4
                                ((void *)0)
                
# 54 "../crypto/x509/v3_ist.c"
               || cnf->value == 
# 54 "../crypto/x509/v3_ist.c" 3 4
                                ((void *)0)
                
# 55 "../crypto/x509/v3_ist.c"
               || !ASN1_STRING_set(ist->signTool, cnf->value, strlen(cnf->value))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",56,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 56 "../crypto/x509/v3_ist.c" 3 4
               ((void *)0)
# 56 "../crypto/x509/v3_ist.c"
               );
                goto err;
            }
            ...
            if (ist->cATool == 
# 61 "../crypto/x509/v3_ist.c" 3 4
                              ((void *)0)
                
# 62 "../crypto/x509/v3_ist.c"
               || cnf->value == 
# 62 "../crypto/x509/v3_ist.c" 3 4
                                ((void *)0)
                
# 63 "../crypto/x509/v3_ist.c"
               || !ASN1_STRING_set(ist->cATool, cnf->value, strlen(cnf->value))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",64,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 64 "../crypto/x509/v3_ist.c" 3 4
               ((void *)0)
# 64 "../crypto/x509/v3_ist.c"
               );
                goto err;
            }
            ...
            if (ist->signToolCert == 
# 69 "../crypto/x509/v3_ist.c" 3 4
                                    ((void *)0)
                
# 70 "../crypto/x509/v3_ist.c"
               || cnf->value == 
# 70 "../crypto/x509/v3_ist.c" 3 4
                                ((void *)0)
                
# 71 "../crypto/x509/v3_ist.c"
               || !ASN1_STRING_set(ist->signToolCert, cnf->value, strlen(cnf->value))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",72,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 72 "../crypto/x509/v3_ist.c" 3 4
               ((void *)0)
# 72 "../crypto/x509/v3_ist.c"
               );
                goto err;
            }
            ...
            if (ist->cAToolCert == 
# 77 "../crypto/x509/v3_ist.c" 3 4
                                  ((void *)0)
                
# 78 "../crypto/x509/v3_ist.c"
               || cnf->value == 
# 78 "../crypto/x509/v3_ist.c" 3 4
                                ((void *)0)
                
# 79 "../crypto/x509/v3_ist.c"
               || !ASN1_STRING_set(ist->cAToolCert, cnf->value, strlen(cnf->value))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",80,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 80 "../crypto/x509/v3_ist.c" 3 4
               ((void *)0)
# 80 "../crypto/x509/v3_ist.c"
               );
                goto err;
            }
        } else {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",84,__func__), ERR_set_error)((34),((262|(0x2 << 18L))),
# 84 "../crypto/x509/v3_ist.c" 3 4
           ((void *)0)
# 84 "../crypto/x509/v3_ist.c"
           );
            goto err;
        }
    }
...
err:
    ...
    return 
# 92 "../crypto/x509/v3_ist.c" 3 4
          ((void *)0)
# 92 "../crypto/x509/v3_ist.c"
              ;
}
                                 ...
                                 int indent)
{
    ...
    if (ist == 
# 101 "../crypto/x509/v3_ist.c" 3 4
              ((void *)0)
# 101 "../crypto/x509/v3_ist.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_ist.c",102,__func__), ERR_set_error)((34),((262|(0x2 << 18L))),
# 102 "../crypto/x509/v3_ist.c" 3 4
       ((void *)0)
# 102 "../crypto/x509/v3_ist.c"
       );
        return 0;
    }
    if (ist->signTool != 
# 105 "../crypto/x509/v3_ist.c" 3 4
                        ((void *)0)
# 105 "../crypto/x509/v3_ist.c"
                            ) {
    ...
    if (ist->cATool != 
# 110 "../crypto/x509/v3_ist.c" 3 4
                      ((void *)0)
# 110 "../crypto/x509/v3_ist.c"
                          ) {
        if (new_line == 1) {
            BIO_write(out, "\n", 1);
        }
    ...
    if (ist->signToolCert != 
# 118 "../crypto/x509/v3_ist.c" 3 4
                            ((void *)0)
# 118 "../crypto/x509/v3_ist.c"
                                ) {
        if (new_line == 1) {
            BIO_write(out, "\n", 1);
        }
    ...
    if (ist->cAToolCert != 
# 126 "../crypto/x509/v3_ist.c" 3 4
                          ((void *)0)
# 126 "../crypto/x509/v3_ist.c"
                              ) {
        if (new_line == 1) {
            BIO_write(out, "\n", 1);
        }
...
const X509V3_EXT_METHOD ossl_v3_issuer_sign_tool = {
    ...
    0,
    0,
    (X509V3_EXT_V2I)v2i_issuer_sign_tool,
    (X509V3_EXT_I2R)i2r_issuer_sign_tool,
    0,
    
# 148 "../crypto/x509/v3_ist.c" 3 4
   ((void *)0)

# 149 "../crypto/x509/v3_ist.c"
};
