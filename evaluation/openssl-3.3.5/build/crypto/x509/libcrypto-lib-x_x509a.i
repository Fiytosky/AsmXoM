# 0 "../crypto/x509/x_x509a.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_x509a.c"
# 10 "../crypto/x509/x_x509a.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 16 "../crypto/x509/x_x509a.c" 2
# 24 "../crypto/x509/x_x509a.c"
static X509_CERT_AUX *aux_get(X509 *x);

static const ASN1_TEMPLATE X509_CERT_AUX_seq_tt[] = {
        { ((0x2 << 1)|(0x1)), (0), 
# 27 "../crypto/x509/x_x509a.c" 3 4
       __builtin_offsetof (
# 27 "../crypto/x509/x_x509a.c"
       X509_CERT_AUX
# 27 "../crypto/x509/x_x509a.c" 3 4
       , 
# 27 "../crypto/x509/x_x509a.c"
...
# 27 "../crypto/x509/x_x509a.c"
       , "trust", (ASN1_OBJECT_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (0), 
# 28 "../crypto/x509/x_x509a.c" 3 4
       __builtin_offsetof (
# 28 "../crypto/x509/x_x509a.c"
       X509_CERT_AUX
# 28 "../crypto/x509/x_x509a.c" 3 4
       , 
# 28 "../crypto/x509/x_x509a.c"
...
# 28 "../crypto/x509/x_x509a.c"
       , "reject", (ASN1_OBJECT_it) },
        { ((0x1)), (0), 
# 29 "../crypto/x509/x_x509a.c" 3 4
       __builtin_offsetof (
# 29 "../crypto/x509/x_x509a.c"
       X509_CERT_AUX
# 29 "../crypto/x509/x_x509a.c" 3 4
       , 
# 29 "../crypto/x509/x_x509a.c"
...
# 29 "../crypto/x509/x_x509a.c"
       , "alias", (ASN1_UTF8STRING_it) },
        { ((0x1)), (0), 
# 30 "../crypto/x509/x_x509a.c" 3 4
       __builtin_offsetof (
# 30 "../crypto/x509/x_x509a.c"
       X509_CERT_AUX
# 30 "../crypto/x509/x_x509a.c" 3 4
       , 
# 30 "../crypto/x509/x_x509a.c"
...
# 31 "../crypto/x509/x_x509a.c" 3 4
       __builtin_offsetof (
# 31 "../crypto/x509/x_x509a.c"
       X509_CERT_AUX
# 31 "../crypto/x509/x_x509a.c" 3 4
       , 
# 31 "../crypto/x509/x_x509a.c"
...
# 31 "../crypto/x509/x_x509a.c"
       , "other", (X509_ALGOR_it) }
} ; const ASN1_ITEM * X509_CERT_AUX_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_CERT_AUX_seq_tt, sizeof(X509_CERT_AUX_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 32 "../crypto/x509/x_x509a.c" 3 4
 ((void *)0)
# 32 "../crypto/x509/x_x509a.c"
 , sizeof(X509_CERT_AUX), "X509_CERT_AUX" }; return &local_it; }

X509_CERT_AUX *d2i_X509_CERT_AUX(X509_CERT_AUX **a, const unsigned char **in, long len) { return (X509_CERT_AUX *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_CERT_AUX_it())); } int i2d_X509_CERT_AUX(const X509_CERT_AUX *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_CERT_AUX_it())); } X509_CERT_AUX *X509_CERT_AUX_new(void) { return (X509_CERT_AUX *)ASN1_item_new((X509_CERT_AUX_it())); } void X509_CERT_AUX_free(X509_CERT_AUX *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_CERT_AUX_it())); }
...
{
    if (x == 
# 43 "../crypto/x509/x_x509a.c" 3 4
            ((void *)0)
# 43 "../crypto/x509/x_x509a.c"
                )
        return 
# 44 "../crypto/x509/x_x509a.c" 3 4
              ((void *)0)
# 44 "../crypto/x509/x_x509a.c"
                  ;
    if (x->aux == 
# 45 "../crypto/x509/x_x509a.c" 3 4
                 ((void *)0) 
# 45 "../crypto/x509/x_x509a.c"
...
# 45 "../crypto/x509/x_x509a.c"
        ...
        return 
# 46 "../crypto/x509/x_x509a.c" 3 4
              ((void *)0)
# 46 "../crypto/x509/x_x509a.c"
                  ;
    return x->aux;
}
...
int X509_alias_set1(X509 *x, const unsigned char *name, int len)
{
    ...
    if (!name) {
        ...
        x->aux->alias = 
# 57 "../crypto/x509/x_x509a.c" 3 4
                       ((void *)0)
# 57 "../crypto/x509/x_x509a.c"
                           ;
        return 1;
    }
    if ((aux = aux_get(x)) == 
# 60 "../crypto/x509/x_x509a.c" 3 4
                             ((void *)0)
# 60 "../crypto/x509/x_x509a.c"
                                 )
        return 0;
    if (aux->alias == 
# 62 "../crypto/x509/x_x509a.c" 3 4
                     ((void *)0) 
# 62 "../crypto/x509/x_x509a.c"
...
int X509_keyid_set1(X509 *x, const unsigned char *id, int len)
{
    ...
    if (!id) {
        ...
        x->aux->keyid = 
# 74 "../crypto/x509/x_x509a.c" 3 4
                       ((void *)0)
# 74 "../crypto/x509/x_x509a.c"
                           ;
        return 1;
    }
    if ((aux = aux_get(x)) == 
# 77 "../crypto/x509/x_x509a.c" 3 4
                             ((void *)0)
# 77 "../crypto/x509/x_x509a.c"
                                 )
        return 0;
    if (aux->keyid == 
# 79 "../crypto/x509/x_x509a.c" 3 4
                     ((void *)0)
        
# 80 "../crypto/x509/x_x509a.c"
       && (aux->keyid = ASN1_OCTET_STRING_new()) == 
# 80 "../crypto/x509/x_x509a.c" 3 4
                                                    ((void *)0)
# 80 "../crypto/x509/x_x509a.c"
                                                        )
        return 0;
...
unsigned char *X509_alias_get0(X509 *x, int *len)
{
    if (!x->aux || !x->aux->alias)
        return 
# 88 "../crypto/x509/x_x509a.c" 3 4
              ((void *)0)
# 88 "../crypto/x509/x_x509a.c"
                  ;
    if (len)
...
unsigned char *X509_keyid_get0(X509 *x, int *len)
{
    if (!x->aux || !x->aux->keyid)
        return 
# 97 "../crypto/x509/x_x509a.c" 3 4
              ((void *)0)
# 97 "../crypto/x509/x_x509a.c"
                  ;
    if (len)
...
int X509_add1_trust_object(X509 *x, const ASN1_OBJECT *obj)
{
    X509_CERT_AUX *aux;
    ASN1_OBJECT *objtmp = 
# 106 "../crypto/x509/x_x509a.c" 3 4
                         ((void *)0)
# 106 "../crypto/x509/x_x509a.c"
                             ;
    if (obj) {
        objtmp = OBJ_dup(obj);
        if (!objtmp)
    ...
    if ((aux = aux_get(x)) == 
# 112 "../crypto/x509/x_x509a.c" 3 4
                             ((void *)0)
# 112 "../crypto/x509/x_x509a.c"
                                 )
        goto err;
    if (aux->trust == 
# 114 "../crypto/x509/x_x509a.c" 3 4
                     ((void *)0)
        
# 115 "../crypto/x509/x_x509a.c"
       && (aux->trust = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null())) == 
# 115 "../crypto/x509/x_x509a.c" 3 4
                                                      ((void *)0)
# 115 "../crypto/x509/x_x509a.c"
                                                          )
        goto err;
    if (!objtmp || OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(aux->trust), ossl_check_ASN1_OBJECT_type(objtmp)))
        return 1;
 err:
...
# 130 "../crypto/x509/x_x509a.c" 3 4
                                  ((void *)0)
# 130 "../crypto/x509/x_x509a.c"
                                      )
        return 0;
    if ((aux = aux_get(x)) == 
# 132 "../crypto/x509/x_x509a.c" 3 4
                             ((void *)0)
# 132 "../crypto/x509/x_x509a.c"
                                 )
        goto err;
    if (aux->reject == 
# 134 "../crypto/x509/x_x509a.c" 3 4
                      ((void *)0)
        
# 135 "../crypto/x509/x_x509a.c"
       && (aux->reject = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null())) == 
# 135 "../crypto/x509/x_x509a.c" 3 4
                                                       ((void *)0)
# 135 "../crypto/x509/x_x509a.c"
                                                           )
        goto err;
    if (OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(aux->reject), ossl_check_ASN1_OBJECT_type(objtmp)) > 0)
        res = 1;
...
{
    if (x->aux) {
        OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(x->aux->trust),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
        x->aux->trust = 
# 150 "../crypto/x509/x_x509a.c" 3 4
                       ((void *)0)
# 150 "../crypto/x509/x_x509a.c"
                           ;
    }
}
...
{
    if (x->aux) {
        OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(x->aux->reject),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
        x->aux->reject = 
# 158 "../crypto/x509/x_x509a.c" 3 4
                        ((void *)0)
# 158 "../crypto/x509/x_x509a.c"
                            ;
    }
}
...
{
    if (x->aux != 
# 164 "../crypto/x509/x_x509a.c" 3 4
                 ((void *)0)
# 164 "../crypto/x509/x_x509a.c"
                     )
        return x->aux->trust;
    return 
# 166 "../crypto/x509/x_x509a.c" 3 4
          ((void *)0)
# 166 "../crypto/x509/x_x509a.c"
              ;
}
...
{
    if (x->aux != 
# 171 "../crypto/x509/x_x509a.c" 3 4
                 ((void *)0)
# 171 "../crypto/x509/x_x509a.c"
                     )
        return x->aux->reject;
    return 
# 173 "../crypto/x509/x_x509a.c" 3 4
          ((void *)0)
# 173 "../crypto/x509/x_x509a.c"
              ;
}
