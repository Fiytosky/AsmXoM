# 0 "../crypto/x509/v3_skid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_skid.c"
# 10 "../crypto/x509/v3_skid.c"
...
# 15 "../crypto/x509/v3_skid.c" 2

static ASN1_OCTET_STRING *s2i_skey_id(X509V3_EXT_METHOD *method,
                                      X509V3_CTX *ctx, char *str);
const X509V3_EXT_METHOD ossl_v3_skey_id = {
    82, 0, (ASN1_OCTET_STRING_it),
    0, 0, 0, 0,
    (X509V3_EXT_I2S)i2s_ASN1_OCTET_STRING,
    (X509V3_EXT_S2I)s2i_skey_id,
    0, 0, 0, 0,
    
# 24 "../crypto/x509/v3_skid.c" 3 4
   ((void *)0)

# 25 "../crypto/x509/v3_skid.c"
};
...
# 39 "../crypto/x509/v3_skid.c" 3 4
                                          ((void *)0)
# 39 "../crypto/x509/v3_skid.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_skid.c",40,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 40 "../crypto/x509/v3_skid.c" 3 4
       ((void *)0)
# 40 "../crypto/x509/v3_skid.c"
       );
        return 
# 41 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 41 "../crypto/x509/v3_skid.c"
                  ;
    }

    if ((oct->data = OPENSSL_hexstr2buf(str, &length)) == 
# 44 "../crypto/x509/v3_skid.c" 3 4
                                                         ((void *)0)
# 44 "../crypto/x509/v3_skid.c"
                                                             ) {
        ASN1_OCTET_STRING_free(oct);
        return 
# 46 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 46 "../crypto/x509/v3_skid.c"
                  ;
    }
...
ASN1_OCTET_STRING *ossl_x509_pubkey_hash(X509_PUBKEY *pubkey)
{
    ...
    if (pubkey == 
# 66 "../crypto/x509/v3_skid.c" 3 4
                 ((void *)0)
# 66 "../crypto/x509/v3_skid.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_skid.c",67,__func__), ERR_set_error)((34),(114),
# 67 "../crypto/x509/v3_skid.c" 3 4
       ((void *)0)
# 67 "../crypto/x509/v3_skid.c"
       );
        return 
# 68 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 68 "../crypto/x509/v3_skid.c"
                  ;
    }
    if (!ossl_x509_PUBKEY_get0_libctx(&libctx, &propq, pubkey))
        return 
# 71 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 71 "../crypto/x509/v3_skid.c"
                  ;
    if ((md = EVP_MD_fetch(libctx, "SHA1", propq)) == 
# 72 "../crypto/x509/v3_skid.c" 3 4
                                                      ((void *)0)
# 72 "../crypto/x509/v3_skid.c"
                                                          )
        return 
# 73 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 73 "../crypto/x509/v3_skid.c"
                  ;
    if ((oct = ASN1_OCTET_STRING_new()) == 
# 74 "../crypto/x509/v3_skid.c" 3 4
                                          ((void *)0)
# 74 "../crypto/x509/v3_skid.c"
                                              ) {
        EVP_MD_free(md);
        return 
# 76 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 76 "../crypto/x509/v3_skid.c"
                  ;
    }

    X509_PUBKEY_get0_param(
# 79 "../crypto/x509/v3_skid.c" 3 4
                          ((void *)0)
# 79 "../crypto/x509/v3_skid.c"
                              , &pk, &pklen, 
# 79 "../crypto/x509/v3_skid.c" 3 4
                                             ((void *)0)
# 79 "../crypto/x509/v3_skid.c"
                                                 , pubkey);
    if (EVP_Digest(pk, pklen, pkey_dig, &diglen, md, 
# 80 "../crypto/x509/v3_skid.c" 3 4
                                                    ((void *)0)
# 80 "../crypto/x509/v3_skid.c"
                                                        )
    ...
    ASN1_OCTET_STRING_free(oct);
    return 
# 88 "../crypto/x509/v3_skid.c" 3 4
          ((void *)0)
# 88 "../crypto/x509/v3_skid.c"
              ;
}
                                      ...
                                      X509V3_CTX *ctx, char *str)
{
    ...
    if (ctx != 
# 100 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0) 
# 100 "../crypto/x509/v3_skid.c"
                   && (ctx->flags & 0x1) != 0)
        return ASN1_OCTET_STRING_new();
    if (ctx == 
# 102 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
        
# 103 "../crypto/x509/v3_skid.c"
       || (ctx->subject_cert == 
# 103 "../crypto/x509/v3_skid.c" 3 4
                                ((void *)0) 
# 103 "../crypto/x509/v3_skid.c"
                                     && ctx->subject_req == 
# 103 "../crypto/x509/v3_skid.c" 3 4
...
# 103 "../crypto/x509/v3_skid.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_skid.c",104,__func__), ERR_set_error)((34),(125),
# 104 "../crypto/x509/v3_skid.c" 3 4
       ((void *)0)
# 104 "../crypto/x509/v3_skid.c"
       );
        return 
# 105 "../crypto/x509/v3_skid.c" 3 4
              ((void *)0)
# 105 "../crypto/x509/v3_skid.c"
                  ;
    }

    return ossl_x509_pubkey_hash(ctx->subject_cert != 
# 108 "../crypto/x509/v3_skid.c" 3 4
                                                     ((void *)0) 
# 108 "../crypto/x509/v3_skid.c"
                                                          ?
