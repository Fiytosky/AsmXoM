# 0 "../crypto/x509/x509_set.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_set.c"
# 10 "../crypto/x509/x509_set.c"
...
# 21 "../crypto/x509/x509_set.c" 2

int X509_set_version(X509 *x, long version)
{
    if (x == 
# 24 "../crypto/x509/x509_set.c" 3 4
            ((void *)0)
# 24 "../crypto/x509/x509_set.c"
                )
        return 0;
    ...
    if (version == 0) {
        ...
        x->cert_info.version = 
# 30 "../crypto/x509/x509_set.c" 3 4
                              ((void *)0)
# 30 "../crypto/x509/x509_set.c"
                                  ;
        x->cert_info.enc.modified = 1;
        return 1;
    }
    if (x->cert_info.version == 
# 34 "../crypto/x509/x509_set.c" 3 4
                               ((void *)0)
# 34 "../crypto/x509/x509_set.c"
                                   ) {
        if ((x->cert_info.version = ASN1_INTEGER_new()) == 
# 35 "../crypto/x509/x509_set.c" 3 4
                                                          ((void *)0)
# 35 "../crypto/x509/x509_set.c"
                                                              )
            return 0;
    }
...
int X509_set_serialNumber(X509 *x, ASN1_INTEGER *serial)
{
    ...
    if (x == 
# 48 "../crypto/x509/x509_set.c" 3 4
            ((void *)0)
# 48 "../crypto/x509/x509_set.c"
                )
        return 0;
...
{
    if (x == 
# 59 "../crypto/x509/x509_set.c" 3 4
            ((void *)0) 
# 59 "../crypto/x509/x509_set.c"
...
{
    if (x == 
# 67 "../crypto/x509/x509_set.c" 3 4
            ((void *)0) 
# 67 "../crypto/x509/x509_set.c"
...
int ossl_x509_set1_time(int *modified, ASN1_TIME **ptm, const ASN1_TIME *tm)
{
    ...
    if (tm != 
# 80 "../crypto/x509/x509_set.c" 3 4
             ((void *)0) 
# 80 "../crypto/x509/x509_set.c"
                  && new == 
# 80 "../crypto/x509/x509_set.c" 3 4
                            ((void *)0)
# 80 "../crypto/x509/x509_set.c"
    ...
    *ptm = new;
    if (modified != 
# 84 "../crypto/x509/x509_set.c" 3 4
                   ((void *)0)
# 84 "../crypto/x509/x509_set.c"
                       )
        *modified = 1;
    return 1;
}
...
{
    if (x == 
# 91 "../crypto/x509/x509_set.c" 3 4
            ((void *)0) 
# 91 "../crypto/x509/x509_set.c"
                 || tm == 
# 91 "../crypto/x509/x509_set.c" 3 4
                          ((void *)0)
# 91 "../crypto/x509/x509_set.c"
...
{
    if (x == 
# 99 "../crypto/x509/x509_set.c" 3 4
            ((void *)0) 
# 99 "../crypto/x509/x509_set.c"
                 || tm == 
# 99 "../crypto/x509/x509_set.c" 3 4
                          ((void *)0)
# 99 "../crypto/x509/x509_set.c"
...
{
    if (x == 
# 107 "../crypto/x509/x509_set.c" 3 4
            ((void *)0)
# 107 "../crypto/x509/x509_set.c"
                )
        return 0;
...
{
    if (piuid != 
# 170 "../crypto/x509/x509_set.c" 3 4
                ((void *)0)
# 170 "../crypto/x509/x509_set.c"
                    )
        *piuid = x->cert_info.issuerUID;
    if (psuid != 
# 172 "../crypto/x509/x509_set.c" 3 4
                ((void *)0)
# 172 "../crypto/x509/x509_set.c"
                    )
...
{
    if (mdnid != 
# 184 "../crypto/x509/x509_set.c" 3 4
                ((void *)0)
# 184 "../crypto/x509/x509_set.c"
                    )
        *mdnid = siginf->mdnid;
    if (pknid != 
# 186 "../crypto/x509/x509_set.c" 3 4
                ((void *)0)
# 186 "../crypto/x509/x509_set.c"
                    )
        *pknid = siginf->pknid;
    if (secbits != 
# 188 "../crypto/x509/x509_set.c" 3 4
                  ((void *)0)
# 188 "../crypto/x509/x509_set.c"
                      )
        *secbits = siginf->secbits;
    if (flags != 
# 190 "../crypto/x509/x509_set.c" 3 4
                ((void *)0)
# 190 "../crypto/x509/x509_set.c"
                    )
        *flags = siginf->flags;
    return (siginf->flags & 0x1) != 0;
}
                              ...
                              const ASN1_STRING *sig, const EVP_PKEY *pubkey)
{
    ...
    if (!OBJ_find_sigid_algs(OBJ_obj2nid(alg->algorithm), &mdnid, &pknid)
            || pknid == 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_set.c",225,__func__), ERR_set_error)((11),(144),
# 225 "../crypto/x509/x509_set.c" 3 4
       ((void *)0)
# 225 "../crypto/x509/x509_set.c"
       );
        return 0;
    }
    siginf->mdnid = mdnid;
...
# 234 "../crypto/x509/x509_set.c" 3 4
                                  ((void *)0)
# 234 "../crypto/x509/x509_set.c"
                                      , pknid);
        if (ameth != 
# 235 "../crypto/x509/x509_set.c" 3 4
                    ((void *)0) 
# 235 "../crypto/x509/x509_set.c"
                         && ameth->siginf_set != 
# 235 "../crypto/x509/x509_set.c" 3 4
                                                 ((void *)0)
                
# 236 "../crypto/x509/x509_set.c"
               && ameth->siginf_set(siginf, alg, sig))
           break;
        if (pubkey != 
# 238 "../crypto/x509/x509_set.c" 3 4
                     ((void *)0)
# 238 "../crypto/x509/x509_set.c"
                         ) {
            int secbits;
        ...
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_set.c",247,__func__), ERR_set_error)((11),(142),
# 247 "../crypto/x509/x509_set.c" 3 4
       ((void *)0)
# 247 "../crypto/x509/x509_set.c"
       );
        return 0;
    ...
    default:
        ...
        if ((md = EVP_get_digestbyname(OBJ_nid2sn(mdnid))) == 
# 278 "../crypto/x509/x509_set.c" 3 4
                                                ((void *)0)
# 278 "../crypto/x509/x509_set.c"
                                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_set.c",279,__func__), ERR_set_error)((11),(141),
# 279 "../crypto/x509/x509_set.c" 3 4
           ((void *)0)
# 279 "../crypto/x509/x509_set.c"
           );
            return 0;
        }
