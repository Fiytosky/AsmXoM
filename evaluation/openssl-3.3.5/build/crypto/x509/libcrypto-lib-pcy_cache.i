# 0 "../crypto/x509/pcy_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_cache.c"
# 10 "../crypto/x509/pcy_cache.c"
                               ...
                               CERTIFICATEPOLICIES *policies, int crit)
{
    ...
    X509_POLICY_DATA *data = 
# 31 "../crypto/x509/pcy_cache.c" 3 4
                            ((void *)0)
# 31 "../crypto/x509/pcy_cache.c"
                                ;
    POLICYINFO *policy;

    if ((num = OPENSSL_sk_num(ossl_check_const_POLICYINFO_sk_type(policies))) <= 0)
        goto bad_policy;
    cache->data = sk_X509_POLICY_DATA_new(policy_data_cmp);
    if (cache->data == 
# 37 "../crypto/x509/pcy_cache.c" 3 4
                      ((void *)0)
# 37 "../crypto/x509/pcy_cache.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/pcy_cache.c",38,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 38 "../crypto/x509/pcy_cache.c" 3 4
       ((void *)0)
# 38 "../crypto/x509/pcy_cache.c"
       );
        goto just_cleanup;
    }
    for (i = 0; i < num; i++) {
        policy = ((POLICYINFO *)OPENSSL_sk_value(ossl_check_const_POLICYINFO_sk_type(policies), (i)));
        data = ossl_policy_data_new(policy, 
# 43 "../crypto/x509/pcy_cache.c" 3 4
                                           ((void *)0)
# 43 "../crypto/x509/pcy_cache.c"
                                               , crit);
        if (data == 
# 44 "../crypto/x509/pcy_cache.c" 3 4
                   ((void *)0)
# 44 "../crypto/x509/pcy_cache.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/pcy_cache.c",45,__func__), ERR_set_error)((34),((11 | (0x2 << 18L))),
# 45 "../crypto/x509/pcy_cache.c" 3 4
           ((void *)0)
# 45 "../crypto/x509/pcy_cache.c"
           );
            goto just_cleanup;
        }
        ...
        if (OBJ_obj2nid(data->valid_policy) == 746) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/x509/pcy_cache.c",61,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 61 "../crypto/x509/pcy_cache.c" 3 4
           ((void *)0)
# 61 "../crypto/x509/pcy_cache.c"
           );
            goto bad_policy;
        }
        data = 
# 64 "../crypto/x509/pcy_cache.c" 3 4
              ((void *)0)
# 64 "../crypto/x509/pcy_cache.c"
                  ;
    }
 ...
 just_cleanup:
    OPENSSL_sk_pop_free(ossl_check_POLICYINFO_sk_type(policies),ossl_check_POLICYINFO_freefunc_type(POLICYINFO_free));
    if (ret <= 0) {
        sk_X509_POLICY_DATA_pop_free(cache->data, ossl_policy_data_free);
        cache->data = 
# 78 "../crypto/x509/pcy_cache.c" 3 4
                     ((void *)0)
# 78 "../crypto/x509/pcy_cache.c"
                         ;
    }
    return ret;
}
...
# 86 "../crypto/x509/pcy_cache.c" 3 4
                           ((void *)0)
# 86 "../crypto/x509/pcy_cache.c"
                               ;
    POLICY_CONSTRAINTS *ext_pcons = 
# 87 "../crypto/x509/pcy_cache.c" 3 4
                                   ((void *)0)
# 87 "../crypto/x509/pcy_cache.c"
                                       ;
    CERTIFICATEPOLICIES *ext_cpols = 
# 88 "../crypto/x509/pcy_cache.c" 3 4
                                    ((void *)0)
# 88 "../crypto/x509/pcy_cache.c"
                                        ;
    POLICY_MAPPINGS *ext_pmaps = 
# 89 "../crypto/x509/pcy_cache.c" 3 4
                                ((void *)0)
# 89 "../crypto/x509/pcy_cache.c"
                                    ;
    int i;

    if (x->policy_cache != 
# 92 "../crypto/x509/pcy_cache.c" 3 4
                          ((void *)0)
# 92 "../crypto/x509/pcy_cache.c"
                              )
        return 1;
    cache = CRYPTO_malloc(sizeof(*cache), "../crypto/x509/pcy_cache.c", 94);
    if (cache == 
# 95 "../crypto/x509/pcy_cache.c" 3 4
                ((void *)0)
# 95 "../crypto/x509/pcy_cache.c"
                    )
        return 0;
    cache->anyPolicy = 
# 97 "../crypto/x509/pcy_cache.c" 3 4
                      ((void *)0)
# 97 "../crypto/x509/pcy_cache.c"
                          ;
    cache->data = 
# 98 "../crypto/x509/pcy_cache.c" 3 4
                 ((void *)0)
# 98 "../crypto/x509/pcy_cache.c"
                     ;
    cache->any_skip = -1;
...
# 109 "../crypto/x509/pcy_cache.c" 3 4
                                                               ((void *)0)
# 109 "../crypto/x509/pcy_cache.c"
                                                                   );
...
# 128 "../crypto/x509/pcy_cache.c" 3 4
                                                                 ((void *)0)
# 128 "../crypto/x509/pcy_cache.c"
                                                                     );
...
# 147 "../crypto/x509/pcy_cache.c" 3 4
                                                            ((void *)0)
# 147 "../crypto/x509/pcy_cache.c"
                                                                );
...
# 159 "../crypto/x509/pcy_cache.c" 3 4
                                                             ((void *)0)
# 159 "../crypto/x509/pcy_cache.c"
                                                                 );
...
void ossl_policy_cache_free(X509_POLICY_CACHE *cache)
{
    ...
    sk_X509_POLICY_DATA_pop_free(cache->data, ossl_policy_data_free);
    CRYPTO_free(cache, "../crypto/x509/pcy_cache.c", 184);
}
...
const X509_POLICY_CACHE *ossl_policy_cache_set(X509 *x)
{
    ...
    if (x->policy_cache == 
# 190 "../crypto/x509/pcy_cache.c" 3 4
                          ((void *)0)
# 190 "../crypto/x509/pcy_cache.c"
                              ) {
        if (!CRYPTO_THREAD_write_lock(x->lock))
            return 
# 192 "../crypto/x509/pcy_cache.c" 3 4
                  ((void *)0)
# 192 "../crypto/x509/pcy_cache.c"
                      ;
        policy_cache_new(x);
...
{
    if (value == 
# 219 "../crypto/x509/pcy_cache.c" 3 4
                ((void *)0)
# 219 "../crypto/x509/pcy_cache.c"
                    )
        return 1;
