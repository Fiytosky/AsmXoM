# 0 "../crypto/x509/v3_sxnet.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_sxnet.c"
# 10 "../crypto/x509/v3_sxnet.c"
...
# 40 "../crypto/x509/v3_sxnet.c" 3 4
   ((void *)0)

# 41 "../crypto/x509/v3_sxnet.c"
};

static const ASN1_TEMPLATE SXNETID_seq_tt[] = {
        { (0), (0), 
# 44 "../crypto/x509/v3_sxnet.c" 3 4
       __builtin_offsetof (
# 44 "../crypto/x509/v3_sxnet.c"
       SXNETID
# 44 "../crypto/x509/v3_sxnet.c" 3 4
       , 
# 44 "../crypto/x509/v3_sxnet.c"
...
# 44 "../crypto/x509/v3_sxnet.c"
       , "zone", (ASN1_INTEGER_it) },
        { (0), (0), 
# 45 "../crypto/x509/v3_sxnet.c" 3 4
       __builtin_offsetof (
# 45 "../crypto/x509/v3_sxnet.c"
       SXNETID
# 45 "../crypto/x509/v3_sxnet.c" 3 4
       , 
# 45 "../crypto/x509/v3_sxnet.c"
...
# 45 "../crypto/x509/v3_sxnet.c"
       , "user", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * SXNETID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, SXNETID_seq_tt, sizeof(SXNETID_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 46 "../crypto/x509/v3_sxnet.c" 3 4
 ((void *)0)
# 46 "../crypto/x509/v3_sxnet.c"
 , sizeof(SXNETID), "SXNETID" }; return &local_it; }

SXNETID *d2i_SXNETID(SXNETID **a, const unsigned char **in, long len) { return (SXNETID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (SXNETID_it())); } int i2d_SXNETID(const SXNETID *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (SXNETID_it())); } SXNETID *SXNETID_new(void) { return (SXNETID *)ASN1_item_new((SXNETID_it())); } void SXNETID_free(SXNETID *a) { ASN1_item_free((ASN1_VALUE *)a, (SXNETID_it())); }

static const ASN1_TEMPLATE SXNET_seq_tt[] = {
        { (0), (0), 
# 51 "../crypto/x509/v3_sxnet.c" 3 4
       __builtin_offsetof (
# 51 "../crypto/x509/v3_sxnet.c"
       SXNET
# 51 "../crypto/x509/v3_sxnet.c" 3 4
       , 
# 51 "../crypto/x509/v3_sxnet.c"
...
# 51 "../crypto/x509/v3_sxnet.c"
       , "version", (ASN1_INTEGER_it) },
        { ((0x2 << 1)), (0), 
# 52 "../crypto/x509/v3_sxnet.c" 3 4
       __builtin_offsetof (
# 52 "../crypto/x509/v3_sxnet.c"
       SXNET
# 52 "../crypto/x509/v3_sxnet.c" 3 4
       , 
# 52 "../crypto/x509/v3_sxnet.c"
...
# 52 "../crypto/x509/v3_sxnet.c"
       , "ids", (SXNETID_it) }
} ; const ASN1_ITEM * SXNET_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, SXNET_seq_tt, sizeof(SXNET_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 53 "../crypto/x509/v3_sxnet.c" 3 4
 ((void *)0)
# 53 "../crypto/x509/v3_sxnet.c"
 , sizeof(SXNET), "SXNET" }; return &local_it; }

SXNET *d2i_SXNET(SXNET **a, const unsigned char **in, long len) { return (SXNET *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (SXNET_it())); } int i2d_SXNET(const SXNET *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (SXNET_it())); } SXNET *SXNET_new(void) { return (SXNET *)ASN1_item_new((SXNET_it())); } void SXNET_free(SXNET *a) { ASN1_item_free((ASN1_VALUE *)a, (SXNET_it())); }
...
# 71 "../crypto/x509/v3_sxnet.c"
           || v < 
# 71 "../crypto/x509/v3_sxnet.c" 3 4
...
# 71 "../crypto/x509/v3_sxnet.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SXNETID_sk_type(sx->ids)); i++) {
        id = ((SXNETID *)OPENSSL_sk_value(ossl_check_const_SXNETID_sk_type(sx->ids), (i)));
        tmp = i2s_ASN1_INTEGER(
# 80 "../crypto/x509/v3_sxnet.c" 3 4
                              ((void *)0)
# 80 "../crypto/x509/v3_sxnet.c"
                                  , id->zone);
        if (tmp == 
# 81 "../crypto/x509/v3_sxnet.c" 3 4
                  ((void *)0)
# 81 "../crypto/x509/v3_sxnet.c"
                      )
            return 0;
        BIO_printf(out, "\n%*sZone: %s, User: ", indent, "", tmp);
        CRYPTO_free(tmp, "../crypto/x509/v3_sxnet.c", 84);
        ASN1_STRING_print(out, id->user);
    }
    return 1;
}
# 98 "../crypto/x509/v3_sxnet.c"
static SXNET *sxnet_v2i(X509V3_EXT_METHOD *method, X509V3_CTX *ctx,
                        struct stack_st_CONF_VALUE *nval)
{
    CONF_VALUE *cnf;
    SXNET *sx = 
# 102 "../crypto/x509/v3_sxnet.c" 3 4
               ((void *)0)
# 102 "../crypto/x509/v3_sxnet.c"
                   ;
    int i;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); i++) {
        ...
        if (!SXNET_add_id_asc(&sx, cnf->name, cnf->value, -1)) {
            SXNET_free(sx);
            return 
# 108 "../crypto/x509/v3_sxnet.c" 3 4
                  ((void *)0)
# 108 "../crypto/x509/v3_sxnet.c"
                      ;
 }
    }
    return sx;
...
# 124 "../crypto/x509/v3_sxnet.c" 3 4
                                 ((void *)0)
# 124 "../crypto/x509/v3_sxnet.c"
                                     , zone)) == 
# 124 "../crypto/x509/v3_sxnet.c" 3 4
                                                 ((void *)0)
# 124 "../crypto/x509/v3_sxnet.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",125,__func__), ERR_set_error)((34),(131),
# 125 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 125 "../crypto/x509/v3_sxnet.c"
       );
        return 0;
    }
...
# 142 "../crypto/x509/v3_sxnet.c" 3 4
                                       ((void *)0)
        
# 143 "../crypto/x509/v3_sxnet.c"
       || !ASN1_INTEGER_set(izone, lzone)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",144,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 144 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 144 "../crypto/x509/v3_sxnet.c"
       );
        ASN1_INTEGER_free(izone);
        return 0;
    }
...
{
    SXNET *sx = 
# 163 "../crypto/x509/v3_sxnet.c" 3 4
               ((void *)0)
# 163 "../crypto/x509/v3_sxnet.c"
                   ;
    SXNETID *id = 
# 164 "../crypto/x509/v3_sxnet.c" 3 4
                 ((void *)0)
# 164 "../crypto/x509/v3_sxnet.c"
                     ;

    if (psx == 
# 166 "../crypto/x509/v3_sxnet.c" 3 4
              ((void *)0) 
# 166 "../crypto/x509/v3_sxnet.c"
                   || zone == 
# 166 "../crypto/x509/v3_sxnet.c" 3 4
                              ((void *)0) 
# 166 "../crypto/x509/v3_sxnet.c"
...
# 166 "../crypto/x509/v3_sxnet.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",167,__func__), ERR_set_error)((34),(107),
# 167 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 167 "../crypto/x509/v3_sxnet.c"
       );
        return 0;
    }
    if (userlen == -1)
        userlen = strlen(user);
    if (userlen > 64) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",173,__func__), ERR_set_error)((34),(132),
# 173 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 173 "../crypto/x509/v3_sxnet.c"
       );
        return 0;
    }
    if (*psx == 
# 176 "../crypto/x509/v3_sxnet.c" 3 4
               ((void *)0)
# 176 "../crypto/x509/v3_sxnet.c"
                   ) {
        if ((sx = SXNET_new()) == 
# 177 "../crypto/x509/v3_sxnet.c" 3 4
                                 ((void *)0)
# 177 "../crypto/x509/v3_sxnet.c"
                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",178,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 178 "../crypto/x509/v3_sxnet.c" 3 4
           ((void *)0)
# 178 "../crypto/x509/v3_sxnet.c"
           );
            goto err;
        }
        if (!ASN1_INTEGER_set(sx->version, 0)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",182,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 182 "../crypto/x509/v3_sxnet.c" 3 4
           ((void *)0)
# 182 "../crypto/x509/v3_sxnet.c"
           );
            goto err;
        }
    } else
    ...
    if (SXNET_get_id_INTEGER(sx, zone)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",188,__func__), ERR_set_error)((34),(133),
# 188 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 188 "../crypto/x509/v3_sxnet.c"
       );
        if (*psx == 
# 189 "../crypto/x509/v3_sxnet.c" 3 4
                   ((void *)0)
# 189 "../crypto/x509/v3_sxnet.c"
                       )
            SXNET_free(sx);
        return 0;
    }
    ...
    if ((id = SXNETID_new()) == 
# 194 "../crypto/x509/v3_sxnet.c" 3 4
                               ((void *)0)
# 194 "../crypto/x509/v3_sxnet.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",195,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 195 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 195 "../crypto/x509/v3_sxnet.c"
       );
        goto err;
    }

    if (!ASN1_OCTET_STRING_set(id->user, (const unsigned char *)user, userlen)){
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",200,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 200 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 200 "../crypto/x509/v3_sxnet.c"
       );
        goto err;
    }
    if (!OPENSSL_sk_push(ossl_check_SXNETID_sk_type(sx->ids), ossl_check_SXNETID_type(id))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",204,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 204 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 204 "../crypto/x509/v3_sxnet.c"
       );
        goto err;
    }
 ...
 err:
    SXNETID_free(id);
    if (*psx == 
# 214 "../crypto/x509/v3_sxnet.c" 3 4
               ((void *)0)
# 214 "../crypto/x509/v3_sxnet.c"
                   )
        SXNET_free(sx);
    return 0;
}
...
ASN1_OCTET_STRING *SXNET_get_id_asc(SXNET *sx, const char *zone)
{
    ...
    if ((izone = s2i_ASN1_INTEGER(
# 224 "../crypto/x509/v3_sxnet.c" 3 4
                                 ((void *)0)
# 224 "../crypto/x509/v3_sxnet.c"
                                     , zone)) == 
# 224 "../crypto/x509/v3_sxnet.c" 3 4
                                                 ((void *)0)
# 224 "../crypto/x509/v3_sxnet.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",225,__func__), ERR_set_error)((34),(131),
# 225 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 225 "../crypto/x509/v3_sxnet.c"
       );
        return 
# 226 "../crypto/x509/v3_sxnet.c" 3 4
              ((void *)0)
# 226 "../crypto/x509/v3_sxnet.c"
                  ;
    }
...
ASN1_OCTET_STRING *SXNET_get_id_ulong(SXNET *sx, unsigned long lzone)
{
    ...
    if ((izone = ASN1_INTEGER_new()) == 
# 238 "../crypto/x509/v3_sxnet.c" 3 4
                                       ((void *)0)
        
# 239 "../crypto/x509/v3_sxnet.c"
       || !ASN1_INTEGER_set(izone, lzone)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_sxnet.c",240,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 240 "../crypto/x509/v3_sxnet.c" 3 4
       ((void *)0)
# 240 "../crypto/x509/v3_sxnet.c"
       );
        ASN1_INTEGER_free(izone);
        return 
# 242 "../crypto/x509/v3_sxnet.c" 3 4
              ((void *)0)
# 242 "../crypto/x509/v3_sxnet.c"
                  ;
    }
    oct = SXNET_get_id_INTEGER(sx, izone);
    ASN1_INTEGER_free(izone);
...
ASN1_OCTET_STRING *SXNET_get_id_INTEGER(SXNET *sx, ASN1_INTEGER *zone)
{
    ...
    return 
# 258 "../crypto/x509/v3_sxnet.c" 3 4
          ((void *)0)
# 258 "../crypto/x509/v3_sxnet.c"
              ;
}
