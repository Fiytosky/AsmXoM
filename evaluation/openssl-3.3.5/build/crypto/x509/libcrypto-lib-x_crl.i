# 0 "../crypto/x509/x_crl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_crl.c"
# 10 "../crypto/x509/x_crl.c"
...
static const ASN1_TEMPLATE X509_REVOKED_seq_tt[] = {
        { ((0x1 << 12)), (0), 
# 23 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 23 "../crypto/x509/x_crl.c"
       X509_REVOKED
# 23 "../crypto/x509/x_crl.c" 3 4
       , 
# 23 "../crypto/x509/x_crl.c"
...
# 23 "../crypto/x509/x_crl.c"
       , "serialNumber", (ASN1_INTEGER_it) },
        { (0), (0), 
# 24 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 24 "../crypto/x509/x_crl.c"
       X509_REVOKED
# 24 "../crypto/x509/x_crl.c" 3 4
       , 
# 24 "../crypto/x509/x_crl.c"
...
# 24 "../crypto/x509/x_crl.c"
       , "revocationDate", (ASN1_TIME_it) },
        { ((0x2 << 1)|(0x1)), (0), 
# 25 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 25 "../crypto/x509/x_crl.c"
       X509_REVOKED
# 25 "../crypto/x509/x_crl.c" 3 4
       , 
# 25 "../crypto/x509/x_crl.c"
...
} ; const ASN1_ITEM * X509_REVOKED_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_REVOKED_seq_tt, sizeof(X509_REVOKED_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 26 "../crypto/x509/x_crl.c" 3 4
 ((void *)0)
# 26 "../crypto/x509/x_crl.c"
 , sizeof(X509_REVOKED), "X509_REVOKED" }; return &local_it; }
                      ...
                      void *exarg)
{
    ...
    case 5:
        (void)((sk_X509_REVOKED_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_REVOKED_sk_type(a->revoked), ossl_check_X509_REVOKED_compfunc_type(X509_REVOKED_cmp)));
        break;
    }
    return 1;
}
...
# 67 "../crypto/x509/x_crl.c" 3 4
((void *)0)
# 67 "../crypto/x509/x_crl.c"
, 2, 0, 0, crl_inf_cb, 
# 67 "../crypto/x509/x_crl.c" 3 4
__builtin_offsetof (
# 67 "../crypto/x509/x_crl.c"
...
# 67 "../crypto/x509/x_crl.c"
        ...
        { ((0x1)), (0), 
# 68 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 68 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 68 "../crypto/x509/x_crl.c" 3 4
       , 
# 68 "../crypto/x509/x_crl.c"
...
# 68 "../crypto/x509/x_crl.c"
       , "version", (ASN1_INTEGER_it) },
        { ((0x1 << 12)), (0), 
# 69 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 69 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 69 "../crypto/x509/x_crl.c" 3 4
       , 
# 69 "../crypto/x509/x_crl.c"
...
# 69 "../crypto/x509/x_crl.c"
       , "sig_alg", (X509_ALGOR_it) },
        { (0), (0), 
# 70 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 70 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 70 "../crypto/x509/x_crl.c" 3 4
       , 
# 70 "../crypto/x509/x_crl.c"
...
# 70 "../crypto/x509/x_crl.c"
       , "issuer", (X509_NAME_it) },
        { (0), (0), 
# 71 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 71 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 71 "../crypto/x509/x_crl.c" 3 4
       , 
# 71 "../crypto/x509/x_crl.c"
...
# 71 "../crypto/x509/x_crl.c"
       , "lastUpdate", (ASN1_TIME_it) },
        { ((0x1)), (0), 
# 72 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 72 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 72 "../crypto/x509/x_crl.c" 3 4
       , 
# 72 "../crypto/x509/x_crl.c"
...
# 72 "../crypto/x509/x_crl.c"
       , "nextUpdate", (ASN1_TIME_it) },
        { ((0x2 << 1)|(0x1)), (0), 
# 73 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 73 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 73 "../crypto/x509/x_crl.c" 3 4
       , 
# 73 "../crypto/x509/x_crl.c"
...
# 73 "../crypto/x509/x_crl.c"
       , "revoked", (X509_REVOKED_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (0), 
# 74 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 74 "../crypto/x509/x_crl.c"
       X509_CRL_INFO
# 74 "../crypto/x509/x_crl.c" 3 4
       , 
# 74 "../crypto/x509/x_crl.c"
...
# 74 "../crypto/x509/x_crl.c"
       , "extensions", (X509_EXTENSION_it) }
} ; const ASN1_ITEM * X509_CRL_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_CRL_INFO_seq_tt, sizeof(X509_CRL_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_CRL_INFO_aux, sizeof(X509_CRL_INFO), "X509_CRL_INFO" }; return &local_it; }
...
static int crl_set_issuers(X509_CRL *crl)
{
    ...
    gens = 
# 91 "../crypto/x509/x_crl.c" 3 4
          ((void *)0)
# 91 "../crypto/x509/x_crl.c"
              ;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(revoked)); i++) {
        X509_REVOKED *rev = ((X509_REVOKED *)OPENSSL_sk_value(ossl_check_const_X509_REVOKED_sk_type(revoked), (i)));
        ...
        gtmp = X509_REVOKED_get_ext_d2i(rev,
                                        771, &j, 
# 99 "../crypto/x509/x_crl.c" 3 4
                                                                   ((void *)0)
# 99 "../crypto/x509/x_crl.c"
                                                                       );
        if (gtmp == 
# 100 "../crypto/x509/x_crl.c" 3 4
                   ((void *)0) 
# 100 "../crypto/x509/x_crl.c"
                        && j != -1) {
            crl->flags |= 0x80;
            return 1;
        }
        ...
        if (gtmp != 
# 105 "../crypto/x509/x_crl.c" 3 4
                   ((void *)0)
# 105 "../crypto/x509/x_crl.c"
                       ) {
            if (crl->issuers == 
# 106 "../crypto/x509/x_crl.c" 3 4
                               ((void *)0)
# 106 "../crypto/x509/x_crl.c"
                                   ) {
                crl->issuers = ((struct stack_st_GENERAL_NAMES *)OPENSSL_sk_new_null());
                if (crl->issuers == 
# 108 "../crypto/x509/x_crl.c" 3 4
                                   ((void *)0)
# 108 "../crypto/x509/x_crl.c"
                                       ) {
                    GENERAL_NAMES_free(gtmp);
                    return 0;
                }
            }
            if (!OPENSSL_sk_push(ossl_check_GENERAL_NAMES_sk_type(crl->issuers), ossl_check_GENERAL_NAMES_type(gtmp))) {
                GENERAL_NAMES_free(gtmp);
                return 0;
            }
            gens = gtmp;
        ...
        reason = X509_REVOKED_get_ext_d2i(rev, 141, &j, 
# 121 "../crypto/x509/x_crl.c" 3 4
                                                                  ((void *)0)
# 121 "../crypto/x509/x_crl.c"
                                                                      );
        if (reason == 
# 122 "../crypto/x509/x_crl.c" 3 4
                     ((void *)0) 
# 122 "../crypto/x509/x_crl.c"
                          && j != -1) {
            crl->flags |= 0x80;
            return 1;
        }
        ...
        if (reason != 
# 127 "../crypto/x509/x_crl.c" 3 4
                     ((void *)0)
# 127 "../crypto/x509/x_crl.c"
                         ) {
        ...
        for (j = 0; j < OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts)); j++) {
            ext = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(exts), (j)));
                  ...
                  void *exarg)
{
    ...
    case 4:
        ...
        OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(crl->issuers),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));


    case 1:
        crl->idp = 
# 180 "../crypto/x509/x_crl.c" 3 4
                  ((void *)0)
# 180 "../crypto/x509/x_crl.c"
                      ;
        crl->akid = 
# 181 "../crypto/x509/x_crl.c" 3 4
                   ((void *)0)
# 181 "../crypto/x509/x_crl.c"
                       ;
        crl->flags = 0;
        crl->idp_flags = 0;
        ...
        crl->meth_data = 
# 186 "../crypto/x509/x_crl.c" 3 4
                        ((void *)0)
# 186 "../crypto/x509/x_crl.c"
                            ;
        crl->issuers = 
# 187 "../crypto/x509/x_crl.c" 3 4
                      ((void *)0)
# 187 "../crypto/x509/x_crl.c"
                          ;
        crl->crl_number = 
# 188 "../crypto/x509/x_crl.c" 3 4
                         ((void *)0)
# 188 "../crypto/x509/x_crl.c"
                             ;
        crl->base_crl_number = 
# 189 "../crypto/x509/x_crl.c" 3 4
                              ((void *)0)
# 189 "../crypto/x509/x_crl.c"
                                  ;
        break;

    case 5:
        if (!X509_CRL_digest(crl, EVP_sha1(), crl->sha1_hash, 
# 193 "../crypto/x509/x_crl.c" 3 4
                                                             ((void *)0)
# 193 "../crypto/x509/x_crl.c"
                                                                 ))
            crl->flags |= 0x100000;
        crl->idp = X509_CRL_get_ext_d2i(crl,
                                        770, &i,
                                        
# 197 "../crypto/x509/x_crl.c" 3 4
                                       ((void *)0)
# 197 "../crypto/x509/x_crl.c"
                                           );
        if (crl->idp != 
# 198 "../crypto/x509/x_crl.c" 3 4
                       ((void *)0)
# 198 "../crypto/x509/x_crl.c"
                           ) {
...
# 208 "../crypto/x509/x_crl.c" 3 4
                                        ((void *)0)
# 208 "../crypto/x509/x_crl.c"
                                            );
        if (crl->akid == 
# 209 "../crypto/x509/x_crl.c" 3 4
                        ((void *)0) 
# 209 "../crypto/x509/x_crl.c"
                             && i != -1)
            crl->flags |= 0x80;

        crl->crl_number = X509_CRL_get_ext_d2i(crl,
                                               88, &i, 
# 213 "../crypto/x509/x_crl.c" 3 4
                                                                  ((void *)0)
# 213 "../crypto/x509/x_crl.c"
                                                                      );
        if (crl->crl_number == 
# 214 "../crypto/x509/x_crl.c" 3 4
                              ((void *)0) 
# 214 "../crypto/x509/x_crl.c"
                                   && i != -1)
            crl->flags |= 0x80;
...
# 219 "../crypto/x509/x_crl.c" 3 4
                                                   ((void *)0)
# 219 "../crypto/x509/x_crl.c"
                                                       );
        if (crl->base_crl_number == 
# 220 "../crypto/x509/x_crl.c" 3 4
                                   ((void *)0) 
# 220 "../crypto/x509/x_crl.c"
                                        && i != -1)
            crl->flags |= 0x80;

        if (crl->base_crl_number && !crl->crl_number)
            crl->flags |= 0x80;
# 233 "../crypto/x509/x_crl.c"
        exts = crl->crl.extensions;

        for (idx = 0; idx < OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts)); idx++) {
            int nid;
            ext = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(exts), (idx)));
    ...
    case 3:
        if (crl->meth != 
# 264 "../crypto/x509/x_crl.c" 3 4
                        ((void *)0) 
# 264 "../crypto/x509/x_crl.c"
                             && crl->meth->crl_free != 
# 264 "../crypto/x509/x_crl.c" 3 4
                                                       ((void *)0)
# 264 "../crypto/x509/x_crl.c"
        ...
        ASN1_INTEGER_free(crl->base_crl_number);
        OPENSSL_sk_pop_free(ossl_check_GENERAL_NAMES_sk_type(crl->issuers),ossl_check_GENERAL_NAMES_freefunc_type(GENERAL_NAMES_free));
        CRYPTO_free(crl->propq, "../crypto/x509/x_crl.c", 273);
        break;
    case 15:
        {
            X509_CRL *old = exarg;
...
# 326 "../crypto/x509/x_crl.c" 3 4
((void *)0)
# 326 "../crypto/x509/x_crl.c"
, 1, 
# 326 "../crypto/x509/x_crl.c" 3 4
__builtin_offsetof (
# 326 "../crypto/x509/x_crl.c"
...
# 326 "../crypto/x509/x_crl.c"
        ...
        { ((0x1 << 12)), (0), 
# 327 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 327 "../crypto/x509/x_crl.c"
       X509_CRL
# 327 "../crypto/x509/x_crl.c" 3 4
       , 
# 327 "../crypto/x509/x_crl.c"
...
# 327 "../crypto/x509/x_crl.c"
       , "crl", (X509_CRL_INFO_it) },
        { ((0x1 << 12)), (0), 
# 328 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 328 "../crypto/x509/x_crl.c"
       X509_CRL
# 328 "../crypto/x509/x_crl.c" 3 4
       , 
# 328 "../crypto/x509/x_crl.c"
...
# 328 "../crypto/x509/x_crl.c"
       , "sig_alg", (X509_ALGOR_it) },
        { ((0x1 << 12)), (0), 
# 329 "../crypto/x509/x_crl.c" 3 4
       __builtin_offsetof (
# 329 "../crypto/x509/x_crl.c"
       X509_CRL
# 329 "../crypto/x509/x_crl.c" 3 4
       , 
# 329 "../crypto/x509/x_crl.c"
...
} ; const ASN1_ITEM * X509_CRL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_CRL_seq_tt, sizeof(X509_CRL_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_CRL_aux, sizeof(X509_CRL), "X509_CRL" }; return &local_it; }

X509_REVOKED *d2i_X509_REVOKED(X509_REVOKED **a, const unsigned char **in, long len) { return (X509_REVOKED *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_REVOKED_it())); } int i2d_X509_REVOKED(const X509_REVOKED *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_REVOKED_it())); } X509_REVOKED *X509_REVOKED_new(void) { return (X509_REVOKED *)ASN1_item_new((X509_REVOKED_it())); } void X509_REVOKED_free(X509_REVOKED *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_REVOKED_it())); }

X509_REVOKED * X509_REVOKED_dup(const X509_REVOKED *x) { return ASN1_item_dup((X509_REVOKED_it()), x); }

X509_CRL_INFO *d2i_X509_CRL_INFO(X509_CRL_INFO **a, const unsigned char **in, long len) { return (X509_CRL_INFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_CRL_INFO_it())); } int i2d_X509_CRL_INFO(const X509_CRL_INFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_CRL_INFO_it())); } X509_CRL_INFO *X509_CRL_INFO_new(void) { return (X509_CRL_INFO *)ASN1_item_new((X509_CRL_INFO_it())); } void X509_CRL_INFO_free(X509_CRL_INFO *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_CRL_INFO_it())); }

X509_CRL *d2i_X509_CRL(X509_CRL **a, const unsigned char **in, long len) { return (X509_CRL *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_CRL_it())); } int i2d_X509_CRL(const X509_CRL *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_CRL_it())); } X509_CRL *X509_CRL_new(void) { return (X509_CRL *)ASN1_item_new((X509_CRL_it())); } void X509_CRL_free(X509_CRL *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_CRL_it())); }

X509_CRL * X509_CRL_dup(const X509_CRL *x) { return ASN1_item_dup((X509_CRL_it()), x); }
...
{
    X509_CRL *crl = 
# 351 "../crypto/x509/x_crl.c" 3 4
                   ((void *)0)
# 351 "../crypto/x509/x_crl.c"
                       ;
    ...
    if (!ossl_x509_crl_set0_libctx(crl, libctx, propq)) {
        X509_CRL_free(crl);
        crl = 
# 356 "../crypto/x509/x_crl.c" 3 4
             ((void *)0)
# 356 "../crypto/x509/x_crl.c"
                 ;
    }
    return crl;
}
...
int X509_CRL_add0_revoked(X509_CRL *crl, X509_REVOKED *rev)
{
    ...
    inf = &crl->crl;
    if (inf->revoked == 
# 366 "../crypto/x509/x_crl.c" 3 4
                       ((void *)0)
# 366 "../crypto/x509/x_crl.c"
                           )
        inf->revoked = ((struct stack_st_X509_REVOKED *)OPENSSL_sk_new(ossl_check_X509_REVOKED_compfunc_type(X509_REVOKED_cmp)));
    if (inf->revoked == 
# 368 "../crypto/x509/x_crl.c" 3 4
                       ((void *)0) 
# 368 "../crypto/x509/x_crl.c"
                            || !OPENSSL_sk_push(ossl_check_X509_REVOKED_sk_type(inf->revoked), ossl_check_X509_REVOKED_type(rev))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_crl.c",369,__func__), ERR_set_error)((13),((15 | (0x2 << 18L))),
# 369 "../crypto/x509/x_crl.c" 3 4
       ((void *)0)
# 369 "../crypto/x509/x_crl.c"
       );
        return 0;
    }
    inf->enc.modified = 1;
...
static int def_crl_verify(X509_CRL *crl, EVP_PKEY *r)
{
    return ASN1_item_verify_ex((X509_CRL_INFO_it()),
                               &crl->sig_alg, &crl->signature, &crl->crl, 
# 403 "../crypto/x509/x_crl.c" 3 4
                                                                         ((void *)0)
# 403 "../crypto/x509/x_crl.c"
                                                                             ,
                                    ...
                                    X509_REVOKED *rev)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(rev->issuer)); i++) {
        GENERAL_NAME *gen = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(rev->issuer), (i)));
        if (gen->type != 4)
            continue;
                          ...
                          const X509_NAME *issuer)
{
    ...
    if (crl->crl.revoked == 
# 441 "../crypto/x509/x_crl.c" 3 4
                           ((void *)0)
# 441 "../crypto/x509/x_crl.c"
                               )
        return 0;
    ...
    if (!OPENSSL_sk_is_sorted(ossl_check_const_X509_REVOKED_sk_type(crl->crl.revoked))) {
        if (!CRYPTO_THREAD_write_lock(crl->lock))
            return 0;
        OPENSSL_sk_sort(ossl_check_X509_REVOKED_sk_type(crl->crl.revoked));
        CRYPTO_THREAD_unlock(crl->lock);
    }
    rtmp.serialNumber = *serial;
    idx = OPENSSL_sk_find(ossl_check_X509_REVOKED_sk_type(crl->crl.revoked), ossl_check_X509_REVOKED_type(&rtmp));
    if (idx < 0)
        return 0;

    for (num = OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(crl->crl.revoked)); idx < num; idx++) {
        rev = ((X509_REVOKED *)OPENSSL_sk_value(ossl_check_const_X509_REVOKED_sk_type(crl->crl.revoked), (idx)));
...
{
    if (meth == 
# 476 "../crypto/x509/x_crl.c" 3 4
               ((void *)0)
# 476 "../crypto/x509/x_crl.c"
                   )
...
X509_CRL_METHOD *X509_CRL_METHOD_new(int (*crl_init) (X509_CRL *crl),
                                     ...
                                     int (*crl_verify) (X509_CRL *crl,
                                                        EVP_PKEY *pk))
{
    X509_CRL_METHOD *m = CRYPTO_malloc(sizeof(*m), "../crypto/x509/x_crl.c", 491);

    if (m == 
# 493 "../crypto/x509/x_crl.c" 3 4
            ((void *)0)
# 493 "../crypto/x509/x_crl.c"
                )
        return 
# 494 "../crypto/x509/x_crl.c" 3 4
              ((void *)0)
# 494 "../crypto/x509/x_crl.c"
                  ;
    m->crl_init = crl_init;
    m->crl_free = crl_free;
...
{
    if (m == 
# 505 "../crypto/x509/x_crl.c" 3 4
            ((void *)0) 
# 505 "../crypto/x509/x_crl.c"
                 || !(m->flags & 1))
        return;
    CRYPTO_free(m, "../crypto/x509/x_crl.c", 507);
}
...
{
    if (x != 
# 523 "../crypto/x509/x_crl.c" 3 4
            ((void *)0)
# 523 "../crypto/x509/x_crl.c"
                ) {
        x->libctx = libctx;
        CRYPTO_free(x->propq, "../crypto/x509/x_crl.c", 525);
        x->propq = 
# 526 "../crypto/x509/x_crl.c" 3 4
                  ((void *)0)
# 526 "../crypto/x509/x_crl.c"
                      ;
        if (propq != 
# 527 "../crypto/x509/x_crl.c" 3 4
                    ((void *)0)
# 527 "../crypto/x509/x_crl.c"
                        ) {
            x->propq = CRYPTO_strdup(propq, "../crypto/x509/x_crl.c", 528);
            if (x->propq == 
# 529 "../crypto/x509/x_crl.c" 3 4
                           ((void *)0)
# 529 "../crypto/x509/x_crl.c"
                               )
                return 0;
        }
    }
