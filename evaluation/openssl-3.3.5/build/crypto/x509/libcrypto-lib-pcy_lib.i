# 0 "../crypto/x509/pcy_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_lib.c"
# 10 "../crypto/x509/pcy_lib.c"
                                               ...
                                               int i)
{
    if (!tree || (i < 0) || (i >= tree->nlevel))
        return 
# 31 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 31 "../crypto/x509/pcy_lib.c"
                  ;
                                                           ...
                                                           *tree)
{
    if (!tree)
        return 
# 40 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 40 "../crypto/x509/pcy_lib.c"
                  ;
                                                                ...
                                                                *tree)
{
    if (!tree)
        return 
# 49 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 49 "../crypto/x509/pcy_lib.c"
                  ;
    if (tree->flags & 0x2)
        return tree->auth_policies;
    else
...
int X509_policy_level_node_count(X509_POLICY_LEVEL *level)
{
    ...
    if (level->anyPolicy)
        ...
        n = 0;
    if (level->nodes)
        n += OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(level->nodes));
    return n;
}
...
X509_POLICY_NODE *X509_policy_level_get0_node(const X509_POLICY_LEVEL *level, int i)
{
    if (!level)
        return 
# 75 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 75 "../crypto/x509/pcy_lib.c"
                  ;
    if (level->anyPolicy) {
        if (i == 0)
    ...
    return ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(level->nodes), (i)));
}
...
const ASN1_OBJECT *X509_policy_node_get0_policy(const X509_POLICY_NODE *node)
{
    if (!node)
        return 
# 89 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 89 "../crypto/x509/pcy_lib.c"
                  ;
                                                           ...
                                                           *node)
{
    if (!node)
        return 
# 98 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 98 "../crypto/x509/pcy_lib.c"
                  ;
                                                     ...
                                                     *node)
{
    if (!node)
        return 
# 106 "../crypto/x509/pcy_lib.c" 3 4
              ((void *)0)
# 106 "../crypto/x509/pcy_lib.c"
                  ;
    return node->parent;
}
