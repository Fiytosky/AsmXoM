# 0 "../crypto/x509/x509_v3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_v3.c"
# 10 "../crypto/x509/x509_v3.c"
...
int X509v3_get_ext_count(const struct stack_st_X509_EXTENSION *x)
{
    ...
    if (x == 
# 24 "../crypto/x509/x509_v3.c" 3 4
            ((void *)0)
# 24 "../crypto/x509/x509_v3.c"
                )
        return 0;
    ret = OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(x));
    return ret > 0 ? ret : 0;
}

int X509v3_get_ext_by_NID(const struct stack_st_X509_EXTENSION *x, int nid,
                          int lastpos)
{
    ASN1_OBJECT *obj;
    ...
    obj = OBJ_nid2obj(nid);
    if (obj == 
# 36 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 36 "../crypto/x509/x509_v3.c"
                  )
        return -2;
    return X509v3_get_ext_by_OBJ(x, obj, lastpos);
}

int X509v3_get_ext_by_OBJ(const struct stack_st_X509_EXTENSION *sk,
                          const ASN1_OBJECT *obj, int lastpos)
{
    int n;
    X509_EXTENSION *ex;
    ...
    if (sk == 
# 47 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 47 "../crypto/x509/x509_v3.c"
                 )
        return -1;
    lastpos++;
    if (lastpos < 0)
        lastpos = 0;
    n = OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(sk));
    for (; lastpos < n; lastpos++) {
        ex = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(sk), (lastpos)));
...
int X509v3_get_ext_by_critical(const struct stack_st_X509_EXTENSION *sk, int crit,
                               int lastpos)
{
    int n;
    X509_EXTENSION *ex;
    ...
    if (sk == 
# 67 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 67 "../crypto/x509/x509_v3.c"
                 )
        return -1;
    lastpos++;
    if (lastpos < 0)
...
{
    if (x == 
# 83 "../crypto/x509/x509_v3.c" 3 4
            ((void *)0) 
# 83 "../crypto/x509/x509_v3.c"
                 || OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(x)) <= loc || loc < 0)
        return 
# 84 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 84 "../crypto/x509/x509_v3.c"
                  ;
    else
        return ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(x), (loc)));
}
...
X509_EXTENSION *X509v3_delete_ext(struct stack_st_X509_EXTENSION *x, int loc)
{
    ...
    if (x == 
# 93 "../crypto/x509/x509_v3.c" 3 4
            ((void *)0) 
# 93 "../crypto/x509/x509_v3.c"
                 || OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(x)) <= loc || loc < 0)
        return 
# 94 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 94 "../crypto/x509/x509_v3.c"
                  ;
    ret = ((X509_EXTENSION *)OPENSSL_sk_delete(ossl_check_X509_EXTENSION_sk_type(x), (loc)));
    return ret;
}
...
# 102 "../crypto/x509/x509_v3.c" 3 4
                            ((void *)0)
# 102 "../crypto/x509/x509_v3.c"
                                ;
    int n;
    struct stack_st_X509_EXTENSION *sk = 
# 104 "../crypto/x509/x509_v3.c" 3 4
                                  ((void *)0)
# 104 "../crypto/x509/x509_v3.c"
                                      ;

    if (x == 
# 106 "../crypto/x509/x509_v3.c" 3 4
            ((void *)0)
# 106 "../crypto/x509/x509_v3.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",107,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 107 "../crypto/x509/x509_v3.c" 3 4
       ((void *)0)
# 107 "../crypto/x509/x509_v3.c"
       );
        goto err;
    }

    if (*x == 
# 111 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 111 "../crypto/x509/x509_v3.c"
                 ) {
        if ((sk = ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_null())) == 
# 112 "../crypto/x509/x509_v3.c" 3 4
                                                  ((void *)0)
# 112 "../crypto/x509/x509_v3.c"
                                                      ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",113,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 113 "../crypto/x509/x509_v3.c" 3 4
           ((void *)0)
# 113 "../crypto/x509/x509_v3.c"
           );
            goto err;
        }
    } else
...
# 125 "../crypto/x509/x509_v3.c" 3 4
                                            ((void *)0)
# 125 "../crypto/x509/x509_v3.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",126,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 126 "../crypto/x509/x509_v3.c" 3 4
       ((void *)0)
# 126 "../crypto/x509/x509_v3.c"
       );
        goto err;
    }
    if (!OPENSSL_sk_insert(ossl_check_X509_EXTENSION_sk_type(sk), ossl_check_X509_EXTENSION_type(new_ex), (loc))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",130,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 130 "../crypto/x509/x509_v3.c" 3 4
       ((void *)0)
# 130 "../crypto/x509/x509_v3.c"
       );
        goto err;
    }
    if (*x == 
# 133 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 133 "../crypto/x509/x509_v3.c"
                 )
        *x = sk;
    return sk;
 err:
    ...
    if (x != 
# 138 "../crypto/x509/x509_v3.c" 3 4
            ((void *)0) 
# 138 "../crypto/x509/x509_v3.c"
                 && *x == 
# 138 "../crypto/x509/x509_v3.c" 3 4
                          ((void *)0)
# 138 "../crypto/x509/x509_v3.c"
    ...
    return 
# 140 "../crypto/x509/x509_v3.c" 3 4
          ((void *)0)
# 140 "../crypto/x509/x509_v3.c"
              ;
}
                                             ...
                                             ASN1_OCTET_STRING *data)
{
    ...
    obj = OBJ_nid2obj(nid);
    if (obj == 
# 151 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 151 "../crypto/x509/x509_v3.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",152,__func__), ERR_set_error)((11),(109),
# 152 "../crypto/x509/x509_v3.c" 3 4
       ((void *)0)
# 152 "../crypto/x509/x509_v3.c"
       );
        return 
# 153 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 153 "../crypto/x509/x509_v3.c"
                  ;
    }
    ret = X509_EXTENSION_create_by_OBJ(ex, obj, crit, data);
    if (ret == 
# 156 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 156 "../crypto/x509/x509_v3.c"
                  )
                                             ...
                                             ASN1_OCTET_STRING *data)
{
    ...
    if ((ex == 
# 167 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 167 "../crypto/x509/x509_v3.c"
                  ) || (*ex == 
# 167 "../crypto/x509/x509_v3.c" 3 4
                               ((void *)0)
# 167 "../crypto/x509/x509_v3.c"
...
# 168 "../crypto/x509/x509_v3.c" 3 4
                                           ((void *)0)
# 168 "../crypto/x509/x509_v3.c"
                                               ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_v3.c",169,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 169 "../crypto/x509/x509_v3.c" 3 4
           ((void *)0)
# 169 "../crypto/x509/x509_v3.c"
           );
            return 
# 170 "../crypto/x509/x509_v3.c" 3 4
                  ((void *)0)
# 170 "../crypto/x509/x509_v3.c"
                      ;
        }
    } else
        ret = *ex;
    ...
    if ((ex != 
# 182 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 182 "../crypto/x509/x509_v3.c"
                  ) && (*ex == 
# 182 "../crypto/x509/x509_v3.c" 3 4
                               ((void *)0)
# 182 "../crypto/x509/x509_v3.c"
 ...
 err:
    if ((ex == 
# 186 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 186 "../crypto/x509/x509_v3.c"
                  ) || (ret != *ex))
        X509_EXTENSION_free(ret);
    return 
# 188 "../crypto/x509/x509_v3.c" 3 4
          ((void *)0)
# 188 "../crypto/x509/x509_v3.c"
              ;
}
...
{
    if ((ex == 
# 193 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 193 "../crypto/x509/x509_v3.c"
                  ) || (obj == 
# 193 "../crypto/x509/x509_v3.c" 3 4
                               ((void *)0)
# 193 "../crypto/x509/x509_v3.c"
    ...
    return ex->object != 
# 197 "../crypto/x509/x509_v3.c" 3 4
                        ((void *)0)
# 197 "../crypto/x509/x509_v3.c"
                            ;
}
...
{
    if (ex == 
# 202 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 202 "../crypto/x509/x509_v3.c"
                 )
        return 0;
...
int X509_EXTENSION_set_data(X509_EXTENSION *ex, ASN1_OCTET_STRING *data)
{
    ...
    if (ex == 
# 212 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 212 "../crypto/x509/x509_v3.c"
                 )
        return 0;
...
{
    if (ex == 
# 222 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 222 "../crypto/x509/x509_v3.c"
                 )
        return 
# 223 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 223 "../crypto/x509/x509_v3.c"
                  ;
    return ex->object;
}
...
{
    if (ex == 
# 229 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 229 "../crypto/x509/x509_v3.c"
                 )
        return 
# 230 "../crypto/x509/x509_v3.c" 3 4
              ((void *)0)
# 230 "../crypto/x509/x509_v3.c"
                  ;
    return &ex->value;
}
...
{
    if (ex == 
# 236 "../crypto/x509/x509_v3.c" 3 4
             ((void *)0)
# 236 "../crypto/x509/x509_v3.c"
                 )
        return 0;
    if (ex->critical > 0)
        return 1;
