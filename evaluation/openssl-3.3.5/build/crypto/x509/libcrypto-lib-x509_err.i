# 0 "../crypto/x509/x509_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_err.c"
# 11 "../crypto/x509/x509_err.c"
...
# 12 "../crypto/x509/x509_err.c" 2
# 1 "../include/openssl/x509err.h" 1
# 13 "../include/openssl/x509err.h"
        
# 13 "../crypto/x509/x509_err.c" 2
# 1 "../include/crypto/x509err.h" 1
# 13 "../include/crypto/x509err.h"
        
# 22 "../include/crypto/x509err.h"
int ossl_err_load_X509_strings(void);
# 14 "../crypto/x509/x509_err.c" 2



static const ERR_STRING_DATA X509_str_reasons[] = {
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "akid mismatch"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ), "bad selector"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "bad x509 filetype"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "base64 decode error"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "can't check dh key"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ),
    "certificate verification failed"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "cert already in hash table"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ), "crl already delta"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "crl verify failure"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(140) & 0X7FFFFF)) ),
    "duplicate attribute"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(141) & 0X7FFFFF)) ),
    "error getting md by nid"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(142) & 0X7FFFFF)) ),
    "error using siginf set"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ), "idp mismatch"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ),
    "invalid attributes"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "invalid directory"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ), "invalid distpoint"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "invalid field name"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ), "invalid trust"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "issuer mismatch"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "key type mismatch"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "key values mismatch"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "loading cert dir"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "loading defaults"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "method not supported"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ), "name too long"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ),
    "newer crl not newer"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ),
    "no certificate found"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "no certificate or crl found"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "no cert set for us to verify"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ), "no crl found"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "no crl number"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "public key decode error"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "public key encode error"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "should retry"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "unable to find parameters in chain"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "unable to get certs public key"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ), "unknown key type"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "unknown nid"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "unknown purpose id"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "unknown sigid algs"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "unknown trust id"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "unsupported algorithm"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "wrong lookup type"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ), "wrong type"},
    {0, 
# 84 "../crypto/x509/x509_err.c" 3 4
       ((void *)0)
# 84 "../crypto/x509/x509_err.c"
           }
};
...
int ossl_err_load_X509_strings(void)
{
    ...
    if (ERR_reason_error_string(X509_str_reasons[0].error) == 
# 92 "../crypto/x509/x509_err.c" 3 4
                                                             ((void *)0)
# 92 "../crypto/x509/x509_err.c"
                                                                 )
