# 0 "../crypto/x509/v3_pcons.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_pcons.c"
# 10 "../crypto/x509/v3_pcons.c"
...
# 17 "../crypto/x509/v3_pcons.c" 2

static struct stack_st_CONF_VALUE *i2v_POLICY_CONSTRAINTS(const X509V3_EXT_METHOD
                                                    *method, void *bcons, struct stack_st_CONF_VALUE
                                                    *extlist);
...
# 32 "../crypto/x509/v3_pcons.c" 3 4
   ((void *)0)
# 32 "../crypto/x509/v3_pcons.c"
       , 
# 32 "../crypto/x509/v3_pcons.c" 3 4
         ((void *)0)
# 32 "../crypto/x509/v3_pcons.c"
...
# 33 "../crypto/x509/v3_pcons.c" 3 4
   ((void *)0)

# 34 "../crypto/x509/v3_pcons.c"
};

static const ASN1_TEMPLATE POLICY_CONSTRAINTS_seq_tt[] = {
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 37 "../crypto/x509/v3_pcons.c" 3 4
       __builtin_offsetof (
# 37 "../crypto/x509/v3_pcons.c"
       POLICY_CONSTRAINTS
# 37 "../crypto/x509/v3_pcons.c" 3 4
       , 
# 37 "../crypto/x509/v3_pcons.c"
...
# 37 "../crypto/x509/v3_pcons.c"
       , "requireExplicitPolicy", (ASN1_INTEGER_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 38 "../crypto/x509/v3_pcons.c" 3 4
       __builtin_offsetof (
# 38 "../crypto/x509/v3_pcons.c"
       POLICY_CONSTRAINTS
# 38 "../crypto/x509/v3_pcons.c" 3 4
       , 
# 38 "../crypto/x509/v3_pcons.c"
...
# 38 "../crypto/x509/v3_pcons.c"
       , "inhibitPolicyMapping", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * POLICY_CONSTRAINTS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, POLICY_CONSTRAINTS_seq_tt, sizeof(POLICY_CONSTRAINTS_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 39 "../crypto/x509/v3_pcons.c" 3 4
 ((void *)0)
# 39 "../crypto/x509/v3_pcons.c"
 , sizeof(POLICY_CONSTRAINTS), "POLICY_CONSTRAINTS" }; return &local_it; }

POLICY_CONSTRAINTS *POLICY_CONSTRAINTS_new(void) { return (POLICY_CONSTRAINTS *)ASN1_item_new((POLICY_CONSTRAINTS_it())); } void POLICY_CONSTRAINTS_free(POLICY_CONSTRAINTS *a) { ASN1_item_free((ASN1_VALUE *)a, (POLICY_CONSTRAINTS_it())); }
...
# 59 "../crypto/x509/v3_pcons.c" 3 4
                               ((void *)0)
# 59 "../crypto/x509/v3_pcons.c"
                                   ;
    CONF_VALUE *val;
    int i;

    if ((pcons = POLICY_CONSTRAINTS_new()) == 
# 63 "../crypto/x509/v3_pcons.c" 3 4
                                             ((void *)0)
# 63 "../crypto/x509/v3_pcons.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pcons.c",64,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 64 "../crypto/x509/v3_pcons.c" 3 4
       ((void *)0)
# 64 "../crypto/x509/v3_pcons.c"
       );
        return 
# 65 "../crypto/x509/v3_pcons.c" 3 4
              ((void *)0)
# 65 "../crypto/x509/v3_pcons.c"
                  ;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(values)); i++) {
        ...
        if (strcmp(val->name, "requireExplicitPolicy") == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pcons.c",76,__func__), ERR_set_error)(34, 106,
                           "%s", val->name);
            goto err;
        }
    }
    if (pcons->inhibitPolicyMapping == 
# 81 "../crypto/x509/v3_pcons.c" 3 4
                                      ((void *)0)
            
# 82 "../crypto/x509/v3_pcons.c"
           && pcons->requireExplicitPolicy == 
# 82 "../crypto/x509/v3_pcons.c" 3 4
                                              ((void *)0)
# 82 "../crypto/x509/v3_pcons.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pcons.c",83,__func__), ERR_set_error)((34),(151),
# 83 "../crypto/x509/v3_pcons.c" 3 4
       ((void *)0)
# 83 "../crypto/x509/v3_pcons.c"
       );
        goto err;
    }
 ...
 err:
    ...
    return 
# 90 "../crypto/x509/v3_pcons.c" 3 4
          ((void *)0)
# 90 "../crypto/x509/v3_pcons.c"
              ;
}
