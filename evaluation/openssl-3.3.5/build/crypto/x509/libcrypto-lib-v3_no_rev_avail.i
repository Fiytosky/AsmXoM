# 0 "../crypto/x509/v3_no_rev_avail.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_no_rev_avail.c"
# 10 "../crypto/x509/v3_no_rev_avail.c"
...
# 11 "../crypto/x509/v3_no_rev_avail.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/x509/v3_no_rev_avail.c" 2
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 14 "../crypto/x509/v3_no_rev_avail.c" 2
...
# 15 "../crypto/x509/v3_no_rev_avail.c" 2
...
# 16 "../crypto/x509/v3_no_rev_avail.c" 2
...
{
    return CRYPTO_strdup("NULL", "../crypto/x509/v3_no_rev_avail.c", 32);
}
...
# 52 "../crypto/x509/v3_no_rev_avail.c" 3 4
   ((void *)0)

# 53 "../crypto/x509/v3_no_rev_avail.c"
};
