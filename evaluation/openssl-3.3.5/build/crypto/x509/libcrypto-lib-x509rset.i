# 0 "../crypto/x509/x509rset.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509rset.c"
# 10 "../crypto/x509/x509rset.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 17 "../crypto/x509/x509rset.c" 2

int X509_REQ_set_version(X509_REQ *x, long version)
{
    if (x == 
# 20 "../crypto/x509/x509rset.c" 3 4
            ((void *)0)
# 20 "../crypto/x509/x509rset.c"
                )
        return 0;
...
{
    if (x == 
# 28 "../crypto/x509/x509rset.c" 3 4
            ((void *)0)
# 28 "../crypto/x509/x509rset.c"
                )
        return 0;
    x->req_info.enc.modified = 1;
...
{
    if (x == 
# 36 "../crypto/x509/x509rset.c" 3 4
            ((void *)0)
# 36 "../crypto/x509/x509rset.c"
                )
        return 0;
    x->req_info.enc.modified = 1;
