# 0 "../crypto/x509/v3_pcia.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_pcia.c"
# 46 "../crypto/x509/v3_pcia.c"
...
# 49 "../crypto/x509/v3_pcia.c" 2

static const ASN1_TEMPLATE PROXY_POLICY_seq_tt[] = {
        { (0), (0), 
# 51 "../crypto/x509/v3_pcia.c" 3 4
       __builtin_offsetof (
# 51 "../crypto/x509/v3_pcia.c"
       PROXY_POLICY
# 51 "../crypto/x509/v3_pcia.c" 3 4
       , 
# 51 "../crypto/x509/v3_pcia.c"
...
# 51 "../crypto/x509/v3_pcia.c"
       , "policyLanguage", (ASN1_OBJECT_it) },
        { ((0x1)), (0), 
# 52 "../crypto/x509/v3_pcia.c" 3 4
       __builtin_offsetof (
# 52 "../crypto/x509/v3_pcia.c"
       PROXY_POLICY
# 52 "../crypto/x509/v3_pcia.c" 3 4
       , 
# 52 "../crypto/x509/v3_pcia.c"
...
# 52 "../crypto/x509/v3_pcia.c"
       , "policy", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * PROXY_POLICY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PROXY_POLICY_seq_tt, sizeof(PROXY_POLICY_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 53 "../crypto/x509/v3_pcia.c" 3 4
 ((void *)0)
# 53 "../crypto/x509/v3_pcia.c"
 , sizeof(PROXY_POLICY), "PROXY_POLICY" }; return &local_it; }

PROXY_POLICY *d2i_PROXY_POLICY(PROXY_POLICY **a, const unsigned char **in, long len) { return (PROXY_POLICY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PROXY_POLICY_it())); } int i2d_PROXY_POLICY(const PROXY_POLICY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PROXY_POLICY_it())); } PROXY_POLICY *PROXY_POLICY_new(void) { return (PROXY_POLICY *)ASN1_item_new((PROXY_POLICY_it())); } void PROXY_POLICY_free(PROXY_POLICY *a) { ASN1_item_free((ASN1_VALUE *)a, (PROXY_POLICY_it())); }

static const ASN1_TEMPLATE PROXY_CERT_INFO_EXTENSION_seq_tt[] = {
        { ((0x1)), (0), 
# 58 "../crypto/x509/v3_pcia.c" 3 4
       __builtin_offsetof (
# 58 "../crypto/x509/v3_pcia.c"
       PROXY_CERT_INFO_EXTENSION
# 58 "../crypto/x509/v3_pcia.c" 3 4
       , 
# 58 "../crypto/x509/v3_pcia.c"
...
# 58 "../crypto/x509/v3_pcia.c"
       , "pcPathLengthConstraint", (ASN1_INTEGER_it) },
        { (0), (0), 
# 59 "../crypto/x509/v3_pcia.c" 3 4
       __builtin_offsetof (
# 59 "../crypto/x509/v3_pcia.c"
       PROXY_CERT_INFO_EXTENSION
# 59 "../crypto/x509/v3_pcia.c" 3 4
       , 
# 59 "../crypto/x509/v3_pcia.c"
