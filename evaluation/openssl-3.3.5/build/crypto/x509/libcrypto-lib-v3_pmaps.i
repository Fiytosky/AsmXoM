# 0 "../crypto/x509/v3_pmaps.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_pmaps.c"
# 10 "../crypto/x509/v3_pmaps.c"
...
# 16 "../crypto/x509/v3_pmaps.c" 2

static void *v2i_POLICY_MAPPINGS(const X509V3_EXT_METHOD *method,
                                 X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval);
static struct stack_st_CONF_VALUE *i2v_POLICY_MAPPINGS(const X509V3_EXT_METHOD
                                                 *method, void *pmps, struct stack_st_CONF_VALUE
                                                 *extlist);
...
# 31 "../crypto/x509/v3_pmaps.c" 3 4
   ((void *)0)

# 32 "../crypto/x509/v3_pmaps.c"
};

static const ASN1_TEMPLATE POLICY_MAPPING_seq_tt[] = {
        { (0), (0), 
# 35 "../crypto/x509/v3_pmaps.c" 3 4
       __builtin_offsetof (
# 35 "../crypto/x509/v3_pmaps.c"
       POLICY_MAPPING
# 35 "../crypto/x509/v3_pmaps.c" 3 4
       , 
# 35 "../crypto/x509/v3_pmaps.c"
...
# 35 "../crypto/x509/v3_pmaps.c"
       , "issuerDomainPolicy", (ASN1_OBJECT_it) },
        { (0), (0), 
# 36 "../crypto/x509/v3_pmaps.c" 3 4
       __builtin_offsetof (
# 36 "../crypto/x509/v3_pmaps.c"
       POLICY_MAPPING
# 36 "../crypto/x509/v3_pmaps.c" 3 4
       , 
# 36 "../crypto/x509/v3_pmaps.c"
...
# 36 "../crypto/x509/v3_pmaps.c"
       , "subjectDomainPolicy", (ASN1_OBJECT_it) }
} ; const ASN1_ITEM * POLICY_MAPPING_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, POLICY_MAPPING_seq_tt, sizeof(POLICY_MAPPING_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 37 "../crypto/x509/v3_pmaps.c" 3 4
 ((void *)0)
# 37 "../crypto/x509/v3_pmaps.c"
 , sizeof(POLICY_MAPPING), "POLICY_MAPPING" }; return &local_it; }

static const ASN1_TEMPLATE POLICY_MAPPINGS_item_tt =
        { ((0x2 << 1)), (0), 0, "POLICY_MAPPINGS", (POLICY_MAPPING_it) }

; const ASN1_ITEM * POLICY_MAPPINGS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &POLICY_MAPPINGS_item_tt, 0, 
# 42 "../crypto/x509/v3_pmaps.c" 3 4
((void *)0)
# 42 "../crypto/x509/v3_pmaps.c"
, 0, "POLICY_MAPPINGS" }; return &local_it; }

POLICY_MAPPING *POLICY_MAPPING_new(void) { return (POLICY_MAPPING *)ASN1_item_new((POLICY_MAPPING_it())); } void POLICY_MAPPING_free(POLICY_MAPPING *a) { ASN1_item_free((ASN1_VALUE *)a, (POLICY_MAPPING_it())); }

static struct stack_st_CONF_VALUE *i2v_POLICY_MAPPINGS(const X509V3_EXT_METHOD
                                                 *method, void *a, struct stack_st_CONF_VALUE
                                                 *ext_list)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_POLICY_MAPPING_sk_type(pmaps)); i++) {
        pmap = ((POLICY_MAPPING *)OPENSSL_sk_value(ossl_check_const_POLICY_MAPPING_sk_type(pmaps), (i)));
...
{
    POLICY_MAPPING *pmap = 
# 68 "../crypto/x509/v3_pmaps.c" 3 4
                          ((void *)0)
# 68 "../crypto/x509/v3_pmaps.c"
                              ;
    ASN1_OBJECT *obj1 = 
# 69 "../crypto/x509/v3_pmaps.c" 3 4
                       ((void *)0)
# 69 "../crypto/x509/v3_pmaps.c"
                           , *obj2 = 
# 69 "../crypto/x509/v3_pmaps.c" 3 4
                                     ((void *)0)
# 69 "../crypto/x509/v3_pmaps.c"
    ...
    if ((pmaps = ((struct stack_st_POLICY_MAPPING *)OPENSSL_sk_new_reserve(ossl_check_POLICY_MAPPING_compfunc_type(
# 75 "../crypto/x509/v3_pmaps.c" 3 4
                ((void *)0)
# 75 "../crypto/x509/v3_pmaps.c"
                ), (num)))) == 
# 75 "../crypto/x509/v3_pmaps.c" 3 4
                                                             ((void *)0)
# 75 "../crypto/x509/v3_pmaps.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pmaps.c",76,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 76 "../crypto/x509/v3_pmaps.c" 3 4
       ((void *)0)
# 76 "../crypto/x509/v3_pmaps.c"
       );
        return 
# 77 "../crypto/x509/v3_pmaps.c" 3 4
              ((void *)0)
# 77 "../crypto/x509/v3_pmaps.c"
                  ;
    }
    ...
    for (i = 0; i < num; i++) {
        ...
        if (!val->value || !val->name) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pmaps.c",83,__func__), ERR_set_error)(34, 110,
                           "%s", val->name);
            goto err;
        }
        ...
        if (!obj1 || !obj2) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pmaps.c",90,__func__), ERR_set_error)(34, 110,
                           "%s", val->name);
            goto err;
        }
        pmap = POLICY_MAPPING_new();
        if (pmap == 
# 95 "../crypto/x509/v3_pmaps.c" 3 4
                   ((void *)0)
# 95 "../crypto/x509/v3_pmaps.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pmaps.c",96,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 96 "../crypto/x509/v3_pmaps.c" 3 4
           ((void *)0)
# 96 "../crypto/x509/v3_pmaps.c"
           );
            goto err;
        }
        ...
        obj1 = obj2 = 
# 101 "../crypto/x509/v3_pmaps.c" 3 4
                     ((void *)0)
# 101 "../crypto/x509/v3_pmaps.c"
                         ;
        OPENSSL_sk_push(ossl_check_POLICY_MAPPING_sk_type(pmaps), ossl_check_POLICY_MAPPING_type(pmap));
    }
    return pmaps;
 err:
    ASN1_OBJECT_free(obj1);
    ASN1_OBJECT_free(obj2);
    OPENSSL_sk_pop_free(ossl_check_POLICY_MAPPING_sk_type(pmaps),ossl_check_POLICY_MAPPING_freefunc_type(POLICY_MAPPING_free));
    return 
# 109 "../crypto/x509/v3_pmaps.c" 3 4
          ((void *)0)
# 109 "../crypto/x509/v3_pmaps.c"
              ;
}
