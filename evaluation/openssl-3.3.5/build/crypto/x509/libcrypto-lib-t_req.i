# 0 "../crypto/x509/t_req.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/t_req.c"
# 10 "../crypto/x509/t_req.c"
...
# 26 "../crypto/x509/t_req.c" 3 4
                                      ((void *)0)
# 26 "../crypto/x509/t_req.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/t_req.c",27,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 27 "../crypto/x509/t_req.c" 3 4
       ((void *)0)
# 27 "../crypto/x509/t_req.c"
       );
        return 0;
    }
...
# 43 "../crypto/x509/t_req.c" 3 4
                                    ((void *)0)
# 43 "../crypto/x509/t_req.c"
                                        ;
    char mlch = ' ';
    ...
    if (!(cflag & (1L << 7))) {
        ...
        X509_PUBKEY_get0_param(&koid, 
# 88 "../crypto/x509/t_req.c" 3 4
                                     ((void *)0)
# 88 "../crypto/x509/t_req.c"
                                         , 
# 88 "../crypto/x509/t_req.c" 3 4
                                           ((void *)0)
# 88 "../crypto/x509/t_req.c"
...
# 88 "../crypto/x509/t_req.c"
        ...
        if (pkey == 
# 95 "../crypto/x509/t_req.c" 3 4
                   ((void *)0)
# 95 "../crypto/x509/t_req.c"
                       ) {
            if (BIO_printf(bp, "%12sUnable to load Public Key\n", "") <= 0)
                goto err;
            ERR_print_errors(bp);
        } else {
            if (EVP_PKEY_print_public(bp, pkey, 16, 
# 100 "../crypto/x509/t_req.c" 3 4
                                                   ((void *)0)
# 100 "../crypto/x509/t_req.c"
                                                       ) <= 0)
                goto err;
        }
    }
    ...
    if (!(cflag & (1L << 11))) {
        ...
        if (X509_REQ_get_attr_count(x) == 0) {
            ...
            for (i = 0; i < X509_REQ_get_attr_count(x); i++) {
                ...
                X509_ATTRIBUTE *a;
                ASN1_BIT_STRING *bs = 
# 117 "../crypto/x509/t_req.c" 3 4
                                     ((void *)0)
# 117 "../crypto/x509/t_req.c"
                                         ;
                ASN1_OBJECT *aobj;
                ...
                if ((j = i2a_ASN1_OBJECT(bp, aobj)) > 0) {
                    ...
                    if (count == 0) {
                      (ERR_new(), ERR_set_debug("../crypto/x509/t_req.c",131,__func__), ERR_set_error)((11),(138),
# 131 "../crypto/x509/t_req.c" 3 4
                     ((void *)0)
# 131 "../crypto/x509/t_req.c"
                     );
                      return 0;
                    }
 get_next:
    ...
    if (!(cflag & (1L << 8))) {
        ...
        if (exts) {
            ...
            exts = 
# 194 "../crypto/x509/t_req.c" 3 4
                  ((void *)0)
# 194 "../crypto/x509/t_req.c"
                      ;
        }
    }
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_X509_EXTENSION_sk_type(exts),ossl_check_X509_EXTENSION_freefunc_type(X509_EXTENSION_free));
    (ERR_new(), ERR_set_debug("../crypto/x509/t_req.c",209,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 209 "../crypto/x509/t_req.c" 3 4
   ((void *)0)
# 209 "../crypto/x509/t_req.c"
   );
    return 0;
}
