# 0 "../crypto/x509/v3_utf8.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_utf8.c"
# 10 "../crypto/x509/v3_utf8.c"
...
# 16 "../crypto/x509/v3_utf8.c" 2
# 25 "../crypto/x509/v3_utf8.c"
const X509V3_EXT_METHOD ossl_v3_utf8_list[1] = {
    { 1007, 0, (ASN1_UTF8STRING_it), 0,0,0,0, (X509V3_EXT_I2S)i2s_ASN1_UTF8STRING, (X509V3_EXT_S2I)s2i_ASN1_UTF8STRING, 0,0,0,0, 
# 26 "../crypto/x509/v3_utf8.c" 3 4
   ((void *)0)
# 26 "../crypto/x509/v3_utf8.c"
   },
};
                          ...
                          ASN1_UTF8STRING *utf8)
{
    ...
    if (utf8 == 
# 34 "../crypto/x509/v3_utf8.c" 3 4
               ((void *)0) 
# 34 "../crypto/x509/v3_utf8.c"
                    || utf8->length == 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utf8.c",35,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 35 "../crypto/x509/v3_utf8.c" 3 4
       ((void *)0)
# 35 "../crypto/x509/v3_utf8.c"
       );
        return 
# 36 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 36 "../crypto/x509/v3_utf8.c"
                  ;
    }
    if ((tmp = CRYPTO_malloc(utf8->length + 1, "../crypto/x509/v3_utf8.c", 38)) == 
# 38 "../crypto/x509/v3_utf8.c" 3 4
                                                   ((void *)0)
# 38 "../crypto/x509/v3_utf8.c"
                                                       )
        return 
# 39 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 39 "../crypto/x509/v3_utf8.c"
                  ;
                                     ...
                                     X509V3_CTX *ctx, const char *str)
{
    ASN1_UTF8STRING *utf8;
    if (str == 
# 49 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 49 "../crypto/x509/v3_utf8.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utf8.c",50,__func__), ERR_set_error)((34),(107),
# 50 "../crypto/x509/v3_utf8.c" 3 4
       ((void *)0)
# 50 "../crypto/x509/v3_utf8.c"
       );
        return 
# 51 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 51 "../crypto/x509/v3_utf8.c"
                  ;
    }
    if ((utf8 = ASN1_UTF8STRING_new()) == 
# 53 "../crypto/x509/v3_utf8.c" 3 4
                                         ((void *)0)
# 53 "../crypto/x509/v3_utf8.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utf8.c",54,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 54 "../crypto/x509/v3_utf8.c" 3 4
       ((void *)0)
# 54 "../crypto/x509/v3_utf8.c"
       );
        return 
# 55 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 55 "../crypto/x509/v3_utf8.c"
                  ;
    }
    if (!ASN1_STRING_set((ASN1_STRING *)utf8, str, strlen(str))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utf8.c",58,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 58 "../crypto/x509/v3_utf8.c" 3 4
       ((void *)0)
# 58 "../crypto/x509/v3_utf8.c"
       );
        ASN1_UTF8STRING_free(utf8);
        return 
# 60 "../crypto/x509/v3_utf8.c" 3 4
              ((void *)0)
# 60 "../crypto/x509/v3_utf8.c"
                  ;
    }
