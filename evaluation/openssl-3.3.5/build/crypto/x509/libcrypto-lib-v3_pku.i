# 0 "../crypto/x509/v3_pku.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_pku.c"
# 10 "../crypto/x509/v3_pku.c"
...
const X509V3_EXT_METHOD ossl_v3_pkey_usage_period = {
    84, 0, (PKEY_USAGE_PERIOD_it),
    0, 0, 0, 0,
    0, 0, 0, 0,
    (X509V3_EXT_I2R)i2r_PKEY_USAGE_PERIOD, 
# 25 "../crypto/x509/v3_pku.c" 3 4
                                          ((void *)0)
# 25 "../crypto/x509/v3_pku.c"
                                              ,
    
# 26 "../crypto/x509/v3_pku.c" 3 4
   ((void *)0)

# 27 "../crypto/x509/v3_pku.c"
};

static const ASN1_TEMPLATE PKEY_USAGE_PERIOD_seq_tt[] = {
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 30 "../crypto/x509/v3_pku.c" 3 4
       __builtin_offsetof (
# 30 "../crypto/x509/v3_pku.c"
       PKEY_USAGE_PERIOD
# 30 "../crypto/x509/v3_pku.c" 3 4
       , 
# 30 "../crypto/x509/v3_pku.c"
...
# 30 "../crypto/x509/v3_pku.c"
       , "notBefore", (ASN1_GENERALIZEDTIME_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 31 "../crypto/x509/v3_pku.c" 3 4
       __builtin_offsetof (
# 31 "../crypto/x509/v3_pku.c"
       PKEY_USAGE_PERIOD
# 31 "../crypto/x509/v3_pku.c" 3 4
       , 
# 31 "../crypto/x509/v3_pku.c"
...
# 31 "../crypto/x509/v3_pku.c"
       , "notAfter", (ASN1_GENERALIZEDTIME_it) }
} ; const ASN1_ITEM * PKEY_USAGE_PERIOD_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKEY_USAGE_PERIOD_seq_tt, sizeof(PKEY_USAGE_PERIOD_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 32 "../crypto/x509/v3_pku.c" 3 4
 ((void *)0)
# 32 "../crypto/x509/v3_pku.c"
 , sizeof(PKEY_USAGE_PERIOD), "PKEY_USAGE_PERIOD" }; return &local_it; }

PKEY_USAGE_PERIOD *d2i_PKEY_USAGE_PERIOD(PKEY_USAGE_PERIOD **a, const unsigned char **in, long len) { return (PKEY_USAGE_PERIOD *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKEY_USAGE_PERIOD_it())); } int i2d_PKEY_USAGE_PERIOD(const PKEY_USAGE_PERIOD *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKEY_USAGE_PERIOD_it())); } PKEY_USAGE_PERIOD *PKEY_USAGE_PERIOD_new(void) { return (PKEY_USAGE_PERIOD *)ASN1_item_new((PKEY_USAGE_PERIOD_it())); } void PKEY_USAGE_PERIOD_free(PKEY_USAGE_PERIOD *a) { ASN1_item_free((ASN1_VALUE *)a, (PKEY_USAGE_PERIOD_it())); }
