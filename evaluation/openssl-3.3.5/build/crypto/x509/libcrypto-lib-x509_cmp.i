# 0 "../crypto/x509/x509_cmp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_cmp.c"
# 10 "../crypto/x509/x509_cmp.c"
...
# 16 "../crypto/x509/x509_cmp.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../crypto/x509/x509_cmp.c" 2
...
int X509_issuer_and_serial_cmp(const X509 *a, const X509 *b)
{
    ...
    if (b == 
# 24 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 24 "../crypto/x509/x509_cmp.c"
                )
        return a != 
# 25 "../crypto/x509/x509_cmp.c" 3 4
                   ((void *)0)
# 25 "../crypto/x509/x509_cmp.c"
                       ;
    if (a == 
# 26 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 26 "../crypto/x509/x509_cmp.c"
                )
        return -1;
    ai = &a->cert_info;
    bi = &b->cert_info;
...
unsigned long X509_issuer_and_serial_hash(X509 *a)
{
    ...
    unsigned char md[16];
    char *f = 
# 42 "../crypto/x509/x509_cmp.c" 3 4
             ((void *)0)
# 42 "../crypto/x509/x509_cmp.c"
                 ;
    EVP_MD *digest = 
# 43 "../crypto/x509/x509_cmp.c" 3 4
                    ((void *)0)
# 43 "../crypto/x509/x509_cmp.c"
                        ;

    if (ctx == 
# 45 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 45 "../crypto/x509/x509_cmp.c"
                  )
        goto err;
    f = X509_NAME_oneline(a->cert_info.issuer, 
# 47 "../crypto/x509/x509_cmp.c" 3 4
                                              ((void *)0)
# 47 "../crypto/x509/x509_cmp.c"
                                                  , 0);
    if (f == 
# 48 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 48 "../crypto/x509/x509_cmp.c"
                )
        goto err;
    digest = EVP_MD_fetch(a->libctx, "MD5", a->propq);
    if (digest == 
# 51 "../crypto/x509/x509_cmp.c" 3 4
                 ((void *)0)
# 51 "../crypto/x509/x509_cmp.c"
                     )
        goto err;

    if (!EVP_DigestInit_ex(ctx, digest, 
# 54 "../crypto/x509/x509_cmp.c" 3 4
                                       ((void *)0)
# 54 "../crypto/x509/x509_cmp.c"
                                           ))
        goto err;
...
# 62 "../crypto/x509/x509_cmp.c" 3 4
                                          ((void *)0)
# 62 "../crypto/x509/x509_cmp.c"
                                              ))
        goto err;
 ...
 err:
    CRYPTO_free(f, "../crypto/x509/x509_cmp.c", 68);
    EVP_MD_free(digest);
    EVP_MD_CTX_free(ctx);
    return ret;
}
...
int X509_CRL_match(const X509_CRL *a, const X509_CRL *b)
{
    ...
    if ((a->flags & 0x100000) == 0
            && (b->flags & 0x100000) == 0)
        rv = memcmp(a->sha1_hash, b->sha1_hash, 20);
    else
        return -2;
...
{
    return X509_NAME_hash_ex(x->cert_info.issuer, 
# 110 "../crypto/x509/x509_cmp.c" 3 4
                                                 ((void *)0)
# 110 "../crypto/x509/x509_cmp.c"
                                                     , 
# 110 "../crypto/x509/x509_cmp.c" 3 4
                                                       ((void *)0)
# 110 "../crypto/x509/x509_cmp.c"
...
unsigned long X509_subject_name_hash(X509 *x)
{
    return X509_NAME_hash_ex(x->cert_info.subject, 
# 137 "../crypto/x509/x509_cmp.c" 3 4
                                                  ((void *)0)
# 137 "../crypto/x509/x509_cmp.c"
                                                      , 
# 137 "../crypto/x509/x509_cmp.c" 3 4
                                                        ((void *)0)
# 137 "../crypto/x509/x509_cmp.c"
...
int X509_cmp(const X509 *a, const X509 *b)
{
    ...
    if ((a->ex_flags & 0x100000) == 0
            && (b->ex_flags & 0x100000) == 0)
        rv = memcmp(a->sha1_hash, b->sha1_hash, 20);
    if (rv != 0)
        return rv < 0 ? -1 : 1;
...
int ossl_x509_add_cert_new(struct stack_st_X509 **p_sk, X509 *cert, int flags)
{
    if (*p_sk == 
# 186 "../crypto/x509/x509_cmp.c" 3 4
                ((void *)0) 
# 186 "../crypto/x509/x509_cmp.c"
                     && (*p_sk = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 186 "../crypto/x509/x509_cmp.c" 3 4
                                                        ((void *)0)
# 186 "../crypto/x509/x509_cmp.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",187,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 187 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 187 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
...
{
    if (sk == 
# 195 "../crypto/x509/x509_cmp.c" 3 4
             ((void *)0)
# 195 "../crypto/x509/x509_cmp.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",196,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 196 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 196 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
    if (cert == 
# 199 "../crypto/x509/x509_cmp.c" 3 4
               ((void *)0)
# 199 "../crypto/x509/x509_cmp.c"
                   )
        return 0;
    if ((flags & 0x4) != 0) {
    ...
    if (!OPENSSL_sk_insert(ossl_check_X509_sk_type(sk), ossl_check_X509_type(cert), ((flags & 0x2) != 0 ? 0 : -1))
                                                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",221,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 221 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 221 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
    if ((flags & 0x1) != 0)
...
{
    if (sk == 
# 232 "../crypto/x509/x509_cmp.c" 3 4
             ((void *)0)
# 232 "../crypto/x509/x509_cmp.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",233,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 233 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 233 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
...
{
    int n = OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs));
    int i;

    for (i = 0; i < n; i++) {
        int j = (flags & 0x2) == 0 ? i : n - 1 - i;


        if (!ossl_x509_add_cert_new(p_sk, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (j))), flags))
            return 0;
    }
    return 1;
}
...
int X509_NAME_cmp(const X509_NAME *a, const X509_NAME *b)
{
    ...
    if (b == 
# 260 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 260 "../crypto/x509/x509_cmp.c"
                )
        return a != 
# 261 "../crypto/x509/x509_cmp.c" 3 4
                   ((void *)0)
# 261 "../crypto/x509/x509_cmp.c"
                       ;
    if (a == 
# 262 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 262 "../crypto/x509/x509_cmp.c"
                )
        return -1;


    if (a->canon_enc == 
# 266 "../crypto/x509/x509_cmp.c" 3 4
                       ((void *)0) 
# 266 "../crypto/x509/x509_cmp.c"
                            || a->modified) {
        ret = i2d_X509_NAME((X509_NAME *)a, 
# 267 "../crypto/x509/x509_cmp.c" 3 4
                                           ((void *)0)
# 267 "../crypto/x509/x509_cmp.c"
                                               );
        if (ret < 0)
            return -2;
    }
    ...
    if (b->canon_enc == 
# 272 "../crypto/x509/x509_cmp.c" 3 4
                       ((void *)0) 
# 272 "../crypto/x509/x509_cmp.c"
                            || b->modified) {
        ret = i2d_X509_NAME((X509_NAME *)b, 
# 273 "../crypto/x509/x509_cmp.c" 3 4
                                           ((void *)0)
# 273 "../crypto/x509/x509_cmp.c"
                                               );
        if (ret < 0)
            return -2;
    }
    ...
    if (ret == 0) {
        if (a->canon_enc == 
# 283 "../crypto/x509/x509_cmp.c" 3 4
                           ((void *)0) 
# 283 "../crypto/x509/x509_cmp.c"
                                || b->canon_enc == 
# 283 "../crypto/x509/x509_cmp.c" 3 4
                                                   ((void *)0)
# 283 "../crypto/x509/x509_cmp.c"
                                ...
                                const char *propq, int *ok)
{
    ...
    i2d_ret = i2d_X509_NAME(x, 
# 300 "../crypto/x509/x509_cmp.c" 3 4
                              ((void *)0)
# 300 "../crypto/x509/x509_cmp.c"
                                  );
    if (ok != 
# 301 "../crypto/x509/x509_cmp.c" 3 4
             ((void *)0)
# 301 "../crypto/x509/x509_cmp.c"
                 )
        *ok = 0;
    if (i2d_ret >= 0 && sha1 != 
# 303 "../crypto/x509/x509_cmp.c" 3 4
                               ((void *)0)
        
# 304 "../crypto/x509/x509_cmp.c"
       && EVP_Digest(x->canon_enc, x->canon_enclen, md, 
# 304 "../crypto/x509/x509_cmp.c" 3 4
                                                        ((void *)0)
# 304 "../crypto/x509/x509_cmp.c"
                                                            , sha1, 
# 304 "../crypto/x509/x509_cmp.c" 3 4
...
# 304 "../crypto/x509/x509_cmp.c"
        ...
        if (ok != 
# 308 "../crypto/x509/x509_cmp.c" 3 4
                 ((void *)0)
# 308 "../crypto/x509/x509_cmp.c"
                     )
            *ok = 1;
    }
    EVP_MD_free(sha1);
...
unsigned long X509_NAME_hash_old(const X509_NAME *x)
{
    EVP_MD *md5 = EVP_MD_fetch(
# 322 "../crypto/x509/x509_cmp.c" 3 4
                              ((void *)0)
# 322 "../crypto/x509/x509_cmp.c"
                                  , "MD5", "-fips");
    ...
    if (md5 == 
# 327 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0) 
# 327 "../crypto/x509/x509_cmp.c"
                   || md_ctx == 
# 327 "../crypto/x509/x509_cmp.c" 3 4
                                ((void *)0)
# 327 "../crypto/x509/x509_cmp.c"
    ...
    if (i2d_X509_NAME(x, 
# 331 "../crypto/x509/x509_cmp.c" 3 4
                        ((void *)0)
# 331 "../crypto/x509/x509_cmp.c"
                            ) < 0)
        goto end;

    if (EVP_DigestInit_ex(md_ctx, md5, 
# 334 "../crypto/x509/x509_cmp.c" 3 4
                                      ((void *)0)
# 334 "../crypto/x509/x509_cmp.c"
                                          )
        && EVP_DigestUpdate(md_ctx, x->bytes->data, x->bytes->length)
        && EVP_DigestFinal_ex(md_ctx, md, 
# 336 "../crypto/x509/x509_cmp.c" 3 4
                                         ((void *)0)
# 336 "../crypto/x509/x509_cmp.c"
                                             ))
        ret = (((unsigned long)md[0]) | ((unsigned long)md[1] << 8L) |
               ((unsigned long)md[2] << 16L) | ((unsigned long)md[3] << 24L)
            ) & 0xffffffffL;
                                     ...
                                     const ASN1_INTEGER *serial)
{
    int i;
    X509 x, *x509 = 
# 354 "../crypto/x509/x509_cmp.c" 3 4
                   ((void *)0)
# 354 "../crypto/x509/x509_cmp.c"
                       ;

    if (!sk)
        return 
# 357 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 357 "../crypto/x509/x509_cmp.c"
                  ;

    x.cert_info.serialNumber = *serial;
    x.cert_info.issuer = (X509_NAME *)name;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk)); i++) {
        x509 = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sk), (i)));
        if (X509_issuer_and_serial_cmp(x509, &x) == 0)
            return x509;
    }
    return 
# 367 "../crypto/x509/x509_cmp.c" 3 4
          ((void *)0)
...
X509 *X509_find_by_subject(struct stack_st_X509 *sk, const X509_NAME *name)
{
    ...
    return 
# 380 "../crypto/x509/x509_cmp.c" 3 4
          ((void *)0)
# 380 "../crypto/x509/x509_cmp.c"
              ;
}
...
{
    if (x == 
# 385 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 385 "../crypto/x509/x509_cmp.c"
                )
        return 
# 386 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 386 "../crypto/x509/x509_cmp.c"
                  ;
...
{
    if (x == 
# 392 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 392 "../crypto/x509/x509_cmp.c"
                )
        return 
# 393 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 393 "../crypto/x509/x509_cmp.c"
                  ;
...
int X509_check_private_key(const X509 *cert, const EVP_PKEY *pkey)
{
    ...
    if (xk == 
# 401 "../crypto/x509/x509_cmp.c" 3 4
             ((void *)0)
# 401 "../crypto/x509/x509_cmp.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",402,__func__), ERR_set_error)((11),(108),
# 402 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 402 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
...
{
    if (x == 
# 410 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 410 "../crypto/x509/x509_cmp.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",411,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 411 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 411 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    }
    ...
    case 1:
        return 1;
    case 0:
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",418,__func__), ERR_set_error)((11),(116),
# 418 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 418 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    case -1:
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",421,__func__), ERR_set_error)((11),(115),
# 421 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 421 "../crypto/x509/x509_cmp.c"
       );
        return 0;
    case -2:
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_cmp.c",424,__func__), ERR_set_error)((11),(117),
# 424 "../crypto/x509/x509_cmp.c" 3 4
       ((void *)0)
# 424 "../crypto/x509/x509_cmp.c"
       );
...
static int check_suite_b(EVP_PKEY *pkey, int sign_nid, unsigned long *pflags)
{
    ...
    if (pkey == 
# 445 "../crypto/x509/x509_cmp.c" 3 4
               ((void *)0) 
# 445 "../crypto/x509/x509_cmp.c"
                            ...
                            unsigned long flags)
{
    ...
    if (x == 
# 486 "../crypto/x509/x509_cmp.c" 3 4
            ((void *)0)
# 486 "../crypto/x509/x509_cmp.c"
                ) {
        x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (0)));
        i = 1;
    } else {
        i = 0;
    }
    ...
    if (chain == 
# 500 "../crypto/x509/x509_cmp.c" 3 4
                ((void *)0)
# 500 "../crypto/x509/x509_cmp.c"
                    )
    ...
    for (; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)); i++) {
...
# 578 "../crypto/x509/x509_cmp.c"
struct stack_st_X509 *X509_chain_up_ref(struct stack_st_X509 *chain)
{
    struct stack_st_X509 *ret = ((struct stack_st_X509 *)OPENSSL_sk_dup(ossl_check_const_X509_sk_type(chain)));
    int i;

    if (ret == 
# 583 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 583 "../crypto/x509/x509_cmp.c"
                  )
        return 
# 584 "../crypto/x509/x509_cmp.c" 3 4
              ((void *)0)
# 584 "../crypto/x509/x509_cmp.c"
                  ;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ret)); i++) {
        X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ret), (i)));
 ...
 err:
    while (i-- > 0)
        X509_free(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ret), (i))));
    OPENSSL_sk_free(ossl_check_X509_sk_type(ret));
    return 
# 597 "../crypto/x509/x509_cmp.c" 3 4
          ((void *)0)
# 597 "../crypto/x509/x509_cmp.c"
              ;
}
