# 0 "../crypto/x509/v3_bcons.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_bcons.c"
# 10 "../crypto/x509/v3_bcons.c"
...
# 34 "../crypto/x509/v3_bcons.c" 3 4
   ((void *)0)
# 34 "../crypto/x509/v3_bcons.c"
       , 
# 34 "../crypto/x509/v3_bcons.c" 3 4
         ((void *)0)
# 34 "../crypto/x509/v3_bcons.c"
...
# 35 "../crypto/x509/v3_bcons.c" 3 4
   ((void *)0)

# 36 "../crypto/x509/v3_bcons.c"
};

static const ASN1_TEMPLATE BASIC_CONSTRAINTS_seq_tt[] = {
        { ((0x1)), (0), 
# 39 "../crypto/x509/v3_bcons.c" 3 4
       __builtin_offsetof (
# 39 "../crypto/x509/v3_bcons.c"
       BASIC_CONSTRAINTS
# 39 "../crypto/x509/v3_bcons.c" 3 4
       , 
# 39 "../crypto/x509/v3_bcons.c"
...
# 39 "../crypto/x509/v3_bcons.c"
       , "ca", (ASN1_FBOOLEAN_it) },
        { ((0x1)), (0), 
# 40 "../crypto/x509/v3_bcons.c" 3 4
       __builtin_offsetof (
# 40 "../crypto/x509/v3_bcons.c"
       BASIC_CONSTRAINTS
# 40 "../crypto/x509/v3_bcons.c" 3 4
       , 
# 40 "../crypto/x509/v3_bcons.c"
...
# 40 "../crypto/x509/v3_bcons.c"
       , "pathlen", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * BASIC_CONSTRAINTS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, BASIC_CONSTRAINTS_seq_tt, sizeof(BASIC_CONSTRAINTS_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 41 "../crypto/x509/v3_bcons.c" 3 4
 ((void *)0)
# 41 "../crypto/x509/v3_bcons.c"
 , sizeof(BASIC_CONSTRAINTS), "BASIC_CONSTRAINTS" }; return &local_it; }

BASIC_CONSTRAINTS *d2i_BASIC_CONSTRAINTS(BASIC_CONSTRAINTS **a, const unsigned char **in, long len) { return (BASIC_CONSTRAINTS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (BASIC_CONSTRAINTS_it())); } int i2d_BASIC_CONSTRAINTS(const BASIC_CONSTRAINTS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (BASIC_CONSTRAINTS_it())); } BASIC_CONSTRAINTS *BASIC_CONSTRAINTS_new(void) { return (BASIC_CONSTRAINTS *)ASN1_item_new((BASIC_CONSTRAINTS_it())); } void BASIC_CONSTRAINTS_free(BASIC_CONSTRAINTS *a) { ASN1_item_free((ASN1_VALUE *)a, (BASIC_CONSTRAINTS_it())); }
...
{
    BASIC_CONSTRAINTS *bcons = 
# 59 "../crypto/x509/v3_bcons.c" 3 4
                              ((void *)0)
# 59 "../crypto/x509/v3_bcons.c"
                                  ;
    CONF_VALUE *val;
    int i;

    if ((bcons = BASIC_CONSTRAINTS_new()) == 
# 63 "../crypto/x509/v3_bcons.c" 3 4
                                            ((void *)0)
# 63 "../crypto/x509/v3_bcons.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_bcons.c",64,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 64 "../crypto/x509/v3_bcons.c" 3 4
       ((void *)0)
# 64 "../crypto/x509/v3_bcons.c"
       );
        return 
# 65 "../crypto/x509/v3_bcons.c" 3 4
              ((void *)0)
# 65 "../crypto/x509/v3_bcons.c"
                  ;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(values)); i++) {
        val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(values), (i)));
        if (strcmp(val->name, "CA") == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_bcons.c",76,__func__), ERR_set_error)((34),(106),
# 76 "../crypto/x509/v3_bcons.c" 3 4
           ((void *)0)
# 76 "../crypto/x509/v3_bcons.c"
           );
 ...
 err:
    ...
    return 
# 84 "../crypto/x509/v3_bcons.c" 3 4
          ((void *)0)
# 84 "../crypto/x509/v3_bcons.c"
              ;
}
