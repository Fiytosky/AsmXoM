# 0 "../crypto/x509/v3_purp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_purp.c"
# 10 "../crypto/x509/v3_purp.c"
...
# 47 "../crypto/x509/v3_purp.c" 3 4
                                                         ((void *)0)
# 47 "../crypto/x509/v3_purp.c"
                                                             },
    {2, 3, 0,
     check_purpose_ssl_server, "SSL server", "sslserver", 
# 49 "../crypto/x509/v3_purp.c" 3 4
                                                         ((void *)0)
# 49 "../crypto/x509/v3_purp.c"
                                                             },
    {3, 3, 0,
     check_purpose_ns_ssl_server, "Netscape SSL server", "nssslserver", 
# 51 "../crypto/x509/v3_purp.c" 3 4
                                                                       ((void *)0)
# 51 "../crypto/x509/v3_purp.c"
                                                                           },
    {4, 4, 0, check_purpose_smime_sign,
     "S/MIME signing", "smimesign", 
# 53 "../crypto/x509/v3_purp.c" 3 4
                                   ((void *)0)
# 53 "../crypto/x509/v3_purp.c"
                                       },
    {5, 4, 0,
     check_purpose_smime_encrypt, "S/MIME encryption", "smimeencrypt", 
# 55 "../crypto/x509/v3_purp.c" 3 4
                                                                      ((void *)0)
# 55 "../crypto/x509/v3_purp.c"
                                                                          },
    {6, 1, 0, check_purpose_crl_sign,
     "CRL signing", "crlsign", 
# 57 "../crypto/x509/v3_purp.c" 3 4
                              ((void *)0)
# 57 "../crypto/x509/v3_purp.c"
                                  },
    {7, 0, 0, no_check_purpose,
     "Any Purpose", "any",
     
# 60 "../crypto/x509/v3_purp.c" 3 4
    ((void *)0)
# 60 "../crypto/x509/v3_purp.c"
        },
    {8, 1, 0, check_purpose_ocsp_helper,
     "OCSP helper", "ocsphelper", 
# 62 "../crypto/x509/v3_purp.c" 3 4
                                 ((void *)0)
# 62 "../crypto/x509/v3_purp.c"
                                     },
    {9, 8, 0,
     check_purpose_timestamp_sign, "Time Stamp signing", "timestampsign",
     
# 65 "../crypto/x509/v3_purp.c" 3 4
    ((void *)0)
# 65 "../crypto/x509/v3_purp.c"
        },
    {10, 5, 0,
     check_purpose_code_sign, "Code signing", "codesign",
     
# 68 "../crypto/x509/v3_purp.c" 3 4
    ((void *)0)
# 68 "../crypto/x509/v3_purp.c"
        },
};
...
# 73 "../crypto/x509/v3_purp.c" 3 4
                                        ((void *)0)
# 73 "../crypto/x509/v3_purp.c"
                                            ;
...
int X509_PURPOSE_set(int *p, int purpose)
{
    if (X509_PURPOSE_get_by_id(purpose) == -1) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",106,__func__), ERR_set_error)((34),(146),
# 106 "../crypto/x509/v3_purp.c" 3 4
       ((void *)0)
# 106 "../crypto/x509/v3_purp.c"
       );
        return 0;
    }
    *p = purpose;
...
{
    if (!xptable)
        return (sizeof(xstandard)/sizeof((xstandard)[0]));
    return OPENSSL_sk_num(ossl_check_const_X509_PURPOSE_sk_type(xptable)) + (sizeof(xstandard)/sizeof((xstandard)[0]));
}
...
X509_PURPOSE *X509_PURPOSE_get0(int idx)
{
    if (idx < 0)
        return 
# 123 "../crypto/x509/v3_purp.c" 3 4
              ((void *)0)
# 123 "../crypto/x509/v3_purp.c"
                  ;
    if (idx < (int)(sizeof(xstandard)/sizeof((xstandard)[0])))
        return xstandard + idx;
    return ((X509_PURPOSE *)OPENSSL_sk_value(ossl_check_const_X509_PURPOSE_sk_type(xptable), (idx - (sizeof(xstandard)/sizeof((xstandard)[0])))));
}
...
int X509_PURPOSE_get_by_id(int purpose)
{
    ...
    if (purpose >= 1 && purpose <= 10)
        return purpose - 1;
    if (xptable == 
# 150 "../crypto/x509/v3_purp.c" 3 4
                  ((void *)0)
# 150 "../crypto/x509/v3_purp.c"
                      )
        return -1;
    tmp.purpose = purpose;
    idx = OPENSSL_sk_find(ossl_check_X509_PURPOSE_sk_type(xptable), ossl_check_X509_PURPOSE_type(&tmp));
    if (idx < 0)
        return -1;
    return idx + (sizeof(xstandard)/sizeof((xstandard)[0]));
}
                     ...
                     const char *name, const char *sname, void *arg)
{
    ...
    if (idx == -1) {
        if ((ptmp = CRYPTO_malloc(sizeof(*ptmp), "../crypto/x509/v3_purp.c", 174)) == 
# 174 "../crypto/x509/v3_purp.c" 3 4
                                                     ((void *)0)
# 174 "../crypto/x509/v3_purp.c"
                                                         )
            return 0;
        ptmp->flags = 0x1;
    } else {
    ...
    if ((ptmp->flags & 0x2) != 0) {
        CRYPTO_free(ptmp->name, "../crypto/x509/v3_purp.c", 183);
        CRYPTO_free(ptmp->sname, "../crypto/x509/v3_purp.c", 184);
    }

    ptmp->name = CRYPTO_strdup(name, "../crypto/x509/v3_purp.c", 187);
    ptmp->sname = CRYPTO_strdup(sname, "../crypto/x509/v3_purp.c", 188);
    if (ptmp->name == 
# 189 "../crypto/x509/v3_purp.c" 3 4
                     ((void *)0) 
# 189 "../crypto/x509/v3_purp.c"
                          || ptmp->sname == 
# 189 "../crypto/x509/v3_purp.c" 3 4
                                            ((void *)0)
# 189 "../crypto/x509/v3_purp.c"
    ...
    if (idx == -1) {
        if (xptable == 
# 203 "../crypto/x509/v3_purp.c" 3 4
                      ((void *)0)
            
# 204 "../crypto/x509/v3_purp.c"
           && (xptable = ((struct stack_st_X509_PURPOSE *)OPENSSL_sk_new(ossl_check_X509_PURPOSE_compfunc_type(xp_cmp)))) == 
# 204 "../crypto/x509/v3_purp.c" 3 4
                                                         ((void *)0)
# 204 "../crypto/x509/v3_purp.c"
                                                             ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",205,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 205 "../crypto/x509/v3_purp.c" 3 4
           ((void *)0)
# 205 "../crypto/x509/v3_purp.c"
           );
            goto err;
        }
        if (!OPENSSL_sk_push(ossl_check_X509_PURPOSE_sk_type(xptable), ossl_check_X509_PURPOSE_type(ptmp))) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",209,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 209 "../crypto/x509/v3_purp.c" 3 4
           ((void *)0)
# 209 "../crypto/x509/v3_purp.c"
           );
            goto err;
        }
    }
 ...
 err:
    if (idx == -1) {
        CRYPTO_free(ptmp->name, "../crypto/x509/v3_purp.c", 216);
        CRYPTO_free(ptmp->sname, "../crypto/x509/v3_purp.c", 217);
        CRYPTO_free(ptmp, "../crypto/x509/v3_purp.c", 218);
    }
    return 0;
}
...
{
    if (p == 
# 225 "../crypto/x509/v3_purp.c" 3 4
            ((void *)0)
# 225 "../crypto/x509/v3_purp.c"
                )
        return;
    if ((p->flags & 0x1) != 0) {
        if ((p->flags & 0x2) != 0) {
            CRYPTO_free(p->name, "../crypto/x509/v3_purp.c", 229);
            CRYPTO_free(p->sname, "../crypto/x509/v3_purp.c", 230);
        }
        CRYPTO_free(p, "../crypto/x509/v3_purp.c", 232);
    }
}

void X509_PURPOSE_cleanup(void)
{
    OPENSSL_sk_pop_free(ossl_check_X509_PURPOSE_sk_type(xptable),ossl_check_X509_PURPOSE_freefunc_type(xptable_free));
    xptable = 
# 239 "../crypto/x509/v3_purp.c" 3 4
             ((void *)0)
# 239 "../crypto/x509/v3_purp.c"
                 ;
}
...
int X509_supported_extension(X509_EXTENSION *ex)
{
    ...
    if (OBJ_bsearch_nid(&ex_nid, supported_nids, (sizeof(supported_nids)/sizeof((supported_nids)[0]))))
        return 1;
    return 0;
}
...
# 312 "../crypto/x509/v3_purp.c" 3 4
                            ((void *)0)
# 312 "../crypto/x509/v3_purp.c"
                                ;
    int i;

    if (dp->distpoint == 
# 315 "../crypto/x509/v3_purp.c" 3 4
                        ((void *)0) 
# 315 "../crypto/x509/v3_purp.c"
                             && OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(dp->CRLissuer)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",316,__func__), ERR_set_error)((11),(143),
# 316 "../crypto/x509/v3_purp.c" 3 4
       ((void *)0)
# 316 "../crypto/x509/v3_purp.c"
       );
        return 0;
    }
    if (dp->reasons != 
# 319 "../crypto/x509/v3_purp.c" 3 4
                      ((void *)0)
# 319 "../crypto/x509/v3_purp.c"
                          ) {
    ...
    if (dp->distpoint == 
# 328 "../crypto/x509/v3_purp.c" 3 4
                        ((void *)0) 
# 328 "../crypto/x509/v3_purp.c"
                             || dp->distpoint->type != 1)
        return 1;
# 338 "../crypto/x509/v3_purp.c"
    ...
    if (iname == 
# 346 "../crypto/x509/v3_purp.c" 3 4
                ((void *)0)
# 346 "../crypto/x509/v3_purp.c"
                    )
...
static int setup_crldp(X509 *x)
{
    ...
    x->crldp = X509_get_ext_d2i(x, 103, &i, 
# 356 "../crypto/x509/v3_purp.c" 3 4
                                                                   ((void *)0)
# 356 "../crypto/x509/v3_purp.c"
                                                                       );
    if (x->crldp == 
# 357 "../crypto/x509/v3_purp.c" 3 4
                   ((void *)0) 
# 357 "../crypto/x509/v3_purp.c"
                        && i != -1)
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_DIST_POINT_sk_type(x->crldp)); i++) {
        int res = setup_dp(x, ((DIST_POINT *)OPENSSL_sk_value(ossl_check_const_DIST_POINT_sk_type(x->crldp), (i))));
...
static int check_sig_alg_match(const EVP_PKEY *issuer_key, const X509 *subject)
{
    ...
    if (issuer_key == 
# 374 "../crypto/x509/v3_purp.c" 3 4
                     ((void *)0)
# 374 "../crypto/x509/v3_purp.c"
                         )
        return 24;
    if (OBJ_find_sigid_algs(OBJ_obj2nid(subject->cert_info.signature.algorithm),
                            
# 377 "../crypto/x509/v3_purp.c" 3 4
                           ((void *)0)
# 377 "../crypto/x509/v3_purp.c"
                               , &subj_sig_nid) == 0)
        return 76;
    if (EVP_PKEY_is_a(issuer_key, OBJ_nid2sn(subj_sig_nid))
        || (EVP_PKEY_is_a(issuer_key, "RSA") && subj_sig_nid == 912))
        return 0;
    return 77;
}
# 400 "../crypto/x509/v3_purp.c"
int ossl_x509v3_cache_extensions(X509 *x)
{
    ...
    if (
# 412 "../crypto/x509/v3_purp.c" 3 4
       __extension__ ({ __auto_type __atomic_load_ptr = (
# 412 "../crypto/x509/v3_purp.c"
       ((_Atomic int *)&x->ex_cached)
# 412 "../crypto/x509/v3_purp.c" 3 4
       ); __typeof__ ((void)0, *__atomic_load_ptr) __atomic_load_tmp; __atomic_load (__atomic_load_ptr, &__atomic_load_tmp, (
# 412 "../crypto/x509/v3_purp.c"
       memory_order_acquire
...
# 412 "../crypto/x509/v3_purp.c"
    ...
    if (!X509_digest(x, EVP_sha1(), x->sha1_hash, 
# 426 "../crypto/x509/v3_purp.c" 3 4
                                                 ((void *)0)
# 426 "../crypto/x509/v3_purp.c"
                                                     ))
        x->ex_flags |= 0x100000;
    ...
    x->ex_pathlen = -1;
    if ((bs = X509_get_ext_d2i(x, 87, &i, 
# 435 "../crypto/x509/v3_purp.c" 3 4
                                                            ((void *)0)
# 435 "../crypto/x509/v3_purp.c"
                                                                )) != 
# 435 "../crypto/x509/v3_purp.c" 3 4
                                                                      ((void *)0)
# 435 "../crypto/x509/v3_purp.c"
        ...
        if (bs->ca)
            x->ex_flags |= 0x10;
        if (bs->pathlen != 
# 438 "../crypto/x509/v3_purp.c" 3 4
                          ((void *)0)
# 438 "../crypto/x509/v3_purp.c"
                              ) {
            ...
            if (bs->pathlen->type == (2 | 0x100)) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",444,__func__), ERR_set_error)((34),(168),
# 444 "../crypto/x509/v3_purp.c" 3 4
               ((void *)0)
# 444 "../crypto/x509/v3_purp.c"
               );
                x->ex_flags |= 0x80;
            } else {
    ...
    if ((pci = X509_get_ext_d2i(x, 663, &i, 
# 457 "../crypto/x509/v3_purp.c" 3 4
                                                         ((void *)0)
# 457 "../crypto/x509/v3_purp.c"
                                                             )) != 
# 457 "../crypto/x509/v3_purp.c" 3 4
                                                                   ((void *)0)
# 457 "../crypto/x509/v3_purp.c"
...
# 463 "../crypto/x509/v3_purp.c" 3 4
                                          ((void *)0)
# 463 "../crypto/x509/v3_purp.c"
                                              )
    ...
    if ((usage = X509_get_ext_d2i(x, 83, &i, 
# 474 "../crypto/x509/v3_purp.c" 3 4
                                                       ((void *)0)
# 474 "../crypto/x509/v3_purp.c"
                                                           )) != 
# 474 "../crypto/x509/v3_purp.c" 3 4
                                                                 ((void *)0)
# 474 "../crypto/x509/v3_purp.c"
        ...
        if (x->ex_kusage == 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",485,__func__), ERR_set_error)((34),(169),
# 485 "../crypto/x509/v3_purp.c" 3 4
           ((void *)0)
# 485 "../crypto/x509/v3_purp.c"
           );
            x->ex_flags |= 0x80;
        }
    } else if (i != -1) {
    ...
    x->ex_xkusage = 0;
    if ((extusage = X509_get_ext_d2i(x, 126, &i, 
# 494 "../crypto/x509/v3_purp.c" 3 4
                                                              ((void *)0)
# 494 "../crypto/x509/v3_purp.c"
                                                                  )) != 
# 494 "../crypto/x509/v3_purp.c" 3 4
                                                                        ((void *)0)
# 494 "../crypto/x509/v3_purp.c"
        ...
        x->ex_flags |= 0x4;
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(extusage)); i++) {
            switch (OBJ_obj2nid(((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(extusage), (i))))) {
            case 129:
                x->ex_xkusage |= 0x1;
                break;
            case 130:
        ...
        OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(extusage),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    } else if (i != -1) {
        x->ex_flags |= 0x80;
    }


    if ((ns = X509_get_ext_d2i(x, 71, &i, 
# 537 "../crypto/x509/v3_purp.c" 3 4
                                                             ((void *)0)
# 537 "../crypto/x509/v3_purp.c"
                                                                 )) != 
# 537 "../crypto/x509/v3_purp.c" 3 4
                                                                       ((void *)0)
# 537 "../crypto/x509/v3_purp.c"
    ...
    x->skid = X509_get_ext_d2i(x, 82, &i, 
# 549 "../crypto/x509/v3_purp.c" 3 4
                                                                 ((void *)0)
# 549 "../crypto/x509/v3_purp.c"
                                                                     );
    if (x->skid == 
# 550 "../crypto/x509/v3_purp.c" 3 4
                  ((void *)0) 
# 550 "../crypto/x509/v3_purp.c"
                       && i != -1)
        x->ex_flags |= 0x80;

    x->akid = X509_get_ext_d2i(x, 90, &i, 
# 553 "../crypto/x509/v3_purp.c" 3 4
                                                                   ((void *)0)
# 553 "../crypto/x509/v3_purp.c"
                                                                       );
    if (x->akid == 
# 554 "../crypto/x509/v3_purp.c" 3 4
                  ((void *)0) 
# 554 "../crypto/x509/v3_purp.c"
                       && i != -1)
        x->ex_flags |= 0x80;
    ...
    if (X509_NAME_cmp(X509_get_subject_name(x), X509_get_issuer_name(x)) == 0) {
        x->ex_flags |= 0x20;
        if (X509_check_akid(x, x->akid) == 0

                && check_sig_alg_match(X509_get0_pubkey(x), x) == 0)
            x->ex_flags |= 0x2000;

    }


    x->altname = X509_get_ext_d2i(x, 85, &i, 
# 568 "../crypto/x509/v3_purp.c" 3 4
                                                              ((void *)0)
# 568 "../crypto/x509/v3_purp.c"
                                                                  );
    if (x->altname == 
# 569 "../crypto/x509/v3_purp.c" 3 4
                     ((void *)0) 
# 569 "../crypto/x509/v3_purp.c"
                          && i != -1)
        x->ex_flags |= 0x80;
    x->nc = X509_get_ext_d2i(x, 666, &i, 
# 571 "../crypto/x509/v3_purp.c" 3 4
                                                         ((void *)0)
# 571 "../crypto/x509/v3_purp.c"
                                                             );
    if (x->nc == 
# 572 "../crypto/x509/v3_purp.c" 3 4
                ((void *)0) 
# 572 "../crypto/x509/v3_purp.c"
                     && i != -1)
        x->ex_flags |= 0x80;
    ...
    x->rfc3779_addr = X509_get_ext_d2i(x, 290, &i, 
# 581 "../crypto/x509/v3_purp.c" 3 4
                                                                   ((void *)0)
# 581 "../crypto/x509/v3_purp.c"
                                                                       );
    if (x->rfc3779_addr == 
# 582 "../crypto/x509/v3_purp.c" 3 4
                          ((void *)0) 
# 582 "../crypto/x509/v3_purp.c"
                               && i != -1)
        x->ex_flags |= 0x80;
    x->rfc3779_asid = X509_get_ext_d2i(x, 291, &i, 
# 584 "../crypto/x509/v3_purp.c" 3 4
                                                                        ((void *)0)
# 584 "../crypto/x509/v3_purp.c"
                                                                            );
    if (x->rfc3779_asid == 
# 585 "../crypto/x509/v3_purp.c" 3 4
                          ((void *)0) 
# 585 "../crypto/x509/v3_purp.c"
                               && i != -1)
        x->ex_flags |= 0x80;
...
# 623 "../crypto/x509/v3_purp.c" 3 4
   __extension__ ({ __auto_type __atomic_store_ptr = (
# 623 "../crypto/x509/v3_purp.c"
   ((_Atomic int *)&x->ex_cached)
# 623 "../crypto/x509/v3_purp.c" 3 4
...
# 623 "../crypto/x509/v3_purp.c"
    ...
    if ((x->ex_flags & 0x80) == 0) {
        CRYPTO_THREAD_unlock(x->lock);
        return 1;
    }
    CRYPTO_THREAD_unlock(x->lock);
    (ERR_new(), ERR_set_debug("../crypto/x509/v3_purp.c",637,__func__), ERR_set_error)((34),(158),
# 637 "../crypto/x509/v3_purp.c" 3 4
   ((void *)0)
# 637 "../crypto/x509/v3_purp.c"
   );
    return 0;
}
# 653 "../crypto/x509/v3_purp.c"
static int check_ca(const X509 *x)
{

    if ((((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0004)) == 0))
        return 0;
    if ((x->ex_flags & 0x1) != 0) {

        return (x->ex_flags & 0x10) != 0;
    } else {

        if ((x->ex_flags & (0x40 | 0x2000)) == (0x40 | 0x2000))
            return 3;



        else if ((x->ex_flags & 0x2) != 0)
            return 4;

        else if ((x->ex_flags & 0x8) != 0
                 && (x->ex_nscert & (0x04|0x02|0x01)) != 0)
            return 5;
...
static int check_ssl_ca(const X509 *x)
{
    ...
    return ca_ret != 5 || (x->ex_nscert & 0x04) != 0;
}

static int check_purpose_ssl_client(const X509_PURPOSE *xp, const X509 *x,
                                    int non_leaf)
{
    if ((((x)->ex_flags & 0x4) != 0 && ((x)->ex_xkusage & (0x2)) == 0))
        return 0;
    if (non_leaf)
        return check_ssl_ca(x);

    if ((((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0080 | 0x0008)) == 0))
        return 0;

    if ((((x)->ex_flags & 0x8) != 0 && ((x)->ex_nscert & (0x80)) == 0))
        return 0;
    return 1;
}
# 736 "../crypto/x509/v3_purp.c"
static int check_purpose_ssl_server(const X509_PURPOSE *xp, const X509 *x,
                                    int non_leaf)
{
    if ((((x)->ex_flags & 0x4) != 0 && ((x)->ex_xkusage & (0x1 | 0x10)) == 0))
        return 0;
    if (non_leaf)
        return check_ssl_ca(x);

    if ((((x)->ex_flags & 0x8) != 0 && ((x)->ex_nscert & (0x40)) == 0))
        return 0;
    if ((((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0080 | 0x0020 | 0x0008)) == 0))
        return 0;
                                       ...
                                       int non_leaf)
{
    ...
    return (((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0020)) == 0) ? 0 : ret;
}


static int purpose_smime(const X509 *x, int non_leaf)
{
    if ((((x)->ex_flags & 0x4) != 0 && ((x)->ex_xkusage & (0x4)) == 0))
        return 0;
    if (non_leaf) {
        int ca_ret = check_ca(x);
        ...
        if (ca_ret != 5 || (x->ex_nscert & 0x02) != 0)
            return ca_ret;
        else
            return 0;
    }
    if ((x->ex_flags & 0x8) != 0) {
        if ((x->ex_nscert & 0x20) != 0)
            return 1;

        return (x->ex_nscert & 0x80) != 0 ? 2 : 0;
    }
    return 1;
}
                                    ...
                                    int non_leaf)
{
    ...
    if (!ret || non_leaf)
        return ret;
    return (((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0080 | 0x0040)) == 0) ? 0 : ret;
}
                                  ...
                                  int non_leaf)
{
    ...
    return !(((x)->ex_flags & 0x2) != 0 && ((x)->ex_kusage & (0x0002)) == 0);
}
...
# 863 "../crypto/x509/v3_purp.c"
    ...
    if ((x->ex_flags & 0x4) == 0 || x->ex_xkusage != 0x40)
        return 0;


    i_ext = X509_get_ext_by_NID(x, 126, -1);
    if (i_ext >= 0
                                   ...
                                   int non_leaf)
{
    ...
    if (non_leaf)
        return check_ca(x);
# 905 "../crypto/x509/v3_purp.c"
    if ((x->ex_flags & 0x2) == 0)
        return 0;
    if ((x->ex_kusage & 0x0080) == 0)
        return 0;
    if ((x->ex_kusage & (0x0004 | 0x0002)) != 0)
        return 0;


    i_ext = X509_get_ext_by_NID(x, 83, -1);
    if (i_ext < 0)
        return 0;
    if (i_ext >= 0) {
    ...
    if ((x->ex_flags & 0x4) == 0)
        return 0;
    if ((x->ex_xkusage & 0x8) == 0)
        return 0;
    if ((x->ex_xkusage & (0x100 | 0x1)) != 0)
        return 0;
...
# 953 "../crypto/x509/v3_purp.c"
int X509_check_issued(X509 *issuer, X509 *subject)
{
    int ret;

    if ((ret = ossl_x509_likely_issued(issuer, subject)) != 0)
        return ret;
...
# 991 "../crypto/x509/v3_purp.c"
int ossl_x509_signing_allowed(const X509 *issuer, const X509 *subject)
{
    if ((subject->ex_flags & 0x400) != 0) {
        if ((((issuer)->ex_flags & 0x2) != 0 && ((issuer)->ex_kusage & (0x0080)) == 0))
            return 39;
    } else if ((((issuer)->ex_flags & 0x2) != 0 && ((issuer)->ex_kusage & (0x0004)) == 0)) {
        return 32;
    }
    return 0;
}
...
{
    if (akid == 
# 1004 "../crypto/x509/v3_purp.c" 3 4
               ((void *)0)
# 1004 "../crypto/x509/v3_purp.c"
                   )
        return 0;
    ...
    if (akid->issuer) {
        ...
        GENERAL_NAME *gen;
        X509_NAME *nm = 
# 1024 "../crypto/x509/v3_purp.c" 3 4
                       ((void *)0)
# 1024 "../crypto/x509/v3_purp.c"
                           ;
        int i;
        ...
        if (nm != 
# 1034 "../crypto/x509/v3_purp.c" 3 4
                 ((void *)0) 
# 1034 "../crypto/x509/v3_purp.c"
...
uint32_t X509_get_key_usage(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 0;
    return (x->ex_flags & 0x2) != 0 ? x->ex_kusage : 
# 1052 "../crypto/x509/v3_purp.c" 3 4
                                                              (4294967295U)
# 1052 "../crypto/x509/v3_purp.c"
                                                                        ;
}
...
uint32_t X509_get_extended_key_usage(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 0;
    return (x->ex_flags & 0x4) != 0 ? x->ex_xkusage : 
# 1060 "../crypto/x509/v3_purp.c" 3 4
                                                                (4294967295U)
# 1060 "../crypto/x509/v3_purp.c"
                                                                          ;
}
...
const ASN1_OCTET_STRING *X509_get0_subject_key_id(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 
# 1067 "../crypto/x509/v3_purp.c" 3 4
              ((void *)0)
# 1067 "../crypto/x509/v3_purp.c"
                  ;
    return x->skid;
}
...
const ASN1_OCTET_STRING *X509_get0_authority_key_id(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 
# 1075 "../crypto/x509/v3_purp.c" 3 4
              ((void *)0)
# 1075 "../crypto/x509/v3_purp.c"
                  ;
    return (x->akid != 
# 1076 "../crypto/x509/v3_purp.c" 3 4
                      ((void *)0) 
# 1076 "../crypto/x509/v3_purp.c"
                           ? x->akid->keyid : 
# 1076 "../crypto/x509/v3_purp.c" 3 4
                                              ((void *)0)
# 1076 "../crypto/x509/v3_purp.c"
...
const GENERAL_NAMES *X509_get0_authority_issuer(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 
# 1083 "../crypto/x509/v3_purp.c" 3 4
              ((void *)0)
# 1083 "../crypto/x509/v3_purp.c"
                  ;
    return (x->akid != 
# 1084 "../crypto/x509/v3_purp.c" 3 4
                      ((void *)0) 
# 1084 "../crypto/x509/v3_purp.c"
                           ? x->akid->issuer : 
# 1084 "../crypto/x509/v3_purp.c" 3 4
                                               ((void *)0)
# 1084 "../crypto/x509/v3_purp.c"
...
const ASN1_INTEGER *X509_get0_authority_serial(X509 *x)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 
# 1091 "../crypto/x509/v3_purp.c" 3 4
              ((void *)0)
# 1091 "../crypto/x509/v3_purp.c"
                  ;
    return (x->akid != 
# 1092 "../crypto/x509/v3_purp.c" 3 4
                      ((void *)0) 
# 1092 "../crypto/x509/v3_purp.c"
                           ? x->akid->serial : 
# 1092 "../crypto/x509/v3_purp.c" 3 4
                                               ((void *)0)
# 1092 "../crypto/x509/v3_purp.c"
