# 0 "../crypto/x509/x_exten.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_exten.c"
# 10 "../crypto/x509/x_exten.c"
...
# 15 "../crypto/x509/x_exten.c" 2

static const ASN1_TEMPLATE X509_EXTENSION_seq_tt[] = {
        { (0), (0), 
# 17 "../crypto/x509/x_exten.c" 3 4
       __builtin_offsetof (
# 17 "../crypto/x509/x_exten.c"
       X509_EXTENSION
# 17 "../crypto/x509/x_exten.c" 3 4
       , 
# 17 "../crypto/x509/x_exten.c"
...
# 17 "../crypto/x509/x_exten.c"
       , "object", (ASN1_OBJECT_it) },
        { ((0x1)), (0), 
# 18 "../crypto/x509/x_exten.c" 3 4
       __builtin_offsetof (
# 18 "../crypto/x509/x_exten.c"
       X509_EXTENSION
# 18 "../crypto/x509/x_exten.c" 3 4
       , 
# 18 "../crypto/x509/x_exten.c"
...
# 18 "../crypto/x509/x_exten.c"
       , "critical", (ASN1_BOOLEAN_it) },
        { ((0x1 << 12)), (0), 
# 19 "../crypto/x509/x_exten.c" 3 4
       __builtin_offsetof (
# 19 "../crypto/x509/x_exten.c"
       X509_EXTENSION
# 19 "../crypto/x509/x_exten.c" 3 4
       , 
# 19 "../crypto/x509/x_exten.c"
...
# 19 "../crypto/x509/x_exten.c"
       , "value", (ASN1_OCTET_STRING_it) }
} ; const ASN1_ITEM * X509_EXTENSION_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_EXTENSION_seq_tt, sizeof(X509_EXTENSION_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 20 "../crypto/x509/x_exten.c" 3 4
 ((void *)0)
# 20 "../crypto/x509/x_exten.c"
 , sizeof(X509_EXTENSION), "X509_EXTENSION" }; return &local_it; }

static const ASN1_TEMPLATE X509_EXTENSIONS_item_tt =
        { ((0x2 << 1)), (0), 0, "Extension", (X509_EXTENSION_it) }
; const ASN1_ITEM * X509_EXTENSIONS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &X509_EXTENSIONS_item_tt, 0, 
# 24 "../crypto/x509/x_exten.c" 3 4
((void *)0)
# 24 "../crypto/x509/x_exten.c"
, 0, "X509_EXTENSIONS" }; return &local_it; }

X509_EXTENSION *d2i_X509_EXTENSION(X509_EXTENSION **a, const unsigned char **in, long len) { return (X509_EXTENSION *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_EXTENSION_it())); } int i2d_X509_EXTENSION(const X509_EXTENSION *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_EXTENSION_it())); } X509_EXTENSION *X509_EXTENSION_new(void) { return (X509_EXTENSION *)ASN1_item_new((X509_EXTENSION_it())); } void X509_EXTENSION_free(X509_EXTENSION *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_EXTENSION_it())); }
X509_EXTENSIONS *d2i_X509_EXTENSIONS(X509_EXTENSIONS **a, const unsigned char **in, long len) { return (X509_EXTENSIONS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_EXTENSIONS_it())); } int i2d_X509_EXTENSIONS(const X509_EXTENSIONS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_EXTENSIONS_it())); }
X509_EXTENSION * X509_EXTENSION_dup(const X509_EXTENSION *x) { return ASN1_item_dup((X509_EXTENSION_it()), x); }
