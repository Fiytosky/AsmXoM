# 0 "../crypto/x509/x509name.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509name.c"
# 10 "../crypto/x509/x509name.c"
                              ...
                              char *buf, int len)
{
    ...
    obj = OBJ_nid2obj(nid);
    if (obj == 
# 25 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 25 "../crypto/x509/x509name.c"
                  )
        return -1;
                              ...
                              char *buf, int len)
{
    ...
    if (buf == 
# 40 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 40 "../crypto/x509/x509name.c"
                  )
        return data->length;
    if (len <= 0)
        return 0;
...
int X509_NAME_entry_count(const X509_NAME *name)
{
    ...
    if (name == 
# 54 "../crypto/x509/x509name.c" 3 4
               ((void *)0)
# 54 "../crypto/x509/x509name.c"
                   )
        return 0;
    ret = OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(name->entries));
    return ret > 0 ? ret : 0;
}
...
int X509_NAME_get_index_by_NID(const X509_NAME *name, int nid, int lastpos)
{
    ...
    obj = OBJ_nid2obj(nid);
    if (obj == 
# 65 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 65 "../crypto/x509/x509name.c"
                  )
        return -2;
                               ...
                               int lastpos)
{
    ...
    if (name == 
# 78 "../crypto/x509/x509name.c" 3 4
               ((void *)0)
# 78 "../crypto/x509/x509name.c"
                   )
        return -1;
    if (lastpos < 0)
        lastpos = -1;
    sk = name->entries;
    n = OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(sk));
    for (lastpos++; lastpos < n; lastpos++) {
        ne = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (lastpos)));
...
{
    if (name == 
# 94 "../crypto/x509/x509name.c" 3 4
               ((void *)0) 
# 94 "../crypto/x509/x509name.c"
                    || OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(name->entries)) <= loc
        || loc < 0)
        return 
# 96 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 96 "../crypto/x509/x509name.c"
                  ;

    return ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(name->entries), (loc)));
}
...
X509_NAME_ENTRY *X509_NAME_delete_entry(X509_NAME *name, int loc)
{
    ...
    if (name == 
# 107 "../crypto/x509/x509name.c" 3 4
               ((void *)0) 
# 107 "../crypto/x509/x509name.c"
                    || OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(name->entries)) <= loc
        || loc < 0)
        return 
# 109 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 109 "../crypto/x509/x509name.c"
                  ;

    sk = name->entries;
    ret = ((X509_NAME_ENTRY *)OPENSSL_sk_delete(ossl_check_X509_NAME_ENTRY_sk_type(sk), (loc)));
    n = OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(sk));
    name->modified = 1;
    if (loc == n)
        return ret;
    ...
    if (loc != 0)
        set_prev = (((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (loc - 1))))->set;
    else
        set_prev = ret->set - 1;
    set_next = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (loc)))->set;
# 135 "../crypto/x509/x509name.c"
    if (set_prev + 1 < set_next)
        for (i = loc; i < n; i++)
            ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (i)))->set--;
    return ret;
}
...
# 148 "../crypto/x509/x509name.c" 3 4
                                      ((void *)0)
# 148 "../crypto/x509/x509name.c"
                                          , obj, type, bytes, len);
    if (!ne)
        return 0;
...
# 162 "../crypto/x509/x509name.c" 3 4
                                      ((void *)0)
# 162 "../crypto/x509/x509name.c"
                                          , nid, type, bytes, len);
    if (!ne)
        return 0;
    ret = X509_NAME_add_entry(name, ne, loc, set);
...
# 176 "../crypto/x509/x509name.c" 3 4
                                      ((void *)0)
# 176 "../crypto/x509/x509name.c"
...
# 191 "../crypto/x509/x509name.c" 3 4
                               ((void *)0)
# 191 "../crypto/x509/x509name.c"
                                   ;
    int n, i, inc;
    struct stack_st_X509_NAME_ENTRY *sk;

    if (name == 
# 195 "../crypto/x509/x509name.c" 3 4
               ((void *)0)
# 195 "../crypto/x509/x509name.c"
                   )
        return 0;
    sk = name->entries;
    n = OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(sk));
    ...
    if (set == -1) {
        if (loc == 0) {
            ...
            set = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (loc - 1)))->set;
        }
    } else {

        if (loc >= n) {
            if (loc != 0)
                set = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (loc - 1)))->set + 1;
            else
                set = 0;
        } else
            set = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (loc)))->set;
    }

    if ((new_name = X509_NAME_ENTRY_dup(ne)) == 
# 224 "../crypto/x509/x509name.c" 3 4
                                               ((void *)0)
# 224 "../crypto/x509/x509name.c"
                                                   )
        goto err;
    new_name->set = set;
    if (!OPENSSL_sk_insert(ossl_check_X509_NAME_ENTRY_sk_type(sk), ossl_check_X509_NAME_ENTRY_type(new_name), (loc))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509name.c",228,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 228 "../crypto/x509/x509name.c" 3 4
       ((void *)0)
# 228 "../crypto/x509/x509name.c"
       );
        goto err;
    }
    if (inc) {
        n = OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(sk));
        for (i = loc + 1; i < n; i++)
            ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(sk), (i)))->set += 1;
    }
    return 1;
 err:
                                               ...
                                               int len)
{
    ...
    if (obj == 
# 251 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 251 "../crypto/x509/x509name.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509name.c",252,__func__), ERR_set_error)(11, 119,
                       "name=%s", field);
        return 
# 254 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 254 "../crypto/x509/x509name.c"
                  ;
    }
                                               ...
                                               int len)
{
    ...
    obj = OBJ_nid2obj(nid);
    if (obj == 
# 270 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 270 "../crypto/x509/x509name.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509name.c",271,__func__), ERR_set_error)((11),(109),
# 271 "../crypto/x509/x509name.c" 3 4
       ((void *)0)
# 271 "../crypto/x509/x509name.c"
       );
        return 
# 272 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 272 "../crypto/x509/x509name.c"
                  ;
    }
    nentry = X509_NAME_ENTRY_create_by_OBJ(ne, obj, type, bytes, len);
    ASN1_OBJECT_free(obj);
                                               ...
                                               int len)
{
    ...
    if ((ne == 
# 286 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 286 "../crypto/x509/x509name.c"
                  ) || (*ne == 
# 286 "../crypto/x509/x509name.c" 3 4
                               ((void *)0)
# 286 "../crypto/x509/x509name.c"
...
# 287 "../crypto/x509/x509name.c" 3 4
                                            ((void *)0)
# 287 "../crypto/x509/x509name.c"
                                                )
            return 
# 288 "../crypto/x509/x509name.c" 3 4
                  ((void *)0)
# 288 "../crypto/x509/x509name.c"
                      ;
    } else
        ret = *ne;
    ...
    if ((ne != 
# 297 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 297 "../crypto/x509/x509name.c"
                  ) && (*ne == 
# 297 "../crypto/x509/x509name.c" 3 4
                               ((void *)0)
# 297 "../crypto/x509/x509name.c"
 ...
 err:
    if ((ne == 
# 301 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 301 "../crypto/x509/x509name.c"
                  ) || (ret != *ne))
        X509_NAME_ENTRY_free(ret);
    return 
# 303 "../crypto/x509/x509name.c" 3 4
          ((void *)0)
# 303 "../crypto/x509/x509name.c"
              ;
}
...
{
    if ((ne == 
# 308 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 308 "../crypto/x509/x509name.c"
                  ) || (obj == 
# 308 "../crypto/x509/x509name.c" 3 4
                               ((void *)0)
# 308 "../crypto/x509/x509name.c"
                                   )) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509name.c",309,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 309 "../crypto/x509/x509name.c" 3 4
       ((void *)0)
# 309 "../crypto/x509/x509name.c"
       );
        return 0;
    }
    ...
    return ((ne->object == 
# 314 "../crypto/x509/x509name.c" 3 4
                          ((void *)0)
# 314 "../crypto/x509/x509name.c"
                              ) ? 0 : 1);
}
                             ...
                             const unsigned char *bytes, int len)
{
    ...
    if ((ne == 
# 322 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 322 "../crypto/x509/x509name.c"
                  ) || ((bytes == 
# 322 "../crypto/x509/x509name.c" 3 4
                                  ((void *)0)
# 322 "../crypto/x509/x509name.c"
...
{
    if (ne == 
# 344 "../crypto/x509/x509name.c" 3 4
             ((void *)0)
# 344 "../crypto/x509/x509name.c"
                 )
        return 
# 345 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 345 "../crypto/x509/x509name.c"
                  ;
    return ne->object;
}
...
{
    if (ne == 
# 351 "../crypto/x509/x509name.c" 3 4
             ((void *)0)
# 351 "../crypto/x509/x509name.c"
                 )
        return 
# 352 "../crypto/x509/x509name.c" 3 4
              ((void *)0)
# 352 "../crypto/x509/x509name.c"
                  ;
    return ne->value;
}
