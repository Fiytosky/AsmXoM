# 0 "../crypto/x509/by_dir.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/by_dir.c"
# 19 "../crypto/x509/by_dir.c"
...
# 66 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 66 "../crypto/x509/by_dir.c"
       ,
    
# 67 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 67 "../crypto/x509/by_dir.c"
       ,
    dir_ctrl,
    get_cert_by_subject,
    
# 70 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 70 "../crypto/x509/by_dir.c"
       ,
    
# 71 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 71 "../crypto/x509/by_dir.c"
       ,
    
# 72 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 72 "../crypto/x509/by_dir.c"
       ,
    get_cert_by_subject_ex,
    
# 74 "../crypto/x509/by_dir.c" 3 4
   ((void *)0)
# 74 "../crypto/x509/by_dir.c"
       ,
};
                    ...
                    char **retp)
{
    ...
    case 2:
        if (argl == 3) {
            ...
            if (dir)
                ret = add_cert_dir(ld, dir, 1);
            else
                ret = add_cert_dir(ld, X509_get_default_cert_dir(),
                                   1);
            if (!ret) {
                (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",99,__func__), ERR_set_error)((11),(103),
# 99 "../crypto/x509/by_dir.c" 3 4
               ((void *)0)
# 99 "../crypto/x509/by_dir.c"
               );
            }
        } else
...
static int new_dir(X509_LOOKUP *lu)
{
    BY_DIR *a = CRYPTO_malloc(sizeof(*a), "../crypto/x509/by_dir.c", 110);

    if (a == 
# 112 "../crypto/x509/by_dir.c" 3 4
            ((void *)0)
# 112 "../crypto/x509/by_dir.c"
                )
        return 0;

    if ((a->buffer = BUF_MEM_new()) == 
# 115 "../crypto/x509/by_dir.c" 3 4
                                      ((void *)0)
# 115 "../crypto/x509/by_dir.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",116,__func__), ERR_set_error)((11),((3 | (0x2 << 18L))),
# 116 "../crypto/x509/by_dir.c" 3 4
       ((void *)0)
# 116 "../crypto/x509/by_dir.c"
       );
        goto err;
    }
    a->dirs = 
# 119 "../crypto/x509/by_dir.c" 3 4
             ((void *)0)
# 119 "../crypto/x509/by_dir.c"
                 ;
    a->lock = CRYPTO_THREAD_lock_new();
    if (a->lock == 
# 121 "../crypto/x509/by_dir.c" 3 4
                  ((void *)0)
# 121 "../crypto/x509/by_dir.c"
                      ) {
        BUF_MEM_free(a->buffer);
        (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",123,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 123 "../crypto/x509/by_dir.c" 3 4
       ((void *)0)
# 123 "../crypto/x509/by_dir.c"
       );
        goto err;
    }
    lu->method_data = a;
 ...
 err:
    CRYPTO_free(a, "../crypto/x509/by_dir.c", 130);
    return 0;
}

static void by_dir_hash_free(BY_DIR_HASH *hash)
{
    CRYPTO_free(hash, "../crypto/x509/by_dir.c", 136);
}
...
{
    CRYPTO_free(ent->dir, "../crypto/x509/by_dir.c", 151);
    sk_BY_DIR_HASH_pop_free(ent->hashes, by_dir_hash_free);
    CRYPTO_free(ent, "../crypto/x509/by_dir.c", 153);
}
...
static void free_dir(X509_LOOKUP *lu)
{
    ...
    CRYPTO_free(a, "../crypto/x509/by_dir.c", 163);
}
...
static int add_cert_dir(BY_DIR *ctx, const char *dir, int type)
{
    ...
    if (dir == 
# 172 "../crypto/x509/by_dir.c" 3 4
              ((void *)0) 
# 172 "../crypto/x509/by_dir.c"
                   || *dir == '\0') {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",173,__func__), ERR_set_error)((11),(113),
# 173 "../crypto/x509/by_dir.c" 3 4
       ((void *)0)
# 173 "../crypto/x509/by_dir.c"
       );
        return 0;
    }
    ...
    do {
        if ((*p == ':') || (*p == '\0')) {
            ...
            if (j < sk_BY_DIR_ENTRY_num(ctx->dirs))
                continue;
            if (ctx->dirs == 
# 195 "../crypto/x509/by_dir.c" 3 4
                            ((void *)0)
# 195 "../crypto/x509/by_dir.c"
                                ) {
                ctx->dirs = sk_BY_DIR_ENTRY_new_null();
                if (!ctx->dirs) {
                    (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",198,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 198 "../crypto/x509/by_dir.c" 3 4
                   ((void *)0)
# 198 "../crypto/x509/by_dir.c"
                   );
                    return 0;
                }
            }
            ent = CRYPTO_malloc(sizeof(*ent), "../crypto/x509/by_dir.c", 202);
            if (ent == 
# 203 "../crypto/x509/by_dir.c" 3 4
                      ((void *)0)
# 203 "../crypto/x509/by_dir.c"
                          )
                return 0;
            ent->dir_type = type;
            ent->hashes = sk_BY_DIR_HASH_new(by_dir_hash_cmp);
            ent->dir = CRYPTO_strndup(ss, len, "../crypto/x509/by_dir.c", 207);
            if (ent->dir == 
# 208 "../crypto/x509/by_dir.c" 3 4
                           ((void *)0) 
# 208 "../crypto/x509/by_dir.c"
                                || ent->hashes == 
# 208 "../crypto/x509/by_dir.c" 3 4
                                                  ((void *)0)
# 208 "../crypto/x509/by_dir.c"
            ...
            if (!sk_BY_DIR_ENTRY_push(ctx->dirs, ent)) {
                by_dir_entry_free(ent);
                (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",214,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 214 "../crypto/x509/by_dir.c" 3 4
               ((void *)0)
# 214 "../crypto/x509/by_dir.c"
               );
                return 0;
            }
        }
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    unsigned long h;
    BUF_MEM *b = 
# 234 "../crypto/x509/by_dir.c" 3 4
                ((void *)0)
# 234 "../crypto/x509/by_dir.c"
                    ;
    X509_OBJECT stmp, *tmp;
    const char *postfix = "";

    if (name == 
# 238 "../crypto/x509/by_dir.c" 3 4
               ((void *)0)
# 238 "../crypto/x509/by_dir.c"
                   )
        return 0;

    stmp.type = type;
    if (type == X509_LU_X509) {
        data.st_x509.cert_info.subject = (X509_NAME *)name;
        stmp.data.x509 = &data.st_x509;
    } else if (type == X509_LU_CRL) {
        data.crl.crl.issuer = (X509_NAME *)name;
        stmp.data.crl = &data.crl;
        postfix = "r";
    } else {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",250,__func__), ERR_set_error)((11),(112),
# 250 "../crypto/x509/by_dir.c" 3 4
       ((void *)0)
# 250 "../crypto/x509/by_dir.c"
       );
        goto finish;
    }

    if ((b = BUF_MEM_new()) == 
# 254 "../crypto/x509/by_dir.c" 3 4
                              ((void *)0)
# 254 "../crypto/x509/by_dir.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",255,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 255 "../crypto/x509/by_dir.c" 3 4
       ((void *)0)
# 255 "../crypto/x509/by_dir.c"
       );
        goto finish;
    }
    ...
    for (i = 0; i < sk_BY_DIR_ENTRY_num(ctx->dirs); i++) {
        ...
        if (!BUF_MEM_grow(b, j)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",271,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 271 "../crypto/x509/by_dir.c" 3 4
           ((void *)0)
# 271 "../crypto/x509/by_dir.c"
           );
            goto finish;
        }
        if (type == X509_LU_CRL && ent->hashes) {
            ...
            if (idx >= 0) {
                ...
                hent = 
# 283 "../crypto/x509/by_dir.c" 3 4
                      ((void *)0)
# 283 "../crypto/x509/by_dir.c"
                          ;
                k = 0;
            }
            ...
            k = 0;
            hent = 
# 289 "../crypto/x509/by_dir.c" 3 4
                  ((void *)0)
# 289 "../crypto/x509/by_dir.c"
                      ;
        }
        for (;;) {
            char c = '/';
# 317 "../crypto/x509/by_dir.c"
            {
        ...
        if (k > 0) {
            if (!X509_STORE_lock(xl->store_ctx))
                goto finish;
            j = OPENSSL_sk_find(ossl_check_X509_OBJECT_sk_type(xl->store_ctx->objs), ossl_check_X509_OBJECT_type(&stmp));
            tmp = ((X509_OBJECT *)OPENSSL_sk_value(ossl_check_const_X509_OBJECT_sk_type(xl->store_ctx->objs), (j)));
            X509_STORE_unlock(xl->store_ctx);
        } else {
            tmp = 
# 357 "../crypto/x509/by_dir.c" 3 4
                 ((void *)0)
# 357 "../crypto/x509/by_dir.c"
                     ;
        }
        ...
        if (type == X509_LU_CRL && k > 0) {
            ...
            if (hent == 
# 372 "../crypto/x509/by_dir.c" 3 4
                       ((void *)0)
# 372 "../crypto/x509/by_dir.c"
                           ) {
                htmp.hash = h;
                idx = sk_BY_DIR_HASH_find(ent->hashes, &htmp);
                hent = sk_BY_DIR_HASH_value(ent->hashes, idx);
            ...
            if (hent == 
# 377 "../crypto/x509/by_dir.c" 3 4
                       ((void *)0)
# 377 "../crypto/x509/by_dir.c"
                           ) {
                hent = CRYPTO_malloc(sizeof(*hent), "../crypto/x509/by_dir.c", 378);
                if (hent == 
# 379 "../crypto/x509/by_dir.c" 3 4
                           ((void *)0)
# 379 "../crypto/x509/by_dir.c"
                               ) {
                    CRYPTO_THREAD_unlock(ctx->lock);
                    ok = 0;
                    goto finish;
                ...
                if (!sk_BY_DIR_HASH_push(ent->hashes, hent)) {
                    CRYPTO_THREAD_unlock(ctx->lock);
                    CRYPTO_free(hent, "../crypto/x509/by_dir.c", 388);
                    (ERR_new(), ERR_set_debug("../crypto/x509/by_dir.c",389,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 389 "../crypto/x509/by_dir.c" 3 4
                   ((void *)0)
# 389 "../crypto/x509/by_dir.c"
                   );
                    ok = 0;
                    goto finish;
                }
        ...
        if (tmp != 
# 407 "../crypto/x509/by_dir.c" 3 4
                  ((void *)0)
# 407 "../crypto/x509/by_dir.c"
                      ) {
            ok = 1;
            ret->type = tmp->type;
 ...
 finish:
    ...
    if (X509_STORE_lock(xl->store_ctx)) {
        if (!OPENSSL_sk_is_sorted(ossl_check_const_X509_OBJECT_sk_type(xl->store_ctx->objs))) {
            OPENSSL_sk_sort(ossl_check_X509_OBJECT_sk_type(xl->store_ctx->objs));
        }
        X509_STORE_unlock(xl->store_ctx);
    }
...
static int get_cert_by_subject(X509_LOOKUP *xl, X509_LOOKUP_TYPE type,
                               const X509_NAME *name, X509_OBJECT *ret)
{
    return get_cert_by_subject_ex(xl, type, name, ret, 
# 437 "../crypto/x509/by_dir.c" 3 4
                                                      ((void *)0)
# 437 "../crypto/x509/by_dir.c"
                                                          , 
# 437 "../crypto/x509/by_dir.c" 3 4
                                                            ((void *)0)
# 437 "../crypto/x509/by_dir.c"
