# 0 "../crypto/x509/x509_req.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_req.c"
# 10 "../crypto/x509/x509_req.c"
...
X509_REQ *X509_to_X509_REQ(X509 *x, EVP_PKEY *pkey, const EVP_MD *md)
{
    ...
    if (ret == 
# 30 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 30 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",31,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 31 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 31 "../crypto/x509/x509_req.c"
       );
        goto err;
    }
    ...
    ri->version->length = 1;
    ri->version->data = CRYPTO_malloc(1, "../crypto/x509/x509_req.c", 38);
    if (ri->version->data == 
# 39 "../crypto/x509/x509_req.c" 3 4
                            ((void *)0)
# 39 "../crypto/x509/x509_req.c"
                                )
        goto err;
    ri->version->data[0] = 0;
    ...
    if (pktmp == 
# 47 "../crypto/x509/x509_req.c" 3 4
                ((void *)0)
# 47 "../crypto/x509/x509_req.c"
                    )
        goto err;
    ...
    if (pkey != 
# 53 "../crypto/x509/x509_req.c" 3 4
               ((void *)0)
# 53 "../crypto/x509/x509_req.c"
                   ) {
 ...
 err:
    X509_REQ_free(ret);
    return 
# 60 "../crypto/x509/x509_req.c" 3 4
          ((void *)0)
# 60 "../crypto/x509/x509_req.c"
              ;
}
...
{
    if (req == 
# 65 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 65 "../crypto/x509/x509_req.c"
                  )
        return 
# 66 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 66 "../crypto/x509/x509_req.c"
                  ;
...
{
    if (req == 
# 72 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 72 "../crypto/x509/x509_req.c"
                  )
        return 
# 73 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 73 "../crypto/x509/x509_req.c"
                  ;
...
struct stack_st_X509_EXTENSION *X509_REQ_get_extensions(X509_REQ *req)
{
    X509_ATTRIBUTE *attr;
    ASN1_TYPE *ext = 
# 123 "../crypto/x509/x509_req.c" 3 4
                    ((void *)0)
# 123 "../crypto/x509/x509_req.c"
                        ;
    int idx, *pnid;
    const unsigned char *p;

    if (req == 
# 127 "../crypto/x509/x509_req.c" 3 4
              ((void *)0) 
# 127 "../crypto/x509/x509_req.c"
                   || !ext_nids)
        return 
# 128 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 128 "../crypto/x509/x509_req.c"
                  ;
    ...
    if (ext == 
# 137 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 137 "../crypto/x509/x509_req.c"
                  )
        return ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_null());
    if (ext->type != 16) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",140,__func__), ERR_set_error)((11),(122),
# 140 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 140 "../crypto/x509/x509_req.c"
       );
        return 
# 141 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 141 "../crypto/x509/x509_req.c"
                  ;
    }
    p = ext->value.sequence->data;
    return (struct stack_st_X509_EXTENSION *)
        ASN1_item_d2i(
# 145 "../crypto/x509/x509_req.c" 3 4
                     ((void *)0)
# 145 "../crypto/x509/x509_req.c"
                                ...
                                const struct stack_st_X509_EXTENSION *exts, int nid)
{
    ...
    int rv = 0;
    unsigned char *ext = 
# 158 "../crypto/x509/x509_req.c" 3 4
                        ((void *)0)
# 158 "../crypto/x509/x509_req.c"
                            ;
    ...
    if (extlen <= 0)
        return 0;
    rv = X509_REQ_add1_attr_by_NID(req, nid, 16, ext, extlen);
    CRYPTO_free(ext, "../crypto/x509/x509_req.c", 166);
    return rv;
}


int X509_REQ_add_extensions(X509_REQ *req, const struct stack_st_X509_EXTENSION *exts)
{
...
X509_ATTRIBUTE *X509_REQ_delete_attr(X509_REQ *req, int loc)
{
    ...
    if (req == 
# 203 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 203 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",204,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 204 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 204 "../crypto/x509/x509_req.c"
       );
        return 
# 205 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 205 "../crypto/x509/x509_req.c"
                  ;
    }
    attr = X509at_delete_attr(req->req_info.attributes, loc);
    if (attr != 
# 208 "../crypto/x509/x509_req.c" 3 4
               ((void *)0)
# 208 "../crypto/x509/x509_req.c"
                   )
...
{
    if (req == 
# 215 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 215 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",216,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 216 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 216 "../crypto/x509/x509_req.c"
       );
        return 0;
    }
...
{
    if (req == 
# 229 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 229 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",230,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 230 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 230 "../crypto/x509/x509_req.c"
       );
        return 0;
    }
...
{
    if (req == 
# 244 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 244 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",245,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 245 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 245 "../crypto/x509/x509_req.c"
       );
        return 0;
    }
...
{
    if (req == 
# 259 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 259 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",260,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 260 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 260 "../crypto/x509/x509_req.c"
       );
        return 0;
    }
...
{
    if (psig != 
# 283 "../crypto/x509/x509_req.c" 3 4
               ((void *)0)
# 283 "../crypto/x509/x509_req.c"
                   )
        *psig = req->signature;
    if (palg != 
# 285 "../crypto/x509/x509_req.c" 3 4
               ((void *)0)
# 285 "../crypto/x509/x509_req.c"
                   )
        *palg = &req->sig_alg;
}
...
{
    if (req == 
# 308 "../crypto/x509/x509_req.c" 3 4
              ((void *)0)
# 308 "../crypto/x509/x509_req.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_req.c",309,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 309 "../crypto/x509/x509_req.c" 3 4
       ((void *)0)
# 309 "../crypto/x509/x509_req.c"
       );
        return 0;
    }
    req->req_info.enc.modified = 1;
