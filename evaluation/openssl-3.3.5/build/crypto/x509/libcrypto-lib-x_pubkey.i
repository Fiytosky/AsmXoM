# 0 "../crypto/x509/x_pubkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_pubkey.c"
# 14 "../crypto/x509/x_pubkey.c"
...
{
    if (x != 
# 50 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 50 "../crypto/x509/x_pubkey.c"
                ) {
        x->libctx = libctx;
        CRYPTO_free(x->propq, "../crypto/x509/x_pubkey.c", 52);
        x->propq = 
# 53 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 53 "../crypto/x509/x_pubkey.c"
                      ;
        if (propq != 
# 54 "../crypto/x509/x_pubkey.c" 3 4
                    ((void *)0)
# 54 "../crypto/x509/x_pubkey.c"
                        ) {
            x->propq = CRYPTO_strdup(propq, "../crypto/x509/x_pubkey.c", 55);
            if (x->propq == 
# 56 "../crypto/x509/x_pubkey.c" 3 4
                           ((void *)0)
# 56 "../crypto/x509/x_pubkey.c"
                               )
                return 0;
        }
    }
...
static const ASN1_TEMPLATE X509_PUBKEY_INTERNAL_seq_tt[] = {
        { (0), (0), 
# 64 "../crypto/x509/x_pubkey.c" 3 4
       __builtin_offsetof (
# 64 "../crypto/x509/x_pubkey.c"
       X509_PUBKEY
# 64 "../crypto/x509/x_pubkey.c" 3 4
       , 
# 64 "../crypto/x509/x_pubkey.c"
...
# 64 "../crypto/x509/x_pubkey.c"
       , "algor", (X509_ALGOR_it) },
        { (0), (0), 
# 65 "../crypto/x509/x_pubkey.c" 3 4
       __builtin_offsetof (
# 65 "../crypto/x509/x_pubkey.c"
       X509_PUBKEY
# 65 "../crypto/x509/x_pubkey.c" 3 4
       , 
# 65 "../crypto/x509/x_pubkey.c"
...
# 65 "../crypto/x509/x_pubkey.c"
       , "public_key", (ASN1_BIT_STRING_it) }
} ; static const ASN1_ITEM * X509_PUBKEY_INTERNAL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_PUBKEY_INTERNAL_seq_tt, sizeof(X509_PUBKEY_INTERNAL_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 66 "../crypto/x509/x_pubkey.c" 3 4
 ((void *)0)
# 66 "../crypto/x509/x_pubkey.c"
 , sizeof(X509_PUBKEY), "X509_PUBKEY" }; return &local_it; }

X509_PUBKEY *ossl_d2i_X509_PUBKEY_INTERNAL(const unsigned char **pp,
                                           long len, OSSL_LIB_CTX *libctx,
                                           const char *propq)
{
    X509_PUBKEY *xpub = CRYPTO_zalloc(sizeof(*xpub), "../crypto/x509/x_pubkey.c", 72);

    if (xpub == 
# 74 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 74 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 75 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 75 "../crypto/x509/x_pubkey.c"
                  ;
...
void ossl_X509_PUBKEY_INTERNAL_free(X509_PUBKEY *xpub)
{
    ASN1_item_free((ASN1_VALUE *)xpub, (X509_PUBKEY_INTERNAL_it()));
}
...
static void x509_pubkey_ex_free(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (pval != 
# 90 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0) 
# 90 "../crypto/x509/x_pubkey.c"
...
# 90 "../crypto/x509/x_pubkey.c"
        ...
        CRYPTO_free(pubkey->propq, "../crypto/x509/x_pubkey.c", 94);
        CRYPTO_free(pubkey, "../crypto/x509/x_pubkey.c", 95);
        *pval = 
# 96 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 96 "../crypto/x509/x_pubkey.c"
                   ;
    }
}
...
static int x509_pubkey_ex_populate(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    return (pubkey->algor != 
# 104 "../crypto/x509/x_pubkey.c" 3 4
                            ((void *)0)
            
# 105 "../crypto/x509/x_pubkey.c"
           || (pubkey->algor = X509_ALGOR_new()) != 
# 105 "../crypto/x509/x_pubkey.c" 3 4
                                                    ((void *)0)
# 105 "../crypto/x509/x_pubkey.c"
                                                        )
        && (pubkey->public_key != 
# 106 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
            
# 107 "../crypto/x509/x_pubkey.c"
           || (pubkey->public_key = ASN1_BIT_STRING_new()) != 
# 107 "../crypto/x509/x_pubkey.c" 3 4
                                                              ((void *)0)
# 107 "../crypto/x509/x_pubkey.c"
                                                                  );
}
                                 ...
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/x509/x_pubkey.c", 116)) == 
# 116 "../crypto/x509/x_pubkey.c" 3 4
                                               ((void *)0)
# 116 "../crypto/x509/x_pubkey.c"
                                                   )
        return 0;
    if (!x509_pubkey_ex_populate((ASN1_VALUE **)&ret, 
# 118 "../crypto/x509/x_pubkey.c" 3 4
                                                     ((void *)0)
# 118 "../crypto/x509/x_pubkey.c"
                                                         )
        || !x509_pubkey_set0_libctx(ret, libctx, propq)) {
        x509_pubkey_ex_free((ASN1_VALUE **)&ret, 
# 120 "../crypto/x509/x_pubkey.c" 3 4
                                                ((void *)0)
# 120 "../crypto/x509/x_pubkey.c"
                                                    );
        ret = 
# 121 "../crypto/x509/x_pubkey.c" 3 4
             ((void *)0)
# 121 "../crypto/x509/x_pubkey.c"
                 ;
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",122,__func__), ERR_set_error)((13),((11 | (0x2 << 18L))),
# 122 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 122 "../crypto/x509/x_pubkey.c"
       );
    } else {
        *pval = (ASN1_VALUE *)ret;
    }
    ...
    return ret != 
# 127 "../crypto/x509/x_pubkey.c" 3 4
                 ((void *)0)
# 127 "../crypto/x509/x_pubkey.c"
                     ;
}
...
# 140 "../crypto/x509/x_pubkey.c" 3 4
                            ((void *)0)
# 140 "../crypto/x509/x_pubkey.c"
                                ;
    unsigned char *tmpbuf = 
# 141 "../crypto/x509/x_pubkey.c" 3 4
                           ((void *)0)
# 141 "../crypto/x509/x_pubkey.c"
                               ;

    if (*pval == 
# 143 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0) 
# 143 "../crypto/x509/x_pubkey.c"
                     && !x509_pubkey_ex_new_ex(pval, it, libctx, propq))
        return 0;
    if (!x509_pubkey_ex_populate(pval, 
# 145 "../crypto/x509/x_pubkey.c" 3 4
                                      ((void *)0)
# 145 "../crypto/x509/x_pubkey.c"
                                          )) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",146,__func__), ERR_set_error)((13),((11 | (0x2 << 18L))),
# 146 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 146 "../crypto/x509/x_pubkey.c"
       );
        return 0;
    }
    ...
    publen = *in - in_saved;
    if (!__builtin_expect(!!((publen > 0) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",158,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 158 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 158 "../crypto/x509/x_pubkey.c"
       );
        return 0;
    }
    ...
    EVP_PKEY_free(pubkey->pkey);
    pubkey->pkey = 
# 164 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 164 "../crypto/x509/x_pubkey.c"
                      ;
    ...
    if (ret <= 0 && !pubkey->flag_force_legacy) {
        ...
        if (aclass != 0x00) {
            tmpbuf = CRYPTO_memdup((in_saved), publen, "../crypto/x509/x_pubkey.c", 194);
            if (tmpbuf == 
# 195 "../crypto/x509/x_pubkey.c" 3 4
                         ((void *)0)
# 195 "../crypto/x509/x_pubkey.c"
                             )
                return 0;
            in_saved = tmpbuf;
            *tmpbuf = 0x20 | 16;
        ...
        if ((dctx =
             OSSL_DECODER_CTX_new_for_pkey(&pubkey->pkey,
                                           ...
                                           txtoidname, ( ( ( 0x04 | 0x80) ) | 0x02 ),
                                           pubkey->libctx,
                                           pubkey->propq)) != 
# 212 "../crypto/x509/x_pubkey.c" 3 4
                                                             ((void *)0)
# 212 "../crypto/x509/x_pubkey.c"
                                                                 )
            ...
            if (OSSL_DECODER_from_data(dctx, &p, &slen)) {
                if (slen != 0) {
                    ...
                    ERR_clear_last_mark();
                    (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",224,__func__), ERR_set_error)((13),(114),
# 224 "../crypto/x509/x_pubkey.c" 3 4
                   ((void *)0)
# 224 "../crypto/x509/x_pubkey.c"
                   );
                    goto end;
                }
            }
    ...
    CRYPTO_free(tmpbuf, "../crypto/x509/x_pubkey.c", 234);
    return ret;
}
...
static int x509_pubkey_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                              const ASN1_ITEM *it, int tag, int aclass)
{
    return ASN1_item_ex_i2d(pval, out, (X509_PUBKEY_INTERNAL_it()),
                            tag, aclass);
}
                                ...
                                const char *fname, const ASN1_PCTX *pctx)
{
    return ASN1_item_print(out, *pval, indent,
                           (X509_PUBKEY_INTERNAL_it()), pctx);
}

static const ASN1_EXTERN_FUNCS x509_pubkey_ff = {
    
# 253 "../crypto/x509/x_pubkey.c" 3 4
   ((void *)0)
# 253 "../crypto/x509/x_pubkey.c"
       ,
    
# 254 "../crypto/x509/x_pubkey.c" 3 4
   ((void *)0)
# 254 "../crypto/x509/x_pubkey.c"
       ,
    x509_pubkey_ex_free,
    0,
    
# 257 "../crypto/x509/x_pubkey.c" 3 4
   ((void *)0)
# 257 "../crypto/x509/x_pubkey.c"
       ,
    x509_pubkey_ex_i2d,
...
const ASN1_ITEM * X509_PUBKEY_it(void) { static const ASN1_ITEM local_it = { 0x4, 16, 
# 264 "../crypto/x509/x_pubkey.c" 3 4
((void *)0)
# 264 "../crypto/x509/x_pubkey.c"
, 0, &x509_pubkey_ff, 0, "X509_PUBKEY" }; return &local_it; }
X509_PUBKEY *d2i_X509_PUBKEY(X509_PUBKEY **a, const unsigned char **in, long len) { return (X509_PUBKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_PUBKEY_it())); } int i2d_X509_PUBKEY(const X509_PUBKEY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_PUBKEY_it())); } X509_PUBKEY *X509_PUBKEY_new(void) { return (X509_PUBKEY *)ASN1_item_new((X509_PUBKEY_it())); } void X509_PUBKEY_free(X509_PUBKEY *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_PUBKEY_it())); }

X509_PUBKEY *X509_PUBKEY_new_ex(OSSL_LIB_CTX *libctx, const char *propq)
{
    X509_PUBKEY *pubkey = 
# 269 "../crypto/x509/x_pubkey.c" 3 4
                         ((void *)0)
# 269 "../crypto/x509/x_pubkey.c"
                             ;
    ...
    if (!x509_pubkey_set0_libctx(pubkey, libctx, propq)) {
        ...
        pubkey = 
# 274 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 274 "../crypto/x509/x_pubkey.c"
                    ;
    }
    return pubkey;
}
...
{
    X509_PUBKEY *pubkey = CRYPTO_zalloc(sizeof(*pubkey), "../crypto/x509/x_pubkey.c", 285);

    if (pubkey == 
# 287 "../crypto/x509/x_pubkey.c" 3 4
                 ((void *)0)
# 287 "../crypto/x509/x_pubkey.c"
                     )
        return 
# 288 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 288 "../crypto/x509/x_pubkey.c"
                  ;
    if (!x509_pubkey_set0_libctx(pubkey, a->libctx, a->propq)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",290,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 290 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 290 "../crypto/x509/x_pubkey.c"
       );
        x509_pubkey_ex_free((ASN1_VALUE **)&pubkey,
                            (X509_PUBKEY_INTERNAL_it()));
        return 
# 293 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 293 "../crypto/x509/x_pubkey.c"
                  ;
    }
    if ((pubkey->algor = X509_ALGOR_dup(a->algor)) == 
# 295 "../crypto/x509/x_pubkey.c" 3 4
                                                     ((void *)0)
        
# 296 "../crypto/x509/x_pubkey.c"
       || (pubkey->public_key = ASN1_BIT_STRING_new()) == 
# 296 "../crypto/x509/x_pubkey.c" 3 4
                                                          ((void *)0)
        
# 297 "../crypto/x509/x_pubkey.c"
       || !ASN1_BIT_STRING_set(pubkey->public_key,
                                a->public_key->data,
                                a->public_key->length)) {
        x509_pubkey_ex_free((ASN1_VALUE **)&pubkey,
                            (X509_PUBKEY_INTERNAL_it()));
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",302,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 302 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 302 "../crypto/x509/x_pubkey.c"
       );
        return 
# 303 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 303 "../crypto/x509/x_pubkey.c"
                  ;
    }

    if (a->pkey != 
# 306 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 306 "../crypto/x509/x_pubkey.c"
                      ) {
        ERR_set_mark();
        pubkey->pkey = EVP_PKEY_dup(a->pkey);
        if (pubkey->pkey == 
# 309 "../crypto/x509/x_pubkey.c" 3 4
                           ((void *)0)
# 309 "../crypto/x509/x_pubkey.c"
                               ) {
            ...
            if (x509_pubkey_decode(&pubkey->pkey, pubkey) <= 0) {
                ...
                ERR_clear_last_mark();
                return 
# 315 "../crypto/x509/x_pubkey.c" 3 4
                      ((void *)0)
# 315 "../crypto/x509/x_pubkey.c"
                          ;
            }
        }
        ERR_pop_to_mark();
...
{
    X509_PUBKEY *pk = 
# 325 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 325 "../crypto/x509/x_pubkey.c"
                         ;

    if (x == 
# 327 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0) 
# 327 "../crypto/x509/x_pubkey.c"
                 || pkey == 
# 327 "../crypto/x509/x_pubkey.c" 3 4
                            ((void *)0)
# 327 "../crypto/x509/x_pubkey.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",328,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 328 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 328 "../crypto/x509/x_pubkey.c"
       );
        return 0;
    }

    if (pkey->ameth != 
# 332 "../crypto/x509/x_pubkey.c" 3 4
                      ((void *)0)
# 332 "../crypto/x509/x_pubkey.c"
                          ) {
        if ((pk = X509_PUBKEY_new()) == 
# 333 "../crypto/x509/x_pubkey.c" 3 4
                                       ((void *)0)
# 333 "../crypto/x509/x_pubkey.c"
                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",334,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 334 "../crypto/x509/x_pubkey.c" 3 4
           ((void *)0)
# 334 "../crypto/x509/x_pubkey.c"
           );
            goto error;
        }
        if (pkey->ameth->pub_encode != 
# 337 "../crypto/x509/x_pubkey.c" 3 4
                                      ((void *)0)
# 337 "../crypto/x509/x_pubkey.c"
                                          ) {
            if (!pkey->ameth->pub_encode(pk, pkey)) {
                (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",339,__func__), ERR_set_error)((11),(126),
# 339 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 339 "../crypto/x509/x_pubkey.c"
               );
                goto error;
            }
        } else {
            (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",343,__func__), ERR_set_error)((11),(124),
# 343 "../crypto/x509/x_pubkey.c" 3 4
           ((void *)0)
# 343 "../crypto/x509/x_pubkey.c"
           );
            goto error;
        }
    } else if (((pkey)->keymgmt != 
# 346 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 346 "../crypto/x509/x_pubkey.c"
              )) {
        unsigned char *der = 
# 347 "../crypto/x509/x_pubkey.c" 3 4
                            ((void *)0)
# 347 "../crypto/x509/x_pubkey.c"
                                ;
        size_t derlen = 0;
        OSSL_ENCODER_CTX *ectx =
            OSSL_ENCODER_CTX_new_for_pkey(pkey, ( ( ( 0x04 | 0x80) ) | 0x02 ),
                                          "DER", "SubjectPublicKeyInfo",
                                          
# 352 "../crypto/x509/x_pubkey.c" 3 4
                                         ((void *)0)
# 352 "../crypto/x509/x_pubkey.c"
                                             );
        ...
        if (OSSL_ENCODER_to_data(ectx, &der, &derlen)) {
            ...
            pk = d2i_X509_PUBKEY(
# 357 "../crypto/x509/x_pubkey.c" 3 4
                                ((void *)0)
# 357 "../crypto/x509/x_pubkey.c"
                                    , &pder, (long)derlen);
        }

        OSSL_ENCODER_CTX_free(ectx);
        CRYPTO_free(der, "../crypto/x509/x_pubkey.c", 361);
    }

    if (pk == 
# 364 "../crypto/x509/x_pubkey.c" 3 4
             ((void *)0)
# 364 "../crypto/x509/x_pubkey.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",365,__func__), ERR_set_error)((11),(111),
# 365 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 365 "../crypto/x509/x_pubkey.c"
    ...
    if (!EVP_PKEY_up_ref(pkey)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",371,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 371 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 371 "../crypto/x509/x_pubkey.c"
       );
        goto error;
    }
    *x = pk;
# 386 "../crypto/x509/x_pubkey.c"
    if (pk->pkey != 
# 386 "../crypto/x509/x_pubkey.c" 3 4
                   ((void *)0)
# 386 "../crypto/x509/x_pubkey.c"
                       )
...
static int x509_pubkey_decode(EVP_PKEY **ppkey, const X509_PUBKEY *key)
{
    ...
    if (!key->flag_force_legacy) {
        ...
        ENGINE *e = 
# 412 "../crypto/x509/x_pubkey.c" 3 4
                   ((void *)0)
# 412 "../crypto/x509/x_pubkey.c"
                       ;

        e = ENGINE_get_pkey_meth_engine(nid);
        if (e == 
# 415 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 415 "../crypto/x509/x_pubkey.c"
                    )
            return 0;
        ENGINE_finish(e);
    ...
    pkey = EVP_PKEY_new();
    if (pkey == 
# 424 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 424 "../crypto/x509/x_pubkey.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",425,__func__), ERR_set_error)((11),((6 | (0x2 << 18L))),
# 425 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 425 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }

    if (!EVP_PKEY_set_type(pkey, nid)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",430,__func__), ERR_set_error)((11),(111),
# 430 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 430 "../crypto/x509/x_pubkey.c"
       );
        goto error;
    }
    ...
    if (pkey->ameth->pub_decode) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",443,__func__), ERR_set_error)((11),(124),
# 443 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 443 "../crypto/x509/x_pubkey.c"
       );
        goto error;
    }
...
{
    if (key == 
# 457 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 457 "../crypto/x509/x_pubkey.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",458,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 458 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 458 "../crypto/x509/x_pubkey.c"
       );
        return 
# 459 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 459 "../crypto/x509/x_pubkey.c"
                  ;
    }

    if (key->pkey == 
# 462 "../crypto/x509/x_pubkey.c" 3 4
                    ((void *)0)
# 462 "../crypto/x509/x_pubkey.c"
                        ) {

        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",464,__func__), ERR_set_error)((6),(114),
# 464 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 464 "../crypto/x509/x_pubkey.c"
       );
        return 
# 465 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 465 "../crypto/x509/x_pubkey.c"
                  ;
    }
...
EVP_PKEY *X509_PUBKEY_get(const X509_PUBKEY *key)
{
    ...
    if (ret != 
# 475 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0) 
# 475 "../crypto/x509/x_pubkey.c"
                   && !EVP_PKEY_up_ref(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",476,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 476 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 476 "../crypto/x509/x_pubkey.c"
       );
        ret = 
# 477 "../crypto/x509/x_pubkey.c" 3 4
             ((void *)0)
# 477 "../crypto/x509/x_pubkey.c"
                 ;
    }
    return ret;
}
...
static EVP_PKEY *d2i_PUBKEY_int(EVP_PKEY **a,
                                ...
                                (*d2i_x509_pubkey)(X509_PUBKEY **a,
                                                   ...
                                                   long len))
{
    X509_PUBKEY *xpk, *xpk2 = 
# 495 "../crypto/x509/x_pubkey.c" 3 4
                             ((void *)0)
# 495 "../crypto/x509/x_pubkey.c"
                                 , **pxpk = 
# 495 "../crypto/x509/x_pubkey.c" 3 4
                                            ((void *)0)
# 495 "../crypto/x509/x_pubkey.c"
                                                ;
    EVP_PKEY *pktmp = 
# 496 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 496 "../crypto/x509/x_pubkey.c"
                         ;
    ...
    if (libctx != 
# 506 "../crypto/x509/x_pubkey.c" 3 4
                 ((void *)0) 
# 506 "../crypto/x509/x_pubkey.c"
                      || propq != 
# 506 "../crypto/x509/x_pubkey.c" 3 4
                                  ((void *)0) 
# 506 "../crypto/x509/x_pubkey.c"
                                       || force_legacy) {
        xpk2 = CRYPTO_zalloc(sizeof(*xpk2), "../crypto/x509/x_pubkey.c", 507);
        if (xpk2 == 
# 508 "../crypto/x509/x_pubkey.c" 3 4
                   ((void *)0)
# 508 "../crypto/x509/x_pubkey.c"
                       )
            return 
# 509 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 509 "../crypto/x509/x_pubkey.c"
                      ;
    ...
    if (xpk == 
# 516 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 516 "../crypto/x509/x_pubkey.c"
                  )
        goto end;
    pktmp = X509_PUBKEY_get(xpk);
    X509_PUBKEY_free(xpk);
    xpk2 = 
# 520 "../crypto/x509/x_pubkey.c" 3 4
          ((void *)0)
# 520 "../crypto/x509/x_pubkey.c"
              ;
    if (pktmp == 
# 521 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 521 "../crypto/x509/x_pubkey.c"
                    )
        goto end;
    *pp = q;
    if (a != 
# 524 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 524 "../crypto/x509/x_pubkey.c"
                ) {
        EVP_PKEY_free(*a);
        *a = pktmp;
    }
...
EVP_PKEY *ossl_d2i_PUBKEY_legacy(EVP_PKEY **a, const unsigned char **pp,
                                 long length)
{
    return d2i_PUBKEY_int(a, pp, length, 
# 537 "../crypto/x509/x_pubkey.c" 3 4
                                        ((void *)0)
# 537 "../crypto/x509/x_pubkey.c"
                                            , 
# 537 "../crypto/x509/x_pubkey.c" 3 4
                                              ((void *)0)
# 537 "../crypto/x509/x_pubkey.c"
...
{
    return d2i_PUBKEY_ex(a, pp, length, 
# 548 "../crypto/x509/x_pubkey.c" 3 4
                                       ((void *)0)
# 548 "../crypto/x509/x_pubkey.c"
                                           , 
# 548 "../crypto/x509/x_pubkey.c" 3 4
                                             ((void *)0)
# 548 "../crypto/x509/x_pubkey.c"
...
int i2d_PUBKEY(const EVP_PKEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 555 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 555 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if (a->ameth != 
# 557 "../crypto/x509/x_pubkey.c" 3 4
                   ((void *)0)
# 557 "../crypto/x509/x_pubkey.c"
                       ) {
        X509_PUBKEY *xpk = 
# 558 "../crypto/x509/x_pubkey.c" 3 4
                          ((void *)0)
# 558 "../crypto/x509/x_pubkey.c"
                              ;

        if ((xpk = X509_PUBKEY_new()) == 
# 560 "../crypto/x509/x_pubkey.c" 3 4
                                        ((void *)0)
# 560 "../crypto/x509/x_pubkey.c"
                                            )
            return -1;


        if (a->ameth->pub_encode != 
# 564 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0) 
# 564 "../crypto/x509/x_pubkey.c"
                                        && a->ameth->pub_encode(xpk, a)) {
            xpk->pkey = (EVP_PKEY *)a;
            ret = i2d_X509_PUBKEY(xpk, pp);
            xpk->pkey = 
# 567 "../crypto/x509/x_pubkey.c" 3 4
                       ((void *)0)
# 567 "../crypto/x509/x_pubkey.c"
                           ;
        }
        X509_PUBKEY_free(xpk);
    } else if (a->keymgmt != 
# 570 "../crypto/x509/x_pubkey.c" 3 4
                            ((void *)0)
# 570 "../crypto/x509/x_pubkey.c"
                                ) {
        OSSL_ENCODER_CTX *ctx =
            OSSL_ENCODER_CTX_new_for_pkey(a, ( ( ( 0x04 | 0x80) ) | 0x02 ),
                                          "DER", "SubjectPublicKeyInfo",
                                          
# 574 "../crypto/x509/x_pubkey.c" 3 4
                                         ((void *)0)
# 574 "../crypto/x509/x_pubkey.c"
                                             );
        BIO *out = BIO_new(BIO_s_mem());
        BUF_MEM *buf = 
# 576 "../crypto/x509/x_pubkey.c" 3 4
                      ((void *)0)
# 576 "../crypto/x509/x_pubkey.c"
                          ;

        if (OSSL_ENCODER_CTX_get_num_encoders(ctx) != 0
            && out != 
# 579 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
            
# 580 "../crypto/x509/x_pubkey.c"
           && OSSL_ENCODER_to_bio(ctx, out)
            && BIO_ctrl(out,115,0, (char *)(&buf)) > 0) {
            ret = buf->length;

            if (pp != 
# 584 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 584 "../crypto/x509/x_pubkey.c"
                         ) {
                if (*pp == 
# 585 "../crypto/x509/x_pubkey.c" 3 4
                          ((void *)0)
# 585 "../crypto/x509/x_pubkey.c"
                              ) {
                    *pp = (unsigned char *)buf->data;
                    buf->length = 0;
                    buf->data = 
# 588 "../crypto/x509/x_pubkey.c" 3 4
                               ((void *)0)
# 588 "../crypto/x509/x_pubkey.c"
                                   ;
                } else {
...
RSA *d2i_RSA_PUBKEY(RSA **a, const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    RSA *key = 
# 608 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 608 "../crypto/x509/x_pubkey.c"
                  ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 612 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 612 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 613 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 613 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 614 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 614 "../crypto/x509/x_pubkey.c"
                  ;
    key = EVP_PKEY_get1_RSA(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 617 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 617 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 618 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 618 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 620 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 620 "../crypto/x509/x_pubkey.c"
                ) {
        RSA_free(*a);
        *a = key;
    }
...
int i2d_RSA_PUBKEY(const RSA *a, unsigned char **pp)
{
    ...
    pktmp = EVP_PKEY_new();
    if (pktmp == 
# 634 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 634 "../crypto/x509/x_pubkey.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",635,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 635 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 635 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign((pktmp),6, ((RSA *)a));
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 640 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 640 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
...
DH *ossl_d2i_DH_PUBKEY(DH **a, const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    DH *key = 
# 649 "../crypto/x509/x_pubkey.c" 3 4
             ((void *)0)
# 649 "../crypto/x509/x_pubkey.c"
                 ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 653 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 653 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 654 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 654 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 655 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 655 "../crypto/x509/x_pubkey.c"
                  ;
    if (EVP_PKEY_get_id(pkey) == 28)
        key = EVP_PKEY_get1_DH(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 659 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 659 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 660 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 660 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 662 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 662 "../crypto/x509/x_pubkey.c"
                ) {
        DH_free(*a);
        *a = key;
    }
...
int ossl_i2d_DH_PUBKEY(const DH *a, unsigned char **pp)
{
    ...
    pktmp = EVP_PKEY_new();
    if (pktmp == 
# 676 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 676 "../crypto/x509/x_pubkey.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",677,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 677 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 677 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign((pktmp),28,((DH *)a));
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 682 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 682 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
...
DH *ossl_d2i_DHx_PUBKEY(DH **a, const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    DH *key = 
# 690 "../crypto/x509/x_pubkey.c" 3 4
             ((void *)0)
# 690 "../crypto/x509/x_pubkey.c"
                 ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 694 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 694 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 695 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 695 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 696 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 696 "../crypto/x509/x_pubkey.c"
                  ;
    if (EVP_PKEY_get_id(pkey) == 920)
        key = EVP_PKEY_get1_DH(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 700 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 700 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 701 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 701 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 703 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 703 "../crypto/x509/x_pubkey.c"
                ) {
        DH_free(*a);
        *a = key;
    }
...
int ossl_i2d_DHx_PUBKEY(const DH *a, unsigned char **pp)
{
    ...
    pktmp = EVP_PKEY_new();
    if (pktmp == 
# 717 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 717 "../crypto/x509/x_pubkey.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",718,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 718 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 718 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign(pktmp, 920, (DH *)a);
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 723 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 723 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
...
DSA *d2i_DSA_PUBKEY(DSA **a, const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    DSA *key = 
# 733 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 733 "../crypto/x509/x_pubkey.c"
                  ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 737 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 737 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 738 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 738 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 739 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 739 "../crypto/x509/x_pubkey.c"
                  ;
    key = EVP_PKEY_get1_DSA(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 742 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 742 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 743 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 743 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 745 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 745 "../crypto/x509/x_pubkey.c"
                ) {
        DSA_free(*a);
        *a = key;
    }
...
{
    DSA *key = 
# 755 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 755 "../crypto/x509/x_pubkey.c"
                  ;
    const unsigned char *data;
    const BIGNUM *p, *q, *g;
    ...
    data = *pp;
    key = d2i_DSA_PUBKEY(
# 760 "../crypto/x509/x_pubkey.c" 3 4
                        ((void *)0)
# 760 "../crypto/x509/x_pubkey.c"
                            , &data, length);
    if (key == 
# 761 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 761 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 762 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 762 "../crypto/x509/x_pubkey.c"
                  ;
    DSA_get0_pqg(key, &p, &q, &g);
    if (p == 
# 764 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0) 
# 764 "../crypto/x509/x_pubkey.c"
                 || q == 
# 764 "../crypto/x509/x_pubkey.c" 3 4
                         ((void *)0) 
# 764 "../crypto/x509/x_pubkey.c"
...
# 764 "../crypto/x509/x_pubkey.c"
        ...
        DSA_free(key);
        return 
# 766 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 766 "../crypto/x509/x_pubkey.c"
                  ;
    }
    *pp = data;
    if (a != 
# 769 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 769 "../crypto/x509/x_pubkey.c"
                ) {
        DSA_free(*a);
        *a = key;
    }
...
int i2d_DSA_PUBKEY(const DSA *a, unsigned char **pp)
{
    ...
    pktmp = EVP_PKEY_new();
    if (pktmp == 
# 783 "../crypto/x509/x_pubkey.c" 3 4
                ((void *)0)
# 783 "../crypto/x509/x_pubkey.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",784,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 784 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 784 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign((pktmp),116, ((DSA *)a));
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 789 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 789 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
...
EC_KEY *d2i_EC_PUBKEY(EC_KEY **a, const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    EC_KEY *key = 
# 799 "../crypto/x509/x_pubkey.c" 3 4
                 ((void *)0)
# 799 "../crypto/x509/x_pubkey.c"
                     ;
    const unsigned char *q;
    int type;
    ...
    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 804 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 804 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 805 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 805 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 806 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 806 "../crypto/x509/x_pubkey.c"
                  ;
    type = EVP_PKEY_get_id(pkey);
    if (type == 408 || type == 1172)
        key = EVP_PKEY_get1_EC_KEY(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 811 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 811 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 812 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 812 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 814 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 814 "../crypto/x509/x_pubkey.c"
                ) {
        EC_KEY_free(*a);
        *a = key;
    }
...
int i2d_EC_PUBKEY(const EC_KEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 826 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 826 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if ((pktmp = EVP_PKEY_new()) == 
# 828 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0)
# 828 "../crypto/x509/x_pubkey.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",829,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 829 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 829 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign((pktmp), 408, ((EC_KEY *)a));
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 834 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 834 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
                                 ...
                                 const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    ECX_KEY *key = 
# 844 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 844 "../crypto/x509/x_pubkey.c"
                      ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 848 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 848 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 849 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 849 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 850 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 850 "../crypto/x509/x_pubkey.c"
                  ;
    key = ossl_evp_pkey_get1_ED25519(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 853 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 853 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 854 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 854 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 856 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 856 "../crypto/x509/x_pubkey.c"
                ) {
        ossl_ecx_key_free(*a);
        *a = key;
    }
...
int ossl_i2d_ED25519_PUBKEY(const ECX_KEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 868 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 868 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if ((pktmp = EVP_PKEY_new()) == 
# 870 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0)
# 870 "../crypto/x509/x_pubkey.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",871,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 871 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 871 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign(pktmp, 1087, (ECX_KEY *)a);
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 876 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 876 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
                               ...
                               const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    ECX_KEY *key = 
# 885 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 885 "../crypto/x509/x_pubkey.c"
                      ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 889 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 889 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 890 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 890 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 891 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 891 "../crypto/x509/x_pubkey.c"
                  ;
    if (EVP_PKEY_get_id(pkey) == 1088)
        key = ossl_evp_pkey_get1_ED448(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 895 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 895 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 896 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 896 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 898 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 898 "../crypto/x509/x_pubkey.c"
                ) {
        ossl_ecx_key_free(*a);
        *a = key;
    }
...
int ossl_i2d_ED448_PUBKEY(const ECX_KEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 910 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 910 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if ((pktmp = EVP_PKEY_new()) == 
# 912 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0)
# 912 "../crypto/x509/x_pubkey.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",913,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 913 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 913 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign(pktmp, 1088, (ECX_KEY *)a);
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 918 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 918 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
                                ...
                                const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    ECX_KEY *key = 
# 927 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 927 "../crypto/x509/x_pubkey.c"
                      ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 931 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 931 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 932 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 932 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 933 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 933 "../crypto/x509/x_pubkey.c"
                  ;
    if (EVP_PKEY_get_id(pkey) == 1034)
        key = ossl_evp_pkey_get1_X25519(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 937 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 937 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 938 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 938 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 940 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 940 "../crypto/x509/x_pubkey.c"
                ) {
        ossl_ecx_key_free(*a);
        *a = key;
    }
...
int ossl_i2d_X25519_PUBKEY(const ECX_KEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 952 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 952 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if ((pktmp = EVP_PKEY_new()) == 
# 954 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0)
# 954 "../crypto/x509/x_pubkey.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",955,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 955 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 955 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign(pktmp, 1034, (ECX_KEY *)a);
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 960 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 960 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
                              ...
                              const unsigned char **pp, long length)
{
    EVP_PKEY *pkey;
    ECX_KEY *key = 
# 969 "../crypto/x509/x_pubkey.c" 3 4
                  ((void *)0)
# 969 "../crypto/x509/x_pubkey.c"
                      ;
    const unsigned char *q;

    q = *pp;
    pkey = ossl_d2i_PUBKEY_legacy(
# 973 "../crypto/x509/x_pubkey.c" 3 4
                                 ((void *)0)
# 973 "../crypto/x509/x_pubkey.c"
                                     , &q, length);
    if (pkey == 
# 974 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 974 "../crypto/x509/x_pubkey.c"
                   )
        return 
# 975 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 975 "../crypto/x509/x_pubkey.c"
                  ;
    if (EVP_PKEY_get_id(pkey) == 1035)
        key = ossl_evp_pkey_get1_X448(pkey);
    EVP_PKEY_free(pkey);
    if (key == 
# 979 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 979 "../crypto/x509/x_pubkey.c"
                  )
        return 
# 980 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 980 "../crypto/x509/x_pubkey.c"
                  ;
    *pp = q;
    if (a != 
# 982 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 982 "../crypto/x509/x_pubkey.c"
                ) {
        ossl_ecx_key_free(*a);
        *a = key;
    }
...
int ossl_i2d_X448_PUBKEY(const ECX_KEY *a, unsigned char **pp)
{
    ...
    if (a == 
# 994 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 994 "../crypto/x509/x_pubkey.c"
                )
        return 0;
    if ((pktmp = EVP_PKEY_new()) == 
# 996 "../crypto/x509/x_pubkey.c" 3 4
                                   ((void *)0)
# 996 "../crypto/x509/x_pubkey.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_pubkey.c",997,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 997 "../crypto/x509/x_pubkey.c" 3 4
       ((void *)0)
# 997 "../crypto/x509/x_pubkey.c"
       );
        return -1;
    }
    (void)EVP_PKEY_assign(pktmp, 1035, (ECX_KEY *)a);
    ret = i2d_PUBKEY(pktmp, pp);
    pktmp->pkey.ptr = 
# 1002 "../crypto/x509/x_pubkey.c" 3 4
                     ((void *)0)
# 1002 "../crypto/x509/x_pubkey.c"
                         ;
    EVP_PKEY_free(pktmp);
    return ret;
}
                           ...
                           unsigned char *penc, int penclen)
{
    if (!X509_ALGOR_set0(pub->algor, aobj, ptype, pval))
        return 0;
    if (penc != 
# 1023 "../crypto/x509/x_pubkey.c" 3 4
               ((void *)0)
# 1023 "../crypto/x509/x_pubkey.c"
                   )
...
{
    if (x == 
# 1045 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0)
# 1045 "../crypto/x509/x_pubkey.c"
                )
        return 
# 1046 "../crypto/x509/x_pubkey.c" 3 4
              ((void *)0)
# 1046 "../crypto/x509/x_pubkey.c"
                  ;
...
int X509_PUBKEY_eq(const X509_PUBKEY *a, const X509_PUBKEY *b)
{
    ...
    if (a == b)
        return 1;
    if (a == 
# 1058 "../crypto/x509/x_pubkey.c" 3 4
            ((void *)0) 
# 1058 "../crypto/x509/x_pubkey.c"
                 || b == 
# 1058 "../crypto/x509/x_pubkey.c" 3 4
                         ((void *)0)
# 1058 "../crypto/x509/x_pubkey.c"
...
# 1060 "../crypto/x509/x_pubkey.c" 3 4
                               ((void *)0)
# 1060 "../crypto/x509/x_pubkey.c"
                                   , 
# 1060 "../crypto/x509/x_pubkey.c" 3 4
                                     ((void *)0)
# 1060 "../crypto/x509/x_pubkey.c"
...
# 1061 "../crypto/x509/x_pubkey.c"
       || !X509_PUBKEY_get0_param(
# 1061 "../crypto/x509/x_pubkey.c" 3 4
                                  ((void *)0)
# 1061 "../crypto/x509/x_pubkey.c"
                                      , 
# 1061 "../crypto/x509/x_pubkey.c" 3 4
...
# 1061 "../crypto/x509/x_pubkey.c"
    ...
    if (X509_ALGOR_cmp(algA, algB) != 0)
        return 0;
    if ((pA = X509_PUBKEY_get0(a)) == 
# 1065 "../crypto/x509/x_pubkey.c" 3 4
                                     ((void *)0)
        
# 1066 "../crypto/x509/x_pubkey.c"
       || (pB = X509_PUBKEY_get0(b)) == 
# 1066 "../crypto/x509/x_pubkey.c" 3 4
                                        ((void *)0)
# 1066 "../crypto/x509/x_pubkey.c"
                                            )
        return -2;
