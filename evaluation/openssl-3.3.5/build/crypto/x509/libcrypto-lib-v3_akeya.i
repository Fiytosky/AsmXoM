# 0 "../crypto/x509/v3_akeya.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_akeya.c"
# 10 "../crypto/x509/v3_akeya.c"
...
# 16 "../crypto/x509/v3_akeya.c" 2

static const ASN1_TEMPLATE AUTHORITY_KEYID_seq_tt[] = {
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 18 "../crypto/x509/v3_akeya.c" 3 4
       __builtin_offsetof (
# 18 "../crypto/x509/v3_akeya.c"
       AUTHORITY_KEYID
# 18 "../crypto/x509/v3_akeya.c" 3 4
       , 
# 18 "../crypto/x509/v3_akeya.c"
...
# 18 "../crypto/x509/v3_akeya.c"
       , "keyid", (ASN1_OCTET_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (1), 
# 19 "../crypto/x509/v3_akeya.c" 3 4
       __builtin_offsetof (
# 19 "../crypto/x509/v3_akeya.c"
       AUTHORITY_KEYID
# 19 "../crypto/x509/v3_akeya.c" 3 4
       , 
# 19 "../crypto/x509/v3_akeya.c"
...
# 19 "../crypto/x509/v3_akeya.c"
       , "issuer", (GENERAL_NAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 20 "../crypto/x509/v3_akeya.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/x509/v3_akeya.c"
       AUTHORITY_KEYID
# 20 "../crypto/x509/v3_akeya.c" 3 4
       , 
# 20 "../crypto/x509/v3_akeya.c"
...
} ; const ASN1_ITEM * AUTHORITY_KEYID_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, AUTHORITY_KEYID_seq_tt, sizeof(AUTHORITY_KEYID_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 21 "../crypto/x509/v3_akeya.c" 3 4
 ((void *)0)
# 21 "../crypto/x509/v3_akeya.c"
 , sizeof(AUTHORITY_KEYID), "AUTHORITY_KEYID" }; return &local_it; }

AUTHORITY_KEYID *d2i_AUTHORITY_KEYID(AUTHORITY_KEYID **a, const unsigned char **in, long len) { return (AUTHORITY_KEYID *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (AUTHORITY_KEYID_it())); } int i2d_AUTHORITY_KEYID(const AUTHORITY_KEYID *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (AUTHORITY_KEYID_it())); } AUTHORITY_KEYID *AUTHORITY_KEYID_new(void) { return (AUTHORITY_KEYID *)ASN1_item_new((AUTHORITY_KEYID_it())); } void AUTHORITY_KEYID_free(AUTHORITY_KEYID *a) { ASN1_item_free((ASN1_VALUE *)a, (AUTHORITY_KEYID_it())); }
