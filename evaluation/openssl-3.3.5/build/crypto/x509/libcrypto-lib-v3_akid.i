# 0 "../crypto/x509/v3_akid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_akid.c"
# 10 "../crypto/x509/v3_akid.c"
...
# 35 "../crypto/x509/v3_akid.c" 3 4
   ((void *)0)

# 36 "../crypto/x509/v3_akid.c"
};
...
{
    char *tmp = 
# 43 "../crypto/x509/v3_akid.c" 3 4
               ((void *)0)
# 43 "../crypto/x509/v3_akid.c"
                   ;
    struct stack_st_CONF_VALUE *origextlist = extlist, *tmpextlist;

    if (akeyid->keyid) {
        tmp = i2s_ASN1_OCTET_STRING(
# 47 "../crypto/x509/v3_akid.c" 3 4
                                   ((void *)0)
# 47 "../crypto/x509/v3_akid.c"
                                       , akeyid->keyid);
        if (tmp == 
# 48 "../crypto/x509/v3_akid.c" 3 4
                  ((void *)0)
# 48 "../crypto/x509/v3_akid.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",49,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 49 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 49 "../crypto/x509/v3_akid.c"
           );
            return 
# 50 "../crypto/x509/v3_akid.c" 3 4
                  ((void *)0)
# 50 "../crypto/x509/v3_akid.c"
                      ;
        }
        if (!X509V3_add_value((akeyid->issuer || akeyid->serial) ? "keyid" : 
# 52 "../crypto/x509/v3_akid.c" 3 4
                                                                            ((void *)0)
# 52 "../crypto/x509/v3_akid.c"
                                                                                ,
                              tmp, &extlist)) {
            CRYPTO_free(tmp, "../crypto/x509/v3_akid.c", 54);
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",55,__func__), ERR_set_error)((34),((11 | (0x2 << 18L))),
# 55 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 55 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
        CRYPTO_free(tmp, "../crypto/x509/v3_akid.c", 58);
    }
    if (akeyid->issuer) {
        tmpextlist = i2v_GENERAL_NAMES(
# 61 "../crypto/x509/v3_akid.c" 3 4
                                      ((void *)0)
# 61 "../crypto/x509/v3_akid.c"
                                          , akeyid->issuer, extlist);
        if (tmpextlist == 
# 62 "../crypto/x509/v3_akid.c" 3 4
                         ((void *)0)
# 62 "../crypto/x509/v3_akid.c"
                             ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",63,__func__), ERR_set_error)((34),((11 | (0x2 << 18L))),
# 63 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 63 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
        extlist = tmpextlist;
    ...
    if (akeyid->serial) {
        tmp = i2s_ASN1_OCTET_STRING(
# 69 "../crypto/x509/v3_akid.c" 3 4
                                   ((void *)0)
# 69 "../crypto/x509/v3_akid.c"
                                       , akeyid->serial);
        if (tmp == 
# 70 "../crypto/x509/v3_akid.c" 3 4
                  ((void *)0)
# 70 "../crypto/x509/v3_akid.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",71,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 71 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 71 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
        if (!X509V3_add_value("serial", tmp, &extlist)) {
            CRYPTO_free(tmp, "../crypto/x509/v3_akid.c", 75);
            goto err;
        }
        CRYPTO_free(tmp, "../crypto/x509/v3_akid.c", 78);
    }
    return extlist;
 err:
    if (origextlist == 
# 82 "../crypto/x509/v3_akid.c" 3 4
                      ((void *)0)
# 82 "../crypto/x509/v3_akid.c"
                          )
        OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(extlist),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return 
# 84 "../crypto/x509/v3_akid.c" 3 4
          ((void *)0)
# 84 "../crypto/x509/v3_akid.c"
              ;
}
# 96 "../crypto/x509/v3_akid.c"
static AUTHORITY_KEYID *v2i_AUTHORITY_KEYID(X509V3_EXT_METHOD *method,
                                            X509V3_CTX *ctx,
                                            struct stack_st_CONF_VALUE *values)
{
    char keyid = 0, issuer = 0;
    int i, n = OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(values));
    CONF_VALUE *cnf;
    ASN1_OCTET_STRING *ikeyid = 
# 103 "../crypto/x509/v3_akid.c" 3 4
                               ((void *)0)
# 103 "../crypto/x509/v3_akid.c"
                                   ;
    X509_NAME *isname = 
# 104 "../crypto/x509/v3_akid.c" 3 4
                       ((void *)0)
# 104 "../crypto/x509/v3_akid.c"
                           ;
    GENERAL_NAMES *gens = 
# 105 "../crypto/x509/v3_akid.c" 3 4
                         ((void *)0)
# 105 "../crypto/x509/v3_akid.c"
                             ;
    GENERAL_NAME *gen = 
# 106 "../crypto/x509/v3_akid.c" 3 4
                       ((void *)0)
# 106 "../crypto/x509/v3_akid.c"
                           ;
    ASN1_INTEGER *serial = 
# 107 "../crypto/x509/v3_akid.c" 3 4
                          ((void *)0)
# 107 "../crypto/x509/v3_akid.c"
                              ;
    X509_EXTENSION *ext;
    X509 *issuer_cert;
    int same_issuer, ss;
    ...
    if (akeyid == 
# 113 "../crypto/x509/v3_akid.c" 3 4
                 ((void *)0)
# 113 "../crypto/x509/v3_akid.c"
                     )
        goto err;

    if (n == 1 && strcmp(((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(values), (0)))->name, "none") == 0) {
        return akeyid;
    }

    for (i = 0; i < n; i++) {
        cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(values), (i)));
        if (cnf->value != 
# 122 "../crypto/x509/v3_akid.c" 3 4
                         ((void *)0) 
# 122 "../crypto/x509/v3_akid.c"
                              && strcmp(cnf->value, "always") != 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",123,__func__), ERR_set_error)(34, 120,
        ...
        if (strcmp(cnf->name, "keyid") == 0 && keyid == 0) {
            keyid = 1;
            if (cnf->value != 
# 129 "../crypto/x509/v3_akid.c" 3 4
                             ((void *)0)
# 129 "../crypto/x509/v3_akid.c"
                                 )
                keyid = 2;
        } else if (strcmp(cnf->name, "issuer") == 0 && issuer == 0) {
            issuer = 1;
            if (cnf->value != 
# 133 "../crypto/x509/v3_akid.c" 3 4
                             ((void *)0)
# 133 "../crypto/x509/v3_akid.c"
                                 )
                issuer = 2;
        } else if (strcmp(cnf->name, "none") == 0
                   || strcmp(cnf->name, "keyid") == 0
                   || strcmp(cnf->name, "issuer") == 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",138,__func__), ERR_set_error)(34, 171,
                           "name=%s", cnf->name);
            goto err;
        } else {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",142,__func__), ERR_set_error)(34, 172,
                           "name=%s", cnf->name);
            goto err;
        }
    }
    ...
    if (ctx != 
# 148 "../crypto/x509/v3_akid.c" 3 4
              ((void *)0) 
# 148 "../crypto/x509/v3_akid.c"
                   && (ctx->flags & 0x1) != 0)
        return akeyid;

    if (ctx == 
# 151 "../crypto/x509/v3_akid.c" 3 4
              ((void *)0)
# 151 "../crypto/x509/v3_akid.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",152,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 152 "../crypto/x509/v3_akid.c" 3 4
       ((void *)0)
# 152 "../crypto/x509/v3_akid.c"
       );
        goto err;
    }
    if ((issuer_cert = ctx->issuer_cert) == 
# 155 "../crypto/x509/v3_akid.c" 3 4
                                           ((void *)0)
# 155 "../crypto/x509/v3_akid.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",156,__func__), ERR_set_error)((34),(121),
# 156 "../crypto/x509/v3_akid.c" 3 4
       ((void *)0)
# 156 "../crypto/x509/v3_akid.c"
       );
        goto err;
    }
    ...
    ERR_set_mark();
    if (ctx->issuer_pkey != 
# 161 "../crypto/x509/v3_akid.c" 3 4
                           ((void *)0)
# 161 "../crypto/x509/v3_akid.c"
                               )
    ...
    if (keyid == 2 || (keyid == 1 && !ss)) {
        ...
        i = X509_get_ext_by_NID(issuer_cert, 82, -1);
        if (i >= 0 && (ext = X509_get_ext(issuer_cert, i)) != 
# 174 "../crypto/x509/v3_akid.c" 3 4
                                                             ((void *)0)
            
# 175 "../crypto/x509/v3_akid.c"
           && !(same_issuer && !ss)) {
            ikeyid = X509V3_EXT_d2i(ext);
            if (ASN1_STRING_length(ikeyid) == 0) {
                ASN1_OCTET_STRING_free(ikeyid);
                ikeyid = 
# 179 "../crypto/x509/v3_akid.c" 3 4
                        ((void *)0)
# 179 "../crypto/x509/v3_akid.c"
                            ;
            }
        }
        if (ikeyid == 
# 182 "../crypto/x509/v3_akid.c" 3 4
                     ((void *)0) 
# 182 "../crypto/x509/v3_akid.c"
                          && same_issuer && ctx->issuer_pkey != 
# 182 "../crypto/x509/v3_akid.c" 3 4
                                                                ((void *)0)
# 182 "../crypto/x509/v3_akid.c"
                                                                    ) {
            ...
            X509_PUBKEY *pubkey = 
# 184 "../crypto/x509/v3_akid.c" 3 4
                                 ((void *)0)
# 184 "../crypto/x509/v3_akid.c"
                                     ;
        ...
        if (keyid == 2 && ikeyid == 
# 190 "../crypto/x509/v3_akid.c" 3 4
                                   ((void *)0)
# 190 "../crypto/x509/v3_akid.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",191,__func__), ERR_set_error)((34),(123),
# 191 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 191 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
    }

    if (issuer == 2 || (issuer == 1 && !ss && ikeyid == 
# 196 "../crypto/x509/v3_akid.c" 3 4
                                                       ((void *)0)
# 196 "../crypto/x509/v3_akid.c"
                                                           )) {
        isname = X509_NAME_dup(X509_get_issuer_name(issuer_cert));
        serial = ASN1_INTEGER_dup(X509_get0_serialNumber(issuer_cert));
        if (isname == 
# 199 "../crypto/x509/v3_akid.c" 3 4
                     ((void *)0) 
# 199 "../crypto/x509/v3_akid.c"
                          || serial == 
# 199 "../crypto/x509/v3_akid.c" 3 4
                                       ((void *)0)
# 199 "../crypto/x509/v3_akid.c"
                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",200,__func__), ERR_set_error)((34),(122),
# 200 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 200 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
    }
    ...
    if (isname != 
# 205 "../crypto/x509/v3_akid.c" 3 4
                 ((void *)0)
# 205 "../crypto/x509/v3_akid.c"
                     ) {
        if ((gens = ((struct stack_st_GENERAL_NAME *)OPENSSL_sk_new_null())) == 
# 206 "../crypto/x509/v3_akid.c" 3 4
                                                  ((void *)0)
            
# 207 "../crypto/x509/v3_akid.c"
           || (gen = GENERAL_NAME_new()) == 
# 207 "../crypto/x509/v3_akid.c" 3 4
                                            ((void *)0)
# 207 "../crypto/x509/v3_akid.c"
                                                ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",208,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 208 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 208 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
        if (!OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(gens), ossl_check_GENERAL_NAME_type(gen))) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_akid.c",212,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 212 "../crypto/x509/v3_akid.c" 3 4
           ((void *)0)
# 212 "../crypto/x509/v3_akid.c"
           );
            goto err;
        }
        gen->type = 4;
    ...
    akeyid->issuer = gens;
    gen = 
# 220 "../crypto/x509/v3_akid.c" 3 4
         ((void *)0)
# 220 "../crypto/x509/v3_akid.c"
             ;
    gens = 
# 221 "../crypto/x509/v3_akid.c" 3 4
          ((void *)0)
# 221 "../crypto/x509/v3_akid.c"
              ;
 ...
 err:
    ...
    return 
# 234 "../crypto/x509/v3_akid.c" 3 4
          ((void *)0)
# 234 "../crypto/x509/v3_akid.c"
              ;
}
