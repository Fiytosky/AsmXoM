# 0 "../crypto/x509/x509_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_meth.c"
# 10 "../crypto/x509/x509_meth.c"
...
# 17 "../crypto/x509/x509_meth.c" 2
# 1 "../include/openssl/types.h" 1
# 18 "../crypto/x509/x509_meth.c" 2
...
# 19 "../crypto/x509/x509_meth.c" 2

X509_LOOKUP_METHOD *X509_LOOKUP_meth_new(const char *name)
{
    X509_LOOKUP_METHOD *method = CRYPTO_zalloc(sizeof(X509_LOOKUP_METHOD), "../crypto/x509/x509_meth.c", 22);

    if (method != 
# 24 "../crypto/x509/x509_meth.c" 3 4
                 ((void *)0)
# 24 "../crypto/x509/x509_meth.c"
                     ) {
        method->name = CRYPTO_strdup(name, "../crypto/x509/x509_meth.c", 25);
        if (method->name == 
# 26 "../crypto/x509/x509_meth.c" 3 4
                           ((void *)0)
# 26 "../crypto/x509/x509_meth.c"
                               )
            goto err;
    }
...
err:
    CRYPTO_free(method, "../crypto/x509/x509_meth.c", 33);
    return 
# 34 "../crypto/x509/x509_meth.c" 3 4
          ((void *)0)
# 34 "../crypto/x509/x509_meth.c"
              ;
}
...
{
    if (method != 
# 39 "../crypto/x509/x509_meth.c" 3 4
                 ((void *)0)
# 39 "../crypto/x509/x509_meth.c"
                     )
        CRYPTO_free(method->name, "../crypto/x509/x509_meth.c", 40);
    CRYPTO_free(method, "../crypto/x509/x509_meth.c", 41);
}
