# 0 "../crypto/x509/t_crl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/t_crl.c"
# 10 "../crypto/x509/t_crl.c"
...
# 24 "../crypto/x509/t_crl.c" 3 4
                                      ((void *)0)
# 24 "../crypto/x509/t_crl.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/t_crl.c",25,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 25 "../crypto/x509/t_crl.c" 3 4
       ((void *)0)
# 25 "../crypto/x509/t_crl.c"
       );
        return 0;
    }
...
{
  return X509_CRL_print_ex(out, x, 0);
}
...
int X509_CRL_print_ex(BIO *out, X509_CRL *x, unsigned long nmflag)
{
    ...
    BIO_puts(out, "    ");
    X509_signature_print(out, sig_alg, 
# 57 "../crypto/x509/t_crl.c" 3 4
                                      ((void *)0)
# 57 "../crypto/x509/t_crl.c"
                                          );
    ...
    if (OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(rev)) > 0)
        BIO_printf(out, "Revoked Certificates:\n");
    else
        BIO_printf(out, "No Revoked Certificates.\n");

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(rev)); i++) {
        r = ((X509_REVOKED *)OPENSSL_sk_value(ossl_check_const_X509_REVOKED_sk_type(rev), (i)));
