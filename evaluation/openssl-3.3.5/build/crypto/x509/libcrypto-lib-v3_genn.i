# 0 "../crypto/x509/v3_genn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_genn.c"
# 10 "../crypto/x509/v3_genn.c"
...
# 15 "../crypto/x509/v3_genn.c" 2

static const ASN1_TEMPLATE OTHERNAME_seq_tt[] = {
        { (0), (0), 
# 17 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 17 "../crypto/x509/v3_genn.c"
       OTHERNAME
# 17 "../crypto/x509/v3_genn.c" 3 4
       , 
# 17 "../crypto/x509/v3_genn.c"
...
# 17 "../crypto/x509/v3_genn.c"
       , "type_id", (ASN1_OBJECT_it) },

        { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 19 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 19 "../crypto/x509/v3_genn.c"
       OTHERNAME
# 19 "../crypto/x509/v3_genn.c" 3 4
       , 
# 19 "../crypto/x509/v3_genn.c"
...
# 19 "../crypto/x509/v3_genn.c"
       , "value", (ASN1_ANY_it) }
} ; const ASN1_ITEM * OTHERNAME_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, OTHERNAME_seq_tt, sizeof(OTHERNAME_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 20 "../crypto/x509/v3_genn.c" 3 4
 ((void *)0)
# 20 "../crypto/x509/v3_genn.c"
 , sizeof(OTHERNAME), "OTHERNAME" }; return &local_it; }

OTHERNAME *d2i_OTHERNAME(OTHERNAME **a, const unsigned char **in, long len) { return (OTHERNAME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (OTHERNAME_it())); } int i2d_OTHERNAME(const OTHERNAME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (OTHERNAME_it())); } OTHERNAME *OTHERNAME_new(void) { return (OTHERNAME *)ASN1_item_new((OTHERNAME_it())); } void OTHERNAME_free(OTHERNAME *a) { ASN1_item_free((ASN1_VALUE *)a, (OTHERNAME_it())); }

static const ASN1_TEMPLATE EDIPARTYNAME_seq_tt[] = {

        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 26 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 26 "../crypto/x509/v3_genn.c"
       EDIPARTYNAME
# 26 "../crypto/x509/v3_genn.c" 3 4
       , 
# 26 "../crypto/x509/v3_genn.c"
...
# 26 "../crypto/x509/v3_genn.c"
       , "nameAssigner", (DIRECTORYSTRING_it) },
        { (((0x2 << 3)|(0x2<<6)) | (0)), (1), 
# 27 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 27 "../crypto/x509/v3_genn.c"
       EDIPARTYNAME
# 27 "../crypto/x509/v3_genn.c" 3 4
       , 
# 27 "../crypto/x509/v3_genn.c"
...
# 27 "../crypto/x509/v3_genn.c"
       , "partyName", (DIRECTORYSTRING_it) }
} ; const ASN1_ITEM * EDIPARTYNAME_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, EDIPARTYNAME_seq_tt, sizeof(EDIPARTYNAME_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 28 "../crypto/x509/v3_genn.c" 3 4
 ((void *)0)
# 28 "../crypto/x509/v3_genn.c"
 , sizeof(EDIPARTYNAME), "EDIPARTYNAME" }; return &local_it; }

EDIPARTYNAME *d2i_EDIPARTYNAME(EDIPARTYNAME **a, const unsigned char **in, long len) { return (EDIPARTYNAME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (EDIPARTYNAME_it())); } int i2d_EDIPARTYNAME(const EDIPARTYNAME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (EDIPARTYNAME_it())); } EDIPARTYNAME *EDIPARTYNAME_new(void) { return (EDIPARTYNAME *)ASN1_item_new((EDIPARTYNAME_it())); } void EDIPARTYNAME_free(EDIPARTYNAME *a) { ASN1_item_free((ASN1_VALUE *)a, (EDIPARTYNAME_it())); }

static const ASN1_TEMPLATE GENERAL_NAME_ch_tt[] = {
        { (((0x1 << 3)|(0x2<<6)) | (0)), (0), 
# 33 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 33 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 33 "../crypto/x509/v3_genn.c" 3 4
       , 
# 33 "../crypto/x509/v3_genn.c"
...
# 33 "../crypto/x509/v3_genn.c"
       , "d.otherName", (OTHERNAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (1), 
# 34 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 34 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 34 "../crypto/x509/v3_genn.c" 3 4
       , 
# 34 "../crypto/x509/v3_genn.c"
...
# 34 "../crypto/x509/v3_genn.c"
       , "d.rfc822Name", (ASN1_IA5STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (2), 
# 35 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 35 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 35 "../crypto/x509/v3_genn.c" 3 4
       , 
# 35 "../crypto/x509/v3_genn.c"
...
# 35 "../crypto/x509/v3_genn.c"
       , "d.dNSName", (ASN1_IA5STRING_it) },

        { (((0x1 << 3)|(0x2<<6)) | (0)), (3), 
# 37 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 37 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 37 "../crypto/x509/v3_genn.c" 3 4
       , 
# 37 "../crypto/x509/v3_genn.c"
...
# 37 "../crypto/x509/v3_genn.c"
       , "d.x400Address", (ASN1_SEQUENCE_it) },

        { (((0x2 << 3)|(0x2<<6)) | (0)), (4), 
# 39 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 39 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 39 "../crypto/x509/v3_genn.c" 3 4
       , 
# 39 "../crypto/x509/v3_genn.c"
...
# 39 "../crypto/x509/v3_genn.c"
       , "d.directoryName", (X509_NAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (5), 
# 40 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 40 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 40 "../crypto/x509/v3_genn.c" 3 4
       , 
# 40 "../crypto/x509/v3_genn.c"
...
# 40 "../crypto/x509/v3_genn.c"
       , "d.ediPartyName", (EDIPARTYNAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (6), 
# 41 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 41 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 41 "../crypto/x509/v3_genn.c" 3 4
       , 
# 41 "../crypto/x509/v3_genn.c"
...
# 41 "../crypto/x509/v3_genn.c"
       , "d.uniformResourceIdentifier", (ASN1_IA5STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (7), 
# 42 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 42 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 42 "../crypto/x509/v3_genn.c" 3 4
       , 
# 42 "../crypto/x509/v3_genn.c"
...
# 42 "../crypto/x509/v3_genn.c"
       , "d.iPAddress", (ASN1_OCTET_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | (0)), (8), 
# 43 "../crypto/x509/v3_genn.c" 3 4
       __builtin_offsetof (
# 43 "../crypto/x509/v3_genn.c"
       GENERAL_NAME
# 43 "../crypto/x509/v3_genn.c" 3 4
       , 
# 43 "../crypto/x509/v3_genn.c"
...
# 43 "../crypto/x509/v3_genn.c"
       , "d.registeredID", (ASN1_OBJECT_it) }
} ; const ASN1_ITEM * GENERAL_NAME_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 44 "../crypto/x509/v3_genn.c" 3 4
 __builtin_offsetof (
# 44 "../crypto/x509/v3_genn.c"
 GENERAL_NAME
# 44 "../crypto/x509/v3_genn.c" 3 4
 , 
# 44 "../crypto/x509/v3_genn.c"
...
# 44 "../crypto/x509/v3_genn.c"
 , GENERAL_NAME_ch_tt, sizeof(GENERAL_NAME_ch_tt) / sizeof(ASN1_TEMPLATE), 
# 44 "../crypto/x509/v3_genn.c" 3 4
 ((void *)0)
# 44 "../crypto/x509/v3_genn.c"
 , sizeof(GENERAL_NAME), "GENERAL_NAME" }; return &local_it; }

GENERAL_NAME *d2i_GENERAL_NAME(GENERAL_NAME **a, const unsigned char **in, long len) { return (GENERAL_NAME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (GENERAL_NAME_it())); } int i2d_GENERAL_NAME(const GENERAL_NAME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (GENERAL_NAME_it())); } GENERAL_NAME *GENERAL_NAME_new(void) { return (GENERAL_NAME *)ASN1_item_new((GENERAL_NAME_it())); } void GENERAL_NAME_free(GENERAL_NAME *a) { ASN1_item_free((ASN1_VALUE *)a, (GENERAL_NAME_it())); }

static const ASN1_TEMPLATE GENERAL_NAMES_item_tt =
        { ((0x2 << 1)), (0), 0, "GeneralNames", (GENERAL_NAME_it) }
; const ASN1_ITEM * GENERAL_NAMES_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &GENERAL_NAMES_item_tt, 0, 
# 50 "../crypto/x509/v3_genn.c" 3 4
((void *)0)
# 50 "../crypto/x509/v3_genn.c"
, 0, "GENERAL_NAMES" }; return &local_it; }

GENERAL_NAMES *d2i_GENERAL_NAMES(GENERAL_NAMES **a, const unsigned char **in, long len) { return (GENERAL_NAMES *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (GENERAL_NAMES_it())); } int i2d_GENERAL_NAMES(const GENERAL_NAMES *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (GENERAL_NAMES_it())); } GENERAL_NAMES *GENERAL_NAMES_new(void) { return (GENERAL_NAMES *)ASN1_item_new((GENERAL_NAMES_it())); } void GENERAL_NAMES_free(GENERAL_NAMES *a) { ASN1_item_free((ASN1_VALUE *)a, (GENERAL_NAMES_it())); }
...
static int edipartyname_cmp(const EDIPARTYNAME *a, const EDIPARTYNAME *b)
{
    ...
    if (a == 
# 65 "../crypto/x509/v3_genn.c" 3 4
            ((void *)0) 
# 65 "../crypto/x509/v3_genn.c"
                 || b == 
# 65 "../crypto/x509/v3_genn.c" 3 4
                         ((void *)0)
# 65 "../crypto/x509/v3_genn.c"
    ...
    if (a->nameAssigner == 
# 72 "../crypto/x509/v3_genn.c" 3 4
                          ((void *)0) 
# 72 "../crypto/x509/v3_genn.c"
                               && b->nameAssigner != 
# 72 "../crypto/x509/v3_genn.c" 3 4
                                                     ((void *)0)
# 72 "../crypto/x509/v3_genn.c"
        ...
        return -1;
    if (a->nameAssigner != 
# 74 "../crypto/x509/v3_genn.c" 3 4
                          ((void *)0) 
# 74 "../crypto/x509/v3_genn.c"
                               && b->nameAssigner == 
# 74 "../crypto/x509/v3_genn.c" 3 4
                                                     ((void *)0)
# 74 "../crypto/x509/v3_genn.c"
    ...
    if (a->nameAssigner != 
# 77 "../crypto/x509/v3_genn.c" 3 4
                          ((void *)0)
# 77 "../crypto/x509/v3_genn.c"
                              ) {
    ...
    if (a->partyName == 
# 86 "../crypto/x509/v3_genn.c" 3 4
                       ((void *)0) 
# 86 "../crypto/x509/v3_genn.c"
                            || b->partyName == 
# 86 "../crypto/x509/v3_genn.c" 3 4
                                               ((void *)0)
# 86 "../crypto/x509/v3_genn.c"
...
void *GENERAL_NAME_get0_value(const GENERAL_NAME *a, int *ptype)
{
    ...
    default:
        return 
# 213 "../crypto/x509/v3_genn.c" 3 4
              ((void *)0)
# 213 "../crypto/x509/v3_genn.c"
                  ;
    }
}
                                ...
                                ASN1_OBJECT *oid, ASN1_TYPE *value)
{
    ...
    oth = OTHERNAME_new();
    if (oth == 
# 222 "../crypto/x509/v3_genn.c" 3 4
              ((void *)0)
# 222 "../crypto/x509/v3_genn.c"
                  )
        return 0;
