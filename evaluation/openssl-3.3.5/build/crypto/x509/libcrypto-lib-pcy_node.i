# 0 "../crypto/x509/pcy_node.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_node.c"
# 10 "../crypto/x509/pcy_node.c"
...
struct stack_st_X509_POLICY_NODE *ossl_policy_node_cmp_new(void)
{
    return ((struct stack_st_X509_POLICY_NODE *)OPENSSL_sk_new(ossl_check_X509_POLICY_NODE_compfunc_type(node_cmp)));
}

X509_POLICY_NODE *ossl_policy_tree_find_sk(struct stack_st_X509_POLICY_NODE *nodes,
                                           const ASN1_OBJECT *id)
{
    X509_POLICY_DATA n;
    X509_POLICY_NODE l;
    ...
    idx = OPENSSL_sk_find(ossl_check_X509_POLICY_NODE_sk_type(nodes), ossl_check_X509_POLICY_NODE_type(&l));
    return ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(nodes), (idx)));
                                              ...
                                              const ASN1_OBJECT *id)
{
    ...
    int i;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(level->nodes)); i++) {
        node = ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(level->nodes), (i)));
    ...
    return 
# 56 "../crypto/x509/pcy_node.c" 3 4
          ((void *)0)
# 56 "../crypto/x509/pcy_node.c"
              ;
}
                                             ...
                                             int extra_data)
{
    ...
    if (tree->node_maximum > 0 && tree->node_count >= tree->node_maximum)
        return 
# 69 "../crypto/x509/pcy_node.c" 3 4
              ((void *)0)
# 69 "../crypto/x509/pcy_node.c"
                  ;

    node = CRYPTO_zalloc(sizeof(*node), "../crypto/x509/pcy_node.c", 71);
    if (node == 
# 72 "../crypto/x509/pcy_node.c" 3 4
               ((void *)0)
# 72 "../crypto/x509/pcy_node.c"
                   )
        return 
# 73 "../crypto/x509/pcy_node.c" 3 4
              ((void *)0)
# 73 "../crypto/x509/pcy_node.c"
                  ;
    node->data = data;
    node->parent = parent;
    if (level != 
# 76 "../crypto/x509/pcy_node.c" 3 4
                ((void *)0)
# 76 "../crypto/x509/pcy_node.c"
                    ) {
        if (OBJ_obj2nid(data->valid_policy) == 746) {
            ...
            if (level->nodes == 
# 83 "../crypto/x509/pcy_node.c" 3 4
                               ((void *)0)
# 83 "../crypto/x509/pcy_node.c"
                                   )
                level->nodes = ossl_policy_node_cmp_new();
            if (level->nodes == 
# 85 "../crypto/x509/pcy_node.c" 3 4
                               ((void *)0)
# 85 "../crypto/x509/pcy_node.c"
                                   ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/pcy_node.c",86,__func__), ERR_set_error)((34),((11 | (0x2 << 18L))),
# 86 "../crypto/x509/pcy_node.c" 3 4
               ((void *)0)
# 86 "../crypto/x509/pcy_node.c"
               );
                goto node_error;
            }
            if (!OPENSSL_sk_push(ossl_check_X509_POLICY_NODE_sk_type(level->nodes), ossl_check_X509_POLICY_NODE_type(node))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/pcy_node.c",90,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 90 "../crypto/x509/pcy_node.c" 3 4
               ((void *)0)
# 90 "../crypto/x509/pcy_node.c"
               );
                goto node_error;
            }
        }
    ...
    if (extra_data) {
        if (tree->extra_data == 
# 97 "../crypto/x509/pcy_node.c" 3 4
                               ((void *)0)
# 97 "../crypto/x509/pcy_node.c"
                                   )
            tree->extra_data = sk_X509_POLICY_DATA_new_null();
        if (tree->extra_data == 
# 99 "../crypto/x509/pcy_node.c" 3 4
                               ((void *)0)
# 99 "../crypto/x509/pcy_node.c"
                                   ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/pcy_node.c",100,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 100 "../crypto/x509/pcy_node.c" 3 4
           ((void *)0)
# 100 "../crypto/x509/pcy_node.c"
           );
            goto extra_data_error;
        }
        if (!sk_X509_POLICY_DATA_push(tree->extra_data, data)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/pcy_node.c",104,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 104 "../crypto/x509/pcy_node.c" 3 4
           ((void *)0)
# 104 "../crypto/x509/pcy_node.c"
           );
            goto extra_data_error;
        }
    }
 ...
 extra_data_error:
    if (level != 
# 116 "../crypto/x509/pcy_node.c" 3 4
                ((void *)0)
# 116 "../crypto/x509/pcy_node.c"
                    ) {
        if (level->anyPolicy == node)
            level->anyPolicy = 
# 118 "../crypto/x509/pcy_node.c" 3 4
                              ((void *)0)
# 118 "../crypto/x509/pcy_node.c"
                                  ;
        else
            (void) ((X509_POLICY_NODE *)OPENSSL_sk_pop(ossl_check_X509_POLICY_NODE_sk_type(level->nodes)));
    }

 node_error:
    ossl_policy_node_free(node);
    return 
# 125 "../crypto/x509/pcy_node.c" 3 4
          ((void *)0)
# 125 "../crypto/x509/pcy_node.c"
              ;
}

void ossl_policy_node_free(X509_POLICY_NODE *node)
{
    CRYPTO_free(node, "../crypto/x509/pcy_node.c", 130);
}
                           ...
                           const X509_POLICY_NODE *node, const ASN1_OBJECT *oid)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(x->expected_policy_set)); i++) {
        policy_oid = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(x->expected_policy_set), (i)));
