# 0 "../crypto/x509/x509_ext.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_ext.c"
# 10 "../crypto/x509/x509_ext.c"
...
static X509_EXTENSION *delete_ext(struct stack_st_X509_EXTENSION **sk, int loc)
{
    X509_EXTENSION *ret = X509v3_delete_ext(*sk, loc);


    if (*sk != 
# 50 "../crypto/x509/x509_ext.c" 3 4
              ((void *)0) 
# 50 "../crypto/x509/x509_ext.c"
                   && OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(*sk)) == 0) {
        OPENSSL_sk_pop_free(ossl_check_X509_EXTENSION_sk_type(*sk),ossl_check_X509_EXTENSION_freefunc_type(X509_EXTENSION_free));
        *sk = 
# 52 "../crypto/x509/x509_ext.c" 3 4
             ((void *)0)
# 52 "../crypto/x509/x509_ext.c"
                 ;
    }
    return ret;
}
...
# 75 "../crypto/x509/x509_ext.c" 3 4
                                                            ((void *)0)
# 75 "../crypto/x509/x509_ext.c"
                                                                );
}
...
# 111 "../crypto/x509/x509_ext.c" 3 4
                                                                  ((void *)0)
# 111 "../crypto/x509/x509_ext.c"
                                                                      );
}
...
# 159 "../crypto/x509/x509_ext.c" 3 4
                                                        ((void *)0)
# 159 "../crypto/x509/x509_ext.c"
                                                            );
}
