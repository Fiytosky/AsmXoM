# 0 "../crypto/x509/x509_obj.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_obj.c"
# 10 "../crypto/x509/x509_obj.c"
...
# 17 "../crypto/x509/x509_obj.c" 2
# 25 "../crypto/x509/x509_obj.c"
char *X509_NAME_oneline(const X509_NAME *a, char *buf, int len)
{
    ...
    unsigned char *q;
    BUF_MEM *b = 
# 34 "../crypto/x509/x509_obj.c" 3 4
                ((void *)0)
# 34 "../crypto/x509/x509_obj.c"
                    ;
    ...
    if (buf == 
# 42 "../crypto/x509/x509_obj.c" 3 4
              ((void *)0)
# 42 "../crypto/x509/x509_obj.c"
                  ) {
        if ((b = BUF_MEM_new()) == 
# 43 "../crypto/x509/x509_obj.c" 3 4
                                  ((void *)0)
# 43 "../crypto/x509/x509_obj.c"
                                      )
            goto buferr;
        ...
        return 
# 50 "../crypto/x509/x509_obj.c" 3 4
              ((void *)0)
# 50 "../crypto/x509/x509_obj.c"
                  ;
    }
    if (a == 
# 52 "../crypto/x509/x509_obj.c" 3 4
            ((void *)0)
# 52 "../crypto/x509/x509_obj.c"
                ) {
        if (b) {
            buf = b->data;
            CRYPTO_free(b, "../crypto/x509/x509_obj.c", 55);
        }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries)); i++) {
        ne = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries), (i)));
        n = OBJ_obj2nid(ne->object);
        if ((n == 0) || ((s = OBJ_nid2sn(n)) == 
# 67 "../crypto/x509/x509_obj.c" 3 4
                                                       ((void *)0)
# 67 "../crypto/x509/x509_obj.c"
                                                           )) {
        ...
        num = ne->value->length;
        if (num > (1024 * 1024)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_obj.c",76,__func__), ERR_set_error)((11),(134),
# 76 "../crypto/x509/x509_obj.c" 3 4
           ((void *)0)
# 76 "../crypto/x509/x509_obj.c"
           );
            goto end;
        }
        q = ne->value->data;
# 93 "../crypto/x509/x509_obj.c"
        if ((type == 27) && ((num % 4) == 0)) {
        ...
        l += 1 + l1 + 1 + l2;
        if (l > (1024 * 1024)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_obj.c",122,__func__), ERR_set_error)((11),(134),
# 122 "../crypto/x509/x509_obj.c" 3 4
           ((void *)0)
# 122 "../crypto/x509/x509_obj.c"
           );
            goto end;
        }
        if (b != 
# 125 "../crypto/x509/x509_obj.c" 3 4
                ((void *)0)
# 125 "../crypto/x509/x509_obj.c"
                    ) {
...
# 170 "../crypto/x509/x509_obj.c"
        }
        *p = '\0';
        prev_set = ne->set;
    }
    if (b != 
# 174 "../crypto/x509/x509_obj.c" 3 4
            ((void *)0)
# 174 "../crypto/x509/x509_obj.c"
                ) {
        p = b->data;
        CRYPTO_free(b, "../crypto/x509/x509_obj.c", 176);
    } else
        p = buf;
    if (i == 0)
        *p = '\0';
    return p;
 buferr:
    (ERR_new(), ERR_set_debug("../crypto/x509/x509_obj.c",183,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 183 "../crypto/x509/x509_obj.c" 3 4
   ((void *)0)
# 183 "../crypto/x509/x509_obj.c"
   );
 end:
    BUF_MEM_free(b);
    return 
# 186 "../crypto/x509/x509_obj.c" 3 4
          ((void *)0)
# 186 "../crypto/x509/x509_obj.c"
              ;
}
