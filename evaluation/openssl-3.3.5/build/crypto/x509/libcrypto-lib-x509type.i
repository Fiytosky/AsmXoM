# 0 "../crypto/x509/x509type.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509type.c"
# 10 "../crypto/x509/x509type.c"
...
int X509_certificate_type(const X509 *x, const EVP_PKEY *pkey)
{
    ...
    if (x == 
# 21 "../crypto/x509/x509type.c" 3 4
            ((void *)0)
# 21 "../crypto/x509/x509type.c"
                )
        return 0;

    if (pkey == 
# 24 "../crypto/x509/x509type.c" 3 4
               ((void *)0)
# 24 "../crypto/x509/x509type.c"
                   )
    ...
    if (pk == 
# 29 "../crypto/x509/x509type.c" 3 4
             ((void *)0)
# 29 "../crypto/x509/x509type.c"
                 )
        return 0;
...
# 64 "../crypto/x509/x509type.c" 3 4
                                   ((void *)0)
# 64 "../crypto/x509/x509type.c"
                                       , &i)) {
