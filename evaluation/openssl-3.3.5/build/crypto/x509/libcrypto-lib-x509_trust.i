# 0 "../crypto/x509/x509_trust.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_trust.c"
# 10 "../crypto/x509/x509_trust.c"
...
# 32 "../crypto/x509/x509_trust.c" 3 4
                                                         ((void *)0)
# 32 "../crypto/x509/x509_trust.c"
                                                             },
    {2, 0, trust_1oidany, "SSL Client", 130,
     
# 34 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 34 "../crypto/x509/x509_trust.c"
        },
    {3, 0, trust_1oidany, "SSL Server", 129,
     
# 36 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 36 "../crypto/x509/x509_trust.c"
        },
    {4, 0, trust_1oidany, "S/MIME email", 132,
     
# 38 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 38 "../crypto/x509/x509_trust.c"
        },
    {5, 0, trust_1oidany, "Object Signer", 131,
     
# 40 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 40 "../crypto/x509/x509_trust.c"
        },
    {6, 0, trust_1oid, "OCSP responder", 180,
     
# 42 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 42 "../crypto/x509/x509_trust.c"
        },
    {7, 0, trust_1oid, "OCSP request", 178,
     
# 44 "../crypto/x509/x509_trust.c" 3 4
    ((void *)0)
# 44 "../crypto/x509/x509_trust.c"
        },
    {8, 0, trust_1oidany, "TSA server", 133, 
# 45 "../crypto/x509/x509_trust.c" 3 4
                                                                    ((void *)0)
# 45 "../crypto/x509/x509_trust.c"
                                                                        }
};
...
# 50 "../crypto/x509/x509_trust.c" 3 4
                                      ((void *)0)
# 50 "../crypto/x509/x509_trust.c"
                                          ;
...
{
    if (!trtable)
        return (sizeof(trstandard)/sizeof((trstandard)[0]));
    return OPENSSL_sk_num(ossl_check_const_X509_TRUST_sk_type(trtable)) + (sizeof(trstandard)/sizeof((trstandard)[0]));
}
...
X509_TRUST *X509_TRUST_get0(int idx)
{
    if (idx < 0)
        return 
# 92 "../crypto/x509/x509_trust.c" 3 4
              ((void *)0)
# 92 "../crypto/x509/x509_trust.c"
                  ;
    if (idx < (int)(sizeof(trstandard)/sizeof((trstandard)[0])))
        return trstandard + idx;
    return ((X509_TRUST *)OPENSSL_sk_value(ossl_check_const_X509_TRUST_sk_type(trtable), (idx - (sizeof(trstandard)/sizeof((trstandard)[0])))));
}
...
int X509_TRUST_get_by_id(int id)
{
    ...
    if ((id >= 1) && (id <= 8))
        return id - 1;
    if (trtable == 
# 105 "../crypto/x509/x509_trust.c" 3 4
                  ((void *)0)
# 105 "../crypto/x509/x509_trust.c"
                      )
        return -1;
    tmp.trust = id;

    OPENSSL_sk_sort(ossl_check_X509_TRUST_sk_type(trtable));
    idx = OPENSSL_sk_find(ossl_check_X509_TRUST_sk_type(trtable), ossl_check_X509_TRUST_type(&tmp));
    if (idx < 0)
        return -1;
    return idx + (sizeof(trstandard)/sizeof((trstandard)[0]));
}

int X509_TRUST_set(int *t, int trust)
{
    if (X509_TRUST_get_by_id(trust) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_trust.c",119,__func__), ERR_set_error)((11),(123),
# 119 "../crypto/x509/x509_trust.c" 3 4
       ((void *)0)
# 119 "../crypto/x509/x509_trust.c"
       );
        return 0;
    }
    *t = trust;
                   ...
                   const char *name, int arg1, void *arg2)
{
    ...
    if (idx < 0) {
        if ((trtmp = CRYPTO_malloc(sizeof(*trtmp), "../crypto/x509/x509_trust.c", 141)) == 
# 141 "../crypto/x509/x509_trust.c" 3 4
                                                       ((void *)0)
# 141 "../crypto/x509/x509_trust.c"
                                                           )
            return 0;
        trtmp->flags = (1U << 0);
    } else
    ...
    if (trtmp->flags & (1U << 1))
        CRYPTO_free(trtmp->name, "../crypto/x509/x509_trust.c", 149);

    if ((trtmp->name = CRYPTO_strdup(name, "../crypto/x509/x509_trust.c", 151)) == 
# 151 "../crypto/x509/x509_trust.c" 3 4
                                               ((void *)0)
# 151 "../crypto/x509/x509_trust.c"
                                                   )
        goto err;
    ...
    if (idx < 0) {
        if (trtable == 
# 165 "../crypto/x509/x509_trust.c" 3 4
                      ((void *)0)
            
# 166 "../crypto/x509/x509_trust.c"
           && (trtable = ((struct stack_st_X509_TRUST *)OPENSSL_sk_new(ossl_check_X509_TRUST_compfunc_type(tr_cmp)))) == 
# 166 "../crypto/x509/x509_trust.c" 3 4
                                                       ((void *)0)
# 166 "../crypto/x509/x509_trust.c"
                                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_trust.c",167,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 167 "../crypto/x509/x509_trust.c" 3 4
           ((void *)0)
# 167 "../crypto/x509/x509_trust.c"
           );
            goto err;
        }
        if (!OPENSSL_sk_push(ossl_check_X509_TRUST_sk_type(trtable), ossl_check_X509_TRUST_type(trtmp))) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_trust.c",171,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 171 "../crypto/x509/x509_trust.c" 3 4
           ((void *)0)
# 171 "../crypto/x509/x509_trust.c"
           );
            goto err;
        }
    }
 ...
 err:
    if (idx < 0) {
        CRYPTO_free(trtmp->name, "../crypto/x509/x509_trust.c", 178);
        CRYPTO_free(trtmp, "../crypto/x509/x509_trust.c", 179);
    }
    return 0;
}
...
{
    if (p == 
# 186 "../crypto/x509/x509_trust.c" 3 4
            ((void *)0)
# 186 "../crypto/x509/x509_trust.c"
                )
        return;
    if (p->flags & (1U << 0)) {
        if (p->flags & (1U << 1))
            CRYPTO_free(p->name, "../crypto/x509/x509_trust.c", 190);
        CRYPTO_free(p, "../crypto/x509/x509_trust.c", 191);
    }
}

void X509_TRUST_cleanup(void)
{
    OPENSSL_sk_pop_free(ossl_check_X509_TRUST_sk_type(trtable),ossl_check_X509_TRUST_freefunc_type(trtable_free));
    trtable = 
# 198 "../crypto/x509/x509_trust.c" 3 4
             ((void *)0)
# 198 "../crypto/x509/x509_trust.c"
                 ;
}
...
static int trust_compat(X509_TRUST *trust, X509 *x, int flags)
{
    ...
    if (X509_check_purpose(x, -1, 0) != 1)
        return 3;
    if ((flags & (1U << 2)) == 0 && (x->ex_flags & 0x2000))
        return 1;
    else
        return 3;
}
...
static int obj_trust(int id, X509 *x, int flags)
{
    ...
    if (ax != 
# 255 "../crypto/x509/x509_trust.c" 3 4
             ((void *)0) 
# 255 "../crypto/x509/x509_trust.c"
                  && ax->reject != 
# 255 "../crypto/x509/x509_trust.c" 3 4
                                   ((void *)0)
# 255 "../crypto/x509/x509_trust.c"
                                       ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(ax->reject)); i++) {
            ASN1_OBJECT *obj = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(ax->reject), (i)));
    ...
    if (ax != 
# 266 "../crypto/x509/x509_trust.c" 3 4
             ((void *)0) 
# 266 "../crypto/x509/x509_trust.c"
                  && ax->trust != 
# 266 "../crypto/x509/x509_trust.c" 3 4
                                  ((void *)0)
# 266 "../crypto/x509/x509_trust.c"
                                      ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(ax->trust)); i++) {
            ASN1_OBJECT *obj = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(ax->trust), (i)));
            int nid = OBJ_obj2nid(obj);
...
# 289 "../crypto/x509/x509_trust.c"
    ...
    return trust_compat(
# 298 "../crypto/x509/x509_trust.c" 3 4
                       ((void *)0)
# 298 "../crypto/x509/x509_trust.c"
                           , x, flags);
}
