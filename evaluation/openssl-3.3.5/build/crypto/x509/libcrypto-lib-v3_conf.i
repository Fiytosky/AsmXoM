# 0 "../crypto/x509/v3_conf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_conf.c"
# 12 "../crypto/x509/v3_conf.c"
...
static struct stack_st_CONF_VALUE *conf_lhash_get_section(void *db, const char *section);
                                            ...
                                            const char *name, const char *value)
{
    ...
    if (!ret) {
        if (section != 
# 47 "../crypto/x509/v3_conf.c" 3 4
                      ((void *)0)
# 47 "../crypto/x509/v3_conf.c"
                          )
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",48,__func__), ERR_set_error)(34, 128,
                           "section=%s, name=%s, value=%s",
                           section, name, value);
        else
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",52,__func__), ERR_set_error)(34, 128,
...
X509_EXTENSION *X509V3_EXT_nconf(CONF *conf, X509V3_CTX *ctx, const char *name,
                                 const char *value)
{
    return X509V3_EXT_nconf_int(conf, ctx, 
# 61 "../crypto/x509/v3_conf.c" 3 4
                                          ((void *)0)
# 61 "../crypto/x509/v3_conf.c"
                                              , name, value);
}
                                    ...
                                    int crit, const char *value)
{
    ...
    if (ext_nid == 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",88,__func__), ERR_set_error)((34),(130),
# 88 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 88 "../crypto/x509/v3_conf.c"
       );
        return 
# 89 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 89 "../crypto/x509/v3_conf.c"
                  ;
    }
    if ((method = X509V3_EXT_get_nid(ext_nid)) == 
# 91 "../crypto/x509/v3_conf.c" 3 4
                                                 ((void *)0)
# 91 "../crypto/x509/v3_conf.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",92,__func__), ERR_set_error)((34),(129),
# 92 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 92 "../crypto/x509/v3_conf.c"
       );
        return 
# 93 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 93 "../crypto/x509/v3_conf.c"
                  ;
    }
    ...
    if (method->v2i) {
        ...
        if (nval == 
# 101 "../crypto/x509/v3_conf.c" 3 4
                   ((void *)0) 
# 101 "../crypto/x509/v3_conf.c"
                        || OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",102,__func__), ERR_set_error)(34, 105,
                           "name=%s,section=%s", OBJ_nid2sn(ext_nid), value);
            if (*value != '@')
                OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(nval),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
            return 
# 106 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 106 "../crypto/x509/v3_conf.c"
                      ;
        }
        ...
        if (!ext_struc)
            return 
# 112 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 112 "../crypto/x509/v3_conf.c"
                      ;
    } else if (method->s2i) {
        if ((ext_struc = method->s2i(method, ctx, value)) == 
# 114 "../crypto/x509/v3_conf.c" 3 4
                                                            ((void *)0)
# 114 "../crypto/x509/v3_conf.c"
                                                                )
            return 
# 115 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 115 "../crypto/x509/v3_conf.c"
                      ;
    } else if (method->r2i) {
        if (!ctx->db || !ctx->db_meth) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",118,__func__), ERR_set_error)((34),(136),
# 118 "../crypto/x509/v3_conf.c" 3 4
           ((void *)0)
# 118 "../crypto/x509/v3_conf.c"
           );
            return 
# 119 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 119 "../crypto/x509/v3_conf.c"
                      ;
        }
        if ((ext_struc = method->r2i(method, ctx, value)) == 
# 121 "../crypto/x509/v3_conf.c" 3 4
                                                            ((void *)0)
# 121 "../crypto/x509/v3_conf.c"
                                                                )
            return 
# 122 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 122 "../crypto/x509/v3_conf.c"
                      ;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",124,__func__), ERR_set_error)(34, 103,
                       "name=%s", OBJ_nid2sn(ext_nid));
        return 
# 126 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 126 "../crypto/x509/v3_conf.c"
                  ;
    }
...
# 141 "../crypto/x509/v3_conf.c" 3 4
                            ((void *)0)
# 141 "../crypto/x509/v3_conf.c"
                                ;
    int ext_len;
    ASN1_OCTET_STRING *ext_oct = 
# 143 "../crypto/x509/v3_conf.c" 3 4
                                ((void *)0)
# 143 "../crypto/x509/v3_conf.c"
                                    ;
    X509_EXTENSION *ext;
    ...
    if (method->it) {
        ext_der = 
# 148 "../crypto/x509/v3_conf.c" 3 4
                 ((void *)0)
# 148 "../crypto/x509/v3_conf.c"
                     ;
        ext_len =
            ASN1_item_i2d(ext_struc, &ext_der, (method->it()));
        if (ext_len < 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",152,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 152 "../crypto/x509/v3_conf.c" 3 4
           ((void *)0)
# 152 "../crypto/x509/v3_conf.c"
           );
            goto err;
        }
    } else {
...
# 158 "../crypto/x509/v3_conf.c" 3 4
                                        ((void *)0)
# 158 "../crypto/x509/v3_conf.c"
                                            );
        if (ext_len <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",160,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 160 "../crypto/x509/v3_conf.c" 3 4
           ((void *)0)
# 160 "../crypto/x509/v3_conf.c"
           );
            goto err;
        }
        if ((ext_der = CRYPTO_malloc(ext_len, "../crypto/x509/v3_conf.c", 163)) == 
# 163 "../crypto/x509/v3_conf.c" 3 4
                                                  ((void *)0)
# 163 "../crypto/x509/v3_conf.c"
                                                      )
            goto err;
        p = ext_der;
...
# 168 "../crypto/x509/v3_conf.c" 3 4
                                              ((void *)0)
# 168 "../crypto/x509/v3_conf.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",169,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 169 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 169 "../crypto/x509/v3_conf.c"
       );
        goto err;
    }
    ext_oct->data = ext_der;
    ext_der = 
# 173 "../crypto/x509/v3_conf.c" 3 4
             ((void *)0)
# 173 "../crypto/x509/v3_conf.c"
                 ;
    ext_oct->length = ext_len;

    ext = X509_EXTENSION_create_by_NID(
# 176 "../crypto/x509/v3_conf.c" 3 4
                                      ((void *)0)
# 176 "../crypto/x509/v3_conf.c"
                                          , ext_nid, crit, ext_oct);
    if (!ext) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",178,__func__), ERR_set_error)((34),((34 | (0x2 << 18L))),
# 178 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 178 "../crypto/x509/v3_conf.c"
       );
        goto err;
    }
 ...
 err:
    CRYPTO_free(ext_der, "../crypto/x509/v3_conf.c", 186);
    ASN1_OCTET_STRING_free(ext_oct);
    return 
# 188 "../crypto/x509/v3_conf.c" 3 4
          ((void *)0)
# 188 "../crypto/x509/v3_conf.c"
              ;
...
X509_EXTENSION *X509V3_EXT_i2d(int ext_nid, int crit, void *ext_struc)
{
    ...
    if ((method = X509V3_EXT_get_nid(ext_nid)) == 
# 198 "../crypto/x509/v3_conf.c" 3 4
                                                 ((void *)0)
# 198 "../crypto/x509/v3_conf.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",199,__func__), ERR_set_error)((34),(129),
# 199 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 199 "../crypto/x509/v3_conf.c"
       );
        return 
# 200 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 200 "../crypto/x509/v3_conf.c"
                  ;
    }
...
static int v3_check_critical(const char **value)
{
    ...
    if (!((strncmp(p, "critical," "", sizeof("critical,") - 1) == 0) ? ((p) += sizeof("critical,") - 1, 1) : 0))
        return 0;
    while ((ossl_ctype_check((*p), 0x8)))
        p++;
    *value = p;
    return 1;
}
...
static int v3_check_generic(const char **value)
{
    ...
    if (((strncmp(p, "DER:" "", sizeof("DER:") - 1) == 0) ? ((p) += sizeof("DER:") - 1, 1) : 0)) {
        gen_type = 1;
    } else if (((strncmp(p, "ASN1:" "", sizeof("ASN1:") - 1) == 0) ? ((p) += sizeof("ASN1:") - 1, 1) : 0)) {
        gen_type = 2;
    } else
        return 0;
...
{
    unsigned char *ext_der = 
# 242 "../crypto/x509/v3_conf.c" 3 4
                            ((void *)0)
# 242 "../crypto/x509/v3_conf.c"
                                ;
    long ext_len = 0;
    ASN1_OBJECT *obj = 
# 244 "../crypto/x509/v3_conf.c" 3 4
                      ((void *)0)
# 244 "../crypto/x509/v3_conf.c"
                          ;
    ASN1_OCTET_STRING *oct = 
# 245 "../crypto/x509/v3_conf.c" 3 4
                            ((void *)0)
# 245 "../crypto/x509/v3_conf.c"
                                ;
    X509_EXTENSION *extension = 
# 246 "../crypto/x509/v3_conf.c" 3 4
                               ((void *)0)
# 246 "../crypto/x509/v3_conf.c"
                                   ;

    if ((obj = OBJ_txt2obj(ext, 0)) == 
# 248 "../crypto/x509/v3_conf.c" 3 4
                                      ((void *)0)
# 248 "../crypto/x509/v3_conf.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",249,__func__), ERR_set_error)(34, 115,
                       "name=%s", ext);
        goto err;
    }
    ...
    if (ext_der == 
# 259 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 259 "../crypto/x509/v3_conf.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",260,__func__), ERR_set_error)(34, 116,
                       "value=%s", value);
        goto err;
    }

    if ((oct = ASN1_OCTET_STRING_new()) == 
# 265 "../crypto/x509/v3_conf.c" 3 4
                                          ((void *)0)
# 265 "../crypto/x509/v3_conf.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",266,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 266 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 266 "../crypto/x509/v3_conf.c"
       );
        goto err;
    }
    ...
    oct->length = ext_len;
    ext_der = 
# 272 "../crypto/x509/v3_conf.c" 3 4
             ((void *)0)
# 272 "../crypto/x509/v3_conf.c"
                 ;

    extension = X509_EXTENSION_create_by_OBJ(
# 274 "../crypto/x509/v3_conf.c" 3 4
                                            ((void *)0)
# 274 "../crypto/x509/v3_conf.c"
                                                , obj, crit, oct);

 err:
    ASN1_OBJECT_free(obj);
    ASN1_OCTET_STRING_free(oct);
    CRYPTO_free(ext_der, "../crypto/x509/v3_conf.c", 279);
    return extension;
                                   ...
                                   long *ext_len)
{
    ASN1_TYPE *typ;
    unsigned char *ext_der = 
# 288 "../crypto/x509/v3_conf.c" 3 4
                            ((void *)0)
# 288 "../crypto/x509/v3_conf.c"
                                ;

    typ = ASN1_generate_v3(value, ctx);
    if (typ == 
# 291 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 291 "../crypto/x509/v3_conf.c"
                  )
        return 
# 292 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 292 "../crypto/x509/v3_conf.c"
                  ;
...
static void delete_ext(struct stack_st_X509_EXTENSION *sk, X509_EXTENSION *dext)
{
    int idx;
    ASN1_OBJECT *obj;
...
# 321 "../crypto/x509/v3_conf.c" 3 4
                                                    ((void *)0)
# 321 "../crypto/x509/v3_conf.c"
                                                        )
        return 0;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); i++) {
        ...
        if (skid > akid && akid >= 0) {
            ...
            if (i == akid)
                val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (skid)));
            else if (i == skid)
                val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (akid)));
        }
        if ((ext = X509V3_EXT_nconf_int(conf, ctx, val->section,
                                        val->name, val->value)) == 
# 340 "../crypto/x509/v3_conf.c" 3 4
                                                                  ((void *)0)
# 340 "../crypto/x509/v3_conf.c"
                                                                      )
            return 0;
        if (sk != 
# 342 "../crypto/x509/v3_conf.c" 3 4
                 ((void *)0)
# 342 "../crypto/x509/v3_conf.c"
                     ) {
            if (ctx->flags == 0x2)
                delete_ext(*sk, ext);
            if (X509v3_add_ext(sk, ext, -1) == 
# 345 "../crypto/x509/v3_conf.c" 3 4
                                              ((void *)0)
# 345 "../crypto/x509/v3_conf.c"
                                                  ) {
...
{
    struct stack_st_X509_EXTENSION **sk = 
# 362 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 362 "../crypto/x509/v3_conf.c"
                                       ;
    if (cert != 
# 363 "../crypto/x509/v3_conf.c" 3 4
               ((void *)0)
# 363 "../crypto/x509/v3_conf.c"
                   )
...
{
    struct stack_st_X509_EXTENSION **sk = 
# 375 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 375 "../crypto/x509/v3_conf.c"
                                       ;
    if (crl != 
# 376 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 376 "../crypto/x509/v3_conf.c"
                  )
...
# 388 "../crypto/x509/v3_conf.c" 3 4
                                    ((void *)0)
# 388 "../crypto/x509/v3_conf.c"
                                        ;
    int ret = X509V3_EXT_add_nconf_sk(conf, ctx, section, &exts);

    if (ret && req != 
# 391 "../crypto/x509/v3_conf.c" 3 4
                     ((void *)0) 
# 391 "../crypto/x509/v3_conf.c"
                          && exts != 
# 391 "../crypto/x509/v3_conf.c" 3 4
                                     ((void *)0)
# 391 "../crypto/x509/v3_conf.c"
...
char *X509V3_get_string(X509V3_CTX *ctx, const char *name, const char *section)
{
    if (!ctx->db || !ctx->db_meth || !ctx->db_meth->get_string) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",402,__func__), ERR_set_error)((34),(148),
# 402 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 402 "../crypto/x509/v3_conf.c"
       );
        return 
# 403 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 403 "../crypto/x509/v3_conf.c"
                  ;
    }
    if (ctx->db_meth->get_string)
        return ctx->db_meth->get_string(ctx->db, name, section);
    return 
# 407 "../crypto/x509/v3_conf.c" 3 4
          ((void *)0)
# 407 "../crypto/x509/v3_conf.c"
              ;
}
...
struct stack_st_CONF_VALUE *X509V3_get_section(X509V3_CTX *ctx, const char *section)
{
    if (!ctx->db || !ctx->db_meth || !ctx->db_meth->get_section) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",413,__func__), ERR_set_error)((34),(148),
# 413 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 413 "../crypto/x509/v3_conf.c"
       );
        return 
# 414 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 414 "../crypto/x509/v3_conf.c"
                  ;
    }
    if (ctx->db_meth->get_section)
        return ctx->db_meth->get_section(ctx->db, section);
    return 
# 418 "../crypto/x509/v3_conf.c" 3 4
          ((void *)0)
# 418 "../crypto/x509/v3_conf.c"
              ;
}
...
static struct stack_st_CONF_VALUE *nconf_get_section(void *db, const char *section)
{
...
# 450 "../crypto/x509/v3_conf.c" 3 4
   ((void *)0)
# 450 "../crypto/x509/v3_conf.c"
       ,
    
# 451 "../crypto/x509/v3_conf.c" 3 4
   ((void *)0)

# 452 "../crypto/x509/v3_conf.c"
};

void X509V3_set_nconf(X509V3_CTX *ctx, CONF *conf)
{
    if (ctx == 
# 456 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 456 "../crypto/x509/v3_conf.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",457,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 457 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 457 "../crypto/x509/v3_conf.c"
       );
        return;
    }
...
{
    if (ctx == 
# 467 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 467 "../crypto/x509/v3_conf.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",468,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 468 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 468 "../crypto/x509/v3_conf.c"
       );
        return;
    }
    ctx->flags = flags;
    ...
    ctx->crl = crl;
    ctx->db_meth = 
# 476 "../crypto/x509/v3_conf.c" 3 4
                  ((void *)0)
# 476 "../crypto/x509/v3_conf.c"
                      ;
    ctx->db = 
# 477 "../crypto/x509/v3_conf.c" 3 4
             ((void *)0)
# 477 "../crypto/x509/v3_conf.c"
                 ;
    ctx->issuer_pkey = 
# 478 "../crypto/x509/v3_conf.c" 3 4
                      ((void *)0)
# 478 "../crypto/x509/v3_conf.c"
                          ;
}
...
{
    if (ctx == 
# 484 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 484 "../crypto/x509/v3_conf.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",485,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 485 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 485 "../crypto/x509/v3_conf.c"
       );
        return 0;
    }
    if (ctx->subject_cert == 
# 488 "../crypto/x509/v3_conf.c" 3 4
                            ((void *)0) 
# 488 "../crypto/x509/v3_conf.c"
                                 && pkey != 
# 488 "../crypto/x509/v3_conf.c" 3 4
                                            ((void *)0)
# 488 "../crypto/x509/v3_conf.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",489,__func__), ERR_set_error)((34),((262|(0x2 << 18L))),
# 489 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 489 "../crypto/x509/v3_conf.c"
       );
        return 0;
    }
                                ...
                                const char *name, const char *value)
{
    ...
    if ((ctmp = NCONF_new(
# 504 "../crypto/x509/v3_conf.c" 3 4
                         ((void *)0)
# 504 "../crypto/x509/v3_conf.c"
                             )) == 
# 504 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 504 "../crypto/x509/v3_conf.c"
        ...
        return 
# 505 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 505 "../crypto/x509/v3_conf.c"
                  ;
    CONF_set_nconf(ctmp, conf);
    ret = X509V3_EXT_nconf(ctmp, ctx, name, value);
    CONF_set_nconf(ctmp, 
# 508 "../crypto/x509/v3_conf.c" 3 4
                        ((void *)0)
# 508 "../crypto/x509/v3_conf.c"
                            );
    NCONF_free(ctmp);
    return ret;
}
                                    ...
                                    X509V3_CTX *ctx, int ext_nid, const char *value)
{
    ...
    if ((ctmp = NCONF_new(
# 519 "../crypto/x509/v3_conf.c" 3 4
                         ((void *)0)
# 519 "../crypto/x509/v3_conf.c"
                             )) == 
# 519 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 519 "../crypto/x509/v3_conf.c"
        ...
        return 
# 520 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 520 "../crypto/x509/v3_conf.c"
                  ;
    CONF_set_nconf(ctmp, conf);
    ret = X509V3_EXT_nconf_nid(ctmp, ctx, ext_nid, value);
    CONF_set_nconf(ctmp, 
# 523 "../crypto/x509/v3_conf.c" 3 4
                        ((void *)0)
# 523 "../crypto/x509/v3_conf.c"
                            );
    NCONF_free(ctmp);
    return ret;
}
...
# 541 "../crypto/x509/v3_conf.c" 3 4
   ((void *)0)
# 541 "../crypto/x509/v3_conf.c"
       ,
    
# 542 "../crypto/x509/v3_conf.c" 3 4
   ((void *)0)

# 543 "../crypto/x509/v3_conf.c"
};

void X509V3_set_conf_lhash(X509V3_CTX *ctx, struct lhash_st_CONF_VALUE *lhash)
{
    if (ctx == 
# 547 "../crypto/x509/v3_conf.c" 3 4
              ((void *)0)
# 547 "../crypto/x509/v3_conf.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_conf.c",548,__func__), ERR_set_error)((34),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 548 "../crypto/x509/v3_conf.c" 3 4
       ((void *)0)
# 548 "../crypto/x509/v3_conf.c"
       );
        return;
    }
                        ...
                        const char *section, X509 *cert)
{
    ...
    if ((ctmp = NCONF_new(
# 561 "../crypto/x509/v3_conf.c" 3 4
                         ((void *)0)
# 561 "../crypto/x509/v3_conf.c"
                             )) == 
# 561 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 561 "../crypto/x509/v3_conf.c"
    ...
    CONF_set_nconf(ctmp, 
# 565 "../crypto/x509/v3_conf.c" 3 4
                        ((void *)0)
# 565 "../crypto/x509/v3_conf.c"
                            );
    NCONF_free(ctmp);
    return ret;
}
                            ...
                            const char *section, X509_CRL *crl)
{
    ...
    if ((ctmp = NCONF_new(
# 578 "../crypto/x509/v3_conf.c" 3 4
                         ((void *)0)
# 578 "../crypto/x509/v3_conf.c"
                             )) == 
# 578 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 578 "../crypto/x509/v3_conf.c"
    ...
    CONF_set_nconf(ctmp, 
# 582 "../crypto/x509/v3_conf.c" 3 4
                        ((void *)0)
# 582 "../crypto/x509/v3_conf.c"
                            );
    NCONF_free(ctmp);
    return ret;
}
                            ...
                            const char *section, X509_REQ *req)
{
    ...
    if ((ctmp = NCONF_new(
# 595 "../crypto/x509/v3_conf.c" 3 4
                         ((void *)0)
# 595 "../crypto/x509/v3_conf.c"
                             )) == 
# 595 "../crypto/x509/v3_conf.c" 3 4
                                   ((void *)0)
# 595 "../crypto/x509/v3_conf.c"
    ...
    CONF_set_nconf(ctmp, 
# 599 "../crypto/x509/v3_conf.c" 3 4
                        ((void *)0)
# 599 "../crypto/x509/v3_conf.c"
                            );
    NCONF_free(ctmp);
    return ret;
}
