# 0 "../crypto/x509/v3_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_info.c"
# 10 "../crypto/x509/v3_info.c"
...
# 17 "../crypto/x509/v3_info.c" 2

static struct stack_st_CONF_VALUE *i2v_AUTHORITY_INFO_ACCESS(X509V3_EXT_METHOD
                                                       *method, AUTHORITY_INFO_ACCESS
                                                       *ainfo, struct stack_st_CONF_VALUE
                                                       *ret);
...
const X509V3_EXT_METHOD ossl_v3_info = { 177, 0x4,
...
# 35 "../crypto/x509/v3_info.c" 3 4
   ((void *)0)

# 36 "../crypto/x509/v3_info.c"
};

const X509V3_EXT_METHOD ossl_v3_sinfo = { 398, 0x4,
    (AUTHORITY_INFO_ACCESS_it),
    0, 0, 0, 0,
    0, 0,
    (X509V3_EXT_I2V) i2v_AUTHORITY_INFO_ACCESS,
...
# 45 "../crypto/x509/v3_info.c" 3 4
   ((void *)0)

# 46 "../crypto/x509/v3_info.c"
};

static const ASN1_TEMPLATE ACCESS_DESCRIPTION_seq_tt[] = {
        { (0), (0), 
# 49 "../crypto/x509/v3_info.c" 3 4
       __builtin_offsetof (
# 49 "../crypto/x509/v3_info.c"
       ACCESS_DESCRIPTION
# 49 "../crypto/x509/v3_info.c" 3 4
       , 
# 49 "../crypto/x509/v3_info.c"
...
# 49 "../crypto/x509/v3_info.c"
       , "method", (ASN1_OBJECT_it) },
        { (0), (0), 
# 50 "../crypto/x509/v3_info.c" 3 4
       __builtin_offsetof (
# 50 "../crypto/x509/v3_info.c"
       ACCESS_DESCRIPTION
# 50 "../crypto/x509/v3_info.c" 3 4
       , 
# 50 "../crypto/x509/v3_info.c"
...
# 50 "../crypto/x509/v3_info.c"
       , "location", (GENERAL_NAME_it) }
} ; const ASN1_ITEM * ACCESS_DESCRIPTION_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ACCESS_DESCRIPTION_seq_tt, sizeof(ACCESS_DESCRIPTION_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 51 "../crypto/x509/v3_info.c" 3 4
 ((void *)0)
# 51 "../crypto/x509/v3_info.c"
 , sizeof(ACCESS_DESCRIPTION), "ACCESS_DESCRIPTION" }; return &local_it; }

ACCESS_DESCRIPTION *d2i_ACCESS_DESCRIPTION(ACCESS_DESCRIPTION **a, const unsigned char **in, long len) { return (ACCESS_DESCRIPTION *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ACCESS_DESCRIPTION_it())); } int i2d_ACCESS_DESCRIPTION(const ACCESS_DESCRIPTION *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ACCESS_DESCRIPTION_it())); } ACCESS_DESCRIPTION *ACCESS_DESCRIPTION_new(void) { return (ACCESS_DESCRIPTION *)ASN1_item_new((ACCESS_DESCRIPTION_it())); } void ACCESS_DESCRIPTION_free(ACCESS_DESCRIPTION *a) { ASN1_item_free((ASN1_VALUE *)a, (ACCESS_DESCRIPTION_it())); }

static const ASN1_TEMPLATE AUTHORITY_INFO_ACCESS_item_tt =
        { ((0x2 << 1)), (0), 0, "GeneralNames", (ACCESS_DESCRIPTION_it) }
; const ASN1_ITEM * AUTHORITY_INFO_ACCESS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &AUTHORITY_INFO_ACCESS_item_tt, 0, 
# 57 "../crypto/x509/v3_info.c" 3 4
((void *)0)
# 57 "../crypto/x509/v3_info.c"
, 0, "AUTHORITY_INFO_ACCESS" }; return &local_it; }

AUTHORITY_INFO_ACCESS *d2i_AUTHORITY_INFO_ACCESS(AUTHORITY_INFO_ACCESS **a, const unsigned char **in, long len) { return (AUTHORITY_INFO_ACCESS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (AUTHORITY_INFO_ACCESS_it())); } int i2d_AUTHORITY_INFO_ACCESS(const AUTHORITY_INFO_ACCESS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (AUTHORITY_INFO_ACCESS_it())); } AUTHORITY_INFO_ACCESS *AUTHORITY_INFO_ACCESS_new(void) { return (AUTHORITY_INFO_ACCESS *)ASN1_item_new((AUTHORITY_INFO_ACCESS_it())); } void AUTHORITY_INFO_ACCESS_free(AUTHORITY_INFO_ACCESS *a) { ASN1_item_free((ASN1_VALUE *)a, (AUTHORITY_INFO_ACCESS_it())); }
    ...
    struct stack_st_CONF_VALUE *ret)
{
    ...
    char objtmp[80], *ntmp;
    CONF_VALUE *vtmp;
    struct stack_st_CONF_VALUE *tret = ret;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ACCESS_DESCRIPTION_sk_type(ainfo)); i++) {
        struct stack_st_CONF_VALUE *tmp;

        desc = ((ACCESS_DESCRIPTION *)OPENSSL_sk_value(ossl_check_const_ACCESS_DESCRIPTION_sk_type(ainfo), (i)));
        tmp = i2v_GENERAL_NAME(method, desc->location, tret);
        if (tmp == 
# 76 "../crypto/x509/v3_info.c" 3 4
                  ((void *)0)
# 76 "../crypto/x509/v3_info.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_info.c",77,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 77 "../crypto/x509/v3_info.c" 3 4
           ((void *)0)
# 77 "../crypto/x509/v3_info.c"
           );
            goto err;
        }
        tret = tmp;
        vtmp = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(tret), (i)));
        i2t_ASN1_OBJECT(objtmp, sizeof(objtmp), desc->method);
        nlen = strlen(objtmp) + 3 + strlen(vtmp->name) + 1;
        ntmp = CRYPTO_malloc(nlen, "../crypto/x509/v3_info.c", 84);
        if (ntmp == 
# 85 "../crypto/x509/v3_info.c" 3 4
                   ((void *)0)
# 85 "../crypto/x509/v3_info.c"
                       )
            goto err;
        BIO_snprintf(ntmp, nlen, "%s - %s", objtmp, vtmp->name);
        CRYPTO_free(vtmp->name, "../crypto/x509/v3_info.c", 88);
        vtmp->name = ntmp;
    }
    if (ret == 
# 91 "../crypto/x509/v3_info.c" 3 4
              ((void *)0) 
# 91 "../crypto/x509/v3_info.c"
                   && tret == 
# 91 "../crypto/x509/v3_info.c" 3 4
                              ((void *)0)
# 91 "../crypto/x509/v3_info.c"
 ...
 err:
    if (ret == 
# 96 "../crypto/x509/v3_info.c" 3 4
              ((void *)0) 
# 96 "../crypto/x509/v3_info.c"
                   && tret != 
# 96 "../crypto/x509/v3_info.c" 3 4
                              ((void *)0)
# 96 "../crypto/x509/v3_info.c"
                                  )
        OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(tret),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return 
# 98 "../crypto/x509/v3_info.c" 3 4
          ((void *)0)
# 98 "../crypto/x509/v3_info.c"
              ;
}
...
# 107 "../crypto/x509/v3_info.c" 3 4
                                  ((void *)0)
# 107 "../crypto/x509/v3_info.c"
                                      ;
    CONF_VALUE *cnf, ctmp;
    ...
    if ((ainfo = ((struct stack_st_ACCESS_DESCRIPTION *)OPENSSL_sk_new_reserve(ossl_check_ACCESS_DESCRIPTION_compfunc_type(
# 114 "../crypto/x509/v3_info.c" 3 4
                ((void *)0)
# 114 "../crypto/x509/v3_info.c"
                ), (num)))) == 
# 114 "../crypto/x509/v3_info.c" 3 4
                                                                 ((void *)0)
# 114 "../crypto/x509/v3_info.c"
                                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_info.c",115,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 115 "../crypto/x509/v3_info.c" 3 4
       ((void *)0)
# 115 "../crypto/x509/v3_info.c"
       );
        return 
# 116 "../crypto/x509/v3_info.c" 3 4
              ((void *)0)
# 116 "../crypto/x509/v3_info.c"
                  ;
    }
    for (i = 0; i < num; i++) {
        cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (i)));
        if ((acc = ACCESS_DESCRIPTION_new()) == 
# 120 "../crypto/x509/v3_info.c" 3 4
                                               ((void *)0)
# 120 "../crypto/x509/v3_info.c"
                                                   ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_info.c",121,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 121 "../crypto/x509/v3_info.c" 3 4
           ((void *)0)
# 121 "../crypto/x509/v3_info.c"
           );
            goto err;
        }
        OPENSSL_sk_push(ossl_check_ACCESS_DESCRIPTION_sk_type(ainfo), ossl_check_ACCESS_DESCRIPTION_type(acc));
        ptmp = strchr(cnf->name, ';');
        if (ptmp == 
# 126 "../crypto/x509/v3_info.c" 3 4
                   ((void *)0)
# 126 "../crypto/x509/v3_info.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_info.c",127,__func__), ERR_set_error)((34),(143),
# 127 "../crypto/x509/v3_info.c" 3 4
           ((void *)0)
# 127 "../crypto/x509/v3_info.c"
           );
            goto err;
        }
        ctmp.name = ptmp + 1;
        ...
        if (!v2i_GENERAL_NAME_ex(acc->location, method, ctx, &ctmp, 0))
            goto err;
        if ((objtmp = CRYPTO_strndup(cnf->name, ptmp - cnf->name, "../crypto/x509/v3_info.c", 134)) == 
# 134 "../crypto/x509/v3_info.c" 3 4
                                                                      ((void *)0)
# 134 "../crypto/x509/v3_info.c"
                                                                          )
            goto err;
        acc->method = OBJ_txt2obj(objtmp, 0);
        if (!acc->method) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_info.c",138,__func__), ERR_set_error)(34, 119,
                           "value=%s", objtmp);
            CRYPTO_free(objtmp, "../crypto/x509/v3_info.c", 140);
            goto err;
        }
        CRYPTO_free(objtmp, "../crypto/x509/v3_info.c", 143);
    }
    return ainfo;
 err:
    OPENSSL_sk_pop_free(ossl_check_ACCESS_DESCRIPTION_sk_type(ainfo),ossl_check_ACCESS_DESCRIPTION_freefunc_type(ACCESS_DESCRIPTION_free));
    return 
# 148 "../crypto/x509/v3_info.c" 3 4
          ((void *)0)
# 148 "../crypto/x509/v3_info.c"
              ;
}
