# 0 "../crypto/x509/v3_utl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_utl.c"
# 12 "../crypto/x509/v3_utl.c"
...
# 24 "../crypto/x509/v3_utl.c" 2

static char *strip_spaces(char *name);
static int sk_strcmp(const char *const *a, const char *const *b);
static struct stack_st_OPENSSL_STRING *get_email(const X509_NAME *name,
                                           GENERAL_NAMES *gens);
static void str_free(OPENSSL_STRING str);
static int append_ia5(struct stack_st_OPENSSL_STRING **sk,
...
{
    CONF_VALUE *vtmp = 
# 43 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 43 "../crypto/x509/v3_utl.c"
                          ;
    char *tname = 
# 44 "../crypto/x509/v3_utl.c" 3 4
                 ((void *)0)
# 44 "../crypto/x509/v3_utl.c"
                     , *tvalue = 
# 44 "../crypto/x509/v3_utl.c" 3 4
                                 ((void *)0)
# 44 "../crypto/x509/v3_utl.c"
                                     ;
    int sk_allocated = (*extlist == 
# 45 "../crypto/x509/v3_utl.c" 3 4
                                   ((void *)0)
# 45 "../crypto/x509/v3_utl.c"
                                       );

    if (name != 
# 47 "../crypto/x509/v3_utl.c" 3 4
               ((void *)0) 
# 47 "../crypto/x509/v3_utl.c"
                    && (tname = CRYPTO_strdup(name, "../crypto/x509/v3_utl.c", 47)) == 
# 47 "../crypto/x509/v3_utl.c" 3 4
                                                         ((void *)0)
# 47 "../crypto/x509/v3_utl.c"
                                                             )
        goto err;
    if (value != 
# 49 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 49 "../crypto/x509/v3_utl.c"
                    ) {

        if (memchr(value, 0, vallen) != 
# 51 "../crypto/x509/v3_utl.c" 3 4
                                       ((void *)0)
# 51 "../crypto/x509/v3_utl.c"
                                           )
            goto err;
        tvalue = CRYPTO_strndup(value, vallen, "../crypto/x509/v3_utl.c", 53);
        if (tvalue == 
# 54 "../crypto/x509/v3_utl.c" 3 4
                     ((void *)0)
# 54 "../crypto/x509/v3_utl.c"
                         )
            goto err;
    }
    if ((vtmp = CRYPTO_malloc(sizeof(*vtmp), "../crypto/x509/v3_utl.c", 57)) == 
# 57 "../crypto/x509/v3_utl.c" 3 4
                                                 ((void *)0)
# 57 "../crypto/x509/v3_utl.c"
                                                     )
        goto err;
    if (sk_allocated && (*extlist = ((struct stack_st_CONF_VALUE *)OPENSSL_sk_new_null())) == 
# 59 "../crypto/x509/v3_utl.c" 3 4
                                                                ((void *)0)
# 59 "../crypto/x509/v3_utl.c"
                                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",60,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 60 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 60 "../crypto/x509/v3_utl.c"
       );
        goto err;
    }
    vtmp->section = 
# 63 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 63 "../crypto/x509/v3_utl.c"
                       ;
    vtmp->name = tname;
    vtmp->value = tvalue;
    if (!OPENSSL_sk_push(ossl_check_CONF_VALUE_sk_type(*extlist), ossl_check_CONF_VALUE_type(vtmp)))
        goto err;
    return 1;
 err:
    if (sk_allocated) {
        OPENSSL_sk_free(ossl_check_CONF_VALUE_sk_type(*extlist));
        *extlist = 
# 72 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 72 "../crypto/x509/v3_utl.c"
                      ;
    }
    CRYPTO_free(vtmp, "../crypto/x509/v3_utl.c", 74);
    CRYPTO_free(tname, "../crypto/x509/v3_utl.c", 75);
    CRYPTO_free(tvalue, "../crypto/x509/v3_utl.c", 76);
    return 0;
}
                     ...
                     struct stack_st_CONF_VALUE **extlist)
{
    return x509v3_add_len_value(name, value,
                                value != 
# 84 "../crypto/x509/v3_utl.c" 3 4
                                        ((void *)0) 
# 84 "../crypto/x509/v3_utl.c"
                                             ? strlen((const char *)value) : 0,
                                extlist);
}
                           ...
                           struct stack_st_CONF_VALUE **extlist)
{
    return x509v3_add_len_value(name, (const char *)value,
                                value != 
# 92 "../crypto/x509/v3_utl.c" 3 4
                                        ((void *)0) 
# 92 "../crypto/x509/v3_utl.c"
                                             ? strlen((const char *)value) : 0,
                                extlist);
}
...
void X509V3_conf_free(CONF_VALUE *conf)
{
    if (!conf)
        return;
    CRYPTO_free(conf->name, "../crypto/x509/v3_utl.c", 108);
    CRYPTO_free(conf->value, "../crypto/x509/v3_utl.c", 109);
    CRYPTO_free(conf->section, "../crypto/x509/v3_utl.c", 110);
    CRYPTO_free(conf, "../crypto/x509/v3_utl.c", 111);
}
...
static char *bignum_to_string(const BIGNUM *bn)
{
    ...
    tmp = BN_bn2hex(bn);
    if (tmp == 
# 144 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 144 "../crypto/x509/v3_utl.c"
                  )
        return 
# 145 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 145 "../crypto/x509/v3_utl.c"
                  ;

    len = strlen(tmp) + 3;
    ret = CRYPTO_malloc(len, "../crypto/x509/v3_utl.c", 148);
    if (ret == 
# 149 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 149 "../crypto/x509/v3_utl.c"
                  ) {
        CRYPTO_free(tmp, "../crypto/x509/v3_utl.c", 150);
        return 
# 151 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 151 "../crypto/x509/v3_utl.c"
                  ;
    }
    ...
    CRYPTO_free(tmp, "../crypto/x509/v3_utl.c", 162);
    return ret;
}
...
{
    BIGNUM *bntmp = 
# 168 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 168 "../crypto/x509/v3_utl.c"
                       ;
    char *strtmp = 
# 169 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 169 "../crypto/x509/v3_utl.c"
                      ;

    if (!a)
        return 
# 172 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 172 "../crypto/x509/v3_utl.c"
                  ;
    if ((bntmp = ASN1_ENUMERATED_to_BN(a, 
# 173 "../crypto/x509/v3_utl.c" 3 4
                                         ((void *)0)
# 173 "../crypto/x509/v3_utl.c"
                                             )) == 
# 173 "../crypto/x509/v3_utl.c" 3 4
                                                   ((void *)0)
# 173 "../crypto/x509/v3_utl.c"
                                                       )
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",174,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 174 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 174 "../crypto/x509/v3_utl.c"
       );
    else if ((strtmp = bignum_to_string(bntmp)) == 
# 175 "../crypto/x509/v3_utl.c" 3 4
                                                  ((void *)0)
# 175 "../crypto/x509/v3_utl.c"
                                                      )
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",176,__func__), ERR_set_error)((34),((34 | (0x2 << 18L))),
# 176 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 176 "../crypto/x509/v3_utl.c"
       );
    BN_free(bntmp);
    return strtmp;
}
...
{
    BIGNUM *bntmp = 
# 183 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 183 "../crypto/x509/v3_utl.c"
                       ;
    char *strtmp = 
# 184 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 184 "../crypto/x509/v3_utl.c"
                      ;

    if (!a)
        return 
# 187 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 187 "../crypto/x509/v3_utl.c"
                  ;
    if ((bntmp = ASN1_INTEGER_to_BN(a, 
# 188 "../crypto/x509/v3_utl.c" 3 4
                                      ((void *)0)
# 188 "../crypto/x509/v3_utl.c"
                                          )) == 
# 188 "../crypto/x509/v3_utl.c" 3 4
                                                ((void *)0)
# 188 "../crypto/x509/v3_utl.c"
                                                    )
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",189,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 189 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 189 "../crypto/x509/v3_utl.c"
       );
    else if ((strtmp = bignum_to_string(bntmp)) == 
# 190 "../crypto/x509/v3_utl.c" 3 4
                                                  ((void *)0)
# 190 "../crypto/x509/v3_utl.c"
                                                      )
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",191,__func__), ERR_set_error)((34),((34 | (0x2 << 18L))),
# 191 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 191 "../crypto/x509/v3_utl.c"
       );
    BN_free(bntmp);
    return strtmp;
}
...
{
    BIGNUM *bn = 
# 198 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 198 "../crypto/x509/v3_utl.c"
                    ;
    ASN1_INTEGER *aint;
    int isneg, ishex;
    int ret;
    ...
    if (value == 
# 203 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 203 "../crypto/x509/v3_utl.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",204,__func__), ERR_set_error)((34),(109),
# 204 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 204 "../crypto/x509/v3_utl.c"
       );
        return 
# 205 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 205 "../crypto/x509/v3_utl.c"
                  ;
    }
    bn = BN_new();
    if (bn == 
# 208 "../crypto/x509/v3_utl.c" 3 4
             ((void *)0)
# 208 "../crypto/x509/v3_utl.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",209,__func__), ERR_set_error)((34),((3 | (0x2 << 18L))),
# 209 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 209 "../crypto/x509/v3_utl.c"
       );
        return 
# 210 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 210 "../crypto/x509/v3_utl.c"
                  ;
    }
    if (value[0] == '-') {
        value++;
    ...
    if (!ret || value[ret]) {
        BN_free(bn);
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",233,__func__), ERR_set_error)((34),(100),
# 233 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 233 "../crypto/x509/v3_utl.c"
       );
        return 
# 234 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 234 "../crypto/x509/v3_utl.c"
                  ;
    }
...
# 240 "../crypto/x509/v3_utl.c" 3 4
                                 ((void *)0)
# 240 "../crypto/x509/v3_utl.c"
                                     );
    BN_free(bn);
    if (!aint) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",243,__func__), ERR_set_error)((34),(101),
# 243 "../crypto/x509/v3_utl.c" 3 4
       ((void *)0)
# 243 "../crypto/x509/v3_utl.c"
       );
        return 
# 244 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 244 "../crypto/x509/v3_utl.c"
                  ;
    }
    if (isneg)
        aint->type |= 0x100;
...
# 259 "../crypto/x509/v3_utl.c" 3 4
                                  ((void *)0)
# 259 "../crypto/x509/v3_utl.c"
                                      , aint)) == 
# 259 "../crypto/x509/v3_utl.c" 3 4
                                                  ((void *)0)
# 259 "../crypto/x509/v3_utl.c"
    ...
    CRYPTO_free(strtmp, "../crypto/x509/v3_utl.c", 262);
    return ret;
}
...
int X509V3_get_value_bool(const CONF_VALUE *value, int *asn1_bool)
{
    ...
    if ((btmp = value->value) == 
# 270 "../crypto/x509/v3_utl.c" 3 4
                                ((void *)0)
# 270 "../crypto/x509/v3_utl.c"
                                    )
        goto err;
 ...
 err:
    (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",291,__func__), ERR_set_error)((34),(104),
# 291 "../crypto/x509/v3_utl.c" 3 4
   ((void *)0)
# 291 "../crypto/x509/v3_utl.c"
   );
...
# 300 "../crypto/x509/v3_utl.c" 3 4
                                ((void *)0)
# 300 "../crypto/x509/v3_utl.c"
                                    , value->value)) == 
# 300 "../crypto/x509/v3_utl.c" 3 4
                                                        ((void *)0)
# 300 "../crypto/x509/v3_utl.c"
...
# 315 "../crypto/x509/v3_utl.c"
struct stack_st_CONF_VALUE *X509V3_parse_list(const char *line)
{
    char *p, *q, c;
    char *ntmp, *vtmp;
    struct stack_st_CONF_VALUE *values = 
# 319 "../crypto/x509/v3_utl.c" 3 4
                                  ((void *)0)
# 319 "../crypto/x509/v3_utl.c"
                                      ;
    char *linebuf;
    int state;


    linebuf = CRYPTO_strdup(line, "../crypto/x509/v3_utl.c", 324);
    if (linebuf == 
# 325 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 325 "../crypto/x509/v3_utl.c"
                      )
        goto err;
    state = 1;
    ntmp = 
# 328 "../crypto/x509/v3_utl.c" 3 4
          ((void *)0)
# 328 "../crypto/x509/v3_utl.c"
              ;
        ...
        case 1:
            if (c == ':') {
                ...
                *p = 0;
                ntmp = strip_spaces(q);
                if (!ntmp) {
                    (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",340,__func__), ERR_set_error)((34),(108),
# 340 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 340 "../crypto/x509/v3_utl.c"
                   );
                    goto err;
                }
                q = p + 1;
                ...
                *p = 0;
                ...
                q = p + 1;
                if (!ntmp) {
                    (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",349,__func__), ERR_set_error)((34),(108),
# 349 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 349 "../crypto/x509/v3_utl.c"
                   );
                    goto err;
                }
                if (!X509V3_add_value(ntmp, 
# 352 "../crypto/x509/v3_utl.c" 3 4
                                           ((void *)0)
# 352 "../crypto/x509/v3_utl.c"
                                               , &values)) {
                    goto err;
                }
            }
        ...
        case 2:
            if (c == ',') {
                ...
                *p = 0;
                vtmp = strip_spaces(q);
                if (!vtmp) {
                    (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",364,__func__), ERR_set_error)((34),(109),
# 364 "../crypto/x509/v3_utl.c" 3 4
                   ((void *)0)
# 364 "../crypto/x509/v3_utl.c"
                ...
                ntmp = 
# 370 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 370 "../crypto/x509/v3_utl.c"
                          ;
                q = p + 1;
            }
    ...
    if (state == 2) {
        vtmp = strip_spaces(q);
        if (!vtmp) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",380,__func__), ERR_set_error)((34),(109),
# 380 "../crypto/x509/v3_utl.c" 3 4
           ((void *)0)
# 380 "../crypto/x509/v3_utl.c"
           );
            goto err;
        }
        if (!X509V3_add_value(ntmp, vtmp, &values)) {
        ...
        ntmp = strip_spaces(q);
        if (!ntmp) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_utl.c",389,__func__), ERR_set_error)((34),(108),
# 389 "../crypto/x509/v3_utl.c" 3 4
           ((void *)0)
# 389 "../crypto/x509/v3_utl.c"
           );
            goto err;
        }
        if (!X509V3_add_value(ntmp, 
# 392 "../crypto/x509/v3_utl.c" 3 4
                                   ((void *)0)
# 392 "../crypto/x509/v3_utl.c"
                                       , &values)) {
            goto err;
        }
    }
    CRYPTO_free(linebuf, "../crypto/x509/v3_utl.c", 396);
    return values;

 err:
    CRYPTO_free(linebuf, "../crypto/x509/v3_utl.c", 400);
    OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(values),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return 
# 402 "../crypto/x509/v3_utl.c" 3 4
          ((void *)0)
# 402 "../crypto/x509/v3_utl.c"
              ;
...
static char *strip_spaces(char *name)
{
    ...
    p = name;
    while (*p && (ossl_ctype_check((*p), 0x8)))
        p++;
    if (*p == '\0')
        return 
# 416 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 416 "../crypto/x509/v3_utl.c"
                  ;
    q = p + strlen(p) - 1;
    while ((q != p) && (ossl_ctype_check((*q), 0x8)))
        q--;
    if (p != q)
        q[1] = 0;
    if (*p == '\0')
        return 
# 423 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 423 "../crypto/x509/v3_utl.c"
                  ;
    return p;
}
...
# 456 "../crypto/x509/v3_utl.c" 3 4
                                                    ((void *)0)
# 456 "../crypto/x509/v3_utl.c"
                                                        , 
# 456 "../crypto/x509/v3_utl.c" 3 4
                                                          ((void *)0)
# 456 "../crypto/x509/v3_utl.c"
    ...
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAME_sk_type(gens),ossl_check_GENERAL_NAME_freefunc_type(GENERAL_NAME_free));
    return ret;
}
...
struct stack_st_OPENSSL_STRING *X509_get1_ocsp(X509 *x)
{
    ...
    struct stack_st_OPENSSL_STRING *ret = 
# 465 "../crypto/x509/v3_utl.c" 3 4
                                   ((void *)0)
# 465 "../crypto/x509/v3_utl.c"
                                       ;
    int i;

    info = X509_get_ext_d2i(x, 177, 
# 468 "../crypto/x509/v3_utl.c" 3 4
                                               ((void *)0)
# 468 "../crypto/x509/v3_utl.c"
                                                   , 
# 468 "../crypto/x509/v3_utl.c" 3 4
                                                     ((void *)0)
# 468 "../crypto/x509/v3_utl.c"
    ...
    if (!info)
        return 
# 470 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 470 "../crypto/x509/v3_utl.c"
                  ;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ACCESS_DESCRIPTION_sk_type(info)); i++) {
        ACCESS_DESCRIPTION *ad = ((ACCESS_DESCRIPTION *)OPENSSL_sk_value(ossl_check_const_ACCESS_DESCRIPTION_sk_type(info), (i)));
...
# 492 "../crypto/x509/v3_utl.c" 3 4
                                                     ((void *)0)
# 492 "../crypto/x509/v3_utl.c"
                                                         , 
# 492 "../crypto/x509/v3_utl.c" 3 4
                                                           ((void *)0)
# 492 "../crypto/x509/v3_utl.c"
...
{
    struct stack_st_OPENSSL_STRING *ret = 
# 502 "../crypto/x509/v3_utl.c" 3 4
                                   ((void *)0)
# 502 "../crypto/x509/v3_utl.c"
                                       ;
    X509_NAME_ENTRY *ne;
    const ASN1_IA5STRING *email;
    GENERAL_NAME *gen;
    ...
    while ((i = X509_NAME_get_index_by_NID(name,
        ...
        if (!append_ia5(&ret, email))
            return 
# 515 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 515 "../crypto/x509/v3_utl.c"
                      ;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gens)); i++) {
        gen = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gens), (i)));
        if (gen->type != 1)
            continue;
        if (!append_ia5(&ret, gen->d.ia5))
            return 
# 522 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 522 "../crypto/x509/v3_utl.c"
                      ;
    }
    return ret;
}
...
static void str_free(OPENSSL_STRING str)
{
    CRYPTO_free(str, "../crypto/x509/v3_utl.c", 529);
}
                      ...
                      const ASN1_IA5STRING *email)
{
    ...
    if (email->type != 22)
        return 1;
    if (email->data == 
# 540 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0) 
# 540 "../crypto/x509/v3_utl.c"
                           || email->length == 0)
        return 1;
    if (memchr(email->data, 0, email->length) != 
# 542 "../crypto/x509/v3_utl.c" 3 4
                                                ((void *)0)
# 542 "../crypto/x509/v3_utl.c"
                                                    )
        return 1;
    if (*sk == 
# 544 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 544 "../crypto/x509/v3_utl.c"
                  )
        *sk = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new(ossl_check_OPENSSL_STRING_compfunc_type(sk_strcmp)));
    if (*sk == 
# 546 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 546 "../crypto/x509/v3_utl.c"
                  )
        return 0;

    emtmp = CRYPTO_strndup((char *)email->data, email->length, "../crypto/x509/v3_utl.c", 549);
    if (emtmp == 
# 550 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 550 "../crypto/x509/v3_utl.c"
                    ) {
        X509_email_free(*sk);
        *sk = 
# 552 "../crypto/x509/v3_utl.c" 3 4
             ((void *)0)
# 552 "../crypto/x509/v3_utl.c"
                 ;
        return 0;
    }


    if (OPENSSL_sk_find(ossl_check_OPENSSL_STRING_sk_type(*sk), ossl_check_OPENSSL_STRING_type(emtmp)) != -1) {
        CRYPTO_free(emtmp, "../crypto/x509/v3_utl.c", 558);
        return 1;
    }
    if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(*sk), ossl_check_OPENSSL_STRING_type(emtmp))) {
        CRYPTO_free(emtmp, "../crypto/x509/v3_utl.c", 562);
        X509_email_free(*sk);
        *sk = 
# 564 "../crypto/x509/v3_utl.c" 3 4
             ((void *)0)
# 564 "../crypto/x509/v3_utl.c"
                 ;
        return 0;
    }
    return 1;
...
void X509_email_free(struct stack_st_OPENSSL_STRING *sk)
{
    OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(sk),ossl_check_OPENSSL_STRING_freefunc_type(str_free));
}
                          ...
                          unsigned int flags)
{
    ...
    if (!allow_idna &&
        subject_len >= 4 && (OPENSSL_strncasecmp((const char *)subject, "xn--" "", sizeof("xn--") - 1) == 0))
        return 0;
                                       ...
                                       unsigned int flags)
{
    ...
    for (i = 0; i < len; ++i) {
        ...
        if (p[i] == '*') {
            ...
            if (star != 
# 763 "../crypto/x509/v3_utl.c" 3 4
                       ((void *)0) 
# 763 "../crypto/x509/v3_utl.c"
                            || (state & (1 << 3)) != 0 || dots)
                return 
# 764 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 764 "../crypto/x509/v3_utl.c"
                          ;

            if ((flags & 0x4)
                && (!atstart || !atend))
                return 
# 768 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 768 "../crypto/x509/v3_utl.c"
                          ;

            if (!atstart && !atend)
                return 
# 771 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 771 "../crypto/x509/v3_utl.c"
                          ;
            star = &p[i];
            state &= ~(1 << 0);
        } else if (('a' <= p[i] && p[i] <= 'z')
                   ...
                   || ('0' <= p[i] && p[i] <= '9')) {
            if ((state & (1 << 0)) != 0
                && len - i >= 4 && (OPENSSL_strncasecmp((const char *)&p[i], "xn--" "", sizeof("xn--") - 1) == 0))
                state |= (1 << 3);
            state &= ~((1 << 2) | (1 << 0));
        } else if (p[i] == '.') {
            if ((state & ((1 << 2) | (1 << 0))) != 0)
                return 
# 783 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 783 "../crypto/x509/v3_utl.c"
                          ;
            state = (1 << 0);
            ++dots;
        } else if (p[i] == '-') {
            ...
            if ((state & (1 << 0)) != 0)
                return 
# 789 "../crypto/x509/v3_utl.c" 3 4
                      ((void *)0)
# 789 "../crypto/x509/v3_utl.c"
                          ;
            state |= (1 << 2);
        } else {
            return 
# 792 "../crypto/x509/v3_utl.c" 3 4
                  ((void *)0)
# 792 "../crypto/x509/v3_utl.c"
                      ;
        }
    }
    ...
    if ((state & ((1 << 0) | (1 << 2))) != 0 || dots < 2)
        return 
# 801 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 801 "../crypto/x509/v3_utl.c"
                  ;
    return star;
}
...
# 810 "../crypto/x509/v3_utl.c" 3 4
                               ((void *)0)
# 810 "../crypto/x509/v3_utl.c"
                                   ;
    ...
    if (star == 
# 818 "../crypto/x509/v3_utl.c" 3 4
               ((void *)0)
# 818 "../crypto/x509/v3_utl.c"
                   )
                           ...
                           char **peername)
{
    ...
    if (cmp_type > 0) {
        ...
        if (cmp_type == 22)
            ...
            rv = 1;
        if (rv > 0 && peername != 
# 847 "../crypto/x509/v3_utl.c" 3 4
                                 ((void *)0)
# 847 "../crypto/x509/v3_utl.c"
                                     ) {
            *peername = CRYPTO_strndup((char *)a->data, a->length, "../crypto/x509/v3_utl.c", 848);
            if (*peername == 
# 849 "../crypto/x509/v3_utl.c" 3 4
                            ((void *)0)
# 849 "../crypto/x509/v3_utl.c"
                                )
                return -1;
        }
    } else {
        ...
        if (rv > 0 && peername != 
# 864 "../crypto/x509/v3_utl.c" 3 4
                                 ((void *)0)
# 864 "../crypto/x509/v3_utl.c"
                                     ) {
            *peername = CRYPTO_strndup((char *)astr, astrlen, "../crypto/x509/v3_utl.c", 865);
            if (*peername == 
# 866 "../crypto/x509/v3_utl.c" 3 4
                            ((void *)0)
# 866 "../crypto/x509/v3_utl.c"
                                ) {
                CRYPTO_free(astr, "../crypto/x509/v3_utl.c", 867);
                return -1;
            }
        }
        CRYPTO_free(astr, "../crypto/x509/v3_utl.c", 871);
    }
    return rv;
}
...
{
    GENERAL_NAMES *gens = 
# 879 "../crypto/x509/v3_utl.c" 3 4
                         ((void *)0)
# 879 "../crypto/x509/v3_utl.c"
                             ;
    const X509_NAME *name = 
# 880 "../crypto/x509/v3_utl.c" 3 4
                           ((void *)0)
# 880 "../crypto/x509/v3_utl.c"
                               ;
    int i;
    int cnid = 0;
    int alt_type;
    ...
    gens = X509_get_ext_d2i(x, 85, 
# 912 "../crypto/x509/v3_utl.c" 3 4
                                                    ((void *)0)
# 912 "../crypto/x509/v3_utl.c"
                                                        , 
# 912 "../crypto/x509/v3_utl.c" 3 4
                                                          ((void *)0)
# 912 "../crypto/x509/v3_utl.c"
  ...
  switch (OBJ_obj2nid(gen->d.otherName->type_id)) {
                default:
                    continue;
                case 1208:
# 952 "../crypto/x509/v3_utl.c"
                    if (check_type != 1
                        || gen->d.otherName->value->type != 12)
                        continue;
                    alt_type = 0;
        ...
        if (rv != 0)
            return rv;
        if (san_present && !(flags & 0x1))
            return 0;
    }


    if (cnid == 0 || (flags & 0x20))
        return 0;
...
{
    if (chk == 
# 1010 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1010 "../crypto/x509/v3_utl.c"
                  )
        return -2;
    ...
    if (chklen > 1 && chk[chklen - 1] == '\0')
        --chklen;
    return do_x509_check(x, chk, chklen, flags, 2, peername);
}
...
{
    if (chk == 
# 1029 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1029 "../crypto/x509/v3_utl.c"
                  )
        return -2;
    ...
    if (chklen > 1 && chk[chklen - 1] == '\0')
        --chklen;
    return do_x509_check(x, chk, chklen, flags, 1, 
# 1042 "../crypto/x509/v3_utl.c" 3 4
                                                          ((void *)0)
# 1042 "../crypto/x509/v3_utl.c"
                                                              );
}
...
{
    if (chk == 
# 1048 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1048 "../crypto/x509/v3_utl.c"
                  )
        return -2;
    return do_x509_check(x, (char *)chk, chklen, flags, 7, 
# 1050 "../crypto/x509/v3_utl.c" 3 4
                                                                  ((void *)0)
# 1050 "../crypto/x509/v3_utl.c"
                                                                      );
}
...
int X509_check_ip_asc(X509 *x, const char *ipasc, unsigned int flags)
{
    ...
    if (ipasc == 
# 1058 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 1058 "../crypto/x509/v3_utl.c"
                    )
        return -2;
    iplen = (size_t)ossl_a2i_ipadd(ipout, ipasc);
    if (iplen == 0)
        return -2;
    return do_x509_check(x, (char *)ipout, iplen, flags, 7, 
# 1063 "../crypto/x509/v3_utl.c" 3 4
                                                                   ((void *)0)
# 1063 "../crypto/x509/v3_utl.c"
                                                                       );
}
...
char *ossl_ipaddr_to_asc(unsigned char *p, int len)
{
    ...
    return CRYPTO_strdup(buf, "../crypto/x509/v3_utl.c", 1093);
}
...
ASN1_OCTET_STRING *a2i_IPADDRESS(const char *ipasc)
{
    ...
    if (!iplen)
        return 
# 1112 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1112 "../crypto/x509/v3_utl.c"
                  ;

    ret = ASN1_OCTET_STRING_new();
    if (ret == 
# 1115 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1115 "../crypto/x509/v3_utl.c"
                  )
        return 
# 1116 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1116 "../crypto/x509/v3_utl.c"
                  ;
    if (!ASN1_OCTET_STRING_set(ret, ipout, iplen)) {
        ASN1_OCTET_STRING_free(ret);
        return 
# 1119 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1119 "../crypto/x509/v3_utl.c"
                  ;
    }
    return ret;
}
...
{
    ASN1_OCTET_STRING *ret = 
# 1126 "../crypto/x509/v3_utl.c" 3 4
                            ((void *)0)
# 1126 "../crypto/x509/v3_utl.c"
                                ;
    unsigned char ipout[32];
    char *iptmp = 
# 1128 "../crypto/x509/v3_utl.c" 3 4
                 ((void *)0)
# 1128 "../crypto/x509/v3_utl.c"
                     , *p;
    int iplen1, iplen2;

    p = strchr(ipasc, '/');
    if (p == 
# 1132 "../crypto/x509/v3_utl.c" 3 4
            ((void *)0)
# 1132 "../crypto/x509/v3_utl.c"
                )
        return 
# 1133 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1133 "../crypto/x509/v3_utl.c"
                  ;
    iptmp = CRYPTO_strdup(ipasc, "../crypto/x509/v3_utl.c", 1134);
    if (iptmp == 
# 1135 "../crypto/x509/v3_utl.c" 3 4
                ((void *)0)
# 1135 "../crypto/x509/v3_utl.c"
                    )
        return 
# 1136 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1136 "../crypto/x509/v3_utl.c"
                  ;
    p = iptmp + (p - ipasc);
    *p++ = 0;
    ...
    CRYPTO_free(iptmp, "../crypto/x509/v3_utl.c", 1147);
    iptmp = 
# 1148 "../crypto/x509/v3_utl.c" 3 4
           ((void *)0)
# 1148 "../crypto/x509/v3_utl.c"
               ;
    ...
    ret = ASN1_OCTET_STRING_new();
    if (ret == 
# 1154 "../crypto/x509/v3_utl.c" 3 4
              ((void *)0)
# 1154 "../crypto/x509/v3_utl.c"
                  )
        goto err;
 ...
 err:
    CRYPTO_free(iptmp, "../crypto/x509/v3_utl.c", 1162);
    ASN1_OCTET_STRING_free(ret);
    return 
# 1164 "../crypto/x509/v3_utl.c" 3 4
          ((void *)0)
# 1164 "../crypto/x509/v3_utl.c"
              ;
}
