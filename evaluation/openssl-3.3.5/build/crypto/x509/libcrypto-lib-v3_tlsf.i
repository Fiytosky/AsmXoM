# 0 "../crypto/x509/v3_tlsf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_tlsf.c"
# 10 "../crypto/x509/v3_tlsf.c"
...
# 18 "../crypto/x509/v3_tlsf.c" 2

static struct stack_st_CONF_VALUE *i2v_TLS_FEATURE(const X509V3_EXT_METHOD *method,
...
static const ASN1_TEMPLATE TLS_FEATURE_item_tt =
        { ((0x2 << 1)), (0), 0, "TLS_FEATURE", (ASN1_INTEGER_it) }
; static const ASN1_ITEM * TLS_FEATURE_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &TLS_FEATURE_item_tt, 0, 
# 28 "../crypto/x509/v3_tlsf.c" 3 4
((void *)0)
# 28 "../crypto/x509/v3_tlsf.c"
, 0, "TLS_FEATURE" }; return &local_it; }

TLS_FEATURE *TLS_FEATURE_new(void) { return (TLS_FEATURE *)ASN1_item_new((TLS_FEATURE_it())); } void TLS_FEATURE_free(TLS_FEATURE *a) { ASN1_item_free((ASN1_VALUE *)a, (TLS_FEATURE_it())); }
...
# 40 "../crypto/x509/v3_tlsf.c" 3 4
   ((void *)0)

# 41 "../crypto/x509/v3_tlsf.c"
};
                                             ...
                                             struct stack_st_CONF_VALUE *ext_list)
{
    ...
    ASN1_INTEGER *ai;
    long tlsextid;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_INTEGER_sk_type(tls_feature)); i++) {
        ai = ((ASN1_INTEGER *)OPENSSL_sk_value(ossl_check_const_ASN1_INTEGER_sk_type(tls_feature), (i)));
        tlsextid = ASN1_INTEGER_get(ai);
        for (j = 0; j < (sizeof(tls_feature_tbl)/sizeof((tls_feature_tbl)[0])); j++)
            if (tlsextid == tls_feature_tbl[j].num)
                break;
        if (j < (sizeof(tls_feature_tbl)/sizeof((tls_feature_tbl)[0])))
            X509V3_add_value(
# 75 "../crypto/x509/v3_tlsf.c" 3 4
                            ((void *)0)
# 75 "../crypto/x509/v3_tlsf.c"
                                , tls_feature_tbl[j].name, &ext_list);
        else
            X509V3_add_value_int(
# 77 "../crypto/x509/v3_tlsf.c" 3 4
                                ((void *)0)
# 77 "../crypto/x509/v3_tlsf.c"
                                    , ai, &ext_list);
    }
    return ext_list;
}
                                    ...
                                    X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval)
{
    ...
    char *extval, *endptr;
    ASN1_INTEGER *ai = 
# 92 "../crypto/x509/v3_tlsf.c" 3 4
                      ((void *)0)
# 92 "../crypto/x509/v3_tlsf.c"
                          ;
    CONF_VALUE *val;
    int i;
    size_t j;
    ...
    if ((tlsf = ((struct stack_st_ASN1_INTEGER *)OPENSSL_sk_new_null())) == 
# 98 "../crypto/x509/v3_tlsf.c" 3 4
                                              ((void *)0)
# 98 "../crypto/x509/v3_tlsf.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_tlsf.c",99,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 99 "../crypto/x509/v3_tlsf.c" 3 4
       ((void *)0)
# 99 "../crypto/x509/v3_tlsf.c"
       );
        return 
# 100 "../crypto/x509/v3_tlsf.c" 3 4
              ((void *)0)
# 100 "../crypto/x509/v3_tlsf.c"
                  ;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); i++) {
        val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (i)));
        if (val->value)
            extval = val->value;
        else
            extval = val->name;
        ...
        if (j < (sizeof(tls_feature_tbl)/sizeof((tls_feature_tbl)[0])))
            ...
            if (((*endptr) != '\0') || (extval == endptr) || (tlsextid < 0) ||
                (tlsextid > 65535)) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_tlsf.c",119,__func__), ERR_set_error)((34),(143),
# 119 "../crypto/x509/v3_tlsf.c" 3 4
               ((void *)0)
# 119 "../crypto/x509/v3_tlsf.c"
               );
        ...
        if ((ai = ASN1_INTEGER_new()) == 
# 125 "../crypto/x509/v3_tlsf.c" 3 4
                                        ((void *)0)
                
# 126 "../crypto/x509/v3_tlsf.c"
               || !ASN1_INTEGER_set(ai, tlsextid)
                || OPENSSL_sk_push(ossl_check_ASN1_INTEGER_sk_type(tlsf), ossl_check_ASN1_INTEGER_type(ai)) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_tlsf.c",128,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 128 "../crypto/x509/v3_tlsf.c" 3 4
           ((void *)0)
# 128 "../crypto/x509/v3_tlsf.c"
           );
            goto err;
        }

        ai = 
# 132 "../crypto/x509/v3_tlsf.c" 3 4
            ((void *)0)
# 132 "../crypto/x509/v3_tlsf.c"
                ;
    }
    return tlsf;

 err:
    OPENSSL_sk_pop_free(ossl_check_ASN1_INTEGER_sk_type(tlsf),ossl_check_ASN1_INTEGER_freefunc_type(ASN1_INTEGER_free));
    ASN1_INTEGER_free(ai);
    return 
# 139 "../crypto/x509/v3_tlsf.c" 3 4
          ((void *)0)
# 139 "../crypto/x509/v3_tlsf.c"
              ;
}
