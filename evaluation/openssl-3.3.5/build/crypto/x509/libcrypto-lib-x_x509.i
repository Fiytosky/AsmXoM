# 0 "../crypto/x509/x_x509.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_x509.c"
# 10 "../crypto/x509/x_x509.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 17 "../crypto/x509/x_x509.c" 2

static const ASN1_AUX X509_CINF_aux = {
# 18 "../crypto/x509/x_x509.c" 3 4
((void *)0)
# 18 "../crypto/x509/x_x509.c"
, 2, 0, 0, 0, 
# 18 "../crypto/x509/x_x509.c" 3 4
__builtin_offsetof (
# 18 "../crypto/x509/x_x509.c"
...
# 18 "../crypto/x509/x_x509.c"
        ...
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 19 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 19 "../crypto/x509/x_x509.c"
       X509_CINF
# 19 "../crypto/x509/x_x509.c" 3 4
       , 
# 19 "../crypto/x509/x_x509.c"
...
# 19 "../crypto/x509/x_x509.c"
       , "version", (ASN1_INTEGER_it) },
        { ((0x1 << 12)), (0), 
# 20 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/x509/x_x509.c"
       X509_CINF
# 20 "../crypto/x509/x_x509.c" 3 4
       , 
# 20 "../crypto/x509/x_x509.c"
...
# 20 "../crypto/x509/x_x509.c"
       , "serialNumber", (ASN1_INTEGER_it) },
        { ((0x1 << 12)), (0), 
# 21 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 21 "../crypto/x509/x_x509.c"
       X509_CINF
# 21 "../crypto/x509/x_x509.c" 3 4
       , 
# 21 "../crypto/x509/x_x509.c"
...
# 21 "../crypto/x509/x_x509.c"
       , "signature", (X509_ALGOR_it) },
        { (0), (0), 
# 22 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 22 "../crypto/x509/x_x509.c"
       X509_CINF
# 22 "../crypto/x509/x_x509.c" 3 4
       , 
# 22 "../crypto/x509/x_x509.c"
...
# 22 "../crypto/x509/x_x509.c"
       , "issuer", (X509_NAME_it) },
        { ((0x1 << 12)), (0), 
# 23 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 23 "../crypto/x509/x_x509.c"
       X509_CINF
# 23 "../crypto/x509/x_x509.c" 3 4
       , 
# 23 "../crypto/x509/x_x509.c"
...
# 23 "../crypto/x509/x_x509.c"
       , "validity", (X509_VAL_it) },
        { (0), (0), 
# 24 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 24 "../crypto/x509/x_x509.c"
       X509_CINF
# 24 "../crypto/x509/x_x509.c" 3 4
       , 
# 24 "../crypto/x509/x_x509.c"
...
# 24 "../crypto/x509/x_x509.c"
       , "subject", (X509_NAME_it) },
        { (0), (0), 
# 25 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 25 "../crypto/x509/x_x509.c"
       X509_CINF
# 25 "../crypto/x509/x_x509.c" 3 4
       , 
# 25 "../crypto/x509/x_x509.c"
...
# 25 "../crypto/x509/x_x509.c"
       , "key", (X509_PUBKEY_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 26 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 26 "../crypto/x509/x_x509.c"
       X509_CINF
# 26 "../crypto/x509/x_x509.c" 3 4
       , 
# 26 "../crypto/x509/x_x509.c"
...
# 26 "../crypto/x509/x_x509.c"
       , "issuerUID", (ASN1_BIT_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 27 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 27 "../crypto/x509/x_x509.c"
       X509_CINF
# 27 "../crypto/x509/x_x509.c" 3 4
       , 
# 27 "../crypto/x509/x_x509.c"
...
# 27 "../crypto/x509/x_x509.c"
       , "subjectUID", (ASN1_BIT_STRING_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (3), 
# 28 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 28 "../crypto/x509/x_x509.c"
       X509_CINF
# 28 "../crypto/x509/x_x509.c" 3 4
       , 
# 28 "../crypto/x509/x_x509.c"
...
} ; const ASN1_ITEM * X509_CINF_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_CINF_seq_tt, sizeof(X509_CINF_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_CINF_aux, sizeof(X509_CINF), "X509_CINF" }; return &local_it; }

X509_CINF *d2i_X509_CINF(X509_CINF **a, const unsigned char **in, long len) { return (X509_CINF *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_CINF_it())); } int i2d_X509_CINF(const X509_CINF *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_CINF_it())); } X509_CINF *X509_CINF_new(void) { return (X509_CINF *)ASN1_item_new((X509_CINF_it())); } void X509_CINF_free(X509_CINF *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_CINF_it())); }
                   ...
                   void *exarg)
{
    ...
    case 4:
        CRYPTO_free_ex_data(3, ret, &ret->ex_data);
        ...
        OPENSSL_sk_pop_free(ossl_check_IPAddressFamily_sk_type(ret->rfc3779_addr),ossl_check_IPAddressFamily_freefunc_type(IPAddressFamily_free));
    ...
    case 1:
        ...
        ret->ex_pcpathlen = -1;
        ret->skid = 
# 68 "../crypto/x509/x_x509.c" 3 4
                   ((void *)0)
# 68 "../crypto/x509/x_x509.c"
                       ;
        ret->akid = 
# 69 "../crypto/x509/x_x509.c" 3 4
                   ((void *)0)
# 69 "../crypto/x509/x_x509.c"
                       ;
        ret->policy_cache = 
# 70 "../crypto/x509/x_x509.c" 3 4
                           ((void *)0)
# 70 "../crypto/x509/x_x509.c"
                               ;
        ret->altname = 
# 71 "../crypto/x509/x_x509.c" 3 4
                      ((void *)0)
# 71 "../crypto/x509/x_x509.c"
                          ;
        ret->nc = 
# 72 "../crypto/x509/x_x509.c" 3 4
                 ((void *)0)
# 72 "../crypto/x509/x_x509.c"
                     ;

        ret->rfc3779_addr = 
# 74 "../crypto/x509/x_x509.c" 3 4
                           ((void *)0)
# 74 "../crypto/x509/x_x509.c"
                               ;
        ret->rfc3779_asid = 
# 75 "../crypto/x509/x_x509.c" 3 4
                           ((void *)0)
# 75 "../crypto/x509/x_x509.c"
                               ;

        ret->distinguishing_id = 
# 77 "../crypto/x509/x_x509.c" 3 4
                                ((void *)0)
# 77 "../crypto/x509/x_x509.c"
                                    ;
        ret->aux = 
# 78 "../crypto/x509/x_x509.c" 3 4
                  ((void *)0)
# 78 "../crypto/x509/x_x509.c"
                      ;
        ret->crldp = 
# 79 "../crypto/x509/x_x509.c" 3 4
                    ((void *)0)
# 79 "../crypto/x509/x_x509.c"
                        ;
        if (!CRYPTO_new_ex_data(3, ret, &ret->ex_data))
            return 0;
        break;
    ...
    case 3:
        ...
        ASN1_OCTET_STRING_free(ret->distinguishing_id);
        CRYPTO_free(ret->propq, "../crypto/x509/x_x509.c", 98);
        break;
...
# 132 "../crypto/x509/x_x509.c" 3 4
((void *)0)
# 132 "../crypto/x509/x_x509.c"
, 1, 
# 132 "../crypto/x509/x_x509.c" 3 4
__builtin_offsetof (
# 132 "../crypto/x509/x_x509.c"
...
# 132 "../crypto/x509/x_x509.c"
        ...
        { ((0x1 << 12)), (0), 
# 133 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 133 "../crypto/x509/x_x509.c"
       X509
# 133 "../crypto/x509/x_x509.c" 3 4
       , 
# 133 "../crypto/x509/x_x509.c"
...
# 133 "../crypto/x509/x_x509.c"
       , "cert_info", (X509_CINF_it) },
        { ((0x1 << 12)), (0), 
# 134 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 134 "../crypto/x509/x_x509.c"
       X509
# 134 "../crypto/x509/x_x509.c" 3 4
       , 
# 134 "../crypto/x509/x_x509.c"
...
# 134 "../crypto/x509/x_x509.c"
       , "sig_alg", (X509_ALGOR_it) },
        { ((0x1 << 12)), (0), 
# 135 "../crypto/x509/x_x509.c" 3 4
       __builtin_offsetof (
# 135 "../crypto/x509/x_x509.c"
       X509
# 135 "../crypto/x509/x_x509.c" 3 4
       , 
# 135 "../crypto/x509/x_x509.c"
...
} ; const ASN1_ITEM * X509_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_seq_tt, sizeof(X509_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_aux, sizeof(X509), "X509" }; return &local_it; }

X509 *d2i_X509(X509 **a, const unsigned char **in, long len) { return (X509 *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_it())); } int i2d_X509(const X509 *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_it())); } X509 *X509_new(void) { return (X509 *)ASN1_item_new((X509_it())); } void X509_free(X509 *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_it())); }
X509 * X509_dup(const X509 *x) { return ASN1_item_dup((X509_it()), x); }
...
{
    if (x != 
# 148 "../crypto/x509/x_x509.c" 3 4
            ((void *)0)
# 148 "../crypto/x509/x_x509.c"
                ) {
        x->libctx = libctx;
        CRYPTO_free(x->propq, "../crypto/x509/x_x509.c", 150);
        x->propq = 
# 151 "../crypto/x509/x_x509.c" 3 4
                  ((void *)0)
# 151 "../crypto/x509/x_x509.c"
                      ;
        if (propq != 
# 152 "../crypto/x509/x_x509.c" 3 4
                    ((void *)0)
# 152 "../crypto/x509/x_x509.c"
                        ) {
            x->propq = CRYPTO_strdup(propq, "../crypto/x509/x_x509.c", 153);
            if (x->propq == 
# 154 "../crypto/x509/x_x509.c" 3 4
                           ((void *)0)
# 154 "../crypto/x509/x_x509.c"
                               )
                return 0;
        }
    }
...
{
    X509 *cert = 
# 163 "../crypto/x509/x_x509.c" 3 4
                ((void *)0)
# 163 "../crypto/x509/x_x509.c"
                    ;
    ...
    if (!ossl_x509_set0_libctx(cert, libctx, propq)) {
        X509_free(cert);
        cert = 
# 168 "../crypto/x509/x_x509.c" 3 4
              ((void *)0)
# 168 "../crypto/x509/x_x509.c"
                  ;
    }
    return cert;
}
...
X509 *d2i_X509_AUX(X509 **a, const unsigned char **pp, long length)
{
    ...
    if (a == 
# 199 "../crypto/x509/x_x509.c" 3 4
            ((void *)0) 
# 199 "../crypto/x509/x_x509.c"
                 || *a == 
# 199 "../crypto/x509/x_x509.c" 3 4
                          ((void *)0)
# 199 "../crypto/x509/x_x509.c"
    ...
    if (ret == 
# 203 "../crypto/x509/x_x509.c" 3 4
              ((void *)0)
# 203 "../crypto/x509/x_x509.c"
                  )
        return 
# 204 "../crypto/x509/x_x509.c" 3 4
              ((void *)0)
# 204 "../crypto/x509/x_x509.c"
                  ;
 ...
 err:
    if (freeret) {
        ...
        if (a)
            *a = 
# 215 "../crypto/x509/x_x509.c" 3 4
                ((void *)0)
# 215 "../crypto/x509/x_x509.c"
                    ;
    }
    return 
# 217 "../crypto/x509/x_x509.c" 3 4
          ((void *)0)
# 217 "../crypto/x509/x_x509.c"
              ;
}
...
# 229 "../crypto/x509/x_x509.c" 3 4
                                ((void *)0) 
# 229 "../crypto/x509/x_x509.c"
                                     ? *pp : 
# 229 "../crypto/x509/x_x509.c" 3 4
                                             ((void *)0)
# 229 "../crypto/x509/x_x509.c"
    ...
    if (length <= 0 || a == 
# 237 "../crypto/x509/x_x509.c" 3 4
                           ((void *)0)
# 237 "../crypto/x509/x_x509.c"
                               )
        return length;
    ...
    if (tmplen < 0) {
        if (start != 
# 242 "../crypto/x509/x_x509.c" 3 4
                    ((void *)0)
# 242 "../crypto/x509/x_x509.c"
                        )
            *pp = start;
        return tmplen;
    }
...
int i2d_X509_AUX(const X509 *a, unsigned char **pp)
{
    ...
    if (pp == 
# 266 "../crypto/x509/x_x509.c" 3 4
             ((void *)0) 
# 266 "../crypto/x509/x_x509.c"
                  || *pp != 
# 266 "../crypto/x509/x_x509.c" 3 4
                            ((void *)0)
# 266 "../crypto/x509/x_x509.c"
    ...
    if ((length = i2d_x509_aux_internal(a, 
# 270 "../crypto/x509/x_x509.c" 3 4
                                          ((void *)0)
# 270 "../crypto/x509/x_x509.c"
                                              )) <= 0)
        return length;


    *pp = tmp = CRYPTO_malloc(length, "../crypto/x509/x_x509.c", 274);
    if (tmp == 
# 275 "../crypto/x509/x_x509.c" 3 4
              ((void *)0)
# 275 "../crypto/x509/x_x509.c"
                  )
        return -1;
    ...
    if (length <= 0) {
        CRYPTO_free(*pp, "../crypto/x509/x_x509.c", 281);
        *pp = 
# 282 "../crypto/x509/x_x509.c" 3 4
             ((void *)0)
# 282 "../crypto/x509/x_x509.c"
                 ;
    }
    return length;
}
