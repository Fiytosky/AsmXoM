# 0 "../crypto/x509/v3_extku.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_extku.c"
# 10 "../crypto/x509/v3_extku.c"
...
# 16 "../crypto/x509/v3_extku.c" 2

static void *v2i_EXTENDED_KEY_USAGE(const X509V3_EXT_METHOD *method,
                                    X509V3_CTX *ctx,
                                    struct stack_st_CONF_VALUE *nval);
static struct stack_st_CONF_VALUE *i2v_EXTENDED_KEY_USAGE(const X509V3_EXT_METHOD
                                                    *method, void *eku, struct stack_st_CONF_VALUE
                                                    *extlist);
...
# 32 "../crypto/x509/v3_extku.c" 3 4
   ((void *)0)

# 33 "../crypto/x509/v3_extku.c"
};
...
# 44 "../crypto/x509/v3_extku.c" 3 4
   ((void *)0)

# 45 "../crypto/x509/v3_extku.c"
};

static const ASN1_TEMPLATE EXTENDED_KEY_USAGE_item_tt =
        { ((0x2 << 1)), (0), 0, "EXTENDED_KEY_USAGE", (ASN1_OBJECT_it) }
; const ASN1_ITEM * EXTENDED_KEY_USAGE_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &EXTENDED_KEY_USAGE_item_tt, 0, 
# 49 "../crypto/x509/v3_extku.c" 3 4
((void *)0)
# 49 "../crypto/x509/v3_extku.c"
, 0, "EXTENDED_KEY_USAGE" }; return &local_it; }

EXTENDED_KEY_USAGE *d2i_EXTENDED_KEY_USAGE(EXTENDED_KEY_USAGE **a, const unsigned char **in, long len) { return (EXTENDED_KEY_USAGE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (EXTENDED_KEY_USAGE_it())); } int i2d_EXTENDED_KEY_USAGE(const EXTENDED_KEY_USAGE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (EXTENDED_KEY_USAGE_it())); } EXTENDED_KEY_USAGE *EXTENDED_KEY_USAGE_new(void) { return (EXTENDED_KEY_USAGE *)ASN1_item_new((EXTENDED_KEY_USAGE_it())); } void EXTENDED_KEY_USAGE_free(EXTENDED_KEY_USAGE *a) { ASN1_item_free((ASN1_VALUE *)a, (EXTENDED_KEY_USAGE_it())); }
                                                    ...
                                                    *ext_list)
{
    ...
    ASN1_OBJECT *obj;
    char obj_tmp[80];
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(eku)); i++) {
        obj = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(eku), (i)));
        i2t_ASN1_OBJECT(obj_tmp, 80, obj);
        X509V3_add_value(
# 64 "../crypto/x509/v3_extku.c" 3 4
                        ((void *)0)
# 64 "../crypto/x509/v3_extku.c"
                            , obj_tmp, &ext_list);
    }
    return ext_list;
}
                                    ...
                                    struct stack_st_CONF_VALUE *nval)
{
    ...
    extku = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_reserve(ossl_check_ASN1_OBJECT_compfunc_type(
# 80 "../crypto/x509/v3_extku.c" 3 4
           ((void *)0)
# 80 "../crypto/x509/v3_extku.c"
           ), (num)));
    if (extku == 
# 81 "../crypto/x509/v3_extku.c" 3 4
                ((void *)0)
# 81 "../crypto/x509/v3_extku.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_extku.c",82,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 82 "../crypto/x509/v3_extku.c" 3 4
       ((void *)0)
# 82 "../crypto/x509/v3_extku.c"
       );
        OPENSSL_sk_free(ossl_check_ASN1_OBJECT_sk_type(extku));
        return 
# 84 "../crypto/x509/v3_extku.c" 3 4
              ((void *)0)
# 84 "../crypto/x509/v3_extku.c"
                  ;
    }
...
# 93 "../crypto/x509/v3_extku.c" 3 4
                                                ((void *)0)
# 93 "../crypto/x509/v3_extku.c"
                                                    ) {
            OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(extku),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_extku.c",95,__func__), ERR_set_error)(34, 110,
                           "%s", extval);
            return 
# 97 "../crypto/x509/v3_extku.c" 3 4
                  ((void *)0)
# 97 "../crypto/x509/v3_extku.c"
                      ;
        }
        OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(extku), ossl_check_ASN1_OBJECT_type(objtmp));
    }
    return extku;
}
