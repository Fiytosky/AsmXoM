# 0 "../crypto/x509/by_file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/by_file.c"
# 10 "../crypto/x509/by_file.c"
...
# 29 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 29 "../crypto/x509/by_file.c"
       ,
    
# 30 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 30 "../crypto/x509/by_file.c"
       ,
    
# 31 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 31 "../crypto/x509/by_file.c"
       ,
    
# 32 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 32 "../crypto/x509/by_file.c"
       ,
    by_file_ctrl,
    
# 34 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 34 "../crypto/x509/by_file.c"
       ,
    
# 35 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 35 "../crypto/x509/by_file.c"
       ,
    
# 36 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 36 "../crypto/x509/by_file.c"
       ,
    
# 37 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 37 "../crypto/x509/by_file.c"
       ,
    
# 38 "../crypto/x509/by_file.c" 3 4
   ((void *)0)
# 38 "../crypto/x509/by_file.c"
       ,
    by_file_ctrl_ex,
};
                           ...
                           const char *propq)
{
    ...
    case 1:
        if (argl == 3) {
            ...
            if (file)
                ok = (X509_load_cert_crl_file_ex(ctx, file, 1,
                                                 libctx, propq) != 0);
            else
            ...
            if (!ok)
                (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",67,__func__), ERR_set_error)((11),(104),
# 67 "../crypto/x509/by_file.c" 3 4
               ((void *)0)
# 67 "../crypto/x509/by_file.c"
               );
        } else {
            if (argl == 1)
                ok = (X509_load_cert_crl_file_ex(ctx, argp, 1,
                                                 libctx, propq) != 0);
            else
...
{
    return by_file_ctrl_ex(ctx, cmd, argp, argl, ret, 
# 84 "../crypto/x509/by_file.c" 3 4
                                                     ((void *)0)
# 84 "../crypto/x509/by_file.c"
                                                         , 
# 84 "../crypto/x509/by_file.c" 3 4
                                                           ((void *)0)
# 84 "../crypto/x509/by_file.c"
...
{
    BIO *in = 
# 90 "../crypto/x509/by_file.c" 3 4
             ((void *)0)
# 90 "../crypto/x509/by_file.c"
                 ;
    int count = 0;
    X509 *x = 
# 92 "../crypto/x509/by_file.c" 3 4
             ((void *)0)
# 92 "../crypto/x509/by_file.c"
                 ;

    in = BIO_new(BIO_s_file());

    if ((in == 
# 96 "../crypto/x509/by_file.c" 3 4
              ((void *)0)
# 96 "../crypto/x509/by_file.c"
                  ) || ((int)BIO_ctrl(in,108, 0x01|0x02,(char *)(file)) <= 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",97,__func__), ERR_set_error)((11),((32 | (0x2 << 18L))),
# 97 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 97 "../crypto/x509/by_file.c"
       );
        goto err;
    }
    ...
    if (x == 
# 102 "../crypto/x509/by_file.c" 3 4
            ((void *)0)
# 102 "../crypto/x509/by_file.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",103,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 103 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 103 "../crypto/x509/by_file.c"
       );
        goto err;
    }
    ...
    if (type == 1) {
        for (;;) {
            ERR_set_mark();
            if (PEM_read_bio_X509_AUX(in, &x, 
# 110 "../crypto/x509/by_file.c" 3 4
                                             ((void *)0)
# 110 "../crypto/x509/by_file.c"
                                                 , "") == 
# 110 "../crypto/x509/by_file.c" 3 4
                                                          ((void *)0)
# 110 "../crypto/x509/by_file.c"
                ...
                if ((ERR_GET_REASON(ERR_peek_last_error()) ==
                    ...
                    ERR_clear_last_mark();
                    if (count == 0) {
                        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",118,__func__), ERR_set_error)((11),(135),
# 118 "../crypto/x509/by_file.c" 3 4
                       ((void *)0)
# 118 "../crypto/x509/by_file.c"
                       );
                    } else {
                        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",120,__func__), ERR_set_error)((11),((9 | (0x2 << 18L))),
# 120 "../crypto/x509/by_file.c" 3 4
                       ((void *)0)
# 120 "../crypto/x509/by_file.c"
                       );
                        count = 0;
                    }
                    goto err;
            ...
            x = X509_new_ex(libctx, propq);
            if (x == 
# 137 "../crypto/x509/by_file.c" 3 4
                    ((void *)0)
# 137 "../crypto/x509/by_file.c"
                        ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",138,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 138 "../crypto/x509/by_file.c" 3 4
               ((void *)0)
# 138 "../crypto/x509/by_file.c"
               );
                count = 0;
                goto err;
            }
        ...
        if (d2i_X509_bio(in, &x) == 
# 145 "../crypto/x509/by_file.c" 3 4
                                   ((void *)0)
# 145 "../crypto/x509/by_file.c"
                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",146,__func__), ERR_set_error)((11),(135),
# 146 "../crypto/x509/by_file.c" 3 4
           ((void *)0)
# 146 "../crypto/x509/by_file.c"
           );
            goto err;
        }
        count = X509_STORE_add_cert(ctx->store_ctx, x);
    } else {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",151,__func__), ERR_set_error)((11),(100),
# 151 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 151 "../crypto/x509/by_file.c"
       );
        goto err;
    }
 err:
...
int X509_load_cert_file(X509_LOOKUP *ctx, const char *file, int type)
{
    return X509_load_cert_file_ex(ctx, file, type, 
# 162 "../crypto/x509/by_file.c" 3 4
                                                  ((void *)0)
# 162 "../crypto/x509/by_file.c"
                                                      , 
# 162 "../crypto/x509/by_file.c" 3 4
                                                        ((void *)0)
# 162 "../crypto/x509/by_file.c"
...
{
    BIO *in = 
# 167 "../crypto/x509/by_file.c" 3 4
             ((void *)0)
# 167 "../crypto/x509/by_file.c"
                 ;
    int count = 0;
    X509_CRL *x = 
# 169 "../crypto/x509/by_file.c" 3 4
                 ((void *)0)
# 169 "../crypto/x509/by_file.c"
                     ;

    in = BIO_new(BIO_s_file());

    if ((in == 
# 173 "../crypto/x509/by_file.c" 3 4
              ((void *)0)
# 173 "../crypto/x509/by_file.c"
                  ) || ((int)BIO_ctrl(in,108, 0x01|0x02,(char *)(file)) <= 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",174,__func__), ERR_set_error)((11),((32 | (0x2 << 18L))),
# 174 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 174 "../crypto/x509/by_file.c"
       );
        goto err;
    }
...
# 180 "../crypto/x509/by_file.c" 3 4
                                         ((void *)0)
# 180 "../crypto/x509/by_file.c"
                                             , 
# 180 "../crypto/x509/by_file.c" 3 4
                                               ((void *)0)
# 180 "../crypto/x509/by_file.c"
                                                   , "");
            if (x == 
# 181 "../crypto/x509/by_file.c" 3 4
                    ((void *)0)
# 181 "../crypto/x509/by_file.c"
                        ) {
                if ((ERR_GET_REASON(ERR_peek_last_error()) ==
                     108) && (count > 0)) {
                    ERR_clear_error();
                    ...
                    if (count == 0) {
                        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",188,__func__), ERR_set_error)((11),(137),
# 188 "../crypto/x509/by_file.c" 3 4
                       ((void *)0)
# 188 "../crypto/x509/by_file.c"
                       );
                    } else {
                        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",190,__func__), ERR_set_error)((11),((9 | (0x2 << 18L))),
# 190 "../crypto/x509/by_file.c" 3 4
                       ((void *)0)
# 190 "../crypto/x509/by_file.c"
                       );
                        count = 0;
                    }
                    goto err;
            ...
            X509_CRL_free(x);
            x = 
# 202 "../crypto/x509/by_file.c" 3 4
               ((void *)0)
# 202 "../crypto/x509/by_file.c"
                   ;
        }
    } else if (type == 2) {
        x = d2i_X509_CRL_bio(in, 
# 205 "../crypto/x509/by_file.c" 3 4
                                ((void *)0)
# 205 "../crypto/x509/by_file.c"
                                    );
        if (x == 
# 206 "../crypto/x509/by_file.c" 3 4
                ((void *)0)
# 206 "../crypto/x509/by_file.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",207,__func__), ERR_set_error)((11),(137),
# 207 "../crypto/x509/by_file.c" 3 4
           ((void *)0)
# 207 "../crypto/x509/by_file.c"
           );
            goto err;
        }
        count = X509_STORE_add_crl(ctx->store_ctx, x);
    } else {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",212,__func__), ERR_set_error)((11),(100),
# 212 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 212 "../crypto/x509/by_file.c"
       );
        goto err;
    }
 err:
...
# 224 "../crypto/x509/by_file.c" 3 4
                              ((void *)0)
# 224 "../crypto/x509/by_file.c"
                                  ;
    X509_INFO *itmp = 
# 225 "../crypto/x509/by_file.c" 3 4
                     ((void *)0)
# 225 "../crypto/x509/by_file.c"
                         ;
    BIO *in = 
# 226 "../crypto/x509/by_file.c" 3 4
             ((void *)0)
# 226 "../crypto/x509/by_file.c"
                 ;
    int i, count = 0;
    ...
    if (in == 
# 232 "../crypto/x509/by_file.c" 3 4
             ((void *)0)
# 232 "../crypto/x509/by_file.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",233,__func__), ERR_set_error)((11),((32 | (0x2 << 18L))),
# 233 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 233 "../crypto/x509/by_file.c"
       );
        return 0;
    }
    inf = PEM_X509_INFO_read_bio_ex(in, 
# 236 "../crypto/x509/by_file.c" 3 4
                                       ((void *)0)
# 236 "../crypto/x509/by_file.c"
                                           , 
# 236 "../crypto/x509/by_file.c" 3 4
                                             ((void *)0)
# 236 "../crypto/x509/by_file.c"
    ...
    BIO_free(in);
    if (inf == 
# 238 "../crypto/x509/by_file.c" 3 4
              ((void *)0)
# 238 "../crypto/x509/by_file.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",239,__func__), ERR_set_error)((11),((9 | (0x2 << 18L))),
# 239 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 239 "../crypto/x509/by_file.c"
       );
        return 0;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(inf)); i++) {
        itmp = ((X509_INFO *)OPENSSL_sk_value(ossl_check_const_X509_INFO_sk_type(inf), (i)));
        if (itmp->x509) {
    ...
    if (count == 0)
        (ERR_new(), ERR_set_debug("../crypto/x509/by_file.c",260,__func__), ERR_set_error)((11),(136),
# 260 "../crypto/x509/by_file.c" 3 4
       ((void *)0)
# 260 "../crypto/x509/by_file.c"
       );
 err:
...
int X509_load_cert_crl_file(X509_LOOKUP *ctx, const char *file, int type)
{
    return X509_load_cert_crl_file_ex(ctx, file, type, 
# 268 "../crypto/x509/by_file.c" 3 4
                                                      ((void *)0)
# 268 "../crypto/x509/by_file.c"
                                                          , 
# 268 "../crypto/x509/by_file.c" 3 4
                                                            ((void *)0)
# 268 "../crypto/x509/by_file.c"
