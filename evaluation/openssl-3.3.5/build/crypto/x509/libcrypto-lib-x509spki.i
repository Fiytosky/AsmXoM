# 0 "../crypto/x509/x509spki.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509spki.c"
# 10 "../crypto/x509/x509spki.c"
...
# 13 "../crypto/x509/x509spki.c" 2

int NETSCAPE_SPKI_set_pubkey(NETSCAPE_SPKI *x, EVP_PKEY *pkey)
{
    if ((x == 
# 16 "../crypto/x509/x509spki.c" 3 4
             ((void *)0)
# 16 "../crypto/x509/x509spki.c"
                 ) || (x->spkac == 
# 16 "../crypto/x509/x509spki.c" 3 4
                                   ((void *)0)
# 16 "../crypto/x509/x509spki.c"
...
{
    if ((x == 
# 23 "../crypto/x509/x509spki.c" 3 4
             ((void *)0)
# 23 "../crypto/x509/x509spki.c"
                 ) || (x->spkac == 
# 23 "../crypto/x509/x509spki.c" 3 4
                                   ((void *)0)
# 23 "../crypto/x509/x509spki.c"
        ...
        return 
# 24 "../crypto/x509/x509spki.c" 3 4
              ((void *)0)
# 24 "../crypto/x509/x509spki.c"
                  ;
...
NETSCAPE_SPKI *NETSCAPE_SPKI_b64_decode(const char *str, int len)
{
    ...
    if (len <= 0)
        len = strlen(str);
    if ((spki_der = CRYPTO_malloc(len + 1, "../crypto/x509/x509spki.c", 38)) == 
# 38 "../crypto/x509/x509spki.c" 3 4
                                               ((void *)0)
# 38 "../crypto/x509/x509spki.c"
                                                   )
        return 
# 39 "../crypto/x509/x509spki.c" 3 4
              ((void *)0)
# 39 "../crypto/x509/x509spki.c"
                  ;
    spki_len = EVP_DecodeBlock(spki_der, (const unsigned char *)str, len);
    if (spki_len < 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509spki.c",42,__func__), ERR_set_error)((11),(118),
# 42 "../crypto/x509/x509spki.c" 3 4
       ((void *)0)
# 42 "../crypto/x509/x509spki.c"
       );
        CRYPTO_free(spki_der, "../crypto/x509/x509spki.c", 43);
        return 
# 44 "../crypto/x509/x509spki.c" 3 4
              ((void *)0)
# 44 "../crypto/x509/x509spki.c"
                  ;
    }
    p = spki_der;
    spki = d2i_NETSCAPE_SPKI(
# 47 "../crypto/x509/x509spki.c" 3 4
                            ((void *)0)
# 47 "../crypto/x509/x509spki.c"
                                , &p, spki_len);
    CRYPTO_free(spki_der, "../crypto/x509/x509spki.c", 48);
    return spki;
}
...
# 60 "../crypto/x509/x509spki.c" 3 4
                                     ((void *)0)
# 60 "../crypto/x509/x509spki.c"
                                         );
    if (der_len <= 0)
        return 
# 62 "../crypto/x509/x509spki.c" 3 4
              ((void *)0)
# 62 "../crypto/x509/x509spki.c"
                  ;
    der_spki = CRYPTO_malloc(der_len, "../crypto/x509/x509spki.c", 63);
    b64_str = CRYPTO_malloc(der_len * 2, "../crypto/x509/x509spki.c", 64);
    if (der_spki == 
# 65 "../crypto/x509/x509spki.c" 3 4
                   ((void *)0) 
# 65 "../crypto/x509/x509spki.c"
                        || b64_str == 
# 65 "../crypto/x509/x509spki.c" 3 4
                                      ((void *)0)
# 65 "../crypto/x509/x509spki.c"
                                          ) {
        CRYPTO_free(der_spki, "../crypto/x509/x509spki.c", 66);
        CRYPTO_free(b64_str, "../crypto/x509/x509spki.c", 67);
        return 
# 68 "../crypto/x509/x509spki.c" 3 4
              ((void *)0)
# 68 "../crypto/x509/x509spki.c"
                  ;
    }
    p = der_spki;
    i2d_NETSCAPE_SPKI(spki, &p);
    EVP_EncodeBlock((unsigned char *)b64_str, der_spki, der_len);
    CRYPTO_free(der_spki, "../crypto/x509/x509spki.c", 73);
    return b64_str;
}
