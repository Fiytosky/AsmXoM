# 0 "../crypto/x509/pcy_data.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_data.c"
# 10 "../crypto/x509/pcy_data.c"
...
{
    if (data == 
# 20 "../crypto/x509/pcy_data.c" 3 4
               ((void *)0)
# 20 "../crypto/x509/pcy_data.c"
                   )
        return;
    ASN1_OBJECT_free(data->valid_policy);

    if (!(data->flags & 0x4))
        OPENSSL_sk_pop_free(ossl_check_POLICYQUALINFO_sk_type(data->qualifier_set),ossl_check_POLICYQUALINFO_freefunc_type(POLICYQUALINFO_free));
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(data->expected_policy_set),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    CRYPTO_free(data, "../crypto/x509/pcy_data.c", 27);
}
# 38 "../crypto/x509/pcy_data.c"
                                       ...
                                       const ASN1_OBJECT *cid, int crit)
{
    ...
    if (policy == 
# 44 "../crypto/x509/pcy_data.c" 3 4
                 ((void *)0) 
# 44 "../crypto/x509/pcy_data.c"
                      && cid == 
# 44 "../crypto/x509/pcy_data.c" 3 4
                                ((void *)0)
# 44 "../crypto/x509/pcy_data.c"
        ...
        return 
# 45 "../crypto/x509/pcy_data.c" 3 4
              ((void *)0)
# 45 "../crypto/x509/pcy_data.c"
                  ;
    if (cid) {
        id = OBJ_dup(cid);
        if (id == 
# 48 "../crypto/x509/pcy_data.c" 3 4
                 ((void *)0)
# 48 "../crypto/x509/pcy_data.c"
                     )
            return 
# 49 "../crypto/x509/pcy_data.c" 3 4
                  ((void *)0)
# 49 "../crypto/x509/pcy_data.c"
                      ;
    } else
        id = 
# 51 "../crypto/x509/pcy_data.c" 3 4
            ((void *)0)
# 51 "../crypto/x509/pcy_data.c"
                ;
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/x509/pcy_data.c", 52);
    if (ret == 
# 53 "../crypto/x509/pcy_data.c" 3 4
              ((void *)0)
# 53 "../crypto/x509/pcy_data.c"
                  ) {
        ASN1_OBJECT_free(id);
        return 
# 55 "../crypto/x509/pcy_data.c" 3 4
              ((void *)0)
# 55 "../crypto/x509/pcy_data.c"
                  ;
    }
    ret->expected_policy_set = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null());
    if (ret->expected_policy_set == 
# 58 "../crypto/x509/pcy_data.c" 3 4
                                   ((void *)0)
# 58 "../crypto/x509/pcy_data.c"
                                       ) {
        CRYPTO_free(ret, "../crypto/x509/pcy_data.c", 59);
        ASN1_OBJECT_free(id);
        (ERR_new(), ERR_set_debug("../crypto/x509/pcy_data.c",61,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 61 "../crypto/x509/pcy_data.c" 3 4
       ((void *)0)
# 61 "../crypto/x509/pcy_data.c"
       );
        return 
# 62 "../crypto/x509/pcy_data.c" 3 4
              ((void *)0)
# 62 "../crypto/x509/pcy_data.c"
                  ;
    }
    ...
    if (id)
        ...
        policy->policyid = 
# 72 "../crypto/x509/pcy_data.c" 3 4
                          ((void *)0)
# 72 "../crypto/x509/pcy_data.c"
                              ;
    }
    ...
    if (policy) {
        ...
        policy->qualifiers = 
# 77 "../crypto/x509/pcy_data.c" 3 4
                            ((void *)0)
# 77 "../crypto/x509/pcy_data.c"
                                ;
    }
