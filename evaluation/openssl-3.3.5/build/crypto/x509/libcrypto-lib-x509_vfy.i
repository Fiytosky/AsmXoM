# 0 "../crypto/x509/x509_vfy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_vfy.c"
# 10 "../crypto/x509/x509_vfy.c"
...
# 16 "../crypto/x509/x509_vfy.c" 2

# 1 "../include/crypto/ctype.h" 1
...
# 26 "../include/crypto/ctype.h" 2
# 59 "../include/crypto/ctype.h"
...
# 25 "../crypto/x509/x509_vfy.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 27 "../crypto/x509/x509_vfy.c" 2
# 1 "../include/internal/dane.h" 1
# 12 "../include/internal/dane.h"
        
# 43 "../include/internal/dane.h"
...
struct ssl_dane_st {
    ...
    struct stack_st_danetls_record *trecs;
    struct stack_st_X509 *certs;
    danetls_record *mtlsa;
    X509 *mcert;
    uint32_t umask;
    int mdpth;
    int pdpth;
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 29 "../crypto/x509/x509_vfy.c" 2
# 1 "../crypto/x509/x509_local.h" 1
# 21 "../crypto/x509/x509_local.h"
...
struct stack_st_BY_DIR_HASH; typedef int (*sk_BY_DIR_HASH_compfunc)(const BY_DIR_HASH * const *a, const BY_DIR_HASH *const *b); typedef void (*sk_BY_DIR_HASH_freefunc)(BY_DIR_HASH *a); typedef BY_DIR_HASH * (*sk_BY_DIR_HASH_copyfunc)(const BY_DIR_HASH *a); static __attribute__((unused)) inline int sk_BY_DIR_HASH_num(const struct stack_st_BY_DIR_HASH *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_value(const struct stack_st_BY_DIR_HASH *sk, int idx) { return (BY_DIR_HASH *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_new(sk_BY_DIR_HASH_compfunc compare) { return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_new_null(void) { return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_new_reserve(sk_BY_DIR_HASH_compfunc compare, int n) { return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_reserve(struct stack_st_BY_DIR_HASH *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_BY_DIR_HASH_free(struct stack_st_BY_DIR_HASH *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BY_DIR_HASH_zero(struct stack_st_BY_DIR_HASH *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_delete(struct stack_st_BY_DIR_HASH *sk, int i) { return (BY_DIR_HASH *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_delete_ptr(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr) { return (BY_DIR_HASH *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_push(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_unshift(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_pop(struct stack_st_BY_DIR_HASH *sk) { return (BY_DIR_HASH *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_shift(struct stack_st_BY_DIR_HASH *sk) { return (BY_DIR_HASH *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BY_DIR_HASH_pop_free(struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_insert(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline BY_DIR_HASH *sk_BY_DIR_HASH_set(struct stack_st_BY_DIR_HASH *sk, int idx, BY_DIR_HASH *ptr) { return (BY_DIR_HASH *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_find(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_find_ex(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_find_all(struct stack_st_BY_DIR_HASH *sk, BY_DIR_HASH *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_BY_DIR_HASH_sort(struct stack_st_BY_DIR_HASH *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_BY_DIR_HASH_is_sorted(const struct stack_st_BY_DIR_HASH *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BY_DIR_HASH * sk_BY_DIR_HASH_dup(const struct stack_st_BY_DIR_HASH *sk) { return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BY_DIR_HASH *sk_BY_DIR_HASH_deep_copy(const struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_copyfunc copyfunc, sk_BY_DIR_HASH_freefunc freefunc) { return (struct stack_st_BY_DIR_HASH *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_BY_DIR_HASH_compfunc sk_BY_DIR_HASH_set_cmp_func(struct stack_st_BY_DIR_HASH *sk, sk_BY_DIR_HASH_compfunc compare) { return (sk_BY_DIR_HASH_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_BY_DIR_ENTRY; typedef int (*sk_BY_DIR_ENTRY_compfunc)(const BY_DIR_ENTRY * const *a, const BY_DIR_ENTRY *const *b); typedef void (*sk_BY_DIR_ENTRY_freefunc)(BY_DIR_ENTRY *a); typedef BY_DIR_ENTRY * (*sk_BY_DIR_ENTRY_copyfunc)(const BY_DIR_ENTRY *a); static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_num(const struct stack_st_BY_DIR_ENTRY *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_value(const struct stack_st_BY_DIR_ENTRY *sk, int idx) { return (BY_DIR_ENTRY *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_new(sk_BY_DIR_ENTRY_compfunc compare) { return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_new_null(void) { return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_new_reserve(sk_BY_DIR_ENTRY_compfunc compare, int n) { return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_reserve(struct stack_st_BY_DIR_ENTRY *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_BY_DIR_ENTRY_free(struct stack_st_BY_DIR_ENTRY *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BY_DIR_ENTRY_zero(struct stack_st_BY_DIR_ENTRY *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_delete(struct stack_st_BY_DIR_ENTRY *sk, int i) { return (BY_DIR_ENTRY *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_delete_ptr(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr) { return (BY_DIR_ENTRY *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_push(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_unshift(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_pop(struct stack_st_BY_DIR_ENTRY *sk) { return (BY_DIR_ENTRY *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_shift(struct stack_st_BY_DIR_ENTRY *sk) { return (BY_DIR_ENTRY *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BY_DIR_ENTRY_pop_free(struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_insert(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline BY_DIR_ENTRY *sk_BY_DIR_ENTRY_set(struct stack_st_BY_DIR_ENTRY *sk, int idx, BY_DIR_ENTRY *ptr) { return (BY_DIR_ENTRY *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_find(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_find_ex(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_find_all(struct stack_st_BY_DIR_ENTRY *sk, BY_DIR_ENTRY *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_BY_DIR_ENTRY_sort(struct stack_st_BY_DIR_ENTRY *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_BY_DIR_ENTRY_is_sorted(const struct stack_st_BY_DIR_ENTRY *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BY_DIR_ENTRY * sk_BY_DIR_ENTRY_dup(const struct stack_st_BY_DIR_ENTRY *sk) { return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BY_DIR_ENTRY *sk_BY_DIR_ENTRY_deep_copy(const struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_copyfunc copyfunc, sk_BY_DIR_ENTRY_freefunc freefunc) { return (struct stack_st_BY_DIR_ENTRY *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_BY_DIR_ENTRY_compfunc sk_BY_DIR_ENTRY_set_cmp_func(struct stack_st_BY_DIR_ENTRY *sk, sk_BY_DIR_ENTRY_compfunc compare) { return (sk_BY_DIR_ENTRY_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
typedef struct stack_st_X509_NAME_ENTRY STACK_OF_X509_NAME_ENTRY;
struct stack_st_STACK_OF_X509_NAME_ENTRY; typedef int (*sk_STACK_OF_X509_NAME_ENTRY_compfunc)(const STACK_OF_X509_NAME_ENTRY * const *a, const STACK_OF_X509_NAME_ENTRY *const *b); typedef void (*sk_STACK_OF_X509_NAME_ENTRY_freefunc)(STACK_OF_X509_NAME_ENTRY *a); typedef STACK_OF_X509_NAME_ENTRY * (*sk_STACK_OF_X509_NAME_ENTRY_copyfunc)(const STACK_OF_X509_NAME_ENTRY *a); static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_num(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_value(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int idx) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_new(sk_STACK_OF_X509_NAME_ENTRY_compfunc compare) { return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_new_null(void) { return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_new_reserve(sk_STACK_OF_X509_NAME_ENTRY_compfunc compare, int n) { return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_reserve(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_STACK_OF_X509_NAME_ENTRY_free(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_STACK_OF_X509_NAME_ENTRY_zero(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_delete(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int i) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_delete_ptr(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_push(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_unshift(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_pop(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_shift(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_STACK_OF_X509_NAME_ENTRY_pop_free(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_insert(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_set(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, int idx, STACK_OF_X509_NAME_ENTRY *ptr) { return (STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_find(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_find_ex(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_find_all(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, STACK_OF_X509_NAME_ENTRY *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_STACK_OF_X509_NAME_ENTRY_sort(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_STACK_OF_X509_NAME_ENTRY_is_sorted(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_STACK_OF_X509_NAME_ENTRY * sk_STACK_OF_X509_NAME_ENTRY_dup(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk) { return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_STACK_OF_X509_NAME_ENTRY *sk_STACK_OF_X509_NAME_ENTRY_deep_copy(const struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_copyfunc copyfunc, sk_STACK_OF_X509_NAME_ENTRY_freefunc freefunc) { return (struct stack_st_STACK_OF_X509_NAME_ENTRY *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_STACK_OF_X509_NAME_ENTRY_compfunc sk_STACK_OF_X509_NAME_ENTRY_set_cmp_func(struct stack_st_STACK_OF_X509_NAME_ENTRY *sk, sk_STACK_OF_X509_NAME_ENTRY_compfunc compare) { return (sk_STACK_OF_X509_NAME_ENTRY_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
# 30 "../crypto/x509/x509_vfy.c" 2
# 44 "../crypto/x509/x509_vfy.c"
...
static int check_crl_chain(X509_STORE_CTX *ctx,
                           struct stack_st_X509 *cert_path,
...
# 98 "../crypto/x509/x509_vfy.c"
int X509_self_signed(X509 *cert, int verify_signature)
{
    EVP_PKEY *pkey;

    if ((pkey = X509_get0_pubkey(cert)) == 
# 102 "../crypto/x509/x509_vfy.c" 3 4
                                          ((void *)0)
# 102 "../crypto/x509/x509_vfy.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",103,__func__), ERR_set_error)((11),(108),
# 103 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 103 "../crypto/x509/x509_vfy.c"
       );
        return -1;
    }
    if (!ossl_x509v3_cache_extensions(cert))
        return -1;
    if ((cert->ex_flags & 0x2000) == 0)
        return 0;
    if (!verify_signature)
        return 1;
...
static int lookup_cert_match(X509 **result, X509_STORE_CTX *ctx, X509 *x)
{
    struct stack_st_X509 *certs;
    X509 *xtmp = 
# 122 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 122 "../crypto/x509/x509_vfy.c"
                    ;
    int i, ret;

    *result = 
# 125 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 125 "../crypto/x509/x509_vfy.c"
                 ;
    ...
    ERR_pop_to_mark();
    if (certs == 
# 130 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 130 "../crypto/x509/x509_vfy.c"
                    )
        return -1;


    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        xtmp = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));
        if (X509_cmp(xtmp, x) == 0)
            break;
        xtmp = 
# 138 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 138 "../crypto/x509/x509_vfy.c"
                  ;
    }
    ret = xtmp != 
# 140 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 140 "../crypto/x509/x509_vfy.c"
                     ;
    if (ret) {
        if (!X509_up_ref(xtmp))
            ret = -1;
...
static int verify_cb_cert(X509_STORE_CTX *ctx, X509 *x, int depth, int err)
{
    ...
    ctx->current_cert = x != 
# 166 "../crypto/x509/x509_vfy.c" 3 4
                            ((void *)0) 
# 166 "../crypto/x509/x509_vfy.c"
                                 ? x : ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (depth)));
    if (err != 0)
        ctx->error = err;
    return ctx->verify_cb(0, ctx);
}
# 183 "../crypto/x509/x509_vfy.c"
...
{
    int i;
    int num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));

    if (ctx->param->auth_level <= 0)
        return 1;

    for (i = 0; i < num; ++i) {
        X509 *cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (i)));





        if ((i > 0 && !check_cert_key_level(ctx, cert)) && verify_cb_cert(ctx, cert, i, 67) == 0) return 0
                                                             ;




        if ((i < num - 1 && !check_sig_level(ctx, cert)) && verify_cb_cert(ctx, cert, i, 68) == 0) return 0
                                                           ;
    }
    return 1;
}
...
static int verify_rpk(X509_STORE_CTX *ctx)
{
    ...
    if (ctx->verify != 
# 224 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 224 "../crypto/x509/x509_vfy.c"
                          )
        return ctx->verify(ctx);

    return !!ctx->verify_cb(ctx->error == 0, ctx);
}
...
static int verify_chain(X509_STORE_CTX *ctx)
{
    ...
    if ((ok = build_chain(ctx)) <= 0
        ...
        || (ok = check_id(ctx)) <= 0
        || (ok = X509_get_pubkey_parameters(
# 244 "../crypto/x509/x509_vfy.c" 3 4
                                           ((void *)0)
# 244 "../crypto/x509/x509_vfy.c"
                                               , ctx->chain) ? 1 : -1) <= 0
        || (ok = ctx->check_revocation(ctx)) <= 0)
        return ok;

    err = X509_chain_check_suiteb(&ctx->error_depth, 
# 248 "../crypto/x509/x509_vfy.c" 3 4
                                                    ((void *)0)
# 248 "../crypto/x509/x509_vfy.c"
                                                        , ctx->chain,
                                  ctx->param->flags);
    if ((err != 0) && verify_cb_cert(ctx, 
# 250 "../crypto/x509/x509_vfy.c" 3 4
   ((void *)0)
# 250 "../crypto/x509/x509_vfy.c"
   , ctx->error_depth, err) == 0) return 0;


    ok = ctx->verify != 
# 253 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0) 
# 253 "../crypto/x509/x509_vfy.c"
...
{
    if (ctx == 
# 276 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 276 "../crypto/x509/x509_vfy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",277,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 277 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 277 "../crypto/x509/x509_vfy.c"
       );
        return -1;
    }
    if (ctx->rpk != 
# 280 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 280 "../crypto/x509/x509_vfy.c"
                       )
        return x509_verify_rpk(ctx);
    if (ctx->cert == 
# 282 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0) 
# 282 "../crypto/x509/x509_vfy.c"
                         && OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->untrusted)) >= 1)
        ctx->cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->untrusted), (0)));
...
{
    if (ctx == 
# 289 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 289 "../crypto/x509/x509_vfy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",290,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 290 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 290 "../crypto/x509/x509_vfy.c"
       );
        return -1;
    }
    return (ctx->rpk != 
# 293 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 293 "../crypto/x509/x509_vfy.c"
                           ) ? x509_verify_rpk(ctx) : x509_verify_x509(ctx);
}
...
static int x509_verify_rpk(X509_STORE_CTX *ctx)
{
    ...
    if (!check_key_level(ctx, ctx->rpk)
        && verify_cb_cert(ctx, 
# 306 "../crypto/x509/x509_vfy.c" 3 4
                              ((void *)0)
# 306 "../crypto/x509/x509_vfy.c"
                                  , 0, 66) == 0)
        return 0;
    ...
    ret = ((ctx->dane) != 
# 312 "../crypto/x509/x509_vfy.c" 3 4
         ((void *)0) 
# 312 "../crypto/x509/x509_vfy.c"
         && sk_danetls_record_num((ctx->dane)->trecs) > 0) ? dane_verify_rpk(ctx) : verify_rpk(ctx);
...
static int x509_verify_x509(X509_STORE_CTX *ctx)
{
    ...
    if (ctx->cert == 
# 332 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0)
# 332 "../crypto/x509/x509_vfy.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",333,__func__), ERR_set_error)((11),(105),
# 333 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 333 "../crypto/x509/x509_vfy.c"
       );
        ctx->error = 69;
        return -1;
    }
    ...
    if (ctx->chain != 
# 338 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 338 "../crypto/x509/x509_vfy.c"
                         ) {




        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",343,__func__), ERR_set_error)((11),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 343 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 343 "../crypto/x509/x509_vfy.c"
       );
        ctx->error = 69;
        return -1;
    }

    if (!ossl_x509_add_cert_new(&ctx->chain, ctx->cert, 0x1)) {
        ctx->error = 17;
        return -1;
    }
    ctx->num_untrusted = 1;
    ...
    if ((!check_cert_key_level(ctx, ctx->cert)) && verify_cb_cert(ctx, ctx->cert, 0, 66) == 0) return 0
                                                              ;

    ret = ((ctx->dane) != 
# 358 "../crypto/x509/x509_vfy.c" 3 4
         ((void *)0) 
# 358 "../crypto/x509/x509_vfy.c"
         && sk_danetls_record_num((ctx->dane)->trecs) > 0) ? dane_verify(ctx) : verify_chain(ctx);
...
static int sk_X509_contains(struct stack_st_X509 *sk, X509 *cert)
{
    int i, n = OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk));

    for (i = 0; i < n; i++)
        if (X509_cmp(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sk), (i))), cert) == 0)
            return 1;
    return 0;
}
...
static X509 *find_issuer(X509_STORE_CTX *ctx, struct stack_st_X509 *sk, X509 *x)
{
    int i;
    X509 *issuer, *rv = 
# 389 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 389 "../crypto/x509/x509_vfy.c"
                           ;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(sk)); i++) {
        issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sk), (i)));
        if (ctx->check_issued(ctx, x, issuer)
            && (((x->ex_flags & 0x20) != 0 && OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) == 1)
                || !sk_X509_contains(ctx->chain, issuer))) {
            if (ossl_x509_check_cert_time(ctx, issuer, -1))
                return issuer;
            if (rv == 
# 398 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0) 
# 398 "../crypto/x509/x509_vfy.c"
...
static int check_issued(__attribute__((unused)) X509_STORE_CTX *ctx, X509 *x, X509 *issuer)
{
...
static int get_issuer_sk(X509 **issuer, X509_STORE_CTX *ctx, X509 *x)
{
    *issuer = find_issuer(ctx, ctx->other_ctx, x);
    if (*issuer == 
# 427 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0)
# 427 "../crypto/x509/x509_vfy.c"
                      )
        return 0;
...
static struct stack_st_X509 *lookup_certs_sk(X509_STORE_CTX *ctx, const X509_NAME *nm)
{
    ...
    if (sk == 
# 442 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 442 "../crypto/x509/x509_vfy.c"
                 )
        return 
# 443 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 443 "../crypto/x509/x509_vfy.c"
                  ;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->other_ctx)); i++) {
        x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->other_ctx), (i)));
        if (X509_NAME_cmp(nm, X509_get_subject_name(x)) == 0) {
            if (!X509_add_cert(sk, x, 0x1)) {
                OSSL_STACK_OF_X509_free(sk);
                ctx->error = 17;
                return 
# 450 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 450 "../crypto/x509/x509_vfy.c"
                          ;
            }
        }
    }
...
{
    int tr_ok = 3;
# 485 "../crypto/x509/x509_vfy.c"
    if (depth >= ctx->num_untrusted && purpose == ctx->param->purpose)
        tr_ok = X509_check_trust(x, ctx->param->trust, (1U << 2));
    ...
    return verify_cb_cert(ctx, x, depth, 26);
}
...
static int check_extensions(X509_STORE_CTX *ctx)
{
    ...
    int purpose, allow_proxy_certs, num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
# 529 "../crypto/x509/x509_vfy.c"
    must_be_ca = -1;


    if (ctx->parent != 
# 532 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 532 "../crypto/x509/x509_vfy.c"
                          ) {
        allow_proxy_certs = 0;
        purpose = 6;
    } else {
        allow_proxy_certs =
            (ctx->param->flags & 0x40) != 0;
        purpose = ctx->param->purpose;
    }

    for (i = 0; i < num; i++) {
        x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (i)));
        if (((ctx->param->flags & 0x10) == 0 && (x->ex_flags & 0x200) != 0) && verify_cb_cert(ctx, x, i, 34) == 0) return 0

                                                                      ;
        if ((!allow_proxy_certs && (x->ex_flags & 0x400) != 0) && verify_cb_cert(ctx, x, i, 40) == 0) return 0
                                                                        ;
        ret = X509_check_ca(x);
        switch (must_be_ca) {
        case -1:
            if (((ctx->param->flags & 0x20) != 0 && ret != 1 && ret != 0) && verify_cb_cert(ctx, x, i, 79) == 0) return 0

                                                        ;
            break;
        case 0:
            if ((ret != 0) && verify_cb_cert(ctx, x, i, 37) == 0) return 0;
            break;
        default:

            if ((ret == 0 || ((i + 1 < num || (ctx->param->flags & 0x20) != 0) && ret != 1)) && verify_cb_cert(ctx, x, i, 79) == 0) return 0
        ...
        if (num > 1) {
            ...
            ret = check_curve(x);
            if ((ret < 0) && verify_cb_cert(ctx, x, i, 1) == 0) return 0;
            if ((ret == 0) && verify_cb_cert(ctx, x, i, 94) == 0) return 0;
        }
        ...
        if ((ctx->param->flags & 0x20) != 0
            ...
            if (x->ex_pathlen != -1) {
                if (((x->ex_flags & 0x10) == 0) && verify_cb_cert(ctx, x, i, 80) == 0) return 0
                                                                            ;
                if (((x->ex_kusage & 0x0004) == 0) && verify_cb_cert(ctx, x, i, 81) == 0) return 0
                                                                             ;
            }
            if (((x->ex_flags & 0x10) != 0 && (x->ex_flags & 0x1) != 0 && (x->ex_flags & 0x10000) == 0) && verify_cb_cert(ctx, x, i, 89) == 0) return 0


                                                                   ;

            if ((x->ex_flags & 0x10) != 0) {
                if (((x->ex_flags & 0x2) == 0) && verify_cb_cert(ctx, x, i, 92) == 0) return 0
                                                                           ;
            } else {
                if (((x->ex_kusage & 0x0004) != 0) && verify_cb_cert(ctx, x, i, 82) == 0) return 0
                                                                          ;
            }

            if ((X509_NAME_entry_count(X509_get_issuer_name(x)) == 0) && verify_cb_cert(ctx, x, i, 83) == 0) return 0
                                                               ;

            if ((((x->ex_flags & 0x10) != 0 || (x->ex_kusage & 0x0002) != 0 || x->altname == 
# 606 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 606 "../crypto/x509/x509_vfy.c"
           ) && X509_NAME_entry_count(X509_get_subject_name(x)) == 0) && verify_cb_cert(ctx, x, i, 84) == 0) return 0



                                                                ;
            if ((X509_NAME_entry_count(X509_get_subject_name(x)) == 0 && x->altname != 
# 611 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0) 
# 611 "../crypto/x509/x509_vfy.c"
           && (x->ex_flags & 0x80000) == 0) && verify_cb_cert(ctx, x, i, 88) == 0) return 0


                                                                            ;

            if ((x->altname != 
# 616 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0) 
# 616 "../crypto/x509/x509_vfy.c"
           && OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(x->altname)) <= 0) && verify_cb_cert(ctx, x, i, 87) == 0) return 0

                                                                    ;

            if ((X509_ALGOR_cmp(&x->sig_alg, &x->cert_info.signature) != 0) && verify_cb_cert(ctx, x, i, 78) == 0) return 0
                                                                               ;
            if ((x->akid != 
# 622 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0) 
# 622 "../crypto/x509/x509_vfy.c"
           && (x->ex_flags & 0x20000) != 0) && verify_cb_cert(ctx, x, i, 90) == 0) return 0

                                                                               ;
            if ((x->skid != 
# 625 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0) 
# 625 "../crypto/x509/x509_vfy.c"
           && (x->ex_flags & 0x40000) != 0) && verify_cb_cert(ctx, x, i, 91) == 0) return 0

                                                                             ;
            if (X509_get_version(x) >= 2) {

                if ((i + 1 < num && (x->akid == 
# 630 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 630 "../crypto/x509/x509_vfy.c"
               || x->akid->keyid == 
# 630 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 630 "../crypto/x509/x509_vfy.c"
               )) && verify_cb_cert(ctx, x, i, 85) == 0) return 0
                ...
                if (((x->ex_flags & 0x10) != 0 && x->skid == 
# 637 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 637 "../crypto/x509/x509_vfy.c"
               ) && verify_cb_cert(ctx, x, i, 86) == 0) return 0
                                                                                ;
            } else {
                if ((OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_get0_extensions(x))) > 0) && verify_cb_cert(ctx, x, i, 93) == 0) return 0
                                                                              ;
            }
        }
        ...
        if ((i > 1 && x->ex_pathlen != -1 && plen > x->ex_pathlen + proxy_path_length) && verify_cb_cert(ctx, x, i, 25) == 0) return 0

                                                              ;

        if (i > 0 && (x->ex_flags & 0x20) == 0)
            plen++;
        ...
        if (x->ex_flags & 0x400) {
# 672 "../crypto/x509/x509_vfy.c"
            if (x->ex_pcpathlen != -1) {
                if ((proxy_path_length > x->ex_pcpathlen) && verify_cb_cert(ctx, x, i, 38) == 0) return 0
                                                                            ;
...
static int has_san_id(X509 *x, int gtype)
{
    int i;
    int ret = 0;
    GENERAL_NAMES *gs = X509_get_ext_d2i(x, 85, 
# 690 "../crypto/x509/x509_vfy.c" 3 4
                                                                 ((void *)0)
# 690 "../crypto/x509/x509_vfy.c"
                                                                     , 
# 690 "../crypto/x509/x509_vfy.c" 3 4
                                                                       ((void *)0)
# 690 "../crypto/x509/x509_vfy.c"
    ...
    if (gs == 
# 692 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 692 "../crypto/x509/x509_vfy.c"
                 )
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gs)); i++) {
        GENERAL_NAME *g = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gs), (i)));
...
static int check_name_constraints(X509_STORE_CTX *ctx)
{
    ...
    for (i = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1; i >= 0; i--) {
        X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (i)));
        int j;
        ...
        if ((x->ex_flags & 0x400) != 0) {
            X509_NAME *tmpsubject = X509_get_subject_name(x);
            X509_NAME *tmpissuer = X509_get_issuer_name(x);
            X509_NAME_ENTRY *tmpentry = 
# 733 "../crypto/x509/x509_vfy.c" 3 4
                                       ((void *)0)
# 733 "../crypto/x509/x509_vfy.c"
                                           ;
            int last_nid = 0;
            int err = 0;
            ...
            if (tmpsubject == 
# 770 "../crypto/x509/x509_vfy.c" 3 4
                             ((void *)0)
# 770 "../crypto/x509/x509_vfy.c"
                                 ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",771,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 771 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 771 "../crypto/x509/x509_vfy.c"
               );
                ctx->error = 17;
                return -1;
            }
        ...
        proxy_name_done:
            if ((err != 0) && verify_cb_cert(ctx, x, i, err) == 0) return 0;
        }
        ...
        for (j = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1; j > i; j--) {
            NAME_CONSTRAINTS *nc = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (j)))->nc;
            ...
            if (nc) {
                ...
                case 17:
                    return -1;
                default:
                    if ((1) && verify_cb_cert(ctx, x, i, rv) == 0) return 0;
                    break;
                }
            }
        }
...
{
    int i;
    int n = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(vpm->hosts));
    char *name;

    if (vpm->peername != 
# 841 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 841 "../crypto/x509/x509_vfy.c"
                            ) {
        CRYPTO_free(vpm->peername, "../crypto/x509/x509_vfy.c", 842);
        vpm->peername = 
# 843 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 843 "../crypto/x509/x509_vfy.c"
                           ;
    }
    for (i = 0; i < n; ++i) {
        name = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(vpm->hosts), (i)));
...
static int check_id(X509_STORE_CTX *ctx)
{
    ...
    if (vpm->hosts != 
# 858 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0) 
# 858 "../crypto/x509/x509_vfy.c"
                          && check_hosts(x, vpm) <= 0) {
        if (!check_id_error(ctx, 62))
            return 0;
    }
    if (vpm->email != 
# 862 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
            
# 863 "../crypto/x509/x509_vfy.c"
           && X509_check_email(x, vpm->email, vpm->emaillen, 0) <= 0) {
        if (!check_id_error(ctx, 63))
            return 0;
    }
    if (vpm->ip != 
# 867 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0) 
# 867 "../crypto/x509/x509_vfy.c"
                       && X509_check_ip(x, vpm->ip, vpm->iplen, 0) <= 0) {
        if (!check_id_error(ctx, 64))
            return 0;
    }
    return 1;
}
...
static int check_trust(X509_STORE_CTX *ctx, int num_untrusted)
{
    int i, res;
    X509 *x = 
# 878 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 878 "../crypto/x509/x509_vfy.c"
                 ;
    X509 *mx;
    ...
    if (((dane) && ((dane)->umask & (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 2))))) && num_untrusted > 0 && num_untrusted < num) {
    ...
    if (num_untrusted == num
        ...
        (void)((X509 *)OPENSSL_sk_set(ossl_check_X509_sk_type(ctx->chain), (0), ossl_check_X509_type(mx)));
        X509_free(x);
        ctx->num_untrusted = 0;
        goto trusted;
    }
 ...
 rejected:
    return verify_cb_cert(ctx, x, i, 28) == 0
        ? 2 : 3;

 trusted:
    if (!((dane) != 
# 962 "../crypto/x509/x509_vfy.c" 3 4
        ((void *)0) 
# 962 "../crypto/x509/x509_vfy.c"
...
static int check_revocation(X509_STORE_CTX *ctx)
{
    ...
    if ((ctx->param->flags & 0x4) == 0)
        return 1;
    if ((ctx->param->flags & 0x8) != 0) {
        last = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1;
    } else {

        if (ctx->parent != 
# 983 "../crypto/x509/x509_vfy.c" 3 4
                          ((void *)0)
# 983 "../crypto/x509/x509_vfy.c"
                              )
            return 1;
        last = 0;
    }
...
{
    X509_CRL *crl = 
# 999 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 999 "../crypto/x509/x509_vfy.c"
                       , *dcrl = 
# 999 "../crypto/x509/x509_vfy.c" 3 4
                                 ((void *)0)
# 999 "../crypto/x509/x509_vfy.c"
    ...
    X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (cnum)));

    ctx->current_cert = x;
    ctx->current_issuer = 
# 1005 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 1005 "../crypto/x509/x509_vfy.c"
                             ;
    ...
    while (ctx->current_reasons != 0x807f) {
        ...
        if (ctx->get_crl != 
# 1016 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 1016 "../crypto/x509/x509_vfy.c"
                               )
        ...
        if (dcrl != 
# 1030 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1030 "../crypto/x509/x509_vfy.c"
                       ) {
        ...
        X509_CRL_free(dcrl);
        crl = 
# 1050 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 1050 "../crypto/x509/x509_vfy.c"
                 ;
        dcrl = 
# 1051 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 1051 "../crypto/x509/x509_vfy.c"
                  ;
    ...
    ctx->current_crl = 
# 1065 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 1065 "../crypto/x509/x509_vfy.c"
                          ;
    return ok;
}
...
static int check_crl_time(X509_STORE_CTX *ctx, X509_CRL *crl, int notify)
{
    ...
    if ((ctx->param->flags & 0x2) != 0)
        ptime = &ctx->param->check_time;
    else if ((ctx->param->flags & 0x200000) != 0)
        return 1;
    else
        ptime = 
# 1080 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 1080 "../crypto/x509/x509_vfy.c"
                   ;
    if (notify)
        ctx->current_crl = crl;
    ...
    if (X509_CRL_get0_nextUpdate(crl)) {
        ...
        if (i == 0) {
            if (!notify)
                return 0;
            if (!verify_cb_crl(ctx, 16))
                return 0;
        }

        if (i < 0 && (ctx->current_crl_score & 0x002) == 0) {
            if (!notify || !verify_cb_crl(ctx, 12))
                return 0;
        }
    }
    ...
    if (notify)
        ctx->current_crl = 
# 1116 "../crypto/x509/x509_vfy.c" 3 4
                          ((void *)0)
# 1116 "../crypto/x509/x509_vfy.c"
                              ;
...
# 1128 "../crypto/x509/x509_vfy.c" 3 4
                              ((void *)0)
# 1128 "../crypto/x509/x509_vfy.c"
                                  ;
    X509 *crl_issuer = 
# 1129 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 1129 "../crypto/x509/x509_vfy.c"
                          , *best_crl_issuer = 
# 1129 "../crypto/x509/x509_vfy.c" 3 4
                                               ((void *)0)
# 1129 "../crypto/x509/x509_vfy.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_CRL_sk_type(crls)); i++) {
        crl = ((X509_CRL *)OPENSSL_sk_value(ossl_check_const_X509_CRL_sk_type(crls), (i)));
        reasons = *preasons;
        crl_score = get_crl_score(ctx, &crl_issuer, &reasons, crl, x);
        if (crl_score < best_score || crl_score == 0)
            continue;

        if (crl_score == best_score && best_crl != 
# 1138 "../crypto/x509/x509_vfy.c" 3 4
                                                  ((void *)0)
# 1138 "../crypto/x509/x509_vfy.c"
                                                      ) {
            int day, sec;
    ...
    if (best_crl != 
# 1157 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1157 "../crypto/x509/x509_vfy.c"
                       ) {
        X509_CRL_free(*pcrl);
        *pcrl = best_crl;
        ...
        *preasons = best_reasons;
        ...
        X509_CRL_free(*pdcrl);
        *pdcrl = 
# 1165 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 1165 "../crypto/x509/x509_vfy.c"
                    ;
...
{
    ASN1_OCTET_STRING *exta = 
# 1181 "../crypto/x509/x509_vfy.c" 3 4
                             ((void *)0)
# 1181 "../crypto/x509/x509_vfy.c"
                                 , *extb = 
# 1181 "../crypto/x509/x509_vfy.c" 3 4
                                           ((void *)0)
# 1181 "../crypto/x509/x509_vfy.c"
    ...
    if (exta == 
# 1198 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 1198 "../crypto/x509/x509_vfy.c"
                    && extb == 
# 1198 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 1198 "../crypto/x509/x509_vfy.c"
    ...
    if (exta == 
# 1201 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 1201 "../crypto/x509/x509_vfy.c"
                    || extb == 
# 1201 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 1201 "../crypto/x509/x509_vfy.c"
...
# 1211 "../crypto/x509/x509_vfy.c" 3 4
                                 ((void *)0)
# 1211 "../crypto/x509/x509_vfy.c"
                                     )
        return 0;

    if (base->crl_number == 
# 1214 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 1214 "../crypto/x509/x509_vfy.c"
                               )
        return 0;
                         ...
                         X509_CRL *base, struct stack_st_X509_CRL *crls)
{
    ...
    if ((ctx->param->flags & 0x2000) == 0)
        return;
    if (((ctx->current_cert->ex_flags | base->flags) & 0x1000) == 0)
        return;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_CRL_sk_type(crls)); i++) {
        delta = ((X509_CRL *)OPENSSL_sk_value(ossl_check_const_X509_CRL_sk_type(crls), (i)));
    ...
    *dcrl = 
# 1256 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 1256 "../crypto/x509/x509_vfy.c"
               ;
}
# 1266 "../crypto/x509/x509_vfy.c"
static int get_crl_score(X509_STORE_CTX *ctx, X509 **pissuer,
                         unsigned int *preasons, X509_CRL *crl, X509 *x)
{
    int crl_score = 0;
...
# 1287 "../crypto/x509/x509_vfy.c" 3 4
                                    ((void *)0)
# 1287 "../crypto/x509/x509_vfy.c"
                                        )
        return 0;
...
{
    X509 *crl_issuer = 
# 1329 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 1329 "../crypto/x509/x509_vfy.c"
                          ;
    const X509_NAME *cnm = X509_CRL_get_issuer(crl);
    int cidx = ctx->error_depth;
    int i;

    if (cidx != OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1)
        cidx++;

    crl_issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (cidx)));
    ...
    for (cidx++; cidx < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)); cidx++) {
        crl_issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (cidx)));
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->untrusted)); i++) {
        crl_issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->untrusted), (i)));
...
static int check_crl_path(X509_STORE_CTX *ctx, X509 *x)
{
    ...
    if (ctx->parent != 
# 1390 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 1390 "../crypto/x509/x509_vfy.c"
                          )
        return 0;
...
# 1422 "../crypto/x509/x509_vfy.c"
static int check_crl_chain(X509_STORE_CTX *ctx,
                           struct stack_st_X509 *cert_path,
                           struct stack_st_X509 *crl_path)
{
    X509 *cert_ta = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(cert_path), (OPENSSL_sk_num(ossl_check_const_X509_sk_type(cert_path)) - 1)));
    X509 *crl_ta = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(crl_path), (OPENSSL_sk_num(ossl_check_const_X509_sk_type(crl_path)) - 1)));

    return X509_cmp(cert_ta, crl_ta) == 0;
}
# 1439 "../crypto/x509/x509_vfy.c"
static int idp_check_dp(DIST_POINT_NAME *a, DIST_POINT_NAME *b)
{
    X509_NAME *nm = 
# 1441 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1441 "../crypto/x509/x509_vfy.c"
                       ;
    GENERAL_NAMES *gens = 
# 1442 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 1442 "../crypto/x509/x509_vfy.c"
                             ;
    GENERAL_NAME *gena, *genb;
    int i, j;

    if (a == 
# 1446 "../crypto/x509/x509_vfy.c" 3 4
            ((void *)0) 
# 1446 "../crypto/x509/x509_vfy.c"
                 || b == 
# 1446 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 1446 "../crypto/x509/x509_vfy.c"
    ...
    if (a->type == 1) {
        if (a->dpname == 
# 1449 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 1449 "../crypto/x509/x509_vfy.c"
                            )
            return 0;

        if (b->type == 1) {
            if (b->dpname == 
# 1453 "../crypto/x509/x509_vfy.c" 3 4
                            ((void *)0)
# 1453 "../crypto/x509/x509_vfy.c"
                                )
                return 0;
        ...
        if (b->dpname == 
# 1461 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 1461 "../crypto/x509/x509_vfy.c"
                            )
            return 0;
    ...
    if (nm != 
# 1469 "../crypto/x509/x509_vfy.c" 3 4
             ((void *)0)
# 1469 "../crypto/x509/x509_vfy.c"
                 ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gens)); i++) {
            gena = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gens), (i)));
            if (gena->type != 4)
                continue;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(a->name.fullname)); i++) {
        gena = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(a->name.fullname), (i)));
        for (j = 0; j < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(b->name.fullname)); j++) {
            genb = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(b->name.fullname), (j)));
...
static int crldp_check_crlissuer(DIST_POINT *dp, X509_CRL *crl, int crl_score)
{
    ...
    if (dp->CRLissuer == 
# 1501 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 1501 "../crypto/x509/x509_vfy.c"
                            )
        return (crl_score & 0x020) != 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(dp->CRLissuer)); i++) {
        GENERAL_NAME *gen = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(dp->CRLissuer), (i)));
                           ...
                           unsigned int *preasons)
{
    ...
    if ((crl->idp_flags & 0x10) != 0)
        return 0;
    if ((x->ex_flags & 0x10) != 0) {
        if ((crl->idp_flags & 0x4) != 0)
            return 0;
    } else {
        if ((crl->idp_flags & 0x8) != 0)
            return 0;
    }
    *preasons = crl->idp_reasons;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_DIST_POINT_sk_type(x->crldp)); i++) {
        DIST_POINT *dp = ((DIST_POINT *)OPENSSL_sk_value(ossl_check_const_DIST_POINT_sk_type(x->crldp), (i)));

        if (crldp_check_crlissuer(dp, crl, crl_score)) {
            if (crl->idp == 
# 1534 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
                    
# 1535 "../crypto/x509/x509_vfy.c"
    ...
    return (crl->idp == 
# 1541 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0) 
# 1541 "../crypto/x509/x509_vfy.c"
                            || crl->idp->distpoint == 
# 1541 "../crypto/x509/x509_vfy.c" 3 4
                                                      ((void *)0)
# 1541 "../crypto/x509/x509_vfy.c"
                         ...
                         X509_CRL **pcrl, X509_CRL **pdcrl, X509 *x)
{
    int ok;
    X509 *issuer = 
# 1553 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0)
# 1553 "../crypto/x509/x509_vfy.c"
                      ;
    int crl_score = 0;
    unsigned int reasons;
    X509_CRL *crl = 
# 1556 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1556 "../crypto/x509/x509_vfy.c"
                       , *dcrl = 
# 1556 "../crypto/x509/x509_vfy.c" 3 4
                                 ((void *)0)
# 1556 "../crypto/x509/x509_vfy.c"
    ...
    if (skcrl == 
# 1570 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 1570 "../crypto/x509/x509_vfy.c"
                     && crl != 
# 1570 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 1570 "../crypto/x509/x509_vfy.c"
    ...
    OPENSSL_sk_pop_free(ossl_check_X509_CRL_sk_type(skcrl),ossl_check_X509_CRL_freefunc_type(X509_CRL_free));

 done:

    if (crl != 
# 1579 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 1579 "../crypto/x509/x509_vfy.c"
                  ) {
...
{
    X509 *issuer = 
# 1593 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0)
# 1593 "../crypto/x509/x509_vfy.c"
                      ;
    EVP_PKEY *ikey = 
# 1594 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0)
# 1594 "../crypto/x509/x509_vfy.c"
                        ;
    int cnum = ctx->error_depth;
    int chnum = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1;


    if (ctx->current_issuer != 
# 1599 "../crypto/x509/x509_vfy.c" 3 4
                              ((void *)0)
# 1599 "../crypto/x509/x509_vfy.c"
                                  ) {
        ...
        issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (cnum + 1)));
    } else {
        issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (chnum)));

        if (!ctx->check_issued(ctx, issuer, issuer) &&
            !verify_cb_crl(ctx, 33))
            return 0;
    }

    if (issuer == 
# 1615 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 1615 "../crypto/x509/x509_vfy.c"
                     )
        return 1;
...
# 1621 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 1621 "../crypto/x509/x509_vfy.c"
                                   ) {

        if ((issuer->ex_flags & 0x2) != 0 &&
            (issuer->ex_kusage & 0x0002) == 0 &&
            !verify_cb_crl(ctx, 35))
            return 0;

        if ((ctx->current_crl_score & 0x080) == 0 &&
            !verify_cb_crl(ctx, 44))
            return 0;

        if ((ctx->current_crl_score & 0x008) == 0 &&
            check_crl_path(ctx, ctx->current_issuer) <= 0 &&
            !verify_cb_crl(ctx, 54))
            return 0;

        if ((crl->idp_flags & 0x2) != 0 &&
            !verify_cb_crl(ctx, 41))
            return 0;
    }

    if ((ctx->current_crl_score & 0x040) == 0 &&
    ...
    if (ikey == 
# 1648 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 1648 "../crypto/x509/x509_vfy.c"
                    &&
        !verify_cb_crl(ctx, 6))
        return 0;

    if (ikey != 
# 1652 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 1652 "../crypto/x509/x509_vfy.c"
                   ) {
        int rv = X509_CRL_check_suiteb(crl, ikey, ctx->param->flags);

        if (rv != 0 && !verify_cb_crl(ctx, rv))
            return 0;
...
static int check_policy(X509_STORE_CTX *ctx)
{
    ...
    if (ctx->parent)
        return 1;
# 1712 "../crypto/x509/x509_vfy.c"
    if (ctx->bare_ta_signed && !OPENSSL_sk_push(ossl_check_X509_sk_type(ctx->chain), ossl_check_X509_type(
# 1712 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 1712 "../crypto/x509/x509_vfy.c"
                               ))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",1713,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 1713 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 1713 "../crypto/x509/x509_vfy.c"
       );
        goto memerr;
    }
    ...
    if (ctx->bare_ta_signed)
        (void)((X509 *)OPENSSL_sk_pop(ossl_check_X509_sk_type(ctx->chain)));

    if (ret == 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",1722,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 1722 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 1722 "../crypto/x509/x509_vfy.c"
       );
        goto memerr;
    }
    ...
    if (ret == -1) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)); i++) {
            X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (i)));

            if ((x->ex_flags & 0x800) != 0)
                cbcalled = 1;
            if (((x->ex_flags & 0x800) != 0) && verify_cb_cert(ctx, x, i, 42) == 0) return 0
                                                                      ;
        }
        if (!cbcalled) {

            (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",1740,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1740 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 1740 "../crypto/x509/x509_vfy.c"
           );
            return 0;
        }
    ...
    if (ret == -2) {
        ctx->current_cert = 
# 1747 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 1747 "../crypto/x509/x509_vfy.c"
                               ;
        ctx->error = 43;
        return ctx->verify_cb(0, ctx);
    }
    if (ret != 1) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",1752,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1752 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 1752 "../crypto/x509/x509_vfy.c"
       );
        return 0;
    }
    ...
    if ((ctx->param->flags & 0x800) != 0) {
        ctx->current_cert = 
# 1757 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 1757 "../crypto/x509/x509_vfy.c"
                               ;
...
int ossl_x509_check_cert_time(X509_STORE_CTX *ctx, X509 *x, int depth)
{
    ...
    if ((ctx->param->flags & 0x2) != 0)
        ...
        ptime = 
# 1793 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 1793 "../crypto/x509/x509_vfy.c"
                   ;

    i = X509_cmp_time(X509_get0_notBefore(x), ptime);
    if (i >= 0 && depth < 0)
        return 0;
    if ((i == 0) && verify_cb_cert(ctx, x, depth, 13) == 0) return 0;
    if ((i > 0) && verify_cb_cert(ctx, x, depth, 9) == 0) return 0;

    i = X509_cmp_time(X509_get0_notAfter(x), ptime);
    if (i <= 0 && depth < 0)
        return 0;
    if ((i == 0) && verify_cb_cert(ctx, x, depth, 14) == 0) return 0;
    if ((i < 0) && verify_cb_cert(ctx, x, depth, 10) == 0) return 0;
    return 1;
}
...
static int internal_verify(X509_STORE_CTX *ctx)
{
    ...
    if (ctx->rpk != 
# 1820 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1820 "../crypto/x509/x509_vfy.c"
                       ) {
        if (!ctx->verify_cb(ctx->error == 0, ctx))
            return 0;
        return 1;
    }
    n = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) - 1;
    xi = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (n)));
    xs = xi;
    ...
    if (ctx->bare_ta_signed) {
        ...
        xi = 
# 1836 "../crypto/x509/x509_vfy.c" 3 4
            ((void *)0)
# 1836 "../crypto/x509/x509_vfy.c"
                ;
    } else if (ossl_x509_likely_issued(xi, xi) != 0

               && ((ctx->param->flags & 0x80000) == 0)) {
        if (n > 0) {
            n--;
            ctx->error_depth = n;
            xs = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (n)));
        } else {
            if ((1) && verify_cb_cert(ctx, xi, 0, 21) == 0) return 0
                                                                  ;
        }
    ...
    while (n >= 0) {
# 1871 "../crypto/x509/x509_vfy.c"
        if (xi != 
# 1871 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
            
# 1872 "../crypto/x509/x509_vfy.c"
           && (xs != xi
                || ((ctx->param->flags & 0x4000) != 0
                    && (xi->ex_flags & 0x2000) != 0))) {
            EVP_PKEY *pkey;
...
# 1895 "../crypto/x509/x509_vfy.c"
            int ret = xs == xi && (xi->ex_flags & 0x10) == 0
                ? 0 : ossl_x509_signing_allowed(xi, xs);

            if ((ret != 0) && verify_cb_cert(ctx, xi, issuer_depth, ret) == 0) return 0;
            if ((pkey = X509_get0_pubkey(xi)) == 
# 1899 "../crypto/x509/x509_vfy.c" 3 4
                                                ((void *)0)
# 1899 "../crypto/x509/x509_vfy.c"
                                                    ) {
                if ((1) && verify_cb_cert(ctx, xi, issuer_depth, 6) == 0) return 0
                                                                         ;
            } else {
                if ((X509_verify(xs, pkey) <= 0) && verify_cb_cert(ctx, xs, n, 7) == 0) return 0
                                                                         ;
            }
        }
...
# 1933 "../crypto/x509/x509_vfy.c" 3 4
                             ((void *)0)
# 1933 "../crypto/x509/x509_vfy.c"
                                 );
}
...
int X509_cmp_time(const ASN1_TIME *ctm, time_t *cmp_time)
{
    ...
    ASN1_TIME *asn1_cmp_time = 
# 1941 "../crypto/x509/x509_vfy.c" 3 4
                              ((void *)0)
# 1941 "../crypto/x509/x509_vfy.c"
                                  ;
    int i, day, sec, ret = 0;
...
# 1960 "../crypto/x509/x509_vfy.c"
    ...
    asn1_cmp_time = X509_time_adj(
# 1990 "../crypto/x509/x509_vfy.c" 3 4
                                 ((void *)0)
# 1990 "../crypto/x509/x509_vfy.c"
                                     , 0, cmp_time);
    if (asn1_cmp_time == 
# 1991 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 1991 "../crypto/x509/x509_vfy.c"
                            )
        goto err;
                       ...
                       const ASN1_TIME *start, const ASN1_TIME *end)
{
    time_t ref_time;
    time_t *time = 
# 2015 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0)
# 2015 "../crypto/x509/x509_vfy.c"
                      ;
    unsigned long flags = vpm == 
# 2016 "../crypto/x509/x509_vfy.c" 3 4
                                ((void *)0) 
# 2016 "../crypto/x509/x509_vfy.c"
    ...
    if (end != 
# 2025 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0) 
# 2025 "../crypto/x509/x509_vfy.c"
                   && X509_cmp_time(end, time) < 0)
        return 1;
    if (start != 
# 2027 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2027 "../crypto/x509/x509_vfy.c"
                     && X509_cmp_time(start, time) > 0)
        return -1;
    return 0;
}
...
# 2034 "../crypto/x509/x509_vfy.c" 3 4
                                ((void *)0)
# 2034 "../crypto/x509/x509_vfy.c"
                                    );
}
                            ...
                            int offset_day, long offset_sec, time_t *in_tm)
{
    ...
    if (s != 
# 2052 "../crypto/x509/x509_vfy.c" 3 4
            ((void *)0) 
# 2052 "../crypto/x509/x509_vfy.c"
                 && (s->flags & 0x040) == 0) {
        if (s->type == 23)
...
{
    EVP_PKEY *ktmp = 
# 2064 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0)
# 2064 "../crypto/x509/x509_vfy.c"
                        , *ktmp2;
    int i, j;

    if (pkey != 
# 2067 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 2067 "../crypto/x509/x509_vfy.c"
                    && !EVP_PKEY_missing_parameters(pkey))
        return 1;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)); i++) {
        ktmp = X509_get0_pubkey(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (i))));
        if (ktmp == 
# 2072 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 2072 "../crypto/x509/x509_vfy.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2073,__func__), ERR_set_error)((11),(108),
# 2073 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 2073 "../crypto/x509/x509_vfy.c"
           );
            return 0;
        }
        if (!EVP_PKEY_missing_parameters(ktmp))
            break;
        ktmp = 
# 2078 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2078 "../crypto/x509/x509_vfy.c"
                  ;
    }
    if (ktmp == 
# 2080 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2080 "../crypto/x509/x509_vfy.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2081,__func__), ERR_set_error)((11),(107),
# 2081 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2081 "../crypto/x509/x509_vfy.c"
       );
        return 0;
    }
    ...
    for (j = i - 1; j >= 0; j--) {
        ktmp2 = X509_get0_pubkey(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (j))));
        if (!EVP_PKEY_copy_parameters(ktmp2, ktmp))
            return 0;
    }

    if (pkey != 
# 2092 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2092 "../crypto/x509/x509_vfy.c"
                   )
...
{
    X509_CRL *crl = 
# 2104 "../crypto/x509/x509_vfy.c" 3 4
                   ((void *)0)
# 2104 "../crypto/x509/x509_vfy.c"
                       ;
    int i;
    struct stack_st_X509_REVOKED *revs = 
# 2106 "../crypto/x509/x509_vfy.c" 3 4
                                  ((void *)0)
# 2106 "../crypto/x509/x509_vfy.c"
                                      ;


    if (base->base_crl_number != 
# 2109 "../crypto/x509/x509_vfy.c" 3 4
                                ((void *)0) 
# 2109 "../crypto/x509/x509_vfy.c"
                                     || newer->base_crl_number != 
# 2109 "../crypto/x509/x509_vfy.c" 3 4
                                                                  ((void *)0)
# 2109 "../crypto/x509/x509_vfy.c"
                                                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2110,__func__), ERR_set_error)((11),(127),
# 2110 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2110 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2111 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2111 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (base->crl_number == 
# 2114 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0) 
# 2114 "../crypto/x509/x509_vfy.c"
                                || newer->crl_number == 
# 2114 "../crypto/x509/x509_vfy.c" 3 4
                                                        ((void *)0)
# 2114 "../crypto/x509/x509_vfy.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2115,__func__), ERR_set_error)((11),(130),
# 2115 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2115 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2116 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2116 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (X509_NAME_cmp(X509_CRL_get_issuer(base),
                      X509_CRL_get_issuer(newer)) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2121,__func__), ERR_set_error)((11),(129),
# 2121 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2121 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2122 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2122 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (!crl_extension_match(base, newer, 90)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2126,__func__), ERR_set_error)((11),(110),
# 2126 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2126 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2127 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2127 "../crypto/x509/x509_vfy.c"
                  ;
    }
    if (!crl_extension_match(base, newer, 770)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2130,__func__), ERR_set_error)((11),(128),
# 2130 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2130 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2131 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2131 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (ASN1_INTEGER_cmp(newer->crl_number, base->crl_number) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2135,__func__), ERR_set_error)((11),(132),
# 2135 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2135 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2136 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2136 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (skey != 
# 2139 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 2139 "../crypto/x509/x509_vfy.c"
                    && (X509_CRL_verify(base, skey) <= 0 ||
                         X509_CRL_verify(newer, skey) <= 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2141,__func__), ERR_set_error)((11),(131),
# 2141 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2141 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2142 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2142 "../crypto/x509/x509_vfy.c"
                  ;
    }

    crl = X509_CRL_new_ex(base->libctx, base->propq);
    if (crl == 
# 2146 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0) 
# 2146 "../crypto/x509/x509_vfy.c"
                   || !X509_CRL_set_version(crl, 1)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2147,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2147 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2147 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }

    if (!X509_CRL_set_issuer_name(crl, X509_CRL_get_issuer(newer))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2152,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2152 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2152 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }

    if (!X509_CRL_set1_lastUpdate(crl, X509_CRL_get0_lastUpdate(newer))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2157,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2157 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2157 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }
    if (!X509_CRL_set1_nextUpdate(crl, X509_CRL_get0_nextUpdate(newer))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2161,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2161 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2161 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }


    if (!X509_CRL_add1_ext_i2d(crl, 140, base->crl_number, 1, 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2167,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2167 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2167 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }
    ...
    for (i = 0; i < X509_CRL_get_ext_count(newer); i++) {
        ...
        if (!X509_CRL_add_ext(crl, ext, -1)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2179,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2179 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 2179 "../crypto/x509/x509_vfy.c"
           );
            goto err;
        }
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(revs)); i++) {
        X509_REVOKED *rvn, *rvtmp;

        rvn = ((X509_REVOKED *)OPENSSL_sk_value(ossl_check_const_X509_REVOKED_sk_type(revs), (i)));
        ...
        if (!X509_CRL_get0_by_serial(base, &rvtmp, &rvn->serialNumber)) {
            ...
            if (rvtmp == 
# 2198 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 2198 "../crypto/x509/x509_vfy.c"
                            ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2199,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 2199 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2199 "../crypto/x509/x509_vfy.c"
               );
                goto err;
            }
            if (!X509_CRL_add0_revoked(crl, rvtmp)) {
                X509_REVOKED_free(rvtmp);
                (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2204,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2204 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2204 "../crypto/x509/x509_vfy.c"
               );
                goto err;
            }
        }
    ...
    if (skey != 
# 2210 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 2210 "../crypto/x509/x509_vfy.c"
                    && md != 
# 2210 "../crypto/x509/x509_vfy.c" 3 4
                             ((void *)0) 
# 2210 "../crypto/x509/x509_vfy.c"
                                  && !X509_CRL_sign(crl, skey, md)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2211,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 2211 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2211 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }
 ...
 err:
    X509_CRL_free(crl);
    return 
# 2219 "../crypto/x509/x509_vfy.c" 3 4
          ((void *)0)
# 2219 "../crypto/x509/x509_vfy.c"
              ;
}
...
{
    if (ctx->chain == 
# 2269 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 2269 "../crypto/x509/x509_vfy.c"
                         )
        return 
# 2270 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2270 "../crypto/x509/x509_vfy.c"
                  ;
                                   ...
                                   int purpose, int trust)
{
    ...
    if (purpose != 0) {
        ...
        if (idx == -1) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2353,__func__), ERR_set_error)((11),(121),
# 2353 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 2353 "../crypto/x509/x509_vfy.c"
           );
            return 0;
        }
        ...
        if (ptmp->trust == 0) {
            ...
            if (idx == -1) {
                (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2360,__func__), ERR_set_error)((11),(121),
# 2360 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2360 "../crypto/x509/x509_vfy.c"
               );
                return 0;
            }
            ptmp = X509_PURPOSE_get0(idx);
    ...
    if (trust != 0) {
        ...
        if (idx == -1) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2372,__func__), ERR_set_error)((11),(120),
# 2372 "../crypto/x509/x509_vfy.c" 3 4
           ((void *)0)
# 2372 "../crypto/x509/x509_vfy.c"
           );
            return 0;
        }
    }
...
X509_STORE_CTX *X509_STORE_CTX_new_ex(OSSL_LIB_CTX *libctx, const char *propq)
{
    X509_STORE_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/x509/x509_vfy.c", 2386);

    if (ctx == 
# 2388 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2388 "../crypto/x509/x509_vfy.c"
                  )
        return 
# 2389 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2389 "../crypto/x509/x509_vfy.c"
                  ;

    ctx->libctx = libctx;
    if (propq != 
# 2392 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2392 "../crypto/x509/x509_vfy.c"
                    ) {
        ctx->propq = CRYPTO_strdup(propq, "../crypto/x509/x509_vfy.c", 2393);
        if (ctx->propq == 
# 2394 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 2394 "../crypto/x509/x509_vfy.c"
                             ) {
            CRYPTO_free(ctx, "../crypto/x509/x509_vfy.c", 2395);
            return 
# 2396 "../crypto/x509/x509_vfy.c" 3 4
                  ((void *)0)
# 2396 "../crypto/x509/x509_vfy.c"
                      ;
        }
    }
...
X509_STORE_CTX *X509_STORE_CTX_new(void)
{
    return X509_STORE_CTX_new_ex(
# 2405 "../crypto/x509/x509_vfy.c" 3 4
                                ((void *)0)
# 2405 "../crypto/x509/x509_vfy.c"
                                    , 
# 2405 "../crypto/x509/x509_vfy.c" 3 4
                                      ((void *)0)
# 2405 "../crypto/x509/x509_vfy.c"
...
{
    if (ctx == 
# 2410 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2410 "../crypto/x509/x509_vfy.c"
                  )
        return;
    ...
    CRYPTO_free(ctx->propq, "../crypto/x509/x509_vfy.c", 2416);
    CRYPTO_free(ctx, "../crypto/x509/x509_vfy.c", 2417);
}
...
# 2423 "../crypto/x509/x509_vfy.c" 3 4
                                        ((void *)0)
# 2423 "../crypto/x509/x509_vfy.c"
                                            , 
# 2423 "../crypto/x509/x509_vfy.c" 3 4
                                              ((void *)0)
# 2423 "../crypto/x509/x509_vfy.c"
...
{
    if (ctx == 
# 2432 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2432 "../crypto/x509/x509_vfy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2433,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 2433 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2433 "../crypto/x509/x509_vfy.c"
       );
        return 0;
    }
    X509_STORE_CTX_cleanup(ctx);
    ...
    ctx->untrusted = chain;
    ctx->crls = 
# 2441 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2441 "../crypto/x509/x509_vfy.c"
                   ;
    ctx->num_untrusted = 0;
    ctx->other_ctx = 
# 2443 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0)
# 2443 "../crypto/x509/x509_vfy.c"
                        ;
    ctx->valid = 0;
    ctx->chain = 
# 2445 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2445 "../crypto/x509/x509_vfy.c"
                    ;
    ctx->error = 0;
    ctx->explicit_policy = 0;
    ctx->error_depth = 0;
    ctx->current_cert = 
# 2449 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 2449 "../crypto/x509/x509_vfy.c"
                           ;
    ctx->current_issuer = 
# 2450 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 2450 "../crypto/x509/x509_vfy.c"
                             ;
    ctx->current_crl = 
# 2451 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 2451 "../crypto/x509/x509_vfy.c"
                          ;
    ctx->current_crl_score = 0;
    ctx->current_reasons = 0;
    ctx->tree = 
# 2454 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2454 "../crypto/x509/x509_vfy.c"
                   ;
    ctx->parent = 
# 2455 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 2455 "../crypto/x509/x509_vfy.c"
                     ;
    ctx->dane = 
# 2456 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2456 "../crypto/x509/x509_vfy.c"
                   ;
    ctx->bare_ta_signed = 0;
    ctx->rpk = 
# 2458 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2458 "../crypto/x509/x509_vfy.c"
                  ;
    ...
    if (store != 
# 2463 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2463 "../crypto/x509/x509_vfy.c"
                    )
        ctx->cleanup = store->cleanup;
    else
        ctx->cleanup = 
# 2466 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 2466 "../crypto/x509/x509_vfy.c"
                          ;

    if (store != 
# 2468 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2468 "../crypto/x509/x509_vfy.c"
                     && store->check_issued != 
# 2468 "../crypto/x509/x509_vfy.c" 3 4
                                               ((void *)0)
# 2468 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2473 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2473 "../crypto/x509/x509_vfy.c"
                     && store->get_issuer != 
# 2473 "../crypto/x509/x509_vfy.c" 3 4
                                             ((void *)0)
# 2473 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2478 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2478 "../crypto/x509/x509_vfy.c"
                     && store->verify_cb != 
# 2478 "../crypto/x509/x509_vfy.c" 3 4
                                            ((void *)0)
# 2478 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2483 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2483 "../crypto/x509/x509_vfy.c"
                     && store->verify != 
# 2483 "../crypto/x509/x509_vfy.c" 3 4
                                         ((void *)0)
# 2483 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2488 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2488 "../crypto/x509/x509_vfy.c"
...
# 2488 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2493 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2493 "../crypto/x509/x509_vfy.c"
                     && store->get_crl != 
# 2493 "../crypto/x509/x509_vfy.c" 3 4
                                          ((void *)0)
# 2493 "../crypto/x509/x509_vfy.c"
        ...
        ctx->get_crl = 
# 2496 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 2496 "../crypto/x509/x509_vfy.c"
                          ;

    if (store != 
# 2498 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2498 "../crypto/x509/x509_vfy.c"
                     && store->check_crl != 
# 2498 "../crypto/x509/x509_vfy.c" 3 4
                                            ((void *)0)
# 2498 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2503 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2503 "../crypto/x509/x509_vfy.c"
                     && store->cert_crl != 
# 2503 "../crypto/x509/x509_vfy.c" 3 4
                                           ((void *)0)
# 2503 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2508 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2508 "../crypto/x509/x509_vfy.c"
                     && store->check_policy != 
# 2508 "../crypto/x509/x509_vfy.c" 3 4
                                               ((void *)0)
# 2508 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2513 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2513 "../crypto/x509/x509_vfy.c"
                     && store->lookup_certs != 
# 2513 "../crypto/x509/x509_vfy.c" 3 4
                                               ((void *)0)
# 2513 "../crypto/x509/x509_vfy.c"
    ...
    if (store != 
# 2518 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0) 
# 2518 "../crypto/x509/x509_vfy.c"
                     && store->lookup_crls != 
# 2518 "../crypto/x509/x509_vfy.c" 3 4
                                              ((void *)0)
# 2518 "../crypto/x509/x509_vfy.c"
    ...
    if (ctx->param == 
# 2524 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 2524 "../crypto/x509/x509_vfy.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2525,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 2525 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2525 "../crypto/x509/x509_vfy.c"
       );
        goto err;
    }
    ...
    if (store == 
# 2530 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2530 "../crypto/x509/x509_vfy.c"
                    )
    ...
    if (ctx->param->trust == 0) {
        ...
        if (xp != 
# 2546 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 2546 "../crypto/x509/x509_vfy.c"
                     )
    ...
    if (CRYPTO_new_ex_data(5, ctx,
                           &ctx->ex_data))
        return 1;
    (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2553,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 2553 "../crypto/x509/x509_vfy.c" 3 4
   ((void *)0)
# 2553 "../crypto/x509/x509_vfy.c"
   );
...
void X509_STORE_CTX_cleanup(X509_STORE_CTX *ctx)
{
    ...
    if (ctx->cleanup != 
# 2584 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 2584 "../crypto/x509/x509_vfy.c"
                           ) {
        ctx->cleanup(ctx);
        ctx->cleanup = 
# 2586 "../crypto/x509/x509_vfy.c" 3 4
                      ((void *)0)
# 2586 "../crypto/x509/x509_vfy.c"
                          ;
    }
    if (ctx->param != 
# 2588 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 2588 "../crypto/x509/x509_vfy.c"
                         ) {
        if (ctx->parent == 
# 2589 "../crypto/x509/x509_vfy.c" 3 4
                          ((void *)0)
# 2589 "../crypto/x509/x509_vfy.c"
                              )
            X509_VERIFY_PARAM_free(ctx->param);
        ctx->param = 
# 2591 "../crypto/x509/x509_vfy.c" 3 4
                    ((void *)0)
# 2591 "../crypto/x509/x509_vfy.c"
                        ;
    }
    X509_policy_tree_free(ctx->tree);
    ctx->tree = 
# 2594 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 2594 "../crypto/x509/x509_vfy.c"
                   ;
    OSSL_STACK_OF_X509_free(ctx->chain);
    ctx->chain = 
# 2596 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2596 "../crypto/x509/x509_vfy.c"
                    ;
...
void X509_STORE_CTX_set0_verified_chain(X509_STORE_CTX *ctx, struct stack_st_X509 *sk)
{
    OSSL_STACK_OF_X509_free(ctx->chain);
    ctx->chain = sk;
}
...
int X509_STORE_CTX_set_default(X509_STORE_CTX *ctx, const char *name)
{
    ...
    if (param == 
# 2755 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 2755 "../crypto/x509/x509_vfy.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2756,__func__), ERR_set_error)(11, 121, "name=%s", name);
        return 0;
    }
...
{
    unsigned char *buf = 
# 2781 "../crypto/x509/x509_vfy.c" 3 4
                        ((void *)0)
# 2781 "../crypto/x509/x509_vfy.c"
                            ;
    int len;
    ...
    case 1:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2795,__func__), ERR_set_error)((11),(133),
# 2795 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2795 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2796 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2796 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if (len < 0 || buf == 
# 2799 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 2799 "../crypto/x509/x509_vfy.c"
                             ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",2800,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 2800 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 2800 "../crypto/x509/x509_vfy.c"
       );
        return 
# 2801 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 2801 "../crypto/x509/x509_vfy.c"
                  ;
    }
...
static int dane_match_cert(X509_STORE_CTX *ctx, X509 *cert, int depth)
{
    SSL_DANE *dane = ctx->dane;
    unsigned usage = 256;
    unsigned selector = 256;
    unsigned ordinal = 256;
    unsigned mtype = 256;
    unsigned char *i2dbuf = 
# 2818 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 2818 "../crypto/x509/x509_vfy.c"
                               ;
    unsigned int i2dlen = 0;
    unsigned char mdbuf[64];
    unsigned char *cmpbuf = 
# 2821 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 2821 "../crypto/x509/x509_vfy.c"
                               ;
    ...
    int matched = 0;
    danetls_record *t = 
# 2826 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 2826 "../crypto/x509/x509_vfy.c"
                           ;
    uint32_t mask;

    mask = (depth == 0) ? (((((uint32_t)1) << 1)) | ((((uint32_t)1) << 3))) : (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 2)));


    if (depth >= ctx->num_untrusted)
        mask &= (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 1)));
...
# 2871 "../crypto/x509/x509_vfy.c"
    ...
    for (i = 0; matched == 0 && i < recnum; ++i) {
        ...
        if (t->selector != selector) {
            ...
            CRYPTO_free(i2dbuf, "../crypto/x509/x509_vfy.c", 2887);
            i2dbuf = dane_i2d(cert, selector, &i2dlen);
            if (i2dbuf == 
# 2889 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 2889 "../crypto/x509/x509_vfy.c"
                             )
                return -1;
...
# 2905 "../crypto/x509/x509_vfy.c"
        ...
        if (t->mtype != mtype) {
            ...
            if (md != 
# 2919 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 2919 "../crypto/x509/x509_vfy.c"
                         ) {
                cmpbuf = mdbuf;
        ...
        if (cmplen == t->dlen &&
            ...
            if ((((uint32_t)1) << usage) & (((((uint32_t)1) << 2)) | ((((uint32_t)1) << 3))))
                matched = 1;
            if (matched || dane->mdpth < 0) {
                dane->mdpth = depth;
                dane->mtlsa = t;
                CRYPTO_free(dane->mcert, "../crypto/x509/x509_vfy.c", 2940);
                dane->mcert = cert;
                X509_up_ref(cert);
            }
            break;
    ...
    CRYPTO_free(i2dbuf, "../crypto/x509/x509_vfy.c", 2949);
    return matched;
}
...
static int check_dane_issuer(X509_STORE_CTX *ctx, int depth)
{
    ...
    if (!((dane) && ((dane)->umask & (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 2))))) || depth == 0)
        return 3;
    ...
    cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (depth)));
    if (cert != 
# 2969 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 2969 "../crypto/x509/x509_vfy.c"
                    && (matched = dane_match_cert(ctx, cert, depth)) < 0)
        return matched;
    if (matched > 0) {
...
static int check_dane_pkeys(X509_STORE_CTX *ctx)
{
    ...
    X509 *cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (num - 1)));
    ...
    for (i = 0; i < recnum; ++i) {
        ...
        dane->mcert = 
# 2998 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 2998 "../crypto/x509/x509_vfy.c"
                         ;
        ...
        num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
        for (; num > ctx->num_untrusted; --num)
            X509_free(((X509 *)OPENSSL_sk_pop(ossl_check_X509_sk_type(ctx->chain))));
...
static int dane_match_rpk(X509_STORE_CTX *ctx, EVP_PKEY *rpk)
{
    SSL_DANE *dane = ctx->dane;
    danetls_record *t = 
# 3023 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 3023 "../crypto/x509/x509_vfy.c"
                           ;
    int mtype = 0;
    unsigned char *i2dbuf = 
# 3025 "../crypto/x509/x509_vfy.c" 3 4
                           ((void *)0)
# 3025 "../crypto/x509/x509_vfy.c"
                               ;
    unsigned int i2dlen = 0;
    unsigned char mdbuf[64];
    unsigned char *cmpbuf;
    ...
    for (i = 0; i < recnum; i++) {
        ...
        if (t->mtype != mtype) {
            ...
            if (md != 
# 3053 "../crypto/x509/x509_vfy.c" 3 4
                     ((void *)0)
# 3053 "../crypto/x509/x509_vfy.c"
                         ) {
                cmpbuf = mdbuf;
                if (!EVP_Digest(i2dbuf, i2dlen, cmpbuf, &cmplen, md, 0)) {
                    matched = -1;
    ...
    CRYPTO_free(i2dbuf, "../crypto/x509/x509_vfy.c", 3068);
    return matched;
}
...
static void dane_reset(SSL_DANE *dane)
{
    ...
    X509_free(dane->mcert);
    dane->mcert = 
# 3076 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 3076 "../crypto/x509/x509_vfy.c"
                     ;
    dane->mtlsa = 
# 3077 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 3077 "../crypto/x509/x509_vfy.c"
                     ;
    dane->mdpth = -1;
    dane->pdpth = -1;
}
...
{
    int err = X509_chain_check_suiteb(
# 3085 "../crypto/x509/x509_vfy.c" 3 4
                                     ((void *)0)
# 3085 "../crypto/x509/x509_vfy.c"
                                         , cert, 
# 3085 "../crypto/x509/x509_vfy.c" 3 4
                                                 ((void *)0)
# 3085 "../crypto/x509/x509_vfy.c"
    ...
    if ((err != 0) && verify_cb_cert(ctx, cert, 0, err) == 0) return 0;
    return 1;
}
...
static int dane_verify(X509_STORE_CTX *ctx)
{
    ...
    dane_reset(dane);
# 3143 "../crypto/x509/x509_vfy.c"
    matched = dane_match_cert(ctx, ctx->cert, 0);
    done = matched != 0 || (!((dane) && ((dane)->umask & (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 2))))) && dane->mdpth < 0);

    if (done && !X509_get_pubkey_parameters(
# 3146 "../crypto/x509/x509_vfy.c" 3 4
                                           ((void *)0)
# 3146 "../crypto/x509/x509_vfy.c"
                                               , ctx->chain))
        return -1;
    ...
    if (done) {
        ...
        if (!check_leaf_suiteb(ctx, cert))
            return 0;
        return verify_cb_cert(ctx, cert, 0, 65);
    }
...
{
    struct stack_st_X509 *saved_chain = ctx->chain;
    int ok;

    ctx->chain = 
# 3193 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 3193 "../crypto/x509/x509_vfy.c"
                    ;
...
static int build_chain(X509_STORE_CTX *ctx)
{
    SSL_DANE *dane = ctx->dane;
    int num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
    struct stack_st_X509 *sk_untrusted = 
# 3208 "../crypto/x509/x509_vfy.c" 3 4
                                  ((void *)0)
# 3208 "../crypto/x509/x509_vfy.c"
                                      ;
    unsigned int search;
    int may_trusted = 0;
    int may_alternate = 0;
    ...
    if (!__builtin_expect(!!((num == 1 && ctx->num_untrusted == num) != 0), 1))
        goto int_err;
# 3233 "../crypto/x509/x509_vfy.c"
    search = ctx->untrusted != 
# 3233 "../crypto/x509/x509_vfy.c" 3 4
                              ((void *)0) 
# 3233 "../crypto/x509/x509_vfy.c"
                                   ? (1 << 0) : 0;
    if (((dane) && ((dane)->umask & (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 1))))) || !((dane) && ((dane)->umask & (((((uint32_t)1) << 2)) | ((((uint32_t)1) << 3)))))) {
        if (search == 0 || (ctx->param->flags & 0x8000) != 0)
            search |= (1 << 1);
        else if (!(ctx->param->flags & 0x100000))
            may_alternate = 1;
        may_trusted = 1;
    }


    if ((sk_untrusted = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 3243 "../crypto/x509/x509_vfy.c" 3 4
                                              ((void *)0)
# 3243 "../crypto/x509/x509_vfy.c"
                                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3244,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 3244 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3244 "../crypto/x509/x509_vfy.c"
       );
        goto memerr;
    }
    ...
    if (((dane) != 
# 3252 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0) 
# 3252 "../crypto/x509/x509_vfy.c"
       && sk_danetls_record_num((dane)->trecs) > 0) && dane->certs != 
# 3252 "../crypto/x509/x509_vfy.c" 3 4
                                               ((void *)0)
        
# 3253 "../crypto/x509/x509_vfy.c"
       && !X509_add_certs(sk_untrusted, dane->certs, 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3254,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 3254 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3254 "../crypto/x509/x509_vfy.c"
       );
        goto memerr;
    }
    ...
    if (!X509_add_certs(sk_untrusted, ctx->untrusted, 0)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3264,__func__), ERR_set_error)((11),((11 | (0x2 << 18L))),
# 3264 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3264 "../crypto/x509/x509_vfy.c"
       );
        goto memerr;
    }
    ...
    if (ctx->param->depth > 0x7fffffff 
# 3272 "../crypto/x509/x509_vfy.c"
                                   / 2)
        ctx->param->depth = 0x7fffffff 
# 3273 "../crypto/x509/x509_vfy.c"
                                   / 2;
    ...
    while (search != 0) {
        X509 *curr, *issuer = 
# 3283 "../crypto/x509/x509_vfy.c" 3 4
                             ((void *)0)
# 3283 "../crypto/x509/x509_vfy.c"
                                 ;

        num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
        ctx->error_depth = num - 1;
# 3301 "../crypto/x509/x509_vfy.c"
        if ((search & (1 << 1)) != 0) {
            i = num;
            if ((search & (1 << 2)) != 0) {
# 3319 "../crypto/x509/x509_vfy.c"
                i = alt_untrusted;
            }
            curr = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (i - 1)));
...
# 3353 "../crypto/x509/x509_vfy.c"
                if ((search & (1 << 2)) != 0) {
                    if (!__builtin_expect(!!((num > i && i > 0 && !self_signed) != 0), 1)) {
                        X509_free(issuer);
                        goto int_err;
                    }
                    search &= ~(1 << 2);
                    ...
                    if (((dane) != 
# 3363 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0) 
# 3363 "../crypto/x509/x509_vfy.c"
                       && sk_danetls_record_num((dane)->trecs) > 0) &&
                        dane->mdpth >= ctx->num_untrusted) {
                        dane->mdpth = -1;
                        X509_free(dane->mcert);
                        dane->mcert = 
# 3367 "../crypto/x509/x509_vfy.c" 3 4
                                     ((void *)0)
# 3367 "../crypto/x509/x509_vfy.c"
                                         ;
                    }
                    if (((dane) != 
# 3369 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0) 
# 3369 "../crypto/x509/x509_vfy.c"
                       && sk_danetls_record_num((dane)->trecs) > 0) &&
                ...
                if (!self_signed) {
                    ...
                    if (!OPENSSL_sk_push(ossl_check_X509_sk_type(ctx->chain), ossl_check_X509_type(issuer))) {
                        X509_free(issuer);
                        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3378,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 3378 "../crypto/x509/x509_vfy.c" 3 4
                       ((void *)0)
# 3378 "../crypto/x509/x509_vfy.c"
                       );
                        goto memerr;
                    }
                    ...
                    if (X509_cmp(curr, issuer) != 0) {
                        ...
                        X509_free(curr);
                        ctx->num_untrusted = --num;
                        (void)((X509 *)OPENSSL_sk_set(ossl_check_X509_sk_type(ctx->chain), (num), ossl_check_X509_type(issuer)));
                    }
                }
# 3418 "../crypto/x509/x509_vfy.c"
                if (ok) {
                    if (!__builtin_expect(!!((ctx->num_untrusted <= num) != 0), 1))
                        goto int_err;
                    search &= ~(1 << 0);
            ...
            if ((search & (1 << 0)) == 0) {
                ...
                if ((search & (1 << 2)) != 0 && --alt_untrusted > 0)
                    continue;

                if (!may_alternate || (search & (1 << 2)) != 0 ||
                    ctx->num_untrusted < 2)
                    break;
        ...
        if ((search & (1 << 0)) != 0) {
            num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
            if (!__builtin_expect(!!((num == ctx->num_untrusted) != 0), 1))
                goto int_err;
            curr = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (num - 1)));
            issuer = (X509_self_signed(curr, 0) > 0 || num > max_depth) ?
                
# 3459 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0) 
# 3459 "../crypto/x509/x509_vfy.c"
                    : find_issuer(ctx, sk_untrusted, curr);
            if (issuer == 
# 3460 "../crypto/x509/x509_vfy.c" 3 4
                         ((void *)0)
# 3460 "../crypto/x509/x509_vfy.c"
                             ) {
            ...
            (void)((X509 *)OPENSSL_sk_delete_ptr(ossl_check_X509_sk_type(sk_untrusted), ossl_check_X509_type(issuer)));


            if (!X509_add_cert(ctx->chain, issuer, 0x1))
                goto int_err;
    ...
    OPENSSL_sk_free(ossl_check_X509_sk_type(sk_untrusted));
    ...
    num = OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain));
    if (num <= max_depth) {
        if (trust == 3 && ((dane)&&((dane)->umask & ((((uint32_t)1) << 2)))))
            trust = check_dane_pkeys(ctx);
        if (trust == 3 && num == ctx->num_untrusted)
            trust = check_trust(ctx, num);
    }
...
# 3519 "../crypto/x509/x509_vfy.c" 3 4
                                      ((void *)0)
# 3519 "../crypto/x509/x509_vfy.c"
                                          , num - 1, ctx->error);
        case 0:
            break;
        }
        if ((num > max_depth) && verify_cb_cert(ctx, 
# 3523 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3523 "../crypto/x509/x509_vfy.c"
       , num - 1, 22) == 0) return 0
                                                                      ;
        if ((((dane) != 
# 3525 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0) 
# 3525 "../crypto/x509/x509_vfy.c"
       && sk_danetls_record_num((dane)->trecs) > 0) && (!((dane) && ((dane)->umask & (((((uint32_t)1) << 0)) | ((((uint32_t)1) << 1))))) || dane->pdpth >= 0)) && verify_cb_cert(ctx, 
# 3525 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3525 "../crypto/x509/x509_vfy.c"
       , num - 1, 65) == 0) return 0
                                                                ...
                                                                ;
        if (X509_self_signed(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ctx->chain), (num - 1))), 0) > 0)
            return verify_cb_cert(ctx, 
# 3529 "../crypto/x509/x509_vfy.c" 3 4
                                      ((void *)0)
# 3529 "../crypto/x509/x509_vfy.c"
                                          , num - 1,
                                  num == 1
                                  ? 18
                                  : 19);
        return verify_cb_cert(ctx, 
# 3533 "../crypto/x509/x509_vfy.c" 3 4
                                  ((void *)0)
# 3533 "../crypto/x509/x509_vfy.c"
                                      , num - 1,
                              ctx->num_untrusted < num
                              ? 2
                              : 20);
 ...
 int_err:
    (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3540,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 3540 "../crypto/x509/x509_vfy.c" 3 4
   ((void *)0)
# 3540 "../crypto/x509/x509_vfy.c"
   );
    ctx->error = 1;
    OPENSSL_sk_free(ossl_check_X509_sk_type(sk_untrusted));
    return -1;
...
struct stack_st_X509 *X509_build_chain(X509 *target, struct stack_st_X509 *certs,
                                 ...
                                 OSSL_LIB_CTX *libctx, const char *propq)
{
    int finish_chain = store != 
# 3555 "../crypto/x509/x509_vfy.c" 3 4
                               ((void *)0)
# 3555 "../crypto/x509/x509_vfy.c"
                                   ;
    X509_STORE_CTX *ctx;
    int flags = 0x1;
    struct stack_st_X509 *result = 
# 3558 "../crypto/x509/x509_vfy.c" 3 4
                            ((void *)0)
# 3558 "../crypto/x509/x509_vfy.c"
                                ;

    if (target == 
# 3560 "../crypto/x509/x509_vfy.c" 3 4
                 ((void *)0)
# 3560 "../crypto/x509/x509_vfy.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vfy.c",3561,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 3561 "../crypto/x509/x509_vfy.c" 3 4
       ((void *)0)
# 3561 "../crypto/x509/x509_vfy.c"
       );
        return 
# 3562 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 3562 "../crypto/x509/x509_vfy.c"
                  ;
    }

    if ((ctx = X509_STORE_CTX_new_ex(libctx, propq)) == 
# 3565 "../crypto/x509/x509_vfy.c" 3 4
                                                       ((void *)0)
# 3565 "../crypto/x509/x509_vfy.c"
                                                           )
        return 
# 3566 "../crypto/x509/x509_vfy.c" 3 4
              ((void *)0)
# 3566 "../crypto/x509/x509_vfy.c"
                  ;
    if (!X509_STORE_CTX_init(ctx, store, target, finish_chain ? certs : 
# 3567 "../crypto/x509/x509_vfy.c" 3 4
                                                                       ((void *)0)
# 3567 "../crypto/x509/x509_vfy.c"
                                                                           ))
        goto err;
    if (!finish_chain)
        X509_STORE_CTX_set0_trusted_stack(ctx, certs);
    if (!ossl_x509_add_cert_new(&ctx->chain, target, 0x1)) {
        ctx->error = 17;
        goto err;
    }
    ctx->num_untrusted = 1;
    ...
    if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->chain)) > 1 && !with_self_signed)
        flags |= 0x8;
    if (!ossl_x509_add_certs_new(&result, ctx->chain, flags)) {
        OPENSSL_sk_free(ossl_check_X509_sk_type(result));
        result = 
# 3585 "../crypto/x509/x509_vfy.c" 3 4
                ((void *)0)
# 3585 "../crypto/x509/x509_vfy.c"
                    ;
    }
...
static const int NUM_AUTH_LEVELS = (sizeof(minbits_table)/sizeof((minbits_table)[0]));
...
static int check_key_level(X509_STORE_CTX *ctx, EVP_PKEY *pkey)
{
    ...
    if (pkey == 
# 3618 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 3618 "../crypto/x509/x509_vfy.c"
                   )
        return 0;
...
static int check_curve(X509 *cert)
{
    ...
    if (pkey == 
# 3648 "../crypto/x509/x509_vfy.c" 3 4
               ((void *)0)
# 3648 "../crypto/x509/x509_vfy.c"
                   )
        return -1;
    if (EVP_PKEY_get_id(pkey) != 408)
        return 1;
...
static int check_sig_level(X509_STORE_CTX *ctx, X509 *cert)
{
    ...
    if (!X509_get_signature_info(cert, 
# 3677 "../crypto/x509/x509_vfy.c" 3 4
                                      ((void *)0)
# 3677 "../crypto/x509/x509_vfy.c"
                                          , 
# 3677 "../crypto/x509/x509_vfy.c" 3 4
                                            ((void *)0)
# 3677 "../crypto/x509/x509_vfy.c"
