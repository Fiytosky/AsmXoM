# 0 "../crypto/x509/x509_d2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_d2.c"
# 10 "../crypto/x509/x509_d2.c"
                                    ...
                                    const char *propq)
{
    ...
    if (lookup == 
# 21 "../crypto/x509/x509_d2.c" 3 4
                 ((void *)0)
# 21 "../crypto/x509/x509_d2.c"
                     )
        return 0;
    X509_LOOKUP_ctrl_ex((lookup), 1, (
# 23 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 23 "../crypto/x509/x509_d2.c"
   ), (long)(3), 
# 23 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 23 "../crypto/x509/x509_d2.c"
   , (libctx), (propq));
    ...
    if (lookup == 
# 26 "../crypto/x509/x509_d2.c" 3 4
                 ((void *)0)
# 26 "../crypto/x509/x509_d2.c"
                     )
        return 0;
    X509_LOOKUP_ctrl((lookup),2,(
# 28 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 28 "../crypto/x509/x509_d2.c"
   ),(long)(3),
# 28 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 28 "../crypto/x509/x509_d2.c"
    ...
    if (lookup == 
# 31 "../crypto/x509/x509_d2.c" 3 4
                 ((void *)0)
# 31 "../crypto/x509/x509_d2.c"
                     )
        return 0;
    X509_LOOKUP_ctrl_ex((lookup), 3, (
# 33 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 33 "../crypto/x509/x509_d2.c"
   ), 0, 
# 33 "../crypto/x509/x509_d2.c" 3 4
   ((void *)0)
# 33 "../crypto/x509/x509_d2.c"
...
{
    return X509_STORE_set_default_paths_ex(ctx, 
# 42 "../crypto/x509/x509_d2.c" 3 4
                                               ((void *)0)
# 42 "../crypto/x509/x509_d2.c"
                                                   , 
# 42 "../crypto/x509/x509_d2.c" 3 4
                                                     ((void *)0)
# 42 "../crypto/x509/x509_d2.c"
                            ...
                            OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (file == 
# 50 "../crypto/x509/x509_d2.c" 3 4
               ((void *)0)
        
# 51 "../crypto/x509/x509_d2.c"
       || (lookup = X509_STORE_add_lookup(ctx, X509_LOOKUP_file())) == 
# 51 "../crypto/x509/x509_d2.c" 3 4
                                                                       ((void *)0)
        
# 52 "../crypto/x509/x509_d2.c"
       || X509_LOOKUP_ctrl_ex((lookup), 1, (file), (long)(1), 
# 52 "../crypto/x509/x509_d2.c" 3 4
          ((void *)0)
# 52 "../crypto/x509/x509_d2.c"
          , (libctx), (propq))
                                           <= 0)
...
{
    return X509_STORE_load_file_ex(ctx, file, 
# 61 "../crypto/x509/x509_d2.c" 3 4
                                             ((void *)0)
# 61 "../crypto/x509/x509_d2.c"
                                                 , 
# 61 "../crypto/x509/x509_d2.c" 3 4
                                                   ((void *)0)
# 61 "../crypto/x509/x509_d2.c"
...
int X509_STORE_load_path(X509_STORE *ctx, const char *path)
{
    ...
    if (path == 
# 68 "../crypto/x509/x509_d2.c" 3 4
               ((void *)0)
        
# 69 "../crypto/x509/x509_d2.c"
       || (lookup = X509_STORE_add_lookup(ctx, X509_LOOKUP_hash_dir())) == 
# 69 "../crypto/x509/x509_d2.c" 3 4
                                                                           ((void *)0)
        
# 70 "../crypto/x509/x509_d2.c"
       || X509_LOOKUP_ctrl((lookup),2,(path),(long)(1),
# 70 "../crypto/x509/x509_d2.c" 3 4
          ((void *)0)
# 70 "../crypto/x509/x509_d2.c"
          ) <= 0)
        return 0;
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (uri == 
# 81 "../crypto/x509/x509_d2.c" 3 4
              ((void *)0)
        
# 82 "../crypto/x509/x509_d2.c"
       || (lookup = X509_STORE_add_lookup(ctx, X509_LOOKUP_store())) == 
# 82 "../crypto/x509/x509_d2.c" 3 4
                                                                        ((void *)0)
        
# 83 "../crypto/x509/x509_d2.c"
       || X509_LOOKUP_ctrl_ex((lookup), 3, (uri), 0, 
# 83 "../crypto/x509/x509_d2.c" 3 4
          ((void *)0)
# 83 "../crypto/x509/x509_d2.c"
          , (libctx), (propq)) == 0)
        return 0;
...
{
    return X509_STORE_load_store_ex(ctx, uri, 
# 91 "../crypto/x509/x509_d2.c" 3 4
                                             ((void *)0)
# 91 "../crypto/x509/x509_d2.c"
                                                 , 
# 91 "../crypto/x509/x509_d2.c" 3 4
                                                   ((void *)0)
# 91 "../crypto/x509/x509_d2.c"
...
{
    if (file == 
# 98 "../crypto/x509/x509_d2.c" 3 4
               ((void *)0) 
# 98 "../crypto/x509/x509_d2.c"
                    && path == 
# 98 "../crypto/x509/x509_d2.c" 3 4
                               ((void *)0)
# 98 "../crypto/x509/x509_d2.c"
        ...
        return 0;
    if (file != 
# 100 "../crypto/x509/x509_d2.c" 3 4
               ((void *)0) 
# 100 "../crypto/x509/x509_d2.c"
                    && !X509_STORE_load_file_ex(ctx, file, libctx, propq))
        return 0;
    if (path != 
# 102 "../crypto/x509/x509_d2.c" 3 4
               ((void *)0) 
# 102 "../crypto/x509/x509_d2.c"
...
int X509_STORE_load_locations(X509_STORE *ctx, const char *file,
                              const char *path)
{
    return X509_STORE_load_locations_ex(ctx, file, path, 
# 110 "../crypto/x509/x509_d2.c" 3 4
                                                        ((void *)0)
# 110 "../crypto/x509/x509_d2.c"
                                                            , 
# 110 "../crypto/x509/x509_d2.c" 3 4
                                                              ((void *)0)
# 110 "../crypto/x509/x509_d2.c"
