# 0 "../crypto/x509/t_x509.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/t_x509.c"
# 10 "../crypto/x509/t_x509.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 19 "../crypto/x509/t_x509.c" 2

void OSSL_STACK_OF_X509_free(struct stack_st_X509 *certs)
{
    OPENSSL_sk_pop_free(ossl_check_X509_sk_type(certs),ossl_check_X509_freefunc_type(X509_free));
}
...
# 37 "../crypto/x509/t_x509.c" 3 4
                                      ((void *)0)
# 37 "../crypto/x509/t_x509.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/t_x509.c",38,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 38 "../crypto/x509/t_x509.c" 3 4
       ((void *)0)
# 38 "../crypto/x509/t_x509.c"
       );
        return 0;
    }
                  ...
                  unsigned long cflag)
{
    ...
    EVP_PKEY *pkey = 
# 60 "../crypto/x509/t_x509.c" 3 4
                    ((void *)0)
# 60 "../crypto/x509/t_x509.c"
                        ;
    const char *neg;
    ...
    if (!(cflag & (1L << 3))) {
        ...
        if (BIO_puts(bp, "    ") <= 0)
            goto err;
        if (X509_signature_print(bp, tsig_alg, 
# 130 "../crypto/x509/t_x509.c" 3 4
                                              ((void *)0)
# 130 "../crypto/x509/t_x509.c"
                                                  ) <= 0)
            goto err;
    }
    ...
    if (!(cflag & (1L << 5))) {
        ...
        if (BIO_write(bp, "            Not Before: ", 24) <= 0)
            goto err;
        if (ossl_asn1_time_print_ex(bp, X509_get0_notBefore(x), 0x00UL) == 0)
            goto err;
        if (BIO_write(bp, "\n            Not After : ", 25) <= 0)
            goto err;
        if (ossl_asn1_time_print_ex(bp, X509_get0_notAfter(x), 0x00UL) == 0)
            goto err;
        if (BIO_write(bp, "\n", 1) <= 0)
            goto err;
    }
    ...
    if (!(cflag & (1L << 7))) {
        ...
        ASN1_OBJECT *xpoid;
        X509_PUBKEY_get0_param(&xpoid, 
# 169 "../crypto/x509/t_x509.c" 3 4
                                      ((void *)0)
# 169 "../crypto/x509/t_x509.c"
                                          , 
# 169 "../crypto/x509/t_x509.c" 3 4
                                            ((void *)0)
# 169 "../crypto/x509/t_x509.c"
...
# 169 "../crypto/x509/t_x509.c"
        ...
        if (pkey == 
# 180 "../crypto/x509/t_x509.c" 3 4
                   ((void *)0)
# 180 "../crypto/x509/t_x509.c"
                       ) {
            BIO_printf(bp, "%12sUnable to load Public Key\n", "");
            ERR_print_errors(bp);
        } else {
            EVP_PKEY_print_public(bp, pkey, 16, 
# 184 "../crypto/x509/t_x509.c" 3 4
                                               ((void *)0)
# 184 "../crypto/x509/t_x509.c"
                                                   );
        }
    }
    ...
    if (!(cflag & (1L << 12))) {
        ...
        if (iuid != 
# 191 "../crypto/x509/t_x509.c" 3 4
                   ((void *)0)
# 191 "../crypto/x509/t_x509.c"
                       ) {
        ...
        if (suid != 
# 197 "../crypto/x509/t_x509.c" 3 4
                   ((void *)0)
# 197 "../crypto/x509/t_x509.c"
                       ) {
...
{
    unsigned char *der = 
# 228 "../crypto/x509/t_x509.c" 3 4
                        ((void *)0)
# 228 "../crypto/x509/t_x509.c"
                            ;
    ...
    EVP_MD *md = 
# 235 "../crypto/x509/t_x509.c" 3 4
                ((void *)0)
# 235 "../crypto/x509/t_x509.c"
                    ;

    if (x == 
# 237 "../crypto/x509/t_x509.c" 3 4
            ((void *)0) 
# 237 "../crypto/x509/t_x509.c"
                 || bp == 
# 237 "../crypto/x509/t_x509.c" 3 4
                          ((void *)0)
# 237 "../crypto/x509/t_x509.c"
    ...
    derlen = i2d_X509_NAME(subj, 
# 245 "../crypto/x509/t_x509.c" 3 4
                                ((void *)0)
# 245 "../crypto/x509/t_x509.c"
                                    );
    if (derlen <= 0)
        goto err;
    if ((der = dertmp = CRYPTO_malloc(derlen, "../crypto/x509/t_x509.c", 248)) == 
# 248 "../crypto/x509/t_x509.c" 3 4
                                                  ((void *)0)
# 248 "../crypto/x509/t_x509.c"
                                                      )
        goto err;
    if (i2d_X509_NAME(subj, &dertmp) < 0)
        goto err;

    md = EVP_MD_fetch(x->libctx, "SHA1", x->propq);
    if (md == 
# 254 "../crypto/x509/t_x509.c" 3 4
             ((void *)0)
# 254 "../crypto/x509/t_x509.c"
                 )
        goto err;
    if (!EVP_Digest(der, derlen, SHA1md, 
# 256 "../crypto/x509/t_x509.c" 3 4
                                        ((void *)0)
# 256 "../crypto/x509/t_x509.c"
                                            , md, 
# 256 "../crypto/x509/t_x509.c" 3 4
                                                  ((void *)0)
# 256 "../crypto/x509/t_x509.c"
    ...
    CRYPTO_free(der, "../crypto/x509/t_x509.c", 262);
    der = 
# 263 "../crypto/x509/t_x509.c" 3 4
         ((void *)0)
# 263 "../crypto/x509/t_x509.c"
             ;
    ...
    if (keybstr == 
# 273 "../crypto/x509/t_x509.c" 3 4
                  ((void *)0)
# 273 "../crypto/x509/t_x509.c"
                      )
        goto err;

    if (!EVP_Digest(ASN1_STRING_get0_data(keybstr),
                    ASN1_STRING_length(keybstr), SHA1md, 
# 277 "../crypto/x509/t_x509.c" 3 4
                                                        ((void *)0)
# 277 "../crypto/x509/t_x509.c"
                                                            , md, 
# 277 "../crypto/x509/t_x509.c" 3 4
                                                                  ((void *)0)
# 277 "../crypto/x509/t_x509.c"
    ...
    return 1;
 err:
    CRYPTO_free(der, "../crypto/x509/t_x509.c", 288);
    EVP_MD_free(md);
    return 0;
}
...
# 333 "../crypto/x509/t_x509.c" 3 4
                                      ((void *)0)
# 333 "../crypto/x509/t_x509.c"
                                          , pkey_nid);
...
int X509_aux_print(BIO *out, X509 *x, int indent)
{
    ...
    struct stack_st_ASN1_OBJECT *trust, *reject;
    ...
    if (trust) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(trust)); i++) {
            ...
            OBJ_obj2txt(oidstr, sizeof(oidstr),
                        ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(trust), (i))), 0);
            BIO_puts(out, oidstr);
        }
        BIO_puts(out, "\n");
    } else
    ...
    if (reject) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(reject)); i++) {
            if (!first)
                ...
                first = 0;
            OBJ_obj2txt(oidstr, sizeof(oidstr),
                        ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(reject), (i))), 0);
            BIO_puts(out, oidstr);
        }
        BIO_puts(out, "\n");
    } else
...
int ossl_x509_print_ex_brief(BIO *bio, X509 *cert, unsigned long neg_cflags)
{
    unsigned long flags = (1 | 2 | 4 | 0x10 | 0x100 | 0x200) | 8 |
        (2 << 16) | 0;

    if (cert == 
# 408 "../crypto/x509/t_x509.c" 3 4
               ((void *)0)
# 408 "../crypto/x509/t_x509.c"
                   )
        return BIO_printf(bio, "    (no certificate)\n") > 0;
    if (BIO_printf(bio, "    certificate\n") <= 0
            || !X509_print_ex(bio, cert, flags, ~(1L << 6)))
        return 0;
    if (X509_check_issued((X509 *)cert, cert) == 0) {
        if (BIO_printf(bio, "        self-issued\n") <= 0)
            return 0;
    } else {
        if (BIO_printf(bio, " ") <= 0
            || !X509_print_ex(bio, cert, flags, ~(1L << 4)))
            return 0;
    }
...
static int print_certs(BIO *bio, const struct stack_st_X509 *certs)
{
    int i;

    if (certs == 
# 438 "../crypto/x509/t_x509.c" 3 4
                ((void *)0) 
# 438 "../crypto/x509/t_x509.c"
                     || OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)) <= 0)
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        ...
        if (cert != 
# 444 "../crypto/x509/t_x509.c" 3 4
                   ((void *)0)
# 444 "../crypto/x509/t_x509.c"
                       ) {
            if (!ossl_x509_print_ex_brief(bio, cert, 0))
                return 0;
            if (!X509V3_extensions_print(bio, 
# 447 "../crypto/x509/t_x509.c" 3 4
                                             ((void *)0)
# 447 "../crypto/x509/t_x509.c"
                                                 ,
...
{
    if (store != 
# 458 "../crypto/x509/t_x509.c" 3 4
                ((void *)0)
# 458 "../crypto/x509/t_x509.c"
                    ) {
        struct stack_st_X509 *certs = X509_STORE_get1_all_certs(store);
...
{
    if (ok == 0 && ctx != 
# 472 "../crypto/x509/t_x509.c" 3 4
                         ((void *)0)
# 472 "../crypto/x509/t_x509.c"
                             ) {
        int cert_error = X509_STORE_CTX_get_error(ctx);
        BIO *bio = BIO_new(BIO_s_mem());

        if (bio == 
# 476 "../crypto/x509/t_x509.c" 3 4
                  ((void *)0)
# 476 "../crypto/x509/t_x509.c"
                      )
            return 0;
        BIO_printf(bio, "%s at depth = %d error = %d (%s)\n",
                   X509_STORE_CTX_get0_parent_ctx(ctx) != 
# 479 "../crypto/x509/t_x509.c" 3 4
                                                         ((void *)0)
                   
# 480 "../crypto/x509/t_x509.c"
                  ? "CRL path validation"
                   ...
                   cert_error, X509_verify_cert_error_string(cert_error));
        {
            ...
            case 62:
                ...
                while ((str = X509_VERIFY_PARAM_get0_host(vpm, idx++)) != 
# 493 "../crypto/x509/t_x509.c" 3 4
                                                                         ((void *)0)
# 493 "../crypto/x509/t_x509.c"
                                                                             )
            ...
            case 63:
                ...
                if (str != 
# 499 "../crypto/x509/t_x509.c" 3 4
                          ((void *)0)
# 499 "../crypto/x509/t_x509.c"
                              )
            ...
            case 64:
                ...
                if (str != 
# 504 "../crypto/x509/t_x509.c" 3 4
                          ((void *)0)
# 504 "../crypto/x509/t_x509.c"
                              )
                    BIO_printf(bio, "Expected IP address = %s\n", str);
                CRYPTO_free(str, "../crypto/x509/t_x509.c", 506);
                break;
            default:
                break;
            }
        ...
        (ERR_new(), ERR_set_debug("../crypto/x509/t_x509.c",528,__func__), ERR_set_error)((11),(139),
# 528 "../crypto/x509/t_x509.c" 3 4
       ((void *)0)
# 528 "../crypto/x509/t_x509.c"
       );
