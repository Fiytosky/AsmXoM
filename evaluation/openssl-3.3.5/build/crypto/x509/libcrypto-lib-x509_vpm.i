# 0 "../crypto/x509/x509_vpm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_vpm.c"
# 10 "../crypto/x509/x509_vpm.c"
...
{
    return CRYPTO_strdup(s, "../crypto/x509/x509_vpm.c", 28);
}

static void str_free(char *s)
{
    CRYPTO_free(s, "../crypto/x509/x509_vpm.c", 33);
}
                                    ...
                                    const char *name, size_t namelen)
{
    ...
    if (namelen == 0 || name == 
# 45 "../crypto/x509/x509_vpm.c" 3 4
                               ((void *)0)
# 45 "../crypto/x509/x509_vpm.c"
                                   )
        namelen = name ? strlen(name) : 0;
    else if (name != 
# 47 "../crypto/x509/x509_vpm.c" 3 4
                    ((void *)0)
             
# 48 "../crypto/x509/x509_vpm.c"
            && memchr(name, '\0', namelen > 1 ? namelen - 1 : namelen) != 
# 48 "../crypto/x509/x509_vpm.c" 3 4
                                                                          ((void *)0)
# 48 "../crypto/x509/x509_vpm.c"
                                                                              )
        return 0;
    ...
    if (mode == 0) {
        OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(vpm->hosts),ossl_check_OPENSSL_STRING_freefunc_type(str_free));
        vpm->hosts = 
# 55 "../crypto/x509/x509_vpm.c" 3 4
                    ((void *)0)
# 55 "../crypto/x509/x509_vpm.c"
                        ;
    }
    if (name == 
# 57 "../crypto/x509/x509_vpm.c" 3 4
               ((void *)0) 
# 57 "../crypto/x509/x509_vpm.c"
                    || namelen == 0)
        return 1;

    copy = CRYPTO_strndup(name, namelen, "../crypto/x509/x509_vpm.c", 60);
    if (copy == 
# 61 "../crypto/x509/x509_vpm.c" 3 4
               ((void *)0)
# 61 "../crypto/x509/x509_vpm.c"
                   )
        return 0;

    if (vpm->hosts == 
# 64 "../crypto/x509/x509_vpm.c" 3 4
                     ((void *)0) 
# 64 "../crypto/x509/x509_vpm.c"
                          &&
        (vpm->hosts = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null())) == 
# 65 "../crypto/x509/x509_vpm.c" 3 4
                                                      ((void *)0)
# 65 "../crypto/x509/x509_vpm.c"
                                                          ) {
        CRYPTO_free(copy, "../crypto/x509/x509_vpm.c", 66);
        return 0;
    }

    if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(vpm->hosts), ossl_check_OPENSSL_STRING_type(copy))) {
        CRYPTO_free(copy, "../crypto/x509/x509_vpm.c", 71);
        if (OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(vpm->hosts)) == 0) {
            OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(vpm->hosts));
            vpm->hosts = 
# 74 "../crypto/x509/x509_vpm.c" 3 4
                        ((void *)0)
# 74 "../crypto/x509/x509_vpm.c"
                            ;
        }
        return 0;
    }
...
X509_VERIFY_PARAM *X509_VERIFY_PARAM_new(void)
{
    ...
    param = CRYPTO_zalloc(sizeof(*param), "../crypto/x509/x509_vpm.c", 86);
    if (param == 
# 87 "../crypto/x509/x509_vpm.c" 3 4
                ((void *)0)
# 87 "../crypto/x509/x509_vpm.c"
                    )
        return 
# 88 "../crypto/x509/x509_vpm.c" 3 4
              ((void *)0)
# 88 "../crypto/x509/x509_vpm.c"
                  ;
    param->trust = 0;
...
{
    if (param == 
# 98 "../crypto/x509/x509_vpm.c" 3 4
                ((void *)0)
# 98 "../crypto/x509/x509_vpm.c"
                    )
        return;
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(param->policies),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(param->hosts),ossl_check_OPENSSL_STRING_freefunc_type(str_free));
    CRYPTO_free(param->peername, "../crypto/x509/x509_vpm.c", 102);
    CRYPTO_free(param->email, "../crypto/x509/x509_vpm.c", 103);
    CRYPTO_free(param->ip, "../crypto/x509/x509_vpm.c", 104);
    CRYPTO_free(param, "../crypto/x509/x509_vpm.c", 105);
}
# 151 "../crypto/x509/x509_vpm.c"
                              ...
                              const X509_VERIFY_PARAM *src)
{
    ...
    if (src == 
# 157 "../crypto/x509/x509_vpm.c" 3 4
              ((void *)0)
# 157 "../crypto/x509/x509_vpm.c"
                  )
        return 1;
    ...
    to_default = (inh_flags & 0x1) != 0;
    to_overwrite = (inh_flags & 0x2) != 0;
    ...
    if ((to_overwrite || (src->auth_level != -1 && (to_default || dest->auth_level == -1)))) dest->auth_level = src->auth_level;;



    if (to_overwrite || (dest->flags & 0x2) == 0) {
...
# 188 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0) 
# 188 "../crypto/x509/x509_vpm.c"
...
# 188 "../crypto/x509/x509_vpm.c"
    ...
    if ((to_overwrite || (src->hostflags != 0 && (to_default || dest->hostflags == 0)))) dest->hostflags = src->hostflags;;

    if ((to_overwrite || (src->hosts != 
# 195 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0) 
# 195 "../crypto/x509/x509_vpm.c"
       && (to_default || dest->hosts == 
# 195 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 195 "../crypto/x509/x509_vpm.c"
       )))) {
        OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(dest->hosts),ossl_check_OPENSSL_STRING_freefunc_type(str_free));
        dest->hosts = 
# 197 "../crypto/x509/x509_vpm.c" 3 4
                     ((void *)0)
# 197 "../crypto/x509/x509_vpm.c"
                         ;
        if (src->hosts != 
# 198 "../crypto/x509/x509_vpm.c" 3 4
                         ((void *)0)
# 198 "../crypto/x509/x509_vpm.c"
                             ) {
            dest->hosts =
                ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_deep_copy(ossl_check_const_OPENSSL_STRING_sk_type(src->hosts), ossl_check_OPENSSL_STRING_copyfunc_type(str_copy), ossl_check_OPENSSL_STRING_freefunc_type(str_free)));
            if (dest->hosts == 
# 201 "../crypto/x509/x509_vpm.c" 3 4
                              ((void *)0)
# 201 "../crypto/x509/x509_vpm.c"
                                  )
                return 0;
        }
    }

    if ((to_overwrite || (src->email != 
# 206 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0) 
# 206 "../crypto/x509/x509_vpm.c"
       && (to_default || dest->email == 
# 206 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 206 "../crypto/x509/x509_vpm.c"
       )))) {
    ...
    if ((to_overwrite || (src->ip != 
# 211 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0) 
# 211 "../crypto/x509/x509_vpm.c"
       && (to_default || dest->ip == 
# 211 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 211 "../crypto/x509/x509_vpm.c"
                           ...
                           const X509_VERIFY_PARAM *from)
{
    ...
    if (to == 
# 225 "../crypto/x509/x509_vpm.c" 3 4
             ((void *)0)
# 225 "../crypto/x509/x509_vpm.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vpm.c",226,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 226 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 226 "../crypto/x509/x509_vpm.c"
       );
        return 0;
    }
                               ...
                               const char *src, size_t srclen)
{
    ...
    if (src != 
# 241 "../crypto/x509/x509_vpm.c" 3 4
              ((void *)0)
# 241 "../crypto/x509/x509_vpm.c"
                  ) {
        if (srclen == 0)
            srclen = strlen(src);

        tmp = CRYPTO_malloc(srclen + 1, "../crypto/x509/x509_vpm.c", 245);
        if (tmp == 
# 246 "../crypto/x509/x509_vpm.c" 3 4
                  ((void *)0)
# 246 "../crypto/x509/x509_vpm.c"
                      )
            return 0;
        ...
        tmp = 
# 251 "../crypto/x509/x509_vpm.c" 3 4
             ((void *)0)
# 251 "../crypto/x509/x509_vpm.c"
                 ;
        srclen = 0;
    }
    CRYPTO_free(*pdest, "../crypto/x509/x509_vpm.c", 254);
    *pdest = tmp;
    if (pdestlen != 
# 256 "../crypto/x509/x509_vpm.c" 3 4
                   ((void *)0)
# 256 "../crypto/x509/x509_vpm.c"
                       )
        *pdestlen = srclen;
    return 1;
}
...
int X509_VERIFY_PARAM_set1_name(X509_VERIFY_PARAM *param, const char *name)
{
    CRYPTO_free(param->name, "../crypto/x509/x509_vpm.c", 263);
    param->name = CRYPTO_strdup(name, "../crypto/x509/x509_vpm.c", 264);
    return param->name != 
# 265 "../crypto/x509/x509_vpm.c" 3 4
                         ((void *)0)
# 265 "../crypto/x509/x509_vpm.c"
                             ;
}
...
{
    param->flags |= flags;
    if ((flags & (0x80 | 0x100 | 0x200 | 0x400)) != 0)
        param->flags |= 0x80;
    return 1;
}
...
{
    if (param->policies == 
# 333 "../crypto/x509/x509_vpm.c" 3 4
                          ((void *)0)
# 333 "../crypto/x509/x509_vpm.c"
                              ) {
        param->policies = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null());
        if (param->policies == 
# 335 "../crypto/x509/x509_vpm.c" 3 4
                              ((void *)0)
# 335 "../crypto/x509/x509_vpm.c"
                                  )
            return 0;
    }

    if (OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(param->policies), ossl_check_ASN1_OBJECT_type(policy)) <= 0)
        return 0;
    return 1;
}
                                    ...
                                    struct stack_st_ASN1_OBJECT *policies)
{
    ...
    if (param == 
# 350 "../crypto/x509/x509_vpm.c" 3 4
                ((void *)0)
# 350 "../crypto/x509/x509_vpm.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vpm.c",351,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 351 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 351 "../crypto/x509/x509_vpm.c"
       );
        return 0;
    }
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(param->policies),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    ...
    if (policies == 
# 356 "../crypto/x509/x509_vpm.c" 3 4
                   ((void *)0)
# 356 "../crypto/x509/x509_vpm.c"
                       ) {
        param->policies = 
# 357 "../crypto/x509/x509_vpm.c" 3 4
                         ((void *)0)
# 357 "../crypto/x509/x509_vpm.c"
                             ;
        return 1;
    }
    ...
    param->policies = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null());
    if (param->policies == 
# 362 "../crypto/x509/x509_vpm.c" 3 4
                          ((void *)0)
# 362 "../crypto/x509/x509_vpm.c"
                              )
        return 0;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(policies)); i++) {
        oid = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(policies), (i)));
        doid = OBJ_dup(oid);
        if (doid == 
# 368 "../crypto/x509/x509_vpm.c" 3 4
                   ((void *)0)
# 368 "../crypto/x509/x509_vpm.c"
                       )
            return 0;
        if (!OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(param->policies), ossl_check_ASN1_OBJECT_type(doid))) {
...
char *X509_VERIFY_PARAM_get0_host(X509_VERIFY_PARAM *param, int idx)
{
    return ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(param->hosts), (idx)));
}

int X509_VERIFY_PARAM_set1_host(X509_VERIFY_PARAM *param,
                                const char *name, size_t namelen)
{
    return int_x509_param_set_hosts(param, 0, name, namelen);
}

int X509_VERIFY_PARAM_add1_host(X509_VERIFY_PARAM *param,
                                const char *name, size_t namelen)
{
    return int_x509_param_set_hosts(param, 1, name, namelen);
}
...
{
    char *peername = (from != 
# 420 "../crypto/x509/x509_vpm.c" 3 4
                             ((void *)0)
# 420 "../crypto/x509/x509_vpm.c"
                                 ) ? from->peername : 
# 420 "../crypto/x509/x509_vpm.c" 3 4
                                                      ((void *)0)
# 420 "../crypto/x509/x509_vpm.c"
    ...
    if (to->peername != peername) {
        CRYPTO_free(to->peername, "../crypto/x509/x509_vpm.c", 423);
        to->peername = peername;
    }
    if (from != 
# 426 "../crypto/x509/x509_vpm.c" 3 4
               ((void *)0)
# 426 "../crypto/x509/x509_vpm.c"
                   )
        from->peername = 
# 427 "../crypto/x509/x509_vpm.c" 3 4
                        ((void *)0)
# 427 "../crypto/x509/x509_vpm.c"
                            ;
}
...
{
    if (param == 
# 445 "../crypto/x509/x509_vpm.c" 3 4
                ((void *)0) 
# 445 "../crypto/x509/x509_vpm.c"
                     || param->ip == 
# 445 "../crypto/x509/x509_vpm.c" 3 4
                                     ((void *)0)
# 445 "../crypto/x509/x509_vpm.c"
                                         ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vpm.c",446,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 446 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 446 "../crypto/x509/x509_vpm.c"
       );
        return 
# 447 "../crypto/x509/x509_vpm.c" 3 4
              ((void *)0)
# 447 "../crypto/x509/x509_vpm.c"
                  ;
    }
    if (plen != 
# 449 "../crypto/x509/x509_vpm.c" 3 4
               ((void *)0)
# 449 "../crypto/x509/x509_vpm.c"
                   )
        *plen = param->iplen;
    return param->ip;
}
...
char *X509_VERIFY_PARAM_get1_ip_asc(X509_VERIFY_PARAM *param)
{
    ...
    return ip == 
# 459 "../crypto/x509/x509_vpm.c" 3 4
                ((void *)0) 
# 459 "../crypto/x509/x509_vpm.c"
                     ? 
# 459 "../crypto/x509/x509_vpm.c" 3 4
                       ((void *)0) 
# 459 "../crypto/x509/x509_vpm.c"
                            : ossl_ipaddr_to_asc(ip, iplen);
}
                              ...
                              const unsigned char *ip, size_t iplen)
{
    if (iplen != 0 && iplen != 4 && iplen != 16) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vpm.c",466,__func__), ERR_set_error)((11),((262|(0x2 << 18L))),
# 466 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 466 "../crypto/x509/x509_vpm.c"
       );
        return 0;
    }
...
# 516 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 516 "../crypto/x509/x509_vpm.c"
        ,
     
# 517 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 517 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 517 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 517 "../crypto/x509/x509_vpm.c"
...
# 528 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 528 "../crypto/x509/x509_vpm.c"
        ,
     
# 529 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 529 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 529 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 529 "../crypto/x509/x509_vpm.c"
...
# 540 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 540 "../crypto/x509/x509_vpm.c"
        ,
     
# 541 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 541 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 541 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 541 "../crypto/x509/x509_vpm.c"
...
# 552 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 552 "../crypto/x509/x509_vpm.c"
        ,
     
# 553 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 553 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 553 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 553 "../crypto/x509/x509_vpm.c"
...
# 564 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 564 "../crypto/x509/x509_vpm.c"
        ,
     
# 565 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 565 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 565 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 565 "../crypto/x509/x509_vpm.c"
...
# 576 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 576 "../crypto/x509/x509_vpm.c"
        ,
     
# 577 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 577 "../crypto/x509/x509_vpm.c"
    , 0U, 
# 577 "../crypto/x509/x509_vpm.c" 3 4
    ((void *)0)
# 577 "../crypto/x509/x509_vpm.c"
...
# 581 "../crypto/x509/x509_vpm.c" 3 4
                                                 ((void *)0)
# 581 "../crypto/x509/x509_vpm.c"
                                                     ;
...
int X509_VERIFY_PARAM_add0_table(X509_VERIFY_PARAM *param)
{
    ...
    if (param_table == 
# 602 "../crypto/x509/x509_vpm.c" 3 4
                      ((void *)0)
# 602 "../crypto/x509/x509_vpm.c"
                          ) {
        param_table = ((struct stack_st_X509_VERIFY_PARAM *)OPENSSL_sk_new(ossl_check_X509_VERIFY_PARAM_compfunc_type(param_cmp)));
        if (param_table == 
# 604 "../crypto/x509/x509_vpm.c" 3 4
                          ((void *)0)
# 604 "../crypto/x509/x509_vpm.c"
                              )
            return 0;
    } else {
        idx = OPENSSL_sk_find(ossl_check_X509_VERIFY_PARAM_sk_type(param_table), ossl_check_X509_VERIFY_PARAM_type(param));
        if (idx >= 0) {
            ptmp = ((X509_VERIFY_PARAM *)OPENSSL_sk_delete(ossl_check_X509_VERIFY_PARAM_sk_type(param_table), (idx)));
            X509_VERIFY_PARAM_free(ptmp);
        }
    }

    if (OPENSSL_sk_push(ossl_check_X509_VERIFY_PARAM_sk_type(param_table), ossl_check_X509_VERIFY_PARAM_type(param)) <= 0)
        return 0;
    return 1;
}
...
int X509_VERIFY_PARAM_get_count(void)
{
    int num = (sizeof(default_table)/sizeof((default_table)[0]));

    if (param_table != 
# 623 "../crypto/x509/x509_vpm.c" 3 4
                      ((void *)0)
# 623 "../crypto/x509/x509_vpm.c"
                          )
        num += OPENSSL_sk_num(ossl_check_const_X509_VERIFY_PARAM_sk_type(param_table));
    return num;
}
...
const X509_VERIFY_PARAM *X509_VERIFY_PARAM_get0(int id)
{
    ...
    if (id < 0) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_vpm.c",633,__func__), ERR_set_error)((11),((262|(0x2 << 18L))),
# 633 "../crypto/x509/x509_vpm.c" 3 4
       ((void *)0)
# 633 "../crypto/x509/x509_vpm.c"
       );
        return 
# 634 "../crypto/x509/x509_vpm.c" 3 4
              ((void *)0)
# 634 "../crypto/x509/x509_vpm.c"
                  ;
    }

    if (id < num)
        return default_table + id;
    return ((X509_VERIFY_PARAM *)OPENSSL_sk_value(ossl_check_const_X509_VERIFY_PARAM_sk_type(param_table), (id - num)));
}
...
const X509_VERIFY_PARAM *X509_VERIFY_PARAM_lookup(const char *name)
{
    ...
    pm.name = (char *)name;
    if (param_table != 
# 648 "../crypto/x509/x509_vpm.c" 3 4
                      ((void *)0)
# 648 "../crypto/x509/x509_vpm.c"
                          ) {

        OPENSSL_sk_sort(ossl_check_X509_VERIFY_PARAM_sk_type(param_table));
        idx = OPENSSL_sk_find(ossl_check_X509_VERIFY_PARAM_sk_type(param_table), ossl_check_X509_VERIFY_PARAM_type(&pm));
        if (idx >= 0)
            return ((X509_VERIFY_PARAM *)OPENSSL_sk_value(ossl_check_const_X509_VERIFY_PARAM_sk_type(param_table), (idx)));
    }
    return OBJ_bsearch_table(&pm, default_table, (sizeof(default_table)/sizeof((default_table)[0])));
}

void X509_VERIFY_PARAM_table_cleanup(void)
{
    OPENSSL_sk_pop_free(ossl_check_X509_VERIFY_PARAM_sk_type(param_table),ossl_check_X509_VERIFY_PARAM_freefunc_type(X509_VERIFY_PARAM_free));
    param_table = 
# 661 "../crypto/x509/x509_vpm.c" 3 4
                 ((void *)0)
# 661 "../crypto/x509/x509_vpm.c"
                     ;
}
