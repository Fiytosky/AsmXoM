# 0 "../crypto/x509/by_store.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/by_store.c"
# 10 "../crypto/x509/by_store.c"
...
struct stack_st_CACHED_STORE; typedef int (*sk_CACHED_STORE_compfunc)(const CACHED_STORE * const *a, const CACHED_STORE *const *b); typedef void (*sk_CACHED_STORE_freefunc)(CACHED_STORE *a); typedef CACHED_STORE * (*sk_CACHED_STORE_copyfunc)(const CACHED_STORE *a); static __attribute__((unused)) inline int sk_CACHED_STORE_num(const struct stack_st_CACHED_STORE *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_value(const struct stack_st_CACHED_STORE *sk, int idx) { return (CACHED_STORE *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_CACHED_STORE *sk_CACHED_STORE_new(sk_CACHED_STORE_compfunc compare) { return (struct stack_st_CACHED_STORE *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_CACHED_STORE *sk_CACHED_STORE_new_null(void) { return (struct stack_st_CACHED_STORE *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_CACHED_STORE *sk_CACHED_STORE_new_reserve(sk_CACHED_STORE_compfunc compare, int n) { return (struct stack_st_CACHED_STORE *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_CACHED_STORE_reserve(struct stack_st_CACHED_STORE *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_CACHED_STORE_free(struct stack_st_CACHED_STORE *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_CACHED_STORE_zero(struct stack_st_CACHED_STORE *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_delete(struct stack_st_CACHED_STORE *sk, int i) { return (CACHED_STORE *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_delete_ptr(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr) { return (CACHED_STORE *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_CACHED_STORE_push(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_CACHED_STORE_unshift(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_pop(struct stack_st_CACHED_STORE *sk) { return (CACHED_STORE *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_shift(struct stack_st_CACHED_STORE *sk) { return (CACHED_STORE *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_CACHED_STORE_pop_free(struct stack_st_CACHED_STORE *sk, sk_CACHED_STORE_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_CACHED_STORE_insert(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline CACHED_STORE *sk_CACHED_STORE_set(struct stack_st_CACHED_STORE *sk, int idx, CACHED_STORE *ptr) { return (CACHED_STORE *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_CACHED_STORE_find(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_CACHED_STORE_find_ex(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_CACHED_STORE_find_all(struct stack_st_CACHED_STORE *sk, CACHED_STORE *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_CACHED_STORE_sort(struct stack_st_CACHED_STORE *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_CACHED_STORE_is_sorted(const struct stack_st_CACHED_STORE *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_CACHED_STORE * sk_CACHED_STORE_dup(const struct stack_st_CACHED_STORE *sk) { return (struct stack_st_CACHED_STORE *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_CACHED_STORE *sk_CACHED_STORE_deep_copy(const struct stack_st_CACHED_STORE *sk, sk_CACHED_STORE_copyfunc copyfunc, sk_CACHED_STORE_freefunc freefunc) { return (struct stack_st_CACHED_STORE *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_CACHED_STORE_compfunc sk_CACHED_STORE_set_cmp_func(struct stack_st_CACHED_STORE *sk, sk_CACHED_STORE_compfunc compare) { return (sk_CACHED_STORE_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
# 33 "../crypto/x509/by_store.c" 3 4
                                 ((void *)0)
# 33 "../crypto/x509/by_store.c"
                                     , 
# 33 "../crypto/x509/by_store.c" 3 4
                                       ((void *)0)
# 33 "../crypto/x509/by_store.c"
...
# 33 "../crypto/x509/by_store.c"
        ...
        return 0;
# 54 "../crypto/x509/by_store.c"
    if (criterion != 
# 54 "../crypto/x509/by_store.c" 3 4
                    ((void *)0)
# 54 "../crypto/x509/by_store.c"
                        )
    ...
    for (;;) {
        ...
        if (info == 
# 62 "../crypto/x509/by_store.c" 3 4
                   ((void *)0)
# 62 "../crypto/x509/by_store.c"
                       )
            break;
...
{
    if (store != 
# 111 "../crypto/x509/by_store.c" 3 4
                ((void *)0)
# 111 "../crypto/x509/by_store.c"
                    ) {
        CRYPTO_free(store->uri, "../crypto/x509/by_store.c", 112);
        CRYPTO_free(store->propq, "../crypto/x509/by_store.c", 113);
        CRYPTO_free(store, "../crypto/x509/by_store.c", 114);
    }
}

static void by_store_free(X509_LOOKUP *ctx)
{
    struct stack_st_CACHED_STORE *stores = X509_LOOKUP_get_method_data(ctx);
                            ...
                            const char *propq)
{
    ...
    int use_default = argp == 
# 132 "../crypto/x509/by_store.c" 3 4
                             ((void *)0)
# 132 "../crypto/x509/by_store.c"
                                 ;
    ...
    case 3:
        ...
        if (argp == 
# 137 "../crypto/x509/by_store.c" 3 4
                   ((void *)0)
# 137 "../crypto/x509/by_store.c"
                       )
            argp = ossl_safe_getenv(X509_get_default_cert_dir_env());

        if (argp == 
# 140 "../crypto/x509/by_store.c" 3 4
                   ((void *)0)
# 140 "../crypto/x509/by_store.c"
                       )
            argp = X509_get_default_cert_dir();

        {
            struct stack_st_CACHED_STORE *stores = X509_LOOKUP_get_method_data(ctx);
            CACHED_STORE *store = CRYPTO_zalloc(sizeof(*store), "../crypto/x509/by_store.c", 145);
            OSSL_STORE_CTX *sctx;

            if (store == 
# 148 "../crypto/x509/by_store.c" 3 4
                        ((void *)0)
# 148 "../crypto/x509/by_store.c"
                            ) {
                return 0;
            }

            store->uri = CRYPTO_strdup(argp, "../crypto/x509/by_store.c", 152);
            store->libctx = libctx;
            if (propq != 
# 154 "../crypto/x509/by_store.c" 3 4
                        ((void *)0)
# 154 "../crypto/x509/by_store.c"
                            )
                store->propq = CRYPTO_strdup(propq, "../crypto/x509/by_store.c", 155);




            sctx = OSSL_STORE_open_ex(argp, libctx, propq, 
# 160 "../crypto/x509/by_store.c" 3 4
                                                          ((void *)0)
# 160 "../crypto/x509/by_store.c"
                                                              , 
# 160 "../crypto/x509/by_store.c" 3 4
                                                                ((void *)0)
# 160 "../crypto/x509/by_store.c"
...
# 161 "../crypto/x509/by_store.c" 3 4
                                     ((void *)0)
# 161 "../crypto/x509/by_store.c"
                                         , 
# 161 "../crypto/x509/by_store.c" 3 4
                                           ((void *)0)
# 161 "../crypto/x509/by_store.c"
...
# 161 "../crypto/x509/by_store.c"
            ...
            if (sctx == 
# 162 "../crypto/x509/by_store.c" 3 4
                       ((void *)0)
                
# 163 "../crypto/x509/by_store.c"
               || (propq != 
# 163 "../crypto/x509/by_store.c" 3 4
                            ((void *)0) 
# 163 "../crypto/x509/by_store.c"
                                 && store->propq == 
# 163 "../crypto/x509/by_store.c" 3 4
...
# 163 "../crypto/x509/by_store.c"
                ...
                || store->uri == 
# 164 "../crypto/x509/by_store.c" 3 4
                                ((void *)0)
# 164 "../crypto/x509/by_store.c"
                                    ) {
            ...
            if (stores == 
# 171 "../crypto/x509/by_store.c" 3 4
                         ((void *)0)
# 171 "../crypto/x509/by_store.c"
                             ) {
                stores = sk_CACHED_STORE_new_null();
                if (stores != 
# 173 "../crypto/x509/by_store.c" 3 4
                             ((void *)0)
# 173 "../crypto/x509/by_store.c"
                                 )
                    X509_LOOKUP_set_method_data(ctx, stores);
            }
            if (stores == 
# 176 "../crypto/x509/by_store.c" 3 4
                         ((void *)0) 
# 176 "../crypto/x509/by_store.c"
                              || sk_CACHED_STORE_push(stores, store) <= 0) {
                free_store(store);
                return 0;
            }
            return 1;
    ...
    case 4: {
        ...
        return cache_objects(ctx, &store, 
# 189 "../crypto/x509/by_store.c" 3 4
                                         ((void *)0)
# 189 "../crypto/x509/by_store.c"
                                             , 0);
    }
    default:
...
# 202 "../crypto/x509/by_store.c" 3 4
                                                       ((void *)0)
# 202 "../crypto/x509/by_store.c"
                                                           , 
# 202 "../crypto/x509/by_store.c" 3 4
                                                             ((void *)0)
# 202 "../crypto/x509/by_store.c"
                            ...
                            const X509_NAME *name, X509_OBJECT *ret)
{
    OSSL_STORE_SEARCH *criterion =
        OSSL_STORE_SEARCH_by_name((X509_NAME *)name);
    int ok = by_store(ctx, type, criterion, ret);
    struct stack_st_X509_OBJECT *store_objects =
        X509_STORE_get0_objects(X509_LOOKUP_get_store(ctx));
    X509_OBJECT *tmp = 
# 230 "../crypto/x509/by_store.c" 3 4
                      ((void *)0)
# 230 "../crypto/x509/by_store.c"
                          ;
    ...
    ok = 0;
    if (tmp != 
# 244 "../crypto/x509/by_store.c" 3 4
              ((void *)0)
# 244 "../crypto/x509/by_store.c"
                  ) {
# 263 "../crypto/x509/by_store.c"
        switch (type) {
        case X509_LU_X509:
...
# 289 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 289 "../crypto/x509/by_store.c"
       ,
    by_store_free,
    
# 291 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 291 "../crypto/x509/by_store.c"
       ,
    
# 292 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 292 "../crypto/x509/by_store.c"
       ,
    by_store_ctrl,
    by_store_subject,
    
# 295 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 295 "../crypto/x509/by_store.c"
       ,
    
# 296 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 296 "../crypto/x509/by_store.c"
       ,
    
# 297 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 297 "../crypto/x509/by_store.c"
       ,
    
# 298 "../crypto/x509/by_store.c" 3 4
   ((void *)0)
# 298 "../crypto/x509/by_store.c"
       ,
    by_store_ctrl_ex
};
