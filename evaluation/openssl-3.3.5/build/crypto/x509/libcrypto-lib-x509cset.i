# 0 "../crypto/x509/x509cset.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509cset.c"
# 10 "../crypto/x509/x509cset.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 18 "../crypto/x509/x509cset.c" 2

int X509_CRL_set_version(X509_CRL *x, long version)
{
    if (x == 
# 21 "../crypto/x509/x509cset.c" 3 4
            ((void *)0)
# 21 "../crypto/x509/x509cset.c"
                )
        return 0;
    if (x->crl.version == 
# 23 "../crypto/x509/x509cset.c" 3 4
                         ((void *)0)
# 23 "../crypto/x509/x509cset.c"
                             ) {
        if ((x->crl.version = ASN1_INTEGER_new()) == 
# 24 "../crypto/x509/x509cset.c" 3 4
                                                    ((void *)0)
# 24 "../crypto/x509/x509cset.c"
                                                        )
            return 0;
    }
...
{
    if (x == 
# 35 "../crypto/x509/x509cset.c" 3 4
            ((void *)0)
# 35 "../crypto/x509/x509cset.c"
                )
        return 0;
...
{
    if (x == 
# 45 "../crypto/x509/x509cset.c" 3 4
            ((void *)0) 
# 45 "../crypto/x509/x509cset.c"
                 || tm == 
# 45 "../crypto/x509/x509cset.c" 3 4
                          ((void *)0)
# 45 "../crypto/x509/x509cset.c"
...
{
    if (x == 
# 52 "../crypto/x509/x509cset.c" 3 4
            ((void *)0)
# 52 "../crypto/x509/x509cset.c"
                )
        return 0;
...
int X509_CRL_sort(X509_CRL *c)
{
    ...
    OPENSSL_sk_sort(ossl_check_X509_REVOKED_sk_type(c->crl.revoked));
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_REVOKED_sk_type(c->crl.revoked)); i++) {
        r = ((X509_REVOKED *)OPENSSL_sk_value(ossl_check_const_X509_REVOKED_sk_type(c->crl.revoked), (i)));
        r->sequence = i;
    }
...
{
    if (psig != 
# 131 "../crypto/x509/x509cset.c" 3 4
               ((void *)0)
# 131 "../crypto/x509/x509cset.c"
                   )
        *psig = &crl->signature;
    if (palg != 
# 133 "../crypto/x509/x509cset.c" 3 4
               ((void *)0)
# 133 "../crypto/x509/x509cset.c"
                   )
        *palg = &crl->sig_alg;
}
...
{
    if (x == 
# 149 "../crypto/x509/x509cset.c" 3 4
            ((void *)0) 
# 149 "../crypto/x509/x509cset.c"
                 || tm == 
# 149 "../crypto/x509/x509cset.c" 3 4
                          ((void *)0)
# 149 "../crypto/x509/x509cset.c"
        ...
        return 0;
    return ossl_x509_set1_time(
# 151 "../crypto/x509/x509cset.c" 3 4
                              ((void *)0)
# 151 "../crypto/x509/x509cset.c"
                                  , &x->revocationDate, tm);
}
...
int X509_REVOKED_set_serialNumber(X509_REVOKED *x, ASN1_INTEGER *serial)
{
    ...
    if (x == 
# 163 "../crypto/x509/x509cset.c" 3 4
            ((void *)0)
# 163 "../crypto/x509/x509cset.c"
                )
        return 0;
    in = &x->serialNumber;
    if (in != serial)
...
const struct stack_st_X509_EXTENSION *X509_REVOKED_get0_extensions(const
                                                             X509_REVOKED *r)
{
    return r->extensions;
}
