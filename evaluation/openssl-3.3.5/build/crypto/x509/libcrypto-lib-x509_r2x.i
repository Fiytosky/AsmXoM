# 0 "../crypto/x509/x509_r2x.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x509_r2x.c"
# 10 "../crypto/x509/x509_r2x.c"
...
{
    X509 *ret = 
# 22 "../crypto/x509/x509_r2x.c" 3 4
               ((void *)0)
# 22 "../crypto/x509/x509_r2x.c"
                   ;
    X509_CINF *xi = 
# 23 "../crypto/x509/x509_r2x.c" 3 4
                   ((void *)0)
# 23 "../crypto/x509/x509_r2x.c"
                       ;
    const X509_NAME *xn;
    EVP_PKEY *pubkey = 
# 25 "../crypto/x509/x509_r2x.c" 3 4
                      ((void *)0)
# 25 "../crypto/x509/x509_r2x.c"
                          ;

    if ((ret = X509_new()) == 
# 27 "../crypto/x509/x509_r2x.c" 3 4
                             ((void *)0)
# 27 "../crypto/x509/x509_r2x.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x509_r2x.c",28,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 28 "../crypto/x509/x509_r2x.c" 3 4
       ((void *)0)
# 28 "../crypto/x509/x509_r2x.c"
       );
        return 
# 29 "../crypto/x509/x509_r2x.c" 3 4
              ((void *)0)
# 29 "../crypto/x509/x509_r2x.c"
                  ;
    }
    ...
    if (OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(r->req_info.attributes)) != 0) {
        if ((xi->version = ASN1_INTEGER_new()) == 
# 36 "../crypto/x509/x509_r2x.c" 3 4
                                                 ((void *)0)
# 36 "../crypto/x509/x509_r2x.c"
                                                     )
            goto err;
...
# 50 "../crypto/x509/x509_r2x.c" 3 4
                                                     ((void *)0)
# 50 "../crypto/x509/x509_r2x.c"
                                                         )
        goto err;
    if (X509_gmtime_adj(xi->validity.notAfter, (long)60 * 60 * 24 * days) ==
        
# 53 "../crypto/x509/x509_r2x.c" 3 4
       ((void *)0)
# 53 "../crypto/x509/x509_r2x.c"
           )
        goto err;

    pubkey = X509_REQ_get0_pubkey(r);
    if (pubkey == 
# 57 "../crypto/x509/x509_r2x.c" 3 4
                 ((void *)0) 
# 57 "../crypto/x509/x509_r2x.c"
 ...
 err:
    X509_free(ret);
    return 
# 66 "../crypto/x509/x509_r2x.c" 3 4
          ((void *)0)
# 66 "../crypto/x509/x509_r2x.c"
              ;
}
