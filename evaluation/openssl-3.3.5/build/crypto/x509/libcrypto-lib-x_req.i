# 0 "../crypto/x509/x_req.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_req.c"
# 10 "../crypto/x509/x_req.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 15 "../crypto/x509/x_req.c" 2
# 35 "../crypto/x509/x_req.c"
                   ...
                   void *exarg)
{
    ...
    if (operation == 1) {
        rinf->attributes = ((struct stack_st_X509_ATTRIBUTE *)OPENSSL_sk_new_null());
        if (!rinf->attributes)
            return 0;
    }
    return 1;
...
# 58 "../crypto/x509/x_req.c" 3 4
                                ((void *)0)
# 58 "../crypto/x509/x_req.c"
                                    ;
        break;

    case 3:
        ASN1_OCTET_STRING_free(ret->distinguishing_id);
        CRYPTO_free(ret->propq, "../crypto/x509/x_req.c", 63);
        break;
    case 15:
        {
            X509_REQ *old = exarg;
            ...
            if (!ossl_x509_req_set0_libctx(ret, old->libctx, old->propq))
                return 0;
            if (old->req_info.pubkey != 
# 71 "../crypto/x509/x_req.c" 3 4
                                       ((void *)0)
# 71 "../crypto/x509/x_req.c"
                                           ) {
                EVP_PKEY *pkey = X509_PUBKEY_get0(old->req_info.pubkey);

                if (pkey != 
# 74 "../crypto/x509/x_req.c" 3 4
                           ((void *)0)
# 74 "../crypto/x509/x_req.c"
                               ) {
                    pkey = EVP_PKEY_dup(pkey);
                    if (pkey == 
# 76 "../crypto/x509/x_req.c" 3 4
                               ((void *)0)
# 76 "../crypto/x509/x_req.c"
                                   ) {
                        (ERR_new(), ERR_set_debug("../crypto/x509/x_req.c",77,__func__), ERR_set_error)((11),((6 | (0x2 << 18L))),
# 77 "../crypto/x509/x_req.c" 3 4
                       ((void *)0)
# 77 "../crypto/x509/x_req.c"
                       );
                        return 0;
                    }
                    if (!X509_PUBKEY_set(&ret->req_info.pubkey, pkey)) {
                        EVP_PKEY_free(pkey);
                        (ERR_new(), ERR_set_debug("../crypto/x509/x_req.c",82,__func__), ERR_set_error)((11),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 82 "../crypto/x509/x_req.c" 3 4
                       ((void *)0)
# 82 "../crypto/x509/x_req.c"
                       );
                        return 0;
                    }
                    EVP_PKEY_free(pkey);
...
# 109 "../crypto/x509/x_req.c" 3 4
((void *)0)
# 109 "../crypto/x509/x_req.c"
, 2, 0, 0, rinf_cb, 
# 109 "../crypto/x509/x_req.c" 3 4
__builtin_offsetof (
# 109 "../crypto/x509/x_req.c"
...
# 109 "../crypto/x509/x_req.c"
        ...
        { (0), (0), 
# 110 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 110 "../crypto/x509/x_req.c"
       X509_REQ_INFO
# 110 "../crypto/x509/x_req.c" 3 4
       , 
# 110 "../crypto/x509/x_req.c"
...
# 110 "../crypto/x509/x_req.c"
       , "version", (ASN1_INTEGER_it) },
        { (0), (0), 
# 111 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 111 "../crypto/x509/x_req.c"
       X509_REQ_INFO
# 111 "../crypto/x509/x_req.c" 3 4
       , 
# 111 "../crypto/x509/x_req.c"
...
# 111 "../crypto/x509/x_req.c"
       , "subject", (X509_NAME_it) },
        { (0), (0), 
# 112 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 112 "../crypto/x509/x_req.c"
       X509_REQ_INFO
# 112 "../crypto/x509/x_req.c" 3 4
       , 
# 112 "../crypto/x509/x_req.c"
...
# 112 "../crypto/x509/x_req.c"
       , "pubkey", (X509_PUBKEY_it) },



        { (((0x1 << 3)|(0x2<<6)) | ((0x1 << 1)|(0x1))), (0), 
# 116 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 116 "../crypto/x509/x_req.c"
       X509_REQ_INFO
# 116 "../crypto/x509/x_req.c" 3 4
       , 
# 116 "../crypto/x509/x_req.c"
...
} ; const ASN1_ITEM * X509_REQ_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_REQ_INFO_seq_tt, sizeof(X509_REQ_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_REQ_INFO_aux, sizeof(X509_REQ_INFO), "X509_REQ_INFO" }; return &local_it; }

X509_REQ_INFO *d2i_X509_REQ_INFO(X509_REQ_INFO **a, const unsigned char **in, long len) { return (X509_REQ_INFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_REQ_INFO_it())); } int i2d_X509_REQ_INFO(const X509_REQ_INFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_REQ_INFO_it())); } X509_REQ_INFO *X509_REQ_INFO_new(void) { return (X509_REQ_INFO *)ASN1_item_new((X509_REQ_INFO_it())); } void X509_REQ_INFO_free(X509_REQ_INFO *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_REQ_INFO_it())); }

static const ASN1_AUX X509_REQ_aux = {
# 121 "../crypto/x509/x_req.c" 3 4
((void *)0)
# 121 "../crypto/x509/x_req.c"
, 1, 
# 121 "../crypto/x509/x_req.c" 3 4
__builtin_offsetof (
# 121 "../crypto/x509/x_req.c"
...
# 121 "../crypto/x509/x_req.c"
        ...
        { ((0x1 << 12)), (0), 
# 122 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 122 "../crypto/x509/x_req.c"
       X509_REQ
# 122 "../crypto/x509/x_req.c" 3 4
       , 
# 122 "../crypto/x509/x_req.c"
...
# 122 "../crypto/x509/x_req.c"
       , "req_info", (X509_REQ_INFO_it) },
        { ((0x1 << 12)), (0), 
# 123 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 123 "../crypto/x509/x_req.c"
       X509_REQ
# 123 "../crypto/x509/x_req.c" 3 4
       , 
# 123 "../crypto/x509/x_req.c"
...
# 123 "../crypto/x509/x_req.c"
       , "sig_alg", (X509_ALGOR_it) },
        { (0), (0), 
# 124 "../crypto/x509/x_req.c" 3 4
       __builtin_offsetof (
# 124 "../crypto/x509/x_req.c"
       X509_REQ
# 124 "../crypto/x509/x_req.c" 3 4
       , 
# 124 "../crypto/x509/x_req.c"
...
} ; const ASN1_ITEM * X509_REQ_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_REQ_seq_tt, sizeof(X509_REQ_seq_tt) / sizeof(ASN1_TEMPLATE), &X509_REQ_aux, sizeof(X509_REQ), "X509_REQ" }; return &local_it; }

X509_REQ *d2i_X509_REQ(X509_REQ **a, const unsigned char **in, long len) { return (X509_REQ *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_REQ_it())); } int i2d_X509_REQ(const X509_REQ *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_REQ_it())); } X509_REQ *X509_REQ_new(void) { return (X509_REQ *)ASN1_item_new((X509_REQ_it())); } void X509_REQ_free(X509_REQ *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_REQ_it())); }

X509_REQ * X509_REQ_dup(const X509_REQ *x) { return ASN1_item_dup((X509_REQ_it()), x); }
...
{
    if (x != 
# 150 "../crypto/x509/x_req.c" 3 4
            ((void *)0)
# 150 "../crypto/x509/x_req.c"
                ) {
        x->libctx = libctx;
        CRYPTO_free(x->propq, "../crypto/x509/x_req.c", 152);
        x->propq = 
# 153 "../crypto/x509/x_req.c" 3 4
                  ((void *)0)
# 153 "../crypto/x509/x_req.c"
                      ;
        if (propq != 
# 154 "../crypto/x509/x_req.c" 3 4
                    ((void *)0)
# 154 "../crypto/x509/x_req.c"
                        ) {
            x->propq = CRYPTO_strdup(propq, "../crypto/x509/x_req.c", 155);
            if (x->propq == 
# 156 "../crypto/x509/x_req.c" 3 4
                           ((void *)0)
# 156 "../crypto/x509/x_req.c"
                               )
                return 0;
        }
    }
...
{
    X509_REQ *req = 
# 165 "../crypto/x509/x_req.c" 3 4
                   ((void *)0)
# 165 "../crypto/x509/x_req.c"
                       ;
    ...
    if (!ossl_x509_req_set0_libctx(req, libctx, propq)) {
        X509_REQ_free(req);
        req = 
# 170 "../crypto/x509/x_req.c" 3 4
             ((void *)0)
# 170 "../crypto/x509/x_req.c"
                 ;
    }
    return req;
}
