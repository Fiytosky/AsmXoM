# 0 "../crypto/x509/v3_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_prn.c"
# 12 "../crypto/x509/v3_prn.c"
                        ...
                        int ml)
{
    ...
    if (!val)
        return;
    if (!ml || !OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(val))) {
        BIO_printf(out, "%*s", indent, "");
        if (!OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(val)))
            BIO_puts(out, "<EMPTY>\n");
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(val)); i++) {
        if (ml) {
            if (i > 0)
                BIO_printf(out, "\n");
            BIO_printf(out, "%*s", indent, "");
            ...
            BIO_printf(out, ", ");
        nval = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(val), (i)));
        if (!nval->name)
...
{
    void *ext_str = 
# 73 "../crypto/x509/v3_prn.c" 3 4
                   ((void *)0)
# 73 "../crypto/x509/v3_prn.c"
                       ;
    char *value = 
# 74 "../crypto/x509/v3_prn.c" 3 4
                 ((void *)0)
# 74 "../crypto/x509/v3_prn.c"
                     ;
    ...
    const X509V3_EXT_METHOD *method;
    struct stack_st_CONF_VALUE *nval = 
# 79 "../crypto/x509/v3_prn.c" 3 4
                                ((void *)0)
# 79 "../crypto/x509/v3_prn.c"
                                    ;
    int ok = 1;
...
# 86 "../crypto/x509/v3_prn.c" 3 4
                                         ((void *)0)
# 86 "../crypto/x509/v3_prn.c"
                                             )
        return unknown_ext_print(out, p, extlen, flag, indent, 0);
    if (method->it)
        ext_str = ASN1_item_d2i(
# 89 "../crypto/x509/v3_prn.c" 3 4
                               ((void *)0)
# 89 "../crypto/x509/v3_prn.c"
                                   , &p, extlen, (method->it()));
    else
        ext_str = method->d2i(
# 91 "../crypto/x509/v3_prn.c" 3 4
                             ((void *)0)
# 91 "../crypto/x509/v3_prn.c"
                                 , &p, extlen);
...
# 97 "../crypto/x509/v3_prn.c" 3 4
                                                     ((void *)0)
# 97 "../crypto/x509/v3_prn.c"
                                                         ) {
            ok = 0;
            goto err;
        }
...
# 116 "../crypto/x509/v3_prn.c"
    } else if (method->i2v) {
        if ((nval = method->i2v(method, ext_str, 
# 117 "../crypto/x509/v3_prn.c" 3 4
                                                ((void *)0)
# 117 "../crypto/x509/v3_prn.c"
                                                    )) == 
# 117 "../crypto/x509/v3_prn.c" 3 4
                                                          ((void *)0)
# 117 "../crypto/x509/v3_prn.c"
 ...
 err:
    ...
    CRYPTO_free(value, "../crypto/x509/v3_prn.c", 131);
    if (method->it)
                            ...
                            unsigned long flag, int indent)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(exts)); i++) {
        ...
        ex = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(exts), (i)));
...
# 210 "../crypto/x509/v3_prn.c" 3 4
                                                  ((void *)0)
# 210 "../crypto/x509/v3_prn.c"
                                                      )
        return 0;
