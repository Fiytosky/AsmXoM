# 0 "../crypto/x509/x_all.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_all.c"
# 14 "../crypto/x509/x_all.c"
...
int X509_verify(X509 *a, EVP_PKEY *r)
{
    ...
    return ASN1_item_verify_ex((X509_CINF_it()), &a->sig_alg,
...
int X509_REQ_verify_ex(X509_REQ *a, EVP_PKEY *r, OSSL_LIB_CTX *libctx,
                       const char *propq)
{
    return ASN1_item_verify_ex((X509_REQ_INFO_it()), &a->sig_alg,
...
int X509_REQ_verify(X509_REQ *a, EVP_PKEY *r)
{
    return X509_REQ_verify_ex(a, r, 
# 51 "../crypto/x509/x_all.c" 3 4
                                   ((void *)0)
# 51 "../crypto/x509/x_all.c"
                                       , 
# 51 "../crypto/x509/x_all.c" 3 4
                                         ((void *)0)
# 51 "../crypto/x509/x_all.c"
...
{
    if (x == 
# 62 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 62 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",63,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 63 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 63 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    if (OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_get0_extensions(x))) > 0
            && !X509_set_version(x, 2))
        return 0;
# 77 "../crypto/x509/x_all.c"
    x->cert_info.enc.modified = 1;
    return ASN1_item_sign_ex((X509_CINF_it()), &x->cert_info.signature,
                             &x->sig_alg, &x->signature, &x->cert_info, 
# 79 "../crypto/x509/x_all.c" 3 4
                                                                       ((void *)0)
# 79 "../crypto/x509/x_all.c"
                                                                           ,
...
{
    if (x == 
# 85 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 85 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",86,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 86 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 86 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    if (OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(X509_get0_extensions(x))) > 0
                                   ...
                                   int timeout, const ASN1_ITEM *it)
{
    ...
    size_t max_resp_len = (it == (X509_CRL_it())) ?
        (32 * 1024 * 1024) : (100 * 1024);
    BIO *mem = OSSL_HTTP_get(url, 
# 104 "../crypto/x509/x_all.c" 3 4
                                 ((void *)0) 
# 104 "../crypto/x509/x_all.c"
                                                 , 
# 104 "../crypto/x509/x_all.c" 3 4
                                                   ((void *)0) 
# 104 "../crypto/x509/x_all.c"
                                                                      ,
                             bio, rbio, 
# 105 "../crypto/x509/x_all.c" 3 4
                                       ((void *)0) 
# 105 "../crypto/x509/x_all.c"
                                                    , 
# 105 "../crypto/x509/x_all.c" 3 4
                                                      ((void *)0) 
# 105 "../crypto/x509/x_all.c"
                                                                    ,
                             1024 , 
# 106 "../crypto/x509/x_all.c" 3 4
                                                 ((void *)0) 
# 106 "../crypto/x509/x_all.c"
                                                                   ,
                             
# 107 "../crypto/x509/x_all.c" 3 4
                            ((void *)0) 
# 107 "../crypto/x509/x_all.c"
                                                  , 1 ,
                             max_resp_len, timeout);
    ASN1_VALUE *res = ASN1_item_d2i_bio(it, mem, 
# 109 "../crypto/x509/x_all.c" 3 4
                                                ((void *)0)
# 109 "../crypto/x509/x_all.c"
                                                    );
...
{
    if (x == 
# 126 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 126 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",127,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 127 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 127 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    x->req_info.enc.modified = 1;
    return ASN1_item_sign_ex((X509_REQ_INFO_it()), &x->sig_alg, 
# 131 "../crypto/x509/x_all.c" 3 4
                                                                        ((void *)0)
# 131 "../crypto/x509/x_all.c"
                                                                            ,
                             x->signature, &x->req_info, 
# 132 "../crypto/x509/x_all.c" 3 4
                                                        ((void *)0)
# 132 "../crypto/x509/x_all.c"
                                                            ,
                             pkey, md, x->libctx, x->propq);
}
...
{
    if (x == 
# 138 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 138 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",139,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 139 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 139 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    x->req_info.enc.modified = 1;
    return ASN1_item_sign_ctx((X509_REQ_INFO_it()),
                              &x->sig_alg, 
# 144 "../crypto/x509/x_all.c" 3 4
                                          ((void *)0)
# 144 "../crypto/x509/x_all.c"
                                              , x->signature, &x->req_info,
                              ctx);
}
...
{
    if (x == 
# 150 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 150 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",151,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 151 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 151 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    x->crl.enc.modified = 1;
    return ASN1_item_sign_ex((X509_CRL_INFO_it()), &x->crl.sig_alg,
                             &x->sig_alg, &x->signature, &x->crl, 
# 156 "../crypto/x509/x_all.c" 3 4
                                                                 ((void *)0)
# 156 "../crypto/x509/x_all.c"
                                                                     ,
                             pkey, md, x->libctx, x->propq);
}
...
{
    if (x == 
# 162 "../crypto/x509/x_all.c" 3 4
            ((void *)0)
# 162 "../crypto/x509/x_all.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",163,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 163 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 163 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    x->crl.enc.modified = 1;
...
{
    return
        ASN1_item_sign_ex((NETSCAPE_SPKAC_it()), &x->sig_algor, 
# 181 "../crypto/x509/x_all.c" 3 4
                                                                        ((void *)0)
# 181 "../crypto/x509/x_all.c"
                                                                            ,
                          x->signature, x->spkac, 
# 182 "../crypto/x509/x_all.c" 3 4
                                                 ((void *)0)
# 182 "../crypto/x509/x_all.c"
                                                     , pkey, md, 
# 182 "../crypto/x509/x_all.c" 3 4
                                                                 ((void *)0)
# 182 "../crypto/x509/x_all.c"
...
PKCS7 *d2i_PKCS7_fp(FILE *fp, PKCS7 **p7)
{
    PKCS7 *ret;
    OSSL_LIB_CTX *libctx = 
# 233 "../crypto/x509/x_all.c" 3 4
                          ((void *)0)
# 233 "../crypto/x509/x_all.c"
                              ;
    const char *propq = 
# 234 "../crypto/x509/x_all.c" 3 4
                       ((void *)0)
# 234 "../crypto/x509/x_all.c"
                           ;

    if (p7 != 
# 236 "../crypto/x509/x_all.c" 3 4
             ((void *)0) 
# 236 "../crypto/x509/x_all.c"
                  && *p7 != 
# 236 "../crypto/x509/x_all.c" 3 4
                            ((void *)0)
# 236 "../crypto/x509/x_all.c"
    ...
    ret = ASN1_item_d2i_fp_ex((PKCS7_it()), fp, p7, libctx, propq);
    if (ret != 
# 242 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 242 "../crypto/x509/x_all.c"
                  )
...
PKCS7 *d2i_PKCS7_bio(BIO *bp, PKCS7 **p7)
{
    PKCS7 *ret;
    OSSL_LIB_CTX *libctx = 
# 256 "../crypto/x509/x_all.c" 3 4
                          ((void *)0)
# 256 "../crypto/x509/x_all.c"
                              ;
    const char *propq = 
# 257 "../crypto/x509/x_all.c" 3 4
                       ((void *)0)
# 257 "../crypto/x509/x_all.c"
                           ;

    if (p7 != 
# 259 "../crypto/x509/x_all.c" 3 4
             ((void *)0) 
# 259 "../crypto/x509/x_all.c"
                  && *p7 != 
# 259 "../crypto/x509/x_all.c" 3 4
                            ((void *)0)
# 259 "../crypto/x509/x_all.c"
    ...
    ret = ASN1_item_d2i_bio_ex((PKCS7_it()), bp, p7, libctx, propq);
    if (ret != 
# 265 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 265 "../crypto/x509/x_all.c"
                  )
        ossl_pkcs7_resolve_libctx(ret);
    return ret;
}
...
{
    OSSL_LIB_CTX *libctx = 
# 289 "../crypto/x509/x_all.c" 3 4
                          ((void *)0)
# 289 "../crypto/x509/x_all.c"
                              ;
    const char *propq = 
# 290 "../crypto/x509/x_all.c" 3 4
                       ((void *)0)
# 290 "../crypto/x509/x_all.c"
                           ;

    if (req != 
# 292 "../crypto/x509/x_all.c" 3 4
              ((void *)0) 
# 292 "../crypto/x509/x_all.c"
                   && *req != 
# 292 "../crypto/x509/x_all.c" 3 4
                              ((void *)0)
# 292 "../crypto/x509/x_all.c"
    ...
    return
        ASN1_item_d2i_bio_ex((X509_REQ_it()), bp, req, libctx, propq);
}
...
RSA *d2i_RSA_PUBKEY_fp(FILE *fp, RSA **rsa)
{
    return ASN1_d2i_fp((void *(*)(void))
                       RSA_new, (void *(*)(void **,const unsigned char **,long)) d2i_RSA_PUBKEY, fp,
                       (void **)rsa);
}
...
{
    return ASN1_i2d_fp((int (*)(const void *,unsigned char **))i2d_RSA_PUBKEY, fp, rsa);
}
...
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_RSA_PUBKEY : ((int (*)(const RSA *,unsigned char **))0))), bp, ((void*) (1 ? rsa : (const RSA*)0))));
}
...
{
    return ((DSA*)ASN1_d2i_fp(((void *(*)(void)) (1 ? DSA_new : ((DSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DSAPrivateKey : ((DSA *(*)(DSA **,const unsigned char **,long))0))), fp, ((void**) (1 ? dsa : (DSA**)0))));
}

int i2d_DSAPrivateKey_fp(FILE *fp, const DSA *dsa)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_DSAPrivateKey : ((int (*)(const DSA *,unsigned char **))0))), fp, ((void*) (1 ? dsa : (const DSA*)0))));
}
...
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_DSA_PUBKEY : ((int (*)(const DSA *,unsigned char **))0))), fp, ((void*) (1 ? dsa : (const DSA*)0))));
}


DSA *d2i_DSAPrivateKey_bio(BIO *bp, DSA **dsa)
{
    return ((DSA*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? DSA_new : ((DSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DSAPrivateKey : ((DSA *(*)(DSA **,const unsigned char **,long))0))), bp, ((void**) (1 ? dsa : (DSA**)0))));
}

int i2d_DSAPrivateKey_bio(BIO *bp, const DSA *dsa)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DSAPrivateKey : ((int (*)(const DSA *,unsigned char **))0))), bp, ((void*) (1 ? dsa : (const DSA*)0))));
}
...
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DSA_PUBKEY : ((int (*)(const DSA *,unsigned char **))0))), bp, ((void*) (1 ? dsa : (const DSA*)0))));
}
...
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_EC_PUBKEY : ((int (*)(const EC_KEY *,unsigned char **))0))), fp, ((void*) (1 ? eckey : (const EC_KEY*)0))));
}
...
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_ECPrivateKey : ((int (*)(const EC_KEY *,unsigned char **))0))), fp, ((void*) (1 ? eckey : (const EC_KEY*)0))));
}
...
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_EC_PUBKEY : ((int (*)(const EC_KEY *,unsigned char **))0))), bp, ((void*) (1 ? ecdsa : (const EC_KEY*)0))));
}
...
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_ECPrivateKey : ((int (*)(const EC_KEY *,unsigned char **))0))), bp, ((void*) (1 ? eckey : (const EC_KEY*)0))));
}
                       ...
                       unsigned char *md, unsigned int *len)
{
    ...
    if (key == 
# 463 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 463 "../crypto/x509/x_all.c"
                  )
        return 0;
    return EVP_Digest(key->data, key->length, md, len, type, 
# 465 "../crypto/x509/x_all.c" 3 4
                                                            ((void *)0)
# 465 "../crypto/x509/x_all.c"
                                                                );
}
...
int X509_digest(const X509 *cert, const EVP_MD *md, unsigned char *data,
                unsigned int *len)
{
    if (EVP_MD_is_a(md, "SHA1") && (cert->ex_flags & 0x100) != 0
            && (cert->ex_flags & 0x100000) == 0) {

        if (len != 
# 474 "../crypto/x509/x_all.c" 3 4
                  ((void *)0)
# 474 "../crypto/x509/x_all.c"
                      )
            *len = sizeof(cert->sha1_hash);
        memcpy(data, cert->sha1_hash, sizeof(cert->sha1_hash));
        return 1;
    }
    return ossl_asn1_item_digest_ex((X509_it()), md, (char *)cert,
                                   ...
                                   EVP_MD **md_used, int *md_is_fallback)
{
    ...
    int mdnid, pknid;
    EVP_MD *md = 
# 490 "../crypto/x509/x_all.c" 3 4
                ((void *)0)
# 490 "../crypto/x509/x_all.c"
                    ;
    const char *md_name;
    ASN1_OCTET_STRING *new;

    if (md_used != 
# 494 "../crypto/x509/x_all.c" 3 4
                  ((void *)0)
# 494 "../crypto/x509/x_all.c"
                      )
        *md_used = 
# 495 "../crypto/x509/x_all.c" 3 4
                  ((void *)0)
# 495 "../crypto/x509/x_all.c"
                      ;
    if (md_is_fallback != 
# 496 "../crypto/x509/x_all.c" 3 4
                         ((void *)0)
# 496 "../crypto/x509/x_all.c"
    ...
    if (cert == 
# 499 "../crypto/x509/x_all.c" 3 4
               ((void *)0)
# 499 "../crypto/x509/x_all.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",500,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 500 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 500 "../crypto/x509/x_all.c"
       );
        return 
# 501 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 501 "../crypto/x509/x_all.c"
                  ;
    }

    if (!OBJ_find_sigid_algs(X509_get_signature_nid(cert), &mdnid, &pknid)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",505,__func__), ERR_set_error)((11),(144),
# 505 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 505 "../crypto/x509/x_all.c"
       );
        return 
# 506 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 506 "../crypto/x509/x_all.c"
                  ;
    }
    ...
    if (mdnid == 0) {
        if (pknid == 912) {
            ...
            const EVP_MD *mgf1md, *mmd = 
# 512 "../crypto/x509/x_all.c" 3 4
                                        ((void *)0)
# 512 "../crypto/x509/x_all.c"
                                            ;
            int saltlen, trailerfield;

            if (pss == 
# 515 "../crypto/x509/x_all.c" 3 4
                      ((void *)0)
                
# 516 "../crypto/x509/x_all.c"
               || !ossl_rsa_pss_get_param_unverified(pss, &mmd, &mgf1md,
                                                      &saltlen,
                                                      &trailerfield)
                || mmd == 
# 519 "../crypto/x509/x_all.c" 3 4
                         ((void *)0)
# 519 "../crypto/x509/x_all.c"
                             ) {
                RSA_PSS_PARAMS_free(pss);
                (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",521,__func__), ERR_set_error)((11),(111),
# 521 "../crypto/x509/x_all.c" 3 4
               ((void *)0)
# 521 "../crypto/x509/x_all.c"
               );
                return 
# 522 "../crypto/x509/x_all.c" 3 4
                      ((void *)0)
# 522 "../crypto/x509/x_all.c"
                          ;
            }
            RSA_PSS_PARAMS_free(pss);
            ...
            if ((md = EVP_MD_fetch(cert->libctx, EVP_MD_get0_name(mmd),
                                   cert->propq)) == 
# 527 "../crypto/x509/x_all.c" 3 4
                                                   ((void *)0)
# 527 "../crypto/x509/x_all.c"
                                                       )

                return 
# 529 "../crypto/x509/x_all.c" 3 4
                      ((void *)0)
# 529 "../crypto/x509/x_all.c"
                          ;
        } else if (pknid != 0) {
            ...
            if ((md = EVP_MD_fetch(cert->libctx, md_name,
                                   cert->propq)) == 
# 544 "../crypto/x509/x_all.c" 3 4
                                                   ((void *)0)
# 544 "../crypto/x509/x_all.c"
                                                       )
                return 
# 545 "../crypto/x509/x_all.c" 3 4
                      ((void *)0)
# 545 "../crypto/x509/x_all.c"
                          ;
            if (md_is_fallback != 
# 546 "../crypto/x509/x_all.c" 3 4
                                 ((void *)0)
# 546 "../crypto/x509/x_all.c"
                                     )
                *md_is_fallback = 1;
        } else {

            (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",550,__func__), ERR_set_error)((11),(111),
# 550 "../crypto/x509/x_all.c" 3 4
           ((void *)0)
# 550 "../crypto/x509/x_all.c"
           );
            return 
# 551 "../crypto/x509/x_all.c" 3 4
                  ((void *)0)
# 551 "../crypto/x509/x_all.c"
                      ;
        }
    } else if ((md = EVP_MD_fetch(cert->libctx, OBJ_nid2sn(mdnid),
                                  cert->propq)) == 
# 554 "../crypto/x509/x_all.c" 3 4
                                                  ((void *)0)
               
# 555 "../crypto/x509/x_all.c"
              && (md = (EVP_MD *)EVP_get_digestbyname(OBJ_nid2sn(mdnid))) == 
# 555 "../crypto/x509/x_all.c" 3 4
                                                                ((void *)0)
# 555 "../crypto/x509/x_all.c"
                                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",556,__func__), ERR_set_error)((11),(111),
# 556 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 556 "../crypto/x509/x_all.c"
       );
        return 
# 557 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 557 "../crypto/x509/x_all.c"
                  ;
    }
    if (!X509_digest(cert, md, hash, &len)
            || (new = ASN1_OCTET_STRING_new()) == 
# 560 "../crypto/x509/x_all.c" 3 4
                                                 ((void *)0)
# 560 "../crypto/x509/x_all.c"
                                                     )
        goto err;
    if (ASN1_OCTET_STRING_set(new, hash, len)) {
        if (md_used != 
# 563 "../crypto/x509/x_all.c" 3 4
                      ((void *)0)
# 563 "../crypto/x509/x_all.c"
                          )
            *md_used = md;
        else
            EVP_MD_free(md);
 ...
 err:
    EVP_MD_free(md);
    return 
# 572 "../crypto/x509/x_all.c" 3 4
          ((void *)0)
# 572 "../crypto/x509/x_all.c"
              ;
}
...
{
    if (type == 
# 578 "../crypto/x509/x_all.c" 3 4
               ((void *)0)
# 578 "../crypto/x509/x_all.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",579,__func__), ERR_set_error)((11),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 579 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 579 "../crypto/x509/x_all.c"
       );
        return 0;
    }
    if (EVP_MD_is_a(type, "SHA1")
            && (data->flags & 0x100) != 0
            && (data->flags & 0x100000) == 0) {

        if (len != 
# 586 "../crypto/x509/x_all.c" 3 4
                  ((void *)0)
# 586 "../crypto/x509/x_all.c"
                      )
    ...
    return
        ossl_asn1_item_digest_ex((X509_CRL_it()), type, (char *)data,
...
{
    return
        ossl_asn1_item_digest_ex((X509_REQ_it()), type, (char *)data,
                                 md, len, data->libctx, data->propq);
}
...
X509_SIG *d2i_PKCS8_fp(FILE *fp, X509_SIG **p8)
{
    return ((X509_SIG*)ASN1_d2i_fp(((void *(*)(void)) (1 ? X509_SIG_new : ((X509_SIG *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_X509_SIG : ((X509_SIG *(*)(X509_SIG **,const unsigned char **,long))0))), fp, ((void**) (1 ? p8 : (X509_SIG**)0))));
}

int i2d_PKCS8_fp(FILE *fp, const X509_SIG *p8)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_X509_SIG : ((int (*)(const X509_SIG *,unsigned char **))0))), fp, ((void*) (1 ? p8 : (const X509_SIG*)0))));
}


X509_SIG *d2i_PKCS8_bio(BIO *bp, X509_SIG **p8)
{
    return ((X509_SIG*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? X509_SIG_new : ((X509_SIG *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_X509_SIG : ((X509_SIG *(*)(X509_SIG **,const unsigned char **,long))0))), bp, ((void**) (1 ? p8 : (X509_SIG**)0))));
}

int i2d_PKCS8_bio(BIO *bp, const X509_SIG *p8)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_X509_SIG : ((int (*)(const X509_SIG *,unsigned char **))0))), bp, ((void*) (1 ? p8 : (const X509_SIG*)0))));
}


X509_PUBKEY *d2i_X509_PUBKEY_fp(FILE *fp, X509_PUBKEY **xpk)
{
    return ((X509_PUBKEY*)ASN1_d2i_fp(((void *(*)(void)) (1 ? X509_PUBKEY_new : ((X509_PUBKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_X509_PUBKEY : ((X509_PUBKEY *(*)(X509_PUBKEY **,const unsigned char **,long))0))), fp, ((void**) (1 ? xpk : (X509_PUBKEY**)0))))
                                  ;
}

int i2d_X509_PUBKEY_fp(FILE *fp, const X509_PUBKEY *xpk)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_X509_PUBKEY : ((int (*)(const X509_PUBKEY *,unsigned char **))0))), fp, ((void*) (1 ? xpk : (const X509_PUBKEY*)0))));
}


X509_PUBKEY *d2i_X509_PUBKEY_bio(BIO *bp, X509_PUBKEY **xpk)
{
    return ((X509_PUBKEY*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? X509_PUBKEY_new : ((X509_PUBKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_X509_PUBKEY : ((X509_PUBKEY *(*)(X509_PUBKEY **,const unsigned char **,long))0))), bp, ((void**) (1 ? xpk : (X509_PUBKEY**)0))))
                                   ;
}

int i2d_X509_PUBKEY_bio(BIO *bp, const X509_PUBKEY *xpk)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_X509_PUBKEY : ((int (*)(const X509_PUBKEY *,unsigned char **))0))), bp, ((void*) (1 ? xpk : (const X509_PUBKEY*)0))));
}
...
PKCS8_PRIV_KEY_INFO *d2i_PKCS8_PRIV_KEY_INFO_fp(FILE *fp,
                                                PKCS8_PRIV_KEY_INFO **p8inf)
{
    return ((PKCS8_PRIV_KEY_INFO*)ASN1_d2i_fp(((void *(*)(void)) (1 ? PKCS8_PRIV_KEY_INFO_new : ((PKCS8_PRIV_KEY_INFO *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_PKCS8_PRIV_KEY_INFO : ((PKCS8_PRIV_KEY_INFO *(*)(PKCS8_PRIV_KEY_INFO **,const unsigned char **,long))0))), fp, ((void**) (1 ? p8inf : (PKCS8_PRIV_KEY_INFO**)0))))
                                                             ;
}

int i2d_PKCS8_PRIV_KEY_INFO_fp(FILE *fp, const PKCS8_PRIV_KEY_INFO *p8inf)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_PKCS8_PRIV_KEY_INFO : ((int (*)(const PKCS8_PRIV_KEY_INFO *,unsigned char **))0))), fp, ((void*) (1 ? p8inf : (const PKCS8_PRIV_KEY_INFO*)0))))
                                ;
}
...
int i2d_PKCS8PrivateKeyInfo_fp(FILE *fp, const EVP_PKEY *key)
{
    ...
    if (p8inf == 
# 685 "../crypto/x509/x_all.c" 3 4
                ((void *)0)
# 685 "../crypto/x509/x_all.c"
                    )
        return 0;
...
int i2d_PrivateKey_fp(FILE *fp, const EVP_PKEY *pkey)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_PrivateKey : ((int (*)(const EVP_PKEY *,unsigned char **))0))), fp, ((void*) (1 ? pkey : (const EVP_PKEY*)0))));
}
...
# 708 "../crypto/x509/x_all.c" 3 4
                                      ((void *)0)
# 708 "../crypto/x509/x_all.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",709,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 709 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 709 "../crypto/x509/x_all.c"
       );
        return 
# 710 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 710 "../crypto/x509/x_all.c"
                  ;
    }
...
int i2d_PUBKEY_fp(FILE *fp, const EVP_PKEY *pkey)
{
    return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_PUBKEY : ((int (*)(const EVP_PKEY *,unsigned char **))0))), fp, ((void*) (1 ? pkey : (const EVP_PKEY*)0))));
}
                           ...
                           const char *propq)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 729 "../crypto/x509/x_all.c" 3 4
                                      ((void *)0)
# 729 "../crypto/x509/x_all.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_all.c",730,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 730 "../crypto/x509/x_all.c" 3 4
       ((void *)0)
# 730 "../crypto/x509/x_all.c"
       );
        return 
# 731 "../crypto/x509/x_all.c" 3 4
              ((void *)0)
# 731 "../crypto/x509/x_all.c"
                  ;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
PKCS8_PRIV_KEY_INFO *d2i_PKCS8_PRIV_KEY_INFO_bio(BIO *bp,
                                                 PKCS8_PRIV_KEY_INFO **p8inf)
{
    return ((PKCS8_PRIV_KEY_INFO*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? PKCS8_PRIV_KEY_INFO_new : ((PKCS8_PRIV_KEY_INFO *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_PKCS8_PRIV_KEY_INFO : ((PKCS8_PRIV_KEY_INFO *(*)(PKCS8_PRIV_KEY_INFO **,const unsigned char **,long))0))), bp, ((void**) (1 ? p8inf : (PKCS8_PRIV_KEY_INFO**)0))))
                                                              ;
}
...
int i2d_PKCS8PrivateKeyInfo_bio(BIO *bp, const EVP_PKEY *key)
{
    ...
    p8inf = EVP_PKEY2PKCS8(key);
    if (p8inf == 
# 765 "../crypto/x509/x_all.c" 3 4
                ((void *)0)
# 765 "../crypto/x509/x_all.c"
                    )
        return 0;
...
int i2d_PrivateKey_bio(BIO *bp, const EVP_PKEY *pkey)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_PrivateKey : ((int (*)(const EVP_PKEY *,unsigned char **))0))), bp, ((void*) (1 ? pkey : (const EVP_PKEY*)0))));
}
...
{
    BUF_MEM *b = 
# 785 "../crypto/x509/x_all.c" 3 4
                ((void *)0)
# 785 "../crypto/x509/x_all.c"
                    ;
    const unsigned char *p;
    void *ret = 
# 787 "../crypto/x509/x_all.c" 3 4
               ((void *)0)
# 787 "../crypto/x509/x_all.c"
                   ;
    int len;
...
int i2d_PUBKEY_bio(BIO *bp, const EVP_PKEY *pkey)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_PUBKEY : ((int (*)(const EVP_PKEY *,unsigned char **))0))), bp, ((void*) (1 ? pkey : (const EVP_PKEY*)0))));
}
...
{
    BUF_MEM *b = 
# 809 "../crypto/x509/x_all.c" 3 4
                ((void *)0)
# 809 "../crypto/x509/x_all.c"
                    ;
    const unsigned char *p;
    void *ret = 
# 811 "../crypto/x509/x_all.c" 3 4
               ((void *)0)
# 811 "../crypto/x509/x_all.c"
                   ;
    int len;
