# 0 "../crypto/x509/x_name.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_name.c"
# 10 "../crypto/x509/x_name.c"
...
# 18 "../crypto/x509/x_name.c" 2
# 26 "../crypto/x509/x_name.c"
...
static int i2d_name_canon(const struct stack_st_STACK_OF_X509_NAME_ENTRY * intname,
                          unsigned char **in);
...
static const ASN1_TEMPLATE X509_NAME_ENTRY_seq_tt[] = {
        { (0), (0), 
# 47 "../crypto/x509/x_name.c" 3 4
       __builtin_offsetof (
# 47 "../crypto/x509/x_name.c"
       X509_NAME_ENTRY
# 47 "../crypto/x509/x_name.c" 3 4
       , 
# 47 "../crypto/x509/x_name.c"
...
# 47 "../crypto/x509/x_name.c"
       , "object", (ASN1_OBJECT_it) },
        { (0), (0), 
# 48 "../crypto/x509/x_name.c" 3 4
       __builtin_offsetof (
# 48 "../crypto/x509/x_name.c"
       X509_NAME_ENTRY
# 48 "../crypto/x509/x_name.c" 3 4
       , 
# 48 "../crypto/x509/x_name.c"
...
# 48 "../crypto/x509/x_name.c"
       , "value", (ASN1_PRINTABLE_it) }
} ; const ASN1_ITEM * X509_NAME_ENTRY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_NAME_ENTRY_seq_tt, sizeof(X509_NAME_ENTRY_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 49 "../crypto/x509/x_name.c" 3 4
 ((void *)0)
# 49 "../crypto/x509/x_name.c"
 , sizeof(X509_NAME_ENTRY), "X509_NAME_ENTRY" }; return &local_it; }

X509_NAME_ENTRY *d2i_X509_NAME_ENTRY(X509_NAME_ENTRY **a, const unsigned char **in, long len) { return (X509_NAME_ENTRY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_NAME_ENTRY_it())); } int i2d_X509_NAME_ENTRY(const X509_NAME_ENTRY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_NAME_ENTRY_it())); } X509_NAME_ENTRY *X509_NAME_ENTRY_new(void) { return (X509_NAME_ENTRY *)ASN1_item_new((X509_NAME_ENTRY_it())); } void X509_NAME_ENTRY_free(X509_NAME_ENTRY *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_NAME_ENTRY_it())); }
X509_NAME_ENTRY * X509_NAME_ENTRY_dup(const X509_NAME_ENTRY *x) { return ASN1_item_dup((X509_NAME_ENTRY_it()), x); }
...
static const ASN1_TEMPLATE X509_NAME_ENTRIES_item_tt =
        { ((0x1 << 1)), (0), 0, "RDNS", (X509_NAME_ENTRY_it) }
; static const ASN1_ITEM * X509_NAME_ENTRIES_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &X509_NAME_ENTRIES_item_tt, 0, 
# 61 "../crypto/x509/x_name.c" 3 4
((void *)0)
# 61 "../crypto/x509/x_name.c"
, 0, "X509_NAME_ENTRIES" }; return &local_it; }

static const ASN1_TEMPLATE X509_NAME_INTERNAL_item_tt =
        { ((0x2 << 1)), (0), 0, "Name", (X509_NAME_ENTRIES_it) }
; static const ASN1_ITEM * X509_NAME_INTERNAL_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &X509_NAME_INTERNAL_item_tt, 0, 
# 65 "../crypto/x509/x_name.c" 3 4
((void *)0)
# 65 "../crypto/x509/x_name.c"
, 0, "X509_NAME_INTERNAL" }; return &local_it; }
# 74 "../crypto/x509/x_name.c"
static const ASN1_EXTERN_FUNCS x509_name_ff = {
    
# 75 "../crypto/x509/x_name.c" 3 4
   ((void *)0)
# 75 "../crypto/x509/x_name.c"
       ,
    x509_name_ex_new,
    x509_name_ex_free,
    0,
...
const ASN1_ITEM * X509_NAME_it(void) { static const ASN1_ITEM local_it = { 0x4, 16, 
# 84 "../crypto/x509/x_name.c" 3 4
((void *)0)
# 84 "../crypto/x509/x_name.c"
, 0, &x509_name_ff, 0, "X509_NAME" }; return &local_it; }

X509_NAME *d2i_X509_NAME(X509_NAME **a, const unsigned char **in, long len) { return (X509_NAME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_NAME_it())); } int i2d_X509_NAME(const X509_NAME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_NAME_it())); } X509_NAME *X509_NAME_new(void) { return (X509_NAME *)ASN1_item_new((X509_NAME_it())); } void X509_NAME_free(X509_NAME *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_NAME_it())); }

X509_NAME * X509_NAME_dup(const X509_NAME *x) { return ASN1_item_dup((X509_NAME_it()), x); }

static int x509_name_ex_new(ASN1_VALUE **val, const ASN1_ITEM *it)
{
    X509_NAME *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/x509/x_name.c", 92);

    if (ret == 
# 94 "../crypto/x509/x_name.c" 3 4
              ((void *)0)
# 94 "../crypto/x509/x_name.c"
                  )
        return 0;
    if ((ret->entries = ((struct stack_st_X509_NAME_ENTRY *)OPENSSL_sk_new_null())) == 
# 96 "../crypto/x509/x_name.c" 3 4
                                                         ((void *)0)
# 96 "../crypto/x509/x_name.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",97,__func__), ERR_set_error)((13),((15 | (0x2 << 18L))),
# 97 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
# 97 "../crypto/x509/x_name.c"
       );
        goto err;
    }
    if ((ret->bytes = BUF_MEM_new()) == 
# 100 "../crypto/x509/x_name.c" 3 4
                                       ((void *)0)
# 100 "../crypto/x509/x_name.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",101,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 101 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
# 101 "../crypto/x509/x_name.c"
       );
        goto err;
    }
    ret->modified = 1;
 ...
 err:
    if (ret) {
        OPENSSL_sk_free(ossl_check_X509_NAME_ENTRY_sk_type(ret->entries));
        CRYPTO_free(ret, "../crypto/x509/x_name.c", 111);
    }
    return 0;
}
...
static void x509_name_ex_free(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (pval == 
# 120 "../crypto/x509/x_name.c" 3 4
               ((void *)0) 
# 120 "../crypto/x509/x_name.c"
                    || *pval == 
# 120 "../crypto/x509/x_name.c" 3 4
                                ((void *)0)
# 120 "../crypto/x509/x_name.c"
    ...
    OPENSSL_sk_pop_free(ossl_check_X509_NAME_ENTRY_sk_type(a->entries),ossl_check_X509_NAME_ENTRY_freefunc_type(X509_NAME_ENTRY_free));
    CRYPTO_free(a->canon_enc, "../crypto/x509/x_name.c", 126);
    CRYPTO_free(a, "../crypto/x509/x_name.c", 127);
    *pval = 
# 128 "../crypto/x509/x_name.c" 3 4
           ((void *)0)
# 128 "../crypto/x509/x_name.c"
               ;
}

static void local_sk_X509_NAME_ENTRY_free(struct stack_st_X509_NAME_ENTRY *ne)
{
    OPENSSL_sk_free(ossl_check_X509_NAME_ENTRY_sk_type(ne));
}

static void local_sk_X509_NAME_ENTRY_pop_free(struct stack_st_X509_NAME_ENTRY *ne)
{
    OPENSSL_sk_pop_free(ossl_check_X509_NAME_ENTRY_sk_type(ne),ossl_check_X509_NAME_ENTRY_freefunc_type(X509_NAME_ENTRY_free));
}
...
# 151 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
    
# 152 "../crypto/x509/x_name.c"
   };
    union {
        X509_NAME *x;
        ASN1_VALUE *a;
...
# 157 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
    
# 158 "../crypto/x509/x_name.c"
   };
    int i, j, ret;
    struct stack_st_X509_NAME_ENTRY *entries;
...
# 176 "../crypto/x509/x_name.c" 3 4
                              ((void *)0)
# 176 "../crypto/x509/x_name.c"
                                  );
    if (!x509_name_ex_new(&nm.a, 
# 177 "../crypto/x509/x_name.c" 3 4
                                ((void *)0)
# 177 "../crypto/x509/x_name.c"
                                    ))
        goto err;
    ...
    for (i = 0; i < sk_STACK_OF_X509_NAME_ENTRY_num(intname.s); i++) {
        ...
        for (j = 0; j < OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(entries)); j++) {
            entry = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(entries), (j)));
            entry->set = i;
            if (!OPENSSL_sk_push(ossl_check_X509_NAME_ENTRY_sk_type(nm.x->entries), ossl_check_X509_NAME_ENTRY_type(entry)))
                goto err;
            (void)((X509_NAME_ENTRY *)OPENSSL_sk_set(ossl_check_X509_NAME_ENTRY_sk_type(entries), (j), ossl_check_X509_NAME_ENTRY_type(
# 192 "../crypto/x509/x_name.c" 3 4
                 ((void *)0)
# 192 "../crypto/x509/x_name.c"
                 )));
        }
    }
 ...
 err:
    if (nm.x != 
# 206 "../crypto/x509/x_name.c" 3 4
               ((void *)0)
# 206 "../crypto/x509/x_name.c"
                   )
        X509_NAME_free(nm.x);
    sk_STACK_OF_X509_NAME_ENTRY_pop_free(intname.s,
                                         local_sk_X509_NAME_ENTRY_pop_free);
    (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",210,__func__), ERR_set_error)((13),((266|(0x2 << 18L))),
# 210 "../crypto/x509/x_name.c" 3 4
   ((void *)0)
# 210 "../crypto/x509/x_name.c"
   );
    return 0;
}
                            ...
                            const ASN1_ITEM *it, int tag, int aclass)
{
    ...
    ret = a->bytes->length;
    if (out != 
# 229 "../crypto/x509/x_name.c" 3 4
              ((void *)0)
# 229 "../crypto/x509/x_name.c"
                  ) {
...
# 242 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
    
# 243 "../crypto/x509/x_name.c"
   };
    int len;
    unsigned char *p;
    struct stack_st_X509_NAME_ENTRY *entries = 
# 246 "../crypto/x509/x_name.c" 3 4
                                        ((void *)0)
# 246 "../crypto/x509/x_name.c"
                                            ;
    X509_NAME_ENTRY *entry;
    int i, set = -1;
    ...
    if (!intname.s)
        goto cerr;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries)); i++) {
        entry = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries), (i)));
        if (entry->set != set) {
            entries = ((struct stack_st_X509_NAME_ENTRY *)OPENSSL_sk_new_null());
            if (!entries)
                goto cerr;
            if (!sk_STACK_OF_X509_NAME_ENTRY_push(intname.s, entries)) {
                OPENSSL_sk_free(ossl_check_X509_NAME_ENTRY_sk_type(entries));
                goto cerr;
            }
            set = entry->set;
        }
        if (!OPENSSL_sk_push(ossl_check_X509_NAME_ENTRY_sk_type(entries), ossl_check_X509_NAME_ENTRY_type(entry)))
            goto cerr;
    }
    len = ASN1_item_ex_i2d(&intname.a, 
# 268 "../crypto/x509/x_name.c" 3 4
                                      ((void *)0)
# 268 "../crypto/x509/x_name.c"
                                          ,
                           (X509_NAME_INTERNAL_it()), -1, -1);
    if (!BUF_MEM_grow(a->bytes, len)) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",271,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 271 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
# 271 "../crypto/x509/x_name.c"
       );
        goto err;
    }
    p = (unsigned char *)a->bytes->data;
    ASN1_item_ex_i2d(&intname.a,
                     &p, (X509_NAME_INTERNAL_it()), -1, -1);
    sk_STACK_OF_X509_NAME_ENTRY_pop_free(intname.s,
                                         local_sk_X509_NAME_ENTRY_free);
    a->modified = 0;
    return len;
 cerr:
    (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",282,__func__), ERR_set_error)((13),((15 | (0x2 << 18L))),
# 282 "../crypto/x509/x_name.c" 3 4
   ((void *)0)
# 282 "../crypto/x509/x_name.c"
   );
 err:
    sk_STACK_OF_X509_NAME_ENTRY_pop_free(intname.s,
                                         local_sk_X509_NAME_ENTRY_free);
...
# 310 "../crypto/x509/x_name.c"
static int x509_name_canon(X509_NAME *a)
{
    unsigned char *p;
    struct stack_st_STACK_OF_X509_NAME_ENTRY *intname;
    struct stack_st_X509_NAME_ENTRY *entries = 
# 314 "../crypto/x509/x_name.c" 3 4
                                        ((void *)0)
# 314 "../crypto/x509/x_name.c"
                                            ;
    X509_NAME_ENTRY *entry, *tmpentry = 
# 315 "../crypto/x509/x_name.c" 3 4
                                       ((void *)0)
# 315 "../crypto/x509/x_name.c"
                                           ;
    int i, set = -1, ret = 0, len;

    CRYPTO_free(a->canon_enc, "../crypto/x509/x_name.c", 318);
    a->canon_enc = 
# 319 "../crypto/x509/x_name.c" 3 4
                  ((void *)0)
# 319 "../crypto/x509/x_name.c"
                      ;

    if (OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries)) == 0) {
        a->canon_enclen = 0;
        return 1;
    }
    intname = sk_STACK_OF_X509_NAME_ENTRY_new_null();
    if (intname == 
# 326 "../crypto/x509/x_name.c" 3 4
                  ((void *)0)
# 326 "../crypto/x509/x_name.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",327,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 327 "../crypto/x509/x_name.c" 3 4
       ((void *)0)
# 327 "../crypto/x509/x_name.c"
       );
        goto err;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(a->entries)); i++) {
        ...
        if (entry->set != set) {
            entries = ((struct stack_st_X509_NAME_ENTRY *)OPENSSL_sk_new_null());
            if (entries == 
# 334 "../crypto/x509/x_name.c" 3 4
                          ((void *)0)
# 334 "../crypto/x509/x_name.c"
                              )
                goto err;
            if (!sk_STACK_OF_X509_NAME_ENTRY_push(intname, entries)) {
                OPENSSL_sk_free(ossl_check_X509_NAME_ENTRY_sk_type(entries));
                (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",338,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 338 "../crypto/x509/x_name.c" 3 4
               ((void *)0)
# 338 "../crypto/x509/x_name.c"
               );
                goto err;
            }
            set = entry->set;
        ...
        if (tmpentry == 
# 344 "../crypto/x509/x_name.c" 3 4
                       ((void *)0)
# 344 "../crypto/x509/x_name.c"
                           ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",345,__func__), ERR_set_error)((11),((13 | (0x2 << 18L))),
# 345 "../crypto/x509/x_name.c" 3 4
           ((void *)0)
# 345 "../crypto/x509/x_name.c"
           );
            goto err;
        }
        tmpentry->object = OBJ_dup(entry->object);
        if (tmpentry->object == 
# 349 "../crypto/x509/x_name.c" 3 4
                               ((void *)0)
# 349 "../crypto/x509/x_name.c"
                                   ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",350,__func__), ERR_set_error)((11),((8 | (0x2 << 18L))),
# 350 "../crypto/x509/x_name.c" 3 4
           ((void *)0)
# 350 "../crypto/x509/x_name.c"
           );
            goto err;
        }
        if (!asn1_string_canon(tmpentry->value, entry->value))
            goto err;
        if (!OPENSSL_sk_push(ossl_check_X509_NAME_ENTRY_sk_type(entries), ossl_check_X509_NAME_ENTRY_type(tmpentry))) {
            (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",356,__func__), ERR_set_error)((11),((15 | (0x2 << 18L))),
# 356 "../crypto/x509/x_name.c" 3 4
           ((void *)0)
# 356 "../crypto/x509/x_name.c"
           );
            goto err;
        }
        tmpentry = 
# 359 "../crypto/x509/x_name.c" 3 4
                  ((void *)0)
# 359 "../crypto/x509/x_name.c"
                      ;
    }


    len = i2d_name_canon(intname, 
# 363 "../crypto/x509/x_name.c" 3 4
                                 ((void *)0)
# 363 "../crypto/x509/x_name.c"
                                     );
    if (len < 0)
        goto err;
    a->canon_enclen = len;

    p = CRYPTO_malloc(a->canon_enclen, "../crypto/x509/x_name.c", 368);
    if (p == 
# 369 "../crypto/x509/x_name.c" 3 4
            ((void *)0)
# 369 "../crypto/x509/x_name.c"
                )
        goto err;
...
static int asn1_string_canon(ASN1_STRING *out, const ASN1_STRING *in)
{
    ...
    len = out->length;
# 422 "../crypto/x509/x_name.c"
    while (len > 0 && (ossl_ctype_check((*from), 0x8))) {
        from++;
        len--;
    }
    ...
    while (len > 0 && (ossl_ctype_check((to[-1]), 0x8))) {
        to--;
        len--;
    }
    ...
    while (i < len) {
        ...
        if (!(((*from) & ~127) == 0)) {
        ...
        else if ((ossl_ctype_check((*from), 0x8))) {
            ...
            *to++ = ' ';
            ...
            while ((ossl_ctype_check((*from), 0x8)));
        } else {
...
static int i2d_name_canon(const struct stack_st_STACK_OF_X509_NAME_ENTRY * _intname,
                          unsigned char **in)
{
    int i, len, ltmp;
    const ASN1_VALUE *v;
    ...
    len = 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_VALUE_sk_type(intname)); i++) {
        v = ((ASN1_VALUE *)OPENSSL_sk_value(ossl_check_const_ASN1_VALUE_sk_type(intname), (i)));
        ltmp = ASN1_item_ex_i2d(&v, in,
                                (X509_NAME_ENTRIES_it()), -1, -1);
        if (ltmp < 0 || len > 0x7fffffff 
# 483 "../crypto/x509/x_name.c"
                                     - ltmp)
            return -1;
        len += ltmp;
    }
...
int X509_NAME_set(X509_NAME **xn, const X509_NAME *name)
{
    ...
    if (*xn == name)
        return *xn != 
# 495 "../crypto/x509/x_name.c" 3 4
                     ((void *)0)
# 495 "../crypto/x509/x_name.c"
                         ;
    if ((name_copy = X509_NAME_dup(name)) == 
# 496 "../crypto/x509/x_name.c" 3 4
                                            ((void *)0)
# 496 "../crypto/x509/x_name.c"
                                                )
        return 0;
    X509_NAME_free(*xn);
    *xn = name_copy;
...
# 508 "../crypto/x509/x_name.c" 3 4
                               ((void *)0)
# 508 "../crypto/x509/x_name.c"
                                   , 0);
    if (b == 
# 509 "../crypto/x509/x_name.c" 3 4
            ((void *)0)
# 509 "../crypto/x509/x_name.c"
                )
        return 0;
    if (*b == '\0') {
        CRYPTO_free(b, "../crypto/x509/x_name.c", 512);
        return 1;
    }
    s = b + 1;
    ...
    CRYPTO_free(b, "../crypto/x509/x_name.c", 538);
    return 1;
 err:
    (ERR_new(), ERR_set_debug("../crypto/x509/x_name.c",541,__func__), ERR_set_error)((11),((7 | (0x2 << 18L))),
# 541 "../crypto/x509/x_name.c" 3 4
   ((void *)0)
# 541 "../crypto/x509/x_name.c"
   );
    CRYPTO_free(b, "../crypto/x509/x_name.c", 542);
    return 0;
}
                       ...
                       size_t *pderlen)
{
    ...
    if (i2d_X509_NAME(nm, 
# 550 "../crypto/x509/x_name.c" 3 4
                         ((void *)0)
# 550 "../crypto/x509/x_name.c"
                             ) <= 0)
        return 0;
    if (pder != 
# 552 "../crypto/x509/x_name.c" 3 4
               ((void *)0)
# 552 "../crypto/x509/x_name.c"
                   )
        *pder = (unsigned char *)nm->bytes->data;
    if (pderlen != 
# 554 "../crypto/x509/x_name.c" 3 4
                  ((void *)0)
# 554 "../crypto/x509/x_name.c"
                      )
