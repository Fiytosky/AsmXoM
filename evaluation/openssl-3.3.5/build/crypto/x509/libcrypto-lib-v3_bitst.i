# 0 "../crypto/x509/v3_bitst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_bitst.c"
# 10 "../crypto/x509/v3_bitst.c"
...
static BIT_STRING_BITNAME ns_cert_type_table[] = {
    ...
    {-1, 
# 25 "../crypto/x509/v3_bitst.c" 3 4
        ((void *)0)
# 25 "../crypto/x509/v3_bitst.c"
            , 
# 25 "../crypto/x509/v3_bitst.c" 3 4
              ((void *)0)
# 25 "../crypto/x509/v3_bitst.c"
...
static BIT_STRING_BITNAME key_usage_type_table[] = {
    ...
    {-1, 
# 38 "../crypto/x509/v3_bitst.c" 3 4
        ((void *)0)
# 38 "../crypto/x509/v3_bitst.c"
            , 
# 38 "../crypto/x509/v3_bitst.c" 3 4
              ((void *)0)
# 38 "../crypto/x509/v3_bitst.c"
...
{ 71, 0, (ASN1_BIT_STRING_it), 0,0,0,0, 0,0, (X509V3_EXT_I2V)i2v_ASN1_BIT_STRING, (X509V3_EXT_V2I)v2i_ASN1_BIT_STRING, 
# 42 "../crypto/x509/v3_bitst.c" 3 4
((void *)0)
# 42 "../crypto/x509/v3_bitst.c"
, 
# 42 "../crypto/x509/v3_bitst.c" 3 4
((void *)0)
# 42 "../crypto/x509/v3_bitst.c"
...
{ 83, 0, (ASN1_BIT_STRING_it), 0,0,0,0, 0,0, (X509V3_EXT_I2V)i2v_ASN1_BIT_STRING, (X509V3_EXT_V2I)v2i_ASN1_BIT_STRING, 
# 44 "../crypto/x509/v3_bitst.c" 3 4
((void *)0)
# 44 "../crypto/x509/v3_bitst.c"
, 
# 44 "../crypto/x509/v3_bitst.c" 3 4
((void *)0)
# 44 "../crypto/x509/v3_bitst.c"
...
# 53 "../crypto/x509/v3_bitst.c" 3 4
                                         ((void *)0)
# 53 "../crypto/x509/v3_bitst.c"
                                             , &ret);
    }
    return ret;
}
...
# 66 "../crypto/x509/v3_bitst.c" 3 4
                                       ((void *)0)
# 66 "../crypto/x509/v3_bitst.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_bitst.c",67,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 67 "../crypto/x509/v3_bitst.c" 3 4
       ((void *)0)
# 67 "../crypto/x509/v3_bitst.c"
       );
        return 
# 68 "../crypto/x509/v3_bitst.c" 3 4
              ((void *)0)
# 68 "../crypto/x509/v3_bitst.c"
                  ;
    }
        ...
        for (bnam = method->usr_data; bnam->lname; bnam++) {
            if (strcmp(bnam->sname, val->name) == 0
                ...
                if (!ASN1_BIT_STRING_set_bit(bs, bnam->bitnum, 1)) {
                    (ERR_new(), ERR_set_debug("../crypto/x509/v3_bitst.c",76,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 76 "../crypto/x509/v3_bitst.c" 3 4
                   ((void *)0)
# 76 "../crypto/x509/v3_bitst.c"
                   );
                    ASN1_BIT_STRING_free(bs);
                    return 
# 78 "../crypto/x509/v3_bitst.c" 3 4
                          ((void *)0)
# 78 "../crypto/x509/v3_bitst.c"
                              ;
                }
                break;
            }
        ...
        if (!bnam->lname) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_bitst.c",84,__func__), ERR_set_error)(34, 111,
                           "%s", val->name);
            ASN1_BIT_STRING_free(bs);
            return 
# 87 "../crypto/x509/v3_bitst.c" 3 4
                  ((void *)0)
# 87 "../crypto/x509/v3_bitst.c"
                      ;
        }
    }
    return bs;
