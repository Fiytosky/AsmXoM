# 0 "../crypto/x509/x_attrib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/x_attrib.c"
# 10 "../crypto/x509/x_attrib.c"
...
# 16 "../crypto/x509/x_attrib.c" 2
# 28 "../crypto/x509/x_attrib.c"
static const ASN1_TEMPLATE X509_ATTRIBUTE_seq_tt[] = {
        { (0), (0), 
# 29 "../crypto/x509/x_attrib.c" 3 4
       __builtin_offsetof (
# 29 "../crypto/x509/x_attrib.c"
       X509_ATTRIBUTE
# 29 "../crypto/x509/x_attrib.c" 3 4
       , 
# 29 "../crypto/x509/x_attrib.c"
...
# 29 "../crypto/x509/x_attrib.c"
       , "object", (ASN1_OBJECT_it) },
        { ((0x1 << 1)), (0), 
# 30 "../crypto/x509/x_attrib.c" 3 4
       __builtin_offsetof (
# 30 "../crypto/x509/x_attrib.c"
       X509_ATTRIBUTE
# 30 "../crypto/x509/x_attrib.c" 3 4
       , 
# 30 "../crypto/x509/x_attrib.c"
...
# 30 "../crypto/x509/x_attrib.c"
       , "set", (ASN1_ANY_it) }
} ; const ASN1_ITEM * X509_ATTRIBUTE_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_ATTRIBUTE_seq_tt, sizeof(X509_ATTRIBUTE_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 31 "../crypto/x509/x_attrib.c" 3 4
 ((void *)0)
# 31 "../crypto/x509/x_attrib.c"
 , sizeof(X509_ATTRIBUTE), "X509_ATTRIBUTE" }; return &local_it; }

X509_ATTRIBUTE *d2i_X509_ATTRIBUTE(X509_ATTRIBUTE **a, const unsigned char **in, long len) { return (X509_ATTRIBUTE *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_ATTRIBUTE_it())); } int i2d_X509_ATTRIBUTE(const X509_ATTRIBUTE *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_ATTRIBUTE_it())); } X509_ATTRIBUTE *X509_ATTRIBUTE_new(void) { return (X509_ATTRIBUTE *)ASN1_item_new((X509_ATTRIBUTE_it())); } void X509_ATTRIBUTE_free(X509_ATTRIBUTE *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_ATTRIBUTE_it())); }
X509_ATTRIBUTE * X509_ATTRIBUTE_dup(const X509_ATTRIBUTE *x) { return ASN1_item_dup((X509_ATTRIBUTE_it()), x); }

X509_ATTRIBUTE *X509_ATTRIBUTE_create(int nid, int atrtype, void *value)
{
    X509_ATTRIBUTE *ret = 
# 38 "../crypto/x509/x_attrib.c" 3 4
                         ((void *)0)
# 38 "../crypto/x509/x_attrib.c"
                             ;
    ASN1_TYPE *val = 
# 39 "../crypto/x509/x_attrib.c" 3 4
                    ((void *)0)
# 39 "../crypto/x509/x_attrib.c"
                        ;
    ASN1_OBJECT *oid;

    if ((oid = OBJ_nid2obj(nid)) == 
# 42 "../crypto/x509/x_attrib.c" 3 4
                                   ((void *)0)
# 42 "../crypto/x509/x_attrib.c"
                                       )
        return 
# 43 "../crypto/x509/x_attrib.c" 3 4
              ((void *)0)
# 43 "../crypto/x509/x_attrib.c"
                  ;
    if ((ret = X509_ATTRIBUTE_new()) == 
# 44 "../crypto/x509/x_attrib.c" 3 4
                                       ((void *)0)
# 44 "../crypto/x509/x_attrib.c"
                                           )
        return 
# 45 "../crypto/x509/x_attrib.c" 3 4
              ((void *)0)
# 45 "../crypto/x509/x_attrib.c"
                  ;
    ret->object = oid;
    if ((val = ASN1_TYPE_new()) == 
# 47 "../crypto/x509/x_attrib.c" 3 4
                                  ((void *)0)
# 47 "../crypto/x509/x_attrib.c"
                                      )
        goto err;
    if (!OPENSSL_sk_push(ossl_check_ASN1_TYPE_sk_type(ret->set), ossl_check_ASN1_TYPE_type(val)))
        goto err;
 ...
 err:
    ...
    ASN1_TYPE_free(val);
    return 
# 57 "../crypto/x509/x_attrib.c" 3 4
          ((void *)0)
# 57 "../crypto/x509/x_attrib.c"
              ;
}
