# 0 "../crypto/x509/pcy_map.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_map.c"
# 10 "../crypto/x509/pcy_map.c"
...
int ossl_policy_cache_set_mapping(X509 *x, POLICY_MAPPINGS *maps)
{
    ...
    int i;
    int ret = 0;
    if (OPENSSL_sk_num(ossl_check_const_POLICY_MAPPING_sk_type(maps)) == 0) {
        ret = -1;
        goto bad_mapping;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_POLICY_MAPPING_sk_type(maps)); i++) {
        map = ((POLICY_MAPPING *)OPENSSL_sk_value(ossl_check_const_POLICY_MAPPING_sk_type(maps), (i)));
        ...
        if (data == 
# 45 "../crypto/x509/pcy_map.c" 3 4
                   ((void *)0) 
# 45 "../crypto/x509/pcy_map.c"
                        && !cache->anyPolicy)
            continue;


        if (data == 
# 49 "../crypto/x509/pcy_map.c" 3 4
                   ((void *)0)
# 49 "../crypto/x509/pcy_map.c"
                       ) {
            data = ossl_policy_data_new(
# 50 "../crypto/x509/pcy_map.c" 3 4
                                       ((void *)0)
# 50 "../crypto/x509/pcy_map.c"
                                           , map->issuerDomainPolicy,
                                        cache->anyPolicy->flags
                                        & 0x10);
            if (data == 
# 53 "../crypto/x509/pcy_map.c" 3 4
                       ((void *)0)
# 53 "../crypto/x509/pcy_map.c"
                           )
                goto bad_mapping;
            ...
            data->flags |= 0x1;
        if (!OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(data->expected_policy_set), ossl_check_ASN1_OBJECT_type(map->subjectDomainPolicy))
                                                          )
            goto bad_mapping;
        map->subjectDomainPolicy = 
# 70 "../crypto/x509/pcy_map.c" 3 4
                                  ((void *)0)
# 70 "../crypto/x509/pcy_map.c"
                                      ;
    ...
    ret = 1;
 bad_mapping:
    OPENSSL_sk_pop_free(ossl_check_POLICY_MAPPING_sk_type(maps),ossl_check_POLICY_MAPPING_freefunc_type(POLICY_MAPPING_free));
    return ret;
