# 0 "../crypto/x509/pcy_tree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/pcy_tree.c"
# 10 "../crypto/x509/pcy_tree.c"
...
# 16 "../crypto/x509/pcy_tree.c" 2
# 28 "../crypto/x509/pcy_tree.c"
                           ...
                           int indent)
{
    if ((lev->flags & 0x400)
        ...
        struct stack_st_ASN1_OBJECT *pset = node->data->expected_policy_set;
        ASN1_OBJECT *oid;
        BIO_puts(channel, "  Expected: ");
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(pset)); i++) {
            oid = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(pset), (i)));
            if (i)
                BIO_puts(channel, ", ");
                       ...
                       X509_POLICY_LEVEL *curr)
{
    ...
    for (plev = tree->levels; plev != curr; plev++) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(plev->nodes)); i++) {
            X509_POLICY_NODE *node =
                ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(plev->nodes), (i)));
...
# 97 "../crypto/x509/pcy_tree.c"
static int tree_init(X509_POLICY_TREE **ptree, struct stack_st_X509 *certs,
                     unsigned int flags)
{
    X509_POLICY_TREE *tree;
    ...
    X509_POLICY_DATA *data = 
# 103 "../crypto/x509/pcy_tree.c" 3 4
                            ((void *)0)
# 103 "../crypto/x509/pcy_tree.c"
                                ;
    int ret = 1;
    int n = OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)) - 1;
    int explicit_policy = (flags & 0x100) ? 0 : n+1;
    int any_skip = (flags & 0x200) ? 0 : n+1;
    int map_skip = (flags & 0x400) ? 0 : n+1;
    int i;

    *ptree = 
# 111 "../crypto/x509/pcy_tree.c" 3 4
            ((void *)0)
# 111 "../crypto/x509/pcy_tree.c"
                ;
    ...
    for (i = n - 1; i >= 0; i--) {
        ...
        if (ossl_policy_cache_set(x) == 
# 129 "../crypto/x509/pcy_tree.c" 3 4
                                       ((void *)0)
# 129 "../crypto/x509/pcy_tree.c"
                                           )
            return 0;
    }
# 144 "../crypto/x509/pcy_tree.c"
    for (i = n - 1;
         i >= 0 && (explicit_policy > 0 || (ret & 2) == 0);
         i--) {
        X509 *x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));
        ...
        if ((ret & 1) && cache->data == 
# 157 "../crypto/x509/pcy_tree.c" 3 4
                                                         ((void *)0)
# 157 "../crypto/x509/pcy_tree.c"
                                                             )
            ret = 2;
    ...
    if ((tree = CRYPTO_zalloc(sizeof(*tree), "../crypto/x509/pcy_tree.c", 174)) == 
# 174 "../crypto/x509/pcy_tree.c" 3 4
                                                 ((void *)0)
# 174 "../crypto/x509/pcy_tree.c"
                                                     )
        return 0;


    tree->node_maximum = 1000;
# 187 "../crypto/x509/pcy_tree.c"
    if ((tree->levels = CRYPTO_zalloc(sizeof(*tree->levels)*(n+1), "../crypto/x509/pcy_tree.c", 187)) == 
# 187 "../crypto/x509/pcy_tree.c" 3 4
                                                                       ((void *)0)
# 187 "../crypto/x509/pcy_tree.c"
                                                                           ) {
        CRYPTO_free(tree, "../crypto/x509/pcy_tree.c", 188);
        return 0;
    }
    tree->nlevel = n+1;
    level = tree->levels;
    if ((data = ossl_policy_data_new(
# 193 "../crypto/x509/pcy_tree.c" 3 4
                                    ((void *)0)
# 193 "../crypto/x509/pcy_tree.c"
                                        ,
                                     OBJ_nid2obj(746), 0)) == 
# 194 "../crypto/x509/pcy_tree.c" 3 4
                                                                        ((void *)0)
# 194 "../crypto/x509/pcy_tree.c"
                                                                            )
        goto bad_tree;
    if (ossl_policy_level_add_node(level, data, 
# 196 "../crypto/x509/pcy_tree.c" 3 4
                                               ((void *)0)
# 196 "../crypto/x509/pcy_tree.c"
                                                   , tree, 1) == 
# 196 "../crypto/x509/pcy_tree.c" 3 4
                                                                 ((void *)0)
# 196 "../crypto/x509/pcy_tree.c"
                                    ...
                                    X509_POLICY_TREE *tree)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(last->nodes)); i++) {
        X509_POLICY_NODE *node = ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(last->nodes), (i)));

        if (ossl_policy_node_match(last, node, data->valid_policy)) {
            if (ossl_policy_level_add_node(curr, data, node, tree, 0) == 
# 266 "../crypto/x509/pcy_tree.c" 3 4
                                                                        ((void *)0)
# 266 "../crypto/x509/pcy_tree.c"
                                                                            )
                return 0;
            matched = 1;
        }
...
# 272 "../crypto/x509/pcy_tree.c" 3 4
                                                                               ((void *)0)
# 272 "../crypto/x509/pcy_tree.c"
                                                                                   )
            return 0;
    }
    return 1;
                              ...
                              X509_POLICY_NODE *node, X509_POLICY_TREE *tree)
{
    ...
    if (id == 
# 313 "../crypto/x509/pcy_tree.c" 3 4
             ((void *)0)
# 313 "../crypto/x509/pcy_tree.c"
                 )
    ...
    if ((data = ossl_policy_data_new(
# 319 "../crypto/x509/pcy_tree.c" 3 4
                                    ((void *)0)
# 319 "../crypto/x509/pcy_tree.c"
...
# 319 "../crypto/x509/pcy_tree.c"
    ...
    data->flags |= 0x4;
    if (ossl_policy_level_add_node(curr, data, node, tree, 1) == 
# 325 "../crypto/x509/pcy_tree.c" 3 4
                                                                ((void *)0)
# 325 "../crypto/x509/pcy_tree.c"
                                                                    ) {
        ossl_policy_data_free(data);
        return 0;
    }
...
# 347 "../crypto/x509/pcy_tree.c" 3 4
                                            ((void *)0)
# 347 "../crypto/x509/pcy_tree.c"
                                                , node, tree))
            return 0;
        ...
        if (node->nchild == OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(expset)))
            return 1;

        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(expset)); i++) {
            ASN1_OBJECT *oid = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(expset), (i)));
                         ...
                         X509_POLICY_TREE *tree)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(last->nodes)); i++) {
        node = ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(last->nodes), (i)));
...
# 388 "../crypto/x509/pcy_tree.c" 3 4
                                                                   ((void *)0)
# 388 "../crypto/x509/pcy_tree.c"
                                                                       )
        return 0;
    return 1;
}
# 403 "../crypto/x509/pcy_tree.c"
static int tree_prune(X509_POLICY_TREE *tree, X509_POLICY_LEVEL *curr)
{
    ...
    nodes = curr->nodes;
    if (curr->flags & 0x400) {
        for (i = OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(nodes)) - 1; i >= 0; i--) {
            node = ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(nodes), (i)));

            if (node->data->flags & 0x3) {
                node->parent->nchild--;
                CRYPTO_free(node, "../crypto/x509/pcy_tree.c", 415);
                (void)((X509_POLICY_NODE *)OPENSSL_sk_delete(ossl_check_X509_POLICY_NODE_sk_type(nodes), (i)));
            }
        }
    }
    ...
    for (;;) {
        ...
        for (i = OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(nodes)) - 1; i >= 0; i--) {
            ...
            if (node->nchild == 0) {
                node->parent->nchild--;
                CRYPTO_free(node, "../crypto/x509/pcy_tree.c", 428);
                (void)((X509_POLICY_NODE *)OPENSSL_sk_delete(ossl_check_X509_POLICY_NODE_sk_type(nodes), (i)));
            }
        }
        if (curr->anyPolicy && !curr->anyPolicy->nchild) {
            ...
            CRYPTO_free(curr->anyPolicy, "../crypto/x509/pcy_tree.c", 435);
            curr->anyPolicy = 
# 436 "../crypto/x509/pcy_tree.c" 3 4
                             ((void *)0)
# 436 "../crypto/x509/pcy_tree.c"
                                 ;
        }
        if (curr == tree->levels) {
...
static int tree_add_auth_node(struct stack_st_X509_POLICY_NODE **pnodes,
                              X509_POLICY_NODE *pcy)
{
    if (*pnodes == 
# 454 "../crypto/x509/pcy_tree.c" 3 4
                  ((void *)0) 
# 454 "../crypto/x509/pcy_tree.c"
                       &&
        (*pnodes = ossl_policy_node_cmp_new()) == 
# 455 "../crypto/x509/pcy_tree.c" 3 4
                                                 ((void *)0)
# 455 "../crypto/x509/pcy_tree.c"
                                                     )
        return 0;
    if (OPENSSL_sk_find(ossl_check_X509_POLICY_NODE_sk_type(*pnodes), ossl_check_X509_POLICY_NODE_type(pcy)) >= 0)
        return 1;
    return OPENSSL_sk_push(ossl_check_X509_POLICY_NODE_sk_type(*pnodes), ossl_check_X509_POLICY_NODE_type(pcy)) != 0;
}
# 478 "../crypto/x509/pcy_tree.c"
...
# 502 "../crypto/x509/pcy_tree.c" 3 4
                                         ((void *)0)
# 502 "../crypto/x509/pcy_tree.c"
                                             )
            break;
        curr++;
        for (j = 0; j < OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(curr->nodes)); j++) {
            node = ((X509_POLICY_NODE *)OPENSSL_sk_value(ossl_check_const_X509_POLICY_NODE_sk_type(curr->nodes), (j)));
            if ((node->parent == anyptr)
                && !tree_add_auth_node(addnodes, node)) {
                if (addnodes == pnodes) {
                    OPENSSL_sk_free(ossl_check_X509_POLICY_NODE_sk_type(*pnodes));
                    *pnodes = 
# 511 "../crypto/x509/pcy_tree.c" 3 4
                             ((void *)0)
# 511 "../crypto/x509/pcy_tree.c"
                                 ;
                }
                return 0;
            }
...
static int tree_calculate_user_set(X509_POLICY_TREE *tree,
                                   ...
                                   struct stack_st_X509_POLICY_NODE *auth_nodes)
{
    int i;
    X509_POLICY_NODE *node;
    ASN1_OBJECT *oid;
    ...
    if (OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(policy_oids)) <= 0)
        return 1;

    anyPolicy = tree->levels[tree->nlevel - 1].anyPolicy;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(policy_oids)); i++) {
        oid = ((ASN1_OBJECT *)OPENSSL_sk_value(ossl_check_const_ASN1_OBJECT_sk_type(policy_oids), (i)));
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_OBJECT_sk_type(policy_oids)); i++) {
        ...
        if (!node) {
            ...
            extra = ossl_policy_data_new(
# 564 "../crypto/x509/pcy_tree.c" 3 4
                                        ((void *)0)
# 564 "../crypto/x509/pcy_tree.c"
                                            , oid, (anyPolicy->data->flags & 0x10));
            if (extra == 
# 565 "../crypto/x509/pcy_tree.c" 3 4
                        ((void *)0)
# 565 "../crypto/x509/pcy_tree.c"
                            )
                return 0;
            extra->qualifier_set = anyPolicy->data->qualifier_set;
            extra->flags = 0x4
                | 0x8;
            node = ossl_policy_level_add_node(
# 570 "../crypto/x509/pcy_tree.c" 3 4
                                             ((void *)0)
# 570 "../crypto/x509/pcy_tree.c"
                                                 , extra, anyPolicy->parent,
                                              tree, 1);
            if (node == 
# 572 "../crypto/x509/pcy_tree.c" 3 4
                       ((void *)0)
# 572 "../crypto/x509/pcy_tree.c"
                           ) {
        ...
        if (!tree->user_policies) {
            tree->user_policies = ((struct stack_st_X509_POLICY_NODE *)OPENSSL_sk_new_null());
            if (!tree->user_policies) {
                exnode_free(node);
                return 0;
            }
        }
        if (!OPENSSL_sk_push(ossl_check_X509_POLICY_NODE_sk_type(tree->user_policies), ossl_check_X509_POLICY_NODE_type(node))) {
            exnode_free(node);
            return 0;
        }
    }
...
static int tree_evaluate(X509_POLICY_TREE *tree)
{
    ...
    for (i = 1; i < tree->nlevel; i++, curr++) {
        ...
        if (!(curr->flags & 0x200)
            ...
            return 0;
        do { BIO *trc_out = 
# 612 "../crypto/x509/pcy_tree.c" 3 4
       ((void *)0)
# 612 "../crypto/x509/pcy_tree.c"
       ; if (0) { tree_print(trc_out, "before tree_prune()", tree, curr); } } while(0);
...
static void exnode_free(X509_POLICY_NODE *node)
{
    if (node->data && (node->data->flags & 0x8))
        CRYPTO_free(node, "../crypto/x509/pcy_tree.c", 623);
}
...
void X509_policy_tree_free(X509_POLICY_TREE *tree)
{
    ...
    OPENSSL_sk_free(ossl_check_X509_POLICY_NODE_sk_type(tree->auth_policies));
    OPENSSL_sk_pop_free(ossl_check_X509_POLICY_NODE_sk_type(tree->user_policies),ossl_check_X509_POLICY_NODE_freefunc_type(exnode_free));

    for (i = 0, curr = tree->levels; i < tree->nlevel; i++, curr++) {
        X509_free(curr->cert);
        OPENSSL_sk_pop_free(ossl_check_X509_POLICY_NODE_sk_type(curr->nodes),ossl_check_X509_POLICY_NODE_freefunc_type(ossl_policy_node_free));
        ossl_policy_node_free(curr->anyPolicy);
    }

    sk_X509_POLICY_DATA_pop_free(tree->extra_data, ossl_policy_data_free);
    CRYPTO_free(tree->levels, "../crypto/x509/pcy_tree.c", 644);
    CRYPTO_free(tree, "../crypto/x509/pcy_tree.c", 645);

}
# 657 "../crypto/x509/pcy_tree.c"
int X509_policy_check(X509_POLICY_TREE **ptree, int *pexplicit_policy,
                      struct stack_st_X509 *certs,
                      struct stack_st_ASN1_OBJECT *policy_oids, unsigned int flags)
{
    ...
    int calc_ret;
    X509_POLICY_TREE *tree = 
# 664 "../crypto/x509/pcy_tree.c" 3 4
                            ((void *)0)
# 664 "../crypto/x509/pcy_tree.c"
                                ;
    struct stack_st_X509_POLICY_NODE *nodes, *auth_nodes = 
# 665 "../crypto/x509/pcy_tree.c" 3 4
                                                    ((void *)0)
# 665 "../crypto/x509/pcy_tree.c"
                                                        ;

    *ptree = 
# 667 "../crypto/x509/pcy_tree.c" 3 4
            ((void *)0)
# 667 "../crypto/x509/pcy_tree.c"
                ;
    *pexplicit_policy = 0;
    ...
    do { BIO *trc_out = 
# 687 "../crypto/x509/pcy_tree.c" 3 4
   ((void *)0)
# 687 "../crypto/x509/pcy_tree.c"
   ; if (0) { tree_print(trc_out, "before tree_prune()", tree, 
# 687 "../crypto/x509/pcy_tree.c" 3 4
   ((void *)0)
# 687 "../crypto/x509/pcy_tree.c"
   ); } } while(0);
    ...
    if ((calc_ret = tree_calculate_authority_set(tree, &auth_nodes)) == 0)
        goto error;
    OPENSSL_sk_sort(ossl_check_X509_POLICY_NODE_sk_type(auth_nodes));
    ret = tree_calculate_user_set(tree, policy_oids, auth_nodes);
    if (calc_ret == 2)
        OPENSSL_sk_free(ossl_check_X509_POLICY_NODE_sk_type(auth_nodes));
    if (!ret)
        goto error;
    ...
    *ptree = tree;
    ...
    if (init_ret & 4) {
        ...
        if (OPENSSL_sk_num(ossl_check_const_X509_POLICY_NODE_sk_type(nodes)) <= 0)
            return -2;
    }
    return 1;
