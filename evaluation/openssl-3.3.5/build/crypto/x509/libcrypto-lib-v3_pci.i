# 0 "../crypto/x509/v3_pci.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_pci.c"
# 46 "../crypto/x509/v3_pci.c"
...
const X509V3_EXT_METHOD ossl_v3_pci =
    { 663, 0, (PROXY_CERT_INFO_EXTENSION_it),
    0, 0, 0, 0,
    0, 0,
    
# 61 "../crypto/x509/v3_pci.c" 3 4
   ((void *)0)
# 61 "../crypto/x509/v3_pci.c"
       , 
# 61 "../crypto/x509/v3_pci.c" 3 4
         ((void *)0)
# 61 "../crypto/x509/v3_pci.c"
...
# 64 "../crypto/x509/v3_pci.c" 3 4
   ((void *)0)
# 64 "../crypto/x509/v3_pci.c"
       ,
};
                             ...
                             ASN1_OCTET_STRING **policy)
{
    ...
    if (strcmp(val->name, "language") == 0) {
        if (*language) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",93,__func__), ERR_set_error)((34),(155),
# 93 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 93 "../crypto/x509/v3_pci.c"
           );
            ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
            return 0;
        }
        if ((*language = OBJ_txt2obj(val->value, 0)) == 
# 97 "../crypto/x509/v3_pci.c" 3 4
                                                       ((void *)0)
# 97 "../crypto/x509/v3_pci.c"
                                                           ) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",98,__func__), ERR_set_error)((34),(110),
# 98 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 98 "../crypto/x509/v3_pci.c"
           );
            ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
            return 0;
        }
        ...
        if (*pathlen) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",104,__func__), ERR_set_error)((34),(157),
# 104 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 104 "../crypto/x509/v3_pci.c"
           )
                                                                  ;
            ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
            return 0;
        ...
        if (!X509V3_get_value_int(val, pathlen)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",110,__func__), ERR_set_error)((34),(156),
# 110 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 110 "../crypto/x509/v3_pci.c"
           );
            ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
            return 0;
        }
...
# 116 "../crypto/x509/v3_pci.c" 3 4
                                 ((void *)0)
# 116 "../crypto/x509/v3_pci.c"
                                     ;
        long val_len;

        if (*policy == 
# 119 "../crypto/x509/v3_pci.c" 3 4
                      ((void *)0)
# 119 "../crypto/x509/v3_pci.c"
                          ) {
            *policy = ASN1_OCTET_STRING_new();
            if (*policy == 
# 121 "../crypto/x509/v3_pci.c" 3 4
                          ((void *)0)
# 121 "../crypto/x509/v3_pci.c"
                              ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",122,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 122 "../crypto/x509/v3_pci.c" 3 4
               ((void *)0)
# 122 "../crypto/x509/v3_pci.c"
               );
                ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                return 0;
            }
        ...
        if (((strncmp(valp, "hex:" "", sizeof("hex:") - 1) == 0) ? ((valp) += sizeof("hex:") - 1, 1) : 0)) {
            ...
            tmp_data = CRYPTO_realloc((*policy)->data, (*policy)->length + val_len + 1, "../crypto/x509/v3_pci.c", 137)
                                                                       ;
            if (tmp_data) {
                ...
                CRYPTO_free(tmp_data2, "../crypto/x509/v3_pci.c", 146);




                CRYPTO_free((*policy)->data, "../crypto/x509/v3_pci.c", 151);
                (*policy)->data = 
# 152 "../crypto/x509/v3_pci.c" 3 4
                                 ((void *)0)
# 152 "../crypto/x509/v3_pci.c"
                                     ;
                (*policy)->length = 0;
                ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                goto err;
            }
            CRYPTO_free(tmp_data2, "../crypto/x509/v3_pci.c", 157);
        } else if (((strncmp(valp, "file:" "", sizeof("file:") - 1) == 0) ? ((valp) += sizeof("file:") - 1, 1) : 0)) {
            unsigned char buf[2048];
            int n;
            BIO *b = BIO_new_file(valp, "r");
            if (!b) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",163,__func__), ERR_set_error)((34),((32 | (0x2 << 18L))),
# 163 "../crypto/x509/v3_pci.c" 3 4
               ((void *)0)
# 163 "../crypto/x509/v3_pci.c"
               );
                ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                goto err;
            }
            while ((n = BIO_read(b, buf, sizeof(buf))) > 0
                ...
                tmp_data = CRYPTO_realloc((*policy)->data, (*policy)->length + n + 1, "../crypto/x509/v3_pci.c", 172)
                                                                     ;

                if (!tmp_data) {
                    CRYPTO_free((*policy)->data, "../crypto/x509/v3_pci.c", 176);
                    (*policy)->data = 
# 177 "../crypto/x509/v3_pci.c" 3 4
                                     ((void *)0)
# 177 "../crypto/x509/v3_pci.c"
                                         ;
                    (*policy)->length = 0;
                    ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                    BIO_free_all(b);
            ...
            if (n < 0) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",192,__func__), ERR_set_error)((34),((32 | (0x2 << 18L))),
# 192 "../crypto/x509/v3_pci.c" 3 4
               ((void *)0)
# 192 "../crypto/x509/v3_pci.c"
               );
                ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                goto err;
            }
        } else if (((strncmp(valp, "text:" "", sizeof("text:") - 1) == 0) ? ((valp) += sizeof("text:") - 1, 1) : 0)) {
            val_len = strlen(valp);
            tmp_data = CRYPTO_realloc((*policy)->data, (*policy)->length + val_len + 1, "../crypto/x509/v3_pci.c", 198)
                                                                       ;
            if (tmp_data) {
                (*policy)->data = tmp_data;
                memcpy(&(*policy)->data[(*policy)->length],
                ...
                CRYPTO_free((*policy)->data, "../crypto/x509/v3_pci.c", 211);
                (*policy)->data = 
# 212 "../crypto/x509/v3_pci.c" 3 4
                                 ((void *)0)
# 212 "../crypto/x509/v3_pci.c"
                                     ;
                (*policy)->length = 0;
                ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
                goto err;
            ...
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",218,__func__), ERR_set_error)((34),(152),
# 218 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 218 "../crypto/x509/v3_pci.c"
           );
            ERR_add_error_data(6, "section:", (val)->section, ",name:", (val)->name, ",value:", (val)->value);
            goto err;
        }
 ...
 err:
    if (free_policy) {
        ...
        *policy = 
# 231 "../crypto/x509/v3_pci.c" 3 4
                 ((void *)0)
# 231 "../crypto/x509/v3_pci.c"
                     ;
    }
    return 0;
}
...
# 239 "../crypto/x509/v3_pci.c" 3 4
                                    ((void *)0)
# 239 "../crypto/x509/v3_pci.c"
                                        ;
    struct stack_st_CONF_VALUE *vals;
    ASN1_OBJECT *language = 
# 241 "../crypto/x509/v3_pci.c" 3 4
                           ((void *)0)
# 241 "../crypto/x509/v3_pci.c"
                               ;
    ASN1_INTEGER *pathlen = 
# 242 "../crypto/x509/v3_pci.c" 3 4
                           ((void *)0)
# 242 "../crypto/x509/v3_pci.c"
                               ;
    ASN1_OCTET_STRING *policy = 
# 243 "../crypto/x509/v3_pci.c" 3 4
                               ((void *)0)
# 243 "../crypto/x509/v3_pci.c"
                                   ;
    int i, j;

    vals = X509V3_parse_list(value);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(vals)); i++) {
        CONF_VALUE *cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(vals), (i)));

        if (!cnf->name || (*cnf->name != '@' && !cnf->value)) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",251,__func__), ERR_set_error)((34),(153),
# 251 "../crypto/x509/v3_pci.c" 3 4
           ((void *)0)
# 251 "../crypto/x509/v3_pci.c"
           );
        ...
        if (*cnf->name == '@') {
            ...
            if (!sect) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",261,__func__), ERR_set_error)((34),(135),
# 261 "../crypto/x509/v3_pci.c" 3 4
               ((void *)0)
# 261 "../crypto/x509/v3_pci.c"
               );
                ERR_add_error_data(6, "section:", (cnf)->section, ",name:", (cnf)->name, ",value:", (cnf)->value);
                goto err;
            }
            for (j = 0; success_p && j < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sect)); j++) {
                success_p =
                    process_pci_value(((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sect), (j))),
    ...
    if (!language) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",283,__func__), ERR_set_error)((34),(154),
# 283 "../crypto/x509/v3_pci.c" 3 4
       ((void *)0)
# 283 "../crypto/x509/v3_pci.c"
       )
                                                                 ;
        goto err;
    }
    ...
    if ((i == 667 || i == 665) && policy) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",289,__func__), ERR_set_error)((34),(159),
# 289 "../crypto/x509/v3_pci.c" 3 4
       ((void *)0)
# 289 "../crypto/x509/v3_pci.c"
       )
                                                                         ;
        goto err;
    }
    ...
    if (pci == 
# 295 "../crypto/x509/v3_pci.c" 3 4
              ((void *)0)
# 295 "../crypto/x509/v3_pci.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_pci.c",296,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 296 "../crypto/x509/v3_pci.c" 3 4
       ((void *)0)
# 296 "../crypto/x509/v3_pci.c"
       );
        goto err;
    }
    ...
    language = 
# 301 "../crypto/x509/v3_pci.c" 3 4
              ((void *)0)
# 301 "../crypto/x509/v3_pci.c"
                  ;
    pci->proxyPolicy->policy = policy;
    policy = 
# 303 "../crypto/x509/v3_pci.c" 3 4
            ((void *)0)
# 303 "../crypto/x509/v3_pci.c"
                ;
    pci->pcPathLengthConstraint = pathlen;
    pathlen = 
# 305 "../crypto/x509/v3_pci.c" 3 4
             ((void *)0)
# 305 "../crypto/x509/v3_pci.c"
                 ;
    goto end;
 err:
    ...
    pathlen = 
# 310 "../crypto/x509/v3_pci.c" 3 4
             ((void *)0)
# 310 "../crypto/x509/v3_pci.c"
                 ;
    ASN1_OCTET_STRING_free(policy);
    policy = 
# 312 "../crypto/x509/v3_pci.c" 3 4
            ((void *)0)
# 312 "../crypto/x509/v3_pci.c"
                ;
    PROXY_CERT_INFO_EXTENSION_free(pci);
    pci = 
# 314 "../crypto/x509/v3_pci.c" 3 4
         ((void *)0)
# 314 "../crypto/x509/v3_pci.c"
             ;
 end:
