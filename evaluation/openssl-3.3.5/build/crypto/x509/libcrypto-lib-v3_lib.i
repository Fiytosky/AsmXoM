# 0 "../crypto/x509/v3_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_lib.c"
# 12 "../crypto/x509/v3_lib.c"
...
# 18 "../crypto/x509/v3_lib.c" 2

static struct stack_st_X509V3_EXT_METHOD *ext_list = 
# 19 "../crypto/x509/v3_lib.c" 3 4
                                              ((void *)0)
# 19 "../crypto/x509/v3_lib.c"
                                                  ;
...
{
    if (ext_list == 
# 27 "../crypto/x509/v3_lib.c" 3 4
                   ((void *)0)
        
# 28 "../crypto/x509/v3_lib.c"
       && (ext_list = ((struct stack_st_X509V3_EXT_METHOD *)OPENSSL_sk_new(ossl_check_X509V3_EXT_METHOD_compfunc_type(ext_cmp)))) == 
# 28 "../crypto/x509/v3_lib.c" 3 4
                                                            ((void *)0)
# 28 "../crypto/x509/v3_lib.c"
                                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_lib.c",29,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 29 "../crypto/x509/v3_lib.c" 3 4
       ((void *)0)
# 29 "../crypto/x509/v3_lib.c"
       );
        return 0;
    }
    if (!OPENSSL_sk_push(ossl_check_X509V3_EXT_METHOD_sk_type(ext_list), ossl_check_X509V3_EXT_METHOD_type(ext))) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_lib.c",33,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 33 "../crypto/x509/v3_lib.c" 3 4
       ((void *)0)
# 33 "../crypto/x509/v3_lib.c"
       );
        return 0;
    }
    return 1;
...
# 1 "../crypto/x509/standard_exts.h" 1
# 15 "../crypto/x509/standard_exts.h"
...
const X509V3_EXT_METHOD *X509V3_EXT_get_nid(int nid)
{
    ...
    if (nid < 0)
        return 
# 59 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 59 "../crypto/x509/v3_lib.c"
                  ;
    tmp.ext_nid = nid;
    ret = OBJ_bsearch_ext(&t, standard_exts, (sizeof(standard_exts)/sizeof((standard_exts)[0])));
    if (ret)
        return *ret;
    if (!ext_list)
        return 
# 65 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 65 "../crypto/x509/v3_lib.c"
                  ;

    OPENSSL_sk_sort(ossl_check_X509V3_EXT_METHOD_sk_type(ext_list));
    idx = OPENSSL_sk_find(ossl_check_X509V3_EXT_METHOD_sk_type(ext_list), ossl_check_X509V3_EXT_METHOD_type(&tmp));

    return ((X509V3_EXT_METHOD *)OPENSSL_sk_value(ossl_check_const_X509V3_EXT_METHOD_sk_type(ext_list), (idx)));
}

const X509V3_EXT_METHOD *X509V3_EXT_get(X509_EXTENSION *ext)
{
    int nid;
    if ((nid = OBJ_obj2nid(X509_EXTENSION_get_object(ext))) == 0)
        return 
# 77 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 77 "../crypto/x509/v3_lib.c"
                  ;
...
# 94 "../crypto/x509/v3_lib.c" 3 4
                                               ((void *)0)
# 94 "../crypto/x509/v3_lib.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_lib.c",95,__func__), ERR_set_error)((34),(102),
# 95 "../crypto/x509/v3_lib.c" 3 4
       ((void *)0)
# 95 "../crypto/x509/v3_lib.c"
       );
        return 0;
    }
    if ((tmpext = CRYPTO_malloc(sizeof(*tmpext), "../crypto/x509/v3_lib.c", 98)) == 
# 98 "../crypto/x509/v3_lib.c" 3 4
                                                     ((void *)0)
# 98 "../crypto/x509/v3_lib.c"
                                                         )
        return 0;
    *tmpext = *ext;
    ...
    if (!X509V3_EXT_add(tmpext)) {
        CRYPTO_free(tmpext, "../crypto/x509/v3_lib.c", 104);
        return 0;
    }
    return 1;
}
...
void X509V3_EXT_cleanup(void)
{
    OPENSSL_sk_pop_free(ossl_check_X509V3_EXT_METHOD_sk_type(ext_list),ossl_check_X509V3_EXT_METHOD_freefunc_type(ext_list_free));
    ext_list = 
# 113 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 113 "../crypto/x509/v3_lib.c"
                  ;
}
...
static void ext_list_free(X509V3_EXT_METHOD *ext)
{
    if (ext->ext_flags & 0x1)
        CRYPTO_free(ext, "../crypto/x509/v3_lib.c", 119);
}
...
# 141 "../crypto/x509/v3_lib.c" 3 4
                                         ((void *)0)
# 141 "../crypto/x509/v3_lib.c"
                                             )
        return 
# 142 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 142 "../crypto/x509/v3_lib.c"
                  ;
...
# 147 "../crypto/x509/v3_lib.c" 3 4
                            ((void *)0)
# 147 "../crypto/x509/v3_lib.c"
                                , &p, extlen, (method->it()));
    return method->d2i(
# 148 "../crypto/x509/v3_lib.c" 3 4
                      ((void *)0)
# 148 "../crypto/x509/v3_lib.c"
                          , &p, extlen);
}
# 167 "../crypto/x509/v3_lib.c"
void *X509V3_get_d2i(const struct stack_st_X509_EXTENSION *x, int nid, int *crit,
                     int *idx)
{
    int lastpos, i;
    X509_EXTENSION *ex, *found_ex = 
# 171 "../crypto/x509/v3_lib.c" 3 4
                                   ((void *)0)
# 171 "../crypto/x509/v3_lib.c"
                                       ;
    ...
    if (!x) {
        ...
        if (crit)
            *crit = -1;
        return 
# 178 "../crypto/x509/v3_lib.c" 3 4
              ((void *)0)
# 178 "../crypto/x509/v3_lib.c"
                  ;
    }
    if (idx)
        lastpos = *idx + 1;
    ...
    if (lastpos < 0)
        lastpos = 0;
    for (i = lastpos; i < OPENSSL_sk_num(ossl_check_const_X509_EXTENSION_sk_type(x)); i++) {
        ex = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(x), (i)));
            ...
            if (idx) {
                *idx = i;
                ...
                if (crit)
                    *crit = -2;
                return 
# 197 "../crypto/x509/v3_lib.c" 3 4
                      ((void *)0)
# 197 "../crypto/x509/v3_lib.c"
                          ;
            }
            found_ex = ex;
        }
    ...
    if (crit)
        *crit = -1;
    return 
# 214 "../crypto/x509/v3_lib.c" 3 4
          ((void *)0)
# 214 "../crypto/x509/v3_lib.c"
              ;
}
                    ...
                    int crit, unsigned long flags)
{
    ...
    X509_EXTENSION *ext = 
# 227 "../crypto/x509/v3_lib.c" 3 4
                         ((void *)0)
# 227 "../crypto/x509/v3_lib.c"
                             , *extmp;
    struct stack_st_X509_EXTENSION *ret = 
# 228 "../crypto/x509/v3_lib.c" 3 4
                                   ((void *)0)
# 228 "../crypto/x509/v3_lib.c"
                                       ;
    ...
    if (extidx >= 0) {
        ...
        if (ext_op == 5L) {
            extmp = ((X509_EXTENSION *)OPENSSL_sk_delete(ossl_check_X509_EXTENSION_sk_type(*x), (extidx)));
            if (extmp == 
# 251 "../crypto/x509/v3_lib.c" 3 4
                        ((void *)0)
# 251 "../crypto/x509/v3_lib.c"
                            )
                return -1;
    ...
    if (!ext) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_lib.c",275,__func__), ERR_set_error)((34),(144),
# 275 "../crypto/x509/v3_lib.c" 3 4
       ((void *)0)
# 275 "../crypto/x509/v3_lib.c"
       );
        return 0;
    }
    ...
    if (extidx >= 0) {
        extmp = ((X509_EXTENSION *)OPENSSL_sk_value(ossl_check_const_X509_EXTENSION_sk_type(*x), (extidx)));
        X509_EXTENSION_free(extmp);
        if (!((X509_EXTENSION *)OPENSSL_sk_set(ossl_check_X509_EXTENSION_sk_type(*x), (extidx), ossl_check_X509_EXTENSION_type(ext))))
            return -1;
        return 1;
    }
    ...
    ret = *x;
    if (*x == 
# 289 "../crypto/x509/v3_lib.c" 3 4
             ((void *)0)
        
# 290 "../crypto/x509/v3_lib.c"
       && (ret = ((struct stack_st_X509_EXTENSION *)OPENSSL_sk_new_null())) == 
# 290 "../crypto/x509/v3_lib.c" 3 4
                                                  ((void *)0)
# 290 "../crypto/x509/v3_lib.c"
                                                      )
        goto m_fail;
    if (!OPENSSL_sk_push(ossl_check_X509_EXTENSION_sk_type(ret), ossl_check_X509_EXTENSION_type(ext)))
        goto m_fail;
 ...
 m_fail:
    ...
    if (ret != *x)
        OPENSSL_sk_free(ossl_check_X509_EXTENSION_sk_type(ret));
    X509_EXTENSION_free(ext);
    return -1;

 err:
    if (!(flags & 0x10))
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_lib.c",307,__func__), ERR_set_error)((34),(errcode),
# 307 "../crypto/x509/v3_lib.c" 3 4
       ((void *)0)
# 307 "../crypto/x509/v3_lib.c"
       );
    return 0;
}
