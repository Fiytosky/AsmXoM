# 0 "../crypto/x509/v3_crld.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/x509/v3_crld.c"
# 10 "../crypto/x509/v3_crld.c"
...
# 33 "../crypto/x509/v3_crld.c" 3 4
   ((void *)0)

# 34 "../crypto/x509/v3_crld.c"
};

const X509V3_EXT_METHOD ossl_v3_freshest_crl = {
    857, 0, (CRL_DIST_POINTS_it),
    0, 0, 0, 0,
    0, 0,
    0,
    v2i_crld,
...
# 43 "../crypto/x509/v3_crld.c" 3 4
   ((void *)0)

# 44 "../crypto/x509/v3_crld.c"
};

static struct stack_st_GENERAL_NAME *gnames_from_sectname(X509V3_CTX *ctx,
                                                    char *sect)
{
    ...
    if (!gnsect) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",56,__func__), ERR_set_error)((34),(150),
# 56 "../crypto/x509/v3_crld.c" 3 4
       ((void *)0)
# 56 "../crypto/x509/v3_crld.c"
       );
        return 
# 57 "../crypto/x509/v3_crld.c" 3 4
              ((void *)0)
# 57 "../crypto/x509/v3_crld.c"
                  ;
    }
    gens = v2i_GENERAL_NAMES(
# 59 "../crypto/x509/v3_crld.c" 3 4
                            ((void *)0)
# 59 "../crypto/x509/v3_crld.c"
                                , ctx, gnsect);
    if (*sect == '@')
        X509V3_section_free(ctx, gnsect);
    else
        OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(gnsect),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return gens;
}
...
# 70 "../crypto/x509/v3_crld.c" 3 4
                                 ((void *)0)
# 70 "../crypto/x509/v3_crld.c"
                                     ;
    struct stack_st_X509_NAME_ENTRY *rnm = 
# 71 "../crypto/x509/v3_crld.c" 3 4
                                    ((void *)0)
# 71 "../crypto/x509/v3_crld.c"
                                        ;

    if (cnf->value == 
# 73 "../crypto/x509/v3_crld.c" 3 4
                     ((void *)0)
# 73 "../crypto/x509/v3_crld.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",74,__func__), ERR_set_error)((34),(124),
# 74 "../crypto/x509/v3_crld.c" 3 4
       ((void *)0)
# 74 "../crypto/x509/v3_crld.c"
       );
        goto err;
    }

    if ((strncmp(cnf->name, "fullname" "", sizeof("fullname") - 1) == 0)) {
        ...
        nm = X509_NAME_new();
        if (nm == 
# 87 "../crypto/x509/v3_crld.c" 3 4
                 ((void *)0)
# 87 "../crypto/x509/v3_crld.c"
                     )
            return -1;
        dnsect = X509V3_get_section(ctx, cnf->value);
        if (!dnsect) {
            X509_NAME_free(nm);
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",92,__func__), ERR_set_error)((34),(150),
# 92 "../crypto/x509/v3_crld.c" 3 4
           ((void *)0)
# 92 "../crypto/x509/v3_crld.c"
           );
            return -1;
        }
        ...
        rnm = nm->entries;
        nm->entries = 
# 98 "../crypto/x509/v3_crld.c" 3 4
                     ((void *)0)
# 98 "../crypto/x509/v3_crld.c"
                         ;
        X509_NAME_free(nm);
        if (!ret || OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(rnm)) <= 0)
            goto err;



        if (((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(rnm), (OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(rnm)) - 1)))
                                                                     ->set) {
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",107,__func__), ERR_set_error)((34),(161),
# 107 "../crypto/x509/v3_crld.c" 3 4
           ((void *)0)
# 107 "../crypto/x509/v3_crld.c"
           );
            goto err;
        }
    } else
    ...
    if (*pdp) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",114,__func__), ERR_set_error)((34),(160),
# 114 "../crypto/x509/v3_crld.c" 3 4
       ((void *)0)
# 114 "../crypto/x509/v3_crld.c"
       );
        goto err;
    }
    ...
    *pdp = DIST_POINT_NAME_new();
    if (*pdp == 
# 119 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 119 "../crypto/x509/v3_crld.c"
                   )
        goto err;
    if (fnm) {
        (*pdp)->type = 0;
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_GENERAL_NAME_sk_type(fnm),ossl_check_GENERAL_NAME_freefunc_type(GENERAL_NAME_free));
    OPENSSL_sk_pop_free(ossl_check_X509_NAME_ENTRY_sk_type(rnm),ossl_check_X509_NAME_ENTRY_freefunc_type(X509_NAME_ENTRY_free));
    return -1;
}
...
static const BIT_STRING_BITNAME reason_flags[] = {
    ...
    {-1, 
# 147 "../crypto/x509/v3_crld.c" 3 4
        ((void *)0)
# 147 "../crypto/x509/v3_crld.c"
            , 
# 147 "../crypto/x509/v3_crld.c" 3 4
              ((void *)0)
# 147 "../crypto/x509/v3_crld.c"
...
# 152 "../crypto/x509/v3_crld.c" 3 4
                               ((void *)0)
# 152 "../crypto/x509/v3_crld.c"
                                   ;
    ...
    if (rsk == 
# 157 "../crypto/x509/v3_crld.c" 3 4
              ((void *)0)
# 157 "../crypto/x509/v3_crld.c"
                  )
        return 0;
    if (*preas != 
# 159 "../crypto/x509/v3_crld.c" 3 4
                 ((void *)0)
# 159 "../crypto/x509/v3_crld.c"
                     )
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(rsk)); i++) {
        bnam = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(rsk), (i)))->name;
        if (*preas == 
# 163 "../crypto/x509/v3_crld.c" 3 4
                     ((void *)0)
# 163 "../crypto/x509/v3_crld.c"
                         ) {
            *preas = ASN1_BIT_STRING_new();
            if (*preas == 
# 165 "../crypto/x509/v3_crld.c" 3 4
                         ((void *)0)
# 165 "../crypto/x509/v3_crld.c"
                             )
                goto err;
        }
        ...
        if (pbn->lname == 
# 175 "../crypto/x509/v3_crld.c" 3 4
                         ((void *)0)
# 175 "../crypto/x509/v3_crld.c"
                             )
            goto err;
    }
    ret = 1;
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(rsk),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return ret;
}
                                      ...
                                      struct stack_st_CONF_VALUE *nval)
{
    ...
    if (point == 
# 214 "../crypto/x509/v3_crld.c" 3 4
                ((void *)0)
# 214 "../crypto/x509/v3_crld.c"
                    )
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); i++) {
        int ret;
        cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (i)));
        ...
        if (strcmp(cnf->name, "reasons") == 0) {
            ...
            if (point->CRLissuer == 
# 229 "../crypto/x509/v3_crld.c" 3 4
                                   ((void *)0)
# 229 "../crypto/x509/v3_crld.c"
                                       )
                goto err;
        }
    }
 ...
 err:
    ...
    return 
# 238 "../crypto/x509/v3_crld.c" 3 4
          ((void *)0)
# 238 "../crypto/x509/v3_crld.c"
              ;
}
                      ...
                      X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval)
{
    ...
    GENERAL_NAMES *gens = 
# 245 "../crypto/x509/v3_crld.c" 3 4
                         ((void *)0)
# 245 "../crypto/x509/v3_crld.c"
                             ;
    GENERAL_NAME *gen = 
# 246 "../crypto/x509/v3_crld.c" 3 4
                       ((void *)0)
# 246 "../crypto/x509/v3_crld.c"
                           ;
    CONF_VALUE *cnf;
    const int num = OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval));
    int i;

    crld = ((struct stack_st_DIST_POINT *)OPENSSL_sk_new_reserve(ossl_check_DIST_POINT_compfunc_type(
# 251 "../crypto/x509/v3_crld.c" 3 4
          ((void *)0)
# 251 "../crypto/x509/v3_crld.c"
          ), (num)));
    if (crld == 
# 252 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 252 "../crypto/x509/v3_crld.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",253,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 253 "../crypto/x509/v3_crld.c" 3 4
       ((void *)0)
# 253 "../crypto/x509/v3_crld.c"
       );
        goto err;
    }
    for (i = 0; i < num; i++) {
        ...
        cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(nval), (i)));
        if (cnf->value == 
# 260 "../crypto/x509/v3_crld.c" 3 4
                         ((void *)0)
# 260 "../crypto/x509/v3_crld.c"
                             ) {
            ...
            if (point == 
# 267 "../crypto/x509/v3_crld.c" 3 4
                        ((void *)0)
# 267 "../crypto/x509/v3_crld.c"
                            )
                goto err;
            OPENSSL_sk_push(ossl_check_DIST_POINT_sk_type(crld), ossl_check_DIST_POINT_type(point));
        } else {
            if ((gen = v2i_GENERAL_NAME(method, ctx, cnf)) == 
# 271 "../crypto/x509/v3_crld.c" 3 4
                                                             ((void *)0)
# 271 "../crypto/x509/v3_crld.c"
                                                                 )
                goto err;
            if ((gens = GENERAL_NAMES_new()) == 
# 273 "../crypto/x509/v3_crld.c" 3 4
                                               ((void *)0)
# 273 "../crypto/x509/v3_crld.c"
                                                   ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",274,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 274 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 274 "../crypto/x509/v3_crld.c"
               );
                goto err;
            }
            if (!OPENSSL_sk_push(ossl_check_GENERAL_NAME_sk_type(gens), ossl_check_GENERAL_NAME_type(gen))) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",278,__func__), ERR_set_error)((34),((15 | (0x2 << 18L))),
# 278 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 278 "../crypto/x509/v3_crld.c"
               );
                goto err;
            }
            gen = 
# 281 "../crypto/x509/v3_crld.c" 3 4
                 ((void *)0)
# 281 "../crypto/x509/v3_crld.c"
                     ;
            if ((point = DIST_POINT_new()) == 
# 282 "../crypto/x509/v3_crld.c" 3 4
                                             ((void *)0)
# 282 "../crypto/x509/v3_crld.c"
                                                 ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",283,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 283 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 283 "../crypto/x509/v3_crld.c"
               );
                goto err;
            }
            OPENSSL_sk_push(ossl_check_DIST_POINT_sk_type(crld), ossl_check_DIST_POINT_type(point));
            if ((point->distpoint = DIST_POINT_NAME_new()) == 
# 287 "../crypto/x509/v3_crld.c" 3 4
                                                             ((void *)0)
# 287 "../crypto/x509/v3_crld.c"
                                                                 ) {
                (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",288,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 288 "../crypto/x509/v3_crld.c" 3 4
               ((void *)0)
# 288 "../crypto/x509/v3_crld.c"
               );
                goto err;
            }
            ...
            gens = 
# 293 "../crypto/x509/v3_crld.c" 3 4
                  ((void *)0)
# 293 "../crypto/x509/v3_crld.c"
                      ;
        }
    }
    return crld;
 ...
 err:
    ...
    OPENSSL_sk_pop_free(ossl_check_DIST_POINT_sk_type(crld),ossl_check_DIST_POINT_freefunc_type(DIST_POINT_free));
    return 
# 302 "../crypto/x509/v3_crld.c" 3 4
          ((void *)0)
# 302 "../crypto/x509/v3_crld.c"
              ;
}
                  ...
                  void *exarg)
{
    ...
    case 1:
        dpn->dpname = 
# 312 "../crypto/x509/v3_crld.c" 3 4
                     ((void *)0)
# 312 "../crypto/x509/v3_crld.c"
                         ;
        break;
...
# 323 "../crypto/x509/v3_crld.c" 3 4
((void *)0)
# 323 "../crypto/x509/v3_crld.c"
, 0, 0, 0, dpn_cb, 0, 
# 323 "../crypto/x509/v3_crld.c" 3 4
((void *)0)
# 323 "../crypto/x509/v3_crld.c"
        ...
        { (((0x1 << 3)|(0x2<<6)) | ((0x2 << 1))), (0), 
# 324 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 324 "../crypto/x509/v3_crld.c"
       DIST_POINT_NAME
# 324 "../crypto/x509/v3_crld.c" 3 4
       , 
# 324 "../crypto/x509/v3_crld.c"
...
# 324 "../crypto/x509/v3_crld.c"
       , "name.fullname", (GENERAL_NAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1 << 1))), (1), 
# 325 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 325 "../crypto/x509/v3_crld.c"
       DIST_POINT_NAME
# 325 "../crypto/x509/v3_crld.c" 3 4
       , 
# 325 "../crypto/x509/v3_crld.c"
...
# 325 "../crypto/x509/v3_crld.c"
       , "name.relativename", (X509_NAME_ENTRY_it) }
} ; const ASN1_ITEM * DIST_POINT_NAME_it(void) { static const ASN1_ITEM local_it = { 0x2, 
# 326 "../crypto/x509/v3_crld.c" 3 4
 __builtin_offsetof (
# 326 "../crypto/x509/v3_crld.c"
 DIST_POINT_NAME
# 326 "../crypto/x509/v3_crld.c" 3 4
 , 
# 326 "../crypto/x509/v3_crld.c"
...
# 326 "../crypto/x509/v3_crld.c"
 , DIST_POINT_NAME_ch_tt, sizeof(DIST_POINT_NAME_ch_tt) / sizeof(ASN1_TEMPLATE), &DIST_POINT_NAME_aux, sizeof(DIST_POINT_NAME), "DIST_POINT_NAME" }; return &local_it; }


DIST_POINT_NAME *d2i_DIST_POINT_NAME(DIST_POINT_NAME **a, const unsigned char **in, long len) { return (DIST_POINT_NAME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DIST_POINT_NAME_it())); } int i2d_DIST_POINT_NAME(const DIST_POINT_NAME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DIST_POINT_NAME_it())); } DIST_POINT_NAME *DIST_POINT_NAME_new(void) { return (DIST_POINT_NAME *)ASN1_item_new((DIST_POINT_NAME_it())); } void DIST_POINT_NAME_free(DIST_POINT_NAME *a) { ASN1_item_free((ASN1_VALUE *)a, (DIST_POINT_NAME_it())); }

static const ASN1_TEMPLATE DIST_POINT_seq_tt[] = {
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 332 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 332 "../crypto/x509/v3_crld.c"
       DIST_POINT
# 332 "../crypto/x509/v3_crld.c" 3 4
       , 
# 332 "../crypto/x509/v3_crld.c"
...
# 332 "../crypto/x509/v3_crld.c"
       , "distpoint", (DIST_POINT_NAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 333 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 333 "../crypto/x509/v3_crld.c"
       DIST_POINT
# 333 "../crypto/x509/v3_crld.c" 3 4
       , 
# 333 "../crypto/x509/v3_crld.c"
...
# 333 "../crypto/x509/v3_crld.c"
       , "reasons", (ASN1_BIT_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x2 << 1)|(0x1))), (2), 
# 334 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 334 "../crypto/x509/v3_crld.c"
       DIST_POINT
# 334 "../crypto/x509/v3_crld.c" 3 4
       , 
# 334 "../crypto/x509/v3_crld.c"
...
# 334 "../crypto/x509/v3_crld.c"
       , "CRLissuer", (GENERAL_NAME_it) }
} ; const ASN1_ITEM * DIST_POINT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DIST_POINT_seq_tt, sizeof(DIST_POINT_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 335 "../crypto/x509/v3_crld.c" 3 4
 ((void *)0)
# 335 "../crypto/x509/v3_crld.c"
 , sizeof(DIST_POINT), "DIST_POINT" }; return &local_it; }

DIST_POINT *d2i_DIST_POINT(DIST_POINT **a, const unsigned char **in, long len) { return (DIST_POINT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DIST_POINT_it())); } int i2d_DIST_POINT(const DIST_POINT *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DIST_POINT_it())); } DIST_POINT *DIST_POINT_new(void) { return (DIST_POINT *)ASN1_item_new((DIST_POINT_it())); } void DIST_POINT_free(DIST_POINT *a) { ASN1_item_free((ASN1_VALUE *)a, (DIST_POINT_it())); }

static const ASN1_TEMPLATE CRL_DIST_POINTS_item_tt =
        { ((0x2 << 1)), (0), 0, "CRLDistributionPoints", (DIST_POINT_it) }
; const ASN1_ITEM * CRL_DIST_POINTS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &CRL_DIST_POINTS_item_tt, 0, 
# 341 "../crypto/x509/v3_crld.c" 3 4
((void *)0)
# 341 "../crypto/x509/v3_crld.c"
, 0, "CRL_DIST_POINTS" }; return &local_it; }

CRL_DIST_POINTS *d2i_CRL_DIST_POINTS(CRL_DIST_POINTS **a, const unsigned char **in, long len) { return (CRL_DIST_POINTS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (CRL_DIST_POINTS_it())); } int i2d_CRL_DIST_POINTS(const CRL_DIST_POINTS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (CRL_DIST_POINTS_it())); } CRL_DIST_POINTS *CRL_DIST_POINTS_new(void) { return (CRL_DIST_POINTS *)ASN1_item_new((CRL_DIST_POINTS_it())); } void CRL_DIST_POINTS_free(CRL_DIST_POINTS *a) { ASN1_item_free((ASN1_VALUE *)a, (CRL_DIST_POINTS_it())); }

static const ASN1_TEMPLATE ISSUING_DIST_POINT_seq_tt[] = {
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 346 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 346 "../crypto/x509/v3_crld.c"
       ISSUING_DIST_POINT
# 346 "../crypto/x509/v3_crld.c" 3 4
       , 
# 346 "../crypto/x509/v3_crld.c"
...
# 346 "../crypto/x509/v3_crld.c"
       , "distpoint", (DIST_POINT_NAME_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 347 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 347 "../crypto/x509/v3_crld.c"
       ISSUING_DIST_POINT
# 347 "../crypto/x509/v3_crld.c" 3 4
       , 
# 347 "../crypto/x509/v3_crld.c"
...
# 347 "../crypto/x509/v3_crld.c"
       , "onlyuser", (ASN1_FBOOLEAN_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 348 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 348 "../crypto/x509/v3_crld.c"
       ISSUING_DIST_POINT
# 348 "../crypto/x509/v3_crld.c" 3 4
       , 
# 348 "../crypto/x509/v3_crld.c"
...
# 348 "../crypto/x509/v3_crld.c"
       , "onlyCA", (ASN1_FBOOLEAN_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (3), 
# 349 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
...
# 349 "../crypto/x509/v3_crld.c"
       , "onlysomereasons", (ASN1_BIT_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (4), 
# 350 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 350 "../crypto/x509/v3_crld.c"
       ISSUING_DIST_POINT
# 350 "../crypto/x509/v3_crld.c" 3 4
       , 
# 350 "../crypto/x509/v3_crld.c"
...
# 350 "../crypto/x509/v3_crld.c"
       , "indirectCRL", (ASN1_FBOOLEAN_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1))), (5), 
# 351 "../crypto/x509/v3_crld.c" 3 4
       __builtin_offsetof (
# 351 "../crypto/x509/v3_crld.c"
       ISSUING_DIST_POINT
# 351 "../crypto/x509/v3_crld.c" 3 4
       , 
# 351 "../crypto/x509/v3_crld.c"
...
# 351 "../crypto/x509/v3_crld.c"
       , "onlyattr", (ASN1_FBOOLEAN_it) }
} ; const ASN1_ITEM * ISSUING_DIST_POINT_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, ISSUING_DIST_POINT_seq_tt, sizeof(ISSUING_DIST_POINT_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 352 "../crypto/x509/v3_crld.c" 3 4
 ((void *)0)
# 352 "../crypto/x509/v3_crld.c"
 , sizeof(ISSUING_DIST_POINT), "ISSUING_DIST_POINT" }; return &local_it; }

ISSUING_DIST_POINT *d2i_ISSUING_DIST_POINT(ISSUING_DIST_POINT **a, const unsigned char **in, long len) { return (ISSUING_DIST_POINT *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ISSUING_DIST_POINT_it())); } int i2d_ISSUING_DIST_POINT(const ISSUING_DIST_POINT *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ISSUING_DIST_POINT_it())); } ISSUING_DIST_POINT *ISSUING_DIST_POINT_new(void) { return (ISSUING_DIST_POINT *)ASN1_item_new((ISSUING_DIST_POINT_it())); } void ISSUING_DIST_POINT_free(ISSUING_DIST_POINT *a) { ASN1_item_free((ASN1_VALUE *)a, (ISSUING_DIST_POINT_it())); }
...
# 369 "../crypto/x509/v3_crld.c" 3 4
   ((void *)0)

# 370 "../crypto/x509/v3_crld.c"
};
...
{
    ISSUING_DIST_POINT *idp = 
# 375 "../crypto/x509/v3_crld.c" 3 4
                             ((void *)0)
# 375 "../crypto/x509/v3_crld.c"
                                 ;
    CONF_VALUE *cnf;
    char *name, *val;
    int i, ret;
    ...
    if (idp == 
# 380 "../crypto/x509/v3_crld.c" 3 4
              ((void *)0)
# 380 "../crypto/x509/v3_crld.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",381,__func__), ERR_set_error)((34),((13 | (0x2 << 18L))),
# 381 "../crypto/x509/v3_crld.c" 3 4
       ((void *)0)
# 381 "../crypto/x509/v3_crld.c"
       );
        goto err;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(nval)); i++) {
        ...
        if (strcmp(name, "onlyuser") == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/x509/v3_crld.c",409,__func__), ERR_set_error)((34),(106),
# 409 "../crypto/x509/v3_crld.c" 3 4
           ((void *)0)
# 409 "../crypto/x509/v3_crld.c"
           );
 ...
 err:
    ...
    return 
# 418 "../crypto/x509/v3_crld.c" 3 4
          ((void *)0)
# 418 "../crypto/x509/v3_crld.c"
              ;
}

static int print_gens(BIO *out, struct stack_st_GENERAL_NAME *gens, int indent)
{
    int i;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gens)); i++) {
        ...
        GENERAL_NAME_print(out, ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gens), (i))));
    }
    return 1;
}
                     ...
                     int indent)
{
    ...
    DIST_POINT *point;
    int i;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_DIST_POINT_sk_type(crld)); i++) {
        if (i > 0)
            BIO_puts(out, "\n");
        point = ((DIST_POINT *)OPENSSL_sk_value(ossl_check_const_DIST_POINT_sk_type(crld), (i)));
        if (point->distpoint)
...
int DIST_POINT_set_dpname(DIST_POINT_NAME *dpn, const X509_NAME *iname)
{
    ...
    if (dpn == 
# 501 "../crypto/x509/v3_crld.c" 3 4
              ((void *)0) 
# 501 "../crypto/x509/v3_crld.c"
                   || dpn->type != 1)
        return 1;
    ...
    if (dpn->dpname == 
# 506 "../crypto/x509/v3_crld.c" 3 4
                      ((void *)0)
# 506 "../crypto/x509/v3_crld.c"
                          )
        return 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_NAME_ENTRY_sk_type(frag)); i++) {
        ne = ((X509_NAME_ENTRY *)OPENSSL_sk_value(ossl_check_const_X509_NAME_ENTRY_sk_type(frag), (i)));
        if (!X509_NAME_add_entry(dpn->dpname, ne, -1, i ? 0 : 1))
            goto err;
    }

    if (i2d_X509_NAME(dpn->dpname, 
# 514 "../crypto/x509/v3_crld.c" 3 4
                                  ((void *)0)
# 514 "../crypto/x509/v3_crld.c"
                                      ) >= 0)
        return 1;
 ...
 err:
    X509_NAME_free(dpn->dpname);
    dpn->dpname = 
# 519 "../crypto/x509/v3_crld.c" 3 4
                 ((void *)0)
# 519 "../crypto/x509/v3_crld.c"
                     ;
    return 0;
}
