# 0 "../crypto/dso/dso_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dso/dso_err.c"
# 11 "../crypto/dso/dso_err.c"
...
# 12 "../crypto/dso/dso_err.c" 2
# 1 "../include/internal/dsoerr.h" 1
# 13 "../include/internal/dsoerr.h"
        
# 22 "../include/internal/dsoerr.h"
int ossl_err_load_DSO_strings(void);
# 13 "../crypto/dso/dso_err.c" 2



static const ERR_STRING_DATA DSO_str_reasons[] = {
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "control command failed"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "dso already loaded"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "empty file structure"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "failure"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "filename too big"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "cleanup method function failed"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "incorrect file syntax"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "could not load the shared library"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "name translation failed"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "no filename"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "a null shared library handle was used"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "set filename failed"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "the meth_data stack is corrupt"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "could not bind to the requested symbol name"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "could not unload the shared library"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "functionality not supported"},
    {0, 
# 44 "../crypto/dso/dso_err.c" 3 4
       ((void *)0)
# 44 "../crypto/dso/dso_err.c"
           }
};
...
int ossl_err_load_DSO_strings(void)
{
    ...
    if (ERR_reason_error_string(DSO_str_reasons[0].error) == 
# 52 "../crypto/dso/dso_err.c" 3 4
                                                            ((void *)0)
# 52 "../crypto/dso/dso_err.c"
                                                                )
