# 0 "../crypto/dso/dso_dlfcn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dso/dso_dlfcn.c"
# 19 "../crypto/dso/dso_dlfcn.c"
...
# 20 "../crypto/dso/dso_dlfcn.c" 2
# 28 "../crypto/dso/dso_dlfcn.c"
...
# 29 "../crypto/dso/dso_dlfcn.c" 2
# 41 "../crypto/dso/dso_dlfcn.c"
...
# 55 "../crypto/dso/dso_dlfcn.c" 3 4
   ((void *)0)
# 55 "../crypto/dso/dso_dlfcn.c"
       ,
    dlfcn_name_converter,
    dlfcn_merger,
    
# 58 "../crypto/dso/dso_dlfcn.c" 3 4
   ((void *)0)
# 58 "../crypto/dso/dso_dlfcn.c"
       ,
    
# 59 "../crypto/dso/dso_dlfcn.c" 3 4
   ((void *)0)
# 59 "../crypto/dso/dso_dlfcn.c"
       ,
    dlfcn_pathbyaddr,
    dlfcn_globallookup
};
...
# 96 "../crypto/dso/dso_dlfcn.c"
static int dlfcn_load(DSO *dso)
{
    void *ptr = 
# 98 "../crypto/dso/dso_dlfcn.c" 3 4
               ((void *)0)
# 98 "../crypto/dso/dso_dlfcn.c"
                   ;

    char *filename = DSO_convert_filename(dso, 
# 100 "../crypto/dso/dso_dlfcn.c" 3 4
                                              ((void *)0)
# 100 "../crypto/dso/dso_dlfcn.c"
                                                  );
    int flags = 
# 101 "../crypto/dso/dso_dlfcn.c" 3 4
               0x00002
# 101 "../crypto/dso/dso_dlfcn.c"
                          ;
    int saveerrno = 
# 102 "../crypto/dso/dso_dlfcn.c" 3 4
                   (*__errno_location ())
# 102 "../crypto/dso/dso_dlfcn.c"
                                       ;

    if (filename == 
# 104 "../crypto/dso/dso_dlfcn.c" 3 4
                   ((void *)0)
# 104 "../crypto/dso/dso_dlfcn.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",105,__func__), ERR_set_error)((37),(111),
# 105 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 105 "../crypto/dso/dso_dlfcn.c"
       );
        goto err;
    }
    ...
    if (dso->flags & 0x20)
        flags |= 
# 110 "../crypto/dso/dso_dlfcn.c" 3 4
                0x00100
# 110 "../crypto/dso/dso_dlfcn.c"
                           ;
    ...
    if (ptr == 
# 117 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 117 "../crypto/dso/dso_dlfcn.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",118,__func__), ERR_set_error)(37, 103,
...
# 126 "../crypto/dso/dso_dlfcn.c" 3 4
   (*__errno_location ())
# 126 "../crypto/dso/dso_dlfcn.c"
   =(saveerrno);
    if (!OPENSSL_sk_push(ossl_check_void_sk_type(dso->meth_data), ossl_check_void_type((char *)ptr))) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",128,__func__), ERR_set_error)((37),(105),
# 128 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 128 "../crypto/dso/dso_dlfcn.c"
       );
        goto err;
    }
 ...
 err:
    ...
    CRYPTO_free(filename, "../crypto/dso/dso_dlfcn.c", 136);
    if (ptr != 
# 137 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 137 "../crypto/dso/dso_dlfcn.c"
                  )
        dlclose(ptr);
    return 0;
}
...
static int dlfcn_unload(DSO *dso)
{
    void *ptr;
    if (dso == 
# 145 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 145 "../crypto/dso/dso_dlfcn.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",146,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 146 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 146 "../crypto/dso/dso_dlfcn.c"
       );
        return 0;
    }
    if (OPENSSL_sk_num(ossl_check_const_void_sk_type(dso->meth_data)) < 1)
        return 1;
    ptr = ((void *)OPENSSL_sk_pop(ossl_check_void_sk_type(dso->meth_data)));
    if (ptr == 
# 152 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 152 "../crypto/dso/dso_dlfcn.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",153,__func__), ERR_set_error)((37),(104),
# 153 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 153 "../crypto/dso/dso_dlfcn.c"
       );



        OPENSSL_sk_push(ossl_check_void_sk_type(dso->meth_data), ossl_check_void_type(ptr));
        return 0;
    }
...
static DSO_FUNC_TYPE dlfcn_bind_func(DSO *dso, const char *symname)
{
    ...
    if ((dso == 
# 173 "../crypto/dso/dso_dlfcn.c" 3 4
               ((void *)0)
# 173 "../crypto/dso/dso_dlfcn.c"
                   ) || (symname == 
# 173 "../crypto/dso/dso_dlfcn.c" 3 4
                                    ((void *)0)
# 173 "../crypto/dso/dso_dlfcn.c"
                                        )) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",174,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 174 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 174 "../crypto/dso/dso_dlfcn.c"
       );
        return 
# 175 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 175 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    if (OPENSSL_sk_num(ossl_check_const_void_sk_type(dso->meth_data)) < 1) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",178,__func__), ERR_set_error)((37),(105),
# 178 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 178 "../crypto/dso/dso_dlfcn.c"
       );
        return 
# 179 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 179 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    ptr = ((void *)OPENSSL_sk_value(ossl_check_const_void_sk_type(dso->meth_data), (OPENSSL_sk_num(ossl_check_const_void_sk_type(dso->meth_data)) - 1)));
    if (ptr == 
# 182 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 182 "../crypto/dso/dso_dlfcn.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",183,__func__), ERR_set_error)((37),(104),
# 183 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 183 "../crypto/dso/dso_dlfcn.c"
       );
        return 
# 184 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 184 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    u.dlret = dlsym(ptr, symname);
    if (u.dlret == 
# 187 "../crypto/dso/dso_dlfcn.c" 3 4
                  ((void *)0)
# 187 "../crypto/dso/dso_dlfcn.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",188,__func__), ERR_set_error)(37, 106,
                       "symname(%s): %s", symname, dlerror());
        return 
# 190 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 190 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    return u.sym;
}
                          ...
                          const char *filespec2)
{
    ...
    if (!filespec1 && !filespec2) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",201,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 201 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 201 "../crypto/dso/dso_dlfcn.c"
       );
        return 
# 202 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 202 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    ...
    if (!filespec2 || (filespec1 != 
# 208 "../crypto/dso/dso_dlfcn.c" 3 4
                                   ((void *)0) 
# 208 "../crypto/dso/dso_dlfcn.c"
                                        && filespec1[0] == '/')) {
        merged = CRYPTO_strdup(filespec1, "../crypto/dso/dso_dlfcn.c", 209);
        if (merged == 
# 210 "../crypto/dso/dso_dlfcn.c" 3 4
                     ((void *)0)
# 210 "../crypto/dso/dso_dlfcn.c"
                         )
            return 
# 211 "../crypto/dso/dso_dlfcn.c" 3 4
                  ((void *)0)
# 211 "../crypto/dso/dso_dlfcn.c"
                      ;
    }
        ...
        merged = CRYPTO_strdup(filespec2, "../crypto/dso/dso_dlfcn.c", 217);
        if (merged == 
# 218 "../crypto/dso/dso_dlfcn.c" 3 4
                     ((void *)0)
# 218 "../crypto/dso/dso_dlfcn.c"
                         )
            return 
# 219 "../crypto/dso/dso_dlfcn.c" 3 4
                  ((void *)0)
# 219 "../crypto/dso/dso_dlfcn.c"
                      ;
    } else {
        ...
        merged = CRYPTO_malloc(len + 2, "../crypto/dso/dso_dlfcn.c", 237);
        if (merged == 
# 238 "../crypto/dso/dso_dlfcn.c" 3 4
                     ((void *)0)
# 238 "../crypto/dso/dso_dlfcn.c"
                         )
            return 
# 239 "../crypto/dso/dso_dlfcn.c" 3 4
                  ((void *)0)
...
static char *dlfcn_name_converter(DSO *dso, const char *filename)
{
    ...
    len = strlen(filename);
    rsize = len + 1;
    transform = (strchr(filename, '/') == 
# 254 "../crypto/dso/dso_dlfcn.c" 3 4
                                         ((void *)0)
# 254 "../crypto/dso/dso_dlfcn.c"
                                             );
    if (transform) {

        rsize += strlen(".so");
        if ((DSO_flags(dso) & 0x02) == 0)
            rsize += 3;
    }
    translated = CRYPTO_malloc(rsize, "../crypto/dso/dso_dlfcn.c", 261);
    if (translated == 
# 262 "../crypto/dso/dso_dlfcn.c" 3 4
                     ((void *)0)
# 262 "../crypto/dso/dso_dlfcn.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_dlfcn.c",263,__func__), ERR_set_error)((37),(109),
# 263 "../crypto/dso/dso_dlfcn.c" 3 4
       ((void *)0)
# 263 "../crypto/dso/dso_dlfcn.c"
       );
        return 
# 264 "../crypto/dso/dso_dlfcn.c" 3 4
              ((void *)0)
# 264 "../crypto/dso/dso_dlfcn.c"
                  ;
    }
    if (transform) {
        if ((DSO_flags(dso) & 0x02) == 0)
            BIO_snprintf(translated, rsize, "lib%s" ".so", filename);
        else
            BIO_snprintf(translated, rsize, "%s" ".so", filename);
    } else {
        BIO_snprintf(translated, rsize, "%s", filename);
    }
    return translated;
}
# 401 "../crypto/dso/dso_dlfcn.c"
static int dlfcn_pathbyaddr(void *addr, char *path, int sz)
{
    ...
    if (addr == 
# 407 "../crypto/dso/dso_dlfcn.c" 3 4
               ((void *)0)
# 407 "../crypto/dso/dso_dlfcn.c"
                   ) {
        union {
            int (*f) (void *, char *, int);
            void *p;
...
{
    void *ret = 
# 442 "../crypto/dso/dso_dlfcn.c" 3 4
               ((void *)0)
# 442 "../crypto/dso/dso_dlfcn.c"
                   , *handle = dlopen(
# 442 "../crypto/dso/dso_dlfcn.c" 3 4
                                      ((void *)0)
# 442 "../crypto/dso/dso_dlfcn.c"
