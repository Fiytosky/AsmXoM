# 0 "../crypto/dso/dso_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dso/dso_lib.c"
# 10 "../crypto/dso/dso_lib.c"
# 1 "../crypto/dso/dso_local.h" 1
# 10 "../crypto/dso/dso_local.h"
...
static DSO *DSO_new_method(DSO_METHOD *meth)
{
    ...
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/dso/dso_lib.c", 17);
    if (ret == 
# 18 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 18 "../crypto/dso/dso_lib.c"
                  )
        return 
# 19 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 19 "../crypto/dso/dso_lib.c"
                  ;
    ret->meth_data = ((struct stack_st_void *)OPENSSL_sk_new_null());
    if (ret->meth_data == 
# 21 "../crypto/dso/dso_lib.c" 3 4
                         ((void *)0)
# 21 "../crypto/dso/dso_lib.c"
                             ) {

        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",23,__func__), ERR_set_error)((37),((15 | (0x2 << 18L))),
# 23 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 23 "../crypto/dso/dso_lib.c"
       );
        CRYPTO_free(ret, "../crypto/dso/dso_lib.c", 24);
        return 
# 25 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 25 "../crypto/dso/dso_lib.c"
                  ;
    }
    ret->meth = DSO_METHOD_openssl();
    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        OPENSSL_sk_free(ossl_check_void_sk_type(ret->meth_data));
        CRYPTO_free(ret, "../crypto/dso/dso_lib.c", 30);
        return 
# 31 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 31 "../crypto/dso/dso_lib.c"
                  ;
    }

    if ((ret->meth->init != 
# 34 "../crypto/dso/dso_lib.c" 3 4
                           ((void *)0)
# 34 "../crypto/dso/dso_lib.c"
                               ) && !ret->meth->init(ret)) {
        DSO_free(ret);
        ret = 
# 36 "../crypto/dso/dso_lib.c" 3 4
             ((void *)0)
# 36 "../crypto/dso/dso_lib.c"
                 ;
    }
...
# 44 "../crypto/dso/dso_lib.c" 3 4
                         ((void *)0)
# 44 "../crypto/dso/dso_lib.c"
                             );
}
...
int DSO_free(DSO *dso)
{
    ...
    if (dso == 
# 51 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 51 "../crypto/dso/dso_lib.c"
                  )
        return 1;
...
# 63 "../crypto/dso/dso_lib.c" 3 4
                                     ((void *)0)
# 63 "../crypto/dso/dso_lib.c"
                                         ) && !dso->meth->dso_unload(dso)) {
            (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",64,__func__), ERR_set_error)((37),(107),
# 64 "../crypto/dso/dso_lib.c" 3 4
           ((void *)0)
# 64 "../crypto/dso/dso_lib.c"
           );
            return 0;
        }
    }
    ...
    if ((dso->meth->finish != 
# 69 "../crypto/dso/dso_lib.c" 3 4
                             ((void *)0)
# 69 "../crypto/dso/dso_lib.c"
                                 ) && !dso->meth->finish(dso)) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",70,__func__), ERR_set_error)((37),(102),
# 70 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 70 "../crypto/dso/dso_lib.c"
       );
        return 0;
    }

    OPENSSL_sk_free(ossl_check_void_sk_type(dso->meth_data));
    CRYPTO_free(dso->filename, "../crypto/dso/dso_lib.c", 75);
    CRYPTO_free(dso->loaded_filename, "../crypto/dso/dso_lib.c", 76);
    CRYPTO_FREE_REF(&dso->references);
    CRYPTO_free(dso, "../crypto/dso/dso_lib.c", 78);
    return 1;
}
...
{
    return ((dso == 
# 84 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
# 84 "../crypto/dso/dso_lib.c"
                       ) ? 0 : dso->flags);
}
...
int DSO_up_ref(DSO *dso)
{
    ...
    if (dso == 
# 91 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 91 "../crypto/dso/dso_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",92,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 92 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 92 "../crypto/dso/dso_lib.c"
       );
        return 0;
    }
...
DSO *DSO_load(DSO *dso, const char *filename, DSO_METHOD *meth, int flags)
{
    ...
    if (dso == 
# 109 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 109 "../crypto/dso/dso_lib.c"
                  ) {
        ret = DSO_new_method(meth);
        if (ret == 
# 111 "../crypto/dso/dso_lib.c" 3 4
                  ((void *)0)
# 111 "../crypto/dso/dso_lib.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",112,__func__), ERR_set_error)((37),((37 | (0x2 << 18L))),
# 112 "../crypto/dso/dso_lib.c" 3 4
           ((void *)0)
# 112 "../crypto/dso/dso_lib.c"
           );
            goto err;
        }
        allocated = 1;
...
# 117 "../crypto/dso/dso_lib.c" 3 4
                                                    ((void *)0)
# 117 "../crypto/dso/dso_lib.c"
                                                        ) < 0) {
            (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",118,__func__), ERR_set_error)((37),(100),
# 118 "../crypto/dso/dso_lib.c" 3 4
           ((void *)0)
# 118 "../crypto/dso/dso_lib.c"
           );
            goto err;
        }
    } else
    ...
    if (ret->filename != 
# 124 "../crypto/dso/dso_lib.c" 3 4
                        ((void *)0)
# 124 "../crypto/dso/dso_lib.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",125,__func__), ERR_set_error)((37),(110),
# 125 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 125 "../crypto/dso/dso_lib.c"
       );
        goto err;
    }
    ...
    if (filename != 
# 132 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
# 132 "../crypto/dso/dso_lib.c"
                       )
        if (!DSO_set_filename(ret, filename)) {
            (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",134,__func__), ERR_set_error)((37),(112),
# 134 "../crypto/dso/dso_lib.c" 3 4
           ((void *)0)
# 134 "../crypto/dso/dso_lib.c"
           );
            goto err;
        }
    filename = ret->filename;
    if (filename == 
# 138 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
# 138 "../crypto/dso/dso_lib.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",139,__func__), ERR_set_error)((37),(111),
# 139 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 139 "../crypto/dso/dso_lib.c"
       );
        goto err;
    }
    if (ret->meth->dso_load == 
# 142 "../crypto/dso/dso_lib.c" 3 4
                              ((void *)0)
# 142 "../crypto/dso/dso_lib.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",143,__func__), ERR_set_error)((37),(108),
# 143 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 143 "../crypto/dso/dso_lib.c"
       );
        goto err;
    }
    if (!ret->meth->dso_load(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",147,__func__), ERR_set_error)((37),(103),
# 147 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 147 "../crypto/dso/dso_lib.c"
       );
        goto err;
    }
 ...
 err:
    if (allocated)
        DSO_free(ret);
    return 
# 155 "../crypto/dso/dso_lib.c" 3 4
          ((void *)0)
# 155 "../crypto/dso/dso_lib.c"
              ;
}
...
{
    DSO_FUNC_TYPE ret = 
# 160 "../crypto/dso/dso_lib.c" 3 4
                       ((void *)0)
# 160 "../crypto/dso/dso_lib.c"
                           ;

    if ((dso == 
# 162 "../crypto/dso/dso_lib.c" 3 4
               ((void *)0)
# 162 "../crypto/dso/dso_lib.c"
                   ) || (symname == 
# 162 "../crypto/dso/dso_lib.c" 3 4
                                    ((void *)0)
# 162 "../crypto/dso/dso_lib.c"
                                        )) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",163,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 163 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 163 "../crypto/dso/dso_lib.c"
       );
        return 
# 164 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 164 "../crypto/dso/dso_lib.c"
                  ;
    }
    if (dso->meth->dso_bind_func == 
# 166 "../crypto/dso/dso_lib.c" 3 4
                                   ((void *)0)
# 166 "../crypto/dso/dso_lib.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",167,__func__), ERR_set_error)((37),(108),
# 167 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 167 "../crypto/dso/dso_lib.c"
       );
        return 
# 168 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 168 "../crypto/dso/dso_lib.c"
                  ;
    }
    if ((ret = dso->meth->dso_bind_func(dso, symname)) == 
# 170 "../crypto/dso/dso_lib.c" 3 4
                                                         ((void *)0)
# 170 "../crypto/dso/dso_lib.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",171,__func__), ERR_set_error)((37),(106),
# 171 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 171 "../crypto/dso/dso_lib.c"
       );
        return 
# 172 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 172 "../crypto/dso/dso_lib.c"
                  ;
    }

    return ret;
}
# 187 "../crypto/dso/dso_lib.c"
long DSO_ctrl(DSO *dso, int cmd, long larg, void *parg)
{
    if (dso == 
# 189 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 189 "../crypto/dso/dso_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",190,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 190 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 190 "../crypto/dso/dso_lib.c"
       );
        return -1;
    }
    ...
    if ((dso->meth == 
# 209 "../crypto/dso/dso_lib.c" 3 4
                     ((void *)0)
# 209 "../crypto/dso/dso_lib.c"
                         ) || (dso->meth->dso_ctrl == 
# 209 "../crypto/dso/dso_lib.c" 3 4
                                                      ((void *)0)
# 209 "../crypto/dso/dso_lib.c"
                                                          )) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",210,__func__), ERR_set_error)((37),(108),
# 210 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 210 "../crypto/dso/dso_lib.c"
       );
        return -1;
    }
...
{
    if (dso == 
# 218 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 218 "../crypto/dso/dso_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",219,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 219 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 219 "../crypto/dso/dso_lib.c"
       );
        return 
# 220 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 220 "../crypto/dso/dso_lib.c"
                  ;
    }
    return dso->filename;
}
...
int DSO_set_filename(DSO *dso, const char *filename)
{
    ...
    if ((dso == 
# 229 "../crypto/dso/dso_lib.c" 3 4
               ((void *)0)
# 229 "../crypto/dso/dso_lib.c"
                   ) || (filename == 
# 229 "../crypto/dso/dso_lib.c" 3 4
                                     ((void *)0)
# 229 "../crypto/dso/dso_lib.c"
                                         )) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",230,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 230 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 230 "../crypto/dso/dso_lib.c"
       );
        return 0;
    }
    if (dso->loaded_filename) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",234,__func__), ERR_set_error)((37),(110),
# 234 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 234 "../crypto/dso/dso_lib.c"
       );
        return 0;
    }

    copied = CRYPTO_strdup(filename, "../crypto/dso/dso_lib.c", 238);
    if (copied == 
# 239 "../crypto/dso/dso_lib.c" 3 4
                 ((void *)0)
# 239 "../crypto/dso/dso_lib.c"
                     )
        return 0;
    CRYPTO_free(dso->filename, "../crypto/dso/dso_lib.c", 241);
    dso->filename = copied;
    return 1;
}
...
{
    char *result = 
# 248 "../crypto/dso/dso_lib.c" 3 4
                  ((void *)0)
# 248 "../crypto/dso/dso_lib.c"
                      ;

    if (dso == 
# 250 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0) 
# 250 "../crypto/dso/dso_lib.c"
                   || filespec1 == 
# 250 "../crypto/dso/dso_lib.c" 3 4
                                   ((void *)0)
# 250 "../crypto/dso/dso_lib.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",251,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 251 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 251 "../crypto/dso/dso_lib.c"
       );
        return 
# 252 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 252 "../crypto/dso/dso_lib.c"
                  ;
    }
    if ((dso->flags & 0x01) == 0) {
        if (dso->merger != 
# 255 "../crypto/dso/dso_lib.c" 3 4
                          ((void *)0)
# 255 "../crypto/dso/dso_lib.c"
                              )
            result = dso->merger(dso, filespec1, filespec2);
        else if (dso->meth->dso_merger != 
# 257 "../crypto/dso/dso_lib.c" 3 4
                                         ((void *)0)
# 257 "../crypto/dso/dso_lib.c"
                                             )
...
{
    char *result = 
# 265 "../crypto/dso/dso_lib.c" 3 4
                  ((void *)0)
# 265 "../crypto/dso/dso_lib.c"
                      ;

    if (dso == 
# 267 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 267 "../crypto/dso/dso_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",268,__func__), ERR_set_error)((37),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 268 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 268 "../crypto/dso/dso_lib.c"
       );
        return 
# 269 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 269 "../crypto/dso/dso_lib.c"
                  ;
    }
    if (filename == 
# 271 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
# 271 "../crypto/dso/dso_lib.c"
                       )
        filename = dso->filename;
    if (filename == 
# 273 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
# 273 "../crypto/dso/dso_lib.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",274,__func__), ERR_set_error)((37),(111),
# 274 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 274 "../crypto/dso/dso_lib.c"
       );
        return 
# 275 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 275 "../crypto/dso/dso_lib.c"
                  ;
    }
    if ((dso->flags & 0x01) == 0) {
        if (dso->name_converter != 
# 278 "../crypto/dso/dso_lib.c" 3 4
                                  ((void *)0)
# 278 "../crypto/dso/dso_lib.c"
                                      )
            result = dso->name_converter(dso, filename);
        else if (dso->meth->dso_name_converter != 
# 280 "../crypto/dso/dso_lib.c" 3 4
                                                 ((void *)0)
# 280 "../crypto/dso/dso_lib.c"
                                                     )
            result = dso->meth->dso_name_converter(dso, filename);
    }
    if (result == 
# 283 "../crypto/dso/dso_lib.c" 3 4
                 ((void *)0)
# 283 "../crypto/dso/dso_lib.c"
                     ) {
        result = CRYPTO_strdup(filename, "../crypto/dso/dso_lib.c", 284);
        if (result == 
# 285 "../crypto/dso/dso_lib.c" 3 4
                     ((void *)0)
# 285 "../crypto/dso/dso_lib.c"
                         )
            return 
# 286 "../crypto/dso/dso_lib.c" 3 4
                  ((void *)0)
# 286 "../crypto/dso/dso_lib.c"
                      ;
    }
    return result;
}
...
int DSO_pathbyaddr(void *addr, char *path, int sz)
{
    ...
    if (meth->pathbyaddr == 
# 295 "../crypto/dso/dso_lib.c" 3 4
                           ((void *)0)
# 295 "../crypto/dso/dso_lib.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",296,__func__), ERR_set_error)((37),(108),
# 296 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 296 "../crypto/dso/dso_lib.c"
       );
        return -1;
    }
...
{
    DSO *ret = 
# 304 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 304 "../crypto/dso/dso_lib.c"
                  ;
    char *filename = 
# 305 "../crypto/dso/dso_lib.c" 3 4
                    ((void *)0)
# 305 "../crypto/dso/dso_lib.c"
                        ;
    int len = DSO_pathbyaddr(addr, 
# 306 "../crypto/dso/dso_lib.c" 3 4
                                  ((void *)0)
# 306 "../crypto/dso/dso_lib.c"
                                      , 0);

    if (len < 0)
        return 
# 309 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 309 "../crypto/dso/dso_lib.c"
                  ;

    filename = CRYPTO_malloc(len, "../crypto/dso/dso_lib.c", 311);
    if (filename != 
# 312 "../crypto/dso/dso_lib.c" 3 4
                   ((void *)0)
            
# 313 "../crypto/dso/dso_lib.c"
           && DSO_pathbyaddr(addr, filename, len) == len)
        ret = DSO_load(
# 314 "../crypto/dso/dso_lib.c" 3 4
                      ((void *)0)
# 314 "../crypto/dso/dso_lib.c"
                          , filename, 
# 314 "../crypto/dso/dso_lib.c" 3 4
                                      ((void *)0)
# 314 "../crypto/dso/dso_lib.c"
    ...
    CRYPTO_free(filename, "../crypto/dso/dso_lib.c", 316);
    return ret;
}
...
# 324 "../crypto/dso/dso_lib.c" 3 4
                             ((void *)0)
# 324 "../crypto/dso/dso_lib.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/dso/dso_lib.c",325,__func__), ERR_set_error)((37),(108),
# 325 "../crypto/dso/dso_lib.c" 3 4
       ((void *)0)
# 325 "../crypto/dso/dso_lib.c"
       );
        return 
# 326 "../crypto/dso/dso_lib.c" 3 4
              ((void *)0)
# 326 "../crypto/dso/dso_lib.c"
                  ;
    }
