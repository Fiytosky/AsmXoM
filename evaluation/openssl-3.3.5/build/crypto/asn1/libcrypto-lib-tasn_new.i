# 0 "../crypto/asn1/tasn_new.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_new.c"
# 10 "../crypto/asn1/tasn_new.c"
...
{
    ASN1_VALUE *ret = 
# 31 "../crypto/asn1/tasn_new.c" 3 4
                     ((void *)0)
# 31 "../crypto/asn1/tasn_new.c"
                         ;
    if (ASN1_item_ex_new(&ret, it) > 0)
        return ret;
    return 
# 34 "../crypto/asn1/tasn_new.c" 3 4
          ((void *)0)
# 34 "../crypto/asn1/tasn_new.c"
              ;
}
...
{
    ASN1_VALUE *ret = 
# 40 "../crypto/asn1/tasn_new.c" 3 4
                     ((void *)0)
# 40 "../crypto/asn1/tasn_new.c"
                         ;
    if (asn1_item_embed_new(&ret, it, 0, libctx, propq) > 0)
        return ret;
    return 
# 43 "../crypto/asn1/tasn_new.c" 3 4
          ((void *)0)
# 43 "../crypto/asn1/tasn_new.c"
              ;
}
...
# 57 "../crypto/asn1/tasn_new.c" 3 4
                                           ((void *)0)
# 57 "../crypto/asn1/tasn_new.c"
                                               , 
# 57 "../crypto/asn1/tasn_new.c" 3 4
                                                 ((void *)0)
# 57 "../crypto/asn1/tasn_new.c"
...
{
    const ASN1_TEMPLATE *tt = 
# 63 "../crypto/asn1/tasn_new.c" 3 4
                             ((void *)0)
# 63 "../crypto/asn1/tasn_new.c"
                                 ;
    ...
    case 0x4:
        ef = it->funcs;
        if (ef != 
# 78 "../crypto/asn1/tasn_new.c" 3 4
                 ((void *)0)
# 78 "../crypto/asn1/tasn_new.c"
                     ) {
            if (ef->asn1_ex_new_ex != 
# 79 "../crypto/asn1/tasn_new.c" 3 4
                                     ((void *)0)
# 79 "../crypto/asn1/tasn_new.c"
                                         ) {
                if (!ef->asn1_ex_new_ex(pval, it, libctx, propq))
                    goto asn1err;
            } else if (ef->asn1_ex_new != 
# 82 "../crypto/asn1/tasn_new.c" 3 4
                                         ((void *)0)
# 82 "../crypto/asn1/tasn_new.c"
                                             ) {
    ...
    case 0x2:
        if (asn1_cb) {
            i = asn1_cb(0, pval, it, 
# 104 "../crypto/asn1/tasn_new.c" 3 4
                                                  ((void *)0)
# 104 "../crypto/asn1/tasn_new.c"
                                                      );
            if (!i)
                goto auxerr;
            if (i == 2) {
        ...
        if (embed) {
            ...
            *pval = CRYPTO_zalloc(it->size, "../crypto/asn1/tasn_new.c", 114);
            if (*pval == 
# 115 "../crypto/asn1/tasn_new.c" 3 4
                        ((void *)0)
# 115 "../crypto/asn1/tasn_new.c"
                            )
                return 0;
        }
        ossl_asn1_set_choice_selector(pval, -1, it);
        if (asn1_cb && !asn1_cb(1, pval, it, 
# 119 "../crypto/asn1/tasn_new.c" 3 4
                                                           ((void *)0)
# 119 "../crypto/asn1/tasn_new.c"
                                                               ))
            goto auxerr2;
        break;
    ...
    case 0x1:
        if (asn1_cb) {
            i = asn1_cb(0, pval, it, 
# 126 "../crypto/asn1/tasn_new.c" 3 4
                                                  ((void *)0)
# 126 "../crypto/asn1/tasn_new.c"
                                                      );
            if (!i)
                goto auxerr;
            if (i == 2) {
        ...
        if (embed) {
            ...
            *pval = CRYPTO_zalloc(it->size, "../crypto/asn1/tasn_new.c", 136);
            if (*pval == 
# 137 "../crypto/asn1/tasn_new.c" 3 4
                        ((void *)0)
# 137 "../crypto/asn1/tasn_new.c"
                            )
                return 0;
        }
        ...
        if (ossl_asn1_do_lock(pval, 0, it) < 0) {
            if (!embed) {
                CRYPTO_free(*pval, "../crypto/asn1/tasn_new.c", 143);
                *pval = 
# 144 "../crypto/asn1/tasn_new.c" 3 4
                       ((void *)0)
# 144 "../crypto/asn1/tasn_new.c"
                           ;
            }
            goto asn1err;
        }
        ...
        if (asn1_cb && !asn1_cb(1, pval, it, 
# 154 "../crypto/asn1/tasn_new.c" 3 4
                                                           ((void *)0)
# 154 "../crypto/asn1/tasn_new.c"
                                                               ))
            goto auxerr2;
        break;
    }
 ...
 asn1err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_new.c",163,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 163 "../crypto/asn1/tasn_new.c" 3 4
   ((void *)0)
# 163 "../crypto/asn1/tasn_new.c"
   );
    return 0;
 ...
 auxerr2:
    ossl_asn1_item_embed_free(pval, it, embed);
 auxerr:
    (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_new.c",169,__func__), ERR_set_error)((13),(100),
# 169 "../crypto/asn1/tasn_new.c" 3 4
   ((void *)0)
# 169 "../crypto/asn1/tasn_new.c"
   );
    return 0;
...
static void asn1_item_clear(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    case 0x4:
        ...
        if (ef && ef->asn1_ex_clear)
            ...
            *pval = 
# 185 "../crypto/asn1/tasn_new.c" 3 4
                   ((void *)0)
# 185 "../crypto/asn1/tasn_new.c"
                       ;
        break;
    ...
    case 0x6:
        *pval = 
# 202 "../crypto/asn1/tasn_new.c" 3 4
               ((void *)0)
# 202 "../crypto/asn1/tasn_new.c"
                   ;
        break;
    }
}
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (tt->flags & (0x3<<8)) {
        *pval = 
# 225 "../crypto/asn1/tasn_new.c" 3 4
               ((void *)0)
# 225 "../crypto/asn1/tasn_new.c"
                   ;
        return 1;
    }
    ...
    if (tt->flags & (0x3 << 1)) {
        ...
        skval = ((struct stack_st_ASN1_VALUE *)OPENSSL_sk_new_null());
        if (!skval) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_new.c",233,__func__), ERR_set_error)((13),((15 | (0x2 << 18L))),
# 233 "../crypto/asn1/tasn_new.c" 3 4
           ((void *)0)
# 233 "../crypto/asn1/tasn_new.c"
           );
            ret = 0;
            goto done;
        }
...
static void asn1_template_clear(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
    ...
    if (tt->flags & ((0x3<<8) | (0x3 << 1)))
        *pval = 
# 251 "../crypto/asn1/tasn_new.c" 3 4
               ((void *)0)
# 251 "../crypto/asn1/tasn_new.c"
                   ;
    else
                              ...
                              int embed)
{
    ...
    case -4:
        if ((typ = CRYPTO_malloc(sizeof(*typ), "../crypto/asn1/tasn_new.c", 301)) == 
# 301 "../crypto/asn1/tasn_new.c" 3 4
                                                   ((void *)0)
# 301 "../crypto/asn1/tasn_new.c"
                                                       )
            return 0;
        typ->value.ptr = 
# 303 "../crypto/asn1/tasn_new.c" 3 4
                        ((void *)0)
# 303 "../crypto/asn1/tasn_new.c"
                            ;
        typ->type = -1;
        *pval = (ASN1_VALUE *)typ;
        break;
...
static void asn1_primitive_clear(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (it && it->funcs) {
        ...
        if (pf->prim_clear)
            ...
            *pval = 
# 335 "../crypto/asn1/tasn_new.c" 3 4
                   ((void *)0)
# 335 "../crypto/asn1/tasn_new.c"
                       ;
        return;
    }
    if (!it || (it->itype == 0x5))
    ...
    if (utype == 1)
        ...
        *pval = 
# 345 "../crypto/asn1/tasn_new.c" 3 4
               ((void *)0)
# 345 "../crypto/asn1/tasn_new.c"
                   ;
}
