# 0 "../crypto/asn1/a_digest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_digest.c"
# 13 "../crypto/asn1/a_digest.c"
                ...
                unsigned char *md, unsigned int *len)
{
    ...
    inl = i2d(data, 
# 34 "../crypto/asn1/a_digest.c" 3 4
                   ((void *)0)
# 34 "../crypto/asn1/a_digest.c"
                       );
    if (inl <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_digest.c",36,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 36 "../crypto/asn1/a_digest.c" 3 4
       ((void *)0)
# 36 "../crypto/asn1/a_digest.c"
       );
        return 0;
    }
    if ((str = CRYPTO_malloc(inl, "../crypto/asn1/a_digest.c", 39)) == 
# 39 "../crypto/asn1/a_digest.c" 3 4
                                      ((void *)0)
# 39 "../crypto/asn1/a_digest.c"
                                          )
        return 0;
    p = str;
    i2d(data, &p);

    if (!EVP_Digest(str, inl, md, len, type, 
# 44 "../crypto/asn1/a_digest.c" 3 4
                                            ((void *)0)
# 44 "../crypto/asn1/a_digest.c"
                                                )) {
        CRYPTO_free(str, "../crypto/asn1/a_digest.c", 45);
        return 0;
    }
    CRYPTO_free(str, "../crypto/asn1/a_digest.c", 48);
    return 1;
}
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    int i, ret = 0;
    unsigned char *str = 
# 59 "../crypto/asn1/a_digest.c" 3 4
                        ((void *)0)
# 59 "../crypto/asn1/a_digest.c"
                            ;
    EVP_MD *fetched_md = (EVP_MD *)md;

    i = ASN1_item_i2d(asn, &str, it);
    if (i < 0 || str == 
# 63 "../crypto/asn1/a_digest.c" 3 4
                       ((void *)0)
# 63 "../crypto/asn1/a_digest.c"
                           )
        return 0;

    if (EVP_MD_get0_provider(md) == 
# 66 "../crypto/asn1/a_digest.c" 3 4
                                   ((void *)0)
# 66 "../crypto/asn1/a_digest.c"
                                       ) {

        ENGINE *tmpeng = ENGINE_get_digest_engine(EVP_MD_get_type(md));

        if (tmpeng != 
# 70 "../crypto/asn1/a_digest.c" 3 4
                     ((void *)0)
# 70 "../crypto/asn1/a_digest.c"
                         )
    ...
    if (fetched_md == 
# 76 "../crypto/asn1/a_digest.c" 3 4
                     ((void *)0)
# 76 "../crypto/asn1/a_digest.c"
                         )
        goto err;

    ret = EVP_Digest(str, i, data, len, fetched_md, 
# 79 "../crypto/asn1/a_digest.c" 3 4
                                                   ((void *)0)
# 79 "../crypto/asn1/a_digest.c"
                                                       );
err:
    CRYPTO_free(str, "../crypto/asn1/a_digest.c", 81);
    if (fetched_md != md)
...
int ASN1_item_digest(const ASN1_ITEM *it, const EVP_MD *md, void *asn,
                     unsigned char *data, unsigned int *len)
{
    return ossl_asn1_item_digest_ex(it, md, asn, data, len, 
# 90 "../crypto/asn1/a_digest.c" 3 4
                                                           ((void *)0)
# 90 "../crypto/asn1/a_digest.c"
                                                               , 
# 90 "../crypto/asn1/a_digest.c" 3 4
                                                                 ((void *)0)
# 90 "../crypto/asn1/a_digest.c"
