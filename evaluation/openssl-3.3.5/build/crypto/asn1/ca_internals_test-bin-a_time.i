# 0 "../crypto/asn1/a_time.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_time.c"
# 17 "../crypto/asn1/a_time.c"
...
int ossl_asn1_item_ex_new_intern(ASN1_VALUE **pval, const ASN1_ITEM *it,
                                 OSSL_LIB_CTX *libctx, const char *propq);
# 24 "../crypto/asn1/a_time.c" 2

const ASN1_ITEM * ASN1_TIME_it(void) { static const ASN1_ITEM local_it = { 0x5, 0x4000 | 0x8000, 
# 25 "../crypto/asn1/a_time.c" 3 4
((void *)0)
# 25 "../crypto/asn1/a_time.c"
, 0, 
# 25 "../crypto/asn1/a_time.c" 3 4
((void *)0)
# 25 "../crypto/asn1/a_time.c"
, sizeof(ASN1_STRING), "ASN1_TIME" }; return &local_it; }

ASN1_TIME *d2i_ASN1_TIME(ASN1_TIME **a, const unsigned char **in, long len) { return (ASN1_TIME *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (ASN1_TIME_it())); } int i2d_ASN1_TIME(const ASN1_TIME *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (ASN1_TIME_it())); } ASN1_TIME *ASN1_TIME_new(void) { return (ASN1_TIME *)ASN1_item_new((ASN1_TIME_it())); } void ASN1_TIME_free(ASN1_TIME *a) { ASN1_item_free((ASN1_VALUE *)a, (ASN1_TIME_it())); }
ASN1_TIME * ASN1_TIME_dup(const ASN1_TIME *x) { return ASN1_item_dup((ASN1_TIME_it()), x); }
...
# 97 "../crypto/asn1/a_time.c"
    ...
    if (a[o] == upper_z) {
        ...
        for (i = end; i < end + 2; i++) {
            ...
            if (tm != 
# 241 "../crypto/asn1/a_time.c" 3 4
                     ((void *)0)
# 241 "../crypto/asn1/a_time.c"
                         ) {
                if (i == end)
                    offset = n * 3600;
                else if (i == end + 1)
    ...
    if (o == l) {
        ...
        if (tm != 
# 257 "../crypto/asn1/a_time.c" 3 4
                 ((void *)0)
# 257 "../crypto/asn1/a_time.c"
                     )
            *tm = tmp;
        return 1;
    }
...
ASN1_TIME *ossl_asn1_time_from_tm(ASN1_TIME *s, struct tm *ts, int type)
{
    char* p;
    ASN1_TIME *tmps = 
# 268 "../crypto/asn1/a_time.c" 3 4
                     ((void *)0)
# 268 "../crypto/asn1/a_time.c"
                         ;
    const size_t len = 20;
    ...
    if (s == 
# 283 "../crypto/asn1/a_time.c" 3 4
            ((void *)0)
# 283 "../crypto/asn1/a_time.c"
                )
        tmps = ASN1_STRING_new();
    else
        tmps = s;
    if (tmps == 
# 287 "../crypto/asn1/a_time.c" 3 4
               ((void *)0)
# 287 "../crypto/asn1/a_time.c"
                   )
        return 
# 288 "../crypto/asn1/a_time.c" 3 4
              ((void *)0)
# 288 "../crypto/asn1/a_time.c"
                  ;

    if (!ASN1_STRING_set(tmps, 
# 290 "../crypto/asn1/a_time.c" 3 4
                              ((void *)0)
# 290 "../crypto/asn1/a_time.c"
                                  , len))
        goto err;
    ...
    if (ts->tm_mon > 0x7fffffff 
# 296 "../crypto/asn1/a_time.c"
                            - 1)
        goto err;

    if (type == 24) {
        if (ts->tm_year > 0x7fffffff 
# 300 "../crypto/asn1/a_time.c"
                                 - 1900)
            goto err;
 ...
 err:
    ...
    return 
# 320 "../crypto/asn1/a_time.c" 3 4
          ((void *)0)
# 320 "../crypto/asn1/a_time.c"
              ;
}
                         ...
                         int offset_day, long offset_sec)
{
    ...
    if (ts == 
# 335 "../crypto/asn1/a_time.c" 3 4
             ((void *)0)
# 335 "../crypto/asn1/a_time.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_time.c",336,__func__), ERR_set_error)((13),(173),
# 336 "../crypto/asn1/a_time.c" 3 4
       ((void *)0)
# 336 "../crypto/asn1/a_time.c"
       );
        return 
# 337 "../crypto/asn1/a_time.c" 3 4
              ((void *)0)
# 337 "../crypto/asn1/a_time.c"
                  ;
    }
    if (offset_day || offset_sec) {
        if (!OPENSSL_gmtime_adj(ts, offset_day, offset_sec))
            return 
# 341 "../crypto/asn1/a_time.c" 3 4
                  ((void *)0)
# 341 "../crypto/asn1/a_time.c"
                      ;
    }
    return ossl_asn1_time_from_tm(s, ts, -1);
}
...
# 359 "../crypto/asn1/a_time.c" 3 4
                               ((void *)0)
# 359 "../crypto/asn1/a_time.c"
                                   ;
    struct tm tm;

    if (!ASN1_TIME_to_tm(t, &tm))
        return 
# 363 "../crypto/asn1/a_time.c" 3 4
              ((void *)0)
# 363 "../crypto/asn1/a_time.c"
                  ;

    if (out != 
# 365 "../crypto/asn1/a_time.c" 3 4
              ((void *)0)
# 365 "../crypto/asn1/a_time.c"
                  )
        ret = *out;

    ret = ossl_asn1_time_from_tm(ret, &tm, 24);

    if (out != 
# 370 "../crypto/asn1/a_time.c" 3 4
              ((void *)0) 
# 370 "../crypto/asn1/a_time.c"
                   && ret != 
# 370 "../crypto/asn1/a_time.c" 3 4
                             ((void *)0)
# 370 "../crypto/asn1/a_time.c"
...
# 416 "../crypto/asn1/a_time.c"
    if (s != 
# 416 "../crypto/asn1/a_time.c" 3 4
            ((void *)0) 
# 416 "../crypto/asn1/a_time.c"
                 && t.type == 24) {
        ...
        if (is_utc(tm.tm_year)) {
            ...
            t.data = CRYPTO_zalloc(t.length + 1, "../crypto/asn1/a_time.c", 426);
            if (t.data == 
# 427 "../crypto/asn1/a_time.c" 3 4
                         ((void *)0)
# 427 "../crypto/asn1/a_time.c"
                             )
                goto out;
    ...
    if (s == 
# 434 "../crypto/asn1/a_time.c" 3 4
            ((void *)0) 
# 434 "../crypto/asn1/a_time.c"
                 || ASN1_STRING_copy((ASN1_STRING *)s, (ASN1_STRING *)&t))
        rv = 1;

    if (t.data != (unsigned char *)str)
        CRYPTO_free(t.data, "../crypto/asn1/a_time.c", 438);
out:
    return rv;
}
...
{
    if (s == 
# 445 "../crypto/asn1/a_time.c" 3 4
            ((void *)0)
# 445 "../crypto/asn1/a_time.c"
                ) {
        time_t now_t;
...
# 450 "../crypto/asn1/a_time.c" 3 4
                                         ((void *)0)
# 450 "../crypto/asn1/a_time.c"
                                             )
            return 1;
        return 0;
    }
...
int ASN1_TIME_print(BIO *bp, const ASN1_TIME *tm)
{
    return ASN1_TIME_print_ex(bp, tm, 0x00UL);
}
...
int ossl_asn1_time_print_ex(BIO *bp, const ASN1_TIME *tm, unsigned long flags)
{
    ...
    if (tm->type == 24) {
        char *f = 
# 505 "../crypto/asn1/a_time.c" 3 4
                 ((void *)0)
# 505 "../crypto/asn1/a_time.c"
                     ;
        int f_len = 0;
...
int ASN1_TIME_normalize(ASN1_TIME *t)
{
    ...
    if (t == 
# 571 "../crypto/asn1/a_time.c" 3 4
            ((void *)0) 
# 571 "../crypto/asn1/a_time.c"
                 || !ASN1_TIME_to_tm(t, &tm))
        return 0;

    return ossl_asn1_time_from_tm(t, &tm, -1) != 
# 574 "../crypto/asn1/a_time.c" 3 4
                                                          ((void *)0)
# 574 "../crypto/asn1/a_time.c"
                                                              ;
}
...
# 601 "../crypto/asn1/a_time.c"
time_t ossl_asn1_string_to_time_t(const char *asn1_string)
{
    ASN1_TIME *timestamp_asn1 = 
# 603 "../crypto/asn1/a_time.c" 3 4
                               ((void *)0)
# 603 "../crypto/asn1/a_time.c"
                                   ;
    struct tm *timestamp_tm = 
# 604 "../crypto/asn1/a_time.c" 3 4
                             ((void *)0)
# 604 "../crypto/asn1/a_time.c"
                                 ;
    ...
    timestamp_tm = CRYPTO_malloc(sizeof(*timestamp_tm), "../crypto/asn1/a_time.c", 619);
    if (timestamp_tm == 
# 620 "../crypto/asn1/a_time.c" 3 4
                       ((void *)0)
# 620 "../crypto/asn1/a_time.c"
                           ) {
        ASN1_TIME_free(timestamp_asn1);
        return -1;
    }
    if (!(ASN1_TIME_to_tm(timestamp_asn1, timestamp_tm))) {
        CRYPTO_free(timestamp_tm, "../crypto/asn1/a_time.c", 625);
        ASN1_TIME_free(timestamp_asn1);
        return -1;
    }
    ASN1_TIME_free(timestamp_asn1);
# 657 "../crypto/asn1/a_time.c"
    timestamp_local = mktime(timestamp_tm);
    timestamp_utc = timestamp_local - timezone;

    CRYPTO_free(timestamp_tm, "../crypto/asn1/a_time.c", 660);
