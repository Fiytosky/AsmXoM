# 0 "../crypto/asn1/a_type.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_type.c"
# 10 "../crypto/asn1/a_type.c"
...
int ASN1_TYPE_get(const ASN1_TYPE *a)
{
    if (a->type == 1
            || a->type == 5
            || a->value.ptr != 
# 20 "../crypto/asn1/a_type.c" 3 4
                              ((void *)0)
# 20 "../crypto/asn1/a_type.c"
                                  )
        return a->type;
    else
        return 0;
...
void ASN1_TYPE_set(ASN1_TYPE *a, int type, void *value)
{
    if (a->type != 1
            && a->type != 5
            && a->value.ptr != 
# 30 "../crypto/asn1/a_type.c" 3 4
                              ((void *)0)
# 30 "../crypto/asn1/a_type.c"
                                  ) {
        ASN1_TYPE **tmp_a = &a;
        ossl_asn1_primitive_free((ASN1_VALUE **)tmp_a, 
# 32 "../crypto/asn1/a_type.c" 3 4
                                                      ((void *)0)
# 32 "../crypto/asn1/a_type.c"
                                                          , 0);
    }
    a->type = type;
    if (type == 1)
...
ASN1_TYPE *ASN1_TYPE_pack_sequence(const ASN1_ITEM *it, void *s, ASN1_TYPE **t)
{
    ...
    oct = ASN1_item_pack(s, it, 
# 114 "../crypto/asn1/a_type.c" 3 4
                               ((void *)0)
# 114 "../crypto/asn1/a_type.c"
                                   );
    if (oct == 
# 115 "../crypto/asn1/a_type.c" 3 4
              ((void *)0)
# 115 "../crypto/asn1/a_type.c"
                  )
        return 
# 116 "../crypto/asn1/a_type.c" 3 4
              ((void *)0)
# 116 "../crypto/asn1/a_type.c"
                  ;
    ...
    if (t && *t) {
        ...
        rt = ASN1_TYPE_new();
        if (rt == 
# 122 "../crypto/asn1/a_type.c" 3 4
                 ((void *)0)
# 122 "../crypto/asn1/a_type.c"
                     ) {
            ASN1_OCTET_STRING_free(oct);
            return 
# 124 "../crypto/asn1/a_type.c" 3 4
                  ((void *)0)
# 124 "../crypto/asn1/a_type.c"
                      ;
        }
        if (t)
            *t = rt;
    }
    ASN1_TYPE_set(rt, 16, oct);
    return rt;
}
...
{
    if (t == 
# 135 "../crypto/asn1/a_type.c" 3 4
            ((void *)0) 
# 135 "../crypto/asn1/a_type.c"
                 || t->type != 16 || t->value.sequence == 
# 135 "../crypto/asn1/a_type.c" 3 4
                                                                       ((void *)0)
# 135 "../crypto/asn1/a_type.c"
                                                                           )
        return 
# 136 "../crypto/asn1/a_type.c" 3 4
              ((void *)0)
# 136 "../crypto/asn1/a_type.c"
                  ;
