# 0 "../crypto/asn1/a_strnid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_strnid.c"
# 10 "../crypto/asn1/a_strnid.c"
...
# 14 "../crypto/asn1/a_strnid.c" 2

static struct stack_st_ASN1_STRING_TABLE *stable = 
# 15 "../crypto/asn1/a_strnid.c" 3 4
                                            ((void *)0)
# 15 "../crypto/asn1/a_strnid.c"
                                                ;
...
# 48 "../crypto/asn1/a_strnid.c"
int ASN1_STRING_set_default_mask_asc(const char *p)
{
    unsigned long mask;
    char *end;

    if (((strncmp(p, "MASK:" "", sizeof("MASK:") - 1) == 0) ? ((p) += sizeof("MASK:") - 1, 1) : 0)) {
        if (*p == '\0')
            return 0;
                                    ...
                                    int inform, int nid)
{
    ...
    ASN1_STRING *str = 
# 84 "../crypto/asn1/a_strnid.c" 3 4
                      ((void *)0)
# 84 "../crypto/asn1/a_strnid.c"
                          ;
    unsigned long mask;
    int ret;

    if (out == 
# 88 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 88 "../crypto/asn1/a_strnid.c"
                  )
        out = &str;
    tbl = ASN1_STRING_TABLE_get(nid);
    if (tbl != 
# 91 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 91 "../crypto/asn1/a_strnid.c"
                  ) {
        mask = tbl->mask;
        if (!(tbl->flags & 0x02))
            mask &= global_mask;
    ...
    if (ret <= 0)
        return 
# 102 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 102 "../crypto/asn1/a_strnid.c"
                  ;
    return *out;
}
...
# 1 "../crypto/asn1/tbl_standard.h" 1
# 28 "../crypto/asn1/tbl_standard.h"
...
# 134 "../crypto/asn1/a_strnid.c" 3 4
                                                 ((void *)0)
# 134 "../crypto/asn1/a_strnid.c"
                                                     );


    fnd.nid = nid;
    if (stable != 
# 138 "../crypto/asn1/a_strnid.c" 3 4
                 ((void *)0)
# 138 "../crypto/asn1/a_strnid.c"
                     ) {

        OPENSSL_sk_sort(ossl_check_ASN1_STRING_TABLE_sk_type(stable));
        idx = OPENSSL_sk_find(ossl_check_ASN1_STRING_TABLE_sk_type(stable), ossl_check_ASN1_STRING_TABLE_type(&fnd));
        if (idx >= 0)
            return ((ASN1_STRING_TABLE *)OPENSSL_sk_value(ossl_check_const_ASN1_STRING_TABLE_sk_type(stable), (idx)));
    }
    return OBJ_bsearch_table(&fnd, tbl_standard, (sizeof(tbl_standard)/sizeof((tbl_standard)[0])));
}
...
static ASN1_STRING_TABLE *stable_get(int nid)
{
    ...
    if (stable == 
# 158 "../crypto/asn1/a_strnid.c" 3 4
                 ((void *)0)
# 158 "../crypto/asn1/a_strnid.c"
                     ) {
        stable = ((struct stack_st_ASN1_STRING_TABLE *)OPENSSL_sk_new(ossl_check_ASN1_STRING_TABLE_compfunc_type(sk_table_cmp)));
        if (stable == 
# 160 "../crypto/asn1/a_strnid.c" 3 4
                     ((void *)0)
# 160 "../crypto/asn1/a_strnid.c"
                         )
            return 
# 161 "../crypto/asn1/a_strnid.c" 3 4
                  ((void *)0)
# 161 "../crypto/asn1/a_strnid.c"
                      ;
    }
    tmp = ASN1_STRING_TABLE_get(nid);
    if (tmp != 
# 164 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0) 
# 164 "../crypto/asn1/a_strnid.c"
                   && tmp->flags & 0x01)
        return tmp;
    if ((rv = CRYPTO_zalloc(sizeof(*rv), "../crypto/asn1/a_strnid.c", 166)) == 
# 166 "../crypto/asn1/a_strnid.c" 3 4
                                             ((void *)0)
# 166 "../crypto/asn1/a_strnid.c"
                                                 )
        return 
# 167 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 167 "../crypto/asn1/a_strnid.c"
                  ;
    if (!OPENSSL_sk_push(ossl_check_ASN1_STRING_TABLE_sk_type(stable), ossl_check_ASN1_STRING_TABLE_type(rv))) {
        CRYPTO_free(rv, "../crypto/asn1/a_strnid.c", 169);
        return 
# 170 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 170 "../crypto/asn1/a_strnid.c"
                  ;
    }
    if (tmp != 
# 172 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 172 "../crypto/asn1/a_strnid.c"
                  ) {
        rv->nid = tmp->nid;
        rv->minsize = tmp->minsize;
        rv->maxsize = tmp->maxsize;
        rv->mask = tmp->mask;
        rv->flags = tmp->flags | 0x01;
    } else {
        rv->nid = nid;
        rv->minsize = -1;
        rv->maxsize = -1;
                          ...
                          unsigned long flags)
{
    ...
    tmp = stable_get(nid);
    if (tmp == 
# 194 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 194 "../crypto/asn1/a_strnid.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_strnid.c",195,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 195 "../crypto/asn1/a_strnid.c" 3 4
       ((void *)0)
# 195 "../crypto/asn1/a_strnid.c"
       );
        return 0;
    }
    if (minsize >= 0)
...
void ASN1_STRING_TABLE_cleanup(void)
{
    ...
    tmp = stable;
    if (tmp == 
# 214 "../crypto/asn1/a_strnid.c" 3 4
              ((void *)0)
# 214 "../crypto/asn1/a_strnid.c"
                  )
        return;
    stable = 
# 216 "../crypto/asn1/a_strnid.c" 3 4
            ((void *)0)
# 216 "../crypto/asn1/a_strnid.c"
                ;
    OPENSSL_sk_pop_free(ossl_check_ASN1_STRING_TABLE_sk_type(tmp),ossl_check_ASN1_STRING_TABLE_freefunc_type(st_free));
}

static void st_free(ASN1_STRING_TABLE *tbl)
{
    if (tbl->flags & 0x01)
        CRYPTO_free(tbl, "../crypto/asn1/a_strnid.c", 223);
}
