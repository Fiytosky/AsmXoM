# 0 "../crypto/asn1/d2i_pu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/d2i_pu.c"
# 14 "../crypto/asn1/d2i_pu.c"
                        ...
                        long length)
{
    EVP_PKEY *ret;
    EVP_PKEY *copy = 
# 32 "../crypto/asn1/d2i_pu.c" 3 4
                    ((void *)0)
# 32 "../crypto/asn1/d2i_pu.c"
                        ;

    if ((a == 
# 34 "../crypto/asn1/d2i_pu.c" 3 4
             ((void *)0)
# 34 "../crypto/asn1/d2i_pu.c"
                 ) || (*a == 
# 34 "../crypto/asn1/d2i_pu.c" 3 4
                             ((void *)0)
# 34 "../crypto/asn1/d2i_pu.c"
        ...
        if ((ret = EVP_PKEY_new()) == 
# 35 "../crypto/asn1/d2i_pu.c" 3 4
                                     ((void *)0)
# 35 "../crypto/asn1/d2i_pu.c"
                                         ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",36,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 36 "../crypto/asn1/d2i_pu.c" 3 4
           ((void *)0)
# 36 "../crypto/asn1/d2i_pu.c"
           );
            return 
# 37 "../crypto/asn1/d2i_pu.c" 3 4
                  ((void *)0)
# 37 "../crypto/asn1/d2i_pu.c"
                      ;
        }
    } else {
        ret = *a;
        ...
        if (((ret)->keymgmt != 
# 43 "../crypto/asn1/d2i_pu.c" 3 4
           ((void *)0)
# 43 "../crypto/asn1/d2i_pu.c"
           )
            && EVP_PKEY_get_base_id(ret) == 408) {
    ...
    if ((type != EVP_PKEY_get_id(ret) || copy != 
# 51 "../crypto/asn1/d2i_pu.c" 3 4
                                                ((void *)0)
# 51 "../crypto/asn1/d2i_pu.c"
                                                    )
        && !EVP_PKEY_set_type(ret, type)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",53,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 53 "../crypto/asn1/d2i_pu.c" 3 4
       ((void *)0)
# 53 "../crypto/asn1/d2i_pu.c"
       );
        goto err;
    }
...
# 59 "../crypto/asn1/d2i_pu.c" 3 4
                                             ((void *)0)
# 59 "../crypto/asn1/d2i_pu.c"
                                                 , pp, length)) == 
# 59 "../crypto/asn1/d2i_pu.c" 3 4
                                                                   ((void *)0)
# 59 "../crypto/asn1/d2i_pu.c"
                                                                       ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",60,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 60 "../crypto/asn1/d2i_pu.c" 3 4
           ((void *)0)
# 60 "../crypto/asn1/d2i_pu.c"
           );
            goto err;
        }
        break;
    ...
    case 116:
        if (!d2i_DSAPublicKey(&ret->pkey.dsa, pp, length)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",67,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 67 "../crypto/asn1/d2i_pu.c" 3 4
           ((void *)0)
# 67 "../crypto/asn1/d2i_pu.c"
           );
            goto err;
        }
        break;
    ...
    case 408:
        if (copy != 
# 74 "../crypto/asn1/d2i_pu.c" 3 4
                   ((void *)0)
# 74 "../crypto/asn1/d2i_pu.c"
                       ) {

            ret->pkey.ec = copy->pkey.ec;
            copy->pkey.ec = 
# 77 "../crypto/asn1/d2i_pu.c" 3 4
                           ((void *)0)
# 77 "../crypto/asn1/d2i_pu.c"
                               ;
        }
        if (!o2i_ECPublicKey(&ret->pkey.ec, pp, length)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",80,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 80 "../crypto/asn1/d2i_pu.c" 3 4
           ((void *)0)
# 80 "../crypto/asn1/d2i_pu.c"
           );
            goto err;
        }
        break;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pu.c",86,__func__), ERR_set_error)((13),(163),
# 86 "../crypto/asn1/d2i_pu.c" 3 4
       ((void *)0)
# 86 "../crypto/asn1/d2i_pu.c"
       );
        goto err;
    }
    if (a != 
# 89 "../crypto/asn1/d2i_pu.c" 3 4
            ((void *)0)
# 89 "../crypto/asn1/d2i_pu.c"
                )
        (*a) = ret;
    EVP_PKEY_free(copy);
    return ret;
 err:
    if (a == 
# 94 "../crypto/asn1/d2i_pu.c" 3 4
            ((void *)0) 
# 94 "../crypto/asn1/d2i_pu.c"
                 || *a != ret)
        EVP_PKEY_free(ret);
    EVP_PKEY_free(copy);
    return 
# 97 "../crypto/asn1/d2i_pu.c" 3 4
          ((void *)0)
# 97 "../crypto/asn1/d2i_pu.c"
              ;
}
