# 0 "../crypto/asn1/asn_moid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn_moid.c"
# 10 "../crypto/asn1/asn_moid.c"
...
# 31 "../crypto/asn1/asn_moid.c" 3 4
                                                        ((void *)0)
# 31 "../crypto/asn1/asn_moid.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_moid.c",32,__func__), ERR_set_error)((13),(172),
# 32 "../crypto/asn1/asn_moid.c" 3 4
       ((void *)0)
# 32 "../crypto/asn1/asn_moid.c"
       );
        return 0;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sktmp)); i++) {
        ...
        if (!do_create(oval->value, oval->name)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_moid.c",38,__func__), ERR_set_error)((13),(171),
# 38 "../crypto/asn1/asn_moid.c" 3 4
           ((void *)0)
# 38 "../crypto/asn1/asn_moid.c"
           );
            return 0;
        }
    }
...
static int do_create(const char *value, const char *name)
{
    ...
    char *lntmp = 
# 64 "../crypto/asn1/asn_moid.c" 3 4
                 ((void *)0)
# 64 "../crypto/asn1/asn_moid.c"
                     ;

    p = strrchr(value, ',');
    if (p == 
# 67 "../crypto/asn1/asn_moid.c" 3 4
            ((void *)0)
# 67 "../crypto/asn1/asn_moid.c"
                ) {
        ln = name;
        ostr = value;
    } else if (p == value) {
        ...
        if (*ostr == '\0')
            return 0;
        while ((ossl_ctype_check((*ostr), 0x8)))
            ostr++;
        while ((ossl_ctype_check((*ln), 0x8)))
            ln++;
        p--;
        ...
        p++;
        if ((lntmp = CRYPTO_malloc((p - ln) + 1, "../crypto/asn1/asn_moid.c", 90)) == 
# 90 "../crypto/asn1/asn_moid.c" 3 4
                                                     ((void *)0)
# 90 "../crypto/asn1/asn_moid.c"
                                                         )
            return 0;
    ...
    CRYPTO_free(lntmp, "../crypto/asn1/asn_moid.c", 99);
