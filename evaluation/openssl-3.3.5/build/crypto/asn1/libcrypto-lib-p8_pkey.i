# 0 "../crypto/asn1/p8_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/p8_pkey.c"
# 10 "../crypto/asn1/p8_pkey.c"
...
# 29 "../crypto/asn1/p8_pkey.c" 3 4
((void *)0)
# 29 "../crypto/asn1/p8_pkey.c"
, 0, 0, 0, pkey_cb, 0, 
# 29 "../crypto/asn1/p8_pkey.c" 3 4
((void *)0)
# 29 "../crypto/asn1/p8_pkey.c"
        ...
        { (0), (0), 
# 30 "../crypto/asn1/p8_pkey.c" 3 4
       __builtin_offsetof (
# 30 "../crypto/asn1/p8_pkey.c"
       PKCS8_PRIV_KEY_INFO
# 30 "../crypto/asn1/p8_pkey.c" 3 4
       , 
# 30 "../crypto/asn1/p8_pkey.c"
...
# 30 "../crypto/asn1/p8_pkey.c"
       , "version", (ASN1_INTEGER_it) },
        { (0), (0), 
# 31 "../crypto/asn1/p8_pkey.c" 3 4
       __builtin_offsetof (
# 31 "../crypto/asn1/p8_pkey.c"
       PKCS8_PRIV_KEY_INFO
# 31 "../crypto/asn1/p8_pkey.c" 3 4
       , 
# 31 "../crypto/asn1/p8_pkey.c"
...
# 31 "../crypto/asn1/p8_pkey.c"
       , "pkeyalg", (X509_ALGOR_it) },
        { (0), (0), 
# 32 "../crypto/asn1/p8_pkey.c" 3 4
       __builtin_offsetof (
# 32 "../crypto/asn1/p8_pkey.c"
       PKCS8_PRIV_KEY_INFO
# 32 "../crypto/asn1/p8_pkey.c" 3 4
       , 
# 32 "../crypto/asn1/p8_pkey.c"
...
# 32 "../crypto/asn1/p8_pkey.c"
       , "pkey", (ASN1_OCTET_STRING_it) },
        { (((0x1 << 3)|(0x2<<6)) | ((0x1 << 1)|(0x1))), (0), 
# 33 "../crypto/asn1/p8_pkey.c" 3 4
       __builtin_offsetof (
# 33 "../crypto/asn1/p8_pkey.c"
       PKCS8_PRIV_KEY_INFO
# 33 "../crypto/asn1/p8_pkey.c" 3 4
       , 
# 33 "../crypto/asn1/p8_pkey.c"
...
} ; const ASN1_ITEM * PKCS8_PRIV_KEY_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKCS8_PRIV_KEY_INFO_seq_tt, sizeof(PKCS8_PRIV_KEY_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), &PKCS8_PRIV_KEY_INFO_aux, sizeof(PKCS8_PRIV_KEY_INFO), "PKCS8_PRIV_KEY_INFO" }; return &local_it; }

PKCS8_PRIV_KEY_INFO *d2i_PKCS8_PRIV_KEY_INFO(PKCS8_PRIV_KEY_INFO **a, const unsigned char **in, long len) { return (PKCS8_PRIV_KEY_INFO *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKCS8_PRIV_KEY_INFO_it())); } int i2d_PKCS8_PRIV_KEY_INFO(const PKCS8_PRIV_KEY_INFO *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKCS8_PRIV_KEY_INFO_it())); } PKCS8_PRIV_KEY_INFO *PKCS8_PRIV_KEY_INFO_new(void) { return (PKCS8_PRIV_KEY_INFO *)ASN1_item_new((PKCS8_PRIV_KEY_INFO_it())); } void PKCS8_PRIV_KEY_INFO_free(PKCS8_PRIV_KEY_INFO *a) { ASN1_item_free((ASN1_VALUE *)a, (PKCS8_PRIV_KEY_INFO_it())); }
...
int PKCS8_pkey_add1_attr_by_NID(PKCS8_PRIV_KEY_INFO *p8, int nid, int type,
                                const unsigned char *bytes, int len)
{
    if (X509at_add1_attr_by_NID(&p8->attributes, nid, type, bytes, len) != 
# 77 "../crypto/asn1/p8_pkey.c" 3 4
                                                                          ((void *)0)
# 77 "../crypto/asn1/p8_pkey.c"
                                                                              )
        return 1;
    return 0;
}
...
# 85 "../crypto/asn1/p8_pkey.c" 3 4
                                                                              ((void *)0)
# 85 "../crypto/asn1/p8_pkey.c"
                                                                                  );
}

int PKCS8_pkey_add1_attr(PKCS8_PRIV_KEY_INFO *p8, X509_ATTRIBUTE *attr)
{
    return (X509at_add1_attr(&p8->attributes, attr) != 
# 90 "../crypto/asn1/p8_pkey.c" 3 4
                                                      ((void *)0)
