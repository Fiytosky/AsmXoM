# 0 "../crypto/asn1/bio_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/bio_asn1.c"
# 16 "../crypto/asn1/bio_asn1.c"
...
{
    BIO_ASN1_BUF_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/asn1/bio_asn1.c", 101);

    if (ctx == 
# 103 "../crypto/asn1/bio_asn1.c" 3 4
              ((void *)0)
# 103 "../crypto/asn1/bio_asn1.c"
                  )
        return 0;
    if (!asn1_bio_init(ctx, 20)) {
        CRYPTO_free(ctx, "../crypto/asn1/bio_asn1.c", 106);
        return 0;
    }
    BIO_set_data(b, ctx);
    BIO_set_init(b, 1);
...
{
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/bio_asn1.c",118,__func__), ERR_set_error)((13),((262|(0x2 << 18L))),
# 118 "../crypto/asn1/bio_asn1.c" 3 4
       ((void *)0)
# 118 "../crypto/asn1/bio_asn1.c"
       );
        return 0;
    }
    if ((ctx->buf = CRYPTO_malloc(size, "../crypto/asn1/bio_asn1.c", 121)) == 
# 121 "../crypto/asn1/bio_asn1.c" 3 4
                                            ((void *)0)
# 121 "../crypto/asn1/bio_asn1.c"
                                                )
        return 0;
    ctx->bufsize = size;
    ctx->asn1_class = 0x00;
...
static int asn1_bio_free(BIO *b)
{
    ...
    if (b == 
# 134 "../crypto/asn1/bio_asn1.c" 3 4
            ((void *)0)
# 134 "../crypto/asn1/bio_asn1.c"
                )
        return 0;

    ctx = BIO_get_data(b);
    if (ctx == 
# 138 "../crypto/asn1/bio_asn1.c" 3 4
              ((void *)0)
# 138 "../crypto/asn1/bio_asn1.c"
                  )
        return 0;

    if (ctx->prefix_free != 
# 141 "../crypto/asn1/bio_asn1.c" 3 4
                           ((void *)0)
# 141 "../crypto/asn1/bio_asn1.c"
                               )
        ctx->prefix_free(b, &ctx->ex_buf, &ctx->ex_len, &ctx->ex_arg);
    if (ctx->suffix_free != 
# 143 "../crypto/asn1/bio_asn1.c" 3 4
                           ((void *)0)
# 143 "../crypto/asn1/bio_asn1.c"
                               )
        ctx->suffix_free(b, &ctx->ex_buf, &ctx->ex_len, &ctx->ex_arg);

    CRYPTO_free(ctx->buf, "../crypto/asn1/bio_asn1.c", 146);
    CRYPTO_free(ctx, "../crypto/asn1/bio_asn1.c", 147);
    BIO_set_data(b, 
# 148 "../crypto/asn1/bio_asn1.c" 3 4
                   ((void *)0)
# 148 "../crypto/asn1/bio_asn1.c"
                       );
    BIO_set_init(b, 0);
...
static int asn1_bio_write(BIO *b, const char *in, int inl)
{
    ...
    next = BIO_next(b);
    if (in == 
# 163 "../crypto/asn1/bio_asn1.c" 3 4
             ((void *)0) 
# 163 "../crypto/asn1/bio_asn1.c"
                  || inl < 0 || ctx == 
# 163 "../crypto/asn1/bio_asn1.c" 3 4
                                       ((void *)0) 
# 163 "../crypto/asn1/bio_asn1.c"
...
# 163 "../crypto/asn1/bio_asn1.c"
    ...
    for (;;) {
        ...
        case ASN1_STATE_HEADER:
            ...
            if (!__builtin_expect(!!((ctx->buflen <= ctx->bufsize) != 0), 1))
                return -1;
            p = ctx->buf;
...
static int asn1_bio_read(BIO *b, char *in, int inl)
{
    BIO *next = BIO_next(b);
    if (next == 
# 298 "../crypto/asn1/bio_asn1.c" 3 4
               ((void *)0)
# 298 "../crypto/asn1/bio_asn1.c"
                   )
        return 0;
...
static int asn1_bio_gets(BIO *b, char *str, int size)
{
    BIO *next = BIO_next(b);
    if (next == 
# 311 "../crypto/asn1/bio_asn1.c" 3 4
               ((void *)0)
# 311 "../crypto/asn1/bio_asn1.c"
                   )
        return 0;
...
static long asn1_bio_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    BIO *next = BIO_next(b);
    if (next == 
# 319 "../crypto/asn1/bio_asn1.c" 3 4
               ((void *)0)
# 319 "../crypto/asn1/bio_asn1.c"
                   )
        return 0;
...
static long asn1_bio_ctrl(BIO *b, int cmd, long arg1, void *arg2)
{
    ...
    ctx = BIO_get_data(b);
    if (ctx == 
# 332 "../crypto/asn1/bio_asn1.c" 3 4
              ((void *)0)
# 332 "../crypto/asn1/bio_asn1.c"
                  )
        return 0;
    next = BIO_next(b);
    switch (cmd) {
    ...
    case 11:
        if (next == 
# 370 "../crypto/asn1/bio_asn1.c" 3 4
                   ((void *)0)
# 370 "../crypto/asn1/bio_asn1.c"
    ...
    default:
        if (next == 
# 395 "../crypto/asn1/bio_asn1.c" 3 4
                   ((void *)0)
# 395 "../crypto/asn1/bio_asn1.c"
                       )
            return 0;
        return BIO_ctrl(next, cmd, arg1, arg2);
