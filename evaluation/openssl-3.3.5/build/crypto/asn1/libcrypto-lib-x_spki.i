# 0 "../crypto/asn1/x_spki.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_spki.c"
# 10 "../crypto/asn1/x_spki.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 14 "../crypto/asn1/x_spki.c" 2

static const ASN1_TEMPLATE NETSCAPE_SPKAC_seq_tt[] = {
        { (0), (0), 
# 16 "../crypto/asn1/x_spki.c" 3 4
       __builtin_offsetof (
# 16 "../crypto/asn1/x_spki.c"
       NETSCAPE_SPKAC
# 16 "../crypto/asn1/x_spki.c" 3 4
       , 
# 16 "../crypto/asn1/x_spki.c"
...
# 16 "../crypto/asn1/x_spki.c"
       , "pubkey", (X509_PUBKEY_it) },
        { (0), (0), 
# 17 "../crypto/asn1/x_spki.c" 3 4
       __builtin_offsetof (
# 17 "../crypto/asn1/x_spki.c"
       NETSCAPE_SPKAC
# 17 "../crypto/asn1/x_spki.c" 3 4
       , 
# 17 "../crypto/asn1/x_spki.c"
...
# 17 "../crypto/asn1/x_spki.c"
       , "challenge", (ASN1_IA5STRING_it) }
} ; const ASN1_ITEM * NETSCAPE_SPKAC_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, NETSCAPE_SPKAC_seq_tt, sizeof(NETSCAPE_SPKAC_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 18 "../crypto/asn1/x_spki.c" 3 4
 ((void *)0)
# 18 "../crypto/asn1/x_spki.c"
 , sizeof(NETSCAPE_SPKAC), "NETSCAPE_SPKAC" }; return &local_it; }

NETSCAPE_SPKAC *d2i_NETSCAPE_SPKAC(NETSCAPE_SPKAC **a, const unsigned char **in, long len) { return (NETSCAPE_SPKAC *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (NETSCAPE_SPKAC_it())); } int i2d_NETSCAPE_SPKAC(const NETSCAPE_SPKAC *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (NETSCAPE_SPKAC_it())); } NETSCAPE_SPKAC *NETSCAPE_SPKAC_new(void) { return (NETSCAPE_SPKAC *)ASN1_item_new((NETSCAPE_SPKAC_it())); } void NETSCAPE_SPKAC_free(NETSCAPE_SPKAC *a) { ASN1_item_free((ASN1_VALUE *)a, (NETSCAPE_SPKAC_it())); }

static const ASN1_TEMPLATE NETSCAPE_SPKI_seq_tt[] = {
        { (0), (0), 
# 23 "../crypto/asn1/x_spki.c" 3 4
       __builtin_offsetof (
# 23 "../crypto/asn1/x_spki.c"
       NETSCAPE_SPKI
# 23 "../crypto/asn1/x_spki.c" 3 4
       , 
# 23 "../crypto/asn1/x_spki.c"
...
# 23 "../crypto/asn1/x_spki.c"
       , "spkac", (NETSCAPE_SPKAC_it) },
        { ((0x1 << 12)), (0), 
# 24 "../crypto/asn1/x_spki.c" 3 4
       __builtin_offsetof (
# 24 "../crypto/asn1/x_spki.c"
       NETSCAPE_SPKI
# 24 "../crypto/asn1/x_spki.c" 3 4
       , 
# 24 "../crypto/asn1/x_spki.c"
...
# 24 "../crypto/asn1/x_spki.c"
       , "sig_algor", (X509_ALGOR_it) },
        { (0), (0), 
# 25 "../crypto/asn1/x_spki.c" 3 4
       __builtin_offsetof (
# 25 "../crypto/asn1/x_spki.c"
       NETSCAPE_SPKI
# 25 "../crypto/asn1/x_spki.c" 3 4
       , 
# 25 "../crypto/asn1/x_spki.c"
...
} ; const ASN1_ITEM * NETSCAPE_SPKI_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, NETSCAPE_SPKI_seq_tt, sizeof(NETSCAPE_SPKI_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 26 "../crypto/asn1/x_spki.c" 3 4
 ((void *)0)
# 26 "../crypto/asn1/x_spki.c"
 , sizeof(NETSCAPE_SPKI), "NETSCAPE_SPKI" }; return &local_it; }

NETSCAPE_SPKI *d2i_NETSCAPE_SPKI(NETSCAPE_SPKI **a, const unsigned char **in, long len) { return (NETSCAPE_SPKI *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (NETSCAPE_SPKI_it())); } int i2d_NETSCAPE_SPKI(const NETSCAPE_SPKI *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (NETSCAPE_SPKI_it())); } NETSCAPE_SPKI *NETSCAPE_SPKI_new(void) { return (NETSCAPE_SPKI *)ASN1_item_new((NETSCAPE_SPKI_it())); } void NETSCAPE_SPKI_free(NETSCAPE_SPKI *a) { ASN1_item_free((ASN1_VALUE *)a, (NETSCAPE_SPKI_it())); }
