# 0 "../crypto/asn1/x_bignum.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_bignum.c"
# 10 "../crypto/asn1/x_bignum.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 13 "../crypto/asn1/x_bignum.c" 2
# 24 "../crypto/asn1/x_bignum.c"
...
# 38 "../crypto/asn1/x_bignum.c" 3 4
   ((void *)0)
# 38 "../crypto/asn1/x_bignum.c"
       , 0,
    bn_new,
    bn_free,
    0,
...
# 48 "../crypto/asn1/x_bignum.c" 3 4
   ((void *)0)
# 48 "../crypto/asn1/x_bignum.c"
       , 0,
    bn_secure_new,
    bn_free,
    0,
...
const ASN1_ITEM * BIGNUM_it(void) { static const ASN1_ITEM local_it = {
        0x0, 2, 
# 58 "../crypto/asn1/x_bignum.c" 3 4
                                             ((void *)0)
# 58 "../crypto/asn1/x_bignum.c"
                                                 , 0, &bignum_pf, 0, "BIGNUM"
}; return &local_it; }

const ASN1_ITEM * CBIGNUM_it(void) { static const ASN1_ITEM local_it = {
        0x0, 2, 
# 62 "../crypto/asn1/x_bignum.c" 3 4
                                             ((void *)0)
# 62 "../crypto/asn1/x_bignum.c"
                                                 , 0, &cbignum_pf, 1, "CBIGNUM"
}; return &local_it; }
...
static int bn_new(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    *pval = (ASN1_VALUE *)BN_new();
    if (*pval != 
# 68 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0)
# 68 "../crypto/asn1/x_bignum.c"
                    )
        return 1;
    else
        return 0;
...
static int bn_secure_new(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    *pval = (ASN1_VALUE *)BN_secure_new();
    if (*pval != 
# 77 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0)
# 77 "../crypto/asn1/x_bignum.c"
                    )
        return 1;
    else
        return 0;
...
{
    if (*pval == 
# 85 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0)
# 85 "../crypto/asn1/x_bignum.c"
                    )
        return;
    if (it->size & 1)
        ...
        BN_free((BIGNUM *)*pval);
    *pval = 
# 91 "../crypto/asn1/x_bignum.c" 3 4
           ((void *)0)
# 91 "../crypto/asn1/x_bignum.c"
               ;
}
                  ...
                  const ASN1_ITEM *it)
{
    ...
    int pad;
    if (*pval == 
# 99 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0)
# 99 "../crypto/asn1/x_bignum.c"
                    )
        return -1;
    bn = (BIGNUM *)*pval;
                  ...
                  int utype, char *free_cont, const ASN1_ITEM *it)
{
    ...
    if (*pval == 
# 120 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0) 
# 120 "../crypto/asn1/x_bignum.c"
                     && !bn_new(pval, it))
        return 0;
    bn = (BIGNUM *)*pval;
                         ...
                         int utype, char *free_cont, const ASN1_ITEM *it)
{
    ...
    if (*pval == 
# 136 "../crypto/asn1/x_bignum.c" 3 4
                ((void *)0) 
# 136 "../crypto/asn1/x_bignum.c"
