# 0 "../crypto/asn1/tasn_fre.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_fre.c"
# 10 "../crypto/asn1/tasn_fre.c"
...
{
    const ASN1_TEMPLATE *tt = 
# 30 "../crypto/asn1/tasn_fre.c" 3 4
                             ((void *)0)
# 30 "../crypto/asn1/tasn_fre.c"
                                 , *seqtt;
    ...
    if (pval == 
# 36 "../crypto/asn1/tasn_fre.c" 3 4
               ((void *)0)
# 36 "../crypto/asn1/tasn_fre.c"
                   )
        return;
    if ((it->itype != 0x0) && *pval == 
# 38 "../crypto/asn1/tasn_fre.c" 3 4
                                                       ((void *)0)
# 38 "../crypto/asn1/tasn_fre.c"
                                                           )
        return;
    if (aux && aux->asn1_cb)
        asn1_cb = aux->asn1_cb;
    ...
    case 0x2:
        if (asn1_cb) {
            i = asn1_cb(2, pval, it, 
# 60 "../crypto/asn1/tasn_fre.c" 3 4
                                                   ((void *)0)
# 60 "../crypto/asn1/tasn_fre.c"
                                                       );
            if (i == 2)
                return;
        }
        ...
        if (asn1_cb)
            asn1_cb(3, pval, it, 
# 73 "../crypto/asn1/tasn_fre.c" 3 4
                                                ((void *)0)
# 73 "../crypto/asn1/tasn_fre.c"
                                                    );
        if (embed == 0) {
            CRYPTO_free(*pval, "../crypto/asn1/tasn_fre.c", 75);
            *pval = 
# 76 "../crypto/asn1/tasn_fre.c" 3 4
                   ((void *)0)
# 76 "../crypto/asn1/tasn_fre.c"
                       ;
        }
        break;
    ...
    case 0x1:
        if (ossl_asn1_do_lock(pval, -1, it) != 0) {
            ...
            (void)((embed == 0) ? 0 : (OPENSSL_die("assertion failed: " "embed == 0", "../crypto/asn1/tasn_fre.c", 90), 1));
            *pval = 
# 91 "../crypto/asn1/tasn_fre.c" 3 4
                   ((void *)0)
# 91 "../crypto/asn1/tasn_fre.c"
                       ;
            return;
        }
        if (asn1_cb) {
            i = asn1_cb(2, pval, it, 
# 95 "../crypto/asn1/tasn_fre.c" 3 4
                                                   ((void *)0)
# 95 "../crypto/asn1/tasn_fre.c"
                                                       );
            if (i == 2)
                return;
        }
        ...
        if (asn1_cb)
            asn1_cb(3, pval, it, 
# 117 "../crypto/asn1/tasn_fre.c" 3 4
                                                ((void *)0)
# 117 "../crypto/asn1/tasn_fre.c"
                                                    );
        if (embed == 0) {
            CRYPTO_free(*pval, "../crypto/asn1/tasn_fre.c", 119);
            *pval = 
# 120 "../crypto/asn1/tasn_fre.c" 3 4
                   ((void *)0)
# 120 "../crypto/asn1/tasn_fre.c"
                       ;
        }
        break;
    }
...
void ossl_asn1_template_free(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
    ...
    if (tt->flags & (0x3 << 1)) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_VALUE_sk_type(sk)); i++) {
            ASN1_VALUE *vtmp = ((ASN1_VALUE *)OPENSSL_sk_value(ossl_check_const_ASN1_VALUE_sk_type(sk), (i)));

            ossl_asn1_item_embed_free(&vtmp, (tt->item()), embed);
        }
        OPENSSL_sk_free(ossl_check_ASN1_VALUE_sk_type(sk));
        *pval = 
# 144 "../crypto/asn1/tasn_fre.c" 3 4
               ((void *)0)
# 144 "../crypto/asn1/tasn_fre.c"
                   ;
    } else {
...
void ossl_asn1_primitive_free(ASN1_VALUE **pval, const ASN1_ITEM *it, int embed)
{
    ...
    if (!it) {
        ...
        if (*pval == 
# 175 "../crypto/asn1/tasn_fre.c" 3 4
                    ((void *)0)
# 175 "../crypto/asn1/tasn_fre.c"
        ...
        utype = -1;
        if (*pval == 
# 179 "../crypto/asn1/tasn_fre.c" 3 4
                    ((void *)0)
# 179 "../crypto/asn1/tasn_fre.c"
                        )
            return;
    } else {
        utype = it->utype;
        if ((utype != 1) && *pval == 
# 183 "../crypto/asn1/tasn_fre.c" 3 4
                                                 ((void *)0)
# 183 "../crypto/asn1/tasn_fre.c"
                                                     )
            return;
    }
    ...
    case -4:
        ossl_asn1_primitive_free(pval, 
# 203 "../crypto/asn1/tasn_fre.c" 3 4
                                      ((void *)0)
# 203 "../crypto/asn1/tasn_fre.c"
                                          , 0);
        CRYPTO_free(*pval, "../crypto/asn1/tasn_fre.c", 204);
        break;
    ...
    *pval = 
# 211 "../crypto/asn1/tasn_fre.c" 3 4
           ((void *)0)
# 211 "../crypto/asn1/tasn_fre.c"
               ;
}
