# 0 "../crypto/asn1/a_bitstr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_bitstr.c"
# 10 "../crypto/asn1/a_bitstr.c"
...
# 26 "../crypto/asn1/a_bitstr.c"
    ...
    ret = 1 + len;
    if (pp == 
# 68 "../crypto/asn1/a_bitstr.c" 3 4
             ((void *)0)
# 68 "../crypto/asn1/a_bitstr.c"
                 )
        return ret;
...
{
    ASN1_BIT_STRING *ret = 
# 87 "../crypto/asn1/a_bitstr.c" 3 4
                          ((void *)0)
# 87 "../crypto/asn1/a_bitstr.c"
                              ;
...
# 97 "../crypto/asn1/a_bitstr.c"
    ...
    if ((a == 
# 102 "../crypto/asn1/a_bitstr.c" 3 4
             ((void *)0)
# 102 "../crypto/asn1/a_bitstr.c"
                 ) || ((*a) == 
# 102 "../crypto/asn1/a_bitstr.c" 3 4
                               ((void *)0)
# 102 "../crypto/asn1/a_bitstr.c"
...
# 103 "../crypto/asn1/a_bitstr.c" 3 4
                                            ((void *)0)
# 103 "../crypto/asn1/a_bitstr.c"
                                                )
            return 
# 104 "../crypto/asn1/a_bitstr.c" 3 4
                  ((void *)0)
# 104 "../crypto/asn1/a_bitstr.c"
                      ;
    } else
        ret = (*a);
    ...
    if (len-- > 1) {
        s = CRYPTO_malloc((int)len, "../crypto/asn1/a_bitstr.c", 121);
        if (s == 
# 122 "../crypto/asn1/a_bitstr.c" 3 4
                ((void *)0)
# 122 "../crypto/asn1/a_bitstr.c"
                    ) {
            goto err;
        }
        memcpy(s, p, (int)len);
        ...
        s = 
# 129 "../crypto/asn1/a_bitstr.c" 3 4
           ((void *)0)
# 129 "../crypto/asn1/a_bitstr.c"
               ;

    ASN1_STRING_set0(ret, s, (int)len);
    ret->type = 3;
    if (a != 
# 133 "../crypto/asn1/a_bitstr.c" 3 4
            ((void *)0)
# 133 "../crypto/asn1/a_bitstr.c"
                )
        (*a) = ret;
    *pp = p;
    return ret;
 err:
    if (i != 0)
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_bitstr.c",139,__func__), ERR_set_error)((13),(i),
# 139 "../crypto/asn1/a_bitstr.c" 3 4
       ((void *)0)
# 139 "../crypto/asn1/a_bitstr.c"
       );
    if ((a == 
# 140 "../crypto/asn1/a_bitstr.c" 3 4
             ((void *)0)
# 140 "../crypto/asn1/a_bitstr.c"
                 ) || (*a != ret))
        ASN1_BIT_STRING_free(ret);
    return 
# 142 "../crypto/asn1/a_bitstr.c" 3 4
          ((void *)0)
# 142 "../crypto/asn1/a_bitstr.c"
              ;
}
...
int ASN1_BIT_STRING_set_bit(ASN1_BIT_STRING *a, int n, int value)
{
    ...
    if (a == 
# 162 "../crypto/asn1/a_bitstr.c" 3 4
            ((void *)0)
# 162 "../crypto/asn1/a_bitstr.c"
                )
        return 0;
...
# 167 "../crypto/asn1/a_bitstr.c" 3 4
                                            ((void *)0)
# 167 "../crypto/asn1/a_bitstr.c"
                                                )) {
        if (!value)
            return 1;
        c = CRYPTO_clear_realloc(a->data, a->length, w + 1, "../crypto/asn1/a_bitstr.c", 170);
        if (c == 
# 171 "../crypto/asn1/a_bitstr.c" 3 4
                ((void *)0)
# 171 "../crypto/asn1/a_bitstr.c"
                    )
            return 0;
        if (w + 1 - a->length > 0)
...
int ASN1_BIT_STRING_get_bit(const ASN1_BIT_STRING *a, int n)
{
    ...
    v = 1 << (7 - (n & 0x07));
    if ((a == 
# 193 "../crypto/asn1/a_bitstr.c" 3 4
             ((void *)0)
# 193 "../crypto/asn1/a_bitstr.c"
                 ) || (a->length < (w + 1)) || (a->data == 
# 193 "../crypto/asn1/a_bitstr.c" 3 4
                                                           ((void *)0)
# 193 "../crypto/asn1/a_bitstr.c"
