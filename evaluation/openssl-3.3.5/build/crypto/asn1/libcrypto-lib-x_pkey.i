# 0 "../crypto/asn1/x_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_pkey.c"
# 10 "../crypto/asn1/x_pkey.c"
...
# 15 "../crypto/asn1/x_pkey.c" 2

X509_PKEY *X509_PKEY_new(void)
{
    X509_PKEY *ret = 
# 18 "../crypto/asn1/x_pkey.c" 3 4
                    ((void *)0)
# 18 "../crypto/asn1/x_pkey.c"
                        ;

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/x_pkey.c", 20);
    if (ret == 
# 21 "../crypto/asn1/x_pkey.c" 3 4
              ((void *)0)
# 21 "../crypto/asn1/x_pkey.c"
                  )
        return 
# 22 "../crypto/asn1/x_pkey.c" 3 4
              ((void *)0)
# 22 "../crypto/asn1/x_pkey.c"
                  ;

    ret->enc_algor = X509_ALGOR_new();
    ret->enc_pkey = ASN1_OCTET_STRING_new();
    if (ret->enc_algor == 
# 26 "../crypto/asn1/x_pkey.c" 3 4
                         ((void *)0) 
# 26 "../crypto/asn1/x_pkey.c"
                              || ret->enc_pkey == 
# 26 "../crypto/asn1/x_pkey.c" 3 4
                                                  ((void *)0)
# 26 "../crypto/asn1/x_pkey.c"
        ...
        X509_PKEY_free(ret);
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_pkey.c",28,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 28 "../crypto/asn1/x_pkey.c" 3 4
       ((void *)0)
# 28 "../crypto/asn1/x_pkey.c"
       );
        return 
# 29 "../crypto/asn1/x_pkey.c" 3 4
              ((void *)0)
# 29 "../crypto/asn1/x_pkey.c"
                  ;
    }
...
{
    if (x == 
# 37 "../crypto/asn1/x_pkey.c" 3 4
            ((void *)0)
# 37 "../crypto/asn1/x_pkey.c"
                )
        return;
    ...
    if (x->key_free)
        CRYPTO_free(x->key_data, "../crypto/asn1/x_pkey.c", 44);
    CRYPTO_free(x, "../crypto/asn1/x_pkey.c", 45);
}
