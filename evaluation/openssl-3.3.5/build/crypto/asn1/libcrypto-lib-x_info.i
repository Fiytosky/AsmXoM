# 0 "../crypto/asn1/x_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_info.c"
# 10 "../crypto/asn1/x_info.c"
...
# 15 "../crypto/asn1/x_info.c" 2

X509_INFO *X509_INFO_new(void)
{
    X509_INFO *ret;

    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/x_info.c", 20);
    if (ret == 
# 21 "../crypto/asn1/x_info.c" 3 4
              ((void *)0)
# 21 "../crypto/asn1/x_info.c"
                  )
        return 
# 22 "../crypto/asn1/x_info.c" 3 4
              ((void *)0)
# 22 "../crypto/asn1/x_info.c"
                  ;
...
{
    if (x == 
# 29 "../crypto/asn1/x_info.c" 3 4
            ((void *)0)
# 29 "../crypto/asn1/x_info.c"
                )
        return;
    ...
    CRYPTO_free(x->enc_data, "../crypto/asn1/x_info.c", 35);
    CRYPTO_free(x, "../crypto/asn1/x_info.c", 36);
}
