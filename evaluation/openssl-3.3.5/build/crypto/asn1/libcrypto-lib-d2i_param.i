# 0 "../crypto/asn1/d2i_param.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/d2i_param.c"
# 10 "../crypto/asn1/d2i_param.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 17 "../crypto/asn1/d2i_param.c" 2

EVP_PKEY *d2i_KeyParams(int type, EVP_PKEY **a, const unsigned char **pp,
                        long length)
{
    EVP_PKEY *ret = 
# 21 "../crypto/asn1/d2i_param.c" 3 4
                   ((void *)0)
# 21 "../crypto/asn1/d2i_param.c"
                       ;

    if ((a == 
# 23 "../crypto/asn1/d2i_param.c" 3 4
             ((void *)0)
# 23 "../crypto/asn1/d2i_param.c"
                 ) || (*a == 
# 23 "../crypto/asn1/d2i_param.c" 3 4
                             ((void *)0)
# 23 "../crypto/asn1/d2i_param.c"
        ...
        if ((ret = EVP_PKEY_new()) == 
# 24 "../crypto/asn1/d2i_param.c" 3 4
                                     ((void *)0)
# 24 "../crypto/asn1/d2i_param.c"
                                         )
            return 
# 25 "../crypto/asn1/d2i_param.c" 3 4
                  ((void *)0)
# 25 "../crypto/asn1/d2i_param.c"
                      ;
    } else
        ret = *a;
    ...
    if (ret->ameth == 
# 32 "../crypto/asn1/d2i_param.c" 3 4
                     ((void *)0) 
# 32 "../crypto/asn1/d2i_param.c"
                          || ret->ameth->param_decode == 
# 32 "../crypto/asn1/d2i_param.c" 3 4
                                                         ((void *)0)
# 32 "../crypto/asn1/d2i_param.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_param.c",33,__func__), ERR_set_error)((13),(196),
# 33 "../crypto/asn1/d2i_param.c" 3 4
       ((void *)0)
# 33 "../crypto/asn1/d2i_param.c"
       );
        goto err;
    }
    ...
    if (a != 
# 40 "../crypto/asn1/d2i_param.c" 3 4
            ((void *)0)
# 40 "../crypto/asn1/d2i_param.c"
                )
        (*a) = ret;
    return ret;
err:
    if (a == 
# 44 "../crypto/asn1/d2i_param.c" 3 4
            ((void *)0) 
# 44 "../crypto/asn1/d2i_param.c"
                 || *a != ret)
        EVP_PKEY_free(ret);
    return 
# 46 "../crypto/asn1/d2i_param.c" 3 4
          ((void *)0)
# 46 "../crypto/asn1/d2i_param.c"
              ;
}
...
{
    BUF_MEM *b = 
# 51 "../crypto/asn1/d2i_param.c" 3 4
                ((void *)0)
# 51 "../crypto/asn1/d2i_param.c"
                    ;
    const unsigned char *p;
    void *ret = 
# 53 "../crypto/asn1/d2i_param.c" 3 4
               ((void *)0)
# 53 "../crypto/asn1/d2i_param.c"
                   ;
    int len;
