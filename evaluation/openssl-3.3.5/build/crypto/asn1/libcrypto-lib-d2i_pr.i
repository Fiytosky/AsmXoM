# 0 "../crypto/asn1/d2i_pr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/d2i_pr.c"
# 13 "../crypto/asn1/d2i_pr.c"
...
# 31 "../crypto/asn1/d2i_pr.c" 3 4
                            ((void *)0)
# 31 "../crypto/asn1/d2i_pr.c"
                                ;
    size_t len = length;
    EVP_PKEY *pkey = 
# 33 "../crypto/asn1/d2i_pr.c" 3 4
                    ((void *)0)
# 33 "../crypto/asn1/d2i_pr.c"
                        , *bak_a = 
# 33 "../crypto/asn1/d2i_pr.c" 3 4
                                   ((void *)0)
# 33 "../crypto/asn1/d2i_pr.c"
...
# 35 "../crypto/asn1/d2i_pr.c"
    ...
    if (keytype != 0) {
        ...
        if (key_name == 
# 45 "../crypto/asn1/d2i_pr.c" 3 4
                       ((void *)0)
# 45 "../crypto/asn1/d2i_pr.c"
                           )
            return 
# 46 "../crypto/asn1/d2i_pr.c" 3 4
                  ((void *)0)
# 46 "../crypto/asn1/d2i_pr.c"
                      ;
    }
...
# 51 "../crypto/asn1/d2i_pr.c" 3 4
                                    ((void *)0)
# 51 "../crypto/asn1/d2i_pr.c"
                                        , pp, len);
    ERR_pop_to_mark();
    if (p8info != 
# 53 "../crypto/asn1/d2i_pr.c" 3 4
                 ((void *)0)
# 53 "../crypto/asn1/d2i_pr.c"
                     ) {
        if (key_name == 
# 54 "../crypto/asn1/d2i_pr.c" 3 4
                       ((void *)0)
                
# 55 "../crypto/asn1/d2i_pr.c"
               && PKCS8_pkey_get0(&algoid, 
# 55 "../crypto/asn1/d2i_pr.c" 3 4
                                           ((void *)0)
# 55 "../crypto/asn1/d2i_pr.c"
                                               , 
# 55 "../crypto/asn1/d2i_pr.c" 3 4
...
# 55 "../crypto/asn1/d2i_pr.c"
    ...
    *pp = p;
    ...
    if (a != 
# 65 "../crypto/asn1/d2i_pr.c" 3 4
            ((void *)0) 
# 65 "../crypto/asn1/d2i_pr.c"
                 && (bak_a = *a) != 
# 65 "../crypto/asn1/d2i_pr.c" 3 4
                                    ((void *)0)
# 65 "../crypto/asn1/d2i_pr.c"
    ...
    dctx = OSSL_DECODER_CTX_new_for_pkey(ppkey, "DER", structure, key_name,
                                         ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), libctx, propq);
    if (a != 
# 69 "../crypto/asn1/d2i_pr.c" 3 4
            ((void *)0)
# 69 "../crypto/asn1/d2i_pr.c"
                )
        *a = bak_a;
    if (dctx == 
# 71 "../crypto/asn1/d2i_pr.c" 3 4
               ((void *)0)
# 71 "../crypto/asn1/d2i_pr.c"
                   )
        goto err;
    ...
    if (ret
        && *ppkey != 
# 77 "../crypto/asn1/d2i_pr.c" 3 4
                    ((void *)0)
        
# 78 "../crypto/asn1/d2i_pr.c"
       && evp_keymgmt_util_has(*ppkey, 0x01)) {
        if (a != 
# 79 "../crypto/asn1/d2i_pr.c" 3 4
                ((void *)0)
# 79 "../crypto/asn1/d2i_pr.c"
                    )
            *a = *ppkey;
        return *ppkey;
    }
 ...
 err:
    if (ppkey != a)
        EVP_PKEY_free(*ppkey);
    return 
# 87 "../crypto/asn1/d2i_pr.c" 3 4
          ((void *)0)
# 87 "../crypto/asn1/d2i_pr.c"
              ;
}
                           ...
                           long length, OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (a == 
# 97 "../crypto/asn1/d2i_pr.c" 3 4
            ((void *)0) 
# 97 "../crypto/asn1/d2i_pr.c"
                 || *a == 
# 97 "../crypto/asn1/d2i_pr.c" 3 4
                          ((void *)0)
# 97 "../crypto/asn1/d2i_pr.c"
        ...
        if ((ret = EVP_PKEY_new()) == 
# 98 "../crypto/asn1/d2i_pr.c" 3 4
                                     ((void *)0)
# 98 "../crypto/asn1/d2i_pr.c"
                                         ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pr.c",99,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 99 "../crypto/asn1/d2i_pr.c" 3 4
           ((void *)0)
# 99 "../crypto/asn1/d2i_pr.c"
           );
            return 
# 100 "../crypto/asn1/d2i_pr.c" 3 4
                  ((void *)0)
# 100 "../crypto/asn1/d2i_pr.c"
                      ;
        }
    } else {
        ret = *a;
        ...
        ret->engine = 
# 106 "../crypto/asn1/d2i_pr.c" 3 4
                     ((void *)0)
# 106 "../crypto/asn1/d2i_pr.c"
                         ;

    }

    if (!EVP_PKEY_set_type(ret, keytype)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pr.c",111,__func__), ERR_set_error)((13),(163),
# 111 "../crypto/asn1/d2i_pr.c" 3 4
       ((void *)0)
# 111 "../crypto/asn1/d2i_pr.c"
       );
        goto err;
    }
...
# 118 "../crypto/asn1/d2i_pr.c" 3 4
                                      ((void *)0)
                
# 119 "../crypto/asn1/d2i_pr.c"
               || ret->ameth->priv_decode_ex != 
# 119 "../crypto/asn1/d2i_pr.c" 3 4
                                                ((void *)0)
# 119 "../crypto/asn1/d2i_pr.c"
                                                    ) {
            EVP_PKEY *tmp;
            PKCS8_PRIV_KEY_INFO *p8 = 
# 121 "../crypto/asn1/d2i_pr.c" 3 4
                                     ((void *)0)
# 121 "../crypto/asn1/d2i_pr.c"
                                         ;
            p8 = d2i_PKCS8_PRIV_KEY_INFO(
# 122 "../crypto/asn1/d2i_pr.c" 3 4
                                        ((void *)0)
# 122 "../crypto/asn1/d2i_pr.c"
                                            , &p, length);
            if (p8 == 
# 123 "../crypto/asn1/d2i_pr.c" 3 4
                     ((void *)0)
# 123 "../crypto/asn1/d2i_pr.c"
                         ) {
                ERR_clear_last_mark();
                goto err;
            }
            ...
            if (tmp == 
# 129 "../crypto/asn1/d2i_pr.c" 3 4
                      ((void *)0)
# 129 "../crypto/asn1/d2i_pr.c"
                          ) {
                ERR_clear_last_mark();
                goto err;
            }
            ...
            ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pr.c",140,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 140 "../crypto/asn1/d2i_pr.c" 3 4
           ((void *)0)
# 140 "../crypto/asn1/d2i_pr.c"
           );
            goto err;
        }
    } else {
    ...
    *pp = p;
    if (a != 
# 147 "../crypto/asn1/d2i_pr.c" 3 4
            ((void *)0)
# 147 "../crypto/asn1/d2i_pr.c"
                )
        *a = ret;
    return ret;
 err:
    if (a == 
# 151 "../crypto/asn1/d2i_pr.c" 3 4
            ((void *)0) 
# 151 "../crypto/asn1/d2i_pr.c"
                 || *a != ret)
        EVP_PKEY_free(ret);
    return 
# 153 "../crypto/asn1/d2i_pr.c" 3 4
          ((void *)0)
# 153 "../crypto/asn1/d2i_pr.c"
              ;
}
                            ...
                            const char *propq)
{
    ...
    if (ret == 
# 164 "../crypto/asn1/d2i_pr.c" 3 4
              ((void *)0)
# 164 "../crypto/asn1/d2i_pr.c"
                  )
...
EVP_PKEY *d2i_PrivateKey(int type, EVP_PKEY **a, const unsigned char **pp,
                         long length)
{
    return d2i_PrivateKey_ex(type, a, pp, length, 
# 172 "../crypto/asn1/d2i_pr.c" 3 4
                                                 ((void *)0)
# 172 "../crypto/asn1/d2i_pr.c"
                                                     , 
# 172 "../crypto/asn1/d2i_pr.c" 3 4
                                                       ((void *)0)
# 172 "../crypto/asn1/d2i_pr.c"
...
# 191 "../crypto/asn1/d2i_pr.c" 3 4
                                 ((void *)0)
# 191 "../crypto/asn1/d2i_pr.c"
                                     , &p, length);
    p = *pp;
    ...
    if (OPENSSL_sk_num(ossl_check_const_ASN1_TYPE_sk_type(inkey)) == 6) {
        keytype = 116;
    } else if (OPENSSL_sk_num(ossl_check_const_ASN1_TYPE_sk_type(inkey)) == 4) {
        keytype = 408;
    } else if (OPENSSL_sk_num(ossl_check_const_ASN1_TYPE_sk_type(inkey)) == 3) {

        PKCS8_PRIV_KEY_INFO *p8 = d2i_PKCS8_PRIV_KEY_INFO(
# 203 "../crypto/asn1/d2i_pr.c" 3 4
                                                         ((void *)0)
# 203 "../crypto/asn1/d2i_pr.c"
                                                             , &p, length);
        EVP_PKEY *ret;

        OPENSSL_sk_pop_free(ossl_check_ASN1_TYPE_sk_type(inkey),ossl_check_ASN1_TYPE_freefunc_type(ASN1_TYPE_free));
        if (p8 == 
# 207 "../crypto/asn1/d2i_pr.c" 3 4
                 ((void *)0)
# 207 "../crypto/asn1/d2i_pr.c"
                     ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/d2i_pr.c",208,__func__), ERR_set_error)((13),(167),
# 208 "../crypto/asn1/d2i_pr.c" 3 4
           ((void *)0)
# 208 "../crypto/asn1/d2i_pr.c"
           );
            return 
# 209 "../crypto/asn1/d2i_pr.c" 3 4
                  ((void *)0)
# 209 "../crypto/asn1/d2i_pr.c"
                      ;
        }
        ret = evp_pkcs82pkey_legacy(p8, libctx, propq);
        PKCS8_PRIV_KEY_INFO_free(p8);
        if (ret == 
# 213 "../crypto/asn1/d2i_pr.c" 3 4
                  ((void *)0)
# 213 "../crypto/asn1/d2i_pr.c"
                      )
            return 
# 214 "../crypto/asn1/d2i_pr.c" 3 4
                  ((void *)0)
# 214 "../crypto/asn1/d2i_pr.c"
                      ;
        *pp = p;
        if (a != 
# 216 "../crypto/asn1/d2i_pr.c" 3 4
                ((void *)0)
# 216 "../crypto/asn1/d2i_pr.c"
                    ) {
            *a = ret;
        }
        return ret;
                                ...
                                const char *propq)
{
    ...
    ret = d2i_PrivateKey_decoder(0, a, pp, length, libctx, propq);

    if (ret == 
# 239 "../crypto/asn1/d2i_pr.c" 3 4
              ((void *)0)
# 239 "../crypto/asn1/d2i_pr.c"
                  )
...
EVP_PKEY *d2i_AutoPrivateKey(EVP_PKEY **a, const unsigned char **pp,
                             long length)
{
    return d2i_AutoPrivateKey_ex(a, pp, length, 
# 247 "../crypto/asn1/d2i_pr.c" 3 4
                                               ((void *)0)
# 247 "../crypto/asn1/d2i_pr.c"
                                                   , 
# 247 "../crypto/asn1/d2i_pr.c" 3 4
                                                     ((void *)0)
# 247 "../crypto/asn1/d2i_pr.c"
