# 0 "../crypto/asn1/x_long.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_long.c"
# 10 "../crypto/asn1/x_long.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 13 "../crypto/asn1/x_long.c" 2
# 21 "../crypto/asn1/x_long.c"
...
# 32 "../crypto/asn1/x_long.c" 3 4
   ((void *)0)
# 32 "../crypto/asn1/x_long.c"
       , 0,
    long_new,
    long_free,
    long_free,
...
const ASN1_ITEM * LONG_it(void) { static const ASN1_ITEM local_it = {
        0x0, 2, 
# 42 "../crypto/asn1/x_long.c" 3 4
                                             ((void *)0)
# 42 "../crypto/asn1/x_long.c"
                                                 , 0, &long_pf, 0x7fffffffL, "LONG"
}; return &local_it; }

const ASN1_ITEM * ZLONG_it(void) { static const ASN1_ITEM local_it = {
        0x0, 2, 
# 46 "../crypto/asn1/x_long.c" 3 4
                                             ((void *)0)
# 46 "../crypto/asn1/x_long.c"
                                                 , 0, &long_pf, 0, "ZLONG"
}; return &local_it; }

static int long_new(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    memcpy(pval, &it->size, (sizeof(*pval) < sizeof(it->size) ? sizeof(*pval) : sizeof(it->size)));
    return 1;
}
                    ...
                    const ASN1_ITEM *it)
{
    ...
    memcpy(&ltmp, pval, (sizeof(*pval) < sizeof(ltmp) ? sizeof(*pval) : sizeof(ltmp)));
    if (ltmp == it->size)
        return -1;
    ...
    if (cont != 
# 117 "../crypto/asn1/x_long.c" 3 4
               ((void *)0)
# 117 "../crypto/asn1/x_long.c"
                   ) {
        if (pad)
                    ...
                    int utype, char *free_cont, const ASN1_ITEM *it)
{
    ...
    if (len > (int)sizeof(long)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_long.c",155,__func__), ERR_set_error)((13),(128),
# 155 "../crypto/asn1/x_long.c" 3 4
       ((void *)0)
# 155 "../crypto/asn1/x_long.c"
       );
        return 0;
    }
    ...
    if (sign == 0x100) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_long.c",166,__func__), ERR_set_error)((13),(221),
# 166 "../crypto/asn1/x_long.c" 3 4
       ((void *)0)
# 166 "../crypto/asn1/x_long.c"
       );
        return 0;
    }
    utmp = 0;
    ...
    ltmp = (long)utmp;
    if (ltmp < 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_long.c",176,__func__), ERR_set_error)((13),(128),
# 176 "../crypto/asn1/x_long.c" 3 4
       ((void *)0)
# 176 "../crypto/asn1/x_long.c"
       );
        return 0;
    }
    if (sign)
        ltmp = -ltmp - 1;
    if (ltmp == it->size) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_long.c",182,__func__), ERR_set_error)((13),(128),
# 182 "../crypto/asn1/x_long.c" 3 4
       ((void *)0)
# 182 "../crypto/asn1/x_long.c"
       );
        return 0;
    }
    memcpy(pval, &ltmp, (sizeof(*pval) < sizeof(ltmp) ? sizeof(*pval) : sizeof(ltmp)));
    return 1;
}
                      ...
                      int indent, const ASN1_PCTX *pctx)
{
    ...
    memcpy(&l, pval, (sizeof(*pval) < sizeof(l) ? sizeof(*pval) : sizeof(l)));
