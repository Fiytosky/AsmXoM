# 0 "../crypto/asn1/n_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/n_pkey.c"
# 10 "../crypto/asn1/n_pkey.c"
...
# 41 "../crypto/asn1/n_pkey.c" 3 4
((void *)0)
# 41 "../crypto/asn1/n_pkey.c"
, 4, 0, 0, 0, 0}; static const ASN1_TEMPLATE NETSCAPE_ENCRYPTED_PKEY_seq_tt[] = {
        { (0), (0), 
# 42 "../crypto/asn1/n_pkey.c" 3 4
       __builtin_offsetof (
# 42 "../crypto/asn1/n_pkey.c"
       NETSCAPE_ENCRYPTED_PKEY
# 42 "../crypto/asn1/n_pkey.c" 3 4
       , 
# 42 "../crypto/asn1/n_pkey.c"
...
# 42 "../crypto/asn1/n_pkey.c"
       , "os", (ASN1_OCTET_STRING_it) },
        { (0), (0), 
# 43 "../crypto/asn1/n_pkey.c" 3 4
       __builtin_offsetof (
# 43 "../crypto/asn1/n_pkey.c"
       NETSCAPE_ENCRYPTED_PKEY
# 43 "../crypto/asn1/n_pkey.c" 3 4
       , 
# 43 "../crypto/asn1/n_pkey.c"
...
# 43 "../crypto/asn1/n_pkey.c"
       , "enckey", (X509_SIG_it) }
} ; static const ASN1_ITEM * NETSCAPE_ENCRYPTED_PKEY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, NETSCAPE_ENCRYPTED_PKEY_seq_tt, sizeof(NETSCAPE_ENCRYPTED_PKEY_seq_tt) / sizeof(ASN1_TEMPLATE), &NETSCAPE_ENCRYPTED_PKEY_aux, sizeof(NETSCAPE_ENCRYPTED_PKEY), "NETSCAPE_ENCRYPTED_PKEY" }; return &local_it; }

extern NETSCAPE_ENCRYPTED_PKEY *NETSCAPE_ENCRYPTED_PKEY_new(void); extern void NETSCAPE_ENCRYPTED_PKEY_free(NETSCAPE_ENCRYPTED_PKEY *a); extern NETSCAPE_ENCRYPTED_PKEY *d2i_NETSCAPE_ENCRYPTED_PKEY(NETSCAPE_ENCRYPTED_PKEY **a, const unsigned char **in, long len); extern int i2d_NETSCAPE_ENCRYPTED_PKEY(const NETSCAPE_ENCRYPTED_PKEY *a, unsigned char **out); extern const ASN1_ITEM * NETSCAPE_ENCRYPTED_PKEY_it(void);
extern NETSCAPE_ENCRYPTED_PKEY *d2i_NETSCAPE_ENCRYPTED_PKEY(NETSCAPE_ENCRYPTED_PKEY **a, const unsigned char **in, long len); extern int i2d_NETSCAPE_ENCRYPTED_PKEY(const NETSCAPE_ENCRYPTED_PKEY *a, unsigned char **out); extern const ASN1_ITEM * NETSCAPE_ENCRYPTED_PKEY_it(void);
NETSCAPE_ENCRYPTED_PKEY *d2i_NETSCAPE_ENCRYPTED_PKEY(NETSCAPE_ENCRYPTED_PKEY **a, const unsigned char **in, long len) { return (NETSCAPE_ENCRYPTED_PKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (NETSCAPE_ENCRYPTED_PKEY_it())); } int i2d_NETSCAPE_ENCRYPTED_PKEY(const NETSCAPE_ENCRYPTED_PKEY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (NETSCAPE_ENCRYPTED_PKEY_it())); } NETSCAPE_ENCRYPTED_PKEY *NETSCAPE_ENCRYPTED_PKEY_new(void) { return (NETSCAPE_ENCRYPTED_PKEY *)ASN1_item_new((NETSCAPE_ENCRYPTED_PKEY_it())); } void NETSCAPE_ENCRYPTED_PKEY_free(NETSCAPE_ENCRYPTED_PKEY *a) { ASN1_item_free((ASN1_VALUE *)a, (NETSCAPE_ENCRYPTED_PKEY_it())); }

static const ASN1_TEMPLATE NETSCAPE_PKEY_seq_tt[] = {
        { ((0x1 << 12)), (0), 
# 51 "../crypto/asn1/n_pkey.c" 3 4
       __builtin_offsetof (
# 51 "../crypto/asn1/n_pkey.c"
       NETSCAPE_PKEY
# 51 "../crypto/asn1/n_pkey.c" 3 4
       , 
# 51 "../crypto/asn1/n_pkey.c"
...
# 51 "../crypto/asn1/n_pkey.c"
       , "version", (INT32_it) },
        { (0), (0), 
# 52 "../crypto/asn1/n_pkey.c" 3 4
       __builtin_offsetof (
# 52 "../crypto/asn1/n_pkey.c"
       NETSCAPE_PKEY
# 52 "../crypto/asn1/n_pkey.c" 3 4
       , 
# 52 "../crypto/asn1/n_pkey.c"
...
# 52 "../crypto/asn1/n_pkey.c"
       , "algor", (X509_ALGOR_it) },
        { (0), (0), 
# 53 "../crypto/asn1/n_pkey.c" 3 4
       __builtin_offsetof (
# 53 "../crypto/asn1/n_pkey.c"
       NETSCAPE_PKEY
# 53 "../crypto/asn1/n_pkey.c" 3 4
       , 
# 53 "../crypto/asn1/n_pkey.c"
...
# 53 "../crypto/asn1/n_pkey.c"
       , "private_key", (ASN1_OCTET_STRING_it) }
} ; static const ASN1_ITEM * NETSCAPE_PKEY_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, NETSCAPE_PKEY_seq_tt, sizeof(NETSCAPE_PKEY_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 54 "../crypto/asn1/n_pkey.c" 3 4
 ((void *)0)
# 54 "../crypto/asn1/n_pkey.c"
 , sizeof(NETSCAPE_PKEY), "NETSCAPE_PKEY" }; return &local_it; }

extern NETSCAPE_PKEY *NETSCAPE_PKEY_new(void); extern void NETSCAPE_PKEY_free(NETSCAPE_PKEY *a); extern NETSCAPE_PKEY *d2i_NETSCAPE_PKEY(NETSCAPE_PKEY **a, const unsigned char **in, long len); extern int i2d_NETSCAPE_PKEY(const NETSCAPE_PKEY *a, unsigned char **out); extern const ASN1_ITEM * NETSCAPE_PKEY_it(void);
extern NETSCAPE_PKEY *d2i_NETSCAPE_PKEY(NETSCAPE_PKEY **a, const unsigned char **in, long len); extern int i2d_NETSCAPE_PKEY(const NETSCAPE_PKEY *a, unsigned char **out); extern const ASN1_ITEM * NETSCAPE_PKEY_it(void);
NETSCAPE_PKEY *d2i_NETSCAPE_PKEY(NETSCAPE_PKEY **a, const unsigned char **in, long len) { return (NETSCAPE_PKEY *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (NETSCAPE_PKEY_it())); } int i2d_NETSCAPE_PKEY(const NETSCAPE_PKEY *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (NETSCAPE_PKEY_it())); } NETSCAPE_PKEY *NETSCAPE_PKEY_new(void) { return (NETSCAPE_PKEY *)ASN1_item_new((NETSCAPE_PKEY_it())); } void NETSCAPE_PKEY_free(NETSCAPE_PKEY *a) { ASN1_item_free((ASN1_VALUE *)a, (NETSCAPE_PKEY_it())); }
