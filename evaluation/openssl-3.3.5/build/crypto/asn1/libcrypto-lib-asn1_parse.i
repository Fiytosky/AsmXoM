# 0 "../crypto/asn1/asn1_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn1_parse.c"
# 10 "../crypto/asn1/asn1_parse.c"
                           ...
                           int tag, int xclass, int constructed, int indent)
{
    ...
    int i = 0;
    BIO *bio = 
# 30 "../crypto/asn1/asn1_parse.c" 3 4
              ((void *)0)
# 30 "../crypto/asn1/asn1_parse.c"
                  ;
    ...
    if (bp != 
# 45 "../crypto/asn1/asn1_parse.c" 3 4
             ((void *)0)
# 45 "../crypto/asn1/asn1_parse.c"
                 ) {
        if (BIO_ctrl((bp), 79, 0, (void *)(str)) <= 0) {
            if ((bio = BIO_new(BIO_f_prefix())) == 
# 47 "../crypto/asn1/asn1_parse.c" 3 4
                                                  ((void *)0)
                    
# 48 "../crypto/asn1/asn1_parse.c"
                   || (bp = BIO_push(bio, bp)) == 
# 48 "../crypto/asn1/asn1_parse.c" 3 4
                                                  ((void *)0)
# 48 "../crypto/asn1/asn1_parse.c"
                                                      )
                goto err;
        ...
        saved_indent = BIO_ctrl((bp), 81, 0, 
# 52 "../crypto/asn1/asn1_parse.c" 3 4
                      ((void *)0)
# 52 "../crypto/asn1/asn1_parse.c"
                      );
        if (BIO_ctrl((bp), 79, 0, (void *)(str)) <= 0 || BIO_ctrl((bp), 80, (indent), 
# 53 "../crypto/asn1/asn1_parse.c" 3 4
                                           ((void *)0)
# 53 "../crypto/asn1/asn1_parse.c"
                                           ) <= 0)
            goto err;
    }
 ...
 err:
    if (saved_indent >= 0)
        BIO_ctrl((bp), 80, (saved_indent), 
# 76 "../crypto/asn1/asn1_parse.c" 3 4
       ((void *)0)
# 76 "../crypto/asn1/asn1_parse.c"
       );
    if (pop_f_prefix)
        BIO_pop(bp);
    BIO_free(bio);
                       ...
                       int offset, int depth, int indent, int dump)
{
    ...
    int nl, hl, j, r;
    ASN1_OBJECT *o = 
# 101 "../crypto/asn1/asn1_parse.c" 3 4
                    ((void *)0)
# 101 "../crypto/asn1/asn1_parse.c"
                        ;
    ASN1_OCTET_STRING *os = 
# 102 "../crypto/asn1/asn1_parse.c" 3 4
                           ((void *)0)
# 102 "../crypto/asn1/asn1_parse.c"
                               ;
    ASN1_INTEGER *ai = 
# 103 "../crypto/asn1/asn1_parse.c" 3 4
                      ((void *)0)
# 103 "../crypto/asn1/asn1_parse.c"
                          ;
    ASN1_ENUMERATED *ae = 
# 104 "../crypto/asn1/asn1_parse.c" 3 4
                         ((void *)0)
# 104 "../crypto/asn1/asn1_parse.c"
                             ;
...
# 186 "../crypto/asn1/asn1_parse.c" 3 4
                                                          ((void *)0)
# 186 "../crypto/asn1/asn1_parse.c"
                                                              ) {
                    if (BIO_write(bp, ":", 1) <= 0)
                        goto end;
...
# 209 "../crypto/asn1/asn1_parse.c" 3 4
                                          ((void *)0)
# 209 "../crypto/asn1/asn1_parse.c"
                                              , &opp, len + hl);
                if (os != 
# 210 "../crypto/asn1/asn1_parse.c" 3 4
                         ((void *)0) 
# 210 "../crypto/asn1/asn1_parse.c"
                              && os->length > 0) {
                    opp = os->data;
                ...
                os = 
# 260 "../crypto/asn1/asn1_parse.c" 3 4
                    ((void *)0)
# 260 "../crypto/asn1/asn1_parse.c"
                        ;
            } else if (tag == 2) {
                int i;
                ...
                opp = op;
                ai = d2i_ASN1_INTEGER(
# 265 "../crypto/asn1/asn1_parse.c" 3 4
                                     ((void *)0)
# 265 "../crypto/asn1/asn1_parse.c"
                                         , &opp, len + hl);
                if (ai != 
# 266 "../crypto/asn1/asn1_parse.c" 3 4
                         ((void *)0)
# 266 "../crypto/asn1/asn1_parse.c"
                             ) {
                    if (BIO_write(bp, ":", 1) <= 0)
                        goto end;
                    if (ai->type == (2 | 0x100))
                ...
                ai = 
# 286 "../crypto/asn1/asn1_parse.c" 3 4
                    ((void *)0)
# 286 "../crypto/asn1/asn1_parse.c"
                        ;
            } else if (tag == 10) {
                int i;

                opp = op;
                ae = d2i_ASN1_ENUMERATED(
# 291 "../crypto/asn1/asn1_parse.c" 3 4
                                        ((void *)0)
# 291 "../crypto/asn1/asn1_parse.c"
                                            , &opp, len + hl);
                if (ae != 
# 292 "../crypto/asn1/asn1_parse.c" 3 4
                         ((void *)0)
# 292 "../crypto/asn1/asn1_parse.c"
                             ) {
                    if (BIO_write(bp, ":", 1) <= 0)
                        goto end;
                    if (ae->type == (10 | 0x100))
                ...
                ae = 
# 312 "../crypto/asn1/asn1_parse.c" 3 4
                    ((void *)0)
# 312 "../crypto/asn1/asn1_parse.c"
                        ;
            } else if (len > 0 && dump) {
                if (!nl) {
                    if (BIO_write(bp, "\n", 1) <= 0)
