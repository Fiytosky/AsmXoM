# 0 "../crypto/asn1/evp_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/evp_asn1.c"
# 10 "../crypto/asn1/evp_asn1.c"
...
# 20 "../crypto/asn1/evp_asn1.c" 3 4
                                         ((void *)0)
# 20 "../crypto/asn1/evp_asn1.c"
                                             )
        return 0;
...
int ASN1_TYPE_get_octetstring(const ASN1_TYPE *a, unsigned char *data, int max_len)
{
    ...
    if ((a->type != 4) || (a->value.octet_string == 
# 39 "../crypto/asn1/evp_asn1.c" 3 4
                                                                     ((void *)0)
# 39 "../crypto/asn1/evp_asn1.c"
                                                                         )) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/evp_asn1.c",40,__func__), ERR_set_error)((13),(109),
# 40 "../crypto/asn1/evp_asn1.c" 3 4
       ((void *)0)
# 40 "../crypto/asn1/evp_asn1.c"
       );
        return -1;
    }
    ...
    if (ret < max_len)
        ...
        num = max_len;
    if (num > 0 && data != 
# 49 "../crypto/asn1/evp_asn1.c" 3 4
                          ((void *)0)
# 49 "../crypto/asn1/evp_asn1.c"
                              )
        memcpy(data, p, num);
    return ret;
}
                                 ...
                                 long *num, unsigned char *data, int max_len)
{
    ...
    if (num != 
# 68 "../crypto/asn1/evp_asn1.c" 3 4
              ((void *)0)
# 68 "../crypto/asn1/evp_asn1.c"
                  )
        *num = anum;
...
static const ASN1_TEMPLATE asn1_int_oct_seq_tt[] = {
        { ((0x1 << 12)), (0), 
# 88 "../crypto/asn1/evp_asn1.c" 3 4
       __builtin_offsetof (
# 88 "../crypto/asn1/evp_asn1.c"
       asn1_int_oct
# 88 "../crypto/asn1/evp_asn1.c" 3 4
       , 
# 88 "../crypto/asn1/evp_asn1.c"
...
# 88 "../crypto/asn1/evp_asn1.c"
       , "num", (INT32_it) },
        { (0), (0), 
# 89 "../crypto/asn1/evp_asn1.c" 3 4
       __builtin_offsetof (
# 89 "../crypto/asn1/evp_asn1.c"
       asn1_int_oct
# 89 "../crypto/asn1/evp_asn1.c" 3 4
       , 
# 89 "../crypto/asn1/evp_asn1.c"
...
# 89 "../crypto/asn1/evp_asn1.c"
       , "oct", (ASN1_OCTET_STRING_it) }
} ; static const ASN1_ITEM * asn1_int_oct_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, asn1_int_oct_seq_tt, sizeof(asn1_int_oct_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 90 "../crypto/asn1/evp_asn1.c" 3 4
 ((void *)0)
# 90 "../crypto/asn1/evp_asn1.c"
 , sizeof(asn1_int_oct), "asn1_int_oct" }; return &local_it; }

extern const ASN1_ITEM * asn1_int_oct_it(void);
                                  ...
                                  int len)
{
    ...
    if (ASN1_TYPE_pack_sequence((asn1_int_oct_it()), &atmp, &a))
        return 1;
    return 0;
}
...
{
    asn1_int_oct *atmp = 
# 112 "../crypto/asn1/evp_asn1.c" 3 4
                        ((void *)0)
# 112 "../crypto/asn1/evp_asn1.c"
                            ;
    int ret = -1;

    if ((a->type != 16) || (a->value.sequence == 
# 115 "../crypto/asn1/evp_asn1.c" 3 4
                                                             ((void *)0)
# 115 "../crypto/asn1/evp_asn1.c"
                                                                 )) {
        goto err;
    }
    ...
    if (atmp == 
# 121 "../crypto/asn1/evp_asn1.c" 3 4
               ((void *)0)
# 121 "../crypto/asn1/evp_asn1.c"
                   )
        goto err;
    ...
    if (ret == -1) {
 err:
        (ERR_new(), ERR_set_debug("../crypto/asn1/evp_asn1.c",128,__func__), ERR_set_error)((13),(109),
# 128 "../crypto/asn1/evp_asn1.c" 3 4
       ((void *)0)
# 128 "../crypto/asn1/evp_asn1.c"
       );
    }
    ASN1_item_free(((void*) (1 ? atmp : (asn1_int_oct*)0)), (asn1_int_oct_it()));
    return ret;
}
...
static const ASN1_TEMPLATE asn1_oct_int_seq_tt[] = {
        { (0), (0), 
# 144 "../crypto/asn1/evp_asn1.c" 3 4
       __builtin_offsetof (
# 144 "../crypto/asn1/evp_asn1.c"
       asn1_oct_int
# 144 "../crypto/asn1/evp_asn1.c" 3 4
       , 
# 144 "../crypto/asn1/evp_asn1.c"
...
# 144 "../crypto/asn1/evp_asn1.c"
       , "oct", (ASN1_OCTET_STRING_it) },
        { ((0x1 << 12)), (0), 
# 145 "../crypto/asn1/evp_asn1.c" 3 4
       __builtin_offsetof (
# 145 "../crypto/asn1/evp_asn1.c"
       asn1_oct_int
# 145 "../crypto/asn1/evp_asn1.c" 3 4
       , 
# 145 "../crypto/asn1/evp_asn1.c"
...
# 145 "../crypto/asn1/evp_asn1.c"
       , "num", (INT32_it) }
} ; static const ASN1_ITEM * asn1_oct_int_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, asn1_oct_int_seq_tt, sizeof(asn1_oct_int_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 146 "../crypto/asn1/evp_asn1.c" 3 4
 ((void *)0)
# 146 "../crypto/asn1/evp_asn1.c"
 , sizeof(asn1_oct_int), "asn1_oct_int" }; return &local_it; }
                                       ...
                                       unsigned char *data, int len)
{
    ...
    if (ASN1_TYPE_pack_sequence((asn1_oct_int_it()), &atmp, &a))
        return 1;
    return 0;
}
...
{
    asn1_oct_int *atmp = 
# 168 "../crypto/asn1/evp_asn1.c" 3 4
                        ((void *)0)
# 168 "../crypto/asn1/evp_asn1.c"
                            ;
    int ret = -1;

    if ((a->type != 16) || (a->value.sequence == 
# 171 "../crypto/asn1/evp_asn1.c" 3 4
                                                             ((void *)0)
# 171 "../crypto/asn1/evp_asn1.c"
                                                                 ))
        goto err;
    ...
    if (atmp == 
# 176 "../crypto/asn1/evp_asn1.c" 3 4
               ((void *)0)
# 176 "../crypto/asn1/evp_asn1.c"
                   )
        goto err;
    ...
    if (ret == -1) {
 err:
        (ERR_new(), ERR_set_debug("../crypto/asn1/evp_asn1.c",183,__func__), ERR_set_error)((13),(109),
# 183 "../crypto/asn1/evp_asn1.c" 3 4
       ((void *)0)
# 183 "../crypto/asn1/evp_asn1.c"
       );
    }
    ASN1_item_free(((void*) (1 ? atmp : (asn1_oct_int*)0)), (asn1_oct_int_it()));
    return ret;
}
