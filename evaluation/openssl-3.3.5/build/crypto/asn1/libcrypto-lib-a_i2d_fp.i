# 0 "../crypto/asn1/a_i2d_fp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_i2d_fp.c"
# 10 "../crypto/asn1/a_i2d_fp.c"
...
# 23 "../crypto/asn1/a_i2d_fp.c" 3 4
                                      ((void *)0)
# 23 "../crypto/asn1/a_i2d_fp.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_i2d_fp.c",24,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 24 "../crypto/asn1/a_i2d_fp.c" 3 4
       ((void *)0)
# 24 "../crypto/asn1/a_i2d_fp.c"
       );
        return 0;
    }
...
int ASN1_i2d_bio(i2d_of_void *i2d, BIO *out, const void *x)
{
    ...
    n = i2d(x, 
# 40 "../crypto/asn1/a_i2d_fp.c" 3 4
              ((void *)0)
# 40 "../crypto/asn1/a_i2d_fp.c"
                  );
    if (n <= 0)
        return 0;

    b = CRYPTO_malloc(n, "../crypto/asn1/a_i2d_fp.c", 44);
    if (b == 
# 45 "../crypto/asn1/a_i2d_fp.c" 3 4
            ((void *)0)
# 45 "../crypto/asn1/a_i2d_fp.c"
                )
        return 0;
    ...
    CRYPTO_free(b, "../crypto/asn1/a_i2d_fp.c", 62);
    return ret;
}
...
int ASN1_item_i2d_fp(const ASN1_ITEM *it, FILE *out, const void *x)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 74 "../crypto/asn1/a_i2d_fp.c" 3 4
                                      ((void *)0)
# 74 "../crypto/asn1/a_i2d_fp.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_i2d_fp.c",75,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 75 "../crypto/asn1/a_i2d_fp.c" 3 4
       ((void *)0)
# 75 "../crypto/asn1/a_i2d_fp.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(out));
...
{
    unsigned char *b = 
# 87 "../crypto/asn1/a_i2d_fp.c" 3 4
                      ((void *)0)
# 87 "../crypto/asn1/a_i2d_fp.c"
                          ;
    int i, j = 0, n, ret = 1;

    n = ASN1_item_i2d(x, &b, it);
    if (b == 
# 91 "../crypto/asn1/a_i2d_fp.c" 3 4
            ((void *)0)
# 91 "../crypto/asn1/a_i2d_fp.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_i2d_fp.c",92,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 92 "../crypto/asn1/a_i2d_fp.c" 3 4
       ((void *)0)
# 92 "../crypto/asn1/a_i2d_fp.c"
       );
        return 0;
    }
    ...
    CRYPTO_free(b, "../crypto/asn1/a_i2d_fp.c", 107);
    return ret;
}
...
BIO *ASN1_item_i2d_mem_bio(const ASN1_ITEM *it, const ASN1_VALUE *val)
{
    ...
    if (it == 
# 115 "../crypto/asn1/a_i2d_fp.c" 3 4
             ((void *)0) 
# 115 "../crypto/asn1/a_i2d_fp.c"
                  || val == 
# 115 "../crypto/asn1/a_i2d_fp.c" 3 4
                            ((void *)0)
# 115 "../crypto/asn1/a_i2d_fp.c"
                                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_i2d_fp.c",116,__func__), ERR_set_error)((13),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 116 "../crypto/asn1/a_i2d_fp.c" 3 4
       ((void *)0)
# 116 "../crypto/asn1/a_i2d_fp.c"
       );
        return 
# 117 "../crypto/asn1/a_i2d_fp.c" 3 4
              ((void *)0)
# 117 "../crypto/asn1/a_i2d_fp.c"
                  ;
    }

    if ((res = BIO_new(BIO_s_mem())) == 
# 120 "../crypto/asn1/a_i2d_fp.c" 3 4
                                       ((void *)0)
# 120 "../crypto/asn1/a_i2d_fp.c"
                                           )
        return 
# 121 "../crypto/asn1/a_i2d_fp.c" 3 4
              ((void *)0)
# 121 "../crypto/asn1/a_i2d_fp.c"
                  ;
    if (ASN1_item_i2d_bio(it, res, val) <= 0) {
        BIO_free(res);
        res = 
# 124 "../crypto/asn1/a_i2d_fp.c" 3 4
             ((void *)0)
# 124 "../crypto/asn1/a_i2d_fp.c"
                 ;
    }
    return res;
}
