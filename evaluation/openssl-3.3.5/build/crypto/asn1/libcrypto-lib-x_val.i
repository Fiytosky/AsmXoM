# 0 "../crypto/asn1/x_val.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_val.c"
# 10 "../crypto/asn1/x_val.c"
...
# 14 "../crypto/asn1/x_val.c" 2

static const ASN1_TEMPLATE X509_VAL_seq_tt[] = {
        { (0), (0), 
# 16 "../crypto/asn1/x_val.c" 3 4
       __builtin_offsetof (
# 16 "../crypto/asn1/x_val.c"
       X509_VAL
# 16 "../crypto/asn1/x_val.c" 3 4
       , 
# 16 "../crypto/asn1/x_val.c"
...
# 16 "../crypto/asn1/x_val.c"
       , "notBefore", (ASN1_TIME_it) },
        { (0), (0), 
# 17 "../crypto/asn1/x_val.c" 3 4
       __builtin_offsetof (
# 17 "../crypto/asn1/x_val.c"
       X509_VAL
# 17 "../crypto/asn1/x_val.c" 3 4
       , 
# 17 "../crypto/asn1/x_val.c"
...
} ; const ASN1_ITEM * X509_VAL_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_VAL_seq_tt, sizeof(X509_VAL_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 18 "../crypto/asn1/x_val.c" 3 4
 ((void *)0)
# 18 "../crypto/asn1/x_val.c"
 , sizeof(X509_VAL), "X509_VAL" }; return &local_it; }

X509_VAL *d2i_X509_VAL(X509_VAL **a, const unsigned char **in, long len) { return (X509_VAL *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_VAL_it())); } int i2d_X509_VAL(const X509_VAL *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_VAL_it())); } X509_VAL *X509_VAL_new(void) { return (X509_VAL *)ASN1_item_new((X509_VAL_it())); } void X509_VAL_free(X509_VAL *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_VAL_it())); }
