# 0 "../crypto/asn1/asn_mstbl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn_mstbl.c"
# 10 "../crypto/asn1/asn_mstbl.c"
...
# 28 "../crypto/asn1/asn_mstbl.c" 3 4
                                                         ((void *)0)
# 28 "../crypto/asn1/asn_mstbl.c"
                                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_mstbl.c",29,__func__), ERR_set_error)((13),(172),
# 29 "../crypto/asn1/asn_mstbl.c" 3 4
       ((void *)0)
# 29 "../crypto/asn1/asn_mstbl.c"
       );
        return 0;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sktmp)); i++) {
        mval = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sktmp), (i)));
        if (!do_tcreate(mval->value, mval->name)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_mstbl.c",35,__func__), ERR_set_error)((13),(219),
# 35 "../crypto/asn1/asn_mstbl.c" 3 4
           ((void *)0)
# 35 "../crypto/asn1/asn_mstbl.c"
           );
            return 0;
        }
    }
...
static int do_tcreate(const char *value, const char *name)
{
    ...
    struct stack_st_CONF_VALUE *lst = 
# 63 "../crypto/asn1/asn_mstbl.c" 3 4
                               ((void *)0)
# 63 "../crypto/asn1/asn_mstbl.c"
                                   ;
    CONF_VALUE *cnf = 
# 64 "../crypto/asn1/asn_mstbl.c" 3 4
                     ((void *)0)
# 64 "../crypto/asn1/asn_mstbl.c"
                         ;
    nid = OBJ_sn2nid(name);
    if (nid == 0)
        nid = OBJ_ln2nid(name);
    ...
    if (!lst)
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(lst)); i++) {
        cnf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(lst), (i)));
        if (cnf->value == 
# 75 "../crypto/asn1/asn_mstbl.c" 3 4
                         ((void *)0)
# 75 "../crypto/asn1/asn_mstbl.c"
                             )
            goto err;
 ...
 err:
    if (rv == 0) {
        if (cnf)
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_mstbl.c",102,__func__), ERR_set_error)(13, 218,
                           "field=%s, value=%s", cnf->name,
                                                 cnf->value != 
# 104 "../crypto/asn1/asn_mstbl.c" 3 4
                                                              ((void *)0) 
# 104 "../crypto/asn1/asn_mstbl.c"
                                                                   ? cnf->value
                                                 : value);
        else
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_mstbl.c",107,__func__), ERR_set_error)(13, 218,
                           "name=%s, value=%s", name, value);
    } else {
        rv = ASN1_STRING_TABLE_add(nid, tbl_min, tbl_max,
                                   tbl_mask, tbl_flags);
        if (!rv)
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_mstbl.c",113,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 113 "../crypto/asn1/asn_mstbl.c" 3 4
           ((void *)0)
# 113 "../crypto/asn1/asn_mstbl.c"
           );
    }
    OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(lst),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return rv;
}
