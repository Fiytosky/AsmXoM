# 0 "../crypto/asn1/tasn_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_enc.c"
# 10 "../crypto/asn1/tasn_enc.c"
...
int ossl_asn1_item_ex_new_intern(ASN1_VALUE **pval, const ASN1_ITEM *it,
                                 OSSL_LIB_CTX *libctx, const char *propq);
# 18 "../crypto/asn1/tasn_enc.c" 2

static int asn1_i2d_ex_primitive(const ASN1_VALUE **pval, unsigned char **out,
                                 const ASN1_ITEM *it, int tag, int aclass);
static int asn1_set_seq_out(struct stack_st_const_ASN1_VALUE *sk,
                            unsigned char **out,
...
# 55 "../crypto/asn1/tasn_enc.c"
static int asn1_item_flags_i2d(const ASN1_VALUE *val, unsigned char **out,
                               const ASN1_ITEM *it, int flags)
{
    if (out != 
# 58 "../crypto/asn1/tasn_enc.c" 3 4
              ((void *)0) 
# 58 "../crypto/asn1/tasn_enc.c"
                   && *out == 
# 58 "../crypto/asn1/tasn_enc.c" 3 4
                              ((void *)0)
# 58 "../crypto/asn1/tasn_enc.c"
...
# 62 "../crypto/asn1/tasn_enc.c" 3 4
                                    ((void *)0)
# 62 "../crypto/asn1/tasn_enc.c"
                                        , it, -1, flags);
        if (len <= 0)
            return len;
        if ((buf = CRYPTO_malloc(len, "../crypto/asn1/tasn_enc.c", 65)) == 
# 65 "../crypto/asn1/tasn_enc.c" 3 4
                                          ((void *)0)
# 65 "../crypto/asn1/tasn_enc.c"
                                              )
            return -1;
        p = buf;
...
# 88 "../crypto/asn1/tasn_enc.c" 3 4
                                ((void *)0)
# 88 "../crypto/asn1/tasn_enc.c"
                                    ;

    if ((it->itype != 0x0) && *pval == 
# 90 "../crypto/asn1/tasn_enc.c" 3 4
                                                       ((void *)0)
# 90 "../crypto/asn1/tasn_enc.c"
                                                           )
        return 0;

    if (aux != 
# 93 "../crypto/asn1/tasn_enc.c" 3 4
              ((void *)0)
# 93 "../crypto/asn1/tasn_enc.c"
                  ) {
    ...
    case 0x5:
        ...
        if (tag != -1) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_enc.c",112,__func__), ERR_set_error)((13),(230),
# 112 "../crypto/asn1/tasn_enc.c" 3 4
           ((void *)0)
# 112 "../crypto/asn1/tasn_enc.c"
           );
            return -1;
        }
    ...
    case 0x2:
        ...
        if (tag != -1) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_enc.c",123,__func__), ERR_set_error)((13),(230),
# 123 "../crypto/asn1/tasn_enc.c" 3 4
           ((void *)0)
# 123 "../crypto/asn1/tasn_enc.c"
           );
            return -1;
        }
        if (asn1_cb && !asn1_cb(6, pval, it, 
# 126 "../crypto/asn1/tasn_enc.c" 3 4
                                                          ((void *)0)
# 126 "../crypto/asn1/tasn_enc.c"
                                                              ))
            return 0;
...
# 137 "../crypto/asn1/tasn_enc.c" 3 4
                                                           ((void *)0)
# 137 "../crypto/asn1/tasn_enc.c"
                                                               ))
            return 0;
        break;
    ...
    case 0x1:
        ...
        if (asn1_cb && !asn1_cb(6, pval, it, 
# 169 "../crypto/asn1/tasn_enc.c" 3 4
                                                          ((void *)0)
# 169 "../crypto/asn1/tasn_enc.c"
                                                              ))
            return 0;
        ...
        for (i = 0, tt = it->templates; i < it->tcount; tt++, i++) {
            ...
            tmplen = asn1_template_ex_i2d(pseqval, 
# 180 "../crypto/asn1/tasn_enc.c" 3 4
                                                  ((void *)0)
# 180 "../crypto/asn1/tasn_enc.c"
                                                      , seqtt, -1, aclass);
            if (tmplen == -1 || (tmplen > 0x7fffffff 
# 181 "../crypto/asn1/tasn_enc.c"
                                                 - seqcontlen))
                return -1;
            seqcontlen += tmplen;
        }
        ...
        if (ndef == 2)
            ASN1_put_eoc(out);
        if (asn1_cb && !asn1_cb(7, pval, it, 
# 203 "../crypto/asn1/tasn_enc.c" 3 4
                                                           ((void *)0)
                                ...
                                const ASN1_TEMPLATE *tt, int tag, int iclass)
{
    ...
    if (flags & (0x3 << 1)) {
        ...
        struct stack_st_const_ASN1_VALUE *sk = (struct stack_st_const_ASN1_VALUE *)*pval;
        int isset, sktag, skaclass;
        int skcontlen, sklen;
        const ASN1_VALUE *skitem;

        if (*pval == 
# 275 "../crypto/asn1/tasn_enc.c" 3 4
                    ((void *)0)
# 275 "../crypto/asn1/tasn_enc.c"
                        )
            return 0;
        ...
        for (i = 0; i < sk_const_ASN1_VALUE_num(sk); i++) {
            ...
            len = ASN1_item_ex_i2d(&skitem, 
# 305 "../crypto/asn1/tasn_enc.c" 3 4
                                           ((void *)0)
# 305 "../crypto/asn1/tasn_enc.c"
                                               , (tt->item()),
                                   -1, iclass);
            if (len == -1 || (skcontlen > 0x7fffffff 
# 307 "../crypto/asn1/tasn_enc.c"
                                                 - len))
                return -1;
            if (len == 0 && (tt->flags & (0x1)) == 0) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_enc.c",310,__func__), ERR_set_error)((13),(222),
# 310 "../crypto/asn1/tasn_enc.c" 3 4
               ((void *)0)
# 310 "../crypto/asn1/tasn_enc.c"
               );
                return -1;
            }
            skcontlen += len;
...
# 348 "../crypto/asn1/tasn_enc.c" 3 4
                                  ((void *)0)
# 348 "../crypto/asn1/tasn_enc.c"
                                      , (tt->item()), -1, iclass);
        if (i == 0) {
            if ((tt->flags & (0x1)) == 0) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_enc.c",351,__func__), ERR_set_error)((13),(222),
# 351 "../crypto/asn1/tasn_enc.c" 3 4
               ((void *)0)
# 351 "../crypto/asn1/tasn_enc.c"
               );
                return -1;
            }
            return 0;
        ...
        if (out && ret != -1) {
            ...
            ASN1_item_ex_i2d(pval, out, (tt->item()), -1, iclass);
            if (ndef == 2)
                ASN1_put_eoc(out);
        }
        return ret;
    ...
    len = ASN1_item_ex_i2d(pval, out, (tt->item()),
                              ttag, tclass | iclass);
    if (len == 0 && (tt->flags & (0x1)) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_enc.c",372,__func__), ERR_set_error)((13),(222),
# 372 "../crypto/asn1/tasn_enc.c" 3 4
       ((void *)0)
# 372 "../crypto/asn1/tasn_enc.c"
       );
        return -1;
    }
    return len;
...
# 406 "../crypto/asn1/tasn_enc.c" 3 4
                           ((void *)0)
# 406 "../crypto/asn1/tasn_enc.c"
                               , *p = 
# 406 "../crypto/asn1/tasn_enc.c" 3 4
                                      ((void *)0)
# 406 "../crypto/asn1/tasn_enc.c"
                                          ;
    DER_ENC *derlst = 
# 407 "../crypto/asn1/tasn_enc.c" 3 4
                     ((void *)0)
# 407 "../crypto/asn1/tasn_enc.c"
                         , *tder;
    ...
    if (do_sort) {
        ...
        if (sk_const_ASN1_VALUE_num(sk) < 2)
            ...
            derlst = CRYPTO_malloc(sk_const_ASN1_VALUE_num(sk) * sizeof(*derlst), "../crypto/asn1/tasn_enc.c", 414)
                                                      ;
            if (derlst == 
# 416 "../crypto/asn1/tasn_enc.c" 3 4
                         ((void *)0)
# 416 "../crypto/asn1/tasn_enc.c"
                             )
                return 0;
            tmpdat = CRYPTO_malloc(skcontlen, "../crypto/asn1/tasn_enc.c", 418);
            if (tmpdat == 
# 419 "../crypto/asn1/tasn_enc.c" 3 4
                         ((void *)0)
# 419 "../crypto/asn1/tasn_enc.c"
                             )
                goto err;
        }
    }
    ...
    *out = p;
    ...
    ret = 1;
err:
    CRYPTO_free(derlst, "../crypto/asn1/tasn_enc.c", 457);
    CRYPTO_free(tmpdat, "../crypto/asn1/tasn_enc.c", 458);
    return ret;
}
...
# 476 "../crypto/asn1/tasn_enc.c" 3 4
                           ((void *)0)
# 476 "../crypto/asn1/tasn_enc.c"
                               , &utype, it);
...
{
    ASN1_BOOLEAN *tbool = 
# 525 "../crypto/asn1/tasn_enc.c" 3 4
                         ((void *)0)
# 525 "../crypto/asn1/tasn_enc.c"
                             ;
    ASN1_STRING *strtmp;
    ASN1_OBJECT *otmp;
    int utype;
    ...
    if ((it->itype != 0x0)
        || (it->utype != 1)) {
        if (*pval == 
# 540 "../crypto/asn1/tasn_enc.c" 3 4
                    ((void *)0)
# 540 "../crypto/asn1/tasn_enc.c"
                        )
            return -1;
    }
    ...
    if (it->itype == 0x5) {
        ...
        *putype = utype;
        ...
        utype = typ->type;
        *putype = utype;
        pval = (const ASN1_VALUE **)&typ->value.asn1_value;
    } else
        utype = *putype;
    ...
    case 6:
        ...
        len = otmp->length;
        if (cont == 
# 564 "../crypto/asn1/tasn_enc.c" 3 4
                   ((void *)0) 
# 564 "../crypto/asn1/tasn_enc.c"
                        || len == 0)
            return -1;
        break;
    ...
    case 5:
        cont = 
# 572 "../crypto/asn1/tasn_enc.c" 3 4
              ((void *)0)
# 572 "../crypto/asn1/tasn_enc.c"
                  ;
        len = 0;
        break;
    ...
    case 3:
        return ossl_i2c_ASN1_BIT_STRING((ASN1_BIT_STRING *)*pval,
                                        cout ? &cout : 
# 596 "../crypto/asn1/tasn_enc.c" 3 4
                                                      ((void *)0)
# 596 "../crypto/asn1/tasn_enc.c"
                                                          );
    ...
    case 10:
        ...
        return ossl_i2c_ASN1_INTEGER((ASN1_INTEGER *)*pval, cout ? &cout : 
# 603 "../crypto/asn1/tasn_enc.c" 3 4
                                                                          ((void *)0)
# 603 "../crypto/asn1/tasn_enc.c"
                                                                              );
