# 0 "../crypto/asn1/p5_pbe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/p5_pbe.c"
# 10 "../crypto/asn1/p5_pbe.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 16 "../crypto/asn1/p5_pbe.c" 2



static const ASN1_TEMPLATE PBEPARAM_seq_tt[] = {
        { (0), (0), 
# 20 "../crypto/asn1/p5_pbe.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/asn1/p5_pbe.c"
       PBEPARAM
# 20 "../crypto/asn1/p5_pbe.c" 3 4
       , 
# 20 "../crypto/asn1/p5_pbe.c"
...
# 20 "../crypto/asn1/p5_pbe.c"
       , "salt", (ASN1_OCTET_STRING_it) },
        { (0), (0), 
# 21 "../crypto/asn1/p5_pbe.c" 3 4
       __builtin_offsetof (
# 21 "../crypto/asn1/p5_pbe.c"
       PBEPARAM
# 21 "../crypto/asn1/p5_pbe.c" 3 4
       , 
# 21 "../crypto/asn1/p5_pbe.c"
...
} ; const ASN1_ITEM * PBEPARAM_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PBEPARAM_seq_tt, sizeof(PBEPARAM_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 22 "../crypto/asn1/p5_pbe.c" 3 4
 ((void *)0)
# 22 "../crypto/asn1/p5_pbe.c"
 , sizeof(PBEPARAM), "PBEPARAM" }; return &local_it; }

PBEPARAM *d2i_PBEPARAM(PBEPARAM **a, const unsigned char **in, long len) { return (PBEPARAM *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PBEPARAM_it())); } int i2d_PBEPARAM(const PBEPARAM *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PBEPARAM_it())); } PBEPARAM *PBEPARAM_new(void) { return (PBEPARAM *)ASN1_item_new((PBEPARAM_it())); } void PBEPARAM_free(PBEPARAM *a) { ASN1_item_free((ASN1_VALUE *)a, (PBEPARAM_it())); }
...
{
    PBEPARAM *pbe = 
# 32 "../crypto/asn1/p5_pbe.c" 3 4
                   ((void *)0)
# 32 "../crypto/asn1/p5_pbe.c"
                       ;
    ASN1_STRING *pbe_str = 
# 33 "../crypto/asn1/p5_pbe.c" 3 4
                          ((void *)0)
# 33 "../crypto/asn1/p5_pbe.c"
                              ;
    unsigned char *sstr = 
# 34 "../crypto/asn1/p5_pbe.c" 3 4
                         ((void *)0)
# 34 "../crypto/asn1/p5_pbe.c"
                             ;

    pbe = PBEPARAM_new();
    if (pbe == 
# 37 "../crypto/asn1/p5_pbe.c" 3 4
              ((void *)0)
# 37 "../crypto/asn1/p5_pbe.c"
                  ) {

        (ERR_new(), ERR_set_debug("../crypto/asn1/p5_pbe.c",39,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 39 "../crypto/asn1/p5_pbe.c" 3 4
       ((void *)0)
# 39 "../crypto/asn1/p5_pbe.c"
       );
        goto err;
    }
    if (iter <= 0)
    ...
    if (!ASN1_INTEGER_set(pbe->iter, iter)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/p5_pbe.c",45,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 45 "../crypto/asn1/p5_pbe.c" 3 4
       ((void *)0)
# 45 "../crypto/asn1/p5_pbe.c"
       );
        goto err;
    }
    if (!saltlen)
    ...
    sstr = CRYPTO_malloc(saltlen, "../crypto/asn1/p5_pbe.c", 53);
    if (sstr == 
# 54 "../crypto/asn1/p5_pbe.c" 3 4
               ((void *)0)
# 54 "../crypto/asn1/p5_pbe.c"
                   )
        goto err;
    if (salt)
    ...
    sstr = 
# 62 "../crypto/asn1/p5_pbe.c" 3 4
          ((void *)0)
# 62 "../crypto/asn1/p5_pbe.c"
              ;

    if (!ASN1_item_pack(pbe, (PBEPARAM_it()), &pbe_str)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/p5_pbe.c",65,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 65 "../crypto/asn1/p5_pbe.c" 3 4
       ((void *)0)
# 65 "../crypto/asn1/p5_pbe.c"
       );
        goto err;
    }
    ...
    PBEPARAM_free(pbe);
    pbe = 
# 70 "../crypto/asn1/p5_pbe.c" 3 4
         ((void *)0)
# 70 "../crypto/asn1/p5_pbe.c"
             ;
 ...
 err:
    CRYPTO_free(sstr, "../crypto/asn1/p5_pbe.c", 76);
    PBEPARAM_free(pbe);
...
int PKCS5_pbe_set0_algor(X509_ALGOR *algor, int alg, int iter,
                         const unsigned char *salt, int saltlen)
{
    return PKCS5_pbe_set0_algor_ex(algor, alg, iter, salt, saltlen, 
# 85 "../crypto/asn1/p5_pbe.c" 3 4
                                                                   ((void *)0)
# 85 "../crypto/asn1/p5_pbe.c"
                                                                       );
}
                             ...
                             OSSL_LIB_CTX *ctx)
{
    ...
    ret = X509_ALGOR_new();
    if (ret == 
# 96 "../crypto/asn1/p5_pbe.c" 3 4
              ((void *)0)
# 96 "../crypto/asn1/p5_pbe.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/p5_pbe.c",97,__func__), ERR_set_error)((13),((11 | (0x2 << 18L))),
# 97 "../crypto/asn1/p5_pbe.c" 3 4
       ((void *)0)
# 97 "../crypto/asn1/p5_pbe.c"
       );
        return 
# 98 "../crypto/asn1/p5_pbe.c" 3 4
              ((void *)0)
# 98 "../crypto/asn1/p5_pbe.c"
                  ;
    }
    ...
    X509_ALGOR_free(ret);
    return 
# 105 "../crypto/asn1/p5_pbe.c" 3 4
          ((void *)0)
# 105 "../crypto/asn1/p5_pbe.c"
              ;
}
...
X509_ALGOR *PKCS5_pbe_set(int alg, int iter,
                          const unsigned char *salt, int saltlen)
{
    return PKCS5_pbe_set_ex(alg, iter, salt, saltlen, 
# 111 "../crypto/asn1/p5_pbe.c" 3 4
                                                     ((void *)0)
# 111 "../crypto/asn1/p5_pbe.c"
                                                         );
}
