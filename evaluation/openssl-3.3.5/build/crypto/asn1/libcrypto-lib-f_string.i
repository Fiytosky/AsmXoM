# 0 "../crypto/asn1/f_string.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/f_string.c"
# 10 "../crypto/asn1/f_string.c"
...
int i2a_ASN1_STRING(BIO *bp, const ASN1_STRING *a, int type)
{
    ...
    if (a == 
# 22 "../crypto/asn1/f_string.c" 3 4
            ((void *)0)
# 22 "../crypto/asn1/f_string.c"
                )
        return 0;
...
int a2i_ASN1_STRING(BIO *bp, ASN1_STRING *bs, char *buf, int size)
{
    ...
    unsigned char *s = 
# 51 "../crypto/asn1/f_string.c" 3 4
                      ((void *)0)
# 51 "../crypto/asn1/f_string.c"
                          , *sp;
    unsigned char *bufp;
    ...
    for (;;) {
        ...
        for (j = i - 1; j > 0; j--) {
            if (!(ossl_ctype_check((buf[j]), 0x10))) {
                i = j;
                break;
            }
        }
        ...
        i -= again;
        if (i % 2 != 0) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/f_string.c",94,__func__), ERR_set_error)((13),(145),
# 94 "../crypto/asn1/f_string.c" 3 4
           ((void *)0)
# 94 "../crypto/asn1/f_string.c"
           );
            CRYPTO_free(s, "../crypto/asn1/f_string.c", 95);
            return 0;
        }
        i /= 2;
        if (num + i > slen) {
            sp = CRYPTO_realloc(s, (unsigned int)num + i * 2, "../crypto/asn1/f_string.c", 100);
            if (sp == 
# 101 "../crypto/asn1/f_string.c" 3 4
                     ((void *)0)
# 101 "../crypto/asn1/f_string.c"
                         ) {
                CRYPTO_free(s, "../crypto/asn1/f_string.c", 102);
                return 0;
            }
            s = sp;
            slen = num + i * 2;
        ...
        for (j = 0; j < i; j++, k += 2) {
            for (n = 0; n < 2; n++) {
                ...
                if (m < 0) {
                    (ERR_new(), ERR_set_debug("../crypto/asn1/f_string.c",112,__func__), ERR_set_error)((13),(141),
# 112 "../crypto/asn1/f_string.c" 3 4
                   ((void *)0)
# 112 "../crypto/asn1/f_string.c"
                   );
                    CRYPTO_free(s, "../crypto/asn1/f_string.c", 113);
                    return 0;
                }
                s[num + j] <<= 4;
                s[num + j] |= m;
 ...
 err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/f_string.c",131,__func__), ERR_set_error)((13),(150),
# 131 "../crypto/asn1/f_string.c" 3 4
   ((void *)0)
# 131 "../crypto/asn1/f_string.c"
   );
    CRYPTO_free(s, "../crypto/asn1/f_string.c", 132);
    return 0;
}
