# 0 "../crypto/asn1/f_int.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/f_int.c"
# 10 "../crypto/asn1/f_int.c"
...
int i2a_ASN1_INTEGER(BIO *bp, const ASN1_INTEGER *a)
{
    ...
    if (a == 
# 22 "../crypto/asn1/f_int.c" 3 4
            ((void *)0)
# 22 "../crypto/asn1/f_int.c"
                )
        return 0;
...
int a2i_ASN1_INTEGER(BIO *bp, ASN1_INTEGER *bs, char *buf, int size)
{
    ...
    unsigned char *s = 
# 57 "../crypto/asn1/f_int.c" 3 4
                      ((void *)0)
# 57 "../crypto/asn1/f_int.c"
                          , *sp;
    unsigned char *bufp;
    ...
    for (;;) {
        ...
        i -= again;
        if (i % 2 != 0) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/f_int.c",103,__func__), ERR_set_error)((13),(145),
# 103 "../crypto/asn1/f_int.c" 3 4
           ((void *)0)
# 103 "../crypto/asn1/f_int.c"
           );
            CRYPTO_free(s, "../crypto/asn1/f_int.c", 104);
            return 0;
        }
        i /= 2;
        if (num + i > slen) {
            sp = CRYPTO_clear_realloc(s, slen, num + i * 2, "../crypto/asn1/f_int.c", 109);
            if (sp == 
# 110 "../crypto/asn1/f_int.c" 3 4
                     ((void *)0)
# 110 "../crypto/asn1/f_int.c"
                         ) {
                CRYPTO_free(s, "../crypto/asn1/f_int.c", 111);
                return 0;
            }
            s = sp;
            slen = num + i * 2;
        ...
        for (j = 0; j < i; j++, k += 2) {
            for (n = 0; n < 2; n++) {
                ...
                if (m < 0) {
                    (ERR_new(), ERR_set_debug("../crypto/asn1/f_int.c",121,__func__), ERR_set_error)((13),(141),
# 121 "../crypto/asn1/f_int.c" 3 4
                   ((void *)0)
# 121 "../crypto/asn1/f_int.c"
                   );
                    goto err;
                }
                s[num + j] <<= 4;
    ...
    return 1;
 err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/f_int.c",138,__func__), ERR_set_error)((13),(150),
# 138 "../crypto/asn1/f_int.c" 3 4
   ((void *)0)
# 138 "../crypto/asn1/f_int.c"
   );
    CRYPTO_free(s, "../crypto/asn1/f_int.c", 139);
    return 0;
}
