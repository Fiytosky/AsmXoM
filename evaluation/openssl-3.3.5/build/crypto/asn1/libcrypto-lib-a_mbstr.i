# 0 "../crypto/asn1/a_mbstr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_mbstr.c"
# 10 "../crypto/asn1/a_mbstr.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 13 "../crypto/asn1/a_mbstr.c" 2
# 1 "../include/internal/unicode.h" 1
...
static __attribute__((unused)) inline int is_unicode_surrogate(unsigned long value)
{
    return value >= SURROGATE_MIN && value <= SURROGATE_MAX;
}

static __attribute__((unused)) inline int is_unicode_valid(unsigned long value)
{
    return value <= UNICODE_MAX && !is_unicode_surrogate(value);
}
# 14 "../crypto/asn1/a_mbstr.c" 2
...
# 53 "../crypto/asn1/a_mbstr.c" 3 4
                                            ((void *)0)
# 53 "../crypto/asn1/a_mbstr.c"
                                                ;
    if (len == -1)
    ...
    case (0x1000|2):
        if (len & 1) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",66,__func__), ERR_set_error)((13),(129),
# 66 "../crypto/asn1/a_mbstr.c" 3 4
           ((void *)0)
# 66 "../crypto/asn1/a_mbstr.c"
           );
            return -1;
        }
        nchar = len >> 1;
    ...
    case (0x1000|4):
        if (len & 3) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",74,__func__), ERR_set_error)((13),(133),
# 74 "../crypto/asn1/a_mbstr.c" 3 4
           ((void *)0)
# 74 "../crypto/asn1/a_mbstr.c"
           );
            return -1;
        }
        nchar = len >> 2;
    ...
    case (0x1000):
        ...
        if (ret < 0) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",85,__func__), ERR_set_error)((13),(134),
# 85 "../crypto/asn1/a_mbstr.c" 3 4
           ((void *)0)
# 85 "../crypto/asn1/a_mbstr.c"
           );
            return -1;
        }
        break;
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",95,__func__), ERR_set_error)((13),(160),
# 95 "../crypto/asn1/a_mbstr.c" 3 4
       ((void *)0)
# 95 "../crypto/asn1/a_mbstr.c"
       );
        return -1;
    }

    if ((minsize > 0) && (nchar < minsize)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",100,__func__), ERR_set_error)(13, 152,
                       "minsize=%ld", minsize);
        return -1;
    }

    if ((maxsize > 0) && (nchar > maxsize)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",106,__func__), ERR_set_error)(13, 151,
                       "maxsize=%ld", maxsize);
        return -1;
    }
    ...
    if (traverse_string(in, len, inform, type_str, &mask) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",113,__func__), ERR_set_error)((13),(124),
# 113 "../crypto/asn1/a_mbstr.c" 3 4
       ((void *)0)
# 113 "../crypto/asn1/a_mbstr.c"
       );
        return -1;
    }
    ...
    if (*out) {
        free_out = 0;
        dest = *out;
        ASN1_STRING_set0(dest, 
# 142 "../crypto/asn1/a_mbstr.c" 3 4
                              ((void *)0)
# 142 "../crypto/asn1/a_mbstr.c"
                                  , 0);
        dest->type = str_type;
    } else {
        free_out = 1;
        ...
        if (dest == 
# 147 "../crypto/asn1/a_mbstr.c" 3 4
                   ((void *)0)
# 147 "../crypto/asn1/a_mbstr.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",148,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 148 "../crypto/asn1/a_mbstr.c" 3 4
           ((void *)0)
# 148 "../crypto/asn1/a_mbstr.c"
           );
            return -1;
        }
        *out = dest;
    ...
    if (inform == outform) {
        if (!ASN1_STRING_set(dest, in, len)) {
            if (free_out) {
                ...
                *out = 
# 158 "../crypto/asn1/a_mbstr.c" 3 4
                      ((void *)0)
# 158 "../crypto/asn1/a_mbstr.c"
                          ;
            }
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_mbstr.c",160,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 160 "../crypto/asn1/a_mbstr.c" 3 4
           ((void *)0)
# 160 "../crypto/asn1/a_mbstr.c"
           );
            return -1;
        }
        return str_type;
    ...
    if ((p = CRYPTO_malloc(outlen + 1, "../crypto/asn1/a_mbstr.c", 189)) == 
# 189 "../crypto/asn1/a_mbstr.c" 3 4
                                           ((void *)0)
# 189 "../crypto/asn1/a_mbstr.c"
                                               ) {
        if (free_out) {
            ASN1_STRING_free(dest);
            *out = 
# 192 "../crypto/asn1/a_mbstr.c" 3 4
                  ((void *)0)
# 192 "../crypto/asn1/a_mbstr.c"
                      ;
        }
        return -1;
    }
...
static int out_utf8(unsigned long value, void *arg)
{
    ...
    len = UTF8_putc(
# 265 "../crypto/asn1/a_mbstr.c" 3 4
                   ((void *)0)
# 265 "../crypto/asn1/a_mbstr.c"
                       , -1, value);
    if (len <= 0)
        return len;
    outlen = arg;
...
static int type_str(unsigned long value, void *arg)
{
    ...
    const int native = value > 0x7fffffff 
# 281 "../crypto/asn1/a_mbstr.c"
                                      ? 0x7fffffff 
# 281 "../crypto/asn1/a_mbstr.c"
                                                : (value);

    if ((types & 0x0001) && !(ossl_isdigit(native)
                                            || native == ' '))
        types &= ~0x0001;
    if ((types & 0x0002) && !(ossl_ctype_check((native), 0x800)))
        types &= ~0x0002;
    if ((types & 0x0010) && !(((native) & ~127) == 0))
        types &= ~0x0010;
    if ((types & 0x0004) && (value > 0xff))
        types &= ~0x0004;
    if ((types & 0x0800) && (value > 0xffff))
        types &= ~0x0800;
    if ((types & 0x2000) && !is_unicode_valid(value))
        types &= ~0x2000;
    if (!types)
        return -1;
