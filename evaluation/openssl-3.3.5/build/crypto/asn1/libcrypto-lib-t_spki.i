# 0 "../crypto/asn1/t_spki.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/t_spki.c"
# 10 "../crypto/asn1/t_spki.c"
...
int NETSCAPE_SPKI_print(BIO *out, NETSCAPE_SPKI *spki)
{
    ...
    X509_PUBKEY_get0_param(&spkioid, 
# 28 "../crypto/asn1/t_spki.c" 3 4
                                    ((void *)0)
# 28 "../crypto/asn1/t_spki.c"
                                        , 
# 28 "../crypto/asn1/t_spki.c" 3 4
                                          ((void *)0)
# 28 "../crypto/asn1/t_spki.c"
...
# 28 "../crypto/asn1/t_spki.c"
    ...
    if (pkey == 
# 33 "../crypto/asn1/t_spki.c" 3 4
               ((void *)0)
# 33 "../crypto/asn1/t_spki.c"
                   )
        BIO_printf(out, "  Unable to load public key\n");
    else {
        EVP_PKEY_print_public(out, pkey, 4, 
# 36 "../crypto/asn1/t_spki.c" 3 4
                                           ((void *)0)
# 36 "../crypto/asn1/t_spki.c"
                                               );
        EVP_PKEY_free(pkey);
    }
