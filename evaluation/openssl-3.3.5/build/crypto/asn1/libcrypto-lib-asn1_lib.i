# 0 "../crypto/asn1/asn1_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn1_lib.c"
# 10 "../crypto/asn1/asn1_lib.c"
                    ...
                    int *pclass, long omax)
{
    ...
    if (omax <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn1_lib.c",56,__func__), ERR_set_error)((13),(224),
# 56 "../crypto/asn1/asn1_lib.c" 3 4
       ((void *)0)
...
# 72 "../crypto/asn1/asn1_lib.c"
    ...
    *pclass = xclass;
    ...
    if (*plength > (omax - (p - *pp))) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn1_lib.c",95,__func__), ERR_set_error)((13),(155),
# 95 "../crypto/asn1/asn1_lib.c" 3 4
       ((void *)0)
# 95 "../crypto/asn1/asn1_lib.c"
       );
    ...
    *pp = p;
    return ret | inf;
 err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/asn1_lib.c",105,__func__), ERR_set_error)((13),(123),
# 105 "../crypto/asn1/asn1_lib.c" 3 4
   ((void *)0)
# 105 "../crypto/asn1/asn1_lib.c"
   );
    return 0x80;
}
# 116 "../crypto/asn1/asn1_lib.c"
static int asn1_get_length(const unsigned char **pp, int *inf, long *rl,
                           long max)
{
    const unsigned char *p = *pp;
...
{
    if (str == 
# 259 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 259 "../crypto/asn1/asn1_lib.c"
                  )
        return 0;
    dst->type = str->type;
...
ASN1_STRING *ASN1_STRING_dup(const ASN1_STRING *str)
{
    ...
    if (!str)
        return 
# 275 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 275 "../crypto/asn1/asn1_lib.c"
                  ;
    ret = ASN1_STRING_new();
    if (ret == 
# 277 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 277 "../crypto/asn1/asn1_lib.c"
                  )
        return 
# 278 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 278 "../crypto/asn1/asn1_lib.c"
                  ;
    if (!ASN1_STRING_copy(ret, str)) {
        ASN1_STRING_free(ret);
        return 
# 281 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 281 "../crypto/asn1/asn1_lib.c"
                  ;
    }
    return ret;
}
...
int ASN1_STRING_set(ASN1_STRING *str, const void *_data, int len_in)
{
    ...
    if (len_in < 0) {
        if (data == 
# 293 "../crypto/asn1/asn1_lib.c" 3 4
                   ((void *)0)
# 293 "../crypto/asn1/asn1_lib.c"
                       )
            return 0;
        len = strlen(data);
    } else {
    ...
    if (len > 0x7fffffff 
# 304 "../crypto/asn1/asn1_lib.c"
                     - 1) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn1_lib.c",305,__func__), ERR_set_error)((13),(223),
# 305 "../crypto/asn1/asn1_lib.c" 3 4
       ((void *)0)
# 305 "../crypto/asn1/asn1_lib.c"
       );
        return 0;
    }
    if ((size_t)str->length <= len || str->data == 
# 308 "../crypto/asn1/asn1_lib.c" 3 4
                                                  ((void *)0)
# 308 "../crypto/asn1/asn1_lib.c"
                                                      ) {
        c = str->data;
        ...
        str->data = CRYPTO_realloc(c, len + 1, "../crypto/asn1/asn1_lib.c", 314);

        if (str->data == 
# 316 "../crypto/asn1/asn1_lib.c" 3 4
                        ((void *)0)
# 316 "../crypto/asn1/asn1_lib.c"
                            ) {
            str->data = c;
            return 0;
        }
    ...
    str->length = len;
    if (data != 
# 322 "../crypto/asn1/asn1_lib.c" 3 4
               ((void *)0)
# 322 "../crypto/asn1/asn1_lib.c"
                   ) {
        memcpy(str->data, data, len);
# 333 "../crypto/asn1/asn1_lib.c"
        str->data[len] = '\0';
...
void ASN1_STRING_set0(ASN1_STRING *str, void *data, int len)
{
    CRYPTO_free(str->data, "../crypto/asn1/asn1_lib.c", 341);
    str->data = data;
    str->length = len;
}
...
ASN1_STRING *ASN1_STRING_type_new(int type)
{
    ...
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/asn1_lib.c", 355);
    if (ret == 
# 356 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 356 "../crypto/asn1/asn1_lib.c"
                  )
        return 
# 357 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 357 "../crypto/asn1/asn1_lib.c"
                  ;
    ret->type = type;
    return ret;
}
...
{
    if (a == 
# 364 "../crypto/asn1/asn1_lib.c" 3 4
            ((void *)0)
# 364 "../crypto/asn1/asn1_lib.c"
                )
        return;
    if (!(a->flags & 0x010))
        CRYPTO_free(a->data, "../crypto/asn1/asn1_lib.c", 367);
    if (embed == 0)
        CRYPTO_free(a, "../crypto/asn1/asn1_lib.c", 369);
}

void ASN1_STRING_free(ASN1_STRING *a)
{
    if (a == 
# 374 "../crypto/asn1/asn1_lib.c" 3 4
            ((void *)0)
# 374 "../crypto/asn1/asn1_lib.c"
                )
        return;
    ossl_asn1_string_embed_free(a, a->flags & 0x080);
}

void ASN1_STRING_clear_free(ASN1_STRING *a)
{
    if (a == 
# 381 "../crypto/asn1/asn1_lib.c" 3 4
            ((void *)0)
# 381 "../crypto/asn1/asn1_lib.c"
                )
        return;
    if (a->data && !(a->flags & 0x010))
                                   ...
                                   const char *sep, size_t max_len)
{
    ...
    char *result = 
# 441 "../crypto/asn1/asn1_lib.c" 3 4
                  ((void *)0)
# 441 "../crypto/asn1/asn1_lib.c"
                      ;
    char *p;

    if (sep == 
# 444 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 444 "../crypto/asn1/asn1_lib.c"
                  )
        sep = "";
    sep_len = strlen(sep);

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(text)); i++) {
        current = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(text), (i)));
        if (i > 0)
            length += sep_len;
        length += ASN1_STRING_length(current);
        if (max_len != 0 && length > max_len)
            return 
# 454 "../crypto/asn1/asn1_lib.c" 3 4
                  ((void *)0)
# 454 "../crypto/asn1/asn1_lib.c"
                      ;
    }
    if ((result = CRYPTO_malloc(length + 1, "../crypto/asn1/asn1_lib.c", 456)) == 
# 456 "../crypto/asn1/asn1_lib.c" 3 4
                                                ((void *)0)
# 456 "../crypto/asn1/asn1_lib.c"
                                                    )
        return 
# 457 "../crypto/asn1/asn1_lib.c" 3 4
              ((void *)0)
# 457 "../crypto/asn1/asn1_lib.c"
                  ;
