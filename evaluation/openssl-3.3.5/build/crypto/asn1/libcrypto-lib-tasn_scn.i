# 0 "../crypto/asn1/tasn_scn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_scn.c"
# 10 "../crypto/asn1/tasn_scn.c"
...
ASN1_SCTX *ASN1_SCTX_new(int (*scan_cb) (ASN1_SCTX *ctx))
{
    ASN1_SCTX *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/tasn_scn.c", 27);

    if (ret == 
# 29 "../crypto/asn1/tasn_scn.c" 3 4
              ((void *)0)
# 29 "../crypto/asn1/tasn_scn.c"
                  )
        return 
# 30 "../crypto/asn1/tasn_scn.c" 3 4
              ((void *)0)
# 30 "../crypto/asn1/tasn_scn.c"
                  ;
    ret->scan_cb = scan_cb;
    return ret;
}
...
void ASN1_SCTX_free(ASN1_SCTX *p)
{
    CRYPTO_free(p, "../crypto/asn1/tasn_scn.c", 37);
}
