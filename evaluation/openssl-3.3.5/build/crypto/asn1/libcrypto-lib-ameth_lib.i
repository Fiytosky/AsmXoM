# 0 "../crypto/asn1/ameth_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/ameth_lib.c"
# 13 "../crypto/asn1/ameth_lib.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 20 "../crypto/asn1/ameth_lib.c" 2

# 1 "../crypto/asn1/standard_methods.h" 1
# 15 "../crypto/asn1/standard_methods.h"
...
# 22 "../crypto/asn1/ameth_lib.c" 2

typedef int sk_cmp_fn_type(const char *const *a, const char *const *b);
static struct stack_st_EVP_PKEY_ASN1_METHOD *app_methods = 
# 24 "../crypto/asn1/ameth_lib.c" 3 4
                                                    ((void *)0)
# 24 "../crypto/asn1/ameth_lib.c"
                                                        ;
...
const EVP_PKEY_ASN1_METHOD *EVP_PKEY_asn1_get0(int idx)
{
    ...
    if (idx < 0)
        return 
# 50 "../crypto/asn1/ameth_lib.c" 3 4
              ((void *)0)
# 50 "../crypto/asn1/ameth_lib.c"
                  ;
    if (idx < num)
...
static const EVP_PKEY_ASN1_METHOD *pkey_asn1_find(int type)
{
    ...
    ret = OBJ_bsearch_ameth(&t, standard_methods, (sizeof(standard_methods)/sizeof((standard_methods)[0])));
    if (ret == 
# 70 "../crypto/asn1/ameth_lib.c" 3 4
              ((void *)0) 
# 70 "../crypto/asn1/ameth_lib.c"
                   || *ret == 
# 70 "../crypto/asn1/ameth_lib.c" 3 4
                              ((void *)0)
# 70 "../crypto/asn1/ameth_lib.c"
        ...
        return 
# 71 "../crypto/asn1/ameth_lib.c" 3 4
              ((void *)0)
# 71 "../crypto/asn1/ameth_lib.c"
                  ;
    return *ret;
}
...
const EVP_PKEY_ASN1_METHOD *EVP_PKEY_asn1_find(ENGINE **pe, int type)
{
    ...
    if (pe) {
        ...
        *pe = 
# 101 "../crypto/asn1/ameth_lib.c" 3 4
             ((void *)0)
# 101 "../crypto/asn1/ameth_lib.c"
                 ;
    }
    return t;
}
                                                   ...
                                                   const char *str, int len)
{
    int i;
    const EVP_PKEY_ASN1_METHOD *ameth = 
# 110 "../crypto/asn1/ameth_lib.c" 3 4
                                       ((void *)0)
# 110 "../crypto/asn1/ameth_lib.c"
                                           ;
    ...
    if (pe) {
        ...
        if (ameth) {
            ...
            if (!ENGINE_init(e))
                ameth = 
# 123 "../crypto/asn1/ameth_lib.c" 3 4
                       ((void *)0)
# 123 "../crypto/asn1/ameth_lib.c"
                           ;
            ENGINE_free(e);
            *pe = e;
            return ameth;
        ...
        *pe = 
# 129 "../crypto/asn1/ameth_lib.c" 3 4
             ((void *)0)
# 129 "../crypto/asn1/ameth_lib.c"
                 ;
    }
    ...
    return 
# 139 "../crypto/asn1/ameth_lib.c" 3 4
          ((void *)0)
# 139 "../crypto/asn1/ameth_lib.c"
              ;
}
...
# 154 "../crypto/asn1/ameth_lib.c"
    if (!((ameth->pem_str == 
# 154 "../crypto/asn1/ameth_lib.c" 3 4
                            ((void *)0)
           
# 155 "../crypto/asn1/ameth_lib.c"
          && (ameth->pkey_flags & 0x1) != 0)
          || (ameth->pem_str != 
# 156 "../crypto/asn1/ameth_lib.c" 3 4
                               ((void *)0)
              
# 157 "../crypto/asn1/ameth_lib.c"
             && (ameth->pkey_flags & 0x1) == 0))) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/ameth_lib.c",158,__func__), ERR_set_error)((6),((262|(0x2 << 18L))),
# 158 "../crypto/asn1/ameth_lib.c" 3 4
       ((void *)0)
# 158 "../crypto/asn1/ameth_lib.c"
       );
        return 0;
    }

    if (app_methods == 
# 162 "../crypto/asn1/ameth_lib.c" 3 4
                      ((void *)0)
# 162 "../crypto/asn1/ameth_lib.c"
                          ) {
        app_methods = sk_EVP_PKEY_ASN1_METHOD_new(ameth_cmp);
        if (app_methods == 
# 164 "../crypto/asn1/ameth_lib.c" 3 4
                          ((void *)0)
# 164 "../crypto/asn1/ameth_lib.c"
                              )
            return 0;
    }
    ...
    if (sk_EVP_PKEY_ASN1_METHOD_find(app_methods, &tmp) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/ameth_lib.c",170,__func__), ERR_set_error)((6),(179),
# 170 "../crypto/asn1/ameth_lib.c" 3 4
       ((void *)0)
# 170 "../crypto/asn1/ameth_lib.c"
       )
                                                                        ;
        return 0;
    }
...
# 184 "../crypto/asn1/ameth_lib.c" 3 4
                                                    ((void *)0)
# 184 "../crypto/asn1/ameth_lib.c"
                                                        , 
# 184 "../crypto/asn1/ameth_lib.c" 3 4
                                                          ((void *)0)
# 184 "../crypto/asn1/ameth_lib.c"
    ...
    if (ameth == 
# 185 "../crypto/asn1/ameth_lib.c" 3 4
                ((void *)0)
# 185 "../crypto/asn1/ameth_lib.c"
                    )
        return 0;
...
{
    EVP_PKEY_ASN1_METHOD *ameth = CRYPTO_zalloc(sizeof(*ameth), "../crypto/asn1/ameth_lib.c", 223);

    if (ameth == 
# 225 "../crypto/asn1/ameth_lib.c" 3 4
                ((void *)0)
# 225 "../crypto/asn1/ameth_lib.c"
                    )
        return 
# 226 "../crypto/asn1/ameth_lib.c" 3 4
              ((void *)0)
# 226 "../crypto/asn1/ameth_lib.c"
                  ;
    ...
    if (info) {
        ameth->info = CRYPTO_strdup(info, "../crypto/asn1/ameth_lib.c", 233);
        if (ameth->info == 
# 234 "../crypto/asn1/ameth_lib.c" 3 4
                          ((void *)0)
# 234 "../crypto/asn1/ameth_lib.c"
                              )
            goto err;
    }

    if (pem_str) {
        ameth->pem_str = CRYPTO_strdup(pem_str, "../crypto/asn1/ameth_lib.c", 239);
        if (ameth->pem_str == 
# 240 "../crypto/asn1/ameth_lib.c" 3 4
                             ((void *)0)
# 240 "../crypto/asn1/ameth_lib.c"
                                 )
            goto err;
    }
 ...
 err:
    EVP_PKEY_asn1_free(ameth);
    return 
# 248 "../crypto/asn1/ameth_lib.c" 3 4
          ((void *)0)
# 248 "../crypto/asn1/ameth_lib.c"
              ;
}
...
void EVP_PKEY_asn1_free(EVP_PKEY_ASN1_METHOD *ameth)
{
    if (ameth && (ameth->pkey_flags & 0x2)) {
        CRYPTO_free(ameth->pem_str, "../crypto/asn1/ameth_lib.c", 273);
        CRYPTO_free(ameth->info, "../crypto/asn1/ameth_lib.c", 274);
        CRYPTO_free(ameth, "../crypto/asn1/ameth_lib.c", 275);
    }
}
