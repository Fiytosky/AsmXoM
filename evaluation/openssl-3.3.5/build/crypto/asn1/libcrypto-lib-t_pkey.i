# 0 "../crypto/asn1/t_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/t_pkey.c"
# 10 "../crypto/asn1/t_pkey.c"
                  ...
                  unsigned char *ign, int indent)
{
    ...
    const char *neg;
    unsigned char *buf = 
# 50 "../crypto/asn1/t_pkey.c" 3 4
                        ((void *)0)
# 50 "../crypto/asn1/t_pkey.c"
                            , *tmp = 
# 50 "../crypto/asn1/t_pkey.c" 3 4
                                     ((void *)0)
# 50 "../crypto/asn1/t_pkey.c"
    ...
    if (num == 
# 53 "../crypto/asn1/t_pkey.c" 3 4
              ((void *)0)
# 53 "../crypto/asn1/t_pkey.c"
                  )
        return 1;
    ...
    buflen = ((BN_num_bits(num)+7)/8) + 1;
    buf = tmp = CRYPTO_malloc(buflen, "../crypto/asn1/t_pkey.c", 73);
    if (buf == 
# 74 "../crypto/asn1/t_pkey.c" 3 4
              ((void *)0)
# 74 "../crypto/asn1/t_pkey.c"
                  )
        goto err;
    buf[0] = 0;
    ...
    rv = 1;
    err:
    CRYPTO_clear_free(buf, buflen, "../crypto/asn1/t_pkey.c", 91);
    return rv;
}
