# 0 "../crypto/asn1/a_print.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_print.c"
# 10 "../crypto/asn1/a_print.c"
...
int ASN1_PRINTABLE_type(const unsigned char *s, int len)
{
    ...
    if (s == 
# 21 "../crypto/asn1/a_print.c" 3 4
            ((void *)0)
# 21 "../crypto/asn1/a_print.c"
                )
        return 19;
...
int ASN1_STRING_print(BIO *bp, const ASN1_STRING *v)
{
    ...
    if (v == 
# 75 "../crypto/asn1/a_print.c" 3 4
            ((void *)0)
# 75 "../crypto/asn1/a_print.c"
                )
        return 0;
    n = 0;
    p = (const char *)v->data;
