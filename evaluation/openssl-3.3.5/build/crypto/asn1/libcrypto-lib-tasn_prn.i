# 0 "../crypto/asn1/tasn_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_prn.c"
# 10 "../crypto/asn1/tasn_prn.c"
...
# 19 "../crypto/asn1/tasn_prn.c" 2
# 1 "../crypto/asn1/asn1_local.h" 1
# 14 "../crypto/asn1/asn1_local.h"
...
ASN1_PCTX *ASN1_PCTX_new(void)
{
    ...
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/tasn_prn.c", 39);
    if (ret == 
# 40 "../crypto/asn1/tasn_prn.c" 3 4
              ((void *)0)
# 40 "../crypto/asn1/tasn_prn.c"
                  )
        return 
# 41 "../crypto/asn1/tasn_prn.c" 3 4
              ((void *)0)
# 41 "../crypto/asn1/tasn_prn.c"
                  ;
    return ret;
}
...
void ASN1_PCTX_free(ASN1_PCTX *p)
{
    CRYPTO_free(p, "../crypto/asn1/tasn_prn.c", 47);
}
                    ...
                    const ASN1_ITEM *it, const ASN1_PCTX *pctx)
{
    const char *sname;
    if (pctx == 
# 123 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 123 "../crypto/asn1/tasn_prn.c"
                   )
        pctx = &default_pctx;
    if (pctx->flags & 0x100)
        sname = 
# 126 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 126 "../crypto/asn1/tasn_prn.c"
                   ;
    else
        sname = it->sname;
    return asn1_item_print_ctx(out, &ifld, indent, it, 
# 129 "../crypto/asn1/tasn_prn.c" 3 4
                                                      ((void *)0)
# 129 "../crypto/asn1/tasn_prn.c"
                                                          , sname, 0, pctx);
}
...
# 141 "../crypto/asn1/tasn_prn.c" 3 4
                                ((void *)0)
# 141 "../crypto/asn1/tasn_prn.c"
                                    ;
    ASN1_PRINT_ARG parg;
    int i;
    if (aux != 
# 144 "../crypto/asn1/tasn_prn.c" 3 4
              ((void *)0)
# 144 "../crypto/asn1/tasn_prn.c"
                  ) {
        parg.out = out;
        parg.indent = indent;
        parg.pctx = pctx;
        asn1_cb = ((aux->flags & 8) != 0) ? aux->asn1_const_cb
            : (ASN1_aux_const_cb *)aux->asn1_cb;
    }

   if (((it->itype != 0x0)
       || (it->utype != 1)) && *fld == 
# 153 "../crypto/asn1/tasn_prn.c" 3 4
                                                   ((void *)0)
# 153 "../crypto/asn1/tasn_prn.c"
                                                       ) {
        if (pctx->flags & 0x001) {
                            ...
                            const ASN1_TEMPLATE *tt, const ASN1_PCTX *pctx)
{
    ...
    if (pctx->flags & 0x080)
        ...
        sname = 
# 272 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 272 "../crypto/asn1/tasn_prn.c"
                   ;
    if (pctx->flags & 0x040)
        fname = 
# 274 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 274 "../crypto/asn1/tasn_prn.c"
                   ;
    else
        fname = tt->field_name;
    ...
    if (flags & (0x3 << 1)) {
        ...
        struct stack_st_const_ASN1_VALUE *stack;
        ...
        stack = (struct stack_st_const_ASN1_VALUE *)*fld;
        for (i = 0; i < sk_const_ASN1_VALUE_num(stack); i++) {
            ...
            if (!asn1_item_print_ctx(out, &skitem, indent + 2,
                                     (tt->item()), 
# 312 "../crypto/asn1/tasn_prn.c" 3 4
                                                             ((void *)0)
# 312 "../crypto/asn1/tasn_prn.c"
                                                                 , 
# 312 "../crypto/asn1/tasn_prn.c" 3 4
                                                                   ((void *)0)
# 312 "../crypto/asn1/tasn_prn.c"
        ...
        if (i == 0 && BIO_printf(out, "%*s<%s>\n", indent + 2, "",
                                 stack == 
# 317 "../crypto/asn1/tasn_prn.c" 3 4
                                         ((void *)0) 
# 317 "../crypto/asn1/tasn_prn.c"
                                              ? "ABSENT" : "EMPTY") <= 0)
            return 0;
        if (pctx->flags & 0x002) {
            if (BIO_printf(out, "%*s}\n", indent, "") <= 0)
                             ...
                             const ASN1_PCTX *pctx)
{
    ...
    if (pctx->flags & 0x100)
        sname = 
# 344 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 344 "../crypto/asn1/tasn_prn.c"
                   ;
    if (pctx->flags & 0x040)
        fname = 
# 346 "../crypto/asn1/tasn_prn.c" 3 4
               ((void *)0)
# 346 "../crypto/asn1/tasn_prn.c"
                   ;
    if (!sname && !fname)
        return 1;
    if (fname) {
...
static int asn1_print_integer(BIO *out, const ASN1_INTEGER *str)
{
    ...
    int ret = 1;
    s = i2s_ASN1_INTEGER(
# 395 "../crypto/asn1/tasn_prn.c" 3 4
                        ((void *)0)
# 395 "../crypto/asn1/tasn_prn.c"
                            , str);
    if (s == 
# 396 "../crypto/asn1/tasn_prn.c" 3 4
            ((void *)0)
# 396 "../crypto/asn1/tasn_prn.c"
    ...
    if (BIO_puts(out, s) <= 0)
        ret = 0;
    CRYPTO_free(s, "../crypto/asn1/tasn_prn.c", 400);
    return ret;
}
                                ...
                                const ASN1_PCTX *pctx)
{
    ...
    if (it->itype == 0x5) {
        ...
        if (utype == 1)
            str = 
# 452 "../crypto/asn1/tasn_prn.c" 3 4
                 ((void *)0)
# 452 "../crypto/asn1/tasn_prn.c"
                     ;
        else
            str = (ASN1_STRING *)*fld;
    }
    if (utype == -4) {
        ...
        utype = atype->type;
        fld = (const ASN1_VALUE **)&atype->value.asn1_value;
        str = (ASN1_STRING *)*fld;
        if (pctx->flags & 0x010)
            pname = 
# 462 "../crypto/asn1/tasn_prn.c" 3 4
                   ((void *)0)
# 462 "../crypto/asn1/tasn_prn.c"
                       ;
        else
        ...
        if (pctx->flags & 0x008)
            ...
            pname = 
# 469 "../crypto/asn1/tasn_prn.c" 3 4
                   ((void *)0)
# 469 "../crypto/asn1/tasn_prn.c"
                       ;
    }
