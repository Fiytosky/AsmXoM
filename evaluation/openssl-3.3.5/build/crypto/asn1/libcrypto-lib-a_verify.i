# 0 "../crypto/asn1/a_verify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_verify.c"
# 10 "../crypto/asn1/a_verify.c"
...
# 32 "../crypto/asn1/a_verify.c" 3 4
                               ((void *)0)
# 32 "../crypto/asn1/a_verify.c"
                                   ;
    int ret = -1, i, inl;

    if (ctx == 
# 35 "../crypto/asn1/a_verify.c" 3 4
              ((void *)0)
# 35 "../crypto/asn1/a_verify.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",36,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 36 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 36 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }
    ...
    if (type == 
# 41 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 41 "../crypto/asn1/a_verify.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",42,__func__), ERR_set_error)((13),(161),
# 42 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 42 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }

    if (signature->type == 3 && signature->flags & 0x7) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",47,__func__), ERR_set_error)((13),(220),
# 47 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 47 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }

    inl = i2d(data, 
# 51 "../crypto/asn1/a_verify.c" 3 4
                   ((void *)0)
# 51 "../crypto/asn1/a_verify.c"
                       );
    if (inl <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",53,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 53 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 53 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }
    buf_in = CRYPTO_malloc((unsigned int)inl, "../crypto/asn1/a_verify.c", 56);
    if (buf_in == 
# 57 "../crypto/asn1/a_verify.c" 3 4
                 ((void *)0)
# 57 "../crypto/asn1/a_verify.c"
                     )
        goto err;
    p = buf_in;

    i2d(data, &p);
    ret = EVP_DigestInit_ex(ctx,type,
# 62 "../crypto/asn1/a_verify.c" 3 4
         ((void *)0)
# 62 "../crypto/asn1/a_verify.c"
         )
        && EVP_DigestUpdate(ctx,(unsigned char *)buf_in,inl);

    CRYPTO_clear_free(buf_in, (unsigned int)inl, "../crypto/asn1/a_verify.c", 65);

    if (!ret) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",68,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 68 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 68 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }
    ret = -1;
    ...
    if (EVP_VerifyFinal(ctx, (unsigned char *)signature->data,
        ...
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",75,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 75 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 75 "../crypto/asn1/a_verify.c"
       );
        ret = 0;
        goto err;
    }
...
int ASN1_item_verify(const ASN1_ITEM *it, const X509_ALGOR *alg,
                     ...
                     EVP_PKEY *pkey)
{
    return ASN1_item_verify_ex(it, alg, signature, data, 
# 91 "../crypto/asn1/a_verify.c" 3 4
                                                        ((void *)0)
# 91 "../crypto/asn1/a_verify.c"
                                                            , pkey, 
# 91 "../crypto/asn1/a_verify.c" 3 4
                                                                    ((void *)0)
# 91 "../crypto/asn1/a_verify.c"
                        ...
                        OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if ((ctx = evp_md_ctx_new_ex(pkey, id, libctx, propq)) != 
# 102 "../crypto/asn1/a_verify.c" 3 4
                                                             ((void *)0)
# 102 "../crypto/asn1/a_verify.c"
                                                                 ) {
...
# 115 "../crypto/asn1/a_verify.c" 3 4
                           ((void *)0)
# 115 "../crypto/asn1/a_verify.c"
                               ;
    int ret = -1, inl = 0;
    int mdnid, pknid;
    size_t inll = 0;
    ...
    if (pkey == 
# 122 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 122 "../crypto/asn1/a_verify.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",123,__func__), ERR_set_error)((13),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 123 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 123 "../crypto/asn1/a_verify.c"
       );
        return -1;
    }

    if (signature->type == 3 && signature->flags & 0x7) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",128,__func__), ERR_set_error)((13),(220),
# 128 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 128 "../crypto/asn1/a_verify.c"
       );
        return -1;
    }
    ...
    if (!OBJ_find_sigid_algs(OBJ_obj2nid(alg->algorithm), &mdnid, &pknid)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",134,__func__), ERR_set_error)((13),(199),
# 134 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 134 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }

    if (mdnid == 0 && ((pkey)->type != 0 && (pkey)->keymgmt == 
# 138 "../crypto/asn1/a_verify.c" 3 4
                             ((void *)0)
# 138 "../crypto/asn1/a_verify.c"
                             )) {
        if (pkey->ameth == 
# 139 "../crypto/asn1/a_verify.c" 3 4
                          ((void *)0) 
# 139 "../crypto/asn1/a_verify.c"
                               || pkey->ameth->item_verify == 
# 139 "../crypto/asn1/a_verify.c" 3 4
                                                              ((void *)0)
# 139 "../crypto/asn1/a_verify.c"
                                                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",140,__func__), ERR_set_error)((13),(199),
# 140 "../crypto/asn1/a_verify.c" 3 4
           ((void *)0)
# 140 "../crypto/asn1/a_verify.c"
           );
            goto err;
        }
        ...
        if (ret <= 0)
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",151,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 151 "../crypto/asn1/a_verify.c" 3 4
           ((void *)0)
# 151 "../crypto/asn1/a_verify.c"
           );
        if (ret <= 1)
            goto err;
    } else {
        const EVP_MD *type = 
# 155 "../crypto/asn1/a_verify.c" 3 4
                            ((void *)0)
# 155 "../crypto/asn1/a_verify.c"
                                ;
        ...
        if (mdnid == 0 && pknid == 912) {
            if (!EVP_PKEY_is_a(pkey, "RSA") && !EVP_PKEY_is_a(pkey, "RSA-PSS")) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",165,__func__), ERR_set_error)((13),(200),
# 165 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 165 "../crypto/asn1/a_verify.c"
               );
                goto err;
            }

            if (ossl_rsa_pss_to_ctx(ctx, 
# 169 "../crypto/asn1/a_verify.c" 3 4
                                        ((void *)0)
# 169 "../crypto/asn1/a_verify.c"
                                            , alg, pkey) <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",170,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 170 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 170 "../crypto/asn1/a_verify.c"
               );
                goto err;
            }
        } else {
            ...
            if (!EVP_PKEY_is_a(pkey, OBJ_nid2sn(pknid))) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",176,__func__), ERR_set_error)((13),(200),
# 176 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 176 "../crypto/asn1/a_verify.c"
               );
                goto err;
            }
            ...
            if (mdnid != 0) {
                ...
                if (type == 
# 182 "../crypto/asn1/a_verify.c" 3 4
                           ((void *)0)
# 182 "../crypto/asn1/a_verify.c"
                               ) {
                    (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",183,__func__), ERR_set_error)(13,
                                   161,
                                   "nid=0x%x", mdnid);
                    goto err;
                }
...
# 194 "../crypto/asn1/a_verify.c" 3 4
                                          ((void *)0)
# 194 "../crypto/asn1/a_verify.c"
                                              , type, 
# 194 "../crypto/asn1/a_verify.c" 3 4
                                                      ((void *)0)
# 194 "../crypto/asn1/a_verify.c"
                                                          , pkey)) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",195,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 195 "../crypto/asn1/a_verify.c" 3 4
               ((void *)0)
# 195 "../crypto/asn1/a_verify.c"
               );
                ret = 0;
                goto err;
            }
    ...
    if (inl <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",204,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 204 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 204 "../crypto/asn1/a_verify.c"
       );
        ret = -1;
        goto err;
    }
    if (buf_in == 
# 208 "../crypto/asn1/a_verify.c" 3 4
                 ((void *)0)
# 208 "../crypto/asn1/a_verify.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",209,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 209 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 209 "../crypto/asn1/a_verify.c"
       );
        ret = -1;
        goto err;
    }
    ...
    ret = EVP_DigestVerify(ctx, signature->data, (size_t)signature->length,
                           buf_in, inl);
    if (ret <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_verify.c",218,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 218 "../crypto/asn1/a_verify.c" 3 4
       ((void *)0)
# 218 "../crypto/asn1/a_verify.c"
       );
        goto err;
    }
    ret = 1;
 err:
    CRYPTO_clear_free(buf_in, inll, "../crypto/asn1/a_verify.c", 223);
    return ret;
}
