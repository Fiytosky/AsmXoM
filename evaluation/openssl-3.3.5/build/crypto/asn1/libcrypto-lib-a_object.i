# 0 "../crypto/asn1/a_object.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_object.c"
# 10 "../crypto/asn1/a_object.c"
...
int ossl_asn1_item_ex_new_intern(ASN1_VALUE **pval, const ASN1_ITEM *it,
                                 OSSL_LIB_CTX *libctx, const char *propq);
# 20 "../crypto/asn1/a_object.c" 2

int i2d_ASN1_OBJECT(const ASN1_OBJECT *a, unsigned char **pp)
{
    unsigned char *p, *allocated = 
# 23 "../crypto/asn1/a_object.c" 3 4
                                  ((void *)0)
# 23 "../crypto/asn1/a_object.c"
                                      ;
    int objsize;

    if ((a == 
# 26 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 26 "../crypto/asn1/a_object.c"
                 ) || (a->data == 
# 26 "../crypto/asn1/a_object.c" 3 4
                                  ((void *)0)
# 26 "../crypto/asn1/a_object.c"
    ...
    if (pp == 
# 30 "../crypto/asn1/a_object.c" 3 4
             ((void *)0) 
# 30 "../crypto/asn1/a_object.c"
                  || objsize == -1)
        return objsize;

    if (*pp == 
# 33 "../crypto/asn1/a_object.c" 3 4
              ((void *)0)
# 33 "../crypto/asn1/a_object.c"
                  ) {
        if ((p = allocated = CRYPTO_malloc(objsize, "../crypto/asn1/a_object.c", 34)) == 
# 34 "../crypto/asn1/a_object.c" 3 4
                                                        ((void *)0)
# 34 "../crypto/asn1/a_object.c"
                                                            )
            return 0;
    } else {
        p = *pp;
    ...
    *pp = allocated != 
# 47 "../crypto/asn1/a_object.c" 3 4
                      ((void *)0) 
# 47 "../crypto/asn1/a_object.c"
                           ? allocated : p + a->length;
    return objsize;
}
...
int a2d_ASN1_OBJECT(unsigned char *out, int olen, const char *buf, int num)
{
    ...
    unsigned long l;
    BIGNUM *bl = 
# 58 "../crypto/asn1/a_object.c" 3 4
                ((void *)0)
# 58 "../crypto/asn1/a_object.c"
                    ;
    ...
    if ((c >= '0') && (c <= '2')) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",71,__func__), ERR_set_error)((13),(122),
# 71 "../crypto/asn1/a_object.c" 3 4
       ((void *)0)
# 71 "../crypto/asn1/a_object.c"
       );
        goto err;
    }

    if (num <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",76,__func__), ERR_set_error)((13),(138),
# 76 "../crypto/asn1/a_object.c" 3 4
       ((void *)0)
# 76 "../crypto/asn1/a_object.c"
       );
        goto err;
    }
    c = *(p++);
    ...
    for (;;) {
        if (num <= 0)
            break;
        if ((c != '.') && (c != ' ')) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",85,__func__), ERR_set_error)((13),(131),
# 85 "../crypto/asn1/a_object.c" 3 4
           ((void *)0)
# 85 "../crypto/asn1/a_object.c"
           );
            goto err;
        }
        l = 0;
        ...
        for (;;) {
            ...
            if ((c == ' ') || (c == '.'))
                break;
            if (!ossl_isdigit(c)) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",98,__func__), ERR_set_error)((13),(130),
# 98 "../crypto/asn1/a_object.c" 3 4
               ((void *)0)
# 98 "../crypto/asn1/a_object.c"
               );
                goto err;
            }
            if (!use_bn && l >= ((
# 101 "../crypto/asn1/a_object.c" 3 4
                                 (0x7fffffffffffffffL * 2UL + 1UL) 
# 101 "../crypto/asn1/a_object.c"
                                           - 80) / 10L)) {
                use_bn = 1;
                if (bl == 
# 103 "../crypto/asn1/a_object.c" 3 4
                         ((void *)0)
# 103 "../crypto/asn1/a_object.c"
                             )
                    bl = BN_new();
                if (bl == 
# 105 "../crypto/asn1/a_object.c" 3 4
                         ((void *)0) 
# 105 "../crypto/asn1/a_object.c"
                              || !BN_set_word(bl, l))
                    goto err;
            }
            if (use_bn) {
        ...
        if (len == 0) {
            if ((first < 2) && (l >= 40)) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",117,__func__), ERR_set_error)((13),(147),
# 117 "../crypto/asn1/a_object.c" 3 4
               ((void *)0)
# 117 "../crypto/asn1/a_object.c"
               );
                goto err;
            }
            if (use_bn) {
        ...
        if (use_bn) {
            ...
            if (blsize > tmpsize) {
                if (tmp != ftmp)
                    CRYPTO_free(tmp, "../crypto/asn1/a_object.c", 133);
                tmpsize = blsize + 32;
                tmp = CRYPTO_malloc(tmpsize, "../crypto/asn1/a_object.c", 135);
                if (tmp == 
# 136 "../crypto/asn1/a_object.c" 3 4
                          ((void *)0)
# 136 "../crypto/asn1/a_object.c"
                              )
                    goto err;
            }
            while (blsize--) {
                unsigned long t = BN_div_word(bl, 0x80L);
        ...
        if (out != 
# 155 "../crypto/asn1/a_object.c" 3 4
                  ((void *)0)
# 155 "../crypto/asn1/a_object.c"
                      ) {
            if (len + i > olen) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",157,__func__), ERR_set_error)((13),(107),
# 157 "../crypto/asn1/a_object.c" 3 4
               ((void *)0)
# 157 "../crypto/asn1/a_object.c"
               );
                goto err;
            }
            while (--i > 0)
    ...
    if (tmp != ftmp)
        CRYPTO_free(tmp, "../crypto/asn1/a_object.c", 167);
    BN_free(bl);
    return len;
 err:
    if (tmp != ftmp)
        CRYPTO_free(tmp, "../crypto/asn1/a_object.c", 172);
    BN_free(bl);
    return 0;
}
...
int i2a_ASN1_OBJECT(BIO *bp, const ASN1_OBJECT *a)
{
    ...
    if ((a == 
# 187 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 187 "../crypto/asn1/a_object.c"
                 ) || (a->data == 
# 187 "../crypto/asn1/a_object.c" 3 4
                                  ((void *)0)
# 187 "../crypto/asn1/a_object.c"
    ...
    if (i > (int)(sizeof(buf) - 1)) {
        if (i > 0x7fffffff 
# 191 "../crypto/asn1/a_object.c"
                       - 1) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",192,__func__), ERR_set_error)((13),(231),
# 192 "../crypto/asn1/a_object.c" 3 4
           ((void *)0)
# 192 "../crypto/asn1/a_object.c"
           );
            return -1;
        }
        if ((p = CRYPTO_malloc(i + 1, "../crypto/asn1/a_object.c", 195)) == 
# 195 "../crypto/asn1/a_object.c" 3 4
                                          ((void *)0)
# 195 "../crypto/asn1/a_object.c"
                                              )
            return -1;
    ...
    BIO_write(bp, p, i);
    if (p != buf)
        CRYPTO_free(p, "../crypto/asn1/a_object.c", 206);
    return i;
}
                             ...
                             long length)
{
    ...
    int inf, i;
    ASN1_OBJECT *ret = 
# 217 "../crypto/asn1/a_object.c" 3 4
                      ((void *)0)
# 217 "../crypto/asn1/a_object.c"
                          ;
    p = *pp;
    ...
    return ret;
 err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",234,__func__), ERR_set_error)((13),(i),
# 234 "../crypto/asn1/a_object.c" 3 4
   ((void *)0)
# 234 "../crypto/asn1/a_object.c"
   );
    return 
# 235 "../crypto/asn1/a_object.c" 3 4
          ((void *)0)
# 235 "../crypto/asn1/a_object.c"
              ;
}
...
{
    ASN1_OBJECT *ret = 
# 241 "../crypto/asn1/a_object.c" 3 4
                      ((void *)0)
# 241 "../crypto/asn1/a_object.c"
                          , tobj;
    const unsigned char *p;
    unsigned char *data;
    int i, length;
...
# 251 "../crypto/asn1/a_object.c"
                                 || pp == 
# 251 "../crypto/asn1/a_object.c" 3 4
                                          ((void *)0) 
# 251 "../crypto/asn1/a_object.c"
                                               || (p = *pp) == 
# 251 "../crypto/asn1/a_object.c" 3 4
...
# 251 "../crypto/asn1/a_object.c"
                                                                    ||
        p[len - 1] & 0x80) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",253,__func__), ERR_set_error)((13),(216),
# 253 "../crypto/asn1/a_object.c" 3 4
       ((void *)0)
# 253 "../crypto/asn1/a_object.c"
       );
        return 
# 254 "../crypto/asn1/a_object.c" 3 4
              ((void *)0)
# 254 "../crypto/asn1/a_object.c"
                  ;
    }
    ...
    for (i = 0; i < length; i++, p++) {
        if (*p == 0x80 && (!i || !(p[-1] & 0x80))) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",283,__func__), ERR_set_error)((13),(216),
# 283 "../crypto/asn1/a_object.c" 3 4
           ((void *)0)
# 283 "../crypto/asn1/a_object.c"
           );
            return 
# 284 "../crypto/asn1/a_object.c" 3 4
                  ((void *)0)
# 284 "../crypto/asn1/a_object.c"
                      ;
        }
    }

    if ((a == 
# 288 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 288 "../crypto/asn1/a_object.c"
                 ) || ((*a) == 
# 288 "../crypto/asn1/a_object.c" 3 4
                               ((void *)0)
# 288 "../crypto/asn1/a_object.c"
...
# 290 "../crypto/asn1/a_object.c" 3 4
                                        ((void *)0)
# 290 "../crypto/asn1/a_object.c"
                                            )
            return 
# 291 "../crypto/asn1/a_object.c" 3 4
                  ((void *)0)
# 291 "../crypto/asn1/a_object.c"
                      ;
    } else {
        ret = (*a);
    }
    ...
    ret->data = 
# 299 "../crypto/asn1/a_object.c" 3 4
               ((void *)0)
# 299 "../crypto/asn1/a_object.c"
                   ;

    if ((data == 
# 301 "../crypto/asn1/a_object.c" 3 4
                ((void *)0)
# 301 "../crypto/asn1/a_object.c"
                    ) || (ret->length < length)) {
        ret->length = 0;
        CRYPTO_free(data, "../crypto/asn1/a_object.c", 303);
        data = CRYPTO_malloc(length, "../crypto/asn1/a_object.c", 304);
        if (data == 
# 305 "../crypto/asn1/a_object.c" 3 4
                   ((void *)0)
# 305 "../crypto/asn1/a_object.c"
                       )
            goto err;
        ret->flags |= 0x08;
    }
    ...
    if ((ret->flags & 0x04) != 0) {
        CRYPTO_free((char *)ret->sn, "../crypto/asn1/a_object.c", 312);
        CRYPTO_free((char *)ret->ln, "../crypto/asn1/a_object.c", 313);
        ret->flags &= ~0x04;
    }
    ...
    ret->length = length;
    ret->sn = 
# 319 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 319 "../crypto/asn1/a_object.c"
                 ;
    ret->ln = 
# 320 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 320 "../crypto/asn1/a_object.c"
                 ;

    p += length;

    if (a != 
# 324 "../crypto/asn1/a_object.c" 3 4
            ((void *)0)
# 324 "../crypto/asn1/a_object.c"
                )
        (*a) = ret;
    *pp = p;
    return ret;
 err:
    (ERR_new(), ERR_set_debug("../crypto/asn1/a_object.c",329,__func__), ERR_set_error)((13),(i),
# 329 "../crypto/asn1/a_object.c" 3 4
   ((void *)0)
# 329 "../crypto/asn1/a_object.c"
   );
    if ((a == 
# 330 "../crypto/asn1/a_object.c" 3 4
             ((void *)0)
# 330 "../crypto/asn1/a_object.c"
                 ) || (*a != ret))
        ASN1_OBJECT_free(ret);
    return 
# 332 "../crypto/asn1/a_object.c" 3 4
          ((void *)0)
...
ASN1_OBJECT *ASN1_OBJECT_new(void)
{
    ...
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/asn1/a_object.c", 339);
    if (ret == 
# 340 "../crypto/asn1/a_object.c" 3 4
              ((void *)0)
# 340 "../crypto/asn1/a_object.c"
                  )
        return 
# 341 "../crypto/asn1/a_object.c" 3 4
              ((void *)0)
# 341 "../crypto/asn1/a_object.c"
                  ;
    ret->flags = 0x01;
    return ret;
}
...
{
    if (a == 
# 348 "../crypto/asn1/a_object.c" 3 4
            ((void *)0)
# 348 "../crypto/asn1/a_object.c"
                )
        return;
    if (a->flags & 0x04) {
        ...
        CRYPTO_free((void*)a->sn, "../crypto/asn1/a_object.c", 356);
        CRYPTO_free((void*)a->ln, "../crypto/asn1/a_object.c", 357);

        a->sn = a->ln = 
# 359 "../crypto/asn1/a_object.c" 3 4
                       ((void *)0)
# 359 "../crypto/asn1/a_object.c"
                           ;
    }
    if (a->flags & 0x08) {
        CRYPTO_free((void*)a->data, "../crypto/asn1/a_object.c", 362);
        a->data = 
# 363 "../crypto/asn1/a_object.c" 3 4
                 ((void *)0)
# 363 "../crypto/asn1/a_object.c"
                     ;
        a->length = 0;
    }
    if (a->flags & 0x01)
        CRYPTO_free(a, "../crypto/asn1/a_object.c", 367);
}
