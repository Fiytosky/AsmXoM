# 0 "../crypto/asn1/bio_ndef.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/bio_ndef.c"
# 10 "../crypto/asn1/bio_ndef.c"
...
# 14 "../crypto/asn1/bio_ndef.c" 2
# 31 "../crypto/asn1/bio_ndef.c"
...
# 60 "../crypto/asn1/bio_ndef.c" 3 4
                            ((void *)0)
# 60 "../crypto/asn1/bio_ndef.c"
                                ;
    BIO *asn_bio = 
# 61 "../crypto/asn1/bio_ndef.c" 3 4
                  ((void *)0)
# 61 "../crypto/asn1/bio_ndef.c"
                      ;
    const ASN1_AUX *aux = it->funcs;
    ASN1_STREAM_ARG sarg;
    BIO *pop_bio = 
# 64 "../crypto/asn1/bio_ndef.c" 3 4
                  ((void *)0)
# 64 "../crypto/asn1/bio_ndef.c"
                      ;

    if (!aux || !aux->asn1_cb) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/bio_ndef.c",67,__func__), ERR_set_error)((13),(202),
# 67 "../crypto/asn1/bio_ndef.c" 3 4
       ((void *)0)
# 67 "../crypto/asn1/bio_ndef.c"
       );
        return 
# 68 "../crypto/asn1/bio_ndef.c" 3 4
              ((void *)0)
# 68 "../crypto/asn1/bio_ndef.c"
                  ;
    }
    ndef_aux = CRYPTO_zalloc(sizeof(*ndef_aux), "../crypto/asn1/bio_ndef.c", 70);
    asn_bio = BIO_new(BIO_f_asn1());
    if (ndef_aux == 
# 72 "../crypto/asn1/bio_ndef.c" 3 4
                   ((void *)0) 
# 72 "../crypto/asn1/bio_ndef.c"
                        || asn_bio == 
# 72 "../crypto/asn1/bio_ndef.c" 3 4
                                      ((void *)0)
# 72 "../crypto/asn1/bio_ndef.c"
...
# 77 "../crypto/asn1/bio_ndef.c"
    ...
    if (BIO_asn1_set_prefix(asn_bio, ndef_prefix, ndef_prefix_free) <= 0
            ...
            || BIO_ctrl(asn_bio, 153, 0, ndef_aux) <= 0)
        goto err;
    ...
    sarg.out = out;
    sarg.ndef_bio = 
# 92 "../crypto/asn1/bio_ndef.c" 3 4
                   ((void *)0)
# 92 "../crypto/asn1/bio_ndef.c"
                       ;
    sarg.boundary = 
# 93 "../crypto/asn1/bio_ndef.c" 3 4
                   ((void *)0)
# 93 "../crypto/asn1/bio_ndef.c"
                       ;
    ...
    if (aux->asn1_cb(10, &val, it, &sarg) <= 0) {
        ...
        ndef_aux = 
# 104 "../crypto/asn1/bio_ndef.c" 3 4
                  ((void *)0)
# 104 "../crypto/asn1/bio_ndef.c"
                      ;
        goto err;
    }
 ...
 err:
    ...
    BIO_free(asn_bio);
    CRYPTO_free(ndef_aux, "../crypto/asn1/bio_ndef.c", 125);
    return 
# 126 "../crypto/asn1/bio_ndef.c" 3 4
          ((void *)0)
# 126 "../crypto/asn1/bio_ndef.c"
              ;
}
...
static int ndef_prefix(BIO *b, unsigned char **pbuf, int *plen, void *parg)
{
    ...
    if (parg == 
# 135 "../crypto/asn1/bio_ndef.c" 3 4
               ((void *)0)
# 135 "../crypto/asn1/bio_ndef.c"
                   )
        return 0;
...
# 140 "../crypto/asn1/bio_ndef.c" 3 4
                                              ((void *)0)
# 140 "../crypto/asn1/bio_ndef.c"
                                                  , ndef_aux->it);
    if (derlen < 0)
        return 0;
    if ((p = CRYPTO_malloc(derlen, "../crypto/asn1/bio_ndef.c", 143)) == 
# 143 "../crypto/asn1/bio_ndef.c" 3 4
                                       ((void *)0)
# 143 "../crypto/asn1/bio_ndef.c"
                                           )
        return 0;
...
# 150 "../crypto/asn1/bio_ndef.c" 3 4
                              ((void *)0)
# 150 "../crypto/asn1/bio_ndef.c"
                                  )
        return 0;
                            ...
                            void *parg)
{
    ...
    if (parg == 
# 163 "../crypto/asn1/bio_ndef.c" 3 4
               ((void *)0)
# 163 "../crypto/asn1/bio_ndef.c"
                   )
        return 0;
    ...
    if (ndef_aux == 
# 168 "../crypto/asn1/bio_ndef.c" 3 4
                   ((void *)0)
# 168 "../crypto/asn1/bio_ndef.c"
                       )
        return 0;

    CRYPTO_free(ndef_aux->derbuf, "../crypto/asn1/bio_ndef.c", 171);

    ndef_aux->derbuf = 
# 173 "../crypto/asn1/bio_ndef.c" 3 4
                      ((void *)0)
# 173 "../crypto/asn1/bio_ndef.c"
                          ;
    *pbuf = 
# 174 "../crypto/asn1/bio_ndef.c" 3 4
           ((void *)0)
# 174 "../crypto/asn1/bio_ndef.c"
               ;
    *plen = 0;
    return 1;
}
                            ...
                            void *parg)
{
    ...
    if (!ndef_prefix_free(b, pbuf, plen, parg))
        return 0;
    CRYPTO_free(*pndef_aux, "../crypto/asn1/bio_ndef.c", 185);
    *pndef_aux = 
# 186 "../crypto/asn1/bio_ndef.c" 3 4
                ((void *)0)
# 186 "../crypto/asn1/bio_ndef.c"
                    ;
    return 1;
}
...
static int ndef_suffix(BIO *b, unsigned char **pbuf, int *plen, void *parg)
{
    ...
    if (parg == 
# 198 "../crypto/asn1/bio_ndef.c" 3 4
               ((void *)0)
# 198 "../crypto/asn1/bio_ndef.c"
                   )
        return 0;
    ...
    derlen = ASN1_item_ndef_i2d(ndef_aux->val, 
# 213 "../crypto/asn1/bio_ndef.c" 3 4
                                              ((void *)0)
# 213 "../crypto/asn1/bio_ndef.c"
                                                  , ndef_aux->it);
    if (derlen < 0)
        return 0;
    if ((p = CRYPTO_malloc(derlen, "../crypto/asn1/bio_ndef.c", 216)) == 
# 216 "../crypto/asn1/bio_ndef.c" 3 4
                                       ((void *)0)
# 216 "../crypto/asn1/bio_ndef.c"
                                           )
        return 0;
    ...
    *pbuf = p;
    ...
    if (*ndef_aux->boundary == 
# 223 "../crypto/asn1/bio_ndef.c" 3 4
                              ((void *)0)
# 223 "../crypto/asn1/bio_ndef.c"
                                  )
        return 0;
