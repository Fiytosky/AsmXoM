# 0 "../crypto/asn1/x_sig.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_sig.c"
# 10 "../crypto/asn1/x_sig.c"
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 15 "../crypto/asn1/x_sig.c" 2

static const ASN1_TEMPLATE X509_SIG_seq_tt[] = {
        { (0), (0), 
# 17 "../crypto/asn1/x_sig.c" 3 4
       __builtin_offsetof (
# 17 "../crypto/asn1/x_sig.c"
       X509_SIG
# 17 "../crypto/asn1/x_sig.c" 3 4
       , 
# 17 "../crypto/asn1/x_sig.c"
...
# 17 "../crypto/asn1/x_sig.c"
       , "algor", (X509_ALGOR_it) },
        { (0), (0), 
# 18 "../crypto/asn1/x_sig.c" 3 4
       __builtin_offsetof (
# 18 "../crypto/asn1/x_sig.c"
       X509_SIG
# 18 "../crypto/asn1/x_sig.c" 3 4
       , 
# 18 "../crypto/asn1/x_sig.c"
...
} ; const ASN1_ITEM * X509_SIG_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_SIG_seq_tt, sizeof(X509_SIG_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 19 "../crypto/asn1/x_sig.c" 3 4
 ((void *)0)
# 19 "../crypto/asn1/x_sig.c"
 , sizeof(X509_SIG), "X509_SIG" }; return &local_it; }

X509_SIG *d2i_X509_SIG(X509_SIG **a, const unsigned char **in, long len) { return (X509_SIG *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_SIG_it())); } int i2d_X509_SIG(const X509_SIG *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_SIG_it())); } X509_SIG *X509_SIG_new(void) { return (X509_SIG *)ASN1_item_new((X509_SIG_it())); } void X509_SIG_free(X509_SIG *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_SIG_it())); }
