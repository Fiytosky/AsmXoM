# 0 "../crypto/asn1/a_int.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_int.c"
# 10 "../crypto/asn1/a_int.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/asn1/a_int.c" 2

# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/limits.h" 1 3 4
# 14 "../crypto/asn1/a_int.c" 2
                       ...
                       unsigned char **pp)
{
    ...
    if (b != 
# 104 "../crypto/asn1/a_int.c" 3 4
            ((void *)0) 
# 104 "../crypto/asn1/a_int.c"
                 && blen) {
        ret = blen;
        i = b[0];
        if (!neg && (i > 127)) {
    ...
    if (pp == 
# 131 "../crypto/asn1/a_int.c" 3 4
             ((void *)0) 
# 131 "../crypto/asn1/a_int.c"
                  || (p = *pp) == 
# 131 "../crypto/asn1/a_int.c" 3 4
                                  ((void *)0)
# 131 "../crypto/asn1/a_int.c"
                       ...
                       const unsigned char *p, size_t plen)
{
    ...
    if (plen == 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",160,__func__), ERR_set_error)((13),(222),
# 160 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 160 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    neg = p[0] & 0x80;
    ...
    if (plen == 1) {
        if (b != 
# 168 "../crypto/asn1/a_int.c" 3 4
                ((void *)0)
# 168 "../crypto/asn1/a_int.c"
                    ) {
            if (neg)
                b[0] = (p[0] ^ 0xFF) + 1;
            else
    ...
    if (pad && (neg == (p[1] & 0x80))) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",193,__func__), ERR_set_error)((13),(221),
# 193 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 193 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    ...
    if (b != 
# 201 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 201 "../crypto/asn1/a_int.c"
                )
...
int ossl_i2c_ASN1_INTEGER(ASN1_INTEGER *a, unsigned char **pp)
{
    return i2c_ibuf(a->data, a->length, a->type & 0x100, pp);
}
...
static int asn1_get_uint64(uint64_t *pr, const unsigned char *b, size_t blen)
{
    ...
    if (blen > sizeof(*pr)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",219,__func__), ERR_set_error)((13),(223),
# 219 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 219 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    if (b == 
# 222 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 222 "../crypto/asn1/a_int.c"
                )
        return 0;
                          ...
                          int neg)
{
    ...
    if (neg) {
        if (r <= 
# 262 "../crypto/asn1/a_int.c" 3 4
                (9223372036854775807L)
# 262 "../crypto/asn1/a_int.c"
                         ) {


            *pr = -(int64_t)r;
        } else if (r == ((uint64_t)
# 266 "../crypto/asn1/a_int.c" 3 4
                       (9223372036854775807L) 
# 266 "../crypto/asn1/a_int.c"
                       + (-(
# 266 "../crypto/asn1/a_int.c" 3 4
...
# 266 "../crypto/asn1/a_int.c"
            ...
            *pr = (int64_t)(0 - r);
            ...
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",271,__func__), ERR_set_error)((13),(224),
# 271 "../crypto/asn1/a_int.c" 3 4
           ((void *)0)
# 271 "../crypto/asn1/a_int.c"
           );
            return 0;
        }
    } else {
        if (r <= 
# 275 "../crypto/asn1/a_int.c" 3 4
                (9223372036854775807L)
# 275 "../crypto/asn1/a_int.c"
                         ) {
            *pr = (int64_t)r;
        } else {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",278,__func__), ERR_set_error)((13),(223),
# 278 "../crypto/asn1/a_int.c" 3 4
           ((void *)0)
# 278 "../crypto/asn1/a_int.c"
           );
            return 0;
        }
    }
...
{
    ASN1_INTEGER *ret = 
# 289 "../crypto/asn1/a_int.c" 3 4
                       ((void *)0)
# 289 "../crypto/asn1/a_int.c"
                           ;
    size_t r;
    int neg;

    r = c2i_ibuf(
# 293 "../crypto/asn1/a_int.c" 3 4
                ((void *)0)
# 293 "../crypto/asn1/a_int.c"
                    , 
# 293 "../crypto/asn1/a_int.c" 3 4
                      ((void *)0)
# 293 "../crypto/asn1/a_int.c"
    ...
    if (r == 0)
        return 
# 296 "../crypto/asn1/a_int.c" 3 4
              ((void *)0)
# 296 "../crypto/asn1/a_int.c"
                  ;

    if ((a == 
# 298 "../crypto/asn1/a_int.c" 3 4
             ((void *)0)
# 298 "../crypto/asn1/a_int.c"
                 ) || ((*a) == 
# 298 "../crypto/asn1/a_int.c" 3 4
                               ((void *)0)
# 298 "../crypto/asn1/a_int.c"
        ...
        if (ret == 
# 300 "../crypto/asn1/a_int.c" 3 4
                  ((void *)0)
# 300 "../crypto/asn1/a_int.c"
                      )
            return 
# 301 "../crypto/asn1/a_int.c" 3 4
                  ((void *)0)
# 301 "../crypto/asn1/a_int.c"
                      ;
        ret->type = 2;
    } else
        ret = *a;

    if (ASN1_STRING_set(ret, 
# 306 "../crypto/asn1/a_int.c" 3 4
                            ((void *)0)
# 306 "../crypto/asn1/a_int.c"
                                , r) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",307,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 307 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 307 "../crypto/asn1/a_int.c"
       );
        goto err;
    }
    ...
    *pp += len;
    if (a != 
# 319 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 319 "../crypto/asn1/a_int.c"
                )
        (*a) = ret;
    return ret;
 err:
    if (a == 
# 323 "../crypto/asn1/a_int.c" 3 4
            ((void *)0) 
# 323 "../crypto/asn1/a_int.c"
                 || *a != ret)
        ASN1_INTEGER_free(ret);
    return 
# 325 "../crypto/asn1/a_int.c" 3 4
          ((void *)0)
# 325 "../crypto/asn1/a_int.c"
              ;
}
...
{
    if (a == 
# 330 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 330 "../crypto/asn1/a_int.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",331,__func__), ERR_set_error)((13),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 331 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 331 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    if ((a->type & ~0x100) != itype) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",335,__func__), ERR_set_error)((13),(225),
# 335 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 335 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    return asn1_get_int64(pr, a->data, a->length, a->type & 0x100);
}
...
{
    if (a == 
# 365 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 365 "../crypto/asn1/a_int.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",366,__func__), ERR_set_error)((13),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 366 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 366 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    if ((a->type & ~0x100) != itype) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",370,__func__), ERR_set_error)((13),(225),
# 370 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 370 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
    if (a->type & 0x100) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",374,__func__), ERR_set_error)((13),(226),
# 374 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 374 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
...
{
    ASN1_INTEGER *ret = 
# 399 "../crypto/asn1/a_int.c" 3 4
                       ((void *)0)
# 399 "../crypto/asn1/a_int.c"
                           ;
    ...
    if ((a == 
# 406 "../crypto/asn1/a_int.c" 3 4
             ((void *)0)
# 406 "../crypto/asn1/a_int.c"
                 ) || ((*a) == 
# 406 "../crypto/asn1/a_int.c" 3 4
                               ((void *)0)
# 406 "../crypto/asn1/a_int.c"
...
# 407 "../crypto/asn1/a_int.c" 3 4
                                         ((void *)0)
# 407 "../crypto/asn1/a_int.c"
                                             )
            return 
# 408 "../crypto/asn1/a_int.c" 3 4
                  ((void *)0)
# 408 "../crypto/asn1/a_int.c"
                      ;
        ret->type = 2;
    } else
        ret = (*a);
    ...
    s = CRYPTO_malloc((int)len + 1, "../crypto/asn1/a_int.c", 433);
    if (s == 
# 434 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 434 "../crypto/asn1/a_int.c"
                )
        goto err;
    ret->type = 2;
    if (len) {
    ...
    if (a != 
# 447 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 447 "../crypto/asn1/a_int.c"
                )
        (*a) = ret;
    *pp = p;
    return ret;
 err:
    if (i != 0)
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",453,__func__), ERR_set_error)((13),(i),
# 453 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 453 "../crypto/asn1/a_int.c"
       );
    if ((a == 
# 454 "../crypto/asn1/a_int.c" 3 4
             ((void *)0)
# 454 "../crypto/asn1/a_int.c"
                 ) || (*a != ret))
        ASN1_INTEGER_free(ret);
    return 
# 456 "../crypto/asn1/a_int.c" 3 4
          ((void *)0)
# 456 "../crypto/asn1/a_int.c"
              ;
}
                                      ...
                                      int atype)
{
    ...
    if (ai == 
# 465 "../crypto/asn1/a_int.c" 3 4
             ((void *)0)
# 465 "../crypto/asn1/a_int.c"
                 ) {
    ...
    if (ret == 
# 472 "../crypto/asn1/a_int.c" 3 4
              ((void *)0)
# 472 "../crypto/asn1/a_int.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",473,__func__), ERR_set_error)((13),((266|(0x2 << 18L))),
# 473 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 473 "../crypto/asn1/a_int.c"
       );
        goto err;
    }
    ...
    if (ASN1_STRING_set(ret, 
# 485 "../crypto/asn1/a_int.c" 3 4
                            ((void *)0)
# 485 "../crypto/asn1/a_int.c"
                                , len) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",486,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 486 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 486 "../crypto/asn1/a_int.c"
       );
        goto err;
    }
 ...
 err:
    if (ret != ai)
        ASN1_INTEGER_free(ret);
    return 
# 500 "../crypto/asn1/a_int.c" 3 4
          ((void *)0)
# 500 "../crypto/asn1/a_int.c"
              ;
}
                                 ...
                                 int itype)
{
    ...
    if ((ai->type & ~0x100) != itype) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",509,__func__), ERR_set_error)((13),(225),
# 509 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 509 "../crypto/asn1/a_int.c"
       );
        return 
# 510 "../crypto/asn1/a_int.c" 3 4
              ((void *)0)
# 510 "../crypto/asn1/a_int.c"
                  ;
    }

    ret = BN_bin2bn(ai->data, ai->length, bn);
    if (ret == 
# 514 "../crypto/asn1/a_int.c" 3 4
              ((void *)0)
# 514 "../crypto/asn1/a_int.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",515,__func__), ERR_set_error)((13),(105),
# 515 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 515 "../crypto/asn1/a_int.c"
       );
        return 
# 516 "../crypto/asn1/a_int.c" 3 4
              ((void *)0)
# 516 "../crypto/asn1/a_int.c"
                  ;
    }
    if (ai->type & 0x100)
...
int ASN1_INTEGER_get_int64(int64_t *pr, const ASN1_INTEGER *a)
{
    return asn1_string_get_int64(pr, a, 2);
}

int ASN1_INTEGER_set_int64(ASN1_INTEGER *a, int64_t r)
{
    return asn1_string_set_int64(a, r, 2);
}

int ASN1_INTEGER_get_uint64(uint64_t *pr, const ASN1_INTEGER *a)
{
    return asn1_string_get_uint64(pr, a, 2);
}

int ASN1_INTEGER_set_uint64(ASN1_INTEGER *a, uint64_t r)
{
    return asn1_string_set_uint64(a, r, 2);
}
...
long ASN1_INTEGER_get(const ASN1_INTEGER *a)
{
    ...
    int64_t r;
    if (a == 
# 552 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 552 "../crypto/asn1/a_int.c"
                )
        return 0;
...
# 557 "../crypto/asn1/a_int.c"
                    || r < 
# 557 "../crypto/asn1/a_int.c" 3 4
...
ASN1_INTEGER *BN_to_ASN1_INTEGER(const BIGNUM *bn, ASN1_INTEGER *ai)
{
    return bn_to_asn1_string(bn, ai, 2);
}

BIGNUM *ASN1_INTEGER_to_BN(const ASN1_INTEGER *ai, BIGNUM *bn)
{
    return asn1_string_to_bn(ai, bn, 2);
}

int ASN1_ENUMERATED_get_int64(int64_t *pr, const ASN1_ENUMERATED *a)
{
    return asn1_string_get_int64(pr, a, 10);
}

int ASN1_ENUMERATED_set_int64(ASN1_ENUMERATED *a, int64_t r)
{
    return asn1_string_set_int64(a, r, 10);
}
...
long ASN1_ENUMERATED_get(const ASN1_ENUMERATED *a)
{
    ...
    int64_t r;
    if (a == 
# 591 "../crypto/asn1/a_int.c" 3 4
            ((void *)0)
# 591 "../crypto/asn1/a_int.c"
                )
        return 0;
    if ((a->type & ~0x100) != 10)
        return -1;
    ...
    if (i == 0)
        return -1;
    if (r > 0x7fffffffffffffffL 
# 600 "../crypto/asn1/a_int.c"
                    || r < 
# 600 "../crypto/asn1/a_int.c" 3 4
                           (-0x7fffffffffffffffL - 1L)
# 600 "../crypto/asn1/a_int.c"
                                   )
        return -1;
...
ASN1_ENUMERATED *BN_to_ASN1_ENUMERATED(const BIGNUM *bn, ASN1_ENUMERATED *ai)
{
    return bn_to_asn1_string(bn, ai, 10);
}

BIGNUM *ASN1_ENUMERATED_to_BN(const ASN1_ENUMERATED *ai, BIGNUM *bn)
{
    return asn1_string_to_bn(ai, bn, 10);
}
                        ...
                        const unsigned char **pp, long len)
{
    ...
    buflen = c2i_ibuf(
# 622 "../crypto/asn1/a_int.c" 3 4
                     ((void *)0)
# 622 "../crypto/asn1/a_int.c"
                         , 
# 622 "../crypto/asn1/a_int.c" 3 4
                           ((void *)0)
# 622 "../crypto/asn1/a_int.c"
    ...
    if (buflen > sizeof(uint64_t)) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_int.c",626,__func__), ERR_set_error)((13),(223),
# 626 "../crypto/asn1/a_int.c" 3 4
       ((void *)0)
# 626 "../crypto/asn1/a_int.c"
       );
        return 0;
    }
