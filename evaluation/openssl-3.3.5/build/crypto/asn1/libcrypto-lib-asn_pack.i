# 0 "../crypto/asn1/asn_pack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn_pack.c"
# 10 "../crypto/asn1/asn_pack.c"
...
ASN1_STRING *ASN1_item_pack(void *obj, const ASN1_ITEM *it, ASN1_STRING **oct)
{
    ...
    if (oct == 
# 20 "../crypto/asn1/asn_pack.c" 3 4
              ((void *)0) 
# 20 "../crypto/asn1/asn_pack.c"
                   || *oct == 
# 20 "../crypto/asn1/asn_pack.c" 3 4
                              ((void *)0)
# 20 "../crypto/asn1/asn_pack.c"
...
# 21 "../crypto/asn1/asn_pack.c" 3 4
                                          ((void *)0)
# 21 "../crypto/asn1/asn_pack.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/asn_pack.c",22,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 22 "../crypto/asn1/asn_pack.c" 3 4
           ((void *)0)
# 22 "../crypto/asn1/asn_pack.c"
           );
            return 
# 23 "../crypto/asn1/asn_pack.c" 3 4
                  ((void *)0)
# 23 "../crypto/asn1/asn_pack.c"
                      ;
        }
    } else {
        octmp = *oct;
    ...
    ASN1_STRING_set0(octmp, 
# 29 "../crypto/asn1/asn_pack.c" 3 4
                           ((void *)0)
# 29 "../crypto/asn1/asn_pack.c"
                               , 0);

    if ((octmp->length = ASN1_item_i2d(obj, &octmp->data, it)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_pack.c",32,__func__), ERR_set_error)((13),(112),
# 32 "../crypto/asn1/asn_pack.c" 3 4
       ((void *)0)
# 32 "../crypto/asn1/asn_pack.c"
       );
        goto err;
    }
    if (octmp->data == 
# 35 "../crypto/asn1/asn_pack.c" 3 4
                      ((void *)0)
# 35 "../crypto/asn1/asn_pack.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_pack.c",36,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 36 "../crypto/asn1/asn_pack.c" 3 4
       ((void *)0)
# 36 "../crypto/asn1/asn_pack.c"
       );
        goto err;
    }

    if (oct != 
# 40 "../crypto/asn1/asn_pack.c" 3 4
              ((void *)0) 
# 40 "../crypto/asn1/asn_pack.c"
                   && *oct == 
# 40 "../crypto/asn1/asn_pack.c" 3 4
                              ((void *)0)
# 40 "../crypto/asn1/asn_pack.c"
 ...
 err:
    if (oct == 
# 45 "../crypto/asn1/asn_pack.c" 3 4
              ((void *)0) 
# 45 "../crypto/asn1/asn_pack.c"
                   || *oct == 
# 45 "../crypto/asn1/asn_pack.c" 3 4
                              ((void *)0)
# 45 "../crypto/asn1/asn_pack.c"
    ...
    return 
# 47 "../crypto/asn1/asn_pack.c" 3 4
          ((void *)0)
# 47 "../crypto/asn1/asn_pack.c"
              ;
}
...
# 58 "../crypto/asn1/asn_pack.c" 3 4
                            ((void *)0)
# 58 "../crypto/asn1/asn_pack.c"
                                , &p, oct->length, it)) == 
# 58 "../crypto/asn1/asn_pack.c" 3 4
                                                           ((void *)0)
# 58 "../crypto/asn1/asn_pack.c"
                                                               )
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_pack.c",59,__func__), ERR_set_error)((13),(110),
# 59 "../crypto/asn1/asn_pack.c" 3 4
       ((void *)0)
# 59 "../crypto/asn1/asn_pack.c"
       );
    return ret;
}
                          ...
                          OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    p = oct->data;
    if ((ret = ASN1_item_d2i_ex(
# 70 "../crypto/asn1/asn_pack.c" 3 4
                               ((void *)0)
# 70 "../crypto/asn1/asn_pack.c"
                                   , &p, oct->length, it,
                                libctx, propq)) == 
# 71 "../crypto/asn1/asn_pack.c" 3 4
                                                  ((void *)0)
# 71 "../crypto/asn1/asn_pack.c"
                                                      )
        (ERR_new(), ERR_set_debug("../crypto/asn1/asn_pack.c",72,__func__), ERR_set_error)((13),(110),
# 72 "../crypto/asn1/asn_pack.c" 3 4
       ((void *)0)
# 72 "../crypto/asn1/asn_pack.c"
       );
    return ret;
}
