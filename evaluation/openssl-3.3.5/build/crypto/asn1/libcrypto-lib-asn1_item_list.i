# 0 "../crypto/asn1/asn1_item_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/asn1_item_list.c"
# 13 "../crypto/asn1/asn1_item_list.c"
...
# 14 "../crypto/asn1/asn1_item_list.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 15 "../crypto/asn1/asn1_item_list.c" 2
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 17 "../crypto/asn1/asn1_item_list.c" 2
...
# 18 "../crypto/asn1/asn1_item_list.c" 2
...
# 20 "../crypto/asn1/asn1_item_list.c" 2
...
# 22 "../crypto/asn1/asn1_item_list.c" 2



# 1 "../crypto/asn1/asn1_item_list.h" 1
# 10 "../crypto/asn1/asn1_item_list.h"
...
# 26 "../crypto/asn1/asn1_item_list.c" 2

const ASN1_ITEM *ASN1_ITEM_lookup(const char *name)
{
    size_t i;

    for (i = 0; i < (sizeof(asn1_item_list)/sizeof((asn1_item_list)[0])); i++) {
        const ASN1_ITEM *it = (asn1_item_list[i]());

        if (strcmp(it->sname, name) == 0)
            return it;
    }
    return 
# 37 "../crypto/asn1/asn1_item_list.c" 3 4
          ((void *)0)
# 37 "../crypto/asn1/asn1_item_list.c"
              ;
}

const ASN1_ITEM *ASN1_ITEM_get(size_t i)
{
    if (i >= (sizeof(asn1_item_list)/sizeof((asn1_item_list)[0])))
        return 
# 43 "../crypto/asn1/asn1_item_list.c" 3 4
              ((void *)0)
# 43 "../crypto/asn1/asn1_item_list.c"
                  ;
    return (asn1_item_list[i]());
}
