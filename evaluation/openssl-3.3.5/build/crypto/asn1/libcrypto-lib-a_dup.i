# 0 "../crypto/asn1/a_dup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_dup.c"
# 10 "../crypto/asn1/a_dup.c"
...
void *ASN1_dup(i2d_of_void *i2d, d2i_of_void *d2i, const void *x)
{
    ...
    if (x == 
# 23 "../crypto/asn1/a_dup.c" 3 4
            ((void *)0)
# 23 "../crypto/asn1/a_dup.c"
                )
        return 
# 24 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 24 "../crypto/asn1/a_dup.c"
                  ;

    i = i2d(x, 
# 26 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 26 "../crypto/asn1/a_dup.c"
                  );
    if (i <= 0)
        return 
# 28 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 28 "../crypto/asn1/a_dup.c"
                  ;

    b = CRYPTO_malloc(i + 10, "../crypto/asn1/a_dup.c", 30);
    if (b == 
# 31 "../crypto/asn1/a_dup.c" 3 4
            ((void *)0)
# 31 "../crypto/asn1/a_dup.c"
                )
        return 
# 32 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 32 "../crypto/asn1/a_dup.c"
                  ;
    p = b;
    i = i2d(x, &p);
    p2 = b;
    ret = d2i(
# 36 "../crypto/asn1/a_dup.c" 3 4
             ((void *)0)
# 36 "../crypto/asn1/a_dup.c"
                 , &p2, i);
    CRYPTO_free(b, "../crypto/asn1/a_dup.c", 37);
    return ret;
}
...
{
    ASN1_aux_cb *asn1_cb = 
# 52 "../crypto/asn1/a_dup.c" 3 4
                          ((void *)0)
# 52 "../crypto/asn1/a_dup.c"
                              ;
    unsigned char *b = 
# 53 "../crypto/asn1/a_dup.c" 3 4
                      ((void *)0)
# 53 "../crypto/asn1/a_dup.c"
                          ;
    const unsigned char *p;
    long i;
    ASN1_VALUE *ret;
    OSSL_LIB_CTX *libctx = 
# 57 "../crypto/asn1/a_dup.c" 3 4
                          ((void *)0)
# 57 "../crypto/asn1/a_dup.c"
                              ;
    const char *propq = 
# 58 "../crypto/asn1/a_dup.c" 3 4
                       ((void *)0)
# 58 "../crypto/asn1/a_dup.c"
                           ;

    if (x == 
# 60 "../crypto/asn1/a_dup.c" 3 4
            ((void *)0)
# 60 "../crypto/asn1/a_dup.c"
                )
        return 
# 61 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 61 "../crypto/asn1/a_dup.c"
                  ;

    if (it->itype == 0x1 || it->itype == 0x2
        || it->itype == 0x6) {
        const ASN1_AUX *aux = it->funcs;

        asn1_cb = aux != 
# 67 "../crypto/asn1/a_dup.c" 3 4
                        ((void *)0) 
# 67 "../crypto/asn1/a_dup.c"
                             ? aux->asn1_cb : 
# 67 "../crypto/asn1/a_dup.c" 3 4
                                              ((void *)0)
# 67 "../crypto/asn1/a_dup.c"
    ...
    if (asn1_cb != 
# 70 "../crypto/asn1/a_dup.c" 3 4
                  ((void *)0)
# 70 "../crypto/asn1/a_dup.c"
                      ) {
        if (!asn1_cb(14, (ASN1_VALUE **)&x, it, 
# 71 "../crypto/asn1/a_dup.c" 3 4
                                                            ((void *)0)
# 71 "../crypto/asn1/a_dup.c"
                                                                )
                || !asn1_cb(16, (ASN1_VALUE **)&x, it, &libctx)
                || !asn1_cb(17, (ASN1_VALUE **)&x, it, &propq))
            goto auxerr;
    }

    i = ASN1_item_i2d(x, &b, it);
    if (b == 
# 78 "../crypto/asn1/a_dup.c" 3 4
            ((void *)0)
# 78 "../crypto/asn1/a_dup.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_dup.c",79,__func__), ERR_set_error)((13),((13 | (0x2 << 18L))),
# 79 "../crypto/asn1/a_dup.c" 3 4
       ((void *)0)
# 79 "../crypto/asn1/a_dup.c"
       );
        return 
# 80 "../crypto/asn1/a_dup.c" 3 4
              ((void *)0)
# 80 "../crypto/asn1/a_dup.c"
                  ;
    }
    p = b;
    ret = ASN1_item_d2i_ex(
# 83 "../crypto/asn1/a_dup.c" 3 4
                          ((void *)0)
# 83 "../crypto/asn1/a_dup.c"
                              , &p, i, it, libctx, propq);
    CRYPTO_free(b, "../crypto/asn1/a_dup.c", 84);

    if (asn1_cb != 
# 86 "../crypto/asn1/a_dup.c" 3 4
                  ((void *)0)
        
# 87 "../crypto/asn1/a_dup.c"
       && !asn1_cb(15, &ret, it, (void *)x))
        goto auxerr;

    return ret;

 auxerr:
    (ERR_new(), ERR_set_debug("../crypto/asn1/a_dup.c",93,__func__), ERR_set_error)(13, 100, "Type=%s", it->sname);
    return 
# 94 "../crypto/asn1/a_dup.c" 3 4
          ((void *)0)
# 94 "../crypto/asn1/a_dup.c"
              ;
}
