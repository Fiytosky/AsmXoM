# 0 "../crypto/asn1/a_utctm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_utctm.c"
# 10 "../crypto/asn1/a_utctm.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 16 "../crypto/asn1/a_utctm.c" 2

ASN1_UTCTIME * ASN1_UTCTIME_dup(const ASN1_UTCTIME *x) { return ASN1_item_dup((ASN1_UTCTIME_it()), x); }
...
{
    return ossl_asn1_utctime_to_tm(
# 30 "../crypto/asn1/a_utctm.c" 3 4
                                  ((void *)0)
# 30 "../crypto/asn1/a_utctm.c"
                                      , d);
}
...
int ASN1_UTCTIME_set_string(ASN1_UTCTIME *s, const char *str)
{
    ...
    if (s != 
# 46 "../crypto/asn1/a_utctm.c" 3 4
            ((void *)0) 
# 46 "../crypto/asn1/a_utctm.c"
                               ...
                               int offset_day, long offset_sec)
{
    ...
    if (ts == 
# 64 "../crypto/asn1/a_utctm.c" 3 4
             ((void *)0)
# 64 "../crypto/asn1/a_utctm.c"
                 )
        return 
# 65 "../crypto/asn1/a_utctm.c" 3 4
              ((void *)0)
# 65 "../crypto/asn1/a_utctm.c"
    ...
    if (offset_day || offset_sec) {
        if (!OPENSSL_gmtime_adj(ts, offset_day, offset_sec))
            return 
# 69 "../crypto/asn1/a_utctm.c" 3 4
                  ((void *)0)
# 69 "../crypto/asn1/a_utctm.c"
                      ;
    }

    return ossl_asn1_time_from_tm(s, ts, 23);
}
...
# 83 "../crypto/asn1/a_utctm.c" 3 4
                                   ((void *)0)
# 83 "../crypto/asn1/a_utctm.c"
                                       )
        return -2;
