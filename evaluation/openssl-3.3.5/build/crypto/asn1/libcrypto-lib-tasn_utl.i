# 0 "../crypto/asn1/tasn_utl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/tasn_utl.c"
# 10 "../crypto/asn1/tasn_utl.c"
...
int ossl_asn1_item_ex_new_intern(ASN1_VALUE **pval, const ASN1_ITEM *it,
                                 OSSL_LIB_CTX *libctx, const char *propq);
# 19 "../crypto/asn1/tasn_utl.c" 2
# 29 "../crypto/asn1/tasn_utl.c"
int ossl_asn1_get_choice_selector(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
...
int ossl_asn1_do_lock(ASN1_VALUE **pval, int op, const ASN1_ITEM *it)
{
    ...
    aux = it->funcs;
    if (aux == 
# 79 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0) 
# 79 "../crypto/asn1/tasn_utl.c"
                   || (aux->flags & 1) == 0)
        return 0;
    lock = (void *)(((char *) *pval) + aux->ref_lock);
    refcnt = (void *)(((char *) *pval) + aux->ref_offset);
    ...
    case 0:
        ...
        *lock = CRYPTO_THREAD_lock_new();
        if (*lock == 
# 89 "../crypto/asn1/tasn_utl.c" 3 4
                    ((void *)0)
# 89 "../crypto/asn1/tasn_utl.c"
                        ) {
            CRYPTO_FREE_REF(refcnt);
            (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_utl.c",91,__func__), ERR_set_error)((13),((15 | (0x2 << 18L))),
# 91 "../crypto/asn1/tasn_utl.c" 3 4
           ((void *)0)
# 91 "../crypto/asn1/tasn_utl.c"
           );
            return -1;
        }
        ret = 1;
    ...
    case -1:
        ...
        if (ret == 0) {
            ...
            *lock = 
# 107 "../crypto/asn1/tasn_utl.c" 3 4
                   ((void *)0)
# 107 "../crypto/asn1/tasn_utl.c"
                       ;
            CRYPTO_FREE_REF(refcnt);
        }
        break;
...
static ASN1_ENCODING *asn1_get_enc_ptr(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (pval == 
# 120 "../crypto/asn1/tasn_utl.c" 3 4
               ((void *)0) 
# 120 "../crypto/asn1/tasn_utl.c"
                    || *pval == 
# 120 "../crypto/asn1/tasn_utl.c" 3 4
                                ((void *)0)
# 120 "../crypto/asn1/tasn_utl.c"
        ...
        return 
# 121 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 121 "../crypto/asn1/tasn_utl.c"
                  ;
    aux = it->funcs;
    if (aux == 
# 123 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0) 
# 123 "../crypto/asn1/tasn_utl.c"
                   || (aux->flags & 2) == 0)
        return 
# 124 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 124 "../crypto/asn1/tasn_utl.c"
                  ;
                                                   ...
                                                   const ASN1_ITEM *it)
{
    ...
    if (pval == 
# 133 "../crypto/asn1/tasn_utl.c" 3 4
               ((void *)0) 
# 133 "../crypto/asn1/tasn_utl.c"
                    || *pval == 
# 133 "../crypto/asn1/tasn_utl.c" 3 4
                                ((void *)0)
# 133 "../crypto/asn1/tasn_utl.c"
        ...
        return 
# 134 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 134 "../crypto/asn1/tasn_utl.c"
                  ;
    aux = it->funcs;
    if (aux == 
# 136 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0) 
# 136 "../crypto/asn1/tasn_utl.c"
                   || (aux->flags & 2) == 0)
        return 
# 137 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 137 "../crypto/asn1/tasn_utl.c"
                  ;
    return (void *)(((char *) *pval) + aux->enc_offset);
}
...
void ossl_asn1_enc_init(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (enc != 
# 145 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 145 "../crypto/asn1/tasn_utl.c"
                  ) {
        enc->enc = 
# 146 "../crypto/asn1/tasn_utl.c" 3 4
                  ((void *)0)
# 146 "../crypto/asn1/tasn_utl.c"
                      ;
        enc->len = 0;
        enc->modified = 1;
    }
...
void ossl_asn1_enc_free(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    ...
    if (enc != 
# 156 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 156 "../crypto/asn1/tasn_utl.c"
                  ) {
        CRYPTO_free(enc->enc, "../crypto/asn1/tasn_utl.c", 157);
        enc->enc = 
# 158 "../crypto/asn1/tasn_utl.c" 3 4
                  ((void *)0)
# 158 "../crypto/asn1/tasn_utl.c"
                      ;
        enc->len = 0;
        enc->modified = 1;
    }
                       ...
                       const ASN1_ITEM *it)
{
    ...
    if (enc == 
# 169 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 169 "../crypto/asn1/tasn_utl.c"
                  )
        return 1;

    CRYPTO_free(enc->enc, "../crypto/asn1/tasn_utl.c", 172);
    if (inlen <= 0)
        return 0;
    if ((enc->enc = CRYPTO_malloc(inlen, "../crypto/asn1/tasn_utl.c", 175)) == 
# 175 "../crypto/asn1/tasn_utl.c" 3 4
                                             ((void *)0)
# 175 "../crypto/asn1/tasn_utl.c"
                                                 )
        return 0;
                          ...
                          const ASN1_ITEM *it)
{
    ...
    if (enc == 
# 189 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0) 
# 189 "../crypto/asn1/tasn_utl.c"
                   || enc->modified)
        return 0;
    if (out) {
    ...
    if (len != 
# 195 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 195 "../crypto/asn1/tasn_utl.c"
                  )
        *len = enc->len;
    return 1;
}
...
ASN1_VALUE **ossl_asn1_get_field_ptr(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
    ASN1_VALUE **pvaltmp = (void *)(((char *) *pval) + tt->offset);
...
const ASN1_VALUE **ossl_asn1_get_const_field_ptr(const ASN1_VALUE **pval,
                                                 const ASN1_TEMPLATE *tt)
{
    return (void *)(((char *) *pval) + tt->offset);
}
                                      ...
                                      int nullerr)
{
    ...
    sfld = (void *)(((char *) val) + adb->offset);


    if (*sfld == 
# 244 "../crypto/asn1/tasn_utl.c" 3 4
                ((void *)0)
# 244 "../crypto/asn1/tasn_utl.c"
                    ) {
        if (adb->null_tt == 
# 245 "../crypto/asn1/tasn_utl.c" 3 4
                           ((void *)0)
# 245 "../crypto/asn1/tasn_utl.c"
                               )
            goto err;
        return adb->null_tt;
    }
    ...
    if (adb->adb_cb != 
# 260 "../crypto/asn1/tasn_utl.c" 3 4
                      ((void *)0) 
# 260 "../crypto/asn1/tasn_utl.c"
                           && adb->adb_cb(&selector) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_utl.c",261,__func__), ERR_set_error)((13),(164),
# 261 "../crypto/asn1/tasn_utl.c" 3 4
       ((void *)0)
# 261 "../crypto/asn1/tasn_utl.c"
       );
        return 
# 262 "../crypto/asn1/tasn_utl.c" 3 4
              ((void *)0)
# 262 "../crypto/asn1/tasn_utl.c"
                  ;
    }
# 272 "../crypto/asn1/tasn_utl.c"
 ...
 err:
    ...
    if (nullerr)
        (ERR_new(), ERR_set_debug("../crypto/asn1/tasn_utl.c",286,__func__), ERR_set_error)((13),(164),
# 286 "../crypto/asn1/tasn_utl.c" 3 4
       ((void *)0)
# 286 "../crypto/asn1/tasn_utl.c"
       );
    return 
# 287 "../crypto/asn1/tasn_utl.c" 3 4
          ((void *)0)
