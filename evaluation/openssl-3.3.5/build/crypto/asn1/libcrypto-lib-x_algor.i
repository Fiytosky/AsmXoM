# 0 "../crypto/asn1/x_algor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_algor.c"
# 10 "../crypto/asn1/x_algor.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 17 "../crypto/asn1/x_algor.c" 2

static const ASN1_TEMPLATE X509_ALGOR_seq_tt[] = {
        { (0), (0), 
# 19 "../crypto/asn1/x_algor.c" 3 4
       __builtin_offsetof (
# 19 "../crypto/asn1/x_algor.c"
       X509_ALGOR
# 19 "../crypto/asn1/x_algor.c" 3 4
       , 
# 19 "../crypto/asn1/x_algor.c"
...
# 19 "../crypto/asn1/x_algor.c"
       , "algorithm", (ASN1_OBJECT_it) },
        { ((0x1)), (0), 
# 20 "../crypto/asn1/x_algor.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/asn1/x_algor.c"
       X509_ALGOR
# 20 "../crypto/asn1/x_algor.c" 3 4
       , 
# 20 "../crypto/asn1/x_algor.c"
...
# 20 "../crypto/asn1/x_algor.c"
       , "parameter", (ASN1_ANY_it) }
} ; const ASN1_ITEM * X509_ALGOR_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, X509_ALGOR_seq_tt, sizeof(X509_ALGOR_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 21 "../crypto/asn1/x_algor.c" 3 4
 ((void *)0)
# 21 "../crypto/asn1/x_algor.c"
 , sizeof(X509_ALGOR), "X509_ALGOR" }; return &local_it; }

static const ASN1_TEMPLATE X509_ALGORS_item_tt =
        { ((0x2 << 1)), (0), 0, "algorithms", (X509_ALGOR_it) }
; const ASN1_ITEM * X509_ALGORS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &X509_ALGORS_item_tt, 0, 
# 25 "../crypto/asn1/x_algor.c" 3 4
((void *)0)
# 25 "../crypto/asn1/x_algor.c"
, 0, "X509_ALGORS" }; return &local_it; }

X509_ALGOR *d2i_X509_ALGOR(X509_ALGOR **a, const unsigned char **in, long len) { return (X509_ALGOR *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_ALGOR_it())); } int i2d_X509_ALGOR(const X509_ALGOR *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_ALGOR_it())); } X509_ALGOR *X509_ALGOR_new(void) { return (X509_ALGOR *)ASN1_item_new((X509_ALGOR_it())); } void X509_ALGOR_free(X509_ALGOR *a) { ASN1_item_free((ASN1_VALUE *)a, (X509_ALGOR_it())); }
X509_ALGORS *d2i_X509_ALGORS(X509_ALGORS **a, const unsigned char **in, long len) { return (X509_ALGORS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (X509_ALGORS_it())); } int i2d_X509_ALGORS(const X509_ALGORS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (X509_ALGORS_it())); }
X509_ALGOR * X509_ALGOR_dup(const X509_ALGOR *x) { return ASN1_item_dup((X509_ALGOR_it()), x); }

int X509_ALGOR_set0(X509_ALGOR *alg, ASN1_OBJECT *aobj, int ptype, void *pval)
{
    if (alg == 
# 33 "../crypto/asn1/x_algor.c" 3 4
              ((void *)0)
# 33 "../crypto/asn1/x_algor.c"
                  )
        return 0;

    if (ptype != -1 && alg->parameter == 
# 36 "../crypto/asn1/x_algor.c" 3 4
                                                  ((void *)0)
            
# 37 "../crypto/asn1/x_algor.c"
           && (alg->parameter = ASN1_TYPE_new()) == 
# 37 "../crypto/asn1/x_algor.c" 3 4
                                                    ((void *)0)
# 37 "../crypto/asn1/x_algor.c"
                                                        )
        return 0;
...
X509_ALGOR *ossl_X509_ALGOR_from_nid(int nid, int ptype, void *pval)
{
    ...
    X509_ALGOR *alg = 
# 56 "../crypto/asn1/x_algor.c" 3 4
                     ((void *)0)
# 56 "../crypto/asn1/x_algor.c"
                         ;

    if (algo == 
# 58 "../crypto/asn1/x_algor.c" 3 4
               ((void *)0)
# 58 "../crypto/asn1/x_algor.c"
                   )
        return 
# 59 "../crypto/asn1/x_algor.c" 3 4
              ((void *)0)
# 59 "../crypto/asn1/x_algor.c"
                  ;
    if ((alg = X509_ALGOR_new()) == 
# 60 "../crypto/asn1/x_algor.c" 3 4
                                   ((void *)0)
# 60 "../crypto/asn1/x_algor.c"
                                       )
        goto err;
    if (X509_ALGOR_set0(alg, algo, ptype, pval))
        return alg;
    alg->algorithm = 
# 64 "../crypto/asn1/x_algor.c" 3 4
                    ((void *)0)
# 64 "../crypto/asn1/x_algor.c"
                        ;
 ...
 err:
    ...
    return 
# 69 "../crypto/asn1/x_algor.c" 3 4
          ((void *)0)
# 69 "../crypto/asn1/x_algor.c"
              ;
}
                     ...
                     const void **ppval, const X509_ALGOR *algor)
{
    ...
    if (pptype) {
        if (algor->parameter == 
# 78 "../crypto/asn1/x_algor.c" 3 4
                               ((void *)0)
# 78 "../crypto/asn1/x_algor.c"
                                   ) {
            *pptype = -1;
            return;
        } else
...
void X509_ALGOR_set_md(X509_ALGOR *alg, const EVP_MD *md)
{
    int type = md->flags & 0x0008 ? -1
                                                       : 5;

    (void)X509_ALGOR_set0(alg, OBJ_nid2obj(EVP_MD_get_type(md)), type, 
# 94 "../crypto/asn1/x_algor.c" 3 4
                                                                      ((void *)0)
# 94 "../crypto/asn1/x_algor.c"
                                                                          );
}
...
{
    if (src == 
# 110 "../crypto/asn1/x_algor.c" 3 4
              ((void *)0) 
# 110 "../crypto/asn1/x_algor.c"
                   || dest == 
# 110 "../crypto/asn1/x_algor.c" 3 4
                              ((void *)0)
# 110 "../crypto/asn1/x_algor.c"
    ...
    dest->algorithm = 
# 115 "../crypto/asn1/x_algor.c" 3 4
                     ((void *)0)
# 115 "../crypto/asn1/x_algor.c"
                         ;

    if (dest->parameter)
        ASN1_TYPE_free(dest->parameter);
    dest->parameter = 
# 119 "../crypto/asn1/x_algor.c" 3 4
                     ((void *)0)
# 119 "../crypto/asn1/x_algor.c"
                         ;

    if (src->algorithm)
        if ((dest->algorithm = OBJ_dup(src->algorithm)) == 
# 122 "../crypto/asn1/x_algor.c" 3 4
                                                          ((void *)0)
# 122 "../crypto/asn1/x_algor.c"
                                                              )
            return 0;

    if (src->parameter != 
# 125 "../crypto/asn1/x_algor.c" 3 4
                         ((void *)0)
# 125 "../crypto/asn1/x_algor.c"
                             ) {
        dest->parameter = ASN1_TYPE_new();
        if (dest->parameter == 
# 127 "../crypto/asn1/x_algor.c" 3 4
                              ((void *)0)
# 127 "../crypto/asn1/x_algor.c"
                                  )
            return 0;
...
int ossl_x509_algor_new_from_md(X509_ALGOR **palg, const EVP_MD *md)
{
    ...
    if (md == 
# 147 "../crypto/asn1/x_algor.c" 3 4
             ((void *)0) 
# 147 "../crypto/asn1/x_algor.c"
                  || EVP_MD_is_a(md, "SHA1"))
        return 1;
    if ((alg = X509_ALGOR_new()) == 
# 149 "../crypto/asn1/x_algor.c" 3 4
                                   ((void *)0)
# 149 "../crypto/asn1/x_algor.c"
                                       )
        return 0;
...
const EVP_MD *ossl_x509_algor_get_md(X509_ALGOR *alg)
{
    ...
    if (alg == 
# 161 "../crypto/asn1/x_algor.c" 3 4
              ((void *)0)
# 161 "../crypto/asn1/x_algor.c"
                  )
        return EVP_sha1();
    md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(alg->algorithm)));
    if (md == 
# 164 "../crypto/asn1/x_algor.c" 3 4
             ((void *)0)
# 164 "../crypto/asn1/x_algor.c"
                 )
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_algor.c",165,__func__), ERR_set_error)((13),(229),
# 165 "../crypto/asn1/x_algor.c" 3 4
       ((void *)0)
# 165 "../crypto/asn1/x_algor.c"
       );
    return md;
}
...
X509_ALGOR *ossl_x509_algor_mgf1_decode(X509_ALGOR *alg)
{
    if (OBJ_obj2nid(alg->algorithm) != 911)
        return 
# 172 "../crypto/asn1/x_algor.c" 3 4
              ((void *)0)
# 172 "../crypto/asn1/x_algor.c"
                  ;
    return ASN1_TYPE_unpack_sequence((X509_ALGOR_it()),
                                     alg->parameter);
}
...
{
    X509_ALGOR *algtmp = 
# 180 "../crypto/asn1/x_algor.c" 3 4
                        ((void *)0)
# 180 "../crypto/asn1/x_algor.c"
                            ;
    ASN1_STRING *stmp = 
# 181 "../crypto/asn1/x_algor.c" 3 4
                       ((void *)0)
# 181 "../crypto/asn1/x_algor.c"
                           ;

    *palg = 
# 183 "../crypto/asn1/x_algor.c" 3 4
           ((void *)0)
# 183 "../crypto/asn1/x_algor.c"
               ;
    if (mgf1md == 
# 184 "../crypto/asn1/x_algor.c" 3 4
                 ((void *)0) 
# 184 "../crypto/asn1/x_algor.c"
                      || EVP_MD_is_a(mgf1md, "SHA1"))
        return 1;

    if (!ossl_x509_algor_new_from_md(&algtmp, mgf1md))
        goto err;
    if (ASN1_item_pack(algtmp, (X509_ALGOR_it()), &stmp) == 
# 189 "../crypto/asn1/x_algor.c" 3 4
                                                                    ((void *)0)
# 189 "../crypto/asn1/x_algor.c"
                                                                        )
         goto err;
    *palg = ossl_X509_ALGOR_from_nid(911, 16, stmp);
    if (*palg == 
# 192 "../crypto/asn1/x_algor.c" 3 4
                ((void *)0)
# 192 "../crypto/asn1/x_algor.c"
                    )
        goto err;
    stmp = 
# 194 "../crypto/asn1/x_algor.c" 3 4
          ((void *)0)
# 194 "../crypto/asn1/x_algor.c"
              ;
 err:
    ASN1_STRING_free(stmp);
    X509_ALGOR_free(algtmp);
    return *palg != 
# 198 "../crypto/asn1/x_algor.c" 3 4
                   ((void *)0)
# 198 "../crypto/asn1/x_algor.c"
                       ;
}
