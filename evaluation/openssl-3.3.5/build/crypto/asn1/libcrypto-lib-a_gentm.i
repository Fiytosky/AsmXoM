# 0 "../crypto/asn1/a_gentm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_gentm.c"
# 14 "../crypto/asn1/a_gentm.c"
...
int ASN1_item_ex_i2d(const ASN1_VALUE **pval, unsigned char **out,
                     const ASN1_ITEM *it, int tag, int aclass);
# 20 "../crypto/asn1/a_gentm.c" 2

ASN1_GENERALIZEDTIME * ASN1_GENERALIZEDTIME_dup(const ASN1_GENERALIZEDTIME *x) { return ASN1_item_dup((ASN1_GENERALIZEDTIME_it()), x); }
...
{
    return asn1_generalizedtime_to_tm(
# 35 "../crypto/asn1/a_gentm.c" 3 4
                                     ((void *)0)
# 35 "../crypto/asn1/a_gentm.c"
                                         , d);
}
...
int ASN1_GENERALIZEDTIME_set_string(ASN1_GENERALIZEDTIME *s, const char *str)
{
    ...
    if (s != 
# 50 "../crypto/asn1/a_gentm.c" 3 4
            ((void *)0) 
# 50 "../crypto/asn1/a_gentm.c"
                 && !ASN1_STRING_copy(s, &t))
        return 0;
                                               ...
                                               long offset_sec)
{
    ...
    if (ts == 
# 70 "../crypto/asn1/a_gentm.c" 3 4
             ((void *)0)
# 70 "../crypto/asn1/a_gentm.c"
                 )
        return 
# 71 "../crypto/asn1/a_gentm.c" 3 4
              ((void *)0)
# 71 "../crypto/asn1/a_gentm.c"
                  ;

    if (offset_day || offset_sec) {
        if (!OPENSSL_gmtime_adj(ts, offset_day, offset_sec))
            return 
# 75 "../crypto/asn1/a_gentm.c" 3 4
                  ((void *)0)
# 75 "../crypto/asn1/a_gentm.c"
                      ;
    }

    return ossl_asn1_time_from_tm(s, ts, 24);
}
