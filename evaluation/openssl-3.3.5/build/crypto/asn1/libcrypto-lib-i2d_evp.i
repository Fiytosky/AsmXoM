# 0 "../crypto/asn1/i2d_evp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/i2d_evp.c"
# 14 "../crypto/asn1/i2d_evp.c"
                        ...
                        unsigned char **pp)
{
    ...
    for (ret = -1;
         ret == -1 && output_info->output_type != 
# 40 "../crypto/asn1/i2d_evp.c" 3 4
                                                 ((void *)0)
# 40 "../crypto/asn1/i2d_evp.c"
                                                     ;
         output_info++) {
...
# 49 "../crypto/asn1/i2d_evp.c"
                           ;
        int pp_was_NULL = (pp == 
# 50 "../crypto/asn1/i2d_evp.c" 3 4
                                ((void *)0) 
# 50 "../crypto/asn1/i2d_evp.c"
                                     || *pp == 
# 50 "../crypto/asn1/i2d_evp.c" 3 4
                                               ((void *)0)
# 50 "../crypto/asn1/i2d_evp.c"
...
# 56 "../crypto/asn1/i2d_evp.c" 3 4
                                           ((void *)0)
# 56 "../crypto/asn1/i2d_evp.c"
                                               );
        if (ctx == 
# 57 "../crypto/asn1/i2d_evp.c" 3 4
                  ((void *)0)
# 57 "../crypto/asn1/i2d_evp.c"
                      )
            return -1;
...
# 63 "../crypto/asn1/i2d_evp.c"
    ...
    if (ret == -1)
        (ERR_new(), ERR_set_debug("../crypto/asn1/i2d_evp.c",69,__func__), ERR_set_error)((13),(196),
# 69 "../crypto/asn1/i2d_evp.c" 3 4
       ((void *)0)
# 69 "../crypto/asn1/i2d_evp.c"
       );
    return ret;
}
...
{
    if (((a)->keymgmt != 
# 75 "../crypto/asn1/i2d_evp.c" 3 4
       ((void *)0)
# 75 "../crypto/asn1/i2d_evp.c"
       )) {
        static const struct type_and_structure_st output_info[] = {
            { "DER", "type-specific" },
            { 
# 78 "../crypto/asn1/i2d_evp.c" 3 4
             ((void *)0)
# 78 "../crypto/asn1/i2d_evp.c"
                 , }
        };

        return i2d_provided(a, ( ( 0x04 | 0x80) ), output_info, pp);
    }
    if (a->ameth != 
# 83 "../crypto/asn1/i2d_evp.c" 3 4
                   ((void *)0) 
# 83 "../crypto/asn1/i2d_evp.c"
                        && a->ameth->param_encode != 
# 83 "../crypto/asn1/i2d_evp.c" 3 4
                                                     ((void *)0)
# 83 "../crypto/asn1/i2d_evp.c"
                                                         )
        return a->ameth->param_encode(a, pp);
    (ERR_new(), ERR_set_debug("../crypto/asn1/i2d_evp.c",85,__func__), ERR_set_error)((13),(196),
# 85 "../crypto/asn1/i2d_evp.c" 3 4
   ((void *)0)
# 85 "../crypto/asn1/i2d_evp.c"
   );
    return -1;
}
...
int i2d_KeyParams_bio(BIO *bp, const EVP_PKEY *pkey)
{
    return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_KeyParams : ((int (*)(const EVP_PKEY *,unsigned char **))0))), bp, ((void*) (1 ? pkey : (const EVP_PKEY*)0))));
}

int i2d_PrivateKey(const EVP_PKEY *a, unsigned char **pp)
{
    if (((a)->keymgmt != 
# 96 "../crypto/asn1/i2d_evp.c" 3 4
       ((void *)0)
# 96 "../crypto/asn1/i2d_evp.c"
       )) {
        static const struct type_and_structure_st output_info[] = {
            { "DER", "type-specific" },
            { "DER", "PrivateKeyInfo" },
            { 
# 100 "../crypto/asn1/i2d_evp.c" 3 4
             ((void *)0)
# 100 "../crypto/asn1/i2d_evp.c"
                 , }
        };

        return i2d_provided(a, ( ( ( ( 0x04 | 0x80) ) | 0x02 ) | 0x01 ), output_info, pp);
    }
    if (a->ameth != 
# 105 "../crypto/asn1/i2d_evp.c" 3 4
                   ((void *)0) 
# 105 "../crypto/asn1/i2d_evp.c"
...
# 105 "../crypto/asn1/i2d_evp.c"
    ...
    if (a->ameth != 
# 108 "../crypto/asn1/i2d_evp.c" 3 4
                   ((void *)0) 
# 108 "../crypto/asn1/i2d_evp.c"
                        && a->ameth->priv_encode != 
# 108 "../crypto/asn1/i2d_evp.c" 3 4
                                                    ((void *)0)
# 108 "../crypto/asn1/i2d_evp.c"
        ...
        if (p8 != 
# 112 "../crypto/asn1/i2d_evp.c" 3 4
                 ((void *)0)
# 112 "../crypto/asn1/i2d_evp.c"
                     ) {
    ...
    (ERR_new(), ERR_set_debug("../crypto/asn1/i2d_evp.c",118,__func__), ERR_set_error)((13),(167),
# 118 "../crypto/asn1/i2d_evp.c" 3 4
   ((void *)0)
# 118 "../crypto/asn1/i2d_evp.c"
   );
    return -1;
}
...
{
    if (((a)->keymgmt != 
# 124 "../crypto/asn1/i2d_evp.c" 3 4
       ((void *)0)
# 124 "../crypto/asn1/i2d_evp.c"
       )) {
        static const struct type_and_structure_st output_info[] = {
            { "DER", "type-specific" },
            { "blob", 
# 127 "../crypto/asn1/i2d_evp.c" 3 4
                     ((void *)0) 
# 127 "../crypto/asn1/i2d_evp.c"
                          },
            { 
# 128 "../crypto/asn1/i2d_evp.c" 3 4
             ((void *)0)
# 128 "../crypto/asn1/i2d_evp.c"
                 , }
        };

        return i2d_provided(a, ( ( ( 0x04 | 0x80) ) | 0x02 ), output_info, pp);
    }
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/asn1/i2d_evp.c",145,__func__), ERR_set_error)((13),(167),
# 145 "../crypto/asn1/i2d_evp.c" 3 4
       ((void *)0)
# 145 "../crypto/asn1/i2d_evp.c"
       );
        return -1;
    }
}
