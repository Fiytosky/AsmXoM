# 0 "../crypto/asn1/a_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_sign.c"
# 10 "../crypto/asn1/a_sign.c"
...
# 19 "../crypto/asn1/a_sign.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 22 "../crypto/asn1/a_sign.c" 2
...
# 32 "../crypto/asn1/a_sign.c" 3 4
                               ((void *)0)
# 32 "../crypto/asn1/a_sign.c"
                                   , *buf_out = 
# 32 "../crypto/asn1/a_sign.c" 3 4
                                                ((void *)0)
# 32 "../crypto/asn1/a_sign.c"
    ...
    if (ctx == 
# 37 "../crypto/asn1/a_sign.c" 3 4
              ((void *)0)
# 37 "../crypto/asn1/a_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",38,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 38 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 38 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    for (i = 0; i < 2; i++) {
        if (i == 0)
            ...
            a = algor2;
        if (a == 
# 46 "../crypto/asn1/a_sign.c" 3 4
                ((void *)0)
# 46 "../crypto/asn1/a_sign.c"
                    )
            continue;
        if (type->pkey_type == 113) {
            ...
            a->parameter = 
# 54 "../crypto/asn1/a_sign.c" 3 4
                          ((void *)0)
# 54 "../crypto/asn1/a_sign.c"
                              ;
        } else if ((a->parameter == 
# 55 "../crypto/asn1/a_sign.c" 3 4
                                   ((void *)0)
# 55 "../crypto/asn1/a_sign.c"
                                       ) ||
                   (a->parameter->type != 5)) {
            ASN1_TYPE_free(a->parameter);
            if ((a->parameter = ASN1_TYPE_new()) == 
# 58 "../crypto/asn1/a_sign.c" 3 4
                                                   ((void *)0)
# 58 "../crypto/asn1/a_sign.c"
                                                       )
                goto err;
            a->parameter->type = 5;
        }
        ...
        if (a->algorithm == 
# 64 "../crypto/asn1/a_sign.c" 3 4
                           ((void *)0)
# 64 "../crypto/asn1/a_sign.c"
                               ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",65,__func__), ERR_set_error)((13),(162),
# 65 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 65 "../crypto/asn1/a_sign.c"
           );
            goto err;
        }
        if (a->algorithm->length == 0) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",69,__func__), ERR_set_error)((13),(154),
# 69 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 69 "../crypto/asn1/a_sign.c"
           )
                                                                                 ;
            goto err;
        }
    ...
    inl = i2d(data, 
# 74 "../crypto/asn1/a_sign.c" 3 4
                   ((void *)0)
# 74 "../crypto/asn1/a_sign.c"
                       );
    if (inl <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",76,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 76 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 76 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    inll = (size_t)inl;
    buf_in = CRYPTO_malloc(inll, "../crypto/asn1/a_sign.c", 80);
    outll = outl = EVP_PKEY_get_size(pkey);
    buf_out = CRYPTO_malloc(outll, "../crypto/asn1/a_sign.c", 82);
    if (buf_in == 
# 83 "../crypto/asn1/a_sign.c" 3 4
                 ((void *)0) 
# 83 "../crypto/asn1/a_sign.c"
                      || buf_out == 
# 83 "../crypto/asn1/a_sign.c" 3 4
                                    ((void *)0)
# 83 "../crypto/asn1/a_sign.c"
    ...
    i2d(data, &p);
    if (!EVP_DigestInit_ex(ctx,type,
# 90 "../crypto/asn1/a_sign.c" 3 4
        ((void *)0)
# 90 "../crypto/asn1/a_sign.c"
        )
        || !EVP_DigestUpdate(ctx,(unsigned char *)buf_in,inl)
        || !EVP_SignFinal(ctx, (unsigned char *)buf_out,
                          (unsigned int *)&outl, pkey)) {
        outl = 0;
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",95,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 95 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 95 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    ASN1_STRING_set0(signature, buf_out, outl);
    buf_out = 
# 99 "../crypto/asn1/a_sign.c" 3 4
             ((void *)0)
# 99 "../crypto/asn1/a_sign.c"
                 ;
 ...
 err:
    EVP_MD_CTX_free(ctx);
    CRYPTO_clear_free((char *)buf_in, inll, "../crypto/asn1/a_sign.c", 107);
    CRYPTO_clear_free((char *)buf_out, outll, "../crypto/asn1/a_sign.c", 108);
    return outl;
}
...
int ASN1_item_sign(const ASN1_ITEM *it, X509_ALGOR *algor1, X509_ALGOR *algor2,
                   ...
                   EVP_PKEY *pkey, const EVP_MD *md)
{
    return ASN1_item_sign_ex(it, algor1, algor2, signature, data, 
# 118 "../crypto/asn1/a_sign.c" 3 4
                                                                 ((void *)0)
# 118 "../crypto/asn1/a_sign.c"
                                                                     , pkey,
                             md, 
# 119 "../crypto/asn1/a_sign.c" 3 4
                                ((void *)0)
# 119 "../crypto/asn1/a_sign.c"
                                    , 
# 119 "../crypto/asn1/a_sign.c" 3 4
                                      ((void *)0)
# 119 "../crypto/asn1/a_sign.c"
                      ...
                      const char *propq)
{
    ...
    if (ctx == 
# 131 "../crypto/asn1/a_sign.c" 3 4
              ((void *)0)
# 131 "../crypto/asn1/a_sign.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",132,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 132 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 132 "../crypto/asn1/a_sign.c"
       );
        return 0;
    }

    if (!EVP_DigestSignInit(ctx, 
# 136 "../crypto/asn1/a_sign.c" 3 4
                                ((void *)0)
# 136 "../crypto/asn1/a_sign.c"
                                    , md, 
# 136 "../crypto/asn1/a_sign.c" 3 4
                                          ((void *)0)
# 136 "../crypto/asn1/a_sign.c"
...
# 153 "../crypto/asn1/a_sign.c" 3 4
                           ((void *)0)
# 153 "../crypto/asn1/a_sign.c"
                               , *buf_out = 
# 153 "../crypto/asn1/a_sign.c" 3 4
                                            ((void *)0)
# 153 "../crypto/asn1/a_sign.c"
    ...
    if (pkey == 
# 161 "../crypto/asn1/a_sign.c" 3 4
               ((void *)0)
# 161 "../crypto/asn1/a_sign.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",162,__func__), ERR_set_error)((13),(217),
# 162 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 162 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }

    if (pkey->ameth == 
# 166 "../crypto/asn1/a_sign.c" 3 4
                      ((void *)0)
# 166 "../crypto/asn1/a_sign.c"
        ...
        if (pctx == 
# 172 "../crypto/asn1/a_sign.c" 3 4
                   ((void *)0)
            
# 173 "../crypto/asn1/a_sign.c"
           || !((pctx)->operation == (1<<4) || (pctx)->operation == (1<<7) || (pctx)->operation == (1<<5) || (pctx)->operation == (1<<8) || (pctx)->operation == (1<<6))) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",174,__func__), ERR_set_error)((13),(217),
# 174 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 174 "../crypto/asn1/a_sign.c"
           );
            goto err;
        }

        params[0] =
            OSSL_PARAM_construct_octet_string("algorithm-id",
                                              aid, sizeof(aid));
        ...
        if ((aid_len = params[0].return_size) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",187,__func__), ERR_set_error)((13),(198),
# 187 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 187 "../crypto/asn1/a_sign.c"
           );
            goto err;
        }

        if (algor1 != 
# 191 "../crypto/asn1/a_sign.c" 3 4
                     ((void *)0)
# 191 "../crypto/asn1/a_sign.c"
                         ) {
            const unsigned char *pp = aid;

            if (d2i_X509_ALGOR(&algor1, &pp, aid_len) == 
# 194 "../crypto/asn1/a_sign.c" 3 4
                                                        ((void *)0)
# 194 "../crypto/asn1/a_sign.c"
                                                            ) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",195,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 195 "../crypto/asn1/a_sign.c" 3 4
               ((void *)0)
# 195 "../crypto/asn1/a_sign.c"
               );
                goto err;
            }
        }
        ...
        if (algor2 != 
# 200 "../crypto/asn1/a_sign.c" 3 4
                     ((void *)0)
# 200 "../crypto/asn1/a_sign.c"
                         ) {
            const unsigned char *pp = aid;

            if (d2i_X509_ALGOR(&algor2, &pp, aid_len) == 
# 203 "../crypto/asn1/a_sign.c" 3 4
                                                        ((void *)0)
# 203 "../crypto/asn1/a_sign.c"
                                                            ) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",204,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 204 "../crypto/asn1/a_sign.c" 3 4
               ((void *)0)
# 204 "../crypto/asn1/a_sign.c"
               );
                goto err;
            }
        }
        ...
        if (rv <= 0)
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",222,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 222 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 222 "../crypto/asn1/a_sign.c"
           );
        if (rv <= 1)
            goto err;
    } else {
    ...
    if (rv == 2) {
        if (md == 
# 230 "../crypto/asn1/a_sign.c" 3 4
                 ((void *)0)
# 230 "../crypto/asn1/a_sign.c"
                     ) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",231,__func__), ERR_set_error)((13),(217),
# 231 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 231 "../crypto/asn1/a_sign.c"
           );
            goto err;
        }
        ...
        pkey_id =
            ...
            EVP_PKEY_get_id(pkey) == 1172 ? 1172 :

            pkey->ameth->pkey_id;

        if (!OBJ_find_sigid_by_algs(&signid, EVP_MD_get_type(md), pkey_id)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",242,__func__), ERR_set_error)((13),(198),
# 242 "../crypto/asn1/a_sign.c" 3 4
           ((void *)0)
# 242 "../crypto/asn1/a_sign.c"
           );
            goto err;
        }

        paramtype = pkey->ameth->pkey_flags & 0x4 ?
            5 : -1;
        if (algor1 != 
# 248 "../crypto/asn1/a_sign.c" 3 4
                     ((void *)0)
            
# 249 "../crypto/asn1/a_sign.c"
           && !X509_ALGOR_set0(algor1, OBJ_nid2obj(signid), paramtype, 
# 249 "../crypto/asn1/a_sign.c" 3 4
                                                                       ((void *)0)
# 249 "../crypto/asn1/a_sign.c"
                                                                           ))
            goto err;
        if (algor2 != 
# 251 "../crypto/asn1/a_sign.c" 3 4
                     ((void *)0)
            
# 252 "../crypto/asn1/a_sign.c"
           && !X509_ALGOR_set0(algor2, OBJ_nid2obj(signid), paramtype, 
# 252 "../crypto/asn1/a_sign.c" 3 4
                                                                       ((void *)0)
# 252 "../crypto/asn1/a_sign.c"
                                                                           ))
            goto err;
    ...
    if (buf_len <= 0) {
        outl = 0;
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",259,__func__), ERR_set_error)((13),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 259 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 259 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    inl = buf_len;
    if (!EVP_DigestSign(ctx, 
# 263 "../crypto/asn1/a_sign.c" 3 4
                            ((void *)0)
# 263 "../crypto/asn1/a_sign.c"
                                , &outll, buf_in, inl)) {
        outl = 0;
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",265,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 265 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 265 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    outl = outll;
    buf_out = CRYPTO_malloc(outll, "../crypto/asn1/a_sign.c", 269);
    if (buf_in == 
# 270 "../crypto/asn1/a_sign.c" 3 4
                 ((void *)0) 
# 270 "../crypto/asn1/a_sign.c"
                      || buf_out == 
# 270 "../crypto/asn1/a_sign.c" 3 4
                                    ((void *)0)
# 270 "../crypto/asn1/a_sign.c"
    ...
    if (!EVP_DigestSign(ctx, buf_out, &outl, buf_in, inl)) {
        outl = 0;
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_sign.c",277,__func__), ERR_set_error)((13),((6 | (0x2 << 18L))),
# 277 "../crypto/asn1/a_sign.c" 3 4
       ((void *)0)
# 277 "../crypto/asn1/a_sign.c"
       );
        goto err;
    }
    ASN1_STRING_set0(signature, buf_out, outl);
    buf_out = 
# 281 "../crypto/asn1/a_sign.c" 3 4
             ((void *)0)
# 281 "../crypto/asn1/a_sign.c"
                 ;
    ...
    ossl_asn1_string_set_bits_left(signature, 0);
 err:
    CRYPTO_clear_free((char *)buf_in, inl, "../crypto/asn1/a_sign.c", 288);
    CRYPTO_clear_free((char *)buf_out, outll, "../crypto/asn1/a_sign.c", 289);
    return outl;
}
