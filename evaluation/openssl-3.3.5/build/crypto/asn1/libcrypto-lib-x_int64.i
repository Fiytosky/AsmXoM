# 0 "../crypto/asn1/x_int64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/x_int64.c"
# 10 "../crypto/asn1/x_int64.c"
...
int ossl_asn1_item_ex_new_intern(ASN1_VALUE **pval, const ASN1_ITEM *it,
                                 OSSL_LIB_CTX *libctx, const char *propq);
# 16 "../crypto/asn1/x_int64.c" 2
# 29 "../crypto/asn1/x_int64.c"
static int uint64_new(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
    if ((*pval = (ASN1_VALUE *)CRYPTO_zalloc(sizeof(uint64_t), "../crypto/asn1/x_int64.c", 31)) == 
# 31 "../crypto/asn1/x_int64.c" 3 4
                                                                   ((void *)0)
# 31 "../crypto/asn1/x_int64.c"
                                                                       )
        return 0;
    return 1;
}
...
{
    CRYPTO_free(*pval, "../crypto/asn1/x_int64.c", 38);
    *pval = 
# 39 "../crypto/asn1/x_int64.c" 3 4
           ((void *)0)
# 39 "../crypto/asn1/x_int64.c"
               ;
}
                      ...
                      int utype, char *free_cont, const ASN1_ITEM *it)
{
    ...
    if (*pval == 
# 78 "../crypto/asn1/x_int64.c" 3 4
                ((void *)0) 
# 78 "../crypto/asn1/x_int64.c"
                     && !uint64_new(pval, it))
        return 0;
    ...
    if (!ossl_c2i_uint64_int(&utmp, &neg, &cont, len))
        return 0;
    if ((it->size & (1<<1)) == 0 && neg) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_int64.c",95,__func__), ERR_set_error)((13),(226),
# 95 "../crypto/asn1/x_int64.c" 3 4
       ((void *)0)
# 95 "../crypto/asn1/x_int64.c"
       );
        return 0;
    }
    if ((it->size & (1<<1)) == (1<<1)
            && !neg && utmp > 
# 99 "../crypto/asn1/x_int64.c" 3 4
                             (9223372036854775807L)
# 99 "../crypto/asn1/x_int64.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_int64.c",100,__func__), ERR_set_error)((13),(223),
# 100 "../crypto/asn1/x_int64.c" 3 4
       ((void *)0)
# 100 "../crypto/asn1/x_int64.c"
       );
        return 0;
    }
    if (neg)
...
{
    if ((*pval = (ASN1_VALUE *)CRYPTO_zalloc(sizeof(uint32_t), "../crypto/asn1/x_int64.c", 124)) == 
# 124 "../crypto/asn1/x_int64.c" 3 4
                                                                   ((void *)0)
# 124 "../crypto/asn1/x_int64.c"
                                                                       )
        return 0;
    return 1;
}
...
{
    CRYPTO_free(*pval, "../crypto/asn1/x_int64.c", 131);
    *pval = 
# 132 "../crypto/asn1/x_int64.c" 3 4
           ((void *)0)
# 132 "../crypto/asn1/x_int64.c"
               ;
}
                      ...
                      int utype, char *free_cont, const ASN1_ITEM *it)
{
    ...
    if (*pval == 
# 179 "../crypto/asn1/x_int64.c" 3 4
                ((void *)0) 
# 179 "../crypto/asn1/x_int64.c"
                     && !uint64_new(pval, it))
        return 0;
    ...
    if (!ossl_c2i_uint64_int(&utmp, &neg, &cont, len))
        return 0;
    if ((it->size & (1<<1)) == 0 && neg) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/x_int64.c",196,__func__), ERR_set_error)((13),(226),
# 196 "../crypto/asn1/x_int64.c" 3 4
       ((void *)0)
# 196 "../crypto/asn1/x_int64.c"
       );
        return 0;
    }
    if (neg) {
        if (utmp > ((uint32_t)
# 200 "../crypto/asn1/x_int64.c" 3 4
                  (2147483647) 
# 200 "../crypto/asn1/x_int64.c"
                  + 1)) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/x_int64.c",201,__func__), ERR_set_error)((13),(224),
# 201 "../crypto/asn1/x_int64.c" 3 4
           ((void *)0)
# 201 "../crypto/asn1/x_int64.c"
           );
            return 0;
        }
        utmp = 0 - utmp;
    } else {
        if (((it->size & (1<<1)) != 0 && utmp > 
# 206 "../crypto/asn1/x_int64.c" 3 4
                                                          (2147483647)
# 206 "../crypto/asn1/x_int64.c"
                                                                   )
            || ((it->size & (1<<1)) == 0 && utmp > 
# 207 "../crypto/asn1/x_int64.c" 3 4
                                                             (4294967295U)
# 207 "../crypto/asn1/x_int64.c"
                                                                       )) {
            (ERR_new(), ERR_set_debug("../crypto/asn1/x_int64.c",208,__func__), ERR_set_error)((13),(223),
# 208 "../crypto/asn1/x_int64.c" 3 4
           ((void *)0)
# 208 "../crypto/asn1/x_int64.c"
           );
            return 0;
        }
    }
...
# 231 "../crypto/asn1/x_int64.c" 3 4
   ((void *)0)
# 231 "../crypto/asn1/x_int64.c"
       , 0,
    uint32_new,
    uint32_free,
    uint32_clear,
...
# 241 "../crypto/asn1/x_int64.c" 3 4
   ((void *)0)
# 241 "../crypto/asn1/x_int64.c"
       , 0,
    uint64_new,
    uint64_free,
    uint64_clear,
...
const ASN1_ITEM * INT32_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 251 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 251 "../crypto/asn1/x_int64.c"
                                             , 0, &uint32_pf,
    (1<<1), "INT32"
}; return &local_it; }

const ASN1_ITEM * UINT32_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 256 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 256 "../crypto/asn1/x_int64.c"
                                             , 0, &uint32_pf, 0, "UINT32"
}; return &local_it; }

const ASN1_ITEM * INT64_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 260 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 260 "../crypto/asn1/x_int64.c"
                                             , 0, &uint64_pf,
    (1<<1), "INT64"
}; return &local_it; }

const ASN1_ITEM * UINT64_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 265 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 265 "../crypto/asn1/x_int64.c"
                                             , 0, &uint64_pf, 0, "UINT64"
}; return &local_it; }

const ASN1_ITEM * ZINT32_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 269 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 269 "../crypto/asn1/x_int64.c"
                                             , 0, &uint32_pf,
    (1<<0)|(1<<1), "ZINT32"
}; return &local_it; }

const ASN1_ITEM * ZUINT32_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 274 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 274 "../crypto/asn1/x_int64.c"
                                             , 0, &uint32_pf,
    (1<<0), "ZUINT32"
}; return &local_it; }

const ASN1_ITEM * ZINT64_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 279 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 279 "../crypto/asn1/x_int64.c"
                                             , 0, &uint64_pf,
    (1<<0)|(1<<1), "ZINT64"
}; return &local_it; }

const ASN1_ITEM * ZUINT64_it(void) { static const ASN1_ITEM local_it = {
    0x0, 2, 
# 284 "../crypto/asn1/x_int64.c" 3 4
                                         ((void *)0)
# 284 "../crypto/asn1/x_int64.c"
                                             , 0, &uint64_pf,
    (1<<0), "ZUINT64"
}; return &local_it; }
