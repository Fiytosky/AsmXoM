# 0 "../crypto/asn1/a_d2i_fp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/asn1/a_d2i_fp.c"
# 10 "../crypto/asn1/a_d2i_fp.c"
...
# 27 "../crypto/asn1/a_d2i_fp.c" 3 4
                                      ((void *)0)
# 27 "../crypto/asn1/a_d2i_fp.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",28,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 28 "../crypto/asn1/a_d2i_fp.c" 3 4
       ((void *)0)
# 28 "../crypto/asn1/a_d2i_fp.c"
       );
        return 
# 29 "../crypto/asn1/a_d2i_fp.c" 3 4
              ((void *)0)
# 29 "../crypto/asn1/a_d2i_fp.c"
                  ;
    }
...
{
    BUF_MEM *b = 
# 40 "../crypto/asn1/a_d2i_fp.c" 3 4
                ((void *)0)
# 40 "../crypto/asn1/a_d2i_fp.c"
                    ;
    const unsigned char *p;
    void *ret = 
# 42 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 42 "../crypto/asn1/a_d2i_fp.c"
                   ;
    int len;
...
{
    BUF_MEM *b = 
# 61 "../crypto/asn1/a_d2i_fp.c" 3 4
                ((void *)0)
# 61 "../crypto/asn1/a_d2i_fp.c"
                    ;
    const unsigned char *p;
    void *ret = 
# 63 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 63 "../crypto/asn1/a_d2i_fp.c"
                   ;
    int len;

    if (in == 
# 66 "../crypto/asn1/a_d2i_fp.c" 3 4
             ((void *)0)
# 66 "../crypto/asn1/a_d2i_fp.c"
                 )
        return 
# 67 "../crypto/asn1/a_d2i_fp.c" 3 4
              ((void *)0)
# 67 "../crypto/asn1/a_d2i_fp.c"
                  ;
    len = asn1_d2i_read_bio(in, &b);
    if (len < 0)
        goto err;
...
{
    return ASN1_item_d2i_bio_ex(it, in, x, 
# 81 "../crypto/asn1/a_d2i_fp.c" 3 4
                                          ((void *)0)
# 81 "../crypto/asn1/a_d2i_fp.c"
                                              , 
# 81 "../crypto/asn1/a_d2i_fp.c" 3 4
                                                ((void *)0)
# 81 "../crypto/asn1/a_d2i_fp.c"
                          ...
                          OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 91 "../crypto/asn1/a_d2i_fp.c" 3 4
                                      ((void *)0)
# 91 "../crypto/asn1/a_d2i_fp.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",92,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 92 "../crypto/asn1/a_d2i_fp.c" 3 4
       ((void *)0)
# 92 "../crypto/asn1/a_d2i_fp.c"
       );
        return 
# 93 "../crypto/asn1/a_d2i_fp.c" 3 4
              ((void *)0)
# 93 "../crypto/asn1/a_d2i_fp.c"
                  ;
    }
    BIO_ctrl(b,106,0x00,(char *)(in));
...
void *ASN1_item_d2i_fp(const ASN1_ITEM *it, FILE *in, void *x)
{
    return ASN1_item_d2i_fp_ex(it, in, x, 
# 103 "../crypto/asn1/a_d2i_fp.c" 3 4
                                         ((void *)0)
# 103 "../crypto/asn1/a_d2i_fp.c"
                                             , 
# 103 "../crypto/asn1/a_d2i_fp.c" 3 4
                                               ((void *)0)
# 103 "../crypto/asn1/a_d2i_fp.c"
...
int asn1_d2i_read_bio(BIO *in, BUF_MEM **pb)
{
    ...
    b = BUF_MEM_new();
    if (b == 
# 125 "../crypto/asn1/a_d2i_fp.c" 3 4
            ((void *)0)
# 125 "../crypto/asn1/a_d2i_fp.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",126,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 126 "../crypto/asn1/a_d2i_fp.c" 3 4
       ((void *)0)
# 126 "../crypto/asn1/a_d2i_fp.c"
       );
        return -1;
    }
    ...
    for (;;) {
        ...
        if (want >= diff) {
            ...
            if (len + want < len || !BUF_MEM_grow_clean(b, len + want)) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",137,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 137 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 137 "../crypto/asn1/a_d2i_fp.c"
               );
                goto err;
            }
            i = BIO_read(in, &(b->data[len]), want);
            if (i < 0 && diff == 0) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",142,__func__), ERR_set_error)((13),(142),
# 142 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 142 "../crypto/asn1/a_d2i_fp.c"
               );
                goto err;
            }
            if (i > 0) {
                if (len + i < len) {
                    (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",147,__func__), ERR_set_error)((13),(155),
# 147 "../crypto/asn1/a_d2i_fp.c" 3 4
                   ((void *)0)
# 147 "../crypto/asn1/a_d2i_fp.c"
                   );
                    goto err;
                }
                len += i;
        ...
        if (inf & 1) {
            ...
            if (eos == 
# 177 "../crypto/asn1/a_d2i_fp.c" 3 4
                      (4294967295U)
# 177 "../crypto/asn1/a_d2i_fp.c"
                                ) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",178,__func__), ERR_set_error)((13),(123),
# 178 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 178 "../crypto/asn1/a_d2i_fp.c"
               );
                goto err;
            }
            eos++;
            want = 8;
        } else if (eos && (slen == 0) && (tag == 0)) {
            ...
            if (want > (len - off)) {
                ...
                want -= (len - off);
                if (want > 0x7fffffff 
# 197 "../crypto/asn1/a_d2i_fp.c"
                                                                      ||
                    len + want < len) {
                    (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",199,__func__), ERR_set_error)((13),(155),
# 199 "../crypto/asn1/a_d2i_fp.c" 3 4
                   ((void *)0)
# 199 "../crypto/asn1/a_d2i_fp.c"
                   );
                    goto err;
                }
                while (want > 0) {
                    ...
                    if (!BUF_MEM_grow_clean(b, len + chunk)) {
                        (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",212,__func__), ERR_set_error)((13),((7 | (0x2 << 18L))),
# 212 "../crypto/asn1/a_d2i_fp.c" 3 4
                       ((void *)0)
# 212 "../crypto/asn1/a_d2i_fp.c"
                       );
                        goto err;
                    }
                    want -= chunk;
                    while (chunk > 0) {
                        ...
                        if (i <= 0) {
                            (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",219,__func__), ERR_set_error)((13),(142),
# 219 "../crypto/asn1/a_d2i_fp.c" 3 4
                           ((void *)0)
# 219 "../crypto/asn1/a_d2i_fp.c"
                           );
                            goto err;
                        }
                    ...
                    if (chunk_max < 0x7fffffff
# 229 "../crypto/asn1/a_d2i_fp.c"
                                          /2)
                        chunk_max *= 2;
                }
            }
            if (off + slen < off) {
                (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",234,__func__), ERR_set_error)((13),(155),
# 234 "../crypto/asn1/a_d2i_fp.c" 3 4
               ((void *)0)
# 234 "../crypto/asn1/a_d2i_fp.c"
               );
                goto err;
            }
            off += slen;
    ...
    if (off > 0x7fffffff
# 245 "../crypto/asn1/a_d2i_fp.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/asn1/a_d2i_fp.c",246,__func__), ERR_set_error)((13),(155),
# 246 "../crypto/asn1/a_d2i_fp.c" 3 4
       ((void *)0)
# 246 "../crypto/asn1/a_d2i_fp.c"
       );
        goto err;
    }
