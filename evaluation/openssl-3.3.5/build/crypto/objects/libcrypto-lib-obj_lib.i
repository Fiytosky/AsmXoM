# 0 "../crypto/objects/obj_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/objects/obj_lib.c"
# 10 "../crypto/objects/obj_lib.c"
...
ASN1_OBJECT *OBJ_dup(const ASN1_OBJECT *o)
{
    ...
    if (o == 
# 20 "../crypto/objects/obj_lib.c" 3 4
            ((void *)0)
# 20 "../crypto/objects/obj_lib.c"
                )
        return 
# 21 "../crypto/objects/obj_lib.c" 3 4
              ((void *)0)
# 21 "../crypto/objects/obj_lib.c"
                  ;
    ...
    r = ASN1_OBJECT_new();
    if (r == 
# 27 "../crypto/objects/obj_lib.c" 3 4
            ((void *)0)
# 27 "../crypto/objects/obj_lib.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/objects/obj_lib.c",28,__func__), ERR_set_error)((8),((13 | (0x2 << 18L))),
# 28 "../crypto/objects/obj_lib.c" 3 4
       ((void *)0)
# 28 "../crypto/objects/obj_lib.c"
       );
        return 
# 29 "../crypto/objects/obj_lib.c" 3 4
              ((void *)0)
# 29 "../crypto/objects/obj_lib.c"
                  ;
    }
    ...
    if (o->length > 0 && (r->data = CRYPTO_memdup((o->data), o->length, "../crypto/objects/obj_lib.c", 38)) == 
# 38 "../crypto/objects/obj_lib.c" 3 4
                                                                          ((void *)0)
# 38 "../crypto/objects/obj_lib.c"
                                                                              )
        goto err;
    ...
    if (o->ln != 
# 44 "../crypto/objects/obj_lib.c" 3 4
                ((void *)0) 
# 44 "../crypto/objects/obj_lib.c"
                     && (r->ln = CRYPTO_strdup(o->ln, "../crypto/objects/obj_lib.c", 44)) == 
# 44 "../crypto/objects/obj_lib.c" 3 4
                                                           ((void *)0)
# 44 "../crypto/objects/obj_lib.c"
                                                               )
    ...
    if (o->sn != 
# 47 "../crypto/objects/obj_lib.c" 3 4
                ((void *)0) 
# 47 "../crypto/objects/obj_lib.c"
                     && (r->sn = CRYPTO_strdup(o->sn, "../crypto/objects/obj_lib.c", 47)) == 
# 47 "../crypto/objects/obj_lib.c" 3 4
                                                           ((void *)0)
# 47 "../crypto/objects/obj_lib.c"
                                                               )
 ...
 err:
    ASN1_OBJECT_free(r);
    return 
# 53 "../crypto/objects/obj_lib.c" 3 4
          ((void *)0)
# 53 "../crypto/objects/obj_lib.c"
              ;
}
