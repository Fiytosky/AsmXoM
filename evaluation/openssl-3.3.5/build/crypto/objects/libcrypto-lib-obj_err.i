# 0 "../crypto/objects/obj_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/objects/obj_err.c"
# 11 "../crypto/objects/obj_err.c"
...
# 14 "../crypto/objects/obj_err.c" 2



static const ERR_STRING_DATA OBJ_str_reasons[] = {
    {( (((unsigned long)(8) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "oid exists"},
    {( (((unsigned long)(8) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "unknown nid"},
    {( (((unsigned long)(8) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "unknown object name"},
    {0, 
# 22 "../crypto/objects/obj_err.c" 3 4
       ((void *)0)
# 22 "../crypto/objects/obj_err.c"
           }
};
...
int ossl_err_load_OBJ_strings(void)
{
    ...
    if (ERR_reason_error_string(OBJ_str_reasons[0].error) == 
# 30 "../crypto/objects/obj_err.c" 3 4
                                                            ((void *)0)
# 30 "../crypto/objects/obj_err.c"
                                                                )
