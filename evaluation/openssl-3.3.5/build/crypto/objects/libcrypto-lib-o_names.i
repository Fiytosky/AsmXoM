# 0 "../crypto/objects/o_names.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/objects/o_names.c"
# 10 "../crypto/objects/o_names.c"
...
# 17 "../crypto/objects/o_names.c" 2


# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 20 "../crypto/objects/o_names.c" 2
# 1 "../include/crypto/lhash.h" 1
# 12 "../include/crypto/lhash.h"
        

unsigned long ossl_lh_strcasehash(const char *);
# 21 "../crypto/objects/o_names.c" 2
# 1 "../crypto/objects/obj_local.h" 1
# 10 "../crypto/objects/obj_local.h"
typedef struct name_funcs_st NAME_FUNCS;
struct stack_st_NAME_FUNCS; typedef int (*sk_NAME_FUNCS_compfunc)(const NAME_FUNCS * const *a, const NAME_FUNCS *const *b); typedef void (*sk_NAME_FUNCS_freefunc)(NAME_FUNCS *a); typedef NAME_FUNCS * (*sk_NAME_FUNCS_copyfunc)(const NAME_FUNCS *a); static __attribute__((unused)) inline int sk_NAME_FUNCS_num(const struct stack_st_NAME_FUNCS *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_value(const struct stack_st_NAME_FUNCS *sk, int idx) { return (NAME_FUNCS *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_new(sk_NAME_FUNCS_compfunc compare) { return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_new_null(void) { return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_new_reserve(sk_NAME_FUNCS_compfunc compare, int n) { return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_NAME_FUNCS_reserve(struct stack_st_NAME_FUNCS *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_NAME_FUNCS_free(struct stack_st_NAME_FUNCS *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_NAME_FUNCS_zero(struct stack_st_NAME_FUNCS *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_delete(struct stack_st_NAME_FUNCS *sk, int i) { return (NAME_FUNCS *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_delete_ptr(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr) { return (NAME_FUNCS *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_NAME_FUNCS_push(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_NAME_FUNCS_unshift(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_pop(struct stack_st_NAME_FUNCS *sk) { return (NAME_FUNCS *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_shift(struct stack_st_NAME_FUNCS *sk) { return (NAME_FUNCS *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_NAME_FUNCS_pop_free(struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_NAME_FUNCS_insert(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline NAME_FUNCS *sk_NAME_FUNCS_set(struct stack_st_NAME_FUNCS *sk, int idx, NAME_FUNCS *ptr) { return (NAME_FUNCS *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_NAME_FUNCS_find(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_NAME_FUNCS_find_ex(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_NAME_FUNCS_find_all(struct stack_st_NAME_FUNCS *sk, NAME_FUNCS *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_NAME_FUNCS_sort(struct stack_st_NAME_FUNCS *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_NAME_FUNCS_is_sorted(const struct stack_st_NAME_FUNCS *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_NAME_FUNCS * sk_NAME_FUNCS_dup(const struct stack_st_NAME_FUNCS *sk) { return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_NAME_FUNCS *sk_NAME_FUNCS_deep_copy(const struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_copyfunc copyfunc, sk_NAME_FUNCS_freefunc freefunc) { return (struct stack_st_NAME_FUNCS *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_NAME_FUNCS_compfunc sk_NAME_FUNCS_set_cmp_func(struct stack_st_NAME_FUNCS *sk, sk_NAME_FUNCS_compfunc compare) { return (sk_NAME_FUNCS_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct lhash_st_OBJ_NAME { union lh_OBJ_NAME_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_OBJ_NAME_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const OBJ_NAME *) = (unsigned long (*)(const OBJ_NAME *))hfn; return hfn_conv((const OBJ_NAME *)data); } static int lh_OBJ_NAME_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const OBJ_NAME *, const OBJ_NAME *) = (int (*)(const OBJ_NAME *, const OBJ_NAME *))cfn; return cfn_conv((const OBJ_NAME *)da, (const OBJ_NAME *)db); } static __attribute__((unused)) inline void lh_OBJ_NAME_free(struct lhash_st_OBJ_NAME *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_OBJ_NAME_flush(struct lhash_st_OBJ_NAME *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline OBJ_NAME * lh_OBJ_NAME_insert(struct lhash_st_OBJ_NAME *lh, OBJ_NAME *d) { return (OBJ_NAME *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline OBJ_NAME * lh_OBJ_NAME_delete(struct lhash_st_OBJ_NAME *lh, const OBJ_NAME *d) { return (OBJ_NAME *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline OBJ_NAME * lh_OBJ_NAME_retrieve(struct lhash_st_OBJ_NAME *lh, const OBJ_NAME *d) { return (OBJ_NAME *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_OBJ_NAME_error(struct lhash_st_OBJ_NAME *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_OBJ_NAME_num_items(struct lhash_st_OBJ_NAME *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_OBJ_NAME_get_down_load(struct lhash_st_OBJ_NAME *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_OBJ_NAME_set_down_load(struct lhash_st_OBJ_NAME *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_OBJ_NAME_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(OBJ_NAME *) = (void (*)(OBJ_NAME *))doall; doall_conv((OBJ_NAME *)node); } static __attribute__((unused)) inline void lh_OBJ_NAME_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(OBJ_NAME *, void *) = (void (*)(OBJ_NAME *, void *))doall; doall_conv((OBJ_NAME *)node, arg); } static __attribute__((unused)) inline void lh_OBJ_NAME_doall(struct lhash_st_OBJ_NAME *lh, void (*doall)(OBJ_NAME *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_OBJ_NAME * lh_OBJ_NAME_new(unsigned long (*hfn)(const OBJ_NAME *), int (*cfn)(const OBJ_NAME *, const OBJ_NAME *)) { return (struct lhash_st_OBJ_NAME *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_OBJ_NAME_hfn_thunk, lh_OBJ_NAME_cfn_thunk, lh_OBJ_NAME_doall_thunk, lh_OBJ_NAME_doall_arg_thunk); } static __attribute__((unused)) inline void lh_OBJ_NAME_doall_arg(struct lhash_st_OBJ_NAME *lh, void (*doallarg)(OBJ_NAME *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_OBJ_NAME;
typedef struct added_obj_st ADDED_OBJ;
struct lhash_st_ADDED_OBJ { union lh_ADDED_OBJ_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_ADDED_OBJ_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const ADDED_OBJ *) = (unsigned long (*)(const ADDED_OBJ *))hfn; return hfn_conv((const ADDED_OBJ *)data); } static int lh_ADDED_OBJ_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const ADDED_OBJ *, const ADDED_OBJ *) = (int (*)(const ADDED_OBJ *, const ADDED_OBJ *))cfn; return cfn_conv((const ADDED_OBJ *)da, (const ADDED_OBJ *)db); } static __attribute__((unused)) inline void lh_ADDED_OBJ_free(struct lhash_st_ADDED_OBJ *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_ADDED_OBJ_flush(struct lhash_st_ADDED_OBJ *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline ADDED_OBJ * lh_ADDED_OBJ_insert(struct lhash_st_ADDED_OBJ *lh, ADDED_OBJ *d) { return (ADDED_OBJ *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline ADDED_OBJ * lh_ADDED_OBJ_delete(struct lhash_st_ADDED_OBJ *lh, const ADDED_OBJ *d) { return (ADDED_OBJ *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline ADDED_OBJ * lh_ADDED_OBJ_retrieve(struct lhash_st_ADDED_OBJ *lh, const ADDED_OBJ *d) { return (ADDED_OBJ *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_ADDED_OBJ_error(struct lhash_st_ADDED_OBJ *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_ADDED_OBJ_num_items(struct lhash_st_ADDED_OBJ *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_ADDED_OBJ_get_down_load(struct lhash_st_ADDED_OBJ *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_ADDED_OBJ_set_down_load(struct lhash_st_ADDED_OBJ *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_ADDED_OBJ_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(ADDED_OBJ *) = (void (*)(ADDED_OBJ *))doall; doall_conv((ADDED_OBJ *)node); } static __attribute__((unused)) inline void lh_ADDED_OBJ_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(ADDED_OBJ *, void *) = (void (*)(ADDED_OBJ *, void *))doall; doall_conv((ADDED_OBJ *)node, arg); } static __attribute__((unused)) inline void lh_ADDED_OBJ_doall(struct lhash_st_ADDED_OBJ *lh, void (*doall)(ADDED_OBJ *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_ADDED_OBJ * lh_ADDED_OBJ_new(unsigned long (*hfn)(const ADDED_OBJ *), int (*cfn)(const ADDED_OBJ *, const ADDED_OBJ *)) { return (struct lhash_st_ADDED_OBJ *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_ADDED_OBJ_hfn_thunk, lh_ADDED_OBJ_cfn_thunk, lh_ADDED_OBJ_doall_thunk, lh_ADDED_OBJ_doall_arg_thunk); } static __attribute__((unused)) inline void lh_ADDED_OBJ_doall_arg(struct lhash_st_ADDED_OBJ *lh, void (*doallarg)(ADDED_OBJ *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_ADDED_OBJ;
# 22 "../crypto/objects/o_names.c" 2
...
# 28 "../crypto/objects/o_names.c"
static struct lhash_st_OBJ_NAME *names_lh = 
# 28 "../crypto/objects/o_names.c" 3 4
                                     ((void *)0)
# 28 "../crypto/objects/o_names.c"
                                         ;
static int names_type_num = 0x07;
static CRYPTO_RWLOCK *obj_lock = 
# 30 "../crypto/objects/o_names.c" 3 4
                                ((void *)0)
# 30 "../crypto/objects/o_names.c"
                                    ;
...
static CRYPTO_ONCE init = 
# 49 "../crypto/objects/o_names.c" 3 4
                         0
# 49 "../crypto/objects/o_names.c"
                                                ;
static int o_names_init(void); static int o_names_init_ossl_ret_ = 0; static void o_names_init_ossl_(void) { o_names_init_ossl_ret_ = o_names_init(); } static int o_names_init(void)
{
    names_lh = 
# 52 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 52 "../crypto/objects/o_names.c"
                  ;
    obj_lock = CRYPTO_THREAD_lock_new();
    if (obj_lock != 
# 54 "../crypto/objects/o_names.c" 3 4
                   ((void *)0)
# 54 "../crypto/objects/o_names.c"
                       )
        names_lh = lh_OBJ_NAME_new(obj_name_hash, obj_name_cmp);
    if (names_lh == 
# 56 "../crypto/objects/o_names.c" 3 4
                   ((void *)0)
# 56 "../crypto/objects/o_names.c"
                       ) {
        CRYPTO_THREAD_lock_free(obj_lock);
        obj_lock = 
# 58 "../crypto/objects/o_names.c" 3 4
                  ((void *)0)
# 58 "../crypto/objects/o_names.c"
                      ;
    }
    return names_lh != 
# 60 "../crypto/objects/o_names.c" 3 4
                      ((void *)0) 
# 60 "../crypto/objects/o_names.c"
                           && obj_lock != 
# 60 "../crypto/objects/o_names.c" 3 4
                                          ((void *)0)
# 60 "../crypto/objects/o_names.c"
...
int OBJ_NAME_init(void)
{
    return (CRYPTO_THREAD_run_once(&init, o_names_init_ossl_) ? o_names_init_ossl_ret_ : 0);
}
                       ...
                       void (*free_func) (const char *, int, const char *))
{
    ...
    if (name_funcs_stack == 
# 81 "../crypto/objects/o_names.c" 3 4
                           ((void *)0)
# 81 "../crypto/objects/o_names.c"
                               )
        name_funcs_stack = sk_NAME_FUNCS_new_null();
    if (name_funcs_stack == 
# 83 "../crypto/objects/o_names.c" 3 4
                           ((void *)0)
# 83 "../crypto/objects/o_names.c"
                               ) {
    ...
    for (i = sk_NAME_FUNCS_num(name_funcs_stack); i < names_type_num; i++) {
        name_funcs = CRYPTO_zalloc(sizeof(*name_funcs), "../crypto/objects/o_names.c", 90);
        if (name_funcs == 
# 91 "../crypto/objects/o_names.c" 3 4
                         ((void *)0)
# 91 "../crypto/objects/o_names.c"
                             ) {
            ret = 0;
            goto out;
        }
        ...
        if (!push) {
            (ERR_new(), ERR_set_debug("../crypto/objects/o_names.c",100,__func__), ERR_set_error)((8),((15 | (0x2 << 18L))),
# 100 "../crypto/objects/o_names.c" 3 4
           ((void *)0)
# 100 "../crypto/objects/o_names.c"
           );
            CRYPTO_free(name_funcs, "../crypto/objects/o_names.c", 101);
            ret = 0;
            goto out;
        }
    }
    ...
    if (hash_func != 
# 107 "../crypto/objects/o_names.c" 3 4
                    ((void *)0)
# 107 "../crypto/objects/o_names.c"
                        )
        name_funcs->hash_func = hash_func;
    if (cmp_func != 
# 109 "../crypto/objects/o_names.c" 3 4
                   ((void *)0)
# 109 "../crypto/objects/o_names.c"
                       )
        name_funcs->cmp_func = cmp_func;
    if (free_func != 
# 111 "../crypto/objects/o_names.c" 3 4
                    ((void *)0)
# 111 "../crypto/objects/o_names.c"
                        )
...
static int obj_name_cmp(const OBJ_NAME *a, const OBJ_NAME *b)
{
    ...
    if (ret == 0) {
        if ((name_funcs_stack != 
# 125 "../crypto/objects/o_names.c" 3 4
                                ((void *)0)
# 125 "../crypto/objects/o_names.c"
                                    )
...
static unsigned long obj_name_hash(const OBJ_NAME *a)
{
    ...
    if ((name_funcs_stack != 
# 139 "../crypto/objects/o_names.c" 3 4
                            ((void *)0)
# 139 "../crypto/objects/o_names.c"
                                )
        && (sk_NAME_FUNCS_num(name_funcs_stack) > a->type)) {
        ret =
...
const char *OBJ_NAME_get(const char *name, int type)
{
    ...
    int num = 0, alias;
    const char *value = 
# 155 "../crypto/objects/o_names.c" 3 4
                       ((void *)0)
# 155 "../crypto/objects/o_names.c"
                           ;

    if (name == 
# 157 "../crypto/objects/o_names.c" 3 4
               ((void *)0)
# 157 "../crypto/objects/o_names.c"
                   )
        return 
# 158 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 158 "../crypto/objects/o_names.c"
                  ;
    if (!OBJ_NAME_init())
        return 
# 160 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 160 "../crypto/objects/o_names.c"
                  ;
    if (!CRYPTO_THREAD_read_lock(obj_lock))
        return 
# 162 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 162 "../crypto/objects/o_names.c"
                  ;
    ...
    for (;;) {
        ...
        if (ret == 
# 172 "../crypto/objects/o_names.c" 3 4
                  ((void *)0)
# 172 "../crypto/objects/o_names.c"
                      )
            break;
        if ((ret->alias) && !alias) {
            if (++num > 10)
...
int OBJ_NAME_add(const char *name, int type, const char *data)
{
    ...
    onp = CRYPTO_malloc(sizeof(*onp), "../crypto/objects/o_names.c", 199);
    if (onp == 
# 200 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 200 "../crypto/objects/o_names.c"
                  )
        return 0;
    ...
    if (!CRYPTO_THREAD_write_lock(obj_lock)) {
        CRYPTO_free(onp, "../crypto/objects/o_names.c", 209);
        return 0;
    }

    ret = lh_OBJ_NAME_insert(names_lh, onp);
    if (ret != 
# 214 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 214 "../crypto/objects/o_names.c"
                  ) {

        if ((name_funcs_stack != 
# 216 "../crypto/objects/o_names.c" 3 4
                                ((void *)0)
# 216 "../crypto/objects/o_names.c"
                                    )
        ...
        CRYPTO_free(ret, "../crypto/objects/o_names.c", 226);
    } else {
        if (lh_OBJ_NAME_error(names_lh)) {

            CRYPTO_free(onp, "../crypto/objects/o_names.c", 230);
            goto unlock;
        }
    }
...
int OBJ_NAME_remove(const char *name, int type)
{
    ...
    if (ret != 
# 257 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 257 "../crypto/objects/o_names.c"
                  ) {

        if ((name_funcs_stack != 
# 259 "../crypto/objects/o_names.c" 3 4
                                ((void *)0)
# 259 "../crypto/objects/o_names.c"
                                    )
            && (sk_NAME_FUNCS_num(name_funcs_stack) > ret->type)) {
        ...
        CRYPTO_free(ret, "../crypto/objects/o_names.c", 269);
        ok = 1;
    }
...
static __attribute__((unused)) inline void lh_OBJ_NAME_doall_OBJ_DOALL_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const OBJ_NAME *, OBJ_DOALL *) = (void (*)(const OBJ_NAME *, OBJ_DOALL *))fn; fn_conv((const OBJ_NAME *)node, (OBJ_DOALL *)arg); } static __attribute__((unused)) inline void lh_OBJ_NAME_doall_OBJ_DOALL(struct lhash_st_OBJ_NAME *lh, void (*fn)(const OBJ_NAME *, OBJ_DOALL *), OBJ_DOALL *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_OBJ_NAME_doall_OBJ_DOALL_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_OBJ_NAME;
                            ...
                            void *arg)
{
    ...
    d.type = type;
    d.names =
        CRYPTO_malloc(sizeof(*d.names) * lh_OBJ_NAME_num_items(names_lh), "../crypto/objects/o_names.c", 336);

    if (d.names != 
# 338 "../crypto/objects/o_names.c" 3 4
                  ((void *)0)
# 338 "../crypto/objects/o_names.c"
                      ) {
        d.n = 0;
        ...
        CRYPTO_free((void *)d.names, "../crypto/objects/o_names.c", 347);
    }
}
...
{
    if (onp == 
# 355 "../crypto/objects/o_names.c" 3 4
              ((void *)0)
# 355 "../crypto/objects/o_names.c"
                  )
        return;
...
{
    CRYPTO_free(ptr, "../crypto/objects/o_names.c", 364);
}
...
void OBJ_NAME_cleanup(int type)
{
    ...
    if (names_lh == 
# 371 "../crypto/objects/o_names.c" 3 4
                   ((void *)0)
# 371 "../crypto/objects/o_names.c"
                       )
        return;
    ...
    if (type < 0) {
        ...
        CRYPTO_THREAD_lock_free(obj_lock);
        names_lh = 
# 383 "../crypto/objects/o_names.c" 3 4
                  ((void *)0)
# 383 "../crypto/objects/o_names.c"
                      ;
        name_funcs_stack = 
# 384 "../crypto/objects/o_names.c" 3 4
                          ((void *)0)
# 384 "../crypto/objects/o_names.c"
                              ;
        obj_lock = 
# 385 "../crypto/objects/o_names.c" 3 4
                  ((void *)0)
# 385 "../crypto/objects/o_names.c"
                      ;
    } else
