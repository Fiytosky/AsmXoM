# 0 "../crypto/dh/dh_pmeth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_pmeth.c"
# 14 "../crypto/dh/dh_pmeth.c"
...
# 20 "../crypto/dh/dh_pmeth.c" 2

# 1 "../crypto/dh/dh_local.h" 1
# 11 "../crypto/dh/dh_local.h"
...
static int pkey_dh_init(EVP_PKEY_CTX *ctx)
{
    ...
    if ((dctx = CRYPTO_zalloc(sizeof(*dctx), "../crypto/dh/dh_pmeth.c", 58)) == 
# 58 "../crypto/dh/dh_pmeth.c" 3 4
                                                 ((void *)0)
# 58 "../crypto/dh/dh_pmeth.c"
                                                     )
        return 0;
    dctx->prime_len = 2048;
    dctx->subprime_len = -1;
...
static void pkey_dh_cleanup(EVP_PKEY_CTX *ctx)
{
    ...
    if (dctx != 
# 76 "../crypto/dh/dh_pmeth.c" 3 4
               ((void *)0)
# 76 "../crypto/dh/dh_pmeth.c"
                   ) {
        CRYPTO_free(dctx->kdf_ukm, "../crypto/dh/dh_pmeth.c", 77);
        ASN1_OBJECT_free(dctx->kdf_oid);
        CRYPTO_free(dctx, "../crypto/dh/dh_pmeth.c", 79);
    }
}
...
static int pkey_dh_copy(EVP_PKEY_CTX *dst, const EVP_PKEY_CTX *src)
{
    ...
    if (dctx->kdf_oid == 
# 102 "../crypto/dh/dh_pmeth.c" 3 4
                        ((void *)0)
# 102 "../crypto/dh/dh_pmeth.c"
                            )
        return 0;
    dctx->kdf_md = sctx->kdf_md;
    if (sctx->kdf_ukm != 
# 105 "../crypto/dh/dh_pmeth.c" 3 4
                        ((void *)0)
# 105 "../crypto/dh/dh_pmeth.c"
                            ) {
        dctx->kdf_ukm = CRYPTO_memdup((sctx->kdf_ukm), sctx->kdf_ukmlen, "../crypto/dh/dh_pmeth.c", 106);
        if (dctx->kdf_ukm == 
# 107 "../crypto/dh/dh_pmeth.c" 3 4
                            ((void *)0)
# 107 "../crypto/dh/dh_pmeth.c"
                                )
          return 0;
...
static int pkey_dh_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2)
{
    ...
    case (0x1000 + 3):
        if (p1 < 1 || p1 > 3 || dctx->param_nid != 0)
            return -2;
        dctx->param_nid = p1;
        return 1;

    case (0x1000 + 15):
        if (p1 <= 0 || dctx->param_nid != 0)
            return -2;
        dctx->param_nid = p1;
        return 1;
    ...
    case (0x1000 + 11):
        CRYPTO_free(dctx->kdf_ukm, "../crypto/dh/dh_pmeth.c", 195);
        dctx->kdf_ukm = p2;
        if (p2)
            dctx->kdf_ukmlen = p1;
        else
                            ...
                            const char *type, const char *value)
{
    ...
    if (strcmp(type, "dh_param") == 0) {
        ...
        if (nid == 0) {
            (ERR_new(), ERR_set_debug("../crypto/dh/dh_pmeth.c",245,__func__), ERR_set_error)((5),(110),
# 245 "../crypto/dh/dh_pmeth.c" 3 4
           ((void *)0)
# 245 "../crypto/dh/dh_pmeth.c"
           );
            return -2;
        }
        dctx->param_nid = nid;
                               ...
                               BN_GENCB *pcb)
{
    ...
    if (dctx->paramgen_type > 2)
        return 
# 284 "../crypto/dh/dh_pmeth.c" 3 4
              ((void *)0)
# 284 "../crypto/dh/dh_pmeth.c"
                  ;
    ret = DH_new();
    if (ret == 
# 286 "../crypto/dh/dh_pmeth.c" 3 4
              ((void *)0)
# 286 "../crypto/dh/dh_pmeth.c"
                  )
        return 
# 287 "../crypto/dh/dh_pmeth.c" 3 4
              ((void *)0)
# 287 "../crypto/dh/dh_pmeth.c"
                  ;
    ...
    if (dctx->md != 
# 296 "../crypto/dh/dh_pmeth.c" 3 4
                   ((void *)0)
# 296 "../crypto/dh/dh_pmeth.c"
                       )
        ossl_ffc_set_digest(&ret->params, EVP_MD_get0_name(dctx->md), 
# 297 "../crypto/dh/dh_pmeth.c" 3 4
                                                                     ((void *)0)
# 297 "../crypto/dh/dh_pmeth.c"
                                                                         );


    if (dctx->paramgen_type == 1)
    ...
    if (rv <= 0) {
        DH_free(ret);
        return 
# 315 "../crypto/dh/dh_pmeth.c" 3 4
              ((void *)0)
# 315 "../crypto/dh/dh_pmeth.c"
                  ;
    }
    return ret;
}
...
{
    DH *dh = 
# 323 "../crypto/dh/dh_pmeth.c" 3 4
            ((void *)0)
# 323 "../crypto/dh/dh_pmeth.c"
                ;
    DH_PKEY_CTX *dctx = ctx->data;
    BN_GENCB *pcb = 
# 325 "../crypto/dh/dh_pmeth.c" 3 4
                   ((void *)0)
# 325 "../crypto/dh/dh_pmeth.c"
                       ;
    int ret;
    ...
    if (dctx->param_nid != 0) {
        int type = dctx->param_nid <= 3 ? 920 : 28;

        if ((dh = DH_new_by_nid(dctx->param_nid)) == 
# 336 "../crypto/dh/dh_pmeth.c" 3 4
                                                    ((void *)0)
# 336 "../crypto/dh/dh_pmeth.c"
                                                        )
            return 0;
    ...
    if (ctx->pkey_gencb != 
# 342 "../crypto/dh/dh_pmeth.c" 3 4
                          ((void *)0)
# 342 "../crypto/dh/dh_pmeth.c"
                              ) {
        pcb = BN_GENCB_new();
        if (pcb == 
# 344 "../crypto/dh/dh_pmeth.c" 3 4
                  ((void *)0)
# 344 "../crypto/dh/dh_pmeth.c"
                      )
            return 0;
    ...
    if (dctx->paramgen_type >= 1) {
        dh = ffc_params_generate(
# 352 "../crypto/dh/dh_pmeth.c" 3 4
                                ((void *)0)
# 352 "../crypto/dh/dh_pmeth.c"
                                    , dctx, pcb);
        BN_GENCB_free(pcb);
        if (dh == 
# 354 "../crypto/dh/dh_pmeth.c" 3 4
                 ((void *)0)
# 354 "../crypto/dh/dh_pmeth.c"
                     )
            return 0;
        EVP_PKEY_assign(pkey, 920, dh);
        return 1;
    }
    dh = DH_new();
    if (dh == 
# 360 "../crypto/dh/dh_pmeth.c" 3 4
             ((void *)0)
# 360 "../crypto/dh/dh_pmeth.c"
                 ) {
        BN_GENCB_free(pcb);
        return 0;
    }
...
static int pkey_dh_keygen(EVP_PKEY_CTX *ctx, EVP_PKEY *pkey)
{
    DH_PKEY_CTX *dctx = ctx->data;
    DH *dh = 
# 377 "../crypto/dh/dh_pmeth.c" 3 4
            ((void *)0)
# 377 "../crypto/dh/dh_pmeth.c"
                ;

    if (ctx->pkey == 
# 379 "../crypto/dh/dh_pmeth.c" 3 4
                    ((void *)0) 
# 379 "../crypto/dh/dh_pmeth.c"
                         && dctx->param_nid == 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_pmeth.c",380,__func__), ERR_set_error)((5),(107),
# 380 "../crypto/dh/dh_pmeth.c" 3 4
       ((void *)0)
# 380 "../crypto/dh/dh_pmeth.c"
       );
        return 0;
    }
    if (dctx->param_nid != 0)
        ...
        dh = DH_new();
    if (dh == 
# 387 "../crypto/dh/dh_pmeth.c" 3 4
             ((void *)0)
# 387 "../crypto/dh/dh_pmeth.c"
                 )
        return 0;
    EVP_PKEY_assign(pkey, ctx->pmeth->pkey_id, dh);

    if (ctx->pkey != 
# 391 "../crypto/dh/dh_pmeth.c" 3 4
                    ((void *)0) 
# 391 "../crypto/dh/dh_pmeth.c"
                          ...
                          size_t *keylen)
{
    ...
    if (ctx->pkey == 
# 405 "../crypto/dh/dh_pmeth.c" 3 4
                    ((void *)0) 
# 405 "../crypto/dh/dh_pmeth.c"
                         || ctx->peerkey == 
# 405 "../crypto/dh/dh_pmeth.c" 3 4
                                            ((void *)0)
# 405 "../crypto/dh/dh_pmeth.c"
                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_pmeth.c",406,__func__), ERR_set_error)((5),(108),
# 406 "../crypto/dh/dh_pmeth.c" 3 4
       ((void *)0)
# 406 "../crypto/dh/dh_pmeth.c"
       );
        return 0;
    }
    ...
    if (dhpub == 
# 411 "../crypto/dh/dh_pmeth.c" 3 4
                ((void *)0) 
# 411 "../crypto/dh/dh_pmeth.c"
                     || dh == 
# 411 "../crypto/dh/dh_pmeth.c" 3 4
                              ((void *)0)
# 411 "../crypto/dh/dh_pmeth.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_pmeth.c",412,__func__), ERR_set_error)((5),(108),
# 412 "../crypto/dh/dh_pmeth.c" 3 4
       ((void *)0)
# 412 "../crypto/dh/dh_pmeth.c"
       );
        return 0;
    }
    ...
    if (dctx->kdf_type == 1) {
        if (key == 
# 417 "../crypto/dh/dh_pmeth.c" 3 4
                  ((void *)0)
# 417 "../crypto/dh/dh_pmeth.c"
                      ) {
            *keylen = DH_size(dh);
            return 1;
        }
    ...
    else if (dctx->kdf_type == 2) {

        unsigned char *Z = 
# 432 "../crypto/dh/dh_pmeth.c" 3 4
                          ((void *)0)
# 432 "../crypto/dh/dh_pmeth.c"
                              ;
        int Zlen = 0;
        ...
        if (!dctx->kdf_outlen || !dctx->kdf_oid)
            return 0;
        if (key == 
# 437 "../crypto/dh/dh_pmeth.c" 3 4
                  ((void *)0)
# 437 "../crypto/dh/dh_pmeth.c"
                      ) {
        ...
        if ((Zlen = DH_size(dh)) <= 0)
            return 0;
        if ((Z = CRYPTO_malloc(Zlen, "../crypto/dh/dh_pmeth.c", 446)) == 
# 446 "../crypto/dh/dh_pmeth.c" 3 4
                                         ((void *)0)
# 446 "../crypto/dh/dh_pmeth.c"
                                             )
            return 0;
        ...
        *keylen = dctx->kdf_outlen;
        ret = 1;
 err:
        CRYPTO_clear_free(Z, Zlen, "../crypto/dh/dh_pmeth.c", 456);
        return ret;
    }
    return 0;
}
