# 0 "../crypto/dh/dh_check.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_check.c"
# 14 "../crypto/dh/dh_check.c"
...
int DH_check_params_ex(const DH *dh)
{
    ...
    if ((errflags & 0x01) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",36,__func__), ERR_set_error)((5),(117),
# 36 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 36 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x08) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",38,__func__), ERR_set_error)((5),(120),
# 38 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 38 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x80) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",40,__func__), ERR_set_error)((5),(126),
# 40 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 40 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x100) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",42,__func__), ERR_set_error)((5),(103),
# 42 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 42 "../crypto/dh/dh_check.c"
       );

    return errflags == 0;
}
# 69 "../crypto/dh/dh_check.c"
int DH_check_params(const DH *dh, int *ret)
{
    int ok = 0;
    BIGNUM *tmp = 
# 72 "../crypto/dh/dh_check.c" 3 4
                 ((void *)0)
# 72 "../crypto/dh/dh_check.c"
                     ;
    BN_CTX *ctx = 
# 73 "../crypto/dh/dh_check.c" 3 4
                 ((void *)0)
# 73 "../crypto/dh/dh_check.c"
                     ;

    *ret = 0;
    ctx = BN_CTX_new_ex(dh->libctx);
    if (ctx == 
# 77 "../crypto/dh/dh_check.c" 3 4
              ((void *)0)
# 77 "../crypto/dh/dh_check.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 81 "../crypto/dh/dh_check.c" 3 4
              ((void *)0)
# 81 "../crypto/dh/dh_check.c"
                  )
        goto err;
    ...
    if (BN_is_negative(dh->params.g)
        ...
        *ret |= 0x08;
    if (BN_copy(tmp, dh->params.p) == 
# 90 "../crypto/dh/dh_check.c" 3 4
                                     ((void *)0) 
# 90 "../crypto/dh/dh_check.c"
                                          || !BN_sub_word(tmp, 1))
        goto err;
...
int DH_check_ex(const DH *dh)
{
    ...
    if ((errflags & 0x08) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",119,__func__), ERR_set_error)((5),(120),
# 119 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 119 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x10) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",121,__func__), ERR_set_error)((5),(119),
# 121 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 121 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x20) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",123,__func__), ERR_set_error)((5),(116),
# 123 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 123 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x40) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",125,__func__), ERR_set_error)((5),(115),
# 125 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 125 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x04) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",127,__func__), ERR_set_error)((5),(121),
# 127 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 127 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x01) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",129,__func__), ERR_set_error)((5),(117),
# 129 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 129 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x02) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",131,__func__), ERR_set_error)((5),(118),
# 131 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 131 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x80) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",133,__func__), ERR_set_error)((5),(126),
# 133 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 133 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x100) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",135,__func__), ERR_set_error)((5),(103),
# 135 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 135 "../crypto/dh/dh_check.c"
       );
...
int DH_check(const DH *dh, int *ret)
{
    ...
    int ok = 0, r, q_good = 0;
    BN_CTX *ctx = 
# 147 "../crypto/dh/dh_check.c" 3 4
                 ((void *)0)
# 147 "../crypto/dh/dh_check.c"
                     ;
    BIGNUM *t1 = 
# 148 "../crypto/dh/dh_check.c" 3 4
                ((void *)0)
# 148 "../crypto/dh/dh_check.c"
                    , *t2 = 
# 148 "../crypto/dh/dh_check.c" 3 4
                            ((void *)0)
# 148 "../crypto/dh/dh_check.c"
    ...
    *ret = 0;
    ...
    if (BN_num_bits(dh->params.p) > 32768) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",157,__func__), ERR_set_error)((5),(103),
# 157 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 157 "../crypto/dh/dh_check.c"
       );
        *ret = 0x100 | 0x01;
        return 0;
    }
    ...
    ctx = BN_CTX_new_ex(dh->libctx);
    if (ctx == 
# 166 "../crypto/dh/dh_check.c" 3 4
              ((void *)0)
# 166 "../crypto/dh/dh_check.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    t1 = BN_CTX_get(ctx);
    t2 = BN_CTX_get(ctx);
    if (t2 == 
# 171 "../crypto/dh/dh_check.c" 3 4
             ((void *)0)
# 171 "../crypto/dh/dh_check.c"
                 )
        goto err;

    if (dh->params.q != 
# 174 "../crypto/dh/dh_check.c" 3 4
                       ((void *)0)
# 174 "../crypto/dh/dh_check.c"
                           ) {
    ...
    if (q_good) {
        ...
        r = BN_check_prime(dh->params.q, ctx, 
# 193 "../crypto/dh/dh_check.c" 3 4
                                             ((void *)0)
# 193 "../crypto/dh/dh_check.c"
                                                 );
        if (r < 0)
            goto err;
        if (!r)
        ...
        if (!BN_is_one(t2))
            *ret |= 0x20;
        if (dh->params.j != 
# 203 "../crypto/dh/dh_check.c" 3 4
                           ((void *)0)
            
# 204 "../crypto/dh/dh_check.c"
           && BN_cmp(dh->params.j, t1))
            *ret |= 0x40;
    }

    r = BN_check_prime(dh->params.p, ctx, 
# 208 "../crypto/dh/dh_check.c" 3 4
                                         ((void *)0)
# 208 "../crypto/dh/dh_check.c"
                                             );
    if (r < 0)
        goto err;
    if (!r)
...
# 213 "../crypto/dh/dh_check.c" 3 4
                            ((void *)0)
# 213 "../crypto/dh/dh_check.c"
                                ) {
        if (!BN_rshift1(t1, dh->params.p))
            goto err;
        r = BN_check_prime(t1, ctx, 
# 216 "../crypto/dh/dh_check.c" 3 4
                                   ((void *)0)
...
int DH_check_pub_key_ex(const DH *dh, const BIGNUM *pub_key)
{
    ...
    if ((errflags & 0x01) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",238,__func__), ERR_set_error)((5),(124),
# 238 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 238 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x02) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",240,__func__), ERR_set_error)((5),(123),
# 240 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 240 "../crypto/dh/dh_check.c"
       );
    if ((errflags & 0x04) != 0)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",242,__func__), ERR_set_error)((5),(122),
# 242 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 242 "../crypto/dh/dh_check.c"
       );
...
int DH_check_pub_key(const DH *dh, const BIGNUM *pub_key, int *ret)
{
    ...
    if (BN_num_bits(dh->params.p) > 32768) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_check.c",254,__func__), ERR_set_error)((5),(103),
# 254 "../crypto/dh/dh_check.c" 3 4
       ((void *)0)
# 254 "../crypto/dh/dh_check.c"
       );
        *ret = 0x100 | 0x04;
        return 0;
    }
    ...
    if (dh->params.q != 
# 259 "../crypto/dh/dh_check.c" 3 4
                       ((void *)0) 
# 259 "../crypto/dh/dh_check.c"
                            && BN_ucmp(dh->params.p, dh->params.q) < 0) {
        *ret |= 0x20 | 0x04;
        return 1;
    }
...
int ossl_dh_check_priv_key(const DH *dh, const BIGNUM *priv_key, int *ret)
{
    int ok = 0;
    BIGNUM *two_powN = 
# 281 "../crypto/dh/dh_check.c" 3 4
                      ((void *)0)
# 281 "../crypto/dh/dh_check.c"
                          , *upper;

    *ret = 0;
    two_powN = BN_new();
    if (two_powN == 
# 285 "../crypto/dh/dh_check.c" 3 4
                   ((void *)0)
# 285 "../crypto/dh/dh_check.c"
                       )
        return 0;

    if (dh->params.q != 
# 288 "../crypto/dh/dh_check.c" 3 4
                       ((void *)0)
# 288 "../crypto/dh/dh_check.c"
                           ) {
        upper = dh->params.q;

    } else if (dh->params.p != 
# 291 "../crypto/dh/dh_check.c" 3 4
                              ((void *)0)
# 291 "../crypto/dh/dh_check.c"
                                  ) {
    ...
    if (DH_get_nid((DH *)dh) != 0 && dh->length != 0) {
...
int ossl_dh_check_pairwise(const DH *dh)
{
    int ret = 0;
    BN_CTX *ctx = 
# 335 "../crypto/dh/dh_check.c" 3 4
                 ((void *)0)
# 335 "../crypto/dh/dh_check.c"
                     ;
    BIGNUM *pub_key = 
# 336 "../crypto/dh/dh_check.c" 3 4
                     ((void *)0)
# 336 "../crypto/dh/dh_check.c"
                         ;

    if (dh->params.p == 
# 338 "../crypto/dh/dh_check.c" 3 4
                       ((void *)0)
        
# 339 "../crypto/dh/dh_check.c"
       || dh->params.g == 
# 339 "../crypto/dh/dh_check.c" 3 4
                          ((void *)0)
        
# 340 "../crypto/dh/dh_check.c"
       || dh->priv_key == 
# 340 "../crypto/dh/dh_check.c" 3 4
                          ((void *)0)
        
# 341 "../crypto/dh/dh_check.c"
       || dh->pub_key == 
# 341 "../crypto/dh/dh_check.c" 3 4
                         ((void *)0)
# 341 "../crypto/dh/dh_check.c"
                             )
        return 0;
    ...
    ctx = BN_CTX_new_ex(dh->libctx);
    if (ctx == 
# 345 "../crypto/dh/dh_check.c" 3 4
              ((void *)0)
# 345 "../crypto/dh/dh_check.c"
                  )
        goto err;
    pub_key = BN_new();
    if (pub_key == 
# 348 "../crypto/dh/dh_check.c" 3 4
                  ((void *)0)
# 348 "../crypto/dh/dh_check.c"
                      )
        goto err;
