# 0 "../crypto/dh/dh_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_lib.c"
# 14 "../crypto/dh/dh_lib.c"
...
# 20 "../crypto/dh/dh_lib.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 23 "../crypto/dh/dh_lib.c" 2
...
int DH_set_method(DH *dh, const DH_METHOD *meth)
{
    ...
    dh->engine = 
# 44 "../crypto/dh/dh_lib.c" 3 4
                ((void *)0)
# 44 "../crypto/dh/dh_lib.c"
                    ;
...
DH *DH_new(void)
{
    return dh_new_intern(
# 59 "../crypto/dh/dh_lib.c" 3 4
                        ((void *)0)
# 59 "../crypto/dh/dh_lib.c"
                            , 
# 59 "../crypto/dh/dh_lib.c" 3 4
                              ((void *)0)
# 59 "../crypto/dh/dh_lib.c"
...
{
    return dh_new_intern(engine, 
# 65 "../crypto/dh/dh_lib.c" 3 4
                                ((void *)0)
# 65 "../crypto/dh/dh_lib.c"
                                    );
}
...
{
    return dh_new_intern(
# 71 "../crypto/dh/dh_lib.c" 3 4
                        ((void *)0)
# 71 "../crypto/dh/dh_lib.c"
                            , libctx);
}

static DH *dh_new_intern(ENGINE *engine, OSSL_LIB_CTX *libctx)
{
    DH *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/dh/dh_lib.c", 76);

    if (ret == 
# 78 "../crypto/dh/dh_lib.c" 3 4
              ((void *)0)
# 78 "../crypto/dh/dh_lib.c"
                  )
        return 
# 79 "../crypto/dh/dh_lib.c" 3 4
              ((void *)0)
# 79 "../crypto/dh/dh_lib.c"
                  ;

    ret->lock = CRYPTO_THREAD_lock_new();
    if (ret->lock == 
# 82 "../crypto/dh/dh_lib.c" 3 4
                    ((void *)0)
# 82 "../crypto/dh/dh_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_lib.c",83,__func__), ERR_set_error)((5),((15 | (0x2 << 18L))),
# 83 "../crypto/dh/dh_lib.c" 3 4
       ((void *)0)
# 83 "../crypto/dh/dh_lib.c"
       );
        CRYPTO_free(ret, "../crypto/dh/dh_lib.c", 84);
        return 
# 85 "../crypto/dh/dh_lib.c" 3 4
              ((void *)0)
# 85 "../crypto/dh/dh_lib.c"
                  ;
    }

    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_THREAD_lock_free(ret->lock);
        CRYPTO_free(ret, "../crypto/dh/dh_lib.c", 90);
        return 
# 91 "../crypto/dh/dh_lib.c" 3 4
              ((void *)0)
# 91 "../crypto/dh/dh_lib.c"
                  ;
    }
    ...
    if (engine) {
        if (!ENGINE_init(engine)) {
            (ERR_new(), ERR_set_debug("../crypto/dh/dh_lib.c",100,__func__), ERR_set_error)((5),((38 | (0x2 << 18L))),
# 100 "../crypto/dh/dh_lib.c" 3 4
           ((void *)0)
# 100 "../crypto/dh/dh_lib.c"
           );
            goto err;
        }
        ret->engine = engine;
    ...
    if (ret->engine) {
        ...
        if (ret->meth == 
# 108 "../crypto/dh/dh_lib.c" 3 4
                        ((void *)0)
# 108 "../crypto/dh/dh_lib.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/dh/dh_lib.c",109,__func__), ERR_set_error)((5),((38 | (0x2 << 18L))),
# 109 "../crypto/dh/dh_lib.c" 3 4
           ((void *)0)
# 109 "../crypto/dh/dh_lib.c"
           );
            goto err;
        }
    }
    ...
    if ((ret->meth->init != 
# 124 "../crypto/dh/dh_lib.c" 3 4
                           ((void *)0)
# 124 "../crypto/dh/dh_lib.c"
                               ) && !ret->meth->init(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_lib.c",125,__func__), ERR_set_error)((5),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 125 "../crypto/dh/dh_lib.c" 3 4
       ((void *)0)
# 125 "../crypto/dh/dh_lib.c"
       );
        goto err;
    }
 ...
 err:
    DH_free(ret);
    return 
# 133 "../crypto/dh/dh_lib.c" 3 4
          ((void *)0)
# 133 "../crypto/dh/dh_lib.c"
              ;
}
...
void DH_free(DH *r)
{
    ...
    if (r == 
# 140 "../crypto/dh/dh_lib.c" 3 4
            ((void *)0)
# 140 "../crypto/dh/dh_lib.c"
                )
        return;
    ...
    if (r->meth != 
# 149 "../crypto/dh/dh_lib.c" 3 4
                  ((void *)0) 
# 149 "../crypto/dh/dh_lib.c"
                       && r->meth->finish != 
# 149 "../crypto/dh/dh_lib.c" 3 4
                                             ((void *)0)
# 149 "../crypto/dh/dh_lib.c"
    ...
    CRYPTO_free(r, "../crypto/dh/dh_lib.c", 164);
}
...
{
    if (dh->params.p != 
# 198 "../crypto/dh/dh_lib.c" 3 4
                       ((void *)0)
# 198 "../crypto/dh/dh_lib.c"
                           )
...
{
    if (dh->params.p != 
# 205 "../crypto/dh/dh_lib.c" 3 4
                       ((void *)0)
# 205 "../crypto/dh/dh_lib.c"
                           )
...
int DH_security_bits(const DH *dh)
{
    ...
    if (dh->params.q != 
# 214 "../crypto/dh/dh_lib.c" 3 4
                       ((void *)0)
# 214 "../crypto/dh/dh_lib.c"
                           )
        ...
        N = -1;
    if (dh->params.p != 
# 220 "../crypto/dh/dh_lib.c" 3 4
                       ((void *)0)
# 220 "../crypto/dh/dh_lib.c"
                           )
...
int DH_set0_pqg(DH *dh, BIGNUM *p, BIGNUM *q, BIGNUM *g)
{
    ...
    if ((dh->params.p == 
# 237 "../crypto/dh/dh_lib.c" 3 4
                        ((void *)0) 
# 237 "../crypto/dh/dh_lib.c"
                             && p == 
# 237 "../crypto/dh/dh_lib.c" 3 4
                                     ((void *)0)
# 237 "../crypto/dh/dh_lib.c"
        ...
        || (dh->params.g == 
# 238 "../crypto/dh/dh_lib.c" 3 4
                           ((void *)0) 
# 238 "../crypto/dh/dh_lib.c"
                                && g == 
# 238 "../crypto/dh/dh_lib.c" 3 4
                                        ((void *)0)
# 238 "../crypto/dh/dh_lib.c"
...
{
    if (pub_key != 
# 261 "../crypto/dh/dh_lib.c" 3 4
                  ((void *)0)
# 261 "../crypto/dh/dh_lib.c"
                      )
        *pub_key = dh->pub_key;
    if (priv_key != 
# 263 "../crypto/dh/dh_lib.c" 3 4
                   ((void *)0)
# 263 "../crypto/dh/dh_lib.c"
                       )
...
{
    if (pub_key != 
# 269 "../crypto/dh/dh_lib.c" 3 4
                  ((void *)0)
# 269 "../crypto/dh/dh_lib.c"
                      ) {
        BN_clear_free(dh->pub_key);
        dh->pub_key = pub_key;
    }
    if (priv_key != 
# 273 "../crypto/dh/dh_lib.c" 3 4
                   ((void *)0)
# 273 "../crypto/dh/dh_lib.c"
                       ) {
