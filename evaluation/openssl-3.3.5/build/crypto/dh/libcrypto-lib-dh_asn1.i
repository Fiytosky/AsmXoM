# 0 "../crypto/dh/dh_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_asn1.c"
# 14 "../crypto/dh/dh_asn1.c"
                 ...
                 void *exarg)
{
    if (operation == 0) {
        *pval = (ASN1_VALUE *)DH_new();
        if (*pval != 
# 30 "../crypto/dh/dh_asn1.c" 3 4
                    ((void *)0)
# 30 "../crypto/dh/dh_asn1.c"
                        )
            return 2;
        return 0;
    } else if (operation == 2) {
        DH_free((DH *)*pval);
        *pval = 
# 35 "../crypto/dh/dh_asn1.c" 3 4
               ((void *)0)
# 35 "../crypto/dh/dh_asn1.c"
                   ;
        return 2;
    } else if (operation == 5) {
        DH *dh = (DH *)*pval;
...
# 48 "../crypto/dh/dh_asn1.c" 3 4
((void *)0)
# 48 "../crypto/dh/dh_asn1.c"
, 0, 0, 0, dh_cb, 0, 
# 48 "../crypto/dh/dh_asn1.c" 3 4
((void *)0)
# 48 "../crypto/dh/dh_asn1.c"
        ...
        { (0), (0), 
# 49 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 49 "../crypto/dh/dh_asn1.c"
       DH
# 49 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 49 "../crypto/dh/dh_asn1.c"
...
# 49 "../crypto/dh/dh_asn1.c"
       , "params.p", (BIGNUM_it) },
        { (0), (0), 
# 50 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 50 "../crypto/dh/dh_asn1.c"
       DH
# 50 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 50 "../crypto/dh/dh_asn1.c"
...
# 50 "../crypto/dh/dh_asn1.c"
       , "params.g", (BIGNUM_it) },
        { ((0x1)|(0x1 << 12)), (0), 
# 51 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 51 "../crypto/dh/dh_asn1.c"
       DH
# 51 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 51 "../crypto/dh/dh_asn1.c"
...
# 51 "../crypto/dh/dh_asn1.c"
       , "length", (ZINT32_it) },
} ; const ASN1_ITEM * DHparams_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DHparams_seq_tt, sizeof(DHparams_seq_tt) / sizeof(ASN1_TEMPLATE), &DHparams_aux, sizeof(DH), "DHparams" }; return &local_it; }

DH *d2i_DHparams(DH **a, const unsigned char **in, long len) { return (DH *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DHparams_it())); } int i2d_DHparams(const DH *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DHparams_it())); }
...
static const ASN1_TEMPLATE DHvparams_seq_tt[] = {
        { (0), (0), 
# 75 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 75 "../crypto/dh/dh_asn1.c"
       int_dhvparams
# 75 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 75 "../crypto/dh/dh_asn1.c"
...
# 75 "../crypto/dh/dh_asn1.c"
       , "seed", (ASN1_BIT_STRING_it) },
        { (0), (0), 
# 76 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 76 "../crypto/dh/dh_asn1.c"
       int_dhvparams
# 76 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 76 "../crypto/dh/dh_asn1.c"
...
# 76 "../crypto/dh/dh_asn1.c"
       , "counter", (BIGNUM_it) }
} ; static const ASN1_ITEM * DHvparams_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DHvparams_seq_tt, sizeof(DHvparams_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 77 "../crypto/dh/dh_asn1.c" 3 4
 ((void *)0)
# 77 "../crypto/dh/dh_asn1.c"
 , sizeof(int_dhvparams), "int_dhvparams" }; return &local_it; }

static const ASN1_TEMPLATE DHxparams_seq_tt[] = {
        { (0), (0), 
# 80 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 80 "../crypto/dh/dh_asn1.c"
       int_dhx942_dh
# 80 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 80 "../crypto/dh/dh_asn1.c"
...
# 80 "../crypto/dh/dh_asn1.c"
       , "p", (BIGNUM_it) },
        { (0), (0), 
# 81 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 81 "../crypto/dh/dh_asn1.c"
       int_dhx942_dh
# 81 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 81 "../crypto/dh/dh_asn1.c"
...
# 81 "../crypto/dh/dh_asn1.c"
       , "g", (BIGNUM_it) },
        { (0), (0), 
# 82 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 82 "../crypto/dh/dh_asn1.c"
       int_dhx942_dh
# 82 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 82 "../crypto/dh/dh_asn1.c"
...
# 82 "../crypto/dh/dh_asn1.c"
       , "q", (BIGNUM_it) },
        { ((0x1)), (0), 
# 83 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 83 "../crypto/dh/dh_asn1.c"
       int_dhx942_dh
# 83 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 83 "../crypto/dh/dh_asn1.c"
...
# 83 "../crypto/dh/dh_asn1.c"
       , "j", (BIGNUM_it) },
        { ((0x1)), (0), 
# 84 "../crypto/dh/dh_asn1.c" 3 4
       __builtin_offsetof (
# 84 "../crypto/dh/dh_asn1.c"
       int_dhx942_dh
# 84 "../crypto/dh/dh_asn1.c" 3 4
       , 
# 84 "../crypto/dh/dh_asn1.c"
...
# 84 "../crypto/dh/dh_asn1.c"
       , "vparams", (DHvparams_it) },
} ; static const ASN1_ITEM * DHxparams_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DHxparams_seq_tt, sizeof(DHxparams_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 85 "../crypto/dh/dh_asn1.c" 3 4
 ((void *)0)
# 85 "../crypto/dh/dh_asn1.c"
 , sizeof(int_dhx942_dh), "int_dhx942_dh" }; return &local_it; }

int_dhx942_dh *d2i_int_dhx(int_dhx942_dh **a,
                           const unsigned char **pp, long length);
int i2d_int_dhx(const int_dhx942_dh *a, unsigned char **pp);

int_dhx942_dh *d2i_int_dhx(int_dhx942_dh **a, const unsigned char **in, long len) { return (int_dhx942_dh *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DHxparams_it())); } int i2d_int_dhx(const int_dhx942_dh *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DHxparams_it())); }

DH *d2i_DHxparams(DH **a, const unsigned char **pp, long length)
{
    FFC_PARAMS *params;
    int_dhx942_dh *dhx = 
# 96 "../crypto/dh/dh_asn1.c" 3 4
                        ((void *)0)
# 96 "../crypto/dh/dh_asn1.c"
                            ;
    DH *dh = 
# 97 "../crypto/dh/dh_asn1.c" 3 4
            ((void *)0)
# 97 "../crypto/dh/dh_asn1.c"
                ;

    dh = DH_new();
    if (dh == 
# 100 "../crypto/dh/dh_asn1.c" 3 4
             ((void *)0)
# 100 "../crypto/dh/dh_asn1.c"
                 )
        return 
# 101 "../crypto/dh/dh_asn1.c" 3 4
              ((void *)0)
# 101 "../crypto/dh/dh_asn1.c"
                  ;
    dhx = d2i_int_dhx(
# 102 "../crypto/dh/dh_asn1.c" 3 4
                     ((void *)0)
# 102 "../crypto/dh/dh_asn1.c"
                         , pp, length);
    if (dhx == 
# 103 "../crypto/dh/dh_asn1.c" 3 4
              ((void *)0)
# 103 "../crypto/dh/dh_asn1.c"
                  ) {
        DH_free(dh);
        return 
# 105 "../crypto/dh/dh_asn1.c" 3 4
              ((void *)0)
# 105 "../crypto/dh/dh_asn1.c"
                  ;
    }

    if (a != 
# 108 "../crypto/dh/dh_asn1.c" 3 4
            ((void *)0)
# 108 "../crypto/dh/dh_asn1.c"
                ) {
        DH_free(*a);
        *a = dh;
    }
    ...
    if (dhx->vparams != 
# 117 "../crypto/dh/dh_asn1.c" 3 4
                       ((void *)0)
# 117 "../crypto/dh/dh_asn1.c"
                           ) {
        ...
        CRYPTO_free(dhx->vparams, "../crypto/dh/dh_asn1.c", 125);
        dhx->vparams = 
# 126 "../crypto/dh/dh_asn1.c" 3 4
                      ((void *)0)
# 126 "../crypto/dh/dh_asn1.c"
                          ;
    }

    CRYPTO_free(dhx, "../crypto/dh/dh_asn1.c", 129);
    DH_clear_flags(dh, 0xF000);
...
int i2d_DHxparams(const DH *dh, unsigned char **pp)
{
    ...
    int_dhx942_dh dhx;
    int_dhvparams dhv = { 
# 139 "../crypto/dh/dh_asn1.c" 3 4
                         ((void *)0)
# 139 "../crypto/dh/dh_asn1.c"
                             , 
# 139 "../crypto/dh/dh_asn1.c" 3 4
                               ((void *)0) 
# 139 "../crypto/dh/dh_asn1.c"
    ...
    if (counter != -1 && seed.data != 
# 151 "../crypto/dh/dh_asn1.c" 3 4
                                     ((void *)0) 
# 151 "../crypto/dh/dh_asn1.c"
                                          && seed.length > 0) {
        seed.flags = 0x08;
        dhv.seed = &seed;
        dhv.counter = BN_new();
        if (dhv.counter == 
# 155 "../crypto/dh/dh_asn1.c" 3 4
                          ((void *)0)
# 155 "../crypto/dh/dh_asn1.c"
                              )
            return 0;
        if (!BN_set_word(dhv.counter, (unsigned long)counter))
            goto err;
        dhx.vparams = &dhv;
    } else {
        dhx.vparams = 
# 161 "../crypto/dh/dh_asn1.c" 3 4
                     ((void *)0)
# 161 "../crypto/dh/dh_asn1.c"
                         ;
    }
