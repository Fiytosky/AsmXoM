# 0 "../crypto/dh/dh_ameth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_ameth.c"
# 14 "../crypto/dh/dh_ameth.c"
...
# 18 "../crypto/dh/dh_ameth.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../crypto/dh/dh_ameth.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 27 "../crypto/dh/dh_ameth.c" 2
# 1 "../crypto/dh/dh_local.h" 1
# 16 "../crypto/dh/dh_local.h"
struct dh_st {
...
{
    DH *dh = 
# 37 "../crypto/dh/dh_ameth.c" 3 4
            ((void *)0)
# 37 "../crypto/dh/dh_ameth.c"
                ;
    int is_dhx = (pkey->ameth == &ossl_dhx_asn1_meth);

    if (is_dhx)
        dh = d2i_DHxparams(
# 41 "../crypto/dh/dh_ameth.c" 3 4
                          ((void *)0)
# 41 "../crypto/dh/dh_ameth.c"
                              , pp, length);
    else
        dh = d2i_DHparams(
# 43 "../crypto/dh/dh_ameth.c" 3 4
                         ((void *)0)
# 43 "../crypto/dh/dh_ameth.c"
                             , pp, length);
...
# 68 "../crypto/dh/dh_ameth.c" 3 4
                              ((void *)0)
# 68 "../crypto/dh/dh_ameth.c"
                                  ;

    DH *dh = 
# 70 "../crypto/dh/dh_ameth.c" 3 4
            ((void *)0)
# 70 "../crypto/dh/dh_ameth.c"
                ;

    if (!X509_PUBKEY_get0_param(
# 72 "../crypto/dh/dh_ameth.c" 3 4
                               ((void *)0)
# 72 "../crypto/dh/dh_ameth.c"
                                   , &p, &pklen, &palg, pubkey))
        return 0;
    X509_ALGOR_get0(
# 74 "../crypto/dh/dh_ameth.c" 3 4
                   ((void *)0)
# 74 "../crypto/dh/dh_ameth.c"
                       , &ptype, &pval, palg);

    if (ptype != 16) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",77,__func__), ERR_set_error)((5),(105),
# 77 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 77 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
...
# 85 "../crypto/dh/dh_ameth.c" 3 4
                                           ((void *)0)
# 85 "../crypto/dh/dh_ameth.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",86,__func__), ERR_set_error)((5),(104),
# 86 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 86 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }

    if ((public_key = d2i_ASN1_INTEGER(
# 90 "../crypto/dh/dh_ameth.c" 3 4
                                      ((void *)0)
# 90 "../crypto/dh/dh_ameth.c"
                                          , &p, pklen)) == 
# 90 "../crypto/dh/dh_ameth.c" 3 4
                                                           ((void *)0)
# 90 "../crypto/dh/dh_ameth.c"
                                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",91,__func__), ERR_set_error)((5),(104),
# 91 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 91 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
...
# 96 "../crypto/dh/dh_ameth.c" 3 4
                                                     ((void *)0)
# 96 "../crypto/dh/dh_ameth.c"
                                                         )) == 
# 96 "../crypto/dh/dh_ameth.c" 3 4
                                                               ((void *)0)
# 96 "../crypto/dh/dh_ameth.c"
                                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",97,__func__), ERR_set_error)((5),(109),
# 97 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 97 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
...
static int dh_pub_encode(X509_PUBKEY *pk, const EVP_PKEY *pkey)
{
    ...
    int ptype;
    unsigned char *penc = 
# 115 "../crypto/dh/dh_ameth.c" 3 4
                         ((void *)0)
# 115 "../crypto/dh/dh_ameth.c"
                             ;
    int penclen;
    ASN1_STRING *str;
    ASN1_INTEGER *pub_key = 
# 118 "../crypto/dh/dh_ameth.c" 3 4
                           ((void *)0)
# 118 "../crypto/dh/dh_ameth.c"
                               ;
    ...
    str = ASN1_STRING_new();
    if (str == 
# 123 "../crypto/dh/dh_ameth.c" 3 4
              ((void *)0)
# 123 "../crypto/dh/dh_ameth.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",124,__func__), ERR_set_error)((5),((13 | (0x2 << 18L))),
# 124 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 124 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    str->length = i2d_dhp(pkey, dh, &str->data);
    if (str->length <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",129,__func__), ERR_set_error)((5),((13 | (0x2 << 18L))),
# 129 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 129 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    ptype = 16;
...
# 134 "../crypto/dh/dh_ameth.c" 3 4
                                             ((void *)0)
# 134 "../crypto/dh/dh_ameth.c"
                                                 );
    if (pub_key == 
# 135 "../crypto/dh/dh_ameth.c" 3 4
                  ((void *)0)
# 135 "../crypto/dh/dh_ameth.c"
                      )
        goto err;
    ...
    if (penclen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",143,__func__), ERR_set_error)((5),((13 | (0x2 << 18L))),
# 143 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 143 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
 ...
 err:
    CRYPTO_free(penc, "../crypto/dh/dh_ameth.c", 152);
...
{
    int ret = 0;
    DH *dh = ossl_dh_key_from_pkcs8(p8, 
# 167 "../crypto/dh/dh_ameth.c" 3 4
                                       ((void *)0)
# 167 "../crypto/dh/dh_ameth.c"
                                           , 
# 167 "../crypto/dh/dh_ameth.c" 3 4
                                             ((void *)0)
# 167 "../crypto/dh/dh_ameth.c"
    ...
    if (dh != 
# 169 "../crypto/dh/dh_ameth.c" 3 4
             ((void *)0)
# 169 "../crypto/dh/dh_ameth.c"
                 ) {
        ret = 1;
        EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, dh);
    }
...
{
    ASN1_STRING *params = 
# 179 "../crypto/dh/dh_ameth.c" 3 4
                         ((void *)0)
# 179 "../crypto/dh/dh_ameth.c"
                             ;
    ASN1_INTEGER *prkey = 
# 180 "../crypto/dh/dh_ameth.c" 3 4
                         ((void *)0)
# 180 "../crypto/dh/dh_ameth.c"
                             ;
    unsigned char *dp = 
# 181 "../crypto/dh/dh_ameth.c" 3 4
                       ((void *)0)
# 181 "../crypto/dh/dh_ameth.c"
                           ;
    int dplen;
    ...
    if (params == 
# 186 "../crypto/dh/dh_ameth.c" 3 4
                 ((void *)0)
# 186 "../crypto/dh/dh_ameth.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",187,__func__), ERR_set_error)((5),((13 | (0x2 << 18L))),
# 187 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 187 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    ...
    if (params->length <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",193,__func__), ERR_set_error)((5),((13 | (0x2 << 18L))),
# 193 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 193 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    params->type = 16;
...
# 199 "../crypto/dh/dh_ameth.c" 3 4
                                                       ((void *)0)
# 199 "../crypto/dh/dh_ameth.c"
                                                           );

    if (prkey == 
# 201 "../crypto/dh/dh_ameth.c" 3 4
                ((void *)0)
# 201 "../crypto/dh/dh_ameth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",202,__func__), ERR_set_error)((5),(106),
# 202 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 202 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    ...
    if (dplen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",211,__func__), ERR_set_error)((5),(106),
# 211 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 211 "../crypto/dh/dh_ameth.c"
       );
        goto err;
    }
    ...
    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(pkey->ameth->pkey_id), 0,
                         16, params, dp, dplen)) {
        CRYPTO_clear_free(dp, dplen, "../crypto/dh/dh_ameth.c", 217);
        goto err;
    }
    return 1;
...
# 232 "../crypto/dh/dh_ameth.c" 3 4
                                             ((void *)0)
# 232 "../crypto/dh/dh_ameth.c"
                                                 )
        return 0;
    dh->dirty_cnt++;
    EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, dh);
...
{
    int reason = (7 | (0x2 << 18L));
    const char *ktype = 
# 247 "../crypto/dh/dh_ameth.c" 3 4
                       ((void *)0)
# 247 "../crypto/dh/dh_ameth.c"
                           ;
    ...
    if (ptype == 2)
        ...
        priv_key = 
# 253 "../crypto/dh/dh_ameth.c" 3 4
                  ((void *)0)
# 253 "../crypto/dh/dh_ameth.c"
                      ;
    ...
    if (ptype > 0)
        ...
        pub_key = 
# 258 "../crypto/dh/dh_ameth.c" 3 4
                 ((void *)0)
# 258 "../crypto/dh/dh_ameth.c"
                     ;

    if (x->params.p == 
# 260 "../crypto/dh/dh_ameth.c" 3 4
                      ((void *)0) 
# 260 "../crypto/dh/dh_ameth.c"
                           || (ptype == 2 && priv_key == 
# 260 "../crypto/dh/dh_ameth.c" 3 4
                                                         ((void *)0)
# 260 "../crypto/dh/dh_ameth.c"
            ...
            || (ptype > 0 && pub_key == 
# 261 "../crypto/dh/dh_ameth.c" 3 4
                                       ((void *)0)
# 261 "../crypto/dh/dh_ameth.c"
                                           )) {
        reason = (258|((0x1 << 18L)|(0x2 << 18L)));
        goto err;
    }
    ...
    if (!ASN1_bn_print(bp, "private-key:", priv_key, 
# 278 "../crypto/dh/dh_ameth.c" 3 4
                                                    ((void *)0)
# 278 "../crypto/dh/dh_ameth.c"
                                                        , indent))
        goto err;
    if (!ASN1_bn_print(bp, "public-key:", pub_key, 
# 280 "../crypto/dh/dh_ameth.c" 3 4
                                                  ((void *)0)
# 280 "../crypto/dh/dh_ameth.c"
                                                      , indent))
        goto err;
 ...
 err:
    (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",296,__func__), ERR_set_error)((5),(reason),
# 296 "../crypto/dh/dh_ameth.c" 3 4
   ((void *)0)
# 296 "../crypto/dh/dh_ameth.c"
   );
    return 0;
}
...
{
    if (is_x942 == -1)
        is_x942 = (from->params.q != 
# 324 "../crypto/dh/dh_ameth.c" 3 4
                                    ((void *)0)
# 324 "../crypto/dh/dh_ameth.c"
                                        );
...
DH *DHparams_dup(const DH *dh)
{
    ...
    ret = DH_new();
    if (ret == 
# 337 "../crypto/dh/dh_ameth.c" 3 4
              ((void *)0)
# 337 "../crypto/dh/dh_ameth.c"
                  )
        return 
# 338 "../crypto/dh/dh_ameth.c" 3 4
              ((void *)0)
# 338 "../crypto/dh/dh_ameth.c"
                  ;
    if (!int_dh_param_copy(ret, dh, -1)) {
        DH_free(ret);
        return 
# 341 "../crypto/dh/dh_ameth.c" 3 4
              ((void *)0)
# 341 "../crypto/dh/dh_ameth.c"
                  ;
    }
    return ret;
}
...
{
    if (to->pkey.dh == 
# 348 "../crypto/dh/dh_ameth.c" 3 4
                      ((void *)0)
# 348 "../crypto/dh/dh_ameth.c"
                          ) {
        to->pkey.dh = DH_new();
        if (to->pkey.dh == 
# 350 "../crypto/dh/dh_ameth.c" 3 4
                          ((void *)0)
# 350 "../crypto/dh/dh_ameth.c"
                              )
            return 0;
    }
...
{
    return a->pkey.dh == 
# 359 "../crypto/dh/dh_ameth.c" 3 4
                        ((void *)0)
        
# 360 "../crypto/dh/dh_ameth.c"
       || a->pkey.dh->params.p == 
# 360 "../crypto/dh/dh_ameth.c" 3 4
                                  ((void *)0)
        
# 361 "../crypto/dh/dh_ameth.c"
       || a->pkey.dh->params.g == 
# 361 "../crypto/dh/dh_ameth.c" 3 4
                                  ((void *)0)
# 361 "../crypto/dh/dh_ameth.c"
                                      ;
}
...
# 403 "../crypto/dh/dh_ameth.c" 3 4
            ((void *)0)
# 403 "../crypto/dh/dh_ameth.c"
            )) != 0), 1))
            return 0;
        dh = (DH *) evp_pkey_get0_DH_int(pkey);
        if (dh == 
# 406 "../crypto/dh/dh_ameth.c" 3 4
                 ((void *)0)
# 406 "../crypto/dh/dh_ameth.c"
                     )
            return 0;
    ...
    case 0xa:
        ...
        if (dh == 
# 411 "../crypto/dh/dh_ameth.c" 3 4
                 ((void *)0)
# 411 "../crypto/dh/dh_ameth.c"
                     )
            return 0;
...
static int dh_pkey_public_check(const EVP_PKEY *pkey)
{
    ...
    if (dh->pub_key == 
# 432 "../crypto/dh/dh_ameth.c" 3 4
                      ((void *)0)
# 432 "../crypto/dh/dh_ameth.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",433,__func__), ERR_set_error)((5),(125),
# 433 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 433 "../crypto/dh/dh_ameth.c"
       );
        return 0;
    }
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    OSSL_PARAM *params = 
# 462 "../crypto/dh/dh_ameth.c" 3 4
                        ((void *)0)
# 462 "../crypto/dh/dh_ameth.c"
                            ;
    int selection = 0;
    int rv = 0;

    if (p == 
# 466 "../crypto/dh/dh_ameth.c" 3 4
            ((void *)0) 
# 466 "../crypto/dh/dh_ameth.c"
                 || g == 
# 466 "../crypto/dh/dh_ameth.c" 3 4
                         ((void *)0)
# 466 "../crypto/dh/dh_ameth.c"
    ...
    if (tmpl == 
# 470 "../crypto/dh/dh_ameth.c" 3 4
               ((void *)0)
# 470 "../crypto/dh/dh_ameth.c"
                   )
        return 0;
    if (!OSSL_PARAM_BLD_push_BN(tmpl, "p", p)
        ...
        goto err;
    if (q != 
# 475 "../crypto/dh/dh_ameth.c" 3 4
            ((void *)0)
# 475 "../crypto/dh/dh_ameth.c"
                ) {
        if (!OSSL_PARAM_BLD_push_BN(tmpl, "q", q))
            goto err;
    }
    selection |= 0x04;
    if (l > 0) {
        if (!OSSL_PARAM_BLD_push_long(tmpl, "priv_len", l))
            goto err;
        selection |= 0x80;
    }
    if (pub_key != 
# 485 "../crypto/dh/dh_ameth.c" 3 4
                  ((void *)0)
# 485 "../crypto/dh/dh_ameth.c"
                      ) {
        if (!OSSL_PARAM_BLD_push_BN(tmpl, "pub", pub_key))
            goto err;
        selection |= 0x02;
    }
    if (priv_key != 
# 490 "../crypto/dh/dh_ameth.c" 3 4
                   ((void *)0)
# 490 "../crypto/dh/dh_ameth.c"
                       ) {
...
# 497 "../crypto/dh/dh_ameth.c" 3 4
                                                   ((void *)0)
# 497 "../crypto/dh/dh_ameth.c"
                                                       )
        goto err;
                                    ...
                                    int type)
{
    ...
    if (dh == 
# 516 "../crypto/dh/dh_ameth.c" 3 4
             ((void *)0)
# 516 "../crypto/dh/dh_ameth.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_ameth.c",517,__func__), ERR_set_error)((5),((5 | (0x2 << 18L))),
# 517 "../crypto/dh/dh_ameth.c" 3 4
       ((void *)0)
# 517 "../crypto/dh/dh_ameth.c"
       );
        return 0;
    }
    DH_clear_flags(dh, 0xF000);
    DH_set_flags(dh, type == 28 ? 0x0000 : 0x1000);
...
{
    return dh_pkey_import_from_type(params, vpctx, 28);
}

static int dhx_pkey_import_from(const OSSL_PARAM params[], void *vpctx)
{
    return dh_pkey_import_from_type(params, vpctx, 920);
}
...
static int dh_pkey_copy(EVP_PKEY *to, EVP_PKEY *from)
{
    DH *dh = from->pkey.dh;
    DH *dupkey = 
# 545 "../crypto/dh/dh_ameth.c" 3 4
                ((void *)0)
# 545 "../crypto/dh/dh_ameth.c"
                    ;
    int ret;

    if (dh != 
# 548 "../crypto/dh/dh_ameth.c" 3 4
             ((void *)0)
# 548 "../crypto/dh/dh_ameth.c"
                 ) {
        dupkey = ossl_dh_dup(dh, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ));
        if (dupkey == 
# 550 "../crypto/dh/dh_ameth.c" 3 4
                     ((void *)0)
# 550 "../crypto/dh/dh_ameth.c"
                         )
            return 0;
    }
