# 0 "../crypto/dh/dh_depr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_depr.c"
# 16 "../crypto/dh/dh_depr.c"
                           ...
                           void (*callback) (int, int, void *), void *cb_arg)
{
    BN_GENCB *cb;
    DH *ret = 
# 29 "../crypto/dh/dh_depr.c" 3 4
             ((void *)0)
# 29 "../crypto/dh/dh_depr.c"
                 ;

    if ((ret = DH_new()) == 
# 31 "../crypto/dh/dh_depr.c" 3 4
                           ((void *)0)
# 31 "../crypto/dh/dh_depr.c"
                               )
        return 
# 32 "../crypto/dh/dh_depr.c" 3 4
              ((void *)0)
# 32 "../crypto/dh/dh_depr.c"
                  ;
    cb = BN_GENCB_new();
    if (cb == 
# 34 "../crypto/dh/dh_depr.c" 3 4
             ((void *)0)
# 34 "../crypto/dh/dh_depr.c"
                 ) {
        DH_free(ret);
        return 
# 36 "../crypto/dh/dh_depr.c" 3 4
              ((void *)0)
# 36 "../crypto/dh/dh_depr.c"
                  ;
    }
    ...
    DH_free(ret);
    return 
# 47 "../crypto/dh/dh_depr.c" 3 4
          ((void *)0)
# 47 "../crypto/dh/dh_depr.c"
              ;
}
