# 0 "../crypto/dh/dh_group_params.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_group_params.c"
# 16 "../crypto/dh/dh_group_params.c"
...
# 17 "../crypto/dh/dh_group_params.c" 2
...
# 19 "../crypto/dh/dh_group_params.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 20 "../crypto/dh/dh_group_params.c" 2
...
# 21 "../crypto/dh/dh_group_params.c" 2
...
# 22 "../crypto/dh/dh_group_params.c" 2
...
# 26 "../crypto/dh/dh_group_params.c" 2
...
static DH *dh_param_init(OSSL_LIB_CTX *libctx, const DH_NAMED_GROUP *group)
{
    ...
    if (dh == 
# 31 "../crypto/dh/dh_group_params.c" 3 4
             ((void *)0)
# 31 "../crypto/dh/dh_group_params.c"
                 )
        return 
# 32 "../crypto/dh/dh_group_params.c" 3 4
              ((void *)0)
# 32 "../crypto/dh/dh_group_params.c"
                  ;
...
DH *ossl_dh_new_by_nid_ex(OSSL_LIB_CTX *libctx, int nid)
{
    ...
    if ((group = ossl_ffc_uid_to_dh_named_group(nid)) != 
# 44 "../crypto/dh/dh_group_params.c" 3 4
                                                        ((void *)0)
# 44 "../crypto/dh/dh_group_params.c"
                                                            )
        return dh_param_init(libctx, group);

    (ERR_new(), ERR_set_debug("../crypto/dh/dh_group_params.c",47,__func__), ERR_set_error)((5),(114),
# 47 "../crypto/dh/dh_group_params.c" 3 4
   ((void *)0)
# 47 "../crypto/dh/dh_group_params.c"
   );
    return 
# 48 "../crypto/dh/dh_group_params.c" 3 4
          ((void *)0)
# 48 "../crypto/dh/dh_group_params.c"
              ;
}

DH *DH_new_by_nid(int nid)
{
    return ossl_dh_new_by_nid_ex(
# 53 "../crypto/dh/dh_group_params.c" 3 4
                                ((void *)0)
# 53 "../crypto/dh/dh_group_params.c"
                                    , nid);
}
...
void ossl_dh_cache_named_group(DH *dh)
{
    ...
    if (dh == 
# 60 "../crypto/dh/dh_group_params.c" 3 4
             ((void *)0)
# 60 "../crypto/dh/dh_group_params.c"
                 )
        return;
    ...
    if (dh->params.p == 
# 66 "../crypto/dh/dh_group_params.c" 3 4
                       ((void *)0)
        
# 67 "../crypto/dh/dh_group_params.c"
       || dh->params.g == 
# 67 "../crypto/dh/dh_group_params.c" 3 4
                          ((void *)0)
# 67 "../crypto/dh/dh_group_params.c"
                              )
        return;
    ...
    if ((group = ossl_ffc_numbers_to_dh_named_group(dh->params.p,
                                                    dh->params.q,
                                                    dh->params.g)) != 
# 72 "../crypto/dh/dh_group_params.c" 3 4
                                                                     ((void *)0)
# 72 "../crypto/dh/dh_group_params.c"
                                                                         ) {
        if (dh->params.q == 
# 73 "../crypto/dh/dh_group_params.c" 3 4
                           ((void *)0)
# 73 "../crypto/dh/dh_group_params.c"
                               )
...
{
    if (dh == 
# 95 "../crypto/dh/dh_group_params.c" 3 4
             ((void *)0)
# 95 "../crypto/dh/dh_group_params.c"
                 )
        return 0;
