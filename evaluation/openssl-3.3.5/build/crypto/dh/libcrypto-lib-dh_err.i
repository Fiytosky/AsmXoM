# 0 "../crypto/dh/dh_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_err.c"
# 11 "../crypto/dh/dh_err.c"
...
static const ERR_STRING_DATA DH_str_reasons[] = {
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ), "bad ffc parameters"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad generator"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "bn decode error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "bn error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "check invalid j value"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "check invalid q value"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "check pubkey invalid"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "check pubkey too large"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "check pubkey too small"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ), "check p not prime"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "check p not safe prime"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "check q not prime"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "decode error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "invalid parameter name"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "invalid parameter nid"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "invalid public key"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ), "invalid secret"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "invalid size"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "kdf parameter error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "keys not set"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "missing pubkey"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "modulus too large"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ), "modulus too small"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "not suitable generator"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "no parameters set"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "no private value"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "parameter encoding error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "peer key error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "q too large"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "shared info error"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "unable to check generator"},
    {0, 
# 62 "../crypto/dh/dh_err.c" 3 4
       ((void *)0)
# 62 "../crypto/dh/dh_err.c"
           }
};
...
int ossl_err_load_DH_strings(void)
{
    ...
    if (ERR_reason_error_string(DH_str_reasons[0].error) == 
# 70 "../crypto/dh/dh_err.c" 3 4
                                                           ((void *)0)
# 70 "../crypto/dh/dh_err.c"
                                                               )
