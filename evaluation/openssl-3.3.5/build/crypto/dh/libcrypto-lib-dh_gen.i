# 0 "../crypto/dh/dh_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_gen.c"
# 24 "../crypto/dh/dh_gen.c"
                                ...
                                BN_GENCB *cb)
{
    ...
    int g, ok = -1;
    BN_CTX *ctx = 
# 161 "../crypto/dh/dh_gen.c" 3 4
                 ((void *)0)
# 161 "../crypto/dh/dh_gen.c"
                     ;

    if (prime_len > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_gen.c",164,__func__), ERR_set_error)((5),(103),
# 164 "../crypto/dh/dh_gen.c" 3 4
       ((void *)0)
# 164 "../crypto/dh/dh_gen.c"
       );
        return 0;
    }

    if (prime_len < 512) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_gen.c",169,__func__), ERR_set_error)((5),(126),
# 169 "../crypto/dh/dh_gen.c" 3 4
       ((void *)0)
# 169 "../crypto/dh/dh_gen.c"
       );
        return 0;
    }
    ...
    if (ctx == 
# 174 "../crypto/dh/dh_gen.c" 3 4
              ((void *)0)
# 174 "../crypto/dh/dh_gen.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    t1 = BN_CTX_get(ctx);
    t2 = BN_CTX_get(ctx);
    if (t2 == 
# 179 "../crypto/dh/dh_gen.c" 3 4
             ((void *)0)
# 179 "../crypto/dh/dh_gen.c"
                 )
        goto err;


    if (ret->params.p == 
# 183 "../crypto/dh/dh_gen.c" 3 4
                        ((void *)0) 
# 183 "../crypto/dh/dh_gen.c"
                             && ((ret->params.p = BN_new()) == 
# 183 "../crypto/dh/dh_gen.c" 3 4
                                                               ((void *)0)
# 183 "../crypto/dh/dh_gen.c"
        ...
        goto err;
    if (ret->params.g == 
# 185 "../crypto/dh/dh_gen.c" 3 4
                        ((void *)0) 
# 185 "../crypto/dh/dh_gen.c"
                             && ((ret->params.g = BN_new()) == 
# 185 "../crypto/dh/dh_gen.c" 3 4
                                                               ((void *)0)
# 185 "../crypto/dh/dh_gen.c"
    ...
    if (generator <= 1) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_gen.c",189,__func__), ERR_set_error)((5),(101),
# 189 "../crypto/dh/dh_gen.c" 3 4
       ((void *)0)
# 189 "../crypto/dh/dh_gen.c"
       );
        goto err;
    }
    if (generator == 2) {
 ...
 err:
    if (ok == -1) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_gen.c",230,__func__), ERR_set_error)((5),((3 | (0x2 << 18L))),
# 230 "../crypto/dh/dh_gen.c" 3 4
       ((void *)0)
# 230 "../crypto/dh/dh_gen.c"
       );
        ok = 0;
    }
