# 0 "../crypto/dh/dh_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_meth.c"
# 14 "../crypto/dh/dh_meth.c"
...
# 18 "../crypto/dh/dh_meth.c" 2



# 20 "../crypto/dh/dh_meth.c"
DH_METHOD *DH_meth_new(const char *name, int flags)
{
    DH_METHOD *dhm = CRYPTO_zalloc(sizeof(*dhm), "../crypto/dh/dh_meth.c", 22);

    if (dhm != 
# 24 "../crypto/dh/dh_meth.c" 3 4
              ((void *)0)
# 24 "../crypto/dh/dh_meth.c"
                  ) {
        dhm->flags = flags;

        dhm->name = CRYPTO_strdup(name, "../crypto/dh/dh_meth.c", 27);
        if (dhm->name != 
# 28 "../crypto/dh/dh_meth.c" 3 4
                        ((void *)0)
# 28 "../crypto/dh/dh_meth.c"
                            )
            return dhm;

        CRYPTO_free(dhm, "../crypto/dh/dh_meth.c", 31);
    }

    return 
# 34 "../crypto/dh/dh_meth.c" 3 4
          ((void *)0)
# 34 "../crypto/dh/dh_meth.c"
              ;
}
...
{
    if (dhm != 
# 39 "../crypto/dh/dh_meth.c" 3 4
              ((void *)0)
# 39 "../crypto/dh/dh_meth.c"
                  ) {
        CRYPTO_free(dhm->name, "../crypto/dh/dh_meth.c", 40);
        CRYPTO_free(dhm, "../crypto/dh/dh_meth.c", 41);
    }
}

DH_METHOD *DH_meth_dup(const DH_METHOD *dhm)
{
    DH_METHOD *ret = CRYPTO_malloc(sizeof(*ret), "../crypto/dh/dh_meth.c", 47);

    if (ret != 
# 49 "../crypto/dh/dh_meth.c" 3 4
              ((void *)0)
# 49 "../crypto/dh/dh_meth.c"
                  ) {
        memcpy(ret, dhm, sizeof(*dhm));

        ret->name = CRYPTO_strdup(dhm->name, "../crypto/dh/dh_meth.c", 52);
        if (ret->name != 
# 53 "../crypto/dh/dh_meth.c" 3 4
                        ((void *)0)
# 53 "../crypto/dh/dh_meth.c"
                            )
            return ret;

        CRYPTO_free(ret, "../crypto/dh/dh_meth.c", 56);
    }

    return 
# 59 "../crypto/dh/dh_meth.c" 3 4
          ((void *)0)
# 59 "../crypto/dh/dh_meth.c"
              ;
}
...
{
    char *tmpname = CRYPTO_strdup(name, "../crypto/dh/dh_meth.c", 69);

    if (tmpname == 
# 71 "../crypto/dh/dh_meth.c" 3 4
                  ((void *)0)
# 71 "../crypto/dh/dh_meth.c"
                      )
        return 0;

    CRYPTO_free(dhm->name, "../crypto/dh/dh_meth.c", 74);
    dhm->name = tmpname;
