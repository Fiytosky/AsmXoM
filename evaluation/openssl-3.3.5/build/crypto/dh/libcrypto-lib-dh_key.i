# 0 "../crypto/dh/dh_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_key.c"
# 14 "../crypto/dh/dh_key.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 18 "../crypto/dh/dh_key.c" 2
# 1 "../crypto/dh/dh_local.h" 1
# 10 "../crypto/dh/dh_local.h"
...
{
    BN_CTX *ctx = 
# 42 "../crypto/dh/dh_key.c" 3 4
                 ((void *)0)
# 42 "../crypto/dh/dh_key.c"
                     ;
    BN_MONT_CTX *mont = 
# 43 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 43 "../crypto/dh/dh_key.c"
                           ;
    BIGNUM *z = 
# 44 "../crypto/dh/dh_key.c" 3 4
               ((void *)0)
# 44 "../crypto/dh/dh_key.c"
                   , *pminus1;
    int ret = -1;

    if (BN_num_bits(dh->params.p) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",48,__func__), ERR_set_error)((5),(103),
# 48 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 48 "../crypto/dh/dh_key.c"
       );
        goto err;
    }

    if (dh->params.q != 
# 52 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
        
# 53 "../crypto/dh/dh_key.c"
       && BN_num_bits(dh->params.q) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",54,__func__), ERR_set_error)((5),(130),
# 54 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 54 "../crypto/dh/dh_key.c"
       );
        goto err;
    }

    if (BN_num_bits(dh->params.p) < 512) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",59,__func__), ERR_set_error)((5),(126),
# 59 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 59 "../crypto/dh/dh_key.c"
       );
        return 0;
    }
    ...
    if (ctx == 
# 64 "../crypto/dh/dh_key.c" 3 4
              ((void *)0)
# 64 "../crypto/dh/dh_key.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    ...
    z = BN_CTX_get(ctx);
    if (z == 
# 69 "../crypto/dh/dh_key.c" 3 4
            ((void *)0)
# 69 "../crypto/dh/dh_key.c"
                )
        goto err;

    if (dh->priv_key == 
# 72 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 72 "../crypto/dh/dh_key.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",73,__func__), ERR_set_error)((5),(100),
# 73 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 73 "../crypto/dh/dh_key.c"
       );
        goto err;
    }
    ...
    if (!dh->meth->bn_mod_exp(dh, z, pub_key, dh->priv_key, dh->params.p, ctx,
                              mont)) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",88,__func__), ERR_set_error)((5),((3 | (0x2 << 18L))),
# 88 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 88 "../crypto/dh/dh_key.c"
       );
        goto err;
    }


    if (BN_copy(pminus1, dh->params.p) == 
# 93 "../crypto/dh/dh_key.c" 3 4
                                         ((void *)0)
        
# 94 "../crypto/dh/dh_key.c"
       || !BN_sub_word(pminus1, 1)
        || BN_cmp(z, BN_value_one()) <= 0
        || BN_cmp(z, pminus1) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",97,__func__), ERR_set_error)((5),(128),
# 97 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 97 "../crypto/dh/dh_key.c"
       );
        goto err;
    }
...
int DH_compute_key_padded(unsigned char *key, const BIGNUM *pub_key, DH *dh)
{
    ...
    if (rv <= 0)
        return rv;
    pad = ((BN_num_bits(dh->params.p)+7)/8) - rv;
...
# 173 "../crypto/dh/dh_key.c" 3 4
   ((void *)0)
# 173 "../crypto/dh/dh_key.c"
       ,
    
# 174 "../crypto/dh/dh_key.c" 3 4
   ((void *)0)

# 175 "../crypto/dh/dh_key.c"
};
                                ...
                                const BIGNUM *priv_key, BIGNUM *pub_key)
{
    ...
    BIGNUM *prk = BN_new();
    BN_MONT_CTX *mont = 
# 234 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 234 "../crypto/dh/dh_key.c"
                           ;

    if (prk == 
# 236 "../crypto/dh/dh_key.c" 3 4
              ((void *)0)
# 236 "../crypto/dh/dh_key.c"
                  )
        return 0;
    ...
    if (dh->flags & 0x01) {
        ...
        if (mont == 
# 250 "../crypto/dh/dh_key.c" 3 4
                   ((void *)0)
# 250 "../crypto/dh/dh_key.c"
                       )
            goto err;
    }
    BN_with_flags(prk, priv_key, 0x04);
...
static int generate_key(DH *dh)
{
    ...
    BN_CTX *ctx = 
# 272 "../crypto/dh/dh_key.c" 3 4
                 ((void *)0)
# 272 "../crypto/dh/dh_key.c"
                     ;
    BIGNUM *pub_key = 
# 273 "../crypto/dh/dh_key.c" 3 4
                     ((void *)0)
# 273 "../crypto/dh/dh_key.c"
                         , *priv_key = 
# 273 "../crypto/dh/dh_key.c" 3 4
                                       ((void *)0)
# 273 "../crypto/dh/dh_key.c"
    ...
    if (BN_num_bits(dh->params.p) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",276,__func__), ERR_set_error)((5),(103),
# 276 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 276 "../crypto/dh/dh_key.c"
       );
        return 0;
    }

    if (dh->params.q != 
# 280 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
        
# 281 "../crypto/dh/dh_key.c"
       && BN_num_bits(dh->params.q) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",282,__func__), ERR_set_error)((5),(130),
# 282 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 282 "../crypto/dh/dh_key.c"
       );
        return 0;
    }

    if (BN_num_bits(dh->params.p) < 512) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",287,__func__), ERR_set_error)((5),(126),
# 287 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 287 "../crypto/dh/dh_key.c"
       );
        return 0;
    }
    ...
    ctx = BN_CTX_new_ex(dh->libctx);
    if (ctx == 
# 292 "../crypto/dh/dh_key.c" 3 4
              ((void *)0)
# 292 "../crypto/dh/dh_key.c"
                  )
        goto err;

    if (dh->priv_key == 
# 295 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 295 "../crypto/dh/dh_key.c"
                           ) {
        priv_key = BN_secure_new();
        if (priv_key == 
# 297 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 297 "../crypto/dh/dh_key.c"
                           )
            goto err;
        generate_new_key = 1;
    } else {
    ...
    if (dh->pub_key == 
# 304 "../crypto/dh/dh_key.c" 3 4
                      ((void *)0)
# 304 "../crypto/dh/dh_key.c"
                          ) {
        pub_key = BN_new();
        if (pub_key == 
# 306 "../crypto/dh/dh_key.c" 3 4
                      ((void *)0)
# 306 "../crypto/dh/dh_key.c"
                          )
            goto err;
    } else {
        pub_key = dh->pub_key;
    ...
    if (generate_new_key) {
        ...
        if (DH_get_nid(dh) != 0) {
            ...
            if (dh->params.q == 
# 317 "../crypto/dh/dh_key.c" 3 4
                               ((void *)0)
                
# 318 "../crypto/dh/dh_key.c"
            ...
            if (dh->params.q == 
# 329 "../crypto/dh/dh_key.c" 3 4
                               ((void *)0)
# 329 "../crypto/dh/dh_key.c"
                                   ) {
                ...
                if (dh->length != 0 && dh->length < l)
                    l = dh->length;
                if (!BN_priv_rand_ex(priv_key, l, 0,
                                     0, 0, ctx))
                    goto err;
...

            {
                ...
                if (!ossl_ffc_params_simple_validate(dh->libctx, &dh->params,
                                                     1, 
# 355 "../crypto/dh/dh_key.c" 3 4
                                                                       ((void *)0)
# 355 "../crypto/dh/dh_key.c"
                                                                           ))
                    goto err;
 ...
 err:
    if (ok != 1)
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",380,__func__), ERR_set_error)((5),((3 | (0x2 << 18L))),
# 380 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 380 "../crypto/dh/dh_key.c"
       );
...
int ossl_dh_buf2key(DH *dh, const unsigned char *buf, size_t len)
{
    int err_reason = 106;
    BIGNUM *pubkey = 
# 393 "../crypto/dh/dh_key.c" 3 4
                    ((void *)0)
# 393 "../crypto/dh/dh_key.c"
                        ;
    const BIGNUM *p;
    int ret;

    if ((pubkey = BN_bin2bn(buf, len, 
# 397 "../crypto/dh/dh_key.c" 3 4
                                     ((void *)0)
# 397 "../crypto/dh/dh_key.c"
                                         )) == 
# 397 "../crypto/dh/dh_key.c" 3 4
                                               ((void *)0)
# 397 "../crypto/dh/dh_key.c"
        ...
        goto err;
    DH_get0_pqg(dh, &p, 
# 399 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 399 "../crypto/dh/dh_key.c"
                           , 
# 399 "../crypto/dh/dh_key.c" 3 4
                             ((void *)0)
# 399 "../crypto/dh/dh_key.c"
    ...
    if (p == 
# 400 "../crypto/dh/dh_key.c" 3 4
            ((void *)0) 
# 400 "../crypto/dh/dh_key.c"
                 || ((BN_num_bits(p)+7)/8) == 0) {
        err_reason = 107;
        goto err;
    }
    ...
    if (DH_set0_key(dh, pubkey, 
# 409 "../crypto/dh/dh_key.c" 3 4
                               ((void *)0)
# 409 "../crypto/dh/dh_key.c"
                                   ) != 1)
        goto err;
    return 1;
err:
    (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",413,__func__), ERR_set_error)((5),(err_reason),
# 413 "../crypto/dh/dh_key.c" 3 4
   ((void *)0)
# 413 "../crypto/dh/dh_key.c"
   );
    BN_free(pubkey);
    return 0;
}
                       ...
                       int alloc)
{
    const BIGNUM *pubkey;
    unsigned char *pbuf = 
# 422 "../crypto/dh/dh_key.c" 3 4
                         ((void *)0)
# 422 "../crypto/dh/dh_key.c"
                             ;
    const BIGNUM *p;
    int p_size;

    DH_get0_pqg(dh, &p, 
# 426 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 426 "../crypto/dh/dh_key.c"
                           , 
# 426 "../crypto/dh/dh_key.c" 3 4
                             ((void *)0)
# 426 "../crypto/dh/dh_key.c"
                                 );
    DH_get0_key(dh, &pubkey, 
# 427 "../crypto/dh/dh_key.c" 3 4
                            ((void *)0)
# 427 "../crypto/dh/dh_key.c"
                                );
    if (p == 
# 428 "../crypto/dh/dh_key.c" 3 4
            ((void *)0) 
# 428 "../crypto/dh/dh_key.c"
                 || pubkey == 
# 428 "../crypto/dh/dh_key.c" 3 4
                              ((void *)0)
            
# 429 "../crypto/dh/dh_key.c"
           || (p_size = ((BN_num_bits(p)+7)/8)) == 0
            || ((BN_num_bits(pubkey)+7)/8) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",431,__func__), ERR_set_error)((5),(102),
# 431 "../crypto/dh/dh_key.c" 3 4
       ((void *)0)
# 431 "../crypto/dh/dh_key.c"
       );
        return 0;
    }
    if (pbuf_out != 
# 434 "../crypto/dh/dh_key.c" 3 4
                   ((void *)0) 
# 434 "../crypto/dh/dh_key.c"
                        && (alloc || *pbuf_out != 
# 434 "../crypto/dh/dh_key.c" 3 4
                                                  ((void *)0)
# 434 "../crypto/dh/dh_key.c"
        ...
        if (!alloc) {
            if (size >= (size_t)p_size)
                pbuf = *pbuf_out;
            if (pbuf == 
# 438 "../crypto/dh/dh_key.c" 3 4
                       ((void *)0)
# 438 "../crypto/dh/dh_key.c"
                           )
                (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",439,__func__), ERR_set_error)((5),(129),
# 439 "../crypto/dh/dh_key.c" 3 4
               ((void *)0)
# 439 "../crypto/dh/dh_key.c"
               );
        } else {
            pbuf = CRYPTO_malloc(p_size, "../crypto/dh/dh_key.c", 441);
        }


        if (pbuf == 
# 445 "../crypto/dh/dh_key.c" 3 4
                   ((void *)0)
# 445 "../crypto/dh/dh_key.c"
                       )
            return 0;
        ...
        if (BN_bn2binpad(pubkey, pbuf, p_size) < 0) {
            if (alloc)
                CRYPTO_free(pbuf, "../crypto/dh/dh_key.c", 453);
            (ERR_new(), ERR_set_debug("../crypto/dh/dh_key.c",454,__func__), ERR_set_error)((5),(106),
# 454 "../crypto/dh/dh_key.c" 3 4
           ((void *)0)
# 454 "../crypto/dh/dh_key.c"
           );
            return 0;
        }
        *pbuf_out = pbuf;
