# 0 "../crypto/dh/dh_kdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_kdf.c"
# 14 "../crypto/dh/dh_kdf.c"
...
# 18 "../crypto/dh/dh_kdf.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 19 "../crypto/dh/dh_kdf.c" 2
                           ...
                           OSSL_LIB_CTX *libctx, const char *propq)
{
    int ret = 0;
    EVP_KDF_CTX *kctx = 
# 35 "../crypto/dh/dh_kdf.c" 3 4
                       ((void *)0)
# 35 "../crypto/dh/dh_kdf.c"
                           ;
    EVP_KDF *kdf = 
# 36 "../crypto/dh/dh_kdf.c" 3 4
                  ((void *)0)
# 36 "../crypto/dh/dh_kdf.c"
                      ;
    OSSL_PARAM params[5], *p = params;
    const char *mdname = EVP_MD_get0_name(md);

    kdf = EVP_KDF_fetch(libctx, "X942KDF-ASN1", propq);
    if (kdf == 
# 41 "../crypto/dh/dh_kdf.c" 3 4
              ((void *)0)
# 41 "../crypto/dh/dh_kdf.c"
                  )
        return 0;
    kctx = EVP_KDF_CTX_new(kdf);
    if (kctx == 
# 44 "../crypto/dh/dh_kdf.c" 3 4
               ((void *)0)
# 44 "../crypto/dh/dh_kdf.c"
                   )
        goto err;
    ...
    *p++ = OSSL_PARAM_construct_octet_string("key",
    ...
    if (ukm != 
# 51 "../crypto/dh/dh_kdf.c" 3 4
              ((void *)0)
# 51 "../crypto/dh/dh_kdf.c"
                  )
        *p++ = OSSL_PARAM_construct_octet_string("ukm",
                 ...
                 const unsigned char *ukm, size_t ukmlen, const EVP_MD *md)
{
    ...
    return ossl_dh_kdf_X9_42_asn1(out, outlen, Z, Zlen, key_alg,
                                  ukm, ukmlen, md, libctx, 
# 78 "../crypto/dh/dh_kdf.c" 3 4
                                                          ((void *)0)
# 78 "../crypto/dh/dh_kdf.c"
                                                              );
}
