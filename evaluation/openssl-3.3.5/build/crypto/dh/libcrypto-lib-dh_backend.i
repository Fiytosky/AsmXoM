# 0 "../crypto/dh/dh_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dh/dh_backend.c"
# 14 "../crypto/dh/dh_backend.c"
...
# 17 "../crypto/dh/dh_backend.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/dh/dh_backend.c" 2
...
int ossl_dh_params_fromdata(DH *dh, const OSSL_PARAM params[])
{
    ...
    param_priv_len =
        OSSL_PARAM_locate_const(params, "priv_len");
    if (param_priv_len != 
# 52 "../crypto/dh/dh_backend.c" 3 4
                         ((void *)0)
        
# 53 "../crypto/dh/dh_backend.c"
...
int ossl_dh_key_fromdata(DH *dh, const OSSL_PARAM params[], int include_private)
{
    ...
    BIGNUM *priv_key = 
# 63 "../crypto/dh/dh_backend.c" 3 4
                      ((void *)0)
# 63 "../crypto/dh/dh_backend.c"
                          , *pub_key = 
# 63 "../crypto/dh/dh_backend.c" 3 4
                                       ((void *)0)
# 63 "../crypto/dh/dh_backend.c"
    ...
    if (dh == 
# 65 "../crypto/dh/dh_backend.c" 3 4
             ((void *)0)
# 65 "../crypto/dh/dh_backend.c"
                 )
        return 0;
    ...
    if (include_private
        && param_priv_key != 
# 72 "../crypto/dh/dh_backend.c" 3 4
                            ((void *)0)
        
# 73 "../crypto/dh/dh_backend.c"
       && !OSSL_PARAM_get_BN(param_priv_key, &priv_key))
        goto err;

    if (param_pub_key != 
# 76 "../crypto/dh/dh_backend.c" 3 4
                        ((void *)0)
        
# 77 "../crypto/dh/dh_backend.c"
...
int ossl_dh_params_todata(DH *dh, OSSL_PARAM_BLD *bld, OSSL_PARAM params[])
{
    ...
    if (!ossl_ffc_params_todata(ossl_dh_get0_params(dh), bld, params))
        return 0;
    if (l > 0
        && !ossl_param_build_set_long(bld, params, "priv_len", l))
        return 0;
    return 1;
}
...
{
    const BIGNUM *priv = 
# 106 "../crypto/dh/dh_backend.c" 3 4
                        ((void *)0)
# 106 "../crypto/dh/dh_backend.c"
                            , *pub = 
# 106 "../crypto/dh/dh_backend.c" 3 4
                                     ((void *)0)
# 106 "../crypto/dh/dh_backend.c"
    ...
    if (dh == 
# 108 "../crypto/dh/dh_backend.c" 3 4
             ((void *)0)
# 108 "../crypto/dh/dh_backend.c"
                 )
        return 0;

    DH_get0_key(dh, &pub, &priv);
    if (priv != 
# 112 "../crypto/dh/dh_backend.c" 3 4
               ((void *)0)
        
# 113 "../crypto/dh/dh_backend.c"
       && include_private
        && !ossl_param_build_set_bn(bld, params, "priv", priv))
        return 0;
    if (pub != 
# 116 "../crypto/dh/dh_backend.c" 3 4
              ((void *)0)
        
# 117 "../crypto/dh/dh_backend.c"
...
int ossl_dh_is_foreign(const DH *dh)
{
    ...
    if (dh->engine != 
# 126 "../crypto/dh/dh_backend.c" 3 4
                     ((void *)0) 
# 126 "../crypto/dh/dh_backend.c"
                          || ossl_dh_get_method(dh) != DH_OpenSSL())
        return 1;
...
{
    if (f != 
# 134 "../crypto/dh/dh_backend.c" 3 4
            ((void *)0) 
# 134 "../crypto/dh/dh_backend.c"
                 && (*out = BN_dup(f)) == 
# 134 "../crypto/dh/dh_backend.c" 3 4
                                          ((void *)0)
# 134 "../crypto/dh/dh_backend.c"
...
{
    DH *dupkey = 
# 141 "../crypto/dh/dh_backend.c" 3 4
                ((void *)0)
# 141 "../crypto/dh/dh_backend.c"
                    ;


    if (ossl_dh_is_foreign(dh))
        return 
# 145 "../crypto/dh/dh_backend.c" 3 4
              ((void *)0)
# 145 "../crypto/dh/dh_backend.c"
                  ;

    if ((dupkey = ossl_dh_new_ex(dh->libctx)) == 
# 147 "../crypto/dh/dh_backend.c" 3 4
                                                ((void *)0)
# 147 "../crypto/dh/dh_backend.c"
                                                    )
        return 
# 148 "../crypto/dh/dh_backend.c" 3 4
              ((void *)0)
# 148 "../crypto/dh/dh_backend.c"
                  ;
 ...
 err:
    DH_free(dupkey);
    return 
# 177 "../crypto/dh/dh_backend.c" 3 4
          ((void *)0)
# 177 "../crypto/dh/dh_backend.c"
              ;
}
                           ...
                           OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    const X509_ALGOR *palg;
    BIGNUM *privkey_bn = 
# 190 "../crypto/dh/dh_backend.c" 3 4
                        ((void *)0)
# 190 "../crypto/dh/dh_backend.c"
                            ;
    ASN1_INTEGER *privkey = 
# 191 "../crypto/dh/dh_backend.c" 3 4
                           ((void *)0)
# 191 "../crypto/dh/dh_backend.c"
                               ;
    DH *dh = 
# 192 "../crypto/dh/dh_backend.c" 3 4
            ((void *)0)
# 192 "../crypto/dh/dh_backend.c"
                ;

    if (!PKCS8_pkey_get0(
# 194 "../crypto/dh/dh_backend.c" 3 4
                        ((void *)0)
# 194 "../crypto/dh/dh_backend.c"
                            , &p, &pklen, &palg, p8inf))
        return 0;

    X509_ALGOR_get0(
# 197 "../crypto/dh/dh_backend.c" 3 4
                   ((void *)0)
# 197 "../crypto/dh/dh_backend.c"
                       , &ptype, &pval, palg);

    if (ptype != 16)
        goto decerr;
    if ((privkey = d2i_ASN1_INTEGER(
# 201 "../crypto/dh/dh_backend.c" 3 4
                                   ((void *)0)
# 201 "../crypto/dh/dh_backend.c"
                                       , &p, pklen)) == 
# 201 "../crypto/dh/dh_backend.c" 3 4
                                                        ((void *)0)
# 201 "../crypto/dh/dh_backend.c"
    ...
    case 28:
        dh = d2i_DHparams(
# 209 "../crypto/dh/dh_backend.c" 3 4
                         ((void *)0)
# 209 "../crypto/dh/dh_backend.c"
                             , &pm, pmlen);
        break;
    case 920:
        dh = d2i_DHxparams(
# 212 "../crypto/dh/dh_backend.c" 3 4
                          ((void *)0)
# 212 "../crypto/dh/dh_backend.c"
                              , &pm, pmlen);
        break;
    default:
        goto decerr;
    ...
    if (dh == 
# 217 "../crypto/dh/dh_backend.c" 3 4
             ((void *)0)
# 217 "../crypto/dh/dh_backend.c"
                 )
        goto decerr;


    if ((privkey_bn = BN_secure_new()) == 
# 221 "../crypto/dh/dh_backend.c" 3 4
                                         ((void *)0)
        
# 222 "../crypto/dh/dh_backend.c"
       || !ASN1_INTEGER_to_BN(privkey, privkey_bn)) {
        (ERR_new(), ERR_set_debug("../crypto/dh/dh_backend.c",223,__func__), ERR_set_error)((5),(106),
# 223 "../crypto/dh/dh_backend.c" 3 4
       ((void *)0)
# 223 "../crypto/dh/dh_backend.c"
       );
        BN_clear_free(privkey_bn);
        goto dherr;
    }
    if (!DH_set0_key(dh, 
# 227 "../crypto/dh/dh_backend.c" 3 4
                        ((void *)0)
# 227 "../crypto/dh/dh_backend.c"
                            , privkey_bn))
        goto dherr;
 ...
 decerr:
    (ERR_new(), ERR_set_debug("../crypto/dh/dh_backend.c",236,__func__), ERR_set_error)((5),(114),
# 236 "../crypto/dh/dh_backend.c" 3 4
   ((void *)0)
# 236 "../crypto/dh/dh_backend.c"
   );
 dherr:
    DH_free(dh);
    dh = 
# 239 "../crypto/dh/dh_backend.c" 3 4
        ((void *)0)
# 239 "../crypto/dh/dh_backend.c"
            ;
 done:
