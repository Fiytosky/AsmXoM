# 0 "crypto/params_idx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "crypto/params_idx.c"
# 14 "crypto/params_idx.c"
...
# 17 "crypto/params_idx.c" 2



# 19 "crypto/params_idx.c"
int ossl_param_find_pidx(const char *s)
{
    switch(s[0]) {
    default:
