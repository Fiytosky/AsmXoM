# 0 "../crypto/cmp/cmp_status.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_status.c"
# 14 "../crypto/cmp/cmp_status.c"
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_first(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_last(void);



__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_next(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_prev(ENGINE *e);



__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_add(ENGINE *e);



__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_remove(ENGINE *e);



__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_by_id(const char *id);
# 358 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_load_builtin_engines(void);
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) unsigned int ENGINE_get_table_flags(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_set_table_flags(unsigned int flags);
# 378 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_RSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_RSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_RSA(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_DSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_DSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_DSA(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_EC(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_EC(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_EC(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_DH(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_DH(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_DH(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_RAND(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_RAND(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_RAND(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_ciphers(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_ciphers(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_ciphers(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_digests(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_digests(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_digests(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_pkey_meths(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_pkey_meths(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_pkey_meths(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_pkey_asn1_meths(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_unregister_pkey_asn1_meths(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_register_all_pkey_asn1_meths(void);
# 414 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_complete(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_register_all_complete(void);
# 429 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_ctrl(ENGINE *e, int cmd, long i, void *p,
                                      void (*f) (void));
# 440 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_cmd_is_executable(ENGINE *e, int cmd);
# 450 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_ctrl_cmd(ENGINE *e, const char *cmd_name,
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_new(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_free(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_up_ref(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_id(ENGINE *e, const char *id);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_name(ENGINE *e, const char *name);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_RSA(ENGINE *e, const RSA_METHOD *rsa_meth);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_DSA(ENGINE *e, const DSA_METHOD *dsa_meth);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_EC(ENGINE *e, const EC_KEY_METHOD *ecdsa_meth);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_DH(ENGINE *e, const DH_METHOD *dh_meth);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_RAND(ENGINE *e, const RAND_METHOD *rand_meth);
__attribute__((deprecated("Since OpenSSL " "3.0")))
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_flags(ENGINE *e, int flags);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_cmd_defns(ENGINE *e,
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_ex_data(ENGINE *e, int idx, void *arg);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void *ENGINE_get_ex_data(const ENGINE *e, int idx);
# 552 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) const char *ENGINE_get_id(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const char *ENGINE_get_name(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const RSA_METHOD *ENGINE_get_RSA(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const DSA_METHOD *ENGINE_get_DSA(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const EC_KEY_METHOD *ENGINE_get_EC(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const DH_METHOD *ENGINE_get_DH(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) const RAND_METHOD *ENGINE_get_RAND(const ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0")))
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_get_flags(const ENGINE *e);
# 620 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_init(ENGINE *e);
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_finish(ENGINE *e);
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_default_RSA(void);



__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_default_DSA(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_default_EC(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_default_DH(void);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_default_RAND(void);
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_cipher_engine(int nid);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_digest_engine(int nid);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_pkey_meth_engine(int nid);
__attribute__((deprecated("Since OpenSSL " "3.0"))) ENGINE *ENGINE_get_pkey_asn1_meth_engine(int nid);
# 684 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_RSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_string(ENGINE *e,
                                                    const char *def_list);



__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_DSA(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_EC(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_DH(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_RAND(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_ciphers(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_digests(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_pkey_meths(ENGINE *e);
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default_pkey_asn1_meths(ENGINE *e);
# 708 "../include/openssl/engine.h"
__attribute__((deprecated("Since OpenSSL " "3.0"))) int ENGINE_set_default(ENGINE *e, unsigned int flags);
__attribute__((deprecated("Since OpenSSL " "3.0"))) void ENGINE_add_conf_module(void);
...
int ossl_cmp_pkisi_get_status(const OSSL_CMP_PKISI *si)
{
    ...
    if (!__builtin_expect(!!((si != 
# 35 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0) 
# 35 "../crypto/cmp/cmp_status.c"
        && si->status != 
# 35 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0)
# 35 "../crypto/cmp/cmp_status.c"
...
const char *ossl_cmp_PKIStatus_to_string(int status)
{
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_status.c",59,__func__), ERR_set_error)(58, 107,
                       "PKIStatus: invalid=%d", status);
        return 
# 61 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 61 "../crypto/cmp/cmp_status.c"
                  ;
    }
}
...
{
    if (!__builtin_expect(!!((si != 
# 67 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0)
# 67 "../crypto/cmp/cmp_status.c"
        ) != 0), 1))
        return 
# 68 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 68 "../crypto/cmp/cmp_status.c"
                  ;
...
int ossl_cmp_pkisi_get_pkifailureinfo(const OSSL_CMP_PKISI *si)
{
    ...
    if (!__builtin_expect(!!((si != 
# 77 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0)
# 77 "../crypto/cmp/cmp_status.c"
        ) != 0), 1))
        return -1;
    if (si->failInfo != 
# 79 "../crypto/cmp/cmp_status.c" 3 4
                       ((void *)0)
# 79 "../crypto/cmp/cmp_status.c"
                           )
        for (i = 0; i <= 26; i++)
...
static const char *CMP_PKIFAILUREINFO_to_string(int number)
{
    ...
    default:
        return 
# 148 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 148 "../crypto/cmp/cmp_status.c"
                  ;
    }
}
...
{
    if (!__builtin_expect(!!((si != 
# 154 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0) 
# 154 "../crypto/cmp/cmp_status.c"
        && si->failInfo != 
# 154 "../crypto/cmp/cmp_status.c" 3 4
        ((void *)0)
# 154 "../crypto/cmp/cmp_status.c"
        ...
        return -1;
    if (bit_index < 0 || bit_index > 26) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_status.c",157,__func__), ERR_set_error)((58),(100),
# 157 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 157 "../crypto/cmp/cmp_status.c"
       );
        return -1;
    }
                                  ...
                                  char *buf, size_t bufsize)
{
    ...
    if (buf == 
# 182 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
            
# 183 "../crypto/cmp/cmp_status.c"
           || status < 0
            || (status_string = ossl_cmp_PKIStatus_to_string(status)) == 
# 184 "../crypto/cmp/cmp_status.c" 3 4
                                                                        ((void *)0)
# 184 "../crypto/cmp/cmp_status.c"
                                                                            )
        return 
# 185 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 185 "../crypto/cmp/cmp_status.c"
                  ;
    ...
    if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 194 "../crypto/cmp/cmp_status.c" 3 4
   ((void *)0)
# 194 "../crypto/cmp/cmp_status.c"
   ; write_ptr += printed_chars; bufsize -= printed_chars;;
    ...
    if (fail_info != -1 && fail_info != 0) {
        ...
        if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 202 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 202 "../crypto/cmp/cmp_status.c"
       ; write_ptr += printed_chars; bufsize -= printed_chars;;
        for (failure = 0; failure <= 26; failure++) {
            if ((fail_info & (1 << failure)) != 0) {
                failure_string = CMP_PKIFAILUREINFO_to_string(failure);
                if (failure_string != 
# 206 "../crypto/cmp/cmp_status.c" 3 4
                                     ((void *)0)
# 206 "../crypto/cmp/cmp_status.c"
                                         ) {
                    printed_chars = BIO_snprintf(write_ptr, bufsize, "%s%s",
                                                 failinfo_found ? ", " : "",
                                                 failure_string);
                    if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 210 "../crypto/cmp/cmp_status.c" 3 4
                   ((void *)0)
# 210 "../crypto/cmp/cmp_status.c"
                   ; write_ptr += printed_chars; bufsize -= printed_chars;;
                    failinfo_found = 1;
                }
            }
    ...
    if (!failinfo_found && status != 0
            && status != 1) {
        printed_chars = BIO_snprintf(write_ptr, bufsize, "; <no failure info>");
        if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 219 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 219 "../crypto/cmp/cmp_status.c"
       ; write_ptr += printed_chars; bufsize -= printed_chars;;
    }


    n_status_strings = OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(status_strings));
    if (n_status_strings > 0) {
        printed_chars = BIO_snprintf(write_ptr, bufsize, "; StatusString%s: ",
                                     n_status_strings > 1 ? "s" : "");
        if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 227 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 227 "../crypto/cmp/cmp_status.c"
       ; write_ptr += printed_chars; bufsize -= printed_chars;;
        for (i = 0; i < n_status_strings; i++) {
            text = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(status_strings), (i)));
            printed_chars = BIO_snprintf(write_ptr, bufsize, "\"%.*s\"%s",
                                         ASN1_STRING_length(text),
                                         ASN1_STRING_get0_data(text),
                                         i < n_status_strings - 1 ? ", " : "");
            if (printed_chars < 0 || (size_t)printed_chars >= bufsize) return 
# 234 "../crypto/cmp/cmp_status.c" 3 4
           ((void *)0)
# 234 "../crypto/cmp/cmp_status.c"
           ; write_ptr += printed_chars; bufsize -= printed_chars;;
        }
    }
                                     ...
                                     char *buf, size_t bufsize)
{
    ...
    if (statusInfo == 
# 246 "../crypto/cmp/cmp_status.c" 3 4
                     ((void *)0)
# 246 "../crypto/cmp/cmp_status.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_status.c",247,__func__), ERR_set_error)((58),(103),
# 247 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 247 "../crypto/cmp/cmp_status.c"
       );
        return 
# 248 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 248 "../crypto/cmp/cmp_status.c"
                  ;
    }
...
{
    if (ctx == 
# 261 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 261 "../crypto/cmp/cmp_status.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_status.c",262,__func__), ERR_set_error)((58),(103),
# 262 "../crypto/cmp/cmp_status.c" 3 4
       ((void *)0)
# 262 "../crypto/cmp/cmp_status.c"
       );
        return 
# 263 "../crypto/cmp/cmp_status.c" 3 4
              ((void *)0)
# 263 "../crypto/cmp/cmp_status.c"
                  ;
    }
...
# 282 "../crypto/cmp/cmp_status.c" 3 4
                                ((void *)0)
# 282 "../crypto/cmp/cmp_status.c"
                                    ;
    int failure;

    if (si == 
# 285 "../crypto/cmp/cmp_status.c" 3 4
             ((void *)0)
# 285 "../crypto/cmp/cmp_status.c"
                 )
        goto err;
    ...
    if (text != 
# 290 "../crypto/cmp/cmp_status.c" 3 4
               ((void *)0)
# 290 "../crypto/cmp/cmp_status.c"
                   ) {
        if ((utf8_text = ASN1_UTF8STRING_new()) == 
# 291 "../crypto/cmp/cmp_status.c" 3 4
                                                  ((void *)0)
                
# 292 "../crypto/cmp/cmp_status.c"
               || !ASN1_STRING_set(utf8_text, text, -1))
            goto err;
        if ((si->statusString = ((struct stack_st_ASN1_UTF8STRING *)OPENSSL_sk_new_null())) == 
# 294 "../crypto/cmp/cmp_status.c" 3 4
                                                                 ((void *)0)
# 294 "../crypto/cmp/cmp_status.c"
                                                                     )
            goto err;
        if (!OPENSSL_sk_push(ossl_check_ASN1_UTF8STRING_sk_type(si->statusString), ossl_check_ASN1_UTF8STRING_type(utf8_text)))
            goto err;

        utf8_text = 
# 299 "../crypto/cmp/cmp_status.c" 3 4
                   ((void *)0)
# 299 "../crypto/cmp/cmp_status.c"
                       ;
    }
    ...
    for (failure = 0; failure <= 26; failure++) {
        if ((fail_info & (1 << failure)) != 0) {
            if (si->failInfo == 
# 304 "../crypto/cmp/cmp_status.c" 3 4
                               ((void *)0)
                    
# 305 "../crypto/cmp/cmp_status.c"
                   && (si->failInfo = ASN1_BIT_STRING_new()) == 
# 305 "../crypto/cmp/cmp_status.c" 3 4
                                                                ((void *)0)
# 305 "../crypto/cmp/cmp_status.c"
                                                                    )
                goto err;
 ...
 err:
    ...
    return 
# 316 "../crypto/cmp/cmp_status.c" 3 4
          ((void *)0)
# 316 "../crypto/cmp/cmp_status.c"
              ;
}
