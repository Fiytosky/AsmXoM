# 0 "../crypto/cmp/cmp_genm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_genm.c"
# 11 "../crypto/cmp/cmp_genm.c"
...
static const X509_VERIFY_PARAM *get0_trustedStore_vpm(const OSSL_CMP_CTX *ctx)
{
    ...
    return ts == 
# 18 "../crypto/cmp/cmp_genm.c" 3 4
                ((void *)0) 
# 18 "../crypto/cmp/cmp_genm.c"
                     ? 
# 18 "../crypto/cmp/cmp_genm.c" 3 4
                       ((void *)0) 
# 18 "../crypto/cmp/cmp_genm.c"
...
{
    char *subj = X509_NAME_oneline(X509_get_subject_name(cert), 
# 25 "../crypto/cmp/cmp_genm.c" 3 4
                                                               ((void *)0)
# 25 "../crypto/cmp/cmp_genm.c"
                                                                   , 0);
    ...
    ossl_cmp_print_log(level, ctx, func, file, lineno,
                       ...
                       source, subj, msg);
    CRYPTO_free(subj, "../crypto/cmp/cmp_genm.c", 31);
}
                           ...
                           int type_CA, const X509_VERIFY_PARAM *vpm)
{
    ...
    OSSL_CMP_severity level =
        vpm == 
# 43 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0) 
# 43 "../crypto/cmp/cmp_genm.c"
                   ? 4 : 3;

    if (!ret)
        cert_msg(__func__, "../crypto/cmp/cmp_genm.c", 46, level, ctx,
                 source, cert, res > 0 ? "has expired" : "not yet valid");
    if (type_CA >= 0 && (ex_flags & 0x40) == 0) {
        int is_CA = (ex_flags & 0x10) != 0;

        if ((type_CA != 0) != is_CA) {
            cert_msg(__func__, "../crypto/cmp/cmp_genm.c", 52, level, ctx,
                     source, cert,
                               ...
                               int type_CA, const X509_VERIFY_PARAM *vpm)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++)
        ret = ossl_X509_check(ctx, source,
                              ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i))), type_CA, vpm)
            && ret;
    return ret;
}
...
# 79 "../crypto/cmp/cmp_genm.c" 3 4
                                    ((void *)0)
# 79 "../crypto/cmp/cmp_genm.c"
                                        ;
    int i, n;

    if (ctx == 
# 82 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0)
# 82 "../crypto/cmp/cmp_genm.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",83,__func__), ERR_set_error)((58),(103),
# 83 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 83 "../crypto/cmp/cmp_genm.c"
       );
        goto err;
    }
    if (OSSL_CMP_CTX_get_status(ctx) != -1) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",87,__func__), ERR_set_error)(58, 191,
    ...
    if (!OSSL_CMP_CTX_push0_genm_ITAV(ctx, req))
        goto err;
    req = 
# 94 "../crypto/cmp/cmp_genm.c" 3 4
         ((void *)0)
# 94 "../crypto/cmp/cmp_genm.c"
             ;
    itavs = OSSL_CMP_exec_GENM_ses(ctx);
    if (itavs == 
# 96 "../crypto/cmp/cmp_genm.c" 3 4
                ((void *)0)
# 96 "../crypto/cmp/cmp_genm.c"
                    ) {
        if (OSSL_CMP_CTX_get_status(ctx) != -3)
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",98,__func__), ERR_set_error)(58, 192,
                           "with infoType %s", desc);
        return 
# 100 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0)
# 100 "../crypto/cmp/cmp_genm.c"
                  ;
    }

    if ((n = OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(itavs))) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",104,__func__), ERR_set_error)(58, 193,
                       "response on genm requesting infoType %s does not include suitable value", desc);
        OPENSSL_sk_free(ossl_check_OSSL_CMP_ITAV_sk_type(itavs));
        return 
# 107 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0)
# 107 "../crypto/cmp/cmp_genm.c"
                  ;
    }

    if (n > 1)
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_genm.c", 111, "WARN", "response on genm contains %d ITAVs; will use the first ITAV with infoType id-it-%s", n, desc)

                              ;
    for (i = 0; i < n; i++) {
        OSSL_CMP_ITAV *itav = ((OSSL_CMP_ITAV *)OPENSSL_sk_shift(ossl_check_OSSL_CMP_ITAV_sk_type(itavs)));
        ...
        if (OBJ_obj2nid(obj) == expected) {
            for (i++; i < n; i++)
                OSSL_CMP_ITAV_free(((OSSL_CMP_ITAV *)OPENSSL_sk_shift(ossl_check_OSSL_CMP_ITAV_sk_type(itavs))));
            OPENSSL_sk_free(ossl_check_OSSL_CMP_ITAV_sk_type(itavs));
            return itav;
        }
        ...
        if (OBJ_obj2txt(name + offset, sizeof(name) - offset, obj, 0) < 0)
            strcat(name, "<unknown>");
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_genm.c", 129, "WARN", "%s' while expecting 'id-it-%s'", name, desc);
        OSSL_CMP_ITAV_free(itav);
    }
    (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",132,__func__), ERR_set_error)(58, 193,
 ...
 err:
    ...
    return 
# 138 "../crypto/cmp/cmp_genm.c" 3 4
          ((void *)0)
# 138 "../crypto/cmp/cmp_genm.c"
              ;
}
...
int OSSL_CMP_get1_caCerts(OSSL_CMP_CTX *ctx, struct stack_st_X509 **out)
{
    ...
    struct stack_st_X509 *certs = 
# 144 "../crypto/cmp/cmp_genm.c" 3 4
                           ((void *)0)
# 144 "../crypto/cmp/cmp_genm.c"
                               ;
    int ret = 0;

    if (out == 
# 147 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0)
# 147 "../crypto/cmp/cmp_genm.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",148,__func__), ERR_set_error)((58),(103),
# 148 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 148 "../crypto/cmp/cmp_genm.c"
       );
        return 0;
    }
    *out = 
# 151 "../crypto/cmp/cmp_genm.c" 3 4
          ((void *)0)
# 151 "../crypto/cmp/cmp_genm.c"
              ;

    if ((req = OSSL_CMP_ITAV_new_caCerts(
# 153 "../crypto/cmp/cmp_genm.c" 3 4
                                        ((void *)0)
# 153 "../crypto/cmp/cmp_genm.c"
                                            )) == 
# 153 "../crypto/cmp/cmp_genm.c" 3 4
                                                  ((void *)0)
# 153 "../crypto/cmp/cmp_genm.c"
        ...
        return 0;
    if ((itav = get_genm_itav(ctx, req, 1223, "caCerts")) == 
# 155 "../crypto/cmp/cmp_genm.c" 3 4
                                                                         ((void *)0)
# 155 "../crypto/cmp/cmp_genm.c"
                                                                             )
        return 0;
    ...
    ret = 1;
    if (certs == 
# 160 "../crypto/cmp/cmp_genm.c" 3 4
                ((void *)0)
# 160 "../crypto/cmp/cmp_genm.c"
                    )
        goto end;

    if (!ossl_X509_check_all(ctx, "genp", certs, 1 ,
                             get0_trustedStore_vpm(ctx))) {
        ret = 0;
        goto end;
    }
    *out = ((struct stack_st_X509 *)OPENSSL_sk_new_reserve(ossl_check_X509_compfunc_type(
# 168 "../crypto/cmp/cmp_genm.c" 3 4
          ((void *)0)
# 168 "../crypto/cmp/cmp_genm.c"
          ), (OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)))));
    if (!X509_add_certs(*out, certs,
                        0x1 | 0x4)) {
        OPENSSL_sk_pop_free(ossl_check_X509_sk_type(*out),ossl_check_X509_freefunc_type(X509_free));
        *out = 
# 172 "../crypto/cmp/cmp_genm.c" 3 4
              ((void *)0)
# 172 "../crypto/cmp/cmp_genm.c"
                  ;
        ret = 0;
    }
...
static int selfsigned_verify_cb(int ok, X509_STORE_CTX *store_ctx)
{
    if (ok == 0
        ...
        int i;
        struct stack_st_X509 *trust;
        struct stack_st_X509 *chain = X509_STORE_CTX_get0_chain(store_ctx);
        struct stack_st_X509 *untrusted = X509_STORE_CTX_get0_untrusted(store_ctx);
        X509_STORE_CTX_check_issued_fn check_issued =
            X509_STORE_CTX_get_check_issued(store_ctx);
        X509 *cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (0)));
        X509 *issuer;

        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(untrusted)); i++) {
            cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(untrusted), (i)));
            if (!X509_add_cert(chain, cert, 0x1))
                return 0;
        }

        trust = X509_STORE_get1_all_certs(X509_STORE_CTX_get0_store(store_ctx));
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(trust)); i++) {
            issuer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(trust), (i)));
        ...
        OPENSSL_sk_pop_free(ossl_check_X509_sk_type(trust),ossl_check_X509_freefunc_type(X509_free));
        return ok;
    } else {
        ...
        if (ts == 
# 218 "../crypto/cmp/cmp_genm.c" 3 4
                 ((void *)0) 
# 218 "../crypto/cmp/cmp_genm.c"
...
static int verify_ss_cert(OSSL_LIB_CTX *libctx, const char *propq,
                          X509_STORE *ts, struct stack_st_X509 *untrusted,
                          X509 *target)
{
    X509_STORE_CTX *csc = 
# 229 "../crypto/cmp/cmp_genm.c" 3 4
                         ((void *)0)
# 229 "../crypto/cmp/cmp_genm.c"
                             ;
    int ok = 0;

    if (ts == 
# 232 "../crypto/cmp/cmp_genm.c" 3 4
             ((void *)0) 
# 232 "../crypto/cmp/cmp_genm.c"
                  || target == 
# 232 "../crypto/cmp/cmp_genm.c" 3 4
                               ((void *)0)
# 232 "../crypto/cmp/cmp_genm.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",233,__func__), ERR_set_error)((58),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 233 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 233 "../crypto/cmp/cmp_genm.c"
       );
        return 0;
    }

    if ((csc = X509_STORE_CTX_new_ex(libctx, propq)) == 
# 237 "../crypto/cmp/cmp_genm.c" 3 4
                                                       ((void *)0)
            
# 238 "../crypto/cmp/cmp_genm.c"
...
static int
verify_ss_cert_trans(OSSL_CMP_CTX *ctx, X509 *trusted ,
                     X509 *trans ,
                     X509 *target, const char *desc)
{
    X509_STORE *ts = OSSL_CMP_CTX_get0_trustedStore(ctx);
    struct stack_st_X509 *untrusted = 
# 254 "../crypto/cmp/cmp_genm.c" 3 4
                               ((void *)0)
# 254 "../crypto/cmp/cmp_genm.c"
                                   ;
    int res = 0;

    if (trusted != 
# 257 "../crypto/cmp/cmp_genm.c" 3 4
                  ((void *)0)
# 257 "../crypto/cmp/cmp_genm.c"
                      ) {
        X509_VERIFY_PARAM *vpm = X509_STORE_get0_param(ts);

        if ((ts = X509_STORE_new()) == 
# 260 "../crypto/cmp/cmp_genm.c" 3 4
                                      ((void *)0)
# 260 "../crypto/cmp/cmp_genm.c"
                                          )
            return 0;
    ...
    if (trans != 
# 267 "../crypto/cmp/cmp_genm.c" 3 4
                ((void *)0)
            
# 268 "../crypto/cmp/cmp_genm.c"
           && !ossl_x509_add_cert_new(&untrusted, trans, 0x1))
        goto err;
    ...
    res = verify_ss_cert(OSSL_CMP_CTX_get0_libctx(ctx),
                         ...
                         ts, untrusted, target);
    if (!res)
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",275,__func__), ERR_set_error)(58, 195,
                       "failed to validate %s certificate received in genp %s",
                       desc, trusted == 
# 277 "../crypto/cmp/cmp_genm.c" 3 4
                                       ((void *)0) 
# 277 "../crypto/cmp/cmp_genm.c"
                                            ? "using trust store"
                       : "with given certificate as trust anchor");

 err:
    OPENSSL_sk_pop_free(ossl_check_X509_sk_type(untrusted),ossl_check_X509_freefunc_type(X509_free));
    if (trusted != 
# 282 "../crypto/cmp/cmp_genm.c" 3 4
                  ((void *)0)
# 282 "../crypto/cmp/cmp_genm.c"
                      )
        X509_STORE_free(ts);
    return res;
}
...
int OSSL_CMP_get1_rootCaKeyUpdate(OSSL_CMP_CTX *ctx,
                                  ...
                                  X509 **newWithOld, X509 **oldWithNew)
{
    X509 *oldWithOld_copy = 
# 291 "../crypto/cmp/cmp_genm.c" 3 4
                           ((void *)0)
# 291 "../crypto/cmp/cmp_genm.c"
                               , *my_newWithOld, *my_oldWithNew;
    OSSL_CMP_ITAV *req, *itav;
    int res = 0;

    if (newWithNew == 
# 295 "../crypto/cmp/cmp_genm.c" 3 4
                     ((void *)0)
# 295 "../crypto/cmp/cmp_genm.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",296,__func__), ERR_set_error)((58),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 296 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 296 "../crypto/cmp/cmp_genm.c"
       );
        return 0;
    }
    *newWithNew = 
# 299 "../crypto/cmp/cmp_genm.c" 3 4
                 ((void *)0)
# 299 "../crypto/cmp/cmp_genm.c"
                     ;

    if ((req = OSSL_CMP_ITAV_new_rootCaCert(oldWithOld)) == 
# 301 "../crypto/cmp/cmp_genm.c" 3 4
                                                           ((void *)0)
# 301 "../crypto/cmp/cmp_genm.c"
                                                               )
        return 0;
    itav = get_genm_itav(ctx, req, 1224, "rootCaKeyUpdate");
    if (itav == 
# 304 "../crypto/cmp/cmp_genm.c" 3 4
               ((void *)0)
# 304 "../crypto/cmp/cmp_genm.c"
                   )
        return 0;
    ...
    if (*newWithNew == 
# 311 "../crypto/cmp/cmp_genm.c" 3 4
                      ((void *)0)
# 311 "../crypto/cmp/cmp_genm.c"
                          ) {
        res = 1;
        goto end;
    }
    if ((oldWithOld_copy = X509_dup(oldWithOld)) == 
# 315 "../crypto/cmp/cmp_genm.c" 3 4
                                                   ((void *)0) 
# 315 "../crypto/cmp/cmp_genm.c"
                                                        && oldWithOld != 
# 315 "../crypto/cmp/cmp_genm.c" 3 4
                                                                         ((void *)0)
# 315 "../crypto/cmp/cmp_genm.c"
    ...
    if (!verify_ss_cert_trans(ctx, oldWithOld_copy, my_newWithOld,
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",319,__func__), ERR_set_error)((58),(195),
# 319 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 319 "../crypto/cmp/cmp_genm.c"
       );
        goto end;
    }
    if (oldWithOld != 
# 322 "../crypto/cmp/cmp_genm.c" 3 4
                     ((void *)0) 
# 322 "../crypto/cmp/cmp_genm.c"
                          && my_oldWithNew != 
# 322 "../crypto/cmp/cmp_genm.c" 3 4
                                              ((void *)0)
        
# 323 "../crypto/cmp/cmp_genm.c"
       && !verify_ss_cert_trans(ctx, *newWithNew, my_oldWithNew,
                                 oldWithOld_copy, "oldWithOld")) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_genm.c",325,__func__), ERR_set_error)((58),(195),
# 325 "../crypto/cmp/cmp_genm.c" 3 4
       ((void *)0)
# 325 "../crypto/cmp/cmp_genm.c"
       );
        goto end;
    }
    ...
    if (!X509_up_ref(*newWithNew))
        goto end;
    if (newWithOld != 
# 331 "../crypto/cmp/cmp_genm.c" 3 4
                     ((void *)0) 
# 331 "../crypto/cmp/cmp_genm.c"
                          &&
        (*newWithOld = my_newWithOld) != 
# 332 "../crypto/cmp/cmp_genm.c" 3 4
                                        ((void *)0) 
# 332 "../crypto/cmp/cmp_genm.c"
                                             && !X509_up_ref(*newWithOld))
        goto free;
    if (oldWithNew == 
# 334 "../crypto/cmp/cmp_genm.c" 3 4
                     ((void *)0) 
# 334 "../crypto/cmp/cmp_genm.c"
                          ||
        (*oldWithNew = my_oldWithNew) == 
# 335 "../crypto/cmp/cmp_genm.c" 3 4
                                        ((void *)0) 
# 335 "../crypto/cmp/cmp_genm.c"
                                             || X509_up_ref(*oldWithNew)) {
        res = 1;
        goto end;
    }
    if (newWithOld != 
# 339 "../crypto/cmp/cmp_genm.c" 3 4
                     ((void *)0)
# 339 "../crypto/cmp/cmp_genm.c"
                         )
