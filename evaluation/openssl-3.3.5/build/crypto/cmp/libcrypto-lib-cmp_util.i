# 0 "../crypto/cmp/cmp_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_util.c"
# 12 "../crypto/cmp/cmp_util.c"
...
# 17 "../include/openssl/cmp_util.h" 2
...
# 15 "../crypto/cmp/cmp_util.c" 2
# 23 "../crypto/cmp/cmp_util.c"
int OSSL_CMP_log_open(void)
{

    return 1;
# 38 "../crypto/cmp/cmp_util.c"
}

void OSSL_CMP_log_close(void)
{
    (void)OSSL_trace_set_channel(13, 
# 42 "../crypto/cmp/cmp_util.c" 3 4
                                                         ((void *)0)
# 42 "../crypto/cmp/cmp_util.c"
                                                             );
}
...
static OSSL_CMP_severity parse_level(const char *level)
{
    ...
    if (end_level == 
# 53 "../crypto/cmp/cmp_util.c" 3 4
                    ((void *)0)
# 53 "../crypto/cmp/cmp_util.c"
                        )
        return -1;

    if ((strncmp(level, "CMP " "", sizeof("CMP ") - 1) == 0))
        level += strlen("CMP ");
    len = end_level - level;
    if (len > 5)
        return -1;
    ...
    return
        strcmp(level_copy, "EMERG") == 0 ? 0 :
        strcmp(level_copy, "ALERT") == 0 ? 1 :
        strcmp(level_copy, "CRIT") == 0 ? 2 :
        strcmp(level_copy, "ERROR") == 0 ? 3 :
        strcmp(level_copy, "WARN") == 0 ? 4 :
        strcmp(level_copy, "NOTE") == 0 ? 5 :
        strcmp(level_copy, "INFO") == 0 ? 6 :
        strcmp(level_copy, "DEBUG") == 0 ? 7 :
        -1;
}
                                        ...
                                        char **func, char **file, int *line)
{
    ...
    const char *p_file = buf == 
# 79 "../crypto/cmp/cmp_util.c" 3 4
                               ((void *)0) 
# 79 "../crypto/cmp/cmp_util.c"
                                    ? 
# 79 "../crypto/cmp/cmp_util.c" 3 4
                                      ((void *)0) 
# 79 "../crypto/cmp/cmp_util.c"
    ...
    *level = -1;
    *func = 
# 84 "../crypto/cmp/cmp_util.c" 3 4
           ((void *)0)
# 84 "../crypto/cmp/cmp_util.c"
               ;
    *file = 
# 85 "../crypto/cmp/cmp_util.c" 3 4
           ((void *)0)
# 85 "../crypto/cmp/cmp_util.c"
               ;
    *line = 0;

    if (p_file != 
# 88 "../crypto/cmp/cmp_util.c" 3 4
                 ((void *)0)
# 88 "../crypto/cmp/cmp_util.c"
                     ) {
        const char *p_line = strchr(++p_file, ':');

        if ((*level = parse_level(buf)) < 0 && p_line != 
# 91 "../crypto/cmp/cmp_util.c" 3 4
                                                        ((void *)0)
# 91 "../crypto/cmp/cmp_util.c"
                                                            ) {
            ...
            if (p_level > p_line && *(p_level++) == ':') {
                if ((*level = parse_level(p_level)) >= 0) {
                    *func = CRYPTO_strndup(p_func, p_file - 1 - p_func, "../crypto/cmp/cmp_util.c", 99);
                    *file = CRYPTO_strndup(p_file, p_line - 1 - p_file, "../crypto/cmp/cmp_util.c", 100);

                    *line = (int)line_number;
                    msg = strchr(p_level, ':');
                    if (msg != 
# 104 "../crypto/cmp/cmp_util.c" 3 4
                              ((void *)0) 
# 104 "../crypto/cmp/cmp_util.c"
                                   && *++msg == ' ')
                        msg++;
                }
            }
...
{
    if (fallback == 
# 120 "../crypto/cmp/cmp_util.c" 3 4
                   ((void *)0)
# 120 "../crypto/cmp/cmp_util.c"
                       )
        return func == 
# 121 "../crypto/cmp/cmp_util.c" 3 4
                      ((void *)0) 
# 121 "../crypto/cmp/cmp_util.c"
                           ? "(unknown function)" : func;

    return func == 
# 123 "../crypto/cmp/cmp_util.c" 3 4
                  ((void *)0) 
# 123 "../crypto/cmp/cmp_util.c"
                       || *func == '\0' || strcmp(func, "(unknown function)") == 0
        ? fallback : func;
}
...
void OSSL_CMP_print_errors_cb(OSSL_CMP_log_cb_t log_fn)
{
    ...
    char msg[4096];
    const char *file = 
# 155 "../crypto/cmp/cmp_util.c" 3 4
                      ((void *)0)
# 155 "../crypto/cmp/cmp_util.c"
                          , *func = 
# 155 "../crypto/cmp/cmp_util.c" 3 4
                                    ((void *)0)
# 155 "../crypto/cmp/cmp_util.c"
...
# 155 "../crypto/cmp/cmp_util.c"
    ...
    while ((err = ERR_get_error_all(&file, &line, &func, &data, &flags)) != 0) {
        ...
        const char *rs = 
# 162 "../crypto/cmp/cmp_util.c" 3 4
                        ((void *)0)
# 162 "../crypto/cmp/cmp_util.c"
                            ;
        char rsbuf[256];


        if ((((err) & ((unsigned int)0x7fffffff 
# 166 "../crypto/cmp/cmp_util.c"
           + 1)) != 0)) {
        ...
        if (rs == 
# 173 "../crypto/cmp/cmp_util.c" 3 4
                 ((void *)0)
# 173 "../crypto/cmp/cmp_util.c"
                     ) {
            BIO_snprintf(rsbuf, sizeof(rsbuf), "reason(%lu)", reason);
            rs = rsbuf;
        }
        if (data != 
# 177 "../crypto/cmp/cmp_util.c" 3 4
                   ((void *)0) 
# 177 "../crypto/cmp/cmp_util.c"
                        && (flags & 0x02) != 0)
        ...
        if (log_fn == 
# 182 "../crypto/cmp/cmp_util.c" 3 4
                     ((void *)0)
# 182 "../crypto/cmp/cmp_util.c"
                         ) {

            BIO *bio = BIO_new_fp(
# 184 "../crypto/cmp/cmp_util.c" 3 4
                                 stderr
# 184 "../crypto/cmp/cmp_util.c"
                                       , 0x00);

            if (bio != 
# 186 "../crypto/cmp/cmp_util.c" 3 4
                      ((void *)0)
# 186 "../crypto/cmp/cmp_util.c"
                          ) {
            ...
            if (log_fn(component, file, line, 3, msg) <= 0)
                break;
        }
    }
}
                                   ...
                                   int only_self_signed)
{
    ...
    if (store == 
# 206 "../crypto/cmp/cmp_util.c" 3 4
                ((void *)0)
# 206 "../crypto/cmp/cmp_util.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_util.c",207,__func__), ERR_set_error)((58),(103),
# 207 "../crypto/cmp/cmp_util.c" 3 4
       ((void *)0)
# 207 "../crypto/cmp/cmp_util.c"
       );
        return 0;
    }
    if (certs == 
# 210 "../crypto/cmp/cmp_util.c" 3 4
                ((void *)0)
# 210 "../crypto/cmp/cmp_util.c"
                    )
        return 1;
                                         ...
                                         const char *text, int len)
{
    ...
    if (!__builtin_expect(!!((sk != 
# 227 "../crypto/cmp/cmp_util.c" 3 4
        ((void *)0) 
# 227 "../crypto/cmp/cmp_util.c"
        && text != 
# 227 "../crypto/cmp/cmp_util.c" 3 4
        ((void *)0)
# 227 "../crypto/cmp/cmp_util.c"
...
# 229 "../crypto/cmp/cmp_util.c" 3 4
                                               ((void *)0)
# 229 "../crypto/cmp/cmp_util.c"
                                                   )
        return 0;
    if (!ASN1_STRING_set(utf8string, text, len))
        goto err;
    if (!OPENSSL_sk_push(ossl_check_ASN1_UTF8STRING_sk_type(sk), ossl_check_ASN1_UTF8STRING_type(utf8string)))
        goto err;
    return 1;
                                    ...
                                    const ASN1_OCTET_STRING *src)
{
    ...
    if (tgt == 
# 247 "../crypto/cmp/cmp_util.c" 3 4
              ((void *)0)
# 247 "../crypto/cmp/cmp_util.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_util.c",248,__func__), ERR_set_error)((58),(103),
# 248 "../crypto/cmp/cmp_util.c" 3 4
       ((void *)0)
# 248 "../crypto/cmp/cmp_util.c"
       );
        return 0;
    }
    if (*tgt == src)
    ...
    if (src != 
# 254 "../crypto/cmp/cmp_util.c" 3 4
              ((void *)0)
# 254 "../crypto/cmp/cmp_util.c"
                  ) {
        if ((new = ASN1_OCTET_STRING_dup(src)) == 
# 255 "../crypto/cmp/cmp_util.c" 3 4
                                                 ((void *)0)
# 255 "../crypto/cmp/cmp_util.c"
                                                     )
            return 0;
    } else {
        new = 
# 258 "../crypto/cmp/cmp_util.c" 3 4
             ((void *)0)
# 258 "../crypto/cmp/cmp_util.c"
                 ;
    }
...
{
    ASN1_OCTET_STRING *new = 
# 269 "../crypto/cmp/cmp_util.c" 3 4
                            ((void *)0)
# 269 "../crypto/cmp/cmp_util.c"
                                ;

    if (tgt == 
# 271 "../crypto/cmp/cmp_util.c" 3 4
              ((void *)0)
# 271 "../crypto/cmp/cmp_util.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_util.c",272,__func__), ERR_set_error)((58),(103),
# 272 "../crypto/cmp/cmp_util.c" 3 4
       ((void *)0)
# 272 "../crypto/cmp/cmp_util.c"
       );
        return 0;
    }
    if (bytes != 
# 275 "../crypto/cmp/cmp_util.c" 3 4
                ((void *)0)
# 275 "../crypto/cmp/cmp_util.c"
                    ) {
        if ((new = ASN1_OCTET_STRING_new()) == 
# 276 "../crypto/cmp/cmp_util.c" 3 4
                                              ((void *)0)
                
# 277 "../crypto/cmp/cmp_util.c"
