# 0 "../crypto/cmp/cmp_http.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_http.c"
# 12 "../crypto/cmp/cmp_http.c"
...
# 52 "../crypto/cmp/cmp_http.c" 3 4
                                   ((void *)0)
# 52 "../crypto/cmp/cmp_http.c"
                                       ;
    const char content_type_pkix[] = "application/pkixcmp";
    int tls_used;
    const ASN1_ITEM *it = (OSSL_CMP_MSG_it());
    BIO *req_mem, *rsp;
    OSSL_CMP_MSG *res = 
# 57 "../crypto/cmp/cmp_http.c" 3 4
                       ((void *)0)
# 57 "../crypto/cmp/cmp_http.c"
                           ;

    if (ctx == 
# 59 "../crypto/cmp/cmp_http.c" 3 4
              ((void *)0) 
# 59 "../crypto/cmp/cmp_http.c"
                   || req == 
# 59 "../crypto/cmp/cmp_http.c" 3 4
                             ((void *)0)
# 59 "../crypto/cmp/cmp_http.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_http.c",60,__func__), ERR_set_error)((58),(103),
# 60 "../crypto/cmp/cmp_http.c" 3 4
       ((void *)0)
# 60 "../crypto/cmp/cmp_http.c"
       );
        return 
# 61 "../crypto/cmp/cmp_http.c" 3 4
              ((void *)0)
# 61 "../crypto/cmp/cmp_http.c"
                  ;
    }

    if (!X509V3_add_value("Pragma", "no-cache", &headers))
        return 
# 65 "../crypto/cmp/cmp_http.c" 3 4
              ((void *)0)
# 65 "../crypto/cmp/cmp_http.c"
                  ;
    if ((req_mem = ASN1_item_i2d_mem_bio(it, (const ASN1_VALUE *)req)) == 
# 66 "../crypto/cmp/cmp_http.c" 3 4
                                                                         ((void *)0)
# 66 "../crypto/cmp/cmp_http.c"
                                                                             )
        goto err;
...
# 72 "../crypto/cmp/cmp_http.c" 3 4
                                              ((void *)0)
# 72 "../crypto/cmp/cmp_http.c"
                                                  ;
    if (ctx->http_ctx == 
# 73 "../crypto/cmp/cmp_http.c" 3 4
                        ((void *)0)
# 73 "../crypto/cmp/cmp_http.c"
                            )
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_http.c", 74, "DEBUG", "connecting to CMP server %s:%s%s", ctx->server, server_port, tls_used ? " using TLS" : "")
                                                                             ;
...
# 80 "../crypto/cmp/cmp_http.c" 3 4
                            ((void *)0) 
# 80 "../crypto/cmp/cmp_http.c"
                                          , 
# 80 "../crypto/cmp/cmp_http.c" 3 4
                                            ((void *)0) 
# 80 "../crypto/cmp/cmp_http.c"
    ...
    BIO_free(req_mem);
    res = (OSSL_CMP_MSG *)ASN1_item_d2i_bio(it, rsp, 
# 89 "../crypto/cmp/cmp_http.c" 3 4
                                                    ((void *)0)
# 89 "../crypto/cmp/cmp_http.c"
                                                        );
    BIO_free(rsp);

    if (ctx->http_ctx == 
# 92 "../crypto/cmp/cmp_http.c" 3 4
                        ((void *)0)
# 92 "../crypto/cmp/cmp_http.c"
                            )
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_http.c", 93, "DEBUG", "%s", "disconnected from CMP server");
    ...
    if (res != 
# 99 "../crypto/cmp/cmp_http.c" 3 4
              ((void *)0)
# 99 "../crypto/cmp/cmp_http.c"
                  )
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_http.c", 100, "DEBUG", "%s", "finished reading response from CMP server");
 err:
    OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(headers),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return res;
}
