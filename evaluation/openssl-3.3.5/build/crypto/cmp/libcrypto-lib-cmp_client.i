# 0 "../crypto/cmp/cmp_client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_client.c"
# 12 "../crypto/cmp/cmp_client.c"
...
# 13 "../crypto/cmp/cmp_client.c" 2
# 31 "../crypto/cmp/cmp_client.c"
static int unprotected_exception(const OSSL_CMP_CTX *ctx,
                                 const OSSL_CMP_MSG *rep,
                                 int invalid_protection,
                                 __attribute__((unused)) int expected_type)
{
    int rcvd_type = OSSL_CMP_MSG_get_bodytype(rep );
    const char *msg_type = 
# 37 "../crypto/cmp/cmp_client.c" 3 4
                          ((void *)0)
# 37 "../crypto/cmp/cmp_client.c"
                              ;

    if (!__builtin_expect(!!((ctx != 
# 39 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0) 
# 39 "../crypto/cmp/cmp_client.c"
        && rep != 
# 39 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0)
# 39 "../crypto/cmp/cmp_client.c"
    ...
    case 12:
        {
            ...
            if (si == 
# 55 "../crypto/cmp/cmp_client.c" 3 4
                     ((void *)0)
# 55 "../crypto/cmp/cmp_client.c"
                         )
                return -1;
            if (ossl_cmp_pkisi_get_status(si) == 2)
    ...
    case 19:
        ...
        break;
    default:
        if (((rcvd_type) == 1 || (rcvd_type) == 3 || (rcvd_type) == 8)) {
            int any_rid = -1;
            OSSL_CMP_CERTREPMESSAGE *crepmsg = rep->body->value.ip;
            OSSL_CMP_CERTRESPONSE *crep =
                ossl_cmp_certrepmessage_get0_certresponse(crepmsg, any_rid);

            if (OPENSSL_sk_num(ossl_check_const_OSSL_CMP_CERTRESPONSE_sk_type(crepmsg->response)) > 1)
                return -1;
            if (crep == 
# 73 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0)
# 73 "../crypto/cmp/cmp_client.c"
                           )
                return -1;
    ...
    if (msg_type == 
# 80 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
# 80 "../crypto/cmp/cmp_client.c"
                       )
        return 0;
    ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 82, "WARN", "ignoring %s protection of %s", invalid_protection ? "invalid" : "missing", msg_type)
                                                                       ;
    return 1;
}
...
static int save_statusInfo(OSSL_CMP_CTX *ctx, OSSL_CMP_PKISI *si)
{
    ...
    if (!__builtin_expect(!!((ctx != 
# 93 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0) 
# 93 "../crypto/cmp/cmp_client.c"
        && si != 
# 93 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0)
# 93 "../crypto/cmp/cmp_client.c"
    ...
    if (!ossl_cmp_ctx_set0_statusString(ctx, ((struct stack_st_ASN1_UTF8STRING *)OPENSSL_sk_new_null()))
            || (ctx->statusString == 
# 103 "../crypto/cmp/cmp_client.c" 3 4
                                    ((void *)0)
# 103 "../crypto/cmp/cmp_client.c"
                                        ))
        return 0;

    ss = si->statusString;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(ss)); i++) {
        ASN1_UTF8STRING *str = ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(ss), (i)));
        ASN1_UTF8STRING *dup = ASN1_STRING_dup(str);

        if (dup == 
# 111 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0) 
# 111 "../crypto/cmp/cmp_client.c"
                       || !OPENSSL_sk_push(ossl_check_ASN1_UTF8STRING_sk_type(ctx->statusString), ossl_check_ASN1_UTF8STRING_type(dup))) {
...
static int is_crep_with_waiting(const OSSL_CMP_MSG *resp, int rid)
{
    ...
    crepmsg = resp->body->value.ip;
    crep = ossl_cmp_certrepmessage_get0_certresponse(crepmsg, rid);

    return (crep != 
# 131 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
            
# 132 "../crypto/cmp/cmp_client.c"
                              ...
                              OSSL_CMP_MSG **rep, int expected_type)
{
    ...
    int bt;
    time_t now = time(
# 153 "../crypto/cmp/cmp_client.c" 3 4
                     ((void *)0)
# 153 "../crypto/cmp/cmp_client.c"
                         );
    int time_left;
    ...
    if (transfer_cb == 
# 158 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 158 "../crypto/cmp/cmp_client.c"
                          )
        transfer_cb = OSSL_CMP_MSG_http_perform;

    *rep = 
# 161 "../crypto/cmp/cmp_client.c" 3 4
          ((void *)0)
# 161 "../crypto/cmp/cmp_client.c"
              ;
    ...
    if (ctx->total_timeout != 0 ) {
        ...
        if (now >= ctx->end_time) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",167,__func__), ERR_set_error)((58),(184),
# 167 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 167 "../crypto/cmp/cmp_client.c"
           );
            return 0;
        }
        if (!__builtin_expect(!!((ctx->end_time - now < 0x7fffffff
# 170 "../crypto/cmp/cmp_client.c"
            ) != 0), 1)) {

            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",172,__func__), ERR_set_error)((58),(100),
# 172 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 172 "../crypto/cmp/cmp_client.c"
           );
            return 0;
        }
    ...
    if (ctx->server != 
# 183 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 183 "../crypto/cmp/cmp_client.c"
                          )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 184, "INFO", "sending %s", req_type_str);

    *rep = (*transfer_cb)(ctx, req);
    ctx->msg_timeout = bak_msg_timeout;

    if (*rep == 
# 189 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 189 "../crypto/cmp/cmp_client.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",190,__func__), ERR_set_error)(58,
                       ctx->total_timeout != 0 && time(
# 191 "../crypto/cmp/cmp_client.c" 3 4
                                                      ((void *)0)
# 191 "../crypto/cmp/cmp_client.c"
                                                          ) >= ctx->end_time ?
                       184 : 159,
    ...
    ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 204, "INFO", "received %s%s", ossl_cmp_bodytype_to_string(bt), ossl_cmp_is_error_with_waiting(*rep) ? " (waiting)" : "")
                                                                           ;
...
# 223 "../crypto/cmp/cmp_client.c"
    ...
    (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",230,__func__), ERR_set_error)((58),(bt == 23 ? 180 : 133),
# 230 "../crypto/cmp/cmp_client.c" 3 4
   ((void *)0)
# 230 "../crypto/cmp/cmp_client.c"
   )
                                       ;
    ...
    if (bt != 23) {
        ...
        if (save_statusInfo(ctx, si)
                && OSSL_CMP_CTX_snprint_PKIStatus(ctx, buf,
                                                  sizeof(buf)) != 
# 243 "../crypto/cmp/cmp_client.c" 3 4
                                                                 ((void *)0)
# 243 "../crypto/cmp/cmp_client.c"
                                                                     )
            ERR_add_error_data(1, buf);
        if (emc->errorCode != 
# 245 "../crypto/cmp/cmp_client.c" 3 4
                             ((void *)0)
                
# 246 "../crypto/cmp/cmp_client.c"
               && BIO_snprintf(buf, sizeof(buf), "; errorCode: %08lX",
                                ASN1_INTEGER_get(emc->errorCode)) > 0)
            ERR_add_error_data(1, buf);
        if (emc->errorDetails != 
# 249 "../crypto/cmp/cmp_client.c" 3 4
                                ((void *)0)
# 249 "../crypto/cmp/cmp_client.c"
                                    ) {
            char *text = ossl_sk_ASN1_UTF8STRING2text(emc->errorDetails, ", ",
                                                      1024 - 1);

            if (text != 
# 253 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0) 
# 253 "../crypto/cmp/cmp_client.c"
                            && *text != '\0')
                ERR_add_error_data(2, "; errorDetails: ", text);
            CRYPTO_free(text, "../crypto/cmp/cmp_client.c", 255);
        }
        if (ctx->status != 2) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",258,__func__), ERR_set_error)((58),(185),
# 258 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 258 "../crypto/cmp/cmp_client.c"
           );
            if (ctx->status == 3)
                ctx->status = 2;
        }
...
# 282 "../crypto/cmp/cmp_client.c"
static int poll_for_response(OSSL_CMP_CTX *ctx, int sleep, int rid,
                             OSSL_CMP_MSG **rep, int *checkAfter)
{
    OSSL_CMP_MSG *preq = 
# 285 "../crypto/cmp/cmp_client.c" 3 4
                        ((void *)0)
# 285 "../crypto/cmp/cmp_client.c"
                            ;
    OSSL_CMP_MSG *prep = 
# 286 "../crypto/cmp/cmp_client.c" 3 4
                        ((void *)0)
# 286 "../crypto/cmp/cmp_client.c"
                            ;

    ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 288, "INFO", "%s", "received 'waiting' PKIStatus, starting to poll for response")
                                                                                ;
    *rep = 
# 290 "../crypto/cmp/cmp_client.c" 3 4
          ((void *)0)
# 290 "../crypto/cmp/cmp_client.c"
              ;
    for (;;) {
        if ((preq = ossl_cmp_pollReq_new(ctx, rid)) == 
# 292 "../crypto/cmp/cmp_client.c" 3 4
                                                      ((void *)0)
# 292 "../crypto/cmp/cmp_client.c"
                                                          )
            goto err;

        if (!send_receive_check(ctx, preq, &prep, 26))
            goto err;


        if (OSSL_CMP_MSG_get_bodytype(prep) == 26) {
            OSSL_CMP_POLLREPCONTENT *prc = prep->body->value.pollRep;
            OSSL_CMP_POLLREP *pollRep = 
# 301 "../crypto/cmp/cmp_client.c" 3 4
                                       ((void *)0)
# 301 "../crypto/cmp/cmp_client.c"
                                           ;
            int64_t check_after;
            char str[1024];
            int len;
            ...
            if (sk_OSSL_CMP_POLLREP_num(prc) > 1) {
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",307,__func__), ERR_set_error)((58),(170),
# 307 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 307 "../crypto/cmp/cmp_client.c"
               );
                goto err;
            }
            pollRep = ossl_cmp_pollrepcontent_get0_pollrep(prc, rid);
            if (pollRep == 
# 311 "../crypto/cmp/cmp_client.c" 3 4
                          ((void *)0)
# 311 "../crypto/cmp/cmp_client.c"
                              )
                goto err;

            if (!ASN1_INTEGER_get_int64(&check_after, pollRep->checkAfter)) {
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",315,__func__), ERR_set_error)((58),(167),
# 315 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 315 "../crypto/cmp/cmp_client.c"
               );
                goto err;
            }
            if (check_after < 0 || (uint64_t)check_after
                > (sleep ? 
# 319 "../crypto/cmp/cmp_client.c" 3 4
                          (0x7fffffffffffffffL * 2UL + 1UL) 
# 319 "../crypto/cmp/cmp_client.c"
                                    / 1000 : 0x7fffffff
# 319 "../crypto/cmp/cmp_client.c"
                                                    )) {
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",320,__func__), ERR_set_error)((58),(181),
# 320 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 320 "../crypto/cmp/cmp_client.c"
               );
                if (BIO_snprintf(str, 1024, "value = %jd",
                                 check_after) >= 0)
            ...
            if (pollRep->reason == 
# 327 "../crypto/cmp/cmp_client.c" 3 4
                                  ((void *)0)
                    
# 328 "../crypto/cmp/cmp_client.c"
                   || (len = BIO_snprintf(str, 1024,
                                           " with reason = '")) < 0) {
                *str = '\0';
            } else {
                ...
                if (text == 
# 335 "../crypto/cmp/cmp_client.c" 3 4
                           ((void *)0)
                        
# 336 "../crypto/cmp/cmp_client.c"
                       || BIO_snprintf(str + len, sizeof(str) - len,
                                        "%s'", text) < 0)
                    *str = '\0';
                CRYPTO_free(text, "../crypto/cmp/cmp_client.c", 339);
            }
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 341, "INFO", "received polling response%s; checkAfter = %ld seconds", str, check_after)

                                           ;

            if (ctx->total_timeout != 0) {
                const int exp = 2;
                int64_t time_left = (int64_t)(ctx->end_time - exp - time(
# 347 "../crypto/cmp/cmp_client.c" 3 4
                                                                        ((void *)0)
# 347 "../crypto/cmp/cmp_client.c"
                                                                            ));

                if (time_left <= 0) {
                    (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",350,__func__), ERR_set_error)((58),(184),
# 350 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
# 350 "../crypto/cmp/cmp_client.c"
                   );
                    goto err;
                }
            ...
            preq = 
# 359 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0)
# 359 "../crypto/cmp/cmp_client.c"
                      ;
            OSSL_CMP_MSG_free(prep);
            prep = 
# 361 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0)
# 361 "../crypto/cmp/cmp_client.c"
                      ;
            if (sleep) {
                OSSL_sleep((unsigned long)(1000 * check_after));
            } else {
                if (checkAfter != 
# 365 "../crypto/cmp/cmp_client.c" 3 4
                                 ((void *)0)
# 365 "../crypto/cmp/cmp_client.c"
                                     )
            ...
            (void)ossl_cmp_exchange_error(ctx, 2,
                                          (1 << 2),
                                          "polling already started",
                                          0 , 
# 375 "../crypto/cmp/cmp_client.c" 3 4
                                                            ((void *)0)
# 375 "../crypto/cmp/cmp_client.c"
                                                                );
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",376,__func__), ERR_set_error)((58),(185),
# 376 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 376 "../crypto/cmp/cmp_client.c"
           );
            goto err;
        } else {
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 379, "INFO", "%s", "received final response after polling");
            if (!ossl_cmp_ctx_set1_first_senderNonce(ctx, 
# 380 "../crypto/cmp/cmp_client.c" 3 4
                                                         ((void *)0)
# 380 "../crypto/cmp/cmp_client.c"
                                                             ))
                return 0;
            break;
        }
    ...
    if (prep == 
# 385 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 385 "../crypto/cmp/cmp_client.c"
                   )
        goto err;
    ...
    *rep = prep;
    ...
    return 1;
 err:
    (void)ossl_cmp_ctx_set1_first_senderNonce(ctx, 
# 393 "../crypto/cmp/cmp_client.c" 3 4
                                                  ((void *)0)
# 393 "../crypto/cmp/cmp_client.c"
                                                      );
    OSSL_CMP_MSG_free(preq);
    OSSL_CMP_MSG_free(prep);
    return 0;
                                     ...
                                     OSSL_CMP_MSG **rep, int expected_type)
{
    ...
    if (ossl_cmp_is_error_with_waiting(*rep)) {
        if (!save_senderNonce_if_waiting(ctx, *rep, -1))
            return 0;
        ...
        *rep = 
# 435 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 435 "../crypto/cmp/cmp_client.c"
                  ;

        if (poll_for_response(ctx, 1 , -1,
                              rep, 
# 438 "../crypto/cmp/cmp_client.c" 3 4
                                  ((void *)0) 
# 438 "../crypto/cmp/cmp_client.c"
                                                       ) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",439,__func__), ERR_set_error)((58),(172),
# 439 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 439 "../crypto/cmp/cmp_client.c"
           );
            return 0;
        }
    }
    if (OSSL_CMP_MSG_get_bodytype(*rep) != expected_type) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",444,__func__), ERR_set_error)((58),(133),
# 444 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 444 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }
                               ...
                               int fail_info, const char *txt)
{
    ...
    OSSL_CMP_MSG *PKIconf = 
# 458 "../crypto/cmp/cmp_client.c" 3 4
                           ((void *)0)
# 458 "../crypto/cmp/cmp_client.c"
                               ;
    int res = 0;
    ...
    if (certConf == 
# 463 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
# 463 "../crypto/cmp/cmp_client.c"
                       )
        goto err;
...
{
    OSSL_CMP_MSG *error = 
# 479 "../crypto/cmp/cmp_client.c" 3 4
                         ((void *)0)
# 479 "../crypto/cmp/cmp_client.c"
                             ;
    OSSL_CMP_PKISI *si = 
# 480 "../crypto/cmp/cmp_client.c" 3 4
                        ((void *)0)
# 480 "../crypto/cmp/cmp_client.c"
                            ;
    OSSL_CMP_MSG *PKIconf = 
# 481 "../crypto/cmp/cmp_client.c" 3 4
                           ((void *)0)
# 481 "../crypto/cmp/cmp_client.c"
                               ;
    int res = 0;


    if ((si = OSSL_CMP_STATUSINFO_new(status, fail_info, txt)) == 
# 485 "../crypto/cmp/cmp_client.c" 3 4
                                                                 ((void *)0)
# 485 "../crypto/cmp/cmp_client.c"
                                                                     )
        goto err;

    if ((error = ossl_cmp_error_new(ctx, si, errorCode, details, 0)) == 
# 488 "../crypto/cmp/cmp_client.c" 3 4
                                                                       ((void *)0)
# 488 "../crypto/cmp/cmp_client.c"
                                                                           )
        goto err;
                              ...
                              OSSL_CMP_CERTRESPONSE *crep)
{
    char buf[1024];
    X509 *crt = 
# 510 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 510 "../crypto/cmp/cmp_client.c"
                   ;

    if (!__builtin_expect(!!((ctx != 
# 512 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0) 
# 512 "../crypto/cmp/cmp_client.c"
        && crep != 
# 512 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0)
# 512 "../crypto/cmp/cmp_client.c"
        ...
        return 
# 513 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 513 "../crypto/cmp/cmp_client.c"
                  ;

    switch (ossl_cmp_pkisi_get_status(crep->status)) {
    case 3:
        ossl_cmp_print_log(3, ctx, __func__, "../crypto/cmp/cmp_client.c", 517, "ERROR", "%s", "received \"waiting\" status for cert when actually aiming to extract cert")
                                                                                                 ;
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",519,__func__), ERR_set_error)((58),(162),
# 519 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 519 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    case 1:
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 522, "WARN", "%s", "received \"grantedWithMods\" for certificate");
        break;
    case 0:
        break;

    case 2:
        ossl_cmp_print_log(3, ctx, __func__, "../crypto/cmp/cmp_client.c", 528, "ERROR", "%s", "received \"rejection\" status rather than cert");
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",529,__func__), ERR_set_error)((58),(182),
# 529 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 529 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    case 4:
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 532, "WARN", "%s", "received \"revocationWarning\" - a revocation of the cert is imminent")
                                                                                              ;
        break;
    case 5:
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 536, "WARN", "%s", "received \"revocationNotification\" - a revocation of the cert has occurred")
                                                                                                    ;
        break;
    case 6:
        if (bodytype != 7) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",541,__func__), ERR_set_error)((58),(176),
# 541 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 541 "../crypto/cmp/cmp_client.c"
           );
            goto err;
        }
        break;
    default:
        ossl_cmp_print_log(3, ctx, __func__, "../crypto/cmp/cmp_client.c", 546, "ERROR", "received unsupported PKIStatus %d for certificate", ctx->status)

                                  ;
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",549,__func__), ERR_set_error)((58),(186),
# 549 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 549 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    }
    crt = ossl_cmp_certresponse_get1_cert(ctx, crep);
    if (crt == 
# 553 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 553 "../crypto/cmp/cmp_client.c"
                  )
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",554,__func__), ERR_set_error)((58),(112),
# 554 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 554 "../crypto/cmp/cmp_client.c"
       );

    return crt;

 err:
    if (OSSL_CMP_CTX_snprint_PKIStatus(ctx, buf, sizeof(buf)) != 
# 559 "../crypto/cmp/cmp_client.c" 3 4
                                                                ((void *)0)
# 559 "../crypto/cmp/cmp_client.c"
                                                                    )
        ERR_add_error_data(1, buf);
    return 
# 561 "../crypto/cmp/cmp_client.c" 3 4
          ((void *)0)
# 561 "../crypto/cmp/cmp_client.c"
              ;
}
# 581 "../crypto/cmp/cmp_client.c"
int OSSL_CMP_certConf_cb(OSSL_CMP_CTX *ctx, X509 *cert, int fail_info,
                         const char **text)
{
    X509_STORE *out_trusted = OSSL_CMP_CTX_get_certConf_cb_arg(ctx);
    struct stack_st_X509 *chain = 
# 585 "../crypto/cmp/cmp_client.c" 3 4
                           ((void *)0)
# 585 "../crypto/cmp/cmp_client.c"
                               ;
    ...
    if (out_trusted == 
# 592 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 592 "../crypto/cmp/cmp_client.c"
                          ) {
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_client.c", 593, "DEBUG", "%s", "trying to build chain for newly enrolled cert");
        ...
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_client.c", 599, "DEBUG", "%s", "validating newly enrolled cert");
        if (csc == 
# 600 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0)
# 600 "../crypto/cmp/cmp_client.c"
                      )
            goto err;
        ...
        if (!ossl_x509_add_certs_new(&chain, X509_STORE_CTX_get0_chain(csc),
            ...
            chain = 
# 617 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
# 617 "../crypto/cmp/cmp_client.c"
                       ;
        }
    err:
    ...
    if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)) > 0)
        X509_free(((X509 *)OPENSSL_sk_shift(ossl_check_X509_sk_type(chain))));
    if (out_trusted != 
# 625 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 625 "../crypto/cmp/cmp_client.c"
                          ) {
        if (chain == 
# 626 "../crypto/cmp/cmp_client.c" 3 4
                    ((void *)0)
# 626 "../crypto/cmp/cmp_client.c"
                        ) {
            ossl_cmp_print_log(3, ctx, __func__, "../crypto/cmp/cmp_client.c", 627, "ERROR", "%s", "failed to validate newly enrolled cert");
            fail_info = 1 << 7;
        } else {
            ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_client.c", 630, "DEBUG", "%s", "success validating newly enrolled cert")
                                                                    ;
        }
    } else if (chain == 
# 633 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0)
# 633 "../crypto/cmp/cmp_client.c"
                           ) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 634, "WARN", "%s", "could not build approximate chain for newly enrolled cert, resorting to received extraCerts");
        chain = OSSL_CMP_CTX_get1_extraCertsIn(ctx);
    } else {
        ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_client.c", 637, "DEBUG", "%s", "success building approximate chain for newly enrolled cert")
                                                                                    ;
    }
...
# 654 "../crypto/cmp/cmp_client.c"
static int cert_response(OSSL_CMP_CTX *ctx, int sleep, int rid,
                         OSSL_CMP_MSG **resp, int *checkAfter,
                         __attribute__((unused)) int req_type,
                         __attribute__((unused)) int expected_type)
{
    EVP_PKEY *rkey = ossl_cmp_ctx_get0_newPubkey(ctx);
    int fail_info = 0;
    const char *txt = 
# 661 "../crypto/cmp/cmp_client.c" 3 4
                     ((void *)0)
# 661 "../crypto/cmp/cmp_client.c"
                         ;
    OSSL_CMP_CERTREPMESSAGE *crepmsg = 
# 662 "../crypto/cmp/cmp_client.c" 3 4
                                      ((void *)0)
# 662 "../crypto/cmp/cmp_client.c"
                                          ;
    OSSL_CMP_CERTRESPONSE *crep = 
# 663 "../crypto/cmp/cmp_client.c" 3 4
                                 ((void *)0)
# 663 "../crypto/cmp/cmp_client.c"
                                     ;
    OSSL_CMP_certConf_cb_t cb;
    X509 *cert;
    char *subj = 
# 666 "../crypto/cmp/cmp_client.c" 3 4
                ((void *)0)
# 666 "../crypto/cmp/cmp_client.c"
                    ;
    int ret = 1;
    int rcvd_type;
    OSSL_CMP_PKISI *si;
    ...
    if (!__builtin_expect(!!((ctx != 
# 671 "../crypto/cmp/cmp_client.c" 3 4
        ((void *)0)
# 671 "../crypto/cmp/cmp_client.c"
        ) != 0), 1))
        return 0;
 ...
 retry:
    ...
    if (((rcvd_type) == 1 || (rcvd_type) == 3 || (rcvd_type) == 8)) {
        crepmsg = (*resp)->body->value.ip;
        if (OPENSSL_sk_num(ossl_check_const_OSSL_CMP_CERTRESPONSE_sk_type(crepmsg->response)) > 1) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",679,__func__), ERR_set_error)((58),(170),
# 679 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 679 "../crypto/cmp/cmp_client.c"
           );
            return 0;
        }
        crep = ossl_cmp_certrepmessage_get0_certresponse(crepmsg, rid);
        if (crep == 
# 683 "../crypto/cmp/cmp_client.c" 3 4
                   ((void *)0)
# 683 "../crypto/cmp/cmp_client.c"
                       )
            return 0;
        si = crep->status;
        ...
        if (rid == -1) {
            ...
            if (rid < -1) {
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",691,__func__), ERR_set_error)((58),(108),
# 691 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 691 "../crypto/cmp/cmp_client.c"
               );
                return 0;
            }
        }
    } else if (rcvd_type == 23) {
        si = (*resp)->body->value.error->pKIStatusInfo;
    } else {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",698,__func__), ERR_set_error)((58),(133),
# 698 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 698 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }
    ...
    if (ossl_cmp_pkisi_get_status(si) == 3) {
        ...
        *resp = 
# 712 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 712 "../crypto/cmp/cmp_client.c"
                   ;
        if ((ret = poll_for_response(ctx, sleep, rid, resp, checkAfter)) != 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",718,__func__), ERR_set_error)((58),(172),
# 718 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 718 "../crypto/cmp/cmp_client.c"
           );
            return 0;
        }
    }
    ...
    if (rcvd_type == 23) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",725,__func__), ERR_set_error)((58),(180),
# 725 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 725 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }

    if (rcvd_type != expected_type) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",730,__func__), ERR_set_error)((58),(133),
# 730 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 730 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }
    ...
    if (cert == 
# 735 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)
# 735 "../crypto/cmp/cmp_client.c"
                   ) {
    ...
    if (crepmsg != 
# 748 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0) 
# 748 "../crypto/cmp/cmp_client.c"
                       && crepmsg->caPubs != 
# 748 "../crypto/cmp/cmp_client.c" 3 4
                                             ((void *)0)
            
# 749 "../crypto/cmp/cmp_client.c"
           && !ossl_cmp_ctx_set1_caPubs(ctx, crepmsg->caPubs))
        return 0;

    subj = X509_NAME_oneline(X509_get_subject_name(cert), 
# 752 "../crypto/cmp/cmp_client.c" 3 4
                                                         ((void *)0)
# 752 "../crypto/cmp/cmp_client.c"
                                                             , 0);
    if (rkey != 
# 753 "../crypto/cmp/cmp_client.c" 3 4
               ((void *)0)

            
# 755 "../crypto/cmp/cmp_client.c"
    ...
    cb = ctx->certConf_cb != 
# 772 "../crypto/cmp/cmp_client.c" 3 4
                            ((void *)0) 
# 772 "../crypto/cmp/cmp_client.c"
                                 ? ctx->certConf_cb : OSSL_CMP_certConf_cb;
    if ((fail_info = cb(ctx, ctx->newCert, fail_info, &txt)) != 0
            && txt == 
# 774 "../crypto/cmp/cmp_client.c" 3 4
                     ((void *)0)
# 774 "../crypto/cmp/cmp_client.c"
                         )
        txt = "CMP client did not accept it";
    if (fail_info != 0)
        ossl_cmp_print_log(3, ctx, __func__, "../crypto/cmp/cmp_client.c", 777, "ERROR", "rejecting newly enrolled cert with subject: %s", subj)
                                                                             ;
    ...
    if (fail_info != 0) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",791,__func__), ERR_set_error)(58, 169,
                       "rejecting newly enrolled cert with subject: %s; %s",
                       subj, txt);
        ctx->status = 2;
        ret = 0;
    }
    CRYPTO_free(subj, "../crypto/cmp/cmp_client.c", 797);
    return ret;
}
                           ...
                           OSSL_CMP_MSG **p_rep, int rep_type)
{
    ...
    ctx->status = -3;
    if (!ossl_cmp_ctx_set0_newCert(ctx, 
# 809 "../crypto/cmp/cmp_client.c" 3 4
                                       ((void *)0)
# 809 "../crypto/cmp/cmp_client.c"
                                           ))
        return 0;


    if ((req = ossl_cmp_certreq_new(ctx, req_type, crm)) == 
# 813 "../crypto/cmp/cmp_client.c" 3 4
                                                           ((void *)0)
# 813 "../crypto/cmp/cmp_client.c"
                                                               )
        return 0;
...
{
    OSSL_CMP_MSG *rep = 
# 825 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0)
# 825 "../crypto/cmp/cmp_client.c"
                           ;
    int is_p10 = req_type == 4;
    int rid = is_p10 ? -1 : 0;
    int rep_type = is_p10 ? 3 : req_type + 1;
    int res = 0;

    if (ctx == 
# 831 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 831 "../crypto/cmp/cmp_client.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",832,__func__), ERR_set_error)((58),(103),
# 832 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 832 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }
    ...
    if (ctx->status != 3) {
        ...
        if (req_type < 0)
            return ossl_cmp_exchange_error(ctx, 2,
                                           0, "polling aborted",
                                           0 , "by application");
        res = poll_for_response(ctx, 0 , rid, &rep, checkAfter);
        if (res <= 0)
            return res;
    }
    res = cert_response(ctx, 0 , rid, &rep, checkAfter,
                        req_type, rep_type);
...
# 866 "../crypto/cmp/cmp_client.c"
X509 *OSSL_CMP_exec_certreq(OSSL_CMP_CTX *ctx, int req_type,
                            const OSSL_CRMF_MSG *crm)
{
    OSSL_CMP_MSG *rep = 
# 869 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0)
# 869 "../crypto/cmp/cmp_client.c"
                           ;
    int is_p10 = req_type == 4;
    int rid = is_p10 ? -1 : 0;
    int rep_type = is_p10 ? 3 : req_type + 1;
    X509 *result = 
# 873 "../crypto/cmp/cmp_client.c" 3 4
                  ((void *)0)
# 873 "../crypto/cmp/cmp_client.c"
                      ;

    if (ctx == 
# 875 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 875 "../crypto/cmp/cmp_client.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",876,__func__), ERR_set_error)((58),(103),
# 876 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 876 "../crypto/cmp/cmp_client.c"
       );
        return 
# 877 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 877 "../crypto/cmp/cmp_client.c"
                  ;
    }
    ...
    if (cert_response(ctx, 1 , rid, &rep, 
# 886 "../crypto/cmp/cmp_client.c" 3 4
                                                    ((void *)0)
# 886 "../crypto/cmp/cmp_client.c"
                                                        , req_type, rep_type)
        <= 0)
        goto err;
...
{
    OSSL_CMP_MSG *rr = 
# 898 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 898 "../crypto/cmp/cmp_client.c"
                          ;
    OSSL_CMP_MSG *rp = 
# 899 "../crypto/cmp/cmp_client.c" 3 4
                      ((void *)0)
# 899 "../crypto/cmp/cmp_client.c"
                          ;
    const int num_RevDetails = 1;
    const int rsid = 0;
    OSSL_CMP_REVREPCONTENT *rrep = 
# 902 "../crypto/cmp/cmp_client.c" 3 4
                                  ((void *)0)
# 902 "../crypto/cmp/cmp_client.c"
                                      ;
    OSSL_CMP_PKISI *si = 
# 903 "../crypto/cmp/cmp_client.c" 3 4
                        ((void *)0)
# 903 "../crypto/cmp/cmp_client.c"
                            ;
    char buf[1024];
    int ret = 0;

    if (ctx == 
# 907 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 907 "../crypto/cmp/cmp_client.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",908,__func__), ERR_set_error)((58),(100),
# 908 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 908 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }
    ctx->status = -3;
    if (ctx->oldCert == 
# 912 "../crypto/cmp/cmp_client.c" 3 4
                       ((void *)0) 
# 912 "../crypto/cmp/cmp_client.c"
                            && ctx->p10CSR == 
# 912 "../crypto/cmp/cmp_client.c" 3 4
                                              ((void *)0)
        
# 913 "../crypto/cmp/cmp_client.c"
       && (ctx->serialNumber == 
# 913 "../crypto/cmp/cmp_client.c" 3 4
                                ((void *)0) 
# 913 "../crypto/cmp/cmp_client.c"
                                     || ctx->issuer == 
# 913 "../crypto/cmp/cmp_client.c" 3 4
...
# 913 "../crypto/cmp/cmp_client.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",914,__func__), ERR_set_error)((58),(168),
# 914 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 914 "../crypto/cmp/cmp_client.c"
       );
        return 0;
    }


    if ((rr = ossl_cmp_rr_new(ctx)) == 
# 919 "../crypto/cmp/cmp_client.c" 3 4
                                      ((void *)0)
# 919 "../crypto/cmp/cmp_client.c"
                                          )
        goto end;

    ctx->status = -2;
    if (!send_receive_also_delayed(ctx, rr, &rp, 12))
        goto end;

    rrep = rp->body->value.rp;

    if (OPENSSL_sk_num(ossl_check_const_OSSL_CMP_PKISI_sk_type(rrep->status)) != num_RevDetails) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",929,__func__), ERR_set_error)((58),(188),
# 929 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 929 "../crypto/cmp/cmp_client.c"
       );
        goto end;
    }
# 940 "../crypto/cmp/cmp_client.c"
    si = ossl_cmp_revrepcontent_get_pkisi(rrep, rsid);
    if (!save_statusInfo(ctx, si))
        goto err;
    switch (ossl_cmp_pkisi_get_status(si)) {
    case 0:
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 945, "INFO", "%s", "revocation accepted (PKIStatus=accepted)");
        ret = 1;
        break;
    case 1:
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 949, "INFO", "%s", "revocation accepted (PKIStatus=grantedWithMods)");
        ret = 1;
        break;
    case 2:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",953,__func__), ERR_set_error)((58),(182),
# 953 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 953 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    case 4:
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_client.c", 956, "INFO", "%s", "revocation accepted (PKIStatus=revocationWarning)");
        ret = 1;
        break;
    case 5:

        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_client.c", 961, "WARN", "%s", "revocation accepted (PKIStatus=revocationNotification)")
                                                                               ;
        ret = 1;
        break;
    case 3:
    case 6:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",967,__func__), ERR_set_error)((58),(185),
# 967 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 967 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    default:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",970,__func__), ERR_set_error)((58),(186),
# 970 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 970 "../crypto/cmp/cmp_client.c"
       );
        goto err;
    }


    if (OPENSSL_sk_num(ossl_check_const_OSSL_CRMF_CERTID_sk_type(rrep->revCerts)) >= 1) {
        ...
        if (OPENSSL_sk_num(ossl_check_const_OSSL_CRMF_CERTID_sk_type(rrep->revCerts)) != num_RevDetails) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",984,__func__), ERR_set_error)((58),(188),
# 984 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 984 "../crypto/cmp/cmp_client.c"
           );
            ret = 0;
            goto err;
        }
        if ((cid = ossl_cmp_revrepcontent_get_CertId(rrep, rsid)) == 
# 988 "../crypto/cmp/cmp_client.c" 3 4
                                                                    ((void *)0)
# 988 "../crypto/cmp/cmp_client.c"
                                                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",989,__func__), ERR_set_error)((58),(165),
# 989 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 989 "../crypto/cmp/cmp_client.c"
           );
            ret = 0;
            goto err;
        }
        if (X509_NAME_cmp(issuer, OSSL_CRMF_CERTID_get0_issuer(cid)) != 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",995,__func__), ERR_set_error)((58),(187),
# 995 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 995 "../crypto/cmp/cmp_client.c"
           );
            ret = 0;
            goto err;
        ...
        if (ASN1_INTEGER_cmp(serial,
            ...
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",1003,__func__), ERR_set_error)((58),(173),
# 1003 "../crypto/cmp/cmp_client.c" 3 4
           ((void *)0)
# 1003 "../crypto/cmp/cmp_client.c"
           );
            ret = 0;
            goto err;
    ...
    if (rrep->crls != 
# 1011 "../crypto/cmp/cmp_client.c" 3 4
                     ((void *)0) 
# 1011 "../crypto/cmp/cmp_client.c"
                          && OPENSSL_sk_num(ossl_check_const_X509_CRL_sk_type(rrep->crls)) != num_RevDetails) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",1012,__func__), ERR_set_error)((58),(188),
# 1012 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 1012 "../crypto/cmp/cmp_client.c"
       );
        ret = 0;
        goto err;
    }
...
# 1019 "../crypto/cmp/cmp_client.c" 3 4
                                                                       ((void *)0)
# 1019 "../crypto/cmp/cmp_client.c"
                                                                           )
        ERR_add_error_data(1, buf);
...
struct stack_st_OSSL_CMP_ITAV *OSSL_CMP_exec_GENM_ses(OSSL_CMP_CTX *ctx)
{
    OSSL_CMP_MSG *genm;
    OSSL_CMP_MSG *genp = 
# 1031 "../crypto/cmp/cmp_client.c" 3 4
                        ((void *)0)
# 1031 "../crypto/cmp/cmp_client.c"
                            ;
    struct stack_st_OSSL_CMP_ITAV *itavs = 
# 1032 "../crypto/cmp/cmp_client.c" 3 4
                                    ((void *)0)
# 1032 "../crypto/cmp/cmp_client.c"
                                        ;

    if (ctx == 
# 1034 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 1034 "../crypto/cmp/cmp_client.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_client.c",1035,__func__), ERR_set_error)((58),(100),
# 1035 "../crypto/cmp/cmp_client.c" 3 4
       ((void *)0)
# 1035 "../crypto/cmp/cmp_client.c"
       );
        return 
# 1036 "../crypto/cmp/cmp_client.c" 3 4
              ((void *)0)
# 1036 "../crypto/cmp/cmp_client.c"
                  ;
    }
    ctx->status = -3;

    if ((genm = ossl_cmp_genm_new(ctx)) == 
# 1040 "../crypto/cmp/cmp_client.c" 3 4
                                          ((void *)0)
# 1040 "../crypto/cmp/cmp_client.c"
                                              )
        goto err;

    ctx->status = -2;
    if (!send_receive_also_delayed(ctx, genm, &genp, 22))
        goto err;
    ctx->status = 0;

    itavs = genp->body->value.genp;
    if (itavs == 
# 1049 "../crypto/cmp/cmp_client.c" 3 4
                ((void *)0)
# 1049 "../crypto/cmp/cmp_client.c"
                    )
        itavs = ((struct stack_st_OSSL_CMP_ITAV *)OPENSSL_sk_new_null());

    genp->body->value.genp = 
# 1052 "../crypto/cmp/cmp_client.c" 3 4
                            ((void *)0)
# 1052 "../crypto/cmp/cmp_client.c"
                                ;
