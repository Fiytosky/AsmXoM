# 0 "../crypto/cmp/cmp_vfy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/cmp/cmp_vfy.c"
# 14 "../crypto/cmp/cmp_vfy.c"
                            ...
                            const OSSL_CMP_MSG *msg, X509 *cert)
{
    ...
    EVP_PKEY *pubkey = 
# 29 "../crypto/cmp/cmp_vfy.c" 3 4
                      ((void *)0)
# 29 "../crypto/cmp/cmp_vfy.c"
                          ;
    BIO *bio;
    int res = 0;

    if (!__builtin_expect(!!((cmp_ctx != 
# 33 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0) 
# 33 "../crypto/cmp/cmp_vfy.c"
        && msg != 
# 33 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0) 
# 33 "../crypto/cmp/cmp_vfy.c"
...
# 33 "../crypto/cmp/cmp_vfy.c"
    ...
    if (bio == 
# 37 "../crypto/cmp/cmp_vfy.c" 3 4
              ((void *)0)
# 37 "../crypto/cmp/cmp_vfy.c"
                  )
        return 0;

    if (!cmp_ctx->ignore_keyusage
            && (X509_get_key_usage(cert) & 0x0080) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",42,__func__), ERR_set_error)((58),(142),
# 42 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 42 "../crypto/cmp/cmp_vfy.c"
       );
        goto sig_err;
    }
    ...
    if (pubkey == 
# 47 "../crypto/cmp/cmp_vfy.c" 3 4
                 ((void *)0)
# 47 "../crypto/cmp/cmp_vfy.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",48,__func__), ERR_set_error)((58),(141),
# 48 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 48 "../crypto/cmp/cmp_vfy.c"
       );
        goto sig_err;
    }
    ...
    if (ASN1_item_verify_ex((OSSL_CMP_PROTECTEDPART_it()),
                            msg->header->protectionAlg, msg->protection,
                            &prot_part, 
# 57 "../crypto/cmp/cmp_vfy.c" 3 4
                                       ((void *)0)
# 57 "../crypto/cmp/cmp_vfy.c"
                                           , pubkey, cmp_ctx->libctx,
                            cmp_ctx->propq) > 0) {
        res = 1;
        goto end;
    }
 ...
 sig_err:
    res = ossl_x509_print_ex_brief(bio, cert, (1L << 8));
    (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",65,__func__), ERR_set_error)((58),(171),
# 65 "../crypto/cmp/cmp_vfy.c" 3 4
   ((void *)0)
# 65 "../crypto/cmp/cmp_vfy.c"
   );
    if (res)
...
{
    ASN1_BIT_STRING *protection = 
# 80 "../crypto/cmp/cmp_vfy.c" 3 4
                                 ((void *)0)
# 80 "../crypto/cmp/cmp_vfy.c"
                                     ;
    int valid = 0;


    if ((protection = ossl_cmp_calc_protection(ctx, msg)) == 
# 84 "../crypto/cmp/cmp_vfy.c" 3 4
                                                            ((void *)0)
# 84 "../crypto/cmp/cmp_vfy.c"
                                                                )
        return 0;

    valid = msg->protection != 
# 87 "../crypto/cmp/cmp_vfy.c" 3 4
                              ((void *)0) 
# 87 "../crypto/cmp/cmp_vfy.c"
    ...
    if (!valid)
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",94,__func__), ERR_set_error)((58),(155),
# 94 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 94 "../crypto/cmp/cmp_vfy.c"
       );

    return valid;
}
# 106 "../crypto/cmp/cmp_vfy.c"
int OSSL_CMP_validate_cert_path(const OSSL_CMP_CTX *ctx,
                                X509_STORE *trusted_store, X509 *cert)
{
    int valid = 0;
    X509_STORE_CTX *csc = 
# 110 "../crypto/cmp/cmp_vfy.c" 3 4
                         ((void *)0)
# 110 "../crypto/cmp/cmp_vfy.c"
                             ;
    int err;

    if (ctx == 
# 113 "../crypto/cmp/cmp_vfy.c" 3 4
              ((void *)0) 
# 113 "../crypto/cmp/cmp_vfy.c"
                   || cert == 
# 113 "../crypto/cmp/cmp_vfy.c" 3 4
                              ((void *)0)
# 113 "../crypto/cmp/cmp_vfy.c"
                                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",114,__func__), ERR_set_error)((58),(103),
# 114 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 114 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }

    if (trusted_store == 
# 118 "../crypto/cmp/cmp_vfy.c" 3 4
                        ((void *)0)
# 118 "../crypto/cmp/cmp_vfy.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",119,__func__), ERR_set_error)((58),(144),
# 119 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 119 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }

    if ((csc = X509_STORE_CTX_new_ex(ctx->libctx, ctx->propq)) == 
# 123 "../crypto/cmp/cmp_vfy.c" 3 4
                                                                 ((void *)0)
            
# 124 "../crypto/cmp/cmp_vfy.c"
    ...
    if (!valid && ERR_GET_REASON(err) != 147)
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",133,__func__), ERR_set_error)((58),(147),
# 133 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 133 "../crypto/cmp/cmp_vfy.c"
       );
...
static int verify_cb_cert(X509_STORE *ts, X509 *cert, int err)
{
    ...
    if (ts == 
# 148 "../crypto/cmp/cmp_vfy.c" 3 4
             ((void *)0) 
# 148 "../crypto/cmp/cmp_vfy.c"
                  || (verify_cb = X509_STORE_get_verify_cb(ts)) == 
# 148 "../crypto/cmp/cmp_vfy.c" 3 4
                                                                   ((void *)0)
# 148 "../crypto/cmp/cmp_vfy.c"
                                                                       )
...
# 150 "../crypto/cmp/cmp_vfy.c" 3 4
                                       ((void *)0)
            
# 151 "../crypto/cmp/cmp_vfy.c"
           && X509_STORE_CTX_init(csc, ts, cert, 
# 151 "../crypto/cmp/cmp_vfy.c" 3 4
                                                 ((void *)0)
# 151 "../crypto/cmp/cmp_vfy.c"
                                                     )) {
                      ...
                      const char *expect_desc, const X509_NAME *expect_name)
{
    ...
    if (expect_name == 
# 167 "../crypto/cmp/cmp_vfy.c" 3 4
                      ((void *)0)
# 167 "../crypto/cmp/cmp_vfy.c"
                          )
        return 1;


    if (actual_name == 
# 171 "../crypto/cmp/cmp_vfy.c" 3 4
                      ((void *)0)
# 171 "../crypto/cmp/cmp_vfy.c"
                          ) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 172, "WARN", "missing %s", actual_desc);
        return 0;
    }
    str = X509_NAME_oneline(actual_name, 
# 175 "../crypto/cmp/cmp_vfy.c" 3 4
                                        ((void *)0)
# 175 "../crypto/cmp/cmp_vfy.c"
                                            , 0);
    if (X509_NAME_cmp(actual_name, expect_name) == 0) {
        if (log_success && str != 
# 177 "../crypto/cmp/cmp_vfy.c" 3 4
                                 ((void *)0)
# 177 "../crypto/cmp/cmp_vfy.c"
                                     )
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 178, "INFO", " %s matches %s: %s", actual_desc, expect_desc, str)
                                                        ;
        CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 180);
        return 1;
    }

    if (str != 
# 184 "../crypto/cmp/cmp_vfy.c" 3 4
              ((void *)0)
# 184 "../crypto/cmp/cmp_vfy.c"
                  )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 185, "INFO", " actual name in %s = %s", actual_desc, str);
    CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 186);
    if ((str = X509_NAME_oneline(expect_name, 
# 187 "../crypto/cmp/cmp_vfy.c" 3 4
                                             ((void *)0)
# 187 "../crypto/cmp/cmp_vfy.c"
                                                 , 0)) != 
# 187 "../crypto/cmp/cmp_vfy.c" 3 4
                                                          ((void *)0)
# 187 "../crypto/cmp/cmp_vfy.c"
                                                              )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 188, "INFO", " does not match %s = %s", expect_desc, str);
    CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 189);
    return 0;
}
                     ...
                     const ASN1_OCTET_STRING *skid)
{
    ...
    if (skid == 
# 200 "../crypto/cmp/cmp_vfy.c" 3 4
               ((void *)0)
# 200 "../crypto/cmp/cmp_vfy.c"
                   )
        return 1;


    if (ckid == 
# 204 "../crypto/cmp/cmp_vfy.c" 3 4
               ((void *)0)
# 204 "../crypto/cmp/cmp_vfy.c"
                   ) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 205, "WARN", "%s", "missing Subject Key Identifier in certificate");
        return 0;
    }
    str = i2s_ASN1_OCTET_STRING(
# 208 "../crypto/cmp/cmp_vfy.c" 3 4
                               ((void *)0)
# 208 "../crypto/cmp/cmp_vfy.c"
                                   , ckid);
    if (ASN1_OCTET_STRING_cmp(ckid, skid) == 0) {
        if (str != 
# 210 "../crypto/cmp/cmp_vfy.c" 3 4
                  ((void *)0)
# 210 "../crypto/cmp/cmp_vfy.c"
                      )
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 211, "INFO", " subjectKID matches senderKID: %s", str);
        CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 212);
        return 1;
    }

    if (str != 
# 216 "../crypto/cmp/cmp_vfy.c" 3 4
              ((void *)0)
# 216 "../crypto/cmp/cmp_vfy.c"
                  )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 217, "INFO", " cert Subject Key Identifier = %s", str);
    CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 218);
    if ((str = i2s_ASN1_OCTET_STRING(
# 219 "../crypto/cmp/cmp_vfy.c" 3 4
                                    ((void *)0)
# 219 "../crypto/cmp/cmp_vfy.c"
                                        , skid)) != 
# 219 "../crypto/cmp/cmp_vfy.c" 3 4
                                                    ((void *)0)
# 219 "../crypto/cmp/cmp_vfy.c"
                                                        )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 220, "INFO", " does not match senderKID    = %s", str);
    CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 221);
    return 0;
}

static int already_checked(const X509 *cert,
                           const struct stack_st_X509 *already_checked)
{
    int i;

    for (i = OPENSSL_sk_num(ossl_check_const_X509_sk_type(already_checked)); i > 0; i--)
        if (X509_cmp(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(already_checked), (i - 1))), cert) == 0)
            return 1;
    return 0;
}
# 244 "../crypto/cmp/cmp_vfy.c"
static int cert_acceptable(const OSSL_CMP_CTX *ctx,
                           const char *desc1, const char *desc2, X509 *cert,
                           const struct stack_st_X509 *already_checked1,
                           const struct stack_st_X509 *already_checked2,
                           const OSSL_CMP_MSG *msg)
{
    X509_STORE *ts = ctx->trusted;
    int self_issued = X509_check_issued(cert, cert) == 0;
    char *str;
    X509_VERIFY_PARAM *vpm = ts != 
# 253 "../crypto/cmp/cmp_vfy.c" 3 4
                                  ((void *)0) 
# 253 "../crypto/cmp/cmp_vfy.c"
...
# 253 "../crypto/cmp/cmp_vfy.c"
    ...
    ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 256, "INFO", " considering %s%s %s with..", self_issued ? "self-issued ": "", desc1, desc2)
                                                                 ;
    if ((str = X509_NAME_oneline(X509_get_subject_name(cert), 
# 258 "../crypto/cmp/cmp_vfy.c" 3 4
                                                             ((void *)0)
# 258 "../crypto/cmp/cmp_vfy.c"
                                                                 , 0)) != 
# 258 "../crypto/cmp/cmp_vfy.c" 3 4
                                                                          ((void *)0)
# 258 "../crypto/cmp/cmp_vfy.c"
                                                                              )
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 259, "INFO", "  subject = %s", str);
    CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 260);
    if (!self_issued) {
        str = X509_NAME_oneline(X509_get_issuer_name(cert), 
# 262 "../crypto/cmp/cmp_vfy.c" 3 4
                                                           ((void *)0)
# 262 "../crypto/cmp/cmp_vfy.c"
                                                               , 0);
        if (str != 
# 263 "../crypto/cmp/cmp_vfy.c" 3 4
                  ((void *)0)
# 263 "../crypto/cmp/cmp_vfy.c"
                      )
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 264, "INFO", "  issuer  = %s", str);
        CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 265);
    }

    if (already_checked(cert, already_checked1)
            || already_checked(cert, already_checked2)) {
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 270, "INFO", "%s", " cert has already been checked");
        return 0;
    }
    ...
    if (time_cmp != 0) {
        int err = time_cmp > 0 ? 10
                               : 9;

        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 280, "WARN", "%s", time_cmp > 0 ? "cert has expired" : "cert is not yet valid")
                                                                  ;
        if (ctx->log_cb != 
# 282 "../crypto/cmp/cmp_vfy.c" 3 4
                          ((void *)0)
                
# 283 "../crypto/cmp/cmp_vfy.c"
    ...
    if (!ossl_x509v3_cache_extensions(cert)) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 296, "WARN", "%s", "cert appears to be invalid");
        return 0;
    }
    if (!verify_signature(ctx, msg, cert)) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 300, "WARN", "%s", "msg signature verification failed");
        return 0;
    }

    ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 304, "INFO", "%s", " cert seems acceptable");
    return 1;
}
                           ...
                           X509 *scrt)
{
    ...
    ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 314, "WARN", "%s", "msg signature validates but cert path validation failed")
                                                                            ;
    return 0;
}
# 326 "../crypto/cmp/cmp_vfy.c"
...
# 335 "../crypto/cmp/cmp_vfy.c" 3 4
                                     ((void *)0)
            
# 336 "../crypto/cmp/cmp_vfy.c"
    ...
    if (!valid) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 343, "WARN", "%s", "also exceptional 3GPP mode cert path validation failed")
                                                                               ;
    } else {
                                ...
                                const OSSL_CMP_MSG *msg)
{
    return cert_acceptable(ctx, "previously validated", "sender cert",
                           cert, 
# 372 "../crypto/cmp/cmp_vfy.c" 3 4
                                ((void *)0)
# 372 "../crypto/cmp/cmp_vfy.c"
                                    , 
# 372 "../crypto/cmp/cmp_vfy.c" 3 4
                                      ((void *)0)
# 372 "../crypto/cmp/cmp_vfy.c"
...
static int check_msg_with_certs(OSSL_CMP_CTX *ctx, const struct stack_st_X509 *certs,
                                const char *desc,
                                const struct stack_st_X509 *already_checked1,
                                const struct stack_st_X509 *already_checked2,
                                const OSSL_CMP_MSG *msg, int mode_3gpp)
{
    int in_extraCerts = already_checked1 == 
# 388 "../crypto/cmp/cmp_vfy.c" 3 4
                                           ((void *)0)
# 388 "../crypto/cmp/cmp_vfy.c"
                                               ;
    int n_acceptable_certs = 0;
    int i;

    if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)) <= 0) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 393, "WARN", "no %s", desc);
        return 0;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        X509 *cert = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));

        if (!__builtin_expect(!!((cert != 
# 400 "../crypto/cmp/cmp_vfy.c" 3 4
            ((void *)0)
# 400 "../crypto/cmp/cmp_vfy.c"
            ) != 0), 1))
            return 0;
    ...
    if (in_extraCerts && n_acceptable_certs == 0)
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 413, "WARN", "%s", "no acceptable cert in extraCerts");
    return 0;
}
                               ...
                               int mode_3gpp)
{
    ...
    if (ctx->permitTAInExtraCertsForIR
            && OSSL_CMP_MSG_get_bodytype(msg) == 1)
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 429, "INFO", "%s", mode_3gpp ? "normal mode failed; trying now 3GPP mode trusting extraCerts" : "trying first normal mode using trust store")
...
# 436 "../crypto/cmp/cmp_vfy.c" 3 4
                            ((void *)0)
# 436 "../crypto/cmp/cmp_vfy.c"
                                , 
# 436 "../crypto/cmp/cmp_vfy.c" 3 4
                                  ((void *)0)
# 436 "../crypto/cmp/cmp_vfy.c"
    ...
    if (check_msg_with_certs(ctx, ctx->untrusted, "untrusted certs",
                             msg->extraCerts, 
# 439 "../crypto/cmp/cmp_vfy.c" 3 4
                                             ((void *)0)
# 439 "../crypto/cmp/cmp_vfy.c"
                                                 , msg, mode_3gpp))
        return 1;

    if (ctx->trusted == 
# 442 "../crypto/cmp/cmp_vfy.c" 3 4
                       ((void *)0)
# 442 "../crypto/cmp/cmp_vfy.c"
                           ) {
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 443, "WARN", "%s", mode_3gpp ? "no self-issued extraCerts" : "no trusted store")
                                                          ;
    } else {
        struct stack_st_X509 *trusted = X509_STORE_get1_all_certs(ctx->trusted);
...
static int check_msg_find_cert(OSSL_CMP_CTX *ctx, const OSSL_CMP_MSG *msg)
{
    ...
    char *sname = 
# 466 "../crypto/cmp/cmp_vfy.c" 3 4
                 ((void *)0)
# 466 "../crypto/cmp/cmp_vfy.c"
                     ;
    char *skid_str = 
# 467 "../crypto/cmp/cmp_vfy.c" 3 4
                    ((void *)0)
# 467 "../crypto/cmp/cmp_vfy.c"
                        ;
    ...
    if (sender == 
# 472 "../crypto/cmp/cmp_vfy.c" 3 4
                 ((void *)0) 
# 472 "../crypto/cmp/cmp_vfy.c"
                      || msg->body == 
# 472 "../crypto/cmp/cmp_vfy.c" 3 4
                                      ((void *)0)
# 472 "../crypto/cmp/cmp_vfy.c"
    ...
    if (sender->type != 4) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",476,__func__), ERR_set_error)((58),(150),
# 476 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 476 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }
    ...
    (void)ERR_set_mark();
    ctx->log_cb = 
# 485 "../crypto/cmp/cmp_vfy.c" 3 4
                 ((void *)0)
# 485 "../crypto/cmp/cmp_vfy.c"
                     ;
    ...
    if (scrt != 
# 491 "../crypto/cmp/cmp_vfy.c" 3 4
               ((void *)0)
# 491 "../crypto/cmp/cmp_vfy.c"
                   ) {
        ...
        (void)ossl_cmp_ctx_set1_validatedSrvCert(ctx, 
# 498 "../crypto/cmp/cmp_vfy.c" 3 4
                                                     ((void *)0)
# 498 "../crypto/cmp/cmp_vfy.c"
                                                         );

        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 500, "INFO", "%s", "trying to verify msg signature with previously validated cert")
                                                                                      ;
        (void)check_msg_given_cert(ctx, scrt, msg);
    }

    res = check_msg_all_certs(ctx, msg, 0 )
    ...
    sname = X509_NAME_oneline(sender->d.directoryName, 
# 516 "../crypto/cmp/cmp_vfy.c" 3 4
                                                      ((void *)0)
# 516 "../crypto/cmp/cmp_vfy.c"
                                                          , 0);
    skid_str = skid == 
# 517 "../crypto/cmp/cmp_vfy.c" 3 4
                      ((void *)0) 
# 517 "../crypto/cmp/cmp_vfy.c"
                           ? 
# 517 "../crypto/cmp/cmp_vfy.c" 3 4
                             ((void *)0) 
# 517 "../crypto/cmp/cmp_vfy.c"
...
# 517 "../crypto/cmp/cmp_vfy.c"
                                                              , skid);
    if (ctx->log_cb != 
# 518 "../crypto/cmp/cmp_vfy.c" 3 4
                      ((void *)0)
# 518 "../crypto/cmp/cmp_vfy.c"
                          ) {
        ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 519, "INFO", "%s", "trying to verify msg signature with a valid cert that..");
        if (sname != 
# 520 "../crypto/cmp/cmp_vfy.c" 3 4
                    ((void *)0)
# 520 "../crypto/cmp/cmp_vfy.c"
                        )
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 521, "INFO", "matches msg sender    = %s", sname);
        if (skid_str != 
# 522 "../crypto/cmp/cmp_vfy.c" 3 4
                       ((void *)0)
# 522 "../crypto/cmp/cmp_vfy.c"
                           )
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 523, "INFO", "matches msg senderKID = %s", skid_str);
        else
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 525, "INFO", "%s", "while msg header does not contain senderKID");

        (void)check_msg_all_certs(ctx, msg, 0 );
        (void)check_msg_all_certs(ctx, msg, 1 );
    }

    (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",531,__func__), ERR_set_error)((58),(145),
# 531 "../crypto/cmp/cmp_vfy.c" 3 4
   ((void *)0)
# 531 "../crypto/cmp/cmp_vfy.c"
   );
    if (sname != 
# 532 "../crypto/cmp/cmp_vfy.c" 3 4
                ((void *)0)
# 532 "../crypto/cmp/cmp_vfy.c"
                    ) {
        ERR_add_error_txt(
# 533 "../crypto/cmp/cmp_vfy.c" 3 4
                         ((void *)0)
# 533 "../crypto/cmp/cmp_vfy.c"
                             , "for msg sender name = ");
        ERR_add_error_txt(
# 534 "../crypto/cmp/cmp_vfy.c" 3 4
                         ((void *)0)
# 534 "../crypto/cmp/cmp_vfy.c"
                             , sname);
    }
    if (skid_str != 
# 536 "../crypto/cmp/cmp_vfy.c" 3 4
                   ((void *)0)
# 536 "../crypto/cmp/cmp_vfy.c"
                       ) {
        ERR_add_error_txt(" and ", "for msg senderKID = ");
        ERR_add_error_txt(
# 538 "../crypto/cmp/cmp_vfy.c" 3 4
                         ((void *)0)
# 538 "../crypto/cmp/cmp_vfy.c"
                             , skid_str);
    }

 end:
    CRYPTO_free(sname, "../crypto/cmp/cmp_vfy.c", 542);
    CRYPTO_free(skid_str, "../crypto/cmp/cmp_vfy.c", 543);
    return res;
}
# 563 "../crypto/cmp/cmp_vfy.c"
int OSSL_CMP_validate_msg(OSSL_CMP_CTX *ctx, const OSSL_CMP_MSG *msg)
{
    X509 *scrt;

    ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 567, "DEBUG", "%s", "validating CMP message");
    if (ctx == 
# 568 "../crypto/cmp/cmp_vfy.c" 3 4
              ((void *)0) 
# 568 "../crypto/cmp/cmp_vfy.c"
                   || msg == 
# 568 "../crypto/cmp/cmp_vfy.c" 3 4
                             ((void *)0)
            
# 569 "../crypto/cmp/cmp_vfy.c"
           || msg->header == 
# 569 "../crypto/cmp/cmp_vfy.c" 3 4
                             ((void *)0) 
# 569 "../crypto/cmp/cmp_vfy.c"
                                  || msg->body == 
# 569 "../crypto/cmp/cmp_vfy.c" 3 4
...
# 569 "../crypto/cmp/cmp_vfy.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",570,__func__), ERR_set_error)((58),(103),
# 570 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 570 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }

    if (msg->header->protectionAlg == 
# 574 "../crypto/cmp/cmp_vfy.c" 3 4
                                     ((void *)0)
            
# 575 "../crypto/cmp/cmp_vfy.c"
           || msg->protection == 
# 575 "../crypto/cmp/cmp_vfy.c" 3 4
                                 ((void *)0) 
# 575 "../crypto/cmp/cmp_vfy.c"
                                      || msg->protection->data == 
# 575 "../crypto/cmp/cmp_vfy.c" 3 4
...
# 575 "../crypto/cmp/cmp_vfy.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",576,__func__), ERR_set_error)((58),(143),
# 576 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 576 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }
    ...
    case 782:
        if (ctx->secretValue == 
# 583 "../crypto/cmp/cmp_vfy.c" 3 4
                               ((void *)0)
# 583 "../crypto/cmp/cmp_vfy.c"
                                   ) {
            ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 584, "INFO", "%s", "no secret available for verifying PBM-based CMP message protection");
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",585,__func__), ERR_set_error)((58),(178),
# 585 "../crypto/cmp/cmp_vfy.c" 3 4
           ((void *)0)
# 585 "../crypto/cmp/cmp_vfy.c"
           );
            return 0;
        }
        if (verify_PBMAC(ctx, msg)) {
            ...
            case 14:
                if (ctx->trusted != 
# 602 "../crypto/cmp/cmp_vfy.c" 3 4
                                   ((void *)0)
# 602 "../crypto/cmp/cmp_vfy.c"
                                       ) {
                    struct stack_st_X509 *certs = msg->body->value.ip->caPubs;
            ...
            ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 614, "DEBUG", "%s", "successfully validated PBM-based CMP message protection")
                                                                                     ;
            return 1;
        }
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 618, "WARN", "%s", "verifying PBM-based CMP message protection failed");
        break;
    ...
    case 783:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",626,__func__), ERR_set_error)((58),(154),
# 626 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 626 "../crypto/cmp/cmp_vfy.c"
       );
        break;
    ...
    default:
        scrt = ctx->srvCert;
        if (scrt == 
# 634 "../crypto/cmp/cmp_vfy.c" 3 4
                   ((void *)0)
# 634 "../crypto/cmp/cmp_vfy.c"
                       ) {
            if (ctx->trusted == 
# 635 "../crypto/cmp/cmp_vfy.c" 3 4
                               ((void *)0) 
# 635 "../crypto/cmp/cmp_vfy.c"
                                    && ctx->secretValue != 
# 635 "../crypto/cmp/cmp_vfy.c" 3 4
                                                           ((void *)0)
# 635 "../crypto/cmp/cmp_vfy.c"
                                                               ) {
                ossl_cmp_print_log(6, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 636, "INFO", "%s", "no trust store nor pinned server cert available for verifying signature-based CMP message protection");
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",637,__func__), ERR_set_error)((58),(179),
# 637 "../crypto/cmp/cmp_vfy.c" 3 4
               ((void *)0)
# 637 "../crypto/cmp/cmp_vfy.c"
               );
                return 0;
            }
            if (check_msg_find_cert(ctx, msg)) {
                ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 641, "DEBUG", "%s", "successfully validated signature-based CMP message protection using trust store")
                                                                                                                 ;
                return 1;
            }
        } else {
            ...
            if (verify_signature(ctx, msg, scrt)) {
                ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 648, "DEBUG", "%s", "successfully validated signature-based CMP message protection using pinned server cert")
                                                                                                                        ;
                return ossl_cmp_ctx_set1_validatedSrvCert(ctx, scrt);
            }
            ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 652, "WARN", "%s", "CMP message signature verification failed");
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",653,__func__), ERR_set_error)((58),(151),
# 653 "../crypto/cmp/cmp_vfy.c" 3 4
           ((void *)0)
# 653 "../crypto/cmp/cmp_vfy.c"
           );
        }
        break;
    }
...
{
    if (expected != 
# 663 "../crypto/cmp/cmp_vfy.c" 3 4
                   ((void *)0)
        
# 664 "../crypto/cmp/cmp_vfy.c"
       && (actual == 
# 664 "../crypto/cmp/cmp_vfy.c" 3 4
                     ((void *)0) 
# 664 "../crypto/cmp/cmp_vfy.c"
                          || ASN1_OCTET_STRING_cmp(expected, actual) != 0)) {

        char *expected_str, *actual_str;

        expected_str = i2s_ASN1_OCTET_STRING(
# 668 "../crypto/cmp/cmp_vfy.c" 3 4
                                            ((void *)0)
# 668 "../crypto/cmp/cmp_vfy.c"
                                                , expected);
        actual_str = actual == 
# 669 "../crypto/cmp/cmp_vfy.c" 3 4
                              ((void *)0) 
# 669 "../crypto/cmp/cmp_vfy.c"
                                   ? 
# 669 "../crypto/cmp/cmp_vfy.c" 3 4
                                     ((void *)0)
# 669 "../crypto/cmp/cmp_vfy.c"
...
# 669 "../crypto/cmp/cmp_vfy.c"
                                                                     , actual);
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",670,__func__), ERR_set_error)(58, reason,
                       "expected = %s, actual = %s",
                       expected_str == 
# 672 "../crypto/cmp/cmp_vfy.c" 3 4
                                      ((void *)0) 
# 672 "../crypto/cmp/cmp_vfy.c"
                                           ? "?" : expected_str,
                       actual == 
# 673 "../crypto/cmp/cmp_vfy.c" 3 4
                                ((void *)0) 
# 673 "../crypto/cmp/cmp_vfy.c"
                                     ? "(none)" :
                       actual_str == 
# 674 "../crypto/cmp/cmp_vfy.c" 3 4
                                    ((void *)0) 
# 674 "../crypto/cmp/cmp_vfy.c"
                                         ? "?" : actual_str);
        CRYPTO_free(expected_str, "../crypto/cmp/cmp_vfy.c", 675);
        CRYPTO_free(actual_str, "../crypto/cmp/cmp_vfy.c", 676);
        return 0;

    }
    return 1;
}
# 703 "../crypto/cmp/cmp_vfy.c"
int ossl_cmp_msg_check_update(OSSL_CMP_CTX *ctx, const OSSL_CMP_MSG *msg,
                              ossl_cmp_allow_unprotected_cb_t cb, int cb_arg)
{
    OSSL_CMP_PKIHEADER *hdr;
...
# 710 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0) 
# 710 "../crypto/cmp/cmp_vfy.c"
        && msg != 
# 710 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0) 
# 710 "../crypto/cmp/cmp_vfy.c"
...
# 710 "../crypto/cmp/cmp_vfy.c"
    ...
    if (expected_sender == 
# 716 "../crypto/cmp/cmp_vfy.c" 3 4
                          ((void *)0) 
# 716 "../crypto/cmp/cmp_vfy.c"
                               && ctx->srvCert != 
# 716 "../crypto/cmp/cmp_vfy.c" 3 4
                                                  ((void *)0)
# 716 "../crypto/cmp/cmp_vfy.c"
    ...
    if (expected_sender != 
# 718 "../crypto/cmp/cmp_vfy.c" 3 4
                          ((void *)0)
# 718 "../crypto/cmp/cmp_vfy.c"
                              ) {
        const X509_NAME *actual_sender;
        char *str;

        if (hdr->sender->type != 4) {
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",723,__func__), ERR_set_error)((58),(150),
# 723 "../crypto/cmp/cmp_vfy.c" 3 4
           ((void *)0)
# 723 "../crypto/cmp/cmp_vfy.c"
           );
            return 0;
        }
        ...
        if (!check_name(ctx, 0, "sender DN field", actual_sender,
            ...
            str = X509_NAME_oneline(actual_sender, 
# 734 "../crypto/cmp/cmp_vfy.c" 3 4
                                                  ((void *)0)
# 734 "../crypto/cmp/cmp_vfy.c"
                                                      , 0);
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",735,__func__), ERR_set_error)(58, 106,
                           str != 
# 736 "../crypto/cmp/cmp_vfy.c" 3 4
                                 ((void *)0) 
# 736 "../crypto/cmp/cmp_vfy.c"
                                      ? str : "<unknown>");
            CRYPTO_free(str, "../crypto/cmp/cmp_vfy.c", 737);
            return 0;
        }
    }


    num_added = OPENSSL_sk_num(ossl_check_const_X509_sk_type(msg->extraCerts));
    if (num_added > 10)
        ossl_cmp_print_log(4, ctx, __func__, "../crypto/cmp/cmp_vfy.c", 745, "WARN", "received CMP message contains %d extraCerts", num_added)
                                ;
# 756 "../crypto/cmp/cmp_vfy.c"
    num_untrusted = ctx->untrusted == 
# 756 "../crypto/cmp/cmp_vfy.c" 3 4
                                     ((void *)0) 
# 756 "../crypto/cmp/cmp_vfy.c"
                                          ? 0 : OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->untrusted));
    res = ossl_x509_add_certs_new(&ctx->untrusted, msg->extraCerts,

                                  0x1 | 0x4
                                  | 0x2);
    num_added = (ctx->untrusted == 
# 761 "../crypto/cmp/cmp_vfy.c" 3 4
                                  ((void *)0) 
# 761 "../crypto/cmp/cmp_vfy.c"
                                       ? 0 : OPENSSL_sk_num(ossl_check_const_X509_sk_type(ctx->untrusted)))
        - num_untrusted;
    if (!res) {
        while (num_added-- > 0)
            X509_free(((X509 *)OPENSSL_sk_shift(ossl_check_X509_sk_type(ctx->untrusted))));
        return 0;
    }

    if (hdr->protectionAlg != 
# 769 "../crypto/cmp/cmp_vfy.c" 3 4
                             ((void *)0)
# 769 "../crypto/cmp/cmp_vfy.c"
                                 )
        res = OSSL_CMP_validate_msg(ctx, msg)

            || (cb != 
# 772 "../crypto/cmp/cmp_vfy.c" 3 4
                     ((void *)0) 
# 772 "../crypto/cmp/cmp_vfy.c"
                          && (*cb)(ctx, msg, 1, cb_arg) > 0);
    else

        res = cb != 
# 775 "../crypto/cmp/cmp_vfy.c" 3 4
                   ((void *)0) 
# 775 "../crypto/cmp/cmp_vfy.c"
                        && (*cb)(ctx, msg, 0, cb_arg) > 0;
    ...
    if (!res) {
        if (hdr->protectionAlg != 
# 786 "../crypto/cmp/cmp_vfy.c" 3 4
                                 ((void *)0)
# 786 "../crypto/cmp/cmp_vfy.c"
                                     )
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",787,__func__), ERR_set_error)((58),(140),
# 787 "../crypto/cmp/cmp_vfy.c" 3 4
           ((void *)0)
# 787 "../crypto/cmp/cmp_vfy.c"
           );
        else
            (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",789,__func__), ERR_set_error)((58),(143),
# 789 "../crypto/cmp/cmp_vfy.c" 3 4
           ((void *)0)
# 789 "../crypto/cmp/cmp_vfy.c"
           );
        return 0;
    }


    if (ossl_cmp_hdr_get_pvno(hdr) != 2
            && ossl_cmp_hdr_get_pvno(hdr) != 3) {

        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",797,__func__), ERR_set_error)((58),(153),
# 797 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 797 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    ...
    if (OSSL_CMP_MSG_get_bodytype(msg) < 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",804,__func__), ERR_set_error)((58),(146),
# 804 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 804 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    ...
    if (!check_transactionID_or_nonce(ctx->senderNonce, hdr->recipNonce,
        ...
        if (ctx->first_senderNonce == 
# 823 "../crypto/cmp/cmp_vfy.c" 3 4
                                     ((void *)0)
            
# 824 "../crypto/cmp/cmp_vfy.c"
           || OSSL_CMP_MSG_get_bodytype(msg) == 26
...
# 836 "../crypto/cmp/cmp_vfy.c" 3 4
                             ((void *)0)
        
# 837 "../crypto/cmp/cmp_vfy.c"
    ...
    if (ossl_cmp_hdr_get_protection_nid(hdr) == 782) {
        ...
        case 14:
            if (ctx->trusted != 
# 860 "../crypto/cmp/cmp_vfy.c" 3 4
                               ((void *)0)
# 860 "../crypto/cmp/cmp_vfy.c"
                                   ) {
                struct stack_st_X509 *certs = msg->body->value.ip->caPubs;
...
# 879 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0) 
# 879 "../crypto/cmp/cmp_vfy.c"
        && msg->body != 
# 879 "../crypto/cmp/cmp_vfy.c" 3 4
        ((void *)0)
# 879 "../crypto/cmp/cmp_vfy.c"
    ...
    case 4:
        {
            ...
            if (X509_REQ_verify_ex(req, X509_REQ_get0_pubkey(req), ctx->libctx,
                ...
                (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",889,__func__), ERR_set_error)((58),(149),
# 889 "../crypto/cmp/cmp_vfy.c" 3 4
               ((void *)0)
# 889 "../crypto/cmp/cmp_vfy.c"
               );
                return 0;
    ...
    case 2:
    case 7:
        if (!OSSL_CRMF_MSGS_verify_popo(msg->body->value.ir, 0,
                                        acceptRAVerified,
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_vfy.c",907,__func__), ERR_set_error)((58),(146),
# 907 "../crypto/cmp/cmp_vfy.c" 3 4
       ((void *)0)
# 907 "../crypto/cmp/cmp_vfy.c"
       );
        return 0;
    }
    return 1;
