...
int ossl_cmp_hdr_set_pvno(OSSL_CMP_PKIHEADER *hdr, int pvno)
{
    if (!__builtin_expect(!!((hdr != 
# 25 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 25 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
...
int ossl_cmp_hdr_get_pvno(const OSSL_CMP_PKIHEADER *hdr)
{
    ...
    if (!__builtin_expect(!!((hdr != 
# 34 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 34 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return -1;
    if (!ASN1_INTEGER_get_int64(&pvno, hdr->pvno) || pvno < 0 || pvno > 0x7fffffff
# 36 "../crypto/cmp/cmp_hdr.c"
                                                                              )
        return -1;
    return (int)pvno;
}
...
{
    if (!__builtin_expect(!!((hdr != 
# 43 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 43 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1)
            || hdr->protectionAlg == 
# 44 "../crypto/cmp/cmp_hdr.c" 3 4
                                    ((void *)0)
# 44 "../crypto/cmp/cmp_hdr.c"
                                        )
        return 0;
...
{
    if (hdr == 
# 52 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 52 "../crypto/cmp/cmp_hdr.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_hdr.c",53,__func__), ERR_set_error)((58),(103),
# 53 "../crypto/cmp/cmp_hdr.c" 3 4
       ((void *)0)
# 53 "../crypto/cmp/cmp_hdr.c"
       );
        return 
# 54 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 54 "../crypto/cmp/cmp_hdr.c"
                  ;
    }
...
{
    if (!__builtin_expect(!!((hdr != 
# 61 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 61 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 
# 62 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 62 "../crypto/cmp/cmp_hdr.c"
                  ;
...
{
    if (hdr == 
# 68 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 68 "../crypto/cmp/cmp_hdr.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_hdr.c",69,__func__), ERR_set_error)((58),(103),
# 69 "../crypto/cmp/cmp_hdr.c" 3 4
       ((void *)0)
# 69 "../crypto/cmp/cmp_hdr.c"
       );
        return 
# 70 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 70 "../crypto/cmp/cmp_hdr.c"
                  ;
    }
...
{
    if (hdr == 
# 78 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 78 "../crypto/cmp/cmp_hdr.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_hdr.c",79,__func__), ERR_set_error)((58),(103),
# 79 "../crypto/cmp/cmp_hdr.c" 3 4
       ((void *)0)
# 79 "../crypto/cmp/cmp_hdr.c"
       );
        return 
# 80 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 80 "../crypto/cmp/cmp_hdr.c"
                  ;
    }
...
{
    return name == 
# 88 "../crypto/cmp/cmp_hdr.c" 3 4
                  ((void *)0)
        
# 89 "../crypto/cmp/cmp_hdr.c"
       || (name->type == 4 && (X509_NAME_get_entry(name->d.directoryName, 0) == 
# 89 "../crypto/cmp/cmp_hdr.c" 3 4
                                        ((void *)0)
# 89 "../crypto/cmp/cmp_hdr.c"
                                        ));
}
...
static int set1_general_name(GENERAL_NAME **tgt, const X509_NAME *src)
{
    ...
    if (!__builtin_expect(!!((tgt != 
# 97 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 97 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
    if ((name = GENERAL_NAME_new()) == 
# 99 "../crypto/cmp/cmp_hdr.c" 3 4
                                      ((void *)0)
# 99 "../crypto/cmp/cmp_hdr.c"
                                          )
        goto err;
    name->type = 4;

    if (src == 
# 103 "../crypto/cmp/cmp_hdr.c" 3 4
              ((void *)0)
# 103 "../crypto/cmp/cmp_hdr.c"
                  ) {
        if ((name->d.directoryName = X509_NAME_new()) == 
# 104 "../crypto/cmp/cmp_hdr.c" 3 4
                                                        ((void *)0)
# 104 "../crypto/cmp/cmp_hdr.c"
                                                            )
            goto err;
...
{
    if (!__builtin_expect(!!((hdr != 
# 127 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 127 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
...
{
    if (!__builtin_expect(!!((hdr != 
# 134 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 134 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
...
{
    if (!__builtin_expect(!!((hdr != 
# 141 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 141 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
    if (hdr->messageTime == 
# 143 "../crypto/cmp/cmp_hdr.c" 3 4
                           ((void *)0)
            
# 144 "../crypto/cmp/cmp_hdr.c"
           && (hdr->messageTime = ASN1_GENERALIZEDTIME_new()) == 
# 144 "../crypto/cmp/cmp_hdr.c" 3 4
                                                                 ((void *)0)
# 144 "../crypto/cmp/cmp_hdr.c"
                                                                     )
        return 0;
    return ASN1_GENERALIZEDTIME_set(hdr->messageTime, time(
# 146 "../crypto/cmp/cmp_hdr.c" 3 4
                                                          ((void *)0)
# 146 "../crypto/cmp/cmp_hdr.c"
                                                              )) != 
# 146 "../crypto/cmp/cmp_hdr.c" 3 4
                                                                    ((void *)0)
# 146 "../crypto/cmp/cmp_hdr.c"
...
{
    unsigned char *bytes = CRYPTO_malloc(len, "../crypto/cmp/cmp_hdr.c", 152);
    int res = 0;

    if (bytes == 
# 155 "../crypto/cmp/cmp_hdr.c" 3 4
                ((void *)0) 
# 155 "../crypto/cmp/cmp_hdr.c"
                     || RAND_bytes_ex(ctx->libctx, bytes, len, 0) <= 0)
        (ERR_new(), ERR_set_debug("../crypto/cmp/cmp_hdr.c",156,__func__), ERR_set_error)((58),(110),
# 156 "../crypto/cmp/cmp_hdr.c" 3 4
       ((void *)0)
# 156 "../crypto/cmp/cmp_hdr.c"
       );
    else
        res = ossl_cmp_asn1_octet_string_set1_bytes(tgt, bytes, len);
    CRYPTO_free(bytes, "../crypto/cmp/cmp_hdr.c", 159);
    return res;
}
...
{
    if (!__builtin_expect(!!((hdr != 
# 166 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 166 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
...
{
    if (!__builtin_expect(!!((hdr != 
# 174 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0) 
# 174 "../crypto/cmp/cmp_hdr.c"
        && text != 
# 174 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 174 "../crypto/cmp/cmp_hdr.c"
    ...
    if (hdr->freeText == 
# 177 "../crypto/cmp/cmp_hdr.c" 3 4
                        ((void *)0)
            
# 178 "../crypto/cmp/cmp_hdr.c"
           && (hdr->freeText = ((struct stack_st_ASN1_UTF8STRING *)OPENSSL_sk_new_null())) == 
# 178 "../crypto/cmp/cmp_hdr.c" 3 4
                                                                 ((void *)0)
# 178 "../crypto/cmp/cmp_hdr.c"
                                                                     )
        return 0;

    return OPENSSL_sk_push(ossl_check_ASN1_UTF8STRING_sk_type(hdr->freeText), ossl_check_ASN1_UTF8STRING_type(text));
}

int ossl_cmp_hdr_push1_freeText(OSSL_CMP_PKIHEADER *hdr, ASN1_UTF8STRING *text)
{
    if (!__builtin_expect(!!((hdr != 
# 186 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0) 
# 186 "../crypto/cmp/cmp_hdr.c"
        && text != 
# 186 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 186 "../crypto/cmp/cmp_hdr.c"
    ...
    if (hdr->freeText == 
# 189 "../crypto/cmp/cmp_hdr.c" 3 4
                        ((void *)0)
            
# 190 "../crypto/cmp/cmp_hdr.c"
           && (hdr->freeText = ((struct stack_st_ASN1_UTF8STRING *)OPENSSL_sk_new_null())) == 
# 190 "../crypto/cmp/cmp_hdr.c" 3 4
                                                                 ((void *)0)
# 190 "../crypto/cmp/cmp_hdr.c"
                                                                     )
        return 0;
...
{
    if (!__builtin_expect(!!((hdr != 
# 201 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0) 
# 201 "../crypto/cmp/cmp_hdr.c"
        && itav != 
# 201 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 201 "../crypto/cmp/cmp_hdr.c"
                                         ...
                                         const struct stack_st_OSSL_CMP_ITAV *itavs)
{
    ...
    if (!__builtin_expect(!!((hdr != 
# 212 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 212 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(itavs)); i++) {
        ...
        if (itav == 
# 217 "../crypto/cmp/cmp_hdr.c" 3 4
                   ((void *)0)
# 217 "../crypto/cmp/cmp_hdr.c"
                       )
            return 0;
...
int ossl_cmp_hdr_set_implicitConfirm(OSSL_CMP_PKIHEADER *hdr)
{
    ...
    if (!__builtin_expect(!!((hdr != 
# 233 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 233 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;
    asn1null = (ASN1_TYPE *)ASN1_NULL_new();
    if (asn1null == 
# 236 "../crypto/cmp/cmp_hdr.c" 3 4
                   ((void *)0)
# 236 "../crypto/cmp/cmp_hdr.c"
                       )
        return 0;
    if ((itav = OSSL_CMP_ITAV_create(OBJ_nid2obj(310),
                                     asn1null)) == 
# 239 "../crypto/cmp/cmp_hdr.c" 3 4
                                                  ((void *)0)
# 239 "../crypto/cmp/cmp_hdr.c"
                                                      )
        goto err;
    if (!ossl_cmp_hdr_generalInfo_push0_item(hdr, itav))
        goto err;
...
int ossl_cmp_hdr_has_implicitConfirm(const OSSL_CMP_PKIHEADER *hdr)
{
    ...
    if (!__builtin_expect(!!((hdr != 
# 258 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 258 "../crypto/cmp/cmp_hdr.c"
        ) != 0), 1))
        return 0;

    itavCount = OPENSSL_sk_num(ossl_check_const_OSSL_CMP_ITAV_sk_type(hdr->generalInfo));
    for (i = 0; i < itavCount; i++) {
        itav = ((OSSL_CMP_ITAV *)OPENSSL_sk_value(ossl_check_const_OSSL_CMP_ITAV_sk_type(hdr->generalInfo), (i)));
        if (itav != 
# 264 "../crypto/cmp/cmp_hdr.c" 3 4
                   ((void *)0)
                
# 265 "../crypto/cmp/cmp_hdr.c"
               && OBJ_obj2nid(itav->infoType) == 310)
            return 1;
    }
...
# 283 "../crypto/cmp/cmp_hdr.c" 3 4
                             ((void *)0)
# 283 "../crypto/cmp/cmp_hdr.c"
                                 ) {
        char *tid;
        ...
        if (!set_random(&ctx->transactionID, ctx,
                        16))
            return 0;
        tid = i2s_ASN1_OCTET_STRING(
# 289 "../crypto/cmp/cmp_hdr.c" 3 4
                                   ((void *)0)
# 289 "../crypto/cmp/cmp_hdr.c"
                                       , ctx->transactionID);
        if (tid != 
# 290 "../crypto/cmp/cmp_hdr.c" 3 4
                  ((void *)0)
# 290 "../crypto/cmp/cmp_hdr.c"
                      )
            ossl_cmp_print_log(7, ctx, __func__, "../crypto/cmp/cmp_hdr.c", 291, "DEBUG", "Starting new transaction with ID=%s", tid)
                                                                     ;
        CRYPTO_free(tid, "../crypto/cmp/cmp_hdr.c", 293);
    }
...
int ossl_cmp_hdr_init(OSSL_CMP_CTX *ctx, OSSL_CMP_PKIHEADER *hdr)
{
    ...
    const X509_NAME *rcp = 
# 304 "../crypto/cmp/cmp_hdr.c" 3 4
                          ((void *)0)
# 304 "../crypto/cmp/cmp_hdr.c"
                              ;

    if (!__builtin_expect(!!((ctx != 
# 306 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0) 
# 306 "../crypto/cmp/cmp_hdr.c"
        && hdr != 
# 306 "../crypto/cmp/cmp_hdr.c" 3 4
        ((void *)0)
# 306 "../crypto/cmp/cmp_hdr.c"
    ...
    if (!ossl_cmp_hdr_set_pvno(hdr, 2))
        return 0;
    ...
    sender = ctx->cert != 
# 317 "../crypto/cmp/cmp_hdr.c" 3 4
                         ((void *)0) 
# 317 "../crypto/cmp/cmp_hdr.c"
                              ? X509_get_subject_name(ctx->cert) :
        ctx->oldCert != 
# 318 "../crypto/cmp/cmp_hdr.c" 3 4
                       ((void *)0) 
# 318 "../crypto/cmp/cmp_hdr.c"
                            ? X509_get_subject_name(ctx->oldCert) :
        ctx->p10CSR != 
# 319 "../crypto/cmp/cmp_hdr.c" 3 4
                      ((void *)0) 
# 319 "../crypto/cmp/cmp_hdr.c"
    ...
    if (ctx->recipient != 
# 325 "../crypto/cmp/cmp_hdr.c" 3 4
                         ((void *)0)
# 325 "../crypto/cmp/cmp_hdr.c"
                             )
        rcp = ctx->recipient;
    else if (ctx->srvCert != 
# 327 "../crypto/cmp/cmp_hdr.c" 3 4
                            ((void *)0)
# 327 "../crypto/cmp/cmp_hdr.c"
                                )
        rcp = X509_get_subject_name(ctx->srvCert);
    else if (ctx->issuer != 
# 329 "../crypto/cmp/cmp_hdr.c" 3 4
                           ((void *)0)
# 329 "../crypto/cmp/cmp_hdr.c"
                               )
        rcp = ctx->issuer;
    else if (ctx->oldCert != 
# 331 "../crypto/cmp/cmp_hdr.c" 3 4
                            ((void *)0)
# 331 "../crypto/cmp/cmp_hdr.c"
                                )
        rcp = X509_get_issuer_name(ctx->oldCert);
    else if (ctx->cert != 
# 333 "../crypto/cmp/cmp_hdr.c" 3 4
                         ((void *)0)
# 333 "../crypto/cmp/cmp_hdr.c"
                             )
    ...
    if (ctx->recipNonce != 
# 342 "../crypto/cmp/cmp_hdr.c" 3 4
                          ((void *)0)
            
# 343 "../crypto/cmp/cmp_hdr.c"
    ...
    if (!ossl_cmp_hdr_set_transactionID(ctx, hdr))
        return 0;
# 362 "../crypto/cmp/cmp_hdr.c"
    if (!set_random(&hdr->senderNonce, ctx, 16))
        return 0;
    ...
    if (ctx->freeText != 
# 374 "../crypto/cmp/cmp_hdr.c" 3 4
                        ((void *)0)
            
# 375 "../crypto/cmp/cmp_hdr.c"
