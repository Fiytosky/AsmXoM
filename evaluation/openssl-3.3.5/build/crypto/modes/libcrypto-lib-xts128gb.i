# 0 "../crypto/modes/xts128gb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/modes/xts128gb.c"
# 10 "../crypto/modes/xts128gb.c"
                                 ...
                                 size_t len, int enc)
{
    ...
    while (len >= 16) {
        ...
        if ((ossl_is_little_endian)) {
            ...
            hi = ({ u64 ret_=(tweak.u[0]); asm ("bswapq %0" : "+r"(ret_)); ret_; });
            lo = ({ u64 ret_=(tweak.u[1]); asm ("bswapq %0" : "+r"(ret_)); ret_; });
    ...
    if (enc) {
        ...
        if ((ossl_is_little_endian)) {
            ...
            hi = ({ u64 ret_=(tweak1.u[0]); asm ("bswapq %0" : "+r"(ret_)); ret_; });
            lo = ({ u64 ret_=(tweak1.u[1]); asm ("bswapq %0" : "+r"(ret_)); ret_; });
