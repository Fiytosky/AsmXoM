# 0 "../crypto/modes/wrap128.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/modes/wrap128.c"
# 16 "../crypto/modes/wrap128.c"
                       ...
                       block128_f block)
{
    ...
    size_t i, j, t;
    if ((inlen & 0x7) || (inlen < 16) || (inlen > (1UL << 31)))
        return 0;
    A = B;
    t = 1;
                             ...
                             block128_f block)
{
    ...
    if ((inlen & 0x7) != 0 || inlen < 16 || inlen >= (1UL << 31))
        return 0;
