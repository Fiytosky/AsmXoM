# 0 "../crypto/modes/ctr128.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/modes/ctr128.c"
# 10 "../crypto/modes/ctr128.c"
...
# 14 "../crypto/modes/ctr128.c" 2


typedef size_t size_t_aX __attribute((__aligned__(1)));
# 27 "../crypto/modes/ctr128.c"
...
static void ctr128_inc_aligned(unsigned char *counter)
{
    ...
    if ((ossl_is_little_endian) || ((size_t)counter % sizeof(size_t)) != 0) {
        ctr128_inc(counter);
        return;
    }
                                 ...
                                 unsigned int *num, ctr128_f func)
{
   ...
   n = *num;
    ...
    ctr32 = ({ u32 ret_=(*(const u32 *)(ivec + 12)); asm ("bswapl %0" : "+r"(ret_)); ret_; });
    while (len >= 16) {
        ...
        *(u32 *)(ivec + 12) = ({ u32 ret_=(ctr32); asm ("bswapl %0" : "+r"(ret_)); ret_; });
