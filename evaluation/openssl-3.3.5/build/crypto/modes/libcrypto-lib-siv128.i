# 0 "../crypto/modes/siv128.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/modes/siv128.c"
# 10 "../crypto/modes/siv128.c"
 ...
 static inline uint32_t rotl8(uint32_t x)
{
 ...
 static inline uint32_t rotr8(uint32_t x)
{
    return (x >> 8) | (x << 24);
}

 static inline uint64_t byteswap8(uint64_t x)
{
 ...
 static inline uint64_t siv128_getword(SIV_BLOCK const *b, size_t i)
{
...
static inline void siv128_dbl(SIV_BLOCK *b)
{
 ...
 static inline int siv128_do_s2v_p(SIV128_CONTEXT *ctx, SIV_BLOCK *out,
                                              unsigned char const* in, size_t len)
{
    ...
    if (mac_ctx == 
# 98 "../crypto/modes/siv128.c" 3 4
                  ((void *)0)
# 98 "../crypto/modes/siv128.c"
                      )
        return 0;

    if (len >= 16) {
        if (!EVP_MAC_update(mac_ctx, in, len - 16))
            goto err;
        memcpy(&t, in + (len-16), 16);
        siv128_xorblock(&t, &ctx->d);
        if (!EVP_MAC_update(mac_ctx, t.byte, 16))
            goto err;
    } else {
        memset(&t, 0, sizeof(t));
        memcpy(&t, in, len);
...
err:
 ...
 static inline int siv128_do_encrypt(EVP_CIPHER_CTX *ctx, unsigned char *out,
                                             unsigned char const *in, size_t len,
                                             SIV_BLOCK *icv)
{
    int out_len = (int)len;
...
# 135 "../crypto/modes/siv128.c" 3 4
                               ((void *)0)
# 135 "../crypto/modes/siv128.c"
                                   , 
# 135 "../crypto/modes/siv128.c" 3 4
                                     ((void *)0)
# 135 "../crypto/modes/siv128.c"
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if ((ctx = CRYPTO_malloc(sizeof(*ctx), "../crypto/modes/siv128.c", 150)) != 
# 150 "../crypto/modes/siv128.c" 3 4
                                               ((void *)0)
# 150 "../crypto/modes/siv128.c"
                                                   ) {
        ret = ossl_siv128_init(ctx, key, klen, cbc, ctr, libctx, propq);
        if (ret)
            return ctx;
        CRYPTO_free(ctx, "../crypto/modes/siv128.c", 154);
    }

    return 
# 157 "../crypto/modes/siv128.c" 3 4
          ((void *)0)
# 157 "../crypto/modes/siv128.c"
              ;
}
                       ...
                       OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    size_t out_len = 16;
    EVP_MAC_CTX *mac_ctx = 
# 169 "../crypto/modes/siv128.c" 3 4
                          ((void *)0)
# 169 "../crypto/modes/siv128.c"
                              ;
    OSSL_PARAM params[3];
    const char *cbc_name;

    if (ctx == 
# 173 "../crypto/modes/siv128.c" 3 4
              ((void *)0)
# 173 "../crypto/modes/siv128.c"
                  )
        return 0;
    ...
    ctx->mac = 
# 180 "../crypto/modes/siv128.c" 3 4
              ((void *)0)
# 180 "../crypto/modes/siv128.c"
                  ;
    ctx->cipher_ctx = 
# 181 "../crypto/modes/siv128.c" 3 4
                     ((void *)0)
# 181 "../crypto/modes/siv128.c"
                         ;
    ctx->mac_ctx_init = 
# 182 "../crypto/modes/siv128.c" 3 4
                       ((void *)0)
# 182 "../crypto/modes/siv128.c"
                           ;

    if (key == 
# 184 "../crypto/modes/siv128.c" 3 4
              ((void *)0) 
# 184 "../crypto/modes/siv128.c"
                   || cbc == 
# 184 "../crypto/modes/siv128.c" 3 4
                             ((void *)0) 
# 184 "../crypto/modes/siv128.c"
...
# 194 "../crypto/modes/siv128.c" 3 4
                                                   ((void *)0)
            
# 195 "../crypto/modes/siv128.c"
           || (ctx->mac =
                EVP_MAC_fetch(libctx, "CMAC", propq)) == 
# 196 "../crypto/modes/siv128.c" 3 4
                                                                    ((void *)0)
            
# 197 "../crypto/modes/siv128.c"
           || (ctx->mac_ctx_init = EVP_MAC_CTX_new(ctx->mac)) == 
# 197 "../crypto/modes/siv128.c" 3 4
                                                                 ((void *)0)
            
# 198 "../crypto/modes/siv128.c"
           || !EVP_MAC_CTX_set_params(ctx->mac_ctx_init, params)
            || !EVP_EncryptInit_ex(ctx->cipher_ctx, ctr, 
# 199 "../crypto/modes/siv128.c" 3 4
                                                        ((void *)0)
# 199 "../crypto/modes/siv128.c"
                                                            , key + klen, 
# 199 "../crypto/modes/siv128.c" 3 4
                                                                          ((void *)0)
# 199 "../crypto/modes/siv128.c"
            ...
            || (mac_ctx = EVP_MAC_CTX_dup(ctx->mac_ctx_init)) == 
# 200 "../crypto/modes/siv128.c" 3 4
                                                                ((void *)0)
            
# 201 "../crypto/modes/siv128.c"
           || !EVP_MAC_update(mac_ctx, zero, sizeof(zero))
            || !EVP_MAC_final(mac_ctx, ctx->d.byte, &out_len,
                              sizeof(ctx->d.byte))) {
        EVP_CIPHER_CTX_free(ctx->cipher_ctx);
        ctx->cipher_ctx = 
# 205 "../crypto/modes/siv128.c" 3 4
                         ((void *)0)
# 205 "../crypto/modes/siv128.c"
                             ;
        EVP_MAC_CTX_free(ctx->mac_ctx_init);
        ctx->mac_ctx_init = 
# 207 "../crypto/modes/siv128.c" 3 4
                           ((void *)0)
# 207 "../crypto/modes/siv128.c"
                               ;
        EVP_MAC_CTX_free(mac_ctx);
        EVP_MAC_free(ctx->mac);
        ctx->mac = 
# 210 "../crypto/modes/siv128.c" 3 4
                  ((void *)0)
# 210 "../crypto/modes/siv128.c"
                      ;
        return 0;
    }
    EVP_MAC_CTX_free(mac_ctx);
...
int ossl_siv128_copy_ctx(SIV128_CONTEXT *dest, SIV128_CONTEXT *src)
{
    ...
    if (dest->cipher_ctx == 
# 227 "../crypto/modes/siv128.c" 3 4
                           ((void *)0)
# 227 "../crypto/modes/siv128.c"
                               ) {
        dest->cipher_ctx = EVP_CIPHER_CTX_new();
        if (dest->cipher_ctx == 
# 229 "../crypto/modes/siv128.c" 3 4
                               ((void *)0)
# 229 "../crypto/modes/siv128.c"
                                   )
            return 0;
    }
    ...
    if (dest->mac_ctx_init == 
# 236 "../crypto/modes/siv128.c" 3 4
                             ((void *)0)
# 236 "../crypto/modes/siv128.c"
                                 )
        return 0;
    dest->mac = src->mac;
    if (dest->mac != 
# 239 "../crypto/modes/siv128.c" 3 4
                    ((void *)0)
# 239 "../crypto/modes/siv128.c"
                        )
                      ...
                      size_t len)
{
    ...
    if ((mac_ctx = EVP_MAC_CTX_dup(ctx->mac_ctx_init)) == 
# 258 "../crypto/modes/siv128.c" 3 4
                                                         ((void *)0)
        
# 259 "../crypto/modes/siv128.c"
...
{
    if (ctx != 
# 375 "../crypto/modes/siv128.c" 3 4
              ((void *)0)
# 375 "../crypto/modes/siv128.c"
                  ) {
        EVP_CIPHER_CTX_free(ctx->cipher_ctx);
        ctx->cipher_ctx = 
# 377 "../crypto/modes/siv128.c" 3 4
                         ((void *)0)
# 377 "../crypto/modes/siv128.c"
                             ;
        EVP_MAC_CTX_free(ctx->mac_ctx_init);
        ctx->mac_ctx_init = 
# 379 "../crypto/modes/siv128.c" 3 4
                           ((void *)0)
# 379 "../crypto/modes/siv128.c"
                               ;
        EVP_MAC_free(ctx->mac);
        ctx->mac = 
# 381 "../crypto/modes/siv128.c" 3 4
                  ((void *)0)
# 381 "../crypto/modes/siv128.c"
                      ;
