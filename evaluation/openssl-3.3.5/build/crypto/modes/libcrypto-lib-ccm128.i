# 0 "../crypto/modes/ccm128.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/modes/ccm128.c"
# 10 "../crypto/modes/ccm128.c"
...
# 13 "../crypto/modes/ccm128.c" 2



typedef u64 u64_a1 __attribute((__aligned__(1)));
# 26 "../crypto/modes/ccm128.c"
void CRYPTO_ccm128_init(CCM128_CONTEXT *ctx,
                        unsigned int M, unsigned int L, void *key,
                        block128_f block)
{
                          ...
                          size_t len)
{
    ...
    if (ctx->blocks > (1ULL << 61))
        return -2;

    while (len >= 16) {
# 181 "../crypto/modes/ccm128.c"
