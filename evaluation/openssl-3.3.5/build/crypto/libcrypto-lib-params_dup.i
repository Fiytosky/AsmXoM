# 0 "../crypto/params_dup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/params_dup.c"
# 10 "../crypto/params_dup.c"
...
# 14 "../crypto/params_dup.c" 2
# 22 "../crypto/params_dup.c"
typedef struct {
    OSSL_PARAM_ALIGNED_BLOCK *alloc;
    OSSL_PARAM_ALIGNED_BLOCK *cur;
    size_t blocks;
    size_t alloc_sz;
} OSSL_PARAM_BUF;
...
size_t ossl_param_bytes_to_blocks(size_t bytes)
{
    return (bytes + sizeof(OSSL_PARAM_ALIGNED_BLOCK) - 1) / sizeof(OSSL_PARAM_ALIGNED_BLOCK);
}

static int ossl_param_buf_alloc(OSSL_PARAM_BUF *out, size_t extra_blocks,
                                int is_secure)
{
    size_t sz = sizeof(OSSL_PARAM_ALIGNED_BLOCK) * (extra_blocks + out->blocks);

    out->alloc = is_secure ? CRYPTO_secure_zalloc(sz, "../crypto/params_dup.c", 39) : CRYPTO_zalloc(sz, "../crypto/params_dup.c", 39);
    if (out->alloc == 
# 40 "../crypto/params_dup.c" 3 4
                     ((void *)0)
# 40 "../crypto/params_dup.c"
                         )
        return 0;
    out->alloc_sz = sz;
...
{
    last->key = 
# 50 "../crypto/params_dup.c" 3 4
               ((void *)0)
# 50 "../crypto/params_dup.c"
                   ;
...
static OSSL_PARAM *ossl_param_dup(const OSSL_PARAM *src, OSSL_PARAM *dst,
                                  OSSL_PARAM_BUF buf[(1 + 1)],
                                  int *param_count)
{
    const OSSL_PARAM *in;
    int has_dst = (dst != 
# 61 "../crypto/params_dup.c" 3 4
                         ((void *)0)
# 61 "../crypto/params_dup.c"
                             );
    int is_secure;
    size_t param_sz, blks;

    for (in = src; in->key != 
# 65 "../crypto/params_dup.c" 3 4
                             ((void *)0)
# 65 "../crypto/params_dup.c"
                                 ; in++) {
        ...
        if (param_count != 
# 92 "../crypto/params_dup.c" 3 4
                          ((void *)0)
# 92 "../crypto/params_dup.c"
                              )
            ++*param_count;
    }
    return dst;
...
OSSL_PARAM *OSSL_PARAM_dup(const OSSL_PARAM *src)
{
    ...
    if (src == 
# 105 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 105 "../crypto/params_dup.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/params_dup.c",106,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 106 "../crypto/params_dup.c" 3 4
       ((void *)0)
# 106 "../crypto/params_dup.c"
       );
        return 
# 107 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 107 "../crypto/params_dup.c"
                  ;
    }
    ...
    (void)ossl_param_dup(src, 
# 113 "../crypto/params_dup.c" 3 4
                             ((void *)0)
# 113 "../crypto/params_dup.c"
                                 , buf, &param_count);
    ...
    if (!ossl_param_buf_alloc(&buf[0], param_blocks, 0))
        return 
# 121 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 121 "../crypto/params_dup.c"
                  ;


    if (buf[1].blocks > 0
        && !ossl_param_buf_alloc(&buf[1], 0, 1)) {
        CRYPTO_free(buf[0].alloc, "../crypto/params_dup.c", 126);
        return 
# 127 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 127 "../crypto/params_dup.c"
                  ;
    }

    dst = (OSSL_PARAM *)buf[0].alloc;
    last = ossl_param_dup(src, dst, buf, 
# 131 "../crypto/params_dup.c" 3 4
                                        ((void *)0)
# 131 "../crypto/params_dup.c"
                                            );

    ossl_param_set_secure_block(last, buf[1].alloc,
                                buf[1].alloc_sz);
    return dst;
}
...
OSSL_PARAM *OSSL_PARAM_merge(const OSSL_PARAM *p1, const OSSL_PARAM *p2)
{
    const OSSL_PARAM *list1[128 + 1];
    const OSSL_PARAM *list2[128 + 1];
    const OSSL_PARAM *p = 
# 150 "../crypto/params_dup.c" 3 4
                         ((void *)0)
# 150 "../crypto/params_dup.c"
                             ;
    ...
    if (p1 == 
# 156 "../crypto/params_dup.c" 3 4
             ((void *)0) 
# 156 "../crypto/params_dup.c"
                  && p2 == 
# 156 "../crypto/params_dup.c" 3 4
                           ((void *)0)
# 156 "../crypto/params_dup.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/params_dup.c",157,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 157 "../crypto/params_dup.c" 3 4
       ((void *)0)
# 157 "../crypto/params_dup.c"
       );
        return 
# 158 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 158 "../crypto/params_dup.c"
                  ;
    }


    if (p1 != 
# 162 "../crypto/params_dup.c" 3 4
             ((void *)0)
# 162 "../crypto/params_dup.c"
                 ) {
        for (p = p1; p->key != 
# 163 "../crypto/params_dup.c" 3 4
                              ((void *)0) 
# 163 "../crypto/params_dup.c"
                                   && list1_sz < 128; p++)
            list1[list1_sz++] = p;
    }
    list1[list1_sz] = 
# 166 "../crypto/params_dup.c" 3 4
                     ((void *)0)
# 166 "../crypto/params_dup.c"
                         ;


    if (p2 != 
# 169 "../crypto/params_dup.c" 3 4
             ((void *)0)
# 169 "../crypto/params_dup.c"
                 ) {
        for (p = p2; p->key != 
# 170 "../crypto/params_dup.c" 3 4
                              ((void *)0) 
# 170 "../crypto/params_dup.c"
                                   && list2_sz < 128; p++)
            list2[list2_sz++] = p;
    }
    list2[list2_sz] = 
# 173 "../crypto/params_dup.c" 3 4
                     ((void *)0)
# 173 "../crypto/params_dup.c"
                         ;
    if (list1_sz == 0 && list2_sz == 0) {
        (ERR_new(), ERR_set_debug("../crypto/params_dup.c",175,__func__), ERR_set_error)((15),(131),
# 175 "../crypto/params_dup.c" 3 4
       ((void *)0)
# 175 "../crypto/params_dup.c"
       );
        return 
# 176 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 176 "../crypto/params_dup.c"
                  ;
    }
    ...
    params = CRYPTO_zalloc((list1_sz + list2_sz + 1) * sizeof(*p1), "../crypto/params_dup.c", 184);
    if (params == 
# 185 "../crypto/params_dup.c" 3 4
                 ((void *)0)
# 185 "../crypto/params_dup.c"
                     )
        return 
# 186 "../crypto/params_dup.c" 3 4
              ((void *)0)
# 186 "../crypto/params_dup.c"
                  ;
    dst = params;
    p1cur = list1;
    p2cur = list2;
    while (1) {
        ...
        if (*p1cur == 
# 192 "../crypto/params_dup.c" 3 4
                     ((void *)0)
# 192 "../crypto/params_dup.c"
                         ) {
            while (*p2cur != 
# 193 "../crypto/params_dup.c" 3 4
                            ((void *)0)
# 193 "../crypto/params_dup.c"
                                ) {
                *dst++ = **p2cur;
                p2cur++;
            }
        ...
        if (*p2cur == 
# 200 "../crypto/params_dup.c" 3 4
                     ((void *)0)
# 200 "../crypto/params_dup.c"
                         ) {
            while (*p1cur != 
# 201 "../crypto/params_dup.c" 3 4
                            ((void *)0)
# 201 "../crypto/params_dup.c"
                                ) {
                *dst++ = **p1cur;
                p1cur++;
            }
...
{
    if (params != 
# 227 "../crypto/params_dup.c" 3 4
                 ((void *)0)
# 227 "../crypto/params_dup.c"
                     ) {
        OSSL_PARAM *p;

        for (p = params; p->key != 
# 230 "../crypto/params_dup.c" 3 4
                                  ((void *)0)
# 230 "../crypto/params_dup.c"
                                      ; p++)
            ;
        if (p->data_type == 127)
            CRYPTO_secure_clear_free(p->data, p->data_size, "../crypto/params_dup.c", 233);
        CRYPTO_free(params, "../crypto/params_dup.c", 234);
    }
}
