# 0 "../crypto/buffer/buf_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/buffer/buf_err.c"
# 11 "../crypto/buffer/buf_err.c"
...
# 14 "../crypto/buffer/buf_err.c" 2



static const ERR_STRING_DATA BUF_str_reasons[] = {
    {0, 
# 18 "../crypto/buffer/buf_err.c" 3 4
       ((void *)0)
# 18 "../crypto/buffer/buf_err.c"
           }
};
...
int ossl_err_load_BUF_strings(void)
{
    ...
    if (ERR_reason_error_string(BUF_str_reasons[0].error) == 
# 26 "../crypto/buffer/buf_err.c" 3 4
                                                            ((void *)0)
# 26 "../crypto/buffer/buf_err.c"
                                                                )
