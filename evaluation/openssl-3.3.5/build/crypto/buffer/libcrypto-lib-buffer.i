# 0 "../crypto/buffer/buffer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/buffer/buffer.c"
# 10 "../crypto/buffer/buffer.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/buffer/buffer.c" 2
# 21 "../crypto/buffer/buffer.c"
BUF_MEM *BUF_MEM_new_ex(unsigned long flags)
{
    BUF_MEM *ret;
    ...
    ret = BUF_MEM_new();
    if (ret != 
# 26 "../crypto/buffer/buffer.c" 3 4
              ((void *)0)
# 26 "../crypto/buffer/buffer.c"
                  )
        ret->flags = flags;
    return ret;
}
...
BUF_MEM *BUF_MEM_new(void)
{
    ...
    ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/buffer/buffer.c", 35);
    if (ret == 
# 36 "../crypto/buffer/buffer.c" 3 4
              ((void *)0)
# 36 "../crypto/buffer/buffer.c"
                  )
        return 
# 37 "../crypto/buffer/buffer.c" 3 4
              ((void *)0)
# 37 "../crypto/buffer/buffer.c"
                  ;
    return ret;
}
...
{
    if (a == 
# 43 "../crypto/buffer/buffer.c" 3 4
            ((void *)0)
# 43 "../crypto/buffer/buffer.c"
                )
        return;
    if (a->data != 
# 45 "../crypto/buffer/buffer.c" 3 4
                  ((void *)0)
# 45 "../crypto/buffer/buffer.c"
                      ) {
        if (a->flags & 0x01)
            CRYPTO_secure_clear_free(a->data, a->max, "../crypto/buffer/buffer.c", 47);
        else
            CRYPTO_clear_free(a->data, a->max, "../crypto/buffer/buffer.c", 49);
    }
    CRYPTO_free(a, "../crypto/buffer/buffer.c", 51);
}
...
static char *sec_alloc_realloc(BUF_MEM *str, size_t len)
{
    ...
    ret = CRYPTO_secure_malloc(len, "../crypto/buffer/buffer.c", 60);
    if (str->data != 
# 61 "../crypto/buffer/buffer.c" 3 4
                    ((void *)0)
# 61 "../crypto/buffer/buffer.c"
                        ) {
        if (ret != 
# 62 "../crypto/buffer/buffer.c" 3 4
                  ((void *)0)
# 62 "../crypto/buffer/buffer.c"
                      ) {
            memcpy(ret, str->data, str->length);
            CRYPTO_secure_clear_free(str->data, str->length, "../crypto/buffer/buffer.c", 64);
            str->data = 
# 65 "../crypto/buffer/buffer.c" 3 4
                       ((void *)0)
# 65 "../crypto/buffer/buffer.c"
                           ;
        }
    }
    return ret;
...
size_t BUF_MEM_grow(BUF_MEM *str, size_t len)
{
    ...
    if (str->max >= len) {
        if (str->data != 
# 81 "../crypto/buffer/buffer.c" 3 4
                        ((void *)0)
# 81 "../crypto/buffer/buffer.c"
                            )
    ...
    if (len > 0x5ffffffc) {
        (ERR_new(), ERR_set_debug("../crypto/buffer/buffer.c",88,__func__), ERR_set_error)((7),((262|(0x2 << 18L))),
# 88 "../crypto/buffer/buffer.c" 3 4
       ((void *)0)
# 88 "../crypto/buffer/buffer.c"
       );
        return 0;
    }
    n = (len + 3) / 3 * 4;
    if ((str->flags & 0x01))
        ...
        ret = CRYPTO_realloc(str->data, n, "../crypto/buffer/buffer.c", 95);
    if (ret == 
# 96 "../crypto/buffer/buffer.c" 3 4
              ((void *)0)
# 96 "../crypto/buffer/buffer.c"
                  ) {
        len = 0;
    } else {
        str->data = ret;
...
size_t BUF_MEM_grow_clean(BUF_MEM *str, size_t len)
{
    ...
    if (str->length >= len) {
        if (str->data != 
# 113 "../crypto/buffer/buffer.c" 3 4
                        ((void *)0)
# 113 "../crypto/buffer/buffer.c"
    ...
    if (len > 0x5ffffffc) {
        (ERR_new(), ERR_set_debug("../crypto/buffer/buffer.c",125,__func__), ERR_set_error)((7),((262|(0x2 << 18L))),
# 125 "../crypto/buffer/buffer.c" 3 4
       ((void *)0)
# 125 "../crypto/buffer/buffer.c"
       );
        return 0;
    }
    n = (len + 3) / 3 * 4;
    if ((str->flags & 0x01))
        ...
        ret = CRYPTO_clear_realloc(str->data, str->max, n, "../crypto/buffer/buffer.c", 132);
    if (ret == 
# 133 "../crypto/buffer/buffer.c" 3 4
              ((void *)0)
# 133 "../crypto/buffer/buffer.c"
                  ) {
        len = 0;
    } else {
        str->data = ret;
