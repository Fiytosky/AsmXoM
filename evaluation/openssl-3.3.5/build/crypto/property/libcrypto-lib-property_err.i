# 0 "../crypto/property/property_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/property/property_err.c"
# 11 "../crypto/property/property_err.c"
...
# 12 "../crypto/property/property_err.c" 2
...
# 13 "../crypto/property/property_err.c" 2



static const ERR_STRING_DATA PROP_str_reasons[] = {
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "name too long"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "not an ascii character"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "not an hexadecimal digit"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "not an identifier"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "not an octal digit"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "not a decimal digit"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "no matching string delimiter"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "no value"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "parse failed"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "string too long"},
    {( (((unsigned long)(55) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "trailing characters"},
    {0, 
# 34 "../crypto/property/property_err.c" 3 4
       ((void *)0)
# 34 "../crypto/property/property_err.c"
           }
};
...
int ossl_err_load_PROP_strings(void)
{
    ...
    if (ERR_reason_error_string(PROP_str_reasons[0].error) == 
# 42 "../crypto/property/property_err.c" 3 4
                                                             ((void *)0)
# 42 "../crypto/property/property_err.c"
                                                                 )
