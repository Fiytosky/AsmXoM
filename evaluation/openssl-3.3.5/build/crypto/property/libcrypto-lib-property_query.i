# 0 "../crypto/property/property_query.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/property/property_query.c"
# 10 "../crypto/property/property_query.c"
...
# 16 "../include/internal/propertyerr.h" 2
...
# 17 "../include/internal/propertyerr.h" 2
...
# 11 "../crypto/property/property_query.c" 2
...
# 12 "../crypto/property/property_query.c" 2
...
# 13 "../crypto/property/property_query.c" 2
                            ...
                            OSSL_LIB_CTX *libctx, const char *name)
{
    ...
    if (list == 
# 29 "../crypto/property/property_query.c" 3 4
               ((void *)0) 
# 29 "../crypto/property/property_query.c"
                    || name == 
# 29 "../crypto/property/property_query.c" 3 4
                               ((void *)0)
        
# 30 "../crypto/property/property_query.c"
       || (name_idx = ossl_property_name(libctx, name, 0)) == 0)
        return 
# 31 "../crypto/property/property_query.c" 3 4
              ((void *)0)
# 31 "../crypto/property/property_query.c"
                  ;
...
{
    const char *value = 
# 45 "../crypto/property/property_query.c" 3 4
                       ((void *)0)
# 45 "../crypto/property/property_query.c"
                           ;

    if (prop != 
# 47 "../crypto/property/property_query.c" 3 4
               ((void *)0) 
# 47 "../crypto/property/property_query.c"
...
int64_t ossl_property_get_number_value(const OSSL_PROPERTY_DEFINITION *prop)
{
    ...
    if (prop != 
# 56 "../crypto/property/property_query.c" 3 4
               ((void *)0) 
# 56 "../crypto/property/property_query.c"
                    && prop->type == OSSL_PROPERTY_TYPE_NUMBER)
                             ...
                             const OSSL_PROPERTY_LIST *prop_list)
{
    ...
    if (prop == 
# 74 "../crypto/property/property_query.c" 3 4
               ((void *)0) 
# 74 "../crypto/property/property_query.c"
                    || prop->optional || prop->oper == OSSL_PROPERTY_OVERRIDE)
        return 0;
