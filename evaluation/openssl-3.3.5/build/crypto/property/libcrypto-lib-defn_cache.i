# 0 "../crypto/property/defn_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
struct lhash_st_PROPERTY_DEFN_ELEM { union lh_PROPERTY_DEFN_ELEM_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_PROPERTY_DEFN_ELEM_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const PROPERTY_DEFN_ELEM *) = (unsigned long (*)(const PROPERTY_DEFN_ELEM *))hfn; return hfn_conv((const PROPERTY_DEFN_ELEM *)data); } static int lh_PROPERTY_DEFN_ELEM_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const PROPERTY_DEFN_ELEM *, const PROPERTY_DEFN_ELEM *) = (int (*)(const PROPERTY_DEFN_ELEM *, const PROPERTY_DEFN_ELEM *))cfn; return cfn_conv((const PROPERTY_DEFN_ELEM *)da, (const PROPERTY_DEFN_ELEM *)db); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_free(struct lhash_st_PROPERTY_DEFN_ELEM *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_flush(struct lhash_st_PROPERTY_DEFN_ELEM *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline PROPERTY_DEFN_ELEM * lh_PROPERTY_DEFN_ELEM_insert(struct lhash_st_PROPERTY_DEFN_ELEM *lh, PROPERTY_DEFN_ELEM *d) { return (PROPERTY_DEFN_ELEM *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline PROPERTY_DEFN_ELEM * lh_PROPERTY_DEFN_ELEM_delete(struct lhash_st_PROPERTY_DEFN_ELEM *lh, const PROPERTY_DEFN_ELEM *d) { return (PROPERTY_DEFN_ELEM *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline PROPERTY_DEFN_ELEM * lh_PROPERTY_DEFN_ELEM_retrieve(struct lhash_st_PROPERTY_DEFN_ELEM *lh, const PROPERTY_DEFN_ELEM *d) { return (PROPERTY_DEFN_ELEM *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_PROPERTY_DEFN_ELEM_error(struct lhash_st_PROPERTY_DEFN_ELEM *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_PROPERTY_DEFN_ELEM_num_items(struct lhash_st_PROPERTY_DEFN_ELEM *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_PROPERTY_DEFN_ELEM_get_down_load(struct lhash_st_PROPERTY_DEFN_ELEM *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_set_down_load(struct lhash_st_PROPERTY_DEFN_ELEM *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(PROPERTY_DEFN_ELEM *) = (void (*)(PROPERTY_DEFN_ELEM *))doall; doall_conv((PROPERTY_DEFN_ELEM *)node); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(PROPERTY_DEFN_ELEM *, void *) = (void (*)(PROPERTY_DEFN_ELEM *, void *))doall; doall_conv((PROPERTY_DEFN_ELEM *)node, arg); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_doall(struct lhash_st_PROPERTY_DEFN_ELEM *lh, void (*doall)(PROPERTY_DEFN_ELEM *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_PROPERTY_DEFN_ELEM * lh_PROPERTY_DEFN_ELEM_new(unsigned long (*hfn)(const PROPERTY_DEFN_ELEM *), int (*cfn)(const PROPERTY_DEFN_ELEM *, const PROPERTY_DEFN_ELEM *)) { return (struct lhash_st_PROPERTY_DEFN_ELEM *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_PROPERTY_DEFN_ELEM_hfn_thunk, lh_PROPERTY_DEFN_ELEM_cfn_thunk, lh_PROPERTY_DEFN_ELEM_doall_thunk, lh_PROPERTY_DEFN_ELEM_doall_arg_thunk); } static __attribute__((unused)) inline void lh_PROPERTY_DEFN_ELEM_doall_arg(struct lhash_st_PROPERTY_DEFN_ELEM *lh, void (*doallarg)(PROPERTY_DEFN_ELEM *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_PROPERTY_DEFN_ELEM;
...
void ossl_property_defns_free(void *vproperty_defns)
{
    ...
    if (property_defns != 
# 55 "../crypto/property/defn_cache.c" 3 4
                         ((void *)0)
# 55 "../crypto/property/defn_cache.c"
                             ) {
...
OSSL_PROPERTY_LIST *ossl_prop_defn_get(OSSL_LIB_CTX *ctx, const char *prop)
{
    ...
    struct lhash_st_PROPERTY_DEFN_ELEM *property_defns;

    property_defns = ossl_lib_ctx_get_data(ctx,
                                           2);
    if (!__builtin_expect(!!((property_defns != 
# 73 "../crypto/property/defn_cache.c" 3 4
        ((void *)0)
# 73 "../crypto/property/defn_cache.c"
        ) != 0), 1) || !ossl_lib_ctx_read_lock(ctx))
        return 
# 74 "../crypto/property/defn_cache.c" 3 4
              ((void *)0)
# 74 "../crypto/property/defn_cache.c"
                  ;
    ...
    if (r == 
# 79 "../crypto/property/defn_cache.c" 3 4
            ((void *)0) 
# 79 "../crypto/property/defn_cache.c"
                 || !__builtin_expect(!!((r->defn != 
# 79 "../crypto/property/defn_cache.c" 3 4
                     ((void *)0)
# 79 "../crypto/property/defn_cache.c"
                     ) != 0), 1))
        return 
# 80 "../crypto/property/defn_cache.c" 3 4
              ((void *)0)
# 80 "../crypto/property/defn_cache.c"
                  ;
    return r->defn;
}
...
int ossl_prop_defn_set(OSSL_LIB_CTX *ctx, const char *prop,
                       OSSL_PROPERTY_LIST **pl)
{
    PROPERTY_DEFN_ELEM elem, *old, *p = 
# 92 "../crypto/property/defn_cache.c" 3 4
                                       ((void *)0)
# 92 "../crypto/property/defn_cache.c"
                                           ;
    size_t len;
    struct lhash_st_PROPERTY_DEFN_ELEM *property_defns;
    int res = 1;
    ...
    property_defns = ossl_lib_ctx_get_data(ctx,
                                           2);
    if (property_defns == 
# 99 "../crypto/property/defn_cache.c" 3 4
                         ((void *)0)
# 99 "../crypto/property/defn_cache.c"
                             )
        return 0;

    if (prop == 
# 102 "../crypto/property/defn_cache.c" 3 4
               ((void *)0)
# 102 "../crypto/property/defn_cache.c"
                   )
        return 1;
    ...
    elem.prop = prop;
    if (pl == 
# 108 "../crypto/property/defn_cache.c" 3 4
             ((void *)0)
# 108 "../crypto/property/defn_cache.c"
                 ) {
...
# 113 "../crypto/property/defn_cache.c" 3 4
                                                                      ((void *)0)
# 113 "../crypto/property/defn_cache.c"
                                                                          ) {
    ...
    len = strlen(prop);
    p = CRYPTO_malloc(sizeof(*p) + len, "../crypto/property/defn_cache.c", 119);
    if (p != 
# 120 "../crypto/property/defn_cache.c" 3 4
            ((void *)0)
# 120 "../crypto/property/defn_cache.c"
                ) {
        p->prop = p->body;
        p->defn = *pl;
        memcpy(p->body, prop, len + 1);
        old = lh_PROPERTY_DEFN_ELEM_insert(property_defns, p);
        if (!__builtin_expect(!!((old == 
# 125 "../crypto/property/defn_cache.c" 3 4
            ((void *)0)
# 125 "../crypto/property/defn_cache.c"
            ) != 0), 1))
    ...
    CRYPTO_free(p, "../crypto/property/defn_cache.c", 131);
    res = 0;
 end:
    ossl_lib_ctx_unlock(ctx);
    return res;
