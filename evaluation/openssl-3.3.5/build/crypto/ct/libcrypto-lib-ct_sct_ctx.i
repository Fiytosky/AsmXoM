# 0 "../crypto/ct/ct_sct_ctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_sct_ctx.c"
# 14 "../crypto/ct/ct_sct_ctx.c"
...
SCT_CTX *SCT_CTX_new(OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (sctx == 
# 27 "../crypto/ct/ct_sct_ctx.c" 3 4
               ((void *)0)
# 27 "../crypto/ct/ct_sct_ctx.c"
                   )
        return 
# 28 "../crypto/ct/ct_sct_ctx.c" 3 4
              ((void *)0)
# 28 "../crypto/ct/ct_sct_ctx.c"
                  ;

    sctx->libctx = libctx;
    if (propq != 
# 31 "../crypto/ct/ct_sct_ctx.c" 3 4
                ((void *)0)
# 31 "../crypto/ct/ct_sct_ctx.c"
                    ) {
        sctx->propq = CRYPTO_strdup(propq, "../crypto/ct/ct_sct_ctx.c", 32);
        if (sctx->propq == 
# 33 "../crypto/ct/ct_sct_ctx.c" 3 4
                          ((void *)0)
# 33 "../crypto/ct/ct_sct_ctx.c"
                              ) {
            CRYPTO_free(sctx, "../crypto/ct/ct_sct_ctx.c", 34);
            return 
# 35 "../crypto/ct/ct_sct_ctx.c" 3 4
                  ((void *)0)
# 35 "../crypto/ct/ct_sct_ctx.c"
                      ;
        }
    }
...
{
    if (sctx == 
# 44 "../crypto/ct/ct_sct_ctx.c" 3 4
               ((void *)0)
# 44 "../crypto/ct/ct_sct_ctx.c"
                   )
        return;
    EVP_PKEY_free(sctx->pkey);
    CRYPTO_free(sctx->pkeyhash, "../crypto/ct/ct_sct_ctx.c", 47);
    CRYPTO_free(sctx->ihash, "../crypto/ct/ct_sct_ctx.c", 48);
    CRYPTO_free(sctx->certder, "../crypto/ct/ct_sct_ctx.c", 49);
    CRYPTO_free(sctx->preder, "../crypto/ct/ct_sct_ctx.c", 50);
    CRYPTO_free(sctx->propq, "../crypto/ct/ct_sct_ctx.c", 51);
    CRYPTO_free(sctx, "../crypto/ct/ct_sct_ctx.c", 52);
}
...
static int ct_x509_get_ext(X509 *cert, int nid, int *is_duplicated)
{
    ...
    if (is_duplicated != 
# 64 "../crypto/ct/ct_sct_ctx.c" 3 4
                        ((void *)0)
# 64 "../crypto/ct/ct_sct_ctx.c"
                            )
 ...
 static int ct_x509_cert_fixup(X509 *cert, X509 *presigner)
{
    ...
    if (presigner == 
# 80 "../crypto/ct/ct_sct_ctx.c" 3 4
                    ((void *)0)
# 80 "../crypto/ct/ct_sct_ctx.c"
                        )
        return 1;
    ...
    if (preidx != -1) {
        ...
        if (preext == 
# 109 "../crypto/ct/ct_sct_ctx.c" 3 4
                     ((void *)0) 
# 109 "../crypto/ct/ct_sct_ctx.c"
                          || certext == 
# 109 "../crypto/ct/ct_sct_ctx.c" 3 4
                                        ((void *)0)
# 109 "../crypto/ct/ct_sct_ctx.c"
        ...
        if (preextdata == 
# 112 "../crypto/ct/ct_sct_ctx.c" 3 4
                         ((void *)0) 
# 112 "../crypto/ct/ct_sct_ctx.c"
                              ||
...
{
    unsigned char *certder = 
# 121 "../crypto/ct/ct_sct_ctx.c" 3 4
                            ((void *)0)
# 121 "../crypto/ct/ct_sct_ctx.c"
                                , *preder = 
# 121 "../crypto/ct/ct_sct_ctx.c" 3 4
                                            ((void *)0)
# 121 "../crypto/ct/ct_sct_ctx.c"
                                                ;
    X509 *pretmp = 
# 122 "../crypto/ct/ct_sct_ctx.c" 3 4
                  ((void *)0)
# 122 "../crypto/ct/ct_sct_ctx.c"
                      ;
    ...
    if (poison_idx == -1) {
        ...
        if (presigner != 
# 135 "../crypto/ct/ct_sct_ctx.c" 3 4
                        ((void *)0)
# 135 "../crypto/ct/ct_sct_ctx.c"
                            )
            goto err;
    ...
    if (idx >= 0) {
        ...
        if (pretmp == 
# 170 "../crypto/ct/ct_sct_ctx.c" 3 4
                     ((void *)0)
# 170 "../crypto/ct/ct_sct_ctx.c"
                         )
            goto err;
    ...
    CRYPTO_free(sctx->certder, "../crypto/ct/ct_sct_ctx.c", 185);
    sctx->certder = certder;
    sctx->certderlen = certderlen;

    CRYPTO_free(sctx->preder, "../crypto/ct/ct_sct_ctx.c", 189);
    sctx->preder = preder;
    sctx->prederlen = prederlen;

    return 1;
err:
    CRYPTO_free(certder, "../crypto/ct/ct_sct_ctx.c", 195);
    CRYPTO_free(preder, "../crypto/ct/ct_sct_ctx.c", 196);
    X509_free(pretmp);
    return 0;
}

 static int ct_public_key_hash(SCT_CTX *sctx, X509_PUBKEY *pkey,
                                     unsigned char **hash, size_t *hash_len)
{
    int ret = 0;
    unsigned char *md = 
# 205 "../crypto/ct/ct_sct_ctx.c" 3 4
                       ((void *)0)
# 205 "../crypto/ct/ct_sct_ctx.c"
                           , *der = 
# 205 "../crypto/ct/ct_sct_ctx.c" 3 4
                                    ((void *)0)
# 205 "../crypto/ct/ct_sct_ctx.c"
    ...
    if (sha256 == 
# 210 "../crypto/ct/ct_sct_ctx.c" 3 4
                 ((void *)0)
# 210 "../crypto/ct/ct_sct_ctx.c"
                     )
        goto err;


    if (*hash != 
# 214 "../crypto/ct/ct_sct_ctx.c" 3 4
                ((void *)0) 
# 214 "../crypto/ct/ct_sct_ctx.c"
                     && *hash_len >= 32) {
        md = *hash;
    } else {
        md = CRYPTO_malloc(32, "../crypto/ct/ct_sct_ctx.c", 217);
        if (md == 
# 218 "../crypto/ct/ct_sct_ctx.c" 3 4
                 ((void *)0)
# 218 "../crypto/ct/ct_sct_ctx.c"
                     )
            goto err;
    }
    ...
    if (!EVP_Digest(der, der_len, md, &md_len, sha256, 
# 227 "../crypto/ct/ct_sct_ctx.c" 3 4
                                                      ((void *)0)
# 227 "../crypto/ct/ct_sct_ctx.c"
                                                          ))
        goto err;

    if (md != *hash) {
        CRYPTO_free(*hash, "../crypto/ct/ct_sct_ctx.c", 231);
        *hash = md;
        *hash_len = 32;
    }

    md = 
# 236 "../crypto/ct/ct_sct_ctx.c" 3 4
        ((void *)0)
# 236 "../crypto/ct/ct_sct_ctx.c"
            ;
    ret = 1;
 err:
    EVP_MD_free(sha256);
    CRYPTO_free(md, "../crypto/ct/ct_sct_ctx.c", 240);
    CRYPTO_free(der, "../crypto/ct/ct_sct_ctx.c", 241);
    return ret;
}
...
int SCT_CTX_set1_pubkey(SCT_CTX *sctx, X509_PUBKEY *pubkey)
{
    ...
    if (pkey == 
# 259 "../crypto/ct/ct_sct_ctx.c" 3 4
               ((void *)0)
# 259 "../crypto/ct/ct_sct_ctx.c"
                   )
        return 0;
