# 0 "../crypto/ct/ct_policy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_policy.c"
# 14 "../crypto/ct/ct_policy.c"
...
CT_POLICY_EVAL_CTX *CT_POLICY_EVAL_CTX_new_ex(OSSL_LIB_CTX *libctx,
                                              const char *propq)
{
    CT_POLICY_EVAL_CTX *ctx = CRYPTO_zalloc(sizeof(CT_POLICY_EVAL_CTX), "../crypto/ct/ct_policy.c", 31);
    OSSL_TIME now;

    if (ctx == 
# 34 "../crypto/ct/ct_policy.c" 3 4
              ((void *)0)
# 34 "../crypto/ct/ct_policy.c"
                  )
        return 
# 35 "../crypto/ct/ct_policy.c" 3 4
              ((void *)0)
# 35 "../crypto/ct/ct_policy.c"
                  ;

    ctx->libctx = libctx;
    if (propq != 
# 38 "../crypto/ct/ct_policy.c" 3 4
                ((void *)0)
# 38 "../crypto/ct/ct_policy.c"
                    ) {
        ctx->propq = CRYPTO_strdup(propq, "../crypto/ct/ct_policy.c", 39);
        if (ctx->propq == 
# 40 "../crypto/ct/ct_policy.c" 3 4
                         ((void *)0)
# 40 "../crypto/ct/ct_policy.c"
                             ) {
            CRYPTO_free(ctx, "../crypto/ct/ct_policy.c", 41);
            return 
# 42 "../crypto/ct/ct_policy.c" 3 4
                  ((void *)0)
# 42 "../crypto/ct/ct_policy.c"
                      ;
        }
    }

    now = ossl_time_add(ossl_time_now(),
                        ossl_ticks2time((SCT_CLOCK_DRIFT_TOLERANCE) * ((uint64_t)1000000000)));
    ctx->epoch_time_in_ms = (ossl_time2ticks(now) / (((uint64_t)1000000000) / 1000));
...
CT_POLICY_EVAL_CTX *CT_POLICY_EVAL_CTX_new(void)
{
    return CT_POLICY_EVAL_CTX_new_ex(
# 55 "../crypto/ct/ct_policy.c" 3 4
                                    ((void *)0)
# 55 "../crypto/ct/ct_policy.c"
                                        , 
# 55 "../crypto/ct/ct_policy.c" 3 4
                                          ((void *)0)
# 55 "../crypto/ct/ct_policy.c"
...
{
    if (ctx == 
# 60 "../crypto/ct/ct_policy.c" 3 4
              ((void *)0)
# 60 "../crypto/ct/ct_policy.c"
                  )
        return;
    X509_free(ctx->cert);
    X509_free(ctx->issuer);
    CRYPTO_free(ctx->propq, "../crypto/ct/ct_policy.c", 64);
    CRYPTO_free(ctx, "../crypto/ct/ct_policy.c", 65);
}
