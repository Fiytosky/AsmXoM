# 0 "../crypto/ct/ct_vfy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_vfy.c"
# 10 "../crypto/ct/ct_vfy.c"
...
static int sct_ctx_update(EVP_MD_CTX *ctx, const SCT_CTX *sctx, const SCT *sct)
{
    ...
    unsigned char *p, *der;
    size_t derlen;
# 47 "../crypto/ct/ct_vfy.c"
    if (sct->entry_type == CT_LOG_ENTRY_TYPE_NOT_SET)
        return 0;
    if (sct->entry_type == CT_LOG_ENTRY_TYPE_PRECERT && sctx->ihash == 
# 49 "../crypto/ct/ct_vfy.c" 3 4
                                                                      ((void *)0)
# 49 "../crypto/ct/ct_vfy.c"
                                                                          )
        return 0;
    ...
    *p++ = SIGNATURE_TYPE_CERT_TIMESTAMP;
    ...
    if (der == 
# 72 "../crypto/ct/ct_vfy.c" 3 4
              ((void *)0)
# 72 "../crypto/ct/ct_vfy.c"
                  )
        return 0;
...
{
    EVP_MD_CTX *ctx = 
# 98 "../crypto/ct/ct_vfy.c" 3 4
                     ((void *)0)
# 98 "../crypto/ct/ct_vfy.c"
                         ;
    int ret = 0;

    if (!SCT_is_complete(sct) || sctx->pkey == 
# 101 "../crypto/ct/ct_vfy.c" 3 4
                                              ((void *)0) 
# 101 "../crypto/ct/ct_vfy.c"
                                                   ||
        sct->entry_type == CT_LOG_ENTRY_TYPE_NOT_SET ||
        (sct->entry_type == CT_LOG_ENTRY_TYPE_PRECERT && sctx->ihash == 
# 103 "../crypto/ct/ct_vfy.c" 3 4
                                                                       ((void *)0)
# 103 "../crypto/ct/ct_vfy.c"
                                                                           )) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_vfy.c",104,__func__), ERR_set_error)((50),(106),
# 104 "../crypto/ct/ct_vfy.c" 3 4
       ((void *)0)
# 104 "../crypto/ct/ct_vfy.c"
       );
        return 0;
    }
    if (sct->version != SCT_VERSION_V1) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_vfy.c",108,__func__), ERR_set_error)((50),(115),
# 108 "../crypto/ct/ct_vfy.c" 3 4
       ((void *)0)
# 108 "../crypto/ct/ct_vfy.c"
       );
        return 0;
    }
    if (sct->log_id_len != sctx->pkeyhashlen ||
        memcmp(sct->log_id, sctx->pkeyhash, sctx->pkeyhashlen) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_vfy.c",113,__func__), ERR_set_error)((50),(114),
# 113 "../crypto/ct/ct_vfy.c" 3 4
       ((void *)0)
# 113 "../crypto/ct/ct_vfy.c"
       );
        return 0;
    }
    if (sct->timestamp > sctx->epoch_time_in_ms) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_vfy.c",117,__func__), ERR_set_error)((50),(116),
# 117 "../crypto/ct/ct_vfy.c" 3 4
       ((void *)0)
# 117 "../crypto/ct/ct_vfy.c"
       );
        return 0;
    }
    ...
    ctx = EVP_MD_CTX_new();
    if (ctx == 
# 122 "../crypto/ct/ct_vfy.c" 3 4
              ((void *)0)
# 122 "../crypto/ct/ct_vfy.c"
                  )
        goto end;

    if (!EVP_DigestVerifyInit_ex(ctx, 
# 125 "../crypto/ct/ct_vfy.c" 3 4
                                     ((void *)0)
# 125 "../crypto/ct/ct_vfy.c"
                                         , "SHA2-256", sctx->libctx,
                                 sctx->propq, sctx->pkey, 
# 126 "../crypto/ct/ct_vfy.c" 3 4
                                                         ((void *)0)
# 126 "../crypto/ct/ct_vfy.c"
                                                             ))
        goto end;
    ...
    if (ret == 0)
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_vfy.c",136,__func__), ERR_set_error)((50),(107),
# 136 "../crypto/ct/ct_vfy.c" 3 4
       ((void *)0)
# 136 "../crypto/ct/ct_vfy.c"
       );
