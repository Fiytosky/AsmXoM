# 0 "../crypto/ct/ct_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_err.c"
# 11 "../crypto/ct/ct_err.c"
...
static const ERR_STRING_DATA CT_str_reasons[] = {
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "base64 decode error"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "invalid log id length"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "log conf invalid"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "log conf invalid key"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "log conf missing description"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "log conf missing key"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "log key invalid"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "sct future timestamp"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "sct invalid"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "sct invalid signature"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "sct list invalid"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "sct log id mismatch"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "sct not set"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "sct unsupported version"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "unrecognized signature nid"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "unsupported entry type"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "unsupported version"},
    {0, 
# 46 "../crypto/ct/ct_err.c" 3 4
       ((void *)0)
# 46 "../crypto/ct/ct_err.c"
           }
};
...
int ossl_err_load_CT_strings(void)
{
    ...
    if (ERR_reason_error_string(CT_str_reasons[0].error) == 
# 54 "../crypto/ct/ct_err.c" 3 4
                                                           ((void *)0)
# 54 "../crypto/ct/ct_err.c"
                                                               )
