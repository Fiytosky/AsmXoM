# 0 "../crypto/ct/ct_log.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_log.c"
# 10 "../crypto/ct/ct_log.c"
...
static CTLOG_STORE_LOAD_CTX *ctlog_store_load_ctx_new(void)
{
    CTLOG_STORE_LOAD_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/ct/ct_log.c", 63);
...
static void ctlog_store_load_ctx_free(CTLOG_STORE_LOAD_CTX* ctx)
{
    CRYPTO_free(ctx, "../crypto/ct/ct_log.c", 70);
}
...
# 77 "../crypto/ct/ct_log.c" 3 4
                             ((void *)0)
# 77 "../crypto/ct/ct_log.c"
                                 ;
    int pkey_der_len = i2d_PUBKEY(pkey, &pkey_der);
    unsigned int len;
    EVP_MD *sha256 = 
# 80 "../crypto/ct/ct_log.c" 3 4
                    ((void *)0)
# 80 "../crypto/ct/ct_log.c"
                        ;

    if (pkey_der_len <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",83,__func__), ERR_set_error)((50),(113),
# 83 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 83 "../crypto/ct/ct_log.c"
       );
        goto err;
    }
    sha256 = EVP_MD_fetch(log->libctx, "SHA2-256", log->propq);
    if (sha256 == 
# 87 "../crypto/ct/ct_log.c" 3 4
                 ((void *)0)
# 87 "../crypto/ct/ct_log.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",88,__func__), ERR_set_error)((50),((6 | (0x2 << 18L))),
# 88 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 88 "../crypto/ct/ct_log.c"
       );
        goto err;
    }
...
# 93 "../crypto/ct/ct_log.c" 3 4
                    ((void *)0)
# 93 "../crypto/ct/ct_log.c"
                        );
err:
    EVP_MD_free(sha256);
    CRYPTO_free(pkey_der, "../crypto/ct/ct_log.c", 96);
    return ret;
}

CTLOG_STORE *CTLOG_STORE_new_ex(OSSL_LIB_CTX *libctx, const char *propq)
{
    CTLOG_STORE *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ct/ct_log.c", 102);

    if (ret == 
# 104 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 104 "../crypto/ct/ct_log.c"
                  )
        return 
# 105 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 105 "../crypto/ct/ct_log.c"
                  ;

    ret->libctx = libctx;
    if (propq != 
# 108 "../crypto/ct/ct_log.c" 3 4
                ((void *)0)
# 108 "../crypto/ct/ct_log.c"
                    ) {
        ret->propq = CRYPTO_strdup(propq, "../crypto/ct/ct_log.c", 109);
        if (ret->propq == 
# 110 "../crypto/ct/ct_log.c" 3 4
                         ((void *)0)
# 110 "../crypto/ct/ct_log.c"
                             )
            goto err;
    }

    ret->logs = ((struct stack_st_CTLOG *)OPENSSL_sk_new_null());
    if (ret->logs == 
# 115 "../crypto/ct/ct_log.c" 3 4
                    ((void *)0)
# 115 "../crypto/ct/ct_log.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",116,__func__), ERR_set_error)((50),((15 | (0x2 << 18L))),
# 116 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 116 "../crypto/ct/ct_log.c"
       );
        goto err;
    }
...
err:
    ...
    return 
# 123 "../crypto/ct/ct_log.c" 3 4
          ((void *)0)
# 123 "../crypto/ct/ct_log.c"
              ;
}

CTLOG_STORE *CTLOG_STORE_new(void)
{
    return CTLOG_STORE_new_ex(
# 128 "../crypto/ct/ct_log.c" 3 4
                             ((void *)0)
# 128 "../crypto/ct/ct_log.c"
                                 , 
# 128 "../crypto/ct/ct_log.c" 3 4
                                   ((void *)0)
# 128 "../crypto/ct/ct_log.c"
...
{
    if (store != 
# 133 "../crypto/ct/ct_log.c" 3 4
                ((void *)0)
# 133 "../crypto/ct/ct_log.c"
                    ) {
        CRYPTO_free(store->propq, "../crypto/ct/ct_log.c", 134);
        OPENSSL_sk_pop_free(ossl_check_CTLOG_sk_type(store->logs),ossl_check_CTLOG_freefunc_type(CTLOG_free));
        CRYPTO_free(store, "../crypto/ct/ct_log.c", 136);
    }
}
                               ...
                               const CONF *conf, const char *section)
{
    ...
    if (description == 
# 146 "../crypto/ct/ct_log.c" 3 4
                      ((void *)0)
# 146 "../crypto/ct/ct_log.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",147,__func__), ERR_set_error)((50),(111),
# 147 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 147 "../crypto/ct/ct_log.c"
       );
        return 0;
    }
    ...
    if (pkey_base64 == 
# 152 "../crypto/ct/ct_log.c" 3 4
                      ((void *)0)
# 152 "../crypto/ct/ct_log.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",153,__func__), ERR_set_error)((50),(112),
# 153 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 153 "../crypto/ct/ct_log.c"
       );
        return 0;
    }
...
int CTLOG_STORE_load_default_file(CTLOG_STORE *store)
{
    const char *fpath = ossl_safe_getenv("CTLOG_FILE");

    if (fpath == 
# 165 "../crypto/ct/ct_log.c" 3 4
                ((void *)0)
# 165 "../crypto/ct/ct_log.c"
                    )
      fpath = "/root/AsmXoM/evaluation/openssl-3.3.5/build/ssl" "/ct_log_list.cnf";
                                ...
                                void *arg)
{
    ...
    CTLOG *ct_log = 
# 181 "../crypto/ct/ct_log.c" 3 4
                   ((void *)0)
# 181 "../crypto/ct/ct_log.c"
                       ;
    ...
    if (log_name == 
# 187 "../crypto/ct/ct_log.c" 3 4
                   ((void *)0)
# 187 "../crypto/ct/ct_log.c"
                       )
        return 1;

    tmp = CRYPTO_strndup(log_name, log_name_len, "../crypto/ct/ct_log.c", 190);
    if (tmp == 
# 191 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 191 "../crypto/ct/ct_log.c"
                  )
        return -1;

    ret = ctlog_new_from_conf(load_ctx->log_store, &ct_log, load_ctx->conf, tmp);
    CRYPTO_free(tmp, "../crypto/ct/ct_log.c", 195);
    ...
    if (!OPENSSL_sk_push(ossl_check_CTLOG_sk_type(load_ctx->log_store->logs), ossl_check_CTLOG_type(ct_log))) {
        CTLOG_free(ct_log);
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",209,__func__), ERR_set_error)((50),((15 | (0x2 << 18L))),
# 209 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 209 "../crypto/ct/ct_log.c"
       );
        return -1;
    }
    return 1;
...
int CTLOG_STORE_load_file(CTLOG_STORE *store, const char *file)
{
    ...
    if (load_ctx == 
# 221 "../crypto/ct/ct_log.c" 3 4
                   ((void *)0)
# 221 "../crypto/ct/ct_log.c"
                       )
        return 0;
    load_ctx->log_store = store;
    load_ctx->conf = NCONF_new(
# 224 "../crypto/ct/ct_log.c" 3 4
                              ((void *)0)
# 224 "../crypto/ct/ct_log.c"
                                  );
    if (load_ctx->conf == 
# 225 "../crypto/ct/ct_log.c" 3 4
                         ((void *)0)
# 225 "../crypto/ct/ct_log.c"
                             )
        goto end;

    if (NCONF_load(load_ctx->conf, file, 
# 228 "../crypto/ct/ct_log.c" 3 4
                                        ((void *)0)
# 228 "../crypto/ct/ct_log.c"
                                            ) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",229,__func__), ERR_set_error)((50),(109),
# 229 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 229 "../crypto/ct/ct_log.c"
       );
        goto end;
    }

    enabled_logs = NCONF_get_string(load_ctx->conf, 
# 233 "../crypto/ct/ct_log.c" 3 4
                                                   ((void *)0)
# 233 "../crypto/ct/ct_log.c"
                                                       , "enabled_logs");
    if (enabled_logs == 
# 234 "../crypto/ct/ct_log.c" 3 4
                       ((void *)0)
# 234 "../crypto/ct/ct_log.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",235,__func__), ERR_set_error)((50),(109),
# 235 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 235 "../crypto/ct/ct_log.c"
       );
        goto end;
    }
    ...
    if (!CONF_parse_list(enabled_logs, ',', 1, ctlog_store_load_log, load_ctx) ||
        ...
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_log.c",241,__func__), ERR_set_error)((50),(109),
# 241 "../crypto/ct/ct_log.c" 3 4
       ((void *)0)
# 241 "../crypto/ct/ct_log.c"
       );
        goto end;
    }
...
CTLOG *CTLOG_new_ex(EVP_PKEY *public_key, const char *name, OSSL_LIB_CTX *libctx,
                    const char *propq)
{
    CTLOG *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/ct/ct_log.c", 260);

    if (ret == 
# 262 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 262 "../crypto/ct/ct_log.c"
                  )
        return 
# 263 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 263 "../crypto/ct/ct_log.c"
                  ;

    ret->libctx = libctx;
    if (propq != 
# 266 "../crypto/ct/ct_log.c" 3 4
                ((void *)0)
# 266 "../crypto/ct/ct_log.c"
                    ) {
        ret->propq = CRYPTO_strdup(propq, "../crypto/ct/ct_log.c", 267);
        if (ret->propq == 
# 268 "../crypto/ct/ct_log.c" 3 4
                         ((void *)0)
# 268 "../crypto/ct/ct_log.c"
                             )
            goto err;
    }

    ret->name = CRYPTO_strdup(name, "../crypto/ct/ct_log.c", 272);
    if (ret->name == 
# 273 "../crypto/ct/ct_log.c" 3 4
                    ((void *)0)
# 273 "../crypto/ct/ct_log.c"
                        )
        goto err;
...
err:
    CTLOG_free(ret);
    return 
# 283 "../crypto/ct/ct_log.c" 3 4
          ((void *)0)
# 283 "../crypto/ct/ct_log.c"
              ;
}

CTLOG *CTLOG_new(EVP_PKEY *public_key, const char *name)
{
    return CTLOG_new_ex(public_key, name, 
# 288 "../crypto/ct/ct_log.c" 3 4
                                         ((void *)0)
# 288 "../crypto/ct/ct_log.c"
                                             , 
# 288 "../crypto/ct/ct_log.c" 3 4
                                               ((void *)0)
# 288 "../crypto/ct/ct_log.c"
...
{
    if (log != 
# 294 "../crypto/ct/ct_log.c" 3 4
              ((void *)0)
# 294 "../crypto/ct/ct_log.c"
                  ) {
        CRYPTO_free(log->name, "../crypto/ct/ct_log.c", 295);
        EVP_PKEY_free(log->public_key);
        CRYPTO_free(log->propq, "../crypto/ct/ct_log.c", 297);
        CRYPTO_free(log, "../crypto/ct/ct_log.c", 298);
    }
}
                                        ...
                                        size_t log_id_len)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CTLOG_sk_type(store->logs)); ++i) {
        const CTLOG *log = ((CTLOG *)OPENSSL_sk_value(ossl_check_const_CTLOG_sk_type(store->logs), (i)));
        if (memcmp(log->log_id, log_id, log_id_len) == 0)
            return log;
    }

    return 
# 335 "../crypto/ct/ct_log.c" 3 4
          ((void *)0)
# 335 "../crypto/ct/ct_log.c"
              ;
}
