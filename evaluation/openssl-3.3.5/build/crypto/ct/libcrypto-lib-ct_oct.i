# 0 "../crypto/ct/ct_oct.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_oct.c"
# 14 "../crypto/ct/ct_oct.c"
...
# 21 "../crypto/ct/ct_oct.c" 2

# 1 "../crypto/ct/ct_local.h" 1
# 10 "../crypto/ct/ct_local.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 11 "../crypto/ct/ct_local.h" 2
...
# 15 "../crypto/ct/ct_local.h" 2
# 57 "../crypto/ct/ct_local.h"
struct sct_st {
...
# 138 "../crypto/ct/ct_local.h"
 int SCT_CTX_set1_cert(SCT_CTX *sctx, X509 *cert, X509 *presigner);
# 147 "../crypto/ct/ct_local.h"
...
# 201 "../crypto/ct/ct_local.h"
 int i2o_SCT_signature(const SCT *sct, unsigned char **out);
# 212 "../crypto/ct/ct_local.h"
...
int o2i_SCT_signature(SCT *sct, const unsigned char **in, size_t len)
{
    ...
    if (sct->version != SCT_VERSION_V1) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",31,__func__), ERR_set_error)((50),(103),
# 31 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 31 "../crypto/ct/ct_oct.c"
       );
        return -1;
    }
    ...
    if (len <= 4) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",42,__func__), ERR_set_error)((50),(107),
# 42 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 42 "../crypto/ct/ct_oct.c"
       );
        return -1;
    }
    ...
    if (SCT_get_signature_nid(sct) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",51,__func__), ERR_set_error)((50),(107),
# 51 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 51 "../crypto/ct/ct_oct.c"
       );
        return -1;
    }
    ...
    if (siglen > len_remaining) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",58,__func__), ERR_set_error)((50),(107),
# 58 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 58 "../crypto/ct/ct_oct.c"
       );
        return -1;
    }
...
{
    SCT *sct = 
# 72 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 72 "../crypto/ct/ct_oct.c"
                  ;
    const unsigned char *p;

    if (len == 0 || len > 65535) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",76,__func__), ERR_set_error)((50),(104),
# 76 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 76 "../crypto/ct/ct_oct.c"
       );
        goto err;
    }

    if ((sct = SCT_new()) == 
# 80 "../crypto/ct/ct_oct.c" 3 4
                            ((void *)0)
# 80 "../crypto/ct/ct_oct.c"
                                )
        goto err;
    ...
    if (sct->version == SCT_VERSION_V1) {
        int sig_len;
        size_t len2;
# 98 "../crypto/ct/ct_oct.c"
        if (len < 43) {
            (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",99,__func__), ERR_set_error)((50),(104),
# 99 "../crypto/ct/ct_oct.c" 3 4
           ((void *)0)
# 99 "../crypto/ct/ct_oct.c"
           );
            goto err;
        }
        len -= 43;
        ...
        if (sct->log_id == 
# 105 "../crypto/ct/ct_oct.c" 3 4
                          ((void *)0)
# 105 "../crypto/ct/ct_oct.c"
                              )
            goto err;
        sct->log_id_len = 32;
        p += 32;
        ...
        if (len < len2) {
            (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",114,__func__), ERR_set_error)((50),(104),
# 114 "../crypto/ct/ct_oct.c" 3 4
           ((void *)0)
# 114 "../crypto/ct/ct_oct.c"
           );
            goto err;
        }
        if (len2 > 0) {
            ...
            if (sct->ext == 
# 119 "../crypto/ct/ct_oct.c" 3 4
                           ((void *)0)
# 119 "../crypto/ct/ct_oct.c"
                               )
                goto err;
        }
        sct->ext_len = len2;
        ...
        if (sig_len <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",128,__func__), ERR_set_error)((50),(104),
# 128 "../crypto/ct/ct_oct.c" 3 4
           ((void *)0)
# 128 "../crypto/ct/ct_oct.c"
           );
            goto err;
        }
        len -= sig_len;
        *in = p + len;
        ...
        if (sct->sct == 
# 136 "../crypto/ct/ct_oct.c" 3 4
                       ((void *)0)
# 136 "../crypto/ct/ct_oct.c"
                           )
            goto err;
        sct->sct_len = len;
        *in = p + len;
    ...
    if (psct != 
# 142 "../crypto/ct/ct_oct.c" 3 4
               ((void *)0)
# 142 "../crypto/ct/ct_oct.c"
                   ) {
        SCT_free(*psct);
        *psct = sct;
    }
...
err:
    SCT_free(sct);
    return 
# 150 "../crypto/ct/ct_oct.c" 3 4
          ((void *)0)
# 150 "../crypto/ct/ct_oct.c"
              ;
}
...
int i2o_SCT_signature(const SCT *sct, unsigned char **out)
{
    size_t len;
    unsigned char *p = 
# 156 "../crypto/ct/ct_oct.c" 3 4
                      ((void *)0)
# 156 "../crypto/ct/ct_oct.c"
                          , *pstart = 
# 156 "../crypto/ct/ct_oct.c" 3 4
                                      ((void *)0)
# 156 "../crypto/ct/ct_oct.c"
    ...
    if (!SCT_signature_is_complete(sct)) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",159,__func__), ERR_set_error)((50),(107),
# 159 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 159 "../crypto/ct/ct_oct.c"
       );
        goto err;
    }

    if (sct->version != SCT_VERSION_V1) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",164,__func__), ERR_set_error)((50),(103),
# 164 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 164 "../crypto/ct/ct_oct.c"
       );
        goto err;
    }
    ...
    if (out != 
# 175 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 175 "../crypto/ct/ct_oct.c"
                  ) {
        if (*out != 
# 176 "../crypto/ct/ct_oct.c" 3 4
                   ((void *)0)
# 176 "../crypto/ct/ct_oct.c"
                       ) {
            p = *out;
            *out += len;
        } else {
            pstart = p = CRYPTO_malloc(len, "../crypto/ct/ct_oct.c", 180);
            if (p == 
# 181 "../crypto/ct/ct_oct.c" 3 4
                    ((void *)0)
# 181 "../crypto/ct/ct_oct.c"
                        )
                goto err;
            *out = p;
        }
    ...
    return len;
err:
    CRYPTO_free(pstart, "../crypto/ct/ct_oct.c", 194);
    return -1;
}
...
int i2o_SCT(const SCT *sct, unsigned char **out)
{
    size_t len;
    unsigned char *p = 
# 201 "../crypto/ct/ct_oct.c" 3 4
                      ((void *)0)
# 201 "../crypto/ct/ct_oct.c"
                          , *pstart = 
# 201 "../crypto/ct/ct_oct.c" 3 4
                                      ((void *)0)
# 201 "../crypto/ct/ct_oct.c"
    ...
    if (!SCT_is_complete(sct)) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",204,__func__), ERR_set_error)((50),(106),
# 204 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 204 "../crypto/ct/ct_oct.c"
       );
        goto err;
    }
    ...
    if (out == 
# 218 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 218 "../crypto/ct/ct_oct.c"
                  )
        return len;

    if (*out != 
# 221 "../crypto/ct/ct_oct.c" 3 4
               ((void *)0)
# 221 "../crypto/ct/ct_oct.c"
                   ) {
        p = *out;
        *out += len;
    } else {
        pstart = p = CRYPTO_malloc(len, "../crypto/ct/ct_oct.c", 225);
        if (p == 
# 226 "../crypto/ct/ct_oct.c" 3 4
                ((void *)0)
# 226 "../crypto/ct/ct_oct.c"
                    )
            goto err;
        *out = p;
    }
    ...
    return len;
err:
    CRYPTO_free(pstart, "../crypto/ct/ct_oct.c", 249);
    return -1;
}
...
struct stack_st_SCT *o2i_SCT_LIST(struct stack_st_SCT **a, const unsigned char **pp,
                            size_t len)
{
    struct stack_st_SCT *sk = 
# 256 "../crypto/ct/ct_oct.c" 3 4
                       ((void *)0)
# 256 "../crypto/ct/ct_oct.c"
                           ;
    size_t list_len, sct_len;

    if (len < 2 || len > 65535) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",260,__func__), ERR_set_error)((50),(105),
# 260 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 260 "../crypto/ct/ct_oct.c"
       );
        return 
# 261 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 261 "../crypto/ct/ct_oct.c"
                  ;
    }

    ((list_len=(((unsigned int)((*pp)[0]))<< 8)| (((unsigned int)((*pp)[1])) )),*pp+=2);
    if (list_len != len - 2) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",266,__func__), ERR_set_error)((50),(105),
# 266 "../crypto/ct/ct_oct.c" 3 4
       ((void *)0)
# 266 "../crypto/ct/ct_oct.c"
       );
        return 
# 267 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 267 "../crypto/ct/ct_oct.c"
                  ;
    }

    if (a == 
# 270 "../crypto/ct/ct_oct.c" 3 4
            ((void *)0) 
# 270 "../crypto/ct/ct_oct.c"
                 || *a == 
# 270 "../crypto/ct/ct_oct.c" 3 4
                          ((void *)0)
# 270 "../crypto/ct/ct_oct.c"
                              ) {
        sk = ((struct stack_st_SCT *)OPENSSL_sk_new_null());
        if (sk == 
# 272 "../crypto/ct/ct_oct.c" 3 4
                 ((void *)0)
# 272 "../crypto/ct/ct_oct.c"
                     )
            return 
# 273 "../crypto/ct/ct_oct.c" 3 4
                  ((void *)0)
# 273 "../crypto/ct/ct_oct.c"
                      ;
    } else {
        SCT *sct;
        ...
        sk = *a;
        while ((sct = ((SCT *)OPENSSL_sk_pop(ossl_check_SCT_sk_type(sk)))) != 
# 279 "../crypto/ct/ct_oct.c" 3 4
                                        ((void *)0)
# 279 "../crypto/ct/ct_oct.c"
                                            )
            SCT_free(sct);
    }
    ...
    while (list_len > 0) {
        ...
        if (list_len < 2) {
            (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",287,__func__), ERR_set_error)((50),(105),
# 287 "../crypto/ct/ct_oct.c" 3 4
           ((void *)0)
# 287 "../crypto/ct/ct_oct.c"
           );
            goto err;
        }
        ...
        if (sct_len == 0 || sct_len > list_len) {
            (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",294,__func__), ERR_set_error)((50),(105),
# 294 "../crypto/ct/ct_oct.c" 3 4
           ((void *)0)
# 294 "../crypto/ct/ct_oct.c"
           );
            goto err;
        }
        list_len -= sct_len;
        ...
        if ((sct = o2i_SCT(
# 299 "../crypto/ct/ct_oct.c" 3 4
                          ((void *)0)
# 299 "../crypto/ct/ct_oct.c"
                              , pp, sct_len)) == 
# 299 "../crypto/ct/ct_oct.c" 3 4
                                                 ((void *)0)
# 299 "../crypto/ct/ct_oct.c"
            ...
            goto err;
        if (!OPENSSL_sk_push(ossl_check_SCT_sk_type(sk), ossl_check_SCT_type(sct))) {
            SCT_free(sct);
            goto err;
        }
    }
    ...
    if (a != 
# 307 "../crypto/ct/ct_oct.c" 3 4
            ((void *)0) 
# 307 "../crypto/ct/ct_oct.c"
                 && *a == 
# 307 "../crypto/ct/ct_oct.c" 3 4
                          ((void *)0)
# 307 "../crypto/ct/ct_oct.c"
 ...
 err:
    if (a == 
# 312 "../crypto/ct/ct_oct.c" 3 4
            ((void *)0) 
# 312 "../crypto/ct/ct_oct.c"
                 || *a == 
# 312 "../crypto/ct/ct_oct.c" 3 4
                          ((void *)0)
# 312 "../crypto/ct/ct_oct.c"
        ...
        SCT_LIST_free(sk);
    return 
# 314 "../crypto/ct/ct_oct.c" 3 4
          ((void *)0)
# 314 "../crypto/ct/ct_oct.c"
              ;
}
...
int i2o_SCT_LIST(const struct stack_st_SCT *a, unsigned char **pp)
{
    ...
    size_t len2;
    unsigned char *p = 
# 321 "../crypto/ct/ct_oct.c" 3 4
                      ((void *)0)
# 321 "../crypto/ct/ct_oct.c"
                          , *p2;

    if (pp != 
# 323 "../crypto/ct/ct_oct.c" 3 4
             ((void *)0)
# 323 "../crypto/ct/ct_oct.c"
                 ) {
        if (*pp == 
# 324 "../crypto/ct/ct_oct.c" 3 4
                  ((void *)0)
# 324 "../crypto/ct/ct_oct.c"
                      ) {
            if ((len = i2o_SCT_LIST(a, 
# 325 "../crypto/ct/ct_oct.c" 3 4
                                      ((void *)0)
# 325 "../crypto/ct/ct_oct.c"
                                          )) == -1) {
                (ERR_new(), ERR_set_debug("../crypto/ct/ct_oct.c",326,__func__), ERR_set_error)((50),(105),
# 326 "../crypto/ct/ct_oct.c" 3 4
               ((void *)0)
# 326 "../crypto/ct/ct_oct.c"
               );
                return -1;
            }
            if ((*pp = CRYPTO_malloc(len, "../crypto/ct/ct_oct.c", 329)) == 
# 329 "../crypto/ct/ct_oct.c" 3 4
                                              ((void *)0)
# 329 "../crypto/ct/ct_oct.c"
                                                  )
                return -1;
            is_pp_new = 1;
        }
    ...
    len2 = 2;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SCT_sk_type(a)); i++) {
        if (pp != 
# 338 "../crypto/ct/ct_oct.c" 3 4
                 ((void *)0)
# 338 "../crypto/ct/ct_oct.c"
                     ) {
            p2 = p;
            p += 2;
            if ((sct_len = i2o_SCT(((SCT *)OPENSSL_sk_value(ossl_check_const_SCT_sk_type(a), (i))), &p)) == -1)
                goto err;
            ((p2[0]=(unsigned char)(((sct_len)>> 8)&0xff), p2[1]=(unsigned char)(((sct_len) )&0xff)),p2+=2);
        } else {
          if ((sct_len = i2o_SCT(((SCT *)OPENSSL_sk_value(ossl_check_const_SCT_sk_type(a), (i))), 
# 345 "../crypto/ct/ct_oct.c" 3 4
                                                    ((void *)0)
# 345 "../crypto/ct/ct_oct.c"
                                                        )) == -1)
              goto err;
        }
        len2 += 2 + sct_len;
    ...
    if (pp != 
# 354 "../crypto/ct/ct_oct.c" 3 4
             ((void *)0)
# 354 "../crypto/ct/ct_oct.c"
                 ) {
        p = *pp;
 ...
 err:
    if (is_pp_new) {
        CRYPTO_free(*pp, "../crypto/ct/ct_oct.c", 364);
        *pp = 
# 365 "../crypto/ct/ct_oct.c" 3 4
             ((void *)0)
# 365 "../crypto/ct/ct_oct.c"
                 ;
    }
    return -1;
}
...
{
    ASN1_OCTET_STRING *oct = 
# 373 "../crypto/ct/ct_oct.c" 3 4
                            ((void *)0)
# 373 "../crypto/ct/ct_oct.c"
                                ;
    struct stack_st_SCT *sk = 
# 374 "../crypto/ct/ct_oct.c" 3 4
                       ((void *)0)
# 374 "../crypto/ct/ct_oct.c"
                           ;
    const unsigned char *p;

    p = *pp;
    if (d2i_ASN1_OCTET_STRING(&oct, &p, len) == 
# 378 "../crypto/ct/ct_oct.c" 3 4
                                               ((void *)0)
# 378 "../crypto/ct/ct_oct.c"
                                                   )
        return 
# 379 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 379 "../crypto/ct/ct_oct.c"
                  ;

    p = oct->data;
    if ((sk = o2i_SCT_LIST(a, &p, oct->length)) != 
# 382 "../crypto/ct/ct_oct.c" 3 4
                                                  ((void *)0)
# 382 "../crypto/ct/ct_oct.c"
                                                      )
        *pp += len;
...
int i2d_SCT_LIST(const struct stack_st_SCT *a, unsigned char **out)
{
    ...
    oct.data = 
# 394 "../crypto/ct/ct_oct.c" 3 4
              ((void *)0)
# 394 "../crypto/ct/ct_oct.c"
                  ;
    if ((oct.length = i2o_SCT_LIST(a, &oct.data)) == -1)
        return -1;

    len = i2d_ASN1_OCTET_STRING(&oct, out);
    CRYPTO_free(oct.data, "../crypto/ct/ct_oct.c", 399);
    return len;
}
