# 0 "../crypto/ct/ct_sct.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_sct.c"
# 14 "../crypto/ct/ct_sct.c"
...
SCT *SCT_new(void)
{
    ...
    if (sct == 
# 26 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 26 "../crypto/ct/ct_sct.c"
                  )
        return 
# 27 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 27 "../crypto/ct/ct_sct.c"
                  ;
...
{
    if (sct == 
# 36 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 36 "../crypto/ct/ct_sct.c"
                  )
        return;

    CRYPTO_free(sct->log_id, "../crypto/ct/ct_sct.c", 39);
    CRYPTO_free(sct->ext, "../crypto/ct/ct_sct.c", 40);
    CRYPTO_free(sct->sig, "../crypto/ct/ct_sct.c", 41);
    CRYPTO_free(sct->sct, "../crypto/ct/ct_sct.c", 42);
    CRYPTO_free(sct, "../crypto/ct/ct_sct.c", 43);
}

void SCT_LIST_free(struct stack_st_SCT *a)
{
    OPENSSL_sk_pop_free(ossl_check_SCT_sk_type(a),ossl_check_SCT_freefunc_type(SCT_free));
}

int SCT_set_version(SCT *sct, sct_version_t version)
{
    if (version != SCT_VERSION_V1) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_sct.c",54,__func__), ERR_set_error)((50),(103),
# 54 "../crypto/ct/ct_sct.c" 3 4
       ((void *)0)
# 54 "../crypto/ct/ct_sct.c"
       );
        return 0;
    }
    sct->version = version;
...
int SCT_set_log_entry_type(SCT *sct, ct_log_entry_type_t entry_type)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/ct/ct_sct.c",74,__func__), ERR_set_error)((50),(102),
# 74 "../crypto/ct/ct_sct.c" 3 4
   ((void *)0)
# 74 "../crypto/ct/ct_sct.c"
   );
    return 0;
}
...
int SCT_set0_log_id(SCT *sct, unsigned char *log_id, size_t log_id_len)
{
    if (sct->version == SCT_VERSION_V1 && log_id_len != 32) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_sct.c",81,__func__), ERR_set_error)((50),(100),
# 81 "../crypto/ct/ct_sct.c" 3 4
       ((void *)0)
# 81 "../crypto/ct/ct_sct.c"
       );
        return 0;
    }

    CRYPTO_free(sct->log_id, "../crypto/ct/ct_sct.c", 85);
    sct->log_id = log_id;
...
{
    if (sct->version == SCT_VERSION_V1 && log_id_len != 32) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_sct.c",95,__func__), ERR_set_error)((50),(100),
# 95 "../crypto/ct/ct_sct.c" 3 4
       ((void *)0)
# 95 "../crypto/ct/ct_sct.c"
       );
        return 0;
    }

    CRYPTO_free(sct->log_id, "../crypto/ct/ct_sct.c", 99);
    sct->log_id = 
# 100 "../crypto/ct/ct_sct.c" 3 4
                 ((void *)0)
# 100 "../crypto/ct/ct_sct.c"
                     ;
    sct->log_id_len = 0;
    sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;

    if (log_id != 
# 104 "../crypto/ct/ct_sct.c" 3 4
                 ((void *)0) 
# 104 "../crypto/ct/ct_sct.c"
                      && log_id_len > 0) {
        sct->log_id = CRYPTO_memdup((log_id), log_id_len, "../crypto/ct/ct_sct.c", 105);
        if (sct->log_id == 
# 106 "../crypto/ct/ct_sct.c" 3 4
                          ((void *)0)
# 106 "../crypto/ct/ct_sct.c"
                              )
            return 0;
        sct->log_id_len = log_id_len;
    }
...
int SCT_set_signature_nid(SCT *sct, int nid)
{
    ...
    case 794:
        ...
        return 1;
    default:
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_sct.c",134,__func__), ERR_set_error)((50),(101),
# 134 "../crypto/ct/ct_sct.c" 3 4
       ((void *)0)
# 134 "../crypto/ct/ct_sct.c"
       );
        return 0;
    }
}
...
void SCT_set0_extensions(SCT *sct, unsigned char *ext, size_t ext_len)
{
    CRYPTO_free(sct->ext, "../crypto/ct/ct_sct.c", 141);
    sct->ext = ext;
    sct->ext_len = ext_len;
    sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
}
...
{
    CRYPTO_free(sct->ext, "../crypto/ct/ct_sct.c", 149);
    sct->ext = 
# 150 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 150 "../crypto/ct/ct_sct.c"
                  ;
    sct->ext_len = 0;
    sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;

    if (ext != 
# 154 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0) 
# 154 "../crypto/ct/ct_sct.c"
                   && ext_len > 0) {
        sct->ext = CRYPTO_memdup((ext), ext_len, "../crypto/ct/ct_sct.c", 155);
        if (sct->ext == 
# 156 "../crypto/ct/ct_sct.c" 3 4
                       ((void *)0)
# 156 "../crypto/ct/ct_sct.c"
                           )
            return 0;
        sct->ext_len = ext_len;
    }
...
void SCT_set0_signature(SCT *sct, unsigned char *sig, size_t sig_len)
{
    CRYPTO_free(sct->sig, "../crypto/ct/ct_sct.c", 165);
    sct->sig = sig;
    sct->sig_len = sig_len;
    sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;
}
...
{
    CRYPTO_free(sct->sig, "../crypto/ct/ct_sct.c", 173);
    sct->sig = 
# 174 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 174 "../crypto/ct/ct_sct.c"
                  ;
    sct->sig_len = 0;
    sct->validation_status = SCT_VALIDATION_STATUS_NOT_SET;

    if (sig != 
# 178 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0) 
# 178 "../crypto/ct/ct_sct.c"
                   && sig_len > 0) {
        sct->sig = CRYPTO_memdup((sig), sig_len, "../crypto/ct/ct_sct.c", 179);
        if (sct->sig == 
# 180 "../crypto/ct/ct_sct.c" 3 4
                       ((void *)0)
# 180 "../crypto/ct/ct_sct.c"
                           )
            return 0;
        sct->sig_len = sig_len;
    }
...
int SCT_is_complete(const SCT *sct)
{
    ...
    case SCT_VERSION_V1:
        return sct->log_id != 
# 243 "../crypto/ct/ct_sct.c" 3 4
                             ((void *)0) 
# 243 "../crypto/ct/ct_sct.c"
                                  && SCT_signature_is_complete(sct);
    default:
        return sct->sct != 
# 245 "../crypto/ct/ct_sct.c" 3 4
                          ((void *)0)
# 245 "../crypto/ct/ct_sct.c"
                              ;
    }
}
...
int SCT_signature_is_complete(const SCT *sct)
{
    return SCT_get_signature_nid(sct) != 0 &&
        sct->sig != 
# 252 "../crypto/ct/ct_sct.c" 3 4
                   ((void *)0) 
# 252 "../crypto/ct/ct_sct.c"
                        && sct->sig_len > 0;
}
...
int SCT_validate(SCT *sct, const CT_POLICY_EVAL_CTX *ctx)
{
    int is_sct_valid = -1;
    SCT_CTX *sctx = 
# 285 "../crypto/ct/ct_sct.c" 3 4
                   ((void *)0)
# 285 "../crypto/ct/ct_sct.c"
                       ;
    X509_PUBKEY *pub = 
# 286 "../crypto/ct/ct_sct.c" 3 4
                      ((void *)0)
# 286 "../crypto/ct/ct_sct.c"
                          , *log_pkey = 
# 286 "../crypto/ct/ct_sct.c" 3 4
                                        ((void *)0)
# 286 "../crypto/ct/ct_sct.c"
    ...
    if (log == 
# 302 "../crypto/ct/ct_sct.c" 3 4
              ((void *)0)
# 302 "../crypto/ct/ct_sct.c"
                  ) {
    ...
    if (sctx == 
# 308 "../crypto/ct/ct_sct.c" 3 4
               ((void *)0)
# 308 "../crypto/ct/ct_sct.c"
                   )
        goto err;
    ...
    if (SCT_get_log_entry_type(sct) == CT_LOG_ENTRY_TYPE_PRECERT) {
        ...
        if (ctx->issuer == 
# 319 "../crypto/ct/ct_sct.c" 3 4
                          ((void *)0)
# 319 "../crypto/ct/ct_sct.c"
                              ) {
...
# 352 "../crypto/ct/ct_sct.c"
    if (SCT_CTX_set1_cert(sctx, ctx->cert, 
# 352 "../crypto/ct/ct_sct.c" 3 4
                                          ((void *)0)
# 352 "../crypto/ct/ct_sct.c"
                                              ) != 1)
        sct->validation_status = SCT_VALIDATION_STATUS_UNVERIFIED;
...
int SCT_LIST_validate(const struct stack_st_SCT *scts, CT_POLICY_EVAL_CTX *ctx)
{
    ...
    int sct_count = scts != 
# 371 "../crypto/ct/ct_sct.c" 3 4
                           ((void *)0) 
# 371 "../crypto/ct/ct_sct.c"
                                ? OPENSSL_sk_num(ossl_check_const_SCT_sk_type(scts)) : 0;
    int i;

    for (i = 0; i < sct_count; ++i) {
        int is_sct_valid = -1;
        SCT *sct = ((SCT *)OPENSSL_sk_value(ossl_check_const_SCT_sk_type(scts), (i)));

        if (sct == 
# 378 "../crypto/ct/ct_sct.c" 3 4
                  ((void *)0)
# 378 "../crypto/ct/ct_sct.c"
                      )
            continue;
