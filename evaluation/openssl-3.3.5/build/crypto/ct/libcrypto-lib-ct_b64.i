# 0 "../crypto/ct/ct_b64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_b64.c"
# 10 "../crypto/ct/ct_b64.c"
...
# 28 "../crypto/ct/ct_b64.c" 3 4
                           ((void *)0)
# 28 "../crypto/ct/ct_b64.c"
                               ;

    if (inlen == 0) {
        *out = 
# 31 "../crypto/ct/ct_b64.c" 3 4
              ((void *)0)
# 31 "../crypto/ct/ct_b64.c"
                  ;
        return 0;
    }
    ...
    if (outbuf == 
# 37 "../crypto/ct/ct_b64.c" 3 4
                 ((void *)0)
# 37 "../crypto/ct/ct_b64.c"
                     )
        goto err;

    outlen = EVP_DecodeBlock(outbuf, (unsigned char *)in, inlen);
    if (outlen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",42,__func__), ERR_set_error)((50),(108),
# 42 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 42 "../crypto/ct/ct_b64.c"
       );
        goto err;
    }
    ...
    *out = outbuf;
    return outlen;
err:
    CRYPTO_free(outbuf, "../crypto/ct/ct_b64.c", 57);
    return -1;
}
                         ...
                         const char *signature_base64)
{
    SCT *sct = SCT_new();
    unsigned char *dec = 
# 67 "../crypto/ct/ct_b64.c" 3 4
                        ((void *)0)
# 67 "../crypto/ct/ct_b64.c"
                            ;
    const unsigned char* p = 
# 68 "../crypto/ct/ct_b64.c" 3 4
                            ((void *)0)
# 68 "../crypto/ct/ct_b64.c"
                                ;
    int declen;

    if (sct == 
# 71 "../crypto/ct/ct_b64.c" 3 4
              ((void *)0)
# 71 "../crypto/ct/ct_b64.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",72,__func__), ERR_set_error)((50),((50 | (0x2 << 18L))),
# 72 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 72 "../crypto/ct/ct_b64.c"
       );
        return 
# 73 "../crypto/ct/ct_b64.c" 3 4
              ((void *)0)
# 73 "../crypto/ct/ct_b64.c"
                  ;
    }
    ...
    if (!SCT_set_version(sct, version)) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",81,__func__), ERR_set_error)((50),(115),
# 81 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 81 "../crypto/ct/ct_b64.c"
       );
        goto err;
    }
    ...
    if (declen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",87,__func__), ERR_set_error)((50),(118),
# 87 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 87 "../crypto/ct/ct_b64.c"
       );
        goto err;
    }
    if (!SCT_set0_log_id(sct, dec, declen))
        goto err;
    dec = 
# 92 "../crypto/ct/ct_b64.c" 3 4
         ((void *)0)
# 92 "../crypto/ct/ct_b64.c"
             ;

    declen = ct_base64_decode(extensions_base64, &dec);
    if (declen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",96,__func__), ERR_set_error)((50),(118),
# 96 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 96 "../crypto/ct/ct_b64.c"
       );
        goto err;
    }
    SCT_set0_extensions(sct, dec, declen);
    dec = 
# 100 "../crypto/ct/ct_b64.c" 3 4
         ((void *)0)
# 100 "../crypto/ct/ct_b64.c"
             ;

    declen = ct_base64_decode(signature_base64, &dec);
    if (declen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",104,__func__), ERR_set_error)((50),(118),
# 104 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 104 "../crypto/ct/ct_b64.c"
       );
        goto err;
    }
    ...
    if (o2i_SCT_signature(sct, &p, declen) <= 0)
        goto err;
    CRYPTO_free(dec, "../crypto/ct/ct_b64.c", 111);
    dec = 
# 112 "../crypto/ct/ct_b64.c" 3 4
         ((void *)0)
# 112 "../crypto/ct/ct_b64.c"
             ;
 ...
 err:
    CRYPTO_free(dec, "../crypto/ct/ct_b64.c", 122);
    SCT_free(sct);
    return 
# 124 "../crypto/ct/ct_b64.c" 3 4
          ((void *)0)
# 124 "../crypto/ct/ct_b64.c"
              ;
}
...
# 137 "../crypto/ct/ct_b64.c" 3 4
                             ((void *)0)
# 137 "../crypto/ct/ct_b64.c"
                                 ;
    int pkey_der_len;
    const unsigned char *p;
    EVP_PKEY *pkey = 
# 140 "../crypto/ct/ct_b64.c" 3 4
                    ((void *)0)
# 140 "../crypto/ct/ct_b64.c"
                        ;

    if (ct_log == 
# 142 "../crypto/ct/ct_b64.c" 3 4
                 ((void *)0)
# 142 "../crypto/ct/ct_b64.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",143,__func__), ERR_set_error)((50),((262|(0x2 << 18L))),
# 143 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 143 "../crypto/ct/ct_b64.c"
       );
        return 0;
    }
    ...
    if (pkey_der_len < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",149,__func__), ERR_set_error)((50),(110),
# 149 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 149 "../crypto/ct/ct_b64.c"
       );
        return 0;
    }
    ...
    p = pkey_der;
    pkey = d2i_PUBKEY_ex(
# 154 "../crypto/ct/ct_b64.c" 3 4
                        ((void *)0)
# 154 "../crypto/ct/ct_b64.c"
                            , &p, pkey_der_len, libctx, propq);
    CRYPTO_free(pkey_der, "../crypto/ct/ct_b64.c", 155);
    if (pkey == 
# 156 "../crypto/ct/ct_b64.c" 3 4
               ((void *)0)
# 156 "../crypto/ct/ct_b64.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/ct/ct_b64.c",157,__func__), ERR_set_error)((50),(110),
# 157 "../crypto/ct/ct_b64.c" 3 4
       ((void *)0)
# 157 "../crypto/ct/ct_b64.c"
       );
        return 0;
    }
    ...
    *ct_log = CTLOG_new_ex(pkey, name, libctx, propq);
    if (*ct_log == 
# 162 "../crypto/ct/ct_b64.c" 3 4
                  ((void *)0)
# 162 "../crypto/ct/ct_b64.c"
                      ) {
        EVP_PKEY_free(pkey);
        return 0;
    }
...
int CTLOG_new_from_base64(CTLOG **ct_log, const char *pkey_base64,
                          const char *name)
{
    return CTLOG_new_from_base64_ex(ct_log, pkey_base64, name, 
# 173 "../crypto/ct/ct_b64.c" 3 4
                                                              ((void *)0)
# 173 "../crypto/ct/ct_b64.c"
                                                                  , 
# 173 "../crypto/ct/ct_b64.c" 3 4
                                                                    ((void *)0)
# 173 "../crypto/ct/ct_b64.c"
