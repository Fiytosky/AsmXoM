# 0 "../crypto/ct/ct_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ct/ct_prn.c"
# 14 "../crypto/ct/ct_prn.c"
...
static void timestamp_print(uint64_t timestamp, BIO *out)
{
    ...
    if (gen == 
# 34 "../crypto/ct/ct_prn.c" 3 4
              ((void *)0)
# 34 "../crypto/ct/ct_prn.c"
                  )
        return;
...
{
    const CTLOG *log = 
# 73 "../crypto/ct/ct_prn.c" 3 4
                      ((void *)0)
# 73 "../crypto/ct/ct_prn.c"
                          ;

    if (log_store != 
# 75 "../crypto/ct/ct_prn.c" 3 4
                    ((void *)0)
# 75 "../crypto/ct/ct_prn.c"
                        ) {
    ...
    if (log != 
# 91 "../crypto/ct/ct_prn.c" 3 4
              ((void *)0)
# 91 "../crypto/ct/ct_prn.c"
                  ) {
        BIO_printf(out, "\n%*sLog       : %s", indent + 4, "",
                   CTLOG_get0_name(log));
    }
...
{
    int sct_count = OPENSSL_sk_num(ossl_check_const_SCT_sk_type(sct_list));
    int i;

    for (i = 0; i < sct_count; ++i) {
        SCT *sct = ((SCT *)OPENSSL_sk_value(ossl_check_const_SCT_sk_type(sct_list), (i)));

        SCT_print(sct, out, indent, log_store);
        if (i < OPENSSL_sk_num(ossl_check_const_SCT_sk_type(sct_list)) - 1)
