# 0 "../crypto/des/qud_cksm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/des/qud_cksm.c"
# 21 "../crypto/des/qud_cksm.c"
...
# 24 "../crypto/des/qud_cksm.c" 2
# 34 "../crypto/des/qud_cksm.c"
DES_LONG DES_quad_cksum(const unsigned char *input, DES_cblock output[],
                        long length, int out_count, DES_cblock *seed)
{
    ...
    for (i = 0; ((i < 4) && (i < out_count)); i++) {
        ...
        if (lp != 
# 73 "../crypto/des/qud_cksm.c" 3 4
                 ((void *)0)
# 73 "../crypto/des/qud_cksm.c"
                     ) {
