# 0 "../crypto/des/set_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/des/set_key.c"
# 23 "../crypto/des/set_key.c"
...
# 27 "../crypto/des/set_key.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 28 "../crypto/des/set_key.c" 2
# 1 "../crypto/des/des_local.h" 1
# 19 "../crypto/des/des_local.h"
...
void DES_set_key_unchecked(const_DES_cblock *key, DES_key_schedule *schedule)
{
    ...
    for (i = 0; i < 16; i++) {
        ...
        *(k++) = ({ register unsigned int ret; asm ("rorl %1,%0" : "=r"(ret) : "I"(30),"0"(t2) : "cc"); ret; }) & 0xffffffffL;

        t2 = ((s >> 16L) | (t & 0xffff0000L));
        *(k++) = ({ register unsigned int ret; asm ("rorl %1,%0" : "=r"(ret) : "I"(26),"0"(t2) : "cc"); ret; }) & 0xffffffffL;
    }
}
