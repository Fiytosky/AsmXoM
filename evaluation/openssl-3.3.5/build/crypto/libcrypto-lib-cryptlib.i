...
# 13 "../crypto/cryptlib.c" 2
# 238 "../crypto/cryptlib.c"
void OPENSSL_showfatal(const char *fmta, ...)
{
...
# 243 "../crypto/cryptlib.c" 3 4
   __builtin_c23_va_start(
# 243 "../crypto/cryptlib.c"
   ap, fmta
# 243 "../crypto/cryptlib.c" 3 4
   )
# 243 "../crypto/cryptlib.c"
                     ;
    vfprintf(
# 244 "../crypto/cryptlib.c" 3 4
            stderr
# 244 "../crypto/cryptlib.c"
                  , fmta, ap);
    
# 245 "../crypto/cryptlib.c" 3 4
   __builtin_va_end(
# 245 "../crypto/cryptlib.c"
   ap
# 245 "../crypto/cryptlib.c" 3 4
   )
# 245 "../crypto/cryptlib.c"
