# 0 "../crypto/pkcs12/p12_mutl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_mutl.c"
# 14 "../crypto/pkcs12/p12_mutl.c"
                     ...
                     const PKCS12 *p12)
{
    if (p12->mac) {
        ...
        if (pmac)
            *pmac = 
# 43 "../crypto/pkcs12/p12_mutl.c" 3 4
                   ((void *)0)
# 43 "../crypto/pkcs12/p12_mutl.c"
                       ;
        if (pmacalg)
            *pmacalg = 
# 45 "../crypto/pkcs12/p12_mutl.c" 3 4
                      ((void *)0)
# 45 "../crypto/pkcs12/p12_mutl.c"
                          ;
        if (psalt)
            *psalt = 
# 47 "../crypto/pkcs12/p12_mutl.c" 3 4
                    ((void *)0)
# 47 "../crypto/pkcs12/p12_mutl.c"
                        ;
        if (piter)
            *piter = 
# 49 "../crypto/pkcs12/p12_mutl.c" 3 4
                    ((void *)0)
# 49 "../crypto/pkcs12/p12_mutl.c"
                        ;
    }
}
                                   ...
                                   const EVP_MD *digest)
{
    ...
    memcpy(key, out + sizeof(out) - 32, 32);
                                                ...
                                                const EVP_MD *md_type))
{
    ...
    EVP_MD *md_fetch;
    HMAC_CTX *hmac = 
# 87 "../crypto/pkcs12/p12_mutl.c" 3 4
                    ((void *)0)
# 87 "../crypto/pkcs12/p12_mutl.c"
                        ;
    ...
    if (!(OBJ_obj2nid((p12->authsafes)->type) == 21)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",97,__func__), ERR_set_error)((35),(121),
# 97 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 97 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }

    if (p12->authsafes->d.data == 
# 101 "../crypto/pkcs12/p12_mutl.c" 3 4
                                 ((void *)0)
# 101 "../crypto/pkcs12/p12_mutl.c"
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",102,__func__), ERR_set_error)((35),(101),
# 102 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 102 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    ...
    if (p12->mac->iter == 
# 108 "../crypto/pkcs12/p12_mutl.c" 3 4
                         ((void *)0)
# 108 "../crypto/pkcs12/p12_mutl.c"
                             )
        iter = 1;
    else
        iter = ASN1_INTEGER_get(p12->mac->iter);
    X509_SIG_get0(p12->mac->dinfo, &macalg, 
# 112 "../crypto/pkcs12/p12_mutl.c" 3 4
                                           ((void *)0)
# 112 "../crypto/pkcs12/p12_mutl.c"
                                               );
    X509_ALGOR_get0(&macoid, 
# 113 "../crypto/pkcs12/p12_mutl.c" 3 4
                            ((void *)0)
# 113 "../crypto/pkcs12/p12_mutl.c"
                                , 
# 113 "../crypto/pkcs12/p12_mutl.c" 3 4
                                  ((void *)0)
# 113 "../crypto/pkcs12/p12_mutl.c"
    ...
    if (md == 
# 120 "../crypto/pkcs12/p12_mutl.c" 3 4
             ((void *)0)
# 120 "../crypto/pkcs12/p12_mutl.c"
                 )
        md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(macoid)));

    if (md == 
# 123 "../crypto/pkcs12/p12_mutl.c" 3 4
             ((void *)0)
# 123 "../crypto/pkcs12/p12_mutl.c"
                 ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",125,__func__), ERR_set_error)((35),(118),
# 125 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 125 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    ...
    if ((md_nid == 809
         || md_nid == 982
         || md_nid == 983)
        && ossl_safe_getenv("LEGACY_GOST_PKCS12") == 
# 137 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                    ((void *)0)
# 137 "../crypto/pkcs12/p12_mutl.c"
                                                        ) {
        md_size = 32;
        if (!pkcs12_gen_gost_mac_key(pass, passlen, salt, saltlen, iter,
                                     md_size, key, md)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",141,__func__), ERR_set_error)((35),(107),
# 141 "../crypto/pkcs12/p12_mutl.c" 3 4
           ((void *)0)
# 141 "../crypto/pkcs12/p12_mutl.c"
           );
            goto err;
        }
    } else {
        if (pkcs12_key_gen != 
# 145 "../crypto/pkcs12/p12_mutl.c" 3 4
                             ((void *)0)
# 145 "../crypto/pkcs12/p12_mutl.c"
                                 ) {
            if (!(*pkcs12_key_gen)(pass, passlen, salt, saltlen, 3,
                                   iter, md_size, key, md)) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",148,__func__), ERR_set_error)((35),(107),
# 148 "../crypto/pkcs12/p12_mutl.c" 3 4
               ((void *)0)
# 148 "../crypto/pkcs12/p12_mutl.c"
               );
                goto err;
            }
        } else {

            if (!PKCS12_key_gen_utf8_ex(pass, passlen, salt, saltlen, 3,
                                       iter, md_size, key, md,
                                       p12->authsafes->ctx.libctx,
                                       p12->authsafes->ctx.propq)) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",157,__func__), ERR_set_error)((35),(107),
# 157 "../crypto/pkcs12/p12_mutl.c" 3 4
               ((void *)0)
# 157 "../crypto/pkcs12/p12_mutl.c"
               );
                goto err;
            }
        }
...
# 162 "../crypto/pkcs12/p12_mutl.c" 3 4
                                  ((void *)0)
        
# 163 "../crypto/pkcs12/p12_mutl.c"
       || !HMAC_Init_ex(hmac, key, md_size, md, 
# 163 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                ((void *)0)
# 163 "../crypto/pkcs12/p12_mutl.c"
                                                    )
...
# 181 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                          ((void *)0)
# 181 "../crypto/pkcs12/p12_mutl.c"
                                                              );
}
...
int PKCS12_verify_mac(PKCS12 *p12, const char *pass, int passlen)
{
    ...
    if (p12->mac == 
# 191 "../crypto/pkcs12/p12_mutl.c" 3 4
                   ((void *)0)
# 191 "../crypto/pkcs12/p12_mutl.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",192,__func__), ERR_set_error)((35),(108),
# 192 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 192 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    if (!pkcs12_gen_mac(p12, pass, passlen, mac, &maclen, 
# 195 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                         ((void *)0)
# 195 "../crypto/pkcs12/p12_mutl.c"
                                                             )) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",196,__func__), ERR_set_error)((35),(109),
# 196 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 196 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    X509_SIG_get0(p12->mac->dinfo, 
# 199 "../crypto/pkcs12/p12_mutl.c" 3 4
                                  ((void *)0)
# 199 "../crypto/pkcs12/p12_mutl.c"
                                      , &macoct);
                   ...
                   const EVP_MD *md_type)
{
    ...
    if (md_type == 
# 217 "../crypto/pkcs12/p12_mutl.c" 3 4
                  ((void *)0)
# 217 "../crypto/pkcs12/p12_mutl.c"
                      )

        md_type = EVP_sha256();
    if (!iter)
        iter = 2048;
    if (PKCS12_setup_mac(p12, iter, salt, saltlen, md_type) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",223,__func__), ERR_set_error)((35),(110),
# 223 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 223 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    ...
    if (!pkcs12_gen_mac(p12, pass, passlen, mac, &maclen, 
# 229 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                         ((void *)0)
# 229 "../crypto/pkcs12/p12_mutl.c"
                                                             )) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",230,__func__), ERR_set_error)((35),(109),
# 230 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 230 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    X509_SIG_getm(p12->mac->dinfo, 
# 233 "../crypto/pkcs12/p12_mutl.c" 3 4
                                  ((void *)0)
# 233 "../crypto/pkcs12/p12_mutl.c"
                                      , &macoct);
    if (!ASN1_OCTET_STRING_set(macoct, mac, maclen)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",235,__func__), ERR_set_error)((35),(111),
# 235 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 235 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
    return 1;
                     ...
                     const EVP_MD *md_type)
{
    ...
    p12->mac = 
# 248 "../crypto/pkcs12/p12_mutl.c" 3 4
              ((void *)0)
# 248 "../crypto/pkcs12/p12_mutl.c"
                  ;

    if ((p12->mac = PKCS12_MAC_DATA_new()) == 
# 250 "../crypto/pkcs12/p12_mutl.c" 3 4
                                             ((void *)0)
# 250 "../crypto/pkcs12/p12_mutl.c"
                                                 )
        return 0;
    if (iter > 1) {
        if ((p12->mac->iter = ASN1_INTEGER_new()) == 
# 253 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                    ((void *)0)
# 253 "../crypto/pkcs12/p12_mutl.c"
                                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",254,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 254 "../crypto/pkcs12/p12_mutl.c" 3 4
           ((void *)0)
# 254 "../crypto/pkcs12/p12_mutl.c"
           );
            return 0;
        }
        if (!ASN1_INTEGER_set(p12->mac->iter, iter)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",258,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 258 "../crypto/pkcs12/p12_mutl.c" 3 4
           ((void *)0)
# 258 "../crypto/pkcs12/p12_mutl.c"
           );
            return 0;
        }
    }
    if (saltlen == 0)
        ...
        return 0;
    if ((p12->mac->salt->data = CRYPTO_malloc(saltlen, "../crypto/pkcs12/p12_mutl.c", 266)) == 
# 266 "../crypto/pkcs12/p12_mutl.c" 3 4
                                                           ((void *)0)
# 266 "../crypto/pkcs12/p12_mutl.c"
                                                               )
        return 0;
    p12->mac->salt->length = saltlen;
    if (salt == 
# 269 "../crypto/pkcs12/p12_mutl.c" 3 4
               ((void *)0)
# 269 "../crypto/pkcs12/p12_mutl.c"
                   ) {
    ...
    X509_SIG_getm(p12->mac->dinfo, &macalg, 
# 276 "../crypto/pkcs12/p12_mutl.c" 3 4
                                           ((void *)0)
# 276 "../crypto/pkcs12/p12_mutl.c"
                                               );
    if (!X509_ALGOR_set0(macalg, OBJ_nid2obj(EVP_MD_get_type(md_type)),
                         5, 
# 278 "../crypto/pkcs12/p12_mutl.c" 3 4
                                     ((void *)0)
# 278 "../crypto/pkcs12/p12_mutl.c"
                                         )) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_mutl.c",279,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 279 "../crypto/pkcs12/p12_mutl.c" 3 4
       ((void *)0)
# 279 "../crypto/pkcs12/p12_mutl.c"
       );
        return 0;
    }
