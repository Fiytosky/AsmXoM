# 0 "../crypto/pkcs12/p12_add.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_add.c"
# 10 "../crypto/pkcs12/p12_add.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/pkcs12/p12_add.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/pkcs12/p12_add.c" 2
...
# 26 "../crypto/pkcs12/p12_add.c" 3 4
                                    ((void *)0)
# 26 "../crypto/pkcs12/p12_add.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",27,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 27 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 27 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 28 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 28 "../crypto/pkcs12/p12_add.c"
                  ;
    }
    bag->type = OBJ_nid2obj(nid1);
    if (!ASN1_item_pack(obj, it, &bag->value.octet)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",32,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 32 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 32 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
    if ((safebag = PKCS12_SAFEBAG_new()) == 
# 35 "../crypto/pkcs12/p12_add.c" 3 4
                                           ((void *)0)
# 35 "../crypto/pkcs12/p12_add.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",36,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 36 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 36 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
 ...
 err:
    ...
    return 
# 45 "../crypto/pkcs12/p12_add.c" 3 4
          ((void *)0)
# 45 "../crypto/pkcs12/p12_add.c"
              ;
}
...
PKCS7 *PKCS12_pack_p7data(struct stack_st_PKCS12_SAFEBAG *sk)
{
    ...
    if ((p7 = PKCS7_new()) == 
# 53 "../crypto/pkcs12/p12_add.c" 3 4
                             ((void *)0)
# 53 "../crypto/pkcs12/p12_add.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",54,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 54 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 54 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 55 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 55 "../crypto/pkcs12/p12_add.c"
                  ;
    }
    p7->type = OBJ_nid2obj(21);
    if ((p7->d.data = ASN1_OCTET_STRING_new()) == 
# 58 "../crypto/pkcs12/p12_add.c" 3 4
                                                 ((void *)0)
# 58 "../crypto/pkcs12/p12_add.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",59,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 59 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 59 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }

    if (!ASN1_item_pack(sk, (PKCS12_SAFEBAGS_it()), &p7->d.data)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",64,__func__), ERR_set_error)((35),(100),
# 64 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 64 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
    return p7;
 ...
 err:
    PKCS7_free(p7);
    return 
# 71 "../crypto/pkcs12/p12_add.c" 3 4
          ((void *)0)
# 71 "../crypto/pkcs12/p12_add.c"
              ;
}
...
struct stack_st_PKCS12_SAFEBAG *PKCS12_unpack_p7data(PKCS7 *p7)
{
    if (!(OBJ_obj2nid((p7)->type) == 21)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",78,__func__), ERR_set_error)((35),(121),
# 78 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 78 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 79 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 79 "../crypto/pkcs12/p12_add.c"
                  ;
    }

    if (p7->d.data == 
# 82 "../crypto/pkcs12/p12_add.c" 3 4
                     ((void *)0)
# 82 "../crypto/pkcs12/p12_add.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",83,__func__), ERR_set_error)((35),(101),
# 83 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 83 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 84 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 84 "../crypto/pkcs12/p12_add.c"
                  ;
    }

    return ASN1_item_unpack_ex(p7->d.data, (PKCS12_SAFEBAGS_it()),
...
# 101 "../crypto/pkcs12/p12_add.c" 3 4
                                ((void *)0)
# 101 "../crypto/pkcs12/p12_add.c"
                                    ;
    EVP_CIPHER *pbe_ciph_fetch = 
# 102 "../crypto/pkcs12/p12_add.c" 3 4
                                ((void *)0)
# 102 "../crypto/pkcs12/p12_add.c"
                                    ;

    if ((p7 = PKCS7_new_ex(ctx, propq)) == 
# 104 "../crypto/pkcs12/p12_add.c" 3 4
                                          ((void *)0)
# 104 "../crypto/pkcs12/p12_add.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",105,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 105 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 105 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 106 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 106 "../crypto/pkcs12/p12_add.c"
                  ;
    }
    if (!PKCS7_set_type(p7, 26)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",109,__func__), ERR_set_error)((35),(120),
# 109 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 109 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
    ...
    if (pbe_ciph == 
# 115 "../crypto/pkcs12/p12_add.c" 3 4
                   ((void *)0)
# 115 "../crypto/pkcs12/p12_add.c"
                       )
        pbe_ciph = EVP_get_cipherbyname(OBJ_nid2sn(pbe_nid));
    ERR_pop_to_mark();

    if (pbe_ciph != 
# 119 "../crypto/pkcs12/p12_add.c" 3 4
                   ((void *)0)
# 119 "../crypto/pkcs12/p12_add.c"
                       ) {
        pbe = PKCS5_pbe2_set_iv_ex(pbe_ciph, iter, salt, saltlen, 
# 120 "../crypto/pkcs12/p12_add.c" 3 4
                                                                 ((void *)0)
# 120 "../crypto/pkcs12/p12_add.c"
                                                                     , -1, ctx);
    } else {
    ...
    if (pbe == 
# 125 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 125 "../crypto/pkcs12/p12_add.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",126,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 126 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 126 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
    ...
    if (!(p7->d.encrypted->enc_data->enc_data =
          PKCS12_item_i2d_encrypt_ex(pbe, (PKCS12_SAFEBAGS_it()), pass,
                                     passlen, bags, 1, ctx, propq))) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",135,__func__), ERR_set_error)((35),(103),
# 135 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 135 "../crypto/pkcs12/p12_add.c"
       );
        goto err;
    }
 ...
 err:
    ...
    EVP_CIPHER_free(pbe_ciph_fetch);
    return 
# 145 "../crypto/pkcs12/p12_add.c" 3 4
          ((void *)0)
# 145 "../crypto/pkcs12/p12_add.c"
              ;
}
                             ...
                             struct stack_st_PKCS12_SAFEBAG *bags)
{
    return PKCS12_pack_p7encdata_ex(pbe_nid, pass, passlen, salt, saltlen,
                                    iter, bags, 
# 153 "../crypto/pkcs12/p12_add.c" 3 4
                                               ((void *)0)
# 153 "../crypto/pkcs12/p12_add.c"
                                                   , 
# 153 "../crypto/pkcs12/p12_add.c" 3 4
                                                     ((void *)0)
# 153 "../crypto/pkcs12/p12_add.c"
                                                  ...
                                                  int passlen)
{
    if (!(OBJ_obj2nid((p7)->type) == 26))
        return 
# 160 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 160 "../crypto/pkcs12/p12_add.c"
                  ;

    if (p7->d.encrypted == 
# 162 "../crypto/pkcs12/p12_add.c" 3 4
                          ((void *)0)
# 162 "../crypto/pkcs12/p12_add.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",163,__func__), ERR_set_error)((35),(101),
# 163 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 163 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 164 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 164 "../crypto/pkcs12/p12_add.c"
                  ;
    }
...
PKCS8_PRIV_KEY_INFO *PKCS12_decrypt_skey(const PKCS12_SAFEBAG *bag,
                                         const char *pass, int passlen)
{
    return PKCS12_decrypt_skey_ex(bag, pass, passlen, 
# 184 "../crypto/pkcs12/p12_add.c" 3 4
                                                     ((void *)0)
# 184 "../crypto/pkcs12/p12_add.c"
                                                         , 
# 184 "../crypto/pkcs12/p12_add.c" 3 4
                                                           ((void *)0)
# 184 "../crypto/pkcs12/p12_add.c"
...
struct stack_st_PKCS7 *PKCS12_unpack_authsafes(const PKCS12 *p12)
{
    struct stack_st_PKCS7 *p7s;
    PKCS7_CTX *p7ctx;
    PKCS7 *p7;
    int i;

    if (!(OBJ_obj2nid((p12->authsafes)->type) == 21)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",203,__func__), ERR_set_error)((35),(121),
# 203 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 203 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 204 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 204 "../crypto/pkcs12/p12_add.c"
                  ;
    }

    if (p12->authsafes->d.data == 
# 207 "../crypto/pkcs12/p12_add.c" 3 4
                                 ((void *)0)
# 207 "../crypto/pkcs12/p12_add.c"
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_add.c",208,__func__), ERR_set_error)((35),(101),
# 208 "../crypto/pkcs12/p12_add.c" 3 4
       ((void *)0)
# 208 "../crypto/pkcs12/p12_add.c"
       );
        return 
# 209 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 209 "../crypto/pkcs12/p12_add.c"
                  ;
    }
    ...
    if (p7s != 
# 217 "../crypto/pkcs12/p12_add.c" 3 4
              ((void *)0)
# 217 "../crypto/pkcs12/p12_add.c"
                  ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_sk_type(p7s)); i++) {
            p7 = ((PKCS7 *)OPENSSL_sk_value(ossl_check_const_PKCS7_sk_type(p7s), (i)));
    ...
    return p7s;
err:
    OPENSSL_sk_free(ossl_check_PKCS7_sk_type(p7s));
    return 
# 227 "../crypto/pkcs12/p12_add.c" 3 4
          ((void *)0)
# 227 "../crypto/pkcs12/p12_add.c"
              ;
}
