# 0 "../crypto/pkcs12/p12_asn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_asn.c"
# 10 "../crypto/pkcs12/p12_asn.c"
...
# 14 "../crypto/pkcs12/p12_asn.c" 2
# 1 "../crypto/pkcs12/p12_local.h" 1
# 10 "../crypto/pkcs12/p12_local.h"
...
# 16 "../crypto/pkcs12/p12_asn.c" 2



static const ASN1_TEMPLATE PKCS12_seq_tt[] = {
        { (0), (0), 
# 20 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 20 "../crypto/pkcs12/p12_asn.c"
       PKCS12
# 20 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 20 "../crypto/pkcs12/p12_asn.c"
...
# 20 "../crypto/pkcs12/p12_asn.c"
       , "version", (ASN1_INTEGER_it) },
        { (0), (0), 
# 21 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 21 "../crypto/pkcs12/p12_asn.c"
       PKCS12
# 21 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 21 "../crypto/pkcs12/p12_asn.c"
...
# 21 "../crypto/pkcs12/p12_asn.c"
       , "authsafes", (PKCS7_it) },
        { ((0x1)), (0), 
# 22 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 22 "../crypto/pkcs12/p12_asn.c"
       PKCS12
# 22 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 22 "../crypto/pkcs12/p12_asn.c"
...
# 22 "../crypto/pkcs12/p12_asn.c"
       , "mac", (PKCS12_MAC_DATA_it) }
} ; const ASN1_ITEM * PKCS12_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKCS12_seq_tt, sizeof(PKCS12_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 23 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0)
# 23 "../crypto/pkcs12/p12_asn.c"
 , sizeof(PKCS12), "PKCS12" }; return &local_it; }

PKCS12 *d2i_PKCS12(PKCS12 **a, const unsigned char **in, long len) { return (PKCS12 *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKCS12_it())); } int i2d_PKCS12(const PKCS12 *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKCS12_it())); }
...
{
    if (p12 != 
# 34 "../crypto/pkcs12/p12_asn.c" 3 4
              ((void *)0) 
# 34 "../crypto/pkcs12/p12_asn.c"
                   && p12->authsafes != 
# 34 "../crypto/pkcs12/p12_asn.c" 3 4
                                        ((void *)0)
# 34 "../crypto/pkcs12/p12_asn.c"
                                            ) {
        CRYPTO_free(p12->authsafes->ctx.propq, "../crypto/pkcs12/p12_asn.c", 35);
        p12->authsafes->ctx.propq = 
# 36 "../crypto/pkcs12/p12_asn.c" 3 4
                                   ((void *)0)
# 36 "../crypto/pkcs12/p12_asn.c"
                                       ;
    }
    ASN1_item_free((ASN1_VALUE *)p12, (PKCS12_it()));
}

static const ASN1_TEMPLATE PKCS12_MAC_DATA_seq_tt[] = {
        { (0), (0), 
# 42 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 42 "../crypto/pkcs12/p12_asn.c"
       PKCS12_MAC_DATA
# 42 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 42 "../crypto/pkcs12/p12_asn.c"
...
# 42 "../crypto/pkcs12/p12_asn.c"
       , "dinfo", (X509_SIG_it) },
        { (0), (0), 
# 43 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 43 "../crypto/pkcs12/p12_asn.c"
       PKCS12_MAC_DATA
# 43 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 43 "../crypto/pkcs12/p12_asn.c"
...
# 43 "../crypto/pkcs12/p12_asn.c"
       , "salt", (ASN1_OCTET_STRING_it) },
        { ((0x1)), (0), 
# 44 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 44 "../crypto/pkcs12/p12_asn.c"
       PKCS12_MAC_DATA
# 44 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 44 "../crypto/pkcs12/p12_asn.c"
...
} ; const ASN1_ITEM * PKCS12_MAC_DATA_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKCS12_MAC_DATA_seq_tt, sizeof(PKCS12_MAC_DATA_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 45 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0)
# 45 "../crypto/pkcs12/p12_asn.c"
 , sizeof(PKCS12_MAC_DATA), "PKCS12_MAC_DATA" }; return &local_it; }

PKCS12_MAC_DATA *d2i_PKCS12_MAC_DATA(PKCS12_MAC_DATA **a, const unsigned char **in, long len) { return (PKCS12_MAC_DATA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKCS12_MAC_DATA_it())); } int i2d_PKCS12_MAC_DATA(const PKCS12_MAC_DATA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKCS12_MAC_DATA_it())); } PKCS12_MAC_DATA *PKCS12_MAC_DATA_new(void) { return (PKCS12_MAC_DATA *)ASN1_item_new((PKCS12_MAC_DATA_it())); } void PKCS12_MAC_DATA_free(PKCS12_MAC_DATA *a) { ASN1_item_free((ASN1_VALUE *)a, (PKCS12_MAC_DATA_it())); }

static const ASN1_TEMPLATE bag_default_tt = { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 49 "../crypto/pkcs12/p12_asn.c" 3 4
                                __builtin_offsetof (
# 49 "../crypto/pkcs12/p12_asn.c"
                                PKCS12_BAGS
# 49 "../crypto/pkcs12/p12_asn.c" 3 4
                                , 
# 49 "../crypto/pkcs12/p12_asn.c"
...
static const ASN1_ADB_TABLE PKCS12_BAGS_adbtbl[] = {
        {158, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 52 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 52 "../crypto/pkcs12/p12_asn.c"
       PKCS12_BAGS
# 52 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 52 "../crypto/pkcs12/p12_asn.c"
...
# 52 "../crypto/pkcs12/p12_asn.c"
       , "value.x509cert", (ASN1_OCTET_STRING_it) }},
        {160, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 53 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 53 "../crypto/pkcs12/p12_asn.c"
       PKCS12_BAGS
# 53 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 53 "../crypto/pkcs12/p12_asn.c"
...
# 53 "../crypto/pkcs12/p12_asn.c"
       , "value.x509crl", (ASN1_OCTET_STRING_it) }},
        {159, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 54 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 54 "../crypto/pkcs12/p12_asn.c"
       PKCS12_BAGS
# 54 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 54 "../crypto/pkcs12/p12_asn.c"
...
# 54 "../crypto/pkcs12/p12_asn.c"
       , "value.sdsicert", (ASN1_IA5STRING_it) }},
} ; static const ASN1_ITEM *PKCS12_BAGS_adb(void) { static const ASN1_ADB internal_adb = { 0, 
# 55 "../crypto/pkcs12/p12_asn.c" 3 4
 __builtin_offsetof (
# 55 "../crypto/pkcs12/p12_asn.c"
 PKCS12_BAGS
# 55 "../crypto/pkcs12/p12_asn.c" 3 4
 , 
# 55 "../crypto/pkcs12/p12_asn.c"
...
# 55 "../crypto/pkcs12/p12_asn.c"
 , 0, PKCS12_BAGS_adbtbl, sizeof(PKCS12_BAGS_adbtbl) / sizeof(ASN1_ADB_TABLE), &bag_default_tt, 
# 55 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0) 
# 55 "../crypto/pkcs12/p12_asn.c"
...
static const ASN1_TEMPLATE PKCS12_BAGS_seq_tt[] = {
        { (0), (0), 
# 58 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 58 "../crypto/pkcs12/p12_asn.c"
       PKCS12_BAGS
# 58 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 58 "../crypto/pkcs12/p12_asn.c"
...
# 58 "../crypto/pkcs12/p12_asn.c"
       , "type", (ASN1_OBJECT_it) },
        { (0x1<<8), -1, 0, "PKCS12_BAGS", PKCS12_BAGS_adb },
} ; const ASN1_ITEM * PKCS12_BAGS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKCS12_BAGS_seq_tt, sizeof(PKCS12_BAGS_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 60 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0)
# 60 "../crypto/pkcs12/p12_asn.c"
 , sizeof(PKCS12_BAGS), "PKCS12_BAGS" }; return &local_it; }

PKCS12_BAGS *d2i_PKCS12_BAGS(PKCS12_BAGS **a, const unsigned char **in, long len) { return (PKCS12_BAGS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKCS12_BAGS_it())); } int i2d_PKCS12_BAGS(const PKCS12_BAGS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKCS12_BAGS_it())); } PKCS12_BAGS *PKCS12_BAGS_new(void) { return (PKCS12_BAGS *)ASN1_item_new((PKCS12_BAGS_it())); } void PKCS12_BAGS_free(PKCS12_BAGS *a) { ASN1_item_free((ASN1_VALUE *)a, (PKCS12_BAGS_it())); }

static const ASN1_TEMPLATE safebag_default_tt = { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 64 "../crypto/pkcs12/p12_asn.c" 3 4
                                    __builtin_offsetof (
# 64 "../crypto/pkcs12/p12_asn.c"
                                    PKCS12_SAFEBAG
# 64 "../crypto/pkcs12/p12_asn.c" 3 4
                                    , 
# 64 "../crypto/pkcs12/p12_asn.c"
...
static const ASN1_ADB_TABLE PKCS12_SAFEBAG_adbtbl[] = {
        {150, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 67 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 67 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 67 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 67 "../crypto/pkcs12/p12_asn.c"
...
# 67 "../crypto/pkcs12/p12_asn.c"
       , "value.keybag", (PKCS8_PRIV_KEY_INFO_it) }},
        {151, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 68 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 68 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 68 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 68 "../crypto/pkcs12/p12_asn.c"
...
# 68 "../crypto/pkcs12/p12_asn.c"
       , "value.shkeybag", (X509_SIG_it) }},
        {155, { (((0x2 << 3)|(0x2<<6)) | ((0x2 << 1))), (0), 
# 69 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 69 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 69 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 69 "../crypto/pkcs12/p12_asn.c"
...
# 69 "../crypto/pkcs12/p12_asn.c"
       , "value.safes", (PKCS12_SAFEBAG_it) }},
        {152, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 70 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 70 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 70 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 70 "../crypto/pkcs12/p12_asn.c"
...
# 70 "../crypto/pkcs12/p12_asn.c"
       , "value.bag", (PKCS12_BAGS_it) }},
        {153, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 71 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 71 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 71 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 71 "../crypto/pkcs12/p12_asn.c"
...
# 71 "../crypto/pkcs12/p12_asn.c"
       , "value.bag", (PKCS12_BAGS_it) }},
        {154, { (((0x2 << 3)|(0x2<<6)) | (0)), (0), 
# 72 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 72 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 72 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 72 "../crypto/pkcs12/p12_asn.c"
...
# 72 "../crypto/pkcs12/p12_asn.c"
       , "value.bag", (PKCS12_BAGS_it) }}
} ; static const ASN1_ITEM *PKCS12_SAFEBAG_adb(void) { static const ASN1_ADB internal_adb = { 0, 
# 73 "../crypto/pkcs12/p12_asn.c" 3 4
 __builtin_offsetof (
# 73 "../crypto/pkcs12/p12_asn.c"
 PKCS12_SAFEBAG
# 73 "../crypto/pkcs12/p12_asn.c" 3 4
 , 
# 73 "../crypto/pkcs12/p12_asn.c"
...
# 73 "../crypto/pkcs12/p12_asn.c"
 , 0, PKCS12_SAFEBAG_adbtbl, sizeof(PKCS12_SAFEBAG_adbtbl) / sizeof(ASN1_ADB_TABLE), &safebag_default_tt, 
# 73 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0) 
# 73 "../crypto/pkcs12/p12_asn.c"
 }; return (const ASN1_ITEM *) &internal_adb; } void dummy_function(void);
...
static const ASN1_TEMPLATE PKCS12_SAFEBAG_seq_tt[] = {
        { (0), (0), 
# 76 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 76 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 76 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 76 "../crypto/pkcs12/p12_asn.c"
...
# 76 "../crypto/pkcs12/p12_asn.c"
       , "type", (ASN1_OBJECT_it) },
        { (0x1<<8), -1, 0, "PKCS12_SAFEBAG", PKCS12_SAFEBAG_adb },
        { ((0x1 << 1)|(0x1)), (0), 
# 78 "../crypto/pkcs12/p12_asn.c" 3 4
       __builtin_offsetof (
# 78 "../crypto/pkcs12/p12_asn.c"
       PKCS12_SAFEBAG
# 78 "../crypto/pkcs12/p12_asn.c" 3 4
       , 
# 78 "../crypto/pkcs12/p12_asn.c"
...
# 78 "../crypto/pkcs12/p12_asn.c"
       , "attrib", (X509_ATTRIBUTE_it) }
} ; const ASN1_ITEM * PKCS12_SAFEBAG_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, PKCS12_SAFEBAG_seq_tt, sizeof(PKCS12_SAFEBAG_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 79 "../crypto/pkcs12/p12_asn.c" 3 4
 ((void *)0)
# 79 "../crypto/pkcs12/p12_asn.c"
 , sizeof(PKCS12_SAFEBAG), "PKCS12_SAFEBAG" }; return &local_it; }

PKCS12_SAFEBAG *d2i_PKCS12_SAFEBAG(PKCS12_SAFEBAG **a, const unsigned char **in, long len) { return (PKCS12_SAFEBAG *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (PKCS12_SAFEBAG_it())); } int i2d_PKCS12_SAFEBAG(const PKCS12_SAFEBAG *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (PKCS12_SAFEBAG_it())); } PKCS12_SAFEBAG *PKCS12_SAFEBAG_new(void) { return (PKCS12_SAFEBAG *)ASN1_item_new((PKCS12_SAFEBAG_it())); } void PKCS12_SAFEBAG_free(PKCS12_SAFEBAG *a) { ASN1_item_free((ASN1_VALUE *)a, (PKCS12_SAFEBAG_it())); }


static const ASN1_TEMPLATE PKCS12_SAFEBAGS_item_tt =
        { ((0x2 << 1)), (0), 0, "PKCS12_SAFEBAGS", (PKCS12_SAFEBAG_it) }
; const ASN1_ITEM * PKCS12_SAFEBAGS_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &PKCS12_SAFEBAGS_item_tt, 0, 
# 86 "../crypto/pkcs12/p12_asn.c" 3 4
((void *)0)
# 86 "../crypto/pkcs12/p12_asn.c"
, 0, "PKCS12_SAFEBAGS" }; return &local_it; }


static const ASN1_TEMPLATE PKCS12_AUTHSAFES_item_tt =
        { ((0x2 << 1)), (0), 0, "PKCS12_AUTHSAFES", (PKCS7_it) }
; const ASN1_ITEM * PKCS12_AUTHSAFES_it(void) { static const ASN1_ITEM local_it = { 0x0, -1, &PKCS12_AUTHSAFES_item_tt, 0, 
# 91 "../crypto/pkcs12/p12_asn.c" 3 4
((void *)0)
# 91 "../crypto/pkcs12/p12_asn.c"
, 0, "PKCS12_AUTHSAFES" }; return &local_it; }
