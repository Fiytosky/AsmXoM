...
static int pkcs12_add_bag(struct stack_st_PKCS12_SAFEBAG **pbags,
                          PKCS12_SAFEBAG *bag);
static int pkcs12_remove_bag(struct stack_st_PKCS12_SAFEBAG **pbags,
                             PKCS12_SAFEBAG *bag);
static PKCS12_SAFEBAG *pkcs12_add_cert_bag(struct stack_st_PKCS12_SAFEBAG **pbags,
                                           X509 *cert,
                                           const char *name,
                                           int namelen,
                                           unsigned char *keyid,
...
static int copy_bag_attr(PKCS12_SAFEBAG *bag, EVP_PKEY *pkey, int nid)
{
    ...
    if (idx < 0)
        return 1;
    return X509at_add1_attr(&bag->attrib, EVP_PKEY_get_attr(pkey, idx)) != 
# 32 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                          ((void *)0)
# 32 "../crypto/pkcs12/p12_crt.c"
                                                                              ;
}
...
{
    PKCS12 *p12 = 
# 41 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 41 "../crypto/pkcs12/p12_crt.c"
                     ;
    struct stack_st_PKCS7 *safes = 
# 42 "../crypto/pkcs12/p12_crt.c" 3 4
                            ((void *)0)
# 42 "../crypto/pkcs12/p12_crt.c"
                                ;
    struct stack_st_PKCS12_SAFEBAG *bags = 
# 43 "../crypto/pkcs12/p12_crt.c" 3 4
                                    ((void *)0)
# 43 "../crypto/pkcs12/p12_crt.c"
                                        ;
    PKCS12_SAFEBAG *bag = 
# 44 "../crypto/pkcs12/p12_crt.c" 3 4
                         ((void *)0)
# 44 "../crypto/pkcs12/p12_crt.c"
                             ;
    int i, cbret;
...
# 49 "../crypto/pkcs12/p12_crt.c" 3 4
                           ((void *)0)
# 49 "../crypto/pkcs12/p12_crt.c"
                               ;
    int pkeyidlen = -1;
    ...
    if (pkey == 
# 62 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0) 
# 62 "../crypto/pkcs12/p12_crt.c"
                    && cert == 
# 62 "../crypto/pkcs12/p12_crt.c" 3 4
                               ((void *)0) 
# 62 "../crypto/pkcs12/p12_crt.c"
...
# 62 "../crypto/pkcs12/p12_crt.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crt.c",63,__func__), ERR_set_error)((35),(104),
# 63 "../crypto/pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 63 "../crypto/pkcs12/p12_crt.c"
       );
        return 
# 64 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0)
# 64 "../crypto/pkcs12/p12_crt.c"
                  ;
    }
    ...
    if (pkey && cert) {
        if (!X509_check_private_key(cert, pkey))
            return 
# 69 "../crypto/pkcs12/p12_crt.c" 3 4
                  ((void *)0)
# 69 "../crypto/pkcs12/p12_crt.c"
                      ;
        if (!X509_digest(cert, EVP_sha1(), keyid, &keyidlen))
            return 
# 71 "../crypto/pkcs12/p12_crt.c" 3 4
                  ((void *)0)
# 71 "../crypto/pkcs12/p12_crt.c"
                      ;
    }

    if (cert) {
        if (name == 
# 75 "../crypto/pkcs12/p12_crt.c" 3 4
                   ((void *)0)
# 75 "../crypto/pkcs12/p12_crt.c"
                       )
        ...
        if (cb != 
# 85 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 85 "../crypto/pkcs12/p12_crt.c"
                     ) {
            cbret = cb(bag, cbarg);
            if (cbret == -1) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crt.c",88,__func__), ERR_set_error)((35),(115),
# 88 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0)
# 88 "../crypto/pkcs12/p12_crt.c"
               );
                goto err;
            } else if (cbret == 0) {
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(ca)); i++) {
        if ((bag = PKCS12_add_cert(&bags, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(ca), (i))))) == 
# 98 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                   ((void *)0)
# 98 "../crypto/pkcs12/p12_crt.c"
                                                                       )
            goto err;
        if (cb != 
# 100 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 100 "../crypto/pkcs12/p12_crt.c"
                     ) {
            cbret = cb(bag, cbarg);
            if (cbret == -1) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crt.c",103,__func__), ERR_set_error)((35),(115),
# 103 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0)
# 103 "../crypto/pkcs12/p12_crt.c"
               );
                goto err;
            } else if (cbret == 0) {
                pkcs12_remove_bag(&bags, bag);
    ...
    bags = 
# 116 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 116 "../crypto/pkcs12/p12_crt.c"
              ;
    ...
    if (pkey) {
        ...
        if (name && !PKCS12_add_friendlyname_utf8(bag, name, -1))
            goto err;
        if (keyidlen && !PKCS12_add_localkeyid(bag, keyid, keyidlen))
            goto err;
        if (cb != 
# 134 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 134 "../crypto/pkcs12/p12_crt.c"
                     ) {
            cbret = cb(bag, cbarg);
            if (cbret == -1) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crt.c",137,__func__), ERR_set_error)((35),(115),
# 137 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0)
# 137 "../crypto/pkcs12/p12_crt.c"
               );
                goto err;
            } else if (cbret == 0) {
                pkcs12_remove_bag(&bags, bag);
...
# 145 "../crypto/pkcs12/p12_crt.c" 3 4
                                                     ((void *)0)
# 145 "../crypto/pkcs12/p12_crt.c"
                                                         ))
        goto err;

    OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    bags = 
# 149 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 149 "../crypto/pkcs12/p12_crt.c"
              ;

    p12 = PKCS12_add_safes_ex(safes, 0, ctx, propq);

    if (p12 == 
# 153 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0)
# 153 "../crypto/pkcs12/p12_crt.c"
                  )
        goto err;

    OPENSSL_sk_pop_free(ossl_check_PKCS7_sk_type(safes),ossl_check_PKCS7_freefunc_type(PKCS7_free));

    safes = 
# 158 "../crypto/pkcs12/p12_crt.c" 3 4
           ((void *)0)
# 158 "../crypto/pkcs12/p12_crt.c"
               ;

    if ((mac_iter != -1) &&
        !PKCS12_set_mac(p12, pass, -1, 
# 161 "../crypto/pkcs12/p12_crt.c" 3 4
                                      ((void *)0)
# 161 "../crypto/pkcs12/p12_crt.c"
                                          , 0, mac_iter, 
# 161 "../crypto/pkcs12/p12_crt.c" 3 4
                                                         ((void *)0)
# 161 "../crypto/pkcs12/p12_crt.c"
 ...
 err:
    ...
    OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
    return 
# 170 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 170 "../crypto/pkcs12/p12_crt.c"
              ;
...
# 181 "../crypto/pkcs12/p12_crt.c" 3 4
                            ((void *)0)
# 181 "../crypto/pkcs12/p12_crt.c"
                                , 
# 181 "../crypto/pkcs12/p12_crt.c" 3 4
                                  ((void *)0)
# 181 "../crypto/pkcs12/p12_crt.c"
                      ...
                      int mac_iter, int keytype)
{
    return PKCS12_create_ex(pass, name, pkey, cert, ca, nid_key, nid_cert,
                            iter, mac_iter, keytype, 
# 189 "../crypto/pkcs12/p12_crt.c" 3 4
                                                    ((void *)0)
# 189 "../crypto/pkcs12/p12_crt.c"
                                                        , 
# 189 "../crypto/pkcs12/p12_crt.c" 3 4
                                                          ((void *)0)
# 189 "../crypto/pkcs12/p12_crt.c"
...
{
    PKCS12_SAFEBAG *bag = 
# 199 "../crypto/pkcs12/p12_crt.c" 3 4
                         ((void *)0)
# 199 "../crypto/pkcs12/p12_crt.c"
                             ;


    if ((bag = PKCS12_SAFEBAG_create_cert(cert)) == 
# 202 "../crypto/pkcs12/p12_crt.c" 3 4
                                                   ((void *)0)
# 202 "../crypto/pkcs12/p12_crt.c"
                                                       )
        goto err;

    if (name != 
# 205 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0) 
# 205 "../crypto/pkcs12/p12_crt.c"
                    && !PKCS12_add_friendlyname_utf8(bag, name, namelen))
        goto err;

    if (keyid != 
# 208 "../crypto/pkcs12/p12_crt.c" 3 4
                ((void *)0) 
# 208 "../crypto/pkcs12/p12_crt.c"
 ...
 err:
    ...
    return 
# 218 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 218 "../crypto/pkcs12/p12_crt.c"
              ;
}
...
{
    char *name = 
# 223 "../crypto/pkcs12/p12_crt.c" 3 4
                ((void *)0)
# 223 "../crypto/pkcs12/p12_crt.c"
                    ;
    int namelen = -1;
    unsigned char *keyid = 
# 225 "../crypto/pkcs12/p12_crt.c" 3 4
                          ((void *)0)
# 225 "../crypto/pkcs12/p12_crt.c"
                              ;
    int keyidlen = -1;
                                  ...
                                  OSSL_LIB_CTX *ctx, const char *propq)
{
    ...
    PKCS12_SAFEBAG *bag = 
# 243 "../crypto/pkcs12/p12_crt.c" 3 4
                         ((void *)0)
# 243 "../crypto/pkcs12/p12_crt.c"
                             ;
    PKCS8_PRIV_KEY_INFO *p8 = 
# 244 "../crypto/pkcs12/p12_crt.c" 3 4
                             ((void *)0)
# 244 "../crypto/pkcs12/p12_crt.c"
                                 ;


    if ((p8 = EVP_PKEY2PKCS8(key)) == 
# 247 "../crypto/pkcs12/p12_crt.c" 3 4
                                     ((void *)0)
# 247 "../crypto/pkcs12/p12_crt.c"
                                         )
        goto err;
    ...
    if (nid_key != -1) {
        ...
        bag = PKCS12_SAFEBAG_create_pkcs8_encrypt_ex(nid_key, pass, -1, 
# 255 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                       ((void *)0)
# 255 "../crypto/pkcs12/p12_crt.c"
                                                                           , 0,
                                                     iter, p8, ctx, propq);
    } else {
        bag = PKCS12_SAFEBAG_create0_p8inf(p8);
        if (bag != 
# 259 "../crypto/pkcs12/p12_crt.c" 3 4
                  ((void *)0)
# 259 "../crypto/pkcs12/p12_crt.c"
                      )
           p8 = 
# 260 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0)
# 260 "../crypto/pkcs12/p12_crt.c"
                   ;
    }

    if (p8 != 
# 263 "../crypto/pkcs12/p12_crt.c" 3 4
             ((void *)0)
# 263 "../crypto/pkcs12/p12_crt.c"
                 )
        PKCS8_PRIV_KEY_INFO_free(p8);

    if (bag == 
# 266 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0) 
# 266 "../crypto/pkcs12/p12_crt.c"
                   || !pkcs12_add_bag(pbags, bag))
        goto err;
 ...
 err:
    PKCS12_SAFEBAG_free(bag);
    return 
# 273 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 273 "../crypto/pkcs12/p12_crt.c"
              ;
...
# 282 "../crypto/pkcs12/p12_crt.c" 3 4
                            ((void *)0)
# 282 "../crypto/pkcs12/p12_crt.c"
                                , 
# 282 "../crypto/pkcs12/p12_crt.c" 3 4
                                  ((void *)0)
# 282 "../crypto/pkcs12/p12_crt.c"
...
{
    PKCS12_SAFEBAG *bag = 
# 288 "../crypto/pkcs12/p12_crt.c" 3 4
                         ((void *)0)
# 288 "../crypto/pkcs12/p12_crt.c"
                             ;


    if ((bag = PKCS12_SAFEBAG_create_secret(nid_type, 4, value, len)) == 
# 291 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                                          ((void *)0)
# 291 "../crypto/pkcs12/p12_crt.c"
                                                                                              )
        goto err;
 ...
 err:
    PKCS12_SAFEBAG_free(bag);
    return 
# 300 "../crypto/pkcs12/p12_crt.c" 3 4
          ((void *)0)
# 300 "../crypto/pkcs12/p12_crt.c"
              ;
}
...
{
    PKCS7 *p7 = 
# 307 "../crypto/pkcs12/p12_crt.c" 3 4
               ((void *)0)
# 307 "../crypto/pkcs12/p12_crt.c"
                   ;
    int free_safes = 0;

    if (*psafes == 
# 310 "../crypto/pkcs12/p12_crt.c" 3 4
                  ((void *)0)
# 310 "../crypto/pkcs12/p12_crt.c"
                      ) {
        *psafes = ((struct stack_st_PKCS7 *)OPENSSL_sk_new_null());
        if (*psafes == 
# 312 "../crypto/pkcs12/p12_crt.c" 3 4
                      ((void *)0)
# 312 "../crypto/pkcs12/p12_crt.c"
                          )
            return 0;
        free_safes = 1;
    }
    ...
    if (nid_safe == -1)
        ...
        p7 = PKCS12_pack_p7encdata_ex(nid_safe, pass, -1, 
# 327 "../crypto/pkcs12/p12_crt.c" 3 4
                                                         ((void *)0)
# 327 "../crypto/pkcs12/p12_crt.c"
                                                             , 0, iter, bags, ctx, propq);
    if (p7 == 
# 328 "../crypto/pkcs12/p12_crt.c" 3 4
             ((void *)0)
# 328 "../crypto/pkcs12/p12_crt.c"
                 )
        goto err;

    if (!OPENSSL_sk_push(ossl_check_PKCS7_sk_type(*psafes), ossl_check_PKCS7_type(p7)))
        goto err;
 ...
 err:
    if (free_safes) {
        OPENSSL_sk_free(ossl_check_PKCS7_sk_type(*psafes));
        *psafes = 
# 339 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 339 "../crypto/pkcs12/p12_crt.c"
                     ;
    }
    PKCS7_free(p7);
    return 0;
...
int PKCS12_add_safe(struct stack_st_PKCS7 **psafes, struct stack_st_PKCS12_SAFEBAG *bags,
                    int nid_safe, int iter, const char *pass)
{
    return PKCS12_add_safe_ex(psafes, bags, nid_safe, iter, pass, 
# 348 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                 ((void *)0)
# 348 "../crypto/pkcs12/p12_crt.c"
                                                                     , 
# 348 "../crypto/pkcs12/p12_crt.c" 3 4
                                                                       ((void *)0)
# 348 "../crypto/pkcs12/p12_crt.c"
                             ...
                             PKCS12_SAFEBAG *bag)
{
    ...
    if (pbags == 
# 357 "../crypto/pkcs12/p12_crt.c" 3 4
                ((void *)0) 
# 357 "../crypto/pkcs12/p12_crt.c"
                     || bag == 
# 357 "../crypto/pkcs12/p12_crt.c" 3 4
                               ((void *)0)
# 357 "../crypto/pkcs12/p12_crt.c"
    ...
    if ((tmp = ((PKCS12_SAFEBAG *)OPENSSL_sk_delete_ptr(ossl_check_PKCS12_SAFEBAG_sk_type(*pbags), ossl_check_PKCS12_SAFEBAG_type(bag)))) == 
# 360 "../crypto/pkcs12/p12_crt.c" 3 4
                                                            ((void *)0)
# 360 "../crypto/pkcs12/p12_crt.c"
                                                                )
        return 0;
                          ...
                          PKCS12_SAFEBAG *bag)
{
    ...
    if (pbags == 
# 372 "../crypto/pkcs12/p12_crt.c" 3 4
                ((void *)0)
# 372 "../crypto/pkcs12/p12_crt.c"
                    )
        return 1;
    if (*pbags == 
# 374 "../crypto/pkcs12/p12_crt.c" 3 4
                 ((void *)0)
# 374 "../crypto/pkcs12/p12_crt.c"
                     ) {
        *pbags = ((struct stack_st_PKCS12_SAFEBAG *)OPENSSL_sk_new_null());
        if (*pbags == 
# 376 "../crypto/pkcs12/p12_crt.c" 3 4
                     ((void *)0)
# 376 "../crypto/pkcs12/p12_crt.c"
                         )
            return 0;
        free_bags = 1;
    }
    ...
    if (!OPENSSL_sk_push(ossl_check_PKCS12_SAFEBAG_sk_type(*pbags), ossl_check_PKCS12_SAFEBAG_type(bag))) {
        if (free_bags) {
            ...
            *pbags = 
# 384 "../crypto/pkcs12/p12_crt.c" 3 4
                    ((void *)0)
# 384 "../crypto/pkcs12/p12_crt.c"
                        ;
        }
        return 0;
    }
...
PKCS12 *PKCS12_add_safes_ex(struct stack_st_PKCS7 *safes, int nid_p7,
                            OSSL_LIB_CTX *ctx, const char *propq)
{
    PKCS12 *p12;
    ...
    if (p12 == 
# 401 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0)
# 401 "../crypto/pkcs12/p12_crt.c"
                  )
        return 
# 402 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0)
# 402 "../crypto/pkcs12/p12_crt.c"
                  ;

    if (!PKCS12_pack_authsafes(p12, safes)) {
        PKCS12_free(p12);
        return 
# 406 "../crypto/pkcs12/p12_crt.c" 3 4
              ((void *)0)
...
PKCS12 *PKCS12_add_safes(struct stack_st_PKCS7 *safes, int nid_p7)
{
    return PKCS12_add_safes_ex(safes, nid_p7, 
# 415 "../crypto/pkcs12/p12_crt.c" 3 4
                                             ((void *)0)
# 415 "../crypto/pkcs12/p12_crt.c"
                                                 , 
# 415 "../crypto/pkcs12/p12_crt.c" 3 4
                                                   ((void *)0)
# 415 "../crypto/pkcs12/p12_crt.c"
