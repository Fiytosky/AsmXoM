# 0 "../crypto/pkcs12/p12_npas.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_npas.c"
# 10 "../crypto/pkcs12/p12_npas.c"
...
int PKCS12_newpass(PKCS12 *p12, const char *oldpass, const char *newpass)
{
    ...
    if (p12 == 
# 38 "../crypto/pkcs12/p12_npas.c" 3 4
              ((void *)0)
# 38 "../crypto/pkcs12/p12_npas.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_npas.c",39,__func__), ERR_set_error)((35),(105),
# 39 "../crypto/pkcs12/p12_npas.c" 3 4
       ((void *)0)
# 39 "../crypto/pkcs12/p12_npas.c"
       );
        return 0;
    }
    ...
    if (p12->mac != 
# 44 "../crypto/pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 44 "../crypto/pkcs12/p12_npas.c"
                       ) {
        if (!PKCS12_verify_mac(p12, oldpass, -1)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_npas.c",46,__func__), ERR_set_error)((35),(113),
# 46 "../crypto/pkcs12/p12_npas.c" 3 4
           ((void *)0)
# 46 "../crypto/pkcs12/p12_npas.c"
           );
            return 0;
        }
    }
    if (!newpass_p12(p12, oldpass, newpass)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_npas.c",51,__func__), ERR_set_error)((35),(114),
# 51 "../crypto/pkcs12/p12_npas.c" 3 4
       ((void *)0)
# 51 "../crypto/pkcs12/p12_npas.c"
       );
        return 0;
    }
...
# 62 "../crypto/pkcs12/p12_npas.c" 3 4
                             ((void *)0)
# 62 "../crypto/pkcs12/p12_npas.c"
                                 , *newsafes = 
# 62 "../crypto/pkcs12/p12_npas.c" 3 4
                                               ((void *)0)
# 62 "../crypto/pkcs12/p12_npas.c"
                                                   ;
    struct stack_st_PKCS12_SAFEBAG *bags = 
# 63 "../crypto/pkcs12/p12_npas.c" 3 4
                                    ((void *)0)
# 63 "../crypto/pkcs12/p12_npas.c"
                                        ;
    int i, bagnid, pbe_nid = 0, pbe_iter = 0, pbe_saltlen = 0, cipherid = 0;
    PKCS7 *p7, *p7new;
    ASN1_OCTET_STRING *p12_data_tmp = 
# 66 "../crypto/pkcs12/p12_npas.c" 3 4
                                     ((void *)0)
# 66 "../crypto/pkcs12/p12_npas.c"
                                         , *macoct = 
# 66 "../crypto/pkcs12/p12_npas.c" 3 4
                                                     ((void *)0)
# 66 "../crypto/pkcs12/p12_npas.c"
...
# 71 "../crypto/pkcs12/p12_npas.c" 3 4
                                                  ((void *)0)
# 71 "../crypto/pkcs12/p12_npas.c"
                                                      )
        goto err;
    if ((newsafes = ((struct stack_st_PKCS7 *)OPENSSL_sk_new_null())) == 
# 73 "../crypto/pkcs12/p12_npas.c" 3 4
                                           ((void *)0)
# 73 "../crypto/pkcs12/p12_npas.c"
                                               )
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_sk_type(asafes)); i++) {
        ...
        if (bagnid == 21) {
            ...
            if (p7->d.encrypted == 
# 83 "../crypto/pkcs12/p12_npas.c" 3 4
                                  ((void *)0)
                    
# 84 "../crypto/pkcs12/p12_npas.c"
        ...
        if (bags == 
# 90 "../crypto/pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 90 "../crypto/pkcs12/p12_npas.c"
                       )
            goto err;
        ...
        if (bagnid == 21)
            ...
            p7new = PKCS12_pack_p7encdata_ex(pbe_nid, newpass, -1, 
# 99 "../crypto/pkcs12/p12_npas.c" 3 4
                                                                  ((void *)0)
# 99 "../crypto/pkcs12/p12_npas.c"
                                                                      ,
                                             pbe_saltlen, pbe_iter, bags,
                                             p7->ctx.libctx, p7->ctx.propq);
        if (p7new == 
# 102 "../crypto/pkcs12/p12_npas.c" 3 4
                    ((void *)0) 
# 102 "../crypto/pkcs12/p12_npas.c"
                         || !OPENSSL_sk_push(ossl_check_PKCS7_sk_type(newsafes), ossl_check_PKCS7_type(p7new)))
            goto err;
        OPENSSL_sk_pop_free(ossl_check_PKCS12_SAFEBAG_sk_type(bags),ossl_check_PKCS12_SAFEBAG_freefunc_type(PKCS12_SAFEBAG_free));
        bags = 
# 105 "../crypto/pkcs12/p12_npas.c" 3 4
              ((void *)0)
# 105 "../crypto/pkcs12/p12_npas.c"
                  ;
    }
...
# 111 "../crypto/pkcs12/p12_npas.c" 3 4
                                                             ((void *)0)
# 111 "../crypto/pkcs12/p12_npas.c"
                                                                 )
        goto err;
    ...
    if (p12->mac != 
# 116 "../crypto/pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 116 "../crypto/pkcs12/p12_npas.c"
                       ) {
        if (!PKCS12_gen_mac(p12, newpass, -1, mac, &maclen))
            goto err;
        X509_SIG_getm(p12->mac->dinfo, 
# 119 "../crypto/pkcs12/p12_npas.c" 3 4
                                      ((void *)0)
# 119 "../crypto/pkcs12/p12_npas.c"
                                          , &macoct);
...
# 130 "../crypto/pkcs12/p12_npas.c" 3 4
                              ((void *)0)
# 130 "../crypto/pkcs12/p12_npas.c"
                                  ) {
    ...
    OPENSSL_sk_pop_free(ossl_check_PKCS7_sk_type(newsafes),ossl_check_PKCS7_freefunc_type(PKCS7_free));
    return rv;
}
                        ...
                        OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags)); i++) {
        if (!newpass_bag(((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags), (i))), oldpass, newpass,
                         libctx, propq))
            return 0;
    }
    return 1;
...
{
    EVP_CIPHER *cipher = 
# 159 "../crypto/pkcs12/p12_npas.c" 3 4
                        ((void *)0)
# 159 "../crypto/pkcs12/p12_npas.c"
                            ;
    ...
    if ((p8 = PKCS8_decrypt_ex(bag->value.shkeybag, oldpass, -1,
                               libctx, propq)) == 
# 169 "../crypto/pkcs12/p12_npas.c" 3 4
                                                 ((void *)0)
# 169 "../crypto/pkcs12/p12_npas.c"
                                                     )
        return 0;
    X509_SIG_get0(bag->value.shkeybag, &shalg, 
# 171 "../crypto/pkcs12/p12_npas.c" 3 4
                                              ((void *)0)
# 171 "../crypto/pkcs12/p12_npas.c"
                                                  );
    ...
    if (cipherid != 0) {
        ...
        if (cipher == 
# 178 "../crypto/pkcs12/p12_npas.c" 3 4
                     ((void *)0)
# 178 "../crypto/pkcs12/p12_npas.c"
                         ) {
            PKCS8_PRIV_KEY_INFO_free(p8);
            return 0;
        }
    }
    p8new = PKCS8_encrypt_ex(p8_nid, cipher, newpass, -1, 
# 183 "../crypto/pkcs12/p12_npas.c" 3 4
                                                         ((void *)0)
# 183 "../crypto/pkcs12/p12_npas.c"
                                                             , p8_saltlen,
                             p8_iter, p8, libctx, propq);
    PKCS8_PRIV_KEY_INFO_free(p8);
    EVP_CIPHER_free(cipher);
    if (p8new == 
# 187 "../crypto/pkcs12/p12_npas.c" 3 4
                ((void *)0)
# 187 "../crypto/pkcs12/p12_npas.c"
                    )
        return 0;
                   ...
                   int *psaltlen, int *cipherid)
{
    ...
    const void *aparam;
    PBEPARAM *pbe = 
# 201 "../crypto/pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 201 "../crypto/pkcs12/p12_npas.c"
                       ;
    PBE2PARAM *pbe2 = 
# 202 "../crypto/pkcs12/p12_npas.c" 3 4
                     ((void *)0)
# 202 "../crypto/pkcs12/p12_npas.c"
                         ;
    PBKDF2PARAM *kdf = 
# 203 "../crypto/pkcs12/p12_npas.c" 3 4
                      ((void *)0)
# 203 "../crypto/pkcs12/p12_npas.c"
                          ;
    ...
    case 161:
        ...
        if (pbe2 == 
# 212 "../crypto/pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 212 "../crypto/pkcs12/p12_npas.c"
                       )
            goto done;
...
# 217 "../crypto/pkcs12/p12_npas.c" 3 4
                              ((void *)0)
# 217 "../crypto/pkcs12/p12_npas.c"
                                  , 
# 217 "../crypto/pkcs12/p12_npas.c" 3 4
                                    ((void *)0)
# 217 "../crypto/pkcs12/p12_npas.c"
        ...
        if (kdf == 
# 222 "../crypto/pkcs12/p12_npas.c" 3 4
                  ((void *)0)
# 222 "../crypto/pkcs12/p12_npas.c"
                      )
            goto done;
        ...
        if (kdf->prf == 
# 229 "../crypto/pkcs12/p12_npas.c" 3 4
                       ((void *)0)
# 229 "../crypto/pkcs12/p12_npas.c"
                           ) {
            prfnid = 163;
        } else {
            X509_ALGOR_get0(&aoid, 
# 232 "../crypto/pkcs12/p12_npas.c" 3 4
                                  ((void *)0)
# 232 "../crypto/pkcs12/p12_npas.c"
                                      , 
# 232 "../crypto/pkcs12/p12_npas.c" 3 4
                                        ((void *)0)
# 232 "../crypto/pkcs12/p12_npas.c"
    ...
    default:
        ...
        if (pbe == 
# 242 "../crypto/pkcs12/p12_npas.c" 3 4
                  ((void *)0)
# 242 "../crypto/pkcs12/p12_npas.c"
                      )
            goto done;
    ...
    if (kdf != 
# 253 "../crypto/pkcs12/p12_npas.c" 3 4
              ((void *)0)
# 253 "../crypto/pkcs12/p12_npas.c"
                  )
        PBKDF2PARAM_free(kdf);
    if (pbe2 != 
# 255 "../crypto/pkcs12/p12_npas.c" 3 4
               ((void *)0)
# 255 "../crypto/pkcs12/p12_npas.c"
                   )
        PBE2PARAM_free(pbe2);
    if (pbe != 
# 257 "../crypto/pkcs12/p12_npas.c" 3 4
              ((void *)0)
# 257 "../crypto/pkcs12/p12_npas.c"
                  )
        PBEPARAM_free(pbe);
    return ret;
}
