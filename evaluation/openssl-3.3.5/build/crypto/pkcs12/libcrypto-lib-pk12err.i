# 0 "../crypto/pkcs12/pk12err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/pk12err.c"
# 11 "../crypto/pkcs12/pk12err.c"
...
# 14 "../crypto/pkcs12/pk12err.c" 2



static const ERR_STRING_DATA PKCS12_str_reasons[] = {
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "callback failed"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "can't pack structure"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "content type not data"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "decode error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "encode error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "encrypt error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "error setting encrypted data type"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "invalid null argument"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "invalid null pkcs12 pointer"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "invalid type"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "iv gen error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "key gen error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "mac absent"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "mac generation error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "mac setup error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "mac string set error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "mac verify failure"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "parse error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "pkcs12 cipherfinal error"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "unknown digest algorithm"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "unsupported pkcs12 mode"},
    {0, 
# 50 "../crypto/pkcs12/pk12err.c" 3 4
       ((void *)0)
# 50 "../crypto/pkcs12/pk12err.c"
           }
};
...
int ossl_err_load_PKCS12_strings(void)
{
    ...
    if (ERR_reason_error_string(PKCS12_str_reasons[0].error) == 
# 58 "../crypto/pkcs12/pk12err.c" 3 4
                                                               ((void *)0)
# 58 "../crypto/pkcs12/pk12err.c"
                                                                   )
