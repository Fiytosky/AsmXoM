# 0 "../crypto/pkcs12/p12_decr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_decr.c"
# 10 "../crypto/pkcs12/p12_decr.c"
...
{
    unsigned char *out = 
# 25 "../crypto/pkcs12/p12_decr.c" 3 4
                        ((void *)0)
# 25 "../crypto/pkcs12/p12_decr.c"
                            ;
    int outlen, i;
    ...
    if (ctx == 
# 31 "../crypto/pkcs12/p12_decr.c" 3 4
              ((void *)0)
# 31 "../crypto/pkcs12/p12_decr.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",32,__func__), ERR_set_error)((35),((6 | (0x2 << 18L))),
# 32 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 32 "../crypto/pkcs12/p12_decr.c"
       );
        goto err;
    }
    ...
    if (block_size == 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",50,__func__), ERR_set_error)((35),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 50 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 50 "../crypto/pkcs12/p12_decr.c"
       );
        goto err;
    }
    ...
    if ((EVP_CIPHER_get_flags(EVP_CIPHER_CTX_get0_cipher(ctx))
                & 0x2000000) != 0) {
        if (EVP_CIPHER_CTX_ctrl(ctx, 0x16, 0, &mac_len) < 0) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",58,__func__), ERR_set_error)((35),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 58 "../crypto/pkcs12/p12_decr.c" 3 4
           ((void *)0)
# 58 "../crypto/pkcs12/p12_decr.c"
           );
            goto err;
        }
        ...
        if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
            ...
            if (inlen < mac_len) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",66,__func__), ERR_set_error)((35),(119),
# 66 "../crypto/pkcs12/p12_decr.c" 3 4
               ((void *)0)
# 66 "../crypto/pkcs12/p12_decr.c"
               );
                goto err;
            }
            inlen -= mac_len;
            if (EVP_CIPHER_CTX_ctrl(ctx, 0x11,
                ...
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",72,__func__), ERR_set_error)((35),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 72 "../crypto/pkcs12/p12_decr.c" 3 4
               ((void *)0)
# 72 "../crypto/pkcs12/p12_decr.c"
               );
                goto err;
            }
        }
    ...
    if ((out = CRYPTO_malloc(max_out_len, "../crypto/pkcs12/p12_decr.c", 78)) == 
# 78 "../crypto/pkcs12/p12_decr.c" 3 4
                                              ((void *)0)
# 78 "../crypto/pkcs12/p12_decr.c"
                                                  )
        goto err;

    if (!EVP_CipherUpdate(ctx, out, &i, in, inlen)) {
        CRYPTO_free(out, "../crypto/pkcs12/p12_decr.c", 82);
        out = 
# 83 "../crypto/pkcs12/p12_decr.c" 3 4
             ((void *)0)
# 83 "../crypto/pkcs12/p12_decr.c"
                 ;
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",84,__func__), ERR_set_error)((35),((6 | (0x2 << 18L))),
# 84 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 84 "../crypto/pkcs12/p12_decr.c"
       );
        goto err;
    }
    ...
    if (!EVP_CipherFinal_ex(ctx, out + i, &i)) {
        CRYPTO_free(out, "../crypto/pkcs12/p12_decr.c", 90);
        out = 
# 91 "../crypto/pkcs12/p12_decr.c" 3 4
             ((void *)0)
# 91 "../crypto/pkcs12/p12_decr.c"
                 ;
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",92,__func__), ERR_set_error)(35, 116,
    ...
    if ((EVP_CIPHER_get_flags(EVP_CIPHER_CTX_get0_cipher(ctx))
        ...
        if (EVP_CIPHER_CTX_is_encrypting(ctx)) {
            if (EVP_CIPHER_CTX_ctrl(ctx, 0x10,
                ...
                CRYPTO_free(out, "../crypto/pkcs12/p12_decr.c", 103);
                out = 
# 104 "../crypto/pkcs12/p12_decr.c" 3 4
                     ((void *)0)
# 104 "../crypto/pkcs12/p12_decr.c"
                         ;
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",105,__func__), ERR_set_error)((35),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 105 "../crypto/pkcs12/p12_decr.c" 3 4
               ((void *)0)
# 105 "../crypto/pkcs12/p12_decr.c"
               );
                goto err;
            }
            outlen += mac_len;
                                ...
                                unsigned char **data, int *datalen, int en_de)
{
    return PKCS12_pbe_crypt_ex(algor, pass, passlen, in, inlen, data, datalen,
                               en_de, 
# 127 "../crypto/pkcs12/p12_decr.c" 3 4
                                     ((void *)0)
# 127 "../crypto/pkcs12/p12_decr.c"
                                         , 
# 127 "../crypto/pkcs12/p12_decr.c" 3 4
                                           ((void *)0)
# 127 "../crypto/pkcs12/p12_decr.c"
...
{
    unsigned char *out = 
# 141 "../crypto/pkcs12/p12_decr.c" 3 4
                        ((void *)0)
# 141 "../crypto/pkcs12/p12_decr.c"
                            ;
    ...
    if (!PKCS12_pbe_crypt_ex(algor, pass, passlen, oct->data, oct->length,
        ...
        return 
# 148 "../crypto/pkcs12/p12_decr.c" 3 4
              ((void *)0)
# 148 "../crypto/pkcs12/p12_decr.c"
                  ;
    p = out;
    do { BIO *trc_out = 
# 150 "../crypto/pkcs12/p12_decr.c" 3 4
   ((void *)0)
# 150 "../crypto/pkcs12/p12_decr.c"
   ; if (0) {
        BIO_printf(trc_out, "\n");
    ...
    ret = ASN1_item_d2i(
# 155 "../crypto/pkcs12/p12_decr.c" 3 4
                       ((void *)0)
# 155 "../crypto/pkcs12/p12_decr.c"
                           , &p, outlen, it);
    if (zbuf)
        OPENSSL_cleanse(out, outlen);
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",159,__func__), ERR_set_error)((35),(101),
# 159 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 159 "../crypto/pkcs12/p12_decr.c"
       );
    CRYPTO_free(out, "../crypto/pkcs12/p12_decr.c", 160);
    return ret;
}
...
# 169 "../crypto/pkcs12/p12_decr.c" 3 4
                                     ((void *)0)
# 169 "../crypto/pkcs12/p12_decr.c"
                                         , 
# 169 "../crypto/pkcs12/p12_decr.c" 3 4
                                           ((void *)0)
# 169 "../crypto/pkcs12/p12_decr.c"
...
{
    ASN1_OCTET_STRING *oct = 
# 184 "../crypto/pkcs12/p12_decr.c" 3 4
                            ((void *)0)
# 184 "../crypto/pkcs12/p12_decr.c"
                                ;
    unsigned char *in = 
# 185 "../crypto/pkcs12/p12_decr.c" 3 4
                       ((void *)0)
# 185 "../crypto/pkcs12/p12_decr.c"
                           ;
    int inlen;

    if ((oct = ASN1_OCTET_STRING_new()) == 
# 188 "../crypto/pkcs12/p12_decr.c" 3 4
                                          ((void *)0)
# 188 "../crypto/pkcs12/p12_decr.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",189,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 189 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 189 "../crypto/pkcs12/p12_decr.c"
       );
        goto err;
    }
    inlen = ASN1_item_i2d(obj, &in, it);
    if (!in) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",194,__func__), ERR_set_error)((35),(102),
# 194 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 194 "../crypto/pkcs12/p12_decr.c"
       );
        goto err;
    }
    if (!PKCS12_pbe_crypt_ex(algor, pass, passlen, in, inlen, &oct->data,
                             &oct->length, 1, ctx, propq)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_decr.c",199,__func__), ERR_set_error)((35),(103),
# 199 "../crypto/pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 199 "../crypto/pkcs12/p12_decr.c"
       );
        CRYPTO_free(in, "../crypto/pkcs12/p12_decr.c", 200);
        goto err;
    }
    if (zbuf)
        OPENSSL_cleanse(in, inlen);
    CRYPTO_free(in, "../crypto/pkcs12/p12_decr.c", 205);
    return oct;
 err:
    ASN1_OCTET_STRING_free(oct);
    return 
# 209 "../crypto/pkcs12/p12_decr.c" 3 4
          ((void *)0)
# 209 "../crypto/pkcs12/p12_decr.c"
              ;
}
...
# 217 "../crypto/pkcs12/p12_decr.c" 3 4
                                                                          ((void *)0)
# 217 "../crypto/pkcs12/p12_decr.c"
                                                                              , 
# 217 "../crypto/pkcs12/p12_decr.c" 3 4
                                                                                ((void *)0)
# 217 "../crypto/pkcs12/p12_decr.c"
