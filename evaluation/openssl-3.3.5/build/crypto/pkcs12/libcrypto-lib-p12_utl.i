# 0 "../crypto/pkcs12/p12_utl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_utl.c"
# 10 "../crypto/pkcs12/p12_utl.c"
                               ...
                               unsigned char **uni, int *unilen)
{
    ...
    if (asclen < 0)
        return 
# 27 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 27 "../crypto/pkcs12/p12_utl.c"
                  ;
    ulen = asclen * 2 + 2;
    if ((unitmp = CRYPTO_malloc(ulen, "../crypto/pkcs12/p12_utl.c", 29)) == 
# 29 "../crypto/pkcs12/p12_utl.c" 3 4
                                          ((void *)0)
# 29 "../crypto/pkcs12/p12_utl.c"
                                              )
        return 
# 30 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 30 "../crypto/pkcs12/p12_utl.c"
                  ;
...
char *OPENSSL_uni2asc(const unsigned char *uni, int unilen)
{
    ...
    if (unilen & 1)
        return 
# 52 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 52 "../crypto/pkcs12/p12_utl.c"
                  ;
    if (unilen < 0)
        return 
# 54 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 54 "../crypto/pkcs12/p12_utl.c"
                  ;
    asclen = unilen / 2;
    ...
    if (!unilen || uni[unilen - 1])
        asclen++;
    uni++;
    if ((asctmp = CRYPTO_malloc(asclen, "../crypto/pkcs12/p12_utl.c", 60)) == 
# 60 "../crypto/pkcs12/p12_utl.c" 3 4
                                            ((void *)0)
# 60 "../crypto/pkcs12/p12_utl.c"
                                                )
        return 
# 61 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 61 "../crypto/pkcs12/p12_utl.c"
                  ;
...
# 106 "../crypto/pkcs12/p12_utl.c"
        if (j < 0)
            return OPENSSL_asc2uni(asc, asclen, uni, unilen);

        if (utf32chr > 0x10FFFF)
            return 
# 110 "../crypto/pkcs12/p12_utl.c" 3 4
                  ((void *)0)
# 110 "../crypto/pkcs12/p12_utl.c"
                      ;
    ...
    if ((ret = CRYPTO_malloc(ulen, "../crypto/pkcs12/p12_utl.c", 120)) == 
# 120 "../crypto/pkcs12/p12_utl.c" 3 4
                                       ((void *)0)
# 120 "../crypto/pkcs12/p12_utl.c"
                                           )
        return 
# 121 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 121 "../crypto/pkcs12/p12_utl.c"
                  ;
...
char *OPENSSL_uni2utf8(const unsigned char *uni, int unilen)
{
    ...
    if (unilen & 1)
        return 
# 184 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 184 "../crypto/pkcs12/p12_utl.c"
                  ;

    for (asclen = 0, i = 0; i < unilen; ) {
        j = bmp_to_utf8(
# 187 "../crypto/pkcs12/p12_utl.c" 3 4
                       ((void *)0)
# 187 "../crypto/pkcs12/p12_utl.c"
                           , uni+i, unilen-i);
    ...
    if ((asctmp = CRYPTO_malloc(asclen, "../crypto/pkcs12/p12_utl.c", 203)) == 
# 203 "../crypto/pkcs12/p12_utl.c" 3 4
                                            ((void *)0)
# 203 "../crypto/pkcs12/p12_utl.c"
                                                )
        return 
# 204 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 204 "../crypto/pkcs12/p12_utl.c"
                  ;
...
{
    OSSL_LIB_CTX *libctx = 
# 235 "../crypto/pkcs12/p12_utl.c" 3 4
                          ((void *)0)
# 235 "../crypto/pkcs12/p12_utl.c"
                              ;
    const char *propq = 
# 236 "../crypto/pkcs12/p12_utl.c" 3 4
                       ((void *)0)
# 236 "../crypto/pkcs12/p12_utl.c"
                           ;
    const PKCS7_CTX *p7ctx = 
# 237 "../crypto/pkcs12/p12_utl.c" 3 4
                            ((void *)0)
# 237 "../crypto/pkcs12/p12_utl.c"
                                ;

    if (p12 != 
# 239 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 239 "../crypto/pkcs12/p12_utl.c"
                  ) {
        p7ctx = ossl_pkcs12_get0_pkcs7ctx(*p12);
        if (p7ctx != 
# 241 "../crypto/pkcs12/p12_utl.c" 3 4
                    ((void *)0)
# 241 "../crypto/pkcs12/p12_utl.c"
                        ) {
            libctx = ossl_pkcs7_ctx_get0_libctx(p7ctx);
            propq = ossl_pkcs7_ctx_get0_propq(p7ctx);
        }
    }
    return ASN1_item_d2i_bio_ex((PKCS12_it()), bp, p12, libctx, propq);
}
...
{
    OSSL_LIB_CTX *libctx = 
# 252 "../crypto/pkcs12/p12_utl.c" 3 4
                          ((void *)0)
# 252 "../crypto/pkcs12/p12_utl.c"
                              ;
    const char *propq = 
# 253 "../crypto/pkcs12/p12_utl.c" 3 4
                       ((void *)0)
# 253 "../crypto/pkcs12/p12_utl.c"
                           ;
    const PKCS7_CTX *p7ctx = 
# 254 "../crypto/pkcs12/p12_utl.c" 3 4
                            ((void *)0)
# 254 "../crypto/pkcs12/p12_utl.c"
                                ;

    if (p12 != 
# 256 "../crypto/pkcs12/p12_utl.c" 3 4
              ((void *)0)
# 256 "../crypto/pkcs12/p12_utl.c"
                  ) {
        p7ctx = ossl_pkcs12_get0_pkcs7ctx(*p12);
        if (p7ctx != 
# 258 "../crypto/pkcs12/p12_utl.c" 3 4
                    ((void *)0)
# 258 "../crypto/pkcs12/p12_utl.c"
                        ) {
            libctx = ossl_pkcs7_ctx_get0_libctx(p7ctx);
            propq = ossl_pkcs7_ctx_get0_propq(p7ctx);
        }
    }
    return ASN1_item_d2i_fp_ex((PKCS12_it()), fp, p12, libctx, propq);
}
