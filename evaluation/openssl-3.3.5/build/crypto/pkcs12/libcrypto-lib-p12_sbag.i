# 0 "../crypto/pkcs12/p12_sbag.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_sbag.c"
# 10 "../crypto/pkcs12/p12_sbag.c"
...
const PKCS8_PRIV_KEY_INFO *PKCS12_SAFEBAG_get0_p8inf(const PKCS12_SAFEBAG *bag)
{
    if (PKCS12_SAFEBAG_get_nid(bag) != 150)
        return 
# 37 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 37 "../crypto/pkcs12/p12_sbag.c"
                  ;
...
const X509_SIG *PKCS12_SAFEBAG_get0_pkcs8(const PKCS12_SAFEBAG *bag)
{
    if (OBJ_obj2nid(bag->type) != 151)
        return 
# 44 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 44 "../crypto/pkcs12/p12_sbag.c"
                  ;
...
PKCS12_SAFEBAG_get0_safes(const PKCS12_SAFEBAG *bag)
{
    if (OBJ_obj2nid(bag->type) != 155)
        return 
# 52 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 52 "../crypto/pkcs12/p12_sbag.c"
                  ;
...
int PKCS12_SAFEBAG_get_bag_nid(const PKCS12_SAFEBAG *bag)
{
    ...
    if (btype != 152 && btype != 153 && btype != 154)
        return -1;
...
X509 *PKCS12_SAFEBAG_get1_cert(const PKCS12_SAFEBAG *bag)
{
    if (PKCS12_SAFEBAG_get_nid(bag) != 152)
        return 
# 88 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 88 "../crypto/pkcs12/p12_sbag.c"
                  ;
    if (OBJ_obj2nid(bag->value.bag->type) != 158)
        return 
# 90 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 90 "../crypto/pkcs12/p12_sbag.c"
                  ;
...
X509_CRL *PKCS12_SAFEBAG_get1_crl(const PKCS12_SAFEBAG *bag)
{
    if (PKCS12_SAFEBAG_get_nid(bag) != 153)
        return 
# 98 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 98 "../crypto/pkcs12/p12_sbag.c"
                  ;
    if (OBJ_obj2nid(bag->value.bag->type) != 160)
        return 
# 100 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 100 "../crypto/pkcs12/p12_sbag.c"
                  ;
    return ASN1_item_unpack(bag->value.bag->value.octet,
                            (X509_CRL_it()));
}
...
{
    X509 *ret = 
# 108 "../crypto/pkcs12/p12_sbag.c" 3 4
               ((void *)0)
# 108 "../crypto/pkcs12/p12_sbag.c"
                   ;

    if (PKCS12_SAFEBAG_get_nid(bag) != 152)
        return 
# 111 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 111 "../crypto/pkcs12/p12_sbag.c"
                  ;
    if (OBJ_obj2nid(bag->value.bag->type) != 158)
        return 
# 113 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 113 "../crypto/pkcs12/p12_sbag.c"
                  ;
    ret = ASN1_item_unpack_ex(bag->value.bag->value.octet,
                              (X509_it()), libctx, propq);
    if (!ossl_x509_set0_libctx(ret, libctx, propq)) {
        X509_free(ret);
        return 
# 118 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 118 "../crypto/pkcs12/p12_sbag.c"
                  ;
    }
    return ret;
}
...
{
    X509_CRL *ret = 
# 126 "../crypto/pkcs12/p12_sbag.c" 3 4
                   ((void *)0)
# 126 "../crypto/pkcs12/p12_sbag.c"
                       ;

    if (PKCS12_SAFEBAG_get_nid(bag) != 153)
        return 
# 129 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 129 "../crypto/pkcs12/p12_sbag.c"
                  ;
    if (OBJ_obj2nid(bag->value.bag->type) != 160)
        return 
# 131 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 131 "../crypto/pkcs12/p12_sbag.c"
                  ;
    ret = ASN1_item_unpack_ex(bag->value.bag->value.octet,
                              (X509_CRL_it()), libctx, propq);
    if (!ossl_x509_crl_set0_libctx(ret, libctx, propq)) {
        X509_CRL_free(ret);
        return 
# 136 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 136 "../crypto/pkcs12/p12_sbag.c"
                  ;
    }
    return ret;
}
...
# 158 "../crypto/pkcs12/p12_sbag.c" 3 4
                                    ((void *)0)
# 158 "../crypto/pkcs12/p12_sbag.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",159,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 159 "../crypto/pkcs12/p12_sbag.c" 3 4
       ((void *)0)
# 159 "../crypto/pkcs12/p12_sbag.c"
       );
        return 
# 160 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 160 "../crypto/pkcs12/p12_sbag.c"
                  ;
    }
    ...
    case 4:
        {
            ...
            if (strtmp == 
# 169 "../crypto/pkcs12/p12_sbag.c" 3 4
                         ((void *)0)
# 169 "../crypto/pkcs12/p12_sbag.c"
                             ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",170,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 170 "../crypto/pkcs12/p12_sbag.c" 3 4
               ((void *)0)
# 170 "../crypto/pkcs12/p12_sbag.c"
               );
                goto err;
            }
            ...
            if (!ASN1_OCTET_STRING_set(strtmp, value, len)) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",176,__func__), ERR_set_error)((35),(102),
# 176 "../crypto/pkcs12/p12_sbag.c" 3 4
               ((void *)0)
# 176 "../crypto/pkcs12/p12_sbag.c"
               );
                goto err;
            }
            bag->value.other = ASN1_TYPE_new();
            if (bag->value.other == 
# 180 "../crypto/pkcs12/p12_sbag.c" 3 4
                                   ((void *)0)
# 180 "../crypto/pkcs12/p12_sbag.c"
                                       ) {
                ASN1_OCTET_STRING_free(strtmp);
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",182,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 182 "../crypto/pkcs12/p12_sbag.c" 3 4
               ((void *)0)
# 182 "../crypto/pkcs12/p12_sbag.c"
               );
                goto err;
            }
    ...
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",190,__func__), ERR_set_error)((35),(112),
# 190 "../crypto/pkcs12/p12_sbag.c" 3 4
       ((void *)0)
# 190 "../crypto/pkcs12/p12_sbag.c"
       );
        goto err;
    }

    if ((safebag = PKCS12_SAFEBAG_new()) == 
# 194 "../crypto/pkcs12/p12_sbag.c" 3 4
                                           ((void *)0)
# 194 "../crypto/pkcs12/p12_sbag.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",195,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 195 "../crypto/pkcs12/p12_sbag.c" 3 4
       ((void *)0)
# 195 "../crypto/pkcs12/p12_sbag.c"
       );
        goto err;
    }
    safebag->value.bag = bag;
    safebag->type = OBJ_nid2obj(154);
    return safebag;

 err:
    PKCS12_BAGS_free(bag);
    return 
# 204 "../crypto/pkcs12/p12_sbag.c" 3 4
          ((void *)0)
# 204 "../crypto/pkcs12/p12_sbag.c"
              ;
}
...
PKCS12_SAFEBAG *PKCS12_SAFEBAG_create0_p8inf(PKCS8_PRIV_KEY_INFO *p8)
{
    ...
    if (bag == 
# 213 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 213 "../crypto/pkcs12/p12_sbag.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",214,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 214 "../crypto/pkcs12/p12_sbag.c" 3 4
       ((void *)0)
# 214 "../crypto/pkcs12/p12_sbag.c"
       );
        return 
# 215 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 215 "../crypto/pkcs12/p12_sbag.c"
                  ;
    }
...
PKCS12_SAFEBAG *PKCS12_SAFEBAG_create0_pkcs8(X509_SIG *p8)
{
    ...
    if (bag == 
# 229 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 229 "../crypto/pkcs12/p12_sbag.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_sbag.c",230,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 230 "../crypto/pkcs12/p12_sbag.c" 3 4
       ((void *)0)
# 230 "../crypto/pkcs12/p12_sbag.c"
       );
        return 
# 231 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 231 "../crypto/pkcs12/p12_sbag.c"
                  ;
    }
...
{
    PKCS12_SAFEBAG *bag = 
# 247 "../crypto/pkcs12/p12_sbag.c" 3 4
                         ((void *)0)
# 247 "../crypto/pkcs12/p12_sbag.c"
                             ;
    const EVP_CIPHER *pbe_ciph = 
# 248 "../crypto/pkcs12/p12_sbag.c" 3 4
                                ((void *)0)
# 248 "../crypto/pkcs12/p12_sbag.c"
                                    ;
    EVP_CIPHER *pbe_ciph_fetch = 
# 249 "../crypto/pkcs12/p12_sbag.c" 3 4
                                ((void *)0)
# 249 "../crypto/pkcs12/p12_sbag.c"
                                    ;
    X509_SIG *p8;
    ...
    if (pbe_ciph == 
# 254 "../crypto/pkcs12/p12_sbag.c" 3 4
                   ((void *)0)
# 254 "../crypto/pkcs12/p12_sbag.c"
                       )
        pbe_ciph = EVP_get_cipherbyname(OBJ_nid2sn(pbe_nid));
    ERR_pop_to_mark();

    if (pbe_ciph != 
# 258 "../crypto/pkcs12/p12_sbag.c" 3 4
                   ((void *)0)
# 258 "../crypto/pkcs12/p12_sbag.c"
                       )
        pbe_nid = -1;
    ...
    p8 = PKCS8_encrypt_ex(pbe_nid, pbe_ciph, pass, passlen, salt, saltlen, iter,
                          p8inf, ctx, propq);
    if (p8 == 
# 263 "../crypto/pkcs12/p12_sbag.c" 3 4
             ((void *)0)
# 263 "../crypto/pkcs12/p12_sbag.c"
                 )
        goto err;

    bag = PKCS12_SAFEBAG_create0_pkcs8(p8);
    if (bag == 
# 267 "../crypto/pkcs12/p12_sbag.c" 3 4
              ((void *)0)
# 267 "../crypto/pkcs12/p12_sbag.c"
                  )
        X509_SIG_free(p8);
...
# 284 "../crypto/pkcs12/p12_sbag.c" 3 4
                                                 ((void *)0)
# 284 "../crypto/pkcs12/p12_sbag.c"
                                                     , 
# 284 "../crypto/pkcs12/p12_sbag.c" 3 4
                                                       ((void *)0)
# 284 "../crypto/pkcs12/p12_sbag.c"
