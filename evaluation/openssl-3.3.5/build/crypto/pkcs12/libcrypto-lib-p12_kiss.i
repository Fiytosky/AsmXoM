# 0 "../crypto/pkcs12/p12_kiss.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_kiss.c"
# 10 "../crypto/pkcs12/p12_kiss.c"
...
static int parse_bags(const struct stack_st_PKCS12_SAFEBAG *bags, const char *pass,
...
static int parse_bag(PKCS12_SAFEBAG *bag, const char *pass, int passlen,
                     EVP_PKEY **pkey, struct stack_st_X509 *ocerts,
                     OSSL_LIB_CTX *libctx, const char *propq);
# 35 "../crypto/pkcs12/p12_kiss.c"
int PKCS12_parse(PKCS12 *p12, const char *pass, EVP_PKEY **pkey, X509 **cert,
                 struct stack_st_X509 **ca)
{
    struct stack_st_X509 *ocerts = 
# 38 "../crypto/pkcs12/p12_kiss.c" 3 4
                            ((void *)0)
# 38 "../crypto/pkcs12/p12_kiss.c"
                                ;
    X509 *x = 
# 39 "../crypto/pkcs12/p12_kiss.c" 3 4
             ((void *)0)
# 39 "../crypto/pkcs12/p12_kiss.c"
                 ;

    if (pkey != 
# 41 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 41 "../crypto/pkcs12/p12_kiss.c"
                   )
        *pkey = 
# 42 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 42 "../crypto/pkcs12/p12_kiss.c"
                   ;
    if (cert != 
# 43 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 43 "../crypto/pkcs12/p12_kiss.c"
                   )
        *cert = 
# 44 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 44 "../crypto/pkcs12/p12_kiss.c"
                   ;



    if (p12 == 
# 48 "../crypto/pkcs12/p12_kiss.c" 3 4
              ((void *)0)
# 48 "../crypto/pkcs12/p12_kiss.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_kiss.c",49,__func__), ERR_set_error)((35),(105),
# 49 "../crypto/pkcs12/p12_kiss.c" 3 4
       ((void *)0)
# 49 "../crypto/pkcs12/p12_kiss.c"
       );
        return 0;
    }
    ...
    if (PKCS12_mac_present(p12)) {
        ...
        if (pass == 
# 61 "../crypto/pkcs12/p12_kiss.c" 3 4
                   ((void *)0) 
# 61 "../crypto/pkcs12/p12_kiss.c"
                        || *pass == '\0') {
            if (PKCS12_verify_mac(p12, 
# 62 "../crypto/pkcs12/p12_kiss.c" 3 4
                                      ((void *)0)
# 62 "../crypto/pkcs12/p12_kiss.c"
                                          , 0))
                pass = 
# 63 "../crypto/pkcs12/p12_kiss.c" 3 4
                      ((void *)0)
# 63 "../crypto/pkcs12/p12_kiss.c"
                          ;
            else if (PKCS12_verify_mac(p12, "", 0))
                pass = "";
            else {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_kiss.c",67,__func__), ERR_set_error)((35),(113),
# 67 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 67 "../crypto/pkcs12/p12_kiss.c"
               );
                goto err;
            }
        } else if (!PKCS12_verify_mac(p12, pass, -1)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_kiss.c",71,__func__), ERR_set_error)((35),(113),
# 71 "../crypto/pkcs12/p12_kiss.c" 3 4
           ((void *)0)
# 71 "../crypto/pkcs12/p12_kiss.c"
           );
            goto err;
        }
    } else if (pass == 
# 74 "../crypto/pkcs12/p12_kiss.c" 3 4
                      ((void *)0) 
# 74 "../crypto/pkcs12/p12_kiss.c"
                           || *pass == '\0') {
        pass = 
# 75 "../crypto/pkcs12/p12_kiss.c" 3 4
              ((void *)0)
# 75 "../crypto/pkcs12/p12_kiss.c"
                  ;
    }


    if ((cert != 
# 79 "../crypto/pkcs12/p12_kiss.c" 3 4
                ((void *)0) 
# 79 "../crypto/pkcs12/p12_kiss.c"
                     || ca != 
# 79 "../crypto/pkcs12/p12_kiss.c" 3 4
                              ((void *)0)
# 79 "../crypto/pkcs12/p12_kiss.c"
                                  )
            && (ocerts = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 80 "../crypto/pkcs12/p12_kiss.c" 3 4
                                               ((void *)0)
# 80 "../crypto/pkcs12/p12_kiss.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_kiss.c",81,__func__), ERR_set_error)((35),((15 | (0x2 << 18L))),
# 81 "../crypto/pkcs12/p12_kiss.c" 3 4
       ((void *)0)
# 81 "../crypto/pkcs12/p12_kiss.c"
       );
        goto err;
    }
    ...
    if (!parse_pk12(p12, pass, -1, pkey, ocerts)) {
        ...
        if (ERR_GET_LIB(err) != 6
                && ERR_GET_REASON(err) != 156)
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_kiss.c",90,__func__), ERR_set_error)((35),(114),
# 90 "../crypto/pkcs12/p12_kiss.c" 3 4
           ((void *)0)
# 90 "../crypto/pkcs12/p12_kiss.c"
           );
        goto err;
    }


    while ((x = ((X509 *)OPENSSL_sk_shift(ossl_check_X509_sk_type(ocerts)))) != 
# 95 "../crypto/pkcs12/p12_kiss.c" 3 4
                                         ((void *)0)
# 95 "../crypto/pkcs12/p12_kiss.c"
                                             ) {
        if (pkey != 
# 96 "../crypto/pkcs12/p12_kiss.c" 3 4
                   ((void *)0) 
# 96 "../crypto/pkcs12/p12_kiss.c"
                        && *pkey != 
# 96 "../crypto/pkcs12/p12_kiss.c" 3 4
                                    ((void *)0)
                
# 97 "../crypto/pkcs12/p12_kiss.c"
               && cert != 
# 97 "../crypto/pkcs12/p12_kiss.c" 3 4
                          ((void *)0) 
# 97 "../crypto/pkcs12/p12_kiss.c"
                               && *cert == 
# 97 "../crypto/pkcs12/p12_kiss.c" 3 4
...
# 97 "../crypto/pkcs12/p12_kiss.c"
        ...
        if (ca != 
# 109 "../crypto/pkcs12/p12_kiss.c" 3 4
                 ((void *)0)
# 109 "../crypto/pkcs12/p12_kiss.c"
                     ) {
            if (!ossl_x509_add_cert_new(ca, x, 0))
                goto err;
            continue;
        }
        X509_free(x);
    }
    OPENSSL_sk_free(ossl_check_X509_sk_type(ocerts));
 ...
 err:
    ...
    if (pkey != 
# 122 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 122 "../crypto/pkcs12/p12_kiss.c"
                   ) {
        EVP_PKEY_free(*pkey);
        *pkey = 
# 124 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 124 "../crypto/pkcs12/p12_kiss.c"
                   ;
    }
    if (cert != 
# 126 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 126 "../crypto/pkcs12/p12_kiss.c"
                   ) {
        X509_free(*cert);
        *cert = 
# 128 "../crypto/pkcs12/p12_kiss.c" 3 4
               ((void *)0)
# 128 "../crypto/pkcs12/p12_kiss.c"
                   ;
    }
    X509_free(x);
...
# 147 "../crypto/pkcs12/p12_kiss.c" 3 4
                                                  ((void *)0)
# 147 "../crypto/pkcs12/p12_kiss.c"
                                                      )
        return 0;
                      ...
                      OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags)); i++) {
        if (!parse_bag(((PKCS12_SAFEBAG *)OPENSSL_sk_value(ossl_check_const_PKCS12_SAFEBAG_sk_type(bags), (i))),
...
# 197 "../crypto/pkcs12/p12_kiss.c" 3 4
                           ((void *)0)
# 197 "../crypto/pkcs12/p12_kiss.c"
                               ;
    ASN1_OCTET_STRING *lkid = 
# 198 "../crypto/pkcs12/p12_kiss.c" 3 4
                             ((void *)0)
# 198 "../crypto/pkcs12/p12_kiss.c"
                                 ;

    if ((attrib = PKCS12_SAFEBAG_get0_attr(bag, 156)))
        fname = attrib->value.bmpstring;

    if ((attrib = PKCS12_SAFEBAG_get0_attr(bag, 157)))
        lkid = attrib->value.octet_string;

    switch (PKCS12_SAFEBAG_get_nid(bag)) {
    case 150:
        if (pkey == 
# 208 "../crypto/pkcs12/p12_kiss.c" 3 4
                   ((void *)0) 
# 208 "../crypto/pkcs12/p12_kiss.c"
                        || *pkey != 
# 208 "../crypto/pkcs12/p12_kiss.c" 3 4
                                    ((void *)0)
# 208 "../crypto/pkcs12/p12_kiss.c"
        ...
        *pkey = EVP_PKCS82PKEY_ex(PKCS12_SAFEBAG_get0_p8inf(bag),
                                  libctx, propq);
        if (*pkey == 
# 212 "../crypto/pkcs12/p12_kiss.c" 3 4
                    ((void *)0)
# 212 "../crypto/pkcs12/p12_kiss.c"
                        )
            return 0;
        break;
    ...
    case 151:
        if (pkey == 
# 217 "../crypto/pkcs12/p12_kiss.c" 3 4
                   ((void *)0) 
# 217 "../crypto/pkcs12/p12_kiss.c"
                        || *pkey != 
# 217 "../crypto/pkcs12/p12_kiss.c" 3 4
                                    ((void *)0)
# 217 "../crypto/pkcs12/p12_kiss.c"
        ...
        if ((p8 = PKCS12_decrypt_skey_ex(bag, pass, passlen,
                                         libctx, propq)) == 
# 220 "../crypto/pkcs12/p12_kiss.c" 3 4
                                                           ((void *)0)
# 220 "../crypto/pkcs12/p12_kiss.c"
                                                               )
            return 0;
    ...
    case 152:
        if (ocerts == 
# 229 "../crypto/pkcs12/p12_kiss.c" 3 4
                     ((void *)0)
                
# 230 "../crypto/pkcs12/p12_kiss.c"
               || PKCS12_SAFEBAG_get_bag_nid(bag) != 158)
            return 1;
        if ((x509 = PKCS12_SAFEBAG_get1_cert_ex(bag, libctx, propq)) == 
# 232 "../crypto/pkcs12/p12_kiss.c" 3 4
                                                                       ((void *)0)
# 232 "../crypto/pkcs12/p12_kiss.c"
                                                                           )
            return 0;
        ...
        if (fname) {
            ...
            if (len >= 0) {
                ...
                CRYPTO_free(data, "../crypto/pkcs12/p12_kiss.c", 245);
                if (!r) {
                    X509_free(x509);
                    return 0;
                }
        ...
        if (!OPENSSL_sk_push(ossl_check_X509_sk_type(ocerts), ossl_check_X509_type(x509))) {
            X509_free(x509);
            return 0;
        }
