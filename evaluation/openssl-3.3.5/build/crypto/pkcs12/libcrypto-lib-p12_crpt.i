# 0 "../crypto/pkcs12/p12_crpt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_crpt.c"
# 10 "../crypto/pkcs12/p12_crpt.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 12 "../crypto/pkcs12/p12_crpt.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 14 "../crypto/pkcs12/p12_crpt.c" 2
                           ...
                           OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (cipher == 
# 34 "../crypto/pkcs12/p12_crpt.c" 3 4
                 ((void *)0)
# 34 "../crypto/pkcs12/p12_crpt.c"
                     )
        return 0;
    ...
    if (pbe == 
# 40 "../crypto/pkcs12/p12_crpt.c" 3 4
              ((void *)0)
# 40 "../crypto/pkcs12/p12_crpt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crpt.c",41,__func__), ERR_set_error)((35),(101),
# 41 "../crypto/pkcs12/p12_crpt.c" 3 4
       ((void *)0)
# 41 "../crypto/pkcs12/p12_crpt.c"
       );
        return 0;
    }

    if (pbe->iter == 
# 45 "../crypto/pkcs12/p12_crpt.c" 3 4
                    ((void *)0)
# 45 "../crypto/pkcs12/p12_crpt.c"
                        )
        iter = 1;
    else
    ...
    if (!PKCS12_key_gen_utf8_ex(pass, passlen, salt, saltlen, 1,
                                iter, EVP_CIPHER_get_key_length(cipher),
                                key, md,
                                libctx, propq)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crpt.c",55,__func__), ERR_set_error)((35),(107),
# 55 "../crypto/pkcs12/p12_crpt.c" 3 4
       ((void *)0)
# 55 "../crypto/pkcs12/p12_crpt.c"
       );
        PBEPARAM_free(pbe);
        return 0;
    }
    if (EVP_CIPHER_get_iv_length(cipher) > 0) {
        if (!PKCS12_key_gen_utf8_ex(pass, passlen, salt, saltlen, 2,
                                    iter, EVP_CIPHER_get_iv_length(cipher),
                                    iv, md,
                                    libctx, propq)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_crpt.c",64,__func__), ERR_set_error)((35),(106),
# 64 "../crypto/pkcs12/p12_crpt.c" 3 4
           ((void *)0)
# 64 "../crypto/pkcs12/p12_crpt.c"
           );
            PBEPARAM_free(pbe);
            return 0;
        }
        ...
        piv = 
# 69 "../crypto/pkcs12/p12_crpt.c" 3 4
             ((void *)0)
# 69 "../crypto/pkcs12/p12_crpt.c"
                 ;
    }
    PBEPARAM_free(pbe);
    ret = EVP_CipherInit_ex(ctx, cipher, 
# 72 "../crypto/pkcs12/p12_crpt.c" 3 4
                                        ((void *)0)
# 72 "../crypto/pkcs12/p12_crpt.c"
                                            , key, piv, en_de);
    OPENSSL_cleanse(key, 64);
...
# 83 "../crypto/pkcs12/p12_crpt.c" 3 4
                                 ((void *)0)
# 83 "../crypto/pkcs12/p12_crpt.c"
                                     , 
# 83 "../crypto/pkcs12/p12_crpt.c" 3 4
                                       ((void *)0)
# 83 "../crypto/pkcs12/p12_crpt.c"
