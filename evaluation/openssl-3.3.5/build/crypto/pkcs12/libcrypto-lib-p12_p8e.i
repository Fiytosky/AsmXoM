# 0 "../crypto/pkcs12/p12_p8e.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_p8e.c"
# 10 "../crypto/pkcs12/p12_p8e.c"
...
{
    X509_SIG *p8 = 
# 22 "../crypto/pkcs12/p12_p8e.c" 3 4
                  ((void *)0)
# 22 "../crypto/pkcs12/p12_p8e.c"
                      ;
    X509_ALGOR *pbe;

    if (pbe_nid == -1) {
        if (cipher == 
# 26 "../crypto/pkcs12/p12_p8e.c" 3 4
                     ((void *)0)
# 26 "../crypto/pkcs12/p12_p8e.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_p8e.c",27,__func__), ERR_set_error)((35),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 27 "../crypto/pkcs12/p12_p8e.c" 3 4
           ((void *)0)
# 27 "../crypto/pkcs12/p12_p8e.c"
           );
            return 
# 28 "../crypto/pkcs12/p12_p8e.c" 3 4
                  ((void *)0)
# 28 "../crypto/pkcs12/p12_p8e.c"
                      ;
        }
        pbe = PKCS5_pbe2_set_iv_ex(cipher, iter, salt, saltlen, 
# 30 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                               ((void *)0)
# 30 "../crypto/pkcs12/p12_p8e.c"
                                                                   , -1,
                                   libctx);
    } else {
        ERR_set_mark();
        if (EVP_PBE_find(0x1, pbe_nid, 
# 34 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                   ((void *)0)
# 34 "../crypto/pkcs12/p12_p8e.c"
                                                       , 
# 34 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                         ((void *)0)
# 34 "../crypto/pkcs12/p12_p8e.c"
            ...
            ERR_clear_last_mark();
            if (cipher == 
# 36 "../crypto/pkcs12/p12_p8e.c" 3 4
                         ((void *)0)
# 36 "../crypto/pkcs12/p12_p8e.c"
                             ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_p8e.c",37,__func__), ERR_set_error)((35),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 37 "../crypto/pkcs12/p12_p8e.c" 3 4
               ((void *)0)
# 37 "../crypto/pkcs12/p12_p8e.c"
               );
                return 
# 38 "../crypto/pkcs12/p12_p8e.c" 3 4
                      ((void *)0)
# 38 "../crypto/pkcs12/p12_p8e.c"
                          ;
            }
            pbe = PKCS5_pbe2_set_iv_ex(cipher, iter, salt, saltlen, 
# 40 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                                   ((void *)0)
# 40 "../crypto/pkcs12/p12_p8e.c"
                                                                       ,
                                       pbe_nid, libctx);
        } else {
            ERR_pop_to_mark();
    ...
    if (pbe == 
# 47 "../crypto/pkcs12/p12_p8e.c" 3 4
              ((void *)0)
# 47 "../crypto/pkcs12/p12_p8e.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_p8e.c",48,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 48 "../crypto/pkcs12/p12_p8e.c" 3 4
       ((void *)0)
# 48 "../crypto/pkcs12/p12_p8e.c"
       );
        return 
# 49 "../crypto/pkcs12/p12_p8e.c" 3 4
              ((void *)0)
# 49 "../crypto/pkcs12/p12_p8e.c"
                  ;
    }
    p8 = PKCS8_set0_pbe_ex(pass, passlen, p8inf, pbe, libctx, propq);
    if (p8 == 
# 52 "../crypto/pkcs12/p12_p8e.c" 3 4
             ((void *)0)
# 52 "../crypto/pkcs12/p12_p8e.c"
                 ) {
        X509_ALGOR_free(pbe);
        return 
# 54 "../crypto/pkcs12/p12_p8e.c" 3 4
              ((void *)0)
# 54 "../crypto/pkcs12/p12_p8e.c"
                  ;
    }
                        ...
                        PKCS8_PRIV_KEY_INFO *p8inf)
{
    return PKCS8_encrypt_ex(pbe_nid, cipher, pass, passlen, salt, saltlen, iter,
                            p8inf, 
# 66 "../crypto/pkcs12/p12_p8e.c" 3 4
                                  ((void *)0)
# 66 "../crypto/pkcs12/p12_p8e.c"
                                      , 
# 66 "../crypto/pkcs12/p12_p8e.c" 3 4
                                        ((void *)0)
# 66 "../crypto/pkcs12/p12_p8e.c"
                            ...
                            OSSL_LIB_CTX *ctx, const char *propq)
{
    ...
    enckey =
        PKCS12_item_i2d_encrypt_ex(pbe, (PKCS8_PRIV_KEY_INFO_it()),
                                   pass, passlen, p8inf, 1, ctx, propq);
    if (!enckey) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_p8e.c",80,__func__), ERR_set_error)((35),(103),
# 80 "../crypto/pkcs12/p12_p8e.c" 3 4
       ((void *)0)
# 80 "../crypto/pkcs12/p12_p8e.c"
       );
        return 
# 81 "../crypto/pkcs12/p12_p8e.c" 3 4
              ((void *)0)
# 81 "../crypto/pkcs12/p12_p8e.c"
                  ;
    }

    p8 = CRYPTO_zalloc(sizeof(*p8), "../crypto/pkcs12/p12_p8e.c", 84);

    if (p8 == 
# 86 "../crypto/pkcs12/p12_p8e.c" 3 4
             ((void *)0)
# 86 "../crypto/pkcs12/p12_p8e.c"
                 ) {
        ASN1_OCTET_STRING_free(enckey);
        return 
# 88 "../crypto/pkcs12/p12_p8e.c" 3 4
              ((void *)0)
# 88 "../crypto/pkcs12/p12_p8e.c"
                  ;
    }
    p8->algor = pbe;
    p8->digest = enckey;
...
X509_SIG *PKCS8_set0_pbe(const char *pass, int passlen,
                         PKCS8_PRIV_KEY_INFO *p8inf, X509_ALGOR *pbe)
{
    return PKCS8_set0_pbe_ex(pass, passlen, p8inf, pbe, 
# 99 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                       ((void *)0)
# 99 "../crypto/pkcs12/p12_p8e.c"
                                                           , 
# 99 "../crypto/pkcs12/p12_p8e.c" 3 4
                                                             ((void *)0)
# 99 "../crypto/pkcs12/p12_p8e.c"
