# 0 "../crypto/pkcs12/p12_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_init.c"
# 10 "../crypto/pkcs12/p12_init.c"
...
# 22 "../crypto/pkcs12/p12_init.c" 3 4
                                  ((void *)0)
# 22 "../crypto/pkcs12/p12_init.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_init.c",23,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 23 "../crypto/pkcs12/p12_init.c" 3 4
       ((void *)0)
# 23 "../crypto/pkcs12/p12_init.c"
       );
        return 
# 24 "../crypto/pkcs12/p12_init.c" 3 4
              ((void *)0)
# 24 "../crypto/pkcs12/p12_init.c"
                  ;
    }
    ...
    if (!ossl_pkcs7_set1_propq(pkcs12->authsafes, propq)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_init.c",32,__func__), ERR_set_error)((35),((33 | (0x2 << 18L))),
# 32 "../crypto/pkcs12/p12_init.c" 3 4
       ((void *)0)
# 32 "../crypto/pkcs12/p12_init.c"
       );
        goto err;
    }
...
# 38 "../crypto/pkcs12/p12_init.c" 3 4
                                                                    ((void *)0)
# 38 "../crypto/pkcs12/p12_init.c"
                                                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_init.c",39,__func__), ERR_set_error)((35),((13 | (0x2 << 18L))),
# 39 "../crypto/pkcs12/p12_init.c" 3 4
           ((void *)0)
# 39 "../crypto/pkcs12/p12_init.c"
           );
            goto err;
        }
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_init.c",44,__func__), ERR_set_error)((35),(119),
# 44 "../crypto/pkcs12/p12_init.c" 3 4
       ((void *)0)
# 44 "../crypto/pkcs12/p12_init.c"
       );
        goto err;
    }
    return pkcs12;
 ...
 err:
    PKCS12_free(pkcs12);
    return 
# 51 "../crypto/pkcs12/p12_init.c" 3 4
          ((void *)0)
# 51 "../crypto/pkcs12/p12_init.c"
              ;
}

PKCS12 *PKCS12_init(int mode)
{
    return PKCS12_init_ex(mode, 
# 56 "../crypto/pkcs12/p12_init.c" 3 4
                               ((void *)0)
# 56 "../crypto/pkcs12/p12_init.c"
                                   , 
# 56 "../crypto/pkcs12/p12_init.c" 3 4
                                     ((void *)0)
# 56 "../crypto/pkcs12/p12_init.c"
...
{
    if (p12 == 
# 61 "../crypto/pkcs12/p12_init.c" 3 4
              ((void *)0) 
# 61 "../crypto/pkcs12/p12_init.c"
                   || p12->authsafes == 
# 61 "../crypto/pkcs12/p12_init.c" 3 4
                                        ((void *)0)
# 61 "../crypto/pkcs12/p12_init.c"
        ...
        return 
# 62 "../crypto/pkcs12/p12_init.c" 3 4
              ((void *)0)
# 62 "../crypto/pkcs12/p12_init.c"
                  ;
