# 0 "../crypto/pkcs12/p12_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_key.c"
# 10 "../crypto/pkcs12/p12_key.c"
...
# 16 "../crypto/pkcs12/p12_key.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../crypto/pkcs12/p12_key.c" 2
                          ...
                          OSSL_LIB_CTX *ctx, const char *propq)
{
    ...
    if (pass == 
# 28 "../crypto/pkcs12/p12_key.c" 3 4
               ((void *)0)
# 28 "../crypto/pkcs12/p12_key.c"
                   ) {
        unipass = 
# 29 "../crypto/pkcs12/p12_key.c" 3 4
                 ((void *)0)
# 29 "../crypto/pkcs12/p12_key.c"
                     ;
        uniplen = 0;
    } else if (!OPENSSL_asc2uni(pass, passlen, &unipass, &uniplen)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_key.c",32,__func__), ERR_set_error)((35),((35 | (0x2 << 18L))),
# 32 "../crypto/pkcs12/p12_key.c" 3 4
       ((void *)0)
# 32 "../crypto/pkcs12/p12_key.c"
       );
        return 0;
    }
    ret = PKCS12_key_gen_uni_ex(unipass, uniplen, salt, saltlen, id, iter,
                                n, out, md_type, ctx, propq);
    CRYPTO_clear_free(unipass, uniplen, "../crypto/pkcs12/p12_key.c", 37);
    return ret > 0;
}
                       ...
                       unsigned char *out, const EVP_MD *md_type)
{
    return PKCS12_key_gen_asc_ex(pass, passlen, salt, saltlen, id, iter, n,
                                  out, md_type, 
# 46 "../crypto/pkcs12/p12_key.c" 3 4
                                               ((void *)0)
# 46 "../crypto/pkcs12/p12_key.c"
                                                   , 
# 46 "../crypto/pkcs12/p12_key.c" 3 4
                                                     ((void *)0)
# 46 "../crypto/pkcs12/p12_key.c"
                           ...
                           OSSL_LIB_CTX *ctx, const char *propq)
{
    ...
    if (pass == 
# 58 "../crypto/pkcs12/p12_key.c" 3 4
               ((void *)0)
# 58 "../crypto/pkcs12/p12_key.c"
                   ) {
        unipass = 
# 59 "../crypto/pkcs12/p12_key.c" 3 4
                 ((void *)0)
# 59 "../crypto/pkcs12/p12_key.c"
                     ;
        uniplen = 0;
    } else if (!OPENSSL_utf82uni(pass, passlen, &unipass, &uniplen)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs12/p12_key.c",62,__func__), ERR_set_error)((35),((35 | (0x2 << 18L))),
# 62 "../crypto/pkcs12/p12_key.c" 3 4
       ((void *)0)
# 62 "../crypto/pkcs12/p12_key.c"
       );
        return 0;
    }
    ret = PKCS12_key_gen_uni_ex(unipass, uniplen, salt, saltlen, id, iter,
                                n, out, md_type, ctx, propq);
    CRYPTO_clear_free(unipass, uniplen, "../crypto/pkcs12/p12_key.c", 67);
    return ret > 0;
}
                        ...
                        unsigned char *out, const EVP_MD *md_type)
{
    return PKCS12_key_gen_utf8_ex(pass, passlen, salt, saltlen, id, iter, n,
                                  out, md_type, 
# 76 "../crypto/pkcs12/p12_key.c" 3 4
                                               ((void *)0)
# 76 "../crypto/pkcs12/p12_key.c"
                                                   , 
# 76 "../crypto/pkcs12/p12_key.c" 3 4
                                                     ((void *)0)
# 76 "../crypto/pkcs12/p12_key.c"
                          ...
                          OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (kdf == 
# 93 "../crypto/pkcs12/p12_key.c" 3 4
              ((void *)0)
# 93 "../crypto/pkcs12/p12_key.c"
                  )
        return 0;
    ctx = EVP_KDF_CTX_new(kdf);
    EVP_KDF_free(kdf);
    if (ctx == 
# 97 "../crypto/pkcs12/p12_key.c" 3 4
              ((void *)0)
# 97 "../crypto/pkcs12/p12_key.c"
                  )
        return 0;
    ...
    *p++ = OSSL_PARAM_construct_octet_string("salt",
                                             salt, saltlen);
    *p++ = OSSL_PARAM_construct_int("id", &id);
    *p++ = OSSL_PARAM_construct_int("iter", &iter);
    *p = OSSL_PARAM_construct_end();

    do { BIO *trc_out = 
# 111 "../crypto/pkcs12/p12_key.c" 3 4
   ((void *)0)
# 111 "../crypto/pkcs12/p12_key.c"
   ; if (0) {
    ...
    if (EVP_KDF_derive(ctx, out, (size_t)n, params)) {
        res = 1;
        do { BIO *trc_out = 
# 123 "../crypto/pkcs12/p12_key.c" 3 4
       ((void *)0)
# 123 "../crypto/pkcs12/p12_key.c"
       ; if (0) {
...
int PKCS12_key_gen_uni(unsigned char *pass, int passlen, unsigned char *salt,
                       ...
                       unsigned char *out, const EVP_MD *md_type)
{
    return PKCS12_key_gen_uni_ex(pass, passlen, salt, saltlen, id, iter, n, out, md_type, 
# 137 "../crypto/pkcs12/p12_key.c" 3 4
                                                                                         ((void *)0)
# 137 "../crypto/pkcs12/p12_key.c"
                                                                                             , 
# 137 "../crypto/pkcs12/p12_key.c" 3 4
                                                                                               ((void *)0)
# 137 "../crypto/pkcs12/p12_key.c"
