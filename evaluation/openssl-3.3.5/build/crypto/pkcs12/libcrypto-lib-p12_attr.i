# 0 "../crypto/pkcs12/p12_attr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs12/p12_attr.c"
# 10 "../crypto/pkcs12/p12_attr.c"
                          ...
                          int namelen)
{
    if (X509at_add1_attr_by_NID(&bag->attrib, 157,
                                4, name, namelen) != 
# 21 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                      ((void *)0)
# 21 "../crypto/pkcs12/p12_attr.c"
                                                                          )
        return 1;
    else
        return 0;
...
int PKCS8_add_keyusage(PKCS8_PRIV_KEY_INFO *p8, int usage)
{
    ...
    return PKCS8_pkey_add1_attr_by_NID(p8, 83,
                                       3, &us_val, 1);
}
...
# 42 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                                ((void *)0)
# 42 "../crypto/pkcs12/p12_attr.c"
                                                                                    )
        return 1;
    else
        return 0;
...
{
    if (X509at_add1_attr_by_NID(&bag->attrib, 156,
                                (0x1000), (unsigned char *)name, namelen) != 
# 52 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                                 ((void *)0)
# 52 "../crypto/pkcs12/p12_attr.c"
                                                                                     )
        return 1;
    else
        return 0;
...
# 62 "../crypto/pkcs12/p12_attr.c" 3 4
                                                               ((void *)0)
# 62 "../crypto/pkcs12/p12_attr.c"
                                                                   )
        return 1;
    else
        return 0;
...
int PKCS12_add_CSPName_asc(PKCS12_SAFEBAG *bag, const char *name, int namelen)
{
    if (X509at_add1_attr_by_NID(&bag->attrib, 417,
                                (0x1000|1), (unsigned char *)name, namelen) != 
# 71 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                                ((void *)0)
# 71 "../crypto/pkcs12/p12_attr.c"
                                                                                    )
        return 1;
    else
        return 0;
...
# 80 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                       ((void *)0)
# 80 "../crypto/pkcs12/p12_attr.c"
                                                                           )
        return 1;
    else
        return 0;
...
# 89 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                            ((void *)0)
# 89 "../crypto/pkcs12/p12_attr.c"
                                                                                )
        return 1;
    else
        return 0;
                               ...
                               int attr_nid)
{
    ...
    if (i < 0)
        return 
# 101 "../crypto/pkcs12/p12_attr.c" 3 4
              ((void *)0)
# 101 "../crypto/pkcs12/p12_attr.c"
                  ;
...
char *PKCS12_get_friendlyname(PKCS12_SAFEBAG *bag)
{
    ...
    if ((atype = PKCS12_SAFEBAG_get0_attr(bag, 156)) == 
# 109 "../crypto/pkcs12/p12_attr.c" 3 4
                                                                    ((void *)0)
# 109 "../crypto/pkcs12/p12_attr.c"
                                                                        )
        return 
# 110 "../crypto/pkcs12/p12_attr.c" 3 4
              ((void *)0)
# 110 "../crypto/pkcs12/p12_attr.c"
                  ;
    if (atype->type != 30)
        return 
# 112 "../crypto/pkcs12/p12_attr.c" 3 4
              ((void *)0)
# 112 "../crypto/pkcs12/p12_attr.c"
                  ;
...
{
    if (bag->attrib != attrs)
       OPENSSL_sk_free(ossl_check_X509_ATTRIBUTE_sk_type(bag->attrib));
