# 0 "../crypto/aes/aes_ige.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/aes/aes_ige.c"
# 14 "../crypto/aes/aes_ige.c"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 19 "../crypto/aes/aes_ige.c" 2
# 1 "../crypto/aes/aes_local.h" 1
# 27 "../crypto/aes/aes_local.h"
                     ...
                     unsigned char *ivec, const int enc)
{
    ...
    (void)((in && out && key && ivec) ? 0 : (OPENSSL_die("assertion failed: " "in && out && key && ivec", "../crypto/aes/aes_ige.c", 58), 1));
    (void)(((1 == enc) || (0 == enc)) ? 0 : (OPENSSL_die("assertion failed: " "(AES_ENCRYPT == enc) || (AES_DECRYPT == enc)", "../crypto/aes/aes_ige.c", 59), 1));
    (void)(((length % 16) == 0) ? 0 : (OPENSSL_die("assertion failed: " "(length % AES_BLOCK_SIZE) == 0", "../crypto/aes/aes_ige.c", 60), 1));
                        ...
                        const int enc)
{
    ...
    (void)((in && out && key && ivec) ? 0 : (OPENSSL_die("assertion failed: " "in && out && key && ivec", "../crypto/aes/aes_ige.c", 200), 1));
    (void)(((1 == enc) || (0 == enc)) ? 0 : (OPENSSL_die("assertion failed: " "(AES_ENCRYPT == enc) || (AES_DECRYPT == enc)", "../crypto/aes/aes_ige.c", 201), 1));
    (void)(((length % 16) == 0) ? 0 : (OPENSSL_die("assertion failed: " "(length % AES_BLOCK_SIZE) == 0", "../crypto/aes/aes_ige.c", 202), 1));
