# 0 "../crypto/async/arch/async_posix.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/async/arch/async_posix.c"
# 11 "../crypto/async/arch/async_posix.c"
# 1 "../crypto/async/arch/../async_local.h" 1
# 23 "../crypto/async/arch/../async_local.h"
...
# 24 "../crypto/async/arch/../async_local.h" 2
...
# 25 "../crypto/async/arch/../async_local.h" 2

typedef struct async_ctx_st async_ctx;
typedef struct async_pool_st async_pool;

# 1 "../crypto/async/arch/../arch/async_win.h" 1
# 30 "../crypto/async/arch/../async_local.h" 2
# 1 "../crypto/async/arch/../arch/async_posix.h" 1
# 18 "../crypto/async/arch/../arch/async_posix.h"
...
# 19 "../crypto/async/arch/../arch/async_posix.h" 2
# 51 "../crypto/async/arch/../arch/async_posix.h"
...
# 52 "../crypto/async/arch/../arch/async_posix.h" 2
...
# 54 "../crypto/async/arch/../arch/async_posix.h" 2



# 56 "../crypto/async/arch/../arch/async_posix.h"
...
# 31 "../crypto/async/arch/../async_local.h" 2
# 1 "../crypto/async/arch/../arch/async_null.h" 1
# 32 "../crypto/async/arch/../async_local.h" 2
...
# 12 "../crypto/async/arch/async_posix.c" 2



# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 16 "../crypto/async/arch/async_posix.c" 2
...
# 18 "../crypto/async/arch/async_posix.c" 2
...
int async_local_init(void)
{
    ...
    return async_mem_lock != 
# 30 "../crypto/async/arch/async_posix.c" 3 4
                            ((void *)0)
# 30 "../crypto/async/arch/async_posix.c"
                                ;
}
...
int ASYNC_set_mem_functions(ASYNC_stack_alloc_fn alloc_fn,
                            ASYNC_stack_free_fn free_fn)
{
    OPENSSL_init_crypto(0x00000100L, 
# 56 "../crypto/async/arch/async_posix.c" 3 4
                                           ((void *)0)
# 56 "../crypto/async/arch/async_posix.c"
                                               );
    ...
    if (alloc_fn != 
# 66 "../crypto/async/arch/async_posix.c" 3 4
                   ((void *)0)
# 66 "../crypto/async/arch/async_posix.c"
                       )
        stack_alloc_impl = alloc_fn;
    if (free_fn != 
# 68 "../crypto/async/arch/async_posix.c" 3 4
                  ((void *)0)
# 68 "../crypto/async/arch/async_posix.c"
                      )
...
{
    if (alloc_fn != 
# 76 "../crypto/async/arch/async_posix.c" 3 4
                   ((void *)0)
# 76 "../crypto/async/arch/async_posix.c"
                       )
        *alloc_fn = stack_alloc_impl;
    if (free_fn != 
# 78 "../crypto/async/arch/async_posix.c" 3 4
                  ((void *)0)
# 78 "../crypto/async/arch/async_posix.c"
                      )
...
static void *async_stack_alloc(size_t *num)
{
    return CRYPTO_malloc(*num, "../crypto/async/arch/async_posix.c", 84);
}

static void async_stack_free(void *addr)
{
    CRYPTO_free(addr, "../crypto/async/arch/async_posix.c", 89);
}
...
# 116 "../crypto/async/arch/async_posix.c" 3 4
                                          ((void *)0)
# 116 "../crypto/async/arch/async_posix.c"
                                              ) {
            fibre->fibre.uc_stack.ss_size = num;
            fibre->fibre.uc_link = 
# 118 "../crypto/async/arch/async_posix.c" 3 4
                                  ((void *)0)
# 118 "../crypto/async/arch/async_posix.c"
                                      ;
            makecontext(&fibre->fibre, async_start_func, 0);
            return 1;
        }
    } else {
        fibre->fibre.uc_stack.ss_sp = 
# 123 "../crypto/async/arch/async_posix.c" 3 4
                                     ((void *)0)
# 123 "../crypto/async/arch/async_posix.c"
                                         ;
    }
    return 0;
}
...
void async_fibre_free(async_fibre *fibre)
{
    ...
    fibre->fibre.uc_stack.ss_sp = 
# 131 "../crypto/async/arch/async_posix.c" 3 4
                                 ((void *)0)
# 131 "../crypto/async/arch/async_posix.c"
                                     ;
}
