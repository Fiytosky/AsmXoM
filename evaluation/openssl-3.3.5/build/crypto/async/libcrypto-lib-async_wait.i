# 0 "../crypto/async/async_wait.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/async/async_wait.c"
# 11 "../crypto/async/async_wait.c"
...
# 12 "../crypto/async/async_wait.c" 2
...
# 14 "../crypto/async/async_wait.c" 2

ASYNC_WAIT_CTX *ASYNC_WAIT_CTX_new(void)
{
    return CRYPTO_zalloc(sizeof(ASYNC_WAIT_CTX), "../crypto/async/async_wait.c", 17);
}
...
void ASYNC_WAIT_CTX_free(ASYNC_WAIT_CTX *ctx)
{
    ...
    if (ctx == 
# 25 "../crypto/async/async_wait.c" 3 4
              ((void *)0)
# 25 "../crypto/async/async_wait.c"
                  )
        return;

    curr = ctx->fds;
    while (curr != 
# 29 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 29 "../crypto/async/async_wait.c"
                      ) {
        if (!curr->del) {

            if (curr->cleanup != 
# 32 "../crypto/async/async_wait.c" 3 4
                                ((void *)0)
# 32 "../crypto/async/async_wait.c"
                                    )
                curr->cleanup(ctx, curr->key, curr->fd, curr->custom_data);
        }

        next = curr->next;
        CRYPTO_free(curr, "../crypto/async/async_wait.c", 37);
        curr = next;
    }

    CRYPTO_free(ctx, "../crypto/async/async_wait.c", 41);
}
int ASYNC_WAIT_CTX_set_wait_fd(ASYNC_WAIT_CTX *ctx, const void *key,
                               int fd, void *custom_data,
                               void (*cleanup)(ASYNC_WAIT_CTX *, const void *,
                                               int, void *))
{
    ...
    if ((fdlookup = CRYPTO_zalloc(sizeof(*fdlookup), "../crypto/async/async_wait.c", 50)) == 
# 50 "../crypto/async/async_wait.c" 3 4
                                                         ((void *)0)
# 50 "../crypto/async/async_wait.c"
                                                             )
        return 0;
                          ...
                          int *fd, void **custom_data)
{
    ...
    curr = ctx->fds;
    while (curr != 
# 70 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 70 "../crypto/async/async_wait.c"
                      ) {
        if (curr->del) {
                               ...
                               size_t *numfds)
{
    ...
    *numfds = 0;
    while (curr != 
# 93 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 93 "../crypto/async/async_wait.c"
                      ) {
        if (curr->del) {
        ...
        if (fd != 
# 99 "../crypto/async/async_wait.c" 3 4
                 ((void *)0)
# 99 "../crypto/async/async_wait.c"
                     ) {
            *fd = curr->fd;
            fd++;
        }
                                   ...
                                   size_t *numdelfds)
{
    ...
    *numdelfds = ctx->numdel;
    if (addfd == 
# 117 "../crypto/async/async_wait.c" 3 4
                ((void *)0) 
# 117 "../crypto/async/async_wait.c"
                     && delfd == 
# 117 "../crypto/async/async_wait.c" 3 4
                                 ((void *)0)
# 117 "../crypto/async/async_wait.c"
    ...
    while (curr != 
# 122 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 122 "../crypto/async/async_wait.c"
                      ) {

        if (curr->del && !curr->add && (delfd != 
# 124 "../crypto/async/async_wait.c" 3 4
                                                ((void *)0)
# 124 "../crypto/async/async_wait.c"
                                                    )) {
            *delfd = curr->fd;
            delfd++;
        }
        if (curr->add && !curr->del && (addfd != 
# 128 "../crypto/async/async_wait.c" 3 4
                                                ((void *)0)
# 128 "../crypto/async/async_wait.c"
                                                    )) {
            *addfd = curr->fd;
            addfd++;
        }
...
int ASYNC_WAIT_CTX_clear_fd(ASYNC_WAIT_CTX *ctx, const void *key)
{
    ...
    curr = ctx->fds;
    prev = 
# 143 "../crypto/async/async_wait.c" 3 4
          ((void *)0)
# 143 "../crypto/async/async_wait.c"
              ;
    while (curr != 
# 144 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 144 "../crypto/async/async_wait.c"
                      ) {
        if (curr->del == 1) {
        ...
        if (curr->key == key) {
            ...
            if (curr->add == 1) {
                ...
                CRYPTO_free(curr, "../crypto/async/async_wait.c", 163);
                ctx->numadd--;
                return 1;
            }
...
{
      if (ctx == 
# 187 "../crypto/async/async_wait.c" 3 4
                ((void *)0)
# 187 "../crypto/async/async_wait.c"
                    )
          return 0;
...
{
      if (ctx->callback == 
# 199 "../crypto/async/async_wait.c" 3 4
                          ((void *)0)
# 199 "../crypto/async/async_wait.c"
                              )
          return 0;
...
{
    struct fd_lookup_st *curr, *prev = 
# 220 "../crypto/async/async_wait.c" 3 4
                                      ((void *)0)
# 220 "../crypto/async/async_wait.c"
                                          ;
    ...
    while (curr != 
# 227 "../crypto/async/async_wait.c" 3 4
                  ((void *)0)
# 227 "../crypto/async/async_wait.c"
                      ) {
        if (curr->del) {
            if (prev == 
# 229 "../crypto/async/async_wait.c" 3 4
                       ((void *)0)
# 229 "../crypto/async/async_wait.c"
                           )
                ctx->fds = curr->next;
            else
                prev->next = curr->next;
            CRYPTO_free(curr, "../crypto/async/async_wait.c", 233);
            if (prev == 
# 234 "../crypto/async/async_wait.c" 3 4
                       ((void *)0)
# 234 "../crypto/async/async_wait.c"
                           )
                curr = ctx->fds;
            else
                curr = prev->next;
