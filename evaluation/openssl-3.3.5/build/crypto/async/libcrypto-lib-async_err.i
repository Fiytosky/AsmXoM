# 0 "../crypto/async/async_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/async/async_err.c"
# 11 "../crypto/async/async_err.c"
...
# 14 "../crypto/async/async_err.c" 2



static const ERR_STRING_DATA ASYNC_str_reasons[] = {
    {( (((unsigned long)(51) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "failed to set pool"},
    {( (((unsigned long)(51) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "failed to swap context"},
    {( (((unsigned long)(51) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "init failed"},
    {( (((unsigned long)(51) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "invalid pool size"},
    {0, 
# 25 "../crypto/async/async_err.c" 3 4
       ((void *)0)
# 25 "../crypto/async/async_err.c"
           }
};
...
int ossl_err_load_ASYNC_strings(void)
{
    ...
    if (ERR_reason_error_string(ASYNC_str_reasons[0].error) == 
# 33 "../crypto/async/async_err.c" 3 4
                                                              ((void *)0)
# 33 "../crypto/async/async_err.c"
                                                                  )
