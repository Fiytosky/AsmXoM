# 0 "../crypto/http/http_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/http/http_err.c"
# 11 "../crypto/http/http_err.c"
...
static const ERR_STRING_DATA HTTP_str_reasons[] = {
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "asn1 len exceeds max resp len"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "connect failure"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "error parsing asn1 length"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "error parsing content length"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "error parsing url"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "error receiving"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "error sending"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "failed reading data"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "header parse error"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "inconsistent content length"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "invalid port number"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "invalid url path"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "invalid url scheme"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "max resp len exceeded"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "missing asn1 encoding"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "missing content type"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "missing redirect location"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "received error"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "received wrong http version"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "redirection from https to http"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "redirection not enabled"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "response line too long"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "response parse error"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "response too many hdrlines"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "retry timeout"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "server canceled connection"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "sock not supported"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "status code unsupported"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "tls not enabled"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "too many redirections"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "unexpected content type"},
    {0, 
# 74 "../crypto/http/http_err.c" 3 4
       ((void *)0)
# 74 "../crypto/http/http_err.c"
           }
};
...
int ossl_err_load_HTTP_strings(void)
{
    ...
    if (ERR_reason_error_string(HTTP_str_reasons[0].error) == 
# 82 "../crypto/http/http_err.c" 3 4
                                                             ((void *)0)
# 82 "../crypto/http/http_err.c"
                                                                 )
