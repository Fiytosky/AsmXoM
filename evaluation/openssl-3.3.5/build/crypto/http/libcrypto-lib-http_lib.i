# 0 "../crypto/http/http_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/http/http_lib.c"
# 10 "../crypto/http/http_lib.c"
...
void OSSL_HTTP_REQ_CTX_set_max_response_hdr_lines(OSSL_HTTP_REQ_CTX *rctx,
                                                  size_t count);
# 13 "../crypto/http/http_lib.c" 2
# 1 "../include/openssl/httperr.h" 1
# 13 "../include/openssl/httperr.h"
        
# 14 "../crypto/http/http_lib.c" 2
...
# 24 "../crypto/http/http_lib.c" 2

static void init_pstring(char **pstr)
{
    if (pstr != 
# 27 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 27 "../crypto/http/http_lib.c"
                   ) {
        *pstr = 
# 28 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 28 "../crypto/http/http_lib.c"
                   ;
    }
}
...
{
    if (pint != 
# 34 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 34 "../crypto/http/http_lib.c"
                   ) {
        *pint = 0;
    }
}
...
{
    return dest == 
# 41 "../crypto/http/http_lib.c" 3 4
                  ((void *)0)
        
# 42 "../crypto/http/http_lib.c"
       || (*dest = CRYPTO_strndup(start, end - start, "../crypto/http/http_lib.c", 42)) != 
# 42 "../crypto/http/http_lib.c" 3 4
                                                           ((void *)0)
# 42 "../crypto/http/http_lib.c"
                                                               ;
}
...
{
    if (pstr != 
# 47 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 47 "../crypto/http/http_lib.c"
                   ) {
        CRYPTO_free(*pstr, "../crypto/http/http_lib.c", 48);
        *pstr = 
# 49 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 49 "../crypto/http/http_lib.c"
                   ;
    }
}
                   ...
                   char **ppath, char **pquery, char **pfrag)
{
    ...
    if (url == 
# 76 "../crypto/http/http_lib.c" 3 4
              ((void *)0)
# 76 "../crypto/http/http_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/http/http_lib.c",77,__func__), ERR_set_error)((61),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 77 "../crypto/http/http_lib.c" 3 4
       ((void *)0)
# 77 "../crypto/http/http_lib.c"
       );
        return 0;
    }
    ...
    p = strstr(url, "://");
    if (p == 
# 84 "../crypto/http/http_lib.c" 3 4
            ((void *)0)
# 84 "../crypto/http/http_lib.c"
                ) {
        p = url;
    } else {
        scheme_end = p;
    ...
    host = strchr(p, '@');
    if (host != 
# 96 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 96 "../crypto/http/http_lib.c"
                   )
        user_end = host++;
    else
        host = p;
    ...
    if (host[0] == '[') {
        ...
        if (host_end == 
# 105 "../crypto/http/http_lib.c" 3 4
                       ((void *)0)
# 105 "../crypto/http/http_lib.c"
                           )
            goto parse_err;
        p = ++host_end;
    } else {
        ...
        if (host_end == 
# 111 "../crypto/http/http_lib.c" 3 4
                       ((void *)0)
# 111 "../crypto/http/http_lib.c"
                           )
    ...
    if (sscanf(port, "%u", &portnum) <= 0 || portnum > 65535) {
        (ERR_new(), ERR_set_debug("../crypto/http/http_lib.c",123,__func__), ERR_set_error)(61, 123, "%s", port);
        goto err;
    }
    ...
    if (*path != '\0' && *path != '/' && *path != '?' && *path != '#') {
        (ERR_new(), ERR_set_debug("../crypto/http/http_lib.c",134,__func__), ERR_set_error)((61),(125),
# 134 "../crypto/http/http_lib.c" 3 4
       ((void *)0)
# 134 "../crypto/http/http_lib.c"
       );
        goto parse_err;
    }
    ...
    tmp = strchr(p, '?');
    if (tmp != 
# 141 "../crypto/http/http_lib.c" 3 4
              ((void *)0)
# 141 "../crypto/http/http_lib.c"
                  ) {
        p = tmp;
        if (pquery != 
# 143 "../crypto/http/http_lib.c" 3 4
                     ((void *)0)
# 143 "../crypto/http/http_lib.c"
                         ) {
            path_end = p;
            query = p + 1;
        }
    ...
    tmp = strchr(p, '#');
    if (tmp != 
# 151 "../crypto/http/http_lib.c" 3 4
              ((void *)0)
# 151 "../crypto/http/http_lib.c"
                  ) {
        if (query == path_end)
            path_end = tmp;
        query_end = tmp;
    ...
    if (!copy_substring(pscheme, scheme, scheme_end)
        ...
        goto err;
    if (pport_num != 
# 165 "../crypto/http/http_lib.c" 3 4
                    ((void *)0)
# 165 "../crypto/http/http_lib.c"
                        )
...
# 170 "../crypto/http/http_lib.c" 3 4
                       ((void *)0)
# 170 "../crypto/http/http_lib.c"
                           ) {
        size_t buflen = 1 + path_end - path + 1;

        if ((*ppath = CRYPTO_malloc(buflen, "../crypto/http/http_lib.c", 173)) == 
# 173 "../crypto/http/http_lib.c" 3 4
                                                ((void *)0)
# 173 "../crypto/http/http_lib.c"
                                                    )
            goto err;
 ...
 parse_err:
    (ERR_new(), ERR_set_debug("../crypto/http/http_lib.c",180,__func__), ERR_set_error)((61),(101),
# 180 "../crypto/http/http_lib.c" 3 4
   ((void *)0)
# 180 "../crypto/http/http_lib.c"
   );
                        ...
                        char **ppath, char **pquery, char **pfrag)
{
    ...
    init_pstring(pport);
    if (pssl != 
# 201 "../crypto/http/http_lib.c" 3 4
               ((void *)0)
# 201 "../crypto/http/http_lib.c"
                   )
        *pssl = 0;
    ...
    if (strcmp(scheme, "https") == 0) {
        ssl = 1;
        if (pssl != 
# 210 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
# 210 "../crypto/http/http_lib.c"
                       )
            *pssl = ssl;
    } else if (*scheme != '\0' && strcmp(scheme, "http") != 0) {
        (ERR_new(), ERR_set_debug("../crypto/http/http_lib.c",213,__func__), ERR_set_error)((61),(124),
# 213 "../crypto/http/http_lib.c" 3 4
       ((void *)0)
# 213 "../crypto/http/http_lib.c"
       );
        CRYPTO_free(scheme, "../crypto/http/http_lib.c", 214);
        CRYPTO_free(port, "../crypto/http/http_lib.c", 215);
        goto err;
    }
    CRYPTO_free(scheme, "../crypto/http/http_lib.c", 218);

    if (strcmp(port, "0") == 0) {

        CRYPTO_free(port, "../crypto/http/http_lib.c", 222);
        port = ssl ? "443" : "80";
        if (!__builtin_expect(!!((sscanf(port, "%d", &portnum) == 1) != 0), 1))
            goto err;
        if (pport_num != 
# 226 "../crypto/http/http_lib.c" 3 4
                        ((void *)0)
# 226 "../crypto/http/http_lib.c"
                            )
            *pport_num = portnum;
        if (pport != 
# 228 "../crypto/http/http_lib.c" 3 4
                    ((void *)0)
# 228 "../crypto/http/http_lib.c"
                        ) {
            *pport = CRYPTO_strdup(port, "../crypto/http/http_lib.c", 229);
            if (*pport == 
# 230 "../crypto/http/http_lib.c" 3 4
                         ((void *)0)
# 230 "../crypto/http/http_lib.c"
                             )
                goto err;
        }
    } else {
        if (pport != 
# 234 "../crypto/http/http_lib.c" 3 4
                    ((void *)0)
# 234 "../crypto/http/http_lib.c"
                        )
            *pport = port;
        else
            CRYPTO_free(port, "../crypto/http/http_lib.c", 237);
    }
    return 1;
...
static int use_proxy(const char *no_proxy, const char *server)
{
    size_t sl;
    const char *found = 
# 254 "../crypto/http/http_lib.c" 3 4
                       ((void *)0)
# 254 "../crypto/http/http_lib.c"
                           ;
    char host[
# 255 "../crypto/http/http_lib.c" 3 4
             1025
# 255 "../crypto/http/http_lib.c"
                       ];

    if (!__builtin_expect(!!((server != 
# 257 "../crypto/http/http_lib.c" 3 4
        ((void *)0)
# 257 "../crypto/http/http_lib.c"
        ) != 0), 1))
        return 0;
    sl = strlen(server);
    ...
    if (no_proxy == 
# 272 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
# 272 "../crypto/http/http_lib.c"
                       )
        no_proxy = ossl_safe_getenv("no_proxy");
    if (no_proxy == 
# 274 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
# 274 "../crypto/http/http_lib.c"
                       )
        no_proxy = ossl_safe_getenv("NO_PROXY");

    if (no_proxy != 
# 277 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
# 277 "../crypto/http/http_lib.c"
                       )
        found = strstr(no_proxy, server);
    while (found != 
# 279 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
           
# 280 "../crypto/http/http_lib.c"
          && ((found != no_proxy && !(ossl_ctype_check((found[-1]), 0x8)) && found[-1] != ',')
               || (found[sl] != '\0' && !(ossl_ctype_check((found[sl]), 0x8)) && found[sl] != ',')))
        found = strstr(found + 1, server);
    return found == 
# 283 "../crypto/http/http_lib.c" 3 4
                   ((void *)0)
# 283 "../crypto/http/http_lib.c"
                       ;
}
                                  ...
                                  const char *server, int use_ssl)
{
    ...
    if (proxy == 
# 294 "../crypto/http/http_lib.c" 3 4
                ((void *)0)
# 294 "../crypto/http/http_lib.c"
                    )
        proxy = ossl_safe_getenv(use_ssl ? "https_proxy" : "http_proxy");
    if (proxy == 
# 296 "../crypto/http/http_lib.c" 3 4
                ((void *)0)
# 296 "../crypto/http/http_lib.c"
                    )
        proxy = ossl_safe_getenv(use_ssl ? "HTTPS_PROXY" : "HTTP_PROXY");

    if (proxy == 
# 299 "../crypto/http/http_lib.c" 3 4
                ((void *)0) 
# 299 "../crypto/http/http_lib.c"
                     || *proxy == '\0' || !use_proxy(no_proxy, server))
        return 
# 300 "../crypto/http/http_lib.c" 3 4
              ((void *)0)
# 300 "../crypto/http/http_lib.c"
                  ;
    return proxy;
}
