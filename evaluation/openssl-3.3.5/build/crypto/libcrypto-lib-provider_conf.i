...
void *ossl_prov_conf_ctx_new(OSSL_LIB_CTX *libctx)
{
    ...
    if (pcgbl == 
# 34 "../crypto/provider_conf.c" 3 4
                ((void *)0)
# 34 "../crypto/provider_conf.c"
                    )
        return 
# 35 "../crypto/provider_conf.c" 3 4
              ((void *)0)
# 35 "../crypto/provider_conf.c"
                  ;

    pcgbl->lock = CRYPTO_THREAD_lock_new();
    if (pcgbl->lock == 
# 38 "../crypto/provider_conf.c" 3 4
                      ((void *)0)
# 38 "../crypto/provider_conf.c"
                          ) {
        CRYPTO_free(pcgbl, "../crypto/provider_conf.c", 39);
        return 
# 40 "../crypto/provider_conf.c" 3 4
              ((void *)0)
# 40 "../crypto/provider_conf.c"
                  ;
    }
...
static const char *skip_dot(const char *name)
{
    ...
    if (p != 
# 62 "../crypto/provider_conf.c" 3 4
            ((void *)0)
# 62 "../crypto/provider_conf.c"
                )
        return p + 1;
    return name;
}
...
static int provider_conf_params_internal(OSSL_PROVIDER *prov,
                                         ...
                                         const CONF *cnf,
                                         struct stack_st_OPENSSL_CSTRING *visited)
{
    ...
    if (sect != 
# 85 "../crypto/provider_conf.c" 3 4
               ((void *)0)
# 85 "../crypto/provider_conf.c"
                   ) {
        int i;
        char buffer[512];
        size_t buffer_len = 0;
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OPENSSL_CSTRING_sk_type(visited)); i++) {
            if (((const char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(visited), (i))) == value) {
                (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",100,__func__), ERR_set_error)((14),(126),
# 100 "../crypto/provider_conf.c" 3 4
               ((void *)0)
# 100 "../crypto/provider_conf.c"
               );
                return -1;
            }
        }
        ...
        if (!OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(visited), ossl_check_OPENSSL_CSTRING_type(value)))
            return -1;

        if (name != 
# 111 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 111 "../crypto/provider_conf.c"
                       ) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sect)); i++) {
            CONF_VALUE *sectconf = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sect), (i)));

            if (buffer_len + strlen(sectconf->name) >= sizeof(buffer)) {
                ((const char *)OPENSSL_sk_pop(ossl_check_OPENSSL_CSTRING_sk_type(visited)));
                return -1;
            }
            buffer[buffer_len] = '\0';
        ...
        ((void)0);
        if (prov != 
# 138 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 138 "../crypto/provider_conf.c"
                       )
...
{
    int rc;
    struct stack_st_OPENSSL_CSTRING *visited = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new_null());

    if (visited == 
# 163 "../crypto/provider_conf.c" 3 4
                  ((void *)0)
# 163 "../crypto/provider_conf.c"
                      )
        return -1;
    ...
    OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(visited));

    return rc;
}

static int prov_already_activated(const char *name,
                                  struct stack_st_OSSL_PROVIDER *activated)
{
    int i, max;

    if (activated == 
# 179 "../crypto/provider_conf.c" 3 4
                    ((void *)0)
# 179 "../crypto/provider_conf.c"
                        )
        return 0;
                                  ...
                                  int soft, const CONF *cnf)
{
    PROVIDER_CONF_GLOBAL *pcgbl
        = ossl_lib_ctx_get_data(libctx, 16);
    OSSL_PROVIDER *prov = 
# 207 "../crypto/provider_conf.c" 3 4
                         ((void *)0)
# 207 "../crypto/provider_conf.c"
                             , *actual = 
# 207 "../crypto/provider_conf.c" 3 4
                                         ((void *)0)
# 207 "../crypto/provider_conf.c"
    ...
    if (pcgbl == 
# 210 "../crypto/provider_conf.c" 3 4
                ((void *)0) 
# 210 "../crypto/provider_conf.c"
                     || !CRYPTO_THREAD_write_lock(pcgbl->lock)) {
        (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",211,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 211 "../crypto/provider_conf.c" 3 4
       ((void *)0)
# 211 "../crypto/provider_conf.c"
       );
        return -1;
    }
    if (!prov_already_activated(name, pcgbl->activated_providers)) {
        ...
        if (!ossl_provider_disable_fallback_loading(libctx)) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",224,__func__), ERR_set_error)((15),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 224 "../crypto/provider_conf.c" 3 4
           ((void *)0)
# 224 "../crypto/provider_conf.c"
           );
            return -1;
        }
        prov = ossl_provider_find(libctx, name, 1);
        if (prov == 
# 228 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 228 "../crypto/provider_conf.c"
                       )
            prov = ossl_provider_new(libctx, name, 
# 229 "../crypto/provider_conf.c" 3 4
                                                  ((void *)0)
# 229 "../crypto/provider_conf.c"
                                                      , 
# 229 "../crypto/provider_conf.c" 3 4
                                                        ((void *)0)
# 229 "../crypto/provider_conf.c"
                                                            , 1);
        if (prov == 
# 230 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 230 "../crypto/provider_conf.c"
                       ) {
            CRYPTO_THREAD_unlock(pcgbl->lock);
            if (soft)
                ERR_clear_error();
        ...
        if (path != 
# 237 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 237 "../crypto/provider_conf.c"
                       )
            ossl_provider_set_module_path(prov, path);

        ok = provider_conf_params(prov, 
# 240 "../crypto/provider_conf.c" 3 4
                                       ((void *)0)
# 240 "../crypto/provider_conf.c"
                                           , 
# 240 "../crypto/provider_conf.c" 3 4
                                             ((void *)0)
# 240 "../crypto/provider_conf.c"
        ...
        if (ok == 1) {
            if (!ossl_provider_activate(prov, 1, 0)) {
                ...
                if (pcgbl->activated_providers == 
# 253 "../crypto/provider_conf.c" 3 4
                                                 ((void *)0)
# 253 "../crypto/provider_conf.c"
                                                     )
                    pcgbl->activated_providers = sk_OSSL_PROVIDER_new_null();
                if (pcgbl->activated_providers == 
# 255 "../crypto/provider_conf.c" 3 4
                                                 ((void *)0)
                    
# 256 "../crypto/provider_conf.c"
                                            ...
                                            const char *confvalue, int *val)
{
    ...
    if (confvalue == 
# 279 "../crypto/provider_conf.c" 3 4
                    ((void *)0)
# 279 "../crypto/provider_conf.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",280,__func__), ERR_set_error)(15, 105,
    ...
    if ((strcmp(confvalue, "1") == 0)
        ...
        (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",302,__func__), ERR_set_error)(15, 105,
                               "directive %s set to unrecognized value",
                               confname);
        return 0;
    }
                              ...
                              const char *value, const CONF *cnf)
{
    ...
    int soft = 0;
    const char *path = 
# 317 "../crypto/provider_conf.c" 3 4
                      ((void *)0)
# 317 "../crypto/provider_conf.c"
                          ;
    int activate = 0;
    int ok = 0;
    int added = 0;
    ...
    if (!ecmds) {
        (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",328,__func__), ERR_set_error)(15, 105,
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(ecmds)); i++) {
        CONF_VALUE *ecmd = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(ecmds), (i)));
    ...
    if (activate) {
        ...
        ok = 1;
        if (name != 
# 368 "../crypto/provider_conf.c" 3 4
                   ((void *)0)
# 368 "../crypto/provider_conf.c"
                       ) {
            entry.name = CRYPTO_strdup(name, "../crypto/provider_conf.c", 369);
            if (entry.name == 
# 370 "../crypto/provider_conf.c" 3 4
                             ((void *)0)
# 370 "../crypto/provider_conf.c"
                                 )
                ok = 0;
        }
        if (ok && path != 
# 373 "../crypto/provider_conf.c" 3 4
                         ((void *)0)
# 373 "../crypto/provider_conf.c"
                             ) {
            entry.path = CRYPTO_strdup(path, "../crypto/provider_conf.c", 374);
            if (entry.path == 
# 375 "../crypto/provider_conf.c" 3 4
                             ((void *)0)
# 375 "../crypto/provider_conf.c"
                                 )
                ok = 0;
        }
        if (ok)
            ok = provider_conf_params(
# 379 "../crypto/provider_conf.c" 3 4
                                     ((void *)0)
# 379 "../crypto/provider_conf.c"
                                         , &entry, 
# 379 "../crypto/provider_conf.c" 3 4
                                                   ((void *)0)
# 379 "../crypto/provider_conf.c"
                                                       , value, cnf);
        if (ok >= 1 && (entry.path != 
# 380 "../crypto/provider_conf.c" 3 4
                                     ((void *)0) 
# 380 "../crypto/provider_conf.c"
                                          || entry.parameters != 
# 380 "../crypto/provider_conf.c" 3 4
                                                                 ((void *)0)
# 380 "../crypto/provider_conf.c"
...
static int provider_conf_init(CONF_IMODULE *md, const CONF *cnf)
{
    ...
    if (!elist) {
        (ERR_new(), ERR_set_debug("../crypto/provider_conf.c",412,__func__), ERR_set_error)((15),(105),
# 412 "../crypto/provider_conf.c" 3 4
       ((void *)0)
# 412 "../crypto/provider_conf.c"
       );
        return 0;
    }
...
{
    ((void)0);
    CONF_module_add("providers", provider_conf_init, 
# 429 "../crypto/provider_conf.c" 3 4
                                                    ((void *)0)
# 429 "../crypto/provider_conf.c"
                                                        );
}
