# 0 "../crypto/comp/comp_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/comp/comp_err.c"
# 11 "../crypto/comp/comp_err.c"
...
static const ERR_STRING_DATA COMP_str_reasons[] = {
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "brotli decode error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "brotli encode error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "brotli not supported"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(99) & 0X7FFFFF)) ),
    "zlib deflate error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "zlib inflate error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "zlib not supported"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "zstd compress error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "zstd decode error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "zstd decompress error"},
    {( (((unsigned long)(41) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "zstd not supported"},
    {0, 
# 39 "../crypto/comp/comp_err.c" 3 4
       ((void *)0)
# 39 "../crypto/comp/comp_err.c"
           }
};
...
int ossl_err_load_COMP_strings(void)
{
    ...
    if (ERR_reason_error_string(COMP_str_reasons[0].error) == 
# 47 "../crypto/comp/comp_err.c" 3 4
                                                             ((void *)0)
# 47 "../crypto/comp/comp_err.c"
                                                                 )
