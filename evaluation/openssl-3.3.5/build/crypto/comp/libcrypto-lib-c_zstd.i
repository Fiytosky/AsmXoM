# 0 "../crypto/comp/c_zstd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/comp/c_zstd.c"
# 15 "../crypto/comp/c_zstd.c"
...
# 23 "../crypto/comp/c_zstd.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 24 "../crypto/comp/c_zstd.c" 2
...
# 25 "../crypto/comp/c_zstd.c" 2

COMP_METHOD *COMP_zstd(void);
# 404 "../crypto/comp/c_zstd.c"
COMP_METHOD *COMP_zstd(void)
{
    COMP_METHOD *meth = 
# 406 "../crypto/comp/c_zstd.c" 3 4
                       ((void *)0)
# 406 "../crypto/comp/c_zstd.c"
                           ;
...
{
    COMP_METHOD *meth = 
# 417 "../crypto/comp/c_zstd.c" 3 4
                       ((void *)0)
# 417 "../crypto/comp/c_zstd.c"
                           ;
...
void ossl_comp_zstd_cleanup(void)
{
# 449 "../crypto/comp/c_zstd.c"
}
# 497 "../crypto/comp/c_zstd.c"
const BIO_METHOD *BIO_f_zstd(void)
{
    ...
    return 
# 503 "../crypto/comp/c_zstd.c" 3 4
          ((void *)0)
# 503 "../crypto/comp/c_zstd.c"
              ;
}
