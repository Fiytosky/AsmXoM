# 0 "../crypto/comp/comp_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/comp/comp_lib.c"
# 10 "../crypto/comp/comp_lib.c"
...
# 16 "../crypto/comp/comp_lib.c" 2
# 1 "../crypto/comp/comp_local.h" 1
# 10 "../crypto/comp/comp_local.h"
struct comp_method_st {
    int type;
    const char *name;
    int (*init) (COMP_CTX *ctx);
    void (*finish) (COMP_CTX *ctx);
    ssize_t (*compress) (COMP_CTX *ctx,
                             unsigned char *out, size_t olen,
                             unsigned char *in, size_t ilen);
    ssize_t (*expand) (COMP_CTX *ctx,
                            unsigned char *out, size_t olen,
                            unsigned char *in, size_t ilen);
};
...
COMP_CTX *COMP_CTX_new(COMP_METHOD *meth)
{
    ...
    if (meth == 
# 22 "../crypto/comp/comp_lib.c" 3 4
               ((void *)0)
# 22 "../crypto/comp/comp_lib.c"
                   )
        return 
# 23 "../crypto/comp/comp_lib.c" 3 4
              ((void *)0)
# 23 "../crypto/comp/comp_lib.c"
                  ;

    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/comp/comp_lib.c", 25)) == 
# 25 "../crypto/comp/comp_lib.c" 3 4
                                               ((void *)0)
# 25 "../crypto/comp/comp_lib.c"
                                                   )
        return 
# 26 "../crypto/comp/comp_lib.c" 3 4
              ((void *)0)
# 26 "../crypto/comp/comp_lib.c"
                  ;
    ret->meth = meth;
    if ((ret->meth->init != 
# 28 "../crypto/comp/comp_lib.c" 3 4
                           ((void *)0)
# 28 "../crypto/comp/comp_lib.c"
                               ) && !ret->meth->init(ret)) {
        CRYPTO_free(ret, "../crypto/comp/comp_lib.c", 29);
        ret = 
# 30 "../crypto/comp/comp_lib.c" 3 4
             ((void *)0)
# 30 "../crypto/comp/comp_lib.c"
                 ;
    }
    return ret;
}
...
{
    if (meth == 
# 42 "../crypto/comp/comp_lib.c" 3 4
               ((void *)0)
# 42 "../crypto/comp/comp_lib.c"
                   )
        return 0;
    return meth->type;
}
...
{
    if (meth == 
# 49 "../crypto/comp/comp_lib.c" 3 4
               ((void *)0)
# 49 "../crypto/comp/comp_lib.c"
                   )
        return 
# 50 "../crypto/comp/comp_lib.c" 3 4
              ((void *)0)
# 50 "../crypto/comp/comp_lib.c"
                  ;
    return meth->name;
}
...
{
    if (ctx == 
# 56 "../crypto/comp/comp_lib.c" 3 4
              ((void *)0)
# 56 "../crypto/comp/comp_lib.c"
                  )
        return;
    if (ctx->meth->finish != 
# 58 "../crypto/comp/comp_lib.c" 3 4
                            ((void *)0)
# 58 "../crypto/comp/comp_lib.c"
                                )
        ctx->meth->finish(ctx);

    CRYPTO_free(ctx, "../crypto/comp/comp_lib.c", 61);
}
...
# 68 "../crypto/comp/comp_lib.c" 3 4
                              ((void *)0)
# 68 "../crypto/comp/comp_lib.c"
                                  ) {
        return -1;
    }
                      ...
                      unsigned char *in, int ilen)
{
    ...
    if (ctx->meth->expand == 
# 84 "../crypto/comp/comp_lib.c" 3 4
                            ((void *)0)
# 84 "../crypto/comp/comp_lib.c"
                                ) {
        return -1;
    }
