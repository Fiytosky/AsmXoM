# 0 "../crypto/conf/conf_api.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_api.c"
# 12 "../crypto/conf/conf_api.c"
...
# 18 "../crypto/conf/conf_api.c" 2
# 1 "../crypto/conf/conf_local.h" 1
# 11 "../crypto/conf/conf_local.h"
void ossl_config_add_ssl_module(void);
# 19 "../crypto/conf/conf_api.c" 2

static void value_free_hash(const CONF_VALUE *a, struct lhash_st_CONF_VALUE *conf);
...
CONF_VALUE *_CONF_get_section(const CONF *conf, const char *section)
{
    ...
    if (conf == 
# 27 "../crypto/conf/conf_api.c" 3 4
               ((void *)0) 
# 27 "../crypto/conf/conf_api.c"
                    || section == 
# 27 "../crypto/conf/conf_api.c" 3 4
                                  ((void *)0)
# 27 "../crypto/conf/conf_api.c"
        ...
        return 
# 28 "../crypto/conf/conf_api.c" 3 4
              ((void *)0)
# 28 "../crypto/conf/conf_api.c"
                  ;
    vv.name = 
# 29 "../crypto/conf/conf_api.c" 3 4
             ((void *)0)
# 29 "../crypto/conf/conf_api.c"
                 ;
    vv.section = (char *)section;
    return conf->data != 
# 31 "../crypto/conf/conf_api.c" 3 4
                        ((void *)0) 
# 31 "../crypto/conf/conf_api.c"
                             ? ((CONF_VALUE *)OPENSSL_LH_retrieve(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_const_CONF_VALUE_lh_plain_type(&vv))) : 
# 31 "../crypto/conf/conf_api.c" 3 4
                                                                         ((void *)0)
# 31 "../crypto/conf/conf_api.c"
                                                                             ;
                                               ...
                                               const char *section)
{
    ...
    if (v == 
# 40 "../crypto/conf/conf_api.c" 3 4
            ((void *)0)
# 40 "../crypto/conf/conf_api.c"
                )
        return 
# 41 "../crypto/conf/conf_api.c" 3 4
              ((void *)0)
# 41 "../crypto/conf/conf_api.c"
                  ;
...
{
    CONF_VALUE *v = 
# 47 "../crypto/conf/conf_api.c" 3 4
                   ((void *)0)
# 47 "../crypto/conf/conf_api.c"
                       ;
    ...
    if (!OPENSSL_sk_push(ossl_check_CONF_VALUE_sk_type(ts), ossl_check_CONF_VALUE_type(value)))
        return 0;

    v = ((CONF_VALUE *)OPENSSL_LH_insert(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_CONF_VALUE_lh_plain_type(value)));
    if (v != 
# 57 "../crypto/conf/conf_api.c" 3 4
            ((void *)0)
# 57 "../crypto/conf/conf_api.c"
                ) {
        (void)((CONF_VALUE *)OPENSSL_sk_delete_ptr(ossl_check_CONF_VALUE_sk_type(ts), ossl_check_CONF_VALUE_type(v)));
        CRYPTO_free(v->name, "../crypto/conf/conf_api.c", 59);
        CRYPTO_free(v->value, "../crypto/conf/conf_api.c", 60);
        CRYPTO_free(v, "../crypto/conf/conf_api.c", 61);
    }
    return 1;
}
                       ...
                       const char *name)
{
    ...
    if (name == 
# 72 "../crypto/conf/conf_api.c" 3 4
               ((void *)0)
# 72 "../crypto/conf/conf_api.c"
                   )
        return 
# 73 "../crypto/conf/conf_api.c" 3 4
              ((void *)0)
# 73 "../crypto/conf/conf_api.c"
                  ;
    if (conf == 
# 74 "../crypto/conf/conf_api.c" 3 4
               ((void *)0)
# 74 "../crypto/conf/conf_api.c"
                   )
        return ossl_safe_getenv(name);
    if (conf->data == 
# 76 "../crypto/conf/conf_api.c" 3 4
                     ((void *)0)
# 76 "../crypto/conf/conf_api.c"
                         )
        return 
# 77 "../crypto/conf/conf_api.c" 3 4
              ((void *)0)
# 77 "../crypto/conf/conf_api.c"
                  ;
    if (section != 
# 78 "../crypto/conf/conf_api.c" 3 4
                  ((void *)0)
# 78 "../crypto/conf/conf_api.c"
                      ) {
        vv.name = (char *)name;
        vv.section = (char *)section;
        v = ((CONF_VALUE *)OPENSSL_LH_retrieve(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_const_CONF_VALUE_lh_plain_type(&vv)));
        if (v != 
# 82 "../crypto/conf/conf_api.c" 3 4
                ((void *)0)
# 82 "../crypto/conf/conf_api.c"
                    )
            return v->value;
        if (strcmp(section, "ENV") == 0) {
            p = ossl_safe_getenv(name);
            if (p != 
# 86 "../crypto/conf/conf_api.c" 3 4
                    ((void *)0)
# 86 "../crypto/conf/conf_api.c"
                        )
                return p;
        }
    }
    ...
    v = ((CONF_VALUE *)OPENSSL_LH_retrieve(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_const_CONF_VALUE_lh_plain_type(&vv)));
    if (v == 
# 93 "../crypto/conf/conf_api.c" 3 4
            ((void *)0)
# 93 "../crypto/conf/conf_api.c"
                )
        return 
# 94 "../crypto/conf/conf_api.c" 3 4
              ((void *)0)
# 94 "../crypto/conf/conf_api.c"
                  ;
    return v->value;
}
...
static int conf_value_cmp(const CONF_VALUE *a, const CONF_VALUE *b)
{
    ...
    if (a->name != 
# 113 "../crypto/conf/conf_api.c" 3 4
                  ((void *)0) 
# 113 "../crypto/conf/conf_api.c"
                       && b->name != 
# 113 "../crypto/conf/conf_api.c" 3 4
                                     ((void *)0)
# 113 "../crypto/conf/conf_api.c"
    ...
    if (a->name == b->name)
        return 0;
    return (a->name == 
# 117 "../crypto/conf/conf_api.c" 3 4
                      ((void *)0)
# 117 "../crypto/conf/conf_api.c"
                          ) ? -1 : 1;
}
...
{
    if (conf == 
# 122 "../crypto/conf/conf_api.c" 3 4
               ((void *)0)
# 122 "../crypto/conf/conf_api.c"
                   )
        return 0;
    if (conf->data == 
# 124 "../crypto/conf/conf_api.c" 3 4
                     ((void *)0)
# 124 "../crypto/conf/conf_api.c"
                         ) {
        conf->data = ((struct lhash_st_CONF_VALUE *)OPENSSL_LH_set_thunks(OPENSSL_LH_new(ossl_check_CONF_VALUE_lh_hashfunc_type(conf_value_hash), ossl_check_CONF_VALUE_lh_compfunc_type(conf_value_cmp)), lh_CONF_VALUE_hash_thunk, lh_CONF_VALUE_comp_thunk, lh_CONF_VALUE_doall_thunk, lh_CONF_VALUE_doall_arg_thunk));
        if (conf->data == 
# 126 "../crypto/conf/conf_api.c" 3 4
                         ((void *)0)
# 126 "../crypto/conf/conf_api.c"
                             )
            return 0;
    }
    return 1;
...
typedef struct lhash_st_CONF_VALUE LH_CONF_VALUE;

static __attribute__((unused)) inline void lh_CONF_VALUE_doall_LH_CONF_VALUE_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const CONF_VALUE *, LH_CONF_VALUE *) = (void (*)(const CONF_VALUE *, LH_CONF_VALUE *))fn; fn_conv((const CONF_VALUE *)node, (LH_CONF_VALUE *)arg); } static __attribute__((unused)) inline void lh_CONF_VALUE_doall_LH_CONF_VALUE(struct lhash_st_CONF_VALUE *lh, void (*fn)(const CONF_VALUE *, LH_CONF_VALUE *), LH_CONF_VALUE *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_CONF_VALUE_doall_LH_CONF_VALUE_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_CONF_VALUE;

void _CONF_free_data(CONF *conf)
{
    if (conf == 
# 138 "../crypto/conf/conf_api.c" 3 4
               ((void *)0)
# 138 "../crypto/conf/conf_api.c"
                   )
        return;

    CRYPTO_free(conf->includedir, "../crypto/conf/conf_api.c", 141);
    if (conf->data == 
# 142 "../crypto/conf/conf_api.c" 3 4
                     ((void *)0)
# 142 "../crypto/conf/conf_api.c"
                         )
        return;


    OPENSSL_LH_set_down_load(ossl_check_CONF_VALUE_lh_type(conf->data), 0);
    ...
    OPENSSL_LH_doall(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_CONF_VALUE_lh_doallfunc_type(value_free_stack_doall));
    OPENSSL_LH_free(ossl_check_CONF_VALUE_lh_type(conf->data));
}

static void value_free_hash(const CONF_VALUE *a, struct lhash_st_CONF_VALUE *conf)
{
    if (a->name != 
# 160 "../crypto/conf/conf_api.c" 3 4
                  ((void *)0)
# 160 "../crypto/conf/conf_api.c"
                      )
        (void)((CONF_VALUE *)OPENSSL_LH_delete(ossl_check_CONF_VALUE_lh_type(conf), ossl_check_const_CONF_VALUE_lh_plain_type(a)));
}
...
static void value_free_stack_doall(CONF_VALUE *a)
{
    ...
    if (a->name != 
# 170 "../crypto/conf/conf_api.c" 3 4
                  ((void *)0)
# 170 "../crypto/conf/conf_api.c"
                      )
        return;

    sk = (struct stack_st_CONF_VALUE *)a->value;
    for (i = OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(sk)) - 1; i >= 0; i--) {
        vv = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(sk), (i)));
        CRYPTO_free(vv->value, "../crypto/conf/conf_api.c", 176);
        CRYPTO_free(vv->name, "../crypto/conf/conf_api.c", 177);
        CRYPTO_free(vv, "../crypto/conf/conf_api.c", 178);
    }
    OPENSSL_sk_free(ossl_check_CONF_VALUE_sk_type(sk));
    CRYPTO_free(a->section, "../crypto/conf/conf_api.c", 181);
    CRYPTO_free(a, "../crypto/conf/conf_api.c", 182);
}

CONF_VALUE *_CONF_new_section(CONF *conf, const char *section)
{
    struct stack_st_CONF_VALUE *sk = 
# 187 "../crypto/conf/conf_api.c" 3 4
                              ((void *)0)
# 187 "../crypto/conf/conf_api.c"
                                  ;
    int i;
    CONF_VALUE *v = 
# 189 "../crypto/conf/conf_api.c" 3 4
                   ((void *)0)
# 189 "../crypto/conf/conf_api.c"
                       , *vv;

    if ((sk = ((struct stack_st_CONF_VALUE *)OPENSSL_sk_new_null())) == 
# 191 "../crypto/conf/conf_api.c" 3 4
                                          ((void *)0)
# 191 "../crypto/conf/conf_api.c"
                                              )
        goto err;
    if ((v = CRYPTO_malloc(sizeof(*v), "../crypto/conf/conf_api.c", 193)) == 
# 193 "../crypto/conf/conf_api.c" 3 4
                                           ((void *)0)
# 193 "../crypto/conf/conf_api.c"
                                               )
        goto err;
    i = strlen(section) + 1;
    if ((v->section = CRYPTO_malloc(i, "../crypto/conf/conf_api.c", 196)) == 
# 196 "../crypto/conf/conf_api.c" 3 4
                                           ((void *)0)
# 196 "../crypto/conf/conf_api.c"
                                               )
        goto err;

    memcpy(v->section, section, i);
    v->name = 
# 200 "../crypto/conf/conf_api.c" 3 4
             ((void *)0)
# 200 "../crypto/conf/conf_api.c"
                 ;
    v->value = (char *)sk;

    vv = ((CONF_VALUE *)OPENSSL_LH_insert(ossl_check_CONF_VALUE_lh_type(conf->data), ossl_check_CONF_VALUE_lh_plain_type(v)));
    if (vv != 
# 204 "../crypto/conf/conf_api.c" 3 4
             ((void *)0) 
# 204 "../crypto/conf/conf_api.c"
                  || OPENSSL_LH_error(ossl_check_CONF_VALUE_lh_type(conf->data)) > 0)
        goto err;
    return v;
 ...
 err:
    OPENSSL_sk_free(ossl_check_CONF_VALUE_sk_type(sk));
    if (v != 
# 210 "../crypto/conf/conf_api.c" 3 4
            ((void *)0)
# 210 "../crypto/conf/conf_api.c"
                )
        CRYPTO_free(v->section, "../crypto/conf/conf_api.c", 211);
    CRYPTO_free(v, "../crypto/conf/conf_api.c", 212);
    return 
# 213 "../crypto/conf/conf_api.c" 3 4
          ((void *)0)
# 213 "../crypto/conf/conf_api.c"
              ;
}
