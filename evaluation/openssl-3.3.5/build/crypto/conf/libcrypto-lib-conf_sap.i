# 0 "../crypto/conf/conf_sap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_sap.c"
# 10 "../crypto/conf/conf_sap.c"
...
# 18 "../crypto/conf/conf_sap.c" 2
# 29 "../crypto/conf/conf_sap.c"
...
void OPENSSL_config(const char *appname)
{
    ...
    if (appname != 
# 37 "../crypto/conf/conf_sap.c" 3 4
                  ((void *)0)
# 37 "../crypto/conf/conf_sap.c"
                      )
        settings.appname = strdup(appname);
    settings.flags = (0x20 | 0x10 | 0x2);
    OPENSSL_init_crypto(0x00000040L, &settings);
...
# 59 "../crypto/conf/conf_sap.c" 3 4
                                              ((void *)0)
# 59 "../crypto/conf/conf_sap.c"
                                                  ;
    appname = settings ? settings->appname : 
# 60 "../crypto/conf/conf_sap.c" 3 4
                                            ((void *)0)
# 60 "../crypto/conf/conf_sap.c"
                                                ;
    flags = settings ? settings->flags : (0x20 | 0x10 | 0x2);
# 70 "../crypto/conf/conf_sap.c"
