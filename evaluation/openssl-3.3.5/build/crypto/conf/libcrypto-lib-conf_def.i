# 0 "../crypto/conf/conf_def.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_def.c"
# 12 "../crypto/conf/conf_def.c"
...
# 24 "../crypto/conf/conf_def.c" 2
# 1 "../crypto/conf/conf_local.h" 1
# 11 "../crypto/conf/conf_local.h"
void ossl_config_add_ssl_module(void);
# 25 "../crypto/conf/conf_def.c" 2
# 1 "../crypto/conf/conf_def.h" 1
# 42 "../crypto/conf/conf_def.h"
...
# 30 "../crypto/conf/conf_def.c" 2
# 45 "../crypto/conf/conf_def.c"
...
static CONF *def_create(CONF_METHOD *meth)
{
    ...
    ret = CRYPTO_malloc(sizeof(*ret), "../crypto/conf/conf_def.c", 115);
    if (ret != 
# 116 "../crypto/conf/conf_def.c" 3 4
              ((void *)0)
# 116 "../crypto/conf/conf_def.c"
                  )
        if (meth->init(ret) == 0) {
            CRYPTO_free(ret, "../crypto/conf/conf_def.c", 118);
            ret = 
# 119 "../crypto/conf/conf_def.c" 3 4
                 ((void *)0)
# 119 "../crypto/conf/conf_def.c"
                     ;
        }
    return ret;
}
...
{
    if (conf == 
# 126 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 126 "../crypto/conf/conf_def.c"
                   )
        return 0;
...
{
    if (conf == 
# 139 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 139 "../crypto/conf/conf_def.c"
                   )
        return 0;
...
static int def_destroy(CONF *conf)
{
    if (def_destroy_data(conf)) {
        CRYPTO_free(conf, "../crypto/conf/conf_def.c", 153);
        return 1;
    }
    return 0;
}
...
{
    if (conf == 
# 161 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 161 "../crypto/conf/conf_def.c"
                   )
        return 0;
...
static int def_load(CONF *conf, const char *name, long *line)
{
    int ret;
    BIO *in = 
# 170 "../crypto/conf/conf_def.c" 3 4
             ((void *)0)
# 170 "../crypto/conf/conf_def.c"
                 ;
    ...
    if (in == 
# 177 "../crypto/conf/conf_def.c" 3 4
             ((void *)0)
# 177 "../crypto/conf/conf_def.c"
                 ) {
        if (ERR_GET_REASON(ERR_peek_last_error()) == 128)
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",179,__func__), ERR_set_error)((14),(114),
# 179 "../crypto/conf/conf_def.c" 3 4
           ((void *)0)
# 179 "../crypto/conf/conf_def.c"
           );
        else
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",181,__func__), ERR_set_error)((14),((2 | (0x2 << 18L))),
# 181 "../crypto/conf/conf_def.c" 3 4
           ((void *)0)
...
static int parsebool(const char *pval, int *flag)
{
    if (OPENSSL_strcasecmp(pval, "on") == 0
        ...
        *flag = 0;
        ...
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",202,__func__), ERR_set_error)((14),(122),
# 202 "../crypto/conf/conf_def.c" 3 4
       ((void *)0)
# 202 "../crypto/conf/conf_def.c"
       );
        return 0;
    }
    return 1;
...
static int def_load_bio(CONF *conf, BIO *in, long *line)
{
    ...
    int bufnum = 0, i, ii;
    BUF_MEM *buff = 
# 213 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 213 "../crypto/conf/conf_def.c"
                       ;
    char *s, *p, *end;
    int again;
    int first_call = 1;
    long eline = 0;
    char btmp[((sizeof(eline)*8+2)/3+1) + 1];
    CONF_VALUE *v = 
# 219 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 219 "../crypto/conf/conf_def.c"
                       , *tv;
    CONF_VALUE *sv = 
# 220 "../crypto/conf/conf_def.c" 3 4
                    ((void *)0)
# 220 "../crypto/conf/conf_def.c"
                        ;
    char *section = 
# 221 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 221 "../crypto/conf/conf_def.c"
                       , *buf;
    char *start, *psection, *pname;
    void *h = (void *)(conf->data);
    struct stack_st_BIO *biosk = 
# 224 "../crypto/conf/conf_def.c" 3 4
                          ((void *)0)
# 224 "../crypto/conf/conf_def.c"
                              ;

    char *dirpath = 
# 226 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 226 "../crypto/conf/conf_def.c"
                       ;
    OPENSSL_DIR_CTX *dirctx = 
# 227 "../crypto/conf/conf_def.c" 3 4
                             ((void *)0)
# 227 "../crypto/conf/conf_def.c"
                                 ;
    ...
    if ((buff = BUF_MEM_new()) == 
# 233 "../crypto/conf/conf_def.c" 3 4
                                 ((void *)0)
# 233 "../crypto/conf/conf_def.c"
                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",234,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 234 "../crypto/conf/conf_def.c" 3 4
       ((void *)0)
# 234 "../crypto/conf/conf_def.c"
       );
        goto err;
    }

    section = CRYPTO_strdup("default", "../crypto/conf/conf_def.c", 238);
    if (section == 
# 239 "../crypto/conf/conf_def.c" 3 4
                  ((void *)0)
# 239 "../crypto/conf/conf_def.c"
                      )
        goto err;

    if (_CONF_new_data(conf) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",243,__func__), ERR_set_error)((14),((14 | (0x2 << 18L))),
# 243 "../crypto/conf/conf_def.c" 3 4
       ((void *)0)
# 243 "../crypto/conf/conf_def.c"
       );
        goto err;
    }
    ...
    if (sv == 
# 248 "../crypto/conf/conf_def.c" 3 4
             ((void *)0)
# 248 "../crypto/conf/conf_def.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",249,__func__), ERR_set_error)((14),(103),
# 249 "../crypto/conf/conf_def.c" 3 4
       ((void *)0)
# 249 "../crypto/conf/conf_def.c"
       );
        goto err;
    }
    ...
    for (;;) {
        if (!BUF_MEM_grow(buff, bufnum + 512)) {
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",257,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 257 "../crypto/conf/conf_def.c" 3 4
           ((void *)0)
# 257 "../crypto/conf/conf_def.c"
           );
            goto err;
        }
        p = &(buff->data[bufnum]);
 ...
 read_retry:
        if (in != 
# 263 "../crypto/conf/conf_def.c" 3 4
                 ((void *)0) 
# 263 "../crypto/conf/conf_def.c"
                      && BIO_gets(in, p, 512 - 1) < 0)
            goto err;
        p[512 - 1] = '\0';
        ii = i = strlen(p);
        if (first_call) {
        ...
        if (i == 0 && !again) {
            ...
            if (dirctx != 
# 286 "../crypto/conf/conf_def.c" 3 4
                         ((void *)0)
# 286 "../crypto/conf/conf_def.c"
                             ) {
                BIO *next;

                if ((next = get_next_file(dirpath, &dirctx)) != 
# 289 "../crypto/conf/conf_def.c" 3 4
                                                               ((void *)0)
# 289 "../crypto/conf/conf_def.c"
                                                                   ) {
                    BIO_vfree(in);
                    in = next;
                    goto read_retry;
                } else {
                    CRYPTO_free(dirpath, "../crypto/conf/conf_def.c", 294);
                    dirpath = 
# 295 "../crypto/conf/conf_def.c" 3 4
                             ((void *)0)
# 295 "../crypto/conf/conf_def.c"
                                 ;
                }
            }


            if ((parent = ((BIO *)OPENSSL_sk_pop(ossl_check_BIO_sk_type(biosk)))) == 
# 300 "../crypto/conf/conf_def.c" 3 4
                                               ((void *)0)
# 300 "../crypto/conf/conf_def.c"
                                                   ) {
        ...
        v = 
# 331 "../crypto/conf/conf_def.c" 3 4
           ((void *)0)
# 331 "../crypto/conf/conf_def.c"
               ;
        ...
        if (!again && bufnum >= 1) {
            ...
            if (is_keytype(conf, p[0], 32) && ((bufnum <= 1) || !is_keytype(conf, p[-1], 32))) {
                bufnum--;
                again = 1;
            }
        }
 ...
 again:
            ...
            if (*p != ']') {
                ...
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",367,__func__), ERR_set_error)((14),(100),
# 367 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 367 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            *end = '\0';
            if (!str_copy(conf, 
# 371 "../crypto/conf/conf_def.c" 3 4
                               ((void *)0)
# 371 "../crypto/conf/conf_def.c"
                                   , &section, start))
                goto err;
            if ((sv = _CONF_get_section(conf, section)) == 
# 373 "../crypto/conf/conf_def.c" 3 4
                                                          ((void *)0)
# 373 "../crypto/conf/conf_def.c"
                                                              )
                sv = _CONF_new_section(conf, section);
            if (sv == 
# 375 "../crypto/conf/conf_def.c" 3 4
                     ((void *)0)
# 375 "../crypto/conf/conf_def.c"
                         ) {
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",376,__func__), ERR_set_error)((14),(103),
# 376 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 376 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            continue;
            ...
            p = eat_ws(conf, end);
            if (((strncmp(pname, ".pragma" "", sizeof(".pragma") - 1) == 0) ? ((pname) += sizeof(".pragma") - 1, 1) : 0)
                && (p != pname || *p == '=')) {
                char *pval;
                ...
                pval = strchr(p, ':');
                if (pval == 
# 405 "../crypto/conf/conf_def.c" 3 4
                           ((void *)0) 
# 405 "../crypto/conf/conf_def.c"
                                || pval == p || pval[1] == '\0') {
                    (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",406,__func__), ERR_set_error)((14),(122),
# 406 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 406 "../crypto/conf/conf_def.c"
                   );
                    goto err;
                }
...
# 421 "../crypto/conf/conf_def.c"
                if (strcmp(p, "dollarid") == 0) {
                    ...
                    CRYPTO_free(conf->includedir, "../crypto/conf/conf_def.c", 428);
                    if ((conf->includedir = CRYPTO_strdup(pval, "../crypto/conf/conf_def.c", 429)) == 
# 429 "../crypto/conf/conf_def.c" 3 4
                                                                    ((void *)0)
# 429 "../crypto/conf/conf_def.c"
                                                                        )
                        goto err;
                }
                ...
                continue;
            } else if (((strncmp(pname, ".include" "", sizeof(".include") - 1) == 0) ? ((pname) += sizeof(".include") - 1, 1) : 0)
                && (p != pname || *p == '=')) {
                char *include = 
# 439 "../crypto/conf/conf_def.c" 3 4
                               ((void *)0)
# 439 "../crypto/conf/conf_def.c"
                                   ;
                BIO *next;
                const char *include_dir = ossl_safe_getenv("OPENSSL_CONF_INCLUDE");
                char *include_path = 
# 442 "../crypto/conf/conf_def.c" 3 4
                                    ((void *)0)
# 442 "../crypto/conf/conf_def.c"
                                        ;
# 458 "../crypto/conf/conf_def.c"
                if (include_dir == 
# 458 "../crypto/conf/conf_def.c" 3 4
                                  ((void *)0)
# 458 "../crypto/conf/conf_def.c"
                                      )
                ...
                if (include_dir != 
# 469 "../crypto/conf/conf_def.c" 3 4
                                  ((void *)0) 
# 469 "../crypto/conf/conf_def.c"
                                       && !ossl_is_absolute_path(include)) {
                    size_t newlen = strlen(include_dir) + strlen(include) + 2;

                    include_path = CRYPTO_malloc(newlen, "../crypto/conf/conf_def.c", 472);
                    if (include_path == 
# 473 "../crypto/conf/conf_def.c" 3 4
                                       ((void *)0)
# 473 "../crypto/conf/conf_def.c"
                                           ) {
                        CRYPTO_free(include, "../crypto/conf/conf_def.c", 474);
                        goto err;
                    }
                    ...
                    CRYPTO_free(include, "../crypto/conf/conf_def.c", 482);
                } else {
                ...
                if (conf->flag_abspath
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",489,__func__), ERR_set_error)((14),(125),
# 489 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 489 "../crypto/conf/conf_def.c"
                   );
                    CRYPTO_free(include_path, "../crypto/conf/conf_def.c", 490);
                    goto err;
                }
                ...
                if (include_path != dirpath) {
                    ...
                    CRYPTO_free(include_path, "../crypto/conf/conf_def.c", 499);
                }
                ...
                if (next != 
# 506 "../crypto/conf/conf_def.c" 3 4
                           ((void *)0)
# 506 "../crypto/conf/conf_def.c"
                               ) {

                    if (biosk == 
# 508 "../crypto/conf/conf_def.c" 3 4
                                ((void *)0)
# 508 "../crypto/conf/conf_def.c"
                                    ) {
                        if ((biosk = ((struct stack_st_BIO *)OPENSSL_sk_new_null())) == 
# 509 "../crypto/conf/conf_def.c" 3 4
                                                          ((void *)0)
# 509 "../crypto/conf/conf_def.c"
                                                              ) {
                            (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",510,__func__), ERR_set_error)((14),((15 | (0x2 << 18L))),
# 510 "../crypto/conf/conf_def.c" 3 4
                           ((void *)0)
# 510 "../crypto/conf/conf_def.c"
                           );
                            BIO_free(next);
                            goto err;
                        }
                    }
                    if (!OPENSSL_sk_push(ossl_check_BIO_sk_type(biosk), ossl_check_BIO_type(in))) {
                        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",516,__func__), ERR_set_error)((14),((15 | (0x2 << 18L))),
# 516 "../crypto/conf/conf_def.c" 3 4
                       ((void *)0)
# 516 "../crypto/conf/conf_def.c"
                       );
                        BIO_free(next);
                        goto err;
                    }
                ...
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",525,__func__), ERR_set_error)(14, 101,
                               "HERE-->%s", p);
                goto err;
            }
            *end = '\0';
            ...
            if ((v = CRYPTO_malloc(sizeof(*v), "../crypto/conf/conf_def.c", 534)) == 
# 534 "../crypto/conf/conf_def.c" 3 4
                                                   ((void *)0)
# 534 "../crypto/conf/conf_def.c"
                                                       )
                goto err;
            v->name = CRYPTO_strdup(pname, "../crypto/conf/conf_def.c", 536);
            v->value = 
# 537 "../crypto/conf/conf_def.c" 3 4
                      ((void *)0)
# 537 "../crypto/conf/conf_def.c"
                          ;
            if (v->name == 
# 538 "../crypto/conf/conf_def.c" 3 4
                          ((void *)0)
# 538 "../crypto/conf/conf_def.c"
                              )
                goto err;
            ...
            if (strcmp(psection, section) != 0) {
                if ((tv = _CONF_get_section(conf, psection))
                    == 
# 545 "../crypto/conf/conf_def.c" 3 4
                      ((void *)0)
# 545 "../crypto/conf/conf_def.c"
                          )
                    tv = _CONF_new_section(conf, psection);
                if (tv == 
# 547 "../crypto/conf/conf_def.c" 3 4
                         ((void *)0)
# 547 "../crypto/conf/conf_def.c"
                             ) {
                    (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",548,__func__), ERR_set_error)((14),(103),
# 548 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 548 "../crypto/conf/conf_def.c"
                   )
                                                                  ;
                    goto err;
                }
            ...
            if (_CONF_add_string(conf, tv, v) == 0) {
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",555,__func__), ERR_set_error)((14),((14 | (0x2 << 18L))),
# 555 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 555 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            v = 
# 558 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 558 "../crypto/conf/conf_def.c"
                   ;
        }
    }
    BUF_MEM_free(buff);
    CRYPTO_free(section, "../crypto/conf/conf_def.c", 562);




    OPENSSL_sk_free(ossl_check_BIO_sk_type(biosk));
    return 1;

 err:
    BUF_MEM_free(buff);
    CRYPTO_free(section, "../crypto/conf/conf_def.c", 572);





    while (OPENSSL_sk_num(ossl_check_const_BIO_sk_type(biosk)) > 0) {
        BIO *popped = ((BIO *)OPENSSL_sk_pop(ossl_check_BIO_sk_type(biosk)));
        BIO_vfree(in);
        in = popped;
    }
    OPENSSL_sk_free(ossl_check_BIO_sk_type(biosk));

    CRYPTO_free(dirpath, "../crypto/conf/conf_def.c", 585);
    if (dirctx != 
# 586 "../crypto/conf/conf_def.c" 3 4
                 ((void *)0)
# 586 "../crypto/conf/conf_def.c"
                     )
        OPENSSL_DIR_end(&dirctx);

    if (line != 
# 589 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 589 "../crypto/conf/conf_def.c"
                   )
        *line = eline;
    ...
    if (h != conf->data) {
        CONF_free(conf->data);
        conf->data = 
# 595 "../crypto/conf/conf_def.c" 3 4
                    ((void *)0)
# 595 "../crypto/conf/conf_def.c"
                        ;
    }
    if (v != 
# 597 "../crypto/conf/conf_def.c" 3 4
            ((void *)0)
# 597 "../crypto/conf/conf_def.c"
                ) {
        CRYPTO_free(v->name, "../crypto/conf/conf_def.c", 598);
        CRYPTO_free(v->value, "../crypto/conf/conf_def.c", 599);
        CRYPTO_free(v, "../crypto/conf/conf_def.c", 600);
    }
    return 0;
}
...
{
    for (;;) {
        if (is_keytype(conf, *p, 2048)) {
            *p = '\0';
            return;
        }
        if (!is_keytype(conf, *p, 16)) {
            break;
        }
        p++;
    }
    ...
    for (;;) {
        if (is_keytype(conf, *p, 128)) {
            *p = '\0';
            return;
        }
        if (is_keytype(conf, *p, 1024)) {
            p = scan_dquote(conf, p);
            continue;
        }
        if (is_keytype(conf, *p, 64)) {
            p = scan_quote(conf, p);
            continue;
        }
        if (is_keytype(conf, *p, 32)) {
            p = (((is_keytype((conf), (p)[1], 8))?((p)+1):((p)+2)));
            continue;
        }
        if (is_keytype(conf, *p, 8))
            return;
        else
            p++;
    }
...
static int str_copy(CONF *conf, char *section, char **pto, char *from)
{
    ...
    if ((buf = BUF_MEM_new()) == 
# 648 "../crypto/conf/conf_def.c" 3 4
                                ((void *)0)
# 648 "../crypto/conf/conf_def.c"
                                    )
        return 0;
    ...
    for (;;) {
        if (is_keytype(conf, *from, 64)) {
            q = *from;
            from++;
            while (!is_keytype(conf, *from, 8) && (*from != q)) {
                if (is_keytype(conf, *from, 32)) {
                    from++;
                    if (is_keytype(conf, *from, 8))
                        break;
                }
                buf->data[to++] = *(from++);
            }
            ...
            rrp = 
# 707 "../crypto/conf/conf_def.c" 3 4
                 ((void *)0)
# 707 "../crypto/conf/conf_def.c"
                     ;
            s = &(from[1]);
            if (*s == '{')
                q = '}';
            ...
            cp = section;
            e = np = s;
            while (is_keytype(conf, *e, ((2|4)|1|256))
                   || (conf->flag_dollarid && is_keytype(conf, *e, 4096)))
                e++;
            if ((e[0] == ':') && (e[1] == ':')) {
                cp = np;
                rrp = e;
            ...
            *e = '\0';
            ...
            if (q) {
                if (r != q) {
                    (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",739,__func__), ERR_set_error)((14),(102),
# 739 "../crypto/conf/conf_def.c" 3 4
                   ((void *)0)
# 739 "../crypto/conf/conf_def.c"
                   );
                    goto err;
                }
                e++;
            }
# 754 "../crypto/conf/conf_def.c"
            p = _CONF_get_string(conf, cp, np);
            if (rrp != 
# 755 "../crypto/conf/conf_def.c" 3 4
                      ((void *)0)
# 755 "../crypto/conf/conf_def.c"
                          )
                *rrp = rr;
            *rp = r;
            if (p == 
# 758 "../crypto/conf/conf_def.c" 3 4
                    ((void *)0)
# 758 "../crypto/conf/conf_def.c"
                        ) {
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",759,__func__), ERR_set_error)((14),(104),
# 759 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 759 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            newsize = strlen(p) + buf->length - (e - from);
            if (newsize > 65536) {
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",764,__func__), ERR_set_error)((14),(116),
# 764 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 764 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            if (!BUF_MEM_grow_clean(buf, newsize)) {
                (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",768,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 768 "../crypto/conf/conf_def.c" 3 4
               ((void *)0)
# 768 "../crypto/conf/conf_def.c"
               );
                goto err;
            }
            while (*p)
    ...
    buf->data[to] = '\0';
    CRYPTO_free(*pto, "../crypto/conf/conf_def.c", 791);
    *pto = buf->data;
    CRYPTO_free(buf, "../crypto/conf/conf_def.c", 793);
    return 1;
 err:
    BUF_MEM_free(buf);
    return 0;
                            ...
                            char **dirpath)
{
    ...
    if (stat(include, &st) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",813,__func__), ERR_set_error)(2, 
# 813 "../crypto/conf/conf_def.c" 3 4
                                   (*__errno_location ())
# 813 "../crypto/conf/conf_def.c"
                                        , "calling stat(%s)", include);

        return 
# 815 "../crypto/conf/conf_def.c" 3 4
              ((void *)0)
# 815 "../crypto/conf/conf_def.c"
                  ;
    }

    if (
# 818 "../crypto/conf/conf_def.c" 3 4
       ((((
# 818 "../crypto/conf/conf_def.c"
       st.st_mode
# 818 "../crypto/conf/conf_def.c" 3 4
       )) & 0170000) == (0040000))
# 818 "../crypto/conf/conf_def.c"
        ...
        if (*dirctx != 
# 819 "../crypto/conf/conf_def.c" 3 4
                      ((void *)0)
# 819 "../crypto/conf/conf_def.c"
                          ) {
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_def.c",820,__func__), ERR_set_error)(14, 111,
                           "%s", include);
            return 
# 822 "../crypto/conf/conf_def.c" 3 4
                  ((void *)0)
# 822 "../crypto/conf/conf_def.c"
                      ;
        }

        if ((next = get_next_file(include, dirctx)) != 
# 825 "../crypto/conf/conf_def.c" 3 4
                                                      ((void *)0)
# 825 "../crypto/conf/conf_def.c"
                                                          )
            *dirpath = include;
        return next;
    }
...
static BIO *get_next_file(const char *path, OPENSSL_DIR_CTX **dirctx)
{
    ...
    pathlen = strlen(path);
    while ((filename = OPENSSL_DIR_read(dirctx, path)) != 
# 844 "../crypto/conf/conf_def.c" 3 4
                                                         ((void *)0)
# 844 "../crypto/conf/conf_def.c"
                                                             ) {
        size_t namelen;
        ...
        if ((namelen > 5
            ...
            newpath = CRYPTO_zalloc(newlen, "../crypto/conf/conf_def.c", 859);
            if (newpath == 
# 860 "../crypto/conf/conf_def.c" 3 4
                          ((void *)0)
# 860 "../crypto/conf/conf_def.c"
                              )
                break;
# 874 "../crypto/conf/conf_def.c"
            if (newpath[0] == '\0') {
            ...
            CRYPTO_free(newpath, "../crypto/conf/conf_def.c", 881);

            if (bio != 
# 883 "../crypto/conf/conf_def.c" 3 4
                      ((void *)0)
# 883 "../crypto/conf/conf_def.c"
                          )
                return bio;
        }
    }
    OPENSSL_DIR_end(dirctx);
    *dirctx = 
# 888 "../crypto/conf/conf_def.c" 3 4
             ((void *)0)
# 888 "../crypto/conf/conf_def.c"
                 ;
    return 
# 889 "../crypto/conf/conf_def.c" 3 4
          ((void *)0)
# 889 "../crypto/conf/conf_def.c"
              ;
}
...
static char *eat_ws(CONF *conf, char *p)
{
    while (is_keytype(conf, *p, 16) && (!is_keytype(conf, *p, 8)))
        p++;
    return p;
}
...
static void trim_ws(CONF *conf, char *start)
{
    ...
    while (!is_keytype(conf, *p, 8))
        p++;
    p--;
    while ((p >= start) && is_keytype(conf, *p, 16))
        p--;
    p++;
    *p = '\0';
}
...
static char *eat_alpha_numeric(CONF *conf, char *p)
{
    for (;;) {
        ...
        if (!(is_keytype(conf, *p, ((2|4)|1|256|512))
              || (conf->flag_dollarid && is_keytype(conf, *p, 4096))))
            return p;
        p++;
    }
}
...
static __attribute__((unused)) inline void lh_CONF_VALUE_doall_BIO_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const CONF_VALUE *, BIO *) = (void (*)(const CONF_VALUE *, BIO *))fn; fn_conv((const CONF_VALUE *)node, (BIO *)arg); } static __attribute__((unused)) inline void lh_CONF_VALUE_doall_BIO(struct lhash_st_CONF_VALUE *lh, void (*fn)(const CONF_VALUE *, BIO *), BIO *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_CONF_VALUE_doall_BIO_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_CONF_VALUE;
