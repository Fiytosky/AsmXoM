# 0 "../crypto/conf/conf_mod.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_mod.c"
# 13 "../crypto/conf/conf_mod.c"
...
# 21 "../crypto/conf/conf_mod.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 22 "../crypto/conf/conf_mod.c" 2
...
# 66 "../crypto/conf/conf_mod.c" 3 4
                                          0
# 66 "../crypto/conf/conf_mod.c"
                                                                 ;
static CRYPTO_RCU_LOCK *module_list_lock = 
# 67 "../crypto/conf/conf_mod.c" 3 4
                                          ((void *)0)
# 67 "../crypto/conf/conf_mod.c"
                                              ;
static struct stack_st_CONF_MODULE *supported_modules = 
# 68 "../crypto/conf/conf_mod.c" 3 4
                                                 ((void *)0)
# 68 "../crypto/conf/conf_mod.c"
                                                     ;
static struct stack_st_CONF_IMODULE *initialized_modules = 
# 69 "../crypto/conf/conf_mod.c" 3 4
                                                    ((void *)0)
# 69 "../crypto/conf/conf_mod.c"
                                                        ;

static CRYPTO_ONCE load_builtin_modules = 
# 71 "../crypto/conf/conf_mod.c" 3 4
                                         0
# 71 "../crypto/conf/conf_mod.c"
                                                                ;
...
static void module_lists_free(void)
{
    ...
    module_list_lock = 
# 91 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 91 "../crypto/conf/conf_mod.c"
                          ;

    sk_CONF_MODULE_free(supported_modules);
    supported_modules = 
# 94 "../crypto/conf/conf_mod.c" 3 4
                       ((void *)0)
# 94 "../crypto/conf/conf_mod.c"
                           ;

    sk_CONF_IMODULE_free(initialized_modules);
    initialized_modules = 
# 97 "../crypto/conf/conf_mod.c" 3 4
                         ((void *)0)
# 97 "../crypto/conf/conf_mod.c"
                             ;
}

static int do_init_module_list_lock(void); static int do_init_module_list_lock_ossl_ret_ = 0; static void do_init_module_list_lock_ossl_(void) { do_init_module_list_lock_ossl_ret_ = do_init_module_list_lock(); } static int do_init_module_list_lock(void)
{
    module_list_lock = ossl_rcu_lock_new(1, 
# 102 "../crypto/conf/conf_mod.c" 3 4
                                           ((void *)0)
# 102 "../crypto/conf/conf_mod.c"
                                               );
    if (module_list_lock == 
# 103 "../crypto/conf/conf_mod.c" 3 4
                           ((void *)0)
# 103 "../crypto/conf/conf_mod.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",104,__func__), ERR_set_error)((14),((15 | (0x2 << 18L))),
# 104 "../crypto/conf/conf_mod.c" 3 4
       ((void *)0)
# 104 "../crypto/conf/conf_mod.c"
       );
        return 0;
    }
...
{
    return _CONF_get_number(cnf, 
# 113 "../crypto/conf/conf_mod.c" 3 4
                                ((void *)0)
# 113 "../crypto/conf/conf_mod.c"
                      ...
                      unsigned long flags)
{
    ...
    CONF_VALUE *vl;
    char *vsection = 
# 123 "../crypto/conf/conf_mod.c" 3 4
                    ((void *)0)
# 123 "../crypto/conf/conf_mod.c"
                        ;
    int ret, i;
...
# 137 "../crypto/conf/conf_mod.c" 3 4
                                        ((void *)0)
# 137 "../crypto/conf/conf_mod.c"
                                            , appname);

    if (!appname || (!vsection && (flags & 0x20)))
        vsection = NCONF_get_string(cnf, 
# 140 "../crypto/conf/conf_mod.c" 3 4
                                        ((void *)0)
# 140 "../crypto/conf/conf_mod.c"
                                            , "openssl_conf");
    ...
    if (values == 
# 150 "../crypto/conf/conf_mod.c" 3 4
                 ((void *)0)
# 150 "../crypto/conf/conf_mod.c"
                     ) {
        if (!(flags & 0x4)) {
            ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",153,__func__), ERR_set_error)(14,
                           124,
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(values)); i++) {
        vl = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(values), (i)));
        ERR_set_mark();
...
{
    char *file = 
# 184 "../crypto/conf/conf_mod.c" 3 4
                ((void *)0)
# 184 "../crypto/conf/conf_mod.c"
                    ;
    CONF *conf = 
# 185 "../crypto/conf/conf_mod.c" 3 4
                ((void *)0)
# 185 "../crypto/conf/conf_mod.c"
    ...
    if (filename == 
# 190 "../crypto/conf/conf_mod.c" 3 4
                   ((void *)0)
# 190 "../crypto/conf/conf_mod.c"
                       ) {
        file = CONF_get1_default_config_file();
        if (file == 
# 192 "../crypto/conf/conf_mod.c" 3 4
                   ((void *)0)
# 192 "../crypto/conf/conf_mod.c"
                       )
            goto err;
        if (*file == '\0') {
    ...
    conf = NCONF_new_ex(libctx, 
# 203 "../crypto/conf/conf_mod.c" 3 4
                               ((void *)0)
# 203 "../crypto/conf/conf_mod.c"
                                   );
    if (conf == 
# 204 "../crypto/conf/conf_mod.c" 3 4
               ((void *)0)
# 204 "../crypto/conf/conf_mod.c"
                   )
        goto err;

    if (NCONF_load(conf, file, 
# 207 "../crypto/conf/conf_mod.c" 3 4
                              ((void *)0)
# 207 "../crypto/conf/conf_mod.c"
                                  ) <= 0) {
        if ((flags & 0x10) &&
            (ERR_GET_REASON(ERR_peek_last_error()) == 114)) {
            ret = 1;
        }
        goto err;
    }
 ...
 err:
    if (filename == 
# 219 "../crypto/conf/conf_mod.c" 3 4
                   ((void *)0)
# 219 "../crypto/conf/conf_mod.c"
                       )
        CRYPTO_free(file, "../crypto/conf/conf_mod.c", 220);
    NCONF_free(conf);

    if ((flags & 0x2) != 0 && !diagnostics)
        ret = 1;
...
int CONF_modules_load_file(const char *filename,
                           const char *appname, unsigned long flags)
{
    return CONF_modules_load_file_ex(
# 237 "../crypto/conf/conf_mod.c" 3 4
                                    ((void *)0)
# 237 "../crypto/conf/conf_mod.c"
                                        , filename, appname, flags);
}

static int do_load_builtin_modules(void); static int do_load_builtin_modules_ossl_ret_ = 0; static void do_load_builtin_modules_ossl_(void) { do_load_builtin_modules_ossl_ret_ = do_load_builtin_modules(); } static int do_load_builtin_modules(void)
{
                      ...
                      unsigned long flags)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&load_builtin_modules, do_load_builtin_modules_ossl_) ? do_load_builtin_modules_ossl_ret_ : 0))
        return -1;
    ...
    if (!md) {
        if (!(flags & 0x4)) {
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",267,__func__), ERR_set_error)(14, 113,
                           "module=%s", name);
        }
        return -1;
    }
    ...
    if (ret <= 0) {
        if (!(flags & 0x4))
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",277,__func__), ERR_set_error)(14, 109,
...
{
    DSO *dso = 
# 289 "../crypto/conf/conf_mod.c" 3 4
              ((void *)0)
# 289 "../crypto/conf/conf_mod.c"
                  ;
    conf_init_func *ifunc;
    conf_finish_func *ffunc;
    const char *path = 
# 292 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 292 "../crypto/conf/conf_mod.c"
                          ;
    int errcode = 0;
    CONF_MODULE *md;
    ...
    if (path == 
# 298 "../crypto/conf/conf_mod.c" 3 4
               ((void *)0)
# 298 "../crypto/conf/conf_mod.c"
                   ) {
        path = name;
    }
    dso = DSO_load(
# 301 "../crypto/conf/conf_mod.c" 3 4
                  ((void *)0)
# 301 "../crypto/conf/conf_mod.c"
                      , path, 
# 301 "../crypto/conf/conf_mod.c" 3 4
                              ((void *)0)
# 301 "../crypto/conf/conf_mod.c"
                                  , 0);
    if (dso == 
# 302 "../crypto/conf/conf_mod.c" 3 4
              ((void *)0)
# 302 "../crypto/conf/conf_mod.c"
                  ) {
        errcode = 110;
        goto err;
    }
    ...
    if (ifunc == 
# 307 "../crypto/conf/conf_mod.c" 3 4
                ((void *)0)
# 307 "../crypto/conf/conf_mod.c"
                    ) {
        errcode = 112;
        goto err;
    }
    ...
    if (md == 
# 315 "../crypto/conf/conf_mod.c" 3 4
             ((void *)0)
# 315 "../crypto/conf/conf_mod.c"
                 )
        goto err;
 ...
 err:
    DSO_free(dso);
    (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",322,__func__), ERR_set_error)(14, errcode, "module=%s, path=%s", name, path);
    return 
# 323 "../crypto/conf/conf_mod.c" 3 4
          ((void *)0)
# 323 "../crypto/conf/conf_mod.c"
              ;
}
...
{
    CONF_MODULE *tmod = 
# 330 "../crypto/conf/conf_mod.c" 3 4
                       ((void *)0)
# 330 "../crypto/conf/conf_mod.c"
                           ;
    struct stack_st_CONF_MODULE *old_modules;
    struct stack_st_CONF_MODULE *new_modules;

    if (!(CRYPTO_THREAD_run_once(&init_module_list_lock, do_init_module_list_lock_ossl_) ? do_init_module_list_lock_ossl_ret_ : 0))
        return 
# 335 "../crypto/conf/conf_mod.c" 3 4
              ((void *)0)
# 335 "../crypto/conf/conf_mod.c"
                  ;

    ossl_rcu_write_lock(module_list_lock);

    old_modules = ossl_rcu_uptr_deref((void **)&supported_modules);

    if (old_modules == 
# 341 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 341 "../crypto/conf/conf_mod.c"
                          )
    ...
    if (new_modules == 
# 346 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 346 "../crypto/conf/conf_mod.c"
                          )
        goto err;

    if ((tmod = CRYPTO_zalloc(sizeof(*tmod), "../crypto/conf/conf_mod.c", 349)) == 
# 349 "../crypto/conf/conf_mod.c" 3 4
                                                 ((void *)0)
# 349 "../crypto/conf/conf_mod.c"
                                                     )
        goto err;

    tmod->dso = dso;
    tmod->name = CRYPTO_strdup(name, "../crypto/conf/conf_mod.c", 353);
    tmod->init = ifunc;
    tmod->finish = ffunc;
    if (tmod->name == 
# 356 "../crypto/conf/conf_mod.c" 3 4
                     ((void *)0)
# 356 "../crypto/conf/conf_mod.c"
                         )
        goto err;
    ...
    ossl_rcu_assign_uptr((void **)&supported_modules, (void **)&new_modules);
 ...
 err:
    ...
    if (tmod != 
# 372 "../crypto/conf/conf_mod.c" 3 4
               ((void *)0)
# 372 "../crypto/conf/conf_mod.c"
                   ) {
        CRYPTO_free(tmod->name, "../crypto/conf/conf_mod.c", 373);
        CRYPTO_free(tmod, "../crypto/conf/conf_mod.c", 374);
    }
    sk_CONF_MODULE_free(new_modules);
    return 
# 377 "../crypto/conf/conf_mod.c" 3 4
          ((void *)0)
# 377 "../crypto/conf/conf_mod.c"
              ;
}
...
static CONF_MODULE *module_find(const char *name)
{
    ...
    int i, nchar;
    char *p;
    struct stack_st_CONF_MODULE *mods;
    ...
    if (!(CRYPTO_THREAD_run_once(&init_module_list_lock, do_init_module_list_lock_ossl_) ? do_init_module_list_lock_ossl_ret_ : 0))
        return 
# 401 "../crypto/conf/conf_mod.c" 3 4
              ((void *)0)
# 401 "../crypto/conf/conf_mod.c"
                  ;

    ossl_rcu_read_lock(module_list_lock);
    mods = ossl_rcu_uptr_deref((void **)&supported_modules);
    ...
    ossl_rcu_read_unlock(module_list_lock);
    return 
# 415 "../crypto/conf/conf_mod.c" 3 4
          ((void *)0)
# 415 "../crypto/conf/conf_mod.c"
              ;
}
                       ...
                       const CONF *cnf)
{
    ...
    int init_called = 0;
    CONF_IMODULE *imod = 
# 424 "../crypto/conf/conf_mod.c" 3 4
                        ((void *)0)
# 424 "../crypto/conf/conf_mod.c"
                            ;
    struct stack_st_CONF_IMODULE *old_modules;
    struct stack_st_CONF_IMODULE *new_modules;


    imod = CRYPTO_malloc(sizeof(*imod), "../crypto/conf/conf_mod.c", 429);
    if (imod == 
# 430 "../crypto/conf/conf_mod.c" 3 4
               ((void *)0)
# 430 "../crypto/conf/conf_mod.c"
                   )
        goto err;

    imod->pmod = pmod;
    imod->name = CRYPTO_strdup(name, "../crypto/conf/conf_mod.c", 434);
    imod->value = CRYPTO_strdup(value, "../crypto/conf/conf_mod.c", 435);
    imod->usr_data = 
# 436 "../crypto/conf/conf_mod.c" 3 4
                    ((void *)0)
# 436 "../crypto/conf/conf_mod.c"
                        ;
    ...
    old_modules = ossl_rcu_uptr_deref((void **)&initialized_modules);

    if (old_modules == 
# 457 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 457 "../crypto/conf/conf_mod.c"
                          )
    ...
    if (new_modules == 
# 462 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 462 "../crypto/conf/conf_mod.c"
                          ) {
        ossl_rcu_write_unlock(module_list_lock);
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",464,__func__), ERR_set_error)((14),((15 | (0x2 << 18L))),
# 464 "../crypto/conf/conf_mod.c" 3 4
       ((void *)0)
# 464 "../crypto/conf/conf_mod.c"
    ...
    if (!sk_CONF_IMODULE_push(new_modules, imod)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",471,__func__), ERR_set_error)((14),((15 | (0x2 << 18L))),
# 471 "../crypto/conf/conf_mod.c" 3 4
       ((void *)0)
# 471 "../crypto/conf/conf_mod.c"
       );
        goto err;
    }
    ...
    ossl_rcu_assign_uptr((void **)&initialized_modules, (void **)&new_modules);
    ossl_rcu_write_unlock(module_list_lock);
    ossl_synchronize_rcu(module_list_lock);
 ...
 memerr:
    if (imod) {
        CRYPTO_free(imod->name, "../crypto/conf/conf_mod.c", 491);
        CRYPTO_free(imod->value, "../crypto/conf/conf_mod.c", 492);
        CRYPTO_free(imod, "../crypto/conf/conf_mod.c", 493);
    }
...
void CONF_modules_unload(int all)
{
    ...
    struct stack_st_CONF_MODULE *old_modules;
    struct stack_st_CONF_MODULE *new_modules;
    struct stack_st_CONF_MODULE *to_delete;
    ...
    if (new_modules == 
# 522 "../crypto/conf/conf_mod.c" 3 4
                      ((void *)0)
# 522 "../crypto/conf/conf_mod.c"
                          ) {
        ossl_rcu_write_unlock(module_list_lock);
        return;
    }
    ...
    if (sk_CONF_MODULE_num(new_modules) == 0) {
        sk_CONF_MODULE_free(new_modules);
        new_modules = 
# 542 "../crypto/conf/conf_mod.c" 3 4
                     ((void *)0)
# 542 "../crypto/conf/conf_mod.c"
                         ;
    }
...
{
    DSO_free(md->dso);
    CRYPTO_free(md->name, "../crypto/conf/conf_mod.c", 557);
    CRYPTO_free(md, "../crypto/conf/conf_mod.c", 558);
}
...
static int conf_modules_finish_int(void)
{
    ...
    struct stack_st_CONF_IMODULE *old_modules;
    struct stack_st_CONF_IMODULE *new_modules = 
# 567 "../crypto/conf/conf_mod.c" 3 4
                                         ((void *)0)
# 567 "../crypto/conf/conf_mod.c"
                                             ;
    ...
    if (module_list_lock == 
# 573 "../crypto/conf/conf_mod.c" 3 4
                           ((void *)0)
# 573 "../crypto/conf/conf_mod.c"
                               )
        return 0;
...
static void module_finish(CONF_IMODULE *imod)
{
    ...
    imod->pmod->links--;
    CRYPTO_free(imod->name, "../crypto/conf/conf_mod.c", 605);
    CRYPTO_free(imod->value, "../crypto/conf/conf_mod.c", 606);
    CRYPTO_free(imod, "../crypto/conf/conf_mod.c", 607);
}
...
{
    if (module_add(
# 615 "../crypto/conf/conf_mod.c" 3 4
                  ((void *)0)
# 615 "../crypto/conf/conf_mod.c"
                      , name, ifunc, ffunc))
        return 1;
    else
        return 0;
...
char *CONF_get1_default_config_file(void)
{
    ...
    if ((file = ossl_safe_getenv("OPENSSL_CONF")) != 
# 681 "../crypto/conf/conf_mod.c" 3 4
                                                    ((void *)0)
# 681 "../crypto/conf/conf_mod.c"
                                                        )
        return CRYPTO_strdup(file, "../crypto/conf/conf_mod.c", 682);

    t = X509_get_default_cert_area();

    sep = "/";

    size = strlen(t) + strlen(sep) + strlen("openssl.cnf") + 1;
    file = CRYPTO_malloc(size, "../crypto/conf/conf_mod.c", 689);

    if (file == 
# 691 "../crypto/conf/conf_mod.c" 3 4
               ((void *)0)
# 691 "../crypto/conf/conf_mod.c"
                   )
        return 
# 692 "../crypto/conf/conf_mod.c" 3 4
              ((void *)0)
# 692 "../crypto/conf/conf_mod.c"
                  ;
    BIO_snprintf(file, size, "%s%s%s", t, sep, "openssl.cnf");

    return file;
}
# 705 "../crypto/conf/conf_mod.c"
                    ...
                    void *arg)
{
    ...
    if (list_ == 
# 712 "../crypto/conf/conf_mod.c" 3 4
                ((void *)0)
# 712 "../crypto/conf/conf_mod.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_mod.c",713,__func__), ERR_set_error)((14),(115),
# 713 "../crypto/conf/conf_mod.c" 3 4
       ((void *)0)
# 713 "../crypto/conf/conf_mod.c"
       );
        return 0;
    }
    ...
    for (;;) {
        if (nospc) {
            while (*lstart && 
# 720 "../crypto/conf/conf_mod.c" 3 4
                             ((*__ctype_b_loc ())[(int) ((
# 720 "../crypto/conf/conf_mod.c"
...
# 720 "../crypto/conf/conf_mod.c"
        ...
        if (p == lstart || *lstart == '\0')
            ret = list_cb(
# 725 "../crypto/conf/conf_mod.c" 3 4
                         ((void *)0)
# 725 "../crypto/conf/conf_mod.c"
                             , 0, arg);
        else {
            if (p)
                tmpend = p - 1;
            ...
            if (nospc) {
                while (
# 732 "../crypto/conf/conf_mod.c" 3 4
                      ((*__ctype_b_loc ())[(int) ((
# 732 "../crypto/conf/conf_mod.c"
...
# 732 "../crypto/conf/conf_mod.c"
        ...
        if (ret <= 0)
            return ret;
        if (p == 
# 739 "../crypto/conf/conf_mod.c" 3 4
                ((void *)0)
# 739 "../crypto/conf/conf_mod.c"
                    )
            return 1;
        lstart = p + 1;
    }
