# 0 "../crypto/conf/conf_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_lib.c"
# 10 "../crypto/conf/conf_lib.c"
...
# 28 "../crypto/conf/conf_lib.c" 3 4
                              ((void *)0)
# 28 "../crypto/conf/conf_lib.c"
                                  )
                                ...
                                long *eline)
{
    ...
    BIO *in = 
# 50 "../crypto/conf/conf_lib.c" 3 4
             ((void *)0)
# 50 "../crypto/conf/conf_lib.c"
                 ;
    ...
    if (in == 
# 57 "../crypto/conf/conf_lib.c" 3 4
             ((void *)0)
# 57 "../crypto/conf/conf_lib.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",58,__func__), ERR_set_error)((14),((2 | (0x2 << 18L))),
# 58 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 58 "../crypto/conf/conf_lib.c"
       );
        return 
# 59 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 59 "../crypto/conf/conf_lib.c"
                  ;
    }
...
# 74 "../crypto/conf/conf_lib.c" 3 4
                                               ((void *)0)
# 74 "../crypto/conf/conf_lib.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",75,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 75 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 75 "../crypto/conf/conf_lib.c"
       );
        return 
# 76 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 76 "../crypto/conf/conf_lib.c"
                  ;
    }
                                    ...
                                    long *eline)
{
    ...
    if (ret)
        return ctmp.data;
    return 
# 95 "../crypto/conf/conf_lib.c" 3 4
          ((void *)0)
# 95 "../crypto/conf/conf_lib.c"
              ;
}
...
{
    if (conf == 
# 101 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 101 "../crypto/conf/conf_lib.c"
                   ) {
        return 
# 102 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 102 "../crypto/conf/conf_lib.c"
                  ;
    } else {
        CONF ctmp;
...
{
    if (conf == 
# 114 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 114 "../crypto/conf/conf_lib.c"
                   ) {
        return NCONF_get_string(
# 115 "../crypto/conf/conf_lib.c" 3 4
                               ((void *)0)
# 115 "../crypto/conf/conf_lib.c"
                                   , group, name);
    } else {
        CONF ctmp;
                     ...
                     const char *name)
{
    ...
    ERR_set_mark();
    if (conf == 
# 131 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 131 "../crypto/conf/conf_lib.c"
                   ) {
        status = NCONF_get_number_e(
# 132 "../crypto/conf/conf_lib.c" 3 4
                                   ((void *)0)
# 132 "../crypto/conf/conf_lib.c"
                                       , group, name, &result);
    } else {
        CONF ctmp;
...
# 156 "../crypto/conf/conf_lib.c" 3 4
                                                ((void *)0)
# 156 "../crypto/conf/conf_lib.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",157,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 157 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 157 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
CONF *NCONF_new_ex(OSSL_LIB_CTX *libctx, CONF_METHOD *meth)
{
    ...
    if (meth == 
# 186 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 186 "../crypto/conf/conf_lib.c"
                   )
        meth = NCONF_default();

    ret = meth->create(meth);
    if (ret == 
# 190 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 190 "../crypto/conf/conf_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",191,__func__), ERR_set_error)((14),((14 | (0x2 << 18L))),
# 191 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 191 "../crypto/conf/conf_lib.c"
       );
        return 
# 192 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 192 "../crypto/conf/conf_lib.c"
                  ;
    }
    ret->libctx = libctx;
...
{
    return NCONF_new_ex(
# 201 "../crypto/conf/conf_lib.c" 3 4
                       ((void *)0)
# 201 "../crypto/conf/conf_lib.c"
                           , meth);
}
...
{
    if (conf == 
# 206 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 206 "../crypto/conf/conf_lib.c"
                   )
        return;
...
{
    if (conf == 
# 213 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 213 "../crypto/conf/conf_lib.c"
                   )
        return;
...
typedef struct stack_st_OPENSSL_CSTRING SECTION_NAMES;

static __attribute__((unused)) inline void lh_CONF_VALUE_doall_SECTION_NAMES_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const CONF_VALUE *, SECTION_NAMES *) = (void (*)(const CONF_VALUE *, SECTION_NAMES *))fn; fn_conv((const CONF_VALUE *)node, (SECTION_NAMES *)arg); } static __attribute__((unused)) inline void lh_CONF_VALUE_doall_SECTION_NAMES(struct lhash_st_CONF_VALUE *lh, void (*fn)(const CONF_VALUE *, SECTION_NAMES *), SECTION_NAMES *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_CONF_VALUE_doall_SECTION_NAMES_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_CONF_VALUE;

static void collect_section_name(const CONF_VALUE *v, SECTION_NAMES *names)
{

    if (v->name == 
# 230 "../crypto/conf/conf_lib.c" 3 4
                  ((void *)0)
# 230 "../crypto/conf/conf_lib.c"
                      )
        OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(names), ossl_check_OPENSSL_CSTRING_type(v->section));
}
...
struct stack_st_OPENSSL_CSTRING *NCONF_get_section_names(const CONF *cnf)
{
    SECTION_NAMES *names;

    if ((names = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new(ossl_check_OPENSSL_CSTRING_compfunc_type(section_name_cmp)))) == 
# 243 "../crypto/conf/conf_lib.c" 3 4
                                                             ((void *)0)
# 243 "../crypto/conf/conf_lib.c"
                                                                 )
        return 
# 244 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 244 "../crypto/conf/conf_lib.c"
                  ;
    lh_CONF_VALUE_doall_SECTION_NAMES(cnf->data, collect_section_name, names);
    OPENSSL_sk_sort(ossl_check_OPENSSL_CSTRING_sk_type(names));
    return names;
}
...
{
    if (conf == 
# 252 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 252 "../crypto/conf/conf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",253,__func__), ERR_set_error)((14),(105),
# 253 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 253 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
int NCONF_load_fp(CONF *conf, FILE *fp, long *eline)
{
    ...
    int ret;
    if ((btmp = BIO_new_fp(fp, 0x00)) == 
# 265 "../crypto/conf/conf_lib.c" 3 4
                                               ((void *)0)
# 265 "../crypto/conf/conf_lib.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",266,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 266 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 266 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
{
    if (conf == 
# 277 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 277 "../crypto/conf/conf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",278,__func__), ERR_set_error)((14),(105),
# 278 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 278 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
{
    if (conf == 
# 287 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 287 "../crypto/conf/conf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",288,__func__), ERR_set_error)((14),(105),
# 288 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 288 "../crypto/conf/conf_lib.c"
       );
        return 
# 289 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 289 "../crypto/conf/conf_lib.c"
                  ;
    }

    if (section == 
# 292 "../crypto/conf/conf_lib.c" 3 4
                  ((void *)0)
# 292 "../crypto/conf/conf_lib.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",293,__func__), ERR_set_error)((14),(107),
# 293 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 293 "../crypto/conf/conf_lib.c"
       );
        return 
# 294 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 294 "../crypto/conf/conf_lib.c"
                  ;
    }
...
char *NCONF_get_string(const CONF *conf, const char *group, const char *name)
{
    ...
    if (conf == 
# 311 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 311 "../crypto/conf/conf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",312,__func__), ERR_set_error)((14),(106),
# 312 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 312 "../crypto/conf/conf_lib.c"
       );
        return 
# 313 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 313 "../crypto/conf/conf_lib.c"
                  ;
    }
    (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",315,__func__), ERR_set_error)(14, 108,
                   "group=%s name=%s", group, name);
    return 
# 317 "../crypto/conf/conf_lib.c" 3 4
          ((void *)0)
# 317 "../crypto/conf/conf_lib.c"
              ;
}
                       ...
                       long *result)
{
    ...
    if (result == 
# 338 "../crypto/conf/conf_lib.c" 3 4
                 ((void *)0)
# 338 "../crypto/conf/conf_lib.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",339,__func__), ERR_set_error)((14),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 339 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 339 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
    ...
    if (str == 
# 345 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 345 "../crypto/conf/conf_lib.c"
                  )
        return 0;

    if (conf != 
# 348 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 348 "../crypto/conf/conf_lib.c"
                   ) {
        if (conf->meth->is_number != 
# 349 "../crypto/conf/conf_lib.c" 3 4
                                    ((void *)0)
# 349 "../crypto/conf/conf_lib.c"
                                        )
            is_number = conf->meth->is_number;
        if (conf->meth->to_int != 
# 351 "../crypto/conf/conf_lib.c" 3 4
                                 ((void *)0)
# 351 "../crypto/conf/conf_lib.c"
                                     )
    ...
    for (res = 0; is_number(conf, *str); str++) {
        ...
        if (res > (0x7fffffffffffffffL 
# 357 "../crypto/conf/conf_lib.c"
                           - d) / 10L) {
            (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",358,__func__), ERR_set_error)((14),(121),
# 358 "../crypto/conf/conf_lib.c" 3 4
           ((void *)0)
# 358 "../crypto/conf/conf_lib.c"
           );
            return 0;
        }
        res = res * 10 + d;
...
int NCONF_dump_fp(const CONF *conf, FILE *out)
{
    ...
    int ret;
    if ((btmp = BIO_new_fp(out, 0x00)) == 
# 385 "../crypto/conf/conf_lib.c" 3 4
                                                ((void *)0)
# 385 "../crypto/conf/conf_lib.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",386,__func__), ERR_set_error)((14),((7 | (0x2 << 18L))),
# 386 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 386 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
{
    if (conf == 
# 397 "../crypto/conf/conf_lib.c" 3 4
               ((void *)0)
# 397 "../crypto/conf/conf_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/conf/conf_lib.c",398,__func__), ERR_set_error)((14),(105),
# 398 "../crypto/conf/conf_lib.c" 3 4
       ((void *)0)
# 398 "../crypto/conf/conf_lib.c"
       );
        return 0;
    }
...
OPENSSL_INIT_SETTINGS *OPENSSL_INIT_new(void)
{
    ...
    if (ret == 
# 413 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 413 "../crypto/conf/conf_lib.c"
                  )
        return 
# 414 "../crypto/conf/conf_lib.c" 3 4
              ((void *)0)
# 414 "../crypto/conf/conf_lib.c"
                  ;

    memset(ret, 0, sizeof(*ret));
    ret->flags = (0x20 | 0x10 | 0x2);

    return ret;
}
# 430 "../crypto/conf/conf_lib.c"
int OPENSSL_INIT_set_config_filename(OPENSSL_INIT_SETTINGS *settings,
                                     const char *filename)
{
    char *newfilename = 
# 433 "../crypto/conf/conf_lib.c" 3 4
                       ((void *)0)
# 433 "../crypto/conf/conf_lib.c"
                           ;

    if (filename != 
# 435 "../crypto/conf/conf_lib.c" 3 4
                   ((void *)0)
# 435 "../crypto/conf/conf_lib.c"
                       ) {
        newfilename = strdup(filename);
        if (newfilename == 
# 437 "../crypto/conf/conf_lib.c" 3 4
                          ((void *)0)
# 437 "../crypto/conf/conf_lib.c"
                              )
            return 0;
    }
...
{
    char *newappname = 
# 462 "../crypto/conf/conf_lib.c" 3 4
                      ((void *)0)
# 462 "../crypto/conf/conf_lib.c"
                          ;

    if (appname != 
# 464 "../crypto/conf/conf_lib.c" 3 4
                  ((void *)0)
# 464 "../crypto/conf/conf_lib.c"
                      ) {
        newappname = strdup(appname);
        if (newappname == 
# 466 "../crypto/conf/conf_lib.c" 3 4
                         ((void *)0)
# 466 "../crypto/conf/conf_lib.c"
                             )
            return 0;
    }
...
{
    if (settings == 
# 479 "../crypto/conf/conf_lib.c" 3 4
                   ((void *)0)
# 479 "../crypto/conf/conf_lib.c"
                       )
        return;
