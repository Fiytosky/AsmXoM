# 0 "../crypto/conf/conf_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/conf/conf_err.c"
# 11 "../crypto/conf/conf_err.c"
...
# 12 "../crypto/conf/conf_err.c" 2
# 1 "../include/openssl/conferr.h" 1
# 13 "../include/openssl/conferr.h"
        
# 13 "../crypto/conf/conf_err.c" 2
# 1 "../include/crypto/conferr.h" 1
# 13 "../include/crypto/conferr.h"
        
# 22 "../include/crypto/conferr.h"
int ossl_err_load_CONF_strings(void);
# 14 "../crypto/conf/conf_err.c" 2



static const ERR_STRING_DATA CONF_str_reasons[] = {
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "error loading dso"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ), "invalid pragma"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "list cannot be null"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "mandatory braces in variable expansion"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "missing close square bracket"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "missing equal sign"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "missing init function"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "module initialization error"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "no close brace"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "no conf"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "no conf or environment variable"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "no section"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "no such file"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "no value"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ), "number too large"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "openssl conf references missing section"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "recursive directory include"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "recursive section reference"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "relative path"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "ssl command section empty"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "ssl command section not found"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "ssl section empty"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "ssl section not found"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "unable to create new section"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "unknown module name"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "variable expansion too long"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "variable has no value"},
    {0, 
# 62 "../crypto/conf/conf_err.c" 3 4
       ((void *)0)
# 62 "../crypto/conf/conf_err.c"
           }
};
...
int ossl_err_load_CONF_strings(void)
{
    ...
    if (ERR_reason_error_string(CONF_str_reasons[0].error) == 
# 70 "../crypto/conf/conf_err.c" 3 4
                                                             ((void *)0)
# 70 "../crypto/conf/conf_err.c"
                                                                 )
