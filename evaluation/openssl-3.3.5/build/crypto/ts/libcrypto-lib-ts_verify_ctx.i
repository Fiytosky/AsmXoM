# 0 "../crypto/ts/ts_verify_ctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_verify_ctx.c"
# 10 "../crypto/ts/ts_verify_ctx.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 11 "../crypto/ts/ts_verify_ctx.c" 2
...
# 12 "../crypto/ts/ts_verify_ctx.c" 2
...
int TS_CONF_set_ess_cert_id_digest(CONF *conf, const char *section,
                                      TS_RESP_CTX *ctx);
# 13 "../crypto/ts/ts_verify_ctx.c" 2
...
# 14 "../crypto/ts/ts_verify_ctx.c" 2

TS_VERIFY_CTX *TS_VERIFY_CTX_new(void)
{
    TS_VERIFY_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/ts/ts_verify_ctx.c", 17);
...
{
    (void)((ctx != 
# 24 "../crypto/ts/ts_verify_ctx.c" 3 4
   ((void *)0)
# 24 "../crypto/ts/ts_verify_ctx.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "ctx != NULL", "../crypto/ts/ts_verify_ctx.c", 24), 1));
...
void TS_VERIFY_CTX_free(TS_VERIFY_CTX *ctx)
{
    ...
    CRYPTO_free(ctx, "../crypto/ts/ts_verify_ctx.c", 34);
}
...
struct stack_st_X509 *TS_VERIFY_CTX_set_certs(TS_VERIFY_CTX *ctx,
                                        struct stack_st_X509 *certs)
{
    ctx->certs = certs;
    return ctx->certs;
...
unsigned char *TS_VERIFY_CTX_set_imprint(TS_VERIFY_CTX *ctx,
                                         unsigned char *hexstr, long len)
{
    CRYPTO_free(ctx->imprint, "../crypto/ts/ts_verify_ctx.c", 71);
    ctx->imprint = hexstr;
    ctx->imprint_len = len;
    return ctx->imprint;
}
...
void TS_VERIFY_CTX_cleanup(TS_VERIFY_CTX *ctx)
{
    ...
    CRYPTO_free(ctx->imprint, "../crypto/ts/ts_verify_ctx.c", 88);
...
TS_VERIFY_CTX *TS_REQ_to_TS_VERIFY_CTX(TS_REQ *req, TS_VERIFY_CTX *ctx)
{
    ...
    (void)((req != 
# 108 "../crypto/ts/ts_verify_ctx.c" 3 4
   ((void *)0)
# 108 "../crypto/ts/ts_verify_ctx.c"
   ) ? 0 : (OPENSSL_die("assertion failed: " "req != NULL", "../crypto/ts/ts_verify_ctx.c", 108), 1));
    if (ret)
        TS_VERIFY_CTX_cleanup(ret);
    else if ((ret = TS_VERIFY_CTX_new()) == 
# 111 "../crypto/ts/ts_verify_ctx.c" 3 4
                                           ((void *)0)
# 111 "../crypto/ts/ts_verify_ctx.c"
                                               )
        return 
# 112 "../crypto/ts/ts_verify_ctx.c" 3 4
              ((void *)0)
# 112 "../crypto/ts/ts_verify_ctx.c"
                  ;

    ret->flags = ((1u << 0) | (1u << 1) | (1u << 2) | (1u << 3) | (1u << 5) | (1u << 6) | (1u << 7)) & ~((1u << 7) | (1u << 0));

    if ((policy = req->policy_id) != 
# 116 "../crypto/ts/ts_verify_ctx.c" 3 4
                                    ((void *)0)
# 116 "../crypto/ts/ts_verify_ctx.c"
                                        ) {
        if ((ret->policy = OBJ_dup(policy)) == 
# 117 "../crypto/ts/ts_verify_ctx.c" 3 4
                                              ((void *)0)
# 117 "../crypto/ts/ts_verify_ctx.c"
                                                  )
            goto err;
    } else
        ret->flags &= ~(1u << 2);
...
# 124 "../crypto/ts/ts_verify_ctx.c" 3 4
                                                 ((void *)0)
# 124 "../crypto/ts/ts_verify_ctx.c"
                                                     )
        goto err;
    ...
    if (ret->imprint_len <= 0)
        goto err;
    if ((ret->imprint = CRYPTO_malloc(ret->imprint_len, "../crypto/ts/ts_verify_ctx.c", 130)) == 
# 130 "../crypto/ts/ts_verify_ctx.c" 3 4
                                                            ((void *)0)
# 130 "../crypto/ts/ts_verify_ctx.c"
                                                                )
        goto err;
    memcpy(ret->imprint, ASN1_STRING_get0_data(msg), ret->imprint_len);

    if ((nonce = req->nonce) != 
# 134 "../crypto/ts/ts_verify_ctx.c" 3 4
                               ((void *)0)
# 134 "../crypto/ts/ts_verify_ctx.c"
                                   ) {
        if ((ret->nonce = ASN1_INTEGER_dup(nonce)) == 
# 135 "../crypto/ts/ts_verify_ctx.c" 3 4
                                                     ((void *)0)
# 135 "../crypto/ts/ts_verify_ctx.c"
                                                         )
            goto err;
    } else
        ret->flags &= ~(1u << 5);
 ...
 err:
    ...
    return 
# 146 "../crypto/ts/ts_verify_ctx.c" 3 4
          ((void *)0)
# 146 "../crypto/ts/ts_verify_ctx.c"
              ;
}
