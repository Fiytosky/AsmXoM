# 0 "../crypto/ts/ts_rsp_print.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_rsp_print.c"
# 10 "../crypto/ts/ts_rsp_print.c"
...
int TS_RESP_print_bio(BIO *bio, TS_RESP *a)
{
    ...
    BIO_printf(bio, "\nTST info:\n");
    if (a->tst_info != 
# 34 "../crypto/ts/ts_rsp_print.c" 3 4
                      ((void *)0)
# 34 "../crypto/ts/ts_rsp_print.c"
                          )
...
int TS_STATUS_INFO_print_bio(BIO *bio, TS_STATUS_INFO *a)
{
    ...
    static const struct status_map_st failure_map[] = {
        ...
        {-1, 
# 70 "../crypto/ts/ts_rsp_print.c" 3 4
            ((void *)0)
# 70 "../crypto/ts/ts_rsp_print.c"
                }
    };
    long status;
    int i, lines = 0;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(a->text)); ++i) {
        if (i > 0)
            BIO_puts(bio, "\t");
        ASN1_STRING_print_ex(bio, ((ASN1_UTF8STRING *)OPENSSL_sk_value(ossl_check_const_ASN1_UTF8STRING_sk_type(a->text), (i))), 0);
        BIO_puts(bio, "\n");
    }
    if (i == 0)
    ...
    if (a->failure_info != 
# 93 "../crypto/ts/ts_rsp_print.c" 3 4
                          ((void *)0)
# 93 "../crypto/ts/ts_rsp_print.c"
                              )
...
int TS_TST_INFO_print_bio(BIO *bio, TS_TST_INFO *a)
{
    ...
    if (a == 
# 122 "../crypto/ts/ts_rsp_print.c" 3 4
            ((void *)0)
# 122 "../crypto/ts/ts_rsp_print.c"
                )
        return 0;
    ...
    if (a->serial == 
# 134 "../crypto/ts/ts_rsp_print.c" 3 4
                    ((void *)0)
# 134 "../crypto/ts/ts_rsp_print.c"
                        )
        BIO_printf(bio, "unspecified");
    else
    ...
    if (a->accuracy == 
# 145 "../crypto/ts/ts_rsp_print.c" 3 4
                      ((void *)0)
# 145 "../crypto/ts/ts_rsp_print.c"
                          )
        BIO_printf(bio, "unspecified");
    else
    ...
    if (a->nonce == 
# 154 "../crypto/ts/ts_rsp_print.c" 3 4
                   ((void *)0)
# 154 "../crypto/ts/ts_rsp_print.c"
                       )
        BIO_printf(bio, "unspecified");
    else
    ...
    BIO_printf(bio, "TSA: ");
    if (a->tsa == 
# 161 "../crypto/ts/ts_rsp_print.c" 3 4
                 ((void *)0)
# 161 "../crypto/ts/ts_rsp_print.c"
                     )
        BIO_printf(bio, "unspecified");
    else {
        struct stack_st_CONF_VALUE *nval;
        if ((nval = i2v_GENERAL_NAME(
# 165 "../crypto/ts/ts_rsp_print.c" 3 4
                                    ((void *)0)
# 165 "../crypto/ts/ts_rsp_print.c"
                                        , a->tsa, 
# 165 "../crypto/ts/ts_rsp_print.c" 3 4
                                                  ((void *)0)
# 165 "../crypto/ts/ts_rsp_print.c"
...
{
    if (a->seconds != 
# 178 "../crypto/ts/ts_rsp_print.c" 3 4
                     ((void *)0)
# 178 "../crypto/ts/ts_rsp_print.c"
                         )
    ...
    if (a->millis != 
# 183 "../crypto/ts/ts_rsp_print.c" 3 4
                    ((void *)0)
# 183 "../crypto/ts/ts_rsp_print.c"
    ...
    if (a->micros != 
# 188 "../crypto/ts/ts_rsp_print.c" 3 4
                    ((void *)0)
# 188 "../crypto/ts/ts_rsp_print.c"
                        )
