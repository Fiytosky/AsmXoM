# 0 "../crypto/ts/ts_rsp_utils.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_rsp_utils.c"
# 10 "../crypto/ts/ts_rsp_utils.c"
...
# 13 "../crypto/ts/ts_rsp_utils.c" 2
# 1 "../include/openssl/ts.h" 1
# 12 "../include/openssl/ts.h"
        
# 24 "../include/openssl/ts.h"
...
int TS_RESP_set_status_info(TS_RESP *a, TS_STATUS_INFO *status_info)
{
    ...
    if (new_status_info == 
# 24 "../crypto/ts/ts_rsp_utils.c" 3 4
                          ((void *)0)
# 24 "../crypto/ts/ts_rsp_utils.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",25,__func__), ERR_set_error)((47),((47 | (0x2 << 18L))),
# 25 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 25 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_policy_id(TS_TST_INFO *a, ASN1_OBJECT *policy)
{
    ...
    if (new_policy == 
# 75 "../crypto/ts/ts_rsp_utils.c" 3 4
                     ((void *)0)
# 75 "../crypto/ts/ts_rsp_utils.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",76,__func__), ERR_set_error)((47),((8 | (0x2 << 18L))),
# 76 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 76 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_msg_imprint(TS_TST_INFO *a, TS_MSG_IMPRINT *msg_imprint)
{
    ...
    if (new_msg_imprint == 
# 96 "../crypto/ts/ts_rsp_utils.c" 3 4
                          ((void *)0)
# 96 "../crypto/ts/ts_rsp_utils.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",97,__func__), ERR_set_error)((47),((47 | (0x2 << 18L))),
# 97 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 97 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_serial(TS_TST_INFO *a, const ASN1_INTEGER *serial)
{
    ...
    if (new_serial == 
# 117 "../crypto/ts/ts_rsp_utils.c" 3 4
                     ((void *)0)
# 117 "../crypto/ts/ts_rsp_utils.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",118,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 118 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 118 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_time(TS_TST_INFO *a, const ASN1_GENERALIZEDTIME *gtime)
{
    ...
    if (new_time == 
# 138 "../crypto/ts/ts_rsp_utils.c" 3 4
                   ((void *)0)
# 138 "../crypto/ts/ts_rsp_utils.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",139,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 139 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 139 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_accuracy(TS_TST_INFO *a, TS_ACCURACY *accuracy)
{
    ...
    if (new_accuracy == 
# 159 "../crypto/ts/ts_rsp_utils.c" 3 4
                       ((void *)0)
# 159 "../crypto/ts/ts_rsp_utils.c"
                           ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",160,__func__), ERR_set_error)((47),((47 | (0x2 << 18L))),
# 160 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 160 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_ACCURACY_set_seconds(TS_ACCURACY *a, const ASN1_INTEGER *seconds)
{
    ...
    if (new_seconds == 
# 180 "../crypto/ts/ts_rsp_utils.c" 3 4
                      ((void *)0)
# 180 "../crypto/ts/ts_rsp_utils.c"
                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",181,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 181 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 181 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
# 196 "../crypto/ts/ts_rsp_utils.c" 3 4
                              ((void *)0)
# 196 "../crypto/ts/ts_rsp_utils.c"
                                  ;

    if (a->millis == millis)
        return 1;
    if (millis != 
# 200 "../crypto/ts/ts_rsp_utils.c" 3 4
                 ((void *)0)
# 200 "../crypto/ts/ts_rsp_utils.c"
                     ) {
        new_millis = ASN1_INTEGER_dup(millis);
        if (new_millis == 
# 202 "../crypto/ts/ts_rsp_utils.c" 3 4
                         ((void *)0)
# 202 "../crypto/ts/ts_rsp_utils.c"
                             ) {
            (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",203,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 203 "../crypto/ts/ts_rsp_utils.c" 3 4
           ((void *)0)
# 203 "../crypto/ts/ts_rsp_utils.c"
           );
            return 0;
        }
    }
...
# 219 "../crypto/ts/ts_rsp_utils.c" 3 4
                              ((void *)0)
# 219 "../crypto/ts/ts_rsp_utils.c"
                                  ;

    if (a->micros == micros)
        return 1;
    if (micros != 
# 223 "../crypto/ts/ts_rsp_utils.c" 3 4
                 ((void *)0)
# 223 "../crypto/ts/ts_rsp_utils.c"
                     ) {
        new_micros = ASN1_INTEGER_dup(micros);
        if (new_micros == 
# 225 "../crypto/ts/ts_rsp_utils.c" 3 4
                         ((void *)0)
# 225 "../crypto/ts/ts_rsp_utils.c"
                             ) {
            (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",226,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 226 "../crypto/ts/ts_rsp_utils.c" 3 4
           ((void *)0)
# 226 "../crypto/ts/ts_rsp_utils.c"
           );
            return 0;
        }
    }
...
int TS_TST_INFO_set_nonce(TS_TST_INFO *a, const ASN1_INTEGER *nonce)
{
    ...
    if (new_nonce == 
# 258 "../crypto/ts/ts_rsp_utils.c" 3 4
                    ((void *)0)
# 258 "../crypto/ts/ts_rsp_utils.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",259,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 259 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 259 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
int TS_TST_INFO_set_tsa(TS_TST_INFO *a, GENERAL_NAME *tsa)
{
    ...
    if (new_tsa == 
# 279 "../crypto/ts/ts_rsp_utils.c" 3 4
                  ((void *)0)
# 279 "../crypto/ts/ts_rsp_utils.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_utils.c",280,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 280 "../crypto/ts/ts_rsp_utils.c" 3 4
       ((void *)0)
# 280 "../crypto/ts/ts_rsp_utils.c"
       );
        return 0;
    }
...
void TS_TST_INFO_ext_free(TS_TST_INFO *a)
{
    if (!a)
        return;
    OPENSSL_sk_pop_free(ossl_check_X509_EXTENSION_sk_type(a->extensions),ossl_check_X509_EXTENSION_freefunc_type(X509_EXTENSION_free));
    a->extensions = 
# 303 "../crypto/ts/ts_rsp_utils.c" 3 4
                   ((void *)0)
# 303 "../crypto/ts/ts_rsp_utils.c"
                       ;
}
...
# 338 "../crypto/ts/ts_rsp_utils.c" 3 4
                                                     ((void *)0)
# 338 "../crypto/ts/ts_rsp_utils.c"
                                                         ;
}
