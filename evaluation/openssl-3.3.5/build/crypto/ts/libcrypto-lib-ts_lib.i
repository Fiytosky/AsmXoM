# 0 "../crypto/ts/ts_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_lib.c"
# 10 "../crypto/ts/ts_lib.c"
...
int TS_ASN1_INTEGER_print_bio(BIO *bio, const ASN1_INTEGER *num)
{
    ...
    num_bn = ASN1_INTEGER_to_BN(num, 
# 25 "../crypto/ts/ts_lib.c" 3 4
                                    ((void *)0)
# 25 "../crypto/ts/ts_lib.c"
                                        );
    if (num_bn == 
# 26 "../crypto/ts/ts_lib.c" 3 4
                 ((void *)0)
# 26 "../crypto/ts/ts_lib.c"
                     )
        return -1;
    if ((hex = BN_bn2hex(num_bn))) {
        result = BIO_write(bio, "0x", 2) > 0;
        result = result && BIO_write(bio, hex, strlen(hex)) > 0;
        CRYPTO_free(hex, "../crypto/ts/ts_lib.c", 31);
    }
    BN_free(num_bn);
