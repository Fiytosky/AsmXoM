# 0 "../crypto/ts/ts_conf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_conf.c"
# 13 "../crypto/ts/ts_conf.c"
...
int TS_CONF_set_ess_cert_id_digest(CONF *conf, const char *section,
                                      TS_RESP_CTX *ctx);
# 20 "../crypto/ts/ts_conf.c" 2
# 1 "../include/openssl/conf_api.h" 1
# 12 "../include/openssl/conf_api.h"
        
# 27 "../include/openssl/conf_api.h"
...
# 21 "../crypto/ts/ts_conf.c" 2
# 48 "../crypto/ts/ts_conf.c"
X509 *TS_CONF_load_cert(const char *file)
{
    BIO *cert = 
# 50 "../crypto/ts/ts_conf.c" 3 4
               ((void *)0)
# 50 "../crypto/ts/ts_conf.c"
                   ;
    X509 *x = 
# 51 "../crypto/ts/ts_conf.c" 3 4
             ((void *)0)
# 51 "../crypto/ts/ts_conf.c"
                 ;

    if ((cert = BIO_new_file(file, "r")) == 
# 53 "../crypto/ts/ts_conf.c" 3 4
                                           ((void *)0)
# 53 "../crypto/ts/ts_conf.c"
                                               )
        goto end;
    x = PEM_read_bio_X509_AUX(cert, 
# 55 "../crypto/ts/ts_conf.c" 3 4
                                   ((void *)0)
# 55 "../crypto/ts/ts_conf.c"
                                       , 
# 55 "../crypto/ts/ts_conf.c" 3 4
                                         ((void *)0)
# 55 "../crypto/ts/ts_conf.c"
...
# 55 "../crypto/ts/ts_conf.c"
    ...
    if (x == 
# 57 "../crypto/ts/ts_conf.c" 3 4
            ((void *)0)
# 57 "../crypto/ts/ts_conf.c"
                )
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",58,__func__), ERR_set_error)((47),(137),
# 58 "../crypto/ts/ts_conf.c" 3 4
       ((void *)0)
# 58 "../crypto/ts/ts_conf.c"
       );
    BIO_free(cert);
    return x;
}
...
{
    BIO *certs = 
# 65 "../crypto/ts/ts_conf.c" 3 4
                ((void *)0)
# 65 "../crypto/ts/ts_conf.c"
                    ;
    struct stack_st_X509 *othercerts = 
# 66 "../crypto/ts/ts_conf.c" 3 4
                                ((void *)0)
# 66 "../crypto/ts/ts_conf.c"
                                    ;
    struct stack_st_X509_INFO *allcerts = 
# 67 "../crypto/ts/ts_conf.c" 3 4
                                   ((void *)0)
# 67 "../crypto/ts/ts_conf.c"
                                       ;
    int i;

    if ((certs = BIO_new_file(file, "r")) == 
# 70 "../crypto/ts/ts_conf.c" 3 4
                                            ((void *)0)
# 70 "../crypto/ts/ts_conf.c"
                                                )
        goto end;
    if ((othercerts = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 72 "../crypto/ts/ts_conf.c" 3 4
                                            ((void *)0)
# 72 "../crypto/ts/ts_conf.c"
                                                )
        goto end;

    allcerts = PEM_X509_INFO_read_bio(certs, 
# 75 "../crypto/ts/ts_conf.c" 3 4
                                            ((void *)0)
# 75 "../crypto/ts/ts_conf.c"
                                                , 
# 75 "../crypto/ts/ts_conf.c" 3 4
                                                  ((void *)0)
# 75 "../crypto/ts/ts_conf.c"
...
# 75 "../crypto/ts/ts_conf.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_INFO_sk_type(allcerts)); i++) {
        X509_INFO *xi = ((X509_INFO *)OPENSSL_sk_value(ossl_check_const_X509_INFO_sk_type(allcerts), (i)));

        if (xi->x509 != 
# 79 "../crypto/ts/ts_conf.c" 3 4
                       ((void *)0)
# 79 "../crypto/ts/ts_conf.c"
                           ) {
            if (!X509_add_cert(othercerts, xi->x509, 0)) {
                OSSL_STACK_OF_X509_free(othercerts);
                othercerts = 
# 82 "../crypto/ts/ts_conf.c" 3 4
                            ((void *)0)
# 82 "../crypto/ts/ts_conf.c"
                                ;
                goto end;
            }
            xi->x509 = 
# 85 "../crypto/ts/ts_conf.c" 3 4
                      ((void *)0)
# 85 "../crypto/ts/ts_conf.c"
                          ;
        }
    }
 end:
    if (othercerts == 
# 89 "../crypto/ts/ts_conf.c" 3 4
                     ((void *)0)
# 89 "../crypto/ts/ts_conf.c"
                         )
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",90,__func__), ERR_set_error)((47),(137),
# 90 "../crypto/ts/ts_conf.c" 3 4
       ((void *)0)
# 90 "../crypto/ts/ts_conf.c"
       );
    OPENSSL_sk_pop_free(ossl_check_X509_INFO_sk_type(allcerts),ossl_check_X509_INFO_freefunc_type(X509_INFO_free));
    BIO_free(certs);
    return othercerts;
}
...
{
    BIO *key = 
# 98 "../crypto/ts/ts_conf.c" 3 4
              ((void *)0)
# 98 "../crypto/ts/ts_conf.c"
                  ;
    EVP_PKEY *pkey = 
# 99 "../crypto/ts/ts_conf.c" 3 4
                    ((void *)0)
# 99 "../crypto/ts/ts_conf.c"
                        ;

    if ((key = BIO_new_file(file, "r")) == 
# 101 "../crypto/ts/ts_conf.c" 3 4
                                          ((void *)0)
# 101 "../crypto/ts/ts_conf.c"
                                              )
        goto end;
    pkey = PEM_read_bio_PrivateKey(key, 
# 103 "../crypto/ts/ts_conf.c" 3 4
                                       ((void *)0)
# 103 "../crypto/ts/ts_conf.c"
                                           , 
# 103 "../crypto/ts/ts_conf.c" 3 4
                                             ((void *)0)
# 103 "../crypto/ts/ts_conf.c"
    ...
    if (pkey == 
# 105 "../crypto/ts/ts_conf.c" 3 4
               ((void *)0)
# 105 "../crypto/ts/ts_conf.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",106,__func__), ERR_set_error)((47),(138),
# 106 "../crypto/ts/ts_conf.c" 3 4
       ((void *)0)
# 106 "../crypto/ts/ts_conf.c"
       );
    BIO_free(key);
    return pkey;
}
...
{
    (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",115,__func__), ERR_set_error)(47, 136, "%s::%s", name, tag);
}

static void ts_CONF_invalid(const char *name, const char *tag)
{
    (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",120,__func__), ERR_set_error)(47, 135, "%s::%s", name, tag);
}
                              ...
                              const char *device)
{
    ...
    if (device == 
# 156 "../crypto/ts/ts_conf.c" 3 4
                 ((void *)0)
# 156 "../crypto/ts/ts_conf.c"
                     )
...
{
    ENGINE *e = 
# 170 "../crypto/ts/ts_conf.c" 3 4
               ((void *)0)
# 170 "../crypto/ts/ts_conf.c"
                   ;
    int ret = 0;
...
# 176 "../crypto/ts/ts_conf.c" 3 4
                                   ((void *)0)
# 176 "../crypto/ts/ts_conf.c"
                                       )
        goto err;
 ...
 err:
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_conf.c",186,__func__), ERR_set_error)(47, 127,
                       "engine:%s", name);
    ENGINE_free(e);
    return ret;
}
                            ...
                            const char *cert, TS_RESP_CTX *ctx)
{
    int ret = 0;
    X509 *cert_obj = 
# 198 "../crypto/ts/ts_conf.c" 3 4
                    ((void *)0)
# 198 "../crypto/ts/ts_conf.c"
                        ;

    if (cert == 
# 200 "../crypto/ts/ts_conf.c" 3 4
               ((void *)0)
# 200 "../crypto/ts/ts_conf.c"
                   ) {
        cert = NCONF_get_string(conf, section, "signer_cert");
        if (cert == 
# 202 "../crypto/ts/ts_conf.c" 3 4
                   ((void *)0)
# 202 "../crypto/ts/ts_conf.c"
                       ) {
...
# 207 "../crypto/ts/ts_conf.c" 3 4
                                               ((void *)0)
# 207 "../crypto/ts/ts_conf.c"
                                                   )
        goto err;
...
# 222 "../crypto/ts/ts_conf.c" 3 4
                               ((void *)0)
# 222 "../crypto/ts/ts_conf.c"
                                   ;

    if (certs == 
# 224 "../crypto/ts/ts_conf.c" 3 4
                ((void *)0)
# 224 "../crypto/ts/ts_conf.c"
                    ) {

        if ((certs = NCONF_get_string(conf, section, "certs")) == 
# 226 "../crypto/ts/ts_conf.c" 3 4
                                                                   ((void *)0)
# 226 "../crypto/ts/ts_conf.c"
                                                                       )
            goto end;
    }
    if ((certs_obj = TS_CONF_load_certs(certs)) == 
# 229 "../crypto/ts/ts_conf.c" 3 4
                                                  ((void *)0)
# 229 "../crypto/ts/ts_conf.c"
                                                      )
        goto err;
                           ...
                           TS_RESP_CTX *ctx)
{
    int ret = 0;
    EVP_PKEY *key_obj = 
# 245 "../crypto/ts/ts_conf.c" 3 4
                       ((void *)0)
# 245 "../crypto/ts/ts_conf.c"
                           ;
    if (!key)
...
# 252 "../crypto/ts/ts_conf.c" 3 4
                                                  ((void *)0)
# 252 "../crypto/ts/ts_conf.c"
                                                      )
        goto err;
...
# 267 "../crypto/ts/ts_conf.c" 3 4
                           ((void *)0)
# 267 "../crypto/ts/ts_conf.c"
                               ;
    if (md == 
# 268 "../crypto/ts/ts_conf.c" 3 4
             ((void *)0)
# 268 "../crypto/ts/ts_conf.c"
                 )
        md = NCONF_get_string(conf, section, "signer_digest");
    if (md == 
# 270 "../crypto/ts/ts_conf.c" 3 4
             ((void *)0)
# 270 "../crypto/ts/ts_conf.c"
                 ) {
        ts_CONF_lookup_fail(section, "signer_digest");
        goto err;
    }
    sign_md = EVP_get_digestbyname(md);
    if (sign_md == 
# 275 "../crypto/ts/ts_conf.c" 3 4
                  ((void *)0)
# 275 "../crypto/ts/ts_conf.c"
                      ) {
        ts_CONF_invalid(section, "signer_digest");
        goto err;
    }
...
# 291 "../crypto/ts/ts_conf.c" 3 4
                             ((void *)0)
# 291 "../crypto/ts/ts_conf.c"
                                 ;

    if (policy == 
# 293 "../crypto/ts/ts_conf.c" 3 4
                 ((void *)0)
# 293 "../crypto/ts/ts_conf.c"
                     )
        policy = NCONF_get_string(conf, section, "default_policy");
    if (policy == 
# 295 "../crypto/ts/ts_conf.c" 3 4
                 ((void *)0)
# 295 "../crypto/ts/ts_conf.c"
                     ) {
        ts_CONF_lookup_fail(section, "default_policy");
        goto err;
    }
    if ((policy_obj = OBJ_txt2obj(policy, 0)) == 
# 299 "../crypto/ts/ts_conf.c" 3 4
                                                ((void *)0)
# 299 "../crypto/ts/ts_conf.c"
                                                    ) {
...
# 316 "../crypto/ts/ts_conf.c" 3 4
                                ((void *)0)
# 316 "../crypto/ts/ts_conf.c"
                                    ;
    char *policies = NCONF_get_string(conf, section, "other_policies");


    if (policies && (list = X509V3_parse_list(policies)) == 
# 320 "../crypto/ts/ts_conf.c" 3 4
                                                           ((void *)0)
# 320 "../crypto/ts/ts_conf.c"
                                                               ) {
        ts_CONF_invalid(section, "other_policies");
        goto err;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(list)); ++i) {
        CONF_VALUE *val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(list), (i)));
        const char *extval = val->value ? val->value : val->name;
        ASN1_OBJECT *objtmp;

        if ((objtmp = OBJ_txt2obj(extval, 0)) == 
# 329 "../crypto/ts/ts_conf.c" 3 4
                                                ((void *)0)
# 329 "../crypto/ts/ts_conf.c"
                                                    ) {
            ts_CONF_invalid(section, "other_policies");
            goto err;
        }
    ...
    ret = 1;
 err:
    OPENSSL_sk_pop_free(ossl_check_CONF_VALUE_sk_type(list),ossl_check_CONF_VALUE_freefunc_type(X509V3_conf_free));
    return ret;
}
...
int TS_CONF_set_digests(CONF *conf, const char *section, TS_RESP_CTX *ctx)
{
    ...
    int i;
    struct stack_st_CONF_VALUE *list = 
# 348 "../crypto/ts/ts_conf.c" 3 4
                                ((void *)0)
# 348 "../crypto/ts/ts_conf.c"
                                    ;
    char *digests = NCONF_get_string(conf, section, "digests");

    if (digests == 
# 351 "../crypto/ts/ts_conf.c" 3 4
                  ((void *)0)
# 351 "../crypto/ts/ts_conf.c"
                      ) {
        ts_CONF_lookup_fail(section, "digests");
        goto err;
    }
    if ((list = X509V3_parse_list(digests)) == 
# 355 "../crypto/ts/ts_conf.c" 3 4
                                              ((void *)0)
# 355 "../crypto/ts/ts_conf.c"
                                                  ) {
        ts_CONF_invalid(section, "digests");
        goto err;
    }
    if (OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(list)) == 0) {
        ts_CONF_invalid(section, "digests");
        goto err;
    }
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(list)); ++i) {
...
# 368 "../crypto/ts/ts_conf.c" 3 4
                                                  ((void *)0)
# 368 "../crypto/ts/ts_conf.c"
                                                      ) {
            ts_CONF_invalid(section, "digests");
            goto err;
        }
...
int TS_CONF_set_accuracy(CONF *conf, const char *section, TS_RESP_CTX *ctx)
{
    ...
    struct stack_st_CONF_VALUE *list = 
# 387 "../crypto/ts/ts_conf.c" 3 4
                                ((void *)0)
# 387 "../crypto/ts/ts_conf.c"
                                    ;
    char *accuracy = NCONF_get_string(conf, section, "accuracy");

    if (accuracy && (list = X509V3_parse_list(accuracy)) == 
# 390 "../crypto/ts/ts_conf.c" 3 4
                                                           ((void *)0)
# 390 "../crypto/ts/ts_conf.c"
                                                               ) {
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(list)); ++i) {
        CONF_VALUE *val = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(list), (i)));
        if (strcmp(val->name, "secs") == 0) {
            if (val->value)
                secs = atoi(val->value);
        } else if (strcmp(val->name, "millisecs") == 0) {
            if (val->value)
                millis = atoi(val->value);
        } else if (strcmp(val->name, "microsecs") == 0) {
            if (val->value)
                                       ...
                                       TS_RESP_CTX *ctx)
{
    ...
    digits = _CONF_get_number(conf, section, "clock_precision_digits");
...
{
    int ret = 0;
    const EVP_MD *cert_md = 
# 480 "../crypto/ts/ts_conf.c" 3 4
                           ((void *)0)
# 480 "../crypto/ts/ts_conf.c"
                               ;
    const char *md = NCONF_get_string(conf, section, "ess_cert_id_alg");

    if (md == 
# 483 "../crypto/ts/ts_conf.c" 3 4
             ((void *)0)
# 483 "../crypto/ts/ts_conf.c"
                 )
        md = "sha256";

    cert_md = EVP_get_digestbyname(md);
    if (cert_md == 
# 487 "../crypto/ts/ts_conf.c" 3 4
                  ((void *)0)
# 487 "../crypto/ts/ts_conf.c"
                      ) {
        ts_CONF_invalid(section, "ess_cert_id_alg");
        goto err;
    }
