# 0 "../crypto/ts/ts_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_err.c"
# 11 "../crypto/ts/ts_err.c"
...
static const ERR_STRING_DATA TS_str_reasons[] = {
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ), "bad pkcs7 type"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ), "bad type"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ), "cannot load certificate"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ), "cannot load private key"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "certificate verify error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "could not set engine"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "could not set time"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ), "detached content"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "ess add signing cert error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ),
    "ess add signing cert v2 error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "ess signing certificate error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "invalid null pointer"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "invalid signer certificate purpose"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "message imprint mismatch"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "nonce mismatch"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "nonce not returned"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "no content"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "no time stamp token"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "pkcs7 add signature error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "pkcs7 add signed attr error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "pkcs7 to ts tst info failed"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "policy mismatch"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "private key does not match certificate"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "response setup error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "signature failure"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "there must be one signer"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ), "time syscall error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "token not present"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ), "token present"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "tsa name mismatch"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "tsa untrusted"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "tst info setup error"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ), "ts datasign"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "unacceptable policy"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "unsupported md algorithm"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "unsupported version"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ), "var bad value"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "cannot find config variable"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "wrong content type"},
    {0, 
# 76 "../crypto/ts/ts_err.c" 3 4
       ((void *)0)
# 76 "../crypto/ts/ts_err.c"
           }
};
...
int ossl_err_load_TS_strings(void)
{
    ...
    if (ERR_reason_error_string(TS_str_reasons[0].error) == 
# 84 "../crypto/ts/ts_err.c" 3 4
                                                           ((void *)0)
# 84 "../crypto/ts/ts_err.c"
                                                               )
