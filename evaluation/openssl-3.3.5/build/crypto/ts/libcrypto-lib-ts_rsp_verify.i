# 0 "../crypto/ts/ts_rsp_verify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_rsp_verify.c"
# 10 "../crypto/ts/ts_rsp_verify.c"
...
# 11 "../crypto/ts/ts_rsp_verify.c" 2
...
# 12 "../crypto/ts/ts_rsp_verify.c" 2
...
int TS_CONF_set_ess_cert_id_digest(CONF *conf, const char *section,
                                      TS_RESP_CTX *ctx);
# 13 "../crypto/ts/ts_rsp_verify.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 15 "../crypto/ts/ts_rsp_verify.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 16 "../crypto/ts/ts_rsp_verify.c" 2
...
# 17 "../crypto/ts/ts_rsp_verify.c" 2
...
# 18 "../crypto/ts/ts_rsp_verify.c" 2
...
static int ts_find_name(struct stack_st_GENERAL_NAME *gen_names,
                        GENERAL_NAME *name);
# 50 "../crypto/ts/ts_rsp_verify.c"
...
# 88 "../crypto/ts/ts_rsp_verify.c"
int TS_RESP_verify_signature(PKCS7 *token, struct stack_st_X509 *certs,
                             X509_STORE *store, X509 **signer_out)
{
    struct stack_st_PKCS7_SIGNER_INFO *sinfos = 
# 91 "../crypto/ts/ts_rsp_verify.c" 3 4
                                         ((void *)0)
# 91 "../crypto/ts/ts_rsp_verify.c"
                                             ;
    PKCS7_SIGNER_INFO *si;
    struct stack_st_X509 *untrusted = 
# 93 "../crypto/ts/ts_rsp_verify.c" 3 4
                               ((void *)0)
# 93 "../crypto/ts/ts_rsp_verify.c"
                                   ;
    struct stack_st_X509 *signers = 
# 94 "../crypto/ts/ts_rsp_verify.c" 3 4
                             ((void *)0)
# 94 "../crypto/ts/ts_rsp_verify.c"
                                 ;
    X509 *signer;
    struct stack_st_X509 *chain = 
# 96 "../crypto/ts/ts_rsp_verify.c" 3 4
                           ((void *)0)
# 96 "../crypto/ts/ts_rsp_verify.c"
                               ;
    char buf[4096];
    int i, j = 0, ret = 0;
    BIO *p7bio = 
# 99 "../crypto/ts/ts_rsp_verify.c" 3 4
                ((void *)0)
# 99 "../crypto/ts/ts_rsp_verify.c"
                    ;


    if (!token) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",103,__func__), ERR_set_error)((47),(102),
# 103 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 103 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    if (!(OBJ_obj2nid((token)->type) == 22)) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",107,__func__), ERR_set_error)((47),(114),
# 107 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 107 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    sinfos = PKCS7_get_signer_info(token);
    if (!sinfos || OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)) != 1) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",112,__func__), ERR_set_error)((47),(110),
# 112 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 112 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    si = ((PKCS7_SIGNER_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos), (0)));
    if (PKCS7_ctrl(token,2,0,
# 116 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 116 "../crypto/ts/ts_rsp_verify.c"
       )) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",117,__func__), ERR_set_error)((47),(106),
# 117 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 117 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    ...
    if (!signers || OPENSSL_sk_num(ossl_check_const_X509_sk_type(signers)) != 1)
        goto err;
    signer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(signers), (0)));

    untrusted = ((struct stack_st_X509 *)OPENSSL_sk_new_reserve(ossl_check_X509_compfunc_type(
# 130 "../crypto/ts/ts_rsp_verify.c" 3 4
               ((void *)0)
# 130 "../crypto/ts/ts_rsp_verify.c"
               ), (OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)) + OPENSSL_sk_num(ossl_check_const_X509_sk_type(token->d.sign->cert)))))
                                                                       ;
    if (untrusted == 
# 132 "../crypto/ts/ts_rsp_verify.c" 3 4
                    ((void *)0)
            
# 133 "../crypto/ts/ts_rsp_verify.c"
...
# 140 "../crypto/ts/ts_rsp_verify.c" 3 4
                                 ((void *)0)
# 140 "../crypto/ts/ts_rsp_verify.c"
                                     );
    ...
    if (j <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",148,__func__), ERR_set_error)((47),(109),
# 148 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 148 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
 ...
 err:
    BIO_free_all(p7bio);
    OPENSSL_sk_free(ossl_check_X509_sk_type(untrusted));
...
# 174 "../crypto/ts/ts_rsp_verify.c" 3 4
                              ((void *)0)
# 174 "../crypto/ts/ts_rsp_verify.c"
                                  ;
    int i;
    int ret = 0;

    *chain = 
# 178 "../crypto/ts/ts_rsp_verify.c" 3 4
            ((void *)0)
# 178 "../crypto/ts/ts_rsp_verify.c"
                ;
    cert_ctx = X509_STORE_CTX_new();
    if (cert_ctx == 
# 180 "../crypto/ts/ts_rsp_verify.c" 3 4
                   ((void *)0)
# 180 "../crypto/ts/ts_rsp_verify.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",181,__func__), ERR_set_error)((47),((11 | (0x2 << 18L))),
# 181 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 181 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    ...
    if (i <= 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",190,__func__), ERR_set_error)(47, 100,
...
static ESS_SIGNING_CERT *ossl_ess_get_signing_cert(const PKCS7_SIGNER_INFO *si)
{
    ...
    attr = PKCS7_get_signed_attribute(si, 223);
    if (attr == 
# 212 "../crypto/ts/ts_rsp_verify.c" 3 4
               ((void *)0)
# 212 "../crypto/ts/ts_rsp_verify.c"
                   )
        return 
# 213 "../crypto/ts/ts_rsp_verify.c" 3 4
              ((void *)0)
# 213 "../crypto/ts/ts_rsp_verify.c"
                  ;
    p = attr->value.sequence->data;
    return d2i_ESS_SIGNING_CERT(
# 215 "../crypto/ts/ts_rsp_verify.c" 3 4
                               ((void *)0)
# 215 "../crypto/ts/ts_rsp_verify.c"
...
ESS_SIGNING_CERT_V2 *ossl_ess_get_signing_cert_v2(const PKCS7_SIGNER_INFO *si)
{
    ...
    attr = PKCS7_get_signed_attribute(si, 1086);
    if (attr == 
# 225 "../crypto/ts/ts_rsp_verify.c" 3 4
               ((void *)0)
# 225 "../crypto/ts/ts_rsp_verify.c"
                   )
        return 
# 226 "../crypto/ts/ts_rsp_verify.c" 3 4
              ((void *)0)
# 226 "../crypto/ts/ts_rsp_verify.c"
                  ;
    p = attr->value.sequence->data;
    return d2i_ESS_SIGNING_CERT_V2(
# 228 "../crypto/ts/ts_rsp_verify.c" 3 4
                                  ((void *)0)
# 228 "../crypto/ts/ts_rsp_verify.c"
                                      , &p, attr->value.sequence->length);
}
...
# 292 "../crypto/ts/ts_rsp_verify.c"
static int int_ts_RESP_verify_token(TS_VERIFY_CTX *ctx,
                                    PKCS7 *token, TS_TST_INFO *tst_info)
{
    X509 *signer = 
# 295 "../crypto/ts/ts_rsp_verify.c" 3 4
                  ((void *)0)
# 295 "../crypto/ts/ts_rsp_verify.c"
                      ;
    GENERAL_NAME *tsa_name = tst_info->tsa;
    X509_ALGOR *md_alg = 
# 297 "../crypto/ts/ts_rsp_verify.c" 3 4
                        ((void *)0)
# 297 "../crypto/ts/ts_rsp_verify.c"
                            ;
    unsigned char *imprint = 
# 298 "../crypto/ts/ts_rsp_verify.c" 3 4
                            ((void *)0)
# 298 "../crypto/ts/ts_rsp_verify.c"
                                ;
    ...
    if (((flags & (1u << 6)) && tsa_name != 
# 304 "../crypto/ts/ts_rsp_verify.c" 3 4
                                               ((void *)0)
# 304 "../crypto/ts/ts_rsp_verify.c"
                                                   )
            || (flags & (1u << 7))) {
        flags |= (1u << 0);
    }
    ...
    if ((flags & (1u << 1))
        ...
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",314,__func__), ERR_set_error)((47),(113),
# 314 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 314 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    if ((flags & (1u << 2))
    ...
    if ((flags & (1u << 6))
        ...
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",334,__func__), ERR_set_error)((47),(111),
# 334 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 334 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    if ((flags & (1u << 7))
        && !ts_check_signer_name(ctx->tsa_name, signer)) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",339,__func__), ERR_set_error)((47),(112),
# 339 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 339 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    ret = 1;
 ...
 err:
    ...
    CRYPTO_free(imprint, "../crypto/ts/ts_rsp_verify.c", 347);
    return ret;
}
...
# 355 "../crypto/ts/ts_rsp_verify.c" 3 4
                             ((void *)0)
# 355 "../crypto/ts/ts_rsp_verify.c"
                                 ;
    char *embedded_status_text = 
# 356 "../crypto/ts/ts_rsp_verify.c" 3 4
                                ((void *)0)
# 356 "../crypto/ts/ts_rsp_verify.c"
                                    ;
    ...
    if (0 <= status && status < (long) (sizeof(ts_status_text)/sizeof((ts_status_text)[0])))
        status_text = ts_status_text[status];
    else
        status_text = "unknown code";

    if (OPENSSL_sk_num(ossl_check_const_ASN1_UTF8STRING_sk_type(info->text)) > 0
        && (embedded_status_text = ts_get_status_text(info->text)) == 
# 369 "../crypto/ts/ts_rsp_verify.c" 3 4
                                                                     ((void *)0)
# 369 "../crypto/ts/ts_rsp_verify.c"
                                                                         )
        return 0;
    ...
    if (info->failure_info) {
        int i;
        int first = 1;
        for (i = 0; i < (int)(sizeof(ts_failure_info)/sizeof((ts_failure_info)[0])); ++i) {
    ...
    (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",390,__func__), ERR_set_error)(47, 107,
                   "status code: %s, status text: %s, failure codes: %s",
                   status_text,
                   embedded_status_text ? embedded_status_text : "unspecified",
                   failure_text);
    CRYPTO_free(embedded_status_text, "../crypto/ts/ts_rsp_verify.c", 395);
...
static char *ts_get_status_text(struct stack_st_ASN1_UTF8STRING *text)
{
    return ossl_sk_ASN1_UTF8STRING2text(text, "/", (1024 * 1024));
}
                           ...
                           const TS_TST_INFO *tst_info)
{
    ...
    if (OBJ_cmp(req_oid, resp_oid) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",411,__func__), ERR_set_error)((47),(108),
# 411 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 411 "../crypto/ts/ts_rsp_verify.c"
       );
        return 0;
    }
                              ...
                              unsigned char **imprint, unsigned *imprint_len)
{
    ...
    EVP_MD *md = 
# 424 "../crypto/ts/ts_rsp_verify.c" 3 4
                ((void *)0)
# 424 "../crypto/ts/ts_rsp_verify.c"
                    ;
    EVP_MD_CTX *md_ctx = 
# 425 "../crypto/ts/ts_rsp_verify.c" 3 4
                        ((void *)0)
# 425 "../crypto/ts/ts_rsp_verify.c"
                            ;
    ...
    *md_alg = 
# 430 "../crypto/ts/ts_rsp_verify.c" 3 4
             ((void *)0)
# 430 "../crypto/ts/ts_rsp_verify.c"
                 ;
    *imprint = 
# 431 "../crypto/ts/ts_rsp_verify.c" 3 4
              ((void *)0)
# 431 "../crypto/ts/ts_rsp_verify.c"
                  ;

    if ((*md_alg = X509_ALGOR_dup(md_alg_resp)) == 
# 433 "../crypto/ts/ts_rsp_verify.c" 3 4
                                                  ((void *)0)
# 433 "../crypto/ts/ts_rsp_verify.c"
                                                      )
        goto err;
    ...
    (void)ERR_set_mark();
    md = EVP_MD_fetch(
# 439 "../crypto/ts/ts_rsp_verify.c" 3 4
                     ((void *)0)
# 439 "../crypto/ts/ts_rsp_verify.c"
                         , name, 
# 439 "../crypto/ts/ts_rsp_verify.c" 3 4
                                 ((void *)0)
# 439 "../crypto/ts/ts_rsp_verify.c"
    ...
    if (md == 
# 441 "../crypto/ts/ts_rsp_verify.c" 3 4
             ((void *)0)
# 441 "../crypto/ts/ts_rsp_verify.c"
                 )
        md = (EVP_MD *)EVP_get_digestbyname(name);

    if (md == 
# 444 "../crypto/ts/ts_rsp_verify.c" 3 4
             ((void *)0)
# 444 "../crypto/ts/ts_rsp_verify.c"
                 ) {
    ...
    if (length < 0)
        goto err;
    *imprint_len = length;
    if ((*imprint = CRYPTO_malloc(*imprint_len, "../crypto/ts/ts_rsp_verify.c", 454)) == 
# 454 "../crypto/ts/ts_rsp_verify.c" 3 4
                                                    ((void *)0)
# 454 "../crypto/ts/ts_rsp_verify.c"
                                                        )
        goto err;

    md_ctx = EVP_MD_CTX_new();
    if (md_ctx == 
# 458 "../crypto/ts/ts_rsp_verify.c" 3 4
                 ((void *)0)
# 458 "../crypto/ts/ts_rsp_verify.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",459,__func__), ERR_set_error)((47),((6 | (0x2 << 18L))),
# 459 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 459 "../crypto/ts/ts_rsp_verify.c"
       );
        goto err;
    }
    ...
    EVP_MD_free(md);
    md = 
# 465 "../crypto/ts/ts_rsp_verify.c" 3 4
        ((void *)0)
# 465 "../crypto/ts/ts_rsp_verify.c"
            ;
...
# 470 "../crypto/ts/ts_rsp_verify.c" 3 4
                                          ((void *)0)
# 470 "../crypto/ts/ts_rsp_verify.c"
                                              ))
        goto err;
 ...
 err:
    ...
    X509_ALGOR_free(*md_alg);
    *md_alg = 
# 479 "../crypto/ts/ts_rsp_verify.c" 3 4
             ((void *)0)
# 479 "../crypto/ts/ts_rsp_verify.c"
                 ;
    CRYPTO_free(*imprint, "../crypto/ts/ts_rsp_verify.c", 480);
    *imprint_len = 0;
    *imprint = 0;
    return 0;
}
                             ...
                             TS_TST_INFO *tst_info)
{
 ...
 err:
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",510,__func__), ERR_set_error)((47),(103),
# 510 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 510 "../crypto/ts/ts_rsp_verify.c"
       );
    return ret;
}
...
static int ts_check_nonces(const ASN1_INTEGER *a, TS_TST_INFO *tst_info)
{
    ...
    if (!b) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",519,__func__), ERR_set_error)((47),(105),
# 519 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 519 "../crypto/ts/ts_rsp_verify.c"
       );
        return 0;
    }
    ...
    if (ASN1_INTEGER_cmp(a, b) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_rsp_verify.c",525,__func__), ERR_set_error)((47),(104),
# 525 "../crypto/ts/ts_rsp_verify.c" 3 4
       ((void *)0)
# 525 "../crypto/ts/ts_rsp_verify.c"
       );
        return 0;
    }
...
# 538 "../crypto/ts/ts_rsp_verify.c" 3 4
                                       ((void *)0)
# 538 "../crypto/ts/ts_rsp_verify.c"
                                           ;
    int idx = -1;
    int found = 0;
...
# 545 "../crypto/ts/ts_rsp_verify.c" 3 4
                                                              ((void *)0)
# 545 "../crypto/ts/ts_rsp_verify.c"
                                                                  , &idx);
    while (gen_names != 
# 546 "../crypto/ts/ts_rsp_verify.c" 3 4
                       ((void *)0)
# 546 "../crypto/ts/ts_rsp_verify.c"
                           ) {
        ...
        gen_names = X509_get_ext_d2i(signer, 85, 
# 555 "../crypto/ts/ts_rsp_verify.c" 3 4
                                                                  ((void *)0)
# 555 "../crypto/ts/ts_rsp_verify.c"
                                                                      , &idx);
    }
    GENERAL_NAMES_free(gen_names);
...
{
    int i, found;
    for (i = 0, found = 0; !found && i < OPENSSL_sk_num(ossl_check_const_GENERAL_NAME_sk_type(gen_names)); ++i) {
        GENERAL_NAME *current = ((GENERAL_NAME *)OPENSSL_sk_value(ossl_check_const_GENERAL_NAME_sk_type(gen_names), (i)));
