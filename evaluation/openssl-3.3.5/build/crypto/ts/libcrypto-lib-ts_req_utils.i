# 0 "../crypto/ts/ts_req_utils.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ts/ts_req_utils.c"
# 10 "../crypto/ts/ts_req_utils.c"
...
int TS_REQ_set_msg_imprint(TS_REQ *a, TS_MSG_IMPRINT *msg_imprint)
{
    ...
    if (new_msg_imprint == 
# 34 "../crypto/ts/ts_req_utils.c" 3 4
                          ((void *)0)
# 34 "../crypto/ts/ts_req_utils.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_req_utils.c",35,__func__), ERR_set_error)((47),((47 | (0x2 << 18L))),
# 35 "../crypto/ts/ts_req_utils.c" 3 4
       ((void *)0)
# 35 "../crypto/ts/ts_req_utils.c"
       );
        return 0;
    }
...
int TS_MSG_IMPRINT_set_algo(TS_MSG_IMPRINT *a, X509_ALGOR *alg)
{
    ...
    if (new_alg == 
# 55 "../crypto/ts/ts_req_utils.c" 3 4
                  ((void *)0)
# 55 "../crypto/ts/ts_req_utils.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_req_utils.c",56,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 56 "../crypto/ts/ts_req_utils.c" 3 4
       ((void *)0)
# 56 "../crypto/ts/ts_req_utils.c"
       );
        return 0;
    }
...
int TS_REQ_set_policy_id(TS_REQ *a, const ASN1_OBJECT *policy)
{
    ...
    if (new_policy == 
# 86 "../crypto/ts/ts_req_utils.c" 3 4
                     ((void *)0)
# 86 "../crypto/ts/ts_req_utils.c"
                         ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_req_utils.c",87,__func__), ERR_set_error)((47),((8 | (0x2 << 18L))),
# 87 "../crypto/ts/ts_req_utils.c" 3 4
       ((void *)0)
# 87 "../crypto/ts/ts_req_utils.c"
       );
        return 0;
    }
...
int TS_REQ_set_nonce(TS_REQ *a, const ASN1_INTEGER *nonce)
{
    ...
    if (new_nonce == 
# 107 "../crypto/ts/ts_req_utils.c" 3 4
                    ((void *)0)
# 107 "../crypto/ts/ts_req_utils.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/ts/ts_req_utils.c",108,__func__), ERR_set_error)((47),((13 | (0x2 << 18L))),
# 108 "../crypto/ts/ts_req_utils.c" 3 4
       ((void *)0)
# 108 "../crypto/ts/ts_req_utils.c"
       );
        return 0;
    }
...
void TS_REQ_ext_free(TS_REQ *a)
{
    ...
    a->extensions = 
# 142 "../crypto/ts/ts_req_utils.c" 3 4
                   ((void *)0)
# 142 "../crypto/ts/ts_req_utils.c"
                       ;
}
...
# 177 "../crypto/ts/ts_req_utils.c" 3 4
                                                     ((void *)0)
# 177 "../crypto/ts/ts_req_utils.c"
                                                         ;
}
