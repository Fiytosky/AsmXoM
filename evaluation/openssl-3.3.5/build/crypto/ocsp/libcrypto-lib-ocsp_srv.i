# 0 "../crypto/ocsp/ocsp_srv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_srv.c"
# 10 "../crypto/ocsp/ocsp_srv.c"
...
int OCSP_request_onereq_count(OCSP_REQUEST *req)
{
    return OPENSSL_sk_num(ossl_check_const_OCSP_ONEREQ_sk_type(req->tbsRequest.requestList));
}

OCSP_ONEREQ *OCSP_request_onereq_get0(OCSP_REQUEST *req, int i)
{
    return ((OCSP_ONEREQ *)OPENSSL_sk_value(ossl_check_const_OCSP_ONEREQ_sk_type(req->tbsRequest.requestList), (i)));
}
...
{
    OCSP_RESPONSE *rsp = 
# 65 "../crypto/ocsp/ocsp_srv.c" 3 4
                        ((void *)0)
# 65 "../crypto/ocsp/ocsp_srv.c"
                            ;

    if ((rsp = OCSP_RESPONSE_new()) == 
# 67 "../crypto/ocsp/ocsp_srv.c" 3 4
                                      ((void *)0)
# 67 "../crypto/ocsp/ocsp_srv.c"
                                          )
        goto err;
...
# 73 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                      ((void *)0)
# 73 "../crypto/ocsp/ocsp_srv.c"
                                                          )
        goto err;
    rsp->responseBytes->responseType = OBJ_nid2obj(365);
    if (!ASN1_item_pack
        (bs, (OCSP_BASICRESP_it()), &rsp->responseBytes->response))
         goto err;
    return rsp;
 err:
    OCSP_RESPONSE_free(rsp);
    return 
# 82 "../crypto/ocsp/ocsp_srv.c" 3 4
          ((void *)0)
# 82 "../crypto/ocsp/ocsp_srv.c"
              ;
}
...
# 92 "../crypto/ocsp/ocsp_srv.c" 3 4
                             ((void *)0)
# 92 "../crypto/ocsp/ocsp_srv.c"
                                 ;
    OCSP_CERTSTATUS *cs;
    OCSP_REVOKEDINFO *ri;

    if (rsp->tbsResponseData.responses == 
# 96 "../crypto/ocsp/ocsp_srv.c" 3 4
                                         ((void *)0)
        
# 97 "../crypto/ocsp/ocsp_srv.c"
       && (rsp->tbsResponseData.responses
                = ((struct stack_st_OCSP_SINGLERESP *)OPENSSL_sk_new_null())) == 
# 98 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                   ((void *)0)
# 98 "../crypto/ocsp/ocsp_srv.c"
                                                       )
        goto err;

    if ((single = OCSP_SINGLERESP_new()) == 
# 101 "../crypto/ocsp/ocsp_srv.c" 3 4
                                           ((void *)0)
# 101 "../crypto/ocsp/ocsp_srv.c"
                                               )
        goto err;
...
# 112 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                  ((void *)0)
# 112 "../crypto/ocsp/ocsp_srv.c"
                                                      )
        goto err;
    ...
    case 1:
        if (!revtime) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_srv.c",119,__func__), ERR_set_error)((39),(109),
# 119 "../crypto/ocsp/ocsp_srv.c" 3 4
           ((void *)0)
# 119 "../crypto/ocsp/ocsp_srv.c"
           );
            goto err;
        }
        if ((cs->value.revoked = ri = OCSP_REVOKEDINFO_new()) == 
# 122 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                                ((void *)0)
# 122 "../crypto/ocsp/ocsp_srv.c"
                                                                    )
            goto err;
...
# 127 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                                 ((void *)0)
# 127 "../crypto/ocsp/ocsp_srv.c"
                                                                     )
                goto err;
    ...
    case 0:
        if ((cs->value.good = ASN1_NULL_new()) == 
# 135 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                 ((void *)0)
# 135 "../crypto/ocsp/ocsp_srv.c"
                                                     )
            goto err;
        break;

    case 2:
        if ((cs->value.unknown = ASN1_NULL_new()) == 
# 140 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                    ((void *)0)
# 140 "../crypto/ocsp/ocsp_srv.c"
                                                        )
            goto err;
        break;
    ...
    if (!(OPENSSL_sk_push(ossl_check_OCSP_SINGLERESP_sk_type(rsp->tbsResponseData.responses), ossl_check_OCSP_SINGLERESP_type(single))))
        goto err;
    return single;
 err:
    OCSP_SINGLERESP_free(single);
    return 
# 153 "../crypto/ocsp/ocsp_srv.c" 3 4
          ((void *)0)
# 153 "../crypto/ocsp/ocsp_srv.c"
              ;
}
...
int OCSP_basic_add1_cert(OCSP_BASICRESP *resp, X509 *cert)
{
    return ossl_x509_add_cert_new(&resp->certs, cert, 0x1);
}
                    ...
                    struct stack_st_X509 *certs, unsigned long flags)
{
    ...
    if (ctx == 
# 174 "../crypto/ocsp/ocsp_srv.c" 3 4
              ((void *)0) 
# 174 "../crypto/ocsp/ocsp_srv.c"
                   || EVP_MD_CTX_get_pkey_ctx(ctx) == 
# 174 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                      ((void *)0)
# 174 "../crypto/ocsp/ocsp_srv.c"
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_srv.c",175,__func__), ERR_set_error)((39),(130),
# 175 "../crypto/ocsp/ocsp_srv.c" 3 4
       ((void *)0)
# 175 "../crypto/ocsp/ocsp_srv.c"
       );
        goto err;
    }
    ...
    if (pkey == 
# 180 "../crypto/ocsp/ocsp_srv.c" 3 4
               ((void *)0) 
# 180 "../crypto/ocsp/ocsp_srv.c"
                    || !X509_check_private_key(signer, pkey)) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_srv.c",181,__func__), ERR_set_error)((39),(110),
# 181 "../crypto/ocsp/ocsp_srv.c" 3 4
       ((void *)0)
# 181 "../crypto/ocsp/ocsp_srv.c"
       );
        goto err;
    }
    ...
    if (!(flags & 0x1)) {
        if (!OCSP_basic_add1_cert(brsp, signer)
            || !X509_add_certs(brsp->certs, certs, 0x1))
            goto err;
    }
    ...
    if (!ASN1_item_sign_ctx((OCSP_RESPDATA_it()), &(brsp)->signatureAlgorithm, 
# 207 "../crypto/ocsp/ocsp_srv.c" 3 4
        ((void *)0)
# 207 "../crypto/ocsp/ocsp_srv.c"
        , (brsp)->signature, &(brsp)->tbsResponseData, ctx))
        goto err;
                    ...
                    struct stack_st_X509 *certs, unsigned long flags)
{
    ...
    EVP_PKEY_CTX *pkctx = 
# 220 "../crypto/ocsp/ocsp_srv.c" 3 4
                         ((void *)0)
# 220 "../crypto/ocsp/ocsp_srv.c"
                             ;
    int i;

    if (ctx == 
# 223 "../crypto/ocsp/ocsp_srv.c" 3 4
              ((void *)0)
# 223 "../crypto/ocsp/ocsp_srv.c"
                  )
        return 0;

    if (!EVP_DigestSignInit_ex(ctx, &pkctx, EVP_MD_get0_name(dgst),
                               signer->libctx, signer->propq, key, 
# 227 "../crypto/ocsp/ocsp_srv.c" 3 4
                                                                  ((void *)0)
# 227 "../crypto/ocsp/ocsp_srv.c"
                                                                      )) {
        EVP_MD_CTX_free(ctx);
        return 0;
    }
...
{
    ASN1_OCTET_STRING *byKey = 
# 249 "../crypto/ocsp/ocsp_srv.c" 3 4
                              ((void *)0)
# 249 "../crypto/ocsp/ocsp_srv.c"
                                  ;
    unsigned char md[20];
    ...
    if (sha1 == 
# 254 "../crypto/ocsp/ocsp_srv.c" 3 4
               ((void *)0)
# 254 "../crypto/ocsp/ocsp_srv.c"
                   )
        return 0;


    if (!X509_pubkey_digest(cert, sha1, md, 
# 258 "../crypto/ocsp/ocsp_srv.c" 3 4
                                           ((void *)0)
# 258 "../crypto/ocsp/ocsp_srv.c"
                                               ))
        goto err;

    byKey = ASN1_OCTET_STRING_new();
    if (byKey == 
# 262 "../crypto/ocsp/ocsp_srv.c" 3 4
                ((void *)0)
# 262 "../crypto/ocsp/ocsp_srv.c"
                    )
        goto err;

    if (!(ASN1_OCTET_STRING_set(byKey, md, 20))) {
...
{
    if (cert == 
# 281 "../crypto/ocsp/ocsp_srv.c" 3 4
               ((void *)0)
# 281 "../crypto/ocsp/ocsp_srv.c"
                   )
        return 0;
...
{
    EVP_MD *sha1 = 
# 289 "../crypto/ocsp/ocsp_srv.c" 3 4
                  ((void *)0)
# 289 "../crypto/ocsp/ocsp_srv.c"
                      ;
    int ret = 0;
    ...
    if (respid->type == 1) {
        ...
        if (sha1 == 
# 296 "../crypto/ocsp/ocsp_srv.c" 3 4
                   ((void *)0)
# 296 "../crypto/ocsp/ocsp_srv.c"
                       )
            goto err;

        if (respid->value.byKey == 
# 299 "../crypto/ocsp/ocsp_srv.c" 3 4
                                  ((void *)0)
# 299 "../crypto/ocsp/ocsp_srv.c"
                                      )
            goto err;


        if (!X509_pubkey_digest(cert, sha1, md, 
# 303 "../crypto/ocsp/ocsp_srv.c" 3 4
                                               ((void *)0)
# 303 "../crypto/ocsp/ocsp_srv.c"
                                                   ))
            goto err;

        ret = (ASN1_STRING_length(respid->value.byKey) == 20)
              && (memcmp(ASN1_STRING_get0_data(respid->value.byKey), md,
                         20) == 0);
    } else if (respid->type == 0) {
        if (respid->value.byName == 
# 310 "../crypto/ocsp/ocsp_srv.c" 3 4
                                   ((void *)0)
# 310 "../crypto/ocsp/ocsp_srv.c"
                                       )
            return 0;
...
{
    if (cert == 
# 324 "../crypto/ocsp/ocsp_srv.c" 3 4
               ((void *)0)
# 324 "../crypto/ocsp/ocsp_srv.c"
                   )
        return 0;
