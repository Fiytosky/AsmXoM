# 0 "../crypto/ocsp/ocsp_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_lib.c"
# 10 "../crypto/ocsp/ocsp_lib.c"
                             ...
                             const X509 *issuer)
{
    ...
    if (subject) {
        ...
        serial = 
# 36 "../crypto/ocsp/ocsp_lib.c" 3 4
                ((void *)0)
# 36 "../crypto/ocsp/ocsp_lib.c"
                    ;
    }
                              ...
                              const ASN1_INTEGER *serialNumber)
{
    ...
    X509_ALGOR *alg;
    OCSP_CERTID *cid = 
# 50 "../crypto/ocsp/ocsp_lib.c" 3 4
                      ((void *)0)
# 50 "../crypto/ocsp/ocsp_lib.c"
                          ;
    unsigned char md[64];

    if ((cid = OCSP_CERTID_new()) == 
# 53 "../crypto/ocsp/ocsp_lib.c" 3 4
                                    ((void *)0)
# 53 "../crypto/ocsp/ocsp_lib.c"
                                        )
        goto err;

    alg = &cid->hashAlgorithm;
    ASN1_OBJECT_free(alg->algorithm);
    if ((nid = EVP_MD_get_type(dgst)) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_lib.c",59,__func__), ERR_set_error)((39),(120),
# 59 "../crypto/ocsp/ocsp_lib.c" 3 4
       ((void *)0)
# 59 "../crypto/ocsp/ocsp_lib.c"
       );
        goto err;
    }
    if ((alg->algorithm = OBJ_nid2obj(nid)) == 
# 62 "../crypto/ocsp/ocsp_lib.c" 3 4
                                              ((void *)0)
# 62 "../crypto/ocsp/ocsp_lib.c"
                                                  )
        goto err;
    if ((alg->parameter = ASN1_TYPE_new()) == 
# 64 "../crypto/ocsp/ocsp_lib.c" 3 4
                                             ((void *)0)
# 64 "../crypto/ocsp/ocsp_lib.c"
                                                 )
        goto err;
...
# 74 "../crypto/ocsp/ocsp_lib.c" 3 4
                                                                     ((void *)0)
# 74 "../crypto/ocsp/ocsp_lib.c"
                                                                         ))
        goto err;
    ...
    return cid;
 digerr:
    (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_lib.c",86,__func__), ERR_set_error)((39),(102),
# 86 "../crypto/ocsp/ocsp_lib.c" 3 4
   ((void *)0)
# 86 "../crypto/ocsp/ocsp_lib.c"
   );
 err:
    OCSP_CERTID_free(cid);
    return 
# 89 "../crypto/ocsp/ocsp_lib.c" 3 4
          ((void *)0)
# 89 "../crypto/ocsp/ocsp_lib.c"
              ;
}
...
OCSP_CERTID * OCSP_CERTID_dup(const OCSP_CERTID *x) { return ASN1_item_dup((OCSP_CERTID_it()), x); }
