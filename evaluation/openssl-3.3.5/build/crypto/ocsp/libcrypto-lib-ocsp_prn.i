# 0 "../crypto/ocsp/ocsp_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_prn.c"
# 10 "../crypto/ocsp/ocsp_prn.c"
...
const char *OCSP_response_status_str(long s)
{
    ...
    return do_table2string(s, rstat_tbl, (sizeof(rstat_tbl)/sizeof((rstat_tbl)[0])));
}
...
const char *OCSP_cert_status_str(long s)
{
    ...
    return do_table2string(s, cstat_tbl, (sizeof(cstat_tbl)/sizeof((cstat_tbl)[0])));
}
...
const char *OCSP_crl_reason_str(long s)
{
    ...
    return do_table2string(s, reason_tbl, (sizeof(reason_tbl)/sizeof((reason_tbl)[0])));
}
...
int OCSP_REQUEST_print(BIO *bp, OCSP_REQUEST *o, unsigned long flags)
{
    ...
    long l;
    OCSP_CERTID *cid = 
# 93 "../crypto/ocsp/ocsp_prn.c" 3 4
                      ((void *)0)
# 93 "../crypto/ocsp/ocsp_prn.c"
                          ;
    OCSP_ONEREQ *one = 
# 94 "../crypto/ocsp/ocsp_prn.c" 3 4
                      ((void *)0)
# 94 "../crypto/ocsp/ocsp_prn.c"
                          ;
...
# 103 "../crypto/ocsp/ocsp_prn.c" 3 4
                             ((void *)0)
# 103 "../crypto/ocsp/ocsp_prn.c"
                                 ) {
        if (BIO_write(bp, "\n    Requestor Name: ", 21) <= 0)
            goto err;
    ...
    if (BIO_write(bp, "\n    Requestor List:\n", 21) <= 0)
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OCSP_ONEREQ_sk_type(inf->requestList)); i++) {
        one = ((OCSP_ONEREQ *)OPENSSL_sk_value(ossl_check_const_OCSP_ONEREQ_sk_type(inf->requestList), (i)));
        cid = one->reqCert;
    ...
    if (sig) {
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(sig->certs)); i++) {
            X509_print(bp, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sig->certs), (i))));
            PEM_write_bio_X509(bp, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(sig->certs), (i))));
        }
    }
    return 1;
 err:
...
int OCSP_RESPONSE_print(BIO *bp, OCSP_RESPONSE *o, unsigned long flags)
{
    ...
    long l;
    OCSP_CERTID *cid = 
# 138 "../crypto/ocsp/ocsp_prn.c" 3 4
                      ((void *)0)
# 138 "../crypto/ocsp/ocsp_prn.c"
                          ;
    OCSP_BASICRESP *br = 
# 139 "../crypto/ocsp/ocsp_prn.c" 3 4
                        ((void *)0)
# 139 "../crypto/ocsp/ocsp_prn.c"
                            ;
    OCSP_RESPID *rid = 
# 140 "../crypto/ocsp/ocsp_prn.c" 3 4
                      ((void *)0)
# 140 "../crypto/ocsp/ocsp_prn.c"
                          ;
    OCSP_RESPDATA *rd = 
# 141 "../crypto/ocsp/ocsp_prn.c" 3 4
                       ((void *)0)
# 141 "../crypto/ocsp/ocsp_prn.c"
                           ;
    OCSP_CERTSTATUS *cst = 
# 142 "../crypto/ocsp/ocsp_prn.c" 3 4
                          ((void *)0)
# 142 "../crypto/ocsp/ocsp_prn.c"
                              ;
    OCSP_REVOKEDINFO *rev = 
# 143 "../crypto/ocsp/ocsp_prn.c" 3 4
                           ((void *)0)
# 143 "../crypto/ocsp/ocsp_prn.c"
                               ;
    OCSP_SINGLERESP *single = 
# 144 "../crypto/ocsp/ocsp_prn.c" 3 4
                             ((void *)0)
# 144 "../crypto/ocsp/ocsp_prn.c"
                                 ;
    ...
    if (BIO_printf(bp, "    OCSP Response Status: %s (0x%lx)\n",
        ...
        goto err;
    if (rb == 
# 153 "../crypto/ocsp/ocsp_prn.c" 3 4
             ((void *)0)
# 153 "../crypto/ocsp/ocsp_prn.c"
                 )
        return 1;
...
# 164 "../crypto/ocsp/ocsp_prn.c" 3 4
                                             ((void *)0)
# 164 "../crypto/ocsp/ocsp_prn.c"
                                                 )
        goto err;
    ...
    if (BIO_printf(bp, "\n    Responses:\n") <= 0)
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OCSP_SINGLERESP_sk_type(rd->responses)); i++) {
        if (!((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(rd->responses), (i))))
            continue;
        single = ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(rd->responses), (i)));
        cid = single->certId;
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(br->certs)); i++) {
        X509_print(bp, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(br->certs), (i))));
        PEM_write_bio_X509(bp, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(br->certs), (i))));
    }
