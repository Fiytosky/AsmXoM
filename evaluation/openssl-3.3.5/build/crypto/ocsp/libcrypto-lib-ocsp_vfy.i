# 0 "../crypto/ocsp/ocsp_vfy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_vfy.c"
# 10 "../crypto/ocsp/ocsp_vfy.c"
...
static int ocsp_req_find_signer(X509 **psigner, OCSP_REQUEST *req,
                                const X509_NAME *nm, struct stack_st_X509 *certs,
                                unsigned long flags);


static int ocsp_verify_signer(X509 *signer, int response,
                              X509_STORE *st, unsigned long flags,
                              struct stack_st_X509 *untrusted, struct stack_st_X509 **chain)
{
    ...
    if (ctx == 
# 38 "../crypto/ocsp/ocsp_vfy.c" 3 4
              ((void *)0)
# 38 "../crypto/ocsp/ocsp_vfy.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",39,__func__), ERR_set_error)((39),((11 | (0x2 << 18L))),
# 39 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 39 "../crypto/ocsp/ocsp_vfy.c"
       );
        goto end;
    }
    if (!X509_STORE_CTX_init(ctx, st, signer, untrusted)) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",43,__func__), ERR_set_error)((39),((11 | (0x2 << 18L))),
# 43 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 43 "../crypto/ocsp/ocsp_vfy.c"
       );
        goto end;
    }
    if ((vp = X509_STORE_CTX_get0_param(ctx)) == 
# 46 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                ((void *)0)
# 46 "../crypto/ocsp/ocsp_vfy.c"
                                                    )
        goto end;
    if ((flags & 0x1000) != 0)
        X509_VERIFY_PARAM_set_flags(vp, 0x80000);
    if (response
            && X509_get_ext_by_NID(signer, 369, -1) >= 0)




        X509_VERIFY_PARAM_clear_flags(vp, 0x4);
    ...
    if (ret <= 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",64,__func__), ERR_set_error)(39, 101,
                       "Verify error: %s", X509_verify_cert_error_string(err));
        goto end;
    }
    if (chain != 
# 68 "../crypto/ocsp/ocsp_vfy.c" 3 4
                ((void *)0)
# 68 "../crypto/ocsp/ocsp_vfy.c"
                    )
                       ...
                       X509 *signer, unsigned long flags)
{
    ...
    if ((flags & 0x4) == 0) {
        if ((skey = X509_get0_pubkey(signer)) == 
# 83 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                ((void *)0)
# 83 "../crypto/ocsp/ocsp_vfy.c"
                                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",84,__func__), ERR_set_error)((39),(130),
# 84 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 84 "../crypto/ocsp/ocsp_vfy.c"
           );
            return -1;
        }
        if (req != 
# 87 "../crypto/ocsp/ocsp_vfy.c" 3 4
                  ((void *)0)
# 87 "../crypto/ocsp/ocsp_vfy.c"
                      )
            ret = ASN1_item_verify_ex((OCSP_REQINFO_it()), &(req)->optionalSignature->signatureAlgorithm, (req)->optionalSignature->signature, &(req)->tbsRequest, 
# 88 "../crypto/ocsp/ocsp_vfy.c" 3 4
                 ((void *)0)
# 88 "../crypto/ocsp/ocsp_vfy.c"
                 , skey, signer->libctx, signer->propq);
        else
            ret = ASN1_item_verify_ex((OCSP_RESPDATA_it()), &(bs)->signatureAlgorithm, (bs)->signature, &(bs)->tbsResponseData, 
# 90 "../crypto/ocsp/ocsp_vfy.c" 3 4
                 ((void *)0)
# 90 "../crypto/ocsp/ocsp_vfy.c"
                 , skey, signer->libctx, signer->propq);
        if (ret <= 0)
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",92,__func__), ERR_set_error)((39),(117),
# 92 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 92 "../crypto/ocsp/ocsp_vfy.c"
           );
    }
    return ret;
}
                      ...
                      X509_STORE *st, unsigned long flags)
{
    X509 *signer, *x;
    struct stack_st_X509 *chain = 
# 102 "../crypto/ocsp/ocsp_vfy.c" 3 4
                           ((void *)0)
# 102 "../crypto/ocsp/ocsp_vfy.c"
                               ;
    struct stack_st_X509 *untrusted = 
# 103 "../crypto/ocsp/ocsp_vfy.c" 3 4
                               ((void *)0)
# 103 "../crypto/ocsp/ocsp_vfy.c"
                                   ;
    int ret = ocsp_find_signer(&signer, bs, certs, flags);

    if (ret == 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",107,__func__), ERR_set_error)((39),(118),
# 107 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 107 "../crypto/ocsp/ocsp_vfy.c"
       );
        goto end;
    }
    if ((ret == 2) && (flags & 0x200) != 0)
        flags |= 0x10;

    if ((ret = ocsp_verify(
# 113 "../crypto/ocsp/ocsp_vfy.c" 3 4
                          ((void *)0)
# 113 "../crypto/ocsp/ocsp_vfy.c"
                              , bs, signer, flags)) <= 0)
        goto end;
    if ((flags & 0x10) == 0) {
        ret = -1;
        if ((flags & 0x8) == 0) {
            if ((untrusted = ((struct stack_st_X509 *)OPENSSL_sk_dup(ossl_check_const_X509_sk_type(bs->certs)))) == 
# 118 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                       ((void *)0)
# 118 "../crypto/ocsp/ocsp_vfy.c"
                                                           )
                goto end;
            if (!X509_add_certs(untrusted, certs, 0))
                goto end;
        }
        ...
        x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)) - 1)));
        if (X509_check_trust(x, 180, 0) != 1) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",149,__func__), ERR_set_error)((39),(112),
# 149 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 149 "../crypto/ocsp/ocsp_vfy.c"
           );
            ret = 0;
            goto end;
        }
...
# 174 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                     ((void *)0)
# 174 "../crypto/ocsp/ocsp_vfy.c"
                                                         ) {
        *psigner = signer;
        return 2;
    }
    ...
    *psigner = 
# 185 "../crypto/ocsp/ocsp_vfy.c" 3 4
              ((void *)0)
# 185 "../crypto/ocsp/ocsp_vfy.c"
                  ;
    return 0;
}
...
static X509 *ocsp_find_signer_sk(struct stack_st_X509 *certs, OCSP_RESPID *id)
{
    ...
    if (id->value.byKey->length != 20)
        return 
# 204 "../crypto/ocsp/ocsp_vfy.c" 3 4
              ((void *)0)
# 204 "../crypto/ocsp/ocsp_vfy.c"
                  ;
    keyhash = id->value.byKey->data;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        if ((x = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)))) != 
# 208 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                            ((void *)0)
# 208 "../crypto/ocsp/ocsp_vfy.c"
                                                ) {
            if ((md = EVP_MD_fetch(x->libctx, "SHA1", x->propq)) == 
# 209 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                                    ((void *)0)
# 209 "../crypto/ocsp/ocsp_vfy.c"
                                                                        )
                break;
            r = X509_pubkey_digest(x, md, tmphash, 
# 211 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                  ((void *)0)
# 211 "../crypto/ocsp/ocsp_vfy.c"
                                                      );
            EVP_MD_free(md);
            if (!r)
                break;
            if (memcmp(keyhash, tmphash, 20) == 0)
                return x;
        }
    }
    return 
# 219 "../crypto/ocsp/ocsp_vfy.c" 3 4
          ((void *)0)
# 219 "../crypto/ocsp/ocsp_vfy.c"
              ;
}

static int ocsp_check_issuer(OCSP_BASICRESP *bs, struct stack_st_X509 *chain)
{
    struct stack_st_OCSP_SINGLERESP *sresp = bs->tbsResponseData.responses;
    X509 *signer, *sca;
    OCSP_CERTID *caid = 
# 226 "../crypto/ocsp/ocsp_vfy.c" 3 4
                       ((void *)0)
# 226 "../crypto/ocsp/ocsp_vfy.c"
                           ;
    int ret;

    if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",230,__func__), ERR_set_error)((39),(105),
# 230 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 230 "../crypto/ocsp/ocsp_vfy.c"
       );
        return -1;
    }
    ...
    signer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (0)));

    if (OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)) > 1) {
        sca = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (1)));
...
# 267 "../crypto/ocsp/ocsp_vfy.c"
static int ocsp_check_ids(struct stack_st_OCSP_SINGLERESP *sresp, OCSP_CERTID **ret)
{
    OCSP_CERTID *tmpid, *cid;
    int i, idcount;

    idcount = OPENSSL_sk_num(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp));
    if (idcount <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",274,__func__), ERR_set_error)((39),(111),
# 274 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 274 "../crypto/ocsp/ocsp_vfy.c"
       );
        return -1;
    }

    cid = ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp), (0)))->certId;

    *ret = 
# 280 "../crypto/ocsp/ocsp_vfy.c" 3 4
          ((void *)0)
# 280 "../crypto/ocsp/ocsp_vfy.c"
              ;
    for (i = 1; i < idcount; i++) {
        tmpid = ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp), (i)))->certId;
                               ...
                               struct stack_st_OCSP_SINGLERESP *sresp)
{
    int ret = -1;
    EVP_MD *dgst = 
# 307 "../crypto/ocsp/ocsp_vfy.c" 3 4
                  ((void *)0)
# 307 "../crypto/ocsp/ocsp_vfy.c"
                      ;


    if (cid != 
# 310 "../crypto/ocsp/ocsp_vfy.c" 3 4
              ((void *)0)
# 310 "../crypto/ocsp/ocsp_vfy.c"
                  ) {
        char name[50];
        ...
        (void)ERR_set_mark();
        dgst = EVP_MD_fetch(
# 319 "../crypto/ocsp/ocsp_vfy.c" 3 4
                           ((void *)0)
# 319 "../crypto/ocsp/ocsp_vfy.c"
                               , name, 
# 319 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                       ((void *)0)
# 319 "../crypto/ocsp/ocsp_vfy.c"
        ...
        if (dgst == 
# 320 "../crypto/ocsp/ocsp_vfy.c" 3 4
                   ((void *)0)
# 320 "../crypto/ocsp/ocsp_vfy.c"
                       )
            dgst = (EVP_MD *)EVP_get_digestbyname(name);

        if (dgst == 
# 323 "../crypto/ocsp/ocsp_vfy.c" 3 4
                   ((void *)0)
# 323 "../crypto/ocsp/ocsp_vfy.c"
                       ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",325,__func__), ERR_set_error)((39),(119),
# 325 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 325 "../crypto/ocsp/ocsp_vfy.c"
           );
            goto end;
        }
        ...
        if (mdlen < 0) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",332,__func__), ERR_set_error)((39),(107),
# 332 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 332 "../crypto/ocsp/ocsp_vfy.c"
           );
            goto end;
        }
...
# 341 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                              ((void *)0)
# 341 "../crypto/ocsp/ocsp_vfy.c"
                                                  ))
            goto end;
        ...
        if (!X509_pubkey_digest(cert, dgst, md, 
# 347 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                               ((void *)0)
# 347 "../crypto/ocsp/ocsp_vfy.c"
                                                   )) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",348,__func__), ERR_set_error)((39),(102),
# 348 "../crypto/ocsp/ocsp_vfy.c" 3 4
           ((void *)0)
# 348 "../crypto/ocsp/ocsp_vfy.c"
           );
            goto end;
        }
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp)); i++) {
            tmpid = ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp), (i)))->certId;
            ret = ocsp_match_issuerid(cert, tmpid, 
# 360 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                  ((void *)0)
# 360 "../crypto/ocsp/ocsp_vfy.c"
                                                      );
            if (ret <= 0)
                return ret;
        }
...
static int ocsp_check_delegated(X509 *x)
{
    if ((X509_get_extension_flags(x) & 0x4)
        ...
        return 1;
    (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",376,__func__), ERR_set_error)((39),(103),
# 376 "../crypto/ocsp/ocsp_vfy.c" 3 4
   ((void *)0)
# 376 "../crypto/ocsp/ocsp_vfy.c"
   );
    return 0;
}
                        ...
                        X509_STORE *store, unsigned long flags)
{
    ...
    if (!req->optionalSignature) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",394,__func__), ERR_set_error)((39),(128),
# 394 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 394 "../crypto/ocsp/ocsp_vfy.c"
       );
        return 0;
    }
    gen = req->tbsRequest.requestorName;
    if (!gen || gen->type != 4) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",399,__func__), ERR_set_error)((39),(129),
# 399 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 399 "../crypto/ocsp/ocsp_vfy.c"
       );
        return 0;
    }
    ...
    if (ret <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_vfy.c",405,__func__), ERR_set_error)((39),(118),
# 405 "../crypto/ocsp/ocsp_vfy.c" 3 4
       ((void *)0)
# 405 "../crypto/ocsp/ocsp_vfy.c"
       );
        return 0;
    }
    if ((ret == 2) && (flags & 0x200) != 0)
    ...
    if ((ret = ocsp_verify(req, 
# 411 "../crypto/ocsp/ocsp_vfy.c" 3 4
                               ((void *)0)
# 411 "../crypto/ocsp/ocsp_vfy.c"
                                   , signer, flags)) <= 0)
        return 0;
    if ((flags & 0x10) != 0)
        return 1;
...
# 417 "../crypto/ocsp/ocsp_vfy.c" 3 4
                             ((void *)0) 
# 417 "../crypto/ocsp/ocsp_vfy.c"
                                ...
                                unsigned long flags)
{
    ...
    if ((flags & 0x2) == 0) {
        ...
        if (signer != 
# 429 "../crypto/ocsp/ocsp_vfy.c" 3 4
                     ((void *)0)
# 429 "../crypto/ocsp/ocsp_vfy.c"
                         ) {
            *psigner = signer;
            return 1;
        }
    ...
    if ((signer = X509_find_by_subject(certs, nm)) != 
# 435 "../crypto/ocsp/ocsp_vfy.c" 3 4
                                                     ((void *)0)
# 435 "../crypto/ocsp/ocsp_vfy.c"
                                                         ) {
        *psigner = signer;
        return 2;
    }
