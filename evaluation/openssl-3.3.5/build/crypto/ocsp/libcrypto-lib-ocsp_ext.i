# 0 "../crypto/ocsp/ocsp_ext.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_ext.c"
# 10 "../crypto/ocsp/ocsp_ext.c"
...
# 72 "../crypto/ocsp/ocsp_ext.c" 3 4
           ((void *)0)
# 72 "../crypto/ocsp/ocsp_ext.c"
               );
}
...
# 123 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                                     ((void *)0)
# 123 "../crypto/ocsp/ocsp_ext.c"
                                                                         );
}
...
int OCSP_BASICRESP_add_ext(OCSP_BASICRESP *x, X509_EXTENSION *ex, int loc)
{
    return (X509v3_add_ext(&(x->tbsResponseData.responseExtensions), ex, loc)
            != 
# 180 "../crypto/ocsp/ocsp_ext.c" 3 4
              ((void *)0)
# 180 "../crypto/ocsp/ocsp_ext.c"
                  );
}
...
# 231 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                              ((void *)0)
# 231 "../crypto/ocsp/ocsp_ext.c"
                                                                  );
}
# 244 "../crypto/ocsp/ocsp_ext.c"
static int ocsp_add1_nonce(struct stack_st_X509_EXTENSION **exts,
                           unsigned char *val, int len)
{
    ...
    os.data = CRYPTO_malloc(os.length, "../crypto/ocsp/ocsp_ext.c", 262);
    if (os.data == 
# 263 "../crypto/ocsp/ocsp_ext.c" 3 4
                  ((void *)0)
# 263 "../crypto/ocsp/ocsp_ext.c"
                      )
        goto err;
    tmpval = os.data;
    ...
    if (val)
        ...
        goto err;
    if (X509V3_add1_i2d(exts, 366,
                         &os, 0, 2L) <= 0)
        goto err;
    ret = 1;
 err:
    CRYPTO_free(os.data, "../crypto/ocsp/ocsp_ext.c", 276);
    return ret;
}
...
# 309 "../crypto/ocsp/ocsp_ext.c"
int OCSP_check_nonce(OCSP_REQUEST *req, OCSP_BASICRESP *bs)
{
# 319 "../crypto/ocsp/ocsp_ext.c"
    int req_idx, resp_idx;
    X509_EXTENSION *req_ext, *resp_ext;
    req_idx = OCSP_REQUEST_get_ext_by_NID(req, 366, -1);
    resp_idx = OCSP_BASICRESP_get_ext_by_NID(bs, 366, -1);
...
{
    X509_EXTENSION *x = 
# 362 "../crypto/ocsp/ocsp_ext.c" 3 4
                       ((void *)0)
# 362 "../crypto/ocsp/ocsp_ext.c"
                           ;
    OCSP_CRLID *cid = 
# 363 "../crypto/ocsp/ocsp_ext.c" 3 4
                     ((void *)0)
# 363 "../crypto/ocsp/ocsp_ext.c"
                         ;

    if ((cid = OCSP_CRLID_new()) == 
# 365 "../crypto/ocsp/ocsp_ext.c" 3 4
                                   ((void *)0)
# 365 "../crypto/ocsp/ocsp_ext.c"
                                       )
        goto err;
    if (url) {
        if ((cid->crlUrl = ASN1_IA5STRING_new()) == 
# 368 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                   ((void *)0)
# 368 "../crypto/ocsp/ocsp_ext.c"
                                                       )
            goto err;
...
# 374 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                 ((void *)0)
...
# 380 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                          ((void *)0)
# 380 "../crypto/ocsp/ocsp_ext.c"
                                                              )
            goto err;
...
# 395 "../crypto/ocsp/ocsp_ext.c" 3 4
                               ((void *)0)
# 395 "../crypto/ocsp/ocsp_ext.c"
                                   ;
    ASN1_OBJECT *o = 
# 396 "../crypto/ocsp/ocsp_ext.c" 3 4
                    ((void *)0)
# 396 "../crypto/ocsp/ocsp_ext.c"
                        ;
    X509_EXTENSION *x = 
# 397 "../crypto/ocsp/ocsp_ext.c" 3 4
                       ((void *)0)
# 397 "../crypto/ocsp/ocsp_ext.c"
                           ;

    if ((sk = ((struct stack_st_ASN1_OBJECT *)OPENSSL_sk_new_null())) == 
# 399 "../crypto/ocsp/ocsp_ext.c" 3 4
                                           ((void *)0)
# 399 "../crypto/ocsp/ocsp_ext.c"
                                               )
        goto err;
    while (oids && *oids) {
        if ((nid = OBJ_txt2nid(*oids)) != 0 && (o = OBJ_nid2obj(nid)))
            OPENSSL_sk_push(ossl_check_ASN1_OBJECT_sk_type(sk), ossl_check_ASN1_OBJECT_type(o));
        oids++;
    }
    x = X509V3_EXT_i2d(368, 0, sk);
 err:
    OPENSSL_sk_pop_free(ossl_check_ASN1_OBJECT_sk_type(sk),ossl_check_ASN1_OBJECT_freefunc_type(ASN1_OBJECT_free));
    return x;
}
...
{
    X509_EXTENSION *x = 
# 415 "../crypto/ocsp/ocsp_ext.c" 3 4
                       ((void *)0)
# 415 "../crypto/ocsp/ocsp_ext.c"
                           ;
    ASN1_GENERALIZEDTIME *gt = 
# 416 "../crypto/ocsp/ocsp_ext.c" 3 4
                              ((void *)0)
# 416 "../crypto/ocsp/ocsp_ext.c"
                                  ;

    if ((gt = ASN1_GENERALIZEDTIME_new()) == 
# 418 "../crypto/ocsp/ocsp_ext.c" 3 4
                                            ((void *)0)
# 418 "../crypto/ocsp/ocsp_ext.c"
                                                )
        goto err;
...
{
    X509_EXTENSION *x = 
# 435 "../crypto/ocsp/ocsp_ext.c" 3 4
                       ((void *)0)
# 435 "../crypto/ocsp/ocsp_ext.c"
                           ;
    ASN1_IA5STRING *ia5 = 
# 436 "../crypto/ocsp/ocsp_ext.c" 3 4
                         ((void *)0)
# 436 "../crypto/ocsp/ocsp_ext.c"
                             ;
    OCSP_SERVICELOC *sloc = 
# 437 "../crypto/ocsp/ocsp_ext.c" 3 4
                           ((void *)0)
# 437 "../crypto/ocsp/ocsp_ext.c"
                               ;
    ACCESS_DESCRIPTION *ad = 
# 438 "../crypto/ocsp/ocsp_ext.c" 3 4
                            ((void *)0)
# 438 "../crypto/ocsp/ocsp_ext.c"
                                ;

    if ((sloc = OCSP_SERVICELOC_new()) == 
# 440 "../crypto/ocsp/ocsp_ext.c" 3 4
                                         ((void *)0)
# 440 "../crypto/ocsp/ocsp_ext.c"
                                             )
        goto err;
    X509_NAME_free(sloc->issuer);
    if ((sloc->issuer = X509_NAME_dup(issuer)) == 
# 443 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                 ((void *)0)
# 443 "../crypto/ocsp/ocsp_ext.c"
                                                     )
        goto err;
    if (urls && *urls
        && (sloc->locator = ((struct stack_st_ACCESS_DESCRIPTION *)OPENSSL_sk_new_null())) == 
# 446 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                                ((void *)0)
# 446 "../crypto/ocsp/ocsp_ext.c"
                                                                    )
        goto err;
    while (urls && *urls) {
        if ((ad = ACCESS_DESCRIPTION_new()) == 
# 449 "../crypto/ocsp/ocsp_ext.c" 3 4
                                              ((void *)0)
# 449 "../crypto/ocsp/ocsp_ext.c"
                                                  )
            goto err;
        if ((ad->method = OBJ_nid2obj(178)) == 
# 451 "../crypto/ocsp/ocsp_ext.c" 3 4
                                                      ((void *)0)
# 451 "../crypto/ocsp/ocsp_ext.c"
                                                          )
            goto err;
        if ((ia5 = ASN1_IA5STRING_new()) == 
# 453 "../crypto/ocsp/ocsp_ext.c" 3 4
                                           ((void *)0)
# 453 "../crypto/ocsp/ocsp_ext.c"
                                               )
            goto err;
        ...
        ia5 = 
# 460 "../crypto/ocsp/ocsp_ext.c" 3 4
             ((void *)0)
# 460 "../crypto/ocsp/ocsp_ext.c"
                 ;
        if (!OPENSSL_sk_push(ossl_check_ACCESS_DESCRIPTION_sk_type(sloc->locator), ossl_check_ACCESS_DESCRIPTION_type(ad)))
            goto err;
        ad = 
# 463 "../crypto/ocsp/ocsp_ext.c" 3 4
            ((void *)0)
# 463 "../crypto/ocsp/ocsp_ext.c"
                ;
        urls++;
    }
