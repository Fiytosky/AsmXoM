# 0 "../crypto/ocsp/ocsp_cl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_cl.c"
# 10 "../crypto/ocsp/ocsp_cl.c"
...
# 20 "../crypto/ocsp/ocsp_cl.c" 2
# 30 "../crypto/ocsp/ocsp_cl.c"
OCSP_ONEREQ *OCSP_request_add0_id(OCSP_REQUEST *req, OCSP_CERTID *cid)
{
    OCSP_ONEREQ *one = 
# 32 "../crypto/ocsp/ocsp_cl.c" 3 4
                      ((void *)0)
# 32 "../crypto/ocsp/ocsp_cl.c"
                          ;

    if ((one = OCSP_ONEREQ_new()) == 
# 34 "../crypto/ocsp/ocsp_cl.c" 3 4
                                    ((void *)0)
# 34 "../crypto/ocsp/ocsp_cl.c"
                                        )
        return 
# 35 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 35 "../crypto/ocsp/ocsp_cl.c"
                  ;
    OCSP_CERTID_free(one->reqCert);
    one->reqCert = cid;
    if (req && !OPENSSL_sk_push(ossl_check_OCSP_ONEREQ_sk_type(req->tbsRequest.requestList), ossl_check_OCSP_ONEREQ_type(one))) {
        one->reqCert = 
# 39 "../crypto/ocsp/ocsp_cl.c" 3 4
                      ((void *)0)
# 39 "../crypto/ocsp/ocsp_cl.c"
                          ;
        OCSP_ONEREQ_free(one);
        return 
# 41 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 41 "../crypto/ocsp/ocsp_cl.c"
                  ;
    }
    return one;
}
...
int OCSP_request_set1_name(OCSP_REQUEST *req, const X509_NAME *nm)
{
    ...
    if (gen == 
# 51 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 51 "../crypto/ocsp/ocsp_cl.c"
                  )
        return 0;
...
# 66 "../crypto/ocsp/ocsp_cl.c" 3 4
                                 ((void *)0)
            
# 67 "../crypto/ocsp/ocsp_cl.c"
           && (req->optionalSignature = OCSP_SIGNATURE_new()) == 
# 67 "../crypto/ocsp/ocsp_cl.c" 3 4
                                                                 ((void *)0)
# 67 "../crypto/ocsp/ocsp_cl.c"
                                                                     )
        return 0;
    if (cert == 
# 69 "../crypto/ocsp/ocsp_cl.c" 3 4
               ((void *)0)
# 69 "../crypto/ocsp/ocsp_cl.c"
                   )
        return 1;
...
# 89 "../crypto/ocsp/ocsp_cl.c" 3 4
                                                          ((void *)0)
# 89 "../crypto/ocsp/ocsp_cl.c"
                                                              )
        goto err;
    if (key != 
# 91 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 91 "../crypto/ocsp/ocsp_cl.c"
                  ) {
        if (!X509_check_private_key(signer, key)) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",93,__func__), ERR_set_error)((39),(110),
# 93 "../crypto/ocsp/ocsp_cl.c" 3 4
           ((void *)0)
# 93 "../crypto/ocsp/ocsp_cl.c"
           )
                                                                    ;
            goto err;
        }
        if (!ASN1_item_sign_ex((OCSP_REQINFO_it()), &(req)->optionalSignature->signatureAlgorithm, 
# 97 "../crypto/ocsp/ocsp_cl.c" 3 4
            ((void *)0)
# 97 "../crypto/ocsp/ocsp_cl.c"
            , (req)->optionalSignature->signature, &(req)->tbsRequest, 
# 97 "../crypto/ocsp/ocsp_cl.c" 3 4
            ((void *)0)
# 97 "../crypto/ocsp/ocsp_cl.c"
            , key, dgst, signer->libctx, signer->propq))
            goto err;
    }
...
# 111 "../crypto/ocsp/ocsp_cl.c" 3 4
                            ((void *)0)
# 111 "../crypto/ocsp/ocsp_cl.c"
                                ;
    return 0;
}
...
OCSP_BASICRESP *OCSP_response_get1_basic(OCSP_RESPONSE *resp)
{
    ...
    if (rb == 
# 129 "../crypto/ocsp/ocsp_cl.c" 3 4
             ((void *)0)
# 129 "../crypto/ocsp/ocsp_cl.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",130,__func__), ERR_set_error)((39),(108),
# 130 "../crypto/ocsp/ocsp_cl.c" 3 4
       ((void *)0)
# 130 "../crypto/ocsp/ocsp_cl.c"
       );
        return 
# 131 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 131 "../crypto/ocsp/ocsp_cl.c"
                  ;
    }
    if (OBJ_obj2nid(rb->responseType) != 365) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",134,__func__), ERR_set_error)((39),(104),
# 134 "../crypto/ocsp/ocsp_cl.c" 3 4
       ((void *)0)
# 134 "../crypto/ocsp/ocsp_cl.c"
       );
        return 
# 135 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 135 "../crypto/ocsp/ocsp_cl.c"
                  ;
    }
...
{
    if (bs == 
# 160 "../crypto/ocsp/ocsp_cl.c" 3 4
             ((void *)0)
# 160 "../crypto/ocsp/ocsp_cl.c"
                 )
        return -1;
    return OPENSSL_sk_num(ossl_check_const_OCSP_SINGLERESP_sk_type(bs->tbsResponseData.responses));
}
...
{
    if (bs == 
# 168 "../crypto/ocsp/ocsp_cl.c" 3 4
             ((void *)0)
# 168 "../crypto/ocsp/ocsp_cl.c"
                 )
        return 
# 169 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 169 "../crypto/ocsp/ocsp_cl.c"
                  ;
    return ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(bs->tbsResponseData.responses), (idx)));
}
                      ...
                      const X509_NAME **pname)
{
    ...
    if (rid->type == 0) {
        ...
        *pid = 
# 191 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 191 "../crypto/ocsp/ocsp_cl.c"
                  ;
    } else if (rid->type == 1) {
        *pid = rid->value.byKey;
        *pname = 
# 194 "../crypto/ocsp/ocsp_cl.c" 3 4
                ((void *)0)
# 194 "../crypto/ocsp/ocsp_cl.c"
                    ;
    } else {
        return 0;
    }
                      ...
                      X509_NAME **pname)
{
    ...
    if (rid->type == 0) {
        ...
        *pid = 
# 209 "../crypto/ocsp/ocsp_cl.c" 3 4
              ((void *)0)
# 209 "../crypto/ocsp/ocsp_cl.c"
                  ;
    } else if (rid->type == 1) {
        *pid = ASN1_OCTET_STRING_dup(rid->value.byKey);
        *pname = 
# 212 "../crypto/ocsp/ocsp_cl.c" 3 4
                ((void *)0)
# 212 "../crypto/ocsp/ocsp_cl.c"
                    ;
    } else {
        return 0;
    }
    if (*pname == 
# 216 "../crypto/ocsp/ocsp_cl.c" 3 4
                 ((void *)0) 
# 216 "../crypto/ocsp/ocsp_cl.c"
                      && *pid == 
# 216 "../crypto/ocsp/ocsp_cl.c" 3 4
                                 ((void *)0)
# 216 "../crypto/ocsp/ocsp_cl.c"
...
int OCSP_resp_find(OCSP_BASICRESP *bs, OCSP_CERTID *id, int last)
{
    ...
    if (bs == 
# 228 "../crypto/ocsp/ocsp_cl.c" 3 4
             ((void *)0)
# 228 "../crypto/ocsp/ocsp_cl.c"
                 )
        return -1;
    if (last < 0)
        last = 0;
    ...
    for (i = last; i < OPENSSL_sk_num(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp)); i++) {
        single = ((OCSP_SINGLERESP *)OPENSSL_sk_value(ossl_check_const_OCSP_SINGLERESP_sk_type(sresp), (i)));
                            ...
                            ASN1_GENERALIZEDTIME **nextupd)
{
    ...
    if (single == 
# 256 "../crypto/ocsp/ocsp_cl.c" 3 4
                 ((void *)0)
# 256 "../crypto/ocsp/ocsp_cl.c"
                     )
        return -1;
    ...
    if (thisupd != 
# 272 "../crypto/ocsp/ocsp_cl.c" 3 4
                  ((void *)0)
# 272 "../crypto/ocsp/ocsp_cl.c"
                      )
        *thisupd = single->thisUpdate;
    if (nextupd != 
# 274 "../crypto/ocsp/ocsp_cl.c" 3 4
                  ((void *)0)
# 274 "../crypto/ocsp/ocsp_cl.c"
                      )
                          ...
                          ASN1_GENERALIZEDTIME **nextupd)
{
    ...
    if (status != 
# 297 "../crypto/ocsp/ocsp_cl.c" 3 4
                 ((void *)0)
# 297 "../crypto/ocsp/ocsp_cl.c"
                     )
        *status = i;
    return 1;
}
# 310 "../crypto/ocsp/ocsp_cl.c"
int OCSP_check_validity(ASN1_GENERALIZEDTIME *thisupd,
                        ASN1_GENERALIZEDTIME *nextupd, long nsec, long maxsec)
{
    ...
    if (!ASN1_GENERALIZEDTIME_check(thisupd)) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",319,__func__), ERR_set_error)((39),(123),
# 319 "../crypto/ocsp/ocsp_cl.c" 3 4
       ((void *)0)
# 319 "../crypto/ocsp/ocsp_cl.c"
       );
        ret = 0;
    } else {
        t_tmp = t_now + nsec;
        if (X509_cmp_time(thisupd, &t_tmp) > 0) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",324,__func__), ERR_set_error)((39),(126),
# 324 "../crypto/ocsp/ocsp_cl.c" 3 4
           ((void *)0)
# 324 "../crypto/ocsp/ocsp_cl.c"
           );
            ret = 0;
        }
        ...
        if (maxsec >= 0) {
            t_tmp = t_now - maxsec;
            if (X509_cmp_time(thisupd, &t_tmp) < 0) {
                (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",335,__func__), ERR_set_error)((39),(127),
# 335 "../crypto/ocsp/ocsp_cl.c" 3 4
               ((void *)0)
# 335 "../crypto/ocsp/ocsp_cl.c"
               );
                ret = 0;
            }
        }
    ...
    if (nextupd == 
# 341 "../crypto/ocsp/ocsp_cl.c" 3 4
                  ((void *)0)
# 341 "../crypto/ocsp/ocsp_cl.c"
                      )
        return ret;


    if (!ASN1_GENERALIZEDTIME_check(nextupd)) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",346,__func__), ERR_set_error)((39),(122),
# 346 "../crypto/ocsp/ocsp_cl.c" 3 4
       ((void *)0)
# 346 "../crypto/ocsp/ocsp_cl.c"
       );
        ret = 0;
    } else {
        t_tmp = t_now - nsec;
        if (X509_cmp_time(nextupd, &t_tmp) < 0) {
            (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",351,__func__), ERR_set_error)((39),(125),
# 351 "../crypto/ocsp/ocsp_cl.c" 3 4
           ((void *)0)
# 351 "../crypto/ocsp/ocsp_cl.c"
           );
            ret = 0;
        }
    }
    ...
    if (ASN1_STRING_cmp(nextupd, thisupd) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/ocsp/ocsp_cl.c",358,__func__), ERR_set_error)((39),(124),
# 358 "../crypto/ocsp/ocsp_cl.c" 3 4
       ((void *)0)
# 358 "../crypto/ocsp/ocsp_cl.c"
       );
        ret = 0;
    }
