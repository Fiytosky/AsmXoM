# 0 "../crypto/ocsp/ocsp_http.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_http.c"
# 10 "../crypto/ocsp/ocsp_http.c"
                                    ...
                                    const OCSP_REQUEST *req, int buf_size)
{
    ...
    if (rctx == 
# 20 "../crypto/ocsp/ocsp_http.c" 3 4
               ((void *)0)
# 20 "../crypto/ocsp/ocsp_http.c"
                   )
        return 
# 21 "../crypto/ocsp/ocsp_http.c" 3 4
              ((void *)0)
# 21 "../crypto/ocsp/ocsp_http.c"
                  ;
# 31 "../crypto/ocsp/ocsp_http.c"
    if (!OSSL_HTTP_REQ_CTX_set_request_line(rctx, 1 ,
                                            
# 32 "../crypto/ocsp/ocsp_http.c" 3 4
                                           ((void *)0)
# 32 "../crypto/ocsp/ocsp_http.c"
                                               , 
# 32 "../crypto/ocsp/ocsp_http.c" 3 4
                                                 ((void *)0)
# 32 "../crypto/ocsp/ocsp_http.c"
...
# 36 "../crypto/ocsp/ocsp_http.c" 3 4
                                       ((void *)0) 
# 36 "../crypto/ocsp/ocsp_http.c"
                                                              , 1 ,
                                        0 , 0 ))
        goto err;
    if (req != 
# 39 "../crypto/ocsp/ocsp_http.c" 3 4
              ((void *)0)
        
# 40 "../crypto/ocsp/ocsp_http.c"
 ...
 err:
    ...
    return 
# 48 "../crypto/ocsp/ocsp_http.c" 3 4
          ((void *)0)
# 48 "../crypto/ocsp/ocsp_http.c"
              ;
}
...
{
    OCSP_RESPONSE *resp = 
# 53 "../crypto/ocsp/ocsp_http.c" 3 4
                         ((void *)0)
# 53 "../crypto/ocsp/ocsp_http.c"
                             ;
    ...
    if (ctx == 
# 58 "../crypto/ocsp/ocsp_http.c" 3 4
              ((void *)0)
# 58 "../crypto/ocsp/ocsp_http.c"
                  )
        return 
# 59 "../crypto/ocsp/ocsp_http.c" 3 4
              ((void *)0)
# 59 "../crypto/ocsp/ocsp_http.c"
                  ;
    mem = OSSL_HTTP_REQ_CTX_exchange(ctx);

    resp = (OCSP_RESPONSE *)ASN1_item_d2i_bio((OCSP_RESPONSE_it()),
                                              mem, 
# 63 "../crypto/ocsp/ocsp_http.c" 3 4
                                                  ((void *)0)
# 63 "../crypto/ocsp/ocsp_http.c"
                                                      );
