# 0 "../crypto/ocsp/v3_ocsp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/v3_ocsp.c"
# 10 "../crypto/ocsp/v3_ocsp.c"
...
# 16 "../crypto/ocsp/v3_ocsp.c" 2

# 1 "../crypto/ocsp/../x509/ext_dat.h" 1
# 10 "../crypto/ocsp/../x509/ext_dat.h"
...
# 50 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 51 "../crypto/ocsp/v3_ocsp.c"
};

const X509V3_EXT_METHOD ossl_v3_ocsp_acutoff = {
    370, 0, (ASN1_GENERALIZEDTIME_it),
    0, 0, 0, 0,
    0, 0,
    0, 0,
    i2r_ocsp_acutoff, 0,
    
# 59 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 60 "../crypto/ocsp/v3_ocsp.c"
};

const X509V3_EXT_METHOD ossl_v3_crl_invdate = {
    142, 0, (ASN1_GENERALIZEDTIME_it),
    0, 0, 0, 0,
    0, 0,
    0, 0,
    i2r_ocsp_acutoff, 0,
    
# 68 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 69 "../crypto/ocsp/v3_ocsp.c"
};

const X509V3_EXT_METHOD ossl_v3_crl_hold = {
    430, 0, (ASN1_OBJECT_it),
    0, 0, 0, 0,
    0, 0,
    0, 0,
    i2r_object, 0,
    
# 77 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 78 "../crypto/ocsp/v3_ocsp.c"
};

const X509V3_EXT_METHOD ossl_v3_ocsp_nonce = {
    366, 0, 
# 81 "../crypto/ocsp/v3_ocsp.c" 3 4
                              ((void *)0)
# 81 "../crypto/ocsp/v3_ocsp.c"
                                  ,
    ocsp_nonce_new,
    ocsp_nonce_free,
    d2i_ocsp_nonce,
...
# 89 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 90 "../crypto/ocsp/v3_ocsp.c"
};
...
# 98 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 99 "../crypto/ocsp/v3_ocsp.c"
};

const X509V3_EXT_METHOD ossl_v3_ocsp_serviceloc = {
    371, 0, (OCSP_SERVICELOC_it),
    0, 0, 0, 0,
    0, 0,
    0, 0,
    i2r_ocsp_serviceloc, 0,
    
# 107 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)

# 108 "../crypto/ocsp/v3_ocsp.c"
};
...
static void *d2i_ocsp_nonce(void *a, const unsigned char **pp, long length)
{
    ...
    pos = a;
    if (pos == 
# 187 "../crypto/ocsp/v3_ocsp.c" 3 4
              ((void *)0) 
# 187 "../crypto/ocsp/v3_ocsp.c"
                   || *pos == 
# 187 "../crypto/ocsp/v3_ocsp.c" 3 4
                              ((void *)0)
# 187 "../crypto/ocsp/v3_ocsp.c"
        ...
        if (os == 
# 189 "../crypto/ocsp/v3_ocsp.c" 3 4
                 ((void *)0)
# 189 "../crypto/ocsp/v3_ocsp.c"
                     )
            goto err;
    } else {
        os = *pos;
 ...
 err:
    if ((pos == 
# 204 "../crypto/ocsp/v3_ocsp.c" 3 4
               ((void *)0)
# 204 "../crypto/ocsp/v3_ocsp.c"
                   ) || (*pos != os))
        ASN1_OCTET_STRING_free(os);
    (ERR_new(), ERR_set_debug("../crypto/ocsp/v3_ocsp.c",206,__func__), ERR_set_error)((39),((13 | (0x2 << 18L))),
# 206 "../crypto/ocsp/v3_ocsp.c" 3 4
   ((void *)0)
# 206 "../crypto/ocsp/v3_ocsp.c"
   );
    return 
# 207 "../crypto/ocsp/v3_ocsp.c" 3 4
          ((void *)0)
# 207 "../crypto/ocsp/v3_ocsp.c"
              ;
}
                               ...
                               BIO *bp, int ind)
{
    ...
    if (X509_NAME_print_ex(bp, a->issuer, 0, ((1 | 2 | 4 | 0x10 | 0x100 | 0x200) | 8 | (2 << 16) | (1 << 23) | 0)) <= 0)
        goto err;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_ACCESS_DESCRIPTION_sk_type(a->locator)); i++) {
        ad = ((ACCESS_DESCRIPTION *)OPENSSL_sk_value(ossl_check_const_ACCESS_DESCRIPTION_sk_type(a->locator), (i)));
        if (BIO_printf(bp, "\n%*s", (2 * ind), "") <= 0)
            goto err;
