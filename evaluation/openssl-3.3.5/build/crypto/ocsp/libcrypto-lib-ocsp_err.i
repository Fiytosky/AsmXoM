# 0 "../crypto/ocsp/ocsp_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ocsp/ocsp_err.c"
# 11 "../crypto/ocsp/ocsp_err.c"
...
static const ERR_STRING_DATA OCSP_str_reasons[] = {
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "certificate verify error"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "digest err"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "digest name err"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "digest size err"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "error in nextupdate field"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "error in thisupdate field"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "missing ocspsigning usage"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "nextupdate before thisupdate"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "not basic response"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "no certificates in chain"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "no response data"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "no revoked time"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "no signer key"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "private key does not match certificate"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "request not signed"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "response contains no revocation data"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "root ca not trusted"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ), "signature failure"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "signer certificate not found"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "status expired"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "status not yet valid"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ), "status too old"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "unknown message digest"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "unknown nid"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "unsupported requestorname type"},
    {0, 
# 60 "../crypto/ocsp/ocsp_err.c" 3 4
       ((void *)0)
# 60 "../crypto/ocsp/ocsp_err.c"
           }
};
...
int ossl_err_load_OCSP_strings(void)
{
    ...
    if (ERR_reason_error_string(OCSP_str_reasons[0].error) == 
# 68 "../crypto/ocsp/ocsp_err.c" 3 4
                                                             ((void *)0)
# 68 "../crypto/ocsp/ocsp_err.c"
                                                                 )
