...
# 13 "../crypto/err/err.c" 2
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stdarg.h" 1 3 4
# 14 "../crypto/err/err.c" 2
...
# 15 "../include/crypto/cryptlib.h" 2
...
# 26 "../crypto/err/err.c" 2

# 1 "../crypto/err/err_local.h" 1
# 14 "../crypto/err/err_local.h"
...
{
    if (es->err_data_flags[i] & 0x01) {
        if (deall) {
            CRYPTO_free(es->err_data[i], "../crypto/err/err_local.h", 25);
            es->err_data[i] = 
# 26 "../crypto/err/err_local.h" 3 4
                             ((void *)0)
# 26 "../crypto/err/err_local.h"
                                 ;
            es->err_data_size[i] = 0;
            es->err_data_flags[i] = 0;
        } else if (es->err_data[i] != 
# 29 "../crypto/err/err_local.h" 3 4
                                     ((void *)0)
# 29 "../crypto/err/err_local.h"
                                         ) {
            es->err_data[i][0] = '\0';
        ...
        es->err_data[i] = 
# 34 "../crypto/err/err_local.h" 3 4
                         ((void *)0)
# 34 "../crypto/err/err_local.h"
                             ;
        es->err_data_size[i] = 0;
        es->err_data_flags[i] = 0;
    }
                                      ...
                                      int lib, int reason)
{
    es->err_buffer[i] =
        lib == 2
        ? (unsigned int)(((unsigned int)0x7fffffff 
# 45 "../crypto/err/err_local.h"
                        + 1) | reason)
        : ( (((unsigned long)(lib) & 0xFF ) << 23L) | (((unsigned long)(reason) & 0X7FFFFF)) );
}
                                      ...
                                      const char *fn)
{
    ...
    CRYPTO_free(es->err_file[i], "../crypto/err/err_local.h", 57);
    if (file == 
# 58 "../crypto/err/err_local.h" 3 4
               ((void *)0) 
# 58 "../crypto/err/err_local.h"
                    || file[0] == '\0')
        es->err_file[i] = 
# 59 "../crypto/err/err_local.h" 3 4
                         ((void *)0)
# 59 "../crypto/err/err_local.h"
                             ;
    else if ((es->err_file[i] = CRYPTO_malloc(strlen(file) + 1,
                                              
# 61 "../crypto/err/err_local.h" 3 4
                                             ((void *)0)
# 61 "../crypto/err/err_local.h"
                                                 , 0)) != 
# 61 "../crypto/err/err_local.h" 3 4
                                                          ((void *)0)
# 61 "../crypto/err/err_local.h"
    ...
    es->err_line[i] = line;
    CRYPTO_free(es->err_func[i], "../crypto/err/err_local.h", 66);
    if (fn == 
# 67 "../crypto/err/err_local.h" 3 4
             ((void *)0) 
# 67 "../crypto/err/err_local.h"
                  || fn[0] == '\0')
        es->err_func[i] = 
# 68 "../crypto/err/err_local.h" 3 4
                         ((void *)0)
# 68 "../crypto/err/err_local.h"
                             ;
    else if ((es->err_func[i] = CRYPTO_malloc(strlen(fn) + 1,
                                              
# 70 "../crypto/err/err_local.h" 3 4
                                             ((void *)0)
# 70 "../crypto/err/err_local.h"
                                                 , 0)) != 
# 70 "../crypto/err/err_local.h" 3 4
                                                          ((void *)0)
# 70 "../crypto/err/err_local.h"
...
{
    if ((es->err_data_flags[i] & 0x01) != 0)
        CRYPTO_free(es->err_data[i], "../crypto/err/err_local.h", 78);
    es->err_data[i] = data;
...
static inline void err_clear(ERR_STATE *es, size_t i, int deall)
{
    ...
    es->err_buffer[i] = 0;
    es->err_line[i] = -1;
    CRYPTO_free(es->err_file[i], "../crypto/err/err_local.h", 91);
    es->err_file[i] = 
# 92 "../crypto/err/err_local.h" 3 4
                     ((void *)0)
# 92 "../crypto/err/err_local.h"
                         ;
    CRYPTO_free(es->err_func[i], "../crypto/err/err_local.h", 93);
    es->err_func[i] = 
# 94 "../crypto/err/err_local.h" 3 4
                     ((void *)0)
# 94 "../crypto/err/err_local.h"
                         ;
}
...
static ERR_STRING_DATA ERR_str_libraries[] = {
    {( (((unsigned long)(1) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "unknown library"},
    {( (((unsigned long)(2) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "system library"},
    {( (((unsigned long)(3) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "bignum routines"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "rsa routines"},
    {( (((unsigned long)(5) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "Diffie-Hellman routines"},
    {( (((unsigned long)(6) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "digital envelope routines"},
    {( (((unsigned long)(7) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "memory buffer routines"},
    {( (((unsigned long)(8) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "object identifier routines"},
    {( (((unsigned long)(9) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "PEM routines"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "dsa routines"},
    {( (((unsigned long)(11) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "x509 certificate routines"},
    {( (((unsigned long)(13) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "asn1 encoding routines"},
    {( (((unsigned long)(14) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "configuration file routines"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "common libcrypto routines"},
    {( (((unsigned long)(16) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "elliptic curve routines"},
    {( (((unsigned long)(42) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "ECDSA routines"},
    {( (((unsigned long)(43) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "ECDH routines"},
    {( (((unsigned long)(20) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "SSL routines"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "BIO routines"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "PKCS7 routines"},
    {( (((unsigned long)(34) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "X509 V3 routines"},
    {( (((unsigned long)(35) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "PKCS12 routines"},
    {( (((unsigned long)(36) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "random number generator"},
    {( (((unsigned long)(37) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "DSO support routines"},
    {( (((unsigned long)(47) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "time stamp routines"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "engine routines"},
    {( (((unsigned long)(39) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "OCSP routines"},
    {( (((unsigned long)(40) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "UI routines"},
    {( (((unsigned long)(45) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "FIPS routines"},
    {( (((unsigned long)(46) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "CMS routines"},
    {( (((unsigned long)(56) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "CRMF routines"},
    {( (((unsigned long)(58) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "CMP routines"},
    {( (((unsigned long)(48) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "HMAC routines"},
    {( (((unsigned long)(50) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "CT routines"},
    {( (((unsigned long)(51) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "ASYNC routines"},
    {( (((unsigned long)(52) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "KDF routines"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "STORE routines"},
    {( (((unsigned long)(53) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "SM2 routines"},
    {( (((unsigned long)(54) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "ESS routines"},
    {( (((unsigned long)(57) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "Provider routines"},
    {( (((unsigned long)(59) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "ENCODER routines"},
    {( (((unsigned long)(60) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "DECODER routines"},
    {( (((unsigned long)(61) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) ), "HTTP routines"},
    {0, 
# 81 "../crypto/err/err.c" 3 4
       ((void *)0)
# 81 "../crypto/err/err.c"
           },
};
...
static ERR_STRING_DATA ERR_str_reasons[] = {
    ...
    {(11 | (0x2 << 18L)), "X509 lib"},
    {(13 | (0x2 << 18L)), "ASN1 lib"},
    {(15 | (0x2 << 18L)), "CRYPTO lib"},
    {(16 | (0x2 << 18L)), "EC lib"},
    {(32 | (0x2 << 18L)), "BIO lib"},
    {(33 | (0x2 << 18L)), "PKCS7 lib"},
    {(34 | (0x2 << 18L)), "X509V3 lib"},
    {(38 | (0x2 << 18L)), "ENGINE lib"},
    {(40 | (0x2 << 18L)), "UI lib"},
    {(42 | (0x2 << 18L)), "ECDSA lib"},
    {(44 | (0x2 << 18L)), "OSSL_STORE lib"},
    {(60 | (0x2 << 18L)), "OSSL_DECODER lib"},

    {((0x1 << 18L)|(0x2 << 18L)), "fatal"},
    {(256|((0x1 << 18L)|(0x2 << 18L))), "malloc failure"},
    {(257|((0x1 << 18L)|(0x2 << 18L))),
     "called a function you should not call"},
    {(258|((0x1 << 18L)|(0x2 << 18L))), "passed a null parameter"},
    {(259|((0x1 << 18L)|(0x2 << 18L))), "internal error"},
    {(260|((0x1 << 18L)|(0x2 << 18L))), "called a function that was disabled at compile-time"},
    {(261|((0x1 << 18L)|(0x2 << 18L))), "init fail"},
    {(262|(0x2 << 18L)), "passed invalid argument"},
    {(263|((0x1 << 18L)|(0x2 << 18L))), "operation fail"},
    {(264|((0x1 << 18L)|(0x2 << 18L))), "invalid provider functions"},
    {(265|(0x2 << 18L)), "interrupted or cancelled"},
    {(266|(0x2 << 18L)), "nested asn1 error"},
    {(267|(0x2 << 18L)), "missing asn1 eos"},



    {(268|(0x2 << 18L)), "unsupported"},




    {(269|(0x2 << 18L)), "fetch failed"},
    {(270|(0x2 << 18L)), "invalid property definition"},
    {(271|((0x1 << 18L)|(0x2 << 18L))), "unable to get read lock"},
    {(272|((0x1 << 18L)|(0x2 << 18L))), "unable to get write lock"},
    {0, 
# 137 "../crypto/err/err.c" 3 4
       ((void *)0)
# 137 "../crypto/err/err.c"
           },
};


static CRYPTO_ONCE err_init = 
# 141 "../crypto/err/err.c" 3 4
                             0
# 141 "../crypto/err/err.c"
                                                    ;
static int set_err_thread_local;
static CRYPTO_THREAD_LOCAL err_thread_local;

static CRYPTO_ONCE err_string_init = 
# 145 "../crypto/err/err.c" 3 4
                                    0
# 145 "../crypto/err/err.c"
                                                           ;
static CRYPTO_RWLOCK *err_string_lock = 
# 146 "../crypto/err/err.c" 3 4
                                       ((void *)0)
# 146 "../crypto/err/err.c"
                                           ;
...
# 157 "../crypto/err/err.c" 3 4
                                                  ((void *)0)
# 157 "../crypto/err/err.c"
                                                      ;
...
{
    ERR_STRING_DATA *p = 
# 190 "../crypto/err/err.c" 3 4
                        ((void *)0)
# 190 "../crypto/err/err.c"
                            ;

    if (!CRYPTO_THREAD_read_lock(err_string_lock))
        return 
# 193 "../crypto/err/err.c" 3 4
              ((void *)0)
# 193 "../crypto/err/err.c"
                  ;
    p = ((ERR_STRING_DATA *)OPENSSL_LH_retrieve(ossl_check_ERR_STRING_DATA_lh_type(int_error_hash), ossl_check_const_ERR_STRING_DATA_lh_plain_type(d)));
...
void OSSL_ERR_STATE_free(ERR_STATE *state)
{
    ...
    if (state == 
# 205 "../crypto/err/err.c" 3 4
                ((void *)0)
# 205 "../crypto/err/err.c"
                    )
        return;
    for (i = 0; i < 16; i++) {
        err_clear(state, i, 1);
    }
    CRYPTO_free(state, "../crypto/err/err.c", 210);
}

static int do_err_strings_init(void); static int do_err_strings_init_ossl_ret_ = 0; static void do_err_strings_init_ossl_(void) { do_err_strings_init_ossl_ret_ = do_err_strings_init(); } static int do_err_strings_init(void)
{
    if (!OPENSSL_init_crypto(0x00040000L, 
# 215 "../crypto/err/err.c" 3 4
                                                    ((void *)0)
# 215 "../crypto/err/err.c"
                                                        ))
        return 0;
    err_string_lock = CRYPTO_THREAD_lock_new();
    if (err_string_lock == 
# 218 "../crypto/err/err.c" 3 4
                          ((void *)0)
# 218 "../crypto/err/err.c"
                              )
        return 0;

    int_error_hash = ((struct lhash_st_ERR_STRING_DATA *)OPENSSL_LH_set_thunks(OPENSSL_LH_new(ossl_check_ERR_STRING_DATA_lh_hashfunc_type(err_string_data_hash), ossl_check_ERR_STRING_DATA_lh_compfunc_type(err_string_data_cmp)), lh_ERR_STRING_DATA_hash_thunk, lh_ERR_STRING_DATA_comp_thunk, lh_ERR_STRING_DATA_doall_thunk, lh_ERR_STRING_DATA_doall_arg_thunk))
                                                                ;
    if (int_error_hash == 
# 223 "../crypto/err/err.c" 3 4
                         ((void *)0)
# 223 "../crypto/err/err.c"
                             ) {
        CRYPTO_THREAD_lock_free(err_string_lock);
        err_string_lock = 
# 225 "../crypto/err/err.c" 3 4
                         ((void *)0)
# 225 "../crypto/err/err.c"
                             ;
        return 0;
    }
...
void err_cleanup(void)
{
    ...
    CRYPTO_THREAD_lock_free(err_string_lock);
    err_string_lock = 
# 237 "../crypto/err/err.c" 3 4
                     ((void *)0)
# 237 "../crypto/err/err.c"
                         ;

    OPENSSL_LH_free(ossl_check_ERR_STRING_DATA_lh_type(int_error_hash));
    int_error_hash = 
# 240 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 240 "../crypto/err/err.c"
                        ;
...
{
    unsigned long plib = ( (((unsigned long)(lib) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) );
...
static int err_load_strings(const ERR_STRING_DATA *str)
{
    if (!CRYPTO_THREAD_write_lock(err_string_lock))
        return 0;
    for (; str->error; str++)
        (void)((ERR_STRING_DATA *)OPENSSL_LH_insert(ossl_check_ERR_STRING_DATA_lh_type(int_error_hash), ossl_check_ERR_STRING_DATA_lh_plain_type((ERR_STRING_DATA *)str)))
                                                              ;
    CRYPTO_THREAD_unlock(err_string_lock);
    return 1;
}
...
int ossl_err_load_ERR_strings(void)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&err_string_init, do_err_strings_init_ossl_) ? do_err_strings_init_ossl_ret_ : 0))
        return 0;
...
int ERR_unload_strings(int lib, ERR_STRING_DATA *str)
{
    ...
    for (; str->error; str++)
        (void)((ERR_STRING_DATA *)OPENSSL_LH_delete(ossl_check_ERR_STRING_DATA_lh_type(int_error_hash), ossl_check_const_ERR_STRING_DATA_lh_plain_type(str)));
    CRYPTO_THREAD_unlock(err_string_lock);
...
void ERR_clear_error(void)
{
    ...
    if (es == 
# 340 "../crypto/err/err.c" 3 4
             ((void *)0)
# 340 "../crypto/err/err.c"
                 )
        return;
...
unsigned long ERR_get_error(void)
{
    return get_error_values(EV_POP, 
# 351 "../crypto/err/err.c" 3 4
                                   ((void *)0)
# 351 "../crypto/err/err.c"
                                       , 
# 351 "../crypto/err/err.c" 3 4
                                         ((void *)0)
# 351 "../crypto/err/err.c"
...
unsigned long ERR_get_error_line(const char **file, int *line)
{
    return get_error_values(EV_POP, file, line, 
# 364 "../crypto/err/err.c" 3 4
                                               ((void *)0)
# 364 "../crypto/err/err.c"
                                                   , 
# 364 "../crypto/err/err.c" 3 4
                                                     ((void *)0)
# 364 "../crypto/err/err.c"
...
{
    return get_error_values(EV_POP, file, line, 
# 370 "../crypto/err/err.c" 3 4
                                               ((void *)0)
# 370 "../crypto/err/err.c"
                                                   , data, flags);
}
...
unsigned long ERR_peek_error(void)
{
    return get_error_values(EV_PEEK, 
# 376 "../crypto/err/err.c" 3 4
                                    ((void *)0)
# 376 "../crypto/err/err.c"
                                        , 
# 376 "../crypto/err/err.c" 3 4
                                          ((void *)0)
# 376 "../crypto/err/err.c"
...
unsigned long ERR_peek_error_line(const char **file, int *line)
{
    return get_error_values(EV_PEEK, file, line, 
# 381 "../crypto/err/err.c" 3 4
                                                ((void *)0)
# 381 "../crypto/err/err.c"
                                                    , 
# 381 "../crypto/err/err.c" 3 4
                                                      ((void *)0)
# 381 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK, 
# 386 "../crypto/err/err.c" 3 4
                                    ((void *)0)
# 386 "../crypto/err/err.c"
                                        , 
# 386 "../crypto/err/err.c" 3 4
                                          ((void *)0)
# 386 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK, 
# 391 "../crypto/err/err.c" 3 4
                                    ((void *)0)
# 391 "../crypto/err/err.c"
                                        , 
# 391 "../crypto/err/err.c" 3 4
                                          ((void *)0)
# 391 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK, file, line, 
# 405 "../crypto/err/err.c" 3 4
                                                ((void *)0)
# 405 "../crypto/err/err.c"
                                                    , data, flags);
}
...
unsigned long ERR_peek_last_error(void)
{
    return get_error_values(EV_PEEK_LAST, 
# 411 "../crypto/err/err.c" 3 4
                                         ((void *)0)
# 411 "../crypto/err/err.c"
                                             , 
# 411 "../crypto/err/err.c" 3 4
                                               ((void *)0)
# 411 "../crypto/err/err.c"
...
unsigned long ERR_peek_last_error_line(const char **file, int *line)
{
    return get_error_values(EV_PEEK_LAST, file, line, 
# 416 "../crypto/err/err.c" 3 4
                                                     ((void *)0)
# 416 "../crypto/err/err.c"
                                                         , 
# 416 "../crypto/err/err.c" 3 4
                                                           ((void *)0)
# 416 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK_LAST, 
# 421 "../crypto/err/err.c" 3 4
                                         ((void *)0)
# 421 "../crypto/err/err.c"
                                             , 
# 421 "../crypto/err/err.c" 3 4
                                               ((void *)0)
# 421 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK_LAST, 
# 426 "../crypto/err/err.c" 3 4
                                         ((void *)0)
# 426 "../crypto/err/err.c"
                                             , 
# 426 "../crypto/err/err.c" 3 4
                                               ((void *)0)
# 426 "../crypto/err/err.c"
...
{
    return get_error_values(EV_PEEK_LAST, file, line, 
# 440 "../crypto/err/err.c" 3 4
                                                     ((void *)0)
# 440 "../crypto/err/err.c"
                                                         , data, flags);
}
                                      ...
                                      const char **data, int *flags)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 454 "../crypto/err/err.c" 3 4
             ((void *)0)
# 454 "../crypto/err/err.c"
                 )
        return 0;
    ...
    while (es->bottom != es->top) {
        if (es->err_flags[es->top] & 0x02) {
            err_clear(es, es->top, 0);
            es->top = es->top > 0 ? es->top - 1 : 16 - 1;
            continue;
        }
        i = (es->bottom + 1) % 16;
        if (es->err_flags[i] & 0x02) {
            es->bottom = i;
    ...
    if (file != 
# 492 "../crypto/err/err.c" 3 4
               ((void *)0)
# 492 "../crypto/err/err.c"
                   ) {
        *file = es->err_file[i];
        if (*file == 
# 494 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 494 "../crypto/err/err.c"
                        )
            *file = "";
    }
    if (line != 
# 497 "../crypto/err/err.c" 3 4
               ((void *)0)
# 497 "../crypto/err/err.c"
                   )
        *line = es->err_line[i];
    if (func != 
# 499 "../crypto/err/err.c" 3 4
               ((void *)0)
# 499 "../crypto/err/err.c"
                   ) {
        *func = es->err_func[i];
        if (*func == 
# 501 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 501 "../crypto/err/err.c"
                        )
            *func = "";
    }
    if (flags != 
# 504 "../crypto/err/err.c" 3 4
                ((void *)0)
# 504 "../crypto/err/err.c"
                    )
        *flags = es->err_data_flags[i];
    if (data == 
# 506 "../crypto/err/err.c" 3 4
               ((void *)0)
# 506 "../crypto/err/err.c"
                   ) {
        if (g == EV_POP) {
        ...
        *data = es->err_data[i];
        if (*data == 
# 512 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 512 "../crypto/err/err.c"
                        ) {
            *data = "";
            if (flags != 
# 514 "../crypto/err/err.c" 3 4
                        ((void *)0)
# 514 "../crypto/err/err.c"
                            )
                *flags = 0;
        }
    }
                         ...
                         char *buf, size_t len)
{
    ...
    const char *ls, *rs = 
# 525 "../crypto/err/err.c" 3 4
                         ((void *)0)
# 525 "../crypto/err/err.c"
                             ;
    unsigned long l, r;
    ...
    if (ls == 
# 533 "../crypto/err/err.c" 3 4
             ((void *)0)
# 533 "../crypto/err/err.c"
                 ) {
    ...
    if ((((e) & ((unsigned int)0x7fffffff 
# 546 "../crypto/err/err.c"
       + 1)) != 0)) {
    ...
    if (rs == 
# 553 "../crypto/err/err.c" 3 4
             ((void *)0)
# 553 "../crypto/err/err.c"
                 ) {
...
char *ERR_error_string(unsigned long e, char *ret)
{
    ...
    if (ret == 
# 580 "../crypto/err/err.c" 3 4
              ((void *)0)
# 580 "../crypto/err/err.c"
                  )
        ret = buf;
...
const char *ERR_lib_error_string(unsigned long e)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&err_string_init, do_err_strings_init_ossl_) ? do_err_strings_init_ossl_ret_ : 0)) {
        return 
# 593 "../crypto/err/err.c" 3 4
              ((void *)0)
# 593 "../crypto/err/err.c"
                  ;
    }

    l = ERR_GET_LIB(e);
    d.error = ( (((unsigned long)(l) & 0xFF ) << 23L) | (((unsigned long)(0) & 0X7FFFFF)) );
    p = int_err_get_item(&d);
    return ((p == 
# 599 "../crypto/err/err.c" 3 4
                 ((void *)0)
# 599 "../crypto/err/err.c"
                     ) ? 
# 599 "../crypto/err/err.c" 3 4
                         ((void *)0) 
# 599 "../crypto/err/err.c"
...
{
    return 
# 608 "../crypto/err/err.c" 3 4
          ((void *)0)
# 608 "../crypto/err/err.c"
              ;
}
...
const char *ERR_reason_error_string(unsigned long e)
{
    ...
    ERR_STRING_DATA d, *p = 
# 615 "../crypto/err/err.c" 3 4
                           ((void *)0)
# 615 "../crypto/err/err.c"
                               ;
    unsigned long l, r;

    if (!(CRYPTO_THREAD_run_once(&err_string_init, do_err_strings_init_ossl_) ? do_err_strings_init_ossl_ret_ : 0)) {
        return 
# 619 "../crypto/err/err.c" 3 4
              ((void *)0)
# 619 "../crypto/err/err.c"
                  ;
    }
    ...
    if ((((e) & ((unsigned int)0x7fffffff 
# 627 "../crypto/err/err.c"
       + 1)) != 0))
        return 
# 628 "../crypto/err/err.c" 3 4
              ((void *)0)
# 628 "../crypto/err/err.c"
                  ;

    l = ERR_GET_LIB(e);
    r = ERR_GET_REASON(e);
    d.error = ( (((unsigned long)(l) & 0xFF ) << 23L) | (((unsigned long)(r) & 0X7FFFFF)) );
    p = int_err_get_item(&d);
    if (p == 
# 634 "../crypto/err/err.c" 3 4
            ((void *)0)
# 634 "../crypto/err/err.c"
                ) {
        d.error = ( (((unsigned long)(0) & 0xFF ) << 23L) | (((unsigned long)(r) & 0X7FFFFF)) );
        p = int_err_get_item(&d);
    }
    return ((p == 
# 638 "../crypto/err/err.c" 3 4
                 ((void *)0)
# 638 "../crypto/err/err.c"
                     ) ? 
# 638 "../crypto/err/err.c" 3 4
                         ((void *)0) 
# 638 "../crypto/err/err.c"
...
static void err_delete_thread_state(void *unused)
{
    ...
    if (state == 
# 647 "../crypto/err/err.c" 3 4
                ((void *)0)
# 647 "../crypto/err/err.c"
                    )
        return;

    CRYPTO_THREAD_set_local(&err_thread_local, 
# 650 "../crypto/err/err.c" 3 4
                                              ((void *)0)
# 650 "../crypto/err/err.c"
                                                  );
...
static int err_do_init(void); static int err_do_init_ossl_ret_ = 0; static void err_do_init_ossl_(void) { err_do_init_ossl_ret_ = err_do_init(); } static int err_do_init(void)
{
    set_err_thread_local = 1;
    return CRYPTO_THREAD_init_local(&err_thread_local, 
# 669 "../crypto/err/err.c" 3 4
                                                      ((void *)0)
# 669 "../crypto/err/err.c"
                                                          );
}
...
ERR_STATE *ossl_err_get_state_int(void)
{
    ERR_STATE *state;
    int saveerrno = 
# 675 "../crypto/err/err.c" 3 4
                   (*__errno_location ())
# 675 "../crypto/err/err.c"
                                       ;

    if (!OPENSSL_init_crypto(0x00040000L, 
# 677 "../crypto/err/err.c" 3 4
                                                    ((void *)0)
# 677 "../crypto/err/err.c"
                                                        ))
        return 
# 678 "../crypto/err/err.c" 3 4
              ((void *)0)
# 678 "../crypto/err/err.c"
                  ;

    if (!(CRYPTO_THREAD_run_once(&err_init, err_do_init_ossl_) ? err_do_init_ossl_ret_ : 0))
        return 
# 681 "../crypto/err/err.c" 3 4
              ((void *)0)
# 681 "../crypto/err/err.c"
                  ;

    state = CRYPTO_THREAD_get_local(&err_thread_local);
    if (state == (ERR_STATE*)-1)
        return 
# 685 "../crypto/err/err.c" 3 4
              ((void *)0)
# 685 "../crypto/err/err.c"
                  ;

    if (state == 
# 687 "../crypto/err/err.c" 3 4
                ((void *)0)
# 687 "../crypto/err/err.c"
                    ) {
        if (!CRYPTO_THREAD_set_local(&err_thread_local, (ERR_STATE*)-1))
            return 
# 689 "../crypto/err/err.c" 3 4
                  ((void *)0)
# 689 "../crypto/err/err.c"
                      ;

        state = OSSL_ERR_STATE_new();
        if (state == 
# 692 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 692 "../crypto/err/err.c"
                        ) {
            CRYPTO_THREAD_set_local(&err_thread_local, 
# 693 "../crypto/err/err.c" 3 4
                                                      ((void *)0)
# 693 "../crypto/err/err.c"
                                                          );
            return 
# 694 "../crypto/err/err.c" 3 4
                  ((void *)0)
# 694 "../crypto/err/err.c"
                      ;
        }

        if (!ossl_init_thread_start(
# 697 "../crypto/err/err.c" 3 4
                                   ((void *)0)
# 697 "../crypto/err/err.c"
                                       , 
# 697 "../crypto/err/err.c" 3 4
                                         ((void *)0)
# 697 "../crypto/err/err.c"
            ...
            OSSL_ERR_STATE_free(state);
            CRYPTO_THREAD_set_local(&err_thread_local, 
# 700 "../crypto/err/err.c" 3 4
                                                      ((void *)0)
# 700 "../crypto/err/err.c"
                                                          );
            return 
# 701 "../crypto/err/err.c" 3 4
                  ((void *)0)
# 701 "../crypto/err/err.c"
                      ;
        }


        OPENSSL_init_crypto(0x00000002L, 
# 705 "../crypto/err/err.c" 3 4
                                                             ((void *)0)
# 705 "../crypto/err/err.c"
                                                                 );
    }

    
# 708 "../crypto/err/err.c" 3 4
   (*__errno_location ())
# 708 "../crypto/err/err.c"
   =(saveerrno);
    return state;
}
...
{
    int saveerrno = 
# 726 "../crypto/err/err.c" 3 4
                   (*__errno_location ())
# 726 "../crypto/err/err.c"
                                       ;
# 740 "../crypto/err/err.c"
    if (!OPENSSL_init_crypto(0x00040000L, 
# 740 "../crypto/err/err.c" 3 4
                                                    ((void *)0)
# 740 "../crypto/err/err.c"
                                                        ))
        return 0;
...
# 750 "../crypto/err/err.c" 3 4
   (*__errno_location ())
# 750 "../crypto/err/err.c"
   =(saveerrno);
    return 1;
}
                                  ...
                                  int deallocate)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 784 "../crypto/err/err.c" 3 4
             ((void *)0)
# 784 "../crypto/err/err.c"
                 )
        return 0;
...
# 815 "../crypto/err/err.c" 3 4
   __builtin_c23_va_start(
# 815 "../crypto/err/err.c"
   args, num
# 815 "../crypto/err/err.c" 3 4
   )
# 815 "../crypto/err/err.c"
...
# 817 "../crypto/err/err.c" 3 4
   __builtin_va_end(
# 817 "../crypto/err/err.c"
   args
# 817 "../crypto/err/err.c" 3 4
   )
# 817 "../crypto/err/err.c"
...
void ERR_add_error_vdata(int num, va_list args)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 829 "../crypto/err/err.c" 3 4
             ((void *)0)
# 829 "../crypto/err/err.c"
                 )
        return;
    i = es->top;
    ...
    if ((es->err_data_flags[i] & flags) == flags
            && __builtin_expect(!!((es->err_data[i] != 
# 838 "../crypto/err/err.c" 3 4
              ((void *)0)
# 838 "../crypto/err/err.c"
              ) != 0), 1)) {
        str = es->err_data[i];
        size = es->err_data_size[i];
# 849 "../crypto/err/err.c"
        es->err_data[i] = 
# 849 "../crypto/err/err.c" 3 4
                         ((void *)0)
# 849 "../crypto/err/err.c"
                             ;
        es->err_data_flags[i] = 0;
    } else if ((str = CRYPTO_malloc(size = 81, "../crypto/err/err.c", 851)) == 
# 851 "../crypto/err/err.c" 3 4
                                                   ((void *)0)
# 851 "../crypto/err/err.c"
                                                       ) {
        return;
    } else {
        str[0] = '\0';
    ...
    while (--num >= 0) {
        arg = 
# 859 "../crypto/err/err.c" 3 4
             __builtin_va_arg(
# 859 "../crypto/err/err.c"
             args
# 859 "../crypto/err/err.c" 3 4
             ,
# 859 "../crypto/err/err.c"
...
# 859 "../crypto/err/err.c"
                                 ;
        if (arg == 
# 860 "../crypto/err/err.c" 3 4
                  ((void *)0)
# 860 "../crypto/err/err.c"
                      )
            arg = "<NULL>";
        len += strlen(arg);
        if (len >= size) {
            ...
            size = len + 20;
            p = CRYPTO_realloc(str, size, "../crypto/err/err.c", 867);
            if (p == 
# 868 "../crypto/err/err.c" 3 4
                    ((void *)0)
# 868 "../crypto/err/err.c"
                        ) {
                CRYPTO_free(str, "../crypto/err/err.c", 869);
                return;
            }
            str = p;
        }
    ...
    if (!err_set_error_data_int(str, size, flags, 0))
        CRYPTO_free(str, "../crypto/err/err.c", 877);
}
...
void err_clear_last_constant_time(int clear)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 886 "../crypto/err/err.c" 3 4
             ((void *)0)
# 886 "../crypto/err/err.c"
                 )
        return;
