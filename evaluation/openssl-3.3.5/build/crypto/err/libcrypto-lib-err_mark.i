# 0 "../crypto/err/err_mark.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/err/err_mark.c"
# 12 "../crypto/err/err_mark.c"
...
int ERR_set_mark(void)
{
    ...
    if (es == 
# 20 "../crypto/err/err_mark.c" 3 4
             ((void *)0)
# 20 "../crypto/err/err_mark.c"
                 )
        return 0;
...
int ERR_pop(void)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 34 "../crypto/err/err_mark.c" 3 4
             ((void *)0) 
# 34 "../crypto/err/err_mark.c"
                  || es->bottom == es->top)
        return 0;
...
int ERR_pop_to_mark(void)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 47 "../crypto/err/err_mark.c" 3 4
             ((void *)0)
# 47 "../crypto/err/err_mark.c"
                 )
        return 0;
...
int ERR_count_to_mark(void)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 68 "../crypto/err/err_mark.c" 3 4
             ((void *)0)
# 68 "../crypto/err/err_mark.c"
                 )
        return 0;
...
int ERR_clear_last_mark(void)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 87 "../crypto/err/err_mark.c" 3 4
             ((void *)0)
# 87 "../crypto/err/err_mark.c"
                 )
        return 0;
