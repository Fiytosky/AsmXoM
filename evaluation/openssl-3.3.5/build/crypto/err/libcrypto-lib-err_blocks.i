# 0 "../crypto/err/err_blocks.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/err/err_blocks.c"
# 12 "../crypto/err/err_blocks.c"
...
void ERR_new(void)
{
    ...
    if (es == 
# 21 "../crypto/err/err_blocks.c" 3 4
             ((void *)0)
# 21 "../crypto/err/err_blocks.c"
                 )
        return;
...
void ERR_set_debug(const char *file, int line, const char *func)
{
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 34 "../crypto/err/err_blocks.c" 3 4
             ((void *)0)
# 34 "../crypto/err/err_blocks.c"
                 )
        return;
...
# 44 "../crypto/err/err_blocks.c" 3 4
   __builtin_c23_va_start(
# 44 "../crypto/err/err_blocks.c"
   args, fmt
# 44 "../crypto/err/err_blocks.c" 3 4
   )
# 44 "../crypto/err/err_blocks.c"
...
# 46 "../crypto/err/err_blocks.c" 3 4
   __builtin_va_end(
# 46 "../crypto/err/err_blocks.c"
   args
# 46 "../crypto/err/err_blocks.c" 3 4
   )
# 46 "../crypto/err/err_blocks.c"
...
void ERR_vset_error(int lib, int reason, const char *fmt, va_list args)
{
    ERR_STATE *es;
    char *buf = 
# 52 "../crypto/err/err_blocks.c" 3 4
               ((void *)0)
# 52 "../crypto/err/err_blocks.c"
                   ;
    size_t buf_size = 0;
    ...
    es = ossl_err_get_state_int();
    if (es == 
# 58 "../crypto/err/err_blocks.c" 3 4
             ((void *)0)
# 58 "../crypto/err/err_blocks.c"
                 )
        return;
    i = es->top;

    if (fmt != 
# 62 "../crypto/err/err_blocks.c" 3 4
              ((void *)0)
# 62 "../crypto/err/err_blocks.c"
                  ) {
        int printed_len = 0;
        char *rbuf = 
# 64 "../crypto/err/err_blocks.c" 3 4
                    ((void *)0)
# 64 "../crypto/err/err_blocks.c"
                        ;

        buf = es->err_data[i];
        buf_size = es->err_data_size[i];
# 76 "../crypto/err/err_blocks.c"
        es->err_data[i] = 
# 76 "../crypto/err/err_blocks.c" 3 4
                         ((void *)0)
# 76 "../crypto/err/err_blocks.c"
                             ;
        es->err_data_flags[i] = 0;
        ...
        if (buf_size < 1024
            && (rbuf = CRYPTO_realloc(buf, 1024, "../crypto/err/err_blocks.c", 84)) != 
# 84 "../crypto/err/err_blocks.c" 3 4
                                                                  ((void *)0)
# 84 "../crypto/err/err_blocks.c"
                                                                      ) {
            buf = rbuf;
            buf_size = 1024;
        }
        ...
        if (buf != 
# 89 "../crypto/err/err_blocks.c" 3 4
                  ((void *)0)
# 89 "../crypto/err/err_blocks.c"
                      ) {
        ...
        if (printed_len < 0)
            printed_len = 0;
        if (buf != 
# 94 "../crypto/err/err_blocks.c" 3 4
                  ((void *)0)
# 94 "../crypto/err/err_blocks.c"
                      )
            buf[printed_len] = '\0';
        ...
        if ((rbuf = CRYPTO_realloc(buf, printed_len + 1, "../crypto/err/err_blocks.c", 103)) != 
# 103 "../crypto/err/err_blocks.c" 3 4
                                                             ((void *)0)
# 103 "../crypto/err/err_blocks.c"
                                                                 ) {
            buf = rbuf;
        ...
        if (buf != 
# 109 "../crypto/err/err_blocks.c" 3 4
                  ((void *)0)
# 109 "../crypto/err/err_blocks.c"
                      )
            flags = 0x01 | 0x02;
    }
    ...
    if (fmt != 
# 115 "../crypto/err/err_blocks.c" 3 4
              ((void *)0)
# 115 "../crypto/err/err_blocks.c"
                  )
