# 0 "../crypto/err/err_save.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/err/err_save.c"
# 12 "../crypto/err/err_save.c"
...
# 13 "../crypto/err/err_save.c" 2
# 1 "../crypto/err/err_local.h" 1
# 10 "../crypto/err/err_local.h"
...
ERR_STATE *OSSL_ERR_STATE_new(void)
{
    return CRYPTO_zalloc(sizeof(ERR_STATE), 
# 23 "../crypto/err/err_save.c" 3 4
                                           ((void *)0)
# 23 "../crypto/err/err_save.c"
                                               , 0);
}
...
void OSSL_ERR_STATE_save(ERR_STATE *es)
{
    ...
    if (es == 
# 31 "../crypto/err/err_save.c" 3 4
             ((void *)0)
# 31 "../crypto/err/err_save.c"
                 )
        return;
    ...
    if (thread_es == 
# 38 "../crypto/err/err_save.c" 3 4
                    ((void *)0)
# 38 "../crypto/err/err_save.c"
                        )
        return;
...
void OSSL_ERR_STATE_save_to_mark(ERR_STATE *es)
{
    ...
    if (es == 
# 52 "../crypto/err/err_save.c" 3 4
             ((void *)0)
# 52 "../crypto/err/err_save.c"
                 )
        return;

    thread_es = ossl_err_get_state_int();
    if (thread_es == 
# 56 "../crypto/err/err_save.c" 3 4
                    ((void *)0)
# 56 "../crypto/err/err_save.c"
                        ) {
        for (i = 0; i < 16; ++i)
            err_clear(es, i, 1);
    ...
    for (i = 0, j = top; i < count; ++i) {
        ...
        thread_es->err_data[j] = 
# 90 "../crypto/err/err_save.c" 3 4
                                      ((void *)0)
# 90 "../crypto/err/err_save.c"
                                          ;
        thread_es->err_data_size[j] = 0;
        thread_es->err_data_flags[j] = 0;
        thread_es->err_file[j] = 
# 93 "../crypto/err/err_save.c" 3 4
                                      ((void *)0)
# 93 "../crypto/err/err_save.c"
                                          ;
        thread_es->err_line[j] = 0;
        thread_es->err_func[j] = 
# 95 "../crypto/err/err_save.c" 3 4
                                      ((void *)0)
# 95 "../crypto/err/err_save.c"
                                          ;
    }
...
void OSSL_ERR_STATE_restore(const ERR_STATE *es)
{
    ...
    if (es == 
# 118 "../crypto/err/err_save.c" 3 4
             ((void *)0) 
# 118 "../crypto/err/err_save.c"
                  || es->bottom == es->top)
        return;

    thread_es = ossl_err_get_state_int();
    if (thread_es == 
# 122 "../crypto/err/err_save.c" 3 4
                    ((void *)0)
# 122 "../crypto/err/err_save.c"
                        )
        return;
    ...
    for (i = (size_t)es->bottom; i != (size_t)es->top;) {
        ...
        if (es->err_data[i] != 
# 142 "../crypto/err/err_save.c" 3 4
                              ((void *)0) 
# 142 "../crypto/err/err_save.c"
                                   && es->err_data_size[i] != 0) {
            void *data;
            size_t data_sz = es->err_data_size[i];

            data = CRYPTO_malloc(data_sz, 
# 146 "../crypto/err/err_save.c" 3 4
                                         ((void *)0)
# 146 "../crypto/err/err_save.c"
                                             , 0);
            if (data != 
# 147 "../crypto/err/err_save.c" 3 4
                       ((void *)0)
# 147 "../crypto/err/err_save.c"
                           ) {
