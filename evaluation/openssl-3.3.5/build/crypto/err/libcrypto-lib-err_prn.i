# 0 "../crypto/err/err_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/err/err_prn.c"
# 12 "../crypto/err/err_prn.c"
                         ...
                         void *u)
{
    ...
    while ((l = ERR_get_error_all(&file, &line, &func, &data, &flags)) != 0) {
        char buf[4096] = "";
        char *hex = 
# 30 "../crypto/err/err_prn.c" 3 4
                   ((void *)0)
# 30 "../crypto/err/err_prn.c"
                       ;
        int offset;
        ...
        BIO_snprintf(buf, sizeof(buf), "%s:", hex == 
# 37 "../crypto/err/err_prn.c" 3 4
                                                    ((void *)0) 
# 37 "../crypto/err/err_prn.c"
                                                         ? "<null>" : hex);
        offset = strlen(buf);
        ...
        BIO_snprintf(buf + offset, sizeof(buf) - offset, ":%s:%d:%s\n",
                     file, line, data);
        CRYPTO_free(hex, "../crypto/err/err_prn.c", 43);
...
# 55 "../crypto/err/err_prn.c" 3 4
                              ((void *)0) 
# 55 "../crypto/err/err_prn.c"
                                                                     );
}
...
{
    const char *file = 
# 62 "../crypto/err/err_prn.c" 3 4
                      ((void *)0)
# 62 "../crypto/err/err_prn.c"
                          ;
    int line;
    const char *func = 
# 64 "../crypto/err/err_prn.c" 3 4
                      ((void *)0)
# 64 "../crypto/err/err_prn.c"
                          ;
    const char *data = 
# 65 "../crypto/err/err_prn.c" 3 4
                      ((void *)0)
# 65 "../crypto/err/err_prn.c"
                          ;
    int flags;
    unsigned long err = ERR_peek_last_error();

    if (separator == 
# 69 "../crypto/err/err_prn.c" 3 4
                    ((void *)0)
# 69 "../crypto/err/err_prn.c"
                        )
        separator = "";
    if (err == 0)
        put_error(1, 
# 72 "../crypto/err/err_prn.c" 3 4
                               ((void *)0)
# 72 "../crypto/err/err_prn.c"
                                   , 0, "", 0);
    ...
    do {
        ...
        if (data_len >= (4096 - 100)
                || strlen(separator) >= (size_t)((4096 - 100) - data_len))
            available_len = 0;
        else
            available_len = (4096 - 100) - data_len - strlen(separator) - 1;
        ...
        if (*separator == '\0') {
            ...
            if (len_next <= available_len) {
                next += len_next;
                curr = 
# 101 "../crypto/err/err_prn.c" 3 4
                      ((void *)0)
# 101 "../crypto/err/err_prn.c"
                          ;
            } else {
                next += available_len;
                curr = next;
            ...
            while (*next != '\0' && (size_t)(next - txt) <= available_len) {
                ...
                if (next != 
# 110 "../crypto/err/err_prn.c" 3 4
                           ((void *)0)
# 110 "../crypto/err/err_prn.c"
                               ) {
            ...
            if ((size_t)(next - txt) <= available_len)
                curr = 
# 118 "../crypto/err/err_prn.c" 3 4
                      ((void *)0)
# 118 "../crypto/err/err_prn.c"
                          ;
        }
        if (curr != 
# 120 "../crypto/err/err_prn.c" 3 4
                   ((void *)0)
# 120 "../crypto/err/err_prn.c"
                       ) {

            if (curr != txt) {
                tmp = CRYPTO_strndup(txt, curr - txt, "../crypto/err/err_prn.c", 123);
                if (tmp == 
# 124 "../crypto/err/err_prn.c" 3 4
                          ((void *)0)
# 124 "../crypto/err/err_prn.c"
                              )
                    return;
                ERR_add_error_data(2, separator, tmp);
                CRYPTO_free(tmp, "../crypto/err/err_prn.c", 127);
            }
            put_error(ERR_GET_LIB(err), func, err, file, line);
            txt = curr;
        } else {
            if (trailing_separator) {
                tmp = CRYPTO_strndup(txt, next - strlen(separator) - txt, "../crypto/err/err_prn.c", 133);
                if (tmp == 
# 134 "../crypto/err/err_prn.c" 3 4
                          ((void *)0)
# 134 "../crypto/err/err_prn.c"
                              )
                    return;

                ERR_add_error_data(2, leading_separator, tmp);
                CRYPTO_free(tmp, "../crypto/err/err_prn.c", 138);
            } else {
...
{
    if (bio != 
# 149 "../crypto/err/err_prn.c" 3 4
              ((void *)0)
# 149 "../crypto/err/err_prn.c"
                  ) {
        char *str;
        long len = BIO_ctrl(bio,3,0,(char *)(&str));
...
void ERR_print_errors_fp(FILE *fp)
{
    BIO *bio = BIO_new_fp(fp, 0x00);
    if (bio == 
# 180 "../crypto/err/err_prn.c" 3 4
              ((void *)0)
# 180 "../crypto/err/err_prn.c"
                  )
        return;
