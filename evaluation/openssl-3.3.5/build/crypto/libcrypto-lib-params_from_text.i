# 0 "../crypto/params_from_text.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/params_from_text.c"
# 11 "../crypto/params_from_text.c"
...
# 12 "../crypto/params_from_text.c" 2
# 1 "../include/openssl/ebcdic.h" 1
...
# 13 "../crypto/params_from_text.c" 2
...
# 14 "../crypto/params_from_text.c" 2
...
# 15 "../crypto/params_from_text.c" 2
# 24 "../crypto/params_from_text.c"
                             ...
                             size_t *buf_n, BIGNUM **tmpbn, int *found)
{
    ...
    *ishex = ((strncmp(key, "hex" "", sizeof("hex") - 1) == 0) ? ((key) += sizeof("hex") - 1, 1) : 0);

    p = *paramdef = OSSL_PARAM_locate_const(paramdefs, key);
    if (found != 
# 41 "../crypto/params_from_text.c" 3 4
                ((void *)0)
# 41 "../crypto/params_from_text.c"
                    )
        *found = p != 
# 42 "../crypto/params_from_text.c" 3 4
                     ((void *)0)
# 42 "../crypto/params_from_text.c"
                         ;
    if (p == 
# 43 "../crypto/params_from_text.c" 3 4
            ((void *)0)
# 43 "../crypto/params_from_text.c"
                )
        return 0;
    ...
    case 2:
        ...
        if (r == 0 || *tmpbn == 
# 54 "../crypto/params_from_text.c" 3 4
                               ((void *)0)
# 54 "../crypto/params_from_text.c"
                                   )
            return 0;

        if (p->data_type == 2
            && BN_is_negative(*tmpbn)) {
            (ERR_new(), ERR_set_debug("../crypto/params_from_text.c",59,__func__), ERR_set_error)((15),(122),
# 59 "../crypto/params_from_text.c" 3 4
           ((void *)0)
# 59 "../crypto/params_from_text.c"
           );
            return 0;
        }
# 73 "../crypto/params_from_text.c"
        if (p->data_type == 1 && BN_is_negative(*tmpbn)
            && !BN_add_word(*tmpbn, 1)) {
            return 0;
        }

        buf_bits = (size_t)BN_num_bits(*tmpbn);
# 90 "../crypto/params_from_text.c"
        if (p->data_type == 1 && buf_bits % 8 == 0)
            buf_bits += 8;
        ...
        *buf_n = (buf_bits + 7) / 8;
        ...
        if (p->data_size > 0) {
            if (buf_bits > p->data_size * 8) {
                (ERR_new(), ERR_set_debug("../crypto/params_from_text.c",101,__func__), ERR_set_error)((15),(116),
# 101 "../crypto/params_from_text.c" 3 4
               ((void *)0)
# 101 "../crypto/params_from_text.c"
               );
    ...
    case 4:
        if (*ishex) {
            (ERR_new(), ERR_set_debug("../crypto/params_from_text.c",111,__func__), ERR_set_error)((15),((262|(0x2 << 18L))),
# 111 "../crypto/params_from_text.c" 3 4
           ((void *)0)
# 111 "../crypto/params_from_text.c"
           );
            return 0;
        }
    ...
    case 5:
        if (*ishex) {
            ...
            if ((hexdigits % 2) != 0) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/params_from_text.c",121,__func__), ERR_set_error)((15),(103),
# 121 "../crypto/params_from_text.c" 3 4
               ((void *)0)
# 121 "../crypto/params_from_text.c"
               );
                return 0;
            }
            *buf_n = hexdigits >> 1;
...
{
    if (buf == 
# 138 "../crypto/params_from_text.c" 3 4
              ((void *)0)
# 138 "../crypto/params_from_text.c"
                  )
        return 0;
...
# 205 "../crypto/params_from_text.c" 3 4
                                ((void *)0)
# 205 "../crypto/params_from_text.c"
                                    ;
    int ishex = 0;
    void *buf = 
# 207 "../crypto/params_from_text.c" 3 4
               ((void *)0)
# 207 "../crypto/params_from_text.c"
                   ;
    size_t buf_n = 0;
    BIGNUM *tmpbn = 
# 209 "../crypto/params_from_text.c" 3 4
                   ((void *)0)
# 209 "../crypto/params_from_text.c"
                       ;
    int ok = 0;

    if (to == 
# 212 "../crypto/params_from_text.c" 3 4
             ((void *)0) 
# 212 "../crypto/params_from_text.c"
                  || paramdefs == 
# 212 "../crypto/params_from_text.c" 3 4
                                  ((void *)0)
# 212 "../crypto/params_from_text.c"
    ...
    if ((buf = CRYPTO_zalloc(buf_n > 0 ? buf_n : 1, "../crypto/params_from_text.c", 219)) == 
# 219 "../crypto/params_from_text.c" 3 4
                                                        ((void *)0)
# 219 "../crypto/params_from_text.c"
                                                            )
        goto err;
    ...
    BN_free(tmpbn);
    if (!ok)
        CRYPTO_free(buf, "../crypto/params_from_text.c", 226);
    return ok;
 err:
    BN_free(tmpbn);
    return 0;
