# 0 "../crypto/mdc2/mdc2_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/mdc2/mdc2_one.c"
# 14 "../crypto/mdc2/mdc2_one.c"
...
unsigned char *MDC2(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 25 "../crypto/mdc2/mdc2_one.c" 3 4
             ((void *)0)
# 25 "../crypto/mdc2/mdc2_one.c"
                 )
        md = m;
    if (!MDC2_Init(&c))
        return 
# 28 "../crypto/mdc2/mdc2_one.c" 3 4
              ((void *)0)
# 28 "../crypto/mdc2/mdc2_one.c"
                  ;
    MDC2_Update(&c, d, n);
    MDC2_Final(md, &c);
