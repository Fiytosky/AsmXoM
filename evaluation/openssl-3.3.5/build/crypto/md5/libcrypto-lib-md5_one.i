# 0 "../crypto/md5/md5_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/md5/md5_one.c"
# 14 "../crypto/md5/md5_one.c"
...
unsigned char *MD5(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 30 "../crypto/md5/md5_one.c" 3 4
             ((void *)0)
# 30 "../crypto/md5/md5_one.c"
                 )
        md = m;
    if (!MD5_Init(&c))
        return 
# 33 "../crypto/md5/md5_one.c" 3 4
              ((void *)0)
# 33 "../crypto/md5/md5_one.c"
                  ;

    MD5_Update(&c, d, n);
# 50 "../crypto/md5/md5_one.c"
    MD5_Final(md, &c);
