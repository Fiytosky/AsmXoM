# 0 "../crypto/md5/md5_dgst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/md5/md5_dgst.c"
# 14 "../crypto/md5/md5_dgst.c"
...
# 17 "../crypto/md5/md5_dgst.c" 2
# 1 "../crypto/md5/md5_local.h" 1
# 10 "../crypto/md5/md5_local.h"
...
# 14 "../crypto/md5/md5_local.h" 2
# 28 "../crypto/md5/md5_local.h"
void ossl_md5_block_asm_data_order(MD5_CTX *c, const void *p, size_t num);
# 47 "../crypto/md5/md5_local.h"
...
int MD5_Update(MD5_CTX *c, const void *data_, size_t len)
{
    ...
    if (n != 0) {
        ...
        if (len >= 64 || len + n >= 64) {
            ...
            ossl_md5_block_asm_data_order(c, p, 1);
            n = 64 - n;
            data += n;
            len -= n;
            c->num = 0;
    ...
    n = len / 64;
    if (n > 0) {
        ossl_md5_block_asm_data_order(c, data, n);
        n *= 64;
        data += n;
        len -= n;
    }
...
{
    ossl_md5_block_asm_data_order(c, data, 1);
}
...
# 48 "../crypto/md5/md5_local.h" 2
# 18 "../crypto/md5/md5_dgst.c" 2
# 29 "../crypto/md5/md5_dgst.c"
