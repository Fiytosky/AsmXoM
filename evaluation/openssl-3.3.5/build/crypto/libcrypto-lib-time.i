...
# 35 "../crypto/time.c"
    ...
    if (gettimeofday(&t, 
# 37 "../crypto/time.c" 3 4
                        ((void *)0)
# 37 "../crypto/time.c"
                            ) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/time.c",38,__func__), ERR_set_error)(2, 
# 38 "../crypto/time.c" 3 4
                                   (*__errno_location ())
# 38 "../crypto/time.c"
                                                       ,
    ...
    if (t.tv_sec <= 0)
        r.t = t.tv_usec <= 0 ? 0 : t.tv_usec * ((((uint64_t)1000000000) / 1000) / 1000);
    else
        r.t = ((uint64_t)t.tv_sec * 1000000 + t.tv_usec) * ((((uint64_t)1000000000) / 1000) / 1000);
