# 0 "../crypto/store/store_strings.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/store/store_strings.c"
# 10 "../crypto/store/store_strings.c"
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 11 "../crypto/store/store_strings.c" 2
...
const char *OSSL_STORE_INFO_type_string(int type)
{
    ...
    if (type < 1 || type > types)
        return 
# 26 "../crypto/store/store_strings.c" 3 4
              ((void *)0)
# 26 "../crypto/store/store_strings.c"
                  ;
