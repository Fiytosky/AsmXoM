# 0 "../crypto/store/store_result.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/store/store_result.c"
# 10 "../crypto/store/store_result.c"
...
# 11 "../crypto/store/store_result.c" 2
...
# 17 "../crypto/store/store_result.c" 2
...
# 18 "../crypto/store/store_result.c" 2
...
# 19 "../crypto/store/store_result.c" 2
...
# 20 "../crypto/store/store_result.c" 2
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 21 "../crypto/store/store_result.c" 2
...
# 22 "../crypto/store/store_result.c" 2
...
# 23 "../crypto/store/store_result.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 24 "../crypto/store/store_result.c" 2
...
struct stack_st_X509_ATTRIBUTE *ossl_x509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x,
                                                       ...
                                                       const unsigned char *bytes,
                                                       int len);
# 25 "../crypto/store/store_result.c" 2
# 1 "../crypto/store/store_local.h" 1
# 11 "../crypto/store/store_local.h"
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 12 "../crypto/store/store_local.h" 2
...
# 15 "../crypto/store/store_local.h" 2
# 26 "../crypto/store/store_local.h"
...
struct stack_st_OSSL_STORE_INFO; typedef int (*sk_OSSL_STORE_INFO_compfunc)(const OSSL_STORE_INFO * const *a, const OSSL_STORE_INFO *const *b); typedef void (*sk_OSSL_STORE_INFO_freefunc)(OSSL_STORE_INFO *a); typedef OSSL_STORE_INFO * (*sk_OSSL_STORE_INFO_copyfunc)(const OSSL_STORE_INFO *a); static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_num(const struct stack_st_OSSL_STORE_INFO *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_value(const struct stack_st_OSSL_STORE_INFO *sk, int idx) { return (OSSL_STORE_INFO *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_INFO *sk_OSSL_STORE_INFO_new(sk_OSSL_STORE_INFO_compfunc compare) { return (struct stack_st_OSSL_STORE_INFO *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_INFO *sk_OSSL_STORE_INFO_new_null(void) { return (struct stack_st_OSSL_STORE_INFO *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_INFO *sk_OSSL_STORE_INFO_new_reserve(sk_OSSL_STORE_INFO_compfunc compare, int n) { return (struct stack_st_OSSL_STORE_INFO *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_reserve(struct stack_st_OSSL_STORE_INFO *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_OSSL_STORE_INFO_free(struct stack_st_OSSL_STORE_INFO *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_STORE_INFO_zero(struct stack_st_OSSL_STORE_INFO *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_delete(struct stack_st_OSSL_STORE_INFO *sk, int i) { return (OSSL_STORE_INFO *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_delete_ptr(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr) { return (OSSL_STORE_INFO *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_push(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_unshift(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_pop(struct stack_st_OSSL_STORE_INFO *sk) { return (OSSL_STORE_INFO *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_shift(struct stack_st_OSSL_STORE_INFO *sk) { return (OSSL_STORE_INFO *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_OSSL_STORE_INFO_pop_free(struct stack_st_OSSL_STORE_INFO *sk, sk_OSSL_STORE_INFO_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_insert(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline OSSL_STORE_INFO *sk_OSSL_STORE_INFO_set(struct stack_st_OSSL_STORE_INFO *sk, int idx, OSSL_STORE_INFO *ptr) { return (OSSL_STORE_INFO *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_find(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_find_ex(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_find_all(struct stack_st_OSSL_STORE_INFO *sk, OSSL_STORE_INFO *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_OSSL_STORE_INFO_sort(struct stack_st_OSSL_STORE_INFO *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_OSSL_STORE_INFO_is_sorted(const struct stack_st_OSSL_STORE_INFO *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_INFO * sk_OSSL_STORE_INFO_dup(const struct stack_st_OSSL_STORE_INFO *sk) { return (struct stack_st_OSSL_STORE_INFO *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_OSSL_STORE_INFO *sk_OSSL_STORE_INFO_deep_copy(const struct stack_st_OSSL_STORE_INFO *sk, sk_OSSL_STORE_INFO_copyfunc copyfunc, sk_OSSL_STORE_INFO_freefunc freefunc) { return (struct stack_st_OSSL_STORE_INFO *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_OSSL_STORE_INFO_compfunc sk_OSSL_STORE_INFO_set_cmp_func(struct stack_st_OSSL_STORE_INFO *sk, sk_OSSL_STORE_INFO_compfunc compare) { return (sk_OSSL_STORE_INFO_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
struct lhash_st_OSSL_STORE_LOADER { union lh_OSSL_STORE_LOADER_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_OSSL_STORE_LOADER_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const OSSL_STORE_LOADER *) = (unsigned long (*)(const OSSL_STORE_LOADER *))hfn; return hfn_conv((const OSSL_STORE_LOADER *)data); } static int lh_OSSL_STORE_LOADER_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const OSSL_STORE_LOADER *, const OSSL_STORE_LOADER *) = (int (*)(const OSSL_STORE_LOADER *, const OSSL_STORE_LOADER *))cfn; return cfn_conv((const OSSL_STORE_LOADER *)da, (const OSSL_STORE_LOADER *)db); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_free(struct lhash_st_OSSL_STORE_LOADER *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_flush(struct lhash_st_OSSL_STORE_LOADER *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline OSSL_STORE_LOADER * lh_OSSL_STORE_LOADER_insert(struct lhash_st_OSSL_STORE_LOADER *lh, OSSL_STORE_LOADER *d) { return (OSSL_STORE_LOADER *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline OSSL_STORE_LOADER * lh_OSSL_STORE_LOADER_delete(struct lhash_st_OSSL_STORE_LOADER *lh, const OSSL_STORE_LOADER *d) { return (OSSL_STORE_LOADER *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline OSSL_STORE_LOADER * lh_OSSL_STORE_LOADER_retrieve(struct lhash_st_OSSL_STORE_LOADER *lh, const OSSL_STORE_LOADER *d) { return (OSSL_STORE_LOADER *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_OSSL_STORE_LOADER_error(struct lhash_st_OSSL_STORE_LOADER *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_OSSL_STORE_LOADER_num_items(struct lhash_st_OSSL_STORE_LOADER *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_OSSL_STORE_LOADER_get_down_load(struct lhash_st_OSSL_STORE_LOADER *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_set_down_load(struct lhash_st_OSSL_STORE_LOADER *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(OSSL_STORE_LOADER *) = (void (*)(OSSL_STORE_LOADER *))doall; doall_conv((OSSL_STORE_LOADER *)node); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(OSSL_STORE_LOADER *, void *) = (void (*)(OSSL_STORE_LOADER *, void *))doall; doall_conv((OSSL_STORE_LOADER *)node, arg); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall(struct lhash_st_OSSL_STORE_LOADER *lh, void (*doall)(OSSL_STORE_LOADER *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_OSSL_STORE_LOADER * lh_OSSL_STORE_LOADER_new(unsigned long (*hfn)(const OSSL_STORE_LOADER *), int (*cfn)(const OSSL_STORE_LOADER *, const OSSL_STORE_LOADER *)) { return (struct lhash_st_OSSL_STORE_LOADER *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_OSSL_STORE_LOADER_hfn_thunk, lh_OSSL_STORE_LOADER_cfn_thunk, lh_OSSL_STORE_LOADER_doall_thunk, lh_OSSL_STORE_LOADER_doall_arg_thunk); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall_arg(struct lhash_st_OSSL_STORE_LOADER *lh, void (*doallarg)(OSSL_STORE_LOADER *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_OSSL_STORE_LOADER;

const OSSL_STORE_LOADER *ossl_store_get0_loader_int(const char *scheme);
void ossl_store_destroy_loaders_int(void);
# 133 "../crypto/store/store_local.h"
struct ossl_store_ctx_st {
    ...
    struct stack_st_OSSL_STORE_INFO *cached_info;
...
# 26 "../crypto/store/store_result.c" 2
# 62 "../crypto/store/store_result.c"
...
int ossl_store_handle_load_result(const OSSL_PARAM params[], void *arg)
{
    ...
    helper_data.object_type = 0;

    if ((p = OSSL_PARAM_locate_const(params, "type")) != 
# 100 "../crypto/store/store_result.c" 3 4
                                                                        ((void *)0)
        
# 101 "../crypto/store/store_result.c"
       && !OSSL_PARAM_get_int(p, &helper_data.object_type))
        return 0;
    p = OSSL_PARAM_locate_const(params, "data-type");
    if (p != 
# 104 "../crypto/store/store_result.c" 3 4
            ((void *)0)
        
# 105 "../crypto/store/store_result.c"
       && !OSSL_PARAM_get_utf8_string_ptr(p, &helper_data.data_type))
        return 0;
    p = OSSL_PARAM_locate_const(params, "data");
    if (p != 
# 108 "../crypto/store/store_result.c" 3 4
            ((void *)0)
        
# 109 "../crypto/store/store_result.c"
       && !OSSL_PARAM_get_octet_string_ptr(p, &helper_data.octet_data,
        ...
        return 0;
    p = OSSL_PARAM_locate_const(params, "data-structure");
    if (p != 
# 114 "../crypto/store/store_result.c" 3 4
            ((void *)0)
        
# 115 "../crypto/store/store_result.c"
       && !OSSL_PARAM_get_utf8_string_ptr(p, &helper_data.data_structure))
        return 0;
    p = OSSL_PARAM_locate_const(params, "reference");
    if (p != 
# 118 "../crypto/store/store_result.c" 3 4
            ((void *)0) 
# 118 "../crypto/store/store_result.c"
                 && !OSSL_PARAM_get_octet_string_ptr(p, &helper_data.ref,
                                                      &helper_data.ref_size))
        return 0;
    p = OSSL_PARAM_locate_const(params, "desc");
    if (p != 
# 122 "../crypto/store/store_result.c" 3 4
            ((void *)0) 
# 122 "../crypto/store/store_result.c"
                 && !OSSL_PARAM_get_utf8_string_ptr(p, &helper_data.desc))
        return 0;
    ...
    ERR_set_mark();
    if (*v == 
# 130 "../crypto/store/store_result.c" 3 4
             ((void *)0) 
# 130 "../crypto/store/store_result.c"
                  && !try_name(&helper_data, v))
        goto err;
    ERR_pop_to_mark();
    ERR_set_mark();
    if (*v == 
# 134 "../crypto/store/store_result.c" 3 4
             ((void *)0) 
# 134 "../crypto/store/store_result.c"
                  && !try_key(&helper_data, v, ctx, provider, libctx, propq))
        goto err;
    ERR_pop_to_mark();
    ERR_set_mark();
    if (*v == 
# 138 "../crypto/store/store_result.c" 3 4
             ((void *)0) 
# 138 "../crypto/store/store_result.c"
                  && !try_cert(&helper_data, v, libctx, propq))
        goto err;
    ERR_pop_to_mark();
    ERR_set_mark();
    if (*v == 
# 142 "../crypto/store/store_result.c" 3 4
             ((void *)0) 
# 142 "../crypto/store/store_result.c"
                  && !try_crl(&helper_data, v, libctx, propq))
        goto err;
    ERR_pop_to_mark();
    ERR_set_mark();
    if (*v == 
# 146 "../crypto/store/store_result.c" 3 4
             ((void *)0) 
# 146 "../crypto/store/store_result.c"
                  && !try_pkcs12(&helper_data, v, ctx, libctx, propq))
        goto err;
    ERR_pop_to_mark();

    if (*v == 
# 150 "../crypto/store/store_result.c" 3 4
             ((void *)0)
# 150 "../crypto/store/store_result.c"
                 )
        (ERR_new(), ERR_set_debug("../crypto/store/store_result.c",151,__func__), ERR_set_error)((44),((268|(0x2 << 18L))),
# 151 "../crypto/store/store_result.c" 3 4
       ((void *)0)
# 151 "../crypto/store/store_result.c"
       );

    return (*v != 
# 153 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 153 "../crypto/store/store_result.c"
                     );
 err:
    ERR_clear_last_mark();
    return 0;
...
static int try_name(struct extracted_param_data_st *data, OSSL_STORE_INFO **v)
{
    if (data->object_type == 1) {
        char *newname = 
# 162 "../crypto/store/store_result.c" 3 4
                       ((void *)0)
# 162 "../crypto/store/store_result.c"
                           , *newdesc = 
# 162 "../crypto/store/store_result.c" 3 4
                                        ((void *)0)
# 162 "../crypto/store/store_result.c"
        ...
        if (data->utf8_data == 
# 164 "../crypto/store/store_result.c" 3 4
                              ((void *)0)
# 164 "../crypto/store/store_result.c"
                                  )
            return 0;
        if ((newname = CRYPTO_strdup(data->utf8_data, "../crypto/store/store_result.c", 166)) == 
# 166 "../crypto/store/store_result.c" 3 4
                                                          ((void *)0)
            
# 167 "../crypto/store/store_result.c"
           || (data->desc != 
# 167 "../crypto/store/store_result.c" 3 4
                             ((void *)0)
                
# 168 "../crypto/store/store_result.c"
               && (newdesc = CRYPTO_strdup(data->desc, "../crypto/store/store_result.c", 168)) == 
# 168 "../crypto/store/store_result.c" 3 4
                                                            ((void *)0)
# 168 "../crypto/store/store_result.c"
                                                                )
            || (*v = OSSL_STORE_INFO_new_NAME(newname)) == 
# 169 "../crypto/store/store_result.c" 3 4
                                                          ((void *)0)
# 169 "../crypto/store/store_result.c"
                                                              ) {
            CRYPTO_free(newname, "../crypto/store/store_result.c", 170);
            CRYPTO_free(newdesc, "../crypto/store/store_result.c", 171);
            return 0;
        }
...
# 186 "../crypto/store/store_result.c"
...
{
    EVP_PKEY *pk = 
# 191 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 191 "../crypto/store/store_result.c"
                      ;
    EVP_KEYMGMT *keymgmt = 
# 192 "../crypto/store/store_result.c" 3 4
                          ((void *)0)
# 192 "../crypto/store/store_result.c"
                              ;
    void *keydata = 
# 193 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 193 "../crypto/store/store_result.c"
                       ;
    int try_fallback = 2;


    if (data->data_type == 
# 197 "../crypto/store/store_result.c" 3 4
                          ((void *)0)
# 197 "../crypto/store/store_result.c"
                              )
        return 0;
    ...
    ERR_set_mark();
    while (keymgmt != 
# 202 "../crypto/store/store_result.c" 3 4
                     ((void *)0) 
# 202 "../crypto/store/store_result.c"
                          && keydata == 
# 202 "../crypto/store/store_result.c" 3 4
                                        ((void *)0) 
# 202 "../crypto/store/store_result.c"
                                             && try_fallback-- > 0) {
# 211 "../crypto/store/store_result.c"
        if (EVP_KEYMGMT_get0_provider(keymgmt) == provider) {
            ...
            import_data.keydata = 
# 221 "../crypto/store/store_result.c" 3 4
                                 ((void *)0)
# 221 "../crypto/store/store_result.c"
                                     ;
            import_data.selection = ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) );

            if (export_object != 
# 224 "../crypto/store/store_result.c" 3 4
                                ((void *)0)
# 224 "../crypto/store/store_result.c"
                                    ) {
        ...
        if (keydata == 
# 238 "../crypto/store/store_result.c" 3 4
                      ((void *)0) 
# 238 "../crypto/store/store_result.c"
                           && try_fallback > 0) {
            EVP_KEYMGMT_free(keymgmt);
            keymgmt = evp_keymgmt_fetch_from_prov((OSSL_PROVIDER *)provider,
                                                  data->data_type, propq);
            if (keymgmt != 
# 242 "../crypto/store/store_result.c" 3 4
                          ((void *)0)
# 242 "../crypto/store/store_result.c"
                              ) {
                ERR_pop_to_mark();
                ERR_set_mark();
            }
    ...
    if (keydata != 
# 248 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 248 "../crypto/store/store_result.c"
                      ) {
        ERR_pop_to_mark();
...
{
    EVP_PKEY *pk = 
# 264 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 264 "../crypto/store/store_result.c"
                      ;
    OSSL_DECODER_CTX *decoderctx = 
# 265 "../crypto/store/store_result.c" 3 4
                                  ((void *)0)
# 265 "../crypto/store/store_result.c"
                                      ;
    ...
    default:
        return 
# 285 "../crypto/store/store_result.c" 3 4
              ((void *)0)
# 285 "../crypto/store/store_result.c"
                  ;
    }

    decoderctx =
        OSSL_DECODER_CTX_new_for_pkey(&pk, 
# 289 "../crypto/store/store_result.c" 3 4
                                          ((void *)0)
# 289 "../crypto/store/store_result.c"
                                              , data->data_structure,
...
{
    EVP_PKEY *pk = 
# 310 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 310 "../crypto/store/store_result.c"
                      ;
    ...
    if (ctx->expected_type == 0
        ...
        derp = der;
        pk = d2i_PUBKEY_ex(
# 318 "../crypto/store/store_result.c" 3 4
                          ((void *)0)
# 318 "../crypto/store/store_result.c"
                              , &derp, der_len, libctx, propq);

        if (pk != 
# 320 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 320 "../crypto/store/store_result.c"
                     )
    ...
    if (pk == 
# 325 "../crypto/store/store_result.c" 3 4
             ((void *)0)
        
# 326 "../crypto/store/store_result.c"
       && (ctx->expected_type == 0
            || ctx->expected_type == 4)) {
        unsigned char *new_der = 
# 328 "../crypto/store/store_result.c" 3 4
                                ((void *)0)
# 328 "../crypto/store/store_result.c"
                                    ;
        X509_SIG *p8 = 
# 329 "../crypto/store/store_result.c" 3 4
                      ((void *)0)
# 329 "../crypto/store/store_result.c"
                          ;
        PKCS8_PRIV_KEY_INFO *p8info = 
# 330 "../crypto/store/store_result.c" 3 4
                                     ((void *)0)
# 330 "../crypto/store/store_result.c"
                                         ;


        derp = der;
        p8 = d2i_X509_SIG(
# 334 "../crypto/store/store_result.c" 3 4
                         ((void *)0)
# 334 "../crypto/store/store_result.c"
                             , &derp, der_len);

        if (p8 != 
# 336 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 336 "../crypto/store/store_result.c"
                     ) {
            char pbuf[1024];
            size_t plen = 0;

            if (!cb(pbuf, sizeof(pbuf), &plen, 
# 340 "../crypto/store/store_result.c" 3 4
                                              ((void *)0)
# 340 "../crypto/store/store_result.c"
                                                  , cbarg)) {
                (ERR_new(), ERR_set_debug("../crypto/store/store_result.c",341,__func__), ERR_set_error)((44),(115),
# 341 "../crypto/store/store_result.c" 3 4
               ((void *)0)
# 341 "../crypto/store/store_result.c"
               );
            } else {
                const X509_ALGOR *alg = 
# 343 "../crypto/store/store_result.c" 3 4
                                       ((void *)0)
# 343 "../crypto/store/store_result.c"
                                           ;
                const ASN1_OCTET_STRING *oct = 
# 344 "../crypto/store/store_result.c" 3 4
                                              ((void *)0)
# 344 "../crypto/store/store_result.c"
                                                  ;
                int len = 0;
        ...
        if (der != 
# 366 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 366 "../crypto/store/store_result.c"
                      ) {

            derp = der;
            p8info = d2i_PKCS8_PRIV_KEY_INFO(
# 369 "../crypto/store/store_result.c" 3 4
                                            ((void *)0)
# 369 "../crypto/store/store_result.c"
                                                , &derp, der_len);

            if (p8info != 
# 371 "../crypto/store/store_result.c" 3 4
                         ((void *)0)
# 371 "../crypto/store/store_result.c"
                             ) {
        ...
        if (pk != 
# 377 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 377 "../crypto/store/store_result.c"
                     )
            *store_info_new = OSSL_STORE_INFO_new_PKEY;

        CRYPTO_free(new_der, "../crypto/store/store_result.c", 380);
    }
...
{
    store_info_new_fn *store_info_new = 
# 390 "../crypto/store/store_result.c" 3 4
                                       ((void *)0)
# 390 "../crypto/store/store_result.c"
                                           ;

    if (data->object_type == 0
        || data->object_type == 2) {
        EVP_PKEY *pk = 
# 394 "../crypto/store/store_result.c" 3 4
                      ((void *)0)
# 394 "../crypto/store/store_result.c"
                          ;


        if (data->object_type == 2 && data->ref != 
# 397 "../crypto/store/store_result.c" 3 4
                                                                 ((void *)0)
# 397 "../crypto/store/store_result.c"
                                                                     ) {
            ...
            if (pk == 
# 406 "../crypto/store/store_result.c" 3 4
                     ((void *)0)
# 406 "../crypto/store/store_result.c"
                         )
                return 0;
        } else if (data->octet_data != 
# 408 "../crypto/store/store_result.c" 3 4
                                      ((void *)0)
# 408 "../crypto/store/store_result.c"
                                          ) {
...
# 421 "../crypto/store/store_result.c"
            if (pk == 
# 421 "../crypto/store/store_result.c" 3 4
                     ((void *)0)
# 421 "../crypto/store/store_result.c"
                         )
        ...
        if (pk != 
# 426 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 426 "../crypto/store/store_result.c"
                     ) {
            data->object_type = 2;

            if (store_info_new == 
# 429 "../crypto/store/store_result.c" 3 4
                                 ((void *)0)
# 429 "../crypto/store/store_result.c"
                                     ) {
# 438 "../crypto/store/store_result.c"
                if (evp_keymgmt_util_has(pk, 0x01))
                    store_info_new = OSSL_STORE_INFO_new_PKEY;
        ...
        if (*v == 
# 449 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 449 "../crypto/store/store_result.c"
                     )
            EVP_PKEY_free(pk);
    }
                    ...
                    OSSL_LIB_CTX *libctx, const char *propq)
{
    if (data->object_type == 0
        || data->object_type == 3) {
# 470 "../crypto/store/store_result.c"
        int ignore_trusted = 1;
        X509 *cert = X509_new_ex(libctx, propq);

        if (cert == 
# 473 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 473 "../crypto/store/store_result.c"
                       )
            return 0;


        if (data->data_type != 
# 477 "../crypto/store/store_result.c" 3 4
                              ((void *)0)
            
# 478 "../crypto/store/store_result.c"
           && (OPENSSL_strcasecmp(data->data_type, "TRUSTED CERTIFICATE") == 0))
            ignore_trusted = 0;

        if (d2i_X509_AUX(&cert, (const unsigned char **)&data->octet_data,
                         data->octet_data_size) == 
# 482 "../crypto/store/store_result.c" 3 4
                                                  ((void *)0)
            
# 483 "../crypto/store/store_result.c"
           && (!ignore_trusted
                || d2i_X509(&cert, (const unsigned char **)&data->octet_data,
                            data->octet_data_size) == 
# 485 "../crypto/store/store_result.c" 3 4
                                                     ((void *)0)
# 485 "../crypto/store/store_result.c"
                                                         )) {
            X509_free(cert);
            cert = 
# 487 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 487 "../crypto/store/store_result.c"
                      ;
        }

        if (cert != 
# 490 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 490 "../crypto/store/store_result.c"
                       ) {

            data->object_type = 3;
            *v = OSSL_STORE_INFO_new_CERT(cert);
            if (*v == 
# 494 "../crypto/store/store_result.c" 3 4
                     ((void *)0)
# 494 "../crypto/store/store_result.c"
                         )
                X509_free(cert);
        }
    }
                   ...
                   OSSL_LIB_CTX *libctx, const char *propq)
{
    if (data->object_type == 0
        ...
        crl = d2i_X509_CRL(
# 509 "../crypto/store/store_result.c" 3 4
                          ((void *)0)
# 509 "../crypto/store/store_result.c"
                              , (const unsigned char **)&data->octet_data,
                           data->octet_data_size);

        if (crl != 
# 512 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 512 "../crypto/store/store_result.c"
                      )

            data->object_type = 4;

        if (crl != 
# 516 "../crypto/store/store_result.c" 3 4
                  ((void *)0) 
# 516 "../crypto/store/store_result.c"
                       && !ossl_x509_crl_set0_libctx(crl, libctx, propq)) {
            X509_CRL_free(crl);
            crl = 
# 518 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 518 "../crypto/store/store_result.c"
                     ;
        }

        if (crl != 
# 521 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 521 "../crypto/store/store_result.c"
                      )
            *v = OSSL_STORE_INFO_new_CRL(crl);
        if (*v == 
# 523 "../crypto/store/store_result.c" 3 4
                 ((void *)0)
# 523 "../crypto/store/store_result.c"
                     )
            X509_CRL_free(crl);
    }
                      ...
                      OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (data->object_type == 0) {
        ...
        p12 = d2i_PKCS12(
# 541 "../crypto/store/store_result.c" 3 4
                        ((void *)0)
# 541 "../crypto/store/store_result.c"
                            , (const unsigned char **)&data->octet_data,
                         data->octet_data_size);

        if (p12 != 
# 544 "../crypto/store/store_result.c" 3 4
                  ((void *)0)
# 544 "../crypto/store/store_result.c"
                      ) {
            char *pass = 
# 545 "../crypto/store/store_result.c" 3 4
                        ((void *)0)
# 545 "../crypto/store/store_result.c"
                            ;
            char tpass[1024 + 1];
            size_t tpass_len;
            EVP_PKEY *pkey = 
# 548 "../crypto/store/store_result.c" 3 4
                            ((void *)0)
# 548 "../crypto/store/store_result.c"
                                ;
            X509 *cert = 
# 549 "../crypto/store/store_result.c" 3 4
                        ((void *)0)
# 549 "../crypto/store/store_result.c"
                            ;
            struct stack_st_X509 *chain = 
# 550 "../crypto/store/store_result.c" 3 4
                                   ((void *)0)
# 550 "../crypto/store/store_result.c"
                                       ;
            ...
            if (!PKCS12_mac_present(p12)
                || PKCS12_verify_mac(p12, 
# 557 "../crypto/store/store_result.c" 3 4
                                         ((void *)0)
# 557 "../crypto/store/store_result.c"
                                             , 0)) {
                pass = 
# 558 "../crypto/store/store_result.c" 3 4
                      ((void *)0)
# 558 "../crypto/store/store_result.c"
                          ;
                ...
                OSSL_PARAM pw_params[] = {
                    { (("info")), (4), ((prompt_info)), (sizeof(prompt_info) - 1), ((size_t)-1) }

                                                                   ,
                    { 
# 567 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 567 "../crypto/store/store_result.c"
                   , 0, 
# 567 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 567 "../crypto/store/store_result.c"
                ...
                if (!ossl_pw_get_passphrase(tpass, sizeof(tpass) - 1,
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/store/store_result.c",573,__func__), ERR_set_error)((44),(114),
# 573 "../crypto/store/store_result.c" 3 4
                   ((void *)0)
# 573 "../crypto/store/store_result.c"
                   )
                                                                     ;
                    goto p12_end;
                }
                ...
                if (!PKCS12_verify_mac(p12, pass, tpass_len)) {
                    (ERR_new(), ERR_set_debug("../crypto/store/store_result.c",584,__func__), ERR_set_error)(44,
                                   113,
            ...
            if (PKCS12_parse(p12, pass, &pkey, &cert, &chain)) {
                struct stack_st_OSSL_STORE_INFO *infos = 
# 593 "../crypto/store/store_result.c" 3 4
                                                  ((void *)0)
# 593 "../crypto/store/store_result.c"
                                                      ;
                OSSL_STORE_INFO *osi_pkey = 
# 594 "../crypto/store/store_result.c" 3 4
                                           ((void *)0)
# 594 "../crypto/store/store_result.c"
                                               ;
                OSSL_STORE_INFO *osi_cert = 
# 595 "../crypto/store/store_result.c" 3 4
                                           ((void *)0)
# 595 "../crypto/store/store_result.c"
                                               ;
                OSSL_STORE_INFO *osi_ca = 
# 596 "../crypto/store/store_result.c" 3 4
                                         ((void *)0)
# 596 "../crypto/store/store_result.c"
                                             ;

                ok = 1;

                if ((infos = sk_OSSL_STORE_INFO_new_null()) != 
# 600 "../crypto/store/store_result.c" 3 4
                                                              ((void *)0)
# 600 "../crypto/store/store_result.c"
                                                                  ) {
                    if (pkey != 
# 601 "../crypto/store/store_result.c" 3 4
                               ((void *)0)
# 601 "../crypto/store/store_result.c"
                                   ) {
                        if ((osi_pkey = OSSL_STORE_INFO_new_PKEY(pkey)) != 
# 602 "../crypto/store/store_result.c" 3 4
                                                                          ((void *)0)

                            
# 604 "../crypto/store/store_result.c"
                           && (pkey = 
# 604 "../crypto/store/store_result.c" 3 4
                                      ((void *)0)
# 604 "../crypto/store/store_result.c"
                                          ) == 
# 604 "../crypto/store/store_result.c" 3 4
...
# 605 "../crypto/store/store_result.c"
                           && sk_OSSL_STORE_INFO_push(infos, osi_pkey) != 0)
                            osi_pkey = 
# 606 "../crypto/store/store_result.c" 3 4
                                      ((void *)0)
# 606 "../crypto/store/store_result.c"
                                          ;
                        else
                            ok = 0;
                    }
                    if (ok && cert != 
# 610 "../crypto/store/store_result.c" 3 4
                                     ((void *)0)
# 610 "../crypto/store/store_result.c"
                                         ) {
                        if ((osi_cert = OSSL_STORE_INFO_new_CERT(cert)) != 
# 611 "../crypto/store/store_result.c" 3 4
                                                                          ((void *)0)

                            
# 613 "../crypto/store/store_result.c"
                           && (cert = 
# 613 "../crypto/store/store_result.c" 3 4
                                      ((void *)0)
# 613 "../crypto/store/store_result.c"
                                          ) == 
# 613 "../crypto/store/store_result.c" 3 4
...
# 614 "../crypto/store/store_result.c"
                           && sk_OSSL_STORE_INFO_push(infos, osi_cert) != 0)
                            osi_cert = 
# 615 "../crypto/store/store_result.c" 3 4
                                      ((void *)0)
# 615 "../crypto/store/store_result.c"
                                          ;
                        else
                            ok = 0;
                    }
                    while (ok && OPENSSL_sk_num(ossl_check_const_X509_sk_type(chain)) > 0) {
                        X509 *ca = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(chain), (0)));

                        if ((osi_ca = OSSL_STORE_INFO_new_CERT(ca)) != 
# 622 "../crypto/store/store_result.c" 3 4
                                                                      ((void *)0)
                            
# 623 "../crypto/store/store_result.c"
                           && ((X509 *)OPENSSL_sk_shift(ossl_check_X509_sk_type(chain))) != 
# 623 "../crypto/store/store_result.c" 3 4
                                                      ((void *)0)
                            
# 624 "../crypto/store/store_result.c"
                           && sk_OSSL_STORE_INFO_push(infos, osi_ca) != 0)
                            osi_ca = 
# 625 "../crypto/store/store_result.c" 3 4
                                    ((void *)0)
# 625 "../crypto/store/store_result.c"
                                        ;
                        else
                            ok = 0;
                    }
                ...
                if (!ok) {
                    ...
                    infos = 
# 638 "../crypto/store/store_result.c" 3 4
                           ((void *)0)
# 638 "../crypto/store/store_result.c"
                               ;
                }
