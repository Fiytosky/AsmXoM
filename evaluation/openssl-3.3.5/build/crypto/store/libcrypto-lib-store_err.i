# 0 "../crypto/store/store_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/store/store_err.c"
# 11 "../crypto/store/store_err.c"
...
# 14 "../crypto/store/store_err.c" 2



static const ERR_STRING_DATA OSSL_STORE_str_reasons[] = {
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "ambiguous content type"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "bad password read"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "error verifying pkcs12 mac"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "fingerprint size does not match digest"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "invalid scheme"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "is not a"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "loader incomplete"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "loading started"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "not a certificate"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "not a crl"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "not a name"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "not a private key"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "not a public key"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "not parameters"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "no loaders found"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "passphrase callback error"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "path must be absolute"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "search only supported for directories"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "ui process interrupted or cancelled"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "unregistered scheme"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "unsupported content type"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "unsupported operation"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "unsupported search type"},
    {( (((unsigned long)(44) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "uri authority unsupported"},
    {0, 
# 63 "../crypto/store/store_err.c" 3 4
       ((void *)0)
# 63 "../crypto/store/store_err.c"
           }
};
...
int ossl_err_load_OSSL_STORE_strings(void)
{
    ...
    if (ERR_reason_error_string(OSSL_STORE_str_reasons[0].error) == 
# 71 "../crypto/store/store_err.c" 3 4
                                                                   ((void *)0)
# 71 "../crypto/store/store_err.c"
                                                                       )
