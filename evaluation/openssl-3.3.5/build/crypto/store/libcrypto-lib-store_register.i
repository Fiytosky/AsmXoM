# 0 "../crypto/store/store_register.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/store/store_register.c"
# 10 "../crypto/store/store_register.c"
...
# 11 "../crypto/store/store_register.c" 2
...
# 12 "../crypto/store/store_register.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 13 "../crypto/store/store_register.c" 2
...
# 15 "../crypto/store/store_register.c" 2

# 1 "../crypto/store/store_local.h" 1
# 10 "../crypto/store/store_local.h"
...
# 11 "../crypto/store/store_local.h" 2
...
__attribute__((deprecated("Since OpenSSL " "3.0"))) int DSA_meth_set_keygen(DSA_METHOD *dsam,
                                              int (*keygen) (DSA *));
# 14 "../crypto/store/store_local.h" 2
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 19 "../crypto/store/store_local.h" 2
...
# 17 "../crypto/store/store_register.c" 2

static CRYPTO_RWLOCK *registry_lock;
static CRYPTO_ONCE registry_init = 
# 19 "../crypto/store/store_register.c" 3 4
                                  0
# 19 "../crypto/store/store_register.c"
                                                         ;

static int do_registry_init(void); static int do_registry_init_ossl_ret_ = 0; static void do_registry_init_ossl_(void) { do_registry_init_ossl_ret_ = do_registry_init(); } static int do_registry_init(void)
{
    registry_lock = CRYPTO_THREAD_lock_new();
    return registry_lock != 
# 24 "../crypto/store/store_register.c" 3 4
                           ((void *)0)
# 24 "../crypto/store/store_register.c"
                               ;
}
...
# 33 "../crypto/store/store_register.c" 3 4
                            ((void *)0)
# 33 "../crypto/store/store_register.c"
                                ;
    ...
    if (scheme == 
# 41 "../crypto/store/store_register.c" 3 4
                 ((void *)0)
# 41 "../crypto/store/store_register.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",42,__func__), ERR_set_error)((44),(106),
# 42 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 42 "../crypto/store/store_register.c"
       );
        return 
# 43 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 43 "../crypto/store/store_register.c"
                  ;
    }

    if ((res = CRYPTO_zalloc(sizeof(*res), "../crypto/store/store_register.c", 46)) == 
# 46 "../crypto/store/store_register.c" 3 4
                                               ((void *)0)
# 46 "../crypto/store/store_register.c"
                                                   )
        return 
# 47 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 47 "../crypto/store/store_register.c"
                  ;
...
# 147 "../crypto/store/store_register.c" 3 4
   ((void) (0))
# 147 "../crypto/store/store_register.c"
                                                 ;
    return strcmp(a->scheme, b->scheme);
}

static struct lhash_st_OSSL_STORE_LOADER *loader_register = 
# 151 "../crypto/store/store_register.c" 3 4
                                                     ((void *)0)
# 151 "../crypto/store/store_register.c"
                                                         ;
static int ossl_store_register_init(void)
{
    if (loader_register == 
# 154 "../crypto/store/store_register.c" 3 4
                          ((void *)0)
# 154 "../crypto/store/store_register.c"
                              ) {
        loader_register = lh_OSSL_STORE_LOADER_new(store_loader_hash,
                                                   store_loader_cmp);
    }
    return loader_register != 
# 158 "../crypto/store/store_register.c" 3 4
                             ((void *)0)
# 158 "../crypto/store/store_register.c"
                                 ;
}
...
int ossl_store_register_loader_int(OSSL_STORE_LOADER *loader)
{
    ...
    if ((ossl_ctype_check((*scheme), (0x1 | 0x2))))
        while (*scheme != '\0'
               && ((ossl_ctype_check((*scheme), (0x1 | 0x2)))
                   || ossl_isdigit(*scheme)
                   || strchr("+-.", *scheme) != 
# 176 "../crypto/store/store_register.c" 3 4
                                               ((void *)0)
# 176 "../crypto/store/store_register.c"
                                                   ))
            scheme++;
    if (*scheme != '\0') {
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",179,__func__), ERR_set_error)(44, 106,
    ...
    if (loader->open == 
# 185 "../crypto/store/store_register.c" 3 4
                       ((void *)0) 
# 185 "../crypto/store/store_register.c"
                            || loader->load == 
# 185 "../crypto/store/store_register.c" 3 4
                                               ((void *)0) 
# 185 "../crypto/store/store_register.c"
...
# 186 "../crypto/store/store_register.c"
       || loader->error == 
# 186 "../crypto/store/store_register.c" 3 4
                           ((void *)0) 
# 186 "../crypto/store/store_register.c"
                                || loader->closefn == 
# 186 "../crypto/store/store_register.c" 3 4
...
# 186 "../crypto/store/store_register.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",187,__func__), ERR_set_error)((44),(116),
# 187 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 187 "../crypto/store/store_register.c"
       );
        return 0;
    }

    if (!(CRYPTO_THREAD_run_once(&registry_init, do_registry_init_ossl_) ? do_registry_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",193,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 193 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 193 "../crypto/store/store_register.c"
       );
        return 0;
    }
    ...
    if (ossl_store_register_init()
        && (lh_OSSL_STORE_LOADER_insert(loader_register, loader) != 
# 200 "../crypto/store/store_register.c" 3 4
                                                                   ((void *)0)
            
# 201 "../crypto/store/store_register.c"
...
const OSSL_STORE_LOADER *ossl_store_get0_loader_int(const char *scheme)
{
    ...
    OSSL_STORE_LOADER *loader = 
# 216 "../crypto/store/store_register.c" 3 4
                               ((void *)0)
# 216 "../crypto/store/store_register.c"
                                   ;

    template.scheme = scheme;
    template.open = 
# 219 "../crypto/store/store_register.c" 3 4
                   ((void *)0)
# 219 "../crypto/store/store_register.c"
                       ;
    template.load = 
# 220 "../crypto/store/store_register.c" 3 4
                   ((void *)0)
# 220 "../crypto/store/store_register.c"
                       ;
    template.eof = 
# 221 "../crypto/store/store_register.c" 3 4
                  ((void *)0)
# 221 "../crypto/store/store_register.c"
                      ;
    template.closefn = 
# 222 "../crypto/store/store_register.c" 3 4
                      ((void *)0)
# 222 "../crypto/store/store_register.c"
                          ;
    template.open_ex = 
# 223 "../crypto/store/store_register.c" 3 4
                      ((void *)0)
# 223 "../crypto/store/store_register.c"
                          ;

    if (!(CRYPTO_THREAD_run_once(&registry_init, do_registry_init_ossl_) ? do_registry_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",227,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 227 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 227 "../crypto/store/store_register.c"
       );
        return 
# 228 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 228 "../crypto/store/store_register.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(registry_lock))
        return 
# 231 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 231 "../crypto/store/store_register.c"
                  ;

    if (!ossl_store_register_init())
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",234,__func__), ERR_set_error)((44),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 234 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 234 "../crypto/store/store_register.c"
       );
    else if ((loader = lh_OSSL_STORE_LOADER_retrieve(loader_register,
                                                     &template)) == 
# 236 "../crypto/store/store_register.c" 3 4
                                                                   ((void *)0)
# 236 "../crypto/store/store_register.c"
                                                                       )
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",237,__func__), ERR_set_error)(44, 105,
                       "scheme=%s", scheme);
...
OSSL_STORE_LOADER *ossl_store_unregister_loader_int(const char *scheme)
{
    OSSL_STORE_LOADER template;
    OSSL_STORE_LOADER *loader = 
# 248 "../crypto/store/store_register.c" 3 4
                               ((void *)0)
# 248 "../crypto/store/store_register.c"
                                   ;

    template.scheme = scheme;
    template.open = 
# 251 "../crypto/store/store_register.c" 3 4
                   ((void *)0)
# 251 "../crypto/store/store_register.c"
                       ;
    template.load = 
# 252 "../crypto/store/store_register.c" 3 4
                   ((void *)0)
# 252 "../crypto/store/store_register.c"
                       ;
    template.eof = 
# 253 "../crypto/store/store_register.c" 3 4
                  ((void *)0)
# 253 "../crypto/store/store_register.c"
                      ;
    template.closefn = 
# 254 "../crypto/store/store_register.c" 3 4
                      ((void *)0)
# 254 "../crypto/store/store_register.c"
                          ;

    if (!(CRYPTO_THREAD_run_once(&registry_init, do_registry_init_ossl_) ? do_registry_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",258,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 258 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 258 "../crypto/store/store_register.c"
       );
        return 
# 259 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 259 "../crypto/store/store_register.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(registry_lock))
        return 
# 262 "../crypto/store/store_register.c" 3 4
              ((void *)0)
# 262 "../crypto/store/store_register.c"
                  ;

    if (!ossl_store_register_init())
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",265,__func__), ERR_set_error)((44),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 265 "../crypto/store/store_register.c" 3 4
       ((void *)0)
# 265 "../crypto/store/store_register.c"
       );
    else if ((loader = lh_OSSL_STORE_LOADER_delete(loader_register,
                                                   &template)) == 
# 267 "../crypto/store/store_register.c" 3 4
                                                                 ((void *)0)
# 267 "../crypto/store/store_register.c"
                                                                     )
        (ERR_new(), ERR_set_debug("../crypto/store/store_register.c",268,__func__), ERR_set_error)(44, 105,
                       "scheme=%s", scheme);
...
void ossl_store_destroy_loaders_int(void)
{
    ...
    loader_register = 
# 283 "../crypto/store/store_register.c" 3 4
                     ((void *)0)
# 283 "../crypto/store/store_register.c"
                         ;
    CRYPTO_THREAD_lock_free(registry_lock);
    registry_lock = 
# 285 "../crypto/store/store_register.c" 3 4
                   ((void *)0)
# 285 "../crypto/store/store_register.c"
                       ;
}
...
static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall_void_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const OSSL_STORE_LOADER *, void *) = (void (*)(const OSSL_STORE_LOADER *, void *))fn; fn_conv((const OSSL_STORE_LOADER *)node, (void *)arg); } static __attribute__((unused)) inline void lh_OSSL_STORE_LOADER_doall_void(struct lhash_st_OSSL_STORE_LOADER *lh, void (*fn)(const OSSL_STORE_LOADER *, void *), void *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_OSSL_STORE_LOADER_doall_void_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_OSSL_STORE_LOADER;
