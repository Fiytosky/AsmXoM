...
int OSSL_STORE_LOADER_up_ref(OSSL_STORE_LOADER *loader)
{
    ...
    if (loader->prov != 
# 23 "../crypto/store/store_meth.c" 3 4
                       ((void *)0)
# 23 "../crypto/store/store_meth.c"
                           )
...
{
    if (loader != 
# 30 "../crypto/store/store_meth.c" 3 4
                 ((void *)0) 
# 30 "../crypto/store/store_meth.c"
                      && loader->prov != 
# 30 "../crypto/store/store_meth.c" 3 4
                                         ((void *)0)
# 30 "../crypto/store/store_meth.c"
    ...
    CRYPTO_free(loader, "../crypto/store/store_meth.c", 39);
}
...
static OSSL_STORE_LOADER *new_loader(OSSL_PROVIDER *prov)
{
    ...
    if ((loader = CRYPTO_zalloc(sizeof(*loader), "../crypto/store/store_meth.c", 50)) == 
# 50 "../crypto/store/store_meth.c" 3 4
                                                     ((void *)0)
        
# 51 "../crypto/store/store_meth.c"
       || !CRYPTO_NEW_REF(&loader->refcnt, 1)) {
        CRYPTO_free(loader, "../crypto/store/store_meth.c", 52);
        return 
# 53 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 53 "../crypto/store/store_meth.c"
                  ;
    }
    loader->prov = prov;
...
# 93 "../crypto/store/store_meth.c" 3 4
                              ((void *)0)
# 93 "../crypto/store/store_meth.c"
                                  )
...
{
    if (store != 
# 100 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
# 100 "../crypto/store/store_meth.c"
                    )
...
static int reserve_loader_store(void *store, void *data)
{
    ...
    if (store == 
# 114 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
        
# 115 "../crypto/store/store_meth.c"
       && (store = get_loader_store(methdata->libctx)) == 
# 115 "../crypto/store/store_meth.c" 3 4
                                                          ((void *)0)
# 115 "../crypto/store/store_meth.c"
                                                              )
        return 0;
...
static int unreserve_loader_store(void *store, void *data)
{
    ...
    if (store == 
# 125 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
        
# 126 "../crypto/store/store_meth.c"
       && (store = get_loader_store(methdata->libctx)) == 
# 126 "../crypto/store/store_meth.c" 3 4
                                                          ((void *)0)
# 126 "../crypto/store/store_meth.c"
                                                              )
        return 0;
                                   ...
                                   void *data)
{
    struct loader_data_st *methdata = data;
    void *method = 
# 137 "../crypto/store/store_meth.c" 3 4
                  ((void *)0)
# 137 "../crypto/store/store_meth.c"
                      ;
    int id;
    ...
    if (store == 
# 146 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
        
# 147 "../crypto/store/store_meth.c"
       && (store = get_loader_store(methdata->libctx)) == 
# 147 "../crypto/store/store_meth.c" 3 4
                                                          ((void *)0)
# 147 "../crypto/store/store_meth.c"
                                                              )
        return 
# 148 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 148 "../crypto/store/store_meth.c"
                  ;

    if (!ossl_method_store_fetch(store, id, methdata->propquery, prov, &method))
        return 
# 151 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 151 "../crypto/store/store_meth.c"
                  ;
    return method;
}
                               ...
                               void *data)
{
    ...
    if ((namemap = ossl_namemap_stored(methdata->libctx)) == 
# 164 "../crypto/store/store_meth.c" 3 4
                                                            ((void *)0)
        
# 165 "../crypto/store/store_meth.c"
       || (id = ossl_namemap_name2num(namemap, scheme)) == 0)
        return 0;

    if (store == 
# 168 "../crypto/store/store_meth.c" 3 4
                ((void *)0) 
# 168 "../crypto/store/store_meth.c"
                     && (store = get_loader_store(methdata->libctx)) == 
# 168 "../crypto/store/store_meth.c" 3 4
                                                                        ((void *)0)
# 168 "../crypto/store/store_meth.c"
...
{
    OSSL_STORE_LOADER *loader = 
# 178 "../crypto/store/store_meth.c" 3 4
                               ((void *)0)
# 178 "../crypto/store/store_meth.c"
                                   ;
    const OSSL_DISPATCH *fns = algodef->implementation;

    if ((loader = new_loader(prov)) == 
# 181 "../crypto/store/store_meth.c" 3 4
                                      ((void *)0)
# 181 "../crypto/store/store_meth.c"
                                          )
        return 
# 182 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 182 "../crypto/store/store_meth.c"
                  ;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (loader->p_open == 
# 190 "../crypto/store/store_meth.c" 3 4
                                 ((void *)0)
# 190 "../crypto/store/store_meth.c"
                                     )
                loader->p_open = OSSL_FUNC_store_open(fns);
            break;
        case 2:
            if (loader->p_attach == 
# 194 "../crypto/store/store_meth.c" 3 4
                                   ((void *)0)
# 194 "../crypto/store/store_meth.c"
                                       )
                loader->p_attach = OSSL_FUNC_store_attach(fns);
            break;
        case 3:
            if (loader->p_settable_ctx_params == 
# 198 "../crypto/store/store_meth.c" 3 4
                                                ((void *)0)
# 198 "../crypto/store/store_meth.c"
                                                    )
...
# 203 "../crypto/store/store_meth.c" 3 4
                                           ((void *)0)
# 203 "../crypto/store/store_meth.c"
                                               )
                loader->p_set_ctx_params = OSSL_FUNC_store_set_ctx_params(fns);
            break;
        case 5:
            if (loader->p_load == 
# 207 "../crypto/store/store_meth.c" 3 4
                                 ((void *)0)
# 207 "../crypto/store/store_meth.c"
                                     )
                loader->p_load = OSSL_FUNC_store_load(fns);
            break;
        case 6:
            if (loader->p_eof == 
# 211 "../crypto/store/store_meth.c" 3 4
                                ((void *)0)
# 211 "../crypto/store/store_meth.c"
                                    )
                loader->p_eof = OSSL_FUNC_store_eof(fns);
            break;
        case 7:
            if (loader->p_close == 
# 215 "../crypto/store/store_meth.c" 3 4
                                  ((void *)0)
# 215 "../crypto/store/store_meth.c"
                                      )
                loader->p_close = OSSL_FUNC_store_close(fns);
            break;
        case 8:
            if (loader->p_export_object == 
# 219 "../crypto/store/store_meth.c" 3 4
                                          ((void *)0)
# 219 "../crypto/store/store_meth.c"
                                              )
                loader->p_export_object = OSSL_FUNC_store_export_object(fns);
            break;
        case 9:
            if (loader->p_delete == 
# 223 "../crypto/store/store_meth.c" 3 4
                                   ((void *)0)
# 223 "../crypto/store/store_meth.c"
                                       )
                loader->p_delete = OSSL_FUNC_store_delete(fns);
            break;
        case 10:
            if (loader->p_open_ex == 
# 227 "../crypto/store/store_meth.c" 3 4
                                    ((void *)0)
# 227 "../crypto/store/store_meth.c"
                                        )
    ...
    if ((loader->p_open == 
# 233 "../crypto/store/store_meth.c" 3 4
                          ((void *)0) 
# 233 "../crypto/store/store_meth.c"
                               && loader->p_attach == 
# 233 "../crypto/store/store_meth.c" 3 4
                                                      ((void *)0)
# 233 "../crypto/store/store_meth.c"
        ...
        || loader->p_load == 
# 234 "../crypto/store/store_meth.c" 3 4
                            ((void *)0)
        
# 235 "../crypto/store/store_meth.c"
       || loader->p_eof == 
# 235 "../crypto/store/store_meth.c" 3 4
                           ((void *)0)
        
# 236 "../crypto/store/store_meth.c"
       || loader->p_close == 
# 236 "../crypto/store/store_meth.c" 3 4
                             ((void *)0)
# 236 "../crypto/store/store_meth.c"
                                 ) {

        OSSL_STORE_LOADER_free(loader);
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",239,__func__), ERR_set_error)((44),(116),
# 239 "../crypto/store/store_meth.c" 3 4
       ((void *)0)
# 239 "../crypto/store/store_meth.c"
       );
        return 
# 240 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 240 "../crypto/store/store_meth.c"
                  ;
    }
    return loader;
}
                              ...
                              OSSL_PROVIDER *prov, void *data)
{
    ...
    void *method = 
# 264 "../crypto/store/store_meth.c" 3 4
                  ((void *)0)
# 264 "../crypto/store/store_meth.c"
                      ;
    ...
    if (method == 
# 274 "../crypto/store/store_meth.c" 3 4
                 ((void *)0)
# 274 "../crypto/store/store_meth.c"
                     )
                   ...
                   const char *scheme, const char *properties)
{
    ...
    OSSL_NAMEMAP *namemap = ossl_namemap_stored(methdata->libctx);
    const char *const propq = properties != 
# 293 "../crypto/store/store_meth.c" 3 4
                                           ((void *)0) 
# 293 "../crypto/store/store_meth.c"
                                                ? properties : "";
    void *method = 
# 294 "../crypto/store/store_meth.c" 3 4
                  ((void *)0)
# 294 "../crypto/store/store_meth.c"
                      ;
    int unsupported, id;

    if (store == 
# 297 "../crypto/store/store_meth.c" 3 4
                ((void *)0) 
# 297 "../crypto/store/store_meth.c"
                     || namemap == 
# 297 "../crypto/store/store_meth.c" 3 4
                                   ((void *)0)
# 297 "../crypto/store/store_meth.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",298,__func__), ERR_set_error)((44),((262|(0x2 << 18L))),
# 298 "../crypto/store/store_meth.c" 3 4
       ((void *)0)
# 298 "../crypto/store/store_meth.c"
       );
        return 
# 299 "../crypto/store/store_meth.c" 3 4
              ((void *)0)
# 299 "../crypto/store/store_meth.c"
                  ;
    }


    id = scheme != 
# 303 "../crypto/store/store_meth.c" 3 4
                  ((void *)0) 
# 303 "../crypto/store/store_meth.c"
                       ? ossl_namemap_name2num(namemap, scheme) : 0;
...
# 312 "../crypto/store/store_meth.c" 3 4
                                              ((void *)0)
# 312 "../crypto/store/store_meth.c"
                                                  , id, propq, &method)) {
        ...
        OSSL_PROVIDER *prov = 
# 322 "../crypto/store/store_meth.c" 3 4
                             ((void *)0)
# 322 "../crypto/store/store_meth.c"
                                 ;
        ...
        if ((method = ossl_method_construct(methdata->libctx, 22,
                                            &prov, 0 ,
                                            &mcm, methdata)) != 
# 330 "../crypto/store/store_meth.c" 3 4
                                                               ((void *)0)
# 330 "../crypto/store/store_meth.c"
                                                                   ) {
    ...
    if ((id != 0 || scheme != 
# 349 "../crypto/store/store_meth.c" 3 4
                             ((void *)0)
# 349 "../crypto/store/store_meth.c"
                                 ) && method == 
# 349 "../crypto/store/store_meth.c" 3 4
                                                ((void *)0)
# 349 "../crypto/store/store_meth.c"
                                                    ) {
        int code = unsupported ? (268|(0x2 << 18L)) : (269|(0x2 << 18L));
        ...
        if (scheme == 
# 358 "../crypto/store/store_meth.c" 3 4
                     ((void *)0)
# 358 "../crypto/store/store_meth.c"
                         )
            scheme = ossl_namemap_num2name(namemap, id, 0);
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",360,__func__), ERR_set_error)(44, code,
                       "%s%s, Scheme (%s : %d), Properties (%s)",
                       helpful_msg,
                       ossl_lib_ctx_get_descriptor(methdata->libctx),
                       scheme == 
# 364 "../crypto/store/store_meth.c" 3 4
                                ((void *)0) 
# 364 "../crypto/store/store_meth.c"
                                     ? "<null>" : scheme, id,
                       properties == 
# 365 "../crypto/store/store_meth.c" 3 4
                                    ((void *)0) 
# 365 "../crypto/store/store_meth.c"
                                         ? "<null>" : properties);
    }
                                           ...
                                           const char *properties)
{
    ...
    methdata.tmp_store = 
# 379 "../crypto/store/store_meth.c" 3 4
                        ((void *)0)
# 379 "../crypto/store/store_meth.c"
                            ;
...
int ossl_store_loader_store_cache_flush(OSSL_LIB_CTX *libctx)
{
    ...
    if (store != 
# 389 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
# 389 "../crypto/store/store_meth.c"
                    )
...
int ossl_store_loader_store_remove_all_provided(const OSSL_PROVIDER *prov)
{
    ...
    if (store != 
# 399 "../crypto/store/store_meth.c" 3 4
                ((void *)0)
# 399 "../crypto/store/store_meth.c"
                    )
...
{
    if (!__builtin_expect(!!((loader != 
# 410 "../crypto/store/store_meth.c" 3 4
        ((void *)0)
# 410 "../crypto/store/store_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",411,__func__), ERR_set_error)((44),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 411 "../crypto/store/store_meth.c" 3 4
       ((void *)0)
# 411 "../crypto/store/store_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((loader != 
# 420 "../crypto/store/store_meth.c" 3 4
        ((void *)0)
# 420 "../crypto/store/store_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",421,__func__), ERR_set_error)((44),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 421 "../crypto/store/store_meth.c" 3 4
       ((void *)0)
# 421 "../crypto/store/store_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((loader != 
# 430 "../crypto/store/store_meth.c" 3 4
        ((void *)0)
# 430 "../crypto/store/store_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_meth.c",431,__func__), ERR_set_error)((44),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 431 "../crypto/store/store_meth.c" 3 4
       ((void *)0)
# 431 "../crypto/store/store_meth.c"
       );
        return 0;
    }
...
{
    if (loader->prov != 
# 445 "../crypto/store/store_meth.c" 3 4
                       ((void *)0)
# 445 "../crypto/store/store_meth.c"
                           ) {
...
static void do_one(__attribute__((unused)) int id, void *method, void *arg)
{
                                       ...
                                       void *user_arg)
{
    ...
    methdata.libctx = libctx;
    methdata.tmp_store = 
# 475 "../crypto/store/store_meth.c" 3 4
                        ((void *)0)
# 475 "../crypto/store/store_meth.c"
                            ;
    (void)inner_loader_fetch(&methdata, 
# 476 "../crypto/store/store_meth.c" 3 4
                                       ((void *)0)
# 476 "../crypto/store/store_meth.c"
                                           , 
# 476 "../crypto/store/store_meth.c" 3 4
                                             ((void *)0) 
# 476 "../crypto/store/store_meth.c"
    ...
    if (methdata.tmp_store != 
# 480 "../crypto/store/store_meth.c" 3 4
                             ((void *)0)
# 480 "../crypto/store/store_meth.c"
                                 )
...
{
    if (loader == 
# 490 "../crypto/store/store_meth.c" 3 4
                 ((void *)0)
# 490 "../crypto/store/store_meth.c"
                     )
        return 0;

    if (loader->prov != 
# 493 "../crypto/store/store_meth.c" 3 4
                       ((void *)0)
# 493 "../crypto/store/store_meth.c"
                           ) {
        OSSL_LIB_CTX *libctx = ossl_provider_libctx(loader->prov);
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(libctx);
