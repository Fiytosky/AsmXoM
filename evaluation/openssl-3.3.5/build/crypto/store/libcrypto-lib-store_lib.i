# 0 "../crypto/store/store_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/store/store_lib.c"
# 10 "../crypto/store/store_lib.c"
...
# 12 "../crypto/store/store_lib.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 13 "../crypto/store/store_lib.c" 2
...
# 22 "../crypto/store/store_lib.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 23 "../crypto/store/store_lib.c" 2
...
# 16 "../include/openssl/param_build.h" 2
# 1 "../include/openssl/types.h" 1
...
int OSSL_STORE_do_all_loaders(void (*do_function)(const OSSL_STORE_LOADER *loader,
                                                  void *do_arg),
                              void *do_arg);
# 26 "../crypto/store/store_lib.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 27 "../crypto/store/store_lib.c" 2
...
# 31 "../crypto/store/store_lib.c" 2
# 1 "../crypto/store/store_local.h" 1
# 12 "../crypto/store/store_local.h"
...
# 13 "../crypto/store/store_local.h" 2
...
# 20 "../crypto/store/store_local.h" 2
...
{
   if (params != 
# 39 "../crypto/store/store_lib.c" 3 4
                ((void *)0)
# 39 "../crypto/store/store_lib.c"
                    ) {
   ...
   if (propq != 
# 44 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 44 "../crypto/store/store_lib.c"
                   ) {
       OSSL_PARAM propp[2];

       if (OSSL_PARAM_locate_const(params,
                                   "properties") != 
# 48 "../crypto/store/store_lib.c" 3 4
                                                                  ((void *)0)
# 48 "../crypto/store/store_lib.c"
                                                                      )

           return 1;

       propp[0] = OSSL_PARAM_construct_utf8_string("properties",
                                                   (char *)propq, 0);
                   ...
                   void *post_process_data)
{
    ...
    const OSSL_STORE_LOADER *loader = 
# 70 "../crypto/store/store_lib.c" 3 4
                                     ((void *)0)
# 70 "../crypto/store/store_lib.c"
                                         ;
    OSSL_STORE_LOADER *fetched_loader = 
# 71 "../crypto/store/store_lib.c" 3 4
                                       ((void *)0)
# 71 "../crypto/store/store_lib.c"
                                           ;
    OSSL_STORE_LOADER_CTX *loader_ctx = 
# 72 "../crypto/store/store_lib.c" 3 4
                                       ((void *)0)
# 72 "../crypto/store/store_lib.c"
                                           ;
    OSSL_STORE_CTX *ctx = 
# 73 "../crypto/store/store_lib.c" 3 4
                         ((void *)0)
# 73 "../crypto/store/store_lib.c"
                             ;
    char *propq_copy = 
# 74 "../crypto/store/store_lib.c" 3 4
                      ((void *)0)
# 74 "../crypto/store/store_lib.c"
                          ;
    int no_loader_found = 1;
    char scheme_copy[256], *p, *schemes[2], *scheme = 
# 76 "../crypto/store/store_lib.c" 3 4
                                                     ((void *)0)
# 76 "../crypto/store/store_lib.c"
                                                         ;
    size_t schemes_n = 0;
    size_t i;
...
# 94 "../crypto/store/store_lib.c"
    OPENSSL_strlcpy(scheme_copy, uri, sizeof(scheme_copy));
    if ((p = strchr(scheme_copy, ':')) != 
# 95 "../crypto/store/store_lib.c" 3 4
                                         ((void *)0)
# 95 "../crypto/store/store_lib.c"
                                             ) {
        *p++ = '\0';
    ...
    if (ui_method != 
# 106 "../crypto/store/store_lib.c" 3 4
                    ((void *)0)
        
# 107 "../crypto/store/store_lib.c"
       && (!ossl_pw_set_ui_method(&pwdata, ui_method, ui_data)
            || !ossl_pw_enable_passphrase_caching(&pwdata))) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",109,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 109 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 109 "../crypto/store/store_lib.c"
       );
        goto err;
    }
# 121 "../crypto/store/store_lib.c"
    for (i = 0; loader_ctx == 
# 121 "../crypto/store/store_lib.c" 3 4
                             ((void *)0) 
# 121 "../crypto/store/store_lib.c"
                                  && i < schemes_n; i++) {
        scheme = schemes[i];
        ...
        ERR_set_mark();
        if ((loader = ossl_store_get0_loader_int(scheme)) != 
# 126 "../crypto/store/store_lib.c" 3 4
                                                            ((void *)0)
# 126 "../crypto/store/store_lib.c"
                                                                ) {
            ERR_clear_last_mark();
            no_loader_found = 0;
            if (loader->open_ex != 
# 129 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 129 "../crypto/store/store_lib.c"
                                      )
        ...
        if (loader == 
# 138 "../crypto/store/store_lib.c" 3 4
                     ((void *)0)
            
# 139 "../crypto/store/store_lib.c"
           && (fetched_loader =
                OSSL_STORE_LOADER_fetch(libctx, scheme, propq)) != 
# 140 "../crypto/store/store_lib.c" 3 4
                                                                  ((void *)0)
# 140 "../crypto/store/store_lib.c"
                                                                      ) {
            ...
            no_loader_found = 0;
            if (fetched_loader->p_open_ex != 
# 146 "../crypto/store/store_lib.c" 3 4
                                            ((void *)0)
# 146 "../crypto/store/store_lib.c"
                                                ) {
                loader_ctx =
                ...
                if (fetched_loader->p_open != 
# 152 "../crypto/store/store_lib.c" 3 4
                                             ((void *)0) 
# 152 "../crypto/store/store_lib.c"
                                                  &&
                    (loader_ctx = fetched_loader->p_open(provctx, uri)) != 
# 153 "../crypto/store/store_lib.c" 3 4
                                                                          ((void *)0) 
# 153 "../crypto/store/store_lib.c"
                                                                               &&
                    !loader_set_params(fetched_loader, loader_ctx,
                                       params, propq)) {
                    (void)fetched_loader->p_close(loader_ctx);
                    loader_ctx = 
# 157 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 157 "../crypto/store/store_lib.c"
                                    ;
                }
            }
            if (loader_ctx == 
# 160 "../crypto/store/store_lib.c" 3 4
                             ((void *)0)
# 160 "../crypto/store/store_lib.c"
                                 ) {
                OSSL_STORE_LOADER_free(fetched_loader);
                fetched_loader = 
# 162 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 162 "../crypto/store/store_lib.c"
                                    ;
            }
    ...
    if (loader_ctx == 
# 180 "../crypto/store/store_lib.c" 3 4
                     ((void *)0)
# 180 "../crypto/store/store_lib.c"
                         )
    ...
    if ((propq != 
# 189 "../crypto/store/store_lib.c" 3 4
                 ((void *)0) 
# 189 "../crypto/store/store_lib.c"
                      && (propq_copy = CRYPTO_strdup(propq, "../crypto/store/store_lib.c", 189)) == 
# 189 "../crypto/store/store_lib.c" 3 4
                                                                 ((void *)0)
# 189 "../crypto/store/store_lib.c"
                                                                     )
        || (ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/store/store_lib.c", 190)) == 
# 190 "../crypto/store/store_lib.c" 3 4
                                                  ((void *)0)
# 190 "../crypto/store/store_lib.c"
                                                      )
        goto err;
 ...
 err:
    ERR_clear_last_mark();
    if (loader_ctx != 
# 212 "../crypto/store/store_lib.c" 3 4
                     ((void *)0)
# 212 "../crypto/store/store_lib.c"
                         ) {
...
# 217 "../crypto/store/store_lib.c" 3 4
                                 ((void *)0)
# 217 "../crypto/store/store_lib.c"
                                     , };
    ...
    OSSL_STORE_LOADER_free(fetched_loader);
    CRYPTO_free(propq_copy, "../crypto/store/store_lib.c", 233);
    CRYPTO_free(ctx, "../crypto/store/store_lib.c", 234);
    return 
# 235 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 235 "../crypto/store/store_lib.c"
              ;
}
...
OSSL_STORE_CTX *OSSL_STORE_open(const char *uri,
                                ...
                                void *post_process_data)
{
    return OSSL_STORE_open_ex(uri, 
# 243 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 243 "../crypto/store/store_lib.c"
                                      , 
# 243 "../crypto/store/store_lib.c" 3 4
                                        ((void *)0)
# 243 "../crypto/store/store_lib.c"
...
# 253 "../crypto/store/store_lib.c" 3 4
   __builtin_c23_va_start(
# 253 "../crypto/store/store_lib.c"
   args, cmd
# 253 "../crypto/store/store_lib.c" 3 4
   )
# 253 "../crypto/store/store_lib.c"
...
# 255 "../crypto/store/store_lib.c" 3 4
   __builtin_va_end(
# 255 "../crypto/store/store_lib.c"
   args
# 255 "../crypto/store/store_lib.c" 3 4
   )
# 255 "../crypto/store/store_lib.c"
...
{
    if (ctx->fetched_loader != 
# 262 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 262 "../crypto/store/store_lib.c"
                                  ) {
        if (ctx->fetched_loader->p_set_ctx_params != 
# 263 "../crypto/store/store_lib.c" 3 4
                                                    ((void *)0)
# 263 "../crypto/store/store_lib.c"
                                                        ) {
            OSSL_PARAM params[2] = { { 
# 264 "../crypto/store/store_lib.c" 3 4
                                    ((void *)0)
# 264 "../crypto/store/store_lib.c"
                                    , 0, 
# 264 "../crypto/store/store_lib.c" 3 4
                                    ((void *)0)
# 264 "../crypto/store/store_lib.c"
...
# 264 "../crypto/store/store_lib.c"
            ...
            case 1:
                {
                    int on = *(
# 269 "../crypto/store/store_lib.c" 3 4
                              __builtin_va_arg(
# 269 "../crypto/store/store_lib.c"
                              args
# 269 "../crypto/store/store_lib.c" 3 4
                              ,
# 269 "../crypto/store/store_lib.c"
...
# 269 "../crypto/store/store_lib.c"
    ...
    } else if (ctx->loader->ctrl != 
# 281 "../crypto/store/store_lib.c" 3 4
                                   ((void *)0)
# 281 "../crypto/store/store_lib.c"
                                       ) {
...
int OSSL_STORE_expect(OSSL_STORE_CTX *ctx, int expected_type)
{
    ...
    if (ctx == 
# 297 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
            
# 298 "../crypto/store/store_lib.c"
           || expected_type < 0 || expected_type > 6) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",299,__func__), ERR_set_error)((44),((262|(0x2 << 18L))),
# 299 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 299 "../crypto/store/store_lib.c"
       );
        return 0;
    }
    if (ctx->loading) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",303,__func__), ERR_set_error)((44),(117),
# 303 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 303 "../crypto/store/store_lib.c"
       );
        return 0;
    }
    ...
    if (ctx->fetched_loader != 
# 308 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
        
# 309 "../crypto/store/store_lib.c"
       && ctx->fetched_loader->p_set_ctx_params != 
# 309 "../crypto/store/store_lib.c" 3 4
                                                   ((void *)0)
# 309 "../crypto/store/store_lib.c"
                                                       ) {
        OSSL_PARAM params[2] = { { 
# 310 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 310 "../crypto/store/store_lib.c"
                                , 0, 
# 310 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 310 "../crypto/store/store_lib.c"
...
# 310 "../crypto/store/store_lib.c"
        ...
        params[0] =
            OSSL_PARAM_construct_int("expect", &expected_type);
        ret = ctx->fetched_loader->p_set_ctx_params(ctx->loader_ctx, params);
    }

    if (ctx->fetched_loader == 
# 317 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
        
# 318 "../crypto/store/store_lib.c"
       && ctx->loader->expect != 
# 318 "../crypto/store/store_lib.c" 3 4
                                 ((void *)0)
# 318 "../crypto/store/store_lib.c"
                                     ) {
...
int OSSL_STORE_find(OSSL_STORE_CTX *ctx, const OSSL_STORE_SEARCH *search)
{
    ...
    if (ctx->loading) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",330,__func__), ERR_set_error)((44),(117),
# 330 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 330 "../crypto/store/store_lib.c"
       );
        return 0;
    }
    if (search == 
# 333 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 333 "../crypto/store/store_lib.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",334,__func__), ERR_set_error)((44),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 334 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 334 "../crypto/store/store_lib.c"
       );
        return 0;
    }

    if (ctx->fetched_loader != 
# 338 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 338 "../crypto/store/store_lib.c"
                                  ) {
        OSSL_PARAM_BLD *bld;
        OSSL_PARAM *params;

        void *name_der = 
# 342 "../crypto/store/store_lib.c" 3 4
                        ((void *)0)
# 342 "../crypto/store/store_lib.c"
                            ;
        int name_der_sz;

        BIGNUM *number = 
# 345 "../crypto/store/store_lib.c" 3 4
                        ((void *)0)
# 345 "../crypto/store/store_lib.c"
                            ;

        if (ctx->fetched_loader->p_set_ctx_params == 
# 347 "../crypto/store/store_lib.c" 3 4
                                                    ((void *)0)
# 347 "../crypto/store/store_lib.c"
                                                        ) {
            (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",348,__func__), ERR_set_error)((44),(118),
# 348 "../crypto/store/store_lib.c" 3 4
           ((void *)0)
# 348 "../crypto/store/store_lib.c"
           );
            return 0;
        }

        if ((bld = OSSL_PARAM_BLD_new()) == 
# 352 "../crypto/store/store_lib.c" 3 4
                                           ((void *)0)
# 352 "../crypto/store/store_lib.c"
                                               ) {
            (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",353,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 353 "../crypto/store/store_lib.c" 3 4
           ((void *)0)
# 353 "../crypto/store/store_lib.c"
           );
            return 0;
        }
        ...
        case 2:
            if ((name_der_sz = i2d_X509_NAME(search->name,
                                             (unsigned char **)&name_der)) > 0
                && (number = ASN1_INTEGER_to_BN(search->serial, 
# 371 "../crypto/store/store_lib.c" 3 4
                                                               ((void *)0)
# 371 "../crypto/store/store_lib.c"
                                                                   )) != 
# 371 "../crypto/store/store_lib.c" 3 4
                                                                         ((void *)0)
                
# 372 "../crypto/store/store_lib.c"
               && OSSL_PARAM_BLD_push_octet_string(bld,
                                                    "name",
                                                    name_der, name_der_sz)
                && OSSL_PARAM_BLD_push_BN(bld, "serial",
                                          number))
                ret = 1;
            break;
        case 3:
            if (OSSL_PARAM_BLD_push_utf8_string(bld, "digest",
            ...
            break;
        case 4:
            if (OSSL_PARAM_BLD_push_utf8_string(bld, "alias",
                                                (char *)search->string,
                                                search->stringlength))
                ret = 1;
            break;
        ...
        CRYPTO_free(name_der, "../crypto/store/store_lib.c", 403);
        BN_free(number);
    } else {


        if (ctx->loader->find == 
# 408 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 408 "../crypto/store/store_lib.c"
                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",409,__func__), ERR_set_error)((44),(118),
# 409 "../crypto/store/store_lib.c" 3 4
           ((void *)0)
# 409 "../crypto/store/store_lib.c"
           );
            return 0;
        }
...
{
    OSSL_STORE_INFO *v = 
# 421 "../crypto/store/store_lib.c" 3 4
                        ((void *)0)
# 421 "../crypto/store/store_lib.c"
                            ;
 ...
 again:
    if (OSSL_STORE_eof(ctx))
        return 
# 426 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 426 "../crypto/store/store_lib.c"
                  ;

    if (ctx->loader != 
# 428 "../crypto/store/store_lib.c" 3 4
                      ((void *)0)
# 428 "../crypto/store/store_lib.c"
                          )
        ((void)0);

    if (ctx->cached_info != 
# 431 "../crypto/store/store_lib.c" 3 4
                           ((void *)0)
# 431 "../crypto/store/store_lib.c"
                               ) {
        v = sk_OSSL_STORE_INFO_shift(ctx->cached_info);
    } else {
        if (ctx->fetched_loader != 
# 434 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 434 "../crypto/store/store_lib.c"
                                      ) {
            struct ossl_load_result_data_st load_data;

            load_data.v = 
# 437 "../crypto/store/store_lib.c" 3 4
                         ((void *)0)
# 437 "../crypto/store/store_lib.c"
                             ;
            load_data.ctx = ctx;
            ctx->error_flag = 0;
            ...
            if (!ctx->fetched_loader->p_load(ctx->loader_ctx,
                ...
                ctx->error_flag = 1;
                return 
# 447 "../crypto/store/store_lib.c" 3 4
                      ((void *)0)
# 447 "../crypto/store/store_lib.c"
                          ;
            }
            v = load_data.v;
        }
        ...
        if (ctx->fetched_loader == 
# 452 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 452 "../crypto/store/store_lib.c"
                                      )
    ...
    if (ctx->post_process != 
# 459 "../crypto/store/store_lib.c" 3 4
                            ((void *)0) 
# 459 "../crypto/store/store_lib.c"
                                 && v != 
# 459 "../crypto/store/store_lib.c" 3 4
                                         ((void *)0)
# 459 "../crypto/store/store_lib.c"
        ...
        if (v == 
# 466 "../crypto/store/store_lib.c" 3 4
                ((void *)0)
# 466 "../crypto/store/store_lib.c"
                    )
            goto again;
    }
    ...
    if (v != 
# 473 "../crypto/store/store_lib.c" 3 4
            ((void *)0) 
# 473 "../crypto/store/store_lib.c"
                 && ctx->expected_type != 0) {
        int returned_type = OSSL_STORE_INFO_get_type(v);

        if (returned_type != 1 && returned_type != 0) {
    ...
    if (v != 
# 484 "../crypto/store/store_lib.c" 3 4
            ((void *)0)
# 484 "../crypto/store/store_lib.c"
                )
        ((void)0)
                                                                             ;
...
{
    OSSL_STORE_LOADER *fetched_loader = 
# 495 "../crypto/store/store_lib.c" 3 4
                                       ((void *)0)
# 495 "../crypto/store/store_lib.c"
                                           ;
    char scheme[256], *p;
    int res = 0;
    struct ossl_passphrase_data_st pwdata = {0};
    ...
    if ((p = strchr(scheme, ':')) != 
# 501 "../crypto/store/store_lib.c" 3 4
                                    ((void *)0)
# 501 "../crypto/store/store_lib.c"
                                        )
        *p++ = '\0';
    else
        return 0;
    ...
    if (ui_method != 
# 506 "../crypto/store/store_lib.c" 3 4
                    ((void *)0)
        
# 507 "../crypto/store/store_lib.c"
       && (!ossl_pw_set_ui_method(&pwdata, ui_method, ui_data)
            || !ossl_pw_enable_passphrase_caching(&pwdata))) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",509,__func__), ERR_set_error)((44),((15 | (0x2 << 18L))),
# 509 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 509 "../crypto/store/store_lib.c"
       );
        return 0;
    }
    ...
    if (fetched_loader != 
# 516 "../crypto/store/store_lib.c" 3 4
                         ((void *)0) 
# 516 "../crypto/store/store_lib.c"
                              && fetched_loader->p_delete != 
# 516 "../crypto/store/store_lib.c" 3 4
                                                             ((void *)0)
# 516 "../crypto/store/store_lib.c"
                                                                 ) {
...
int OSSL_STORE_error(OSSL_STORE_CTX *ctx)
{
    ...
    if (ctx->fetched_loader != 
# 542 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 542 "../crypto/store/store_lib.c"
                                  )
        ret = ctx->error_flag;

    if (ctx->fetched_loader == 
# 545 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 545 "../crypto/store/store_lib.c"
                                  )
...
int OSSL_STORE_eof(OSSL_STORE_CTX *ctx)
{
    ...
    if (ctx->cached_info != 
# 555 "../crypto/store/store_lib.c" 3 4
                           ((void *)0)
        
# 556 "../crypto/store/store_lib.c"
       && sk_OSSL_STORE_INFO_num(ctx->cached_info) == 0) {
        sk_OSSL_STORE_INFO_free(ctx->cached_info);
        ctx->cached_info = 
# 558 "../crypto/store/store_lib.c" 3 4
                          ((void *)0)
# 558 "../crypto/store/store_lib.c"
                              ;
    }

    if (ctx->cached_info == 
# 561 "../crypto/store/store_lib.c" 3 4
                           ((void *)0)
# 561 "../crypto/store/store_lib.c"
                               ) {
        ret = 1;
        if (ctx->fetched_loader != 
# 563 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 563 "../crypto/store/store_lib.c"
                                      )
            ret = ctx->loader->p_eof(ctx->loader_ctx);

        if (ctx->fetched_loader == 
# 566 "../crypto/store/store_lib.c" 3 4
                                  ((void *)0)
# 566 "../crypto/store/store_lib.c"
                                      )
...
static int ossl_store_close_it(OSSL_STORE_CTX *ctx)
{
    ...
    if (ctx == 
# 577 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 577 "../crypto/store/store_lib.c"
                  )
        return 1;
    ((void)0);

    if (ctx->fetched_loader != 
# 581 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 581 "../crypto/store/store_lib.c"
                                  )
        ret = ctx->loader->p_close(ctx->loader_ctx);

    if (ctx->fetched_loader == 
# 584 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 584 "../crypto/store/store_lib.c"
                                  )
    ...
    CRYPTO_free(ctx->properties, "../crypto/store/store_lib.c", 590);
...
int OSSL_STORE_close(OSSL_STORE_CTX *ctx)
{
    ...
    CRYPTO_free(ctx, "../crypto/store/store_lib.c", 599);
    return ret;
}
# 610 "../crypto/store/store_lib.c"
OSSL_STORE_INFO *OSSL_STORE_INFO_new(int type, void *data)
{
    OSSL_STORE_INFO *info = CRYPTO_zalloc(sizeof(*info), "../crypto/store/store_lib.c", 612);

    if (info == 
# 614 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 614 "../crypto/store/store_lib.c"
                   )
        return 
# 615 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 615 "../crypto/store/store_lib.c"
                  ;
...
OSSL_STORE_INFO *OSSL_STORE_INFO_new_NAME(char *name)
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(1, 
# 624 "../crypto/store/store_lib.c" 3 4
                                                                     ((void *)0)
# 624 "../crypto/store/store_lib.c"
                                                                         );

    if (info == 
# 626 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 626 "../crypto/store/store_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",627,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 627 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 627 "../crypto/store/store_lib.c"
       );
        return 
# 628 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 628 "../crypto/store/store_lib.c"
                  ;
    }

    info->_.name.name = name;
    info->_.name.desc = 
# 632 "../crypto/store/store_lib.c" 3 4
                       ((void *)0)
# 632 "../crypto/store/store_lib.c"
                           ;
...
{
    if (info->type != 1) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",640,__func__), ERR_set_error)((44),((262|(0x2 << 18L))),
# 640 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 640 "../crypto/store/store_lib.c"
       );
        return 0;
    }
...
OSSL_STORE_INFO *OSSL_STORE_INFO_new_PARAMS(EVP_PKEY *params)
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(2, params);

    if (info == 
# 652 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 652 "../crypto/store/store_lib.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",653,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 653 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 653 "../crypto/store/store_lib.c"
       );
    return info;
}
...
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(3, pkey);

    if (info == 
# 661 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 661 "../crypto/store/store_lib.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",662,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 662 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 662 "../crypto/store/store_lib.c"
       );
    return info;
}
...
OSSL_STORE_INFO *OSSL_STORE_INFO_new_PKEY(EVP_PKEY *pkey)
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(4, pkey);

    if (info == 
# 670 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 670 "../crypto/store/store_lib.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",671,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 671 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 671 "../crypto/store/store_lib.c"
       );
    return info;
}
...
OSSL_STORE_INFO *OSSL_STORE_INFO_new_CERT(X509 *x509)
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(5, x509);

    if (info == 
# 679 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 679 "../crypto/store/store_lib.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",680,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 680 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 680 "../crypto/store/store_lib.c"
       );
    return info;
}
...
OSSL_STORE_INFO *OSSL_STORE_INFO_new_CRL(X509_CRL *crl)
{
    OSSL_STORE_INFO *info = OSSL_STORE_INFO_new(6, crl);

    if (info == 
# 688 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 688 "../crypto/store/store_lib.c"
                   )
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",689,__func__), ERR_set_error)((44),((44 | (0x2 << 18L))),
# 689 "../crypto/store/store_lib.c" 3 4
       ((void *)0)
# 689 "../crypto/store/store_lib.c"
       );
    return info;
}
...
void *OSSL_STORE_INFO_get0_data(int type, const OSSL_STORE_INFO *info)
{
    if (info->type == type)
        return info->_.data;
    return 
# 705 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 705 "../crypto/store/store_lib.c"
              ;
}
...
const char *OSSL_STORE_INFO_get0_NAME(const OSSL_STORE_INFO *info)
{
    ...
    return 
# 712 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 712 "../crypto/store/store_lib.c"
              ;
}
...
{
    if (info->type == 1)
        return CRYPTO_strdup(info->_.name.name, "../crypto/store/store_lib.c", 718);
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",719,__func__), ERR_set_error)((44),(103),
# 719 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 719 "../crypto/store/store_lib.c"
   );
    return 
# 720 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 720 "../crypto/store/store_lib.c"
              ;
}
...
const char *OSSL_STORE_INFO_get0_NAME_description(const OSSL_STORE_INFO *info)
{
    ...
    return 
# 727 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 727 "../crypto/store/store_lib.c"
              ;
}
...
{
    if (info->type == 1)
        return CRYPTO_strdup(info->_.name.desc ? info->_.name.desc : "", "../crypto/store/store_lib.c", 733);
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",734,__func__), ERR_set_error)((44),(103),
# 734 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 734 "../crypto/store/store_lib.c"
   );
    return 
# 735 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 735 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get0_PARAMS(const OSSL_STORE_INFO *info)
{
    ...
    return 
# 742 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 742 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get1_PARAMS(const OSSL_STORE_INFO *info)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",751,__func__), ERR_set_error)((44),(104),
# 751 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 751 "../crypto/store/store_lib.c"
   );
    return 
# 752 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 752 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get0_PUBKEY(const OSSL_STORE_INFO *info)
{
    ...
    return 
# 759 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 759 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get1_PUBKEY(const OSSL_STORE_INFO *info)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",768,__func__), ERR_set_error)((44),(122),
# 768 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 768 "../crypto/store/store_lib.c"
   );
    return 
# 769 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 769 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get0_PKEY(const OSSL_STORE_INFO *info)
{
    if (info->type == 4)
        return info->_.pkey;
    return 
# 776 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 776 "../crypto/store/store_lib.c"
              ;
}
...
EVP_PKEY *OSSL_STORE_INFO_get1_PKEY(const OSSL_STORE_INFO *info)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",785,__func__), ERR_set_error)((44),(102),
# 785 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 785 "../crypto/store/store_lib.c"
   );
    return 
# 786 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 786 "../crypto/store/store_lib.c"
              ;
}
...
X509 *OSSL_STORE_INFO_get0_CERT(const OSSL_STORE_INFO *info)
{
    if (info->type == 5)
        return info->_.x509;
    return 
# 793 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 793 "../crypto/store/store_lib.c"
              ;
}
...
X509 *OSSL_STORE_INFO_get1_CERT(const OSSL_STORE_INFO *info)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",802,__func__), ERR_set_error)((44),(100),
# 802 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 802 "../crypto/store/store_lib.c"
   );
    return 
# 803 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 803 "../crypto/store/store_lib.c"
              ;
}
...
X509_CRL *OSSL_STORE_INFO_get0_CRL(const OSSL_STORE_INFO *info)
{
    if (info->type == 6)
        return info->_.crl;
    return 
# 810 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 810 "../crypto/store/store_lib.c"
              ;
}
...
X509_CRL *OSSL_STORE_INFO_get1_CRL(const OSSL_STORE_INFO *info)
{
    ...
    (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",819,__func__), ERR_set_error)((44),(101),
# 819 "../crypto/store/store_lib.c" 3 4
   ((void *)0)
# 819 "../crypto/store/store_lib.c"
   );
    return 
# 820 "../crypto/store/store_lib.c" 3 4
          ((void *)0)
# 820 "../crypto/store/store_lib.c"
              ;
}
...
{
    if (info != 
# 828 "../crypto/store/store_lib.c" 3 4
               ((void *)0)
# 828 "../crypto/store/store_lib.c"
                   ) {
        switch (info->type) {
        case 1:
            CRYPTO_free(info->_.name.name, "../crypto/store/store_lib.c", 831);
            CRYPTO_free(info->_.name.desc, "../crypto/store/store_lib.c", 832);
            break;
        case 2:
        ...
        CRYPTO_free(info, "../crypto/store/store_lib.c", 850);
    }
}
...
int OSSL_STORE_supports_search(OSSL_STORE_CTX *ctx, int search_type)
{
    ...
    if (ctx->fetched_loader != 
# 858 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 858 "../crypto/store/store_lib.c"
                                  ) {
        void *provctx =
            ossl_provider_ctx(OSSL_STORE_LOADER_get0_provider(ctx->fetched_loader));
        const OSSL_PARAM *params;
        const OSSL_PARAM *p_subject = 
# 862 "../crypto/store/store_lib.c" 3 4
                                     ((void *)0)
# 862 "../crypto/store/store_lib.c"
                                         ;
        const OSSL_PARAM *p_issuer = 
# 863 "../crypto/store/store_lib.c" 3 4
                                    ((void *)0)
# 863 "../crypto/store/store_lib.c"
                                        ;
        const OSSL_PARAM *p_serial = 
# 864 "../crypto/store/store_lib.c" 3 4
                                    ((void *)0)
# 864 "../crypto/store/store_lib.c"
                                        ;
        const OSSL_PARAM *p_fingerprint = 
# 865 "../crypto/store/store_lib.c" 3 4
                                         ((void *)0)
# 865 "../crypto/store/store_lib.c"
                                             ;
        const OSSL_PARAM *p_alias = 
# 866 "../crypto/store/store_lib.c" 3 4
                                   ((void *)0)
# 866 "../crypto/store/store_lib.c"
                                       ;

        if (ctx->fetched_loader->p_settable_ctx_params == 
# 868 "../crypto/store/store_lib.c" 3 4
                                                         ((void *)0)
# 868 "../crypto/store/store_lib.c"
                                                             )
            return 0;

        params = ctx->fetched_loader->p_settable_ctx_params(provctx);
        p_subject = OSSL_PARAM_locate_const(params, "subject");
        p_issuer = OSSL_PARAM_locate_const(params, "name");
        p_serial = OSSL_PARAM_locate_const(params, "serial");
        p_fingerprint =
            OSSL_PARAM_locate_const(params, "fingerprint");
        p_alias = OSSL_PARAM_locate_const(params, "alias");

        switch (search_type) {
        case 1:
            ret = (p_subject != 
# 881 "../crypto/store/store_lib.c" 3 4
                               ((void *)0)
# 881 "../crypto/store/store_lib.c"
                                   );
            break;
        case 2:
            ret = (p_issuer != 
# 884 "../crypto/store/store_lib.c" 3 4
                              ((void *)0) 
# 884 "../crypto/store/store_lib.c"
                                   && p_serial != 
# 884 "../crypto/store/store_lib.c" 3 4
                                                  ((void *)0)
# 884 "../crypto/store/store_lib.c"
        ...
        case 3:
            ret = (p_fingerprint != 
# 887 "../crypto/store/store_lib.c" 3 4
                                   ((void *)0)
# 887 "../crypto/store/store_lib.c"
                                       );
            break;
        case 4:
            ret = (p_alias != 
# 890 "../crypto/store/store_lib.c" 3 4
                             ((void *)0)
# 890 "../crypto/store/store_lib.c"
                                 );
            break;
        }
    }
    ...
    if (ctx->fetched_loader == 
# 895 "../crypto/store/store_lib.c" 3 4
                              ((void *)0)
# 895 "../crypto/store/store_lib.c"
                                  ) {
        OSSL_STORE_SEARCH tmp_search;

        if (ctx->loader->find == 
# 898 "../crypto/store/store_lib.c" 3 4
                                ((void *)0)
# 898 "../crypto/store/store_lib.c"
                                    )
            return 0;
        tmp_search.search_type = search_type;
        ret = ctx->loader->find(
# 901 "../crypto/store/store_lib.c" 3 4
                               ((void *)0)
# 901 "../crypto/store/store_lib.c"
                                   , &tmp_search);
    }
...
OSSL_STORE_SEARCH *OSSL_STORE_SEARCH_by_name(X509_NAME *name)
{
    OSSL_STORE_SEARCH *search = CRYPTO_zalloc(sizeof(*search), "../crypto/store/store_lib.c", 910);

    if (search == 
# 912 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 912 "../crypto/store/store_lib.c"
                     )
        return 
# 913 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 913 "../crypto/store/store_lib.c"
                  ;
...
OSSL_STORE_SEARCH *OSSL_STORE_SEARCH_by_issuer_serial(X509_NAME *name,
                                                      const ASN1_INTEGER *serial)
{
    OSSL_STORE_SEARCH *search = CRYPTO_zalloc(sizeof(*search), "../crypto/store/store_lib.c", 923);

    if (search == 
# 925 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 925 "../crypto/store/store_lib.c"
                     )
        return 
# 926 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 926 "../crypto/store/store_lib.c"
                  ;
...
OSSL_STORE_SEARCH *OSSL_STORE_SEARCH_by_key_fingerprint(const EVP_MD *digest,
                                                        ...
                                                        *bytes, size_t len)
{
    OSSL_STORE_SEARCH *search = CRYPTO_zalloc(sizeof(*search), "../crypto/store/store_lib.c", 938);

    if (search == 
# 940 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 940 "../crypto/store/store_lib.c"
                     )
        return 
# 941 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 941 "../crypto/store/store_lib.c"
                  ;

    if (digest != 
# 943 "../crypto/store/store_lib.c" 3 4
                 ((void *)0) 
# 943 "../crypto/store/store_lib.c"
                      && len != (size_t)EVP_MD_get_size(digest)) {
        (ERR_new(), ERR_set_debug("../crypto/store/store_lib.c",944,__func__), ERR_set_error)(44,
                       121,
                       "%s size is %d, fingerprint size is %zu",
                       EVP_MD_get0_name(digest), EVP_MD_get_size(digest), len);
        CRYPTO_free(search, "../crypto/store/store_lib.c", 948);
        return 
# 949 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 949 "../crypto/store/store_lib.c"
                  ;
    }
...
OSSL_STORE_SEARCH *OSSL_STORE_SEARCH_by_alias(const char *alias)
{
    OSSL_STORE_SEARCH *search = CRYPTO_zalloc(sizeof(*search), "../crypto/store/store_lib.c", 961);

    if (search == 
# 963 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 963 "../crypto/store/store_lib.c"
                     )
        return 
# 964 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 964 "../crypto/store/store_lib.c"
                  ;

    search->search_type = 4;
...
void OSSL_STORE_SEARCH_free(OSSL_STORE_SEARCH *search)
{
    CRYPTO_free(search, "../crypto/store/store_lib.c", 975);
}
...
{
    const OSSL_STORE_LOADER *loader = 
# 1019 "../crypto/store/store_lib.c" 3 4
                                     ((void *)0)
# 1019 "../crypto/store/store_lib.c"
                                         ;
    OSSL_STORE_LOADER *fetched_loader = 
# 1020 "../crypto/store/store_lib.c" 3 4
                                       ((void *)0)
# 1020 "../crypto/store/store_lib.c"
                                           ;
    OSSL_STORE_LOADER_CTX *loader_ctx = 
# 1021 "../crypto/store/store_lib.c" 3 4
                                       ((void *)0)
# 1021 "../crypto/store/store_lib.c"
                                           ;
    OSSL_STORE_CTX *ctx = 
# 1022 "../crypto/store/store_lib.c" 3 4
                         ((void *)0)
# 1022 "../crypto/store/store_lib.c"
                             ;

    if (scheme == 
# 1024 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
# 1024 "../crypto/store/store_lib.c"
                     )
        scheme = "file";
    ...
    if ((loader = ossl_store_get0_loader_int(scheme)) != 
# 1030 "../crypto/store/store_lib.c" 3 4
                                                        ((void *)0)
# 1030 "../crypto/store/store_lib.c"
                                                            )
        loader_ctx = loader->attach(loader, bp, libctx, propq,
                                    ui_method, ui_data);

    if (loader == 
# 1034 "../crypto/store/store_lib.c" 3 4
                 ((void *)0)
        
# 1035 "../crypto/store/store_lib.c"
       && (fetched_loader =
            OSSL_STORE_LOADER_fetch(libctx, scheme, propq)) != 
# 1036 "../crypto/store/store_lib.c" 3 4
                                                              ((void *)0)
# 1036 "../crypto/store/store_lib.c"
                                                                  ) {
        const OSSL_PROVIDER *provider =
            OSSL_STORE_LOADER_get0_provider(fetched_loader);
        void *provctx = OSSL_PROVIDER_get0_provider_ctx(provider);
        ...
        if (cbio == 
# 1042 "../crypto/store/store_lib.c" 3 4
                   ((void *)0)
            
# 1043 "../crypto/store/store_lib.c"
           || fetched_loader->p_attach == 
# 1043 "../crypto/store/store_lib.c" 3 4
                                          ((void *)0)
            
# 1044 "../crypto/store/store_lib.c"
           || (loader_ctx = fetched_loader->p_attach(provctx, cbio)) == 
# 1044 "../crypto/store/store_lib.c" 3 4
                                                                        ((void *)0)
# 1044 "../crypto/store/store_lib.c"
                                                                            ) {
            OSSL_STORE_LOADER_free(fetched_loader);
            fetched_loader = 
# 1046 "../crypto/store/store_lib.c" 3 4
                            ((void *)0)
# 1046 "../crypto/store/store_lib.c"
                                ;
            ...
            OSSL_STORE_LOADER_free(fetched_loader);
            fetched_loader = 
# 1051 "../crypto/store/store_lib.c" 3 4
                            ((void *)0)
# 1051 "../crypto/store/store_lib.c"
                                ;
        }
        loader = fetched_loader;
    ...
    if (loader_ctx == 
# 1057 "../crypto/store/store_lib.c" 3 4
                     ((void *)0)
# 1057 "../crypto/store/store_lib.c"
                         ) {
        ERR_clear_last_mark();
        return 
# 1059 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 1059 "../crypto/store/store_lib.c"
                  ;
    }

    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/store/store_lib.c", 1062)) == 
# 1062 "../crypto/store/store_lib.c" 3 4
                                               ((void *)0)
# 1062 "../crypto/store/store_lib.c"
                                                   ) {
        ERR_clear_last_mark();
        return 
# 1064 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 1064 "../crypto/store/store_lib.c"
                  ;
    }

    if (ui_method != 
# 1067 "../crypto/store/store_lib.c" 3 4
                    ((void *)0)
        
# 1068 "../crypto/store/store_lib.c"
       && !ossl_pw_set_ui_method(&ctx->pwdata, ui_method, ui_data)) {
        ERR_clear_last_mark();
        CRYPTO_free(ctx, "../crypto/store/store_lib.c", 1070);
        return 
# 1071 "../crypto/store/store_lib.c" 3 4
              ((void *)0)
# 1071 "../crypto/store/store_lib.c"
                  ;
    }
