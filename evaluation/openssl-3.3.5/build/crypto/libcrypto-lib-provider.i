...
# 14 "../crypto/provider.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../crypto/provider.c" 2
...
int ossl_provider_info_add_parameter(OSSL_PROVIDER_INFO *provinfo,
                                     const char *name,
                                     const char *value);
# 17 "../crypto/provider.c" 2

OSSL_PROVIDER *OSSL_PROVIDER_try_load_ex(OSSL_LIB_CTX *libctx, const char *name,
                                         OSSL_PARAM *params, int retain_fallbacks)
{
    OSSL_PROVIDER *prov = 
# 21 "../crypto/provider.c" 3 4
                         ((void *)0)
# 21 "../crypto/provider.c"
                             , *actual;
    int isnew = 0;


    if ((prov = ossl_provider_find(libctx, name, 0)) == 
# 25 "../crypto/provider.c" 3 4
                                                       ((void *)0)
# 25 "../crypto/provider.c"
                                                           ) {
        if ((prov = ossl_provider_new(libctx, name, 
# 26 "../crypto/provider.c" 3 4
                                                   ((void *)0)
# 26 "../crypto/provider.c"
                                                       , params, 0)) == 
# 26 "../crypto/provider.c" 3 4
                                                                        ((void *)0)
# 26 "../crypto/provider.c"
            ...
            return 
# 27 "../crypto/provider.c" 3 4
                  ((void *)0)
# 27 "../crypto/provider.c"
                      ;
        isnew = 1;
    }
    ...
    if (!ossl_provider_activate(prov, 1, 0)) {
        ...
        return 
# 33 "../crypto/provider.c" 3 4
              ((void *)0)
# 33 "../crypto/provider.c"
                  ;
    }
    ...
    if (isnew && !ossl_provider_add_to_store(prov, &actual, retain_fallbacks)) {
        ...
        ossl_provider_free(prov);
        return 
# 40 "../crypto/provider.c" 3 4
              ((void *)0)
# 40 "../crypto/provider.c"
                  ;
    }
    if (actual != prov) {
        if (!ossl_provider_activate(actual, 1, 0)) {
            ...
            return 
# 45 "../crypto/provider.c" 3 4
                  ((void *)0)
# 45 "../crypto/provider.c"
                      ;
        }
    }
...
OSSL_PROVIDER *OSSL_PROVIDER_try_load(OSSL_LIB_CTX *libctx, const char *name,
                                      int retain_fallbacks)
{
    return OSSL_PROVIDER_try_load_ex(libctx, name, 
# 55 "../crypto/provider.c" 3 4
                                                  ((void *)0)
# 55 "../crypto/provider.c"
                                                      , retain_fallbacks);
}
...
OSSL_PROVIDER *OSSL_PROVIDER_load_ex(OSSL_LIB_CTX *libctx, const char *name, OSSL_PARAM *params)
{
    ...
    return 
# 63 "../crypto/provider.c" 3 4
          ((void *)0)
# 63 "../crypto/provider.c"
              ;
}

OSSL_PROVIDER *OSSL_PROVIDER_load(OSSL_LIB_CTX *libctx, const char *name)
{
    return OSSL_PROVIDER_load_ex(libctx, name, 
# 68 "../crypto/provider.c" 3 4
                                              ((void *)0)
# 68 "../crypto/provider.c"
                                                  );
}
                              ...
                              OSSL_provider_init_fn *init_fn)
{
    ...
    if (name == 
# 131 "../crypto/provider.c" 3 4
               ((void *)0) 
# 131 "../crypto/provider.c"
                    || init_fn == 
# 131 "../crypto/provider.c" 3 4
                                  ((void *)0)
# 131 "../crypto/provider.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/provider.c",132,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 132 "../crypto/provider.c" 3 4
       ((void *)0)
# 132 "../crypto/provider.c"
       );
        return 0;
    }
    memset(&entry, 0, sizeof(entry));
    entry.name = CRYPTO_strdup(name, "../crypto/provider.c", 136);
    if (entry.name == 
# 137 "../crypto/provider.c" 3 4
                     ((void *)0)
# 137 "../crypto/provider.c"
                         )
        return 0;
    entry.init = init_fn;
