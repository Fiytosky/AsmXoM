# 0 "../crypto/ffc/ffc_dh.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_dh.c"
# 10 "../crypto/ffc/ffc_dh.c"
...
# 11 "../crypto/ffc/ffc_dh.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 12 "../crypto/ffc/ffc_dh.c" 2
...
# 13 "../crypto/ffc/ffc_dh.c" 2
# 48 "../crypto/ffc/ffc_dh.c"
...
static const DH_NAMED_GROUP dh_named_groups[] = {
    { "ffdhe2048", 1126, 2048, 225, &ossl_bignum_ffdhe2048_p, &ossl_bignum_ffdhe2048_q, &ossl_bignum_const_2, },
    { "ffdhe3072", 1127, 3072, 275, &ossl_bignum_ffdhe3072_p, &ossl_bignum_ffdhe3072_q, &ossl_bignum_const_2, },
    { "ffdhe4096", 1128, 4096, 325, &ossl_bignum_ffdhe4096_p, &ossl_bignum_ffdhe4096_q, &ossl_bignum_const_2, },
    { "ffdhe6144", 1129, 6144, 375, &ossl_bignum_ffdhe6144_p, &ossl_bignum_ffdhe6144_q, &ossl_bignum_const_2, },
    { "ffdhe8192", 1130, 8192, 400, &ossl_bignum_ffdhe8192_p, &ossl_bignum_ffdhe8192_q, &ossl_bignum_const_2, },

    { "modp_1536", 1212, 1536, 200, &ossl_bignum_modp_1536_p, &ossl_bignum_modp_1536_q, &ossl_bignum_const_2 },

    { "modp_2048", 1213, 2048, 225, &ossl_bignum_modp_2048_p, &ossl_bignum_modp_2048_q, &ossl_bignum_const_2 },
    { "modp_3072", 1214, 3072, 275, &ossl_bignum_modp_3072_p, &ossl_bignum_modp_3072_q, &ossl_bignum_const_2 },
    { "modp_4096", 1215, 4096, 325, &ossl_bignum_modp_4096_p, &ossl_bignum_modp_4096_q, &ossl_bignum_const_2 },
    { "modp_6144", 1216, 6144, 375, &ossl_bignum_modp_6144_p, &ossl_bignum_modp_6144_q, &ossl_bignum_const_2 },
    { "modp_8192", 1217, 8192, 400, &ossl_bignum_modp_8192_p, &ossl_bignum_modp_8192_q, &ossl_bignum_const_2 },





    { "dh_1024_160", 1, 1024, 0, &ossl_bignum_dh1024_160_p, &ossl_bignum_dh1024_160_q, &ossl_bignum_dh1024_160_g },
    { "dh_2048_224", 2, 2048, 0, &ossl_bignum_dh2048_224_p, &ossl_bignum_dh2048_224_q, &ossl_bignum_dh2048_224_g },
    { "dh_2048_256", 3, 2048, 0, &ossl_bignum_dh2048_256_p, &ossl_bignum_dh2048_256_q, &ossl_bignum_dh2048_256_g },
...
const DH_NAMED_GROUP *ossl_ffc_name_to_dh_named_group(const char *name)
{
    ...
    for (i = 0; i < (sizeof(dh_named_groups)/sizeof((dh_named_groups)[0])); ++i) {
        if (OPENSSL_strcasecmp(dh_named_groups[i].name, name) == 0)
            return &dh_named_groups[i];
    }
    return 
# 98 "../crypto/ffc/ffc_dh.c" 3 4
          ((void *)0)
# 98 "../crypto/ffc/ffc_dh.c"
              ;
}
...
const DH_NAMED_GROUP *ossl_ffc_uid_to_dh_named_group(int uid)
{
    ...
    return 
# 109 "../crypto/ffc/ffc_dh.c" 3 4
          ((void *)0)
# 109 "../crypto/ffc/ffc_dh.c"
              ;
}
                                                         ...
                                                         const BIGNUM *g)
{
    ...
    for (i = 0; i < (sizeof(dh_named_groups)/sizeof((dh_named_groups)[0])); ++i) {
        ...
        if (BN_cmp(p, dh_named_groups[i].p) == 0
            ...
            && (q == 
# 124 "../crypto/ffc/ffc_dh.c" 3 4
                    ((void *)0) 
# 124 "../crypto/ffc/ffc_dh.c"
                         || BN_cmp(q, dh_named_groups[i].q) == 0))
            return &dh_named_groups[i];
    }
    return 
# 127 "../crypto/ffc/ffc_dh.c" 3 4
          ((void *)0)
# 127 "../crypto/ffc/ffc_dh.c"
              ;
}
...
{
    if (group == 
# 133 "../crypto/ffc/ffc_dh.c" 3 4
                ((void *)0)
# 133 "../crypto/ffc/ffc_dh.c"
                    )
        return 0;
    return group->uid;
}
...
{
    if (group == 
# 140 "../crypto/ffc/ffc_dh.c" 3 4
                ((void *)0)
# 140 "../crypto/ffc/ffc_dh.c"
                    )
        return 
# 141 "../crypto/ffc/ffc_dh.c" 3 4
              ((void *)0)
# 141 "../crypto/ffc/ffc_dh.c"
                  ;
    return group->name;
}
...
{
    if (group == 
# 148 "../crypto/ffc/ffc_dh.c" 3 4
                ((void *)0)
# 148 "../crypto/ffc/ffc_dh.c"
                    )
        return 0;
...
{
    if (group == 
# 155 "../crypto/ffc/ffc_dh.c" 3 4
                ((void *)0)
# 155 "../crypto/ffc/ffc_dh.c"
                    )
        return 
# 156 "../crypto/ffc/ffc_dh.c" 3 4
              ((void *)0)
# 156 "../crypto/ffc/ffc_dh.c"
                  ;
    return group->q;
}
...
{
    if (ffc == 
# 162 "../crypto/ffc/ffc_dh.c" 3 4
              ((void *)0) 
# 162 "../crypto/ffc/ffc_dh.c"
                   || group == 
# 162 "../crypto/ffc/ffc_dh.c" 3 4
                               ((void *)0)
# 162 "../crypto/ffc/ffc_dh.c"
