# 0 "../crypto/ffc/ffc_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_backend.c"
# 10 "../crypto/ffc/ffc_backend.c"
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 11 "../crypto/ffc/ffc_backend.c" 2
...
# 12 "../crypto/ffc/ffc_backend.c" 2
# 20 "../crypto/ffc/ffc_backend.c"
int ossl_ffc_params_fromdata(FFC_PARAMS *ffc, const OSSL_PARAM params[])
{
    const OSSL_PARAM *prm;
    const OSSL_PARAM *param_p, *param_q, *param_g;
    BIGNUM *p = 
# 24 "../crypto/ffc/ffc_backend.c" 3 4
               ((void *)0)
# 24 "../crypto/ffc/ffc_backend.c"
                   , *q = 
# 24 "../crypto/ffc/ffc_backend.c" 3 4
                          ((void *)0)
# 24 "../crypto/ffc/ffc_backend.c"
...
# 24 "../crypto/ffc/ffc_backend.c"
    ...
    prm = OSSL_PARAM_locate_const(params, "group");
    if (prm != 
# 28 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 28 "../crypto/ffc/ffc_backend.c"
                  ) {
...
# 34 "../crypto/ffc/ffc_backend.c" 3 4
                                     ((void *)0)
# 34 "../crypto/ffc/ffc_backend.c"
                                         ;

        if (prm->data_type != 4
            || prm->data == 
# 37 "../crypto/ffc/ffc_backend.c" 3 4
                           ((void *)0)
            
# 38 "../crypto/ffc/ffc_backend.c"
           || (group = ossl_ffc_name_to_dh_named_group(prm->data)) == 
# 38 "../crypto/ffc/ffc_backend.c" 3 4
                                                                      ((void *)0)
            
# 39 "../crypto/ffc/ffc_backend.c"
    ...
    param_g = OSSL_PARAM_locate_const(params, "g");
    param_q = OSSL_PARAM_locate_const(params, "q");

    if ((param_p != 
# 48 "../crypto/ffc/ffc_backend.c" 3 4
                   ((void *)0) 
# 48 "../crypto/ffc/ffc_backend.c"
                        && !OSSL_PARAM_get_BN(param_p, &p))
        || (param_q != 
# 49 "../crypto/ffc/ffc_backend.c" 3 4
                      ((void *)0) 
# 49 "../crypto/ffc/ffc_backend.c"
                           && !OSSL_PARAM_get_BN(param_q, &q))
        || (param_g != 
# 50 "../crypto/ffc/ffc_backend.c" 3 4
                      ((void *)0) 
# 50 "../crypto/ffc/ffc_backend.c"
                           && !OSSL_PARAM_get_BN(param_g, &g)))
        goto err;

    prm = OSSL_PARAM_locate_const(params, "gindex");
    if (prm != 
# 54 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 54 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ffc->gindex = i;
    }
    prm = OSSL_PARAM_locate_const(params, "pcounter");
    if (prm != 
# 60 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 60 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ffc->pcounter = i;
    }
    prm = OSSL_PARAM_locate_const(params, "j");
    if (prm != 
# 66 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0) 
# 66 "../crypto/ffc/ffc_backend.c"
                   && !OSSL_PARAM_get_BN(prm, &j))
        goto err;
    prm = OSSL_PARAM_locate_const(params, "hindex");
    if (prm != 
# 69 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 69 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ffc->h = i;
    }
    prm = OSSL_PARAM_locate_const(params, "seed");
    if (prm != 
# 75 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 75 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (prm->data_type != 5
            || !ossl_ffc_params_set_seed(ffc, prm->data, prm->data_size))
            goto err;
    }
    prm = OSSL_PARAM_locate_const(params, "validate-pq");
    if (prm != 
# 81 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 81 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ossl_ffc_params_enable_flags(ffc, 0x01, i);
    }
    prm = OSSL_PARAM_locate_const(params, "validate-g");
    if (prm != 
# 87 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 87 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ossl_ffc_params_enable_flags(ffc, 0x02, i);
    }
    prm = OSSL_PARAM_locate_const(params, "validate-legacy");
    if (prm != 
# 93 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 93 "../crypto/ffc/ffc_backend.c"
                  ) {
        if (!OSSL_PARAM_get_int(prm, &i))
            goto err;
        ossl_ffc_params_enable_flags(ffc, 0x04, i);
    }

    prm = OSSL_PARAM_locate_const(params, "digest");
    if (prm != 
# 100 "../crypto/ffc/ffc_backend.c" 3 4
              ((void *)0)
# 100 "../crypto/ffc/ffc_backend.c"
                  ) {
        const OSSL_PARAM *p1;
        const char *props = 
# 102 "../crypto/ffc/ffc_backend.c" 3 4
                           ((void *)0)
# 102 "../crypto/ffc/ffc_backend.c"
                               ;

        if (prm->data_type != 4)
            goto err;
        p1 = OSSL_PARAM_locate_const(params, "properties");
        if (p1 != 
# 107 "../crypto/ffc/ffc_backend.c" 3 4
                 ((void *)0)
# 107 "../crypto/ffc/ffc_backend.c"
                     ) {
            if (p1->data_type != 4)
                goto err;
            props = p1->data;
