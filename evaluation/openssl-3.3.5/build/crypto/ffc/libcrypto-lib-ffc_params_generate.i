# 0 "../crypto/ffc/ffc_params_generate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_params_generate.c"
# 27 "../crypto/ffc/ffc_params_generate.c"
...
# 28 "../crypto/ffc/ffc_params_generate.c" 2
...
# 29 "../crypto/ffc/ffc_params_generate.c" 2
...
int RAND_poll(void);
# 30 "../crypto/ffc/ffc_params_generate.c" 2
...
# 31 "../crypto/ffc/ffc_params_generate.c" 2
# 1 "../include/openssl/dherr.h" 1
# 13 "../include/openssl/dherr.h"
        
# 32 "../crypto/ffc/ffc_params_generate.c" 2
# 1 "../include/openssl/dsaerr.h" 1
# 13 "../include/openssl/dsaerr.h"
        
# 33 "../crypto/ffc/ffc_params_generate.c" 2
...
# 34 "../crypto/ffc/ffc_params_generate.c" 2
...
# 35 "../crypto/ffc/ffc_params_generate.c" 2
# 67 "../crypto/ffc/ffc_params_generate.c"
static int ffc_validate_LN(size_t L, size_t N, int type, int verify)
{
    if (type == 1) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/ffc/ffc_params_generate.c",77,__func__), ERR_set_error)((5),(127),
# 77 "../crypto/ffc/ffc_params_generate.c" 3 4
       ((void *)0)
# 77 "../crypto/ffc/ffc_params_generate.c"
       );
        ...
        (ERR_new(), ERR_set_debug("../crypto/ffc/ffc_params_generate.c",87,__func__), ERR_set_error)((10),(114),
# 87 "../crypto/ffc/ffc_params_generate.c" 3 4
       ((void *)0)
# 87 "../crypto/ffc/ffc_params_generate.c"
       );
...
# 132 "../crypto/ffc/ffc_params_generate.c"
                                ...
                                int gindex, unsigned char *seed, size_t seedlen)
{
    ...
    unsigned char md[64];
    EVP_MD_CTX *mctx = 
# 140 "../crypto/ffc/ffc_params_generate.c" 3 4
                      ((void *)0)
# 140 "../crypto/ffc/ffc_params_generate.c"
                          ;
    int mdsize;
    ...
    mctx = EVP_MD_CTX_new();
    if (mctx == 
# 148 "../crypto/ffc/ffc_params_generate.c" 3 4
               ((void *)0)
# 148 "../crypto/ffc/ffc_params_generate.c"
                   )
        return 0;
    ...
    for (counter = 1; counter <= 0xFFFF; ++counter) {
        ...
        if (!EVP_DigestInit_ex(mctx, evpmd, 
# 168 "../crypto/ffc/ffc_params_generate.c" 3 4
                                           ((void *)0)
# 168 "../crypto/ffc/ffc_params_generate.c"
                                               )
                || !EVP_DigestUpdate(mctx, seed, seedlen)
                || !EVP_DigestUpdate(mctx, ggen, sizeof(ggen))
                || !EVP_DigestUpdate(mctx, md, 3)
                || !EVP_DigestFinal_ex(mctx, md, 
# 172 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                ((void *)0)
# 172 "../crypto/ffc/ffc_params_generate.c"
                                                    )
                || (BN_bin2bn(md, mdsize, tmp) == 
# 173 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                 ((void *)0)
# 173 "../crypto/ffc/ffc_params_generate.c"
                                                     )
                      ...
                      int *res)
{
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 208 "../crypto/ffc/ffc_params_generate.c" 3 4
              ((void *)0)
# 208 "../crypto/ffc/ffc_params_generate.c"
                  )
        goto err;
    ...
    if (mdsize <= 0)
        goto err;
# 226 "../crypto/ffc/ffc_params_generate.c"
    for (i = 0; i <= max_counter; i++) {
        ...
        for (j = 0; j <= n; j++) {
            ...
            if (!EVP_Digest(buf, buf_len, md, 
# 244 "../crypto/ffc/ffc_params_generate.c" 3 4
                                             ((void *)0)
# 244 "../crypto/ffc/ffc_params_generate.c"
                                                 , evpmd, 
# 244 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                          ((void *)0)
# 244 "../crypto/ffc/ffc_params_generate.c"
                    ...
                    || (BN_bin2bn(md, mdsize, tmp) == 
# 245 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                     ((void *)0)
# 245 "../crypto/ffc/ffc_params_generate.c"
                                                         )
        ...
        if (!BN_mask_bits(W, L - 1)
                ...
                || !BN_lshift1(tmp, q)
                || !BN_div(
# 270 "../crypto/ffc/ffc_params_generate.c" 3 4
                   ((void *)0)
# 270 "../crypto/ffc/ffc_params_generate.c"
                   ,(c),(X),(tmp),(ctx))
                                ...
                                BN_GENCB *cb)
{
    ...
    for (;;) {
        ...
        if (!EVP_Digest(seed, seedlen, md, 
# 339 "../crypto/ffc/ffc_params_generate.c" 3 4
                                          ((void *)0)
# 339 "../crypto/ffc/ffc_params_generate.c"
                                              , evpmd, 
# 339 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                       ((void *)0)
# 339 "../crypto/ffc/ffc_params_generate.c"
...
# 416 "../crypto/ffc/ffc_params_generate.c" 3 4
                                        ((void *)0)
# 416 "../crypto/ffc/ffc_params_generate.c"
                                            , evpmd, 
# 416 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                     ((void *)0)
# 416 "../crypto/ffc/ffc_params_generate.c"
...
# 418 "../crypto/ffc/ffc_params_generate.c" 3 4
                                         ((void *)0)
# 418 "../crypto/ffc/ffc_params_generate.c"
                                             , evpmd, 
# 418 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                      ((void *)0)
# 418 "../crypto/ffc/ffc_params_generate.c"
...
static const char *default_mdname(size_t N)
{
    if (N == 160)
        ...
        return "SHA-256";
    return 
# 454 "../crypto/ffc/ffc_params_generate.c" 3 4
          ((void *)0)
# 454 "../crypto/ffc/ffc_params_generate.c"
              ;
}
# 513 "../crypto/ffc/ffc_params_generate.c"
int ossl_ffc_params_FIPS186_4_gen_verify(OSSL_LIB_CTX *libctx,
                                         FFC_PARAMS *params, int mode, int type,
                                         size_t L, size_t N, int *res,
                                         BN_GENCB *cb)
{
    int ok = 0;
    unsigned char *seed = 
# 519 "../crypto/ffc/ffc_params_generate.c" 3 4
                         ((void *)0)
# 519 "../crypto/ffc/ffc_params_generate.c"
                             , *seed_tmp = 
# 519 "../crypto/ffc/ffc_params_generate.c" 3 4
                                           ((void *)0)
# 519 "../crypto/ffc/ffc_params_generate.c"
    ...
    BIGNUM *g = 
# 523 "../crypto/ffc/ffc_params_generate.c" 3 4
               ((void *)0)
# 523 "../crypto/ffc/ffc_params_generate.c"
                   , *q = 
# 523 "../crypto/ffc/ffc_params_generate.c" 3 4
                          ((void *)0)
# 523 "../crypto/ffc/ffc_params_generate.c"
...
# 523 "../crypto/ffc/ffc_params_generate.c"
                                         ;
    BN_MONT_CTX *mont = 
# 524 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 524 "../crypto/ffc/ffc_params_generate.c"
                           ;
    int n = 0, m = 0, qsize;
    int canonical_g = 0, hret = 0;
    BN_CTX *ctx = 
# 527 "../crypto/ffc/ffc_params_generate.c" 3 4
                 ((void *)0)
# 527 "../crypto/ffc/ffc_params_generate.c"
                     ;
    EVP_MD_CTX *mctx = 
# 528 "../crypto/ffc/ffc_params_generate.c" 3 4
                      ((void *)0)
# 528 "../crypto/ffc/ffc_params_generate.c"
                          ;
    EVP_MD *md = 
# 529 "../crypto/ffc/ffc_params_generate.c" 3 4
                ((void *)0)
# 529 "../crypto/ffc/ffc_params_generate.c"
                    ;
    int verify = (mode == 0);
    ...
    *res = 0;
    ...
    if (params->mdname != 
# 536 "../crypto/ffc/ffc_params_generate.c" 3 4
                         ((void *)0)
# 536 "../crypto/ffc/ffc_params_generate.c"
                             ) {
        ...
        if (def_name == 
# 542 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 542 "../crypto/ffc/ffc_params_generate.c"
                           ) {
            *res = 0x00020;
            goto err;
        }
    ...
    if (md == 
# 548 "../crypto/ffc/ffc_params_generate.c" 3 4
             ((void *)0)
# 548 "../crypto/ffc/ffc_params_generate.c"
                 )
        goto err;
    ...
    mctx = EVP_MD_CTX_new();
    if (mctx == 
# 569 "../crypto/ffc/ffc_params_generate.c" 3 4
               ((void *)0)
# 569 "../crypto/ffc/ffc_params_generate.c"
                   )
        goto err;

    if ((ctx = BN_CTX_new_ex(libctx)) == 
# 572 "../crypto/ffc/ffc_params_generate.c" 3 4
                                        ((void *)0)
# 572 "../crypto/ffc/ffc_params_generate.c"
                                            )
        goto err;
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 581 "../crypto/ffc/ffc_params_generate.c" 3 4
              ((void *)0)
# 581 "../crypto/ffc/ffc_params_generate.c"
                  )
        goto err;
    ...
    if (params->seed != 
# 588 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 588 "../crypto/ffc/ffc_params_generate.c"
                           )
        seed = params->seed;
    ...
    if (!verify) {
        ...
        if ((params->p == 
# 593 "../crypto/ffc/ffc_params_generate.c" 3 4
                         ((void *)0)
# 593 "../crypto/ffc/ffc_params_generate.c"
                             ) != (params->q == 
# 593 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                ((void *)0)
# 593 "../crypto/ffc/ffc_params_generate.c"
        ...
        if ((flags & 0x01) != 0) {
            if (seed == 
# 600 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0) 
# 600 "../crypto/ffc/ffc_params_generate.c"
                            || params->pcounter < 0) {
                *res = 0x00200;
                goto err;
            }
        ...
        if ((flags & 0x02) != 0) {
            ...
            if (params->g == 
# 607 "../crypto/ffc/ffc_params_generate.c" 3 4
                            ((void *)0)
# 607 "../crypto/ffc/ffc_params_generate.c"
                                ) {
                *res = 0x00400;
                goto err;
            }
    ...
    if (params->p != 
# 619 "../crypto/ffc/ffc_params_generate.c" 3 4
                    ((void *)0) 
# 619 "../crypto/ffc/ffc_params_generate.c"
                         && ((flags & 0x01) == 0)) {
    ...
    q = BN_CTX_get(ctx);
    if (q == 
# 630 "../crypto/ffc/ffc_params_generate.c" 3 4
            ((void *)0)
# 630 "../crypto/ffc/ffc_params_generate.c"
                )
        goto err;
    ...
    seed_tmp = CRYPTO_malloc(seedlen, "../crypto/ffc/ffc_params_generate.c", 643);
    if (seed_tmp == 
# 644 "../crypto/ffc/ffc_params_generate.c" 3 4
                   ((void *)0)
# 644 "../crypto/ffc/ffc_params_generate.c"
                       )
        goto err;

    if (seed == 
# 647 "../crypto/ffc/ffc_params_generate.c" 3 4
               ((void *)0)
# 647 "../crypto/ffc/ffc_params_generate.c"
                   ) {
        ...
        seed = CRYPTO_malloc(seedlen, "../crypto/ffc/ffc_params_generate.c", 654);
        if (seed == 
# 655 "../crypto/ffc/ffc_params_generate.c" 3 4
                   ((void *)0)
# 655 "../crypto/ffc/ffc_params_generate.c"
                       )
            goto err;
    }
    ...
    if ((flags & (0x01 | 0x02)) == 0x01)
        goto pass;
g_only:
    if ((mont = BN_MONT_CTX_new()) == 
# 726 "../crypto/ffc/ffc_params_generate.c" 3 4
                                     ((void *)0)
# 726 "../crypto/ffc/ffc_params_generate.c"
                                         )
        goto err;
    ...
    if (!(BN_sub(pm1, p, BN_value_one()) && BN_div(e, 
# 742 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                     ((void *)0)
# 742 "../crypto/ffc/ffc_params_generate.c"
                                                         , pm1, q, ctx)))
        goto err;


    if ((seed != 
# 746 "../crypto/ffc/ffc_params_generate.c" 3 4
                ((void *)0)
# 746 "../crypto/ffc/ffc_params_generate.c"
                    ) && (params->gindex != -1)) {
        canonical_g = 1;
    ...
    if (!verify) {
        ...
        if (params->p == 
# 779 "../crypto/ffc/ffc_params_generate.c" 3 4
                        ((void *)0) 
# 779 "../crypto/ffc/ffc_params_generate.c"
                             || params->q == 
# 779 "../crypto/ffc/ffc_params_generate.c" 3 4
                                             ((void *)0) 
# 779 "../crypto/ffc/ffc_params_generate.c"
...
err:
    if (seed != params->seed)
        CRYPTO_free(seed, "../crypto/ffc/ffc_params_generate.c", 794);
    CRYPTO_free(seed_tmp, "../crypto/ffc/ffc_params_generate.c", 795);
    if (ctx != 
# 796 "../crypto/ffc/ffc_params_generate.c" 3 4
              ((void *)0)
# 796 "../crypto/ffc/ffc_params_generate.c"
                  )
        BN_CTX_end(ctx);
    BN_CTX_free(ctx);
                                         ...
                                         BN_GENCB *cb)
{
    ...
    BIGNUM *r0, *test, *tmp, *g = 
# 814 "../crypto/ffc/ffc_params_generate.c" 3 4
                                 ((void *)0)
# 814 "../crypto/ffc/ffc_params_generate.c"
                                     , *q = 
# 814 "../crypto/ffc/ffc_params_generate.c" 3 4
                                            ((void *)0)
# 814 "../crypto/ffc/ffc_params_generate.c"
...
# 814 "../crypto/ffc/ffc_params_generate.c"
                                                           ;
    BN_MONT_CTX *mont = 
# 815 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 815 "../crypto/ffc/ffc_params_generate.c"
                           ;
    EVP_MD *md = 
# 816 "../crypto/ffc/ffc_params_generate.c" 3 4
                ((void *)0)
# 816 "../crypto/ffc/ffc_params_generate.c"
                    ;
    size_t qsize;
    int n = 0, m = 0;
    ...
    int rv;
    BN_CTX *ctx = 
# 821 "../crypto/ffc/ffc_params_generate.c" 3 4
                 ((void *)0)
# 821 "../crypto/ffc/ffc_params_generate.c"
                     ;
    int hret = -1;
    ...
    *res = 0;
    ...
    if (params->mdname != 
# 831 "../crypto/ffc/ffc_params_generate.c" 3 4
                         ((void *)0)
# 831 "../crypto/ffc/ffc_params_generate.c"
                             ) {
        md = EVP_MD_fetch(libctx, params->mdname, params->mdprops);
    } else {
        if (N == 0)
        ...
        def_name = default_mdname(N);
        if (def_name == 
# 837 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 837 "../crypto/ffc/ffc_params_generate.c"
                           ) {
            *res = 0x00020;
            goto err;
        }
    ...
    if (md == 
# 843 "../crypto/ffc/ffc_params_generate.c" 3 4
             ((void *)0)
# 843 "../crypto/ffc/ffc_params_generate.c"
                 )
        goto err;
    if (N == 0)
    ...
    if (seed_in != 
# 868 "../crypto/ffc/ffc_params_generate.c" 3 4
                  ((void *)0)
# 868 "../crypto/ffc/ffc_params_generate.c"
                      ) {
        if (seed_len < qsize) {
            *res = 0x40000;
            goto err;
    ...
    if (ctx == 
# 880 "../crypto/ffc/ffc_params_generate.c" 3 4
              ((void *)0)
# 880 "../crypto/ffc/ffc_params_generate.c"
                  )
        goto err;
    ...
    test = BN_CTX_get(ctx);
    if (test == 
# 891 "../crypto/ffc/ffc_params_generate.c" 3 4
               ((void *)0)
# 891 "../crypto/ffc/ffc_params_generate.c"
                   )
        goto err;
    ...
    if (!verify) {
        ...
        if ((params->p != 
# 899 "../crypto/ffc/ffc_params_generate.c" 3 4
                         ((void *)0)
# 899 "../crypto/ffc/ffc_params_generate.c"
                             ) != (params->q != 
# 899 "../crypto/ffc/ffc_params_generate.c" 3 4
                                                ((void *)0)
# 899 "../crypto/ffc/ffc_params_generate.c"
        ...
        if ((flags & 0x01) != 0) {
            ...
            if (seed_in == 
# 906 "../crypto/ffc/ffc_params_generate.c" 3 4
                          ((void *)0) 
# 906 "../crypto/ffc/ffc_params_generate.c"
                               || params->pcounter < 0) {
                *res = 0x00200;
                goto err;
            }
        ...
        if ((flags & 0x02) != 0) {
            ...
            if (params->g == 
# 913 "../crypto/ffc/ffc_params_generate.c" 3 4
                            ((void *)0)
# 913 "../crypto/ffc/ffc_params_generate.c"
                                ) {
                *res = 0x00400;
                goto err;
            }
    ...
    if (params->p != 
# 920 "../crypto/ffc/ffc_params_generate.c" 3 4
                    ((void *)0) 
# 920 "../crypto/ffc/ffc_params_generate.c"
                         && ((flags & 0x01) == 0)) {
    ...
    use_random_seed = (seed_in == 
# 928 "../crypto/ffc/ffc_params_generate.c" 3 4
                                 ((void *)0)
# 928 "../crypto/ffc/ffc_params_generate.c"
                                     );
    for (;;) {
...
g_only:
    if ((mont = BN_MONT_CTX_new()) == 
# 978 "../crypto/ffc/ffc_params_generate.c" 3 4
                                     ((void *)0)
# 978 "../crypto/ffc/ffc_params_generate.c"
                                         )
        goto err;
    if (!BN_MONT_CTX_set(mont, p, ctx))
        goto err;
    ...
    if (!verify) {
        ...
        if (!BN_div(r0, 
# 989 "../crypto/ffc/ffc_params_generate.c" 3 4
                       ((void *)0)
# 989 "../crypto/ffc/ffc_params_generate.c"
                           , test, q, ctx))
            goto err;
    ...
    if (!verify) {
        ...
        if (params->p == 
# 1016 "../crypto/ffc/ffc_params_generate.c" 3 4
                        ((void *)0) 
# 1016 "../crypto/ffc/ffc_params_generate.c"
                             || params->q == 
# 1016 "../crypto/ffc/ffc_params_generate.c" 3 4
                                             ((void *)0) 
# 1016 "../crypto/ffc/ffc_params_generate.c"
...
err:
    if (ctx != 
# 1028 "../crypto/ffc/ffc_params_generate.c" 3 4
              ((void *)0)
# 1028 "../crypto/ffc/ffc_params_generate.c"
                  )
        BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    BN_MONT_CTX_free(mont);
                                       ...
                                       int *res, BN_GENCB *cb)
{
    ...
    ossl_ffc_params_enable_flags(params, 0x04, 1);
    return 1;
}
