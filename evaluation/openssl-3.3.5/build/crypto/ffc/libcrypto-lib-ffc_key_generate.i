# 0 "../crypto/ffc/ffc_key_generate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_key_generate.c"
# 10 "../crypto/ffc/ffc_key_generate.c"
...
# 11 "../crypto/ffc/ffc_key_generate.c" 2
# 22 "../crypto/ffc/ffc_key_generate.c"
int ossl_ffc_generate_private_key(BN_CTX *ctx, const FFC_PARAMS *params,
                                  int N, int s, BIGNUM *priv)
{
    int ret = 0, qbits = BN_num_bits(params->q);
    BIGNUM *m, *two_powN = 
# 26 "../crypto/ffc/ffc_key_generate.c" 3 4
                          ((void *)0)
# 26 "../crypto/ffc/ffc_key_generate.c"
                              ;
    ...
    if (two_powN == 
# 40 "../crypto/ffc/ffc_key_generate.c" 3 4
                   ((void *)0) 
# 40 "../crypto/ffc/ffc_key_generate.c"
                        || !BN_lshift(two_powN, BN_value_one(), N))
        goto err;
