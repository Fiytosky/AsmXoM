# 0 "../crypto/ffc/ffc_params_validate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_params_validate.c"
# 16 "../crypto/ffc/ffc_params_validate.c"
...
# 17 "../crypto/ffc/ffc_params_validate.c" 2
...
# 18 "../crypto/ffc/ffc_params_validate.c" 2
# 1 "../include/openssl/dsaerr.h" 1
# 13 "../include/openssl/dsaerr.h"
        
# 19 "../crypto/ffc/ffc_params_validate.c" 2
# 1 "../include/openssl/dherr.h" 1
# 13 "../include/openssl/dherr.h"
        
# 20 "../crypto/ffc/ffc_params_validate.c" 2
...
# 21 "../crypto/ffc/ffc_params_validate.c" 2
                                       ...
                                       int *res, BN_GENCB *cb)
{
    ...
    if (params == 
# 58 "../crypto/ffc/ffc_params_validate.c" 3 4
                 ((void *)0) 
# 58 "../crypto/ffc/ffc_params_validate.c"
                      || params->p == 
# 58 "../crypto/ffc/ffc_params_validate.c" 3 4
                                      ((void *)0) 
# 58 "../crypto/ffc/ffc_params_validate.c"
                                       ...
                                       int *res, BN_GENCB *cb)
{
    ...
    if (params == 
# 76 "../crypto/ffc/ffc_params_validate.c" 3 4
                 ((void *)0) 
# 76 "../crypto/ffc/ffc_params_validate.c"
                      || params->p == 
# 76 "../crypto/ffc/ffc_params_validate.c" 3 4
                                      ((void *)0) 
# 76 "../crypto/ffc/ffc_params_validate.c"
                                    ...
                                    int paramstype, int *res)
{
    ...
    if (params == 
# 102 "../crypto/ffc/ffc_params_validate.c" 3 4
                 ((void *)0)
# 102 "../crypto/ffc/ffc_params_validate.c"
                     )
        return 0;

    if (res == 
# 105 "../crypto/ffc/ffc_params_validate.c" 3 4
              ((void *)0)
# 105 "../crypto/ffc/ffc_params_validate.c"
                  )
        res = &tmpres;
    ...
    tmpparams.flags = 0x02;
    tmpparams.gindex = -1;


    if (params->flags & 0x04)
        ret = ossl_ffc_params_FIPS186_2_validate(libctx, &tmpparams, paramstype,
                                                 res, 
# 117 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                     ((void *)0)
# 117 "../crypto/ffc/ffc_params_validate.c"
                                                         );
    else

        ret = ossl_ffc_params_FIPS186_4_validate(libctx, &tmpparams, paramstype,
                                                 res, 
# 121 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                     ((void *)0)
# 121 "../crypto/ffc/ffc_params_validate.c"
                                                         );

    if (ret == 0
        && (*res & 0x08) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/ffc/ffc_params_validate.c",125,__func__), ERR_set_error)((5),(120),
# 125 "../crypto/ffc/ffc_params_validate.c" 3 4
       ((void *)0)
# 125 "../crypto/ffc/ffc_params_validate.c"
       );
    }
                                  ...
                                  int paramstype, int *res)
{
    ...
    if (params == 
# 144 "../crypto/ffc/ffc_params_validate.c" 3 4
                 ((void *)0)
# 144 "../crypto/ffc/ffc_params_validate.c"
                     )
        return 0;

    if (res == 
# 147 "../crypto/ffc/ffc_params_validate.c" 3 4
              ((void *)0)
# 147 "../crypto/ffc/ffc_params_validate.c"
                  )
        res = &tmpres;
    ...
    if (params->seed != 
# 154 "../crypto/ffc/ffc_params_validate.c" 3 4
                       ((void *)0)
# 154 "../crypto/ffc/ffc_params_validate.c"
                           ) {
        if (params->flags & 0x04)
            return ossl_ffc_params_FIPS186_2_validate(libctx, params, paramstype,
                                                      res, 
# 157 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                          ((void *)0)
# 157 "../crypto/ffc/ffc_params_validate.c"
                                                              );
        else
            return ossl_ffc_params_FIPS186_4_validate(libctx, params, paramstype,
                                                      res, 
# 160 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                          ((void *)0)
# 160 "../crypto/ffc/ffc_params_validate.c"
                                                              );
    } else {
        int ret = 0;
...
# 168 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                ((void *)0)
# 168 "../crypto/ffc/ffc_params_validate.c"
                                                    )
                return 0;
            if (BN_check_prime(params->q, ctx, 
# 170 "../crypto/ffc/ffc_params_validate.c" 3 4
                                              ((void *)0)
# 170 "../crypto/ffc/ffc_params_validate.c"
                                                  ) != 1) {

                (ERR_new(), ERR_set_debug("../crypto/ffc/ffc_params_validate.c",172,__func__), ERR_set_error)((10),(113),
# 172 "../crypto/ffc/ffc_params_validate.c" 3 4
               ((void *)0)
# 172 "../crypto/ffc/ffc_params_validate.c"
               );

                ret = 0;
            }
            if (ret && BN_check_prime(params->p, ctx, 
# 176 "../crypto/ffc/ffc_params_validate.c" 3 4
                                                     ((void *)0)
# 176 "../crypto/ffc/ffc_params_validate.c"
                                                         ) != 1) {

                (ERR_new(), ERR_set_debug("../crypto/ffc/ffc_params_validate.c",178,__func__), ERR_set_error)((10),(115),
# 178 "../crypto/ffc/ffc_params_validate.c" 3 4
               ((void *)0)
# 178 "../crypto/ffc/ffc_params_validate.c"
               );
