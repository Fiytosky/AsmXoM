# 0 "../crypto/ffc/ffc_key_validate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_key_validate.c"
# 10 "../crypto/ffc/ffc_key_validate.c"
...
# 11 "../crypto/ffc/ffc_key_validate.c" 2
# 19 "../crypto/ffc/ffc_key_validate.c"
int ossl_ffc_validate_public_key_partial(const FFC_PARAMS *params,
                                         const BIGNUM *pub_key, int *ret)
{
    int ok = 0;
    BIGNUM *tmp = 
# 23 "../crypto/ffc/ffc_key_validate.c" 3 4
                 ((void *)0)
# 23 "../crypto/ffc/ffc_key_validate.c"
                     ;
    BN_CTX *ctx = 
# 24 "../crypto/ffc/ffc_key_validate.c" 3 4
                 ((void *)0)
# 24 "../crypto/ffc/ffc_key_validate.c"
                     ;

    *ret = 0;
    if (params == 
# 27 "../crypto/ffc/ffc_key_validate.c" 3 4
                 ((void *)0) 
# 27 "../crypto/ffc/ffc_key_validate.c"
                      || pub_key == 
# 27 "../crypto/ffc/ffc_key_validate.c" 3 4
                                    ((void *)0) 
# 27 "../crypto/ffc/ffc_key_validate.c"
...
# 27 "../crypto/ffc/ffc_key_validate.c"
    ...
    ctx = BN_CTX_new_ex(
# 32 "../crypto/ffc/ffc_key_validate.c" 3 4
                       ((void *)0)
# 32 "../crypto/ffc/ffc_key_validate.c"
                           );
    if (ctx == 
# 33 "../crypto/ffc/ffc_key_validate.c" 3 4
              ((void *)0)
# 33 "../crypto/ffc/ffc_key_validate.c"
                  )
        goto err;
    ...
    if (tmp == 
# 39 "../crypto/ffc/ffc_key_validate.c" 3 4
              ((void *)0)
        
# 40 "../crypto/ffc/ffc_key_validate.c"
       || !BN_set_word(tmp, 1))
        goto err;
    if (BN_cmp(pub_key, tmp) <= 0)
        *ret |= 0x01;

    if (BN_copy(tmp, params->p) == 
# 45 "../crypto/ffc/ffc_key_validate.c" 3 4
                                  ((void *)0)
        
# 46 "../crypto/ffc/ffc_key_validate.c"
       || !BN_sub_word(tmp, 1))
        goto err;
    if (BN_cmp(pub_key, tmp) >= 0)
        *ret |= 0x02;
 ...
 err:
    if (ctx != 
# 52 "../crypto/ffc/ffc_key_validate.c" 3 4
              ((void *)0)
# 52 "../crypto/ffc/ffc_key_validate.c"
                  ) {
        BN_CTX_end(ctx);
        BN_CTX_free(ctx);
    }
                                 ...
                                 const BIGNUM *pub_key, int *ret)
{
    int ok = 0;
    BIGNUM *tmp = 
# 66 "../crypto/ffc/ffc_key_validate.c" 3 4
                 ((void *)0)
# 66 "../crypto/ffc/ffc_key_validate.c"
                     ;
    BN_CTX *ctx = 
# 67 "../crypto/ffc/ffc_key_validate.c" 3 4
                 ((void *)0)
# 67 "../crypto/ffc/ffc_key_validate.c"
                     ;
    ...
    if (*ret == 0 && params->q != 
# 72 "../crypto/ffc/ffc_key_validate.c" 3 4
                                 ((void *)0)
# 72 "../crypto/ffc/ffc_key_validate.c"
                                     ) {
        ctx = BN_CTX_new_ex(
# 73 "../crypto/ffc/ffc_key_validate.c" 3 4
                           ((void *)0)
# 73 "../crypto/ffc/ffc_key_validate.c"
                               );
        if (ctx == 
# 74 "../crypto/ffc/ffc_key_validate.c" 3 4
                  ((void *)0)
# 74 "../crypto/ffc/ffc_key_validate.c"
                      )
            goto err;
        BN_CTX_start(ctx);
        tmp = BN_CTX_get(ctx);
        ...
        if (tmp == 
# 80 "../crypto/ffc/ffc_key_validate.c" 3 4
                  ((void *)0)
            
# 81 "../crypto/ffc/ffc_key_validate.c"
 ...
 err:
    if (ctx != 
# 89 "../crypto/ffc/ffc_key_validate.c" 3 4
              ((void *)0)
# 89 "../crypto/ffc/ffc_key_validate.c"
                  ) {
        BN_CTX_end(ctx);
        BN_CTX_free(ctx);
    }
                                  ...
                                  int *ret)
{
    ...
    *ret = 0;
    ...
    if (priv == 
# 109 "../crypto/ffc/ffc_key_validate.c" 3 4
               ((void *)0) 
# 109 "../crypto/ffc/ffc_key_validate.c"
                    || upper == 
# 109 "../crypto/ffc/ffc_key_validate.c" 3 4
                                ((void *)0)
# 109 "../crypto/ffc/ffc_key_validate.c"
