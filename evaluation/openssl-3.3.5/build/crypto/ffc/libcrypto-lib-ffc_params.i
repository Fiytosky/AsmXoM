# 0 "../crypto/ffc/ffc_params.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/ffc/ffc_params.c"
# 10 "../crypto/ffc/ffc_params.c"
...
# 11 "../crypto/ffc/ffc_params.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../crypto/ffc/ffc_params.c" 2
...
void ossl_ffc_params_cleanup(FFC_PARAMS *params)
{
    ...
    BN_free(params->g);
    BN_free(params->j);
    CRYPTO_free(params->seed, "../crypto/ffc/ffc_params.c", 34);
...
{
    if (p != 
# 40 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0) 
# 40 "../crypto/ffc/ffc_params.c"
                 && p != d->p) {
        BN_free(d->p);
        d->p = p;
    }
    if (q != 
# 44 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0) 
# 44 "../crypto/ffc/ffc_params.c"
                 && q != d->q) {
        BN_free(d->q);
        d->q = q;
    }
    if (g != 
# 48 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0) 
# 48 "../crypto/ffc/ffc_params.c"
                 && g != d->g) {
        BN_free(d->g);
        d->g = g;
    }
...
{
    if (p != 
# 57 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0)
# 57 "../crypto/ffc/ffc_params.c"
                )
        *p = d->p;
    if (q != 
# 59 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0)
# 59 "../crypto/ffc/ffc_params.c"
                )
        *q = d->q;
    if (g != 
# 61 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0)
# 61 "../crypto/ffc/ffc_params.c"
                )
        *g = d->g;
}
...
void ossl_ffc_params_set0_j(FFC_PARAMS *d, BIGNUM *j)
{
    BN_free(d->j);
    d->j = 
# 70 "../crypto/ffc/ffc_params.c" 3 4
          ((void *)0)
# 70 "../crypto/ffc/ffc_params.c"
              ;
    if (j != 
# 71 "../crypto/ffc/ffc_params.c" 3 4
            ((void *)0)
# 71 "../crypto/ffc/ffc_params.c"
                )
        d->j = j;
}
...
{
    if (params->seed != 
# 78 "../crypto/ffc/ffc_params.c" 3 4
                       ((void *)0)
# 78 "../crypto/ffc/ffc_params.c"
                           ) {
        if (params->seed == seed)
            return 1;
        CRYPTO_free(params->seed, "../crypto/ffc/ffc_params.c", 81);
    }

    if (seed != 
# 84 "../crypto/ffc/ffc_params.c" 3 4
               ((void *)0) 
# 84 "../crypto/ffc/ffc_params.c"
                    && seedlen > 0) {
        params->seed = CRYPTO_memdup((seed), seedlen, "../crypto/ffc/ffc_params.c", 85);
        if (params->seed == 
# 86 "../crypto/ffc/ffc_params.c" 3 4
                           ((void *)0)
# 86 "../crypto/ffc/ffc_params.c"
                               )
            return 0;
        params->seedlen = seedlen;
    } else {
        params->seed = 
# 90 "../crypto/ffc/ffc_params.c" 3 4
                      ((void *)0)
# 90 "../crypto/ffc/ffc_params.c"
                          ;
        params->seedlen = 0;
    }
    return 1;
...
{
    if (seed != 
# 145 "../crypto/ffc/ffc_params.c" 3 4
               ((void *)0)
# 145 "../crypto/ffc/ffc_params.c"
                   )
        *seed = params->seed;
    if (seedlen != 
# 147 "../crypto/ffc/ffc_params.c" 3 4
                  ((void *)0)
# 147 "../crypto/ffc/ffc_params.c"
                      )
        *seedlen = params->seedlen;
    if (pcounter != 
# 149 "../crypto/ffc/ffc_params.c" 3 4
                   ((void *)0)
# 149 "../crypto/ffc/ffc_params.c"
                       )
...
static int ffc_bn_cpy(BIGNUM **dst, const BIGNUM *src)
{
    ...
    if (src == 
# 161 "../crypto/ffc/ffc_params.c" 3 4
              ((void *)0)
# 161 "../crypto/ffc/ffc_params.c"
                  )
        a = 
# 162 "../crypto/ffc/ffc_params.c" 3 4
           ((void *)0)
# 162 "../crypto/ffc/ffc_params.c"
               ;
    else if (BN_get_flags(src, 0x02)
             && !BN_get_flags(src, 0x01))
        a = (BIGNUM *)src;
    else if ((a = BN_dup(src)) == 
# 166 "../crypto/ffc/ffc_params.c" 3 4
                                 ((void *)0)
# 166 "../crypto/ffc/ffc_params.c"
                                     )
        return 0;
    BN_clear_free(*dst);
    *dst = a;
...
int ossl_ffc_params_copy(FFC_PARAMS *dst, const FFC_PARAMS *src)
{
    ...
    CRYPTO_free(dst->seed, "../crypto/ffc/ffc_params.c", 183);
    dst->seedlen = src->seedlen;
    if (src->seed != 
# 185 "../crypto/ffc/ffc_params.c" 3 4
                    ((void *)0)
# 185 "../crypto/ffc/ffc_params.c"
                        ) {
        dst->seed = CRYPTO_memdup((src->seed), src->seedlen, "../crypto/ffc/ffc_params.c", 186);
        if (dst->seed == 
# 187 "../crypto/ffc/ffc_params.c" 3 4
                         ((void *)0)
# 187 "../crypto/ffc/ffc_params.c"
                             )
            return 0;
    } else {
        dst->seed = 
# 190 "../crypto/ffc/ffc_params.c" 3 4
                   ((void *)0)
# 190 "../crypto/ffc/ffc_params.c"
                       ;
    }
    dst->nid = src->nid;
                      ...
                      OSSL_PARAM params[])
{
    ...
    if (ffc->p != 
# 213 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 214 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_bn(bld, params, "p", ffc->p))
        return 0;
    if (ffc->q != 
# 216 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 217 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_bn(bld, params, "q", ffc->q))
        return 0;
    if (ffc->g != 
# 219 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 220 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_bn(bld, params, "g", ffc->g))
        return 0;
    if (ffc->j != 
# 222 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 223 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_bn(bld, params, "j",
                                    ffc->j))
        return 0;
    if (!ossl_param_build_set_int(bld, params, "gindex",
                                  ffc->gindex))
        return 0;
    if (!ossl_param_build_set_int(bld, params, "pcounter",
                                  ffc->pcounter))
        return 0;
    if (!ossl_param_build_set_int(bld, params, "hindex", ffc->h))
        return 0;
    if (ffc->seed != 
# 234 "../crypto/ffc/ffc_params.c" 3 4
                    ((void *)0)
        
# 235 "../crypto/ffc/ffc_params.c"
    ...
    if (ffc->nid != 0) {
        ...
        if (name == 
# 243 "../crypto/ffc/ffc_params.c" 3 4
                   ((void *)0)
            
# 244 "../crypto/ffc/ffc_params.c"
           || !ossl_param_build_set_utf8_string(bld, params,
                                                 "group",
                                                 name))
            return 0;
    }
    test_flags = ((ffc->flags & 0x01) != 0);
    if (!ossl_param_build_set_int(bld, params,
                                  "validate-pq", test_flags))
        return 0;
    test_flags = ((ffc->flags & 0x02) != 0);
    if (!ossl_param_build_set_int(bld, params,
                                  "validate-g", test_flags))
        return 0;
    test_flags = ((ffc->flags & 0x04) != 0);
    if (!ossl_param_build_set_int(bld, params,
                                  "validate-legacy",
                                  test_flags))
        return 0;
    ...
    if (ffc->mdname != 
# 263 "../crypto/ffc/ffc_params.c" 3 4
                      ((void *)0)
        
# 264 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_utf8_string(bld, params,
                                             "digest",
                                             ffc->mdname))
       return 0;
    if (ffc->mdprops != 
# 268 "../crypto/ffc/ffc_params.c" 3 4
                       ((void *)0)
        
# 269 "../crypto/ffc/ffc_params.c"
       && !ossl_param_build_set_utf8_string(bld, params,
                                             "properties",
                                             ffc->mdprops))
        return 0;
...
int ossl_ffc_params_print(BIO *bp, const FFC_PARAMS *ffc, int indent)
{
    if (!ASN1_bn_print(bp, "prime P:", ffc->p, 
# 279 "../crypto/ffc/ffc_params.c" 3 4
                                              ((void *)0)
# 279 "../crypto/ffc/ffc_params.c"
                                                  , indent))
        goto err;
    if (!ASN1_bn_print(bp, "generator G:", ffc->g, 
# 281 "../crypto/ffc/ffc_params.c" 3 4
                                                  ((void *)0)
# 281 "../crypto/ffc/ffc_params.c"
                                                      , indent))
        goto err;
    if (ffc->q != 
# 283 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 284 "../crypto/ffc/ffc_params.c"
       && !ASN1_bn_print(bp, "subgroup order Q:", ffc->q, 
# 284 "../crypto/ffc/ffc_params.c" 3 4
                                                          ((void *)0)
# 284 "../crypto/ffc/ffc_params.c"
                                                              , indent))
        goto err;
    if (ffc->j != 
# 286 "../crypto/ffc/ffc_params.c" 3 4
                 ((void *)0)
        
# 287 "../crypto/ffc/ffc_params.c"
       && !ASN1_bn_print(bp, "subgroup factor:", ffc->j, 
# 287 "../crypto/ffc/ffc_params.c" 3 4
                                                         ((void *)0)
# 287 "../crypto/ffc/ffc_params.c"
                                                             , indent))
        goto err;
    if (ffc->seed != 
# 289 "../crypto/ffc/ffc_params.c" 3 4
                    ((void *)0)
# 289 "../crypto/ffc/ffc_params.c"
                        ) {
        size_t i;
