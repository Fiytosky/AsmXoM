# 0 "../crypto/threads_pthread.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/threads_pthread.c"
# 13 "../crypto/threads_pthread.c"
...
# 17 "../crypto/threads_pthread.c" 2
# 1 "../crypto/rcu_internal.h" 1
# 12 "../crypto/rcu_internal.h"
...
# 18 "../crypto/threads_pthread.c" 2
# 42 "../crypto/threads_pthread.c"
# 1 "/usr/include/assert.h" 1 3 4
# 43 "../crypto/threads_pthread.c" 2
# 76 "../crypto/threads_pthread.c"
typedef void *pvoid;
# 170 "../crypto/threads_pthread.c"
struct rcu_qp {
    uint64_t users;
};
...
# 189 "../crypto/threads_pthread.c"
struct rcu_thr_data {
    struct thread_qp thread_qps[10];
};
...
static struct rcu_qp *get_hold_current_qp(struct rcu_lock_st *lock)
{
    ...
    for (;;) {
        qp_idx = __atomic_load_n(&lock->reader_idx, 0);
# 261 "../crypto/threads_pthread.c"
        __atomic_add_fetch(&lock->qp_group[qp_idx].users, (uint64_t)1, 2)
                                          ;


        if (qp_idx == __atomic_load_n(&lock->reader_idx, 2)
                                                     )
            break;

        __atomic_sub_fetch(&lock->qp_group[qp_idx].users, (uint64_t)1, 0)
                                          ;
    }
...
static void ossl_rcu_free_local_data(void *arg)
{
    ...
    CRYPTO_free(data, "../crypto/threads_pthread.c", 282);
    CRYPTO_THREAD_set_local(lkey, 
# 283 "../crypto/threads_pthread.c" 3 4
                                 ((void *)0)
# 283 "../crypto/threads_pthread.c"
                                     );
}
...
void ossl_rcu_read_lock(CRYPTO_RCU_LOCK *lock)
{
    ...
    if (data == 
# 298 "../crypto/threads_pthread.c" 3 4
               ((void *)0)
# 298 "../crypto/threads_pthread.c"
                   ) {
        data = CRYPTO_zalloc(sizeof(*data), "../crypto/threads_pthread.c", 299);
        (void)((data != 
# 300 "../crypto/threads_pthread.c" 3 4
       ((void *)0)
# 300 "../crypto/threads_pthread.c"
       ) ? 0 : (OPENSSL_die("assertion failed: " "data != NULL", "../crypto/threads_pthread.c", 300), 1));
        CRYPTO_THREAD_set_local(lkey, data);
        ossl_init_thread_start(
# 302 "../crypto/threads_pthread.c" 3 4
                              ((void *)0)
# 302 "../crypto/threads_pthread.c"
                                  , lock->ctx, ossl_rcu_free_local_data);
    }

    for (i = 0; i < 10; i++) {
        if (data->thread_qps[i].qp == 
# 306 "../crypto/threads_pthread.c" 3 4
                                     ((void *)0) 
# 306 "../crypto/threads_pthread.c"
                                          && available_qp == -1)
            available_qp = i;
...
# 318 "../crypto/threads_pthread.c" 3 4
   ((void) (0))
# 318 "../crypto/threads_pthread.c"
                             ;
...
# 332 "../crypto/threads_pthread.c" 3 4
   ((void) (0))
# 332 "../crypto/threads_pthread.c"
                       ;
    ...
    for (i = 0; i < 10; i++) {
        if (data->thread_qps[i].lock == lock) {
            ...
            if (data->thread_qps[i].depth == 0) {
                ret = __atomic_sub_fetch(&data->thread_qps[i].qp->users, (uint64_t)1, 3)
                                                                     ;
                (void)((ret != 
# 345 "../crypto/threads_pthread.c" 3 4
               (18446744073709551615UL)
# 345 "../crypto/threads_pthread.c"
               ) ? 0 : (OPENSSL_die("assertion failed: " "ret != UINT64_MAX", "../crypto/threads_pthread.c", 345), 1));
                data->thread_qps[i].qp = 
# 346 "../crypto/threads_pthread.c" 3 4
                                        ((void *)0)
# 346 "../crypto/threads_pthread.c"
                                            ;
                data->thread_qps[i].lock = 
# 347 "../crypto/threads_pthread.c" 3 4
                                          ((void *)0)
...
# 356 "../crypto/threads_pthread.c" 3 4
   ((void) (0))
# 356 "../crypto/threads_pthread.c"
            ;
}
...
static struct rcu_qp *update_qp(CRYPTO_RCU_LOCK *lock, uint32_t *curr_id)
{
    ...
    *curr_id = lock->id_ctr;
    ...
    __atomic_store_n(&lock->reader_idx, lock->current_alloc_idx, 3)
                                    ;
    ...
    __atomic_add_fetch(&lock->qp_group[current_idx].users, (uint64_t)0, 3)
                                      ;
...
{
    struct rcu_qp *new =
        CRYPTO_zalloc(sizeof(*new) * count, "../crypto/threads_pthread.c", 422);
...
void ossl_synchronize_rcu(CRYPTO_RCU_LOCK *lock)
{
    ...
    lock->cb_items = 
# 447 "../crypto/threads_pthread.c" 3 4
                    ((void *)0)
# 447 "../crypto/threads_pthread.c"
                        ;
    pthread_mutex_unlock(&lock->write_lock);
...
# 466 "../crypto/threads_pthread.c"
    do {
        count = __atomic_load_n(&qp->users, 2);
    ...
    while (cb_items != 
# 477 "../crypto/threads_pthread.c" 3 4
                      ((void *)0)
# 477 "../crypto/threads_pthread.c"
                          ) {
        tmpcb = cb_items;
        cb_items = cb_items->next;
        tmpcb->fn(tmpcb->data);
        CRYPTO_free(tmpcb, "../crypto/threads_pthread.c", 481);
    }
}
...
int ossl_rcu_call(CRYPTO_RCU_LOCK *lock, rcu_cb_fn cb, void *data)
{
    struct rcu_cb_item *new =
        CRYPTO_zalloc(sizeof(*new), "../crypto/threads_pthread.c", 492);

    if (new == 
# 494 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 494 "../crypto/threads_pthread.c"
                  )
        return 0;
...
void *ossl_rcu_uptr_deref(void **p)
{
    return __atomic_load_n(p, 2);
}

void ossl_rcu_assign_uptr(void **p, void **v)
{
    __atomic_store(p, v, 3);
}
...
CRYPTO_RCU_LOCK *ossl_rcu_lock_new(int num_writers, OSSL_LIB_CTX *ctx)
{
    ...
    if (ctx == 
# 527 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 527 "../crypto/threads_pthread.c"
                  )
        return 0;

    new = CRYPTO_zalloc(sizeof(*new), "../crypto/threads_pthread.c", 530);
    if (new == 
# 531 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 531 "../crypto/threads_pthread.c"
                  )
        return 
# 532 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 532 "../crypto/threads_pthread.c"
                  ;

    new->ctx = ctx;
    pthread_mutex_init(&new->write_lock, 
# 535 "../crypto/threads_pthread.c" 3 4
                                        ((void *)0)
# 535 "../crypto/threads_pthread.c"
                                            );
    pthread_mutex_init(&new->prior_lock, 
# 536 "../crypto/threads_pthread.c" 3 4
                                        ((void *)0)
# 536 "../crypto/threads_pthread.c"
                                            );
    pthread_mutex_init(&new->alloc_lock, 
# 537 "../crypto/threads_pthread.c" 3 4
                                        ((void *)0)
# 537 "../crypto/threads_pthread.c"
                                            );
    pthread_cond_init(&new->prior_signal, 
# 538 "../crypto/threads_pthread.c" 3 4
                                         ((void *)0)
# 538 "../crypto/threads_pthread.c"
                                             );
    pthread_cond_init(&new->alloc_signal, 
# 539 "../crypto/threads_pthread.c" 3 4
                                         ((void *)0)
# 539 "../crypto/threads_pthread.c"
                                             );

    new->qp_group = allocate_new_qp_group(new, num_writers);
    if (new->qp_group == 
# 542 "../crypto/threads_pthread.c" 3 4
                        ((void *)0)
# 542 "../crypto/threads_pthread.c"
                            ) {
        CRYPTO_free(new, "../crypto/threads_pthread.c", 543);
        new = 
# 544 "../crypto/threads_pthread.c" 3 4
             ((void *)0)
# 544 "../crypto/threads_pthread.c"
                 ;
    }
...
void ossl_rcu_lock_free(CRYPTO_RCU_LOCK *lock)
{
    ...
    if (lock == 
# 554 "../crypto/threads_pthread.c" 3 4
               ((void *)0)
# 554 "../crypto/threads_pthread.c"
                   )
        return;
    ...
    CRYPTO_free(rlock->qp_group, "../crypto/threads_pthread.c", 560);

    CRYPTO_free(rlock, "../crypto/threads_pthread.c", 562);
}
...
CRYPTO_RWLOCK *CRYPTO_THREAD_lock_new(void)
{
    ...
    if ((lock = CRYPTO_zalloc(sizeof(pthread_rwlock_t), "../crypto/threads_pthread.c", 570)) == 
# 570 "../crypto/threads_pthread.c" 3 4
                                                            ((void *)0)
# 570 "../crypto/threads_pthread.c"
                                                                )

        return 
# 572 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 572 "../crypto/threads_pthread.c"
                  ;

    if (pthread_rwlock_init(lock, 
# 574 "../crypto/threads_pthread.c" 3 4
                                 ((void *)0)
# 574 "../crypto/threads_pthread.c"
                                     ) != 0) {
        CRYPTO_free(lock, "../crypto/threads_pthread.c", 575);
        return 
# 576 "../crypto/threads_pthread.c" 3 4
              ((void *)0)
# 576 "../crypto/threads_pthread.c"
                  ;
    }
# 607 "../crypto/threads_pthread.c"
    return lock;
}
...
{
    if (lock == 
# 657 "../crypto/threads_pthread.c" 3 4
               ((void *)0)
# 657 "../crypto/threads_pthread.c"
                   )
        return;
    ...
    CRYPTO_free(lock, "../crypto/threads_pthread.c", 665);
...
int CRYPTO_atomic_add(int *val, int amount, int *ret, CRYPTO_RWLOCK *lock)
{
    ...
    if (__atomic_is_lock_free(sizeof(*val), val)) {
        *ret = __atomic_add_fetch(val, amount, 4);
        return 1;
    }
    ...
    if (lock == 
# 731 "../crypto/threads_pthread.c" 3 4
               ((void *)0) 
# 731 "../crypto/threads_pthread.c"
                     ...
                     CRYPTO_RWLOCK *lock)
{
    ...
    if (__atomic_is_lock_free(sizeof(*val), val)) {
        *ret = __atomic_or_fetch(val, op, 4);
        return 1;
    }
    ...
    if (lock == 
# 758 "../crypto/threads_pthread.c" 3 4
               ((void *)0) 
# 758 "../crypto/threads_pthread.c"
                    || !CRYPTO_THREAD_write_lock(lock))
        return 0;
    *val |= op;
    *ret = *val;
...
int CRYPTO_atomic_load(uint64_t *val, uint64_t *ret, CRYPTO_RWLOCK *lock)
{
    ...
    if (lock == 
# 783 "../crypto/threads_pthread.c" 3 4
               ((void *)0) 
# 783 "../crypto/threads_pthread.c"
...
int CRYPTO_atomic_load_int(int *val, int *ret, CRYPTO_RWLOCK *lock)
{
    ...
    if (lock == 
# 806 "../crypto/threads_pthread.c" 3 4
               ((void *)0) 
# 806 "../crypto/threads_pthread.c"
                    || !CRYPTO_THREAD_read_lock(lock))
        return 0;
    *ret = *val;
    if (!CRYPTO_THREAD_unlock(lock))
