# 0 "../crypto/pkcs7/pk7_smime.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs7/pk7_smime.c"
# 12 "../crypto/pkcs7/pk7_smime.c"
                     ...
                     const char *propq)
{
    ...
    if ((p7 = PKCS7_new_ex(libctx, propq)) == 
# 30 "../crypto/pkcs7/pk7_smime.c" 3 4
                                             ((void *)0)
# 30 "../crypto/pkcs7/pk7_smime.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",31,__func__), ERR_set_error)((33),((33 | (0x2 << 18L))),
# 31 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 31 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 32 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 32 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }
...
# 41 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                          ((void *)0)
# 41 "../crypto/pkcs7/pk7_smime.c"
                                                              , flags)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",42,__func__), ERR_set_error)((33),(153),
# 42 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 42 "../crypto/pkcs7/pk7_smime.c"
       );
        goto err;
    }
    ...
    if (!(flags & 0x2)) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
            if (!PKCS7_add_certificate(p7, ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)))))
                goto err;
        }
    }
    ...
    if (flags & 0x40)
        PKCS7_ctrl(p7,1,1,
# 54 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 54 "../crypto/pkcs7/pk7_smime.c"
       );
 ...
 err:
    PKCS7_free(p7);
    return 
# 64 "../crypto/pkcs7/pk7_smime.c" 3 4
          ((void *)0)
# 64 "../crypto/pkcs7/pk7_smime.c"
              ;
}
...
PKCS7 *PKCS7_sign(X509 *signcert, EVP_PKEY *pkey, struct stack_st_X509 *certs,
                  BIO *data, int flags)
{
    return PKCS7_sign_ex(signcert, pkey, certs, data, flags, 
# 70 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                            ((void *)0)
# 70 "../crypto/pkcs7/pk7_smime.c"
                                                                , 
# 70 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                                  ((void *)0)
# 70 "../crypto/pkcs7/pk7_smime.c"
...
# 79 "../crypto/pkcs7/pk7_smime.c" 3 4
                                   ((void *)0)
# 79 "../crypto/pkcs7/pk7_smime.c"
                                       )) == 
# 79 "../crypto/pkcs7/pk7_smime.c" 3 4
                                             ((void *)0)
# 79 "../crypto/pkcs7/pk7_smime.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",80,__func__), ERR_set_error)((33),((33 | (0x2 << 18L))),
# 80 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 80 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
...
# 87 "../crypto/pkcs7/pk7_smime.c" 3 4
         ((void *)0)
# 87 "../crypto/pkcs7/pk7_smime.c"
         );

    if (!PKCS7_dataFinal(p7, p7bio)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",90,__func__), ERR_set_error)((33),(145),
# 90 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 90 "../crypto/pkcs7/pk7_smime.c"
       );
        goto err;
    }
    ret = 1;
...
static int add_cipher_smcap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
...
static int add_digest_smcap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
...
# 121 "../crypto/pkcs7/pk7_smime.c" 3 4
                           ((void *)0)
# 121 "../crypto/pkcs7/pk7_smime.c"
                               ;
    struct stack_st_X509_ALGOR *smcap = 
# 122 "../crypto/pkcs7/pk7_smime.c" 3 4
                                 ((void *)0)
# 122 "../crypto/pkcs7/pk7_smime.c"
                                     ;

    if (!X509_check_private_key(signcert, pkey)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",125,__func__), ERR_set_error)((33),(127),
# 125 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 125 "../crypto/pkcs7/pk7_smime.c"
       )
                                                                 ;
        return 
# 127 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 127 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }

    if ((si = PKCS7_add_signature(p7, signcert, pkey, md)) == 
# 130 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                             ((void *)0)
# 130 "../crypto/pkcs7/pk7_smime.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",131,__func__), ERR_set_error)((33),(124),
# 131 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 131 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 132 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 132 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }
...
# 142 "../crypto/pkcs7/pk7_smime.c" 3 4
                                              ((void *)0)
# 142 "../crypto/pkcs7/pk7_smime.c"
                                                  ))
            goto err;

        if (!(flags & 0x200)) {
            if ((smcap = ((struct stack_st_X509_ALGOR *)OPENSSL_sk_new_null())) == 
# 146 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                     ((void *)0)
# 146 "../crypto/pkcs7/pk7_smime.c"
                                                         ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",147,__func__), ERR_set_error)((33),((15 | (0x2 << 18L))),
# 147 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 147 "../crypto/pkcs7/pk7_smime.c"
               );
                goto err;
            }
            if (!add_cipher_smcap(smcap, 427, -1)
                || !add_digest_smcap(smcap, 982, -1)
                || !add_digest_smcap(smcap, 983, -1)
            ...
            smcap = 
# 165 "../crypto/pkcs7/pk7_smime.c" 3 4
                   ((void *)0)
# 165 "../crypto/pkcs7/pk7_smime.c"
                       ;
        }
        if (flags & 0x8000) {
 ...
 err:
    OPENSSL_sk_pop_free(ossl_check_X509_ALGOR_sk_type(smcap),ossl_check_X509_ALGOR_freefunc_type(X509_ALGOR_free));
    return 
# 178 "../crypto/pkcs7/pk7_smime.c" 3 4
          ((void *)0)
# 178 "../crypto/pkcs7/pk7_smime.c"
              ;
}
...
# 191 "../crypto/pkcs7/pk7_smime.c" 3 4
                              ((void *)0)
# 191 "../crypto/pkcs7/pk7_smime.c"
                                  ;
    sinfos = PKCS7_get_signer_info(p7);
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)); i++) {
        sitmp = ((PKCS7_SIGNER_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos), (i)));
        if (si == sitmp)
            break;
        if (OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(sitmp->auth_attr)) <= 0)
            continue;
    ...
    if (osdig != 
# 206 "../crypto/pkcs7/pk7_smime.c" 3 4
                ((void *)0)
# 206 "../crypto/pkcs7/pk7_smime.c"
                    )
        return PKCS7_add1_attrib_digest(si, osdig->data, osdig->length);

    (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",209,__func__), ERR_set_error)((33),(154),
# 209 "../crypto/pkcs7/pk7_smime.c" 3 4
   ((void *)0)
# 209 "../crypto/pkcs7/pk7_smime.c"
   );
    return 0;
}
...
# 221 "../crypto/pkcs7/pk7_smime.c" 3 4
                              ((void *)0)
# 221 "../crypto/pkcs7/pk7_smime.c"
                                  ;
    char *buf = 
# 222 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 222 "../crypto/pkcs7/pk7_smime.c"
                   ;
    int i, j = 0, k, ret = 0;
    BIO *p7bio = 
# 224 "../crypto/pkcs7/pk7_smime.c" 3 4
                ((void *)0)
# 224 "../crypto/pkcs7/pk7_smime.c"
                    ;
    BIO *tmpout = 
# 225 "../crypto/pkcs7/pk7_smime.c" 3 4
                 ((void *)0)
# 225 "../crypto/pkcs7/pk7_smime.c"
                     ;
    const PKCS7_CTX *p7_ctx;

    if (p7 == 
# 228 "../crypto/pkcs7/pk7_smime.c" 3 4
             ((void *)0)
# 228 "../crypto/pkcs7/pk7_smime.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",229,__func__), ERR_set_error)((33),(143),
# 229 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 229 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }

    if (!(OBJ_obj2nid((p7)->type) == 22)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",234,__func__), ERR_set_error)((33),(113),
# 234 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 234 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
...
# 239 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 239 "../crypto/pkcs7/pk7_smime.c"
       ) && indata == 
# 239 "../crypto/pkcs7/pk7_smime.c" 3 4
                                           ((void *)0)
# 239 "../crypto/pkcs7/pk7_smime.c"
                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",240,__func__), ERR_set_error)((33),(122),
# 240 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 240 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
    ...
    if (flags & 0x10000) {
        ...
        if (!PKCS7_ctrl(p7,2,0,
# 252 "../crypto/pkcs7/pk7_smime.c" 3 4
            ((void *)0)
# 252 "../crypto/pkcs7/pk7_smime.c"
            ) && indata != 
# 252 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                ((void *)0)
# 252 "../crypto/pkcs7/pk7_smime.c"
                                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",253,__func__), ERR_set_error)((33),(118),
# 253 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 253 "../crypto/pkcs7/pk7_smime.c"
           );
            return 0;
        }
    }
    ...
    if (!sinfos || !OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos))) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",261,__func__), ERR_set_error)((33),(123),
# 261 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 261 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
    ...
    if (signers == 
# 266 "../crypto/pkcs7/pk7_smime.c" 3 4
                  ((void *)0)
# 266 "../crypto/pkcs7/pk7_smime.c"
                      )
        return 0;
    ...
    if (cert_ctx == 
# 273 "../crypto/pkcs7/pk7_smime.c" 3 4
                   ((void *)0)
# 273 "../crypto/pkcs7/pk7_smime.c"
                       )
        goto err;
    if (!(flags & 0x20))
        for (k = 0; k < OPENSSL_sk_num(ossl_check_const_X509_sk_type(signers)); k++) {
            signer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(signers), (k)));
            if (!(flags & 0x8)) {
                if (!X509_STORE_CTX_init(cert_ctx, store, signer,
                                         p7->d.sign->cert)) {
                    (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",281,__func__), ERR_set_error)((33),((11 | (0x2 << 18L))),
# 281 "../crypto/pkcs7/pk7_smime.c" 3 4
                   ((void *)0)
# 281 "../crypto/pkcs7/pk7_smime.c"
                   );
                    goto err;
                }
...
# 286 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                                    ((void *)0)
# 286 "../crypto/pkcs7/pk7_smime.c"
                                                                        )) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",287,__func__), ERR_set_error)((33),((11 | (0x2 << 18L))),
# 287 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 287 "../crypto/pkcs7/pk7_smime.c"
               );
                goto err;
            }
            if (!(flags & 0x2000))
            ...
            if (i <= 0) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",295,__func__), ERR_set_error)(33, 117,
                               "Verify error: %s",
    ...
    if ((p7bio = PKCS7_dataInit(p7, indata)) == 
# 303 "../crypto/pkcs7/pk7_smime.c" 3 4
                                               ((void *)0)
# 303 "../crypto/pkcs7/pk7_smime.c"
                                                   )
        goto err;

    if (flags & 0x1) {
        if ((tmpout = BIO_new(BIO_s_mem())) == 
# 307 "../crypto/pkcs7/pk7_smime.c" 3 4
                                              ((void *)0)
# 307 "../crypto/pkcs7/pk7_smime.c"
                                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",308,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 308 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 308 "../crypto/pkcs7/pk7_smime.c"
           );
            goto err;
        }
        BIO_ctrl(tmpout,130,0,
# 311 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 311 "../crypto/pkcs7/pk7_smime.c"
       );
    } else
        tmpout = out;


    if ((buf = CRYPTO_malloc(4096, "../crypto/pkcs7/pk7_smime.c", 316)) == 
# 316 "../crypto/pkcs7/pk7_smime.c" 3 4
                                             ((void *)0)
# 316 "../crypto/pkcs7/pk7_smime.c"
                                                 )
        goto err;
    for (;;) {
        i = BIO_read(p7bio, buf, 4096);
        if (i <= 0)
            break;
        if (tmpout)
    ...
    if (flags & 0x1) {
        if (!SMIME_text(tmpout, out)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",328,__func__), ERR_set_error)((33),(129),
# 328 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 328 "../crypto/pkcs7/pk7_smime.c"
           );
            goto err;
        }
    }
    ...
    if (!(flags & 0x4))
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)); i++) {
            si = ((PKCS7_SIGNER_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos), (i)));
            signer = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(signers), (i)));
            j = PKCS7_signatureVerify(p7bio, p7, si, signer);
            if (j <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",340,__func__), ERR_set_error)((33),(105),
# 340 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 340 "../crypto/pkcs7/pk7_smime.c"
               );
                goto err;
            }
        }
 ...
 err:
    ...
    CRYPTO_free(buf, "../crypto/pkcs7/pk7_smime.c", 351);
    if (indata != 
# 352 "../crypto/pkcs7/pk7_smime.c" 3 4
                 ((void *)0)
# 352 "../crypto/pkcs7/pk7_smime.c"
                     )
        BIO_pop(p7bio);
    BIO_free_all(p7bio);
                                   ...
                                   int flags)
{
    ...
    if (p7 == 
# 369 "../crypto/pkcs7/pk7_smime.c" 3 4
             ((void *)0)
# 369 "../crypto/pkcs7/pk7_smime.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",370,__func__), ERR_set_error)((33),(143),
# 370 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 370 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 371 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 371 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }

    if (!(OBJ_obj2nid((p7)->type) == 22)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",375,__func__), ERR_set_error)((33),(113),
# 375 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 375 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 376 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 376 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }
    ...
    if (OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",384,__func__), ERR_set_error)((33),(142),
# 384 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 384 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }

    if ((signers = ((struct stack_st_X509 *)OPENSSL_sk_new_null())) == 
# 388 "../crypto/pkcs7/pk7_smime.c" 3 4
                                         ((void *)0)
# 388 "../crypto/pkcs7/pk7_smime.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",389,__func__), ERR_set_error)((33),((15 | (0x2 << 18L))),
# 389 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 389 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 390 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 390 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)); i++) {
        ...
        signer = 
# 396 "../crypto/pkcs7/pk7_smime.c" 3 4
                ((void *)0)
# 396 "../crypto/pkcs7/pk7_smime.c"
                    ;

        if (certs != 
# 398 "../crypto/pkcs7/pk7_smime.c" 3 4
                    ((void *)0)
# 398 "../crypto/pkcs7/pk7_smime.c"
                        )
            signer = X509_find_by_issuer_and_serial(certs,
                                                    ias->issuer, ias->serial);
        if (signer == 
# 401 "../crypto/pkcs7/pk7_smime.c" 3 4
                     ((void *)0) 
# 401 "../crypto/pkcs7/pk7_smime.c"
                          && !(flags & 0x10)
            && p7->d.sign->cert)
            signer =
                X509_find_by_issuer_and_serial(p7->d.sign->cert,
                                               ias->issuer, ias->serial);
        if (signer == 
# 406 "../crypto/pkcs7/pk7_smime.c" 3 4
                     ((void *)0)
# 406 "../crypto/pkcs7/pk7_smime.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",407,__func__), ERR_set_error)((33),(128),
# 407 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 407 "../crypto/pkcs7/pk7_smime.c"
           );
            OPENSSL_sk_free(ossl_check_X509_sk_type(signers));
            return 0;
        }

        if (!OPENSSL_sk_push(ossl_check_X509_sk_type(signers), ossl_check_X509_type(signer))) {
            OPENSSL_sk_free(ossl_check_X509_sk_type(signers));
            return 
# 414 "../crypto/pkcs7/pk7_smime.c" 3 4
                  ((void *)0)
# 414 "../crypto/pkcs7/pk7_smime.c"
                      ;
        }
    }
    return signers;
                        ...
                        OSSL_LIB_CTX *libctx, const char *propq)
{
    PKCS7 *p7;
    BIO *p7bio = 
# 427 "../crypto/pkcs7/pk7_smime.c" 3 4
                ((void *)0)
# 427 "../crypto/pkcs7/pk7_smime.c"
                    ;
    int i;
    X509 *x509;

    if ((p7 = PKCS7_new_ex(libctx, propq)) == 
# 431 "../crypto/pkcs7/pk7_smime.c" 3 4
                                             ((void *)0)
# 431 "../crypto/pkcs7/pk7_smime.c"
                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",432,__func__), ERR_set_error)((33),((33 | (0x2 << 18L))),
# 432 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 432 "../crypto/pkcs7/pk7_smime.c"
       );
        return 
# 433 "../crypto/pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 433 "../crypto/pkcs7/pk7_smime.c"
                  ;
    }
    ...
    if (!PKCS7_set_cipher(p7, cipher)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",439,__func__), ERR_set_error)((33),(121),
# 439 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 439 "../crypto/pkcs7/pk7_smime.c"
       );
        goto err;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++) {
        x509 = ((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i)));
        if (!PKCS7_add_recipient(p7, x509)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",446,__func__), ERR_set_error)((33),(120),
# 446 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 446 "../crypto/pkcs7/pk7_smime.c"
           );
            goto err;
        }
    }
 ...
 err:
    ...
    PKCS7_free(p7);
    return 
# 461 "../crypto/pkcs7/pk7_smime.c" 3 4
          ((void *)0)
# 461 "../crypto/pkcs7/pk7_smime.c"
              ;
...
PKCS7 *PKCS7_encrypt(struct stack_st_X509 *certs, BIO *in, const EVP_CIPHER *cipher,
                     int flags)
{
    return PKCS7_encrypt_ex(certs, in, cipher, flags, 
# 468 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                     ((void *)0)
# 468 "../crypto/pkcs7/pk7_smime.c"
                                                         , 
# 468 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                           ((void *)0)
# 468 "../crypto/pkcs7/pk7_smime.c"
...
int PKCS7_decrypt(PKCS7 *p7, EVP_PKEY *pkey, X509 *cert, BIO *data, int flags)
{
    ...
    int ret = 0, i;
    char *buf = 
# 476 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 476 "../crypto/pkcs7/pk7_smime.c"
                   ;

    if (p7 == 
# 478 "../crypto/pkcs7/pk7_smime.c" 3 4
             ((void *)0)
# 478 "../crypto/pkcs7/pk7_smime.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",479,__func__), ERR_set_error)((33),(143),
# 479 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 479 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
    ...
    if (!(OBJ_obj2nid((p7)->type) == 23)
        ...
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",485,__func__), ERR_set_error)((33),(113),
# 485 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 485 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }

    if (cert && !X509_check_private_key(cert, pkey)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",490,__func__), ERR_set_error)((33),(127),
# 490 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 490 "../crypto/pkcs7/pk7_smime.c"
       )
                                                                 ;
        return 0;
    }
...
# 495 "../crypto/pkcs7/pk7_smime.c" 3 4
                                            ((void *)0)
# 495 "../crypto/pkcs7/pk7_smime.c"
                                                , cert)) == 
# 495 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                            ((void *)0)
# 495 "../crypto/pkcs7/pk7_smime.c"
                                                                ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",496,__func__), ERR_set_error)((33),(119),
# 496 "../crypto/pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 496 "../crypto/pkcs7/pk7_smime.c"
       );
        return 0;
    }
...
# 503 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                 ((void *)0)
# 503 "../crypto/pkcs7/pk7_smime.c"
                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",504,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 504 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 504 "../crypto/pkcs7/pk7_smime.c"
           );
            BIO_free_all(tmpmem);
            return 0;
        }
        if ((bread = BIO_push(tmpbuf, tmpmem)) == 
# 508 "../crypto/pkcs7/pk7_smime.c" 3 4
                                                 ((void *)0)
# 508 "../crypto/pkcs7/pk7_smime.c"
                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_smime.c",509,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 509 "../crypto/pkcs7/pk7_smime.c" 3 4
           ((void *)0)
# 509 "../crypto/pkcs7/pk7_smime.c"
           );
            BIO_free_all(tmpbuf);
            BIO_free_all(tmpmem);
            return 0;
...
# 516 "../crypto/pkcs7/pk7_smime.c" 3 4
               ((void *)0)
# 516 "../crypto/pkcs7/pk7_smime.c"
               ) <= 0)
                ret = 0;
        }
        BIO_free_all(bread);
    ...
    if ((buf = CRYPTO_malloc(4096, "../crypto/pkcs7/pk7_smime.c", 522)) == 
# 522 "../crypto/pkcs7/pk7_smime.c" 3 4
                                             ((void *)0)
# 522 "../crypto/pkcs7/pk7_smime.c"
                                                 )
        goto err;
    for (;;) {
        i = BIO_read(tmpmem, buf, 4096);
        if (i <= 0) {
            ret = 1;
            if (BIO_method_type(tmpmem) == (10|0x0200)) {
                if (BIO_ctrl(tmpmem,113,0,
# 529 "../crypto/pkcs7/pk7_smime.c" 3 4
                   ((void *)0)
# 529 "../crypto/pkcs7/pk7_smime.c"
                   ) <= 0)
                    ret = 0;
            }
...
err:
    CRYPTO_free(buf, "../crypto/pkcs7/pk7_smime.c", 540);
    BIO_free_all(tmpmem);
    return ret;
}
