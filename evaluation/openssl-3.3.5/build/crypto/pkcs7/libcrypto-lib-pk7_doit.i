# 0 "../crypto/pkcs7/pk7_doit.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs7/pk7_doit.c"
# 10 "../crypto/pkcs7/pk7_doit.c"
...
# 17 "../include/openssl/randerr.h" 2
...
# 18 "../include/openssl/randerr.h" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 17 "../crypto/pkcs7/pk7_doit.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 18 "../crypto/pkcs7/pk7_doit.c" 2
...
# 1 "../crypto/pkcs7/pk7_local.h" 1
# 10 "../crypto/pkcs7/pk7_local.h"
# 1 "../include/crypto/pkcs7.h" 1
...
# 20 "../crypto/pkcs7/pk7_doit.c" 2

static int add_attribute(struct stack_st_X509_ATTRIBUTE **sk, int nid, int atrtype,
                         void *value);
static ASN1_TYPE *get_attribute(const struct stack_st_X509_ATTRIBUTE *sk, int nid);
...
ASN1_OCTET_STRING *PKCS7_get_octet_string(PKCS7 *p7)
{
    ...
    return 
# 55 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 55 "../crypto/pkcs7/pk7_doit.c"
              ;
}
                                ...
                                const PKCS7_CTX *ctx)
{
    ...
    char name[50];
    EVP_MD *fetched = 
# 63 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 63 "../crypto/pkcs7/pk7_doit.c"
                         ;
    const EVP_MD *md;

    if ((btmp = BIO_new(BIO_f_md())) == 
# 66 "../crypto/pkcs7/pk7_doit.c" 3 4
                                       ((void *)0)
# 66 "../crypto/pkcs7/pk7_doit.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",67,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 67 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 67 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (fetched != 
# 76 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 76 "../crypto/pkcs7/pk7_doit.c"
                      )
        md = fetched;
    else
    ...
    if (md == 
# 81 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 81 "../crypto/pkcs7/pk7_doit.c"
                 ) {
        (void)ERR_clear_last_mark();
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",83,__func__), ERR_set_error)((33),(109),
# 83 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 83 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    (void)ERR_pop_to_mark();

    if (BIO_ctrl(btmp,111,0,(void *)(md)) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",89,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 89 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 89 "../crypto/pkcs7/pk7_doit.c"
       );
        EVP_MD_free(fetched);
        goto err;
    }
    EVP_MD_free(fetched);
    if (*pbio == 
# 94 "../crypto/pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 94 "../crypto/pkcs7/pk7_doit.c"
                    )
        *pbio = btmp;
    else if (!BIO_push(*pbio, btmp)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",97,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 97 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 97 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    btmp = 
# 100 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 100 "../crypto/pkcs7/pk7_doit.c"
              ;
...
{
    EVP_PKEY_CTX *pctx = 
# 112 "../crypto/pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 112 "../crypto/pkcs7/pk7_doit.c"
                            ;
    EVP_PKEY *pkey = 
# 113 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 113 "../crypto/pkcs7/pk7_doit.c"
                        ;
    unsigned char *ek = 
# 114 "../crypto/pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 114 "../crypto/pkcs7/pk7_doit.c"
                           ;
    int ret = 0;
    size_t eklen;
    ...
    if (pkey == 
# 120 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 120 "../crypto/pkcs7/pk7_doit.c"
                   )
        return 0;
    ...
    pctx = EVP_PKEY_CTX_new_from_pkey(ossl_pkcs7_ctx_get0_libctx(ctx), pkey,
                                      ossl_pkcs7_ctx_get0_propq(ctx));
    if (pctx == 
# 125 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 125 "../crypto/pkcs7/pk7_doit.c"
                   )
        return 0;
...
# 131 "../crypto/pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 131 "../crypto/pkcs7/pk7_doit.c"
                                  , &eklen, key, keylen) <= 0)
        goto err;

    ek = CRYPTO_malloc(eklen, "../crypto/pkcs7/pk7_doit.c", 134);
    if (ek == 
# 135 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 135 "../crypto/pkcs7/pk7_doit.c"
                 )
        goto err;
    ...
    ek = 
# 142 "../crypto/pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 142 "../crypto/pkcs7/pk7_doit.c"
            ;
 ...
 err:
    ...
    CRYPTO_free(ek, "../crypto/pkcs7/pk7_doit.c", 148);
    return ret;
...
{
    EVP_PKEY_CTX *pctx = 
# 157 "../crypto/pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 157 "../crypto/pkcs7/pk7_doit.c"
                            ;
    unsigned char *ek = 
# 158 "../crypto/pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 158 "../crypto/pkcs7/pk7_doit.c"
                           ;
    size_t eklen;
    int ret = -1;
    const PKCS7_CTX *ctx = ri->ctx;
    ...
    pctx = EVP_PKEY_CTX_new_from_pkey(ossl_pkcs7_ctx_get0_libctx(ctx), pkey,
                                      ossl_pkcs7_ctx_get0_propq(ctx));
    if (pctx == 
# 165 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 165 "../crypto/pkcs7/pk7_doit.c"
                   )
        return -1;
    ...
    CRYPTO_clear_free(*pek, *peklen, "../crypto/pkcs7/pk7_doit.c", 185);
    *pek = ek;
    *peklen = eklen;
 ...
 err:
    EVP_PKEY_CTX_free(pctx);
    if (!ret)
        CRYPTO_free(ek, "../crypto/pkcs7/pk7_doit.c", 192);
...
BIO *PKCS7_dataInit(PKCS7 *p7, BIO *bio)
{
    int i;
    BIO *out = 
# 200 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 200 "../crypto/pkcs7/pk7_doit.c"
                  , *btmp = 
# 200 "../crypto/pkcs7/pk7_doit.c" 3 4
                            ((void *)0)
# 200 "../crypto/pkcs7/pk7_doit.c"
                                ;
    X509_ALGOR *xa = 
# 201 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 201 "../crypto/pkcs7/pk7_doit.c"
                        ;
    EVP_CIPHER *fetched_cipher = 
# 202 "../crypto/pkcs7/pk7_doit.c" 3 4
                                ((void *)0)
# 202 "../crypto/pkcs7/pk7_doit.c"
                                    ;
    const EVP_CIPHER *cipher;
    const EVP_CIPHER *evp_cipher = 
# 204 "../crypto/pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 204 "../crypto/pkcs7/pk7_doit.c"
                                      ;
    struct stack_st_X509_ALGOR *md_sk = 
# 205 "../crypto/pkcs7/pk7_doit.c" 3 4
                                 ((void *)0)
# 205 "../crypto/pkcs7/pk7_doit.c"
                                     ;
    struct stack_st_PKCS7_RECIP_INFO *rsk = 
# 206 "../crypto/pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 206 "../crypto/pkcs7/pk7_doit.c"
                                         ;
    X509_ALGOR *xalg = 
# 207 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 207 "../crypto/pkcs7/pk7_doit.c"
                          ;
    PKCS7_RECIP_INFO *ri = 
# 208 "../crypto/pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 208 "../crypto/pkcs7/pk7_doit.c"
                              ;
    ASN1_OCTET_STRING *os = 
# 209 "../crypto/pkcs7/pk7_doit.c" 3 4
                           ((void *)0)
# 209 "../crypto/pkcs7/pk7_doit.c"
                               ;
    ...
    if (p7 == 
# 214 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 214 "../crypto/pkcs7/pk7_doit.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",215,__func__), ERR_set_error)((33),(143),
# 215 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 215 "../crypto/pkcs7/pk7_doit.c"
       );
        return 
# 216 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 216 "../crypto/pkcs7/pk7_doit.c"
                  ;
    }
    p7_ctx = ossl_pkcs7_get0_ctx(p7);
    libctx = ossl_pkcs7_ctx_get0_libctx(p7_ctx);
    propq = ossl_pkcs7_ctx_get0_propq(p7_ctx);
# 232 "../crypto/pkcs7/pk7_doit.c"
    if (p7->d.ptr == 
# 232 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 232 "../crypto/pkcs7/pk7_doit.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",233,__func__), ERR_set_error)((33),(122),
# 233 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 233 "../crypto/pkcs7/pk7_doit.c"
       );
        return 
# 234 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 234 "../crypto/pkcs7/pk7_doit.c"
                  ;
    }
    ...
    case 24:
        ...
        if (evp_cipher == 
# 250 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 250 "../crypto/pkcs7/pk7_doit.c"
                             ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",251,__func__), ERR_set_error)((33),(116),
# 251 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 251 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        break;
    case 23:
        ...
        if (evp_cipher == 
# 259 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 259 "../crypto/pkcs7/pk7_doit.c"
                             ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",260,__func__), ERR_set_error)((33),(116),
# 260 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 260 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        break;
    ...
    case 21:
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",271,__func__), ERR_set_error)((33),(112),
# 271 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 271 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ALGOR_sk_type(md_sk)); i++)
        if (!pkcs7_bio_add_digest(&out, ((X509_ALGOR *)OPENSSL_sk_value(ossl_check_const_X509_ALGOR_sk_type(md_sk), (i))), p7_ctx))
            goto err;
    ...
    if (evp_cipher != 
# 282 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 282 "../crypto/pkcs7/pk7_doit.c"
                         ) {
...
# 288 "../crypto/pkcs7/pk7_doit.c" 3 4
                                               ((void *)0)
# 288 "../crypto/pkcs7/pk7_doit.c"
                                                   ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",289,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 289 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 289 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        BIO_ctrl(btmp,129,0,(&ctx));
        ...
        (void)ERR_pop_to_mark();
        if (fetched_cipher != 
# 305 "../crypto/pkcs7/pk7_doit.c" 3 4
                             ((void *)0)
# 305 "../crypto/pkcs7/pk7_doit.c"
                                 )
...
# 310 "../crypto/pkcs7/pk7_doit.c" 3 4
                                          ((void *)0)
# 310 "../crypto/pkcs7/pk7_doit.c"
                                              , 
# 310 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                ((void *)0)
# 310 "../crypto/pkcs7/pk7_doit.c"
...
# 310 "../crypto/pkcs7/pk7_doit.c"
        ...
        fetched_cipher = 
# 314 "../crypto/pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 314 "../crypto/pkcs7/pk7_doit.c"
                            ;

        if (EVP_CIPHER_CTX_rand_key(ctx, key) <= 0)
            goto err;
        if (EVP_CipherInit_ex(ctx, 
# 318 "../crypto/pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 318 "../crypto/pkcs7/pk7_doit.c"
                                      , 
# 318 "../crypto/pkcs7/pk7_doit.c" 3 4
                                        ((void *)0)
# 318 "../crypto/pkcs7/pk7_doit.c"
        ...
        if (ivlen > 0) {
            if (xalg->parameter == 
# 322 "../crypto/pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 322 "../crypto/pkcs7/pk7_doit.c"
                                      ) {
                xalg->parameter = ASN1_TYPE_new();
                if (xalg->parameter == 
# 324 "../crypto/pkcs7/pk7_doit.c" 3 4
                                      ((void *)0)
# 324 "../crypto/pkcs7/pk7_doit.c"
                                          )
                    goto err;
            }
            if (EVP_CIPHER_param_to_asn1(ctx, xalg->parameter) <= 0) {
                ...
                xalg->parameter = 
# 329 "../crypto/pkcs7/pk7_doit.c" 3 4
                                 ((void *)0)
# 329 "../crypto/pkcs7/pk7_doit.c"
                                     ;
                goto err;
            }
        }
        ...
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk)); i++) {
            ri = ((PKCS7_RECIP_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk), (i)));
        ...
        if (out == 
# 342 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 342 "../crypto/pkcs7/pk7_doit.c"
                      )
            out = btmp;
        else
            BIO_push(out, btmp);
        btmp = 
# 346 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 346 "../crypto/pkcs7/pk7_doit.c"
                  ;
    }

    if (bio == 
# 349 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 349 "../crypto/pkcs7/pk7_doit.c"
                  ) {
        if (((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 350 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 350 "../crypto/pkcs7/pk7_doit.c"
           ))) {
            ...
            if (bio == 
# 356 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 356 "../crypto/pkcs7/pk7_doit.c"
                          )
                goto err;
            BIO_ctrl(bio,130,0,
# 358 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 358 "../crypto/pkcs7/pk7_doit.c"
           );
        }
        if (bio == 
# 360 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 360 "../crypto/pkcs7/pk7_doit.c"
                      )
            goto err;
    }
    if (out)
 ...
 err:
    ...
    BIO_free_all(btmp);
    return 
# 373 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 373 "../crypto/pkcs7/pk7_doit.c"
              ;
}
...
BIO *PKCS7_dataDecode(PKCS7 *p7, EVP_PKEY *pkey, BIO *in_bio, X509 *pcert)
{
    int i, len;
    BIO *out = 
# 391 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 391 "../crypto/pkcs7/pk7_doit.c"
                  , *btmp = 
# 391 "../crypto/pkcs7/pk7_doit.c" 3 4
                            ((void *)0)
# 391 "../crypto/pkcs7/pk7_doit.c"
...
# 393 "../crypto/pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 393 "../crypto/pkcs7/pk7_doit.c"
                                      ;
    EVP_MD *evp_md = 
# 394 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 394 "../crypto/pkcs7/pk7_doit.c"
                        ;
    const EVP_MD *md;
    EVP_CIPHER *evp_cipher = 
# 396 "../crypto/pkcs7/pk7_doit.c" 3 4
                            ((void *)0)
# 396 "../crypto/pkcs7/pk7_doit.c"
                                ;
    const EVP_CIPHER *cipher = 
# 397 "../crypto/pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 397 "../crypto/pkcs7/pk7_doit.c"
                                  ;
    EVP_CIPHER_CTX *evp_ctx = 
# 398 "../crypto/pkcs7/pk7_doit.c" 3 4
                             ((void *)0)
# 398 "../crypto/pkcs7/pk7_doit.c"
                                 ;
    X509_ALGOR *enc_alg = 
# 399 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 399 "../crypto/pkcs7/pk7_doit.c"
                             ;
    struct stack_st_X509_ALGOR *md_sk = 
# 400 "../crypto/pkcs7/pk7_doit.c" 3 4
                                 ((void *)0)
# 400 "../crypto/pkcs7/pk7_doit.c"
                                     ;
    struct stack_st_PKCS7_RECIP_INFO *rsk = 
# 401 "../crypto/pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 401 "../crypto/pkcs7/pk7_doit.c"
                                         ;
    PKCS7_RECIP_INFO *ri = 
# 402 "../crypto/pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 402 "../crypto/pkcs7/pk7_doit.c"
                              ;
    unsigned char *ek = 
# 403 "../crypto/pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 403 "../crypto/pkcs7/pk7_doit.c"
                           , *tkey = 
# 403 "../crypto/pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 403 "../crypto/pkcs7/pk7_doit.c"
    ...
    if (p7 == 
# 410 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 410 "../crypto/pkcs7/pk7_doit.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",411,__func__), ERR_set_error)((33),(143),
# 411 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 411 "../crypto/pkcs7/pk7_doit.c"
       );
        return 
# 412 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 412 "../crypto/pkcs7/pk7_doit.c"
                  ;
    }
    ...
    if (p7->d.ptr == 
# 419 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 419 "../crypto/pkcs7/pk7_doit.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",420,__func__), ERR_set_error)((33),(122),
# 420 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 420 "../crypto/pkcs7/pk7_doit.c"
       );
        return 
# 421 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 421 "../crypto/pkcs7/pk7_doit.c"
    ...
    case 22:
        ...
        if (!((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 436 "../crypto/pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 436 "../crypto/pkcs7/pk7_doit.c"
            )) && data_body == 
# 436 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                  ((void *)0)
# 436 "../crypto/pkcs7/pk7_doit.c"
                                                      ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",437,__func__), ERR_set_error)((33),(155),
# 437 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 437 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        md_sk = p7->d.sign->md_algs;
    ...
    case 24:
        ...
        if (evp_cipher != 
# 453 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 453 "../crypto/pkcs7/pk7_doit.c"
                             )
            cipher = evp_cipher;
        else
        ...
        if (cipher == 
# 458 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 458 "../crypto/pkcs7/pk7_doit.c"
                         ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",460,__func__), ERR_set_error)((33),(111),
# 460 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 460 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        (void)ERR_pop_to_mark();
    ...
    case 23:
        ...
        evp_cipher = EVP_CIPHER_fetch(libctx, name, propq);
        if (evp_cipher != 
# 474 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 474 "../crypto/pkcs7/pk7_doit.c"
                             )
            cipher = evp_cipher;
        else
            cipher = EVP_get_cipherbyname(name);
        ...
        if (cipher == 
# 479 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 479 "../crypto/pkcs7/pk7_doit.c"
                         ) {
            (void)ERR_clear_last_mark();
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",481,__func__), ERR_set_error)((33),(111),
# 481 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 481 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        (void)ERR_pop_to_mark();
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",487,__func__), ERR_set_error)((33),(112),
# 487 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 487 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (data_body == 
# 492 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0) 
# 492 "../crypto/pkcs7/pk7_doit.c"
                         && in_bio == 
# 492 "../crypto/pkcs7/pk7_doit.c" 3 4
                                      ((void *)0)
# 492 "../crypto/pkcs7/pk7_doit.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",493,__func__), ERR_set_error)((33),(122),
# 493 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 493 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (md_sk != 
# 498 "../crypto/pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 498 "../crypto/pkcs7/pk7_doit.c"
                    ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ALGOR_sk_type(md_sk)); i++) {
            xa = ((X509_ALGOR *)OPENSSL_sk_value(ossl_check_const_X509_ALGOR_sk_type(md_sk), (i)));
            if ((btmp = BIO_new(BIO_f_md())) == 
# 501 "../crypto/pkcs7/pk7_doit.c" 3 4
                                               ((void *)0)
# 501 "../crypto/pkcs7/pk7_doit.c"
                                                   ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",502,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 502 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 502 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
            ...
            if (evp_md != 
# 510 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 510 "../crypto/pkcs7/pk7_doit.c"
                             )
                md = evp_md;
            else
                md = EVP_get_digestbyname(name);
            ...
            if (md == 
# 515 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 515 "../crypto/pkcs7/pk7_doit.c"
                         ) {
                (void)ERR_clear_last_mark();
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",517,__func__), ERR_set_error)((33),(109),
# 517 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 517 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
            (void)ERR_pop_to_mark();
            ...
            if (BIO_ctrl(btmp,111,0,(void *)(md)) <= 0) {
                EVP_MD_free(evp_md);
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",524,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 524 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 524 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
            EVP_MD_free(evp_md);
            if (out == 
# 528 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 528 "../crypto/pkcs7/pk7_doit.c"
                          )
                out = btmp;
            else
                BIO_push(out, btmp);
            btmp = 
# 532 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 532 "../crypto/pkcs7/pk7_doit.c"
                      ;
        }
    }

    if (cipher != 
# 536 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 536 "../crypto/pkcs7/pk7_doit.c"
                     ) {
        if ((etmp = BIO_new(BIO_f_cipher())) == 
# 537 "../crypto/pkcs7/pk7_doit.c" 3 4
                                               ((void *)0)
# 537 "../crypto/pkcs7/pk7_doit.c"
                                                   ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",538,__func__), ERR_set_error)((33),((32 | (0x2 << 18L))),
# 538 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 538 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
# 552 "../crypto/pkcs7/pk7_doit.c"
        if (pcert) {
            for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk)); i++) {
                ri = ((PKCS7_RECIP_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk), (i)));
                if (!pkcs7_cmp_ri(ri, pcert))
                    break;
                ri = 
# 557 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 557 "../crypto/pkcs7/pk7_doit.c"
                        ;
            }
            if (ri == 
# 559 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 559 "../crypto/pkcs7/pk7_doit.c"
                         ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",560,__func__), ERR_set_error)((33),(115),
# 560 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 560 "../crypto/pkcs7/pk7_doit.c"
               )
                                                                   ;
                goto err;
            }
        ...
        if (pcert == 
# 567 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 567 "../crypto/pkcs7/pk7_doit.c"
                        ) {
        ...
        evp_ctx = 
# 588 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 588 "../crypto/pkcs7/pk7_doit.c"
                     ;
        BIO_ctrl(etmp,129,0,(&evp_ctx));
        if (EVP_CipherInit_ex(evp_ctx, cipher, 
# 590 "../crypto/pkcs7/pk7_doit.c" 3 4
                                              ((void *)0)
# 590 "../crypto/pkcs7/pk7_doit.c"
                                                  , 
# 590 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                    ((void *)0)
# 590 "../crypto/pkcs7/pk7_doit.c"
...
# 590 "../crypto/pkcs7/pk7_doit.c"
        ...
        if (len <= 0)
            goto err;
        tkeylen = (size_t)len;
        tkey = CRYPTO_malloc(tkeylen, "../crypto/pkcs7/pk7_doit.c", 599);
        if (tkey == 
# 600 "../crypto/pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 600 "../crypto/pkcs7/pk7_doit.c"
                       )
            goto err;
        if (EVP_CIPHER_CTX_rand_key(evp_ctx, tkey) <= 0)
            goto err;
        if (ek == 
# 604 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 604 "../crypto/pkcs7/pk7_doit.c"
                     ) {
            ek = tkey;
            eklen = tkeylen;
            tkey = 
# 607 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 607 "../crypto/pkcs7/pk7_doit.c"
                      ;
        }
        ...
        if (eklen != EVP_CIPHER_CTX_get_key_length(evp_ctx)) {
            ...
            if (EVP_CIPHER_CTX_set_key_length(evp_ctx, eklen) <= 0) {
                ...
                CRYPTO_clear_free(ek, eklen, "../crypto/pkcs7/pk7_doit.c", 618);
                ek = tkey;
                eklen = tkeylen;
                tkey = 
# 621 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 621 "../crypto/pkcs7/pk7_doit.c"
                          ;
            }
        }
...
# 626 "../crypto/pkcs7/pk7_doit.c" 3 4
                                      ((void *)0)
# 626 "../crypto/pkcs7/pk7_doit.c"
                                          , 
# 626 "../crypto/pkcs7/pk7_doit.c" 3 4
                                            ((void *)0)
# 626 "../crypto/pkcs7/pk7_doit.c"
...
# 626 "../crypto/pkcs7/pk7_doit.c"
        ...
        CRYPTO_clear_free(ek, eklen, "../crypto/pkcs7/pk7_doit.c", 629);
        ek = 
# 630 "../crypto/pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 630 "../crypto/pkcs7/pk7_doit.c"
                ;
        CRYPTO_clear_free(tkey, tkeylen, "../crypto/pkcs7/pk7_doit.c", 631);
        tkey = 
# 632 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 632 "../crypto/pkcs7/pk7_doit.c"
                  ;

        if (out == 
# 634 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 634 "../crypto/pkcs7/pk7_doit.c"
                      )
            out = etmp;
        else
            BIO_push(out, etmp);
        etmp = 
# 638 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 638 "../crypto/pkcs7/pk7_doit.c"
                  ;
    }
    if (in_bio != 
# 640 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 640 "../crypto/pkcs7/pk7_doit.c"
                     ) {
        bio = in_bio;
    } else {
        if (data_body->length > 0)
            ...
            bio = BIO_new(BIO_s_mem());
            if (bio == 
# 647 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 647 "../crypto/pkcs7/pk7_doit.c"
                          )
                goto err;
            BIO_ctrl(bio,130,0,
# 649 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 649 "../crypto/pkcs7/pk7_doit.c"
           );
        }
        if (bio == 
# 651 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 651 "../crypto/pkcs7/pk7_doit.c"
                      )
            goto err;
    }
    BIO_push(out, bio);
    bio = 
# 655 "../crypto/pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 655 "../crypto/pkcs7/pk7_doit.c"
             ;
 ...
 err:
    EVP_CIPHER_free(evp_cipher);
    CRYPTO_clear_free(ek, eklen, "../crypto/pkcs7/pk7_doit.c", 661);
    CRYPTO_clear_free(tkey, tkeylen, "../crypto/pkcs7/pk7_doit.c", 662);
    BIO_free_all(out);
    BIO_free_all(btmp);
    BIO_free_all(etmp);
    BIO_free_all(bio);
    return 
# 667 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 667 "../crypto/pkcs7/pk7_doit.c"
              ;
}
...
static BIO *PKCS7_find_digest(EVP_MD_CTX **pmd, BIO *bio, int nid)
{
    for (;;) {
        ...
        if (bio == 
# 674 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 674 "../crypto/pkcs7/pk7_doit.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",675,__func__), ERR_set_error)((33),(108),
# 675 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 675 "../crypto/pkcs7/pk7_doit.c"
           );
            return 
# 676 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 676 "../crypto/pkcs7/pk7_doit.c"
                      ;
        }
        BIO_ctrl(bio,120,0,(pmd));
        if (*pmd == 
# 679 "../crypto/pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 679 "../crypto/pkcs7/pk7_doit.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",680,__func__), ERR_set_error)((33),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 680 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 680 "../crypto/pkcs7/pk7_doit.c"
           );
            return 
# 681 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 681 "../crypto/pkcs7/pk7_doit.c"
                      ;
        }
        if (EVP_MD_get_type(EVP_MD_CTX_get0_md(*pmd)) == nid)
            return bio;
        bio = BIO_next(bio);
    }
    return 
# 687 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 687 "../crypto/pkcs7/pk7_doit.c"
              ;
}
...
# 697 "../crypto/pkcs7/pk7_doit.c" 3 4
                                               ((void *)0)
# 697 "../crypto/pkcs7/pk7_doit.c"
                                                   )) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",698,__func__), ERR_set_error)((33),((33 | (0x2 << 18L))),
# 698 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 698 "../crypto/pkcs7/pk7_doit.c"
           );
            return 0;
        }
    }
    ...
    if (!EVP_DigestFinal_ex(mctx, md_data, &md_len)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",705,__func__), ERR_set_error)((33),((6 | (0x2 << 18L))),
# 705 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 705 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
    if (!PKCS7_add1_attrib_digest(si, md_data, md_len)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",709,__func__), ERR_set_error)((33),((33 | (0x2 << 18L))),
# 709 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 709 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
...
# 728 "../crypto/pkcs7/pk7_doit.c" 3 4
                                        ((void *)0)
# 728 "../crypto/pkcs7/pk7_doit.c"
                                            ;
    ASN1_OCTET_STRING *os = 
# 729 "../crypto/pkcs7/pk7_doit.c" 3 4
                           ((void *)0)
# 729 "../crypto/pkcs7/pk7_doit.c"
                               ;
    const PKCS7_CTX *p7_ctx;

    if (p7 == 
# 732 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 732 "../crypto/pkcs7/pk7_doit.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",733,__func__), ERR_set_error)((33),(143),
# 733 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 733 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
    ...
    if (p7->d.ptr == 
# 739 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 739 "../crypto/pkcs7/pk7_doit.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",740,__func__), ERR_set_error)((33),(122),
# 740 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 740 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
    ...
    if (ctx_tmp == 
# 745 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 745 "../crypto/pkcs7/pk7_doit.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",746,__func__), ERR_set_error)((33),((6 | (0x2 << 18L))),
# 746 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 746 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
    ...
    case 24:
        ...
        if (os == 
# 761 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 761 "../crypto/pkcs7/pk7_doit.c"
                     ) {
            os = ASN1_OCTET_STRING_new();
            if (os == 
# 763 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 763 "../crypto/pkcs7/pk7_doit.c"
                         ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",764,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 764 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 764 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
    ...
    case 23:
        ...
        if (os == 
# 773 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 773 "../crypto/pkcs7/pk7_doit.c"
                     ) {
            os = ASN1_OCTET_STRING_new();
            if (os == 
# 775 "../crypto/pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 775 "../crypto/pkcs7/pk7_doit.c"
                         ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",776,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 776 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 776 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
    ...
    case 22:
        ...
        if ((OBJ_obj2nid((p7->d.sign->contents)->type) == 21) && p7->detached) {
            ...
            os = 
# 788 "../crypto/pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 788 "../crypto/pkcs7/pk7_doit.c"
                    ;
            p7->d.sign->contents->d.data = 
# 789 "../crypto/pkcs7/pk7_doit.c" 3 4
                                          ((void *)0)
# 789 "../crypto/pkcs7/pk7_doit.c"
                                              ;
        }
        break;
    ...
    case 25:
        ...
        if ((OBJ_obj2nid((p7->d.digest->contents)->type) == 21) && p7->detached) {
            ASN1_OCTET_STRING_free(os);
            os = 
# 798 "../crypto/pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 798 "../crypto/pkcs7/pk7_doit.c"
                    ;
            p7->d.digest->contents->d.data = 
# 799 "../crypto/pkcs7/pk7_doit.c" 3 4
                                            ((void *)0)
# 799 "../crypto/pkcs7/pk7_doit.c"
                                                ;
        }
        break;

    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",804,__func__), ERR_set_error)((33),(112),
# 804 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 804 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }

    if (si_sk != 
# 808 "../crypto/pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 808 "../crypto/pkcs7/pk7_doit.c"
                    ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(si_sk)); i++) {
            si = ((PKCS7_SIGNER_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(si_sk), (i)));
            if (si->pkey == 
# 811 "../crypto/pkcs7/pk7_doit.c" 3 4
                           ((void *)0)
# 811 "../crypto/pkcs7/pk7_doit.c"
                               )
                continue;
            ...
            if (btmp == 
# 820 "../crypto/pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 820 "../crypto/pkcs7/pk7_doit.c"
                           )
                goto err;
            ...
            if (OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)) > 0) {
                if (!do_pkcs7_signed_attrib(si, ctx_tmp))
                    goto err;
            } else {
                unsigned char *abuf = 
# 839 "../crypto/pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 839 "../crypto/pkcs7/pk7_doit.c"
                                         ;
                unsigned int abuflen = EVP_PKEY_get_size(si->pkey);

                if (abuflen == 0 || (abuf = CRYPTO_malloc(abuflen, "../crypto/pkcs7/pk7_doit.c", 842)) == 
# 842 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                                       ((void *)0)
# 842 "../crypto/pkcs7/pk7_doit.c"
                                                                           )
                    goto err;
                ...
                if (!EVP_SignFinal_ex(ctx_tmp, abuf, &abuflen, si->pkey,
                    ...
                    CRYPTO_free(abuf, "../crypto/pkcs7/pk7_doit.c", 848);
                    (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",849,__func__), ERR_set_error)((33),((6 | (0x2 << 18L))),
# 849 "../crypto/pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 849 "../crypto/pkcs7/pk7_doit.c"
                   );
                    goto err;
                }
    ...
    if (!((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 867 "../crypto/pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 867 "../crypto/pkcs7/pk7_doit.c"
        ))) {
        ...
        if (os == 
# 872 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 872 "../crypto/pkcs7/pk7_doit.c"
                     )
            goto err;
        if (!(os->flags & 0x010)) {
            char *cont;
            ...
            if (btmp == 
# 878 "../crypto/pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 878 "../crypto/pkcs7/pk7_doit.c"
                           ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",879,__func__), ERR_set_error)((33),(107),
# 879 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 879 "../crypto/pkcs7/pk7_doit.c"
               );
                goto err;
            }
            ...
            BIO_ctrl(btmp,130,0,
# 888 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 888 "../crypto/pkcs7/pk7_doit.c"
           );
...
int PKCS7_SIGNER_INFO_sign(PKCS7_SIGNER_INFO *si)
{
    EVP_MD_CTX *mctx;
    EVP_PKEY_CTX *pctx = 
# 901 "../crypto/pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 901 "../crypto/pkcs7/pk7_doit.c"
                            ;
    unsigned char *abuf = 
# 902 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 902 "../crypto/pkcs7/pk7_doit.c"
                             ;
    int alen;
    size_t siglen;
    const EVP_MD *md = 
# 905 "../crypto/pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 905 "../crypto/pkcs7/pk7_doit.c"
                          ;
    const PKCS7_CTX *ctx = si->ctx;

    md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(si->digest_alg->algorithm)));
    if (md == 
# 909 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 909 "../crypto/pkcs7/pk7_doit.c"
                 )
        return 0;

    mctx = EVP_MD_CTX_new();
    if (mctx == 
# 913 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 913 "../crypto/pkcs7/pk7_doit.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",914,__func__), ERR_set_error)((33),((6 | (0x2 << 18L))),
# 914 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 914 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
...
# 921 "../crypto/pkcs7/pk7_doit.c" 3 4
                             ((void *)0)
# 921 "../crypto/pkcs7/pk7_doit.c"
                                 ) <= 0)
        goto err;
    ...
    if (EVP_DigestSignUpdate(mctx, abuf, alen) <= 0)
        goto err;
    CRYPTO_free(abuf, "../crypto/pkcs7/pk7_doit.c", 930);
    abuf = 
# 931 "../crypto/pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 931 "../crypto/pkcs7/pk7_doit.c"
              ;
    if (EVP_DigestSignFinal(mctx, 
# 932 "../crypto/pkcs7/pk7_doit.c" 3 4
                                 ((void *)0)
# 932 "../crypto/pkcs7/pk7_doit.c"
                                     , &siglen) <= 0)
        goto err;
    abuf = CRYPTO_malloc(siglen, "../crypto/pkcs7/pk7_doit.c", 934);
    if (abuf == 
# 935 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 935 "../crypto/pkcs7/pk7_doit.c"
                   )
        goto err;
 ...
 err:
    CRYPTO_free(abuf, "../crypto/pkcs7/pk7_doit.c", 947);
    EVP_MD_CTX_free(mctx);
    return 0;
}
                     ...
                     PKCS7 *p7, PKCS7_SIGNER_INFO *si)
{
    ...
    if (p7 == 
# 962 "../crypto/pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 962 "../crypto/pkcs7/pk7_doit.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",963,__func__), ERR_set_error)((33),(143),
# 963 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 963 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }

    if (p7->d.ptr == 
# 967 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 967 "../crypto/pkcs7/pk7_doit.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",968,__func__), ERR_set_error)((33),(122),
# 968 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 968 "../crypto/pkcs7/pk7_doit.c"
       );
        return 0;
    }
    ...
    if ((OBJ_obj2nid((p7)->type) == 22)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",979,__func__), ERR_set_error)((33),(114),
# 979 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 979 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (signer == 
# 990 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 990 "../crypto/pkcs7/pk7_doit.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",991,__func__), ERR_set_error)((33),(106),
# 991 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 991 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (!X509_STORE_CTX_init(ctx, cert_store, signer, untrusted)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",997,__func__), ERR_set_error)((33),((11 | (0x2 << 18L))),
# 997 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 997 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    if (i <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1003,__func__), ERR_set_error)((33),((11 | (0x2 << 18L))),
# 1003 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 1003 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
                          ...
                          X509 *signer)
{
    ...
    const EVP_MD *md;
    EVP_MD *fetched_md = 
# 1018 "../crypto/pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 1018 "../crypto/pkcs7/pk7_doit.c"
                            ;
    int ret = 0, i;
    int md_type;
    struct stack_st_X509_ATTRIBUTE *sk;
    ...
    EVP_PKEY *pkey;
    unsigned char *abuf = 
# 1024 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 1024 "../crypto/pkcs7/pk7_doit.c"
                             ;
    ...
    if (mdc_tmp == 
# 1030 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 1030 "../crypto/pkcs7/pk7_doit.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1031,__func__), ERR_set_error)((33),((6 | (0x2 << 18L))),
# 1031 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 1031 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }

    if (!(OBJ_obj2nid((p7)->type) == 22) && !(OBJ_obj2nid((p7)->type) == 24)) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1036,__func__), ERR_set_error)((33),(114),
# 1036 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 1036 "../crypto/pkcs7/pk7_doit.c"
       );
        goto err;
    }
    ...
    for (;;) {
        if ((btmp == 
# 1044 "../crypto/pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 1044 "../crypto/pkcs7/pk7_doit.c"
                        ) ||
            ((btmp = BIO_find_type(btmp, ( 8|0x0200))) == 
# 1045 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                         ((void *)0)
# 1045 "../crypto/pkcs7/pk7_doit.c"
                                                             )) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1046,__func__), ERR_set_error)((33),(108),
# 1046 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1046 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        BIO_ctrl(btmp,120,0,(&mdc));
        if (mdc == 
# 1050 "../crypto/pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 1050 "../crypto/pkcs7/pk7_doit.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1051,__func__), ERR_set_error)((33),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 1051 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1051 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        if (EVP_MD_get_type(EVP_MD_CTX_get0_md(mdc)) == md_type)
            break;
    ...
    sk = si->auth_attr;
    if ((sk != 
# 1073 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1073 "../crypto/pkcs7/pk7_doit.c"
                  ) && (OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)) != 0)) {
        unsigned char md_dat[64];
        unsigned int md_len;
        int alen;
        ...
        if (!message_digest) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1083,__func__), ERR_set_error)((33),(108),
# 1083 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1083 "../crypto/pkcs7/pk7_doit.c"
           );
            goto err;
        }
        if ((message_digest->length != (int)md_len) ||
            (memcmp(message_digest->data, md_dat, md_len))) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1088,__func__), ERR_set_error)((33),(101),
# 1088 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1088 "../crypto/pkcs7/pk7_doit.c"
           );
            ret = -1;
            goto err;
        }
        ...
        if (fetched_md != 
# 1096 "../crypto/pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 1096 "../crypto/pkcs7/pk7_doit.c"
                             )
            md = fetched_md;
        else
            md = EVP_get_digestbyname(OBJ_nid2sn(md_type));

        if (md == 
# 1101 "../crypto/pkcs7/pk7_doit.c" 3 4
                 ((void *)0) 
# 1101 "../crypto/pkcs7/pk7_doit.c"
                      || !EVP_DigestInit_ex(mdc_tmp,md,
# 1101 "../crypto/pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 1101 "../crypto/pkcs7/pk7_doit.c"
                          )) {
        ...
        if (alen <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1110,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 1110 "../crypto/pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1110 "../crypto/pkcs7/pk7_doit.c"
           );
            ret = -1;
            goto err;
        }
    ...
    if (pkey == 
# 1120 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 1120 "../crypto/pkcs7/pk7_doit.c"
                   ) {
        ret = -1;
        goto err;
    }
    ...
    if (i <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_doit.c",1127,__func__), ERR_set_error)((33),(105),
# 1127 "../crypto/pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 1127 "../crypto/pkcs7/pk7_doit.c"
       );
        ret = -1;
        goto err;
    }
    ret = 1;
 err:
    CRYPTO_free(abuf, "../crypto/pkcs7/pk7_doit.c", 1133);
...
PKCS7_ISSUER_AND_SERIAL *PKCS7_get_issuer_and_serial(PKCS7 *p7, int idx)
{
    ...
    if (i != 24)
        return 
# 1147 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1147 "../crypto/pkcs7/pk7_doit.c"
                  ;
    if (p7->d.signed_and_enveloped == 
# 1148 "../crypto/pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 1148 "../crypto/pkcs7/pk7_doit.c"
                                         )
        return 
# 1149 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1149 "../crypto/pkcs7/pk7_doit.c"
                  ;
    rsk = p7->d.signed_and_enveloped->recipientinfo;
    if (rsk == 
# 1151 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1151 "../crypto/pkcs7/pk7_doit.c"
                  )
        return 
# 1152 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1152 "../crypto/pkcs7/pk7_doit.c"
                  ;
    if (OPENSSL_sk_num(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk)) <= idx)
        return 
# 1154 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1154 "../crypto/pkcs7/pk7_doit.c"
                  ;
    ri = ((PKCS7_RECIP_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rsk), (idx)));
...
static ASN1_TYPE *get_attribute(const struct stack_st_X509_ATTRIBUTE *sk, int nid)
{
    ...
    if (idx < 0)
        return 
# 1174 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1174 "../crypto/pkcs7/pk7_doit.c"
                  ;
...
# 1181 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                                ((void *)0)
# 1181 "../crypto/pkcs7/pk7_doit.c"
                                                                    )
        return 
# 1182 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1182 "../crypto/pkcs7/pk7_doit.c"
                  ;
                                ...
                                struct stack_st_X509_ATTRIBUTE *sk)
{
    ...
    OPENSSL_sk_pop_free(ossl_check_X509_ATTRIBUTE_sk_type(p7si->auth_attr),ossl_check_X509_ATTRIBUTE_freefunc_type(X509_ATTRIBUTE_free));
    p7si->auth_attr = ((struct stack_st_X509_ATTRIBUTE *)OPENSSL_sk_dup(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)));
    if (p7si->auth_attr == 
# 1193 "../crypto/pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 1193 "../crypto/pkcs7/pk7_doit.c"
                              )
        return 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)); i++) {
        if ((((X509_ATTRIBUTE *)OPENSSL_sk_set(ossl_check_X509_ATTRIBUTE_sk_type(p7si->auth_attr), (i), ossl_check_X509_ATTRIBUTE_type(X509_ATTRIBUTE_dup(((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(sk), (i)))))))

                                                               )
            == 
# 1199 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1199 "../crypto/pkcs7/pk7_doit.c"
                  )
            return 0;
    }
    return 1;
                         ...
                         struct stack_st_X509_ATTRIBUTE *sk)
{
    ...
    OPENSSL_sk_pop_free(ossl_check_X509_ATTRIBUTE_sk_type(p7si->unauth_attr),ossl_check_X509_ATTRIBUTE_freefunc_type(X509_ATTRIBUTE_free));
    p7si->unauth_attr = ((struct stack_st_X509_ATTRIBUTE *)OPENSSL_sk_dup(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)));
    if (p7si->unauth_attr == 
# 1212 "../crypto/pkcs7/pk7_doit.c" 3 4
                            ((void *)0)
# 1212 "../crypto/pkcs7/pk7_doit.c"
                                )
        return 0;
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(sk)); i++) {
        if ((((X509_ATTRIBUTE *)OPENSSL_sk_set(ossl_check_X509_ATTRIBUTE_sk_type(p7si->unauth_attr), (i), ossl_check_X509_ATTRIBUTE_type(X509_ATTRIBUTE_dup(((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(sk), (i)))))))

                                                               )
            == 
# 1218 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1218 "../crypto/pkcs7/pk7_doit.c"
                  )
            return 0;
    }
    return 1;
...
{
    X509_ATTRIBUTE *attr = 
# 1239 "../crypto/pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 1239 "../crypto/pkcs7/pk7_doit.c"
                              ;
    int i, n;

    if (*sk == 
# 1242 "../crypto/pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1242 "../crypto/pkcs7/pk7_doit.c"
                  ) {
        if ((*sk = ((struct stack_st_X509_ATTRIBUTE *)OPENSSL_sk_new_null())) == 
# 1243 "../crypto/pkcs7/pk7_doit.c" 3 4
                                                   ((void *)0)
# 1243 "../crypto/pkcs7/pk7_doit.c"
                                                       )
            return 0;
    }
    n = OPENSSL_sk_num(ossl_check_const_X509_ATTRIBUTE_sk_type(*sk));
    for (i = 0; i < n; i++) {
        attr = ((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(*sk), (i)));
        if (OBJ_obj2nid(X509_ATTRIBUTE_get0_object(attr)) == nid)
            goto end;
    }
    if (!OPENSSL_sk_push(ossl_check_X509_ATTRIBUTE_sk_type(*sk), ossl_check_X509_ATTRIBUTE_type(
# 1252 "../crypto/pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1252 "../crypto/pkcs7/pk7_doit.c"
        )))
        return 0;
    ...
    if (attr == 
# 1257 "../crypto/pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 1257 "../crypto/pkcs7/pk7_doit.c"
                   ) {
        if (i == n)
            ((X509_ATTRIBUTE *)OPENSSL_sk_pop(ossl_check_X509_ATTRIBUTE_sk_type(*sk)));
        return 0;
    }
    X509_ATTRIBUTE_free(((X509_ATTRIBUTE *)OPENSSL_sk_value(ossl_check_const_X509_ATTRIBUTE_sk_type(*sk), (i))));
    (void) ((X509_ATTRIBUTE *)OPENSSL_sk_set(ossl_check_X509_ATTRIBUTE_sk_type(*sk), (i), ossl_check_X509_ATTRIBUTE_type(attr)));
    return 1;
}
