...
# 14 "../crypto/pkcs7/pkcs7err.c" 2



static const ERR_STRING_DATA PKCS7_str_reasons[] = {
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "certificate verify error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "cipher has no object identifier"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "cipher not initialized"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "content and data present"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(152) & 0X7FFFFF)) ), "ctrl error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ), "decrypt error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "digest failure"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(149) & 0X7FFFFF)) ),
    "encryption ctrl failure"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ),
    "encryption not supported for this key type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "error adding recipient"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "error setting cipher"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ),
    "invalid null pointer"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(155) & 0X7FFFFF)) ),
    "invalid signed data type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ), "no content"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(151) & 0X7FFFFF)) ),
    "no default digest"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(154) & 0X7FFFFF)) ),
    "no matching digest type found"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "no recipient matches certificate"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "no signatures on data"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(142) & 0X7FFFFF)) ), "no signers"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "operation not supported on this type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "pkcs7 add signature error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(153) & 0X7FFFFF)) ),
    "pkcs7 add signer error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(145) & 0X7FFFFF)) ), "pkcs7 datasign"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "private key does not match certificate"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "signature failure"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "signer certificate not found"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(147) & 0X7FFFFF)) ),
    "signing ctrl failure"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(148) & 0X7FFFFF)) ),
    "signing not supported for this key type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "smime text error"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "unable to find certificate"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "unable to find mem bio"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "unable to find message digest"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "unknown digest type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "unknown operation"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "unsupported cipher type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "unsupported content type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "wrong content type"},
    {( (((unsigned long)(33) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "wrong pkcs7 type"},
    {0, 
# 86 "../crypto/pkcs7/pkcs7err.c" 3 4
       ((void *)0)
# 86 "../crypto/pkcs7/pkcs7err.c"
           }
};
...
int ossl_err_load_PKCS7_strings(void)
{
    ...
    if (ERR_reason_error_string(PKCS7_str_reasons[0].error) == 
# 94 "../crypto/pkcs7/pkcs7err.c" 3 4
                                                              ((void *)0)
# 94 "../crypto/pkcs7/pkcs7err.c"
                                                                  )
