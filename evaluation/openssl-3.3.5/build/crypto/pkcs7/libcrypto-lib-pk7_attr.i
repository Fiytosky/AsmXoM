# 0 "../crypto/pkcs7/pk7_attr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs7/pk7_attr.c"
# 10 "../crypto/pkcs7/pk7_attr.c"
...
# 25 "../crypto/pkcs7/pk7_attr.c" 3 4
                                    ((void *)0)
# 25 "../crypto/pkcs7/pk7_attr.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",26,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 26 "../crypto/pkcs7/pk7_attr.c" 3 4
       ((void *)0)
# 26 "../crypto/pkcs7/pk7_attr.c"
       );
        return 0;
    }
    seq->length = ASN1_item_i2d((ASN1_VALUE *)cap, &seq->data,
                                (X509_ALGORS_it()));
    if (!PKCS7_add_signed_attribute(si, 167,
                                    16, seq)) {
...
struct stack_st_X509_ALGOR *PKCS7_get_smimecap(PKCS7_SIGNER_INFO *si)
{
    ...
    if (cap == 
# 45 "../crypto/pkcs7/pk7_attr.c" 3 4
              ((void *)0) 
# 45 "../crypto/pkcs7/pk7_attr.c"
                   || (cap->type != 16))
        return 
# 46 "../crypto/pkcs7/pk7_attr.c" 3 4
              ((void *)0)
# 46 "../crypto/pkcs7/pk7_attr.c"
                  ;
    p = cap->value.sequence->data;
    return (struct stack_st_X509_ALGOR *)
        ASN1_item_d2i(
# 49 "../crypto/pkcs7/pk7_attr.c" 3 4
                     ((void *)0)
# 49 "../crypto/pkcs7/pk7_attr.c"
...
{
    ASN1_INTEGER *nbit = 
# 56 "../crypto/pkcs7/pk7_attr.c" 3 4
                        ((void *)0)
# 56 "../crypto/pkcs7/pk7_attr.c"
                            ;
    X509_ALGOR *alg;

    if ((alg = X509_ALGOR_new()) == 
# 59 "../crypto/pkcs7/pk7_attr.c" 3 4
                                   ((void *)0)
# 59 "../crypto/pkcs7/pk7_attr.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",60,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 60 "../crypto/pkcs7/pk7_attr.c" 3 4
       ((void *)0)
# 60 "../crypto/pkcs7/pk7_attr.c"
       );
        return 0;
    }
...
# 66 "../crypto/pkcs7/pk7_attr.c" 3 4
                                                 ((void *)0)
# 66 "../crypto/pkcs7/pk7_attr.c"
                                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",67,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 67 "../crypto/pkcs7/pk7_attr.c" 3 4
           ((void *)0)
# 67 "../crypto/pkcs7/pk7_attr.c"
           );
            goto err;
        }
        if ((nbit = ASN1_INTEGER_new()) == 
# 70 "../crypto/pkcs7/pk7_attr.c" 3 4
                                          ((void *)0)
# 70 "../crypto/pkcs7/pk7_attr.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",71,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 71 "../crypto/pkcs7/pk7_attr.c" 3 4
           ((void *)0)
# 71 "../crypto/pkcs7/pk7_attr.c"
           );
            goto err;
        }
        if (!ASN1_INTEGER_set(nbit, arg)) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",75,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 75 "../crypto/pkcs7/pk7_attr.c" 3 4
           ((void *)0)
# 75 "../crypto/pkcs7/pk7_attr.c"
           );
            goto err;
        }
        ...
        nbit = 
# 80 "../crypto/pkcs7/pk7_attr.c" 3 4
              ((void *)0)
# 80 "../crypto/pkcs7/pk7_attr.c"
                  ;
    }
    if (!OPENSSL_sk_push(ossl_check_X509_ALGOR_sk_type(sk), ossl_check_X509_ALGOR_type(alg))) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",83,__func__), ERR_set_error)((33),((15 | (0x2 << 18L))),
# 83 "../crypto/pkcs7/pk7_attr.c" 3 4
       ((void *)0)
# 83 "../crypto/pkcs7/pk7_attr.c"
       );
        goto err;
    }
    return 1;
...
{
    ASN1_TIME *tmp = 
# 105 "../crypto/pkcs7/pk7_attr.c" 3 4
                    ((void *)0)
# 105 "../crypto/pkcs7/pk7_attr.c"
                        ;

    if (t == 
# 107 "../crypto/pkcs7/pk7_attr.c" 3 4
            ((void *)0) 
# 107 "../crypto/pkcs7/pk7_attr.c"
                 && (tmp = t = X509_gmtime_adj(
# 107 "../crypto/pkcs7/pk7_attr.c" 3 4
                                               ((void *)0)
# 107 "../crypto/pkcs7/pk7_attr.c"
                                                   , 0)) == 
...
# 107 "../crypto/pkcs7/pk7_attr.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_attr.c",108,__func__), ERR_set_error)((33),((11 | (0x2 << 18L))),
# 108 "../crypto/pkcs7/pk7_attr.c" 3 4
       ((void *)0)
# 108 "../crypto/pkcs7/pk7_attr.c"
       );
        return 0;
    }
    if (!PKCS7_add_signed_attribute(si, 52,
                                    23, t)) {
        ASN1_TIME_free(tmp);
        return 0;
    }
                             ...
                             const unsigned char *md, int mdlen)
{
    ...
    if (os == 
# 124 "../crypto/pkcs7/pk7_attr.c" 3 4
             ((void *)0)
# 124 "../crypto/pkcs7/pk7_attr.c"
                 )
        return 0;
