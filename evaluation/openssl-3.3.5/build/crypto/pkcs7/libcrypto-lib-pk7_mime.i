# 0 "../crypto/pkcs7/pk7_mime.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs7/pk7_mime.c"
# 10 "../crypto/pkcs7/pk7_mime.c"
...
int SMIME_write_PKCS7(BIO *bio, PKCS7 *p7, BIO *data, int flags)
{
    ...
    if (ctype_nid == 22) {
        if (p7->d.sign == 
# 37 "../crypto/pkcs7/pk7_mime.c" 3 4
                         ((void *)0)
# 37 "../crypto/pkcs7/pk7_mime.c"
                             )
            return 0;
        mdalgs = p7->d.sign->md_algs;
    } else {
        mdalgs = 
# 41 "../crypto/pkcs7/pk7_mime.c" 3 4
                ((void *)0)
# 41 "../crypto/pkcs7/pk7_mime.c"
                    ;
    }
...
PKCS7 *SMIME_read_PKCS7_ex(BIO *bio, BIO **bcont, PKCS7 **p7)
{
    PKCS7 *ret;
    OSSL_LIB_CTX *libctx = 
# 55 "../crypto/pkcs7/pk7_mime.c" 3 4
                          ((void *)0)
# 55 "../crypto/pkcs7/pk7_mime.c"
                              ;
    const char *propq = 
# 56 "../crypto/pkcs7/pk7_mime.c" 3 4
                       ((void *)0)
# 56 "../crypto/pkcs7/pk7_mime.c"
                           ;

    if (p7 != 
# 58 "../crypto/pkcs7/pk7_mime.c" 3 4
             ((void *)0) 
# 58 "../crypto/pkcs7/pk7_mime.c"
                  && *p7 != 
# 58 "../crypto/pkcs7/pk7_mime.c" 3 4
                            ((void *)0)
# 58 "../crypto/pkcs7/pk7_mime.c"
    ...
    ret = (PKCS7 *)SMIME_read_ASN1_ex(bio, 0, bcont, (PKCS7_it()),
                                      (ASN1_VALUE **)p7, libctx, propq);
    if (ret != 
# 65 "../crypto/pkcs7/pk7_mime.c" 3 4
              ((void *)0)
# 65 "../crypto/pkcs7/pk7_mime.c"
                  )
...
PKCS7 *SMIME_read_PKCS7(BIO *bio, BIO **bcont)
{
    return SMIME_read_PKCS7_ex(bio, bcont, 
# 72 "../crypto/pkcs7/pk7_mime.c" 3 4
                                          ((void *)0)
# 72 "../crypto/pkcs7/pk7_mime.c"
                                              );
}
