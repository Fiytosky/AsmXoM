# 0 "../crypto/pkcs7/pk7_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/pkcs7/pk7_lib.c"
# 10 "../crypto/pkcs7/pk7_lib.c"
...
long PKCS7_ctrl(PKCS7 *p7, int cmd, long larg, char *parg)
{
    ...
    case 1:
        if (nid == 22) {
            if (p7->d.sign == 
# 31 "../crypto/pkcs7/pk7_lib.c" 3 4
                             ((void *)0)
# 31 "../crypto/pkcs7/pk7_lib.c"
                                 ) {
                (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",32,__func__), ERR_set_error)((33),(122),
# 32 "../crypto/pkcs7/pk7_lib.c" 3 4
               ((void *)0)
# 32 "../crypto/pkcs7/pk7_lib.c"
               );
                ret = 0;
                break;
            }
...
# 41 "../crypto/pkcs7/pk7_lib.c" 3 4
                                              ((void *)0)
# 41 "../crypto/pkcs7/pk7_lib.c"
                                                  ;
            }
        } else {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",44,__func__), ERR_set_error)((33),(104),
# 44 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 44 "../crypto/pkcs7/pk7_lib.c"
           )
                                                                   ;
            ret = 0;
        }
    ...
    case 2:
        if (nid == 22) {
            if (p7->d.sign == 
# 51 "../crypto/pkcs7/pk7_lib.c" 3 4
                             ((void *)0) 
# 51 "../crypto/pkcs7/pk7_lib.c"
...
# 51 "../crypto/pkcs7/pk7_lib.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",58,__func__), ERR_set_error)((33),(104),
# 58 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 58 "../crypto/pkcs7/pk7_lib.c"
           )
                                                                   ;
            ret = 0;
        }
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",65,__func__), ERR_set_error)((33),(110),
# 65 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 65 "../crypto/pkcs7/pk7_lib.c"
       );
        ret = 0;
    }
    return ret;
...
{
    PKCS7 *ret = 
# 73 "../crypto/pkcs7/pk7_lib.c" 3 4
                ((void *)0)
# 73 "../crypto/pkcs7/pk7_lib.c"
                    ;

    if ((ret = PKCS7_new()) == 
# 75 "../crypto/pkcs7/pk7_lib.c" 3 4
                              ((void *)0)
# 75 "../crypto/pkcs7/pk7_lib.c"
                                  )
        goto err;
...
int PKCS7_set_content(PKCS7 *p7, PKCS7 *p7_data)
{
    ...
    case 26:
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",107,__func__), ERR_set_error)((33),(112),
# 107 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 107 "../crypto/pkcs7/pk7_lib.c"
       );
        goto err;
    }
    return 1;
...
# 127 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                ((void *)0)
# 127 "../crypto/pkcs7/pk7_lib.c"
                                                    )
            goto err;
        if (!ASN1_INTEGER_set(p7->d.sign->version, 1)) {
            PKCS7_SIGNED_free(p7->d.sign);
            p7->d.sign = 
# 131 "../crypto/pkcs7/pk7_lib.c" 3 4
                        ((void *)0)
# 131 "../crypto/pkcs7/pk7_lib.c"
                            ;
            goto err;
        }
        break;
...
# 137 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                     ((void *)0)
# 137 "../crypto/pkcs7/pk7_lib.c"
                                                         )
            goto err;
        break;
    case 24:
        ...
        if ((p7->d.signed_and_enveloped = PKCS7_SIGN_ENVELOPE_new())
            == 
# 143 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 143 "../crypto/pkcs7/pk7_lib.c"
                  )
            goto err;
    ...
    case 23:
        ...
        if ((p7->d.enveloped = PKCS7_ENVELOPE_new())
            == 
# 153 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 153 "../crypto/pkcs7/pk7_lib.c"
                  )
            goto err;
        if (!ASN1_INTEGER_set(p7->d.enveloped->version, 0))
            goto err;
        p7->d.enveloped->enc_data->content_type = OBJ_nid2obj(21);
        break;
    case 26:
        p7->type = obj;
        if ((p7->d.encrypted = PKCS7_ENCRYPT_new())
            == 
# 162 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 162 "../crypto/pkcs7/pk7_lib.c"
                  )
            goto err;
        if (!ASN1_INTEGER_set(p7->d.encrypted->version, 0))
            goto err;
        p7->d.encrypted->enc_data->content_type = OBJ_nid2obj(21);
        break;
    ...
    case 25:
        ...
        if ((p7->d.digest = PKCS7_DIGEST_new())
            == 
# 172 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 172 "../crypto/pkcs7/pk7_lib.c"
                  )
            goto err;
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",178,__func__), ERR_set_error)((33),(112),
# 178 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 178 "../crypto/pkcs7/pk7_lib.c"
       );
        goto err;
    }
    return 1;
...
int PKCS7_add_signer(PKCS7 *p7, PKCS7_SIGNER_INFO *psi)
{
    ...
    case 24:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",212,__func__), ERR_set_error)((33),(113),
# 212 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 212 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_ALGOR_sk_type(md_sk)); i++) {
        alg = ((X509_ALGOR *)OPENSSL_sk_value(ossl_check_const_X509_ALGOR_sk_type(md_sk), (i)));
...
# 229 "../crypto/pkcs7/pk7_lib.c" 3 4
                                       ((void *)0)
            
# 230 "../crypto/pkcs7/pk7_lib.c"
           || (alg->parameter = ASN1_TYPE_new()) == 
# 230 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                    ((void *)0)
# 230 "../crypto/pkcs7/pk7_lib.c"
                                                        ) {
            X509_ALGOR_free(alg);
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",232,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 232 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 232 "../crypto/pkcs7/pk7_lib.c"
           );
            return 0;
        }
        ...
        if ((nid = OBJ_obj2nid(obj)) != 0)
            alg->algorithm = OBJ_nid2obj(nid);
        else
            alg->algorithm = OBJ_dup(obj);
        alg->parameter->type = 5;
        if (alg->algorithm == 
# 244 "../crypto/pkcs7/pk7_lib.c" 3 4
                             ((void *)0) 
# 244 "../crypto/pkcs7/pk7_lib.c"
                                  || !OPENSSL_sk_push(ossl_check_X509_ALGOR_sk_type(md_sk), ossl_check_X509_ALGOR_type(alg))) {
            X509_ALGOR_free(alg);
            return 0;
        }
    }
    ...
    if (!OPENSSL_sk_push(ossl_check_PKCS7_SIGNER_INFO_sk_type(signer_sk), ossl_check_PKCS7_SIGNER_INFO_type(psi)))
        return 0;
    return 1;
}
...
int PKCS7_add_certificate(PKCS7 *p7, X509 *x509)
{
    ...
    case 24:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",270,__func__), ERR_set_error)((33),(113),
# 270 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 270 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }

    return ossl_x509_add_cert_new(sk, x509, 0x1);
}
...
int PKCS7_add_crl(PKCS7 *p7, X509_CRL *crl)
{
    ...
    case 24:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",291,__func__), ERR_set_error)((33),(113),
# 291 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 291 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }

    if (*sk == 
# 295 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 295 "../crypto/pkcs7/pk7_lib.c"
                  )
        *sk = ((struct stack_st_X509_CRL *)OPENSSL_sk_new_null());
    if (*sk == 
# 297 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 297 "../crypto/pkcs7/pk7_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",298,__func__), ERR_set_error)((33),((15 | (0x2 << 18L))),
# 298 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 298 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }

    X509_CRL_up_ref(crl);
    if (!OPENSSL_sk_push(ossl_check_X509_CRL_sk_type(*sk), ossl_check_X509_CRL_type(crl))) {
        X509_CRL_free(crl);
        return 0;
    }
    return 1;
                                                ...
                                                int verify)
{
    if (!verify) {
        ...
        PKCS7_SIGNER_INFO_get0_algs(si, 
# 318 "../crypto/pkcs7/pk7_lib.c" 3 4
                                       ((void *)0)
# 318 "../crypto/pkcs7/pk7_lib.c"
                                           , &alg1, &alg2);
        if (alg1 == 
# 319 "../crypto/pkcs7/pk7_lib.c" 3 4
                   ((void *)0) 
# 319 "../crypto/pkcs7/pk7_lib.c"
                        || alg1->algorithm == 
# 319 "../crypto/pkcs7/pk7_lib.c" 3 4
                                              ((void *)0)
# 319 "../crypto/pkcs7/pk7_lib.c"
...
# 326 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                                     ((void *)0)
# 326 "../crypto/pkcs7/pk7_lib.c"
                                                                         );
    }
    return 1;
}
...
static int pkcs7_rsa_sign_verify_setup(PKCS7_SIGNER_INFO *si, int verify)
{
    if (!verify) {
        X509_ALGOR *alg = 
# 334 "../crypto/pkcs7/pk7_lib.c" 3 4
                         ((void *)0)
# 334 "../crypto/pkcs7/pk7_lib.c"
                             ;

        PKCS7_SIGNER_INFO_get0_algs(si, 
# 336 "../crypto/pkcs7/pk7_lib.c" 3 4
                                       ((void *)0)
# 336 "../crypto/pkcs7/pk7_lib.c"
                                           , 
# 336 "../crypto/pkcs7/pk7_lib.c" 3 4
                                             ((void *)0)
# 336 "../crypto/pkcs7/pk7_lib.c"
                                                 , &alg);
        if (alg != 
# 337 "../crypto/pkcs7/pk7_lib.c" 3 4
                  ((void *)0)
# 337 "../crypto/pkcs7/pk7_lib.c"
                      )
            return X509_ALGOR_set0(alg, OBJ_nid2obj(6),
                                   5, 
# 339 "../crypto/pkcs7/pk7_lib.c" 3 4
                                               ((void *)0)
# 339 "../crypto/pkcs7/pk7_lib.c"
                                                   );
    }
    return 1;
}
                          ...
                          const EVP_MD *dgst)
{
    ...
    if (!X509_ALGOR_set0(p7i->digest_alg, OBJ_nid2obj(EVP_MD_get_type(dgst)),
                         5, 
# 372 "../crypto/pkcs7/pk7_lib.c" 3 4
                                     ((void *)0)
# 372 "../crypto/pkcs7/pk7_lib.c"
                                         ))
        return 0;
    ...
    if (pkey->ameth != 
# 380 "../crypto/pkcs7/pk7_lib.c" 3 4
                      ((void *)0) 
# 380 "../crypto/pkcs7/pk7_lib.c"
                           && pkey->ameth->pkey_ctrl != 
# 380 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                        ((void *)0)
# 380 "../crypto/pkcs7/pk7_lib.c"
                                                            ) {
        ret = pkey->ameth->pkey_ctrl(pkey, 0x1, 0, p7i);
        if (ret > 0)
            return 1;
        if (ret != -2) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",385,__func__), ERR_set_error)((33),(147),
# 385 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 385 "../crypto/pkcs7/pk7_lib.c"
           );
            return 0;
        }
    }
    (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",389,__func__), ERR_set_error)((33),(148),
# 389 "../crypto/pkcs7/pk7_lib.c" 3 4
   ((void *)0)
# 389 "../crypto/pkcs7/pk7_lib.c"
   );
    return 0;
}
...
# 396 "../crypto/pkcs7/pk7_lib.c" 3 4
                           ((void *)0)
# 396 "../crypto/pkcs7/pk7_lib.c"
                               ;

    if (dgst == 
# 398 "../crypto/pkcs7/pk7_lib.c" 3 4
               ((void *)0)
# 398 "../crypto/pkcs7/pk7_lib.c"
                   ) {
        int def_nid;
        ...
        if (dgst == 
# 403 "../crypto/pkcs7/pk7_lib.c" 3 4
                   ((void *)0)
# 403 "../crypto/pkcs7/pk7_lib.c"
                       ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",404,__func__), ERR_set_error)((33),(151),
# 404 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 404 "../crypto/pkcs7/pk7_lib.c"
           );
            goto err;
        }
    }
...
# 409 "../crypto/pkcs7/pk7_lib.c" 3 4
                                         ((void *)0)
# 409 "../crypto/pkcs7/pk7_lib.c"
                                             )
        goto err;
 ...
 err:
    ...
    return 
# 418 "../crypto/pkcs7/pk7_lib.c" 3 4
          ((void *)0)
# 418 "../crypto/pkcs7/pk7_lib.c"
              ;
}

static struct stack_st_X509 *pkcs7_get_signer_certs(const PKCS7 *p7)
{
    if (p7->d.ptr == 
# 423 "../crypto/pkcs7/pk7_lib.c" 3 4
                    ((void *)0)
# 423 "../crypto/pkcs7/pk7_lib.c"
                        )
        return 
# 424 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 424 "../crypto/pkcs7/pk7_lib.c"
                  ;
    ...
    return 
# 429 "../crypto/pkcs7/pk7_lib.c" 3 4
          ((void *)0)
# 429 "../crypto/pkcs7/pk7_lib.c"
              ;
}

static struct stack_st_PKCS7_RECIP_INFO *pkcs7_get_recipient_info(const PKCS7 *p7)
{
    if (p7->d.ptr == 
# 434 "../crypto/pkcs7/pk7_lib.c" 3 4
                    ((void *)0)
# 434 "../crypto/pkcs7/pk7_lib.c"
                        )
        return 
# 435 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 435 "../crypto/pkcs7/pk7_lib.c"
                  ;
    if ((OBJ_obj2nid((p7)->type) == 24))
    ...
    return 
# 440 "../crypto/pkcs7/pk7_lib.c" 3 4
          ((void *)0)
# 440 "../crypto/pkcs7/pk7_lib.c"
              ;
}
...
void ossl_pkcs7_resolve_libctx(PKCS7 *p7)
{
    ...
    struct stack_st_PKCS7_RECIP_INFO *rinfos;
    struct stack_st_PKCS7_SIGNER_INFO *sinfos;
    struct stack_st_X509 *certs;

    if (ctx == 
# 457 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0) 
# 457 "../crypto/pkcs7/pk7_lib.c"
                   || p7->d.ptr == 
# 457 "../crypto/pkcs7/pk7_lib.c" 3 4
                                   ((void *)0)
# 457 "../crypto/pkcs7/pk7_lib.c"
    ...
    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_X509_sk_type(certs)); i++)
        ossl_x509_set0_libctx(((X509 *)OPENSSL_sk_value(ossl_check_const_X509_sk_type(certs), (i))), libctx, propq);

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rinfos)); i++) {
        PKCS7_RECIP_INFO *ri = ((PKCS7_RECIP_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_RECIP_INFO_sk_type(rinfos), (i)));

        ossl_x509_set0_libctx(ri->cert, libctx, propq);
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos)); i++) {
        PKCS7_SIGNER_INFO *si = ((PKCS7_SIGNER_INFO *)OPENSSL_sk_value(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sinfos), (i)));

        if (si != 
# 476 "../crypto/pkcs7/pk7_lib.c" 3 4
                 ((void *)0)
# 476 "../crypto/pkcs7/pk7_lib.c"
                     )
            si->ctx = ctx;
    }
}
...
{
    return p7 != 
# 483 "../crypto/pkcs7/pk7_lib.c" 3 4
                ((void *)0) 
# 483 "../crypto/pkcs7/pk7_lib.c"
                     ? &p7->ctx : 
# 483 "../crypto/pkcs7/pk7_lib.c" 3 4
                                  ((void *)0)
# 483 "../crypto/pkcs7/pk7_lib.c"
...
{
    if (p7->ctx.propq != 
# 493 "../crypto/pkcs7/pk7_lib.c" 3 4
                        ((void *)0)
# 493 "../crypto/pkcs7/pk7_lib.c"
                            ) {
        CRYPTO_free(p7->ctx.propq, "../crypto/pkcs7/pk7_lib.c", 494);
        p7->ctx.propq = 
# 495 "../crypto/pkcs7/pk7_lib.c" 3 4
                       ((void *)0)
# 495 "../crypto/pkcs7/pk7_lib.c"
                           ;
    }
    if (propq != 
# 497 "../crypto/pkcs7/pk7_lib.c" 3 4
                ((void *)0)
# 497 "../crypto/pkcs7/pk7_lib.c"
                    ) {
        p7->ctx.propq = CRYPTO_strdup(propq, "../crypto/pkcs7/pk7_lib.c", 498);
        if (p7->ctx.propq == 
# 499 "../crypto/pkcs7/pk7_lib.c" 3 4
                            ((void *)0)
# 499 "../crypto/pkcs7/pk7_lib.c"
                                )
            return 0;
    }
    return 1;
...
{
    return ctx != 
# 517 "../crypto/pkcs7/pk7_lib.c" 3 4
                 ((void *)0) 
# 517 "../crypto/pkcs7/pk7_lib.c"
                      ? ctx->libctx : 
# 517 "../crypto/pkcs7/pk7_lib.c" 3 4
                                      ((void *)0)
# 517 "../crypto/pkcs7/pk7_lib.c"
...
{
    return ctx != 
# 521 "../crypto/pkcs7/pk7_lib.c" 3 4
                 ((void *)0) 
# 521 "../crypto/pkcs7/pk7_lib.c"
                      ? ctx->propq : 
# 521 "../crypto/pkcs7/pk7_lib.c" 3 4
                                     ((void *)0)
# 521 "../crypto/pkcs7/pk7_lib.c"
...
# 527 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                              ((void *)0)
# 527 "../crypto/pkcs7/pk7_lib.c"
                                                                  ) {
            (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",528,__func__), ERR_set_error)((33),((13 | (0x2 << 18L))),
# 528 "../crypto/pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 528 "../crypto/pkcs7/pk7_lib.c"
           );
            return 0;
        }
        p7->d.digest->md->parameter->type = 5;
        p7->d.digest->md->algorithm = OBJ_nid2obj(EVP_MD_get_type(md));
        return 1;
    }

    (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",536,__func__), ERR_set_error)((33),(113),
# 536 "../crypto/pkcs7/pk7_lib.c" 3 4
   ((void *)0)
# 536 "../crypto/pkcs7/pk7_lib.c"
   );
    return 1;
}
...
{
    if (p7 == 
# 542 "../crypto/pkcs7/pk7_lib.c" 3 4
             ((void *)0) 
# 542 "../crypto/pkcs7/pk7_lib.c"
                  || p7->d.ptr == 
# 542 "../crypto/pkcs7/pk7_lib.c" 3 4
                                  ((void *)0)
# 542 "../crypto/pkcs7/pk7_lib.c"
        ...
        return 
# 543 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 543 "../crypto/pkcs7/pk7_lib.c"
                  ;
    if ((OBJ_obj2nid((p7)->type) == 22)) {
        ...
        return 
# 549 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 549 "../crypto/pkcs7/pk7_lib.c"
                  ;
}
...
# 573 "../crypto/pkcs7/pk7_lib.c" 3 4
                                        ((void *)0)
# 573 "../crypto/pkcs7/pk7_lib.c"
                                            )
        goto err;
 ...
 err:
    ...
    return 
# 583 "../crypto/pkcs7/pk7_lib.c" 3 4
          ((void *)0)
...
int PKCS7_add_recipient_info(PKCS7 *p7, PKCS7_RECIP_INFO *ri)
{
    ...
    case 23:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",600,__func__), ERR_set_error)((33),(113),
# 600 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 600 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }

    if (!OPENSSL_sk_push(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_type(ri)))
        return 0;
    return 1;
}
...
{
    X509_ALGOR *alg = 
# 611 "../crypto/pkcs7/pk7_lib.c" 3 4
                     ((void *)0)
# 611 "../crypto/pkcs7/pk7_lib.c"
                         ;

    if (!decrypt) {
        PKCS7_RECIP_INFO_get0_alg(ri, &alg);
        if (alg != 
# 615 "../crypto/pkcs7/pk7_lib.c" 3 4
                  ((void *)0)
# 615 "../crypto/pkcs7/pk7_lib.c"
                      )
            return X509_ALGOR_set0(alg, OBJ_nid2obj(6),
                                   5, 
# 617 "../crypto/pkcs7/pk7_lib.c" 3 4
                                               ((void *)0)
# 617 "../crypto/pkcs7/pk7_lib.c"
                                                   );
    }
    return 1;
}
...
int PKCS7_RECIP_INFO_set(PKCS7_RECIP_INFO *p7i, X509 *x509)
{
    int ret;
    EVP_PKEY *pkey = 
# 625 "../crypto/pkcs7/pk7_lib.c" 3 4
                    ((void *)0)
# 625 "../crypto/pkcs7/pk7_lib.c"
                        ;
    ...
    if (pkey == 
# 638 "../crypto/pkcs7/pk7_lib.c" 3 4
               ((void *)0)
# 638 "../crypto/pkcs7/pk7_lib.c"
                   )
        return 0;
    ...
    if (pkey->ameth == 
# 649 "../crypto/pkcs7/pk7_lib.c" 3 4
                      ((void *)0) 
# 649 "../crypto/pkcs7/pk7_lib.c"
                           || pkey->ameth->pkey_ctrl == 
# 649 "../crypto/pkcs7/pk7_lib.c" 3 4
                                                        ((void *)0)
# 649 "../crypto/pkcs7/pk7_lib.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",650,__func__), ERR_set_error)((33),(150),
# 650 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 650 "../crypto/pkcs7/pk7_lib.c"
       )
                                                                     ;
        goto err;
    }

    ret = pkey->ameth->pkey_ctrl(pkey, 0x2, 0, p7i);
    if (ret == -2) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",657,__func__), ERR_set_error)((33),(150),
# 657 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 657 "../crypto/pkcs7/pk7_lib.c"
       )
                                                                     ;
        goto err;
    }
    if (ret <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",662,__func__), ERR_set_error)((33),(149),
# 662 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 662 "../crypto/pkcs7/pk7_lib.c"
       );
        goto err;
    }
finished:
...
X509 *PKCS7_cert_from_signer_info(PKCS7 *p7, PKCS7_SIGNER_INFO *si)
{
    if ((OBJ_obj2nid((p7)->type) == 22))
        ...
        return 
# 683 "../crypto/pkcs7/pk7_lib.c" 3 4
              ((void *)0)
# 683 "../crypto/pkcs7/pk7_lib.c"
                  ;
}
...
int PKCS7_set_cipher(PKCS7 *p7, const EVP_CIPHER *cipher)
{
    ...
    case 23:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",700,__func__), ERR_set_error)((33),(113),
# 700 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 700 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }
    ...
    if (i == 0) {
        (ERR_new(), ERR_set_debug("../crypto/pkcs7/pk7_lib.c",707,__func__), ERR_set_error)((33),(144),
# 707 "../crypto/pkcs7/pk7_lib.c" 3 4
       ((void *)0)
# 707 "../crypto/pkcs7/pk7_lib.c"
       );
        return 0;
    }
...
{
    ASN1_OCTET_STRING *os = 
# 719 "../crypto/pkcs7/pk7_lib.c" 3 4
                           ((void *)0)
# 719 "../crypto/pkcs7/pk7_lib.c"
    ...
    case 24:
        ...
        if (os == 
# 728 "../crypto/pkcs7/pk7_lib.c" 3 4
                 ((void *)0)
# 728 "../crypto/pkcs7/pk7_lib.c"
                     ) {
    ...
    case 23:
        ...
        if (os == 
# 736 "../crypto/pkcs7/pk7_lib.c" 3 4
                 ((void *)0)
# 736 "../crypto/pkcs7/pk7_lib.c"
                     ) {
            os = ASN1_OCTET_STRING_new();
    ...
    default:
        os = 
# 747 "../crypto/pkcs7/pk7_lib.c" 3 4
            ((void *)0)
# 747 "../crypto/pkcs7/pk7_lib.c"
                ;
        break;
    }

    if (os == 
# 751 "../crypto/pkcs7/pk7_lib.c" 3 4
             ((void *)0)
# 751 "../crypto/pkcs7/pk7_lib.c"
                 )
        return 0;
