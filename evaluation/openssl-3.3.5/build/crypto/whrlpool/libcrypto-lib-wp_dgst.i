# 0 "../crypto/whrlpool/wp_dgst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/whrlpool/wp_dgst.c"
# 59 "../crypto/whrlpool/wp_dgst.c"
...
# 60 "../crypto/whrlpool/wp_dgst.c" 2
...
# 62 "../crypto/whrlpool/wp_dgst.c" 2
# 1 "../crypto/whrlpool/wp_local.h" 1
# 10 "../crypto/whrlpool/wp_local.h"
...
extern unsigned char *WHIRLPOOL(const void *inp, size_t bytes,
                                               unsigned char *md);
# 11 "../crypto/whrlpool/wp_local.h" 2

void whirlpool_block(WHIRLPOOL_CTX *, const void *, size_t);
# 63 "../crypto/whrlpool/wp_dgst.c" 2
...
# 64 "../crypto/whrlpool/wp_dgst.c" 2


# 65 "../crypto/whrlpool/wp_dgst.c"
...
unsigned char *WHIRLPOOL(const void *inp, size_t bytes, unsigned char *md)
{
    ...
    if (md == 
# 258 "../crypto/whrlpool/wp_dgst.c" 3 4
             ((void *)0)
# 258 "../crypto/whrlpool/wp_dgst.c"
                 )
        md = m;
    WHIRLPOOL_Init(&ctx);
