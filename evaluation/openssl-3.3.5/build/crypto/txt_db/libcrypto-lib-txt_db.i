# 0 "../crypto/txt_db/txt_db.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/txt_db/txt_db.c"
# 10 "../crypto/txt_db/txt_db.c"
...
{
    TXT_DB *ret = 
# 22 "../crypto/txt_db/txt_db.c" 3 4
                 ((void *)0)
# 22 "../crypto/txt_db/txt_db.c"
                     ;
    int esc = 0;
    int i, add, n;
    int size = 512;
    ...
    OPENSSL_STRING *pp;
    BUF_MEM *buf = 
# 29 "../crypto/txt_db/txt_db.c" 3 4
                  ((void *)0)
# 29 "../crypto/txt_db/txt_db.c"
                      ;

    if ((buf = BUF_MEM_new()) == 
# 31 "../crypto/txt_db/txt_db.c" 3 4
                                ((void *)0)
# 31 "../crypto/txt_db/txt_db.c"
                                    )
        goto err;
    if (!BUF_MEM_grow(buf, size))
        goto err;

    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/txt_db/txt_db.c", 36)) == 
# 36 "../crypto/txt_db/txt_db.c" 3 4
                                               ((void *)0)
# 36 "../crypto/txt_db/txt_db.c"
                                                   )
        goto err;
    ret->num_fields = num;
    ret->index = 
# 39 "../crypto/txt_db/txt_db.c" 3 4
                ((void *)0)
# 39 "../crypto/txt_db/txt_db.c"
                    ;
    ret->qual = 
# 40 "../crypto/txt_db/txt_db.c" 3 4
               ((void *)0)
# 40 "../crypto/txt_db/txt_db.c"
                   ;
    if ((ret->data = sk_OPENSSL_PSTRING_new_null()) == 
# 41 "../crypto/txt_db/txt_db.c" 3 4
                                                      ((void *)0)
# 41 "../crypto/txt_db/txt_db.c"
                                                          )
        goto err;
    if ((ret->index = CRYPTO_malloc(sizeof(*ret->index) * num, "../crypto/txt_db/txt_db.c", 43)) == 
# 43 "../crypto/txt_db/txt_db.c" 3 4
                                                                   ((void *)0)
# 43 "../crypto/txt_db/txt_db.c"
                                                                       )
        goto err;
    if ((ret->qual = CRYPTO_malloc(sizeof(*(ret->qual)) * num, "../crypto/txt_db/txt_db.c", 45)) == 
# 45 "../crypto/txt_db/txt_db.c" 3 4
                                                                   ((void *)0)
# 45 "../crypto/txt_db/txt_db.c"
                                                                       )
        goto err;
    for (i = 0; i < num; i++) {
        ret->index[i] = 
# 48 "../crypto/txt_db/txt_db.c" 3 4
                       ((void *)0)
# 48 "../crypto/txt_db/txt_db.c"
                           ;
        ret->qual[i] = 
# 49 "../crypto/txt_db/txt_db.c" 3 4
                      ((void *)0)
# 49 "../crypto/txt_db/txt_db.c"
                          ;
    }
    ...
    for (;;) {
        ...
        if (buf->data[offset - 1] != '\n')
            ...
            buf->data[offset - 1] = '\0';
            if ((p = CRYPTO_malloc(add + offset, "../crypto/txt_db/txt_db.c", 73)) == 
# 73 "../crypto/txt_db/txt_db.c" 3 4
                                                     ((void *)0)
# 73 "../crypto/txt_db/txt_db.c"
                                                         )
                goto err;
            offset = 0;
        }
        ...
        *(p++) = '\0';
        if ((n != num) || (*f != '\0')) {
            CRYPTO_free(pp, "../crypto/txt_db/txt_db.c", 104);
            ret->error = 6;
            goto err;
        }
        pp[n] = p;
        if (!sk_OPENSSL_PSTRING_push(ret->data, pp)) {
            CRYPTO_free(pp, "../crypto/txt_db/txt_db.c", 110);
            goto err;
        }
    }
    BUF_MEM_free(buf);
 ...
 err:
    BUF_MEM_free(buf);
    if (ret != 
# 118 "../crypto/txt_db/txt_db.c" 3 4
              ((void *)0)
# 118 "../crypto/txt_db/txt_db.c"
                  ) {
        sk_OPENSSL_PSTRING_free(ret->data);
        CRYPTO_free(ret->index, "../crypto/txt_db/txt_db.c", 120);
        CRYPTO_free(ret->qual, "../crypto/txt_db/txt_db.c", 121);
        CRYPTO_free(ret, "../crypto/txt_db/txt_db.c", 122);
    }
    return 
# 124 "../crypto/txt_db/txt_db.c" 3 4
          ((void *)0)
# 124 "../crypto/txt_db/txt_db.c"
              ;
}
                                    ...
                                    OPENSSL_STRING *value)
{
    ...
    if (idx >= db->num_fields) {
        db->error = 3;
        return 
# 135 "../crypto/txt_db/txt_db.c" 3 4
              ((void *)0)
# 135 "../crypto/txt_db/txt_db.c"
                  ;
    }
    lh = db->index[idx];
    if (lh == 
# 138 "../crypto/txt_db/txt_db.c" 3 4
             ((void *)0)
# 138 "../crypto/txt_db/txt_db.c"
                 ) {
        db->error = 4;
        return 
# 140 "../crypto/txt_db/txt_db.c" 3 4
              ((void *)0)
# 140 "../crypto/txt_db/txt_db.c"
                  ;
    }
    ret = ((OPENSSL_STRING *)OPENSSL_LH_retrieve(ossl_check_OPENSSL_STRING_lh_type(lh), ossl_check_const_OPENSSL_STRING_lh_plain_type(value)));
    db->error = 0;
    return ret;
}
                        ...
                        OPENSSL_LH_HASHFUNC hash, OPENSSL_LH_COMPFUNC cmp)
{
    ...
    if ((idx = (struct lhash_st_OPENSSL_STRING *)OPENSSL_LH_new(hash, cmp)) == 
# 159 "../crypto/txt_db/txt_db.c" 3 4
                                                                        ((void *)0)
# 159 "../crypto/txt_db/txt_db.c"
                                                                            ) {
        db->error = 1;
        return 0;
    }
    ...
    for (i = 0; i < n; i++) {
        ...
        if ((qual != 
# 166 "../crypto/txt_db/txt_db.c" 3 4
                    ((void *)0)
# 166 "../crypto/txt_db/txt_db.c"
                        ) && (qual(r) == 0))
            continue;
        if ((k = ((OPENSSL_STRING *)OPENSSL_LH_insert(ossl_check_OPENSSL_STRING_lh_type(idx), ossl_check_OPENSSL_STRING_lh_plain_type(r)))) != 
# 168 "../crypto/txt_db/txt_db.c" 3 4
                                                     ((void *)0)
# 168 "../crypto/txt_db/txt_db.c"
                                                         ) {
            db->error = 2;
            db->arg1 = sk_OPENSSL_PSTRING_find(db->data, k);
            db->arg2 = i;
            OPENSSL_LH_free(ossl_check_OPENSSL_STRING_lh_type(idx));
            return 0;
        }
        if (((OPENSSL_STRING *)OPENSSL_LH_retrieve(ossl_check_OPENSSL_STRING_lh_type(idx), ossl_check_const_OPENSSL_STRING_lh_plain_type(r))) == 
# 175 "../crypto/txt_db/txt_db.c" 3 4
                                                 ((void *)0)
# 175 "../crypto/txt_db/txt_db.c"
                                                     ) {
            db->error = 1;
            OPENSSL_LH_free(ossl_check_OPENSSL_STRING_lh_type(idx));
            return 0;
    ...
    OPENSSL_LH_free(ossl_check_OPENSSL_STRING_lh_type(db->index[field]));
    db->index[field] = idx;
    db->qual[field] = qual;
    return 1;
}
...
long TXT_DB_write(BIO *out, TXT_DB *db)
{
    ...
    char *p, **pp, *f;
    BUF_MEM *buf = 
# 191 "../crypto/txt_db/txt_db.c" 3 4
                  ((void *)0)
# 191 "../crypto/txt_db/txt_db.c"
                      ;
    long ret = -1;

    if ((buf = BUF_MEM_new()) == 
# 194 "../crypto/txt_db/txt_db.c" 3 4
                                ((void *)0)
# 194 "../crypto/txt_db/txt_db.c"
                                    )
        goto err;
    n = sk_OPENSSL_PSTRING_num(db->data);
    nn = db->num_fields;
    for (i = 0; i < n; i++) {
        ...
        for (j = 0; j < nn; j++) {
            if (pp[j] != 
# 203 "../crypto/txt_db/txt_db.c" 3 4
                        ((void *)0)
# 203 "../crypto/txt_db/txt_db.c"
                            )
                l += strlen(pp[j]);
        }
        ...
        for (j = 0; j < nn; j++) {
            f = pp[j];
            if (f != 
# 212 "../crypto/txt_db/txt_db.c" 3 4
                    ((void *)0)
# 212 "../crypto/txt_db/txt_db.c"
                        )
                for (;;) {
                    if (*f == '\0')
                        break;
...
int TXT_DB_insert(TXT_DB *db, OPENSSL_STRING *row)
{
    ...
    for (i = 0; i < db->num_fields; i++) {
        if (db->index[i] != 
# 240 "../crypto/txt_db/txt_db.c" 3 4
                           ((void *)0)
# 240 "../crypto/txt_db/txt_db.c"
                               ) {
            if ((db->qual[i] != 
# 241 "../crypto/txt_db/txt_db.c" 3 4
                               ((void *)0)
# 241 "../crypto/txt_db/txt_db.c"
                                   ) && (db->qual[i] (row) == 0))
                continue;
            r = ((OPENSSL_STRING *)OPENSSL_LH_retrieve(ossl_check_OPENSSL_STRING_lh_type(db->index[i]), ossl_check_const_OPENSSL_STRING_lh_plain_type(row)));
            if (r != 
# 244 "../crypto/txt_db/txt_db.c" 3 4
                    ((void *)0)
# 244 "../crypto/txt_db/txt_db.c"
                        ) {
                db->error = 2;
                db->arg1 = i;
                db->arg_row = r;
    ...
    for (i = 0; i < db->num_fields; i++) {
        if (db->index[i] != 
# 254 "../crypto/txt_db/txt_db.c" 3 4
                           ((void *)0)
# 254 "../crypto/txt_db/txt_db.c"
                               ) {
            if ((db->qual[i] != 
# 255 "../crypto/txt_db/txt_db.c" 3 4
                               ((void *)0)
# 255 "../crypto/txt_db/txt_db.c"
                                   ) && (db->qual[i] (row) == 0))
                continue;
            (void)((OPENSSL_STRING *)OPENSSL_LH_insert(ossl_check_OPENSSL_STRING_lh_type(db->index[i]), ossl_check_OPENSSL_STRING_lh_plain_type(row)));
            if (((OPENSSL_STRING *)OPENSSL_LH_retrieve(ossl_check_OPENSSL_STRING_lh_type(db->index[i]), ossl_check_const_OPENSSL_STRING_lh_plain_type(row))) == 
# 258 "../crypto/txt_db/txt_db.c" 3 4
                                                                ((void *)0)
# 258 "../crypto/txt_db/txt_db.c"
                                                                    )
                goto err1;
        }
    }
 ...
 err1:
    ...
    while (i-- > 0) {
        if (db->index[i] != 
# 269 "../crypto/txt_db/txt_db.c" 3 4
                           ((void *)0)
# 269 "../crypto/txt_db/txt_db.c"
                               ) {
            if ((db->qual[i] != 
# 270 "../crypto/txt_db/txt_db.c" 3 4
                               ((void *)0)
# 270 "../crypto/txt_db/txt_db.c"
                                   ) && (db->qual[i] (row) == 0))
                continue;
            (void)((OPENSSL_STRING *)OPENSSL_LH_delete(ossl_check_OPENSSL_STRING_lh_type(db->index[i]), ossl_check_const_OPENSSL_STRING_lh_plain_type(row)));
        }
    }
 err:
    return 0;
...
void TXT_DB_free(TXT_DB *db)
{
    ...
    if (db == 
# 284 "../crypto/txt_db/txt_db.c" 3 4
             ((void *)0)
# 284 "../crypto/txt_db/txt_db.c"
                 )
        return;
    if (db->index != 
# 286 "../crypto/txt_db/txt_db.c" 3 4
                    ((void *)0)
# 286 "../crypto/txt_db/txt_db.c"
                        ) {
        for (i = db->num_fields - 1; i >= 0; i--)
            OPENSSL_LH_free(ossl_check_OPENSSL_STRING_lh_type(db->index[i]));
        CRYPTO_free(db->index, "../crypto/txt_db/txt_db.c", 289);
    }
    CRYPTO_free(db->qual, "../crypto/txt_db/txt_db.c", 291);
    if (db->data != 
# 292 "../crypto/txt_db/txt_db.c" 3 4
                   ((void *)0)
# 292 "../crypto/txt_db/txt_db.c"
                       ) {
        for (i = sk_OPENSSL_PSTRING_num(db->data) - 1; i >= 0; i--) {
            ...
            max = p[db->num_fields];
            if (max == 
# 300 "../crypto/txt_db/txt_db.c" 3 4
                      ((void *)0)
# 300 "../crypto/txt_db/txt_db.c"
                          ) {
                for (n = 0; n < db->num_fields; n++)
                    CRYPTO_free(p[n], "../crypto/txt_db/txt_db.c", 302);
            } else {
                for (n = 0; n < db->num_fields; n++) {
                    if (((p[n] < (char *)p) || (p[n] > max)))
                        CRYPTO_free(p[n], "../crypto/txt_db/txt_db.c", 306);
                }
            }
            CRYPTO_free(sk_OPENSSL_PSTRING_value(db->data, i), "../crypto/txt_db/txt_db.c", 309);
        }
        sk_OPENSSL_PSTRING_free(db->data);
    }
    CRYPTO_free(db, "../crypto/txt_db/txt_db.c", 313);
}
