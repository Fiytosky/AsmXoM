# 0 "../crypto/encode_decode/encoder_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 18 "../include/openssl/encoder.h" 2
...
# 17 "../include/openssl/encodererr.h" 2
...
# 18 "../include/openssl/encodererr.h" 2
...
{
    OSSL_ENCODER *encoder = 
# 30 "../crypto/encode_decode/encoder_meth.c" 3 4
                           ((void *)0)
# 30 "../crypto/encode_decode/encoder_meth.c"
                               ;

    if ((encoder = CRYPTO_zalloc(sizeof(*encoder), "../crypto/encode_decode/encoder_meth.c", 32)) == 
# 32 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                       ((void *)0)
# 32 "../crypto/encode_decode/encoder_meth.c"
                                                           )
        return 
# 33 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 33 "../crypto/encode_decode/encoder_meth.c"
                  ;
    if (!CRYPTO_NEW_REF(&encoder->base.refcnt, 1)) {
        OSSL_ENCODER_free(encoder);
        return 
# 36 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 36 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }
...
void OSSL_ENCODER_free(OSSL_ENCODER *encoder)
{
    ...
    if (encoder == 
# 54 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 54 "../crypto/encode_decode/encoder_meth.c"
                      )
        return;
    ...
    if (ref > 0)
        return;
    CRYPTO_free(encoder->base.name, "../crypto/encode_decode/encoder_meth.c", 60);
    ossl_property_free(encoder->base.parsed_propdef);
    ossl_provider_free(encoder->base.prov);
    CRYPTO_FREE_REF(&encoder->base.refcnt);
    CRYPTO_free(encoder, "../crypto/encode_decode/encoder_meth.c", 64);
}
...
# 89 "../crypto/encode_decode/encoder_meth.c" 3 4
                              ((void *)0)
# 89 "../crypto/encode_decode/encoder_meth.c"
                                  )
...
{
    if (store != 
# 96 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
# 96 "../crypto/encode_decode/encoder_meth.c"
                    )
...
static int reserve_encoder_store(void *store, void *data)
{
    ...
    if (store == 
# 110 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
        
# 111 "../crypto/encode_decode/encoder_meth.c"
       && (store = get_encoder_store(methdata->libctx)) == 
# 111 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                           ((void *)0)
# 111 "../crypto/encode_decode/encoder_meth.c"
                                                               )
        return 0;
...
static int unreserve_encoder_store(void *store, void *data)
{
    ...
    if (store == 
# 121 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
        
# 122 "../crypto/encode_decode/encoder_meth.c"
       && (store = get_encoder_store(methdata->libctx)) == 
# 122 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                           ((void *)0)
# 122 "../crypto/encode_decode/encoder_meth.c"
                                                               )
        return 0;
                                    ...
                                    void *data)
{
    struct encoder_data_st *methdata = data;
    void *method = 
# 133 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 133 "../crypto/encode_decode/encoder_meth.c"
                      ;
    int id;
    ...
    if ((id = methdata->id) == 0 && methdata->names != 
# 141 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                      ((void *)0)
# 141 "../crypto/encode_decode/encoder_meth.c"
                                                          ) {
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(methdata->libctx);
        const char *names = methdata->names;
        const char *q = strchr(names, ':');
        size_t l = (q == 
# 145 "../crypto/encode_decode/encoder_meth.c" 3 4
                        ((void *)0) 
# 145 "../crypto/encode_decode/encoder_meth.c"
                             ? strlen(names) : (size_t)(q - names));

        if (namemap == 0)
            return 
# 148 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 148 "../crypto/encode_decode/encoder_meth.c"
                      ;
    ...
    if (id == 0)
        return 
# 153 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 153 "../crypto/encode_decode/encoder_meth.c"
                  ;

    if (store == 
# 155 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
        
# 156 "../crypto/encode_decode/encoder_meth.c"
       && (store = get_encoder_store(methdata->libctx)) == 
# 156 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                           ((void *)0)
# 156 "../crypto/encode_decode/encoder_meth.c"
                                                               )
        return 
# 157 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 157 "../crypto/encode_decode/encoder_meth.c"
                  ;

    if (!ossl_method_store_fetch(store, id, methdata->propquery, prov, &method))
        return 
# 160 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 160 "../crypto/encode_decode/encoder_meth.c"
                  ;
    return method;
}
                                ...
                                void *data)
{
    ...
    if (names != 
# 180 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
# 180 "../crypto/encode_decode/encoder_meth.c"
                    ) {
        const char *q = strchr(names, ':');

        l = (q == 
# 183 "../crypto/encode_decode/encoder_meth.c" 3 4
                 ((void *)0) 
# 183 "../crypto/encode_decode/encoder_meth.c"
                      ? strlen(names) : (size_t)(q - names));
    }

    if ((namemap = ossl_namemap_stored(methdata->libctx)) == 
# 186 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                            ((void *)0)
        
# 187 "../crypto/encode_decode/encoder_meth.c"
       || (id = ossl_namemap_name2num_n(namemap, names, l)) == 0)
        return 0;

    if (store == 
# 190 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0) 
# 190 "../crypto/encode_decode/encoder_meth.c"
                     && (store = get_encoder_store(methdata->libctx)) == 
# 190 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                                         ((void *)0)
# 190 "../crypto/encode_decode/encoder_meth.c"
...
{
    OSSL_ENCODER *encoder = 
# 202 "../crypto/encode_decode/encoder_meth.c" 3 4
                           ((void *)0)
# 202 "../crypto/encode_decode/encoder_meth.c"
                               ;
    const OSSL_DISPATCH *fns = algodef->implementation;
    OSSL_LIB_CTX *libctx = ossl_provider_libctx(prov);

    if ((encoder = ossl_encoder_new()) == 
# 206 "../crypto/encode_decode/encoder_meth.c" 3 4
                                         ((void *)0)
# 206 "../crypto/encode_decode/encoder_meth.c"
                                             )
        return 
# 207 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 207 "../crypto/encode_decode/encoder_meth.c"
                  ;
    encoder->base.id = id;
    if ((encoder->base.name = ossl_algorithm_get1_first_name(algodef)) == 
# 209 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                                         ((void *)0)
# 209 "../crypto/encode_decode/encoder_meth.c"
                                                                             ) {
        OSSL_ENCODER_free(encoder);
        return 
# 211 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 211 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }
    encoder->base.algodef = algodef;
    if ((encoder->base.parsed_propdef
         = ossl_parse_property(libctx, algodef->property_definition)) == 
# 215 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                                        ((void *)0)
# 215 "../crypto/encode_decode/encoder_meth.c"
                                                                            ) {
        OSSL_ENCODER_free(encoder);
        return 
# 217 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 217 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (encoder->newctx == 
# 223 "../crypto/encode_decode/encoder_meth.c" 3 4
                                  ((void *)0)
# 223 "../crypto/encode_decode/encoder_meth.c"
                                      )
                encoder->newctx =
        ...
        case 2:
            if (encoder->freectx == 
# 228 "../crypto/encode_decode/encoder_meth.c" 3 4
                                   ((void *)0)
# 228 "../crypto/encode_decode/encoder_meth.c"
                                       )
                encoder->freectx =
                    OSSL_FUNC_encoder_freectx(fns);
            break;
        case 3:
            if (encoder->get_params == 
# 233 "../crypto/encode_decode/encoder_meth.c" 3 4
                                      ((void *)0)
# 233 "../crypto/encode_decode/encoder_meth.c"
                                          )
                encoder->get_params =
                    OSSL_FUNC_encoder_get_params(fns);
            break;
        case 4:
            if (encoder->gettable_params == 
# 238 "../crypto/encode_decode/encoder_meth.c" 3 4
                                           ((void *)0)
# 238 "../crypto/encode_decode/encoder_meth.c"
                                               )
                encoder->gettable_params =
                    OSSL_FUNC_encoder_gettable_params(fns);
            break;
        case 5:
            if (encoder->set_ctx_params == 
# 243 "../crypto/encode_decode/encoder_meth.c" 3 4
                                          ((void *)0)
# 243 "../crypto/encode_decode/encoder_meth.c"
                                              )
                encoder->set_ctx_params =
                    OSSL_FUNC_encoder_set_ctx_params(fns);
            break;
        case 6:
            if (encoder->settable_ctx_params == 
# 248 "../crypto/encode_decode/encoder_meth.c" 3 4
                                               ((void *)0)
# 248 "../crypto/encode_decode/encoder_meth.c"
                                                   )
                encoder->settable_ctx_params =
                    OSSL_FUNC_encoder_settable_ctx_params(fns);
            break;
        case 10:
            if (encoder->does_selection == 
# 253 "../crypto/encode_decode/encoder_meth.c" 3 4
                                          ((void *)0)
# 253 "../crypto/encode_decode/encoder_meth.c"
                                              )
        ...
        case 11:
            if (encoder->encode == 
# 258 "../crypto/encode_decode/encoder_meth.c" 3 4
                                  ((void *)0)
# 258 "../crypto/encode_decode/encoder_meth.c"
                                      )
                encoder->encode = OSSL_FUNC_encoder_encode(fns);
            break;
        case 20:
            if (encoder->import_object == 
# 262 "../crypto/encode_decode/encoder_meth.c" 3 4
                                         ((void *)0)
# 262 "../crypto/encode_decode/encoder_meth.c"
                                             )
...
# 267 "../crypto/encode_decode/encoder_meth.c" 3 4
                                       ((void *)0)
# 267 "../crypto/encode_decode/encoder_meth.c"
                                           )
                encoder->free_object =
    ...
    if (!((encoder->newctx == 
# 278 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0) 
# 278 "../crypto/encode_decode/encoder_meth.c"
                                  && encoder->freectx == 
# 278 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                         ((void *)0)
# 278 "../crypto/encode_decode/encoder_meth.c"
          ...
          || (encoder->newctx != 
# 279 "../crypto/encode_decode/encoder_meth.c" 3 4
                                ((void *)0) 
# 279 "../crypto/encode_decode/encoder_meth.c"
                                     && encoder->freectx != 
# 279 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                            ((void *)0)
# 279 "../crypto/encode_decode/encoder_meth.c"
          ...
          || (encoder->import_object != 
# 280 "../crypto/encode_decode/encoder_meth.c" 3 4
                                       ((void *)0) 
# 280 "../crypto/encode_decode/encoder_meth.c"
                                            && encoder->free_object != 
# 280 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                                       ((void *)0)
# 280 "../crypto/encode_decode/encoder_meth.c"
          ...
          || (encoder->import_object == 
# 281 "../crypto/encode_decode/encoder_meth.c" 3 4
                                       ((void *)0) 
# 281 "../crypto/encode_decode/encoder_meth.c"
                                            && encoder->free_object == 
# 281 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                                       ((void *)0)
# 281 "../crypto/encode_decode/encoder_meth.c"
        ...
        || encoder->encode == 
# 282 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 282 "../crypto/encode_decode/encoder_meth.c"
                                 ) {
        OSSL_ENCODER_free(encoder);
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",284,__func__), ERR_set_error)((59),((264|((0x1 << 18L)|(0x2 << 18L)))),
# 284 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 284 "../crypto/encode_decode/encoder_meth.c"
       );
        return 
# 285 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 285 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }

    if (prov != 
# 288 "../crypto/encode_decode/encoder_meth.c" 3 4
               ((void *)0) 
# 288 "../crypto/encode_decode/encoder_meth.c"
                    && !ossl_provider_up_ref(prov)) {
        OSSL_ENCODER_free(encoder);
        return 
# 290 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 290 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }
                               ...
                               OSSL_PROVIDER *prov, void *data)
{
    ...
    int id = ossl_namemap_add_names(namemap, 0, names, ':');
    void *method = 
# 317 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 317 "../crypto/encode_decode/encoder_meth.c"
                      ;
    ...
    if (method == 
# 327 "../crypto/encode_decode/encoder_meth.c" 3 4
                 ((void *)0)
# 327 "../crypto/encode_decode/encoder_meth.c"
                     )
...
# 356 "../crypto/encode_decode/encoder_meth.c" 3 4
                                           ((void *)0) 
# 356 "../crypto/encode_decode/encoder_meth.c"
                                                ? properties : "";
    void *method = 
# 357 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 357 "../crypto/encode_decode/encoder_meth.c"
                      ;
    int unsupported, id;

    if (store == 
# 360 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0) 
# 360 "../crypto/encode_decode/encoder_meth.c"
                     || namemap == 
# 360 "../crypto/encode_decode/encoder_meth.c" 3 4
                                   ((void *)0)
# 360 "../crypto/encode_decode/encoder_meth.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",361,__func__), ERR_set_error)((59),((262|(0x2 << 18L))),
# 361 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 361 "../crypto/encode_decode/encoder_meth.c"
       );
        return 
# 362 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 362 "../crypto/encode_decode/encoder_meth.c"
                  ;
    }

    id = name != 
# 365 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0) 
# 365 "../crypto/encode_decode/encoder_meth.c"
                     ? ossl_namemap_name2num(namemap, name) : 0;
...
# 374 "../crypto/encode_decode/encoder_meth.c" 3 4
                                              ((void *)0)
# 374 "../crypto/encode_decode/encoder_meth.c"
                                                  , id, propq, &method)) {
        ...
        OSSL_PROVIDER *prov = 
# 384 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 384 "../crypto/encode_decode/encoder_meth.c"
                                 ;
        ...
        if ((method = ossl_method_construct(methdata->libctx, 20,
                                            &prov, 0 ,
                                            &mcm, methdata)) != 
# 392 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                               ((void *)0)
# 392 "../crypto/encode_decode/encoder_meth.c"
                                                                   ) {
    ...
    if ((id != 0 || name != 
# 412 "../crypto/encode_decode/encoder_meth.c" 3 4
                           ((void *)0)
# 412 "../crypto/encode_decode/encoder_meth.c"
                               ) && method == 
# 412 "../crypto/encode_decode/encoder_meth.c" 3 4
                                              ((void *)0)
# 412 "../crypto/encode_decode/encoder_meth.c"
        ...
        if (name == 
# 415 "../crypto/encode_decode/encoder_meth.c" 3 4
                   ((void *)0)
# 415 "../crypto/encode_decode/encoder_meth.c"
                       )
            name = ossl_namemap_num2name(namemap, id, 0);
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",417,__func__), ERR_set_error)(59, code,
                       "%s, Name (%s : %d), Properties (%s)",
                       ossl_lib_ctx_get_descriptor(methdata->libctx),
                       name == 
# 420 "../crypto/encode_decode/encoder_meth.c" 3 4
                              ((void *)0) 
# 420 "../crypto/encode_decode/encoder_meth.c"
                                   ? "<null>" : name, id,
                       properties == 
# 421 "../crypto/encode_decode/encoder_meth.c" 3 4
                                    ((void *)0) 
# 421 "../crypto/encode_decode/encoder_meth.c"
                                         ? "<null>" : properties);
    }
                                 ...
                                 const char *properties)
{
    ...
    methdata.tmp_store = 
# 434 "../crypto/encode_decode/encoder_meth.c" 3 4
                        ((void *)0)
# 434 "../crypto/encode_decode/encoder_meth.c"
                            ;
...
int ossl_encoder_store_cache_flush(OSSL_LIB_CTX *libctx)
{
    ...
    if (store != 
# 444 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
# 444 "../crypto/encode_decode/encoder_meth.c"
                    )
...
int ossl_encoder_store_remove_all_provided(const OSSL_PROVIDER *prov)
{
    ...
    if (store != 
# 454 "../crypto/encode_decode/encoder_meth.c" 3 4
                ((void *)0)
# 454 "../crypto/encode_decode/encoder_meth.c"
                    )
...
const OSSL_PROVIDER *OSSL_ENCODER_get0_provider(const OSSL_ENCODER *encoder)
{
    if (!__builtin_expect(!!((encoder != 
# 465 "../crypto/encode_decode/encoder_meth.c" 3 4
        ((void *)0)
# 465 "../crypto/encode_decode/encoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",466,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 466 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 466 "../crypto/encode_decode/encoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((encoder != 
# 475 "../crypto/encode_decode/encoder_meth.c" 3 4
        ((void *)0)
# 475 "../crypto/encode_decode/encoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",476,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 476 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 476 "../crypto/encode_decode/encoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((encoder != 
# 486 "../crypto/encode_decode/encoder_meth.c" 3 4
        ((void *)0)
# 486 "../crypto/encode_decode/encoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",487,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 487 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 487 "../crypto/encode_decode/encoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((encoder != 
# 496 "../crypto/encode_decode/encoder_meth.c" 3 4
        ((void *)0)
# 496 "../crypto/encode_decode/encoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",497,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 497 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 497 "../crypto/encode_decode/encoder_meth.c"
       );
        return 0;
    }
...
int OSSL_ENCODER_is_a(const OSSL_ENCODER *encoder, const char *name)
{
    if (encoder->base.prov != 
# 516 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 516 "../crypto/encode_decode/encoder_meth.c"
                                 ) {
                                  ...
                                  void *user_arg)
{
    ...
    methdata.libctx = libctx;
    methdata.tmp_store = 
# 546 "../crypto/encode_decode/encoder_meth.c" 3 4
                        ((void *)0)
# 546 "../crypto/encode_decode/encoder_meth.c"
                            ;
    (void)inner_ossl_encoder_fetch(&methdata, 
# 547 "../crypto/encode_decode/encoder_meth.c" 3 4
                                             ((void *)0)
# 547 "../crypto/encode_decode/encoder_meth.c"
                                                 , 
# 547 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                   ((void *)0) 
# 547 "../crypto/encode_decode/encoder_meth.c"
    ...
    if (methdata.tmp_store != 
# 551 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 551 "../crypto/encode_decode/encoder_meth.c"
                                 )
...
{
    if (encoder == 
# 561 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0)
# 561 "../crypto/encode_decode/encoder_meth.c"
                      )
        return 0;

    if (encoder->base.prov != 
# 564 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 564 "../crypto/encode_decode/encoder_meth.c"
                                 ) {
        OSSL_LIB_CTX *libctx = ossl_provider_libctx(encoder->base.prov);
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(libctx);
...
{
    if (encoder != 
# 577 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0) 
# 577 "../crypto/encode_decode/encoder_meth.c"
                       && encoder->gettable_params != 
# 577 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                      ((void *)0)
# 577 "../crypto/encode_decode/encoder_meth.c"
    ...
    return 
# 582 "../crypto/encode_decode/encoder_meth.c" 3 4
          ((void *)0)
# 582 "../crypto/encode_decode/encoder_meth.c"
              ;
}
...
{
    if (encoder != 
# 587 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0) 
# 587 "../crypto/encode_decode/encoder_meth.c"
                       && encoder->get_params != 
# 587 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                 ((void *)0)
# 587 "../crypto/encode_decode/encoder_meth.c"
...
{
    if (encoder != 
# 594 "../crypto/encode_decode/encoder_meth.c" 3 4
                  ((void *)0) 
# 594 "../crypto/encode_decode/encoder_meth.c"
                       && encoder->settable_ctx_params != 
# 594 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                          ((void *)0)
# 594 "../crypto/encode_decode/encoder_meth.c"
    ...
    return 
# 599 "../crypto/encode_decode/encoder_meth.c" 3 4
          ((void *)0)
# 599 "../crypto/encode_decode/encoder_meth.c"
              ;
}
...
OSSL_ENCODER_CTX *OSSL_ENCODER_CTX_new(void)
{
    ...
    ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/encode_decode/encoder_meth.c", 610);
    return ctx;
}
...
# 621 "../crypto/encode_decode/encoder_meth.c" 3 4
        ((void *)0)
# 621 "../crypto/encode_decode/encoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_meth.c",622,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 622 "../crypto/encode_decode/encoder_meth.c" 3 4
       ((void *)0)
# 622 "../crypto/encode_decode/encoder_meth.c"
       );
        return 0;
    }

    if (ctx->encoder_insts == 
# 626 "../crypto/encode_decode/encoder_meth.c" 3 4
                             ((void *)0)
# 626 "../crypto/encode_decode/encoder_meth.c"
                                 )
        return 1;
    ...
    for (i = 0; i < l; i++) {
        ...
        if (encoderctx == 
# 636 "../crypto/encode_decode/encoder_meth.c" 3 4
                         ((void *)0) 
# 636 "../crypto/encode_decode/encoder_meth.c"
                              || encoder->set_ctx_params == 
# 636 "../crypto/encode_decode/encoder_meth.c" 3 4
                                                            ((void *)0)
# 636 "../crypto/encode_decode/encoder_meth.c"
...
{
    if (ctx != 
# 646 "../crypto/encode_decode/encoder_meth.c" 3 4
              ((void *)0)
# 646 "../crypto/encode_decode/encoder_meth.c"
                  ) {
        sk_OSSL_ENCODER_INSTANCE_pop_free(ctx->encoder_insts,
                                          ossl_encoder_instance_free);
        CRYPTO_free(ctx->construct_data, "../crypto/encode_decode/encoder_meth.c", 649);
        ossl_pw_clear_passphrase_data(&ctx->pwdata);
        CRYPTO_free(ctx, "../crypto/encode_decode/encoder_meth.c", 651);
    }
}
