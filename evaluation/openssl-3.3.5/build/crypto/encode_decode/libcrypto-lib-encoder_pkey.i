# 0 "../crypto/encode_decode/encoder_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/encode_decode/encoder_pkey.c"
# 10 "../crypto/encode_decode/encoder_pkey.c"
...
# 11 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 12 "../crypto/encode_decode/encoder_pkey.c" 2
...
OSSL_ENCODER_CTX *OSSL_ENCODER_CTX_new_for_pkey(const EVP_PKEY *pkey,
                                                ...
                                                const char *propquery);
# 14 "../crypto/encode_decode/encoder_pkey.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 16 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 18 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 19 "../crypto/encode_decode/encoder_pkey.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 16 "../include/internal/property.h" 2
...
# 20 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 21 "../crypto/encode_decode/encoder_pkey.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 22 "../crypto/encode_decode/encoder_pkey.c" 2
...
# 15 "../crypto/encode_decode/encoder_local.h" 2
...
# 23 "../crypto/encode_decode/encoder_pkey.c" 2
...
{
    OSSL_PARAM params[] = { { 
# 30 "../crypto/encode_decode/encoder_pkey.c" 3 4
                           ((void *)0)
# 30 "../crypto/encode_decode/encoder_pkey.c"
                           , 0, 
# 30 "../crypto/encode_decode/encoder_pkey.c" 3 4
                           ((void *)0)
# 30 "../crypto/encode_decode/encoder_pkey.c"
...
# 30 "../crypto/encode_decode/encoder_pkey.c"
    ...
    params[0] =
        OSSL_PARAM_construct_utf8_string("cipher",
                                         (void *)cipher_name, 0);
    params[1] =
        OSSL_PARAM_construct_utf8_string("properties",
                                         (void *)propquery, 0);
...
static void collect_encoder(OSSL_ENCODER *encoder, void *arg)
{
    ...
    if ((data->keymgmt_prov == prov) == data->flag_find_same_provider) {
        ...
        int i, end_i = OPENSSL_sk_num(ossl_check_const_OPENSSL_CSTRING_sk_type(data->names));
        int match;
        ...
        for (i = 0; i < end_i; i++) {
            if (data->flag_find_same_provider)
                ...
                match = OSSL_ENCODER_is_a(encoder,
                                          ((const char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(data->names), (i))));
            if (!match
                || (encoder->does_selection != 
# 116 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                              ((void *)0)
                    
# 117 "../crypto/encode_decode/encoder_pkey.c"
                   && !encoder->does_selection(provctx, data->ctx->selection))
                || (data->keymgmt_prov != prov
                    && encoder->import_object == 
# 119 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                                ((void *)0)
# 119 "../crypto/encode_decode/encoder_pkey.c"
                                                    ))
                continue;
...
static void collect_name(const char *name, void *arg)
{
    ...
    if (OPENSSL_sk_push(ossl_check_OPENSSL_CSTRING_sk_type(data->names), ossl_check_OPENSSL_CSTRING_type(name)) <= 0)
        return;
...
static int encoder_import_cb(const OSSL_PARAM params[], void *arg)
{
    ...
    return (construct_data->constructed_obj != 
# 176 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                              ((void *)0)
# 176 "../crypto/encode_decode/encoder_pkey.c"
                                                  );
}
...
encoder_construct_pkey(OSSL_ENCODER_INSTANCE *encoder_inst, void *arg)
{
    ...
    if (data->obj == 
# 184 "../crypto/encode_decode/encoder_pkey.c" 3 4
                    ((void *)0)
# 184 "../crypto/encode_decode/encoder_pkey.c"
                        ) {
        OSSL_ENCODER *encoder =
        ...
        if (k_prov != e_prov) {
            ...
            if (!evp_keymgmt_export(pk->keymgmt, pk->keydata, selection,
                ...
                return 
# 200 "../crypto/encode_decode/encoder_pkey.c" 3 4
                      ((void *)0)
# 200 "../crypto/encode_decode/encoder_pkey.c"
                          ;
...
static void encoder_destruct_pkey(void *arg)
{
    ...
    if (data->encoder_inst != 
# 215 "../crypto/encode_decode/encoder_pkey.c" 3 4
                             ((void *)0)
# 215 "../crypto/encode_decode/encoder_pkey.c"
                                 ) {
        OSSL_ENCODER *encoder =
    ...
    data->constructed_obj = 
# 221 "../crypto/encode_decode/encoder_pkey.c" 3 4
                           ((void *)0)
# 221 "../crypto/encode_decode/encoder_pkey.c"
                               ;
    if (match)
        data->obj = 
# 223 "../crypto/encode_decode/encoder_pkey.c" 3 4
                   ((void *)0)
# 223 "../crypto/encode_decode/encoder_pkey.c"
                       ;
}
...
static int ossl_encoder_ctx_setup_for_pkey(OSSL_ENCODER_CTX *ctx,
                                           ...
                                           const char *propquery)
{
    struct construct_data_st *data = 
# 237 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                    ((void *)0)
# 237 "../crypto/encode_decode/encoder_pkey.c"
                                        ;
    const OSSL_PROVIDER *prov = 
# 238 "../crypto/encode_decode/encoder_pkey.c" 3 4
                               ((void *)0)
# 238 "../crypto/encode_decode/encoder_pkey.c"
                                   ;
    OSSL_LIB_CTX *libctx = 
# 239 "../crypto/encode_decode/encoder_pkey.c" 3 4
                          ((void *)0)
# 239 "../crypto/encode_decode/encoder_pkey.c"
                              ;
    int ok = 0, i, end;
    OSSL_NAMEMAP *namemap;

    if (!__builtin_expect(!!((ctx != 
# 243 "../crypto/encode_decode/encoder_pkey.c" 3 4
        ((void *)0)
# 243 "../crypto/encode_decode/encoder_pkey.c"
        ) != 0), 1) || !__builtin_expect(!!((pkey != 
# 243 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                     ((void *)0)
# 243 "../crypto/encode_decode/encoder_pkey.c"
                                     ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",244,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 244 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 244 "../crypto/encode_decode/encoder_pkey.c"
       );
        return 0;
    }

    if (((pkey)->keymgmt != 
# 248 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 248 "../crypto/encode_decode/encoder_pkey.c"
       )) {
    ...
    if (pkey->keymgmt != 
# 253 "../crypto/encode_decode/encoder_pkey.c" 3 4
                        ((void *)0)
# 253 "../crypto/encode_decode/encoder_pkey.c"
                            ) {
        struct collected_encoder_st encoder_data;
        struct collected_names_st keymgmt_data;

        if ((data = CRYPTO_zalloc(sizeof(*data), "../crypto/encode_decode/encoder_pkey.c", 257)) == 
# 257 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                                     ((void *)0)
# 257 "../crypto/encode_decode/encoder_pkey.c"
                                                         )
            goto err;
        ...
        keymgmt_data.names = ((struct stack_st_OPENSSL_CSTRING *)OPENSSL_sk_new_null());
        if (keymgmt_data.names == 
# 265 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                 ((void *)0)
# 265 "../crypto/encode_decode/encoder_pkey.c"
                                     ) {
            (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",266,__func__), ERR_set_error)((59),((15 | (0x2 << 18L))),
# 266 "../crypto/encode_decode/encoder_pkey.c" 3 4
           ((void *)0)
# 266 "../crypto/encode_decode/encoder_pkey.c"
           );
            goto err;
        }
        ...
        if (keymgmt_data.error_occurred) {
            OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(keymgmt_data.names));
            goto err;
        }
...
# 283 "../crypto/encode_decode/encoder_pkey.c" 3 4
                               ((void *)0)
# 283 "../crypto/encode_decode/encoder_pkey.c"
                                   ;
        ...
        end = OPENSSL_sk_num(ossl_check_const_OPENSSL_CSTRING_sk_type(encoder_data.names));
        if (end > 0) {
            encoder_data.id_names = CRYPTO_malloc(end * sizeof(int), "../crypto/encode_decode/encoder_pkey.c", 293);
            if (encoder_data.id_names == 
# 294 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                        ((void *)0)
# 294 "../crypto/encode_decode/encoder_pkey.c"
                                            ) {
                OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(keymgmt_data.names));
                goto err;
            }
            for (i = 0; i < end; ++i) {
                const char *name = ((const char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_CSTRING_sk_type(keymgmt_data.names), (i)));
        ...
        CRYPTO_free(encoder_data.id_names, "../crypto/encode_decode/encoder_pkey.c", 318);
        OPENSSL_sk_free(ossl_check_OPENSSL_CSTRING_sk_type(keymgmt_data.names));
        if (encoder_data.error_occurred) {
            (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",321,__func__), ERR_set_error)((59),((15 | (0x2 << 18L))),
# 321 "../crypto/encode_decode/encoder_pkey.c" 3 4
           ((void *)0)
# 321 "../crypto/encode_decode/encoder_pkey.c"
           );
            goto err;
        }
    }
    ...
    if (data != 
# 326 "../crypto/encode_decode/encoder_pkey.c" 3 4
               ((void *)0) 
# 326 "../crypto/encode_decode/encoder_pkey.c"
        ...
        data = 
# 335 "../crypto/encode_decode/encoder_pkey.c" 3 4
              ((void *)0)
# 335 "../crypto/encode_decode/encoder_pkey.c"
                  ;
    }
 ...
 err:
    if (data != 
# 340 "../crypto/encode_decode/encoder_pkey.c" 3 4
               ((void *)0)
# 340 "../crypto/encode_decode/encoder_pkey.c"
                   ) {
        OSSL_ENCODER_CTX_set_construct_data(ctx, 
# 341 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                                ((void *)0)
# 341 "../crypto/encode_decode/encoder_pkey.c"
                                                    );
        CRYPTO_free(data, "../crypto/encode_decode/encoder_pkey.c", 342);
    }
    return ok;
}
...
{
    OSSL_ENCODER_CTX *ctx = 
# 353 "../crypto/encode_decode/encoder_pkey.c" 3 4
                           ((void *)0)
# 353 "../crypto/encode_decode/encoder_pkey.c"
                               ;
    OSSL_LIB_CTX *libctx = 
# 354 "../crypto/encode_decode/encoder_pkey.c" 3 4
                          ((void *)0)
# 354 "../crypto/encode_decode/encoder_pkey.c"
                              ;

    if (pkey == 
# 356 "../crypto/encode_decode/encoder_pkey.c" 3 4
               ((void *)0)
# 356 "../crypto/encode_decode/encoder_pkey.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",357,__func__), ERR_set_error)((59),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 357 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 357 "../crypto/encode_decode/encoder_pkey.c"
       );
        return 
# 358 "../crypto/encode_decode/encoder_pkey.c" 3 4
              ((void *)0)
# 358 "../crypto/encode_decode/encoder_pkey.c"
                  ;
    }

    if (!((pkey)->pkey.ptr != 
# 361 "../crypto/encode_decode/encoder_pkey.c" 3 4
        ((void *)0) 
# 361 "../crypto/encode_decode/encoder_pkey.c"
        || (pkey)->keydata != 
# 361 "../crypto/encode_decode/encoder_pkey.c" 3 4
        ((void *)0)
# 361 "../crypto/encode_decode/encoder_pkey.c"
        )) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",362,__func__), ERR_set_error)(59, (262|(0x2 << 18L)),
                       "The passed EVP_PKEY must be assigned a key");
        return 
# 364 "../crypto/encode_decode/encoder_pkey.c" 3 4
              ((void *)0)
# 364 "../crypto/encode_decode/encoder_pkey.c"
                  ;
    }

    if ((ctx = OSSL_ENCODER_CTX_new()) == 
# 367 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                         ((void *)0)
# 367 "../crypto/encode_decode/encoder_pkey.c"
                                             ) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/encoder_pkey.c",368,__func__), ERR_set_error)((59),((59 | (0x2 << 18L))),
# 368 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 368 "../crypto/encode_decode/encoder_pkey.c"
       );
        return 
# 369 "../crypto/encode_decode/encoder_pkey.c" 3 4
              ((void *)0)
# 369 "../crypto/encode_decode/encoder_pkey.c"
                  ;
    }

    if (((pkey)->keymgmt != 
# 372 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 372 "../crypto/encode_decode/encoder_pkey.c"
       )) {
    ...
    do { BIO *trc_out = 
# 378 "../crypto/encode_decode/encoder_pkey.c" 3 4
   ((void *)0)
# 378 "../crypto/encode_decode/encoder_pkey.c"
   ; if (0) {
        BIO_printf(trc_out,
    ...
    if (OSSL_ENCODER_CTX_set_output_type(ctx, output_type)
        && (output_struct == 
# 387 "../crypto/encode_decode/encoder_pkey.c" 3 4
                            ((void *)0)
            
# 388 "../crypto/encode_decode/encoder_pkey.c"
        ...
        OSSL_PARAM params[2] = { { 
# 392 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                ((void *)0)
# 392 "../crypto/encode_decode/encoder_pkey.c"
                                , 0, 
# 392 "../crypto/encode_decode/encoder_pkey.c" 3 4
                                ((void *)0)
# 392 "../crypto/encode_decode/encoder_pkey.c"
...
# 392 "../crypto/encode_decode/encoder_pkey.c"
        ...
        params[0] = OSSL_PARAM_construct_int("save-parameters",
                                             &save_parameters);

        (void)OSSL_ENCODER_CTX_set_params(ctx, params);

        do { BIO *trc_out = 
# 400 "../crypto/encode_decode/encoder_pkey.c" 3 4
       ((void *)0)
# 400 "../crypto/encode_decode/encoder_pkey.c"
       ; if (0) {
    ...
    return 
# 408 "../crypto/encode_decode/encoder_pkey.c" 3 4
          ((void *)0)
# 408 "../crypto/encode_decode/encoder_pkey.c"
              ;
}
