# 0 "../crypto/encode_decode/decoder_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/encode_decode/decoder_err.c"
# 11 "../crypto/encode_decode/decoder_err.c"
...
# 12 "../crypto/encode_decode/decoder_err.c" 2
# 1 "../include/openssl/decodererr.h" 1
# 13 "../include/openssl/decodererr.h"
        
# 13 "../crypto/encode_decode/decoder_err.c" 2
# 1 "../include/crypto/decodererr.h" 1
# 13 "../include/crypto/decodererr.h"
        
# 22 "../include/crypto/decodererr.h"
int ossl_err_load_OSSL_DECODER_strings(void);
# 14 "../crypto/encode_decode/decoder_err.c" 2



static const ERR_STRING_DATA OSSL_DECODER_str_reasons[] = {
    {( (((unsigned long)(60) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "could not decode object"},
    {( (((unsigned long)(60) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "decoder not found"},
    {( (((unsigned long)(60) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "missing get params"},
    {0, 
# 24 "../crypto/encode_decode/decoder_err.c" 3 4
       ((void *)0)
# 24 "../crypto/encode_decode/decoder_err.c"
           }
};
...
int ossl_err_load_OSSL_DECODER_strings(void)
{
    ...
    if (ERR_reason_error_string(OSSL_DECODER_str_reasons[0].error) == 
# 32 "../crypto/encode_decode/decoder_err.c" 3 4
                                                                     ((void *)0)
# 32 "../crypto/encode_decode/decoder_err.c"
                                                                         )
