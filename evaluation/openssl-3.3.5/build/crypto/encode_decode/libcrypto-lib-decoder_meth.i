# 0 "../crypto/encode_decode/decoder_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 18 "../include/openssl/decoder.h" 2
...
# 17 "../include/openssl/decodererr.h" 2
...
# 18 "../include/openssl/decodererr.h" 2
...
{
    OSSL_DECODER *decoder = 
# 30 "../crypto/encode_decode/decoder_meth.c" 3 4
                           ((void *)0)
# 30 "../crypto/encode_decode/decoder_meth.c"
                               ;

    if ((decoder = CRYPTO_zalloc(sizeof(*decoder), "../crypto/encode_decode/decoder_meth.c", 32)) == 
# 32 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                       ((void *)0)
# 32 "../crypto/encode_decode/decoder_meth.c"
                                                           )
        return 
# 33 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 33 "../crypto/encode_decode/decoder_meth.c"
                  ;
    if (!CRYPTO_NEW_REF(&decoder->base.refcnt, 1)) {
        OSSL_DECODER_free(decoder);
        return 
# 36 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 36 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }
...
void OSSL_DECODER_free(OSSL_DECODER *decoder)
{
    ...
    if (decoder == 
# 54 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 54 "../crypto/encode_decode/decoder_meth.c"
                      )
        return;
    ...
    if (ref > 0)
        return;
    CRYPTO_free(decoder->base.name, "../crypto/encode_decode/decoder_meth.c", 60);
    ossl_property_free(decoder->base.parsed_propdef);
    ossl_provider_free(decoder->base.prov);
    CRYPTO_FREE_REF(&decoder->base.refcnt);
    CRYPTO_free(decoder, "../crypto/encode_decode/decoder_meth.c", 64);
}
...
# 89 "../crypto/encode_decode/decoder_meth.c" 3 4
                              ((void *)0)
# 89 "../crypto/encode_decode/decoder_meth.c"
                                  )
...
{
    if (store != 
# 96 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
# 96 "../crypto/encode_decode/decoder_meth.c"
                    )
...
static int reserve_decoder_store(void *store, void *data)
{
    ...
    if (store == 
# 110 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
        
# 111 "../crypto/encode_decode/decoder_meth.c"
       && (store = get_decoder_store(methdata->libctx)) == 
# 111 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                           ((void *)0)
# 111 "../crypto/encode_decode/decoder_meth.c"
                                                               )
        return 0;
...
static int unreserve_decoder_store(void *store, void *data)
{
    ...
    if (store == 
# 121 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
        
# 122 "../crypto/encode_decode/decoder_meth.c"
       && (store = get_decoder_store(methdata->libctx)) == 
# 122 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                           ((void *)0)
# 122 "../crypto/encode_decode/decoder_meth.c"
                                                               )
        return 0;
                                    ...
                                    void *data)
{
    struct decoder_data_st *methdata = data;
    void *method = 
# 133 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 133 "../crypto/encode_decode/decoder_meth.c"
                      ;
    int id;
...
# 141 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                      ((void *)0)
# 141 "../crypto/encode_decode/decoder_meth.c"
                                                          ) {
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(methdata->libctx);
        const char *names = methdata->names;
        const char *q = strchr(names, ':');
        size_t l = (q == 
# 145 "../crypto/encode_decode/decoder_meth.c" 3 4
                        ((void *)0) 
# 145 "../crypto/encode_decode/decoder_meth.c"
                             ? strlen(names) : (size_t)(q - names));

        if (namemap == 0)
            return 
# 148 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 148 "../crypto/encode_decode/decoder_meth.c"
                      ;
    ...
    if (id == 0)
        return 
# 153 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 153 "../crypto/encode_decode/decoder_meth.c"
                  ;

    if (store == 
# 155 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
        
# 156 "../crypto/encode_decode/decoder_meth.c"
       && (store = get_decoder_store(methdata->libctx)) == 
# 156 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                           ((void *)0)
# 156 "../crypto/encode_decode/decoder_meth.c"
                                                               )
        return 
# 157 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 157 "../crypto/encode_decode/decoder_meth.c"
                  ;

    if (!ossl_method_store_fetch(store, id, methdata->propquery, prov, &method))
        return 
# 160 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 160 "../crypto/encode_decode/decoder_meth.c"
                  ;
    return method;
}
                                ...
                                void *data)
{
    ...
    if (names != 
# 180 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
# 180 "../crypto/encode_decode/decoder_meth.c"
                    ) {
        const char *q = strchr(names, ':');

        l = (q == 
# 183 "../crypto/encode_decode/decoder_meth.c" 3 4
                 ((void *)0) 
# 183 "../crypto/encode_decode/decoder_meth.c"
                      ? strlen(names) : (size_t)(q - names));
    }

    if ((namemap = ossl_namemap_stored(methdata->libctx)) == 
# 186 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                            ((void *)0)
        
# 187 "../crypto/encode_decode/decoder_meth.c"
       || (id = ossl_namemap_name2num_n(namemap, names, l)) == 0)
        return 0;

    if (store == 
# 190 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0) 
# 190 "../crypto/encode_decode/decoder_meth.c"
                     && (store = get_decoder_store(methdata->libctx)) == 
# 190 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                                         ((void *)0)
# 190 "../crypto/encode_decode/decoder_meth.c"
...
{
    OSSL_DECODER *decoder = 
# 202 "../crypto/encode_decode/decoder_meth.c" 3 4
                           ((void *)0)
# 202 "../crypto/encode_decode/decoder_meth.c"
                               ;
    const OSSL_DISPATCH *fns = algodef->implementation;
    OSSL_LIB_CTX *libctx = ossl_provider_libctx(prov);

    if ((decoder = ossl_decoder_new()) == 
# 206 "../crypto/encode_decode/decoder_meth.c" 3 4
                                         ((void *)0)
# 206 "../crypto/encode_decode/decoder_meth.c"
                                             )
        return 
# 207 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 207 "../crypto/encode_decode/decoder_meth.c"
                  ;
    decoder->base.id = id;
    if ((decoder->base.name = ossl_algorithm_get1_first_name(algodef)) == 
# 209 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                                         ((void *)0)
# 209 "../crypto/encode_decode/decoder_meth.c"
                                                                             ) {
        OSSL_DECODER_free(decoder);
        return 
# 211 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 211 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }
    decoder->base.algodef = algodef;
    if ((decoder->base.parsed_propdef
         = ossl_parse_property(libctx, algodef->property_definition)) == 
# 215 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                                        ((void *)0)
# 215 "../crypto/encode_decode/decoder_meth.c"
                                                                            ) {
        OSSL_DECODER_free(decoder);
        return 
# 217 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 217 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 1:
            if (decoder->newctx == 
# 223 "../crypto/encode_decode/decoder_meth.c" 3 4
                                  ((void *)0)
# 223 "../crypto/encode_decode/decoder_meth.c"
                                      )
                decoder->newctx = OSSL_FUNC_decoder_newctx(fns);
            break;
        case 2:
            if (decoder->freectx == 
# 227 "../crypto/encode_decode/decoder_meth.c" 3 4
                                   ((void *)0)
# 227 "../crypto/encode_decode/decoder_meth.c"
                                       )
                decoder->freectx = OSSL_FUNC_decoder_freectx(fns);
            break;
        case 3:
            if (decoder->get_params == 
# 231 "../crypto/encode_decode/decoder_meth.c" 3 4
                                      ((void *)0)
# 231 "../crypto/encode_decode/decoder_meth.c"
                                          )
                decoder->get_params =
                    OSSL_FUNC_decoder_get_params(fns);
            break;
        case 4:
            if (decoder->gettable_params == 
# 236 "../crypto/encode_decode/decoder_meth.c" 3 4
                                           ((void *)0)
# 236 "../crypto/encode_decode/decoder_meth.c"
                                               )
                decoder->gettable_params =
                    OSSL_FUNC_decoder_gettable_params(fns);
            break;
        case 5:
            if (decoder->set_ctx_params == 
# 241 "../crypto/encode_decode/decoder_meth.c" 3 4
                                          ((void *)0)
# 241 "../crypto/encode_decode/decoder_meth.c"
                                              )
                decoder->set_ctx_params =
                    OSSL_FUNC_decoder_set_ctx_params(fns);
            break;
        case 6:
            if (decoder->settable_ctx_params == 
# 246 "../crypto/encode_decode/decoder_meth.c" 3 4
                                               ((void *)0)
# 246 "../crypto/encode_decode/decoder_meth.c"
                                                   )
...
# 251 "../crypto/encode_decode/decoder_meth.c" 3 4
                                          ((void *)0)
# 251 "../crypto/encode_decode/decoder_meth.c"
                                              )
        ...
        case 11:
            if (decoder->decode == 
# 256 "../crypto/encode_decode/decoder_meth.c" 3 4
                                  ((void *)0)
# 256 "../crypto/encode_decode/decoder_meth.c"
                                      )
                decoder->decode = OSSL_FUNC_decoder_decode(fns);
            break;
        case 20:
            if (decoder->export_object == 
# 260 "../crypto/encode_decode/decoder_meth.c" 3 4
                                         ((void *)0)
# 260 "../crypto/encode_decode/decoder_meth.c"
                                             )
    ...
    if (!((decoder->newctx == 
# 270 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0) 
# 270 "../crypto/encode_decode/decoder_meth.c"
                                  && decoder->freectx == 
# 270 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                         ((void *)0)
# 270 "../crypto/encode_decode/decoder_meth.c"
          ...
          || (decoder->newctx != 
# 271 "../crypto/encode_decode/decoder_meth.c" 3 4
                                ((void *)0) 
# 271 "../crypto/encode_decode/decoder_meth.c"
                                     && decoder->freectx != 
# 271 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                            ((void *)0)
# 271 "../crypto/encode_decode/decoder_meth.c"
        ...
        || decoder->decode == 
# 272 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 272 "../crypto/encode_decode/decoder_meth.c"
                                 ) {
        OSSL_DECODER_free(decoder);
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",274,__func__), ERR_set_error)((60),((264|((0x1 << 18L)|(0x2 << 18L)))),
# 274 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 274 "../crypto/encode_decode/decoder_meth.c"
       );
        return 
# 275 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 275 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }

    if (prov != 
# 278 "../crypto/encode_decode/decoder_meth.c" 3 4
               ((void *)0) 
# 278 "../crypto/encode_decode/decoder_meth.c"
                    && !ossl_provider_up_ref(prov)) {
        OSSL_DECODER_free(decoder);
        return 
# 280 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 280 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }
                               ...
                               OSSL_PROVIDER *prov, void *data)
{
    ...
    void *method = 
# 307 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 307 "../crypto/encode_decode/decoder_meth.c"
                      ;
    ...
    if (method == 
# 317 "../crypto/encode_decode/decoder_meth.c" 3 4
                 ((void *)0)
# 317 "../crypto/encode_decode/decoder_meth.c"
                     )
...
# 346 "../crypto/encode_decode/decoder_meth.c" 3 4
                                           ((void *)0) 
# 346 "../crypto/encode_decode/decoder_meth.c"
                                                ? properties : "";
    void *method = 
# 347 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 347 "../crypto/encode_decode/decoder_meth.c"
                      ;
    int unsupported, id;

    if (store == 
# 350 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0) 
# 350 "../crypto/encode_decode/decoder_meth.c"
                     || namemap == 
# 350 "../crypto/encode_decode/decoder_meth.c" 3 4
                                   ((void *)0)
# 350 "../crypto/encode_decode/decoder_meth.c"
                                       ) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",351,__func__), ERR_set_error)((60),((262|(0x2 << 18L))),
# 351 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 351 "../crypto/encode_decode/decoder_meth.c"
       );
        return 
# 352 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 352 "../crypto/encode_decode/decoder_meth.c"
                  ;
    }

    id = name != 
# 355 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0) 
# 355 "../crypto/encode_decode/decoder_meth.c"
...
# 364 "../crypto/encode_decode/decoder_meth.c" 3 4
                                              ((void *)0)
# 364 "../crypto/encode_decode/decoder_meth.c"
                                                  , id, propq, &method)) {
        ...
        OSSL_PROVIDER *prov = 
# 374 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 374 "../crypto/encode_decode/decoder_meth.c"
                                 ;
        ...
        if ((method = ossl_method_construct(methdata->libctx, 21,
                                            &prov, 0 ,
                                            &mcm, methdata)) != 
# 382 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                               ((void *)0)
# 382 "../crypto/encode_decode/decoder_meth.c"
                                                                   ) {
            ...
            if (id == 0 && name != 
# 389 "../crypto/encode_decode/decoder_meth.c" 3 4
                                  ((void *)0)
# 389 "../crypto/encode_decode/decoder_meth.c"
                                      )
    ...
    if ((id != 0 || name != 
# 403 "../crypto/encode_decode/decoder_meth.c" 3 4
                           ((void *)0)
# 403 "../crypto/encode_decode/decoder_meth.c"
                               ) && method == 
# 403 "../crypto/encode_decode/decoder_meth.c" 3 4
                                              ((void *)0)
# 403 "../crypto/encode_decode/decoder_meth.c"
        ...
        if (name == 
# 406 "../crypto/encode_decode/decoder_meth.c" 3 4
                   ((void *)0)
# 406 "../crypto/encode_decode/decoder_meth.c"
                       )
            name = ossl_namemap_num2name(namemap, id, 0);
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",408,__func__), ERR_set_error)(60, code,
                       "%s, Name (%s : %d), Properties (%s)",
                       ossl_lib_ctx_get_descriptor(methdata->libctx),
                       name == 
# 411 "../crypto/encode_decode/decoder_meth.c" 3 4
                              ((void *)0) 
# 411 "../crypto/encode_decode/decoder_meth.c"
                                   ? "<null>" : name, id,
                       properties == 
# 412 "../crypto/encode_decode/decoder_meth.c" 3 4
                                    ((void *)0) 
# 412 "../crypto/encode_decode/decoder_meth.c"
                                         ? "<null>" : properties);
    }
                                 ...
                                 const char *properties)
{
    ...
    methdata.tmp_store = 
# 425 "../crypto/encode_decode/decoder_meth.c" 3 4
                        ((void *)0)
# 425 "../crypto/encode_decode/decoder_meth.c"
                            ;
...
int ossl_decoder_store_cache_flush(OSSL_LIB_CTX *libctx)
{
    ...
    if (store != 
# 435 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
# 435 "../crypto/encode_decode/decoder_meth.c"
                    )
...
int ossl_decoder_store_remove_all_provided(const OSSL_PROVIDER *prov)
{
    ...
    if (store != 
# 445 "../crypto/encode_decode/decoder_meth.c" 3 4
                ((void *)0)
# 445 "../crypto/encode_decode/decoder_meth.c"
                    )
...
# 456 "../crypto/encode_decode/decoder_meth.c" 3 4
        ((void *)0)
# 456 "../crypto/encode_decode/decoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",457,__func__), ERR_set_error)((60),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 457 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 457 "../crypto/encode_decode/decoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((decoder != 
# 466 "../crypto/encode_decode/decoder_meth.c" 3 4
        ((void *)0)
# 466 "../crypto/encode_decode/decoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",467,__func__), ERR_set_error)((60),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 467 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 467 "../crypto/encode_decode/decoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((decoder != 
# 477 "../crypto/encode_decode/decoder_meth.c" 3 4
        ((void *)0)
# 477 "../crypto/encode_decode/decoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",478,__func__), ERR_set_error)((60),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 478 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 478 "../crypto/encode_decode/decoder_meth.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((decoder != 
# 487 "../crypto/encode_decode/decoder_meth.c" 3 4
        ((void *)0)
# 487 "../crypto/encode_decode/decoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",488,__func__), ERR_set_error)((60),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 488 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 488 "../crypto/encode_decode/decoder_meth.c"
       );
        return 0;
    }
...
{
    if (decoder->base.prov != 
# 507 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 507 "../crypto/encode_decode/decoder_meth.c"
                                 ) {
                                  ...
                                  void *user_arg)
{
    ...
    methdata.libctx = libctx;
    methdata.tmp_store = 
# 555 "../crypto/encode_decode/decoder_meth.c" 3 4
                        ((void *)0)
# 555 "../crypto/encode_decode/decoder_meth.c"
                            ;
    (void)inner_ossl_decoder_fetch(&methdata, 
# 556 "../crypto/encode_decode/decoder_meth.c" 3 4
                                             ((void *)0)
# 556 "../crypto/encode_decode/decoder_meth.c"
                                                 , 
# 556 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                   ((void *)0) 
# 556 "../crypto/encode_decode/decoder_meth.c"
    ...
    if (methdata.tmp_store != 
# 560 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 560 "../crypto/encode_decode/decoder_meth.c"
                                 )
...
{
    if (decoder == 
# 570 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0)
# 570 "../crypto/encode_decode/decoder_meth.c"
                      )
        return 0;

    if (decoder->base.prov != 
# 573 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 573 "../crypto/encode_decode/decoder_meth.c"
                                 ) {
        OSSL_LIB_CTX *libctx = ossl_provider_libctx(decoder->base.prov);
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(libctx);
...
{
    if (decoder != 
# 586 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0) 
# 586 "../crypto/encode_decode/decoder_meth.c"
                       && decoder->gettable_params != 
# 586 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                      ((void *)0)
# 586 "../crypto/encode_decode/decoder_meth.c"
    ...
    return 
# 591 "../crypto/encode_decode/decoder_meth.c" 3 4
          ((void *)0)
# 591 "../crypto/encode_decode/decoder_meth.c"
              ;
}
...
{
    if (decoder != 
# 596 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0) 
# 596 "../crypto/encode_decode/decoder_meth.c"
                       && decoder->get_params != 
# 596 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                 ((void *)0)
# 596 "../crypto/encode_decode/decoder_meth.c"
...
{
    if (decoder != 
# 604 "../crypto/encode_decode/decoder_meth.c" 3 4
                  ((void *)0) 
# 604 "../crypto/encode_decode/decoder_meth.c"
                       && decoder->settable_ctx_params != 
# 604 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                          ((void *)0)
# 604 "../crypto/encode_decode/decoder_meth.c"
    ...
    return 
# 609 "../crypto/encode_decode/decoder_meth.c" 3 4
          ((void *)0)
# 609 "../crypto/encode_decode/decoder_meth.c"
              ;
}
...
OSSL_DECODER_CTX *OSSL_DECODER_CTX_new(void)
{
    ...
    ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/encode_decode/decoder_meth.c", 626);
    return ctx;
}
...
# 637 "../crypto/encode_decode/decoder_meth.c" 3 4
        ((void *)0)
# 637 "../crypto/encode_decode/decoder_meth.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/encode_decode/decoder_meth.c",638,__func__), ERR_set_error)((60),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 638 "../crypto/encode_decode/decoder_meth.c" 3 4
       ((void *)0)
# 638 "../crypto/encode_decode/decoder_meth.c"
       );
        return 0;
    }

    if (ctx->decoder_insts == 
# 642 "../crypto/encode_decode/decoder_meth.c" 3 4
                             ((void *)0)
# 642 "../crypto/encode_decode/decoder_meth.c"
                                 )
        return 1;
    ...
    for (i = 0; i < l; i++) {
        ...
        if (decoderctx == 
# 654 "../crypto/encode_decode/decoder_meth.c" 3 4
                         ((void *)0) 
# 654 "../crypto/encode_decode/decoder_meth.c"
                              || decoder->set_ctx_params == 
# 654 "../crypto/encode_decode/decoder_meth.c" 3 4
                                                            ((void *)0)
# 654 "../crypto/encode_decode/decoder_meth.c"
...
{
    if (ctx != 
# 664 "../crypto/encode_decode/decoder_meth.c" 3 4
              ((void *)0)
# 664 "../crypto/encode_decode/decoder_meth.c"
                  ) {
        if (ctx->cleanup != 
# 665 "../crypto/encode_decode/decoder_meth.c" 3 4
                           ((void *)0)
# 665 "../crypto/encode_decode/decoder_meth.c"
                               )
            ctx->cleanup(ctx->construct_data);
        sk_OSSL_DECODER_INSTANCE_pop_free(ctx->decoder_insts,
                                          ossl_decoder_instance_free);
        ossl_pw_clear_passphrase_data(&ctx->pwdata);
        CRYPTO_free(ctx, "../crypto/encode_decode/decoder_meth.c", 670);
    }
}
