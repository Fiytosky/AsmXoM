# 0 "../crypto/encode_decode/encoder_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/encode_decode/encoder_err.c"
# 11 "../crypto/encode_decode/encoder_err.c"
...
# 12 "../crypto/encode_decode/encoder_err.c" 2
# 1 "../include/openssl/encodererr.h" 1
# 13 "../include/openssl/encodererr.h"
        
# 13 "../crypto/encode_decode/encoder_err.c" 2
# 1 "../include/crypto/encodererr.h" 1
# 13 "../include/crypto/encodererr.h"
        
# 22 "../include/crypto/encodererr.h"
int ossl_err_load_OSSL_ENCODER_strings(void);
# 14 "../crypto/encode_decode/encoder_err.c" 2



static const ERR_STRING_DATA OSSL_ENCODER_str_reasons[] = {
    {( (((unsigned long)(59) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "encoder not found"},
    {( (((unsigned long)(59) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ),
    "incorrect property query"},
    {( (((unsigned long)(59) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "missing get params"},
    {0, 
# 24 "../crypto/encode_decode/encoder_err.c" 3 4
       ((void *)0)
# 24 "../crypto/encode_decode/encoder_err.c"
           }
};
...
int ossl_err_load_OSSL_ENCODER_strings(void)
{
    ...
    if (ERR_reason_error_string(OSSL_ENCODER_str_reasons[0].error) == 
# 32 "../crypto/encode_decode/encoder_err.c" 3 4
                                                                     ((void *)0)
# 32 "../crypto/encode_decode/encoder_err.c"
                                                                         )
