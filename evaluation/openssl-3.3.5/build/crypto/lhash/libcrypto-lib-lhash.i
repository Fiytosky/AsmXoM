...
# 1 "../crypto/lhash/lhash_local.h" 1
# 11 "../crypto/lhash/lhash_local.h"
...
# 12 "../crypto/lhash/lhash_local.h" 2


# 13 "../crypto/lhash/lhash_local.h"
                                     ...
                                     OPENSSL_LH_DOALL_FUNCARG_THUNK daaw)
{
    ...
    if (lh == 
# 54 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 54 "../crypto/lhash/lhash.c"
                 )
        return 
# 55 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 55 "../crypto/lhash/lhash.c"
                  ;
    lh->compw = cw;
    lh->hashw = hw;
    lh->daw = daw;
...
OPENSSL_LHASH *OPENSSL_LH_new(OPENSSL_LH_HASHFUNC h, OPENSSL_LH_COMPFUNC c)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/lhash/lhash.c", 67)) == 
# 67 "../crypto/lhash/lhash.c" 3 4
                                               ((void *)0)
# 67 "../crypto/lhash/lhash.c"
                                                   )
        return 
# 68 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 68 "../crypto/lhash/lhash.c"
                  ;
    if ((ret->b = CRYPTO_zalloc(sizeof(*ret->b) * 16, "../crypto/lhash/lhash.c", 69)) == 
# 69 "../crypto/lhash/lhash.c" 3 4
                                                                 ((void *)0)
# 69 "../crypto/lhash/lhash.c"
                                                                     )
        goto err;
    ret->comp = ((c == 
# 71 "../crypto/lhash/lhash.c" 3 4
                      ((void *)0)
# 71 "../crypto/lhash/lhash.c"
                          ) ? (OPENSSL_LH_COMPFUNC)strcmp : c);
    ret->hash = ((h == 
# 72 "../crypto/lhash/lhash.c" 3 4
                      ((void *)0)
# 72 "../crypto/lhash/lhash.c"
...
err:
    CRYPTO_free(ret->b, "../crypto/lhash/lhash.c", 81);
    CRYPTO_free(ret, "../crypto/lhash/lhash.c", 82);
    return 
# 83 "../crypto/lhash/lhash.c" 3 4
          ((void *)0)
# 83 "../crypto/lhash/lhash.c"
              ;
}
...
{
    if (lh == 
# 88 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 88 "../crypto/lhash/lhash.c"
                 )
        return;

    OPENSSL_LH_flush(lh);
    CRYPTO_free(lh->b, "../crypto/lhash/lhash.c", 92);
    CRYPTO_free(lh, "../crypto/lhash/lhash.c", 93);
}
...
void OPENSSL_LH_flush(OPENSSL_LHASH *lh)
{
    ...
    if (lh == 
# 101 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 101 "../crypto/lhash/lhash.c"
                 )
        return;
    ...
    for (i = 0; i < lh->num_nodes; i++) {
        n = lh->b[i];
        while (n != 
# 106 "../crypto/lhash/lhash.c" 3 4
                   ((void *)0)
# 106 "../crypto/lhash/lhash.c"
                       ) {
            nn = n->next;
            CRYPTO_free(n, "../crypto/lhash/lhash.c", 108);
            n = nn;
        }
        lh->b[i] = 
# 111 "../crypto/lhash/lhash.c" 3 4
                  ((void *)0)
# 111 "../crypto/lhash/lhash.c"
                      ;
    }
...
void *OPENSSL_LH_insert(OPENSSL_LHASH *lh, void *data)
{
    ...
    if ((lh->up_load <= (lh->num_items * 256 / lh->num_nodes)) && !expand(lh))
        return 
# 125 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 125 "../crypto/lhash/lhash.c"
                  ;

    rn = getrn(lh, data, &hash);

    if (*rn == 
# 129 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 129 "../crypto/lhash/lhash.c"
                  ) {
        if ((nn = CRYPTO_malloc(sizeof(*nn), "../crypto/lhash/lhash.c", 130)) == 
# 130 "../crypto/lhash/lhash.c" 3 4
                                                 ((void *)0)
# 130 "../crypto/lhash/lhash.c"
                                                     ) {
            lh->error++;
            return 
# 132 "../crypto/lhash/lhash.c" 3 4
                  ((void *)0)
# 132 "../crypto/lhash/lhash.c"
                      ;
        }
        nn->data = data;
        nn->next = 
# 135 "../crypto/lhash/lhash.c" 3 4
                  ((void *)0)
# 135 "../crypto/lhash/lhash.c"
                      ;
        nn->hash = hash;
        *rn = nn;
        ret = 
# 138 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 138 "../crypto/lhash/lhash.c"
                 ;
        lh->num_items++;
    } else {
        ret = (*rn)->data;
...
void *OPENSSL_LH_delete(OPENSSL_LHASH *lh, const void *data)
{
    ...
    if (*rn == 
# 156 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 156 "../crypto/lhash/lhash.c"
                  ) {
        return 
# 157 "../crypto/lhash/lhash.c" 3 4
              ((void *)0)
# 157 "../crypto/lhash/lhash.c"
        ...
        *rn = nn->next;
        ret = nn->data;
        CRYPTO_free(nn, "../crypto/lhash/lhash.c", 162);
    }
...
void *OPENSSL_LH_retrieve(OPENSSL_LHASH *lh, const void *data)
{
    ...
    return *rn == 
# 183 "../crypto/lhash/lhash.c" 3 4
                 ((void *)0) 
# 183 "../crypto/lhash/lhash.c"
                      ? 
# 183 "../crypto/lhash/lhash.c" 3 4
                        ((void *)0) 
# 183 "../crypto/lhash/lhash.c"
                          ...
                          void *arg)
{
    ...
    if (lh == 
# 196 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 196 "../crypto/lhash/lhash.c"
                 )
        return;
    ...
    for (i = lh->num_nodes - 1; i >= 0; i--) {
        a = lh->b[i];
        while (a != 
# 205 "../crypto/lhash/lhash.c" 3 4
                   ((void *)0)
# 205 "../crypto/lhash/lhash.c"
                       ) {
            n = a->next;
            if (use_arg)
...
{
    if (lh == 
# 218 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 218 "../crypto/lhash/lhash.c"
                 )
        return;

    doall_util_fn(lh, 0, lh->daw, func, (OPENSSL_LH_DOALL_FUNCARG)
# 221 "../crypto/lhash/lhash.c" 3 4
                                                                 ((void *)0)
# 221 "../crypto/lhash/lhash.c"
                                                                     ,
                  (OPENSSL_LH_DOALL_FUNCARG_THUNK)
# 222 "../crypto/lhash/lhash.c" 3 4
                                                 ((void *)0)
# 222 "../crypto/lhash/lhash.c"
                                                     , 
# 222 "../crypto/lhash/lhash.c" 3 4
                                                       ((void *)0)
# 222 "../crypto/lhash/lhash.c"
...
{
    if (lh == 
# 228 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 228 "../crypto/lhash/lhash.c"
                 )
        return;

    doall_util_fn(lh, 1, (OPENSSL_LH_DOALL_FUNC_THUNK)
# 231 "../crypto/lhash/lhash.c" 3 4
                                                     ((void *)0)
# 231 "../crypto/lhash/lhash.c"
                                                         ,
                  (OPENSSL_LH_DOALL_FUNC)
# 232 "../crypto/lhash/lhash.c" 3 4
                                        ((void *)0)
# 232 "../crypto/lhash/lhash.c"
                                            , func, lh->daaw, arg);
}
...
{
    doall_util_fn(lh, 1, (OPENSSL_LH_DOALL_FUNC_THUNK)
# 239 "../crypto/lhash/lhash.c" 3 4
                                                     ((void *)0)
# 239 "../crypto/lhash/lhash.c"
                                                         ,
                  (OPENSSL_LH_DOALL_FUNC)
# 240 "../crypto/lhash/lhash.c" 3 4
                                        ((void *)0)
# 240 "../crypto/lhash/lhash.c"
                                            , fn, daaw, arg);
}
...
static int expand(OPENSSL_LHASH *lh)
{
    ...
    if (p + 1 >= pmax) {
        j = nni * 2;
        n = CRYPTO_realloc(lh->b, sizeof(OPENSSL_LH_NODE *) * j, "../crypto/lhash/lhash.c", 254);
        if (n == 
# 255 "../crypto/lhash/lhash.c" 3 4
                ((void *)0)
# 255 "../crypto/lhash/lhash.c"
                    ) {
            lh->error++;
            return 0;
        }
    ...
    n2 = &(lh->b[p + pmax]);
    *n2 = 
# 271 "../crypto/lhash/lhash.c" 3 4
         ((void *)0)
# 271 "../crypto/lhash/lhash.c"
             ;

    for (np = *n1; np != 
# 273 "../crypto/lhash/lhash.c" 3 4
                        ((void *)0)
# 273 "../crypto/lhash/lhash.c"
                            ;) {
        hash = np->hash;
        if ((hash % nni) != p) {
            *n1 = (*n1)->next;
...
static void contract(OPENSSL_LHASH *lh)
{
    ...
    lh->b[lh->p + lh->pmax - 1] = 
# 292 "../crypto/lhash/lhash.c" 3 4
                                 ((void *)0)
# 292 "../crypto/lhash/lhash.c"
                                     ;
    if (lh->p == 0) {
        n = CRYPTO_realloc(lh->b, (unsigned int)(sizeof(OPENSSL_LH_NODE *) * lh->pmax), "../crypto/lhash/lhash.c", 294)
                                                                                 ;
        if (n == 
# 296 "../crypto/lhash/lhash.c" 3 4
                ((void *)0)
# 296 "../crypto/lhash/lhash.c"
                    ) {
    ...
    n1 = lh->b[(int)lh->p];
    if (n1 == 
# 311 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 311 "../crypto/lhash/lhash.c"
                 )
        lh->b[(int)lh->p] = np;
    else {
        while (n1->next != 
# 314 "../crypto/lhash/lhash.c" 3 4
                          ((void *)0)
# 314 "../crypto/lhash/lhash.c"
                              )
            n1 = n1->next;
        n1->next = np;
    }
                               ...
                               const void *data, unsigned long *rhash)
{
    ...
    if (lh->hashw != 
# 326 "../crypto/lhash/lhash.c" 3 4
                    ((void *)0)
# 326 "../crypto/lhash/lhash.c"
                        )
    ...
    *rhash = hash;
    ...
    ret = &(lh->b[(int)nn]);
    for (n1 = *ret; n1 != 
# 338 "../crypto/lhash/lhash.c" 3 4
                         ((void *)0)
# 338 "../crypto/lhash/lhash.c"
                             ; n1 = n1->next) {
        if (n1->hash != hash) {
            ret = &(n1->next);
            continue;
        ...
        if (lh->compw != 
# 344 "../crypto/lhash/lhash.c" 3 4
                        ((void *)0)
# 344 "../crypto/lhash/lhash.c"
                            ) {
...
unsigned long OPENSSL_LH_strhash(const char *c)
{
    ...
    if ((c == 
# 368 "../crypto/lhash/lhash.c" 3 4
             ((void *)0)
# 368 "../crypto/lhash/lhash.c"
                 ) || (*c == '\0'))
        return ret;
...
unsigned long ossl_lh_strcasehash(const char *c)
{
    ...
    if (c == 
# 411 "../crypto/lhash/lhash.c" 3 4
            ((void *)0) 
# 411 "../crypto/lhash/lhash.c"
                 || *c == '\0')
        return ret;
