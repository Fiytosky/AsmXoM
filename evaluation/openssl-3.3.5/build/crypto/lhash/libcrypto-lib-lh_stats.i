# 0 "../crypto/lhash/lh_stats.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/lhash/lh_stats.c"
# 12 "../crypto/lhash/lh_stats.c"
...
void OPENSSL_LH_stats(const OPENSSL_LHASH *lh, FILE *fp)
{
    ...
    if (bp == 
# 32 "../crypto/lhash/lh_stats.c" 3 4
             ((void *)0)
# 32 "../crypto/lhash/lh_stats.c"
                 )
        return;
...
void OPENSSL_LH_node_stats(const OPENSSL_LHASH *lh, FILE *fp)
{
    ...
    bp = BIO_new(BIO_s_file());
    if (bp == 
# 44 "../crypto/lhash/lh_stats.c" 3 4
             ((void *)0)
# 44 "../crypto/lhash/lh_stats.c"
                 )
        return;
    BIO_ctrl(bp,106,0x00,(char *)(fp));
...
void OPENSSL_LH_node_usage_stats(const OPENSSL_LHASH *lh, FILE *fp)
{
    ...
    bp = BIO_new(BIO_s_file());
    if (bp == 
# 56 "../crypto/lhash/lh_stats.c" 3 4
             ((void *)0)
# 56 "../crypto/lhash/lh_stats.c"
                 )
        return;
    BIO_ctrl(bp,106,0x00,(char *)(fp));
...
# 97 "../crypto/lhash/lh_stats.c" 3 4
                                        ((void *)0)
# 97 "../crypto/lhash/lh_stats.c"
                                            ; n = n->next)
            num++;
...
void OPENSSL_LH_node_usage_stats_bio(const OPENSSL_LHASH *lh, BIO *out)
{
    ...
    for (i = 0; i < lh->num_nodes; i++) {
        for (n = lh->b[i], num = 0; n != 
# 111 "../crypto/lhash/lh_stats.c" 3 4
                                        ((void *)0)
# 111 "../crypto/lhash/lh_stats.c"
                                            ; n = n->next)
            num++;
        if (num != 0) {
            n_used++;
