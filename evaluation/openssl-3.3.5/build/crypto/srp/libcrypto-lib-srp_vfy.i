# 0 "../crypto/srp/srp_vfy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/srp/srp_vfy.c"
# 18 "../crypto/srp/srp_vfy.c"
...
# 26 "../crypto/srp/srp_vfy.c" 2
# 44 "../crypto/srp/srp_vfy.c"
static int t_fromb64(unsigned char *a, size_t alen, const char *src)
{
    ...
    if (size > 0x7fffffff 
# 58 "../crypto/srp/srp_vfy.c"
                      || ((size + padsize) / 4) * 3 > alen)
        return -1;

    ctx = EVP_ENCODE_CTX_new();
    if (ctx == 
# 62 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 62 "../crypto/srp/srp_vfy.c"
                  )
        return -1;
# 75 "../crypto/srp/srp_vfy.c"
    if (padsize == 3) {
        outl = -1;
        goto err;
    }
...
static int t_tob64(char *dst, const unsigned char *src, int size)
{
    ...
    if (ctx == 
# 140 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 140 "../crypto/srp/srp_vfy.c"
                  )
        return 0;

    EVP_EncodeInit(ctx);
    evp_encode_ctx_set_flags(ctx, 1
                                  | 2);
...
{
    if (user_pwd == 
# 181 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 181 "../crypto/srp/srp_vfy.c"
                       )
        return;
    BN_free(user_pwd->s);
    BN_clear_free(user_pwd->v);
    CRYPTO_free(user_pwd->id, "../crypto/srp/srp_vfy.c", 185);
    CRYPTO_free(user_pwd->info, "../crypto/srp/srp_vfy.c", 186);
    CRYPTO_free(user_pwd, "../crypto/srp/srp_vfy.c", 187);
}
...
SRP_user_pwd *SRP_user_pwd_new(void)
{
    ...
    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/srp/srp_vfy.c", 194)) == 
# 194 "../crypto/srp/srp_vfy.c" 3 4
                                               ((void *)0)
# 194 "../crypto/srp/srp_vfy.c"
                                                   )
        return 
# 195 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 195 "../crypto/srp/srp_vfy.c"
                  ;
    ret->N = 
# 196 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 196 "../crypto/srp/srp_vfy.c"
                ;
    ret->g = 
# 197 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 197 "../crypto/srp/srp_vfy.c"
                ;
    ret->s = 
# 198 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 198 "../crypto/srp/srp_vfy.c"
                ;
    ret->v = 
# 199 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 199 "../crypto/srp/srp_vfy.c"
                ;
    ret->id = 
# 200 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 200 "../crypto/srp/srp_vfy.c"
                 ;
    ret->info = 
# 201 "../crypto/srp/srp_vfy.c" 3 4
               ((void *)0)
# 201 "../crypto/srp/srp_vfy.c"
                   ;
    return ret;
}
...
int SRP_user_pwd_set1_ids(SRP_user_pwd *vinfo, const char *id,
                          const char *info)
{
    CRYPTO_free(vinfo->id, "../crypto/srp/srp_vfy.c", 215);
    CRYPTO_free(vinfo->info, "../crypto/srp/srp_vfy.c", 216);
    vinfo->id = 
# 217 "../crypto/srp/srp_vfy.c" 3 4
               ((void *)0)
# 217 "../crypto/srp/srp_vfy.c"
                   ;
    vinfo->info = 
# 218 "../crypto/srp/srp_vfy.c" 3 4
                 ((void *)0)
# 218 "../crypto/srp/srp_vfy.c"
                     ;
    if (id != 
# 219 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0) 
# 219 "../crypto/srp/srp_vfy.c"
                  && 
# 219 "../crypto/srp/srp_vfy.c" 3 4
                     ((void *)0) 
# 219 "../crypto/srp/srp_vfy.c"
                          == (vinfo->id = CRYPTO_strdup(id, "../crypto/srp/srp_vfy.c", 219)))
        return 0;
    return (info == 
# 221 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0) 
# 221 "../crypto/srp/srp_vfy.c"
                        || 
# 221 "../crypto/srp/srp_vfy.c" 3 4
                           ((void *)0) 
# 221 "../crypto/srp/srp_vfy.c"
                                != (vinfo->info = CRYPTO_strdup(info, "../crypto/srp/srp_vfy.c", 221)));
}

static int SRP_user_pwd_set_sv(SRP_user_pwd *vinfo, const char *s,
                               const char *v)
{
    unsigned char tmp[2500];
    int len;

    vinfo->v = 
# 230 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 230 "../crypto/srp/srp_vfy.c"
                  ;
    vinfo->s = 
# 231 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 231 "../crypto/srp/srp_vfy.c"
                  ;
    ...
    if (len < 0)
        return 0;
    if (
# 236 "../crypto/srp/srp_vfy.c" 3 4
       ((void *)0) 
# 236 "../crypto/srp/srp_vfy.c"
            == (vinfo->v = BN_bin2bn(tmp, len, 
# 236 "../crypto/srp/srp_vfy.c" 3 4
                                               ((void *)0)
# 236 "../crypto/srp/srp_vfy.c"
                                                   )))
    ...
    if (len < 0)
        goto err;
    vinfo->s = BN_bin2bn(tmp, len, 
# 241 "../crypto/srp/srp_vfy.c" 3 4
                                  ((void *)0)
# 241 "../crypto/srp/srp_vfy.c"
                                      );
    if (vinfo->s == 
# 242 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 242 "../crypto/srp/srp_vfy.c"
                       )
        goto err;
    return 1;
 err:
    BN_free(vinfo->v);
    vinfo->v = 
# 247 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 247 "../crypto/srp/srp_vfy.c"
                  ;
    return 0;
}
...
int SRP_user_pwd_set0_sv(SRP_user_pwd *vinfo, BIGNUM *s, BIGNUM *v)
{
    ...
    vinfo->s = s;
    return (vinfo->s != 
# 257 "../crypto/srp/srp_vfy.c" 3 4
                       ((void *)0) 
# 257 "../crypto/srp/srp_vfy.c"
                            && vinfo->v != 
# 257 "../crypto/srp/srp_vfy.c" 3 4
                                           ((void *)0)
# 257 "../crypto/srp/srp_vfy.c"
...
static SRP_user_pwd *srp_user_pwd_dup(SRP_user_pwd *src)
{
    ...
    if (src == 
# 264 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 264 "../crypto/srp/srp_vfy.c"
                  )
        return 
# 265 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 265 "../crypto/srp/srp_vfy.c"
                  ;
    if ((ret = SRP_user_pwd_new()) == 
# 266 "../crypto/srp/srp_vfy.c" 3 4
                                     ((void *)0)
# 266 "../crypto/srp/srp_vfy.c"
                                         )
        return 
# 267 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 267 "../crypto/srp/srp_vfy.c"
                  ;
    ...
    if (!SRP_user_pwd_set1_ids(ret, src->id, src->info)
        || !SRP_user_pwd_set0_sv(ret, BN_dup(src->s), BN_dup(src->v))) {
            ...
            return 
# 273 "../crypto/srp/srp_vfy.c" 3 4
                  ((void *)0)
# 273 "../crypto/srp/srp_vfy.c"
                      ;
    }
    return ret;
}
...
SRP_VBASE *SRP_VBASE_new(char *seed_key)
{
    SRP_VBASE *vb = CRYPTO_malloc(sizeof(*vb), "../crypto/srp/srp_vfy.c", 280);

    if (vb == 
# 282 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 282 "../crypto/srp/srp_vfy.c"
                 )
        return 
# 283 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 283 "../crypto/srp/srp_vfy.c"
                  ;
    if ((vb->users_pwd = ((struct stack_st_SRP_user_pwd *)OPENSSL_sk_new_null())) == 
# 284 "../crypto/srp/srp_vfy.c" 3 4
                                                       ((void *)0)
        
# 285 "../crypto/srp/srp_vfy.c"
       || (vb->gN_cache = ((struct stack_st_SRP_gN_cache *)OPENSSL_sk_new_null())) == 
# 285 "../crypto/srp/srp_vfy.c" 3 4
                                                         ((void *)0)
# 285 "../crypto/srp/srp_vfy.c"
                                                             ) {
        OPENSSL_sk_free(ossl_check_SRP_user_pwd_sk_type(vb->users_pwd));
        CRYPTO_free(vb, "../crypto/srp/srp_vfy.c", 287);
        return 
# 288 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 288 "../crypto/srp/srp_vfy.c"
                  ;
    }
    vb->default_g = 
# 290 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 290 "../crypto/srp/srp_vfy.c"
                       ;
    vb->default_N = 
# 291 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 291 "../crypto/srp/srp_vfy.c"
                       ;
    vb->seed_key = 
# 292 "../crypto/srp/srp_vfy.c" 3 4
                  ((void *)0)
# 292 "../crypto/srp/srp_vfy.c"
                      ;
    if ((seed_key != 
# 293 "../crypto/srp/srp_vfy.c" 3 4
                    ((void *)0)
# 293 "../crypto/srp/srp_vfy.c"
                        ) && (vb->seed_key = CRYPTO_strdup(seed_key, "../crypto/srp/srp_vfy.c", 293)) == 
# 293 "../crypto/srp/srp_vfy.c" 3 4
                                                                          ((void *)0)
# 293 "../crypto/srp/srp_vfy.c"
                                                                              ) {
        OPENSSL_sk_free(ossl_check_SRP_user_pwd_sk_type(vb->users_pwd));
        OPENSSL_sk_free(ossl_check_SRP_gN_cache_sk_type(vb->gN_cache));
        CRYPTO_free(vb, "../crypto/srp/srp_vfy.c", 296);
        return 
# 297 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 297 "../crypto/srp/srp_vfy.c"
                  ;
    }
    return vb;
}
...
void SRP_VBASE_free(SRP_VBASE *vb)
{
    if (!vb)
        return;
    OPENSSL_sk_pop_free(ossl_check_SRP_user_pwd_sk_type(vb->users_pwd),ossl_check_SRP_user_pwd_freefunc_type(SRP_user_pwd_free));
    OPENSSL_sk_free(ossl_check_SRP_gN_cache_sk_type(vb->gN_cache));
    CRYPTO_free(vb->seed_key, "../crypto/srp/srp_vfy.c", 308);
    CRYPTO_free(vb, "../crypto/srp/srp_vfy.c", 309);
}
...
static SRP_gN_cache *SRP_gN_new_init(const char *ch)
{
    unsigned char tmp[2500];
    int len;
    SRP_gN_cache *newgN = CRYPTO_malloc(sizeof(*newgN), "../crypto/srp/srp_vfy.c", 316);

    if (newgN == 
# 318 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 318 "../crypto/srp/srp_vfy.c"
                    )
        return 
# 319 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 319 "../crypto/srp/srp_vfy.c"
                  ;
    ...
    if ((newgN->b64_bn = CRYPTO_strdup(ch, "../crypto/srp/srp_vfy.c", 325)) == 
# 325 "../crypto/srp/srp_vfy.c" 3 4
                                               ((void *)0)
# 325 "../crypto/srp/srp_vfy.c"
                                                   )
        goto err;

    if ((newgN->bn = BN_bin2bn(tmp, len, 
# 328 "../crypto/srp/srp_vfy.c" 3 4
                                        ((void *)0)
# 328 "../crypto/srp/srp_vfy.c"
                                            )))
        return newgN;

    CRYPTO_free(newgN->b64_bn, "../crypto/srp/srp_vfy.c", 331);
 err:
    CRYPTO_free(newgN, "../crypto/srp/srp_vfy.c", 333);
    return 
# 334 "../crypto/srp/srp_vfy.c" 3 4
          ((void *)0)
# 334 "../crypto/srp/srp_vfy.c"
              ;
}
...
{
    if (gN_cache == 
# 339 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 339 "../crypto/srp/srp_vfy.c"
                       )
        return;
    CRYPTO_free(gN_cache->b64_bn, "../crypto/srp/srp_vfy.c", 341);
    BN_free(gN_cache->bn);
    CRYPTO_free(gN_cache, "../crypto/srp/srp_vfy.c", 343);
}

static SRP_gN *SRP_get_gN_by_id(const char *id, struct stack_st_SRP_gN *gN_tab)
{
    int i;

    SRP_gN *gN;
    if (gN_tab != 
# 351 "../crypto/srp/srp_vfy.c" 3 4
                 ((void *)0)
# 351 "../crypto/srp/srp_vfy.c"
                     ) {
        for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SRP_gN_sk_type(gN_tab)); i++) {
            gN = ((SRP_gN *)OPENSSL_sk_value(ossl_check_const_SRP_gN_sk_type(gN_tab), (i)));
            if (gN && (id == 
# 354 "../crypto/srp/srp_vfy.c" 3 4
                            ((void *)0) 
# 354 "../crypto/srp/srp_vfy.c"
                                 || strcmp(gN->id, id) == 0))
                return gN;
        }
    }
...
static BIGNUM *SRP_gN_place_bn(struct stack_st_SRP_gN_cache *gN_cache, char *ch)
{
    int i;
    if (gN_cache == 
# 365 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 365 "../crypto/srp/srp_vfy.c"
                       )
        return 
# 366 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 366 "../crypto/srp/srp_vfy.c"
                  ;


    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SRP_gN_cache_sk_type(gN_cache)); i++) {
        SRP_gN_cache *cache = ((SRP_gN_cache *)OPENSSL_sk_value(ossl_check_const_SRP_gN_cache_sk_type(gN_cache), (i)));
    ...
    }
    {
        ...
        if (newgN) {
            if (OPENSSL_sk_insert(ossl_check_SRP_gN_cache_sk_type(gN_cache), ossl_check_SRP_gN_cache_type(newgN), (0)) > 0)
                return newgN->bn;
            SRP_gN_free(newgN);
        }
    }
    return 
# 382 "../crypto/srp/srp_vfy.c" 3 4
          ((void *)0)
# 382 "../crypto/srp/srp_vfy.c"
              ;
}
# 395 "../crypto/srp/srp_vfy.c"
int SRP_VBASE_init(SRP_VBASE *vb, char *verifier_file)
{
    int error_code = 4;
    struct stack_st_SRP_gN *SRP_gN_tab = ((struct stack_st_SRP_gN *)OPENSSL_sk_new_null());
    char *last_index = 
# 399 "../crypto/srp/srp_vfy.c" 3 4
                      ((void *)0)
# 399 "../crypto/srp/srp_vfy.c"
                          ;
    int i;
    char **pp;

    SRP_gN *gN = 
# 403 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 403 "../crypto/srp/srp_vfy.c"
                    ;
    SRP_user_pwd *user_pwd = 
# 404 "../crypto/srp/srp_vfy.c" 3 4
                            ((void *)0)
# 404 "../crypto/srp/srp_vfy.c"
                                ;

    TXT_DB *tmpdb = 
# 406 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 406 "../crypto/srp/srp_vfy.c"
                       ;
    BIO *in = BIO_new(BIO_s_file());

    if (SRP_gN_tab == 
# 409 "../crypto/srp/srp_vfy.c" 3 4
                     ((void *)0)
# 409 "../crypto/srp/srp_vfy.c"
                         )
        goto err;
    ...
    if (in == 
# 414 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0) 
# 414 "../crypto/srp/srp_vfy.c"
                  || (int)BIO_ctrl(in,108, 0x01|0x02,(char *)(verifier_file)) <= 0)
        goto err;

    error_code = 1;

    if ((tmpdb = TXT_DB_read(in, 6)) == 
# 419 "../crypto/srp/srp_vfy.c" 3 4
                                               ((void *)0)
# 419 "../crypto/srp/srp_vfy.c"
                                                   )
        goto err;
    ...
    if (vb->seed_key) {
        last_index = SRP_get_default_gN(
# 425 "../crypto/srp/srp_vfy.c" 3 4
                                       ((void *)0)
# 425 "../crypto/srp/srp_vfy.c"
                                           )->id;
    }
    for (i = 0; i < sk_OPENSSL_PSTRING_num(tmpdb->data); i++) {
        ...
        if (pp[0][0] == 'I') {
            ...
            if ((gN = CRYPTO_malloc(sizeof(*gN), "../crypto/srp/srp_vfy.c", 434)) == 
# 434 "../crypto/srp/srp_vfy.c" 3 4
                                                     ((void *)0)
# 434 "../crypto/srp/srp_vfy.c"
                                                         )
                goto err;

            if ((gN->id = CRYPTO_strdup(pp[3], "../crypto/srp/srp_vfy.c", 437)) == 
# 437 "../crypto/srp/srp_vfy.c" 3 4
                                                          ((void *)0)
                
# 438 "../crypto/srp/srp_vfy.c"
               || (gN->N = SRP_gN_place_bn(vb->gN_cache, pp[1]))
                        == 
# 439 "../crypto/srp/srp_vfy.c" 3 4
                          ((void *)0)
                
# 440 "../crypto/srp/srp_vfy.c"
               || (gN->g = SRP_gN_place_bn(vb->gN_cache, pp[2]))
                        == 
# 441 "../crypto/srp/srp_vfy.c" 3 4
                          ((void *)0)
                
# 442 "../crypto/srp/srp_vfy.c"
               || OPENSSL_sk_insert(ossl_check_SRP_gN_sk_type(SRP_gN_tab), ossl_check_SRP_gN_type(gN), (0)) == 0)
                goto err;

            gN = 
# 445 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 445 "../crypto/srp/srp_vfy.c"
                    ;

            if (vb->seed_key != 
# 447 "../crypto/srp/srp_vfy.c" 3 4
                               ((void *)0)
# 447 "../crypto/srp/srp_vfy.c"
                                   ) {
                last_index = pp[3];
            }
        } else if (pp[0][0] == 'V') {
            ...
            if ((lgN = SRP_get_gN_by_id(pp[4], SRP_gN_tab)) != 
# 454 "../crypto/srp/srp_vfy.c" 3 4
                                                                     ((void *)0)
# 454 "../crypto/srp/srp_vfy.c"
                                                                         ) {
                error_code = 4;
                if ((user_pwd = SRP_user_pwd_new()) == 
# 456 "../crypto/srp/srp_vfy.c" 3 4
                                                      ((void *)0)
# 456 "../crypto/srp/srp_vfy.c"
                ...
                if (OPENSSL_sk_insert(ossl_check_SRP_user_pwd_sk_type(vb->users_pwd), ossl_check_SRP_user_pwd_type(user_pwd), (0)) == 0)
                    goto err;
                user_pwd = 
# 471 "../crypto/srp/srp_vfy.c" 3 4
                          ((void *)0)
# 471 "../crypto/srp/srp_vfy.c"
                              ;
            }
        }
    }
    ...
    if (last_index != 
# 476 "../crypto/srp/srp_vfy.c" 3 4
                     ((void *)0)
# 476 "../crypto/srp/srp_vfy.c"
                         ) {


        if (((gN = SRP_get_gN_by_id(last_index, SRP_gN_tab)) == 
# 479 "../crypto/srp/srp_vfy.c" 3 4
                                                               ((void *)0)
# 479 "../crypto/srp/srp_vfy.c"
                                                                   )) {
            error_code = 2;
            goto err;
        }
        ...
        vb->default_N = gN->N;
        gN = 
# 485 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 485 "../crypto/srp/srp_vfy.c"
                ;
    }
    error_code = 0;
 ...
 err:
    ...
    if (gN != 
# 495 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 495 "../crypto/srp/srp_vfy.c"
                 ) {
        CRYPTO_free(gN->id, "../crypto/srp/srp_vfy.c", 496);
        CRYPTO_free(gN, "../crypto/srp/srp_vfy.c", 497);
    }
    ...
    OPENSSL_sk_free(ossl_check_SRP_gN_sk_type(SRP_gN_tab));
...
static SRP_user_pwd *find_user(SRP_VBASE *vb, char *username)
{
    ...
    if (vb == 
# 516 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 516 "../crypto/srp/srp_vfy.c"
                 )
        return 
# 517 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 517 "../crypto/srp/srp_vfy.c"
                  ;

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_SRP_user_pwd_sk_type(vb->users_pwd)); i++) {
        user = ((SRP_user_pwd *)OPENSSL_sk_value(ossl_check_const_SRP_user_pwd_sk_type(vb->users_pwd), (i)));
        if (strcmp(user->id, username) == 0)
            return user;
    }

    return 
# 525 "../crypto/srp/srp_vfy.c" 3 4
          ((void *)0)
# 525 "../crypto/srp/srp_vfy.c"
              ;
}

int SRP_VBASE_add0_user(SRP_VBASE *vb, SRP_user_pwd *user_pwd)
{
    if (OPENSSL_sk_push(ossl_check_SRP_user_pwd_sk_type(vb->users_pwd), ossl_check_SRP_user_pwd_type(user_pwd)) <= 0)
        return 0;
    return 1;
}
# 542 "../crypto/srp/srp_vfy.c"
SRP_user_pwd *SRP_VBASE_get_by_user(SRP_VBASE *vb, char *username)
{
...
{
    SRP_user_pwd *user;
    unsigned char digv[20];
    unsigned char digs[20];
    EVP_MD_CTX *ctxt = 
# 557 "../crypto/srp/srp_vfy.c" 3 4
                      ((void *)0)
# 557 "../crypto/srp/srp_vfy.c"
                          ;
    EVP_MD *md = 
# 558 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 558 "../crypto/srp/srp_vfy.c"
                    ;

    if (vb == 
# 560 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 560 "../crypto/srp/srp_vfy.c"
                 )
        return 
# 561 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 561 "../crypto/srp/srp_vfy.c"
                  ;

    if ((user = find_user(vb, username)) != 
# 563 "../crypto/srp/srp_vfy.c" 3 4
                                           ((void *)0)
# 563 "../crypto/srp/srp_vfy.c"
                                               )
        return srp_user_pwd_dup(user);

    if ((vb->seed_key == 
# 566 "../crypto/srp/srp_vfy.c" 3 4
                        ((void *)0)
# 566 "../crypto/srp/srp_vfy.c"
                            ) ||
        (vb->default_g == 
# 567 "../crypto/srp/srp_vfy.c" 3 4
                         ((void *)0)
# 567 "../crypto/srp/srp_vfy.c"
                             ) || (vb->default_N == 
# 567 "../crypto/srp/srp_vfy.c" 3 4
                                                    ((void *)0)
# 567 "../crypto/srp/srp_vfy.c"
        ...
        return 
# 568 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 568 "../crypto/srp/srp_vfy.c"
                  ;



    if ((user = SRP_user_pwd_new()) == 
# 572 "../crypto/srp/srp_vfy.c" 3 4
                                      ((void *)0)
# 572 "../crypto/srp/srp_vfy.c"
                                          )
        return 
# 573 "../crypto/srp/srp_vfy.c" 3 4
              ((void *)0)
# 573 "../crypto/srp/srp_vfy.c"
                  ;

    SRP_user_pwd_set_gN(user, vb->default_g, vb->default_N);

    if (!SRP_user_pwd_set1_ids(user, username, 
# 577 "../crypto/srp/srp_vfy.c" 3 4
                                              ((void *)0)
# 577 "../crypto/srp/srp_vfy.c"
                                                  ))
        goto err;

    if (RAND_priv_bytes(digv, 20) <= 0)
        goto err;
    md = EVP_MD_fetch(
# 582 "../crypto/srp/srp_vfy.c" 3 4
                     ((void *)0)
# 582 "../crypto/srp/srp_vfy.c"
                         , "SHA1", 
# 582 "../crypto/srp/srp_vfy.c" 3 4
                                    ((void *)0)
# 582 "../crypto/srp/srp_vfy.c"
    ...
    if (md == 
# 583 "../crypto/srp/srp_vfy.c" 3 4
             ((void *)0)
# 583 "../crypto/srp/srp_vfy.c"
                 )
        goto err;
    ctxt = EVP_MD_CTX_new();
    if (ctxt == 
# 586 "../crypto/srp/srp_vfy.c" 3 4
               ((void *)0)
        
# 587 "../crypto/srp/srp_vfy.c"
       || !EVP_DigestInit_ex(ctxt, md, 
# 587 "../crypto/srp/srp_vfy.c" 3 4
                                       ((void *)0)
# 587 "../crypto/srp/srp_vfy.c"
                                           )
        || !EVP_DigestUpdate(ctxt, vb->seed_key, strlen(vb->seed_key))
        || !EVP_DigestUpdate(ctxt, username, strlen(username))
        || !EVP_DigestFinal_ex(ctxt, digs, 
# 590 "../crypto/srp/srp_vfy.c" 3 4
                                          ((void *)0)
# 590 "../crypto/srp/srp_vfy.c"
                                              ))
        goto err;
    EVP_MD_CTX_free(ctxt);
    ctxt = 
# 593 "../crypto/srp/srp_vfy.c" 3 4
          ((void *)0)
# 593 "../crypto/srp/srp_vfy.c"
              ;
    EVP_MD_free(md);
    md = 
# 595 "../crypto/srp/srp_vfy.c" 3 4
        ((void *)0)
# 595 "../crypto/srp/srp_vfy.c"
            ;
    if (SRP_user_pwd_set0_sv(user,
                             BN_bin2bn(digs, 20, 
# 597 "../crypto/srp/srp_vfy.c" 3 4
                                                               ((void *)0)
# 597 "../crypto/srp/srp_vfy.c"
                                                                   ),
                             BN_bin2bn(digv, 20, 
# 598 "../crypto/srp/srp_vfy.c" 3 4
                                                               ((void *)0)
# 598 "../crypto/srp/srp_vfy.c"
                                                                   )))
        return user;
 ...
 err:
    ...
    return 
# 605 "../crypto/srp/srp_vfy.c" 3 4
          ((void *)0)
# 605 "../crypto/srp/srp_vfy.c"
              ;
}
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    int len;
    char *result = 
# 616 "../crypto/srp/srp_vfy.c" 3 4
                  ((void *)0)
# 616 "../crypto/srp/srp_vfy.c"
                      , *vf = 
# 616 "../crypto/srp/srp_vfy.c" 3 4
                              ((void *)0)
# 616 "../crypto/srp/srp_vfy.c"
                                  ;
    const BIGNUM *N_bn = 
# 617 "../crypto/srp/srp_vfy.c" 3 4
                        ((void *)0)
# 617 "../crypto/srp/srp_vfy.c"
                            , *g_bn = 
# 617 "../crypto/srp/srp_vfy.c" 3 4
                                      ((void *)0)
# 617 "../crypto/srp/srp_vfy.c"
                                          ;
    BIGNUM *N_bn_alloc = 
# 618 "../crypto/srp/srp_vfy.c" 3 4
                        ((void *)0)
# 618 "../crypto/srp/srp_vfy.c"
                            , *g_bn_alloc = 
# 618 "../crypto/srp/srp_vfy.c" 3 4
                                            ((void *)0)
# 618 "../crypto/srp/srp_vfy.c"
...
# 618 "../crypto/srp/srp_vfy.c"
                                                                      ;
    unsigned char tmp[2500];
    unsigned char tmp2[2500];
    char *defgNid = 
# 621 "../crypto/srp/srp_vfy.c" 3 4
                   ((void *)0)
# 621 "../crypto/srp/srp_vfy.c"
                       ;
    int vfsize = 0;

    if ((user == 
# 624 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 624 "../crypto/srp/srp_vfy.c"
                    ) ||
        (pass == 
# 625 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 625 "../crypto/srp/srp_vfy.c"
                    ) || (salt == 
# 625 "../crypto/srp/srp_vfy.c" 3 4
                                  ((void *)0)
# 625 "../crypto/srp/srp_vfy.c"
...
# 625 "../crypto/srp/srp_vfy.c"
    ...
    if (N) {
        if ((len = t_fromb64(tmp, sizeof(tmp), N)) <= 0)
            goto err;
        N_bn_alloc = BN_bin2bn(tmp, len, 
# 631 "../crypto/srp/srp_vfy.c" 3 4
                                        ((void *)0)
# 631 "../crypto/srp/srp_vfy.c"
                                            );
        if (N_bn_alloc == 
# 632 "../crypto/srp/srp_vfy.c" 3 4
                         ((void *)0)
# 632 "../crypto/srp/srp_vfy.c"
                             )
            goto err;
        N_bn = N_bn_alloc;
        if ((len = t_fromb64(tmp, sizeof(tmp), g)) <= 0)
            goto err;
        g_bn_alloc = BN_bin2bn(tmp, len, 
# 637 "../crypto/srp/srp_vfy.c" 3 4
                                        ((void *)0)
# 637 "../crypto/srp/srp_vfy.c"
                                            );
        if (g_bn_alloc == 
# 638 "../crypto/srp/srp_vfy.c" 3 4
                         ((void *)0)
# 638 "../crypto/srp/srp_vfy.c"
                             )
            goto err;
        g_bn = g_bn_alloc;
        defgNid = "*";
        ...
        if (gN == 
# 644 "../crypto/srp/srp_vfy.c" 3 4
                 ((void *)0)
# 644 "../crypto/srp/srp_vfy.c"
                     )
            goto err;
        N_bn = gN->N;
        g_bn = gN->g;
    ...
    if (*salt == 
# 651 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 651 "../crypto/srp/srp_vfy.c"
                    ) {
        if (RAND_bytes_ex(libctx, tmp2, 20, 0) <= 0)
            goto err;

        s = BN_bin2bn(tmp2, 20, 
# 655 "../crypto/srp/srp_vfy.c" 3 4
                                                ((void *)0)
# 655 "../crypto/srp/srp_vfy.c"
                                                    );
    } else {
        if ((len = t_fromb64(tmp2, sizeof(tmp2), *salt)) <= 0)
            goto err;
        s = BN_bin2bn(tmp2, len, 
# 659 "../crypto/srp/srp_vfy.c" 3 4
                                ((void *)0)
# 659 "../crypto/srp/srp_vfy.c"
                                    );
    }
    if (s == 
# 661 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 661 "../crypto/srp/srp_vfy.c"
                )
        goto err;
    ...
    if (BN_bn2bin(v, tmp) < 0)
        goto err;
    vfsize = ((BN_num_bits(v)+7)/8) * 2;
    if (((vf = CRYPTO_malloc(vfsize, "../crypto/srp/srp_vfy.c", 671)) == 
# 671 "../crypto/srp/srp_vfy.c" 3 4
                                         ((void *)0)
# 671 "../crypto/srp/srp_vfy.c"
                                             ))
        goto err;
    if (!t_tob64(vf, tmp, ((BN_num_bits(v)+7)/8)))
        goto err;

    if (*salt == 
# 676 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 676 "../crypto/srp/srp_vfy.c"
                    ) {
        char *tmp_salt;

        if ((tmp_salt = CRYPTO_malloc(20 * 2, "../crypto/srp/srp_vfy.c", 679)) == 
# 679 "../crypto/srp/srp_vfy.c" 3 4
                                                                   ((void *)0)
# 679 "../crypto/srp/srp_vfy.c"
                                                                       ) {
            goto err;
        }
        if (!t_tob64(tmp_salt, tmp2, 20)) {
            CRYPTO_free(tmp_salt, "../crypto/srp/srp_vfy.c", 683);
            goto err;
        }
        *salt = tmp_salt;
    }
    ...
    *verifier = vf;
    vf = 
# 690 "../crypto/srp/srp_vfy.c" 3 4
        ((void *)0)
# 690 "../crypto/srp/srp_vfy.c"
            ;
    result = defgNid;
 ...
 err:
    BN_free(N_bn_alloc);
    BN_free(g_bn_alloc);
    CRYPTO_clear_free(vf, vfsize, "../crypto/srp/srp_vfy.c", 696);
    BN_clear_free(s);
    BN_clear_free(v);
    return result;
}
...
char *SRP_create_verifier(const char *user, const char *pass, char **salt,
                          char **verifier, const char *N, const char *g)
{
    return SRP_create_verifier_ex(user, pass, salt, verifier, N, g, 
# 705 "../crypto/srp/srp_vfy.c" 3 4
                                                                   ((void *)0)
# 705 "../crypto/srp/srp_vfy.c"
                                                                       , 
# 705 "../crypto/srp/srp_vfy.c" 3 4
                                                                         ((void *)0)
# 705 "../crypto/srp/srp_vfy.c"
                              ...
                              const char *propq)
{
    int result = 0;
    BIGNUM *x = 
# 723 "../crypto/srp/srp_vfy.c" 3 4
               ((void *)0)
# 723 "../crypto/srp/srp_vfy.c"
                   ;
    BN_CTX *bn_ctx = BN_CTX_new_ex(libctx);
    unsigned char tmp2[2500];
    BIGNUM *salttmp = 
# 726 "../crypto/srp/srp_vfy.c" 3 4
                     ((void *)0)
# 726 "../crypto/srp/srp_vfy.c"
                         , *verif;

    if ((user == 
# 728 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 728 "../crypto/srp/srp_vfy.c"
                    ) ||
        (pass == 
# 729 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 729 "../crypto/srp/srp_vfy.c"
                    ) ||
        (salt == 
# 730 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 730 "../crypto/srp/srp_vfy.c"
                    ) ||
        (verifier == 
# 731 "../crypto/srp/srp_vfy.c" 3 4
                    ((void *)0)
# 731 "../crypto/srp/srp_vfy.c"
                        ) || (N == 
# 731 "../crypto/srp/srp_vfy.c" 3 4
                                   ((void *)0)
# 731 "../crypto/srp/srp_vfy.c"
...
# 734 "../crypto/srp/srp_vfy.c"
        ...
        salttmp = BN_bin2bn(tmp2, 20, 
# 738 "../crypto/srp/srp_vfy.c" 3 4
                                                      ((void *)0)
# 738 "../crypto/srp/srp_vfy.c"
                                                          );
        if (salttmp == 
# 739 "../crypto/srp/srp_vfy.c" 3 4
                      ((void *)0)
# 739 "../crypto/srp/srp_vfy.c"
    ...
    if (x == 
# 746 "../crypto/srp/srp_vfy.c" 3 4
            ((void *)0)
# 746 "../crypto/srp/srp_vfy.c"
                )
        goto err;

    verif = BN_new();
    if (verif == 
# 750 "../crypto/srp/srp_vfy.c" 3 4
                ((void *)0)
# 750 "../crypto/srp/srp_vfy.c"
                    )
        goto err;
 ...
 err:
    if (salt != 
# 763 "../crypto/srp/srp_vfy.c" 3 4
               ((void *)0) 
# 763 "../crypto/srp/srp_vfy.c"
                    && *salt != salttmp)
...
int SRP_create_verifier_BN(const char *user, const char *pass, BIGNUM **salt,
                           ...
                           const BIGNUM *g)
{
    return SRP_create_verifier_BN_ex(user, pass, salt, verifier, N, g, 
# 774 "../crypto/srp/srp_vfy.c" 3 4
                                                                      ((void *)0)
# 774 "../crypto/srp/srp_vfy.c"
                                                                          ,
                                     
# 775 "../crypto/srp/srp_vfy.c" 3 4
                                    ((void *)0)
# 775 "../crypto/srp/srp_vfy.c"
                                        );
}
