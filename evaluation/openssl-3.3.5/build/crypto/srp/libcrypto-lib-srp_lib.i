# 0 "../crypto/srp/srp_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/srp/srp_lib.c"
# 18 "../crypto/srp/srp_lib.c"
                           ...
                           OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    unsigned char *tmp = 
# 30 "../crypto/srp/srp_lib.c" 3 4
                        ((void *)0)
# 30 "../crypto/srp/srp_lib.c"
                            ;
    int numN = ((BN_num_bits(N)+7)/8);
    BIGNUM *res = 
# 32 "../crypto/srp/srp_lib.c" 3 4
                 ((void *)0)
# 32 "../crypto/srp/srp_lib.c"
                     ;
    EVP_MD *sha1 = EVP_MD_fetch(libctx, "SHA1", propq);

    if (sha1 == 
# 35 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0)
# 35 "../crypto/srp/srp_lib.c"
                   )
        return 
# 36 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 36 "../crypto/srp/srp_lib.c"
                  ;
    ...
    if (y != N && BN_ucmp(y, N) >= 0)
        goto err;
    if ((tmp = CRYPTO_malloc(numN * 2, "../crypto/srp/srp_lib.c", 42)) == 
# 42 "../crypto/srp/srp_lib.c" 3 4
                                           ((void *)0)
# 42 "../crypto/srp/srp_lib.c"
                                               )
        goto err;
    if (BN_bn2binpad(x, tmp, numN) < 0
        || BN_bn2binpad(y, tmp + numN, numN) < 0
        || !EVP_Digest(tmp, numN * 2, digest, 
# 46 "../crypto/srp/srp_lib.c" 3 4
                                             ((void *)0)
# 46 "../crypto/srp/srp_lib.c"
                                                 , sha1, 
# 46 "../crypto/srp/srp_lib.c" 3 4
                                                         ((void *)0)
# 46 "../crypto/srp/srp_lib.c"
        ...
        goto err;
    res = BN_bin2bn(digest, sizeof(digest), 
# 48 "../crypto/srp/srp_lib.c" 3 4
                                           ((void *)0)
# 48 "../crypto/srp/srp_lib.c"
                                               );
 err:
    EVP_MD_free(sha1);
    CRYPTO_free(tmp, "../crypto/srp/srp_lib.c", 51);
    return res;
}
...
# 73 "../crypto/srp/srp_lib.c" 3 4
                               ((void *)0)
# 73 "../crypto/srp/srp_lib.c"
                                   , 
# 73 "../crypto/srp/srp_lib.c" 3 4
                                     ((void *)0)
# 73 "../crypto/srp/srp_lib.c"
...
{
    BIGNUM *tmp = 
# 79 "../crypto/srp/srp_lib.c" 3 4
                 ((void *)0)
# 79 "../crypto/srp/srp_lib.c"
                     , *S = 
# 79 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0)
# 79 "../crypto/srp/srp_lib.c"
    ...
    if (u == 
# 82 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 82 "../crypto/srp/srp_lib.c"
                 || A == 
# 82 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 82 "../crypto/srp/srp_lib.c"
...
# 82 "../crypto/srp/srp_lib.c"
        ...
        return 
# 83 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 83 "../crypto/srp/srp_lib.c"
                  ;

    if ((bn_ctx = BN_CTX_new()) == 
# 85 "../crypto/srp/srp_lib.c" 3 4
                                  ((void *)0) 
# 85 "../crypto/srp/srp_lib.c"
                                       || (tmp = BN_new()) == 
# 85 "../crypto/srp/srp_lib.c" 3 4
                                                              ((void *)0)
# 85 "../crypto/srp/srp_lib.c"
    ...
    S = BN_new();
    if (S != 
# 96 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 96 "../crypto/srp/srp_lib.c"
                 && !BN_mod_exp(S, tmp, b, N, bn_ctx)) {
        BN_free(S);
        S = 
# 98 "../crypto/srp/srp_lib.c" 3 4
           ((void *)0)
# 98 "../crypto/srp/srp_lib.c"
               ;
    }
 err:
    BN_CTX_free(bn_ctx);
...
{
    BIGNUM *kv = 
# 109 "../crypto/srp/srp_lib.c" 3 4
                ((void *)0)
# 109 "../crypto/srp/srp_lib.c"
                    , *gb = 
# 109 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0)
# 109 "../crypto/srp/srp_lib.c"
                                ;
    BIGNUM *B = 
# 110 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0)
# 110 "../crypto/srp/srp_lib.c"
                   , *k = 
# 110 "../crypto/srp/srp_lib.c" 3 4
                          ((void *)0)
# 110 "../crypto/srp/srp_lib.c"
    ...
    if (b == 
# 113 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 113 "../crypto/srp/srp_lib.c"
                 || N == 
# 113 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 113 "../crypto/srp/srp_lib.c"
...
# 113 "../crypto/srp/srp_lib.c"
                                                        ||
        (bn_ctx = BN_CTX_new_ex(libctx)) == 
# 114 "../crypto/srp/srp_lib.c" 3 4
                                           ((void *)0)
# 114 "../crypto/srp/srp_lib.c"
                                               )
        return 
# 115 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 115 "../crypto/srp/srp_lib.c"
                  ;

    if ((kv = BN_new()) == 
# 117 "../crypto/srp/srp_lib.c" 3 4
                          ((void *)0) 
# 117 "../crypto/srp/srp_lib.c"
                               ||
        (gb = BN_new()) == 
# 118 "../crypto/srp/srp_lib.c" 3 4
                          ((void *)0) 
# 118 "../crypto/srp/srp_lib.c"
                               || (B = BN_new()) == 
# 118 "../crypto/srp/srp_lib.c" 3 4
                                                    ((void *)0)
# 118 "../crypto/srp/srp_lib.c"
    ...
    if (!BN_mod_exp(gb, g, b, N, bn_ctx)
        || (k = srp_Calc_k(N, g, libctx, propq)) == 
# 124 "../crypto/srp/srp_lib.c" 3 4
                                                   ((void *)0)
        
# 125 "../crypto/srp/srp_lib.c"
       || !BN_mod_mul(kv, v, k, N, bn_ctx)
        || !BN_mod_add(B, gb, kv, N, bn_ctx)) {
        BN_free(B);
        B = 
# 128 "../crypto/srp/srp_lib.c" 3 4
           ((void *)0)
# 128 "../crypto/srp/srp_lib.c"
               ;
    }
 err:
    BN_CTX_free(bn_ctx);
...
BIGNUM *SRP_Calc_B(const BIGNUM *b, const BIGNUM *N, const BIGNUM *g,
                   const BIGNUM *v)
{
    return SRP_Calc_B_ex(b, N, g, v, 
# 141 "../crypto/srp/srp_lib.c" 3 4
                                    ((void *)0)
# 141 "../crypto/srp/srp_lib.c"
                                        , 
# 141 "../crypto/srp/srp_lib.c" 3 4
                                          ((void *)0)
# 141 "../crypto/srp/srp_lib.c"
                      ...
                      OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    EVP_MD_CTX *ctxt;
    unsigned char *cs = 
# 149 "../crypto/srp/srp_lib.c" 3 4
                       ((void *)0)
# 149 "../crypto/srp/srp_lib.c"
                           ;
    BIGNUM *res = 
# 150 "../crypto/srp/srp_lib.c" 3 4
                 ((void *)0)
# 150 "../crypto/srp/srp_lib.c"
                     ;
    EVP_MD *sha1 = 
# 151 "../crypto/srp/srp_lib.c" 3 4
                  ((void *)0)
# 151 "../crypto/srp/srp_lib.c"
                      ;

    if ((s == 
# 153 "../crypto/srp/srp_lib.c" 3 4
             ((void *)0)
# 153 "../crypto/srp/srp_lib.c"
                 ) || (user == 
# 153 "../crypto/srp/srp_lib.c" 3 4
                               ((void *)0)
# 153 "../crypto/srp/srp_lib.c"
...
# 153 "../crypto/srp/srp_lib.c"
        ...
        return 
# 154 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 154 "../crypto/srp/srp_lib.c"
                  ;

    ctxt = EVP_MD_CTX_new();
    if (ctxt == 
# 157 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0)
# 157 "../crypto/srp/srp_lib.c"
                   )
        return 
# 158 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 158 "../crypto/srp/srp_lib.c"
                  ;
    if ((cs = CRYPTO_malloc(((BN_num_bits(s)+7)/8), "../crypto/srp/srp_lib.c", 159)) == 
# 159 "../crypto/srp/srp_lib.c" 3 4
                                                 ((void *)0)
# 159 "../crypto/srp/srp_lib.c"
                                                     )
        goto err;

    sha1 = EVP_MD_fetch(libctx, "SHA1", propq);
    if (sha1 == 
# 163 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0)
# 163 "../crypto/srp/srp_lib.c"
                   )
        goto err;

    if (!EVP_DigestInit_ex(ctxt, sha1, 
# 166 "../crypto/srp/srp_lib.c" 3 4
                                      ((void *)0)
# 166 "../crypto/srp/srp_lib.c"
                                          )
        || !EVP_DigestUpdate(ctxt, user, strlen(user))
        || !EVP_DigestUpdate(ctxt, ":", 1)
        || !EVP_DigestUpdate(ctxt, pass, strlen(pass))
        || !EVP_DigestFinal_ex(ctxt, dig, 
# 170 "../crypto/srp/srp_lib.c" 3 4
                                         ((void *)0)
# 170 "../crypto/srp/srp_lib.c"
                                             )
        || !EVP_DigestInit_ex(ctxt, sha1, 
# 171 "../crypto/srp/srp_lib.c" 3 4
                                         ((void *)0)
# 171 "../crypto/srp/srp_lib.c"
                                             ))
        goto err;
    if (BN_bn2bin(s, cs) < 0)
        goto err;
    if (!EVP_DigestUpdate(ctxt, cs, ((BN_num_bits(s)+7)/8)))
        goto err;

    if (!EVP_DigestUpdate(ctxt, dig, sizeof(dig))
        || !EVP_DigestFinal_ex(ctxt, dig, 
# 179 "../crypto/srp/srp_lib.c" 3 4
                                         ((void *)0)
# 179 "../crypto/srp/srp_lib.c"
                                             ))
        goto err;

    res = BN_bin2bn(dig, sizeof(dig), 
# 182 "../crypto/srp/srp_lib.c" 3 4
                                     ((void *)0)
# 182 "../crypto/srp/srp_lib.c"
                                         );

 err:
    EVP_MD_free(sha1);
    CRYPTO_free(cs, "../crypto/srp/srp_lib.c", 186);
...
BIGNUM *SRP_Calc_x(const BIGNUM *s, const char *user, const char *pass)
{
    return SRP_Calc_x_ex(s, user, pass, 
# 193 "../crypto/srp/srp_lib.c" 3 4
                                       ((void *)0)
# 193 "../crypto/srp/srp_lib.c"
                                           , 
# 193 "../crypto/srp/srp_lib.c" 3 4
                                             ((void *)0)
# 193 "../crypto/srp/srp_lib.c"
...
BIGNUM *SRP_Calc_A(const BIGNUM *a, const BIGNUM *N, const BIGNUM *g)
{
    BN_CTX *bn_ctx;
    BIGNUM *A = 
# 199 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0)
# 199 "../crypto/srp/srp_lib.c"
                   ;

    if (a == 
# 201 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 201 "../crypto/srp/srp_lib.c"
                 || N == 
# 201 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 201 "../crypto/srp/srp_lib.c"
...
# 201 "../crypto/srp/srp_lib.c"
        ...
        return 
# 202 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 202 "../crypto/srp/srp_lib.c"
                  ;

    if ((A = BN_new()) != 
# 204 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 204 "../crypto/srp/srp_lib.c"
                              && !BN_mod_exp(A, g, a, N, bn_ctx)) {
        BN_free(A);
        A = 
# 206 "../crypto/srp/srp_lib.c" 3 4
           ((void *)0)
# 206 "../crypto/srp/srp_lib.c"
               ;
    }
    BN_CTX_free(bn_ctx);
    return A;
...
{
    BIGNUM *tmp = 
# 216 "../crypto/srp/srp_lib.c" 3 4
                 ((void *)0)
# 216 "../crypto/srp/srp_lib.c"
                     , *tmp2 = 
# 216 "../crypto/srp/srp_lib.c" 3 4
                               ((void *)0)
# 216 "../crypto/srp/srp_lib.c"
...
# 216 "../crypto/srp/srp_lib.c"
                                                                       ;
    BIGNUM *xtmp = 
# 217 "../crypto/srp/srp_lib.c" 3 4
                  ((void *)0)
# 217 "../crypto/srp/srp_lib.c"
                      ;
    BN_CTX *bn_ctx;

    if (u == 
# 220 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 220 "../crypto/srp/srp_lib.c"
                 || B == 
# 220 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 220 "../crypto/srp/srp_lib.c"
...
# 221 "../crypto/srp/srp_lib.c"
       || a == 
# 221 "../crypto/srp/srp_lib.c" 3 4
               ((void *)0) 
# 221 "../crypto/srp/srp_lib.c"
                    || (bn_ctx = BN_CTX_new_ex(libctx)) == 
# 221 "../crypto/srp/srp_lib.c" 3 4
...
# 221 "../crypto/srp/srp_lib.c"
        ...
        return 
# 222 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 222 "../crypto/srp/srp_lib.c"
                  ;

    if ((tmp = BN_new()) == 
# 224 "../crypto/srp/srp_lib.c" 3 4
                           ((void *)0) 
# 224 "../crypto/srp/srp_lib.c"
                                ||
        (tmp2 = BN_new()) == 
# 225 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0) 
# 225 "../crypto/srp/srp_lib.c"
                                 ||
        (tmp3 = BN_new()) == 
# 226 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0) 
# 226 "../crypto/srp/srp_lib.c"
                                 ||
        (xtmp = BN_new()) == 
# 227 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0)
# 227 "../crypto/srp/srp_lib.c"
                                )
        goto err;

    BN_with_flags(xtmp, x, 0x04);
    BN_set_flags(tmp, 0x04);
    if (!BN_mod_exp(tmp, g, xtmp, N, bn_ctx))
        goto err;
    if ((k = srp_Calc_k(N, g, libctx, propq)) == 
# 234 "../crypto/srp/srp_lib.c" 3 4
                                                ((void *)0)
# 234 "../crypto/srp/srp_lib.c"
                                                    )
        goto err;
    ...
    K = BN_new();
    if (K != 
# 245 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 245 "../crypto/srp/srp_lib.c"
                 && !BN_mod_exp(K, tmp, tmp2, N, bn_ctx)) {
        BN_free(K);
        K = 
# 247 "../crypto/srp/srp_lib.c" 3 4
           ((void *)0)
# 247 "../crypto/srp/srp_lib.c"
               ;
    }
...
BIGNUM *SRP_Calc_client_key(const BIGNUM *N, const BIGNUM *B, const BIGNUM *g,
                            const BIGNUM *x, const BIGNUM *a, const BIGNUM *u)
{
    return SRP_Calc_client_key_ex(N, B, g, x, a, u, 
# 263 "../crypto/srp/srp_lib.c" 3 4
                                                   ((void *)0)
# 263 "../crypto/srp/srp_lib.c"
                                                       , 
# 263 "../crypto/srp/srp_lib.c" 3 4
                                                         ((void *)0)
# 263 "../crypto/srp/srp_lib.c"
...
int SRP_Verify_B_mod_N(const BIGNUM *B, const BIGNUM *N)
{
    ...
    if (B == 
# 272 "../crypto/srp/srp_lib.c" 3 4
            ((void *)0) 
# 272 "../crypto/srp/srp_lib.c"
                 || N == 
# 272 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0) 
# 272 "../crypto/srp/srp_lib.c"
...
# 272 "../crypto/srp/srp_lib.c"
    ...
    if ((r = BN_new()) == 
# 275 "../crypto/srp/srp_lib.c" 3 4
                         ((void *)0)
# 275 "../crypto/srp/srp_lib.c"
                             )
        goto err;
...
char *SRP_check_known_gN_param(const BIGNUM *g, const BIGNUM *N)
{
    size_t i;
    if ((g == 
# 312 "../crypto/srp/srp_lib.c" 3 4
             ((void *)0)
# 312 "../crypto/srp/srp_lib.c"
                 ) || (N == 
# 312 "../crypto/srp/srp_lib.c" 3 4
                            ((void *)0)
# 312 "../crypto/srp/srp_lib.c"
        ...
        return 
# 313 "../crypto/srp/srp_lib.c" 3 4
              ((void *)0)
# 313 "../crypto/srp/srp_lib.c"
                  ;

    for (i = 0; i < sizeof(knowngN) / sizeof(SRP_gN); i++) {
        if (BN_cmp(knowngN[i].g, g) == 0 && BN_cmp(knowngN[i].N, N) == 0)
            return knowngN[i].id;
    }
    return 
# 319 "../crypto/srp/srp_lib.c" 3 4
          ((void *)0)
# 319 "../crypto/srp/srp_lib.c"
              ;
}
...
SRP_gN *SRP_get_default_gN(const char *id)
{
    ...
    if (id == 
# 326 "../crypto/srp/srp_lib.c" 3 4
             ((void *)0)
# 326 "../crypto/srp/srp_lib.c"
                 )
        return knowngN;
    for (i = 0; i < sizeof(knowngN) / sizeof(SRP_gN); i++) {
    ...
    return 
# 332 "../crypto/srp/srp_lib.c" 3 4
          ((void *)0)
# 332 "../crypto/srp/srp_lib.c"
              ;
}
