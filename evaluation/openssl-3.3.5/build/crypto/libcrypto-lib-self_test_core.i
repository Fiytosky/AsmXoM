...
# 15 "../include/openssl/self_test.h" 2
...
{
    return ossl_lib_ctx_get_data(libctx, 12);
}
                                 ...
                                 void *cbarg)
{
    ...
    if (stcb != 
# 59 "../crypto/self_test_core.c" 3 4
               ((void *)0)
# 59 "../crypto/self_test_core.c"
                   ) {
        stcb->cb = cb;
        stcb->cbarg = cbarg;
    }
                                 ...
                                 void **cbarg)
{
    ...
    if (cb != 
# 70 "../crypto/self_test_core.c" 3 4
             ((void *)0)
# 70 "../crypto/self_test_core.c"
                 )
        *cb = (stcb != 
# 71 "../crypto/self_test_core.c" 3 4
                      ((void *)0) 
# 71 "../crypto/self_test_core.c"
                           ? stcb->cb : 
# 71 "../crypto/self_test_core.c" 3 4
                                        ((void *)0)
# 71 "../crypto/self_test_core.c"
    ...
    if (cbarg != 
# 72 "../crypto/self_test_core.c" 3 4
                ((void *)0)
# 72 "../crypto/self_test_core.c"
                    )
        *cbarg = (stcb != 
# 73 "../crypto/self_test_core.c" 3 4
                         ((void *)0) 
# 73 "../crypto/self_test_core.c"
                              ? stcb->cbarg : 
# 73 "../crypto/self_test_core.c" 3 4
                                              ((void *)0)
# 73 "../crypto/self_test_core.c"
...
static void self_test_setparams(OSSL_SELF_TEST *st)
{
    ...
    if (st->cb != 
# 81 "../crypto/self_test_core.c" 3 4
                 ((void *)0)
# 81 "../crypto/self_test_core.c"
                     ) {
        st->params[n++] =
            OSSL_PARAM_construct_utf8_string("st-phase",
                                             (char *)st->phase, 0);
        st->params[n++] =
            OSSL_PARAM_construct_utf8_string("st-type",
                                             (char *)st->type, 0);
        st->params[n++] =
            OSSL_PARAM_construct_utf8_string("st-desc",
                                             (char *)st->desc, 0);
    }
...
OSSL_SELF_TEST *OSSL_SELF_TEST_new(OSSL_CALLBACK *cb, void *cbarg)
{
    OSSL_SELF_TEST *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/self_test_core.c", 97);

    if (ret == 
# 99 "../crypto/self_test_core.c" 3 4
              ((void *)0)
# 99 "../crypto/self_test_core.c"
                  )
        return 
# 100 "../crypto/self_test_core.c" 3 4
              ((void *)0)
# 100 "../crypto/self_test_core.c"
                  ;
...
void OSSL_SELF_TEST_free(OSSL_SELF_TEST *st)
{
    CRYPTO_free(st, "../crypto/self_test_core.c", 113);
}
...
{
    if (st != 
# 120 "../crypto/self_test_core.c" 3 4
             ((void *)0) 
# 120 "../crypto/self_test_core.c"
                  && st->cb != 
# 120 "../crypto/self_test_core.c" 3 4
                               ((void *)0)
# 120 "../crypto/self_test_core.c"
...
{
    if (st != 
# 135 "../crypto/self_test_core.c" 3 4
             ((void *)0) 
# 135 "../crypto/self_test_core.c"
                  && st->cb != 
# 135 "../crypto/self_test_core.c" 3 4
                               ((void *)0)
# 135 "../crypto/self_test_core.c"
...
{
    if (st != 
# 157 "../crypto/self_test_core.c" 3 4
             ((void *)0) 
# 157 "../crypto/self_test_core.c"
                  && st->cb != 
# 157 "../crypto/self_test_core.c" 3 4
                               ((void *)0)
# 157 "../crypto/self_test_core.c"
