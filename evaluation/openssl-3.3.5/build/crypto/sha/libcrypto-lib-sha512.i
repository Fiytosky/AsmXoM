# 0 "../crypto/sha/sha512.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sha/sha512.c"
# 14 "../crypto/sha/sha512.c"
...
# 17 "../crypto/sha/sha512.c" 2
# 52 "../crypto/sha/sha512.c"
...
# 61 "../crypto/sha/sha512.c" 2
# 78 "../crypto/sha/sha512.c"
...
int SHA512_Update(SHA512_CTX *c, const void *_data, size_t len)
{
    ...
    if (l < c->Nl)
        c->Nh++;
    if (sizeof(len) >= 8)
        c->Nh += (((unsigned long long) len) >> 61);
    c->Nl = l;
