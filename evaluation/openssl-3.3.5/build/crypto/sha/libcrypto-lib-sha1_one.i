# 0 "../crypto/sha/sha1_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sha/sha1_one.c"
# 14 "../crypto/sha/sha1_one.c"
...
unsigned char *ossl_sha1(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 28 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 28 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    if (!SHA1_Init(&c))
        return 
# 31 "../crypto/sha/sha1_one.c" 3 4
              ((void *)0)
# 31 "../crypto/sha/sha1_one.c"
                  ;
    SHA1_Update(&c, d, n);
    SHA1_Final(md, &c);
...
unsigned char *SHA1(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 42 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 42 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    return EVP_Q_digest(
# 44 "../crypto/sha/sha1_one.c" 3 4
                       ((void *)0)
# 44 "../crypto/sha/sha1_one.c"
                           , "SHA1", 
# 44 "../crypto/sha/sha1_one.c" 3 4
                                     ((void *)0)
# 44 "../crypto/sha/sha1_one.c"
...
unsigned char *SHA224(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 51 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 51 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    return EVP_Q_digest(
# 53 "../crypto/sha/sha1_one.c" 3 4
                       ((void *)0)
# 53 "../crypto/sha/sha1_one.c"
                           , "SHA224", 
# 53 "../crypto/sha/sha1_one.c" 3 4
                                       ((void *)0)
# 53 "../crypto/sha/sha1_one.c"
...
unsigned char *SHA256(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 60 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 60 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    return EVP_Q_digest(
# 62 "../crypto/sha/sha1_one.c" 3 4
                       ((void *)0)
# 62 "../crypto/sha/sha1_one.c"
                           , "SHA256", 
# 62 "../crypto/sha/sha1_one.c" 3 4
                                       ((void *)0)
# 62 "../crypto/sha/sha1_one.c"
...
unsigned char *SHA384(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 69 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 69 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    return EVP_Q_digest(
# 71 "../crypto/sha/sha1_one.c" 3 4
                       ((void *)0)
# 71 "../crypto/sha/sha1_one.c"
                           , "SHA384", 
# 71 "../crypto/sha/sha1_one.c" 3 4
                                       ((void *)0)
# 71 "../crypto/sha/sha1_one.c"
...
unsigned char *SHA512(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 78 "../crypto/sha/sha1_one.c" 3 4
             ((void *)0)
# 78 "../crypto/sha/sha1_one.c"
                 )
        md = m;
    return EVP_Q_digest(
# 80 "../crypto/sha/sha1_one.c" 3 4
                       ((void *)0)
# 80 "../crypto/sha/sha1_one.c"
                           , "SHA512", 
# 80 "../crypto/sha/sha1_one.c" 3 4
                                       ((void *)0)
# 80 "../crypto/sha/sha1_one.c"
