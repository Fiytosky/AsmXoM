# 0 "../crypto/sha/sha256.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sha/sha256.c"
# 14 "../crypto/sha/sha256.c"
...
int SHA256_Final(unsigned char *md, SHA256_CTX *c)
{
    ...
    do { unsigned long ll; unsigned int nn; switch ((c)->md_len) { case 24: for (nn=0;nn<24/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; case 28: for (nn=0;nn<28/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; case 32: for (nn=0;nn<32/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; default: if ((c)->md_len > 32) return 0; for (nn=0;nn<(c)->md_len/4;nn++) { ll=(c)->h[nn]; (void)(*(((md))++)=(unsigned char)(((ll)>>24)&0xff), *(((md))++)=(unsigned char)(((ll)>>16)&0xff), *(((md))++)=(unsigned char)(((ll)>> 8)&0xff), *(((md))++)=(unsigned char)(((ll) )&0xff), ll); } break; } } while (0);


    return 1;
}
# 127 "../crypto/sha/sha256.c" 2
