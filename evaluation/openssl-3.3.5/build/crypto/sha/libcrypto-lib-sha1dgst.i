# 0 "../crypto/sha/sha1dgst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/sha/sha1dgst.c"
# 14 "../crypto/sha/sha1dgst.c"
...
# 22 "../crypto/sha/sha1dgst.c" 2



# 1 "../crypto/sha/sha_local.h" 1
# 11 "../crypto/sha/sha_local.h"
...
# 16 "../crypto/sha/sha_local.h" 2
# 43 "../crypto/sha/sha_local.h"
...
int ossl_sha1_ctrl(SHA_CTX *sha1, int cmd, int mslen, void *ms)
{
    ...
    if (sha1 == 
# 36 "../crypto/sha/sha1dgst.c" 3 4
               ((void *)0)
# 36 "../crypto/sha/sha1dgst.c"
                   )
        return 0;
