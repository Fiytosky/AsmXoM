# 0 "../crypto/engine/tb_pkmeth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/tb_pkmeth.c"
# 11 "../crypto/engine/tb_pkmeth.c"
...
# 12 "../crypto/engine/tb_pkmeth.c" 2
...
# 14 "../crypto/engine/tb_pkmeth.c" 2


static ENGINE_TABLE *pkey_meth_table = 
# 16 "../crypto/engine/tb_pkmeth.c" 3 4
                                      ((void *)0)
# 16 "../crypto/engine/tb_pkmeth.c"
                                          ;
...
# 32 "../crypto/engine/tb_pkmeth.c" 3 4
                                       ((void *)0)
# 32 "../crypto/engine/tb_pkmeth.c"
                                           , &nids, 0);
        if (num_nids > 0)
...
int ENGINE_set_default_pkey_meths(ENGINE *e)
{
    if (e->pkey_meths) {
        const int *nids;
        int num_nids = e->pkey_meths(e, 
# 53 "../crypto/engine/tb_pkmeth.c" 3 4
                                       ((void *)0)
# 53 "../crypto/engine/tb_pkmeth.c"
                                           , &nids, 0);
        if (num_nids > 0)
            return engine_table_register(&pkey_meth_table,
                                         engine_unregister_all_pkey_meths, e,
...
const EVP_PKEY_METHOD *ENGINE_get_pkey_meth(ENGINE *e, int nid)
{
    ...
    if (!fn || !fn(e, &ret, 
# 78 "../crypto/engine/tb_pkmeth.c" 3 4
                           ((void *)0)
# 78 "../crypto/engine/tb_pkmeth.c"
                               , nid)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/tb_pkmeth.c",79,__func__), ERR_set_error)((38),(101),
# 79 "../crypto/engine/tb_pkmeth.c" 3 4
       ((void *)0)
# 79 "../crypto/engine/tb_pkmeth.c"
       );
        return 
# 80 "../crypto/engine/tb_pkmeth.c" 3 4
              ((void *)0)
# 80 "../crypto/engine/tb_pkmeth.c"
                  ;
    }
    return ret;
}
...
# 110 "../crypto/engine/tb_pkmeth.c" 3 4
                                  ((void *)0)
# 110 "../crypto/engine/tb_pkmeth.c"
                                      , &pknids, 0);
        for (i = 0; i < npknids; i++) {
            if (e->pkey_meths(e, &pkm, 
# 112 "../crypto/engine/tb_pkmeth.c" 3 4
                                      ((void *)0)
# 112 "../crypto/engine/tb_pkmeth.c"
                                          , pknids[i])) {
