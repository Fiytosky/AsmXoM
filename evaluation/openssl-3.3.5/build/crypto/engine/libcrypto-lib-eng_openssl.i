# 0 "../crypto/engine/eng_openssl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_openssl.c"
# 18 "../crypto/engine/eng_openssl.c"
...
# 19 "../crypto/engine/eng_openssl.c" 2
...
# 21 "../crypto/engine/eng_openssl.c" 2
...
# 22 "../crypto/engine/eng_openssl.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 23 "../crypto/engine/eng_openssl.c" 2
...
# 24 "../crypto/engine/eng_openssl.c" 2
...
# 32 "../crypto/engine/eng_openssl.c" 2
...
# 33 "../crypto/engine/eng_openssl.c" 2
# 64 "../crypto/engine/eng_openssl.c"
...
static EVP_PKEY *openssl_load_privkey(ENGINE *eng, const char *key_id,
                                      UI_METHOD *ui_method,
                                      void *callback_data);
# 88 "../crypto/engine/eng_openssl.c"
...
static ENGINE *engine_openssl(void)
{
    ...
    if (ret == 
# 139 "../crypto/engine/eng_openssl.c" 3 4
              ((void *)0)
# 139 "../crypto/engine/eng_openssl.c"
                  )
        return 
# 140 "../crypto/engine/eng_openssl.c" 3 4
              ((void *)0)
# 140 "../crypto/engine/eng_openssl.c"
                  ;
    if (!bind_helper(ret)) {
        ENGINE_free(ret);
        return 
# 143 "../crypto/engine/eng_openssl.c" 3 4
              ((void *)0)
# 143 "../crypto/engine/eng_openssl.c"
                  ;
    }
    return ret;
}
...
# 198 "../crypto/engine/eng_openssl.c"
# 1 "../include/openssl/rc4.h" 1
# 12 "../include/openssl/rc4.h"
        
# 22 "../include/openssl/rc4.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 23 "../include/openssl/rc4.h" 2
...
extern const char *RC4_options(void);
extern void RC4_set_key(RC4_KEY *key, int len,
                                       const unsigned char *data);
extern void RC4(RC4_KEY *key, size_t len,
                               const unsigned char *indata,
                               unsigned char *outdata);
# 199 "../crypto/engine/eng_openssl.c" 2
                             ...
                             const unsigned char *iv, int enc)
{
    ...
    fprintf(
# 211 "../crypto/engine/eng_openssl.c" 3 4
           stderr
# 211 "../crypto/engine/eng_openssl.c"
                 , "(TEST_ENG_OPENSSL_RC4) test_init_key() called\n");

    if (n <= 0)
        return n;
    memcpy(&((TEST_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->key[0], key, n);
    RC4_set_key(&((TEST_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, n, ((TEST_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->key);
    return 1;
}
                           ...
                           const unsigned char *in, size_t inl)
{
    ...
    RC4(&((TEST_RC4_KEY *)EVP_CIPHER_CTX_get_cipher_data(ctx))->ks, inl, in, out);
    return 1;
}

static EVP_CIPHER *r4_cipher = 
# 230 "../crypto/engine/eng_openssl.c" 3 4
                              ((void *)0)
# 230 "../crypto/engine/eng_openssl.c"
                                  ;
static const EVP_CIPHER *test_r4_cipher(void)
{
    if (r4_cipher == 
# 233 "../crypto/engine/eng_openssl.c" 3 4
                    ((void *)0)
# 233 "../crypto/engine/eng_openssl.c"
                        ) {
        EVP_CIPHER *cipher;

        if ((cipher = EVP_CIPHER_meth_new(5, 1, 16)) == 
# 236 "../crypto/engine/eng_openssl.c" 3 4
                                                                            ((void *)0)
            
# 237 "../crypto/engine/eng_openssl.c"
           || !EVP_CIPHER_meth_set_iv_length(cipher, 0)
            || !EVP_CIPHER_meth_set_flags(cipher, 0x8)
            ...
            cipher = 
# 243 "../crypto/engine/eng_openssl.c" 3 4
                    ((void *)0)
# 243 "../crypto/engine/eng_openssl.c"
                        ;
        }
        r4_cipher = cipher;
    }
...
static void test_r4_cipher_destroy(void)
{
    ...
    r4_cipher = 
# 252 "../crypto/engine/eng_openssl.c" 3 4
               ((void *)0)
# 252 "../crypto/engine/eng_openssl.c"
                   ;
}

static EVP_CIPHER *r4_40_cipher = 
# 255 "../crypto/engine/eng_openssl.c" 3 4
                                 ((void *)0)
# 255 "../crypto/engine/eng_openssl.c"
                                     ;
static const EVP_CIPHER *test_r4_40_cipher(void)
{
    if (r4_40_cipher == 
# 258 "../crypto/engine/eng_openssl.c" 3 4
                       ((void *)0)
# 258 "../crypto/engine/eng_openssl.c"
                           ) {
        EVP_CIPHER *cipher;

        if ((cipher = EVP_CIPHER_meth_new(5, 1, 5 )) == 
# 261 "../crypto/engine/eng_openssl.c" 3 4
                                                                          ((void *)0)
            
# 262 "../crypto/engine/eng_openssl.c"
           || !EVP_CIPHER_meth_set_iv_length(cipher, 0)
            || !EVP_CIPHER_meth_set_flags(cipher, 0x8)
            || !EVP_CIPHER_meth_set_init(cipher, test_rc4_init_key)
            || !EVP_CIPHER_meth_set_do_cipher(cipher, test_rc4_cipher)
            ...
            EVP_CIPHER_meth_free(cipher);
            cipher = 
# 268 "../crypto/engine/eng_openssl.c" 3 4
                    ((void *)0)
# 268 "../crypto/engine/eng_openssl.c"
                        ;
        }
        r4_40_cipher = cipher;
    }
...
static void test_r4_40_cipher_destroy(void)
{
    ...
    r4_40_cipher = 
# 277 "../crypto/engine/eng_openssl.c" 3 4
                  ((void *)0)
# 277 "../crypto/engine/eng_openssl.c"
                      ;
}
static int test_cipher_nids(const int **nids)
{
    ...
    if (!init) {
        const EVP_CIPHER *cipher;
        if ((cipher = test_r4_cipher()) != 
# 287 "../crypto/engine/eng_openssl.c" 3 4
                                          ((void *)0)
# 287 "../crypto/engine/eng_openssl.c"
                                              )
            cipher_nids[pos++] = EVP_CIPHER_get_nid(cipher);
        if ((cipher = test_r4_40_cipher()) != 
# 289 "../crypto/engine/eng_openssl.c" 3 4
                                             ((void *)0)
# 289 "../crypto/engine/eng_openssl.c"
                                                 )
            cipher_nids[pos++] = EVP_CIPHER_get_nid(cipher);
        cipher_nids[pos] = 0;
        init = 1;
                           ...
                           const int **nids, int nid)
{
    ...
    if (nid == 5)
        ...
        *cipher = 
# 315 "../crypto/engine/eng_openssl.c" 3 4
                 ((void *)0)
# 315 "../crypto/engine/eng_openssl.c"
                     ;
        return 0;
    }
    return 1;
...
# 350 "../crypto/engine/eng_openssl.c" 3 4
                        ((void *)0)
# 350 "../crypto/engine/eng_openssl.c"
                            ;
static const EVP_MD *test_sha_md(void)
{
    if (sha1_md == 
# 353 "../crypto/engine/eng_openssl.c" 3 4
                  ((void *)0)
# 353 "../crypto/engine/eng_openssl.c"
                      ) {
        EVP_MD *md;

        if ((md = EVP_MD_meth_new(64, 65)) == 
# 356 "../crypto/engine/eng_openssl.c" 3 4
                                                                          ((void *)0)
            
# 357 "../crypto/engine/eng_openssl.c"
           || !EVP_MD_meth_set_result_size(md, 20)
            || !EVP_MD_meth_set_input_blocksize(md, (16*4))
            ...
            EVP_MD_meth_free(md);
            md = 
# 366 "../crypto/engine/eng_openssl.c" 3 4
                ((void *)0)
# 366 "../crypto/engine/eng_openssl.c"
                    ;
        }
        sha1_md = md;
    }
...
static void test_sha_md_destroy(void)
{
    ...
    sha1_md = 
# 375 "../crypto/engine/eng_openssl.c" 3 4
             ((void *)0)
# 375 "../crypto/engine/eng_openssl.c"
                 ;
}
static int test_digest_nids(const int **nids)
{
    ...
    if (!init) {
        const EVP_MD *md;
        if ((md = test_sha_md()) != 
# 385 "../crypto/engine/eng_openssl.c" 3 4
                                   ((void *)0)
# 385 "../crypto/engine/eng_openssl.c"
                                       )
                           ...
                           const int **nids, int nid)
{
    ...
    if (nid == 64)
        ...
        *digest = 
# 409 "../crypto/engine/eng_openssl.c" 3 4
                 ((void *)0)
# 409 "../crypto/engine/eng_openssl.c"
                     ;
        return 0;
    }
    return 1;
                                      ...
                                      void *callback_data)
{
    ...
    EVP_PKEY *key;
    fprintf(
# 423 "../crypto/engine/eng_openssl.c" 3 4
           stderr
# 423 "../crypto/engine/eng_openssl.c"
                 , "(TEST_ENG_OPENSSL_PKEY)Loading Private key %s\n",
            key_id);
    in = BIO_new_file(key_id, "r");
    if (!in)
        return 
# 427 "../crypto/engine/eng_openssl.c" 3 4
              ((void *)0)
# 427 "../crypto/engine/eng_openssl.c"
                  ;
    key = PEM_read_bio_PrivateKey(in, 
# 428 "../crypto/engine/eng_openssl.c" 3 4
                                     ((void *)0)
# 428 "../crypto/engine/eng_openssl.c"
                                         , 0, 
# 428 "../crypto/engine/eng_openssl.c" 3 4
                                              ((void *)0)
# 428 "../crypto/engine/eng_openssl.c"
...
# 657 "../crypto/engine/eng_openssl.c"
