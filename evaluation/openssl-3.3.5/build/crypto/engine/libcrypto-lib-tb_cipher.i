# 0 "../crypto/engine/tb_cipher.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/tb_cipher.c"
# 13 "../crypto/engine/tb_cipher.c"
...
# 14 "../crypto/engine/tb_cipher.c" 2

static ENGINE_TABLE *cipher_table = 
# 15 "../crypto/engine/tb_cipher.c" 3 4
                                   ((void *)0)
# 15 "../crypto/engine/tb_cipher.c"
                                       ;
...
# 31 "../crypto/engine/tb_cipher.c" 3 4
                                    ((void *)0)
# 31 "../crypto/engine/tb_cipher.c"
                                        , &nids, 0);
        if (num_nids > 0)
...
int ENGINE_set_default_ciphers(ENGINE *e)
{
    if (e->ciphers) {
        const int *nids;
        int num_nids = e->ciphers(e, 
# 52 "../crypto/engine/tb_cipher.c" 3 4
                                    ((void *)0)
# 52 "../crypto/engine/tb_cipher.c"
                                        , &nids, 0);
        if (num_nids > 0)
            return engine_table_register(&cipher_table,
                                         engine_unregister_all_ciphers, e,
...
const EVP_CIPHER *ENGINE_get_cipher(ENGINE *e, int nid)
{
    ...
    if (!fn || !fn(e, &ret, 
# 77 "../crypto/engine/tb_cipher.c" 3 4
                           ((void *)0)
# 77 "../crypto/engine/tb_cipher.c"
                               , nid)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/tb_cipher.c",78,__func__), ERR_set_error)((38),(146),
# 78 "../crypto/engine/tb_cipher.c" 3 4
       ((void *)0)
# 78 "../crypto/engine/tb_cipher.c"
       );
        return 
# 79 "../crypto/engine/tb_cipher.c" 3 4
              ((void *)0)
# 79 "../crypto/engine/tb_cipher.c"
                  ;
    }
    return ret;
}
