# 0 "../crypto/engine/eng_fat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_fat.c"
# 14 "../crypto/engine/eng_fat.c"
...
int ENGINE_set_default(ENGINE *e, unsigned int flags)
{
    ...
    if ((flags & (unsigned int)0x0800) && !ENGINE_set_default_EC(e))
        return 0;
...
static int int_def_cb(const char *alg, int len, void *arg)
{
    ...
    if (alg == 
# 53 "../crypto/engine/eng_fat.c" 3 4
              ((void *)0)
# 53 "../crypto/engine/eng_fat.c"
                  )
        return 0;
    if (strncmp(alg, "ALL", len) == 0)
        ...
        *pflags |= (unsigned int)0x0200 | (unsigned int)0x0400;
...
int ENGINE_set_default_string(ENGINE *e, const char *def_list)
{
    ...
    if (!CONF_parse_list(def_list, ',', 1, int_def_cb, &flags)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_fat.c",86,__func__), ERR_set_error)(38, 150,
                       "str=%s", def_list);
        return 0;
    }
