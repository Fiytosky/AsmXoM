# 0 "../crypto/engine/tb_asnmth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/tb_asnmth.c"
# 13 "../crypto/engine/tb_asnmth.c"
...
# 14 "../crypto/engine/tb_asnmth.c" 2
...
# 15 "../crypto/engine/tb_asnmth.c" 2
...
# 17 "../crypto/engine/tb_asnmth.c" 2
# 26 "../crypto/engine/tb_asnmth.c"
static ENGINE_TABLE *pkey_asn1_meth_table = 
# 26 "../crypto/engine/tb_asnmth.c" 3 4
                                           ((void *)0)
# 26 "../crypto/engine/tb_asnmth.c"
                                               ;
...
# 42 "../crypto/engine/tb_asnmth.c" 3 4
                                            ((void *)0)
# 42 "../crypto/engine/tb_asnmth.c"
                                                , &nids, 0);
        if (num_nids > 0)
...
int ENGINE_set_default_pkey_asn1_meths(ENGINE *e)
{
    if (e->pkey_asn1_meths) {
        const int *nids;
        int num_nids = e->pkey_asn1_meths(e, 
# 63 "../crypto/engine/tb_asnmth.c" 3 4
                                            ((void *)0)
# 63 "../crypto/engine/tb_asnmth.c"
                                                , &nids, 0);
        if (num_nids > 0)
            return engine_table_register(&pkey_asn1_meth_table,
                                         engine_unregister_all_pkey_asn1_meths,
...
const EVP_PKEY_ASN1_METHOD *ENGINE_get_pkey_asn1_meth(ENGINE *e, int nid)
{
    ...
    if (!fn || !fn(e, &ret, 
# 91 "../crypto/engine/tb_asnmth.c" 3 4
                           ((void *)0)
# 91 "../crypto/engine/tb_asnmth.c"
                               , nid)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/tb_asnmth.c",92,__func__), ERR_set_error)((38),(101),
# 92 "../crypto/engine/tb_asnmth.c" 3 4
       ((void *)0)
# 92 "../crypto/engine/tb_asnmth.c"
       );
        return 
# 93 "../crypto/engine/tb_asnmth.c" 3 4
              ((void *)0)
# 93 "../crypto/engine/tb_asnmth.c"
                  ;
    }
    return ret;
}
...
# 123 "../crypto/engine/tb_asnmth.c" 3 4
                                       ((void *)0)
# 123 "../crypto/engine/tb_asnmth.c"
                                           , &pknids, 0);
        for (i = 0; i < npknids; i++) {
            if (e->pkey_asn1_meths(e, &pkm, 
# 125 "../crypto/engine/tb_asnmth.c" 3 4
                                           ((void *)0)
# 125 "../crypto/engine/tb_asnmth.c"
                                               , pknids[i])) {
                                                          ...
                                                          int len)
{
    ...
    if (!e->pkey_asn1_meths)
        return 
# 147 "../crypto/engine/tb_asnmth.c" 3 4
              ((void *)0)
# 147 "../crypto/engine/tb_asnmth.c"
                  ;
    if (len == -1)
        len = strlen(str);
    nidcount = e->pkey_asn1_meths(e, 
# 150 "../crypto/engine/tb_asnmth.c" 3 4
                                    ((void *)0)
# 150 "../crypto/engine/tb_asnmth.c"
                                        , &nids, 0);
    for (i = 0; i < nidcount; i++) {
        e->pkey_asn1_meths(e, &ameth, 
# 152 "../crypto/engine/tb_asnmth.c" 3 4
                                     ((void *)0)
# 152 "../crypto/engine/tb_asnmth.c"
                                         , nids[i]);
        if (ameth != 
# 153 "../crypto/engine/tb_asnmth.c" 3 4
                    ((void *)0)
            
# 154 "../crypto/engine/tb_asnmth.c"
           && ((int)strlen(ameth->pem_str) == len)
            && OPENSSL_strncasecmp(ameth->pem_str, str, len) == 0)
            return ameth;
    }
    return 
# 158 "../crypto/engine/tb_asnmth.c" 3 4
          ((void *)0)
# 158 "../crypto/engine/tb_asnmth.c"
              ;
}
...
static void look_str_cb(int nid, struct stack_st_ENGINE *sk, ENGINE *def, void *arg)
{
    ...
    for (i = 0; i < sk_ENGINE_num(sk); i++) {
        ...
        EVP_PKEY_ASN1_METHOD *ameth;
        e->pkey_asn1_meths(e, &ameth, 
# 177 "../crypto/engine/tb_asnmth.c" 3 4
                                     ((void *)0)
# 177 "../crypto/engine/tb_asnmth.c"
                                         , nid);
        if (ameth != 
# 178 "../crypto/engine/tb_asnmth.c" 3 4
                    ((void *)0)
                
# 179 "../crypto/engine/tb_asnmth.c"
                                                      ...
                                                      int len)
{
    ...
    fstr.e = 
# 193 "../crypto/engine/tb_asnmth.c" 3 4
            ((void *)0)
# 193 "../crypto/engine/tb_asnmth.c"
                ;
    fstr.ameth = 
# 194 "../crypto/engine/tb_asnmth.c" 3 4
                ((void *)0)
# 194 "../crypto/engine/tb_asnmth.c"
                    ;
    fstr.str = str;
    fstr.len = len;
    ...
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/engine/tb_asnmth.c",200,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 200 "../crypto/engine/tb_asnmth.c" 3 4
       ((void *)0)
# 200 "../crypto/engine/tb_asnmth.c"
       );
        return 
# 201 "../crypto/engine/tb_asnmth.c" 3 4
              ((void *)0)
# 201 "../crypto/engine/tb_asnmth.c"
                  ;
    }

    if (!CRYPTO_THREAD_read_lock(global_engine_lock))
        return 
# 205 "../crypto/engine/tb_asnmth.c" 3 4
              ((void *)0)
# 205 "../crypto/engine/tb_asnmth.c"
                  ;
    engine_table_doall(pkey_asn1_meth_table, look_str_cb, &fstr);

    if (fstr.e != 
# 208 "../crypto/engine/tb_asnmth.c" 3 4
                 ((void *)0)
# 208 "../crypto/engine/tb_asnmth.c"
                     ) {
        int ref;

        if (!CRYPTO_UP_REF(&fstr.e->struct_ref, &ref)) {
            CRYPTO_THREAD_unlock(global_engine_lock);
            (ERR_new(), ERR_set_debug("../crypto/engine/tb_asnmth.c",213,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 213 "../crypto/engine/tb_asnmth.c" 3 4
           ((void *)0)
# 213 "../crypto/engine/tb_asnmth.c"
           );
            return 
# 214 "../crypto/engine/tb_asnmth.c" 3 4
                  ((void *)0)
# 214 "../crypto/engine/tb_asnmth.c"
                      ;
        }
        ((void)0);
    }
