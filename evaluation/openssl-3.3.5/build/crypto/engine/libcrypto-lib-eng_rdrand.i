# 0 "../crypto/engine/eng_rdrand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_rdrand.c"
# 13 "../crypto/engine/eng_rdrand.c"
...
# 14 "../crypto/engine/eng_rdrand.c" 2
...
# 16 "../crypto/engine/eng_rdrand.c" 2
...
# 17 "../crypto/engine/eng_rdrand.c" 2
...
# 18 "../crypto/engine/eng_rdrand.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 19 "../crypto/engine/eng_rdrand.c" 2
# 33 "../crypto/engine/eng_rdrand.c"
...
# 60 "../crypto/engine/eng_rdrand.c" 3 4
   ((void *)0)
# 60 "../crypto/engine/eng_rdrand.c"
       ,
    get_random_bytes,
    
# 62 "../crypto/engine/eng_rdrand.c" 3 4
   ((void *)0)
# 62 "../crypto/engine/eng_rdrand.c"
       ,
    
# 63 "../crypto/engine/eng_rdrand.c" 3 4
   ((void *)0)
# 63 "../crypto/engine/eng_rdrand.c"
       ,
    get_random_bytes,
    random_status,
};
...
static ENGINE *ENGINE_rdrand(void)
{
    ...
    if (ret == 
# 91 "../crypto/engine/eng_rdrand.c" 3 4
              ((void *)0)
# 91 "../crypto/engine/eng_rdrand.c"
                  )
        return 
# 92 "../crypto/engine/eng_rdrand.c" 3 4
              ((void *)0)
# 92 "../crypto/engine/eng_rdrand.c"
                  ;
    if (!bind_helper(ret)) {
        ENGINE_free(ret);
        return 
# 95 "../crypto/engine/eng_rdrand.c" 3 4
              ((void *)0)
# 95 "../crypto/engine/eng_rdrand.c"
                  ;
    }
    return ret;
}
