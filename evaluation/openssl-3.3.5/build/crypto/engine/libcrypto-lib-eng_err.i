# 0 "../crypto/engine/eng_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_err.c"
# 11 "../crypto/engine/eng_err.c"
...
static const ERR_STRING_DATA ENGINE_str_reasons[] = {
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "already loaded"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ),
    "argument is not a number"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ),
    "cmd not executable"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ),
    "command takes input"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "command takes no input"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "conflicting engine id"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "ctrl command not implemented"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "DSO failure"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ), "dso not found"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(148) & 0X7FFFFF)) ),
    "engines section error"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "engine configuration error"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "engine is not in the list"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(149) & 0X7FFFFF)) ),
    "engine section error"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "failed loading private key"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "failed loading public key"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "finish failed"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "'id' or 'name' missing"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "init failed"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "internal list error"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ),
    "invalid argument"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ),
    "invalid cmd name"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ),
    "invalid cmd number"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(151) & 0X7FFFFF)) ),
    "invalid init value"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ), "invalid string"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ), "not initialised"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "not loaded"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "no control function"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ), "no index"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "no load function"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ), "no reference"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ), "no such engine"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(146) & 0X7FFFFF)) ),
    "unimplemented cipher"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(147) & 0X7FFFFF)) ),
    "unimplemented digest"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ),
    "unimplemented public key method"},
    {( (((unsigned long)(38) & 0xFF ) << 23L) | (((unsigned long)(145) & 0X7FFFFF)) ),
    "version incompatibility"},
    {0, 
# 79 "../crypto/engine/eng_err.c" 3 4
       ((void *)0)
# 79 "../crypto/engine/eng_err.c"
           }
};
...
int ossl_err_load_ENGINE_strings(void)
{
    ...
    if (ERR_reason_error_string(ENGINE_str_reasons[0].error) == 
# 87 "../crypto/engine/eng_err.c" 3 4
                                                               ((void *)0)
# 87 "../crypto/engine/eng_err.c"
                                                                   )
