# 0 "../crypto/engine/eng_cnf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_cnf.c"
# 13 "../crypto/engine/eng_cnf.c"
...
static const char *skip_dot(const char *name)
{
    ...
    if (p != 
# 23 "../crypto/engine/eng_cnf.c" 3 4
            ((void *)0)
# 23 "../crypto/engine/eng_cnf.c"
                )
        return p + 1;
    return name;
}
...
# 28 "../crypto/engine/eng_cnf.c" 3 4
                                              ((void *)0)
# 28 "../crypto/engine/eng_cnf.c"
                                                  ;
...
static int int_engine_configure(const char *name, const char *value, const CONF *cnf)
{
    ...
    CONF_VALUE *ecmd = 
# 49 "../crypto/engine/eng_cnf.c" 3 4
                      ((void *)0)
# 49 "../crypto/engine/eng_cnf.c"
                          ;
    const char *ctrlname, *ctrlvalue;
    ENGINE *e = 
# 51 "../crypto/engine/eng_cnf.c" 3 4
               ((void *)0)
# 51 "../crypto/engine/eng_cnf.c"
                   ;
    int soft = 0;
    ...
    if (!ecmds) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_cnf.c",60,__func__), ERR_set_error)((38),(149),
# 60 "../crypto/engine/eng_cnf.c" 3 4
       ((void *)0)
# 60 "../crypto/engine/eng_cnf.c"
       );
        return 0;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(ecmds)); i++) {
        ecmd = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(ecmds), (i)));
...
# 87 "../crypto/engine/eng_cnf.c" 3 4
                                                  ((void *)0)
# 87 "../crypto/engine/eng_cnf.c"
                                                      , 0))
                goto err;
        }
            ...
            if (strcmp(ctrlvalue, "EMPTY") == 0)
                ctrlvalue = 
# 110 "../crypto/engine/eng_cnf.c" 3 4
                           ((void *)0)
# 110 "../crypto/engine/eng_cnf.c"
                               ;
            if (strcmp(ctrlname, "init") == 0) {
                ...
                if (do_init == 1) {
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/engine/eng_cnf.c",118,__func__), ERR_set_error)((38),(151),
# 118 "../crypto/engine/eng_cnf.c" 3 4
                   ((void *)0)
# 118 "../crypto/engine/eng_cnf.c"
                   );
                    goto err;
                }
    ...
    if (e && (do_init == -1) && !int_engine_init(e)) {
        ecmd = 
# 130 "../crypto/engine/eng_cnf.c" 3 4
              ((void *)0)
# 130 "../crypto/engine/eng_cnf.c"
                  ;
        goto err;
    }
    ret = 1;
 err:
    if (ret != 1) {
        if (ecmd == 
# 136 "../crypto/engine/eng_cnf.c" 3 4
                   ((void *)0)
# 136 "../crypto/engine/eng_cnf.c"
                       )
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_cnf.c",137,__func__), ERR_set_error)((38),(102),
# 137 "../crypto/engine/eng_cnf.c" 3 4
           ((void *)0)
# 137 "../crypto/engine/eng_cnf.c"
           );
        else
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_cnf.c",139,__func__), ERR_set_error)(38, 102,
...
static int int_engine_module_init(CONF_IMODULE *md, const CONF *cnf)
{
    ...
    if (!elist) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_cnf.c",158,__func__), ERR_set_error)((38),(148),
# 158 "../crypto/engine/eng_cnf.c" 3 4
       ((void *)0)
# 158 "../crypto/engine/eng_cnf.c"
       );
        return 0;
    }

    for (i = 0; i < OPENSSL_sk_num(ossl_check_const_CONF_VALUE_sk_type(elist)); i++) {
        cval = ((CONF_VALUE *)OPENSSL_sk_value(ossl_check_const_CONF_VALUE_sk_type(elist), (i)));
...
static void int_engine_module_finish(CONF_IMODULE *md)
{
    ...
    initialized_engines = 
# 178 "../crypto/engine/eng_cnf.c" 3 4
                         ((void *)0)
# 178 "../crypto/engine/eng_cnf.c"
                             ;
}
