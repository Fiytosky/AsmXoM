# 0 "../crypto/engine/eng_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_lib.c"
# 10 "../crypto/engine/eng_lib.c"
...
# 17 "../crypto/engine/eng_lib.c" 3 4
                              0
# 17 "../crypto/engine/eng_lib.c"
                                                     ;



static int do_engine_lock_init(void); int do_engine_lock_init_ossl_ret_ = 0; void do_engine_lock_init_ossl_(void) { do_engine_lock_init_ossl_ret_ = do_engine_lock_init(); } static int do_engine_lock_init(void)
{
    global_engine_lock = CRYPTO_THREAD_lock_new();
    return global_engine_lock != 
# 24 "../crypto/engine/eng_lib.c" 3 4
                                ((void *)0)
# 24 "../crypto/engine/eng_lib.c"
                                    ;
}
...
ENGINE *ENGINE_new(void)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_lib.c",33,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 33 "../crypto/engine/eng_lib.c" 3 4
       ((void *)0)
# 33 "../crypto/engine/eng_lib.c"
       );
        return 0;
    }
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/engine/eng_lib.c", 36)) == 
# 36 "../crypto/engine/eng_lib.c" 3 4
                                               ((void *)0)
# 36 "../crypto/engine/eng_lib.c"
                                                   )
        return 
# 37 "../crypto/engine/eng_lib.c" 3 4
              ((void *)0)
# 37 "../crypto/engine/eng_lib.c"
                  ;
    if (!CRYPTO_NEW_REF(&ret->struct_ref, 1)) {
        CRYPTO_free(ret, "../crypto/engine/eng_lib.c", 39);
        return 
# 40 "../crypto/engine/eng_lib.c" 3 4
              ((void *)0)
# 40 "../crypto/engine/eng_lib.c"
                  ;
    }
    ((void)0);
    if (!CRYPTO_new_ex_data(10, ret, &ret->ex_data)) {
        CRYPTO_FREE_REF(&ret->struct_ref);
        CRYPTO_free(ret, "../crypto/engine/eng_lib.c", 45);
        return 
# 46 "../crypto/engine/eng_lib.c" 3 4
              ((void *)0)
# 46 "../crypto/engine/eng_lib.c"
                  ;
    }
    return ret;
}
...
{
    e->id = 
# 58 "../crypto/engine/eng_lib.c" 3 4
           ((void *)0)
# 58 "../crypto/engine/eng_lib.c"
               ;
    e->name = 
# 59 "../crypto/engine/eng_lib.c" 3 4
             ((void *)0)
# 59 "../crypto/engine/eng_lib.c"
                 ;
    e->rsa_meth = 
# 60 "../crypto/engine/eng_lib.c" 3 4
                 ((void *)0)
# 60 "../crypto/engine/eng_lib.c"
                     ;
    e->dsa_meth = 
# 61 "../crypto/engine/eng_lib.c" 3 4
                 ((void *)0)
# 61 "../crypto/engine/eng_lib.c"
                     ;
    e->dh_meth = 
# 62 "../crypto/engine/eng_lib.c" 3 4
                ((void *)0)
# 62 "../crypto/engine/eng_lib.c"
                    ;
    e->rand_meth = 
# 63 "../crypto/engine/eng_lib.c" 3 4
                  ((void *)0)
# 63 "../crypto/engine/eng_lib.c"
                      ;
    e->ciphers = 
# 64 "../crypto/engine/eng_lib.c" 3 4
                ((void *)0)
# 64 "../crypto/engine/eng_lib.c"
                    ;
    e->digests = 
# 65 "../crypto/engine/eng_lib.c" 3 4
                ((void *)0)
# 65 "../crypto/engine/eng_lib.c"
                    ;
    e->destroy = 
# 66 "../crypto/engine/eng_lib.c" 3 4
                ((void *)0)
# 66 "../crypto/engine/eng_lib.c"
                    ;
    e->init = 
# 67 "../crypto/engine/eng_lib.c" 3 4
             ((void *)0)
# 67 "../crypto/engine/eng_lib.c"
                 ;
    e->finish = 
# 68 "../crypto/engine/eng_lib.c" 3 4
               ((void *)0)
# 68 "../crypto/engine/eng_lib.c"
                   ;
    e->ctrl = 
# 69 "../crypto/engine/eng_lib.c" 3 4
             ((void *)0)
# 69 "../crypto/engine/eng_lib.c"
                 ;
    e->load_privkey = 
# 70 "../crypto/engine/eng_lib.c" 3 4
                     ((void *)0)
# 70 "../crypto/engine/eng_lib.c"
                         ;
    e->load_pubkey = 
# 71 "../crypto/engine/eng_lib.c" 3 4
                    ((void *)0)
# 71 "../crypto/engine/eng_lib.c"
                        ;
    e->cmd_defns = 
# 72 "../crypto/engine/eng_lib.c" 3 4
                  ((void *)0)
# 72 "../crypto/engine/eng_lib.c"
                      ;
    e->flags = 0;
    e->dynamic_id = 
# 74 "../crypto/engine/eng_lib.c" 3 4
                   ((void *)0)
# 74 "../crypto/engine/eng_lib.c"
                       ;
}
...
int engine_free_util(ENGINE *e, int not_locked)
{
    ...
    if (e == 
# 81 "../crypto/engine/eng_lib.c" 3 4
            ((void *)0)
# 81 "../crypto/engine/eng_lib.c"
                )
        return 1;
    ...
    CRYPTO_free_ex_data(10, e, &e->ex_data);
    CRYPTO_FREE_REF(&e->struct_ref);
    CRYPTO_free(e, "../crypto/engine/eng_lib.c", 100);
    return 1;
}
...
# 117 "../crypto/engine/eng_lib.c"
static struct stack_st_ENGINE_CLEANUP_ITEM *cleanup_stack = 
# 117 "../crypto/engine/eng_lib.c" 3 4
                                                     ((void *)0)
# 117 "../crypto/engine/eng_lib.c"
                                                         ;
...
static ENGINE_CLEANUP_ITEM *int_cleanup_item(ENGINE_CLEANUP_CB *cb)
{
    ...
    if ((item = CRYPTO_malloc(sizeof(*item), "../crypto/engine/eng_lib.c", 132)) == 
# 132 "../crypto/engine/eng_lib.c" 3 4
                                                 ((void *)0)
# 132 "../crypto/engine/eng_lib.c"
                                                     )
        return 
# 133 "../crypto/engine/eng_lib.c" 3 4
              ((void *)0)
# 133 "../crypto/engine/eng_lib.c"
                  ;
    item->cb = cb;
    return item;
}
...
int engine_cleanup_add_first(ENGINE_CLEANUP_CB *cb)
{
    ...
    if (item != 
# 145 "../crypto/engine/eng_lib.c" 3 4
               ((void *)0)
# 145 "../crypto/engine/eng_lib.c"
                   ) {
        if (sk_ENGINE_CLEANUP_ITEM_insert(cleanup_stack, item, 0))
            return 1;
        CRYPTO_free(item, "../crypto/engine/eng_lib.c", 148);
    }
    return 0;
}
...
int engine_cleanup_add_last(ENGINE_CLEANUP_CB *cb)
{
    ...
    item = int_cleanup_item(cb);
    if (item != 
# 160 "../crypto/engine/eng_lib.c" 3 4
               ((void *)0)
# 160 "../crypto/engine/eng_lib.c"
                   ) {
        if (sk_ENGINE_CLEANUP_ITEM_push(cleanup_stack, item) > 0)
            return 1;
        CRYPTO_free(item, "../crypto/engine/eng_lib.c", 163);
    }
    return 0;
}
...
{
    (*(item->cb)) ();
    CRYPTO_free(item, "../crypto/engine/eng_lib.c", 172);
}
...
void engine_cleanup_int(void)
{
    if (int_cleanup_check(0)) {
        ...
        cleanup_stack = 
# 180 "../crypto/engine/eng_lib.c" 3 4
                       ((void *)0)
# 180 "../crypto/engine/eng_lib.c"
                           ;
    }
    CRYPTO_THREAD_lock_free(global_engine_lock);
    global_engine_lock = 
# 183 "../crypto/engine/eng_lib.c" 3 4
                        ((void *)0)
# 183 "../crypto/engine/eng_lib.c"
                            ;
}
...
{
    if (id == 
# 205 "../crypto/engine/eng_lib.c" 3 4
             ((void *)0)
# 205 "../crypto/engine/eng_lib.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_lib.c",206,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 206 "../crypto/engine/eng_lib.c" 3 4
       ((void *)0)
# 206 "../crypto/engine/eng_lib.c"
       );
        return 0;
    }
    e->id = id;
...
{
    if (name == 
# 215 "../crypto/engine/eng_lib.c" 3 4
               ((void *)0)
# 215 "../crypto/engine/eng_lib.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_lib.c",216,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 216 "../crypto/engine/eng_lib.c" 3 4
       ((void *)0)
# 216 "../crypto/engine/eng_lib.c"
       );
        return 0;
    }
    e->name = name;
