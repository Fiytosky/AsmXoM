# 0 "../crypto/engine/eng_pkey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_pkey.c"
# 13 "../crypto/engine/eng_pkey.c"
                                  ...
                                  UI_METHOD *ui_method, void *callback_data)
{
    ...
    if (e == 
# 61 "../crypto/engine/eng_pkey.c" 3 4
            ((void *)0)
# 61 "../crypto/engine/eng_pkey.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",62,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 62 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 62 "../crypto/engine/eng_pkey.c"
       );
        return 
# 63 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 63 "../crypto/engine/eng_pkey.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 66 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 66 "../crypto/engine/eng_pkey.c"
                  ;
    if (e->funct_ref == 0) {
        CRYPTO_THREAD_unlock(global_engine_lock);
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",69,__func__), ERR_set_error)((38),(117),
# 69 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 69 "../crypto/engine/eng_pkey.c"
       );
        return 
# 70 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 70 "../crypto/engine/eng_pkey.c"
                  ;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (!e->load_privkey) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",74,__func__), ERR_set_error)((38),(125),
# 74 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 74 "../crypto/engine/eng_pkey.c"
       );
        return 
# 75 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 75 "../crypto/engine/eng_pkey.c"
                  ;
    }
    pkey = e->load_privkey(e, key_id, ui_method, callback_data);
    if (pkey == 
# 78 "../crypto/engine/eng_pkey.c" 3 4
               ((void *)0)
# 78 "../crypto/engine/eng_pkey.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",79,__func__), ERR_set_error)((38),(128),
# 79 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 79 "../crypto/engine/eng_pkey.c"
       );
        return 
# 80 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 80 "../crypto/engine/eng_pkey.c"
                  ;
    }
    return pkey;
}
                                 ...
                                 UI_METHOD *ui_method, void *callback_data)
{
    ...
    if (e == 
# 90 "../crypto/engine/eng_pkey.c" 3 4
            ((void *)0)
# 90 "../crypto/engine/eng_pkey.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",91,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 91 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 91 "../crypto/engine/eng_pkey.c"
       );
        return 
# 92 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 92 "../crypto/engine/eng_pkey.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 95 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 95 "../crypto/engine/eng_pkey.c"
                  ;
    if (e->funct_ref == 0) {
        CRYPTO_THREAD_unlock(global_engine_lock);
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",98,__func__), ERR_set_error)((38),(117),
# 98 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 98 "../crypto/engine/eng_pkey.c"
       );
        return 
# 99 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 99 "../crypto/engine/eng_pkey.c"
                  ;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (!e->load_pubkey) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",103,__func__), ERR_set_error)((38),(125),
# 103 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 103 "../crypto/engine/eng_pkey.c"
       );
        return 
# 104 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 104 "../crypto/engine/eng_pkey.c"
                  ;
    }
    pkey = e->load_pubkey(e, key_id, ui_method, callback_data);
    if (pkey == 
# 107 "../crypto/engine/eng_pkey.c" 3 4
               ((void *)0)
# 107 "../crypto/engine/eng_pkey.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",108,__func__), ERR_set_error)((38),(129),
# 108 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 108 "../crypto/engine/eng_pkey.c"
       );
        return 
# 109 "../crypto/engine/eng_pkey.c" 3 4
              ((void *)0)
# 109 "../crypto/engine/eng_pkey.c"
                  ;
    }
    return pkey;
}
                                ...
                                UI_METHOD *ui_method, void *callback_data)
{
    ...
    if (e == 
# 120 "../crypto/engine/eng_pkey.c" 3 4
            ((void *)0)
# 120 "../crypto/engine/eng_pkey.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",121,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 121 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 121 "../crypto/engine/eng_pkey.c"
       );
        return 0;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
    ...
    if (e->funct_ref == 0) {
        CRYPTO_THREAD_unlock(global_engine_lock);
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",128,__func__), ERR_set_error)((38),(117),
# 128 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 128 "../crypto/engine/eng_pkey.c"
       );
        return 0;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (!e->load_ssl_client_cert) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_pkey.c",133,__func__), ERR_set_error)((38),(125),
# 133 "../crypto/engine/eng_pkey.c" 3 4
       ((void *)0)
# 133 "../crypto/engine/eng_pkey.c"
       );
        return 0;
    }
