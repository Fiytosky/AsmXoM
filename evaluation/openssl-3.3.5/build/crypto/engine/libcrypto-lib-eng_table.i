# 0 "../crypto/engine/eng_table.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_table.c"
# 10 "../crypto/engine/eng_table.c"
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 11 "../crypto/engine/eng_table.c" 2
...
# 12 "../crypto/engine/eng_table.c" 2
...
# 14 "../crypto/engine/eng_table.c" 2
# 1 "../crypto/engine/eng_local.h" 1
# 16 "../crypto/engine/eng_local.h"
...
# 15 "../crypto/engine/eng_table.c" 2
...
# 73 "../crypto/engine/eng_table.c" 3 4
                                                                       ((void *)0)
# 73 "../crypto/engine/eng_table.c"
                                                                           )
        return 0;
    *t = (ENGINE_TABLE *)lh;
    return 1;
                          ...
                          int setdefault)
{
    ...
    if (added && !engine_cleanup_add_first(cleanup)) {
        ...
        *table = 
# 99 "../crypto/engine/eng_table.c" 3 4
                ((void *)0)
# 99 "../crypto/engine/eng_table.c"
                    ;
        goto end;
    }
    while (num_nids--) {
        ...
        if (!fnd) {
            fnd = CRYPTO_malloc(sizeof(*fnd), "../crypto/engine/eng_table.c", 106);
            if (fnd == 
# 107 "../crypto/engine/eng_table.c" 3 4
                      ((void *)0)
# 107 "../crypto/engine/eng_table.c"
                          )
                goto end;
            fnd->uptodate = 1;
            fnd->nid = *nids;
            ...
            if (!fnd->sk) {
                CRYPTO_free(fnd, "../crypto/engine/eng_table.c", 113);
                goto end;
            }
            fnd->funct = 
# 116 "../crypto/engine/eng_table.c" 3 4
                        ((void *)0)
# 116 "../crypto/engine/eng_table.c"
                            ;
            (void)lh_ENGINE_PILE_insert(&(*table)->piles, fnd);
            if (lh_ENGINE_PILE_retrieve(&(*table)->piles, &tmplate) != fnd) {
                sk_ENGINE_free(fnd->sk);
                CRYPTO_free(fnd, "../crypto/engine/eng_table.c", 120);
                goto end;
            }
        }
        ...
        if (setdefault) {
            if (!engine_unlocked_init(e)) {
                (ERR_new(), ERR_set_debug("../crypto/engine/eng_table.c",135,__func__), ERR_set_error)((38),(109),
# 135 "../crypto/engine/eng_table.c" 3 4
               ((void *)0)
# 135 "../crypto/engine/eng_table.c"
               );
                goto end;
            }
            if (fnd->funct)
...
static void int_unregister_cb(ENGINE_PILE *pile, ENGINE *e)
{
    ...
    if (pile->funct == e) {
        ...
        pile->funct = 
# 161 "../crypto/engine/eng_table.c" 3 4
                     ((void *)0)
# 161 "../crypto/engine/eng_table.c"
                         ;
    }
}

static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_ENGINE_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(ENGINE_PILE *, ENGINE *) = (void (*)(ENGINE_PILE *, ENGINE *))fn; fn_conv((ENGINE_PILE *)node, (ENGINE *)arg); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_ENGINE(struct lhash_st_ENGINE_PILE *lh, void (*fn)(ENGINE_PILE *, ENGINE *), ENGINE *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_ENGINE_PILE_doall_ENGINE_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_ENGINE_PILE;
...
{
    if (p == 
# 179 "../crypto/engine/eng_table.c" 3 4
            ((void *)0)
# 179 "../crypto/engine/eng_table.c"
                )
        return;
    sk_ENGINE_free(p->sk);
    if (p->funct)
        engine_unlocked_finish(p->funct, 0);
    CRYPTO_free(p, "../crypto/engine/eng_table.c", 184);
}
...
void engine_table_cleanup(ENGINE_TABLE **table)
{
    ...
    if (*table) {
        ...
        lh_ENGINE_PILE_free(&(*table)->piles);
        *table = 
# 194 "../crypto/engine/eng_table.c" 3 4
                ((void *)0)
# 194 "../crypto/engine/eng_table.c"
                    ;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
}
...
{
    ENGINE *ret = 
# 203 "../crypto/engine/eng_table.c" 3 4
                 ((void *)0)
# 203 "../crypto/engine/eng_table.c"
                     ;
    ENGINE_PILE tmplate, *fnd = 
# 204 "../crypto/engine/eng_table.c" 3 4
                               ((void *)0)
# 204 "../crypto/engine/eng_table.c"
                                   ;
    int initres, loop = 0;
...
# 209 "../crypto/engine/eng_table.c" 3 4
                                                 ((void *)0)
# 209 "../crypto/engine/eng_table.c"
                                                     );
    ...
    if (!(*table)) {
        ((void)0)
                             ...
                             ;
        return 
# 216 "../crypto/engine/eng_table.c" 3 4
              ((void *)0)
# 216 "../crypto/engine/eng_table.c"
                  ;
    }

    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 220 "../crypto/engine/eng_table.c" 3 4
              ((void *)0)
# 220 "../crypto/engine/eng_table.c"
                  ;
...
static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_ENGINE_PILE_DOALL_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const ENGINE_PILE *, ENGINE_PILE_DOALL *) = (void (*)(const ENGINE_PILE *, ENGINE_PILE_DOALL *))fn; fn_conv((const ENGINE_PILE *)node, (ENGINE_PILE_DOALL *)arg); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_ENGINE_PILE_DOALL(struct lhash_st_ENGINE_PILE *lh, void (*fn)(const ENGINE_PILE *, ENGINE_PILE_DOALL *), ENGINE_PILE_DOALL *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_ENGINE_PILE_doall_ENGINE_PILE_DOALL_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_ENGINE_PILE;
