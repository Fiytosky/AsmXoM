# 0 "../crypto/engine/eng_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_init.c"
# 13 "../crypto/engine/eng_init.c"
...
# 64 "../crypto/engine/eng_init.c"
    ...
    if (!engine_free_util(e, 0)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_init.c",79,__func__), ERR_set_error)((38),(106),
# 79 "../crypto/engine/eng_init.c" 3 4
       ((void *)0)
# 79 "../crypto/engine/eng_init.c"
       );
        return 0;
    }
    return to_return;
...
int ENGINE_init(ENGINE *e)
{
    int ret;
    if (e == 
# 89 "../crypto/engine/eng_init.c" 3 4
            ((void *)0)
# 89 "../crypto/engine/eng_init.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_init.c",90,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 90 "../crypto/engine/eng_init.c" 3 4
       ((void *)0)
# 90 "../crypto/engine/eng_init.c"
       );
        return 0;
    }
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/engine/eng_init.c",95,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 95 "../crypto/engine/eng_init.c" 3 4
       ((void *)0)
# 95 "../crypto/engine/eng_init.c"
       );
        return 0;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
...
int ENGINE_finish(ENGINE *e)
{
    ...
    if (e == 
# 110 "../crypto/engine/eng_init.c" 3 4
            ((void *)0)
# 110 "../crypto/engine/eng_init.c"
                )
        return 1;
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 0;
    ...
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (!to_return) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_init.c",117,__func__), ERR_set_error)((38),(106),
# 117 "../crypto/engine/eng_init.c" 3 4
       ((void *)0)
# 117 "../crypto/engine/eng_init.c"
       );
        return 0;
    }
    return to_return;
