# 0 "../crypto/engine/eng_dyn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_dyn.c"
# 13 "../crypto/engine/eng_dyn.c"
...
# 15 "../crypto/engine/eng_dyn.c" 2
# 24 "../crypto/engine/eng_dyn.c"
...
static const ENGINE_CMD_DEFN dynamic_cmd_defns[] = {
    ...
    {(200 + 6),
     ...
     (unsigned int)0x0004},
    {0, 
# 73 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 73 "../crypto/engine/eng_dyn.c"
           , 
# 73 "../crypto/engine/eng_dyn.c" 3 4
             ((void *)0)
# 73 "../crypto/engine/eng_dyn.c"
...
struct st_dynamic_data_ctx {
    ...
    struct stack_st_OPENSSL_STRING *dirs;
};
...
{
    CRYPTO_free(s, "../crypto/engine/eng_dyn.c", 125);
}
# 137 "../crypto/engine/eng_dyn.c"
                                       ...
                                       void *argp)
{
    if (ptr) {
        ...
        CRYPTO_free(ctx->DYNAMIC_LIBNAME, "../crypto/engine/eng_dyn.c", 144);
        CRYPTO_free(ctx->engine_id, "../crypto/engine/eng_dyn.c", 145);
        OPENSSL_sk_pop_free(ossl_check_OPENSSL_STRING_sk_type(ctx->dirs),ossl_check_OPENSSL_STRING_freefunc_type(int_free_str));
        CRYPTO_free(ctx, "../crypto/engine/eng_dyn.c", 147);
    }
}
...
{
    dynamic_data_ctx *c = CRYPTO_zalloc(sizeof(*c), "../crypto/engine/eng_dyn.c", 159);
    int ret = 0;

    if (c == 
# 162 "../crypto/engine/eng_dyn.c" 3 4
            ((void *)0)
# 162 "../crypto/engine/eng_dyn.c"
                )
        return 0;
    c->dirs = ((struct stack_st_OPENSSL_STRING *)OPENSSL_sk_new_null());
    if (c->dirs == 
# 165 "../crypto/engine/eng_dyn.c" 3 4
                  ((void *)0)
# 165 "../crypto/engine/eng_dyn.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",166,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 166 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 166 "../crypto/engine/eng_dyn.c"
       );
        goto end;
    }
    ...
    if ((*ctx = (dynamic_data_ctx *)ENGINE_get_ex_data(e,
                                                       dynamic_ex_data_idx))
        == 
# 176 "../crypto/engine/eng_dyn.c" 3 4
          ((void *)0)
# 176 "../crypto/engine/eng_dyn.c"
              ) {
        ...
        if (ret) {
            *ctx = c;
            c = 
# 181 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 181 "../crypto/engine/eng_dyn.c"
                   ;
        }
    }
    ...
    if (c != 
# 191 "../crypto/engine/eng_dyn.c" 3 4
            ((void *)0)
# 191 "../crypto/engine/eng_dyn.c"
                )
        OPENSSL_sk_free(ossl_check_OPENSSL_STRING_sk_type(c->dirs));
    CRYPTO_free(c, "../crypto/engine/eng_dyn.c", 193);
    return ret;
}
...
static dynamic_data_ctx *dynamic_get_data_ctx(ENGINE *e)
{
    ...
    if (dynamic_ex_data_idx < 0) {
        ...
        int new_idx = CRYPTO_get_ex_new_index(10, 0, 
# 210 "../crypto/engine/eng_dyn.c" 3 4
                     ((void *)0)
# 210 "../crypto/engine/eng_dyn.c"
                     , 
# 210 "../crypto/engine/eng_dyn.c" 3 4
                     ((void *)0)
# 210 "../crypto/engine/eng_dyn.c"
...
# 210 "../crypto/engine/eng_dyn.c"
                     , dynamic_data_ctx_free_func)
                                                                         ;
        if (new_idx == -1) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",213,__func__), ERR_set_error)((38),(144),
# 213 "../crypto/engine/eng_dyn.c" 3 4
           ((void *)0)
# 213 "../crypto/engine/eng_dyn.c"
           );
            return 
# 214 "../crypto/engine/eng_dyn.c" 3 4
                  ((void *)0)
# 214 "../crypto/engine/eng_dyn.c"
                      ;
        }
        if (!CRYPTO_THREAD_write_lock(global_engine_lock))
            return 
# 217 "../crypto/engine/eng_dyn.c" 3 4
                  ((void *)0)
# 217 "../crypto/engine/eng_dyn.c"
                      ;
    ...
    if ((ctx == 
# 232 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 232 "../crypto/engine/eng_dyn.c"
                   ) && !dynamic_set_data_ctx(e, &ctx))

        return 
# 234 "../crypto/engine/eng_dyn.c" 3 4
              ((void *)0)
# 234 "../crypto/engine/eng_dyn.c"
                  ;
    return ctx;
}
...
static ENGINE *engine_dynamic(void)
{
    ...
    if (ret == 
# 241 "../crypto/engine/eng_dyn.c" 3 4
              ((void *)0)
# 241 "../crypto/engine/eng_dyn.c"
                  )
        return 
# 242 "../crypto/engine/eng_dyn.c" 3 4
              ((void *)0)
# 242 "../crypto/engine/eng_dyn.c"
                  ;
    if (!ENGINE_set_id(ret, engine_dynamic_id) ||
        ...
        !ENGINE_set_flags(ret, (int)0x0004) ||
        !ENGINE_set_cmd_defns(ret, dynamic_cmd_defns)) {
        ENGINE_free(ret);
        return 
# 251 "../crypto/engine/eng_dyn.c" 3 4
              ((void *)0)
# 251 "../crypto/engine/eng_dyn.c"
                  ;
    }
    return ret;
}
...
static int dynamic_ctrl(ENGINE *e, int cmd, long i, void *p, void (*f) (void))
{
    ...
    if (!ctx) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",301,__func__), ERR_set_error)((38),(112),
# 301 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 301 "../crypto/engine/eng_dyn.c"
       );
        return 0;
    }
    initialised = ((ctx->dynamic_dso == 
# 304 "../crypto/engine/eng_dyn.c" 3 4
                                       ((void *)0)
# 304 "../crypto/engine/eng_dyn.c"
                                           ) ? 0 : 1);

    if (initialised) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",307,__func__), ERR_set_error)((38),(100),
# 307 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 307 "../crypto/engine/eng_dyn.c"
       );
        return 0;
    }
    switch (cmd) {
    case 200:
        ...
        if (p && (strlen((const char *)p) < 1))
            p = 
# 314 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 314 "../crypto/engine/eng_dyn.c"
                   ;
        CRYPTO_free(ctx->DYNAMIC_LIBNAME, "../crypto/engine/eng_dyn.c", 315);
        if (p)
            ctx->DYNAMIC_LIBNAME = CRYPTO_strdup(p, "../crypto/engine/eng_dyn.c", 317);
        else
            ctx->DYNAMIC_LIBNAME = 
# 319 "../crypto/engine/eng_dyn.c" 3 4
                                  ((void *)0)
# 319 "../crypto/engine/eng_dyn.c"
                                      ;
    ...
    case (200 + 2):
        ...
        if (p && (strlen((const char *)p) < 1))
            p = 
# 327 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 327 "../crypto/engine/eng_dyn.c"
                   ;
        CRYPTO_free(ctx->engine_id, "../crypto/engine/eng_dyn.c", 328);
        if (p)
            ctx->engine_id = CRYPTO_strdup(p, "../crypto/engine/eng_dyn.c", 330);
        else
            ctx->engine_id = 
# 332 "../crypto/engine/eng_dyn.c" 3 4
                            ((void *)0)
# 332 "../crypto/engine/eng_dyn.c"
                                ;
        return (ctx->engine_id ? 1 : 0);
    case (200 + 3):
        if ((i < 0) || (i > 2)) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",336,__func__), ERR_set_error)((38),(143),
# 336 "../crypto/engine/eng_dyn.c" 3 4
           ((void *)0)
# 336 "../crypto/engine/eng_dyn.c"
           );
            return 0;
        }
    ...
    case (200 + 4):
        if ((i < 0) || (i > 2)) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",345,__func__), ERR_set_error)((38),(143),
# 345 "../crypto/engine/eng_dyn.c" 3 4
           ((void *)0)
# 345 "../crypto/engine/eng_dyn.c"
           );
            return 0;
        }
        ctx->dir_load = (int)i;
    ...
    case (200 + 5):
        ...
        if (p == 
# 352 "../crypto/engine/eng_dyn.c" 3 4
                ((void *)0) 
# 352 "../crypto/engine/eng_dyn.c"
                     || (strlen((const char *)p) < 1)) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",353,__func__), ERR_set_error)((38),(143),
# 353 "../crypto/engine/eng_dyn.c" 3 4
           ((void *)0)
# 353 "../crypto/engine/eng_dyn.c"
           );
            return 0;
        }
        {
            char *tmp_str = CRYPTO_strdup(p, "../crypto/engine/eng_dyn.c", 357);
            if (tmp_str == 
# 358 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 358 "../crypto/engine/eng_dyn.c"
                              )
                return 0;
            if (!OPENSSL_sk_push(ossl_check_OPENSSL_STRING_sk_type(ctx->dirs), ossl_check_OPENSSL_STRING_type(tmp_str))) {
                CRYPTO_free(tmp_str, "../crypto/engine/eng_dyn.c", 361);
                (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",362,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 362 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 362 "../crypto/engine/eng_dyn.c"
               );
                return 0;
            }
        }
    ...
    (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",370,__func__), ERR_set_error)((38),(119),
# 370 "../crypto/engine/eng_dyn.c" 3 4
   ((void *)0)
# 370 "../crypto/engine/eng_dyn.c"
   );
    return 0;
}
...
static int int_load(dynamic_data_ctx *ctx)
{
    ...
    if ((ctx->dir_load != 2) && (DSO_load(ctx->dynamic_dso,
                                          ctx->DYNAMIC_LIBNAME, 
# 379 "../crypto/engine/eng_dyn.c" 3 4
                                                               ((void *)0)
# 379 "../crypto/engine/eng_dyn.c"
                                                                   ,
                                          0)) != 
# 380 "../crypto/engine/eng_dyn.c" 3 4
                                                ((void *)0)
# 380 "../crypto/engine/eng_dyn.c"
                                                    )
        return 1;

    if (!ctx->dir_load || (num = OPENSSL_sk_num(ossl_check_const_OPENSSL_STRING_sk_type(ctx->dirs))) < 1)
        return 0;
    for (loop = 0; loop < num; loop++) {
        const char *s = ((char *)OPENSSL_sk_value(ossl_check_const_OPENSSL_STRING_sk_type(ctx->dirs), (loop)));
        char *merge = DSO_merge(ctx->dynamic_dso, ctx->DYNAMIC_LIBNAME, s);
        if (!merge)
            return 0;
        if (DSO_load(ctx->dynamic_dso, merge, 
# 390 "../crypto/engine/eng_dyn.c" 3 4
                                             ((void *)0)
# 390 "../crypto/engine/eng_dyn.c"
                                                 , 0)) {

            CRYPTO_free(merge, "../crypto/engine/eng_dyn.c", 392);
            return 1;
        }
        CRYPTO_free(merge, "../crypto/engine/eng_dyn.c", 395);
    }
    return 0;
}
# 409 "../crypto/engine/eng_dyn.c"
static int using_libcrypto_11(dynamic_data_ctx *ctx)
{
    int ret;

    ERR_set_mark();
    ret = DSO_bind_func(ctx->dynamic_dso, "EVP_PKEY_base_id") != 
# 414 "../crypto/engine/eng_dyn.c" 3 4
                                                                ((void *)0)
# 414 "../crypto/engine/eng_dyn.c"
                                                                    ;
    ERR_pop_to_mark();
...
static int dynamic_load(ENGINE *e, dynamic_data_ctx *ctx)
{
    ...
    if (ctx->dynamic_dso == 
# 425 "../crypto/engine/eng_dyn.c" 3 4
                           ((void *)0)
# 425 "../crypto/engine/eng_dyn.c"
                               )
        ctx->dynamic_dso = DSO_new();
    if (ctx->dynamic_dso == 
# 427 "../crypto/engine/eng_dyn.c" 3 4
                           ((void *)0)
# 427 "../crypto/engine/eng_dyn.c"
                               )
        return 0;
    if (!ctx->DYNAMIC_LIBNAME) {
        if (!ctx->engine_id)
            return 0;
        DSO_ctrl(ctx->dynamic_dso, 2,
                 0x02, 
# 433 "../crypto/engine/eng_dyn.c" 3 4
                                                    ((void *)0)
# 433 "../crypto/engine/eng_dyn.c"
                                                        );
        ctx->DYNAMIC_LIBNAME =
            DSO_convert_filename(ctx->dynamic_dso, ctx->engine_id);
    }
    if (!int_load(ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",438,__func__), ERR_set_error)((38),(132),
# 438 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 438 "../crypto/engine/eng_dyn.c"
       );
        DSO_free(ctx->dynamic_dso);
        ctx->dynamic_dso = 
# 440 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 440 "../crypto/engine/eng_dyn.c"
                              ;
        return 0;
    }
    ...
    if (!
        (ctx->bind_engine =
         (dynamic_bind_engine) DSO_bind_func(ctx->dynamic_dso,
                                             ctx->DYNAMIC_F2))) {
        ctx->bind_engine = 
# 448 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 448 "../crypto/engine/eng_dyn.c"
                              ;
        DSO_free(ctx->dynamic_dso);
        ctx->dynamic_dso = 
# 450 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 450 "../crypto/engine/eng_dyn.c"
                              ;
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",451,__func__), ERR_set_error)((38),(104),
# 451 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 451 "../crypto/engine/eng_dyn.c"
       );
        return 0;
    }
    ...
    if (!ctx->no_vcheck) {
        ...
        ctx->v_check =
            (dynamic_v_check_fn) DSO_bind_func(ctx->dynamic_dso,
                                               ctx->DYNAMIC_F1);
        if (ctx->v_check)
            vcheck_res = ctx->v_check((unsigned long)0x00030000);





        if (vcheck_res < (unsigned long)0x00030000 || using_libcrypto_11(ctx)) {

            ctx->bind_engine = 
# 473 "../crypto/engine/eng_dyn.c" 3 4
                              ((void *)0)
# 473 "../crypto/engine/eng_dyn.c"
                                  ;
            ctx->v_check = 
# 474 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 474 "../crypto/engine/eng_dyn.c"
                              ;
            DSO_free(ctx->dynamic_dso);
            ctx->dynamic_dso = 
# 476 "../crypto/engine/eng_dyn.c" 3 4
                              ((void *)0)
# 476 "../crypto/engine/eng_dyn.c"
                                  ;
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",477,__func__), ERR_set_error)((38),(145),
# 477 "../crypto/engine/eng_dyn.c" 3 4
           ((void *)0)
# 477 "../crypto/engine/eng_dyn.c"
           );
            return 0;
        }
    }
    ...
    if (!engine_add_dynamic_id(e, (ENGINE_DYNAMIC_ID)ctx->bind_engine, 1)
        ...
        ctx->bind_engine = 
# 506 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 506 "../crypto/engine/eng_dyn.c"
                              ;
        ctx->v_check = 
# 507 "../crypto/engine/eng_dyn.c" 3 4
                      ((void *)0)
# 507 "../crypto/engine/eng_dyn.c"
                          ;
        DSO_free(ctx->dynamic_dso);
        ctx->dynamic_dso = 
# 509 "../crypto/engine/eng_dyn.c" 3 4
                          ((void *)0)
# 509 "../crypto/engine/eng_dyn.c"
                              ;
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",510,__func__), ERR_set_error)((38),(109),
# 510 "../crypto/engine/eng_dyn.c" 3 4
       ((void *)0)
# 510 "../crypto/engine/eng_dyn.c"
       );
    ...
    if (ctx->list_add_value > 0) {
        if (!ENGINE_add(e)) {
            ...
            if (ctx->list_add_value > 1) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/engine/eng_dyn.c",526,__func__), ERR_set_error)((38),(103),
# 526 "../crypto/engine/eng_dyn.c" 3 4
               ((void *)0)
# 526 "../crypto/engine/eng_dyn.c"
               );
                return 0;
            }
