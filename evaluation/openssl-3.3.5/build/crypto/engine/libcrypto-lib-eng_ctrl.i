# 0 "../crypto/engine/eng_ctrl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_ctrl.c"
# 13 "../crypto/engine/eng_ctrl.c"
...
# 29 "../crypto/engine/eng_ctrl.c" 3 4
                                                  ((void *)0)
# 29 "../crypto/engine/eng_ctrl.c"
                                                      ))
        return 1;
    return 0;
}
                           ...
                           void (*f) (void))
{
    ...
    if (cmd == 11) {
        if ((e->cmd_defns == 
# 73 "../crypto/engine/eng_ctrl.c" 3 4
                            ((void *)0)
# 73 "../crypto/engine/eng_ctrl.c"
    ...
    if ((cmd == 13) ||
        ...
        (cmd == 17)) {
        if (s == 
# 81 "../crypto/engine/eng_ctrl.c" 3 4
                ((void *)0)
# 81 "../crypto/engine/eng_ctrl.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",82,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 82 "../crypto/engine/eng_ctrl.c" 3 4
           ((void *)0)
# 82 "../crypto/engine/eng_ctrl.c"
           );
            return -1;
        }
    }
    ...
    if (cmd == 13) {
        if ((e->cmd_defns == 
# 88 "../crypto/engine/eng_ctrl.c" 3 4
                            ((void *)0)
# 88 "../crypto/engine/eng_ctrl.c"
                                )
            || ((idx = int_ctrl_cmd_by_name(e->cmd_defns, s)) < 0)) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",90,__func__), ERR_set_error)((38),(137),
# 90 "../crypto/engine/eng_ctrl.c" 3 4
           ((void *)0)
# 90 "../crypto/engine/eng_ctrl.c"
           );
            return -1;
        }
    ...
    if ((e->cmd_defns == 
# 99 "../crypto/engine/eng_ctrl.c" 3 4
                        ((void *)0)
# 99 "../crypto/engine/eng_ctrl.c"
                            )
        || ((idx = int_ctrl_cmd_by_num(e->cmd_defns, (unsigned int)i)) < 0)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",101,__func__), ERR_set_error)((38),(138),
# 101 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 101 "../crypto/engine/eng_ctrl.c"
       );
        return -1;
    }
    ...
    case 16:
        return strlen(cdp->cmd_desc == 
# 115 "../crypto/engine/eng_ctrl.c" 3 4
                                      ((void *)0) 
# 115 "../crypto/engine/eng_ctrl.c"
                                           ? int_no_description
                                            : cdp->cmd_desc);
    case 17:
        return strlen(strcpy(s, cdp->cmd_desc == 
# 118 "../crypto/engine/eng_ctrl.c" 3 4
                                                ((void *)0) 
# 118 "../crypto/engine/eng_ctrl.c"
                                                     ? int_no_description
                                                      : cdp->cmd_desc));
    case 18:
    ...
    (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",124,__func__), ERR_set_error)((38),(110),
# 124 "../crypto/engine/eng_ctrl.c" 3 4
   ((void *)0)
# 124 "../crypto/engine/eng_ctrl.c"
   );
    return -1;
}
...
int ENGINE_ctrl(ENGINE *e, int cmd, long i, void *p, void (*f) (void))
{
    ...
    if (e == 
# 132 "../crypto/engine/eng_ctrl.c" 3 4
            ((void *)0)
# 132 "../crypto/engine/eng_ctrl.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",133,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 133 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 133 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }

    ctrl_exists = ((e->ctrl == 
# 137 "../crypto/engine/eng_ctrl.c" 3 4
                              ((void *)0)
# 137 "../crypto/engine/eng_ctrl.c"
                                  ) ? 0 : 1);
    ...
    case 18:
        ...
        if (!ctrl_exists) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",157,__func__), ERR_set_error)((38),(120),
# 157 "../crypto/engine/eng_ctrl.c" 3 4
           ((void *)0)
# 157 "../crypto/engine/eng_ctrl.c"
           );
    ...
    if (!ctrl_exists) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",170,__func__), ERR_set_error)((38),(120),
# 170 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 170 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
...
int ENGINE_cmd_is_executable(ENGINE *e, int cmd)
{
    int flags;
    if ((flags =
         ENGINE_ctrl(e, 18, cmd, 
# 180 "../crypto/engine/eng_ctrl.c" 3 4
                                                       ((void *)0)
# 180 "../crypto/engine/eng_ctrl.c"
                                                           , 
# 180 "../crypto/engine/eng_ctrl.c" 3 4
                                                             ((void *)0)
# 180 "../crypto/engine/eng_ctrl.c"
                                                                 )) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",181,__func__), ERR_set_error)((38),(138),
# 181 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 181 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
                    ...
                    long i, void *p, void (*f) (void), int cmd_optional)
{
    ...
    if (e == 
# 196 "../crypto/engine/eng_ctrl.c" 3 4
            ((void *)0) 
# 196 "../crypto/engine/eng_ctrl.c"
                 || cmd_name == 
# 196 "../crypto/engine/eng_ctrl.c" 3 4
                                ((void *)0)
# 196 "../crypto/engine/eng_ctrl.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",197,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 197 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 197 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    if (e->ctrl == 
# 200 "../crypto/engine/eng_ctrl.c" 3 4
                  ((void *)0)
        
# 201 "../crypto/engine/eng_ctrl.c"
       || (num = ENGINE_ctrl(e, 13,
                              0, (void *)cmd_name, 
# 202 "../crypto/engine/eng_ctrl.c" 3 4
                                                  ((void *)0)
# 202 "../crypto/engine/eng_ctrl.c"
                                                      )) <= 0) {
# 211 "../crypto/engine/eng_ctrl.c"
        if (cmd_optional) {
            ERR_clear_error();
            return 1;
        }
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",215,__func__), ERR_set_error)((38),(137),
# 215 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 215 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
                           ...
                           int cmd_optional)
{
    ...
    if (e == 
# 234 "../crypto/engine/eng_ctrl.c" 3 4
            ((void *)0) 
# 234 "../crypto/engine/eng_ctrl.c"
                 || cmd_name == 
# 234 "../crypto/engine/eng_ctrl.c" 3 4
                                ((void *)0)
# 234 "../crypto/engine/eng_ctrl.c"
                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",235,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 235 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 235 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    if (e->ctrl == 
# 238 "../crypto/engine/eng_ctrl.c" 3 4
                  ((void *)0)
        
# 239 "../crypto/engine/eng_ctrl.c"
       || (num = ENGINE_ctrl(e, 13,
                              0, (void *)cmd_name, 
# 240 "../crypto/engine/eng_ctrl.c" 3 4
                                                  ((void *)0)
# 240 "../crypto/engine/eng_ctrl.c"
                                                      )) <= 0) {
# 249 "../crypto/engine/eng_ctrl.c"
        if (cmd_optional) {
            ERR_clear_error();
            return 1;
        }
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",253,__func__), ERR_set_error)((38),(137),
# 253 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 253 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    if (!ENGINE_cmd_is_executable(e, num)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",257,__func__), ERR_set_error)((38),(134),
# 257 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 257 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }

    flags = ENGINE_ctrl(e, 18, num, 
# 261 "../crypto/engine/eng_ctrl.c" 3 4
                                                          ((void *)0)
# 261 "../crypto/engine/eng_ctrl.c"
                                                              , 
# 261 "../crypto/engine/eng_ctrl.c" 3 4
                                                                ((void *)0)
# 261 "../crypto/engine/eng_ctrl.c"
    ...
    if (flags < 0) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",267,__func__), ERR_set_error)((38),(110),
# 267 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 267 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    ...
    if (flags & (unsigned int)0x0004) {
        if (arg != 
# 274 "../crypto/engine/eng_ctrl.c" 3 4
                  ((void *)0)
# 274 "../crypto/engine/eng_ctrl.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",275,__func__), ERR_set_error)((38),(136),
# 275 "../crypto/engine/eng_ctrl.c" 3 4
           ((void *)0)
...
# 284 "../crypto/engine/eng_ctrl.c" 3 4
                                               ((void *)0)
# 284 "../crypto/engine/eng_ctrl.c"
                                                   ) > 0)
            return 1;
        return 0;
    }
    ...
    if (arg == 
# 289 "../crypto/engine/eng_ctrl.c" 3 4
              ((void *)0)
# 289 "../crypto/engine/eng_ctrl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",290,__func__), ERR_set_error)((38),(135),
# 290 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 290 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    ...
    if (flags & (unsigned int)0x0002) {
        ...
        if (ENGINE_ctrl(e, num, 0, (void *)arg, 
# 296 "../crypto/engine/eng_ctrl.c" 3 4
                                               ((void *)0)
# 296 "../crypto/engine/eng_ctrl.c"
                                                   ) > 0)
            return 1;
        return 0;
    }
    ...
    if (!(flags & (unsigned int)0x0001)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",307,__func__), ERR_set_error)((38),(110),
# 307 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 307 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
    l = strtol(arg, &ptr, 10);
    if ((arg == ptr) || (*ptr != '\0')) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_ctrl.c",312,__func__), ERR_set_error)((38),(133),
# 312 "../crypto/engine/eng_ctrl.c" 3 4
       ((void *)0)
# 312 "../crypto/engine/eng_ctrl.c"
       );
        return 0;
    }
...
# 319 "../crypto/engine/eng_ctrl.c" 3 4
                              ((void *)0)
# 319 "../crypto/engine/eng_ctrl.c"
                                  , 
# 319 "../crypto/engine/eng_ctrl.c" 3 4
                                    ((void *)0)
# 319 "../crypto/engine/eng_ctrl.c"
