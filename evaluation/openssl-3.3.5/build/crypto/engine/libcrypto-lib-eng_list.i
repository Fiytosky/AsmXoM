# 0 "../crypto/engine/eng_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/eng_list.c"
# 14 "../crypto/engine/eng_list.c"
# 1 "../crypto/engine/eng_local.h" 1
# 14 "../crypto/engine/eng_local.h"
...
# 15 "../crypto/engine/eng_local.h" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 16 "../crypto/engine/eng_local.h" 2
# 1 "../include/crypto/engine.h" 1
...
# 17 "../crypto/engine/eng_local.h" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 18 "../crypto/engine/eng_local.h" 2
...
# 19 "../crypto/engine/eng_local.h" 2

extern CRYPTO_RWLOCK *global_engine_lock;
# 44 "../crypto/engine/eng_local.h"
typedef void (ENGINE_CLEANUP_CB) (void);
typedef struct st_engine_cleanup_item {
    ENGINE_CLEANUP_CB *cb;
} ENGINE_CLEANUP_ITEM;
struct stack_st_ENGINE_CLEANUP_ITEM; typedef int (*sk_ENGINE_CLEANUP_ITEM_compfunc)(const ENGINE_CLEANUP_ITEM * const *a, const ENGINE_CLEANUP_ITEM *const *b); typedef void (*sk_ENGINE_CLEANUP_ITEM_freefunc)(ENGINE_CLEANUP_ITEM *a); typedef ENGINE_CLEANUP_ITEM * (*sk_ENGINE_CLEANUP_ITEM_copyfunc)(const ENGINE_CLEANUP_ITEM *a); static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_num(const struct stack_st_ENGINE_CLEANUP_ITEM *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_value(const struct stack_st_ENGINE_CLEANUP_ITEM *sk, int idx) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_new(sk_ENGINE_CLEANUP_ITEM_compfunc compare) { return (struct stack_st_ENGINE_CLEANUP_ITEM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_new_null(void) { return (struct stack_st_ENGINE_CLEANUP_ITEM *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_new_reserve(sk_ENGINE_CLEANUP_ITEM_compfunc compare, int n) { return (struct stack_st_ENGINE_CLEANUP_ITEM *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_reserve(struct stack_st_ENGINE_CLEANUP_ITEM *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_ENGINE_CLEANUP_ITEM_free(struct stack_st_ENGINE_CLEANUP_ITEM *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_ENGINE_CLEANUP_ITEM_zero(struct stack_st_ENGINE_CLEANUP_ITEM *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_delete(struct stack_st_ENGINE_CLEANUP_ITEM *sk, int i) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_delete_ptr(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_push(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_unshift(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_pop(struct stack_st_ENGINE_CLEANUP_ITEM *sk) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_shift(struct stack_st_ENGINE_CLEANUP_ITEM *sk) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_ENGINE_CLEANUP_ITEM_pop_free(struct stack_st_ENGINE_CLEANUP_ITEM *sk, sk_ENGINE_CLEANUP_ITEM_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_insert(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_set(struct stack_st_ENGINE_CLEANUP_ITEM *sk, int idx, ENGINE_CLEANUP_ITEM *ptr) { return (ENGINE_CLEANUP_ITEM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_find(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_find_ex(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_find_all(struct stack_st_ENGINE_CLEANUP_ITEM *sk, ENGINE_CLEANUP_ITEM *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_ENGINE_CLEANUP_ITEM_sort(struct stack_st_ENGINE_CLEANUP_ITEM *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_ENGINE_CLEANUP_ITEM_is_sorted(const struct stack_st_ENGINE_CLEANUP_ITEM *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_ENGINE_CLEANUP_ITEM * sk_ENGINE_CLEANUP_ITEM_dup(const struct stack_st_ENGINE_CLEANUP_ITEM *sk) { return (struct stack_st_ENGINE_CLEANUP_ITEM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_ENGINE_CLEANUP_ITEM *sk_ENGINE_CLEANUP_ITEM_deep_copy(const struct stack_st_ENGINE_CLEANUP_ITEM *sk, sk_ENGINE_CLEANUP_ITEM_copyfunc copyfunc, sk_ENGINE_CLEANUP_ITEM_freefunc freefunc) { return (struct stack_st_ENGINE_CLEANUP_ITEM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_ENGINE_CLEANUP_ITEM_compfunc sk_ENGINE_CLEANUP_ITEM_set_cmp_func(struct stack_st_ENGINE_CLEANUP_ITEM *sk, sk_ENGINE_CLEANUP_ITEM_compfunc compare) { return (sk_ENGINE_CLEANUP_ITEM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
int engine_cleanup_add_first(ENGINE_CLEANUP_CB *cb);
int engine_cleanup_add_last(ENGINE_CLEANUP_CB *cb);


struct stack_st_ENGINE; typedef int (*sk_ENGINE_compfunc)(const ENGINE * const *a, const ENGINE *const *b); typedef void (*sk_ENGINE_freefunc)(ENGINE *a); typedef ENGINE * (*sk_ENGINE_copyfunc)(const ENGINE *a); static __attribute__((unused)) inline int sk_ENGINE_num(const struct stack_st_ENGINE *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_value(const struct stack_st_ENGINE *sk, int idx) { return (ENGINE *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_ENGINE *sk_ENGINE_new(sk_ENGINE_compfunc compare) { return (struct stack_st_ENGINE *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_ENGINE *sk_ENGINE_new_null(void) { return (struct stack_st_ENGINE *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_ENGINE *sk_ENGINE_new_reserve(sk_ENGINE_compfunc compare, int n) { return (struct stack_st_ENGINE *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_ENGINE_reserve(struct stack_st_ENGINE *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_ENGINE_free(struct stack_st_ENGINE *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_ENGINE_zero(struct stack_st_ENGINE *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_delete(struct stack_st_ENGINE *sk, int i) { return (ENGINE *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_delete_ptr(struct stack_st_ENGINE *sk, ENGINE *ptr) { return (ENGINE *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_push(struct stack_st_ENGINE *sk, ENGINE *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_unshift(struct stack_st_ENGINE *sk, ENGINE *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_pop(struct stack_st_ENGINE *sk) { return (ENGINE *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_shift(struct stack_st_ENGINE *sk) { return (ENGINE *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_ENGINE_pop_free(struct stack_st_ENGINE *sk, sk_ENGINE_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_ENGINE_insert(struct stack_st_ENGINE *sk, ENGINE *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline ENGINE *sk_ENGINE_set(struct stack_st_ENGINE *sk, int idx, ENGINE *ptr) { return (ENGINE *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_find(struct stack_st_ENGINE *sk, ENGINE *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_find_ex(struct stack_st_ENGINE *sk, ENGINE *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_ENGINE_find_all(struct stack_st_ENGINE *sk, ENGINE *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_ENGINE_sort(struct stack_st_ENGINE *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_ENGINE_is_sorted(const struct stack_st_ENGINE *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_ENGINE * sk_ENGINE_dup(const struct stack_st_ENGINE *sk) { return (struct stack_st_ENGINE *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_ENGINE *sk_ENGINE_deep_copy(const struct stack_st_ENGINE *sk, sk_ENGINE_copyfunc copyfunc, sk_ENGINE_freefunc freefunc) { return (struct stack_st_ENGINE *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_ENGINE_compfunc sk_ENGINE_set_cmp_func(struct stack_st_ENGINE *sk, sk_ENGINE_compfunc compare) { return (sk_ENGINE_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
# 95 "../crypto/engine/eng_local.h"
void engine_pkey_meths_free(ENGINE *e);
void engine_pkey_asn1_meths_free(ENGINE *e);


extern CRYPTO_ONCE engine_lock_init;
extern int do_engine_lock_init_ossl_ret_; void do_engine_lock_init_ossl_(void);
...
struct lhash_st_ENGINE_PILE { union lh_ENGINE_PILE_dummy { void* d1; unsigned long d2; int d3; } dummy; }; static unsigned long lh_ENGINE_PILE_hfn_thunk(const void *data, OPENSSL_LH_HASHFUNC hfn) { unsigned long (*hfn_conv)(const ENGINE_PILE *) = (unsigned long (*)(const ENGINE_PILE *))hfn; return hfn_conv((const ENGINE_PILE *)data); } static int lh_ENGINE_PILE_cfn_thunk(const void *da, const void *db, OPENSSL_LH_COMPFUNC cfn) { int (*cfn_conv)(const ENGINE_PILE *, const ENGINE_PILE *) = (int (*)(const ENGINE_PILE *, const ENGINE_PILE *))cfn; return cfn_conv((const ENGINE_PILE *)da, (const ENGINE_PILE *)db); } static __attribute__((unused)) inline void lh_ENGINE_PILE_free(struct lhash_st_ENGINE_PILE *lh) { OPENSSL_LH_free((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_ENGINE_PILE_flush(struct lhash_st_ENGINE_PILE *lh) { OPENSSL_LH_flush((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline ENGINE_PILE * lh_ENGINE_PILE_insert(struct lhash_st_ENGINE_PILE *lh, ENGINE_PILE *d) { return (ENGINE_PILE *)OPENSSL_LH_insert((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline ENGINE_PILE * lh_ENGINE_PILE_delete(struct lhash_st_ENGINE_PILE *lh, const ENGINE_PILE *d) { return (ENGINE_PILE *)OPENSSL_LH_delete((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline ENGINE_PILE * lh_ENGINE_PILE_retrieve(struct lhash_st_ENGINE_PILE *lh, const ENGINE_PILE *d) { return (ENGINE_PILE *)OPENSSL_LH_retrieve((OPENSSL_LHASH *)lh, d); } static __attribute__((unused)) inline int lh_ENGINE_PILE_error(struct lhash_st_ENGINE_PILE *lh) { return OPENSSL_LH_error((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_ENGINE_PILE_num_items(struct lhash_st_ENGINE_PILE *lh) { return OPENSSL_LH_num_items((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline unsigned long lh_ENGINE_PILE_get_down_load(struct lhash_st_ENGINE_PILE *lh) { return OPENSSL_LH_get_down_load((OPENSSL_LHASH *)lh); } static __attribute__((unused)) inline void lh_ENGINE_PILE_set_down_load(struct lhash_st_ENGINE_PILE *lh, unsigned long dl) { OPENSSL_LH_set_down_load((OPENSSL_LHASH *)lh, dl); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_thunk(void *node, OPENSSL_LH_DOALL_FUNC doall) { void (*doall_conv)(ENGINE_PILE *) = (void (*)(ENGINE_PILE *))doall; doall_conv((ENGINE_PILE *)node); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_arg_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG doall) { void (*doall_conv)(ENGINE_PILE *, void *) = (void (*)(ENGINE_PILE *, void *))doall; doall_conv((ENGINE_PILE *)node, arg); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall(struct lhash_st_ENGINE_PILE *lh, void (*doall)(ENGINE_PILE *)) { OPENSSL_LH_doall((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNC)doall); } static __attribute__((unused)) inline struct lhash_st_ENGINE_PILE * lh_ENGINE_PILE_new(unsigned long (*hfn)(const ENGINE_PILE *), int (*cfn)(const ENGINE_PILE *, const ENGINE_PILE *)) { return (struct lhash_st_ENGINE_PILE *)OPENSSL_LH_set_thunks(OPENSSL_LH_new((OPENSSL_LH_HASHFUNC)hfn, (OPENSSL_LH_COMPFUNC)cfn), lh_ENGINE_PILE_hfn_thunk, lh_ENGINE_PILE_cfn_thunk, lh_ENGINE_PILE_doall_thunk, lh_ENGINE_PILE_doall_arg_thunk); } static __attribute__((unused)) inline void lh_ENGINE_PILE_doall_arg(struct lhash_st_ENGINE_PILE *lh, void (*doallarg)(ENGINE_PILE *, void *), void *arg) { OPENSSL_LH_doall_arg((OPENSSL_LHASH *)lh, (OPENSSL_LH_DOALL_FUNCARG)doallarg, arg); } struct lhash_st_ENGINE_PILE;

static __attribute__((unused)) inline int eng_struct_ref(ENGINE *e)
{
    int res;
...
# 15 "../crypto/engine/eng_list.c" 2
# 27 "../crypto/engine/eng_list.c"
static ENGINE *engine_list_head = 
# 27 "../crypto/engine/eng_list.c" 3 4
                                 ((void *)0)
# 27 "../crypto/engine/eng_list.c"
                                     ;
static ENGINE *engine_list_tail = 
# 28 "../crypto/engine/eng_list.c" 3 4
                                 ((void *)0)
# 28 "../crypto/engine/eng_list.c"
                                     ;




static ENGINE *engine_dyn_list_head = 
# 33 "../crypto/engine/eng_list.c" 3 4
                                     ((void *)0)
# 33 "../crypto/engine/eng_list.c"
                                         ;
static ENGINE *engine_dyn_list_tail = 
# 34 "../crypto/engine/eng_list.c" 3 4
                                     ((void *)0)
# 34 "../crypto/engine/eng_list.c"
                                         ;
...
static void engine_list_cleanup(void)
{
    ...
    while (iterator != 
# 46 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 46 "../crypto/engine/eng_list.c"
                          ) {
...
static int engine_list_add(ENGINE *e)
{
    int conflict = 0;
    ENGINE *iterator = 
# 60 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 60 "../crypto/engine/eng_list.c"
                          ;
    int ref;

    if (e == 
# 63 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 63 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",64,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 64 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 64 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    iterator = engine_list_head;
    ...
    if (conflict) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",73,__func__), ERR_set_error)((38),(103),
# 73 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 73 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    ...
    if (!CRYPTO_UP_REF(&e->struct_ref, &ref)) {
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",81,__func__), ERR_set_error)((38),(110),
# 81 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 81 "../crypto/engine/eng_list.c"
           );
            return 0;
    }
    ((void)0);
    if (engine_list_head == 
# 85 "../crypto/engine/eng_list.c" 3 4
                           ((void *)0)
# 85 "../crypto/engine/eng_list.c"
                               ) {

        if (engine_list_tail != 
# 87 "../crypto/engine/eng_list.c" 3 4
                               ((void *)0)
# 87 "../crypto/engine/eng_list.c"
                                   ) {
            CRYPTO_DOWN_REF(&e->struct_ref, &ref);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",89,__func__), ERR_set_error)((38),(110),
# 89 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 89 "../crypto/engine/eng_list.c"
           );
            return 0;
        }
        ...
        if (!engine_cleanup_add_last(engine_list_cleanup)) {
            CRYPTO_DOWN_REF(&e->struct_ref, &ref);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",97,__func__), ERR_set_error)((38),(110),
# 97 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 97 "../crypto/engine/eng_list.c"
           );
            return 0;
        }
        engine_list_head = e;
        e->prev = 
# 101 "../crypto/engine/eng_list.c" 3 4
                 ((void *)0)
# 101 "../crypto/engine/eng_list.c"
                     ;
    } else {

        if ((engine_list_tail == 
# 104 "../crypto/engine/eng_list.c" 3 4
                                ((void *)0)
# 104 "../crypto/engine/eng_list.c"
...
# 104 "../crypto/engine/eng_list.c"
            ...
            CRYPTO_DOWN_REF(&e->struct_ref, &ref);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",106,__func__), ERR_set_error)((38),(110),
# 106 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 106 "../crypto/engine/eng_list.c"
           );
            return 0;
        }
    ...
    engine_list_tail = e;
    e->next = 
# 115 "../crypto/engine/eng_list.c" 3 4
             ((void *)0)
# 115 "../crypto/engine/eng_list.c"
                 ;
    return 1;
}
...
static int engine_list_remove(ENGINE *e)
{
    ...
    if (e == 
# 123 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 123 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",124,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 124 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 124 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    ...
    while (iterator && (iterator != e))
        iterator = iterator->next;
    if (iterator == 
# 131 "../crypto/engine/eng_list.c" 3 4
                   ((void *)0)
# 131 "../crypto/engine/eng_list.c"
                       ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",132,__func__), ERR_set_error)((38),(105),
# 132 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 132 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
                          ...
                          int not_locked)
{
    int result = 0;
    ENGINE *iterator = 
# 154 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 154 "../crypto/engine/eng_list.c"
                          ;

    if (e == 
# 156 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 156 "../crypto/engine/eng_list.c"
                )
        return 0;

    if (e->dynamic_id == 
# 159 "../crypto/engine/eng_list.c" 3 4
                        ((void *)0) 
# 159 "../crypto/engine/eng_list.c"
                             && dynamic_id == 
# 159 "../crypto/engine/eng_list.c" 3 4
                                              ((void *)0)
# 159 "../crypto/engine/eng_list.c"
    ...
    if (dynamic_id != 
# 165 "../crypto/engine/eng_list.c" 3 4
                     ((void *)0)
# 165 "../crypto/engine/eng_list.c"
                         ) {
        iterator = engine_dyn_list_head;
        while (iterator != 
# 167 "../crypto/engine/eng_list.c" 3 4
                          ((void *)0)
# 167 "../crypto/engine/eng_list.c"
                              ) {
        ...
        if (e->dynamic_id != 
# 172 "../crypto/engine/eng_list.c" 3 4
                            ((void *)0)
# 172 "../crypto/engine/eng_list.c"
                                )
            goto err;
        e->dynamic_id = dynamic_id;
    }

    if (engine_dyn_list_head == 
# 177 "../crypto/engine/eng_list.c" 3 4
                               ((void *)0)
# 177 "../crypto/engine/eng_list.c"
                                   ) {

        if (engine_dyn_list_tail != 
# 179 "../crypto/engine/eng_list.c" 3 4
                                   ((void *)0)
# 179 "../crypto/engine/eng_list.c"
                                       )
            goto err;
        engine_dyn_list_head = e;
        e->prev_dyn = 
# 182 "../crypto/engine/eng_list.c" 3 4
                     ((void *)0)
# 182 "../crypto/engine/eng_list.c"
                         ;
    } else {

        if (engine_dyn_list_tail == 
# 185 "../crypto/engine/eng_list.c" 3 4
                                   ((void *)0)
            
# 186 "../crypto/engine/eng_list.c"
           || engine_dyn_list_tail->next_dyn != 
# 186 "../crypto/engine/eng_list.c" 3 4
                                                ((void *)0)
# 186 "../crypto/engine/eng_list.c"
                                                    )
            goto err;
    ...
    e->next_dyn = 
# 193 "../crypto/engine/eng_list.c" 3 4
                 ((void *)0)
# 193 "../crypto/engine/eng_list.c"
                     ;
    result = 1;
...
{
    if (e == 
# 205 "../crypto/engine/eng_list.c" 3 4
            ((void *)0) 
# 205 "../crypto/engine/eng_list.c"
                 || e->dynamic_id == 
# 205 "../crypto/engine/eng_list.c" 3 4
                                     ((void *)0)
# 205 "../crypto/engine/eng_list.c"
    ...
    e->dynamic_id = 
# 211 "../crypto/engine/eng_list.c" 3 4
                   ((void *)0)
# 211 "../crypto/engine/eng_list.c"
                       ;


    if (e->next_dyn != 
# 214 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 214 "../crypto/engine/eng_list.c"
                          )
        e->next_dyn->prev_dyn = e->prev_dyn;
    if (e->prev_dyn != 
# 216 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 216 "../crypto/engine/eng_list.c"
                          )
...
ENGINE *ENGINE_get_first(void)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",235,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 235 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 235 "../crypto/engine/eng_list.c"
       );
        return 
# 236 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 236 "../crypto/engine/eng_list.c"
                  ;
    }

    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 240 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 240 "../crypto/engine/eng_list.c"
                  ;
    ...
    if (ret) {
        ...
        if (!CRYPTO_UP_REF(&ret->struct_ref, &ref)) {
            CRYPTO_THREAD_unlock(global_engine_lock);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",247,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 247 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 247 "../crypto/engine/eng_list.c"
           );
            return 
# 248 "../crypto/engine/eng_list.c" 3 4
                  ((void *)0)
# 248 "../crypto/engine/eng_list.c"
                      ;
        }
        ((void)0);
    }
...
ENGINE *ENGINE_get_last(void)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",262,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 262 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 262 "../crypto/engine/eng_list.c"
       );
        return 
# 263 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 263 "../crypto/engine/eng_list.c"
                  ;
    }

    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 267 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 267 "../crypto/engine/eng_list.c"
                  ;
    ...
    if (ret) {
        ...
        if (!CRYPTO_UP_REF(&ret->struct_ref, &ref)) {
            CRYPTO_THREAD_unlock(global_engine_lock);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",274,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 274 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 274 "../crypto/engine/eng_list.c"
           );
            return 
# 275 "../crypto/engine/eng_list.c" 3 4
                  ((void *)0)
# 275 "../crypto/engine/eng_list.c"
                      ;
        }
        ((void)0);
    }
...
{
    ENGINE *ret = 
# 286 "../crypto/engine/eng_list.c" 3 4
                 ((void *)0)
# 286 "../crypto/engine/eng_list.c"
                     ;
    if (e == 
# 287 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 287 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",288,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 288 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 288 "../crypto/engine/eng_list.c"
       );
        return 
# 289 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 289 "../crypto/engine/eng_list.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 292 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 292 "../crypto/engine/eng_list.c"
                  ;
    ret = e->next;
    if (ret) {
        int ref;
        ...
        if (!CRYPTO_UP_REF(&ret->struct_ref, &ref)) {
            CRYPTO_THREAD_unlock(global_engine_lock);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",300,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 300 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 300 "../crypto/engine/eng_list.c"
           );
            return 
# 301 "../crypto/engine/eng_list.c" 3 4
                  ((void *)0)
# 301 "../crypto/engine/eng_list.c"
                      ;
        }
        ((void)0);
    }
...
{
    ENGINE *ret = 
# 313 "../crypto/engine/eng_list.c" 3 4
                 ((void *)0)
# 313 "../crypto/engine/eng_list.c"
                     ;
    if (e == 
# 314 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 314 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",315,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 315 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 315 "../crypto/engine/eng_list.c"
       );
        return 
# 316 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 316 "../crypto/engine/eng_list.c"
                  ;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 319 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 319 "../crypto/engine/eng_list.c"
                  ;
    ret = e->prev;
    if (ret) {
        int ref;
        ...
        if (!CRYPTO_UP_REF(&ret->struct_ref, &ref)) {
            CRYPTO_THREAD_unlock(global_engine_lock);
            (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",327,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 327 "../crypto/engine/eng_list.c" 3 4
           ((void *)0)
# 327 "../crypto/engine/eng_list.c"
           );
            return 
# 328 "../crypto/engine/eng_list.c" 3 4
                  ((void *)0)
# 328 "../crypto/engine/eng_list.c"
                      ;
        }
        ((void)0);
    }
...
int ENGINE_add(ENGINE *e)
{
    int to_return = 1;
    if (e == 
# 342 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 342 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",343,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 343 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 343 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    if ((e->id == 
# 346 "../crypto/engine/eng_list.c" 3 4
                 ((void *)0)
# 346 "../crypto/engine/eng_list.c"
                     ) || (e->name == 
# 346 "../crypto/engine/eng_list.c" 3 4
                                      ((void *)0)
# 346 "../crypto/engine/eng_list.c"
                                          )) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",347,__func__), ERR_set_error)((38),(108),
# 347 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 347 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
    ...
    if (!engine_list_add(e)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",353,__func__), ERR_set_error)((38),(110),
# 353 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 353 "../crypto/engine/eng_list.c"
       );
        to_return = 0;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
...
int ENGINE_remove(ENGINE *e)
{
    int to_return = 1;
    if (e == 
# 364 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 364 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",365,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 365 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 365 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
    ...
    if (!engine_list_remove(e)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",371,__func__), ERR_set_error)((38),(110),
# 371 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 371 "../crypto/engine/eng_list.c"
       );
        to_return = 0;
    }
    CRYPTO_THREAD_unlock(global_engine_lock);
...
static void engine_cpy(ENGINE *dest, const ENGINE *src)
{
    ...
    engine_add_dynamic_id(dest, 
# 405 "../crypto/engine/eng_list.c" 3 4
                               ((void *)0)
# 405 "../crypto/engine/eng_list.c"
                                   , 0);
}
...
ENGINE *ENGINE_by_id(const char *id)
{
    ENGINE *iterator;
    char *load_dir = 
# 411 "../crypto/engine/eng_list.c" 3 4
                    ((void *)0)
# 411 "../crypto/engine/eng_list.c"
                        ;
    if (id == 
# 412 "../crypto/engine/eng_list.c" 3 4
             ((void *)0)
# 412 "../crypto/engine/eng_list.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",413,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 413 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 413 "../crypto/engine/eng_list.c"
       );
        return 
# 414 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 414 "../crypto/engine/eng_list.c"
                  ;
    }
    ...
    if (!(CRYPTO_THREAD_run_once(&engine_lock_init, do_engine_lock_init_ossl_) ? do_engine_lock_init_ossl_ret_ : 0)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",420,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 420 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 420 "../crypto/engine/eng_list.c"
       );
        return 
# 421 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 421 "../crypto/engine/eng_list.c"
                  ;
    }

    if (!CRYPTO_THREAD_write_lock(global_engine_lock))
        return 
# 425 "../crypto/engine/eng_list.c" 3 4
              ((void *)0)
# 425 "../crypto/engine/eng_list.c"
                  ;
    iterator = engine_list_head;
    while (iterator && (strcmp(id, iterator->id) != 0))
        iterator = iterator->next;
    if (iterator != 
# 429 "../crypto/engine/eng_list.c" 3 4
                   ((void *)0)
# 429 "../crypto/engine/eng_list.c"
                       ) {
        ...
        if (iterator->flags & (int)0x0004) {
            ...
            if (cp == 
# 437 "../crypto/engine/eng_list.c" 3 4
                     ((void *)0)
# 437 "../crypto/engine/eng_list.c"
                         )
                iterator = 
# 438 "../crypto/engine/eng_list.c" 3 4
                          ((void *)0)
# 438 "../crypto/engine/eng_list.c"
                              ;
            else {
            ...
            if (!CRYPTO_UP_REF(&iterator->struct_ref, &ref)) {
                CRYPTO_THREAD_unlock(global_engine_lock);
                (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",448,__func__), ERR_set_error)((38),((15 | (0x2 << 18L))),
# 448 "../crypto/engine/eng_list.c" 3 4
               ((void *)0)
# 448 "../crypto/engine/eng_list.c"
               );
                return 
# 449 "../crypto/engine/eng_list.c" 3 4
                      ((void *)0)
# 449 "../crypto/engine/eng_list.c"
                          ;
            }
            ((void)0);
        }
    ...
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (iterator != 
# 455 "../crypto/engine/eng_list.c" 3 4
                   ((void *)0)
# 455 "../crypto/engine/eng_list.c"
                       )
        return iterator;
    ...
    if (strcmp(id, "dynamic")) {
        if ((load_dir = ossl_safe_getenv("OPENSSL_ENGINES")) == 
# 461 "../crypto/engine/eng_list.c" 3 4
                                                               ((void *)0)
# 461 "../crypto/engine/eng_list.c"
                                                                   )
            load_dir = "/root/AsmXoM/evaluation/openssl-3.3.5/build/lib64/engines-3";
        ...
        if (!iterator || !ENGINE_ctrl_cmd_string(iterator, "ID", id, 0) ||
            ...
            !ENGINE_ctrl_cmd_string(iterator, "LOAD", 
# 469 "../crypto/engine/eng_list.c" 3 4
                                                     ((void *)0)
# 469 "../crypto/engine/eng_list.c"
                                                         , 0))
            goto notfound;
        return iterator;
    }
 notfound:
    ...
    (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",475,__func__), ERR_set_error)(38, 116, "id=%s", id);
    return 
# 476 "../crypto/engine/eng_list.c" 3 4
          ((void *)0)
# 476 "../crypto/engine/eng_list.c"
              ;
...
int ENGINE_up_ref(ENGINE *e)
{
    int i;
    if (e == 
# 483 "../crypto/engine/eng_list.c" 3 4
            ((void *)0)
# 483 "../crypto/engine/eng_list.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/engine/eng_list.c",484,__func__), ERR_set_error)((38),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 484 "../crypto/engine/eng_list.c" 3 4
       ((void *)0)
# 484 "../crypto/engine/eng_list.c"
       );
        return 0;
    }
