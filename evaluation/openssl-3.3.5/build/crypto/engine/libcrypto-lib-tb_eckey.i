# 0 "../crypto/engine/tb_eckey.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/tb_eckey.c"
# 13 "../crypto/engine/tb_eckey.c"
...
# 14 "../crypto/engine/tb_eckey.c" 2

static ENGINE_TABLE *dh_table = 
# 15 "../crypto/engine/tb_eckey.c" 3 4
                               ((void *)0)
# 15 "../crypto/engine/tb_eckey.c"
                                   ;
...
{
    if (e->ec_meth != 
# 30 "../crypto/engine/tb_eckey.c" 3 4
                     ((void *)0)
# 30 "../crypto/engine/tb_eckey.c"
                         )
...
{
    if (e->ec_meth != 
# 47 "../crypto/engine/tb_eckey.c" 3 4
                     ((void *)0)
# 47 "../crypto/engine/tb_eckey.c"
                         )
        return engine_table_register(&dh_table,
                                     engine_unregister_all_EC, e, &dummy_nid,
                                     1, 1);
