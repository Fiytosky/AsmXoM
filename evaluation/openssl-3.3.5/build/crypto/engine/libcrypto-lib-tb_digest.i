# 0 "../crypto/engine/tb_digest.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/engine/tb_digest.c"
# 13 "../crypto/engine/tb_digest.c"
...
# 14 "../crypto/engine/tb_digest.c" 2

static ENGINE_TABLE *digest_table = 
# 15 "../crypto/engine/tb_digest.c" 3 4
                                   ((void *)0)
# 15 "../crypto/engine/tb_digest.c"
                                       ;
...
# 31 "../crypto/engine/tb_digest.c" 3 4
                                    ((void *)0)
# 31 "../crypto/engine/tb_digest.c"
                                        , &nids, 0);
        if (num_nids > 0)
...
int ENGINE_set_default_digests(ENGINE *e)
{
    if (e->digests) {
        const int *nids;
        int num_nids = e->digests(e, 
# 52 "../crypto/engine/tb_digest.c" 3 4
                                    ((void *)0)
# 52 "../crypto/engine/tb_digest.c"
                                        , &nids, 0);
        if (num_nids > 0)
            return engine_table_register(&digest_table,
                                         engine_unregister_all_digests, e,
...
const EVP_MD *ENGINE_get_digest(ENGINE *e, int nid)
{
    ...
    if (!fn || !fn(e, &ret, 
# 77 "../crypto/engine/tb_digest.c" 3 4
                           ((void *)0)
# 77 "../crypto/engine/tb_digest.c"
                               , nid)) {
        (ERR_new(), ERR_set_debug("../crypto/engine/tb_digest.c",78,__func__), ERR_set_error)((38),(147),
# 78 "../crypto/engine/tb_digest.c" 3 4
       ((void *)0)
# 78 "../crypto/engine/tb_digest.c"
       );
        return 
# 79 "../crypto/engine/tb_digest.c" 3 4
              ((void *)0)
# 79 "../crypto/engine/tb_digest.c"
                  ;
    }
    return ret;
}
