...
# 14 "../crypto/params.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 15 "../crypto/params.c" 2
...
{
    return p != 
# 82 "../crypto/params.c" 3 4
               ((void *)0) 
# 82 "../crypto/params.c"
                    && p->return_size != ((size_t)-1);
}

void OSSL_PARAM_set_all_unmodified(OSSL_PARAM *p)
{
    if (p != 
# 87 "../crypto/params.c" 3 4
            ((void *)0)
# 87 "../crypto/params.c"
                )
        while (p->key != 
# 88 "../crypto/params.c" 3 4
                        ((void *)0)
# 88 "../crypto/params.c"
                            )
            p++->return_size = ((size_t)-1);
...
static int is_negative(const void *number, size_t s)
{
    ...
    return 0x80 & ((!ossl_is_little_endian) ? n[0] : n[s - 1]);
}
    ...
    if ((!ossl_is_little_endian)) {
        if (src_len < dest_len) {
            ...
            if (!check_sign_bytes(src, n, pad)
                ...
                (ERR_new(), ERR_set_debug("../crypto/params.c",137,__func__), ERR_set_error)((15),(126),
# 137 "../crypto/params.c" 3 4
               ((void *)0)
# 137 "../crypto/params.c"
               );
                return 0;
        ...
        if (src_len < dest_len) {
            ...
            if (!check_sign_bytes(src + dest_len, n, pad)
                ...
                (ERR_new(), ERR_set_debug("../crypto/params.c",155,__func__), ERR_set_error)((15),(126),
# 155 "../crypto/params.c" 3 4
               ((void *)0)
# 155 "../crypto/params.c"
               );
                return 0;
                                ...
                                const void *src, size_t src_len)
{
    if (is_negative(src, src_len)) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",184,__func__), ERR_set_error)((15),(125),
# 184 "../crypto/params.c" 3 4
       ((void *)0)
# 184 "../crypto/params.c"
       );
        return 0;
...
{
    if (p->data == 
# 200 "../crypto/params.c" 3 4
                  ((void *)0)
# 200 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",201,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 201 "../crypto/params.c" 3 4
       ((void *)0)
# 201 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",208,__func__), ERR_set_error)((15),(124),
# 208 "../crypto/params.c" 3 4
   ((void *)0)
# 208 "../crypto/params.c"
   );
    return 0;
...
# 218 "../crypto/params.c"
    ...
    if (p->data_type == 1)
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",225,__func__), ERR_set_error)((15),(124),
# 225 "../crypto/params.c" 3 4
       ((void *)0)
# 225 "../crypto/params.c"
       );
...
static int general_get_uint(const OSSL_PARAM *p, void *val, size_t val_size)
{
    ...
    if (p->data == 
# 234 "../crypto/params.c" 3 4
                  ((void *)0)
# 234 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",235,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 235 "../crypto/params.c" 3 4
       ((void *)0)
# 235 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",242,__func__), ERR_set_error)((15),(124),
# 242 "../crypto/params.c" 3 4
   ((void *)0)
# 242 "../crypto/params.c"
   );
    return 0;
...
# 252 "../crypto/params.c"
    ...
    if (p->data_type == 1)
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",259,__func__), ERR_set_error)((15),(124),
# 259 "../crypto/params.c" 3 4
       ((void *)0)
# 259 "../crypto/params.c"
       );
    p->return_size = r ? p->data_size : val_size;
...
OSSL_PARAM OSSL_PARAM_construct_int(const char *key, int *buf)
{
    return ossl_param_construct(key, 1, buf, sizeof(int));
}
...
OSSL_PARAM OSSL_PARAM_construct_uint(const char *key, unsigned int *buf)
{
    return ossl_param_construct(key, 2, buf,
                                sizeof(unsigned int));
}
...
OSSL_PARAM OSSL_PARAM_construct_long(const char *key, long int *buf)
{
    return ossl_param_construct(key, 1, buf, sizeof(long int));
}
...
# 392 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",393,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 393 "../crypto/params.c" 3 4
       ((void *)0)
# 393 "../crypto/params.c"
       );
        return 0;
    ...
    if (p->data == 
# 397 "../crypto/params.c" 3 4
                  ((void *)0)
# 397 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",398,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 398 "../crypto/params.c" 3 4
       ((void *)0)
# 398 "../crypto/params.c"
       );
        return 0;
...
# 412 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",416,__func__), ERR_set_error)((15),(126),
# 416 "../crypto/params.c" 3 4
           ((void *)0)
# 416 "../crypto/params.c"
           );
            return 0;
...
# 430 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",434,__func__), ERR_set_error)((15),(126),
# 434 "../crypto/params.c" 3 4
           ((void *)0)
# 434 "../crypto/params.c"
           );
            return 0;
...
# 438 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",442,__func__), ERR_set_error)((15),(126),
# 442 "../crypto/params.c" 3 4
           ((void *)0)
# 442 "../crypto/params.c"
           );
            return 0;
...
# 455 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",459,__func__), ERR_set_error)((15),(126),
# 459 "../crypto/params.c" 3 4
           ((void *)0)
# 459 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",462,__func__), ERR_set_error)((15),(130),
# 462 "../crypto/params.c" 3 4
       ((void *)0)
# 462 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",466,__func__), ERR_set_error)((15),(129),
# 466 "../crypto/params.c" 3 4
   ((void *)0)
# 466 "../crypto/params.c"
   );
    return 0;
...
{
    if (p == 
# 472 "../crypto/params.c" 3 4
            ((void *)0)
# 472 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",473,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 473 "../crypto/params.c" 3 4
       ((void *)0)
# 473 "../crypto/params.c"
       );
        return 0;
...
# 480 "../crypto/params.c"
        ...
        return general_set_int(p, &val, sizeof(val));
    } else if (p->data_type == 2 && val >= 0) {

        p->return_size = sizeof(uint32_t);
        if (p->data == 
# 496 "../crypto/params.c" 3 4
                      ((void *)0)
# 496 "../crypto/params.c"
                          )
            return 1;
...
# 515 "../crypto/params.c"
        ...
        case sizeof(double):
            ...
            if (shift < 8 * sizeof(val) - 1) {
                u32 = val < 0 ? -val : val;
                if ((u32 >> shift) != 0) {
                    (ERR_new(), ERR_set_debug("../crypto/params.c",523,__func__), ERR_set_error)((15),(123),
# 523 "../crypto/params.c" 3 4
                   ((void *)0)
# 523 "../crypto/params.c"
                   );
                    return 0;
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",530,__func__), ERR_set_error)((15),(130),
# 530 "../crypto/params.c" 3 4
       ((void *)0)
# 530 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",534,__func__), ERR_set_error)((15),(129),
# 534 "../crypto/params.c" 3 4
   ((void *)0)
# 534 "../crypto/params.c"
   );
    return 0;
...
OSSL_PARAM OSSL_PARAM_construct_int32(const char *key, int32_t *buf)
{
    return ossl_param_construct(key, 1, buf,
                                sizeof(int32_t));
}
...
# 546 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",547,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 547 "../crypto/params.c" 3 4
       ((void *)0)
# 547 "../crypto/params.c"
       );
        return 0;
    ...
    if (p->data == 
# 551 "../crypto/params.c" 3 4
                  ((void *)0)
# 551 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",552,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 552 "../crypto/params.c" 3 4
       ((void *)0)
# 552 "../crypto/params.c"
       );
        return 0;
...
# 566 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",570,__func__), ERR_set_error)((15),(126),
# 570 "../crypto/params.c" 3 4
           ((void *)0)
# 570 "../crypto/params.c"
           );
            return 0;
        ...
        case sizeof(int32_t):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",587,__func__), ERR_set_error)((15),(125),
# 587 "../crypto/params.c" 3 4
           ((void *)0)
# 587 "../crypto/params.c"
           );
            return 0;
...
# 591 "../crypto/params.c"
            ...
            if (i64 < 0)
                (ERR_new(), ERR_set_debug("../crypto/params.c",596,__func__), ERR_set_error)((15),(125),
# 596 "../crypto/params.c" 3 4
               ((void *)0)
# 596 "../crypto/params.c"
               );
            else
                (ERR_new(), ERR_set_debug("../crypto/params.c",598,__func__), ERR_set_error)((15),(126),
# 598 "../crypto/params.c" 3 4
               ((void *)0)
# 598 "../crypto/params.c"
               );
            return 0;
...
# 610 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",614,__func__), ERR_set_error)((15),(123),
# 614 "../crypto/params.c" 3 4
           ((void *)0)
# 614 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",617,__func__), ERR_set_error)((15),(130),
# 617 "../crypto/params.c" 3 4
       ((void *)0)
# 617 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",621,__func__), ERR_set_error)((15),(129),
# 621 "../crypto/params.c" 3 4
   ((void *)0)
# 621 "../crypto/params.c"
   );
    return 0;
...
{
    if (p == 
# 627 "../crypto/params.c" 3 4
            ((void *)0)
# 627 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",628,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 628 "../crypto/params.c" 3 4
       ((void *)0)
# 628 "../crypto/params.c"
       );
        return 0;
...
# 656 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",660,__func__), ERR_set_error)((15),(126),
# 660 "../crypto/params.c" 3 4
           ((void *)0)
# 660 "../crypto/params.c"
           );
            return 0;
...
# 674 "../crypto/params.c"
        ...
        case sizeof(double):
            ...
            if (shift < 8 * sizeof(val) && (val >> shift) != 0) {
                (ERR_new(), ERR_set_debug("../crypto/params.c",680,__func__), ERR_set_error)((15),(123),
# 680 "../crypto/params.c" 3 4
               ((void *)0)
# 680 "../crypto/params.c"
               );
                return 0;
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",686,__func__), ERR_set_error)((15),(130),
# 686 "../crypto/params.c" 3 4
       ((void *)0)
# 686 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",690,__func__), ERR_set_error)((15),(129),
# 690 "../crypto/params.c" 3 4
   ((void *)0)
# 690 "../crypto/params.c"
   );
    return 0;
...
# 702 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",703,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 703 "../crypto/params.c" 3 4
       ((void *)0)
# 703 "../crypto/params.c"
       );
        return 0;
    ...
    if (p->data == 
# 707 "../crypto/params.c" 3 4
                  ((void *)0)
# 707 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",708,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 708 "../crypto/params.c" 3 4
       ((void *)0)
# 708 "../crypto/params.c"
       );
        return 0;
...
# 734 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",738,__func__), ERR_set_error)((15),(126),
# 738 "../crypto/params.c" 3 4
           ((void *)0)
# 738 "../crypto/params.c"
           );
            return 0;
...
# 756 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",761,__func__), ERR_set_error)((15),(123),
# 761 "../crypto/params.c" 3 4
           ((void *)0)
# 761 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",764,__func__), ERR_set_error)((15),(130),
# 764 "../crypto/params.c" 3 4
       ((void *)0)
# 764 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",768,__func__), ERR_set_error)((15),(129),
# 768 "../crypto/params.c" 3 4
   ((void *)0)
# 768 "../crypto/params.c"
   );
    return 0;
...
{
    if (p == 
# 774 "../crypto/params.c" 3 4
            ((void *)0)
# 774 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",775,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 775 "../crypto/params.c" 3 4
       ((void *)0)
# 775 "../crypto/params.c"
       );
        return 0;
...
# 786 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",791,__func__), ERR_set_error)((15),(126),
# 791 "../crypto/params.c" 3 4
           ((void *)0)
# 791 "../crypto/params.c"
           );
            return 0;
...
# 806 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",811,__func__), ERR_set_error)((15),(126),
# 811 "../crypto/params.c" 3 4
           ((void *)0)
# 811 "../crypto/params.c"
           );
            return 0;
...
# 824 "../crypto/params.c"
        ...
        case sizeof(double):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",833,__func__), ERR_set_error)((15),(123),
# 833 "../crypto/params.c" 3 4
           ((void *)0)
# 833 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",836,__func__), ERR_set_error)((15),(130),
# 836 "../crypto/params.c" 3 4
       ((void *)0)
# 836 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",840,__func__), ERR_set_error)((15),(129),
# 840 "../crypto/params.c" 3 4
   ((void *)0)
# 840 "../crypto/params.c"
   );
    return 0;
...
OSSL_PARAM OSSL_PARAM_construct_int64(const char *key, int64_t *buf)
{
    return ossl_param_construct(key, 1, buf, sizeof(int64_t));
}

int OSSL_PARAM_get_uint64(const OSSL_PARAM *p, uint64_t *val)
{
    if (val == 
# 851 "../crypto/params.c" 3 4
              ((void *)0) 
# 851 "../crypto/params.c"
                   || p == 
# 851 "../crypto/params.c" 3 4
...
# 851 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",852,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 852 "../crypto/params.c" 3 4
       ((void *)0)
# 852 "../crypto/params.c"
       );
        return 0;
    ...
    if (p->data == 
# 856 "../crypto/params.c" 3 4
                  ((void *)0)
# 856 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",857,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 857 "../crypto/params.c" 3 4
       ((void *)0)
# 857 "../crypto/params.c"
       );
        return 0;
    ...
    if (p->data_type == 2) {
        ...
        case sizeof(int32_t):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",885,__func__), ERR_set_error)((15),(125),
# 885 "../crypto/params.c" 3 4
           ((void *)0)
# 885 "../crypto/params.c"
           );
            return 0;
        case sizeof(int64_t):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",893,__func__), ERR_set_error)((15),(125),
# 893 "../crypto/params.c" 3 4
           ((void *)0)
# 893 "../crypto/params.c"
           );
            return 0;
...
# 911 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",916,__func__), ERR_set_error)((15),(123),
# 916 "../crypto/params.c" 3 4
           ((void *)0)
# 916 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",919,__func__), ERR_set_error)((15),(130),
# 919 "../crypto/params.c" 3 4
       ((void *)0)
# 919 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",923,__func__), ERR_set_error)((15),(129),
# 923 "../crypto/params.c" 3 4
   ((void *)0)
# 923 "../crypto/params.c"
   );
    return 0;
...
{
    if (p == 
# 929 "../crypto/params.c" 3 4
            ((void *)0)
# 929 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",930,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 930 "../crypto/params.c" 3 4
       ((void *)0)
# 930 "../crypto/params.c"
       );
        return 0;
...
# 942 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",947,__func__), ERR_set_error)((15),(126),
# 947 "../crypto/params.c" 3 4
           ((void *)0)
# 947 "../crypto/params.c"
           );
            return 0;
...
# 962 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",967,__func__), ERR_set_error)((15),(126),
# 967 "../crypto/params.c" 3 4
           ((void *)0)
# 967 "../crypto/params.c"
           );
            return 0;
...
# 970 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",974,__func__), ERR_set_error)((15),(126),
# 974 "../crypto/params.c" 3 4
           ((void *)0)
# 974 "../crypto/params.c"
           );
            return 0;
        ...
        case sizeof(double):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",988,__func__), ERR_set_error)((15),(123),
# 988 "../crypto/params.c" 3 4
           ((void *)0)
# 988 "../crypto/params.c"
           );
            return 0;
        }
        (ERR_new(), ERR_set_debug("../crypto/params.c",991,__func__), ERR_set_error)((15),(130),
# 991 "../crypto/params.c" 3 4
       ((void *)0)
# 991 "../crypto/params.c"
       );
        return 0;
    ...
    (ERR_new(), ERR_set_debug("../crypto/params.c",995,__func__), ERR_set_error)((15),(129),
# 995 "../crypto/params.c" 3 4
   ((void *)0)
# 995 "../crypto/params.c"
   );
    return 0;
...
OSSL_PARAM OSSL_PARAM_construct_time_t(const char *key, time_t *buf)
{
    return ossl_param_construct(key, 1, buf, sizeof(time_t));
}

int OSSL_PARAM_get_BN(const OSSL_PARAM *p, BIGNUM **val)
{
    BIGNUM *b = 
# 1070 "../crypto/params.c" 3 4
               ((void *)0)
# 1070 "../crypto/params.c"
                   ;

    if (val == 
# 1072 "../crypto/params.c" 3 4
              ((void *)0) 
# 1072 "../crypto/params.c"
                   || p == 
# 1072 "../crypto/params.c" 3 4
                           ((void *)0) 
# 1072 "../crypto/params.c"
...
# 1072 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",1073,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1073 "../crypto/params.c" 3 4
       ((void *)0)
# 1073 "../crypto/params.c"
       );
        return 0;
    }
    ...
    case 1:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/params.c",1085,__func__), ERR_set_error)((15),(129),
# 1085 "../crypto/params.c" 3 4
       ((void *)0)
# 1085 "../crypto/params.c"
       );
        break;
    }

    if (b == 
# 1089 "../crypto/params.c" 3 4
            ((void *)0)
# 1089 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1090,__func__), ERR_set_error)((15),((3 | (0x2 << 18L))),
# 1090 "../crypto/params.c" 3 4
       ((void *)0)
# 1090 "../crypto/params.c"
       );
        return 0;
    }
...
int OSSL_PARAM_set_BN(OSSL_PARAM *p, const BIGNUM *val)
{
    ...
    if (p == 
# 1102 "../crypto/params.c" 3 4
            ((void *)0)
# 1102 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1103,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1103 "../crypto/params.c" 3 4
       ((void *)0)
# 1103 "../crypto/params.c"
       );
        return 0;
    }
    p->return_size = 0;
    if (val == 
# 1107 "../crypto/params.c" 3 4
              ((void *)0)
# 1107 "../crypto/params.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1108,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1108 "../crypto/params.c" 3 4
       ((void *)0)
# 1108 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data_type == 2 && BN_is_negative(val)) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1112,__func__), ERR_set_error)((15),(129),
# 1112 "../crypto/params.c" 3 4
       ((void *)0)
# 1112 "../crypto/params.c"
       );
        return 0;
    }

    bytes = (size_t)((BN_num_bits(val)+7)/8);
    ...
    p->return_size = bytes;
    if (p->data == 
# 1125 "../crypto/params.c" 3 4
                  ((void *)0)
# 1125 "../crypto/params.c"
                      )
        return 1;
    if (p->data_size >= bytes) {
        ...
        case 2:
            if (BN_bn2nativepad(val, p->data, p->data_size) >= 0)
                return 1;
            (ERR_new(), ERR_set_debug("../crypto/params.c",1134,__func__), ERR_set_error)((15),(127),
# 1134 "../crypto/params.c" 3 4
           ((void *)0)
# 1134 "../crypto/params.c"
           );
            break;
        case 1:
            if (BN_signed_bn2native(val, p->data, p->data_size) >= 0)
                return 1;
            (ERR_new(), ERR_set_debug("../crypto/params.c",1139,__func__), ERR_set_error)((15),(127),
# 1139 "../crypto/params.c" 3 4
           ((void *)0)
# 1139 "../crypto/params.c"
           );
            break;
        default:
            (ERR_new(), ERR_set_debug("../crypto/params.c",1142,__func__), ERR_set_error)((15),(129),
# 1142 "../crypto/params.c" 3 4
           ((void *)0)
# 1142 "../crypto/params.c"
           );
            break;
        }
        return 0;
    }
    (ERR_new(), ERR_set_debug("../crypto/params.c",1147,__func__), ERR_set_error)((15),(116),
# 1147 "../crypto/params.c" 3 4
   ((void *)0)
# 1147 "../crypto/params.c"
   );
    return 0;
}
...
OSSL_PARAM OSSL_PARAM_construct_BN(const char *key, unsigned char *buf,
                                   size_t bsize)
{
    return ossl_param_construct(key, 2,
                                buf, bsize);
}
...
int OSSL_PARAM_get_double(const OSSL_PARAM *p, double *val)
{
    ...
    if (val == 
# 1164 "../crypto/params.c" 3 4
              ((void *)0) 
# 1164 "../crypto/params.c"
                   || p == 
# 1164 "../crypto/params.c" 3 4
                           ((void *)0) 
# 1164 "../crypto/params.c"
...
# 1164 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",1165,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1165 "../crypto/params.c" 3 4
       ((void *)0)
# 1165 "../crypto/params.c"
       );
        return 0;
    }
    ...
    if (p->data_type == 3) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",1175,__func__), ERR_set_error)((15),(130),
# 1175 "../crypto/params.c" 3 4
       ((void *)0)
# 1175 "../crypto/params.c"
       );
        return 0;
    } else if (p->data_type == 2) {
        switch (p->data_size) {
        ...
        case sizeof(uint64_t):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",1188,__func__), ERR_set_error)((15),(123),
# 1188 "../crypto/params.c" 3 4
           ((void *)0)
# 1188 "../crypto/params.c"
           );
            return 0;
        }
    } else if (p->data_type == 1) {
        ...
        case sizeof(int64_t):
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",1203,__func__), ERR_set_error)((15),(123),
# 1203 "../crypto/params.c" 3 4
           ((void *)0)
# 1203 "../crypto/params.c"
           );
            return 0;
        }
    }
    (ERR_new(), ERR_set_debug("../crypto/params.c",1207,__func__), ERR_set_error)((15),(129),
# 1207 "../crypto/params.c" 3 4
   ((void *)0)
# 1207 "../crypto/params.c"
   );
    return 0;
}
...
{
    if (p == 
# 1213 "../crypto/params.c" 3 4
            ((void *)0)
# 1213 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1214,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1214 "../crypto/params.c" 3 4
       ((void *)0)
# 1214 "../crypto/params.c"
       );
        return 0;
    }
    p->return_size = 0;
    ...
    if (p->data_type == 3) {
        p->return_size = sizeof(double);
        if (p->data == 
# 1221 "../crypto/params.c" 3 4
                      ((void *)0)
# 1221 "../crypto/params.c"
                          )
            return 1;
        switch (p->data_size) {
        case sizeof(double):
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",1228,__func__), ERR_set_error)((15),(130),
# 1228 "../crypto/params.c" 3 4
       ((void *)0)
# 1228 "../crypto/params.c"
       );
        return 0;
    } else if (p->data_type == 2) {
        p->return_size = sizeof(double);
        if (p->data == 
# 1232 "../crypto/params.c" 3 4
                      ((void *)0)
# 1232 "../crypto/params.c"
                          )
            return 1;
        if (val != (uint64_t)val) {
            (ERR_new(), ERR_set_debug("../crypto/params.c",1235,__func__), ERR_set_error)((15),(123),
# 1235 "../crypto/params.c" 3 4
           ((void *)0)
# 1235 "../crypto/params.c"
           );
            return 0;
        }
        switch (p->data_size) {
        case sizeof(uint32_t):
            if (val >= 0 && val <= 
# 1240 "../crypto/params.c" 3 4
                                  (4294967295U)
# 1240 "../crypto/params.c"
                                            ) {
                p->return_size = sizeof(uint32_t);
                *(uint32_t *)p->data = (uint32_t)val;
                return 1;
            }
            (ERR_new(), ERR_set_debug("../crypto/params.c",1245,__func__), ERR_set_error)((15),(126),
# 1245 "../crypto/params.c" 3 4
           ((void *)0)
# 1245 "../crypto/params.c"
           );
            return 0;
        case sizeof(uint64_t):
            if (val >= 0
                    ...
                    && val < (double)(
# 1254 "../crypto/params.c" 3 4
                                     (18446744073709551615UL) 
# 1254 "../crypto/params.c"
                                                - 65535) + 65536.0) {
                p->return_size = sizeof(uint64_t);
                *(uint64_t *)p->data = (uint64_t)val;
                return 1;
            }
            (ERR_new(), ERR_set_debug("../crypto/params.c",1259,__func__), ERR_set_error)((15),(126),
# 1259 "../crypto/params.c" 3 4
           ((void *)0)
# 1259 "../crypto/params.c"
           );
            return 0;
        }
    } else if (p->data_type == 1) {
        p->return_size = sizeof(double);
        if (p->data == 
# 1264 "../crypto/params.c" 3 4
                      ((void *)0)
# 1264 "../crypto/params.c"
                          )
            return 1;
        if (val != (int64_t)val) {
            (ERR_new(), ERR_set_debug("../crypto/params.c",1267,__func__), ERR_set_error)((15),(123),
# 1267 "../crypto/params.c" 3 4
           ((void *)0)
# 1267 "../crypto/params.c"
           );
            return 0;
        }
        switch (p->data_size) {
        case sizeof(int32_t):
            if (val >= 
# 1272 "../crypto/params.c" 3 4
                      (-2147483647-1) 
# 1272 "../crypto/params.c"
                                && val <= 
# 1272 "../crypto/params.c" 3 4
                                          (2147483647)
# 1272 "../crypto/params.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",1277,__func__), ERR_set_error)((15),(126),
# 1277 "../crypto/params.c" 3 4
           ((void *)0)
# 1277 "../crypto/params.c"
           );
            return 0;
        case sizeof(int64_t):
            if (val >= 
# 1280 "../crypto/params.c" 3 4
                      (-9223372036854775807L -1)
...
# 1286 "../crypto/params.c"
                   && val < (double)(
# 1286 "../crypto/params.c" 3 4
                                     (9223372036854775807L) 
# 1286 "../crypto/params.c"
                                               - 65535) + 65536.0) {
                p->return_size = sizeof(int64_t);
            ...
            (ERR_new(), ERR_set_debug("../crypto/params.c",1291,__func__), ERR_set_error)((15),(126),
# 1291 "../crypto/params.c" 3 4
           ((void *)0)
# 1291 "../crypto/params.c"
           );
            return 0;
        }
    }
    (ERR_new(), ERR_set_debug("../crypto/params.c",1295,__func__), ERR_set_error)((15),(129),
# 1295 "../crypto/params.c" 3 4
   ((void *)0)
# 1295 "../crypto/params.c"
   );
    return 0;
}
...
OSSL_PARAM OSSL_PARAM_construct_double(const char *key, double *buf)
{
    return ossl_param_construct(key, 3, buf, sizeof(double));
}
                               ...
                               unsigned int type)
{
    ...
    if ((val == 
# 1311 "../crypto/params.c" 3 4
               ((void *)0) 
# 1311 "../crypto/params.c"
                    && used_len == 
# 1311 "../crypto/params.c" 3 4
                                   ((void *)0)
# 1311 "../crypto/params.c"
...
# 1311 "../crypto/params.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/params.c",1312,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1312 "../crypto/params.c" 3 4
       ((void *)0)
# 1312 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data_type != type) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1316,__func__), ERR_set_error)((15),(129),
# 1316 "../crypto/params.c" 3 4
       ((void *)0)
# 1316 "../crypto/params.c"
       );
        return 0;
    }
    ...
    alloc_sz = sz + (type == 4 || sz == 0);

    if (used_len != 
# 1327 "../crypto/params.c" 3 4
                   ((void *)0)
# 1327 "../crypto/params.c"
                       )
        *used_len = sz;

    if (p->data == 
# 1330 "../crypto/params.c" 3 4
                  ((void *)0)
# 1330 "../crypto/params.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1331,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1331 "../crypto/params.c" 3 4
       ((void *)0)
# 1331 "../crypto/params.c"
       );
        return 0;
    }

    if (val == 
# 1335 "../crypto/params.c" 3 4
              ((void *)0)
# 1335 "../crypto/params.c"
                  )
        return 1;

    if (*val == 
# 1338 "../crypto/params.c" 3 4
               ((void *)0)
# 1338 "../crypto/params.c"
                   ) {
        char *const q = CRYPTO_malloc(alloc_sz, "../crypto/params.c", 1339);

        if (q == 
# 1341 "../crypto/params.c" 3 4
                ((void *)0)
# 1341 "../crypto/params.c"
                    )
            return 0;
        *val = q;
        *max_len = alloc_sz;
    ...
    if (*max_len < sz) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1348,__func__), ERR_set_error)((15),(116),
# 1348 "../crypto/params.c" 3 4
       ((void *)0)
# 1348 "../crypto/params.c"
       );
        return 0;
    }
...
int OSSL_PARAM_get_utf8_string(const OSSL_PARAM *p, char **val, size_t max_len)
{
    int ret = get_string_internal(p, (void **)val, &max_len, 
# 1357 "../crypto/params.c" 3 4
                                                            ((void *)0)
# 1357 "../crypto/params.c"
                                                                ,
                                  4);
# 1371 "../crypto/params.c"
    ...
    if (data_length >= max_len) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1378,__func__), ERR_set_error)((15),(128),
# 1378 "../crypto/params.c" 3 4
       ((void *)0)
# 1378 "../crypto/params.c"
       );
        return 0;
    }
    (*val)[data_length] = '\0';
                               ...
                               unsigned int type)
{
    p->return_size = len;
    if (p->data == 
# 1397 "../crypto/params.c" 3 4
                  ((void *)0)
# 1397 "../crypto/params.c"
                      )
        return 1;
    if (p->data_type != type) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1400,__func__), ERR_set_error)((15),(129),
# 1400 "../crypto/params.c" 3 4
       ((void *)0)
# 1400 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data_size < len) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1404,__func__), ERR_set_error)((15),(116),
# 1404 "../crypto/params.c" 3 4
       ((void *)0)
# 1404 "../crypto/params.c"
       );
        return 0;
    }
...
{
    if (p == 
# 1417 "../crypto/params.c" 3 4
            ((void *)0)
# 1417 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1418,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1418 "../crypto/params.c" 3 4
       ((void *)0)
# 1418 "../crypto/params.c"
       );
        return 0;
    }
    ...
    p->return_size = 0;
    if (val == 
# 1423 "../crypto/params.c" 3 4
              ((void *)0)
# 1423 "../crypto/params.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1424,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1424 "../crypto/params.c" 3 4
       ((void *)0)
# 1424 "../crypto/params.c"
       );
        return 0;
    }
    return set_string_internal(p, val, strlen(val), 4);
}
...
{
    if (p == 
# 1433 "../crypto/params.c" 3 4
            ((void *)0)
# 1433 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1434,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1434 "../crypto/params.c" 3 4
       ((void *)0)
# 1434 "../crypto/params.c"
       );
        return 0;
    }
    ...
    p->return_size = 0;
    if (val == 
# 1439 "../crypto/params.c" 3 4
              ((void *)0)
# 1439 "../crypto/params.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1440,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1440 "../crypto/params.c" 3 4
       ((void *)0)
# 1440 "../crypto/params.c"
       );
        return 0;
    }
    return set_string_internal(p, val, len, 5);
}
...
{
    if (buf != 
# 1449 "../crypto/params.c" 3 4
              ((void *)0) 
# 1449 "../crypto/params.c"
                   && bsize == 0)
        bsize = strlen(buf);
    return ossl_param_construct(key, 4, buf, bsize);
}

OSSL_PARAM OSSL_PARAM_construct_octet_string(const char *key, void *buf,
                                             size_t bsize)
{
    return ossl_param_construct(key, 5, buf, bsize);
}
...
{
    if (val == 
# 1463 "../crypto/params.c" 3 4
              ((void *)0) 
# 1463 "../crypto/params.c"
                   || p == 
# 1463 "../crypto/params.c" 3 4
                           ((void *)0)
# 1463 "../crypto/params.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1464,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1464 "../crypto/params.c" 3 4
       ((void *)0)
# 1464 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data_type != type) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1468,__func__), ERR_set_error)((15),(129),
# 1468 "../crypto/params.c" 3 4
       ((void *)0)
# 1468 "../crypto/params.c"
       );
        return 0;
    }
    if (used_len != 
# 1471 "../crypto/params.c" 3 4
                   ((void *)0)
# 1471 "../crypto/params.c"
                       )
...
int OSSL_PARAM_get_utf8_ptr(const OSSL_PARAM *p, const char **val)
{
    return get_ptr_internal(p, (const void **)val, 
# 1479 "../crypto/params.c" 3 4
                                                  ((void *)0)
# 1479 "../crypto/params.c"
                                                      , 6);
}
...
int OSSL_PARAM_get_octet_ptr(const OSSL_PARAM *p, const void **val,
                             size_t *used_len)
{
    return get_ptr_internal(p, val, used_len, 7);
}
                            ...
                            unsigned int type, size_t len)
{
    p->return_size = len;
    if (p->data_type != type) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1493,__func__), ERR_set_error)((15),(129),
# 1493 "../crypto/params.c" 3 4
       ((void *)0)
# 1493 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data != 
# 1496 "../crypto/params.c" 3 4
                  ((void *)0)
# 1496 "../crypto/params.c"
                      )
...
{
    if (p == 
# 1503 "../crypto/params.c" 3 4
            ((void *)0)
# 1503 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1504,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1504 "../crypto/params.c" 3 4
       ((void *)0)
# 1504 "../crypto/params.c"
       );
        return 0;
    }
    p->return_size = 0;
    return set_ptr_internal(p, val, 6,
                            val == 
# 1509 "../crypto/params.c" 3 4
                                  ((void *)0) 
# 1509 "../crypto/params.c"
                                       ? 0 : strlen(val));
}
...
{
    if (p == 
# 1515 "../crypto/params.c" 3 4
            ((void *)0)
# 1515 "../crypto/params.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1516,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1516 "../crypto/params.c" 3 4
       ((void *)0)
# 1516 "../crypto/params.c"
       );
        return 0;
    }
    p->return_size = 0;
    return set_ptr_internal(p, val, 7, used_len);
}

OSSL_PARAM OSSL_PARAM_construct_utf8_ptr(const char *key, char **buf,
                                         size_t bsize)
{
    return ossl_param_construct(key, 6, buf, bsize);
}

OSSL_PARAM OSSL_PARAM_construct_octet_ptr(const char *key, void **buf,
                                          size_t bsize)
{
    return ossl_param_construct(key, 7, buf, bsize);
}
# 1544 "../crypto/params.c"
int ossl_param_get1_octet_string(const OSSL_PARAM *params, const char *name,
                                 unsigned char **out, size_t *out_len)
{
    const OSSL_PARAM *p = OSSL_PARAM_locate_const(params, name);
    void *buf = 
# 1548 "../crypto/params.c" 3 4
               ((void *)0)
# 1548 "../crypto/params.c"
                   ;
    size_t len = 0;

    if (p == 
# 1551 "../crypto/params.c" 3 4
            ((void *)0)
# 1551 "../crypto/params.c"
                )
        return -1;

    if (p->data != 
# 1554 "../crypto/params.c" 3 4
                  ((void *)0)
            
# 1555 "../crypto/params.c"
           && p->data_size > 0
            && !OSSL_PARAM_get_octet_string(p, &buf, 0, &len))
        return 0;

    CRYPTO_clear_free(*out, *out_len, "../crypto/params.c", 1559);
    *out = buf;
    *out_len = len;
    return 1;
}
                             ...
                             unsigned char *out, size_t *outlen)
{
    ...
    if (out == 
# 1571 "../crypto/params.c" 3 4
              ((void *)0)
# 1571 "../crypto/params.c"
                  ) {
    ...
    for (; p != 
# 1579 "../crypto/params.c" 3 4
               ((void *)0)
# 1579 "../crypto/params.c"
                   ; p = OSSL_PARAM_locate_const(p + 1, name)) {
        if (p->data_type != 5)
            goto err;
        if (p->data != 
# 1582 "../crypto/params.c" 3 4
                      ((void *)0)
                
# 1583 "../crypto/params.c"
               && p->data_size != 0
                                        ...
                                        size_t *out_len, size_t maxsize)
{
    ...
    if (p == 
# 1604 "../crypto/params.c" 3 4
            ((void *)0)
# 1604 "../crypto/params.c"
                )
        return -1;


    if (!setbuf_fromparams(p, name, 
# 1608 "../crypto/params.c" 3 4
                                   ((void *)0)
# 1608 "../crypto/params.c"
                                       , &sz))
        return 0;
    ...
    if (sz == 0) {
        if ((res = CRYPTO_zalloc(1, "../crypto/params.c", 1617)) == 
# 1617 "../crypto/params.c" 3 4
                                        ((void *)0)
# 1617 "../crypto/params.c"
                                            )
            return 0;
        goto fin;
    }
    ...
    res = CRYPTO_malloc(sz, "../crypto/params.c", 1623);
    if (res == 
# 1624 "../crypto/params.c" 3 4
              ((void *)0)
# 1624 "../crypto/params.c"
                  )
        return 0;


    if (!setbuf_fromparams(p, name, res, &sz)) {
        CRYPTO_clear_free(res, sz, "../crypto/params.c", 1629);
        return 0;
    }

 fin:
    CRYPTO_clear_free(*out, *out_len, "../crypto/params.c", 1634);
    *out = res;
    *out_len = sz;
    return 1;
}
...
{
    OSSL_PARAM end = { 
# 1642 "../crypto/params.c" 3 4
                    ((void *)0)
# 1642 "../crypto/params.c"
                    , 0, 
# 1642 "../crypto/params.c" 3 4
                    ((void *)0)
# 1642 "../crypto/params.c"
...
{
    if (val == 
# 1650 "../crypto/params.c" 3 4
              ((void *)0) 
# 1650 "../crypto/params.c"
                   || p == 
# 1650 "../crypto/params.c" 3 4
                           ((void *)0)
# 1650 "../crypto/params.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1651,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1651 "../crypto/params.c" 3 4
       ((void *)0)
# 1651 "../crypto/params.c"
       );
        return 0;
    }
    if (p->data_type != type) {
        (ERR_new(), ERR_set_debug("../crypto/params.c",1655,__func__), ERR_set_error)((15),(129),
# 1655 "../crypto/params.c" 3 4
       ((void *)0)
# 1655 "../crypto/params.c"
       );
        return 0;
    }
    if (used_len != 
# 1658 "../crypto/params.c" 3 4
                   ((void *)0)
# 1658 "../crypto/params.c"
                       )
        *used_len = p->data_size;
    *val = p->data;
    return 1;
...
int OSSL_PARAM_get_utf8_string_ptr(const OSSL_PARAM *p, const char **val)
{
    ...
    return rv || get_string_ptr_internal(p, (const void **)val, 
# 1672 "../crypto/params.c" 3 4
                                                               ((void *)0)
# 1672 "../crypto/params.c"
                                                                   ,
                                         4);
}
