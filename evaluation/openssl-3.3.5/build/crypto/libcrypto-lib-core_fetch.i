# 0 "../crypto/core_fetch.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/core_fetch.c"
# 10 "../crypto/core_fetch.c"
...
static int ossl_method_construct_reserve_store(int no_store, void *cbdata)
{
    ...
    if (is_temporary_method_store(no_store, data) && data->store == 
# 38 "../crypto/core_fetch.c" 3 4
                                                                   ((void *)0)
# 38 "../crypto/core_fetch.c"
                                                                       ) {
        ...
        if ((data->store = data->mcm->get_tmp_store(data->mcm_data)) == 
# 45 "../crypto/core_fetch.c" 3 4
                                                                       ((void *)0)
# 45 "../crypto/core_fetch.c"
                                                                           )
            return 0;
    }
...
# 63 "../crypto/core_fetch.c" 3 4
        ((void *)0)
# 63 "../crypto/core_fetch.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/core_fetch.c",64,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 64 "../crypto/core_fetch.c" 3 4
       ((void *)0)
# 64 "../crypto/core_fetch.c"
       );
        return 0;
    }
...
{
    if (!__builtin_expect(!!((result != 
# 90 "../crypto/core_fetch.c" 3 4
        ((void *)0)
# 90 "../crypto/core_fetch.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/core_fetch.c",91,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 91 "../crypto/core_fetch.c" 3 4
       ((void *)0)
# 91 "../crypto/core_fetch.c"
       );
        return 0;
    }
                                       ...
                                       int no_store, void *cbdata)
{
    struct construct_data_st *data = cbdata;
    void *method = 
# 107 "../crypto/core_fetch.c" 3 4
                  ((void *)0)
# 107 "../crypto/core_fetch.c"
                      ;

    if ((method = data->mcm->construct(algo, provider, data->mcm_data))
        == 
# 110 "../crypto/core_fetch.c" 3 4
          ((void *)0)
# 110 "../crypto/core_fetch.c"
              )
        return;
# 123 "../crypto/core_fetch.c"
    data->mcm->put(no_store ? data->store : 
# 123 "../crypto/core_fetch.c" 3 4
                                           ((void *)0)
# 123 "../crypto/core_fetch.c"
...
{
    void *method = 
# 134 "../crypto/core_fetch.c" 3 4
                  ((void *)0)
# 134 "../crypto/core_fetch.c"
                      ;
    OSSL_PROVIDER *provider = provider_rw != 
# 135 "../crypto/core_fetch.c" 3 4
                                            ((void *)0) 
# 135 "../crypto/core_fetch.c"
                                                 ? *provider_rw : 
# 135 "../crypto/core_fetch.c" 3 4
                                                                  ((void *)0)
# 135 "../crypto/core_fetch.c"
...
# 149 "../crypto/core_fetch.c"
    cbdata.store = 
# 149 "../crypto/core_fetch.c" 3 4
                  ((void *)0)
# 149 "../crypto/core_fetch.c"
                      ;
    ...
    if (cbdata.store != 
# 162 "../crypto/core_fetch.c" 3 4
                       ((void *)0)
# 162 "../crypto/core_fetch.c"
                           )
    ...
    if (method == 
# 167 "../crypto/core_fetch.c" 3 4
                 ((void *)0)
# 167 "../crypto/core_fetch.c"
                     )
        method = mcm->get(
# 168 "../crypto/core_fetch.c" 3 4
                         ((void *)0)
# 168 "../crypto/core_fetch.c"
                             , (const OSSL_PROVIDER **)provider_rw, mcm_data);
