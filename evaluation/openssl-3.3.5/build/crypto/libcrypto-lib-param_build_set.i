# 0 "../crypto/param_build_set.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/param_build_set.c"
# 17 "../crypto/param_build_set.c"
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/param_build_set.c" 2
...
# 15 "../include/internal/param_build_set.h" 2
...
{
    if (bld != 
# 25 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 25 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_int(bld, key, num);
    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 28 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 28 "../crypto/param_build_set.c"
                )
...
{
    if (bld != 
# 36 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 36 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_long(bld, key, num);
    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 39 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 39 "../crypto/param_build_set.c"
                )
...
{
    if (bld != 
# 47 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 47 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_utf8_string(bld, key, buf, 0);
    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 50 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 50 "../crypto/param_build_set.c"
                )
...
{
    if (bld != 
# 60 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 60 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_octet_string(bld, key, data, data_len);

    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 64 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 64 "../crypto/param_build_set.c"
                )
...
{
    if (bld != 
# 72 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 72 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_BN_pad(bld, key, bn, sz);
    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 75 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 75 "../crypto/param_build_set.c"
                ) {
        if (sz > p->data_size) {
            (ERR_new(), ERR_set_debug("../crypto/param_build_set.c",77,__func__), ERR_set_error)((15),(116),
# 77 "../crypto/param_build_set.c" 3 4
           ((void *)0)
# 77 "../crypto/param_build_set.c"
           );
            return 0;
        }
        p->data_size = sz;
...
{
    if (bld != 
# 89 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 89 "../crypto/param_build_set.c"
                  )
        return OSSL_PARAM_BLD_push_BN(bld, key, bn);

    p = OSSL_PARAM_locate(p, key);
    if (p != 
# 93 "../crypto/param_build_set.c" 3 4
            ((void *)0)
# 93 "../crypto/param_build_set.c"
                )
                                      ...
                                      struct stack_st_BIGNUM_const *stk)
{
    ...
    if (bld != 
# 106 "../crypto/param_build_set.c" 3 4
              ((void *)0)
# 106 "../crypto/param_build_set.c"
                  ) {
        for (i = 0; i < sz && names[i] != 
# 107 "../crypto/param_build_set.c" 3 4
                                         ((void *)0)
# 107 "../crypto/param_build_set.c"
                                             ; ++i) {
            bn = sk_BIGNUM_const_value(stk, i);
            if (bn != 
# 109 "../crypto/param_build_set.c" 3 4
                     ((void *)0) 
# 109 "../crypto/param_build_set.c"
                          && !OSSL_PARAM_BLD_push_BN(bld, names[i], bn))
                return 0;
        }
        return 1;
    }
    ...
    for (i = 0; i < sz && names[i] != 
# 115 "../crypto/param_build_set.c" 3 4
                                     ((void *)0)
# 115 "../crypto/param_build_set.c"
                                         ; ++i) {
        bn = sk_BIGNUM_const_value(stk, i);
        p = OSSL_PARAM_locate(params, names[i]);
        if (p != 
# 118 "../crypto/param_build_set.c" 3 4
                ((void *)0) 
# 118 "../crypto/param_build_set.c"
                     && bn != 
# 118 "../crypto/param_build_set.c" 3 4
                              ((void *)0)
# 118 "../crypto/param_build_set.c"
