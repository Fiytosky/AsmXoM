# 0 "../crypto/core_algorithm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/core_algorithm.c"
# 10 "../crypto/core_algorithm.c"
                            ...
                            int cur_operation, int no_store, void *cbdata)
{
    ...
    if (data->pre == 
# 53 "../crypto/core_algorithm.c" 3 4
                    ((void *)0)
# 53 "../crypto/core_algorithm.c"
                        ) {
    ...
    if (map != 
# 73 "../crypto/core_algorithm.c" 3 4
              ((void *)0)
# 73 "../crypto/core_algorithm.c"
                  ) {
        const OSSL_ALGORITHM *thismap;

        for (thismap = map; thismap->algorithm_names != 
# 76 "../crypto/core_algorithm.c" 3 4
                                                       ((void *)0)
# 76 "../crypto/core_algorithm.c"
                                                           ; thismap++)
    ...
    if (data->post == 
# 81 "../crypto/core_algorithm.c" 3 4
                     ((void *)0)
# 81 "../crypto/core_algorithm.c"
                         ) {
...
# 117 "../crypto/core_algorithm.c" 3 4
                                   ((void *)0)
                           ...
                           void *data)
{
    ...
    if (provider == 
# 161 "../crypto/core_algorithm.c" 3 4
                   ((void *)0)
# 161 "../crypto/core_algorithm.c"
                       ) {
        ...
        if (!__builtin_expect(!!((ossl_lib_ctx_get_concrete(libctx) == ossl_lib_ctx_get_concrete(libctx2)) != 0), 1)
                                                               )
            return;
...
char *ossl_algorithm_get1_first_name(const OSSL_ALGORITHM *algo)
{
    const char *first_name_end = 
# 182 "../crypto/core_algorithm.c" 3 4
                                ((void *)0)
# 182 "../crypto/core_algorithm.c"
                                    ;
    size_t first_name_len = 0;
    char *ret;

    if (algo->algorithm_names == 
# 186 "../crypto/core_algorithm.c" 3 4
                                ((void *)0)
# 186 "../crypto/core_algorithm.c"
                                    )
        return 
# 187 "../crypto/core_algorithm.c" 3 4
              ((void *)0)
# 187 "../crypto/core_algorithm.c"
                  ;

    first_name_end = strchr(algo->algorithm_names, ':');
    if (first_name_end == 
# 190 "../crypto/core_algorithm.c" 3 4
                         ((void *)0)
# 190 "../crypto/core_algorithm.c"
                             )
        first_name_len = strlen(algo->algorithm_names);
    else
        first_name_len = first_name_end - algo->algorithm_names;

    ret = CRYPTO_strndup(algo->algorithm_names, first_name_len, "../crypto/core_algorithm.c", 195);
    return ret;
}
