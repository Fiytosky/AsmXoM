# 0 "../crypto/siphash/siphash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/siphash/siphash.c"
# 26 "../crypto/siphash/siphash.c"
...
# 31 "../crypto/siphash/siphash.c" 2
# 68 "../crypto/siphash/siphash.c"
size_t SipHash_ctx_size(void)
{
...
void SipHash_Update(SIPHASH *ctx, const unsigned char *in, size_t inlen)
{
    ...
    if (ctx->len) {
        ...
        m = (((uint64_t)((ctx->leavings)[0])) | ((uint64_t)((ctx->leavings)[1]) << 8) | ((uint64_t)((ctx->leavings)[2]) << 16) | ((uint64_t)((ctx->leavings)[3]) << 24) | ((uint64_t)((ctx->leavings)[4]) << 32) | ((uint64_t)((ctx->leavings)[5]) << 40) | ((uint64_t)((ctx->leavings)[6]) << 48) | ((uint64_t)((ctx->leavings)[7]) << 56));
        v3 ^= m;
...
int SipHash_Final(SIPHASH *ctx, unsigned char *out, size_t outlen)
{
    ...
    for (i = 0; i < ctx->drounds; ++i)
        do { v0 += v1; v1 = (uint64_t)(((v1) << (13)) | ((v1) >> (64 - (13)))); v1 ^= v0; v0 = (uint64_t)(((v0) << (32)) | ((v0) >> (64 - (32)))); v2 += v3; v3 = (uint64_t)(((v3) << (16)) | ((v3) >> (64 - (16)))); v3 ^= v2; v0 += v3; v3 = (uint64_t)(((v3) << (21)) | ((v3) >> (64 - (21)))); v3 ^= v0; v2 += v1; v1 = (uint64_t)(((v1) << (17)) | ((v1) >> (64 - (17)))); v1 ^= v2; v2 = (uint64_t)(((v2) << (32)) | ((v2) >> (64 - (32)))); } while (0);
    b = v0 ^ v1 ^ v2 ^ v3;
    ((out + 8))[0] = (uint8_t)(((uint32_t)((b)))); ((out + 8))[1] = (uint8_t)(((uint32_t)((b))) >> 8); ((out + 8))[2] = (uint8_t)(((uint32_t)((b))) >> 16); ((out + 8))[3] = (uint8_t)(((uint32_t)((b))) >> 24);; ((out + 8) + 4)[0] = (uint8_t)(((uint32_t)((b) >> 32))); ((out + 8) + 4)[1] = (uint8_t)(((uint32_t)((b) >> 32)) >> 8); ((out + 8) + 4)[2] = (uint8_t)(((uint32_t)((b) >> 32)) >> 16); ((out + 8) + 4)[3] = (uint8_t)(((uint32_t)((b) >> 32)) >> 24);;;
    return 1;
}
