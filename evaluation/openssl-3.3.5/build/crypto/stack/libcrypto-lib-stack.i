# 0 "../crypto/stack/stack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/stack/stack.c"
# 10 "../crypto/stack/stack.c"
...
# 18 "../crypto/stack/stack.c" 3 4
((void *)0) 
# 18 "../crypto/stack/stack.c"
...
# 24 "../crypto/stack/stack.c" 3 4
                            (18446744073709551615UL) 
# 24 "../crypto/stack/stack.c"
                                     / sizeof(void *) < 0x7fffffff
    
# 25 "../crypto/stack/stack.c"
   ? (int)(
# 25 "../crypto/stack/stack.c" 3 4
           (18446744073709551615UL) 
# 25 "../crypto/stack/stack.c"
                    / sizeof(void *)) : 0x7fffffff
# 25 "../crypto/stack/stack.c"
...
OPENSSL_STACK *OPENSSL_sk_dup(const OPENSSL_STACK *sk)
{
    ...
    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/stack/stack.c", 51)) == 
# 51 "../crypto/stack/stack.c" 3 4
                                               ((void *)0)
# 51 "../crypto/stack/stack.c"
                                                   )
        goto err;

    if (sk == 
# 54 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 54 "../crypto/stack/stack.c"
                 ) {
        ret->num = 0;
        ret->sorted = 0;
        ret->comp = 
# 57 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 57 "../crypto/stack/stack.c"
                       ;
    } else {
    ...
    if (sk == 
# 63 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 63 "../crypto/stack/stack.c"
                  || sk->num == 0) {

        ret->data = 
# 65 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 65 "../crypto/stack/stack.c"
                       ;
        ret->num_alloc = 0;
        return ret;
    }
    ...
    ret->data = CRYPTO_malloc(sizeof(*ret->data) * sk->num_alloc, "../crypto/stack/stack.c", 71);
    if (ret->data == 
# 72 "../crypto/stack/stack.c" 3 4
                    ((void *)0)
# 72 "../crypto/stack/stack.c"
                        )
        goto err;
 ...
 err:
    OPENSSL_sk_free(ret);
    return 
# 79 "../crypto/stack/stack.c" 3 4
          ((void *)0)
# 79 "../crypto/stack/stack.c"
              ;
}
                                    ...
                                    OPENSSL_sk_freefunc free_func)
{
    ...
    if ((ret = CRYPTO_malloc(sizeof(*ret), "../crypto/stack/stack.c", 89)) == 
# 89 "../crypto/stack/stack.c" 3 4
                                               ((void *)0)
# 89 "../crypto/stack/stack.c"
                                                   )
        goto err;

    if (sk == 
# 92 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 92 "../crypto/stack/stack.c"
                 ) {
        ret->num = 0;
        ret->sorted = 0;
        ret->comp = 
# 95 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 95 "../crypto/stack/stack.c"
                       ;
    } else {
    ...
    if (sk == 
# 101 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 101 "../crypto/stack/stack.c"
                  || sk->num == 0) {

        ret->data = 
# 103 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 103 "../crypto/stack/stack.c"
                       ;
        ret->num_alloc = 0;
        return ret;
    }
    ...
    ret->data = CRYPTO_zalloc(sizeof(*ret->data) * ret->num_alloc, "../crypto/stack/stack.c", 109);
    if (ret->data == 
# 110 "../crypto/stack/stack.c" 3 4
                    ((void *)0)
# 110 "../crypto/stack/stack.c"
                        )
        goto err;

    for (i = 0; i < ret->num; ++i) {
        if (sk->data[i] == 
# 114 "../crypto/stack/stack.c" 3 4
                          ((void *)0)
# 114 "../crypto/stack/stack.c"
                              )
            continue;
        if ((ret->data[i] = copy_func(sk->data[i])) == 
# 116 "../crypto/stack/stack.c" 3 4
                                                      ((void *)0)
# 116 "../crypto/stack/stack.c"
                                                          ) {
            while (--i >= 0)
                if (ret->data[i] != 
# 118 "../crypto/stack/stack.c" 3 4
                                   ((void *)0)
# 118 "../crypto/stack/stack.c"
                                       )
 ...
 err:
    OPENSSL_sk_free(ret);
    return 
# 127 "../crypto/stack/stack.c" 3 4
          ((void *)0)
# 127 "../crypto/stack/stack.c"
              ;
}

OPENSSL_STACK *OPENSSL_sk_new_null(void)
{
    return OPENSSL_sk_new_reserve(
# 132 "../crypto/stack/stack.c" 3 4
                                 ((void *)0)
# 132 "../crypto/stack/stack.c"
                                     , 0);
}
...
static int sk_reserve(OPENSSL_STACK *st, int n, int exact)
{
    ...
    if (n > max_nodes - st->num) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",184,__func__), ERR_set_error)((15),(114),
# 184 "../crypto/stack/stack.c" 3 4
       ((void *)0)
# 184 "../crypto/stack/stack.c"
       );
        return 0;
    }
    ...
    if (st->data == 
# 194 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 194 "../crypto/stack/stack.c"
                       ) {




        if ((st->data = CRYPTO_zalloc(sizeof(void *) * num_alloc, "../crypto/stack/stack.c", 199)) == 
# 199 "../crypto/stack/stack.c" 3 4
                                                                      ((void *)0)
# 199 "../crypto/stack/stack.c"
                                                                          )
            return 0;
    ...
    if (!exact) {
        ...
        if (num_alloc == 0) {
            (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",210,__func__), ERR_set_error)((15),(114),
# 210 "../crypto/stack/stack.c" 3 4
           ((void *)0)
# 210 "../crypto/stack/stack.c"
           );
            return 0;
        }
    ...
    tmpdata = CRYPTO_realloc((void *)st->data, sizeof(void *) * num_alloc, "../crypto/stack/stack.c", 217);
    if (tmpdata == 
# 218 "../crypto/stack/stack.c" 3 4
                  ((void *)0)
# 218 "../crypto/stack/stack.c"
                      )
        return 0;
...
OPENSSL_STACK *OPENSSL_sk_new_reserve(OPENSSL_sk_compfunc c, int n)
{
    OPENSSL_STACK *st = CRYPTO_zalloc(sizeof(OPENSSL_STACK), "../crypto/stack/stack.c", 228);

    if (st == 
# 230 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 230 "../crypto/stack/stack.c"
                 )
        return 
# 231 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 231 "../crypto/stack/stack.c"
                  ;
    ...
    if (!sk_reserve(st, n, 1)) {
        OPENSSL_sk_free(st);
        return 
# 240 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 240 "../crypto/stack/stack.c"
                  ;
    }
...
{
    if (st == 
# 248 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 248 "../crypto/stack/stack.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",249,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 249 "../crypto/stack/stack.c" 3 4
       ((void *)0)
# 249 "../crypto/stack/stack.c"
       );
        return 0;
    }
...
{
    if (st == 
# 260 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 260 "../crypto/stack/stack.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",261,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 261 "../crypto/stack/stack.c" 3 4
       ((void *)0)
# 261 "../crypto/stack/stack.c"
       );
        return 0;
    }
    if (st->num == max_nodes) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",265,__func__), ERR_set_error)((15),(114),
# 265 "../crypto/stack/stack.c" 3 4
       ((void *)0)
# 265 "../crypto/stack/stack.c"
       );
        return 0;
    }
...
void *OPENSSL_sk_delete_ptr(OPENSSL_STACK *st, const void *p)
{
    ...
    if (st == 
# 300 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 300 "../crypto/stack/stack.c"
                 )
        return 
# 301 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 301 "../crypto/stack/stack.c"
                  ;
    ...
    return 
# 306 "../crypto/stack/stack.c" 3 4
          ((void *)0)
# 306 "../crypto/stack/stack.c"
              ;
}
...
{
    if (st == 
# 311 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 311 "../crypto/stack/stack.c"
                  || loc < 0 || loc >= st->num)
        return 
# 312 "../crypto/stack/stack.c" 3 4
              ((void *)0)
                         ...
                         int ret_val_options, int *pnum_matched)
{
    ...
    if (st == 
# 324 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 324 "../crypto/stack/stack.c"
                  || st->num == 0)
        return -1;

    if (pnum == 
# 327 "../crypto/stack/stack.c" 3 4
               ((void *)0)
# 327 "../crypto/stack/stack.c"
                   )
        pnum = &count;

    if (st->comp == 
# 330 "../crypto/stack/stack.c" 3 4
                   ((void *)0)
# 330 "../crypto/stack/stack.c"
                       ) {
        for (i = 0; i < st->num; i++)
            if (st->data[i] == data) {
                *pnum = 1;
    ...
    if (data == 
# 340 "../crypto/stack/stack.c" 3 4
               ((void *)0)
# 340 "../crypto/stack/stack.c"
                   )
        return -1;
    ...
    if (!st->sorted) {
        ...
        for (i = 0; i < st->num; i++)
            if (st->comp(&data, st->data + i) == 0) {
                ...
                if (pnum_matched == 
# 352 "../crypto/stack/stack.c" 3 4
                                   ((void *)0)
# 352 "../crypto/stack/stack.c"
                                       )
                    return i;
            }
        if (res == -1)
    ...
    if (pnum_matched != 
# 360 "../crypto/stack/stack.c" 3 4
                       ((void *)0)
# 360 "../crypto/stack/stack.c"
                           )
        ret_val_options |= 0x02;
    r = ossl_bsearch(&data, st->data, st->num, sizeof(void *), st->comp,
                     ret_val_options);

    if (pnum_matched != 
# 365 "../crypto/stack/stack.c" 3 4
                       ((void *)0)
# 365 "../crypto/stack/stack.c"
                           ) {
        *pnum = 0;
        if (r != 
# 367 "../crypto/stack/stack.c" 3 4
                ((void *)0)
# 367 "../crypto/stack/stack.c"
                    ) {
    ...
    return r == 
# 379 "../crypto/stack/stack.c" 3 4
               ((void *)0) 
# 379 "../crypto/stack/stack.c"
                    ? -1 : (int)((const void **)r - st->data);
}

int OPENSSL_sk_find(OPENSSL_STACK *st, const void *data)
{
    return internal_find(st, data, 0x02, 
# 384 "../crypto/stack/stack.c" 3 4
                                                                     ((void *)0)
# 384 "../crypto/stack/stack.c"
                                                                         );
}
...
# 389 "../crypto/stack/stack.c" 3 4
                                                                 ((void *)0)
# 389 "../crypto/stack/stack.c"
                                                                     );
}

int OPENSSL_sk_find_all(OPENSSL_STACK *st, const void *data, int *pnum)
{
    return internal_find(st, data, 0x02, pnum);
}

int OPENSSL_sk_push(OPENSSL_STACK *st, const void *data)
{
    if (st == 
# 399 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 399 "../crypto/stack/stack.c"
                 )
        return 0;
...
{
    if (st == 
# 411 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 411 "../crypto/stack/stack.c"
                  || st->num == 0)
        return 
# 412 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 412 "../crypto/stack/stack.c"
                  ;
...
{
    if (st == 
# 418 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 418 "../crypto/stack/stack.c"
                  || st->num == 0)
        return 
# 419 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 419 "../crypto/stack/stack.c"
                  ;
...
{
    if (st == 
# 425 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 425 "../crypto/stack/stack.c"
                  || st->num == 0)
        return;
...
void OPENSSL_sk_pop_free(OPENSSL_STACK *st, OPENSSL_sk_freefunc func)
{
    ...
    if (st == 
# 435 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 435 "../crypto/stack/stack.c"
                 )
        return;
    for (i = 0; i < st->num; i++)
        if (st->data[i] != 
# 438 "../crypto/stack/stack.c" 3 4
                          ((void *)0)
# 438 "../crypto/stack/stack.c"
                              )
            func((char *)st->data[i]);
    OPENSSL_sk_free(st);
}
...
{
    if (st == 
# 445 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 445 "../crypto/stack/stack.c"
                 )
        return;
    CRYPTO_free(st->data, "../crypto/stack/stack.c", 447);
    CRYPTO_free(st, "../crypto/stack/stack.c", 448);
}

int OPENSSL_sk_num(const OPENSSL_STACK *st)
{
    return st == 
# 453 "../crypto/stack/stack.c" 3 4
                ((void *)0) 
# 453 "../crypto/stack/stack.c"
                     ? -1 : st->num;
}
...
{
    if (st == 
# 458 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 458 "../crypto/stack/stack.c"
                  || i < 0 || i >= st->num)
        return 
# 459 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 459 "../crypto/stack/stack.c"
                  ;
...
{
    if (st == 
# 465 "../crypto/stack/stack.c" 3 4
             ((void *)0)
# 465 "../crypto/stack/stack.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",466,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 466 "../crypto/stack/stack.c" 3 4
       ((void *)0)
# 466 "../crypto/stack/stack.c"
       );
        return 
# 467 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 467 "../crypto/stack/stack.c"
                  ;
    }
    if (i < 0 || i >= st->num) {
        (ERR_new(), ERR_set_debug("../crypto/stack/stack.c",470,__func__), ERR_set_error)(15, (262|(0x2 << 18L)),
                       "i=%d", i);
        return 
# 472 "../crypto/stack/stack.c" 3 4
              ((void *)0)
# 472 "../crypto/stack/stack.c"
                  ;
    }
    st->data[i] = data;
    st->sorted = 0;
...
{
    if (st != 
# 481 "../crypto/stack/stack.c" 3 4
             ((void *)0) 
# 481 "../crypto/stack/stack.c"
                  && !st->sorted && st->comp != 
# 481 "../crypto/stack/stack.c" 3 4
                                                ((void *)0)
# 481 "../crypto/stack/stack.c"
...
{
    return st == 
# 490 "../crypto/stack/stack.c" 3 4
                ((void *)0) 
# 490 "../crypto/stack/stack.c"
                     ? 1 : st->sorted;
}
