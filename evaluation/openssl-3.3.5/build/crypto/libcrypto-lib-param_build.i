# 0 "../crypto/param_build.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/param_build.c"
# 11 "../crypto/param_build.c"
...
# 15 "../crypto/param_build.c" 2
# 1 "../include/openssl/types.h" 1
# 16 "../crypto/param_build.c" 2
...
struct ossl_param_bld_st {
    ...
    struct stack_st_OSSL_PARAM_BLD_DEF *params;
};
...
static OSSL_PARAM_BLD_DEF *param_push(OSSL_PARAM_BLD *bld, const char *key,
                                      ...
                                      int secure)
{
    OSSL_PARAM_BLD_DEF *pd = CRYPTO_zalloc(sizeof(*pd), "../crypto/param_build.c", 55);

    if (pd == 
# 57 "../crypto/param_build.c" 3 4
             ((void *)0)
# 57 "../crypto/param_build.c"
                 )
        return 
# 58 "../crypto/param_build.c" 3 4
              ((void *)0)
# 58 "../crypto/param_build.c"
                  ;
    pd->key = key;
    pd->type = type;
    pd->size = size;
    ...
    if (sk_OSSL_PARAM_BLD_DEF_push(bld->params, pd) <= 0) {
        CRYPTO_free(pd, "../crypto/param_build.c", 68);
        pd = 
# 69 "../crypto/param_build.c" 3 4
            ((void *)0)
# 69 "../crypto/param_build.c"
                ;
    }
    return pd;
}
                          ...
                          void *num, size_t size, int type)
{
    ...
    if (pd == 
# 79 "../crypto/param_build.c" 3 4
             ((void *)0)
# 79 "../crypto/param_build.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/param_build.c",80,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 80 "../crypto/param_build.c" 3 4
       ((void *)0)
# 80 "../crypto/param_build.c"
       );
        return 0;
    }
    if (size > sizeof(pd->num)) {
        (ERR_new(), ERR_set_debug("../crypto/param_build.c",84,__func__), ERR_set_error)((15),(113),
# 84 "../crypto/param_build.c" 3 4
       ((void *)0)
# 84 "../crypto/param_build.c"
       );
        return 0;
    }
...
OSSL_PARAM_BLD *OSSL_PARAM_BLD_new(void)
{
    OSSL_PARAM_BLD *r = CRYPTO_zalloc(sizeof(OSSL_PARAM_BLD), "../crypto/param_build.c", 93);

    if (r != 
# 95 "../crypto/param_build.c" 3 4
            ((void *)0)
# 95 "../crypto/param_build.c"
                ) {
        r->params = sk_OSSL_PARAM_BLD_DEF_new_null();
        if (r->params == 
# 97 "../crypto/param_build.c" 3 4
                        ((void *)0)
# 97 "../crypto/param_build.c"
                            ) {
            CRYPTO_free(r, "../crypto/param_build.c", 98);
            r = 
# 99 "../crypto/param_build.c" 3 4
               ((void *)0)
# 99 "../crypto/param_build.c"
                   ;
        }
    }
    return r;
...
static void free_all_params(OSSL_PARAM_BLD *bld)
{
    ...
    for (i = 0; i < n; i++)
        CRYPTO_free(sk_OSSL_PARAM_BLD_DEF_pop(bld->params), "../crypto/param_build.c", 110);
}

void OSSL_PARAM_BLD_free(OSSL_PARAM_BLD *bld)
{
    if (bld == 
# 115 "../crypto/param_build.c" 3 4
              ((void *)0)
# 115 "../crypto/param_build.c"
                  )
        return;
    free_all_params(bld);
    sk_OSSL_PARAM_BLD_DEF_free(bld->params);
    CRYPTO_free(bld, "../crypto/param_build.c", 119);
}

int OSSL_PARAM_BLD_push_int(OSSL_PARAM_BLD *bld, const char *key, int num)
{
    return param_push_num(bld, key, &num, sizeof(num), 1);
}
...
int OSSL_PARAM_BLD_push_double(OSSL_PARAM_BLD *bld, const char *key,
                               double num)
{
    return param_push_num(bld, key, &num, sizeof(num), 3);
}
                   ...
                   const BIGNUM *bn, size_t sz, int type)
{
    ...
    if (!__builtin_expect(!!((type == 2 || type == 1) != 0), 1)
                                                   )
        return 0;

    if (bn != 
# 203 "../crypto/param_build.c" 3 4
             ((void *)0)
# 203 "../crypto/param_build.c"
                 ) {
        if (type == 2 && BN_is_negative(bn)) {
            (ERR_new(), ERR_set_debug("../crypto/param_build.c",205,__func__), ERR_set_error)(15, (268|(0x2 << 18L)),
                           "Negative big numbers are unsupported for OSSL_PARAM_UNSIGNED_INTEGER");
            return 0;
        }

        n = ((BN_num_bits(bn)+7)/8);
        if (n < 0) {
            (ERR_new(), ERR_set_debug("../crypto/param_build.c",212,__func__), ERR_set_error)((15),(115),
# 212 "../crypto/param_build.c" 3 4
           ((void *)0)
# 212 "../crypto/param_build.c"
           );
            return 0;
        }
        if (sz < (size_t)n) {
            (ERR_new(), ERR_set_debug("../crypto/param_build.c",216,__func__), ERR_set_error)((15),(116),
# 216 "../crypto/param_build.c" 3 4
           ((void *)0)
# 216 "../crypto/param_build.c"
           );
            return 0;
        }
        if (BN_get_flags(bn, 0x08) == 0x08)
            secure = 1;
    ...
    if (pd == 
# 227 "../crypto/param_build.c" 3 4
             ((void *)0)
# 227 "../crypto/param_build.c"
                 )
        return 0;
    pd->bn = bn;
    return 1;
...
{
    if (bn != 
# 236 "../crypto/param_build.c" 3 4
             ((void *)0) 
# 236 "../crypto/param_build.c"
                  && BN_is_negative(bn))
        return push_BN(bld, key, bn, ((BN_num_bits(bn)+7)/8) + 1,
                       1);
    return push_BN(bld, key, bn, bn == 
# 239 "../crypto/param_build.c" 3 4
                                      ((void *)0) 
# 239 "../crypto/param_build.c"
                                           ? 0 : ((BN_num_bits(bn)+7)/8),
                   2);
}
...
{
    if (bn != 
# 246 "../crypto/param_build.c" 3 4
             ((void *)0) 
# 246 "../crypto/param_build.c"
                  && BN_is_negative(bn))
        return push_BN(bld, key, bn, ((BN_num_bits(bn)+7)/8),
                       1);
    return push_BN(bld, key, bn, sz, 2);
}
                                    ...
                                    const char *buf, size_t bsize)
{
    ...
    pd = param_push(bld, key, bsize, bsize + 1, 4, secure);
    if (pd == 
# 262 "../crypto/param_build.c" 3 4
             ((void *)0)
# 262 "../crypto/param_build.c"
                 )
        return 0;
    pd->string = buf;
    return 1;
                                 ...
                                 char *buf, size_t bsize)
{
    ...
    if (bsize == 0)
        bsize = strlen(buf);
    pd = param_push(bld, key, bsize, sizeof(buf), 6, 0);
    if (pd == 
# 276 "../crypto/param_build.c" 3 4
             ((void *)0)
# 276 "../crypto/param_build.c"
                 )
        return 0;
    pd->string = buf;
    return 1;
                                     ...
                                     const void *buf, size_t bsize)
{
    ...
    secure = CRYPTO_secure_allocated(buf);
    pd = param_push(bld, key, bsize, bsize, 5, secure);
    if (pd == 
# 290 "../crypto/param_build.c" 3 4
             ((void *)0)
# 290 "../crypto/param_build.c"
                 )
        return 0;
    pd->string = buf;
    return 1;
                                  ...
                                  void *buf, size_t bsize)
{
    ...
    pd = param_push(bld, key, bsize, sizeof(buf), 7, 0);
    if (pd == 
# 302 "../crypto/param_build.c" 3 4
             ((void *)0)
# 302 "../crypto/param_build.c"
                 )
        return 0;
    pd->string = buf;
    return 1;
                                     ...
                                     OSSL_PARAM_ALIGNED_BLOCK *secure)
{
    ...
    for (i = 0; i < num; i++) {
        ...
        param[i].data = p;
        if (pd->bn != 
# 331 "../crypto/param_build.c" 3 4
                     ((void *)0)
# 331 "../crypto/param_build.c"
                         ) {
            ...
            *(const void **)p = pd->string;
                   ...
                   || pd->type == 4) {
            if (pd->string != 
# 343 "../crypto/param_build.c" 3 4
                             ((void *)0)
# 343 "../crypto/param_build.c"
                                 )
...
OSSL_PARAM *OSSL_PARAM_BLD_to_param(OSSL_PARAM_BLD *bld)
{
    OSSL_PARAM_ALIGNED_BLOCK *blk, *s = 
# 363 "../crypto/param_build.c" 3 4
                                       ((void *)0)
# 363 "../crypto/param_build.c"
                                           ;
    ...
    const size_t total = sizeof(OSSL_PARAM_ALIGNED_BLOCK) * (p_blks + bld->total_blocks);
    const size_t ss = sizeof(OSSL_PARAM_ALIGNED_BLOCK) * bld->secure_blocks;

    if (ss > 0) {
        s = CRYPTO_secure_malloc(ss, "../crypto/param_build.c", 371);
        if (s == 
# 372 "../crypto/param_build.c" 3 4
                ((void *)0)
# 372 "../crypto/param_build.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/param_build.c",373,__func__), ERR_set_error)((15),(111),
# 373 "../crypto/param_build.c" 3 4
           ((void *)0)
# 373 "../crypto/param_build.c"
           );
            return 
# 374 "../crypto/param_build.c" 3 4
                  ((void *)0)
# 374 "../crypto/param_build.c"
                      ;
        }
    }
    params = CRYPTO_malloc(total, "../crypto/param_build.c", 377);
    if (params == 
# 378 "../crypto/param_build.c" 3 4
                 ((void *)0)
# 378 "../crypto/param_build.c"
                     ) {
        CRYPTO_secure_free(s, "../crypto/param_build.c", 379);
        return 
# 380 "../crypto/param_build.c" 3 4
              ((void *)0)
# 380 "../crypto/param_build.c"
                  ;
    }
