# 0 "../crypto/bio/bss_bio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_bio.c"
# 18 "../crypto/bio/bss_bio.c"
...
# 19 "../crypto/bio/bss_bio.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 20 "../crypto/bio/bss_bio.c" 2
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/limits.h" 1 3 4
# 21 "../crypto/bio/bss_bio.c" 2
...
# 46 "../crypto/bio/bss_bio.c" 3 4
   ((void *)0) 
# 46 "../crypto/bio/bss_bio.c"
                          ,
    bio_ctrl,
    bio_new,
    bio_free,
    
# 50 "../crypto/bio/bss_bio.c" 3 4
   ((void *)0)

# 51 "../crypto/bio/bss_bio.c"
};
...
static int bio_new(BIO *bio)
{
    struct bio_bio_st *b = CRYPTO_zalloc(sizeof(*b), "../crypto/bio/bss_bio.c", 78);

    if (b == 
# 80 "../crypto/bio/bss_bio.c" 3 4
            ((void *)0)
# 80 "../crypto/bio/bss_bio.c"
                )
        return 0;
...
static int bio_free(BIO *bio)
{
    ...
    if (bio == 
# 94 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0)
# 94 "../crypto/bio/bss_bio.c"
                  )
        return 0;
    b = bio->ptr;

    
# 98 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 98 "../crypto/bio/bss_bio.c"
                    ;

    if (b->peer)
        bio_destroy_pair(bio);

    CRYPTO_free(b->buf, "../crypto/bio/bss_bio.c", 103);
    CRYPTO_free(b, "../crypto/bio/bss_bio.c", 104);
...
# 121 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 121 "../crypto/bio/bss_bio.c"
                    ;
    
# 122 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 122 "../crypto/bio/bss_bio.c"
                          ;
    peer_b = b->peer->ptr;
    
# 124 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 124 "../crypto/bio/bss_bio.c"
                         ;
    
# 125 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 125 "../crypto/bio/bss_bio.c"
                              ;

    peer_b->request = 0;

    if (buf == 
# 129 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0) 
# 129 "../crypto/bio/bss_bio.c"
                   || size == 0)
        return 0;
...
# 156 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 156 "../crypto/bio/bss_bio.c"
                   ;
    do {
        size_t chunk;

        
# 160 "../crypto/bio/bss_bio.c" 3 4
       ((void) (0))
# 160 "../crypto/bio/bss_bio.c"
                                  ;
...
# 166 "../crypto/bio/bss_bio.c" 3 4
       ((void) (0))
# 166 "../crypto/bio/bss_bio.c"
                                                     ;
...
# 173 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 173 "../crypto/bio/bss_bio.c"
                                                 ;
...
# 179 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 179 "../crypto/bio/bss_bio.c"
                                ;
            peer_b->offset = 0;
        }
        rest -= chunk;
...
# 211 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 211 "../crypto/bio/bss_bio.c"
                    ;
    
# 212 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 212 "../crypto/bio/bss_bio.c"
                          ;
    peer_b = b->peer->ptr;
    
# 214 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 214 "../crypto/bio/bss_bio.c"
                         ;
    
# 215 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 215 "../crypto/bio/bss_bio.c"
                              ;
...
# 230 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 230 "../crypto/bio/bss_bio.c"
                  ;

    if (buf != 
# 232 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0)
# 232 "../crypto/bio/bss_bio.c"
                  )
...
# 242 "../crypto/bio/bss_bio.c"
                            )
        num = 0x7fffffffffffffffL
# 243 "../crypto/bio/bss_bio.c"
                           ;
    else
        num = (ssize_t) num_;
...
# 259 "../crypto/bio/bss_bio.c" 3 4
       ((void) (0))
# 259 "../crypto/bio/bss_bio.c"
                                             ;
        if (peer_b->offset == peer_b->size)
            peer_b->offset = 0;
    } else
...
static int bio_write(BIO *bio, const char *buf, int num_)
{
    ...
    if (!bio->init || buf == 
# 276 "../crypto/bio/bss_bio.c" 3 4
                            ((void *)0) 
# 276 "../crypto/bio/bss_bio.c"
                                 || num_ <= 0)
        return 0;

    b = bio->ptr;
    
# 280 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 280 "../crypto/bio/bss_bio.c"
                    ;
    
# 281 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 281 "../crypto/bio/bss_bio.c"
                          ;
    
# 282 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 282 "../crypto/bio/bss_bio.c"
                         ;

    b->request = 0;
    if (b->closed) {

        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",287,__func__), ERR_set_error)((32),(124),
# 287 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 287 "../crypto/bio/bss_bio.c"
       );
        return -1;
    }

    
# 291 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 291 "../crypto/bio/bss_bio.c"
                            ;
...
# 306 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 306 "../crypto/bio/bss_bio.c"
                   ;
    do {
        size_t write_offset;
        size_t chunk;
...
# 311 "../crypto/bio/bss_bio.c" 3 4
       ((void) (0))
# 311 "../crypto/bio/bss_bio.c"
                                       ;
...
# 328 "../crypto/bio/bss_bio.c" 3 4
       ((void) (0))
# 328 "../crypto/bio/bss_bio.c"
                                ;
...
# 357 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 357 "../crypto/bio/bss_bio.c"
                    ;
    
# 358 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 358 "../crypto/bio/bss_bio.c"
                          ;
    
# 359 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 359 "../crypto/bio/bss_bio.c"
                         ;

    b->request = 0;
    if (b->closed) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",363,__func__), ERR_set_error)((32),(124),
# 363 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 363 "../crypto/bio/bss_bio.c"
       );
        return -1;
    }

    
# 367 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 367 "../crypto/bio/bss_bio.c"
                            ;
    ...
    if (buf != 
# 386 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0)
# 386 "../crypto/bio/bss_bio.c"
                  )
        *buf = b->buf + write_offset;
    
# 388 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 388 "../crypto/bio/bss_bio.c"
                                        ;
...
static ssize_t bio_nwrite(BIO *bio, char **buf, size_t num_)
{
    ...
    if (num_ > 0x7fffffffffffffffL
# 398 "../crypto/bio/bss_bio.c"
                            )
        num = 0x7fffffffffffffffL
# 399 "../crypto/bio/bss_bio.c"
                           ;
    else
        num = (ssize_t) num_;
...
# 409 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 409 "../crypto/bio/bss_bio.c"
                    ;
    b->len += num;
    
# 411 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 411 "../crypto/bio/bss_bio.c"
                            ;
...
# 421 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 421 "../crypto/bio/bss_bio.c"
                    ;
    ...
    case 136:
        if (b->peer) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",428,__func__), ERR_set_error)((32),(123),
# 428 "../crypto/bio/bss_bio.c" 3 4
           ((void *)0)
# 428 "../crypto/bio/bss_bio.c"
           );
            ret = 0;
        } else if (num == 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",431,__func__), ERR_set_error)((32),(125),
# 431 "../crypto/bio/bss_bio.c" 3 4
           ((void *)0)
# 431 "../crypto/bio/bss_bio.c"
            ...
            if (b->size != new_size) {
                CRYPTO_free(b->buf, "../crypto/bio/bss_bio.c", 437);
                b->buf = 
# 438 "../crypto/bio/bss_bio.c" 3 4
                        ((void *)0)
# 438 "../crypto/bio/bss_bio.c"
                            ;
                b->size = new_size;
            }
            ret = 1;
    ...
    case 140:
        ...
        if (b->peer == 
# 474 "../crypto/bio/bss_bio.c" 3 4
                      ((void *)0) 
# 474 "../crypto/bio/bss_bio.c"
                           || b->closed)
            ret = 0;
        else
    ...
    case 1:
        if (b->buf != 
# 528 "../crypto/bio/bss_bio.c" 3 4
                     ((void *)0)
# 528 "../crypto/bio/bss_bio.c"
                         ) {
            b->len = 0;
            b->offset = 0;
        }
    ...
    case 10:
        if (b->peer != 
# 545 "../crypto/bio/bss_bio.c" 3 4
                      ((void *)0)
# 545 "../crypto/bio/bss_bio.c"
                          ) {
    ...
    case 13:
        if (b->buf != 
# 554 "../crypto/bio/bss_bio.c" 3 4
                     ((void *)0)
# 554 "../crypto/bio/bss_bio.c"
                         )
            ret = (long)b->len;
        else
            ret = 0;
...
# 566 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 566 "../crypto/bio/bss_bio.c"
                                    ;
            other_b = other_bio->ptr;
            
# 568 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 568 "../crypto/bio/bss_bio.c"
                                  ;

            
# 570 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 570 "../crypto/bio/bss_bio.c"
                                       ;
    ...
    case 2:
        if (b->peer != 
# 583 "../crypto/bio/bss_bio.c" 3 4
                      ((void *)0)
# 583 "../crypto/bio/bss_bio.c"
                          ) {
            struct bio_bio_st *peer_b = b->peer->ptr;
...
# 610 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 610 "../crypto/bio/bss_bio.c"
                       ;
    
# 611 "../crypto/bio/bss_bio.c" 3 4
   ((void) (0))
# 611 "../crypto/bio/bss_bio.c"
                       ;
    ...
    if (b1->peer != 
# 616 "../crypto/bio/bss_bio.c" 3 4
                   ((void *)0) 
# 616 "../crypto/bio/bss_bio.c"
                        || b2->peer != 
# 616 "../crypto/bio/bss_bio.c" 3 4
                                       ((void *)0)
# 616 "../crypto/bio/bss_bio.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",617,__func__), ERR_set_error)((32),(123),
# 617 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 617 "../crypto/bio/bss_bio.c"
       );
        return 0;
    }

    if (b1->buf == 
# 621 "../crypto/bio/bss_bio.c" 3 4
                  ((void *)0)
# 621 "../crypto/bio/bss_bio.c"
                      ) {
        b1->buf = CRYPTO_malloc(b1->size, "../crypto/bio/bss_bio.c", 622);
        if (b1->buf == 
# 623 "../crypto/bio/bss_bio.c" 3 4
                      ((void *)0)
# 623 "../crypto/bio/bss_bio.c"
                          )
            return 0;
        b1->len = 0;
        b1->offset = 0;
    ...
    if (b2->buf == 
# 629 "../crypto/bio/bss_bio.c" 3 4
                  ((void *)0)
# 629 "../crypto/bio/bss_bio.c"
                      ) {
        b2->buf = CRYPTO_malloc(b2->size, "../crypto/bio/bss_bio.c", 630);
        if (b2->buf == 
# 631 "../crypto/bio/bss_bio.c" 3 4
                      ((void *)0)
# 631 "../crypto/bio/bss_bio.c"
                          )
            return 0;
        b2->len = 0;
        b2->offset = 0;
...
static void bio_destroy_pair(BIO *bio)
{
    ...
    if (b != 
# 654 "../crypto/bio/bss_bio.c" 3 4
            ((void *)0)
# 654 "../crypto/bio/bss_bio.c"
                ) {
        BIO *peer_bio = b->peer;

        if (peer_bio != 
# 657 "../crypto/bio/bss_bio.c" 3 4
                       ((void *)0)
# 657 "../crypto/bio/bss_bio.c"
                           ) {
            struct bio_bio_st *peer_b = peer_bio->ptr;

            
# 660 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 660 "../crypto/bio/bss_bio.c"
                                 ;
            
# 661 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 661 "../crypto/bio/bss_bio.c"
                                      ;

            peer_b->peer = 
# 663 "../crypto/bio/bss_bio.c" 3 4
                          ((void *)0)
# 663 "../crypto/bio/bss_bio.c"
                              ;
            peer_bio->init = 0;
            
# 665 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 665 "../crypto/bio/bss_bio.c"
                                      ;
            peer_b->len = 0;
            peer_b->offset = 0;

            b->peer = 
# 669 "../crypto/bio/bss_bio.c" 3 4
                     ((void *)0)
# 669 "../crypto/bio/bss_bio.c"
                         ;
            bio->init = 0;
            
# 671 "../crypto/bio/bss_bio.c" 3 4
           ((void) (0))
# 671 "../crypto/bio/bss_bio.c"
                                 ;
            b->len = 0;
            b->offset = 0;
        }
...
{
    BIO *bio1 = 
# 682 "../crypto/bio/bss_bio.c" 3 4
               ((void *)0)
# 682 "../crypto/bio/bss_bio.c"
                   , *bio2 = 
# 682 "../crypto/bio/bss_bio.c" 3 4
                             ((void *)0)
# 682 "../crypto/bio/bss_bio.c"
    ...
    if (bio1 == 
# 687 "../crypto/bio/bss_bio.c" 3 4
               ((void *)0)
# 687 "../crypto/bio/bss_bio.c"
                   )
        goto err;
    bio2 = BIO_new(BIO_s_bio());
    if (bio2 == 
# 690 "../crypto/bio/bss_bio.c" 3 4
               ((void *)0)
# 690 "../crypto/bio/bss_bio.c"
                   )
        goto err;

    if (writebuf1) {
        r = (int)BIO_ctrl(bio1,136,writebuf1,
# 694 "../crypto/bio/bss_bio.c" 3 4
           ((void *)0)
# 694 "../crypto/bio/bss_bio.c"
           );
        if (!r)
            goto err;
    }
...
# 699 "../crypto/bio/bss_bio.c" 3 4
           ((void *)0)
# 699 "../crypto/bio/bss_bio.c"
           );
        if (!r)
            goto err;
    }
 ...
 err:
    if (ret == 0) {
        BIO_free(bio1);
        bio1 = 
# 712 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0)
# 712 "../crypto/bio/bss_bio.c"
                  ;
        BIO_free(bio2);
        bio2 = 
# 714 "../crypto/bio/bss_bio.c" 3 4
              ((void *)0)
# 714 "../crypto/bio/bss_bio.c"
                  ;
    }
...
# 724 "../crypto/bio/bss_bio.c" 3 4
                                                      ((void *)0)
# 724 "../crypto/bio/bss_bio.c"
                                                          );
}
...
# 729 "../crypto/bio/bss_bio.c" 3 4
                                                   ((void *)0)
# 729 "../crypto/bio/bss_bio.c"
                                                       );
}
...
# 734 "../crypto/bio/bss_bio.c" 3 4
                                                      ((void *)0)
# 734 "../crypto/bio/bss_bio.c"
                                                          ) != 0);
}
...
int BIO_nread0(BIO *bio, char **buf)
{
    ...
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",747,__func__), ERR_set_error)((32),(120),
# 747 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 747 "../crypto/bio/bss_bio.c"
       );
        return -2;
    }
    ...
    if (ret > 0x7fffffff
# 752 "../crypto/bio/bss_bio.c"
                    )
        return 0x7fffffff
# 753 "../crypto/bio/bss_bio.c"
                     ;
    else
        return (int)ret;
}
...
int BIO_nread(BIO *bio, char **buf, int num)
{
    ...
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",763,__func__), ERR_set_error)((32),(120),
# 763 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 763 "../crypto/bio/bss_bio.c"
       );
        return -2;
    }
...
int BIO_nwrite0(BIO *bio, char **buf)
{
    ...
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",778,__func__), ERR_set_error)((32),(120),
# 778 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 778 "../crypto/bio/bss_bio.c"
       );
        return -2;
    }
    ...
    if (ret > 0x7fffffff
# 783 "../crypto/bio/bss_bio.c"
                    )
        return 0x7fffffff
# 784 "../crypto/bio/bss_bio.c"
                     ;
    else
        return (int)ret;
}
...
int BIO_nwrite(BIO *bio, char **buf, int num)
{
    ...
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_bio.c",794,__func__), ERR_set_error)((32),(120),
# 794 "../crypto/bio/bss_bio.c" 3 4
       ((void *)0)
# 794 "../crypto/bio/bss_bio.c"
       );
        return -2;
    }
