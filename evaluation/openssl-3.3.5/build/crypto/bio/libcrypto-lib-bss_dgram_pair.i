# 0 "../crypto/bio/bss_dgram_pair.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_dgram_pair.c"
# 10 "../crypto/bio/bss_dgram_pair.c"
...
# 11 "../crypto/bio/bss_dgram_pair.c" 2
...
# 12 "../crypto/bio/bss_dgram_pair.c" 2
...
# 13 "../crypto/bio/bss_dgram_pair.c" 2

# 1 "../include/internal/safe_math.h" 1
# 12 "../include/internal/safe_math.h"
        
# 15 "../crypto/bio/bss_dgram_pair.c" 2
...
# 18 "../crypto/bio/bss_dgram_pair.c" 3 4
((void *)0) 
# 18 "../crypto/bio/bss_dgram_pair.c"
...
{
    r->start = CRYPTO_malloc(nbytes, "../crypto/bio/bss_dgram_pair.c", 37);
    if (r->start == 
# 38 "../crypto/bio/bss_dgram_pair.c" 3 4
                   ((void *)0)
# 38 "../crypto/bio/bss_dgram_pair.c"
                       )
        return 0;
...
{
    CRYPTO_free(r->start, "../crypto/bio/bss_dgram_pair.c", 48);
    r->start = 
# 49 "../crypto/bio/bss_dgram_pair.c" 3 4
                 ((void *)0)
# 49 "../crypto/bio/bss_dgram_pair.c"
                     ;
    r->len = 0;
    r->count = 0;
}
# 62 "../crypto/bio/bss_dgram_pair.c"
...
# 82 "../crypto/bio/bss_dgram_pair.c"
static void ring_buf_push_pop(struct ring_buf *r, int idx, size_t num_bytes)
{
    ...
    if (!__builtin_expect(!!((num_bytes <= r->len - r->idx[idx]) != 0), 1))
        return;




    if (!__builtin_expect(!!((idx != 0 ? num_bytes <= r->count : num_bytes + r->count <= r->len) != 0), 1)
                                                               )
        return;
...
static int ring_buf_resize(struct ring_buf *r, size_t nbytes)
{
    ...
    if (r->start == 
# 124 "../crypto/bio/bss_dgram_pair.c" 3 4
                   ((void *)0)
# 124 "../crypto/bio/bss_dgram_pair.c"
                       )
    ...
    new_start = CRYPTO_realloc(r->start, nbytes, "../crypto/bio/bss_dgram_pair.c", 134);
    if (new_start == 
# 135 "../crypto/bio/bss_dgram_pair.c" 3 4
                    ((void *)0)
# 135 "../crypto/bio/bss_dgram_pair.c"
                        )
        return 0;
...
# 177 "../crypto/bio/bss_dgram_pair.c"
...
# 206 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 206 "../crypto/bio/bss_dgram_pair.c"
       ,
    
# 207 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 207 "../crypto/bio/bss_dgram_pair.c"
       ,
    dgram_pair_ctrl,
    dgram_pair_init,
    dgram_pair_free,
    
# 211 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 211 "../crypto/bio/bss_dgram_pair.c"
       ,
    dgram_pair_sendmmsg,
    dgram_pair_recvmmsg,
};
...
# 223 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 223 "../crypto/bio/bss_dgram_pair.c"
       ,
    
# 224 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 224 "../crypto/bio/bss_dgram_pair.c"
       ,
    dgram_mem_ctrl,
    dgram_mem_init,
    dgram_pair_free,
    
# 228 "../crypto/bio/bss_dgram_pair.c" 3 4
   ((void *)0)
# 228 "../crypto/bio/bss_dgram_pair.c"
       ,
    dgram_pair_sendmmsg,
    dgram_pair_recvmmsg,
};
...
static int dgram_pair_init(BIO *bio)
{
    struct bio_dgram_pair_st *b = CRYPTO_zalloc(sizeof(*b), "../crypto/bio/bss_dgram_pair.c", 277);

    if (b == 
# 279 "../crypto/bio/bss_dgram_pair.c" 3 4
            ((void *)0)
# 279 "../crypto/bio/bss_dgram_pair.c"
                )
        return 0;
    ...
    if (b->lock == 
# 287 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 287 "../crypto/bio/bss_dgram_pair.c"
                      ) {
        CRYPTO_free(b, "../crypto/bio/bss_dgram_pair.c", 288);
        return 0;
    }
...
static int dgram_mem_init(BIO *bio)
{
    ...
    if (ring_buf_init(&b->rbuf, b->req_buf_len) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",306,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 306 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 306 "../crypto/bio/bss_dgram_pair.c"
       );
        return 0;
    }
...
static int dgram_pair_free(BIO *bio)
{
    ...
    if (bio == 
# 320 "../crypto/bio/bss_dgram_pair.c" 3 4
              ((void *)0)
# 320 "../crypto/bio/bss_dgram_pair.c"
                  )
        return 0;

    b = bio->ptr;
    if (!__builtin_expect(!!((b != 
# 324 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 324 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1))
        return 0;
    ...
    CRYPTO_free(b, "../crypto/bio/bss_dgram_pair.c", 331);
    return 1;
}
...
static int dgram_pair_ctrl_make_bio_pair(BIO *bio1, BIO *bio2)
{
    ...
    if (bio1 == 
# 341 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0) 
# 341 "../crypto/bio/bss_dgram_pair.c"
                    || bio2 == 
# 341 "../crypto/bio/bss_dgram_pair.c" 3 4
                               ((void *)0)
# 341 "../crypto/bio/bss_dgram_pair.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",342,__func__), ERR_set_error)((32),(125),
# 342 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 342 "../crypto/bio/bss_dgram_pair.c"
       );
        return 0;
    }
    ...
    if (bio1->method != &dgram_pair_method || bio2->method != &dgram_pair_method) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",348,__func__), ERR_set_error)(32, 125,
    ...
    if (!__builtin_expect(!!((b1 != 
# 356 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0) 
# 356 "../crypto/bio/bss_dgram_pair.c"
        && b2 != 
# 356 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 356 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",357,__func__), ERR_set_error)((32),(120),
# 357 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 357 "../crypto/bio/bss_dgram_pair.c"
       );
        return 0;
    }
    ...
    if (b1->peer != 
# 365 "../crypto/bio/bss_dgram_pair.c" 3 4
                   ((void *)0) 
# 365 "../crypto/bio/bss_dgram_pair.c"
                        || b2->peer != 
# 365 "../crypto/bio/bss_dgram_pair.c" 3 4
                                       ((void *)0)
# 365 "../crypto/bio/bss_dgram_pair.c"
                                           ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",366,__func__), ERR_set_error)(32, 123,
                       "cannot associate a BIO_dgram_pair which is already in use");
        return 0;
    }

    if (!__builtin_expect(!!((b1->req_buf_len >= (1024) && b2->req_buf_len >= (1024)) != 0), 1)
                                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",373,__func__), ERR_set_error)((32),(120),
# 373 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 373 "../crypto/bio/bss_dgram_pair.c"
       );
        return 0;
    }
    ...
    if (b1->rbuf.len != b1->req_buf_len)
        if (ring_buf_init(&b1->rbuf, b1->req_buf_len) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",379,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 379 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 379 "../crypto/bio/bss_dgram_pair.c"
           );
            return 0;
        }
    ...
    if (b2->rbuf.len != b2->req_buf_len)
        if (ring_buf_init(&b2->rbuf, b2->req_buf_len) == 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",385,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 385 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 385 "../crypto/bio/bss_dgram_pair.c"
           );
...
static int dgram_pair_ctrl_destroy_bio_pair(BIO *bio1)
{
    ...
    if (b1->peer == 
# 409 "../crypto/bio/bss_dgram_pair.c" 3 4
                   ((void *)0)
# 409 "../crypto/bio/bss_dgram_pair.c"
                       )
        return 1;
    ...
    if (!__builtin_expect(!!((b2->peer == bio1) != 0), 1))
        return 0;
    ...
    bio2->init = 0;
    b1->peer = 
# 423 "../crypto/bio/bss_dgram_pair.c" 3 4
              ((void *)0)
# 423 "../crypto/bio/bss_dgram_pair.c"
                  ;
    b2->peer = 
# 424 "../crypto/bio/bss_dgram_pair.c" 3 4
              ((void *)0)
# 424 "../crypto/bio/bss_dgram_pair.c"
                  ;
    return 1;
}
...
static int dgram_pair_ctrl_eof(BIO *bio)
{
    ...
    if (!__builtin_expect(!!((b != 
# 433 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 433 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1))
        return -1;
    ...
    if (!bio->init)
        return 1;
    if (!(b->peer != 
# 439 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 439 "../crypto/bio/bss_dgram_pair.c"
        ))
        return 0;


    peerb = b->peer->ptr;
    if (!__builtin_expect(!!((peerb != 
# 444 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 444 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1))
        return -1;
...
static int dgram_pair_ctrl_set_write_buf_size(BIO *bio, size_t len)
{
    ...
    if (b->peer != 
# 460 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 460 "../crypto/bio/bss_dgram_pair.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",461,__func__), ERR_set_error)((32),(123),
# 461 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 461 "../crypto/bio/bss_dgram_pair.c"
       );
        return 0;
    }
    ...
    if (b->rbuf.start != 
# 469 "../crypto/bio/bss_dgram_pair.c" 3 4
                        ((void *)0)
# 469 "../crypto/bio/bss_dgram_pair.c"
                            ) {
...
static size_t dgram_pair_ctrl_pending(BIO *bio)
{
    ...
    if (!bio->init)
        return 0;
    if ((b->peer != 
# 499 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 499 "../crypto/bio/bss_dgram_pair.c"
       ))
        readb = b->peer->ptr;
    else
        readb = b;
    ...
    if (!__builtin_expect(!!((l == 0 || l == sizeof(hdr)) != 0), 1))
        return 0;
...
static int dgram_pair_ctrl_get_local_addr_cap(BIO *bio)
{
    ...
    if ((b->peer != 
# 555 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 555 "../crypto/bio/bss_dgram_pair.c"
       ))
        readb = b->peer->ptr;
    else
        readb = b;

    return (~readb->cap & ((1U << 0)
                           | (1U << 3))) == 0;
}
...
static int dgram_pair_ctrl_get_effective_caps(BIO *bio)
{
    ...
    if (b->peer == 
# 569 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 569 "../crypto/bio/bss_dgram_pair.c"
                      )
        return 0;
...
static int dgram_pair_ctrl_set_mtu(BIO *bio, size_t mtu)
{
    ...
    if (b->peer != 
# 629 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 629 "../crypto/bio/bss_dgram_pair.c"
                      ) {
        peerb = b->peer->ptr;
        peerb->mtu = mtu;
    }
...
static long dgram_mem_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (!__builtin_expect(!!((b != 
# 643 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 643 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1))
        return 0;
                           ...
                           BIO **pbio2, size_t writebuf2)
{
    ...
    long r;
    BIO *bio1 = 
# 790 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 790 "../crypto/bio/bss_dgram_pair.c"
                   , *bio2 = 
# 790 "../crypto/bio/bss_dgram_pair.c" 3 4
                             ((void *)0)
# 790 "../crypto/bio/bss_dgram_pair.c"
    ...
    if (bio1 == 
# 793 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 793 "../crypto/bio/bss_dgram_pair.c"
                   )
        goto err;

    bio2 = BIO_new(BIO_s_dgram_pair());
    if (bio2 == 
# 797 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 797 "../crypto/bio/bss_dgram_pair.c"
                   )
        goto err;

    if (writebuf1 > 0) {
        r = (int)BIO_ctrl(bio1,136,writebuf1,
# 801 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 801 "../crypto/bio/bss_dgram_pair.c"
           );
        if (r == 0)
            goto err;
    }
...
# 807 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 807 "../crypto/bio/bss_dgram_pair.c"
           );
        if (r == 0)
            goto err;
    }
...
err:
    if (ret == 0) {
        BIO_free(bio1);
        bio1 = 
# 820 "../crypto/bio/bss_dgram_pair.c" 3 4
              ((void *)0)
# 820 "../crypto/bio/bss_dgram_pair.c"
                  ;
        BIO_free(bio2);
        bio2 = 
# 822 "../crypto/bio/bss_dgram_pair.c" 3 4
              ((void *)0)
# 822 "../crypto/bio/bss_dgram_pair.c"
                  ;
    }
...
static size_t dgram_pair_read_inner(struct bio_dgram_pair_st *b, uint8_t *buf, size_t sz)
{
    ...
    while (sz > 0) {
        uint8_t *src_buf = 
# 842 "../crypto/bio/bss_dgram_pair.c" 3 4
                          ((void *)0)
# 842 "../crypto/bio/bss_dgram_pair.c"
                              ;
        size_t src_len = 0;
        ...
        ring_buf_head_tail((&b->rbuf), 1, (&src_buf), (&src_len));
        if (src_len == 0)
            break;
        ...
        if (buf != 
# 856 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 856 "../crypto/bio/bss_dgram_pair.c"
                      )
            memcpy(buf, src_buf, src_len);

        ring_buf_push_pop((&b->rbuf), 1, (src_len));

        if (buf != 
# 861 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 861 "../crypto/bio/bss_dgram_pair.c"
                      )
            buf += src_len;
        total_read += src_len;
        sz -= src_len;
...
static ssize_t dgram_pair_read_actual(BIO *bio, char *buf, size_t sz,
                                           ...
                                           int is_multi)
{
    ...
    if (!__builtin_expect(!!((b != 
# 888 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 888 "../crypto/bio/bss_dgram_pair.c"
        ) != 0), 1))
        return -104;

    if ((b->peer != 
# 891 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 891 "../crypto/bio/bss_dgram_pair.c"
       ))
        readb = b->peer->ptr;
    else
        readb = b;
    if (!__builtin_expect(!!((readb != 
# 895 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0) 
# 895 "../crypto/bio/bss_dgram_pair.c"
        && readb->rbuf.start != 
# 895 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 895 "../crypto/bio/bss_dgram_pair.c"
    ...
    if (sz > 0 && buf == 
# 898 "../crypto/bio/bss_dgram_pair.c" 3 4
                        ((void *)0)
# 898 "../crypto/bio/bss_dgram_pair.c"
                            )
        return -125;


    if (local != 
# 902 "../crypto/bio/bss_dgram_pair.c" 3 4
                ((void *)0) 
# 902 "../crypto/bio/bss_dgram_pair.c"
                     && b->local_addr_enable == 0)
        return -111;
    ...
    if (!__builtin_expect(!!((l == sizeof(hdr)) != 0), 1))
    ...
    if (trunc > 0 && !__builtin_expect(!!((dgram_pair_read_inner(readb, 
# 945 "../crypto/bio/bss_dgram_pair.c" 3 4
                     ((void *)0)
# 945 "../crypto/bio/bss_dgram_pair.c"
                     , trunc) == trunc) != 0), 1))

        return -104;

    if (local != 
# 949 "../crypto/bio/bss_dgram_pair.c" 3 4
                ((void *)0)
# 949 "../crypto/bio/bss_dgram_pair.c"
                    )
        *local = hdr.dst_addr;
    if (peer != 
# 951 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 951 "../crypto/bio/bss_dgram_pair.c"
                   )
        *peer = hdr.src_addr;
                                      ...
                                      struct bio_dgram_pair_st *b)
{
    ...
    if (!__builtin_expect(!!((a->role != b->role) != 0), 1))
        return 0;

    if (!__builtin_expect(!!((a != b && x != y) != 0), 1))
        return 0;
...
static int dgram_pair_read(BIO *bio, char *buf, int sz_)
{
    ...
    if (sz_ < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",998,__func__), ERR_set_error)((32),(125),
# 998 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 998 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    if (b->peer == 
# 1002 "../crypto/bio/bss_dgram_pair.c" 3 4
                  ((void *)0)
# 1002 "../crypto/bio/bss_dgram_pair.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1003,__func__), ERR_set_error)((32),(124),
# 1003 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1003 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }
    ...
    if (dgram_pair_lock_both_write(peerb, b) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1015,__func__), ERR_set_error)((32),((272|((0x1 << 18L)|(0x2 << 18L)))),
# 1015 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1015 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    l = dgram_pair_read_actual(bio, buf, (size_t)sz_, 
# 1019 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                     ((void *)0)
# 1019 "../crypto/bio/bss_dgram_pair.c"
                                                         , 
# 1019 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                           ((void *)0)
# 1019 "../crypto/bio/bss_dgram_pair.c"
    ...
    if (l < 0) {
        if (l != -112)
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1022,__func__), ERR_set_error)((32),(-l),
# 1022 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 1022 "../crypto/bio/bss_dgram_pair.c"
           );
        ret = -1;
    } else {
        ret = (int)l;
                               ...
                               size_t *num_processed)
{
    ...
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1050,__func__), ERR_set_error)((32),(124),
# 1050 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1050 "../crypto/bio/bss_dgram_pair.c"
       );
        *num_processed = 0;
        return 0;
    }
    ...
    if ((b->peer != 
# 1055 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1055 "../crypto/bio/bss_dgram_pair.c"
       ))
        readb = b->peer->ptr;
    else
        readb = b;
    ...
    if (CRYPTO_THREAD_write_lock(readb->lock) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1061,__func__), ERR_set_error)((32),((272|((0x1 << 18L)|(0x2 << 18L)))),
# 1061 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1061 "../crypto/bio/bss_dgram_pair.c"
       );
        *num_processed = 0;
        return 0;
    }
        ...
        if (l < 0) {
            *num_processed = i;
            if (i > 0) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1075,__func__), ERR_set_error)((32),(-l),
# 1075 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 1075 "../crypto/bio/bss_dgram_pair.c"
               );
                ret = 0;
            }
            goto out;
...
static int dgram_mem_read(BIO *bio, char *buf, int sz_)
{
    ...
    if (sz_ < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1100,__func__), ERR_set_error)((32),(125),
# 1100 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1100 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    if (CRYPTO_THREAD_write_lock(b->lock) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1105,__func__), ERR_set_error)((32),((272|((0x1 << 18L)|(0x2 << 18L)))),
# 1105 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1105 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    l = dgram_pair_read_actual(bio, buf, (size_t)sz_, 
# 1109 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                     ((void *)0)
# 1109 "../crypto/bio/bss_dgram_pair.c"
                                                         , 
# 1109 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                           ((void *)0)
# 1109 "../crypto/bio/bss_dgram_pair.c"
    ...
    if (l < 0) {
        if (l != -112)
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1112,__func__), ERR_set_error)((32),(-l),
# 1112 "../crypto/bio/bss_dgram_pair.c" 3 4
           ((void *)0)
# 1112 "../crypto/bio/bss_dgram_pair.c"
           );
        ret = -1;
    } else {
        ret = (int)l;
...
# 1132 "../crypto/bio/bss_dgram_pair.c"
static const size_t max_rbuf_size = 
# 1132 "../crypto/bio/bss_dgram_pair.c" 3 4
                                     ...
                                     const uint8_t *buf, size_t sz)
{
    ...
    while (sz > 0) {
        ...
        ring_buf_head_tail((&b->rbuf), 0, (&dst_buf), (&dst_len));
        if (dst_len == 0) {
            size_t new_len;
        ...
        ring_buf_push_pop((&b->rbuf), 0, (dst_len));
...
static ssize_t dgram_pair_write_actual(BIO *bio, const char *buf, size_t sz,
                                            ...
                                            int is_multi)
{
    ...
    if (!__builtin_expect(!!((b != 
# 1215 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0) 
# 1215 "../crypto/bio/bss_dgram_pair.c"
        && b->rbuf.start != 
# 1215 "../crypto/bio/bss_dgram_pair.c" 3 4
        ((void *)0)
# 1215 "../crypto/bio/bss_dgram_pair.c"
    ...
    if (sz > 0 && buf == 
# 1218 "../crypto/bio/bss_dgram_pair.c" 3 4
                        ((void *)0)
# 1218 "../crypto/bio/bss_dgram_pair.c"
                            )
        return -125;

    if (local != 
# 1221 "../crypto/bio/bss_dgram_pair.c" 3 4
                ((void *)0) 
# 1221 "../crypto/bio/bss_dgram_pair.c"
                     && b->local_addr_enable == 0)
        return -111;

    if ((b->peer != 
# 1224 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1224 "../crypto/bio/bss_dgram_pair.c"
       ))
        readb = b->peer->ptr;
    else
        readb = b;
    if (peer != 
# 1228 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0) 
# 1228 "../crypto/bio/bss_dgram_pair.c"
                    && (readb->cap & (1U << 1)) == 0)
        return -151;

    hdr.len = sz;
    hdr.dst_addr = (peer != 
# 1232 "../crypto/bio/bss_dgram_pair.c" 3 4
                           ((void *)0) 
# 1232 "../crypto/bio/bss_dgram_pair.c"
                                ? *peer : zero_addr);
    hdr.src_addr = (local != 
# 1233 "../crypto/bio/bss_dgram_pair.c" 3 4
                            ((void *)0) 
# 1233 "../crypto/bio/bss_dgram_pair.c"
                                 ? *local : zero_addr);
...
static int dgram_pair_write(BIO *bio, const char *buf, int sz_)
{
    ...
    if (sz_ < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1261,__func__), ERR_set_error)((32),(125),
# 1261 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1261 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    if (CRYPTO_THREAD_write_lock(b->lock) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1266,__func__), ERR_set_error)((32),((272|((0x1 << 18L)|(0x2 << 18L)))),
# 1266 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1266 "../crypto/bio/bss_dgram_pair.c"
       );
        return -1;
    }

    l = dgram_pair_write_actual(bio, buf, (size_t)sz_, 
# 1270 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                      ((void *)0)
# 1270 "../crypto/bio/bss_dgram_pair.c"
                                                          , 
# 1270 "../crypto/bio/bss_dgram_pair.c" 3 4
                                                            ((void *)0)
# 1270 "../crypto/bio/bss_dgram_pair.c"
                                                                , 0);
    if (l < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1272,__func__), ERR_set_error)((32),(-l),
# 1272 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1272 "../crypto/bio/bss_dgram_pair.c"
       );
        ret = -1;
    } else {
        ret = (int)l;
                               ...
                               uint64_t flags, size_t *num_processed)
{
    ...
    if (CRYPTO_THREAD_write_lock(b->lock) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1298,__func__), ERR_set_error)((32),((272|((0x1 << 18L)|(0x2 << 18L)))),
# 1298 "../crypto/bio/bss_dgram_pair.c" 3 4
       ((void *)0)
# 1298 "../crypto/bio/bss_dgram_pair.c"
       );
        *num_processed = 0;
        return 0;
    }
        ...
        if (l < 0) {
            *num_processed = i;
            if (i > 0) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram_pair.c",1312,__func__), ERR_set_error)((32),(-l),
# 1312 "../crypto/bio/bss_dgram_pair.c" 3 4
               ((void *)0)
# 1312 "../crypto/bio/bss_dgram_pair.c"
               );
                ret = 0;
            }
            goto out;
