# 0 "../crypto/bio/ossl_core_bio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/ossl_core_bio.c"
# 10 "../crypto/bio/ossl_core_bio.c"
...
# 11 "../crypto/bio/ossl_core_bio.c" 2
...
# 12 "../crypto/bio/ossl_core_bio.c" 2
...
{
    OSSL_CORE_BIO *cb = CRYPTO_malloc(sizeof(*cb), "../crypto/bio/ossl_core_bio.c", 25);

    if (cb == 
# 27 "../crypto/bio/ossl_core_bio.c" 3 4
             ((void *)0) 
# 27 "../crypto/bio/ossl_core_bio.c"
                  || !CRYPTO_NEW_REF(&cb->ref_cnt, 1)) {
        CRYPTO_free(cb, "../crypto/bio/ossl_core_bio.c", 28);
        return 
# 29 "../crypto/bio/ossl_core_bio.c" 3 4
              ((void *)0)
# 29 "../crypto/bio/ossl_core_bio.c"
                  ;
    }
    return cb;
}
...
int ossl_core_bio_free(OSSL_CORE_BIO *cb)
{
    ...
    if (cb != 
# 45 "../crypto/bio/ossl_core_bio.c" 3 4
             ((void *)0)
# 45 "../crypto/bio/ossl_core_bio.c"
                 ) {
        CRYPTO_DOWN_REF(&cb->ref_cnt, &ref);
        if (ref <= 0) {
            res = BIO_free(cb->bio);
            CRYPTO_FREE_REF(&cb->ref_cnt);
            CRYPTO_free(cb, "../crypto/bio/ossl_core_bio.c", 50);
        }
    }
    return res;
}
...
OSSL_CORE_BIO *ossl_core_bio_new_from_bio(BIO *bio)
{
    ...
    if (cb == 
# 60 "../crypto/bio/ossl_core_bio.c" 3 4
             ((void *)0) 
# 60 "../crypto/bio/ossl_core_bio.c"
                  || !BIO_up_ref(bio)) {
        ossl_core_bio_free(cb);
        return 
# 62 "../crypto/bio/ossl_core_bio.c" 3 4
              ((void *)0)
# 62 "../crypto/bio/ossl_core_bio.c"
                  ;
    }
    cb->bio = bio;
    return cb;
...
{
    OSSL_CORE_BIO *cb = 
# 70 "../crypto/bio/ossl_core_bio.c" 3 4
                       ((void *)0)
# 70 "../crypto/bio/ossl_core_bio.c"
                           ;

    if (bio == 
# 72 "../crypto/bio/ossl_core_bio.c" 3 4
              ((void *)0)
# 72 "../crypto/bio/ossl_core_bio.c"
                  )
        return 
# 73 "../crypto/bio/ossl_core_bio.c" 3 4
              ((void *)0)
# 73 "../crypto/bio/ossl_core_bio.c"
                  ;
    if ((cb = core_bio_new()) == 
# 74 "../crypto/bio/ossl_core_bio.c" 3 4
                                ((void *)0)
# 74 "../crypto/bio/ossl_core_bio.c"
                                    ) {
        BIO_free(bio);
        return 
# 76 "../crypto/bio/ossl_core_bio.c" 3 4
              ((void *)0)
# 76 "../crypto/bio/ossl_core_bio.c"
                  ;
    }
    cb->bio = bio;
    return cb;
