# 0 "../crypto/bio/bf_buff.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_buff.c"
# 10 "../crypto/bio/bf_buff.c"
...
{
    BIO_F_BUFFER_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/bio/bf_buff.c", 47);

    if (ctx == 
# 49 "../crypto/bio/bf_buff.c" 3 4
              ((void *)0)
# 49 "../crypto/bio/bf_buff.c"
                  )
        return 0;
    ctx->ibuf_size = 4096;
    ctx->ibuf = CRYPTO_malloc(4096, "../crypto/bio/bf_buff.c", 52);
    if (ctx->ibuf == 
# 53 "../crypto/bio/bf_buff.c" 3 4
                    ((void *)0)
# 53 "../crypto/bio/bf_buff.c"
                        ) {
        CRYPTO_free(ctx, "../crypto/bio/bf_buff.c", 54);
        return 0;
    }
    ctx->obuf_size = 4096;
    ctx->obuf = CRYPTO_malloc(4096, "../crypto/bio/bf_buff.c", 58);
    if (ctx->obuf == 
# 59 "../crypto/bio/bf_buff.c" 3 4
                    ((void *)0)
# 59 "../crypto/bio/bf_buff.c"
                        ) {
        CRYPTO_free(ctx->ibuf, "../crypto/bio/bf_buff.c", 60);
        CRYPTO_free(ctx, "../crypto/bio/bf_buff.c", 61);
        return 0;
    }
...
static int buffer_free(BIO *a)
{
    ...
    if (a == 
# 75 "../crypto/bio/bf_buff.c" 3 4
            ((void *)0)
# 75 "../crypto/bio/bf_buff.c"
                )
        return 0;
    b = (BIO_F_BUFFER_CTX *)a->ptr;
    CRYPTO_free(b->ibuf, "../crypto/bio/bf_buff.c", 78);
    CRYPTO_free(b->obuf, "../crypto/bio/bf_buff.c", 79);
    CRYPTO_free(a->ptr, "../crypto/bio/bf_buff.c", 80);
    a->ptr = 
# 81 "../crypto/bio/bf_buff.c" 3 4
            ((void *)0)
# 81 "../crypto/bio/bf_buff.c"
                ;
    a->init = 0;
    a->flags = 0;
    return 1;
...
static int buffer_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 92 "../crypto/bio/bf_buff.c" 3 4
              ((void *)0)
# 92 "../crypto/bio/bf_buff.c"
                  )
        return 0;
    ctx = (BIO_F_BUFFER_CTX *)b->ptr;

    if ((ctx == 
# 96 "../crypto/bio/bf_buff.c" 3 4
               ((void *)0)
# 96 "../crypto/bio/bf_buff.c"
                   ) || (b->next_bio == 
# 96 "../crypto/bio/bf_buff.c" 3 4
                                        ((void *)0)
# 96 "../crypto/bio/bf_buff.c"
...
static int buffer_write(BIO *b, const char *in, int inl)
{
    ...
    if ((in == 
# 163 "../crypto/bio/bf_buff.c" 3 4
              ((void *)0)
# 163 "../crypto/bio/bf_buff.c"
                  ) || (inl <= 0))
        return 0;
    ctx = (BIO_F_BUFFER_CTX *)b->ptr;
    if ((ctx == 
# 166 "../crypto/bio/bf_buff.c" 3 4
               ((void *)0)
# 166 "../crypto/bio/bf_buff.c"
                   ) || (b->next_bio == 
# 166 "../crypto/bio/bf_buff.c" 3 4
                                        ((void *)0)
# 166 "../crypto/bio/bf_buff.c"
...
static long buffer_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 1:
        ...
        ctx->obuf_len = 0;
        if (b->next_bio == 
# 252 "../crypto/bio/bf_buff.c" 3 4
                          ((void *)0)
# 252 "../crypto/bio/bf_buff.c"
                              )
            return 0;
    ...
    case 13:
        ...
        if (ret == 0) {
            if (b->next_bio == 
# 275 "../crypto/bio/bf_buff.c" 3 4
                              ((void *)0)
# 275 "../crypto/bio/bf_buff.c"
                                  )
                return 0;
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        }
    ...
    case 10:
        ...
        if (ret == 0) {
            if (b->next_bio == 
# 283 "../crypto/bio/bf_buff.c" 3 4
                              ((void *)0)
# 283 "../crypto/bio/bf_buff.c"
                                  )
                return 0;
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        }
    ...
    case 122:
        if (num > ctx->ibuf_size) {
            if (num <= 0)
                return 0;
            p1 = CRYPTO_malloc((size_t)num, "../crypto/bio/bf_buff.c", 292);
            if (p1 == 
# 293 "../crypto/bio/bf_buff.c" 3 4
                     ((void *)0)
# 293 "../crypto/bio/bf_buff.c"
                         )
                return 0;
            CRYPTO_free(ctx->ibuf, "../crypto/bio/bf_buff.c", 295);
            ctx->ibuf = p1;
        }
        ctx->ibuf_off = 0;
    ...
    case 117:
        if (ptr != 
# 304 "../crypto/bio/bf_buff.c" 3 4
                  ((void *)0)
# 304 "../crypto/bio/bf_buff.c"
                      ) {
            ip = (int *)ptr;
            if (*ip == 0) {
                ibs = (int)num;
        ...
        if ((ibs > 4096) && (ibs != ctx->ibuf_size)) {
            if (num <= 0)
                return 0;
            p1 = CRYPTO_malloc((size_t)num, "../crypto/bio/bf_buff.c", 323);
            if (p1 == 
# 324 "../crypto/bio/bf_buff.c" 3 4
                     ((void *)0)
# 324 "../crypto/bio/bf_buff.c"
                         )
                return 0;
        }
        if ((obs > 4096) && (obs != ctx->obuf_size)) {
            p2 = CRYPTO_malloc((size_t)num, "../crypto/bio/bf_buff.c", 328);
            if (p2 == 
# 329 "../crypto/bio/bf_buff.c" 3 4
                     ((void *)0)
# 329 "../crypto/bio/bf_buff.c"
                         ) {
                if (p1 != ctx->ibuf)
                    CRYPTO_free(p1, "../crypto/bio/bf_buff.c", 331);
                return 0;
            }
        }
        if (ctx->ibuf != p1) {
            CRYPTO_free(ctx->ibuf, "../crypto/bio/bf_buff.c", 336);
            ctx->ibuf = p1;
            ctx->ibuf_off = 0;
            ctx->ibuf_len = 0;
            ctx->ibuf_size = ibs;
        ...
        if (ctx->obuf != p2) {
            CRYPTO_free(ctx->obuf, "../crypto/bio/bf_buff.c", 343);
            ctx->obuf = p2;
            ctx->obuf_off = 0;
            ctx->obuf_len = 0;
            ctx->obuf_size = obs;
    ...
    case 101:
        if (b->next_bio == 
# 351 "../crypto/bio/bf_buff.c" 3 4
                          ((void *)0)
# 351 "../crypto/bio/bf_buff.c"
                              )
            return 0;
        BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
        ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
    ...
    case 11:
        if (b->next_bio == 
# 359 "../crypto/bio/bf_buff.c" 3 4
                          ((void *)0)
# 359 "../crypto/bio/bf_buff.c"
                              )
            return 0;
        if (ctx->obuf_len <= 0) {
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
    ...
    case 12:
        dbio = (BIO *)ptr;
        if (BIO_int_ctrl(dbio,117,ctx->ibuf_size,0) <= 0 ||
            BIO_int_ctrl(dbio,117,ctx->obuf_size,1) <= 0)
            ret = 0;
        break;
    case 29:
    ...
    default:
        if (b->next_bio == 
# 404 "../crypto/bio/bf_buff.c" 3 4
                          ((void *)0)
# 404 "../crypto/bio/bf_buff.c"
                              )
            return 0;
        ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        break;
...
{
    if (b->next_bio == 
# 414 "../crypto/bio/bf_buff.c" 3 4
                      ((void *)0)
# 414 "../crypto/bio/bf_buff.c"
                          )
        return 0;
