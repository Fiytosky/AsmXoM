# 0 "../crypto/bio/bf_lbuf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_lbuf.c"
# 10 "../crypto/bio/bf_lbuf.c"
...
static int linebuffer_new(BIO *bi)
{
    ...
    if ((ctx = CRYPTO_malloc(sizeof(*ctx), "../crypto/bio/bf_lbuf.c", 60)) == 
# 60 "../crypto/bio/bf_lbuf.c" 3 4
                                               ((void *)0)
# 60 "../crypto/bio/bf_lbuf.c"
                                                   )
        return 0;
    ctx->obuf = CRYPTO_malloc(1024*10, "../crypto/bio/bf_lbuf.c", 62);
    if (ctx->obuf == 
# 63 "../crypto/bio/bf_lbuf.c" 3 4
                    ((void *)0)
# 63 "../crypto/bio/bf_lbuf.c"
                        ) {
        CRYPTO_free(ctx, "../crypto/bio/bf_lbuf.c", 64);
        return 0;
    }
    ctx->obuf_size = 1024*10;
    ctx->obuf_len = 0;
...
static int linebuffer_free(BIO *a)
{
    ...
    if (a == 
# 80 "../crypto/bio/bf_lbuf.c" 3 4
            ((void *)0)
# 80 "../crypto/bio/bf_lbuf.c"
                )
        return 0;
    b = (BIO_LINEBUFFER_CTX *)a->ptr;
    CRYPTO_free(b->obuf, "../crypto/bio/bf_lbuf.c", 83);
    CRYPTO_free(a->ptr, "../crypto/bio/bf_lbuf.c", 84);
    a->ptr = 
# 85 "../crypto/bio/bf_lbuf.c" 3 4
            ((void *)0)
# 85 "../crypto/bio/bf_lbuf.c"
                ;
    a->init = 0;
    a->flags = 0;
    return 1;
...
static int linebuffer_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 95 "../crypto/bio/bf_lbuf.c" 3 4
              ((void *)0)
# 95 "../crypto/bio/bf_lbuf.c"
                  )
        return 0;
    if (b->next_bio == 
# 97 "../crypto/bio/bf_lbuf.c" 3 4
                      ((void *)0)
# 97 "../crypto/bio/bf_lbuf.c"
                          )
        return 0;
...
static int linebuffer_write(BIO *b, const char *in, int inl)
{
    ...
    if ((in == 
# 110 "../crypto/bio/bf_lbuf.c" 3 4
              ((void *)0)
# 110 "../crypto/bio/bf_lbuf.c"
                  ) || (inl <= 0))
        return 0;
    ctx = (BIO_LINEBUFFER_CTX *)b->ptr;
    if ((ctx == 
# 113 "../crypto/bio/bf_lbuf.c" 3 4
               ((void *)0)
# 113 "../crypto/bio/bf_lbuf.c"
                   ) || (b->next_bio == 
# 113 "../crypto/bio/bf_lbuf.c" 3 4
                                        ((void *)0)
# 113 "../crypto/bio/bf_lbuf.c"
...
static long linebuffer_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 1:
        ctx->obuf_len = 0;
        if (b->next_bio == 
# 214 "../crypto/bio/bf_lbuf.c" 3 4
                          ((void *)0)
# 214 "../crypto/bio/bf_lbuf.c"
                              )
            return 0;
    ...
    case 13:
        ...
        if (ret == 0) {
            if (b->next_bio == 
# 224 "../crypto/bio/bf_lbuf.c" 3 4
                              ((void *)0)
# 224 "../crypto/bio/bf_lbuf.c"
                                  )
                return 0;
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        }
    ...
    case 117:
        if (num > 0x7fffffff
# 230 "../crypto/bio/bf_lbuf.c"
                        )
            return 0;
        obs = (int)num;
        p = ctx->obuf;
        if ((obs > 1024*10) && (obs != ctx->obuf_size)) {
            p = CRYPTO_malloc((size_t)obs, "../crypto/bio/bf_lbuf.c", 235);
            if (p == 
# 236 "../crypto/bio/bf_lbuf.c" 3 4
                    ((void *)0)
# 236 "../crypto/bio/bf_lbuf.c"
                        )
                return 0;
        }
        if (ctx->obuf != p) {
            ...
            CRYPTO_free(ctx->obuf, "../crypto/bio/bf_lbuf.c", 244);
            ctx->obuf = p;
            ctx->obuf_size = obs;
        }
        break;
    case 101:
        if (b->next_bio == 
# 250 "../crypto/bio/bf_lbuf.c" 3 4
                          ((void *)0)
# 250 "../crypto/bio/bf_lbuf.c"
                              )
            return 0;
        BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
        ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
    ...
    case 11:
        if (b->next_bio == 
# 258 "../crypto/bio/bf_lbuf.c" 3 4
                          ((void *)0)
# 258 "../crypto/bio/bf_lbuf.c"
                              )
            return 0;
        if (ctx->obuf_len <= 0) {
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
    ...
    case 12:
        dbio = (BIO *)ptr;
        if (BIO_int_ctrl(dbio,117,ctx->obuf_size,1) <= 0)
            ret = 0;
        break;
    default:
        if (b->next_bio == 
# 290 "../crypto/bio/bf_lbuf.c" 3 4
                          ((void *)0)
# 290 "../crypto/bio/bf_lbuf.c"
                              )
            return 0;
        ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        break;
...
{
    if (b->next_bio == 
# 300 "../crypto/bio/bf_lbuf.c" 3 4
                      ((void *)0)
# 300 "../crypto/bio/bf_lbuf.c"
                          )
        return 0;
...
{
    if (b->next_bio == 
# 307 "../crypto/bio/bf_lbuf.c" 3 4
                      ((void *)0)
# 307 "../crypto/bio/bf_lbuf.c"
                          )
        return 0;
