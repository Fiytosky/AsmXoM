# 0 "../crypto/bio/bss_log.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_log.c"
# 19 "../crypto/bio/bss_log.c"
...
# 23 "../crypto/bio/bss_log.c" 2
# 47 "../crypto/bio/bss_log.c"
...
# 48 "../crypto/bio/bss_log.c" 2
# 80 "../crypto/bio/bss_log.c"
...
# 94 "../crypto/bio/bss_log.c" 3 4
   ((void *)0)
# 94 "../crypto/bio/bss_log.c"
       ,
    
# 95 "../crypto/bio/bss_log.c" 3 4
   ((void *)0)
# 95 "../crypto/bio/bss_log.c"
       ,
    slg_puts,
    
# 97 "../crypto/bio/bss_log.c" 3 4
   ((void *)0)
# 97 "../crypto/bio/bss_log.c"
       ,
    slg_ctrl,
    slg_new,
    slg_free,
    
# 101 "../crypto/bio/bss_log.c" 3 4
   ((void *)0)
# 101 "../crypto/bio/bss_log.c"
       ,
};
...
static int slg_new(BIO *bi)
{
    ...
    bi->num = 0;
    bi->ptr = 
# 113 "../crypto/bio/bss_log.c" 3 4
             ((void *)0)
# 113 "../crypto/bio/bss_log.c"
                 ;
    xopenlog(bi, "application", 
# 114 "../crypto/bio/bss_log.c" 3 4
                               (3<<3)
# 114 "../crypto/bio/bss_log.c"
                                         );
    return 1;
}
...
{
    if (a == 
# 120 "../crypto/bio/bss_log.c" 3 4
            ((void *)0)
# 120 "../crypto/bio/bss_log.c"
                )
        return 0;
    xcloselog(a);
    return 1;
...
static int slg_write(BIO *b, const char *in, int inl)
{
    ...
    static const struct {
        ...
        {
            6, "PANIC ", 
# 138 "../crypto/bio/bss_log.c" 3 4
                        0
        
# 139 "../crypto/bio/bss_log.c"
       },
        {
            6, "EMERG ", 
# 141 "../crypto/bio/bss_log.c" 3 4
                        0
...
# 142 "../crypto/bio/bss_log.c"
        ...
        {
            4, "EMR ", 
# 144 "../crypto/bio/bss_log.c" 3 4
                      0
        
# 145 "../crypto/bio/bss_log.c"
       },
        {
            6, "ALERT ", 
# 147 "../crypto/bio/bss_log.c" 3 4
                        1
        
# 148 "../crypto/bio/bss_log.c"
       },
        {
            4, "ALR ", 
# 150 "../crypto/bio/bss_log.c" 3 4
                      1
        
# 151 "../crypto/bio/bss_log.c"
       },
        {
            5, "CRIT ", 
# 153 "../crypto/bio/bss_log.c" 3 4
                       2
        
# 154 "../crypto/bio/bss_log.c"
       },
        {
            4, "CRI ", 
# 156 "../crypto/bio/bss_log.c" 3 4
                      2
        
# 157 "../crypto/bio/bss_log.c"
       },
        {
            6, "ERROR ", 
# 159 "../crypto/bio/bss_log.c" 3 4
                        3
        
# 160 "../crypto/bio/bss_log.c"
       },
        {
            4, "ERR ", 
# 162 "../crypto/bio/bss_log.c" 3 4
                      3
        
# 163 "../crypto/bio/bss_log.c"
       },
        {
            8, "WARNING ", 
# 165 "../crypto/bio/bss_log.c" 3 4
                          4
        
# 166 "../crypto/bio/bss_log.c"
       },
        {
            5, "WARN ", 
# 168 "../crypto/bio/bss_log.c" 3 4
                       4
        
# 169 "../crypto/bio/bss_log.c"
       },
        {
            4, "WAR ", 
# 171 "../crypto/bio/bss_log.c" 3 4
                      4
        
# 172 "../crypto/bio/bss_log.c"
       },
        {
            7, "NOTICE ", 
# 174 "../crypto/bio/bss_log.c" 3 4
                         5
        
# 175 "../crypto/bio/bss_log.c"
       },
        {
            5, "NOTE ", 
# 177 "../crypto/bio/bss_log.c" 3 4
                       5
        
# 178 "../crypto/bio/bss_log.c"
       },
        {
            4, "NOT ", 
# 180 "../crypto/bio/bss_log.c" 3 4
                      5
        
# 181 "../crypto/bio/bss_log.c"
       },
        {
            5, "INFO ", 
# 183 "../crypto/bio/bss_log.c" 3 4
                       6
        
# 184 "../crypto/bio/bss_log.c"
       },
        {
            4, "INF ", 
# 186 "../crypto/bio/bss_log.c" 3 4
                      6
        
# 187 "../crypto/bio/bss_log.c"
       },
        {
            6, "DEBUG ", 
# 189 "../crypto/bio/bss_log.c" 3 4
                        7
        
# 190 "../crypto/bio/bss_log.c"
       },
        {
            4, "DBG ", 
# 192 "../crypto/bio/bss_log.c" 3 4
                      7
        
# 193 "../crypto/bio/bss_log.c"
       },
        {
            0, "", 
# 195 "../crypto/bio/bss_log.c" 3 4
                  3
        
# 196 "../crypto/bio/bss_log.c"
       }
    ...
    if (inl < 0)
        return 0;
    if ((buf = CRYPTO_malloc(inl + 1, "../crypto/bio/bss_log.c", 202)) == 
# 202 "../crypto/bio/bss_log.c" 3 4
                                          ((void *)0)
# 202 "../crypto/bio/bss_log.c"
                                              )
        return 0;
    memcpy(buf, in, inl);
    buf[inl] = '\0';
    ...
    CRYPTO_free(buf, "../crypto/bio/bss_log.c", 215);
    return ret;
}
...
static void xopenlog(BIO *bp, char *name, int level)
{
    ...
    openlog(name, 
# 396 "../crypto/bio/bss_log.c" 3 4
                 0x01 
# 396 "../crypto/bio/bss_log.c"
                         | 
# 396 "../crypto/bio/bss_log.c" 3 4
                           0x02
# 396 "../crypto/bio/bss_log.c"
