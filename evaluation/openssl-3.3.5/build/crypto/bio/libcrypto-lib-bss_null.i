# 0 "../crypto/bio/bss_null.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_null.c"
# 10 "../crypto/bio/bss_null.c"
...
# 30 "../crypto/bio/bss_null.c" 3 4
   ((void *)0)
# 30 "../crypto/bio/bss_null.c"
       ,
    
# 31 "../crypto/bio/bss_null.c" 3 4
   ((void *)0)
# 31 "../crypto/bio/bss_null.c"
       ,
    
# 32 "../crypto/bio/bss_null.c" 3 4
   ((void *)0)
# 32 "../crypto/bio/bss_null.c"
       ,
};
...
{
    if (str == 
# 82 "../crypto/bio/bss_null.c" 3 4
              ((void *)0)
# 82 "../crypto/bio/bss_null.c"
                  )
        return 0;
    return strlen(str);
}
