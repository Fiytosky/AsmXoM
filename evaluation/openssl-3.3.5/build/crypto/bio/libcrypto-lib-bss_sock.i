# 0 "../crypto/bio/bss_sock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_sock.c"
# 10 "../crypto/bio/bss_sock.c"
...
# 13 "../crypto/bio/bss_sock.c" 2
# 1 "../include/internal/bio_tfo.h" 1
# 14 "../crypto/bio/bss_sock.c" 2

# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 16 "../crypto/bio/bss_sock.c" 2
# 31 "../crypto/bio/bss_sock.c"
struct bss_sock_st {
    BIO_ADDR tfo_peer;
    int tfo_first;
...
# 55 "../crypto/bio/bss_sock.c" 3 4
   ((void *)0)
# 55 "../crypto/bio/bss_sock.c"
       ,
    sock_ctrl,
    sock_new,
    sock_free,
    
# 59 "../crypto/bio/bss_sock.c" 3 4
   ((void *)0)
# 59 "../crypto/bio/bss_sock.c"
       ,
};
...
BIO *BIO_new_socket(int fd, int close_flag)
{
    ...
    if (ret == 
# 72 "../crypto/bio/bss_sock.c" 3 4
              ((void *)0)
# 72 "../crypto/bio/bss_sock.c"
                  )
        return 
# 73 "../crypto/bio/bss_sock.c" 3 4
              ((void *)0)
# 73 "../crypto/bio/bss_sock.c"
                  ;
    BIO_int_ctrl(ret,104,close_flag,fd);
# 86 "../crypto/bio/bss_sock.c"
    return ret;
}
...
static int sock_new(BIO *bi)
{
    ...
    bi->num = 0;
    bi->flags = 0;
    bi->ptr = CRYPTO_zalloc(sizeof(struct bss_sock_st), "../crypto/bio/bss_sock.c", 94);
    if (bi->ptr == 
# 95 "../crypto/bio/bss_sock.c" 3 4
                  ((void *)0)
# 95 "../crypto/bio/bss_sock.c"
                      )
        return 0;
    return 1;
}
...
{
    if (a == 
# 102 "../crypto/bio/bss_sock.c" 3 4
            ((void *)0)
# 102 "../crypto/bio/bss_sock.c"
                )
        return 0;
    if (a->shutdown) {
        if (a->init) {
    ...
    CRYPTO_free(a->ptr, "../crypto/bio/bss_sock.c", 111);
    a->ptr = 
# 112 "../crypto/bio/bss_sock.c" 3 4
            ((void *)0)
# 112 "../crypto/bio/bss_sock.c"
                ;
    return 1;
}
...
static int sock_read(BIO *b, char *out, int outl)
{
    ...
    if (out != 
# 120 "../crypto/bio/bss_sock.c" 3 4
              ((void *)0)
# 120 "../crypto/bio/bss_sock.c"
                  ) {
        
# 121 "../crypto/bio/bss_sock.c" 3 4
       (*__errno_location ())
# 121 "../crypto/bio/bss_sock.c"
       =0;
...
# 146 "../crypto/bio/bss_sock.c" 3 4
   (*__errno_location ())
# 146 "../crypto/bio/bss_sock.c"
   =0;
# 167 "../crypto/bio/bss_sock.c"
...
static long sock_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 105:
        if (b->init) {
            ip = (int *)ptr;
            if (ip != 
# 202 "../crypto/bio/bss_sock.c" 3 4
                     ((void *)0)
# 202 "../crypto/bio/bss_sock.c"
                         )
                *ip = b->num;
            ret = b->num;
        } else
    ...
    case 92:
        ...
        break;
# 258 "../crypto/bio/bss_sock.c"
    case 2:
        ret = (b->flags & 0x800) != 0;
        break;
    case 123:
        if (ptr != 
# 262 "../crypto/bio/bss_sock.c" 3 4
                  ((void *)0) 
# 262 "../crypto/bio/bss_sock.c"
                       && num == 2) {
    ...
    case 100:
        if (ptr != 
# 271 "../crypto/bio/bss_sock.c" 3 4
                  ((void *)0) 
# 271 "../crypto/bio/bss_sock.c"
                       && num == 2) {
...
int BIO_sock_should_retry(int i)
{
    ...
    if ((i == 0) || (i == -1)) {
        err = 
# 301 "../crypto/bio/bss_sock.c" 3 4
             (*__errno_location ())
# 301 "../crypto/bio/bss_sock.c"
                                    ;
...
{
    switch (err) {
# 323 "../crypto/bio/bss_sock.c"
    case 
# 323 "../crypto/bio/bss_sock.c" 3 4
        11
# 323 "../crypto/bio/bss_sock.c"
                   :
    ...
    case 
# 328 "../crypto/bio/bss_sock.c" 3 4
        107
# 328 "../crypto/bio/bss_sock.c"
                :



    case 
# 332 "../crypto/bio/bss_sock.c" 3 4
        4
# 332 "../crypto/bio/bss_sock.c"
             :
# 342 "../crypto/bio/bss_sock.c"
    case 
# 342 "../crypto/bio/bss_sock.c" 3 4
        71
# 342 "../crypto/bio/bss_sock.c"
              :
    ...
    case 
# 346 "../crypto/bio/bss_sock.c" 3 4
        115
# 346 "../crypto/bio/bss_sock.c"
                   :



    case 
# 350 "../crypto/bio/bss_sock.c" 3 4
        114
# 350 "../crypto/bio/bss_sock.c"
                :
