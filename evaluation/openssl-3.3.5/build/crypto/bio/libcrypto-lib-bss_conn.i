# 0 "../crypto/bio/bss_conn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_conn.c"
# 10 "../crypto/bio/bss_conn.c"
...
{
    if (c->connect_sock_type != 
# 95 "../crypto/bio/bss_conn.c" 3 4
                               SOCK_DGRAM
# 95 "../crypto/bio/bss_conn.c"
                                         )
        return 1;
    ...
    if (c->dgram_bio == 
# 100 "../crypto/bio/bss_conn.c" 3 4
                       ((void *)0)
# 100 "../crypto/bio/bss_conn.c"
                           )
        goto err;
...
static int conn_state(BIO *b, BIO_CONNECT *c)
{
    int ret = -1, i, opts;
    BIO_info_cb *cb = 
# 114 "../crypto/bio/bss_conn.c" 3 4
                     ((void *)0)
# 114 "../crypto/bio/bss_conn.c"
                         ;

    if (c->info_callback != 
# 116 "../crypto/bio/bss_conn.c" 3 4
                           ((void *)0)
# 116 "../crypto/bio/bss_conn.c"
                               )
        cb = c->info_callback;
    ...
    for (;;) {
        ...
        case 1:
            if (c->param_hostname == 
# 122 "../crypto/bio/bss_conn.c" 3 4
                                    ((void *)0) 
# 122 "../crypto/bio/bss_conn.c"
                                         && c->param_service == 
# 122 "../crypto/bio/bss_conn.c" 3 4
                                                                ((void *)0)
# 122 "../crypto/bio/bss_conn.c"
                                                                    ) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",123,__func__), ERR_set_error)(32,
                               144,
...
# 134 "../crypto/bio/bss_conn.c"
                ...
                case 6:
                    if (1) {
                        ...
                        family = 
# 142 "../crypto/bio/bss_conn.c" 3 4
                                10
# 142 "../crypto/bio/bss_conn.c"
                                        ;
                    } else {

                        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",145,__func__), ERR_set_error)((32),(145),
# 145 "../crypto/bio/bss_conn.c" 3 4
                       ((void *)0)
# 145 "../crypto/bio/bss_conn.c"
                       );
                        goto exit_loop;
                    }
                    break;
                case 4:
                    family = 
# 150 "../crypto/bio/bss_conn.c" 3 4
                            2
# 150 "../crypto/bio/bss_conn.c"
                                   ;
                    break;
                case 256:
                    family = 
# 153 "../crypto/bio/bss_conn.c" 3 4
                            0
# 153 "../crypto/bio/bss_conn.c"
                                     ;
                    break;
                default:
                    (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",156,__func__), ERR_set_error)((32),(146),
# 156 "../crypto/bio/bss_conn.c" 3 4
                   ((void *)0)
# 156 "../crypto/bio/bss_conn.c"
                   );
                    goto exit_loop;
                }
            ...
            if (c->addr_first == 
# 165 "../crypto/bio/bss_conn.c" 3 4
                                ((void *)0)
# 165 "../crypto/bio/bss_conn.c"
                                    ) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",166,__func__), ERR_set_error)((32),(142),
# 166 "../crypto/bio/bss_conn.c" 3 4
               ((void *)0)
# 166 "../crypto/bio/bss_conn.c"
               );
                goto exit_loop;
            }
        ...
        case 3:
            ...
            if (ret == (int)(-1)) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",178,__func__), ERR_set_error)(2, 
# 178 "../crypto/bio/bss_conn.c" 3 4
                                           (*__errno_location ())
# 178 "../crypto/bio/bss_conn.c"
                                                                  ,
                               "calling socket(%s, %s)",
                               c->param_hostname, c->param_service);
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",181,__func__), ERR_set_error)((32),(118),
# 181 "../crypto/bio/bss_conn.c" 3 4
               ((void *)0)
# 181 "../crypto/bio/bss_conn.c"
               );
                goto exit_loop;
            }
            b->num = ret;
        ...
        case 4:
            ...
            opts = c->connect_mode;
            if (BIO_ADDRINFO_socktype(c->addr_iter) == 
# 193 "../crypto/bio/bss_conn.c" 3 4
                                                      SOCK_STREAM
# 193 "../crypto/bio/bss_conn.c"
                                                                 )
                opts |= 0x04;
            ...
            if (ret == 0) {
                if (BIO_sock_should_retry(ret)) {
                    ...
                    ERR_pop_to_mark();
                           ...
                           != 
# 205 "../crypto/bio/bss_conn.c" 3 4
                             ((void *)0)
# 205 "../crypto/bio/bss_conn.c"
                                 ) {
                    ...
                    ERR_clear_last_mark();
                    (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",215,__func__), ERR_set_error)(2, 
# 215 "../crypto/bio/bss_conn.c" 3 4
                                               (*__errno_location ())
# 215 "../crypto/bio/bss_conn.c"
                                                                      ,
                                   "calling connect(%s, %s)",
                                    c->param_hostname, c->param_service);
                    c->state = 7;
        ...
        case 6:
            ...
            if (BIO_socket_wait(b->num, 0, time(
# 232 "../crypto/bio/bss_conn.c" 3 4
                                               ((void *)0)
# 232 "../crypto/bio/bss_conn.c"
                                                   )) == 0)
                break;
...
# 237 "../crypto/bio/bss_conn.c" 3 4
                                                                       ((void *)0)
# 237 "../crypto/bio/bss_conn.c"
                                                                           ) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",245,__func__), ERR_set_error)(2, i,
                               "calling connect(%s, %s)",
                                c->param_hostname, c->param_service);
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",248,__func__), ERR_set_error)((32),(110),
# 248 "../crypto/bio/bss_conn.c" 3 4
               ((void *)0)
# 248 "../crypto/bio/bss_conn.c"
               );
                ret = 0;
                goto exit_loop;
            } else {
                if (!conn_create_dgram_bio(b, c))
                    break;
                c->state = 5;
# 264 "../crypto/bio/bss_conn.c"
            }
            break;

        case 7:
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",268,__func__), ERR_set_error)((32),(103),
# 268 "../crypto/bio/bss_conn.c" 3 4
           ((void *)0)
# 268 "../crypto/bio/bss_conn.c"
           );
            ret = 0;
            goto exit_loop;
        ...
        if (cb != 
# 280 "../crypto/bio/bss_conn.c" 3 4
                 ((void *)0)
# 280 "../crypto/bio/bss_conn.c"
                     ) {
 ...
 exit_loop:
    if (cb != 
# 288 "../crypto/bio/bss_conn.c" 3 4
             ((void *)0)
# 288 "../crypto/bio/bss_conn.c"
                 )
...
static BIO_CONNECT *BIO_CONNECT_new(void)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bio/bss_conn.c", 298)) == 
# 298 "../crypto/bio/bss_conn.c" 3 4
                                               ((void *)0)
# 298 "../crypto/bio/bss_conn.c"
                                                   )
        return 
# 299 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 299 "../crypto/bio/bss_conn.c"
                  ;
    ret->state = 1;
    ret->connect_family = 256;
    ret->connect_sock_type = 
# 302 "../crypto/bio/bss_conn.c" 3 4
                            SOCK_STREAM
# 302 "../crypto/bio/bss_conn.c"
                                       ;
    return ret;
}
...
{
    if (a == 
# 308 "../crypto/bio/bss_conn.c" 3 4
            ((void *)0)
# 308 "../crypto/bio/bss_conn.c"
                )
        return;
    CRYPTO_free(a->param_hostname, "../crypto/bio/bss_conn.c", 310);
    CRYPTO_free(a->param_service, "../crypto/bio/bss_conn.c", 311);
    BIO_ADDRINFO_free(a->addr_first);
    CRYPTO_free(a, "../crypto/bio/bss_conn.c", 313);
}
...
# 326 "../crypto/bio/bss_conn.c" 3 4
                                                ((void *)0)
# 326 "../crypto/bio/bss_conn.c"
                                                    )
        return 0;
    else
        return 1;
...
static int conn_free(BIO *a)
{
    ...
    if (a == 
# 350 "../crypto/bio/bss_conn.c" 3 4
            ((void *)0)
# 350 "../crypto/bio/bss_conn.c"
                )
        return 0;
    ...
    if (a->shutdown) {
        ...
        a->ptr = 
# 359 "../crypto/bio/bss_conn.c" 3 4
                ((void *)0)
# 359 "../crypto/bio/bss_conn.c"
                    ;
        a->flags = 0;
        a->init = 0;
    }
...
static int conn_read(BIO *b, char *out, int outl)
{
    ...
    if (data->dgram_bio != 
# 378 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 378 "../crypto/bio/bss_conn.c"
                              ) {
        BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
        ret = BIO_read(data->dgram_bio, out, outl);
        BIO_set_flags(b, BIO_test_flags(data->dgram_bio, ((0x01|0x02|0x04)|0x08)));
        return ret;
    }

    if (out != 
# 385 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 385 "../crypto/bio/bss_conn.c"
                  ) {
        
# 386 "../crypto/bio/bss_conn.c" 3 4
       (*__errno_location ())
# 386 "../crypto/bio/bss_conn.c"
       =0;
...
static int conn_write(BIO *b, const char *in, int inl)
{
    ...
    if (data->dgram_bio != 
# 416 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 416 "../crypto/bio/bss_conn.c"
                              ) {
        BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
...
# 423 "../crypto/bio/bss_conn.c" 3 4
   (*__errno_location ())
# 423 "../crypto/bio/bss_conn.c"
   =0;
# 442 "../crypto/bio/bss_conn.c"
...
static long conn_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    int *ip;
    const char **pptr = 
# 455 "../crypto/bio/bss_conn.c" 3 4
                       ((void *)0)
# 455 "../crypto/bio/bss_conn.c"
                           ;
    long ret = 1;
    BIO_CONNECT *data;
    ...
    case 1:
        ...
        data->addr_first = 
# 471 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 471 "../crypto/bio/bss_conn.c"
                              ;
        b->flags = 0;
        break;
    case 101:
    ...
    case 123:
        if (ptr != 
# 482 "../crypto/bio/bss_conn.c" 3 4
                  ((void *)0)
# 482 "../crypto/bio/bss_conn.c"
                      ) {
            pptr = (const char **)ptr;
            if (num == 0) {
                ...
                *pptr = (const char *)BIO_ADDRINFO_address(data->addr_iter);
                ...
                case 
# 493 "../crypto/bio/bss_conn.c" 3 4
                    10
# 493 "../crypto/bio/bss_conn.c"
                            :
                    ret = 6;
                    break;

                case 
# 497 "../crypto/bio/bss_conn.c" 3 4
                    2
# 497 "../crypto/bio/bss_conn.c"
                           :
                    ret = 4;
                    break;
                case 0:
    ...
    case 100:
        if (ptr != 
# 517 "../crypto/bio/bss_conn.c" 3 4
                  ((void *)0)
# 517 "../crypto/bio/bss_conn.c"
                      ) {
            b->init = 1;
            if (num == 0) {
                ...
                CRYPTO_free(data->param_hostname, "../crypto/bio/bss_conn.c", 526);
                data->param_hostname = 
# 527 "../crypto/bio/bss_conn.c" 3 4
                                      ((void *)0)
# 527 "../crypto/bio/bss_conn.c"
                                          ;
                ...
                if (hold_service != data->param_service)
                    CRYPTO_free(hold_service, "../crypto/bio/bss_conn.c", 533);
            } else if (num == 1) {
                CRYPTO_free(data->param_service, "../crypto/bio/bss_conn.c", 535);
                if ((data->param_service = CRYPTO_strdup(ptr, "../crypto/bio/bss_conn.c", 536)) == 
# 536 "../crypto/bio/bss_conn.c" 3 4
                                                                  ((void *)0)
# 536 "../crypto/bio/bss_conn.c"
                                                                      )
                    ret = 0;
            } else if (num == 2) {
                ...
                ret = host != 
# 543 "../crypto/bio/bss_conn.c" 3 4
                             ((void *)0) 
# 543 "../crypto/bio/bss_conn.c"
                                  && service != 
# 543 "../crypto/bio/bss_conn.c" 3 4
                                                ((void *)0)
# 543 "../crypto/bio/bss_conn.c"
                                                    ;
                if (ret) {
                    CRYPTO_free(data->param_hostname, "../crypto/bio/bss_conn.c", 545);
                    data->param_hostname = host;
                    CRYPTO_free(data->param_service, "../crypto/bio/bss_conn.c", 547);
                    data->param_service = service;
                    BIO_ADDRINFO_free(data->addr_first);
                    data->addr_first = 
# 550 "../crypto/bio/bss_conn.c" 3 4
                                      ((void *)0)
# 550 "../crypto/bio/bss_conn.c"
                                          ;
                    data->addr_iter = 
# 551 "../crypto/bio/bss_conn.c" 3 4
                                     ((void *)0)
# 551 "../crypto/bio/bss_conn.c"
                                         ;
                } else {
                    CRYPTO_free(host, "../crypto/bio/bss_conn.c", 553);
                    CRYPTO_free(service, "../crypto/bio/bss_conn.c", 554);
                }
            } else if (num == 3) {
    ...
    case 157:
        if ((num != 
# 564 "../crypto/bio/bss_conn.c" 3 4
                   SOCK_STREAM 
# 564 "../crypto/bio/bss_conn.c"
                               && num != 
# 564 "../crypto/bio/bss_conn.c" 3 4
                                         SOCK_DGRAM
# 564 "../crypto/bio/bss_conn.c"
    ...
    case 159:
        if (data->dgram_bio != 
# 577 "../crypto/bio/bss_conn.c" 3 4
                              ((void *)0)
# 577 "../crypto/bio/bss_conn.c"
                                  ) {
    ...
    case 93:
        ...
        if (data->state >= 3
            && data->addr_iter != 
# 590 "../crypto/bio/bss_conn.c" 3 4
                                 ((void *)0)
            
# 591 "../crypto/bio/bss_conn.c"
           && (dg_addr = BIO_ADDRINFO_address(data->addr_iter)) != 
# 591 "../crypto/bio/bss_conn.c" 3 4
                                                                   ((void *)0)
# 591 "../crypto/bio/bss_conn.c"
                                                                       ) {
    ...
    case 102:
        if (num != 0)
            data->connect_mode |= 0x08;
        else
            data->connect_mode &= ~0x08;

        if (data->dgram_bio != 
# 626 "../crypto/bio/bss_conn.c" 3 4
                              ((void *)0)
# 626 "../crypto/bio/bss_conn.c"
                                  )
            ret = BIO_ctrl(data->dgram_bio,102,(num),
# 627 "../crypto/bio/bss_conn.c" 3 4
                 ((void *)0)
# 627 "../crypto/bio/bss_conn.c"
                 );

        break;
# 641 "../crypto/bio/bss_conn.c"
    case 155:
    ...
    case 105:
        if (b->init) {
            ip = (int *)ptr;
            if (ip != 
# 651 "../crypto/bio/bss_conn.c" 3 4
                     ((void *)0)
# 651 "../crypto/bio/bss_conn.c"
                         )
                *ip = b->num;
            ret = b->num;
        } else
    ...
    case 12:
        {
            ...
            if (data->param_service)
                BIO_ctrl(dbio,100,1, (char *)(data->param_service));
            BIO_int_ctrl(dbio,100,3,data->connect_family);
            BIO_ctrl(dbio,155,(data->connect_mode),
# 677 "../crypto/bio/bss_conn.c" 3 4
           ((void *)0)
# 677 "../crypto/bio/bss_conn.c"
           );




            (void)(int)BIO_callback_ctrl(dbio,14,data->info_callback);
        }
        break;
    case 14:
        ret = 0;
...
int conn_gets(BIO *bio, char *buf, int size)
{
    ...
    if (buf == 
# 767 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 767 "../crypto/bio/bss_conn.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",768,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 768 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 768 "../crypto/bio/bss_conn.c"
       );
        return -1;
    }
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",772,__func__), ERR_set_error)((32),(125),
# 772 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 772 "../crypto/bio/bss_conn.c"
       );
        return -1;
    }
    *buf = '\0';
    ...
    if (bio == 
# 777 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0) 
# 777 "../crypto/bio/bss_conn.c"
                   || bio->ptr == 
# 777 "../crypto/bio/bss_conn.c" 3 4
                                  ((void *)0)
# 777 "../crypto/bio/bss_conn.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",778,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 778 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 778 "../crypto/bio/bss_conn.c"
       );
        return -1;
    }
    ...
    if (data->dgram_bio != 
# 788 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 788 "../crypto/bio/bss_conn.c"
                              ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",789,__func__), ERR_set_error)((32),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 789 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 789 "../crypto/bio/bss_conn.c"
       );
        return -1;
    }

    
# 793 "../crypto/bio/bss_conn.c" 3 4
   (*__errno_location ())
# 793 "../crypto/bio/bss_conn.c"
   =0;
    while (size-- > 1) {
    ...
    *ptr = '\0';
    return ret > 0 || (bio->flags & 0x800) != 0 ? ptr - buf : ret;
}
                         ...
                         uint64_t flags, size_t *msgs_processed)
{
    ...
    if (bio == 
# 822 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 822 "../crypto/bio/bss_conn.c"
                  ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",824,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 824 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 824 "../crypto/bio/bss_conn.c"
       );
        return 0;
    }
    ...
    if (data->dgram_bio == 
# 837 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 837 "../crypto/bio/bss_conn.c"
                              ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",839,__func__), ERR_set_error)((32),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 839 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 839 "../crypto/bio/bss_conn.c"
       );
        return 0;
    }
                         ...
                         uint64_t flags, size_t *msgs_processed)
{
    ...
    if (bio == 
# 853 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 853 "../crypto/bio/bss_conn.c"
                  ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",855,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 855 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 855 "../crypto/bio/bss_conn.c"
       );
        return 0;
    }
    ...
    if (data->dgram_bio == 
# 868 "../crypto/bio/bss_conn.c" 3 4
                          ((void *)0)
# 868 "../crypto/bio/bss_conn.c"
                              ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_conn.c",870,__func__), ERR_set_error)((32),((257|((0x1 << 18L)|(0x2 << 18L)))),
# 870 "../crypto/bio/bss_conn.c" 3 4
       ((void *)0)
# 870 "../crypto/bio/bss_conn.c"
       );
        return 0;
    }
...
BIO *BIO_new_connect(const char *str)
{
    ...
    if (ret == 
# 883 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 883 "../crypto/bio/bss_conn.c"
                  )
        return 
# 884 "../crypto/bio/bss_conn.c" 3 4
              ((void *)0)
# 884 "../crypto/bio/bss_conn.c"
                  ;
    if (BIO_ctrl(ret,100,0, (char *)(str)))
        return ret;
    BIO_free(ret);
    return 
# 888 "../crypto/bio/bss_conn.c" 3 4
          ((void *)0)
# 888 "../crypto/bio/bss_conn.c"
              ;
}
