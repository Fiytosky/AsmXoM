# 0 "../crypto/bio/bf_prefix.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_prefix.c"
# 10 "../crypto/bio/bf_prefix.c"
...
# 29 "../crypto/bio/bf_prefix.c" 3 4
   ((void *)0)
# 29 "../crypto/bio/bf_prefix.c"
       ,
    prefix_read,
    
# 31 "../crypto/bio/bf_prefix.c" 3 4
   ((void *)0)
# 31 "../crypto/bio/bf_prefix.c"
       ,
    prefix_puts,
    prefix_gets,
    prefix_ctrl,
...
static int prefix_create(BIO *b)
{
    PREFIX_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/bio/bf_prefix.c", 54);

    if (ctx == 
# 56 "../crypto/bio/bf_prefix.c" 3 4
              ((void *)0)
# 56 "../crypto/bio/bf_prefix.c"
                  )
        return 0;

    ctx->prefix = 
# 59 "../crypto/bio/bf_prefix.c" 3 4
                 ((void *)0)
# 59 "../crypto/bio/bf_prefix.c"
                     ;
    ctx->indent = 0;
    ctx->linestart = 1;
    BIO_set_data(b, ctx);
...
static int prefix_destroy(BIO *b)
{
    ...
    CRYPTO_free(ctx->prefix, "../crypto/bio/bf_prefix.c", 71);
    CRYPTO_free(ctx, "../crypto/bio/bf_prefix.c", 72);
    return 1;
}
                        ...
                        size_t *numwritten)
{
    ...
    if (ctx == 
# 86 "../crypto/bio/bf_prefix.c" 3 4
              ((void *)0)
# 86 "../crypto/bio/bf_prefix.c"
                  )
        return 0;
    ...
    if ((ctx->prefix == 
# 93 "../crypto/bio/bf_prefix.c" 3 4
                       ((void *)0) 
# 93 "../crypto/bio/bf_prefix.c"
                            || *ctx->prefix == '\0')
        && ctx->indent == 0) {
    ...
    *numwritten = 0;
    ...
    while (outl > 0) {
        ...
        if (ctx->linestart) {
            ...
            if (ctx->prefix != 
# 117 "../crypto/bio/bf_prefix.c" 3 4
                              ((void *)0)
                
# 118 "../crypto/bio/bf_prefix.c"
...
static long prefix_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    if (b == 
# 156 "../crypto/bio/bf_prefix.c" 3 4
            ((void *)0) 
# 156 "../crypto/bio/bf_prefix.c"
                 || (ctx = BIO_get_data(b)) == 
# 156 "../crypto/bio/bf_prefix.c" 3 4
                                               ((void *)0)
# 156 "../crypto/bio/bf_prefix.c"
    ...
    switch (cmd) {
    case 79:
        CRYPTO_free(ctx->prefix, "../crypto/bio/bf_prefix.c", 161);
        if (ptr == 
# 162 "../crypto/bio/bf_prefix.c" 3 4
                  ((void *)0)
# 162 "../crypto/bio/bf_prefix.c"
                      ) {
            ctx->prefix = 
# 163 "../crypto/bio/bf_prefix.c" 3 4
                         ((void *)0)
# 163 "../crypto/bio/bf_prefix.c"
                             ;
            ret = 1;
        } else {
            ctx->prefix = CRYPTO_strdup((const char *)ptr, "../crypto/bio/bf_prefix.c", 166);
            ret = ctx->prefix != 
# 167 "../crypto/bio/bf_prefix.c" 3 4
                                ((void *)0)
# 167 "../crypto/bio/bf_prefix.c"
                                    ;
        }
        break;
    case 80:
    ...
    default:
        ...
        if (BIO_next(b) != 
# 187 "../crypto/bio/bf_prefix.c" 3 4
                          ((void *)0)
# 187 "../crypto/bio/bf_prefix.c"
                              )
