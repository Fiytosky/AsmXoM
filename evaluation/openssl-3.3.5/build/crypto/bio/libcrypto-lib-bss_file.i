# 0 "../crypto/bio/bss_file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_file.c"
# 28 "../crypto/bio/bss_file.c"
...
# 54 "../crypto/bio/bss_file.c" 3 4
   ((void *)0)
# 54 "../crypto/bio/bss_file.c"
       ,
};
...
BIO *BIO_new_file(const char *filename, const char *mode)
{
    ...
    if (strchr(mode, 'b') == 
# 63 "../crypto/bio/bss_file.c" 3 4
                            ((void *)0)
# 63 "../crypto/bio/bss_file.c"
                                )
        fp_flags |= 0x10;

    if (file == 
# 66 "../crypto/bio/bss_file.c" 3 4
               ((void *)0)
# 66 "../crypto/bio/bss_file.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",67,__func__), ERR_set_error)(2, 
# 67 "../crypto/bio/bss_file.c" 3 4
                                   (*__errno_location ())
# 67 "../crypto/bio/bss_file.c"
                                                       ,
                       "calling fopen(%s, %s)",
                       filename, mode);
        if (
# 70 "../crypto/bio/bss_file.c" 3 4
           (*__errno_location ()) 
# 70 "../crypto/bio/bss_file.c"
                 == 
# 70 "../crypto/bio/bss_file.c" 3 4
                    2

            
# 72 "../crypto/bio/bss_file.c"
           || 
# 72 "../crypto/bio/bss_file.c" 3 4
              (*__errno_location ()) 
# 72 "../crypto/bio/bss_file.c"
                    == 
# 72 "../crypto/bio/bss_file.c" 3 4
...
# 74 "../crypto/bio/bss_file.c"
           )
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",75,__func__), ERR_set_error)((32),(128),
# 75 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 75 "../crypto/bio/bss_file.c"
           );
        else
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",77,__func__), ERR_set_error)((32),((2 | (0x2 << 18L))),
# 77 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 77 "../crypto/bio/bss_file.c"
           );
        return 
# 78 "../crypto/bio/bss_file.c" 3 4
              ((void *)0)
# 78 "../crypto/bio/bss_file.c"
                  ;
    }
    if ((ret = BIO_new(BIO_s_file())) == 
# 80 "../crypto/bio/bss_file.c" 3 4
                                        ((void *)0)
# 80 "../crypto/bio/bss_file.c"
                                            ) {
        fclose(file);
        return 
# 82 "../crypto/bio/bss_file.c" 3 4
              ((void *)0)
# 82 "../crypto/bio/bss_file.c"
                  ;
    }


    BIO_clear_flags(ret, 0);
    BIO_ctrl(ret,106,fp_flags,(char *)(file));
    return ret;
}
...
BIO *BIO_new_fp(FILE *stream, int close_flag)
{
    ...
    if ((ret = BIO_new(BIO_s_file())) == 
# 95 "../crypto/bio/bss_file.c" 3 4
                                        ((void *)0)
# 95 "../crypto/bio/bss_file.c"
                                            )
        return 
# 96 "../crypto/bio/bss_file.c" 3 4
              ((void *)0)
# 96 "../crypto/bio/bss_file.c"
                  ;
...
static int file_new(BIO *bi)
{
    ...
    bi->num = 0;
    bi->ptr = 
# 113 "../crypto/bio/bss_file.c" 3 4
             ((void *)0)
# 113 "../crypto/bio/bss_file.c"
                 ;
    bi->flags = 0;
    return 1;
}
...
{
    if (a == 
# 120 "../crypto/bio/bss_file.c" 3 4
            ((void *)0)
# 120 "../crypto/bio/bss_file.c"
                )
        return 0;
    if (a->shutdown) {
        if ((a->init) && (a->ptr != 
# 123 "../crypto/bio/bss_file.c" 3 4
                                   ((void *)0)
# 123 "../crypto/bio/bss_file.c"
                                       )) {
            if (a->flags & 0)
                fclose(a->ptr);
            else
                fclose(a->ptr);
            a->ptr = 
# 128 "../crypto/bio/bss_file.c" 3 4
                    ((void *)0)
# 128 "../crypto/bio/bss_file.c"
                        ;
            a->flags = 0;
        }
        a->init = 0;
...
static int file_read(BIO *b, char *out, int outl)
{
    ...
    if (b->init && (out != 
# 140 "../crypto/bio/bss_file.c" 3 4
                          ((void *)0)
# 140 "../crypto/bio/bss_file.c"
                              )) {
        if (b->flags & 0)
        ...
        if (ret == 0
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",148,__func__), ERR_set_error)(2, 
# 148 "../crypto/bio/bss_file.c" 3 4
                                       (*__errno_location ())
# 148 "../crypto/bio/bss_file.c"
                                                           ,
                           "calling fread()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",150,__func__), ERR_set_error)((32),((2 | (0x2 << 18L))),
# 150 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 150 "../crypto/bio/bss_file.c"
           );
            ret = -1;
        }
    }
...
static int file_write(BIO *b, const char *in, int inl)
{
    ...
    if (b->init && (in != 
# 161 "../crypto/bio/bss_file.c" 3 4
                         ((void *)0)
# 161 "../crypto/bio/bss_file.c"
                             )) {
        if (b->flags & 0)
...
static long file_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 106:
        ...
        b->ptr = ptr;
        b->init = 1;
# 231 "../crypto/bio/bss_file.c"
        {
# 265 "../crypto/bio/bss_file.c"
        }
        break;
    case 108:
        file_free(b);
        ...
        if (num & 0x08) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",282,__func__), ERR_set_error)((32),(101),
# 282 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 282 "../crypto/bio/bss_file.c"
           );
            ret = 0;
            break;
        }
# 295 "../crypto/bio/bss_file.c"
        fp = openssl_fopen(ptr, p);
        if (fp == 
# 296 "../crypto/bio/bss_file.c" 3 4
                 ((void *)0)
# 296 "../crypto/bio/bss_file.c"
                     ) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",297,__func__), ERR_set_error)(2, 
# 297 "../crypto/bio/bss_file.c" 3 4
                                       (*__errno_location ())
# 297 "../crypto/bio/bss_file.c"
                                                           ,
                           "calling fopen(%s, %s)",
                           (const char *)ptr, p);
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",300,__func__), ERR_set_error)((32),((2 | (0x2 << 18L))),
# 300 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 300 "../crypto/bio/bss_file.c"
           );
            ret = 0;
            break;
        }
    ...
    case 107:
        ...
        if (ptr != 
# 311 "../crypto/bio/bss_file.c" 3 4
                  ((void *)0)
# 311 "../crypto/bio/bss_file.c"
                      ) {
            fpp = (FILE **)ptr;
            *fpp = (FILE *)b->ptr;
        }
    ...
    case 11:
        st = b->flags & 0
                ? fflush(b->ptr) : fflush((FILE *)b->ptr);
        if (st == 
# 325 "../crypto/bio/bss_file.c" 3 4
                 (-1)
# 325 "../crypto/bio/bss_file.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",326,__func__), ERR_set_error)(2, 
# 326 "../crypto/bio/bss_file.c" 3 4
                                       (*__errno_location ())
# 326 "../crypto/bio/bss_file.c"
                                                           ,
                           "calling fflush()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_file.c",328,__func__), ERR_set_error)((32),((2 | (0x2 << 18L))),
# 328 "../crypto/bio/bss_file.c" 3 4
           ((void *)0)
# 328 "../crypto/bio/bss_file.c"
           );
            ret = 0;
        }
        break;
