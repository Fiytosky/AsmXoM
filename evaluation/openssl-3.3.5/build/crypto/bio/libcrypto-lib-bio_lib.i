# 0 "../crypto/bio/bio_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_lib.c"
# 12 "../crypto/bio/bio_lib.c"
...
# 74 "../crypto/bio/bio_local.h" 2

typedef struct bio_f_buffer_ctx_struct {
# 88 "../crypto/bio/bio_local.h"
    int ibuf_size;
    int obuf_size;
    char *ibuf;
    int ibuf_len;
...
# 142 "../crypto/bio/bio_local.h"
extern CRYPTO_REF_COUNT bio_type_count;

void bio_sock_cleanup_int(void);
# 17 "../crypto/bio/bio_lib.c" 2
# 37 "../crypto/bio/bio_lib.c"
                              ...
                              size_t *processed)
{
    ...
    if (b->callback_ex != 
# 45 "../crypto/bio/bio_lib.c" 3 4
                         ((void *)0)
# 45 "../crypto/bio/bio_lib.c"
                             )
    ...
    if (((bareoper) == 0x02 || (bareoper) == 0x03 || (bareoper) == 0x05)) {

        if (len > 0x7fffffff
# 59 "../crypto/bio/bio_lib.c"
                        )
            return -1;
    ...
    if (inret > 0 && (oper & 0x80) && bareoper != 0x06) {
        if (*processed > 0x7fffffff
# 66 "../crypto/bio/bio_lib.c"
                               )
            return -1;
        inret = *processed;
    }
    ...
    if (ret > 0 && (oper & 0x80) && bareoper != 0x06) {
...
BIO *BIO_new_ex(OSSL_LIB_CTX *libctx, const BIO_METHOD *method)
{
    BIO *bio = CRYPTO_zalloc(sizeof(*bio), "../crypto/bio/bio_lib.c", 83);

    if (bio == 
# 85 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 85 "../crypto/bio/bio_lib.c"
                  )
        return 
# 86 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 86 "../crypto/bio/bio_lib.c"
                  ;
    ...
    if (!CRYPTO_new_ex_data(12, bio, &bio->ex_data))
        goto err;

    if (method->create != 
# 98 "../crypto/bio/bio_lib.c" 3 4
                         ((void *)0) 
# 98 "../crypto/bio/bio_lib.c"
                              && !method->create(bio)) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",99,__func__), ERR_set_error)((32),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 99 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 99 "../crypto/bio/bio_lib.c"
       );
        CRYPTO_free_ex_data(12, bio, &bio->ex_data);
        goto err;
    }
    if (method->create == 
# 103 "../crypto/bio/bio_lib.c" 3 4
                         ((void *)0)
# 103 "../crypto/bio/bio_lib.c"
                             )
        bio->init = 1;
...
err:
    ...
    CRYPTO_free(bio, "../crypto/bio/bio_lib.c", 110);
    return 
# 111 "../crypto/bio/bio_lib.c" 3 4
          ((void *)0)
# 111 "../crypto/bio/bio_lib.c"
              ;
}
...
{
    return BIO_new_ex(
# 116 "../crypto/bio/bio_lib.c" 3 4
                     ((void *)0)
# 116 "../crypto/bio/bio_lib.c"
                         , method);
}
...
int BIO_free(BIO *a)
{
    ...
    if (a == 
# 123 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 123 "../crypto/bio/bio_lib.c"
                )
        return 0;
    ...
    if (((a)->callback != 
# 134 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 134 "../crypto/bio/bio_lib.c"
       || (a)->callback_ex != 
# 134 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 134 "../crypto/bio/bio_lib.c"
       )) {
        ret = (int)bio_call_callback(a, 0x01, 
# 135 "../crypto/bio/bio_lib.c" 3 4
                                                    ((void *)0)
...
# 135 "../crypto/bio/bio_lib.c"
    ...
    if ((a->method != 
# 140 "../crypto/bio/bio_lib.c" 3 4
                     ((void *)0)
# 140 "../crypto/bio/bio_lib.c"
                         ) && (a->method->destroy != 
# 140 "../crypto/bio/bio_lib.c" 3 4
                                                     ((void *)0)
# 140 "../crypto/bio/bio_lib.c"
    ...
    CRYPTO_free_ex_data(12, a, &a->ex_data);

    CRYPTO_FREE_REF(&a->references);

    CRYPTO_free(a, "../crypto/bio/bio_lib.c", 147);
...
static int bio_read_intern(BIO *b, void *data, size_t dlen, size_t *readbytes)
{
    ...
    if (b == 
# 266 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 266 "../crypto/bio/bio_lib.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",267,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 267 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 267 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    if (b->method == 
# 270 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 270 "../crypto/bio/bio_lib.c"
                         || b->method->bread == 
# 270 "../crypto/bio/bio_lib.c" 3 4
                                                ((void *)0)
# 270 "../crypto/bio/bio_lib.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",271,__func__), ERR_set_error)((32),(121),
# 271 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 271 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (((b)->callback != 
# 275 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 275 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 275 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 275 "../crypto/bio/bio_lib.c"
...
# 277 "../crypto/bio/bio_lib.c" 3 4
                                      ((void *)0)
# 277 "../crypto/bio/bio_lib.c"
                                          )) <= 0))
        return ret;

    if (!b->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",281,__func__), ERR_set_error)((32),(120),
# 281 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 281 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    if (((b)->callback != 
# 290 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 290 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 290 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 290 "../crypto/bio/bio_lib.c"
       ))
        ret = (int)bio_call_callback(b, 0x02 | 0x80, data,
                                     dlen, 0, 0L, ret, readbytes);


    if (ret > 0 && *readbytes > dlen) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",296,__func__), ERR_set_error)((32),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 296 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 296 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
                            ...
                            size_t *written)
{
    ...
    if (written != 
# 332 "../crypto/bio/bio_lib.c" 3 4
                  ((void *)0)
# 332 "../crypto/bio/bio_lib.c"
                      )
        *written = 0;
    ...
    if (b == 
# 338 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 338 "../crypto/bio/bio_lib.c"
                )
        return 0;

    if (b->method == 
# 341 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 341 "../crypto/bio/bio_lib.c"
                         || b->method->bwrite == 
# 341 "../crypto/bio/bio_lib.c" 3 4
                                                 ((void *)0)
# 341 "../crypto/bio/bio_lib.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",342,__func__), ERR_set_error)((32),(121),
# 342 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 342 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (((b)->callback != 
# 346 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 346 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 346 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 346 "../crypto/bio/bio_lib.c"
...
# 348 "../crypto/bio/bio_lib.c" 3 4
                                      ((void *)0)
# 348 "../crypto/bio/bio_lib.c"
                                          )) <= 0))
        return ret;

    if (!b->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",352,__func__), ERR_set_error)((32),(120),
# 352 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 352 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    if (((b)->callback != 
# 361 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 361 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 361 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 361 "../crypto/bio/bio_lib.c"
       ))
        ret = (int)bio_call_callback(b, 0x03 | 0x80, data,
                                     dlen, 0, 0L, ret, &local_written);

    if (written != 
# 365 "../crypto/bio/bio_lib.c" 3 4
                  ((void *)0)
# 365 "../crypto/bio/bio_lib.c"
                      )
...
int BIO_write_ex(BIO *b, const void *data, size_t dlen, size_t *written)
{
    return bio_write_intern(b, data, dlen, written) > 0
        || (b != 
# 391 "../crypto/bio/bio_lib.c" 3 4
                ((void *)0) 
# 391 "../crypto/bio/bio_lib.c"
                     && dlen == 0);
}
                 ...
                 size_t *msgs_processed)
{
    ...
    if (b == 
# 401 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 401 "../crypto/bio/bio_lib.c"
                ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",403,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 403 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 403 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }

    if (b->method == 
# 407 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 407 "../crypto/bio/bio_lib.c"
                         || b->method->bsendmmsg == 
# 407 "../crypto/bio/bio_lib.c" 3 4
                                                    ((void *)0)
# 407 "../crypto/bio/bio_lib.c"
        ...
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",409,__func__), ERR_set_error)((32),(121),
# 409 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 409 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }

    if (((b)->callback != 
# 413 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 413 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 413 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 413 "../crypto/bio/bio_lib.c"
        ...
        ret = (size_t)bio_call_callback(b, 0x08, (void *)&args,
                                        0, 0, 0, 1, 
# 421 "../crypto/bio/bio_lib.c" 3 4
                                                   ((void *)0)
# 421 "../crypto/bio/bio_lib.c"
                                                       );
        if (ret <= 0)
            return 0;
    }
    ...
    if (!b->init) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",428,__func__), ERR_set_error)((32),(120),
# 428 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 428 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }
    ...
    if (((b)->callback != 
# 434 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 434 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 434 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 434 "../crypto/bio/bio_lib.c"
       ))
        ret = (size_t)bio_call_callback(b, 0x08 | 0x80,
                                        (void *)&args, ret, 0, 0, ret, 
# 436 "../crypto/bio/bio_lib.c" 3 4
                                                                      ((void *)0)
# 436 "../crypto/bio/bio_lib.c"
                                                                          );
                 ...
                 size_t *msgs_processed)
{
    ...
    if (b == 
# 448 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 448 "../crypto/bio/bio_lib.c"
                ) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",450,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 450 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 450 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }

    if (b->method == 
# 454 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 454 "../crypto/bio/bio_lib.c"
                         || b->method->brecvmmsg == 
# 454 "../crypto/bio/bio_lib.c" 3 4
                                                    ((void *)0)
# 454 "../crypto/bio/bio_lib.c"
        ...
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",456,__func__), ERR_set_error)((32),(121),
# 456 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 456 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }

    if (((b)->callback != 
# 460 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 460 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 460 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 460 "../crypto/bio/bio_lib.c"
        ...
        ret = bio_call_callback(b, 0x07, (void *)&args,
                                0, 0, 0, 1, 
# 468 "../crypto/bio/bio_lib.c" 3 4
                                           ((void *)0)
# 468 "../crypto/bio/bio_lib.c"
                                               );
        if (ret <= 0)
            return 0;
    }
    ...
    if (!b->init) {
        *msgs_processed = 0;
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",475,__func__), ERR_set_error)((32),(120),
# 475 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 475 "../crypto/bio/bio_lib.c"
       );
        return 0;
    }
    ...
    if (((b)->callback != 
# 481 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 481 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 481 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 481 "../crypto/bio/bio_lib.c"
       ))
        ret = (size_t)bio_call_callback(b, 0x07 | 0x80,
                                        (void *)&args, ret, 0, 0, ret, 
# 483 "../crypto/bio/bio_lib.c" 3 4
                                                                      ((void *)0)
# 483 "../crypto/bio/bio_lib.c"
                                                                          );
...
int BIO_get_rpoll_descriptor(BIO *b, BIO_POLL_DESCRIPTOR *desc)
{
    return BIO_ctrl(b, 91, 0, desc);
}

int BIO_get_wpoll_descriptor(BIO *b, BIO_POLL_DESCRIPTOR *desc)
{
    return BIO_ctrl(b, 92, 0, desc);
}
...
int BIO_puts(BIO *b, const char *buf)
{
    ...
    if (b == 
# 503 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 503 "../crypto/bio/bio_lib.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",504,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 504 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 504 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    if (b->method == 
# 507 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 507 "../crypto/bio/bio_lib.c"
                         || b->method->bputs == 
# 507 "../crypto/bio/bio_lib.c" 3 4
                                                ((void *)0)
# 507 "../crypto/bio/bio_lib.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",508,__func__), ERR_set_error)((32),(121),
# 508 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 508 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (((b)->callback != 
# 512 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 512 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 512 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 512 "../crypto/bio/bio_lib.c"
       )) {
        ret = (int)bio_call_callback(b, 0x04, buf, 0, 0, 0L, 1L, 
# 513 "../crypto/bio/bio_lib.c" 3 4
                                                                       ((void *)0)
# 513 "../crypto/bio/bio_lib.c"
                                                                           );
        if (ret <= 0)
            return ret;
    }
    ...
    if (!b->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",519,__func__), ERR_set_error)((32),(120),
# 519 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 519 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    if (((b)->callback != 
# 531 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 531 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 531 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 531 "../crypto/bio/bio_lib.c"
       ))
        ret = (int)bio_call_callback(b, 0x04 | 0x80, buf, 0, 0,
                                     0L, ret, &written);

    if (ret > 0) {
        if (written > 0x7fffffff
# 536 "../crypto/bio/bio_lib.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",537,__func__), ERR_set_error)((32),(102),
# 537 "../crypto/bio/bio_lib.c" 3 4
           ((void *)0)
# 537 "../crypto/bio/bio_lib.c"
           );
            ret = -1;
        } else {
            ret = (int)written;
...
int BIO_gets(BIO *b, char *buf, int size)
{
    ...
    if (b == 
# 552 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 552 "../crypto/bio/bio_lib.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",553,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 553 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 553 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    if (b->method == 
# 556 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 556 "../crypto/bio/bio_lib.c"
                         || b->method->bgets == 
# 556 "../crypto/bio/bio_lib.c" 3 4
                                                ((void *)0)
# 556 "../crypto/bio/bio_lib.c"
                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",557,__func__), ERR_set_error)((32),(121),
# 557 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 557 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (size < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",562,__func__), ERR_set_error)((32),(125),
# 562 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 562 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }

    if (((b)->callback != 
# 566 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 566 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 566 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 566 "../crypto/bio/bio_lib.c"
       )) {
        ret = (int)bio_call_callback(b, 0x05, buf, size, 0, 0L, 1, 
# 567 "../crypto/bio/bio_lib.c" 3 4
                                                                         ((void *)0)
# 567 "../crypto/bio/bio_lib.c"
                                                                             );
        if (ret <= 0)
            return ret;
    }
    ...
    if (!b->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",573,__func__), ERR_set_error)((32),(120),
# 573 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 573 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    if (((b)->callback != 
# 584 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 584 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 584 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 584 "../crypto/bio/bio_lib.c"
       ))
        ret = (int)bio_call_callback(b, 0x05 | 0x80, buf, size,
                                     0, 0L, ret, &readbytes);
...
int BIO_get_line(BIO *bio, char *buf, int size)
{
    ...
    if (buf == 
# 604 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 604 "../crypto/bio/bio_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",605,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 605 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 605 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    if (size <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",609,__func__), ERR_set_error)((32),(125),
# 609 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 609 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    *buf = '\0';
    ...
    if (bio == 
# 614 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 614 "../crypto/bio/bio_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",615,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 615 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 615 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    if (!bio->init) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",619,__func__), ERR_set_error)((32),(120),
# 619 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 619 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    while (size-- > 1 && (ret = BIO_read(bio, ptr, 1)) > 0)
        if (*ptr++ == '\n')
            break;
    *ptr = '\0';
    return ret > 0 || (int)BIO_ctrl(bio,2,0,
# 627 "../crypto/bio/bio_lib.c" 3 4
                     ((void *)0)
# 627 "../crypto/bio/bio_lib.c"
                     ) ? ptr - buf : ret;
}
...
{
    void *p = 
# 652 "../crypto/bio/bio_lib.c" 3 4
             ((void *)0)
# 652 "../crypto/bio/bio_lib.c"
                 ;

    if (BIO_ctrl(b, cmd, larg, (char *)&p) <= 0)
        return 
# 655 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 655 "../crypto/bio/bio_lib.c"
                  ;
    else
        return p;
}
...
long BIO_ctrl(BIO *b, int cmd, long larg, void *parg)
{
    ...
    if (b == 
# 664 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 664 "../crypto/bio/bio_lib.c"
                )
        return -1;
    if (b->method == 
# 666 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 666 "../crypto/bio/bio_lib.c"
                         || b->method->ctrl == 
# 666 "../crypto/bio/bio_lib.c" 3 4
                                               ((void *)0)
# 666 "../crypto/bio/bio_lib.c"
                                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",667,__func__), ERR_set_error)((32),(121),
# 667 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 667 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (((b)->callback != 
# 671 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 671 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 671 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 671 "../crypto/bio/bio_lib.c"
       )) {
        ret = bio_call_callback(b, 0x06, parg, 0, cmd, larg, 1L, 
# 672 "../crypto/bio/bio_lib.c" 3 4
                                                                       ((void *)0)
# 672 "../crypto/bio/bio_lib.c"
                                                                           );
        if (ret <= 0)
            return ret;
    }
    ...
    if (((b)->callback != 
# 679 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 679 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 679 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 679 "../crypto/bio/bio_lib.c"
       ))
        ret = bio_call_callback(b, 0x06 | 0x80, parg, 0, cmd,
                                larg, ret, 
# 681 "../crypto/bio/bio_lib.c" 3 4
                                          ((void *)0)
# 681 "../crypto/bio/bio_lib.c"
                                              );
...
long BIO_callback_ctrl(BIO *b, int cmd, BIO_info_cb *fp)
{
    ...
    if (b == 
# 690 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 690 "../crypto/bio/bio_lib.c"
                )
        return -2;
    if (b->method == 
# 692 "../crypto/bio/bio_lib.c" 3 4
                    ((void *)0) 
# 692 "../crypto/bio/bio_lib.c"
                         || b->method->callback_ctrl == 
# 692 "../crypto/bio/bio_lib.c" 3 4
                                                        ((void *)0)
            
# 693 "../crypto/bio/bio_lib.c"
           || cmd != 14) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",694,__func__), ERR_set_error)((32),(121),
# 694 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 694 "../crypto/bio/bio_lib.c"
       );
        return -2;
    }

    if (((b)->callback != 
# 698 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 698 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 698 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 698 "../crypto/bio/bio_lib.c"
       )) {
        ret = bio_call_callback(b, 0x06, (void *)&fp, 0, cmd, 0, 1L,
                                
# 700 "../crypto/bio/bio_lib.c" 3 4
                               ((void *)0)
# 700 "../crypto/bio/bio_lib.c"
                                   );
        if (ret <= 0)
            return ret;
    }
    ...
    if (((b)->callback != 
# 707 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0) 
# 707 "../crypto/bio/bio_lib.c"
       || (b)->callback_ex != 
# 707 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 707 "../crypto/bio/bio_lib.c"
       ))
        ret = bio_call_callback(b, 0x06 | 0x80, (void *)&fp, 0,
                                cmd, 0, ret, 
# 709 "../crypto/bio/bio_lib.c" 3 4
                                            ((void *)0)
# 709 "../crypto/bio/bio_lib.c"
                                                );
...
{
    long ret = BIO_ctrl(bio, 10, 0, 
# 721 "../crypto/bio/bio_lib.c" 3 4
                                                 ((void *)0)
# 721 "../crypto/bio/bio_lib.c"
                                                     );
...
{
    long ret = BIO_ctrl(bio, 13, 0, 
# 734 "../crypto/bio/bio_lib.c" 3 4
                                                  ((void *)0)
# 734 "../crypto/bio/bio_lib.c"
                                                      );
...
BIO *BIO_push(BIO *b, BIO *bio)
{
    ...
    if (b == 
# 750 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 750 "../crypto/bio/bio_lib.c"
                )
        return bio;
    lb = b;
    while (lb->next_bio != 
# 753 "../crypto/bio/bio_lib.c" 3 4
                          ((void *)0)
# 753 "../crypto/bio/bio_lib.c"
                              )
        lb = lb->next_bio;
    lb->next_bio = bio;
    if (bio != 
# 756 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 756 "../crypto/bio/bio_lib.c"
                  )
        bio->prev_bio = lb;
...
BIO *BIO_pop(BIO *b)
{
    ...
    if (b == 
# 768 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 768 "../crypto/bio/bio_lib.c"
                )
        return 
# 769 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 769 "../crypto/bio/bio_lib.c"
                  ;
    ret = b->next_bio;
    ...
    if (b->prev_bio != 
# 774 "../crypto/bio/bio_lib.c" 3 4
                      ((void *)0)
# 774 "../crypto/bio/bio_lib.c"
                          )
        b->prev_bio->next_bio = b->next_bio;
    if (b->next_bio != 
# 776 "../crypto/bio/bio_lib.c" 3 4
                      ((void *)0)
# 776 "../crypto/bio/bio_lib.c"
                          )
        b->next_bio->prev_bio = b->prev_bio;

    b->next_bio = 
# 779 "../crypto/bio/bio_lib.c" 3 4
                 ((void *)0)
# 779 "../crypto/bio/bio_lib.c"
                     ;
    b->prev_bio = 
# 780 "../crypto/bio/bio_lib.c" 3 4
                 ((void *)0)
# 780 "../crypto/bio/bio_lib.c"
                     ;
    return ret;
}
...
BIO *BIO_get_retry_BIO(BIO *bio, int *reason)
{
    ...
    for (;;) {
        ...
        b = b->next_bio;
        if (b == 
# 794 "../crypto/bio/bio_lib.c" 3 4
                ((void *)0)
# 794 "../crypto/bio/bio_lib.c"
                    )
            break;
    }
    if (reason != 
# 797 "../crypto/bio/bio_lib.c" 3 4
                 ((void *)0)
# 797 "../crypto/bio/bio_lib.c"
                     )
...
BIO *BIO_find_type(BIO *bio, int type)
{
    ...
    if (bio == 
# 816 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 816 "../crypto/bio/bio_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",817,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 817 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 817 "../crypto/bio/bio_lib.c"
       );
        return 
# 818 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 818 "../crypto/bio/bio_lib.c"
                  ;
    }
    mask = type & 0xFF;
    do {
        if (bio->method != 
# 822 "../crypto/bio/bio_lib.c" 3 4
                          ((void *)0)
# 822 "../crypto/bio/bio_lib.c"
                              ) {
            mt = bio->method->type;
...
# 833 "../crypto/bio/bio_lib.c" 3 4
                   ((void *)0)
# 833 "../crypto/bio/bio_lib.c"
                       );
    return 
# 834 "../crypto/bio/bio_lib.c" 3 4
          ((void *)0)
# 834 "../crypto/bio/bio_lib.c"
              ;
}
...
{
    if (b == 
# 839 "../crypto/bio/bio_lib.c" 3 4
            ((void *)0)
# 839 "../crypto/bio/bio_lib.c"
                )
        return 
# 840 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 840 "../crypto/bio/bio_lib.c"
                  ;
    return b->next_bio;
}
...
void BIO_free_all(BIO *bio)
{
    ...
    while (bio != 
# 854 "../crypto/bio/bio_lib.c" 3 4
                 ((void *)0)
# 854 "../crypto/bio/bio_lib.c"
                     ) {
        b = bio;
...
{
    BIO *ret = 
# 867 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 867 "../crypto/bio/bio_lib.c"
                  , *eoc = 
# 867 "../crypto/bio/bio_lib.c" 3 4
                           ((void *)0)
# 867 "../crypto/bio/bio_lib.c"
    ...
    for (bio = in; bio != 
# 869 "../crypto/bio/bio_lib.c" 3 4
                         ((void *)0)
# 869 "../crypto/bio/bio_lib.c"
                             ; bio = bio->next_bio) {
        if ((new_bio = BIO_new(bio->method)) == 
# 870 "../crypto/bio/bio_lib.c" 3 4
                                               ((void *)0)
# 870 "../crypto/bio/bio_lib.c"
                                                   )
            goto err;
        ...
        if (BIO_ctrl(bio,12,0,(char *)((char *)new_bio)) <= 0) {
            BIO_free(new_bio);
            goto err;
        }


        if (!CRYPTO_dup_ex_data(12, &new_bio->ex_data,
                                &bio->ex_data)) {
            BIO_free(new_bio);
            goto err;
        }
        ...
        if (ret == 
# 896 "../crypto/bio/bio_lib.c" 3 4
                  ((void *)0)
# 896 "../crypto/bio/bio_lib.c"
                      ) {
            eoc = new_bio;
            ret = eoc;
        } else {
 ...
 err:
    ...
    return 
# 908 "../crypto/bio/bio_lib.c" 3 4
          ((void *)0)
# 908 "../crypto/bio/bio_lib.c"
              ;
}
...
void bio_cleanup(void)
{
    ...
    bio_lookup_lock = 
# 951 "../crypto/bio/bio_lib.c" 3 4
                     ((void *)0)
# 951 "../crypto/bio/bio_lib.c"
                         ;
...
static int bio_wait(BIO *bio, time_t max_time, unsigned int nap_milliseconds)
{
    ...
    if (BIO_ctrl(bio,105,0,(char *)(&fd)) > 0) {
        int ret = BIO_socket_wait(fd, BIO_test_flags(bio, 0x01), max_time);
    ...
    sec_diff = (long)(max_time - time(
# 977 "../crypto/bio/bio_lib.c" 3 4
                                     ((void *)0)
# 977 "../crypto/bio/bio_lib.c"
                                         ));
    if (sec_diff < 0)
        return 0;
...
# 1001 "../crypto/bio/bio_lib.c"
int BIO_wait(BIO *bio, time_t max_time, unsigned int nap_milliseconds)
{
    int rv = bio_wait(bio, max_time, nap_milliseconds);

    if (rv <= 0)
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",1006,__func__), ERR_set_error)((32),(rv == 0 ? 105 : 104),
# 1006 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 1006 "../crypto/bio/bio_lib.c"
       )
                                                                          ;
    return rv;
}
# 1019 "../crypto/bio/bio_lib.c"
int BIO_do_connect_retry(BIO *bio, int timeout, int nap_milliseconds)
{
    int blocking = timeout <= 0;
    time_t max_time = timeout > 0 ? time(
# 1022 "../crypto/bio/bio_lib.c" 3 4
                                        ((void *)0)
# 1022 "../crypto/bio/bio_lib.c"
                                            ) + timeout : 0;
    int rv;

    if (bio == 
# 1025 "../crypto/bio/bio_lib.c" 3 4
              ((void *)0)
# 1025 "../crypto/bio/bio_lib.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",1026,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 1026 "../crypto/bio/bio_lib.c" 3 4
       ((void *)0)
# 1026 "../crypto/bio/bio_lib.c"
       );
        return -1;
    }
    ...
    BIO_ctrl(bio,102,(!blocking),
# 1032 "../crypto/bio/bio_lib.c" 3 4
   ((void *)0)
# 1032 "../crypto/bio/bio_lib.c"
   );

 retry:
    ERR_set_mark();
    rv = BIO_ctrl(bio,101,0,
# 1036 "../crypto/bio/bio_lib.c" 3 4
        ((void *)0)
# 1036 "../crypto/bio/bio_lib.c"
        );

    if (rv <= 0) {
        int err = ERR_peek_last_error();
        int reason = ERR_GET_REASON(err);
        int do_retry = BIO_test_flags(bio, 0x08);

        if (ERR_GET_LIB(err) == 32) {
            switch (reason) {
            case (2 | (0x2 << 18L)):
            ...
            case 110:
                ...
                (void)(int)BIO_ctrl(bio,1,0,
# 1055 "../crypto/bio/bio_lib.c" 3 4
                     ((void *)0)
# 1055 "../crypto/bio/bio_lib.c"
                     );
                do_retry = 1;
                break;
            default:
        ...
        if (timeout >= 0 && do_retry) {
            ...
            if (rv > 0)
                goto retry;
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",1068,__func__), ERR_set_error)((32),(rv == 0 ? 147 : 103),
# 1068 "../crypto/bio/bio_lib.c" 3 4
           ((void *)0)
# 1068 "../crypto/bio/bio_lib.c"
           )
                                                                            ;
        } else {
            ERR_clear_last_mark();
            ...
            if (err == 0)
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_lib.c",1075,__func__), ERR_set_error)((32),(103),
# 1075 "../crypto/bio/bio_lib.c" 3 4
               ((void *)0)
# 1075 "../crypto/bio/bio_lib.c"
               );
        }
    } else {
        ERR_clear_last_mark();
