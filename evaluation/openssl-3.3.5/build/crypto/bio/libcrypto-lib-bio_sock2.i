# 0 "../crypto/bio/bio_sock2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_sock2.c"
# 10 "../crypto/bio/bio_sock2.c"
...
# 15 "../crypto/bio/bio_sock2.c" 2
# 1 "../include/internal/ktls.h" 1
# 25 "../include/internal/ktls.h"
        
# 16 "../crypto/bio/bio_sock2.c" 2
# 1 "../include/internal/bio_tfo.h" 1
# 17 "../crypto/bio/bio_sock2.c" 2
# 42 "../crypto/bio/bio_sock2.c"
int BIO_socket(int domain, int socktype, int protocol, int options)
{
    int sock = -1;
    ...
    if (sock == -1) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",51,__func__), ERR_set_error)(2, 
# 51 "../crypto/bio/bio_sock2.c" 3 4
                                   (*__errno_location ())
# 51 "../crypto/bio/bio_sock2.c"
                                                          ,
                       "calling socket()");
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",53,__func__), ERR_set_error)((32),(118),
# 53 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 53 "../crypto/bio/bio_sock2.c"
       );
        return (-1);
    }
...
# 81 "../crypto/bio/bio_sock2.c"
int BIO_connect(int sock, const BIO_ADDR *addr, int options)
{
    const int on = 1;

    if (sock == -1) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",86,__func__), ERR_set_error)((32),(135),
# 86 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 86 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }

    if (!BIO_socket_nbio(sock, (options & 0x08) != 0))
        return 0;

    if (options & 0x04) {
        if (setsockopt(sock, 
# 94 "../crypto/bio/bio_sock2.c" 3 4
                            1
# 94 "../crypto/bio/bio_sock2.c"
                                      , 
# 94 "../crypto/bio/bio_sock2.c" 3 4
                                        9
# 94 "../crypto/bio/bio_sock2.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",96,__func__), ERR_set_error)(2, 
# 96 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 96 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",98,__func__), ERR_set_error)((32),(137),
# 98 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 98 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    ...
    if (options & 0x10) {
        if (setsockopt(sock, 
# 104 "../crypto/bio/bio_sock2.c" 3 4
                            IPPROTO_TCP
# 104 "../crypto/bio/bio_sock2.c"
                                       , 
# 104 "../crypto/bio/bio_sock2.c" 3 4
                                         1
# 104 "../crypto/bio/bio_sock2.c"
                                                    ,
                       (const void *)&on, sizeof(on)) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",106,__func__), ERR_set_error)(2, 
# 106 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 106 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",108,__func__), ERR_set_error)((32),(138),
# 108 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 108 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    if (options & 0x20) {
# 173 "../crypto/bio/bio_sock2.c"
    }

    if (connect(sock, BIO_ADDR_sockaddr(addr),
                BIO_ADDR_sockaddr_size(addr)) == -1) {
        if (!BIO_sock_should_retry(-1)) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",178,__func__), ERR_set_error)(2, 
# 178 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 178 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling connect()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",180,__func__), ERR_set_error)((32),(103),
# 180 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 180 "../crypto/bio/bio_sock2.c"
           );
        }
        return 0;
    }
# 193 "../crypto/bio/bio_sock2.c"
    return 1;
}
# 212 "../crypto/bio/bio_sock2.c"
int BIO_bind(int sock, const BIO_ADDR *addr, int options)
{
    ...
    if (sock == -1) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",219,__func__), ERR_set_error)((32),(135),
# 219 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 219 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }
    ...
    if (options & 0x01) {
        if (setsockopt(sock, 
# 229 "../crypto/bio/bio_sock2.c" 3 4
                            1
# 229 "../crypto/bio/bio_sock2.c"
                                      , 
# 229 "../crypto/bio/bio_sock2.c" 3 4
                                        2
# 229 "../crypto/bio/bio_sock2.c"
                                                    ,
                       (const void *)&on, sizeof(on)) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",231,__func__), ERR_set_error)(2, 
# 231 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 231 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",233,__func__), ERR_set_error)((32),(139),
# 233 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 233 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    ...
    if (bind(sock, BIO_ADDR_sockaddr(addr), BIO_ADDR_sockaddr_size(addr)) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",240,__func__), ERR_set_error)(2, 
# 240 "../crypto/bio/bio_sock2.c" 3 4
                                   (*__errno_location ()) 
# 240 "../crypto/bio/bio_sock2.c"
                                                                         ,
                       "calling bind()");
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",242,__func__), ERR_set_error)((32),(117),
# 242 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 242 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }
...
int BIO_listen(int sock, const BIO_ADDR *addr, int options)
{
    ...
    if (sock == -1) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",294,__func__), ERR_set_error)((32),(135),
# 294 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 294 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }

    if (getsockopt(sock, 
# 298 "../crypto/bio/bio_sock2.c" 3 4
                        1
# 298 "../crypto/bio/bio_sock2.c"
                                  , 
# 298 "../crypto/bio/bio_sock2.c" 3 4
                                    3
# 298 "../crypto/bio/bio_sock2.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",301,__func__), ERR_set_error)(2, 
# 301 "../crypto/bio/bio_sock2.c" 3 4
                                   (*__errno_location ())
# 301 "../crypto/bio/bio_sock2.c"
                                                          ,
                       "calling getsockopt()");
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",303,__func__), ERR_set_error)((32),(134),
# 303 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 303 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }
    ...
    if (options & 0x04) {
        if (setsockopt(sock, 
# 311 "../crypto/bio/bio_sock2.c" 3 4
                            1
# 311 "../crypto/bio/bio_sock2.c"
                                      , 
# 311 "../crypto/bio/bio_sock2.c" 3 4
                                        9
# 311 "../crypto/bio/bio_sock2.c"
                                                    ,
                       (const void *)&on, sizeof(on)) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",313,__func__), ERR_set_error)(2, 
# 313 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 313 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",315,__func__), ERR_set_error)((32),(137),
# 315 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 315 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    ...
    if (options & 0x10) {
        if (setsockopt(sock, 
# 321 "../crypto/bio/bio_sock2.c" 3 4
                            IPPROTO_TCP
# 321 "../crypto/bio/bio_sock2.c"
                                       , 
# 321 "../crypto/bio/bio_sock2.c" 3 4
                                         1
# 321 "../crypto/bio/bio_sock2.c"
                                                    ,
                       (const void *)&on, sizeof(on)) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",323,__func__), ERR_set_error)(2, 
# 323 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 323 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",325,__func__), ERR_set_error)((32),(138),
# 325 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 325 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    ...
    if (BIO_ADDR_family(addr) == 
# 332 "../crypto/bio/bio_sock2.c" 3 4
                                10
# 332 "../crypto/bio/bio_sock2.c"
                                        ) {
        ...
        on = options & 0x02 ? 1 : 0;
        if (setsockopt(sock, 
# 338 "../crypto/bio/bio_sock2.c" 3 4
                            IPPROTO_IPV6
# 338 "../crypto/bio/bio_sock2.c"
                                        , 
# 338 "../crypto/bio/bio_sock2.c" 3 4
                                          26
# 338 "../crypto/bio/bio_sock2.c"
                                                     ,
                       (const void *)&on, sizeof(on)) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",340,__func__), ERR_set_error)(2, 
# 340 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 340 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling setsockopt()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",342,__func__), ERR_set_error)((32),(136),
# 342 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 342 "../crypto/bio/bio_sock2.c"
           );
            return 0;
        }
    }
    ...
    if (socktype != 
# 351 "../crypto/bio/bio_sock2.c" 3 4
                   SOCK_DGRAM 
# 351 "../crypto/bio/bio_sock2.c"
                              && listen(sock, 
# 351 "../crypto/bio/bio_sock2.c" 3 4
                                              4096
# 351 "../crypto/bio/bio_sock2.c"
                                                        ) == -1) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",352,__func__), ERR_set_error)(2, 
# 352 "../crypto/bio/bio_sock2.c" 3 4
                                   (*__errno_location ())
# 352 "../crypto/bio/bio_sock2.c"
                                                          ,
                       "calling listen()");
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",354,__func__), ERR_set_error)((32),(119),
# 354 "../crypto/bio/bio_sock2.c" 3 4
       ((void *)0)
# 354 "../crypto/bio/bio_sock2.c"
       );
        return 0;
    }
# 406 "../crypto/bio/bio_sock2.c"
    return 1;
}
# 416 "../crypto/bio/bio_sock2.c"
int BIO_accept_ex(int accept_sock, BIO_ADDR *addr_, int options)
{
    ...
    BIO_ADDR locaddr;
    BIO_ADDR *addr = addr_ == 
# 421 "../crypto/bio/bio_sock2.c" 3 4
                             ((void *)0) 
# 421 "../crypto/bio/bio_sock2.c"
                                  ? &locaddr : addr_;
    ...
    if (accepted_sock == -1) {
        if (!BIO_sock_should_retry(accepted_sock)) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",428,__func__), ERR_set_error)(2, 
# 428 "../crypto/bio/bio_sock2.c" 3 4
                                       (*__errno_location ())
# 428 "../crypto/bio/bio_sock2.c"
                                                              ,
                           "calling accept()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock2.c",430,__func__), ERR_set_error)((32),(100),
# 430 "../crypto/bio/bio_sock2.c" 3 4
           ((void *)0)
# 430 "../crypto/bio/bio_sock2.c"
           );
        }
        return (-1);
    }

    if (!BIO_socket_nbio(accepted_sock, (options & 0x08) != 0)) {
        close(accepted_sock);
        return (-1);
    }
