# 0 "../crypto/bio/bio_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_meth.c"
# 10 "../crypto/bio/bio_meth.c"
...
# 11 "../crypto/bio/bio_meth.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 12 "../crypto/bio/bio_meth.c" 2

CRYPTO_REF_COUNT bio_type_count;
static CRYPTO_ONCE bio_type_init = 
# 14 "../crypto/bio/bio_meth.c" 3 4
                                  0
# 14 "../crypto/bio/bio_meth.c"
                                                         ;

static int do_bio_type_init(void); static int do_bio_type_init_ossl_ret_ = 0; static void do_bio_type_init_ossl_(void) { do_bio_type_init_ossl_ret_ = do_bio_type_init(); } static int do_bio_type_init(void)
{
    return CRYPTO_NEW_REF(&bio_type_count, 128);
}
...
int BIO_get_new_index(void)
{
    ...
    if (!(CRYPTO_THREAD_run_once(&bio_type_init, do_bio_type_init_ossl_) ? do_bio_type_init_ossl_ret_ : 0)) {

        (ERR_new(), ERR_set_debug("../crypto/bio/bio_meth.c",27,__func__), ERR_set_error)((32),((15 | (0x2 << 18L))),
# 27 "../crypto/bio/bio_meth.c" 3 4
       ((void *)0)
# 27 "../crypto/bio/bio_meth.c"
       );
        return -1;
    }
...
BIO_METHOD *BIO_meth_new(int type, const char *name)
{
    BIO_METHOD *biom = CRYPTO_zalloc(sizeof(BIO_METHOD), "../crypto/bio/bio_meth.c", 39);

    if (biom == 
# 41 "../crypto/bio/bio_meth.c" 3 4
               ((void *)0)
            
# 42 "../crypto/bio/bio_meth.c"
           || (biom->name = CRYPTO_strdup(name, "../crypto/bio/bio_meth.c", 42)) == 
# 42 "../crypto/bio/bio_meth.c" 3 4
                                                     ((void *)0)
# 42 "../crypto/bio/bio_meth.c"
                                                         ) {
        CRYPTO_free(biom, "../crypto/bio/bio_meth.c", 43);
        return 
# 44 "../crypto/bio/bio_meth.c" 3 4
              ((void *)0)
# 44 "../crypto/bio/bio_meth.c"
                  ;
    }
    biom->type = type;
    return biom;
...
{
    if (biom != 
# 52 "../crypto/bio/bio_meth.c" 3 4
               ((void *)0)
# 52 "../crypto/bio/bio_meth.c"
                   ) {
        CRYPTO_free(biom->name, "../crypto/bio/bio_meth.c", 53);
        CRYPTO_free(biom, "../crypto/bio/bio_meth.c", 54);
    }
}
...
int bwrite_conv(BIO *bio, const char *data, size_t datal, size_t *written)
{
    ...
    if (datal > 0x7fffffff
# 74 "../crypto/bio/bio_meth.c"
                      )
        datal = 0x7fffffff
# 75 "../crypto/bio/bio_meth.c"
                      ;
...
{
    biom->bwrite_old = 
# 100 "../crypto/bio/bio_meth.c" 3 4
                      ((void *)0)
# 100 "../crypto/bio/bio_meth.c"
                          ;
    biom->bwrite = bwrite;
    return 1;
}
...
int bread_conv(BIO *bio, char *data, size_t datal, size_t *readbytes)
{
    ...
    if (datal > 0x7fffffff
# 120 "../crypto/bio/bio_meth.c"
                      )
        datal = 0x7fffffff
# 121 "../crypto/bio/bio_meth.c"
                      ;
...
{
    biom->bread_old = 
# 146 "../crypto/bio/bio_meth.c" 3 4
                     ((void *)0)
# 146 "../crypto/bio/bio_meth.c"
                         ;
    biom->bread = bread;
    return 1;
}
