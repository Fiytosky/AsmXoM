...
{
    return ossl_lib_ctx_get_data(libctx, 17);
}
                            ...
                            size_t *bytes_read)
{
    ...
    if (bcgbl == 
# 45 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 45 "../crypto/bio/bss_core.c"
                     || bcgbl->c_bio_read_ex == 
# 45 "../crypto/bio/bss_core.c" 3 4
                                                ((void *)0)
# 45 "../crypto/bio/bss_core.c"
                             ...
                             size_t *written)
{
    ...
    if (bcgbl == 
# 55 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 55 "../crypto/bio/bss_core.c"
...
static long bio_core_ctrl(BIO *bio, int cmd, long num, void *ptr)
{
    ...
    if (bcgbl == 
# 64 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 64 "../crypto/bio/bss_core.c"
                     || bcgbl->c_bio_ctrl == 
# 64 "../crypto/bio/bss_core.c" 3 4
                                             ((void *)0)
# 64 "../crypto/bio/bss_core.c"
...
static int bio_core_gets(BIO *bio, char *buf, int size)
{
    ...
    if (bcgbl == 
# 73 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 73 "../crypto/bio/bss_core.c"
                     || bcgbl->c_bio_gets == 
# 73 "../crypto/bio/bss_core.c" 3 4
                                             ((void *)0)
# 73 "../crypto/bio/bss_core.c"
...
static int bio_core_puts(BIO *bio, const char *str)
{
    ...
    if (bcgbl == 
# 82 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 82 "../crypto/bio/bss_core.c"
                     || bcgbl->c_bio_puts == 
# 82 "../crypto/bio/bss_core.c" 3 4
                                             ((void *)0)
# 82 "../crypto/bio/bss_core.c"
...
static int bio_core_free(BIO *bio)
{
    ...
    if (bcgbl == 
# 98 "../crypto/bio/bss_core.c" 3 4
                ((void *)0)
# 98 "../crypto/bio/bss_core.c"
                    )
        return 0;
...
# 111 "../crypto/bio/bss_core.c" 3 4
   ((void *)0)
# 111 "../crypto/bio/bss_core.c"
       ,
    bio_core_read_ex,
    
# 113 "../crypto/bio/bss_core.c" 3 4
   ((void *)0)
# 113 "../crypto/bio/bss_core.c"
       ,
    bio_core_puts,
    bio_core_gets,
    bio_core_ctrl,
...
# 119 "../crypto/bio/bss_core.c" 3 4
   ((void *)0)
# 119 "../crypto/bio/bss_core.c"
       ,
};
...
BIO *BIO_new_from_core_bio(OSSL_LIB_CTX *libctx, OSSL_CORE_BIO *corebio)
{
    ...
    if (bcgbl == 
# 133 "../crypto/bio/bss_core.c" 3 4
                ((void *)0) 
# 133 "../crypto/bio/bss_core.c"
                     || (bcgbl->c_bio_write_ex == 
# 133 "../crypto/bio/bss_core.c" 3 4
                                                  ((void *)0) 
# 133 "../crypto/bio/bss_core.c"
...
# 133 "../crypto/bio/bss_core.c"
        ...
        return 
# 134 "../crypto/bio/bss_core.c" 3 4
              ((void *)0)
# 134 "../crypto/bio/bss_core.c"
                  ;

    if ((outbio = BIO_new_ex(libctx, BIO_s_core())) == 
# 136 "../crypto/bio/bss_core.c" 3 4
                                                      ((void *)0)
# 136 "../crypto/bio/bss_core.c"
                                                          )
        return 
# 137 "../crypto/bio/bss_core.c" 3 4
              ((void *)0)
# 137 "../crypto/bio/bss_core.c"
                  ;

    if (!bcgbl->c_bio_up_ref(corebio)) {
        BIO_free(outbio);
        return 
# 141 "../crypto/bio/bss_core.c" 3 4
              ((void *)0)
# 141 "../crypto/bio/bss_core.c"
                  ;
    }
...
int ossl_bio_init_core(OSSL_LIB_CTX *libctx, const OSSL_DISPATCH *fns)
{
    ...
    if (bcgbl == 
# 151 "../crypto/bio/bss_core.c" 3 4
                ((void *)0)
# 151 "../crypto/bio/bss_core.c"
                    )
     return 0;
    ...
    for (; fns->function_id != 0; fns++) {
        ...
        case 42:
            if (bcgbl->c_bio_read_ex == 
# 157 "../crypto/bio/bss_core.c" 3 4
                                       ((void *)0)
# 157 "../crypto/bio/bss_core.c"
                                           )
                bcgbl->c_bio_read_ex = OSSL_FUNC_BIO_read_ex(fns);
            break;
        case 43:
            if (bcgbl->c_bio_write_ex == 
# 161 "../crypto/bio/bss_core.c" 3 4
                                        ((void *)0)
# 161 "../crypto/bio/bss_core.c"
                                            )
                bcgbl->c_bio_write_ex = OSSL_FUNC_BIO_write_ex(fns);
            break;
        case 49:
            if (bcgbl->c_bio_gets == 
# 165 "../crypto/bio/bss_core.c" 3 4
                                    ((void *)0)
# 165 "../crypto/bio/bss_core.c"
                                        )
                bcgbl->c_bio_gets = OSSL_FUNC_BIO_gets(fns);
            break;
        case 48:
            if (bcgbl->c_bio_puts == 
# 169 "../crypto/bio/bss_core.c" 3 4
                                    ((void *)0)
# 169 "../crypto/bio/bss_core.c"
                                        )
                bcgbl->c_bio_puts = OSSL_FUNC_BIO_puts(fns);
            break;
        case 50:
            if (bcgbl->c_bio_ctrl == 
# 173 "../crypto/bio/bss_core.c" 3 4
                                    ((void *)0)
# 173 "../crypto/bio/bss_core.c"
                                        )
                bcgbl->c_bio_ctrl = OSSL_FUNC_BIO_ctrl(fns);
            break;
        case 44:
            if (bcgbl->c_bio_up_ref == 
# 177 "../crypto/bio/bss_core.c" 3 4
                                      ((void *)0)
# 177 "../crypto/bio/bss_core.c"
                                          )
                bcgbl->c_bio_up_ref = OSSL_FUNC_BIO_up_ref(fns);
            break;
        case 45:
            if (bcgbl->c_bio_free == 
# 181 "../crypto/bio/bss_core.c" 3 4
                                    ((void *)0)
# 181 "../crypto/bio/bss_core.c"
                                        )
