# 0 "../crypto/bio/bss_acpt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_acpt.c"
# 12 "../crypto/bio/bss_acpt.c"
...
# 64 "../crypto/bio/bss_acpt.c" 3 4
   ((void *)0)
# 64 "../crypto/bio/bss_acpt.c"
       ,
    acpt_ctrl,
    acpt_new,
    acpt_free,
    
# 68 "../crypto/bio/bss_acpt.c" 3 4
   ((void *)0)
# 68 "../crypto/bio/bss_acpt.c"
       ,
};
...
# 83 "../crypto/bio/bss_acpt.c" 3 4
                                  ((void *)0)
# 83 "../crypto/bio/bss_acpt.c"
                                      )
        return 0;
    bi->ptr = (char *)ba;
    ba->state = 1;
...
static BIO_ACCEPT *BIO_ACCEPT_new(void)
{
    ...
    if ((ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bio/bss_acpt.c", 95)) == 
# 95 "../crypto/bio/bss_acpt.c" 3 4
                                               ((void *)0)
# 95 "../crypto/bio/bss_acpt.c"
                                                   )
        return 
# 96 "../crypto/bio/bss_acpt.c" 3 4
              ((void *)0)
# 96 "../crypto/bio/bss_acpt.c"
                  ;
    ret->accept_family = 256;
    ret->accept_sock = (int)(-1);
    return ret;
}
...
{
    if (a == 
# 104 "../crypto/bio/bss_acpt.c" 3 4
            ((void *)0)
# 104 "../crypto/bio/bss_acpt.c"
                )
        return;
    CRYPTO_free(a->param_addr, "../crypto/bio/bss_acpt.c", 106);
    CRYPTO_free(a->param_serv, "../crypto/bio/bss_acpt.c", 107);
    BIO_ADDRINFO_free(a->addr_first);
    CRYPTO_free(a->cache_accepting_name, "../crypto/bio/bss_acpt.c", 109);
    CRYPTO_free(a->cache_accepting_serv, "../crypto/bio/bss_acpt.c", 110);
    CRYPTO_free(a->cache_peer_name, "../crypto/bio/bss_acpt.c", 111);
    CRYPTO_free(a->cache_peer_serv, "../crypto/bio/bss_acpt.c", 112);
    BIO_free(a->bio_chain);
    CRYPTO_free(a, "../crypto/bio/bss_acpt.c", 114);
}
...
static int acpt_free(BIO *a)
{
    ...
    if (a == 
# 134 "../crypto/bio/bss_acpt.c" 3 4
            ((void *)0)
# 134 "../crypto/bio/bss_acpt.c"
                )
        return 0;
    ...
    if (a->shutdown) {
        ...
        a->ptr = 
# 141 "../crypto/bio/bss_acpt.c" 3 4
                ((void *)0)
# 141 "../crypto/bio/bss_acpt.c"
                    ;
        a->flags = 0;
        a->init = 0;
    }
...
{
    BIO *bio = 
# 150 "../crypto/bio/bss_acpt.c" 3 4
              ((void *)0)
# 150 "../crypto/bio/bss_acpt.c"
                  , *dbio;
    int s = -1, ret = -1;
    ...
    for (;;) {
        ...
        case 1:
            if (c->param_addr == 
# 156 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0) 
# 156 "../crypto/bio/bss_acpt.c"
                                     && c->param_serv == 
# 156 "../crypto/bio/bss_acpt.c" 3 4
                                                         ((void *)0)
# 156 "../crypto/bio/bss_acpt.c"
                                                             ) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",157,__func__), ERR_set_error)(32,
                               143,
            ...
            CRYPTO_free(c->cache_accepting_name, "../crypto/bio/bss_acpt.c", 168);
            c->cache_accepting_name = 
# 169 "../crypto/bio/bss_acpt.c" 3 4
                                     ((void *)0)
# 169 "../crypto/bio/bss_acpt.c"
                                         ;
            CRYPTO_free(c->cache_accepting_serv, "../crypto/bio/bss_acpt.c", 170);
            c->cache_accepting_serv = 
# 171 "../crypto/bio/bss_acpt.c" 3 4
                                     ((void *)0)
# 171 "../crypto/bio/bss_acpt.c"
                                         ;
            CRYPTO_free(c->cache_peer_name, "../crypto/bio/bss_acpt.c", 172);
            c->cache_peer_name = 
# 173 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0)
# 173 "../crypto/bio/bss_acpt.c"
                                    ;
            CRYPTO_free(c->cache_peer_serv, "../crypto/bio/bss_acpt.c", 174);
            c->cache_peer_serv = 
# 175 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0)
# 175 "../crypto/bio/bss_acpt.c"
                                    ;
        ...
        case 2:
            {
                int family = 
# 182 "../crypto/bio/bss_acpt.c" 3 4
                            0
# 182 "../crypto/bio/bss_acpt.c"
                                     ;
                ...
                case 6:
                    if (1) {
                        ...
                        family = 
# 190 "../crypto/bio/bss_acpt.c" 3 4
                                10
# 190 "../crypto/bio/bss_acpt.c"
                                        ;
                    } else {

                        (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",193,__func__), ERR_set_error)((32),(145),
# 193 "../crypto/bio/bss_acpt.c" 3 4
                       ((void *)0)
# 193 "../crypto/bio/bss_acpt.c"
                       );
                        goto exit_loop;
                    }
                    break;
                case 4:
                    family = 
# 198 "../crypto/bio/bss_acpt.c" 3 4
                            2
# 198 "../crypto/bio/bss_acpt.c"
                                   ;
                    break;
                case 256:
                    family = 
# 201 "../crypto/bio/bss_acpt.c" 3 4
                            0
# 201 "../crypto/bio/bss_acpt.c"
                                     ;
                    break;
                default:
                    (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",204,__func__), ERR_set_error)((32),(146),
# 204 "../crypto/bio/bss_acpt.c" 3 4
                   ((void *)0)
# 204 "../crypto/bio/bss_acpt.c"
                   );
                    goto exit_loop;
                }
                if (BIO_lookup(c->param_addr, c->param_serv, BIO_LOOKUP_SERVER,
                               family, 
# 208 "../crypto/bio/bss_acpt.c" 3 4
                                      SOCK_STREAM
# 208 "../crypto/bio/bss_acpt.c"
                                                 , &c->addr_first) == 0)
                    goto exit_loop;
            }
            if (c->addr_first == 
# 211 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0)
# 211 "../crypto/bio/bss_acpt.c"
                                    ) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",212,__func__), ERR_set_error)((32),(142),
# 212 "../crypto/bio/bss_acpt.c" 3 4
               ((void *)0)
# 212 "../crypto/bio/bss_acpt.c"
               );
                goto exit_loop;
            }
...
# 225 "../crypto/bio/bss_acpt.c" 3 4
                                                                       ((void *)0)
# 225 "../crypto/bio/bss_acpt.c"
                                                                           ) {
                ...
                ERR_clear_last_mark();
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",233,__func__), ERR_set_error)(2, 
# 233 "../crypto/bio/bss_acpt.c" 3 4
                                           (*__errno_location ())
# 233 "../crypto/bio/bss_acpt.c"
                                                                  ,
                               "calling socket(%s, %s)",
                                c->param_addr, c->param_serv);
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_acpt.c",236,__func__), ERR_set_error)((32),(118),
# 236 "../crypto/bio/bss_acpt.c" 3 4
               ((void *)0)
# 236 "../crypto/bio/bss_acpt.c"
               );
                goto exit_loop;
            }
            c->accept_sock = s;
        ...
        case 5:
            if (b->next_bio != 
# 276 "../crypto/bio/bss_acpt.c" 3 4
                              ((void *)0)
# 276 "../crypto/bio/bss_acpt.c"
                                  ) {
                c->state = 6;
                break;
            }
            ...
            CRYPTO_free(c->cache_peer_name, "../crypto/bio/bss_acpt.c", 283);
            c->cache_peer_name = 
# 284 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0)
# 284 "../crypto/bio/bss_acpt.c"
                                    ;
            CRYPTO_free(c->cache_peer_serv, "../crypto/bio/bss_acpt.c", 285);
            c->cache_peer_serv = 
# 286 "../crypto/bio/bss_acpt.c" 3 4
                                ((void *)0)
# 286 "../crypto/bio/bss_acpt.c"
                                    ;
            ...
            bio = BIO_new_socket(s, 0x01);
            if (bio == 
# 309 "../crypto/bio/bss_acpt.c" 3 4
                      ((void *)0)
# 309 "../crypto/bio/bss_acpt.c"
                          )
                goto exit_loop;
            ...
            if (c->bio_chain != 
# 321 "../crypto/bio/bss_acpt.c" 3 4
                               ((void *)0)
# 321 "../crypto/bio/bss_acpt.c"
                                   ) {
                if ((dbio = BIO_dup_chain(c->bio_chain)) == 
# 322 "../crypto/bio/bss_acpt.c" 3 4
                                                           ((void *)0)
# 322 "../crypto/bio/bss_acpt.c"
                                                               )
                    goto exit_loop;
            ...
            if (BIO_push(b, bio) == 
# 328 "../crypto/bio/bss_acpt.c" 3 4
                                   ((void *)0)
# 328 "../crypto/bio/bss_acpt.c"
                                       )
                goto exit_loop;
            ...
            c->state = 6;
            bio = 
# 336 "../crypto/bio/bss_acpt.c" 3 4
                 ((void *)0)
# 336 "../crypto/bio/bss_acpt.c"
                     ;
            ret = 1;
            goto end;
        ...
        case 6:
            if (b->next_bio == 
# 341 "../crypto/bio/bss_acpt.c" 3 4
                              ((void *)0)
# 341 "../crypto/bio/bss_acpt.c"
                                  ) {
                c->state = 5;
                break;
            }
  ...
  exit_loop:
    if (bio != 
# 355 "../crypto/bio/bss_acpt.c" 3 4
              ((void *)0)
# 355 "../crypto/bio/bss_acpt.c"
                  )
        BIO_free(bio);
    else if (s >= 0)
        BIO_closesocket(s);
...
static int acpt_read(BIO *b, char *out, int outl)
{
    ...
    while (b->next_bio == 
# 371 "../crypto/bio/bss_acpt.c" 3 4
                         ((void *)0)
# 371 "../crypto/bio/bss_acpt.c"
                             ) {
...
static int acpt_write(BIO *b, const char *in, int inl)
{
    ...
    while (b->next_bio == 
# 390 "../crypto/bio/bss_acpt.c" 3 4
                         ((void *)0)
# 390 "../crypto/bio/bss_acpt.c"
                             ) {
        ret = acpt_state(b, data);
        if (ret <= 0)
            return ret;
...
static long acpt_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 1:
        ...
        data->addr_first = 
# 416 "../crypto/bio/bss_acpt.c" 3 4
                          ((void *)0)
# 416 "../crypto/bio/bss_acpt.c"
                              ;
        b->flags = 0;
        break;
    case 101:
    ...
    case 118:
        if (ptr != 
# 424 "../crypto/bio/bss_acpt.c" 3 4
                  ((void *)0)
# 424 "../crypto/bio/bss_acpt.c"
                      ) {
            if (num == 0) {
                ...
                CRYPTO_free(data->param_addr, "../crypto/bio/bss_acpt.c", 431);
                data->param_addr = 
# 432 "../crypto/bio/bss_acpt.c" 3 4
                                  ((void *)0)
# 432 "../crypto/bio/bss_acpt.c"
                                      ;
                ...
                if (hold_serv != data->param_serv)
                    CRYPTO_free(hold_serv, "../crypto/bio/bss_acpt.c", 438);
                b->init = 1;
            } else if (num == 1) {
                CRYPTO_free(data->param_serv, "../crypto/bio/bss_acpt.c", 441);
                if ((data->param_serv = CRYPTO_strdup(ptr, "../crypto/bio/bss_acpt.c", 442)) == 
# 442 "../crypto/bio/bss_acpt.c" 3 4
                                                               ((void *)0)
# 442 "../crypto/bio/bss_acpt.c"
                                                                   )
                    ret = 0;
                else
                    b->init = 1;
    ...
    case 105:
        if (b->init) {
            ip = (int *)ptr;
            if (ip != 
# 480 "../crypto/bio/bss_acpt.c" 3 4
                     ((void *)0)
# 480 "../crypto/bio/bss_acpt.c"
                         )
                *ip = data->accept_sock;
    ...
    case 124:
        if (b->init) {
            if (num == 0 && ptr != 
# 488 "../crypto/bio/bss_acpt.c" 3 4
                                  ((void *)0)
# 488 "../crypto/bio/bss_acpt.c"
                                      ) {
                pp = (char **)ptr;
                *pp = data->cache_accepting_name;
            } else if (num == 1 && ptr != 
# 491 "../crypto/bio/bss_acpt.c" 3 4
                                         ((void *)0)
# 491 "../crypto/bio/bss_acpt.c"
                                             ) {
                pp = (char **)ptr;
                *pp = data->cache_accepting_serv;
            } else if (num == 2 && ptr != 
# 494 "../crypto/bio/bss_acpt.c" 3 4
                                         ((void *)0)
# 494 "../crypto/bio/bss_acpt.c"
                                             ) {
                pp = (char **)ptr;
                *pp = data->cache_peer_name;
            } else if (num == 3 && ptr != 
# 497 "../crypto/bio/bss_acpt.c" 3 4
                                         ((void *)0)
# 497 "../crypto/bio/bss_acpt.c"
                                             ) {
                pp = (char **)ptr;
                *pp = data->cache_peer_serv;
                ...
                case 
# 503 "../crypto/bio/bss_acpt.c" 3 4
                    10
# 503 "../crypto/bio/bss_acpt.c"
                            :
                    ret = 6;
                    break;

                case 
# 507 "../crypto/bio/bss_acpt.c" 3 4
                    2
# 507 "../crypto/bio/bss_acpt.c"
                           :
                    ret = 4;
                    break;
                case 0:
    ...
    case 2:
        if (b->next_bio == 
# 543 "../crypto/bio/bss_acpt.c" 3 4
                          ((void *)0)
# 543 "../crypto/bio/bss_acpt.c"
                              )
            ret = 0;
        else
...
BIO *BIO_new_accept(const char *str)
{
    ...
    if (ret == 
# 569 "../crypto/bio/bss_acpt.c" 3 4
              ((void *)0)
# 569 "../crypto/bio/bss_acpt.c"
                  )
        return 
# 570 "../crypto/bio/bss_acpt.c" 3 4
              ((void *)0)
# 570 "../crypto/bio/bss_acpt.c"
                  ;
    if (BIO_ctrl(ret,118,0, (char *)(str)) > 0)
        return ret;
    BIO_free(ret);
    return 
# 574 "../crypto/bio/bss_acpt.c" 3 4
          ((void *)0)
# 574 "../crypto/bio/bss_acpt.c"
              ;
}
