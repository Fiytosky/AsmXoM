# 0 "../crypto/bio/bio_cb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_cb.c"
# 12 "../crypto/bio/bio_cb.c"
                           ...
                           int argi, long argl, int ret, size_t *processed)
{
    ...
    if (processed != 
# 30 "../crypto/bio/bio_cb.c" 3 4
                    ((void *)0)
# 30 "../crypto/bio/bio_cb.c"
                        )
        l = *processed;
    ...
    b = (BIO *)bio->cb_arg;
    if (b != 
# 113 "../crypto/bio/bio_cb.c" 3 4
            ((void *)0)
# 113 "../crypto/bio/bio_cb.c"
                )
        BIO_write(b, buf, strlen(buf));

    else
        fputs(buf, 
# 117 "../crypto/bio/bio_cb.c" 3 4
                  stderr
# 117 "../crypto/bio/bio_cb.c"
                        );
