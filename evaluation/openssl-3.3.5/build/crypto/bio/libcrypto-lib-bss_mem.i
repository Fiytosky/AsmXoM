# 0 "../crypto/bio/bss_mem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_mem.c"
# 10 "../crypto/bio/bss_mem.c"
...
# 38 "../crypto/bio/bss_mem.c" 3 4
   ((void *)0)
# 38 "../crypto/bio/bss_mem.c"
       ,
};
...
# 53 "../crypto/bio/bss_mem.c" 3 4
   ((void *)0)
# 53 "../crypto/bio/bss_mem.c"
       ,
};
...
typedef struct bio_buf_mem_st {
    struct buf_mem_st *buf;
    struct buf_mem_st *readp;
} BIO_BUF_MEM;
...
BIO *BIO_new_mem_buf(const void *buf, int len)
{
    ...
    if (buf == 
# 89 "../crypto/bio/bss_mem.c" 3 4
              ((void *)0)
# 89 "../crypto/bio/bss_mem.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_mem.c",90,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 90 "../crypto/bio/bss_mem.c" 3 4
       ((void *)0)
# 90 "../crypto/bio/bss_mem.c"
       );
        return 
# 91 "../crypto/bio/bss_mem.c" 3 4
              ((void *)0)
# 91 "../crypto/bio/bss_mem.c"
                  ;
    }
    sz = (len < 0) ? strlen(buf) : (size_t)len;
    if ((ret = BIO_new(BIO_s_mem())) == 
# 94 "../crypto/bio/bss_mem.c" 3 4
                                       ((void *)0)
# 94 "../crypto/bio/bss_mem.c"
                                           )
        return 
# 95 "../crypto/bio/bss_mem.c" 3 4
              ((void *)0)
# 95 "../crypto/bio/bss_mem.c"
                  ;
...
{
    BIO_BUF_MEM *bb = CRYPTO_zalloc(sizeof(*bb), "../crypto/bio/bss_mem.c", 111);

    if (bb == 
# 113 "../crypto/bio/bss_mem.c" 3 4
             ((void *)0)
# 113 "../crypto/bio/bss_mem.c"
                 )
        return 0;
    if ((bb->buf = BUF_MEM_new_ex(flags)) == 
# 115 "../crypto/bio/bss_mem.c" 3 4
                                            ((void *)0)
# 115 "../crypto/bio/bss_mem.c"
                                                ) {
        CRYPTO_free(bb, "../crypto/bio/bss_mem.c", 116);
        return 0;
    }
    if ((bb->readp = CRYPTO_zalloc(sizeof(*bb->readp), "../crypto/bio/bss_mem.c", 119)) == 
# 119 "../crypto/bio/bss_mem.c" 3 4
                                                           ((void *)0)
# 119 "../crypto/bio/bss_mem.c"
                                                               ) {
        BUF_MEM_free(bb->buf);
        CRYPTO_free(bb, "../crypto/bio/bss_mem.c", 121);
        return 0;
    }
    *bb->readp = *bb->buf;
    bi->shutdown = 1;
...
static int mem_free(BIO *a)
{
    ...
    if (a == 
# 146 "../crypto/bio/bss_mem.c" 3 4
            ((void *)0)
# 146 "../crypto/bio/bss_mem.c"
                )
        return 0;
    ...
    if (!mem_buf_free(a))
        return 0;
    CRYPTO_free(bb->readp, "../crypto/bio/bss_mem.c", 152);
    CRYPTO_free(bb, "../crypto/bio/bss_mem.c", 153);
    return 1;
}
...
{
    if (a == 
# 159 "../crypto/bio/bss_mem.c" 3 4
            ((void *)0)
# 159 "../crypto/bio/bss_mem.c"
                )
        return 0;

    if (a->shutdown && a->init && a->ptr != 
# 162 "../crypto/bio/bss_mem.c" 3 4
                                           ((void *)0)
# 162 "../crypto/bio/bss_mem.c"
                                               ) {
        ...
        if (a->flags & 0x200)
            b->data = 
# 167 "../crypto/bio/bss_mem.c" 3 4
                     ((void *)0)
# 167 "../crypto/bio/bss_mem.c"
                         ;
        BUF_MEM_free(b);
    }
    return 1;
...
{
    if (b != 
# 179 "../crypto/bio/bss_mem.c" 3 4
            ((void *)0) 
# 179 "../crypto/bio/bss_mem.c"
                 && b->init != 0 && b->ptr != 
# 179 "../crypto/bio/bss_mem.c" 3 4
                                              ((void *)0)
# 179 "../crypto/bio/bss_mem.c"
...
static int mem_read(BIO *b, char *out, int outl)
{
    ...
    if ((out != 
# 201 "../crypto/bio/bss_mem.c" 3 4
               ((void *)0)
# 201 "../crypto/bio/bss_mem.c"
                   ) && (ret > 0)) {
...
static int mem_write(BIO *b, const char *in, int inl)
{
    ...
    if (b->flags & 0x200) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_mem.c",221,__func__), ERR_set_error)((32),(126),
# 221 "../crypto/bio/bss_mem.c" 3 4
       ((void *)0)
# 221 "../crypto/bio/bss_mem.c"
       );
        goto end;
    }
    BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
    if (inl == 0)
        return 0;
    if (in == 
# 227 "../crypto/bio/bss_mem.c" 3 4
             ((void *)0)
# 227 "../crypto/bio/bss_mem.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_mem.c",228,__func__), ERR_set_error)((32),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 228 "../crypto/bio/bss_mem.c" 3 4
       ((void *)0)
# 228 "../crypto/bio/bss_mem.c"
       );
        goto end;
    }
...
static long mem_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 1:
        bm = bbm->buf;
        if (bm->data != 
# 263 "../crypto/bio/bss_mem.c" 3 4
                       ((void *)0)
# 263 "../crypto/bio/bss_mem.c"
                           ) {
            if (!(b->flags & 0x200)) {
                if (!(b->flags & 0x400)) {
    ...
    case 3:
        ret = (long)bm->length;
        if (ptr != 
# 296 "../crypto/bio/bss_mem.c" 3 4
                  ((void *)0)
# 296 "../crypto/bio/bss_mem.c"
                      ) {
            pptr = (char **)ptr;
            *pptr = (char *)(bm->data);
        }
    ...
    case 115:
        if (ptr != 
# 308 "../crypto/bio/bss_mem.c" 3 4
                  ((void *)0)
# 308 "../crypto/bio/bss_mem.c"
                      ) {
            if (!(b->flags & 0x200))
                mem_buf_sync(b);
            bm = bbm->buf;
