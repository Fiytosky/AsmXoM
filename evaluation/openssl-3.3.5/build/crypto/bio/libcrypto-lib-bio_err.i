# 0 "../crypto/bio/bio_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_err.c"
# 11 "../crypto/bio/bio_err.c"
...
# 12 "../crypto/bio/bio_err.c" 2

# 1 "../include/crypto/bioerr.h" 1
# 13 "../include/crypto/bioerr.h"
        
# 22 "../include/crypto/bioerr.h"
int ossl_err_load_BIO_strings(void);
# 14 "../crypto/bio/bio_err.c" 2



static const ERR_STRING_DATA BIO_str_reasons[] = {
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "accept error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(141) & 0X7FFFFF)) ),
    "addrinfo addr is not af inet"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "ambiguous host or service"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad fopen mode"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ), "broken pipe"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "connect error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(147) & 0X7FFFFF)) ), "connect timeout"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "gethostbyname addr is not af inet"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ), "getsockname error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ),
    "getsockname truncated address"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ), "getting socktype"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ), "invalid argument"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ), "invalid socket"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ), "in use"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "length too long"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ), "listen v6 only"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(142) & 0X7FFFFF)) ),
    "lookup returned nothing"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "malformed host or service"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ), "nbio connect error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ),
    "no accept addr or service specified"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "no hostname or service specified"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "no port defined"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ), "no such file"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ), "port mismatch"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ), "tfo disabled"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "tfo no kernel support"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "transfer error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "transfer timeout"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "unable to bind socket"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "unable to create socket"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ),
    "unable to keepalive"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "unable to listen socket"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ), "unable to nodelay"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ),
    "unable to reuseaddr"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "unable to tfo"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(145) & 0X7FFFFF)) ),
    "unavailable ip family"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "uninitialized"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(140) & 0X7FFFFF)) ), "unknown info type"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(146) & 0X7FFFFF)) ),
    "unsupported ip family"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ), "unsupported method"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "unsupported protocol family"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "write to read only BIO"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ), "WSAStartup"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
     "local address not available"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(151) & 0X7FFFFF)) ),
     "peer address not available"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
     "non-fatal or transient error"},
    {( (((unsigned long)(32) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ),
     "port mismatch"},
    {0, 
# 87 "../crypto/bio/bio_err.c" 3 4
       ((void *)0)
# 87 "../crypto/bio/bio_err.c"
           }
};
...
int ossl_err_load_BIO_strings(void)
{
    ...
    if (ERR_reason_error_string(BIO_str_reasons[0].error) == 
# 95 "../crypto/bio/bio_err.c" 3 4
                                                            ((void *)0)
# 95 "../crypto/bio/bio_err.c"
                                                                )
...
{
    if ((((errcode) & ((unsigned int)0x7fffffff 
# 105 "../crypto/bio/bio_err.c"
       + 1)) != 0))
        return BIO_sock_non_fatal_error(ERR_GET_REASON(errcode));
    else if (ERR_GET_LIB(errcode) == 32
             && ERR_GET_REASON(errcode) == 112)
        return 1;
    else
        return 0;
}
