# 0 "../crypto/bio/bio_addr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_addr.c"
# 24 "../crypto/bio/bio_addr.c"
...
# 34 "../crypto/bio/bio_addr.c" 2

CRYPTO_RWLOCK *bio_lookup_lock;
static CRYPTO_ONCE bio_lookup_init = 
# 36 "../crypto/bio/bio_addr.c" 3 4
                                    0
# 36 "../crypto/bio/bio_addr.c"
                                                           ;
# 52 "../crypto/bio/bio_addr.c"
BIO_ADDR *BIO_ADDR_new(void)
{
    BIO_ADDR *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/bio/bio_addr.c", 54);

    if (ret == 
# 56 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 56 "../crypto/bio/bio_addr.c"
                  )
        return 
# 57 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 57 "../crypto/bio/bio_addr.c"
                  ;

    ret->sa.sa_family = 
# 59 "../crypto/bio/bio_addr.c" 3 4
                       0
# 59 "../crypto/bio/bio_addr.c"
                                ;
    return ret;
}
...
{
    CRYPTO_free(ap, "../crypto/bio/bio_addr.c", 65);
}

int BIO_ADDR_copy(BIO_ADDR *dst, const BIO_ADDR *src)
{
    if (dst == 
# 70 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0) 
# 70 "../crypto/bio/bio_addr.c"
                   || src == 
# 70 "../crypto/bio/bio_addr.c" 3 4
                             ((void *)0)
# 70 "../crypto/bio/bio_addr.c"
    ...
    if (src->sa.sa_family == 
# 73 "../crypto/bio/bio_addr.c" 3 4
                            0
# 73 "../crypto/bio/bio_addr.c"
                                     ) {
        BIO_ADDR_clear(dst);
        return 1;
    }
...
{
    BIO_ADDR *ret = 
# 83 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 83 "../crypto/bio/bio_addr.c"
                       ;

    if (ap != 
# 85 "../crypto/bio/bio_addr.c" 3 4
             ((void *)0)
# 85 "../crypto/bio/bio_addr.c"
                 ) {
        ret = BIO_ADDR_new();
        if (ret != 
# 87 "../crypto/bio/bio_addr.c" 3 4
                  ((void *)0) 
# 87 "../crypto/bio/bio_addr.c"
                       && !BIO_ADDR_copy(ret, ap)) {
            BIO_ADDR_free(ret);
            ret = 
# 89 "../crypto/bio/bio_addr.c" 3 4
                 ((void *)0)
# 89 "../crypto/bio/bio_addr.c"
                     ;
        }
    }
    return ret;
...
void BIO_ADDR_clear(BIO_ADDR *ap)
{
    ...
    ap->sa.sa_family = 
# 98 "../crypto/bio/bio_addr.c" 3 4
                      0
# 98 "../crypto/bio/bio_addr.c"
                               ;
}
...
int BIO_ADDR_make(BIO_ADDR *ap, const struct sockaddr *sa)
{
    ...
    if (sa->sa_family == 
# 108 "../crypto/bio/bio_addr.c" 3 4
                        2
# 108 "../crypto/bio/bio_addr.c"
                               ) {
    ...
    if (sa->sa_family == 
# 113 "../crypto/bio/bio_addr.c" 3 4
                        10
# 113 "../crypto/bio/bio_addr.c"
                                ) {
    ...
    if (sa->sa_family == 
# 119 "../crypto/bio/bio_addr.c" 3 4
                        1
# 119 "../crypto/bio/bio_addr.c"
                               ) {
                     ...
                     unsigned short port)
{
    ...
    if (family == 
# 133 "../crypto/bio/bio_addr.c" 3 4
                 1
# 133 "../crypto/bio/bio_addr.c"
                        ) {
    ...
    if (family == 
# 142 "../crypto/bio/bio_addr.c" 3 4
                 2
# 142 "../crypto/bio/bio_addr.c"
                        ) {
    ...
    if (family == 
# 152 "../crypto/bio/bio_addr.c" 3 4
                 10
# 152 "../crypto/bio/bio_addr.c"
                         ) {
...
int BIO_ADDR_rawaddress(const BIO_ADDR *ap, void *p, size_t *l)
{
    size_t len = 0;
    const void *addrptr = 
# 174 "../crypto/bio/bio_addr.c" 3 4
                         ((void *)0)
# 174 "../crypto/bio/bio_addr.c"
                             ;

    if (ap->sa.sa_family == 
# 176 "../crypto/bio/bio_addr.c" 3 4
                           2
# 176 "../crypto/bio/bio_addr.c"
                                  ) {
        len = sizeof(ap->s_in.sin_addr);
        addrptr = &ap->s_in.sin_addr;
    }

    else if (ap->sa.sa_family == 
# 181 "../crypto/bio/bio_addr.c" 3 4
                                10
# 181 "../crypto/bio/bio_addr.c"
                                        ) {
...
# 187 "../crypto/bio/bio_addr.c" 3 4
                                1
# 187 "../crypto/bio/bio_addr.c"
                                       ) {
    ...
    if (addrptr == 
# 193 "../crypto/bio/bio_addr.c" 3 4
                  ((void *)0)
# 193 "../crypto/bio/bio_addr.c"
                      )
        return 0;

    if (p != 
# 196 "../crypto/bio/bio_addr.c" 3 4
            ((void *)0)
# 196 "../crypto/bio/bio_addr.c"
                ) {
        memcpy(p, addrptr, len);
    }
    if (l != 
# 199 "../crypto/bio/bio_addr.c" 3 4
            ((void *)0)
# 199 "../crypto/bio/bio_addr.c"
                )
        *l = len;
...
{
    if (ap->sa.sa_family == 
# 207 "../crypto/bio/bio_addr.c" 3 4
                           2
# 207 "../crypto/bio/bio_addr.c"
                                  )
        return ap->s_in.sin_port;

    if (ap->sa.sa_family == 
# 210 "../crypto/bio/bio_addr.c" 3 4
                           10
# 210 "../crypto/bio/bio_addr.c"
                                   )
        return ap->s_in6.sin6_port;

    return 0;
}
# 229 "../crypto/bio/bio_addr.c"
                        ...
                        char **hostname, char **service)
{
    ...
    if (1) {
        ...
        int ret = 0;
        char host[
# 238 "../crypto/bio/bio_addr.c" 3 4
                 1025
# 238 "../crypto/bio/bio_addr.c"
                           ] = "", serv[
# 238 "../crypto/bio/bio_addr.c" 3 4
                                        32
# 238 "../crypto/bio/bio_addr.c"
        ...
        if (numeric)
            flags |= 
# 242 "../crypto/bio/bio_addr.c" 3 4
                    1 
# 242 "../crypto/bio/bio_addr.c"
                                   | 
# 242 "../crypto/bio/bio_addr.c" 3 4
                                     2
# 242 "../crypto/bio/bio_addr.c"
        ...
        if ((ret = getnameinfo(BIO_ADDR_sockaddr(ap),
            ...
            if (ret == 
# 249 "../crypto/bio/bio_addr.c" 3 4
                      -11
# 249 "../crypto/bio/bio_addr.c"
                                ) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",250,__func__), ERR_set_error)(2, 
# 250 "../crypto/bio/bio_addr.c" 3 4
                                           (*__errno_location ())
# 250 "../crypto/bio/bio_addr.c"
                                                                  ,
                               "calling getnameinfo()");
            } else

            {
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",255,__func__), ERR_set_error)(32, (2 | (0x2 << 18L)), gai_strerror(ret));
            }
            return 0;
        }
        ...
        if (hostname != 
# 271 "../crypto/bio/bio_addr.c" 3 4
                       ((void *)0)
# 271 "../crypto/bio/bio_addr.c"
                           )
            *hostname = CRYPTO_strdup(host, "../crypto/bio/bio_addr.c", 272);
        if (service != 
# 273 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 273 "../crypto/bio/bio_addr.c"
                          )
            *service = CRYPTO_strdup(serv, "../crypto/bio/bio_addr.c", 274);
    } else {

        if (hostname != 
# 277 "../crypto/bio/bio_addr.c" 3 4
                       ((void *)0)
# 277 "../crypto/bio/bio_addr.c"
                           )
            *hostname = CRYPTO_strdup(inet_ntoa(ap->s_in.sin_addr), "../crypto/bio/bio_addr.c", 278);
        if (service != 
# 279 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 279 "../crypto/bio/bio_addr.c"
                          ) {
            char serv[6];
            BIO_snprintf(serv, sizeof(serv), "%d", ntohs(ap->s_in.sin_port));
            *service = CRYPTO_strdup(serv, "../crypto/bio/bio_addr.c", 282);
        }
    }

    if ((hostname != 
# 286 "../crypto/bio/bio_addr.c" 3 4
                    ((void *)0) 
# 286 "../crypto/bio/bio_addr.c"
                         && *hostname == 
# 286 "../crypto/bio/bio_addr.c" 3 4
                                         ((void *)0)
# 286 "../crypto/bio/bio_addr.c"
            ...
            || (service != 
# 287 "../crypto/bio/bio_addr.c" 3 4
                          ((void *)0) 
# 287 "../crypto/bio/bio_addr.c"
                               && *service == 
# 287 "../crypto/bio/bio_addr.c" 3 4
                                              ((void *)0)
# 287 "../crypto/bio/bio_addr.c"
        ...
        if (hostname != 
# 288 "../crypto/bio/bio_addr.c" 3 4
                       ((void *)0)
# 288 "../crypto/bio/bio_addr.c"
                           ) {
            CRYPTO_free(*hostname, "../crypto/bio/bio_addr.c", 289);
            *hostname = 
# 290 "../crypto/bio/bio_addr.c" 3 4
                       ((void *)0)
# 290 "../crypto/bio/bio_addr.c"
                           ;
        }
        if (service != 
# 292 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 292 "../crypto/bio/bio_addr.c"
                          ) {
            CRYPTO_free(*service, "../crypto/bio/bio_addr.c", 293);
            *service = 
# 294 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 294 "../crypto/bio/bio_addr.c"
                          ;
        }
        return 0;
    }
...
{
    char *hostname = 
# 304 "../crypto/bio/bio_addr.c" 3 4
                    ((void *)0)
# 304 "../crypto/bio/bio_addr.c"
                        ;

    if (addr_strings(ap, numeric, &hostname, 
# 306 "../crypto/bio/bio_addr.c" 3 4
                                            ((void *)0)
# 306 "../crypto/bio/bio_addr.c"
                                                ))
        return hostname;

    return 
# 309 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 309 "../crypto/bio/bio_addr.c"
              ;
}
...
{
    char *service = 
# 314 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 314 "../crypto/bio/bio_addr.c"
                       ;

    if (addr_strings(ap, numeric, 
# 316 "../crypto/bio/bio_addr.c" 3 4
                                 ((void *)0)
# 316 "../crypto/bio/bio_addr.c"
                                     , &service))
        return service;

    return 
# 319 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 319 "../crypto/bio/bio_addr.c"
              ;
}
...
char *BIO_ADDR_path_string(const BIO_ADDR *ap)
{
    ...
    if (ap->sa.sa_family == 
# 325 "../crypto/bio/bio_addr.c" 3 4
                           1
# 325 "../crypto/bio/bio_addr.c"
                                  )
        return CRYPTO_strdup(ap->s_un.sun_path, "../crypto/bio/bio_addr.c", 326);

    return 
# 328 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 328 "../crypto/bio/bio_addr.c"
              ;
}
...
{
    if (ap->sa.sa_family == 
# 360 "../crypto/bio/bio_addr.c" 3 4
                           2
# 360 "../crypto/bio/bio_addr.c"
                                  )
        return sizeof(ap->s_in);

    if (ap->sa.sa_family == 
# 363 "../crypto/bio/bio_addr.c" 3 4
                           10
# 363 "../crypto/bio/bio_addr.c"
                                   )
        return sizeof(ap->s_in6);


    if (ap->sa.sa_family == 
# 367 "../crypto/bio/bio_addr.c" 3 4
                           1
# 367 "../crypto/bio/bio_addr.c"
                                  )
...
{
    if (bai != 
# 381 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 381 "../crypto/bio/bio_addr.c"
                  )
        return bai->ai_next;
    return 
# 383 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 383 "../crypto/bio/bio_addr.c"
              ;
}
...
{
    if (bai != 
# 388 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 388 "../crypto/bio/bio_addr.c"
                  )
...
{
    if (bai != 
# 395 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 395 "../crypto/bio/bio_addr.c"
                  )
...
{
    if (bai != 
# 402 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 402 "../crypto/bio/bio_addr.c"
                  ) {
        ...
        if (bai->ai_family == 
# 407 "../crypto/bio/bio_addr.c" 3 4
                              1
# 407 "../crypto/bio/bio_addr.c"
                                     )
            return 0;
        ...
        case 
# 412 "../crypto/bio/bio_addr.c" 3 4
            SOCK_STREAM
# 412 "../crypto/bio/bio_addr.c"
                       :
            return 
# 413 "../crypto/bio/bio_addr.c" 3 4
                  IPPROTO_TCP
# 413 "../crypto/bio/bio_addr.c"
                             ;
        case 
# 414 "../crypto/bio/bio_addr.c" 3 4
            SOCK_DGRAM
# 414 "../crypto/bio/bio_addr.c"
                      :
            return 
# 415 "../crypto/bio/bio_addr.c" 3 4
                  IPPROTO_UDP
# 415 "../crypto/bio/bio_addr.c"
                             ;
        default:
            break;
        }
...
{
    if (bai != 
# 429 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 429 "../crypto/bio/bio_addr.c"
                  )
...
{
    if (bai != 
# 440 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 440 "../crypto/bio/bio_addr.c"
                  )
        return bai->ai_addr;
    return 
# 442 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 442 "../crypto/bio/bio_addr.c"
              ;
}
...
{
    if (bai != 
# 447 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 447 "../crypto/bio/bio_addr.c"
                  )
        return (BIO_ADDR *)bai->ai_addr;
    return 
# 449 "../crypto/bio/bio_addr.c" 3 4
          ((void *)0)
# 449 "../crypto/bio/bio_addr.c"
              ;
}
...
{
    if (bai == 
# 454 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 454 "../crypto/bio/bio_addr.c"
                  )
        return;
    ...
    if (bai->ai_family != 
# 463 "../crypto/bio/bio_addr.c" 3 4
       1
# 463 "../crypto/bio/bio_addr.c"
            ) {
        freeaddrinfo(bai);
        return;
    }
    ...
    while (bai != 
# 472 "../crypto/bio/bio_addr.c" 3 4
                 ((void *)0)
# 472 "../crypto/bio/bio_addr.c"
                     ) {
        BIO_ADDRINFO *next = bai->ai_next;
        CRYPTO_free(bai->ai_addr, "../crypto/bio/bio_addr.c", 474);
        CRYPTO_free(bai, "../crypto/bio/bio_addr.c", 475);
        bai = next;
    }
}
# 505 "../crypto/bio/bio_addr.c"
int BIO_parse_hostserv(const char *hostserv, char **host, char **service,
                       enum BIO_hostserv_priorities hostserv_prio)
{
    const char *h = 
# 508 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 508 "../crypto/bio/bio_addr.c"
                       ; size_t hl = 0;
    const char *p = 
# 509 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 509 "../crypto/bio/bio_addr.c"
                       ; size_t pl = 0;

    if (*hostserv == '[') {
        if ((p = strchr(hostserv, ']')) == 
# 512 "../crypto/bio/bio_addr.c" 3 4
                                          ((void *)0)
# 512 "../crypto/bio/bio_addr.c"
                                              )
            goto spec_err;
        h = hostserv + 1;
        hl = p - h;
        ...
        if (*p == '\0')
            p = 
# 518 "../crypto/bio/bio_addr.c" 3 4
               ((void *)0)
# 518 "../crypto/bio/bio_addr.c"
                   ;
        else if (*p != ':')
            goto spec_err;
        else {
        ...
        p = strchr(hostserv, ':');
# 539 "../crypto/bio/bio_addr.c"
        if (p != p2)
            goto amb_err;

        if (p != 
# 542 "../crypto/bio/bio_addr.c" 3 4
                ((void *)0)
# 542 "../crypto/bio/bio_addr.c"
                    ) {
            h = hostserv;
            hl = p - h;
            p++;
    ...
    if (p != 
# 556 "../crypto/bio/bio_addr.c" 3 4
            ((void *)0) 
# 556 "../crypto/bio/bio_addr.c"
                 && strchr(p, ':'))
        goto spec_err;

    if (h != 
# 559 "../crypto/bio/bio_addr.c" 3 4
            ((void *)0) 
# 559 "../crypto/bio/bio_addr.c"
                 && host != 
# 559 "../crypto/bio/bio_addr.c" 3 4
                            ((void *)0)
# 559 "../crypto/bio/bio_addr.c"
        ...
        if (hl == 0
            || (hl == 1 && h[0] == '*')) {
            *host = 
# 562 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 562 "../crypto/bio/bio_addr.c"
                       ;
        } else {
            *host = CRYPTO_strndup(h, hl, "../crypto/bio/bio_addr.c", 564);
            if (*host == 
# 565 "../crypto/bio/bio_addr.c" 3 4
                        ((void *)0)
# 565 "../crypto/bio/bio_addr.c"
                            )
                return 0;
        }
    }
    if (p != 
# 569 "../crypto/bio/bio_addr.c" 3 4
            ((void *)0) 
# 569 "../crypto/bio/bio_addr.c"
                 && service != 
# 569 "../crypto/bio/bio_addr.c" 3 4
                               ((void *)0)
# 569 "../crypto/bio/bio_addr.c"
        ...
        if (pl == 0
            || (pl == 1 && p[0] == '*')) {
            *service = 
# 572 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 572 "../crypto/bio/bio_addr.c"
                          ;
        } else {
            *service = CRYPTO_strndup(p, pl, "../crypto/bio/bio_addr.c", 574);
            if (*service == 
# 575 "../crypto/bio/bio_addr.c" 3 4
                           ((void *)0)
# 575 "../crypto/bio/bio_addr.c"
                               ) {
                if (h != 
# 576 "../crypto/bio/bio_addr.c" 3 4
                        ((void *)0) 
# 576 "../crypto/bio/bio_addr.c"
                             && host != 
# 576 "../crypto/bio/bio_addr.c" 3 4
                                        ((void *)0)
# 576 "../crypto/bio/bio_addr.c"
                                            ) {
                    CRYPTO_free(*host, "../crypto/bio/bio_addr.c", 577);
                    *host = 
# 578 "../crypto/bio/bio_addr.c" 3 4
                           ((void *)0)
# 578 "../crypto/bio/bio_addr.c"
                               ;
                }
                return 0;
            }
    ...
    return 1;
 amb_err:
    (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",587,__func__), ERR_set_error)((32),(129),
# 587 "../crypto/bio/bio_addr.c" 3 4
   ((void *)0)
# 587 "../crypto/bio/bio_addr.c"
   );
    return 0;
 spec_err:
    (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",590,__func__), ERR_set_error)((32),(130),
# 590 "../crypto/bio/bio_addr.c" 3 4
   ((void *)0)
# 590 "../crypto/bio/bio_addr.c"
   );
    return 0;
}
# 603 "../crypto/bio/bio_addr.c"
static int addrinfo_wrap(int family, int socktype,
                         const void *where, size_t wherelen,
                         unsigned short port,
                         BIO_ADDRINFO **bai)
{
    if ((*bai = CRYPTO_zalloc(sizeof(**bai), "../crypto/bio/bio_addr.c", 608)) == 
# 608 "../crypto/bio/bio_addr.c" 3 4
                                                 ((void *)0)
# 608 "../crypto/bio/bio_addr.c"
                                                     )
        return 0;
    ...
    if (socktype == 
# 613 "../crypto/bio/bio_addr.c" 3 4
                   SOCK_STREAM
# 613 "../crypto/bio/bio_addr.c"
                              )
        (*bai)->ai_protocol = 
# 614 "../crypto/bio/bio_addr.c" 3 4
                              IPPROTO_TCP
# 614 "../crypto/bio/bio_addr.c"
                                         ;
    if (socktype == 
# 615 "../crypto/bio/bio_addr.c" 3 4
                   SOCK_DGRAM
# 615 "../crypto/bio/bio_addr.c"
                             )
        (*bai)->ai_protocol = 
# 616 "../crypto/bio/bio_addr.c" 3 4
                              IPPROTO_UDP
# 616 "../crypto/bio/bio_addr.c"
                                         ;

    if (family == 
# 618 "../crypto/bio/bio_addr.c" 3 4
                 1
# 618 "../crypto/bio/bio_addr.c"
                        )
        (*bai)->ai_protocol = 0;

    {
        ...
        if (addr != 
# 628 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 628 "../crypto/bio/bio_addr.c"
                       ) {
    ...
    (*bai)->ai_next = 
# 633 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 633 "../crypto/bio/bio_addr.c"
                          ;
    if ((*bai)->ai_addr == 
# 634 "../crypto/bio/bio_addr.c" 3 4
                           ((void *)0)
# 634 "../crypto/bio/bio_addr.c"
                               ) {
        BIO_ADDRINFO_free(*bai);
        *bai = 
# 636 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 636 "../crypto/bio/bio_addr.c"
                  ;
        return 0;
    }
    return 1;
...
static int do_bio_lookup_init(void); static int do_bio_lookup_init_ossl_ret_ = 0; static void do_bio_lookup_init_ossl_(void) { do_bio_lookup_init_ossl_ret_ = do_bio_lookup_init(); } static int do_bio_lookup_init(void)
{
    ...
    return bio_lookup_lock != 
# 645 "../crypto/bio/bio_addr.c" 3 4
                             ((void *)0)
# 645 "../crypto/bio/bio_addr.c"
                                 ;
}
                  ...
                  int family, int socktype, int protocol, BIO_ADDRINFO **res)
{
    ...
    switch (family) {
    case 
# 683 "../crypto/bio/bio_addr.c" 3 4
        2
# 683 "../crypto/bio/bio_addr.c"
               :

    case 
# 685 "../crypto/bio/bio_addr.c" 3 4
        10
# 685 "../crypto/bio/bio_addr.c"
                :


    case 
# 688 "../crypto/bio/bio_addr.c" 3 4
        1
# 688 "../crypto/bio/bio_addr.c"
               :


    case 
# 691 "../crypto/bio/bio_addr.c" 3 4
        0
# 691 "../crypto/bio/bio_addr.c"
                 :

        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",695,__func__), ERR_set_error)((32),(131),
# 695 "../crypto/bio/bio_addr.c" 3 4
       ((void *)0)
# 695 "../crypto/bio/bio_addr.c"
       );
        return 0;
    }
    ...
    if (family == 
# 700 "../crypto/bio/bio_addr.c" 3 4
                 1
# 700 "../crypto/bio/bio_addr.c"
                        ) {
        if (addrinfo_wrap(family, socktype, host, strlen(host), 0, res))
            return 1;
        else
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",704,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 704 "../crypto/bio/bio_addr.c" 3 4
           ((void *)0)
# 704 "../crypto/bio/bio_addr.c"
           );
        return 0;
    }
    ...
    if (1) {
        ...
        if (host != 
# 724 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0) 
# 724 "../crypto/bio/bio_addr.c"
                        && family == 
# 724 "../crypto/bio/bio_addr.c" 3 4
                                     0
# 724 "../crypto/bio/bio_addr.c"
            ...
            hints.ai_flags |= 
# 726 "../crypto/bio/bio_addr.c" 3 4
                             0x0020
# 726 "../crypto/bio/bio_addr.c"
                                          ;


        if (lookup_type == BIO_LOOKUP_SERVER)
            hints.ai_flags |= 
# 730 "../crypto/bio/bio_addr.c" 3 4
                             0x0001
# 730 "../crypto/bio/bio_addr.c"
                                       ;
      ...
      retry:
        ...
        case 
# 740 "../crypto/bio/bio_addr.c" 3 4
            -11
# 740 "../crypto/bio/bio_addr.c"
                      :
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",741,__func__), ERR_set_error)(2, 
# 741 "../crypto/bio/bio_addr.c" 3 4
                                       (*__errno_location ())
# 741 "../crypto/bio/bio_addr.c"
                                                              ,
                           "calling getaddrinfo()");
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",743,__func__), ERR_set_error)((32),((2 | (0x2 << 18L))),
# 743 "../crypto/bio/bio_addr.c" 3 4
           ((void *)0)
# 743 "../crypto/bio/bio_addr.c"
           );
            break;


        case 
# 747 "../crypto/bio/bio_addr.c" 3 4
            -10
# 747 "../crypto/bio/bio_addr.c"
                      :
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",748,__func__), ERR_set_error)(32, (2 | (0x2 << 18L)),
        ...
        default:
            ...
            if (hints.ai_flags & 
# 757 "../crypto/bio/bio_addr.c" 3 4
                                0x0020
# 757 "../crypto/bio/bio_addr.c"
                                             ) {
                hints.ai_flags &= ~
# 758 "../crypto/bio/bio_addr.c" 3 4
                                  0x0020
# 758 "../crypto/bio/bio_addr.c"
                                               ;
                hints.ai_flags |= 
# 759 "../crypto/bio/bio_addr.c" 3 4
                                 0x0004
# 759 "../crypto/bio/bio_addr.c"
                                               ;
                old_ret = gai_ret;
                goto retry;
            }

            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",764,__func__), ERR_set_error)(32, (2 | (0x2 << 18L)),
                           gai_strerror(old_ret ? old_ret : gai_ret));
            break;
        }
    } else {
...
# 786 "../crypto/bio/bio_addr.c"
        static in_addr_t he_fallback_address;
        static const char *he_fallback_addresses[] =
            { (char *)&he_fallback_address, 
# 788 "../crypto/bio/bio_addr.c" 3 4
                                           ((void *)0) 
# 788 "../crypto/bio/bio_addr.c"
                                                };

        static const struct hostent he_fallback =
            { 
# 791 "../crypto/bio/bio_addr.c" 3 4
             ((void *)0)
# 791 "../crypto/bio/bio_addr.c"
                 , 
# 791 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 791 "../crypto/bio/bio_addr.c"
...
# 791 "../crypto/bio/bio_addr.c"
        ...
        struct servent se_fallback = { 
# 802 "../crypto/bio/bio_addr.c" 3 4
                                      ((void *)0)
# 802 "../crypto/bio/bio_addr.c"
                                          , 
# 802 "../crypto/bio/bio_addr.c" 3 4
                                            ((void *)0)
# 802 "../crypto/bio/bio_addr.c"
...
# 802 "../crypto/bio/bio_addr.c"
        ...
        if (!(CRYPTO_THREAD_run_once(&bio_lookup_init, do_bio_lookup_init_ossl_) ? do_bio_lookup_init_ossl_ret_ : 0)) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",807,__func__), ERR_set_error)((32),((15 | (0x2 << 18L))),
# 807 "../crypto/bio/bio_addr.c" 3 4
           ((void *)0)
# 807 "../crypto/bio/bio_addr.c"
           );
            return 0;
        }
        ...
        he_fallback_address = 
# 814 "../crypto/bio/bio_addr.c" 3 4
                             ((in_addr_t) 0x00000000)
# 814 "../crypto/bio/bio_addr.c"
                                       ;
        if (host == 
# 815 "../crypto/bio/bio_addr.c" 3 4
                   ((void *)0)
# 815 "../crypto/bio/bio_addr.c"
                       ) {
            he = &he_fallback;
            switch (lookup_type) {
            case BIO_LOOKUP_CLIENT:
                he_fallback_address = 
# 819 "../crypto/bio/bio_addr.c" 3 4
                                     ((in_addr_t) 0x7f000001)
# 819 "../crypto/bio/bio_addr.c"
                                                    ;
                break;
            case BIO_LOOKUP_SERVER:
                he_fallback_address = 
# 822 "../crypto/bio/bio_addr.c" 3 4
                                     ((in_addr_t) 0x00000000)
# 822 "../crypto/bio/bio_addr.c"
                                               ;
                break;
            default:

                
# 826 "../crypto/bio/bio_addr.c" 3 4
               ((void) (0))
# 826 "../crypto/bio/bio_addr.c"
                                                                   ;
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",827,__func__), ERR_set_error)((32),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 827 "../crypto/bio/bio_addr.c" 3 4
               ((void *)0)
# 827 "../crypto/bio/bio_addr.c"
               );
                ret = 0;
                goto err;
            }
            ...
            if (he == 
# 834 "../crypto/bio/bio_addr.c" 3 4
                     ((void *)0)
# 834 "../crypto/bio/bio_addr.c"
                         ) {
# 852 "../crypto/bio/bio_addr.c"
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",852,__func__), ERR_set_error)(2, 1000 + 
# 852 "../crypto/bio/bio_addr.c" 3 4
                                                  (*__h_errno_location ())
# 852 "../crypto/bio/bio_addr.c"
                                                         ,
        ...
        if (service == 
# 864 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 864 "../crypto/bio/bio_addr.c"
                          ) {
            se_fallback.s_port = 0;
            se_fallback.s_proto = 
# 866 "../crypto/bio/bio_addr.c" 3 4
                                 ((void *)0)
# 866 "../crypto/bio/bio_addr.c"
                                     ;
            se = &se_fallback;
        } else {
            char *endp = 
# 869 "../crypto/bio/bio_addr.c" 3 4
                        ((void *)0)
# 869 "../crypto/bio/bio_addr.c"
                            ;
            long portnum = strtol(service, &endp, 10);
# 880 "../crypto/bio/bio_addr.c"
            char *proto = 
# 880 "../crypto/bio/bio_addr.c" 3 4
                         ((void *)0)
# 880 "../crypto/bio/bio_addr.c"
                             ;
            ...
            switch (socktype) {
            case 
# 886 "../crypto/bio/bio_addr.c" 3 4
                SOCK_STREAM
# 886 "../crypto/bio/bio_addr.c"
                           :
                proto = "tcp";
                break;
            case 
# 889 "../crypto/bio/bio_addr.c" 3 4
                SOCK_DGRAM
# 889 "../crypto/bio/bio_addr.c"
                          :
                proto = "udp";
                break;
            }
            ...
            if (endp != service && *endp == '\0'
                ...
                if (se == 
# 902 "../crypto/bio/bio_addr.c" 3 4
                         ((void *)0)
# 902 "../crypto/bio/bio_addr.c"
                             ) {
                    (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",903,__func__), ERR_set_error)(2, 
# 903 "../crypto/bio/bio_addr.c" 3 4
                                               (*__errno_location ())
# 903 "../crypto/bio/bio_addr.c"
                                                                      ,
                                   "calling getservbyname()");
                    goto err;
                }
            } else {
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",908,__func__), ERR_set_error)((32),(130),
# 908 "../crypto/bio/bio_addr.c" 3 4
               ((void *)0)
# 908 "../crypto/bio/bio_addr.c"
               );
                goto err;
            }
        }
        ...
        *res = 
# 913 "../crypto/bio/bio_addr.c" 3 4
              ((void *)0)
# 913 "../crypto/bio/bio_addr.c"
                  ;

        {
# 925 "../crypto/bio/bio_addr.c"
            char **addrlistp;



            size_t addresses;
            BIO_ADDRINFO *tmp_bai = 
# 930 "../crypto/bio/bio_addr.c" 3 4
                                   ((void *)0)
# 930 "../crypto/bio/bio_addr.c"
                                       ;



            for (addrlistp = he->h_addr_list; *addrlistp != 
# 934 "../crypto/bio/bio_addr.c" 3 4
                                                           ((void *)0)
# 934 "../crypto/bio/bio_addr.c"
                                                               ;
                 addrlistp++)
                ;
            ...
            for (addresses = addrlistp - he->h_addr_list;
             ...
             addrinfo_wrap_err:
                ...
                *res = 
# 949 "../crypto/bio/bio_addr.c" 3 4
                      ((void *)0)
# 949 "../crypto/bio/bio_addr.c"
                          ;
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_addr.c",950,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 950 "../crypto/bio/bio_addr.c" 3 4
               ((void *)0)
# 950 "../crypto/bio/bio_addr.c"
               );
                ret = 0;
                goto err;
            }
