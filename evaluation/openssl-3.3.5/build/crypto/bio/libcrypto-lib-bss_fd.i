# 0 "../crypto/bio/bss_fd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_fd.c"
# 10 "../crypto/bio/bss_fd.c"
...
# 14 "../crypto/bio/bss_fd.c" 2
# 51 "../crypto/bio/bss_fd.c"
...
# 72 "../crypto/bio/bss_fd.c" 3 4
   ((void *)0)
# 72 "../crypto/bio/bss_fd.c"
       ,
};
...
BIO *BIO_new_fd(int fd, int close_flag)
{
    ...
    if (ret == 
# 84 "../crypto/bio/bss_fd.c" 3 4
              ((void *)0)
# 84 "../crypto/bio/bss_fd.c"
                  )
        return 
# 85 "../crypto/bio/bss_fd.c" 3 4
              ((void *)0)
# 85 "../crypto/bio/bss_fd.c"
                  ;
...
static int fd_new(BIO *bi)
{
    ...
    bi->num = -1;
    bi->ptr = 
# 94 "../crypto/bio/bss_fd.c" 3 4
             ((void *)0)
# 94 "../crypto/bio/bss_fd.c"
                 ;
    bi->flags = 0;
    return 1;
}
...
{
    if (a == 
# 101 "../crypto/bio/bss_fd.c" 3 4
            ((void *)0)
# 101 "../crypto/bio/bss_fd.c"
                )
        return 0;
    if (a->shutdown) {
        if (a->init) {
...
static int fd_read(BIO *b, char *out, int outl)
{
    ...
    if (out != 
# 117 "../crypto/bio/bss_fd.c" 3 4
              ((void *)0)
# 117 "../crypto/bio/bss_fd.c"
                  ) {
        
# 118 "../crypto/bio/bss_fd.c" 3 4
       (*__errno_location ())
# 118 "../crypto/bio/bss_fd.c"
       =0;
...
# 134 "../crypto/bio/bss_fd.c" 3 4
   (*__errno_location ())
# 134 "../crypto/bio/bss_fd.c"
   =0;
...
static long fd_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 105:
        if (b->init) {
            ip = (int *)ptr;
            if (ip != 
# 169 "../crypto/bio/bss_fd.c" 3 4
                     ((void *)0)
# 169 "../crypto/bio/bss_fd.c"
                         )
                *ip = b->num;
            ret = b->num;
        } else
...
int BIO_fd_should_retry(int i)
{
    ...
    if ((i == 0) || (i == -1)) {
        err = 
# 231 "../crypto/bio/bss_fd.c" 3 4
             (*__errno_location ())
# 231 "../crypto/bio/bss_fd.c"
                                 ;
...
int BIO_fd_non_fatal_error(int err)
{
    ...
    case 
# 248 "../crypto/bio/bss_fd.c" 3 4
        11
# 248 "../crypto/bio/bss_fd.c"
                   :
    ...
    case 
# 253 "../crypto/bio/bss_fd.c" 3 4
        107
# 253 "../crypto/bio/bss_fd.c"
                :



    case 
# 257 "../crypto/bio/bss_fd.c" 3 4
        4
# 257 "../crypto/bio/bss_fd.c"
             :
# 267 "../crypto/bio/bss_fd.c"
    case 
# 267 "../crypto/bio/bss_fd.c" 3 4
        71
# 267 "../crypto/bio/bss_fd.c"
              :
    ...
    case 
# 271 "../crypto/bio/bss_fd.c" 3 4
        115
# 271 "../crypto/bio/bss_fd.c"
                   :



    case 
# 275 "../crypto/bio/bss_fd.c" 3 4
        114
# 275 "../crypto/bio/bss_fd.c"
                :
