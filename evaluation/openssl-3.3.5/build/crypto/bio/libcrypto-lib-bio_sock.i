# 0 "../crypto/bio/bio_sock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bio_sock.c"
# 10 "../crypto/bio/bio_sock.c"
...
# 13 "../crypto/bio/bio_sock.c" 2
# 43 "../crypto/bio/bio_sock.c"
int BIO_get_host_ip(const char *str, unsigned char *ip)
{
    BIO_ADDRINFO *res = 
# 45 "../crypto/bio/bio_sock.c" 3 4
                       ((void *)0)
# 45 "../crypto/bio/bio_sock.c"
                           ;
    int ret = 0;
    ...
    if (BIO_lookup(str, 
# 51 "../crypto/bio/bio_sock.c" 3 4
                       ((void *)0)
# 51 "../crypto/bio/bio_sock.c"
                           , BIO_LOOKUP_CLIENT, 
# 51 "../crypto/bio/bio_sock.c" 3 4
                                                2
# 51 "../crypto/bio/bio_sock.c"
...
# 51 "../crypto/bio/bio_sock.c"
        ...
        if (BIO_ADDRINFO_family(res) != 
# 54 "../crypto/bio/bio_sock.c" 3 4
                                       2
# 54 "../crypto/bio/bio_sock.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",55,__func__), ERR_set_error)((32),(107),
# 55 "../crypto/bio/bio_sock.c" 3 4
           ((void *)0)
# 55 "../crypto/bio/bio_sock.c"
           );
        } else if (BIO_ADDR_rawaddress(BIO_ADDRINFO_address(res), 
# 56 "../crypto/bio/bio_sock.c" 3 4
                                                                 ((void *)0)
# 56 "../crypto/bio/bio_sock.c"
                                                                     , &l)) {
...
{
    BIO_ADDRINFO *res = 
# 74 "../crypto/bio/bio_sock.c" 3 4
                       ((void *)0)
# 74 "../crypto/bio/bio_sock.c"
                           ;
    int ret = 0;

    if (str == 
# 77 "../crypto/bio/bio_sock.c" 3 4
              ((void *)0)
# 77 "../crypto/bio/bio_sock.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",78,__func__), ERR_set_error)((32),(113),
# 78 "../crypto/bio/bio_sock.c" 3 4
       ((void *)0)
# 78 "../crypto/bio/bio_sock.c"
       );
        return 0;
    }
    ...
    if (BIO_lookup(
# 85 "../crypto/bio/bio_sock.c" 3 4
                  ((void *)0)
# 85 "../crypto/bio/bio_sock.c"
                      , str, BIO_LOOKUP_CLIENT, 
# 85 "../crypto/bio/bio_sock.c" 3 4
                                                2
# 85 "../crypto/bio/bio_sock.c"
                                                       , 
...
# 85 "../crypto/bio/bio_sock.c"
                                                                    , &res)) {
        if (BIO_ADDRINFO_family(res) != 
# 86 "../crypto/bio/bio_sock.c" 3 4
                                       2
# 86 "../crypto/bio/bio_sock.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",87,__func__), ERR_set_error)((32),(141),
# 87 "../crypto/bio/bio_sock.c" 3 4
           ((void *)0)
# 87 "../crypto/bio/bio_sock.c"
           );
        } else {
...
int BIO_sock_error(int sock)
{
    ...
    i = getsockopt(sock, 
# 112 "../crypto/bio/bio_sock.c" 3 4
                        1
# 112 "../crypto/bio/bio_sock.c"
                                  , 
# 112 "../crypto/bio/bio_sock.c" 3 4
                                    4
# 112 "../crypto/bio/bio_sock.c"
    ...
    if (i < 0)
        return 
# 114 "../crypto/bio/bio_sock.c" 3 4
              (*__errno_location ())
# 114 "../crypto/bio/bio_sock.c"
                                     ;
    else
        return j;
}
...
{
    int i;
# 241 "../crypto/bio/bio_sock.c"
    i = ioctl(fd,type,arg);

    if (i < 0)
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",244,__func__), ERR_set_error)(2, 
# 244 "../crypto/bio/bio_sock.c" 3 4
                                   (*__errno_location ())
# 244 "../crypto/bio/bio_sock.c"
                                                          ,
                       "calling ioctlsocket()");
    return i;
}
...
int BIO_get_accept_socket(char *host, int bind_mode)
{
    int s = (-1);
    char *h = 
# 253 "../crypto/bio/bio_sock.c" 3 4
             ((void *)0)
# 253 "../crypto/bio/bio_sock.c"
                 , *p = 
# 253 "../crypto/bio/bio_sock.c" 3 4
                        ((void *)0)
# 253 "../crypto/bio/bio_sock.c"
                            ;
    BIO_ADDRINFO *res = 
# 254 "../crypto/bio/bio_sock.c" 3 4
                       ((void *)0)
# 254 "../crypto/bio/bio_sock.c"
                           ;
    ...
    if (BIO_lookup(h, p, BIO_LOOKUP_SERVER, 
# 262 "../crypto/bio/bio_sock.c" 3 4
                                           0
# 262 "../crypto/bio/bio_sock.c"
                                                    , 
# 262 "../crypto/bio/bio_sock.c" 3 4
                                                      SOCK_STREAM
# 262 "../crypto/bio/bio_sock.c"
 ...
 err:
    BIO_ADDRINFO_free(res);
    CRYPTO_free(h, "../crypto/bio/bio_sock.c", 279);
    CRYPTO_free(p, "../crypto/bio/bio_sock.c", 280);
...
int BIO_accept(int sock, char **ip_port)
{
    ...
    if (ret == (int)(-1)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",296,__func__), ERR_set_error)(2, 
# 296 "../crypto/bio/bio_sock.c" 3 4
                                   (*__errno_location ())
# 296 "../crypto/bio/bio_sock.c"
                                                          ,
                       "calling accept()");
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",298,__func__), ERR_set_error)((32),(100),
# 298 "../crypto/bio/bio_sock.c" 3 4
       ((void *)0)
# 298 "../crypto/bio/bio_sock.c"
       );
        goto end;
    }

    if (ip_port != 
# 302 "../crypto/bio/bio_sock.c" 3 4
                  ((void *)0)
# 302 "../crypto/bio/bio_sock.c"
                      ) {
        char *host = BIO_ADDR_hostname_string(&res, 1);
        char *port = BIO_ADDR_service_string(&res, 1);
        if (host != 
# 305 "../crypto/bio/bio_sock.c" 3 4
                   ((void *)0) 
# 305 "../crypto/bio/bio_sock.c"
                        && port != 
# 305 "../crypto/bio/bio_sock.c" 3 4
                                   ((void *)0)
# 305 "../crypto/bio/bio_sock.c"
                                       ) {
            *ip_port = CRYPTO_zalloc(strlen(host) + strlen(port) + 2, "../crypto/bio/bio_sock.c", 306);
        } else {
            *ip_port = 
# 308 "../crypto/bio/bio_sock.c" 3 4
                      ((void *)0)
# 308 "../crypto/bio/bio_sock.c"
                          ;
            (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",309,__func__), ERR_set_error)((32),((32 | (0x2 << 18L))),
# 309 "../crypto/bio/bio_sock.c" 3 4
           ((void *)0)
# 309 "../crypto/bio/bio_sock.c"
           );
        }

        if (*ip_port == 
# 312 "../crypto/bio/bio_sock.c" 3 4
                       ((void *)0)
# 312 "../crypto/bio/bio_sock.c"
                           ) {
            BIO_closesocket(ret);
            ret = (int)(-1);
        } else {
        ...
        CRYPTO_free(host, "../crypto/bio/bio_sock.c", 320);
        CRYPTO_free(port, "../crypto/bio/bio_sock.c", 321);
    }
...
int BIO_set_tcp_ndelay(int s, int on)
{
    ...
    opt = 
# 336 "../crypto/bio/bio_sock.c" 3 4
         6
# 336 "../crypto/bio/bio_sock.c"
                ;
    ...
    ret = setsockopt(s, opt, 
# 343 "../crypto/bio/bio_sock.c" 3 4
                            1
# 343 "../crypto/bio/bio_sock.c"
                                       , (char *)&on, sizeof(on));
...
int BIO_socket_nbio(int s, int mode)
{
    ...
    ret = BIO_socket_ioctl(s, 
# 357 "../crypto/bio/bio_sock.c" 3 4
                             0x5421
# 357 "../crypto/bio/bio_sock.c"
                                    , &l);
# 391 "../crypto/bio/bio_sock.c"
    return (ret == 0);
}
    ...
    case BIO_SOCK_INFO_ADDRESS:
        {
            ...
            ret = getsockname(sock, BIO_ADDR_sockaddr_noconst(info->addr),
                              &addr_len);
            if (ret == -1) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",406,__func__), ERR_set_error)(2, 
# 406 "../crypto/bio/bio_sock.c" 3 4
                                           (*__errno_location ())
# 406 "../crypto/bio/bio_sock.c"
                                                                  ,
                               "calling getsockname()");
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",408,__func__), ERR_set_error)((32),(132),
# 408 "../crypto/bio/bio_sock.c" 3 4
               ((void *)0)
# 408 "../crypto/bio/bio_sock.c"
               );
                return 0;
            }
            if ((size_t)addr_len > sizeof(*info->addr)) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",412,__func__), ERR_set_error)((32),(133),
# 412 "../crypto/bio/bio_sock.c" 3 4
               ((void *)0)
# 412 "../crypto/bio/bio_sock.c"
               );
                return 0;
            }
        }
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/bio/bio_sock.c",418,__func__), ERR_set_error)((32),(140),
# 418 "../crypto/bio/bio_sock.c" 3 4
       ((void *)0)
# 418 "../crypto/bio/bio_sock.c"
       );
        return 0;
    }
    return 1;
...
int BIO_socket_wait(int fd, int for_read, time_t max_time)
{
    ...
    if (fd < 0 || fd >= 
# 438 "../crypto/bio/bio_sock.c" 3 4
                       1024
# 438 "../crypto/bio/bio_sock.c"
                                 )
    ...
    now = time(
# 444 "../crypto/bio/bio_sock.c" 3 4
              ((void *)0)
# 444 "../crypto/bio/bio_sock.c"
                  );
    if (max_time < now)
        return 0;

    
# 448 "../crypto/bio/bio_sock.c" 3 4
   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 448 "../crypto/bio/bio_sock.c"
   &confds
# 448 "../crypto/bio/bio_sock.c" 3 4
...
# 449 "../crypto/bio/bio_sock.c" 3 4
   ((void) (((
# 449 "../crypto/bio/bio_sock.c"
   &confds
# 449 "../crypto/bio/bio_sock.c" 3 4
   )->__fds_bits)[((
# 449 "../crypto/bio/bio_sock.c"
...
# 449 "../crypto/bio/bio_sock.c"
                             ;
    tv.tv_usec = 0;
    tv.tv_sec = (long)(max_time - now);
    return select(fd + 1, for_read ? &confds : 
# 452 "../crypto/bio/bio_sock.c" 3 4
                                              ((void *)0)
# 452 "../crypto/bio/bio_sock.c"
                                                  ,
                  for_read ? 
# 453 "../crypto/bio/bio_sock.c" 3 4
                            ((void *)0) 
# 453 "../crypto/bio/bio_sock.c"
                                 : &confds, 
# 453 "../crypto/bio/bio_sock.c" 3 4
                                            ((void *)0)
# 453 "../crypto/bio/bio_sock.c"
