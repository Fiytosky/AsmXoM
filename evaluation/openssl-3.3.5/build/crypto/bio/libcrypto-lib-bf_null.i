# 0 "../crypto/bio/bf_null.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_null.c"
# 10 "../crypto/bio/bf_null.c"
...
# 35 "../crypto/bio/bf_null.c" 3 4
   ((void *)0)
# 35 "../crypto/bio/bf_null.c"
       ,
    
# 36 "../crypto/bio/bf_null.c" 3 4
   ((void *)0)
# 36 "../crypto/bio/bf_null.c"
       ,
    nullf_callback_ctrl,
};
...
static int nullf_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 49 "../crypto/bio/bf_null.c" 3 4
              ((void *)0)
# 49 "../crypto/bio/bf_null.c"
                  )
        return 0;
    if (b->next_bio == 
# 51 "../crypto/bio/bf_null.c" 3 4
                      ((void *)0)
# 51 "../crypto/bio/bf_null.c"
                          )
        return 0;
...
static int nullf_write(BIO *b, const char *in, int inl)
{
    ...
    if ((in == 
# 63 "../crypto/bio/bf_null.c" 3 4
              ((void *)0)
# 63 "../crypto/bio/bf_null.c"
                  ) || (inl <= 0))
        return 0;
    if (b->next_bio == 
# 65 "../crypto/bio/bf_null.c" 3 4
                      ((void *)0)
# 65 "../crypto/bio/bf_null.c"
                          )
        return 0;
...
static long nullf_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    if (b->next_bio == 
# 77 "../crypto/bio/bf_null.c" 3 4
                      ((void *)0)
# 77 "../crypto/bio/bf_null.c"
                          )
        return 0;
    switch (cmd) {
    case 101:
...
{
    if (b->next_bio == 
# 96 "../crypto/bio/bf_null.c" 3 4
                      ((void *)0)
# 96 "../crypto/bio/bf_null.c"
                          )
        return 0;
...
{
    if (bp->next_bio == 
# 103 "../crypto/bio/bf_null.c" 3 4
                       ((void *)0)
# 103 "../crypto/bio/bf_null.c"
                           )
        return 0;
...
{
    if (bp->next_bio == 
# 110 "../crypto/bio/bf_null.c" 3 4
                       ((void *)0)
# 110 "../crypto/bio/bf_null.c"
                           )
        return 0;
