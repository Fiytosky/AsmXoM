# 0 "../crypto/bio/bf_readbuff.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_readbuff.c"
# 17 "../crypto/bio/bf_readbuff.c"
...
{
    BIO_F_BUFFER_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../crypto/bio/bf_readbuff.c", 55);

    if (ctx == 
# 57 "../crypto/bio/bf_readbuff.c" 3 4
              ((void *)0)
# 57 "../crypto/bio/bf_readbuff.c"
                  )
        return 0;
    ctx->ibuf_size = 4096;
    ctx->ibuf = CRYPTO_zalloc(4096, "../crypto/bio/bf_readbuff.c", 60);
    if (ctx->ibuf == 
# 61 "../crypto/bio/bf_readbuff.c" 3 4
                    ((void *)0)
# 61 "../crypto/bio/bf_readbuff.c"
                        ) {
        CRYPTO_free(ctx, "../crypto/bio/bf_readbuff.c", 62);
        return 0;
    }
...
static int readbuffer_free(BIO *a)
{
    ...
    if (a == 
# 76 "../crypto/bio/bf_readbuff.c" 3 4
            ((void *)0)
# 76 "../crypto/bio/bf_readbuff.c"
                )
        return 0;
    b = (BIO_F_BUFFER_CTX *)a->ptr;
    CRYPTO_free(b->ibuf, "../crypto/bio/bf_readbuff.c", 79);
    CRYPTO_free(a->ptr, "../crypto/bio/bf_readbuff.c", 80);
    a->ptr = 
# 81 "../crypto/bio/bf_readbuff.c" 3 4
            ((void *)0)
# 81 "../crypto/bio/bf_readbuff.c"
                ;
    a->init = 0;
    a->flags = 0;
    return 1;
...
static int readbuffer_resize(BIO_F_BUFFER_CTX *ctx, int sz)
{
    ...
    sz += (ctx->ibuf_off + 4096 - 1);
    sz = 4096 * (sz / 4096);


    if (sz > ctx->ibuf_size) {
        tmp = CRYPTO_realloc(ctx->ibuf, sz, "../crypto/bio/bf_readbuff.c", 97);
        if (tmp == 
# 98 "../crypto/bio/bf_readbuff.c" 3 4
                  ((void *)0)
# 98 "../crypto/bio/bf_readbuff.c"
                      )
            return 0;
        ctx->ibuf = tmp;
        ctx->ibuf_size = sz;
...
static int readbuffer_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 111 "../crypto/bio/bf_readbuff.c" 3 4
              ((void *)0) 
# 111 "../crypto/bio/bf_readbuff.c"
                   || outl == 0)
        return 0;
    ctx = (BIO_F_BUFFER_CTX *)b->ptr;

    if ((ctx == 
# 115 "../crypto/bio/bf_readbuff.c" 3 4
               ((void *)0)
# 115 "../crypto/bio/bf_readbuff.c"
                   ) || (b->next_bio == 
# 115 "../crypto/bio/bf_readbuff.c" 3 4
                                        ((void *)0)
# 115 "../crypto/bio/bf_readbuff.c"
...
static long readbuffer_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    case 2:
        if (ctx->ibuf_len > 0)
            return 0;
        if (b->next_bio == 
# 173 "../crypto/bio/bf_readbuff.c" 3 4
                          ((void *)0)
# 173 "../crypto/bio/bf_readbuff.c"
                              )
            return 1;
    ...
    case 10:
        ...
        if (ret == 0) {
            if (b->next_bio == 
# 195 "../crypto/bio/bf_readbuff.c" 3 4
                              ((void *)0)
# 195 "../crypto/bio/bf_readbuff.c"
                                  )
                return 0;
            ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
        }
...
{
    if (b->next_bio == 
# 213 "../crypto/bio/bf_readbuff.c" 3 4
                      ((void *)0)
# 213 "../crypto/bio/bf_readbuff.c"
                          )
        return 0;
...
static int readbuffer_gets(BIO *b, char *buf, int size)
{
    ...
    if (buf == 
# 225 "../crypto/bio/bf_readbuff.c" 3 4
              ((void *)0) 
# 225 "../crypto/bio/bf_readbuff.c"
                   || size == 0)
        return 0;
    --size;
    ctx = (BIO_F_BUFFER_CTX *)b->ptr;
    ...
    if (ctx == 
# 230 "../crypto/bio/bf_readbuff.c" 3 4
              ((void *)0) 
# 230 "../crypto/bio/bf_readbuff.c"
                   || b->next_bio == 
# 230 "../crypto/bio/bf_readbuff.c" 3 4
                                     ((void *)0)
# 230 "../crypto/bio/bf_readbuff.c"
