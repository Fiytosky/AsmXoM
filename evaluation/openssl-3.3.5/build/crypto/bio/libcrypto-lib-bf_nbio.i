# 0 "../crypto/bio/bf_nbio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bf_nbio.c"
# 10 "../crypto/bio/bf_nbio.c"
...
static int nbiof_new(BIO *bi)
{
    ...
    if ((nt = CRYPTO_zalloc(sizeof(*nt), "../crypto/bio/bf_nbio.c", 58)) == 
# 58 "../crypto/bio/bf_nbio.c" 3 4
                                             ((void *)0)
# 58 "../crypto/bio/bf_nbio.c"
                                                 )
        return 0;
    nt->lrn = -1;
    nt->lwn = -1;
...
{
    if (a == 
# 69 "../crypto/bio/bf_nbio.c" 3 4
            ((void *)0)
# 69 "../crypto/bio/bf_nbio.c"
                )
        return 0;
    CRYPTO_free(a->ptr, "../crypto/bio/bf_nbio.c", 71);
    a->ptr = 
# 72 "../crypto/bio/bf_nbio.c" 3 4
            ((void *)0)
# 72 "../crypto/bio/bf_nbio.c"
                ;
    a->init = 0;
    a->flags = 0;
    return 1;
...
static int nbiof_read(BIO *b, char *out, int outl)
{
    ...
    if (out == 
# 84 "../crypto/bio/bf_nbio.c" 3 4
              ((void *)0)
# 84 "../crypto/bio/bf_nbio.c"
                  )
        return 0;
    if (b->next_bio == 
# 86 "../crypto/bio/bf_nbio.c" 3 4
                      ((void *)0)
# 86 "../crypto/bio/bf_nbio.c"
                          )
        return 0;
...
static int nbiof_write(BIO *b, const char *in, int inl)
{
    ...
    if ((in == 
# 115 "../crypto/bio/bf_nbio.c" 3 4
              ((void *)0)
# 115 "../crypto/bio/bf_nbio.c"
                  ) || (inl <= 0))
        return 0;
    if (b->next_bio == 
# 117 "../crypto/bio/bf_nbio.c" 3 4
                      ((void *)0)
# 117 "../crypto/bio/bf_nbio.c"
                          )
        return 0;
    nt = (NBIO_TEST *)b->ptr;
...
static long nbiof_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    if (b->next_bio == 
# 152 "../crypto/bio/bf_nbio.c" 3 4
                      ((void *)0)
# 152 "../crypto/bio/bf_nbio.c"
                          )
        return 0;
    switch (cmd) {
    case 101:
...
{
    if (b->next_bio == 
# 172 "../crypto/bio/bf_nbio.c" 3 4
                      ((void *)0)
# 172 "../crypto/bio/bf_nbio.c"
                          )
        return 0;
...
{
    if (bp->next_bio == 
# 179 "../crypto/bio/bf_nbio.c" 3 4
                       ((void *)0)
# 179 "../crypto/bio/bf_nbio.c"
                           )
        return 0;
...
{
    if (bp->next_bio == 
# 186 "../crypto/bio/bf_nbio.c" 3 4
                       ((void *)0)
# 186 "../crypto/bio/bf_nbio.c"
                           )
        return 0;
