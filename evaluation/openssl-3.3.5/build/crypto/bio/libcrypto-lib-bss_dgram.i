# 0 "../crypto/bio/bss_dgram.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/bio/bss_dgram.c"
# 14 "../crypto/bio/bss_dgram.c"
...
# 18 "../crypto/bio/bss_dgram.c" 2
# 1 "../crypto/bio/bio_local.h" 1
# 11 "../crypto/bio/bio_local.h"
...
# 19 "../crypto/bio/bss_dgram.c" 2
# 142 "../crypto/bio/bss_dgram.c"
...
# 181 "../crypto/bio/bss_dgram.c" 3 4
   ((void *)0)
# 181 "../crypto/bio/bss_dgram.c"
       ,
    dgram_ctrl,
    dgram_new,
    dgram_free,
    
# 185 "../crypto/bio/bss_dgram.c" 3 4
   ((void *)0)
# 185 "../crypto/bio/bss_dgram.c"
       ,
    dgram_sendmmsg,
    dgram_recvmmsg,
};
# 209 "../crypto/bio/bss_dgram.c"
...
BIO *BIO_new_dgram(int fd, int close_flag)
{
    ...
    if (ret == 
# 258 "../crypto/bio/bss_dgram.c" 3 4
              ((void *)0)
# 258 "../crypto/bio/bss_dgram.c"
                  )
        return 
# 259 "../crypto/bio/bss_dgram.c" 3 4
              ((void *)0)
# 259 "../crypto/bio/bss_dgram.c"
                  ;
...
{
    bio_dgram_data *data = CRYPTO_zalloc(sizeof(*data), "../crypto/bio/bss_dgram.c", 266);

    if (data == 
# 268 "../crypto/bio/bss_dgram.c" 3 4
               ((void *)0)
# 268 "../crypto/bio/bss_dgram.c"
                   )
        return 0;
    bi->ptr = data;
    return 1;
...
static int dgram_free(BIO *a)
{
    ...
    if (a == 
# 278 "../crypto/bio/bss_dgram.c" 3 4
            ((void *)0)
# 278 "../crypto/bio/bss_dgram.c"
                )
        return 0;
    if (!dgram_clear(a))
        return 0;
    ...
    CRYPTO_free(data, "../crypto/bio/bss_dgram.c", 284);
...
{
    if (a == 
# 291 "../crypto/bio/bss_dgram.c" 3 4
            ((void *)0)
# 291 "../crypto/bio/bss_dgram.c"
                )
        return 0;
    if (a->shutdown) {
        if (a->init) {
...
# 323 "../crypto/bio/bss_dgram.c"
        struct timeval tv;
        socklen_t sz = sizeof(tv);

        if (getsockopt(b->num, 
# 326 "../crypto/bio/bss_dgram.c" 3 4
                              1
# 326 "../crypto/bio/bss_dgram.c"
                                        , 
# 326 "../crypto/bio/bss_dgram.c" 3 4
                                          20
# 326 "../crypto/bio/bss_dgram.c"
                                                     , &tv, &sz) < 0)
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",327,__func__), ERR_set_error)(2, 
# 327 "../crypto/bio/bss_dgram.c" 3 4
                                       (*__errno_location ())
# 327 "../crypto/bio/bss_dgram.c"
                                                              ,
                           "calling getsockopt()");
        else
        ...
        if (ossl_time_compare(timeleft, ossl_ticks2time(((((uint64_t)1000000000) / 1000) / 1000))) < 0)
            timeleft = ossl_ticks2time(((((uint64_t)1000000000) / 1000) / 1000));
        ...
        if (ossl_time_is_zero(data->socket_timeout)
            ...
            if (setsockopt(b->num, 
# 352 "../crypto/bio/bss_dgram.c" 3 4
                                  1
# 352 "../crypto/bio/bss_dgram.c"
                                            , 
# 352 "../crypto/bio/bss_dgram.c" 3 4
                                              20
# 352 "../crypto/bio/bss_dgram.c"
                                                         , &tv,
                           sizeof(tv)) < 0)
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",354,__func__), ERR_set_error)(2, 
# 354 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 354 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling setsockopt()");
...
static void dgram_reset_rcv_timeout(BIO *b)
{
    ...
    if (!ossl_time_is_zero(data->next_timeout)) {
# 398 "../crypto/bio/bss_dgram.c"
        struct timeval tv = ossl_time_to_timeval(data->socket_timeout);

        if (setsockopt(b->num, 
# 400 "../crypto/bio/bss_dgram.c" 3 4
                              1
# 400 "../crypto/bio/bss_dgram.c"
                                        , 
# 400 "../crypto/bio/bss_dgram.c" 3 4
                                          20
# 400 "../crypto/bio/bss_dgram.c"
                                                     , &tv, sizeof(tv)) < 0)
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",401,__func__), ERR_set_error)(2, 
# 401 "../crypto/bio/bss_dgram.c" 3 4
                                       (*__errno_location ())
# 401 "../crypto/bio/bss_dgram.c"
                                                              ,
                           "calling setsockopt()");
...
static int dgram_read(BIO *b, char *out, int outl)
{
    ...
    if (out != 
# 417 "../crypto/bio/bss_dgram.c" 3 4
              ((void *)0)
# 417 "../crypto/bio/bss_dgram.c"
                  ) {
        
# 418 "../crypto/bio/bss_dgram.c" 3 4
       (*__errno_location ())
# 418 "../crypto/bio/bss_dgram.c"
       =0;
        BIO_ADDR_clear(&peer);
        dgram_adjust_rcv_timeout(b);
        if (data->peekmode)
            flags = 
# 422 "../crypto/bio/bss_dgram.c" 3 4
                   MSG_PEEK
# 422 "../crypto/bio/bss_dgram.c"
                           ;
        ret = recvfrom(b->num, out, outl, flags,
                       BIO_ADDR_sockaddr_noconst(&peer), &len);

        if (!data->connected && ret >= 0)
            BIO_ctrl(b, 44, 0, &peer);
        ...
        if (ret < 0) {
            if (BIO_dgram_should_retry(ret)) {
                ...
                data->_errno = 
# 433 "../crypto/bio/bss_dgram.c" 3 4
                              (*__errno_location ())
...
# 446 "../crypto/bio/bss_dgram.c" 3 4
   (*__errno_location ())
# 446 "../crypto/bio/bss_dgram.c"
   =0;
    ...
    if (ret <= 0) {
        if (BIO_dgram_should_retry(ret)) {
            ...
            data->_errno = 
# 461 "../crypto/bio/bss_dgram.c" 3 4
                          (*__errno_location ())
# 461 "../crypto/bio/bss_dgram.c"
                                                 ;
        }
    }
    return ret;
...
static long dgram_get_mtu_overhead(BIO_ADDR *addr)
{
    ...
    case 
# 472 "../crypto/bio/bss_dgram.c" 3 4
        2
# 472 "../crypto/bio/bss_dgram.c"
               :
    ...
    case 
# 479 "../crypto/bio/bss_dgram.c" 3 4
        10
# 479 "../crypto/bio/bss_dgram.c"
                :
        {

            struct in6_addr tmp_addr;

            if (BIO_ADDR_rawaddress(addr, &tmp_addr, 
# 484 "../crypto/bio/bss_dgram.c" 3 4
                                                    ((void *)0)
# 484 "../crypto/bio/bss_dgram.c"
                                                        )
                && 
# 485 "../crypto/bio/bss_dgram.c" 3 4
                  (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (
# 485 "../crypto/bio/bss_dgram.c"
                  &tmp_addr
# 485 "../crypto/bio/bss_dgram.c" 3 4
...
static int enable_local_addr(BIO *b, int enable) {
    ...
    if (af == 
# 512 "../crypto/bio/bss_dgram.c" 3 4
             2
# 512 "../crypto/bio/bss_dgram.c"
                    ) {


        if (setsockopt(b->num, 
# 515 "../crypto/bio/bss_dgram.c" 3 4
                              IPPROTO_IP
# 515 "../crypto/bio/bss_dgram.c"
                                        , 
# 515 "../crypto/bio/bss_dgram.c" 3 4
                                          8
# 515 "../crypto/bio/bss_dgram.c"
        ...
        return 1;
# 530 "../crypto/bio/bss_dgram.c"
    }


    if (af == 
# 533 "../crypto/bio/bss_dgram.c" 3 4
             10
# 533 "../crypto/bio/bss_dgram.c"
                     ) {

        if (setsockopt(b->num, 
# 535 "../crypto/bio/bss_dgram.c" 3 4
                              IPPROTO_IPV6
# 535 "../crypto/bio/bss_dgram.c"
                                          , 
# 535 "../crypto/bio/bss_dgram.c" 3 4
                                            49
# 535 "../crypto/bio/bss_dgram.c"
...
static long dgram_ctrl(BIO *b, int cmd, long num, void *ptr)
{
    ...
    int *ip;
    bio_dgram_data *data = 
# 552 "../crypto/bio/bss_dgram.c" 3 4
                          ((void *)0)
# 552 "../crypto/bio/bss_dgram.c"
                              ;
    ...
    case 105:
        if (b->init) {
            ip = (int *)ptr;
            if (ip != 
# 597 "../crypto/bio/bss_dgram.c" 3 4
                     ((void *)0)
# 597 "../crypto/bio/bss_dgram.c"
                         )
                *ip = b->num;
            ret = b->num;
        } else
    ...
    case 39:
        ...
        case 
# 630 "../crypto/bio/bss_dgram.c" 3 4
            2
# 630 "../crypto/bio/bss_dgram.c"
                   :
            sockopt_val = 
# 631 "../crypto/bio/bss_dgram.c" 3 4
                         2
# 631 "../crypto/bio/bss_dgram.c"
                                       ;
            if ((ret = setsockopt(b->num, 
# 632 "../crypto/bio/bss_dgram.c" 3 4
                                         IPPROTO_IP
# 632 "../crypto/bio/bss_dgram.c"
                                                   , 
# 632 "../crypto/bio/bss_dgram.c" 3 4
                                                     10
# 632 "../crypto/bio/bss_dgram.c"
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",634,__func__), ERR_set_error)(2, 
# 634 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 634 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling setsockopt()");
            break;

        case 
# 638 "../crypto/bio/bss_dgram.c" 3 4
            10
# 638 "../crypto/bio/bss_dgram.c"
                    :
            sockopt_val = 
# 639 "../crypto/bio/bss_dgram.c" 3 4
                         2
# 639 "../crypto/bio/bss_dgram.c"
                                         ;
            if ((ret = setsockopt(b->num, 
# 640 "../crypto/bio/bss_dgram.c" 3 4
                                         IPPROTO_IPV6
# 640 "../crypto/bio/bss_dgram.c"
                                                     , 
# 640 "../crypto/bio/bss_dgram.c" 3 4
                                                       23
# 640 "../crypto/bio/bss_dgram.c"
                                                                        ,
                                  &sockopt_val, sizeof(sockopt_val))) < 0)
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",642,__func__), ERR_set_error)(2, 
# 642 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 642 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling setsockopt()");
            break;
    ...
    case 40:
        ...
        switch (addr.sa.sa_family) {
        case 
# 664 "../crypto/bio/bss_dgram.c" 3 4
            2
# 664 "../crypto/bio/bss_dgram.c"
                   :
            if ((ret =
                 getsockopt(b->num, 
# 666 "../crypto/bio/bss_dgram.c" 3 4
                                   IPPROTO_IP
# 666 "../crypto/bio/bss_dgram.c"
                                             , 
# 666 "../crypto/bio/bss_dgram.c" 3 4
                                               14
# 666 "../crypto/bio/bss_dgram.c"
        ...
        case 
# 675 "../crypto/bio/bss_dgram.c" 3 4
            10
# 675 "../crypto/bio/bss_dgram.c"
                    :
            if ((ret =
                 getsockopt(b->num, 
# 677 "../crypto/bio/bss_dgram.c" 3 4
                                   IPPROTO_IPV6
# 677 "../crypto/bio/bss_dgram.c"
                                               , 
# 677 "../crypto/bio/bss_dgram.c" 3 4
                                                 24
# 677 "../crypto/bio/bss_dgram.c"
    ...
    case 47:
        ...
        case 
# 698 "../crypto/bio/bss_dgram.c" 3 4
            2
# 698 "../crypto/bio/bss_dgram.c"
                   :
            ret += 576;
            break;

        case 
# 702 "../crypto/bio/bss_dgram.c" 3 4
            10
# 702 "../crypto/bio/bss_dgram.c"
                    :
            {

                struct in6_addr tmp_addr;
                if (BIO_ADDR_rawaddress(&data->peer, &tmp_addr, 
# 706 "../crypto/bio/bss_dgram.c" 3 4
                                                               ((void *)0)
# 706 "../crypto/bio/bss_dgram.c"
                                                                   )
                    && 
# 707 "../crypto/bio/bss_dgram.c" 3 4
                      (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (
# 707 "../crypto/bio/bss_dgram.c"
                      &tmp_addr
# 707 "../crypto/bio/bss_dgram.c" 3 4
                      ); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == htonl (0xffff); }))
# 707 "../crypto/bio/bss_dgram.c"
    ...
    case 32:
        if (ptr != 
# 727 "../crypto/bio/bss_dgram.c" 3 4
                  ((void *)0)
# 727 "../crypto/bio/bss_dgram.c"
                      ) {
            data->connected = 1;
            BIO_ADDR_make(&data->peer, BIO_ADDR_sockaddr((BIO_ADDR *)ptr));
        } else {
    ...
    case 93:
        {
            ...
            if (BIO_ADDR_family(p) == 
# 751 "../crypto/bio/bss_dgram.c" 3 4
                                     0
# 751 "../crypto/bio/bss_dgram.c"
                                              ) {
                if (getpeername(b->num, (void *)&xaddr.sa, &xaddr_len) == 0
                    && BIO_ADDR_family(&xaddr) != 
# 753 "../crypto/bio/bss_dgram.c" 3 4
                                                 0
# 753 "../crypto/bio/bss_dgram.c"
                                                          ) {
                    p = &xaddr;
                } else {
                    ret = 0;
    ...
    case 33:
# 788 "../crypto/bio/bss_dgram.c"
        if ((ret = setsockopt(b->num, 
# 788 "../crypto/bio/bss_dgram.c" 3 4
                                     1
# 788 "../crypto/bio/bss_dgram.c"
                                               , 
# 788 "../crypto/bio/bss_dgram.c" 3 4
...
# 788 "../crypto/bio/bss_dgram.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",790,__func__), ERR_set_error)(2, 
# 790 "../crypto/bio/bss_dgram.c" 3 4
                                       (*__errno_location ())
# 790 "../crypto/bio/bss_dgram.c"
                                                              ,
                           "calling setsockopt()");
    ...
    case 34:
        {
# 812 "../crypto/bio/bss_dgram.c"
            socklen_t sz = sizeof(struct timeval);
            if ((ret = getsockopt(b->num, 
# 813 "../crypto/bio/bss_dgram.c" 3 4
                                         1
# 813 "../crypto/bio/bss_dgram.c"
                                                   , 
# 813 "../crypto/bio/bss_dgram.c" 3 4
                                                     20
# 813 "../crypto/bio/bss_dgram.c"
                                                                ,
                                  ptr, &sz)) < 0) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",815,__func__), ERR_set_error)(2, 
# 815 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 815 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling getsockopt()");
            } else {
                (void)(((size_t)sz <= sizeof(struct timeval)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)sz <= sizeof(struct timeval)", "../crypto/bio/bss_dgram.c", 818), 1));
                ret = (int)sz;
            }
    ...
    case 35:
# 838 "../crypto/bio/bss_dgram.c"
        if ((ret = setsockopt(b->num, 
# 838 "../crypto/bio/bss_dgram.c" 3 4
                                     1
# 838 "../crypto/bio/bss_dgram.c"
                                               , 
# 838 "../crypto/bio/bss_dgram.c" 3 4
...
# 838 "../crypto/bio/bss_dgram.c"
                                                            , ptr,
                              sizeof(struct timeval))) < 0)
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",840,__func__), ERR_set_error)(2, 
# 840 "../crypto/bio/bss_dgram.c" 3 4
                                       (*__errno_location ())
# 840 "../crypto/bio/bss_dgram.c"
                                                              ,
                           "calling setsockopt()");
    ...
    case 36:
        {
# 862 "../crypto/bio/bss_dgram.c"
            socklen_t sz = sizeof(struct timeval);

            if ((ret = getsockopt(b->num, 
# 864 "../crypto/bio/bss_dgram.c" 3 4
                                         1
# 864 "../crypto/bio/bss_dgram.c"
                                                   , 
# 864 "../crypto/bio/bss_dgram.c" 3 4
                                                     21
# 864 "../crypto/bio/bss_dgram.c"
                                                                ,
                                  ptr, &sz)) < 0) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",866,__func__), ERR_set_error)(2, 
# 866 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 866 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling getsockopt()");
            } else {
                (void)(((size_t)sz <= sizeof(struct timeval)) ? 0 : (OPENSSL_die("assertion failed: " "(size_t)sz <= sizeof(struct timeval)", "../crypto/bio/bss_dgram.c", 869), 1));
                ret = (int)sz;
            }
    ...
    case 37:
        ...
        d_errno = (data->_errno == 
# 882 "../crypto/bio/bss_dgram.c" 3 4
                                  11
# 882 "../crypto/bio/bss_dgram.c"
    ...
    case 43:
        if (data->_errno == 
# 892 "../crypto/bio/bss_dgram.c" 3 4
                           90
# 892 "../crypto/bio/bss_dgram.c"
                                   ) {
            ret = 1;
            data->_errno = 0;
        } else
    ...
    case 48:
        ...
        case 
# 901 "../crypto/bio/bss_dgram.c" 3 4
            2
# 901 "../crypto/bio/bss_dgram.c"
                   :
            ...
            sockopt_val = num ? 
# 909 "../crypto/bio/bss_dgram.c" 3 4
                               3 
# 909 "../crypto/bio/bss_dgram.c"
                                                 : 
# 909 "../crypto/bio/bss_dgram.c" 3 4
                                                   0
# 909 "../crypto/bio/bss_dgram.c"
                                                                   ;
            if ((ret = setsockopt(b->num, 
# 910 "../crypto/bio/bss_dgram.c" 3 4
                                         IPPROTO_IP
# 910 "../crypto/bio/bss_dgram.c"
                                                   , 
# 910 "../crypto/bio/bss_dgram.c" 3 4
                                                     10
# 910 "../crypto/bio/bss_dgram.c"
                                                                    ,
                                  &sockopt_val, sizeof(sockopt_val))) < 0)
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",912,__func__), ERR_set_error)(2, 
# 912 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 912 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling setsockopt()");
# 924 "../crypto/bio/bss_dgram.c"
            break;

        case 
# 926 "../crypto/bio/bss_dgram.c" 3 4
            10
# 926 "../crypto/bio/bss_dgram.c"
                    :

            sockopt_val = num ? 1 : 0;
            if ((ret = setsockopt(b->num, 
# 929 "../crypto/bio/bss_dgram.c" 3 4
                                         IPPROTO_IPV6
# 929 "../crypto/bio/bss_dgram.c"
                                                     , 
# 929 "../crypto/bio/bss_dgram.c" 3 4
                                                       62
# 929 "../crypto/bio/bss_dgram.c"
                ...
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",932,__func__), ERR_set_error)(2, 
# 932 "../crypto/bio/bss_dgram.c" 3 4
                                           (*__errno_location ())
# 932 "../crypto/bio/bss_dgram.c"
                                                                  ,
                               "calling setsockopt()");
# 944 "../crypto/bio/bss_dgram.c"
            break;
                          ...
                          unsigned char *control, BIO_MSG *msg)
{
    ...
    if (data->connected == 0) {
        ...
        mh->msg_name = msg->peer != 
# 1077 "../crypto/bio/bss_dgram.c" 3 4
                                   ((void *)0) 
# 1077 "../crypto/bio/bss_dgram.c"
                                        ? &msg->peer->sa : 
# 1077 "../crypto/bio/bss_dgram.c" 3 4
                                                           ((void *)0)
# 1077 "../crypto/bio/bss_dgram.c"
                                                               ;
        if (msg->peer != 
# 1078 "../crypto/bio/bss_dgram.c" 3 4
                        ((void *)0) 
# 1078 "../crypto/bio/bss_dgram.c"
...
# 1081 "../crypto/bio/bss_dgram.c" 3 4
                             ((void *)0) 
# 1081 "../crypto/bio/bss_dgram.c"
                                  && dgram_get_sock_family(b) == 
# 1081 "../crypto/bio/bss_dgram.c" 3 4
                                                                 10
# 1081 "../crypto/bio/bss_dgram.c"
        ...
        mh->msg_name = 
# 1087 "../crypto/bio/bss_dgram.c" 3 4
                      ((void *)0)
# 1087 "../crypto/bio/bss_dgram.c"
                          ;
        mh->msg_namelen = 0;
    }
    ...
    mh->msg_iov = iov;
    mh->msg_iovlen = 1;
    mh->msg_control = msg->local != 
# 1093 "../crypto/bio/bss_dgram.c" 3 4
                                       ((void *)0) 
# 1093 "../crypto/bio/bss_dgram.c"
                                            ? control : 
# 1093 "../crypto/bio/bss_dgram.c" 3 4
                                                        ((void *)0)
# 1093 "../crypto/bio/bss_dgram.c"
                                                            ;
    mh->msg_controllen = msg->local != 
# 1094 "../crypto/bio/bss_dgram.c" 3 4
                                       ((void *)0) 
# 1094 "../crypto/bio/bss_dgram.c"
                                            ? ((
# 1094 "../crypto/bio/bss_dgram.c" 3 4
                                              ((((
# 1094 "../crypto/bio/bss_dgram.c"
...
static int extract_local(BIO *b, struct msghdr *mh, BIO_ADDR *local) {

    struct cmsghdr *cmsg;
    int af = dgram_get_sock_family(b);

    for (cmsg = 
# 1106 "../crypto/bio/bss_dgram.c" 3 4
               ((size_t) (
# 1106 "../crypto/bio/bss_dgram.c"
               mh
# 1106 "../crypto/bio/bss_dgram.c" 3 4
...
# 1106 "../crypto/bio/bss_dgram.c"
                                                  ;
         cmsg = 
# 1107 "../crypto/bio/bss_dgram.c" 3 4
               __cmsg_nxthdr (
# 1107 "../crypto/bio/bss_dgram.c"
               mh
# 1107 "../crypto/bio/bss_dgram.c" 3 4
               , 
# 1107 "../crypto/bio/bss_dgram.c"
...
# 1107 "../crypto/bio/bss_dgram.c"
        ...
        if (af == 
# 1108 "../crypto/bio/bss_dgram.c" 3 4
                 2
# 1108 "../crypto/bio/bss_dgram.c"
                        ) {
            if (cmsg->cmsg_level != 
# 1109 "../crypto/bio/bss_dgram.c" 3 4
                                   IPPROTO_IP
# 1109 "../crypto/bio/bss_dgram.c"
                                             )
                continue;


            if (cmsg->cmsg_type != 
# 1113 "../crypto/bio/bss_dgram.c" 3 4
                                  8
# 1113 "../crypto/bio/bss_dgram.c"
                                            )
                continue;

            local->s_in.sin_addr =
                ((struct in_pktinfo *)
# 1117 "../crypto/bio/bss_dgram.c" 3 4
                                     ((
# 1117 "../crypto/bio/bss_dgram.c"
                                     cmsg
# 1117 "../crypto/bio/bss_dgram.c" 3 4
                                     )->__cmsg_data)
# 1117 "../crypto/bio/bss_dgram.c"
                                                        )->ipi_addr;
# 1127 "../crypto/bio/bss_dgram.c"
            {
                bio_dgram_data *data = b->ptr;

                local->s_in.sin_family = 
# 1130 "../crypto/bio/bss_dgram.c" 3 4
                                        2
# 1130 "../crypto/bio/bss_dgram.c"
                                               ;
...
# 1137 "../crypto/bio/bss_dgram.c" 3 4
                      10
# 1137 "../crypto/bio/bss_dgram.c"
                              ) {
            if (cmsg->cmsg_level != 
# 1138 "../crypto/bio/bss_dgram.c" 3 4
                                   IPPROTO_IPV6
# 1138 "../crypto/bio/bss_dgram.c"
                                               )
                continue;


            if (cmsg->cmsg_type != 
# 1142 "../crypto/bio/bss_dgram.c" 3 4
                                  50
# 1142 "../crypto/bio/bss_dgram.c"
                                              )
                continue;

            {
                ...
                local->s_in6.sin6_addr =
                    ((struct in6_pktinfo *)
# 1149 "../crypto/bio/bss_dgram.c" 3 4
                                          ((
# 1149 "../crypto/bio/bss_dgram.c"
                                          cmsg
# 1149 "../crypto/bio/bss_dgram.c" 3 4
                                          )->__cmsg_data)
# 1149 "../crypto/bio/bss_dgram.c"
                                                             )->ipi6_addr;
                local->s_in6.sin6_family = 
# 1150 "../crypto/bio/bss_dgram.c" 3 4
                                            10
# 1150 "../crypto/bio/bss_dgram.c"
                                                    ;
...
static int pack_local(BIO *b, struct msghdr *mh, const BIO_ADDR *local) {
    int af = dgram_get_sock_family(b);
    ...
    if (af == 
# 1173 "../crypto/bio/bss_dgram.c" 3 4
             2
# 1173 "../crypto/bio/bss_dgram.c"
                    ) {
...
# 1183 "../crypto/bio/bss_dgram.c"
                                                                 ;
        cmsg->cmsg_level = 
# 1184 "../crypto/bio/bss_dgram.c" 3 4
                          IPPROTO_IP
# 1184 "../crypto/bio/bss_dgram.c"
                                    ;
        cmsg->cmsg_type = 
# 1185 "../crypto/bio/bss_dgram.c" 3 4
                          8
# 1185 "../crypto/bio/bss_dgram.c"
                                    ;

        info = (struct in_pktinfo *)
# 1187 "../crypto/bio/bss_dgram.c" 3 4
                                   ((
# 1187 "../crypto/bio/bss_dgram.c"
                                   cmsg
# 1187 "../crypto/bio/bss_dgram.c" 3 4
                                   )->__cmsg_data)
# 1187 "../crypto/bio/bss_dgram.c"
        ...
        if (local->s_in.sin_port != 0
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1202,__func__), ERR_set_error)((32),(150),
# 1202 "../crypto/bio/bss_dgram.c" 3 4
           ((void *)0)
# 1202 "../crypto/bio/bss_dgram.c"
           );
            return 0;
        }
        ...
        mh->msg_controllen = 
# 1209 "../crypto/bio/bss_dgram.c" 3 4
                            ((((
# 1209 "../crypto/bio/bss_dgram.c"
                            sizeof(struct in_pktinfo)
# 1209 "../crypto/bio/bss_dgram.c" 3 4
                            ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 1209 "../crypto/bio/bss_dgram.c"
        ...
        return 1;
# 1247 "../crypto/bio/bss_dgram.c"
    }

    else if (af == 
# 1249 "../crypto/bio/bss_dgram.c" 3 4
                  10
# 1249 "../crypto/bio/bss_dgram.c"
                          ) {
        ...
        cmsg->cmsg_len = 
# 1258 "../crypto/bio/bss_dgram.c" 3 4
                          ((((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (
# 1258 "../crypto/bio/bss_dgram.c"
                          sizeof(struct in6_pktinfo)
# 1258 "../crypto/bio/bss_dgram.c" 3 4
                          ))
# 1258 "../crypto/bio/bss_dgram.c"
                                                                  ;
        cmsg->cmsg_level = 
# 1259 "../crypto/bio/bss_dgram.c" 3 4
                          IPPROTO_IPV6
# 1259 "../crypto/bio/bss_dgram.c"
                                      ;
        cmsg->cmsg_type = 
# 1260 "../crypto/bio/bss_dgram.c" 3 4
                          50
# 1260 "../crypto/bio/bss_dgram.c"
                                      ;

        info = (struct in6_pktinfo *)
# 1262 "../crypto/bio/bss_dgram.c" 3 4
                                    ((
# 1262 "../crypto/bio/bss_dgram.c"
                                    cmsg
# 1262 "../crypto/bio/bss_dgram.c" 3 4
                                    )->__cmsg_data)
# 1262 "../crypto/bio/bss_dgram.c"
        ...
        if (local->s_in6.sin6_port != 0
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1272,__func__), ERR_set_error)((32),(150),
# 1272 "../crypto/bio/bss_dgram.c" 3 4
           ((void *)0)
# 1272 "../crypto/bio/bss_dgram.c"
           );
            return 0;
        }
        ...
        if (local->s_in6.sin6_scope_id != 0
            ...
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1278,__func__), ERR_set_error)((32),(150),
# 1278 "../crypto/bio/bss_dgram.c" 3 4
           ((void *)0)
# 1278 "../crypto/bio/bss_dgram.c"
           );
            return 0;
        }
        ...
        mh->msg_controllen = 
# 1285 "../crypto/bio/bss_dgram.c" 3 4
                            ((((
# 1285 "../crypto/bio/bss_dgram.c"
                            sizeof(struct in6_pktinfo)
# 1285 "../crypto/bio/bss_dgram.c" 3 4
                            ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 1285 "../crypto/bio/bss_dgram.c"
                          ...
                          size_t num_msg, uint64_t flags, size_t *num_processed)
{
    ...
    bio_dgram_data *data = (bio_dgram_data *)b->ptr;
    size_t i;
    struct mmsghdr mh[64];
    struct iovec iov[64];
    unsigned char control[64][((
# 1320 "../crypto/bio/bss_dgram.c" 3 4
                                                ((((
# 1320 "../crypto/bio/bss_dgram.c"
                                                sizeof(struct in6_pktinfo)
# 1320 "../crypto/bio/bss_dgram.c" 3 4
                                                ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 1320 "../crypto/bio/bss_dgram.c"
...
# 1342 "../crypto/bio/bss_dgram.c"
    ...
    if (num_msg > ((ssize_t)(
# 1347 "../crypto/bio/bss_dgram.c" 3 4
                 (18446744073709551615UL)
# 1347 "../crypto/bio/bss_dgram.c"
                 >>1)))
        num_msg = ((ssize_t)(
# 1348 "../crypto/bio/bss_dgram.c" 3 4
                 (18446744073709551615UL)
# 1348 "../crypto/bio/bss_dgram.c"
                 >>1));


    sysflags = translate_flags(flags);
# 1362 "../crypto/bio/bss_dgram.c"
    if (num_msg > 64)
        num_msg = 64;

    for (i = 0; i < num_msg; ++i) {
        translate_msg(b, &mh[i].msg_hdr, &iov[i],
                      control[i], &(*(BIO_MSG *)((char *)(msg) + (i)*(stride))));


        if ((*(BIO_MSG *)((char *)(msg) + (i)*(stride))).local != 
# 1370 "../crypto/bio/bss_dgram.c" 3 4
                                              ((void *)0)
# 1370 "../crypto/bio/bss_dgram.c"
                                                  ) {
            if (!have_local_enabled) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1372,__func__), ERR_set_error)((32),(111),
# 1372 "../crypto/bio/bss_dgram.c" 3 4
               ((void *)0)
# 1372 "../crypto/bio/bss_dgram.c"
               );
                *num_processed = 0;
                return 0;
            }
            ...
            if (pack_local(b, &mh[i].msg_hdr,
                           (*(BIO_MSG *)((char *)(msg) + (i)*(stride))).local) < 1) {
                (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1379,__func__), ERR_set_error)((32),(111),
# 1379 "../crypto/bio/bss_dgram.c" 3 4
               ((void *)0)
# 1379 "../crypto/bio/bss_dgram.c"
               );
                *num_processed = 0;
                return 0;
            }
    ...
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1389,__func__), ERR_set_error)((2),(
# 1389 "../crypto/bio/bss_dgram.c" 3 4
       (*__errno_location ())
# 1389 "../crypto/bio/bss_dgram.c"
       ),
# 1389 "../crypto/bio/bss_dgram.c" 3 4
       ((void *)0)
# 1389 "../crypto/bio/bss_dgram.c"
    ...
    for (i = 0; i < (size_t)ret; ++i) {
        (*(BIO_MSG *)((char *)(msg) + (i)*(stride))).data_len = mh[i].msg_len;
        (*(BIO_MSG *)((char *)(msg) + (i)*(stride))).flags = 0;
    }

    *num_processed = (size_t)ret;
    return 1;
# 1506 "../crypto/bio/bss_dgram.c"
}
                          ...
                          uint64_t flags, size_t *num_processed)
{
    ...
    struct iovec iov[64];
    unsigned char control[64][((
# 1521 "../crypto/bio/bss_dgram.c" 3 4
                                                ((((
# 1521 "../crypto/bio/bss_dgram.c"
                                                sizeof(struct in6_pktinfo)
# 1521 "../crypto/bio/bss_dgram.c" 3 4
                                                ) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)) + (((sizeof (struct cmsghdr)) + sizeof (size_t) - 1) & (size_t) ~(sizeof (size_t) - 1)))
# 1521 "../crypto/bio/bss_dgram.c"
...
# 1544 "../crypto/bio/bss_dgram.c"
    ...
    if (num_msg > ((ssize_t)(
# 1549 "../crypto/bio/bss_dgram.c" 3 4
                 (18446744073709551615UL)
# 1549 "../crypto/bio/bss_dgram.c"
                 >>1)))
        num_msg = ((ssize_t)(
# 1550 "../crypto/bio/bss_dgram.c" 3 4
                 (18446744073709551615UL)
# 1550 "../crypto/bio/bss_dgram.c"
                 >>1));


    sysflags = translate_flags(flags);
# 1564 "../crypto/bio/bss_dgram.c"
    if (num_msg > 64)
        num_msg = 64;
    ...
    for (i = 0; i < num_msg; ++i) {
        ...
        if ((*(BIO_MSG *)((char *)(msg) + (i)*(stride))).local != 
# 1572 "../crypto/bio/bss_dgram.c" 3 4
                                              ((void *)0) 
# 1572 "../crypto/bio/bss_dgram.c"
                                                   && !have_local_enabled) {
            (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1573,__func__), ERR_set_error)((32),(111),
# 1573 "../crypto/bio/bss_dgram.c" 3 4
           ((void *)0)
# 1573 "../crypto/bio/bss_dgram.c"
           );
            *num_processed = 0;
            return 0;
        }
    ...
    ret = recvmmsg(b->num, mh, num_msg, sysflags, 
# 1580 "../crypto/bio/bss_dgram.c" 3 4
                                                 ((void *)0)
# 1580 "../crypto/bio/bss_dgram.c"
                                                     );
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../crypto/bio/bss_dgram.c",1582,__func__), ERR_set_error)((2),(
# 1582 "../crypto/bio/bss_dgram.c" 3 4
       (*__errno_location ())
# 1582 "../crypto/bio/bss_dgram.c"
       ),
# 1582 "../crypto/bio/bss_dgram.c" 3 4
       ((void *)0)
# 1582 "../crypto/bio/bss_dgram.c"
    ...
    for (i = 0; i < (size_t)ret; ++i) {
        ...
        if ((*(BIO_MSG *)((char *)(msg) + (i)*(stride))).local != 
# 1594 "../crypto/bio/bss_dgram.c" 3 4
                                              ((void *)0)
# 1594 "../crypto/bio/bss_dgram.c"
                                                  )
    ...
    *num_processed = (size_t)ret;
    return 1;
# 1749 "../crypto/bio/bss_dgram.c"
}
# 2785 "../crypto/bio/bss_dgram.c"
static int BIO_dgram_should_retry(int i)
{
    ...
    if ((i == 0) || (i == -1)) {
        err = 
# 2790 "../crypto/bio/bss_dgram.c" 3 4
             (*__errno_location ())
# 2790 "../crypto/bio/bss_dgram.c"
                                    ;
# 2800 "../crypto/bio/bss_dgram.c"
...
{
    switch (err) {
# 2820 "../crypto/bio/bss_dgram.c"
    case 
# 2820 "../crypto/bio/bss_dgram.c" 3 4
        11
# 2820 "../crypto/bio/bss_dgram.c"
                   :
    ...
    case 
# 2825 "../crypto/bio/bss_dgram.c" 3 4
        4
# 2825 "../crypto/bio/bss_dgram.c"
             :
# 2835 "../crypto/bio/bss_dgram.c"
    case 
# 2835 "../crypto/bio/bss_dgram.c" 3 4
        71
# 2835 "../crypto/bio/bss_dgram.c"
              :
    ...
    case 
# 2839 "../crypto/bio/bss_dgram.c" 3 4
        115
# 2839 "../crypto/bio/bss_dgram.c"
                   :



    case 
# 2843 "../crypto/bio/bss_dgram.c" 3 4
        114
# 2843 "../crypto/bio/bss_dgram.c"
                :
