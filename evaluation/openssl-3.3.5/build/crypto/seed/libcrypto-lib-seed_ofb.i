# 0 "../crypto/seed/seed_ofb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/seed/seed_ofb.c"
# 14 "../crypto/seed/seed_ofb.c"
