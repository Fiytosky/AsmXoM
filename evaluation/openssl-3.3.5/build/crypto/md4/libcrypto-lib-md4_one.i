# 0 "../crypto/md4/md4_one.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/md4/md4_one.c"
# 14 "../crypto/md4/md4_one.c"
...
unsigned char *MD4(const unsigned char *d, size_t n, unsigned char *md)
{
    ...
    if (md == 
# 30 "../crypto/md4/md4_one.c" 3 4
             ((void *)0)
# 30 "../crypto/md4/md4_one.c"
                 )
        md = m;
    if (!MD4_Init(&c))
        return 
# 33 "../crypto/md4/md4_one.c" 3 4
              ((void *)0)
# 33 "../crypto/md4/md4_one.c"
                  ;

    MD4_Update(&c, d, n);
# 50 "../crypto/md4/md4_one.c"
    MD4_Final(md, &c);
