...
# 1 "../crypto/LPdir_unix.c" 1
# 39 "../crypto/LPdir_unix.c"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 40 "../crypto/LPdir_unix.c" 2

# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/limits.h" 1 3 4
# 42 "../crypto/LPdir_unix.c" 2
...
# 45 "../crypto/LPdir_unix.c" 2
# 76 "../crypto/LPdir_unix.c"

# 76 "../crypto/LPdir_unix.c"
struct OPENSSL_dir_context_st {
    DIR *dir;
    char entry_name[
# 78 "../crypto/LPdir_unix.c" 3 4
                   4096 
# 78 "../crypto/LPdir_unix.c"
                                 + 1];
...
# 87 "../crypto/LPdir_unix.c" 3 4
                             ((void *)0)
# 87 "../crypto/LPdir_unix.c"
                                 ;

    if (ctx == 
# 89 "../crypto/LPdir_unix.c" 3 4
              ((void *)0) 
# 89 "../crypto/LPdir_unix.c"
                   || directory == 
# 89 "../crypto/LPdir_unix.c" 3 4
                                   ((void *)0)
# 89 "../crypto/LPdir_unix.c"
...
# 90 "../crypto/LPdir_unix.c" 3 4
       (*__errno_location ()) 
# 90 "../crypto/LPdir_unix.c"
             = 
# 90 "../crypto/LPdir_unix.c" 3 4
               22
# 90 "../crypto/LPdir_unix.c"
...
# 94 "../crypto/LPdir_unix.c" 3 4
   (*__errno_location ()) 
# 94 "../crypto/LPdir_unix.c"
         = 0;
    if (*ctx == 
# 95 "../crypto/LPdir_unix.c" 3 4
               ((void *)0)
# 95 "../crypto/LPdir_unix.c"
                   ) {
        *ctx = malloc(sizeof(**ctx));
        if (*ctx == 
# 97 "../crypto/LPdir_unix.c" 3 4
                   ((void *)0)
# 97 "../crypto/LPdir_unix.c"
                       ) {
            
# 98 "../crypto/LPdir_unix.c" 3 4
           (*__errno_location ()) 
# 98 "../crypto/LPdir_unix.c"
                 = 
# 98 "../crypto/LPdir_unix.c" 3 4
                   12
# 98 "../crypto/LPdir_unix.c"
...
# 112 "../crypto/LPdir_unix.c"
        (*ctx)->dir = opendir(directory);
        if ((*ctx)->dir == 
# 113 "../crypto/LPdir_unix.c" 3 4
                          ((void *)0)
# 113 "../crypto/LPdir_unix.c"
                              ) {
            int save_errno = 
# 114 "../crypto/LPdir_unix.c" 3 4
                            (*__errno_location ())
# 114 "../crypto/LPdir_unix.c"
                                 ;
            free(*ctx);
            *ctx = 
# 116 "../crypto/LPdir_unix.c" 3 4
                  ((void *)0)
# 116 "../crypto/LPdir_unix.c"
                      ;
            
# 117 "../crypto/LPdir_unix.c" 3 4
           (*__errno_location ()) 
# 117 "../crypto/LPdir_unix.c"
                 = save_errno;
            return 0;
        }
    }
# 129 "../crypto/LPdir_unix.c"
    direntry = readdir((*ctx)->dir);
    if (direntry == 
# 130 "../crypto/LPdir_unix.c" 3 4
                   ((void *)0)
# 130 "../crypto/LPdir_unix.c"
                       ) {
        return 0;
    }
...
{
    if (ctx != 
# 154 "../crypto/LPdir_unix.c" 3 4
              ((void *)0) 
# 154 "../crypto/LPdir_unix.c"
                   && *ctx != 
# 154 "../crypto/LPdir_unix.c" 3 4
                              ((void *)0)
# 154 "../crypto/LPdir_unix.c"
...
# 167 "../crypto/LPdir_unix.c" 3 4
   (*__errno_location ()) 
# 167 "../crypto/LPdir_unix.c"
         = 
# 167 "../crypto/LPdir_unix.c" 3 4
           22
# 167 "../crypto/LPdir_unix.c"
