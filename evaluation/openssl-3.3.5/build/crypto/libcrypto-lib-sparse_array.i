                     ...
                     void (*leaf)(ossl_uintmax_t, void *, void *), void *arg)
{
    ...
    while (l >= 0) {
        ...
        if (n >= (1 << 4)) {
            if (p != 
# 80 "../crypto/sparse_array.c" 3 4
                    ((void *)0) 
# 80 "../crypto/sparse_array.c"
                         && node != 
# 80 "../crypto/sparse_array.c" 3 4
                                    ((void *)0)
# 80 "../crypto/sparse_array.c"
            ...
            i[l] = n + 1;
            if (p != 
# 86 "../crypto/sparse_array.c" 3 4
                    ((void *)0) 
# 86 "../crypto/sparse_array.c"
                         && p[n] != 
# 86 "../crypto/sparse_array.c" 3 4
                                    ((void *)0)
# 86 "../crypto/sparse_array.c"
...
# 92 "../crypto/sparse_array.c" 3 4
                                  ((void *)0)
# 92 "../crypto/sparse_array.c"
                                      ) {
                    (*leaf)(idx, p[n], arg);
                }
            }
...
{
    CRYPTO_free(p, "../crypto/sparse_array.c", 107);
}

void ossl_sa_free(OPENSSL_SA *sa)
{
    if (sa != 
# 112 "../crypto/sparse_array.c" 3 4
             ((void *)0)
# 112 "../crypto/sparse_array.c"
                 ) {
        sa_doall(sa, &sa_free_node, 
# 113 "../crypto/sparse_array.c" 3 4
                                   ((void *)0)
# 113 "../crypto/sparse_array.c"
                                       , 
# 113 "../crypto/sparse_array.c" 3 4
                                         ((void *)0)
# 113 "../crypto/sparse_array.c"
...
void ossl_sa_free_leaves(OPENSSL_SA *sa)
{
    sa_doall(sa, &sa_free_node, &sa_free_leaf, 
# 120 "../crypto/sparse_array.c" 3 4
                                              ((void *)0)
# 120 "../crypto/sparse_array.c"
                                                  );
    CRYPTO_free(sa, "../crypto/sparse_array.c", 121);
}
...
void ossl_sa_doall(const OPENSSL_SA *sa, void (*leaf)(ossl_uintmax_t, void *))
{
    ...
    tramp.func = leaf;
    if (sa != 
# 139 "../crypto/sparse_array.c" 3 4
             ((void *)0)
# 139 "../crypto/sparse_array.c"
                 )
        sa_doall(sa, 
# 140 "../crypto/sparse_array.c" 3 4
                    ((void *)0)
# 140 "../crypto/sparse_array.c"
                        , &trampoline, &tramp);
}
...
{
    if (sa != 
# 147 "../crypto/sparse_array.c" 3 4
             ((void *)0)
# 147 "../crypto/sparse_array.c"
                 )
        sa_doall(sa, 
# 148 "../crypto/sparse_array.c" 3 4
                    ((void *)0)
# 148 "../crypto/sparse_array.c"
                        , leaf, arg);
}
...
{
    return sa == 
# 153 "../crypto/sparse_array.c" 3 4
                ((void *)0) 
# 153 "../crypto/sparse_array.c"
                     ? 0 : sa->nelem;
}
...
void *ossl_sa_get(const OPENSSL_SA *sa, ossl_uintmax_t n)
{
    int level;
    void **p, *r = 
# 159 "../crypto/sparse_array.c" 3 4
                  ((void *)0)
# 159 "../crypto/sparse_array.c"
                      ;

    if (sa == 
# 161 "../crypto/sparse_array.c" 3 4
             ((void *)0) 
# 161 "../crypto/sparse_array.c"
                  || sa->nelem == 0)
        return 
# 162 "../crypto/sparse_array.c" 3 4
              ((void *)0)
# 162 "../crypto/sparse_array.c"
                  ;

    if (n <= sa->top) {
        p = sa->nodes;
        for (level = sa->levels - 1; p != 
# 166 "../crypto/sparse_array.c" 3 4
                                         ((void *)0) 
# 166 "../crypto/sparse_array.c"
                                              && level > 0; level--)
            p = (void **)p[(n >> (4 * level))
                           & ((1 << 4) - 1)];
        r = p == 
# 169 "../crypto/sparse_array.c" 3 4
                ((void *)0) 
# 169 "../crypto/sparse_array.c"
                     ? 
# 169 "../crypto/sparse_array.c" 3 4
                       ((void *)0) 
# 169 "../crypto/sparse_array.c"
...
int ossl_sa_set(OPENSSL_SA *sa, ossl_uintmax_t posn, void *val)
{
    ...
    if (sa == 
# 185 "../crypto/sparse_array.c" 3 4
             ((void *)0)
# 185 "../crypto/sparse_array.c"
                 )
        return 0;
    ...
    for (;sa->levels < level; sa->levels++) {
        p = alloc_node();
        if (p == 
# 194 "../crypto/sparse_array.c" 3 4
                ((void *)0)
# 194 "../crypto/sparse_array.c"
                    )
            return 0;
        p[0] = sa->nodes;
        sa->nodes = p;
    ...
    for (level = sa->levels - 1; level > 0; level--) {
        ...
        if (p[i] == 
# 205 "../crypto/sparse_array.c" 3 4
                   ((void *)0) 
# 205 "../crypto/sparse_array.c"
                        && (p[i] = alloc_node()) == 
# 205 "../crypto/sparse_array.c" 3 4
                                                    ((void *)0)
# 205 "../crypto/sparse_array.c"
    ...
    p += posn & ((1 << 4) - 1);
    if (val == 
# 210 "../crypto/sparse_array.c" 3 4
              ((void *)0) 
# 210 "../crypto/sparse_array.c"
                   && *p != 
# 210 "../crypto/sparse_array.c" 3 4
                            ((void *)0)
# 210 "../crypto/sparse_array.c"
...
# 212 "../crypto/sparse_array.c" 3 4
                   ((void *)0) 
# 212 "../crypto/sparse_array.c"
                        && *p == 
# 212 "../crypto/sparse_array.c" 3 4
                                 ((void *)0)
# 212 "../crypto/sparse_array.c"
