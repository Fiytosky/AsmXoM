# 0 "../crypto/dsa/dsa_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_meth.c"
# 14 "../crypto/dsa/dsa_meth.c"
...
# 18 "../crypto/dsa/dsa_meth.c" 2




# 21 "../crypto/dsa/dsa_meth.c"
DSA_METHOD *DSA_meth_new(const char *name, int flags)
{
    DSA_METHOD *dsam = CRYPTO_zalloc(sizeof(*dsam), "../crypto/dsa/dsa_meth.c", 23);

    if (dsam != 
# 25 "../crypto/dsa/dsa_meth.c" 3 4
               ((void *)0)
# 25 "../crypto/dsa/dsa_meth.c"
                   ) {
        dsam->flags = flags;

        dsam->name = CRYPTO_strdup(name, "../crypto/dsa/dsa_meth.c", 28);
        if (dsam->name != 
# 29 "../crypto/dsa/dsa_meth.c" 3 4
                         ((void *)0)
# 29 "../crypto/dsa/dsa_meth.c"
                             )
            return dsam;

        CRYPTO_free(dsam, "../crypto/dsa/dsa_meth.c", 32);
    }

    return 
# 35 "../crypto/dsa/dsa_meth.c" 3 4
          ((void *)0)
# 35 "../crypto/dsa/dsa_meth.c"
              ;
}
...
{
    if (dsam != 
# 40 "../crypto/dsa/dsa_meth.c" 3 4
               ((void *)0)
# 40 "../crypto/dsa/dsa_meth.c"
                   ) {
        CRYPTO_free(dsam->name, "../crypto/dsa/dsa_meth.c", 41);
        CRYPTO_free(dsam, "../crypto/dsa/dsa_meth.c", 42);
    }
}

DSA_METHOD *DSA_meth_dup(const DSA_METHOD *dsam)
{
    DSA_METHOD *ret = CRYPTO_malloc(sizeof(*ret), "../crypto/dsa/dsa_meth.c", 48);

    if (ret != 
# 50 "../crypto/dsa/dsa_meth.c" 3 4
              ((void *)0)
# 50 "../crypto/dsa/dsa_meth.c"
                  ) {
        memcpy(ret, dsam, sizeof(*dsam));

        ret->name = CRYPTO_strdup(dsam->name, "../crypto/dsa/dsa_meth.c", 53);
        if (ret->name != 
# 54 "../crypto/dsa/dsa_meth.c" 3 4
                        ((void *)0)
# 54 "../crypto/dsa/dsa_meth.c"
                            )
            return ret;

        CRYPTO_free(ret, "../crypto/dsa/dsa_meth.c", 57);
    }

    return 
# 60 "../crypto/dsa/dsa_meth.c" 3 4
          ((void *)0)
# 60 "../crypto/dsa/dsa_meth.c"
              ;
}
...
{
    char *tmpname = CRYPTO_strdup(name, "../crypto/dsa/dsa_meth.c", 70);

    if (tmpname == 
# 72 "../crypto/dsa/dsa_meth.c" 3 4
                  ((void *)0)
# 72 "../crypto/dsa/dsa_meth.c"
                      )
        return 0;

    CRYPTO_free(dsam->name, "../crypto/dsa/dsa_meth.c", 75);
    dsam->name = tmpname;
