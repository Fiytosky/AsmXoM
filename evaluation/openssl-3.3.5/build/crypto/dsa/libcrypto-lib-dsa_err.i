# 0 "../crypto/dsa/dsa_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_err.c"
# 11 "../crypto/dsa/dsa_err.c"
...
static const ERR_STRING_DATA DSA_str_reasons[] = {
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ), "bad ffc parameters"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ), "bad q value"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ), "bn decode error"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "bn error"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "decode error"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "invalid digest type"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "invalid parameters"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "missing parameters"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "missing private key"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "modulus too large"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ), "no parameters set"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "parameter encoding error"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ), "p not prime"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "q not prime"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "seed_len is less than the length of q"},
    {( (((unsigned long)(10) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ), "too many retries"},
    {0, 
# 40 "../crypto/dsa/dsa_err.c" 3 4
       ((void *)0)
# 40 "../crypto/dsa/dsa_err.c"
           }
};
...
int ossl_err_load_DSA_strings(void)
{
    ...
    if (ERR_reason_error_string(DSA_str_reasons[0].error) == 
# 48 "../crypto/dsa/dsa_err.c" 3 4
                                                            ((void *)0)
# 48 "../crypto/dsa/dsa_err.c"
                                                                )
