# 0 "../crypto/dsa/dsa_pmeth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_pmeth.c"
# 14 "../crypto/dsa/dsa_pmeth.c"
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 23 "../crypto/dsa/dsa_pmeth.c" 2
# 1 "../crypto/dsa/dsa_local.h" 1
# 12 "../crypto/dsa/dsa_local.h"
...
{
    DSA_PKEY_CTX *dctx = CRYPTO_malloc(sizeof(*dctx), "../crypto/dsa/dsa_pmeth.c", 40);

    if (dctx == 
# 42 "../crypto/dsa/dsa_pmeth.c" 3 4
               ((void *)0)
# 42 "../crypto/dsa/dsa_pmeth.c"
                   )
        return 0;
    dctx->nbits = 2048;
    dctx->qbits = 224;
    dctx->pmd = 
# 46 "../crypto/dsa/dsa_pmeth.c" 3 4
               ((void *)0)
# 46 "../crypto/dsa/dsa_pmeth.c"
                   ;
    dctx->md = 
# 47 "../crypto/dsa/dsa_pmeth.c" 3 4
              ((void *)0)
# 47 "../crypto/dsa/dsa_pmeth.c"
                  ;
...
static void pkey_dsa_cleanup(EVP_PKEY_CTX *ctx)
{
    ...
    CRYPTO_free(dctx, "../crypto/dsa/dsa_pmeth.c", 74);
}
                         ...
                         size_t tbslen)
{
    ...
    if (dctx->md != 
# 91 "../crypto/dsa/dsa_pmeth.c" 3 4
                   ((void *)0) 
# 91 "../crypto/dsa/dsa_pmeth.c"
                        && tbslen != (size_t)EVP_MD_get_size(dctx->md))
        return 0;
                           ...
                           const unsigned char *tbs, size_t tbslen)
{
    ...
    if (dctx->md != 
# 115 "../crypto/dsa/dsa_pmeth.c" 3 4
                   ((void *)0) 
# 115 "../crypto/dsa/dsa_pmeth.c"
                        && tbslen != (size_t)EVP_MD_get_size(dctx->md))
        return 0;
...
static int pkey_dsa_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2)
{
    ...
    case (0x1000 + 3):
        if (EVP_MD_get_type((const EVP_MD *)p2) != 64 &&
            ...
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_pmeth.c",144,__func__), ERR_set_error)((10),(106),
# 144 "../crypto/dsa/dsa_pmeth.c" 3 4
           ((void *)0)
# 144 "../crypto/dsa/dsa_pmeth.c"
           );
            return 0;
        }
        dctx->pmd = p2;
    ...
    case 1:
        if (EVP_MD_get_type((const EVP_MD *)p2) != 64 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 116 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 66 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 675 &&
            EVP_MD_get_type((const EVP_MD *)p2) != 672 &&
            ...
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_pmeth.c",162,__func__), ERR_set_error)((10),(106),
# 162 "../crypto/dsa/dsa_pmeth.c" 3 4
           ((void *)0)
# 162 "../crypto/dsa/dsa_pmeth.c"
           );
            return 0;
        }
        dctx->md = p2;
    ...
    case 2:
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_pmeth.c",178,__func__), ERR_set_error)((10),(150),
# 178 "../crypto/dsa/dsa_pmeth.c" 3 4
       ((void *)0)
# 178 "../crypto/dsa/dsa_pmeth.c"
       );
        return -2;
    default:
        return -2;
                             ...
                             const char *type, const char *value)
{
    ...
    if (strcmp(type, "dsa_paramgen_md") == 0) {
        ...
        if (md == 
# 201 "../crypto/dsa/dsa_pmeth.c" 3 4
                 ((void *)0)
# 201 "../crypto/dsa/dsa_pmeth.c"
                     ) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_pmeth.c",202,__func__), ERR_set_error)((10),(106),
# 202 "../crypto/dsa/dsa_pmeth.c" 3 4
           ((void *)0)
# 202 "../crypto/dsa/dsa_pmeth.c"
           );
            return 0;
        }
...
{
    DSA *dsa = 
# 212 "../crypto/dsa/dsa_pmeth.c" 3 4
              ((void *)0)
# 212 "../crypto/dsa/dsa_pmeth.c"
                  ;
    DSA_PKEY_CTX *dctx = ctx->data;
    BN_GENCB *pcb;
    int ret, res;
    ...
    if (ctx->pkey_gencb) {
        pcb = BN_GENCB_new();
        if (pcb == 
# 219 "../crypto/dsa/dsa_pmeth.c" 3 4
                  ((void *)0)
# 219 "../crypto/dsa/dsa_pmeth.c"
                      )
            return 0;
        evp_pkey_set_cb_translate(pcb, ctx);
    } else
        pcb = 
# 223 "../crypto/dsa/dsa_pmeth.c" 3 4
             ((void *)0)
# 223 "../crypto/dsa/dsa_pmeth.c"
                 ;
    dsa = DSA_new();
    if (dsa == 
# 225 "../crypto/dsa/dsa_pmeth.c" 3 4
              ((void *)0)
# 225 "../crypto/dsa/dsa_pmeth.c"
                  ) {
        BN_GENCB_free(pcb);
        return 0;
    }
    if (dctx->md != 
# 229 "../crypto/dsa/dsa_pmeth.c" 3 4
                   ((void *)0)
# 229 "../crypto/dsa/dsa_pmeth.c"
                       )
        ossl_ffc_set_digest(&dsa->params, EVP_MD_get0_name(dctx->md), 
# 230 "../crypto/dsa/dsa_pmeth.c" 3 4
                                                                     ((void *)0)
# 230 "../crypto/dsa/dsa_pmeth.c"
                                                                         );

    ret = ossl_ffc_params_FIPS186_4_generate(
# 232 "../crypto/dsa/dsa_pmeth.c" 3 4
                                            ((void *)0)
...
{
    DSA *dsa = 
# 245 "../crypto/dsa/dsa_pmeth.c" 3 4
              ((void *)0)
# 245 "../crypto/dsa/dsa_pmeth.c"
                  ;

    if (ctx->pkey == 
# 247 "../crypto/dsa/dsa_pmeth.c" 3 4
                    ((void *)0)
# 247 "../crypto/dsa/dsa_pmeth.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_pmeth.c",248,__func__), ERR_set_error)((10),(107),
# 248 "../crypto/dsa/dsa_pmeth.c" 3 4
       ((void *)0)
# 248 "../crypto/dsa/dsa_pmeth.c"
       );
        return 0;
    }
    dsa = DSA_new();
    if (dsa == 
# 252 "../crypto/dsa/dsa_pmeth.c" 3 4
              ((void *)0)
# 252 "../crypto/dsa/dsa_pmeth.c"
                  )
        return 0;
    EVP_PKEY_assign((pkey),116, (dsa));
