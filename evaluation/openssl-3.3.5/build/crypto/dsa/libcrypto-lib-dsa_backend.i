# 0 "../crypto/dsa/dsa_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_backend.c"
# 14 "../crypto/dsa/dsa_backend.c"
...
# 15 "../crypto/dsa/dsa_backend.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../crypto/dsa/dsa_backend.c" 2
...
# 22 "../crypto/dsa/dsa_backend.c" 2
# 1 "../crypto/dsa/dsa_local.h" 1
# 11 "../crypto/dsa/dsa_local.h"
...
# 33 "../crypto/dsa/dsa_backend.c" 3 4
                                      ((void *)0)
# 33 "../crypto/dsa/dsa_backend.c"
                                          , *param_pub_key;
    BIGNUM *priv_key = 
# 34 "../crypto/dsa/dsa_backend.c" 3 4
                      ((void *)0)
# 34 "../crypto/dsa/dsa_backend.c"
                          , *pub_key = 
# 34 "../crypto/dsa/dsa_backend.c" 3 4
                                       ((void *)0)
# 34 "../crypto/dsa/dsa_backend.c"
    ...
    if (dsa == 
# 36 "../crypto/dsa/dsa_backend.c" 3 4
              ((void *)0)
# 36 "../crypto/dsa/dsa_backend.c"
                  )
        return 0;
    ...
    if (param_priv_key == 
# 47 "../crypto/dsa/dsa_backend.c" 3 4
                         ((void *)0) 
# 47 "../crypto/dsa/dsa_backend.c"
                              && param_pub_key == 
# 47 "../crypto/dsa/dsa_backend.c" 3 4
                                                  ((void *)0)
# 47 "../crypto/dsa/dsa_backend.c"
    ...
    if (param_pub_key != 
# 50 "../crypto/dsa/dsa_backend.c" 3 4
                        ((void *)0) 
# 50 "../crypto/dsa/dsa_backend.c"
                             && !OSSL_PARAM_get_BN(param_pub_key, &pub_key))
        goto err;
    if (param_priv_key != 
# 52 "../crypto/dsa/dsa_backend.c" 3 4
                         ((void *)0) 
# 52 "../crypto/dsa/dsa_backend.c"
...
int ossl_dsa_is_foreign(const DSA *dsa)
{
    ...
    if (dsa->engine != 
# 69 "../crypto/dsa/dsa_backend.c" 3 4
                      ((void *)0) 
# 69 "../crypto/dsa/dsa_backend.c"
                           || DSA_get_method((DSA *)dsa) != DSA_OpenSSL())
        return 1;
...
{
    if (f != 
# 77 "../crypto/dsa/dsa_backend.c" 3 4
            ((void *)0) 
# 77 "../crypto/dsa/dsa_backend.c"
                 && (*out = BN_dup(f)) == 
# 77 "../crypto/dsa/dsa_backend.c" 3 4
                                          ((void *)0)
# 77 "../crypto/dsa/dsa_backend.c"
...
{
    DSA *dupkey = 
# 84 "../crypto/dsa/dsa_backend.c" 3 4
                 ((void *)0)
# 84 "../crypto/dsa/dsa_backend.c"
                     ;


    if (ossl_dsa_is_foreign(dsa))
        return 
# 88 "../crypto/dsa/dsa_backend.c" 3 4
              ((void *)0)
# 88 "../crypto/dsa/dsa_backend.c"
                  ;

    if ((dupkey = ossl_dsa_new(dsa->libctx)) == 
# 90 "../crypto/dsa/dsa_backend.c" 3 4
                                               ((void *)0)
# 90 "../crypto/dsa/dsa_backend.c"
                                                   )
        return 
# 91 "../crypto/dsa/dsa_backend.c" 3 4
              ((void *)0)
# 91 "../crypto/dsa/dsa_backend.c"
                  ;
 ...
 err:
    DSA_free(dupkey);
    return 
# 119 "../crypto/dsa/dsa_backend.c" 3 4
          ((void *)0)
...
# 132 "../crypto/dsa/dsa_backend.c" 3 4
                           ((void *)0)
# 132 "../crypto/dsa/dsa_backend.c"
                               ;
    const BIGNUM *dsa_p, *dsa_g;
    BIGNUM *dsa_pubkey = 
# 134 "../crypto/dsa/dsa_backend.c" 3 4
                        ((void *)0)
# 134 "../crypto/dsa/dsa_backend.c"
                            , *dsa_privkey = 
# 134 "../crypto/dsa/dsa_backend.c" 3 4
                                             ((void *)0)
# 134 "../crypto/dsa/dsa_backend.c"
                                                 ;
    BN_CTX *ctx = 
# 135 "../crypto/dsa/dsa_backend.c" 3 4
                 ((void *)0)
# 135 "../crypto/dsa/dsa_backend.c"
                     ;

    DSA *dsa = 
# 137 "../crypto/dsa/dsa_backend.c" 3 4
              ((void *)0)
# 137 "../crypto/dsa/dsa_backend.c"
                  ;

    if (!PKCS8_pkey_get0(
# 139 "../crypto/dsa/dsa_backend.c" 3 4
                        ((void *)0)
# 139 "../crypto/dsa/dsa_backend.c"
                            , &p, &pklen, &palg, p8inf))
        return 0;
    X509_ALGOR_get0(
# 141 "../crypto/dsa/dsa_backend.c" 3 4
                   ((void *)0)
# 141 "../crypto/dsa/dsa_backend.c"
                       , &ptype, &pval, palg);

    if ((privkey = d2i_ASN1_INTEGER(
# 143 "../crypto/dsa/dsa_backend.c" 3 4
                                   ((void *)0)
# 143 "../crypto/dsa/dsa_backend.c"
                                       , &p, pklen)) == 
# 143 "../crypto/dsa/dsa_backend.c" 3 4
                                                        ((void *)0)
# 143 "../crypto/dsa/dsa_backend.c"
        ...
        goto decerr;
    if (privkey->type == (2 | 0x100) || ptype != 16)
        goto decerr;
...
# 151 "../crypto/dsa/dsa_backend.c" 3 4
                            ((void *)0)
# 151 "../crypto/dsa/dsa_backend.c"
                                , &pm, pmlen)) == 
# 151 "../crypto/dsa/dsa_backend.c" 3 4
                                                  ((void *)0)
# 151 "../crypto/dsa/dsa_backend.c"
    ...
    if ((dsa_privkey = BN_secure_new()) == 
# 154 "../crypto/dsa/dsa_backend.c" 3 4
                                          ((void *)0)
        
# 155 "../crypto/dsa/dsa_backend.c"
       || !ASN1_INTEGER_to_BN(privkey, dsa_privkey)) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",156,__func__), ERR_set_error)((10),(109),
# 156 "../crypto/dsa/dsa_backend.c" 3 4
       ((void *)0)
# 156 "../crypto/dsa/dsa_backend.c"
       );
        goto dsaerr;
    }

    if ((dsa_pubkey = BN_new()) == 
# 160 "../crypto/dsa/dsa_backend.c" 3 4
                                  ((void *)0)
# 160 "../crypto/dsa/dsa_backend.c"
                                      ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",161,__func__), ERR_set_error)((10),((3 | (0x2 << 18L))),
# 161 "../crypto/dsa/dsa_backend.c" 3 4
       ((void *)0)
# 161 "../crypto/dsa/dsa_backend.c"
       );
        goto dsaerr;
    }
    if ((ctx = BN_CTX_new()) == 
# 164 "../crypto/dsa/dsa_backend.c" 3 4
                               ((void *)0)
# 164 "../crypto/dsa/dsa_backend.c"
                                   ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",165,__func__), ERR_set_error)((10),((3 | (0x2 << 18L))),
# 165 "../crypto/dsa/dsa_backend.c" 3 4
       ((void *)0)
# 165 "../crypto/dsa/dsa_backend.c"
       );
        goto dsaerr;
    }
    ...
    BN_set_flags(dsa_privkey, 0x04);
    if (!BN_mod_exp(dsa_pubkey, dsa_g, dsa_privkey, dsa_p, ctx)) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",173,__func__), ERR_set_error)((10),(109),
# 173 "../crypto/dsa/dsa_backend.c" 3 4
       ((void *)0)
# 173 "../crypto/dsa/dsa_backend.c"
       );
        goto dsaerr;
    }
    if (!DSA_set0_key(dsa, dsa_pubkey, dsa_privkey)) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",177,__func__), ERR_set_error)((10),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 177 "../crypto/dsa/dsa_backend.c" 3 4
       ((void *)0)
# 177 "../crypto/dsa/dsa_backend.c"
       );
        goto dsaerr;
    }
 ...
 decerr:
    (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_backend.c",184,__func__), ERR_set_error)((10),(104),
# 184 "../crypto/dsa/dsa_backend.c" 3 4
   ((void *)0)
# 184 "../crypto/dsa/dsa_backend.c"
   );
 dsaerr:
    BN_free(dsa_privkey);
    BN_free(dsa_pubkey);
    DSA_free(dsa);
    dsa = 
# 189 "../crypto/dsa/dsa_backend.c" 3 4
         ((void *)0)
# 189 "../crypto/dsa/dsa_backend.c"
             ;
 done:
    BN_CTX_free(ctx);
