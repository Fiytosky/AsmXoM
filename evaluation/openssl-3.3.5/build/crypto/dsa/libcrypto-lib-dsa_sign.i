# 0 "../crypto/dsa/dsa_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_sign.c"
# 14 "../crypto/dsa/dsa_sign.c"
...
DSA_SIG *DSA_SIG_new(void)
{
    DSA_SIG *sig = CRYPTO_zalloc(sizeof(*sig), "../crypto/dsa/dsa_sign.c", 36);
...
{
    if (sig == 
# 43 "../crypto/dsa/dsa_sign.c" 3 4
              ((void *)0)
# 43 "../crypto/dsa/dsa_sign.c"
                  )
        return;
    BN_clear_free(sig->r);
    BN_clear_free(sig->s);
    CRYPTO_free(sig, "../crypto/dsa/dsa_sign.c", 47);
}
...
DSA_SIG *d2i_DSA_SIG(DSA_SIG **psig, const unsigned char **ppin, long len)
{
    ...
    if (len < 0)
        return 
# 55 "../crypto/dsa/dsa_sign.c" 3 4
              ((void *)0)
# 55 "../crypto/dsa/dsa_sign.c"
                  ;
    if (psig != 
# 56 "../crypto/dsa/dsa_sign.c" 3 4
               ((void *)0) 
# 56 "../crypto/dsa/dsa_sign.c"
                    && *psig != 
# 56 "../crypto/dsa/dsa_sign.c" 3 4
                                ((void *)0)
# 56 "../crypto/dsa/dsa_sign.c"
        ...
        sig = DSA_SIG_new();
        if (sig == 
# 60 "../crypto/dsa/dsa_sign.c" 3 4
                  ((void *)0)
# 60 "../crypto/dsa/dsa_sign.c"
                      )
            return 
# 61 "../crypto/dsa/dsa_sign.c" 3 4
                  ((void *)0)
# 61 "../crypto/dsa/dsa_sign.c"
                      ;
    }
    if (sig->r == 
# 63 "../crypto/dsa/dsa_sign.c" 3 4
                 ((void *)0)
# 63 "../crypto/dsa/dsa_sign.c"
                     )
        sig->r = BN_new();
    if (sig->s == 
# 65 "../crypto/dsa/dsa_sign.c" 3 4
                 ((void *)0)
# 65 "../crypto/dsa/dsa_sign.c"
                     )
        sig->s = BN_new();
    if (sig->r == 
# 67 "../crypto/dsa/dsa_sign.c" 3 4
                 ((void *)0) 
# 67 "../crypto/dsa/dsa_sign.c"
                      || sig->s == 
# 67 "../crypto/dsa/dsa_sign.c" 3 4
                                   ((void *)0)
        
# 68 "../crypto/dsa/dsa_sign.c"
       || ossl_decode_der_dsa_sig(sig->r, sig->s, ppin, (size_t)len) == 0) {
        if (psig == 
# 69 "../crypto/dsa/dsa_sign.c" 3 4
                   ((void *)0) 
# 69 "../crypto/dsa/dsa_sign.c"
                        || *psig == 
# 69 "../crypto/dsa/dsa_sign.c" 3 4
                                    ((void *)0)
# 69 "../crypto/dsa/dsa_sign.c"
            ...
            DSA_SIG_free(sig);
        return 
# 71 "../crypto/dsa/dsa_sign.c" 3 4
              ((void *)0)
# 71 "../crypto/dsa/dsa_sign.c"
                  ;
    }
    if (psig != 
# 73 "../crypto/dsa/dsa_sign.c" 3 4
               ((void *)0) 
# 73 "../crypto/dsa/dsa_sign.c"
                    && *psig == 
# 73 "../crypto/dsa/dsa_sign.c" 3 4
                                ((void *)0)
# 73 "../crypto/dsa/dsa_sign.c"
...
{
    BUF_MEM *buf = 
# 80 "../crypto/dsa/dsa_sign.c" 3 4
                  ((void *)0)
# 80 "../crypto/dsa/dsa_sign.c"
                      ;
    size_t encoded_len;
    WPACKET pkt;

    if (ppout == 
# 84 "../crypto/dsa/dsa_sign.c" 3 4
                ((void *)0)
# 84 "../crypto/dsa/dsa_sign.c"
                    ) {
        if (!WPACKET_init_null(&pkt, 0))
            return -1;
    } else if (*ppout == 
# 87 "../crypto/dsa/dsa_sign.c" 3 4
                        ((void *)0)
# 87 "../crypto/dsa/dsa_sign.c"
                            ) {
        if ((buf = BUF_MEM_new()) == 
# 88 "../crypto/dsa/dsa_sign.c" 3 4
                                    ((void *)0)
                
# 89 "../crypto/dsa/dsa_sign.c"
...
# 94 "../crypto/dsa/dsa_sign.c" 3 4
                                                  (18446744073709551615UL)
# 94 "../crypto/dsa/dsa_sign.c"
                                                          , 0))
            return -1;
    }
    ...
    if (ppout != 
# 106 "../crypto/dsa/dsa_sign.c" 3 4
                ((void *)0)
# 106 "../crypto/dsa/dsa_sign.c"
                    ) {
        if (*ppout == 
# 107 "../crypto/dsa/dsa_sign.c" 3 4
                     ((void *)0)
# 107 "../crypto/dsa/dsa_sign.c"
                         ) {
            *ppout = (unsigned char *)buf->data;
            buf->data = 
# 109 "../crypto/dsa/dsa_sign.c" 3 4
                       ((void *)0)
# 109 "../crypto/dsa/dsa_sign.c"
                           ;
            BUF_MEM_free(buf);
        } else {
            *ppout += encoded_len;
...
int DSA_size(const DSA *dsa)
{
    ...
    if (dsa->params.q != 
# 124 "../crypto/dsa/dsa_sign.c" 3 4
                        ((void *)0)
# 124 "../crypto/dsa/dsa_sign.c"
                            ) {
        sig.r = sig.s = dsa->params.q;
        ret = i2d_DSA_SIG(&sig, 
# 126 "../crypto/dsa/dsa_sign.c" 3 4
                               ((void *)0)
# 126 "../crypto/dsa/dsa_sign.c"
                                   );
...
{
    if (pr != 
# 136 "../crypto/dsa/dsa_sign.c" 3 4
             ((void *)0)
# 136 "../crypto/dsa/dsa_sign.c"
                 )
        *pr = sig->r;
    if (ps != 
# 138 "../crypto/dsa/dsa_sign.c" 3 4
             ((void *)0)
# 138 "../crypto/dsa/dsa_sign.c"
                 )
        *ps = sig->s;
}
...
{
    if (r == 
# 144 "../crypto/dsa/dsa_sign.c" 3 4
            ((void *)0) 
# 144 "../crypto/dsa/dsa_sign.c"
                 || s == 
# 144 "../crypto/dsa/dsa_sign.c" 3 4
                         ((void *)0)
# 144 "../crypto/dsa/dsa_sign.c"
                      ...
                      OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (sig == 
# 160 "../crypto/dsa/dsa_sign.c" 3 4
              ((void *)0)
# 160 "../crypto/dsa/dsa_sign.c"
                  ) {
        *siglen = DSA_size(dsa);
        return 1;
    }
    ...
    if (dsa->libctx == 
# 166 "../crypto/dsa/dsa_sign.c" 3 4
                      ((void *)0) 
# 166 "../crypto/dsa/dsa_sign.c"
    ...
    if (s == 
# 171 "../crypto/dsa/dsa_sign.c" 3 4
            ((void *)0)
# 171 "../crypto/dsa/dsa_sign.c"
                ) {
        *siglen = 0;
        return 0;
    }
             ...
             unsigned char *sig, unsigned int *siglen, DSA *dsa)
{
    return ossl_dsa_sign_int(type, dgst, dlen, sig, siglen, dsa,
                             0, 
# 184 "../crypto/dsa/dsa_sign.c" 3 4
                               ((void *)0)
# 184 "../crypto/dsa/dsa_sign.c"
                                   , 
# 184 "../crypto/dsa/dsa_sign.c" 3 4
                                     ((void *)0)
# 184 "../crypto/dsa/dsa_sign.c"
               ...
               const unsigned char *sigbuf, int siglen, DSA *dsa)
{
    ...
    unsigned char *der = 
# 199 "../crypto/dsa/dsa_sign.c" 3 4
                        ((void *)0)
# 199 "../crypto/dsa/dsa_sign.c"
                            ;
    int derlen = -1;
    int ret = -1;
    ...
    s = DSA_SIG_new();
    if (s == 
# 204 "../crypto/dsa/dsa_sign.c" 3 4
            ((void *)0)
# 204 "../crypto/dsa/dsa_sign.c"
                )
        return ret;
    if (d2i_DSA_SIG(&s, &p, siglen) == 
# 206 "../crypto/dsa/dsa_sign.c" 3 4
                                      ((void *)0)
# 206 "../crypto/dsa/dsa_sign.c"
                                          )
        goto err;
 ...
 err:
    CRYPTO_clear_free(der, derlen, "../crypto/dsa/dsa_sign.c", 214);
    DSA_SIG_free(s);
    return ret;
}
