# 0 "../crypto/dsa/dsa_ossl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_ossl.c"
# 14 "../crypto/dsa/dsa_ossl.c"
...
# 21 "../crypto/dsa/dsa_ossl.c" 2
# 1 "../crypto/dsa/dsa_local.h" 1
# 10 "../crypto/dsa/dsa_local.h"
...
# 47 "../crypto/dsa/dsa_ossl.c" 3 4
   ((void *)0)
# 47 "../crypto/dsa/dsa_ossl.c"
       ,
    
# 48 "../crypto/dsa/dsa_ossl.c" 3 4
   ((void *)0)
# 48 "../crypto/dsa/dsa_ossl.c"
       ,
    dsa_init,
    dsa_finish,
    0x0400,
    
# 52 "../crypto/dsa/dsa_ossl.c" 3 4
   ((void *)0)
# 52 "../crypto/dsa/dsa_ossl.c"
       ,
    
# 53 "../crypto/dsa/dsa_ossl.c" 3 4
   ((void *)0)
# 53 "../crypto/dsa/dsa_ossl.c"
       ,
    
# 54 "../crypto/dsa/dsa_ossl.c" 3 4
   ((void *)0)

# 55 "../crypto/dsa/dsa_ossl.c"
};
...
{
    BIGNUM *kinv = 
# 80 "../crypto/dsa/dsa_ossl.c" 3 4
                  ((void *)0)
# 80 "../crypto/dsa/dsa_ossl.c"
                      ;
    BIGNUM *m, *blind, *blindm, *tmp;
    BN_CTX *ctx = 
# 82 "../crypto/dsa/dsa_ossl.c" 3 4
                 ((void *)0)
# 82 "../crypto/dsa/dsa_ossl.c"
                     ;
    int reason = (3 | (0x2 << 18L));
    DSA_SIG *ret = 
# 84 "../crypto/dsa/dsa_ossl.c" 3 4
                  ((void *)0)
# 84 "../crypto/dsa/dsa_ossl.c"
                      ;
    int rv = 0;
    int retries = 0;

    if (dsa->params.p == 
# 88 "../crypto/dsa/dsa_ossl.c" 3 4
                        ((void *)0)
        
# 89 "../crypto/dsa/dsa_ossl.c"
       || dsa->params.q == 
# 89 "../crypto/dsa/dsa_ossl.c" 3 4
                           ((void *)0)
        
# 90 "../crypto/dsa/dsa_ossl.c"
       || dsa->params.g == 
# 90 "../crypto/dsa/dsa_ossl.c" 3 4
                           ((void *)0)
# 90 "../crypto/dsa/dsa_ossl.c"
                               ) {
        reason = 101;
    ...
    if (dsa->priv_key == 
# 94 "../crypto/dsa/dsa_ossl.c" 3 4
                        ((void *)0)
# 94 "../crypto/dsa/dsa_ossl.c"
                            ) {
        reason = 111;
        goto err;
    }
    ...
    ret = DSA_SIG_new();
    if (ret == 
# 100 "../crypto/dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 100 "../crypto/dsa/dsa_ossl.c"
                  )
        goto err;
    ret->r = BN_new();
    ret->s = BN_new();
    if (ret->r == 
# 104 "../crypto/dsa/dsa_ossl.c" 3 4
                 ((void *)0) 
# 104 "../crypto/dsa/dsa_ossl.c"
                      || ret->s == 
# 104 "../crypto/dsa/dsa_ossl.c" 3 4
                                   ((void *)0)
# 104 "../crypto/dsa/dsa_ossl.c"
    ...
    if (ctx == 
# 108 "../crypto/dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 108 "../crypto/dsa/dsa_ossl.c"
                  )
        goto err;
    m = BN_CTX_get(ctx);
    ...
    tmp = BN_CTX_get(ctx);
    if (tmp == 
# 114 "../crypto/dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 114 "../crypto/dsa/dsa_ossl.c"
                  )
        goto err;
 ...
 redo:
    ...
    if (dlen > ((BN_num_bits(dsa->params.q)+7)/8))





        dlen = ((BN_num_bits(dsa->params.q)+7)/8);
    if (BN_bin2bn(dgst, dlen, m) == 
# 129 "../crypto/dsa/dsa_ossl.c" 3 4
                                   ((void *)0)
# 129 "../crypto/dsa/dsa_ossl.c"
                                       )
        goto err;
# 146 "../crypto/dsa/dsa_ossl.c"
    do {
        if (!BN_priv_rand_ex(blind, BN_num_bits(dsa->params.q) - 1,
                             -1, 0, 0, ctx))
            goto err;
    } while (BN_is_zero(blind));
    BN_set_flags(blind, 0x04);
    BN_set_flags(blindm, 0x04);
    ...
    if (BN_mod_inverse(blind, blind, dsa->params.q, ctx) == 
# 174 "../crypto/dsa/dsa_ossl.c" 3 4
                                                           ((void *)0)
# 174 "../crypto/dsa/dsa_ossl.c"
                                                               )
        goto err;
 ...
 err:
    if (rv == 0) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",195,__func__), ERR_set_error)((10),(reason),
# 195 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 195 "../crypto/dsa/dsa_ossl.c"
       );
        DSA_SIG_free(ret);
        ret = 
# 197 "../crypto/dsa/dsa_ossl.c" 3 4
             ((void *)0)
# 197 "../crypto/dsa/dsa_ossl.c"
                 ;
    }
    BN_CTX_free(ctx);
    BN_clear_free(kinv);
...
static DSA_SIG *dsa_do_sign(const unsigned char *dgst, int dlen, DSA *dsa)
{
    return ossl_dsa_do_sign_int(dgst, dlen, dsa,
                                0, 
# 207 "../crypto/dsa/dsa_ossl.c" 3 4
                                  ((void *)0)
# 207 "../crypto/dsa/dsa_ossl.c"
                                      , 
# 207 "../crypto/dsa/dsa_ossl.c" 3 4
                                        ((void *)0)
# 207 "../crypto/dsa/dsa_ossl.c"
...
# 213 "../crypto/dsa/dsa_ossl.c" 3 4
                                                 ((void *)0)
# 213 "../crypto/dsa/dsa_ossl.c"
                                                     , 0,
                          0, 
# 214 "../crypto/dsa/dsa_ossl.c" 3 4
                            ((void *)0)
# 214 "../crypto/dsa/dsa_ossl.c"
                                , 
# 214 "../crypto/dsa/dsa_ossl.c" 3 4
                                  ((void *)0)
# 214 "../crypto/dsa/dsa_ossl.c"
...
{
    BN_CTX *ctx = 
# 223 "../crypto/dsa/dsa_ossl.c" 3 4
                 ((void *)0)
# 223 "../crypto/dsa/dsa_ossl.c"
                     ;
    BIGNUM *k, *kinv = 
# 224 "../crypto/dsa/dsa_ossl.c" 3 4
                      ((void *)0)
# 224 "../crypto/dsa/dsa_ossl.c"
                          , *r = *rp;
    BIGNUM *l;
    int ret = 0;
    int q_bits, q_words;
    ...
    if (!dsa->params.p || !dsa->params.q || !dsa->params.g) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",230,__func__), ERR_set_error)((10),(101),
# 230 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 230 "../crypto/dsa/dsa_ossl.c"
    ...
    if (BN_is_zero(dsa->params.p)
        ...
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",241,__func__), ERR_set_error)((10),(112),
# 241 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 241 "../crypto/dsa/dsa_ossl.c"
       );
        return 0;
    }
    if (dsa->priv_key == 
# 244 "../crypto/dsa/dsa_ossl.c" 3 4
                        ((void *)0)
# 244 "../crypto/dsa/dsa_ossl.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",245,__func__), ERR_set_error)((10),(111),
# 245 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 245 "../crypto/dsa/dsa_ossl.c"
       );
        return 0;
    }
    k = BN_new();
    l = BN_new();
    if (k == 
# 250 "../crypto/dsa/dsa_ossl.c" 3 4
            ((void *)0) 
# 250 "../crypto/dsa/dsa_ossl.c"
                 || l == 
# 250 "../crypto/dsa/dsa_ossl.c" 3 4
                         ((void *)0)
# 250 "../crypto/dsa/dsa_ossl.c"
    ...
    if (ctx_in == 
# 253 "../crypto/dsa/dsa_ossl.c" 3 4
                 ((void *)0)
# 253 "../crypto/dsa/dsa_ossl.c"
                     ) {

        if ((ctx = BN_CTX_new_ex(
# 255 "../crypto/dsa/dsa_ossl.c" 3 4
                                ((void *)0)
# 255 "../crypto/dsa/dsa_ossl.c"
                                    )) == 
# 255 "../crypto/dsa/dsa_ossl.c" 3 4
                                          ((void *)0)
# 255 "../crypto/dsa/dsa_ossl.c"
    ...
    do {
        if (dgst != 
# 270 "../crypto/dsa/dsa_ossl.c" 3 4
                   ((void *)0)
# 270 "../crypto/dsa/dsa_ossl.c"
                       ) {
            if (nonce_type == 1) {
...
# 324 "../crypto/dsa/dsa_ossl.c" 3 4
                                  ((void *)0)
# 324 "../crypto/dsa/dsa_ossl.c"
                                      ) {
    ...
    if (!BN_div(
# 334 "../crypto/dsa/dsa_ossl.c" 3 4
        ((void *)0)
# 334 "../crypto/dsa/dsa_ossl.c"
        ,(r),(r),(dsa->params.q),(ctx)))
        goto err;


    if ((kinv = dsa_mod_inverse_fermat(k, dsa->params.q, ctx)) == 
# 338 "../crypto/dsa/dsa_ossl.c" 3 4
                                                                 ((void *)0)
# 338 "../crypto/dsa/dsa_ossl.c"
                                                                     )
        goto err;
    ...
    *kinvp = kinv;
    kinv = 
# 343 "../crypto/dsa/dsa_ossl.c" 3 4
          ((void *)0)
# 343 "../crypto/dsa/dsa_ossl.c"
              ;
    ret = 1;
 err:
    if (!ret)
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",347,__func__), ERR_set_error)((10),((3 | (0x2 << 18L))),
# 347 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 347 "../crypto/dsa/dsa_ossl.c"
       );
    if (ctx != ctx_in)
        BN_CTX_free(ctx);
    BN_clear_free(k);
                         ...
                         DSA_SIG *sig, DSA *dsa)
{
    ...
    BIGNUM *u1, *u2, *t1;
    BN_MONT_CTX *mont = 
# 360 "../crypto/dsa/dsa_ossl.c" 3 4
                       ((void *)0)
# 360 "../crypto/dsa/dsa_ossl.c"
                           ;
    const BIGNUM *r, *s;
    int ret = -1, i;

    if (dsa->params.p == 
# 364 "../crypto/dsa/dsa_ossl.c" 3 4
                        ((void *)0)
        
# 365 "../crypto/dsa/dsa_ossl.c"
       || dsa->params.q == 
# 365 "../crypto/dsa/dsa_ossl.c" 3 4
                           ((void *)0)
        
# 366 "../crypto/dsa/dsa_ossl.c"
       || dsa->params.g == 
# 366 "../crypto/dsa/dsa_ossl.c" 3 4
                           ((void *)0)
# 366 "../crypto/dsa/dsa_ossl.c"
                               ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",367,__func__), ERR_set_error)((10),(101),
# 367 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 367 "../crypto/dsa/dsa_ossl.c"
       );
        return -1;
    }
    ...
    if (i != 160 && i != 224 && i != 256) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",374,__func__), ERR_set_error)((10),(102),
# 374 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 374 "../crypto/dsa/dsa_ossl.c"
       );
        return -1;
    }

    if (BN_num_bits(dsa->params.p) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",379,__func__), ERR_set_error)((10),(103),
# 379 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 379 "../crypto/dsa/dsa_ossl.c"
       );
        return -1;
    }
    u1 = BN_new();
    ...
    t1 = BN_new();
    ctx = BN_CTX_new_ex(
# 385 "../crypto/dsa/dsa_ossl.c" 3 4
                       ((void *)0)
# 385 "../crypto/dsa/dsa_ossl.c"
                           );
    if (u1 == 
# 386 "../crypto/dsa/dsa_ossl.c" 3 4
             ((void *)0) 
# 386 "../crypto/dsa/dsa_ossl.c"
                  || u2 == 
# 386 "../crypto/dsa/dsa_ossl.c" 3 4
                           ((void *)0) 
# 386 "../crypto/dsa/dsa_ossl.c"
...
# 386 "../crypto/dsa/dsa_ossl.c"
    ...
    if ((BN_mod_inverse(u2, s, dsa->params.q, ctx)) == 
# 405 "../crypto/dsa/dsa_ossl.c" 3 4
                                                      ((void *)0)
# 405 "../crypto/dsa/dsa_ossl.c"
                                                          )
        goto err;
...
# 416 "../crypto/dsa/dsa_ossl.c" 3 4
                                        ((void *)0)
# 416 "../crypto/dsa/dsa_ossl.c"
                                            )
        goto err;
...
# 434 "../crypto/dsa/dsa_ossl.c" 3 4
                                 ((void *)0)
# 434 "../crypto/dsa/dsa_ossl.c"
                                     ) {
    ...
    if (!BN_div(
# 445 "../crypto/dsa/dsa_ossl.c" 3 4
        ((void *)0)
# 445 "../crypto/dsa/dsa_ossl.c"
        ,(u1),(t1),(dsa->params.q),(ctx)))
        goto err;
 ...
 err:
    if (ret < 0)
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ossl.c",455,__func__), ERR_set_error)((10),((3 | (0x2 << 18L))),
# 455 "../crypto/dsa/dsa_ossl.c" 3 4
       ((void *)0)
# 455 "../crypto/dsa/dsa_ossl.c"
       );
    BN_CTX_free(ctx);
    BN_free(u1);
    BN_free(u2);
...
# 483 "../crypto/dsa/dsa_ossl.c"
static BIGNUM *dsa_mod_inverse_fermat(const BIGNUM *k, const BIGNUM *q,
                                      BN_CTX *ctx)
{
    BIGNUM *res = 
# 486 "../crypto/dsa/dsa_ossl.c" 3 4
                 ((void *)0)
# 486 "../crypto/dsa/dsa_ossl.c"
                     ;
    BIGNUM *r, *e;

    if ((r = BN_new()) == 
# 489 "../crypto/dsa/dsa_ossl.c" 3 4
                         ((void *)0)
# 489 "../crypto/dsa/dsa_ossl.c"
                             )
        return 
# 490 "../crypto/dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 490 "../crypto/dsa/dsa_ossl.c"
                  ;

    BN_CTX_start(ctx);
    if ((e = BN_CTX_get(ctx)) != 
# 493 "../crypto/dsa/dsa_ossl.c" 3 4
                                ((void *)0)
            
# 494 "../crypto/dsa/dsa_ossl.c"
           && BN_set_word(r, 2)
            && BN_sub(e, q, r)
            && BN_mod_exp_mont(r, k, e, q, ctx, 
# 496 "../crypto/dsa/dsa_ossl.c" 3 4
                                               ((void *)0)
# 496 "../crypto/dsa/dsa_ossl.c"
                                                   ))
        res = r;
    else
        BN_free(r);
