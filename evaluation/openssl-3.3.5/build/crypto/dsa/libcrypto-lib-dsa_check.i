# 0 "../crypto/dsa/dsa_check.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_check.c"
# 14 "../crypto/dsa/dsa_check.c"
...
# 21 "../crypto/dsa/dsa_check.c" 2

static int dsa_precheck_params(const DSA *dsa, int *ret)
{
    if (dsa->params.p == 
# 24 "../crypto/dsa/dsa_check.c" 3 4
                        ((void *)0) 
# 24 "../crypto/dsa/dsa_check.c"
                             || dsa->params.q == 
# 24 "../crypto/dsa/dsa_check.c" 3 4
                                                 ((void *)0)
# 24 "../crypto/dsa/dsa_check.c"
                                                     ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_check.c",25,__func__), ERR_set_error)((10),(114),
# 25 "../crypto/dsa/dsa_check.c" 3 4
       ((void *)0)
# 25 "../crypto/dsa/dsa_check.c"
       );
        *ret = 0x00800;
        return 0;
    }
    ...
    if (BN_num_bits(dsa->params.p) > 10000) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_check.c",31,__func__), ERR_set_error)((10),(103),
# 31 "../crypto/dsa/dsa_check.c" 3 4
       ((void *)0)
# 31 "../crypto/dsa/dsa_check.c"
       );
        *ret = 0x00800;
        return 0;
    }
    ...
    if (BN_num_bits(dsa->params.q) >= BN_num_bits(dsa->params.p)) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_check.c",37,__func__), ERR_set_error)((10),(102),
# 37 "../crypto/dsa/dsa_check.c" 3 4
       ((void *)0)
# 37 "../crypto/dsa/dsa_check.c"
       );
        *ret = 0x00800;
        return 0;
    }
...
int ossl_dsa_check_pairwise(const DSA *dsa)
{
    int ret = 0;
    BN_CTX *ctx = 
# 106 "../crypto/dsa/dsa_check.c" 3 4
                 ((void *)0)
# 106 "../crypto/dsa/dsa_check.c"
                     ;
    BIGNUM *pub_key = 
# 107 "../crypto/dsa/dsa_check.c" 3 4
                     ((void *)0)
# 107 "../crypto/dsa/dsa_check.c"
                         ;
    ...
    if (dsa->params.g == 
# 112 "../crypto/dsa/dsa_check.c" 3 4
                        ((void *)0)
        
# 113 "../crypto/dsa/dsa_check.c"
       || dsa->priv_key == 
# 113 "../crypto/dsa/dsa_check.c" 3 4
                           ((void *)0)
        
# 114 "../crypto/dsa/dsa_check.c"
       || dsa->pub_key == 
# 114 "../crypto/dsa/dsa_check.c" 3 4
                          ((void *)0)
# 114 "../crypto/dsa/dsa_check.c"
                              )
        return 0;
    ...
    if (ctx == 
# 118 "../crypto/dsa/dsa_check.c" 3 4
              ((void *)0)
# 118 "../crypto/dsa/dsa_check.c"
                  )
        goto err;
    pub_key = BN_new();
    if (pub_key == 
# 121 "../crypto/dsa/dsa_check.c" 3 4
                  ((void *)0)
# 121 "../crypto/dsa/dsa_check.c"
                      )
        goto err;
