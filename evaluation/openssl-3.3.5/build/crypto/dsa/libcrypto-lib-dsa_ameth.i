# 0 "../crypto/dsa/dsa_ameth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_ameth.c"
# 14 "../crypto/dsa/dsa_ameth.c"
...
# 18 "../crypto/dsa/dsa_ameth.c" 2


# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../crypto/dsa/dsa_ameth.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 26 "../crypto/dsa/dsa_ameth.c" 2

# 1 "../crypto/dsa/dsa_local.h" 1
# 14 "../crypto/dsa/dsa_local.h"
struct dsa_st {
...
# 37 "../crypto/dsa/dsa_ameth.c" 3 4
                              ((void *)0)
# 37 "../crypto/dsa/dsa_ameth.c"
                                  ;

    DSA *dsa = 
# 39 "../crypto/dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 39 "../crypto/dsa/dsa_ameth.c"
                  ;

    if (!X509_PUBKEY_get0_param(
# 41 "../crypto/dsa/dsa_ameth.c" 3 4
                               ((void *)0)
# 41 "../crypto/dsa/dsa_ameth.c"
                                   , &p, &pklen, &palg, pubkey))
        return 0;
    X509_ALGOR_get0(
# 43 "../crypto/dsa/dsa_ameth.c" 3 4
                   ((void *)0)
# 43 "../crypto/dsa/dsa_ameth.c"
                       , &ptype, &pval, palg);
...
# 50 "../crypto/dsa/dsa_ameth.c" 3 4
                                ((void *)0)
# 50 "../crypto/dsa/dsa_ameth.c"
                                    , &pm, pmlen)) == 
# 50 "../crypto/dsa/dsa_ameth.c" 3 4
                                                      ((void *)0)
# 50 "../crypto/dsa/dsa_ameth.c"
                                                          ) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",51,__func__), ERR_set_error)((10),(104),
# 51 "../crypto/dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 51 "../crypto/dsa/dsa_ameth.c"
           );
            goto err;
        }
        ...
        if ((dsa = DSA_new()) == 
# 56 "../crypto/dsa/dsa_ameth.c" 3 4
                                ((void *)0)
# 56 "../crypto/dsa/dsa_ameth.c"
                                    ) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",57,__func__), ERR_set_error)((10),((10 | (0x2 << 18L))),
# 57 "../crypto/dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 57 "../crypto/dsa/dsa_ameth.c"
           );
            goto err;
        }
    } else {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",61,__func__), ERR_set_error)((10),(105),
# 61 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 61 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }

    if ((public_key = d2i_ASN1_INTEGER(
# 65 "../crypto/dsa/dsa_ameth.c" 3 4
                                      ((void *)0)
# 65 "../crypto/dsa/dsa_ameth.c"
                                          , &p, pklen)) == 
# 65 "../crypto/dsa/dsa_ameth.c" 3 4
                                                           ((void *)0)
# 65 "../crypto/dsa/dsa_ameth.c"
                                                               ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",66,__func__), ERR_set_error)((10),(104),
# 66 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 66 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }

    if ((dsa->pub_key = ASN1_INTEGER_to_BN(public_key, 
# 70 "../crypto/dsa/dsa_ameth.c" 3 4
                                                      ((void *)0)
# 70 "../crypto/dsa/dsa_ameth.c"
                                                          )) == 
# 70 "../crypto/dsa/dsa_ameth.c" 3 4
                                                                ((void *)0)
# 70 "../crypto/dsa/dsa_ameth.c"
                                                                    ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",71,__func__), ERR_set_error)((10),(108),
# 71 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 71 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
...
static int dsa_pub_encode(X509_PUBKEY *pk, const EVP_PKEY *pkey)
{
    ...
    int ptype;
    unsigned char *penc = 
# 91 "../crypto/dsa/dsa_ameth.c" 3 4
                         ((void *)0)
# 91 "../crypto/dsa/dsa_ameth.c"
                             ;
    int penclen;
    ASN1_STRING *str = 
# 93 "../crypto/dsa/dsa_ameth.c" 3 4
                      ((void *)0)
# 93 "../crypto/dsa/dsa_ameth.c"
                          ;
    ASN1_INTEGER *pubint = 
# 94 "../crypto/dsa/dsa_ameth.c" 3 4
                          ((void *)0)
# 94 "../crypto/dsa/dsa_ameth.c"
                              ;
    ASN1_OBJECT *aobj;
    ...
    if (pkey->save_parameters
        && dsa->params.p != 
# 99 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
        
# 100 "../crypto/dsa/dsa_ameth.c"
       && dsa->params.q != 
# 100 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
        
# 101 "../crypto/dsa/dsa_ameth.c"
       && dsa->params.g != 
# 101 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
# 101 "../crypto/dsa/dsa_ameth.c"
                               ) {
        str = ASN1_STRING_new();
        if (str == 
# 103 "../crypto/dsa/dsa_ameth.c" 3 4
                  ((void *)0)
# 103 "../crypto/dsa/dsa_ameth.c"
                      ) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",104,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 104 "../crypto/dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 104 "../crypto/dsa/dsa_ameth.c"
           );
            goto err;
        }
        str->length = i2d_DSAparams(dsa, &str->data);
        if (str->length <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",109,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 109 "../crypto/dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 109 "../crypto/dsa/dsa_ameth.c"
           );
            goto err;
        }
        ptype = 16;
    ...
    pubint = BN_to_ASN1_INTEGER(dsa->pub_key, 
# 116 "../crypto/dsa/dsa_ameth.c" 3 4
                                             ((void *)0)
# 116 "../crypto/dsa/dsa_ameth.c"
                                                 );

    if (pubint == 
# 118 "../crypto/dsa/dsa_ameth.c" 3 4
                 ((void *)0)
# 118 "../crypto/dsa/dsa_ameth.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",119,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 119 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 119 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
    ...
    if (penclen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",127,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 127 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 127 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }

    aobj = OBJ_nid2obj(116);
    if (aobj == 
# 132 "../crypto/dsa/dsa_ameth.c" 3 4
               ((void *)0)
# 132 "../crypto/dsa/dsa_ameth.c"
                   )
        goto err;
 ...
 err:
    CRYPTO_free(penc, "../crypto/dsa/dsa_ameth.c", 139);
...
{
    int ret = 0;
    DSA *dsa = ossl_dsa_key_from_pkcs8(p8, 
# 153 "../crypto/dsa/dsa_ameth.c" 3 4
                                          ((void *)0)
# 153 "../crypto/dsa/dsa_ameth.c"
                                              , 
# 153 "../crypto/dsa/dsa_ameth.c" 3 4
                                                ((void *)0)
# 153 "../crypto/dsa/dsa_ameth.c"
    ...
    if (dsa != 
# 155 "../crypto/dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 155 "../crypto/dsa/dsa_ameth.c"
                  ) {
        ret = 1;
        EVP_PKEY_assign((pkey),116, (dsa));
    }
...
{
    ASN1_STRING *params = 
# 165 "../crypto/dsa/dsa_ameth.c" 3 4
                         ((void *)0)
# 165 "../crypto/dsa/dsa_ameth.c"
                             ;
    ASN1_INTEGER *prkey = 
# 166 "../crypto/dsa/dsa_ameth.c" 3 4
                         ((void *)0)
# 166 "../crypto/dsa/dsa_ameth.c"
                             ;
    unsigned char *dp = 
# 167 "../crypto/dsa/dsa_ameth.c" 3 4
                       ((void *)0)
# 167 "../crypto/dsa/dsa_ameth.c"
                           ;
    int dplen;

    if (pkey->pkey.dsa == 
# 170 "../crypto/dsa/dsa_ameth.c" 3 4
                          ((void *)0)
# 170 "../crypto/dsa/dsa_ameth.c"
                              || pkey->pkey.dsa->priv_key == 
# 170 "../crypto/dsa/dsa_ameth.c" 3 4
                                                             ((void *)0)
# 170 "../crypto/dsa/dsa_ameth.c"
                                                                 ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",171,__func__), ERR_set_error)((10),(101),
# 171 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 171 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
    ...
    if (params == 
# 177 "../crypto/dsa/dsa_ameth.c" 3 4
                 ((void *)0)
# 177 "../crypto/dsa/dsa_ameth.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",178,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 178 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 178 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
    ...
    if (params->length <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",184,__func__), ERR_set_error)((10),((13 | (0x2 << 18L))),
# 184 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 184 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
    params->type = 16;
...
# 190 "../crypto/dsa/dsa_ameth.c" 3 4
                                                        ((void *)0)
# 190 "../crypto/dsa/dsa_ameth.c"
                                                            );

    if (prkey == 
# 192 "../crypto/dsa/dsa_ameth.c" 3 4
                ((void *)0)
# 192 "../crypto/dsa/dsa_ameth.c"
                    ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",193,__func__), ERR_set_error)((10),(109),
# 193 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 193 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }
    ...
    if (dplen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",202,__func__), ERR_set_error)((10),(109),
# 202 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 202 "../crypto/dsa/dsa_ameth.c"
       );
        goto err;
    }

    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(116), 0,
                         16, params, dp, dplen)) {
        CRYPTO_clear_free(dp, dplen, "../crypto/dsa/dsa_ameth.c", 208);
        goto err;
    }
    return 1;
...
static int dsa_missing_parameters(const EVP_PKEY *pkey)
{
    ...
    dsa = pkey->pkey.dsa;
    return dsa == 
# 237 "../crypto/dsa/dsa_ameth.c" 3 4
                 ((void *)0)
        
# 238 "../crypto/dsa/dsa_ameth.c"
       || dsa->params.p == 
# 238 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
        
# 239 "../crypto/dsa/dsa_ameth.c"
       || dsa->params.q == 
# 239 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
        
# 240 "../crypto/dsa/dsa_ameth.c"
       || dsa->params.g == 
# 240 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
# 240 "../crypto/dsa/dsa_ameth.c"
                               ;
}
...
{
    if (to->pkey.dsa == 
# 245 "../crypto/dsa/dsa_ameth.c" 3 4
                       ((void *)0)
# 245 "../crypto/dsa/dsa_ameth.c"
                           ) {
        to->pkey.dsa = DSA_new();
        if (to->pkey.dsa == 
# 247 "../crypto/dsa/dsa_ameth.c" 3 4
                           ((void *)0)
# 247 "../crypto/dsa/dsa_ameth.c"
                               )
            return 0;
    }
...
static int do_dsa_print(BIO *bp, const DSA *x, int off, int ptype)
{
    int ret = 0;
    const char *ktype = 
# 275 "../crypto/dsa/dsa_ameth.c" 3 4
                       ((void *)0)
# 275 "../crypto/dsa/dsa_ameth.c"
                           ;
    const BIGNUM *priv_key, *pub_key;
    int mod_len = 0;

    if (x->params.p != 
# 279 "../crypto/dsa/dsa_ameth.c" 3 4
                      ((void *)0)
# 279 "../crypto/dsa/dsa_ameth.c"
                          )
        mod_len = DSA_bits(x);
    ...
    if (ptype == 2)
        ...
        priv_key = 
# 285 "../crypto/dsa/dsa_ameth.c" 3 4
                  ((void *)0)
# 285 "../crypto/dsa/dsa_ameth.c"
                      ;
    ...
    if (ptype > 0)
        ...
        pub_key = 
# 290 "../crypto/dsa/dsa_ameth.c" 3 4
                 ((void *)0)
# 290 "../crypto/dsa/dsa_ameth.c"
                     ;
    ...
    if (priv_key != 
# 299 "../crypto/dsa/dsa_ameth.c" 3 4
                   ((void *)0)
# 299 "../crypto/dsa/dsa_ameth.c"
                       ) {
    ...
    if (!ASN1_bn_print(bp, "priv:", priv_key, 
# 309 "../crypto/dsa/dsa_ameth.c" 3 4
                                             ((void *)0)
# 309 "../crypto/dsa/dsa_ameth.c"
                                                 , off))
        goto err;
    if (!ASN1_bn_print(bp, "pub: ", pub_key, 
# 311 "../crypto/dsa/dsa_ameth.c" 3 4
                                            ((void *)0)
# 311 "../crypto/dsa/dsa_ameth.c"
                                                , off))
        goto err;
                            ...
                            const unsigned char **pder, int derlen)
{
    ...
    if ((dsa = d2i_DSAparams(
# 325 "../crypto/dsa/dsa_ameth.c" 3 4
                            ((void *)0)
# 325 "../crypto/dsa/dsa_ameth.c"
                                , pder, derlen)) == 
# 325 "../crypto/dsa/dsa_ameth.c" 3 4
                                                    ((void *)0)
# 325 "../crypto/dsa/dsa_ameth.c"
...
# 361 "../crypto/dsa/dsa_ameth.c" 3 4
                                ((void *)0)
# 361 "../crypto/dsa/dsa_ameth.c"
                                    , pder, derlen)) == 
# 361 "../crypto/dsa/dsa_ameth.c" 3 4
                                                        ((void *)0)
# 361 "../crypto/dsa/dsa_ameth.c"
                                                            ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",362,__func__), ERR_set_error)((10),((10 | (0x2 << 18L))),
# 362 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 362 "../crypto/dsa/dsa_ameth.c"
       );
        return 0;
    }
    dsa->dirty_cnt++;
                         ...
                         const ASN1_STRING *sig, int indent, ASN1_PCTX *pctx)
{
    ...
    if (sig == 
# 381 "../crypto/dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 381 "../crypto/dsa/dsa_ameth.c"
                  ) {
        if (BIO_puts(bp, "\n") <= 0)
            return 0;
        else
    ...
    p = sig->data;
    dsa_sig = d2i_DSA_SIG(
# 388 "../crypto/dsa/dsa_ameth.c" 3 4
                         ((void *)0)
# 388 "../crypto/dsa/dsa_ameth.c"
                             , &p, sig->length);
    if (dsa_sig != 
# 389 "../crypto/dsa/dsa_ameth.c" 3 4
                  ((void *)0)
# 389 "../crypto/dsa/dsa_ameth.c"
                      ) {
        int rv = 0;
        const BIGNUM *r, *s;
        ...
        if (!ASN1_bn_print(bp, "r:   ", r, 
# 398 "../crypto/dsa/dsa_ameth.c" 3 4
                                          ((void *)0)
# 398 "../crypto/dsa/dsa_ameth.c"
                                              , indent))
            goto err;
        if (!ASN1_bn_print(bp, "s:   ", s, 
# 400 "../crypto/dsa/dsa_ameth.c" 3 4
                                          ((void *)0)
# 400 "../crypto/dsa/dsa_ameth.c"
                                              , indent))
            goto err;
        rv = 1;
 err:
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (p == 
# 442 "../crypto/dsa/dsa_ameth.c" 3 4
            ((void *)0) 
# 442 "../crypto/dsa/dsa_ameth.c"
                 || q == 
# 442 "../crypto/dsa/dsa_ameth.c" 3 4
                         ((void *)0) 
# 442 "../crypto/dsa/dsa_ameth.c"
...
# 442 "../crypto/dsa/dsa_ameth.c"
    ...
    if (tmpl == 
# 446 "../crypto/dsa/dsa_ameth.c" 3 4
               ((void *)0)
# 446 "../crypto/dsa/dsa_ameth.c"
                   )
        return 0;

    if (!OSSL_PARAM_BLD_push_BN(tmpl, "p", p)
        || !OSSL_PARAM_BLD_push_BN(tmpl, "q", q)
        || !OSSL_PARAM_BLD_push_BN(tmpl, "g", g))
        goto err;
    selection |= 0x04;
    if (pub_key != 
# 454 "../crypto/dsa/dsa_ameth.c" 3 4
                  ((void *)0)
# 454 "../crypto/dsa/dsa_ameth.c"
                      ) {
        if (!OSSL_PARAM_BLD_push_BN(tmpl, "pub",
                                    pub_key))
            goto err;
        selection |= 0x02;
    }
    if (priv_key != 
# 460 "../crypto/dsa/dsa_ameth.c" 3 4
                   ((void *)0)
# 460 "../crypto/dsa/dsa_ameth.c"
                       ) {
        if (!OSSL_PARAM_BLD_push_BN(tmpl, "priv",
                                    priv_key))
            goto err;
        selection |= 0x01;
    }
...
# 467 "../crypto/dsa/dsa_ameth.c" 3 4
                                                   ((void *)0)
# 467 "../crypto/dsa/dsa_ameth.c"
                                                       )
        goto err;
...
static int dsa_pkey_import_from(const OSSL_PARAM params[], void *vpctx)
{
    ...
    if (dsa == 
# 485 "../crypto/dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 485 "../crypto/dsa/dsa_ameth.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_ameth.c",486,__func__), ERR_set_error)((10),((10 | (0x2 << 18L))),
# 486 "../crypto/dsa/dsa_ameth.c" 3 4
       ((void *)0)
# 486 "../crypto/dsa/dsa_ameth.c"
       );
        return 0;
    }
...
static int dsa_pkey_copy(EVP_PKEY *to, EVP_PKEY *from)
{
    DSA *dsa = from->pkey.dsa;
    DSA *dupkey = 
# 502 "../crypto/dsa/dsa_ameth.c" 3 4
                 ((void *)0)
# 502 "../crypto/dsa/dsa_ameth.c"
                     ;
    int ret;

    if (dsa != 
# 505 "../crypto/dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 505 "../crypto/dsa/dsa_ameth.c"
                  ) {
        dupkey = ossl_dsa_dup(dsa, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ));
        if (dupkey == 
# 507 "../crypto/dsa/dsa_ameth.c" 3 4
                     ((void *)0)
# 507 "../crypto/dsa/dsa_ameth.c"
                         )
            return 0;
    }

    ret = EVP_PKEY_assign((to),116, (dupkey));
    if (!ret)
        DSA_free(dupkey);
    return ret;
}
...
# 575 "../crypto/dsa/dsa_ameth.c" 3 4
    ((void *)0)
# 575 "../crypto/dsa/dsa_ameth.c"
        , 
# 575 "../crypto/dsa/dsa_ameth.c" 3 4
          ((void *)0)
# 575 "../crypto/dsa/dsa_ameth.c"
...
# 576 "../crypto/dsa/dsa_ameth.c" 3 4
    ((void *)0)
# 576 "../crypto/dsa/dsa_ameth.c"
        , 
# 576 "../crypto/dsa/dsa_ameth.c" 3 4
          ((void *)0)
# 576 "../crypto/dsa/dsa_ameth.c"
...
# 577 "../crypto/dsa/dsa_ameth.c" 3 4
    ((void *)0)
# 577 "../crypto/dsa/dsa_ameth.c"
        , 
# 577 "../crypto/dsa/dsa_ameth.c" 3 4
          ((void *)0)
# 577 "../crypto/dsa/dsa_ameth.c"
