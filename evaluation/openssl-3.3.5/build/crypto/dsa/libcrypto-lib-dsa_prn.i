# 0 "../crypto/dsa/dsa_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_prn.c"
# 14 "../crypto/dsa/dsa_prn.c"
...
# 27 "../crypto/dsa/dsa_prn.c" 3 4
                                      ((void *)0)
# 27 "../crypto/dsa/dsa_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_prn.c",28,__func__), ERR_set_error)((10),((7 | (0x2 << 18L))),
# 28 "../crypto/dsa/dsa_prn.c" 3 4
       ((void *)0)
# 28 "../crypto/dsa/dsa_prn.c"
       );
        return 0;
    }
...
int DSAparams_print_fp(FILE *fp, const DSA *x)
{
    ...
    if ((b = BIO_new(BIO_s_file())) == 
# 42 "../crypto/dsa/dsa_prn.c" 3 4
                                      ((void *)0)
# 42 "../crypto/dsa/dsa_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_prn.c",43,__func__), ERR_set_error)((10),((7 | (0x2 << 18L))),
# 43 "../crypto/dsa/dsa_prn.c" 3 4
       ((void *)0)
# 43 "../crypto/dsa/dsa_prn.c"
       );
        return 0;
    }
    BIO_ctrl(b,106,0x00,(char *)(fp));
...
int DSA_print(BIO *bp, const DSA *x, int off)
{
    ...
    pk = EVP_PKEY_new();
    if (pk == 
# 58 "../crypto/dsa/dsa_prn.c" 3 4
             ((void *)0)
# 58 "../crypto/dsa/dsa_prn.c"
                 )
        return 0;
    ret = EVP_PKEY_set1_DSA(pk, (DSA *)x);
    if (ret)
        ret = EVP_PKEY_print_private(bp, pk, off, 
# 62 "../crypto/dsa/dsa_prn.c" 3 4
                                                 ((void *)0)
# 62 "../crypto/dsa/dsa_prn.c"
                                                     );
    EVP_PKEY_free(pk);
    return ret;
}
...
int DSAparams_print(BIO *bp, const DSA *x)
{
    ...
    pk = EVP_PKEY_new();
    if (pk == 
# 72 "../crypto/dsa/dsa_prn.c" 3 4
             ((void *)0)
# 72 "../crypto/dsa/dsa_prn.c"
                 )
        return 0;
    ret = EVP_PKEY_set1_DSA(pk, (DSA *)x);
    if (ret)
        ret = EVP_PKEY_print_params(bp, pk, 4, 
# 76 "../crypto/dsa/dsa_prn.c" 3 4
                                              ((void *)0)
# 76 "../crypto/dsa/dsa_prn.c"
                                                  );
    EVP_PKEY_free(pk);
    return ret;
}
