# 0 "../crypto/dsa/dsa_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_gen.c"
# 14 "../crypto/dsa/dsa_gen.c"
                               ...
                               BN_GENCB *cb)
{
    ...
    if (seed_in != 
# 55 "../crypto/dsa/dsa_gen.c" 3 4
                  ((void *)0)
        
# 56 "../crypto/dsa/dsa_gen.c"
    ...
    if (bits < 2048 && seed_len <= 20) {
        if (!ossl_dsa_generate_ffc_parameters(dsa, 1,
                                              bits, 160, cb))
            return 0;
    } else {
        if (!ossl_dsa_generate_ffc_parameters(dsa, 0,
                                              bits, 0, cb))
            return 0;
    }

    if (counter_ret != 
# 71 "../crypto/dsa/dsa_gen.c" 3 4
                      ((void *)0)
# 71 "../crypto/dsa/dsa_gen.c"
                          )
        *counter_ret = dsa->params.pcounter;
    if (h_ret != 
# 73 "../crypto/dsa/dsa_gen.c" 3 4
                ((void *)0)
# 73 "../crypto/dsa/dsa_gen.c"
                    )
        *h_ret = dsa->params.h;
    return 1;
}
