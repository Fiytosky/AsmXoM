# 0 "../crypto/dsa/dsa_depr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_depr.c"
# 19 "../crypto/dsa/dsa_depr.c"
                             ...
                             void *cb_arg)
{
    ...
    if ((ret = DSA_new()) == 
# 40 "../crypto/dsa/dsa_depr.c" 3 4
                            ((void *)0)
# 40 "../crypto/dsa/dsa_depr.c"
                                )
        return 
# 41 "../crypto/dsa/dsa_depr.c" 3 4
              ((void *)0)
# 41 "../crypto/dsa/dsa_depr.c"
                  ;
    cb = BN_GENCB_new();
    if (cb == 
# 43 "../crypto/dsa/dsa_depr.c" 3 4
             ((void *)0)
# 43 "../crypto/dsa/dsa_depr.c"
                 )
        goto err;
...
err:
    DSA_free(ret);
    return 
# 56 "../crypto/dsa/dsa_depr.c" 3 4
          ((void *)0)
# 56 "../crypto/dsa/dsa_depr.c"
              ;
}
