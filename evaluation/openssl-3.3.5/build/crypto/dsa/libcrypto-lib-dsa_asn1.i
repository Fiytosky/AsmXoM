# 0 "../crypto/dsa/dsa_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_asn1.c"
# 14 "../crypto/dsa/dsa_asn1.c"
                  ...
                  void *exarg)
{
    if (operation == 0) {
        *pval = (ASN1_VALUE *)DSA_new();
        if (*pval != 
# 30 "../crypto/dsa/dsa_asn1.c" 3 4
                    ((void *)0)
# 30 "../crypto/dsa/dsa_asn1.c"
                        )
            return 2;
        return 0;
    } else if (operation == 2) {
        DSA_free((DSA *)*pval);
        *pval = 
# 35 "../crypto/dsa/dsa_asn1.c" 3 4
               ((void *)0)
# 35 "../crypto/dsa/dsa_asn1.c"
                   ;
        return 2;
    }
    return 1;
...
# 41 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 41 "../crypto/dsa/dsa_asn1.c"
, 0, 0, 0, dsa_cb, 0, 
# 41 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 41 "../crypto/dsa/dsa_asn1.c"
        ...
        { ((0x1 << 12)), (0), 
# 42 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 42 "../crypto/dsa/dsa_asn1.c"
       DSA
# 42 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 42 "../crypto/dsa/dsa_asn1.c"
...
# 42 "../crypto/dsa/dsa_asn1.c"
       , "version", (INT32_it) },
        { (0), (0), 
# 43 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 43 "../crypto/dsa/dsa_asn1.c"
       DSA
# 43 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 43 "../crypto/dsa/dsa_asn1.c"
...
# 43 "../crypto/dsa/dsa_asn1.c"
       , "params.p", (BIGNUM_it) },
        { (0), (0), 
# 44 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 44 "../crypto/dsa/dsa_asn1.c"
       DSA
# 44 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 44 "../crypto/dsa/dsa_asn1.c"
...
# 44 "../crypto/dsa/dsa_asn1.c"
       , "params.q", (BIGNUM_it) },
        { (0), (0), 
# 45 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 45 "../crypto/dsa/dsa_asn1.c"
       DSA
# 45 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 45 "../crypto/dsa/dsa_asn1.c"
...
# 45 "../crypto/dsa/dsa_asn1.c"
       , "params.g", (BIGNUM_it) },
        { (0), (0), 
# 46 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 46 "../crypto/dsa/dsa_asn1.c"
       DSA
# 46 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 46 "../crypto/dsa/dsa_asn1.c"
...
# 46 "../crypto/dsa/dsa_asn1.c"
       , "pub_key", (BIGNUM_it) },
        { (0), (0), 
# 47 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 47 "../crypto/dsa/dsa_asn1.c"
       DSA
# 47 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 47 "../crypto/dsa/dsa_asn1.c"
...
# 47 "../crypto/dsa/dsa_asn1.c"
       , "priv_key", (CBIGNUM_it) }
} ; static const ASN1_ITEM * DSAPrivateKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DSAPrivateKey_seq_tt, sizeof(DSAPrivateKey_seq_tt) / sizeof(ASN1_TEMPLATE), &DSAPrivateKey_aux, sizeof(DSA), "DSA" }; return &local_it; }

DSA *d2i_DSAPrivateKey(DSA **a, const unsigned char **in, long len) { return (DSA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DSAPrivateKey_it())); } int i2d_DSAPrivateKey(const DSA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DSAPrivateKey_it())); }

static const ASN1_AUX DSAparams_aux = {
# 52 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 52 "../crypto/dsa/dsa_asn1.c"
, 0, 0, 0, dsa_cb, 0, 
# 52 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 52 "../crypto/dsa/dsa_asn1.c"
        ...
        { (0), (0), 
# 53 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 53 "../crypto/dsa/dsa_asn1.c"
       DSA
# 53 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 53 "../crypto/dsa/dsa_asn1.c"
...
# 53 "../crypto/dsa/dsa_asn1.c"
       , "params.p", (BIGNUM_it) },
        { (0), (0), 
# 54 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 54 "../crypto/dsa/dsa_asn1.c"
       DSA
# 54 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 54 "../crypto/dsa/dsa_asn1.c"
...
# 54 "../crypto/dsa/dsa_asn1.c"
       , "params.q", (BIGNUM_it) },
        { (0), (0), 
# 55 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 55 "../crypto/dsa/dsa_asn1.c"
       DSA
# 55 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 55 "../crypto/dsa/dsa_asn1.c"
...
# 55 "../crypto/dsa/dsa_asn1.c"
       , "params.g", (BIGNUM_it) },
} ; static const ASN1_ITEM * DSAparams_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DSAparams_seq_tt, sizeof(DSAparams_seq_tt) / sizeof(ASN1_TEMPLATE), &DSAparams_aux, sizeof(DSA), "DSA" }; return &local_it; }

DSA *d2i_DSAparams(DSA **a, const unsigned char **in, long len) { return (DSA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DSAparams_it())); } int i2d_DSAparams(const DSA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DSAparams_it())); }

static const ASN1_AUX DSAPublicKey_aux = {
# 60 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 60 "../crypto/dsa/dsa_asn1.c"
, 0, 0, 0, dsa_cb, 0, 
# 60 "../crypto/dsa/dsa_asn1.c" 3 4
((void *)0)
# 60 "../crypto/dsa/dsa_asn1.c"
        ...
        { (0), (0), 
# 61 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 61 "../crypto/dsa/dsa_asn1.c"
       DSA
# 61 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 61 "../crypto/dsa/dsa_asn1.c"
...
# 61 "../crypto/dsa/dsa_asn1.c"
       , "pub_key", (BIGNUM_it) },
        { (0), (0), 
# 62 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 62 "../crypto/dsa/dsa_asn1.c"
       DSA
# 62 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 62 "../crypto/dsa/dsa_asn1.c"
...
# 62 "../crypto/dsa/dsa_asn1.c"
       , "params.p", (BIGNUM_it) },
        { (0), (0), 
# 63 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 63 "../crypto/dsa/dsa_asn1.c"
       DSA
# 63 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 63 "../crypto/dsa/dsa_asn1.c"
...
# 63 "../crypto/dsa/dsa_asn1.c"
       , "params.q", (BIGNUM_it) },
        { (0), (0), 
# 64 "../crypto/dsa/dsa_asn1.c" 3 4
       __builtin_offsetof (
# 64 "../crypto/dsa/dsa_asn1.c"
       DSA
# 64 "../crypto/dsa/dsa_asn1.c" 3 4
       , 
# 64 "../crypto/dsa/dsa_asn1.c"
...
# 64 "../crypto/dsa/dsa_asn1.c"
       , "params.g", (BIGNUM_it) }
} ; static const ASN1_ITEM * DSAPublicKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, DSAPublicKey_seq_tt, sizeof(DSAPublicKey_seq_tt) / sizeof(ASN1_TEMPLATE), &DSAPublicKey_aux, sizeof(DSA), "DSA" }; return &local_it; }

DSA *d2i_DSAPublicKey(DSA **a, const unsigned char **in, long len) { return (DSA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (DSAPublicKey_it())); } int i2d_DSAPublicKey(const DSA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (DSAPublicKey_it())); }
