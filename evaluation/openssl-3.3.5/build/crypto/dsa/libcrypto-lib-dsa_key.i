# 0 "../crypto/dsa/dsa_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_key.c"
# 14 "../crypto/dsa/dsa_key.c"
...
# 36 "../crypto/dsa/dsa_key.c" 3 4
                                ((void *)0)
# 36 "../crypto/dsa/dsa_key.c"
                                    )
                                 ...
                                 const BIGNUM *priv_key, BIGNUM *pub_key)
{
    ...
    if (prk == 
# 48 "../crypto/dsa/dsa_key.c" 3 4
              ((void *)0)
# 48 "../crypto/dsa/dsa_key.c"
                  )
        return 0;
...
# 147 "../crypto/dsa/dsa_key.c"
static int dsa_keygen(DSA *dsa)
{
    int ok = 0;
    BN_CTX *ctx = 
# 150 "../crypto/dsa/dsa_key.c" 3 4
                 ((void *)0)
# 150 "../crypto/dsa/dsa_key.c"
                     ;
    BIGNUM *pub_key = 
# 151 "../crypto/dsa/dsa_key.c" 3 4
                     ((void *)0)
# 151 "../crypto/dsa/dsa_key.c"
                         , *priv_key = 
# 151 "../crypto/dsa/dsa_key.c" 3 4
                                       ((void *)0)
# 151 "../crypto/dsa/dsa_key.c"
    ...
    if ((ctx = BN_CTX_new_ex(dsa->libctx)) == 
# 153 "../crypto/dsa/dsa_key.c" 3 4
                                             ((void *)0)
# 153 "../crypto/dsa/dsa_key.c"
                                                 )
        goto err;

    if (dsa->priv_key == 
# 156 "../crypto/dsa/dsa_key.c" 3 4
                        ((void *)0)
# 156 "../crypto/dsa/dsa_key.c"
                            ) {
        if ((priv_key = BN_secure_new()) == 
# 157 "../crypto/dsa/dsa_key.c" 3 4
                                           ((void *)0)
# 157 "../crypto/dsa/dsa_key.c"
                                               )
            goto err;
    } else {
    ...
    if (!ossl_ffc_params_simple_validate(dsa->libctx, &dsa->params,
                                         0, 
# 165 "../crypto/dsa/dsa_key.c" 3 4
                                                            ((void *)0)
# 165 "../crypto/dsa/dsa_key.c"
                                                                ))
        goto err;
    ...
    if (dsa->pub_key == 
# 178 "../crypto/dsa/dsa_key.c" 3 4
                       ((void *)0)
# 178 "../crypto/dsa/dsa_key.c"
                           ) {
        if ((pub_key = BN_new()) == 
# 179 "../crypto/dsa/dsa_key.c" 3 4
                                   ((void *)0)
# 179 "../crypto/dsa/dsa_key.c"
                                       )
            goto err;
    } else {
        pub_key = dsa->pub_key;
