# 0 "../crypto/dsa/dsa_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/dsa/dsa_lib.c"
# 14 "../crypto/dsa/dsa_lib.c"
...
DH *DSA_dup_DH(const DSA *r)
{
    ...
    DH *ret = 
# 48 "../crypto/dsa/dsa_lib.c" 3 4
             ((void *)0)
# 48 "../crypto/dsa/dsa_lib.c"
                 ;
    BIGNUM *pub_key = 
# 49 "../crypto/dsa/dsa_lib.c" 3 4
                     ((void *)0)
# 49 "../crypto/dsa/dsa_lib.c"
                         , *priv_key = 
# 49 "../crypto/dsa/dsa_lib.c" 3 4
                                       ((void *)0)
# 49 "../crypto/dsa/dsa_lib.c"
    ...
    if (r == 
# 51 "../crypto/dsa/dsa_lib.c" 3 4
            ((void *)0)
# 51 "../crypto/dsa/dsa_lib.c"
                )
        goto err;
    ret = DH_new();
    if (ret == 
# 54 "../crypto/dsa/dsa_lib.c" 3 4
              ((void *)0)
# 54 "../crypto/dsa/dsa_lib.c"
                  )
        goto err;
    ...
    if (r->pub_key != 
# 60 "../crypto/dsa/dsa_lib.c" 3 4
                     ((void *)0)
# 60 "../crypto/dsa/dsa_lib.c"
                         ) {
        pub_key = BN_dup(r->pub_key);
        if (pub_key == 
# 62 "../crypto/dsa/dsa_lib.c" 3 4
                      ((void *)0)
# 62 "../crypto/dsa/dsa_lib.c"
                          )
            goto err;
        if (r->priv_key != 
# 64 "../crypto/dsa/dsa_lib.c" 3 4
                          ((void *)0)
# 64 "../crypto/dsa/dsa_lib.c"
                              ) {
            priv_key = BN_dup(r->priv_key);
            if (priv_key == 
# 66 "../crypto/dsa/dsa_lib.c" 3 4
                           ((void *)0)
# 66 "../crypto/dsa/dsa_lib.c"
                               )
                goto err;
        }
...
# 71 "../crypto/dsa/dsa_lib.c" 3 4
                             ((void *)0)
# 71 "../crypto/dsa/dsa_lib.c"
                                 ) {
 ...
 err:
    ...
    DH_free(ret);
    return 
# 82 "../crypto/dsa/dsa_lib.c" 3 4
          ((void *)0)
# 82 "../crypto/dsa/dsa_lib.c"
              ;
}
...
int DSA_set_method(DSA *dsa, const DSA_METHOD *meth)
{
    ...
    dsa->engine = 
# 118 "../crypto/dsa/dsa_lib.c" 3 4
                 ((void *)0)
# 118 "../crypto/dsa/dsa_lib.c"
                     ;
...
static DSA *dsa_new_intern(ENGINE *engine, OSSL_LIB_CTX *libctx)
{
    DSA *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/dsa/dsa_lib.c", 135);

    if (ret == 
# 137 "../crypto/dsa/dsa_lib.c" 3 4
              ((void *)0)
# 137 "../crypto/dsa/dsa_lib.c"
                  )
        return 
# 138 "../crypto/dsa/dsa_lib.c" 3 4
              ((void *)0)
# 138 "../crypto/dsa/dsa_lib.c"
                  ;

    ret->lock = CRYPTO_THREAD_lock_new();
    if (ret->lock == 
# 141 "../crypto/dsa/dsa_lib.c" 3 4
                    ((void *)0)
# 141 "../crypto/dsa/dsa_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_lib.c",142,__func__), ERR_set_error)((10),((15 | (0x2 << 18L))),
# 142 "../crypto/dsa/dsa_lib.c" 3 4
       ((void *)0)
# 142 "../crypto/dsa/dsa_lib.c"
       );
        CRYPTO_free(ret, "../crypto/dsa/dsa_lib.c", 143);
        return 
# 144 "../crypto/dsa/dsa_lib.c" 3 4
              ((void *)0)
# 144 "../crypto/dsa/dsa_lib.c"
                  ;
    }

    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_THREAD_lock_free(ret->lock);
        CRYPTO_free(ret, "../crypto/dsa/dsa_lib.c", 149);
        return 
# 150 "../crypto/dsa/dsa_lib.c" 3 4
              ((void *)0)
# 150 "../crypto/dsa/dsa_lib.c"
    ...
    if (engine) {
        if (!ENGINE_init(engine)) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_lib.c",159,__func__), ERR_set_error)((10),((38 | (0x2 << 18L))),
# 159 "../crypto/dsa/dsa_lib.c" 3 4
           ((void *)0)
# 159 "../crypto/dsa/dsa_lib.c"
           );
            goto err;
        }
        ret->engine = engine;
    ...
    if (ret->engine) {
        ...
        if (ret->meth == 
# 167 "../crypto/dsa/dsa_lib.c" 3 4
                        ((void *)0)
# 167 "../crypto/dsa/dsa_lib.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_lib.c",168,__func__), ERR_set_error)((10),((38 | (0x2 << 18L))),
# 168 "../crypto/dsa/dsa_lib.c" 3 4
           ((void *)0)
# 168 "../crypto/dsa/dsa_lib.c"
           );
            goto err;
        }
    }
    ...
    if (!ossl_crypto_new_ex_data_ex(libctx, 7, ret,
                                    &ret->ex_data))
        goto err;
    ...
    if ((ret->meth->init != 
# 184 "../crypto/dsa/dsa_lib.c" 3 4
                           ((void *)0)
# 184 "../crypto/dsa/dsa_lib.c"
                               ) && !ret->meth->init(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/dsa/dsa_lib.c",185,__func__), ERR_set_error)((10),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 185 "../crypto/dsa/dsa_lib.c" 3 4
       ((void *)0)
# 185 "../crypto/dsa/dsa_lib.c"
       );
        goto err;
    }
 ...
 err:
    DSA_free(ret);
    return 
# 193 "../crypto/dsa/dsa_lib.c" 3 4
          ((void *)0)
# 193 "../crypto/dsa/dsa_lib.c"
              ;
}

DSA *DSA_new_method(ENGINE *engine)
{
    return dsa_new_intern(engine, 
# 198 "../crypto/dsa/dsa_lib.c" 3 4
                                 ((void *)0)
# 198 "../crypto/dsa/dsa_lib.c"
                                     );
}
...
# 203 "../crypto/dsa/dsa_lib.c" 3 4
                         ((void *)0)
# 203 "../crypto/dsa/dsa_lib.c"
                             , libctx);
}
...
{
    return dsa_new_intern(
# 209 "../crypto/dsa/dsa_lib.c" 3 4
                         ((void *)0)
# 209 "../crypto/dsa/dsa_lib.c"
                             , 
# 209 "../crypto/dsa/dsa_lib.c" 3 4
                               ((void *)0)
# 209 "../crypto/dsa/dsa_lib.c"
...
void DSA_free(DSA *r)
{
    ...
    if (r == 
# 217 "../crypto/dsa/dsa_lib.c" 3 4
            ((void *)0)
# 217 "../crypto/dsa/dsa_lib.c"
                )
        return;
    ...
    if (r->meth != 
# 226 "../crypto/dsa/dsa_lib.c" 3 4
                  ((void *)0) 
# 226 "../crypto/dsa/dsa_lib.c"
                       && r->meth->finish != 
# 226 "../crypto/dsa/dsa_lib.c" 3 4
                                             ((void *)0)
# 226 "../crypto/dsa/dsa_lib.c"
    ...
    CRYPTO_free(r, "../crypto/dsa/dsa_lib.c", 242);
}
...
int DSA_set0_pqg(DSA *d, BIGNUM *p, BIGNUM *q, BIGNUM *g)
{
    ...
    if ((d->params.p == 
# 273 "../crypto/dsa/dsa_lib.c" 3 4
                       ((void *)0) 
# 273 "../crypto/dsa/dsa_lib.c"
                            && p == 
# 273 "../crypto/dsa/dsa_lib.c" 3 4
                                    ((void *)0)
# 273 "../crypto/dsa/dsa_lib.c"
        ...
        || (d->params.q == 
# 274 "../crypto/dsa/dsa_lib.c" 3 4
                          ((void *)0) 
# 274 "../crypto/dsa/dsa_lib.c"
                               && q == 
# 274 "../crypto/dsa/dsa_lib.c" 3 4
                                       ((void *)0)
# 274 "../crypto/dsa/dsa_lib.c"
        ...
        || (d->params.g == 
# 275 "../crypto/dsa/dsa_lib.c" 3 4
                          ((void *)0) 
# 275 "../crypto/dsa/dsa_lib.c"
                               && g == 
# 275 "../crypto/dsa/dsa_lib.c" 3 4
                                       ((void *)0)
# 275 "../crypto/dsa/dsa_lib.c"
...
{
    if (pub_key != 
# 312 "../crypto/dsa/dsa_lib.c" 3 4
                  ((void *)0)
# 312 "../crypto/dsa/dsa_lib.c"
                      )
        *pub_key = d->pub_key;
    if (priv_key != 
# 314 "../crypto/dsa/dsa_lib.c" 3 4
                   ((void *)0)
# 314 "../crypto/dsa/dsa_lib.c"
                       )
        *priv_key = d->priv_key;
}
...
{
    if (pub_key != 
# 320 "../crypto/dsa/dsa_lib.c" 3 4
                  ((void *)0)
# 320 "../crypto/dsa/dsa_lib.c"
                      ) {
        BN_free(d->pub_key);
        d->pub_key = pub_key;
    }
    if (priv_key != 
# 324 "../crypto/dsa/dsa_lib.c" 3 4
                   ((void *)0)
# 324 "../crypto/dsa/dsa_lib.c"
                       ) {
        BN_free(d->priv_key);
        d->priv_key = priv_key;
    }
...
{
    if (d->params.p != 
# 335 "../crypto/dsa/dsa_lib.c" 3 4
                      ((void *)0) 
# 335 "../crypto/dsa/dsa_lib.c"
                           && d->params.q != 
# 335 "../crypto/dsa/dsa_lib.c" 3 4
                                             ((void *)0)
# 335 "../crypto/dsa/dsa_lib.c"
...
{
    if (dsa->params.p != 
# 343 "../crypto/dsa/dsa_lib.c" 3 4
                        ((void *)0)
# 343 "../crypto/dsa/dsa_lib.c"
                            )
