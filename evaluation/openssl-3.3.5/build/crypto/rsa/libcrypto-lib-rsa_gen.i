# 0 "../crypto/rsa/rsa_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_gen.c"
# 20 "../crypto/rsa/rsa_gen.c"
...
# 12 "../providers/common/include/prov/providercommon.h" 2
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 29 "../crypto/rsa/rsa_gen.c" 2

static int rsa_keygen_pairwise_test(RSA *rsa, OSSL_CALLBACK *cb, void *cbarg);
static int rsa_keygen(OSSL_LIB_CTX *libctx, RSA *rsa, int bits, int primes,
                      BIGNUM *e_value, BN_GENCB *cb, int pairwise_test);
# 41 "../crypto/rsa/rsa_gen.c"
int RSA_generate_key_ex(RSA *rsa, int bits, BIGNUM *e_value, BN_GENCB *cb)
{
    if (rsa->meth->rsa_keygen != 
# 43 "../crypto/rsa/rsa_gen.c" 3 4
                                ((void *)0)
# 43 "../crypto/rsa/rsa_gen.c"
                                    )
        return rsa->meth->rsa_keygen(rsa, bits, e_value, cb);

    return RSA_generate_multi_prime_key(rsa, bits, 2,
                                        e_value, cb);
}
...
# 55 "../crypto/rsa/rsa_gen.c" 3 4
                                            ((void *)0)
# 55 "../crypto/rsa/rsa_gen.c"
                                                ) {
        return rsa->meth->rsa_multi_prime_keygen(rsa, bits, primes,
                                                 e_value, cb);
    } else if (rsa->meth->rsa_keygen != 
# 58 "../crypto/rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 58 "../crypto/rsa/rsa_gen.c"
                                           ) {
...
int ossl_rsa_multiprime_derive(RSA *rsa, int bits, int primes,
                               ...
                               struct stack_st_BIGNUM *coeffs)
{
    struct stack_st_BIGNUM *pplist = 
# 88 "../crypto/rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 88 "../crypto/rsa/rsa_gen.c"
                                  , *pdlist = 
# 88 "../crypto/rsa/rsa_gen.c" 3 4
                                              ((void *)0)
# 88 "../crypto/rsa/rsa_gen.c"
                                                  ;
    BIGNUM *factor = 
# 89 "../crypto/rsa/rsa_gen.c" 3 4
                    ((void *)0)
# 89 "../crypto/rsa/rsa_gen.c"
                        , *newpp = 
# 89 "../crypto/rsa/rsa_gen.c" 3 4
                                   ((void *)0)
# 89 "../crypto/rsa/rsa_gen.c"
...
# 89 "../crypto/rsa/rsa_gen.c"
                                                      ;
    BIGNUM *dval = 
# 90 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 90 "../crypto/rsa/rsa_gen.c"
                      , *newexp = 
# 90 "../crypto/rsa/rsa_gen.c" 3 4
                                  ((void *)0)
# 90 "../crypto/rsa/rsa_gen.c"
...
# 90 "../crypto/rsa/rsa_gen.c"
                                                        ;
    BIGNUM *p = 
# 91 "../crypto/rsa/rsa_gen.c" 3 4
               ((void *)0)
# 91 "../crypto/rsa/rsa_gen.c"
                   , *q = 
# 91 "../crypto/rsa/rsa_gen.c" 3 4
                          ((void *)0)
# 91 "../crypto/rsa/rsa_gen.c"
                              ;
    BIGNUM *dmp1 = 
# 92 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 92 "../crypto/rsa/rsa_gen.c"
                      , *dmq1 = 
# 92 "../crypto/rsa/rsa_gen.c" 3 4
                                ((void *)0)
# 92 "../crypto/rsa/rsa_gen.c"
...
# 92 "../crypto/rsa/rsa_gen.c"
                                                  ;
    BIGNUM *r0 = 
# 93 "../crypto/rsa/rsa_gen.c" 3 4
                ((void *)0)
# 93 "../crypto/rsa/rsa_gen.c"
                    , *r1 = 
# 93 "../crypto/rsa/rsa_gen.c" 3 4
                            ((void *)0)
# 93 "../crypto/rsa/rsa_gen.c"
...
# 93 "../crypto/rsa/rsa_gen.c"
                                            ;
    BN_CTX *ctx = 
# 94 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 94 "../crypto/rsa/rsa_gen.c"
                     ;
    BIGNUM *tmp = 
# 95 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 95 "../crypto/rsa/rsa_gen.c"
                     ;
    int i;
    int ret = 0;
    ...
    if (ctx == 
# 100 "../crypto/rsa/rsa_gen.c" 3 4
              ((void *)0)
# 100 "../crypto/rsa/rsa_gen.c"
                  )
        goto err;
    ...
    if (pplist == 
# 106 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 106 "../crypto/rsa/rsa_gen.c"
                     )
        goto err;

    pdlist = sk_BIGNUM_new_null();
    if (pdlist == 
# 110 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 110 "../crypto/rsa/rsa_gen.c"
                     )
        goto err;
    ...
    if (r2 == 
# 117 "../crypto/rsa/rsa_gen.c" 3 4
             ((void *)0)
# 117 "../crypto/rsa/rsa_gen.c"
                 )
        goto err;

    BN_set_flags(r0, 0x04);
    BN_set_flags(r1, 0x04);
    BN_set_flags(r2, 0x04);

    if (BN_copy(r1, rsa->n) == 
# 124 "../crypto/rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 124 "../crypto/rsa/rsa_gen.c"
                                  )
        goto err;
...
# 138 "../crypto/rsa/rsa_gen.c" 3 4
                                                      ((void *)0)
# 138 "../crypto/rsa/rsa_gen.c"
                                                          )
                goto err;
            break;
        case 1:
            ...
            tmp = BN_dup(r1);
            if (tmp == 
# 146 "../crypto/rsa/rsa_gen.c" 3 4
                      ((void *)0)
# 146 "../crypto/rsa/rsa_gen.c"
                          )
                goto err;
            if (!sk_BIGNUM_insert(pplist, tmp, sk_BIGNUM_num(pplist)))
                goto err;
            tmp = 
# 150 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 150 "../crypto/rsa/rsa_gen.c"
                     ;
            break;
        default:
            ...
            tmp = BN_dup(r1);
            if (tmp == 
# 158 "../crypto/rsa/rsa_gen.c" 3 4
                      ((void *)0)
# 158 "../crypto/rsa/rsa_gen.c"
                          )
                goto err;
            if (!sk_BIGNUM_insert(pplist, tmp, sk_BIGNUM_num(pplist)))
                goto err;
            tmp = 
# 162 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 162 "../crypto/rsa/rsa_gen.c"
                     ;
            break;
        }
    }
    ...
    for (i = 2; i < sk_BIGNUM_num(factors); i++) {
        ...
        dval = BN_new();
        if (dval == 
# 178 "../crypto/rsa/rsa_gen.c" 3 4
                   ((void *)0)
# 178 "../crypto/rsa/rsa_gen.c"
                       )
            goto err;
        BN_set_flags(dval, 0x04);
        ...
        if (!sk_BIGNUM_insert(pdlist, dval, sk_BIGNUM_num(pdlist)))
            goto err;
        dval = 
# 187 "../crypto/rsa/rsa_gen.c" 3 4
              ((void *)0)
# 187 "../crypto/rsa/rsa_gen.c"
                  ;
    }
    ...
    dmp1 = BN_secure_new();
    if (dmp1 == 
# 192 "../crypto/rsa/rsa_gen.c" 3 4
               ((void *)0)
# 192 "../crypto/rsa/rsa_gen.c"
                   )
        goto err;
    dmq1 = BN_secure_new();
    if (dmq1 == 
# 195 "../crypto/rsa/rsa_gen.c" 3 4
               ((void *)0)
# 195 "../crypto/rsa/rsa_gen.c"
                   )
        goto err;

    if (!BN_div(
# 198 "../crypto/rsa/rsa_gen.c" 3 4
        ((void *)0)
# 198 "../crypto/rsa/rsa_gen.c"
        ,(dmp1),(rsa->d),(r1),(ctx)))
        goto err;
    if (!sk_BIGNUM_insert(exps, dmp1, sk_BIGNUM_num(exps)))
        goto err;
    dmp1 = 
# 202 "../crypto/rsa/rsa_gen.c" 3 4
          ((void *)0)
# 202 "../crypto/rsa/rsa_gen.c"
              ;

    if (!BN_div(
# 204 "../crypto/rsa/rsa_gen.c" 3 4
        ((void *)0)
# 204 "../crypto/rsa/rsa_gen.c"
        ,(dmq1),(rsa->d),(r2),(ctx)))
        goto err;
    if (!sk_BIGNUM_insert(exps, dmq1, sk_BIGNUM_num(exps)))
        goto err;
    dmq1 = 
# 208 "../crypto/rsa/rsa_gen.c" 3 4
          ((void *)0)
# 208 "../crypto/rsa/rsa_gen.c"
              ;
    ...
    for (i = 2; i < sk_BIGNUM_num(factors); i++) {
        ...
        newexp = BN_new();
        if (newexp == 
# 213 "../crypto/rsa/rsa_gen.c" 3 4
                     ((void *)0)
# 213 "../crypto/rsa/rsa_gen.c"
                         )
            goto err;
        if (!BN_div(
# 215 "../crypto/rsa/rsa_gen.c" 3 4
            ((void *)0)
# 215 "../crypto/rsa/rsa_gen.c"
            ,(newexp),(rsa->d),(newpd),(ctx)))
            goto err;
        if (!sk_BIGNUM_insert(exps, newexp, sk_BIGNUM_num(exps)))
            goto err;
        newexp = 
# 219 "../crypto/rsa/rsa_gen.c" 3 4
                ((void *)0)
# 219 "../crypto/rsa/rsa_gen.c"
                    ;
    }
    ...
    iqmp = BN_new();
    if (iqmp == 
# 224 "../crypto/rsa/rsa_gen.c" 3 4
               ((void *)0)
# 224 "../crypto/rsa/rsa_gen.c"
                   )
        goto err;

    if (BN_mod_inverse(iqmp, sk_BIGNUM_value(factors, 1),
                       sk_BIGNUM_value(factors, 0), ctx) == 
# 228 "../crypto/rsa/rsa_gen.c" 3 4
                                                           ((void *)0)
# 228 "../crypto/rsa/rsa_gen.c"
                                                               )
        goto err;
    if (!sk_BIGNUM_insert(coeffs, iqmp, sk_BIGNUM_num(coeffs)))
        goto err;
    iqmp = 
# 232 "../crypto/rsa/rsa_gen.c" 3 4
          ((void *)0)
# 232 "../crypto/rsa/rsa_gen.c"
              ;
    ...
    for (i = 2; i < sk_BIGNUM_num(factors); i++) {
        ...
        newcoeff = BN_new();
        if (newcoeff == 
# 237 "../crypto/rsa/rsa_gen.c" 3 4
                       ((void *)0)
# 237 "../crypto/rsa/rsa_gen.c"
                           )
            goto err;
        if (BN_mod_inverse(newcoeff, newpp, sk_BIGNUM_value(factors, i),
                           ctx) == 
# 240 "../crypto/rsa/rsa_gen.c" 3 4
                                  ((void *)0)
# 240 "../crypto/rsa/rsa_gen.c"
                                      )
            goto err;
        if (!sk_BIGNUM_insert(coeffs, newcoeff, sk_BIGNUM_num(coeffs)))
            goto err;
        newcoeff = 
# 244 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 244 "../crypto/rsa/rsa_gen.c"
                      ;
    }
...
{
    BIGNUM *r0 = 
# 266 "../crypto/rsa/rsa_gen.c" 3 4
                ((void *)0)
# 266 "../crypto/rsa/rsa_gen.c"
                    , *r1 = 
# 266 "../crypto/rsa/rsa_gen.c" 3 4
                            ((void *)0)
# 266 "../crypto/rsa/rsa_gen.c"
...
# 266 "../crypto/rsa/rsa_gen.c"
                                            , *tmp, *tmp2, *prime;
    int n = 0, bitsr[5], bitse = 0;
    int i = 0, quo = 0, rmd = 0, adj = 0, retries = 0;
    RSA_PRIME_INFO *pinfo = 
# 269 "../crypto/rsa/rsa_gen.c" 3 4
                           ((void *)0)
# 269 "../crypto/rsa/rsa_gen.c"
                               ;
    struct stack_st_RSA_PRIME_INFO *prime_infos = 
# 270 "../crypto/rsa/rsa_gen.c" 3 4
                                           ((void *)0)
# 270 "../crypto/rsa/rsa_gen.c"
                                               ;
    struct stack_st_BIGNUM *factors = 
# 271 "../crypto/rsa/rsa_gen.c" 3 4
                               ((void *)0)
# 271 "../crypto/rsa/rsa_gen.c"
                                   ;
    struct stack_st_BIGNUM *exps = 
# 272 "../crypto/rsa/rsa_gen.c" 3 4
                            ((void *)0)
# 272 "../crypto/rsa/rsa_gen.c"
                                ;
    struct stack_st_BIGNUM *coeffs = 
# 273 "../crypto/rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 273 "../crypto/rsa/rsa_gen.c"
                                  ;
    BN_CTX *ctx = 
# 274 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 274 "../crypto/rsa/rsa_gen.c"
                     ;
    unsigned long bitst = 0;
    unsigned long error = 0;
    int ok = -1;

    if (bits < 512) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_gen.c",280,__func__), ERR_set_error)((4),(120),
# 280 "../crypto/rsa/rsa_gen.c" 3 4
       ((void *)0)
# 280 "../crypto/rsa/rsa_gen.c"
       );
        return 0;
    }
    if (e_value == 
# 283 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 283 "../crypto/rsa/rsa_gen.c"
                      ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_gen.c",284,__func__), ERR_set_error)((4),(101),
# 284 "../crypto/rsa/rsa_gen.c" 3 4
       ((void *)0)
# 284 "../crypto/rsa/rsa_gen.c"
       );
        return 0;
    }

    if (!ossl_rsa_check_public_exponent(e_value)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_gen.c",289,__func__), ERR_set_error)((4),(178),
# 289 "../crypto/rsa/rsa_gen.c" 3 4
       ((void *)0)
# 289 "../crypto/rsa/rsa_gen.c"
       );
        return 0;
    }

    if (primes < 2 || primes > ossl_rsa_multip_cap(bits)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_gen.c",294,__func__), ERR_set_error)((4),(165),
# 294 "../crypto/rsa/rsa_gen.c" 3 4
       ((void *)0)
# 294 "../crypto/rsa/rsa_gen.c"
       );
        return 0;
    }
    ...
    if (factors == 
# 299 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 299 "../crypto/rsa/rsa_gen.c"
                      )
        return 0;

    exps = sk_BIGNUM_new_null();
    if (exps == 
# 303 "../crypto/rsa/rsa_gen.c" 3 4
               ((void *)0)
# 303 "../crypto/rsa/rsa_gen.c"
                   )
        goto err;

    coeffs = sk_BIGNUM_new_null();
    if (coeffs == 
# 307 "../crypto/rsa/rsa_gen.c" 3 4
                 ((void *)0)
# 307 "../crypto/rsa/rsa_gen.c"
                     )
        goto err;

    ctx = BN_CTX_new_ex(rsa->libctx);
    if (ctx == 
# 311 "../crypto/rsa/rsa_gen.c" 3 4
              ((void *)0)
# 311 "../crypto/rsa/rsa_gen.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    r0 = BN_CTX_get(ctx);
    ...
    r2 = BN_CTX_get(ctx);
    if (r2 == 
# 317 "../crypto/rsa/rsa_gen.c" 3 4
             ((void *)0)
# 317 "../crypto/rsa/rsa_gen.c"
                 )
        goto err;
...
# 330 "../crypto/rsa/rsa_gen.c" 3 4
                                          ((void *)0)
# 330 "../crypto/rsa/rsa_gen.c"
                                              ))
        goto err;
    if (!rsa->d && ((rsa->d = BN_secure_new()) == 
# 332 "../crypto/rsa/rsa_gen.c" 3 4
                                                 ((void *)0)
# 332 "../crypto/rsa/rsa_gen.c"
                                                     ))
        goto err;
    BN_set_flags(rsa->d, 0x04);
    if (!rsa->e && ((rsa->e = BN_new()) == 
# 335 "../crypto/rsa/rsa_gen.c" 3 4
                                          ((void *)0)
# 335 "../crypto/rsa/rsa_gen.c"
                                              ))
        goto err;
    if (!rsa->p && ((rsa->p = BN_secure_new()) == 
# 337 "../crypto/rsa/rsa_gen.c" 3 4
                                                 ((void *)0)
# 337 "../crypto/rsa/rsa_gen.c"
                                                     ))
        goto err;
    BN_set_flags(rsa->p, 0x04);
    if (!rsa->q && ((rsa->q = BN_secure_new()) == 
# 340 "../crypto/rsa/rsa_gen.c" 3 4
                                                 ((void *)0)
# 340 "../crypto/rsa/rsa_gen.c"
                                                     ))
        goto err;
    BN_set_flags(rsa->q, 0x04);


    if (primes > 2) {
        rsa->version = 1;
        prime_infos = sk_RSA_PRIME_INFO_new_reserve(
# 347 "../crypto/rsa/rsa_gen.c" 3 4
                                                   ((void *)0)
# 347 "../crypto/rsa/rsa_gen.c"
                                                       , primes - 2);
        if (prime_infos == 
# 348 "../crypto/rsa/rsa_gen.c" 3 4
                          ((void *)0)
# 348 "../crypto/rsa/rsa_gen.c"
                              )
            goto err;
        if (rsa->prime_infos != 
# 350 "../crypto/rsa/rsa_gen.c" 3 4
                               ((void *)0)
# 350 "../crypto/rsa/rsa_gen.c"
                                   ) {
        ...
        for (i = 2; i < primes; i++) {
            ...
            if (pinfo == 
# 360 "../crypto/rsa/rsa_gen.c" 3 4
                        ((void *)0)
# 360 "../crypto/rsa/rsa_gen.c"
                            )
                goto err;
...
# 366 "../crypto/rsa/rsa_gen.c" 3 4
                                   ((void *)0)
# 366 "../crypto/rsa/rsa_gen.c"
                                       )
        goto err;
    ...
    for (i = 0; i < primes; i++) {
        ...
        BN_set_flags(prime, 0x04);

        for (;;) {
 redo:
            if (!BN_generate_prime_ex2(prime, bitsr[i] + adj, 0, 
# 386 "../crypto/rsa/rsa_gen.c" 3 4
                                                                ((void *)0)
# 386 "../crypto/rsa/rsa_gen.c"
                                                                    , 
# 386 "../crypto/rsa/rsa_gen.c" 3 4
                                                                      ((void *)0)
# 386 "../crypto/rsa/rsa_gen.c"
            ...
            BN_set_flags(r2, 0x04);
            if (BN_mod_inverse(r1, r2, rsa->e, ctx) != 
# 416 "../crypto/rsa/rsa_gen.c" 3 4
                                                      ((void *)0)
# 416 "../crypto/rsa/rsa_gen.c"
                                                          ) {

                break;
            }
            error = ERR_peek_last_error();
            if (ERR_GET_LIB(error) == 3
                && ERR_GET_REASON(error) == 108) {
        ...
        if (i == 1) {
            ...
            tmp = BN_dup(prime);
            if (tmp == 
# 448 "../crypto/rsa/rsa_gen.c" 3 4
                      ((void *)0)
# 448 "../crypto/rsa/rsa_gen.c"
                          )
                goto err;
...
# 469 "../crypto/rsa/rsa_gen.c"
        if (!BN_rshift(r2, r1, bitse - 4))
            goto err;
        bitst = BN_get_word(r2);

        if (bitst < 0x9 || bitst > 0xF) {
# 485 "../crypto/rsa/rsa_gen.c"
            bitse -= bitsr[i];
            if (!BN_GENCB_call(cb, 2, n++))
                goto err;
            if (primes > 4) {
                ...
                factors = sk_BIGNUM_new_null();
                if (factors == 
# 503 "../crypto/rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 503 "../crypto/rsa/rsa_gen.c"
                                  )
                    goto err;
                continue;
            }
        ...
        if (i > 1 && BN_copy(pinfo->pp, rsa->n) == 
# 511 "../crypto/rsa/rsa_gen.c" 3 4
                                                  ((void *)0)
# 511 "../crypto/rsa/rsa_gen.c"
                                                      )
            goto err;
        if (BN_copy(rsa->n, r1) == 
# 513 "../crypto/rsa/rsa_gen.c" 3 4
                                  ((void *)0)
# 513 "../crypto/rsa/rsa_gen.c"
                                      )
            goto err;
        if (!BN_GENCB_call(cb, 3, i))
            goto err;
        tmp = BN_dup(prime);
        if (tmp == 
# 518 "../crypto/rsa/rsa_gen.c" 3 4
                  ((void *)0)
# 518 "../crypto/rsa/rsa_gen.c"
                      )
            goto err;
        if (!sk_BIGNUM_insert(factors, tmp, sk_BIGNUM_num(factors)))
            goto err;
...
# 556 "../crypto/rsa/rsa_gen.c" 3 4
                                                  ((void *)0)
# 556 "../crypto/rsa/rsa_gen.c"
                                                      ) {
        goto err;
    }
...
# 573 "../crypto/rsa/rsa_gen.c"
    ...
    for (i = 2; i < primes; i++) {
        ...
        BN_clear_free(tmp);
        if (tmp2 == 
# 586 "../crypto/rsa/rsa_gen.c" 3 4
                   ((void *)0)
# 586 "../crypto/rsa/rsa_gen.c"
                       )
            goto err;
        ...
        BN_clear_free(tmp);
        if (tmp2 == 
# 591 "../crypto/rsa/rsa_gen.c" 3 4
                   ((void *)0)
# 591 "../crypto/rsa/rsa_gen.c"
                       )
            goto err;
    }
    ok = 1;
 err:
    ...
    if (ok == -1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_gen.c",600,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 600 "../crypto/rsa/rsa_gen.c" 3 4
       ((void *)0)
# 600 "../crypto/rsa/rsa_gen.c"
       );
        ok = 0;
    }
    BN_CTX_end(ctx);
...
{
    int ok = 0;
# 622 "../crypto/rsa/rsa_gen.c"
    if (primes == 2
            && bits >= 2048
            && (e_value == 
# 624 "../crypto/rsa/rsa_gen.c" 3 4
                          ((void *)0) 
# 624 "../crypto/rsa/rsa_gen.c"
                               || BN_num_bits(e_value) > 16))
    ...
    if (pairwise_test && ok > 0) {
        OSSL_CALLBACK *stcb = 
# 631 "../crypto/rsa/rsa_gen.c" 3 4
                             ((void *)0)
# 631 "../crypto/rsa/rsa_gen.c"
                                 ;
        void *stcbarg = 
# 632 "../crypto/rsa/rsa_gen.c" 3 4
                       ((void *)0)
# 632 "../crypto/rsa/rsa_gen.c"
                           ;
        ...
        if (!ok) {
            ...
            rsa->d = 
# 645 "../crypto/rsa/rsa_gen.c" 3 4
                    ((void *)0)
# 645 "../crypto/rsa/rsa_gen.c"
                        ;
            rsa->p = 
# 646 "../crypto/rsa/rsa_gen.c" 3 4
                    ((void *)0)
# 646 "../crypto/rsa/rsa_gen.c"
                        ;
            rsa->q = 
# 647 "../crypto/rsa/rsa_gen.c" 3 4
                    ((void *)0)
# 647 "../crypto/rsa/rsa_gen.c"
                        ;
            rsa->dmp1 = 
# 648 "../crypto/rsa/rsa_gen.c" 3 4
                       ((void *)0)
# 648 "../crypto/rsa/rsa_gen.c"
                           ;
            rsa->dmq1 = 
# 649 "../crypto/rsa/rsa_gen.c" 3 4
                       ((void *)0)
# 649 "../crypto/rsa/rsa_gen.c"
                           ;
            rsa->iqmp = 
# 650 "../crypto/rsa/rsa_gen.c" 3 4
                       ((void *)0)
# 650 "../crypto/rsa/rsa_gen.c"
                           ;
        }
    }
    return ok;
}
# 663 "../crypto/rsa/rsa_gen.c"
static int rsa_keygen_pairwise_test(RSA *rsa, OSSL_CALLBACK *cb, void *cbarg)
{
    int ret = 0;
    unsigned int ciphertxt_len;
    unsigned char *ciphertxt = 
# 667 "../crypto/rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 667 "../crypto/rsa/rsa_gen.c"
                                  ;
    const unsigned char plaintxt[16] = {0};
    unsigned char *decoded = 
# 669 "../crypto/rsa/rsa_gen.c" 3 4
                            ((void *)0)
# 669 "../crypto/rsa/rsa_gen.c"
                                ;
    unsigned int decoded_len;
    unsigned int plaintxt_len = (unsigned int)sizeof(plaintxt_len);
    int padding = 1;
    OSSL_SELF_TEST *st = 
# 673 "../crypto/rsa/rsa_gen.c" 3 4
                        ((void *)0)
# 673 "../crypto/rsa/rsa_gen.c"
                            ;

    st = OSSL_SELF_TEST_new(cb, cbarg);
    if (st == 
# 676 "../crypto/rsa/rsa_gen.c" 3 4
             ((void *)0)
# 676 "../crypto/rsa/rsa_gen.c"
                 )
        goto err;
    ...
    ciphertxt = CRYPTO_zalloc(ciphertxt_len * 2, "../crypto/rsa/rsa_gen.c", 686);
    if (ciphertxt == 
# 687 "../crypto/rsa/rsa_gen.c" 3 4
                    ((void *)0)
# 687 "../crypto/rsa/rsa_gen.c"
                        )
        goto err;
...
err:
    ...
    CRYPTO_free(ciphertxt, "../crypto/rsa/rsa_gen.c", 711);
