# 0 "../crypto/rsa/rsa_mp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_mp.c"
# 11 "../crypto/rsa/rsa_mp.c"
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 14 "../crypto/rsa/rsa_mp.c" 2

void ossl_rsa_multip_info_free_ex(RSA_PRIME_INFO *pinfo)
{

    BN_clear_free(pinfo->pp);
    CRYPTO_free(pinfo, "../crypto/rsa/rsa_mp.c", 19);
}
...
RSA_PRIME_INFO *ossl_rsa_multip_info_new(void)
{
    ...
    if ((pinfo = CRYPTO_zalloc(sizeof(RSA_PRIME_INFO), "../crypto/rsa/rsa_mp.c", 36)) == 
# 36 "../crypto/rsa/rsa_mp.c" 3 4
                                                           ((void *)0)
# 36 "../crypto/rsa/rsa_mp.c"
                                                               )
        return 
# 37 "../crypto/rsa/rsa_mp.c" 3 4
              ((void *)0)
# 37 "../crypto/rsa/rsa_mp.c"
                  ;
    if ((pinfo->r = BN_secure_new()) == 
# 38 "../crypto/rsa/rsa_mp.c" 3 4
                                       ((void *)0)
# 38 "../crypto/rsa/rsa_mp.c"
                                           )
        goto err;
    if ((pinfo->d = BN_secure_new()) == 
# 40 "../crypto/rsa/rsa_mp.c" 3 4
                                       ((void *)0)
# 40 "../crypto/rsa/rsa_mp.c"
                                           )
        goto err;
    if ((pinfo->t = BN_secure_new()) == 
# 42 "../crypto/rsa/rsa_mp.c" 3 4
                                       ((void *)0)
# 42 "../crypto/rsa/rsa_mp.c"
                                           )
        goto err;
    if ((pinfo->pp = BN_secure_new()) == 
# 44 "../crypto/rsa/rsa_mp.c" 3 4
                                        ((void *)0)
# 44 "../crypto/rsa/rsa_mp.c"
                                            )
        goto err;
 ...
 err:
    ...
    BN_free(pinfo->t);
    BN_free(pinfo->pp);
    CRYPTO_free(pinfo, "../crypto/rsa/rsa_mp.c", 54);
    return 
# 55 "../crypto/rsa/rsa_mp.c" 3 4
          ((void *)0)
# 55 "../crypto/rsa/rsa_mp.c"
              ;
}
...
int ossl_rsa_multip_calc_product(RSA *rsa)
{
    RSA_PRIME_INFO *pinfo;
    BIGNUM *p1 = 
# 62 "../crypto/rsa/rsa_mp.c" 3 4
                ((void *)0)
# 62 "../crypto/rsa/rsa_mp.c"
                    , *p2 = 
# 62 "../crypto/rsa/rsa_mp.c" 3 4
                            ((void *)0)
# 62 "../crypto/rsa/rsa_mp.c"
                                ;
    BN_CTX *ctx = 
# 63 "../crypto/rsa/rsa_mp.c" 3 4
                 ((void *)0)
# 63 "../crypto/rsa/rsa_mp.c"
                     ;
    ...
    if ((ctx = BN_CTX_new()) == 
# 71 "../crypto/rsa/rsa_mp.c" 3 4
                               ((void *)0)
# 71 "../crypto/rsa/rsa_mp.c"
                                   )
        goto err;
    ...
    for (i = 0; i < ex_primes; i++) {
        ...
        if (pinfo->pp == 
# 80 "../crypto/rsa/rsa_mp.c" 3 4
                        ((void *)0)
# 80 "../crypto/rsa/rsa_mp.c"
                            ) {
            pinfo->pp = BN_secure_new();
            if (pinfo->pp == 
# 82 "../crypto/rsa/rsa_mp.c" 3 4
                            ((void *)0)
# 82 "../crypto/rsa/rsa_mp.c"
                                )
                goto err;
        }
