# 0 "../crypto/rsa/rsa_sign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_sign.c"
# 14 "../crypto/rsa/rsa_sign.c"
...
extern int MD4_Update(MD4_CTX *c, const void *data, size_t len);
extern int MD4_Final(unsigned char *md, MD4_CTX *c);
extern unsigned char *MD4(const unsigned char *d, size_t n,
                                         unsigned char *md);
extern void MD4_Transform(MD4_CTX *c, const unsigned char *b);
# 27 "../crypto/rsa/rsa_sign.c" 2
...
# 30 "../crypto/rsa/rsa_sign.c" 2


# 1 "../include/openssl/mdc2.h" 1
# 12 "../include/openssl/mdc2.h"
        
# 23 "../include/openssl/mdc2.h"
...
void DES_ofb64_encrypt(const unsigned char *in, unsigned char *out,
                       long length, DES_key_schedule *schedule,
                       DES_cblock *ivec, int *num);
# 24 "../include/openssl/mdc2.h" 2
# 34 "../include/openssl/mdc2.h"
...
extern int MDC2_Init(MDC2_CTX *c);
extern int MDC2_Update(MDC2_CTX *c, const unsigned char *data,
                                      size_t len);
extern int MDC2_Final(unsigned char *md, MDC2_CTX *c);
extern unsigned char *MDC2(const unsigned char *d, size_t n,
                                          unsigned char *md);
# 33 "../crypto/rsa/rsa_sign.c" 2
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 41 "../crypto/rsa/rsa_sign.c" 2
# 101 "../crypto/rsa/rsa_sign.c"
static const unsigned char digestinfo_md4_der[] = { 0x30, 0x10 + 16, 0x30, 0x0c, 0x06, 0x08, 1 * 40 + 2, 0x86, 0x48, 0x86, 0xf7, 0x0d, 2, 0x03, 0x05, 0x00, 0x04, 16 };


static const unsigned char digestinfo_md5_der[] = { 0x30, 0x10 + 16, 0x30, 0x0c, 0x06, 0x08, 1 * 40 + 2, 0x86, 0x48, 0x86, 0xf7, 0x0d, 2, 0x05, 0x05, 0x00, 0x04, 16 };
...
static const unsigned char digestinfo_sha1_der[] = {
    0x30, 0x0d + 20,
      0x30, 0x09,
        0x06, 0x05, 1 * 40 + 3, 14, 3, 2, 26,
        0x05, 0x00,
      0x04, 20
};

static const unsigned char digestinfo_sha256_der[] = { 0x30, 0x11 + 32, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x01, 0x05, 0x00, 0x04, 32 };
static const unsigned char digestinfo_sha384_der[] = { 0x30, 0x11 + 48, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x02, 0x05, 0x00, 0x04, 48 };
static const unsigned char digestinfo_sha512_der[] = { 0x30, 0x11 + 64, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x03, 0x05, 0x00, 0x04, 64 };
static const unsigned char digestinfo_sha224_der[] = { 0x30, 0x11 + 28, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x04, 0x05, 0x00, 0x04, 28 };
static const unsigned char digestinfo_sha512_224_der[] = { 0x30, 0x11 + 28, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x05, 0x05, 0x00, 0x04, 28 };
static const unsigned char digestinfo_sha512_256_der[] = { 0x30, 0x11 + 32, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x06, 0x05, 0x00, 0x04, 32 };
static const unsigned char digestinfo_sha3_224_der[] = { 0x30, 0x11 + 28, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x07, 0x05, 0x00, 0x04, 28 };
static const unsigned char digestinfo_sha3_256_der[] = { 0x30, 0x11 + 32, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x08, 0x05, 0x00, 0x04, 32 };
static const unsigned char digestinfo_sha3_384_der[] = { 0x30, 0x11 + 48, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x09, 0x05, 0x00, 0x04, 48 };
static const unsigned char digestinfo_sha3_512_der[] = { 0x30, 0x11 + 64, 0x30, 0x0d, 0x06, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101, 3, 4, 2, 0x0a, 0x05, 0x00, 0x04, 64 };
...
const unsigned char *ossl_rsa_digestinfo_encoding(int md_nid, size_t *len)
{
    ...
    case 95: *len = sizeof(digestinfo_mdc2_der); return digestinfo_mdc2_der;





    case 257: *len = sizeof(digestinfo_md4_der); return digestinfo_md4_der;


    case 4: *len = sizeof(digestinfo_md5_der); return digestinfo_md5_der;


    case 117: *len = sizeof(digestinfo_ripemd160_der); return digestinfo_ripemd160_der;


    case 64: *len = sizeof(digestinfo_sha1_der); return digestinfo_sha1_der;
    case 675: *len = sizeof(digestinfo_sha224_der); return digestinfo_sha224_der;
    case 672: *len = sizeof(digestinfo_sha256_der); return digestinfo_sha256_der;
    case 673: *len = sizeof(digestinfo_sha384_der); return digestinfo_sha384_der;
    case 674: *len = sizeof(digestinfo_sha512_der); return digestinfo_sha512_der;
    case 1094: *len = sizeof(digestinfo_sha512_224_der); return digestinfo_sha512_224_der;
    case 1095: *len = sizeof(digestinfo_sha512_256_der); return digestinfo_sha512_256_der;
    case 1096: *len = sizeof(digestinfo_sha3_224_der); return digestinfo_sha3_224_der;
    case 1097: *len = sizeof(digestinfo_sha3_256_der); return digestinfo_sha3_256_der;
    case 1098: *len = sizeof(digestinfo_sha3_384_der); return digestinfo_sha3_384_der;
    case 1099: *len = sizeof(digestinfo_sha3_512_der); return digestinfo_sha3_512_der;
    default:
        return 
# 185 "../crypto/rsa/rsa_sign.c" 3 4
              ((void *)0)
# 185 "../crypto/rsa/rsa_sign.c"
                  ;
    }
}
                        ...
                        const unsigned char *m, size_t m_len)
{
    ...
    if (type == 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",250,__func__), ERR_set_error)((4),(117),
# 250 "../crypto/rsa/rsa_sign.c" 3 4
       ((void *)0)
# 250 "../crypto/rsa/rsa_sign.c"
       );
        return 0;
    }
    di_prefix = ossl_rsa_digestinfo_encoding(type, &di_prefix_len);
    if (di_prefix == 
# 254 "../crypto/rsa/rsa_sign.c" 3 4
                    ((void *)0)
# 254 "../crypto/rsa/rsa_sign.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",255,__func__), ERR_set_error)((4),(116),
# 255 "../crypto/rsa/rsa_sign.c" 3 4
       ((void *)0)
# 255 "../crypto/rsa/rsa_sign.c"
       )
                                                                            ;
        return 0;
    }
    dig_info_len = di_prefix_len + m_len;
    dig_info = CRYPTO_malloc(dig_info_len, "../crypto/rsa/rsa_sign.c", 260);
    if (dig_info == 
# 261 "../crypto/rsa/rsa_sign.c" 3 4
                   ((void *)0)
# 261 "../crypto/rsa/rsa_sign.c"
                       )
        return 0;
             ...
             unsigned char *sigret, unsigned int *siglen, RSA *rsa)
{
    ...
    unsigned char *tmps = 
# 276 "../crypto/rsa/rsa_sign.c" 3 4
                         ((void *)0)
# 276 "../crypto/rsa/rsa_sign.c"
                             ;
    const unsigned char *encoded = 
# 277 "../crypto/rsa/rsa_sign.c" 3 4
                                  ((void *)0)
# 277 "../crypto/rsa/rsa_sign.c"
                                      ;


    if (rsa->meth->rsa_sign != 
# 280 "../crypto/rsa/rsa_sign.c" 3 4
                              ((void *)0)
# 280 "../crypto/rsa/rsa_sign.c"
                                  )
    ...
    if (type == 114) {
        ...
        if (m_len != 36) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",292,__func__), ERR_set_error)((4),(131),
# 292 "../crypto/rsa/rsa_sign.c" 3 4
           ((void *)0)
# 292 "../crypto/rsa/rsa_sign.c"
           );
            return 0;
        }
        encoded_len = 36;
    ...
    if (encoded_len + 11 > (size_t)RSA_size(rsa)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",304,__func__), ERR_set_error)((4),(112),
# 304 "../crypto/rsa/rsa_sign.c" 3 4
       ((void *)0)
# 304 "../crypto/rsa/rsa_sign.c"
       );
        goto err;
    }
...
err:
    CRYPTO_clear_free(tmps, encoded_len, "../crypto/rsa/rsa_sign.c", 316);
    return ret;
}
# 329 "../crypto/rsa/rsa_sign.c"
...
# 335 "../crypto/rsa/rsa_sign.c"
    ...
    if (siglen != (size_t)RSA_size(rsa)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",338,__func__), ERR_set_error)((4),(119),
# 338 "../crypto/rsa/rsa_sign.c" 3 4
       ((void *)0)
# 338 "../crypto/rsa/rsa_sign.c"
       );
        return 0;
    }


    decrypt_buf = CRYPTO_malloc(siglen, "../crypto/rsa/rsa_sign.c", 343);
    if (decrypt_buf == 
# 344 "../crypto/rsa/rsa_sign.c" 3 4
                      ((void *)0)
# 344 "../crypto/rsa/rsa_sign.c"
                          )
        goto err;
    ...
    if (type == 114) {
        ...
        if (decrypt_len != 36) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",361,__func__), ERR_set_error)((4),(104),
# 361 "../crypto/rsa/rsa_sign.c" 3 4
           ((void *)0)
# 361 "../crypto/rsa/rsa_sign.c"
           );
            goto err;
        }

        if (rm != 
# 365 "../crypto/rsa/rsa_sign.c" 3 4
                 ((void *)0)
# 365 "../crypto/rsa/rsa_sign.c"
                     ) {
            memcpy(rm, decrypt_buf, 36);
            *prm_len = 36;
        } else {
            if (m_len != 36) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",370,__func__), ERR_set_error)((4),(131),
# 370 "../crypto/rsa/rsa_sign.c" 3 4
               ((void *)0)
# 370 "../crypto/rsa/rsa_sign.c"
               );
                goto err;
            }

            if (memcmp(decrypt_buf, m, 36) != 0) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",375,__func__), ERR_set_error)((4),(104),
# 375 "../crypto/rsa/rsa_sign.c" 3 4
               ((void *)0)
# 375 "../crypto/rsa/rsa_sign.c"
               );
                goto err;
            }
        }
    } else if (type == 95 && decrypt_len == 2 + 16
        ...
        if (rm != 
# 385 "../crypto/rsa/rsa_sign.c" 3 4
                 ((void *)0)
# 385 "../crypto/rsa/rsa_sign.c"
                     ) {
            memcpy(rm, decrypt_buf + 2, 16);
            *prm_len = 16;
        } else {
            if (m_len != 16) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",390,__func__), ERR_set_error)((4),(131),
# 390 "../crypto/rsa/rsa_sign.c" 3 4
               ((void *)0)
# 390 "../crypto/rsa/rsa_sign.c"
               );
                goto err;
            }

            if (memcmp(m, decrypt_buf + 2, 16) != 0) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",395,__func__), ERR_set_error)((4),(104),
# 395 "../crypto/rsa/rsa_sign.c" 3 4
               ((void *)0)
# 395 "../crypto/rsa/rsa_sign.c"
               );
                goto err;
            }
        }
...

    {
        ...
        if (rm != 
# 407 "../crypto/rsa/rsa_sign.c" 3 4
                 ((void *)0)
# 407 "../crypto/rsa/rsa_sign.c"
                     ) {
            ...
            if (m_len > decrypt_len) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",414,__func__), ERR_set_error)((4),(143),
# 414 "../crypto/rsa/rsa_sign.c" 3 4
               ((void *)0)
# 414 "../crypto/rsa/rsa_sign.c"
               );
                goto err;
            }
        ...
        if (encoded_len != decrypt_len
            ...
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sign.c",426,__func__), ERR_set_error)((4),(104),
# 426 "../crypto/rsa/rsa_sign.c" 3 4
           ((void *)0)
# 426 "../crypto/rsa/rsa_sign.c"
           );
            goto err;
        }
        ...
        if (rm != 
# 431 "../crypto/rsa/rsa_sign.c" 3 4
                 ((void *)0)
# 431 "../crypto/rsa/rsa_sign.c"
                     ) {
            memcpy(rm, m, m_len);
            *prm_len = m_len;
        }
...
err:
    CRYPTO_clear_free(encoded, encoded_len, "../crypto/rsa/rsa_sign.c", 440);
    CRYPTO_clear_free(decrypt_buf, siglen, "../crypto/rsa/rsa_sign.c", 441);
    return ret;
}
...
# 449 "../crypto/rsa/rsa_sign.c" 3 4
                                ((void *)0)
# 449 "../crypto/rsa/rsa_sign.c"
                                    )
        return rsa->meth->rsa_verify(type, m, m_len, sigbuf, siglen, rsa);

    return ossl_rsa_verify(type, m, m_len, 
# 452 "../crypto/rsa/rsa_sign.c" 3 4
                                          ((void *)0)
# 452 "../crypto/rsa/rsa_sign.c"
                                              , 
# 452 "../crypto/rsa/rsa_sign.c" 3 4
                                                ((void *)0)
# 452 "../crypto/rsa/rsa_sign.c"
