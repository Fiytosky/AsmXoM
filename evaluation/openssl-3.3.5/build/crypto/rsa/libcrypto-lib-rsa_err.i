# 0 "../crypto/rsa/rsa_err.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_err.c"
# 11 "../crypto/rsa/rsa_err.c"
...
# 12 "../crypto/rsa/rsa_err.c" 2
# 1 "../include/openssl/rsaerr.h" 1
# 13 "../include/openssl/rsaerr.h"
        
# 13 "../crypto/rsa/rsa_err.c" 2
# 1 "../include/crypto/rsaerr.h" 1
# 13 "../include/crypto/rsaerr.h"
        
# 22 "../include/crypto/rsaerr.h"
int ossl_err_load_RSA_strings(void);
# 14 "../crypto/rsa/rsa_err.c" 2



static const ERR_STRING_DATA RSA_str_reasons[] = {
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(100) & 0X7FFFFF)) ), "algorithm mismatch"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(101) & 0X7FFFFF)) ), "bad e value"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "bad fixed header decrypt"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ), "bad pad byte count"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ), "bad signature"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "block type is not 01"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "block type is not 02"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "data greater than mod len"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ), "data too large"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "data too large for key size"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(132) & 0X7FFFFF)) ),
    "data too large for modulus"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ), "data too small"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "data too small for key size"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(158) & 0X7FFFFF)) ),
    "digest does not match"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(145) & 0X7FFFFF)) ), "digest not allowed"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ),
    "digest too big for rsa key"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "dmp1 not congruent to d"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "dmq1 not congruent to d"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "d e not congruent to 1"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(133) & 0X7FFFFF)) ),
    "first octet invalid"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(144) & 0X7FFFFF)) ),
    "illegal or unsupported padding mode"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(157) & 0X7FFFFF)) ), "invalid digest"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(143) & 0X7FFFFF)) ),
    "invalid digest length"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(137) & 0X7FFFFF)) ), "invalid header"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(171) & 0X7FFFFF)) ), "invalid keypair"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(173) & 0X7FFFFF)) ), "invalid key length"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(160) & 0X7FFFFF)) ), "invalid label"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(181) & 0X7FFFFF)) ), "invalid length"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "invalid message length"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(156) & 0X7FFFFF)) ), "invalid mgf1 md"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(174) & 0X7FFFFF)) ), "invalid modulus"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(167) & 0X7FFFFF)) ),
    "invalid multi prime key"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(161) & 0X7FFFFF)) ),
    "invalid oaep parameters"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(138) & 0X7FFFFF)) ), "invalid padding"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(141) & 0X7FFFFF)) ),
    "invalid padding mode"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(149) & 0X7FFFFF)) ),
    "invalid pss parameters"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(146) & 0X7FFFFF)) ),
    "invalid pss saltlen"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(175) & 0X7FFFFF)) ), "invalid request"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(150) & 0X7FFFFF)) ),
    "invalid salt length"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(176) & 0X7FFFFF)) ), "invalid strength"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(139) & 0X7FFFFF)) ), "invalid trailer"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(142) & 0X7FFFFF)) ),
    "invalid x931 digest"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "iqmp not inverse of q"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(165) & 0X7FFFFF)) ),
    "key prime num invalid"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ), "key size too small"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(134) & 0X7FFFFF)) ), "last octet invalid"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(152) & 0X7FFFFF)) ),
    "mgf1 digest not allowed"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(179) & 0X7FFFFF)) ),
    "missing private key"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ), "modulus too large"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(168) & 0X7FFFFF)) ),
    "mp coefficient not inverse of r"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(169) & 0X7FFFFF)) ),
    "mp exponent not congruent to d"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(170) & 0X7FFFFF)) ), "mp r not prime"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(140) & 0X7FFFFF)) ), "no public exponent"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ),
    "null before block missing"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(172) & 0X7FFFFF)) ),
    "n does not equal product of primes"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "n does not equal p q"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "oaep decoding error"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(148) & 0X7FFFFF)) ),
    "operation not supported for this keytype"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "padding check failed"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(177) & 0X7FFFFF)) ),
    "pairwise test failure"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(159) & 0X7FFFFF)) ),
    "pkcs decoding error"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(164) & 0X7FFFFF)) ),
    "pss saltlen too small"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(178) & 0X7FFFFF)) ),
    "pub exponent out of range"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ), "p not prime"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ), "q not prime"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(180) & 0X7FFFFF)) ),
    "randomness source strength insufficient"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "rsa operations not supported"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(136) & 0X7FFFFF)) ),
    "salt length check failed"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(135) & 0X7FFFFF)) ),
    "salt length recovery failed"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "sslv3 rollback attack"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "the asn1 object identifier is not known for this md"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "unknown algorithm type"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(166) & 0X7FFFFF)) ), "unknown digest"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(151) & 0X7FFFFF)) ),
    "unknown mask digest"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "unknown padding type"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(162) & 0X7FFFFF)) ),
    "unsupported encryption type"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(163) & 0X7FFFFF)) ),
    "unsupported label source"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(153) & 0X7FFFFF)) ),
    "unsupported mask algorithm"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(154) & 0X7FFFFF)) ),
    "unsupported mask parameter"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(155) & 0X7FFFFF)) ),
    "unsupported signature type"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(147) & 0X7FFFFF)) ), "value missing"},
    {( (((unsigned long)(4) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "wrong signature length"},
    {0, 
# 154 "../crypto/rsa/rsa_err.c" 3 4
       ((void *)0)
# 154 "../crypto/rsa/rsa_err.c"
           }
};
...
int ossl_err_load_RSA_strings(void)
{
    ...
    if (ERR_reason_error_string(RSA_str_reasons[0].error) == 
# 162 "../crypto/rsa/rsa_err.c" 3 4
                                                            ((void *)0)
# 162 "../crypto/rsa/rsa_err.c"
                                                                )
