# 0 "../crypto/rsa/rsa_chk.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_chk.c"
# 14 "../crypto/rsa/rsa_chk.c"
...
static int rsa_validate_keypair_multiprime(const RSA *key, BN_GENCB *cb)
{
    ...
    if (key->p == 
# 29 "../crypto/rsa/rsa_chk.c" 3 4
                 ((void *)0) 
# 29 "../crypto/rsa/rsa_chk.c"
                      || key->q == 
# 29 "../crypto/rsa/rsa_chk.c" 3 4
                                   ((void *)0) 
# 29 "../crypto/rsa/rsa_chk.c"
...
# 30 "../crypto/rsa/rsa_chk.c"
           || key->e == 
# 30 "../crypto/rsa/rsa_chk.c" 3 4
                        ((void *)0) 
# 30 "../crypto/rsa/rsa_chk.c"
                             || key->d == 
# 30 "../crypto/rsa/rsa_chk.c" 3 4
...
# 30 "../crypto/rsa/rsa_chk.c"
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",31,__func__), ERR_set_error)((4),(147),
# 31 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 31 "../crypto/rsa/rsa_chk.c"
       );
        return 0;
    }
    ...
    if (key->version == 1) {
        ...
        if (ex_primes <= 0
            ...
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",40,__func__), ERR_set_error)((4),(167),
# 40 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 40 "../crypto/rsa/rsa_chk.c"
           );
            return 0;
        }
    }
    ...
    if (i == 
# 51 "../crypto/rsa/rsa_chk.c" 3 4
            ((void *)0) 
# 51 "../crypto/rsa/rsa_chk.c"
                 || j == 
# 51 "../crypto/rsa/rsa_chk.c" 3 4
                         ((void *)0) 
# 51 "../crypto/rsa/rsa_chk.c"
...
# 52 "../crypto/rsa/rsa_chk.c"
           || m == 
# 52 "../crypto/rsa/rsa_chk.c" 3 4
                   ((void *)0) 
# 52 "../crypto/rsa/rsa_chk.c"
                        || ctx == 
# 52 "../crypto/rsa/rsa_chk.c" 3 4
...
# 52 "../crypto/rsa/rsa_chk.c"
        ...
        ret = -1;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",54,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 54 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 54 "../crypto/rsa/rsa_chk.c"
       );
        goto err;
    }
    ...
    if (BN_is_one(key->e)) {
        ret = 0;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",60,__func__), ERR_set_error)((4),(101),
# 60 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 60 "../crypto/rsa/rsa_chk.c"
       );
    }
    if (!BN_is_odd(key->e)) {
        ret = 0;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",64,__func__), ERR_set_error)((4),(101),
# 64 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 64 "../crypto/rsa/rsa_chk.c"
       );
    }
    ...
    if (BN_check_prime(key->p, ctx, cb) != 1) {
        ret = 0;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",70,__func__), ERR_set_error)((4),(128),
# 70 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 70 "../crypto/rsa/rsa_chk.c"
       );
    }
    ...
    if (BN_check_prime(key->q, ctx, cb) != 1) {
        ret = 0;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",76,__func__), ERR_set_error)((4),(129),
# 76 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 76 "../crypto/rsa/rsa_chk.c"
       );
    }
    ...
    for (idx = 0; idx < ex_primes; idx++) {
        ...
        if (BN_check_prime(pinfo->r, ctx, cb) != 1) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",84,__func__), ERR_set_error)((4),(170),
# 84 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 84 "../crypto/rsa/rsa_chk.c"
           );
        }
    }
    ...
    if (BN_cmp(i, key->n) != 0) {
        ret = 0;
        if (ex_primes)
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",103,__func__), ERR_set_error)((4),(172),
# 103 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 103 "../crypto/rsa/rsa_chk.c"
           );
        else
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",105,__func__), ERR_set_error)((4),(127),
# 105 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 105 "../crypto/rsa/rsa_chk.c"
           );
    }
    ...
    if (!BN_div(m, 
# 127 "../crypto/rsa/rsa_chk.c" 3 4
                  ((void *)0)
# 127 "../crypto/rsa/rsa_chk.c"
                      , l, m, ctx)) {
        ret = -1;
        goto err;
    }
    for (idx = 0; idx < ex_primes; idx++) {
        ...
        if (!BN_div(m, 
# 145 "../crypto/rsa/rsa_chk.c" 3 4
                      ((void *)0)
# 145 "../crypto/rsa/rsa_chk.c"
                          , l, m, ctx)) {
            ret = -1;
            goto err;
        }
    ...
    if (!BN_is_one(i)) {
        ret = 0;
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",157,__func__), ERR_set_error)((4),(123),
# 157 "../crypto/rsa/rsa_chk.c" 3 4
       ((void *)0)
# 157 "../crypto/rsa/rsa_chk.c"
       );
    }

    if (key->dmp1 != 
# 160 "../crypto/rsa/rsa_chk.c" 3 4
                    ((void *)0) 
# 160 "../crypto/rsa/rsa_chk.c"
                         && key->dmq1 != 
# 160 "../crypto/rsa/rsa_chk.c" 3 4
                                         ((void *)0) 
# 160 "../crypto/rsa/rsa_chk.c"
...
# 160 "../crypto/rsa/rsa_chk.c"
        ...
        if (!BN_div(
# 166 "../crypto/rsa/rsa_chk.c" 3 4
            ((void *)0)
# 166 "../crypto/rsa/rsa_chk.c"
            ,(j),(key->d),(i),(ctx))) {
            ret = -1;
            goto err;
        }
        if (BN_cmp(j, key->dmp1) != 0) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",172,__func__), ERR_set_error)((4),(124),
# 172 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 172 "../crypto/rsa/rsa_chk.c"
           );
        }
        ...
        if (!BN_div(
# 180 "../crypto/rsa/rsa_chk.c" 3 4
            ((void *)0)
# 180 "../crypto/rsa/rsa_chk.c"
            ,(j),(key->d),(i),(ctx))) {
            ret = -1;
            goto err;
        }
        if (BN_cmp(j, key->dmq1) != 0) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",186,__func__), ERR_set_error)((4),(125),
# 186 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 186 "../crypto/rsa/rsa_chk.c"
           );
        }
        ...
        if (BN_cmp(i, key->iqmp) != 0) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",196,__func__), ERR_set_error)((4),(126),
# 196 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 196 "../crypto/rsa/rsa_chk.c"
           );
        }
    }
    ...
    for (idx = 0; idx < ex_primes; idx++) {
        ...
        if (!BN_div(
# 207 "../crypto/rsa/rsa_chk.c" 3 4
            ((void *)0)
# 207 "../crypto/rsa/rsa_chk.c"
            ,(j),(key->d),(i),(ctx))) {
            ret = -1;
            goto err;
        }
        if (BN_cmp(j, pinfo->d) != 0) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",213,__func__), ERR_set_error)((4),(169),
# 213 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 213 "../crypto/rsa/rsa_chk.c"
           );
        }
        ...
        if (BN_cmp(i, pinfo->t) != 0) {
            ret = 0;
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_chk.c",222,__func__), ERR_set_error)((4),(168),
# 222 "../crypto/rsa/rsa_chk.c" 3 4
           ((void *)0)
# 222 "../crypto/rsa/rsa_chk.c"
           );
        }
    }
...
int ossl_rsa_validate_pairwise(const RSA *key)
{
    ...
    return rsa_validate_keypair_multiprime(key, 
# 252 "../crypto/rsa/rsa_chk.c" 3 4
                                               ((void *)0)
# 252 "../crypto/rsa/rsa_chk.c"
                                                   ) > 0;
...
{
    return RSA_check_key_ex(key, 
# 258 "../crypto/rsa/rsa_chk.c" 3 4
                                ((void *)0)
# 258 "../crypto/rsa/rsa_chk.c"
                                    );
}
