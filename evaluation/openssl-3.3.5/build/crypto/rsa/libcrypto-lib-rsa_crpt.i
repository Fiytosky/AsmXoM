# 0 "../crypto/rsa/rsa_crpt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_crpt.c"
# 14 "../crypto/rsa/rsa_crpt.c"
...
{
    return r == 
# 59 "../crypto/rsa/rsa_crpt.c" 3 4
               ((void *)0) 
# 59 "../crypto/rsa/rsa_crpt.c"
                    ? 0 : r->meth->flags;
}
...
void RSA_blinding_off(RSA *rsa)
{
    ...
    rsa->blinding = 
# 65 "../crypto/rsa/rsa_crpt.c" 3 4
                   ((void *)0)
# 65 "../crypto/rsa/rsa_crpt.c"
                       ;
    rsa->flags &= ~0x0008;
    rsa->flags |= 0x0080;
}
...
int RSA_blinding_on(RSA *rsa, BN_CTX *ctx)
{
    ...
    if (rsa->blinding != 
# 74 "../crypto/rsa/rsa_crpt.c" 3 4
                        ((void *)0)
# 74 "../crypto/rsa/rsa_crpt.c"
                            )
        RSA_blinding_off(rsa);

    rsa->blinding = RSA_setup_blinding(rsa, ctx);
    if (rsa->blinding == 
# 78 "../crypto/rsa/rsa_crpt.c" 3 4
                        ((void *)0)
# 78 "../crypto/rsa/rsa_crpt.c"
                            )
        goto err;
...
{
    BIGNUM *ret = 
# 91 "../crypto/rsa/rsa_crpt.c" 3 4
                 ((void *)0)
# 91 "../crypto/rsa/rsa_crpt.c"
                     , *r0, *r1, *r2;

    if (d == 
# 93 "../crypto/rsa/rsa_crpt.c" 3 4
            ((void *)0) 
# 93 "../crypto/rsa/rsa_crpt.c"
                 || p == 
# 93 "../crypto/rsa/rsa_crpt.c" 3 4
                         ((void *)0) 
# 93 "../crypto/rsa/rsa_crpt.c"
...
# 93 "../crypto/rsa/rsa_crpt.c"
        ...
        return 
# 94 "../crypto/rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 94 "../crypto/rsa/rsa_crpt.c"
                  ;
    ...
    r2 = BN_CTX_get(ctx);
    if (r2 == 
# 100 "../crypto/rsa/rsa_crpt.c" 3 4
             ((void *)0)
# 100 "../crypto/rsa/rsa_crpt.c"
                 )
        goto err;
    ...
    ret = BN_mod_inverse(
# 110 "../crypto/rsa/rsa_crpt.c" 3 4
                        ((void *)0)
# 110 "../crypto/rsa/rsa_crpt.c"
                            , d, r0, ctx);
 err:
    BN_CTX_end(ctx);
    return ret;
...
BN_BLINDING *RSA_setup_blinding(RSA *rsa, BN_CTX *in_ctx)
{
    ...
    BN_CTX *ctx;
    BN_BLINDING *ret = 
# 120 "../crypto/rsa/rsa_crpt.c" 3 4
                      ((void *)0)
# 120 "../crypto/rsa/rsa_crpt.c"
                          ;

    if (in_ctx == 
# 122 "../crypto/rsa/rsa_crpt.c" 3 4
                 ((void *)0)
# 122 "../crypto/rsa/rsa_crpt.c"
                     ) {
        if ((ctx = BN_CTX_new_ex(rsa->libctx)) == 
# 123 "../crypto/rsa/rsa_crpt.c" 3 4
                                                 ((void *)0)
# 123 "../crypto/rsa/rsa_crpt.c"
                                                     )
            return 0;
    } else {
        ctx = in_ctx;
    ...
    e = BN_CTX_get(ctx);
    if (e == 
# 131 "../crypto/rsa/rsa_crpt.c" 3 4
            ((void *)0)
# 131 "../crypto/rsa/rsa_crpt.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_crpt.c",132,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 132 "../crypto/rsa/rsa_crpt.c" 3 4
       ((void *)0)
# 132 "../crypto/rsa/rsa_crpt.c"
       );
        goto err;
    }

    if (rsa->e == 
# 136 "../crypto/rsa/rsa_crpt.c" 3 4
                 ((void *)0)
# 136 "../crypto/rsa/rsa_crpt.c"
                     ) {
        e = rsa_get_public_exp(rsa->d, rsa->p, rsa->q, ctx);
        if (e == 
# 138 "../crypto/rsa/rsa_crpt.c" 3 4
                ((void *)0)
# 138 "../crypto/rsa/rsa_crpt.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_crpt.c",139,__func__), ERR_set_error)((4),(140),
# 139 "../crypto/rsa/rsa_crpt.c" 3 4
           ((void *)0)
# 139 "../crypto/rsa/rsa_crpt.c"
           );
            goto err;
        }
    } else {
...

    {
        ...
        if (n == 
# 149 "../crypto/rsa/rsa_crpt.c" 3 4
                ((void *)0)
# 149 "../crypto/rsa/rsa_crpt.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_crpt.c",150,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 150 "../crypto/rsa/rsa_crpt.c" 3 4
           ((void *)0)
# 150 "../crypto/rsa/rsa_crpt.c"
           );
            goto err;
        }
        BN_with_flags(n, rsa->n, 0x04);

        ret = BN_BLINDING_create_param(
# 155 "../crypto/rsa/rsa_crpt.c" 3 4
                                      ((void *)0)
# 155 "../crypto/rsa/rsa_crpt.c"
    ...
    if (ret == 
# 160 "../crypto/rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 160 "../crypto/rsa/rsa_crpt.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_crpt.c",161,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 161 "../crypto/rsa/rsa_crpt.c" 3 4
       ((void *)0)
# 161 "../crypto/rsa/rsa_crpt.c"
       );
        goto err;
    }
