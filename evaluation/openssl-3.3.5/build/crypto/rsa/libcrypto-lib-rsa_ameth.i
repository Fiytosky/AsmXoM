# 0 "../crypto/rsa/rsa_ameth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_ameth.c"
# 14 "../crypto/rsa/rsa_ameth.c"
...
# 20 "../crypto/rsa/rsa_ameth.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 22 "../crypto/rsa/rsa_ameth.c" 2
                            ...
                            ASN1_STRING **pstr, int *pstrtype)
{
    ...
    *pstr = 
# 34 "../crypto/rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 34 "../crypto/rsa/rsa_ameth.c"
               ;

    if (RSA_test_flags(rsa, 0xF000) != 0x1000) {
        *pstrtype = 5;
        return 1;
    }

    if (rsa->pss == 
# 41 "../crypto/rsa/rsa_ameth.c" 3 4
                   ((void *)0)
# 41 "../crypto/rsa/rsa_ameth.c"
                       ) {
        *pstrtype = -1;
        return 1;
    }

    if (ASN1_item_pack(rsa->pss, (RSA_PSS_PARAMS_it()), pstr) == 
# 46 "../crypto/rsa/rsa_ameth.c" 3 4
                                                                         ((void *)0)
# 46 "../crypto/rsa/rsa_ameth.c"
                                                                             )
        return 0;
...
{
    unsigned char *penc = 
# 55 "../crypto/rsa/rsa_ameth.c" 3 4
                         ((void *)0)
# 55 "../crypto/rsa/rsa_ameth.c"
                             ;
    int penclen;
    ASN1_STRING *str;
    int strtype;
    ...
    CRYPTO_free(penc, "../crypto/rsa/rsa_ameth.c", 71);
    ASN1_STRING_free(str);
    return 0;
}
...
static int rsa_pub_decode(EVP_PKEY *pkey, const X509_PUBKEY *pubkey)
{
    ...
    X509_ALGOR *alg;
    RSA *rsa = 
# 81 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 81 "../crypto/rsa/rsa_ameth.c"
                  ;

    if (!X509_PUBKEY_get0_param(
# 83 "../crypto/rsa/rsa_ameth.c" 3 4
                               ((void *)0)
# 83 "../crypto/rsa/rsa_ameth.c"
                                   , &p, &pklen, &alg, pubkey))
        return 0;
    if ((rsa = d2i_RSAPublicKey(
# 85 "../crypto/rsa/rsa_ameth.c" 3 4
                               ((void *)0)
# 85 "../crypto/rsa/rsa_ameth.c"
                                   , &p, pklen)) == 
# 85 "../crypto/rsa/rsa_ameth.c" 3 4
                                                    ((void *)0)
# 85 "../crypto/rsa/rsa_ameth.c"
    ...
    RSA_clear_flags(rsa, 0xF000);
    switch (pkey->ameth->pkey_id) {
    case 6:
        RSA_set_flags(rsa, 0x0000);
        break;
    case 912:
        RSA_set_flags(rsa, 0x1000);
        break;
    default:
...
static int rsa_pub_cmp(const EVP_PKEY *a, const EVP_PKEY *b)
{
    ...
    if (((RSA_flags(a->pkey.rsa) & 0x0001))
            || (RSA_flags(b->pkey.rsa) & 0x0001)) {
        return 1;
    }
...
# 134 "../crypto/rsa/rsa_ameth.c" 3 4
                                ((void *)0)
# 134 "../crypto/rsa/rsa_ameth.c"
                                    , pder, derlen)) == 
# 134 "../crypto/rsa/rsa_ameth.c" 3 4
                                                        ((void *)0)
# 134 "../crypto/rsa/rsa_ameth.c"
...
{
    unsigned char *rk = 
# 147 "../crypto/rsa/rsa_ameth.c" 3 4
                       ((void *)0)
# 147 "../crypto/rsa/rsa_ameth.c"
                           ;
    int rklen;
    ASN1_STRING *str;
    int strtype;
    ...
    if (rklen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",157,__func__), ERR_set_error)((4),((13 | (0x2 << 18L))),
# 157 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 157 "../crypto/rsa/rsa_ameth.c"
       );
        ASN1_STRING_free(str);
        return 0;
    }
    ...
    if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(pkey->ameth->pkey_id), 0,
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",164,__func__), ERR_set_error)((4),((13 | (0x2 << 18L))),
# 164 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 164 "../crypto/rsa/rsa_ameth.c"
       );
        ASN1_STRING_free(str);
        CRYPTO_clear_free(rk, rklen, "../crypto/rsa/rsa_ameth.c", 166);
        return 0;
    }
...
{
    int ret = 0;
    RSA *rsa = ossl_rsa_key_from_pkcs8(p8, 
# 176 "../crypto/rsa/rsa_ameth.c" 3 4
                                          ((void *)0)
# 176 "../crypto/rsa/rsa_ameth.c"
                                              , 
# 176 "../crypto/rsa/rsa_ameth.c" 3 4
                                                ((void *)0)
# 176 "../crypto/rsa/rsa_ameth.c"
    ...
    if (rsa != 
# 178 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 178 "../crypto/rsa/rsa_ameth.c"
                  ) {
        ret = 1;
        EVP_PKEY_assign(pkey, pkey->ameth->pkey_id, rsa);
    }
                               ...
                               int indent)
{
    int rv = 0;
    X509_ALGOR *maskHash = 
# 209 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 209 "../crypto/rsa/rsa_ameth.c"
                              ;
    ...
    if (pss_key) {
        if (pss == 
# 214 "../crypto/rsa/rsa_ameth.c" 3 4
                  ((void *)0)
# 214 "../crypto/rsa/rsa_ameth.c"
                      ) {
...
# 222 "../crypto/rsa/rsa_ameth.c" 3 4
                     ((void *)0)
# 222 "../crypto/rsa/rsa_ameth.c"
                         ) {
    ...
    if (pss->maskGenAlgorithm) {
        ...
        if (maskHash != 
# 257 "../crypto/rsa/rsa_ameth.c" 3 4
                       ((void *)0)
# 257 "../crypto/rsa/rsa_ameth.c"
                           ) {
...
static int pkey_rsa_print(BIO *bp, const EVP_PKEY *pkey, int off, int priv)
{
    ...
    if (x->n != 
# 307 "../crypto/rsa/rsa_ameth.c" 3 4
               ((void *)0)
# 307 "../crypto/rsa/rsa_ameth.c"
                   )
    ...
    if (BIO_printf(bp, "%s ", (pkey->ameth->pkey_id == 912) ? "RSA-PSS" : "RSA") <= 0)
        goto err;
    ...
    if (!ASN1_bn_print(bp, str, x->n, 
# 329 "../crypto/rsa/rsa_ameth.c" 3 4
                                     ((void *)0)
# 329 "../crypto/rsa/rsa_ameth.c"
                                         , off))
        goto err;
    if (!ASN1_bn_print(bp, s, x->e, 
# 331 "../crypto/rsa/rsa_ameth.c" 3 4
                                   ((void *)0)
# 331 "../crypto/rsa/rsa_ameth.c"
                                       , off))
        goto err;
    if (priv) {
        int i;

        if (!ASN1_bn_print(bp, "privateExponent:", x->d, 
# 336 "../crypto/rsa/rsa_ameth.c" 3 4
                                                        ((void *)0)
# 336 "../crypto/rsa/rsa_ameth.c"
                                                            , off))
            goto err;
        if (!ASN1_bn_print(bp, "prime1:", x->p, 
# 338 "../crypto/rsa/rsa_ameth.c" 3 4
                                               ((void *)0)
# 338 "../crypto/rsa/rsa_ameth.c"
                                                   , off))
            goto err;
        if (!ASN1_bn_print(bp, "prime2:", x->q, 
# 340 "../crypto/rsa/rsa_ameth.c" 3 4
                                               ((void *)0)
# 340 "../crypto/rsa/rsa_ameth.c"
                                                   , off))
            goto err;
        if (!ASN1_bn_print(bp, "exponent1:", x->dmp1, 
# 342 "../crypto/rsa/rsa_ameth.c" 3 4
                                                     ((void *)0)
# 342 "../crypto/rsa/rsa_ameth.c"
                                                         , off))
            goto err;
        if (!ASN1_bn_print(bp, "exponent2:", x->dmq1, 
# 344 "../crypto/rsa/rsa_ameth.c" 3 4
                                                     ((void *)0)
# 344 "../crypto/rsa/rsa_ameth.c"
                                                         , off))
            goto err;
        if (!ASN1_bn_print(bp, "coefficient:", x->iqmp, 
# 346 "../crypto/rsa/rsa_ameth.c" 3 4
                                                       ((void *)0)
# 346 "../crypto/rsa/rsa_ameth.c"
                                                           , off))
            goto err;
        for (i = 0; i < sk_RSA_PRIME_INFO_num(x->prime_infos); i++) {

            BIGNUM *bn = 
# 350 "../crypto/rsa/rsa_ameth.c" 3 4
                        ((void *)0)
# 350 "../crypto/rsa/rsa_ameth.c"
                            ;
            ...
            for (j = 0; j < 3; j++) {
                ...
                if (!ASN1_bn_print(bp, "", bn, 
# 377 "../crypto/rsa/rsa_ameth.c" 3 4
                                              ((void *)0)
# 377 "../crypto/rsa/rsa_ameth.c"
                                                  , off))
                    goto err;
            }
        }
    }
    if ((pkey->ameth->pkey_id == 912) && !rsa_pss_param_print(bp, 1, x->pss, off))
        goto err;
    ret = 1;
 err:
    return ret;
...
static int rsa_pkey_ctrl(EVP_PKEY *pkey, int op, long arg1, void *arg2)
{
    ...
    switch (op) {
    case 0x3:
        if (pkey->pkey.rsa->pss != 
# 428 "../crypto/rsa/rsa_ameth.c" 3 4
                                  ((void *)0)
# 428 "../crypto/rsa/rsa_ameth.c"
                                      ) {
            if (!ossl_rsa_pss_get_param(pkey->pkey.rsa->pss, &md, &mgf1md,
                                        &min_saltlen)) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",431,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 431 "../crypto/rsa/rsa_ameth.c" 3 4
               ((void *)0)
...
static RSA_PSS_PARAMS *rsa_ctx_to_pss(EVP_PKEY_CTX *pkctx)
{
    ...
    if (EVP_PKEY_CTX_get_signature_md(pkctx, &sigmd) <= 0)
        return 
# 459 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 459 "../crypto/rsa/rsa_ameth.c"
                  ;
    if (EVP_PKEY_CTX_get_rsa_mgf1_md(pkctx, &mgf1md) <= 0)
        return 
# 461 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 461 "../crypto/rsa/rsa_ameth.c"
                  ;
    if (EVP_PKEY_CTX_get_rsa_pss_saltlen(pkctx, &saltlen) <= 0)
        return 
# 463 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 463 "../crypto/rsa/rsa_ameth.c"
                  ;
    if (saltlen == -1) {
                                           ...
                                           const EVP_MD *mgf1md, int saltlen)
{
    ...
    if (pss == 
# 495 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 495 "../crypto/rsa/rsa_ameth.c"
                  )
        goto err;
    if (saltlen != 20) {
        pss->saltLength = ASN1_INTEGER_new();
        if (pss->saltLength == 
# 499 "../crypto/rsa/rsa_ameth.c" 3 4
                              ((void *)0)
# 499 "../crypto/rsa/rsa_ameth.c"
                                  )
            goto err;
    ...
    if (!ossl_x509_algor_new_from_md(&pss->hashAlgorithm, sigmd))
        goto err;
    if (mgf1md == 
# 506 "../crypto/rsa/rsa_ameth.c" 3 4
                 ((void *)0)
# 506 "../crypto/rsa/rsa_ameth.c"
                     )
        mgf1md = sigmd;
 ...
 err:
    RSA_PSS_PARAMS_free(pss);
    return 
# 515 "../crypto/rsa/rsa_ameth.c" 3 4
          ((void *)0)
# 515 "../crypto/rsa/rsa_ameth.c"
              ;
}
...
ASN1_STRING *ossl_rsa_ctx_to_pss_string(EVP_PKEY_CTX *pkctx)
{
    ...
    if (pss == 
# 523 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 523 "../crypto/rsa/rsa_ameth.c"
                  )
        return 
# 524 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 524 "../crypto/rsa/rsa_ameth.c"
                  ;

    os = ASN1_item_pack(pss, (RSA_PSS_PARAMS_it()), 
# 526 "../crypto/rsa/rsa_ameth.c" 3 4
                                                            ((void *)0)
# 526 "../crypto/rsa/rsa_ameth.c"
                                                                );
    RSA_PSS_PARAMS_free(pss);
    return os;
}
                        ...
                        const X509_ALGOR *sigalg, EVP_PKEY *pkey)
{
    ...
    int saltlen;
    const EVP_MD *mgf1md = 
# 542 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 542 "../crypto/rsa/rsa_ameth.c"
                              , *md = 
# 542 "../crypto/rsa/rsa_ameth.c" 3 4
                                      ((void *)0)
# 542 "../crypto/rsa/rsa_ameth.c"
    ...
    if (OBJ_obj2nid(sigalg->algorithm) != 912) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",547,__func__), ERR_set_error)((4),(155),
# 547 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 547 "../crypto/rsa/rsa_ameth.c"
       );
        return -1;
    }
    ...
    if (!ossl_rsa_pss_get_param(pss, &md, &mgf1md, &saltlen)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",554,__func__), ERR_set_error)((4),(149),
# 554 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 554 "../crypto/rsa/rsa_ameth.c"
       );
        goto err;
    }
...
# 560 "../crypto/rsa/rsa_ameth.c" 3 4
                                                  ((void *)0)
# 560 "../crypto/rsa/rsa_ameth.c"
                                                      , pkey))
            goto err;
    } else {
        ...
        if (EVP_MD_get_type(md) != EVP_MD_get_type(checkmd)) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",567,__func__), ERR_set_error)((4),(158),
# 567 "../crypto/rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 567 "../crypto/rsa/rsa_ameth.c"
           );
            goto err;
        }
    }

    if (EVP_PKEY_CTX_set_rsa_padding(pkctx, 6) <= 0)
        goto err;
...
{
    if (psaltlen != 
# 591 "../crypto/rsa/rsa_ameth.c" 3 4
                   ((void *)0) 
# 591 "../crypto/rsa/rsa_ameth.c"
                        && *psaltlen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",592,__func__), ERR_set_error)((4),(150),
# 592 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 592 "../crypto/rsa/rsa_ameth.c"
       );
        return 0;
    }
    ...
    if (ptrailerField != 
# 599 "../crypto/rsa/rsa_ameth.c" 3 4
                        ((void *)0) 
# 599 "../crypto/rsa/rsa_ameth.c"
                             && *ptrailerField != 1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",600,__func__), ERR_set_error)((4),(139),
# 600 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 600 "../crypto/rsa/rsa_ameth.c"
       );
        return 0;
    }
    return 1;
                           ...
                           const ASN1_BIT_STRING *sig, EVP_PKEY *pkey)
{
    ...
    if (OBJ_obj2nid(sigalg->algorithm) != 912) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",635,__func__), ERR_set_error)((4),(155),
# 635 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 635 "../crypto/rsa/rsa_ameth.c"
       );
        return -1;
    }
    if (ossl_rsa_pss_to_ctx(ctx, 
# 638 "../crypto/rsa/rsa_ameth.c" 3 4
                                ((void *)0)
# 638 "../crypto/rsa/rsa_ameth.c"
                                    , sigalg, pkey) > 0) {
                         ...
                         ASN1_BIT_STRING *sig)
{
    ...
    if (pad_mode == 6) {
        ...
        if (((pkctx)->keymgmt == 
# 661 "../crypto/rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 661 "../crypto/rsa/rsa_ameth.c"
           )) {

            ASN1_STRING *os1 = 
# 663 "../crypto/rsa/rsa_ameth.c" 3 4
                              ((void *)0)
# 663 "../crypto/rsa/rsa_ameth.c"
                                  ;

            os1 = ossl_rsa_ctx_to_pss_string(pkctx);
            if (os1 == 
# 666 "../crypto/rsa/rsa_ameth.c" 3 4
                      ((void *)0)
# 666 "../crypto/rsa/rsa_ameth.c"
                          )
                return 0;

            if (alg2 != 
# 669 "../crypto/rsa/rsa_ameth.c" 3 4
                       ((void *)0)
# 669 "../crypto/rsa/rsa_ameth.c"
                           ) {
                ASN1_STRING *os2 = ASN1_STRING_dup(os1);

                if (os2 == 
# 672 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 672 "../crypto/rsa/rsa_ameth.c"
                              ) {
                    ASN1_STRING_free(os1);
                    return 0;
                }
                if (!X509_ALGOR_set0(alg2, OBJ_nid2obj(912),
                                     16, os2)) {
                    ASN1_STRING_free(os1);
            ...
            if (!X509_ALGOR_set0(alg1, OBJ_nid2obj(912),
                                 16, os1)) {
                    ASN1_STRING_free(os1);
                    return 0;
            }
        ...
        if (alg1 != 
# 700 "../crypto/rsa/rsa_ameth.c" 3 4
                   ((void *)0)
# 700 "../crypto/rsa/rsa_ameth.c"
                       ) {
            const unsigned char *pp = aid;

            if (d2i_X509_ALGOR(&alg1, &pp, aid_len) == 
# 703 "../crypto/rsa/rsa_ameth.c" 3 4
                                                      ((void *)0)
# 703 "../crypto/rsa/rsa_ameth.c"
                                                          )
                return 0;
        }
        if (alg2 != 
# 706 "../crypto/rsa/rsa_ameth.c" 3 4
                   ((void *)0)
# 706 "../crypto/rsa/rsa_ameth.c"
                       ) {
            const unsigned char *pp = aid;

            if (d2i_X509_ALGOR(&alg2, &pp, aid_len) == 
# 709 "../crypto/rsa/rsa_ameth.c" 3 4
                                                      ((void *)0)
# 709 "../crypto/rsa/rsa_ameth.c"
                                                          )
                return 0;
        }
                            ...
                            const ASN1_STRING *sig)
{
    ...
    uint32_t flags;
    const EVP_MD *mgf1md = 
# 724 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 724 "../crypto/rsa/rsa_ameth.c"
                              , *md = 
# 724 "../crypto/rsa/rsa_ameth.c" 3 4
                                      ((void *)0)
# 724 "../crypto/rsa/rsa_ameth.c"
    ...
    if ((mdnid == 672 || mdnid == 673 || mdnid == 674)
...
# 758 "../crypto/rsa/rsa_ameth.c"
    if (mdnid == 64)
        ...
        secbits = 39;
    X509_SIG_INFO_set(siginf, mdnid, 912, secbits,
                      flags);
    rv = 1;
    err:
    RSA_PSS_PARAMS_free(pss);
...
{
    return RSA_check_key_ex(pkey->pkey.rsa, 
# 774 "../crypto/rsa/rsa_ameth.c" 3 4
                                           ((void *)0)
# 774 "../crypto/rsa/rsa_ameth.c"
                                               );
}
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    OSSL_PARAM *params = 
# 793 "../crypto/rsa/rsa_ameth.c" 3 4
                        ((void *)0)
# 793 "../crypto/rsa/rsa_ameth.c"
                            ;
    int selection = 0;
    int rv = 0;

    if (tmpl == 
# 797 "../crypto/rsa/rsa_ameth.c" 3 4
               ((void *)0)
# 797 "../crypto/rsa/rsa_ameth.c"
                   )
        return 0;

    if (RSA_get0_n(rsa) == 
# 800 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0) 
# 800 "../crypto/rsa/rsa_ameth.c"
                               || RSA_get0_e(rsa) == 
# 800 "../crypto/rsa/rsa_ameth.c" 3 4
                                                     ((void *)0)
# 800 "../crypto/rsa/rsa_ameth.c"
    ...
    if (!ossl_rsa_todata(rsa, tmpl, 
# 803 "../crypto/rsa/rsa_ameth.c" 3 4
                                   ((void *)0)
# 803 "../crypto/rsa/rsa_ameth.c"
                                       , 1))
        goto err;

    selection |= 0x02;
    if (RSA_get0_d(rsa) != 
# 807 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 807 "../crypto/rsa/rsa_ameth.c"
                              )
        selection |= 0x01;

    if (rsa->pss != 
# 810 "../crypto/rsa/rsa_ameth.c" 3 4
                   ((void *)0)
# 810 "../crypto/rsa/rsa_ameth.c"
                       ) {
        const EVP_MD *md = 
# 811 "../crypto/rsa/rsa_ameth.c" 3 4
                          ((void *)0)
# 811 "../crypto/rsa/rsa_ameth.c"
                              , *mgf1md = 
# 811 "../crypto/rsa/rsa_ameth.c" 3 4
                                          ((void *)0)
# 811 "../crypto/rsa/rsa_ameth.c"
        ...
        if (!ossl_rsa_pss_params_30_set_defaults(&pss_params)
            ...
            || !ossl_rsa_pss_params_30_todata(&pss_params, tmpl, 
# 825 "../crypto/rsa/rsa_ameth.c" 3 4
                                                                ((void *)0)
# 825 "../crypto/rsa/rsa_ameth.c"
                                                                    ))
            goto err;
        selection |= 0x80;
    }
...
# 830 "../crypto/rsa/rsa_ameth.c" 3 4
                                                   ((void *)0)
# 830 "../crypto/rsa/rsa_ameth.c"
                                                       )
        goto err;
                               ...
                               int rsa_type)
{
    ...
    if (rsa == 
# 852 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 852 "../crypto/rsa/rsa_ameth.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ameth.c",853,__func__), ERR_set_error)((5),((4 | (0x2 << 18L))),
# 853 "../crypto/rsa/rsa_ameth.c" 3 4
       ((void *)0)
# 853 "../crypto/rsa/rsa_ameth.c"
       );
        return 0;
    }
    ...
    case 0x1000:
        ...
        if (!ossl_rsa_pss_params_30_is_unrestricted(&rsa_pss_params)) {
            ...
            const EVP_MD *md = EVP_get_digestbyname(OBJ_nid2sn(mdnid));
            const EVP_MD *mgf1md = EVP_get_digestbyname(OBJ_nid2sn(mgf1mdnid));

            if ((rsa->pss = ossl_rsa_pss_params_create(md, mgf1md,
                                                       saltlen)) == 
# 887 "../crypto/rsa/rsa_ameth.c" 3 4
                                                                   ((void *)0)
# 887 "../crypto/rsa/rsa_ameth.c"
                                                                       )
                goto err;
        }
        break;
    ...
    switch (rsa_type) {
    case 0x0000:
        ok = EVP_PKEY_assign((pkey),6, (rsa));
        break;
    case 0x1000:
        ok = EVP_PKEY_assign(pkey, 912, rsa);
        break;
    }
...
static int rsa_pkey_export_to(const EVP_PKEY *from, void *to_keydata,
                              ...
                              OSSL_LIB_CTX *libctx, const char *propq)
{
    return rsa_int_export_to(from, 0x0000, to_keydata,
...
static int rsa_pss_pkey_export_to(const EVP_PKEY *from, void *to_keydata,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq)
{
    return rsa_int_export_to(from, 0x1000, to_keydata,
                             importer, libctx, propq);
}

static int rsa_pkey_import_from(const OSSL_PARAM params[], void *vpctx)
{
    return rsa_int_import_from(params, vpctx, 0x0000);
}

static int rsa_pss_pkey_import_from(const OSSL_PARAM params[], void *vpctx)
{
    return rsa_int_import_from(params, vpctx, 0x1000);
}
...
static int rsa_pkey_copy(EVP_PKEY *to, EVP_PKEY *from)
{
    RSA *rsa = from->pkey.rsa;
    RSA *dupkey = 
# 943 "../crypto/rsa/rsa_ameth.c" 3 4
                 ((void *)0)
# 943 "../crypto/rsa/rsa_ameth.c"
                     ;
    int ret;

    if (rsa != 
# 946 "../crypto/rsa/rsa_ameth.c" 3 4
              ((void *)0)
# 946 "../crypto/rsa/rsa_ameth.c"
                  ) {
        dupkey = ossl_rsa_dup(rsa, ( ( 0x01 | 0x02 ) | ( 0x04 | 0x80) ));
        if (dupkey == 
# 948 "../crypto/rsa/rsa_ameth.c" 3 4
                     ((void *)0)
# 948 "../crypto/rsa/rsa_ameth.c"
                         )
            return 0;
    }
