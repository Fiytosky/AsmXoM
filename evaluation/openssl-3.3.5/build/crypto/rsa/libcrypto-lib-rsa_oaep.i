# 0 "../crypto/rsa/rsa_oaep.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_oaep.c"
# 27 "../crypto/rsa/rsa_oaep.c"
...
# 43 "../crypto/rsa/rsa_oaep.c" 3 4
                                                  ((void *)0)
# 43 "../crypto/rsa/rsa_oaep.c"
                                                      , to, tlen, from, flen,
                                                   param, plen, 
# 44 "../crypto/rsa/rsa_oaep.c" 3 4
                                                               ((void *)0)
# 44 "../crypto/rsa/rsa_oaep.c"
                                                                   , 
# 44 "../crypto/rsa/rsa_oaep.c" 3 4
                                                                     ((void *)0)
# 44 "../crypto/rsa/rsa_oaep.c"
...
# 64 "../crypto/rsa/rsa_oaep.c" 3 4
                           ((void *)0)
# 64 "../crypto/rsa/rsa_oaep.c"
                               ;
    unsigned char seedmask[64];
    int mdlen, dbmask_len = 0;

    if (md == 
# 68 "../crypto/rsa/rsa_oaep.c" 3 4
             ((void *)0)
# 68 "../crypto/rsa/rsa_oaep.c"
                 ) {
    ...
    if (mgf1md == 
# 76 "../crypto/rsa/rsa_oaep.c" 3 4
                 ((void *)0)
# 76 "../crypto/rsa/rsa_oaep.c"
                     )
        mgf1md = md;

    mdlen = EVP_MD_get_size(md);
    if (mdlen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_oaep.c",81,__func__), ERR_set_error)((4),(181),
# 81 "../crypto/rsa/rsa_oaep.c" 3 4
       ((void *)0)
# 81 "../crypto/rsa/rsa_oaep.c"
       );
        return 0;
    }
    ...
    if (flen > emlen - 2 * mdlen - 1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_oaep.c",87,__func__), ERR_set_error)((4),(110),
# 87 "../crypto/rsa/rsa_oaep.c" 3 4
       ((void *)0)
# 87 "../crypto/rsa/rsa_oaep.c"
       );
        return 0;
    }

    if (emlen < 2 * mdlen + 1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_oaep.c",92,__func__), ERR_set_error)((4),(120),
# 92 "../crypto/rsa/rsa_oaep.c" 3 4
       ((void *)0)
# 92 "../crypto/rsa/rsa_oaep.c"
       );
        return 0;
    }
...
# 102 "../crypto/rsa/rsa_oaep.c" 3 4
                                            ((void *)0)
# 102 "../crypto/rsa/rsa_oaep.c"
                                                , md, 
# 102 "../crypto/rsa/rsa_oaep.c" 3 4
                                                      ((void *)0)
# 102 "../crypto/rsa/rsa_oaep.c"
    ...
    dbmask = CRYPTO_malloc(dbmask_len, "../crypto/rsa/rsa_oaep.c", 114);
    if (dbmask == 
# 115 "../crypto/rsa/rsa_oaep.c" 3 4
                 ((void *)0)
# 115 "../crypto/rsa/rsa_oaep.c"
                     )
        goto err;
 ...
 err:
    ...
    CRYPTO_clear_free(dbmask, dbmask_len, "../crypto/rsa/rsa_oaep.c", 135);
    return rv;
}
...
{
    return ossl_rsa_padding_add_PKCS1_OAEP_mgf1_ex(
# 144 "../crypto/rsa/rsa_oaep.c" 3 4
                                                  ((void *)0)
# 144 "../crypto/rsa/rsa_oaep.c"
                                                      , to, tlen, from, flen,
                                 ...
                                 const unsigned char *param, int plen)
{
    return RSA_padding_check_PKCS1_OAEP_mgf1(to, tlen, from, flen, num,
                                             param, plen, 
# 153 "../crypto/rsa/rsa_oaep.c" 3 4
                                                         ((void *)0)
# 153 "../crypto/rsa/rsa_oaep.c"
                                                             , 
# 153 "../crypto/rsa/rsa_oaep.c" 3 4
                                                               ((void *)0)
# 153 "../crypto/rsa/rsa_oaep.c"
                                      ...
                                      const EVP_MD *mgf1md)
{
    ...
    unsigned char *db = 
# 169 "../crypto/rsa/rsa_oaep.c" 3 4
                       ((void *)0)
# 169 "../crypto/rsa/rsa_oaep.c"
                           , *em = 
# 169 "../crypto/rsa/rsa_oaep.c" 3 4
                                   ((void *)0)
# 169 "../crypto/rsa/rsa_oaep.c"
    ...
    if (md == 
# 173 "../crypto/rsa/rsa_oaep.c" 3 4
             ((void *)0)
# 173 "../crypto/rsa/rsa_oaep.c"
                 ) {
    ...
    if (mgf1md == 
# 182 "../crypto/rsa/rsa_oaep.c" 3 4
                 ((void *)0)
# 182 "../crypto/rsa/rsa_oaep.c"
                     )
        mgf1md = md;
    ...
    if (tlen <= 0 || flen <= 0 || mdlen <= 0)
        return -1;
# 197 "../crypto/rsa/rsa_oaep.c"
    if (num < flen || num < 2 * mdlen + 2) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_oaep.c",198,__func__), ERR_set_error)((4),(121),
# 198 "../crypto/rsa/rsa_oaep.c" 3 4
       ((void *)0)
# 198 "../crypto/rsa/rsa_oaep.c"
       );
        return -1;
    }

    dblen = num - mdlen - 1;
    db = CRYPTO_malloc(dblen, "../crypto/rsa/rsa_oaep.c", 203);
    if (db == 
# 204 "../crypto/rsa/rsa_oaep.c" 3 4
             ((void *)0)
# 204 "../crypto/rsa/rsa_oaep.c"
                 )
        goto cleanup;

    em = CRYPTO_malloc(num, "../crypto/rsa/rsa_oaep.c", 207);
    if (em == 
# 208 "../crypto/rsa/rsa_oaep.c" 3 4
             ((void *)0)
# 208 "../crypto/rsa/rsa_oaep.c"
                 )
        goto cleanup;
...
# 244 "../crypto/rsa/rsa_oaep.c" 3 4
                                               ((void *)0)
# 244 "../crypto/rsa/rsa_oaep.c"
                                                   , md, 
# 244 "../crypto/rsa/rsa_oaep.c" 3 4
                                                         ((void *)0)
# 244 "../crypto/rsa/rsa_oaep.c"
...
# 308 "../crypto/rsa/rsa_oaep.c"
    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_oaep.c",308,__func__), ERR_set_error)((4),(121),
# 308 "../crypto/rsa/rsa_oaep.c" 3 4
   ((void *)0)
# 308 "../crypto/rsa/rsa_oaep.c"
   );
 ...
 cleanup:
    ...
    CRYPTO_clear_free(db, dblen, "../crypto/rsa/rsa_oaep.c", 313);
    CRYPTO_clear_free(em, num, "../crypto/rsa/rsa_oaep.c", 314);

    return constant_time_select_int(good, mlen, -1);
}
# 326 "../crypto/rsa/rsa_oaep.c"
               ...
               const unsigned char *seed, long seedlen, const EVP_MD *dgst)
{
    ...
    if (c == 
# 336 "../crypto/rsa/rsa_oaep.c" 3 4
            ((void *)0)
# 336 "../crypto/rsa/rsa_oaep.c"
                )
        goto err;
...
# 349 "../crypto/rsa/rsa_oaep.c" 3 4
                                       ((void *)0)
# 349 "../crypto/rsa/rsa_oaep.c"
                                           )
...
# 354 "../crypto/rsa/rsa_oaep.c" 3 4
                                                     ((void *)0)
# 354 "../crypto/rsa/rsa_oaep.c"
                                                         ))
                goto err;
            outlen += mdlen;
        } else {
            if (!EVP_DigestFinal_ex(c, md, 
# 358 "../crypto/rsa/rsa_oaep.c" 3 4
                                          ((void *)0)
# 358 "../crypto/rsa/rsa_oaep.c"
                                              ))
                goto err;
