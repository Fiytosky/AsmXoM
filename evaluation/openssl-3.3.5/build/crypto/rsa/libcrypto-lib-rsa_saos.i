# 0 "../crypto/rsa/rsa_saos.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_saos.c"
# 14 "../crypto/rsa/rsa_saos.c"
...
# 36 "../crypto/rsa/rsa_saos.c" 3 4
                                   ((void *)0)
# 36 "../crypto/rsa/rsa_saos.c"
                                       );
    j = RSA_size(rsa);
    if (i > (j - 11)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_saos.c",39,__func__), ERR_set_error)((4),(112),
# 39 "../crypto/rsa/rsa_saos.c" 3 4
       ((void *)0)
# 39 "../crypto/rsa/rsa_saos.c"
       );
        return 0;
    }
    s = CRYPTO_malloc((unsigned int)j + 1, "../crypto/rsa/rsa_saos.c", 42);
    if (s == 
# 43 "../crypto/rsa/rsa_saos.c" 3 4
            ((void *)0)
# 43 "../crypto/rsa/rsa_saos.c"
                )
        return 0;
    p = s;
    ...
    CRYPTO_clear_free(s, (unsigned int)j + 1, "../crypto/rsa/rsa_saos.c", 53);
    return ret;
}
                                 ...
                                 unsigned int siglen, RSA *rsa)
{
    ...
    ASN1_OCTET_STRING *sig = 
# 65 "../crypto/rsa/rsa_saos.c" 3 4
                            ((void *)0)
# 65 "../crypto/rsa/rsa_saos.c"
                                ;

    if (siglen != (unsigned int)RSA_size(rsa)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_saos.c",68,__func__), ERR_set_error)((4),(119),
# 68 "../crypto/rsa/rsa_saos.c" 3 4
       ((void *)0)
# 68 "../crypto/rsa/rsa_saos.c"
       );
        return 0;
    }

    s = CRYPTO_malloc((unsigned int)siglen, "../crypto/rsa/rsa_saos.c", 72);
    if (s == 
# 73 "../crypto/rsa/rsa_saos.c" 3 4
            ((void *)0)
# 73 "../crypto/rsa/rsa_saos.c"
                )
        goto err;
...
# 81 "../crypto/rsa/rsa_saos.c" 3 4
                               ((void *)0)
# 81 "../crypto/rsa/rsa_saos.c"
                                   , &p, (long)i);
    if (sig == 
# 82 "../crypto/rsa/rsa_saos.c" 3 4
              ((void *)0)
# 82 "../crypto/rsa/rsa_saos.c"
                  )
        goto err;

    if (((unsigned int)sig->length != m_len) ||
        (memcmp(m, sig->data, m_len) != 0)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_saos.c",87,__func__), ERR_set_error)((4),(104),
# 87 "../crypto/rsa/rsa_saos.c" 3 4
       ((void *)0)
# 87 "../crypto/rsa/rsa_saos.c"
       );
    } else {
        ret = 1;
    }
 err:
    ...
    CRYPTO_clear_free(s, (unsigned int)siglen, "../crypto/rsa/rsa_saos.c", 93);
    return ret;
}
