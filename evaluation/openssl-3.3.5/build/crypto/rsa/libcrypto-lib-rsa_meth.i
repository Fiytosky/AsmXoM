# 0 "../crypto/rsa/rsa_meth.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_meth.c"
# 14 "../crypto/rsa/rsa_meth.c"
...
# 14 "../include/internal/refcount.h" 2
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 18 "../crypto/rsa/rsa_meth.c" 2


RSA_METHOD *RSA_meth_new(const char *name, int flags)
{
    RSA_METHOD *meth = CRYPTO_zalloc(sizeof(*meth), "../crypto/rsa/rsa_meth.c", 22);

    if (meth != 
# 24 "../crypto/rsa/rsa_meth.c" 3 4
               ((void *)0)
# 24 "../crypto/rsa/rsa_meth.c"
                   ) {
        meth->flags = flags;

        meth->name = CRYPTO_strdup(name, "../crypto/rsa/rsa_meth.c", 27);
        if (meth->name != 
# 28 "../crypto/rsa/rsa_meth.c" 3 4
                         ((void *)0)
# 28 "../crypto/rsa/rsa_meth.c"
                             )
            return meth;

        CRYPTO_free(meth, "../crypto/rsa/rsa_meth.c", 31);
    }

    return 
# 34 "../crypto/rsa/rsa_meth.c" 3 4
          ((void *)0)
# 34 "../crypto/rsa/rsa_meth.c"
              ;
}
...
{
    if (meth != 
# 39 "../crypto/rsa/rsa_meth.c" 3 4
               ((void *)0)
# 39 "../crypto/rsa/rsa_meth.c"
                   ) {
        CRYPTO_free(meth->name, "../crypto/rsa/rsa_meth.c", 40);
        CRYPTO_free(meth, "../crypto/rsa/rsa_meth.c", 41);
    }
}

RSA_METHOD *RSA_meth_dup(const RSA_METHOD *meth)
{
    RSA_METHOD *ret = CRYPTO_malloc(sizeof(*ret), "../crypto/rsa/rsa_meth.c", 47);

    if (ret != 
# 49 "../crypto/rsa/rsa_meth.c" 3 4
              ((void *)0)
# 49 "../crypto/rsa/rsa_meth.c"
                  ) {
        memcpy(ret, meth, sizeof(*meth));

        ret->name = CRYPTO_strdup(meth->name, "../crypto/rsa/rsa_meth.c", 52);
        if (ret->name != 
# 53 "../crypto/rsa/rsa_meth.c" 3 4
                        ((void *)0)
# 53 "../crypto/rsa/rsa_meth.c"
                            )
            return ret;

        CRYPTO_free(ret, "../crypto/rsa/rsa_meth.c", 56);
    }

    return 
# 59 "../crypto/rsa/rsa_meth.c" 3 4
          ((void *)0)
# 59 "../crypto/rsa/rsa_meth.c"
              ;
}
...
{
    char *tmpname = CRYPTO_strdup(name, "../crypto/rsa/rsa_meth.c", 69);

    if (tmpname == 
# 71 "../crypto/rsa/rsa_meth.c" 3 4
                  ((void *)0)
# 71 "../crypto/rsa/rsa_meth.c"
                      )
        return 0;

    CRYPTO_free(meth->name, "../crypto/rsa/rsa_meth.c", 74);
    meth->name = tmpname;
