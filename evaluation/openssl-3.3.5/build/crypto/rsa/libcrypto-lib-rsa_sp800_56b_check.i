# 0 "../crypto/rsa/rsa_sp800_56b_check.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_sp800_56b_check.c"
# 11 "../crypto/rsa/rsa_sp800_56b_check.c"
...
# 12 "../crypto/rsa/rsa_sp800_56b_check.c" 2
...
# 13 "../crypto/rsa/rsa_sp800_56b_check.c" 2
...
# 14 "../crypto/rsa/rsa_sp800_56b_check.c" 2
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 15 "../crypto/rsa/rsa_sp800_56b_check.c" 2
# 24 "../crypto/rsa/rsa_sp800_56b_check.c"
int ossl_rsa_check_crt_components(const RSA *rsa, BN_CTX *ctx)
{
    int ret = 0;
    BIGNUM *r = 
# 27 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
               ((void *)0)
# 27 "../crypto/rsa/rsa_sp800_56b_check.c"
                   , *p1 = 
# 27 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                           ((void *)0)
# 27 "../crypto/rsa/rsa_sp800_56b_check.c"
...
# 27 "../crypto/rsa/rsa_sp800_56b_check.c"
    ...
    if (rsa->dmp1 == 
# 30 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                    ((void *)0) 
# 30 "../crypto/rsa/rsa_sp800_56b_check.c"
                         || rsa->dmq1 == 
# 30 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                         ((void *)0) 
# 30 "../crypto/rsa/rsa_sp800_56b_check.c"
...
# 30 "../crypto/rsa/rsa_sp800_56b_check.c"
        ...
        if (rsa->dmp1 != 
# 31 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                        ((void *)0) 
# 31 "../crypto/rsa/rsa_sp800_56b_check.c"
                             || rsa->dmq1 != 
# 31 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                             ((void *)0) 
# 31 "../crypto/rsa/rsa_sp800_56b_check.c"
...
# 31 "../crypto/rsa/rsa_sp800_56b_check.c"
    ...
    q1 = BN_CTX_get(ctx);
    if (q1 != 
# 40 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
             ((void *)0)
# 40 "../crypto/rsa/rsa_sp800_56b_check.c"
                 ) {
        BN_set_flags(r, 0x04);
        BN_set_flags(p1, 0x04);
        BN_set_flags(q1, 0x04);
        ret = 1;
    } else {
        ret = 0;
    }
    ret = ret
          ...
          && (BN_copy(p1, rsa->p) != 
# 50 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                    ((void *)0)
# 50 "../crypto/rsa/rsa_sp800_56b_check.c"
                                        )
          && BN_sub_word(p1, 1)

          && (BN_copy(q1, rsa->q) != 
# 53 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                    ((void *)0)
# 53 "../crypto/rsa/rsa_sp800_56b_check.c"
                                        )
          && BN_sub_word(q1, 1)
...
# 88 "../crypto/rsa/rsa_sp800_56b_check.c"
int ossl_rsa_check_prime_factor_range(const BIGNUM *p, int nbits, BN_CTX *ctx)
{
    int ret = 0;
    BIGNUM *low;
    ...
    low = BN_CTX_get(ctx);
    if (low == 
# 103 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
              ((void *)0)
# 103 "../crypto/rsa/rsa_sp800_56b_check.c"
                  )
        goto err;
...
# 136 "../crypto/rsa/rsa_sp800_56b_check.c"
int ossl_rsa_check_prime_factor(BIGNUM *p, BIGNUM *e, int nbits, BN_CTX *ctx)
{
    int ret = 0;
    BIGNUM *p1 = 
# 139 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                ((void *)0)
# 139 "../crypto/rsa/rsa_sp800_56b_check.c"
                    , *gcd = 
# 139 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                             ((void *)0)
# 139 "../crypto/rsa/rsa_sp800_56b_check.c"
    ...
    if (BN_check_prime(p, ctx, 
# 142 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                              ((void *)0)
# 142 "../crypto/rsa/rsa_sp800_56b_check.c"
                                  ) != 1
    ...
    gcd = BN_CTX_get(ctx);
    if (gcd != 
# 150 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
              ((void *)0)
# 150 "../crypto/rsa/rsa_sp800_56b_check.c"
                  ) {
        BN_set_flags(p1, 0x04);
        BN_set_flags(gcd, 0x04);
        ret = 1;
    } else {
        ret = 0;
    }
    ret = ret
          ...
          && (BN_copy(p1, p) != 
# 159 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                               ((void *)0)
# 159 "../crypto/rsa/rsa_sp800_56b_check.c"
                                   )
          && BN_sub_word(p1, 1)
          && BN_gcd(gcd, p1, e, ctx)
          && BN_is_one(gcd);
...
int ossl_rsa_check_private_exponent(const RSA *rsa, int nbits, BN_CTX *ctx)
{
    ...
    gcd = BN_CTX_get(ctx);
    if (gcd != 
# 191 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
              ((void *)0)
# 191 "../crypto/rsa/rsa_sp800_56b_check.c"
                  ) {
        BN_set_flags(r, 0x04);
        BN_set_flags(p1, 0x04);
        BN_set_flags(q1, 0x04);
        BN_set_flags(lcm, 0x04);
        BN_set_flags(p1q1, 0x04);
        BN_set_flags(gcd, 0x04);
        ret = 1;
    } else {
        ret = 0;
                     ...
                     BIGNUM *p1q1)
{
    return BN_sub(p1, p, BN_value_one())
           ...
           && BN_div(lcm, 
# 273 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                         ((void *)0)
# 273 "../crypto/rsa/rsa_sp800_56b_check.c"
                             , p1q1, gcd, ctx);
}
...
int ossl_rsa_sp800_56b_check_public(const RSA *rsa)
{
    ...
    int nbits;
    BN_CTX *ctx = 
# 285 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0)
# 285 "../crypto/rsa/rsa_sp800_56b_check.c"
                     ;
    BIGNUM *gcd = 
# 286 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0)
# 286 "../crypto/rsa/rsa_sp800_56b_check.c"
                     ;

    if (rsa->n == 
# 288 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0) 
# 288 "../crypto/rsa/rsa_sp800_56b_check.c"
                      || rsa->e == 
# 288 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                   ((void *)0)
# 288 "../crypto/rsa/rsa_sp800_56b_check.c"
    ...
    if (nbits > 16384) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",293,__func__), ERR_set_error)((4),(105),
# 293 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 293 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }
# 307 "../crypto/rsa/rsa_sp800_56b_check.c"
    if (!BN_is_odd(rsa->n)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",308,__func__), ERR_set_error)((4),(174),
# 308 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 308 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }

    if (!ossl_rsa_check_public_exponent(rsa->e)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",313,__func__), ERR_set_error)((4),(178),
# 313 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 313 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }
    ...
    gcd = BN_new();
    if (ctx == 
# 319 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
              ((void *)0) 
# 319 "../crypto/rsa/rsa_sp800_56b_check.c"
                   || gcd == 
# 319 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                             ((void *)0)
# 319 "../crypto/rsa/rsa_sp800_56b_check.c"
    ...
    if (!BN_gcd(gcd, rsa->n, ossl_bn_get0_small_factors(), ctx)
        || !BN_is_one(gcd)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",328,__func__), ERR_set_error)((4),(174),
# 328 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 328 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        goto err;
    }


    ret = ossl_bn_miller_rabin_is_prime(rsa->n, 5, ctx, 
# 333 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                                       ((void *)0)
# 333 "../crypto/rsa/rsa_sp800_56b_check.c"
                                                           , 1, &status);
    ...
    if (ret != 1 || (status != 2
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",341,__func__), ERR_set_error)((4),(174),
# 341 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 341 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        ret = 0;
        goto err;
    }
...
{
    if (rsa->d == 
# 358 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0) 
# 358 "../crypto/rsa/rsa_sp800_56b_check.c"
                      || rsa->n == 
# 358 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                                   ((void *)0)
# 358 "../crypto/rsa/rsa_sp800_56b_check.c"
...
# 374 "../crypto/rsa/rsa_sp800_56b_check.c"
int ossl_rsa_sp800_56b_check_keypair(const RSA *rsa, const BIGNUM *efixed,
                                     int strength, int nbits)
{
    int ret = 0;
    BN_CTX *ctx = 
# 378 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0)
# 378 "../crypto/rsa/rsa_sp800_56b_check.c"
                     ;
    BIGNUM *r = 
# 379 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
               ((void *)0)
# 379 "../crypto/rsa/rsa_sp800_56b_check.c"
                   ;

    if (rsa->p == 
# 381 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0)
            
# 382 "../crypto/rsa/rsa_sp800_56b_check.c"
           || rsa->q == 
# 382 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                        ((void *)0)
            
# 383 "../crypto/rsa/rsa_sp800_56b_check.c"
           || rsa->e == 
# 383 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                        ((void *)0)
            
# 384 "../crypto/rsa/rsa_sp800_56b_check.c"
           || rsa->d == 
# 384 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                        ((void *)0)
            
# 385 "../crypto/rsa/rsa_sp800_56b_check.c"
           || rsa->n == 
# 385 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                        ((void *)0)
# 385 "../crypto/rsa/rsa_sp800_56b_check.c"
                            ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",386,__func__), ERR_set_error)((4),(175),
# 386 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 386 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }
    ...
    if (efixed != 
# 394 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
                 ((void *)0)
# 394 "../crypto/rsa/rsa_sp800_56b_check.c"
                     ) {

        if (BN_cmp(efixed, rsa->e) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",397,__func__), ERR_set_error)((4),(175),
# 397 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
           ((void *)0)
# 397 "../crypto/rsa/rsa_sp800_56b_check.c"
           );
            return 0;
        }
    }
    ...
    if (!ossl_rsa_check_public_exponent(rsa->e)) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",404,__func__), ERR_set_error)((4),(178),
# 404 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 404 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }

    if (nbits != BN_num_bits(rsa->n)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",409,__func__), ERR_set_error)((4),(171),
# 409 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 409 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }

    if (nbits <= 0 || (nbits & 0x1)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",414,__func__), ERR_set_error)((4),(171),
# 414 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 414 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        return 0;
    }
    ...
    ctx = BN_CTX_new_ex(rsa->libctx);
    if (ctx == 
# 419 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
              ((void *)0)
# 419 "../crypto/rsa/rsa_sp800_56b_check.c"
                  )
        return 0;
    ...
    r = BN_CTX_get(ctx);
    if (r == 
# 424 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
            ((void *)0) 
# 424 "../crypto/rsa/rsa_sp800_56b_check.c"
                 || !BN_mul(r, rsa->p, rsa->q, ctx))
        goto err;

    if (BN_cmp(rsa->n, r) != 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",428,__func__), ERR_set_error)((4),(175),
# 428 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 428 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
        goto err;
    }
    ...
    if (ret != 1)
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_check.c",441,__func__), ERR_set_error)((4),(171),
# 441 "../crypto/rsa/rsa_sp800_56b_check.c" 3 4
       ((void *)0)
# 441 "../crypto/rsa/rsa_sp800_56b_check.c"
       );
