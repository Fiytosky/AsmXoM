# 0 "../crypto/rsa/rsa_asn1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_asn1.c"
# 14 "../crypto/rsa/rsa_asn1.c"
                  ...
                  void *exarg)
{
    if (operation == 0) {
        *pval = (ASN1_VALUE *)RSA_new();
        if (*pval != 
# 33 "../crypto/rsa/rsa_asn1.c" 3 4
                    ((void *)0)
# 33 "../crypto/rsa/rsa_asn1.c"
                        )
            return 2;
        return 0;
    } else if (operation == 2) {
        RSA_free((RSA *)*pval);
        *pval = 
# 38 "../crypto/rsa/rsa_asn1.c" 3 4
               ((void *)0)
# 38 "../crypto/rsa/rsa_asn1.c"
                   ;
        return 2;
    } else if (operation == 5) {
        if (((RSA *)*pval)->version != 1) {
...
static const ASN1_TEMPLATE RSA_PRIME_INFO_seq_tt[] = {
        { (0), (0), 
# 52 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 52 "../crypto/rsa/rsa_asn1.c"
       RSA_PRIME_INFO
# 52 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 52 "../crypto/rsa/rsa_asn1.c"
...
# 52 "../crypto/rsa/rsa_asn1.c"
       , "r", (CBIGNUM_it) },
        { (0), (0), 
# 53 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 53 "../crypto/rsa/rsa_asn1.c"
       RSA_PRIME_INFO
# 53 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 53 "../crypto/rsa/rsa_asn1.c"
...
# 53 "../crypto/rsa/rsa_asn1.c"
       , "d", (CBIGNUM_it) },
        { (0), (0), 
# 54 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 54 "../crypto/rsa/rsa_asn1.c"
       RSA_PRIME_INFO
# 54 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 54 "../crypto/rsa/rsa_asn1.c"
...
# 54 "../crypto/rsa/rsa_asn1.c"
       , "t", (CBIGNUM_it) },
} ; const ASN1_ITEM * RSA_PRIME_INFO_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, RSA_PRIME_INFO_seq_tt, sizeof(RSA_PRIME_INFO_seq_tt) / sizeof(ASN1_TEMPLATE), 
# 55 "../crypto/rsa/rsa_asn1.c" 3 4
 ((void *)0)
# 55 "../crypto/rsa/rsa_asn1.c"
 , sizeof(RSA_PRIME_INFO), "RSA_PRIME_INFO" }; return &local_it; }

static const ASN1_AUX RSAPrivateKey_aux = {
# 57 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 57 "../crypto/rsa/rsa_asn1.c"
, 0, 0, 0, rsa_cb, 0, 
# 57 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 57 "../crypto/rsa/rsa_asn1.c"
        ...
        { ((0x1 << 12)), (0), 
# 58 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 58 "../crypto/rsa/rsa_asn1.c"
       RSA
# 58 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 58 "../crypto/rsa/rsa_asn1.c"
...
# 58 "../crypto/rsa/rsa_asn1.c"
       , "version", (INT32_it) },
        { (0), (0), 
# 59 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 59 "../crypto/rsa/rsa_asn1.c"
       RSA
# 59 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 59 "../crypto/rsa/rsa_asn1.c"
...
# 59 "../crypto/rsa/rsa_asn1.c"
       , "n", (BIGNUM_it) },
        { (0), (0), 
# 60 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 60 "../crypto/rsa/rsa_asn1.c"
       RSA
# 60 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 60 "../crypto/rsa/rsa_asn1.c"
...
# 60 "../crypto/rsa/rsa_asn1.c"
       , "e", (BIGNUM_it) },
        { (0), (0), 
# 61 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 61 "../crypto/rsa/rsa_asn1.c"
       RSA
# 61 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 61 "../crypto/rsa/rsa_asn1.c"
...
# 61 "../crypto/rsa/rsa_asn1.c"
       , "d", (CBIGNUM_it) },
        { (0), (0), 
# 62 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 62 "../crypto/rsa/rsa_asn1.c"
       RSA
# 62 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 62 "../crypto/rsa/rsa_asn1.c"
...
# 62 "../crypto/rsa/rsa_asn1.c"
       , "p", (CBIGNUM_it) },
        { (0), (0), 
# 63 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 63 "../crypto/rsa/rsa_asn1.c"
       RSA
# 63 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 63 "../crypto/rsa/rsa_asn1.c"
...
# 63 "../crypto/rsa/rsa_asn1.c"
       , "q", (CBIGNUM_it) },
        { (0), (0), 
# 64 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 64 "../crypto/rsa/rsa_asn1.c"
       RSA
# 64 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 64 "../crypto/rsa/rsa_asn1.c"
...
# 64 "../crypto/rsa/rsa_asn1.c"
       , "dmp1", (CBIGNUM_it) },
        { (0), (0), 
# 65 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 65 "../crypto/rsa/rsa_asn1.c"
       RSA
# 65 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 65 "../crypto/rsa/rsa_asn1.c"
...
# 65 "../crypto/rsa/rsa_asn1.c"
       , "dmq1", (CBIGNUM_it) },
        { (0), (0), 
# 66 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 66 "../crypto/rsa/rsa_asn1.c"
       RSA
# 66 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 66 "../crypto/rsa/rsa_asn1.c"
...
# 66 "../crypto/rsa/rsa_asn1.c"
       , "iqmp", (CBIGNUM_it) },
        { ((0x2 << 1)|(0x1)), (0), 
# 67 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 67 "../crypto/rsa/rsa_asn1.c"
       RSA
# 67 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 67 "../crypto/rsa/rsa_asn1.c"
...
# 67 "../crypto/rsa/rsa_asn1.c"
       , "prime_infos", (RSA_PRIME_INFO_it) }
} ; const ASN1_ITEM * RSAPrivateKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, RSAPrivateKey_seq_tt, sizeof(RSAPrivateKey_seq_tt) / sizeof(ASN1_TEMPLATE), &RSAPrivateKey_aux, sizeof(RSA), "RSAPrivateKey" }; return &local_it; }


static const ASN1_AUX RSAPublicKey_aux = {
# 71 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 71 "../crypto/rsa/rsa_asn1.c"
, 0, 0, 0, rsa_cb, 0, 
# 71 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 71 "../crypto/rsa/rsa_asn1.c"
        ...
        { (0), (0), 
# 72 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 72 "../crypto/rsa/rsa_asn1.c"
       RSA
# 72 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 72 "../crypto/rsa/rsa_asn1.c"
...
# 72 "../crypto/rsa/rsa_asn1.c"
       , "n", (BIGNUM_it) },
        { (0), (0), 
# 73 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 73 "../crypto/rsa/rsa_asn1.c"
       RSA
# 73 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 73 "../crypto/rsa/rsa_asn1.c"
...
# 73 "../crypto/rsa/rsa_asn1.c"
       , "e", (BIGNUM_it) },
} ; const ASN1_ITEM * RSAPublicKey_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, RSAPublicKey_seq_tt, sizeof(RSAPublicKey_seq_tt) / sizeof(ASN1_TEMPLATE), &RSAPublicKey_aux, sizeof(RSA), "RSAPublicKey" }; return &local_it; }
...
# 87 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 87 "../crypto/rsa/rsa_asn1.c"
, 0, 0, 0, rsa_pss_cb, 0, 
# 87 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 87 "../crypto/rsa/rsa_asn1.c"
        ...
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 88 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 88 "../crypto/rsa/rsa_asn1.c"
       RSA_PSS_PARAMS
# 88 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 88 "../crypto/rsa/rsa_asn1.c"
...
# 88 "../crypto/rsa/rsa_asn1.c"
       , "hashAlgorithm", (X509_ALGOR_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 89 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 89 "../crypto/rsa/rsa_asn1.c"
       RSA_PSS_PARAMS
# 89 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 89 "../crypto/rsa/rsa_asn1.c"
...
# 89 "../crypto/rsa/rsa_asn1.c"
       , "maskGenAlgorithm", (X509_ALGOR_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 90 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 90 "../crypto/rsa/rsa_asn1.c"
       RSA_PSS_PARAMS
# 90 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 90 "../crypto/rsa/rsa_asn1.c"
...
# 90 "../crypto/rsa/rsa_asn1.c"
       , "saltLength", (ASN1_INTEGER_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (3), 
# 91 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 91 "../crypto/rsa/rsa_asn1.c"
       RSA_PSS_PARAMS
# 91 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 91 "../crypto/rsa/rsa_asn1.c"
...
# 91 "../crypto/rsa/rsa_asn1.c"
       , "trailerField", (ASN1_INTEGER_it) }
} ; const ASN1_ITEM * RSA_PSS_PARAMS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, RSA_PSS_PARAMS_seq_tt, sizeof(RSA_PSS_PARAMS_seq_tt) / sizeof(ASN1_TEMPLATE), &RSA_PSS_PARAMS_aux, sizeof(RSA_PSS_PARAMS), "RSA_PSS_PARAMS" }; return &local_it; }

RSA_PSS_PARAMS *d2i_RSA_PSS_PARAMS(RSA_PSS_PARAMS **a, const unsigned char **in, long len) { return (RSA_PSS_PARAMS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (RSA_PSS_PARAMS_it())); } int i2d_RSA_PSS_PARAMS(const RSA_PSS_PARAMS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (RSA_PSS_PARAMS_it())); } RSA_PSS_PARAMS *RSA_PSS_PARAMS_new(void) { return (RSA_PSS_PARAMS *)ASN1_item_new((RSA_PSS_PARAMS_it())); } void RSA_PSS_PARAMS_free(RSA_PSS_PARAMS *a) { ASN1_item_free((ASN1_VALUE *)a, (RSA_PSS_PARAMS_it())); }
RSA_PSS_PARAMS * RSA_PSS_PARAMS_dup(const RSA_PSS_PARAMS *x) { return ASN1_item_dup((RSA_PSS_PARAMS_it()), x); }
...
# 108 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 108 "../crypto/rsa/rsa_asn1.c"
, 0, 0, 0, rsa_oaep_cb, 0, 
# 108 "../crypto/rsa/rsa_asn1.c" 3 4
((void *)0)
# 108 "../crypto/rsa/rsa_asn1.c"
        ...
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (0), 
# 109 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 109 "../crypto/rsa/rsa_asn1.c"
       RSA_OAEP_PARAMS
# 109 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 109 "../crypto/rsa/rsa_asn1.c"
...
# 109 "../crypto/rsa/rsa_asn1.c"
       , "hashFunc", (X509_ALGOR_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (1), 
# 110 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 110 "../crypto/rsa/rsa_asn1.c"
       RSA_OAEP_PARAMS
# 110 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 110 "../crypto/rsa/rsa_asn1.c"
...
# 110 "../crypto/rsa/rsa_asn1.c"
       , "maskGenFunc", (X509_ALGOR_it) },
        { (((0x2 << 3)|(0x2<<6)) | ((0x1))), (2), 
# 111 "../crypto/rsa/rsa_asn1.c" 3 4
       __builtin_offsetof (
# 111 "../crypto/rsa/rsa_asn1.c"
       RSA_OAEP_PARAMS
# 111 "../crypto/rsa/rsa_asn1.c" 3 4
       , 
# 111 "../crypto/rsa/rsa_asn1.c"
...
# 111 "../crypto/rsa/rsa_asn1.c"
       , "pSourceFunc", (X509_ALGOR_it) },
} ; const ASN1_ITEM * RSA_OAEP_PARAMS_it(void) { static const ASN1_ITEM local_it = { 0x1, 16, RSA_OAEP_PARAMS_seq_tt, sizeof(RSA_OAEP_PARAMS_seq_tt) / sizeof(ASN1_TEMPLATE), &RSA_OAEP_PARAMS_aux, sizeof(RSA_OAEP_PARAMS), "RSA_OAEP_PARAMS" }; return &local_it; }

RSA_OAEP_PARAMS *d2i_RSA_OAEP_PARAMS(RSA_OAEP_PARAMS **a, const unsigned char **in, long len) { return (RSA_OAEP_PARAMS *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (RSA_OAEP_PARAMS_it())); } int i2d_RSA_OAEP_PARAMS(const RSA_OAEP_PARAMS *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (RSA_OAEP_PARAMS_it())); } RSA_OAEP_PARAMS *RSA_OAEP_PARAMS_new(void) { return (RSA_OAEP_PARAMS *)ASN1_item_new((RSA_OAEP_PARAMS_it())); } void RSA_OAEP_PARAMS_free(RSA_OAEP_PARAMS *a) { ASN1_item_free((ASN1_VALUE *)a, (RSA_OAEP_PARAMS_it())); }

RSA *d2i_RSAPrivateKey(RSA **a, const unsigned char **in, long len) { return (RSA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (RSAPrivateKey_it())); } int i2d_RSAPrivateKey(const RSA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (RSAPrivateKey_it())); }

RSA *d2i_RSAPublicKey(RSA **a, const unsigned char **in, long len) { return (RSA *)ASN1_item_d2i((ASN1_VALUE **)a, in, len, (RSAPublicKey_it())); } int i2d_RSAPublicKey(const RSA *a, unsigned char **out) { return ASN1_item_i2d((const ASN1_VALUE *)a, out, (RSAPublicKey_it())); }
