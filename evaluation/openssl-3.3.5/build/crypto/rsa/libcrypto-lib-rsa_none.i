# 0 "../crypto/rsa/rsa_none.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_none.c"
# 14 "../crypto/rsa/rsa_none.c"
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 19 "../crypto/rsa/rsa_none.c" 2

int RSA_padding_add_none(unsigned char *to, int tlen,
                         const unsigned char *from, int flen)
{
    if (flen > tlen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_none.c",24,__func__), ERR_set_error)((4),(110),
# 24 "../crypto/rsa/rsa_none.c" 3 4
       ((void *)0)
# 24 "../crypto/rsa/rsa_none.c"
       );
        return 0;
    }

    if (flen < tlen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_none.c",29,__func__), ERR_set_error)((4),(122),
# 29 "../crypto/rsa/rsa_none.c" 3 4
       ((void *)0)
# 29 "../crypto/rsa/rsa_none.c"
       );
        return 0;
    }
                           ...
                           const unsigned char *from, int flen, int num)
{
    ...
    if (flen > tlen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_none.c",42,__func__), ERR_set_error)((4),(109),
# 42 "../crypto/rsa/rsa_none.c" 3 4
       ((void *)0)
# 42 "../crypto/rsa/rsa_none.c"
       );
        return -1;
    }
