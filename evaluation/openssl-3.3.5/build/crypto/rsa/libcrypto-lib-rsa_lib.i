# 0 "../crypto/rsa/rsa_lib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_lib.c"
# 14 "../crypto/rsa/rsa_lib.c"
...
# 17 "../crypto/rsa/rsa_lib.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/rsa/rsa_lib.c" 2
...
# 25 "../crypto/rsa/rsa_lib.c" 2
# 1 "../include/crypto/bn.h" 1
# 12 "../include/crypto/bn.h"
        


# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/limits.h" 1 3 4
# 16 "../include/crypto/bn.h" 2
...
int bn_copy_words(unsigned long *out, const BIGNUM *in, int size);

unsigned long *bn_get_words(const BIGNUM *a);





void bn_set_static_words(BIGNUM *a, const unsigned long *words, int size);
# 62 "../include/crypto/bn.h"
int bn_set_words(BIGNUM *a, const unsigned long *words, int num_words);
# 74 "../include/crypto/bn.h"
...
int ossl_bn_is_word_fixed_top(const BIGNUM *a, const unsigned long w);
...
# 28 "../crypto/rsa/rsa_lib.c" 2
# 1 "../include/crypto/security_bits.h" 1
# 12 "../include/crypto/security_bits.h"
        

uint16_t ossl_ifc_ffc_compute_security_bits(int n);
# 29 "../crypto/rsa/rsa_lib.c" 2
...
RSA *RSA_new(void)
{
    return rsa_new_intern(
# 36 "../crypto/rsa/rsa_lib.c" 3 4
                         ((void *)0)
# 36 "../crypto/rsa/rsa_lib.c"
                             , 
# 36 "../crypto/rsa/rsa_lib.c" 3 4
                               ((void *)0)
# 36 "../crypto/rsa/rsa_lib.c"
...
int RSA_set_method(RSA *rsa, const RSA_METHOD *meth)
{
    ...
    rsa->engine = 
# 56 "../crypto/rsa/rsa_lib.c" 3 4
                 ((void *)0)
# 56 "../crypto/rsa/rsa_lib.c"
                     ;
...
# 66 "../crypto/rsa/rsa_lib.c" 3 4
                                 ((void *)0)
# 66 "../crypto/rsa/rsa_lib.c"
                                     );
}
...
{
    return rsa_new_intern(
# 72 "../crypto/rsa/rsa_lib.c" 3 4
                         ((void *)0)
# 72 "../crypto/rsa/rsa_lib.c"
                             , libctx);
}

static RSA *rsa_new_intern(ENGINE *engine, OSSL_LIB_CTX *libctx)
{
    RSA *ret = CRYPTO_zalloc(sizeof(*ret), "../crypto/rsa/rsa_lib.c", 77);

    if (ret == 
# 79 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0)
# 79 "../crypto/rsa/rsa_lib.c"
                  )
        return 
# 80 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0)
# 80 "../crypto/rsa/rsa_lib.c"
                  ;

    ret->lock = CRYPTO_THREAD_lock_new();
    if (ret->lock == 
# 83 "../crypto/rsa/rsa_lib.c" 3 4
                    ((void *)0)
# 83 "../crypto/rsa/rsa_lib.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",84,__func__), ERR_set_error)((4),((15 | (0x2 << 18L))),
# 84 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 84 "../crypto/rsa/rsa_lib.c"
       );
        CRYPTO_free(ret, "../crypto/rsa/rsa_lib.c", 85);
        return 
# 86 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0)
# 86 "../crypto/rsa/rsa_lib.c"
                  ;
    }

    if (!CRYPTO_NEW_REF(&ret->references, 1)) {
        CRYPTO_THREAD_lock_free(ret->lock);
        CRYPTO_free(ret, "../crypto/rsa/rsa_lib.c", 91);
        return 
# 92 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0)
# 92 "../crypto/rsa/rsa_lib.c"
                  ;
    }
    ...
    if (engine) {
        if (!ENGINE_init(engine)) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",101,__func__), ERR_set_error)((4),((38 | (0x2 << 18L))),
# 101 "../crypto/rsa/rsa_lib.c" 3 4
           ((void *)0)
# 101 "../crypto/rsa/rsa_lib.c"
           );
            goto err;
        }
        ret->engine = engine;
    ...
    if (ret->engine) {
        ...
        if (ret->meth == 
# 110 "../crypto/rsa/rsa_lib.c" 3 4
                        ((void *)0)
# 110 "../crypto/rsa/rsa_lib.c"
                            ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",111,__func__), ERR_set_error)((4),((38 | (0x2 << 18L))),
# 111 "../crypto/rsa/rsa_lib.c" 3 4
           ((void *)0)
# 111 "../crypto/rsa/rsa_lib.c"
           );
            goto err;
        }
    }
    ...
    if (!CRYPTO_new_ex_data(9, ret, &ret->ex_data)) {
        goto err;
    }


    if ((ret->meth->init != 
# 124 "../crypto/rsa/rsa_lib.c" 3 4
                           ((void *)0)
# 124 "../crypto/rsa/rsa_lib.c"
                               ) && !ret->meth->init(ret)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",125,__func__), ERR_set_error)((4),((261|((0x1 << 18L)|(0x2 << 18L)))),
# 125 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 125 "../crypto/rsa/rsa_lib.c"
       );
        goto err;
    }
 ...
 err:
    RSA_free(ret);
    return 
# 133 "../crypto/rsa/rsa_lib.c" 3 4
          ((void *)0)
# 133 "../crypto/rsa/rsa_lib.c"
              ;
}
...
void RSA_free(RSA *r)
{
    ...
    if (r == 
# 140 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 140 "../crypto/rsa/rsa_lib.c"
                )
        return;
    ...
    if (r->meth != 
# 149 "../crypto/rsa/rsa_lib.c" 3 4
                  ((void *)0) 
# 149 "../crypto/rsa/rsa_lib.c"
                       && r->meth->finish != 
# 149 "../crypto/rsa/rsa_lib.c" 3 4
                                             ((void *)0)
# 149 "../crypto/rsa/rsa_lib.c"
    ...
    CRYPTO_free(r, "../crypto/rsa/rsa_lib.c", 181);
}
...
# 274 "../crypto/rsa/rsa_lib.c"
static uint32_t ilog_e(uint64_t v)
{
    uint32_t i, r = 0;
# 285 "../crypto/rsa/rsa_lib.c"
    while (v >= 2 * scale) {
        v >>= 1;
        r += scale;
    }
...
int RSA_set0_key(RSA *r, BIGNUM *n, BIGNUM *e, BIGNUM *d)
{
    ...
    if ((r->n == 
# 402 "../crypto/rsa/rsa_lib.c" 3 4
                ((void *)0) 
# 402 "../crypto/rsa/rsa_lib.c"
                     && n == 
# 402 "../crypto/rsa/rsa_lib.c" 3 4
                             ((void *)0)
# 402 "../crypto/rsa/rsa_lib.c"
        ...
        || (r->e == 
# 403 "../crypto/rsa/rsa_lib.c" 3 4
                   ((void *)0) 
# 403 "../crypto/rsa/rsa_lib.c"
                        && e == 
# 403 "../crypto/rsa/rsa_lib.c" 3 4
                                ((void *)0)
# 403 "../crypto/rsa/rsa_lib.c"
    ...
    if (n != 
# 406 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 406 "../crypto/rsa/rsa_lib.c"
                ) {
        BN_free(r->n);
        r->n = n;
    }
    if (e != 
# 410 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 410 "../crypto/rsa/rsa_lib.c"
                ) {
        BN_free(r->e);
        r->e = e;
    }
    if (d != 
# 414 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 414 "../crypto/rsa/rsa_lib.c"
                ) {
        BN_clear_free(r->d);
        r->d = d;
        BN_set_flags(r->d, 0x04);
    }
    r->dirty_cnt++;
...
int RSA_set0_factors(RSA *r, BIGNUM *p, BIGNUM *q)
{
    ...
    if ((r->p == 
# 429 "../crypto/rsa/rsa_lib.c" 3 4
                ((void *)0) 
# 429 "../crypto/rsa/rsa_lib.c"
                     && p == 
# 429 "../crypto/rsa/rsa_lib.c" 3 4
                             ((void *)0)
# 429 "../crypto/rsa/rsa_lib.c"
        ...
        || (r->q == 
# 430 "../crypto/rsa/rsa_lib.c" 3 4
                   ((void *)0) 
# 430 "../crypto/rsa/rsa_lib.c"
                        && q == 
# 430 "../crypto/rsa/rsa_lib.c" 3 4
                                ((void *)0)
# 430 "../crypto/rsa/rsa_lib.c"
    ...
    if (p != 
# 433 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 433 "../crypto/rsa/rsa_lib.c"
                ) {
        BN_clear_free(r->p);
        r->p = p;
        BN_set_flags(r->p, 0x04);
    }
    if (q != 
# 438 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 438 "../crypto/rsa/rsa_lib.c"
                ) {
        BN_clear_free(r->q);
        r->q = q;
        BN_set_flags(r->q, 0x04);
    }
    r->dirty_cnt++;
...
int RSA_set0_crt_params(RSA *r, BIGNUM *dmp1, BIGNUM *dmq1, BIGNUM *iqmp)
{
    ...
    if ((r->dmp1 == 
# 453 "../crypto/rsa/rsa_lib.c" 3 4
                   ((void *)0) 
# 453 "../crypto/rsa/rsa_lib.c"
                        && dmp1 == 
# 453 "../crypto/rsa/rsa_lib.c" 3 4
                                   ((void *)0)
# 453 "../crypto/rsa/rsa_lib.c"
        ...
        || (r->dmq1 == 
# 454 "../crypto/rsa/rsa_lib.c" 3 4
                      ((void *)0) 
# 454 "../crypto/rsa/rsa_lib.c"
                           && dmq1 == 
# 454 "../crypto/rsa/rsa_lib.c" 3 4
                                      ((void *)0)
# 454 "../crypto/rsa/rsa_lib.c"
        ...
        || (r->iqmp == 
# 455 "../crypto/rsa/rsa_lib.c" 3 4
                      ((void *)0) 
# 455 "../crypto/rsa/rsa_lib.c"
                           && iqmp == 
# 455 "../crypto/rsa/rsa_lib.c" 3 4
                                      ((void *)0)
# 455 "../crypto/rsa/rsa_lib.c"
    ...
    if (dmp1 != 
# 458 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
# 458 "../crypto/rsa/rsa_lib.c"
                   ) {
        BN_clear_free(r->dmp1);
        r->dmp1 = dmp1;
        BN_set_flags(r->dmp1, 0x04);
    }
    if (dmq1 != 
# 463 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
# 463 "../crypto/rsa/rsa_lib.c"
                   ) {
        BN_clear_free(r->dmq1);
        r->dmq1 = dmq1;
        BN_set_flags(r->dmq1, 0x04);
    }
    if (iqmp != 
# 468 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
# 468 "../crypto/rsa/rsa_lib.c"
                   ) {
        BN_clear_free(r->iqmp);
        r->iqmp = iqmp;
        BN_set_flags(r->iqmp, 0x04);
    }
    r->dirty_cnt++;
...
{
    struct stack_st_RSA_PRIME_INFO *prime_infos, *old = 
# 486 "../crypto/rsa/rsa_lib.c" 3 4
                                                 ((void *)0)
# 486 "../crypto/rsa/rsa_lib.c"
                                                     ;
    RSA_PRIME_INFO *pinfo;
    int i;

    if (primes == 
# 490 "../crypto/rsa/rsa_lib.c" 3 4
                 ((void *)0) 
# 490 "../crypto/rsa/rsa_lib.c"
                      || exps == 
# 490 "../crypto/rsa/rsa_lib.c" 3 4
                                 ((void *)0) 
# 490 "../crypto/rsa/rsa_lib.c"
...
# 490 "../crypto/rsa/rsa_lib.c"
    ...
    prime_infos = sk_RSA_PRIME_INFO_new_reserve(
# 493 "../crypto/rsa/rsa_lib.c" 3 4
                                               ((void *)0)
# 493 "../crypto/rsa/rsa_lib.c"
                                                   , pnum);
    if (prime_infos == 
# 494 "../crypto/rsa/rsa_lib.c" 3 4
                      ((void *)0)
# 494 "../crypto/rsa/rsa_lib.c"
                          )
        return 0;

    if (r->prime_infos != 
# 497 "../crypto/rsa/rsa_lib.c" 3 4
                         ((void *)0)
# 497 "../crypto/rsa/rsa_lib.c"
                             )
        old = r->prime_infos;
    ...
    for (i = 0; i < pnum; i++) {
        ...
        if (pinfo == 
# 502 "../crypto/rsa/rsa_lib.c" 3 4
                    ((void *)0)
# 502 "../crypto/rsa/rsa_lib.c"
                        )
            goto err;
        if (primes[i] != 
# 504 "../crypto/rsa/rsa_lib.c" 3 4
                        ((void *)0) 
# 504 "../crypto/rsa/rsa_lib.c"
                             && exps[i] != 
# 504 "../crypto/rsa/rsa_lib.c" 3 4
                                           ((void *)0) 
# 504 "../crypto/rsa/rsa_lib.c"
...
# 504 "../crypto/rsa/rsa_lib.c"
            ...
            pinfo->d = exps[i];
            pinfo->t = coeffs[i];
            BN_set_flags(pinfo->r, 0x04);
            BN_set_flags(pinfo->d, 0x04);
            BN_set_flags(pinfo->t, 0x04);
        } else {
    ...
    if (old != 
# 528 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0)
# 528 "../crypto/rsa/rsa_lib.c"
                  ) {
...
{
    if (n != 
# 552 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 552 "../crypto/rsa/rsa_lib.c"
                )
        *n = r->n;
    if (e != 
# 554 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 554 "../crypto/rsa/rsa_lib.c"
                )
        *e = r->e;
    if (d != 
# 556 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 556 "../crypto/rsa/rsa_lib.c"
                )
        *d = r->d;
}
...
{
    if (p != 
# 562 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 562 "../crypto/rsa/rsa_lib.c"
                )
        *p = r->p;
    if (q != 
# 564 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 564 "../crypto/rsa/rsa_lib.c"
                )
        *q = r->q;
}
...
{
    if (dmp1 != 
# 604 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
# 604 "../crypto/rsa/rsa_lib.c"
                   )
        *dmp1 = r->dmp1;
    if (dmq1 != 
# 606 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
# 606 "../crypto/rsa/rsa_lib.c"
                   )
        *dmq1 = r->dmq1;
    if (iqmp != 
# 608 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0)
                                    ...
                                    const BIGNUM *coeffs[])
{
    ...
    if (exps != 
# 622 "../crypto/rsa/rsa_lib.c" 3 4
               ((void *)0) 
# 622 "../crypto/rsa/rsa_lib.c"
                    || coeffs != 
# 622 "../crypto/rsa/rsa_lib.c" 3 4
                                 ((void *)0)
# 622 "../crypto/rsa/rsa_lib.c"
        ...
        for (i = 0; i < pnum; i++) {
            pinfo = sk_RSA_PRIME_INFO_value(r->prime_infos, i);
            if (exps != 
# 629 "../crypto/rsa/rsa_lib.c" 3 4
                       ((void *)0)
# 629 "../crypto/rsa/rsa_lib.c"
                           )
                exps[i] = pinfo->d;
            if (coeffs != 
# 631 "../crypto/rsa/rsa_lib.c" 3 4
                         ((void *)0)
# 631 "../crypto/rsa/rsa_lib.c"
                             )
                coeffs[i] = pinfo->t;
        }
    }
...
int RSA_pkey_ctx_ctrl(EVP_PKEY_CTX *ctx, int optype, int cmd, int p1, void *p2)
{
    ...
    if (ctx != 
# 737 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 737 "../crypto/rsa/rsa_lib.c"
                   && ctx->pmeth != 
# 737 "../crypto/rsa/rsa_lib.c" 3 4
                                    ((void *)0)
        
# 738 "../crypto/rsa/rsa_lib.c"
       && ctx->pmeth->pkey_id != 6
        && ctx->pmeth->pkey_id != 912)
        return -1;
     return EVP_PKEY_CTX_ctrl(ctx, -1, optype, cmd, p1, p2);
}


struct stack_st_BIGNUM; typedef int (*sk_BIGNUM_compfunc)(const BIGNUM * const *a, const BIGNUM *const *b); typedef void (*sk_BIGNUM_freefunc)(BIGNUM *a); typedef BIGNUM * (*sk_BIGNUM_copyfunc)(const BIGNUM *a); static __attribute__((unused)) inline int sk_BIGNUM_num(const struct stack_st_BIGNUM *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_value(const struct stack_st_BIGNUM *sk, int idx) { return (BIGNUM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_BIGNUM *sk_BIGNUM_new(sk_BIGNUM_compfunc compare) { return (struct stack_st_BIGNUM *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_BIGNUM *sk_BIGNUM_new_null(void) { return (struct stack_st_BIGNUM *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_BIGNUM *sk_BIGNUM_new_reserve(sk_BIGNUM_compfunc compare, int n) { return (struct stack_st_BIGNUM *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_BIGNUM_reserve(struct stack_st_BIGNUM *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_BIGNUM_free(struct stack_st_BIGNUM *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BIGNUM_zero(struct stack_st_BIGNUM *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_delete(struct stack_st_BIGNUM *sk, int i) { return (BIGNUM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_delete_ptr(struct stack_st_BIGNUM *sk, BIGNUM *ptr) { return (BIGNUM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_push(struct stack_st_BIGNUM *sk, BIGNUM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_unshift(struct stack_st_BIGNUM *sk, BIGNUM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_pop(struct stack_st_BIGNUM *sk) { return (BIGNUM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_shift(struct stack_st_BIGNUM *sk) { return (BIGNUM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BIGNUM_pop_free(struct stack_st_BIGNUM *sk, sk_BIGNUM_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_BIGNUM_insert(struct stack_st_BIGNUM *sk, BIGNUM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline BIGNUM *sk_BIGNUM_set(struct stack_st_BIGNUM *sk, int idx, BIGNUM *ptr) { return (BIGNUM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_find(struct stack_st_BIGNUM *sk, BIGNUM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_find_ex(struct stack_st_BIGNUM *sk, BIGNUM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_find_all(struct stack_st_BIGNUM *sk, BIGNUM *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_BIGNUM_sort(struct stack_st_BIGNUM *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_BIGNUM_is_sorted(const struct stack_st_BIGNUM *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BIGNUM * sk_BIGNUM_dup(const struct stack_st_BIGNUM *sk) { return (struct stack_st_BIGNUM *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BIGNUM *sk_BIGNUM_deep_copy(const struct stack_st_BIGNUM *sk, sk_BIGNUM_copyfunc copyfunc, sk_BIGNUM_freefunc freefunc) { return (struct stack_st_BIGNUM *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_BIGNUM_compfunc sk_BIGNUM_set_cmp_func(struct stack_st_BIGNUM *sk, sk_BIGNUM_compfunc compare) { return (sk_BIGNUM_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
                             ...
                             struct stack_st_BIGNUM *coeffs)
{
    ...
    struct stack_st_RSA_PRIME_INFO *prime_infos, *old_infos = 
# 756 "../crypto/rsa/rsa_lib.c" 3 4
                                                       ((void *)0)
# 756 "../crypto/rsa/rsa_lib.c"
                                                           ;

    int pnum;

    if (primes == 
# 760 "../crypto/rsa/rsa_lib.c" 3 4
                 ((void *)0) 
# 760 "../crypto/rsa/rsa_lib.c"
                      || exps == 
# 760 "../crypto/rsa/rsa_lib.c" 3 4
                                 ((void *)0) 
# 760 "../crypto/rsa/rsa_lib.c"
...
# 781 "../crypto/rsa/rsa_lib.c"
    ...
    if (pnum > 2) {
        ...
        prime_infos = sk_RSA_PRIME_INFO_new_reserve(
# 806 "../crypto/rsa/rsa_lib.c" 3 4
                                                   ((void *)0)
# 806 "../crypto/rsa/rsa_lib.c"
                                                       , pnum);
        if (prime_infos == 
# 807 "../crypto/rsa/rsa_lib.c" 3 4
                          ((void *)0)
# 807 "../crypto/rsa/rsa_lib.c"
                              )
            return 0;
        ...
        for (i = 2; i < pnum; i++) {
            ...
            RSA_PRIME_INFO *pinfo = 
# 814 "../crypto/rsa/rsa_lib.c" 3 4
                                   ((void *)0)
# 814 "../crypto/rsa/rsa_lib.c"
                                       ;

            if (!__builtin_expect(!!((prime != 
# 816 "../crypto/rsa/rsa_lib.c" 3 4
                ((void *)0) 
# 816 "../crypto/rsa/rsa_lib.c"
                && exp != 
# 816 "../crypto/rsa/rsa_lib.c" 3 4
                ((void *)0) 
# 816 "../crypto/rsa/rsa_lib.c"
...
# 816 "../crypto/rsa/rsa_lib.c"
            ...
            if ((pinfo = CRYPTO_zalloc(sizeof(*pinfo), "../crypto/rsa/rsa_lib.c", 820)) == 
# 820 "../crypto/rsa/rsa_lib.c" 3 4
                                                           ((void *)0)
# 820 "../crypto/rsa/rsa_lib.c"
                                                               )
                goto err;
    ...
    if (old_infos != 
# 844 "../crypto/rsa/rsa_lib.c" 3 4
                    ((void *)0)
# 844 "../crypto/rsa/rsa_lib.c"
                        ) {
...
struct stack_st_BIGNUM_const; typedef int (*sk_BIGNUM_const_compfunc)(const BIGNUM * const *a, const BIGNUM *const *b); typedef void (*sk_BIGNUM_const_freefunc)(BIGNUM *a); typedef BIGNUM * (*sk_BIGNUM_const_copyfunc)(const BIGNUM *a); static __attribute__((unused)) inline int sk_BIGNUM_const_num(const struct stack_st_BIGNUM_const *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_value(const struct stack_st_BIGNUM_const *sk, int idx) { return (const BIGNUM *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static __attribute__((unused)) inline struct stack_st_BIGNUM_const *sk_BIGNUM_const_new(sk_BIGNUM_const_compfunc compare) { return (struct stack_st_BIGNUM_const *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static __attribute__((unused)) inline struct stack_st_BIGNUM_const *sk_BIGNUM_const_new_null(void) { return (struct stack_st_BIGNUM_const *)OPENSSL_sk_new_null(); } static __attribute__((unused)) inline struct stack_st_BIGNUM_const *sk_BIGNUM_const_new_reserve(sk_BIGNUM_const_compfunc compare, int n) { return (struct stack_st_BIGNUM_const *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static __attribute__((unused)) inline int sk_BIGNUM_const_reserve(struct stack_st_BIGNUM_const *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static __attribute__((unused)) inline void sk_BIGNUM_const_free(struct stack_st_BIGNUM_const *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BIGNUM_const_zero(struct stack_st_BIGNUM_const *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_delete(struct stack_st_BIGNUM_const *sk, int i) { return (const BIGNUM *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_delete_ptr(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr) { return (const BIGNUM *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_const_push(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_const_unshift(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_pop(struct stack_st_BIGNUM_const *sk) { return (const BIGNUM *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_shift(struct stack_st_BIGNUM_const *sk) { return (const BIGNUM *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline void sk_BIGNUM_const_pop_free(struct stack_st_BIGNUM_const *sk, sk_BIGNUM_const_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline int sk_BIGNUM_const_insert(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static __attribute__((unused)) inline const BIGNUM *sk_BIGNUM_const_set(struct stack_st_BIGNUM_const *sk, int idx, const BIGNUM *ptr) { return (const BIGNUM *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_const_find(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_const_find_ex(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static __attribute__((unused)) inline int sk_BIGNUM_const_find_all(struct stack_st_BIGNUM_const *sk, const BIGNUM *ptr, int *pnum) { return OPENSSL_sk_find_all((OPENSSL_STACK *)sk, (const void *)ptr, pnum); } static __attribute__((unused)) inline void sk_BIGNUM_const_sort(struct stack_st_BIGNUM_const *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static __attribute__((unused)) inline int sk_BIGNUM_const_is_sorted(const struct stack_st_BIGNUM_const *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BIGNUM_const * sk_BIGNUM_const_dup(const struct stack_st_BIGNUM_const *sk) { return (struct stack_st_BIGNUM_const *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static __attribute__((unused)) inline struct stack_st_BIGNUM_const *sk_BIGNUM_const_deep_copy(const struct stack_st_BIGNUM_const *sk, sk_BIGNUM_const_copyfunc copyfunc, sk_BIGNUM_const_freefunc freefunc) { return (struct stack_st_BIGNUM_const *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static __attribute__((unused)) inline sk_BIGNUM_const_compfunc sk_BIGNUM_const_set_cmp_func(struct stack_st_BIGNUM_const *sk, sk_BIGNUM_const_compfunc compare) { return (sk_BIGNUM_const_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
                             ...
                             struct stack_st_BIGNUM_const *coeffs)
{
    ...
    if (r == 
# 878 "../crypto/rsa/rsa_lib.c" 3 4
            ((void *)0)
# 878 "../crypto/rsa/rsa_lib.c"
                )
        return 0;


    if (RSA_get0_p(r) == 
# 882 "../crypto/rsa/rsa_lib.c" 3 4
                        ((void *)0)
# 882 "../crypto/rsa/rsa_lib.c"
                            )
        return 1;
                               ...
                               const char *propkey, const char *mdprops)
{
    ...
    if (ctx == 
# 915 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 915 "../crypto/rsa/rsa_lib.c"
                   || mdname == 
# 915 "../crypto/rsa/rsa_lib.c" 3 4
                                ((void *)0) 
# 915 "../crypto/rsa/rsa_lib.c"
                                     || (ctx->operation & optype) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",916,__func__), ERR_set_error)((6),(147),
# 916 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 916 "../crypto/rsa/rsa_lib.c"
       );
    ...
    *p++ = OSSL_PARAM_construct_utf8_string(mdkey, (char *)mdname, 0);
    if ((!((ctx)->keymgmt == 
# 936 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 936 "../crypto/rsa/rsa_lib.c"
       )) && mdprops != 
# 936 "../crypto/rsa/rsa_lib.c" 3 4
                                                   ((void *)0)
# 936 "../crypto/rsa/rsa_lib.c"
                               ...
                               char *mdname, size_t mdnamesize)
{
    ...
    if (ctx == 
# 955 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 955 "../crypto/rsa/rsa_lib.c"
                   || mdname == 
# 955 "../crypto/rsa/rsa_lib.c" 3 4
                                ((void *)0) 
# 955 "../crypto/rsa/rsa_lib.c"
                                     || (ctx->operation & optype) == 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",956,__func__), ERR_set_error)((6),(147),
# 956 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 956 "../crypto/rsa/rsa_lib.c"
       );
...
int EVP_PKEY_CTX_set_rsa_padding(EVP_PKEY_CTX *ctx, int pad_mode)
{
    return RSA_pkey_ctx_ctrl(ctx, -1, (0x1000 + 1),
                             pad_mode, 
# 988 "../crypto/rsa/rsa_lib.c" 3 4
                                      ((void *)0)
# 988 "../crypto/rsa/rsa_lib.c"
                                          );
}
...
int EVP_PKEY_CTX_get_rsa_padding(EVP_PKEY_CTX *ctx, int *pad_mode)
{
    return RSA_pkey_ctx_ctrl(ctx, -1, (0x1000 + 6),
                             0, pad_mode);
}
...
int EVP_PKEY_CTX_set_rsa_pss_keygen_md(EVP_PKEY_CTX *ctx, const EVP_MD *md)
{
    return EVP_PKEY_CTX_ctrl(ctx, 912, (1<<2),
                             1, 0, (void *)(md));
}
...
int EVP_PKEY_CTX_set_rsa_pss_keygen_md_name(EVP_PKEY_CTX *ctx,
                                            ...
                                            const char *mdprops)
{
    return int_set_rsa_md_name(ctx, 912, (1<<2),
                               "digest", mdname,
                               "properties", mdprops);
}
...
int EVP_PKEY_CTX_set_rsa_oaep_md(EVP_PKEY_CTX *ctx, const EVP_MD *md)
{
    ...
    return EVP_PKEY_CTX_ctrl(ctx, 6, ((1<<9) | (1<<10)),
                             (0x1000 + 9), 0, (void *)(md));
}
...
{
    return
        int_set_rsa_md_name(ctx, 6, ((1<<9) | (1<<10)),
                            "digest", mdname,
                            "digest-props", mdprops);
}

int EVP_PKEY_CTX_get_rsa_oaep_md_name(EVP_PKEY_CTX *ctx, char *name,
                                      size_t namesize)
{
    return int_get_rsa_md_name(ctx, 6, ((1<<9) | (1<<10)),
                               "digest",
                               name, namesize);
}
...
int EVP_PKEY_CTX_set_rsa_mgf1_md(EVP_PKEY_CTX *ctx, const EVP_MD *md)
{
    return RSA_pkey_ctx_ctrl(ctx, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)) | ((1<<9) | (1<<10)),
                             (0x1000 + 5), 0, (void *)(md));
}
...
# 1107 "../crypto/rsa/rsa_lib.c" 3 4
                              ((void *)0)
# 1107 "../crypto/rsa/rsa_lib.c"
                                  , 
# 1107 "../crypto/rsa/rsa_lib.c" 3 4
                                    ((void *)0)
# 1107 "../crypto/rsa/rsa_lib.c"
...
int EVP_PKEY_CTX_set0_rsa_oaep_label(EVP_PKEY_CTX *ctx, void *label, int llen)
{
    ...
    if (ctx == 
# 1131 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 1131 "../crypto/rsa/rsa_lib.c"
                   || !((ctx)->operation == (1<<9) || (ctx)->operation == (1<<10))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",1132,__func__), ERR_set_error)((6),(147),
# 1132 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1132 "../crypto/rsa/rsa_lib.c"
       );
    ...
    if (label == 
# 1142 "../crypto/rsa/rsa_lib.c" 3 4
                ((void *)0) 
# 1142 "../crypto/rsa/rsa_lib.c"
                     && llen == 0)
        plabel = (void *)empty;


    *p++ = OSSL_PARAM_construct_octet_string("oaep-label",
    ...
    *p++ = OSSL_PARAM_construct_end();
    ...
    CRYPTO_free(label, "../crypto/rsa/rsa_lib.c", 1155);
    return 1;
}
...
int EVP_PKEY_CTX_get0_rsa_oaep_label(EVP_PKEY_CTX *ctx, unsigned char **label)
{
    ...
    if (ctx == 
# 1164 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 1164 "../crypto/rsa/rsa_lib.c"
                   || !((ctx)->operation == (1<<9) || (ctx)->operation == (1<<10))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",1165,__func__), ERR_set_error)((6),(147),
# 1165 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1165 "../crypto/rsa/rsa_lib.c"
       );
    ...
    *p++ = OSSL_PARAM_construct_octet_ptr("oaep-label",
                                          (void **)label, 0);
    *p++ = OSSL_PARAM_construct_end();
    ...
    if (labellen > 0x7fffffff
# 1182 "../crypto/rsa/rsa_lib.c"
                         )
        return -1;
...
int EVP_PKEY_CTX_set_rsa_pss_saltlen(EVP_PKEY_CTX *ctx, int saltlen)
{
# 1204 "../crypto/rsa/rsa_lib.c"
    return RSA_pkey_ctx_ctrl(ctx, ((1<<4) | (1<<5) | (1<<6) | (1<<7) | (1<<8)),
                             (0x1000 + 2), saltlen, 
# 1205 "../crypto/rsa/rsa_lib.c" 3 4
                                                                    ((void *)0)
# 1205 "../crypto/rsa/rsa_lib.c"
                                                                        );
}
...
int EVP_PKEY_CTX_set_rsa_pss_keygen_saltlen(EVP_PKEY_CTX *ctx, int saltlen)
{
    ...
    if (ctx == 
# 1231 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 1231 "../crypto/rsa/rsa_lib.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",1232,__func__), ERR_set_error)((6),(147),
# 1232 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1232 "../crypto/rsa/rsa_lib.c"
       );
    ...
    *p++ = OSSL_PARAM_construct_int("saltlen",
                                    &saltlen);
    *p++ = OSSL_PARAM_construct_end();
...
int EVP_PKEY_CTX_set_rsa_keygen_bits(EVP_PKEY_CTX *ctx, int bits)
{
    ...
    if (ctx == 
# 1252 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 1252 "../crypto/rsa/rsa_lib.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",1253,__func__), ERR_set_error)((6),(147),
# 1253 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1253 "../crypto/rsa/rsa_lib.c"
       );
    ...
    *p++ = OSSL_PARAM_construct_size_t("bits", &bits2);
    *p++ = OSSL_PARAM_construct_end();
...
int EVP_PKEY_CTX_set_rsa_keygen_pubexp(EVP_PKEY_CTX *ctx, BIGNUM *pubexp)
{
    int ret = RSA_pkey_ctx_ctrl(ctx, (1<<2),
                                (0x1000 + 4), 0, pubexp);
    ...
    if (ret > 0 && (!((ctx)->keymgmt == 
# 1279 "../crypto/rsa/rsa_lib.c" 3 4
                  ((void *)0)
# 1279 "../crypto/rsa/rsa_lib.c"
                  ))) {
...
int EVP_PKEY_CTX_set1_rsa_keygen_pubexp(EVP_PKEY_CTX *ctx, BIGNUM *pubexp)
{
    ...
    if (((ctx)->keymgmt == 
# 1295 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1295 "../crypto/rsa/rsa_lib.c"
       )) {
        pubexp = BN_dup(pubexp);
        if (pubexp == 
# 1297 "../crypto/rsa/rsa_lib.c" 3 4
                     ((void *)0)
# 1297 "../crypto/rsa/rsa_lib.c"
                         )
            return 0;
    }
    ret = EVP_PKEY_CTX_ctrl(ctx, 6, (1<<2),
                            (0x1000 + 4), 0, pubexp);
    if (((ctx)->keymgmt == 
# 1302 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1302 "../crypto/rsa/rsa_lib.c"
       ) && ret <= 0)
        BN_free(pubexp);
    return ret;
}
...
int EVP_PKEY_CTX_set_rsa_keygen_primes(EVP_PKEY_CTX *ctx, int primes)
{
    ...
    if (ctx == 
# 1312 "../crypto/rsa/rsa_lib.c" 3 4
              ((void *)0) 
# 1312 "../crypto/rsa/rsa_lib.c"
                   || !((ctx)->operation == (1<<1) || (ctx)->operation == (1<<2))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_lib.c",1313,__func__), ERR_set_error)((6),(147),
# 1313 "../crypto/rsa/rsa_lib.c" 3 4
       ((void *)0)
# 1313 "../crypto/rsa/rsa_lib.c"
       );
    ...
    *p++ = OSSL_PARAM_construct_size_t("primes", &primes2);
    *p++ = OSSL_PARAM_construct_end();
