# 0 "../crypto/rsa/rsa_x931.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_x931.c"
# 14 "../crypto/rsa/rsa_x931.c"
                         ...
                         const unsigned char *from, int flen)
{
    ...
    if (j < 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_x931.c",36,__func__), ERR_set_error)((4),(110),
# 36 "../crypto/rsa/rsa_x931.c" 3 4
       ((void *)0)
# 36 "../crypto/rsa/rsa_x931.c"
       );
        return -1;
    }
                           ...
                           const unsigned char *from, int flen, int num)
{
    ...
    if ((num != flen) || ((*p != 0x6A) && (*p != 0x6B))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_x931.c",67,__func__), ERR_set_error)((4),(137),
# 67 "../crypto/rsa/rsa_x931.c" 3 4
       ((void *)0)
# 67 "../crypto/rsa/rsa_x931.c"
       );
        return -1;
    }
    ...
    if (*p++ == 0x6B) {
        ...
        for (i = 0; i < j; i++) {
            ...
            if (c == 0xBA)
                break;
            if (c != 0xBB) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_x931.c",78,__func__), ERR_set_error)((4),(138),
# 78 "../crypto/rsa/rsa_x931.c" 3 4
               ((void *)0)
# 78 "../crypto/rsa/rsa_x931.c"
               );
                return -1;
            }
        }
        ...
        if (i == 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_x931.c",86,__func__), ERR_set_error)((4),(138),
# 86 "../crypto/rsa/rsa_x931.c" 3 4
           ((void *)0)
# 86 "../crypto/rsa/rsa_x931.c"
           );
            return -1;
        }
    ...
    if (p[j] != 0xCC) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_x931.c",95,__func__), ERR_set_error)((4),(139),
# 95 "../crypto/rsa/rsa_x931.c" 3 4
       ((void *)0)
# 95 "../crypto/rsa/rsa_x931.c"
       );
        return -1;
    }
