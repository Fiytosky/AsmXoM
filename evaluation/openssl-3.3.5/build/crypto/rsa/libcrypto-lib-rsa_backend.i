# 0 "../crypto/rsa/rsa_backend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_backend.c"
# 14 "../crypto/rsa/rsa_backend.c"
...
# 17 "../crypto/rsa/rsa_backend.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../crypto/rsa/rsa_backend.c" 2
...
# 24 "../crypto/rsa/rsa_backend.c" 2

# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 26 "../crypto/rsa/rsa_backend.c" 2
...
static int collect_numbers(struct stack_st_BIGNUM *numbers,
                           const OSSL_PARAM params[], const char *names[])
{
    const OSSL_PARAM *p = 
# 41 "../crypto/rsa/rsa_backend.c" 3 4
                         ((void *)0)
# 41 "../crypto/rsa/rsa_backend.c"
                             ;
    int i;

    if (numbers == 
# 44 "../crypto/rsa/rsa_backend.c" 3 4
                  ((void *)0)
# 44 "../crypto/rsa/rsa_backend.c"
                      )
        return 0;

    for (i = 0; names[i] != 
# 47 "../crypto/rsa/rsa_backend.c" 3 4
                           ((void *)0)
# 47 "../crypto/rsa/rsa_backend.c"
                               ; i++) {
        p = OSSL_PARAM_locate_const(params, names[i]);
        if (p != 
# 49 "../crypto/rsa/rsa_backend.c" 3 4
                ((void *)0)
# 49 "../crypto/rsa/rsa_backend.c"
                    ) {
            BIGNUM *tmp = 
# 50 "../crypto/rsa/rsa_backend.c" 3 4
                         ((void *)0)
# 50 "../crypto/rsa/rsa_backend.c"
                             ;
...
# 66 "../crypto/rsa/rsa_backend.c" 3 4
                                                    ((void *)0)
# 66 "../crypto/rsa/rsa_backend.c"
                                                        ;
    const OSSL_PARAM *param_p, *param_q = 
# 67 "../crypto/rsa/rsa_backend.c" 3 4
                                         ((void *)0)
# 67 "../crypto/rsa/rsa_backend.c"
                                             ;
    const OSSL_PARAM *param_derive = 
# 68 "../crypto/rsa/rsa_backend.c" 3 4
                                    ((void *)0)
# 68 "../crypto/rsa/rsa_backend.c"
                                        ;
    BIGNUM *p = 
# 69 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 69 "../crypto/rsa/rsa_backend.c"
                   , *q = 
# 69 "../crypto/rsa/rsa_backend.c" 3 4
                          ((void *)0)
# 69 "../crypto/rsa/rsa_backend.c"
...
# 69 "../crypto/rsa/rsa_backend.c"
                                                               ;
    struct stack_st_BIGNUM *factors = 
# 70 "../crypto/rsa/rsa_backend.c" 3 4
                               ((void *)0)
# 70 "../crypto/rsa/rsa_backend.c"
                                   , *exps = 
# 70 "../crypto/rsa/rsa_backend.c" 3 4
                                             ((void *)0)
# 70 "../crypto/rsa/rsa_backend.c"
...
# 70 "../crypto/rsa/rsa_backend.c"
    ...
    BN_CTX *ctx = 
# 73 "../crypto/rsa/rsa_backend.c" 3 4
                 ((void *)0)
# 73 "../crypto/rsa/rsa_backend.c"
                     ;

    if (rsa == 
# 75 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 75 "../crypto/rsa/rsa_backend.c"
                  )
        return 0;

    param_n = OSSL_PARAM_locate_const(params, "n");
    param_e = OSSL_PARAM_locate_const(params, "e");

    if ((param_n == 
# 81 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0) 
# 81 "../crypto/rsa/rsa_backend.c"
                        || !OSSL_PARAM_get_BN(param_n, &n))
        || (param_e == 
# 82 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0) 
# 82 "../crypto/rsa/rsa_backend.c"
                           || !OSSL_PARAM_get_BN(param_e, &e))) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",83,__func__), ERR_set_error)((4),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 83 "../crypto/rsa/rsa_backend.c" 3 4
       ((void *)0)
# 83 "../crypto/rsa/rsa_backend.c"
       );
        goto err;
    }
    ...
    if (include_private) {
        ...
        param_derive = OSSL_PARAM_locate_const(params,
                                           "rsa-derive-from-pq");
        if ((param_derive != 
# 91 "../crypto/rsa/rsa_backend.c" 3 4
                            ((void *)0)
# 91 "../crypto/rsa/rsa_backend.c"
                                )
            && !OSSL_PARAM_get_int(param_derive, &derive_from_pq))
            goto err;

        param_d = OSSL_PARAM_locate_const(params, "d");
        if (param_d != 
# 96 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0) 
# 96 "../crypto/rsa/rsa_backend.c"
                           && !OSSL_PARAM_get_BN(param_d, &d)) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",97,__func__), ERR_set_error)((4),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 97 "../crypto/rsa/rsa_backend.c" 3 4
           ((void *)0)
# 97 "../crypto/rsa/rsa_backend.c"
           );
            goto err;
        }
        ...
        if (derive_from_pq) {
            ...
            if (ctx == 
# 103 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0)
# 103 "../crypto/rsa/rsa_backend.c"
                          )
                goto err;


            param_p = OSSL_PARAM_locate_const(params, "rsa-factor1");
            param_q = OSSL_PARAM_locate_const(params, "rsa-factor2");
            if ((param_p == 
# 109 "../crypto/rsa/rsa_backend.c" 3 4
                           ((void *)0) 
# 109 "../crypto/rsa/rsa_backend.c"
                                || !OSSL_PARAM_get_BN(param_p, &p))
                || (param_q == 
# 110 "../crypto/rsa/rsa_backend.c" 3 4
                              ((void *)0) 
# 110 "../crypto/rsa/rsa_backend.c"
                                   || !OSSL_PARAM_get_BN(param_q, &q))) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",111,__func__), ERR_set_error)((4),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 111 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 111 "../crypto/rsa/rsa_backend.c"
               );
                goto err;
            }
    ...
    is_private = (d != 
# 118 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0)
# 118 "../crypto/rsa/rsa_backend.c"
                          );

    if (!RSA_set0_key(rsa, n, e, d))
        goto err;
    n = e = d = 
# 122 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 122 "../crypto/rsa/rsa_backend.c"
                   ;
    ...
    if (is_private) {
        ...
        if (derive_from_pq && sk_BIGNUM_num(exps) == 0
            ...
            if (sk_BIGNUM_num(factors) < 2) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",140,__func__), ERR_set_error)((4),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 140 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 140 "../crypto/rsa/rsa_backend.c"
               );
                goto err;
            }
            ...
            if (sk_BIGNUM_num(factors) > 2
                && (param_n == 
# 149 "../crypto/rsa/rsa_backend.c" 3 4
                              ((void *)0) 
# 149 "../crypto/rsa/rsa_backend.c"
                                   || param_d == 
# 149 "../crypto/rsa/rsa_backend.c" 3 4
                                                 ((void *)0)
# 149 "../crypto/rsa/rsa_backend.c"
                                                     )) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",150,__func__), ERR_set_error)((4),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 150 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 150 "../crypto/rsa/rsa_backend.c"
               );
                goto err;
            }
            ...
            if (sk_BIGNUM_num(factors) == 2) {
                ...
                if (!RSA_set0_factors(rsa, sk_BIGNUM_value(factors, 0),
                    ...
                    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",159,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 159 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 159 "../crypto/rsa/rsa_backend.c"
                   );
                    goto err;
                }
...
# 177 "../crypto/rsa/rsa_backend.c" 3 4
                                                             ((void *)0)
# 177 "../crypto/rsa/rsa_backend.c"
                                                                 , ctx)) {
                    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",178,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 178 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 178 "../crypto/rsa/rsa_backend.c"
                   );
                    goto err;
                }
            } else {
                ...
                if (!ossl_rsa_multiprime_derive(rsa, RSA_bits(rsa),
                                                ...
                                                rsa->e, factors, exps,
                                                coeffs)) {
                    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",191,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 191 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 191 "../crypto/rsa/rsa_backend.c"
                   );
                    goto err;
                }
                ...
                if (!ossl_rsa_set0_all_params(rsa, factors, exps, coeffs)) {
                    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",200,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 200 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 200 "../crypto/rsa/rsa_backend.c"
                   );
                    goto err;
                }
        ...
        if (sk_BIGNUM_num(factors) != 0
            ...
            || sk_BIGNUM_num(coeffs) != 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",224,__func__), ERR_set_error)(4, (259|((0x1 << 18L)|(0x2 << 18L))),
                    ...
                    int include_private)
{
    int ret = 0;
    const BIGNUM *rsa_d = 
# 257 "../crypto/rsa/rsa_backend.c" 3 4
                         ((void *)0)
# 257 "../crypto/rsa/rsa_backend.c"
                             , *rsa_n = 
# 257 "../crypto/rsa/rsa_backend.c" 3 4
                                        ((void *)0)
# 257 "../crypto/rsa/rsa_backend.c"
...
# 257 "../crypto/rsa/rsa_backend.c"
                                                           ;
    struct stack_st_BIGNUM_const *factors = sk_BIGNUM_const_new_null();
    struct stack_st_BIGNUM_const *exps = sk_BIGNUM_const_new_null();
    struct stack_st_BIGNUM_const *coeffs = sk_BIGNUM_const_new_null();

    if (rsa == 
# 262 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0) 
# 262 "../crypto/rsa/rsa_backend.c"
                   || factors == 
# 262 "../crypto/rsa/rsa_backend.c" 3 4
                                 ((void *)0) 
# 262 "../crypto/rsa/rsa_backend.c"
...
# 262 "../crypto/rsa/rsa_backend.c"
    ...
    if (!ossl_param_build_set_bn(bld, params, "n", rsa_n)
        || !ossl_param_build_set_bn(bld, params, "e", rsa_e))
        goto err;


    if (include_private && rsa_d != 
# 273 "../crypto/rsa/rsa_backend.c" 3 4
                                   ((void *)0)
# 273 "../crypto/rsa/rsa_backend.c"
                                       ) {

        if (!ossl_param_build_set_bn(bld, params, "d",
                                     rsa_d)
                                  ...
                                  OSSL_PARAM_BLD *bld, OSSL_PARAM params[])
{
    if (!ossl_rsa_pss_params_30_is_unrestricted(pss)) {
        ...
        int default_hashalg_nid = ossl_rsa_pss_params_30_hashalg(
# 309 "../crypto/rsa/rsa_backend.c" 3 4
                                                                ((void *)0)
# 309 "../crypto/rsa/rsa_backend.c"
                                                                    );
        int default_maskgenalg_nid = ossl_rsa_pss_params_30_maskgenalg(
# 310 "../crypto/rsa/rsa_backend.c" 3 4
                                                                      ((void *)0)
# 310 "../crypto/rsa/rsa_backend.c"
                                                                          );
        int default_maskgenhashalg_nid =
                ossl_rsa_pss_params_30_maskgenhashalg(
# 312 "../crypto/rsa/rsa_backend.c" 3 4
                                                     ((void *)0)
# 312 "../crypto/rsa/rsa_backend.c"
                                                         );
        const char *mdname =
            (hashalg_nid == default_hashalg_nid
             ? 
# 315 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0) 
# 315 "../crypto/rsa/rsa_backend.c"
                   : ossl_rsa_oaeppss_nid2name(hashalg_nid));
        const char *mgfname =
            (maskgenalg_nid == default_maskgenalg_nid
             ? 
# 318 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0) 
# 318 "../crypto/rsa/rsa_backend.c"
                   : ossl_rsa_oaeppss_nid2name(maskgenalg_nid));
        const char *mgf1mdname =
            (maskgenhashalg_nid == default_maskgenhashalg_nid
             ? 
# 321 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0) 
# 321 "../crypto/rsa/rsa_backend.c"
                   : ossl_rsa_oaeppss_nid2name(maskgenhashalg_nid));
        const char *key_md = "digest";
        const char *key_mgf = "mgf";
        const char *key_mgf1_md = "mgf1-digest";
        const char *key_saltlen = "saltlen";
        ...
        if ((mdname != 
# 332 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0)
             
# 333 "../crypto/rsa/rsa_backend.c"
            && !ossl_param_build_set_utf8_string(bld, params, key_md, mdname))
            || (mgfname != 
# 334 "../crypto/rsa/rsa_backend.c" 3 4
                          ((void *)0)
                
# 335 "../crypto/rsa/rsa_backend.c"
               && !ossl_param_build_set_utf8_string(bld, params,
                                                     key_mgf, mgfname))
            || (mgf1mdname != 
# 337 "../crypto/rsa/rsa_backend.c" 3 4
                             ((void *)0)
                
# 338 "../crypto/rsa/rsa_backend.c"
               && !ossl_param_build_set_utf8_string(bld, params,
                                    ...
                                    OSSL_LIB_CTX *libctx)
{
    ...
    const char *propq = 
# 353 "../crypto/rsa/rsa_backend.c" 3 4
                       ((void *)0)
# 353 "../crypto/rsa/rsa_backend.c"
                           ;
    EVP_MD *md = 
# 354 "../crypto/rsa/rsa_backend.c" 3 4
                ((void *)0)
# 354 "../crypto/rsa/rsa_backend.c"
                    , *mgf1md = 
# 354 "../crypto/rsa/rsa_backend.c" 3 4
                                ((void *)0)
# 354 "../crypto/rsa/rsa_backend.c"
    ...
    if (pss_params == 
# 358 "../crypto/rsa/rsa_backend.c" 3 4
                     ((void *)0)
# 358 "../crypto/rsa/rsa_backend.c"
                         )
        return 0;
    param_propq =
        OSSL_PARAM_locate_const(params, "properties");
    param_md =
        OSSL_PARAM_locate_const(params, "digest");
    param_mgf =
        OSSL_PARAM_locate_const(params, "mgf");
    param_mgf1md =
        OSSL_PARAM_locate_const(params, "mgf1-digest");
    param_saltlen =
        OSSL_PARAM_locate_const(params, "saltlen");

    if (param_propq != 
# 371 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0)
# 371 "../crypto/rsa/rsa_backend.c"
                          ) {
        if (param_propq->data_type == 4)
    ...
    if (!*defaults_set
        && (param_md != 
# 381 "../crypto/rsa/rsa_backend.c" 3 4
                       ((void *)0) 
# 381 "../crypto/rsa/rsa_backend.c"
                            || param_mgf != 
# 381 "../crypto/rsa/rsa_backend.c" 3 4
                                            ((void *)0) 
# 381 "../crypto/rsa/rsa_backend.c"
...
# 382 "../crypto/rsa/rsa_backend.c"
           || param_saltlen != 
# 382 "../crypto/rsa/rsa_backend.c" 3 4
                               ((void *)0)
# 382 "../crypto/rsa/rsa_backend.c"
                                   )) {
    ...
    if (param_mgf != 
# 388 "../crypto/rsa/rsa_backend.c" 3 4
                    ((void *)0)
# 388 "../crypto/rsa/rsa_backend.c"
                        ) {
        int default_maskgenalg_nid = ossl_rsa_pss_params_30_maskgenalg(
# 389 "../crypto/rsa/rsa_backend.c" 3 4
                                                                      ((void *)0)
# 389 "../crypto/rsa/rsa_backend.c"
                                                                          );
        const char *mgfname = 
# 390 "../crypto/rsa/rsa_backend.c" 3 4
                             ((void *)0)
# 390 "../crypto/rsa/rsa_backend.c"
                                 ;

        if (param_mgf->data_type == 4)
    ...
    if (param_md != 
# 407 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 407 "../crypto/rsa/rsa_backend.c"
                       ) {
        const char *mdname = 
# 408 "../crypto/rsa/rsa_backend.c" 3 4
                            ((void *)0)
# 408 "../crypto/rsa/rsa_backend.c"
                                ;

        if (param_md->data_type == 4)
            mdname = param_md->data;
        else if (!OSSL_PARAM_get_utf8_ptr(param_mgf, &mdname))
            goto err;

        if ((md = EVP_MD_fetch(libctx, mdname, propq)) == 
# 415 "../crypto/rsa/rsa_backend.c" 3 4
                                                         ((void *)0)
            
# 416 "../crypto/rsa/rsa_backend.c"
    ...
    if (param_mgf1md != 
# 421 "../crypto/rsa/rsa_backend.c" 3 4
                       ((void *)0)
# 421 "../crypto/rsa/rsa_backend.c"
                           ) {
        const char *mgf1mdname = 
# 422 "../crypto/rsa/rsa_backend.c" 3 4
                                ((void *)0)
# 422 "../crypto/rsa/rsa_backend.c"
                                    ;

        if (param_mgf1md->data_type == 4)
...
# 429 "../crypto/rsa/rsa_backend.c" 3 4
                                                                 ((void *)0)
            
# 430 "../crypto/rsa/rsa_backend.c"
    ...
    if (param_saltlen != 
# 435 "../crypto/rsa/rsa_backend.c" 3 4
                        ((void *)0)
# 435 "../crypto/rsa/rsa_backend.c"
                            ) {
...
int ossl_rsa_is_foreign(const RSA *rsa)
{
    ...
    if (rsa->engine != 
# 452 "../crypto/rsa/rsa_backend.c" 3 4
                      ((void *)0) 
# 452 "../crypto/rsa/rsa_backend.c"
                           || RSA_get_method(rsa) != RSA_PKCS1_OpenSSL())
        return 1;
...
{
    if (f != 
# 460 "../crypto/rsa/rsa_backend.c" 3 4
            ((void *)0) 
# 460 "../crypto/rsa/rsa_backend.c"
                 && (*out = BN_dup(f)) == 
# 460 "../crypto/rsa/rsa_backend.c" 3 4
                                          ((void *)0)
# 460 "../crypto/rsa/rsa_backend.c"
...
{
    RSA *dupkey = 
# 467 "../crypto/rsa/rsa_backend.c" 3 4
                 ((void *)0)
# 467 "../crypto/rsa/rsa_backend.c"
                     ;
    ...
    if (ossl_rsa_is_foreign(rsa))
        return 
# 474 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 474 "../crypto/rsa/rsa_backend.c"
                  ;

    if ((dupkey = ossl_rsa_new_with_ctx(rsa->libctx)) == 
# 476 "../crypto/rsa/rsa_backend.c" 3 4
                                                        ((void *)0)
# 476 "../crypto/rsa/rsa_backend.c"
                                                            )
        return 
# 477 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 477 "../crypto/rsa/rsa_backend.c"
                  ;
    ...
    if ((selection & 0x01) != 0
        ...
        dupkey->prime_infos = sk_RSA_PRIME_INFO_new_reserve(
# 515 "../crypto/rsa/rsa_backend.c" 3 4
                                                           ((void *)0)
# 515 "../crypto/rsa/rsa_backend.c"
                                                               , pnum);
        if (dupkey->prime_infos == 
# 516 "../crypto/rsa/rsa_backend.c" 3 4
                                  ((void *)0)
# 516 "../crypto/rsa/rsa_backend.c"
                                      )
            goto err;
        for (i = 0; i < pnum; i++) {
            const RSA_PRIME_INFO *pinfo = 
# 519 "../crypto/rsa/rsa_backend.c" 3 4
                                         ((void *)0)
# 519 "../crypto/rsa/rsa_backend.c"
                                             ;
            RSA_PRIME_INFO *duppinfo = 
# 520 "../crypto/rsa/rsa_backend.c" 3 4
                                      ((void *)0)
# 520 "../crypto/rsa/rsa_backend.c"
                                          ;

            if ((duppinfo = CRYPTO_zalloc(sizeof(*duppinfo), "../crypto/rsa/rsa_backend.c", 522)) == 
# 522 "../crypto/rsa/rsa_backend.c" 3 4
                                                                 ((void *)0)
# 522 "../crypto/rsa/rsa_backend.c"
                                                                     )
                goto err;
    ...
    if (rsa->pss != 
# 539 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 539 "../crypto/rsa/rsa_backend.c"
                       ) {
        dupkey->pss = RSA_PSS_PARAMS_dup(rsa->pss);
        if (rsa->pss->maskGenAlgorithm != 
# 541 "../crypto/rsa/rsa_backend.c" 3 4
                                         ((void *)0)
            
# 542 "../crypto/rsa/rsa_backend.c"
           && dupkey->pss->maskGenAlgorithm == 
# 542 "../crypto/rsa/rsa_backend.c" 3 4
                                               ((void *)0)
# 542 "../crypto/rsa/rsa_backend.c"
                                                   ) {
            dupkey->pss->maskHash = ossl_x509_algor_mgf1_decode(rsa->pss->maskGenAlgorithm);
            if (dupkey->pss->maskHash == 
# 544 "../crypto/rsa/rsa_backend.c" 3 4
                                        ((void *)0)
# 544 "../crypto/rsa/rsa_backend.c"
                                            )
                goto err;
        }
    }
    if (!CRYPTO_dup_ex_data(9,
 ...
 err:
    RSA_free(dupkey);
    return 
# 557 "../crypto/rsa/rsa_backend.c" 3 4
          ((void *)0)
# 557 "../crypto/rsa/rsa_backend.c"
              ;
}
...
RSA_PSS_PARAMS *ossl_rsa_pss_decode(const X509_ALGOR *alg)
{
    ...
    pss = ASN1_TYPE_unpack_sequence((RSA_PSS_PARAMS_it()),
                                    alg->parameter);

    if (pss == 
# 568 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 568 "../crypto/rsa/rsa_backend.c"
                  )
        return 
# 569 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 569 "../crypto/rsa/rsa_backend.c"
                  ;

    if (pss->maskGenAlgorithm != 
# 571 "../crypto/rsa/rsa_backend.c" 3 4
                                ((void *)0)
# 571 "../crypto/rsa/rsa_backend.c"
                                    ) {
        pss->maskHash = ossl_x509_algor_mgf1_decode(pss->maskGenAlgorithm);
        if (pss->maskHash == 
# 573 "../crypto/rsa/rsa_backend.c" 3 4
                            ((void *)0)
# 573 "../crypto/rsa/rsa_backend.c"
                                ) {
            RSA_PSS_PARAMS_free(pss);
            return 
# 575 "../crypto/rsa/rsa_backend.c" 3 4
                  ((void *)0)
# 575 "../crypto/rsa/rsa_backend.c"
                      ;
        }
    }
...
{
    const RSA_PSS_PARAMS *legacy_pss = 
# 584 "../crypto/rsa/rsa_backend.c" 3 4
                                      ((void *)0)
# 584 "../crypto/rsa/rsa_backend.c"
                                          ;
    RSA_PSS_PARAMS_30 *pss = 
# 585 "../crypto/rsa/rsa_backend.c" 3 4
                            ((void *)0)
# 585 "../crypto/rsa/rsa_backend.c"
                                ;

    if (rsa != 
# 587 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
        
# 588 "../crypto/rsa/rsa_backend.c"
       && (legacy_pss = RSA_get0_pss_params(rsa)) != 
# 588 "../crypto/rsa/rsa_backend.c" 3 4
                                                     ((void *)0)
        
# 589 "../crypto/rsa/rsa_backend.c"
       && (pss = ossl_rsa_get0_pss_params_30(rsa)) != 
# 589 "../crypto/rsa/rsa_backend.c" 3 4
                                                      ((void *)0)
# 589 "../crypto/rsa/rsa_backend.c"
                                                          ) {
        const EVP_MD *md = 
# 590 "../crypto/rsa/rsa_backend.c" 3 4
                          ((void *)0)
# 590 "../crypto/rsa/rsa_backend.c"
                              , *mgf1md = 
# 590 "../crypto/rsa/rsa_backend.c" 3 4
                                          ((void *)0)
# 590 "../crypto/rsa/rsa_backend.c"
                                      ...
                                      int *psaltlen, int *ptrailerField)
{
    ...
    if (pss == 
# 630 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 630 "../crypto/rsa/rsa_backend.c"
                  )
        return 0;
    *pmd = ossl_x509_algor_get_md(pss->hashAlgorithm);
    if (*pmd == 
# 633 "../crypto/rsa/rsa_backend.c" 3 4
               ((void *)0)
# 633 "../crypto/rsa/rsa_backend.c"
                   )
        return 0;
    *pmgf1md = ossl_x509_algor_get_md(pss->maskHash);
    if (*pmgf1md == 
# 636 "../crypto/rsa/rsa_backend.c" 3 4
                   ((void *)0)
# 636 "../crypto/rsa/rsa_backend.c"
                       )
        return 0;
    if (pss->saltLength)
...
int ossl_rsa_param_decode(RSA *rsa, const X509_ALGOR *alg)
{
    ...
    if (OBJ_obj2nid(algoid) != 912)
        return 1;
    if (algptype == -1)
        return 1;
    if (algptype != 16) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",663,__func__), ERR_set_error)((4),(149),
# 663 "../crypto/rsa/rsa_backend.c" 3 4
       ((void *)0)
# 663 "../crypto/rsa/rsa_backend.c"
       );
        return 0;
    }
    if ((pss = ossl_rsa_pss_decode(alg)) == 
# 666 "../crypto/rsa/rsa_backend.c" 3 4
                                           ((void *)0)
        
# 667 "../crypto/rsa/rsa_backend.c"
                             ...
                             OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (!PKCS8_pkey_get0(
# 684 "../crypto/rsa/rsa_backend.c" 3 4
                        ((void *)0)
# 684 "../crypto/rsa/rsa_backend.c"
                            , &p, &pklen, &alg, p8inf))
        return 0;
    rsa = d2i_RSAPrivateKey(
# 686 "../crypto/rsa/rsa_backend.c" 3 4
                           ((void *)0)
# 686 "../crypto/rsa/rsa_backend.c"
                               , &p, pklen);
    if (rsa == 
# 687 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 687 "../crypto/rsa/rsa_backend.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_backend.c",688,__func__), ERR_set_error)((4),((4 | (0x2 << 18L))),
# 688 "../crypto/rsa/rsa_backend.c" 3 4
       ((void *)0)
# 688 "../crypto/rsa/rsa_backend.c"
       );
        return 
# 689 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 689 "../crypto/rsa/rsa_backend.c"
                  ;
    }
    if (!ossl_rsa_param_decode(rsa, alg)) {
        RSA_free(rsa);
        return 
# 693 "../crypto/rsa/rsa_backend.c" 3 4
              ((void *)0)
# 693 "../crypto/rsa/rsa_backend.c"
                  ;
    }
