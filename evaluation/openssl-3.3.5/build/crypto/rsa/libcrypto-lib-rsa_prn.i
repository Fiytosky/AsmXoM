# 0 "../crypto/rsa/rsa_prn.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_prn.c"
# 14 "../crypto/rsa/rsa_prn.c"
...
# 27 "../crypto/rsa/rsa_prn.c" 3 4
                                      ((void *)0)
# 27 "../crypto/rsa/rsa_prn.c"
                                          ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_prn.c",28,__func__), ERR_set_error)((4),((7 | (0x2 << 18L))),
# 28 "../crypto/rsa/rsa_prn.c" 3 4
       ((void *)0)
# 28 "../crypto/rsa/rsa_prn.c"
       );
        return 0;
    }
...
int RSA_print(BIO *bp, const RSA *x, int off)
{
    ...
    pk = EVP_PKEY_new();
    if (pk == 
# 43 "../crypto/rsa/rsa_prn.c" 3 4
             ((void *)0)
# 43 "../crypto/rsa/rsa_prn.c"
                 )
        return 0;
    ret = EVP_PKEY_set1_RSA(pk, (RSA *)x);
    if (ret)
        ret = EVP_PKEY_print_private(bp, pk, off, 
# 47 "../crypto/rsa/rsa_prn.c" 3 4
                                                 ((void *)0)
# 47 "../crypto/rsa/rsa_prn.c"
                                                     );
    EVP_PKEY_free(pk);
    return ret;
}
