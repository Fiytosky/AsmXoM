# 0 "../crypto/rsa/rsa_ossl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_ossl.c"
# 14 "../crypto/rsa/rsa_ossl.c"
...
# 69 "../crypto/rsa/rsa_ossl.c" 3 4
   ((void *)0)
# 69 "../crypto/rsa/rsa_ossl.c"
       ,
    0,
    0,
    
# 72 "../crypto/rsa/rsa_ossl.c" 3 4
   ((void *)0)
# 72 "../crypto/rsa/rsa_ossl.c"
       ,
    
# 73 "../crypto/rsa/rsa_ossl.c" 3 4
   ((void *)0)

# 74 "../crypto/rsa/rsa_ossl.c"
};
...
{
    return 
# 96 "../crypto/rsa/rsa_ossl.c" 3 4
          ((void *)0)
# 96 "../crypto/rsa/rsa_ossl.c"
              ;
}
                                  ...
                                  unsigned char *to, RSA *rsa, int padding)
{
    ...
    int i, num = 0, r = -1;
    unsigned char *buf = 
# 104 "../crypto/rsa/rsa_ossl.c" 3 4
                        ((void *)0)
# 104 "../crypto/rsa/rsa_ossl.c"
                            ;
    BN_CTX *ctx = 
# 105 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0)
# 105 "../crypto/rsa/rsa_ossl.c"
                     ;

    if (BN_num_bits(rsa->n) > 16384) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",108,__func__), ERR_set_error)((4),(105),
# 108 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 108 "../crypto/rsa/rsa_ossl.c"
       );
        return -1;
    }

    if (BN_ucmp(rsa->n, rsa->e) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",113,__func__), ERR_set_error)((4),(101),
# 113 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 113 "../crypto/rsa/rsa_ossl.c"
       );
        return -1;
    }
    ...
    if (BN_num_bits(rsa->n) > 3072) {
        if (BN_num_bits(rsa->e) > 64) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",120,__func__), ERR_set_error)((4),(101),
# 120 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 120 "../crypto/rsa/rsa_ossl.c"
           );
            return -1;
        }
    }

    if ((ctx = BN_CTX_new_ex(rsa->libctx)) == 
# 125 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 125 "../crypto/rsa/rsa_ossl.c"
                                                 )
        goto err;
    BN_CTX_start(ctx);
    f = BN_CTX_get(ctx);
    ...
    buf = CRYPTO_malloc(num, "../crypto/rsa/rsa_ossl.c", 131);
    if (ret == 
# 132 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0) 
# 132 "../crypto/rsa/rsa_ossl.c"
                   || buf == 
# 132 "../crypto/rsa/rsa_ossl.c" 3 4
                             ((void *)0)
# 132 "../crypto/rsa/rsa_ossl.c"
    ...
    case 4:
        i = ossl_rsa_padding_add_PKCS1_OAEP_mgf1_ex(rsa->libctx, buf, num,
                                                    from, flen, 
# 142 "../crypto/rsa/rsa_ossl.c" 3 4
                                                               ((void *)0)
# 142 "../crypto/rsa/rsa_ossl.c"
                                                                   , 0,
                                                    
# 143 "../crypto/rsa/rsa_ossl.c" 3 4
                                                   ((void *)0)
# 143 "../crypto/rsa/rsa_ossl.c"
                                                       , 
# 143 "../crypto/rsa/rsa_ossl.c" 3 4
                                                         ((void *)0)
# 143 "../crypto/rsa/rsa_ossl.c"
    ...
    case 3:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",149,__func__), ERR_set_error)((4),(118),
# 149 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 149 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    if (i <= 0)
...
# 155 "../crypto/rsa/rsa_ossl.c" 3 4
                                 ((void *)0)
# 155 "../crypto/rsa/rsa_ossl.c"
                                     )
        goto err;

    if (BN_ucmp(f, rsa->n) >= 0) {

        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",160,__func__), ERR_set_error)((4),(132),
# 160 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 160 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
 ...
 err:
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_clear_free(buf, num, "../crypto/rsa/rsa_ossl.c", 181);
    return r;
}
...
static BN_BLINDING *rsa_get_blinding(RSA *rsa, int *local, BN_CTX *ctx)
{
    ...
    if (!CRYPTO_THREAD_read_lock(rsa->lock))
        return 
# 190 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 190 "../crypto/rsa/rsa_ossl.c"
                  ;

    if (rsa->blinding == 
# 192 "../crypto/rsa/rsa_ossl.c" 3 4
                        ((void *)0)
# 192 "../crypto/rsa/rsa_ossl.c"
                            ) {
        ...
        if (!CRYPTO_THREAD_write_lock(rsa->lock))
            return 
# 201 "../crypto/rsa/rsa_ossl.c" 3 4
                  ((void *)0)
# 201 "../crypto/rsa/rsa_ossl.c"
                      ;
        if (rsa->blinding == 
# 202 "../crypto/rsa/rsa_ossl.c" 3 4
                            ((void *)0)
# 202 "../crypto/rsa/rsa_ossl.c"
                                )
    ...
    ret = rsa->blinding;
    if (ret == 
# 207 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 207 "../crypto/rsa/rsa_ossl.c"
                  )
        goto err;
    ...
    if (BN_BLINDING_is_current_thread(ret)) {
        ...
        *local = 0;
        ...
        if (rsa->mt_blinding == 
# 224 "../crypto/rsa/rsa_ossl.c" 3 4
                               ((void *)0)
# 224 "../crypto/rsa/rsa_ossl.c"
                                   ) {
            CRYPTO_THREAD_unlock(rsa->lock);
            if (!CRYPTO_THREAD_write_lock(rsa->lock))
                return 
# 227 "../crypto/rsa/rsa_ossl.c" 3 4
                      ((void *)0)
# 227 "../crypto/rsa/rsa_ossl.c"
                          ;
            if (rsa->mt_blinding == 
# 228 "../crypto/rsa/rsa_ossl.c" 3 4
                                   ((void *)0)
# 228 "../crypto/rsa/rsa_ossl.c"
                                       )
...
{
    if (unblind == 
# 242 "../crypto/rsa/rsa_ossl.c" 3 4
                  ((void *)0)
# 242 "../crypto/rsa/rsa_ossl.c"
                      ) {



        return BN_BLINDING_convert_ex(f, 
# 246 "../crypto/rsa/rsa_ossl.c" 3 4
                                        ((void *)0)
# 246 "../crypto/rsa/rsa_ossl.c"
                                            , b, ctx);
    } else {
                                   ...
                                   unsigned char *to, RSA *rsa, int padding)
{
    ...
    int i, num = 0, r = -1;
    unsigned char *buf = 
# 284 "../crypto/rsa/rsa_ossl.c" 3 4
                        ((void *)0)
# 284 "../crypto/rsa/rsa_ossl.c"
                            ;
    BN_CTX *ctx = 
# 285 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0)
# 285 "../crypto/rsa/rsa_ossl.c"
                     ;
    ...
    BIGNUM *unblind = 
# 292 "../crypto/rsa/rsa_ossl.c" 3 4
                     ((void *)0)
# 292 "../crypto/rsa/rsa_ossl.c"
                         ;
    BN_BLINDING *blinding = 
# 293 "../crypto/rsa/rsa_ossl.c" 3 4
                           ((void *)0)
# 293 "../crypto/rsa/rsa_ossl.c"
                               ;

    if ((ctx = BN_CTX_new_ex(rsa->libctx)) == 
# 295 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 295 "../crypto/rsa/rsa_ossl.c"
                                                 )
        goto err;
    BN_CTX_start(ctx);
    f = BN_CTX_get(ctx);
    ret = BN_CTX_get(ctx);
    num = ((BN_num_bits(rsa->n)+7)/8);
    buf = CRYPTO_malloc(num, "../crypto/rsa/rsa_ossl.c", 301);
    if (ret == 
# 302 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0) 
...
# 302 "../crypto/rsa/rsa_ossl.c"
    ...
    case 3:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",316,__func__), ERR_set_error)((4),(118),
# 316 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 316 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    if (i <= 0)
    ...
    if (BN_bin2bn(buf, num, f) == 
# 322 "../crypto/rsa/rsa_ossl.c" 3 4
                                 ((void *)0)
# 322 "../crypto/rsa/rsa_ossl.c"
                                     )
        goto err;

    if (BN_ucmp(f, rsa->n) >= 0) {

        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",327,__func__), ERR_set_error)((4),(132),
# 327 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 327 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    if (!(rsa->flags & 0x0080)) {
        ...
        if (blinding == 
# 338 "../crypto/rsa/rsa_ossl.c" 3 4
                       ((void *)0)
# 338 "../crypto/rsa/rsa_ossl.c"
                           ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",339,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 339 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 339 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
    }
    ...
    if (blinding != 
# 344 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 344 "../crypto/rsa/rsa_ossl.c"
                       ) {
        if (!local_blinding && ((unblind = BN_CTX_get(ctx)) == 
# 345 "../crypto/rsa/rsa_ossl.c" 3 4
                                                              ((void *)0)
# 345 "../crypto/rsa/rsa_ossl.c"
                                                                  )) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",346,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 346 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 346 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
    ...
    if ((rsa->flags & 0x0020) ||
        (rsa->version == 1) ||
        ((rsa->p != 
# 355 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 355 "../crypto/rsa/rsa_ossl.c"
                       ) &&
         (rsa->q != 
# 356 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 356 "../crypto/rsa/rsa_ossl.c"
                       ) &&
         (rsa->dmp1 != 
# 357 "../crypto/rsa/rsa_ossl.c" 3 4
                      ((void *)0)
# 357 "../crypto/rsa/rsa_ossl.c"
                          ) && (rsa->dmq1 != 
# 357 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 357 "../crypto/rsa/rsa_ossl.c"
...
# 357 "../crypto/rsa/rsa_ossl.c"
        ...
        BIGNUM *d = BN_new();
        if (d == 
# 362 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 362 "../crypto/rsa/rsa_ossl.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",363,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 363 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 363 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
        if (rsa->d == 
# 366 "../crypto/rsa/rsa_ossl.c" 3 4
                     ((void *)0)
# 366 "../crypto/rsa/rsa_ossl.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",367,__func__), ERR_set_error)((4),(179),
# 367 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 367 "../crypto/rsa/rsa_ossl.c"
           );
            BN_free(d);
            goto err;
        }
        BN_with_flags(d, rsa->d, 0x04);
 ...
 err:
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_clear_free(buf, num, "../crypto/rsa/rsa_ossl.c", 405);
    return r;
}
                      ...
                      unsigned char *buf, int num, unsigned char *kdk)
{
    int ret = 0;
    HMAC_CTX *hmac = 
# 413 "../crypto/rsa/rsa_ossl.c" 3 4
                    ((void *)0)
# 413 "../crypto/rsa/rsa_ossl.c"
                        ;
    EVP_MD *md = 
# 414 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 414 "../crypto/rsa/rsa_ossl.c"
                    ;
    unsigned int md_len = 32;
    unsigned char d_hash[32] = {0};
    ...
    if (d == 
# 423 "../crypto/rsa/rsa_ossl.c" 3 4
            ((void *)0)
# 423 "../crypto/rsa/rsa_ossl.c"
                ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",424,__func__), ERR_set_error)((4),((15 | (0x2 << 18L))),
# 424 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 424 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    if (rsa->d == 
# 427 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0)
# 427 "../crypto/rsa/rsa_ossl.c"
                     ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",428,__func__), ERR_set_error)((4),(179),
# 428 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 428 "../crypto/rsa/rsa_ossl.c"
       );
        BN_free(d);
        goto err;
    }
    ...
    if (BN_bn2binpad(d, buf, num) < 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",434,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 434 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 434 "../crypto/rsa/rsa_ossl.c"
       );
        BN_free(d);
        goto err;
    }
    BN_free(d);
# 447 "../crypto/rsa/rsa_ossl.c"
    md = EVP_MD_fetch(rsa->libctx, "sha256", 
# 447 "../crypto/rsa/rsa_ossl.c" 3 4
                                            ((void *)0)
# 447 "../crypto/rsa/rsa_ossl.c"
                                                );
    if (md == 
# 448 "../crypto/rsa/rsa_ossl.c" 3 4
             ((void *)0)
# 448 "../crypto/rsa/rsa_ossl.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",449,__func__), ERR_set_error)((4),((269|(0x2 << 18L))),
# 449 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 449 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }

    if (EVP_Digest(buf, num, d_hash, 
# 453 "../crypto/rsa/rsa_ossl.c" 3 4
                                    ((void *)0)
# 453 "../crypto/rsa/rsa_ossl.c"
                                        , md, 
# 453 "../crypto/rsa/rsa_ossl.c" 3 4
                                              ((void *)0)
# 453 "../crypto/rsa/rsa_ossl.c"
                                                  ) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",454,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 454 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 454 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    hmac = HMAC_CTX_new();
    if (hmac == 
# 459 "../crypto/rsa/rsa_ossl.c" 3 4
               ((void *)0)
# 459 "../crypto/rsa/rsa_ossl.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",460,__func__), ERR_set_error)((4),((15 | (0x2 << 18L))),
# 460 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 460 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }

    if (HMAC_Init_ex(hmac, d_hash, sizeof(d_hash), md, 
# 464 "../crypto/rsa/rsa_ossl.c" 3 4
                                                      ((void *)0)
# 464 "../crypto/rsa/rsa_ossl.c"
                                                          ) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",465,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 465 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 465 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    if (flen < num) {
        ...
        if (HMAC_Update(hmac, buf, num - flen) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",472,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 472 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 472 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
    }
    if (HMAC_Update(hmac, from, flen) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",477,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 477 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 477 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    if (HMAC_Final(hmac, kdk, &md_len) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",483,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 483 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 483 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ret = 1;
                                   ...
                                   unsigned char *to, RSA *rsa, int padding)
{
    ...
    int j, num = 0, r = -1;
    unsigned char *buf = 
# 499 "../crypto/rsa/rsa_ossl.c" 3 4
                        ((void *)0)
# 499 "../crypto/rsa/rsa_ossl.c"
                            ;
    unsigned char kdk[32] = {0};
    BN_CTX *ctx = 
# 501 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0)
# 501 "../crypto/rsa/rsa_ossl.c"
                     ;
    int local_blinding = 0;
    ...
    BIGNUM *unblind = 
# 508 "../crypto/rsa/rsa_ossl.c" 3 4
                     ((void *)0)
# 508 "../crypto/rsa/rsa_ossl.c"
                         ;
    BN_BLINDING *blinding = 
# 509 "../crypto/rsa/rsa_ossl.c" 3 4
                           ((void *)0)
# 509 "../crypto/rsa/rsa_ossl.c"
                               ;




    if ((rsa->flags & 0x0020) && (padding == 1))
        padding = 8;

    if ((ctx = BN_CTX_new_ex(rsa->libctx)) == 
# 517 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 517 "../crypto/rsa/rsa_ossl.c"
                                                 )
        goto err;
    BN_CTX_start(ctx);
    f = BN_CTX_get(ctx);
    ret = BN_CTX_get(ctx);
    if (ret == 
# 522 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 522 "../crypto/rsa/rsa_ossl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",523,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 523 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 523 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    num = ((BN_num_bits(rsa->n)+7)/8);
    buf = CRYPTO_malloc(num, "../crypto/rsa/rsa_ossl.c", 527);
    if (buf == 
# 528 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 528 "../crypto/rsa/rsa_ossl.c"
                  )
        goto err;
    ...
    if (flen > num) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",536,__func__), ERR_set_error)((4),(108),
# 536 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 536 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }

    if (flen < 1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",541,__func__), ERR_set_error)((4),(111),
# 541 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 541 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
...
# 546 "../crypto/rsa/rsa_ossl.c" 3 4
                                        ((void *)0)
# 546 "../crypto/rsa/rsa_ossl.c"
                                            )
        goto err;

    if (BN_ucmp(f, rsa->n) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",550,__func__), ERR_set_error)((4),(132),
# 550 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 550 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    if (!(rsa->flags & 0x0080)) {
        blinding = rsa_get_blinding(rsa, &local_blinding, ctx);
        if (blinding == 
# 561 "../crypto/rsa/rsa_ossl.c" 3 4
                       ((void *)0)
# 561 "../crypto/rsa/rsa_ossl.c"
                           ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",562,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 562 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 562 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
    }
    ...
    if (blinding != 
# 567 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 567 "../crypto/rsa/rsa_ossl.c"
                       ) {
        if (!local_blinding && ((unblind = BN_CTX_get(ctx)) == 
# 568 "../crypto/rsa/rsa_ossl.c" 3 4
                                                              ((void *)0)
# 568 "../crypto/rsa/rsa_ossl.c"
                                                                  )) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",569,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 569 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 569 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
        if (!rsa_blinding_convert(blinding, f, unblind, ctx))
    ...
    if ((rsa->flags & 0x0020) ||
        (rsa->version == 1) ||
        ((rsa->p != 
# 579 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 579 "../crypto/rsa/rsa_ossl.c"
                       ) &&
         (rsa->q != 
# 580 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 580 "../crypto/rsa/rsa_ossl.c"
                       ) &&
         (rsa->dmp1 != 
# 581 "../crypto/rsa/rsa_ossl.c" 3 4
                      ((void *)0)
# 581 "../crypto/rsa/rsa_ossl.c"
                          ) && (rsa->dmq1 != 
# 581 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 581 "../crypto/rsa/rsa_ossl.c"
...
# 581 "../crypto/rsa/rsa_ossl.c"
        ...
        BIGNUM *d = BN_new();
        if (d == 
# 586 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 586 "../crypto/rsa/rsa_ossl.c"
                    ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",587,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 587 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 587 "../crypto/rsa/rsa_ossl.c"
           );
            goto err;
        }
        if (rsa->d == 
# 590 "../crypto/rsa/rsa_ossl.c" 3 4
                     ((void *)0)
# 590 "../crypto/rsa/rsa_ossl.c"
                         ) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",591,__func__), ERR_set_error)((4),(179),
# 591 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 591 "../crypto/rsa/rsa_ossl.c"
           );
            BN_free(d);
            goto err;
        }
...
# 630 "../crypto/rsa/rsa_ossl.c" 3 4
                                                              ((void *)0)
# 630 "../crypto/rsa/rsa_ossl.c"
                                                                  , 0);
        break;
    case 3:
        memcpy(to, buf, (r = j));
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",636,__func__), ERR_set_error)((4),(118),
# 636 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 636 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",645,__func__), ERR_set_error)((4),(114),
# 645 "../crypto/rsa/rsa_ossl.c" 3 4
   ((void *)0)
# 645 "../crypto/rsa/rsa_ossl.c"
   );
 ...
 err:
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_clear_free(buf, num, "../crypto/rsa/rsa_ossl.c", 652);
    return r;
}
                                  ...
                                  unsigned char *to, RSA *rsa, int padding)
{
    ...
    int i, num = 0, r = -1;
    unsigned char *buf = 
# 662 "../crypto/rsa/rsa_ossl.c" 3 4
                        ((void *)0)
# 662 "../crypto/rsa/rsa_ossl.c"
                            ;
    BN_CTX *ctx = 
# 663 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0)
# 663 "../crypto/rsa/rsa_ossl.c"
                     ;

    if (BN_num_bits(rsa->n) > 16384) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",666,__func__), ERR_set_error)((4),(105),
# 666 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 666 "../crypto/rsa/rsa_ossl.c"
       );
        return -1;
    }

    if (BN_ucmp(rsa->n, rsa->e) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",671,__func__), ERR_set_error)((4),(101),
# 671 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 671 "../crypto/rsa/rsa_ossl.c"
       );
        return -1;
    }
    ...
    if (BN_num_bits(rsa->n) > 3072) {
        if (BN_num_bits(rsa->e) > 64) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",678,__func__), ERR_set_error)((4),(101),
# 678 "../crypto/rsa/rsa_ossl.c" 3 4
           ((void *)0)
# 678 "../crypto/rsa/rsa_ossl.c"
           );
            return -1;
        }
    }
    ...
    if ((ctx = BN_CTX_new_ex(rsa->libctx)) == 
# 683 "../crypto/rsa/rsa_ossl.c" 3 4
                                             ((void *)0)
# 683 "../crypto/rsa/rsa_ossl.c"
                                                 )
        goto err;
    BN_CTX_start(ctx);
    f = BN_CTX_get(ctx);
    ret = BN_CTX_get(ctx);
    if (ret == 
# 688 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 688 "../crypto/rsa/rsa_ossl.c"
                  ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",689,__func__), ERR_set_error)((4),((3 | (0x2 << 18L))),
# 689 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 689 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    num = ((BN_num_bits(rsa->n)+7)/8);
    buf = CRYPTO_malloc(num, "../crypto/rsa/rsa_ossl.c", 693);
    if (buf == 
# 694 "../crypto/rsa/rsa_ossl.c" 3 4
              ((void *)0)
# 694 "../crypto/rsa/rsa_ossl.c"
                  )
        goto err;
    ...
    if (flen > num) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",702,__func__), ERR_set_error)((4),(108),
# 702 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 702 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }

    if (BN_bin2bn(from, flen, f) == 
# 706 "../crypto/rsa/rsa_ossl.c" 3 4
                                   ((void *)0)
# 706 "../crypto/rsa/rsa_ossl.c"
                                       )
        goto err;

    if (BN_ucmp(f, rsa->n) >= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",710,__func__), ERR_set_error)((4),(132),
# 710 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 710 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    ...
    if ((padding == 5) && ((bn_get_words(ret)[0] & 0xf) != 12))
    ...
    case 3:
        ...
        break;
    default:
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",742,__func__), ERR_set_error)((4),(118),
# 742 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 742 "../crypto/rsa/rsa_ossl.c"
       );
        goto err;
    }
    if (r < 0)
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_ossl.c",746,__func__), ERR_set_error)((4),(114),
# 746 "../crypto/rsa/rsa_ossl.c" 3 4
       ((void *)0)
# 746 "../crypto/rsa/rsa_ossl.c"
       );

 err:
    BN_CTX_end(ctx);
    BN_CTX_free(ctx);
    CRYPTO_clear_free(buf, num, "../crypto/rsa/rsa_ossl.c", 751);
    return r;
}
...
static int rsa_ossl_mod_exp(BIGNUM *r0, const BIGNUM *I, RSA *rsa, BN_CTX *ctx)
{
    ...
    vrfy = BN_CTX_get(ctx);
    if (vrfy == 
# 773 "../crypto/rsa/rsa_ossl.c" 3 4
               ((void *)0)
# 773 "../crypto/rsa/rsa_ossl.c"
                   )
        goto err;
    ...
    if (rsa->flags & 0x0004) {
        ...
        if (factor == 
# 786 "../crypto/rsa/rsa_ossl.c" 3 4
                     ((void *)0)
# 786 "../crypto/rsa/rsa_ossl.c"
                         )
            goto err;
        ...
        if (!(BN_with_flags(factor, rsa->p, 0x04),
              BN_MONT_CTX_set_locked(&rsa->_method_mod_p, rsa->lock,
                                     factor, ctx))
            || !(BN_with_flags(factor, rsa->q, 0x04),
        ...
        for (i = 0; i < ex_primes; i++) {
            ...
            BN_with_flags(factor, pinfo->r, 0x04);
...

    {
        BIGNUM *c = BN_new();
        if (c == 
# 878 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 878 "../crypto/rsa/rsa_ossl.c"
                    )
            goto err;
        BN_with_flags(c, I, 0x04);

        if (!BN_div(
# 882 "../crypto/rsa/rsa_ossl.c" 3 4
            ((void *)0)
# 882 "../crypto/rsa/rsa_ossl.c"
            ,(r1),(c),(rsa->q),(ctx))) {
            BN_free(c);
            goto err;
        }

        {
            BIGNUM *dmq1 = BN_new();
            if (dmq1 == 
# 889 "../crypto/rsa/rsa_ossl.c" 3 4
                       ((void *)0)
# 889 "../crypto/rsa/rsa_ossl.c"
                           ) {
                BN_free(c);
                goto err;
            }
            BN_with_flags(dmq1, rsa->dmq1, 0x04);
        ...
        if (!BN_div(
# 907 "../crypto/rsa/rsa_ossl.c" 3 4
            ((void *)0)
# 907 "../crypto/rsa/rsa_ossl.c"
            ,(r1),(c),(rsa->p),(ctx))) {
            BN_free(c);
            goto err;
        }
...

    {
        BIGNUM *dmp1 = BN_new();
        if (dmp1 == 
# 917 "../crypto/rsa/rsa_ossl.c" 3 4
                   ((void *)0)
# 917 "../crypto/rsa/rsa_ossl.c"
                       )
            goto err;
        BN_with_flags(dmp1, rsa->dmp1, 0x04);
    ...
    if (ex_primes > 0) {
        ...
        if (cc == 
# 935 "../crypto/rsa/rsa_ossl.c" 3 4
                 ((void *)0) 
# 935 "../crypto/rsa/rsa_ossl.c"
                      || di == 
# 935 "../crypto/rsa/rsa_ossl.c" 3 4
                               ((void *)0)
# 935 "../crypto/rsa/rsa_ossl.c"
        ...
        for (i = 0; i < ex_primes; i++) {
            ...
            if ((m[i] = BN_CTX_get(ctx)) == 
# 943 "../crypto/rsa/rsa_ossl.c" 3 4
                                           ((void *)0)
# 943 "../crypto/rsa/rsa_ossl.c"
                                               ) {
                BN_free(cc);
                BN_free(di);
                goto err;
            ...
            BN_with_flags(cc, I, 0x04);
            BN_with_flags(di, pinfo->d, 0x04);

            if (!BN_div(
# 955 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 955 "../crypto/rsa/rsa_ossl.c"
                ,(r1),(cc),(pinfo->r),(ctx))) {
                BN_free(cc);
                BN_free(di);
                goto err;
...

    {
        BIGNUM *pr1 = BN_new();
        if (pr1 == 
# 988 "../crypto/rsa/rsa_ossl.c" 3 4
                  ((void *)0)
# 988 "../crypto/rsa/rsa_ossl.c"
                      )
            goto err;
        BN_with_flags(pr1, r1, 0x04);

        if (!BN_div(
# 992 "../crypto/rsa/rsa_ossl.c" 3 4
            ((void *)0)
# 992 "../crypto/rsa/rsa_ossl.c"
            ,(r0),(pr1),(rsa->p),(ctx))) {
            BN_free(pr1);
            goto err;
        }
...
# 1007 "../crypto/rsa/rsa_ossl.c"
    ...
    if (ex_primes > 0) {
        ...
        if (pr2 == 
# 1020 "../crypto/rsa/rsa_ossl.c" 3 4
                  ((void *)0)
# 1020 "../crypto/rsa/rsa_ossl.c"
                      )
            goto err;
        ...
        for (i = 0; i < ex_primes; i++) {
            ...
            BN_with_flags(pr2, r2, 0x04);

            if (!BN_div(
# 1037 "../crypto/rsa/rsa_ossl.c" 3 4
                ((void *)0)
# 1037 "../crypto/rsa/rsa_ossl.c"
                ,(r1),(pr2),(pinfo->r),(ctx))) {
                BN_free(pr2);
                goto err;
            }
 ...
 tail:
    if (rsa->e && rsa->n) {
        ...
        if (!BN_div(
# 1085 "../crypto/rsa/rsa_ossl.c" 3 4
            ((void *)0)
# 1085 "../crypto/rsa/rsa_ossl.c"
            ,(vrfy),(vrfy),(rsa->n),(ctx)))
            goto err;
        ...
        if (!BN_is_zero(vrfy)) {
            ...
            BIGNUM *d = BN_new();
            if (d == 
# 1098 "../crypto/rsa/rsa_ossl.c" 3 4
                    ((void *)0)
# 1098 "../crypto/rsa/rsa_ossl.c"
                        )
                goto err;
            BN_with_flags(d, rsa->d, 0x04);
