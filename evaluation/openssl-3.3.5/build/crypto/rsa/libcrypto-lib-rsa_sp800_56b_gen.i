# 0 "../crypto/rsa/rsa_sp800_56b_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_sp800_56b_gen.c"
# 11 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
# 12 "../crypto/rsa/rsa_sp800_56b_gen.c" 2
...
# 13 "../crypto/rsa/rsa_sp800_56b_gen.c" 2
...
# 15 "../crypto/rsa/rsa_sp800_56b_gen.c" 2
...
int RAND_poll(void);
# 16 "../crypto/rsa/rsa_sp800_56b_gen.c" 2
...
int ossl_rsa_padding_add_PKCS1_type_2_ex(OSSL_LIB_CTX *libctx, unsigned char *to,
                                         ...
                                         int flen);
# 19 "../crypto/rsa/rsa_sp800_56b_gen.c" 2
# 55 "../crypto/rsa/rsa_sp800_56b_gen.c"
int ossl_rsa_fips186_4_gen_prob_primes(RSA *rsa, void *test,
                                       int nbits, const BIGNUM *e, BN_CTX *ctx,
                                       BN_GENCB *cb)
{
    ...
    BIGNUM *Xpo = 
# 61 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 61 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     , *Xqo = 
# 61 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                              ((void *)0)
# 61 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
# 61 "../crypto/rsa/rsa_sp800_56b_gen.c"
    ...
    BIGNUM *p1 = 
# 63 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 63 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    , *p2 = 
# 63 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                            ((void *)0)
# 63 "../crypto/rsa/rsa_sp800_56b_gen.c"
                                ;
    BIGNUM *q1 = 
# 64 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 64 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    , *q2 = 
# 64 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                            ((void *)0)
# 64 "../crypto/rsa/rsa_sp800_56b_gen.c"
    ...
    BIGNUM *Xp = 
# 66 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 66 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    , *Xp1 = 
# 66 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                             ((void *)0)
# 66 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
# 66 "../crypto/rsa/rsa_sp800_56b_gen.c"
                                              ;
    BIGNUM *Xq = 
# 67 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 67 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    , *Xq1 = 
# 67 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                             ((void *)0)
# 67 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
# 67 "../crypto/rsa/rsa_sp800_56b_gen.c"
                                              ;
# 88 "../crypto/rsa/rsa_sp800_56b_gen.c"
    if (nbits < 2048) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_gen.c",89,__func__), ERR_set_error)((4),(120),
# 89 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
       ((void *)0)
# 89 "../crypto/rsa/rsa_sp800_56b_gen.c"
       );
        return 0;
    }

    if (!ossl_rsa_check_public_exponent(e)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_gen.c",94,__func__), ERR_set_error)((4),(178),
# 94 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
       ((void *)0)
# 94 "../crypto/rsa/rsa_sp800_56b_gen.c"
       );
        return 0;
    }
    ...
    Xqo = BN_CTX_get(ctx);
    if (tmp == 
# 107 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0) 
# 107 "../crypto/rsa/rsa_sp800_56b_gen.c"
                   || Xpo == 
# 107 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                             ((void *)0) 
# 107 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
# 107 "../crypto/rsa/rsa_sp800_56b_gen.c"
        ...
        goto err;
    BN_set_flags(Xpo, 0x04);
    BN_set_flags(Xqo, 0x04);

    if (rsa->p == 
# 112 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 112 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     )
        rsa->p = BN_secure_new();
    if (rsa->q == 
# 114 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 114 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     )
        rsa->q = BN_secure_new();
    if (rsa->p == 
# 116 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0) 
# 116 "../crypto/rsa/rsa_sp800_56b_gen.c"
                      || rsa->q == 
# 116 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                                   ((void *)0)
# 116 "../crypto/rsa/rsa_sp800_56b_gen.c"
...
err:
    ...
    if (Xpo != 
# 150 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0)
# 150 "../crypto/rsa/rsa_sp800_56b_gen.c"
                  )
        BN_clear(Xpo);
    if (Xqo != 
# 152 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0)
# 152 "../crypto/rsa/rsa_sp800_56b_gen.c"
                  )
        BN_clear(Xqo);
    BN_clear(tmp);
...
# 170 "../crypto/rsa/rsa_sp800_56b_gen.c"
int ossl_rsa_sp800_56b_validate_strength(int nbits, int strength)
{
    ...
    if (strength != -1 && s != strength) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_gen.c",181,__func__), ERR_set_error)((4),(176),
# 181 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
       ((void *)0)
# 181 "../crypto/rsa/rsa_sp800_56b_gen.c"
       );
        return 0;
    }
    return 1;
...
{
    if (rng == 
# 193 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0)
# 193 "../crypto/rsa/rsa_sp800_56b_gen.c"
                  )
        return 0;
# 206 "../crypto/rsa/rsa_sp800_56b_gen.c"
    return 1;
}
# 233 "../crypto/rsa/rsa_sp800_56b_gen.c"
int ossl_rsa_sp800_56b_derive_params_from_pq(RSA *rsa, int nbits,
                                             const BIGNUM *e, BN_CTX *ctx)
{
    int ret = -1;
    ...
    gcd = BN_CTX_get(ctx);
    if (gcd == 
# 244 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0)
# 244 "../crypto/rsa/rsa_sp800_56b_gen.c"
                  )
        goto err;
    ...
    if (e != 
# 260 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
            ((void *)0)
# 260 "../crypto/rsa/rsa_sp800_56b_gen.c"
                ) {

        BN_free(rsa->e);
        rsa->e = BN_dup(e);
        if (rsa->e == 
# 264 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                     ((void *)0)
# 264 "../crypto/rsa/rsa_sp800_56b_gen.c"
                         )
            goto err;
        ...
        rsa->d = BN_secure_new();
        if (rsa->d == 
# 270 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                     ((void *)0)
# 270 "../crypto/rsa/rsa_sp800_56b_gen.c"
                         )
            goto err;
        BN_set_flags(rsa->d, 0x04);
        if (BN_mod_inverse(rsa->d, e, lcm, ctx) == 
# 273 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                                                  ((void *)0)
# 273 "../crypto/rsa/rsa_sp800_56b_gen.c"
                                                      )
            goto err;
        ...
        if (rsa->n == 
# 283 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                     ((void *)0)
# 283 "../crypto/rsa/rsa_sp800_56b_gen.c"
                         )
            rsa->n = BN_new();
        if (rsa->n == 
# 285 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                     ((void *)0) 
# 285 "../crypto/rsa/rsa_sp800_56b_gen.c"
    ...
    if (rsa->dmp1 == 
# 290 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                    ((void *)0)
# 290 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        )
        rsa->dmp1 = BN_secure_new();
    if (rsa->dmp1 == 
# 292 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                    ((void *)0)
# 292 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        )
        goto err;
    BN_set_flags(rsa->dmp1, 0x04);
    if (!BN_div(
# 295 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
        ((void *)0)
# 295 "../crypto/rsa/rsa_sp800_56b_gen.c"
        ,(rsa->dmp1),(rsa->d),(p1),(ctx)))
        goto err;


    if (rsa->dmq1 == 
# 299 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                    ((void *)0)
# 299 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        )
        rsa->dmq1 = BN_secure_new();
    if (rsa->dmq1 == 
# 301 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                    ((void *)0)
# 301 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        )
        goto err;
    BN_set_flags(rsa->dmq1, 0x04);
    if (!BN_div(
# 304 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
        ((void *)0)
# 304 "../crypto/rsa/rsa_sp800_56b_gen.c"
        ,(rsa->dmq1),(rsa->d),(q1),(ctx)))
        goto err;
    ...
    if (rsa->iqmp == 
# 310 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                    ((void *)0)
# 310 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        )
        goto err;
    BN_set_flags(rsa->iqmp, 0x04);
    if (BN_mod_inverse(rsa->iqmp, rsa->q, rsa->p, ctx) == 
# 313 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                                                         ((void *)0)
# 313 "../crypto/rsa/rsa_sp800_56b_gen.c"
                                                             )
        goto err;
...
err:
    if (ret != 1) {
        BN_free(rsa->e);
        rsa->e = 
# 321 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 321 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    ;
        BN_free(rsa->d);
        rsa->d = 
# 323 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 323 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    ;
        BN_free(rsa->n);
        rsa->n = 
# 325 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0)
# 325 "../crypto/rsa/rsa_sp800_56b_gen.c"
                    ;
        BN_free(rsa->iqmp);
        rsa->iqmp = 
# 327 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                   ((void *)0)
# 327 "../crypto/rsa/rsa_sp800_56b_gen.c"
                       ;
        BN_free(rsa->dmq1);
        rsa->dmq1 = 
# 329 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                   ((void *)0)
# 329 "../crypto/rsa/rsa_sp800_56b_gen.c"
                       ;
        BN_free(rsa->dmp1);
        rsa->dmp1 = 
# 331 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                   ((void *)0)
# 331 "../crypto/rsa/rsa_sp800_56b_gen.c"
                       ;
    }
    BN_clear(p1);
    BN_clear(q1);
...
# 361 "../crypto/rsa/rsa_sp800_56b_gen.c"
int ossl_rsa_sp800_56b_generate_key(RSA *rsa, int nbits, const BIGNUM *efixed,
                                    BN_GENCB *cb)
{
    int ret = 0;
    int ok;
    BN_CTX *ctx = 
# 366 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 366 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     ;
    BIGNUM *e = 
# 367 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
               ((void *)0)
# 367 "../crypto/rsa/rsa_sp800_56b_gen.c"
                   ;
    void *info = 
# 368 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                         ((void *)0)
# 368 "../crypto/rsa/rsa_sp800_56b_gen.c"
                             ;
    BIGNUM *tmp;
   ...
   if (!rsa_validate_rng_strength(RAND_get0_private(rsa->libctx), nbits))
    ...
    if (ctx == 
# 384 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
              ((void *)0)
# 384 "../crypto/rsa/rsa_sp800_56b_gen.c"
                  )
        return 0;


    if (efixed == 
# 388 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 388 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     ) {
        e = BN_new();
        if (e == 
# 390 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                ((void *)0) 
# 390 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     || !BN_set_word(e, 65537))
            goto err;
    } else {
        e = (BIGNUM *)efixed;
    ...
    for (;;) {
        ...
        if (info == 
# 403 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                   ((void *)0) 
# 403 "../crypto/rsa/rsa_sp800_56b_gen.c"
                        && BN_cmp(rsa->p, rsa->q) < 0) {
            tmp = rsa->p;
            rsa->p = rsa->q;
            rsa->q = tmp;
        }
...
err:
    if (efixed == 
# 421 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
                 ((void *)0)
# 421 "../crypto/rsa/rsa_sp800_56b_gen.c"
                     )
        BN_free(e);
    BN_CTX_free(ctx);
    return ret;
...
int ossl_rsa_sp800_56b_pairwise_test(RSA *rsa, BN_CTX *ctx)
{
    ...
    k = BN_CTX_get(ctx);
    if (k == 
# 441 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
            ((void *)0)
# 441 "../crypto/rsa/rsa_sp800_56b_gen.c"
                )
        goto err;
    BN_set_flags(k, 0x04);
    ...
    ret = (BN_set_word(k, 2)
           ...
           && BN_cmp(k, tmp) == 0);
    if (ret == 0)
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_sp800_56b_gen.c",450,__func__), ERR_set_error)((4),(177),
# 450 "../crypto/rsa/rsa_sp800_56b_gen.c" 3 4
       ((void *)0)
# 450 "../crypto/rsa/rsa_sp800_56b_gen.c"
       );
err:
    BN_CTX_end(ctx);
    return ret;
