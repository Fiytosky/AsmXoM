# 0 "../crypto/rsa/rsa_pss.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_pss.c"
# 14 "../crypto/rsa/rsa_pss.c"
...
# 35 "../crypto/rsa/rsa_pss.c" 3 4
                                                      ((void *)0)
# 35 "../crypto/rsa/rsa_pss.c"
                                                          , EM, sLen);
}
                              ...
                              const unsigned char *EM, int sLen)
{
    ...
    unsigned char *DB = 
# 46 "../crypto/rsa/rsa_pss.c" 3 4
                       ((void *)0)
# 46 "../crypto/rsa/rsa_pss.c"
                           ;
    EVP_MD_CTX *ctx = EVP_MD_CTX_new();
    unsigned char H_[64];

    if (ctx == 
# 50 "../crypto/rsa/rsa_pss.c" 3 4
              ((void *)0)
# 50 "../crypto/rsa/rsa_pss.c"
                  )
        goto err;

    if (mgf1Hash == 
# 53 "../crypto/rsa/rsa_pss.c" 3 4
                   ((void *)0)
# 53 "../crypto/rsa/rsa_pss.c"
                       )
        mgf1Hash = Hash;
    ...
    if (hLen < 0)
        goto err;
# 67 "../crypto/rsa/rsa_pss.c"
    if (sLen == -1) {
        sLen = hLen;
    } else if (sLen < -4) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",70,__func__), ERR_set_error)((4),(136),
# 70 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 70 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    ...
    emLen = RSA_size(rsa);
    if (EM[0] & (0xFF << MSBits)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",77,__func__), ERR_set_error)((4),(133),
# 77 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 77 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (MSBits == 0) {
    ...
    if (emLen < hLen + 2) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",85,__func__), ERR_set_error)((4),(109),
# 85 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 85 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (sLen == -3) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",91,__func__), ERR_set_error)((4),(109),
# 91 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 91 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (EM[emLen - 1] != 0xbc) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",95,__func__), ERR_set_error)((4),(134),
# 95 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 95 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    maskedDBLen = emLen - hLen - 1;
    H = EM + maskedDBLen;
    DB = CRYPTO_malloc(maskedDBLen, "../crypto/rsa/rsa_pss.c", 100);
    if (DB == 
# 101 "../crypto/rsa/rsa_pss.c" 3 4
             ((void *)0)
# 101 "../crypto/rsa/rsa_pss.c"
                 )
        goto err;
    ...
    if (DB[i++] != 0x1) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",111,__func__), ERR_set_error)((4),(135),
# 111 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 111 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (sLen != -2
            && sLen != -4
            && (maskedDBLen - i) != sLen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",117,__func__), ERR_set_error)(4, 136,
                       "expected: %d retrieved: %d", sLen,
                       maskedDBLen - i);
        goto err;
    }
    if (!EVP_DigestInit_ex(ctx, Hash, 
# 122 "../crypto/rsa/rsa_pss.c" 3 4
                                     ((void *)0)
# 122 "../crypto/rsa/rsa_pss.c"
                                         )
...
# 130 "../crypto/rsa/rsa_pss.c" 3 4
                                    ((void *)0)
# 130 "../crypto/rsa/rsa_pss.c"
                                        ))
        goto err;
    if (memcmp(H_, H, hLen)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",133,__func__), ERR_set_error)((4),(104),
# 133 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 133 "../crypto/rsa/rsa_pss.c"
       );
        ret = 0;
    } else {
        ret = 1;
 ...
 err:
    CRYPTO_free(DB, "../crypto/rsa/rsa_pss.c", 140);
    EVP_MD_CTX_free(ctx);
...
# 151 "../crypto/rsa/rsa_pss.c" 3 4
                                                               ((void *)0)
# 151 "../crypto/rsa/rsa_pss.c"
                                                                   , sLen);
}
...
# 162 "../crypto/rsa/rsa_pss.c" 3 4
                             ((void *)0)
# 162 "../crypto/rsa/rsa_pss.c"
                                 , *p;
    EVP_MD_CTX *ctx = 
# 163 "../crypto/rsa/rsa_pss.c" 3 4
                     ((void *)0)
# 163 "../crypto/rsa/rsa_pss.c"
                         ;
    int sLenMax = -1;

    if (mgf1Hash == 
# 166 "../crypto/rsa/rsa_pss.c" 3 4
                   ((void *)0)
# 166 "../crypto/rsa/rsa_pss.c"
                       )
        mgf1Hash = Hash;
...
# 187 "../crypto/rsa/rsa_pss.c"
    if (sLen == -1) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",196,__func__), ERR_set_error)((4),(136),
# 196 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 196 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    ...
    if (emLen < hLen + 2) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",207,__func__), ERR_set_error)((4),(110),
# 207 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 207 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (sLen == -3) {
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pss.c",215,__func__), ERR_set_error)((4),(110),
# 215 "../crypto/rsa/rsa_pss.c" 3 4
       ((void *)0)
# 215 "../crypto/rsa/rsa_pss.c"
       );
        goto err;
    }
    if (sLen > 0) {
        salt = CRYPTO_malloc(sLen, "../crypto/rsa/rsa_pss.c", 219);
        if (salt == 
# 220 "../crypto/rsa/rsa_pss.c" 3 4
                   ((void *)0)
# 220 "../crypto/rsa/rsa_pss.c"
                       )
            goto err;
    ...
    ctx = EVP_MD_CTX_new();
    if (ctx == 
# 228 "../crypto/rsa/rsa_pss.c" 3 4
              ((void *)0)
# 228 "../crypto/rsa/rsa_pss.c"
                  )
        goto err;
    if (!EVP_DigestInit_ex(ctx, Hash, 
# 230 "../crypto/rsa/rsa_pss.c" 3 4
                                     ((void *)0)
# 230 "../crypto/rsa/rsa_pss.c"
                                         )
        || !EVP_DigestUpdate(ctx, zeroes, sizeof(zeroes))
        || !EVP_DigestUpdate(ctx, mHash, hLen))
        goto err;
...
# 236 "../crypto/rsa/rsa_pss.c" 3 4
                                   ((void *)0)
# 236 "../crypto/rsa/rsa_pss.c"
                                       ))
        goto err;
 ...
 err:
    EVP_MD_CTX_free(ctx);
    CRYPTO_clear_free(salt, (size_t)sLen, "../crypto/rsa/rsa_pss.c", 266);

    return ret;

}
# 294 "../crypto/rsa/rsa_pss.c"
...
{
    if (rsa_pss_params == 
# 306 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 306 "../crypto/rsa/rsa_pss.c"
                             )
        return 0;
...
# 316 "../crypto/rsa/rsa_pss.c" 3 4
                            ((void *)0)
        
# 317 "../crypto/rsa/rsa_pss.c"
...
{
    if (rsa_pss_params == 
# 331 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 331 "../crypto/rsa/rsa_pss.c"
                             )
        return 0;
...
{
    if (rsa_pss_params == 
# 340 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 340 "../crypto/rsa/rsa_pss.c"
                             )
        return 0;
...
{
    if (rsa_pss_params == 
# 349 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 349 "../crypto/rsa/rsa_pss.c"
                             )
        return 0;
...
{
    if (rsa_pss_params == 
# 358 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 358 "../crypto/rsa/rsa_pss.c"
                             )
        return 0;
...
{
    if (rsa_pss_params == 
# 366 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 366 "../crypto/rsa/rsa_pss.c"
                             )
...
{
    if (rsa_pss_params == 
# 373 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 373 "../crypto/rsa/rsa_pss.c"
                             )
...
{
    if (rsa_pss_params == 
# 380 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 380 "../crypto/rsa/rsa_pss.c"
                             )
        return default_RSASSA_PSS_params.hash_algorithm_nid;
...
{
    if (rsa_pss_params == 
# 387 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 387 "../crypto/rsa/rsa_pss.c"
                             )
...
{
    if (rsa_pss_params == 
# 394 "../crypto/rsa/rsa_pss.c" 3 4
                         ((void *)0)
# 394 "../crypto/rsa/rsa_pss.c"
                             )
