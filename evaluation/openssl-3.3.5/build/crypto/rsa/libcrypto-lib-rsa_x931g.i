# 0 "../crypto/rsa/rsa_x931g.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_x931g.c"
# 16 "../crypto/rsa/rsa_x931g.c"
...
{
    BIGNUM *r0 = 
# 30 "../crypto/rsa/rsa_x931g.c" 3 4
                ((void *)0)
# 30 "../crypto/rsa/rsa_x931g.c"
                    , *r1 = 
# 30 "../crypto/rsa/rsa_x931g.c" 3 4
                            ((void *)0)
# 30 "../crypto/rsa/rsa_x931g.c"
...
# 30 "../crypto/rsa/rsa_x931g.c"
                                                        ;
    BN_CTX *ctx = 
# 31 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0)
# 31 "../crypto/rsa/rsa_x931g.c"
                     , *ctx2 = 
# 31 "../crypto/rsa/rsa_x931g.c" 3 4
                               ((void *)0)
# 31 "../crypto/rsa/rsa_x931g.c"
    ...
    if (rsa == 
# 34 "../crypto/rsa/rsa_x931g.c" 3 4
              ((void *)0)
# 34 "../crypto/rsa/rsa_x931g.c"
                  )
        goto err;

    ctx = BN_CTX_new_ex(rsa->libctx);
    if (ctx == 
# 38 "../crypto/rsa/rsa_x931g.c" 3 4
              ((void *)0)
# 38 "../crypto/rsa/rsa_x931g.c"
                  )
        goto err;
    BN_CTX_start(ctx);
    ...
    if (r3 == 
# 47 "../crypto/rsa/rsa_x931g.c" 3 4
             ((void *)0)
# 47 "../crypto/rsa/rsa_x931g.c"
                 )
        goto err;
    if (!rsa->e) {
        rsa->e = BN_dup(e);
    ...
    if (Xp && rsa->p == 
# 62 "../crypto/rsa/rsa_x931g.c" 3 4
                       ((void *)0)
# 62 "../crypto/rsa/rsa_x931g.c"
                           ) {
        rsa->p = BN_new();
        if (rsa->p == 
# 64 "../crypto/rsa/rsa_x931g.c" 3 4
                     ((void *)0)
# 64 "../crypto/rsa/rsa_x931g.c"
                         )
            goto err;
    ...
    if (Xq && rsa->q == 
# 72 "../crypto/rsa/rsa_x931g.c" 3 4
                       ((void *)0)
# 72 "../crypto/rsa/rsa_x931g.c"
                           ) {
        rsa->q = BN_new();
        if (rsa->q == 
# 74 "../crypto/rsa/rsa_x931g.c" 3 4
                     ((void *)0)
# 74 "../crypto/rsa/rsa_x931g.c"
                         )
            goto err;
    ...
    if (rsa->p == 
# 81 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0) 
# 81 "../crypto/rsa/rsa_x931g.c"
                      || rsa->q == 
# 81 "../crypto/rsa/rsa_x931g.c" 3 4
                                   ((void *)0)
# 81 "../crypto/rsa/rsa_x931g.c"
    ...
    rsa->n = BN_new();
    if (rsa->n == 
# 94 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0)
# 94 "../crypto/rsa/rsa_x931g.c"
                     )
        goto err;
    ...
    if (!BN_div(r0, 
# 110 "../crypto/rsa/rsa_x931g.c" 3 4
                   ((void *)0)
# 110 "../crypto/rsa/rsa_x931g.c"
                       , r0, r3, ctx))
        goto err;

    ctx2 = BN_CTX_new();
    if (ctx2 == 
# 114 "../crypto/rsa/rsa_x931g.c" 3 4
               ((void *)0)
# 114 "../crypto/rsa/rsa_x931g.c"
                   )
        goto err;

    rsa->d = BN_mod_inverse(
# 117 "../crypto/rsa/rsa_x931g.c" 3 4
                           ((void *)0)
# 117 "../crypto/rsa/rsa_x931g.c"
                               , rsa->e, r0, ctx2);
    if (rsa->d == 
# 118 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0)
# 118 "../crypto/rsa/rsa_x931g.c"
                     )
        goto err;
    ...
    rsa->dmp1 = BN_new();
    if (rsa->dmp1 == 
# 123 "../crypto/rsa/rsa_x931g.c" 3 4
                    ((void *)0)
# 123 "../crypto/rsa/rsa_x931g.c"
                        )
        goto err;
    if (!BN_div(
# 125 "../crypto/rsa/rsa_x931g.c" 3 4
        ((void *)0)
# 125 "../crypto/rsa/rsa_x931g.c"
        ,(rsa->dmp1),(rsa->d),(r1),(ctx)))
        goto err;


    rsa->dmq1 = BN_new();
    if (rsa->dmq1 == 
# 130 "../crypto/rsa/rsa_x931g.c" 3 4
                    ((void *)0)
# 130 "../crypto/rsa/rsa_x931g.c"
                        )
        goto err;
    if (!BN_div(
# 132 "../crypto/rsa/rsa_x931g.c" 3 4
        ((void *)0)
# 132 "../crypto/rsa/rsa_x931g.c"
        ,(rsa->dmq1),(rsa->d),(r2),(ctx)))
        goto err;


    rsa->iqmp = BN_mod_inverse(
# 136 "../crypto/rsa/rsa_x931g.c" 3 4
                              ((void *)0)
# 136 "../crypto/rsa/rsa_x931g.c"
                                  , rsa->q, rsa->p, ctx2);
    if (rsa->iqmp == 
# 137 "../crypto/rsa/rsa_x931g.c" 3 4
                    ((void *)0)
# 137 "../crypto/rsa/rsa_x931g.c"
                        )
        goto err;
                             ...
                             BN_GENCB *cb)
{
    int ok = 0;
    BIGNUM *Xp = 
# 154 "../crypto/rsa/rsa_x931g.c" 3 4
                ((void *)0)
# 154 "../crypto/rsa/rsa_x931g.c"
                    , *Xq = 
# 154 "../crypto/rsa/rsa_x931g.c" 3 4
                            ((void *)0)
# 154 "../crypto/rsa/rsa_x931g.c"
                                ;
    BN_CTX *ctx = 
# 155 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0)
# 155 "../crypto/rsa/rsa_x931g.c"
                     ;

    ctx = BN_CTX_new_ex(rsa->libctx);
    if (ctx == 
# 158 "../crypto/rsa/rsa_x931g.c" 3 4
              ((void *)0)
# 158 "../crypto/rsa/rsa_x931g.c"
                  )
        goto error;
    ...
    Xq = BN_CTX_get(ctx);
    if (Xq == 
# 164 "../crypto/rsa/rsa_x931g.c" 3 4
             ((void *)0)
# 164 "../crypto/rsa/rsa_x931g.c"
                 )
        goto error;
    ...
    rsa->q = BN_new();
    if (rsa->p == 
# 171 "../crypto/rsa/rsa_x931g.c" 3 4
                 ((void *)0) 
# 171 "../crypto/rsa/rsa_x931g.c"
                      || rsa->q == 
# 171 "../crypto/rsa/rsa_x931g.c" 3 4
                                   ((void *)0)
# 171 "../crypto/rsa/rsa_x931g.c"
    ...
    if (!BN_X931_generate_prime_ex(rsa->p, 
# 176 "../crypto/rsa/rsa_x931g.c" 3 4
                                          ((void *)0)
# 176 "../crypto/rsa/rsa_x931g.c"
                                              , 
# 176 "../crypto/rsa/rsa_x931g.c" 3 4
                                                ((void *)0)
# 176 "../crypto/rsa/rsa_x931g.c"
...
# 176 "../crypto/rsa/rsa_x931g.c"
    ...
    if (!BN_X931_generate_prime_ex(rsa->q, 
# 180 "../crypto/rsa/rsa_x931g.c" 3 4
                                          ((void *)0)
# 180 "../crypto/rsa/rsa_x931g.c"
                                              , 
# 180 "../crypto/rsa/rsa_x931g.c" 3 4
                                                ((void *)0)
# 180 "../crypto/rsa/rsa_x931g.c"
...
# 180 "../crypto/rsa/rsa_x931g.c"
    ...
    if (!RSA_X931_derive_ex(rsa, 
# 189 "../crypto/rsa/rsa_x931g.c" 3 4
                                ((void *)0)
# 189 "../crypto/rsa/rsa_x931g.c"
                                    , 
# 189 "../crypto/rsa/rsa_x931g.c" 3 4
                                      ((void *)0)
# 189 "../crypto/rsa/rsa_x931g.c"
...
# 190 "../crypto/rsa/rsa_x931g.c" 3 4
                           ((void *)0)
# 190 "../crypto/rsa/rsa_x931g.c"
                               , 
# 190 "../crypto/rsa/rsa_x931g.c" 3 4
                                 ((void *)0)
# 190 "../crypto/rsa/rsa_x931g.c"
