# 0 "../crypto/rsa/rsa_schemes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_schemes.c"
# 10 "../crypto/rsa/rsa_schemes.c"
...
# 11 "../crypto/rsa/rsa_schemes.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../crypto/rsa/rsa_schemes.c" 2
...
# 13 "../crypto/rsa/rsa_schemes.c" 2

# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 15 "../crypto/rsa/rsa_schemes.c" 2
                    ...
                    const OSSL_ITEM *items, size_t items_n)
{
    ...
    if (meth != 
# 23 "../crypto/rsa/rsa_schemes.c" 3 4
               ((void *)0)
# 23 "../crypto/rsa/rsa_schemes.c"
                   )
        for (i = 0; i < items_n; i++)
...
static const char *nid2name(int meth, const OSSL_ITEM *items, size_t items_n)
{
    ...
    for (i = 0; i < items_n; i++)
        if (meth == (int)items[i].id)
            return items[i].ptr;
    return 
# 37 "../crypto/rsa/rsa_schemes.c" 3 4
          ((void *)0)
# 37 "../crypto/rsa/rsa_schemes.c"
              ;
}
# 55 "../crypto/rsa/rsa_schemes.c"
...
int ossl_rsa_oaeppss_md2nid(const EVP_MD *md)
{
    return meth2nid(md, md_is_a,
                    oaeppss_name_nid_map, (sizeof(oaeppss_name_nid_map)/sizeof((oaeppss_name_nid_map)[0])));
}

const char *ossl_rsa_oaeppss_nid2name(int md)
{
    return nid2name(md, oaeppss_name_nid_map, (sizeof(oaeppss_name_nid_map)/sizeof((oaeppss_name_nid_map)[0])));
}
...
const char *ossl_rsa_mgf_nid2name(int mgf)
{
    if (mgf == 911)
        return "MGF1";
    return 
# 85 "../crypto/rsa/rsa_schemes.c" 3 4
          ((void *)0)
# 85 "../crypto/rsa/rsa_schemes.c"
              ;
}
