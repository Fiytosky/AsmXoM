# 0 "../crypto/rsa/rsa_pk1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../crypto/rsa/rsa_pk1.c"
# 14 "../crypto/rsa/rsa_pk1.c"
                                 ...
                                 const unsigned char *from, int flen)
{
    ...
    if (flen > (tlen - 11)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",39,__func__), ERR_set_error)((4),(110),
# 39 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 39 "../crypto/rsa/rsa_pk1.c"
       );
        return 0;
    }
...
# 73 "../crypto/rsa/rsa_pk1.c"
    ...
    if (num == flen) {
        if ((*p++) != 0x00) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",79,__func__), ERR_set_error)((4),(138),
# 79 "../crypto/rsa/rsa_pk1.c" 3 4
           ((void *)0)
# 79 "../crypto/rsa/rsa_pk1.c"
           );
            return -1;
        }
        flen--;
    ...
    if ((num != (flen + 1)) || (*(p++) != 0x01)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",86,__func__), ERR_set_error)((4),(106),
# 86 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 86 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
    ...
    for (i = 0; i < j; i++) {
        if (*p != 0xff) {
            if (*p == 0) {
                ...
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",98,__func__), ERR_set_error)((4),(102),
# 98 "../crypto/rsa/rsa_pk1.c" 3 4
               ((void *)0)
# 98 "../crypto/rsa/rsa_pk1.c"
               );
                return -1;
            }
        }
    ...
    if (i == j) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",106,__func__), ERR_set_error)((4),(113),
# 106 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 106 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }

    if (i < 8) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",111,__func__), ERR_set_error)((4),(103),
# 111 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 111 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
    i++;
    j -= i;
    if (j > tlen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",117,__func__), ERR_set_error)((4),(109),
# 117 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 117 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
                                         ...
                                         int flen)
{
    ...
    if (flen > (tlen - 11)) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",133,__func__), ERR_set_error)((4),(110),
# 133 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 133 "../crypto/rsa/rsa_pk1.c"
       );
        return 0;
    } else if (flen < 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",136,__func__), ERR_set_error)((4),(181),
# 136 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 136 "../crypto/rsa/rsa_pk1.c"
       );
        return 0;
    }
...
int RSA_padding_add_PKCS1_type_2(unsigned char *to, int tlen,
                                 const unsigned char *from, int flen)
{
    return ossl_rsa_padding_add_PKCS1_type_2_ex(
# 168 "../crypto/rsa/rsa_pk1.c" 3 4
                                               ((void *)0)
# 168 "../crypto/rsa/rsa_pk1.c"
                                                   , to, tlen, from, flen);
}
                                   ...
                                   int num)
{
    ...
    unsigned char *em = 
# 177 "../crypto/rsa/rsa_pk1.c" 3 4
                       ((void *)0)
# 177 "../crypto/rsa/rsa_pk1.c"
                           ;
    ...
    if (flen > num || num < 11) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",190,__func__), ERR_set_error)((4),(159),
# 190 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 190 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }

    em = CRYPTO_malloc(num, "../crypto/rsa/rsa_pk1.c", 194);
    if (em == 
# 195 "../crypto/rsa/rsa_pk1.c" 3 4
             ((void *)0)
# 195 "../crypto/rsa/rsa_pk1.c"
                 )
        return -1;
...
# 252 "../crypto/rsa/rsa_pk1.c"
    ...
    CRYPTO_clear_free(em, num, "../crypto/rsa/rsa_pk1.c", 264);
    ...
    (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",271,__func__), ERR_set_error)((4),(159),
# 271 "../crypto/rsa/rsa_pk1.c" 3 4
   ((void *)0)
# 271 "../crypto/rsa/rsa_pk1.c"
   );
                        ...
                        uint16_t bitlen)
{
    ...
    HMAC_CTX *hmac = 
# 290 "../crypto/rsa/rsa_pk1.c" 3 4
                    ((void *)0)
# 290 "../crypto/rsa/rsa_pk1.c"
                        ;
    EVP_MD *md = 
# 291 "../crypto/rsa/rsa_pk1.c" 3 4
                ((void *)0)
# 291 "../crypto/rsa/rsa_pk1.c"
                    ;
    unsigned char hmac_out[32];
    unsigned int md_len;

    if (tlen * 8 != bitlen) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",296,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 296 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 296 "../crypto/rsa/rsa_pk1.c"
       );
        return ret;
    }
    ...
    hmac = HMAC_CTX_new();
    if (hmac == 
# 304 "../crypto/rsa/rsa_pk1.c" 3 4
               ((void *)0)
# 304 "../crypto/rsa/rsa_pk1.c"
                   ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",305,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 305 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 305 "../crypto/rsa/rsa_pk1.c"
       );
        goto err;
    }
# 316 "../crypto/rsa/rsa_pk1.c"
    md = EVP_MD_fetch(ctx, "sha256", 
# 316 "../crypto/rsa/rsa_pk1.c" 3 4
                                    ((void *)0)
# 316 "../crypto/rsa/rsa_pk1.c"
                                        );
    if (md == 
# 317 "../crypto/rsa/rsa_pk1.c" 3 4
             ((void *)0)
# 317 "../crypto/rsa/rsa_pk1.c"
                 ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",318,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 318 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 318 "../crypto/rsa/rsa_pk1.c"
       );
        goto err;
    }

    if (HMAC_Init_ex(hmac, kdk, 32, md, 
# 322 "../crypto/rsa/rsa_pk1.c" 3 4
                                                         ((void *)0)
# 322 "../crypto/rsa/rsa_pk1.c"
                                                             ) <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",323,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 323 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 323 "../crypto/rsa/rsa_pk1.c"
       );
        goto err;
    }

    for (pos = 0; pos < tlen; pos += 32, iter++) {
        if (HMAC_Init_ex(hmac, 
# 328 "../crypto/rsa/rsa_pk1.c" 3 4
                              ((void *)0)
# 328 "../crypto/rsa/rsa_pk1.c"
                                  , 0, 
# 328 "../crypto/rsa/rsa_pk1.c" 3 4
                                       ((void *)0)
# 328 "../crypto/rsa/rsa_pk1.c"
...
# 328 "../crypto/rsa/rsa_pk1.c"
            ...
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",329,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 329 "../crypto/rsa/rsa_pk1.c" 3 4
           ((void *)0)
# 329 "../crypto/rsa/rsa_pk1.c"
           );
            goto err;
        }
        ...
        if (HMAC_Update(hmac, be_iter, sizeof(be_iter)) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",337,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 337 "../crypto/rsa/rsa_pk1.c" 3 4
           ((void *)0)
# 337 "../crypto/rsa/rsa_pk1.c"
           );
            goto err;
        }
        if (HMAC_Update(hmac, (unsigned char *)label, llen) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",341,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 341 "../crypto/rsa/rsa_pk1.c" 3 4
           ((void *)0)
# 341 "../crypto/rsa/rsa_pk1.c"
           );
            goto err;
        }
        if (HMAC_Update(hmac, be_bitlen, sizeof(be_bitlen)) <= 0) {
            (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",345,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 345 "../crypto/rsa/rsa_pk1.c" 3 4
           ((void *)0)
# 345 "../crypto/rsa/rsa_pk1.c"
           );
            goto err;
        }
        ...
        if (pos + 32 > tlen) {
            if (HMAC_Final(hmac, hmac_out, &md_len) <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",357,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 357 "../crypto/rsa/rsa_pk1.c" 3 4
               ((void *)0)
# 357 "../crypto/rsa/rsa_pk1.c"
               );
                goto err;
            }
            ...
            if (HMAC_Final(hmac, to + pos, &md_len) <= 0) {
                (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",363,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 363 "../crypto/rsa/rsa_pk1.c" 3 4
               ((void *)0)
# 363 "../crypto/rsa/rsa_pk1.c"
               );
                goto err;
            }
        }
...
# 389 "../crypto/rsa/rsa_pk1.c"
int ossl_rsa_padding_check_PKCS1_type_2(OSSL_LIB_CTX *ctx,
                                        unsigned char *to, int tlen,
                                        const unsigned char *from, int flen,
                                        int num, unsigned char *kdk)
{
# 402 "../crypto/rsa/rsa_pk1.c"
    unsigned char *synthetic = 
# 402 "../crypto/rsa/rsa_pk1.c" 3 4
                              ((void *)0)
# 402 "../crypto/rsa/rsa_pk1.c"
                                  ;
    int synthetic_length;
    uint16_t len_candidate;
    unsigned char candidate_lengths[128 * sizeof(len_candidate)];
    uint16_t len_mask;
    ...
    if (num != flen || tlen <= 0 || flen <= 0) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",421,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 421 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 421 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }


    synthetic = CRYPTO_malloc(flen, "../crypto/rsa/rsa_pk1.c", 426);
    if (synthetic == 
# 427 "../crypto/rsa/rsa_pk1.c" 3 4
                    ((void *)0)
# 427 "../crypto/rsa/rsa_pk1.c"
                        ) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",428,__func__), ERR_set_error)((4),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 428 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 428 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
    ...
    synthetic_length = 0;
    for (i = 0; i < 128 * (int)sizeof(len_candidate);
...
err:
    ...
    if (ret < 0)
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",521,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 521 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 521 "../crypto/rsa/rsa_pk1.c"
       );
    CRYPTO_free(synthetic, "../crypto/rsa/rsa_pk1.c", 522);
    return ret;
}
# 547 "../crypto/rsa/rsa_pk1.c"
                                            ...
                                            int alt_version)
{
    ...
    unsigned char rand_premaster_secret[48];
    ...
    if (flen < 11 + 48
            || tlen < 48) {
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",562,__func__), ERR_set_error)((4),(159),
# 562 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 562 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
    ...
    if (RAND_priv_bytes_ex(libctx, rand_premaster_secret,
        ...
        (ERR_new(), ERR_set_debug("../crypto/rsa/rsa_pk1.c",572,__func__), ERR_set_error)((4),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 572 "../crypto/rsa/rsa_pk1.c" 3 4
       ((void *)0)
# 572 "../crypto/rsa/rsa_pk1.c"
       );
        return -1;
    }
    ...
    for (i = 2; i < flen - 48 - 1; i++)
        good &= ~constant_time_is_zero_8(from[i]);
    good &= constant_time_is_zero_8(from[flen - 48 - 1]);
# 593 "../crypto/rsa/rsa_pk1.c"
    version_good =
        constant_time_eq(from[flen - 48],
                         (client_version >> 8) & 0xff);
    version_good &=
        constant_time_eq(from[flen - 48 + 1],
                         client_version & 0xff);
# 610 "../crypto/rsa/rsa_pk1.c"
    if (alt_version > 0) {
