...
# 1 "crypto/buildinf.h" 1
# 21 "crypto/buildinf.h"
static const char compiler_flags[] = {
    'c','o','m','p','i','l','e','r',':',' ','/','r','o','o','t','/',
    'A','s','m','X','o','M','/','g','c','c','-','1','5','.','2','.',
    '0','/','b','u','i','l','d','/','b','i','n','/','g','c','c',' ',
    '-','f','P','I','C',' ','-','p','t','h','r','e','a','d',' ','-',
    'm','6','4',' ','-','W','a',',','-','-','n','o','e','x','e','c',
    's','t','a','c','k',' ','-','O','0',' ','-','W','a',',','-','-',
    'k','e','e','p','-','l','o','c','a','l','s',' ','-','W','a',',',
    '-','-','d','s','p','l','i','t',' ','-','s','a','v','e','-','t',
    'e','m','p','s','=','o','b','j',' ','-','f','P','I','C',' ','-',
...
static char *seed_sources = 
# 34 "../crypto/info.c" 3 4
                           ((void *)0)
# 34 "../crypto/info.c"
                               ;
...
# 39 "../crypto/info.c" 3 4
                              0
# 39 "../crypto/info.c"
                                                     ;

static int init_info_strings(void); static int init_info_strings_ossl_ret_ = 0; static void init_info_strings_ossl_(void) { init_info_strings_ossl_ret_ = init_info_strings(); } static int init_info_strings(void)
{
...
# 169 "../crypto/info.c"
        do { if (seeds[0] != '\0') OPENSSL_strlcat(seeds, " ", sizeof(seeds)); OPENSSL_strlcat(seeds, "os-specific", sizeof(seeds)); } while (0);
...
const char *OPENSSL_info(int t)
{
    ...
    (void)(CRYPTO_THREAD_run_once(&init_info, init_info_strings_ossl_) ? init_info_strings_ossl_ret_ : 0);

    switch (t) {
    case 1001:
        return "/root/AsmXoM/evaluation/openssl-3.3.5/build/ssl";
    case 1002:
        return "/root/AsmXoM/evaluation/openssl-3.3.5/build/lib64/engines-3";
    case 1003:
        return "/root/AsmXoM/evaluation/openssl-3.3.5/build/lib64/ossl-modules";
    case 1004:
        return ".so";
    case 1005:
    ...
    case 1008:
        ...
        if (ossl_cpu_info_str[0] != '\0')
            return ossl_cpu_info_str + strlen("CPUINFO: ");
        break;
    default:
        break;
    }
