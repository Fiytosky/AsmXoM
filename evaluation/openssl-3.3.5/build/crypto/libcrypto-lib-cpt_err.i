...
# 14 "../crypto/cpt_err.c" 2



static const ERR_STRING_DATA CRYPTO_str_reasons[] = {
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(117) & 0X7FFFFF)) ),
    "bad algorithm name"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(118) & 0X7FFFFF)) ),
    "conflicting names"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(121) & 0X7FFFFF)) ),
    "hex string too short"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(102) & 0X7FFFFF)) ),
    "illegal hex digit"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(106) & 0X7FFFFF)) ),
    "insufficient data space"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(107) & 0X7FFFFF)) ),
    "insufficient param size"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(108) & 0X7FFFFF)) ),
    "insufficient secure data space"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(127) & 0X7FFFFF)) ),
    "integer overflow"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(122) & 0X7FFFFF)) ),
    "invalid negative value"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(109) & 0X7FFFFF)) ),
    "invalid null argument"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(110) & 0X7FFFFF)) ),
    "invalid ossl param type"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(131) & 0X7FFFFF)) ),
    "no params to merge"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(128) & 0X7FFFFF)) ),
    "no space for terminating null"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(103) & 0X7FFFFF)) ),
    "odd number of digits"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(123) & 0X7FFFFF)) ),
    "param cannot be represented exactly"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(124) & 0X7FFFFF)) ),
    "param not integer type"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(129) & 0X7FFFFF)) ),
    "param of incompatible type"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(125) & 0X7FFFFF)) ),
    "param unsigned integer negative value unsupported"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(130) & 0X7FFFFF)) ),
    "param unsupported floating point format"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(126) & 0X7FFFFF)) ),
    "param value too large for destination"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(104) & 0X7FFFFF)) ),
    "provider already exists"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(105) & 0X7FFFFF)) ),
    "provider section error"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(119) & 0X7FFFFF)) ),
    "random section error"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(111) & 0X7FFFFF)) ),
    "secure malloc failure"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(112) & 0X7FFFFF)) ), "string too long"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(113) & 0X7FFFFF)) ), "too many bytes"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(114) & 0X7FFFFF)) ),
    "too many records"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(116) & 0X7FFFFF)) ),
    "too small buffer"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(120) & 0X7FFFFF)) ),
    "unknown name in random section"},
    {( (((unsigned long)(15) & 0xFF ) << 23L) | (((unsigned long)(115) & 0X7FFFFF)) ),
    "zero length number"},
    {0, 
# 76 "../crypto/cpt_err.c" 3 4
       ((void *)0)
# 76 "../crypto/cpt_err.c"
           }
};
...
int ossl_err_load_CRYPTO_strings(void)
{
    ...
    if (ERR_reason_error_string(CRYPTO_str_reasons[0].error) == 
# 84 "../crypto/cpt_err.c" 3 4
                                                               ((void *)0)
# 84 "../crypto/cpt_err.c"
                                                                   )
