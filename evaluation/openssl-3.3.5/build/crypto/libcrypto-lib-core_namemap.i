...
{
    if (n != 
# 57 "../crypto/core_namemap.c" 3 4
            ((void *)0)
# 57 "../crypto/core_namemap.c"
                )
...
void *ossl_stored_namemap_new(OSSL_LIB_CTX *libctx)
{
    ...
    if (namemap != 
# 68 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 68 "../crypto/core_namemap.c"
                      )
        namemap->stored = 1;
...
void ossl_stored_namemap_free(void *vnamemap)
{
    ...
    if (namemap != 
# 78 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 78 "../crypto/core_namemap.c"
                      ) {
...
int ossl_namemap_empty(OSSL_NAMEMAP *namemap)
{
# 106 "../crypto/core_namemap.c"
    return namemap == 
# 106 "../crypto/core_namemap.c" 3 4
                     ((void *)0) 
# 106 "../crypto/core_namemap.c"
                          || 
# 106 "../crypto/core_namemap.c" 3 4
...
static __attribute__((unused)) inline void lh_NAMENUM_ENTRY_doall_DOALL_NAMES_DATA_thunk(void *node, void *arg, OPENSSL_LH_DOALL_FUNCARG fn) { void (*fn_conv)(const NAMENUM_ENTRY *, DOALL_NAMES_DATA *) = (void (*)(const NAMENUM_ENTRY *, DOALL_NAMES_DATA *))fn; fn_conv((const NAMENUM_ENTRY *)node, (DOALL_NAMES_DATA *)arg); } static __attribute__((unused)) inline void lh_NAMENUM_ENTRY_doall_DOALL_NAMES_DATA(struct lhash_st_NAMENUM_ENTRY *lh, void (*fn)(const NAMENUM_ENTRY *, DOALL_NAMES_DATA *), DOALL_NAMES_DATA *arg) { OPENSSL_LH_doall_arg_thunk((OPENSSL_LHASH *)lh, lh_NAMENUM_ENTRY_doall_DOALL_NAMES_DATA_thunk, (OPENSSL_LH_DOALL_FUNCARG)fn, (void *)arg); } struct lhash_st_NAMENUM_ENTRY;
                             ...
                             void *data)
{
    ...
    if (namemap == 
# 140 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 140 "../crypto/core_namemap.c"
                      )
        return 0;
    ...
    cbdata.names = CRYPTO_malloc(sizeof(*cbdata.names) * num_names, "../crypto/core_namemap.c", 156);
    if (cbdata.names == 
# 157 "../crypto/core_namemap.c" 3 4
                       ((void *)0)
# 157 "../crypto/core_namemap.c"
                           ) {
        CRYPTO_THREAD_unlock(namemap->lock);
        return 0;
    }
    ...
    CRYPTO_free(cbdata.names, "../crypto/core_namemap.c", 168);
    return 1;
}
                            ...
                            const char *name)
{
    ...
    return namenum_entry != 
# 182 "../crypto/core_namemap.c" 3 4
                           ((void *)0) 
# 182 "../crypto/core_namemap.c"
                                ? namenum_entry->number : 0;
}
...
int ossl_namemap_name2num(const OSSL_NAMEMAP *namemap, const char *name)
{
    ...
    if (namemap == 
# 190 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 190 "../crypto/core_namemap.c"
                      )
        namemap = ossl_namemap_stored(
# 191 "../crypto/core_namemap.c" 3 4
                                     ((void *)0)
# 191 "../crypto/core_namemap.c"
                                         );


    if (namemap == 
# 194 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 194 "../crypto/core_namemap.c"
                      )
        return 0;
                            ...
                            const char *name, size_t name_len)
{
    ...
    if (name == 
# 211 "../crypto/core_namemap.c" 3 4
               ((void *)0) 
# 211 "../crypto/core_namemap.c"
                    || (tmp = CRYPTO_strndup(name, name_len, "../crypto/core_namemap.c", 211)) == 
# 211 "../crypto/core_namemap.c" 3 4
                                                                  ((void *)0)
# 211 "../crypto/core_namemap.c"
                                                                      )
    ...
    CRYPTO_free(tmp, "../crypto/core_namemap.c", 215);
    return ret;
}
...
# 230 "../crypto/core_namemap.c" 3 4
                          ((void *)0)
# 230 "../crypto/core_namemap.c"
                              )
        data->name = name;
}
                                  ...
                                  size_t idx)
{
    ...
    data.idx = idx;
    data.name = 
# 240 "../crypto/core_namemap.c" 3 4
               ((void *)0)
# 240 "../crypto/core_namemap.c"
                   ;
    if (!ossl_namemap_doall_names(namemap, number, do_num2name, &data))
        return 
# 242 "../crypto/core_namemap.c" 3 4
              ((void *)0)
# 242 "../crypto/core_namemap.c"
                  ;
    return data.name;
}
...
static int namemap_add_name(OSSL_NAMEMAP *namemap, int number,
                            const char *name)
{
    NAMENUM_ENTRY *namenum = 
# 250 "../crypto/core_namemap.c" 3 4
                            ((void *)0)
# 250 "../crypto/core_namemap.c"
                                ;
    int tmp_number;
    ...
    if ((namenum = CRYPTO_zalloc(sizeof(*namenum), "../crypto/core_namemap.c", 257)) == 
# 257 "../crypto/core_namemap.c" 3 4
                                                       ((void *)0)
# 257 "../crypto/core_namemap.c"
                                                           )
        return 0;

    if ((namenum->name = CRYPTO_strdup(name, "../crypto/core_namemap.c", 260)) == 
# 260 "../crypto/core_namemap.c" 3 4
                                                 ((void *)0)
# 260 "../crypto/core_namemap.c"
                                                     )
        goto err;
    ...
    namenum->number =
        number != 0 ? number : 1 + 
# 265 "../crypto/core_namemap.c" 3 4
                                  __atomic_fetch_add ((
# 265 "../crypto/core_namemap.c"
                                  ((&namemap->max_number))
# 265 "../crypto/core_namemap.c" 3 4
                                  ), (
# 265 "../crypto/core_namemap.c"
                          ...
                          const char *name)
{
    ...
    if (namemap == 
# 283 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 283 "../crypto/core_namemap.c"
                      )
        namemap = ossl_namemap_stored(
# 284 "../crypto/core_namemap.c" 3 4
                                     ((void *)0)
# 284 "../crypto/core_namemap.c"
                                         );


    if (name == 
# 287 "../crypto/core_namemap.c" 3 4
               ((void *)0) 
# 287 "../crypto/core_namemap.c"
                    || *name == 0 || namemap == 
# 287 "../crypto/core_namemap.c" 3 4
                                                ((void *)0)
# 287 "../crypto/core_namemap.c"
                           ...
                           const char *names, const char separator)
{
    ...
    if (!__builtin_expect(!!((namemap != 
# 303 "../crypto/core_namemap.c" 3 4
        ((void *)0)
# 303 "../crypto/core_namemap.c"
        ) != 0), 1)) {
        (ERR_new(), ERR_set_debug("../crypto/core_namemap.c",304,__func__), ERR_set_error)((15),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 304 "../crypto/core_namemap.c" 3 4
       ((void *)0)
# 304 "../crypto/core_namemap.c"
       );
        return 0;
    }

    if ((tmp = CRYPTO_strdup(names, "../crypto/core_namemap.c", 308)) == 
# 308 "../crypto/core_namemap.c" 3 4
                                        ((void *)0)
# 308 "../crypto/core_namemap.c"
                                            )
        return 0;

    if (!CRYPTO_THREAD_write_lock(namemap->lock)) {
        CRYPTO_free(tmp, "../crypto/core_namemap.c", 312);
        return 0;
    }
...
# 323 "../crypto/core_namemap.c" 3 4
                                         ((void *)0)
# 323 "../crypto/core_namemap.c"
                                             ) {
            l = strlen(p);
            q = p + l;
        } else {
        ...
        if (*p == '\0') {
            (ERR_new(), ERR_set_debug("../crypto/core_namemap.c",332,__func__), ERR_set_error)((15),(117),
# 332 "../crypto/core_namemap.c" 3 4
           ((void *)0)
# 332 "../crypto/core_namemap.c"
           );
            number = 0;
            goto end;
        }
        ...
        if (number == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/core_namemap.c",342,__func__), ERR_set_error)(15, 118,
    ...
    for (p = tmp; p < endp; p = q) {
        ...
        if (number == 0) {
            ...
            (ERR_new(), ERR_set_debug("../crypto/core_namemap.c",361,__func__), ERR_set_error)(15, (259|((0x1 << 18L)|(0x2 << 18L))),
    ...
    CRYPTO_THREAD_unlock(namemap->lock);
    CRYPTO_free(tmp, "../crypto/core_namemap.c", 371);
    return number;
}
...
# 398 "../crypto/core_namemap.c" 3 4
                                       ((void *)0)
# 398 "../crypto/core_namemap.c"
                                           ) {
            char txtoid[50];
    ...
    if (pem_name != 
# 405 "../crypto/core_namemap.c" 3 4
                   ((void *)0)
# 405 "../crypto/core_namemap.c"
                       )
...
static void get_legacy_cipher_names(const OBJ_NAME *on, void *arg)
{
    ...
    if (cipher != 
# 413 "../crypto/core_namemap.c" 3 4
                 ((void *)0)
# 413 "../crypto/core_namemap.c"
                     )
        get_legacy_evp_names(0, EVP_CIPHER_get_type(cipher), 
# 414 "../crypto/core_namemap.c" 3 4
                                                                    ((void *)0)
# 414 "../crypto/core_namemap.c"
                                                                        , arg);
}
...
static void get_legacy_md_names(const OBJ_NAME *on, void *arg)
{
    ...
    if (md != 
# 421 "../crypto/core_namemap.c" 3 4
             ((void *)0)
# 421 "../crypto/core_namemap.c"
                 )
        get_legacy_evp_names(0, EVP_MD_get_type(md), 
# 422 "../crypto/core_namemap.c" 3 4
                                                    ((void *)0)
# 422 "../crypto/core_namemap.c"
                                                        , arg);
}
                                       ...
                                       void *arg)
{
    ...
    const char *pem_name = 
# 429 "../crypto/core_namemap.c" 3 4
                          ((void *)0)
# 429 "../crypto/core_namemap.c"
                              ;

    EVP_PKEY_asn1_get0_info(&nid, &base_nid, &flags, 
# 431 "../crypto/core_namemap.c" 3 4
                                                    ((void *)0)
# 431 "../crypto/core_namemap.c"
                                                        , &pem_name, ameth);
    if (nid != 0) {
        if ((flags & 0x1) == 0) {
            switch (nid) {
...
OSSL_NAMEMAP *ossl_namemap_stored(OSSL_LIB_CTX *libctx)
{
    ...
    OSSL_NAMEMAP *namemap =
        ossl_lib_ctx_get_data(libctx, 4);

    if (namemap == 
# 478 "../crypto/core_namemap.c" 3 4
                  ((void *)0)
# 478 "../crypto/core_namemap.c"
                      )
        return 
# 479 "../crypto/core_namemap.c" 3 4
              ((void *)0)
# 479 "../crypto/core_namemap.c"
                  ;
    ...
    if (nms < 0) {
        ...
        return 
# 488 "../crypto/core_namemap.c" 3 4
              ((void *)0)
# 488 "../crypto/core_namemap.c"
                  ;
    }
    if (nms == 1) {
        int i, end;
        ...
        OPENSSL_init_crypto(0x00000004L
                            | 0x00000008L, 
# 495 "../crypto/core_namemap.c" 3 4
                                                           ((void *)0)
# 495 "../crypto/core_namemap.c"
                                                               );

        OBJ_NAME_do_all(0x02,
                        get_legacy_cipher_names, namemap);
        OBJ_NAME_do_all(0x01,
...
OSSL_NAMEMAP *ossl_namemap_new(void)
{
    ...
    if ((namemap = CRYPTO_zalloc(sizeof(*namemap), "../crypto/core_namemap.c", 515)) != 
# 515 "../crypto/core_namemap.c" 3 4
                                                       ((void *)0)
        
# 516 "../crypto/core_namemap.c"
       && (namemap->lock = CRYPTO_THREAD_lock_new()) != 
# 516 "../crypto/core_namemap.c" 3 4
                                                        ((void *)0)
        
# 517 "../crypto/core_namemap.c"
       && (namemap->namenum =
            lh_NAMENUM_ENTRY_new(namenum_hash, namenum_cmp)) != 
# 518 "../crypto/core_namemap.c" 3 4
                                                               ((void *)0)
# 518 "../crypto/core_namemap.c"
                                                                   )
        return namemap;

    ossl_namemap_free(namemap);
    return 
# 522 "../crypto/core_namemap.c" 3 4
          ((void *)0)
# 522 "../crypto/core_namemap.c"
              ;
}
...
{
    if (namemap == 
# 527 "../crypto/core_namemap.c" 3 4
                  ((void *)0) 
# 527 "../crypto/core_namemap.c"
                       || namemap->stored)
        return;
