# 0 "../providers/implementations/asymciphers/sm2_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/asymciphers/sm2_enc.c"
# 10 "../providers/implementations/asymciphers/sm2_enc.c"
...
# 11 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 13 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 14 "../providers/implementations/asymciphers/sm2_enc.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 18 "../providers/implementations/asymciphers/sm2_enc.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 19 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
const unsigned char *ossl_sm2_algorithmidentifier_encoding(int md_nid,
                                                           size_t *len);
# 20 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 21 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 22 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
# 23 "../providers/implementations/asymciphers/sm2_enc.c" 2
...
{
    PROV_SM2_CTX *psm2ctx = CRYPTO_zalloc(sizeof(PROV_SM2_CTX), "../providers/implementations/asymciphers/sm2_enc.c", 50);

    if (psm2ctx == 
# 52 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                  ((void *)0)
# 52 "../providers/implementations/asymciphers/sm2_enc.c"
                      )
        return 
# 53 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 53 "../providers/implementations/asymciphers/sm2_enc.c"
                  ;
    psm2ctx->libctx = ossl_prov_ctx_get0_libctx((provctx));
...
static int sm2_init(void *vpsm2ctx, void *vkey, const OSSL_PARAM params[])
{
    ...
    if (psm2ctx == 
# 63 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                  ((void *)0) 
# 63 "../providers/implementations/asymciphers/sm2_enc.c"
                       || vkey == 
# 63 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                                  ((void *)0) 
# 63 "../providers/implementations/asymciphers/sm2_enc.c"
...
static const EVP_MD *sm2_get_md(PROV_SM2_CTX *psm2ctx)
{
    ...
    if (md == 
# 75 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
             ((void *)0)
# 75 "../providers/implementations/asymciphers/sm2_enc.c"
                 )
        md = ossl_prov_digest_fetch(&psm2ctx->md, psm2ctx->libctx, "SM3", 
# 76 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                                                                         ((void *)0)
# 76 "../providers/implementations/asymciphers/sm2_enc.c"
                                                                             );
                            ...
                            size_t inlen)
{
    ...
    if (md == 
# 88 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
             ((void *)0)
# 88 "../providers/implementations/asymciphers/sm2_enc.c"
                 )
        return 0;

    if (out == 
# 91 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 91 "../providers/implementations/asymciphers/sm2_enc.c"
                  ) {
        if (!ossl_sm2_ciphertext_size(psm2ctx->key, md, inlen, outlen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/sm2_enc.c",93,__func__), ERR_set_error)((57),(158),
# 93 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
           ((void *)0)
# 93 "../providers/implementations/asymciphers/sm2_enc.c"
           );
            return 0;
        }
        return 1;
                            ...
                            size_t inlen)
{
    ...
    if (md == 
# 109 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
             ((void *)0)
# 109 "../providers/implementations/asymciphers/sm2_enc.c"
                 )
        return 0;

    if (out == 
# 112 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 112 "../providers/implementations/asymciphers/sm2_enc.c"
                  ) {
...
static void sm2_freectx(void *vpsm2ctx)
{
    ...
    CRYPTO_free(psm2ctx, "../providers/implementations/asymciphers/sm2_enc.c", 128);
}
...
static void *sm2_dupctx(void *vpsm2ctx)
{
    ...
    dstctx = CRYPTO_zalloc(sizeof(*srcctx), "../providers/implementations/asymciphers/sm2_enc.c", 136);
    if (dstctx == 
# 137 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                 ((void *)0)
# 137 "../providers/implementations/asymciphers/sm2_enc.c"
                     )
        return 
# 138 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 138 "../providers/implementations/asymciphers/sm2_enc.c"
                  ;
    ...
    *dstctx = *srcctx;
    ...
    if (dstctx->key != 
# 143 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                      ((void *)0) 
# 143 "../providers/implementations/asymciphers/sm2_enc.c"
                           && !EC_KEY_up_ref(dstctx->key)) {
        CRYPTO_free(dstctx, "../providers/implementations/asymciphers/sm2_enc.c", 144);
        return 
# 145 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 145 "../providers/implementations/asymciphers/sm2_enc.c"
                  ;
    }
    ...
    if (!ossl_prov_digest_copy(&dstctx->md, &srcctx->md)) {
        sm2_freectx(dstctx);
        return 
# 150 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
              ((void *)0)
# 150 "../providers/implementations/asymciphers/sm2_enc.c"
                  ;
    }
...
static int sm2_get_ctx_params(void *vpsm2ctx, OSSL_PARAM *params)
{
    ...
    if (vpsm2ctx == 
# 161 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                   ((void *)0)
# 161 "../providers/implementations/asymciphers/sm2_enc.c"
                       )
        return 0;

    p = OSSL_PARAM_locate(params, "digest");
    if (p != 
# 165 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
            ((void *)0)
# 165 "../providers/implementations/asymciphers/sm2_enc.c"
                ) {
        const EVP_MD *md = ossl_prov_digest_md(&psm2ctx->md);

        if (!OSSL_PARAM_set_utf8_string(p, md == 
# 168 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                                                ((void *)0) 
# 168 "../providers/implementations/asymciphers/sm2_enc.c"
                                                     ? ""
                                                      : EVP_MD_get0_name(md)))
            return 0;
    }
...
static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("digest")), (4), ((
# 177 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 177 "../providers/implementations/asymciphers/sm2_enc.c"
   )), (0), ((size_t)-1) },
    { 
# 178 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 178 "../providers/implementations/asymciphers/sm2_enc.c"
   , 0, 
# 178 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 178 "../providers/implementations/asymciphers/sm2_enc.c"
...
static const OSSL_PARAM *sm2_gettable_ctx_params(__attribute__((unused)) void *vpsm2ctx,
...
static int sm2_set_ctx_params(void *vpsm2ctx, const OSSL_PARAM params[])
{
    ...
    if (psm2ctx == 
# 191 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                  ((void *)0)
# 191 "../providers/implementations/asymciphers/sm2_enc.c"
                      )
        return 0;
    if (params == 
# 193 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
                 ((void *)0)
# 193 "../providers/implementations/asymciphers/sm2_enc.c"
                     )
        return 1;
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("digest")), (4), ((
# 204 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 204 "../providers/implementations/asymciphers/sm2_enc.c"
   )), (0), ((size_t)-1) },
    { (("properties")), (4), ((
# 205 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 205 "../providers/implementations/asymciphers/sm2_enc.c"
   )), (0), ((size_t)-1) },
    { (("engine")), (4), ((
# 206 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 206 "../providers/implementations/asymciphers/sm2_enc.c"
   )), (0), ((size_t)-1) },
    { 
# 207 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 207 "../providers/implementations/asymciphers/sm2_enc.c"
   , 0, 
# 207 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0)
# 207 "../providers/implementations/asymciphers/sm2_enc.c"
...
static const OSSL_PARAM *sm2_settable_ctx_params(__attribute__((unused)) void *vpsm2ctx,
                                                 __attribute__((unused)) void *provctx)
{
...
const OSSL_DISPATCH ossl_sm2_asym_cipher_functions[] = {
    { 1, (void (*)(void))sm2_newctx },
    { 2, (void (*)(void))sm2_init },
    { 3, (void (*)(void))sm2_asym_encrypt },
    { 4, (void (*)(void))sm2_init },
    { 5, (void (*)(void))sm2_asym_decrypt },
    { 6, (void (*)(void))sm2_freectx },
    { 7, (void (*)(void))sm2_dupctx },
    { 8,
    ...
    { 0, 
# 232 "../providers/implementations/asymciphers/sm2_enc.c" 3 4
   ((void *)0) 
# 232 "../providers/implementations/asymciphers/sm2_enc.c"
   }
};
