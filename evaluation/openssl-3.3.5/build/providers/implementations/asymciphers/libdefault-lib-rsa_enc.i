# 0 "../providers/implementations/asymciphers/rsa_enc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/asymciphers/rsa_enc.c"
# 14 "../providers/implementations/asymciphers/rsa_enc.c"
...
# 15 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 17 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 18 "../providers/implementations/asymciphers/rsa_enc.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 21 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 23 "../providers/implementations/asymciphers/rsa_enc.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 24 "../providers/implementations/asymciphers/rsa_enc.c" 2

# 1 "../include/openssl/prov_ssl.h" 1
# 12 "../include/openssl/prov_ssl.h"
        
# 26 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 27 "../providers/implementations/asymciphers/rsa_enc.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 28 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 29 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 30 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 31 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 32 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
# 33 "../providers/implementations/asymciphers/rsa_enc.c" 2
...
static OSSL_ITEM padding_item[] = {
    ...
    { 5, "x931" },
    { 0, 
# 54 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                               ((void *)0) 
# 54 "../providers/implementations/asymciphers/rsa_enc.c"
                                        }
};
...
static void *rsa_newctx(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 87 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 87 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;
    prsactx = CRYPTO_zalloc(sizeof(PROV_RSA_CTX), "../providers/implementations/asymciphers/rsa_enc.c", 88);
    if (prsactx == 
# 89 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                  ((void *)0)
# 89 "../providers/implementations/asymciphers/rsa_enc.c"
                      )
        return 
# 90 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 90 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;
...
# 101 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                             ((void *)0) 
# 101 "../providers/implementations/asymciphers/rsa_enc.c"
                                                  || vrsa == 
# 101 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                             ((void *)0)
# 101 "../providers/implementations/asymciphers/rsa_enc.c"
    ...
    default:
        ...
        (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",120,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 120 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
       ((void *)0)
# 120 "../providers/implementations/asymciphers/rsa_enc.c"
       );
        return 0;
    }
...
static int rsa_encrypt_init(void *vprsactx, void *vrsa,
                            const OSSL_PARAM params[])
{
    return rsa_init(vprsactx, vrsa, params, (1<<9));
}

static int rsa_decrypt_init(void *vprsactx, void *vrsa,
                            const OSSL_PARAM params[])
{
    return rsa_init(vprsactx, vrsa, params, (1<<10));
}
                       ...
                       size_t outsize, const unsigned char *in, size_t inlen)
{
    ...
    if (len == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",149,__func__), ERR_set_error)((57),(158),
# 149 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
       ((void *)0)
# 149 "../providers/implementations/asymciphers/rsa_enc.c"
       );
        return 0;
    }

    if (out == 
# 153 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 153 "../providers/implementations/asymciphers/rsa_enc.c"
                  ) {
        *outlen = len;
        return 1;
    }
    ...
    if (outsize < len) {
        (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",159,__func__), ERR_set_error)((57),(106),
# 159 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
       ((void *)0)
# 159 "../providers/implementations/asymciphers/rsa_enc.c"
       );
        return 0;
    }

    if (prsactx->pad_mode == 4) {
        int rsasize = RSA_size(prsactx->rsa);
        unsigned char *tbuf;

        if ((tbuf = CRYPTO_malloc(rsasize, "../providers/implementations/asymciphers/rsa_enc.c", 167)) == 
# 167 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                               ((void *)0)
# 167 "../providers/implementations/asymciphers/rsa_enc.c"
                                                   )
            return 0;
        if (prsactx->oaep_md == 
# 169 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                               ((void *)0)
# 169 "../providers/implementations/asymciphers/rsa_enc.c"
                                   ) {
            prsactx->oaep_md = EVP_MD_fetch(prsactx->libctx, "SHA-1", 
# 170 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                                     ((void *)0)
# 170 "../providers/implementations/asymciphers/rsa_enc.c"
                                                                         );
            if (prsactx->oaep_md == 
# 171 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                   ((void *)0)
# 171 "../providers/implementations/asymciphers/rsa_enc.c"
                                       ) {
                CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 172);
                (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",173,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 173 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
               ((void *)0)
# 173 "../providers/implementations/asymciphers/rsa_enc.c"
               );
                return 0;
            }
        }
        ...
        if (!ret) {
            CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 186);
            return 0;
        }
        ret = RSA_public_encrypt(rsasize, tbuf, out, prsactx->rsa,
                                 3);
        CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 191);
    } else {
                       ...
                       size_t outsize, const unsigned char *in, size_t inlen)
{
    ...
    if (prsactx->pad_mode == 7) {
        if (out == 
# 215 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                  ((void *)0)
# 215 "../providers/implementations/asymciphers/rsa_enc.c"
                      ) {
            *outlen = 48;
            return 1;
        }
        if (outsize < 48) {
            (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",220,__func__), ERR_set_error)((57),(142),
# 220 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
           ((void *)0)
# 220 "../providers/implementations/asymciphers/rsa_enc.c"
           );
            return 0;
        }
    } else {
        if (out == 
# 224 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                  ((void *)0)
# 224 "../providers/implementations/asymciphers/rsa_enc.c"
                      ) {
            if (len == 0) {
                (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",226,__func__), ERR_set_error)((57),(158),
# 226 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
               ((void *)0)
# 226 "../providers/implementations/asymciphers/rsa_enc.c"
               );
                return 0;
            }
            *outlen = len;
        ...
        if (outsize < len) {
            (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",234,__func__), ERR_set_error)((57),(142),
# 234 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
           ((void *)0)
# 234 "../providers/implementations/asymciphers/rsa_enc.c"
           );
            return 0;
        }
    }
    ...
    if (prsactx->pad_mode == 4
        ...
        if ((tbuf = CRYPTO_malloc(len, "../providers/implementations/asymciphers/rsa_enc.c", 243)) == 
# 243 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                           ((void *)0)
# 243 "../providers/implementations/asymciphers/rsa_enc.c"
                                               )
            return 0;
        ...
        if (ret != (int)len) {
            CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 252);
            (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",253,__func__), ERR_set_error)((57),(162),
# 253 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
           ((void *)0)
# 253 "../providers/implementations/asymciphers/rsa_enc.c"
           );
            return 0;
        }
        if (prsactx->pad_mode == 4) {
            if (prsactx->oaep_md == 
# 257 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                   ((void *)0)
# 257 "../providers/implementations/asymciphers/rsa_enc.c"
                                       ) {
                prsactx->oaep_md = EVP_MD_fetch(prsactx->libctx, "SHA-1", 
# 258 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                                         ((void *)0)
# 258 "../providers/implementations/asymciphers/rsa_enc.c"
                                                                             );
                if (prsactx->oaep_md == 
# 259 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                       ((void *)0)
# 259 "../providers/implementations/asymciphers/rsa_enc.c"
                                           ) {
                    CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 260);
                    (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",261,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 261 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                   ((void *)0)
# 261 "../providers/implementations/asymciphers/rsa_enc.c"
                   );
                    return 0;
                }
            }
            ...
            if (prsactx->client_version <= 0) {
                (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",274,__func__), ERR_set_error)((57),(161),
# 274 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
               ((void *)0)
# 274 "../providers/implementations/asymciphers/rsa_enc.c"
               );
                CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 275);
                return 0;
            }
        ...
        CRYPTO_free(tbuf, "../providers/implementations/asymciphers/rsa_enc.c", 282);
    } else {
...
static void rsa_freectx(void *vprsactx)
{
    ...
    CRYPTO_free(prsactx->oaep_label, "../providers/implementations/asymciphers/rsa_enc.c", 304);

    CRYPTO_free(prsactx, "../providers/implementations/asymciphers/rsa_enc.c", 306);
}
...
static void *rsa_dupctx(void *vprsactx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 315 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 315 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;

    dstctx = CRYPTO_zalloc(sizeof(*srcctx), "../providers/implementations/asymciphers/rsa_enc.c", 317);
    if (dstctx == 
# 318 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                 ((void *)0)
# 318 "../providers/implementations/asymciphers/rsa_enc.c"
                     )
        return 
# 319 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 319 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;

    *dstctx = *srcctx;
    if (dstctx->rsa != 
# 322 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                      ((void *)0) 
# 322 "../providers/implementations/asymciphers/rsa_enc.c"
                           && !RSA_up_ref(dstctx->rsa)) {
        CRYPTO_free(dstctx, "../providers/implementations/asymciphers/rsa_enc.c", 323);
        return 
# 324 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 324 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;
    }

    if (dstctx->oaep_md != 
# 327 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                          ((void *)0) 
# 327 "../providers/implementations/asymciphers/rsa_enc.c"
                               && !EVP_MD_up_ref(dstctx->oaep_md)) {
        RSA_free(dstctx->rsa);
        CRYPTO_free(dstctx, "../providers/implementations/asymciphers/rsa_enc.c", 329);
        return 
# 330 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 330 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;
    }

    if (dstctx->mgf1_md != 
# 333 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                          ((void *)0) 
# 333 "../providers/implementations/asymciphers/rsa_enc.c"
                               && !EVP_MD_up_ref(dstctx->mgf1_md)) {
        RSA_free(dstctx->rsa);
        EVP_MD_free(dstctx->oaep_md);
        CRYPTO_free(dstctx, "../providers/implementations/asymciphers/rsa_enc.c", 336);
        return 
# 337 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
              ((void *)0)
# 337 "../providers/implementations/asymciphers/rsa_enc.c"
                  ;
    }
...
static int rsa_get_ctx_params(void *vprsactx, OSSL_PARAM *params)
{
    ...
    if (prsactx == 
# 348 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                  ((void *)0)
# 348 "../providers/implementations/asymciphers/rsa_enc.c"
                      )
        return 0;

    p = OSSL_PARAM_locate(params, "pad-mode");
    if (p != 
# 352 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 352 "../providers/implementations/asymciphers/rsa_enc.c"
                )
        switch (p->data_type) {
        case 1:
        ...
        case 4:
            {
                int i;
                const char *word = 
# 361 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                  ((void *)0)
# 361 "../providers/implementations/asymciphers/rsa_enc.c"
                                      ;
                ...
                if (word != 
# 370 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                           ((void *)0)
# 370 "../providers/implementations/asymciphers/rsa_enc.c"
                               ) {
                    if (!OSSL_PARAM_set_utf8_string(p, word))
                        return 0;
                } else {
                    (ERR_new(), ERR_set_debug("../providers/implementations/asymciphers/rsa_enc.c",374,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 374 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                   ((void *)0)
# 374 "../providers/implementations/asymciphers/rsa_enc.c"
                   );
                }
            }
            break;
    ...
    if (p != 
# 383 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0) 
# 383 "../providers/implementations/asymciphers/rsa_enc.c"
                 && !OSSL_PARAM_set_utf8_string(p, prsactx->oaep_md == 
# 383 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                                       ((void *)0)
                                                    
# 384 "../providers/implementations/asymciphers/rsa_enc.c"
                                                   ? ""
    ...
    if (p != 
# 389 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 389 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        EVP_MD *mgf1_md = prsactx->mgf1_md == 
# 390 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                             ((void *)0) 
# 390 "../providers/implementations/asymciphers/rsa_enc.c"
                                                  ? prsactx->oaep_md
                                                   : prsactx->mgf1_md;

        if (!OSSL_PARAM_set_utf8_string(p, mgf1_md == 
# 393 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                     ((void *)0)
                                           
# 394 "../providers/implementations/asymciphers/rsa_enc.c"
                                          ? ""
                                           : EVP_MD_get0_name(mgf1_md)))
        return 0;
    }

    p = OSSL_PARAM_locate(params, "oaep-label");
    if (p != 
# 400 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0) 
# 400 "../providers/implementations/asymciphers/rsa_enc.c"
                 &&
        !OSSL_PARAM_set_octet_ptr(p, prsactx->oaep_label,
                                  prsactx->oaep_labellen))
        return 0;

    p = OSSL_PARAM_locate(params, "tls-client-version");
    if (p != 
# 406 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0) 
# 406 "../providers/implementations/asymciphers/rsa_enc.c"
                 && !OSSL_PARAM_set_uint(p, prsactx->client_version))
        return 0;

    p = OSSL_PARAM_locate(params, "tls-negotiated-version");
    if (p != 
# 410 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0) 
# 410 "../providers/implementations/asymciphers/rsa_enc.c"
                 && !OSSL_PARAM_set_uint(p, prsactx->alt_version))
        return 0;

    p = OSSL_PARAM_locate(params, "implicit-rejection");
    if (p != 
# 414 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0) 
# 414 "../providers/implementations/asymciphers/rsa_enc.c"
                 && !OSSL_PARAM_set_uint(p, prsactx->implicit_rejection))
        return 0;
...
static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("digest")), (4), ((
# 421 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 421 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("pad-mode")), (4), ((
# 422 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 422 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("mgf1-digest")), (4), ((
# 423 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 423 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { ("oaep-label"), (7), (
# 424 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 424 "../providers/implementations/asymciphers/rsa_enc.c"
   ), (0), ((size_t)-1) }
                            ,
    { (("tls-client-version")), (2), ((
# 426 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 426 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("tls-negotiated-version")), (2), ((
# 427 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 427 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("implicit-rejection")), (2), ((
# 428 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 428 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { 
# 429 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 429 "../providers/implementations/asymciphers/rsa_enc.c"
   , 0, 
# 429 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 429 "../providers/implementations/asymciphers/rsa_enc.c"
...
static int rsa_set_ctx_params(void *vprsactx, const OSSL_PARAM params[])
{
    ...
    char mdprops[256] = { '\0' };
    char *str = 
# 444 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
               ((void *)0)
# 444 "../providers/implementations/asymciphers/rsa_enc.c"
                   ;

    if (prsactx == 
# 446 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                  ((void *)0)
# 446 "../providers/implementations/asymciphers/rsa_enc.c"
                      )
        return 0;
    if (params == 
# 448 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                 ((void *)0)
# 448 "../providers/implementations/asymciphers/rsa_enc.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "digest");
    if (p != 
# 452 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 452 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        str = mdname;
        ...
        p = OSSL_PARAM_locate_const(params,
                                    "digest-props");
        if (p != 
# 459 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                ((void *)0)
# 459 "../providers/implementations/asymciphers/rsa_enc.c"
                    ) {
            str = mdprops;
        ...
        if (prsactx->oaep_md == 
# 468 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                               ((void *)0)
# 468 "../providers/implementations/asymciphers/rsa_enc.c"
                                   )
            return 0;
    }
    ...
    if (p != 
# 473 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 473 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        int pad_mode = 0;
        ...
        case 4:
            {
                ...
                if (p->data == 
# 485 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                              ((void *)0)
# 485 "../providers/implementations/asymciphers/rsa_enc.c"
                                  )
                    return 0;
        ...
        if (pad_mode == 6)
            return 0;
        if (pad_mode == 4 && prsactx->oaep_md == 
# 506 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                                                     ((void *)0)
# 506 "../providers/implementations/asymciphers/rsa_enc.c"
                                                                         ) {
            prsactx->oaep_md = EVP_MD_fetch(prsactx->libctx, "SHA1", mdprops);
            if (prsactx->oaep_md == 
# 508 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                                   ((void *)0)
# 508 "../providers/implementations/asymciphers/rsa_enc.c"
                                       )
                return 0;
        }
    ...
    if (p != 
# 515 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 515 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        str = mdname;
        if (!OSSL_PARAM_get_utf8_string(p, &str, sizeof(mdname)))
            return 0;
        ...
        p = OSSL_PARAM_locate_const(params,
                                    "mgf1-properties");
        if (p != 
# 522 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                ((void *)0)
# 522 "../providers/implementations/asymciphers/rsa_enc.c"
                    ) {
            str = mdprops;
            if (!OSSL_PARAM_get_utf8_string(p, &str, sizeof(mdprops)))
                return 0;
            ...
            str = 
# 527 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                 ((void *)0)
# 527 "../providers/implementations/asymciphers/rsa_enc.c"
                     ;
        }
        ...
        if (prsactx->mgf1_md == 
# 533 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                               ((void *)0)
# 533 "../providers/implementations/asymciphers/rsa_enc.c"
                                   )
            return 0;
    }

    p = OSSL_PARAM_locate_const(params, "oaep-label");
    if (p != 
# 538 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 538 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        void *tmp_label = 
# 539 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
                         ((void *)0)
# 539 "../providers/implementations/asymciphers/rsa_enc.c"
                             ;
        size_t tmp_labellen;

        if (!OSSL_PARAM_get_octet_string(p, &tmp_label, 0, &tmp_labellen))
            return 0;
        CRYPTO_free(prsactx->oaep_label, "../providers/implementations/asymciphers/rsa_enc.c", 544);
        prsactx->oaep_label = (unsigned char *)tmp_label;
        prsactx->oaep_labellen = tmp_labellen;
    }

    p = OSSL_PARAM_locate_const(params, "tls-client-version");
    if (p != 
# 550 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 550 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        unsigned int client_version;
    ...
    p = OSSL_PARAM_locate_const(params, "tls-negotiated-version");
    if (p != 
# 559 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 559 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        unsigned int alt_version;
    ...
    p = OSSL_PARAM_locate_const(params, "implicit-rejection");
    if (p != 
# 567 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
            ((void *)0)
# 567 "../providers/implementations/asymciphers/rsa_enc.c"
                ) {
        unsigned int implicit_rejection;
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("digest")), (4), ((
# 579 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 579 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("digest-props")), (4), ((
# 580 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 580 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("pad-mode")), (4), ((
# 581 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 581 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("mgf1-digest")), (4), ((
# 582 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 582 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("mgf1-properties")), (4), ((
# 583 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 583 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("oaep-label")), (5), ((
# 584 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 584 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (0), ((size_t)-1) },
    { (("tls-client-version")), (2), ((
# 585 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 585 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("tls-negotiated-version")), (2), ((
# 586 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 586 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("implicit-rejection")), (2), ((
# 587 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 587 "../providers/implementations/asymciphers/rsa_enc.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { 
# 588 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 588 "../providers/implementations/asymciphers/rsa_enc.c"
   , 0, 
# 588 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0)
# 588 "../providers/implementations/asymciphers/rsa_enc.c"
...
static const OSSL_PARAM *rsa_settable_ctx_params(__attribute__((unused)) void *vprsactx,
                                                 __attribute__((unused)) void *provctx)
{
...
const OSSL_DISPATCH ossl_rsa_asym_cipher_functions[] = {
    ...
    { 2, (void (*)(void))rsa_encrypt_init },
    { 3, (void (*)(void))rsa_encrypt },
    { 4, (void (*)(void))rsa_decrypt_init },
    { 5, (void (*)(void))rsa_decrypt },
    { 6, (void (*)(void))rsa_freectx },
    { 7, (void (*)(void))rsa_dupctx },
    { 8,
    ...
    { 0, 
# 613 "../providers/implementations/asymciphers/rsa_enc.c" 3 4
   ((void *)0) 
# 613 "../providers/implementations/asymciphers/rsa_enc.c"
   }
};
