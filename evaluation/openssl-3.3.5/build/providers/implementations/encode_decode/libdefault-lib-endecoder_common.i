# 0 "../providers/implementations/encode_decode/endecoder_common.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/encode_decode/endecoder_common.c"
# 10 "../providers/implementations/encode_decode/endecoder_common.c"
...
# 11 "../providers/implementations/encode_decode/endecoder_common.c" 2
...
# 12 "../providers/implementations/encode_decode/endecoder_common.c" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 15 "../include/internal/asn1.h" 2

int asn1_d2i_read_bio(BIO *in, BUF_MEM **pb);
# 13 "../providers/implementations/encode_decode/endecoder_common.c" 2
...
# 14 "../providers/implementations/encode_decode/endecoder_common.c" 2
# 1 "../providers/implementations/encode_decode/endecoder_local.h" 1
# 11 "../providers/implementations/encode_decode/endecoder_local.h"
...
# 12 "../providers/implementations/encode_decode/endecoder_local.h" 2
# 1 "../include/openssl/types.h" 1
...
int ossl_read_der(PROV_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
                  long *len);
# 15 "../providers/implementations/encode_decode/endecoder_common.c" 2
...
ossl_prov_get_keymgmt_new(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 24 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
          ((void *)0)
# 24 "../providers/implementations/encode_decode/endecoder_common.c"
              ;
}
...
ossl_prov_get_keymgmt_free(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 35 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
          ((void *)0)
# 35 "../providers/implementations/encode_decode/endecoder_common.c"
              ;
}
...
ossl_prov_get_keymgmt_import(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 46 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
          ((void *)0)
# 46 "../providers/implementations/encode_decode/endecoder_common.c"
              ;
}
...
ossl_prov_get_keymgmt_export(const OSSL_DISPATCH *fns)
{
    ...
    return 
# 57 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
          ((void *)0)
# 57 "../providers/implementations/encode_decode/endecoder_common.c"
              ;
}
                           ...
                           int selection, const OSSL_PARAM params[])
{
    ...
    void *key = 
# 67 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
               ((void *)0)
# 67 "../providers/implementations/encode_decode/endecoder_common.c"
                   ;

    if (kmgmt_new != 
# 69 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                    ((void *)0) 
# 69 "../providers/implementations/encode_decode/endecoder_common.c"
                         && kmgmt_import != 
# 69 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                                            ((void *)0) 
# 69 "../providers/implementations/encode_decode/endecoder_common.c"
...
# 70 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                                         ((void *)0)
            
# 71 "../providers/implementations/encode_decode/endecoder_common.c"
           || !kmgmt_import(key, selection, params)) {
            kmgmt_free(key);
            key = 
# 73 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                 ((void *)0)
# 73 "../providers/implementations/encode_decode/endecoder_common.c"
                     ;
        }
    }
    return key;
...
void ossl_prov_free_key(const OSSL_DISPATCH *fns, void *key)
{
    ...
    if (kmgmt_free != 
# 83 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                     ((void *)0)
# 83 "../providers/implementations/encode_decode/endecoder_common.c"
                         )
        kmgmt_free(key);
}
...
{
    BUF_MEM *mem = 
# 90 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
                  ((void *)0)
# 90 "../providers/implementations/encode_decode/endecoder_common.c"
                      ;
    BIO *in = ossl_bio_new_from_core_bio(provctx, cin);
    int ok;

    if (in == 
# 94 "../providers/implementations/encode_decode/endecoder_common.c" 3 4
             ((void *)0)
# 94 "../providers/implementations/encode_decode/endecoder_common.c"
                 )
        return 0;
    ...
    if (ok) {
        ...
        *len = (long)mem->length;
        CRYPTO_free(mem, "../providers/implementations/encode_decode/endecoder_common.c", 100);
    }
    BIO_free(in);
    return ok;
}
