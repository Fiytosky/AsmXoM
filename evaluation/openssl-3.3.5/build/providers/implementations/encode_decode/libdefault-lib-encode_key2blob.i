# 0 "../providers/implementations/encode_decode/encode_key2blob.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/encode_decode/encode_key2blob.c"
# 13 "../providers/implementations/encode_decode/encode_key2blob.c"
...
# 14 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 16 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 17 "../providers/implementations/encode_decode/encode_key2blob.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 19 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 20 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 21 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
extern void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 22 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 23 "../providers/implementations/encode_decode/encode_key2blob.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 24 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 25 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
# 26 "../providers/implementations/encode_decode/encode_key2blob.c" 2
...
int ossl_read_der(PROV_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
                  long *len);
# 28 "../providers/implementations/encode_decode/encode_key2blob.c" 2
                      ...
                      void *data, int len)
{
    ...
    if (out == 
# 35 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
              ((void *)0)
# 35 "../providers/implementations/encode_decode/encode_key2blob.c"
                  )
        return 0;
...
# 92 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
                           ((void *)0)
# 92 "../providers/implementations/encode_decode/encode_key2blob.c"
                               ;

    pubkey_len = i2o_ECPublicKey(key, &pubkey);
    if (pubkey_len > 0 && pubkey != 
# 95 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
                                   ((void *)0)
# 95 "../providers/implementations/encode_decode/encode_key2blob.c"
                                       )
        ok = write_blob(vctx, cout, pubkey, pubkey_len);
    CRYPTO_free(pubkey, "../providers/implementations/encode_decode/encode_key2blob.c", 97);
    return ok;
}
# 175 "../providers/implementations/encode_decode/encode_key2blob.c"
static OSSL_FUNC_encoder_import_object_fn ec2blob_import_object; static OSSL_FUNC_encoder_free_object_fn ec2blob_free_object; static OSSL_FUNC_encoder_does_selection_fn ec2blob_does_selection; static OSSL_FUNC_encoder_encode_fn ec2blob_encode; static void *ec2blob_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_ec_keymgmt_functions, ctx, selection, params); } static void ec2blob_free_object(void *key) { ossl_prov_free_key(ossl_ec_keymgmt_functions, key); } static int ec2blob_does_selection(void *ctx, int selection) { return key2blob_check_selection(selection, ( ( ( 0x04 | 0x80) ) | 0x02 )); } static int ec2blob_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 175 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0)
# 175 "../providers/implementations/encode_decode/encode_key2blob.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2blob.c",175,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 175 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0)
# 175 "../providers/implementations/encode_decode/encode_key2blob.c"
); return 0; } return key2blob_encode(vctx, key, selection, cout); } const OSSL_DISPATCH ossl_ec_to_blob_encoder_functions[] = { { 1, (void (*)(void))key2blob_newctx }, { 2, (void (*)(void))key2blob_freectx }, { 10, (void (*)(void))ec2blob_does_selection }, { 20, (void (*)(void))ec2blob_import_object }, { 21, (void (*)(void))ec2blob_free_object }, { 11, (void (*)(void))ec2blob_encode }, { 0, 
# 175 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0) 
# 175 "../providers/implementations/encode_decode/encode_key2blob.c"
} };

static OSSL_FUNC_encoder_import_object_fn sm22blob_import_object; static OSSL_FUNC_encoder_free_object_fn sm22blob_free_object; static OSSL_FUNC_encoder_does_selection_fn sm22blob_does_selection; static OSSL_FUNC_encoder_encode_fn sm22blob_encode; static void *sm22blob_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_sm2_keymgmt_functions, ctx, selection, params); } static void sm22blob_free_object(void *key) { ossl_prov_free_key(ossl_sm2_keymgmt_functions, key); } static int sm22blob_does_selection(void *ctx, int selection) { return key2blob_check_selection(selection, ( ( ( 0x04 | 0x80) ) | 0x02 )); } static int sm22blob_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 177 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0)
# 177 "../providers/implementations/encode_decode/encode_key2blob.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2blob.c",177,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 177 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0)
# 177 "../providers/implementations/encode_decode/encode_key2blob.c"
); return 0; } return key2blob_encode(vctx, key, selection, cout); } const OSSL_DISPATCH ossl_sm2_to_blob_encoder_functions[] = { { 1, (void (*)(void))key2blob_newctx }, { 2, (void (*)(void))key2blob_freectx }, { 10, (void (*)(void))sm22blob_does_selection }, { 20, (void (*)(void))sm22blob_import_object }, { 21, (void (*)(void))sm22blob_free_object }, { 11, (void (*)(void))sm22blob_encode }, { 0, 
# 177 "../providers/implementations/encode_decode/encode_key2blob.c" 3 4
((void *)0) 
# 177 "../providers/implementations/encode_decode/encode_key2blob.c"
} };
