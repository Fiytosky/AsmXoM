# 0 "../providers/implementations/encode_decode/encode_key2text.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/encode_decode/encode_key2text.c"
# 13 "../providers/implementations/encode_decode/encode_key2text.c"
...
# 14 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 16 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 18 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 19 "../providers/implementations/encode_decode/encode_key2text.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 21 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 22 "../providers/implementations/encode_decode/encode_key2text.c" 2

# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 24 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 25 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 26 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 27 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 28 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst, int dlen,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq);
# 29 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 30 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 31 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 32 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 33 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
int ossl_read_der(PROV_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
                  long *len);
# 34 "../providers/implementations/encode_decode/encode_key2text.c" 2
...
# 52 "../providers/implementations/encode_decode/encode_key2text.c"
static int print_labeled_bignum(BIO *out, const char *label, const BIGNUM *bn)
{
    int ret = 0, use_sep = 0;
    char *hex_str = 
# 55 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                   ((void *)0)
# 55 "../providers/implementations/encode_decode/encode_key2text.c"
                       , *p;
    const char spaces[] = "    ";
    ...
    if (bn == 
# 62 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
             ((void *)0)
# 62 "../providers/implementations/encode_decode/encode_key2text.c"
                 )
        return 0;
    if (label == 
# 64 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                ((void *)0)
# 64 "../providers/implementations/encode_decode/encode_key2text.c"
                    ) {
        label = "";
        post_label_spc = "";
    }
    ...
    if (((BN_num_bits(bn)+7)/8) <= 8) {
        unsigned long *words = bn_get_words(bn);

        if (BN_is_negative(bn))
            neg = "-";

        return BIO_printf(out, "%s%s%s" "%lu" " (%s0x" "%lx" ")\n",
                          label, post_label_spc, neg, words[0], neg, words[0]);
    }

    hex_str = BN_bn2hex(bn);
    if (hex_str == 
# 83 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                  ((void *)0)
# 83 "../providers/implementations/encode_decode/encode_key2text.c"
                      )
        return 0;
    ...
    ret = 1;
err:
    CRYPTO_free(hex_str, "../providers/implementations/encode_decode/encode_key2text.c", 126);
    return ret;
}
...
static int ffc_params_to_text(BIO *out, const FFC_PARAMS *ffc)
{
    if (ffc->nid != 0) {
        ...
        if (name == 
# 169 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                   ((void *)0)
# 169 "../providers/implementations/encode_decode/encode_key2text.c"
                       )
            goto err;
    ...
    if (!print_labeled_bignum(out, "P:   ", ffc->p))
        goto err;
    if (ffc->q != 
# 182 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                 ((void *)0)
# 182 "../providers/implementations/encode_decode/encode_key2text.c"
                     ) {
    ...
    if (!print_labeled_bignum(out, "G:   ", ffc->g))
        goto err;
    if (ffc->j != 
# 188 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                 ((void *)0)
# 188 "../providers/implementations/encode_decode/encode_key2text.c"
                     ) {
        if (!print_labeled_bignum(out, "J:   ", ffc->j))
            goto err;
    }
    if (ffc->seed != 
# 192 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                    ((void *)0)
# 192 "../providers/implementations/encode_decode/encode_key2text.c"
                        ) {
...
# 220 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 220 "../providers/implementations/encode_decode/encode_key2text.c"
                                ;
    const BIGNUM *priv_key = 
# 221 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 221 "../providers/implementations/encode_decode/encode_key2text.c"
                                , *pub_key = 
# 221 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                             ((void *)0)
# 221 "../providers/implementations/encode_decode/encode_key2text.c"
                                                 ;
    const FFC_PARAMS *params = 
# 222 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                              ((void *)0)
# 222 "../providers/implementations/encode_decode/encode_key2text.c"
                                  ;
    const BIGNUM *p = 
# 223 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
# 223 "../providers/implementations/encode_decode/encode_key2text.c"
                         ;
    long length;

    if (out == 
# 226 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0) 
# 226 "../providers/implementations/encode_decode/encode_key2text.c"
                   || dh == 
# 226 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 226 "../providers/implementations/encode_decode/encode_key2text.c"
                                ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",227,__func__), ERR_set_error)((57),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 227 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 227 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    else if ((selection & 0x02) != 0)
        type_label = "DH Public-Key";
    else if ((selection & 0x04) != 0)
        type_label = "DH Parameters";

    if ((selection & 0x01) != 0) {
        priv_key = DH_get0_priv_key(dh);
        if (priv_key == 
# 240 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                       ((void *)0)
# 240 "../providers/implementations/encode_decode/encode_key2text.c"
                           ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",241,__func__), ERR_set_error)((57),(221),
# 241 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 241 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    if ((selection & ( 0x01 | 0x02 )) != 0) {
        ...
        if (pub_key == 
# 247 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                      ((void *)0)
# 247 "../providers/implementations/encode_decode/encode_key2text.c"
                          ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",248,__func__), ERR_set_error)((57),(220),
# 248 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 248 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    if ((selection & 0x04) != 0) {
        ...
        if (params == 
# 254 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
# 254 "../providers/implementations/encode_decode/encode_key2text.c"
                         ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",255,__func__), ERR_set_error)((57),(226),
# 255 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 255 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    ...
    p = DH_get0_p(dh);
    if (p == 
# 261 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
            ((void *)0)
# 261 "../providers/implementations/encode_decode/encode_key2text.c"
                ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",262,__func__), ERR_set_error)((57),(158),
# 262 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 262 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    if (BIO_printf(out, "%s: (%d bit)\n", type_label, BN_num_bits(p)) <= 0)
        return 0;
    if (priv_key != 
# 268 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                   ((void *)0)
        
# 269 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_bignum(out, "private-key:", priv_key))
        return 0;
    if (pub_key != 
# 271 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                  ((void *)0)
        
# 272 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_bignum(out, "public-key:", pub_key))
        return 0;
    if (params != 
# 274 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                 ((void *)0)
        
# 275 "../providers/implementations/encode_decode/encode_key2text.c"
...
# 293 "../providers/implementations/encode_decode/encode_key2text.c"
static int dsa_to_text(BIO *out, const void *key, int selection)
{
    const DSA *dsa = key;
    const char *type_label = 
# 296 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 296 "../providers/implementations/encode_decode/encode_key2text.c"
                                ;
    const BIGNUM *priv_key = 
# 297 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 297 "../providers/implementations/encode_decode/encode_key2text.c"
                                , *pub_key = 
# 297 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                             ((void *)0)
# 297 "../providers/implementations/encode_decode/encode_key2text.c"
                                                 ;
    const FFC_PARAMS *params = 
# 298 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                              ((void *)0)
# 298 "../providers/implementations/encode_decode/encode_key2text.c"
                                  ;
    const BIGNUM *p = 
# 299 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
# 299 "../providers/implementations/encode_decode/encode_key2text.c"
                         ;

    if (out == 
# 301 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0) 
# 301 "../providers/implementations/encode_decode/encode_key2text.c"
                   || dsa == 
# 301 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                             ((void *)0)
# 301 "../providers/implementations/encode_decode/encode_key2text.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",302,__func__), ERR_set_error)((57),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 302 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 302 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    if ((selection & 0x01) != 0) {
        ...
        if (priv_key == 
# 315 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                       ((void *)0)
# 315 "../providers/implementations/encode_decode/encode_key2text.c"
                           ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",316,__func__), ERR_set_error)((57),(221),
# 316 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 316 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    if ((selection & ( 0x01 | 0x02 )) != 0) {
        ...
        if (pub_key == 
# 322 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                      ((void *)0)
# 322 "../providers/implementations/encode_decode/encode_key2text.c"
                          ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",323,__func__), ERR_set_error)((57),(220),
# 323 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 323 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    if ((selection & 0x04) != 0) {
        ...
        if (params == 
# 329 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
# 329 "../providers/implementations/encode_decode/encode_key2text.c"
                         ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",330,__func__), ERR_set_error)((57),(226),
# 330 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 330 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
    }
    ...
    p = DSA_get0_p(dsa);
    if (p == 
# 336 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
            ((void *)0)
# 336 "../providers/implementations/encode_decode/encode_key2text.c"
                ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",337,__func__), ERR_set_error)((57),(158),
# 337 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 337 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    if (BIO_printf(out, "%s: (%d bit)\n", type_label, BN_num_bits(p)) <= 0)
        return 0;
    if (priv_key != 
# 343 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                   ((void *)0)
        
# 344 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_bignum(out, "priv:", priv_key))
        return 0;
    if (pub_key != 
# 346 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                  ((void *)0)
        
# 347 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_bignum(out, "pub: ", pub_key))
        return 0;
    if (params != 
# 349 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                 ((void *)0)
        
# 350 "../providers/implementations/encode_decode/encode_key2text.c"
       && !ffc_params_to_text(out, params))
        return 0;
                                           ...
                                           BN_CTX *ctx)
{
    ...
    BIGNUM *p = 
# 366 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
               ((void *)0)
# 366 "../providers/implementations/encode_decode/encode_key2text.c"
                   , *a = 
# 366 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                          ((void *)0)
# 366 "../providers/implementations/encode_decode/encode_key2text.c"
...
# 366 "../providers/implementations/encode_decode/encode_key2text.c"
    ...
    b = BN_CTX_get(ctx);
    if (b == 
# 371 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
            ((void *)0)
        
# 372 "../providers/implementations/encode_decode/encode_key2text.c"
       || !EC_GROUP_get_curve(group, p, a, b, ctx))
        return 0;

    if (EC_GROUP_get_field_type(group) == 407) {
...
# 395 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                           ((void *)0)
# 395 "../providers/implementations/encode_decode/encode_key2text.c"
                               ;
    const char *glabel = 
# 396 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                        ((void *)0)
# 396 "../providers/implementations/encode_decode/encode_key2text.c"
                            ;
    unsigned char *buf = 
# 397 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                        ((void *)0)
# 397 "../providers/implementations/encode_decode/encode_key2text.c"
                            ;
    ...
    if (point == 
# 402 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                ((void *)0)
# 402 "../providers/implementations/encode_decode/encode_key2text.c"
                    )
        return 0;
    ...
    CRYPTO_clear_free(buf, buflen, "../providers/implementations/encode_decode/encode_key2text.c", 424);
    return ret;
}
                                     ...
                                     OSSL_LIB_CTX *libctx)
{
    int ret = 0, tmp_nid;
    BN_CTX *ctx = 
# 433 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                 ((void *)0)
# 433 "../providers/implementations/encode_decode/encode_key2text.c"
                     ;
    const BIGNUM *order = 
# 434 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                         ((void *)0)
# 434 "../providers/implementations/encode_decode/encode_key2text.c"
                             , *cofactor = 
# 434 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                           ((void *)0)
# 434 "../providers/implementations/encode_decode/encode_key2text.c"
    ...
    if (ctx == 
# 439 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0)
# 439 "../providers/implementations/encode_decode/encode_key2text.c"
                  )
        return 0;
    BN_CTX_start(ctx);
    ...
    if (order == 
# 445 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                ((void *)0)
# 445 "../providers/implementations/encode_decode/encode_key2text.c"
                    )
        goto err;

    seed = EC_GROUP_get0_seed(group);
    if (seed != 
# 449 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
               ((void *)0)
# 449 "../providers/implementations/encode_decode/encode_key2text.c"
                   )
    ...
    if (BIO_printf(out, "Field Type: %s\n", OBJ_nid2sn(tmp_nid)) <= 0
        ...
        || (cofactor != 
# 458 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                       ((void *)0)
            
# 459 "../providers/implementations/encode_decode/encode_key2text.c"
           && !print_labeled_bignum(out, "Cofactor: ", cofactor))
        || (seed != 
# 460 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                   ((void *)0)
            
# 461 "../providers/implementations/encode_decode/encode_key2text.c"
                            ...
                            OSSL_LIB_CTX *libctx)
{
    if (EC_GROUP_get_asn1_flag(group) & 0x001) {
        ...
        return (curve_name == 
# 485 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                             ((void *)0)
                
# 486 "../providers/implementations/encode_decode/encode_key2text.c"
...
static int ec_to_text(BIO *out, const void *key, int selection)
{
    const EC_KEY *ec = key;
    const char *type_label = 
# 495 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 495 "../providers/implementations/encode_decode/encode_key2text.c"
                                ;
    unsigned char *priv = 
# 496 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                         ((void *)0)
# 496 "../providers/implementations/encode_decode/encode_key2text.c"
                             , *pub = 
# 496 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                      ((void *)0)
# 496 "../providers/implementations/encode_decode/encode_key2text.c"
    ...
    if (out == 
# 501 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0) 
# 501 "../providers/implementations/encode_decode/encode_key2text.c"
                   || ec == 
# 501 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 501 "../providers/implementations/encode_decode/encode_key2text.c"
                                ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",502,__func__), ERR_set_error)((57),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 502 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 502 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }

    if ((group = EC_KEY_get0_group(ec)) == 
# 506 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                          ((void *)0)
# 506 "../providers/implementations/encode_decode/encode_key2text.c"
                                              ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",507,__func__), ERR_set_error)((57),(158),
# 507 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 507 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    if ((selection & 0x01) != 0)
        ...
        if (EC_GROUP_get_curve_name(group) != 1172)
    ...
    if ((selection & 0x01) != 0) {
        ...
        if (priv_key == 
# 522 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                       ((void *)0)
# 522 "../providers/implementations/encode_decode/encode_key2text.c"
                           ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",523,__func__), ERR_set_error)((57),(221),
# 523 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 523 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            goto err;
        }
    ...
    if ((selection & ( 0x01 | 0x02 )) != 0) {
        ...
        if (pub_pt == 
# 533 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
# 533 "../providers/implementations/encode_decode/encode_key2text.c"
                         ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",534,__func__), ERR_set_error)((57),(220),
# 534 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 534 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            goto err;
        }

        pub_len = EC_KEY_key2buf(ec, EC_KEY_get_conv_form(ec), &pub, 
# 538 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                                                    ((void *)0)
# 538 "../providers/implementations/encode_decode/encode_key2text.c"
                                                                        );
        if (pub_len == 0)
            goto err;
    }
    ...
    if (type_label != 
# 543 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                     ((void *)0)
        
# 544 "../providers/implementations/encode_decode/encode_key2text.c"
       && BIO_printf(out, "%s: (%d bit)\n", type_label,
                      EC_GROUP_order_bits(group)) <= 0)
        goto err;
    if (priv != 
# 547 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
               ((void *)0)
        
# 548 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_buf(out, "priv:", priv, priv_len))
        goto err;
    if (pub != 
# 550 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0)
        
# 551 "../providers/implementations/encode_decode/encode_key2text.c"
       && !print_labeled_buf(out, "pub:", pub, pub_len))
        goto err;
    if ((selection & 0x04) != 0)
        ret = ec_param_to_text(out, group, ossl_ec_key_get_libctx(ec));
err:
    CRYPTO_clear_free(priv, priv_len, "../providers/implementations/encode_decode/encode_key2text.c", 556);
    CRYPTO_free(pub, "../providers/implementations/encode_decode/encode_key2text.c", 557);
    return ret;
}
# 571 "../providers/implementations/encode_decode/encode_key2text.c"
static int ecx_to_text(BIO *out, const void *key, int selection)
{
    const ECX_KEY *ecx = key;
    const char *type_label = 
# 574 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                            ((void *)0)
# 574 "../providers/implementations/encode_decode/encode_key2text.c"
                                ;

    if (out == 
# 576 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0) 
# 576 "../providers/implementations/encode_decode/encode_key2text.c"
                   || ecx == 
# 576 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                             ((void *)0)
# 576 "../providers/implementations/encode_decode/encode_key2text.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",577,__func__), ERR_set_error)((57),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 577 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 577 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        return 0;
    }
    ...
    if ((selection & 0x01) != 0) {
        if (ecx->privkey == 
# 597 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                           ((void *)0)
# 597 "../providers/implementations/encode_decode/encode_key2text.c"
                               ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",598,__func__), ERR_set_error)((57),(221),
# 598 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 598 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
        ...
        if (!ecx->haspubkey) {
            (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",609,__func__), ERR_set_error)((57),(220),
# 609 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
           ((void *)0)
# 609 "../providers/implementations/encode_decode/encode_key2text.c"
           );
            return 0;
        }
...
# 631 "../providers/implementations/encode_decode/encode_key2text.c"
static int rsa_to_text(BIO *out, const void *key, int selection)
{
    const RSA *rsa = key;
    const char *type_label = "RSA key";
    const char *modulus_label = 
# 635 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                               ((void *)0)
# 635 "../providers/implementations/encode_decode/encode_key2text.c"
                                   ;
    const char *exponent_label = 
# 636 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                ((void *)0)
# 636 "../providers/implementations/encode_decode/encode_key2text.c"
                                    ;
    const BIGNUM *rsa_d = 
# 637 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                         ((void *)0)
# 637 "../providers/implementations/encode_decode/encode_key2text.c"
                             , *rsa_n = 
# 637 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                        ((void *)0)
# 637 "../providers/implementations/encode_decode/encode_key2text.c"
...
# 637 "../providers/implementations/encode_decode/encode_key2text.c"
                                                           ;
    struct stack_st_BIGNUM_const *factors = 
# 638 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                     ((void *)0)
# 638 "../providers/implementations/encode_decode/encode_key2text.c"
                                         ;
    struct stack_st_BIGNUM_const *exps = 
# 639 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                  ((void *)0)
# 639 "../providers/implementations/encode_decode/encode_key2text.c"
                                      ;
    struct stack_st_BIGNUM_const *coeffs = 
# 640 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                    ((void *)0)
# 640 "../providers/implementations/encode_decode/encode_key2text.c"
                                        ;
    int primes;
    ...
    if (out == 
# 645 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0) 
# 645 "../providers/implementations/encode_decode/encode_key2text.c"
                   || rsa == 
# 645 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                             ((void *)0)
# 645 "../providers/implementations/encode_decode/encode_key2text.c"
                                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",646,__func__), ERR_set_error)((57),((258|((0x1 << 18L)|(0x2 << 18L)))),
# 646 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 646 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        goto err;
    }
    ...
    if (factors == 
# 654 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                  ((void *)0) 
# 654 "../providers/implementations/encode_decode/encode_key2text.c"
                       || exps == 
# 654 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                  ((void *)0) 
# 654 "../providers/implementations/encode_decode/encode_key2text.c"
...
# 654 "../providers/implementations/encode_decode/encode_key2text.c"
        ...
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",655,__func__), ERR_set_error)((57),((15 | (0x2 << 18L))),
# 655 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
       ((void *)0)
# 655 "../providers/implementations/encode_decode/encode_key2text.c"
       );
        goto err;
    }
    ...
    if ((selection & 0x01) != 0) {
        ...
        for (i = 2; i < sk_BIGNUM_const_num(factors); i++) {
            if (BIO_printf(out, "prime%d:", i + 1) <= 0)
                goto err;
            if (!print_labeled_bignum(out, 
# 710 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                          ((void *)0)
# 710 "../providers/implementations/encode_decode/encode_key2text.c"
                                              ,
            ...
            if (BIO_printf(out, "exponent%d:", i + 1) <= 0)
                goto err;
            if (!print_labeled_bignum(out, 
# 715 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                          ((void *)0)
# 715 "../providers/implementations/encode_decode/encode_key2text.c"
                                              ,
            ...
            if (BIO_printf(out, "coefficient%d:", i + 1) <= 0)
                goto err;
            if (!print_labeled_bignum(out, 
# 720 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
                                          ((void *)0)
# 720 "../providers/implementations/encode_decode/encode_key2text.c"
                                              ,
    ...
    if ((selection & 0x80) != 0) {
        switch (RSA_test_flags(rsa, 0xF000)) {
        case 0x0000:
...
static void key2text_freectx(__attribute__((unused)) void *vctx)
{
}
                           ...
                           OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg)
{
    ...
    if (out == 
# 806 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
              ((void *)0)
# 806 "../providers/implementations/encode_decode/encode_key2text.c"
                  )
        return 0;
...
# 862 "../providers/implementations/encode_decode/encode_key2text.c"
static OSSL_FUNC_encoder_import_object_fn dh2text_import_object; static OSSL_FUNC_encoder_free_object_fn dh2text_free_object; static OSSL_FUNC_encoder_encode_fn dh2text_encode; static void *dh2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_dh_keymgmt_functions, ctx, selection, params); } static void dh2text_free_object(void *key) { ossl_prov_free_key(ossl_dh_keymgmt_functions, key); } static int dh2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 862 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 862 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",862,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 862 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 862 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, dh_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_dh_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))dh2text_import_object }, { 21, (void (*)(void))dh2text_free_object }, { 11, (void (*)(void))dh2text_encode }, { 0, 
# 862 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 862 "../providers/implementations/encode_decode/encode_key2text.c"
} };
static OSSL_FUNC_encoder_import_object_fn dhx2text_import_object; static OSSL_FUNC_encoder_free_object_fn dhx2text_free_object; static OSSL_FUNC_encoder_encode_fn dhx2text_encode; static void *dhx2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_dhx_keymgmt_functions, ctx, selection, params); } static void dhx2text_free_object(void *key) { ossl_prov_free_key(ossl_dhx_keymgmt_functions, key); } static int dhx2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 863 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 863 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",863,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 863 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 863 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, dh_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_dhx_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))dhx2text_import_object }, { 21, (void (*)(void))dhx2text_free_object }, { 11, (void (*)(void))dhx2text_encode }, { 0, 
# 863 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 863 "../providers/implementations/encode_decode/encode_key2text.c"
} };
...
static OSSL_FUNC_encoder_import_object_fn dsa2text_import_object; static OSSL_FUNC_encoder_free_object_fn dsa2text_free_object; static OSSL_FUNC_encoder_encode_fn dsa2text_encode; static void *dsa2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_dsa_keymgmt_functions, ctx, selection, params); } static void dsa2text_free_object(void *key) { ossl_prov_free_key(ossl_dsa_keymgmt_functions, key); } static int dsa2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 866 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 866 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",866,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 866 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 866 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, dsa_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_dsa_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))dsa2text_import_object }, { 21, (void (*)(void))dsa2text_free_object }, { 11, (void (*)(void))dsa2text_encode }, { 0, 
# 866 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 866 "../providers/implementations/encode_decode/encode_key2text.c"
} };
...
static OSSL_FUNC_encoder_import_object_fn ec2text_import_object; static OSSL_FUNC_encoder_free_object_fn ec2text_free_object; static OSSL_FUNC_encoder_encode_fn ec2text_encode; static void *ec2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_ec_keymgmt_functions, ctx, selection, params); } static void ec2text_free_object(void *key) { ossl_prov_free_key(ossl_ec_keymgmt_functions, key); } static int ec2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 869 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 869 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",869,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 869 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 869 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ec_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_ec_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))ec2text_import_object }, { 21, (void (*)(void))ec2text_free_object }, { 11, (void (*)(void))ec2text_encode }, { 0, 
# 869 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 869 "../providers/implementations/encode_decode/encode_key2text.c"
} };

static OSSL_FUNC_encoder_import_object_fn sm22text_import_object; static OSSL_FUNC_encoder_free_object_fn sm22text_free_object; static OSSL_FUNC_encoder_encode_fn sm22text_encode; static void *sm22text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_sm2_keymgmt_functions, ctx, selection, params); } static void sm22text_free_object(void *key) { ossl_prov_free_key(ossl_sm2_keymgmt_functions, key); } static int sm22text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 871 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 871 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",871,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 871 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 871 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ec_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_sm2_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))sm22text_import_object }, { 21, (void (*)(void))sm22text_free_object }, { 11, (void (*)(void))sm22text_encode }, { 0, 
# 871 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 871 "../providers/implementations/encode_decode/encode_key2text.c"
} };
...
static OSSL_FUNC_encoder_import_object_fn ed255192text_import_object; static OSSL_FUNC_encoder_free_object_fn ed255192text_free_object; static OSSL_FUNC_encoder_encode_fn ed255192text_encode; static void *ed255192text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_ed25519_keymgmt_functions, ctx, selection, params); } static void ed255192text_free_object(void *key) { ossl_prov_free_key(ossl_ed25519_keymgmt_functions, key); } static int ed255192text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 874 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 874 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",874,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 874 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 874 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ecx_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_ed25519_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))ed255192text_import_object }, { 21, (void (*)(void))ed255192text_free_object }, { 11, (void (*)(void))ed255192text_encode }, { 0, 
# 874 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 874 "../providers/implementations/encode_decode/encode_key2text.c"
} };
static OSSL_FUNC_encoder_import_object_fn ed4482text_import_object; static OSSL_FUNC_encoder_free_object_fn ed4482text_free_object; static OSSL_FUNC_encoder_encode_fn ed4482text_encode; static void *ed4482text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_ed448_keymgmt_functions, ctx, selection, params); } static void ed4482text_free_object(void *key) { ossl_prov_free_key(ossl_ed448_keymgmt_functions, key); } static int ed4482text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 875 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 875 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",875,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 875 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 875 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ecx_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_ed448_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))ed4482text_import_object }, { 21, (void (*)(void))ed4482text_free_object }, { 11, (void (*)(void))ed4482text_encode }, { 0, 
# 875 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 875 "../providers/implementations/encode_decode/encode_key2text.c"
} };
static OSSL_FUNC_encoder_import_object_fn x255192text_import_object; static OSSL_FUNC_encoder_free_object_fn x255192text_free_object; static OSSL_FUNC_encoder_encode_fn x255192text_encode; static void *x255192text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_x25519_keymgmt_functions, ctx, selection, params); } static void x255192text_free_object(void *key) { ossl_prov_free_key(ossl_x25519_keymgmt_functions, key); } static int x255192text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 876 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 876 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",876,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 876 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 876 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ecx_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_x25519_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))x255192text_import_object }, { 21, (void (*)(void))x255192text_free_object }, { 11, (void (*)(void))x255192text_encode }, { 0, 
# 876 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 876 "../providers/implementations/encode_decode/encode_key2text.c"
} };
static OSSL_FUNC_encoder_import_object_fn x4482text_import_object; static OSSL_FUNC_encoder_free_object_fn x4482text_free_object; static OSSL_FUNC_encoder_encode_fn x4482text_encode; static void *x4482text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_x448_keymgmt_functions, ctx, selection, params); } static void x4482text_free_object(void *key) { ossl_prov_free_key(ossl_x448_keymgmt_functions, key); } static int x4482text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 877 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 877 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",877,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 877 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 877 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, ecx_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_x448_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))x4482text_import_object }, { 21, (void (*)(void))x4482text_free_object }, { 11, (void (*)(void))x4482text_encode }, { 0, 
# 877 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 877 "../providers/implementations/encode_decode/encode_key2text.c"
} };
...
static OSSL_FUNC_encoder_import_object_fn rsa2text_import_object; static OSSL_FUNC_encoder_free_object_fn rsa2text_free_object; static OSSL_FUNC_encoder_encode_fn rsa2text_encode; static void *rsa2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_rsa_keymgmt_functions, ctx, selection, params); } static void rsa2text_free_object(void *key) { ossl_prov_free_key(ossl_rsa_keymgmt_functions, key); } static int rsa2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 880 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 880 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",880,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 880 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 880 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, rsa_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_rsa_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))rsa2text_import_object }, { 21, (void (*)(void))rsa2text_free_object }, { 11, (void (*)(void))rsa2text_encode }, { 0, 
# 880 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 880 "../providers/implementations/encode_decode/encode_key2text.c"
} };
static OSSL_FUNC_encoder_import_object_fn rsapss2text_import_object; static OSSL_FUNC_encoder_free_object_fn rsapss2text_free_object; static OSSL_FUNC_encoder_encode_fn rsapss2text_encode; static void *rsapss2text_import_object(void *ctx, int selection, const OSSL_PARAM params[]) { return ossl_prov_import_key(ossl_rsapss_keymgmt_functions, ctx, selection, params); } static void rsapss2text_free_object(void *key) { ossl_prov_free_key(ossl_rsapss_keymgmt_functions, key); } static int rsapss2text_encode(void *vctx, OSSL_CORE_BIO *cout, const void *key, const OSSL_PARAM key_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK *cb, void *cbarg) { if (key_abstract != 
# 881 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 881 "../providers/implementations/encode_decode/encode_key2text.c"
) { (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/encode_key2text.c",881,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 881 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0)
# 881 "../providers/implementations/encode_decode/encode_key2text.c"
); return 0; } return key2text_encode(vctx, key, selection, cout, rsa_to_text, cb, cbarg); } const OSSL_DISPATCH ossl_rsapss_to_text_encoder_functions[] = { { 1, (void (*)(void))key2text_newctx }, { 2, (void (*)(void))key2text_freectx }, { 20, (void (*)(void))rsapss2text_import_object }, { 21, (void (*)(void))rsapss2text_free_object }, { 11, (void (*)(void))rsapss2text_encode }, { 0, 
# 881 "../providers/implementations/encode_decode/encode_key2text.c" 3 4
((void *)0) 
# 881 "../providers/implementations/encode_decode/encode_key2text.c"
} };
