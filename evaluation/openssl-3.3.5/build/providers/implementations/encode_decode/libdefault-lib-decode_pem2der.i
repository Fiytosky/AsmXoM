# 0 "../providers/implementations/encode_decode/decode_pem2der.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/encode_decode/decode_pem2der.c"
# 14 "../providers/implementations/encode_decode/decode_pem2der.c"
...
# 15 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 17 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 19 "../providers/implementations/encode_decode/decode_pem2der.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/encode_decode/decode_pem2der.c" 2
# 1 "../include/openssl/core_object.h" 1
# 12 "../include/openssl/core_object.h"
        
# 21 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 22 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 23 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 24 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 25 "../providers/implementations/encode_decode/decode_pem2der.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 26 "../providers/implementations/encode_decode/decode_pem2der.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 27 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 28 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
# 29 "../providers/implementations/encode_decode/decode_pem2der.c" 2
...
int ossl_read_der(PROV_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
                  long *len);
# 30 "../providers/implementations/encode_decode/decode_pem2der.c" 2
                    ...
                    unsigned char **data, long *len)
{
    ...
    if (in == 
# 38 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
             ((void *)0)
# 38 "../providers/implementations/encode_decode/decode_pem2der.c"
                 )
        return 0;
...
{
    struct pem2der_ctx_st *ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/encode_decode/decode_pem2der.c", 59);

    if (ctx != 
# 61 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
              ((void *)0)
# 61 "../providers/implementations/encode_decode/decode_pem2der.c"
                  )
        ctx->provctx = provctx;
    return ctx;
}
...
static void pem2der_freectx(void *vctx)
{
    ...
    CRYPTO_free(ctx, "../providers/implementations/encode_decode/decode_pem2der.c", 70);
}
...
static int pem2der_pass_helper(char *buf, int num, int w, void *data)
{
    ...
    if (pass_data == 
# 84 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                    ((void *)0)
        
# 85 "../providers/implementations/encode_decode/decode_pem2der.c"
       || pass_data->cb == 
# 85 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                           ((void *)0)
        
# 86 "../providers/implementations/encode_decode/decode_pem2der.c"
       || !pass_data->cb(buf, num, &plen, 
# 86 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                          ((void *)0)
# 86 "../providers/implementations/encode_decode/decode_pem2der.c"
                                              , pass_data->cbarg))
        return -1;
                          ...
                          OSSL_PASSPHRASE_CALLBACK *pw_cb, void *pw_cbarg)
{
    ...
    static struct pem_name_map_st {
        ...
        { "ENCRYPTED PRIVATE KEY", 2, 
# 110 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                             ((void *)0)
# 110 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                 , "EncryptedPrivateKeyInfo" },
        { "PRIVATE KEY", 2, 
# 111 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                                ((void *)0)
# 111 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                    , "PrivateKeyInfo" },
        { "PUBLIC KEY", 2, 
# 112 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                              ((void *)0)
# 112 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                  , "SubjectPublicKeyInfo" },


        { "DH PARAMETERS", 2, "DH", "type-specific" },
        { "X9.42 DH PARAMETERS", 2, "X9.42 DH", "type-specific" },
        { "DSA PRIVATE KEY", 2, "DSA", "type-specific" },
        { "DSA PUBLIC KEY", 2, "DSA", "type-specific" },
        { "DSA PARAMETERS", 2, "DSA", "type-specific" },
        { "EC PRIVATE KEY", 2, "EC", "type-specific" },
        { "EC PARAMETERS", 2, "EC", "type-specific" },
        { "SM2 PRIVATE KEY", 2, "SM2", "type-specific" },
        { "SM2 PARAMETERS", 2, "SM2", "type-specific" },
        { "RSA PRIVATE KEY", 2, "RSA", "type-specific" },
        { "RSA PUBLIC KEY", 2, "RSA", "type-specific" },
        ...
        { "CERTIFICATE", 3, 
# 132 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                            ((void *)0)
# 132 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                , "Certificate" },
        { "TRUSTED CERTIFICATE", 3, 
# 133 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                                    ((void *)0)
# 133 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                        , "Certificate" },
        { "X509 CERTIFICATE", 3, 
# 134 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                                ((void *)0)
# 134 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                    , "Certificate" },
        { "X509 CRL", 4, 
# 135 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                               ((void *)0)
# 135 "../providers/implementations/encode_decode/decode_pem2der.c"
                                                   , "CertificateList" }
    };
    struct pem2der_ctx_st *ctx = vctx;
    char *pem_name = 
# 138 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                    ((void *)0)
# 138 "../providers/implementations/encode_decode/decode_pem2der.c"
                        , *pem_header = 
# 138 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                                        ((void *)0)
# 138 "../providers/implementations/encode_decode/decode_pem2der.c"
    ...
    size_t i;
    unsigned char *der = 
# 140 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                        ((void *)0)
# 140 "../providers/implementations/encode_decode/decode_pem2der.c"
                            ;
    long der_len = 0;
    int ok = 0;
    int objtype = 0;
    ...
    for (i = 0; i < (sizeof(pem_name_map)/sizeof((pem_name_map)[0])); i++)
        if (strcmp(pem_name, pem_name_map[i].pem_name) == 0)
            break;

    if (i < (sizeof(pem_name_map)/sizeof((pem_name_map)[0]))) {
        ...
        if (data_type != 
# 188 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                        ((void *)0)
# 188 "../providers/implementations/encode_decode/decode_pem2der.c"
                            )
            *p++ =
        ...
        if (data_structure != 
# 194 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
                             ((void *)0)
# 194 "../providers/implementations/encode_decode/decode_pem2der.c"
                                 )
            *p++ =
    ...
    CRYPTO_free(pem_name, "../providers/implementations/encode_decode/decode_pem2der.c", 210);
    CRYPTO_free(pem_header, "../providers/implementations/encode_decode/decode_pem2der.c", 211);
    CRYPTO_free(der, "../providers/implementations/encode_decode/decode_pem2der.c", 212);
    return ok;
}

const OSSL_DISPATCH ossl_pem_to_der_decoder_functions[] = {
    { 1, (void (*)(void))pem2der_newctx },
    { 2, (void (*)(void))pem2der_freectx },
    { 11, (void (*)(void))pem2der_decode },
    { 0, 
# 220 "../providers/implementations/encode_decode/decode_pem2der.c" 3 4
   ((void *)0) 
# 220 "../providers/implementations/encode_decode/decode_pem2der.c"
   }
};
