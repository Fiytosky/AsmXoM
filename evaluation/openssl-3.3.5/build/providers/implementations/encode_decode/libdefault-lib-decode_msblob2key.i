# 0 "../providers/implementations/encode_decode/decode_msblob2key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/encode_decode/decode_msblob2key.c"
# 14 "../providers/implementations/encode_decode/decode_msblob2key.c"
...
# 15 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 17 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 19 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
# 1 "../include/openssl/core_object.h" 1
# 12 "../include/openssl/core_object.h"
        
# 21 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 22 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 23 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
int i2b_PVK_bio_ex(BIO *out, const EVP_PKEY *pk, int enclevel,
                   pem_password_cb *cb, void *u,
                   OSSL_LIB_CTX *libctx, const char *propq);
# 24 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 26 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 27 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
RSA *b2i_RSA_PVK_bio_ex(BIO *in, pem_password_cb *cb, void *u,
                        OSSL_LIB_CTX *libctx, const char *propq);
# 28 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 29 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 30 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
# 31 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
int ossl_read_der(PROV_CTX *provctx, OSSL_CORE_BIO *cin, unsigned char **data,
                  long *len);
# 32 "../providers/implementations/encode_decode/decode_msblob2key.c" 2
...
{
    struct msblob2key_ctx_st *ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/encode_decode/decode_msblob2key.c", 66);

    if (ctx != 
# 68 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/encode_decode/decode_msblob2key.c"
                  ) {
        ctx->provctx = provctx;
        ctx->desc = desc;
    }
...
static void msblob2key_freectx(void *vctx)
{
    ...
    CRYPTO_free(ctx, "../providers/implementations/encode_decode/decode_msblob2key.c", 79);
}
...
# 101 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                     ((void *)0)
# 101 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                         ;
    unsigned int bitlen, magic, length;
    int isdss = -1;
    int ispub = -1;
    void *key = 
# 105 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
               ((void *)0)
# 105 "../providers/implementations/encode_decode/decode_msblob2key.c"
                   ;
    int ok = 0;

    if (in == 
# 108 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
             ((void *)0)
# 108 "../providers/implementations/encode_decode/decode_msblob2key.c"
                 )
        return 0;

    if (BIO_read(in, hdr_buf, 16) != 16) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/decode_msblob2key.c",112,__func__), ERR_set_error)((9),(123),
# 112 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
       ((void *)0)
# 112 "../providers/implementations/encode_decode/decode_msblob2key.c"
       );
        goto next;
    }
    ERR_set_mark();
    ...
    if ((isdss && ctx->desc->type != 116)
        || (!isdss && ctx->desc->type != 6))
        goto next;

    length = ossl_blob_length(bitlen, isdss, ispub);
    if (length > 102400) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/decode_msblob2key.c",131,__func__), ERR_set_error)((9),(128),
# 131 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
       ((void *)0)
# 131 "../providers/implementations/encode_decode/decode_msblob2key.c"
       );
        goto next;
    }
    buf = CRYPTO_malloc(length, "../providers/implementations/encode_decode/decode_msblob2key.c", 134);
    if (buf == 
# 135 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
              ((void *)0)
# 135 "../providers/implementations/encode_decode/decode_msblob2key.c"
                  )
        goto end;
    p = buf;
    if (BIO_read(in, buf, length) != (int)length) {
        (ERR_new(), ERR_set_debug("../providers/implementations/encode_decode/decode_msblob2key.c",139,__func__), ERR_set_error)((9),(123),
# 139 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
       ((void *)0)
# 139 "../providers/implementations/encode_decode/decode_msblob2key.c"
       );
        goto next;
    }
    ...
    if ((selection == 0
         || (selection & 0x01) != 0)
        && !ispub
        && ctx->desc->read_private_key != 
# 146 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                         ((void *)0)
# 146 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                             ) {
        ...
        if (selection != 0 && key == 
# 154 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                    ((void *)0)
# 154 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                        )
            goto next;
    }
    if (key == 
# 157 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
              ((void *)0) 
# 157 "../providers/implementations/encode_decode/decode_msblob2key.c"
                   && (selection == 0
         || (selection & 0x02) != 0)
        && ispub
        && ctx->desc->read_public_key != 
# 160 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                        ((void *)0)
# 160 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                            ) {
        p = buf;
        key = ctx->desc->read_public_key(&p, bitlen, ispub);
        if (selection != 0 && key == 
# 163 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                    ((void *)0)
# 163 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                        )
            goto next;
    }

    if (key != 
# 167 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
              ((void *)0) 
# 167 "../providers/implementations/encode_decode/decode_msblob2key.c"
                   && ctx->desc->adjust_key != 
# 167 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                               ((void *)0)
# 167 "../providers/implementations/encode_decode/decode_msblob2key.c"
 ...
 next:
    ...
    CRYPTO_free(buf, "../providers/implementations/encode_decode/decode_msblob2key.c", 182);
    BIO_free(in);
    buf = 
# 184 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
         ((void *)0)
# 184 "../providers/implementations/encode_decode/decode_msblob2key.c"
             ;
    in = 
# 185 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
        ((void *)0)
# 185 "../providers/implementations/encode_decode/decode_msblob2key.c"
            ;

    if (key != 
# 187 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
              ((void *)0)
# 187 "../providers/implementations/encode_decode/decode_msblob2key.c"
                  ) {
        OSSL_PARAM params[4];
        int object_type = 2;
    ...
    BIO_free(in);
    CRYPTO_free(buf, "../providers/implementations/encode_decode/decode_msblob2key.c", 207);
...
# 223 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
                                                    ((void *)0)
# 223 "../providers/implementations/encode_decode/decode_msblob2key.c"
                                                        ) {
...
# 248 "../providers/implementations/encode_decode/decode_msblob2key.c"
...
# 287 "../providers/implementations/encode_decode/decode_msblob2key.c"
static const struct keytype_desc_st mstype2dsa_desc = { 116, "DSA", ossl_dsa_keymgmt_functions, (b2i_of_void_fn *)ossl_b2i_DSA_after_header, (b2i_of_void_fn *)ossl_b2i_DSA_after_header, 
# 287 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
((void *)0)
# 287 "../providers/implementations/encode_decode/decode_msblob2key.c"
, (void (*)(void *))DSA_free }; static OSSL_FUNC_decoder_newctx_fn msblob2dsa_newctx; static void *msblob2dsa_newctx(void *provctx) { return msblob2key_newctx(provctx, &mstype2dsa_desc); } const OSSL_DISPATCH ossl_msblob_to_dsa_decoder_functions[] = { { 1, (void (*)(void))msblob2dsa_newctx }, { 2, (void (*)(void))msblob2key_freectx }, { 10, (void (*)(void))msblob2key_does_selection }, { 11, (void (*)(void))msblob2key_decode }, { 20, (void (*)(void))msblob2key_export_object }, { 0, 
# 287 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
((void *)0) 
# 287 "../providers/implementations/encode_decode/decode_msblob2key.c"
} };

static const struct keytype_desc_st mstype2rsa_desc = { 6, "RSA", ossl_rsa_keymgmt_functions, (b2i_of_void_fn *)ossl_b2i_RSA_after_header, (b2i_of_void_fn *)ossl_b2i_RSA_after_header, rsa_adjust, (void (*)(void *))RSA_free }; static OSSL_FUNC_decoder_newctx_fn msblob2rsa_newctx; static void *msblob2rsa_newctx(void *provctx) { return msblob2key_newctx(provctx, &mstype2rsa_desc); } const OSSL_DISPATCH ossl_msblob_to_rsa_decoder_functions[] = { { 1, (void (*)(void))msblob2rsa_newctx }, { 2, (void (*)(void))msblob2key_freectx }, { 10, (void (*)(void))msblob2key_does_selection }, { 11, (void (*)(void))msblob2key_decode }, { 20, (void (*)(void))msblob2key_export_object }, { 0, 
# 289 "../providers/implementations/encode_decode/decode_msblob2key.c" 3 4
((void *)0) 
# 289 "../providers/implementations/encode_decode/decode_msblob2key.c"
} };
