# 0 "../providers/implementations/keymgmt/rsa_kmgmt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/keymgmt/rsa_kmgmt.c"
# 14 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 15 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 17 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 18 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 19 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 20 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 21 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 22 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 23 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 24 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 25 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 26 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 27 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 28 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
# 29 "../providers/implementations/keymgmt/rsa_kmgmt.c" 2
...
static void *rsa_newdata(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 84 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 84 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;

    rsa = ossl_rsa_new_with_ctx(libctx);
    if (rsa != 
# 87 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 87 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ) {
...
static void *rsapss_newdata(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 100 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 100 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;

    rsa = ossl_rsa_new_with_ctx(libctx);
    if (rsa != 
# 103 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 103 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ) {
        RSA_clear_flags(rsa, 0xF000);
...
static int rsa_has(const void *keydata, int selection)
{
    ...
    if (rsa == 
# 120 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0) 
# 120 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                   || !ossl_prov_is_running())
        return 0;
    if ((selection & (( 0x01 | 0x02 ) | 0x80)) == 0)
        return 1;


    if ((selection & ( 0x01 | 0x02 )) != 0)
        ok = ok && (RSA_get0_n(rsa) != 
# 127 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                      ((void *)0)
# 127 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                          );
    if ((selection & 0x02) != 0)
        ok = ok && (RSA_get0_e(rsa) != 
# 129 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                      ((void *)0)
# 129 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                          );
    if ((selection & 0x01) != 0)
        ok = ok && (RSA_get0_d(rsa) != 
# 131 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                      ((void *)0)
# 131 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                          );
    return ok;
}
...
static int rsa_match(const void *keydata1, const void *keydata2, int selection)
{
    ...
    if ((selection & ( 0x01 | 0x02 )) != 0) {
        ...
        if ((selection & 0x02) != 0) {
            ...
            if (pa != 
# 153 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                     ((void *)0) 
# 153 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                          && pb != 
# 153 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                   ((void *)0)
# 153 "../providers/implementations/keymgmt/rsa_kmgmt.c"
        ...
        if (!key_checked
            ...
            if (pa != 
# 163 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                     ((void *)0) 
# 163 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                          && pb != 
# 163 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                   ((void *)0)
# 163 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
static int rsa_import(void *keydata, int selection, const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_is_running() || rsa == 
# 180 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                         ((void *)0)
# 180 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                             )
        return 0;
    ...
    rsa_type = RSA_test_flags(rsa, 0xF000);
                      ...
                      OSSL_CALLBACK *param_callback, void *cbarg)
{
    ...
    OSSL_PARAM_BLD *tmpl;
    OSSL_PARAM *params = 
# 209 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                        ((void *)0)
# 209 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                            ;
    int ok = 1;

    if (!ossl_prov_is_running() || rsa == 
# 212 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                         ((void *)0)
# 212 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                             )
        return 0;
    ...
    if (tmpl == 
# 219 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
               ((void *)0)
# 219 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                   )
        return 0;
...
# 224 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                      ((void *)0)
# 224 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                                          ));
    if ((selection & ( 0x01 | 0x02 )) != 0) {
        int include_private =
            selection & 0x01 ? 1 : 0;

        ok = ok && ossl_rsa_todata(rsa, tmpl, 
# 229 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                             ((void *)0)
# 229 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                 , include_private);
    }

    if (!ok || (params = OSSL_PARAM_BLD_to_param(tmpl)) == 
# 232 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                          ((void *)0)
# 232 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                              ) {
        ok = 0;
        goto err;
    }
...
# 302 "../providers/implementations/keymgmt/rsa_kmgmt.c"
static const OSSL_PARAM rsa_key_types[] = {
    { (("n")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("e")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor1")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor2")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor3")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor4")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor5")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor6")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor7")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor8")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor9")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-factor10")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent1")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent2")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent3")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent4")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent5")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent6")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent7")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent8")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent9")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-exponent10")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient1")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient2")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient3")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient4")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient5")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient6")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient7")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient8")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("rsa-coefficient9")), (2), ((
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 303 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) },
    { 
# 304 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 304 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   , 0, 
# 304 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 304 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
static const OSSL_PARAM *rsa_imexport_types(int selection)
{
    ...
    return 
# 317 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
          ((void *)0)
# 317 "../providers/implementations/keymgmt/rsa_kmgmt.c"
              ;
}
...
static int rsa_get_params(void *key, OSSL_PARAM params[])
{
    RSA *rsa = key;
    const RSA_PSS_PARAMS_30 *pss_params = ossl_rsa_get0_pss_params_30(rsa);
    int rsa_type = RSA_test_flags(rsa, 0xF000);
    OSSL_PARAM *p;
    int empty = RSA_get0_n(rsa) == 
# 336 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                  ((void *)0)
# 336 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                      ;

    if ((p = OSSL_PARAM_locate(params, "bits")) != 
# 338 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                ((void *)0)
        
# 339 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && (empty || !OSSL_PARAM_set_int(p, RSA_bits(rsa))))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "security-bits")) != 
# 341 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                         ((void *)0)
        
# 342 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && (empty || !OSSL_PARAM_set_int(p, RSA_security_bits(rsa))))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "max-size")) != 
# 344 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                    ((void *)0)
        
# 345 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 352 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                          ((void *)0)
        
# 353 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && (rsa_type != 0x1000
            || ossl_rsa_pss_params_30_is_unrestricted(pss_params))) {
        if (!OSSL_PARAM_set_utf8_string(p, "SHA256"))
            return 0;
    }
    ...
    if ((p = OSSL_PARAM_locate(params,
                               "mandatory-digest")) != 
# 364 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                    ((void *)0)
        
# 365 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && rsa_type == 0x1000
        && !ossl_rsa_pss_params_30_is_unrestricted(pss_params)) {
        const char *mdname =
        ...
        if (mdname == 
# 370 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                     ((void *)0) 
# 370 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                          || !OSSL_PARAM_set_utf8_string(p, mdname))
            return 0;
    }
    return (rsa_type != 0x1000
            || ossl_rsa_pss_params_30_todata(pss_params, 
# 374 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                        ((void *)0)
# 374 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                            , params))
        && ossl_rsa_todata(rsa, 
# 375 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                               ((void *)0)
# 375 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                   , params, 1);
}

static const OSSL_PARAM rsa_params[] = {
    { (("bits")), (1), ((
# 379 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 379 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("security-bits")), (1), ((
# 380 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 380 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("max-size")), (1), ((
# 381 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 381 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("default-digest")), (4), ((
# 382 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 382 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), (0), ((size_t)-1) },
    { (("n")), (2), ((
# 383 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 383 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   )), ((0)), ((size_t)-1) }, { (("e")), (2), ((
# 383 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 383 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 383 "../providers/implementations/keymgmt/rsa_kmgmt.c"
    ...
    { 
# 384 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 384 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   , 0, 
# 384 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0)
# 384 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
static int rsa_gencb(int p, int n, BN_GENCB *cb)
{
    ...
    OSSL_PARAM params[] = { { 
# 443 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                           ((void *)0)
# 443 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                           , 0, 
# 443 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                           ((void *)0)
# 443 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 443 "../providers/implementations/keymgmt/rsa_kmgmt.c"
    ...
    params[0] = OSSL_PARAM_construct_int("potential", &p);
    params[1] = OSSL_PARAM_construct_int("iteration", &n);
...
{
    OSSL_LIB_CTX *libctx = ossl_prov_ctx_get0_libctx((provctx));
    struct rsa_gen_ctx *gctx = 
# 454 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                              ((void *)0)
# 454 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                  ;

    if (!ossl_prov_is_running())
        return 
# 457 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 457 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;

    if ((selection & ( 0x01 | 0x02 )) == 0)
        return 
# 460 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 460 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;

    if ((gctx = CRYPTO_zalloc(sizeof(*gctx), "../providers/implementations/keymgmt/rsa_kmgmt.c", 462)) != 
# 462 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                 ((void *)0)
# 462 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                     ) {
        gctx->libctx = libctx;
        if ((gctx->pub_exp = BN_new()) == 
# 464 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                         ((void *)0)
            
# 465 "../providers/implementations/keymgmt/rsa_kmgmt.c"
           || !BN_set_word(gctx->pub_exp, 0x10001L)) {
            goto err;
        }
        gctx->nbits = 2048;
        gctx->primes = 2;
...
err:
    if (gctx != 
# 480 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
               ((void *)0)
# 480 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                   )
        BN_free(gctx->pub_exp);
    CRYPTO_free(gctx, "../providers/implementations/keymgmt/rsa_kmgmt.c", 482);
    return 
# 483 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
          ((void *)0)
# 483 "../providers/implementations/keymgmt/rsa_kmgmt.c"
              ;
}
...
static void *rsa_gen_init(void *provctx, int selection,
                          const OSSL_PARAM params[])
{
    return gen_init(provctx, selection, 0x0000, params);
}

static void *rsapss_gen_init(void *provctx, int selection,
                             const OSSL_PARAM params[])
{
    return gen_init(provctx, selection, 0x1000, params);
}
...
static int rsa_gen_set_params(void *genctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 508 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                 ((void *)0)
# 508 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                     )
        return 1;

    if ((p = OSSL_PARAM_locate_const(params, "bits")) != 
# 511 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                          ((void *)0)
# 511 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                                              ) {
        if (!OSSL_PARAM_get_size_t(p, &gctx->nbits))
            return 0;
        if (gctx->nbits < 512) {
            (ERR_new(), ERR_set_debug("../providers/implementations/keymgmt/rsa_kmgmt.c",515,__func__), ERR_set_error)((57),(171),
# 515 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
           ((void *)0)
# 515 "../providers/implementations/keymgmt/rsa_kmgmt.c"
           );
            return 0;
        }
    }
    if ((p = OSSL_PARAM_locate_const(params, "primes")) != 
# 519 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                            ((void *)0)
        
# 520 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && !OSSL_PARAM_get_size_t(p, &gctx->primes))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "e")) != 
# 522 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                                       ((void *)0)
        
# 523 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       && !OSSL_PARAM_get_BN(p, &gctx->pub_exp))
        return 0;

    if (gctx->rsa_type == 0x1000
...
# 554 "../providers/implementations/keymgmt/rsa_kmgmt.c"
static const OSSL_PARAM *rsa_gen_settable_params(__attribute__((unused)) void *genctx,
                                                 __attribute__((unused)) void *provctx)
{
    static OSSL_PARAM settable[] = {
        { (("bits")), (2), ((
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (sizeof(size_t)), ((size_t)-1) }, { (("primes")), (2), ((
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (sizeof(size_t)), ((size_t)-1) }, { (("e")), (2), ((
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 558 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), ((0)), ((size_t)-1) },
        { 
# 559 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 559 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       , 0, 
# 559 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 559 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
static const OSSL_PARAM *rsapss_gen_settable_params(__attribute__((unused)) void *genctx,
                                                    __attribute__((unused)) void *provctx)
{
    static OSSL_PARAM settable[] = {
        { (("bits")), (2), ((
# 569 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 569 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (sizeof(size_t)), ((size_t)-1) }, { (("primes")), (2), ((
# 569 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 569 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
# 569 "../providers/implementations/keymgmt/rsa_kmgmt.c"
        ...
        { (("digest")), (4), ((
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (0), ((size_t)-1) }, { (("properties")), (4), ((
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (0), ((size_t)-1) }, { (("mgf")), (4), ((
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (0), ((size_t)-1) }, { (("mgf1-digest")), (4), ((
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (0), ((size_t)-1) }, { (("saltlen")), (1), ((
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 570 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       )), (sizeof(int)), ((size_t)-1) },
        { 
# 571 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 571 "../providers/implementations/keymgmt/rsa_kmgmt.c"
       , 0, 
# 571 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
       ((void *)0)
# 571 "../providers/implementations/keymgmt/rsa_kmgmt.c"
...
static void *rsa_gen(void *genctx, OSSL_CALLBACK *osslcb, void *cbarg)
{
    struct rsa_gen_ctx *gctx = genctx;
    RSA *rsa = 
# 580 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 580 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  , *rsa_tmp = 
# 580 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                               ((void *)0)
# 580 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                   ;
    BN_GENCB *gencb = 
# 581 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                     ((void *)0)
# 581 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                         ;

    if (!ossl_prov_is_running() || gctx == 
# 583 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                          ((void *)0)
# 583 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                              )
        return 
# 584 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 584 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;
    ...
    default:
        ...
        return 
# 600 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 600 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;
    }

    if ((rsa_tmp = ossl_rsa_new_with_ctx(gctx->libctx)) == 
# 603 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                                                          ((void *)0)
# 603 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                                              )
        return 
# 604 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 604 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;
    ...
    gencb = BN_GENCB_new();
    if (gencb != 
# 609 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                ((void *)0)
# 609 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                    )
        BN_GENCB_set(gencb, rsa_gencb, genctx);
# 619 "../providers/implementations/keymgmt/rsa_kmgmt.c"
    ...
    RSA_clear_flags(rsa_tmp, 0xF000);
    RSA_set_flags(rsa_tmp, gctx->rsa_type);

    rsa = rsa_tmp;
    rsa_tmp = 
# 632 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
             ((void *)0)
# 632 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                 ;
 err:
    BN_GENCB_free(gencb);
    RSA_free(rsa_tmp);
...
static void rsa_gen_cleanup(void *genctx)
{
    ...
    if (gctx == 
# 643 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
               ((void *)0)
# 643 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                   )
        return;
    ...
    CRYPTO_free(gctx, "../providers/implementations/keymgmt/rsa_kmgmt.c", 650);
}
...
{
    RSA *rsa = 
# 656 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
              ((void *)0)
# 656 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                  ;
    ...
    if (ossl_prov_is_running() && reference_sz == sizeof(rsa)) {
        ...
        if (RSA_test_flags(rsa, 0xF000) != expected_rsa_type)
            return 
# 663 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                  ((void *)0)
# 663 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                      ;


        *(RSA **)reference = 
# 666 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
                            ((void *)0)
# 666 "../providers/implementations/keymgmt/rsa_kmgmt.c"
                                ;
        return rsa;
    }
    return 
# 669 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
          ((void *)0)
# 669 "../providers/implementations/keymgmt/rsa_kmgmt.c"
              ;
}

static void *rsa_load(const void *reference, size_t reference_sz)
{
    return common_load(reference, reference_sz, 0x0000);
}

static void *rsapss_load(const void *reference, size_t reference_sz)
{
    return common_load(reference, reference_sz, 0x1000);
}
...
static void *rsa_dup(const void *keydata_from, int selection)
{
    if (ossl_prov_is_running()
        ...
        && (selection & ( 0x01 | 0x02 )) != 0)
        return ossl_rsa_dup(keydata_from, selection);
    return 
# 688 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
          ((void *)0)
# 688 "../providers/implementations/keymgmt/rsa_kmgmt.c"
              ;
}
...
const OSSL_DISPATCH ossl_rsa_keymgmt_functions[] = {
    { 1, (void (*)(void))rsa_newdata },
    { 2, (void (*)(void))rsa_gen_init },
    { 4,
      (void (*)(void))rsa_gen_set_params },
    { 5,
      (void (*)(void))rsa_gen_settable_params },
    { 6, (void (*)(void))rsa_gen },
    { 7, (void (*)(void))rsa_gen_cleanup },
    { 8, (void (*)(void))rsa_load },
    { 10, (void (*)(void))rsa_freedata },
    { 11, (void (*) (void))rsa_get_params },
    { 12, (void (*) (void))rsa_gettable_params },
    { 21, (void (*)(void))rsa_has },
    { 23, (void (*)(void))rsa_match },
    { 22, (void (*)(void))rsa_validate },
    { 40, (void (*)(void))rsa_import },
    { 41, (void (*)(void))rsa_import_types },
    { 42, (void (*)(void))rsa_export },
    { 43, (void (*)(void))rsa_export_types },
    { 44, (void (*)(void))rsa_dup },
    { 0, 
# 718 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0) 
# 718 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   }
};

const OSSL_DISPATCH ossl_rsapss_keymgmt_functions[] = {
    { 1, (void (*)(void))rsapss_newdata },
    { 2, (void (*)(void))rsapss_gen_init },
    { 4, (void (*)(void))rsa_gen_set_params },
    { 5,
      (void (*)(void))rsapss_gen_settable_params },
    { 6, (void (*)(void))rsa_gen },
    { 7, (void (*)(void))rsa_gen_cleanup },
    { 8, (void (*)(void))rsapss_load },
    { 10, (void (*)(void))rsa_freedata },
    { 11, (void (*) (void))rsa_get_params },
    { 12, (void (*) (void))rsa_gettable_params },
    { 21, (void (*)(void))rsa_has },
    ...
    { 44, (void (*)(void))rsa_dup },
    { 0, 
# 743 "../providers/implementations/keymgmt/rsa_kmgmt.c" 3 4
   ((void *)0) 
# 743 "../providers/implementations/keymgmt/rsa_kmgmt.c"
   }
};
