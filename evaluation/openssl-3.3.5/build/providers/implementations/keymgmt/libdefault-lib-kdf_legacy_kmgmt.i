# 0 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
# 17 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
...
# 18 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 19 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
# 20 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
# 21 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
# 22 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
# 23 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
# 24 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 2
...
KDF_DATA *ossl_kdf_data_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 34 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
              ((void *)0)
# 34 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
                  ;

    kdfdata = CRYPTO_zalloc(sizeof(*kdfdata), "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c", 36);
    if (kdfdata == 
# 37 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
                  ((void *)0)
# 37 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
                      )
        return 
# 38 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
              ((void *)0)
# 38 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
                  ;

    if (!CRYPTO_NEW_REF(&kdfdata->refcnt, 1)) {
        CRYPTO_free(kdfdata, "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c", 41);
        return 
# 42 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
              ((void *)0)
# 42 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
                  ;
    }
    kdfdata->libctx = ossl_prov_ctx_get0_libctx((provctx));
...
void ossl_kdf_data_free(KDF_DATA *kdfdata)
{
    ...
    if (kdfdata == 
# 53 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
                  ((void *)0)
# 53 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
                      )
        return;
    ...
    CRYPTO_free(kdfdata, "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c", 61);
}

int ossl_kdf_data_up_ref(KDF_DATA *kdfdata)
{
    int ref = 0;
# 75 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
    if (!ossl_prov_is_running())
        return 0;
...
const OSSL_DISPATCH ossl_kdf_keymgmt_functions[] = {
    { 1, (void (*)(void))kdf_newdata },
    { 10, (void (*)(void))kdf_freedata },
    { 21, (void (*)(void))kdf_has },
    { 0, 
# 101 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c" 3 4
   ((void *)0) 
# 101 "../providers/implementations/keymgmt/kdf_legacy_kmgmt.c"
   }
};
