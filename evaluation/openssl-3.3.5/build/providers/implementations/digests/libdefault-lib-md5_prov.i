# 0 "../providers/implementations/digests/md5_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/md5_prov.c"
# 14 "../providers/implementations/digests/md5_prov.c"
...
# 15 "../providers/implementations/digests/md5_prov.c" 2
...
# 17 "../providers/implementations/digests/md5_prov.c" 2
...
# 18 "../providers/implementations/digests/md5_prov.c" 2
...
# 19 "../providers/implementations/digests/md5_prov.c" 2
...
# 20 "../providers/implementations/digests/md5_prov.c" 2


static OSSL_FUNC_digest_init_fn md5_internal_init; static int md5_internal_init(void *ctx, __attribute__((unused)) const OSSL_PARAM params[]) { return ossl_prov_is_running() && MD5_Init(ctx); } static OSSL_FUNC_digest_newctx_fn md5_newctx; static OSSL_FUNC_digest_freectx_fn md5_freectx; static OSSL_FUNC_digest_dupctx_fn md5_dupctx; static void *md5_newctx(void *prov_ctx) { MD5_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/digests/md5_prov.c", 22) : 
# 22 "../providers/implementations/digests/md5_prov.c" 3 4
((void *)0)
# 22 "../providers/implementations/digests/md5_prov.c"
; return ctx; } static void md5_freectx(void *vctx) { MD5_CTX *ctx = (MD5_CTX *)vctx; CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/digests/md5_prov.c", 22); } static void *md5_dupctx(void *ctx) { MD5_CTX *in = (MD5_CTX *)ctx; MD5_CTX *ret = ossl_prov_is_running() ? CRYPTO_malloc(sizeof(*ret), "../providers/implementations/digests/md5_prov.c", 22) : 
# 22 "../providers/implementations/digests/md5_prov.c" 3 4
((void *)0)
# 22 "../providers/implementations/digests/md5_prov.c"
; if (ret != 
...
((void *)0)
# 22 "../providers/implementations/digests/md5_prov.c"
) *ret = *in; return ret; } static OSSL_FUNC_digest_final_fn md5_internal_final; static int md5_internal_final(void *ctx, unsigned char *out, size_t *outl, size_t outsz) { if (ossl_prov_is_running() && outsz >= 16 && MD5_Final(out, ctx)) { *outl = 16; return 1; } return 0; } static OSSL_FUNC_digest_get_params_fn md5_get_params; static int md5_get_params(OSSL_PARAM params[]) { return ossl_digest_default_get_params(params, 64, 16, 0); } const OSSL_DISPATCH ossl_md5_functions[] = { { 1, (void (*)(void))md5_newctx }, { 3, (void (*)(void))MD5_Update }, { 4, (void (*)(void))md5_internal_final }, { 6, (void (*)(void))md5_freectx }, { 7, (void (*)(void))md5_dupctx }, { 8, (void (*)(void))md5_get_params }, { 11, (void (*)(void))ossl_digest_default_gettable_params }, { 2, (void (*)(void))md5_internal_init }, { 0, 
# 22 "../providers/implementations/digests/md5_prov.c" 3 4
((void *)0) 
# 22 "../providers/implementations/digests/md5_prov.c"
} };
