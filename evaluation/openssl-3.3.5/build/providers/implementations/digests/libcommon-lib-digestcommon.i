# 0 "../providers/implementations/digests/digestcommon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/digestcommon.c"
# 10 "../providers/implementations/digests/digestcommon.c"
...
# 11 "../providers/implementations/digests/digestcommon.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 12 "../providers/implementations/digests/digestcommon.c" 2
...
# 15 "../providers/implementations/include/prov/digestcommon.h" 2
...
# 16 "../providers/implementations/include/prov/digestcommon.h" 2
...
# 13 "../providers/implementations/digests/digestcommon.c" 2

int ossl_digest_default_get_params(OSSL_PARAM params[], size_t blksz,
                                   size_t paramsz, unsigned long flags)
{
    OSSL_PARAM *p = 
# 17 "../providers/implementations/digests/digestcommon.c" 3 4
                   ((void *)0)
# 17 "../providers/implementations/digests/digestcommon.c"
                       ;

    p = OSSL_PARAM_locate(params, "blocksize");
    if (p != 
# 20 "../providers/implementations/digests/digestcommon.c" 3 4
            ((void *)0) 
# 20 "../providers/implementations/digests/digestcommon.c"
                 && !OSSL_PARAM_set_size_t(p, blksz)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/digests/digestcommon.c",21,__func__), ERR_set_error)((57),(104),
# 21 "../providers/implementations/digests/digestcommon.c" 3 4
       ((void *)0)
# 21 "../providers/implementations/digests/digestcommon.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "size");
    if (p != 
# 25 "../providers/implementations/digests/digestcommon.c" 3 4
            ((void *)0) 
# 25 "../providers/implementations/digests/digestcommon.c"
                 && !OSSL_PARAM_set_size_t(p, paramsz)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/digests/digestcommon.c",26,__func__), ERR_set_error)((57),(104),
# 26 "../providers/implementations/digests/digestcommon.c" 3 4
       ((void *)0)
# 26 "../providers/implementations/digests/digestcommon.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "xof");
    if (p != 
# 30 "../providers/implementations/digests/digestcommon.c" 3 4
            ((void *)0)
        
# 31 "../providers/implementations/digests/digestcommon.c"
       && !OSSL_PARAM_set_int(p, (flags & 0x0001) != 0)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/digests/digestcommon.c",32,__func__), ERR_set_error)((57),(104),
# 32 "../providers/implementations/digests/digestcommon.c" 3 4
       ((void *)0)
# 32 "../providers/implementations/digests/digestcommon.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "algid-absent");
    if (p != 
# 36 "../providers/implementations/digests/digestcommon.c" 3 4
            ((void *)0)
        
# 37 "../providers/implementations/digests/digestcommon.c"
       && !OSSL_PARAM_set_int(p, (flags & 0x0002) != 0)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/digests/digestcommon.c",38,__func__), ERR_set_error)((57),(104),
# 38 "../providers/implementations/digests/digestcommon.c" 3 4
       ((void *)0)
# 38 "../providers/implementations/digests/digestcommon.c"
       );
        return 0;
    }
    return 1;
...
static const OSSL_PARAM digest_default_known_gettable_params[] = {
    { (("blocksize")), (2), ((
# 45 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 45 "../providers/implementations/digests/digestcommon.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("size")), (2), ((
# 46 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 46 "../providers/implementations/digests/digestcommon.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("xof")), (1), ((
# 47 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 47 "../providers/implementations/digests/digestcommon.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("algid-absent")), (1), ((
# 48 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 48 "../providers/implementations/digests/digestcommon.c"
   )), (sizeof(int)), ((size_t)-1) },
    { 
# 49 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 49 "../providers/implementations/digests/digestcommon.c"
   , 0, 
# 49 "../providers/implementations/digests/digestcommon.c" 3 4
   ((void *)0)
# 49 "../providers/implementations/digests/digestcommon.c"
