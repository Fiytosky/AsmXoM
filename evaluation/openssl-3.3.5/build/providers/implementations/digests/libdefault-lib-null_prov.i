# 0 "../providers/implementations/digests/null_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/null_prov.c"
# 10 "../providers/implementations/digests/null_prov.c"
...
# 11 "../providers/implementations/digests/null_prov.c" 2
...
# 12 "../providers/implementations/digests/null_prov.c" 2
...
# 13 "../providers/implementations/digests/null_prov.c" 2
...
# 50 "../providers/implementations/digests/null_prov.c"
static OSSL_FUNC_digest_init_fn nullmd_internal_init; static int nullmd_internal_init(void *ctx, __attribute__((unused)) const OSSL_PARAM params[]) { return ossl_prov_is_running() && null_init(ctx); } static OSSL_FUNC_digest_newctx_fn nullmd_newctx; static OSSL_FUNC_digest_freectx_fn nullmd_freectx; static OSSL_FUNC_digest_dupctx_fn nullmd_dupctx; static void *nullmd_newctx(void *prov_ctx) { NULLMD_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/digests/null_prov.c", 50) : 
# 50 "../providers/implementations/digests/null_prov.c" 3 4
((void *)0)
# 50 "../providers/implementations/digests/null_prov.c"
; return ctx; } static void nullmd_freectx(void *vctx) { NULLMD_CTX *ctx = (NULLMD_CTX *)vctx; CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/digests/null_prov.c", 50); } static void *nullmd_dupctx(void *ctx) { NULLMD_CTX *in = (NULLMD_CTX *)ctx; NULLMD_CTX *ret = ossl_prov_is_running() ? CRYPTO_malloc(sizeof(*ret), "../providers/implementations/digests/null_prov.c", 50) : 
# 50 "../providers/implementations/digests/null_prov.c" 3 4
((void *)0)
# 50 "../providers/implementations/digests/null_prov.c"
; if (ret != 
...
((void *)0)
# 50 "../providers/implementations/digests/null_prov.c"
) *ret = *in; return ret; } static OSSL_FUNC_digest_final_fn nullmd_internal_final; static int nullmd_internal_final(void *ctx, unsigned char *out, size_t *outl, size_t outsz) { if (ossl_prov_is_running() && null_final(out, ctx)) { *outl = 0; return 1; } return 0; } static OSSL_FUNC_digest_get_params_fn nullmd_get_params; static int nullmd_get_params(OSSL_PARAM params[]) { return ossl_digest_default_get_params(params, 0, 0, 0); } const OSSL_DISPATCH ossl_nullmd_functions[] = { { 1, (void (*)(void))nullmd_newctx }, { 3, (void (*)(void))null_update }, { 4, (void (*)(void))nullmd_internal_final }, { 6, (void (*)(void))nullmd_freectx }, { 7, (void (*)(void))nullmd_dupctx }, { 8, (void (*)(void))nullmd_get_params }, { 11, (void (*)(void))ossl_digest_default_gettable_params }, { 2, (void (*)(void))nullmd_internal_init }, { 0, 
# 50 "../providers/implementations/digests/null_prov.c" 3 4
((void *)0) 
# 50 "../providers/implementations/digests/null_prov.c"
} };
