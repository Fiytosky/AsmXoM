# 0 "../providers/implementations/digests/md5_sha1_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/md5_sha1_prov.c"
# 14 "../providers/implementations/digests/md5_sha1_prov.c"
...
# 15 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 17 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 18 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 19 "../providers/implementations/digests/md5_sha1_prov.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 22 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 23 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
# 24 "../providers/implementations/digests/md5_sha1_prov.c" 2
...
static const OSSL_PARAM known_md5_sha1_settable_ctx_params[] = {
    {"ssl3-ms", 5, 
# 29 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
                                                        ((void *)0)
# 29 "../providers/implementations/digests/md5_sha1_prov.c"
                                                            , 0, 0},
    { 
# 30 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
   ((void *)0)
# 30 "../providers/implementations/digests/md5_sha1_prov.c"
   , 0, 
# 30 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
   ((void *)0)
# 30 "../providers/implementations/digests/md5_sha1_prov.c"
...
static const OSSL_PARAM *md5_sha1_settable_ctx_params(__attribute__((unused)) void *ctx,
...
static int md5_sha1_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (ctx == 
# 45 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
              ((void *)0)
# 45 "../providers/implementations/digests/md5_sha1_prov.c"
                  )
        return 0;
    if (params == 
# 47 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
                 ((void *)0)
# 47 "../providers/implementations/digests/md5_sha1_prov.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "ssl3-ms");
    if (p != 
# 51 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
            ((void *)0) 
# 51 "../providers/implementations/digests/md5_sha1_prov.c"
                 && p->data_type == 5)
        return ossl_md5_sha1_ctrl(ctx, 0x1d,
                                  p->data_size, p->data);
    return 1;
}


static OSSL_FUNC_digest_init_fn md5_sha1_internal_init; static int md5_sha1_internal_init(void *ctx, const OSSL_PARAM params[]) { return ossl_prov_is_running() && ossl_md5_sha1_init(ctx) && md5_sha1_set_ctx_params(ctx, params); } static OSSL_FUNC_digest_newctx_fn md5_sha1_newctx; static OSSL_FUNC_digest_freectx_fn md5_sha1_freectx; static OSSL_FUNC_digest_dupctx_fn md5_sha1_dupctx; static void *md5_sha1_newctx(void *prov_ctx) { MD5_SHA1_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/digests/md5_sha1_prov.c", 58) : 
# 58 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
((void *)0)
# 58 "../providers/implementations/digests/md5_sha1_prov.c"
; return ctx; } static void md5_sha1_freectx(void *vctx) { MD5_SHA1_CTX *ctx = (MD5_SHA1_CTX *)vctx; CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/digests/md5_sha1_prov.c", 58); } static void *md5_sha1_dupctx(void *ctx) { MD5_SHA1_CTX *in = (MD5_SHA1_CTX *)ctx; MD5_SHA1_CTX *ret = ossl_prov_is_running() ? CRYPTO_malloc(sizeof(*ret), "../providers/implementations/digests/md5_sha1_prov.c", 58) : 
# 58 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
((void *)0)
# 58 "../providers/implementations/digests/md5_sha1_prov.c"
; if (ret != 
...
((void *)0)
# 58 "../providers/implementations/digests/md5_sha1_prov.c"
) *ret = *in; return ret; } static OSSL_FUNC_digest_final_fn md5_sha1_internal_final; static int md5_sha1_internal_final(void *ctx, unsigned char *out, size_t *outl, size_t outsz) { if (ossl_prov_is_running() && outsz >= (16 + 20) && ossl_md5_sha1_final(out, ctx)) { *outl = (16 + 20); return 1; } return 0; } static OSSL_FUNC_digest_get_params_fn md5_sha1_get_params; static int md5_sha1_get_params(OSSL_PARAM params[]) { return ossl_digest_default_get_params(params, 64, (16 + 20), 0); } const OSSL_DISPATCH ossl_md5_sha1_functions[] = { { 1, (void (*)(void))md5_sha1_newctx }, { 3, (void (*)(void))ossl_md5_sha1_update }, { 4, (void (*)(void))md5_sha1_internal_final }, { 6, (void (*)(void))md5_sha1_freectx }, { 7, (void (*)(void))md5_sha1_dupctx }, { 8, (void (*)(void))md5_sha1_get_params }, { 11, (void (*)(void))ossl_digest_default_gettable_params }, { 2, (void (*)(void))md5_sha1_internal_init }, { 12, (void (*)(void))md5_sha1_settable_ctx_params }, { 9, (void (*)(void))md5_sha1_set_ctx_params }, { 0, 
# 58 "../providers/implementations/digests/md5_sha1_prov.c" 3 4
((void *)0) 
# 58 "../providers/implementations/digests/md5_sha1_prov.c"
} };
