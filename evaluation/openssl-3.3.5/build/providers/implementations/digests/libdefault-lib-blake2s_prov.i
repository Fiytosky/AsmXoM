# 0 "../providers/implementations/digests/blake2s_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/blake2s_prov.c"
# 17 "../providers/implementations/digests/blake2s_prov.c"
...
# 18 "../providers/implementations/digests/blake2s_prov.c" 2
...
# 19 "../providers/implementations/digests/blake2s_prov.c" 2
...
# 20 "../providers/implementations/digests/blake2s_prov.c" 2
# 1 "../providers/implementations/digests/blake2_impl.h" 1
# 18 "../providers/implementations/digests/blake2_impl.h"
# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 19 "../providers/implementations/digests/blake2_impl.h" 2
...
# 21 "../providers/implementations/digests/blake2s_prov.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 18 "../providers/implementations/include/prov/blake2.h" 2
...
# 22 "../providers/implementations/digests/blake2s_prov.c" 2
...
# 71 "../providers/implementations/digests/blake2s_prov.c" 3 4
   ((void) (0))
# 71 "../providers/implementations/digests/blake2s_prov.c"
                                      ;
                          ...
                          const void *key)
{
...

    {
        ...
        ossl_blake2s_update(c, block, 64);
        OPENSSL_cleanse(block, 64);
    }
                            ...
                            size_t len)
{
    ...
    size_t i;
    size_t increment;
# 166 "../providers/implementations/digests/blake2s_prov.c"
    
# 166 "../providers/implementations/digests/blake2s_prov.c" 3 4
   ((void) (0))
# 166 "../providers/implementations/digests/blake2s_prov.c"
                                                                    ;
# 175 "../providers/implementations/digests/blake2s_prov.c"
    increment = len < 64 ? len : 64;
...
# 226 "../providers/implementations/digests/blake2s_prov.c"
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[0][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[0][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[0][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[0][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[0][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[0][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[0][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[0][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[0][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[0][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[0][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[0][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[0][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[0][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[0][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[0][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[1][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[1][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[1][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[1][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[1][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[1][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[1][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[1][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[1][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[1][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[1][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[1][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[1][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[1][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[1][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[1][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[2][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[2][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[2][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[2][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[2][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[2][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[2][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[2][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[2][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[2][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[2][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[2][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[2][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[2][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[2][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[2][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[3][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[3][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[3][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[3][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[3][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[3][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[3][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[3][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[3][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[3][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[3][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[3][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[3][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[3][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[3][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[3][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[4][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[4][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[4][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[4][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[4][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[4][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[4][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[4][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[4][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[4][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[4][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[4][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[4][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[4][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[4][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[4][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[5][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[5][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[5][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[5][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[5][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[5][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[5][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[5][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[5][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[5][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[5][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[5][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[5][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[5][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[5][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[5][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        ...
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[7][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[7][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[7][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[7][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[7][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[7][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[7][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[7][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[7][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[7][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[7][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[7][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[7][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[7][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[7][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[7][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[8][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[8][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[8][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[8][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[8][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[8][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[8][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[8][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[8][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[8][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[8][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[8][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[8][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[8][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[8][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[8][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
        do { do { v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[9][2*0 +0]]; v[12] = rotr32(v[12] ^ v[ 0], 16); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 12); v[ 0] = v[ 0] + v[ 4] + m[blake2s_sigma[9][2*0 +1]]; v[12] = rotr32(v[12] ^ v[ 0], 8); v[ 8] = v[ 8] + v[12]; v[ 4] = rotr32(v[ 4] ^ v[ 8], 7); } while (0); do { v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[9][2*1 +0]]; v[13] = rotr32(v[13] ^ v[ 1], 16); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 12); v[ 1] = v[ 1] + v[ 5] + m[blake2s_sigma[9][2*1 +1]]; v[13] = rotr32(v[13] ^ v[ 1], 8); v[ 9] = v[ 9] + v[13]; v[ 5] = rotr32(v[ 5] ^ v[ 9], 7); } while (0); do { v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[9][2*2 +0]]; v[14] = rotr32(v[14] ^ v[ 2], 16); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 12); v[ 2] = v[ 2] + v[ 6] + m[blake2s_sigma[9][2*2 +1]]; v[14] = rotr32(v[14] ^ v[ 2], 8); v[10] = v[10] + v[14]; v[ 6] = rotr32(v[ 6] ^ v[10], 7); } while (0); do { v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[9][2*3 +0]]; v[15] = rotr32(v[15] ^ v[ 3], 16); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 12); v[ 3] = v[ 3] + v[ 7] + m[blake2s_sigma[9][2*3 +1]]; v[15] = rotr32(v[15] ^ v[ 3], 8); v[11] = v[11] + v[15]; v[ 7] = rotr32(v[ 7] ^ v[11], 7); } while (0); do { v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[9][2*4 +0]]; v[15] = rotr32(v[15] ^ v[ 0], 16); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 12); v[ 0] = v[ 0] + v[ 5] + m[blake2s_sigma[9][2*4 +1]]; v[15] = rotr32(v[15] ^ v[ 0], 8); v[10] = v[10] + v[15]; v[ 5] = rotr32(v[ 5] ^ v[10], 7); } while (0); do { v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[9][2*5 +0]]; v[12] = rotr32(v[12] ^ v[ 1], 16); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 12); v[ 1] = v[ 1] + v[ 6] + m[blake2s_sigma[9][2*5 +1]]; v[12] = rotr32(v[12] ^ v[ 1], 8); v[11] = v[11] + v[12]; v[ 6] = rotr32(v[ 6] ^ v[11], 7); } while (0); do { v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[9][2*6 +0]]; v[13] = rotr32(v[13] ^ v[ 2], 16); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 12); v[ 2] = v[ 2] + v[ 7] + m[blake2s_sigma[9][2*6 +1]]; v[13] = rotr32(v[13] ^ v[ 2], 8); v[ 8] = v[ 8] + v[13]; v[ 7] = rotr32(v[ 7] ^ v[ 8], 7); } while (0); do { v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[9][2*7 +0]]; v[14] = rotr32(v[14] ^ v[ 3], 16); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 12); v[ 3] = v[ 3] + v[ 4] + m[blake2s_sigma[9][2*7 +1]]; v[14] = rotr32(v[14] ^ v[ 3], 8); v[ 9] = v[ 9] + v[14]; v[ 4] = rotr32(v[ 4] ^ v[ 9], 7); } while (0); } while (0);
...
int ossl_blake2s_update(BLAKE2S_CTX *c, const void *data, size_t datalen)
{
    ...
    size_t fill;
# 262 "../providers/implementations/digests/blake2s_prov.c"
    fill = sizeof(c->buf) - c->buflen;
    if (datalen > fill) {
        if (c->buflen) {
            memcpy(c->buf + c->buflen, in, fill);
            blake2s_compress(c, c->buf, 64);
            c->buflen = 0;
            in += fill;
            datalen -= fill;
        }
        if (datalen > 64) {
            size_t stashlen = datalen % 64;




            stashlen = stashlen ? stashlen : 64;
            datalen -= stashlen;
...
# 285 "../providers/implementations/digests/blake2s_prov.c" 3 4
   ((void) (0))
# 285 "../providers/implementations/digests/blake2s_prov.c"
                                        ;
