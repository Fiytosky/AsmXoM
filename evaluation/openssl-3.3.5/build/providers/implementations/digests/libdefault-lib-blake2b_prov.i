# 0 "../providers/implementations/digests/blake2b_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/blake2b_prov.c"
# 17 "../providers/implementations/digests/blake2b_prov.c"
...
# 18 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 19 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 20 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 21 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 22 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 23 "../providers/implementations/digests/blake2b_prov.c" 2
...
# 76 "../providers/implementations/digests/blake2b_prov.c" 3 4
   ((void) (0))
# 76 "../providers/implementations/digests/blake2b_prov.c"
                                      ;
                                     ...
                                     size_t len)
{
    ...
    memset(P->personal + len, 0, 16 - len);
}
                          ...
                          const void *key)
{
...

    {
        ...
        ossl_blake2b_update(c, block, 128);
        OPENSSL_cleanse(block, 128);
    }
                            ...
                            size_t len)
{
    ...
    int i;
    size_t increment;
# 174 "../providers/implementations/digests/blake2b_prov.c"
    
# 174 "../providers/implementations/digests/blake2b_prov.c" 3 4
   ((void) (0))
# 174 "../providers/implementations/digests/blake2b_prov.c"
                                                                    ;
# 183 "../providers/implementations/digests/blake2b_prov.c"
    increment = len < 128 ? len : 128;
...
# 234 "../providers/implementations/digests/blake2b_prov.c"
...
int ossl_blake2b_update(BLAKE2B_CTX *c, const void *data, size_t datalen)
{
    ...
    size_t fill;
# 272 "../providers/implementations/digests/blake2b_prov.c"
    fill = sizeof(c->buf) - c->buflen;
    if (datalen > fill) {
        if (c->buflen) {
            memcpy(c->buf + c->buflen, in, fill);
            blake2b_compress(c, c->buf, 128);
            c->buflen = 0;
            in += fill;
            datalen -= fill;
        }
        if (datalen > 128) {
            size_t stashlen = datalen % 128;




            stashlen = stashlen ? stashlen : 128;
            datalen -= stashlen;
...
# 295 "../providers/implementations/digests/blake2b_prov.c" 3 4
   ((void) (0))
# 295 "../providers/implementations/digests/blake2b_prov.c"
                                        ;
