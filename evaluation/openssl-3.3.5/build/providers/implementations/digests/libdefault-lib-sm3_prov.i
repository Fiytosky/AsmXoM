# 0 "../providers/implementations/digests/sm3_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/sm3_prov.c"
# 10 "../providers/implementations/digests/sm3_prov.c"
...
# 11 "../providers/implementations/digests/sm3_prov.c" 2
...
# 12 "../providers/implementations/digests/sm3_prov.c" 2
...
# 13 "../providers/implementations/digests/sm3_prov.c" 2
...
# 14 "../providers/implementations/digests/sm3_prov.c" 2


static OSSL_FUNC_digest_init_fn sm3_internal_init; static int sm3_internal_init(void *ctx, __attribute__((unused)) const OSSL_PARAM params[]) { return ossl_prov_is_running() && ossl_sm3_init(ctx); } static OSSL_FUNC_digest_newctx_fn sm3_newctx; static OSSL_FUNC_digest_freectx_fn sm3_freectx; static OSSL_FUNC_digest_dupctx_fn sm3_dupctx; static void *sm3_newctx(void *prov_ctx) { SM3_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/digests/sm3_prov.c", 16) : 
# 16 "../providers/implementations/digests/sm3_prov.c" 3 4
((void *)0)
# 16 "../providers/implementations/digests/sm3_prov.c"
; return ctx; } static void sm3_freectx(void *vctx) { SM3_CTX *ctx = (SM3_CTX *)vctx; CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/digests/sm3_prov.c", 16); } static void *sm3_dupctx(void *ctx) { SM3_CTX *in = (SM3_CTX *)ctx; SM3_CTX *ret = ossl_prov_is_running() ? CRYPTO_malloc(sizeof(*ret), "../providers/implementations/digests/sm3_prov.c", 16) : 
# 16 "../providers/implementations/digests/sm3_prov.c" 3 4
((void *)0)
# 16 "../providers/implementations/digests/sm3_prov.c"
; if (ret != 
...
((void *)0)
# 16 "../providers/implementations/digests/sm3_prov.c"
) *ret = *in; return ret; } static OSSL_FUNC_digest_final_fn sm3_internal_final; static int sm3_internal_final(void *ctx, unsigned char *out, size_t *outl, size_t outsz) { if (ossl_prov_is_running() && outsz >= 32 && ossl_sm3_final(out, ctx)) { *outl = 32; return 1; } return 0; } static OSSL_FUNC_digest_get_params_fn sm3_get_params; static int sm3_get_params(OSSL_PARAM params[]) { return ossl_digest_default_get_params(params, 64, 32, 0); } const OSSL_DISPATCH ossl_sm3_functions[] = { { 1, (void (*)(void))sm3_newctx }, { 3, (void (*)(void))ossl_sm3_update }, { 4, (void (*)(void))sm3_internal_final }, { 6, (void (*)(void))sm3_freectx }, { 7, (void (*)(void))sm3_dupctx }, { 8, (void (*)(void))sm3_get_params }, { 11, (void (*)(void))ossl_digest_default_gettable_params }, { 2, (void (*)(void))sm3_internal_init }, { 0, 
# 16 "../providers/implementations/digests/sm3_prov.c" 3 4
((void *)0) 
# 16 "../providers/implementations/digests/sm3_prov.c"
} };
