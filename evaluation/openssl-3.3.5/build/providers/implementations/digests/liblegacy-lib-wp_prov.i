# 0 "../providers/implementations/digests/wp_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/digests/wp_prov.c"
# 14 "../providers/implementations/digests/wp_prov.c"
...
# 15 "../providers/implementations/digests/wp_prov.c" 2
...
# 17 "../providers/implementations/digests/wp_prov.c" 2
...
extern unsigned char *WHIRLPOOL(const void *inp, size_t bytes,
                                               unsigned char *md);
# 18 "../providers/implementations/digests/wp_prov.c" 2
...
# 19 "../providers/implementations/digests/wp_prov.c" 2
...
# 20 "../providers/implementations/digests/wp_prov.c" 2


static OSSL_FUNC_digest_init_fn wp_internal_init; static int wp_internal_init(void *ctx, __attribute__((unused)) const OSSL_PARAM params[]) { return ossl_prov_is_running() && WHIRLPOOL_Init(ctx); } static OSSL_FUNC_digest_newctx_fn wp_newctx; static OSSL_FUNC_digest_freectx_fn wp_freectx; static OSSL_FUNC_digest_dupctx_fn wp_dupctx; static void *wp_newctx(void *prov_ctx) { WHIRLPOOL_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/digests/wp_prov.c", 22) : 
# 22 "../providers/implementations/digests/wp_prov.c" 3 4
((void *)0)
# 22 "../providers/implementations/digests/wp_prov.c"
; return ctx; } static void wp_freectx(void *vctx) { WHIRLPOOL_CTX *ctx = (WHIRLPOOL_CTX *)vctx; CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/digests/wp_prov.c", 22); } static void *wp_dupctx(void *ctx) { WHIRLPOOL_CTX *in = (WHIRLPOOL_CTX *)ctx; WHIRLPOOL_CTX *ret = ossl_prov_is_running() ? CRYPTO_malloc(sizeof(*ret), "../providers/implementations/digests/wp_prov.c", 22) : 
# 22 "../providers/implementations/digests/wp_prov.c" 3 4
((void *)0)
# 22 "../providers/implementations/digests/wp_prov.c"
; if (ret != 
...
((void *)0)
# 22 "../providers/implementations/digests/wp_prov.c"
) *ret = *in; return ret; } static OSSL_FUNC_digest_final_fn wp_internal_final; static int wp_internal_final(void *ctx, unsigned char *out, size_t *outl, size_t outsz) { if (ossl_prov_is_running() && outsz >= (512/8) && WHIRLPOOL_Final(out, ctx)) { *outl = (512/8); return 1; } return 0; } static OSSL_FUNC_digest_get_params_fn wp_get_params; static int wp_get_params(OSSL_PARAM params[]) { return ossl_digest_default_get_params(params, 512 / 8, (512/8), 0); } const OSSL_DISPATCH ossl_wp_functions[] = { { 1, (void (*)(void))wp_newctx }, { 3, (void (*)(void))WHIRLPOOL_Update }, { 4, (void (*)(void))wp_internal_final }, { 6, (void (*)(void))wp_freectx }, { 7, (void (*)(void))wp_dupctx }, { 8, (void (*)(void))wp_get_params }, { 11, (void (*)(void))ossl_digest_default_gettable_params }, { 2, (void (*)(void))wp_internal_init }, { 0, 
# 22 "../providers/implementations/digests/wp_prov.c" 3 4
((void *)0) 
# 22 "../providers/implementations/digests/wp_prov.c"
} };
