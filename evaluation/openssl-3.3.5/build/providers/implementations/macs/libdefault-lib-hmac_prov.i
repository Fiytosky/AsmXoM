# 0 "../providers/implementations/macs/hmac_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/macs/hmac_prov.c"
# 14 "../providers/implementations/macs/hmac_prov.c"
...
# 15 "../providers/implementations/macs/hmac_prov.c" 2
...
# 17 "../providers/implementations/macs/hmac_prov.c" 2
...
# 19 "../providers/implementations/macs/hmac_prov.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/macs/hmac_prov.c" 2
...
# 21 "../providers/implementations/macs/hmac_prov.c" 2
...
# 22 "../providers/implementations/macs/hmac_prov.c" 2
...
# 23 "../providers/implementations/macs/hmac_prov.c" 2
...
# 25 "../providers/implementations/macs/hmac_prov.c" 2
...
# 27 "../providers/implementations/macs/hmac_prov.c" 2
...
# 28 "../providers/implementations/macs/hmac_prov.c" 2
...
# 29 "../providers/implementations/macs/hmac_prov.c" 2
...
# 30 "../providers/implementations/macs/hmac_prov.c" 2
...
static void *hmac_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 69 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 69 "../providers/implementations/macs/hmac_prov.c"
                  ;

    if ((macctx = CRYPTO_zalloc(sizeof(*macctx), "../providers/implementations/macs/hmac_prov.c", 71)) == 
# 71 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                     ((void *)0)
        
# 72 "../providers/implementations/macs/hmac_prov.c"
       || (macctx->ctx = HMAC_CTX_new()) == 
# 72 "../providers/implementations/macs/hmac_prov.c" 3 4
                                            ((void *)0)
# 72 "../providers/implementations/macs/hmac_prov.c"
                                                ) {
        CRYPTO_free(macctx, "../providers/implementations/macs/hmac_prov.c", 73);
        return 
# 74 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 74 "../providers/implementations/macs/hmac_prov.c"
                  ;
    }
...
static void hmac_free(void *vmacctx)
{
    ...
    if (macctx != 
# 85 "../providers/implementations/macs/hmac_prov.c" 3 4
                 ((void *)0)
# 85 "../providers/implementations/macs/hmac_prov.c"
                     ) {
        HMAC_CTX_free(macctx->ctx);
        ossl_prov_digest_reset(&macctx->digest);
        CRYPTO_clear_free(macctx->key, macctx->keylen, "../providers/implementations/macs/hmac_prov.c", 88);
        CRYPTO_free(macctx, "../providers/implementations/macs/hmac_prov.c", 89);
    }
}
...
static void *hmac_dup(void *vsrc)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 100 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 100 "../providers/implementations/macs/hmac_prov.c"
                  ;
    dst = hmac_new(src->provctx);
    if (dst == 
# 102 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 102 "../providers/implementations/macs/hmac_prov.c"
                  )
        return 
# 103 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 103 "../providers/implementations/macs/hmac_prov.c"
                  ;
    ...
    *dst = *src;
    dst->ctx = ctx;
    dst->key = 
# 108 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 108 "../providers/implementations/macs/hmac_prov.c"
                  ;
    ...
    if (!HMAC_CTX_copy(dst->ctx, src->ctx)
        ...
        hmac_free(dst);
        return 
# 114 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 114 "../providers/implementations/macs/hmac_prov.c"
                  ;
    }
    if (src->key != 
# 116 "../providers/implementations/macs/hmac_prov.c" 3 4
                   ((void *)0)
# 116 "../providers/implementations/macs/hmac_prov.c"
                       ) {
        dst->key = CRYPTO_malloc(src->keylen > 0 ? src->keylen : 1, "../providers/implementations/macs/hmac_prov.c", 117);
        if (dst->key == 
# 118 "../providers/implementations/macs/hmac_prov.c" 3 4
                       ((void *)0)
# 118 "../providers/implementations/macs/hmac_prov.c"
                           ) {
            hmac_free(dst);
            return 0;
        }
...
static int hmac_block_size(struct hmac_data_st *macctx)
{
    ...
    if (md == 
# 137 "../providers/implementations/macs/hmac_prov.c" 3 4
             ((void *)0)
# 137 "../providers/implementations/macs/hmac_prov.c"
                 )
        return 0;
                       ...
                       const unsigned char *key, size_t keylen)
{
    ...
    if (macctx->key != 
# 147 "../providers/implementations/macs/hmac_prov.c" 3 4
                      ((void *)0)
# 147 "../providers/implementations/macs/hmac_prov.c"
                          )
        CRYPTO_clear_free(macctx->key, macctx->keylen, "../providers/implementations/macs/hmac_prov.c", 148);

    macctx->key = CRYPTO_malloc(keylen > 0 ? keylen : 1, "../providers/implementations/macs/hmac_prov.c", 150);
    if (macctx->key == 
# 151 "../providers/implementations/macs/hmac_prov.c" 3 4
                      ((void *)0)
# 151 "../providers/implementations/macs/hmac_prov.c"
                          )
        return 0;
    ...
    if (key != 
# 160 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0) 
# 160 "../providers/implementations/macs/hmac_prov.c"
                   || (macctx->tls_data_size == 0 && digest != 
# 160 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                               ((void *)0)
# 160 "../providers/implementations/macs/hmac_prov.c"
                                                                   ))
                     ...
                     size_t keylen, const OSSL_PARAM params[])
{
    ...
    if (key != 
# 174 "../providers/implementations/macs/hmac_prov.c" 3 4
              ((void *)0)
# 174 "../providers/implementations/macs/hmac_prov.c"
                  )
        return hmac_setkey(macctx, key, keylen);


    return HMAC_Init_ex(macctx->ctx, 
# 178 "../providers/implementations/macs/hmac_prov.c" 3 4
                                    ((void *)0)
# 178 "../providers/implementations/macs/hmac_prov.c"
                                        , 0, 
# 178 "../providers/implementations/macs/hmac_prov.c" 3 4
                                             ((void *)0)
# 178 "../providers/implementations/macs/hmac_prov.c"
                      ...
                      size_t outsize)
{
    ...
    if (macctx->tls_data_size > 0) {
        if (macctx->tls_mac_out_size == 0)
            return 0;
        if (outl != 
# 226 "../providers/implementations/macs/hmac_prov.c" 3 4
                   ((void *)0)
# 226 "../providers/implementations/macs/hmac_prov.c"
                       )
...
static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("size")), (2), ((
# 238 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 238 "../providers/implementations/macs/hmac_prov.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("block-size")), (2), ((
# 239 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 239 "../providers/implementations/macs/hmac_prov.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 240 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 240 "../providers/implementations/macs/hmac_prov.c"
   , 0, 
# 240 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 240 "../providers/implementations/macs/hmac_prov.c"
...
static const OSSL_PARAM *hmac_gettable_ctx_params(__attribute__((unused)) void *ctx,
...
# 253 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                               ((void *)0)
            
# 254 "../providers/implementations/macs/hmac_prov.c"
           && !OSSL_PARAM_set_size_t(p, hmac_size(macctx)))
        return 0;

    if ((p = OSSL_PARAM_locate(params, "block-size")) != 
# 257 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                                     ((void *)0)
            
# 258 "../providers/implementations/macs/hmac_prov.c"
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("digest")), (4), ((
# 265 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 265 "../providers/implementations/macs/hmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("properties")), (4), ((
# 266 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 266 "../providers/implementations/macs/hmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("key")), (5), ((
# 267 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 267 "../providers/implementations/macs/hmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("digest-noinit")), (1), ((
# 268 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 268 "../providers/implementations/macs/hmac_prov.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("digest-oneshot")), (1), ((
# 269 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 269 "../providers/implementations/macs/hmac_prov.c"
   )), (sizeof(int)), ((size_t)-1) },
    { (("tls-data-size")), (2), ((
# 270 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 270 "../providers/implementations/macs/hmac_prov.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 271 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 271 "../providers/implementations/macs/hmac_prov.c"
   , 0, 
# 271 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0)
# 271 "../providers/implementations/macs/hmac_prov.c"
...
static const OSSL_PARAM *hmac_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                  __attribute__((unused)) void *provctx)
{
...
{
    struct hmac_data_st *macctx = vmacctx;
    OSSL_LIB_CTX *ctx = ossl_prov_ctx_get0_libctx((macctx->provctx));
    const OSSL_PARAM *p;

    if (params == 
# 288 "../providers/implementations/macs/hmac_prov.c" 3 4
                 ((void *)0)
# 288 "../providers/implementations/macs/hmac_prov.c"
                     )
        return 1;
...
# 294 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                                    ((void *)0)
# 294 "../providers/implementations/macs/hmac_prov.c"
                                                                        ) {
        if (p->data_type != 5)
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params,
                                     "tls-data-size")) != 
# 302 "../providers/implementations/macs/hmac_prov.c" 3 4
                                                                      ((void *)0)
# 302 "../providers/implementations/macs/hmac_prov.c"
                                                                          ) {
...
const OSSL_DISPATCH ossl_hmac_functions[] = {
    { 1, (void (*)(void))hmac_new },
    { 2, (void (*)(void))hmac_dup },
    { 3, (void (*)(void))hmac_free },
    { 4, (void (*)(void))hmac_init },
    { 5, (void (*)(void))hmac_update },
    { 6, (void (*)(void))hmac_final },
    { 11,
      (void (*)(void))hmac_gettable_ctx_params },
    { 8, (void (*)(void))hmac_get_ctx_params },
    { 12,
      (void (*)(void))hmac_settable_ctx_params },
    { 9, (void (*)(void))hmac_set_ctx_params },
    { 0, 
# 322 "../providers/implementations/macs/hmac_prov.c" 3 4
   ((void *)0) 
# 322 "../providers/implementations/macs/hmac_prov.c"
   }
};
