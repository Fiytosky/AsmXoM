# 0 "../providers/implementations/macs/siphash_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/macs/siphash_prov.c"
# 10 "../providers/implementations/macs/siphash_prov.c"
...
# 11 "../providers/implementations/macs/siphash_prov.c" 2
...
# 12 "../providers/implementations/macs/siphash_prov.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../providers/implementations/macs/siphash_prov.c" 2
...
# 14 "../providers/implementations/macs/siphash_prov.c" 2
...
# 15 "../providers/implementations/macs/siphash_prov.c" 2
...
# 16 "../providers/implementations/macs/siphash_prov.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 17 "../providers/implementations/macs/siphash_prov.c" 2
...
# 19 "../providers/implementations/macs/siphash_prov.c" 2
...
# 21 "../providers/implementations/macs/siphash_prov.c" 2
...
# 22 "../providers/implementations/macs/siphash_prov.c" 2
...
{
    return ctx->crounds != 0 ? ctx->crounds : 2;
}

static unsigned int drounds(struct siphash_data_st *ctx)
{
    return ctx->drounds != 0 ? ctx->drounds : 4;
}
...
static void *siphash_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 61 "../providers/implementations/macs/siphash_prov.c" 3 4
              ((void *)0)
# 61 "../providers/implementations/macs/siphash_prov.c"
                  ;
    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/macs/siphash_prov.c", 62);
    if (ctx != 
# 63 "../providers/implementations/macs/siphash_prov.c" 3 4
              ((void *)0)
# 63 "../providers/implementations/macs/siphash_prov.c"
                  )
        ctx->provctx = provctx;
    return ctx;
}
...
{
    CRYPTO_free(vmacctx, "../providers/implementations/macs/siphash_prov.c", 70);
}
...
static void *siphash_dup(void *vsrc)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 79 "../providers/implementations/macs/siphash_prov.c" 3 4
              ((void *)0)
# 79 "../providers/implementations/macs/siphash_prov.c"
                  ;
    sdst = CRYPTO_malloc(sizeof(*sdst), "../providers/implementations/macs/siphash_prov.c", 80);
    if (sdst == 
# 81 "../providers/implementations/macs/siphash_prov.c" 3 4
               ((void *)0)
# 81 "../providers/implementations/macs/siphash_prov.c"
                   )
        return 
# 82 "../providers/implementations/macs/siphash_prov.c" 3 4
              ((void *)0)
# 82 "../providers/implementations/macs/siphash_prov.c"
                  ;
                        ...
                        const OSSL_PARAM params[])
{
    ...
    if (key == 
# 119 "../providers/implementations/macs/siphash_prov.c" 3 4
              ((void *)0)
# 119 "../providers/implementations/macs/siphash_prov.c"
                  ) {
...
static const OSSL_PARAM *siphash_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                     __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 155 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 155 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { (("c-rounds")), (2), ((
# 156 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 156 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("d-rounds")), (2), ((
# 157 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 157 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { 
# 158 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 158 "../providers/implementations/macs/siphash_prov.c"
       , 0, 
# 158 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 158 "../providers/implementations/macs/siphash_prov.c"
...
# 169 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                               ((void *)0)
        
# 170 "../providers/implementations/macs/siphash_prov.c"
       && !OSSL_PARAM_set_size_t(p, siphash_size(vmacctx)))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "c-rounds")) != 
# 172 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                   ((void *)0)
        
# 173 "../providers/implementations/macs/siphash_prov.c"
       && !OSSL_PARAM_set_uint(p, crounds(ctx)))
        return 0;
    if ((p = OSSL_PARAM_locate(params, "d-rounds")) != 
# 175 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                   ((void *)0)
        
# 176 "../providers/implementations/macs/siphash_prov.c"
       && !OSSL_PARAM_set_uint(p, drounds(ctx)))
        return 0;
    return 1;
}

static const OSSL_PARAM *siphash_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                     void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("size")), (2), ((
# 185 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 185 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { (("key")), (5), ((
# 186 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 186 "../providers/implementations/macs/siphash_prov.c"
       )), (0), ((size_t)-1) },
        { (("c-rounds")), (2), ((
# 187 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 187 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("d-rounds")), (2), ((
# 188 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 188 "../providers/implementations/macs/siphash_prov.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { 
# 189 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 189 "../providers/implementations/macs/siphash_prov.c"
       , 0, 
# 189 "../providers/implementations/macs/siphash_prov.c" 3 4
       ((void *)0)
# 189 "../providers/implementations/macs/siphash_prov.c"
...
static int siphash_set_params(void *vmacctx, const OSSL_PARAM *params)
{
    struct siphash_data_st *ctx = vmacctx;
    const OSSL_PARAM *p = 
# 198 "../providers/implementations/macs/siphash_prov.c" 3 4
                         ((void *)0)
# 198 "../providers/implementations/macs/siphash_prov.c"
                             ;
    size_t size;

    if (params == 
# 201 "../providers/implementations/macs/siphash_prov.c" 3 4
                 ((void *)0)
# 201 "../providers/implementations/macs/siphash_prov.c"
                     )
        return 1;

    if ((p = OSSL_PARAM_locate_const(params, "size")) != 
# 204 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                     ((void *)0)
# 204 "../providers/implementations/macs/siphash_prov.c"
                                                                         ) {
    ...
    if ((p = OSSL_PARAM_locate_const(params, "c-rounds")) != 
# 210 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                         ((void *)0)
            
# 211 "../providers/implementations/macs/siphash_prov.c"
           && !OSSL_PARAM_get_uint(p, &ctx->crounds))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "d-rounds")) != 
# 213 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                         ((void *)0)
            
# 214 "../providers/implementations/macs/siphash_prov.c"
           && !OSSL_PARAM_get_uint(p, &ctx->drounds))
        return 0;
    if ((p = OSSL_PARAM_locate_const(params, "key")) != 
# 216 "../providers/implementations/macs/siphash_prov.c" 3 4
                                                                    ((void *)0)
# 216 "../providers/implementations/macs/siphash_prov.c"
                                                                        )
        if (p->data_type != 5
...
const OSSL_DISPATCH ossl_siphash_functions[] = {
    { 1, (void (*)(void))siphash_new },
    { 2, (void (*)(void))siphash_dup },
    { 3, (void (*)(void))siphash_free },
    { 4, (void (*)(void))siphash_init },
    { 5, (void (*)(void))siphash_update },
    { 6, (void (*)(void))siphash_final },
    { 11,
      (void (*)(void))siphash_gettable_ctx_params },
    { 8, (void (*)(void))siphash_get_ctx_params },
    { 12,
      (void (*)(void))siphash_settable_ctx_params },
    { 9, (void (*)(void))siphash_set_params },
    { 0, 
# 236 "../providers/implementations/macs/siphash_prov.c" 3 4
   ((void *)0) 
# 236 "../providers/implementations/macs/siphash_prov.c"
   }
};
