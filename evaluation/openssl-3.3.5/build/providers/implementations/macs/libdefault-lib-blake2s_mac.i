# 0 "../providers/implementations/macs/blake2s_mac.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/macs/blake2s_mac.c"
# 32 "../providers/implementations/macs/blake2s_mac.c"
# 1 "../providers/implementations/macs/blake2_mac_impl.c" 1
# 10 "../providers/implementations/macs/blake2_mac_impl.c"
...
# 11 "../providers/implementations/macs/blake2_mac_impl.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
# 13 "../providers/implementations/macs/blake2_mac_impl.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 14 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
# 16 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 17 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
# 18 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
# 19 "../providers/implementations/macs/blake2_mac_impl.c" 2
...
static void *blake2_mac_new(void *unused_provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 47 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
              ((void *)0)
# 47 "../providers/implementations/macs/blake2_mac_impl.c"
                  ;

    macctx = CRYPTO_zalloc(sizeof(*macctx), "../providers/implementations/macs/blake2_mac_impl.c", 49);
    if (macctx != 
# 50 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                 ((void *)0)
# 50 "../providers/implementations/macs/blake2_mac_impl.c"
                     ) {
        ossl_blake2s_param_init(&macctx->params);
...
static void *blake2_mac_dup(void *vsrc)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 63 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
              ((void *)0)
# 63 "../providers/implementations/macs/blake2_mac_impl.c"
                  ;

    dst = CRYPTO_zalloc(sizeof(*dst), "../providers/implementations/macs/blake2_mac_impl.c", 65);
    if (dst == 
# 66 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
              ((void *)0)
# 66 "../providers/implementations/macs/blake2_mac_impl.c"
                  )
        return 
# 67 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
              ((void *)0)
# 67 "../providers/implementations/macs/blake2_mac_impl.c"
                  ;
...
static void blake2_mac_free(void *vmacctx)
{
    ...
    if (macctx != 
# 77 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                 ((void *)0)
# 77 "../providers/implementations/macs/blake2_mac_impl.c"
                     ) {
        OPENSSL_cleanse(macctx->key, sizeof(macctx->key));
        CRYPTO_free(macctx, "../providers/implementations/macs/blake2_mac_impl.c", 79);
    }
}
                         ...
                         const unsigned char *key, size_t keylen)
{
    if (keylen > 32 || keylen == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/macs/blake2_mac_impl.c",94,__func__), ERR_set_error)((57),(105),
# 94 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
       ((void *)0)
# 94 "../providers/implementations/macs/blake2_mac_impl.c"
       );
        return 0;
    }
    ...
    if (keylen < 32)
        memset(macctx->key + keylen, 0, 32 - keylen);
    ossl_blake2s_param_set_key_length(&macctx->params, (uint8_t)keylen);
    return 1;
}
                           ...
                           size_t keylen, const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_is_running() || !blake2_mac_set_ctx_params(macctx, params))
        return 0;
    if (key != 
# 112 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
              ((void *)0)
# 112 "../providers/implementations/macs/blake2_mac_impl.c"
                  ) {
        if (!blake2_setkey(macctx, key, keylen))
            return 0;
    } else if (macctx->params.key_length == 0) {

        (ERR_new(), ERR_set_debug("../providers/implementations/macs/blake2_mac_impl.c",117,__func__), ERR_set_error)((57),(114),
# 117 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
       ((void *)0)
# 117 "../providers/implementations/macs/blake2_mac_impl.c"
       );
        return 0;
    }
    return ossl_blake2s_init_key(&macctx->ctx, &macctx->params, macctx->key);
}
                             ...
                             const unsigned char *data, size_t datalen)
{
    ...
    return ossl_blake2s_update(&macctx->ctx, data, datalen);
}
                            ...
                            size_t outsize)
{
    ...
    *outl = blake2_mac_size(macctx);
    return ossl_blake2s_final(out, &macctx->ctx);
}

static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("size")), (2), ((
# 148 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 148 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("block-size")), (2), ((
# 149 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 149 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 150 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 150 "../providers/implementations/macs/blake2_mac_impl.c"
   , 0, 
# 150 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 150 "../providers/implementations/macs/blake2_mac_impl.c"
...
static const OSSL_PARAM *blake2_gettable_ctx_params(__attribute__((unused)) void *ctx,
...
# 162 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                                                               ((void *)0)
            
# 163 "../providers/implementations/macs/blake2_mac_impl.c"
           && !OSSL_PARAM_set_size_t(p, blake2_mac_size(vmacctx)))
        return 0;

    if ((p = OSSL_PARAM_locate(params, "block-size")) != 
# 166 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                                                                     ((void *)0)
            
# 167 "../providers/implementations/macs/blake2_mac_impl.c"
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("size")), (2), ((
# 174 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 174 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("key")), (5), ((
# 175 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 175 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (0), ((size_t)-1) },
    { (("custom")), (5), ((
# 176 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 176 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (0), ((size_t)-1) },
    { (("salt")), (5), ((
# 177 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 177 "../providers/implementations/macs/blake2_mac_impl.c"
   )), (0), ((size_t)-1) },
    { 
# 178 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 178 "../providers/implementations/macs/blake2_mac_impl.c"
   , 0, 
# 178 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0)
# 178 "../providers/implementations/macs/blake2_mac_impl.c"
...
static const OSSL_PARAM *blake2_mac_settable_ctx_params(
            __attribute__((unused)) void *ctx, __attribute__((unused)) void *p_ctx)
{
...
static int blake2_mac_set_ctx_params(void *vmacctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 194 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                 ((void *)0)
# 194 "../providers/implementations/macs/blake2_mac_impl.c"
                     )
        return 1;

    if ((p = OSSL_PARAM_locate_const(params, "size")) != 
# 197 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                                                                     ((void *)0)
# 197 "../providers/implementations/macs/blake2_mac_impl.c"
                                                                         ) {
        size_t size;
        ...
        if (!OSSL_PARAM_get_size_t(p, &size)
            || size < 1
            || size > 32) {
            (ERR_new(), ERR_set_debug("../providers/implementations/macs/blake2_mac_impl.c",203,__func__), ERR_set_error)((57),(113),
# 203 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
           ((void *)0)
# 203 "../providers/implementations/macs/blake2_mac_impl.c"
           );
            return 0;
        }
        ossl_blake2s_param_set_digest_length(&macctx->params, (uint8_t)size);
    }

    if ((p = OSSL_PARAM_locate_const(params, "key")) != 
# 209 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                                                                    ((void *)0)
            
# 210 "../providers/implementations/macs/blake2_mac_impl.c"
           && !blake2_setkey(macctx, p->data, p->data_size))
        return 0;

    if ((p = OSSL_PARAM_locate_const(params, "custom"))
        != 
# 214 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
          ((void *)0)
# 214 "../providers/implementations/macs/blake2_mac_impl.c"
              ) {
        ...
        if (p->data_size > 8) {
            (ERR_new(), ERR_set_debug("../providers/implementations/macs/blake2_mac_impl.c",220,__func__), ERR_set_error)((57),(111),
# 220 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
           ((void *)0)
# 220 "../providers/implementations/macs/blake2_mac_impl.c"
           );
            return 0;
        }
        ossl_blake2s_param_set_personal(&macctx->params, p->data, p->data_size);
    }

    if ((p = OSSL_PARAM_locate_const(params, "salt")) != 
# 226 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
                                                                     ((void *)0)
# 226 "../providers/implementations/macs/blake2_mac_impl.c"
                                                                         ) {
        ...
        if (p->data_size > 8) {
            (ERR_new(), ERR_set_debug("../providers/implementations/macs/blake2_mac_impl.c",232,__func__), ERR_set_error)((57),(112),
# 232 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
           ((void *)0)
# 232 "../providers/implementations/macs/blake2_mac_impl.c"
           );
            return 0;
        }
        ossl_blake2s_param_set_salt(&macctx->params, p->data, p->data_size);
    }
    return 1;
}

const OSSL_DISPATCH ossl_blake2smac_functions[] = {
    { 1, (void (*)(void))blake2_mac_new },
    { 2, (void (*)(void))blake2_mac_dup },
    { 3, (void (*)(void))blake2_mac_free },
    { 4, (void (*)(void))blake2_mac_init },
    { 5, (void (*)(void))blake2_mac_update },
    { 6, (void (*)(void))blake2_mac_final },
    { 11,
      (void (*)(void))blake2_gettable_ctx_params },
    { 8, (void (*)(void))blake2_get_ctx_params },
    { 12,
      (void (*)(void))blake2_mac_settable_ctx_params },
    { 9, (void (*)(void))blake2_mac_set_ctx_params },
    { 0, 
# 253 "../providers/implementations/macs/blake2_mac_impl.c" 3 4
   ((void *)0) 
# 253 "../providers/implementations/macs/blake2_mac_impl.c"
   }
};
# 33 "../providers/implementations/macs/blake2s_mac.c" 2
