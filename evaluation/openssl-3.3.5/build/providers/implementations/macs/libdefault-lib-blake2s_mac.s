...
.L22:
	...
	movl	%eax, %esi
	movq	%rdx, %rdi
	call	ossl_blake2s_param_set_key_length@PLT
	movl	$1, %eax
.L21:
	leave
	.cfi_def_cfa 7, 8
...
.L28:
	...
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	ossl_blake2s_init_key@PLT
.L26:
	leave
	.cfi_def_cfa 7, 8
	ret
...
.L51:
	...
	movq	%rax, %rsi
	movq	%rcx, %rdi
	call	ossl_blake2s_param_set_personal@PLT
.L50:
	leaq	.LC5(%rip), %rdx
	movq	-48(%rbp), %rax
	movq	%rdx, %rsi
...
.L53:
	...
	movq	%rax, %rsi
	movq	%rcx, %rdi
	call	ossl_blake2s_param_set_salt@PLT
.L52:
	movl	$1, %eax
.L45:
	leave
...
.LFE468:
	...
	.globl	ossl_blake2smac_functions
	.section	.data.rel.ro.local
	.align 32
	.type	ossl_blake2smac_functions, @object
	.size	ossl_blake2smac_functions, 176
