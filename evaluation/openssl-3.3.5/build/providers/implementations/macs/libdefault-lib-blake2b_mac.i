# 0 "../providers/implementations/macs/blake2b_mac.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/macs/blake2b_mac.c"
# 32 "../providers/implementations/macs/blake2b_mac.c"
...
# 50 "../providers/implementations/macs/blake2_mac_impl.c"
        ...
        ossl_blake2b_param_init(&macctx->params);
...
# 94 "../providers/implementations/macs/blake2_mac_impl.c"
    ...
    if (keylen < 64)
        memset(macctx->key + keylen, 0, 64 - keylen);
    ossl_blake2b_param_set_key_length(&macctx->params, (uint8_t)keylen);
    return 1;
}
...
# 117 "../providers/implementations/macs/blake2_mac_impl.c"
    ...
    return ossl_blake2b_init_key(&macctx->ctx, &macctx->params, macctx->key);
}
                             ...
                             const unsigned char *data, size_t datalen)
{
    ...
    return ossl_blake2b_update(&macctx->ctx, data, datalen);
}
                            ...
                            size_t outsize)
{
    ...
    *outl = blake2_mac_size(macctx);
    return ossl_blake2b_final(out, &macctx->ctx);
}
...
# 203 "../providers/implementations/macs/blake2_mac_impl.c"
        ...
        ossl_blake2b_param_set_digest_length(&macctx->params, (uint8_t)size);
    }
...
# 220 "../providers/implementations/macs/blake2_mac_impl.c"
        ...
        ossl_blake2b_param_set_personal(&macctx->params, p->data, p->data_size);
    }
...
# 232 "../providers/implementations/macs/blake2_mac_impl.c"
        ...
        ossl_blake2b_param_set_salt(&macctx->params, p->data, p->data_size);
    }
    return 1;
}
...
# 33 "../providers/implementations/macs/blake2b_mac.c" 2
