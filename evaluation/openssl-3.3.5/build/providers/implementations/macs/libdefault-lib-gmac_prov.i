# 0 "../providers/implementations/macs/gmac_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/macs/gmac_prov.c"
# 10 "../providers/implementations/macs/gmac_prov.c"
...
# 11 "../providers/implementations/macs/gmac_prov.c" 2
...
# 12 "../providers/implementations/macs/gmac_prov.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 13 "../providers/implementations/macs/gmac_prov.c" 2
...
# 14 "../providers/implementations/macs/gmac_prov.c" 2
...
# 15 "../providers/implementations/macs/gmac_prov.c" 2
...
# 16 "../providers/implementations/macs/gmac_prov.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 17 "../providers/implementations/macs/gmac_prov.c" 2
...
# 19 "../providers/implementations/macs/gmac_prov.c" 2
...
# 20 "../providers/implementations/macs/gmac_prov.c" 2
...
# 21 "../providers/implementations/macs/gmac_prov.c" 2
...
# 22 "../providers/implementations/macs/gmac_prov.c" 2
...
static void gmac_free(void *vmacctx)
{
    ...
    if (macctx != 
# 51 "../providers/implementations/macs/gmac_prov.c" 3 4
                 ((void *)0)
# 51 "../providers/implementations/macs/gmac_prov.c"
                     ) {
        EVP_CIPHER_CTX_free(macctx->ctx);
        ossl_prov_cipher_reset(&macctx->cipher);
        CRYPTO_free(macctx, "../providers/implementations/macs/gmac_prov.c", 54);
    }
}
...
static void *gmac_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 63 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 63 "../providers/implementations/macs/gmac_prov.c"
                  ;

    if ((macctx = CRYPTO_zalloc(sizeof(*macctx), "../providers/implementations/macs/gmac_prov.c", 65)) == 
# 65 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                     ((void *)0)
        
# 66 "../providers/implementations/macs/gmac_prov.c"
       || (macctx->ctx = EVP_CIPHER_CTX_new()) == 
# 66 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                  ((void *)0)
# 66 "../providers/implementations/macs/gmac_prov.c"
                                                      ) {
        gmac_free(macctx);
        return 
# 68 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/macs/gmac_prov.c"
                  ;
    }
...
static void *gmac_dup(void *vsrc)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 81 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 81 "../providers/implementations/macs/gmac_prov.c"
                  ;

    dst = gmac_new(src->provctx);
    if (dst == 
# 84 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 84 "../providers/implementations/macs/gmac_prov.c"
                  )
        return 
# 85 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 85 "../providers/implementations/macs/gmac_prov.c"
                  ;
    ...
    if (!EVP_CIPHER_CTX_copy(dst->ctx, src->ctx)
        ...
        gmac_free(dst);
        return 
# 90 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 90 "../providers/implementations/macs/gmac_prov.c"
                  ;
    }
    return dst;
}
                       ...
                       const unsigned char *key, size_t keylen)
{
    ...
    if (keylen != (size_t)EVP_CIPHER_CTX_get_key_length(ctx)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/macs/gmac_prov.c",106,__func__), ERR_set_error)((57),(105),
# 106 "../providers/implementations/macs/gmac_prov.c" 3 4
       ((void *)0)
# 106 "../providers/implementations/macs/gmac_prov.c"
       );
        return 0;
    }
    if (!EVP_EncryptInit_ex(ctx, 
# 109 "../providers/implementations/macs/gmac_prov.c" 3 4
                                ((void *)0)
# 109 "../providers/implementations/macs/gmac_prov.c"
                                    , 
# 109 "../providers/implementations/macs/gmac_prov.c" 3 4
                                      ((void *)0)
# 109 "../providers/implementations/macs/gmac_prov.c"
                     ...
                     size_t keylen, const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_is_running() || !gmac_set_ctx_params(macctx, params))
        return 0;
    if (key != 
# 121 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 121 "../providers/implementations/macs/gmac_prov.c"
                  )
        return gmac_setkey(macctx, key, keylen);
    return EVP_EncryptInit_ex(macctx->ctx, 
# 123 "../providers/implementations/macs/gmac_prov.c" 3 4
                                          ((void *)0)
# 123 "../providers/implementations/macs/gmac_prov.c"
                                              , 
# 123 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                ((void *)0)
# 123 "../providers/implementations/macs/gmac_prov.c"
                       ...
                       size_t datalen)
{
    ...
    while (datalen > 0x7fffffff
# 136 "../providers/implementations/macs/gmac_prov.c"
                           ) {
        if (!EVP_EncryptUpdate(ctx, 
# 137 "../providers/implementations/macs/gmac_prov.c" 3 4
                                   ((void *)0)
# 137 "../providers/implementations/macs/gmac_prov.c"
                                       , &outlen, data, 0x7fffffff
# 137 "../providers/implementations/macs/gmac_prov.c"
                                                               ))
            return 0;
        data += 0x7fffffff
# 139 "../providers/implementations/macs/gmac_prov.c"
                      ;
        datalen -= 0x7fffffff
# 140 "../providers/implementations/macs/gmac_prov.c"
                         ;
    }
    return EVP_EncryptUpdate(ctx, 
# 142 "../providers/implementations/macs/gmac_prov.c" 3 4
                                 ((void *)0)
# 142 "../providers/implementations/macs/gmac_prov.c"
                                     , &outlen, data, datalen);
}
...
{
    OSSL_PARAM params[2] = { { 
# 148 "../providers/implementations/macs/gmac_prov.c" 3 4
                            ((void *)0)
# 148 "../providers/implementations/macs/gmac_prov.c"
                            , 0, 
# 148 "../providers/implementations/macs/gmac_prov.c" 3 4
                            ((void *)0)
# 148 "../providers/implementations/macs/gmac_prov.c"
...
static const OSSL_PARAM known_gettable_params[] = {
    { (("size")), (2), ((
# 169 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 169 "../providers/implementations/macs/gmac_prov.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 170 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 170 "../providers/implementations/macs/gmac_prov.c"
   , 0, 
# 170 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 170 "../providers/implementations/macs/gmac_prov.c"
...
# 181 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                               ((void *)0)
# 181 "../providers/implementations/macs/gmac_prov.c"
                                                                   )
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("cipher")), (4), ((
# 188 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 188 "../providers/implementations/macs/gmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("properties")), (4), ((
# 189 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 189 "../providers/implementations/macs/gmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("key")), (5), ((
# 190 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 190 "../providers/implementations/macs/gmac_prov.c"
   )), (0), ((size_t)-1) },
    { (("iv")), (5), ((
# 191 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 191 "../providers/implementations/macs/gmac_prov.c"
   )), (0), ((size_t)-1) },
    { 
# 192 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 192 "../providers/implementations/macs/gmac_prov.c"
   , 0, 
# 192 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0)
# 192 "../providers/implementations/macs/gmac_prov.c"
...
static const OSSL_PARAM *gmac_settable_ctx_params(__attribute__((unused)) void *ctx,
...
static int gmac_set_ctx_params(void *vmacctx, const OSSL_PARAM params[])
{
    struct gmac_data_st *macctx = vmacctx;
    EVP_CIPHER_CTX *ctx = macctx->ctx;
    OSSL_LIB_CTX *provctx = ossl_prov_ctx_get0_libctx((macctx->provctx));
    const OSSL_PARAM *p;

    if (params == 
# 210 "../providers/implementations/macs/gmac_prov.c" 3 4
                 ((void *)0)
# 210 "../providers/implementations/macs/gmac_prov.c"
                     )
        return 1;
    if (ctx == 
# 212 "../providers/implementations/macs/gmac_prov.c" 3 4
              ((void *)0)
# 212 "../providers/implementations/macs/gmac_prov.c"
                  )
        return 0;

    if ((p = OSSL_PARAM_locate_const(params, "cipher")) != 
# 215 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                                       ((void *)0)
# 215 "../providers/implementations/macs/gmac_prov.c"
                                                                           ) {
        ...
        if (EVP_CIPHER_get_mode(ossl_prov_cipher_cipher(&macctx->cipher))
            != 0x6) {
            (ERR_new(), ERR_set_debug("../providers/implementations/macs/gmac_prov.c",220,__func__), ERR_set_error)((57),(125),
# 220 "../providers/implementations/macs/gmac_prov.c" 3 4
           ((void *)0)
# 220 "../providers/implementations/macs/gmac_prov.c"
           );
            return 0;
        }
        if (!EVP_EncryptInit_ex(ctx, ossl_prov_cipher_cipher(&macctx->cipher),
                                ossl_prov_cipher_engine(&macctx->cipher), 
# 224 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                                         ((void *)0)
# 224 "../providers/implementations/macs/gmac_prov.c"
                                                                             ,
                                
# 225 "../providers/implementations/macs/gmac_prov.c" 3 4
                               ((void *)0)
# 225 "../providers/implementations/macs/gmac_prov.c"
                                   ))
            return 0;
    }

    if ((p = OSSL_PARAM_locate_const(params, "key")) != 
# 229 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                                    ((void *)0)
# 229 "../providers/implementations/macs/gmac_prov.c"
                                                                        )
        if (p->data_type != 5
                || !gmac_setkey(macctx, p->data, p->data_size))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "iv")) != 
# 234 "../providers/implementations/macs/gmac_prov.c" 3 4
                                                                   ((void *)0)
# 234 "../providers/implementations/macs/gmac_prov.c"
                                                                       ) {
        if (p->data_type != 5)
            return 0;
        ...
        if (EVP_CIPHER_CTX_ctrl(ctx, 0x9,
                                 p->data_size, 
# 239 "../providers/implementations/macs/gmac_prov.c" 3 4
                                              ((void *)0)
# 239 "../providers/implementations/macs/gmac_prov.c"
                                                  ) <= 0
            || !EVP_EncryptInit_ex(ctx, 
# 240 "../providers/implementations/macs/gmac_prov.c" 3 4
                                       ((void *)0)
# 240 "../providers/implementations/macs/gmac_prov.c"
                                           , 
# 240 "../providers/implementations/macs/gmac_prov.c" 3 4
                                             ((void *)0)
# 240 "../providers/implementations/macs/gmac_prov.c"
...
const OSSL_DISPATCH ossl_gmac_functions[] = {
    { 1, (void (*)(void))gmac_new },
    { 2, (void (*)(void))gmac_dup },
    { 3, (void (*)(void))gmac_free },
    { 4, (void (*)(void))gmac_init },
    { 5, (void (*)(void))gmac_update },
    { 6, (void (*)(void))gmac_final },
    { 10, (void (*)(void))gmac_gettable_params },
    { 7, (void (*)(void))gmac_get_params },
    { 12,
      (void (*)(void))gmac_settable_ctx_params },
    { 9, (void (*)(void))gmac_set_ctx_params },
    { 0, 
# 258 "../providers/implementations/macs/gmac_prov.c" 3 4
   ((void *)0) 
# 258 "../providers/implementations/macs/gmac_prov.c"
   }
};
