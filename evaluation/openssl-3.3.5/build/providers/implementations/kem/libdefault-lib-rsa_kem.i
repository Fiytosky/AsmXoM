# 0 "../providers/implementations/kem/rsa_kem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kem/rsa_kem.c"
# 14 "../providers/implementations/kem/rsa_kem.c"
...
# 15 "../providers/implementations/kem/rsa_kem.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 16 "../providers/implementations/kem/rsa_kem.c" 2
...
# 18 "../providers/implementations/kem/rsa_kem.c" 2
...
# 19 "../providers/implementations/kem/rsa_kem.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../providers/implementations/kem/rsa_kem.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 22 "../providers/implementations/kem/rsa_kem.c" 2
...
# 24 "../providers/implementations/kem/rsa_kem.c" 2
...
# 25 "../providers/implementations/kem/rsa_kem.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 26 "../providers/implementations/kem/rsa_kem.c" 2
...
# 28 "../providers/implementations/kem/rsa_kem.c" 2
...
# 29 "../providers/implementations/kem/rsa_kem.c" 2
...
# 30 "../providers/implementations/kem/rsa_kem.c" 2
...
# 55 "../providers/implementations/kem/rsa_kem.c"
typedef struct {
    OSSL_LIB_CTX *libctx;
    RSA *rsa;
    int op;
...
static int name2id(const char *name, const OSSL_ITEM *map, size_t sz)
{
    ...
    if (name == 
# 69 "../providers/implementations/kem/rsa_kem.c" 3 4
               ((void *)0)
# 69 "../providers/implementations/kem/rsa_kem.c"
                   )
        return -1;
...
{
    PROV_RSA_CTX *prsactx = CRYPTO_zalloc(sizeof(PROV_RSA_CTX), "../providers/implementations/kem/rsa_kem.c", 86);

    if (prsactx == 
# 88 "../providers/implementations/kem/rsa_kem.c" 3 4
                  ((void *)0)
# 88 "../providers/implementations/kem/rsa_kem.c"
                      )
        return 
# 89 "../providers/implementations/kem/rsa_kem.c" 3 4
              ((void *)0)
# 89 "../providers/implementations/kem/rsa_kem.c"
                  ;
...
static void rsakem_freectx(void *vprsactx)
{
    ...
    CRYPTO_free(prsactx, "../providers/implementations/kem/rsa_kem.c", 101);
}
...
static void *rsakem_dupctx(void *vprsactx)
{
    ...
    dstctx = CRYPTO_zalloc(sizeof(*srcctx), "../providers/implementations/kem/rsa_kem.c", 109);
    if (dstctx == 
# 110 "../providers/implementations/kem/rsa_kem.c" 3 4
                 ((void *)0)
# 110 "../providers/implementations/kem/rsa_kem.c"
                     )
        return 
# 111 "../providers/implementations/kem/rsa_kem.c" 3 4
              ((void *)0)
# 111 "../providers/implementations/kem/rsa_kem.c"
                  ;

    *dstctx = *srcctx;
    if (dstctx->rsa != 
# 114 "../providers/implementations/kem/rsa_kem.c" 3 4
                      ((void *)0) 
# 114 "../providers/implementations/kem/rsa_kem.c"
                           && !RSA_up_ref(dstctx->rsa)) {
        CRYPTO_free(dstctx, "../providers/implementations/kem/rsa_kem.c", 115);
        return 
# 116 "../providers/implementations/kem/rsa_kem.c" 3 4
              ((void *)0)
# 116 "../providers/implementations/kem/rsa_kem.c"
                  ;
    }
    return dstctx;
}
                       ...
                       const OSSL_PARAM params[], int operation)
{
    ...
    if (prsactx == 
# 126 "../providers/implementations/kem/rsa_kem.c" 3 4
                  ((void *)0) 
# 126 "../providers/implementations/kem/rsa_kem.c"
                       || vrsa == 
# 126 "../providers/implementations/kem/rsa_kem.c" 3 4
                                  ((void *)0)
# 126 "../providers/implementations/kem/rsa_kem.c"
...
static int rsakem_encapsulate_init(void *vprsactx, void *vrsa,
                                   const OSSL_PARAM params[])
{
    return rsakem_init(vprsactx, vrsa, params, (1<<12));
}

static int rsakem_decapsulate_init(void *vprsactx, void *vrsa,
                                   const OSSL_PARAM params[])
{
    return rsakem_init(vprsactx, vrsa, params, (1<<13));
}
...
static int rsakem_get_ctx_params(void *vprsactx, OSSL_PARAM *params)
{
    ...
    return ctx != 
# 156 "../providers/implementations/kem/rsa_kem.c" 3 4
                 ((void *)0)
# 156 "../providers/implementations/kem/rsa_kem.c"
                     ;
}

static const OSSL_PARAM known_gettable_rsakem_ctx_params[] = {
    { 
# 160 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0)
# 160 "../providers/implementations/kem/rsa_kem.c"
   , 0, 
# 160 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0)
# 160 "../providers/implementations/kem/rsa_kem.c"
...
static const OSSL_PARAM *rsakem_gettable_ctx_params(__attribute__((unused)) void *vprsactx,
...
static int rsakem_set_ctx_params(void *vprsactx, const OSSL_PARAM params[])
{
    ...
    if (prsactx == 
# 175 "../providers/implementations/kem/rsa_kem.c" 3 4
                  ((void *)0)
# 175 "../providers/implementations/kem/rsa_kem.c"
                      )
        return 0;
    if (params == 
# 177 "../providers/implementations/kem/rsa_kem.c" 3 4
                 ((void *)0)
# 177 "../providers/implementations/kem/rsa_kem.c"
                     )
        return 1;
    ...
    if (p != 
# 182 "../providers/implementations/kem/rsa_kem.c" 3 4
            ((void *)0)
# 182 "../providers/implementations/kem/rsa_kem.c"
                ) {
        if (p->data_type != 4)
            return 0;
...
static const OSSL_PARAM known_settable_rsakem_ctx_params[] = {
    { (("operation")), (4), ((
# 194 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0)
# 194 "../providers/implementations/kem/rsa_kem.c"
   )), (0), ((size_t)-1) },
    { 
# 195 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0)
# 195 "../providers/implementations/kem/rsa_kem.c"
   , 0, 
# 195 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0)
# 195 "../providers/implementations/kem/rsa_kem.c"
...
static const OSSL_PARAM *rsakem_settable_ctx_params(__attribute__((unused)) void *vprsactx,
                                                    __attribute__((unused)) void *provctx)
{
                                 ...
                                 unsigned char *out, int outlen)
{
    ...
    if (bnctx == 
# 218 "../providers/implementations/kem/rsa_kem.c" 3 4
                ((void *)0)
# 218 "../providers/implementations/kem/rsa_kem.c"
                    )
        return 0;
    ...
    z = BN_CTX_get(bnctx);
    ret = (z != 
# 230 "../providers/implementations/kem/rsa_kem.c" 3 4
               ((void *)0)
           
# 231 "../providers/implementations/kem/rsa_kem.c"
          && (BN_copy(nminus3, RSA_get0_n(rsa_pub)) != 
# 231 "../providers/implementations/kem/rsa_kem.c" 3 4
                                                       ((void *)0)
# 231 "../providers/implementations/kem/rsa_kem.c"
                                                           )
                           ...
                           unsigned char *secret, size_t *secretlen)
{
    ...
    if (out == 
# 255 "../providers/implementations/kem/rsa_kem.c" 3 4
              ((void *)0)
# 255 "../providers/implementations/kem/rsa_kem.c"
                  ) {
        if (nlen == 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kem/rsa_kem.c",257,__func__), ERR_set_error)((57),(158),
# 257 "../providers/implementations/kem/rsa_kem.c" 3 4
           ((void *)0)
# 257 "../providers/implementations/kem/rsa_kem.c"
           );
            return 0;
        }
        if (outlen == 
# 260 "../providers/implementations/kem/rsa_kem.c" 3 4
                     ((void *)0) 
# 260 "../providers/implementations/kem/rsa_kem.c"
                          && secretlen == 
# 260 "../providers/implementations/kem/rsa_kem.c" 3 4
                                          ((void *)0)
# 260 "../providers/implementations/kem/rsa_kem.c"
            ...
            return 0;
        if (outlen != 
# 262 "../providers/implementations/kem/rsa_kem.c" 3 4
                     ((void *)0)
# 262 "../providers/implementations/kem/rsa_kem.c"
                         )
            *outlen = nlen;
        if (secretlen != 
# 264 "../providers/implementations/kem/rsa_kem.c" 3 4
                        ((void *)0)
# 264 "../providers/implementations/kem/rsa_kem.c"
                            )
            *secretlen = nlen;
        return 1;
    }
    ...
    if (outlen != 
# 274 "../providers/implementations/kem/rsa_kem.c" 3 4
                 ((void *)0) 
# 274 "../providers/implementations/kem/rsa_kem.c"
                      && *outlen < nlen) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kem/rsa_kem.c",275,__func__), ERR_set_error)((57),(217),
# 275 "../providers/implementations/kem/rsa_kem.c" 3 4
       ((void *)0)
# 275 "../providers/implementations/kem/rsa_kem.c"
       );
        return 0;
    }
    ...
    ret = RSA_public_encrypt(nlen, secret, out, prsactx->rsa, 3);
    if (ret) {
        ret = 1;
        if (outlen != 
# 290 "../providers/implementations/kem/rsa_kem.c" 3 4
                     ((void *)0)
# 290 "../providers/implementations/kem/rsa_kem.c"
                         )
            *outlen = nlen;
        if (secretlen != 
# 292 "../providers/implementations/kem/rsa_kem.c" 3 4
                        ((void *)0)
# 292 "../providers/implementations/kem/rsa_kem.c"
                            )
            *secretlen = nlen;
    } else {
...
# 321 "../providers/implementations/kem/rsa_kem.c"
                          ...
                          const unsigned char *in, size_t inlen)
{
    ...
    if (out == 
# 331 "../providers/implementations/kem/rsa_kem.c" 3 4
              ((void *)0)
# 331 "../providers/implementations/kem/rsa_kem.c"
                  ) {
        if (nlen == 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kem/rsa_kem.c",333,__func__), ERR_set_error)((57),(158),
# 333 "../providers/implementations/kem/rsa_kem.c" 3 4
           ((void *)0)
# 333 "../providers/implementations/kem/rsa_kem.c"
           );
            return 0;
        }
        *outlen = nlen;
    ...
    if (inlen != nlen) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kem/rsa_kem.c",345,__func__), ERR_set_error)((57),(142),
# 345 "../providers/implementations/kem/rsa_kem.c" 3 4
       ((void *)0)
# 345 "../providers/implementations/kem/rsa_kem.c"
       );
        return 0;
    }
    ...
    if (outlen != 
# 354 "../providers/implementations/kem/rsa_kem.c" 3 4
                 ((void *)0) 
# 354 "../providers/implementations/kem/rsa_kem.c"
                      && *outlen < nlen) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kem/rsa_kem.c",355,__func__), ERR_set_error)((57),(217),
# 355 "../providers/implementations/kem/rsa_kem.c" 3 4
       ((void *)0)
# 355 "../providers/implementations/kem/rsa_kem.c"
       );
        return 0;
    }


    ret = RSA_private_decrypt(inlen, in, out, prsactx->rsa, 3);
    if (ret > 0 && outlen != 
# 361 "../providers/implementations/kem/rsa_kem.c" 3 4
                            ((void *)0)
# 361 "../providers/implementations/kem/rsa_kem.c"
                                )
        *outlen = ret;
    return ret > 0;
}
...
const OSSL_DISPATCH ossl_rsa_asym_kem_functions[] = {
    { 1, (void (*)(void))rsakem_newctx },
    { 2,
      (void (*)(void))rsakem_encapsulate_init },
    { 3, (void (*)(void))rsakem_generate },
    { 4,
      (void (*)(void))rsakem_decapsulate_init },
    { 5, (void (*)(void))rsakem_recover },
    { 6, (void (*)(void))rsakem_freectx },
    { 7, (void (*)(void))rsakem_dupctx },
    { 8,
    ...
    { 0, 
# 410 "../providers/implementations/kem/rsa_kem.c" 3 4
   ((void *)0) 
# 410 "../providers/implementations/kem/rsa_kem.c"
   }
};
