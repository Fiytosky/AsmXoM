# 0 "../providers/implementations/ciphers/cipher_chacha20_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_chacha20_hw.c"
# 12 "../providers/implementations/ciphers/cipher_chacha20_hw.c"
...
# 13 "../providers/implementations/ciphers/cipher_chacha20_hw.c" 2
                            ...
                            size_t keylen)
{
    ...
    if (key != 
# 20 "../providers/implementations/ciphers/cipher_chacha20_hw.c" 3 4
              ((void *)0)
# 20 "../providers/implementations/ciphers/cipher_chacha20_hw.c"
                  ) {
        for (i = 0; i < 32; i += 4)
            ctx->key.d[i / 4] = ( ((unsigned int)(key + i)[0]) | ((unsigned int)(key + i)[1]<<8) | ((unsigned int)(key + i)[2]<<16) | ((unsigned int)(key + i)[3]<<24) );
    }
    ctx->partial_len = 0;
    return 1;
}
...
static int chacha20_initiv(PROV_CIPHER_CTX *bctx)
{
    ...
    if (bctx->iv_set) {
        for (i = 0; i < 16; i += 4)
            ctx->counter[i / 4] = ( ((unsigned int)(bctx->oiv + i)[0]) | ((unsigned int)(bctx->oiv + i)[1]<<8) | ((unsigned int)(bctx->oiv + i)[2]<<16) | ((unsigned int)(bctx->oiv + i)[3]<<24) );
    }
    ctx->partial_len = 0;
    return 1;
}
                           ...
                           const unsigned char *in, size_t inl)
{
    ...
    rem = (unsigned int)(inl % 64);
    inl -= rem;
    ctr32 = ctx->counter[0];
    while (inl >= 64) {
        size_t blocks = inl / 64;
    ...
    if (rem > 0) {
        ...
        ChaCha20_ctr32(ctx->buf, ctx->buf, 64,
