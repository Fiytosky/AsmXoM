# 0 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c"
# 14 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c" 2
                            ...
                            size_t keylen)
{
    ...
    ossl_aria_set_encrypt_key(key, keylen * 8, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)ossl_aria_encrypt); ctx->ctr = (ctr128_f)
# 22 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c" 3 4
   ((void *)0)
# 22 "../providers/implementations/ciphers/cipher_aria_gcm_hw.c"
   ; ctx->key_set = 1;;
    return 1;
}
