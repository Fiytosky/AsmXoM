# 0 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
# 14 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
...
# 15 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
int RAND_poll(void);
# 18 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 19 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
# 1 "../providers/implementations/ciphers/cipher_tdes_default.h" 1
# 10 "../providers/implementations/ciphers/cipher_tdes_default.h"
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 11 "../providers/implementations/ciphers/cipher_tdes_default.h" 2
# 1 "../providers/implementations/ciphers/cipher_tdes.h" 1
# 10 "../providers/implementations/ciphers/cipher_tdes.h"
...
void DES_ofb64_encrypt(const unsigned char *in, unsigned char *out,
                       long length, DES_key_schedule *schedule,
                       DES_cblock *ivec, int *num);
# 11 "../providers/implementations/ciphers/cipher_tdes.h" 2

# 1 "../include/crypto/des_platform.h" 1
# 12 "../include/crypto/des_platform.h"
        
# 13 "../providers/implementations/ciphers/cipher_tdes.h" 2
...
# 73 "../providers/implementations/ciphers/cipher_tdes.h"
...
# 93 "../providers/implementations/ciphers/cipher_tdes.h"
...
# 12 "../providers/implementations/ciphers/cipher_tdes_default.h" 2
...
# 20 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 21 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
# 23 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
...
# 24 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 2
                           ...
                           const unsigned char *in, size_t inl)
{
    ...
    if (inl < 24)
        return -1;
    if (out == 
# 43 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
              ((void *)0)
# 43 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
                  )
        return inl - 16;
    ...
    BUF_reverse(icv, 
# 62 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
                    ((void *)0)
# 62 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
                        , 8);
    BUF_reverse(out, 
# 63 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
                    ((void *)0)
# 63 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
                        , inl - 16);
                         ...
                         const unsigned char *in, size_t inl)
{
    ...
    if (out == 
# 89 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
              ((void *)0)
# 89 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
                  )
        return len;
    ...
    BUF_reverse(out, 
# 105 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
                    ((void *)0)
# 105 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
                        , len);
                            ...
                            const unsigned char *in, size_t inl)
{
    ...
    *outl = 0;
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_tdes_wrap.c",139,__func__), ERR_set_error)((57),(106),
# 139 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
       ((void *)0)
# 139 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
       );
        return 0;
    }
                            ...
                            size_t inl)
{
    *outl = 0;
    if (inl == 0)
        return 1;
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_tdes_wrap.c",159,__func__), ERR_set_error)((57),(106),
# 159 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
       ((void *)0)
# 159 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
       );
        return 0;
    }

    if (!tdes_wrap_cipher(vctx, out, outl, outsize, in, inl)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_tdes_wrap.c",164,__func__), ERR_set_error)((57),(102),
# 164 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
       ((void *)0)
# 164 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
       );
        return 0;
    }
    return 1;
}
# 210 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
static OSSL_FUNC_cipher_newctx_fn tdes_wrap_newctx; static void *tdes_wrap_newctx(void *provctx) { return ossl_tdes_newctx(provctx, 0x10002, 64*3, 64, 0, 0x0002 | 0x0010, ossl_prov_cipher_hw_tdes_wrap_cbc()); } static OSSL_FUNC_cipher_get_params_fn tdes_wrap_get_params; static int tdes_wrap_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, 0x0002 | 0x0010, 64*3, 64, 0); } const OSSL_DISPATCH ossl_tdes_wrap_cbc_functions[] = { { 2, (void (*)(void)) ossl_tdes_einit }, { 3, (void (*)(void)) ossl_tdes_dinit }, { 6, (void (*)(void))tdes_wrap_cipher }, { 1, (void (*)(void))tdes_wrap_newctx }, { 7, (void (*)(void))ossl_tdes_freectx }, { 4, (void (*)(void))tdes_wrap_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 9, (void (*)(void))tdes_wrap_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_tdes_get_ctx_params }, { 13, (void (*)(void))ossl_tdes_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 210 "../providers/implementations/ciphers/cipher_tdes_wrap.c" 3 4
((void *)0) 
# 210 "../providers/implementations/ciphers/cipher_tdes_wrap.c"
} };
