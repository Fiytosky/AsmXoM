# 0 "../providers/implementations/ciphers/ciphercommon_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_hw.c"
# 10 "../providers/implementations/ciphers/ciphercommon_hw.c"
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 11 "../providers/implementations/ciphers/ciphercommon_hw.c" 2
                               ...
                               const unsigned char *in, size_t inl)
{
    while (inl >= ((size_t)1 << 30)) {
        ossl_cipher_hw_generic_cbc(ctx, out, in, ((size_t)1 << 30));
        inl -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    }
...
{
    while (inl >= ((size_t)1 << 30)) {
        ossl_cipher_hw_generic_ofb128(ctx, out, in, ((size_t)1 << 30));
        inl -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    }
