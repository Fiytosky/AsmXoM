# 0 "../providers/implementations/ciphers/cipher_des_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_des_hw.c"
# 14 "../providers/implementations/ciphers/cipher_des_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_des_hw.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 17 "../providers/implementations/ciphers/cipher_des_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_des_hw.c" 2
                                 ...
                                 const unsigned char *key, size_t keylen)
{
    ...
    dctx->dstream.cbc = 
# 26 "../providers/implementations/ciphers/cipher_des_hw.c" 3 4
                       ((void *)0)
# 26 "../providers/implementations/ciphers/cipher_des_hw.c"
                           ;
# 37 "../providers/implementations/ciphers/cipher_des_hw.c"
                                    ...
                                    const unsigned char *in, size_t len)
{
    ...
    if (dctx->dstream.cbc != 
# 71 "../providers/implementations/ciphers/cipher_des_hw.c" 3 4
                            ((void *)0)
# 71 "../providers/implementations/ciphers/cipher_des_hw.c"
                                ) {
        (*dctx->dstream.cbc) (in, out, len, key, ctx->iv);
        return 1;
    }

    while (len >= ((size_t)1 << 30)) {
        DES_ncbc_encrypt(in, out, ((size_t)1 << 30), key, (DES_cblock *)ctx->iv,
                         ctx->enc);
        len -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
                                      ...
                                      const unsigned char *in, size_t len)
{
    ...
    while (len >= ((size_t)1 << 30)) {
        DES_ofb64_encrypt(in, out, ((size_t)1 << 30), key, (DES_cblock *)ctx->iv, &num);
        len -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    }
                                     ...
                                     const unsigned char *in, size_t inl)
{
    ...
    while (inl >= ((size_t)1 << 30)) {
        DES_cfb_encrypt(in, out, 8, (long)((size_t)1 << 30), key,
...
# 192 "../providers/implementations/ciphers/cipher_des_hw.c"
static const PROV_CIPHER_HW des_ecb = { cipher_hw_des_initkey, cipher_hw_des_ecb_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_ecb(void) { return &des_ecb; }
static const PROV_CIPHER_HW des_cbc = { cipher_hw_des_initkey, cipher_hw_des_cbc_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_cbc(void) { return &des_cbc; }
static const PROV_CIPHER_HW des_ofb64 = { cipher_hw_des_initkey, cipher_hw_des_ofb64_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_ofb64(void) { return &des_ofb64; }
static const PROV_CIPHER_HW des_cfb64 = { cipher_hw_des_initkey, cipher_hw_des_cfb64_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_cfb64(void) { return &des_cfb64; }
static const PROV_CIPHER_HW des_cfb1 = { cipher_hw_des_initkey, cipher_hw_des_cfb1_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_cfb1(void) { return &des_cfb1; }
static const PROV_CIPHER_HW des_cfb8 = { cipher_hw_des_initkey, cipher_hw_des_cfb8_cipher, cipher_hw_des_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_des_cfb8(void) { return &des_cfb8; }
