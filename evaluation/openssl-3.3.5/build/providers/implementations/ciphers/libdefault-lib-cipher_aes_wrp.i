# 0 "../providers/implementations/ciphers/cipher_aes_wrp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_wrp.c"
# 14 "../providers/implementations/ciphers/cipher_aes_wrp.c"
...
# 15 "../providers/implementations/ciphers/cipher_aes_wrp.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_aes_wrp.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_aes_wrp.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_wrp.c" 2
...
# 20 "../providers/implementations/ciphers/cipher_aes_wrp.c" 2
# 28 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                             ...
                             size_t ivbits, unsigned int mode, uint64_t flags)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 57 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 57 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  ;

    wctx = CRYPTO_zalloc(sizeof(*wctx), "../providers/implementations/ciphers/cipher_aes_wrp.c", 59);
    ctx = (PROV_CIPHER_CTX *)wctx;
    if (ctx != 
# 61 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 61 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  ) {
        ossl_cipher_generic_initkey(ctx, kbits, blkbits, ivbits, mode, flags,
                                    
# 63 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                                   ((void *)0)
# 63 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                                       , 
# 63 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                                         ((void *)0)
# 63 "../providers/implementations/ciphers/cipher_aes_wrp.c"
...
static void *aes_wrap_dupctx(void *wctx)
{
    ...
    if (ctx == 
# 74 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 74 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  )
        return 
# 75 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 75 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  ;
    dctx = CRYPTO_memdup((ctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_wrp.c", 76);

    if (dctx != 
# 78 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
               ((void *)0) 
# 78 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                    && dctx->base.tlsmac != 
# 78 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                                            ((void *)0) 
# 78 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                                                 && dctx->base.alloced) {
        dctx->base.tlsmac = CRYPTO_memdup((dctx->base.tlsmac), dctx->base.tlsmacsize, "../providers/implementations/ciphers/cipher_aes_wrp.c", 79)
                                                                 ;
        if (dctx->base.tlsmac == 
# 81 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                                ((void *)0)
# 81 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                                    ) {
            CRYPTO_free(dctx, "../providers/implementations/ciphers/cipher_aes_wrp.c", 82);
            dctx = 
# 83 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                  ((void *)0)
# 83 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                      ;
        }
    }
    return dctx;
...
static void aes_wrap_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(wctx, sizeof(*wctx), "../providers/implementations/ciphers/cipher_aes_wrp.c", 94);
}
                         ...
                         size_t ivlen, const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 113 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
             ((void *)0)
# 113 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                 ) {
        if (!ossl_cipher_generic_initiv(ctx, iv, ivlen))
            return 0;
    }
    if (key != 
# 117 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 117 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  ) {
        int use_forward_transform;

        if (keylen != ctx->keylen) {
           (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",121,__func__), ERR_set_error)((57),(105),
# 121 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
          ((void *)0)
# 121 "../providers/implementations/ciphers/cipher_aes_wrp.c"
          );
           return 0;
        }
# 133 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                                    ...
                                    const unsigned char *in, size_t inlen)
{
    ...
    if (in == 
# 171 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
             ((void *)0)
# 171 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                 )
        return 0;


    if (inlen == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",176,__func__), ERR_set_error)((57),(230),
# 176 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 176 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return -1;
    }
    ...
    if (!ctx->enc && (inlen < 16 || inlen & 0x7)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",182,__func__), ERR_set_error)((57),(230),
# 182 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 182 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return -1;
    }
    ...
    if (!pad && inlen & 0x7) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",188,__func__), ERR_set_error)((57),(230),
# 188 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 188 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return -1;
    }

    if (out == 
# 192 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
              ((void *)0)
# 192 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                  ) {
        if (ctx->enc) {
    ...
    rv = wctx->wrapfn(&wctx->ks.ks, ctx->iv_set ? ctx->iv : 
# 209 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                                                           ((void *)0)
# 209 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                                                               , out, in,
                      inlen, ctx->block);
    if (!rv) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",212,__func__), ERR_set_error)((57),(102),
# 212 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 212 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return -1;
    }
    if (rv > 0x7fffffff
# 215 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                   ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",216,__func__), ERR_set_error)((57),(217),
# 216 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 216 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return -1;
    }
    return (int)rv;
                           ...
                           const unsigned char *in, size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",248,__func__), ERR_set_error)((57),(106),
# 248 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
       ((void *)0)
# 248 "../providers/implementations/ciphers/cipher_aes_wrp.c"
       );
        return 0;
    }
...
static int aes_wrap_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 266 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
                 ((void *)0)
# 266 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "keylen");
    if (p != 
# 270 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
            ((void *)0)
# 270 "../providers/implementations/ciphers/cipher_aes_wrp.c"
                ) {
        if (!OSSL_PARAM_get_size_t(p, &keylen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",272,__func__), ERR_set_error)((57),(103),
# 272 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
           ((void *)0)
# 272 "../providers/implementations/ciphers/cipher_aes_wrp.c"
           );
            return 0;
        }
        if (ctx->keylen != keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_wrp.c",276,__func__), ERR_set_error)((57),(105),
# 276 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
           ((void *)0)
# 276 "../providers/implementations/ciphers/cipher_aes_wrp.c"
           );
            return 0;
        }
    }
...
# 320 "../providers/implementations/ciphers/cipher_aes_wrp.c"
static OSSL_FUNC_cipher_get_params_fn aes_256_wrap_get_params; static int aes_256_wrap_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 256, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_256wrap_newctx; static void *aes_256wrap_newctx(void *provctx) { return aes_wrap_newctx(256, 64, 8 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes256wrap_functions[] = { { 1, (void (*)(void))aes_256wrap_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_256_wrap_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 320 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 320 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_192_wrap_get_params; static int aes_192_wrap_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 192, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_192wrap_newctx; static void *aes_192wrap_newctx(void *provctx) { return aes_wrap_newctx(192, 64, 8 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes192wrap_functions[] = { { 1, (void (*)(void))aes_192wrap_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_192_wrap_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 321 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 321 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_wrap_get_params; static int aes_128_wrap_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 128, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_128wrap_newctx; static void *aes_128wrap_newctx(void *provctx) { return aes_wrap_newctx(128, 64, 8 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes128wrap_functions[] = { { 1, (void (*)(void))aes_128wrap_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_128_wrap_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 322 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 322 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_256_wrappad_get_params; static int aes_256_wrappad_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 256, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_256wrappad_newctx; static void *aes_256wrappad_newctx(void *provctx) { return aes_wrap_newctx(256, 64, 4 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes256wrappad_functions[] = { { 1, (void (*)(void))aes_256wrappad_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_256_wrappad_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 323 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 323 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_192_wrappad_get_params; static int aes_192_wrappad_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 192, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_192wrappad_newctx; static void *aes_192wrappad_newctx(void *provctx) { return aes_wrap_newctx(192, 64, 4 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes192wrappad_functions[] = { { 1, (void (*)(void))aes_192wrappad_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_192_wrappad_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 324 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 324 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_wrappad_get_params; static int aes_128_wrappad_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, (0x0002), 128, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_128wrappad_newctx; static void *aes_128wrappad_newctx(void *provctx) { return aes_wrap_newctx(128, 64, 4 * 8, 0x10002, (0x0002)); } const OSSL_DISPATCH ossl_aes128wrappad_functions[] = { { 1, (void (*)(void))aes_128wrappad_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_128_wrappad_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 325 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 325 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };

static OSSL_FUNC_cipher_get_params_fn aes_256_wrapinv_get_params; static int aes_256_wrapinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 256, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_256wrapinv_newctx; static void *aes_256wrapinv_newctx(void *provctx) { return aes_wrap_newctx(256, 64, 8 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes256wrapinv_functions[] = { { 1, (void (*)(void))aes_256wrapinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_256_wrapinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 327 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 327 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_192_wrapinv_get_params; static int aes_192_wrapinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 192, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_192wrapinv_newctx; static void *aes_192wrapinv_newctx(void *provctx) { return aes_wrap_newctx(192, 64, 8 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes192wrapinv_functions[] = { { 1, (void (*)(void))aes_192wrapinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_192_wrapinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 328 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 328 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_wrapinv_get_params; static int aes_128_wrapinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 128, 64, 8 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_128wrapinv_newctx; static void *aes_128wrapinv_newctx(void *provctx) { return aes_wrap_newctx(128, 64, 8 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes128wrapinv_functions[] = { { 1, (void (*)(void))aes_128wrapinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_128_wrapinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 329 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 329 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_256_wrappadinv_get_params; static int aes_256_wrappadinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 256, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_256wrappadinv_newctx; static void *aes_256wrappadinv_newctx(void *provctx) { return aes_wrap_newctx(256, 64, 4 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes256wrappadinv_functions[] = { { 1, (void (*)(void))aes_256wrappadinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_256_wrappadinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 330 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 330 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_192_wrappadinv_get_params; static int aes_192_wrappadinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 192, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_192wrappadinv_newctx; static void *aes_192wrappadinv_newctx(void *provctx) { return aes_wrap_newctx(192, 64, 4 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes192wrappadinv_functions[] = { { 1, (void (*)(void))aes_192wrappadinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_192_wrappadinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 331 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 331 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_wrappadinv_get_params; static int aes_128_wrappadinv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10002, ((0x0002) | 0x0200), 128, 64, 4 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_128wrappadinv_newctx; static void *aes_128wrappadinv_newctx(void *provctx) { return aes_wrap_newctx(128, 64, 4 * 8, 0x10002, ((0x0002) | 0x0200)); } const OSSL_DISPATCH ossl_aes128wrappadinv_functions[] = { { 1, (void (*)(void))aes_128wrappadinv_newctx }, { 2, (void (*)(void))aes_wrap_einit }, { 3, (void (*)(void))aes_wrap_dinit }, { 4, (void (*)(void))aes_wrap_cipher }, { 5, (void (*)(void))aes_wrap_final }, { 7, (void (*)(void))aes_wrap_freectx }, { 8, (void (*)(void))aes_wrap_dupctx }, { 9, (void (*)(void))aes_128_wrappadinv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))aes_wrap_set_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 332 "../providers/implementations/ciphers/cipher_aes_wrp.c" 3 4
((void *)0) 
# 332 "../providers/implementations/ciphers/cipher_aes_wrp.c"
} };
