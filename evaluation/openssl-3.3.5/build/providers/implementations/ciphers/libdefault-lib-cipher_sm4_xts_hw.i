# 0 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
# 10 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
...
# 11 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c" 2
# 32 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
                                             ...
                                             size_t keylen)
{
    ...
    OSSL_xts_stream_fn stream = 
# 37 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c" 3 4
                               ((void *)0)
# 37 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
                                   ;
    OSSL_xts_stream_fn stream_gb = 
# 38 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c" 3 4
                                  ((void *)0)
# 38 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
                                      ;
# 64 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
    {
        (void)0;
    }
    {
        { size_t bytes = keylen / 2; if (ctx->enc) { ossl_sm4_set_key(key, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)ossl_sm4_encrypt; } else { ossl_sm4_set_key(key, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)ossl_sm4_decrypt; } ossl_sm4_set_key(key + bytes, &xctx->ks2.ks); xctx->xts.block2 = (block128_f)ossl_sm4_encrypt; xctx->xts.key1 = &xctx->ks1; xctx->xts.key2 = &xctx->ks2; xctx->stream = stream; xctx->stream_gb = stream_gb; }
                                                           ;
    }
    return 1;
}
...
# 88 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c" 3 4
   ((void *)0)
# 88 "../providers/implementations/ciphers/cipher_sm4_xts_hw.c"
       ,
