# 0 "../providers/implementations/ciphers/cipher_aria_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aria_hw.c"
# 10 "../providers/implementations/ciphers/cipher_aria_hw.c"
...
# 11 "../providers/implementations/ciphers/cipher_aria_hw.c" 2
...
# 12 "../providers/implementations/ciphers/cipher_aria_hw.c" 2
                                  ...
                                  const unsigned char *key, size_t keylen)
{
    ...
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aria_hw.c",25,__func__), ERR_set_error)((57),(101),
# 25 "../providers/implementations/ciphers/cipher_aria_hw.c" 3 4
       ((void *)0)
# 25 "../providers/implementations/ciphers/cipher_aria_hw.c"
       );
        return 0;
    }
    dat->ks = ks;
...
static void cipher_hw_aria_copyctx(PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src) { PROV_ARIA_CTX *sctx = (PROV_ARIA_CTX *)src; PROV_ARIA_CTX *dctx = (PROV_ARIA_CTX *)dst; *dctx = *sctx; dst->ks = &dctx->ks.ks; }
# 46 "../providers/implementations/ciphers/cipher_aria_hw.c"
static const PROV_CIPHER_HW aria_cbc = { cipher_hw_aria_initkey, ossl_cipher_hw_chunked_cbc, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_cbc(size_t keybits) { return &aria_cbc; }
static const PROV_CIPHER_HW aria_ecb = { cipher_hw_aria_initkey, ossl_cipher_hw_generic_ecb, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_ecb(size_t keybits) { return &aria_ecb; }
static const PROV_CIPHER_HW aria_ofb128 = { cipher_hw_aria_initkey, ossl_cipher_hw_chunked_ofb128, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_ofb128(size_t keybits) { return &aria_ofb128; }
static const PROV_CIPHER_HW aria_cfb128 = { cipher_hw_aria_initkey, ossl_cipher_hw_chunked_cfb128, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_cfb128(size_t keybits) { return &aria_cfb128; }
static const PROV_CIPHER_HW aria_cfb1 = { cipher_hw_aria_initkey, ossl_cipher_hw_generic_cfb1, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_cfb1(size_t keybits) { return &aria_cfb1; }
static const PROV_CIPHER_HW aria_cfb8 = { cipher_hw_aria_initkey, ossl_cipher_hw_chunked_cfb8, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_cfb8(size_t keybits) { return &aria_cfb8; }
static const PROV_CIPHER_HW aria_ctr = { cipher_hw_aria_initkey, ossl_cipher_hw_generic_ctr, cipher_hw_aria_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aria_ctr(size_t keybits) { return &aria_ctr; }
