# 0 "../providers/implementations/ciphers/cipher_aes_xts.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_xts.c"
# 16 "../providers/implementations/ciphers/cipher_aes_xts.c"
...
# 17 "../providers/implementations/ciphers/cipher_aes_xts.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_xts.c" 2
# 1 "../providers/implementations/ciphers/cipher_aes_xts.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_xts.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_xts.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aes_xts.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_xts.h" 2
...
typedef void (* OSSL_xts_stream_fn)(const unsigned char *in, unsigned char *out, size_t len, const AES_KEY *key1, const AES_KEY *key2, const unsigned char iv[16])
...
# 20 "../providers/implementations/ciphers/cipher_aes_xts.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_xts.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_xts.c" 2
...
# 54 "../providers/implementations/ciphers/cipher_aes_xts.c"
                                     ...
                                     int enc)
{
    if ((!ossl_aes_xts_allow_insecure_decrypt || enc)
        ...
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",59,__func__), ERR_set_error)((57),(149),
# 59 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
       ((void *)0)
# 59 "../providers/implementations/ciphers/cipher_aes_xts.c"
       );
        return 0;
    }
    return 1;
                        ...
                        const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 80 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
             ((void *)0)
# 80 "../providers/implementations/ciphers/cipher_aes_xts.c"
                 ) {
        if (!ossl_cipher_generic_initiv(vctx, iv, ivlen))
            return 0;
    }
    if (key != 
# 84 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
              ((void *)0)
# 84 "../providers/implementations/ciphers/cipher_aes_xts.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",86,__func__), ERR_set_error)((57),(105),
# 86 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
           ((void *)0)
# 86 "../providers/implementations/ciphers/cipher_aes_xts.c"
           );
            return 0;
        }
...
static void *aes_xts_newctx(void *provctx, unsigned int mode, uint64_t flags,
                            size_t kbits, size_t blkbits, size_t ivbits)
{
    PROV_AES_XTS_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_xts.c", 114);

    if (ctx != 
# 116 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
              ((void *)0)
# 116 "../providers/implementations/ciphers/cipher_aes_xts.c"
                  ) {
        ossl_cipher_generic_initkey(&ctx->base, kbits, blkbits, ivbits, mode,
                                    flags, ossl_prov_cipher_hw_aes_xts(kbits),
                                    
# 119 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                                   ((void *)0)
# 119 "../providers/implementations/ciphers/cipher_aes_xts.c"
                                       );
    }
    return ctx;
}
...
static void aes_xts_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_xts.c", 129);
}

static void *aes_xts_dupctx(void *vctx)
{
    PROV_AES_XTS_CTX *in = (PROV_AES_XTS_CTX *)vctx;
    PROV_AES_XTS_CTX *ret = 
# 135 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                           ((void *)0)
# 135 "../providers/implementations/ciphers/cipher_aes_xts.c"
                               ;

    if (!ossl_prov_is_running())
        return 
# 138 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
              ((void *)0)
# 138 "../providers/implementations/ciphers/cipher_aes_xts.c"
                  ;

    if (in->xts.key1 != 
# 140 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                       ((void *)0)
# 140 "../providers/implementations/ciphers/cipher_aes_xts.c"
                           ) {
        if (in->xts.key1 != &in->ks1)
            return 
# 142 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                  ((void *)0)
# 142 "../providers/implementations/ciphers/cipher_aes_xts.c"
                      ;
    }
    if (in->xts.key2 != 
# 144 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                       ((void *)0)
# 144 "../providers/implementations/ciphers/cipher_aes_xts.c"
                           ) {
        if (in->xts.key2 != &in->ks2)
            return 
# 146 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                  ((void *)0)
# 146 "../providers/implementations/ciphers/cipher_aes_xts.c"
                      ;
    }
    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_aes_xts.c", 148);
    if (ret == 
# 149 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
              ((void *)0)
# 149 "../providers/implementations/ciphers/cipher_aes_xts.c"
                  )
        return 
# 150 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
              ((void *)0)
# 150 "../providers/implementations/ciphers/cipher_aes_xts.c"
                  ;
                          ...
                          size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (!ossl_prov_is_running()
            || ctx->xts.key1 == 
# 161 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                               ((void *)0)
            
# 162 "../providers/implementations/ciphers/cipher_aes_xts.c"
           || ctx->xts.key2 == 
# 162 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                               ((void *)0)
            
# 163 "../providers/implementations/ciphers/cipher_aes_xts.c"
           || !ctx->base.iv_set
            || out == 
# 164 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                     ((void *)0)
            
# 165 "../providers/implementations/ciphers/cipher_aes_xts.c"
           || in == 
# 165 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                    ((void *)0)
            
# 166 "../providers/implementations/ciphers/cipher_aes_xts.c"
           || inl < 16)
        return 0;
    ...
    if (inl > (1<<20) * 16) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",176,__func__), ERR_set_error)((57),(148),
# 176 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
       ((void *)0)
# 176 "../providers/implementations/ciphers/cipher_aes_xts.c"
       );
        return 0;
    }

    if (ctx->stream != 
# 180 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                      ((void *)0)
# 180 "../providers/implementations/ciphers/cipher_aes_xts.c"
                          )
                                 ...
                                 size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",197,__func__), ERR_set_error)((57),(106),
# 197 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
       ((void *)0)
# 197 "../providers/implementations/ciphers/cipher_aes_xts.c"
       );
        return 0;
    }

    if (!aes_xts_cipher(ctx, out, outl, outsize, in, inl)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",202,__func__), ERR_set_error)((57),(102),
# 202 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
       ((void *)0)
# 202 "../providers/implementations/ciphers/cipher_aes_xts.c"
       );
        return 0;
    }
...
static const OSSL_PARAM aes_xts_known_settable_ctx_params[] = {
    { (("keylen")), (2), ((
# 219 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
   ((void *)0)
# 219 "../providers/implementations/ciphers/cipher_aes_xts.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 220 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
   ((void *)0)
# 220 "../providers/implementations/ciphers/cipher_aes_xts.c"
   , 0, 
# 220 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
   ((void *)0)
# 220 "../providers/implementations/ciphers/cipher_aes_xts.c"
...
static const OSSL_PARAM *aes_xts_settable_ctx_params(__attribute__((unused)) void *cctx,
...
static int aes_xts_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 234 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
                 ((void *)0)
# 234 "../providers/implementations/ciphers/cipher_aes_xts.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "keylen");
    if (p != 
# 238 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
            ((void *)0)
# 238 "../providers/implementations/ciphers/cipher_aes_xts.c"
                ) {
        size_t keylen;

        if (!OSSL_PARAM_get_size_t(p, &keylen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_xts.c",242,__func__), ERR_set_error)((57),(103),
# 242 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
           ((void *)0)
# 242 "../providers/implementations/ciphers/cipher_aes_xts.c"
           );
            return 0;
        }
...
# 291 "../providers/implementations/ciphers/cipher_aes_xts.c"
static OSSL_FUNC_cipher_get_params_fn aes_256_xts_get_params; static int aes_256_xts_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10001, 0x0002, 2 * 256, 8, 128); } static OSSL_FUNC_cipher_newctx_fn aes_256_xts_newctx; static void *aes_256_xts_newctx(void *provctx) { return aes_xts_newctx(provctx, 0x10001, 0x0002, 2 * 256, 8, 128); } const OSSL_DISPATCH ossl_aes256xts_functions[] = { { 1, (void (*)(void))aes_256_xts_newctx }, { 2, (void (*)(void))aes_xts_einit }, { 3, (void (*)(void))aes_xts_dinit }, { 4, (void (*)(void))aes_xts_stream_update }, { 5, (void (*)(void))aes_xts_stream_final }, { 6, (void (*)(void))aes_xts_cipher }, { 7, (void (*)(void))aes_xts_freectx }, { 8, (void (*)(void))aes_xts_dupctx }, { 9, (void (*)(void))aes_256_xts_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 11, (void (*)(void))aes_xts_set_ctx_params }, { 14, (void (*)(void))aes_xts_settable_ctx_params }, { 0, 
# 291 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
((void *)0) 
# 291 "../providers/implementations/ciphers/cipher_aes_xts.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_xts_get_params; static int aes_128_xts_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10001, 0x0002, 2 * 128, 8, 128); } static OSSL_FUNC_cipher_newctx_fn aes_128_xts_newctx; static void *aes_128_xts_newctx(void *provctx) { return aes_xts_newctx(provctx, 0x10001, 0x0002, 2 * 128, 8, 128); } const OSSL_DISPATCH ossl_aes128xts_functions[] = { { 1, (void (*)(void))aes_128_xts_newctx }, { 2, (void (*)(void))aes_xts_einit }, { 3, (void (*)(void))aes_xts_dinit }, { 4, (void (*)(void))aes_xts_stream_update }, { 5, (void (*)(void))aes_xts_stream_final }, { 6, (void (*)(void))aes_xts_cipher }, { 7, (void (*)(void))aes_xts_freectx }, { 8, (void (*)(void))aes_xts_dupctx }, { 9, (void (*)(void))aes_128_xts_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 11, (void (*)(void))aes_xts_set_ctx_params }, { 14, (void (*)(void))aes_xts_settable_ctx_params }, { 0, 
# 292 "../providers/implementations/ciphers/cipher_aes_xts.c" 3 4
((void *)0) 
# 292 "../providers/implementations/ciphers/cipher_aes_xts.c"
} };
