# 0 "../providers/implementations/ciphers/cipher_tdes_default_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_tdes_default_hw.c"
# 14 "../providers/implementations/ciphers/cipher_tdes_default_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_tdes_default_hw.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_tdes_default_hw.c" 2
                                            ...
                                            size_t keylen)
{
    ...
    tctx->tstream.cbc = 
# 29 "../providers/implementations/ciphers/cipher_tdes_default_hw.c" 3 4
                       ((void *)0)
# 29 "../providers/implementations/ciphers/cipher_tdes_default_hw.c"
                           ;
# 42 "../providers/implementations/ciphers/cipher_tdes_default_hw.c"
    DES_set_key_unchecked(&deskey[0], &tctx->tks.ks[0]);
    DES_set_key_unchecked(&deskey[1], &tctx->tks.ks[1]);
    memcpy(&tctx->tks.ks[2], &tctx->tks.ks[0], sizeof(tctx->tks.ks[0]));
    return 1;
}
                                   ...
                                   const unsigned char *in, size_t inl)
{
    ...
    while (inl >= ((size_t)1 << 30)) {
        DES_ede3_ofb64_encrypt(in, out, (long)((size_t)1 << 30), &tctx->tks.ks[0], &tctx->tks.ks[1],
                               &tctx->tks.ks[2], (DES_cblock *)ctx->iv, &num);
        inl -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    }
    if (inl > 0) {
        DES_ede3_ofb64_encrypt(in, out, (long)inl, &tctx->tks.ks[0], &tctx->tks.ks[1],
                               &tctx->tks.ks[2], (DES_cblock *)ctx->iv, &num);
    }
    ctx->num = num;
    return 1;
                                   ...
                                   const unsigned char *in, size_t inl)
{
    ...
    while (inl >= ((size_t)1 << 30)) {
        ...
        DES_ede3_cfb64_encrypt(in, out, (long)((size_t)1 << 30),
                               &tctx->tks.ks[0], &tctx->tks.ks[1], &tctx->tks.ks[2],
...
static const PROV_CIPHER_HW ede3_ofb = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_ofb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_ofb(void) { return &ede3_ofb; }
static const PROV_CIPHER_HW ede3_cfb = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_cfb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_cfb(void) { return &ede3_cfb; }
static const PROV_CIPHER_HW ede3_cfb1 = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_cfb1, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_cfb1(void) { return &ede3_cfb1; }
static const PROV_CIPHER_HW ede3_cfb8 = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_cfb8, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_cfb8(void) { return &ede3_cfb8; }

static const PROV_CIPHER_HW ede2_ecb = { ossl_cipher_hw_tdes_ede2_initkey, ossl_cipher_hw_tdes_ecb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede2_ecb(void) { return &ede2_ecb; }
static const PROV_CIPHER_HW ede2_cbc = { ossl_cipher_hw_tdes_ede2_initkey, ossl_cipher_hw_tdes_cbc, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede2_cbc(void) { return &ede2_cbc; }
static const PROV_CIPHER_HW ede2_ofb = { ossl_cipher_hw_tdes_ede2_initkey, ossl_cipher_hw_tdes_ofb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede2_ofb(void) { return &ede2_ofb; }
static const PROV_CIPHER_HW ede2_cfb = { ossl_cipher_hw_tdes_ede2_initkey, ossl_cipher_hw_tdes_cfb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede2_cfb(void) { return &ede2_cfb; }
