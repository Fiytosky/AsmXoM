# 0 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
# 12 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
# 1 "../providers/implementations/ciphers/cipher_sm4_gcm.h" 1
# 10 "../providers/implementations/ciphers/cipher_sm4_gcm.h"
...
# 11 "../providers/implementations/ciphers/cipher_sm4_gcm.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_sm4_gcm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_sm4_gcm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 2
...
# 14 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 2
...
# 15 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 2
...
static void *sm4_gcm_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 23 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
              ((void *)0)
# 23 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_gcm.c", 25);
    if (ctx != 
# 26 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
              ((void *)0)
# 26 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                  )
...
static void *sm4_gcm_dupctx(void *provctx)
{
    ...
    PROV_SM4_GCM_CTX *dctx = 
# 35 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
                            ((void *)0)
# 35 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                                ;

    if (ctx == 
# 37 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
              ((void *)0)
# 37 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                  )
        return 
# 38 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
              ((void *)0)
# 38 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                  ;

    dctx = CRYPTO_memdup((ctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_gcm.c", 40);
    if (dctx != 
# 41 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
               ((void *)0) 
# 41 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
                    && dctx->base.gcm.key != 
# 41 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
                                             ((void *)0)
# 41 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
...
static void sm4_gcm_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_gcm.c", 51);
}


static OSSL_FUNC_cipher_get_params_fn sm4_128_gcm_get_params; static int sm4_128_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 128, 8, 96); } static OSSL_FUNC_cipher_newctx_fn sm4128gcm_newctx; static void * sm4128gcm_newctx(void *provctx) { return sm4_gcm_newctx(provctx, 128); } static void * sm4128gcm_dupctx(void *src) { return sm4_gcm_dupctx(src); } const OSSL_DISPATCH ossl_sm4128gcm_functions[] = { { 1, (void (*)(void))sm4128gcm_newctx }, { 7, (void (*)(void))sm4_gcm_freectx }, { 8, (void (*)(void))sm4128gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) sm4_128_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 55 "../providers/implementations/ciphers/cipher_sm4_gcm.c" 3 4
((void *)0) 
# 55 "../providers/implementations/ciphers/cipher_sm4_gcm.c"
} };
