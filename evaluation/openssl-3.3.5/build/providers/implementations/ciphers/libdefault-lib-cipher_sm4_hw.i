# 0 "../providers/implementations/ciphers/cipher_sm4_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_hw.c"
# 10 "../providers/implementations/ciphers/cipher_sm4_hw.c"
...
# 11 "../providers/implementations/ciphers/cipher_sm4_hw.c" 2
                                 ...
                                 const unsigned char *key, size_t keylen)
{
    ...
    if (ctx->enc
            || (ctx->mode != 0x1
                && ctx->mode != 0x2)) {
# 71 "../providers/implementations/ciphers/cipher_sm4_hw.c"
        {
            ossl_sm4_set_key(key, ks);
            ctx->block = (block128_f)ossl_sm4_encrypt;
        }
    } else {
# 113 "../providers/implementations/ciphers/cipher_sm4_hw.c"
        {
            ossl_sm4_set_key(key, ks);
...
static void cipher_hw_sm4_copyctx(PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src) { PROV_SM4_CTX *sctx = (PROV_SM4_CTX *)src; PROV_SM4_CTX *dctx = (PROV_SM4_CTX *)dst; *dctx = *sctx; dst->ks = &dctx->ks.ks; }
# 145 "../providers/implementations/ciphers/cipher_sm4_hw.c"
static const PROV_CIPHER_HW sm4_cbc = { cipher_hw_sm4_initkey, ossl_cipher_hw_generic_cbc, cipher_hw_sm4_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_cbc(size_t keybits) { return &sm4_cbc; }
static const PROV_CIPHER_HW sm4_ecb = { cipher_hw_sm4_initkey, ossl_cipher_hw_generic_ecb, cipher_hw_sm4_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_ecb(size_t keybits) { return &sm4_ecb; }
static const PROV_CIPHER_HW sm4_ofb128 = { cipher_hw_sm4_initkey, ossl_cipher_hw_generic_ofb128, cipher_hw_sm4_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_ofb128(size_t keybits) { return &sm4_ofb128; }
static const PROV_CIPHER_HW sm4_cfb128 = { cipher_hw_sm4_initkey, ossl_cipher_hw_generic_cfb128, cipher_hw_sm4_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_cfb128(size_t keybits) { return &sm4_cfb128; }
static const PROV_CIPHER_HW sm4_ctr = { cipher_hw_sm4_initkey, ossl_cipher_hw_generic_ctr, cipher_hw_sm4_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_sm4_ctr(size_t keybits) { return &sm4_ctr; }
