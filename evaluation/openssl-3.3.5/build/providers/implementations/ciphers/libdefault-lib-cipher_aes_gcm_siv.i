# 0 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
# 16 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
...
# 17 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
# 1 "../providers/implementations/include/prov/implementations.h" 1
# 10 "../providers/implementations/include/prov/implementations.h"
...
# 11 "../providers/implementations/include/prov/implementations.h" 2
# 1 "../include/openssl/types.h" 1
...
# 20 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
...
# 15 "../providers/common/include/prov/provider_ctx.h" 2
...
int BIO_meth_set_callback_ctrl(BIO_METHOD *biom,
                               long (*callback_ctrl) (BIO *, int,
                                                      BIO_info_cb *));
# 16 "../providers/common/include/prov/provider_ctx.h" 2
...
# 23 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h" 2
# 24 "../providers/implementations/ciphers/cipher_aes_gcm_siv.h"
...
# 24 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 2
...
static void *ossl_aes_gcm_siv_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 32 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 32 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 34);
    if (ctx != 
# 35 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 35 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ) {
...
static void ossl_aes_gcm_siv_freectx(void *vctx)
{
    ...
    if (ctx == 
# 48 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 48 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  )
        return;

    CRYPTO_clear_free(ctx->aad, ctx->aad_len, "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 51);
    ctx->hw->clean_ctx(ctx);
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 53);
}
...
static void *ossl_aes_gcm_siv_dupctx(void *vctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 62 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 62 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ;

    if (in->hw == 
# 64 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                 ((void *)0)
# 64 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                     )
        return 
# 65 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 65 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ;

    ret = CRYPTO_memdup((in), sizeof(*in), "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 67);
    if (ret == 
# 68 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  )
        return 
# 69 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 69 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ;

    ret->aad = 
# 71 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 71 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ;
    ret->ecb_ctx = 
# 72 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                  ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                      ;

    if (in->aad != 
# 74 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                  ((void *)0)
# 74 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                      ) {
        if ((ret->aad = CRYPTO_memdup((in->aad), (((ret->aad_len) + 15) & ~0x0F), "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 75)) == 
# 75 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                                                                       ((void *)0)
# 75 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                                                                           )
            goto err;
    }
 ...
 err:
    if (ret != 
# 84 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 84 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ) {
        CRYPTO_clear_free(ret->aad, ret->aad_len, "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 85);
        CRYPTO_free(ret, "../providers/implementations/ciphers/cipher_aes_gcm_siv.c", 86);
    }
    return 
# 88 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
          ((void *)0)
# 88 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
              ;
}
                                 ...
                                 const OSSL_PARAM params[], int enc)
{
    ...
    if (key != 
# 102 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
              ((void *)0)
# 102 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                  ) {
        if (keylen != ctx->key_len) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",104,__func__), ERR_set_error)((57),(105),
# 104 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 104 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
    ...
    if (iv != 
# 109 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
             ((void *)0)
# 109 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                 ) {
        if (ivlen != sizeof(ctx->nonce)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",111,__func__), ERR_set_error)((57),(109),
# 111 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 111 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
                                   ...
                                   size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (inl == 0) {
        if (outl != 
# 149 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                   ((void *)0)
# 149 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                       )
            *outl = 0;
        return 1;
    }
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",155,__func__), ERR_set_error)((57),(106),
# 155 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
       ((void *)0)
# 155 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
       );
        return 0;
    }
    ...
    if (outl != 
# 161 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
               ((void *)0) 
# 161 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                    && !error)
        *outl = inl;
    return !error;
}
                                         ...
                                         size_t outsize)
{
    ...
    error |= !ctx->hw->cipher(vctx, out, 
# 175 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                                        ((void *)0)
# 175 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                                            , 0);

    if (outl != 
# 177 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
               ((void *)0) 
# 177 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                    && !error)
        *outl = 0;
    return !error;
}
...
static int ossl_aes_gcm_siv_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 188 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0) 
# 188 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                 && p->data_type == 5) {
        if (!ctx->enc || !ctx->generated_tag
                || p->data_size != sizeof(ctx->tag)
                || !OSSL_PARAM_set_octet_string(p, ctx->tag, sizeof(ctx->tag))) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",192,__func__), ERR_set_error)((57),(104),
# 192 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 192 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 197 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0) 
# 197 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                 && !OSSL_PARAM_set_size_t(p, sizeof(ctx->tag))) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",198,__func__), ERR_set_error)((57),(104),
# 198 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
       ((void *)0)
# 198 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "keylen");
    if (p != 
# 202 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0) 
# 202 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->key_len)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",203,__func__), ERR_set_error)((57),(104),
# 203 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
       ((void *)0)
# 203 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
       );
        return 0;
    }
    return 1;
...
static const OSSL_PARAM aes_gcm_siv_known_gettable_ctx_params[] = {
    { (("keylen")), (2), ((
# 210 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 210 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("taglen")), (2), ((
# 211 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 211 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("tag")), (5), ((
# 212 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 212 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (0), ((size_t)-1) },
    { 
# 213 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 213 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   , 0, 
# 213 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 213 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
...
static const OSSL_PARAM *ossl_aes_gcm_siv_gettable_ctx_params(__attribute__((unused)) void *cctx,
...
static int ossl_aes_gcm_siv_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 228 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
                 ((void *)0)
# 228 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "tag");
    if (p != 
# 232 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0)
# 232 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                ) {
        if (p->data_type != 5
                || p->data_size != sizeof(ctx->user_tag)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",235,__func__), ERR_set_error)((57),(103),
# 235 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 235 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
        if (!ctx->enc) {
    ...
    p = OSSL_PARAM_locate_const(params, "speed");
    if (p != 
# 244 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0)
# 244 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                ) {
        if (!OSSL_PARAM_get_uint(p, &speed)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",246,__func__), ERR_set_error)((57),(103),
# 246 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 246 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
        ctx->speed = !!speed;
    ...
    if (p != 
# 252 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
            ((void *)0)
# 252 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
                ) {
        size_t key_len;

        if (!OSSL_PARAM_get_size_t(p, &key_len)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",256,__func__), ERR_set_error)((57),(103),
# 256 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 256 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }

        if (key_len != ctx->key_len) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_gcm_siv.c",261,__func__), ERR_set_error)((57),(105),
# 261 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
           ((void *)0)
# 261 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
           );
            return 0;
        }
    }
...
static const OSSL_PARAM aes_gcm_siv_known_settable_ctx_params[] = {
    { (("keylen")), (2), ((
# 269 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 269 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("speed")), (2), ((
# 270 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 270 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("tag")), (5), ((
# 271 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 271 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   )), (0), ((size_t)-1) },
    { 
# 272 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 272 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
   , 0, 
# 272 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
   ((void *)0)
# 272 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
...
static const OSSL_PARAM *ossl_aes_gcm_siv_settable_ctx_params(__attribute__((unused)) void *cctx,
                                                              __attribute__((unused)) void *provctx)
{
    return aes_gcm_siv_known_settable_ctx_params;
}
# 321 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
static OSSL_FUNC_cipher_newctx_fn ossl_aes128_gcm_siv_newctx; static OSSL_FUNC_cipher_freectx_fn ossl_aes_gcm_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn ossl_aes_gcm_siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn ossl_aes_gcm_siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn ossl_aes_gcm_siv_dinit; static OSSL_FUNC_cipher_update_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_final_fn ossl_aes_gcm_siv_stream_final; static OSSL_FUNC_cipher_cipher_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_get_params_fn ossl_aes_128_gcm_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn ossl_aes_gcm_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn ossl_aes_gcm_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn ossl_aes_gcm_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn ossl_aes_gcm_siv_settable_ctx_params; static int ossl_aes_128_gcm_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10005, (0x0001 | 0x0002), 128, 8, 96); } static void *ossl_aes128_gcm_siv_newctx(void *provctx) { return ossl_aes_gcm_siv_newctx(provctx, 128); } const OSSL_DISPATCH ossl_aes128gcm_siv_functions[] = { { 1, (void (*)(void))ossl_aes128_gcm_siv_newctx }, { 7, (void (*)(void))ossl_aes_gcm_siv_freectx }, { 8, (void (*)(void))ossl_aes_gcm_siv_dupctx }, { 2, (void (*)(void))ossl_aes_gcm_siv_einit }, { 3, (void (*)(void))ossl_aes_gcm_siv_dinit }, { 4, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 5, (void (*)(void))ossl_aes_gcm_siv_stream_final }, { 6, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 9, (void (*)(void))ossl_aes_128_gcm_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_aes_gcm_siv_get_ctx_params }, { 13, (void (*)(void))ossl_aes_gcm_siv_gettable_ctx_params }, { 11, (void (*)(void))ossl_aes_gcm_siv_set_ctx_params }, { 14, (void (*)(void))ossl_aes_gcm_siv_settable_ctx_params }, { 0, 
# 321 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
((void *)0) 
# 321 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
} };
static OSSL_FUNC_cipher_newctx_fn ossl_aes192_gcm_siv_newctx; static OSSL_FUNC_cipher_freectx_fn ossl_aes_gcm_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn ossl_aes_gcm_siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn ossl_aes_gcm_siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn ossl_aes_gcm_siv_dinit; static OSSL_FUNC_cipher_update_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_final_fn ossl_aes_gcm_siv_stream_final; static OSSL_FUNC_cipher_cipher_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_get_params_fn ossl_aes_192_gcm_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn ossl_aes_gcm_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn ossl_aes_gcm_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn ossl_aes_gcm_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn ossl_aes_gcm_siv_settable_ctx_params; static int ossl_aes_192_gcm_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10005, (0x0001 | 0x0002), 192, 8, 96); } static void *ossl_aes192_gcm_siv_newctx(void *provctx) { return ossl_aes_gcm_siv_newctx(provctx, 192); } const OSSL_DISPATCH ossl_aes192gcm_siv_functions[] = { { 1, (void (*)(void))ossl_aes192_gcm_siv_newctx }, { 7, (void (*)(void))ossl_aes_gcm_siv_freectx }, { 8, (void (*)(void))ossl_aes_gcm_siv_dupctx }, { 2, (void (*)(void))ossl_aes_gcm_siv_einit }, { 3, (void (*)(void))ossl_aes_gcm_siv_dinit }, { 4, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 5, (void (*)(void))ossl_aes_gcm_siv_stream_final }, { 6, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 9, (void (*)(void))ossl_aes_192_gcm_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_aes_gcm_siv_get_ctx_params }, { 13, (void (*)(void))ossl_aes_gcm_siv_gettable_ctx_params }, { 11, (void (*)(void))ossl_aes_gcm_siv_set_ctx_params }, { 14, (void (*)(void))ossl_aes_gcm_siv_settable_ctx_params }, { 0, 
# 322 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
((void *)0) 
# 322 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
} };
static OSSL_FUNC_cipher_newctx_fn ossl_aes256_gcm_siv_newctx; static OSSL_FUNC_cipher_freectx_fn ossl_aes_gcm_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn ossl_aes_gcm_siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn ossl_aes_gcm_siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn ossl_aes_gcm_siv_dinit; static OSSL_FUNC_cipher_update_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_final_fn ossl_aes_gcm_siv_stream_final; static OSSL_FUNC_cipher_cipher_fn ossl_aes_gcm_siv_cipher; static OSSL_FUNC_cipher_get_params_fn ossl_aes_256_gcm_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn ossl_aes_gcm_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn ossl_aes_gcm_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn ossl_aes_gcm_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn ossl_aes_gcm_siv_settable_ctx_params; static int ossl_aes_256_gcm_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10005, (0x0001 | 0x0002), 256, 8, 96); } static void *ossl_aes256_gcm_siv_newctx(void *provctx) { return ossl_aes_gcm_siv_newctx(provctx, 256); } const OSSL_DISPATCH ossl_aes256gcm_siv_functions[] = { { 1, (void (*)(void))ossl_aes256_gcm_siv_newctx }, { 7, (void (*)(void))ossl_aes_gcm_siv_freectx }, { 8, (void (*)(void))ossl_aes_gcm_siv_dupctx }, { 2, (void (*)(void))ossl_aes_gcm_siv_einit }, { 3, (void (*)(void))ossl_aes_gcm_siv_dinit }, { 4, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 5, (void (*)(void))ossl_aes_gcm_siv_stream_final }, { 6, (void (*)(void))ossl_aes_gcm_siv_cipher }, { 9, (void (*)(void))ossl_aes_256_gcm_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_aes_gcm_siv_get_ctx_params }, { 13, (void (*)(void))ossl_aes_gcm_siv_gettable_ctx_params }, { 11, (void (*)(void))ossl_aes_gcm_siv_set_ctx_params }, { 14, (void (*)(void))ossl_aes_gcm_siv_settable_ctx_params }, { 0, 
# 323 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c" 3 4
((void *)0) 
# 323 "../providers/implementations/ciphers/cipher_aes_gcm_siv.c"
} };
