# 0 "../providers/implementations/ciphers/ciphercommon_block.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_block.c"
# 10 "../providers/implementations/ciphers/ciphercommon_block.c"
...
# 11 "../providers/implementations/ciphers/ciphercommon_block.c" 2

# 1 "../include/openssl/prov_ssl.h" 1
# 12 "../include/openssl/prov_ssl.h"
        
# 13 "../providers/implementations/ciphers/ciphercommon_block.c" 2
...
int RAND_poll(void);
# 14 "../providers/implementations/ciphers/ciphercommon_block.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 15 "../providers/implementations/ciphers/ciphercommon_block.c" 2
...
# 16 "../providers/implementations/ciphers/ciphercommon_block.c" 2
...
# 17 "../providers/implementations/ciphers/ciphercommon_block.c" 2
...
# 18 "../providers/implementations/ciphers/ciphercommon_block.c" 2
# 39 "../providers/implementations/ciphers/ciphercommon_block.c"
size_t ossl_cipher_fillblock(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen)
{
...
# 46 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
   ((void) (0))
# 46 "../providers/implementations/ciphers/ciphercommon_block.c"
                               ;
    
# 47 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
   ((void) (0))
# 47 "../providers/implementations/ciphers/ciphercommon_block.c"
                                                              ;
                             ...
                             const unsigned char **in, size_t *inlen)
{
    ...
    if (*buflen + *inlen > blocksize) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_block.c",70,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 70 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
       ((void *)0)
# 70 "../providers/implementations/ciphers/ciphercommon_block.c"
       );
        return 0;
    }
...
int ossl_cipher_unpadblock(unsigned char *buf, size_t *buflen, size_t blocksize)
{
    ...
    if (len != blocksize) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_block.c",97,__func__), ERR_set_error)((57),((259|((0x1 << 18L)|(0x2 << 18L)))),
# 97 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
       ((void *)0)
# 97 "../providers/implementations/ciphers/ciphercommon_block.c"
       );
        return 0;
    }
    ...
    if (pad == 0 || pad > blocksize) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_block.c",107,__func__), ERR_set_error)((57),(100),
# 107 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
       ((void *)0)
# 107 "../providers/implementations/ciphers/ciphercommon_block.c"
       );
        return 0;
    }
    for (i = 0; i < pad; i++) {
        if (buf[--len] != pad) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_block.c",112,__func__), ERR_set_error)((57),(100),
# 112 "../providers/implementations/ciphers/ciphercommon_block.c" 3 4
           ((void *)0)
# 112 "../providers/implementations/ciphers/ciphercommon_block.c"
           );
            return 0;
        }
    }
...
# 141 "../providers/implementations/ciphers/ciphercommon_block.c"
int ossl_cipher_tlsunpadblock(OSSL_LIB_CTX *libctx, unsigned int tlsversion,
