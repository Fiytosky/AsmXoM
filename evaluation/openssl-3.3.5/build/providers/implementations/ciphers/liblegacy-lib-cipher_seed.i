# 0 "../providers/implementations/ciphers/cipher_seed.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_seed.c"
# 16 "../providers/implementations/ciphers/cipher_seed.c"
...
# 17 "../providers/implementations/ciphers/cipher_seed.c" 2

# 1 "../providers/implementations/ciphers/cipher_seed.h" 1
# 10 "../providers/implementations/ciphers/cipher_seed.h"
# 1 "../include/openssl/seed.h" 1
# 37 "../include/openssl/seed.h"
        
# 47 "../include/openssl/seed.h"
...
void SEED_ofb128_encrypt(const unsigned char *in, unsigned char *out,
                         ...
                         unsigned char ivec[16],
                         int *num);
# 11 "../providers/implementations/ciphers/cipher_seed.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_seed.h" 2
...
# 19 "../providers/implementations/ciphers/cipher_seed.c" 2
...
# 20 "../providers/implementations/ciphers/cipher_seed.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_seed.c" 2
...
static void seed_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_seed.c", 30);
}
...
static void *seed_dupctx(void *ctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 39 "../providers/implementations/ciphers/cipher_seed.c" 3 4
              ((void *)0)
# 39 "../providers/implementations/ciphers/cipher_seed.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_seed.c", 41);
    if (ret == 
# 42 "../providers/implementations/ciphers/cipher_seed.c" 3 4
              ((void *)0)
# 42 "../providers/implementations/ciphers/cipher_seed.c"
                  )
        return 
# 43 "../providers/implementations/ciphers/cipher_seed.c" 3 4
              ((void *)0)
# 43 "../providers/implementations/ciphers/cipher_seed.c"
                  ;
    *ret = *in;
...
static OSSL_FUNC_cipher_get_params_fn seed_128_ecb_get_params; static int seed_128_ecb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x1, 0, 128, 128, 0); } static OSSL_FUNC_cipher_newctx_fn seed_128_ecb_newctx; static void * seed_128_ecb_newctx(void *provctx) { PROV_SEED_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_seed.c", 50) : 
# 50 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 50 "../providers/implementations/ciphers/cipher_seed.c"
; if (ctx != 
# 50 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 50 "../providers/implementations/ciphers/cipher_seed.c"
) { ossl_cipher_generic_initkey(ctx, 128, 128, 0, 0x1, 0, ossl_prov_cipher_hw_seed_ecb(128), provctx); } return ctx; } const OSSL_DISPATCH ossl_seed128ecb_functions[] = { { 1, (void (*)(void)) seed_128_ecb_newctx }, { 7, (void (*)(void)) seed_freectx }, { 8, (void (*)(void)) seed_dupctx }, { 2, (void (*)(void))ossl_cipher_generic_einit }, { 3, (void (*)(void))ossl_cipher_generic_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) seed_128_ecb_get_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 50 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0) 
# 50 "../providers/implementations/ciphers/cipher_seed.c"
} };

static OSSL_FUNC_cipher_get_params_fn seed_128_cbc_get_params; static int seed_128_cbc_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x2, 0, 128, 128, 128); } static OSSL_FUNC_cipher_newctx_fn seed_128_cbc_newctx; static void * seed_128_cbc_newctx(void *provctx) { PROV_SEED_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_seed.c", 52) : 
# 52 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 52 "../providers/implementations/ciphers/cipher_seed.c"
; if (ctx != 
# 52 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 52 "../providers/implementations/ciphers/cipher_seed.c"
) { ossl_cipher_generic_initkey(ctx, 128, 128, 128, 0x2, 0, ossl_prov_cipher_hw_seed_cbc(128), provctx); } return ctx; } const OSSL_DISPATCH ossl_seed128cbc_functions[] = { { 1, (void (*)(void)) seed_128_cbc_newctx }, { 7, (void (*)(void)) seed_freectx }, { 8, (void (*)(void)) seed_dupctx }, { 2, (void (*)(void))ossl_cipher_generic_einit }, { 3, (void (*)(void))ossl_cipher_generic_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) seed_128_cbc_get_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 52 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0) 
# 52 "../providers/implementations/ciphers/cipher_seed.c"
} };

static OSSL_FUNC_cipher_get_params_fn seed_128_ofb128_get_params; static int seed_128_ofb128_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x4, 0, 128, 8, 128); } static OSSL_FUNC_cipher_newctx_fn seed_128_ofb128_newctx; static void * seed_128_ofb128_newctx(void *provctx) { PROV_SEED_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_seed.c", 54) : 
# 54 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 54 "../providers/implementations/ciphers/cipher_seed.c"
; if (ctx != 
# 54 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 54 "../providers/implementations/ciphers/cipher_seed.c"
) { ossl_cipher_generic_initkey(ctx, 128, 8, 128, 0x4, 0, ossl_prov_cipher_hw_seed_ofb128(128), provctx); } return ctx; } const OSSL_DISPATCH ossl_seed128ofb128_functions[] = { { 1, (void (*)(void)) seed_128_ofb128_newctx }, { 7, (void (*)(void)) seed_freectx }, { 8, (void (*)(void)) seed_dupctx }, { 2, (void (*)(void))ossl_cipher_generic_einit }, { 3, (void (*)(void))ossl_cipher_generic_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) seed_128_ofb128_get_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 54 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0) 
# 54 "../providers/implementations/ciphers/cipher_seed.c"
} };

static OSSL_FUNC_cipher_get_params_fn seed_128_cfb128_get_params; static int seed_128_cfb128_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x3, 0, 128, 8, 128); } static OSSL_FUNC_cipher_newctx_fn seed_128_cfb128_newctx; static void * seed_128_cfb128_newctx(void *provctx) { PROV_SEED_CTX *ctx = ossl_prov_is_running() ? CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_seed.c", 56) : 
# 56 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 56 "../providers/implementations/ciphers/cipher_seed.c"
; if (ctx != 
# 56 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0)
# 56 "../providers/implementations/ciphers/cipher_seed.c"
) { ossl_cipher_generic_initkey(ctx, 128, 8, 128, 0x3, 0, ossl_prov_cipher_hw_seed_cfb128(128), provctx); } return ctx; } const OSSL_DISPATCH ossl_seed128cfb128_functions[] = { { 1, (void (*)(void)) seed_128_cfb128_newctx }, { 7, (void (*)(void)) seed_freectx }, { 8, (void (*)(void)) seed_dupctx }, { 2, (void (*)(void))ossl_cipher_generic_einit }, { 3, (void (*)(void))ossl_cipher_generic_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) seed_128_cfb128_get_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 56 "../providers/implementations/ciphers/cipher_seed.c" 3 4
((void *)0) 
# 56 "../providers/implementations/ciphers/cipher_seed.c"
} };
