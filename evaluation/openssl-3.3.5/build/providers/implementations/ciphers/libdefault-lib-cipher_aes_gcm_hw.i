# 0 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
# 16 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
...
# 17 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 2
...
# 38 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        AES_set_encrypt_key(key, keylen * 8, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)AES_encrypt); ctx->ctr = (ctr128_f)ossl_bsaes_ctr32_encrypt_blocks; ctx->key_set = 1;
                                                              ;
    } else
    ...
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        vpaes_set_encrypt_key(key, keylen * 8, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)vpaes_encrypt); ctx->ctr = (ctr128_f)
# 46 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 3 4
       ((void *)0)
# 46 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
       ; ctx->key_set = 1;;
    } else
...

    {
        ...
        AES_set_encrypt_key(key, keylen * 8, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)AES_encrypt); ctx->ctr = (ctr128_f)
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 3 4
       ((void *)0)
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
       ; ctx->key_set = 1;;
                                         ...
                                         size_t len, unsigned char *out)
{
    if (ctx->enc) {
        if (ctx->ctr != 
# 65 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 3 4
                       ((void *)0)
# 65 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
                           ) {

            size_t bulk = 0;

            if (len >= 32 && (ctx->ctr == aesni_ctr32_encrypt_blocks && ctx->gcm.funcs.ghash == gcm_ghash_avx)) {
        ...
        if (ctx->ctr != 
# 94 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 3 4
                       ((void *)0)
# 94 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c"
                           ) {

            size_t bulk = 0;

            if (len >= 16 && (ctx->ctr == aesni_ctr32_encrypt_blocks && ctx->gcm.funcs.ghash == gcm_ghash_avx)) {
                size_t res = (16 - ctx->gcm.mres) % 16;
...
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_hw_aesni.inc" 1
# 15 "../providers/implementations/ciphers/cipher_aes_gcm_hw_aesni.inc"
static int aesni_gcm_initkey(PROV_GCM_CTX *ctx, const unsigned char *key,
                             size_t keylen)
{
    PROV_AES_GCM_CTX *actx = (PROV_AES_GCM_CTX *)ctx;
    AES_KEY *ks = &actx->ks.ks;
    aesni_set_encrypt_key(key, keylen * 8, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)aesni_encrypt); ctx->ctr = (ctr128_f)aesni_ctr32_encrypt_blocks; ctx->key_set = 1;
                                                     ;
    return 1;
}
...
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_hw_vaes_avx512.inc" 1
# 22 "../providers/implementations/ciphers/cipher_aes_gcm_hw_vaes_avx512.inc"
int ossl_vaes_vpclmulqdq_capable(void);
# 32 "../providers/implementations/ciphers/cipher_aes_gcm_hw_vaes_avx512.inc"
void ossl_aes_gcm_encrypt_avx512(const void *ks, void *gcm128ctx, unsigned int *pblocklen, const unsigned char *in, size_t len, unsigned char *out);
void ossl_aes_gcm_decrypt_avx512(const void *ks, void *gcm128ctx, unsigned int *pblocklen, const unsigned char *in, size_t len, unsigned char *out);
...
# 35 "../providers/implementations/ciphers/cipher_aes_gcm_hw_aesni.inc" 2
...
# 139 "../providers/implementations/ciphers/cipher_aes_gcm_hw.c" 2
