# 0 "../providers/implementations/ciphers/cipher_des.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_des.c"
# 14 "../providers/implementations/ciphers/cipher_des.c"
...
# 15 "../providers/implementations/ciphers/cipher_des.c" 2
...
int RAND_poll(void);
# 17 "../providers/implementations/ciphers/cipher_des.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 18 "../providers/implementations/ciphers/cipher_des.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 19 "../providers/implementations/ciphers/cipher_des.c" 2
# 1 "../providers/implementations/ciphers/cipher_des.h" 1
# 10 "../providers/implementations/ciphers/cipher_des.h"
...
void DES_ofb64_encrypt(const unsigned char *in, unsigned char *out,
                       long length, DES_key_schedule *schedule,
                       DES_cblock *ivec, int *num);
# 11 "../providers/implementations/ciphers/cipher_des.h" 2
# 1 "../include/crypto/des_platform.h" 1
# 12 "../include/crypto/des_platform.h"
        
# 12 "../providers/implementations/ciphers/cipher_des.h" 2
...
# 20 "../providers/implementations/ciphers/cipher_des.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_des.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_des.c" 2
                        ...
                        const PROV_CIPHER_HW *hw)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 38 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 38 "../providers/implementations/ciphers/cipher_des.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_des.c", 40);
    if (ctx != 
# 41 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 41 "../providers/implementations/ciphers/cipher_des.c"
                  )
...
static void *des_dupctx(void *ctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 53 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 53 "../providers/implementations/ciphers/cipher_des.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_des.c", 55);
    if (ret == 
# 56 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 56 "../providers/implementations/ciphers/cipher_des.c"
                  )
        return 
# 57 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 57 "../providers/implementations/ciphers/cipher_des.c"
                  ;
...
static void des_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_des.c", 68);
}
                    ...
                    const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 84 "../providers/implementations/ciphers/cipher_des.c" 3 4
             ((void *)0)
# 84 "../providers/implementations/ciphers/cipher_des.c"
                 ) {
    ...
    if (key != 
# 92 "../providers/implementations/ciphers/cipher_des.c" 3 4
              ((void *)0)
# 92 "../providers/implementations/ciphers/cipher_des.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_des.c",94,__func__), ERR_set_error)((57),(105),
# 94 "../providers/implementations/ciphers/cipher_des.c" 3 4
           ((void *)0)
# 94 "../providers/implementations/ciphers/cipher_des.c"
           );
            return 0;
        }
...
static const OSSL_PARAM des_known_gettable_ctx_params[] = { { (("keylen")), (2), ((
# 130 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0)
# 130 "../providers/implementations/ciphers/cipher_des.c"
...
# 130 "../providers/implementations/ciphers/cipher_des.c"
    ...
    { (("randkey")), (5), ((
# 131 "../providers/implementations/ciphers/cipher_des.c" 3 4
   ((void *)0)
# 131 "../providers/implementations/ciphers/cipher_des.c"
   )), (0), ((size_t)-1) },
{ 
# 132 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0)
# 132 "../providers/implementations/ciphers/cipher_des.c"
, 0, 
# 132 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0)
# 132 "../providers/implementations/ciphers/cipher_des.c"
, 0, 0 } }; const OSSL_PARAM * des_gettable_ctx_params(__attribute__((unused)) void *cctx, __attribute__((unused)) void *provctx) { return des_known_gettable_ctx_params; }
...
static int des_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    p = OSSL_PARAM_locate(params, "randkey");
    if (p != 
# 143 "../providers/implementations/ciphers/cipher_des.c" 3 4
            ((void *)0) 
# 143 "../providers/implementations/ciphers/cipher_des.c"
                 && !des_generatekey(ctx, p->data)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_des.c",144,__func__), ERR_set_error)((57),(121),
# 144 "../providers/implementations/ciphers/cipher_des.c" 3 4
       ((void *)0)
# 144 "../providers/implementations/ciphers/cipher_des.c"
       );
        return 0;
    }
    return 1;
}
# 191 "../providers/implementations/ciphers/cipher_des.c"
static OSSL_FUNC_cipher_newctx_fn des_ecb_newctx; static void *des_ecb_newctx(void *provctx) { return des_newctx(provctx, 64, 64, 0, 0x1, 0x0010, ossl_prov_cipher_hw_des_ecb()); } static OSSL_FUNC_cipher_get_params_fn des_ecb_get_params; static int des_ecb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x1, 0x0010, 64, 64, 0); } const OSSL_DISPATCH ossl_des_ecb_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_ecb_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_ecb_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 191 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 191 "../providers/implementations/ciphers/cipher_des.c"
} };

static OSSL_FUNC_cipher_newctx_fn des_cbc_newctx; static void *des_cbc_newctx(void *provctx) { return des_newctx(provctx, 64, 64, 64, 0x2, 0x0010, ossl_prov_cipher_hw_des_cbc()); } static OSSL_FUNC_cipher_get_params_fn des_cbc_get_params; static int des_cbc_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x2, 0x0010, 64, 64, 64); } const OSSL_DISPATCH ossl_des_cbc_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_cbc_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_cbc_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 193 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 193 "../providers/implementations/ciphers/cipher_des.c"
} };

static OSSL_FUNC_cipher_newctx_fn des_ofb64_newctx; static void *des_ofb64_newctx(void *provctx) { return des_newctx(provctx, 64, 8, 64, 0x4, 0x0010, ossl_prov_cipher_hw_des_ofb64()); } static OSSL_FUNC_cipher_get_params_fn des_ofb64_get_params; static int des_ofb64_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x4, 0x0010, 64, 8, 64); } const OSSL_DISPATCH ossl_des_ofb64_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_ofb64_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_ofb64_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 195 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 195 "../providers/implementations/ciphers/cipher_des.c"
} };

static OSSL_FUNC_cipher_newctx_fn des_cfb64_newctx; static void *des_cfb64_newctx(void *provctx) { return des_newctx(provctx, 64, 8, 64, 0x3, 0x0010, ossl_prov_cipher_hw_des_cfb64()); } static OSSL_FUNC_cipher_get_params_fn des_cfb64_get_params; static int des_cfb64_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x3, 0x0010, 64, 8, 64); } const OSSL_DISPATCH ossl_des_cfb64_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_cfb64_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_cfb64_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 197 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 197 "../providers/implementations/ciphers/cipher_des.c"
} };

static OSSL_FUNC_cipher_newctx_fn des_cfb1_newctx; static void *des_cfb1_newctx(void *provctx) { return des_newctx(provctx, 64, 8, 64, 0x3, 0x0010, ossl_prov_cipher_hw_des_cfb1()); } static OSSL_FUNC_cipher_get_params_fn des_cfb1_get_params; static int des_cfb1_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x3, 0x0010, 64, 8, 64); } const OSSL_DISPATCH ossl_des_cfb1_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_cfb1_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_cfb1_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 199 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 199 "../providers/implementations/ciphers/cipher_des.c"
} };

static OSSL_FUNC_cipher_newctx_fn des_cfb8_newctx; static void *des_cfb8_newctx(void *provctx) { return des_newctx(provctx, 64, 8, 64, 0x3, 0x0010, ossl_prov_cipher_hw_des_cfb8()); } static OSSL_FUNC_cipher_get_params_fn des_cfb8_get_params; static int des_cfb8_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x3, 0x0010, 64, 8, 64); } const OSSL_DISPATCH ossl_des_cfb8_functions[] = { { 2, (void (*)(void))des_einit }, { 3, (void (*)(void))des_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 1, (void (*)(void))des_cfb8_newctx }, { 8, (void (*)(void))des_dupctx }, { 7, (void (*)(void))des_freectx }, { 9, (void (*)(void))des_cfb8_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))des_get_ctx_params }, { 13, (void (*)(void))des_gettable_ctx_params }, { 11, (void (*)(void))ossl_cipher_generic_set_ctx_params }, { 14, (void (*)(void))ossl_cipher_generic_settable_ctx_params }, { 0, 
# 201 "../providers/implementations/ciphers/cipher_des.c" 3 4
((void *)0) 
# 201 "../providers/implementations/ciphers/cipher_des.c"
} };
