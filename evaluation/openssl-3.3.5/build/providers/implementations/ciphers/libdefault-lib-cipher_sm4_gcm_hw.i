# 0 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
# 14 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c" 2
# 1 "../include/crypto/sm4_platform.h" 1
# 12 "../include/crypto/sm4_platform.h"
        
# 16 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c" 2
...
# 53 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
    {
        ossl_sm4_set_key(key, ks); CRYPTO_gcm128_init(&ctx->gcm, ks, (block128_f)ossl_sm4_encrypt); ctx->ctr = (ctr128_f)
# 54 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c" 3 4
       ((void *)0)
# 54 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
       ; ctx->key_set = 1;;
    }
                                ...
                                size_t len, unsigned char *out)
{
    if (ctx->enc) {
        if (ctx->ctr != 
# 64 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c" 3 4
                       ((void *)0)
# 64 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
                           ) {
        ...
        if (ctx->ctr != 
# 72 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c" 3 4
                       ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_sm4_gcm_hw.c"
                           ) {
