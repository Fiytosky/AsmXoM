# 0 "../providers/implementations/ciphers/cipher_aria_gcm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aria_gcm.c"
# 12 "../providers/implementations/ciphers/cipher_aria_gcm.c"
# 1 "../providers/implementations/ciphers/cipher_aria_gcm.h" 1
# 10 "../providers/implementations/ciphers/cipher_aria_gcm.h"
...
void ossl_aria_encrypt(const unsigned char *in, unsigned char *out,
                       const ARIA_KEY *key);
# 11 "../providers/implementations/ciphers/cipher_aria_gcm.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aria_gcm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aria_gcm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aria_gcm.c" 2
...
# 14 "../providers/implementations/ciphers/cipher_aria_gcm.c" 2
...
# 15 "../providers/implementations/ciphers/cipher_aria_gcm.c" 2
...
static void *aria_gcm_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 21 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
              ((void *)0)
# 21 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aria_gcm.c", 23);
    if (ctx != 
# 24 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
              ((void *)0)
# 24 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                  )
...
static void *aria_gcm_dupctx(void *provctx)
{
    ...
    PROV_ARIA_GCM_CTX *dctx = 
# 33 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
                             ((void *)0)
# 33 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                                 ;

    if (ctx == 
# 35 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
              ((void *)0)
# 35 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                  )
        return 
# 36 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
              ((void *)0)
# 36 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                  ;

    dctx = CRYPTO_memdup((ctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_aria_gcm.c", 38);
    if (dctx != 
# 39 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
               ((void *)0) 
# 39 "../providers/implementations/ciphers/cipher_aria_gcm.c"
                    && dctx->base.gcm.key != 
# 39 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
                                             ((void *)0)
# 39 "../providers/implementations/ciphers/cipher_aria_gcm.c"
...
static void aria_gcm_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aria_gcm.c", 50);
}


static OSSL_FUNC_cipher_get_params_fn aria_128_gcm_get_params; static int aria_128_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 128, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aria128gcm_newctx; static void * aria128gcm_newctx(void *provctx) { return aria_gcm_newctx(provctx, 128); } static void * aria128gcm_dupctx(void *src) { return aria_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aria128gcm_functions[] = { { 1, (void (*)(void))aria128gcm_newctx }, { 7, (void (*)(void))aria_gcm_freectx }, { 8, (void (*)(void))aria128gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aria_128_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 54 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
((void *)0) 
# 54 "../providers/implementations/ciphers/cipher_aria_gcm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aria_192_gcm_get_params; static int aria_192_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 192, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aria192gcm_newctx; static void * aria192gcm_newctx(void *provctx) { return aria_gcm_newctx(provctx, 192); } static void * aria192gcm_dupctx(void *src) { return aria_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aria192gcm_functions[] = { { 1, (void (*)(void))aria192gcm_newctx }, { 7, (void (*)(void))aria_gcm_freectx }, { 8, (void (*)(void))aria192gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aria_192_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 56 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
((void *)0) 
# 56 "../providers/implementations/ciphers/cipher_aria_gcm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aria_256_gcm_get_params; static int aria_256_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 256, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aria256gcm_newctx; static void * aria256gcm_newctx(void *provctx) { return aria_gcm_newctx(provctx, 256); } static void * aria256gcm_dupctx(void *src) { return aria_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aria256gcm_functions[] = { { 1, (void (*)(void))aria256gcm_newctx }, { 7, (void (*)(void))aria_gcm_freectx }, { 8, (void (*)(void))aria256gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aria_256_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 58 "../providers/implementations/ciphers/cipher_aria_gcm.c" 3 4
((void *)0) 
# 58 "../providers/implementations/ciphers/cipher_aria_gcm.c"
} };
