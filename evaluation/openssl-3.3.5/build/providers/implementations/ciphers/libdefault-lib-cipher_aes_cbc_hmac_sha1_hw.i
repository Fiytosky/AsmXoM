# 0 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
# 15 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
...
# 16 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c" 2
# 31 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
...
int RAND_poll(void);
# 32 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 33 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c" 2
...
# 34 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c" 2
                                       ...
                                       size_t inp_len, int n4x)
{
    ...
    mctx = (SHA1_MB_CTX *) (storage + 32 - ((size_t)storage % 32));
...
# 228 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
...
# 317 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
        edges[i].ptr = blocks[i].c;
        edges[i].blocks = 1;
    }
                                      ...
                                      const unsigned char *in, size_t len)
{
    ...
    if (ctx->base.enc) {
        ...
        if (plen != len) {
            ...
            sctx->md = sctx->tail;
            sha1_update(&sctx->md, out + plen, 20);
            SHA1_Final(out + plen, &sctx->md);
...
# 522 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
            pmac->u[0] = 0;
            pmac->u[1] = 0;
            pmac->u[2] = 0;
            pmac->u[3] = 0;
...
# 592 "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c"
            len += 20;
            sctx->md = sctx->tail;
            sha1_update(&sctx->md, pmac->c, 20);
...
static int aesni_cbc_hmac_sha1_tls1_multiblock_max_bufsize(void *vctx)
{
    ...
    (void)((ctx->multiblock_max_send_fragment != 0) ? 0 : (OPENSSL_die("assertion failed: " "ctx->multiblock_max_send_fragment != 0", "../providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c", 707), 1));
    return (int)(5 + 16
