# 0 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
# 14 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 2
# 32 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
static int cipher_hw_aes_ocb_generic_initkey(PROV_CIPHER_CTX *vctx,
                                             const unsigned char *key,
                                             size_t keylen)
{
    PROV_AES_OCB_CTX *ctx = (PROV_AES_OCB_CTX *)vctx;
# 50 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        CRYPTO_ocb128_cleanup(&ctx->ocb); vpaes_set_encrypt_key(key, keylen * 8, &ctx->ksenc.ks); vpaes_set_decrypt_key(key, keylen * 8, &ctx->ksdec.ks); if (!CRYPTO_ocb128_init(&ctx->ocb, &ctx->ksenc.ks, &ctx->ksdec.ks, (block128_f)vpaes_encrypt, (block128_f)vpaes_decrypt, ctx->base.enc ? (ocb128_f)
# 51 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
       ((void *)0) 
# 51 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
       : (ocb128_f)
# 51 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
       ((void *)0)
# 51 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
       )) return 0; ctx->key_set = 1
                                                                ;
    } else

    {
        CRYPTO_ocb128_cleanup(&ctx->ocb); AES_set_encrypt_key(key, keylen * 8, &ctx->ksenc.ks); AES_set_decrypt_key(key, keylen * 8, &ctx->ksdec.ks); if (!CRYPTO_ocb128_init(&ctx->ocb, &ctx->ksenc.ks, &ctx->ksdec.ks, (block128_f)AES_encrypt, (block128_f)AES_decrypt, ctx->base.enc ? (ocb128_f)
# 56 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
       ((void *)0) 
# 56 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
       : (ocb128_f)
# 56 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
       ((void *)0)
# 56 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
                                           ...
                                           size_t keylen)
{
    ...
    CRYPTO_ocb128_cleanup(&ctx->ocb); aesni_set_encrypt_key(key, keylen * 8, &ctx->ksenc.ks); aesni_set_decrypt_key(key, keylen * 8, &ctx->ksdec.ks); if (!CRYPTO_ocb128_init(&ctx->ocb, &ctx->ksenc.ks, &ctx->ksdec.ks, (block128_f)aesni_encrypt, (block128_f)aesni_decrypt, ctx->base.enc ? (ocb128_f)aesni_ocb_encrypt : (ocb128_f)aesni_ocb_decrypt)) return 0; ctx->key_set = 1

                                                        ;
    return 1;
}
# 198 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
static const PROV_CIPHER_HW aes_generic_ocb = {
    cipher_hw_aes_ocb_generic_initkey,
    
# 200 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
   ((void *)0)

# 201 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
};
static const PROV_CIPHER_HW aesni_ocb = { cipher_hw_aes_ocb_aesni_initkey, 
# 202 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c" 3 4
((void *)0) 
# 202 "../providers/implementations/ciphers/cipher_aes_ocb_hw.c"
};
const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_ocb(size_t keybits)
{
    if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_ocb;
