# 0 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
# 12 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
# 1 "../providers/implementations/ciphers/cipher_sm4_ccm.h" 1
# 10 "../providers/implementations/ciphers/cipher_sm4_ccm.h"
...
# 11 "../providers/implementations/ciphers/cipher_sm4_ccm.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_sm4_ccm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_sm4_ccm.h" 2
# 1 "../include/crypto/sm4_platform.h" 1
# 12 "../include/crypto/sm4_platform.h"
        
# 14 "../providers/implementations/ciphers/cipher_sm4_ccm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 2
...
# 14 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 2
...
# 15 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 2
...
static void *sm4_ccm_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 23 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
              ((void *)0)
# 23 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_ccm.c", 25);
    if (ctx != 
# 26 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
              ((void *)0)
# 26 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
                  )
...
static void *sm4_ccm_dupctx(void *provctx)
{
    ...
    PROV_SM4_CCM_CTX *dctx = 
# 34 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
                            ((void *)0)
# 34 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
                                ;

    if (ctx == 
# 36 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
              ((void *)0)
# 36 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
                  )
        return 
# 37 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
              ((void *)0)
# 37 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
                  ;

    dctx = CRYPTO_memdup((ctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_ccm.c", 39);
    if (dctx != 
# 40 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
               ((void *)0) 
# 40 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
...
static void sm4_ccm_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_ccm.c", 50);
}


static OSSL_FUNC_cipher_get_params_fn sm4_128_ccm_get_params; static int sm4_128_ccm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x7, (0x0001 | 0x0002), 128, 8, 96); } static OSSL_FUNC_cipher_newctx_fn sm4128ccm_newctx; static void * sm4128ccm_newctx(void *provctx) { return sm4_ccm_newctx(provctx, 128); } static void * sm4128ccm_dupctx(void *src) { return sm4_ccm_dupctx(src); } const OSSL_DISPATCH ossl_sm4128ccm_functions[] = { { 1, (void (*)(void))sm4128ccm_newctx }, { 7, (void (*)(void))sm4_ccm_freectx }, { 8, (void (*)(void))sm4128ccm_dupctx }, { 2, (void (*)(void))ossl_ccm_einit }, { 3, (void (*)(void))ossl_ccm_dinit }, { 4, (void (*)(void))ossl_ccm_stream_update }, { 5, (void (*)(void))ossl_ccm_stream_final }, { 6, (void (*)(void))ossl_ccm_cipher }, { 9, (void (*)(void)) sm4_128_ccm_get_params }, { 10, (void (*)(void)) ossl_ccm_get_ctx_params }, { 11, (void (*)(void)) ossl_ccm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 54 "../providers/implementations/ciphers/cipher_sm4_ccm.c" 3 4
((void *)0) 
# 54 "../providers/implementations/ciphers/cipher_sm4_ccm.c"
} };
