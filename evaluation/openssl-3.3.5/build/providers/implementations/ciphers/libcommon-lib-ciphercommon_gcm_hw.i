# 0 "../providers/implementations/ciphers/ciphercommon_gcm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_gcm_hw.c"
# 10 "../providers/implementations/ciphers/ciphercommon_gcm_hw.c"
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 11 "../providers/implementations/ciphers/ciphercommon_gcm_hw.c" 2
...
# 12 "../providers/implementations/ciphers/ciphercommon_gcm_hw.c" 2
...
{
    if (ctx->enc) {
        CRYPTO_gcm128_tag(&ctx->gcm, tag, 16);
        ctx->taglen = 16;
    } else {
