# 0 "../providers/implementations/ciphers/cipher_sm4_xts.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_xts.c"
# 13 "../providers/implementations/ciphers/cipher_sm4_xts.c"
...
# 14 "../providers/implementations/ciphers/cipher_sm4_xts.c" 2
# 1 "../providers/implementations/ciphers/cipher_sm4_xts.h" 1
# 10 "../providers/implementations/ciphers/cipher_sm4_xts.h"
...
# 11 "../providers/implementations/ciphers/cipher_sm4_xts.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_sm4_xts.h" 2
# 1 "../include/crypto/sm4_platform.h" 1
# 12 "../include/crypto/sm4_platform.h"
        
# 13 "../providers/implementations/ciphers/cipher_sm4_xts.h" 2

typedef void (* OSSL_xts_stream_fn)(const unsigned char *in, unsigned char *out, size_t len, const SM4_KEY *key1, const SM4_KEY *key2, const unsigned char iv[16], const int enc)
...
# 36 "../providers/implementations/ciphers/cipher_sm4_xts.h"
    int xts_standard;
...
# 15 "../providers/implementations/ciphers/cipher_sm4_xts.c" 2
...
# 16 "../providers/implementations/ciphers/cipher_sm4_xts.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_sm4_xts.c" 2
                        ...
                        const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 48 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
             ((void *)0)
# 48 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                 ) {
        if (!ossl_cipher_generic_initiv(vctx, iv, ivlen))
            return 0;
    }
    if (key != 
# 52 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
              ((void *)0)
# 52 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",54,__func__), ERR_set_error)((57),(105),
# 54 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
           ((void *)0)
# 54 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           );
            return 0;
        }
...
static void *sm4_xts_newctx(void *provctx, unsigned int mode, uint64_t flags,
                            size_t kbits, size_t blkbits, size_t ivbits)
{
    PROV_SM4_XTS_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_xts.c", 80);

    if (ctx != 
# 82 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
              ((void *)0)
# 82 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                  ) {
        ossl_cipher_generic_initkey(&ctx->base, kbits, blkbits, ivbits, mode,
                                    flags, ossl_prov_cipher_hw_sm4_xts(kbits),
                                    
# 85 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                                   ((void *)0)
# 85 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                                       );
    }
    return ctx;
}
...
static void sm4_xts_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_sm4_xts.c", 95);
}

static void *sm4_xts_dupctx(void *vctx)
{
    PROV_SM4_XTS_CTX *in = (PROV_SM4_XTS_CTX *)vctx;
    PROV_SM4_XTS_CTX *ret = 
# 101 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                           ((void *)0)
# 101 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                               ;

    if (!ossl_prov_is_running())
        return 
# 104 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
              ((void *)0)
# 104 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                  ;

    if (in->xts.key1 != 
# 106 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                       ((void *)0)
# 106 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                           ) {
        if (in->xts.key1 != &in->ks1)
            return 
# 108 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                  ((void *)0)
# 108 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                      ;
    }
    if (in->xts.key2 != 
# 110 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                       ((void *)0)
# 110 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                           ) {
        if (in->xts.key2 != &in->ks2)
            return 
# 112 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                  ((void *)0)
# 112 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                      ;
    }
    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_sm4_xts.c", 114);
    if (ret == 
# 115 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
              ((void *)0)
# 115 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                  )
        return 
# 116 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
              ((void *)0)
# 116 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                  ;
                          ...
                          size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (!ossl_prov_is_running()
            || ctx->xts.key1 == 
# 127 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                               ((void *)0)
            
# 128 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           || ctx->xts.key2 == 
# 128 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                               ((void *)0)
            
# 129 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           || !ctx->base.iv_set
            || out == 
# 130 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                     ((void *)0)
            
# 131 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           || in == 
# 131 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                    ((void *)0)
            
# 132 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           || inl < 16)
        return 0;
    ...
    if (inl > (1<<20) * 16) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",142,__func__), ERR_set_error)((57),(148),
# 142 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
       ((void *)0)
# 142 "../providers/implementations/ciphers/cipher_sm4_xts.c"
       );
        return 0;
    }
    if (ctx->xts_standard) {
        if (ctx->stream != 
# 146 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                          ((void *)0)
# 146 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                              )
        ...
        if (ctx->stream_gb != 
# 153 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                             ((void *)0)
# 153 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                                 )
                                 ...
                                 size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",171,__func__), ERR_set_error)((57),(106),
# 171 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
       ((void *)0)
# 171 "../providers/implementations/ciphers/cipher_sm4_xts.c"
       );
        return 0;
    }

    if (!sm4_xts_cipher(ctx, out, outl, outsize, in, inl)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",176,__func__), ERR_set_error)((57),(102),
# 176 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
       ((void *)0)
# 176 "../providers/implementations/ciphers/cipher_sm4_xts.c"
       );
        return 0;
    }
...
static const OSSL_PARAM sm4_xts_known_settable_ctx_params[] = {
    { (("xts_standard")), (4), ((
# 193 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
   ((void *)0)
# 193 "../providers/implementations/ciphers/cipher_sm4_xts.c"
   )), (0), ((size_t)-1) },
    { 
# 194 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
   ((void *)0)
# 194 "../providers/implementations/ciphers/cipher_sm4_xts.c"
   , 0, 
# 194 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
   ((void *)0)
# 194 "../providers/implementations/ciphers/cipher_sm4_xts.c"
...
static const OSSL_PARAM *sm4_xts_settable_ctx_params(__attribute__((unused)) void *cctx,
...
static int sm4_xts_set_ctx_params(void *vxctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 208 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                 ((void *)0)
# 208 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                     )
        return 1;
# 218 "../providers/implementations/ciphers/cipher_sm4_xts.c"
    p = OSSL_PARAM_locate_const(params, "xts_standard");

    if (p != 
# 220 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
            ((void *)0)
# 220 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                ) {
        const char *xts_standard = 
# 221 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
                                  ((void *)0)
# 221 "../providers/implementations/ciphers/cipher_sm4_xts.c"
                                      ;
        ...
        if (!OSSL_PARAM_get_utf8_string_ptr(p, &xts_standard)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",227,__func__), ERR_set_error)((57),(103),
# 227 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
           ((void *)0)
# 227 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           );
            return 0;
        }
        if (OPENSSL_strcasecmp(xts_standard, "GB") == 0) {
            ...
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_sm4_xts.c",235,__func__), ERR_set_error)((57),(104),
# 235 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
           ((void *)0)
# 235 "../providers/implementations/ciphers/cipher_sm4_xts.c"
           );
            return 0;
        }
    }
...
# 281 "../providers/implementations/ciphers/cipher_sm4_xts.c"
static OSSL_FUNC_cipher_get_params_fn sm4_128_xts_get_params; static int sm4_128_xts_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10001, 0x0002, 2 * 128, 8, 128); } static OSSL_FUNC_cipher_newctx_fn sm4_128_xts_newctx; static void *sm4_128_xts_newctx(void *provctx) { return sm4_xts_newctx(provctx, 0x10001, 0x0002, 2 * 128, 8, 128); } const OSSL_DISPATCH ossl_sm4128xts_functions[] = { { 1, (void (*)(void))sm4_128_xts_newctx }, { 2, (void (*)(void))sm4_xts_einit }, { 3, (void (*)(void))sm4_xts_dinit }, { 4, (void (*)(void))sm4_xts_stream_update }, { 5, (void (*)(void))sm4_xts_stream_final }, { 6, (void (*)(void))sm4_xts_cipher }, { 7, (void (*)(void))sm4_xts_freectx }, { 8, (void (*)(void))sm4_xts_dupctx }, { 9, (void (*)(void))sm4_128_xts_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))ossl_cipher_generic_get_ctx_params }, { 13, (void (*)(void))ossl_cipher_generic_gettable_ctx_params }, { 11, (void (*)(void))sm4_xts_set_ctx_params }, { 14, (void (*)(void))sm4_xts_settable_ctx_params }, { 0, 
# 281 "../providers/implementations/ciphers/cipher_sm4_xts.c" 3 4
((void *)0) 
# 281 "../providers/implementations/ciphers/cipher_sm4_xts.c"
} };
