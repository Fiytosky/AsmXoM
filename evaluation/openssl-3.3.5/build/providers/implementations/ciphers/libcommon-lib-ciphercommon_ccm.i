# 0 "../providers/implementations/ciphers/ciphercommon_ccm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_ccm.c"
# 12 "../providers/implementations/ciphers/ciphercommon_ccm.c"
...
# 13 "../providers/implementations/ciphers/ciphercommon_ccm.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 14 "../providers/implementations/ciphers/ciphercommon_ccm.c" 2
# 1 "../providers/implementations/include/prov/ciphercommon_ccm.h" 1
# 12 "../providers/implementations/include/prov/ciphercommon_ccm.h"
...
# 15 "../providers/implementations/include/prov/ciphercommon_ccm.h" 2

typedef struct prov_ccm_hw_st PROV_CCM_HW;
# 34 "../providers/implementations/include/prov/ciphercommon_ccm.h"
typedef struct prov_ccm_st {
    unsigned int enc : 1;
    unsigned int key_set : 1;
    unsigned int iv_set : 1;
    unsigned int tag_set : 1;
    unsigned int len_set : 1;
    size_t l, m;
    size_t keylen;
    size_t tls_aad_len;
...
typedef int (* OSSL_CCM_cipher_fn)(PROV_CCM_CTX *ctx, unsigned char *out, size_t *padlen, const unsigned char *in, size_t len)

                                               ;
typedef int (* OSSL_CCM_setkey_fn)(PROV_CCM_CTX *ctx, const unsigned char *key, size_t keylen)
                                                                            ;
typedef int (* OSSL_CCM_setiv_fn)(PROV_CCM_CTX *dat, const unsigned char *iv, size_t ivlen, size_t mlen)

                                               ;
typedef int (* OSSL_CCM_setaad_fn)(PROV_CCM_CTX *ctx, const unsigned char *aad, size_t aadlen)
                                                                            ;
typedef int (* OSSL_CCM_auth_encrypt_fn)(PROV_CCM_CTX *ctx, const unsigned char *in, unsigned char *out, size_t len, unsigned char *tag, size_t taglen)


                                                                            ;
typedef int (* OSSL_CCM_auth_decrypt_fn)(PROV_CCM_CTX *ctx, const unsigned char *in, unsigned char *out, size_t len, unsigned char *tag, size_t taglen)


                                                                            ;
typedef int (* OSSL_CCM_gettag_fn)(PROV_CCM_CTX *ctx, unsigned char *tag, size_t taglen)
                                                                       ;
...
# 15 "../providers/implementations/ciphers/ciphercommon_ccm.c" 2
...
# 16 "../providers/implementations/ciphers/ciphercommon_ccm.c" 2
...
static int ccm_tls_init(PROV_CCM_CTX *ctx, unsigned char *aad, size_t alen)
{
    ...
    if (!ossl_prov_is_running() || alen != 13)
        return 0;
...
int ossl_ccm_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 74 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                 ((void *)0)
# 74 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "tag");
    if (p != 
# 78 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 78 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",80,__func__), ERR_set_error)((57),(103),
# 80 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 80 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if ((p->data_size & 1) || (p->data_size < 4) || p->data_size > 16) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",84,__func__), ERR_set_error)((57),(118),
# 84 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 84 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }

        if (p->data != 
# 88 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                      ((void *)0)
# 88 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                          ) {
            if (ctx->enc) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",90,__func__), ERR_set_error)((57),(120),
# 90 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
               ((void *)0)
# 90 "../providers/implementations/ciphers/ciphercommon_ccm.c"
               );
                return 0;
            }
    ...
    if (p != 
# 100 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 100 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        size_t ivlen;

        if (!OSSL_PARAM_get_size_t(p, &sz)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",104,__func__), ERR_set_error)((57),(103),
# 104 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 104 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        ivlen = 15 - sz;
        if (ivlen < 2 || ivlen > 8) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",109,__func__), ERR_set_error)((57),(109),
# 109 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 109 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if (ctx->l != ivlen) {
    ...
    if (p != 
# 119 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 119 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",121,__func__), ERR_set_error)((57),(103),
# 121 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 121 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        sz = ccm_tls_init(ctx, p->data, p->data_size);
        if (sz == 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",126,__func__), ERR_set_error)((57),(115),
# 126 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 126 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    ...
    if (p != 
# 133 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 133 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",135,__func__), ERR_set_error)((57),(103),
# 135 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 135 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if (ccm_tls_iv_set_fixed(ctx, p->data, p->data_size) == 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",139,__func__), ERR_set_error)((57),(109),
# 139 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 139 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    }
...
int ossl_ccm_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 153 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0) 
# 153 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                 && !OSSL_PARAM_set_size_t(p, ccm_get_ivlen(ctx))) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",154,__func__), ERR_set_error)((57),(104),
# 154 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 154 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }
    ...
    if (p != 
# 159 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 159 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        size_t m = ctx->m;

        if (!OSSL_PARAM_set_size_t(p, m)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",163,__func__), ERR_set_error)((57),(104),
# 163 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 163 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 169 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 169 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (ccm_get_ivlen(ctx) > p->data_size) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",171,__func__), ERR_set_error)((57),(109),
# 171 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 171 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if (!OSSL_PARAM_set_octet_string(p, ctx->iv, p->data_size)
            && !OSSL_PARAM_set_octet_ptr(p, &ctx->iv, p->data_size)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",176,__func__), ERR_set_error)((57),(104),
# 176 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 176 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 182 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 182 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (ccm_get_ivlen(ctx) > p->data_size) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",184,__func__), ERR_set_error)((57),(109),
# 184 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 184 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if (!OSSL_PARAM_set_octet_string(p, ctx->iv, p->data_size)
            && !OSSL_PARAM_set_octet_ptr(p, &ctx->iv, p->data_size)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",189,__func__), ERR_set_error)((57),(104),
# 189 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 189 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 195 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0) 
# 195 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->keylen)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",196,__func__), ERR_set_error)((57),(104),
# 196 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 196 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }
    ...
    if (p != 
# 201 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0) 
# 201 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->tls_aad_pad_sz)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",202,__func__), ERR_set_error)((57),(104),
# 202 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 202 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }
    ...
    if (p != 
# 207 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
            ((void *)0)
# 207 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                ) {
        if (!ctx->enc || !ctx->tag_set) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",209,__func__), ERR_set_error)((57),(119),
# 209 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 209 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",213,__func__), ERR_set_error)((57),(104),
# 213 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 213 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
                    ...
                    const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 236 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
             ((void *)0)
# 236 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                 ) {
        if (ivlen != ccm_get_ivlen(ctx)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",238,__func__), ERR_set_error)((57),(109),
# 238 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 238 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
    ...
    if (key != 
# 244 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
              ((void *)0)
# 244 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",246,__func__), ERR_set_error)((57),(105),
# 246 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
           ((void *)0)
# 246 "../providers/implementations/ciphers/ciphercommon_ccm.c"
           );
            return 0;
        }
                           ...
                           size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",276,__func__), ERR_set_error)((57),(106),
# 276 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 276 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }

    if (!ccm_cipher_internal(ctx, out, outl, in, inl)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",281,__func__), ERR_set_error)((57),(102),
# 281 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 281 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }
    return 1;
                          ...
                          size_t outsize)
{
    ...
    i = ccm_cipher_internal(ctx, out, outl, 
# 296 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                                           ((void *)0)
# 296 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                                               , 0);
    if (i <= 0)
        return 0;
                    ...
                    const unsigned char *in, size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_ccm.c",313,__func__), ERR_set_error)((57),(106),
# 313 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
       ((void *)0)
# 313 "../providers/implementations/ciphers/ciphercommon_ccm.c"
       );
        return 0;
    }
                          ...
                          const unsigned char *in, size_t len)
{
    ...
    if (in == 
# 346 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
             ((void *)0) 
# 346 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                  || out != in || len < 8 + ctx->m)
        goto err;


    if (ctx->enc)
        memcpy(out, ctx->buf, 8);

    memcpy(ctx->iv + 4, in, 8);
                               ...
                               size_t len)
{
    ...
    if (ctx->tls_aad_len != ((size_t)-1))
        return ccm_tls_cipher(ctx, out, padlen, in, len);


    if (in == 
# 398 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
             ((void *)0) 
# 398 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                  && out != 
# 398 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                            ((void *)0)
# 398 "../providers/implementations/ciphers/ciphercommon_ccm.c"
    ...
    if (out == 
# 404 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
              ((void *)0)
# 404 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                  ) {
        if (in == 
# 405 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                 ((void *)0)
# 405 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                     ) {
            if (!ccm_set_iv(ctx, len))
                goto err;
        } else {
        ...
        if (ctx->enc) {
            if (!hw->auth_encrypt(ctx, in, out, len, 
# 421 "../providers/implementations/ciphers/ciphercommon_ccm.c" 3 4
                                                    ((void *)0)
# 421 "../providers/implementations/ciphers/ciphercommon_ccm.c"
                                                        , 0))
                goto err;
            ctx->tag_set = 1;
        } else {
