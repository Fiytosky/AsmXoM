# 0 "../providers/implementations/ciphers/cipher_tdes_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_tdes_hw.c"
# 14 "../providers/implementations/ciphers/cipher_tdes_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_tdes_hw.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 17 "../providers/implementations/ciphers/cipher_tdes_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_tdes_hw.c" 2
                                     ...
                                     const unsigned char *key, size_t keylen)
{
    ...
    tctx->tstream.cbc = 
# 29 "../providers/implementations/ciphers/cipher_tdes_hw.c" 3 4
                       ((void *)0)
# 29 "../providers/implementations/ciphers/cipher_tdes_hw.c"
                           ;
# 42 "../providers/implementations/ciphers/cipher_tdes_hw.c"
                            ...
                            const unsigned char *in, size_t inl)
{
    ...
    if (tctx->tstream.cbc != 
# 63 "../providers/implementations/ciphers/cipher_tdes_hw.c" 3 4
                            ((void *)0)
# 63 "../providers/implementations/ciphers/cipher_tdes_hw.c"
                                ) {
    ...
    while (inl >= ((size_t)1 << 30)) {
        DES_ede3_cbc_encrypt(in, out, (long)((size_t)1 << 30), &tctx->tks.ks[0], &tctx->tks.ks[1],
                             &tctx->tks.ks[2], (DES_cblock *)ctx->iv, ctx->enc);
        inl -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    }
    if (inl > 0)
        DES_ede3_cbc_encrypt(in, out, (long)inl, &tctx->tks.ks[0], &tctx->tks.ks[1],
                             &tctx->tks.ks[2], (DES_cblock *)ctx->iv, ctx->enc);
    return 1;
}
...
static const PROV_CIPHER_HW ede3_ecb = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_ecb, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_ecb(void) { return &ede3_ecb; }
static const PROV_CIPHER_HW ede3_cbc = { ossl_cipher_hw_tdes_ede3_initkey, ossl_cipher_hw_tdes_cbc, ossl_cipher_hw_tdes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_tdes_ede3_cbc(void) { return &ede3_cbc; }
