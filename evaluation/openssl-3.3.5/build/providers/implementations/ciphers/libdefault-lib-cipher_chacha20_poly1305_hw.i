# 0 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
# 12 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 13 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 2
...
# 14 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 2
                                    ...
                                    unsigned char *aad, size_t alen)
{
    ...
    memcpy(ctx->tls_aad, aad, 13);
    len = aad[13 - 2] << 8 | aad[13 - 1];
    aad = ctx->tls_aad;
    if (!bctx->enc) {
        if (len < 16)
            return 0;
    ...
    ctx->chacha.counter[2] = ctx->nonce[1] ^ ( ((unsigned int)(aad)[0]) | ((unsigned int)(aad)[1]<<8) | ((unsigned int)(aad)[2]<<16) | ((unsigned int)(aad)[3]<<24) );
    ctx->chacha.counter[3] = ctx->nonce[2] ^ ( ((unsigned int)(aad+4)[0]) | ((unsigned int)(aad+4)[1]<<8) | ((unsigned int)(aad+4)[2]<<16) | ((unsigned int)(aad+4)[3]<<24) );
    ctx->mac_inited = 0;
                                            ...
                                            unsigned char *fixed, size_t flen)
{
    ...
    if (flen != 12)
        return 0;
    ctx->nonce[0] = ctx->chacha.counter[1] = ( ((unsigned int)(fixed)[0]) | ((unsigned int)(fixed)[1]<<8) | ((unsigned int)(fixed)[2]<<16) | ((unsigned int)(fixed)[3]<<24) );
    ctx->nonce[1] = ctx->chacha.counter[2] = ( ((unsigned int)(fixed + 4)[0]) | ((unsigned int)(fixed + 4)[1]<<8) | ((unsigned int)(fixed + 4)[2]<<16) | ((unsigned int)(fixed + 4)[3]<<24) );
    ctx->nonce[2] = ctx->chacha.counter[3] = ( ((unsigned int)(fixed + 8)[0]) | ((unsigned int)(fixed + 8)[1]<<8) | ((unsigned int)(fixed + 8)[2]<<16) | ((unsigned int)(fixed + 8)[3]<<24) );
    return 1;
}
                                     ...
                                     const unsigned char *key, size_t keylen)
{
    ...
    if (bctx->enc)
        return ossl_chacha20_einit(&ctx->chacha, key, keylen, 
# 70 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                             ((void *)0)
# 70 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                                 , 0, 
# 70 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                                      ((void *)0)
# 70 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
        ...
        return ossl_chacha20_dinit(&ctx->chacha, key, keylen, 
# 72 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                             ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                                 , 0, 
# 72 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                                      ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
...
static int chacha20_poly1305_initiv(PROV_CIPHER_CTX *bctx)
{
    ...
    memcpy(tempiv + 16 - noncelen, bctx->oiv,
           noncelen);

    if (bctx->enc)
        ret = ossl_chacha20_einit(&ctx->chacha, 
# 93 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                               ((void *)0)
# 93 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                   , 0,
                                  tempiv, sizeof(tempiv), 
# 94 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                         ((void *)0)
# 94 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                             );
    else
        ret = ossl_chacha20_dinit(&ctx->chacha, 
# 96 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                               ((void *)0)
# 96 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                   , 0,
                                  tempiv, sizeof(tempiv), 
# 97 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                         ((void *)0)
# 97 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                             );
...
# 114 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
static const unsigned char zero[2 * 64] = { 0 };
                                        ...
                                        const unsigned char *in, size_t len)
{
    ...
    ctr = buf + 64;
    tohash = buf + 64 - 16;
# 157 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
    if (plen <= 64) {
        size_t i;

        ctx->chacha.counter[0] = 0;
        ChaCha20_ctr32(buf, zero, (buf_len = 2 * 64),
                       ctx->chacha.key.d, ctx->chacha.counter);
        Poly1305_Init(poly, buf);
        ctx->chacha.partial_len = 0;
        memcpy(tohash, ctx->tls_aad, 16);
        tohash_len = 16;
        ctx->len.aad = 13;
        ctx->len.text = plen;
        ...
        ctx->chacha.partial_len = 0;
        Poly1305_Update(poly, ctx->tls_aad, 16);
        tohash = ctr;
        tohash_len = 0;
        ctx->len.aad = 13;
        ctx->len.text = plen;
    ...
    if ((ossl_is_little_endian)) {
        memcpy(ctr, (unsigned char *)&ctx->len, 16);
    } else {
...
# 280 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                                   ((void *)0)
# 280 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                                       ) {
            if (inl != plen + 16)
                return 0;
        ...
        ctx->chacha.counter[0] = 0;
        ChaCha20_ctr32(ctx->chacha.buf, zero, 64,
                       ctx->chacha.key.d, ctx->chacha.counter);
        ...
        ctx->mac_inited = 1;
        if (plen != ((size_t)-1)) {
            Poly1305_Update(poly, ctx->tls_aad, 13);
            ctx->len.aad = 13;
            ctx->aad = 1;
        }
    }
    ...
    if (in != 
# 303 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
             ((void *)0)
# 303 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                 ) {
        if (out == 
# 304 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                  ((void *)0)
# 304 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                      ) {
            ...
            if (ctx->aad) {
                if ((rem = (size_t)ctx->len.aad % 16))
                    Poly1305_Update(poly, zero, 16 - rem);
                ctx->aad = 0;
            }
    ...
    if (in == 
# 338 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
             ((void *)0) 
# 338 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                  || inl != plen) {
        ...
        if ((ossl_is_little_endian)) {
            ...
            Poly1305_Update(poly, temp, 16);
        }
        Poly1305_Final(poly, bctx->enc ? ctx->tag : temp);
        ctx->mac_inited = 0;

        if (in != 
# 376 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                 ((void *)0) 
# 376 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                      && inl != plen) {
            if (bctx->enc) {
                memcpy(out, ctx->tag, 16);
            } else {
...
# 403 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c" 3 4
                                ((void *)0) 
# 403 "../providers/implementations/ciphers/cipher_chacha20_poly1305_hw.c"
                                     },
