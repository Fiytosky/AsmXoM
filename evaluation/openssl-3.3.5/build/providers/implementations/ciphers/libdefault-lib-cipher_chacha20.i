# 0 "../providers/implementations/ciphers/cipher_chacha20.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_chacha20.c"
# 12 "../providers/implementations/ciphers/cipher_chacha20.c"
...
# 13 "../providers/implementations/ciphers/cipher_chacha20.c" 2
...
# 14 "../providers/implementations/ciphers/cipher_chacha20.c" 2
...
# 15 "../providers/implementations/ciphers/cipher_chacha20.c" 2
...
# 16 "../providers/implementations/ciphers/cipher_chacha20.c" 2
...
void ossl_chacha20_initctx(PROV_CHACHA20_CTX *ctx)
{
    ossl_cipher_generic_initkey(ctx, (32) * 8,
                                (1) * 8,
                                (16) * 8,
                                0, (0x0002),
                                ossl_prov_cipher_hw_chacha20((32) * 8),
                                
# 42 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                               ((void *)0)
# 42 "../providers/implementations/ciphers/cipher_chacha20.c"
                                   );
}
...
static void *chacha20_newctx(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 50 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
              ((void *)0)
# 50 "../providers/implementations/ciphers/cipher_chacha20.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_chacha20.c", 52);
    if (ctx != 
# 53 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
              ((void *)0)
# 53 "../providers/implementations/ciphers/cipher_chacha20.c"
                  )
...
static void chacha20_freectx(void *vctx)
{
    ...
    if (ctx != 
# 62 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
              ((void *)0)
# 62 "../providers/implementations/ciphers/cipher_chacha20.c"
                  ) {
        ossl_cipher_generic_reset_ctx((PROV_CIPHER_CTX *)vctx);
        CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_chacha20.c", 64);
    }
}
...
{
    PROV_CHACHA20_CTX *ctx = (PROV_CHACHA20_CTX *)vctx;
    PROV_CHACHA20_CTX *dupctx = 
# 71 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                               ((void *)0)
# 71 "../providers/implementations/ciphers/cipher_chacha20.c"
                                   ;

    if (ctx != 
# 73 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
              ((void *)0)
# 73 "../providers/implementations/ciphers/cipher_chacha20.c"
                  ) {
        dupctx = CRYPTO_memdup((ctx), sizeof(*dupctx), "../providers/implementations/ciphers/cipher_chacha20.c", 74);
        if (dupctx != 
# 75 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                     ((void *)0) 
# 75 "../providers/implementations/ciphers/cipher_chacha20.c"
                          && dupctx->base.tlsmac != 
# 75 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                                                    ((void *)0) 
# 75 "../providers/implementations/ciphers/cipher_chacha20.c"
                                                         && dupctx->base.alloced) {
            dupctx->base.tlsmac = CRYPTO_memdup((dupctx->base.tlsmac), dupctx->base.tlsmacsize, "../providers/implementations/ciphers/cipher_chacha20.c", 76)
                                                                         ;
            if (dupctx->base.tlsmac == 
# 78 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                                      ((void *)0)
# 78 "../providers/implementations/ciphers/cipher_chacha20.c"
                                          ) {
                CRYPTO_free(dupctx, "../providers/implementations/ciphers/cipher_chacha20.c", 79);
                dupctx = 
# 80 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                        ((void *)0)
# 80 "../providers/implementations/ciphers/cipher_chacha20.c"
                            ;
            }
        }
    }
...
{
    return ossl_cipher_generic_get_params(params, 0, (0x0002),
                                          (32) * 8,
                                          (1) * 8,
                                          (16) * 8);
}
...
static int chacha20_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 100 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
            ((void *)0) 
# 100 "../providers/implementations/ciphers/cipher_chacha20.c"
                 && !OSSL_PARAM_set_size_t(p, (16))) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",101,__func__), ERR_set_error)((57),(104),
# 101 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
       ((void *)0)
# 101 "../providers/implementations/ciphers/cipher_chacha20.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "keylen");
    if (p != 
# 105 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
            ((void *)0) 
# 105 "../providers/implementations/ciphers/cipher_chacha20.c"
                 && !OSSL_PARAM_set_size_t(p, (32))) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",106,__func__), ERR_set_error)((57),(104),
# 106 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
       ((void *)0)
# 106 "../providers/implementations/ciphers/cipher_chacha20.c"
       );
        return 0;
    }
...
static const OSSL_PARAM chacha20_known_gettable_ctx_params[] = {
    { (("keylen")), (2), ((
# 114 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 114 "../providers/implementations/ciphers/cipher_chacha20.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("ivlen")), (2), ((
# 115 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 115 "../providers/implementations/ciphers/cipher_chacha20.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 116 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 116 "../providers/implementations/ciphers/cipher_chacha20.c"
   , 0, 
# 116 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 116 "../providers/implementations/ciphers/cipher_chacha20.c"
...
const OSSL_PARAM *chacha20_gettable_ctx_params(__attribute__((unused)) void *cctx,
...
static int chacha20_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 129 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                 ((void *)0)
# 129 "../providers/implementations/ciphers/cipher_chacha20.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "keylen");
    if (p != 
# 133 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
            ((void *)0)
# 133 "../providers/implementations/ciphers/cipher_chacha20.c"
                ) {
        if (!OSSL_PARAM_get_size_t(p, &len)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",135,__func__), ERR_set_error)((57),(103),
# 135 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
           ((void *)0)
# 135 "../providers/implementations/ciphers/cipher_chacha20.c"
           );
            return 0;
        }
        if (len != (32)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",139,__func__), ERR_set_error)((57),(105),
# 139 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
           ((void *)0)
# 139 "../providers/implementations/ciphers/cipher_chacha20.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 144 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
            ((void *)0)
# 144 "../providers/implementations/ciphers/cipher_chacha20.c"
                ) {
        if (!OSSL_PARAM_get_size_t(p, &len)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",146,__func__), ERR_set_error)((57),(103),
# 146 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
           ((void *)0)
# 146 "../providers/implementations/ciphers/cipher_chacha20.c"
           );
            return 0;
        }
        if (len != (16)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_chacha20.c",150,__func__), ERR_set_error)((57),(109),
# 150 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
           ((void *)0)
# 150 "../providers/implementations/ciphers/cipher_chacha20.c"
           );
            return 0;
        }
    }
...
static const OSSL_PARAM chacha20_known_settable_ctx_params[] = {
    { (("keylen")), (2), ((
# 158 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 158 "../providers/implementations/ciphers/cipher_chacha20.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("ivlen")), (2), ((
# 159 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 159 "../providers/implementations/ciphers/cipher_chacha20.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 160 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 160 "../providers/implementations/ciphers/cipher_chacha20.c"
   , 0, 
# 160 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0)
# 160 "../providers/implementations/ciphers/cipher_chacha20.c"
...
const OSSL_PARAM *chacha20_settable_ctx_params(__attribute__((unused)) void *cctx,
                                               __attribute__((unused)) void *provctx)
{
...
# 175 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                                                                 ((void *)0)
# 175 "../providers/implementations/ciphers/cipher_chacha20.c"
                                                                     );
    if (ret && iv != 
# 176 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                    ((void *)0)
# 176 "../providers/implementations/ciphers/cipher_chacha20.c"
                        ) {
...
# 194 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                                                                 ((void *)0)
# 194 "../providers/implementations/ciphers/cipher_chacha20.c"
                                                                     );
    if (ret && iv != 
# 195 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
                    ((void *)0)
# 195 "../providers/implementations/ciphers/cipher_chacha20.c"
                        ) {
        PROV_CIPHER_CTX *ctx = (PROV_CIPHER_CTX *)vctx;
        PROV_CIPHER_HW_CHACHA20 *hw = (PROV_CIPHER_HW_CHACHA20 *)ctx->hw;
...
const OSSL_DISPATCH ossl_chacha20_functions[] = {
    { 1, (void (*)(void))chacha20_newctx },
    { 7, (void (*)(void))chacha20_freectx },
    { 8, (void (*)(void))chacha20_dupctx },
    { 2, (void (*)(void))ossl_chacha20_einit },
    { 3, (void (*)(void))ossl_chacha20_dinit },
    ...
    { 9, (void (*)(void))chacha20_get_params },
    { 12, (void (*)(void))ossl_cipher_generic_gettable_params },
    { 10, (void (*)(void))chacha20_get_ctx_params },
    { 13,
        (void (*)(void))chacha20_gettable_ctx_params },
    { 11, (void (*)(void))chacha20_set_ctx_params },
    { 14,
        (void (*)(void))chacha20_settable_ctx_params },
    { 0, 
# 224 "../providers/implementations/ciphers/cipher_chacha20.c" 3 4
   ((void *)0) 
# 224 "../providers/implementations/ciphers/cipher_chacha20.c"
   }
};
