# 0 "../providers/implementations/ciphers/cipher_desx_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_desx_hw.c"
# 14 "../providers/implementations/ciphers/cipher_desx_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_desx_hw.c" 2
...
void DES_ofb64_encrypt(const unsigned char *in, unsigned char *out,
                       long length, DES_key_schedule *schedule,
                       DES_cblock *ivec, int *num);
# 17 "../providers/implementations/ciphers/cipher_desx_hw.c" 2
...
# 12 "../providers/implementations/ciphers/cipher_tdes.h"
...
# 18 "../providers/implementations/ciphers/cipher_desx_hw.c" 2
# 27 "../providers/implementations/ciphers/cipher_desx_hw.c"
                                      ...
                                      const unsigned char *key, size_t keylen)
{
    ...
    DES_set_key_unchecked(deskey, &tctx->tks.ks[0]);
    memcpy(&tctx->tks.ks[1].ks[0].cblock, &key[8], 8);
    memcpy(&tctx->tks.ks[2].ks[0].cblock, &key[16], 8);
                              ...
                              const unsigned char *in, size_t inl)
{
    ...
    while (inl >= ((size_t)1 << 30)) {
        DES_xcbc_encrypt(in, out, (long)((size_t)1 << 30), &tctx->tks.ks[0],
                         (DES_cblock *)ctx->iv, &tctx->tks.ks[1].ks[0].cblock, &tctx->tks.ks[2].ks[0].cblock,
                         ctx->enc);
        inl -= ((size_t)1 << 30);
        in += ((size_t)1 << 30);
        out += ((size_t)1 << 30);
    ...
    if (inl > 0)
        DES_xcbc_encrypt(in, out, (long)inl, &tctx->tks.ks[0],
                         (DES_cblock *)ctx->iv, &tctx->tks.ks[1].ks[0].cblock, &tctx->tks.ks[2].ks[0].cblock,
                         ctx->enc);
    return 1;
}
