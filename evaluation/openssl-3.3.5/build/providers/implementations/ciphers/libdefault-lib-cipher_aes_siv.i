# 0 "../providers/implementations/ciphers/cipher_aes_siv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_siv.c"
# 16 "../providers/implementations/ciphers/cipher_aes_siv.c"
...
# 17 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
# 1 "../providers/implementations/ciphers/cipher_aes_siv.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_siv.h"
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_siv.h" 2
...
# 12 "../providers/implementations/ciphers/cipher_aes_siv.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_siv.h" 2
...
# 20 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
...
# 23 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
...
# 24 "../providers/implementations/ciphers/cipher_aes_siv.c" 2
                            ...
                            uint64_t flags)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 36 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 36 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_siv.c", 38);
    if (ctx != 
# 39 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 39 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ) {
        ctx->taglen = 16;
        ctx->mode = mode;
...
static void aes_siv_freectx(void *vctx)
{
    ...
    if (ctx != 
# 53 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 53 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ) {
        ctx->hw->cleanup(ctx);
        CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_siv.c", 55);
    }
}
...
static void *siv_dupctx(void *vctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 65 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 65 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_aes_siv.c", 67);
    if (ret == 
# 68 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  )
        return 
# 69 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 69 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ;
    if (!in->hw->dupctx(in, ret)) {
        CRYPTO_free(ret, "../providers/implementations/ciphers/cipher_aes_siv.c", 71);
        ret = 
# 72 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
             ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_aes_siv.c"
                 ;
    }
    return ret;
}
                    ...
                    const OSSL_PARAM params[], int enc)
{
    ...
    if (key != 
# 88 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 88 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",90,__func__), ERR_set_error)((57),(105),
# 90 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 90 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
                      ...
                      size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (out != 
# 122 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
              ((void *)0)
# 122 "../providers/implementations/ciphers/cipher_aes_siv.c"
                  ) {
        if (inl == 0) {
            if (outl != 
# 124 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
                       ((void *)0)
# 124 "../providers/implementations/ciphers/cipher_aes_siv.c"
                           )
                *outl = 0;
            return 1;
        }
        ...
        if (outsize < inl) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",130,__func__), ERR_set_error)((57),(106),
# 130 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 130 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
    }
    ...
    if (outl != 
# 138 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
               ((void *)0)
# 138 "../providers/implementations/ciphers/cipher_aes_siv.c"
                   )
        *outl = inl;
    return 1;
}
                            ...
                            size_t outsize)
{
    ...
    if (!ctx->hw->cipher(vctx, out, 
# 151 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
                                   ((void *)0)
# 151 "../providers/implementations/ciphers/cipher_aes_siv.c"
                                       , 0))
        return 0;

    if (outl != 
# 154 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
               ((void *)0)
# 154 "../providers/implementations/ciphers/cipher_aes_siv.c"
                   )
        *outl = 0;
    return 1;
}
...
static int aes_siv_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 166 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0) 
# 166 "../providers/implementations/ciphers/cipher_aes_siv.c"
                 && p->data_type == 5) {
        if (!ctx->enc
            || p->data_size != ctx->taglen
            || !OSSL_PARAM_set_octet_string(p, &sctx->tag.byte, ctx->taglen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",170,__func__), ERR_set_error)((57),(104),
# 170 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 170 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 175 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0) 
# 175 "../providers/implementations/ciphers/cipher_aes_siv.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->taglen)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",176,__func__), ERR_set_error)((57),(104),
# 176 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
       ((void *)0)
# 176 "../providers/implementations/ciphers/cipher_aes_siv.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "keylen");
    if (p != 
# 180 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0) 
# 180 "../providers/implementations/ciphers/cipher_aes_siv.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->keylen)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",181,__func__), ERR_set_error)((57),(104),
# 181 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
       ((void *)0)
# 181 "../providers/implementations/ciphers/cipher_aes_siv.c"
       );
        return 0;
    }
    return 1;
...
static const OSSL_PARAM aes_siv_known_gettable_ctx_params[] = {
    { (("keylen")), (2), ((
# 188 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 188 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("taglen")), (2), ((
# 189 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 189 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("tag")), (5), ((
# 190 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 190 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (0), ((size_t)-1) },
    { 
# 191 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 191 "../providers/implementations/ciphers/cipher_aes_siv.c"
   , 0, 
# 191 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 191 "../providers/implementations/ciphers/cipher_aes_siv.c"
...
static const OSSL_PARAM *aes_siv_gettable_ctx_params(__attribute__((unused)) void *cctx,
...
static int aes_siv_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 205 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
                 ((void *)0)
# 205 "../providers/implementations/ciphers/cipher_aes_siv.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "tag");
    if (p != 
# 209 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0)
# 209 "../providers/implementations/ciphers/cipher_aes_siv.c"
                ) {
        if (ctx->enc)
            return 1;
        if (p->data_type != 5
            || !ctx->hw->settag(ctx, p->data, p->data_size)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",214,__func__), ERR_set_error)((57),(103),
# 214 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 214 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 219 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0)
# 219 "../providers/implementations/ciphers/cipher_aes_siv.c"
                ) {
        if (!OSSL_PARAM_get_uint(p, &speed)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",221,__func__), ERR_set_error)((57),(103),
# 221 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 221 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
    ...
    if (p != 
# 227 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
            ((void *)0)
# 227 "../providers/implementations/ciphers/cipher_aes_siv.c"
                ) {
        size_t keylen;

        if (!OSSL_PARAM_get_size_t(p, &keylen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_siv.c",231,__func__), ERR_set_error)((57),(103),
# 231 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
           ((void *)0)
# 231 "../providers/implementations/ciphers/cipher_aes_siv.c"
           );
            return 0;
        }
...
static const OSSL_PARAM aes_siv_known_settable_ctx_params[] = {
    { (("keylen")), (2), ((
# 242 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 242 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("speed")), (2), ((
# 243 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 243 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (sizeof(unsigned int)), ((size_t)-1) },
    { (("tag")), (5), ((
# 244 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 244 "../providers/implementations/ciphers/cipher_aes_siv.c"
   )), (0), ((size_t)-1) },
    { 
# 245 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 245 "../providers/implementations/ciphers/cipher_aes_siv.c"
   , 0, 
# 245 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
   ((void *)0)
# 245 "../providers/implementations/ciphers/cipher_aes_siv.c"
...
static const OSSL_PARAM *aes_siv_settable_ctx_params(__attribute__((unused)) void *cctx,
                                                     __attribute__((unused)) void *provctx)
{
    return aes_siv_known_settable_ctx_params;
}
# 303 "../providers/implementations/ciphers/cipher_aes_siv.c"
static OSSL_FUNC_cipher_newctx_fn aes128siv_newctx; static OSSL_FUNC_cipher_freectx_fn aes_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn siv_dinit; static OSSL_FUNC_cipher_update_fn siv_cipher; static OSSL_FUNC_cipher_final_fn siv_stream_final; static OSSL_FUNC_cipher_cipher_fn siv_cipher; static OSSL_FUNC_cipher_get_params_fn aes_128_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn aes_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn aes_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn aes_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn aes_siv_settable_ctx_params; static int aes_128_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10004, (0x0001 | 0x0002), 2*128, 8, 0); } static void *aes128siv_newctx(void *provctx) { return aes_siv_newctx(provctx, 2*128, 0x10004, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes128siv_functions[] = { { 1, (void (*)(void))aes128siv_newctx }, { 7, (void (*)(void))aes_siv_freectx }, { 8, (void (*)(void)) siv_dupctx }, { 2, (void (*)(void)) siv_einit }, { 3, (void (*)(void)) siv_dinit }, { 4, (void (*)(void)) siv_cipher }, { 5, (void (*)(void)) siv_stream_final }, { 6, (void (*)(void)) siv_cipher }, { 9, (void (*)(void)) aes_128_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void)) aes_siv_get_ctx_params }, { 13, (void (*)(void)) aes_siv_gettable_ctx_params }, { 11, (void (*)(void)) aes_siv_set_ctx_params }, { 14, (void (*)(void)) aes_siv_settable_ctx_params }, { 0, 
# 303 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
((void *)0) 
# 303 "../providers/implementations/ciphers/cipher_aes_siv.c"
} };
static OSSL_FUNC_cipher_newctx_fn aes192siv_newctx; static OSSL_FUNC_cipher_freectx_fn aes_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn siv_dinit; static OSSL_FUNC_cipher_update_fn siv_cipher; static OSSL_FUNC_cipher_final_fn siv_stream_final; static OSSL_FUNC_cipher_cipher_fn siv_cipher; static OSSL_FUNC_cipher_get_params_fn aes_192_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn aes_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn aes_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn aes_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn aes_siv_settable_ctx_params; static int aes_192_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10004, (0x0001 | 0x0002), 2*192, 8, 0); } static void *aes192siv_newctx(void *provctx) { return aes_siv_newctx(provctx, 2*192, 0x10004, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes192siv_functions[] = { { 1, (void (*)(void))aes192siv_newctx }, { 7, (void (*)(void))aes_siv_freectx }, { 8, (void (*)(void)) siv_dupctx }, { 2, (void (*)(void)) siv_einit }, { 3, (void (*)(void)) siv_dinit }, { 4, (void (*)(void)) siv_cipher }, { 5, (void (*)(void)) siv_stream_final }, { 6, (void (*)(void)) siv_cipher }, { 9, (void (*)(void)) aes_192_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void)) aes_siv_get_ctx_params }, { 13, (void (*)(void)) aes_siv_gettable_ctx_params }, { 11, (void (*)(void)) aes_siv_set_ctx_params }, { 14, (void (*)(void)) aes_siv_settable_ctx_params }, { 0, 
# 304 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
((void *)0) 
# 304 "../providers/implementations/ciphers/cipher_aes_siv.c"
} };
static OSSL_FUNC_cipher_newctx_fn aes256siv_newctx; static OSSL_FUNC_cipher_freectx_fn aes_siv_freectx; static OSSL_FUNC_cipher_dupctx_fn siv_dupctx; static OSSL_FUNC_cipher_encrypt_init_fn siv_einit; static OSSL_FUNC_cipher_decrypt_init_fn siv_dinit; static OSSL_FUNC_cipher_update_fn siv_cipher; static OSSL_FUNC_cipher_final_fn siv_stream_final; static OSSL_FUNC_cipher_cipher_fn siv_cipher; static OSSL_FUNC_cipher_get_params_fn aes_256_siv_get_params; static OSSL_FUNC_cipher_get_ctx_params_fn aes_siv_get_ctx_params; static OSSL_FUNC_cipher_gettable_ctx_params_fn aes_siv_gettable_ctx_params; static OSSL_FUNC_cipher_set_ctx_params_fn aes_siv_set_ctx_params; static OSSL_FUNC_cipher_settable_ctx_params_fn aes_siv_settable_ctx_params; static int aes_256_siv_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10004, (0x0001 | 0x0002), 2*256, 8, 0); } static void *aes256siv_newctx(void *provctx) { return aes_siv_newctx(provctx, 2*256, 0x10004, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes256siv_functions[] = { { 1, (void (*)(void))aes256siv_newctx }, { 7, (void (*)(void))aes_siv_freectx }, { 8, (void (*)(void)) siv_dupctx }, { 2, (void (*)(void)) siv_einit }, { 3, (void (*)(void)) siv_dinit }, { 4, (void (*)(void)) siv_cipher }, { 5, (void (*)(void)) siv_stream_final }, { 6, (void (*)(void)) siv_cipher }, { 9, (void (*)(void)) aes_256_siv_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void)) aes_siv_get_ctx_params }, { 13, (void (*)(void)) aes_siv_gettable_ctx_params }, { 11, (void (*)(void)) aes_siv_set_ctx_params }, { 14, (void (*)(void)) aes_siv_settable_ctx_params }, { 0, 
# 305 "../providers/implementations/ciphers/cipher_aes_siv.c" 3 4
((void *)0) 
# 305 "../providers/implementations/ciphers/cipher_aes_siv.c"
} };
