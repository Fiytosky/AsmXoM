# 0 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
# 14 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 2
# 38 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
...
# 43 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 3 4
                                   ((void *)0)
# 43 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
                                       ;
    OSSL_xts_stream_fn stream_dec = 
# 44 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 3 4
                                   ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
                                       ;
# 67 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
    ...
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        { size_t bytes = keylen / 2; size_t bits = bytes * 8; if (ctx->enc) { vpaes_set_encrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)vpaes_encrypt; } else { vpaes_set_decrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)vpaes_decrypt; } vpaes_set_encrypt_key(key + bytes, bits, &xctx->ks2.ks); xctx->xts.block2 = (block128_f)vpaes_encrypt; xctx->xts.key1 = &xctx->ks1; xctx->xts.key2 = &xctx->ks2; xctx->stream = ctx->enc ? stream_enc : stream_dec; }
                                                                            ;
        return 1;
    } else
    ...
    {
        { size_t bytes = keylen / 2; size_t bits = bytes * 8; if (ctx->enc) { AES_set_encrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)AES_encrypt; } else { AES_set_decrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)AES_decrypt; } AES_set_encrypt_key(key + bytes, bits, &xctx->ks2.ks); xctx->xts.block2 = (block128_f)AES_encrypt; xctx->xts.key1 = &xctx->ks1; xctx->xts.key2 = &xctx->ks2; xctx->stream = ctx->enc ? stream_enc : stream_dec; }
                                                                        ;
    }
    return 1;
}
                                       ...
                                       const unsigned char *key, size_t keylen)
{
    ...
    { size_t bytes = keylen / 2; size_t bits = bytes * 8; if (ctx->enc) { aesni_set_encrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)aesni_encrypt; } else { aesni_set_decrypt_key(key, bits, &xctx->ks1.ks); xctx->xts.block1 = (block128_f)aesni_decrypt; } aesni_set_encrypt_key(key + bytes, bits, &xctx->ks2.ks); xctx->xts.block2 = (block128_f)aesni_encrypt; xctx->xts.key1 = &xctx->ks1; xctx->xts.key2 = &xctx->ks2; xctx->stream = ctx->enc ? aesni_xts_encrypt : aesni_xts_decrypt; }

                                                        ;
    return 1;
}
# 296 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
static const PROV_CIPHER_HW aes_generic_xts = {
    cipher_hw_aes_xts_generic_initkey,
    
# 298 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 3 4
   ((void *)0)
# 298 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
       ,
    cipher_hw_aes_xts_copyctx
};
static const PROV_CIPHER_HW aesni_xts = { cipher_hw_aesni_xts_initkey, 
# 301 "../providers/implementations/ciphers/cipher_aes_xts_hw.c" 3 4
((void *)0)
# 301 "../providers/implementations/ciphers/cipher_aes_xts_hw.c"
, cipher_hw_aes_xts_copyctx };
const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_xts(size_t keybits)
{
    if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_xts;
