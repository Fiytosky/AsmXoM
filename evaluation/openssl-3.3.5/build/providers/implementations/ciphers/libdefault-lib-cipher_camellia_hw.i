# 0 "../providers/implementations/ciphers/cipher_camellia_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_camellia_hw.c"
# 14 "../providers/implementations/ciphers/cipher_camellia_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_camellia_hw.c" 2
...
void Camellia_ctr128_encrypt(const unsigned char *in, unsigned char *out,
                             ...
                             unsigned int *num);
# 17 "../providers/implementations/ciphers/cipher_camellia_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_camellia_hw.c" 2
# 1 "../providers/implementations/ciphers/cipher_camellia.h" 1
# 11 "../providers/implementations/ciphers/cipher_camellia.h"
...
# 19 "../providers/implementations/ciphers/cipher_camellia_hw.c" 2
                                      ...
                                      const unsigned char *key, size_t keylen)
{
    ...
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_camellia_hw.c",30,__func__), ERR_set_error)((57),(101),
# 30 "../providers/implementations/ciphers/cipher_camellia_hw.c" 3 4
       ((void *)0)
# 30 "../providers/implementations/ciphers/cipher_camellia_hw.c"
       );
        return 0;
    }
    if (dat->enc || (mode != 0x1 && mode != 0x2)) {
        dat->block = (block128_f) Camellia_encrypt;
        dat->stream.cbc = mode == 0x2 ?
            (cbc128_f) Camellia_cbc_encrypt : 
# 36 "../providers/implementations/ciphers/cipher_camellia_hw.c" 3 4
                                             ((void *)0)
# 36 "../providers/implementations/ciphers/cipher_camellia_hw.c"
                                                 ;
    } else {
        dat->block = (block128_f) Camellia_decrypt;
        dat->stream.cbc = mode == 0x2 ?
            (cbc128_f) Camellia_cbc_encrypt : 
# 40 "../providers/implementations/ciphers/cipher_camellia_hw.c" 3 4
                                             ((void *)0)
# 40 "../providers/implementations/ciphers/cipher_camellia_hw.c"
                                                 ;
    }
    return 1;
}

static void cipher_hw_camellia_copyctx(PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src) { PROV_CAMELLIA_CTX *sctx = (PROV_CAMELLIA_CTX *)src; PROV_CAMELLIA_CTX *dctx = (PROV_CAMELLIA_CTX *)dst; *dctx = *sctx; dst->ks = &dctx->ks.ks; }
# 68 "../providers/implementations/ciphers/cipher_camellia_hw.c"
static const PROV_CIPHER_HW camellia_cbc = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_cbc, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_cbc(size_t keybits) { return &camellia_cbc; }
static const PROV_CIPHER_HW camellia_ecb = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_ecb, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_ecb(size_t keybits) { return &camellia_ecb; }
static const PROV_CIPHER_HW camellia_ofb128 = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_ofb128, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_ofb128(size_t keybits) { return &camellia_ofb128; }
static const PROV_CIPHER_HW camellia_cfb128 = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_cfb128, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_cfb128(size_t keybits) { return &camellia_cfb128; }
static const PROV_CIPHER_HW camellia_cfb1 = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_cfb1, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_cfb1(size_t keybits) { return &camellia_cfb1; }
static const PROV_CIPHER_HW camellia_cfb8 = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_cfb8, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_cfb8(size_t keybits) { return &camellia_cfb8; }
static const PROV_CIPHER_HW camellia_ctr = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_ctr, cipher_hw_camellia_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_camellia_ctr(size_t keybits) { return &camellia_ctr; }
