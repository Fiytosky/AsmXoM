# 0 "../providers/implementations/ciphers/cipher_aes_ocb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_ocb.c"
# 15 "../providers/implementations/ciphers/cipher_aes_ocb.c"
...
# 16 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
# 1 "../providers/implementations/ciphers/cipher_aes_ocb.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_ocb.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_ocb.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aes_ocb.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_ocb.h" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
...
# 20 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
# 1 "../providers/implementations/include/prov/ciphercommon_aead.h" 1
# 12 "../providers/implementations/include/prov/ciphercommon_aead.h"
        
# 21 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_ocb.c" 2
# 30 "../providers/implementations/ciphers/cipher_aes_ocb.c"
typedef int (* OSSL_ocb_cipher_fn)(PROV_AES_OCB_CTX *ctx, const unsigned char *in, unsigned char *out, size_t nextblock)
                        ...
                        const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 117 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
             ((void *)0)
# 117 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                 ) {
        if (ivlen != ctx->base.ivlen) {

            if (ivlen < 1 || ivlen > 15) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",121,__func__), ERR_set_error)((57),(109),
# 121 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
               ((void *)0)
# 121 "../providers/implementations/ciphers/cipher_aes_ocb.c"
               );
                return 0;
            }
    ...
    if (key != 
# 130 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 130 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ) {
        if (keylen != ctx->base.keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",132,__func__), ERR_set_error)((57),(105),
# 132 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 132 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
                                         ...
                                         size_t inl, OSSL_ocb_cipher_fn ciph)
{
    ...
    if (*bufsz != 0)
        nextblocks = ossl_cipher_fillblock(buf, bufsz, 16, &in, &inl);
    else
        nextblocks = inl & ~(16 -1);

    if (*bufsz == 16) {
        if (outsize < 16) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",175,__func__), ERR_set_error)((57),(106),
# 175 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 175 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (!ciph(ctx, buf, out, 16)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",179,__func__), ERR_set_error)((57),(102),
# 179 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 179 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        *bufsz = 0;
        outlint = 16;
        if (out != 
# 184 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
                  ((void *)0)
# 184 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                      )
            out += 16;
    }
    if (nextblocks > 0) {
        outlint += nextblocks;
        if (outsize < outlint) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",190,__func__), ERR_set_error)((57),(106),
# 190 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 190 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (!ciph(ctx, in, out, nextblocks)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",194,__func__), ERR_set_error)((57),(102),
# 194 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 194 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        in += nextblocks;
    ...
    if (inl != 0
        && !ossl_cipher_trailingdata(buf, bufsz, 16, &in, &inl)) {
                                ...
                                size_t inl)
{
    ...
    if (out == 
# 249 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 249 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ) {
        buf = ctx->aad_buf;
                            ...
                            size_t ivbits, unsigned int mode, uint64_t flags)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 312 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 312 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_ocb.c", 314);
    if (ctx != 
# 315 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 315 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ) {
        ossl_cipher_generic_initkey(ctx, kbits, blkbits, ivbits, mode, flags,
                                    ossl_prov_cipher_hw_aes_ocb(kbits), 
# 317 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
                                                                       ((void *)0)
# 317 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                                                                           );
        ctx->taglen = 16;
    }
    return ctx;
...
static void aes_ocb_freectx(void *vctx)
{
    ...
    if (ctx != 
# 327 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 327 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ) {
        aes_generic_ocb_cleanup(ctx);
        ossl_cipher_generic_reset_ctx((PROV_CIPHER_CTX *)vctx);
        CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_ocb.c", 330);
    }
}
...
static void *aes_ocb_dupctx(void *vctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 340 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 340 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_aes_ocb.c", 342);
    if (ret == 
# 343 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 343 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  )
        return 
# 344 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
              ((void *)0)
# 344 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                  ;
    *ret = *in;
    if (!aes_generic_ocb_copy_ctx(ret, in)) {
        CRYPTO_free(ret, "../providers/implementations/ciphers/cipher_aes_ocb.c", 347);
        ret = 
# 348 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
             ((void *)0)
# 348 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                 ;
    }
    return ret;
}
...
static int aes_ocb_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 359 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
                 ((void *)0)
# 359 "../providers/implementations/ciphers/cipher_aes_ocb.c"
    ...
    if (p != 
# 363 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 363 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",365,__func__), ERR_set_error)((57),(103),
# 365 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 365 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (p->data == 
# 368 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
                      ((void *)0)
# 368 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                          ) {

            if (p->data_size > 16) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",371,__func__), ERR_set_error)((57),(118),
# 371 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
               ((void *)0)
# 371 "../providers/implementations/ciphers/cipher_aes_ocb.c"
               );
                return 0;
            }
            ...
            if (ctx->base.enc) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",377,__func__), ERR_set_error)((57),((262|(0x2 << 18L))),
# 377 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
               ((void *)0)
# 377 "../providers/implementations/ciphers/cipher_aes_ocb.c"
               );
                return 0;
            }
            if (p->data_size != ctx->taglen) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",381,__func__), ERR_set_error)((57),(118),
# 381 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
               ((void *)0)
# 381 "../providers/implementations/ciphers/cipher_aes_ocb.c"
               );
                return 0;
            }
    ...
    if (p != 
# 388 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 388 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (!OSSL_PARAM_get_size_t(p, &sz)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",390,__func__), ERR_set_error)((57),(103),
# 390 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 390 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
    ...
    if (p != 
# 402 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 402 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        size_t keylen;

        if (!OSSL_PARAM_get_size_t(p, &keylen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",406,__func__), ERR_set_error)((57),(103),
# 406 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 406 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (ctx->base.keylen != keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",410,__func__), ERR_set_error)((57),(105),
# 410 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 410 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
    }
...
static int aes_ocb_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 423 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0) 
# 423 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->base.ivlen)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",424,__func__), ERR_set_error)((57),(104),
# 424 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
       ((void *)0)
# 424 "../providers/implementations/ciphers/cipher_aes_ocb.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "keylen");
    if (p != 
# 428 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0) 
# 428 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->base.keylen)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",429,__func__), ERR_set_error)((57),(104),
# 429 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
       ((void *)0)
# 429 "../providers/implementations/ciphers/cipher_aes_ocb.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "taglen");
    if (p != 
# 433 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 433 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (!OSSL_PARAM_set_size_t(p, ctx->taglen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",435,__func__), ERR_set_error)((57),(104),
# 435 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 435 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 441 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 441 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (ctx->base.ivlen > p->data_size) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",443,__func__), ERR_set_error)((57),(109),
# 443 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 443 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (!OSSL_PARAM_set_octet_string(p, ctx->base.oiv, ctx->base.ivlen)
            && !OSSL_PARAM_set_octet_ptr(p, &ctx->base.oiv, ctx->base.ivlen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",448,__func__), ERR_set_error)((57),(104),
# 448 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 448 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 453 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 453 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (ctx->base.ivlen > p->data_size) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",455,__func__), ERR_set_error)((57),(109),
# 455 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 455 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (!OSSL_PARAM_set_octet_string(p, ctx->base.iv, ctx->base.ivlen)
            && !OSSL_PARAM_set_octet_ptr(p, &ctx->base.iv, ctx->base.ivlen)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",460,__func__), ERR_set_error)((57),(104),
# 460 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 460 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 465 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
            ((void *)0)
# 465 "../providers/implementations/ciphers/cipher_aes_ocb.c"
                ) {
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",467,__func__), ERR_set_error)((57),(103),
# 467 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 467 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
        if (!ctx->base.enc || p->data_size != ctx->taglen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",471,__func__), ERR_set_error)((57),(118),
# 471 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
           ((void *)0)
# 471 "../providers/implementations/ciphers/cipher_aes_ocb.c"
           );
            return 0;
        }
...
static const OSSL_PARAM cipher_ocb_known_gettable_ctx_params[] = {
    { (("keylen")), (2), ((
# 480 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 480 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("ivlen")), (2), ((
# 481 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 481 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("taglen")), (2), ((
# 482 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 482 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("iv")), (5), ((
# 483 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 483 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (0), ((size_t)-1) },
    { (("updated-iv")), (5), ((
# 484 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 484 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (0), ((size_t)-1) },
    { (("tag")), (5), ((
# 485 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 485 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (0), ((size_t)-1) },
    { 
# 486 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 486 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   , 0, 
# 486 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 486 "../providers/implementations/ciphers/cipher_aes_ocb.c"
...
static const OSSL_PARAM *cipher_ocb_gettable_ctx_params(__attribute__((unused)) void *cctx,
...
static const OSSL_PARAM cipher_ocb_known_settable_ctx_params[] = {
    { (("keylen")), (2), ((
# 495 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 495 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("ivlen")), (2), ((
# 496 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 496 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("tag")), (5), ((
# 497 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 497 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   )), (0), ((size_t)-1) },
    { 
# 498 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 498 "../providers/implementations/ciphers/cipher_aes_ocb.c"
   , 0, 
# 498 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
   ((void *)0)
# 498 "../providers/implementations/ciphers/cipher_aes_ocb.c"
...
static const OSSL_PARAM *cipher_ocb_settable_ctx_params(__attribute__((unused)) void *cctx,
                                                        __attribute__((unused)) void *p_ctx)
{
                          ...
                          size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",515,__func__), ERR_set_error)((57),(106),
# 515 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
       ((void *)0)
# 515 "../providers/implementations/ciphers/cipher_aes_ocb.c"
       );
        return 0;
    }

    if (!aes_generic_ocb_cipher(ctx, in, out, inl)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_ocb.c",520,__func__), ERR_set_error)((57),(102),
# 520 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
       ((void *)0)
# 520 "../providers/implementations/ciphers/cipher_aes_ocb.c"
       );
        return 0;
    }
...
# 566 "../providers/implementations/ciphers/cipher_aes_ocb.c"
static OSSL_FUNC_cipher_get_params_fn aes_256_ocb_get_params; static int aes_256_ocb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10003, (0x0001 | 0x0002), 256, 128, 12 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_256_ocb_newctx; static void *aes_256_ocb_newctx(void *provctx) { return aes_ocb_newctx(provctx, 256, 128, 12 * 8, 0x10003, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes256ocb_functions[] = { { 1, (void (*)(void))aes_256_ocb_newctx }, { 2, (void (*)(void))aes_ocb_einit }, { 3, (void (*)(void))aes_ocb_dinit }, { 4, (void (*)(void))aes_ocb_block_update }, { 5, (void (*)(void))aes_ocb_block_final }, { 6, (void (*)(void))aes_ocb_cipher }, { 7, (void (*)(void))aes_ocb_freectx }, { 8, (void (*)(void))aes_ocb_dupctx }, { 9, (void (*)(void))aes_256_ocb_get_params }, { 10, (void (*)(void))aes_ocb_get_ctx_params }, { 11, (void (*)(void))aes_ocb_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))cipher_ocb_gettable_ctx_params }, { 14, (void (*)(void))cipher_ocb_settable_ctx_params }, { 0, 
# 566 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
((void *)0) 
# 566 "../providers/implementations/ciphers/cipher_aes_ocb.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_192_ocb_get_params; static int aes_192_ocb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10003, (0x0001 | 0x0002), 192, 128, 12 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_192_ocb_newctx; static void *aes_192_ocb_newctx(void *provctx) { return aes_ocb_newctx(provctx, 192, 128, 12 * 8, 0x10003, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes192ocb_functions[] = { { 1, (void (*)(void))aes_192_ocb_newctx }, { 2, (void (*)(void))aes_ocb_einit }, { 3, (void (*)(void))aes_ocb_dinit }, { 4, (void (*)(void))aes_ocb_block_update }, { 5, (void (*)(void))aes_ocb_block_final }, { 6, (void (*)(void))aes_ocb_cipher }, { 7, (void (*)(void))aes_ocb_freectx }, { 8, (void (*)(void))aes_ocb_dupctx }, { 9, (void (*)(void))aes_192_ocb_get_params }, { 10, (void (*)(void))aes_ocb_get_ctx_params }, { 11, (void (*)(void))aes_ocb_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))cipher_ocb_gettable_ctx_params }, { 14, (void (*)(void))cipher_ocb_settable_ctx_params }, { 0, 
# 567 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
((void *)0) 
# 567 "../providers/implementations/ciphers/cipher_aes_ocb.c"
} };
static OSSL_FUNC_cipher_get_params_fn aes_128_ocb_get_params; static int aes_128_ocb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x10003, (0x0001 | 0x0002), 128, 128, 12 * 8); } static OSSL_FUNC_cipher_newctx_fn aes_128_ocb_newctx; static void *aes_128_ocb_newctx(void *provctx) { return aes_ocb_newctx(provctx, 128, 128, 12 * 8, 0x10003, (0x0001 | 0x0002)); } const OSSL_DISPATCH ossl_aes128ocb_functions[] = { { 1, (void (*)(void))aes_128_ocb_newctx }, { 2, (void (*)(void))aes_ocb_einit }, { 3, (void (*)(void))aes_ocb_dinit }, { 4, (void (*)(void))aes_ocb_block_update }, { 5, (void (*)(void))aes_ocb_block_final }, { 6, (void (*)(void))aes_ocb_cipher }, { 7, (void (*)(void))aes_ocb_freectx }, { 8, (void (*)(void))aes_ocb_dupctx }, { 9, (void (*)(void))aes_128_ocb_get_params }, { 10, (void (*)(void))aes_ocb_get_ctx_params }, { 11, (void (*)(void))aes_ocb_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))cipher_ocb_gettable_ctx_params }, { 14, (void (*)(void))cipher_ocb_settable_ctx_params }, { 0, 
# 568 "../providers/implementations/ciphers/cipher_aes_ocb.c" 3 4
((void *)0) 
# 568 "../providers/implementations/ciphers/cipher_aes_ocb.c"
} };
