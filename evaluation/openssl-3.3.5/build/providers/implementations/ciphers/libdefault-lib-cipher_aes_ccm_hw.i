# 0 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
# 16 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
...
# 17 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 2
# 27 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
static int ccm_generic_aes_initkey(PROV_CCM_CTX *ctx, const unsigned char *key,
                                   size_t keylen)
{
    PROV_AES_CCM_CTX *actx = (PROV_AES_CCM_CTX *)ctx;
# 39 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        vpaes_set_encrypt_key(key, keylen * 8, &actx->ccm.ks.ks); CRYPTO_ccm128_init(&ctx->ccm_ctx, ctx->m, ctx->l, &actx->ccm.ks.ks, (block128_f)vpaes_encrypt); ctx->str = ctx->enc ? (ccm128_f)
# 40 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 3 4
       ((void *)0) 
# 40 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
       : (ccm128_f)
# 40 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 3 4
       ((void *)0)
# 40 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
    ...
    {
        AES_set_encrypt_key(key, keylen * 8, &actx->ccm.ks.ks); CRYPTO_ccm128_init(&ctx->ccm_ctx, ctx->m, ctx->l, &actx->ccm.ks.ks, (block128_f)AES_encrypt); ctx->str = ctx->enc ? (ccm128_f)
# 44 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 3 4
       ((void *)0) 
# 44 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
       : (ccm128_f)
# 44 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 3 4
       ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c"
...
# 1 "../providers/implementations/ciphers/cipher_aes_ccm_hw_aesni.inc" 1
# 15 "../providers/implementations/ciphers/cipher_aes_ccm_hw_aesni.inc"
static int ccm_aesni_initkey(PROV_CCM_CTX *ctx, const unsigned char *key,
                             size_t keylen)
{
    PROV_AES_CCM_CTX *actx = (PROV_AES_CCM_CTX *)ctx;

    aesni_set_encrypt_key(key, keylen * 8, &actx->ccm.ks.ks); CRYPTO_ccm128_init(&ctx->ccm_ctx, ctx->m, ctx->l, &actx->ccm.ks.ks, (block128_f)aesni_encrypt); ctx->str = ctx->enc ? (ccm128_f)aesni_ccm64_encrypt_blocks : (ccm128_f)aesni_ccm64_decrypt_blocks; ctx->key_set = 1;
...
{
    return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_ccm : &aes_ccm;
}
# 62 "../providers/implementations/ciphers/cipher_aes_ccm_hw.c" 2
