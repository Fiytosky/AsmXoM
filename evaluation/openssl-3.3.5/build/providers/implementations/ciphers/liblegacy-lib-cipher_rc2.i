# 0 "../providers/implementations/ciphers/cipher_rc2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_rc2.c"
# 16 "../providers/implementations/ciphers/cipher_rc2.c"
...
# 17 "../providers/implementations/ciphers/cipher_rc2.c" 2
...
# 19 "../providers/implementations/ciphers/cipher_rc2.c" 2
# 1 "../providers/implementations/ciphers/cipher_rc2.h" 1
# 10 "../providers/implementations/ciphers/cipher_rc2.h"
...
extern void RC2_ofb64_encrypt(const unsigned char *in,
                                             ...
                                             unsigned char *ivec,
                                             int *num);
# 11 "../providers/implementations/ciphers/cipher_rc2.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_rc2.h" 2
...
# 20 "../providers/implementations/ciphers/cipher_rc2.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_rc2.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_rc2.c" 2
...
static void rc2_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 41);
}
...
static void *rc2_dupctx(void *ctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 50 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
              ((void *)0)
# 50 "../providers/implementations/ciphers/cipher_rc2.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_rc2.c", 52);
    if (ret == 
# 53 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
              ((void *)0)
# 53 "../providers/implementations/ciphers/cipher_rc2.c"
                  )
        return 
# 54 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
              ((void *)0)
# 54 "../providers/implementations/ciphers/cipher_rc2.c"
                  ;
    *ret = *in;
...
static int rc2_keybits_to_magic(int keybits)
{
    ...
    (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",70,__func__), ERR_set_error)((57),(153),
# 70 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
   ((void *)0)
# 70 "../providers/implementations/ciphers/cipher_rc2.c"
   );
    return 0;
}
...
static int rc2_magic_to_keybits(int magic)
{
    ...
    (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",84,__func__), ERR_set_error)((57),(153),
# 84 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
   ((void *)0)
# 84 "../providers/implementations/ciphers/cipher_rc2.c"
   );
    return 0;
}
...
# 92 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                                               ((void *)0)
# 92 "../providers/implementations/ciphers/cipher_rc2.c"
                                                                   ))
        return 0;
...
# 101 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                                               ((void *)0)
# 101 "../providers/implementations/ciphers/cipher_rc2.c"
                                                                   ))
        return 0;
    return rc2_set_ctx_params(ctx, params);
}
...
static int rc2_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (!ossl_cipher_generic_get_ctx_params(vctx, params))
        return 0;
    p = OSSL_PARAM_locate(params, "keybits");
    if (p != 
# 114 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
            ((void *)0) 
# 114 "../providers/implementations/ciphers/cipher_rc2.c"
                 && !OSSL_PARAM_set_size_t(p, ctx->key_bits)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",115,__func__), ERR_set_error)((57),(104),
# 115 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
       ((void *)0)
# 115 "../providers/implementations/ciphers/cipher_rc2.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "alg_id_param");
    if (p != 
# 119 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
            ((void *)0)
# 119 "../providers/implementations/ciphers/cipher_rc2.c"
                ) {
        long num;
        int i;
        ASN1_TYPE *type;
        ...
        unsigned char **dd = d == 
# 124 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                 ((void *)0) 
# 124 "../providers/implementations/ciphers/cipher_rc2.c"
                                      ? 
# 124 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                        ((void *)0) 
# 124 "../providers/implementations/ciphers/cipher_rc2.c"
        ...
        if (p->data_type != 5) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",127,__func__), ERR_set_error)((57),(104),
# 127 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 127 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            return 0;
        }
        if ((type = ASN1_TYPE_new()) == 
# 130 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                       ((void *)0)
# 130 "../providers/implementations/ciphers/cipher_rc2.c"
                                           ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",131,__func__), ERR_set_error)((57),((13 | (0x2 << 18L))),
# 131 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 131 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            return 0;
        }
        ...
        if (!ASN1_TYPE_set_int_octetstring(type, num,
            ...
            ASN1_TYPE_free(type);
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",140,__func__), ERR_set_error)((57),((13 | (0x2 << 18L))),
# 140 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 140 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            return 0;
        }
        ...
        ASN1_TYPE_free(type);
        if (i < 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",153,__func__), ERR_set_error)((57),(104),
# 153 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 153 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            return 0;
        }
    }
...
static int rc2_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 165 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                 ((void *)0)
# 165 "../providers/implementations/ciphers/cipher_rc2.c"
                     )
        return 1;

    if (!ossl_cipher_var_keylen_set_ctx_params(vctx, params))
        return 0;
    p = OSSL_PARAM_locate_const(params, "keybits");
    if (p != 
# 171 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
            ((void *)0)
# 171 "../providers/implementations/ciphers/cipher_rc2.c"
                ) {
         if (!OSSL_PARAM_get_size_t(p, &ctx->key_bits)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",173,__func__), ERR_set_error)((57),(103),
# 173 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 173 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            return 0;
        }
    }
    p = OSSL_PARAM_locate_const(params, "alg_id_param");
    if (p != 
# 178 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
            ((void *)0)
# 178 "../providers/implementations/ciphers/cipher_rc2.c"
                ) {
        ASN1_TYPE *type = 
# 179 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                         ((void *)0)
# 179 "../providers/implementations/ciphers/cipher_rc2.c"
                             ;
        long num = 0;
        ...
        if (p->data_type != 5
            ...
            || (type = d2i_ASN1_TYPE(
# 187 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                    ((void *)0)
# 187 "../providers/implementations/ciphers/cipher_rc2.c"
                                        , &d, p->data_size)) == 
# 187 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
                                                                ((void *)0)
            
# 188 "../providers/implementations/ciphers/cipher_rc2.c"
           || ((size_t)ASN1_TYPE_get_int_octetstring(type, &num, iv,
            ...
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_rc2.c",193,__func__), ERR_set_error)((57),(104),
# 193 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
           ((void *)0)
# 193 "../providers/implementations/ciphers/cipher_rc2.c"
           );
            ret = 0;
        }
        ASN1_TYPE_free(type);
...
static const OSSL_PARAM rc2_known_gettable_ctx_params[] = { { (("keylen")), (2), ((
# 209 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 209 "../providers/implementations/ciphers/cipher_rc2.c"
...
{ (("keybits")), (2), ((
# 210 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 210 "../providers/implementations/ciphers/cipher_rc2.c"
)), (sizeof(size_t)), ((size_t)-1) },
{ (("alg_id_param")), (5), ((
# 211 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 211 "../providers/implementations/ciphers/cipher_rc2.c"
)), (0), ((size_t)-1) },
{ 
# 212 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 212 "../providers/implementations/ciphers/cipher_rc2.c"
, 0, 
# 212 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 212 "../providers/implementations/ciphers/cipher_rc2.c"
, 0, 0 } }; const OSSL_PARAM * rc2_gettable_ctx_params(__attribute__((unused)) void *cctx, __attribute__((unused)) void *provctx) { return rc2_known_gettable_ctx_params; }

static const OSSL_PARAM rc2_known_settable_ctx_params[] = { { (("padding")), (2), ((
# 214 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 214 "../providers/implementations/ciphers/cipher_rc2.c"
)), (sizeof(unsigned int)), ((size_t)-1) }, { (("num")), (2), ((
# 214 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 214 "../providers/implementations/ciphers/cipher_rc2.c"
...
{ (("keylen")), (2), ((
# 215 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 215 "../providers/implementations/ciphers/cipher_rc2.c"
)), (sizeof(size_t)), ((size_t)-1) },
{ (("keybits")), (2), ((
# 216 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 216 "../providers/implementations/ciphers/cipher_rc2.c"
)), (sizeof(size_t)), ((size_t)-1) },
{ (("alg_id_param")), (5), ((
# 217 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 217 "../providers/implementations/ciphers/cipher_rc2.c"
)), (0), ((size_t)-1) },
{ 
# 218 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 218 "../providers/implementations/ciphers/cipher_rc2.c"
, 0, 
# 218 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 218 "../providers/implementations/ciphers/cipher_rc2.c"
, 0, 0 } }; const OSSL_PARAM * rc2_settable_ctx_params(__attribute__((unused)) void *cctx, __attribute__((unused)) void *provctx) { return rc2_known_settable_ctx_params; }
# 270 "../providers/implementations/ciphers/cipher_rc2.c"
static OSSL_FUNC_cipher_get_params_fn rc2_128_ecb_get_params; static int rc2_128_ecb_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x1, 0x0100, 128, 64, 0); } static OSSL_FUNC_cipher_newctx_fn rc2_128_ecb_newctx; static void *rc2_128_ecb_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 270 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 270 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 270); if (ctx != 
# 270 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 270 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 128, 64, 0, 0x1, 0x0100, ossl_prov_cipher_hw_rc2_ecb(128), 
# 270 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 270 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 128; } return ctx; } const OSSL_DISPATCH ossl_rc2128ecb_functions[] = { { 1, (void (*)(void)) rc2_128_ecb_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_128_ecb_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 270 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 270 "../providers/implementations/ciphers/cipher_rc2.c"
} };

static OSSL_FUNC_cipher_get_params_fn rc2_128_cbc_get_params; static int rc2_128_cbc_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x2, 0x0100, 128, 64, 64); } static OSSL_FUNC_cipher_newctx_fn rc2_128_cbc_newctx; static void *rc2_128_cbc_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 272 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 272 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 272); if (ctx != 
# 272 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 272 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 128, 64, 64, 0x2, 0x0100, ossl_prov_cipher_hw_rc2_cbc(128), 
# 272 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 272 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 128; } return ctx; } const OSSL_DISPATCH ossl_rc2128cbc_functions[] = { { 1, (void (*)(void)) rc2_128_cbc_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_128_cbc_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 272 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 272 "../providers/implementations/ciphers/cipher_rc2.c"
} };

static OSSL_FUNC_cipher_get_params_fn rc2_40_cbc_get_params; static int rc2_40_cbc_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x2, 0x0100, 40, 64, 64); } static OSSL_FUNC_cipher_newctx_fn rc2_40_cbc_newctx; static void *rc2_40_cbc_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 274 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 274 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 274); if (ctx != 
# 274 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 274 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 40, 64, 64, 0x2, 0x0100, ossl_prov_cipher_hw_rc2_cbc(40), 
# 274 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 274 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 40; } return ctx; } const OSSL_DISPATCH ossl_rc240cbc_functions[] = { { 1, (void (*)(void)) rc2_40_cbc_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_40_cbc_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 274 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 274 "../providers/implementations/ciphers/cipher_rc2.c"
} };

static OSSL_FUNC_cipher_get_params_fn rc2_64_cbc_get_params; static int rc2_64_cbc_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x2, 0x0100, 64, 64, 64); } static OSSL_FUNC_cipher_newctx_fn rc2_64_cbc_newctx; static void *rc2_64_cbc_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 276 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 276 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 276); if (ctx != 
# 276 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 276 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 64, 64, 64, 0x2, 0x0100, ossl_prov_cipher_hw_rc2_cbc(64), 
# 276 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 276 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 64; } return ctx; } const OSSL_DISPATCH ossl_rc264cbc_functions[] = { { 1, (void (*)(void)) rc2_64_cbc_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_block_update }, { 5, (void (*)(void))ossl_cipher_generic_block_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_64_cbc_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 276 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 276 "../providers/implementations/ciphers/cipher_rc2.c"
} };
...
static OSSL_FUNC_cipher_get_params_fn rc2_128_ofb128_get_params; static int rc2_128_ofb128_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x4, 0x0100, 128, 8, 64); } static OSSL_FUNC_cipher_newctx_fn rc2_128_ofb128_newctx; static void *rc2_128_ofb128_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 279 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 279 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 279); if (ctx != 
# 279 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 279 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 128, 8, 64, 0x4, 0x0100, ossl_prov_cipher_hw_rc2_ofb64(128), 
# 279 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 279 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 128; } return ctx; } const OSSL_DISPATCH ossl_rc2128ofb128_functions[] = { { 1, (void (*)(void)) rc2_128_ofb128_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_128_ofb128_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 279 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 279 "../providers/implementations/ciphers/cipher_rc2.c"
} };

static OSSL_FUNC_cipher_get_params_fn rc2_128_cfb128_get_params; static int rc2_128_cfb128_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x3, 0x0100, 128, 8, 64); } static OSSL_FUNC_cipher_newctx_fn rc2_128_cfb128_newctx; static void *rc2_128_cfb128_newctx(void *provctx) { PROV_RC2_CTX *ctx; if (!ossl_prov_is_running()) return 
# 281 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 281 "../providers/implementations/ciphers/cipher_rc2.c"
; ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_rc2.c", 281); if (ctx != 
# 281 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 281 "../providers/implementations/ciphers/cipher_rc2.c"
) { ossl_cipher_generic_initkey(ctx, 128, 8, 64, 0x3, 0x0100, ossl_prov_cipher_hw_rc2_cfb64(128), 
# 281 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0)
# 281 "../providers/implementations/ciphers/cipher_rc2.c"
); ctx->key_bits = 128; } return ctx; } const OSSL_DISPATCH ossl_rc2128cfb128_functions[] = { { 1, (void (*)(void)) rc2_128_cfb128_newctx }, { 7, (void (*)(void)) rc2_freectx }, { 8, (void (*)(void)) rc2_dupctx }, { 2, (void (*)(void))rc2_einit }, { 3, (void (*)(void))rc2_dinit }, { 4, (void (*)(void))ossl_cipher_generic_stream_update }, { 5, (void (*)(void))ossl_cipher_generic_stream_final }, { 6, (void (*)(void))ossl_cipher_generic_cipher }, { 9, (void (*)(void)) rc2_128_cfb128_get_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 10, (void (*)(void))rc2_get_ctx_params }, { 13, (void (*)(void))rc2_gettable_ctx_params }, { 11, (void (*)(void))rc2_set_ctx_params }, { 14, (void (*)(void))rc2_settable_ctx_params }, { 0, 
# 281 "../providers/implementations/ciphers/cipher_rc2.c" 3 4
((void *)0) 
# 281 "../providers/implementations/ciphers/cipher_rc2.c"
} };
