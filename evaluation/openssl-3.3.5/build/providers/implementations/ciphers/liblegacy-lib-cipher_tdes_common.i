# 0 "../providers/implementations/ciphers/cipher_tdes_common.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_tdes_common.c"
# 14 "../providers/implementations/ciphers/cipher_tdes_common.c"
...
# 15 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
...
int RAND_poll(void);
# 17 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 18 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 19 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
...
# 20 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_tdes_common.c" 2
                       ...
                       size_t ivbits, uint64_t flags, const PROV_CIPHER_HW *hw)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 29 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
              ((void *)0)
# 29 "../providers/implementations/ciphers/cipher_tdes_common.c"
                  ;

    tctx = CRYPTO_zalloc(sizeof(*tctx), "../providers/implementations/ciphers/cipher_tdes_common.c", 31);
    if (tctx != 
# 32 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
               ((void *)0)
# 32 "../providers/implementations/ciphers/cipher_tdes_common.c"
                   )
...
void *ossl_tdes_dupctx(void *ctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 44 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
              ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_tdes_common.c"
                  ;

    ret = CRYPTO_malloc(sizeof(*ret), "../providers/implementations/ciphers/cipher_tdes_common.c", 46);
    if (ret == 
# 47 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
              ((void *)0)
# 47 "../providers/implementations/ciphers/cipher_tdes_common.c"
                  )
        return 
# 48 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
              ((void *)0)
# 48 "../providers/implementations/ciphers/cipher_tdes_common.c"
                  ;
...
void ossl_tdes_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_tdes_common.c", 59);
}
                     ...
                     const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 75 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
             ((void *)0)
# 75 "../providers/implementations/ciphers/cipher_tdes_common.c"
                 ) {
    ...
    if (key != 
# 86 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
              ((void *)0)
# 86 "../providers/implementations/ciphers/cipher_tdes_common.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_tdes_common.c",88,__func__), ERR_set_error)((57),(105),
# 88 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
           ((void *)0)
# 88 "../providers/implementations/ciphers/cipher_tdes_common.c"
           );
            return 0;
        }
...
static const OSSL_PARAM ossl_tdes_known_gettable_ctx_params[] = { { (("keylen")), (2), ((
# 112 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
((void *)0)
# 112 "../providers/implementations/ciphers/cipher_tdes_common.c"
...
# 112 "../providers/implementations/ciphers/cipher_tdes_common.c"
    ...
    { (("randkey")), (5), ((
# 113 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
   ((void *)0)
# 113 "../providers/implementations/ciphers/cipher_tdes_common.c"
   )), (0), ((size_t)-1) },
{ 
# 114 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
((void *)0)
# 114 "../providers/implementations/ciphers/cipher_tdes_common.c"
, 0, 
# 114 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
((void *)0)
# 114 "../providers/implementations/ciphers/cipher_tdes_common.c"
, 0, 0 } }; const OSSL_PARAM * ossl_tdes_gettable_ctx_params(__attribute__((unused)) void *cctx, __attribute__((unused)) void *provctx) { return ossl_tdes_known_gettable_ctx_params; }
...
int ossl_tdes_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 142 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
            ((void *)0) 
# 142 "../providers/implementations/ciphers/cipher_tdes_common.c"
                 && !tdes_generatekey(ctx, p->data)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_tdes_common.c",143,__func__), ERR_set_error)((57),(121),
# 143 "../providers/implementations/ciphers/cipher_tdes_common.c" 3 4
       ((void *)0)
# 143 "../providers/implementations/ciphers/cipher_tdes_common.c"
       );
        return 0;
    }
    return 1;
