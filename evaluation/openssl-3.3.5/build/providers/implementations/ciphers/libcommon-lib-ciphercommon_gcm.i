# 0 "../providers/implementations/ciphers/ciphercommon_gcm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_gcm.c"
# 12 "../providers/implementations/ciphers/ciphercommon_gcm.c"
...
int RAND_poll(void);
# 13 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 14 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 15 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
# 1 "../providers/implementations/include/prov/ciphercommon_gcm.h" 1
# 13 "../providers/implementations/include/prov/ciphercommon_gcm.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 16 "../providers/implementations/include/prov/ciphercommon_gcm.h" 2
...
# 17 "../providers/implementations/include/prov/ciphercommon_gcm.h" 2

typedef struct prov_gcm_hw_st PROV_GCM_HW;
# 51 "../providers/implementations/include/prov/ciphercommon_gcm.h"
typedef struct prov_gcm_ctx_st {
    ...
    unsigned int pad:1;
    unsigned int key_set:1;
    unsigned int iv_gen_rand:1;
    unsigned int iv_gen:1;

    unsigned char iv[(1024 / 8)];
    unsigned char buf[16];
...
typedef int (* OSSL_GCM_setkey_fn)(PROV_GCM_CTX *ctx, const unsigned char *key, size_t keylen)
                                                  ;
typedef int (* OSSL_GCM_setiv_fn)(PROV_GCM_CTX *dat, const unsigned char *iv, size_t ivlen)
                                                ;
typedef int (* OSSL_GCM_aadupdate_fn)(PROV_GCM_CTX *ctx, const unsigned char *aad, size_t aadlen)
                                                                               ;
typedef int (* OSSL_GCM_cipherupdate_fn)(PROV_GCM_CTX *ctx, const unsigned char *in, size_t len, unsigned char *out)

                                                             ;
typedef int (* OSSL_GCM_cipherfinal_fn)(PROV_GCM_CTX *ctx, unsigned char *tag);
typedef int (* OSSL_GCM_oneshot_fn)(PROV_GCM_CTX *ctx, unsigned char *aad, size_t aad_len, const unsigned char *in, size_t in_len, unsigned char *out, unsigned char *tag, size_t taglen)
...
# 16 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
...
# 17 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
...
# 18 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
# 1 "include/internal/param_names.h" 1
# 14 "include/internal/param_names.h"
int ossl_param_find_pidx(const char *s);
# 19 "../providers/implementations/ciphers/ciphercommon_gcm.c" 2
                    ...
                    const OSSL_PARAM params[], int enc)
{
    ...
    if (iv != 
# 60 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
             ((void *)0)
# 60 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                 ) {
        if (ivlen == 0 || ivlen > sizeof(ctx->iv)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",62,__func__), ERR_set_error)((57),(109),
# 62 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
           ((void *)0)
# 62 "../providers/implementations/ciphers/ciphercommon_gcm.c"
           );
            return 0;
        }
        ctx->ivlen = ivlen;
    ...
    if (key != 
# 70 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
              ((void *)0)
# 70 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                  ) {
        if (keylen != ctx->keylen) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",72,__func__), ERR_set_error)((57),(105),
# 72 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
           ((void *)0)
# 72 "../providers/implementations/ciphers/ciphercommon_gcm.c"
           );
            return 0;
        }
...
int ossl_gcm_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    for (p = params; p->key != 
# 151 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                              ((void *)0)
# 151 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                                  ; p++) {
        ...
        case 47:
            if (!OSSL_PARAM_set_size_t(p, ctx->ivlen)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",159,__func__), ERR_set_error)((57),(104),
# 159 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 159 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 48:
            if (!OSSL_PARAM_set_size_t(p, ctx->keylen)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",166,__func__), ERR_set_error)((57),(104),
# 166 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 166 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 34:
            {
                size_t taglen = (ctx->taglen != ((size_t)-1)) ? ctx->taglen :
                                 16;

                if (!OSSL_PARAM_set_size_t(p, taglen)) {
                    (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",177,__func__), ERR_set_error)((57),(104),
# 177 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                   ((void *)0)
# 177 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                   );
                    return 0;
                }
            }
        ...
        case 46:
            ...
            if (ctx->ivlen > p->data_size) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",187,__func__), ERR_set_error)((57),(109),
# 187 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 187 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (!OSSL_PARAM_set_octet_string(p, ctx->iv, ctx->ivlen)
                && !OSSL_PARAM_set_octet_ptr(p, &ctx->iv, ctx->ivlen)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",192,__func__), ERR_set_error)((57),(104),
# 192 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 192 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 68:
            if (ctx->iv_state == 0)
                return 0;
            if (ctx->ivlen > p->data_size) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",201,__func__), ERR_set_error)((57),(109),
# 201 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 201 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (!OSSL_PARAM_set_octet_string(p, ctx->iv, ctx->ivlen)
                && !OSSL_PARAM_set_octet_ptr(p, &ctx->iv, ctx->ivlen)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",206,__func__), ERR_set_error)((57),(104),
# 206 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 206 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 36:
            if (!OSSL_PARAM_set_size_t(p, ctx->tls_aad_pad_sz)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",213,__func__), ERR_set_error)((57),(104),
# 213 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 213 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 33:
            ...
            if (sz == 0
                ...
                || !ctx->enc
                || ctx->taglen == ((size_t)-1)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",224,__func__), ERR_set_error)((57),(110),
# 224 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 224 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (!OSSL_PARAM_set_octet_string(p, ctx->buf, sz)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",228,__func__), ERR_set_error)((57),(104),
# 228 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 228 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 37:
            if (p->data == 
# 234 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                          ((void *)0)
                
# 235 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               || p->data_type != 5
...
int ossl_gcm_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 252 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                 ((void *)0)
# 252 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                     )
        return 1;

    for (p = params; p->key != 
# 255 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                              ((void *)0)
# 255 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                                  ; p++) {
        type = ossl_param_find_pidx(p->key);
        switch (type) {
        default:
        ...
        case 33:
            vp = ctx->buf;
            if (!OSSL_PARAM_get_octet_string(p, &vp, 16, &sz)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",264,__func__), ERR_set_error)((57),(103),
# 264 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 264 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (sz == 0 || ctx->enc) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",268,__func__), ERR_set_error)((57),(110),
# 268 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 268 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            ctx->taglen = sz;
        ...
        case 47:
            if (!OSSL_PARAM_get_size_t(p, &sz)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",276,__func__), ERR_set_error)((57),(103),
# 276 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 276 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (sz == 0 || sz > sizeof(ctx->iv)) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",280,__func__), ERR_set_error)((57),(109),
# 280 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 280 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (ctx->ivlen != sz) {
        ...
        case 35:
            if (p->data_type != 5) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",293,__func__), ERR_set_error)((57),(103),
# 293 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 293 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            sz = gcm_tls_init(ctx, p->data, p->data_size);
            if (sz == 0) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",298,__func__), ERR_set_error)((57),(108),
# 298 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 298 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
        ...
        case 38:
            if (p->data_type != 5) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",306,__func__), ERR_set_error)((57),(103),
# 306 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 306 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            if (gcm_tls_iv_set_fixed(ctx, p->data, p->data_size) == 0) {
                (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",310,__func__), ERR_set_error)((57),(103),
# 310 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
               ((void *)0)
# 310 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               );
                return 0;
            }
            break;
        ...
        case 39:
            if (p->data == 
# 316 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                          ((void *)0)
                
# 317 "../providers/implementations/ciphers/ciphercommon_gcm.c"
               || p->data_type != 5
                           ...
                           size_t outsize, const unsigned char *in, size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",338,__func__), ERR_set_error)((57),(106),
# 338 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
       ((void *)0)
# 338 "../providers/implementations/ciphers/ciphercommon_gcm.c"
       );
        return 0;
    }

    if (gcm_cipher_internal(ctx, out, outl, in, inl) <= 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",343,__func__), ERR_set_error)((57),(102),
# 343 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
       ((void *)0)
# 343 "../providers/implementations/ciphers/ciphercommon_gcm.c"
       );
        return 0;
    }
    return 1;
                          ...
                          size_t outsize)
{
    ...
    i = gcm_cipher_internal(ctx, out, outl, 
# 358 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                                           ((void *)0)
# 358 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                                               , 0);
    if (i <= 0)
        return 0;
                    ...
                    const unsigned char *in, size_t inl)
{
    ...
    if (outsize < inl) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",376,__func__), ERR_set_error)((57),(106),
# 376 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
       ((void *)0)
# 376 "../providers/implementations/ciphers/ciphercommon_gcm.c"
       );
        return 0;
    }
                               ...
                               size_t len)
{
    ...
    if (in != 
# 442 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
             ((void *)0)
# 442 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                 ) {

        if (out == 
# 444 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                  ((void *)0)
# 444 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                      ) {
        ...
        if (!ctx->enc && ctx->taglen == ((size_t)-1))
            goto err;
...
static int gcm_tls_init(PROV_GCM_CTX *dat, unsigned char *aad, size_t aad_len)
{
    ...
    if (!ossl_prov_is_running() || aad_len != 13)
       return 0;
                          ...
                          const unsigned char *in, size_t len)
{
    ...
    size_t plen = 0;
    unsigned char *tag = 
# 536 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
                        ((void *)0)
# 536 "../providers/implementations/ciphers/ciphercommon_gcm.c"
                            ;
    ...
    if (ctx->enc && ++ctx->tls_enc_records == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/ciphercommon_gcm.c",552,__func__), ERR_set_error)((57),(126),
# 552 "../providers/implementations/ciphers/ciphercommon_gcm.c" 3 4
       ((void *)0)
# 552 "../providers/implementations/ciphers/ciphercommon_gcm.c"
       );
        goto err;
    }
