# 0 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
# 10 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 11 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c" 2
...
# 12 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c" 2
                                  ...
                                  unsigned char *tag, size_t taglen)
{
    ...
    if (ctx->str != 
# 37 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c" 3 4
                   ((void *)0)
# 37 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
                       )
    ...
    if (rv == 1 && tag != 
# 43 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c" 3 4
                         ((void *)0)
# 43 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
                             )
                                  ...
                                  unsigned char *expected_tag, size_t taglen)
{
    ...
    if (ctx->str != 
# 54 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c" 3 4
                   ((void *)0)
# 54 "../providers/implementations/ciphers/ciphercommon_ccm_hw.c"
                       )
