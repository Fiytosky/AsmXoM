# 0 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
# 15 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
...
# 16 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 2
# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 19 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 2
...
# 20 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 2
...
static int aes_gcm_siv_initkey(void *vctx)
{
    ...
    int out_len;
    EVP_CIPHER *ecb = 
# 36 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                     ((void *)0)
# 36 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                         ;
    const int ossl_is_little_endian = 1234 == 1234;

    switch (ctx->key_len) {
    case 16:
        ecb = EVP_CIPHER_fetch(ctx->libctx, "AES-128-ECB", 
# 41 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                          ((void *)0)
# 41 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                              );
        break;
    case 24:
        ecb = EVP_CIPHER_fetch(ctx->libctx, "AES-192-ECB", 
# 44 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                          ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                              );
        break;
    case 32:
        ecb = EVP_CIPHER_fetch(ctx->libctx, "AES-256-ECB", 
# 47 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                          ((void *)0)
# 47 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                              );
        break;
    default:
        goto err;
    ...
    if (ctx->ecb_ctx == 
# 53 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                       ((void *)0) 
# 53 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
...
# 53 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
        ...
        goto err;
    if (!EVP_EncryptInit_ex2(ctx->ecb_ctx, ecb, ctx->key_gen_key, 
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                                 ((void *)0)
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                                     , 
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                                       ((void *)0)
# 55 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
    ...
    memcpy(&data.block[sizeof(data.counter)], ctx->nonce, 12);
    ...
    for (i = 0; i < 16; i += 8) {
        ...
        out_len = 16;
        if (!EVP_EncryptUpdate(ctx->ecb_ctx, output, &out_len, data.block, 16))
            goto err;
    ...
    if (!EVP_EncryptInit_ex2(ctx->ecb_ctx, ecb, ctx->msg_enc_key, 
# 92 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                                 ((void *)0)
# 92 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                                     , 
# 92 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                                       ((void *)0)
# 92 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
 ...
 err:
    ...
    EVP_CIPHER_free(ecb);
    ctx->ecb_ctx = 
# 103 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                  ((void *)0)
# 103 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                      ;
    return 0;
}
                           ...
                           const unsigned char *aad, size_t len)
{
    ...
    if (len == 0) {
        CRYPTO_free(ctx->aad, "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c", 116);
        ctx->aad = 
# 117 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                  ((void *)0)
# 117 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                      ;
        ctx->aad_len = 0;
        return 1;
    }
    to_alloc = (((ctx->aad_len + len) + 15) & ~0x0F);

    len64 = to_alloc;
    if (len64 > ((uint64_t)1 << 36))
        return 0;
    ptr = CRYPTO_realloc(ctx->aad, to_alloc, "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c", 126);
    if (ptr == 
# 127 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
              ((void *)0)
# 127 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                  )
        return 0;
    ctx->aad = ptr;
                               ...
                               unsigned char *out, size_t len)
{
    ...
    if (ctx->aad != 
# 178 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                   ((void *)0)
# 178 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                       ) {

        ossl_polyval_ghash_hash(ctx->Htable, S_s, ctx->aad, (((ctx->aad_len) + 15) & ~0x0F));
    }
    if (((len) & ~0x0F) > 0)
        ossl_polyval_ghash_hash(ctx->Htable, S_s, (uint8_t *) in, ((len) & ~0x0F));
    if (!(((len) & 0x0F) == 0)) {

        memset(padding, 0, sizeof(padding));
        memcpy(padding, &in[((len) & ~0x0F)], ((len) & 0x0F));
    ...
    memcpy(counter_block, ctx->tag, 16);
    counter_block[16 - 1] |= 0x80;
                               ...
                               unsigned char *out, size_t len)
{
    ...
    ossl_polyval_ghash_init(ctx->Htable, (const uint64_t*)ctx->msg_auth_key);
    if (ctx->aad != 
# 243 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                   ((void *)0)
# 243 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                       ) {

        ossl_polyval_ghash_hash(ctx->Htable, S_s, ctx->aad, (((ctx->aad_len) + 15) & ~0x0F));
    }
    if (((len) & ~0x0F) > 0)
        ossl_polyval_ghash_hash(ctx->Htable, S_s, out, ((len) & ~0x0F));
    if (!(((len) & 0x0F) == 0)) {

        padding[0] = padding[1] = 0;
        memcpy(padding, &out[((len) & ~0x0F)], ((len) & 0x0F));
        ossl_polyval_ghash_hash(ctx->Htable, S_s, (uint8_t *)padding, sizeof(padding));
    }
    ossl_polyval_ghash_hash(ctx->Htable, S_s, (uint8_t *)len_blk, 16);
                              ...
                              const unsigned char *in, size_t len)
{
    ...
    if (in == 
# 280 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
             ((void *)0)
# 280 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                 )
        return aes_gcm_siv_finish(ctx);


    if (out == 
# 284 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
              ((void *)0)
# 284 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                  )
...
static void aes_gcm_siv_clean_ctx(void *vctx)
{
    ...
    EVP_CIPHER_CTX_free(ctx->ecb_ctx);
    ctx->ecb_ctx = 
# 298 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                  ((void *)0)
# 298 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                      ;
}
...
static int aes_gcm_siv_dup_ctx(void *vdst, void *vsrc)
{
    ...
    dst->ecb_ctx = 
# 306 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                  ((void *)0)
# 306 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                      ;
    if (src->ecb_ctx != 
# 307 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                       ((void *)0)
# 307 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                           ) {
        if ((dst->ecb_ctx = EVP_CIPHER_CTX_new()) == 
# 308 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                                                    ((void *)0)
# 308 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                                                        )
            goto err;
 ...
 err:
    ...
    dst->ecb_ctx = 
# 317 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c" 3 4
                  ((void *)0)
# 317 "../providers/implementations/ciphers/cipher_aes_gcm_siv_hw.c"
                      ;
    return 0;
}
