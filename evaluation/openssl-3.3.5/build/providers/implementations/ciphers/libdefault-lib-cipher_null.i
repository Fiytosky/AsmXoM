# 0 "../providers/implementations/ciphers/cipher_null.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_null.c"
# 10 "../providers/implementations/ciphers/cipher_null.c"
...
# 11 "../providers/implementations/ciphers/cipher_null.c" 2
...
# 12 "../providers/implementations/ciphers/cipher_null.c" 2
...
# 13 "../providers/implementations/ciphers/cipher_null.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 14 "../providers/implementations/ciphers/cipher_null.c" 2
...
# 15 "../providers/implementations/ciphers/cipher_null.c" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 16 "../providers/implementations/ciphers/cipher_null.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_null.c" 2
...
static void *null_newctx(void *provctx)
{
    if (!ossl_prov_is_running())
        return 
# 28 "../providers/implementations/ciphers/cipher_null.c" 3 4
              ((void *)0)
# 28 "../providers/implementations/ciphers/cipher_null.c"
                  ;

    return CRYPTO_zalloc(sizeof(PROV_CIPHER_NULL_CTX), "../providers/implementations/ciphers/cipher_null.c", 30);
}

static OSSL_FUNC_cipher_freectx_fn null_freectx;
static void null_freectx(void *vctx)
{
    CRYPTO_free(vctx, "../providers/implementations/ciphers/cipher_null.c", 36);
}
...
static const OSSL_PARAM null_known_gettable_ctx_params[] = {
    { (("keylen")), (2), ((
# 109 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 109 "../providers/implementations/ciphers/cipher_null.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("ivlen")), (2), ((
# 110 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 110 "../providers/implementations/ciphers/cipher_null.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { "tls-mac", 7, 
# 111 "../providers/implementations/ciphers/cipher_null.c" 3 4
                                                      ((void *)0)
# 111 "../providers/implementations/ciphers/cipher_null.c"
                                                          , 0, ((size_t)-1) },
    { 
# 112 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 112 "../providers/implementations/ciphers/cipher_null.c"
   , 0, 
# 112 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 112 "../providers/implementations/ciphers/cipher_null.c"
...
static const OSSL_PARAM *null_gettable_ctx_params(__attribute__((unused)) void *cctx,
...
static int null_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 129 "../providers/implementations/ciphers/cipher_null.c" 3 4
            ((void *)0) 
# 129 "../providers/implementations/ciphers/cipher_null.c"
                 && !OSSL_PARAM_set_size_t(p, 0)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_null.c",130,__func__), ERR_set_error)((57),(104),
# 130 "../providers/implementations/ciphers/cipher_null.c" 3 4
       ((void *)0)
# 130 "../providers/implementations/ciphers/cipher_null.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "keylen");
    if (p != 
# 134 "../providers/implementations/ciphers/cipher_null.c" 3 4
            ((void *)0) 
# 134 "../providers/implementations/ciphers/cipher_null.c"
                 && !OSSL_PARAM_set_size_t(p, 0)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_null.c",135,__func__), ERR_set_error)((57),(104),
# 135 "../providers/implementations/ciphers/cipher_null.c" 3 4
       ((void *)0)
# 135 "../providers/implementations/ciphers/cipher_null.c"
       );
        return 0;
    }
    p = OSSL_PARAM_locate(params, "tls-mac");
    if (p != 
# 139 "../providers/implementations/ciphers/cipher_null.c" 3 4
            ((void *)0)
        
# 140 "../providers/implementations/ciphers/cipher_null.c"
       && !OSSL_PARAM_set_octet_ptr(p, ctx->tlsmac, ctx->tlsmacsize)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_null.c",141,__func__), ERR_set_error)((57),(104),
# 141 "../providers/implementations/ciphers/cipher_null.c" 3 4
       ((void *)0)
# 141 "../providers/implementations/ciphers/cipher_null.c"
       );
        return 0;
    }
    return 1;
...
static const OSSL_PARAM null_known_settable_ctx_params[] = {
    { (("tls-mac-size")), (2), ((
# 148 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 148 "../providers/implementations/ciphers/cipher_null.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { 
# 149 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 149 "../providers/implementations/ciphers/cipher_null.c"
   , 0, 
# 149 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0)
# 149 "../providers/implementations/ciphers/cipher_null.c"
...
static const OSSL_PARAM *null_settable_ctx_params(__attribute__((unused)) void *cctx,
                                                  __attribute__((unused)) void *provctx)
{
...
static int null_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (p != 
# 167 "../providers/implementations/ciphers/cipher_null.c" 3 4
            ((void *)0)
# 167 "../providers/implementations/ciphers/cipher_null.c"
                ) {
        if (!OSSL_PARAM_get_size_t(p, &ctx->tlsmacsize)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_null.c",169,__func__), ERR_set_error)((57),(103),
# 169 "../providers/implementations/ciphers/cipher_null.c" 3 4
           ((void *)0)
# 169 "../providers/implementations/ciphers/cipher_null.c"
           );
            return 0;
        }
    }
...
const OSSL_DISPATCH ossl_null_functions[] = {
    ...
    { 7, (void (*)(void)) null_freectx },
    { 8, (void (*)(void)) null_newctx },
    { 2, (void (*)(void))null_einit },
    { 3, (void (*)(void))null_dinit },
    { 4, (void (*)(void))null_cipher },
    { 5, (void (*)(void))null_final },
    { 6, (void (*)(void))null_cipher },
    { 9, (void (*)(void)) null_get_params },
    { 12,
        (void (*)(void))ossl_cipher_generic_gettable_params },
    { 10, (void (*)(void))null_get_ctx_params },
    { 13,
      (void (*)(void))null_gettable_ctx_params },
    { 11, (void (*)(void))null_set_ctx_params },
    { 14,
      (void (*)(void))null_settable_ctx_params },
    { 0, 
# 196 "../providers/implementations/ciphers/cipher_null.c" 3 4
   ((void *)0) 
# 196 "../providers/implementations/ciphers/cipher_null.c"
   }
};
