# 0 "../providers/implementations/ciphers/cipher_aes_ccm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_ccm.c"
# 15 "../providers/implementations/ciphers/cipher_aes_ccm.c"
...
# 16 "../providers/implementations/ciphers/cipher_aes_ccm.c" 2



# 1 "../providers/implementations/ciphers/cipher_aes_ccm.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_ccm.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_ccm.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aes_ccm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_ccm.h" 2
...
# 14 "../providers/implementations/ciphers/cipher_aes_ccm.h" 2
...
# 45 "../providers/implementations/ciphers/cipher_aes_ccm.h"
    } ccm;
} PROV_AES_CCM_CTX;

const PROV_CCM_HW *ossl_prov_aes_hw_ccm(size_t keylen);
# 20 "../providers/implementations/ciphers/cipher_aes_ccm.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_ccm.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_ccm.c" 2
...
static void *aes_ccm_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 28 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
              ((void *)0)
# 28 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_ccm.c", 30);
    if (ctx != 
# 31 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
              ((void *)0)
# 31 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                  )
...
static void *aes_ccm_dupctx(void *provctx)
{
    ...
    PROV_AES_CCM_CTX *dupctx = 
# 39 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
                              ((void *)0)
# 39 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                                  ;

    if (ctx == 
# 41 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
              ((void *)0)
# 41 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                  )
        return 
# 42 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
              ((void *)0)
# 42 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                  ;
    dupctx = CRYPTO_memdup((provctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_ccm.c", 43);
    if (dupctx == 
# 44 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
                 ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                     )
        return 
# 45 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
              ((void *)0)
# 45 "../providers/implementations/ciphers/cipher_aes_ccm.c"
                  ;
...
static void aes_ccm_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_ccm.c", 61);
}


static OSSL_FUNC_cipher_get_params_fn aes_128_ccm_get_params; static int aes_128_ccm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x7, (0x0001 | 0x0002), 128, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes128ccm_newctx; static void * aes128ccm_newctx(void *provctx) { return aes_ccm_newctx(provctx, 128); } static void * aes128ccm_dupctx(void *src) { return aes_ccm_dupctx(src); } const OSSL_DISPATCH ossl_aes128ccm_functions[] = { { 1, (void (*)(void))aes128ccm_newctx }, { 7, (void (*)(void))aes_ccm_freectx }, { 8, (void (*)(void))aes128ccm_dupctx }, { 2, (void (*)(void))ossl_ccm_einit }, { 3, (void (*)(void))ossl_ccm_dinit }, { 4, (void (*)(void))ossl_ccm_stream_update }, { 5, (void (*)(void))ossl_ccm_stream_final }, { 6, (void (*)(void))ossl_ccm_cipher }, { 9, (void (*)(void)) aes_128_ccm_get_params }, { 10, (void (*)(void)) ossl_ccm_get_ctx_params }, { 11, (void (*)(void)) ossl_ccm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 65 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
((void *)0) 
# 65 "../providers/implementations/ciphers/cipher_aes_ccm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aes_192_ccm_get_params; static int aes_192_ccm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x7, (0x0001 | 0x0002), 192, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes192ccm_newctx; static void * aes192ccm_newctx(void *provctx) { return aes_ccm_newctx(provctx, 192); } static void * aes192ccm_dupctx(void *src) { return aes_ccm_dupctx(src); } const OSSL_DISPATCH ossl_aes192ccm_functions[] = { { 1, (void (*)(void))aes192ccm_newctx }, { 7, (void (*)(void))aes_ccm_freectx }, { 8, (void (*)(void))aes192ccm_dupctx }, { 2, (void (*)(void))ossl_ccm_einit }, { 3, (void (*)(void))ossl_ccm_dinit }, { 4, (void (*)(void))ossl_ccm_stream_update }, { 5, (void (*)(void))ossl_ccm_stream_final }, { 6, (void (*)(void))ossl_ccm_cipher }, { 9, (void (*)(void)) aes_192_ccm_get_params }, { 10, (void (*)(void)) ossl_ccm_get_ctx_params }, { 11, (void (*)(void)) ossl_ccm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 67 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
((void *)0) 
# 67 "../providers/implementations/ciphers/cipher_aes_ccm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aes_256_ccm_get_params; static int aes_256_ccm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x7, (0x0001 | 0x0002), 256, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes256ccm_newctx; static void * aes256ccm_newctx(void *provctx) { return aes_ccm_newctx(provctx, 256); } static void * aes256ccm_dupctx(void *src) { return aes_ccm_dupctx(src); } const OSSL_DISPATCH ossl_aes256ccm_functions[] = { { 1, (void (*)(void))aes256ccm_newctx }, { 7, (void (*)(void))aes_ccm_freectx }, { 8, (void (*)(void))aes256ccm_dupctx }, { 2, (void (*)(void))ossl_ccm_einit }, { 3, (void (*)(void))ossl_ccm_dinit }, { 4, (void (*)(void))ossl_ccm_stream_update }, { 5, (void (*)(void))ossl_ccm_stream_final }, { 6, (void (*)(void))ossl_ccm_cipher }, { 9, (void (*)(void)) aes_256_ccm_get_params }, { 10, (void (*)(void)) ossl_ccm_get_ctx_params }, { 11, (void (*)(void)) ossl_ccm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 69 "../providers/implementations/ciphers/cipher_aes_ccm.c" 3 4
((void *)0) 
# 69 "../providers/implementations/ciphers/cipher_aes_ccm.c"
} };
