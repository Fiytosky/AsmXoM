# 0 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
# 14 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 2
...
static int aes_siv_initkey(void *vctx, const unsigned char *key, size_t keylen)
{
    ...
    const char *propq = 
# 26 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                       ((void *)0)
# 26 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                           ;

    EVP_CIPHER_free(ctx->cbc);
    EVP_CIPHER_free(ctx->ctr);
    ctx->cbc = 
# 30 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
              ((void *)0)
# 30 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                  ;
    ctx->ctr = 
# 31 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
              ((void *)0)
# 31 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                  ;
    ...
    if (ctx->cbc == 
# 49 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                   ((void *)0) 
# 49 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                        || ctx->ctr == 
# 49 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                                       ((void *)0)
# 49 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
...
static int aes_siv_dupctx(void *in_vctx, void *out_vctx)
{
    ...
    *out = *in;
    out->siv.cipher_ctx = 
# 65 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                         ((void *)0)
# 65 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                             ;
    out->siv.mac_ctx_init = 
# 66 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                           ((void *)0)
# 66 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                               ;
    out->siv.mac = 
# 67 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                  ((void *)0)
# 67 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                      ;
    if (!ossl_siv128_copy_ctx(&out->siv, &in->siv))
        return 0;
    if (out->cbc != 
# 70 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                   ((void *)0)
# 70 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                       )
        EVP_CIPHER_up_ref(out->cbc);
    if (out->ctr != 
# 72 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
                   ((void *)0)
# 72 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                       )
                          ...
                          const unsigned char *in, size_t len)
{
    ...
    if (in == 
# 110 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
             ((void *)0)
# 110 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                 )
        return ossl_siv128_finish(sctx) == 0;


    if (out == 
# 114 "../providers/implementations/ciphers/cipher_aes_siv_hw.c" 3 4
              ((void *)0)
# 114 "../providers/implementations/ciphers/cipher_aes_siv_hw.c"
                  )
