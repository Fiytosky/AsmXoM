...
.LFE387:
	...
	.type	tdes_desx_cbc_newctx, @function
...
.LFB402:
	...
	subq	$16, %rsp
	movq	%rdi, -8(%rbp)
	call	ossl_prov_cipher_hw_tdes_desx_cbc@PLT
	movq	%rax, %rdx
	movq	-8(%rbp), %rax
	subq	$8, %rsp
	pushq	%rdx
	...
	.cfi_endproc
.LFE402:
	.size	tdes_desx_cbc_newctx, .-tdes_desx_cbc_newctx
	.type	tdes_desx_cbc_get_params, @function
...
.LFB403:
	...
	.cfi_endproc
.LFE403:
	.size	tdes_desx_cbc_get_params, .-tdes_desx_cbc_get_params
	.globl	ossl_tdes_desx_cbc_functions
	.section	.data.rel.ro,"aw"
	.align 32
	.type	ossl_tdes_desx_cbc_functions, @object
	.size	ossl_tdes_desx_cbc_functions, 240
