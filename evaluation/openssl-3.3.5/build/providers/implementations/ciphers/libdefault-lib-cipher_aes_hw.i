# 0 "../providers/implementations/ciphers/cipher_aes_hw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_hw.c"
# 14 "../providers/implementations/ciphers/cipher_aes_hw.c"
...
# 15 "../providers/implementations/ciphers/cipher_aes_hw.c" 2
...
# 17 "../providers/implementations/ciphers/cipher_aes_hw.c" 2
...
# 18 "../providers/implementations/ciphers/cipher_aes_hw.c" 2
                                 ...
                                 const unsigned char *key, size_t keylen)
{
    ...
    if ((dat->mode == 0x1 || dat->mode == 0x2)
        && !dat->enc) {
# 46 "../providers/implementations/ciphers/cipher_aes_hw.c"
        if ((OPENSSL_ia32cap_P[1]&(1<<(41-32))) && dat->mode == 0x2) {
        ...
        if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
            ...
            dat->stream.cbc = (dat->mode == 0x2)
                              ?(cbc128_f)vpaes_cbc_encrypt : 
# 57 "../providers/implementations/ciphers/cipher_aes_hw.c" 3 4
                                                            ((void *)0)
# 57 "../providers/implementations/ciphers/cipher_aes_hw.c"
                                                                ;
        } else
...
# 64 "../providers/implementations/ciphers/cipher_aes_hw.c" 3 4
                                                           ((void *)0)
# 64 "../providers/implementations/ciphers/cipher_aes_hw.c"
                                                               ;
        }
    } else
# 91 "../providers/implementations/ciphers/cipher_aes_hw.c"
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32))) && dat->mode == 0x5) {
    ...
    if ((OPENSSL_ia32cap_P[1]&(1<<(41-32)))) {
        ...
        dat->stream.cbc = (dat->mode == 0x2)
                          ? (cbc128_f)vpaes_cbc_encrypt : 
# 102 "../providers/implementations/ciphers/cipher_aes_hw.c" 3 4
                                                         ((void *)0)
# 102 "../providers/implementations/ciphers/cipher_aes_hw.c"
                                                             ;
    } else

    {
        ...
        dat->stream.cbc = (dat->mode == 0x2)
                          ? (cbc128_f)AES_cbc_encrypt : 
# 109 "../providers/implementations/ciphers/cipher_aes_hw.c" 3 4
                                                       ((void *)0)
# 109 "../providers/implementations/ciphers/cipher_aes_hw.c"
                                                           ;
    ...
    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_hw.c",117,__func__), ERR_set_error)((57),(101),
# 117 "../providers/implementations/ciphers/cipher_aes_hw.c" 3 4
       ((void *)0)
# 117 "../providers/implementations/ciphers/cipher_aes_hw.c"
       );
        return 0;
    }
...
static void cipher_hw_aes_copyctx(PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src) { PROV_AES_CTX *sctx = (PROV_AES_CTX *)src; PROV_AES_CTX *dctx = (PROV_AES_CTX *)dst; *dctx = *sctx; dst->ks = &dctx->ks.ks; }
# 140 "../providers/implementations/ciphers/cipher_aes_hw.c"
# 1 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc" 1
# 21 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc"
...
# 35 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc" 3 4
                                          ((void *)0)
# 35 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc"
                                              ;
    } else {
        ...
        else if (dat->mode == 0x5)
            dat->stream.ctr = (ctr128_f) aesni_ctr32_encrypt_blocks;
        else
            dat->stream.cbc = 
# 44 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc" 3 4
                             ((void *)0)
# 44 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc"
                                 ;
    }

    if (ret < 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/ciphers/cipher_aes_hw_aesni.inc",48,__func__), ERR_set_error)((57),(101),
# 48 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc" 3 4
       ((void *)0)
# 48 "../providers/implementations/ciphers/cipher_aes_hw_aesni.inc"
       );
        return 0;
    }
...
# 141 "../providers/implementations/ciphers/cipher_aes_hw.c" 2
# 157 "../providers/implementations/ciphers/cipher_aes_hw.c"
static const PROV_CIPHER_HW aes_cbc = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_cbc, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_cbc = { cipher_hw_aesni_initkey, cipher_hw_aesni_cbc, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_cbc(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_cbc; return &aes_cbc; }
static const PROV_CIPHER_HW aes_ecb = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_ecb, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_ecb = { cipher_hw_aesni_initkey, cipher_hw_aesni_ecb, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_ecb(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_ecb; return &aes_ecb; }
static const PROV_CIPHER_HW aes_ofb128 = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_ofb128, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_ofb128 = { cipher_hw_aesni_initkey, ossl_cipher_hw_generic_ofb128, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_ofb128(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_ofb128; return &aes_ofb128; }
static const PROV_CIPHER_HW aes_cfb128 = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_cfb128, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_cfb128 = { cipher_hw_aesni_initkey, ossl_cipher_hw_generic_cfb128, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_cfb128(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_cfb128; return &aes_cfb128; }
static const PROV_CIPHER_HW aes_cfb1 = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_cfb1, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_cfb1 = { cipher_hw_aesni_initkey, ossl_cipher_hw_generic_cfb1, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_cfb1(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_cfb1; return &aes_cfb1; }
static const PROV_CIPHER_HW aes_cfb8 = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_cfb8, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_cfb8 = { cipher_hw_aesni_initkey, ossl_cipher_hw_generic_cfb8, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_cfb8(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_cfb8; return &aes_cfb8; }
static const PROV_CIPHER_HW aes_ctr = { cipher_hw_aes_initkey, ossl_cipher_hw_generic_ctr, cipher_hw_aes_copyctx }; static const PROV_CIPHER_HW aesni_ctr = { cipher_hw_aesni_initkey, ossl_cipher_hw_generic_ctr, cipher_hw_aes_copyctx }; const PROV_CIPHER_HW *ossl_prov_cipher_hw_aes_ctr(size_t keybits) { if ((OPENSSL_ia32cap_P[1]&(1<<(57-32)))) return &aesni_ctr; return &aes_ctr; }
