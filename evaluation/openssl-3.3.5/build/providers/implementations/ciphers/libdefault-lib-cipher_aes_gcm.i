# 0 "../providers/implementations/ciphers/cipher_aes_gcm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/ciphers/cipher_aes_gcm.c"
# 15 "../providers/implementations/ciphers/cipher_aes_gcm.c"
...
# 16 "../providers/implementations/ciphers/cipher_aes_gcm.c" 2



# 1 "../providers/implementations/ciphers/cipher_aes_gcm.h" 1
# 10 "../providers/implementations/ciphers/cipher_aes_gcm.h"
...
int AES_unwrap_key(AES_KEY *key, const unsigned char *iv,
                   unsigned char *out, const unsigned char *in,
                   unsigned int inlen);
# 11 "../providers/implementations/ciphers/cipher_aes_gcm.h" 2
...
int ossl_cipher_trailingdata(unsigned char *buf, size_t *buflen,
                             size_t blocksize,
                             const unsigned char **in, size_t *inlen);
# 12 "../providers/implementations/ciphers/cipher_aes_gcm.h" 2
...
# 13 "../providers/implementations/ciphers/cipher_aes_gcm.h" 2
...
# 14 "../providers/implementations/ciphers/cipher_aes_gcm.h" 2
...
typedef struct prov_aes_gcm_ctx_st {
    ...
    union {
        int dummy;
# 42 "../providers/implementations/ciphers/cipher_aes_gcm.h"
    } plat;
} PROV_AES_GCM_CTX;

const PROV_GCM_HW *ossl_prov_aes_hw_gcm(size_t keybits);
# 20 "../providers/implementations/ciphers/cipher_aes_gcm.c" 2
...
# 21 "../providers/implementations/ciphers/cipher_aes_gcm.c" 2
...
# 22 "../providers/implementations/ciphers/cipher_aes_gcm.c" 2
...
static void *aes_gcm_newctx(void *provctx, size_t keybits)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 28 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
              ((void *)0)
# 28 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_gcm.c", 30);
    if (ctx != 
# 31 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
              ((void *)0)
# 31 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                  )
...
static void *aes_gcm_dupctx(void *provctx)
{
    ...
    PROV_AES_GCM_CTX *dctx = 
# 40 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
                            ((void *)0)
# 40 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                                ;

    if (ctx == 
# 42 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
              ((void *)0)
# 42 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                  )
        return 
# 43 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
              ((void *)0)
# 43 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                  ;

    dctx = CRYPTO_memdup((ctx), sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_gcm.c", 45);
    if (dctx != 
# 46 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
               ((void *)0) 
# 46 "../providers/implementations/ciphers/cipher_aes_gcm.c"
                    && dctx->base.gcm.key != 
# 46 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
                                             ((void *)0)
# 46 "../providers/implementations/ciphers/cipher_aes_gcm.c"
...
static void aes_gcm_freectx(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx, sizeof(*ctx), "../providers/implementations/ciphers/cipher_aes_gcm.c", 57);
}


static OSSL_FUNC_cipher_get_params_fn aes_128_gcm_get_params; static int aes_128_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 128, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes128gcm_newctx; static void * aes128gcm_newctx(void *provctx) { return aes_gcm_newctx(provctx, 128); } static void * aes128gcm_dupctx(void *src) { return aes_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aes128gcm_functions[] = { { 1, (void (*)(void))aes128gcm_newctx }, { 7, (void (*)(void))aes_gcm_freectx }, { 8, (void (*)(void))aes128gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aes_128_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 61 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
((void *)0) 
# 61 "../providers/implementations/ciphers/cipher_aes_gcm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aes_192_gcm_get_params; static int aes_192_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 192, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes192gcm_newctx; static void * aes192gcm_newctx(void *provctx) { return aes_gcm_newctx(provctx, 192); } static void * aes192gcm_dupctx(void *src) { return aes_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aes192gcm_functions[] = { { 1, (void (*)(void))aes192gcm_newctx }, { 7, (void (*)(void))aes_gcm_freectx }, { 8, (void (*)(void))aes192gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aes_192_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 63 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
((void *)0) 
# 63 "../providers/implementations/ciphers/cipher_aes_gcm.c"
} };

static OSSL_FUNC_cipher_get_params_fn aes_256_gcm_get_params; static int aes_256_gcm_get_params(OSSL_PARAM params[]) { return ossl_cipher_generic_get_params(params, 0x6, (0x0001 | 0x0002), 256, 8, 96); } static OSSL_FUNC_cipher_newctx_fn aes256gcm_newctx; static void * aes256gcm_newctx(void *provctx) { return aes_gcm_newctx(provctx, 256); } static void * aes256gcm_dupctx(void *src) { return aes_gcm_dupctx(src); } const OSSL_DISPATCH ossl_aes256gcm_functions[] = { { 1, (void (*)(void))aes256gcm_newctx }, { 7, (void (*)(void))aes_gcm_freectx }, { 8, (void (*)(void))aes256gcm_dupctx }, { 2, (void (*)(void))ossl_gcm_einit }, { 3, (void (*)(void))ossl_gcm_dinit }, { 4, (void (*)(void))ossl_gcm_stream_update }, { 5, (void (*)(void))ossl_gcm_stream_final }, { 6, (void (*)(void))ossl_gcm_cipher }, { 9, (void (*)(void)) aes_256_gcm_get_params }, { 10, (void (*)(void)) ossl_gcm_get_ctx_params }, { 11, (void (*)(void)) ossl_gcm_set_ctx_params }, { 12, (void (*)(void))ossl_cipher_generic_gettable_params }, { 13, (void (*)(void))ossl_cipher_aead_gettable_ctx_params }, { 14, (void (*)(void))ossl_cipher_aead_settable_ctx_params }, { 0, 
# 65 "../providers/implementations/ciphers/cipher_aes_gcm.c" 3 4
((void *)0) 
# 65 "../providers/implementations/ciphers/cipher_aes_gcm.c"
} };
