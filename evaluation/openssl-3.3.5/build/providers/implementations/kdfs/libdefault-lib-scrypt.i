# 0 "../providers/implementations/kdfs/scrypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/scrypt.c"
# 10 "../providers/implementations/kdfs/scrypt.c"
...
# 11 "../providers/implementations/kdfs/scrypt.c" 2
...
# 12 "../providers/implementations/kdfs/scrypt.c" 2
...
# 13 "../providers/implementations/kdfs/scrypt.c" 2
...
# 14 "../providers/implementations/kdfs/scrypt.c" 2
...
# 15 "../providers/implementations/kdfs/scrypt.c" 2
...
# 16 "../providers/implementations/kdfs/scrypt.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../providers/implementations/kdfs/scrypt.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 18 "../providers/implementations/kdfs/scrypt.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 19 "../providers/implementations/kdfs/scrypt.c" 2
...
# 20 "../providers/implementations/kdfs/scrypt.c" 2
...
# 21 "../providers/implementations/kdfs/scrypt.c" 2
...
# 22 "../providers/implementations/kdfs/scrypt.c" 2
...
# 23 "../providers/implementations/kdfs/scrypt.c" 2
...
# 24 "../providers/implementations/kdfs/scrypt.c" 2
...
static void *kdf_scrypt_new_inner(OSSL_LIB_CTX *libctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 63 "../providers/implementations/kdfs/scrypt.c" 3 4
              ((void *)0)
# 63 "../providers/implementations/kdfs/scrypt.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/scrypt.c", 65);
    if (ctx == 
# 66 "../providers/implementations/kdfs/scrypt.c" 3 4
              ((void *)0)
# 66 "../providers/implementations/kdfs/scrypt.c"
                  )
        return 
# 67 "../providers/implementations/kdfs/scrypt.c" 3 4
              ((void *)0)
# 67 "../providers/implementations/kdfs/scrypt.c"
                  ;
    ctx->libctx = libctx;
    kdf_scrypt_init(ctx);
    return ctx;
...
{
    return kdf_scrypt_new_inner(ossl_prov_ctx_get0_libctx((provctx)));
}
...
static void kdf_scrypt_free(void *vctx)
{
    ...
    if (ctx != 
# 82 "../providers/implementations/kdfs/scrypt.c" 3 4
              ((void *)0)
# 82 "../providers/implementations/kdfs/scrypt.c"
                  ) {
        CRYPTO_free(ctx->propq, "../providers/implementations/kdfs/scrypt.c", 83);
        EVP_MD_free(ctx->sha256);
        kdf_scrypt_reset(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/scrypt.c", 86);
    }
}
...
static void kdf_scrypt_reset(void *vctx)
{
    ...
    CRYPTO_free(ctx->salt, "../providers/implementations/kdfs/scrypt.c", 94);
    ctx->salt = 
# 95 "../providers/implementations/kdfs/scrypt.c" 3 4
               ((void *)0)
# 95 "../providers/implementations/kdfs/scrypt.c"
                   ;
    CRYPTO_clear_free(ctx->pass, ctx->pass_len, "../providers/implementations/kdfs/scrypt.c", 96);
    ctx->pass = 
# 97 "../providers/implementations/kdfs/scrypt.c" 3 4
               ((void *)0)
# 97 "../providers/implementations/kdfs/scrypt.c"
                   ;
    kdf_scrypt_init(ctx);
}
...
static void *kdf_scrypt_dup(void *vctx)
{
    ...
    if (dest != 
# 107 "../providers/implementations/kdfs/scrypt.c" 3 4
               ((void *)0)
# 107 "../providers/implementations/kdfs/scrypt.c"
                   ) {
        if (src->sha256 != 
# 108 "../providers/implementations/kdfs/scrypt.c" 3 4
                          ((void *)0) 
# 108 "../providers/implementations/kdfs/scrypt.c"
                               && !EVP_MD_up_ref(src->sha256))
            goto err;
        if (src->propq != 
# 110 "../providers/implementations/kdfs/scrypt.c" 3 4
                         ((void *)0)
# 110 "../providers/implementations/kdfs/scrypt.c"
                             ) {
            dest->propq = CRYPTO_strdup(src->propq, "../providers/implementations/kdfs/scrypt.c", 111);
            if (dest->propq == 
# 112 "../providers/implementations/kdfs/scrypt.c" 3 4
                              ((void *)0)
# 112 "../providers/implementations/kdfs/scrypt.c"
                                  )
                goto err;
        }
 ...
 err:
    ...
    return 
# 130 "../providers/implementations/kdfs/scrypt.c" 3 4
          ((void *)0)
# 130 "../providers/implementations/kdfs/scrypt.c"
              ;
}
...
static int scrypt_set_membuf(unsigned char **buffer, size_t *buflen,
                             const OSSL_PARAM *p)
{
    CRYPTO_clear_free(*buffer, *buflen, "../providers/implementations/kdfs/scrypt.c", 148);
    *buffer = 
# 149 "../providers/implementations/kdfs/scrypt.c" 3 4
             ((void *)0)
# 149 "../providers/implementations/kdfs/scrypt.c"
                 ;
    *buflen = 0;

    if (p->data_size == 0) {
        if ((*buffer = CRYPTO_malloc(1, "../providers/implementations/kdfs/scrypt.c", 153)) == 
# 153 "../providers/implementations/kdfs/scrypt.c" 3 4
                                            ((void *)0)
# 153 "../providers/implementations/kdfs/scrypt.c"
                                                )
            return 0;
    } else if (p->data != 
# 155 "../providers/implementations/kdfs/scrypt.c" 3 4
                         ((void *)0)
# 155 "../providers/implementations/kdfs/scrypt.c"
                             ) {
...
static int set_digest(KDF_SCRYPT *ctx)
{
    ...
    if (ctx->sha256 == 
# 166 "../providers/implementations/kdfs/scrypt.c" 3 4
                      ((void *)0)
# 166 "../providers/implementations/kdfs/scrypt.c"
                          ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",167,__func__), ERR_set_error)((57),(147),
# 167 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 167 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    return 1;
...
{
    CRYPTO_free(ctx->propq, "../providers/implementations/kdfs/scrypt.c", 175);
    ctx->propq = 
# 176 "../providers/implementations/kdfs/scrypt.c" 3 4
                ((void *)0)
# 176 "../providers/implementations/kdfs/scrypt.c"
                    ;
    if (propq != 
# 177 "../providers/implementations/kdfs/scrypt.c" 3 4
                ((void *)0)
# 177 "../providers/implementations/kdfs/scrypt.c"
                    ) {
        ctx->propq = CRYPTO_strdup(propq, "../providers/implementations/kdfs/scrypt.c", 178);
        if (ctx->propq == 
# 179 "../providers/implementations/kdfs/scrypt.c" 3 4
                         ((void *)0)
# 179 "../providers/implementations/kdfs/scrypt.c"
                             )
            return 0;
    }
    return 1;
                             ...
                             const OSSL_PARAM params[])
{
    ...
    if (ctx->pass == 
# 193 "../providers/implementations/kdfs/scrypt.c" 3 4
                    ((void *)0)
# 193 "../providers/implementations/kdfs/scrypt.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",194,__func__), ERR_set_error)((57),(130),
# 194 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 194 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }

    if (ctx->salt == 
# 198 "../providers/implementations/kdfs/scrypt.c" 3 4
                    ((void *)0)
# 198 "../providers/implementations/kdfs/scrypt.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",199,__func__), ERR_set_error)((57),(131),
# 199 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 199 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }

    if (ctx->sha256 == 
# 203 "../providers/implementations/kdfs/scrypt.c" 3 4
                      ((void *)0) 
# 203 "../providers/implementations/kdfs/scrypt.c"
                           && !set_digest(ctx))
        return 0;
...
static int kdf_scrypt_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 223 "../providers/implementations/kdfs/scrypt.c" 3 4
                 ((void *)0)
# 223 "../providers/implementations/kdfs/scrypt.c"
                     )
        return 1;

    if ((p = OSSL_PARAM_locate_const(params, "pass")) != 
# 226 "../providers/implementations/kdfs/scrypt.c" 3 4
                                                                         ((void *)0)
# 226 "../providers/implementations/kdfs/scrypt.c"
                                                                             )
        if (!scrypt_set_membuf(&ctx->pass, &ctx->pass_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "salt")) != 
# 230 "../providers/implementations/kdfs/scrypt.c" 3 4
                                                                     ((void *)0)
# 230 "../providers/implementations/kdfs/scrypt.c"
                                                                         )
        if (!scrypt_set_membuf(&ctx->salt, &ctx->salt_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "n"))
        != 
# 235 "../providers/implementations/kdfs/scrypt.c" 3 4
          ((void *)0)
# 235 "../providers/implementations/kdfs/scrypt.c"
              ) {
    ...
    if ((p = OSSL_PARAM_locate_const(params, "r"))
        != 
# 244 "../providers/implementations/kdfs/scrypt.c" 3 4
          ((void *)0)
# 244 "../providers/implementations/kdfs/scrypt.c"
              ) {
    ...
    if ((p = OSSL_PARAM_locate_const(params, "p"))
        != 
# 251 "../providers/implementations/kdfs/scrypt.c" 3 4
          ((void *)0)
# 251 "../providers/implementations/kdfs/scrypt.c"
              ) {
        if (!OSSL_PARAM_get_uint64(p, &u64_value) || u64_value < 1)
            return 0;
        ctx->p = u64_value;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "maxmem_bytes"))
        != 
# 258 "../providers/implementations/kdfs/scrypt.c" 3 4
          ((void *)0)
# 258 "../providers/implementations/kdfs/scrypt.c"
              ) {
        if (!OSSL_PARAM_get_uint64(p, &u64_value) || u64_value < 1)
            return 0;
    ...
    if (p != 
# 265 "../providers/implementations/kdfs/scrypt.c" 3 4
            ((void *)0)
# 265 "../providers/implementations/kdfs/scrypt.c"
                ) {
        if (p->data_type != 4
...
static const OSSL_PARAM *kdf_scrypt_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("pass")), (5), ((
# 278 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 278 "../providers/implementations/kdfs/scrypt.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 279 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 279 "../providers/implementations/kdfs/scrypt.c"
       )), (0), ((size_t)-1) },
        { (("n")), (2), ((
# 280 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 280 "../providers/implementations/kdfs/scrypt.c"
       )), (sizeof(uint64_t)), ((size_t)-1) },
        { (("r")), (2), ((
# 281 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 281 "../providers/implementations/kdfs/scrypt.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("p")), (2), ((
# 282 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 282 "../providers/implementations/kdfs/scrypt.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("maxmem_bytes")), (2), ((
# 283 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 283 "../providers/implementations/kdfs/scrypt.c"
       )), (sizeof(uint64_t)), ((size_t)-1) },
        { (("properties")), (4), ((
# 284 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 284 "../providers/implementations/kdfs/scrypt.c"
       )), (0), ((size_t)-1) },
        { 
# 285 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 285 "../providers/implementations/kdfs/scrypt.c"
       , 0, 
# 285 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 285 "../providers/implementations/kdfs/scrypt.c"
...
# 294 "../providers/implementations/kdfs/scrypt.c" 3 4
                                                               ((void *)0)
# 294 "../providers/implementations/kdfs/scrypt.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, 
# 295 "../providers/implementations/kdfs/scrypt.c" 3 4
                                       (18446744073709551615UL)
# 295 "../providers/implementations/kdfs/scrypt.c"
                                               );
    return -2;
}

static const OSSL_PARAM *kdf_scrypt_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 303 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 303 "../providers/implementations/kdfs/scrypt.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 304 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 304 "../providers/implementations/kdfs/scrypt.c"
       , 0, 
# 304 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 304 "../providers/implementations/kdfs/scrypt.c"
...
const OSSL_DISPATCH ossl_kdf_scrypt_functions[] = {
    { 1, (void(*)(void))kdf_scrypt_new },
    { 2, (void(*)(void))kdf_scrypt_dup },
    { 3, (void(*)(void))kdf_scrypt_free },
    { 4, (void(*)(void))kdf_scrypt_reset },
    { 5, (void(*)(void))kdf_scrypt_derive },
    { 8,
      (void(*)(void))kdf_scrypt_settable_ctx_params },
    { 11, (void(*)(void))kdf_scrypt_set_ctx_params },
    { 7,
      (void(*)(void))kdf_scrypt_gettable_ctx_params },
    { 10, (void(*)(void))kdf_scrypt_get_ctx_params },
    { 0, 
# 321 "../providers/implementations/kdfs/scrypt.c" 3 4
   ((void *)0) 
# 321 "../providers/implementations/kdfs/scrypt.c"
   }
};
...
# 444 "../providers/implementations/kdfs/scrypt.c"
static int scrypt_alg(const char *pass, size_t passlen,
                      const unsigned char *salt, size_t saltlen,
                      uint64_t N, uint64_t r, uint64_t p, uint64_t maxmem,
                      unsigned char *key, size_t keylen, EVP_MD *sha256,
                      OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (p > ((1 << 30) - 1) / r) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",461,__func__), ERR_set_error)((6),(172),
# 461 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 461 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    ...
    if (16 * r <= (sizeof(uint64_t) * 8 - 1)) {
        if (N >= (((uint64_t)1) << (16 * r))) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",472,__func__), ERR_set_error)((6),(172),
# 472 "../providers/implementations/kdfs/scrypt.c" 3 4
           ((void *)0)
# 472 "../providers/implementations/kdfs/scrypt.c"
           );
            return 0;
        }
    }
# 484 "../providers/implementations/kdfs/scrypt.c"
    Blen = p * 128 * r;
    ...
    if (Blen > 0x7fffffff
# 489 "../providers/implementations/kdfs/scrypt.c"
                     ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",490,__func__), ERR_set_error)((6),(172),
# 490 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 490 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    ...
    i = 
# 498 "../providers/implementations/kdfs/scrypt.c" 3 4
       (18446744073709551615UL) 
# 498 "../providers/implementations/kdfs/scrypt.c"
                  / (32 * sizeof(uint32_t));
    if (N + 2 > i / r) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",500,__func__), ERR_set_error)((6),(172),
# 500 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 500 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    ...
    if (Blen > 
# 506 "../providers/implementations/kdfs/scrypt.c" 3 4
              (18446744073709551615UL) 
# 506 "../providers/implementations/kdfs/scrypt.c"
                         - Vlen) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",507,__func__), ERR_set_error)((6),(172),
# 507 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 507 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    ...
    if (maxmem > 
# 512 "../providers/implementations/kdfs/scrypt.c" 3 4
                (18446744073709551615UL)
# 512 "../providers/implementations/kdfs/scrypt.c"
                        )
        maxmem = 
# 513 "../providers/implementations/kdfs/scrypt.c" 3 4
                (18446744073709551615UL)
# 513 "../providers/implementations/kdfs/scrypt.c"
                        ;

    if (Blen + Vlen > maxmem) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",516,__func__), ERR_set_error)((6),(172),
# 516 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 516 "../providers/implementations/kdfs/scrypt.c"
       );
        return 0;
    }
    ...
    if (key == 
# 521 "../providers/implementations/kdfs/scrypt.c" 3 4
              ((void *)0)
# 521 "../providers/implementations/kdfs/scrypt.c"
                  )
        return 1;

    B = CRYPTO_malloc((size_t)(Blen + Vlen), "../providers/implementations/kdfs/scrypt.c", 524);
    if (B == 
# 525 "../providers/implementations/kdfs/scrypt.c" 3 4
            ((void *)0)
# 525 "../providers/implementations/kdfs/scrypt.c"
                )
        return 0;
    X = (uint32_t *)(B + Blen);
    T = X + 32 * r;
 ...
 err:
    if (rv == 0)
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/scrypt.c",543,__func__), ERR_set_error)((6),(181),
# 543 "../providers/implementations/kdfs/scrypt.c" 3 4
       ((void *)0)
# 543 "../providers/implementations/kdfs/scrypt.c"
       );

    CRYPTO_clear_free(B, (size_t)(Blen + Vlen), "../providers/implementations/kdfs/scrypt.c", 545);
    return rv;
}
