# 0 "../providers/implementations/kdfs/krb5kdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/krb5kdf.c"
# 14 "../providers/implementations/kdfs/krb5kdf.c"
...
# 15 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 17 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 18 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 19 "../providers/implementations/kdfs/krb5kdf.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 21 "../providers/implementations/kdfs/krb5kdf.c" 2
...
void DES_ofb64_encrypt(const unsigned char *in, unsigned char *out,
                       long length, DES_key_schedule *schedule,
                       DES_cblock *ivec, int *num);
# 22 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 23 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 24 "../providers/implementations/kdfs/krb5kdf.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 25 "../providers/implementations/kdfs/krb5kdf.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 27 "../providers/implementations/kdfs/krb5kdf.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 28 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 30 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 31 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 32 "../providers/implementations/kdfs/krb5kdf.c" 2
...
# 33 "../providers/implementations/kdfs/krb5kdf.c" 2
...
static void *krb5kdf_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 65 "../providers/implementations/kdfs/krb5kdf.c" 3 4
              ((void *)0)
# 65 "../providers/implementations/kdfs/krb5kdf.c"
                  ;

    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/krb5kdf.c", 67)) == 
# 67 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                               ((void *)0)
# 67 "../providers/implementations/kdfs/krb5kdf.c"
                                                   )
        return 
# 68 "../providers/implementations/kdfs/krb5kdf.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/kdfs/krb5kdf.c"
                  ;
    ctx->provctx = provctx;
    return ctx;
}
...
static void krb5kdf_free(void *vctx)
{
    ...
    if (ctx != 
# 77 "../providers/implementations/kdfs/krb5kdf.c" 3 4
              ((void *)0)
# 77 "../providers/implementations/kdfs/krb5kdf.c"
                  ) {
        krb5kdf_reset(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/krb5kdf.c", 79);
    }
}
...
static void krb5kdf_reset(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx->key, ctx->key_len, "../providers/implementations/kdfs/krb5kdf.c", 89);
    CRYPTO_clear_free(ctx->constant, ctx->constant_len, "../providers/implementations/kdfs/krb5kdf.c", 90);
...
static int krb5kdf_set_membuf(unsigned char **dst, size_t *dst_len,
                              const OSSL_PARAM *p)
{
    CRYPTO_clear_free(*dst, *dst_len, "../providers/implementations/kdfs/krb5kdf.c", 98);
    *dst = 
# 99 "../providers/implementations/kdfs/krb5kdf.c" 3 4
          ((void *)0)
# 99 "../providers/implementations/kdfs/krb5kdf.c"
              ;
    *dst_len = 0;
...
static void *krb5kdf_dup(void *vctx)
{
    ...
    if (dest != 
# 110 "../providers/implementations/kdfs/krb5kdf.c" 3 4
               ((void *)0)
# 110 "../providers/implementations/kdfs/krb5kdf.c"
                   ) {
 ...
 err:
    krb5kdf_free(dest);
    return 
# 122 "../providers/implementations/kdfs/krb5kdf.c" 3 4
          ((void *)0)
# 122 "../providers/implementations/kdfs/krb5kdf.c"
              ;
}
                          ...
                          const OSSL_PARAM params[])
{
    ...
    if (cipher == 
# 136 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                 ((void *)0)
# 136 "../providers/implementations/kdfs/krb5kdf.c"
                     ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",137,__func__), ERR_set_error)((57),(155),
# 137 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 137 "../providers/implementations/kdfs/krb5kdf.c"
       );
        return 0;
    }
    if (ctx->key == 
# 140 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                   ((void *)0)
# 140 "../providers/implementations/kdfs/krb5kdf.c"
                       ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",141,__func__), ERR_set_error)((57),(128),
# 141 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 141 "../providers/implementations/kdfs/krb5kdf.c"
       );
        return 0;
    }
    if (ctx->constant == 
# 144 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                        ((void *)0)
# 144 "../providers/implementations/kdfs/krb5kdf.c"
                            ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",145,__func__), ERR_set_error)((57),(156),
# 145 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 145 "../providers/implementations/kdfs/krb5kdf.c"
       );
        return 0;
    }
...
static int krb5kdf_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 160 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                 ((void *)0)
# 160 "../providers/implementations/kdfs/krb5kdf.c"
                     )
        return 1;
...
# 166 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                                                    ((void *)0)
# 166 "../providers/implementations/kdfs/krb5kdf.c"
                                                                        )
        if (!krb5kdf_set_membuf(&ctx->key, &ctx->key_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "constant"))
        != 
# 171 "../providers/implementations/kdfs/krb5kdf.c" 3 4
          ((void *)0)
# 171 "../providers/implementations/kdfs/krb5kdf.c"
              )
...
static const OSSL_PARAM *krb5kdf_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                     __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("properties")), (4), ((
# 182 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 182 "../providers/implementations/kdfs/krb5kdf.c"
       )), (0), ((size_t)-1) },
        { (("cipher")), (4), ((
# 183 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 183 "../providers/implementations/kdfs/krb5kdf.c"
       )), (0), ((size_t)-1) },
        { (("key")), (5), ((
# 184 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 184 "../providers/implementations/kdfs/krb5kdf.c"
       )), (0), ((size_t)-1) },
        { (("constant")), (5), ((
# 185 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 185 "../providers/implementations/kdfs/krb5kdf.c"
       )), (0), ((size_t)-1) },
        { 
# 186 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 186 "../providers/implementations/kdfs/krb5kdf.c"
       , 0, 
# 186 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 186 "../providers/implementations/kdfs/krb5kdf.c"
...
# 204 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                                               ((void *)0)
# 204 "../providers/implementations/kdfs/krb5kdf.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, len);
    return -2;
}

static const OSSL_PARAM *krb5kdf_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                     __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 213 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 213 "../providers/implementations/kdfs/krb5kdf.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 214 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 214 "../providers/implementations/kdfs/krb5kdf.c"
       , 0, 
# 214 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 214 "../providers/implementations/kdfs/krb5kdf.c"
...
const OSSL_DISPATCH ossl_kdf_krb5kdf_functions[] = {
    { 1, (void(*)(void))krb5kdf_new },
    { 2, (void(*)(void))krb5kdf_dup },
    { 3, (void(*)(void))krb5kdf_free },
    { 4, (void(*)(void))krb5kdf_reset },
    { 5, (void(*)(void))krb5kdf_derive },
    { 8,
    ...
    { 0, 
# 233 "../providers/implementations/kdfs/krb5kdf.c" 3 4
   ((void *)0) 
# 233 "../providers/implementations/kdfs/krb5kdf.c"
   }
};
...
# 286 "../providers/implementations/kdfs/krb5kdf.c"
                       ...
                       const unsigned char *key, size_t key_len)
{
    ...
    ret = EVP_EncryptInit_ex(ctx, cipher, engine, 
# 353 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                                 ((void *)0)
# 353 "../providers/implementations/kdfs/krb5kdf.c"
                                                     , 
# 353 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                                       ((void *)0)
# 353 "../providers/implementations/kdfs/krb5kdf.c"
...
# 365 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                 ((void *)0)
# 365 "../providers/implementations/kdfs/krb5kdf.c"
                                     , 
# 365 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                                       ((void *)0)
# 365 "../providers/implementations/kdfs/krb5kdf.c"
...
{
    EVP_CIPHER_CTX *ctx = 
# 384 "../providers/implementations/kdfs/krb5kdf.c" 3 4
                         ((void *)0)
# 384 "../providers/implementations/kdfs/krb5kdf.c"
                             ;
    ...
    if (key_len != okey_len) {
        ...
        if (EVP_CIPHER_get_nid(cipher) == 44 &&
            key_len == 24 && okey_len == 21) {
                des3_no_fixup = 1;
        } else {

            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",404,__func__), ERR_set_error)((57),(139),
# 404 "../providers/implementations/kdfs/krb5kdf.c" 3 4
           ((void *)0)
# 404 "../providers/implementations/kdfs/krb5kdf.c"
           );
            return 0;
    ...
    if (ctx == 
# 412 "../providers/implementations/kdfs/krb5kdf.c" 3 4
              ((void *)0)
# 412 "../providers/implementations/kdfs/krb5kdf.c"
                  )
        return 0;
    ...
    if (blocksize == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",423,__func__), ERR_set_error)((57),(155),
# 423 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 423 "../providers/implementations/kdfs/krb5kdf.c"
       );
        ret = 0;
        goto out;
    }
    ...
    if (constant_len > blocksize) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",429,__func__), ERR_set_error)((57),(157),
# 429 "../providers/implementations/kdfs/krb5kdf.c" 3 4
       ((void *)0)
# 429 "../providers/implementations/kdfs/krb5kdf.c"
       );
        ret = 0;
        goto out;
    }
    ...
    for (osize = 0; osize < okey_len; osize += cipherlen) {
        ...
        if (!ret)
            goto out;
        if (olen != 0) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",450,__func__), ERR_set_error)((57),(107),
# 450 "../providers/implementations/kdfs/krb5kdf.c" 3 4
           ((void *)0)
# 450 "../providers/implementations/kdfs/krb5kdf.c"
           );
            ret = 0;
            goto out;
        }
    ...
    if (EVP_CIPHER_get_nid(cipher) == 44 && !des3_no_fixup) {
        ret = fixup_des3_key(okey);
        if (!ret) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/krb5kdf.c",484,__func__), ERR_set_error)((57),(121),
# 484 "../providers/implementations/kdfs/krb5kdf.c" 3 4
           ((void *)0)
# 484 "../providers/implementations/kdfs/krb5kdf.c"
           );
            goto out;
        }
    }
