# 0 "../providers/implementations/kdfs/argon2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/argon2.c"
# 13 "../providers/implementations/kdfs/argon2.c"
...
# 14 "../providers/implementations/kdfs/argon2.c" 2
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
...
# 15 "../providers/implementations/kdfs/argon2.c" 2
...
# 16 "../providers/implementations/kdfs/argon2.c" 2
...
# 17 "../providers/implementations/kdfs/argon2.c" 2
...
# 18 "../providers/implementations/kdfs/argon2.c" 2
...
# 19 "../providers/implementations/kdfs/argon2.c" 2
...
# 22 "../providers/implementations/kdfs/argon2.c" 2
...
# 23 "../providers/implementations/kdfs/argon2.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 24 "../providers/implementations/kdfs/argon2.c" 2
...
# 26 "../providers/implementations/kdfs/argon2.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 27 "../providers/implementations/kdfs/argon2.c" 2
...
# 15 "../include/internal/thread_arch.h" 2
...
# 28 "../providers/implementations/kdfs/argon2.c" 2

# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 30 "../providers/implementations/kdfs/argon2.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 31 "../providers/implementations/kdfs/argon2.c" 2
...
# 32 "../providers/implementations/kdfs/argon2.c" 2
...
# 33 "../providers/implementations/kdfs/argon2.c" 2
...
# 34 "../providers/implementations/kdfs/argon2.c" 2
# 1 "../providers/implementations/include/prov/blake2.h" 1
# 16 "../providers/implementations/include/prov/blake2.h"
# 1 "/root/AsmXoM/gcc-15.2.0/build/lib/gcc/x86_64-pc-linux-gnu/15.2.0/include/stddef.h" 1 3 4
# 17 "../providers/implementations/include/prov/blake2.h" 2
# 31 "../providers/implementations/include/prov/blake2.h"
...
# 35 "../providers/implementations/kdfs/argon2.c" 2
# 134 "../providers/implementations/kdfs/argon2.c"
typedef struct {
    uint64_t v[((1024) / 8)];
} BLOCK;
...
static const OSSL_PARAM *kdf_argon2_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx);
static const OSSL_PARAM *kdf_argon2_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx);
...
static void copy_block(BLOCK *dst, const BLOCK *src)
{
    memcpy(dst->v, src->v, sizeof(uint64_t) * ((1024) / 8));
}
...
static void fill_first_blocks(uint8_t *blockhash, const KDF_ARGON2 *ctx)
{
    ...
    for (l = 0; l < ctx->lanes; ++l) {
        store32(blockhash + 64, 0);
        store32(blockhash + 64 + 4, l);
        blake2b_long(ctx->md, ctx->mac, blockhash_bytes, 1024,
                     blockhash, (64 + (2 * sizeof(uint32_t))));
        load_block(&ctx->memory[l * ctx->lane_length + 0],
                   blockhash_bytes);
        store32(blockhash + 64, 1);
        blake2b_long(ctx->md, ctx->mac, blockhash_bytes, 1024,
                     blockhash, (64 + (2 * sizeof(uint32_t))));
        load_block(&ctx->memory[l * ctx->lane_length + 1],
                   blockhash_bytes);
    }
    OPENSSL_cleanse(blockhash_bytes, 1024);
}
                       ...
                       BLOCK *next, int with_xor)
{
    ...
    for (i = 0; i < 8; ++i)
        do { uint64_t *base = &blockR.v[16 * i]; do { do { *base = *base + *(base + 4) + 2 * mul_lower(*base, *(base + 4)); *(base + 12) = rotr64(*(base + 12) ^ *base, 32); *(base + 8) = *(base + 8) + *(base + 12) + 2 * mul_lower(*(base + 8), *(base + 12)); *(base + 4) = rotr64(*(base + 4) ^ *(base + 8), 24); *base = *base + *(base + 4) + 2 * mul_lower(*base, *(base + 4)); *(base + 12) = rotr64(*(base + 12) ^ *base, 16); *(base + 8) = *(base + 8) + *(base + 12) + 2 * mul_lower(*(base + 8), *(base + 12)); *(base + 4) = rotr64(*(base + 4) ^ *(base + 8), 63); } while ((void)0, 0); do { *(base + 1) = *(base + 1) + *(base + 5) + 2 * mul_lower(*(base + 1), *(base + 5)); *(base + 13) = rotr64(*(base + 13) ^ *(base + 1), 32); *(base + 9) = *(base + 9) + *(base + 13) + 2 * mul_lower(*(base + 9), *(base + 13)); *(base + 5) = rotr64(*(base + 5) ^ *(base + 9), 24); *(base + 1) = *(base + 1) + *(base + 5) + 2 * mul_lower(*(base + 1), *(base + 5)); *(base + 13) = rotr64(*(base + 13) ^ *(base + 1), 16); *(base + 9) = *(base + 9) + *(base + 13) + 2 * mul_lower(*(base + 9), *(base + 13)); *(base + 5) = rotr64(*(base + 5) ^ *(base + 9), 63); } while ((void)0, 0); do { *(base + 2) = *(base + 2) + *(base + 6) + 2 * mul_lower(*(base + 2), *(base + 6)); *(base + 14) = rotr64(*(base + 14) ^ *(base + 2), 32); *(base + 10) = *(base + 10) + *(base + 14) + 2 * mul_lower(*(base + 10), *(base + 14)); *(base + 6) = rotr64(*(base + 6) ^ *(base + 10), 24); *(base + 2) = *(base + 2) + *(base + 6) + 2 * mul_lower(*(base + 2), *(base + 6)); *(base + 14) = rotr64(*(base + 14) ^ *(base + 2), 16); *(base + 10) = *(base + 10) + *(base + 14) + 2 * mul_lower(*(base + 10), *(base + 14)); *(base + 6) = rotr64(*(base + 6) ^ *(base + 10), 63); } while ((void)0, 0); do { *(base + 3) = *(base + 3) + *(base + 7) + 2 * mul_lower(*(base + 3), *(base + 7)); *(base + 15) = rotr64(*(base + 15) ^ *(base + 3), 32); *(base + 11) = *(base + 11) + *(base + 15) + 2 * mul_lower(*(base + 11), *(base + 15)); *(base + 7) = rotr64(*(base + 7) ^ *(base + 11), 24); *(base + 3) = *(base + 3) + *(base + 7) + 2 * mul_lower(*(base + 3), *(base + 7)); *(base + 15) = rotr64(*(base + 15) ^ *(base + 3), 16); *(base + 11) = *(base + 11) + *(base + 15) + 2 * mul_lower(*(base + 11), *(base + 15)); *(base + 7) = rotr64(*(base + 7) ^ *(base + 11), 63); } while ((void)0, 0); do { *base = *base + *(base + 5) + 2 * mul_lower(*base, *(base + 5)); *(base + 15) = rotr64(*(base + 15) ^ *base, 32); *(base + 10) = *(base + 10) + *(base + 15) + 2 * mul_lower(*(base + 10), *(base + 15)); *(base + 5) = rotr64(*(base + 5) ^ *(base + 10), 24); *base = *base + *(base + 5) + 2 * mul_lower(*base, *(base + 5)); *(base + 15) = rotr64(*(base + 15) ^ *base, 16); *(base + 10) = *(base + 10) + *(base + 15) + 2 * mul_lower(*(base + 10), *(base + 15)); *(base + 5) = rotr64(*(base + 5) ^ *(base + 10), 63); } while ((void)0, 0); do { *(base + 1) = *(base + 1) + *(base + 6) + 2 * mul_lower(*(base + 1), *(base + 6)); *(base + 12) = rotr64(*(base + 12) ^ *(base + 1), 32); *(base + 11) = *(base + 11) + *(base + 12) + 2 * mul_lower(*(base + 11), *(base + 12)); *(base + 6) = rotr64(*(base + 6) ^ *(base + 11), 24); *(base + 1) = *(base + 1) + *(base + 6) + 2 * mul_lower(*(base + 1), *(base + 6)); *(base + 12) = rotr64(*(base + 12) ^ *(base + 1), 16); *(base + 11) = *(base + 11) + *(base + 12) + 2 * mul_lower(*(base + 11), *(base + 12)); *(base + 6) = rotr64(*(base + 6) ^ *(base + 11), 63); } while ((void)0, 0); do { *(base + 2) = *(base + 2) + *(base + 7) + 2 * mul_lower(*(base + 2), *(base + 7)); *(base + 13) = rotr64(*(base + 13) ^ *(base + 2), 32); *(base + 8) = *(base + 8) + *(base + 13) + 2 * mul_lower(*(base + 8), *(base + 13)); *(base + 7) = rotr64(*(base + 7) ^ *(base + 8), 24); *(base + 2) = *(base + 2) + *(base + 7) + 2 * mul_lower(*(base + 2), *(base + 7)); *(base + 13) = rotr64(*(base + 13) ^ *(base + 2), 16); *(base + 8) = *(base + 8) + *(base + 13) + 2 * mul_lower(*(base + 8), *(base + 13)); *(base + 7) = rotr64(*(base + 7) ^ *(base + 8), 63); } while ((void)0, 0); do { *(base + 3) = *(base + 3) + *(base + 4) + 2 * mul_lower(*(base + 3), *(base + 4)); *(base + 14) = rotr64(*(base + 14) ^ *(base + 3), 32); *(base + 9) = *(base + 9) + *(base + 14) + 2 * mul_lower(*(base + 9), *(base + 14)); *(base + 4) = rotr64(*(base + 4) ^ *(base + 9), 24); *(base + 3) = *(base + 3) + *(base + 4) + 2 * mul_lower(*(base + 3), *(base + 4)); *(base + 14) = rotr64(*(base + 14) ^ *(base + 3), 16); *(base + 9) = *(base + 9) + *(base + 14) + 2 * mul_lower(*(base + 9), *(base + 14)); *(base + 4) = rotr64(*(base + 4) ^ *(base + 9), 63); } while ((void)0, 0); } while ((void)0, 0); } while ((void)0, 0);

    for (i = 0; i < 8; ++i)
        do { uint64_t *base = &blockR.v[2 * i]; do { do { *base = *base + *(base + 32) + 2 * mul_lower(*base, *(base + 32)); *(base + 96) = rotr64(*(base + 96) ^ *base, 32); *(base + 64) = *(base + 64) + *(base + 96) + 2 * mul_lower(*(base + 64), *(base + 96)); *(base + 32) = rotr64(*(base + 32) ^ *(base + 64), 24); *base = *base + *(base + 32) + 2 * mul_lower(*base, *(base + 32)); *(base + 96) = rotr64(*(base + 96) ^ *base, 16); *(base + 64) = *(base + 64) + *(base + 96) + 2 * mul_lower(*(base + 64), *(base + 96)); *(base + 32) = rotr64(*(base + 32) ^ *(base + 64), 63); } while ((void)0, 0); do { *(base + 1) = *(base + 1) + *(base + 33) + 2 * mul_lower(*(base + 1), *(base + 33)); *(base + 97) = rotr64(*(base + 97) ^ *(base + 1), 32); *(base + 65) = *(base + 65) + *(base + 97) + 2 * mul_lower(*(base + 65), *(base + 97)); *(base + 33) = rotr64(*(base + 33) ^ *(base + 65), 24); *(base + 1) = *(base + 1) + *(base + 33) + 2 * mul_lower(*(base + 1), *(base + 33)); *(base + 97) = rotr64(*(base + 97) ^ *(base + 1), 16); *(base + 65) = *(base + 65) + *(base + 97) + 2 * mul_lower(*(base + 65), *(base + 97)); *(base + 33) = rotr64(*(base + 33) ^ *(base + 65), 63); } while ((void)0, 0); do { *(base + 16) = *(base + 16) + *(base + 48) + 2 * mul_lower(*(base + 16), *(base + 48)); *(base + 112) = rotr64(*(base + 112) ^ *(base + 16), 32); *(base + 80) = *(base + 80) + *(base + 112) + 2 * mul_lower(*(base + 80), *(base + 112)); *(base + 48) = rotr64(*(base + 48) ^ *(base + 80), 24); *(base + 16) = *(base + 16) + *(base + 48) + 2 * mul_lower(*(base + 16), *(base + 48)); *(base + 112) = rotr64(*(base + 112) ^ *(base + 16), 16); *(base + 80) = *(base + 80) + *(base + 112) + 2 * mul_lower(*(base + 80), *(base + 112)); *(base + 48) = rotr64(*(base + 48) ^ *(base + 80), 63); } while ((void)0, 0); do { *(base + 17) = *(base + 17) + *(base + 49) + 2 * mul_lower(*(base + 17), *(base + 49)); *(base + 113) = rotr64(*(base + 113) ^ *(base + 17), 32); *(base + 81) = *(base + 81) + *(base + 113) + 2 * mul_lower(*(base + 81), *(base + 113)); *(base + 49) = rotr64(*(base + 49) ^ *(base + 81), 24); *(base + 17) = *(base + 17) + *(base + 49) + 2 * mul_lower(*(base + 17), *(base + 49)); *(base + 113) = rotr64(*(base + 113) ^ *(base + 17), 16); *(base + 81) = *(base + 81) + *(base + 113) + 2 * mul_lower(*(base + 81), *(base + 113)); *(base + 49) = rotr64(*(base + 49) ^ *(base + 81), 63); } while ((void)0, 0); do { *base = *base + *(base + 33) + 2 * mul_lower(*base, *(base + 33)); *(base + 113) = rotr64(*(base + 113) ^ *base, 32); *(base + 80) = *(base + 80) + *(base + 113) + 2 * mul_lower(*(base + 80), *(base + 113)); *(base + 33) = rotr64(*(base + 33) ^ *(base + 80), 24); *base = *base + *(base + 33) + 2 * mul_lower(*base, *(base + 33)); *(base + 113) = rotr64(*(base + 113) ^ *base, 16); *(base + 80) = *(base + 80) + *(base + 113) + 2 * mul_lower(*(base + 80), *(base + 113)); *(base + 33) = rotr64(*(base + 33) ^ *(base + 80), 63); } while ((void)0, 0); do { *(base + 1) = *(base + 1) + *(base + 48) + 2 * mul_lower(*(base + 1), *(base + 48)); *(base + 96) = rotr64(*(base + 96) ^ *(base + 1), 32); *(base + 81) = *(base + 81) + *(base + 96) + 2 * mul_lower(*(base + 81), *(base + 96)); *(base + 48) = rotr64(*(base + 48) ^ *(base + 81), 24); *(base + 1) = *(base + 1) + *(base + 48) + 2 * mul_lower(*(base + 1), *(base + 48)); *(base + 96) = rotr64(*(base + 96) ^ *(base + 1), 16); *(base + 81) = *(base + 81) + *(base + 96) + 2 * mul_lower(*(base + 81), *(base + 96)); *(base + 48) = rotr64(*(base + 48) ^ *(base + 81), 63); } while ((void)0, 0); do { *(base + 16) = *(base + 16) + *(base + 49) + 2 * mul_lower(*(base + 16), *(base + 49)); *(base + 97) = rotr64(*(base + 97) ^ *(base + 16), 32); *(base + 64) = *(base + 64) + *(base + 97) + 2 * mul_lower(*(base + 64), *(base + 97)); *(base + 49) = rotr64(*(base + 49) ^ *(base + 64), 24); *(base + 16) = *(base + 16) + *(base + 49) + 2 * mul_lower(*(base + 16), *(base + 49)); *(base + 97) = rotr64(*(base + 97) ^ *(base + 16), 16); *(base + 64) = *(base + 64) + *(base + 97) + 2 * mul_lower(*(base + 64), *(base + 97)); *(base + 49) = rotr64(*(base + 49) ^ *(base + 64), 63); } while ((void)0, 0); do { *(base + 17) = *(base + 17) + *(base + 32) + 2 * mul_lower(*(base + 17), *(base + 32)); *(base + 112) = rotr64(*(base + 112) ^ *(base + 17), 32); *(base + 65) = *(base + 65) + *(base + 112) + 2 * mul_lower(*(base + 65), *(base + 112)); *(base + 32) = rotr64(*(base + 32) ^ *(base + 65), 24); *(base + 17) = *(base + 17) + *(base + 32) + 2 * mul_lower(*(base + 17), *(base + 32)); *(base + 112) = rotr64(*(base + 112) ^ *(base + 17), 16); *(base + 65) = *(base + 65) + *(base + 112) + 2 * mul_lower(*(base + 65), *(base + 112)); *(base + 32) = rotr64(*(base + 32) ^ *(base + 65), 63); } while ((void)0, 0); } while ((void)0, 0); } while ((void)0, 0);
                                 ...
                                 uint8_t slice)
{
    ...
    case ARGON2_I:
        return 1;
    case ARGON2_ID:
        return (pass == 0) && (slice < 4u / 2);
    case ARGON2_D:
    default:
        return 0;
    }
}
# 428 "../providers/implementations/kdfs/argon2.c"
static uint32_t index_alpha(const KDF_ARGON2 *ctx, uint32_t pass,
                            uint8_t slice, uint32_t index,
                            uint32_t pseudo_rand, int same_lane)
{
...
{
    BLOCK *ref_block = 
# 469 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 469 "../providers/implementations/kdfs/argon2.c"
                          , *curr_block = 
# 469 "../providers/implementations/kdfs/argon2.c" 3 4
                                          ((void *)0)
# 469 "../providers/implementations/kdfs/argon2.c"
    ...
    if (ctx == 
# 479 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 479 "../providers/implementations/kdfs/argon2.c"
                  )
        return;
...
static int fill_mem_blocks_mt(KDF_ARGON2 *ctx)
{
    ...
    t = CRYPTO_zalloc(sizeof(void *)*ctx->lanes, "../providers/implementations/kdfs/argon2.c", 567);
    t_data = CRYPTO_zalloc(ctx->lanes * sizeof(ARGON2_THREAD_DATA), "../providers/implementations/kdfs/argon2.c", 568);

    if (t == 
# 570 "../providers/implementations/kdfs/argon2.c" 3 4
            ((void *)0) 
# 570 "../providers/implementations/kdfs/argon2.c"
                 || t_data == 
# 570 "../providers/implementations/kdfs/argon2.c" 3 4
                              ((void *)0)
# 570 "../providers/implementations/kdfs/argon2.c"
    ...
    for (r = 0; r < ctx->passes; ++r) {
        for (s = 0; s < 4u; ++s) {
            for (l = 0; l < ctx->lanes; ++l) {
                ARGON2_POS p;
                if (l >= ctx->threads) {
                    if (ossl_crypto_thread_join(t[l - ctx->threads], 
# 578 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                    ((void *)0)
# 578 "../providers/implementations/kdfs/argon2.c"
                                                                        ) == 0)
                        goto fail;
                    if (ossl_crypto_thread_clean(t[l - ctx->threads]) == 0)
                        goto fail;
                    t[l] = 
# 582 "../providers/implementations/kdfs/argon2.c" 3 4
                          ((void *)0)
# 582 "../providers/implementations/kdfs/argon2.c"
                              ;
                }
                ...
                t[l] = ossl_crypto_thread_start(ctx->libctx, &fill_segment_thr,
                                                (void *) &t_data[l]);
                if (t[l] == 
# 594 "../providers/implementations/kdfs/argon2.c" 3 4
                           ((void *)0)
# 594 "../providers/implementations/kdfs/argon2.c"
                               ) {
                    for (ll = 0; ll < l; ++ll) {
                        if (ossl_crypto_thread_join(t[ll], 
# 596 "../providers/implementations/kdfs/argon2.c" 3 4
                                                          ((void *)0)
# 596 "../providers/implementations/kdfs/argon2.c"
                                                              ) == 0)
                            goto fail;
                        if (ossl_crypto_thread_clean(t[ll]) == 0)
                            goto fail;
                        t[ll] = 
# 600 "../providers/implementations/kdfs/argon2.c" 3 4
                               ((void *)0)
# 600 "../providers/implementations/kdfs/argon2.c"
                                   ;
                    }
                    goto fail;
                }
            ...
            for (l = ctx->lanes - ctx->threads; l < ctx->lanes; ++l) {
                if (ossl_crypto_thread_join(t[l], 
# 606 "../providers/implementations/kdfs/argon2.c" 3 4
                                                 ((void *)0)
# 606 "../providers/implementations/kdfs/argon2.c"
                                                     ) == 0)
                    goto fail;
                if (ossl_crypto_thread_clean(t[l]) == 0)
                    goto fail;
                t[l] = 
# 610 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 610 "../providers/implementations/kdfs/argon2.c"
                          ;
            }
        }
    }

    CRYPTO_free(t_data, "../providers/implementations/kdfs/argon2.c", 615);
    CRYPTO_free(t, "../providers/implementations/kdfs/argon2.c", 616);

    return 1;

fail:
    if (t_data != 
# 621 "../providers/implementations/kdfs/argon2.c" 3 4
                 ((void *)0)
# 621 "../providers/implementations/kdfs/argon2.c"
                     )
        CRYPTO_free(t_data, "../providers/implementations/kdfs/argon2.c", 622);
    if (t != 
# 623 "../providers/implementations/kdfs/argon2.c" 3 4
            ((void *)0)
# 623 "../providers/implementations/kdfs/argon2.c"
                )
        CRYPTO_free(t, "../providers/implementations/kdfs/argon2.c", 624);
    return 0;
}
...
static void initial_hash(uint8_t *blockhash, KDF_ARGON2 *ctx)
{
    ...
    if (ctx == 
# 657 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0) 
# 657 "../providers/implementations/kdfs/argon2.c"
                   || blockhash == 
# 657 "../providers/implementations/kdfs/argon2.c" 3 4
                                   ((void *)0)
# 657 "../providers/implementations/kdfs/argon2.c"
    ...
    if (mdctx == 
# 669 "../providers/implementations/kdfs/argon2.c" 3 4
                ((void *)0) 
# 669 "../providers/implementations/kdfs/argon2.c"
                     || EVP_DigestInit_ex(mdctx, ctx->md, 
# 669 "../providers/implementations/kdfs/argon2.c" 3 4
                                                          ((void *)0)
# 669 "../providers/implementations/kdfs/argon2.c"
                                                              ) != 1)
    ...
    if (ctx->pwd != 
# 678 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 678 "../providers/implementations/kdfs/argon2.c"
                       ) {
    ...
    if (ctx->salt != 
# 692 "../providers/implementations/kdfs/argon2.c" 3 4
                    ((void *)0)
# 692 "../providers/implementations/kdfs/argon2.c"
                        )
    ...
    if (ctx->secret != 
# 700 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 700 "../providers/implementations/kdfs/argon2.c"
                          ) {
    ...
    if (ctx->ad != 
# 713 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 713 "../providers/implementations/kdfs/argon2.c"
                      )
...
static int initialize(KDF_ARGON2 *ctx)
{
    uint8_t blockhash[(64 + (2 * sizeof(uint32_t)))];

    if (ctx == 
# 729 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 729 "../providers/implementations/kdfs/argon2.c"
                  )
        return 0;
    ...
    if (ctx->type != ARGON2_D)
        ctx->memory = CRYPTO_secure_zalloc(ctx->memory_blocks * sizeof(BLOCK), "../providers/implementations/kdfs/argon2.c", 736)
                                                          ;
    else
        ctx->memory = CRYPTO_zalloc(ctx->memory_blocks * sizeof(BLOCK), "../providers/implementations/kdfs/argon2.c", 739)
                                                   ;

    if (ctx->memory == 
# 742 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 742 "../providers/implementations/kdfs/argon2.c"
                          ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",743,__func__), ERR_set_error)(57, 235,
                       "cannot allocate required memory");
        return 0;
    }

    initial_hash(blockhash, ctx);
    OPENSSL_cleanse(blockhash + 64,
                    (64 + (2 * sizeof(uint32_t))) - 64);
    fill_first_blocks(blockhash, ctx);
    OPENSSL_cleanse(blockhash, (64 + (2 * sizeof(uint32_t))));
...
static void finalize(const KDF_ARGON2 *ctx, void *out)
{
    ...
    if (ctx == 
# 764 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 764 "../providers/implementations/kdfs/argon2.c"
                  )
        return;
    ...
    blake2b_long(ctx->md, ctx->mac, out, ctx->outlen, blockhash_bytes,
                 1024);
    OPENSSL_cleanse(blockhash.v, 1024);
    OPENSSL_cleanse(blockhash_bytes, 1024);

    if (ctx->type != ARGON2_D)
        CRYPTO_secure_clear_free(ctx->memory, ctx->memory_blocks * sizeof(BLOCK), "../providers/implementations/kdfs/argon2.c", 783)
                                                                     ;
    else
        CRYPTO_clear_free(ctx->memory, ctx->memory_blocks * sizeof(BLOCK), "../providers/implementations/kdfs/argon2.c", 786)
                                                              ;
}
                       ...
                       size_t inlen, const void *key, size_t keylen)
{
    ...
    EVP_MAC_CTX *ctx = 
# 795 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 795 "../providers/implementations/kdfs/argon2.c"
                          ;
    OSSL_PARAM par[3];

    if ((ctx = EVP_MAC_CTX_new(mac)) == 
# 798 "../providers/implementations/kdfs/argon2.c" 3 4
                                       ((void *)0)
# 798 "../providers/implementations/kdfs/argon2.c"
                                           )
        goto fail;

    par[par_n++] = OSSL_PARAM_construct_octet_string("key",
                                                     (void *) key, keylen);
    par[par_n++] = OSSL_PARAM_construct_size_t("size", &outlen);
    par[par_n++] = OSSL_PARAM_construct_end();

    ret = EVP_MAC_CTX_set_params(ctx, par) == 1
        && EVP_MAC_init(ctx, 
# 807 "../providers/implementations/kdfs/argon2.c" 3 4
                            ((void *)0)
# 807 "../providers/implementations/kdfs/argon2.c"
                                , 0, 
# 807 "../providers/implementations/kdfs/argon2.c" 3 4
                                     ((void *)0)
# 807 "../providers/implementations/kdfs/argon2.c"
                      ...
                      size_t inlen)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 820 "../providers/implementations/kdfs/argon2.c" 3 4
                     ((void *)0)
# 820 "../providers/implementations/kdfs/argon2.c"
                         ;
    OSSL_PARAM par[2];

    if ((ctx = EVP_MD_CTX_new()) == 
# 823 "../providers/implementations/kdfs/argon2.c" 3 4
                                      ((void *)0)
# 823 "../providers/implementations/kdfs/argon2.c"
                                          )
        return 0;

    par[0] = OSSL_PARAM_construct_size_t("size", &outlen);
    par[1] = OSSL_PARAM_construct_end();

    ret = EVP_DigestInit_ex2(ctx, md, par) == 1
        && EVP_DigestUpdate(ctx, in, inlen) == 1
        && EVP_DigestFinal_ex(ctx, out, 
# 831 "../providers/implementations/kdfs/argon2.c" 3 4
                                       ((void *)0)
# 831 "../providers/implementations/kdfs/argon2.c"
                                           ) == 1;
...
{
    if (out == 
# 840 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0) 
# 840 "../providers/implementations/kdfs/argon2.c"
                   || outlen == 0)
        return 0;

    if (key == 
# 843 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0) 
# 843 "../providers/implementations/kdfs/argon2.c"
                   || keylen == 0)
                        ...
                        size_t outlen, const void *in, size_t inlen)
{
    int ret = 0;
    EVP_MD_CTX *ctx = 
# 853 "../providers/implementations/kdfs/argon2.c" 3 4
                     ((void *)0)
# 853 "../providers/implementations/kdfs/argon2.c"
                         ;
    ...
    if (out == 
# 861 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0) 
# 861 "../providers/implementations/kdfs/argon2.c"
                   || outlen == 0)
        return 0;
    ...
    if ((ctx = EVP_MD_CTX_new()) == 
# 867 "../providers/implementations/kdfs/argon2.c" 3 4
                                      ((void *)0)
# 867 "../providers/implementations/kdfs/argon2.c"
                                          )
        return 0;

    outlen_md = (outlen <= 64) ? outlen : 64;
    par[0] = OSSL_PARAM_construct_size_t("size", &outlen_md);
    par[1] = OSSL_PARAM_construct_end();

    ret = EVP_DigestInit_ex2(ctx, md, par) == 1
        && EVP_DigestUpdate(ctx, outlen_bytes, sizeof(outlen_bytes)) == 1
        && EVP_DigestUpdate(ctx, in, inlen) == 1
        && EVP_DigestFinal_ex(ctx, (outlen > 64) ? outbuf : out,
                              
# 878 "../providers/implementations/kdfs/argon2.c" 3 4
                             ((void *)0)
# 878 "../providers/implementations/kdfs/argon2.c"
                                 ) == 1;
    ...
    if (outlen > 64) {
        memcpy(out, outbuf, 64 / 2);
        out += 64 / 2;
        outlen_curr = (uint32_t) outlen - 64 / 2;

        while (outlen_curr > 64) {
            memcpy(inbuf, outbuf, 64);
            if (blake2b(md, mac, outbuf, 64, inbuf,
                        64, 
# 891 "../providers/implementations/kdfs/argon2.c" 3 4
                                         ((void *)0)
# 891 "../providers/implementations/kdfs/argon2.c"
                                             , 0) != 1)
                goto fail;
            memcpy(out, outbuf, 64 / 2);
            out += 64 / 2;
        ...
        memcpy(inbuf, outbuf, 64);
        if (blake2b(md, mac, outbuf, outlen_curr, inbuf, 64,
                    
# 900 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 900 "../providers/implementations/kdfs/argon2.c"
                       , 0) != 1)
            goto fail;
...
static void *kdf_argon2d_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 933 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 933 "../providers/implementations/kdfs/argon2.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/argon2.c", 935);
    if (ctx == 
# 936 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 936 "../providers/implementations/kdfs/argon2.c"
                  ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",937,__func__), ERR_set_error)((57),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 937 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 937 "../providers/implementations/kdfs/argon2.c"
       );
        return 
# 938 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 938 "../providers/implementations/kdfs/argon2.c"
                  ;
    }

    ctx->libctx = ossl_prov_ctx_get0_libctx((provctx));
...
static void *kdf_argon2i_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 952 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 952 "../providers/implementations/kdfs/argon2.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/argon2.c", 954);
    if (ctx == 
# 955 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 955 "../providers/implementations/kdfs/argon2.c"
                  ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",956,__func__), ERR_set_error)((57),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 956 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 956 "../providers/implementations/kdfs/argon2.c"
       );
        return 
# 957 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 957 "../providers/implementations/kdfs/argon2.c"
                  ;
    }
...
static void *kdf_argon2id_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 971 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 971 "../providers/implementations/kdfs/argon2.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/argon2.c", 973);
    if (ctx == 
# 974 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 974 "../providers/implementations/kdfs/argon2.c"
                  ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",975,__func__), ERR_set_error)((57),((256|((0x1 << 18L)|(0x2 << 18L)))),
# 975 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 975 "../providers/implementations/kdfs/argon2.c"
       );
        return 
# 976 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 976 "../providers/implementations/kdfs/argon2.c"
                  ;
    }
...
static void kdf_argon2_free(void *vctx)
{
    ...
    if (ctx == 
# 989 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 989 "../providers/implementations/kdfs/argon2.c"
                  )
        return;

    if (ctx->pwd != 
# 992 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 992 "../providers/implementations/kdfs/argon2.c"
                       )
        CRYPTO_clear_free(ctx->pwd, ctx->pwdlen, "../providers/implementations/kdfs/argon2.c", 993);

    if (ctx->salt != 
# 995 "../providers/implementations/kdfs/argon2.c" 3 4
                    ((void *)0)
# 995 "../providers/implementations/kdfs/argon2.c"
                        )
        CRYPTO_clear_free(ctx->salt, ctx->saltlen, "../providers/implementations/kdfs/argon2.c", 996);

    if (ctx->secret != 
# 998 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 998 "../providers/implementations/kdfs/argon2.c"
                          )
        CRYPTO_clear_free(ctx->secret, ctx->secretlen, "../providers/implementations/kdfs/argon2.c", 999);

    if (ctx->ad != 
# 1001 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1001 "../providers/implementations/kdfs/argon2.c"
                      )
        CRYPTO_clear_free(ctx->ad, ctx->adlen, "../providers/implementations/kdfs/argon2.c", 1002);

    EVP_MD_free(ctx->md);
    EVP_MAC_free(ctx->mac);

    CRYPTO_free(ctx->propq, "../providers/implementations/kdfs/argon2.c", 1007);

    memset(ctx, 0, sizeof(*ctx));

    CRYPTO_free(ctx, "../providers/implementations/kdfs/argon2.c", 1011);
}
                             ...
                             const OSSL_PARAM params[])
{
    ...
    if (ctx->mac == 
# 1025 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 1025 "../providers/implementations/kdfs/argon2.c"
                       )
        ctx->mac = EVP_MAC_fetch(ctx->libctx, "blake2bmac", ctx->propq);
    if (ctx->mac == 
# 1027 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 1027 "../providers/implementations/kdfs/argon2.c"
                       ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1028,__func__), ERR_set_error)(57, 150,
                       "cannot fetch blake2bmac");
        return 0;
    }

    if (ctx->md == 
# 1033 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1033 "../providers/implementations/kdfs/argon2.c"
                      )
        ctx->md = EVP_MD_fetch(ctx->libctx, "blake2b512", ctx->propq);
    if (ctx->md == 
# 1035 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1035 "../providers/implementations/kdfs/argon2.c"
                      ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1036,__func__), ERR_set_error)(57, 129,
                       "cannot fetch blake2b512");
        return 0;
    }

    if (ctx->salt == 
# 1041 "../providers/implementations/kdfs/argon2.c" 3 4
                    ((void *)0) 
# 1041 "../providers/implementations/kdfs/argon2.c"
                         || ctx->saltlen == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1042,__func__), ERR_set_error)((57),(131),
# 1042 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1042 "../providers/implementations/kdfs/argon2.c"
       );
        return 0;
    }

    if (outlen != ctx->outlen) {
        if (OSSL_PARAM_locate((OSSL_PARAM *)params, "size") != 
# 1047 "../providers/implementations/kdfs/argon2.c" 3 4
                                                              ((void *)0)
# 1047 "../providers/implementations/kdfs/argon2.c"
                                                                  ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1048,__func__), ERR_set_error)((57),(106),
# 1048 "../providers/implementations/kdfs/argon2.c" 3 4
           ((void *)0)
# 1048 "../providers/implementations/kdfs/argon2.c"
           );
            return 0;
        }
    ...
    case ARGON2_ID:
        break;
    default:
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1061,__func__), ERR_set_error)(57, 125, "invalid Argon2 type");
        return 0;
    }
    ...
    if (ctx->threads > 1) {
        ...
        if (ctx->threads > ossl_get_avail_threads(ctx->libctx)) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1073,__func__), ERR_set_error)(57, 234,
        ...
        if (ctx->threads > ctx->lanes) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1080,__func__), ERR_set_error)(57, 234,
    ...
    if (ctx->m_cost < 8 * ctx->lanes) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1088,__func__), ERR_set_error)(57, 235,
                       "m_cost must be greater or equal than 8 times the number of lanes");
        return 0;
    }

    memory_blocks = ctx->m_cost;
    if (memory_blocks < 2 * 4u * ctx->lanes)
        memory_blocks = 2 * 4u * ctx->lanes;


    segment_length = memory_blocks / (ctx->lanes * 4u);
    memory_blocks = segment_length * (ctx->lanes * 4u);

    ctx->memory = 
# 1101 "../providers/implementations/kdfs/argon2.c" 3 4
                 ((void *)0)
# 1101 "../providers/implementations/kdfs/argon2.c"
                     ;
    ctx->memory_blocks = memory_blocks;
    ctx->segment_length = segment_length;
    ctx->passes = ctx->t_cost;
    ctx->lane_length = segment_length * 4u;
...
static void kdf_argon2_reset(void *vctx)
{
    ...
    CRYPTO_free(ctx->propq, "../providers/implementations/kdfs/argon2.c", 1131);

    if (ctx->pwd != 
# 1133 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 1133 "../providers/implementations/kdfs/argon2.c"
                       )
        CRYPTO_clear_free(ctx->pwd, ctx->pwdlen, "../providers/implementations/kdfs/argon2.c", 1134);

    if (ctx->salt != 
# 1136 "../providers/implementations/kdfs/argon2.c" 3 4
                    ((void *)0)
# 1136 "../providers/implementations/kdfs/argon2.c"
                        )
        CRYPTO_clear_free(ctx->salt, ctx->saltlen, "../providers/implementations/kdfs/argon2.c", 1137);

    if (ctx->secret != 
# 1139 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 1139 "../providers/implementations/kdfs/argon2.c"
                          )
        CRYPTO_clear_free(ctx->secret, ctx->secretlen, "../providers/implementations/kdfs/argon2.c", 1140);

    if (ctx->ad != 
# 1142 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1142 "../providers/implementations/kdfs/argon2.c"
                      )
        CRYPTO_clear_free(ctx->ad, ctx->adlen, "../providers/implementations/kdfs/argon2.c", 1143);
...
{
    if (threads < 1u) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1153,__func__), ERR_set_error)(57, 234,
                       "min threads: %u", 1u);
        return 0;
    }

    if (threads > 0xFFFFFFu) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1159,__func__), ERR_set_error)(57, 234,
                       "max threads: %u", 0xFFFFFFu);
        return 0;
    }
...
{
    if (lanes > 0xFFFFFFu) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1171,__func__), ERR_set_error)(57, 104,
                       "max lanes: %u", 0xFFFFFFu);
        return 0;
    }

    if (lanes < 1u) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1177,__func__), ERR_set_error)(57, 104,
                       "min lanes: %u", 1u);
        return 0;
    }
...
static int kdf_argon2_ctx_set_t_cost(KDF_ARGON2 *ctx, uint32_t t_cost)
{
    ...
    if (t_cost < 1u) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1191,__func__), ERR_set_error)(57, 123,
                       "min: %u", 1u);
        return 0;
    }
...
static int kdf_argon2_ctx_set_m_cost(KDF_ARGON2 *ctx, uint32_t m_cost)
{
    ...
    if (m_cost < (2 * 4u)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1205,__func__), ERR_set_error)(57, 235, "min: %u",
                       (2 * 4u));
        return 0;
    }
...
static int kdf_argon2_ctx_set_out_length(KDF_ARGON2 *ctx, uint32_t outlen)
{
    ...
    if (outlen < 4u) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1223,__func__), ERR_set_error)(57, 217, "min: %u",
                       4u);
        return 0;
    }
...
static int kdf_argon2_ctx_set_secret(KDF_ARGON2 *ctx, const OSSL_PARAM *p)
{
    ...
    if (p->data == 
# 1236 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1236 "../providers/implementations/kdfs/argon2.c"
                      )
        return 0;

    if (ctx->secret != 
# 1239 "../providers/implementations/kdfs/argon2.c" 3 4
                      ((void *)0)
# 1239 "../providers/implementations/kdfs/argon2.c"
                          ) {
        CRYPTO_clear_free(ctx->secret, ctx->secretlen, "../providers/implementations/kdfs/argon2.c", 1240);
        ctx->secret = 
# 1241 "../providers/implementations/kdfs/argon2.c" 3 4
                     ((void *)0)
# 1241 "../providers/implementations/kdfs/argon2.c"
                         ;
        ctx->secretlen = 0U;
    }
    ...
    if (buflen > 0xFFFFFFFFu) {
        CRYPTO_free(ctx->secret, "../providers/implementations/kdfs/argon2.c", 1249);
        ctx->secret = 
# 1250 "../providers/implementations/kdfs/argon2.c" 3 4
                     ((void *)0)
# 1250 "../providers/implementations/kdfs/argon2.c"
                         ;
        ctx->secretlen = 0U;
        return 0;
    }
...
static int kdf_argon2_ctx_set_pwd(KDF_ARGON2 *ctx, const OSSL_PARAM *p)
{
    ...
    if (p->data == 
# 1263 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1263 "../providers/implementations/kdfs/argon2.c"
                      )
        return 0;

    if (ctx->pwd != 
# 1266 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 1266 "../providers/implementations/kdfs/argon2.c"
                       ) {
        CRYPTO_clear_free(ctx->pwd, ctx->pwdlen, "../providers/implementations/kdfs/argon2.c", 1267);
        ctx->pwd = 
# 1268 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1268 "../providers/implementations/kdfs/argon2.c"
                      ;
        ctx->pwdlen = 0U;
    }
    ...
    if (buflen > 0xFFFFFFFFu) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1276,__func__), ERR_set_error)(57, 112, "max: %u",
                       0xFFFFFFFFu);
        goto fail;
    }
...
fail:
    CRYPTO_free(ctx->pwd, "../providers/implementations/kdfs/argon2.c", 1285);
    ctx->pwd = 
# 1286 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 1286 "../providers/implementations/kdfs/argon2.c"
                  ;
    ctx->pwdlen = 0U;
    return 0;
}
...
static int kdf_argon2_ctx_set_salt(KDF_ARGON2 *ctx, const OSSL_PARAM *p)
{
    ...
    if (p->data == 
# 1295 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1295 "../providers/implementations/kdfs/argon2.c"
                      )
        return 0;

    if (ctx->salt != 
# 1298 "../providers/implementations/kdfs/argon2.c" 3 4
                    ((void *)0)
# 1298 "../providers/implementations/kdfs/argon2.c"
                        ) {
        CRYPTO_clear_free(ctx->salt, ctx->saltlen, "../providers/implementations/kdfs/argon2.c", 1299);
        ctx->salt = 
# 1300 "../providers/implementations/kdfs/argon2.c" 3 4
                   ((void *)0)
# 1300 "../providers/implementations/kdfs/argon2.c"
                       ;
        ctx->saltlen = 0U;
    }
    ...
    if (buflen < 8u) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1308,__func__), ERR_set_error)(57, 112, "min: %u",
                       8u);
        goto fail;
    }

    if (buflen > 0xFFFFFFFFu) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1314,__func__), ERR_set_error)(57, 112, "max: %u",
                       0xFFFFFFFFu);
        goto fail;
    }
...
fail:
    CRYPTO_free(ctx->salt, "../providers/implementations/kdfs/argon2.c", 1323);
    ctx->salt = 
# 1324 "../providers/implementations/kdfs/argon2.c" 3 4
               ((void *)0)
# 1324 "../providers/implementations/kdfs/argon2.c"
                   ;
    ctx->saltlen = 0U;
    return 0;
}
...
static int kdf_argon2_ctx_set_ad(KDF_ARGON2 *ctx, const OSSL_PARAM *p)
{
    ...
    if (p->data == 
# 1333 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1333 "../providers/implementations/kdfs/argon2.c"
                      )
        return 0;

    if (ctx->ad != 
# 1336 "../providers/implementations/kdfs/argon2.c" 3 4
                  ((void *)0)
# 1336 "../providers/implementations/kdfs/argon2.c"
                      ) {
        CRYPTO_clear_free(ctx->ad, ctx->adlen, "../providers/implementations/kdfs/argon2.c", 1337);
        ctx->ad = 
# 1338 "../providers/implementations/kdfs/argon2.c" 3 4
                 ((void *)0)
# 1338 "../providers/implementations/kdfs/argon2.c"
                     ;
        ctx->adlen = 0U;
    }
    ...
    if (buflen > 0xFFFFFFFFu) {
        CRYPTO_free(ctx->ad, "../providers/implementations/kdfs/argon2.c", 1346);
        ctx->ad = 
# 1347 "../providers/implementations/kdfs/argon2.c" 3 4
                 ((void *)0)
# 1347 "../providers/implementations/kdfs/argon2.c"
                     ;
        ctx->adlen = 0U;
        return 0;
    }
...
static int kdf_argon2_ctx_set_version(KDF_ARGON2 *ctx, uint32_t version)
{
    ...
    case ARGON2_VERSION_13:
        ...
        return 1;
    default:
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/argon2.c",1369,__func__), ERR_set_error)(57, 125,
...
{
    CRYPTO_free(ctx->propq, "../providers/implementations/kdfs/argon2.c", 1377);
    ctx->propq = 
# 1378 "../providers/implementations/kdfs/argon2.c" 3 4
                ((void *)0)
# 1378 "../providers/implementations/kdfs/argon2.c"
                    ;
    if (propq != 
# 1379 "../providers/implementations/kdfs/argon2.c" 3 4
                ((void *)0)
# 1379 "../providers/implementations/kdfs/argon2.c"
                    ) {
        ctx->propq = CRYPTO_strdup(propq, "../providers/implementations/kdfs/argon2.c", 1380);
        if (ctx->propq == 
# 1381 "../providers/implementations/kdfs/argon2.c" 3 4
                         ((void *)0)
# 1381 "../providers/implementations/kdfs/argon2.c"
                             )
            return 0;
    }
    EVP_MD_free(ctx->md);
    ctx->md = 
# 1385 "../providers/implementations/kdfs/argon2.c" 3 4
             ((void *)0)
# 1385 "../providers/implementations/kdfs/argon2.c"
                 ;
    EVP_MAC_free(ctx->mac);
    ctx->mac = 
# 1387 "../providers/implementations/kdfs/argon2.c" 3 4
              ((void *)0)
# 1387 "../providers/implementations/kdfs/argon2.c"
                  ;
    return 1;
}
...
static int kdf_argon2_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 1397 "../providers/implementations/kdfs/argon2.c" 3 4
                 ((void *)0)
# 1397 "../providers/implementations/kdfs/argon2.c"
                     )
        return 1;

    ctx = (KDF_ARGON2 *) vctx;
    if ((p = OSSL_PARAM_locate_const(params, "pass")) != 
# 1401 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                         ((void *)0)
# 1401 "../providers/implementations/kdfs/argon2.c"
                                                                             )
        if (!kdf_argon2_ctx_set_pwd(ctx, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "salt")) != 
# 1405 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                     ((void *)0)
# 1405 "../providers/implementations/kdfs/argon2.c"
                                                                         )
        if (!kdf_argon2_ctx_set_salt(ctx, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "secret")) != 
# 1409 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                       ((void *)0)
# 1409 "../providers/implementations/kdfs/argon2.c"
                                                                           )
        if (!kdf_argon2_ctx_set_secret(ctx, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "ad")) != 
# 1413 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                          ((void *)0)
# 1413 "../providers/implementations/kdfs/argon2.c"
                                                                              )
        if (!kdf_argon2_ctx_set_ad(ctx, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "size")) != 
# 1417 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                     ((void *)0)
# 1417 "../providers/implementations/kdfs/argon2.c"
                                                                         ) {
    ...
    if ((p = OSSL_PARAM_locate_const(params, "iter")) != 
# 1424 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                     ((void *)0)
# 1424 "../providers/implementations/kdfs/argon2.c"
                                                                         ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "threads")) != 
# 1431 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                        ((void *)0)
# 1431 "../providers/implementations/kdfs/argon2.c"
                                                                            ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "lanes")) != 
# 1438 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                             ((void *)0)
# 1438 "../providers/implementations/kdfs/argon2.c"
                                                                                 ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "memcost")) != 
# 1445 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                               ((void *)0)
# 1445 "../providers/implementations/kdfs/argon2.c"
                                                                                   ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "early_clean")) != 
# 1452 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                            ((void *)0)
# 1452 "../providers/implementations/kdfs/argon2.c"
                                                                                ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "version")) != 
# 1458 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                               ((void *)0)
# 1458 "../providers/implementations/kdfs/argon2.c"
                                                                                   ) {
        if (!OSSL_PARAM_get_uint32(p, &u32_value))
            return 0;
    ...
    if ((p = OSSL_PARAM_locate_const(params, "properties")) != 
# 1465 "../providers/implementations/kdfs/argon2.c" 3 4
                                                                           ((void *)0)
# 1465 "../providers/implementations/kdfs/argon2.c"
                                                                               ) {
        if (p->data_type != 4
                                                        ...
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("pass")), (5), ((
# 1478 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1478 "../providers/implementations/kdfs/argon2.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 1479 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1479 "../providers/implementations/kdfs/argon2.c"
       )), (0), ((size_t)-1) },
        { (("secret")), (5), ((
# 1480 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1480 "../providers/implementations/kdfs/argon2.c"
       )), (0), ((size_t)-1) },
        { (("ad")), (5), ((
# 1481 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1481 "../providers/implementations/kdfs/argon2.c"
       )), (0), ((size_t)-1) },
        { (("size")), (2), ((
# 1482 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1482 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("iter")), (2), ((
# 1483 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1483 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("threads")), (2), ((
# 1484 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1484 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("lanes")), (2), ((
# 1485 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1485 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("memcost")), (2), ((
# 1486 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1486 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("early_clean")), (2), ((
# 1487 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1487 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("version")), (2), ((
# 1488 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1488 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(uint32_t)), ((size_t)-1) },
        { (("properties")), (4), ((
# 1489 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1489 "../providers/implementations/kdfs/argon2.c"
       )), (0), ((size_t)-1) },
        { 
# 1490 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1490 "../providers/implementations/kdfs/argon2.c"
       , 0, 
# 1490 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1490 "../providers/implementations/kdfs/argon2.c"
...
static int kdf_argon2_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    (void) vctx;
    if ((p = OSSL_PARAM_locate(params, "size")) != 
# 1501 "../providers/implementations/kdfs/argon2.c" 3 4
                                                               ((void *)0)
# 1501 "../providers/implementations/kdfs/argon2.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, 
# 1502 "../providers/implementations/kdfs/argon2.c" 3 4
                                       (18446744073709551615UL)
# 1502 "../providers/implementations/kdfs/argon2.c"
                                               );
                                                        ...
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 1511 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1511 "../providers/implementations/kdfs/argon2.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 1512 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1512 "../providers/implementations/kdfs/argon2.c"
       , 0, 
# 1512 "../providers/implementations/kdfs/argon2.c" 3 4
       ((void *)0)
# 1512 "../providers/implementations/kdfs/argon2.c"
...
const OSSL_DISPATCH ossl_kdf_argon2i_functions[] = {
    { 1, (void(*)(void))kdf_argon2i_new },
    { 3, (void(*)(void))kdf_argon2_free },
    { 4, (void(*)(void))kdf_argon2_reset },
    { 5, (void(*)(void))kdf_argon2_derive },
    { 8,
      (void(*)(void))kdf_argon2_settable_ctx_params },
    { 11, (void(*)(void))kdf_argon2_set_ctx_params },
    { 7,
      (void(*)(void))kdf_argon2_gettable_ctx_params },
    { 10, (void(*)(void))kdf_argon2_get_ctx_params },
    { 0, 
# 1529 "../providers/implementations/kdfs/argon2.c" 3 4
   ((void *)0) 
# 1529 "../providers/implementations/kdfs/argon2.c"
   }
};

const OSSL_DISPATCH ossl_kdf_argon2d_functions[] = {
    { 1, (void(*)(void))kdf_argon2d_new },
    { 3, (void(*)(void))kdf_argon2_free },
    { 4, (void(*)(void))kdf_argon2_reset },
    { 5, (void(*)(void))kdf_argon2_derive },
    { 8,
    ...
    { 10, (void(*)(void))kdf_argon2_get_ctx_params },
    { 0, 
# 1543 "../providers/implementations/kdfs/argon2.c" 3 4
   ((void *)0) 
# 1543 "../providers/implementations/kdfs/argon2.c"
   }
};

const OSSL_DISPATCH ossl_kdf_argon2id_functions[] = {
    { 1, (void(*)(void))kdf_argon2id_new },
    { 3, (void(*)(void))kdf_argon2_free },
    { 4, (void(*)(void))kdf_argon2_reset },
    { 5, (void(*)(void))kdf_argon2_derive },
    { 8,
    ...
    { 10, (void(*)(void))kdf_argon2_get_ctx_params },
    { 0, 
# 1557 "../providers/implementations/kdfs/argon2.c" 3 4
   ((void *)0) 
# 1557 "../providers/implementations/kdfs/argon2.c"
   }
};
