# 0 "../providers/implementations/kdfs/pvkkdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/pvkkdf.c"
# 10 "../providers/implementations/kdfs/pvkkdf.c"
...
# 11 "../providers/implementations/kdfs/pvkkdf.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 12 "../providers/implementations/kdfs/pvkkdf.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 13 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 14 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 15 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 16 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 17 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 18 "../providers/implementations/kdfs/pvkkdf.c" 2
...
# 19 "../providers/implementations/kdfs/pvkkdf.c" 2
...
static void *kdf_pvk_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 46 "../providers/implementations/kdfs/pvkkdf.c" 3 4
              ((void *)0)
# 46 "../providers/implementations/kdfs/pvkkdf.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/pvkkdf.c", 48);
    if (ctx == 
# 49 "../providers/implementations/kdfs/pvkkdf.c" 3 4
              ((void *)0)
# 49 "../providers/implementations/kdfs/pvkkdf.c"
                  )
        return 
# 50 "../providers/implementations/kdfs/pvkkdf.c" 3 4
              ((void *)0)
# 50 "../providers/implementations/kdfs/pvkkdf.c"
                  ;
    ctx->provctx = provctx;
    kdf_pvk_init(ctx);
    return ctx;
...
static void kdf_pvk_cleanup(KDF_PVK *ctx)
{
    ...
    CRYPTO_free(ctx->salt, "../providers/implementations/kdfs/pvkkdf.c", 59);
    CRYPTO_clear_free(ctx->pass, ctx->pass_len, "../providers/implementations/kdfs/pvkkdf.c", 60);
...
static void kdf_pvk_free(void *vctx)
{
    ...
    if (ctx != 
# 68 "../providers/implementations/kdfs/pvkkdf.c" 3 4
              ((void *)0)
# 68 "../providers/implementations/kdfs/pvkkdf.c"
                  ) {
        kdf_pvk_cleanup(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/pvkkdf.c", 70);
    }
}
...
static void *kdf_pvk_dup(void *vctx)
{
    ...
    if (dest != 
# 80 "../providers/implementations/kdfs/pvkkdf.c" 3 4
               ((void *)0)
# 80 "../providers/implementations/kdfs/pvkkdf.c"
                   )
 ...
 err:
    kdf_pvk_free(dest);
    return 
# 91 "../providers/implementations/kdfs/pvkkdf.c" 3 4
          ((void *)0)
# 91 "../providers/implementations/kdfs/pvkkdf.c"
              ;
}
...
{
    OSSL_PARAM params[2] = { { 
# 106 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                            ((void *)0)
# 106 "../providers/implementations/kdfs/pvkkdf.c"
                            , 0, 
# 106 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                            ((void *)0)
# 106 "../providers/implementations/kdfs/pvkkdf.c"
...
static int pvk_set_membuf(unsigned char **buffer, size_t *buflen,
                             const OSSL_PARAM *p)
{
    CRYPTO_clear_free(*buffer, *buflen, "../providers/implementations/kdfs/pvkkdf.c", 119);
    *buffer = 
# 120 "../providers/implementations/kdfs/pvkkdf.c" 3 4
             ((void *)0)
# 120 "../providers/implementations/kdfs/pvkkdf.c"
                 ;
    *buflen = 0;

    if (p->data_size == 0) {
        if ((*buffer = CRYPTO_malloc(1, "../providers/implementations/kdfs/pvkkdf.c", 124)) == 
# 124 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                            ((void *)0)
# 124 "../providers/implementations/kdfs/pvkkdf.c"
                                                )
            return 0;
    } else if (p->data != 
# 126 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                         ((void *)0)
# 126 "../providers/implementations/kdfs/pvkkdf.c"
                             ) {
                             ...
                             const OSSL_PARAM params[])
{
    ...
    if (ctx->pass == 
# 144 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                    ((void *)0)
# 144 "../providers/implementations/kdfs/pvkkdf.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pvkkdf.c",145,__func__), ERR_set_error)((57),(130),
# 145 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 145 "../providers/implementations/kdfs/pvkkdf.c"
       );
        return 0;
    }

    if (ctx->salt == 
# 149 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                    ((void *)0)
# 149 "../providers/implementations/kdfs/pvkkdf.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pvkkdf.c",150,__func__), ERR_set_error)((57),(131),
# 150 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 150 "../providers/implementations/kdfs/pvkkdf.c"
       );
        return 0;
    }
    ...
    if (md == 
# 155 "../providers/implementations/kdfs/pvkkdf.c" 3 4
             ((void *)0)
# 155 "../providers/implementations/kdfs/pvkkdf.c"
                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pvkkdf.c",156,__func__), ERR_set_error)((57),(122),
# 156 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 156 "../providers/implementations/kdfs/pvkkdf.c"
       );
        return 0;
    }
    res = EVP_MD_get_size(md);
    if (res <= 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pvkkdf.c",161,__func__), ERR_set_error)((57),(142),
# 161 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 161 "../providers/implementations/kdfs/pvkkdf.c"
       );
        return 0;
    }
    if ((size_t)res > keylen) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pvkkdf.c",165,__func__), ERR_set_error)((57),(202),
# 165 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 165 "../providers/implementations/kdfs/pvkkdf.c"
       );
        return 0;
    }
    ...
    mctx = EVP_MD_CTX_new();
    res = mctx != 
# 170 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                 ((void *)0)
          
# 171 "../providers/implementations/kdfs/pvkkdf.c"
         && EVP_DigestInit_ex(mctx, md, 
# 171 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                        ((void *)0)
# 171 "../providers/implementations/kdfs/pvkkdf.c"
                                            )
...
# 174 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                          ((void *)0)
# 174 "../providers/implementations/kdfs/pvkkdf.c"
                                              );
...
static int kdf_pvk_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 185 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                 ((void *)0)
# 185 "../providers/implementations/kdfs/pvkkdf.c"
                     )
        return 1;
...
# 191 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                                                         ((void *)0)
# 191 "../providers/implementations/kdfs/pvkkdf.c"
                                                                             )
        if (!pvk_set_membuf(&ctx->pass, &ctx->pass_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "salt")) != 
# 195 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                                                     ((void *)0)
# 195 "../providers/implementations/kdfs/pvkkdf.c"
                                                                         ) {
...
static const OSSL_PARAM *kdf_pvk_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("properties")), (4), ((
# 207 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 207 "../providers/implementations/kdfs/pvkkdf.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 208 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 208 "../providers/implementations/kdfs/pvkkdf.c"
       )), (0), ((size_t)-1) },
        { (("pass")), (5), ((
# 209 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 209 "../providers/implementations/kdfs/pvkkdf.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 210 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 210 "../providers/implementations/kdfs/pvkkdf.c"
       )), (0), ((size_t)-1) },
        { 
# 211 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 211 "../providers/implementations/kdfs/pvkkdf.c"
       , 0, 
# 211 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 211 "../providers/implementations/kdfs/pvkkdf.c"
...
# 220 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                                               ((void *)0)
# 220 "../providers/implementations/kdfs/pvkkdf.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, 
# 221 "../providers/implementations/kdfs/pvkkdf.c" 3 4
                                       (18446744073709551615UL)
# 221 "../providers/implementations/kdfs/pvkkdf.c"
                                               );
    return -2;
}

static const OSSL_PARAM *kdf_pvk_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 229 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 229 "../providers/implementations/kdfs/pvkkdf.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 230 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 230 "../providers/implementations/kdfs/pvkkdf.c"
       , 0, 
# 230 "../providers/implementations/kdfs/pvkkdf.c" 3 4
       ((void *)0)
# 230 "../providers/implementations/kdfs/pvkkdf.c"
...
const OSSL_DISPATCH ossl_kdf_pvk_functions[] = {
    { 1, (void(*)(void))kdf_pvk_new },
    { 2, (void(*)(void))kdf_pvk_dup },
    { 3, (void(*)(void))kdf_pvk_free },
    { 4, (void(*)(void))kdf_pvk_reset },
    { 5, (void(*)(void))kdf_pvk_derive },
    { 8,
      (void(*)(void))kdf_pvk_settable_ctx_params },
    { 11, (void(*)(void))kdf_pvk_set_ctx_params },
    { 7,
      (void(*)(void))kdf_pvk_gettable_ctx_params },
    { 10, (void(*)(void))kdf_pvk_get_ctx_params },
    { 0, 
# 247 "../providers/implementations/kdfs/pvkkdf.c" 3 4
   ((void *)0) 
# 247 "../providers/implementations/kdfs/pvkkdf.c"
   }
};
