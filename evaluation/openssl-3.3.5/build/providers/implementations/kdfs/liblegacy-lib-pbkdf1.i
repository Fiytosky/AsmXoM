# 0 "../providers/implementations/kdfs/pbkdf1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/pbkdf1.c"
# 10 "../providers/implementations/kdfs/pbkdf1.c"
...
# 11 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 14 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 15 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 16 "../providers/implementations/kdfs/pbkdf1.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 17 "../providers/implementations/kdfs/pbkdf1.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 18 "../providers/implementations/kdfs/pbkdf1.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 19 "../providers/implementations/kdfs/pbkdf1.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 21 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 22 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 23 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 24 "../providers/implementations/kdfs/pbkdf1.c" 2
...
# 25 "../providers/implementations/kdfs/pbkdf1.c" 2
                                ...
                                unsigned char *out, size_t n)
{
    ...
    EVP_MD_CTX *ctx = 
# 59 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                     ((void *)0)
# 59 "../providers/implementations/kdfs/pbkdf1.c"
                         ;

    ctx = EVP_MD_CTX_new();
    if (ctx == 
# 62 "../providers/implementations/kdfs/pbkdf1.c" 3 4
              ((void *)0)
# 62 "../providers/implementations/kdfs/pbkdf1.c"
                  ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pbkdf1.c",63,__func__), ERR_set_error)((57),((6 | (0x2 << 18L))),
# 63 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 63 "../providers/implementations/kdfs/pbkdf1.c"
       );
        goto err;
    }

    if (!EVP_DigestInit_ex(ctx, md_type, 
# 67 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                        ((void *)0)
# 67 "../providers/implementations/kdfs/pbkdf1.c"
                                            )
        || !EVP_DigestUpdate(ctx, pass, passlen)
        || !EVP_DigestUpdate(ctx, salt, saltlen)
        || !EVP_DigestFinal_ex(ctx, md_tmp, 
# 70 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                           ((void *)0)
# 70 "../providers/implementations/kdfs/pbkdf1.c"
                                               ))
        goto err;
    mdsize = EVP_MD_get_size(md_type);
    if (mdsize < 0)
        goto err;
    if (n > (size_t)mdsize) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pbkdf1.c",76,__func__), ERR_set_error)((57),(202),
# 76 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 76 "../providers/implementations/kdfs/pbkdf1.c"
       );
        goto err;
    }
    ...
    for (i = 1; i < iter; i++) {
        if (!EVP_DigestInit_ex(ctx, md_type, 
# 81 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                            ((void *)0)
# 81 "../providers/implementations/kdfs/pbkdf1.c"
                                                ))
            goto err;
        if (!EVP_DigestUpdate(ctx, md_tmp, mdsize))
            goto err;
        if (!EVP_DigestFinal_ex(ctx, md_tmp, 
# 85 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                            ((void *)0)
# 85 "../providers/implementations/kdfs/pbkdf1.c"
                                                ))
            goto err;
    }
...
static void *kdf_pbkdf1_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 102 "../providers/implementations/kdfs/pbkdf1.c" 3 4
              ((void *)0)
# 102 "../providers/implementations/kdfs/pbkdf1.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/pbkdf1.c", 104);
    if (ctx == 
# 105 "../providers/implementations/kdfs/pbkdf1.c" 3 4
              ((void *)0)
# 105 "../providers/implementations/kdfs/pbkdf1.c"
                  )
        return 
# 106 "../providers/implementations/kdfs/pbkdf1.c" 3 4
              ((void *)0)
# 106 "../providers/implementations/kdfs/pbkdf1.c"
                  ;
    ctx->provctx = provctx;
    return ctx;
}
...
static void kdf_pbkdf1_cleanup(KDF_PBKDF1 *ctx)
{
    ...
    CRYPTO_free(ctx->salt, "../providers/implementations/kdfs/pbkdf1.c", 114);
    CRYPTO_clear_free(ctx->pass, ctx->pass_len, "../providers/implementations/kdfs/pbkdf1.c", 115);
...
static void kdf_pbkdf1_free(void *vctx)
{
    ...
    if (ctx != 
# 123 "../providers/implementations/kdfs/pbkdf1.c" 3 4
              ((void *)0)
# 123 "../providers/implementations/kdfs/pbkdf1.c"
                  ) {
        kdf_pbkdf1_cleanup(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/pbkdf1.c", 125);
    }
}
...
static void *kdf_pbkdf1_dup(void *vctx)
{
    ...
    if (dest != 
# 144 "../providers/implementations/kdfs/pbkdf1.c" 3 4
               ((void *)0)
# 144 "../providers/implementations/kdfs/pbkdf1.c"
                   ) {
 ...
 err:
    ...
    return 
# 157 "../providers/implementations/kdfs/pbkdf1.c" 3 4
          ((void *)0)
# 157 "../providers/implementations/kdfs/pbkdf1.c"
              ;
}
...
static int kdf_pbkdf1_set_membuf(unsigned char **buffer, size_t *buflen,
                             const OSSL_PARAM *p)
{
    CRYPTO_clear_free(*buffer, *buflen, "../providers/implementations/kdfs/pbkdf1.c", 163);
    *buffer = 
# 164 "../providers/implementations/kdfs/pbkdf1.c" 3 4
             ((void *)0)
# 164 "../providers/implementations/kdfs/pbkdf1.c"
                 ;
    *buflen = 0;

    if (p->data_size == 0) {
        if ((*buffer = CRYPTO_malloc(1, "../providers/implementations/kdfs/pbkdf1.c", 168)) == 
# 168 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                            ((void *)0)
# 168 "../providers/implementations/kdfs/pbkdf1.c"
                                                )
            return 0;
    } else if (p->data != 
# 170 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                         ((void *)0)
# 170 "../providers/implementations/kdfs/pbkdf1.c"
                             ) {
                             ...
                             const OSSL_PARAM params[])
{
    ...
    if (ctx->pass == 
# 186 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                    ((void *)0)
# 186 "../providers/implementations/kdfs/pbkdf1.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pbkdf1.c",187,__func__), ERR_set_error)((57),(130),
# 187 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 187 "../providers/implementations/kdfs/pbkdf1.c"
       );
        return 0;
    }

    if (ctx->salt == 
# 191 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                    ((void *)0)
# 191 "../providers/implementations/kdfs/pbkdf1.c"
                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/pbkdf1.c",192,__func__), ERR_set_error)((57),(131),
# 192 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 192 "../providers/implementations/kdfs/pbkdf1.c"
       );
        return 0;
    }
...
# 210 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                                                         ((void *)0)
# 210 "../providers/implementations/kdfs/pbkdf1.c"
                                                                             )
        if (!kdf_pbkdf1_set_membuf(&ctx->pass, &ctx->pass_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "salt")) != 
# 214 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                                                     ((void *)0)
# 214 "../providers/implementations/kdfs/pbkdf1.c"
                                                                         )
        if (!kdf_pbkdf1_set_membuf(&ctx->salt, &ctx->salt_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "iter")) != 
# 218 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                                                     ((void *)0)
# 218 "../providers/implementations/kdfs/pbkdf1.c"
                                                                         )
...
static const OSSL_PARAM *kdf_pbkdf1_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("properties")), (4), ((
# 228 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 228 "../providers/implementations/kdfs/pbkdf1.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 229 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 229 "../providers/implementations/kdfs/pbkdf1.c"
       )), (0), ((size_t)-1) },
        { (("pass")), (5), ((
# 230 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 230 "../providers/implementations/kdfs/pbkdf1.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 231 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 231 "../providers/implementations/kdfs/pbkdf1.c"
       )), (0), ((size_t)-1) },
        { (("iter")), (2), ((
# 232 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 232 "../providers/implementations/kdfs/pbkdf1.c"
       )), (sizeof(uint64_t)), ((size_t)-1) },
        { 
# 233 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 233 "../providers/implementations/kdfs/pbkdf1.c"
       , 0, 
# 233 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 233 "../providers/implementations/kdfs/pbkdf1.c"
...
# 242 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                                               ((void *)0)
# 242 "../providers/implementations/kdfs/pbkdf1.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, 
# 243 "../providers/implementations/kdfs/pbkdf1.c" 3 4
                                       (18446744073709551615UL)
# 243 "../providers/implementations/kdfs/pbkdf1.c"
                                               );
    return -2;
}

static const OSSL_PARAM *kdf_pbkdf1_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 251 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 251 "../providers/implementations/kdfs/pbkdf1.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 252 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 252 "../providers/implementations/kdfs/pbkdf1.c"
       , 0, 
# 252 "../providers/implementations/kdfs/pbkdf1.c" 3 4
       ((void *)0)
# 252 "../providers/implementations/kdfs/pbkdf1.c"
...
const OSSL_DISPATCH ossl_kdf_pbkdf1_functions[] = {
    { 1, (void(*)(void))kdf_pbkdf1_new },
    { 2, (void(*)(void))kdf_pbkdf1_dup },
    { 3, (void(*)(void))kdf_pbkdf1_free },
    { 4, (void(*)(void))kdf_pbkdf1_reset },
    { 5, (void(*)(void))kdf_pbkdf1_derive },
    { 8,
      (void(*)(void))kdf_pbkdf1_settable_ctx_params },
    { 11, (void(*)(void))kdf_pbkdf1_set_ctx_params },
    { 7,
      (void(*)(void))kdf_pbkdf1_gettable_ctx_params },
    { 10, (void(*)(void))kdf_pbkdf1_get_ctx_params },
    { 0, 
# 269 "../providers/implementations/kdfs/pbkdf1.c" 3 4
   ((void *)0) 
# 269 "../providers/implementations/kdfs/pbkdf1.c"
   }
};
