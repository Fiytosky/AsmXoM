# 0 "../providers/implementations/kdfs/sskdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/sskdf.c"
# 37 "../providers/implementations/kdfs/sskdf.c"
...
# 38 "../providers/implementations/kdfs/sskdf.c" 2
...
# 39 "../providers/implementations/kdfs/sskdf.c" 2
...
# 40 "../providers/implementations/kdfs/sskdf.c" 2
...
# 41 "../providers/implementations/kdfs/sskdf.c" 2
...
# 43 "../providers/implementations/kdfs/sskdf.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 44 "../providers/implementations/kdfs/sskdf.c" 2

# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 46 "../providers/implementations/kdfs/sskdf.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 47 "../providers/implementations/kdfs/sskdf.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 49 "../providers/implementations/kdfs/sskdf.c" 2
...
# 50 "../providers/implementations/kdfs/sskdf.c" 2
...
# 51 "../providers/implementations/kdfs/sskdf.c" 2
...
# 52 "../providers/implementations/kdfs/sskdf.c" 2
...
# 53 "../providers/implementations/kdfs/sskdf.c" 2
...
int ossl_param_get1_concat_octet_string(const OSSL_PARAM *params, const char *name,
                                        unsigned char **out, size_t *out_len,
                                        size_t maxsize);
# 54 "../providers/implementations/kdfs/sskdf.c" 2
...
# 96 "../providers/implementations/kdfs/sskdf.c"
                          ...
                          unsigned char *derived_key, size_t derived_key_len)
{
    ...
    EVP_MD_CTX *ctx = 
# 107 "../providers/implementations/kdfs/sskdf.c" 3 4
                     ((void *)0)
# 107 "../providers/implementations/kdfs/sskdf.c"
                         , *ctx_init = 
# 107 "../providers/implementations/kdfs/sskdf.c" 3 4
                                       ((void *)0)
# 107 "../providers/implementations/kdfs/sskdf.c"
    ...
    if (z_len > (1<<30) || info_len > (1<<30)
            || derived_key_len > (1<<30)
            || derived_key_len == 0)
        return 0;
    ...
    if (ctx == 
# 121 "../providers/implementations/kdfs/sskdf.c" 3 4
              ((void *)0) 
# 121 "../providers/implementations/kdfs/sskdf.c"
                   || ctx_init == 
# 121 "../providers/implementations/kdfs/sskdf.c" 3 4
                                  ((void *)0)
# 121 "../providers/implementations/kdfs/sskdf.c"
    ...
    for (counter = 1;; counter++) {
        ...
        if (!(EVP_MD_CTX_copy_ex(ctx, ctx_init)
            ...
            goto end;
        if (len >= out_len) {
            if (!EVP_DigestFinal_ex(ctx, out, 
# 140 "../providers/implementations/kdfs/sskdf.c" 3 4
                                             ((void *)0)
# 140 "../providers/implementations/kdfs/sskdf.c"
                                                 ))
                goto end;
            out += out_len;
            len -= out_len;
            ...
            if (!EVP_DigestFinal_ex(ctx, mac, 
# 147 "../providers/implementations/kdfs/sskdf.c" 3 4
                                             ((void *)0)
# 147 "../providers/implementations/kdfs/sskdf.c"
                                                 ))
                goto end;
            memcpy(out, mac, len);
            break;
                     ...
                     size_t derived_key_len, unsigned char **out)
{
    ...
    if (custom == 
# 168 "../providers/implementations/kdfs/sskdf.c" 3 4
                 ((void *)0)
# 168 "../providers/implementations/kdfs/sskdf.c"
                     )
        return 1;
    ...
    if (kmac_out_len > 64) {
        *out = CRYPTO_zalloc(kmac_out_len, "../providers/implementations/kdfs/sskdf.c", 201);
        if (*out == 
# 202 "../providers/implementations/kdfs/sskdf.c" 3 4
                   ((void *)0)
# 202 "../providers/implementations/kdfs/sskdf.c"
                       )
            return 0;
    }
    return 1;
                         ...
                         unsigned char *derived_key, size_t derived_key_len)
{
    ...
    unsigned char *out = derived_key;
    EVP_MAC_CTX *ctx = 
# 227 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 227 "../providers/implementations/kdfs/sskdf.c"
                          ;
    unsigned char *mac = mac_buf, *kmac_buffer = 
# 228 "../providers/implementations/kdfs/sskdf.c" 3 4
                                                ((void *)0)
# 228 "../providers/implementations/kdfs/sskdf.c"
                                                    ;
    ...
    if (!kmac_init(ctx_init, kmac_custom, kmac_custom_len, kmac_out_len,
        ...
        goto end;
    if (kmac_buffer != 
# 238 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 238 "../providers/implementations/kdfs/sskdf.c"
                          )
        mac = kmac_buffer;

    if (!EVP_MAC_init(ctx_init, salt, salt_len, 
# 241 "../providers/implementations/kdfs/sskdf.c" 3 4
                                               ((void *)0)
# 241 "../providers/implementations/kdfs/sskdf.c"
                                                   ))
        goto end;

    out_len = EVP_MAC_CTX_get_mac_size(ctx_init);
    ...
    for (counter = 1;; counter++) {
        ...
        if (!(ctx != 
# 256 "../providers/implementations/kdfs/sskdf.c" 3 4
                    ((void *)0)
                
# 257 "../providers/implementations/kdfs/sskdf.c"
               && EVP_MAC_update(ctx, c, sizeof(c))
                && EVP_MAC_update(ctx, z, z_len)
                && EVP_MAC_update(ctx, info, info_len)))
            goto end;
        if (len >= out_len) {
            if (!EVP_MAC_final(ctx, out, 
# 262 "../providers/implementations/kdfs/sskdf.c" 3 4
                                        ((void *)0)
# 262 "../providers/implementations/kdfs/sskdf.c"
                                            , len))
                goto end;
            out += out_len;
            len -= out_len;
            ...
            if (!EVP_MAC_final(ctx, mac, 
# 269 "../providers/implementations/kdfs/sskdf.c" 3 4
                                        ((void *)0)
# 269 "../providers/implementations/kdfs/sskdf.c"
                                            , out_len))
                goto end;
            memcpy(out, mac, len);
            break;
        ...
        ctx = 
# 275 "../providers/implementations/kdfs/sskdf.c" 3 4
             ((void *)0)
# 275 "../providers/implementations/kdfs/sskdf.c"
                 ;
    }
    ret = 1;
end:
    if (kmac_buffer != 
# 279 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 279 "../providers/implementations/kdfs/sskdf.c"
                          )
        CRYPTO_clear_free(kmac_buffer, kmac_out_len, "../providers/implementations/kdfs/sskdf.c", 280);
    else
...
static void *sskdf_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 293 "../providers/implementations/kdfs/sskdf.c" 3 4
              ((void *)0)
# 293 "../providers/implementations/kdfs/sskdf.c"
                  ;

    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/sskdf.c", 295)) != 
# 295 "../providers/implementations/kdfs/sskdf.c" 3 4
                                               ((void *)0)
# 295 "../providers/implementations/kdfs/sskdf.c"
                                                   )
        ctx->provctx = provctx;
    return ctx;
}
...
static void sskdf_reset(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx->secret, ctx->secret_len, "../providers/implementations/kdfs/sskdf.c", 307);
    CRYPTO_clear_free(ctx->info, ctx->info_len, "../providers/implementations/kdfs/sskdf.c", 308);
    CRYPTO_clear_free(ctx->salt, ctx->salt_len, "../providers/implementations/kdfs/sskdf.c", 309);
...
static void sskdf_free(void *vctx)
{
    ...
    if (ctx != 
# 318 "../providers/implementations/kdfs/sskdf.c" 3 4
              ((void *)0)
# 318 "../providers/implementations/kdfs/sskdf.c"
                  ) {
        sskdf_reset(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/sskdf.c", 320);
    }
}
...
static void *sskdf_dup(void *vctx)
{
    ...
    if (dest != 
# 330 "../providers/implementations/kdfs/sskdf.c" 3 4
               ((void *)0)
# 330 "../providers/implementations/kdfs/sskdf.c"
                   ) {
        if (src->macctx != 
# 331 "../providers/implementations/kdfs/sskdf.c" 3 4
                          ((void *)0)
# 331 "../providers/implementations/kdfs/sskdf.c"
                              ) {
            dest->macctx = EVP_MAC_CTX_dup(src->macctx);
            if (dest->macctx == 
# 333 "../providers/implementations/kdfs/sskdf.c" 3 4
                               ((void *)0)
# 333 "../providers/implementations/kdfs/sskdf.c"
                                   )
                goto err;
        }
 ...
 err:
    sskdf_free(dest);
    return 
# 351 "../providers/implementations/kdfs/sskdf.c" 3 4
          ((void *)0)
# 351 "../providers/implementations/kdfs/sskdf.c"
              ;
}
...
static size_t sskdf_size(KDF_SSKDF *ctx)
{
    int len;
    const EVP_MD *md = 
# 357 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 357 "../providers/implementations/kdfs/sskdf.c"
                          ;

    if (ctx->is_kmac)
        return 
# 360 "../providers/implementations/kdfs/sskdf.c" 3 4
              (18446744073709551615UL)
# 360 "../providers/implementations/kdfs/sskdf.c"
                      ;

    md = ossl_prov_digest_md(&ctx->digest);
    if (md == 
# 363 "../providers/implementations/kdfs/sskdf.c" 3 4
             ((void *)0)
# 363 "../providers/implementations/kdfs/sskdf.c"
                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",364,__func__), ERR_set_error)((57),(129),
# 364 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 364 "../providers/implementations/kdfs/sskdf.c"
       );
        return 0;
    }
                        ...
                        const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_is_running() || !sskdf_set_ctx_params(ctx, params))
        return 0;
    if (ctx->secret == 
# 379 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 379 "../providers/implementations/kdfs/sskdf.c"
                          ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",380,__func__), ERR_set_error)((57),(132),
# 380 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 380 "../providers/implementations/kdfs/sskdf.c"
       );
        return 0;
    }
    md = ossl_prov_digest_md(&ctx->digest);
    ...
    if (ctx->macctx != 
# 385 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 385 "../providers/implementations/kdfs/sskdf.c"
                          ) {

        int ret;
        const unsigned char *custom = 
# 388 "../providers/implementations/kdfs/sskdf.c" 3 4
                                     ((void *)0)
# 388 "../providers/implementations/kdfs/sskdf.c"
                                         ;
        size_t custom_len = 0;
        int default_salt_len;
        EVP_MAC *mac = EVP_MAC_CTX_get0_mac(ctx->macctx);

        if (EVP_MAC_is_a(mac, "HMAC")) {

            if (md == 
# 395 "../providers/implementations/kdfs/sskdf.c" 3 4
                     ((void *)0)
# 395 "../providers/implementations/kdfs/sskdf.c"
                         ) {
                (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",396,__func__), ERR_set_error)((57),(129),
# 396 "../providers/implementations/kdfs/sskdf.c" 3 4
               ((void *)0)
# 396 "../providers/implementations/kdfs/sskdf.c"
               );
                return 0;
            }
            ...
            if (EVP_MAC_is_a(mac, "KMAC128"))
                default_salt_len = (168 - 4);
            else
                default_salt_len = (136 - 4);
        } else {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",411,__func__), ERR_set_error)((57),(137),
# 411 "../providers/implementations/kdfs/sskdf.c" 3 4
           ((void *)0)
# 411 "../providers/implementations/kdfs/sskdf.c"
           );
            return 0;
        }

        if (ctx->salt == 
# 415 "../providers/implementations/kdfs/sskdf.c" 3 4
                        ((void *)0) 
# 415 "../providers/implementations/kdfs/sskdf.c"
                             || ctx->salt_len <= 0) {
            ctx->salt = CRYPTO_zalloc(default_salt_len, "../providers/implementations/kdfs/sskdf.c", 416);
            if (ctx->salt == 
# 417 "../providers/implementations/kdfs/sskdf.c" 3 4
                            ((void *)0)
# 417 "../providers/implementations/kdfs/sskdf.c"
                                )
                return 0;
        ...
        if (md == 
# 429 "../providers/implementations/kdfs/sskdf.c" 3 4
                 ((void *)0)
# 429 "../providers/implementations/kdfs/sskdf.c"
                     ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",430,__func__), ERR_set_error)((57),(129),
# 430 "../providers/implementations/kdfs/sskdf.c" 3 4
           ((void *)0)
# 430 "../providers/implementations/kdfs/sskdf.c"
           );
            return 0;
        }
                          ...
                          const OSSL_PARAM params[])
{
    ...
    if (ctx->secret == 
# 447 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 447 "../providers/implementations/kdfs/sskdf.c"
                          ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",448,__func__), ERR_set_error)((57),(132),
# 448 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 448 "../providers/implementations/kdfs/sskdf.c"
       );
        return 0;
    }

    if (ctx->macctx != 
# 452 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 452 "../providers/implementations/kdfs/sskdf.c"
                          ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",453,__func__), ERR_set_error)((57),(136),
# 453 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 453 "../providers/implementations/kdfs/sskdf.c"
       );
        return 0;
    }
    ...
    md = ossl_prov_digest_md(&ctx->digest);
    if (md == 
# 459 "../providers/implementations/kdfs/sskdf.c" 3 4
             ((void *)0)
# 459 "../providers/implementations/kdfs/sskdf.c"
                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sskdf.c",460,__func__), ERR_set_error)((57),(129),
# 460 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 460 "../providers/implementations/kdfs/sskdf.c"
       );
        return 0;
    }
...
static int sskdf_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 476 "../providers/implementations/kdfs/sskdf.c" 3 4
                 ((void *)0)
# 476 "../providers/implementations/kdfs/sskdf.c"
                     )
        return 1;

    if (!ossl_prov_macctx_load_from_params(&ctx->macctx, params,
                                           
# 480 "../providers/implementations/kdfs/sskdf.c" 3 4
                                          ((void *)0)
# 480 "../providers/implementations/kdfs/sskdf.c"
                                              , 
# 480 "../providers/implementations/kdfs/sskdf.c" 3 4
                                                ((void *)0)
# 480 "../providers/implementations/kdfs/sskdf.c"
...
# 480 "../providers/implementations/kdfs/sskdf.c"
        ...
        return 0;
    if (ctx->macctx != 
# 482 "../providers/implementations/kdfs/sskdf.c" 3 4
                      ((void *)0)
# 482 "../providers/implementations/kdfs/sskdf.c"
                          ) {
    ...
    r = ossl_param_get1_octet_string(params, "secret",
                                     &ctx->secret, &ctx->secret_len);
    if (r == -1)
        r = ossl_param_get1_octet_string(params, "key",
                                         &ctx->secret, &ctx->secret_len);
    if (r == 0)
        return 0;
    ...
    if (ossl_param_get1_octet_string(params, "salt",
                                     &ctx->salt, &ctx->salt_len) == 0)
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "maclen"))
        != 
# 511 "../providers/implementations/kdfs/sskdf.c" 3 4
          ((void *)0)
# 511 "../providers/implementations/kdfs/sskdf.c"
              ) {
...
static const OSSL_PARAM *sskdf_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                   __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("secret")), (5), ((
# 523 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 523 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("key")), (5), ((
# 524 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 524 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("info")), (5), ((
# 525 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 525 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("properties")), (4), ((
# 526 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 526 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 527 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 527 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("mac")), (4), ((
# 528 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 528 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 529 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 529 "../providers/implementations/kdfs/sskdf.c"
       )), (0), ((size_t)-1) },
        { (("maclen")), (2), ((
# 530 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 530 "../providers/implementations/kdfs/sskdf.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 531 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 531 "../providers/implementations/kdfs/sskdf.c"
       , 0, 
# 531 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 531 "../providers/implementations/kdfs/sskdf.c"
...
# 541 "../providers/implementations/kdfs/sskdf.c" 3 4
                                                               ((void *)0)
# 541 "../providers/implementations/kdfs/sskdf.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, sskdf_size(ctx));
    return -2;
}

static const OSSL_PARAM *sskdf_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                   __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 550 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 550 "../providers/implementations/kdfs/sskdf.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 551 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 551 "../providers/implementations/kdfs/sskdf.c"
       , 0, 
# 551 "../providers/implementations/kdfs/sskdf.c" 3 4
       ((void *)0)
# 551 "../providers/implementations/kdfs/sskdf.c"
...
const OSSL_DISPATCH ossl_kdf_sskdf_functions[] = {
    { 1, (void(*)(void))sskdf_new },
    { 2, (void(*)(void))sskdf_dup },
    { 3, (void(*)(void))sskdf_free },
    { 4, (void(*)(void))sskdf_reset },
    { 5, (void(*)(void))sskdf_derive },
    { 8,
      (void(*)(void))sskdf_settable_ctx_params },
    { 11, (void(*)(void))sskdf_set_ctx_params },
    { 7,
      (void(*)(void))sskdf_gettable_ctx_params },
    { 10, (void(*)(void))sskdf_get_ctx_params },
    { 0, 
# 568 "../providers/implementations/kdfs/sskdf.c" 3 4
   ((void *)0) 
# 568 "../providers/implementations/kdfs/sskdf.c"
   }
};
...
const OSSL_DISPATCH ossl_kdf_x963_kdf_functions[] = {
    ...
    { 10, (void(*)(void))sskdf_get_ctx_params },
    { 0, 
# 583 "../providers/implementations/kdfs/sskdf.c" 3 4
   ((void *)0) 
# 583 "../providers/implementations/kdfs/sskdf.c"
   }
};
