# 0 "../providers/implementations/kdfs/kbkdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/kbkdf.c"
# 27 "../providers/implementations/kdfs/kbkdf.c"
...
# 28 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 29 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 30 "../providers/implementations/kdfs/kbkdf.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 32 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 33 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 34 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 35 "../providers/implementations/kdfs/kbkdf.c" 2

# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 37 "../providers/implementations/kdfs/kbkdf.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 39 "../providers/implementations/kdfs/kbkdf.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 40 "../providers/implementations/kdfs/kbkdf.c" 2

# 1 "../include/internal/endian.h" 1
# 12 "../include/internal/endian.h"
        
# 42 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 43 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 44 "../providers/implementations/kdfs/kbkdf.c" 2
...
# 45 "../providers/implementations/kdfs/kbkdf.c" 2
# 1 "../providers/common/include/prov/providercommon.h" 1
# 13 "../providers/common/include/prov/providercommon.h"
...
# 46 "../providers/implementations/kdfs/kbkdf.c" 2
...
int ossl_param_get1_concat_octet_string(const OSSL_PARAM *params, const char *name,
                                        unsigned char **out, size_t *out_len,
                                        size_t maxsize);
# 49 "../providers/implementations/kdfs/kbkdf.c" 2
...
static void *kbkdf_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 118 "../providers/implementations/kdfs/kbkdf.c" 3 4
              ((void *)0)
# 118 "../providers/implementations/kdfs/kbkdf.c"
                  ;

    ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/kbkdf.c", 120);
    if (ctx == 
# 121 "../providers/implementations/kdfs/kbkdf.c" 3 4
              ((void *)0)
# 121 "../providers/implementations/kdfs/kbkdf.c"
                  )
        return 
# 122 "../providers/implementations/kdfs/kbkdf.c" 3 4
              ((void *)0)
# 122 "../providers/implementations/kdfs/kbkdf.c"
                  ;
...
static void kbkdf_free(void *vctx)
{
    ...
    if (ctx != 
# 133 "../providers/implementations/kdfs/kbkdf.c" 3 4
              ((void *)0)
# 133 "../providers/implementations/kdfs/kbkdf.c"
                  ) {
        kbkdf_reset(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/kbkdf.c", 135);
    }
}
...
static void kbkdf_reset(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx->context, ctx->context_len, "../providers/implementations/kdfs/kbkdf.c", 145);
    CRYPTO_clear_free(ctx->label, ctx->label_len, "../providers/implementations/kdfs/kbkdf.c", 146);
    CRYPTO_clear_free(ctx->ki, ctx->ki_len, "../providers/implementations/kdfs/kbkdf.c", 147);
    CRYPTO_clear_free(ctx->iv, ctx->iv_len, "../providers/implementations/kdfs/kbkdf.c", 148);
...
static void *kbkdf_dup(void *vctx)
{
    ...
    if (dest != 
# 160 "../providers/implementations/kdfs/kbkdf.c" 3 4
               ((void *)0)
# 160 "../providers/implementations/kdfs/kbkdf.c"
                   ) {
        dest->ctx_init = EVP_MAC_CTX_dup(src->ctx_init);
        if (dest->ctx_init == 
# 162 "../providers/implementations/kdfs/kbkdf.c" 3 4
                             ((void *)0)
                
# 163 "../providers/implementations/kdfs/kbkdf.c"
 ...
 err:
    kbkdf_free(dest);
    return 
# 182 "../providers/implementations/kdfs/kbkdf.c" 3 4
          ((void *)0)
# 182 "../providers/implementations/kdfs/kbkdf.c"
              ;
}
                  ...
                  unsigned char *ko, size_t ko_len, int r)
{
    int ret = 0;
    EVP_MAC_CTX *ctx = 
# 193 "../providers/implementations/kdfs/kbkdf.c" 3 4
                      ((void *)0)
# 193 "../providers/implementations/kdfs/kbkdf.c"
                          ;
    size_t written = 0, to_write, k_i_len = iv_len;
    const unsigned char zero = 0;
    uint32_t counter, i;
# 207 "../providers/implementations/kdfs/kbkdf.c"
    int has_l = (l != 0);
    ...
    for (counter = 1; written < ko_len; counter++) {
        ...
        if (ctx == 
# 217 "../providers/implementations/kdfs/kbkdf.c" 3 4
                  ((void *)0)
# 217 "../providers/implementations/kdfs/kbkdf.c"
                      )
            goto done;
        ...
        if (!EVP_MAC_update(ctx, 4 - (r / 8) + (unsigned char *)&i, r / 8)
            ...
            || !EVP_MAC_final(ctx, k_i, 
# 229 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                       ((void *)0)
# 229 "../providers/implementations/kdfs/kbkdf.c"
                                           , h))
            goto done;

        to_write = ko_len - written;
        memcpy(ko + written, k_i, ((to_write) < (h)) ? (to_write) : (h));
        written += h;

        k_i_len = h;
        EVP_MAC_CTX_free(ctx);
        ctx = 
# 238 "../providers/implementations/kdfs/kbkdf.c" 3 4
             ((void *)0)
# 238 "../providers/implementations/kdfs/kbkdf.c"
                 ;
    }
...
static int kmac_init(EVP_MAC_CTX *ctx, const unsigned char *custom, size_t customlen)
{
    ...
    if (custom == 
# 252 "../providers/implementations/kdfs/kbkdf.c" 3 4
                 ((void *)0) 
# 252 "../providers/implementations/kdfs/kbkdf.c"
                      || customlen == 0)
        return 1;
                       ...
                       const unsigned char *context, size_t contextlen)
{
    ...
    params[0] = OSSL_PARAM_construct_size_t("size", &outlen);
    params[1] = OSSL_PARAM_construct_end();
    return EVP_MAC_CTX_set_params(ctx, params) > 0
           && EVP_MAC_update(ctx, context, contextlen)
           && EVP_MAC_final(ctx, out, 
# 269 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                     ((void *)0)
# 269 "../providers/implementations/kdfs/kbkdf.c"
                                         , outlen);
}
                        ...
                        const OSSL_PARAM params[])
{
    ...
    int ret = 0;
    unsigned char *k_i = 
# 277 "../providers/implementations/kdfs/kbkdf.c" 3 4
                        ((void *)0)
# 277 "../providers/implementations/kdfs/kbkdf.c"
                            ;
    uint32_t l = 0;
    size_t h = 0;
    ...
    if (ctx->ctx_init == 
# 287 "../providers/implementations/kdfs/kbkdf.c" 3 4
                        ((void *)0)
# 287 "../providers/implementations/kdfs/kbkdf.c"
                            ) {
        if (ctx->ki_len == 0 || ctx->ki == 
# 288 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                          ((void *)0)
# 288 "../providers/implementations/kdfs/kbkdf.c"
                                              ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",289,__func__), ERR_set_error)((57),(114),
# 289 "../providers/implementations/kdfs/kbkdf.c" 3 4
           ((void *)0)
# 289 "../providers/implementations/kdfs/kbkdf.c"
           );
            return 0;
        }


        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",294,__func__), ERR_set_error)((57),(150),
# 294 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 294 "../providers/implementations/kdfs/kbkdf.c"
       );
        return 0;
    }
    ...
    if (keylen == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",300,__func__), ERR_set_error)((57),(105),
# 300 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 300 "../providers/implementations/kdfs/kbkdf.c"
       );
        return 0;
    }
    ...
    if (ctx->iv_len != 0 && ctx->iv_len != h) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",315,__func__), ERR_set_error)((57),(154),
# 315 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 315 "../providers/implementations/kdfs/kbkdf.c"
       );
        goto done;
    }
    ...
    if (ctx->mode == COUNTER) {
        ...
        if ((uint64_t)(keylen / h) >= counter_max) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",323,__func__), ERR_set_error)((57),(105),
# 323 "../providers/implementations/kdfs/kbkdf.c" 3 4
           ((void *)0)
# 323 "../providers/implementations/kdfs/kbkdf.c"
           );
            goto done;
        }
    }
    ...
    k_i = CRYPTO_zalloc(h, "../providers/implementations/kdfs/kbkdf.c", 331);
    if (k_i == 
# 332 "../providers/implementations/kdfs/kbkdf.c" 3 4
              ((void *)0)
# 332 "../providers/implementations/kdfs/kbkdf.c"
                  )
        goto done;
    ...
    CRYPTO_clear_free(k_i, h, "../providers/implementations/kdfs/kbkdf.c", 341);
    return ret;
}
...
static int kbkdf_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 351 "../providers/implementations/kdfs/kbkdf.c" 3 4
                 ((void *)0)
# 351 "../providers/implementations/kdfs/kbkdf.c"
                     )
        return 1;

    if (!ossl_prov_macctx_load_from_params(&ctx->ctx_init, params, 
# 354 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                                                  ((void *)0)
# 354 "../providers/implementations/kdfs/kbkdf.c"
                                                                      ,
                                           
# 355 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                          ((void *)0)
# 355 "../providers/implementations/kdfs/kbkdf.c"
                                              , 
# 355 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                                ((void *)0)
# 355 "../providers/implementations/kdfs/kbkdf.c"
        ...
        return 0;
    if (ctx->ctx_init != 
# 357 "../providers/implementations/kdfs/kbkdf.c" 3 4
                        ((void *)0)
# 357 "../providers/implementations/kdfs/kbkdf.c"
                            ) {
        ctx->is_kmac = 0;
        if (EVP_MAC_is_a(EVP_MAC_CTX_get0_mac(ctx->ctx_init),
            ...
            ctx->is_kmac = 1;
                   ...
                   && !EVP_MAC_is_a(EVP_MAC_CTX_get0_mac(ctx->ctx_init),
                                    "CMAC")) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",368,__func__), ERR_set_error)((57),(151),
# 368 "../providers/implementations/kdfs/kbkdf.c" 3 4
           ((void *)0)
# 368 "../providers/implementations/kdfs/kbkdf.c"
           );
            return 0;
        }
    }
    ...
    if (p != 
# 374 "../providers/implementations/kdfs/kbkdf.c" 3 4
            ((void *)0)
        
# 375 "../providers/implementations/kdfs/kbkdf.c"
       && OPENSSL_strncasecmp("counter", p->data, p->data_size) == 0) {
        ctx->mode = COUNTER;
    } else if (p != 
# 377 "../providers/implementations/kdfs/kbkdf.c" 3 4
                   ((void *)0)
               
# 378 "../providers/implementations/kdfs/kbkdf.c"
              && OPENSSL_strncasecmp("feedback", p->data, p->data_size) == 0) {
        ctx->mode = FEEDBACK;
    } else if (p != 
# 380 "../providers/implementations/kdfs/kbkdf.c" 3 4
                   ((void *)0)
# 380 "../providers/implementations/kdfs/kbkdf.c"
                       ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/kbkdf.c",381,__func__), ERR_set_error)((57),(125),
# 381 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 381 "../providers/implementations/kdfs/kbkdf.c"
       );
        return 0;
    }

    if (ossl_param_get1_octet_string(params, "key",
                                     &ctx->ki, &ctx->ki_len) == 0)
            return 0;
    ...
    if (ossl_param_get1_octet_string(params, "seed",
                                     &ctx->iv, &ctx->iv_len) == 0)
            return 0;

    p = OSSL_PARAM_locate_const(params, "use-l");
    if (p != 
# 403 "../providers/implementations/kdfs/kbkdf.c" 3 4
            ((void *)0) 
# 403 "../providers/implementations/kdfs/kbkdf.c"
                 && !OSSL_PARAM_get_int(p, &ctx->use_l))
        return 0;

    p = OSSL_PARAM_locate_const(params, "r");
    if (p != 
# 407 "../providers/implementations/kdfs/kbkdf.c" 3 4
            ((void *)0)
# 407 "../providers/implementations/kdfs/kbkdf.c"
                ) {
        int new_r = 0;
    ...
    p = OSSL_PARAM_locate_const(params, "use-separator");
    if (p != 
# 418 "../providers/implementations/kdfs/kbkdf.c" 3 4
            ((void *)0) 
# 418 "../providers/implementations/kdfs/kbkdf.c"
                 && !OSSL_PARAM_get_int(p, &ctx->use_separator))
        return 0;


    if (ctx->ctx_init != 
# 422 "../providers/implementations/kdfs/kbkdf.c" 3 4
                        ((void *)0) 
# 422 "../providers/implementations/kdfs/kbkdf.c"
                             && ctx->ki_len != 0) {
        if ((ctx->is_kmac && !kmac_init(ctx->ctx_init, ctx->label, ctx->label_len))
            || !EVP_MAC_init(ctx->ctx_init, ctx->ki, ctx->ki_len, 
# 424 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                                                 ((void *)0)
# 424 "../providers/implementations/kdfs/kbkdf.c"
                                                                     ))
            return 0;
    }
    return 1;
...
static const OSSL_PARAM *kbkdf_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                   __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("info")), (5), ((
# 434 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 434 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("salt")), (5), ((
# 435 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 435 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("key")), (5), ((
# 436 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 436 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("seed")), (5), ((
# 437 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 437 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 438 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 438 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("cipher")), (4), ((
# 439 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 439 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("mac")), (4), ((
# 440 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 440 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("mode")), (4), ((
# 441 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 441 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("properties")), (4), ((
# 442 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 442 "../providers/implementations/kdfs/kbkdf.c"
       )), (0), ((size_t)-1) },
        { (("use-l")), (1), ((
# 443 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 443 "../providers/implementations/kdfs/kbkdf.c"
       )), (sizeof(int)), ((size_t)-1) },
        { (("use-separator")), (1), ((
# 444 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 444 "../providers/implementations/kdfs/kbkdf.c"
       )), (sizeof(int)), ((size_t)-1) },
        { (("r")), (1), ((
# 445 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 445 "../providers/implementations/kdfs/kbkdf.c"
       )), (sizeof(int)), ((size_t)-1) },
        { 
# 446 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 446 "../providers/implementations/kdfs/kbkdf.c"
       , 0, 
# 446 "../providers/implementations/kdfs/kbkdf.c" 3 4
       ((void *)0)
# 446 "../providers/implementations/kdfs/kbkdf.c"
...
static int kbkdf_get_ctx_params(void *vctx, OSSL_PARAM params[])
{
    ...
    if (p == 
# 456 "../providers/implementations/kdfs/kbkdf.c" 3 4
            ((void *)0)
# 456 "../providers/implementations/kdfs/kbkdf.c"
                )
        return -2;


    return OSSL_PARAM_set_size_t(p, 
# 460 "../providers/implementations/kdfs/kbkdf.c" 3 4
                                   (18446744073709551615UL)
# 460 "../providers/implementations/kdfs/kbkdf.c"
                                           );
}

static const OSSL_PARAM *kbkdf_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                   __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] =
        { { (("size")), (2), ((
# 467 "../providers/implementations/kdfs/kbkdf.c" 3 4
         ((void *)0)
# 467 "../providers/implementations/kdfs/kbkdf.c"
...
const OSSL_DISPATCH ossl_kdf_kbkdf_functions[] = {
    { 1, (void(*)(void))kbkdf_new },
    { 2, (void(*)(void))kbkdf_dup },
    { 3, (void(*)(void))kbkdf_free },
    { 4, (void(*)(void))kbkdf_reset },
    { 5, (void(*)(void))kbkdf_derive },
    { 8,
      (void(*)(void))kbkdf_settable_ctx_params },
    { 11, (void(*)(void))kbkdf_set_ctx_params },
    { 7,
      (void(*)(void))kbkdf_gettable_ctx_params },
    { 10, (void(*)(void))kbkdf_get_ctx_params },
    { 0, 
# 483 "../providers/implementations/kdfs/kbkdf.c" 3 4
   ((void *)0) 
# 483 "../providers/implementations/kdfs/kbkdf.c"
   },
};
