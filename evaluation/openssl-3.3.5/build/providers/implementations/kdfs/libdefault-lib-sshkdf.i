# 0 "../providers/implementations/kdfs/sshkdf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/kdfs/sshkdf.c"
# 10 "../providers/implementations/kdfs/sshkdf.c"
...
# 11 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 12 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 13 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 14 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 15 "../providers/implementations/kdfs/sshkdf.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../providers/implementations/kdfs/sshkdf.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 17 "../providers/implementations/kdfs/sshkdf.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 18 "../providers/implementations/kdfs/sshkdf.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 20 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 21 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 22 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 23 "../providers/implementations/kdfs/sshkdf.c" 2
...
# 24 "../providers/implementations/kdfs/sshkdf.c" 2
...
static void *kdf_sshkdf_new(void *provctx)
{
    ...
    if (!ossl_prov_is_running())
        return 
# 59 "../providers/implementations/kdfs/sshkdf.c" 3 4
              ((void *)0)
# 59 "../providers/implementations/kdfs/sshkdf.c"
                  ;

    if ((ctx = CRYPTO_zalloc(sizeof(*ctx), "../providers/implementations/kdfs/sshkdf.c", 61)) != 
# 61 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                               ((void *)0)
# 61 "../providers/implementations/kdfs/sshkdf.c"
                                                   )
        ctx->provctx = provctx;
    return ctx;
}
...
static void kdf_sshkdf_free(void *vctx)
{
    ...
    if (ctx != 
# 70 "../providers/implementations/kdfs/sshkdf.c" 3 4
              ((void *)0)
# 70 "../providers/implementations/kdfs/sshkdf.c"
                  ) {
        kdf_sshkdf_reset(ctx);
        CRYPTO_free(ctx, "../providers/implementations/kdfs/sshkdf.c", 72);
    }
}
...
static void kdf_sshkdf_reset(void *vctx)
{
    ...
    CRYPTO_clear_free(ctx->key, ctx->key_len, "../providers/implementations/kdfs/sshkdf.c", 82);
    CRYPTO_clear_free(ctx->xcghash, ctx->xcghash_len, "../providers/implementations/kdfs/sshkdf.c", 83);
    CRYPTO_clear_free(ctx->session_id, ctx->session_id_len, "../providers/implementations/kdfs/sshkdf.c", 84);
...
static void *kdf_sshkdf_dup(void *vctx)
{
    ...
    if (dest != 
# 95 "../providers/implementations/kdfs/sshkdf.c" 3 4
               ((void *)0)
# 95 "../providers/implementations/kdfs/sshkdf.c"
                   ) {
 ...
 err:
    ...
    return 
# 110 "../providers/implementations/kdfs/sshkdf.c" 3 4
          ((void *)0)
# 110 "../providers/implementations/kdfs/sshkdf.c"
              ;
}
...
static int sshkdf_set_membuf(unsigned char **dst, size_t *dst_len,
                             const OSSL_PARAM *p)
{
    CRYPTO_clear_free(*dst, *dst_len, "../providers/implementations/kdfs/sshkdf.c", 116);
    *dst = 
# 117 "../providers/implementations/kdfs/sshkdf.c" 3 4
          ((void *)0)
# 117 "../providers/implementations/kdfs/sshkdf.c"
              ;
    *dst_len = 0;
                             ...
                             const OSSL_PARAM params[])
{
    ...
    if (md == 
# 132 "../providers/implementations/kdfs/sshkdf.c" 3 4
             ((void *)0)
# 132 "../providers/implementations/kdfs/sshkdf.c"
                 ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",133,__func__), ERR_set_error)((57),(129),
# 133 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 133 "../providers/implementations/kdfs/sshkdf.c"
       );
        return 0;
    }
    if (ctx->key == 
# 136 "../providers/implementations/kdfs/sshkdf.c" 3 4
                   ((void *)0)
# 136 "../providers/implementations/kdfs/sshkdf.c"
                       ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",137,__func__), ERR_set_error)((57),(128),
# 137 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 137 "../providers/implementations/kdfs/sshkdf.c"
       );
        return 0;
    }
    if (ctx->xcghash == 
# 140 "../providers/implementations/kdfs/sshkdf.c" 3 4
                       ((void *)0)
# 140 "../providers/implementations/kdfs/sshkdf.c"
                           ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",141,__func__), ERR_set_error)((57),(135),
# 141 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 141 "../providers/implementations/kdfs/sshkdf.c"
       );
        return 0;
    }
    if (ctx->session_id == 
# 144 "../providers/implementations/kdfs/sshkdf.c" 3 4
                          ((void *)0)
# 144 "../providers/implementations/kdfs/sshkdf.c"
                              ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",145,__func__), ERR_set_error)((57),(133),
# 145 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 145 "../providers/implementations/kdfs/sshkdf.c"
       );
        return 0;
    }
    if (ctx->type == 0) {
        (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",149,__func__), ERR_set_error)((57),(134),
# 149 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 149 "../providers/implementations/kdfs/sshkdf.c"
       );
        return 0;
    }
...
static int kdf_sshkdf_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (params == 
# 164 "../providers/implementations/kdfs/sshkdf.c" 3 4
                 ((void *)0)
# 164 "../providers/implementations/kdfs/sshkdf.c"
                     )
        return 1;
...
# 170 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                                                    ((void *)0)
# 170 "../providers/implementations/kdfs/sshkdf.c"
                                                                        )
        if (!sshkdf_set_membuf(&ctx->key, &ctx->key_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "xcghash"))
        != 
# 175 "../providers/implementations/kdfs/sshkdf.c" 3 4
          ((void *)0)
# 175 "../providers/implementations/kdfs/sshkdf.c"
              )
        if (!sshkdf_set_membuf(&ctx->xcghash, &ctx->xcghash_len, p))
            return 0;

    if ((p = OSSL_PARAM_locate_const(params, "session_id"))
        != 
# 180 "../providers/implementations/kdfs/sshkdf.c" 3 4
          ((void *)0)
# 180 "../providers/implementations/kdfs/sshkdf.c"
              )
    ...
    if ((p = OSSL_PARAM_locate_const(params, "type"))
        != 
# 185 "../providers/implementations/kdfs/sshkdf.c" 3 4
          ((void *)0)
# 185 "../providers/implementations/kdfs/sshkdf.c"
              ) {
        const char *kdftype;
        ...
        if (kdftype == 
# 191 "../providers/implementations/kdfs/sshkdf.c" 3 4
                      ((void *)0) 
# 191 "../providers/implementations/kdfs/sshkdf.c"
                           || p->data_size != 1)
            return 0;
        if (kdftype[0] < 65 || kdftype[0] > 70) {
            (ERR_new(), ERR_set_debug("../providers/implementations/kdfs/sshkdf.c",194,__func__), ERR_set_error)((57),(138),
# 194 "../providers/implementations/kdfs/sshkdf.c" 3 4
           ((void *)0)
# 194 "../providers/implementations/kdfs/sshkdf.c"
           );
            return 0;
        }
        ctx->type = kdftype[0];
...
static const OSSL_PARAM *kdf_sshkdf_settable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("properties")), (4), ((
# 206 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 206 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 207 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 207 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { (("key")), (5), ((
# 208 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 208 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { (("xcghash")), (5), ((
# 209 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 209 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { (("session_id")), (5), ((
# 210 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 210 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { (("type")), (4), ((
# 211 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 211 "../providers/implementations/kdfs/sshkdf.c"
       )), (0), ((size_t)-1) },
        { 
# 212 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 212 "../providers/implementations/kdfs/sshkdf.c"
       , 0, 
# 212 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 212 "../providers/implementations/kdfs/sshkdf.c"
...
# 221 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                                               ((void *)0)
# 221 "../providers/implementations/kdfs/sshkdf.c"
                                                                   )
        return OSSL_PARAM_set_size_t(p, 
# 222 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                       (18446744073709551615UL)
# 222 "../providers/implementations/kdfs/sshkdf.c"
                                               );
    return -2;
}

static const OSSL_PARAM *kdf_sshkdf_gettable_ctx_params(__attribute__((unused)) void *ctx,
                                                        __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("size")), (2), ((
# 230 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 230 "../providers/implementations/kdfs/sshkdf.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { 
# 231 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 231 "../providers/implementations/kdfs/sshkdf.c"
       , 0, 
# 231 "../providers/implementations/kdfs/sshkdf.c" 3 4
       ((void *)0)
# 231 "../providers/implementations/kdfs/sshkdf.c"
...
const OSSL_DISPATCH ossl_kdf_sshkdf_functions[] = {
    { 1, (void(*)(void))kdf_sshkdf_new },
    { 2, (void(*)(void))kdf_sshkdf_dup },
    { 3, (void(*)(void))kdf_sshkdf_free },
    { 4, (void(*)(void))kdf_sshkdf_reset },
    { 5, (void(*)(void))kdf_sshkdf_derive },
    { 8,
      (void(*)(void))kdf_sshkdf_settable_ctx_params },
    { 11, (void(*)(void))kdf_sshkdf_set_ctx_params },
    { 7,
      (void(*)(void))kdf_sshkdf_gettable_ctx_params },
    { 10, (void(*)(void))kdf_sshkdf_get_ctx_params },
    { 0, 
# 248 "../providers/implementations/kdfs/sshkdf.c" 3 4
   ((void *)0) 
# 248 "../providers/implementations/kdfs/sshkdf.c"
   }
};
...
{
    EVP_MD_CTX *md = 
# 257 "../providers/implementations/kdfs/sshkdf.c" 3 4
                    ((void *)0)
# 257 "../providers/implementations/kdfs/sshkdf.c"
                        ;
    ...
    md = EVP_MD_CTX_new();
    if (md == 
# 264 "../providers/implementations/kdfs/sshkdf.c" 3 4
             ((void *)0)
# 264 "../providers/implementations/kdfs/sshkdf.c"
                 )
        return 0;

    if (!EVP_DigestInit_ex(md, evp_md, 
# 267 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                      ((void *)0)
# 267 "../providers/implementations/kdfs/sshkdf.c"
                                          ))
        goto out;
    ...
    for (cursize = dsize; cursize < okey_len; cursize += dsize) {
        ...
        if (!EVP_DigestInit_ex(md, evp_md, 
# 295 "../providers/implementations/kdfs/sshkdf.c" 3 4
                                          ((void *)0)
# 295 "../providers/implementations/kdfs/sshkdf.c"
                                              ))
            goto out;
