# 0 "../providers/implementations/rands/drbg_hash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/rands/drbg_hash.c"
# 10 "../providers/implementations/rands/drbg_hash.c"
...
# 11 "../providers/implementations/rands/drbg_hash.c" 2
...
# 12 "../providers/implementations/rands/drbg_hash.c" 2
...
# 13 "../providers/implementations/rands/drbg_hash.c" 2
...
# 14 "../providers/implementations/rands/drbg_hash.c" 2
...
# 15 "../providers/implementations/rands/drbg_hash.c" 2
...
# 16 "../providers/implementations/rands/drbg_hash.c" 2
...
int RAND_poll(void);
# 17 "../providers/implementations/rands/drbg_hash.c" 2

# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 19 "../providers/implementations/rands/drbg_hash.c" 2
# 1 "../include/internal/thread_once.h" 1
# 12 "../include/internal/thread_once.h"
        
# 20 "../providers/implementations/rands/drbg_hash.c" 2
...
# 21 "../providers/implementations/rands/drbg_hash.c" 2
...
# 22 "../providers/implementations/rands/drbg_hash.c" 2
...
# 23 "../providers/implementations/rands/drbg_hash.c" 2
...
# 24 "../providers/implementations/rands/drbg_hash.c" 2
...
# 25 "../providers/implementations/rands/drbg_hash.c" 2
...
# 50 "../providers/implementations/rands/drbg_hash.c"
typedef struct rand_drbg_hash_st {
    PROV_DIGEST digest;
    EVP_MD_CTX *ctx;
    size_t blocklen;
    unsigned char V[(888/8)];
    unsigned char C[(888/8)];

    unsigned char vtmp[(888/8)];
} PROV_DRBG_HASH;
# 69 "../providers/implementations/rands/drbg_hash.c"
                   ...
                   const unsigned char *in3, size_t in3len)
{
    ...
    for (;;) {
        ...
        if (!(EVP_DigestInit_ex(ctx, ossl_prov_digest_md(&hash->digest), 
# 105 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                                        ((void *)0)
# 105 "../providers/implementations/rands/drbg_hash.c"
                                                                            )
                && EVP_DigestUpdate(ctx, tmp, tmp_sz)
                && EVP_DigestUpdate(ctx, in, inlen)
                && (in2 == 
# 108 "../providers/implementations/rands/drbg_hash.c" 3 4
                          ((void *)0) 
# 108 "../providers/implementations/rands/drbg_hash.c"
                               || EVP_DigestUpdate(ctx, in2, in2len))
                && (in3 == 
# 109 "../providers/implementations/rands/drbg_hash.c" 3 4
                          ((void *)0) 
# 109 "../providers/implementations/rands/drbg_hash.c"
                               || EVP_DigestUpdate(ctx, in3, in3len))))
            return 0;

        if (outlen < hash->blocklen) {
            if (!EVP_DigestFinal(ctx, vtmp, 
# 113 "../providers/implementations/rands/drbg_hash.c" 3 4
                                           ((void *)0)
# 113 "../providers/implementations/rands/drbg_hash.c"
                                               ))
                return 0;
            memcpy(out, vtmp, outlen);
            OPENSSL_cleanse(vtmp, hash->blocklen);
            break;
        } else if (!EVP_DigestFinal(ctx, out, 
# 118 "../providers/implementations/rands/drbg_hash.c" 3 4
                                             ((void *)0)
# 118 "../providers/implementations/rands/drbg_hash.c"
                                                 )) {
            return 0;
        }
...
{
    return hash_df(drbg, out, in_byte, in1, in1len, 
# 137 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                   ((void *)0)
# 137 "../providers/implementations/rands/drbg_hash.c"
                                                       , 0, 
# 137 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                            ((void *)0)
# 137 "../providers/implementations/rands/drbg_hash.c"
...
# 154 "../providers/implementations/rands/drbg_hash.c" 3 4
   ((void) (0))
# 154 "../providers/implementations/rands/drbg_hash.c"
                                                                     ;
                         ...
                         const unsigned char *adin, size_t adinlen)
{
    ...
    return EVP_DigestInit_ex(ctx, ossl_prov_digest_md(&hash->digest), 
# 183 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                                     ((void *)0)
# 183 "../providers/implementations/rands/drbg_hash.c"
                                                                         )
           && EVP_DigestUpdate(ctx, &inbyte, 1)
           && EVP_DigestUpdate(ctx, hash->V, drbg->seedlen)
           && (adin == 
# 186 "../providers/implementations/rands/drbg_hash.c" 3 4
                      ((void *)0) 
# 186 "../providers/implementations/rands/drbg_hash.c"
                           || EVP_DigestUpdate(ctx, adin, adinlen))
           && EVP_DigestFinal(ctx, hash->vtmp, 
# 187 "../providers/implementations/rands/drbg_hash.c" 3 4
                                              ((void *)0)
# 187 "../providers/implementations/rands/drbg_hash.c"
                                                  )
           && add_bytes(drbg, hash->V, hash->vtmp, hash->blocklen);
}
# 209 "../providers/implementations/rands/drbg_hash.c"
...
# 219 "../providers/implementations/rands/drbg_hash.c" 3 4
                              ((void *)0)
# 219 "../providers/implementations/rands/drbg_hash.c"
                                  )
                || !EVP_DigestUpdate(hash->ctx, hash->vtmp, drbg->seedlen))
            return 0;

        if (outlen < hash->blocklen) {
            if (!EVP_DigestFinal(hash->ctx, hash->vtmp, 
# 224 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                       ((void *)0)
# 224 "../providers/implementations/rands/drbg_hash.c"
                                                           ))
                return 0;
            memcpy(out, hash->vtmp, outlen);
            return 1;
        } else {
            if (!EVP_DigestFinal(hash->ctx, out, 
# 229 "../providers/implementations/rands/drbg_hash.c" 3 4
                                                ((void *)0)
# 229 "../providers/implementations/rands/drbg_hash.c"
                                                    ))
                return 0;
            outlen -= hash->blocklen;
            if (outlen == 0)
...
# 250 "../providers/implementations/rands/drbg_hash.c"
                                 ...
                                 const unsigned char *pstr, size_t pstr_len)
{
    ...
    return hash->ctx != 
# 261 "../providers/implementations/rands/drbg_hash.c" 3 4
                       ((void *)0)
           
# 262 "../providers/implementations/rands/drbg_hash.c"
          && hash_df(drbg, hash->V, ((unsigned char)0xFF),
                                         ...
                                         const OSSL_PARAM params[])
{
    ...
    if (drbg->lock != 
# 277 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0) 
# 277 "../providers/implementations/rands/drbg_hash.c"
 ...
 err:
    if (drbg->lock != 
# 286 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0)
# 286 "../providers/implementations/rands/drbg_hash.c"
                         )
        CRYPTO_THREAD_unlock(drbg->lock);
    return ret;
}
# 299 "../providers/implementations/rands/drbg_hash.c"
...
# 334 "../providers/implementations/rands/drbg_hash.c"
                              ...
                              const unsigned char *adin, size_t adin_len)
{
    ...
    return hash->ctx != 
# 347 "../providers/implementations/rands/drbg_hash.c" 3 4
                       ((void *)0)
           
# 348 "../providers/implementations/rands/drbg_hash.c"
          && (adin == 
# 348 "../providers/implementations/rands/drbg_hash.c" 3 4
                      ((void *)0)

               
# 350 "../providers/implementations/rands/drbg_hash.c"
              || adin_len == 0
               || add_hash_to_v(drbg, 0x02, adin, adin_len))

           && hash_gen(drbg, out, outlen)

           && add_hash_to_v(drbg, 0x03, 
# 355 "../providers/implementations/rands/drbg_hash.c" 3 4
                                       ((void *)0)
# 355 "../providers/implementations/rands/drbg_hash.c"
                                           , 0)
...
static int drbg_hash_uninstantiate_wrapper(void *vdrbg)
{
    ...
    if (drbg->lock != 
# 388 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0) 
# 388 "../providers/implementations/rands/drbg_hash.c"
                          && !CRYPTO_THREAD_write_lock(drbg->lock))
        return 0;
    ...
    if (drbg->lock != 
# 393 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0)
# 393 "../providers/implementations/rands/drbg_hash.c"
                         )
        CRYPTO_THREAD_unlock(drbg->lock);
...
static int drbg_hash_verify_zeroization(void *vdrbg)
{
    ...
    if (drbg->lock != 
# 405 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0) 
# 405 "../providers/implementations/rands/drbg_hash.c"
                          && !CRYPTO_THREAD_read_lock(drbg->lock))
        return 0;

    { size_t i; for (i = 0; i < (sizeof(hash->V)/sizeof((hash->V)[0])); i++) if ((hash->V)[i] != 0) goto err; };
    { size_t i; for (i = 0; i < (sizeof(hash->C)/sizeof((hash->C)[0])); i++) if ((hash->C)[i] != 0) goto err; };
    { size_t i; for (i = 0; i < (sizeof(hash->vtmp)/sizeof((hash->vtmp)[0])); i++) if ((hash->vtmp)[i] != 0) goto err; };

    ret = 1;
 err:
    if (drbg->lock != 
# 414 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0)
# 414 "../providers/implementations/rands/drbg_hash.c"
                         )
        CRYPTO_THREAD_unlock(drbg->lock);
    return ret;
}
...
static int drbg_hash_new(PROV_DRBG *ctx)
{
    ...
    hash = CRYPTO_secure_zalloc(sizeof(*hash), "../providers/implementations/rands/drbg_hash.c", 423);
    if (hash == 
# 424 "../providers/implementations/rands/drbg_hash.c" 3 4
               ((void *)0)
# 424 "../providers/implementations/rands/drbg_hash.c"
                   )
        return 0;
    ...
    ctx->seedlen = (888/8);
    ctx->max_entropylen = 
# 429 "../providers/implementations/rands/drbg_hash.c" 3 4
                         (2147483647)
# 429 "../providers/implementations/rands/drbg_hash.c"
                                        ;
    ctx->max_noncelen = 
# 430 "../providers/implementations/rands/drbg_hash.c" 3 4
                       (2147483647)
# 430 "../providers/implementations/rands/drbg_hash.c"
                                      ;
    ctx->max_perslen = 
# 431 "../providers/implementations/rands/drbg_hash.c" 3 4
                      (2147483647)
# 431 "../providers/implementations/rands/drbg_hash.c"
                                     ;
    ctx->max_adinlen = 
# 432 "../providers/implementations/rands/drbg_hash.c" 3 4
                      (2147483647)
# 432 "../providers/implementations/rands/drbg_hash.c"
                                     ;
...
static void drbg_hash_free(void *vdrbg)
{
    ...
    if (drbg != 
# 453 "../providers/implementations/rands/drbg_hash.c" 3 4
               ((void *)0) 
# 453 "../providers/implementations/rands/drbg_hash.c"
...
# 453 "../providers/implementations/rands/drbg_hash.c"
        ...
        CRYPTO_secure_clear_free(hash, sizeof(*hash), "../providers/implementations/rands/drbg_hash.c", 456);
    }
...
static int drbg_hash_get_ctx_params(void *vdrbg, OSSL_PARAM params[])
{
    ...
    if (drbg->lock != 
# 475 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0) 
# 475 "../providers/implementations/rands/drbg_hash.c"
                          && !CRYPTO_THREAD_read_lock(drbg->lock))
        return 0;

    p = OSSL_PARAM_locate(params, "digest");
    if (p != 
# 479 "../providers/implementations/rands/drbg_hash.c" 3 4
            ((void *)0)
# 479 "../providers/implementations/rands/drbg_hash.c"
                ) {
        md = ossl_prov_digest_md(&hash->digest);
        if (md == 
# 481 "../providers/implementations/rands/drbg_hash.c" 3 4
                 ((void *)0) 
# 481 "../providers/implementations/rands/drbg_hash.c"
 ...
 err:
    if (drbg->lock != 
# 487 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0)
# 487 "../providers/implementations/rands/drbg_hash.c"
                         )
        CRYPTO_THREAD_unlock(drbg->lock);
...
static const OSSL_PARAM *drbg_hash_gettable_ctx_params(__attribute__((unused)) void *vctx,
                                                       __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("digest")), (4), ((
# 497 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 497 "../providers/implementations/rands/drbg_hash.c"
       )), (0), ((size_t)-1) },
        { (("state")), (1), ((
# 498 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 498 "../providers/implementations/rands/drbg_hash.c"
...
# 498 "../providers/implementations/rands/drbg_hash.c"
        ...
        { 
# 499 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 499 "../providers/implementations/rands/drbg_hash.c"
       , 0, 
# 499 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 499 "../providers/implementations/rands/drbg_hash.c"
...
static int drbg_hash_set_ctx_params_locked(void *vctx, const OSSL_PARAM params[])
{
    ...
    md = ossl_prov_digest_md(&hash->digest);
    if (md != 
# 515 "../providers/implementations/rands/drbg_hash.c" 3 4
             ((void *)0)
# 515 "../providers/implementations/rands/drbg_hash.c"
                 ) {
...
static int drbg_hash_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (drbg->lock != 
# 542 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0) 
# 542 "../providers/implementations/rands/drbg_hash.c"
                          && !CRYPTO_THREAD_write_lock(drbg->lock))
        return 0;
    ...
    if (drbg->lock != 
# 547 "../providers/implementations/rands/drbg_hash.c" 3 4
                     ((void *)0)
# 547 "../providers/implementations/rands/drbg_hash.c"
                         )
        CRYPTO_THREAD_unlock(drbg->lock);
...
static const OSSL_PARAM *drbg_hash_settable_ctx_params(__attribute__((unused)) void *vctx,
                                                       __attribute__((unused)) void *p_ctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("properties")), (4), ((
# 557 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 557 "../providers/implementations/rands/drbg_hash.c"
       )), (0), ((size_t)-1) },
        { (("digest")), (4), ((
# 558 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 558 "../providers/implementations/rands/drbg_hash.c"
       )), (0), ((size_t)-1) },
        { (("reseed_requests")), (2), ((
# 559 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 559 "../providers/implementations/rands/drbg_hash.c"
       )), (sizeof(unsigned int)), ((size_t)-1) }, { (("reseed_time_interval")), (2), ((
# 559 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 559 "../providers/implementations/rands/drbg_hash.c"
        ...
        { 
# 560 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 560 "../providers/implementations/rands/drbg_hash.c"
       , 0, 
# 560 "../providers/implementations/rands/drbg_hash.c" 3 4
       ((void *)0)
# 560 "../providers/implementations/rands/drbg_hash.c"
...
const OSSL_DISPATCH ossl_drbg_hash_functions[] = {
    { 1, (void(*)(void))drbg_hash_new_wrapper },
    { 2, (void(*)(void))drbg_hash_free },
    { 3,
      (void(*)(void))drbg_hash_instantiate_wrapper },
    { 4,
      (void(*)(void))drbg_hash_uninstantiate_wrapper },
    { 5, (void(*)(void))drbg_hash_generate_wrapper },
    { 6, (void(*)(void))drbg_hash_reseed_wrapper },
    ...
    { 16, (void(*)(void))drbg_hash_set_ctx_params },
    { 12,
      (void(*)(void))drbg_hash_gettable_ctx_params },
    { 15, (void(*)(void))drbg_hash_get_ctx_params },
    { 17,
      (void(*)(void))drbg_hash_verify_zeroization },
    { 18, (void(*)(void))ossl_drbg_get_seed },
    { 19, (void(*)(void))ossl_drbg_clear_seed },
    { 0, 
# 587 "../providers/implementations/rands/drbg_hash.c" 3 4
   ((void *)0) 
# 587 "../providers/implementations/rands/drbg_hash.c"
   }
};
