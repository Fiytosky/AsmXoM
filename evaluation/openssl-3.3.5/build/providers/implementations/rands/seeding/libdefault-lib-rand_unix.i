# 0 "../providers/implementations/rands/seeding/rand_unix.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/rands/seeding/rand_unix.c"
# 13 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 14 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 16 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
int RAND_poll(void);
# 17 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 19 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
uint32_t ossl_rand_range_uint32(OSSL_LIB_CTX *ctx, uint32_t lower, uint32_t upper,
                                int *err);
# 20 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 21 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
void ossl_prov_cleanup_nonce(PROV_CTX *prov_ctx, unsigned char *buf,
                             size_t len);
# 23 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 26 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 28 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 29 "../providers/implementations/rands/seeding/rand_unix.c" 2
# 47 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 48 "../providers/implementations/rands/seeding/rand_unix.c" 2
...
# 49 "../providers/implementations/rands/seeding/rand_unix.c" 2




# 52 "../providers/implementations/rands/seeding/rand_unix.c"
static uint64_t get_time_stamp(void);
# 331 "../providers/implementations/rands/seeding/rand_unix.c"
static ssize_t syscall_random(void *buf, size_t buflen)
{
# 358 "../providers/implementations/rands/seeding/rand_unix.c"
    extern int getentropy(void *buffer, size_t length) __attribute__((weak));

    if (getentropy != 
# 360 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                     ((void *)0)
# 360 "../providers/implementations/rands/seeding/rand_unix.c"
                         ) {
        if (getentropy(buf, buflen) == 0)
            return (ssize_t)buflen;
        if (
# 363 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
           (*__errno_location ()) 
# 363 "../providers/implementations/rands/seeding/rand_unix.c"
                 != 
# 363 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                    38
# 363 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 392 "../providers/implementations/rands/seeding/rand_unix.c"
    return syscall(
# 392 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                  318
# 392 "../providers/implementations/rands/seeding/rand_unix.c"
                                , buf, buflen, 0);
# 406 "../providers/implementations/rands/seeding/rand_unix.c"
}



static const char *random_device_paths[] = { "/dev/urandom", "/dev/random", "/dev/hwrng", "/dev/srandom" };
static struct random_device {
    ...
    mode_t mode;
    dev_t rdev;
} random_devices[(sizeof(random_device_paths)/sizeof((random_device_paths)[0]))];
...
{
    static int seeded = 114 < 0;
    static const int kernel_version[] = { 4, 8 };
    int kernel[2];
    int shm_id, fd, r;
    char c, *p;
    struct utsname un;
    ...
    if (!seeded) {
        ...
        if ((shm_id = shmget(114, 1, 0)) == -1) {
# 457 "../providers/implementations/rands/seeding/rand_unix.c"
            if (uname(&un) == 0) {
                kernel[0] = atoi(un.release);
                p = strchr(un.release, '.');
                kernel[1] = p == 
# 460 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                ((void *)0) 
# 460 "../providers/implementations/rands/seeding/rand_unix.c"
                                     ? 0 : atoi(p + 1);
            ...
            if ((fd = open("/dev/random", 
# 468 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                          00
# 468 "../providers/implementations/rands/seeding/rand_unix.c"
                                                  )) != -1) {
                if (1 && fd < 
# 469 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                    1024
# 469 "../providers/implementations/rands/seeding/rand_unix.c"
                                                              ) {
                    
# 470 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                   do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((
# 470 "../providers/implementations/rands/seeding/rand_unix.c"
                   &fds
# 470 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
...
# 471 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                   ((void) (((
# 471 "../providers/implementations/rands/seeding/rand_unix.c"
                   &fds
# 471 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                   )->fds_bits)[((
# 471 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 471 "../providers/implementations/rands/seeding/rand_unix.c"
                                   ;
                    while ((r = select(fd + 1, &fds, 
# 472 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                    ((void *)0)
# 472 "../providers/implementations/rands/seeding/rand_unix.c"
                                                        , 
# 472 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                          ((void *)0)
# 472 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 472 "../providers/implementations/rands/seeding/rand_unix.c"
                           ...
                           && 
# 473 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                             (*__errno_location ()) 
# 473 "../providers/implementations/rands/seeding/rand_unix.c"
                                   == 
# 473 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                      4
# 473 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 475 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                       (*__errno_location ()) 
# 475 "../providers/implementations/rands/seeding/rand_unix.c"
                                                             == 
# 475 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                                4
# 475 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 482 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                   01000 
# 482 "../providers/implementations/rands/seeding/rand_unix.c"
                                             | 
# 482 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                               0400 
# 482 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 482 "../providers/implementations/rands/seeding/rand_unix.c"
        ...
        if (shm_id != -1) {
            ...
            shm_addr = shmat(shm_id, 
# 492 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                    ((void *)0)
# 492 "../providers/implementations/rands/seeding/rand_unix.c"
                                        , 
# 492 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                          010000
# 492 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 513 "../providers/implementations/rands/seeding/rand_unix.c"
static int check_random_device(struct random_device *rd)
{
    ...
    return rd->fd != -1
           ...
           && rd->ino == st.st_ino
           && ((rd->mode ^ st.st_mode) & ~(
# 521 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                          (0400|0200|0100) 
# 521 "../providers/implementations/rands/seeding/rand_unix.c"
                                                  | 
# 521 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                    ((0400|0200|0100) >> 3) 
# 521 "../providers/implementations/rands/seeding/rand_unix.c"
...
static int get_random_device(size_t n)
{
    ...
    if ((rd->fd = open(random_device_paths[n], 
# 538 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                              00
# 538 "../providers/implementations/rands/seeding/rand_unix.c"
                                                      )) == -1)
        return rd->fd;
...
int ossl_rand_pool_init(void)
{
    ...
    for (i = 0; i < (sizeof(random_devices)/sizeof((random_devices)[0])); i++)
...
# 627 "../providers/implementations/rands/seeding/rand_unix.c"
size_t ossl_pool_acquire_entropy(RAND_POOL *pool)
{
...
# 652 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                   (*__errno_location ()) 
# 652 "../providers/implementations/rands/seeding/rand_unix.c"
                                         != 
# 652 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                            4
# 652 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 669 "../providers/implementations/rands/seeding/rand_unix.c"
    if (wait_random_seeded()) {
        ...
        bytes_needed = ossl_rand_pool_bytes_needed(pool, 1 );
        for (i = 0; bytes_needed > 0 && i < (sizeof(random_device_paths)/sizeof((random_device_paths)[0]));
             i++) {
            ssize_t bytes = 0;
...
# 693 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                       (*__errno_location ()) 
# 693 "../providers/implementations/rands/seeding/rand_unix.c"
                                             != 
# 693 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                                                4
# 693 "../providers/implementations/rands/seeding/rand_unix.c"
...
# 747 "../providers/implementations/rands/seeding/rand_unix.c"
...
static uint64_t get_time_stamp(void)
{

    {
        ...
        if (clock_gettime(
# 791 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                         0
# 791 "../providers/implementations/rands/seeding/rand_unix.c"
                                       , &ts) == 0)
...

    {
        ...
        if (gettimeofday(&tv, 
# 800 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
                             ((void *)0)
# 800 "../providers/implementations/rands/seeding/rand_unix.c"
                                 ) == 0)
            return ((((uint64_t)(tv.tv_sec)) << 32) + (tv.tv_usec));
    }

    return time(
# 804 "../providers/implementations/rands/seeding/rand_unix.c" 3 4
               ((void *)0)
# 804 "../providers/implementations/rands/seeding/rand_unix.c"
                   );
}
