# 0 "../providers/implementations/rands/test_rng.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/rands/test_rng.c"
# 10 "../providers/implementations/rands/test_rng.c"
...
# 11 "../providers/implementations/rands/test_rng.c" 2
...
# 12 "../providers/implementations/rands/test_rng.c" 2
...
# 13 "../providers/implementations/rands/test_rng.c" 2
...
# 15 "../providers/implementations/rands/test_rng.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../providers/implementations/rands/test_rng.c" 2
...
# 17 "../providers/implementations/rands/test_rng.c" 2
...
# 18 "../providers/implementations/rands/test_rng.c" 2
# 1 "../include/openssl/randerr.h" 1
# 13 "../include/openssl/randerr.h"
        
# 19 "../providers/implementations/rands/test_rng.c" 2
...
# 20 "../providers/implementations/rands/test_rng.c" 2
...
# 21 "../providers/implementations/rands/test_rng.c" 2
...
# 22 "../providers/implementations/rands/test_rng.c" 2
...
# 23 "../providers/implementations/rands/test_rng.c" 2
                          ...
                          const OSSL_DISPATCH *parent_dispatch)
{
    ...
    t = CRYPTO_zalloc(sizeof(*t), "../providers/implementations/rands/test_rng.c", 58);
    if (t == 
# 59 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0)
# 59 "../providers/implementations/rands/test_rng.c"
                )
        return 
# 60 "../providers/implementations/rands/test_rng.c" 3 4
              ((void *)0)
# 60 "../providers/implementations/rands/test_rng.c"
                  ;

    t->max_request = 0x7fffffff
# 62 "../providers/implementations/rands/test_rng.c"
                           ;
    t->provctx = provctx;
    t->state = 0;
    return t;
...
static void test_rng_free(void *vtest)
{
    ...
    if (t == 
# 72 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0)
# 72 "../providers/implementations/rands/test_rng.c"
                )
        return;
    CRYPTO_free(t->entropy, "../providers/implementations/rands/test_rng.c", 74);
    CRYPTO_free(t->nonce, "../providers/implementations/rands/test_rng.c", 75);
    CRYPTO_THREAD_lock_free(t->lock);
    CRYPTO_free(t, "../providers/implementations/rands/test_rng.c", 77);
}
...
{
    uint32_t n;
# 117 "../providers/implementations/rands/test_rng.c"
    n = t->seed;
    n ^= n << 13;
    n ^= n >> 17;
    n ^= n << 5;
...
static int test_rng_reseed(__attribute__((unused)) void *vtest,
                           __attribute__((unused)) int prediction_resistance,
                           __attribute__((unused)) const unsigned char *ent,
                           __attribute__((unused)) size_t ent_len,
                           __attribute__((unused)) const unsigned char *adin,
                           __attribute__((unused)) size_t adin_len)
{
    return 1;
}
                             ...
                             size_t max_noncelen)
{
    ...
    if (t->nonce == 
# 174 "../providers/implementations/rands/test_rng.c" 3 4
                   ((void *)0)
# 174 "../providers/implementations/rands/test_rng.c"
                       )
        return 0;
    i = t->nonce_len > max_noncelen ? max_noncelen : t->nonce_len;
    if (out != 
# 177 "../providers/implementations/rands/test_rng.c" 3 4
              ((void *)0)
# 177 "../providers/implementations/rands/test_rng.c"
                  )
...
static int test_rng_get_ctx_params(void *vtest, OSSL_PARAM params[])
{
    ...
    if (p != 
# 188 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 188 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_set_int(p, t->state))
        return 0;

    p = OSSL_PARAM_locate(params, "strength");
    if (p != 
# 192 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 192 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_set_int(p, t->strength))
        return 0;

    p = OSSL_PARAM_locate(params, "max_request");
    if (p != 
# 196 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 196 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_set_size_t(p, t->max_request))
        return 0;

    p = OSSL_PARAM_locate(params, "generate");
    if (p != 
# 200 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 200 "../providers/implementations/rands/test_rng.c"
                 && OSSL_PARAM_set_uint(p, t->generate))
        return 0;
    return 1;
}

static const OSSL_PARAM *test_rng_gettable_ctx_params(__attribute__((unused)) void *vtest,
                                                      __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        { (("state")), (1), ((
# 209 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 209 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(int)), ((size_t)-1) },
        { (("strength")), (2), ((
# 210 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 210 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("max_request")), (2), ((
# 211 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 211 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { (("generate")), (2), ((
# 212 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 212 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { 
# 213 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 213 "../providers/implementations/rands/test_rng.c"
       , 0, 
# 213 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 213 "../providers/implementations/rands/test_rng.c"
...
static int test_rng_set_ctx_params(void *vtest, const OSSL_PARAM params[])
{
    ...
    const OSSL_PARAM *p;
    void *ptr = 
# 222 "../providers/implementations/rands/test_rng.c" 3 4
               ((void *)0)
# 222 "../providers/implementations/rands/test_rng.c"
                   ;
    size_t size = 0;

    if (params == 
# 225 "../providers/implementations/rands/test_rng.c" 3 4
                 ((void *)0)
# 225 "../providers/implementations/rands/test_rng.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "strength");
    if (p != 
# 229 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 229 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_get_uint(p, &t->strength))
        return 0;

    p = OSSL_PARAM_locate_const(params, "test_entropy");
    if (p != 
# 233 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0)
# 233 "../providers/implementations/rands/test_rng.c"
                ) {
        if (!OSSL_PARAM_get_octet_string(p, &ptr, 0, &size))
            return 0;
        CRYPTO_free(t->entropy, "../providers/implementations/rands/test_rng.c", 236);
        t->entropy = ptr;
        t->entropy_len = size;
        t->entropy_pos = 0;
        ptr = 
# 240 "../providers/implementations/rands/test_rng.c" 3 4
             ((void *)0)
# 240 "../providers/implementations/rands/test_rng.c"
                 ;
    }

    p = OSSL_PARAM_locate_const(params, "test_nonce");
    if (p != 
# 244 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0)
# 244 "../providers/implementations/rands/test_rng.c"
                ) {
        if (!OSSL_PARAM_get_octet_string(p, &ptr, 0, &size))
            return 0;
        CRYPTO_free(t->nonce, "../providers/implementations/rands/test_rng.c", 247);
        t->nonce = ptr;
        t->nonce_len = size;
    }

    p = OSSL_PARAM_locate_const(params, "max_request");
    if (p != 
# 253 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 253 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_get_size_t(p, &t->max_request))
        return 0;

    p = OSSL_PARAM_locate_const(params, "generate");
    if (p != 
# 257 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 257 "../providers/implementations/rands/test_rng.c"
                 && !OSSL_PARAM_get_uint(p, &t->generate))
        return 0;
    return 1;
}

static const OSSL_PARAM *test_rng_settable_ctx_params(__attribute__((unused)) void *vtest,
                                                      __attribute__((unused)) void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        { (("test_entropy")), (5), ((
# 266 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 266 "../providers/implementations/rands/test_rng.c"
       )), (0), ((size_t)-1) },
        { (("test_nonce")), (5), ((
# 267 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 267 "../providers/implementations/rands/test_rng.c"
       )), (0), ((size_t)-1) },
        { (("strength")), (2), ((
# 268 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 268 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { (("max_request")), (2), ((
# 269 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 269 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(size_t)), ((size_t)-1) },
        { (("generate")), (2), ((
# 270 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 270 "../providers/implementations/rands/test_rng.c"
       )), (sizeof(unsigned int)), ((size_t)-1) },
        { 
# 271 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 271 "../providers/implementations/rands/test_rng.c"
       , 0, 
# 271 "../providers/implementations/rands/test_rng.c" 3 4
       ((void *)0)
# 271 "../providers/implementations/rands/test_rng.c"
...
static int test_rng_verify_zeroization(__attribute__((unused)) void *vtest)
{
    return 1;
}
...
static int test_rng_enable_locking(void *vtest)
{
    ...
    if (t != 
# 297 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 297 "../providers/implementations/rands/test_rng.c"
                 && t->lock == 
# 297 "../providers/implementations/rands/test_rng.c" 3 4
                               ((void *)0)
# 297 "../providers/implementations/rands/test_rng.c"
        ...
        if (t->lock == 
# 299 "../providers/implementations/rands/test_rng.c" 3 4
                      ((void *)0)
# 299 "../providers/implementations/rands/test_rng.c"
                          ) {
            (ERR_new(), ERR_set_debug("../providers/implementations/rands/test_rng.c",300,__func__), ERR_set_error)((57),(126),
# 300 "../providers/implementations/rands/test_rng.c" 3 4
           ((void *)0)
# 300 "../providers/implementations/rands/test_rng.c"
           );
            return 0;
        }
    }
...
static int test_rng_lock(void *vtest)
{
    ...
    if (t == 
# 311 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 311 "../providers/implementations/rands/test_rng.c"
                 || t->lock == 
# 311 "../providers/implementations/rands/test_rng.c" 3 4
                               ((void *)0)
# 311 "../providers/implementations/rands/test_rng.c"
...
static void test_rng_unlock(void *vtest)
{
    ...
    if (t != 
# 320 "../providers/implementations/rands/test_rng.c" 3 4
            ((void *)0) 
# 320 "../providers/implementations/rands/test_rng.c"
                 && t->lock != 
# 320 "../providers/implementations/rands/test_rng.c" 3 4
                               ((void *)0)
# 320 "../providers/implementations/rands/test_rng.c"
...
const OSSL_DISPATCH ossl_test_rng_functions[] = {
    { 1, (void(*)(void))test_rng_new },
    { 2, (void(*)(void))test_rng_free },
    { 3,
      (void(*)(void))test_rng_instantiate },
    { 4,
      (void(*)(void))test_rng_uninstantiate },
    { 5, (void(*)(void))test_rng_generate },
    { 6, (void(*)(void))test_rng_reseed },
    { 7, (void(*)(void))test_rng_nonce },
    { 8, (void(*)(void))test_rng_enable_locking },
    { 9, (void(*)(void))test_rng_lock },
    { 10, (void(*)(void))test_rng_unlock },
    { 13,
      (void(*)(void))test_rng_settable_ctx_params },
    { 16, (void(*)(void))test_rng_set_ctx_params },
    { 12,
      (void(*)(void))test_rng_gettable_ctx_params },
    { 15, (void(*)(void))test_rng_get_ctx_params },
    { 17,
      (void(*)(void))test_rng_verify_zeroization },
    { 18, (void(*)(void))test_rng_get_seed },
    { 0, 
# 346 "../providers/implementations/rands/test_rng.c" 3 4
   ((void *)0) 
# 346 "../providers/implementations/rands/test_rng.c"
   }
};
