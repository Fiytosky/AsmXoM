# 0 "../providers/implementations/rands/crngt.c"
# 0 "<built-in>"
# 0 "<command-line>"
                             ...
                             unsigned int *md_size)
{
    ...
    n = ossl_prov_get_entropy(provctx, &p, 0, 16, 16);
    if (n == 16) {
        r = EVP_Digest(p, 16, md, md_size, digest, 
# 45 "../providers/implementations/rands/crngt.c" 3 4
                                                            ((void *)0)
# 45 "../providers/implementations/rands/crngt.c"
                                                                );
        if (r != 0)
            memcpy(buf, p, 16);
...
void *ossl_rand_crng_ctx_new(OSSL_LIB_CTX *ctx)
{
    ...
    if (crngt_glob == 
# 69 "../providers/implementations/rands/crngt.c" 3 4
                     ((void *)0)
# 69 "../providers/implementations/rands/crngt.c"
                         )
        return 
# 70 "../providers/implementations/rands/crngt.c" 3 4
              ((void *)0)
# 70 "../providers/implementations/rands/crngt.c"
                  ;

    if ((crngt_glob->md = EVP_MD_fetch(ctx, "SHA256", "")) == 
# 72 "../providers/implementations/rands/crngt.c" 3 4
                                                             ((void *)0)
# 72 "../providers/implementations/rands/crngt.c"
                                                                 ) {
        CRYPTO_free(crngt_glob, "../providers/implementations/rands/crngt.c", 73);
        return 
# 74 "../providers/implementations/rands/crngt.c" 3 4
              ((void *)0)
# 74 "../providers/implementations/rands/crngt.c"
                  ;
    }

    if ((crngt_glob->lock = CRYPTO_THREAD_lock_new()) == 
# 77 "../providers/implementations/rands/crngt.c" 3 4
                                                        ((void *)0)
# 77 "../providers/implementations/rands/crngt.c"
                                                            ) {
        EVP_MD_free(crngt_glob->md);
        CRYPTO_free(crngt_glob, "../providers/implementations/rands/crngt.c", 79);
        return 
# 80 "../providers/implementations/rands/crngt.c" 3 4
              ((void *)0)
# 80 "../providers/implementations/rands/crngt.c"
                  ;
    }
                                       ...
                                       size_t sz)
{
    ...
    if (!res)
        ossl_set_error_state("Continuous_RNG_Test");
    return res;
}
                              ...
                              int prediction_resistance)
{
    ...
    CRNG_TEST_GLOBAL *crngt_glob
        = ossl_lib_ctx_get_data(libctx, 7);
    OSSL_CALLBACK *stcb = 
# 112 "../providers/implementations/rands/crngt.c" 3 4
                         ((void *)0)
# 112 "../providers/implementations/rands/crngt.c"
                             ;
    void *stcbarg = 
# 113 "../providers/implementations/rands/crngt.c" 3 4
                   ((void *)0)
# 113 "../providers/implementations/rands/crngt.c"
                       ;
    OSSL_SELF_TEST *st = 
# 114 "../providers/implementations/rands/crngt.c" 3 4
                        ((void *)0)
# 114 "../providers/implementations/rands/crngt.c"
                            ;

    if (crngt_glob == 
# 116 "../providers/implementations/rands/crngt.c" 3 4
                     ((void *)0)
# 116 "../providers/implementations/rands/crngt.c"
                         )
        return 0;
    ...
    if (!crngt_glob->preloaded) {
        if (!crngt_get_entropy(drbg->provctx, crngt_glob->md, buf,
                               crngt_glob->crngt_prev, 
# 124 "../providers/implementations/rands/crngt.c" 3 4
                                                      ((void *)0)
# 124 "../providers/implementations/rands/crngt.c"
                                                          )) {
    ...
    if (bytes_needed > max_len)
        goto unlock_return;
    entp = ent = CRYPTO_secure_malloc(bytes_needed, "../providers/implementations/rands/crngt.c", 141);
    if (ent == 
# 142 "../providers/implementations/rands/crngt.c" 3 4
              ((void *)0)
# 142 "../providers/implementations/rands/crngt.c"
                  )
        goto unlock_return;

    OSSL_SELF_TEST_get_callback(libctx, &stcb, &stcbarg);
    if (stcb != 
# 146 "../providers/implementations/rands/crngt.c" 3 4
               ((void *)0)
# 146 "../providers/implementations/rands/crngt.c"
                   ) {
        st = OSSL_SELF_TEST_new(stcb, stcbarg);
        if (st == 
# 148 "../providers/implementations/rands/crngt.c" 3 4
                 ((void *)0)
# 148 "../providers/implementations/rands/crngt.c"
                     )
            goto err;
        OSSL_SELF_TEST_onbegin(st, "Continuous_RNG_Test",
                               "RNG");
    }
    ...
    *pout = ent;
    ent = 
# 176 "../providers/implementations/rands/crngt.c" 3 4
         ((void *)0)
# 176 "../providers/implementations/rands/crngt.c"
             ;

 err:
    OSSL_SELF_TEST_onend(st, crng_test_pass);
    OSSL_SELF_TEST_free(st);
    CRYPTO_secure_clear_free(ent, bytes_needed, "../providers/implementations/rands/crngt.c", 181);
...
void ossl_crngt_cleanup_entropy(__attribute__((unused)) PROV_DRBG *drbg,
                                unsigned char *out, size_t outlen)
{
    CRYPTO_secure_clear_free(out, outlen, "../providers/implementations/rands/crngt.c", 191);
}
