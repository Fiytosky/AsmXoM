# 0 "../providers/implementations/signature/sm2_sig.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/implementations/signature/sm2_sig.c"
# 14 "../providers/implementations/signature/sm2_sig.c"
...
# 15 "../providers/implementations/signature/sm2_sig.c" 2
...
# 17 "../providers/implementations/signature/sm2_sig.c" 2
...
# 18 "../providers/implementations/signature/sm2_sig.c" 2
...
# 19 "../providers/implementations/signature/sm2_sig.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/implementations/signature/sm2_sig.c" 2
...
extern int DSA_meth_set_keygen(DSA_METHOD *dsam,
                                              int (*keygen) (DSA *));
# 21 "../providers/implementations/signature/sm2_sig.c" 2
...
# 22 "../providers/implementations/signature/sm2_sig.c" 2
...
# 23 "../providers/implementations/signature/sm2_sig.c" 2
...
# 24 "../providers/implementations/signature/sm2_sig.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 25 "../providers/implementations/signature/sm2_sig.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 26 "../providers/implementations/signature/sm2_sig.c" 2
# 1 "../include/internal/sizes.h" 1
# 12 "../include/internal/sizes.h"
        
# 27 "../providers/implementations/signature/sm2_sig.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 28 "../providers/implementations/signature/sm2_sig.c" 2
...
# 29 "../providers/implementations/signature/sm2_sig.c" 2
...
# 30 "../providers/implementations/signature/sm2_sig.c" 2
...
# 31 "../providers/implementations/signature/sm2_sig.c" 2
...
# 32 "../providers/implementations/signature/sm2_sig.c" 2
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst, int dlen,
                                  ...
                                  OSSL_LIB_CTX *libctx, const char *propq);
# 33 "../providers/implementations/signature/sm2_sig.c" 2
...
const unsigned char *ossl_sm2_algorithmidentifier_encoding(int md_nid,
                                                           size_t *len);
# 34 "../providers/implementations/signature/sm2_sig.c" 2
# 1 "providers/common/include/prov/der_sm2.h" 1
# 14 "providers/common/include/prov/der_sm2.h"
...
# 15 "providers/common/include/prov/der_sm2.h" 2
# 23 "providers/common/include/prov/der_sm2.h"
extern const unsigned char ossl_der_oid_sm2_with_SM3[10];
...
extern const unsigned char ossl_der_oid_curveSM2[10];
...
int ossl_DER_w_algorithmIdentifier_SM2_with_MD(WPACKET *pkt, int cont,
                                               EC_KEY *ec, int mdnid);
# 35 "../providers/implementations/signature/sm2_sig.c" 2
...
{
    if (psm2ctx->md == 
# 95 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 95 "../providers/implementations/signature/sm2_sig.c"
                          )
        psm2ctx->md = EVP_MD_fetch(psm2ctx->libctx, psm2ctx->mdname,
                                   psm2ctx->propq);
    if (psm2ctx->md == 
# 98 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 98 "../providers/implementations/signature/sm2_sig.c"
                          )
        return 0;

    if (mdname == 
# 101 "../providers/implementations/signature/sm2_sig.c" 3 4
                 ((void *)0)
# 101 "../providers/implementations/signature/sm2_sig.c"
                     )
        return 1;

    if (strlen(mdname) >= sizeof(psm2ctx->mdname)
        || !EVP_MD_is_a(psm2ctx->md, mdname)) {
        (ERR_new(), ERR_set_debug("../providers/implementations/signature/sm2_sig.c",106,__func__), ERR_set_error)(57, 122, "digest=%s",
                       mdname);
        return 0;
    }
...
{
    PROV_SM2_CTX *ctx = CRYPTO_zalloc(sizeof(PROV_SM2_CTX), "../providers/implementations/signature/sm2_sig.c", 117);

    if (ctx == 
# 119 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 119 "../providers/implementations/signature/sm2_sig.c"
                  )
        return 
# 120 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 120 "../providers/implementations/signature/sm2_sig.c"
                  ;

    ctx->libctx = ossl_prov_ctx_get0_libctx((provctx));
    if (propq != 
# 123 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0) 
# 123 "../providers/implementations/signature/sm2_sig.c"
                     && (ctx->propq = CRYPTO_strdup(propq, "../providers/implementations/signature/sm2_sig.c", 123)) == 
# 123 "../providers/implementations/signature/sm2_sig.c" 3 4
                                                                ((void *)0)
# 123 "../providers/implementations/signature/sm2_sig.c"
                                                                    ) {
        CRYPTO_free(ctx, "../providers/implementations/signature/sm2_sig.c", 124);
        return 
# 125 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 125 "../providers/implementations/signature/sm2_sig.c"
                  ;
    }
    ctx->mdsize = 32;
                                 ...
                                 const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_is_running()
            || psm2ctx == 
# 138 "../providers/implementations/signature/sm2_sig.c" 3 4
                         ((void *)0)
# 138 "../providers/implementations/signature/sm2_sig.c"
                             )
        return 0;

    if (ec == 
# 141 "../providers/implementations/signature/sm2_sig.c" 3 4
             ((void *)0) 
# 141 "../providers/implementations/signature/sm2_sig.c"
                  && psm2ctx->ec == 
# 141 "../providers/implementations/signature/sm2_sig.c" 3 4
                                    ((void *)0)
# 141 "../providers/implementations/signature/sm2_sig.c"
                                        ) {
        (ERR_new(), ERR_set_debug("../providers/implementations/signature/sm2_sig.c",142,__func__), ERR_set_error)((57),(114),
# 142 "../providers/implementations/signature/sm2_sig.c" 3 4
       ((void *)0)
# 142 "../providers/implementations/signature/sm2_sig.c"
       );
        return 0;
    }

    if (ec != 
# 146 "../providers/implementations/signature/sm2_sig.c" 3 4
             ((void *)0)
# 146 "../providers/implementations/signature/sm2_sig.c"
                 ) {
        if (!EC_KEY_up_ref(ec))
            return 0;
                       ...
                       size_t sigsize, const unsigned char *tbs, size_t tbslen)
{
    ...
    if (sig == 
# 165 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 165 "../providers/implementations/signature/sm2_sig.c"
                  ) {
        *siglen = ecsize;
        return 1;
    }
...
static void free_md(PROV_SM2_CTX *ctx)
{
    ...
    EVP_MD_free(ctx->md);
    ctx->mdctx = 
# 199 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0)
# 199 "../providers/implementations/signature/sm2_sig.c"
                    ;
    ctx->md = 
# 200 "../providers/implementations/signature/sm2_sig.c" 3 4
             ((void *)0)
# 200 "../providers/implementations/signature/sm2_sig.c"
                 ;
}
                                         ...
                                         void *ec, const OSSL_PARAM params[])
{
    ...
    if (ctx->mdctx == 
# 215 "../providers/implementations/signature/sm2_sig.c" 3 4
                     ((void *)0)
# 215 "../providers/implementations/signature/sm2_sig.c"
                         ) {
        ctx->mdctx = EVP_MD_CTX_new();
        if (ctx->mdctx == 
# 217 "../providers/implementations/signature/sm2_sig.c" 3 4
                         ((void *)0)
# 217 "../providers/implementations/signature/sm2_sig.c"
                             )
            goto error;
    }

    md_nid = EVP_MD_get_type(ctx->md);
# 230 "../providers/implementations/signature/sm2_sig.c"
    ctx->aid_len = 0;
...
{
    uint8_t *z = 
# 252 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0)
# 252 "../providers/implementations/signature/sm2_sig.c"
                    ;
    int ret = 1;
    ...
    if (ctx->flag_compute_z_digest) {
        ...
        if ((z = CRYPTO_zalloc(ctx->mdsize, "../providers/implementations/signature/sm2_sig.c", 259)) == 
# 259 "../providers/implementations/signature/sm2_sig.c" 3 4
                                                ((void *)0)

            
# 261 "../providers/implementations/signature/sm2_sig.c"
           || !ossl_sm2_compute_z_digest(z, ctx->md, ctx->id, ctx->id_len,
                                          ctx->ec)
            || !EVP_DigestUpdate(ctx->mdctx, z, ctx->mdsize))
            ret = 0;
        CRYPTO_free(z, "../providers/implementations/signature/sm2_sig.c", 265);
    }
                                    ...
                                    size_t datalen)
{
    ...
    if (psm2ctx == 
# 276 "../providers/implementations/signature/sm2_sig.c" 3 4
                  ((void *)0) 
# 276 "../providers/implementations/signature/sm2_sig.c"
                       || psm2ctx->mdctx == 
# 276 "../providers/implementations/signature/sm2_sig.c" 3 4
                                            ((void *)0)
# 276 "../providers/implementations/signature/sm2_sig.c"
                             ...
                             size_t sigsize)
{
    ...
    if (psm2ctx == 
# 290 "../providers/implementations/signature/sm2_sig.c" 3 4
                  ((void *)0) 
# 290 "../providers/implementations/signature/sm2_sig.c"
                       || psm2ctx->mdctx == 
# 290 "../providers/implementations/signature/sm2_sig.c" 3 4
                                            ((void *)0)
# 290 "../providers/implementations/signature/sm2_sig.c"
    ...
    if (sig != 
# 297 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 297 "../providers/implementations/signature/sm2_sig.c"
                  ) {
                               ...
                               size_t siglen)
{
    ...
    if (psm2ctx == 
# 314 "../providers/implementations/signature/sm2_sig.c" 3 4
                  ((void *)0)
        
# 315 "../providers/implementations/signature/sm2_sig.c"
       || psm2ctx->mdctx == 
# 315 "../providers/implementations/signature/sm2_sig.c" 3 4
                            ((void *)0)
        
# 316 "../providers/implementations/signature/sm2_sig.c"
...
static void sm2sig_freectx(void *vpsm2ctx)
{
    ...
    free_md(ctx);
    EC_KEY_free(ctx->ec);
    CRYPTO_free(ctx->propq, "../providers/implementations/signature/sm2_sig.c", 332);
    CRYPTO_free(ctx->id, "../providers/implementations/signature/sm2_sig.c", 333);
    CRYPTO_free(ctx, "../providers/implementations/signature/sm2_sig.c", 334);
}
...
static void *sm2sig_dupctx(void *vpsm2ctx)
{
    ...
    dstctx = CRYPTO_zalloc(sizeof(*srcctx), "../providers/implementations/signature/sm2_sig.c", 342);
    if (dstctx == 
# 343 "../providers/implementations/signature/sm2_sig.c" 3 4
                 ((void *)0)
# 343 "../providers/implementations/signature/sm2_sig.c"
                     )
        return 
# 344 "../providers/implementations/signature/sm2_sig.c" 3 4
              ((void *)0)
# 344 "../providers/implementations/signature/sm2_sig.c"
                  ;

    *dstctx = *srcctx;
    dstctx->ec = 
# 347 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0)
# 347 "../providers/implementations/signature/sm2_sig.c"
                    ;
    dstctx->propq = 
# 348 "../providers/implementations/signature/sm2_sig.c" 3 4
                   ((void *)0)
# 348 "../providers/implementations/signature/sm2_sig.c"
                       ;
    dstctx->md = 
# 349 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0)
# 349 "../providers/implementations/signature/sm2_sig.c"
                    ;
    dstctx->mdctx = 
# 350 "../providers/implementations/signature/sm2_sig.c" 3 4
                   ((void *)0)
# 350 "../providers/implementations/signature/sm2_sig.c"
                       ;
    dstctx->id = 
# 351 "../providers/implementations/signature/sm2_sig.c" 3 4
                ((void *)0)
# 351 "../providers/implementations/signature/sm2_sig.c"
                    ;

    if (srcctx->ec != 
# 353 "../providers/implementations/signature/sm2_sig.c" 3 4
                     ((void *)0) 
# 353 "../providers/implementations/signature/sm2_sig.c"
                          && !EC_KEY_up_ref(srcctx->ec))
        goto err;
    dstctx->ec = srcctx->ec;

    if (srcctx->propq != 
# 357 "../providers/implementations/signature/sm2_sig.c" 3 4
                        ((void *)0)
# 357 "../providers/implementations/signature/sm2_sig.c"
                            ) {
        dstctx->propq = CRYPTO_strdup(srcctx->propq, "../providers/implementations/signature/sm2_sig.c", 358);
        if (dstctx->propq == 
# 359 "../providers/implementations/signature/sm2_sig.c" 3 4
                            ((void *)0)
# 359 "../providers/implementations/signature/sm2_sig.c"
                                )
            goto err;
    }

    if (srcctx->md != 
# 363 "../providers/implementations/signature/sm2_sig.c" 3 4
                     ((void *)0) 
# 363 "../providers/implementations/signature/sm2_sig.c"
                          && !EVP_MD_up_ref(srcctx->md))
        goto err;
    dstctx->md = srcctx->md;

    if (srcctx->mdctx != 
# 367 "../providers/implementations/signature/sm2_sig.c" 3 4
                        ((void *)0)
# 367 "../providers/implementations/signature/sm2_sig.c"
                            ) {
        dstctx->mdctx = EVP_MD_CTX_new();
        if (dstctx->mdctx == 
# 369 "../providers/implementations/signature/sm2_sig.c" 3 4
                            ((void *)0)
                
# 370 "../providers/implementations/signature/sm2_sig.c"
               || !EVP_MD_CTX_copy_ex(dstctx->mdctx, srcctx->mdctx))
            goto err;
    }

    if (srcctx->id != 
# 374 "../providers/implementations/signature/sm2_sig.c" 3 4
                     ((void *)0)
# 374 "../providers/implementations/signature/sm2_sig.c"
                         ) {
        dstctx->id = CRYPTO_malloc(srcctx->id_len, "../providers/implementations/signature/sm2_sig.c", 375);
        if (dstctx->id == 
# 376 "../providers/implementations/signature/sm2_sig.c" 3 4
                         ((void *)0)
# 376 "../providers/implementations/signature/sm2_sig.c"
                             )
            goto err;
 ...
 err:
    ...
    return 
# 385 "../providers/implementations/signature/sm2_sig.c" 3 4
          ((void *)0)
# 385 "../providers/implementations/signature/sm2_sig.c"
              ;
}
...
static int sm2sig_get_ctx_params(void *vpsm2ctx, OSSL_PARAM *params)
{
    ...
    if (psm2ctx == 
# 393 "../providers/implementations/signature/sm2_sig.c" 3 4
                  ((void *)0)
# 393 "../providers/implementations/signature/sm2_sig.c"
                      )
        return 0;

    p = OSSL_PARAM_locate(params, "algorithm-id");
    if (p != 
# 397 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0)
        
# 398 "../providers/implementations/signature/sm2_sig.c"
       && !OSSL_PARAM_set_octet_string(p, psm2ctx->aid, psm2ctx->aid_len))
        return 0;

    p = OSSL_PARAM_locate(params, "digest-size");
    if (p != 
# 402 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0) 
# 402 "../providers/implementations/signature/sm2_sig.c"
                 && !OSSL_PARAM_set_size_t(p, psm2ctx->mdsize))
        return 0;

    p = OSSL_PARAM_locate(params, "digest");
    if (p != 
# 406 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0) 
# 406 "../providers/implementations/signature/sm2_sig.c"
                 && !OSSL_PARAM_set_utf8_string(p, psm2ctx->md == 
# 406 "../providers/implementations/signature/sm2_sig.c" 3 4
                                                                  ((void *)0)
                                                    
# 407 "../providers/implementations/signature/sm2_sig.c"
                                                   ? psm2ctx->mdname
...
static const OSSL_PARAM known_gettable_ctx_params[] = {
    { (("algorithm-id")), (5), ((
# 415 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 415 "../providers/implementations/signature/sm2_sig.c"
   )), (0), ((size_t)-1) },
    { (("digest-size")), (2), ((
# 416 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 416 "../providers/implementations/signature/sm2_sig.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("digest")), (4), ((
# 417 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 417 "../providers/implementations/signature/sm2_sig.c"
   )), (0), ((size_t)-1) },
    { 
# 418 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 418 "../providers/implementations/signature/sm2_sig.c"
   , 0, 
# 418 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 418 "../providers/implementations/signature/sm2_sig.c"
...
static const OSSL_PARAM *sm2sig_gettable_ctx_params(__attribute__((unused)) void *vpsm2ctx,
...
static int sm2sig_set_ctx_params(void *vpsm2ctx, const OSSL_PARAM params[])
{
    ...
    if (psm2ctx == 
# 433 "../providers/implementations/signature/sm2_sig.c" 3 4
                  ((void *)0)
# 433 "../providers/implementations/signature/sm2_sig.c"
                      )
        return 0;
    if (params == 
# 435 "../providers/implementations/signature/sm2_sig.c" 3 4
                 ((void *)0)
# 435 "../providers/implementations/signature/sm2_sig.c"
                     )
        return 1;

    p = OSSL_PARAM_locate_const(params, "distid");
    if (p != 
# 439 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0)
# 439 "../providers/implementations/signature/sm2_sig.c"
                ) {
        void *tmp_id = 
# 440 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 440 "../providers/implementations/signature/sm2_sig.c"
                          ;
        size_t tmp_idlen = 0;
        ...
        if (p->data_size != 0
            ...
            return 0;
        CRYPTO_free(psm2ctx->id, "../providers/implementations/signature/sm2_sig.c", 452);
        psm2ctx->id = tmp_id;
    ...
    if (p != 
# 464 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0) 
# 464 "../providers/implementations/signature/sm2_sig.c"
                 && (!OSSL_PARAM_get_size_t(p, &mdsize)
                      || mdsize != psm2ctx->mdsize))
        return 0;

    p = OSSL_PARAM_locate_const(params, "digest");
    if (p != 
# 469 "../providers/implementations/signature/sm2_sig.c" 3 4
            ((void *)0)
# 469 "../providers/implementations/signature/sm2_sig.c"
                ) {
        char *mdname = 
# 470 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 470 "../providers/implementations/signature/sm2_sig.c"
                          ;

        if (!OSSL_PARAM_get_utf8_string(p, &mdname, 0))
            return 0;
        if (!sm2sig_set_mdname(psm2ctx, mdname)) {
            CRYPTO_free(mdname, "../providers/implementations/signature/sm2_sig.c", 475);
            return 0;
        }
        CRYPTO_free(mdname, "../providers/implementations/signature/sm2_sig.c", 478);
    }
...
static const OSSL_PARAM known_settable_ctx_params[] = {
    { (("digest-size")), (2), ((
# 485 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 485 "../providers/implementations/signature/sm2_sig.c"
   )), (sizeof(size_t)), ((size_t)-1) },
    { (("digest")), (4), ((
# 486 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 486 "../providers/implementations/signature/sm2_sig.c"
   )), (0), ((size_t)-1) },
    { (("distid")), (5), ((
# 487 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 487 "../providers/implementations/signature/sm2_sig.c"
   )), (0), ((size_t)-1) },
    { 
# 488 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 488 "../providers/implementations/signature/sm2_sig.c"
   , 0, 
# 488 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0)
# 488 "../providers/implementations/signature/sm2_sig.c"
...
static const OSSL_PARAM *sm2sig_settable_ctx_params(__attribute__((unused)) void *vpsm2ctx,
                                                    __attribute__((unused)) void *provctx)
{
...
static int sm2sig_get_ctx_md_params(void *vpsm2ctx, OSSL_PARAM *params)
{
    ...
    if (psm2ctx->mdctx == 
# 501 "../providers/implementations/signature/sm2_sig.c" 3 4
                         ((void *)0)
# 501 "../providers/implementations/signature/sm2_sig.c"
                             )
        return 0;
...
static const OSSL_PARAM *sm2sig_gettable_ctx_md_params(void *vpsm2ctx)
{
    ...
    if (psm2ctx->md == 
# 511 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 511 "../providers/implementations/signature/sm2_sig.c"
                          )
        return 0;
...
static int sm2sig_set_ctx_md_params(void *vpsm2ctx, const OSSL_PARAM params[])
{
    ...
    if (psm2ctx->mdctx == 
# 521 "../providers/implementations/signature/sm2_sig.c" 3 4
                         ((void *)0)
# 521 "../providers/implementations/signature/sm2_sig.c"
                             )
        return 0;
...
static const OSSL_PARAM *sm2sig_settable_ctx_md_params(void *vpsm2ctx)
{
    ...
    if (psm2ctx->md == 
# 531 "../providers/implementations/signature/sm2_sig.c" 3 4
                      ((void *)0)
# 531 "../providers/implementations/signature/sm2_sig.c"
                          )
        return 0;
...
const OSSL_DISPATCH ossl_sm2_signature_functions[] = {
    { 1, (void (*)(void))sm2sig_newctx },
    { 2, (void (*)(void))sm2sig_signature_init },
    { 3, (void (*)(void))sm2sig_sign },
    { 4, (void (*)(void))sm2sig_signature_init },
    { 5, (void (*)(void))sm2sig_verify },
    { 8,
    ...
    { 16, (void (*)(void))sm2sig_freectx },
    { 17, (void (*)(void))sm2sig_dupctx },
    { 18, (void (*)(void))sm2sig_get_ctx_params },
    { 19,
      (void (*)(void))sm2sig_gettable_ctx_params },
    { 20, (void (*)(void))sm2sig_set_ctx_params },
    { 21,
    ...
    { 0, 
# 571 "../providers/implementations/signature/sm2_sig.c" 3 4
   ((void *)0) 
# 571 "../providers/implementations/signature/sm2_sig.c"
   }
};
