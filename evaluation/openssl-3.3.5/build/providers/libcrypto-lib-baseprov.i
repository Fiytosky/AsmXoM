# 0 "../providers/baseprov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/baseprov.c"
# 10 "../providers/baseprov.c"
...
# 15 "../providers/baseprov.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 16 "../providers/baseprov.c" 2
...
# 22 "../providers/baseprov.c" 2
# 1 "../providers/implementations/include/prov/names.h" 1
# 23 "../providers/baseprov.c" 2
...
# 33 "../providers/baseprov.c" 3 4
                                                             ((void *)0)
# 33 "../providers/baseprov.c"
                                                                 ;
static OSSL_FUNC_core_get_params_fn *c_get_params = 
# 34 "../providers/baseprov.c" 3 4
                                                   ((void *)0)
# 34 "../providers/baseprov.c"
                                                       ;


static const OSSL_PARAM base_param_types[] = {
    { ("name"), (6), (
# 38 "../providers/baseprov.c" 3 4
   ((void *)0)
# 38 "../providers/baseprov.c"
   ), (0), ((size_t)-1) },
    { ("version"), (6), (
# 39 "../providers/baseprov.c" 3 4
   ((void *)0)
# 39 "../providers/baseprov.c"
   ), (0), ((size_t)-1) },
    { ("buildinfo"), (6), (
# 40 "../providers/baseprov.c" 3 4
   ((void *)0)
# 40 "../providers/baseprov.c"
   ), (0), ((size_t)-1) },
    { ("status"), (1), (
# 41 "../providers/baseprov.c" 3 4
   ((void *)0)
# 41 "../providers/baseprov.c"
   ), (0), ((size_t)-1) },
    { 
# 42 "../providers/baseprov.c" 3 4
   ((void *)0)
# 42 "../providers/baseprov.c"
   , 0, 
# 42 "../providers/baseprov.c" 3 4
   ((void *)0)
# 42 "../providers/baseprov.c"
...
static int base_get_params(void *provctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 55 "../providers/baseprov.c" 3 4
            ((void *)0)
            
# 56 "../providers/baseprov.c"
           && !OSSL_PARAM_set_utf8_ptr(p, "OpenSSL Base Provider"))
        return 0;
    p = OSSL_PARAM_locate(params, "version");
    if (p != 
# 59 "../providers/baseprov.c" 3 4
            ((void *)0) 
# 59 "../providers/baseprov.c"
                 && !OSSL_PARAM_set_utf8_ptr(p, "3.3.5"))
        return 0;
    p = OSSL_PARAM_locate(params, "buildinfo");
    if (p != 
# 62 "../providers/baseprov.c" 3 4
            ((void *)0) 
# 62 "../providers/baseprov.c"
                 && !OSSL_PARAM_set_utf8_ptr(p, "3.3.5"))
        return 0;
    p = OSSL_PARAM_locate(params, "status");
    if (p != 
# 65 "../providers/baseprov.c" 3 4
            ((void *)0) 
# 65 "../providers/baseprov.c"
...
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_rsa_to_text_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_rsapss_to_text_encoder_functions) },

{ "DH", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_dh_to_text_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_dhx_to_text_encoder_functions) },


{ "DSA", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_dsa_to_text_encoder_functions) },


{ "EC", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_ec_to_text_encoder_functions) },

{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_ed25519_to_text_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_ed448_to_text_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_x25519_to_text_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=text", (ossl_x448_to_text_encoder_functions) },


{ "SM2", "provider=" "base" ",fips=" "no" ",output=text", (ossl_sm2_to_text_encoder_functions) },
# 96 "../providers/encoders.inc"
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "type-specific", (ossl_rsa_to_type_specific_keypair_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "type-specific", (ossl_rsa_to_type_specific_keypair_pem_encoder_functions) },


{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "type-specific", (ossl_dh_to_type_specific_params_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "type-specific", (ossl_dh_to_type_specific_params_pem_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "type-specific", (ossl_dhx_to_type_specific_params_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "type-specific", (ossl_dhx_to_type_specific_params_pem_encoder_functions) },


{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "type-specific", (ossl_dsa_to_type_specific_der_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "type-specific", (ossl_dsa_to_type_specific_pem_encoder_functions) },



{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "type-specific", (ossl_ec_to_type_specific_no_pub_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "type-specific", (ossl_ec_to_type_specific_no_pub_pem_encoder_functions) },

{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "blob", (ossl_ec_to_blob_encoder_functions) },

{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "der" ",structure=" "type-specific", (ossl_sm2_to_type_specific_no_pub_der_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "pem" ",structure=" "type-specific", (ossl_sm2_to_type_specific_no_pub_pem_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "blob", (ossl_sm2_to_blob_encoder_functions) },
...
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "msblob", (ossl_rsa_to_msblob_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pvk", (ossl_rsa_to_pvk_encoder_functions) },

{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "msblob", (ossl_dsa_to_msblob_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pvk", (ossl_dsa_to_pvk_encoder_functions) },
# 139 "../providers/encoders.inc"
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_rsa_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_rsa_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_rsa_to_PrivateKeyInfo_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_rsa_to_PrivateKeyInfo_pem_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_rsa_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_rsa_to_SubjectPublicKeyInfo_pem_encoder_functions) },

{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_rsapss_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_rsapss_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_rsapss_to_PrivateKeyInfo_der_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_rsapss_to_PrivateKeyInfo_pem_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_rsapss_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_rsapss_to_SubjectPublicKeyInfo_pem_encoder_functions) },


{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dh_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dh_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_dh_to_PrivateKeyInfo_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_dh_to_PrivateKeyInfo_pem_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_dh_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_dh_to_SubjectPublicKeyInfo_pem_encoder_functions) },

{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dhx_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dhx_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_dhx_to_PrivateKeyInfo_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_dhx_to_PrivateKeyInfo_pem_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_dhx_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_dhx_to_SubjectPublicKeyInfo_pem_encoder_functions) },



{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dsa_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_dsa_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_dsa_to_PrivateKeyInfo_der_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_dsa_to_PrivateKeyInfo_pem_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_dsa_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_dsa_to_SubjectPublicKeyInfo_pem_encoder_functions) },



{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ec_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ec_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_ec_to_PrivateKeyInfo_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_ec_to_PrivateKeyInfo_pem_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_ec_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_ec_to_SubjectPublicKeyInfo_pem_encoder_functions) },


{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_x25519_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_x25519_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_x25519_to_PrivateKeyInfo_der_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_x25519_to_PrivateKeyInfo_pem_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_x25519_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_x25519_to_SubjectPublicKeyInfo_pem_encoder_functions) },

{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_x448_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_x448_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_x448_to_PrivateKeyInfo_der_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_x448_to_PrivateKeyInfo_pem_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_x448_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_x448_to_SubjectPublicKeyInfo_pem_encoder_functions) },

{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ed25519_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ed25519_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_ed25519_to_PrivateKeyInfo_der_encoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_ed25519_to_PrivateKeyInfo_pem_encoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_ed25519_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_ed25519_to_SubjectPublicKeyInfo_pem_encoder_functions) },

{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ed448_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_ed448_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_ed448_to_PrivateKeyInfo_der_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_ed448_to_PrivateKeyInfo_pem_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_ed448_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_ed448_to_SubjectPublicKeyInfo_pem_encoder_functions) },



{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_sm2_to_EncryptedPrivateKeyInfo_der_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "pem" ",structure=" "EncryptedPrivateKeyInfo", (ossl_sm2_to_EncryptedPrivateKeyInfo_pem_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "der" ",structure=" "PrivateKeyInfo", (ossl_sm2_to_PrivateKeyInfo_der_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "pem" ",structure=" "PrivateKeyInfo", (ossl_sm2_to_PrivateKeyInfo_pem_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_sm2_to_SubjectPublicKeyInfo_der_encoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",output=" "pem" ",structure=" "SubjectPublicKeyInfo", (ossl_sm2_to_SubjectPublicKeyInfo_pem_encoder_functions) },
# 234 "../providers/encoders.inc"
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "rsa", (ossl_rsa_to_RSA_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "rsa", (ossl_rsa_to_RSA_pem_encoder_functions) },


{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "dh", (ossl_dh_to_DH_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "dh", (ossl_dh_to_DH_pem_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "dhx", (ossl_dhx_to_DHX_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "dhx", (ossl_dhx_to_DHX_pem_encoder_functions) },


{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "dsa", (ossl_dsa_to_DSA_der_encoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "dsa", (ossl_dsa_to_DSA_pem_encoder_functions) },


{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "ec", (ossl_ec_to_EC_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "ec", (ossl_ec_to_EC_pem_encoder_functions) },
# 259 "../providers/encoders.inc"
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "pkcs1", (ossl_rsa_to_PKCS1_der_encoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "pkcs1", (ossl_rsa_to_PKCS1_pem_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "pkcs1", (ossl_rsapss_to_PKCS1_der_encoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "pkcs1", (ossl_rsapss_to_PKCS1_pem_encoder_functions) },


{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "pkcs3", (ossl_dh_to_PKCS3_der_encoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "pkcs3", (ossl_dh_to_PKCS3_pem_encoder_functions) },

{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "X9.42", (ossl_dhx_to_X9_42_der_encoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "X9.42", (ossl_dhx_to_X9_42_pem_encoder_functions) },



{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "der" ",structure=" "X9.62", (ossl_ec_to_X9_62_der_encoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",output=" "pem" ",structure=" "X9.62", (ossl_ec_to_X9_62_pem_encoder_functions) },
# 74 "../providers/baseprov.c" 2
    { 
# 74 "../providers/baseprov.c" 3 4
     ((void *)0)
# 74 "../providers/baseprov.c"
         , 
# 74 "../providers/baseprov.c" 3 4
           ((void *)0)
# 74 "../providers/baseprov.c"
...
{ "DH", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_dh_decoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_dh_decoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_params_der_to_dh_decoder_functions) },
{ "DH", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "dh", (ossl_DH_der_to_dh_decoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_dhx_decoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_dhx_decoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_params_der_to_dhx_decoder_functions) },
{ "DHX", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "dhx", (ossl_DHX_der_to_dhx_decoder_functions) },


{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_dsa_decoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_dsa_decoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_der_to_dsa_decoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "dsa", (ossl_DSA_der_to_dsa_decoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "msblob", (ossl_msblob_to_dsa_decoder_functions) },
{ "DSA", "provider=" "base" ",fips=" "yes" ",input=" "pvk", (ossl_pvk_to_dsa_decoder_functions) },


{ "EC", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_ec_decoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_ec_decoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_no_pub_der_to_ec_decoder_functions) },
{ "EC", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "ec", (ossl_EC_der_to_ec_decoder_functions) },

{ "ED25519", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_ed25519_decoder_functions) },
{ "ED25519", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_ed25519_decoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_ed448_decoder_functions) },
{ "ED448", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_ed448_decoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_x25519_decoder_functions) },
{ "X25519", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_x25519_decoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_x448_decoder_functions) },
{ "X448", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_x448_decoder_functions) },


{ "SM2", "provider=" "base" ",fips=" "no" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_sm2_decoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_sm2_decoder_functions) },
{ "SM2", "provider=" "base" ",fips=" "no" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_no_pub_der_to_sm2_decoder_functions) },


{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_rsa_decoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_rsa_decoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "type-specific", (ossl_type_specific_keypair_der_to_rsa_decoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "rsa", (ossl_RSA_der_to_rsa_decoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "PrivateKeyInfo", (ossl_PrivateKeyInfo_der_to_rsapss_decoder_functions) },
{ "RSA-PSS", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_rsapss_decoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "msblob", (ossl_msblob_to_rsa_decoder_functions) },
{ "RSA", "provider=" "base" ",fips=" "yes" ",input=" "pvk", (ossl_pvk_to_rsa_decoder_functions) },





{ "DER", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "SubjectPublicKeyInfo", (ossl_SubjectPublicKeyInfo_der_to_der_decoder_functions) },
{ "DER", "provider=" "base" ",fips=" "yes" ",input=" "pem", (ossl_pem_to_der_decoder_functions) },





{ "DER", "provider=" "base" ",fips=" "yes" ",input=" "der" ",structure=" "EncryptedPrivateKeyInfo", (ossl_EncryptedPrivateKeyInfo_der_to_der_decoder_functions) },
# 81 "../providers/baseprov.c" 2
    { 
# 81 "../providers/baseprov.c" 3 4
     ((void *)0)
# 81 "../providers/baseprov.c"
         , 
# 81 "../providers/baseprov.c" 3 4
           ((void *)0)
# 81 "../providers/baseprov.c"
...
# 90 "../providers/baseprov.c" 2
    { 
# 90 "../providers/baseprov.c" 3 4
     ((void *)0)
# 90 "../providers/baseprov.c"
         , 
# 90 "../providers/baseprov.c" 3 4
           ((void *)0)
# 90 "../providers/baseprov.c"
...
static const OSSL_ALGORITHM base_rands[] = {
    { "SEED-SRC", "provider=base", ossl_seed_src_functions },
    { 
# 96 "../providers/baseprov.c" 3 4
     ((void *)0)
# 96 "../providers/baseprov.c"
         , 
# 96 "../providers/baseprov.c" 3 4
           ((void *)0)
# 96 "../providers/baseprov.c"
                                         ...
                                         int *no_cache)
{
    *no_cache = 0;
    ...
    return 
# 113 "../providers/baseprov.c" 3 4
          ((void *)0)
# 113 "../providers/baseprov.c"
              ;
}
...
static const OSSL_DISPATCH base_dispatch_table[] = {
    { 1024, (void (*)(void))base_teardown },
    { 1025,
      (void (*)(void))base_gettable_params },
    { 1026, (void (*)(void))base_get_params },
    { 1027, (void (*)(void))base_query },
    { 0, 
# 129 "../providers/baseprov.c" 3 4
   ((void *)0) 
# 129 "../providers/baseprov.c"
   }
};
...
# 138 "../providers/baseprov.c" 3 4
                                                ((void *)0)
# 138 "../providers/baseprov.c"
                                                    ;
    BIO_METHOD *corebiometh;
    ...
    if (c_get_libctx == 
# 160 "../providers/baseprov.c" 3 4
                       ((void *)0)
# 160 "../providers/baseprov.c"
                           )
        return 0;
# 171 "../providers/baseprov.c"
    if ((*provctx = ossl_prov_ctx_new()) == 
# 171 "../providers/baseprov.c" 3 4
                                           ((void *)0)
            
# 172 "../providers/baseprov.c"
           || (corebiometh = ossl_bio_prov_init_bio_method()) == 
# 172 "../providers/baseprov.c" 3 4
                                                                 ((void *)0)
# 172 "../providers/baseprov.c"
                                                                     ) {
        ossl_prov_ctx_free(*provctx);
        *provctx = 
# 174 "../providers/baseprov.c" 3 4
                  ((void *)0)
# 174 "../providers/baseprov.c"
                      ;
        return 0;
    }
