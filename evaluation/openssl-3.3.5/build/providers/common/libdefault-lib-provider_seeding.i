# 0 "../providers/common/provider_seeding.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/provider_seeding.c"
# 10 "../providers/common/provider_seeding.c"
...
# 11 "../providers/common/provider_seeding.c" 2
...
void ossl_prov_cleanup_nonce(PROV_CTX *prov_ctx, unsigned char *buf,
                             size_t len);
# 12 "../providers/common/provider_seeding.c" 2
...
# 13 "../providers/common/provider_seeding.c" 2

static OSSL_FUNC_get_entropy_fn *c_get_entropy = 
# 14 "../providers/common/provider_seeding.c" 3 4
                                                ((void *)0)
# 14 "../providers/common/provider_seeding.c"
                                                    ;
static OSSL_FUNC_get_user_entropy_fn *c_get_user_entropy = 
# 15 "../providers/common/provider_seeding.c" 3 4
                                                          ((void *)0)
# 15 "../providers/common/provider_seeding.c"
                                                              ;
static OSSL_FUNC_cleanup_entropy_fn *c_cleanup_entropy = 
# 16 "../providers/common/provider_seeding.c" 3 4
                                                        ((void *)0)
# 16 "../providers/common/provider_seeding.c"
                                                            ;
static OSSL_FUNC_cleanup_user_entropy_fn *c_cleanup_user_entropy = 
# 17 "../providers/common/provider_seeding.c" 3 4
                                                                  ((void *)0)
# 17 "../providers/common/provider_seeding.c"
                                                                      ;
static OSSL_FUNC_get_nonce_fn *c_get_nonce = 
# 18 "../providers/common/provider_seeding.c" 3 4
                                            ((void *)0)
# 18 "../providers/common/provider_seeding.c"
                                                ;
static OSSL_FUNC_get_user_nonce_fn *c_get_user_nonce = 
# 19 "../providers/common/provider_seeding.c" 3 4
                                                      ((void *)0)
# 19 "../providers/common/provider_seeding.c"
                                                          ;
static OSSL_FUNC_cleanup_nonce_fn *c_cleanup_nonce = 
# 20 "../providers/common/provider_seeding.c" 3 4
                                                    ((void *)0)
# 20 "../providers/common/provider_seeding.c"
                                                        ;
static OSSL_FUNC_cleanup_user_nonce_fn *c_cleanup_user_nonce = 
# 21 "../providers/common/provider_seeding.c" 3 4
                                                              ((void *)0)
# 21 "../providers/common/provider_seeding.c"
                                                                  ;
# 41 "../providers/common/provider_seeding.c"
int ossl_prov_seeding_from_dispatch(const OSSL_DISPATCH *fns)
{
    for (; fns->function_id != 0; fns++) {
        ...
        case 101:
            do { if (c_get_entropy == 
# 53 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 53 "../providers/common/provider_seeding.c"
           ) c_get_entropy = OSSL_FUNC_get_entropy(fns); else if (c_get_entropy != OSSL_FUNC_get_entropy(fns)) return 0; } while (0);
            break;
        case 98:
            do { if (c_get_user_entropy == 
# 56 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 56 "../providers/common/provider_seeding.c"
           ) c_get_user_entropy = OSSL_FUNC_get_user_entropy(fns); else if (c_get_user_entropy != OSSL_FUNC_get_user_entropy(fns)) return 0; } while (0);
            break;
        case 102:
            do { if (c_cleanup_entropy == 
# 59 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 59 "../providers/common/provider_seeding.c"
           ) c_cleanup_entropy = OSSL_FUNC_cleanup_entropy(fns); else if (c_cleanup_entropy != OSSL_FUNC_cleanup_entropy(fns)) return 0; } while (0);
            break;
        case 96:
            do { if (c_cleanup_user_entropy == 
# 62 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 62 "../providers/common/provider_seeding.c"
           ) c_cleanup_user_entropy = OSSL_FUNC_cleanup_user_entropy(fns); else if (c_cleanup_user_entropy != OSSL_FUNC_cleanup_user_entropy(fns)) return 0; } while (0);
            break;
        case 103:
            do { if (c_get_nonce == 
# 65 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 65 "../providers/common/provider_seeding.c"
           ) c_get_nonce = OSSL_FUNC_get_nonce(fns); else if (c_get_nonce != OSSL_FUNC_get_nonce(fns)) return 0; } while (0);
            break;
        case 99:
            do { if (c_get_user_nonce == 
# 68 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 68 "../providers/common/provider_seeding.c"
           ) c_get_user_nonce = OSSL_FUNC_get_user_nonce(fns); else if (c_get_user_nonce != OSSL_FUNC_get_user_nonce(fns)) return 0; } while (0);
            break;
        case 104:
            do { if (c_cleanup_nonce == 
# 71 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 71 "../providers/common/provider_seeding.c"
           ) c_cleanup_nonce = OSSL_FUNC_cleanup_nonce(fns); else if (c_cleanup_nonce != OSSL_FUNC_cleanup_nonce(fns)) return 0; } while (0);
            break;
        case 97:
            do { if (c_cleanup_user_nonce == 
# 74 "../providers/common/provider_seeding.c" 3 4
           ((void *)0)
# 74 "../providers/common/provider_seeding.c"
           ) c_cleanup_user_nonce = OSSL_FUNC_cleanup_user_nonce(fns); else if (c_cleanup_user_nonce != OSSL_FUNC_cleanup_user_nonce(fns)) return 0; } while (0);
            break;
        }
...
size_t ossl_prov_get_entropy(PROV_CTX *prov_ctx, unsigned char **pout,
                             int entropy, size_t min_len, size_t max_len)
{
    const OSSL_CORE_HANDLE *handle = ossl_prov_ctx_get0_handle(prov_ctx);

    if (c_get_user_entropy != 
# 87 "../providers/common/provider_seeding.c" 3 4
                             ((void *)0)
# 87 "../providers/common/provider_seeding.c"
                                 )
        return c_get_user_entropy(handle, pout, entropy, min_len, max_len);
    if (c_get_entropy != 
# 89 "../providers/common/provider_seeding.c" 3 4
                        ((void *)0)
# 89 "../providers/common/provider_seeding.c"
                            )
                               ...
                               size_t len)
{
    ...
    if (c_cleanup_user_entropy != 
# 99 "../providers/common/provider_seeding.c" 3 4
                                 ((void *)0)
# 99 "../providers/common/provider_seeding.c"
                                     )
        c_cleanup_user_entropy(handle, buf, len);
    else if (c_cleanup_entropy != 
# 101 "../providers/common/provider_seeding.c" 3 4
                                 ((void *)0)
# 101 "../providers/common/provider_seeding.c"
                                     )
                           ...
                           const void *salt, size_t salt_len)
{
    ...
    if (c_get_user_nonce != 
# 111 "../providers/common/provider_seeding.c" 3 4
                           ((void *)0)
# 111 "../providers/common/provider_seeding.c"
                               )
        return c_get_user_nonce(handle, pout, min_len, max_len, salt, salt_len);
    if (c_get_nonce != 
# 113 "../providers/common/provider_seeding.c" 3 4
                      ((void *)0)
# 113 "../providers/common/provider_seeding.c"
                          )
...
void ossl_prov_cleanup_nonce(PROV_CTX *prov_ctx, unsigned char *buf, size_t len)
{
    ...
    if (c_cleanup_user_nonce != 
# 122 "../providers/common/provider_seeding.c" 3 4
                               ((void *)0)
# 122 "../providers/common/provider_seeding.c"
                                   )
        c_cleanup_user_nonce(handle, buf, len);
    else if (c_cleanup_nonce != 
# 124 "../providers/common/provider_seeding.c" 3 4
                               ((void *)0)
# 124 "../providers/common/provider_seeding.c"
                                   )
