# 0 "../providers/common/provider_ctx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/provider_ctx.c"
# 10 "../providers/common/provider_ctx.c"
...
# 11 "../providers/common/provider_ctx.c" 2
...
# 12 "../providers/common/provider_ctx.c" 2
# 1 "../providers/common/include/prov/bio.h" 1
# 15 "../providers/common/include/prov/bio.h"
...
# 13 "../providers/common/provider_ctx.c" 2

PROV_CTX *ossl_prov_ctx_new(void)
{
    return CRYPTO_zalloc(sizeof(PROV_CTX), "../providers/common/provider_ctx.c", 16);
}

void ossl_prov_ctx_free(PROV_CTX *ctx)
{
    CRYPTO_free(ctx, "../providers/common/provider_ctx.c", 21);
}

void ossl_prov_ctx_set0_libctx(PROV_CTX *ctx, OSSL_LIB_CTX *libctx)
{
    if (ctx != 
# 26 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 26 "../providers/common/provider_ctx.c"
                  )
        ctx->libctx = libctx;
}
...
{
    if (ctx != 
# 32 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 32 "../providers/common/provider_ctx.c"
                  )
        ctx->handle = handle;
}
...
{
    if (ctx != 
# 38 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 38 "../providers/common/provider_ctx.c"
                  )
...
{
    if (ctx == 
# 44 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 44 "../providers/common/provider_ctx.c"
                  )
        return 
# 45 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 45 "../providers/common/provider_ctx.c"
                  ;
    return ctx->libctx;
}
...
{
    if (ctx == 
# 51 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 51 "../providers/common/provider_ctx.c"
                  )
        return 
# 52 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 52 "../providers/common/provider_ctx.c"
                  ;
    return ctx->handle;
}
...
{
    if (ctx == 
# 58 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 58 "../providers/common/provider_ctx.c"
                  )
        return 
# 59 "../providers/common/provider_ctx.c" 3 4
              ((void *)0)
# 59 "../providers/common/provider_ctx.c"
                  ;
