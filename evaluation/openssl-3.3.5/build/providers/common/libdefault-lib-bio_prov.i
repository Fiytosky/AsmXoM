# 0 "../providers/common/bio_prov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/bio_prov.c"
# 10 "../providers/common/bio_prov.c"
...
# 11 "../providers/common/bio_prov.c" 2
...
# 12 "../providers/common/bio_prov.c" 2
...
unsigned char *ossl_hexstr2buf_sep(const char *str, long *buflen,
                                   const char sep);
# 13 "../providers/common/bio_prov.c" 2
...
# 14 "../providers/common/bio_prov.c" 2

static OSSL_FUNC_BIO_new_file_fn *c_bio_new_file = 
# 15 "../providers/common/bio_prov.c" 3 4
                                                  ((void *)0)
# 15 "../providers/common/bio_prov.c"
                                                      ;
static OSSL_FUNC_BIO_new_membuf_fn *c_bio_new_membuf = 
# 16 "../providers/common/bio_prov.c" 3 4
                                                      ((void *)0)
# 16 "../providers/common/bio_prov.c"
                                                          ;
static OSSL_FUNC_BIO_read_ex_fn *c_bio_read_ex = 
# 17 "../providers/common/bio_prov.c" 3 4
                                                ((void *)0)
# 17 "../providers/common/bio_prov.c"
                                                    ;
static OSSL_FUNC_BIO_write_ex_fn *c_bio_write_ex = 
# 18 "../providers/common/bio_prov.c" 3 4
                                                  ((void *)0)
# 18 "../providers/common/bio_prov.c"
                                                      ;
static OSSL_FUNC_BIO_gets_fn *c_bio_gets = 
# 19 "../providers/common/bio_prov.c" 3 4
                                          ((void *)0)
# 19 "../providers/common/bio_prov.c"
                                              ;
static OSSL_FUNC_BIO_puts_fn *c_bio_puts = 
# 20 "../providers/common/bio_prov.c" 3 4
                                          ((void *)0)
# 20 "../providers/common/bio_prov.c"
                                              ;
static OSSL_FUNC_BIO_ctrl_fn *c_bio_ctrl = 
# 21 "../providers/common/bio_prov.c" 3 4
                                          ((void *)0)
# 21 "../providers/common/bio_prov.c"
                                              ;
static OSSL_FUNC_BIO_up_ref_fn *c_bio_up_ref = 
# 22 "../providers/common/bio_prov.c" 3 4
                                              ((void *)0)
# 22 "../providers/common/bio_prov.c"
                                                  ;
static OSSL_FUNC_BIO_free_fn *c_bio_free = 
# 23 "../providers/common/bio_prov.c" 3 4
                                          ((void *)0)
# 23 "../providers/common/bio_prov.c"
                                              ;
static OSSL_FUNC_BIO_vprintf_fn *c_bio_vprintf = 
# 24 "../providers/common/bio_prov.c" 3 4
                                                ((void *)0)
# 24 "../providers/common/bio_prov.c"
                                                    ;
...
int ossl_prov_bio_from_dispatch(const OSSL_DISPATCH *fns)
{
    for (; fns->function_id != 0; fns++) {
        ...
        case 40:
            if (c_bio_new_file == 
# 31 "../providers/common/bio_prov.c" 3 4
                                 ((void *)0)
# 31 "../providers/common/bio_prov.c"
                                     )
                c_bio_new_file = OSSL_FUNC_BIO_new_file(fns);
            break;
        case 41:
            if (c_bio_new_membuf == 
# 35 "../providers/common/bio_prov.c" 3 4
                                   ((void *)0)
# 35 "../providers/common/bio_prov.c"
                                       )
                c_bio_new_membuf = OSSL_FUNC_BIO_new_membuf(fns);
            break;
        case 42:
            if (c_bio_read_ex == 
# 39 "../providers/common/bio_prov.c" 3 4
                                ((void *)0)
# 39 "../providers/common/bio_prov.c"
                                    )
                c_bio_read_ex = OSSL_FUNC_BIO_read_ex(fns);
            break;
        case 43:
            if (c_bio_write_ex == 
# 43 "../providers/common/bio_prov.c" 3 4
                                 ((void *)0)
# 43 "../providers/common/bio_prov.c"
                                     )
                c_bio_write_ex = OSSL_FUNC_BIO_write_ex(fns);
            break;
        case 49:
            if (c_bio_gets == 
# 47 "../providers/common/bio_prov.c" 3 4
                             ((void *)0)
# 47 "../providers/common/bio_prov.c"
                                 )
                c_bio_gets = OSSL_FUNC_BIO_gets(fns);
            break;
        case 48:
            if (c_bio_puts == 
# 51 "../providers/common/bio_prov.c" 3 4
                             ((void *)0)
# 51 "../providers/common/bio_prov.c"
                                 )
                c_bio_puts = OSSL_FUNC_BIO_puts(fns);
            break;
        case 50:
            if (c_bio_ctrl == 
# 55 "../providers/common/bio_prov.c" 3 4
                             ((void *)0)
# 55 "../providers/common/bio_prov.c"
                                 )
                c_bio_ctrl = OSSL_FUNC_BIO_ctrl(fns);
            break;
        case 44:
            if (c_bio_up_ref == 
# 59 "../providers/common/bio_prov.c" 3 4
                               ((void *)0)
# 59 "../providers/common/bio_prov.c"
                                   )
                c_bio_up_ref = OSSL_FUNC_BIO_up_ref(fns);
            break;
        case 45:
            if (c_bio_free == 
# 63 "../providers/common/bio_prov.c" 3 4
                             ((void *)0)
# 63 "../providers/common/bio_prov.c"
                                 )
                c_bio_free = OSSL_FUNC_BIO_free(fns);
            break;
        case 46:
            if (c_bio_vprintf == 
# 67 "../providers/common/bio_prov.c" 3 4
                                ((void *)0)
# 67 "../providers/common/bio_prov.c"
                                    )
...
{
    if (c_bio_new_file == 
# 78 "../providers/common/bio_prov.c" 3 4
                         ((void *)0)
# 78 "../providers/common/bio_prov.c"
                             )
        return 
# 79 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 79 "../providers/common/bio_prov.c"
                  ;
...
{
    if (c_bio_new_membuf == 
# 85 "../providers/common/bio_prov.c" 3 4
                           ((void *)0)
# 85 "../providers/common/bio_prov.c"
                               )
        return 
# 86 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 86 "../providers/common/bio_prov.c"
                  ;
...
{
    if (c_bio_read_ex == 
# 93 "../providers/common/bio_prov.c" 3 4
                        ((void *)0)
# 93 "../providers/common/bio_prov.c"
                            )
        return 0;
...
{
    if (c_bio_write_ex == 
# 101 "../providers/common/bio_prov.c" 3 4
                         ((void *)0)
# 101 "../providers/common/bio_prov.c"
                             )
        return 0;
...
{
    if (c_bio_gets == 
# 108 "../providers/common/bio_prov.c" 3 4
                     ((void *)0)
# 108 "../providers/common/bio_prov.c"
                         )
        return -1;
...
{
    if (c_bio_puts == 
# 115 "../providers/common/bio_prov.c" 3 4
                     ((void *)0)
# 115 "../providers/common/bio_prov.c"
                         )
        return -1;
...
{
    if (c_bio_ctrl == 
# 122 "../providers/common/bio_prov.c" 3 4
                     ((void *)0)
# 122 "../providers/common/bio_prov.c"
                         )
        return -1;
...
{
    if (c_bio_up_ref == 
# 129 "../providers/common/bio_prov.c" 3 4
                       ((void *)0)
# 129 "../providers/common/bio_prov.c"
                           )
        return 0;
...
{
    if (c_bio_free == 
# 136 "../providers/common/bio_prov.c" 3 4
                     ((void *)0)
# 136 "../providers/common/bio_prov.c"
                         )
        return 0;
...
{
    if (c_bio_vprintf == 
# 143 "../providers/common/bio_prov.c" 3 4
                        ((void *)0)
# 143 "../providers/common/bio_prov.c"
                            )
        return -1;
...
# 153 "../providers/common/bio_prov.c" 3 4
   __builtin_c23_va_start(
# 153 "../providers/common/bio_prov.c"
   ap, format
# 153 "../providers/common/bio_prov.c" 3 4
   )
# 153 "../providers/common/bio_prov.c"
...
# 155 "../providers/common/bio_prov.c" 3 4
   __builtin_va_end(
# 155 "../providers/common/bio_prov.c"
   ap
# 155 "../providers/common/bio_prov.c" 3 4
   )
# 155 "../providers/common/bio_prov.c"
...
{
    BIO_METHOD *corebiometh = 
# 208 "../providers/common/bio_prov.c" 3 4
                             ((void *)0)
# 208 "../providers/common/bio_prov.c"
                                 ;

    corebiometh = BIO_meth_new((25|0x0400), "BIO to Core filter");
    if (corebiometh == 
# 211 "../providers/common/bio_prov.c" 3 4
                      ((void *)0)
            
# 212 "../providers/common/bio_prov.c"
        ...
        return 
# 220 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 220 "../providers/common/bio_prov.c"
                  ;
    }
...
BIO *ossl_bio_new_from_core_bio(PROV_CTX *provctx, OSSL_CORE_BIO *corebio)
{
    ...
    if (corebiometh == 
# 231 "../providers/common/bio_prov.c" 3 4
                      ((void *)0)
# 231 "../providers/common/bio_prov.c"
                          )
        return 
# 232 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 232 "../providers/common/bio_prov.c"
                  ;

    if ((outbio = BIO_new(corebiometh)) == 
# 234 "../providers/common/bio_prov.c" 3 4
                                          ((void *)0)
# 234 "../providers/common/bio_prov.c"
                                              )
        return 
# 235 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 235 "../providers/common/bio_prov.c"
                  ;
    if (!ossl_prov_bio_up_ref(corebio)) {
        BIO_free(outbio);
        return 
# 238 "../providers/common/bio_prov.c" 3 4
              ((void *)0)
# 238 "../providers/common/bio_prov.c"
                  ;
    }
