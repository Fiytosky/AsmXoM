# 0 "../providers/common/securitycheck.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/securitycheck.c"
# 10 "../providers/common/securitycheck.c"
...
# 11 "../providers/common/securitycheck.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 13 "../providers/common/securitycheck.c" 2
...
extern int DSA_meth_set_keygen(DSA_METHOD *dsam,
                                              int (*keygen) (DSA *));
# 14 "../providers/common/securitycheck.c" 2
...
extern void EC_KEY_METHOD_get_verify
                      (const EC_KEY_METHOD *meth,
                       ...
                       int (**pverify_sig)(const unsigned char *dgst,
                                           ...
                                           const ECDSA_SIG *sig,
                                           EC_KEY *eckey));
# 16 "../providers/common/securitycheck.c" 2
...
# 17 "../providers/common/securitycheck.c" 2
...
# 18 "../providers/common/securitycheck.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 19 "../providers/common/securitycheck.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 20 "../providers/common/securitycheck.c" 2
...
# 22 "../providers/common/securitycheck.c" 2
    ...
    switch (operation) {
        ...
        case (1<<10):
            if (RSA_test_flags(rsa,
                               0xF000) == 0x1000) {
                (ERR_new(), ERR_set_debug("../providers/common/securitycheck.c",48,__func__), ERR_set_error)(57,
                               178,
            ...
            break;
        default:
            (ERR_new(), ERR_set_debug("../providers/common/securitycheck.c",55,__func__), ERR_set_error)(57, (259|((0x1 << 18L)|(0x2 << 18L))),
                           "invalid operation: %d", operation);
            return 0;
    }
# 72 "../providers/common/securitycheck.c"
    (void)protect;

    return 1;
}
# 92 "../providers/common/securitycheck.c"
int ossl_ec_check_key(OSSL_LIB_CTX *ctx, const EC_KEY *ec, int protect)
{
# 140 "../providers/common/securitycheck.c"
    return 1;
}
# 150 "../providers/common/securitycheck.c"
int ossl_dsa_check_key(OSSL_LIB_CTX *ctx, const DSA *dsa, int sign)
{
# 191 "../providers/common/securitycheck.c"
    return 1;
}
# 202 "../providers/common/securitycheck.c"
int ossl_dh_check_key(OSSL_LIB_CTX *ctx, const DH *dh)
{
# 231 "../providers/common/securitycheck.c"
    return 1;
}
