# 0 "../providers/common/provider_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/provider_util.c"
# 13 "../providers/common/provider_util.c"
...
# 14 "../providers/common/provider_util.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../providers/common/provider_util.c" 2
...
# 16 "../providers/common/provider_util.c" 2
# 1 "../include/openssl/proverr.h" 1
# 13 "../include/openssl/proverr.h"
        
# 17 "../providers/common/provider_util.c" 2
...
# 19 "../providers/common/provider_util.c" 2
...
int evp_pkey_decrypt_alloc(EVP_PKEY_CTX *ctx, unsigned char **outp,
                           ...
                           const unsigned char *in, size_t inlen);
# 20 "../providers/common/provider_util.c" 2

# 1 "../providers/common/include/prov/provider_util.h" 1
# 10 "../providers/common/include/prov/provider_util.h"
...
# 11 "../providers/common/include/prov/provider_util.h" 2
# 1 "../include/openssl/types.h" 1
...
# 22 "../providers/common/provider_util.c" 2

void ossl_prov_cipher_reset(PROV_CIPHER *pc)
{
    EVP_CIPHER_free(pc->alloc_cipher);
    pc->alloc_cipher = 
# 26 "../providers/common/provider_util.c" 3 4
                      ((void *)0)
# 26 "../providers/common/provider_util.c"
                          ;
    pc->cipher = 
# 27 "../providers/common/provider_util.c" 3 4
                ((void *)0)
# 27 "../providers/common/provider_util.c"
                    ;

    ENGINE_finish(pc->engine);

    pc->engine = 
# 31 "../providers/common/provider_util.c" 3 4
                ((void *)0)
# 31 "../providers/common/provider_util.c"
                    ;
}
...
{
    if (src->alloc_cipher != 
# 36 "../providers/common/provider_util.c" 3 4
                            ((void *)0) 
# 36 "../providers/common/provider_util.c"
                                 && !EVP_CIPHER_up_ref(src->alloc_cipher))
        return 0;

    if (src->engine != 
# 39 "../providers/common/provider_util.c" 3 4
                      ((void *)0) 
# 39 "../providers/common/provider_util.c"
                           && !ENGINE_init(src->engine)) {
                       ...
                       ENGINE **engine)
{
    ...
    *propquery = 
# 55 "../providers/common/provider_util.c" 3 4
                ((void *)0)
# 55 "../providers/common/provider_util.c"
                    ;
    p = OSSL_PARAM_locate_const(params, "properties");
    if (p != 
# 57 "../providers/common/provider_util.c" 3 4
            ((void *)0)
# 57 "../providers/common/provider_util.c"
                ) {
        if (p->data_type != 4)
            return 0;
        *propquery = p->data;
    ...
    *engine = 
# 66 "../providers/common/provider_util.c" 3 4
             ((void *)0)
# 66 "../providers/common/provider_util.c"
                 ;


    p = OSSL_PARAM_locate_const(params, "engine");
    if (p != 
# 70 "../providers/common/provider_util.c" 3 4
            ((void *)0)
# 70 "../providers/common/provider_util.c"
                ) {
        if (p->data_type != 4)
            return 0;
        ...
        *engine = ENGINE_by_id(p->data);
        if (*engine == 
# 75 "../providers/common/provider_util.c" 3 4
                      ((void *)0)
# 75 "../providers/common/provider_util.c"
                          )
            return 0;
        ...
        if (!ENGINE_init(*engine)) {
            ENGINE_free(*engine);
            *engine = 
# 80 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 80 "../providers/common/provider_util.c"
                         ;
            return 0;
        }
                                      ...
                                      OSSL_LIB_CTX *ctx)
{
    ...
    if (params == 
# 97 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 97 "../providers/common/provider_util.c"
                     )
        return 1;
    ...
    p = OSSL_PARAM_locate_const(params, "cipher");
    if (p == 
# 104 "../providers/common/provider_util.c" 3 4
            ((void *)0)
# 104 "../providers/common/provider_util.c"
                )
        return 1;
    if (p->data_type != 4)
        return 0;
    ...
    if (pc->cipher == 
# 113 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 113 "../providers/common/provider_util.c"
                         ) {
        const EVP_CIPHER *cipher;
        ...
        if (cipher != 
# 118 "../providers/common/provider_util.c" 3 4
                     ((void *)0) 
# 118 "../providers/common/provider_util.c"
                          && cipher->origin != 1)
            pc->cipher = cipher;
    }

    if (pc->cipher != 
# 122 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 122 "../providers/common/provider_util.c"
                         )
        ERR_pop_to_mark();
    else
        ERR_clear_last_mark();
    return pc->cipher != 
# 126 "../providers/common/provider_util.c" 3 4
                        ((void *)0)
# 126 "../providers/common/provider_util.c"
                            ;
}
...
void ossl_prov_digest_reset(PROV_DIGEST *pd)
{
    ...
    pd->alloc_md = 
# 142 "../providers/common/provider_util.c" 3 4
                  ((void *)0)
# 142 "../providers/common/provider_util.c"
                      ;
    pd->md = 
# 143 "../providers/common/provider_util.c" 3 4
            ((void *)0)
# 143 "../providers/common/provider_util.c"
                ;

    ENGINE_finish(pd->engine);

    pd->engine = 
# 147 "../providers/common/provider_util.c" 3 4
                ((void *)0)
# 147 "../providers/common/provider_util.c"
                    ;
}
...
{
    if (src->alloc_md != 
# 152 "../providers/common/provider_util.c" 3 4
                        ((void *)0) 
# 152 "../providers/common/provider_util.c"
                             && !EVP_MD_up_ref(src->alloc_md))
        return 0;

    if (src->engine != 
# 155 "../providers/common/provider_util.c" 3 4
                      ((void *)0) 
# 155 "../providers/common/provider_util.c"
                           && !ENGINE_init(src->engine)) {
                                      ...
                                      OSSL_LIB_CTX *ctx)
{
    ...
    if (params == 
# 182 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 182 "../providers/common/provider_util.c"
                     )
        return 1;
    ...
    if (p == 
# 189 "../providers/common/provider_util.c" 3 4
            ((void *)0)
# 189 "../providers/common/provider_util.c"
                )
        return 1;
    if (p->data_type != 4)
        return 0;
    ...
    if (pd->md == 
# 197 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 197 "../providers/common/provider_util.c"
                     ) {
        const EVP_MD *md;
        ...
        if (md != 
# 202 "../providers/common/provider_util.c" 3 4
                 ((void *)0) 
# 202 "../providers/common/provider_util.c"
                      && md->origin != 1)
            pd->md = md;
    }

    if (pd->md != 
# 206 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 206 "../providers/common/provider_util.c"
                     )
        ERR_pop_to_mark();
    else
        ERR_clear_last_mark();
    return pd->md != 
# 210 "../providers/common/provider_util.c" 3 4
                    ((void *)0)
# 210 "../providers/common/provider_util.c"
                        ;
}
                         ...
                         size_t keylen)
{
    ...
    if (params != 
# 235 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 235 "../providers/common/provider_util.c"
                     ) {
        if (mdname == 
# 236 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 236 "../providers/common/provider_util.c"
                         ) {
            if ((p = OSSL_PARAM_locate_const(params,
                                            "digest")) != 
# 238 "../providers/common/provider_util.c" 3 4
                                                                      ((void *)0)
# 238 "../providers/common/provider_util.c"
                                                                          ) {
                if (p->data_type != 4)
                    return 0;
                mdname = p->data;
        ...
        if (ciphername == 
# 244 "../providers/common/provider_util.c" 3 4
                         ((void *)0)
# 244 "../providers/common/provider_util.c"
                             ) {
            if ((p = OSSL_PARAM_locate_const(params,
                                            "cipher")) != 
# 246 "../providers/common/provider_util.c" 3 4
                                                                      ((void *)0)
# 246 "../providers/common/provider_util.c"
                                                                          ) {
                if (p->data_type != 4)
                    return 0;
                ciphername = p->data;
        ...
        if (engine == 
# 252 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 252 "../providers/common/provider_util.c"
                         ) {
            if ((p = OSSL_PARAM_locate_const(params, "engine"))
                    != 
# 254 "../providers/common/provider_util.c" 3 4
                      ((void *)0)
# 254 "../providers/common/provider_util.c"
                          ) {
                if (p->data_type != 4)
                    return 0;
                engine = p->data;
    ...
    if (mdname != 
# 262 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 262 "../providers/common/provider_util.c"
                     )
        *mp++ = OSSL_PARAM_construct_utf8_string("digest",
                                                 (char *)mdname, 0);
    if (ciphername != 
# 265 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 265 "../providers/common/provider_util.c"
                         )
        *mp++ = OSSL_PARAM_construct_utf8_string("cipher",
                                                 (char *)ciphername, 0);
    if (properties != 
# 268 "../providers/common/provider_util.c" 3 4
                     ((void *)0)
# 268 "../providers/common/provider_util.c"
                         )
        *mp++ = OSSL_PARAM_construct_utf8_string("properties",
                                                 (char *)properties, 0);


    if (engine != 
# 273 "../providers/common/provider_util.c" 3 4
                 ((void *)0)
# 273 "../providers/common/provider_util.c"
                     )
    ...
    if (key != 
# 278 "../providers/common/provider_util.c" 3 4
              ((void *)0)
# 278 "../providers/common/provider_util.c"
                  )
        *mp++ = OSSL_PARAM_construct_octet_string("key",
                                                  (unsigned char *)key,
                                                  keylen);
                                      ...
                                      OSSL_LIB_CTX *libctx)
{
    const OSSL_PARAM *p;
    const char *properties = 
# 297 "../providers/common/provider_util.c" 3 4
                            ((void *)0)
# 297 "../providers/common/provider_util.c"
                                ;

    if (macname == 
# 299 "../providers/common/provider_util.c" 3 4
                  ((void *)0)
        
# 300 "../providers/common/provider_util.c"
       && (p = OSSL_PARAM_locate_const(params, "mac")) != 
# 300 "../providers/common/provider_util.c" 3 4
                                                                       ((void *)0)
# 300 "../providers/common/provider_util.c"
                                                                           ) {
        if (p->data_type != 4)
    ...
    if ((p = OSSL_PARAM_locate_const(params,
                                     "properties")) != 
# 306 "../providers/common/provider_util.c" 3 4
                                                                   ((void *)0)
# 306 "../providers/common/provider_util.c"
                                                                       ) {
        if (p->data_type != 4)
            return 0;
        properties = p->data;
    ...
    if (macname != 
# 313 "../providers/common/provider_util.c" 3 4
                  ((void *)0)
# 313 "../providers/common/provider_util.c"
                      ) {
        EVP_MAC *mac = EVP_MAC_fetch(libctx, macname, properties);

        EVP_MAC_CTX_free(*macctx);
        *macctx = mac == 
# 317 "../providers/common/provider_util.c" 3 4
                        ((void *)0) 
# 317 "../providers/common/provider_util.c"
                             ? 
# 317 "../providers/common/provider_util.c" 3 4
                               ((void *)0) 
# 317 "../providers/common/provider_util.c"
        ...
        EVP_MAC_free(mac);
        if (*macctx == 
# 320 "../providers/common/provider_util.c" 3 4
                      ((void *)0)
# 320 "../providers/common/provider_util.c"
                          )
            return 0;
    }
    ...
    if (*macctx == 
# 328 "../providers/common/provider_util.c" 3 4
                  ((void *)0)
# 328 "../providers/common/provider_util.c"
                      )
        return 1;

    if (ossl_prov_set_macctx(*macctx, params, ciphername, mdname, 
# 331 "../providers/common/provider_util.c" 3 4
                                                                 ((void *)0)
# 331 "../providers/common/provider_util.c"
                                                                     ,
                             properties, 
# 332 "../providers/common/provider_util.c" 3 4
                                        ((void *)0)
# 332 "../providers/common/provider_util.c"
    ...
    EVP_MAC_CTX_free(*macctx);
    *macctx = 
# 336 "../providers/common/provider_util.c" 3 4
             ((void *)0)
# 336 "../providers/common/provider_util.c"
                 ;
    return 0;
}
                                         ...
                                         OSSL_ALGORITHM *out)
{
    ...
    if (out[0].algorithm_names == 
# 345 "../providers/common/provider_util.c" 3 4
                                 ((void *)0)
# 345 "../providers/common/provider_util.c"
                                     ) {
        for (i = j = 0; in[i].alg.algorithm_names != 
# 346 "../providers/common/provider_util.c" 3 4
                                                    ((void *)0)
# 346 "../providers/common/provider_util.c"
                                                        ; ++i) {
            if (in[i].capable == 
# 347 "../providers/common/provider_util.c" 3 4
                                ((void *)0) 
# 347 "../providers/common/provider_util.c"
                                     || in[i].capable())
                out[j++] = in[i].alg;
        }
        out[j++] = in[i].alg;
...
{
    if (src != 
# 358 "../providers/common/provider_util.c" 3 4
              ((void *)0)
# 358 "../providers/common/provider_util.c"
                  ) {
        if ((*dest = CRYPTO_memdup((src), src_len, "../providers/common/provider_util.c", 359)) == 
# 359 "../providers/common/provider_util.c" 3 4
                                                     ((void *)0)
# 359 "../providers/common/provider_util.c"
                                                         )
            return 0;
        *dest_len = src_len;
    } else {
        *dest = 
# 363 "../providers/common/provider_util.c" 3 4
               ((void *)0)
# 363 "../providers/common/provider_util.c"
                   ;
        *dest_len = 0;
    }
    return 1;
