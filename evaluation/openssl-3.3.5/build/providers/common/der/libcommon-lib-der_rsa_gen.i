# 0 "providers/common/der/der_rsa_gen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "providers/common/der/der_rsa_gen.c"
# 13 "providers/common/der/der_rsa_gen.c"
...
int ossl_DER_w_algorithmIdentifier_MDWithRSAEncryption(WPACKET *pkt, int tag,
                                                       int mdnid);
# 14 "providers/common/der/der_rsa_gen.c" 2
...
const unsigned char ossl_der_oid_hashAlgs[10] = {
    6, 8, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02
};




const unsigned char ossl_der_oid_rsaEncryption[11] = {
...
const unsigned char ossl_der_oid_id_RSAES_OAEP[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x07
};




const unsigned char ossl_der_oid_id_pSpecified[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x09
};




const unsigned char ossl_der_oid_id_RSASSA_PSS[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0A
};




const unsigned char ossl_der_oid_md2WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x02
};




const unsigned char ossl_der_oid_md5WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x04
};




const unsigned char ossl_der_oid_sha1WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x05
};




const unsigned char ossl_der_oid_sha224WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0E
};




const unsigned char ossl_der_oid_sha256WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0B
};




const unsigned char ossl_der_oid_sha384WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0C
};




const unsigned char ossl_der_oid_sha512WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0D
};




const unsigned char ossl_der_oid_sha512_224WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x0F
};




const unsigned char ossl_der_oid_sha512_256WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x10
};




const unsigned char ossl_der_oid_id_mgf1[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x08
};




const unsigned char ossl_der_oid_id_rsassa_pkcs1_v1_5_with_sha3_224[11] = {
    6, 9, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x0D
};




const unsigned char ossl_der_oid_id_rsassa_pkcs1_v1_5_with_sha3_256[11] = {
    6, 9, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x0E
};




const unsigned char ossl_der_oid_id_rsassa_pkcs1_v1_5_with_sha3_384[11] = {
    6, 9, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x0F
};




const unsigned char ossl_der_oid_id_rsassa_pkcs1_v1_5_with_sha3_512[11] = {
    6, 9, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x03, 0x10
};




const unsigned char ossl_der_oid_md4WithRSAEncryption[11] = {
    6, 9, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x03
};
...
const unsigned char ossl_der_oid_ripemd160WithRSAEncryption[8] = {
    6, 6, 0x2B, 0x24, 0x03, 0x03, 0x01, 0x02
};
...
const unsigned char ossl_der_oid_mdc2WithRSASignature[7] = {
    6, 5, 0x2B, 0x0E, 0x03, 0x02, 0x0E
};
