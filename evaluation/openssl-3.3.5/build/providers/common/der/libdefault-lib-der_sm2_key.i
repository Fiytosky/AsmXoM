# 0 "../providers/common/der/der_sm2_key.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/der/der_sm2_key.c"
# 10 "../providers/common/der/der_sm2_key.c"
# 1 "../include/openssl/obj_mac.h" 1
# 14 "../include/openssl/obj_mac.h"
        
# 11 "../providers/common/der/der_sm2_key.c" 2
...
# 12 "../providers/common/der/der_sm2_key.c" 2
...
int ossl_DER_w_algorithmIdentifier_ECDSA_with_MD(WPACKET *pkt, int cont,
                                                 EC_KEY *ec, int mdnid);
# 13 "../providers/common/der/der_sm2_key.c" 2
...
int ossl_DER_w_algorithmIdentifier_SM2_with_MD(WPACKET *pkt, int cont,
                                               EC_KEY *ec, int mdnid);
# 14 "../providers/common/der/der_sm2_key.c" 2
