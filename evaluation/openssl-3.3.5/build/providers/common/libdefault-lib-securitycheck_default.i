# 0 "../providers/common/securitycheck_default.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/common/securitycheck_default.c"
# 10 "../providers/common/securitycheck_default.c"
...
# 11 "../providers/common/securitycheck_default.c" 2
...
int RSA_meth_set_multi_prime_keygen(RSA_METHOD *meth,
                                    int (*keygen) (RSA *rsa, int bits,
                                                   int primes, BIGNUM *e,
                                                   BN_GENCB *cb));
# 13 "../providers/common/securitycheck_default.c" 2

# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../providers/common/securitycheck_default.c" 2
# 1 "../include/openssl/obj_mac.h" 1
# 14 "../include/openssl/obj_mac.h"
        
# 16 "../providers/common/securitycheck_default.c" 2
...
# 17 "../providers/common/securitycheck_default.c" 2
# 1 "../include/internal/nelem.h" 1
# 12 "../include/internal/nelem.h"
        
# 18 "../providers/common/securitycheck_default.c" 2
...
int ossl_digest_rsa_sign_get_md_nid(OSSL_LIB_CTX *ctx, const EVP_MD *md,
                                    __attribute__((unused)) int sha1_allowed)
{
    int mdnid;
    ...
    if (mdnid == 0)
        mdnid = ossl_digest_md_to_nid(md, name_to_nid, (sizeof(name_to_nid)/sizeof((name_to_nid)[0])));
    return mdnid;
}
