# 0 "../providers/nullprov.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "../providers/nullprov.c"
# 10 "../providers/nullprov.c"
...
# 14 "../providers/nullprov.c" 2
# 1 "include/openssl/core_names.h" 1
# 16 "include/openssl/core_names.h"
        
# 15 "../providers/nullprov.c" 2
...
static const OSSL_PARAM null_param_types[] = {
    { ("name"), (6), (
# 23 "../providers/nullprov.c" 3 4
   ((void *)0)
# 23 "../providers/nullprov.c"
   ), (0), ((size_t)-1) },
    { ("version"), (6), (
# 24 "../providers/nullprov.c" 3 4
   ((void *)0)
# 24 "../providers/nullprov.c"
   ), (0), ((size_t)-1) },
    { ("buildinfo"), (6), (
# 25 "../providers/nullprov.c" 3 4
   ((void *)0)
# 25 "../providers/nullprov.c"
   ), (0), ((size_t)-1) },
    { ("status"), (1), (
# 26 "../providers/nullprov.c" 3 4
   ((void *)0)
# 26 "../providers/nullprov.c"
   ), (0), ((size_t)-1) },
    { 
# 27 "../providers/nullprov.c" 3 4
   ((void *)0)
# 27 "../providers/nullprov.c"
   , 0, 
# 27 "../providers/nullprov.c" 3 4
   ((void *)0)
# 27 "../providers/nullprov.c"
...
static int null_get_params(const OSSL_PROVIDER *provctx, OSSL_PARAM params[])
{
    ...
    if (p != 
# 40 "../providers/nullprov.c" 3 4
            ((void *)0) 
# 40 "../providers/nullprov.c"
                 && !OSSL_PARAM_set_utf8_ptr(p, "OpenSSL Null Provider"))
        return 0;
    p = OSSL_PARAM_locate(params, "version");
    if (p != 
# 43 "../providers/nullprov.c" 3 4
            ((void *)0) 
# 43 "../providers/nullprov.c"
                 && !OSSL_PARAM_set_utf8_ptr(p, "3.3.5"))
        return 0;
    p = OSSL_PARAM_locate(params, "buildinfo");
    if (p != 
# 46 "../providers/nullprov.c" 3 4
            ((void *)0) 
# 46 "../providers/nullprov.c"
                 && !OSSL_PARAM_set_utf8_ptr(p, "3.3.5"))
        return 0;
    p = OSSL_PARAM_locate(params, "status");
    if (p != 
# 49 "../providers/nullprov.c" 3 4
            ((void *)0) 
# 49 "../providers/nullprov.c"
                                          ...
                                          int *no_cache)
{
    *no_cache = 0;
    return 
# 59 "../providers/nullprov.c" 3 4
          ((void *)0)
# 59 "../providers/nullprov.c"
              ;
}


static const OSSL_DISPATCH null_dispatch_table[] = {
    { 1025, (void (*)(void))null_gettable_params },
    { 1026, (void (*)(void))null_get_params },
    { 1027, (void (*)(void))null_query },
    { 0, 
# 67 "../providers/nullprov.c" 3 4
   ((void *)0) 
# 67 "../providers/nullprov.c"
   }
};
