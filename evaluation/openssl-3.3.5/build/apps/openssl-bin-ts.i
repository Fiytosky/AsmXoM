...
# 13 "../include/openssl/tserr.h"
        
# 32 "../include/openssl/ts.h" 2
...
# 33 "../include/openssl/ts.h" 2
# 42 "../include/openssl/ts.h"
...
extern TS_REQ *TS_REQ_new(void); extern void TS_REQ_free(TS_REQ *a);
extern TS_REQ *d2i_TS_REQ(TS_REQ **a, const unsigned char **in, long len); extern int i2d_TS_REQ(const TS_REQ *a, unsigned char **out);
extern TS_REQ *TS_REQ_dup(const TS_REQ *a);
...
extern TS_MSG_IMPRINT *TS_MSG_IMPRINT_new(void); extern void TS_MSG_IMPRINT_free(TS_MSG_IMPRINT *a);
extern TS_MSG_IMPRINT *d2i_TS_MSG_IMPRINT(TS_MSG_IMPRINT **a, const unsigned char **in, long len); extern int i2d_TS_MSG_IMPRINT(const TS_MSG_IMPRINT *a, unsigned char **out);
extern TS_MSG_IMPRINT *TS_MSG_IMPRINT_dup(const TS_MSG_IMPRINT *a);
...
extern TS_RESP *TS_RESP_new(void); extern void TS_RESP_free(TS_RESP *a);
extern TS_RESP *d2i_TS_RESP(TS_RESP **a, const unsigned char **in, long len); extern int i2d_TS_RESP(const TS_RESP *a, unsigned char **out);
extern TS_RESP *TS_RESP_dup(const TS_RESP *a);
...
extern TS_STATUS_INFO *TS_STATUS_INFO_new(void); extern void TS_STATUS_INFO_free(TS_STATUS_INFO *a);
extern TS_STATUS_INFO *d2i_TS_STATUS_INFO(TS_STATUS_INFO **a, const unsigned char **in, long len); extern int i2d_TS_STATUS_INFO(const TS_STATUS_INFO *a, unsigned char **out);
extern TS_STATUS_INFO *TS_STATUS_INFO_dup(const TS_STATUS_INFO *a);

extern TS_TST_INFO *TS_TST_INFO_new(void); extern void TS_TST_INFO_free(TS_TST_INFO *a);
extern TS_TST_INFO *d2i_TS_TST_INFO(TS_TST_INFO **a, const unsigned char **in, long len); extern int i2d_TS_TST_INFO(const TS_TST_INFO *a, unsigned char **out);
extern TS_TST_INFO *TS_TST_INFO_dup(const TS_TST_INFO *a);
...
extern TS_ACCURACY *TS_ACCURACY_new(void); extern void TS_ACCURACY_free(TS_ACCURACY *a);
extern TS_ACCURACY *d2i_TS_ACCURACY(TS_ACCURACY **a, const unsigned char **in, long len); extern int i2d_TS_ACCURACY(const TS_ACCURACY *a, unsigned char **out);
extern TS_ACCURACY *TS_ACCURACY_dup(const TS_ACCURACY *a);
...
struct stack_st_X509 *TS_VERIFY_CTX_set_certs(TS_VERIFY_CTX *ctx, struct stack_st_X509 *certs);
# 446 "../include/openssl/ts.h"
...
const OPTIONS ts_options[] = {
    ...
    { OPT_SECTION_STR, 1, '-', "Query" " options:\n" },
    ...
    { OPT_SECTION_STR, 1, '-', "Verify" " options:\n" },
...
# 162 "../apps/ts.c"
                         ;
    const char *configfile = default_config_file, *engine = 
# 163 "../apps/ts.c" 3 4
                                                           ((void *)0)
# 163 "../apps/ts.c"
                                                               ;
...
# 307 "../apps/ts.c"
    ...
    if ((conf = load_config_file(configfile)) == 
# 312 "../apps/ts.c" 3 4
                                                ((void *)0)
# 312 "../apps/ts.c"
                                                    )
...
# 339 "../apps/ts.c" 3 4
                  ((void *)0)
# 339 "../apps/ts.c"
                      ) || !(( queryfile && !data && !digest) || ( data && !queryfile && !digest) || ( digest && !queryfile && !data)))
            goto opthelp;
...
# 343 "../apps/ts.c"
    ...
    EVP_MD_free(md);
    NCONF_free(conf);
    CRYPTO_free(password, "../apps/ts.c", 352);
    return ret;
}
...
static CONF *load_config_file(const char *configfile)
{
    CONF *conf = app_load_config_internal(configfile, 0);
...
# 408 "../apps/ts.c"
        ...
        if ((in_bio = bio_open_default(in, 'r', 4)) == 
# 409 "../apps/ts.c" 3 4
                                                                ((void *)0)
# 409 "../apps/ts.c"
                                                                    )
            goto end;
        query = d2i_TS_REQ_bio(in_bio, 
# 411 "../apps/ts.c" 3 4
                                      ((void *)0)
# 411 "../apps/ts.c"
                                          );
...
# 414 "../apps/ts.c"
           && (data_bio = bio_open_default(data, 'r', 4)) == 
# 414 "../apps/ts.c" 3 4
                                                                       ((void *)0)
# 414 "../apps/ts.c"
                                                                           )
...
# 418 "../apps/ts.c"
    ...
    if (text) {
        if ((out_bio = bio_open_default(out, 'w', (1 | 0x8000))) == 
# 422 "../apps/ts.c" 3 4
                                                                  ((void *)0)
# 422 "../apps/ts.c"
                                                                      )
        ...
        if ((out_bio = bio_open_default(out, 'w', 4)) == 
# 427 "../apps/ts.c" 3 4
                                                                  ((void *)0)
# 427 "../apps/ts.c"
                                                                      )
...
# 464 "../apps/ts.c"
        ...
        goto err;
    if ((algo->algorithm = OBJ_nid2obj(EVP_MD_get_type(md))) == 
# 466 "../apps/ts.c" 3 4
                                                               ((void *)0)
# 466 "../apps/ts.c"
                                                                   )
...
# 479 "../apps/ts.c"
    ...
    if (!no_nonce && (nonce_asn1 = create_nonce(64)) == 
# 485 "../apps/ts.c" 3 4
                                                                 ((void *)0)
# 485 "../apps/ts.c"
                                                                     )
...
# 496 "../apps/ts.c"
    ...
    CRYPTO_free(data, "../apps/ts.c", 502);
...
# 524 "../apps/ts.c"
        ...
        *md_value = app_malloc(md_value_len, "digest buffer");
        ...
        if (!EVP_DigestFinal(md_ctx, *md_value, 
# 533 "../apps/ts.c" 3 4
                                               ((void *)0)
# 533 "../apps/ts.c"
                                                   ))
...
# 540 "../apps/ts.c"
 ...
 err:
    if (rv <= 0) {
        CRYPTO_free(*md_value, "../apps/ts.c", 549);
        *md_value = 
# 550 "../apps/ts.c" 3 4
                   ((void *)0)
# 550 "../apps/ts.c"
...
# 572 "../apps/ts.c"
        ...
        goto err;
    CRYPTO_free(nonce->data, "../apps/ts.c", 574);
    nonce->length = len - i;
...
# 605 "../apps/ts.c"
        ...
        if (token_in) {
            ...
            response = d2i_TS_RESP_bio(in_bio, 
# 610 "../apps/ts.c" 3 4
                                              ((void *)0)
# 610 "../apps/ts.c"
                                                  );
...
# 712 "../apps/ts.c"
    ...
    if (md) {
        if (!TS_RESP_CTX_set_signer_digest(resp_ctx, md))
            goto end;
    } else if (!TS_CONF_set_signer_digest(conf, section, 
# 730 "../apps/ts.c" 3 4
                                                        ((void *)0)
# 730 "../apps/ts.c"
                                                            , resp_ctx)) {
...
# 793 "../apps/ts.c"
        ...
        if ((bn = ASN1_INTEGER_to_BN(serial, 
# 806 "../apps/ts.c" 3 4
                                            ((void *)0)
# 806 "../apps/ts.c"
                                                )) == 
...
# 809 "../apps/ts.c"
        ...
        if (!BN_add_word(bn, 1))
            goto err;
        if ((serial = BN_to_ASN1_INTEGER(bn, 
# 812 "../apps/ts.c" 3 4
                                            ((void *)0)
# 812 "../apps/ts.c"
                                                )) == 
...
# 867 "../apps/ts.c"
        ...
        if ((response = d2i_TS_RESP_bio(in_bio, 
# 870 "../apps/ts.c" 3 4
                                               ((void *)0)
# 870 "../apps/ts.c"
                                                   )) == 
...
# 918 "../apps/ts.c"
            ...
            f |= (1u << 4);
            if ((out = BIO_new_file(data, "rb")) == 
# 921 "../apps/ts.c" 3 4
                                                   ((void *)0)
# 921 "../apps/ts.c"
                                                       )
                goto err;
            if (TS_VERIFY_CTX_set_data(ctx, out) == 
# 923 "../apps/ts.c" 3 4
                                                   ((void *)0)
# 923 "../apps/ts.c"
                                                       ) {
...
# 927 "../apps/ts.c"
            ...
            f |= (1u << 3);
            if (TS_VERIFY_CTX_set_imprint(ctx, hexstr, imprint_len) == 
# 931 "../apps/ts.c" 3 4
                                                                      ((void *)0)
# 931 "../apps/ts.c"
                                                                          ) {
...
# 938 "../apps/ts.c"
            ...
            goto err;
        if ((request = d2i_TS_REQ_bio(input, 
# 940 "../apps/ts.c" 3 4
                                            ((void *)0)
# 940 "../apps/ts.c"
                                                )) == 
...
# 940 "../apps/ts.c"
            ...
            goto err;
        if ((ctx = TS_REQ_to_TS_VERIFY_CTX(request, 
# 942 "../apps/ts.c" 3 4
                                                   ((void *)0)
# 942 "../apps/ts.c"
                                                       )) == 
...
# 958 "../apps/ts.c"
        ...
        certs = load_certs_multifile(untrusted, 
# 959 "../apps/ts.c" 3 4
                                               ((void *)0)
# 959 "../apps/ts.c"
...
# 992 "../apps/ts.c"
        ...
        if (X509_LOOKUP_ctrl((lookup),2,(CApath),(long)(1),
# 996 "../apps/ts.c" 3 4
           ((void *)0)
# 996 "../apps/ts.c"
           ) <= 0) {
...
# 1004 "../apps/ts.c"
        ...
        if (X509_LOOKUP_ctrl_ex((lookup), 1, (CAfile), (long)(1), 
# 1008 "../apps/ts.c" 3 4
           ((void *)0)
# 1008 "../apps/ts.c"
           , (libctx), (propq))
...
# 1017 "../apps/ts.c"
        ...
        if (X509_LOOKUP_ctrl_ex((lookup), 3, (CAstore), 0, 
# 1021 "../apps/ts.c" 3 4
           ((void *)0)
# 1021 "../apps/ts.c"
           , (libctx), (propq)) <= 0) {
